...
class InstanceAlerts {
  ...
  factory InstanceAlerts.fromMap(Map<String, dynamic> map) {
    return InstanceAlerts(
      ...
      io: (() { final guardedValue = map['io']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      networkIn: (() { final guardedValue = map['networkIn']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      networkOut: (() { final guardedValue = map['networkOut']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      transferQuota: (() { final guardedValue = map['transferQuota']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
    );
  }
}
