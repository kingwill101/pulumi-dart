...
class DatabaseMysqlV2Timeouts {
  ...
  /// Creates a new [DatabaseMysqlV2Timeouts].
  ...
  DatabaseMysqlV2Timeouts({this.create, this.delete, this.update});
  ...
  factory DatabaseMysqlV2Timeouts.fromMap(Map<String, dynamic> map) {
    return DatabaseMysqlV2Timeouts(
      create: (() {
