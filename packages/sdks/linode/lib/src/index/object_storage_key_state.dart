...
class ObjectStorageKeyState {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'regionsDetails':
          ?pulumi.Input.mapOptionalInputValue<
            List<ObjectStorageKeyRegionsDetail>,
            List<Map<String, dynamic>>
          >(
            regionsDetails,
            (value) =>
  ...
  factory ObjectStorageKeyState.fromMap(Map<String, dynamic> map) {
    return ObjectStorageKeyState(
      ...
      regionsDetails: (() {
        final guardedValue = map['regionsDetails'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ObjectStorageKeyRegionsDetail>(
            guardedValue,
            (value) => ObjectStorageKeyRegionsDetail.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
