...
class GetVolumesArgs {
  ...
  factory GetVolumesArgs.fromMap(Map<String, dynamic> map) {
    return GetVolumesArgs(
      filters: (() { final guardedValue = map['filters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetVolumesFilter>(guardedValue, (value) => GetVolumesFilter.fromMap((value as Map).cast<String, dynamic>()))); })(),
