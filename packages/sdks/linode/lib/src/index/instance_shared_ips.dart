...
import 'instance_shared_ips_state.dart';
...
class InstanceSharedIps extends pulumi.CustomResource {
  ...
  /// Gets an existing [InstanceSharedIps] resource's state with the given [name] and [id].
  static InstanceSharedIps get(
    String name,
    pulumi.Input<String> id, {
    InstanceSharedIpsState? state,
  }) {
    return InstanceSharedIps._get(
      name,
      state: state?.toMap(),
