...
class GetAccountAvailabilitiesFilter {
  ...
  /// Creates a new [GetAccountAvailabilitiesFilter].
  ...
  const GetAccountAvailabilitiesFilter({
    this.matchBy,
    required this.name,
  ...
  factory GetAccountAvailabilitiesFilter.fromMap(Map<String, dynamic> map) {
    return GetAccountAvailabilitiesFilter(
