...
class GetNodebalancerConfigsNodebalancerConfig {
  ...
  factory GetNodebalancerConfigsNodebalancerConfig.fromMap(Map<String, dynamic> map) {
    return GetNodebalancerConfigsNodebalancerConfig(
      ...
      check: (map['check'] as String).input(),
      checkAttempts: (map['checkAttempts'] as int).input(),
      checkBody: (map['checkBody'] as String).input(),
      checkInterval: (map['checkInterval'] as int).input(),
      checkPassive: (map['checkPassive'] as bool).input(),
      checkPath: (map['checkPath'] as String).input(),
      checkTimeout: (map['checkTimeout'] as int).input(),
      cipherSuite: (map['cipherSuite'] as String).input(),
      id: (map['id'] as int).input(),
      nodeStatuses: (pulumi.Input.decodeList<GetNodebalancerConfigsNodebalancerConfigNodeStatus>(map['nodeStatuses'], (value) => GetNodebalancerConfigsNodebalancerConfigNodeStatus.fromMap((value as Map).cast<String, dynamic>()))).input(),
      nodebalancerId: (map['nodebalancerId'] as int).input(),
      port: (map['port'] as int).input(),
      protocol: (map['protocol'] as String).input(),
      proxyProtocol: (map['proxyProtocol'] as String).input(),
      sslCommonname: (map['sslCommonname'] as String).input(),
      sslFingerprint: (map['sslFingerprint'] as String).input(),
      stickiness: (map['stickiness'] as String).input(),
      udpCheckPort: (map['udpCheckPort'] as int).input(),
      udpSessionTimeout: (map['udpSessionTimeout'] as int).input(),
    );
  }
}
