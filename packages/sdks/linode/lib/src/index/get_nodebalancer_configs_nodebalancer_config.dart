...
class GetNodebalancerConfigsNodebalancerConfig {
  ...
  final pulumi.Input<List<GetNodebalancerConfigsNodebalancerConfigNodeStatus>> nodeStatuses;
  ...
  const GetNodebalancerConfigsNodebalancerConfig({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'id': id,
      'nodeStatuses': pulumi.Input.mapInputValue<List<GetNodebalancerConfigsNodebalancerConfigNodeStatus>, List<Map<String, dynamic>>>(nodeStatuses, (value) => pulumi.Input.encodeList<GetNodebalancerConfigsNodebalancerConfigNodeStatus, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory GetNodebalancerConfigsNodebalancerConfig.fromMap(Map<String, dynamic> map) {
    return GetNodebalancerConfigsNodebalancerConfig(
      ...
      check: pulumi.Input.fromValue(map['check'] as String),
      checkAttempts: pulumi.Input.fromValue(map['checkAttempts'] as int),
      checkBody: pulumi.Input.fromValue(map['checkBody'] as String),
      checkInterval: pulumi.Input.fromValue(map['checkInterval'] as int),
      checkPassive: pulumi.Input.fromValue(map['checkPassive'] as bool),
      checkPath: pulumi.Input.fromValue(map['checkPath'] as String),
      checkTimeout: pulumi.Input.fromValue(map['checkTimeout'] as int),
      cipherSuite: pulumi.Input.fromValue(map['cipherSuite'] as String),
      id: pulumi.Input.fromValue(map['id'] as int),
      nodeStatuses: pulumi.Input.fromValue(pulumi.Input.decodeList<GetNodebalancerConfigsNodebalancerConfigNodeStatus>(map['nodeStatuses']!, (value) => GetNodebalancerConfigsNodebalancerConfigNodeStatus.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      sslCommonname: pulumi.Input.fromValue(map['sslCommonname'] as String),
      sslFingerprint: pulumi.Input.fromValue(map['sslFingerprint'] as String),
      stickiness: pulumi.Input.fromValue(map['stickiness'] as String),
      udpCheckPort: pulumi.Input.fromValue(map['udpCheckPort'] as int),
      udpSessionTimeout: pulumi.Input.fromValue(map['udpSessionTimeout'] as int),
    );
  }
}
