...
class GetNodebalancerConfigsNodebalancerConfig {
  ...
  final pulumi.Input<List<GetNodebalancerConfigsNodebalancerConfigNodeStatus>>
  nodeStatuses;
    ...
    return <String, dynamic>{
      ...
      'nodeStatuses':
          pulumi.Input.mapInputValue<
            List<GetNodebalancerConfigsNodebalancerConfigNodeStatus>,
  ...
  factory GetNodebalancerConfigsNodebalancerConfig.fromMap(
    ...
    return GetNodebalancerConfigsNodebalancerConfig(
      ...
      nodeStatuses: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetNodebalancerConfigsNodebalancerConfigNodeStatus
        >(
          map['nodeStatuses']!,
          (value) => GetNodebalancerConfigsNodebalancerConfigNodeStatus.fromMap(
      ...
      udpSessionTimeout: pulumi.Input.fromValue(
        map['udpSessionTimeout'] as int,
      ),
    );
  }
}
