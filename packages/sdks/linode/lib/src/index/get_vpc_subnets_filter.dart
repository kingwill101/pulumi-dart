...
class GetVpcSubnetsFilter {
  ...
  /// Creates a new [GetVpcSubnetsFilter].
  ...
  GetVpcSubnetsFilter({this.matchBy, required this.name, required this.values});
  ...
  factory GetVpcSubnetsFilter.fromMap(Map<String, dynamic> map) {
    return GetVpcSubnetsFilter(
      matchBy: (() {
