...
class GetVpcIpsVpcIp {
    ...
    return <String, dynamic>{
      ...
      'ipv6Addresses':
          pulumi.Input.mapInputValue<
            List<GetVpcIpsVpcIpIpv6Address>,
  ...
  factory GetVpcIpsVpcIp.fromMap(Map<String, dynamic> map) {
    return GetVpcIpsVpcIp(
      ...
      ipv6Addresses: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetVpcIpsVpcIpIpv6Address>(
          map['ipv6Addresses']!,
          (value) => GetVpcIpsVpcIpIpv6Address.fromMap(
