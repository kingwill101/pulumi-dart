    ...
    return LkeClusterPool(
      autoscaler: (() {
        ...
        return pulumi.Input.fromValue(
          LkeClusterPoolAutoscaler.fromMap(
      ...
      nodes: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<LkeClusterPoolNode>(
            guardedValue,
            (value) => LkeClusterPoolNode.fromMap(
      ...
      taints: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<LkeClusterPoolTaint>(
            guardedValue,
            (value) => LkeClusterPoolTaint.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
