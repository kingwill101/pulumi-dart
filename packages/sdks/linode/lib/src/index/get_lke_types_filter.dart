...
class GetLkeTypesFilter {
  ...
  /// Creates a new [GetLkeTypesFilter].
  ...
  GetLkeTypesFilter({this.matchBy, required this.name, required this.values});
  ...
  factory GetLkeTypesFilter.fromMap(Map<String, dynamic> map) {
    return GetLkeTypesFilter(
      matchBy: (() {
