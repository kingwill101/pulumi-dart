...
class GetConsumerImageShareGroupImageSharesArgs {
  final pulumi.Input<List<GetConsumerImageShareGroupImageSharesFilter>>?
  filters;
  final pulumi.Input<List<GetConsumerImageShareGroupImageSharesImageShare>>?
  imageShares;
    ...
    return <String, dynamic>{
      'filters':
          ?pulumi.Input.mapOptionalInputValue<
            List<GetConsumerImageShareGroupImageSharesFilter>,
      ...
      'imageShares':
          ?pulumi.Input.mapOptionalInputValue<
            List<GetConsumerImageShareGroupImageSharesImageShare>,
            List<Map<String, dynamic>>
          >(
            imageShares,
            (value) =>
  ...
  factory GetConsumerImageShareGroupImageSharesArgs.fromMap(
    ...
    return GetConsumerImageShareGroupImageSharesArgs(
      filters: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GetConsumerImageShareGroupImageSharesFilter>(
            guardedValue,
            (value) => GetConsumerImageShareGroupImageSharesFilter.fromMap(
      ...
      imageShares: (() {
        final guardedValue = map['imageShares'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => GetConsumerImageShareGroupImageSharesImageShare.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
