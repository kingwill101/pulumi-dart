...
class GetVpcIpsFilter {
  ...
  GetVpcIpsFilter({this.matchBy, required this.name, required this.values});
  ...
  factory GetVpcIpsFilter.fromMap(Map<String, dynamic> map) {
    return GetVpcIpsFilter(
      matchBy: (() {
