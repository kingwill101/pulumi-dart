...
class GetLkeTypesArgs {
  ...
  GetLkeTypesArgs({
    pulumi.Output<List<GetLkeTypesFilter>>? filters,
  ...
  factory GetLkeTypesArgs.fromMap(Map<String, dynamic> map) {
    return GetLkeTypesArgs(
      filters: map['filters'] == null ? null : pulumi.Output.create<List<GetLkeTypesFilter>>(pulumi.Input.decodeList<GetLkeTypesFilter>(map['filters'], (value) => GetLkeTypesFilter.fromMap((value as Map).cast<String, dynamic>()))),
