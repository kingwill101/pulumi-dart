...
class GetNodeBalancerFirewallInbound {
  ...
  /// Creates a new [GetNodeBalancerFirewallInbound].
  ...
  const GetNodeBalancerFirewallInbound({
  ...
  factory GetNodeBalancerFirewallInbound.fromMap(Map<String, dynamic> map) {
    return GetNodeBalancerFirewallInbound(
