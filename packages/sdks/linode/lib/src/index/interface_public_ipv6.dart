    ...
    return <String, dynamic>{
      'assignedRanges':
          ?pulumi.Input.mapOptionalInputValue<
            List<InterfacePublicIpv6AssignedRange>,
      ...
      'shareds':
          ?pulumi.Input.mapOptionalInputValue<
            List<InterfacePublicIpv6Shared>,
            List<Map<String, dynamic>>
          >(
            shareds,
            (value) =>
    ...
    return InterfacePublicIpv6(
      assignedRanges: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InterfacePublicIpv6AssignedRange>(
            guardedValue,
            (value) => InterfacePublicIpv6AssignedRange.fromMap(
      ...
      ranges: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InterfacePublicIpv6Range>(
            guardedValue,
            (value) => InterfacePublicIpv6Range.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      shareds: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InterfacePublicIpv6Shared>(
            guardedValue,
            (value) => InterfacePublicIpv6Shared.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      slaacs: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InterfacePublicIpv6Slaac>(
            guardedValue,
            (value) => InterfacePublicIpv6Slaac.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
