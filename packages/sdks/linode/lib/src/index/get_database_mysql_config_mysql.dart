...
class GetDatabaseMysqlConfigMysql {
  ...
  factory GetDatabaseMysqlConfigMysql.fromMap(Map<String, dynamic> map) {
    return GetDatabaseMysqlConfigMysql(
      connectTimeout: pulumi.Input.fromValue(GetDatabaseMysqlConfigMysqlConnectTimeout.fromMap((map['connectTimeout']! as Map).cast<String, dynamic>())),
      defaultTimeZone: pulumi.Input.fromValue(GetDatabaseMysqlConfigMysqlDefaultTimeZone.fromMap((map['defaultTimeZone']! as Map).cast<String, dynamic>())),
      groupConcatMaxLen: pulumi.Input.fromValue(GetDatabaseMysqlConfigMysqlGroupConcatMaxLen.fromMap((map['groupConcatMaxLen']! as Map).cast<String, dynamic>())),
      informationSchemaStatsExpiry: pulumi.Input.fromValue(GetDatabaseMysqlConfigMysqlInformationSchemaStatsExpiry.fromMap((map['informationSchemaStatsExpiry']! as Map).cast<String, dynamic>())),
      innodbChangeBufferMaxSize: pulumi.Input.fromValue(GetDatabaseMysqlConfigMysqlInnodbChangeBufferMaxSize.fromMap((map['innodbChangeBufferMaxSize']! as Map).cast<String, dynamic>())),
      innodbFlushNeighbors: pulumi.Input.fromValue(GetDatabaseMysqlConfigMysqlInnodbFlushNeighbors.fromMap((map['innodbFlushNeighbors']! as Map).cast<String, dynamic>())),
      innodbFtMinTokenSize: pulumi.Input.fromValue(GetDatabaseMysqlConfigMysqlInnodbFtMinTokenSize.fromMap((map['innodbFtMinTokenSize']! as Map).cast<String, dynamic>())),
      innodbFtServerStopwordTable: pulumi.Input.fromValue(GetDatabaseMysqlConfigMysqlInnodbFtServerStopwordTable.fromMap((map['innodbFtServerStopwordTable']! as Map).cast<String, dynamic>())),
      innodbLockWaitTimeout: pulumi.Input.fromValue(GetDatabaseMysqlConfigMysqlInnodbLockWaitTimeout.fromMap((map['innodbLockWaitTimeout']! as Map).cast<String, dynamic>())),
      innodbLogBufferSize: pulumi.Input.fromValue(GetDatabaseMysqlConfigMysqlInnodbLogBufferSize.fromMap((map['innodbLogBufferSize']! as Map).cast<String, dynamic>())),
      innodbOnlineAlterLogMaxSize: pulumi.Input.fromValue(GetDatabaseMysqlConfigMysqlInnodbOnlineAlterLogMaxSize.fromMap((map['innodbOnlineAlterLogMaxSize']! as Map).cast<String, dynamic>())),
      innodbReadIoThreads: pulumi.Input.fromValue(GetDatabaseMysqlConfigMysqlInnodbReadIoThreads.fromMap((map['innodbReadIoThreads']! as Map).cast<String, dynamic>())),
      innodbRollbackOnTimeout: pulumi.Input.fromValue(GetDatabaseMysqlConfigMysqlInnodbRollbackOnTimeout.fromMap((map['innodbRollbackOnTimeout']! as Map).cast<String, dynamic>())),
      innodbThreadConcurrency: pulumi.Input.fromValue(GetDatabaseMysqlConfigMysqlInnodbThreadConcurrency.fromMap((map['innodbThreadConcurrency']! as Map).cast<String, dynamic>())),
      innodbWriteIoThreads: pulumi.Input.fromValue(GetDatabaseMysqlConfigMysqlInnodbWriteIoThreads.fromMap((map['innodbWriteIoThreads']! as Map).cast<String, dynamic>())),
      interactiveTimeout: pulumi.Input.fromValue(GetDatabaseMysqlConfigMysqlInteractiveTimeout.fromMap((map['interactiveTimeout']! as Map).cast<String, dynamic>())),
      internalTmpMemStorageEngine: pulumi.Input.fromValue(GetDatabaseMysqlConfigMysqlInternalTmpMemStorageEngine.fromMap((map['internalTmpMemStorageEngine']! as Map).cast<String, dynamic>())),
      maxAllowedPacket: pulumi.Input.fromValue(GetDatabaseMysqlConfigMysqlMaxAllowedPacket.fromMap((map['maxAllowedPacket']! as Map).cast<String, dynamic>())),
      maxHeapTableSize: pulumi.Input.fromValue(GetDatabaseMysqlConfigMysqlMaxHeapTableSize.fromMap((map['maxHeapTableSize']! as Map).cast<String, dynamic>())),
      netBufferLength: pulumi.Input.fromValue(GetDatabaseMysqlConfigMysqlNetBufferLength.fromMap((map['netBufferLength']! as Map).cast<String, dynamic>())),
      netReadTimeout: pulumi.Input.fromValue(GetDatabaseMysqlConfigMysqlNetReadTimeout.fromMap((map['netReadTimeout']! as Map).cast<String, dynamic>())),
      netWriteTimeout: pulumi.Input.fromValue(GetDatabaseMysqlConfigMysqlNetWriteTimeout.fromMap((map['netWriteTimeout']! as Map).cast<String, dynamic>())),
      sortBufferSize: pulumi.Input.fromValue(GetDatabaseMysqlConfigMysqlSortBufferSize.fromMap((map['sortBufferSize']! as Map).cast<String, dynamic>())),
      sqlMode: pulumi.Input.fromValue(GetDatabaseMysqlConfigMysqlSqlMode.fromMap((map['sqlMode']! as Map).cast<String, dynamic>())),
      sqlRequirePrimaryKey: pulumi.Input.fromValue(GetDatabaseMysqlConfigMysqlSqlRequirePrimaryKey.fromMap((map['sqlRequirePrimaryKey']! as Map).cast<String, dynamic>())),
      tmpTableSize: pulumi.Input.fromValue(GetDatabaseMysqlConfigMysqlTmpTableSize.fromMap((map['tmpTableSize']! as Map).cast<String, dynamic>())),
      waitTimeout: pulumi.Input.fromValue(GetDatabaseMysqlConfigMysqlWaitTimeout.fromMap((map['waitTimeout']! as Map).cast<String, dynamic>())),
    );
  }
}
