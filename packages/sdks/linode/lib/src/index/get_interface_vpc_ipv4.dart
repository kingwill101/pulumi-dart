...
class GetInterfaceVpcIpv4 {
  ...
  factory GetInterfaceVpcIpv4.fromMap(Map<String, dynamic> map) {
    return GetInterfaceVpcIpv4(
      addresses: pulumi.Input.fromValue(pulumi.Input.decodeList<GetInterfaceVpcIpv4Address>(map['addresses']!, (value) => GetInterfaceVpcIpv4Address.fromMap((value as Map).cast<String, dynamic>()))),
      ranges: pulumi.Input.fromValue(pulumi.Input.decodeList<GetInterfaceVpcIpv4Range>(map['ranges']!, (value) => GetInterfaceVpcIpv4Range.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
