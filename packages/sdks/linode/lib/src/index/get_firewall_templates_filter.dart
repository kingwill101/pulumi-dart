...
class GetFirewallTemplatesFilter {
  ...
  /// Creates a new [GetFirewallTemplatesFilter].
  ...
  const GetFirewallTemplatesFilter({
    this.matchBy,
    required this.name,
  ...
  factory GetFirewallTemplatesFilter.fromMap(Map<String, dynamic> map) {
    return GetFirewallTemplatesFilter(
