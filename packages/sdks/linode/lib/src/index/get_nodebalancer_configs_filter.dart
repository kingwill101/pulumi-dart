...
class GetNodebalancerConfigsFilter {
  ...
  /// Creates a new [GetNodebalancerConfigsFilter].
  ...
  const GetNodebalancerConfigsFilter({
    this.matchBy,
    required this.name,
  ...
  factory GetNodebalancerConfigsFilter.fromMap(Map<String, dynamic> map) {
    return GetNodebalancerConfigsFilter(
