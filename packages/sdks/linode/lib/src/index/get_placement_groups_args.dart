...
class GetPlacementGroupsArgs {
  ...
  GetPlacementGroupsArgs({
    pulumi.Output<List<GetPlacementGroupsFilter>>? filters,
  ...
  factory GetPlacementGroupsArgs.fromMap(Map<String, dynamic> map) {
    return GetPlacementGroupsArgs(
      filters: map['filters'] == null ? null : pulumi.Output.create<List<GetPlacementGroupsFilter>>(pulumi.Input.decodeList<GetPlacementGroupsFilter>(map['filters'], (value) => GetPlacementGroupsFilter.fromMap((value as Map).cast<String, dynamic>()))),
