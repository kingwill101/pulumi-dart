...
class GetVlansFilter {
  ...
  GetVlansFilter({this.matchBy, required this.name, required this.values});
  ...
  factory GetVlansFilter.fromMap(Map<String, dynamic> map) {
    return GetVlansFilter(
      matchBy: (() {
