...
class NodeBalancerConfigState {
  ...
  factory NodeBalancerConfigState.fromMap(Map<String, dynamic> map) {
    return NodeBalancerConfigState(
      ...
      nodeStatuses: map['nodeStatuses'] == null ? null : (pulumi.Input.decodeList<NodeBalancerConfigNodeStatus>(map['nodeStatuses'], (value) => NodeBalancerConfigNodeStatus.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      sslCommonname: map['sslCommonname'] == null ? null : (map['sslCommonname'] as String).input(),
      sslFingerprint: map['sslFingerprint'] == null ? null : (map['sslFingerprint'] as String).input(),
      ...
      udpSessionTimeout: map['udpSessionTimeout'] == null ? null : (map['udpSessionTimeout'] as int).input(),
    );
  }
}
