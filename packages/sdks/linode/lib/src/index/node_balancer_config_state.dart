...
class NodeBalancerConfigState {
  ...
  factory NodeBalancerConfigState.fromMap(Map<String, dynamic> map) {
    return NodeBalancerConfigState(
      ...
      checkAttempts: (() { final guardedValue = map['checkAttempts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      checkBody: (() { final guardedValue = map['checkBody']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      checkInterval: (() { final guardedValue = map['checkInterval']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      checkPassive: (() { final guardedValue = map['checkPassive']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      checkPath: (() { final guardedValue = map['checkPath']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      checkTimeout: (() { final guardedValue = map['checkTimeout']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      nodeStatuses: (() { final guardedValue = map['nodeStatuses']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NodeBalancerConfigNodeStatus>(guardedValue, (value) => NodeBalancerConfigNodeStatus.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      sslCert: (() { final guardedValue = map['sslCert']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      sslCommonname: (() { final guardedValue = map['sslCommonname']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      sslFingerprint: (() { final guardedValue = map['sslFingerprint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      sslKey: (() { final guardedValue = map['sslKey']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      stickiness: (() { final guardedValue = map['stickiness']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      udpCheckPort: (() { final guardedValue = map['udpCheckPort']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      udpSessionTimeout: (() { final guardedValue = map['udpSessionTimeout']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
    );
  }
}
