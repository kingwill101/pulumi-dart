...
class GetNetworkTransferPricesFilter {
  ...
  /// Creates a new [GetNetworkTransferPricesFilter].
  ...
  const GetNetworkTransferPricesFilter({
    this.matchBy,
    required this.name,
  ...
  factory GetNetworkTransferPricesFilter.fromMap(Map<String, dynamic> map) {
    return GetNetworkTransferPricesFilter(
