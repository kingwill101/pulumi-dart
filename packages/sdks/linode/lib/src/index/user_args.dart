...
class UserArgs {
  ...
  factory UserArgs.fromMap(Map<String, dynamic> map) {
    return UserArgs(
      domainGrants: (() { final guardedValue = map['domainGrants']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<UserDomainGrant>(guardedValue, (value) => UserDomainGrant.fromMap((value as Map).cast<String, dynamic>()))); })(),
      email: pulumi.Input.fromValue(map['email'] as String),
      firewallGrants: (() { final guardedValue = map['firewallGrants']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<UserFirewallGrant>(guardedValue, (value) => UserFirewallGrant.fromMap((value as Map).cast<String, dynamic>()))); })(),
      globalGrants: (() { final guardedValue = map['globalGrants']; if (guardedValue == null) return null; return pulumi.Input.fromValue(UserGlobalGrants.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      imageGrants: (() { final guardedValue = map['imageGrants']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<UserImageGrant>(guardedValue, (value) => UserImageGrant.fromMap((value as Map).cast<String, dynamic>()))); })(),
      linodeGrants: (() { final guardedValue = map['linodeGrants']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<UserLinodeGrant>(guardedValue, (value) => UserLinodeGrant.fromMap((value as Map).cast<String, dynamic>()))); })(),
      longviewGrants: (() { final guardedValue = map['longviewGrants']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<UserLongviewGrant>(guardedValue, (value) => UserLongviewGrant.fromMap((value as Map).cast<String, dynamic>()))); })(),
      nodebalancerGrants: (() { final guardedValue = map['nodebalancerGrants']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<UserNodebalancerGrant>(guardedValue, (value) => UserNodebalancerGrant.fromMap((value as Map).cast<String, dynamic>()))); })(),
      restricted: (() { final guardedValue = map['restricted']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      stackscriptGrants: (() { final guardedValue = map['stackscriptGrants']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<UserStackscriptGrant>(guardedValue, (value) => UserStackscriptGrant.fromMap((value as Map).cast<String, dynamic>()))); })(),
      username: pulumi.Input.fromValue(map['username'] as String),
      volumeGrants: (() { final guardedValue = map['volumeGrants']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<UserVolumeGrant>(guardedValue, (value) => UserVolumeGrant.fromMap((value as Map).cast<String, dynamic>()))); })(),
      vpcGrants: (() { final guardedValue = map['vpcGrants']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<UserVpcGrant>(guardedValue, (value) => UserVpcGrant.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
