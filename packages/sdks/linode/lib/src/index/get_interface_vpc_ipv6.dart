...
class GetInterfaceVpcIpv6 {
  ...
  factory GetInterfaceVpcIpv6.fromMap(Map<String, dynamic> map) {
    return GetInterfaceVpcIpv6(
      ...
      ranges: (pulumi.Input.decodeList<GetInterfaceVpcIpv6Range>(map['ranges'], (value) => GetInterfaceVpcIpv6Range.fromMap((value as Map).cast<String, dynamic>()))).input(),
      slaacs: (pulumi.Input.decodeList<GetInterfaceVpcIpv6Slaac>(map['slaacs'], (value) => GetInterfaceVpcIpv6Slaac.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
