...
class GetInterfaceVpcIpv6 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'isPublic': isPublic,
      'ranges': pulumi.Input.mapInputValue<List<GetInterfaceVpcIpv6Range>, List<Map<String, dynamic>>>(ranges, (value) => pulumi.Input.encodeList<GetInterfaceVpcIpv6Range, Map<String, dynamic>>(value, (value) => value.toMap())),
      'slaacs': pulumi.Input.mapInputValue<List<GetInterfaceVpcIpv6Slaac>, List<Map<String, dynamic>>>(slaacs, (value) => pulumi.Input.encodeList<GetInterfaceVpcIpv6Slaac, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory GetInterfaceVpcIpv6.fromMap(Map<String, dynamic> map) {
    return GetInterfaceVpcIpv6(
      ...
      ranges: pulumi.Input.fromValue(pulumi.Input.decodeList<GetInterfaceVpcIpv6Range>(map['ranges']!, (value) => GetInterfaceVpcIpv6Range.fromMap((value as Map).cast<String, dynamic>()))),
      slaacs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetInterfaceVpcIpv6Slaac>(map['slaacs']!, (value) => GetInterfaceVpcIpv6Slaac.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
