...
class GetVolumeTypesResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'orderBy': ?orderBy,
      'types':
          pulumi.Input.encodeList<GetVolumeTypesType, Map<String, dynamic>>(
            types,
            (value) => value.toMap(),
          ),
    };
  ...
  factory GetVolumeTypesResult.fromMap(Map<String, dynamic> map) {
    return GetVolumeTypesResult(
      filters: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<GetVolumeTypesFilter>(
          guardedValue,
      ...
      types: pulumi.Input.decodeList<GetVolumeTypesType>(
        map['types']!,
        (value) =>
            GetVolumeTypesType.fromMap((value as Map).cast<String, dynamic>()),
      ),
    );
  }
}
