...
class GetVolumeTypesResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'filters': ?(() { final guardedValue = filters; if (guardedValue == null) return null; return pulumi.Input.encodeList<GetVolumeTypesFilter, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
      'id': id,
      'order': ?order,
      'orderBy': ?orderBy,
  ...
  factory GetVolumeTypesResult.fromMap(Map<String, dynamic> map) {
    return GetVolumeTypesResult(
      filters: (() { final guardedValue = map['filters']; if (guardedValue == null) return null; return pulumi.Input.decodeList<GetVolumeTypesFilter>(guardedValue, (value) => GetVolumeTypesFilter.fromMap((value as Map).cast<String, dynamic>())); })(),
      id: map['id'] as String,
