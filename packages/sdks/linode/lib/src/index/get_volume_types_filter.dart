...
class GetVolumeTypesFilter {
  ...
  /// Creates a new [GetVolumeTypesFilter].
  ...
  factory GetVolumeTypesFilter.fromMap(Map<String, dynamic> map) {
    return GetVolumeTypesFilter(
