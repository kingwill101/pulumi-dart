...
class GetObjectStorageEndpointsFilter {
  ...
  /// Creates a new [GetObjectStorageEndpointsFilter].
  ...
  const GetObjectStorageEndpointsFilter({
    this.matchBy,
    required this.name,
  ...
  factory GetObjectStorageEndpointsFilter.fromMap(Map<String, dynamic> map) {
    return GetObjectStorageEndpointsFilter(
