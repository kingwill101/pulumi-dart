...
class GetKernelsFilter {
  ...
  /// Creates a new [GetKernelsFilter].
  ...
  GetKernelsFilter({this.matchBy, required this.name, required this.values});
  ...
  factory GetKernelsFilter.fromMap(Map<String, dynamic> map) {
    return GetKernelsFilter(
      matchBy: (() {
