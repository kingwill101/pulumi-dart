...
class GetDatabaseMysqlBackupsResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'filters': ?(() { final guardedValue = filters; if (guardedValue == null) return null; return pulumi.Input.encodeList<GetDatabaseMysqlBackupsFilter, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
      'id': id,
      'latest': ?latest,
      'order': ?order,
      'orderBy': ?orderBy,
  ...
  factory GetDatabaseMysqlBackupsResult.fromMap(Map<String, dynamic> map) {
    return GetDatabaseMysqlBackupsResult(
      ...
      filters: (() { final guardedValue = map['filters']; if (guardedValue == null) return null; return pulumi.Input.decodeList<GetDatabaseMysqlBackupsFilter>(guardedValue, (value) => GetDatabaseMysqlBackupsFilter.fromMap((value as Map).cast<String, dynamic>())); })(),
      id: map['id'] as String,
