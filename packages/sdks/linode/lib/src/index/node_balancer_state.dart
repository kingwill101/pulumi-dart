    ...
    return NodeBalancerState(
      ...
      firewalls: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NodeBalancerFirewall>(
            guardedValue,
            (value) => NodeBalancerFirewall.fromMap(
      ...
      transfers: (() {
        final guardedValue = map['transfers'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NodeBalancerTransfer>(
            guardedValue,
            (value) => NodeBalancerTransfer.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
