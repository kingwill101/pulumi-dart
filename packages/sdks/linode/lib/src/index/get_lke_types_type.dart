...
class GetLkeTypesType {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'regionPrices':
          pulumi.Input.mapInputValue<
            List<GetLkeTypesTypeRegionPrice>,
            List<Map<String, dynamic>>
          >(
            regionPrices,
            (value) =>
  ...
  factory GetLkeTypesType.fromMap(Map<String, dynamic> map) {
    return GetLkeTypesType(
      ...
      prices: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetLkeTypesTypePrice>(
          map['prices']!,
          (value) => GetLkeTypesTypePrice.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      regionPrices: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetLkeTypesTypeRegionPrice>(
          map['regionPrices']!,
          (value) => GetLkeTypesTypeRegionPrice.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
