...
class InstanceConfig {
  ...
  factory InstanceConfig.fromMap(Map<String, dynamic> map) {
    return InstanceConfig(
      ...
      helpers: (() { final guardedValue = map['helpers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceConfigHelpers.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
