...
class InstanceBackup {
  ...
  factory InstanceBackup.fromMap(Map<String, dynamic> map) {
    return InstanceBackup(
      ...
      schedules: (() { final guardedValue = map['schedules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InstanceBackupSchedule>(guardedValue, (value) => InstanceBackupSchedule.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
