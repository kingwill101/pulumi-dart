...
class UserGlobalGrants {
  ...
  factory UserGlobalGrants.fromMap(Map<String, dynamic> map) {
    return UserGlobalGrants(
      ...
      addDatabases: (() { final guardedValue = map['addDatabases']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      addDomains: (() { final guardedValue = map['addDomains']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      addFirewalls: (() { final guardedValue = map['addFirewalls']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      addImages: (() { final guardedValue = map['addImages']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      addLinodes: (() { final guardedValue = map['addLinodes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      addLongview: (() { final guardedValue = map['addLongview']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      addNodebalancers: (() { final guardedValue = map['addNodebalancers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      addStackscripts: (() { final guardedValue = map['addStackscripts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      addVolumes: (() { final guardedValue = map['addVolumes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      addVpcs: (() { final guardedValue = map['addVpcs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      cancelAccount: (() { final guardedValue = map['cancelAccount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      longviewSubscription: (() { final guardedValue = map['longviewSubscription']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
    );
  }
}
