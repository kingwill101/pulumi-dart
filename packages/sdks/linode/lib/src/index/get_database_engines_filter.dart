...
class GetDatabaseEnginesFilter {
  ...
  /// Creates a new [GetDatabaseEnginesFilter].
  ...
  const GetDatabaseEnginesFilter({
    this.matchBy,
    required this.name,
  ...
  factory GetDatabaseEnginesFilter.fromMap(Map<String, dynamic> map) {
    return GetDatabaseEnginesFilter(
