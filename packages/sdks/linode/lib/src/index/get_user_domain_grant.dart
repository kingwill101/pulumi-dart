...
class GetUserDomainGrant {
  ...
  /// Creates a new [GetUserDomainGrant].
  ...
  factory GetUserDomainGrant.fromMap(Map<String, dynamic> map) {
    return GetUserDomainGrant(
