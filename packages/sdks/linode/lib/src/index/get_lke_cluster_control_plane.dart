...
class GetLkeClusterControlPlane {
  ...
  factory GetLkeClusterControlPlane.fromMap(Map<String, dynamic> map) {
    return GetLkeClusterControlPlane(
      acls: pulumi.Input.fromValue(pulumi.Input.decodeList<GetLkeClusterControlPlaneAcl>(map['acls']!, (value) => GetLkeClusterControlPlaneAcl.fromMap((value as Map).cast<String, dynamic>()))),
