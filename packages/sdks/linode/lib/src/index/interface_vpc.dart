...
class InterfaceVpc {
  ...
  factory InterfaceVpc.fromMap(Map<String, dynamic> map) {
    return InterfaceVpc(
      ipv4: (() { final guardedValue = map['ipv4']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InterfaceVpcIpv4.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ipv6: (() { final guardedValue = map['ipv6']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InterfaceVpcIpv6.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
