...
import 'database_postgresql_v2_state.dart';
...
class DatabasePostgresqlV2 extends pulumi.CustomResource {
  ...
  /// Gets an existing [DatabasePostgresqlV2] resource's state with the given [name] and [id].
  static DatabasePostgresqlV2 get(
    String name,
    pulumi.Input<String> id, {
    DatabasePostgresqlV2State? state,
  }) {
    return DatabasePostgresqlV2._get(
      name,
      state: state?.toMap(),
