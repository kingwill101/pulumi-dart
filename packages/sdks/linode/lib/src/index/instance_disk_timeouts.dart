...
class InstanceDiskTimeouts {
  ...
  /// Creates a new [InstanceDiskTimeouts].
  ...
  InstanceDiskTimeouts({this.create, this.delete, this.update});
  ...
  factory InstanceDiskTimeouts.fromMap(Map<String, dynamic> map) {
    return InstanceDiskTimeouts(
      create: (() {
