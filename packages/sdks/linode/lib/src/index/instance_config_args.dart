    ...
    return InstanceConfigArgs(
      ...
      device: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InstanceConfigDevice>(
            guardedValue,
            (value) => InstanceConfigDevice.fromMap(
      ...
      helpers: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InstanceConfigHelper>(
            guardedValue,
            (value) => InstanceConfigHelper.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
