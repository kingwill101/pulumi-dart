...
class GetUserArgs {
  ...
  factory GetUserArgs.fromMap(Map<String, dynamic> map) {
    return GetUserArgs(
      databaseGrants: (() { final guardedValue = map['databaseGrants']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetUserDatabaseGrant>(guardedValue, (value) => GetUserDatabaseGrant.fromMap((value as Map).cast<String, dynamic>()))); })(),
      domainGrants: (() { final guardedValue = map['domainGrants']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetUserDomainGrant>(guardedValue, (value) => GetUserDomainGrant.fromMap((value as Map).cast<String, dynamic>()))); })(),
      firewallGrants: (() { final guardedValue = map['firewallGrants']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetUserFirewallGrant>(guardedValue, (value) => GetUserFirewallGrant.fromMap((value as Map).cast<String, dynamic>()))); })(),
      imageGrants: (() { final guardedValue = map['imageGrants']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetUserImageGrant>(guardedValue, (value) => GetUserImageGrant.fromMap((value as Map).cast<String, dynamic>()))); })(),
      linodeGrants: (() { final guardedValue = map['linodeGrants']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetUserLinodeGrant>(guardedValue, (value) => GetUserLinodeGrant.fromMap((value as Map).cast<String, dynamic>()))); })(),
      longviewGrants: (() { final guardedValue = map['longviewGrants']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetUserLongviewGrant>(guardedValue, (value) => GetUserLongviewGrant.fromMap((value as Map).cast<String, dynamic>()))); })(),
      nodebalancerGrants: (() { final guardedValue = map['nodebalancerGrants']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetUserNodebalancerGrant>(guardedValue, (value) => GetUserNodebalancerGrant.fromMap((value as Map).cast<String, dynamic>()))); })(),
      stackscriptGrants: (() { final guardedValue = map['stackscriptGrants']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetUserStackscriptGrant>(guardedValue, (value) => GetUserStackscriptGrant.fromMap((value as Map).cast<String, dynamic>()))); })(),
      username: pulumi.Input.fromValue(map['username'] as String),
      volumeGrants: (() { final guardedValue = map['volumeGrants']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetUserVolumeGrant>(guardedValue, (value) => GetUserVolumeGrant.fromMap((value as Map).cast<String, dynamic>()))); })(),
      vpcGrants: (() { final guardedValue = map['vpcGrants']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetUserVpcGrant>(guardedValue, (value) => GetUserVpcGrant.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
