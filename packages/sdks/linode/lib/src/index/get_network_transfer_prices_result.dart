  ...
  factory GetNetworkTransferPricesResult.fromMap(Map<String, dynamic> map) {
    return GetNetworkTransferPricesResult(
      filters: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<GetNetworkTransferPricesFilter>(
          guardedValue,
      ...
      types: pulumi.Input.decodeList<GetNetworkTransferPricesType>(
        map['types']!,
        (value) => GetNetworkTransferPricesType.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
    );
