...
class GetInstanceTypeAddon {
  ...
  /// [backups] Required.
  GetInstanceTypeAddon({required this.backups});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'backups':
          pulumi.Input.mapInputValue<
            List<GetInstanceTypeAddonBackup>,
  ...
  factory GetInstanceTypeAddon.fromMap(Map<String, dynamic> map) {
    return GetInstanceTypeAddon(
      backups: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetInstanceTypeAddonBackup>(
          map['backups']!,
          (value) => GetInstanceTypeAddonBackup.fromMap(
