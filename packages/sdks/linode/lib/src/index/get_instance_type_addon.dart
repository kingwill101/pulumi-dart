...
class GetInstanceTypeAddon {
  ...
  factory GetInstanceTypeAddon.fromMap(Map<String, dynamic> map) {
    return GetInstanceTypeAddon(
      backups: pulumi.Input.fromValue(pulumi.Input.decodeList<GetInstanceTypeAddonBackup>(map['backups']!, (value) => GetInstanceTypeAddonBackup.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
