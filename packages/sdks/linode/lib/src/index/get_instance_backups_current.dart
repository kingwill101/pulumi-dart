...
class GetInstanceBackupsCurrent {
  ...
  factory GetInstanceBackupsCurrent.fromMap(Map<String, dynamic> map) {
    return GetInstanceBackupsCurrent(
      ...
      disks: (pulumi.Input.decodeList<GetInstanceBackupsCurrentDisk>(map['disks'], (value) => GetInstanceBackupsCurrentDisk.fromMap((value as Map).cast<String, dynamic>()))).input(),
