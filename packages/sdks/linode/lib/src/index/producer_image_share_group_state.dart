...
class ProducerImageShareGroupState {
  ...
  factory ProducerImageShareGroupState.fromMap(Map<String, dynamic> map) {
    return ProducerImageShareGroupState(
      ...
      isSuspended: (() { final guardedValue = map['isSuspended']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      label: (() { final guardedValue = map['label']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      membersCount: (() { final guardedValue = map['membersCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
