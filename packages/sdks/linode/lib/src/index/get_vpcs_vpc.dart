    ...
    return <String, dynamic>{
      ...
      'ipv6s':
          ...
          >(
            ipv6s,
            (value) =>
                pulumi.Input.encodeList<GetVpcsVpcIpv6, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory GetVpcsVpc.fromMap(Map<String, dynamic> map) {
    return GetVpcsVpc(
      ...
      ipv6s: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetVpcsVpcIpv6>(
          map['ipv6s']!,
          (value) =>
              GetVpcsVpcIpv6.fromMap((value as Map).cast<String, dynamic>()),
        ),
      ),
