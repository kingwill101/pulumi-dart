...
class GetProducerImageShareGroupImageSharesImageShare {
  ...
  final GetProducerImageShareGroupImageSharesImageShareImageSharing imageSharing;
  ...
  factory GetProducerImageShareGroupImageSharesImageShare.fromMap(Map<String, dynamic> map) {
    return GetProducerImageShareGroupImageSharesImageShare(
      ...
      id: map['id'] as String,
      imageSharing: GetProducerImageShareGroupImageSharesImageShareImageSharing.fromMap((map['imageSharing'] as Map).cast<String, dynamic>()),
