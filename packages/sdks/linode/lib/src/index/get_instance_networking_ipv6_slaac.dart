...
class GetInstanceNetworkingIpv6Slaac {
  ...
  final pulumi.Input<GetInstanceNetworkingIpv6SlaacVpcNat11> vpcNat11;
  ...
  const GetInstanceNetworkingIpv6Slaac({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'type': type,
      'vpcNat11': pulumi.Input.mapInputValue<GetInstanceNetworkingIpv6SlaacVpcNat11, Map<String, dynamic>>(vpcNat11, (value) => value.toMap()),
    };
  }
  ...
  factory GetInstanceNetworkingIpv6Slaac.fromMap(Map<String, dynamic> map) {
    return GetInstanceNetworkingIpv6Slaac(
      ...
      vpcNat11: pulumi.Input.fromValue(GetInstanceNetworkingIpv6SlaacVpcNat11.fromMap((map['vpcNat11']! as Map).cast<String, dynamic>())),
    );
  }
}
