...
/// Result data returned by getChildAccount.
class GetChildAccountResult {
  ...
  /// Creates a new [GetChildAccountResult].
  ...
  factory GetChildAccountResult.fromMap(Map<String, dynamic> map) {
