...
class GetInterfaceVpc {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'ipv4':
          pulumi.Input.mapInputValue<GetInterfaceVpcIpv4, Map<String, dynamic>>(
            ipv4,
            (value) => value.toMap(),
          ),
      'ipv6':
          pulumi.Input.mapInputValue<GetInterfaceVpcIpv6, Map<String, dynamic>>(
            ipv6,
            (value) => value.toMap(),
          ),
      'subnetId': subnetId,
  ...
  factory GetInterfaceVpc.fromMap(Map<String, dynamic> map) {
    return GetInterfaceVpc(
      ipv4: pulumi.Input.fromValue(
        GetInterfaceVpcIpv4.fromMap(
          (map['ipv4']! as Map).cast<String, dynamic>(),
        ),
      ),
      ipv6: pulumi.Input.fromValue(
        GetInterfaceVpcIpv6.fromMap(
          (map['ipv6']! as Map).cast<String, dynamic>(),
        ),
      ),
