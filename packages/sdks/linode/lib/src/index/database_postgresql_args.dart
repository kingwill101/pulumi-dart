...
class DatabasePostgresqlArgs {
  ...
  factory DatabasePostgresqlArgs.fromMap(Map<String, dynamic> map) {
    return DatabasePostgresqlArgs(
      ...
      replicationCommitType: (() { final guardedValue = map['replicationCommitType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      updates: (() { final guardedValue = map['updates']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DatabasePostgresqlUpdates.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
