...
class VpcSubnetLinode {
  ...
  VpcSubnetLinode({required this.id, required this.interfaces});
  ...
  factory VpcSubnetLinode.fromMap(Map<String, dynamic> map) {
    return VpcSubnetLinode(
      ...
      interfaces: pulumi.Input.fromValue(
        pulumi.Input.decodeList<VpcSubnetLinodeInterface>(
          map['interfaces']!,
          (value) => VpcSubnetLinodeInterface.fromMap(
