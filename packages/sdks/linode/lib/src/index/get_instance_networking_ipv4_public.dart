...
class GetInstanceNetworkingIpv4Public {
  ...
  const GetInstanceNetworkingIpv4Public({
  ...
  factory GetInstanceNetworkingIpv4Public.fromMap(Map<String, dynamic> map) {
    return GetInstanceNetworkingIpv4Public(
      ...
      vpcNat11: pulumi.Input.fromValue(GetInstanceNetworkingIpv4PublicVpcNat11.fromMap((map['vpcNat11']! as Map).cast<String, dynamic>())),
    );
  }
}
