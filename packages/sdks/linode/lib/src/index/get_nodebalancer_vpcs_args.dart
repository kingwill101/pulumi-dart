...
class GetNodebalancerVpcsArgs {
  ...
  factory GetNodebalancerVpcsArgs.fromMap(Map<String, dynamic> map) {
    return GetNodebalancerVpcsArgs(
      filters: (() { final guardedValue = map['filters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetNodebalancerVpcsFilter>(guardedValue, (value) => GetNodebalancerVpcsFilter.fromMap((value as Map).cast<String, dynamic>()))); })(),
