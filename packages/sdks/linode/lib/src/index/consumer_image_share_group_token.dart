...
import 'consumer_image_share_group_token_state.dart';
...
class ConsumerImageShareGroupToken extends pulumi.CustomResource {
  ...
  static ConsumerImageShareGroupToken get(
    String name,
    pulumi.Input<String> id, {
    ConsumerImageShareGroupTokenState? state,
  }) {
    return ConsumerImageShareGroupToken._get(
      name,
      state: state?.toMap(),
  ...
  ConsumerImageShareGroupToken._get(
    String name, {
