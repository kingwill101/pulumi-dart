...
class GetLkeClustersLkeCluster {
  ...
  const GetLkeClustersLkeCluster({
  ...
  factory GetLkeClustersLkeCluster.fromMap(Map<String, dynamic> map) {
    return GetLkeClustersLkeCluster(
      ...
      controlPlane: pulumi.Input.fromValue(GetLkeClustersLkeClusterControlPlane.fromMap((map['controlPlane']! as Map).cast<String, dynamic>())),
