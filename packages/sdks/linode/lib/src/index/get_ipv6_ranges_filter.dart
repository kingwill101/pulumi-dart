...
class GetIpv6RangesFilter {
  ...
  /// Creates a new [GetIpv6RangesFilter].
  ...
  GetIpv6RangesFilter({this.matchBy, required this.name, required this.values});
  ...
  factory GetIpv6RangesFilter.fromMap(Map<String, dynamic> map) {
    return GetIpv6RangesFilter(
      matchBy: (() {
