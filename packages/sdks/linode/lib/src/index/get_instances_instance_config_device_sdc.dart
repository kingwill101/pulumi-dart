...
class GetInstancesInstanceConfigDeviceSdc {
  ...
  /// Creates a new [GetInstancesInstanceConfigDeviceSdc].
  ...
  factory GetInstancesInstanceConfigDeviceSdc.fromMap(Map<String, dynamic> map) {
    return GetInstancesInstanceConfigDeviceSdc(
