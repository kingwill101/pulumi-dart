    ...
    return <String, dynamic>{
      ...
      'devices':
          ...
          >(
            devices,
            (value) =>
                pulumi.Input.encodeList<FirewallDevice, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      ...
      'inbounds':
          ...
          >(
            inbounds,
            (value) =>
                pulumi.Input.encodeList<FirewallInbound, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      ...
      'outbounds':
          ?pulumi.Input.mapOptionalInputValue<
            List<FirewallOutbound>,
            List<Map<String, dynamic>>
          >(
            outbounds,
            (value) =>
                pulumi.Input.encodeList<FirewallOutbound, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return FirewallState(
      ...
      devices: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FirewallDevice>(
            guardedValue,
            (value) =>
                FirewallDevice.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      disabled: (() {
      ...
      inbounds: (() {
        final guardedValue = map['inbounds'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FirewallInbound>(
            guardedValue,
            (value) =>
                FirewallInbound.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      interfaces: (() {
      ...
      nodebalancers: (() {
        final guardedValue = map['nodebalancers'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<int>());
      })(),
      outboundPolicy: (() {
      ...
      outbounds: (() {
        final guardedValue = map['outbounds'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FirewallOutbound>(
            guardedValue,
            (value) => FirewallOutbound.fromMap(
