...
class GetNodebalancersFilter {
  ...
  /// Creates a new [GetNodebalancersFilter].
  ...
  factory GetNodebalancersFilter.fromMap(Map<String, dynamic> map) {
    return GetNodebalancersFilter(
