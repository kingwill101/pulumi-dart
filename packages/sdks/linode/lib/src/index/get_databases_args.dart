...
class GetDatabasesArgs {
  ...
  factory GetDatabasesArgs.fromMap(Map<String, dynamic> map) {
    return GetDatabasesArgs(
      filters: (() { final guardedValue = map['filters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetDatabasesFilter>(guardedValue, (value) => GetDatabasesFilter.fromMap((value as Map).cast<String, dynamic>()))); })(),
