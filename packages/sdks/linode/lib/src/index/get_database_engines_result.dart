...
class GetDatabaseEnginesResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'filters': ?(() { final guardedValue = filters; if (guardedValue == null) return null; return pulumi.Input.encodeList<GetDatabaseEnginesFilter, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
      'id': id,
      'latest': ?latest,
      'order': ?order,
      'orderBy': ?orderBy,
  ...
  factory GetDatabaseEnginesResult.fromMap(Map<String, dynamic> map) {
    return GetDatabaseEnginesResult(
      ...
      filters: (() { final guardedValue = map['filters']; if (guardedValue == null) return null; return pulumi.Input.decodeList<GetDatabaseEnginesFilter>(guardedValue, (value) => GetDatabaseEnginesFilter.fromMap((value as Map).cast<String, dynamic>())); })(),
      id: map['id'] as String,
