...
class GetMaintenancePoliciesArgs {
  ...
  factory GetMaintenancePoliciesArgs.fromMap(Map<String, dynamic> map) {
    return GetMaintenancePoliciesArgs(
      filters: (() { final guardedValue = map['filters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetMaintenancePoliciesFilter>(guardedValue, (value) => GetMaintenancePoliciesFilter.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
