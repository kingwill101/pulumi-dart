...
class GetConsumerImageShareGroupTokensFilter {
  ...
  /// Creates a new [GetConsumerImageShareGroupTokensFilter].
  ...
  factory GetConsumerImageShareGroupTokensFilter.fromMap(
