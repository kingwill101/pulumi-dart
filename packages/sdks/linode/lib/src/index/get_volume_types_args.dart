...
class GetVolumeTypesArgs {
  ...
  factory GetVolumeTypesArgs.fromMap(Map<String, dynamic> map) {
    return GetVolumeTypesArgs(
      filters: (() { final guardedValue = map['filters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetVolumeTypesFilter>(guardedValue, (value) => GetVolumeTypesFilter.fromMap((value as Map).cast<String, dynamic>()))); })(),
