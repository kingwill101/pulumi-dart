...
class GetUsersUser {
  ...
  factory GetUsersUser.fromMap(Map<String, dynamic> map) {
    return GetUsersUser(
      databaseGrants: (pulumi.Input.decodeList<GetUsersUserDatabaseGrant>(map['databaseGrants'], (value) => GetUsersUserDatabaseGrant.fromMap((value as Map).cast<String, dynamic>()))).input(),
      domainGrants: (pulumi.Input.decodeList<GetUsersUserDomainGrant>(map['domainGrants'], (value) => GetUsersUserDomainGrant.fromMap((value as Map).cast<String, dynamic>()))).input(),
      email: (map['email'] as String).input(),
      firewallGrants: (pulumi.Input.decodeList<GetUsersUserFirewallGrant>(map['firewallGrants'], (value) => GetUsersUserFirewallGrant.fromMap((value as Map).cast<String, dynamic>()))).input(),
      globalGrants: (pulumi.Input.decodeList<GetUsersUserGlobalGrant>(map['globalGrants'], (value) => GetUsersUserGlobalGrant.fromMap((value as Map).cast<String, dynamic>()))).input(),
      id: (map['id'] as String).input(),
      imageGrants: (pulumi.Input.decodeList<GetUsersUserImageGrant>(map['imageGrants'], (value) => GetUsersUserImageGrant.fromMap((value as Map).cast<String, dynamic>()))).input(),
      linodeGrants: (pulumi.Input.decodeList<GetUsersUserLinodeGrant>(map['linodeGrants'], (value) => GetUsersUserLinodeGrant.fromMap((value as Map).cast<String, dynamic>()))).input(),
      longviewGrants: (pulumi.Input.decodeList<GetUsersUserLongviewGrant>(map['longviewGrants'], (value) => GetUsersUserLongviewGrant.fromMap((value as Map).cast<String, dynamic>()))).input(),
      nodebalancerGrants: (pulumi.Input.decodeList<GetUsersUserNodebalancerGrant>(map['nodebalancerGrants'], (value) => GetUsersUserNodebalancerGrant.fromMap((value as Map).cast<String, dynamic>()))).input(),
      passwordCreated: (map['passwordCreated'] as String).input(),
      restricted: (map['restricted'] as bool).input(),
      sshKeys: ((map['sshKeys'] as List).cast<String>()).input(),
      stackscriptGrants: (pulumi.Input.decodeList<GetUsersUserStackscriptGrant>(map['stackscriptGrants'], (value) => GetUsersUserStackscriptGrant.fromMap((value as Map).cast<String, dynamic>()))).input(),
      tfaEnabled: (map['tfaEnabled'] as bool).input(),
      userType: (map['userType'] as String).input(),
      username: (map['username'] as String).input(),
      verifiedPhoneNumber: (map['verifiedPhoneNumber'] as String).input(),
      volumeGrants: (pulumi.Input.decodeList<GetUsersUserVolumeGrant>(map['volumeGrants'], (value) => GetUsersUserVolumeGrant.fromMap((value as Map).cast<String, dynamic>()))).input(),
      vpcGrants: (pulumi.Input.decodeList<GetUsersUserVpcGrant>(map['vpcGrants'], (value) => GetUsersUserVpcGrant.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
