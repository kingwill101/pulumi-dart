...
class GetUsersUser {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'databaseGrants': pulumi.Input.mapInputValue<List<GetUsersUserDatabaseGrant>, List<Map<String, dynamic>>>(databaseGrants, (value) => pulumi.Input.encodeList<GetUsersUserDatabaseGrant, Map<String, dynamic>>(value, (value) => value.toMap())),
      'domainGrants': pulumi.Input.mapInputValue<List<GetUsersUserDomainGrant>, List<Map<String, dynamic>>>(domainGrants, (value) => pulumi.Input.encodeList<GetUsersUserDomainGrant, Map<String, dynamic>>(value, (value) => value.toMap())),
      'email': email,
      'firewallGrants': pulumi.Input.mapInputValue<List<GetUsersUserFirewallGrant>, List<Map<String, dynamic>>>(firewallGrants, (value) => pulumi.Input.encodeList<GetUsersUserFirewallGrant, Map<String, dynamic>>(value, (value) => value.toMap())),
      'globalGrants': pulumi.Input.mapInputValue<List<GetUsersUserGlobalGrant>, List<Map<String, dynamic>>>(globalGrants, (value) => pulumi.Input.encodeList<GetUsersUserGlobalGrant, Map<String, dynamic>>(value, (value) => value.toMap())),
      'id': id,
      'imageGrants': pulumi.Input.mapInputValue<List<GetUsersUserImageGrant>, List<Map<String, dynamic>>>(imageGrants, (value) => pulumi.Input.encodeList<GetUsersUserImageGrant, Map<String, dynamic>>(value, (value) => value.toMap())),
      'linodeGrants': pulumi.Input.mapInputValue<List<GetUsersUserLinodeGrant>, List<Map<String, dynamic>>>(linodeGrants, (value) => pulumi.Input.encodeList<GetUsersUserLinodeGrant, Map<String, dynamic>>(value, (value) => value.toMap())),
      'longviewGrants': pulumi.Input.mapInputValue<List<GetUsersUserLongviewGrant>, List<Map<String, dynamic>>>(longviewGrants, (value) => pulumi.Input.encodeList<GetUsersUserLongviewGrant, Map<String, dynamic>>(value, (value) => value.toMap())),
      'nodebalancerGrants': pulumi.Input.mapInputValue<List<GetUsersUserNodebalancerGrant>, List<Map<String, dynamic>>>(nodebalancerGrants, (value) => pulumi.Input.encodeList<GetUsersUserNodebalancerGrant, Map<String, dynamic>>(value, (value) => value.toMap())),
      'passwordCreated': passwordCreated,
      'restricted': restricted,
      'sshKeys': sshKeys,
      'stackscriptGrants': pulumi.Input.mapInputValue<List<GetUsersUserStackscriptGrant>, List<Map<String, dynamic>>>(stackscriptGrants, (value) => pulumi.Input.encodeList<GetUsersUserStackscriptGrant, Map<String, dynamic>>(value, (value) => value.toMap())),
      'tfaEnabled': tfaEnabled,
      'userType': userType,
      'username': username,
      'verifiedPhoneNumber': verifiedPhoneNumber,
      'volumeGrants': pulumi.Input.mapInputValue<List<GetUsersUserVolumeGrant>, List<Map<String, dynamic>>>(volumeGrants, (value) => pulumi.Input.encodeList<GetUsersUserVolumeGrant, Map<String, dynamic>>(value, (value) => value.toMap())),
      'vpcGrants': pulumi.Input.mapInputValue<List<GetUsersUserVpcGrant>, List<Map<String, dynamic>>>(vpcGrants, (value) => pulumi.Input.encodeList<GetUsersUserVpcGrant, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory GetUsersUser.fromMap(Map<String, dynamic> map) {
    return GetUsersUser(
      databaseGrants: pulumi.Input.fromValue(pulumi.Input.decodeList<GetUsersUserDatabaseGrant>(map['databaseGrants']!, (value) => GetUsersUserDatabaseGrant.fromMap((value as Map).cast<String, dynamic>()))),
      domainGrants: pulumi.Input.fromValue(pulumi.Input.decodeList<GetUsersUserDomainGrant>(map['domainGrants']!, (value) => GetUsersUserDomainGrant.fromMap((value as Map).cast<String, dynamic>()))),
      email: pulumi.Input.fromValue(map['email'] as String),
      firewallGrants: pulumi.Input.fromValue(pulumi.Input.decodeList<GetUsersUserFirewallGrant>(map['firewallGrants']!, (value) => GetUsersUserFirewallGrant.fromMap((value as Map).cast<String, dynamic>()))),
      globalGrants: pulumi.Input.fromValue(pulumi.Input.decodeList<GetUsersUserGlobalGrant>(map['globalGrants']!, (value) => GetUsersUserGlobalGrant.fromMap((value as Map).cast<String, dynamic>()))),
      id: pulumi.Input.fromValue(map['id'] as String),
      imageGrants: pulumi.Input.fromValue(pulumi.Input.decodeList<GetUsersUserImageGrant>(map['imageGrants']!, (value) => GetUsersUserImageGrant.fromMap((value as Map).cast<String, dynamic>()))),
      linodeGrants: pulumi.Input.fromValue(pulumi.Input.decodeList<GetUsersUserLinodeGrant>(map['linodeGrants']!, (value) => GetUsersUserLinodeGrant.fromMap((value as Map).cast<String, dynamic>()))),
      longviewGrants: pulumi.Input.fromValue(pulumi.Input.decodeList<GetUsersUserLongviewGrant>(map['longviewGrants']!, (value) => GetUsersUserLongviewGrant.fromMap((value as Map).cast<String, dynamic>()))),
      nodebalancerGrants: pulumi.Input.fromValue(pulumi.Input.decodeList<GetUsersUserNodebalancerGrant>(map['nodebalancerGrants']!, (value) => GetUsersUserNodebalancerGrant.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      stackscriptGrants: pulumi.Input.fromValue(pulumi.Input.decodeList<GetUsersUserStackscriptGrant>(map['stackscriptGrants']!, (value) => GetUsersUserStackscriptGrant.fromMap((value as Map).cast<String, dynamic>()))),
      tfaEnabled: pulumi.Input.fromValue(map['tfaEnabled'] as bool),
      userType: pulumi.Input.fromValue(map['userType'] as String),
      username: pulumi.Input.fromValue(map['username'] as String),
      verifiedPhoneNumber: pulumi.Input.fromValue(map['verifiedPhoneNumber'] as String),
      volumeGrants: pulumi.Input.fromValue(pulumi.Input.decodeList<GetUsersUserVolumeGrant>(map['volumeGrants']!, (value) => GetUsersUserVolumeGrant.fromMap((value as Map).cast<String, dynamic>()))),
      vpcGrants: pulumi.Input.fromValue(pulumi.Input.decodeList<GetUsersUserVpcGrant>(map['vpcGrants']!, (value) => GetUsersUserVpcGrant.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
