...
class GetNodebalancerVpcsResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'filters': ?(() { final guardedValue = filters; if (guardedValue == null) return null; return pulumi.Input.encodeList<GetNodebalancerVpcsFilter, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
      'id': id,
  ...
  factory GetNodebalancerVpcsResult.fromMap(Map<String, dynamic> map) {
    return GetNodebalancerVpcsResult(
      filters: (() { final guardedValue = map['filters']; if (guardedValue == null) return null; return pulumi.Input.decodeList<GetNodebalancerVpcsFilter>(guardedValue, (value) => GetNodebalancerVpcsFilter.fromMap((value as Map).cast<String, dynamic>())); })(),
      id: map['id'] as String,
