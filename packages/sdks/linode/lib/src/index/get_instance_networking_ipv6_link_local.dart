...
class GetInstanceNetworkingIpv6LinkLocal {
  ...
  final GetInstanceNetworkingIpv6LinkLocalVpcNat11 vpcNat11;
  ...
  factory GetInstanceNetworkingIpv6LinkLocal.fromMap(Map<String, dynamic> map) {
    return GetInstanceNetworkingIpv6LinkLocal(
      ...
      vpcNat11: GetInstanceNetworkingIpv6LinkLocalVpcNat11.fromMap((map['vpcNat11'] as Map).cast<String, dynamic>()),
    );
  }
}
