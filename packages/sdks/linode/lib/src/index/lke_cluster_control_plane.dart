...
class LkeClusterControlPlane {
  ...
  factory LkeClusterControlPlane.fromMap(Map<String, dynamic> map) {
    return LkeClusterControlPlane(
      acl: (() { final guardedValue = map['acl']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LkeClusterControlPlaneAcl.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      highAvailability: (() { final guardedValue = map['highAvailability']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
    );
  }
}
