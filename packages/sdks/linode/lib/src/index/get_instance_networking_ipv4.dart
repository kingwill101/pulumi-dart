...
class GetInstanceNetworkingIpv4 {
    ...
    return <String, dynamic>{
      'privates':
          pulumi.Input.mapInputValue<
            List<GetInstanceNetworkingIpv4Private>,
      ...
      'publics':
          pulumi.Input.mapInputValue<
            List<GetInstanceNetworkingIpv4Public>,
            List<Map<String, dynamic>>
          >(
            publics,
            (value) =>
      ...
      'reserveds':
          pulumi.Input.mapInputValue<
            List<GetInstanceNetworkingIpv4Reserved>,
            List<Map<String, dynamic>>
          >(
            reserveds,
            (value) =>
      ...
      'shareds':
          pulumi.Input.mapInputValue<
            List<GetInstanceNetworkingIpv4Shared>,
            List<Map<String, dynamic>>
          >(
            shareds,
            (value) =>
      ...
      'vpcs':
          pulumi.Input.mapInputValue<
            List<GetInstanceNetworkingIpv4Vpc>,
            List<Map<String, dynamic>>
          >(
            vpcs,
            (value) =>
  ...
  factory GetInstanceNetworkingIpv4.fromMap(Map<String, dynamic> map) {
    return GetInstanceNetworkingIpv4(
      privates: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetInstanceNetworkingIpv4Private>(
          map['privates']!,
          (value) => GetInstanceNetworkingIpv4Private.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      publics: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetInstanceNetworkingIpv4Public>(
          map['publics']!,
          (value) => GetInstanceNetworkingIpv4Public.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      reserveds: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetInstanceNetworkingIpv4Reserved>(
          map['reserveds']!,
          (value) => GetInstanceNetworkingIpv4Reserved.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      shareds: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetInstanceNetworkingIpv4Shared>(
          map['shareds']!,
          (value) => GetInstanceNetworkingIpv4Shared.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      vpcs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetInstanceNetworkingIpv4Vpc>(
          map['vpcs']!,
          (value) => GetInstanceNetworkingIpv4Vpc.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
