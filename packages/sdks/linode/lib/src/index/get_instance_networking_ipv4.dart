...
class GetInstanceNetworkingIpv4 {
  ...
  factory GetInstanceNetworkingIpv4.fromMap(Map<String, dynamic> map) {
    return GetInstanceNetworkingIpv4(
      privates: pulumi.Input.fromValue(pulumi.Input.decodeList<GetInstanceNetworkingIpv4Private>(map['privates']!, (value) => GetInstanceNetworkingIpv4Private.fromMap((value as Map).cast<String, dynamic>()))),
      publics: pulumi.Input.fromValue(pulumi.Input.decodeList<GetInstanceNetworkingIpv4Public>(map['publics']!, (value) => GetInstanceNetworkingIpv4Public.fromMap((value as Map).cast<String, dynamic>()))),
      reserveds: pulumi.Input.fromValue(pulumi.Input.decodeList<GetInstanceNetworkingIpv4Reserved>(map['reserveds']!, (value) => GetInstanceNetworkingIpv4Reserved.fromMap((value as Map).cast<String, dynamic>()))),
      shareds: pulumi.Input.fromValue(pulumi.Input.decodeList<GetInstanceNetworkingIpv4Shared>(map['shareds']!, (value) => GetInstanceNetworkingIpv4Shared.fromMap((value as Map).cast<String, dynamic>()))),
      vpcs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetInstanceNetworkingIpv4Vpc>(map['vpcs']!, (value) => GetInstanceNetworkingIpv4Vpc.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
