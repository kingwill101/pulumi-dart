...
class GetStackScriptsStackscript {
  ...
  final pulumi.Input<List<GetStackScriptsStackscriptUserDefinedField>>
  userDefinedFields;
    ...
    return <String, dynamic>{
      ...
      'userDefinedFields':
          pulumi.Input.mapInputValue<
            List<GetStackScriptsStackscriptUserDefinedField>,
  ...
  factory GetStackScriptsStackscript.fromMap(Map<String, dynamic> map) {
    return GetStackScriptsStackscript(
      ...
      deploymentsActive: pulumi.Input.fromValue(
        map['deploymentsActive'] as int,
      ),
      ...
      userDefinedFields: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetStackScriptsStackscriptUserDefinedField>(
          map['userDefinedFields']!,
          (value) => GetStackScriptsStackscriptUserDefinedField.fromMap(
