...
class GetVpcSubnetsArgs {
  ...
  factory GetVpcSubnetsArgs.fromMap(Map<String, dynamic> map) {
    return GetVpcSubnetsArgs(
      filters: (() { final guardedValue = map['filters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetVpcSubnetsFilter>(guardedValue, (value) => GetVpcSubnetsFilter.fromMap((value as Map).cast<String, dynamic>()))); })(),
