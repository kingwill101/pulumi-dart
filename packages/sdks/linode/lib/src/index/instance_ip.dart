...
class InstanceIp extends pulumi.CustomResource {
  ...
  /// Gets an existing [InstanceIp] resource's state with the given [name] and [id].
  static InstanceIp get(
    String name,
    pulumi.Input<String> id, {
    InstanceIpState? state,
  }) {
    return InstanceIp._get(
      name,
      state: state?.toMap(),
