...
class GetInstancesFilter {
  ...
  /// [name] The name of the field to filter by. See the Filterable Fields section for a list of filterable fields.
  /// [values] A list of values for the filter to allow. These values should all be in string form.
  GetInstancesFilter({this.matchBy, required this.name, required this.values});
