    ...
    return <String, dynamic>{
      ...
      'devices':
          pulumi.Input.mapInputValue<
            List<GetFirewallsFirewallDevice>,
      ...
      'inbounds':
          pulumi.Input.mapInputValue<
            List<GetFirewallsFirewallInbound>,
            List<Map<String, dynamic>>
          >(
            inbounds,
            (value) =>
      ...
      'outbounds':
          pulumi.Input.mapInputValue<
            List<GetFirewallsFirewallOutbound>,
            List<Map<String, dynamic>>
          >(
            outbounds,
            (value) =>
  ...
  factory GetFirewallsFirewall.fromMap(Map<String, dynamic> map) {
    return GetFirewallsFirewall(
      ...
      devices: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetFirewallsFirewallDevice>(
          map['devices']!,
          (value) => GetFirewallsFirewallDevice.fromMap(
      ...
      inbounds: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetFirewallsFirewallInbound>(
          map['inbounds']!,
          (value) => GetFirewallsFirewallInbound.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      interfaces: pulumi.Input.fromValue(
        (map['interfaces'] as List).cast<int>(),
      ),
      label: pulumi.Input.fromValue(map['label'] as String),
      linodes: pulumi.Input.fromValue((map['linodes'] as List).cast<int>()),
      nodebalancers: pulumi.Input.fromValue(
        (map['nodebalancers'] as List).cast<int>(),
      ),
      outboundPolicy: pulumi.Input.fromValue(map['outboundPolicy'] as String),
      outbounds: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetFirewallsFirewallOutbound>(
          map['outbounds']!,
          (value) => GetFirewallsFirewallOutbound.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
