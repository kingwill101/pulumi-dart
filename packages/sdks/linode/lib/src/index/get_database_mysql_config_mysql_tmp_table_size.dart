...
class GetDatabaseMysqlConfigMysqlTmpTableSize {
  ...
  /// Creates a new [GetDatabaseMysqlConfigMysqlTmpTableSize].
  ...
  factory GetDatabaseMysqlConfigMysqlTmpTableSize.fromMap(Map<String, dynamic> map) {
    return GetDatabaseMysqlConfigMysqlTmpTableSize(
