...
class GetUserDatabaseGrant {
  ...
  /// Creates a new [GetUserDatabaseGrant].
  ...
  factory GetUserDatabaseGrant.fromMap(Map<String, dynamic> map) {
    return GetUserDatabaseGrant(
