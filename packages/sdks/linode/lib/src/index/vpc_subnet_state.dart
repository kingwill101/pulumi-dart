...
class VpcSubnetState {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'linodes':
          ?pulumi.Input.mapOptionalInputValue<
            List<VpcSubnetLinode>,
            List<Map<String, dynamic>>
          >(
            linodes,
            (value) =>
                pulumi.Input.encodeList<VpcSubnetLinode, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory VpcSubnetState.fromMap(Map<String, dynamic> map) {
    return VpcSubnetState(
      ...
      linodes: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VpcSubnetLinode>(
            guardedValue,
            (value) =>
                VpcSubnetLinode.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      updated: (() {
