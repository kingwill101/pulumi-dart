...
class GetNetworkingIpsFilter {
  ...
  /// Creates a new [GetNetworkingIpsFilter].
  ...
  factory GetNetworkingIpsFilter.fromMap(Map<String, dynamic> map) {
    return GetNetworkingIpsFilter(
