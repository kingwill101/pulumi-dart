...
class UserDomainGrant {
  ...
  UserDomainGrant({required this.id, required this.permissions});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'id': id, 'permissions': permissions};
  }

  factory UserDomainGrant.fromMap(Map<String, dynamic> map) {
    return UserDomainGrant(
