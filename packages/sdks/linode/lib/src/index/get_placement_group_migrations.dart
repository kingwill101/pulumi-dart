...
class GetPlacementGroupMigrations {
  ...
  factory GetPlacementGroupMigrations.fromMap(Map<String, dynamic> map) {
    return GetPlacementGroupMigrations(
      inbounds: pulumi.Input.fromValue(pulumi.Input.decodeList<GetPlacementGroupMigrationsInbound>(map['inbounds']!, (value) => GetPlacementGroupMigrationsInbound.fromMap((value as Map).cast<String, dynamic>()))),
      outbounds: pulumi.Input.fromValue(pulumi.Input.decodeList<GetPlacementGroupMigrationsOutbound>(map['outbounds']!, (value) => GetPlacementGroupMigrationsOutbound.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
