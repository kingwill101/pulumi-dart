...
class GetProducerImageShareGroupsFilter {
  ...
  /// Creates a new [GetProducerImageShareGroupsFilter].
  ...
  const GetProducerImageShareGroupsFilter({
    this.matchBy,
    required this.name,
  ...
  factory GetProducerImageShareGroupsFilter.fromMap(Map<String, dynamic> map) {
    return GetProducerImageShareGroupsFilter(
