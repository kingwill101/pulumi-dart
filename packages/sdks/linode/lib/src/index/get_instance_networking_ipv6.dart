...
class GetInstanceNetworkingIpv6 {
  ...
  factory GetInstanceNetworkingIpv6.fromMap(Map<String, dynamic> map) {
    return GetInstanceNetworkingIpv6(
      globals: (pulumi.Input.decodeList<GetInstanceNetworkingIpv6Global>(map['globals'], (value) => GetInstanceNetworkingIpv6Global.fromMap((value as Map).cast<String, dynamic>()))).input(),
      linkLocal: (GetInstanceNetworkingIpv6LinkLocal.fromMap((map['linkLocal'] as Map).cast<String, dynamic>())).input(),
      slaac: (GetInstanceNetworkingIpv6Slaac.fromMap((map['slaac'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
