...
class GetInstanceTypesType {
  ...
  factory GetInstanceTypesType.fromMap(Map<String, dynamic> map) {
    return GetInstanceTypesType(
      ...
      addons: pulumi.Input.fromValue(pulumi.Input.decodeList<GetInstanceTypesTypeAddon>(map['addons']!, (value) => GetInstanceTypesTypeAddon.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      prices: pulumi.Input.fromValue(pulumi.Input.decodeList<GetInstanceTypesTypePrice>(map['prices']!, (value) => GetInstanceTypesTypePrice.fromMap((value as Map).cast<String, dynamic>()))),
      regionPrices: pulumi.Input.fromValue(pulumi.Input.decodeList<GetInstanceTypesTypeRegionPrice>(map['regionPrices']!, (value) => GetInstanceTypesTypeRegionPrice.fromMap((value as Map).cast<String, dynamic>()))),
