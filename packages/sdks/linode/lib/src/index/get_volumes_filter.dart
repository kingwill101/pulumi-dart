...
class GetVolumesFilter {
  ...
  /// Creates a new [GetVolumesFilter].
  ...
  GetVolumesFilter({this.matchBy, required this.name, required this.values});
  ...
  factory GetVolumesFilter.fromMap(Map<String, dynamic> map) {
    return GetVolumesFilter(
      matchBy: (() {
