...
class DatabaseMysqlV2State {
  ...
  factory DatabaseMysqlV2State.fromMap(Map<String, dynamic> map) {
    return DatabaseMysqlV2State(
      ...
      pendingUpdates: (() { final guardedValue = map['pendingUpdates']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DatabaseMysqlV2PendingUpdate>(guardedValue, (value) => DatabaseMysqlV2PendingUpdate.fromMap((value as Map).cast<String, dynamic>()))); })(),
