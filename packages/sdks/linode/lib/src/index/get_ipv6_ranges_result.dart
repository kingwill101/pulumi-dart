...
class GetIpv6RangesResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'filters': ?(() { final guardedValue = filters; if (guardedValue == null) return null; return pulumi.Input.encodeList<GetIpv6RangesFilter, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
      'id': id,
  ...
  factory GetIpv6RangesResult.fromMap(Map<String, dynamic> map) {
    return GetIpv6RangesResult(
      filters: (() { final guardedValue = map['filters']; if (guardedValue == null) return null; return pulumi.Input.decodeList<GetIpv6RangesFilter>(guardedValue, (value) => GetIpv6RangesFilter.fromMap((value as Map).cast<String, dynamic>())); })(),
      id: map['id'] as String,
