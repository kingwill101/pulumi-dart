...
class GetNetworkTransferPricesType {
  ...
  factory GetNetworkTransferPricesType.fromMap(Map<String, dynamic> map) {
    return GetNetworkTransferPricesType(
      ...
      prices: (pulumi.Input.decodeList<GetNetworkTransferPricesTypePrice>(map['prices'], (value) => GetNetworkTransferPricesTypePrice.fromMap((value as Map).cast<String, dynamic>()))).input(),
      regionPrices: (pulumi.Input.decodeList<GetNetworkTransferPricesTypeRegionPrice>(map['regionPrices'], (value) => GetNetworkTransferPricesTypeRegionPrice.fromMap((value as Map).cast<String, dynamic>()))).input(),
