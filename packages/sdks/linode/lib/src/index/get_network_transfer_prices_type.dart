...
class GetNetworkTransferPricesType {
  ...
  final pulumi.Input<List<GetNetworkTransferPricesTypeRegionPrice>>
  regionPrices;
    ...
    return <String, dynamic>{
      ...
      'prices':
          pulumi.Input.mapInputValue<
            List<GetNetworkTransferPricesTypePrice>,
      ...
      'regionPrices':
          pulumi.Input.mapInputValue<
            List<GetNetworkTransferPricesTypeRegionPrice>,
            List<Map<String, dynamic>>
          >(
            regionPrices,
            (value) =>
  ...
  factory GetNetworkTransferPricesType.fromMap(Map<String, dynamic> map) {
    return GetNetworkTransferPricesType(
      ...
      prices: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetNetworkTransferPricesTypePrice>(
          map['prices']!,
          (value) => GetNetworkTransferPricesTypePrice.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      regionPrices: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetNetworkTransferPricesTypeRegionPrice>(
          map['regionPrices']!,
          (value) => GetNetworkTransferPricesTypeRegionPrice.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
