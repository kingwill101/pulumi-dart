...
class GetDatabaseMysqlConfigMysqlInteractiveTimeout {
  ...
  /// Creates a new [GetDatabaseMysqlConfigMysqlInteractiveTimeout].
  ...
  /// [type] Required.
  const GetDatabaseMysqlConfigMysqlInteractiveTimeout({
