...
class GetObjectStorageEndpointsArgs {
  ...
  const GetObjectStorageEndpointsArgs({
    this.filters,
    this.order,
    this.orderBy,
  });
  ...
  factory GetObjectStorageEndpointsArgs.fromMap(Map<String, dynamic> map) {
    return GetObjectStorageEndpointsArgs(
      filters: (() { final guardedValue = map['filters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetObjectStorageEndpointsFilter>(guardedValue, (value) => GetObjectStorageEndpointsFilter.fromMap((value as Map).cast<String, dynamic>()))); })(),
