...
class GetInstanceTypeResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'addons':
          pulumi.Input.encodeList<GetInstanceTypeAddon, Map<String, dynamic>>(
            addons,
            (value) => value.toMap(),
          ),
      'class': class_,
      ...
      'prices':
          pulumi.Input.encodeList<GetInstanceTypePrice, Map<String, dynamic>>(
            prices,
            (value) => value.toMap(),
          ),
      'regionPrices':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(regionPrices, (value) => value.toMap()),
      'transfer': transfer,
      'vcpus': vcpus,
    };
  }
  ...
  factory GetInstanceTypeResult.fromMap(Map<String, dynamic> map) {
    return GetInstanceTypeResult(
      ...
      addons: pulumi.Input.decodeList<GetInstanceTypeAddon>(
        map['addons']!,
        (value) => GetInstanceTypeAddon.fromMap(
      ...
      prices: pulumi.Input.decodeList<GetInstanceTypePrice>(
        map['prices']!,
        (value) => GetInstanceTypePrice.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      regionPrices: pulumi.Input.decodeList<GetInstanceTypeRegionPrice>(
        map['regionPrices']!,
        (value) => GetInstanceTypeRegionPrice.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
