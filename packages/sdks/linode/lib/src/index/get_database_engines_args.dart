...
class GetDatabaseEnginesArgs {
  ...
  factory GetDatabaseEnginesArgs.fromMap(Map<String, dynamic> map) {
    return GetDatabaseEnginesArgs(
      filters: (() { final guardedValue = map['filters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetDatabaseEnginesFilter>(guardedValue, (value) => GetDatabaseEnginesFilter.fromMap((value as Map).cast<String, dynamic>()))); })(),
