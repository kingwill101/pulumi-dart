...
class GetInstanceTypeAddonBackup {
  ...
  const GetInstanceTypeAddonBackup({
  ...
  factory GetInstanceTypeAddonBackup.fromMap(Map<String, dynamic> map) {
    return GetInstanceTypeAddonBackup(
      prices: pulumi.Input.fromValue(pulumi.Input.decodeList<GetInstanceTypeAddonBackupPrice>(map['prices']!, (value) => GetInstanceTypeAddonBackupPrice.fromMap((value as Map).cast<String, dynamic>()))),
      regionPrices: pulumi.Input.fromValue(pulumi.Input.decodeList<GetInstanceTypeAddonBackupRegionPrice>(map['regionPrices']!, (value) => GetInstanceTypeAddonBackupRegionPrice.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
