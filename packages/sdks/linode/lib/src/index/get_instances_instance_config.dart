...
class GetInstancesInstanceConfig {
  ...
  factory GetInstancesInstanceConfig.fromMap(Map<String, dynamic> map) {
    return GetInstancesInstanceConfig(
      ...
      devices: pulumi.Input.fromValue(pulumi.Input.decodeList<GetInstancesInstanceConfigDevice>(map['devices']!, (value) => GetInstancesInstanceConfigDevice.fromMap((value as Map).cast<String, dynamic>()))),
      helpers: pulumi.Input.fromValue(pulumi.Input.decodeList<GetInstancesInstanceConfigHelper>(map['helpers']!, (value) => GetInstancesInstanceConfigHelper.fromMap((value as Map).cast<String, dynamic>()))),
      id: pulumi.Input.fromValue(map['id'] as int),
      interfaces: pulumi.Input.fromValue(pulumi.Input.decodeList<GetInstancesInstanceConfigInterface>(map['interfaces']!, (value) => GetInstancesInstanceConfigInterface.fromMap((value as Map).cast<String, dynamic>()))),
