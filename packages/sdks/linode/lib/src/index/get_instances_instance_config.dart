...
class GetInstancesInstanceConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'comments': comments,
      'devices': pulumi.Input.mapInputValue<List<GetInstancesInstanceConfigDevice>, List<Map<String, dynamic>>>(devices, (value) => pulumi.Input.encodeList<GetInstancesInstanceConfigDevice, Map<String, dynamic>>(value, (value) => value.toMap())),
      'helpers': pulumi.Input.mapInputValue<List<GetInstancesInstanceConfigHelper>, List<Map<String, dynamic>>>(helpers, (value) => pulumi.Input.encodeList<GetInstancesInstanceConfigHelper, Map<String, dynamic>>(value, (value) => value.toMap())),
      'id': id,
      'interfaces': pulumi.Input.mapInputValue<List<GetInstancesInstanceConfigInterface>, List<Map<String, dynamic>>>(interfaces, (value) => pulumi.Input.encodeList<GetInstancesInstanceConfigInterface, Map<String, dynamic>>(value, (value) => value.toMap())),
      'kernel': kernel,
      'label': label,
  ...
  factory GetInstancesInstanceConfig.fromMap(Map<String, dynamic> map) {
    return GetInstancesInstanceConfig(
      ...
      devices: (pulumi.Input.decodeList<GetInstancesInstanceConfigDevice>(map['devices'], (value) => GetInstancesInstanceConfigDevice.fromMap((value as Map).cast<String, dynamic>()))).input(),
      helpers: (pulumi.Input.decodeList<GetInstancesInstanceConfigHelper>(map['helpers'], (value) => GetInstancesInstanceConfigHelper.fromMap((value as Map).cast<String, dynamic>()))).input(),
      id: (map['id'] as int).input(),
      interfaces: (pulumi.Input.decodeList<GetInstancesInstanceConfigInterface>(map['interfaces'], (value) => GetInstancesInstanceConfigInterface.fromMap((value as Map).cast<String, dynamic>()))).input(),
      kernel: (map['kernel'] as String).input(),
      label: (map['label'] as String).input(),
      memoryLimit: (map['memoryLimit'] as int).input(),
      rootDevice: (map['rootDevice'] as String).input(),
      runLevel: (map['runLevel'] as String).input(),
      virtMode: (map['virtMode'] as String).input(),
    );
  }
}
