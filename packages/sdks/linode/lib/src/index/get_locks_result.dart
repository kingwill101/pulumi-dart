  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'filters': ?(() {
        ...
        return pulumi.Input.encodeList<GetLocksFilter, Map<String, dynamic>>(
          guardedValue,
          (value) => value.toMap(),
        );
      })(),
      'id': id,
      'locks': pulumi.Input.encodeList<GetLocksLock, Map<String, dynamic>>(
        locks,
        (value) => value.toMap(),
      ),
      'order': ?order,
  ...
  factory GetLocksResult.fromMap(Map<String, dynamic> map) {
    return GetLocksResult(
      filters: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<GetLocksFilter>(
          guardedValue,
          (value) =>
              GetLocksFilter.fromMap((value as Map).cast<String, dynamic>()),
        );
      })(),
      id: map['id'] as String,
      locks: pulumi.Input.decodeList<GetLocksLock>(
        map['locks']!,
        (value) => GetLocksLock.fromMap((value as Map).cast<String, dynamic>()),
      ),
      order: (() {
