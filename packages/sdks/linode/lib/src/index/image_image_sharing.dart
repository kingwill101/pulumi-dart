...
class ImageImageSharing {
  ...
  factory ImageImageSharing.fromMap(Map<String, dynamic> map) {
    return ImageImageSharing(
      sharedBy: (() { final guardedValue = map['sharedBy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ImageImageSharingSharedBy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      sharedWith: (() { final guardedValue = map['sharedWith']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ImageImageSharingSharedWith.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
