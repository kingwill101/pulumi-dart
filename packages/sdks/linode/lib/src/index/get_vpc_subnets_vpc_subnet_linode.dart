...
class GetVpcSubnetsVpcSubnetLinode {
  ...
  GetVpcSubnetsVpcSubnetLinode({required this.id, required this.interfaces});
    ...
    return <String, dynamic>{
      ...
      'interfaces':
          pulumi.Input.mapInputValue<
            List<GetVpcSubnetsVpcSubnetLinodeInterface>,
  ...
  factory GetVpcSubnetsVpcSubnetLinode.fromMap(Map<String, dynamic> map) {
    return GetVpcSubnetsVpcSubnetLinode(
      ...
      interfaces: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetVpcSubnetsVpcSubnetLinodeInterface>(
          map['interfaces']!,
          (value) => GetVpcSubnetsVpcSubnetLinodeInterface.fromMap(
