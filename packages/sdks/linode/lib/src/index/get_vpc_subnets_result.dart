...
class GetVpcSubnetsResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'filters': ?(() { final guardedValue = filters; if (guardedValue == null) return null; return pulumi.Input.encodeList<GetVpcSubnetsFilter, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
      'id': id,
      'vpcId': vpcId,
  ...
  factory GetVpcSubnetsResult.fromMap(Map<String, dynamic> map) {
    return GetVpcSubnetsResult(
      filters: (() { final guardedValue = map['filters']; if (guardedValue == null) return null; return pulumi.Input.decodeList<GetVpcSubnetsFilter>(guardedValue, (value) => GetVpcSubnetsFilter.fromMap((value as Map).cast<String, dynamic>())); })(),
      id: map['id'] as String,
