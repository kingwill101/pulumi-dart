...
class GetInstanceNetworkingIpv4Shared {
  ...
  final pulumi.Input<GetInstanceNetworkingIpv4SharedVpcNat11> vpcNat11;
  ...
  const GetInstanceNetworkingIpv4Shared({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'type': type,
      'vpcNat11': pulumi.Input.mapInputValue<GetInstanceNetworkingIpv4SharedVpcNat11, Map<String, dynamic>>(vpcNat11, (value) => value.toMap()),
    };
  }
  ...
  factory GetInstanceNetworkingIpv4Shared.fromMap(Map<String, dynamic> map) {
    return GetInstanceNetworkingIpv4Shared(
      ...
      vpcNat11: pulumi.Input.fromValue(GetInstanceNetworkingIpv4SharedVpcNat11.fromMap((map['vpcNat11']! as Map).cast<String, dynamic>())),
    );
  }
}
