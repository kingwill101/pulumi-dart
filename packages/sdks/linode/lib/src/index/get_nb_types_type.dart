...
class GetNbTypesType {
  ...
  factory GetNbTypesType.fromMap(Map<String, dynamic> map) {
    return GetNbTypesType(
      ...
      prices: pulumi.Input.fromValue(pulumi.Input.decodeList<GetNbTypesTypePrice>(map['prices']!, (value) => GetNbTypesTypePrice.fromMap((value as Map).cast<String, dynamic>()))),
      regionPrices: pulumi.Input.fromValue(pulumi.Input.decodeList<GetNbTypesTypeRegionPrice>(map['regionPrices']!, (value) => GetNbTypesTypeRegionPrice.fromMap((value as Map).cast<String, dynamic>()))),
