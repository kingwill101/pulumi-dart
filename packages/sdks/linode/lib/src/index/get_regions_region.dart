...
class GetRegionsRegion {
  ...
  final pulumi.Input<List<GetRegionsRegionPlacementGroupLimit>>
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'placementGroupLimits':
          pulumi.Input.mapInputValue<
            List<GetRegionsRegionPlacementGroupLimit>,
  ...
  factory GetRegionsRegion.fromMap(Map<String, dynamic> map) {
    return GetRegionsRegion(
      ...
      monitors: pulumi.Input.fromValue(
        GetRegionsRegionMonitors.fromMap(
          (map['monitors']! as Map).cast<String, dynamic>(),
        ),
      ),
      placementGroupLimits: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetRegionsRegionPlacementGroupLimit>(
          map['placementGroupLimits']!,
          (value) => GetRegionsRegionPlacementGroupLimit.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      resolvers: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetRegionsRegionResolver>(
          map['resolvers']!,
          (value) => GetRegionsRegionResolver.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
