...
class InterfacePublicIpv4 {
  ...
  final pulumi.Input<List<InterfacePublicIpv4AssignedAddress>>?
  assignedAddresses;
  ...
  InterfacePublicIpv4({this.addresses, this.assignedAddresses, this.shareds});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'addresses':
          ?pulumi.Input.mapOptionalInputValue<
            List<InterfacePublicIpv4Address>,
      ...
      'assignedAddresses':
          ?pulumi.Input.mapOptionalInputValue<
            List<InterfacePublicIpv4AssignedAddress>,
            List<Map<String, dynamic>>
          >(
            assignedAddresses,
            (value) =>
      ...
      'shareds':
          ?pulumi.Input.mapOptionalInputValue<
            List<InterfacePublicIpv4Shared>,
            List<Map<String, dynamic>>
          >(
            shareds,
            (value) =>
    ...
    return InterfacePublicIpv4(
      addresses: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InterfacePublicIpv4Address>(
            guardedValue,
            (value) => InterfacePublicIpv4Address.fromMap(
      ...
      assignedAddresses: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InterfacePublicIpv4AssignedAddress>(
            guardedValue,
            (value) => InterfacePublicIpv4AssignedAddress.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      shareds: (() {
        final guardedValue = map['shareds'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InterfacePublicIpv4Shared>(
            guardedValue,
            (value) => InterfacePublicIpv4Shared.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
