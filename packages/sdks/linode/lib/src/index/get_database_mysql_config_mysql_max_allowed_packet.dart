...
class GetDatabaseMysqlConfigMysqlMaxAllowedPacket {
  ...
  /// Creates a new [GetDatabaseMysqlConfigMysqlMaxAllowedPacket].
  ...
  factory GetDatabaseMysqlConfigMysqlMaxAllowedPacket.fromMap(Map<String, dynamic> map) {
    return GetDatabaseMysqlConfigMysqlMaxAllowedPacket(
