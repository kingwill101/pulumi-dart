...
class GetUserStackscriptGrant {
  ...
  /// Creates a new [GetUserStackscriptGrant].
  ...
  factory GetUserStackscriptGrant.fromMap(Map<String, dynamic> map) {
    return GetUserStackscriptGrant(
