...
class GetVpcSubnetsVpcSubnet {
    ...
    return <String, dynamic>{
      ...
      'ipv6s':
          pulumi.Input.mapInputValue<
            List<GetVpcSubnetsVpcSubnetIpv6>,
      ...
      'linodes':
          pulumi.Input.mapInputValue<
            List<GetVpcSubnetsVpcSubnetLinode>,
            List<Map<String, dynamic>>
          >(
            linodes,
            (value) =>
  ...
  factory GetVpcSubnetsVpcSubnet.fromMap(Map<String, dynamic> map) {
    return GetVpcSubnetsVpcSubnet(
      ...
      ipv6s: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetVpcSubnetsVpcSubnetIpv6>(
          map['ipv6s']!,
          (value) => GetVpcSubnetsVpcSubnetIpv6.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      label: pulumi.Input.fromValue(map['label'] as String),
      linodes: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetVpcSubnetsVpcSubnetLinode>(
          map['linodes']!,
          (value) => GetVpcSubnetsVpcSubnetLinode.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
