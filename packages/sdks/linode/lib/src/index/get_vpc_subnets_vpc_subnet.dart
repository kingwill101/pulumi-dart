...
class GetVpcSubnetsVpcSubnet {
  ...
  factory GetVpcSubnetsVpcSubnet.fromMap(Map<String, dynamic> map) {
    return GetVpcSubnetsVpcSubnet(
      ...
      ipv6s: (pulumi.Input.decodeList<GetVpcSubnetsVpcSubnetIpv6>(map['ipv6s'], (value) => GetVpcSubnetsVpcSubnetIpv6.fromMap((value as Map).cast<String, dynamic>()))).input(),
      label: (map['label'] as String).input(),
      linodes: (pulumi.Input.decodeList<GetVpcSubnetsVpcSubnetLinode>(map['linodes'], (value) => GetVpcSubnetsVpcSubnetLinode.fromMap((value as Map).cast<String, dynamic>()))).input(),
