...
class GetNetworkTransferPricesArgs {
  ...
  GetNetworkTransferPricesArgs({
    pulumi.Output<List<GetNetworkTransferPricesFilter>>? filters,
  ...
  factory GetNetworkTransferPricesArgs.fromMap(Map<String, dynamic> map) {
    return GetNetworkTransferPricesArgs(
      filters: map['filters'] == null ? null : pulumi.Output.create<List<GetNetworkTransferPricesFilter>>(pulumi.Input.decodeList<GetNetworkTransferPricesFilter>(map['filters'], (value) => GetNetworkTransferPricesFilter.fromMap((value as Map).cast<String, dynamic>()))),
