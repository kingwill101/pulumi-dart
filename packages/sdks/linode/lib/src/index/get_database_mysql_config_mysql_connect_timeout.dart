...
class GetDatabaseMysqlConfigMysqlConnectTimeout {
  ...
  /// Creates a new [GetDatabaseMysqlConfigMysqlConnectTimeout].
  ...
  factory GetDatabaseMysqlConfigMysqlConnectTimeout.fromMap(Map<String, dynamic> map) {
    return GetDatabaseMysqlConfigMysqlConnectTimeout(
