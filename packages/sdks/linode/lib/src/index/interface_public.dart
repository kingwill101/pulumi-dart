...
class InterfacePublic {
  ...
  factory InterfacePublic.fromMap(Map<String, dynamic> map) {
    return InterfacePublic(
      ipv4: (() { final guardedValue = map['ipv4']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InterfacePublicIpv4.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ipv6: (() { final guardedValue = map['ipv6']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InterfacePublicIpv6.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
