...
class GetDatabasePostgresqlConfigResult {
  final String id;
  final List<GetDatabasePostgresqlConfigPgStatMonitorEnable>
  pgStatMonitorEnables;
  final List<GetDatabasePostgresqlConfigPglookout> pglookouts;
  final List<GetDatabasePostgresqlConfigSharedBuffersPercentage>
  sharedBuffersPercentages;
    ...
    return <String, dynamic>{
      ...
      'pgStatMonitorEnables':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(pgStatMonitorEnables, (value) => value.toMap()),
      'pglookouts':
          pulumi.Input.encodeList<
            GetDatabasePostgresqlConfigPglookout,
            Map<String, dynamic>
          >(pglookouts, (value) => value.toMap()),
      'sharedBuffersPercentages':
          pulumi.Input.encodeList<
            GetDatabasePostgresqlConfigSharedBuffersPercentage,
            Map<String, dynamic>
          >(sharedBuffersPercentages, (value) => value.toMap()),
      'workMems':
          pulumi.Input.encodeList<
            GetDatabasePostgresqlConfigWorkMem,
            Map<String, dynamic>
          >(workMems, (value) => value.toMap()),
    };
  }
  ...
  factory GetDatabasePostgresqlConfigResult.fromMap(Map<String, dynamic> map) {
    return GetDatabasePostgresqlConfigResult(
      ...
      pgStatMonitorEnables:
          pulumi
              .Input.decodeList<GetDatabasePostgresqlConfigPgStatMonitorEnable>(
            map['pgStatMonitorEnables']!,
            (value) => GetDatabasePostgresqlConfigPgStatMonitorEnable.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      pglookouts: pulumi.Input.decodeList<GetDatabasePostgresqlConfigPglookout>(
        map['pglookouts']!,
        (value) => GetDatabasePostgresqlConfigPglookout.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      sharedBuffersPercentages:
          pulumi.Input.decodeList<
            GetDatabasePostgresqlConfigSharedBuffersPercentage
          >(
            map['sharedBuffersPercentages']!,
            (value) =>
                GetDatabasePostgresqlConfigSharedBuffersPercentage.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
      workMems: pulumi.Input.decodeList<GetDatabasePostgresqlConfigWorkMem>(
        map['workMems']!,
        (value) => GetDatabasePostgresqlConfigWorkMem.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
    );
