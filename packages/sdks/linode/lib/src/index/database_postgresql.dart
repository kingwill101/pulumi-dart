...
import 'database_postgresql_state.dart';
...
class DatabasePostgresql extends pulumi.CustomResource {
  ...
  DatabasePostgresql(
    ...
    hostPrimary = registerOutput<String>('hostPrimary');
    hostSecondary = registerOutput<String>('hostSecondary');
    label = registerOutput<String>('label');
    port = registerOutput<int>('port');
    region = registerOutput<String>('region');
    replicationCommitType = registerOutput<String?>('replicationCommitType');
    ...
    updates = registerOutput<DatabasePostgresqlUpdates>('updates', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return DatabasePostgresqlUpdates.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    version = registerOutput<String>('version');
  }

  /// Gets an existing [DatabasePostgresql] resource's state with the given [name] and [id].
  static DatabasePostgresql get(
    String name,
    pulumi.Input<String> id, {
    DatabasePostgresqlState? state,
  }) {
    return DatabasePostgresql._get(
      name,
      state: state?.toMap(),
