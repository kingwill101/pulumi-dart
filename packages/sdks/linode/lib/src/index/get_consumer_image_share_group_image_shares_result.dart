...
class GetConsumerImageShareGroupImageSharesResult {
  ...
  factory GetConsumerImageShareGroupImageSharesResult.fromMap(
    ...
    return GetConsumerImageShareGroupImageSharesResult(
      filters: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi
            .Input.decodeList<GetConsumerImageShareGroupImageSharesFilter>(
          guardedValue,
      ...
      imageShares: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi
            .Input.decodeList<GetConsumerImageShareGroupImageSharesImageShare>(
          guardedValue,
