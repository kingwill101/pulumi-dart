...
class GetImageResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'label': label,
      'replications':
          pulumi.Input.encodeList<GetImageReplication, Map<String, dynamic>>(
            replications,
            (value) => value.toMap(),
          ),
      'size': size,
  ...
  factory GetImageResult.fromMap(Map<String, dynamic> map) {
    return GetImageResult(
      ...
      id: map['id'] as String,
      imageSharing: GetImageImageSharing.fromMap(
        (map['imageSharing']! as Map).cast<String, dynamic>(),
      ),
      isPublic: map['isPublic'] as bool,
      isShared: map['isShared'] as bool,
      label: map['label'] as String,
      replications: pulumi.Input.decodeList<GetImageReplication>(
        map['replications']!,
        (value) =>
            GetImageReplication.fromMap((value as Map).cast<String, dynamic>()),
      ),
