...
class GetAccountAvailabilitiesResult {
    ...
    return <String, dynamic>{
      'availabilities':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(availabilities, (value) => value.toMap()),
      'filters': ?(() {
  ...
  factory GetAccountAvailabilitiesResult.fromMap(Map<String, dynamic> map) {
    return GetAccountAvailabilitiesResult(
      availabilities:
          pulumi.Input.decodeList<GetAccountAvailabilitiesAvailability>(
            map['availabilities']!,
            (value) => GetAccountAvailabilitiesAvailability.fromMap(
      ...
      filters: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<GetAccountAvailabilitiesFilter>(
          guardedValue,
          (value) => GetAccountAvailabilitiesFilter.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        );
      })(),
