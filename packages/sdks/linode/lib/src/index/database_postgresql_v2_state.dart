...
class DatabasePostgresqlV2State {
  ...
  factory DatabasePostgresqlV2State.fromMap(Map<String, dynamic> map) {
    return DatabasePostgresqlV2State(
      ...
      engineConfigPgAutovacuumAnalyzeScaleFactor: map['engineConfigPgAutovacuumAnalyzeScaleFactor'] == null ? null : (map['engineConfigPgAutovacuumAnalyzeScaleFactor'] as double).input(),
      engineConfigPgAutovacuumAnalyzeThreshold: map['engineConfigPgAutovacuumAnalyzeThreshold'] == null ? null : (map['engineConfigPgAutovacuumAnalyzeThreshold'] as int).input(),
      engineConfigPgAutovacuumMaxWorkers: map['engineConfigPgAutovacuumMaxWorkers'] == null ? null : (map['engineConfigPgAutovacuumMaxWorkers'] as int).input(),
      engineConfigPgAutovacuumNaptime: map['engineConfigPgAutovacuumNaptime'] == null ? null : (map['engineConfigPgAutovacuumNaptime'] as int).input(),
      engineConfigPgAutovacuumVacuumCostDelay: map['engineConfigPgAutovacuumVacuumCostDelay'] == null ? null : (map['engineConfigPgAutovacuumVacuumCostDelay'] as int).input(),
      engineConfigPgAutovacuumVacuumCostLimit: map['engineConfigPgAutovacuumVacuumCostLimit'] == null ? null : (map['engineConfigPgAutovacuumVacuumCostLimit'] as int).input(),
      engineConfigPgAutovacuumVacuumScaleFactor: map['engineConfigPgAutovacuumVacuumScaleFactor'] == null ? null : (map['engineConfigPgAutovacuumVacuumScaleFactor'] as double).input(),
      engineConfigPgAutovacuumVacuumThreshold: map['engineConfigPgAutovacuumVacuumThreshold'] == null ? null : (map['engineConfigPgAutovacuumVacuumThreshold'] as int).input(),
      engineConfigPgBgwriterDelay: map['engineConfigPgBgwriterDelay'] == null ? null : (map['engineConfigPgBgwriterDelay'] as int).input(),
      engineConfigPgBgwriterFlushAfter: map['engineConfigPgBgwriterFlushAfter'] == null ? null : (map['engineConfigPgBgwriterFlushAfter'] as int).input(),
      engineConfigPgBgwriterLruMaxpages: map['engineConfigPgBgwriterLruMaxpages'] == null ? null : (map['engineConfigPgBgwriterLruMaxpages'] as int).input(),
      engineConfigPgBgwriterLruMultiplier: map['engineConfigPgBgwriterLruMultiplier'] == null ? null : (map['engineConfigPgBgwriterLruMultiplier'] as double).input(),
      engineConfigPgDeadlockTimeout: map['engineConfigPgDeadlockTimeout'] == null ? null : (map['engineConfigPgDeadlockTimeout'] as int).input(),
      engineConfigPgDefaultToastCompression: map['engineConfigPgDefaultToastCompression'] == null ? null : (map['engineConfigPgDefaultToastCompression'] as String).input(),
      engineConfigPgIdleInTransactionSessionTimeout: map['engineConfigPgIdleInTransactionSessionTimeout'] == null ? null : (map['engineConfigPgIdleInTransactionSessionTimeout'] as int).input(),
      engineConfigPgJit: map['engineConfigPgJit'] == null ? null : (map['engineConfigPgJit'] as bool).input(),
      engineConfigPgMaxFilesPerProcess: map['engineConfigPgMaxFilesPerProcess'] == null ? null : (map['engineConfigPgMaxFilesPerProcess'] as int).input(),
      engineConfigPgMaxLocksPerTransaction: map['engineConfigPgMaxLocksPerTransaction'] == null ? null : (map['engineConfigPgMaxLocksPerTransaction'] as int).input(),
      engineConfigPgMaxLogicalReplicationWorkers: map['engineConfigPgMaxLogicalReplicationWorkers'] == null ? null : (map['engineConfigPgMaxLogicalReplicationWorkers'] as int).input(),
      engineConfigPgMaxParallelWorkers: map['engineConfigPgMaxParallelWorkers'] == null ? null : (map['engineConfigPgMaxParallelWorkers'] as int).input(),
      engineConfigPgMaxParallelWorkersPerGather: map['engineConfigPgMaxParallelWorkersPerGather'] == null ? null : (map['engineConfigPgMaxParallelWorkersPerGather'] as int).input(),
      engineConfigPgMaxPredLocksPerTransaction: map['engineConfigPgMaxPredLocksPerTransaction'] == null ? null : (map['engineConfigPgMaxPredLocksPerTransaction'] as int).input(),
      engineConfigPgMaxReplicationSlots: map['engineConfigPgMaxReplicationSlots'] == null ? null : (map['engineConfigPgMaxReplicationSlots'] as int).input(),
      engineConfigPgMaxSlotWalKeepSize: map['engineConfigPgMaxSlotWalKeepSize'] == null ? null : (map['engineConfigPgMaxSlotWalKeepSize'] as int).input(),
      engineConfigPgMaxStackDepth: map['engineConfigPgMaxStackDepth'] == null ? null : (map['engineConfigPgMaxStackDepth'] as int).input(),
      engineConfigPgMaxStandbyArchiveDelay: map['engineConfigPgMaxStandbyArchiveDelay'] == null ? null : (map['engineConfigPgMaxStandbyArchiveDelay'] as int).input(),
      engineConfigPgMaxStandbyStreamingDelay: map['engineConfigPgMaxStandbyStreamingDelay'] == null ? null : (map['engineConfigPgMaxStandbyStreamingDelay'] as int).input(),
      engineConfigPgMaxWalSenders: map['engineConfigPgMaxWalSenders'] == null ? null : (map['engineConfigPgMaxWalSenders'] as int).input(),
      engineConfigPgMaxWorkerProcesses: map['engineConfigPgMaxWorkerProcesses'] == null ? null : (map['engineConfigPgMaxWorkerProcesses'] as int).input(),
      engineConfigPgPasswordEncryption: map['engineConfigPgPasswordEncryption'] == null ? null : (map['engineConfigPgPasswordEncryption'] as String).input(),
      engineConfigPgPgPartmanBgwInterval: map['engineConfigPgPgPartmanBgwInterval'] == null ? null : (map['engineConfigPgPgPartmanBgwInterval'] as int).input(),
      engineConfigPgPgPartmanBgwRole: map['engineConfigPgPgPartmanBgwRole'] == null ? null : (map['engineConfigPgPgPartmanBgwRole'] as String).input(),
      engineConfigPgPgStatMonitorPgsmEnableQueryPlan: map['engineConfigPgPgStatMonitorPgsmEnableQueryPlan'] == null ? null : (map['engineConfigPgPgStatMonitorPgsmEnableQueryPlan'] as bool).input(),
      engineConfigPgPgStatMonitorPgsmMaxBuckets: map['engineConfigPgPgStatMonitorPgsmMaxBuckets'] == null ? null : (map['engineConfigPgPgStatMonitorPgsmMaxBuckets'] as int).input(),
      engineConfigPgPgStatStatementsTrack: map['engineConfigPgPgStatStatementsTrack'] == null ? null : (map['engineConfigPgPgStatStatementsTrack'] as String).input(),
      engineConfigPgStatMonitorEnable: map['engineConfigPgStatMonitorEnable'] == null ? null : (map['engineConfigPgStatMonitorEnable'] as bool).input(),
      engineConfigPgTempFileLimit: map['engineConfigPgTempFileLimit'] == null ? null : (map['engineConfigPgTempFileLimit'] as int).input(),
      engineConfigPgTimezone: map['engineConfigPgTimezone'] == null ? null : (map['engineConfigPgTimezone'] as String).input(),
      engineConfigPgTrackActivityQuerySize: map['engineConfigPgTrackActivityQuerySize'] == null ? null : (map['engineConfigPgTrackActivityQuerySize'] as int).input(),
      engineConfigPgTrackCommitTimestamp: map['engineConfigPgTrackCommitTimestamp'] == null ? null : (map['engineConfigPgTrackCommitTimestamp'] as String).input(),
      engineConfigPgTrackFunctions: map['engineConfigPgTrackFunctions'] == null ? null : (map['engineConfigPgTrackFunctions'] as String).input(),
      engineConfigPgTrackIoTiming: map['engineConfigPgTrackIoTiming'] == null ? null : (map['engineConfigPgTrackIoTiming'] as String).input(),
      engineConfigPgWalSenderTimeout: map['engineConfigPgWalSenderTimeout'] == null ? null : (map['engineConfigPgWalSenderTimeout'] as int).input(),
      engineConfigPgWalWriterDelay: map['engineConfigPgWalWriterDelay'] == null ? null : (map['engineConfigPgWalWriterDelay'] as int).input(),
      engineConfigPglookoutMaxFailoverReplicationTimeLag: map['engineConfigPglookoutMaxFailoverReplicationTimeLag'] == null ? null : (map['engineConfigPglookoutMaxFailoverReplicationTimeLag'] as int).input(),
      engineConfigSharedBuffersPercentage: map['engineConfigSharedBuffersPercentage'] == null ? null : (map['engineConfigSharedBuffersPercentage'] as double).input(),
      engineConfigWorkMem: map['engineConfigWorkMem'] == null ? null : (map['engineConfigWorkMem'] as int).input(),
      ...
      pendingUpdates: map['pendingUpdates'] == null ? null : (pulumi.Input.decodeList<DatabasePostgresqlV2PendingUpdate>(map['pendingUpdates'], (value) => DatabasePostgresqlV2PendingUpdate.fromMap((value as Map).cast<String, dynamic>()))).input(),
      platform: map['platform'] == null ? null : (map['platform'] as String).input(),
      port: map['port'] == null ? null : (map['port'] as int).input(),
      privateNetwork: map['privateNetwork'] == null ? null : (DatabasePostgresqlV2PrivateNetwork.fromMap((map['privateNetwork'] as Map).cast<String, dynamic>())).input(),
      ...
      timeouts: map['timeouts'] == null ? null : (DatabasePostgresqlV2Timeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>())).input(),
      type: map['type'] == null ? null : (map['type'] as String).input(),
      updated: map['updated'] == null ? null : (map['updated'] as String).input(),
      updates: map['updates'] == null ? null : (DatabasePostgresqlV2Updates.fromMap((map['updates'] as Map).cast<String, dynamic>())).input(),
