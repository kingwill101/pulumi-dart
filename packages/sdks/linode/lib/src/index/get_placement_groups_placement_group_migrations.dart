...
class GetPlacementGroupsPlacementGroupMigrations {
  ...
  factory GetPlacementGroupsPlacementGroupMigrations.fromMap(Map<String, dynamic> map) {
    return GetPlacementGroupsPlacementGroupMigrations(
      inbounds: (pulumi.Input.decodeList<GetPlacementGroupsPlacementGroupMigrationsInbound>(map['inbounds'], (value) => GetPlacementGroupsPlacementGroupMigrationsInbound.fromMap((value as Map).cast<String, dynamic>()))).input(),
      outbounds: (pulumi.Input.decodeList<GetPlacementGroupsPlacementGroupMigrationsOutbound>(map['outbounds'], (value) => GetPlacementGroupsPlacementGroupMigrationsOutbound.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
