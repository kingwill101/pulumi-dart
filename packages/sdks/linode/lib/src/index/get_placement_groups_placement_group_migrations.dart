...
class GetPlacementGroupsPlacementGroupMigrations {
  ...
  final pulumi.Input<List<GetPlacementGroupsPlacementGroupMigrationsInbound>>
  inbounds;

  /// A list of the Linodes the system is migrating out of the placement group.
  final pulumi.Input<List<GetPlacementGroupsPlacementGroupMigrationsOutbound>>
  outbounds;
    ...
    return <String, dynamic>{
      'inbounds':
          pulumi.Input.mapInputValue<
            List<GetPlacementGroupsPlacementGroupMigrationsInbound>,
      ...
      'outbounds':
          pulumi.Input.mapInputValue<
            List<GetPlacementGroupsPlacementGroupMigrationsOutbound>,
            List<Map<String, dynamic>>
          >(
            outbounds,
            (value) =>
  ...
  factory GetPlacementGroupsPlacementGroupMigrations.fromMap(
    ...
    return GetPlacementGroupsPlacementGroupMigrations(
      inbounds: pulumi.Input.fromValue(
        ...
        >(
          map['inbounds']!,
          (value) => GetPlacementGroupsPlacementGroupMigrationsInbound.fromMap(
      ...
      outbounds: pulumi.Input.fromValue(
        ...
        >(
          map['outbounds']!,
          (value) => GetPlacementGroupsPlacementGroupMigrationsOutbound.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
