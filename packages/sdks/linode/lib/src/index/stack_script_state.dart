...
class StackScriptState {
    ...
    return <String, dynamic>{
      ...
      'userDefinedFields':
          ?pulumi.Input.mapOptionalInputValue<
            List<StackScriptUserDefinedField>,
  ...
  factory StackScriptState.fromMap(Map<String, dynamic> map) {
    return StackScriptState(
      ...
      deploymentsActive: (() {
        final guardedValue = map['deploymentsActive'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      deploymentsTotal: (() {
        final guardedValue = map['deploymentsTotal'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      description: (() {
      ...
      revNote: (() {
        final guardedValue = map['revNote'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      script: (() {
      ...
      userDefinedFields: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<StackScriptUserDefinedField>(
            guardedValue,
            (value) => StackScriptUserDefinedField.fromMap(
      ...
      userGravatarId: (() {
        final guardedValue = map['userGravatarId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      username: (() {
