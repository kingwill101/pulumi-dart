...
class GetUsersUserStackscriptGrant {
  ...
  /// Creates a new [GetUsersUserStackscriptGrant].
  ...
  const GetUsersUserStackscriptGrant({
    required this.id,
    required this.label,
  ...
  factory GetUsersUserStackscriptGrant.fromMap(Map<String, dynamic> map) {
    return GetUsersUserStackscriptGrant(
