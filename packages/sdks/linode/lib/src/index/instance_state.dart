    ...
    return <String, dynamic>{
      ...
      'backups':
          ...
          >(
            backups,
            (value) =>
                pulumi.Input.encodeList<InstanceBackup, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      ...
      'specs':
          ...
          >(
            specs,
            (value) =>
                pulumi.Input.encodeList<InstanceSpec, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory InstanceState.fromMap(Map<String, dynamic> map) {
    return InstanceState(
      ...
      backups: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InstanceBackup>(
            guardedValue,
            (value) =>
                InstanceBackup.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      backupsEnabled: (() {
      ...
      hasUserData: (() {
        final guardedValue = map['hasUserData'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      hostUuid: (() {
        final guardedValue = map['hostUuid'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      image: (() {
      ...
      lkeClusterId: (() {
        final guardedValue = map['lkeClusterId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      locks: (() {
      ...
      specs: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InstanceSpec>(
            guardedValue,
            (value) =>
                InstanceSpec.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      stackscriptData: (() {
