...
class InstanceState {
  ...
  InstanceState({
    ...
    pulumi.Output<List<InstanceBackup>>? backups,
    ...
    pulumi.Output<bool>? hasUserData,
    pulumi.Output<String>? hostUuid,
    ...
    pulumi.Output<int>? lkeClusterId,
    pulumi.Output<List<String>>? locks,
    ...
    pulumi.Output<List<InstanceSpec>>? specs,
    ...
    pulumi.Output<bool>? watchdogEnabled,
      ...
      backups = pulumi.Input.asOptionalInput<List<InstanceBackup>>(backups),
      ...
      hasUserData = pulumi.Input.asOptionalInput<bool>(hasUserData),
      hostUuid = pulumi.Input.asOptionalInput<String>(hostUuid),
      ...
      lkeClusterId = pulumi.Input.asOptionalInput<int>(lkeClusterId),
      locks = pulumi.Input.asOptionalInput<List<String>>(locks),
      ...
      specs = pulumi.Input.asOptionalInput<List<InstanceSpec>>(specs),
  ...
  factory InstanceState.fromMap(Map<String, dynamic> map) {
    return InstanceState(
      ...
      backups: map['backups'] == null ? null : pulumi.Output.create<List<InstanceBackup>>(pulumi.Input.decodeList<InstanceBackup>(map['backups'], (value) => InstanceBackup.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      hasUserData: map['hasUserData'] == null ? null : pulumi.Output.create<bool>(map['hasUserData'] as bool),
      hostUuid: map['hostUuid'] == null ? null : pulumi.Output.create<String>(map['hostUuid'] as String),
      ...
      lkeClusterId: map['lkeClusterId'] == null ? null : pulumi.Output.create<int>(map['lkeClusterId'] as int),
      locks: map['locks'] == null ? null : pulumi.Output.create<List<String>>((map['locks'] as List).cast<String>()),
      ...
      specs: map['specs'] == null ? null : pulumi.Output.create<List<InstanceSpec>>(pulumi.Input.decodeList<InstanceSpec>(map['specs'], (value) => InstanceSpec.fromMap((value as Map).cast<String, dynamic>()))),
