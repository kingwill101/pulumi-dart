...
class InstanceState {
  ...
  factory InstanceState.fromMap(Map<String, dynamic> map) {
    return InstanceState(
      ...
      backups: map['backups'] == null ? null : (pulumi.Input.decodeList<InstanceBackup>(map['backups'], (value) => InstanceBackup.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      hasUserData: map['hasUserData'] == null ? null : (map['hasUserData'] as bool).input(),
      hostUuid: map['hostUuid'] == null ? null : (map['hostUuid'] as String).input(),
      ...
      lkeClusterId: map['lkeClusterId'] == null ? null : (map['lkeClusterId'] as int).input(),
      locks: map['locks'] == null ? null : ((map['locks'] as List).cast<String>()).input(),
      ...
      specs: map['specs'] == null ? null : (pulumi.Input.decodeList<InstanceSpec>(map['specs'], (value) => InstanceSpec.fromMap((value as Map).cast<String, dynamic>()))).input(),
