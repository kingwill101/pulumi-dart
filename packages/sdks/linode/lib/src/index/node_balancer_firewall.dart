...
class NodeBalancerFirewall {
  ...
  factory NodeBalancerFirewall.fromMap(Map<String, dynamic> map) {
    return NodeBalancerFirewall(
      ...
      inbounds: pulumi.Input.fromValue(pulumi.Input.decodeList<NodeBalancerFirewallInbound>(map['inbounds']!, (value) => NodeBalancerFirewallInbound.fromMap((value as Map).cast<String, dynamic>()))),
      label: pulumi.Input.fromValue(map['label'] as String),
      outboundPolicy: pulumi.Input.fromValue(map['outboundPolicy'] as String),
      outbounds: pulumi.Input.fromValue(pulumi.Input.decodeList<NodeBalancerFirewallOutbound>(map['outbounds']!, (value) => NodeBalancerFirewallOutbound.fromMap((value as Map).cast<String, dynamic>()))),
