...
class GetProducerImageShareGroupsArgs {
  ...
  /// [order] Optional.
  /// [orderBy] Optional.
  const GetProducerImageShareGroupsArgs({
    this.filters,
  ...
  factory GetProducerImageShareGroupsArgs.fromMap(Map<String, dynamic> map) {
    return GetProducerImageShareGroupsArgs(
      filters: (() { final guardedValue = map['filters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetProducerImageShareGroupsFilter>(guardedValue, (value) => GetProducerImageShareGroupsFilter.fromMap((value as Map).cast<String, dynamic>()))); })(),
      imageShareGroups: (() { final guardedValue = map['imageShareGroups']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetProducerImageShareGroupsImageShareGroup>(guardedValue, (value) => GetProducerImageShareGroupsImageShareGroup.fromMap((value as Map).cast<String, dynamic>()))); })(),
