...
class GetFirewallsFilter {
  ...
  /// Creates a new [GetFirewallsFilter].
  ...
  GetFirewallsFilter({this.matchBy, required this.name, required this.values});
  ...
  factory GetFirewallsFilter.fromMap(Map<String, dynamic> map) {
    return GetFirewallsFilter(
      matchBy: (() {
