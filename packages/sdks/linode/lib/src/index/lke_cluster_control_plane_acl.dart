...
class LkeClusterControlPlaneAcl {
  ...
  LkeClusterControlPlaneAcl({this.addresses, this.enabled});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'addresses':
          ?pulumi.Input.mapOptionalInputValue<
            List<LkeClusterControlPlaneAclAddress>,
    ...
    return LkeClusterControlPlaneAcl(
      addresses: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<LkeClusterControlPlaneAclAddress>(
            guardedValue,
            (value) => LkeClusterControlPlaneAclAddress.fromMap(
