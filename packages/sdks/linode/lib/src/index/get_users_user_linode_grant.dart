...
class GetUsersUserLinodeGrant {
  ...
  /// Creates a new [GetUsersUserLinodeGrant].
  ...
  factory GetUsersUserLinodeGrant.fromMap(Map<String, dynamic> map) {
    return GetUsersUserLinodeGrant(
