...
class GetUserResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'databaseGrants':
          pulumi.Input.encodeList<GetUserDatabaseGrant, Map<String, dynamic>>(
            databaseGrants,
            (value) => value.toMap(),
          ),
      'domainGrants':
          pulumi.Input.encodeList<GetUserDomainGrant, Map<String, dynamic>>(
            domainGrants,
            (value) => value.toMap(),
          ),
      'email': email,
      'firewallGrants':
          pulumi.Input.encodeList<GetUserFirewallGrant, Map<String, dynamic>>(
            firewallGrants,
            (value) => value.toMap(),
          ),
      'globalGrants':
          pulumi.Input.encodeList<GetUserGlobalGrant, Map<String, dynamic>>(
            globalGrants,
            (value) => value.toMap(),
          ),
      'id': id,
      'imageGrants':
          pulumi.Input.encodeList<GetUserImageGrant, Map<String, dynamic>>(
            imageGrants,
            (value) => value.toMap(),
          ),
      'linodeGrants':
          pulumi.Input.encodeList<GetUserLinodeGrant, Map<String, dynamic>>(
            linodeGrants,
            (value) => value.toMap(),
          ),
      'longviewGrants':
          pulumi.Input.encodeList<GetUserLongviewGrant, Map<String, dynamic>>(
            longviewGrants,
            (value) => value.toMap(),
          ),
      'nodebalancerGrants':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(nodebalancerGrants, (value) => value.toMap()),
      ...
      'stackscriptGrants':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(stackscriptGrants, (value) => value.toMap()),
      'tfaEnabled': tfaEnabled,
      'userType': userType,
      'username': username,
      'verifiedPhoneNumber': verifiedPhoneNumber,
      'volumeGrants':
          pulumi.Input.encodeList<GetUserVolumeGrant, Map<String, dynamic>>(
            volumeGrants,
            (value) => value.toMap(),
          ),
      'vpcGrants':
  ...
  factory GetUserResult.fromMap(Map<String, dynamic> map) {
    return GetUserResult(
      databaseGrants: pulumi.Input.decodeList<GetUserDatabaseGrant>(
        map['databaseGrants']!,
        (value) => GetUserDatabaseGrant.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      domainGrants: pulumi.Input.decodeList<GetUserDomainGrant>(
        map['domainGrants']!,
        (value) =>
            GetUserDomainGrant.fromMap((value as Map).cast<String, dynamic>()),
      ),
      email: map['email'] as String,
      firewallGrants: pulumi.Input.decodeList<GetUserFirewallGrant>(
        map['firewallGrants']!,
        (value) => GetUserFirewallGrant.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      globalGrants: pulumi.Input.decodeList<GetUserGlobalGrant>(
        map['globalGrants']!,
        (value) =>
            GetUserGlobalGrant.fromMap((value as Map).cast<String, dynamic>()),
      ),
      id: map['id'] as String,
      imageGrants: pulumi.Input.decodeList<GetUserImageGrant>(
        map['imageGrants']!,
        (value) =>
            GetUserImageGrant.fromMap((value as Map).cast<String, dynamic>()),
      ),
      linodeGrants: pulumi.Input.decodeList<GetUserLinodeGrant>(
        map['linodeGrants']!,
        (value) =>
            GetUserLinodeGrant.fromMap((value as Map).cast<String, dynamic>()),
      ),
      longviewGrants: pulumi.Input.decodeList<GetUserLongviewGrant>(
        map['longviewGrants']!,
        (value) => GetUserLongviewGrant.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      nodebalancerGrants: pulumi.Input.decodeList<GetUserNodebalancerGrant>(
      ...
      stackscriptGrants: pulumi.Input.decodeList<GetUserStackscriptGrant>(
      ...
      volumeGrants: pulumi.Input.decodeList<GetUserVolumeGrant>(
        map['volumeGrants']!,
        (value) =>
            GetUserVolumeGrant.fromMap((value as Map).cast<String, dynamic>()),
      ),
      vpcGrants: pulumi.Input.decodeList<GetUserVpcGrant>(
        map['vpcGrants']!,
        (value) =>
