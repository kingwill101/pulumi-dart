...
class GetFirewallResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'created': created,
      'devices':
          pulumi.Input.encodeList<GetFirewallDevice, Map<String, dynamic>>(
            devices,
            (value) => value.toMap(),
          ),
      'disabled': disabled,
      ...
      'inbounds':
          pulumi.Input.encodeList<GetFirewallInbound, Map<String, dynamic>>(
            inbounds,
            (value) => value.toMap(),
          ),
      ...
      'outbounds':
          pulumi.Input.encodeList<GetFirewallOutbound, Map<String, dynamic>>(
            outbounds,
            (value) => value.toMap(),
          ),
      'status': status,
  ...
  factory GetFirewallResult.fromMap(Map<String, dynamic> map) {
    return GetFirewallResult(
      ...
      devices: pulumi.Input.decodeList<GetFirewallDevice>(
        map['devices']!,
        (value) =>
            GetFirewallDevice.fromMap((value as Map).cast<String, dynamic>()),
      ),
      disabled: map['disabled'] as bool,
      id: map['id'] as int,
      inboundPolicy: map['inboundPolicy'] as String,
      inbounds: pulumi.Input.decodeList<GetFirewallInbound>(
        map['inbounds']!,
        (value) =>
            GetFirewallInbound.fromMap((value as Map).cast<String, dynamic>()),
      ),
      ...
      outbounds: pulumi.Input.decodeList<GetFirewallOutbound>(
        map['outbounds']!,
        (value) =>
            GetFirewallOutbound.fromMap((value as Map).cast<String, dynamic>()),
      ),
