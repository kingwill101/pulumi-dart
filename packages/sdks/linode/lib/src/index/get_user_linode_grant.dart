...
class GetUserLinodeGrant {
  ...
  /// Creates a new [GetUserLinodeGrant].
  ...
  factory GetUserLinodeGrant.fromMap(Map<String, dynamic> map) {
    return GetUserLinodeGrant(
