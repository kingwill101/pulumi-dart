...
class ImageState {
  ...
  factory ImageState.fromMap(Map<String, dynamic> map) {
    return ImageState(
      ...
      imageSharing: (() { final guardedValue = map['imageSharing']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ImageImageSharing.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      replications: (() { final guardedValue = map['replications']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ImageReplication>(guardedValue, (value) => ImageReplication.fromMap((value as Map).cast<String, dynamic>()))); })(),
