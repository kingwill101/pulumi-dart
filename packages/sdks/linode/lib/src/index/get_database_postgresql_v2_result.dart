...
class GetDatabasePostgresqlV2Result {
  ...
  factory GetDatabasePostgresqlV2Result.fromMap(Map<String, dynamic> map) {
    return GetDatabasePostgresqlV2Result(
      ...
      engineConfigPgAutovacuumAnalyzeScaleFactor:
          map['engineConfigPgAutovacuumAnalyzeScaleFactor'] as double,
      engineConfigPgAutovacuumAnalyzeThreshold:
          map['engineConfigPgAutovacuumAnalyzeThreshold'] as int,
      engineConfigPgAutovacuumMaxWorkers:
          map['engineConfigPgAutovacuumMaxWorkers'] as int,
      engineConfigPgAutovacuumNaptime:
          map['engineConfigPgAutovacuumNaptime'] as int,
      engineConfigPgAutovacuumVacuumCostDelay:
          map['engineConfigPgAutovacuumVacuumCostDelay'] as int,
      engineConfigPgAutovacuumVacuumCostLimit:
          map['engineConfigPgAutovacuumVacuumCostLimit'] as int,
      engineConfigPgAutovacuumVacuumScaleFactor:
          map['engineConfigPgAutovacuumVacuumScaleFactor'] as double,
      engineConfigPgAutovacuumVacuumThreshold:
          map['engineConfigPgAutovacuumVacuumThreshold'] as int,
      engineConfigPgBgwriterDelay: map['engineConfigPgBgwriterDelay'] as int,
      engineConfigPgBgwriterFlushAfter:
          map['engineConfigPgBgwriterFlushAfter'] as int,
      engineConfigPgBgwriterLruMaxpages:
          map['engineConfigPgBgwriterLruMaxpages'] as int,
      engineConfigPgBgwriterLruMultiplier:
          map['engineConfigPgBgwriterLruMultiplier'] as double,
      engineConfigPgDeadlockTimeout:
          map['engineConfigPgDeadlockTimeout'] as int,
      engineConfigPgDefaultToastCompression:
          map['engineConfigPgDefaultToastCompression'] as String,
      engineConfigPgIdleInTransactionSessionTimeout:
          map['engineConfigPgIdleInTransactionSessionTimeout'] as int,
      engineConfigPgJit: map['engineConfigPgJit'] as bool,
      engineConfigPgMaxFilesPerProcess:
          map['engineConfigPgMaxFilesPerProcess'] as int,
      engineConfigPgMaxLocksPerTransaction:
          map['engineConfigPgMaxLocksPerTransaction'] as int,
      engineConfigPgMaxLogicalReplicationWorkers:
          map['engineConfigPgMaxLogicalReplicationWorkers'] as int,
      engineConfigPgMaxParallelWorkers:
          map['engineConfigPgMaxParallelWorkers'] as int,
      engineConfigPgMaxParallelWorkersPerGather:
          map['engineConfigPgMaxParallelWorkersPerGather'] as int,
      engineConfigPgMaxPredLocksPerTransaction:
          map['engineConfigPgMaxPredLocksPerTransaction'] as int,
      engineConfigPgMaxReplicationSlots:
          map['engineConfigPgMaxReplicationSlots'] as int,
      engineConfigPgMaxSlotWalKeepSize:
          map['engineConfigPgMaxSlotWalKeepSize'] as int,
      engineConfigPgMaxStackDepth: map['engineConfigPgMaxStackDepth'] as int,
      engineConfigPgMaxStandbyArchiveDelay:
          map['engineConfigPgMaxStandbyArchiveDelay'] as int,
      engineConfigPgMaxStandbyStreamingDelay:
          map['engineConfigPgMaxStandbyStreamingDelay'] as int,
      engineConfigPgMaxWalSenders: map['engineConfigPgMaxWalSenders'] as int,
      engineConfigPgMaxWorkerProcesses:
          map['engineConfigPgMaxWorkerProcesses'] as int,
      engineConfigPgPasswordEncryption:
          map['engineConfigPgPasswordEncryption'] as String,
      engineConfigPgPgPartmanBgwInterval:
          map['engineConfigPgPgPartmanBgwInterval'] as int,
      engineConfigPgPgPartmanBgwRole:
          map['engineConfigPgPgPartmanBgwRole'] as String,
      engineConfigPgPgStatMonitorPgsmEnableQueryPlan:
          map['engineConfigPgPgStatMonitorPgsmEnableQueryPlan'] as bool,
      engineConfigPgPgStatMonitorPgsmMaxBuckets:
          map['engineConfigPgPgStatMonitorPgsmMaxBuckets'] as int,
      engineConfigPgPgStatStatementsTrack:
          map['engineConfigPgPgStatStatementsTrack'] as String,
      engineConfigPgStatMonitorEnable:
          map['engineConfigPgStatMonitorEnable'] as bool,
      ...
      engineConfigPgTrackActivityQuerySize:
          map['engineConfigPgTrackActivityQuerySize'] as int,
      engineConfigPgTrackCommitTimestamp:
          map['engineConfigPgTrackCommitTimestamp'] as String,
      engineConfigPgTrackFunctions:
          map['engineConfigPgTrackFunctions'] as String,
      engineConfigPgTrackIoTiming: map['engineConfigPgTrackIoTiming'] as String,
      engineConfigPgWalSenderTimeout:
          map['engineConfigPgWalSenderTimeout'] as int,
      engineConfigPgWalWriterDelay: map['engineConfigPgWalWriterDelay'] as int,
      engineConfigPglookoutMaxFailoverReplicationTimeLag:
          map['engineConfigPglookoutMaxFailoverReplicationTimeLag'] as int,
      engineConfigSharedBuffersPercentage:
          map['engineConfigSharedBuffersPercentage'] as double,
      ...
      pendingUpdates:
          pulumi.Input.decodeList<GetDatabasePostgresqlV2PendingUpdate>(
            map['pendingUpdates']!,
            (value) => GetDatabasePostgresqlV2PendingUpdate.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      platform: map['platform'] as String,
      port: map['port'] as int,
      privateNetwork: GetDatabasePostgresqlV2PrivateNetwork.fromMap(
      ...
      updates: GetDatabasePostgresqlV2Updates.fromMap(
