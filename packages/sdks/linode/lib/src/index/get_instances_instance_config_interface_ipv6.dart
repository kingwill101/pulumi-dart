...
class GetInstancesInstanceConfigInterfaceIpv6 {
  ...
  factory GetInstancesInstanceConfigInterfaceIpv6.fromMap(Map<String, dynamic> map) {
    return GetInstancesInstanceConfigInterfaceIpv6(
      ...
      ranges: pulumi.Input.fromValue(pulumi.Input.decodeList<GetInstancesInstanceConfigInterfaceIpv6Range>(map['ranges']!, (value) => GetInstancesInstanceConfigInterfaceIpv6Range.fromMap((value as Map).cast<String, dynamic>()))),
      slaacs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetInstancesInstanceConfigInterfaceIpv6Slaac>(map['slaacs']!, (value) => GetInstancesInstanceConfigInterfaceIpv6Slaac.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
