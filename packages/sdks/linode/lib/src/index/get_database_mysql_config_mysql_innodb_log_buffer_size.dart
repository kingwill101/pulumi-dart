...
class GetDatabaseMysqlConfigMysqlInnodbLogBufferSize {
  ...
  /// Creates a new [GetDatabaseMysqlConfigMysqlInnodbLogBufferSize].
  ...
  factory GetDatabaseMysqlConfigMysqlInnodbLogBufferSize.fromMap(Map<String, dynamic> map) {
    return GetDatabaseMysqlConfigMysqlInnodbLogBufferSize(
