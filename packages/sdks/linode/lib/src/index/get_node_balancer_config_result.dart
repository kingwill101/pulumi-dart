...
import 'get_node_balancer_config_node_status.dart';

/// Result data returned by getNodeBalancerConfig.
class GetNodeBalancerConfigResult {
  ...
  /// Creates a new [GetNodeBalancerConfigResult].
  ...
  factory GetNodeBalancerConfigResult.fromMap(Map<String, dynamic> map) {
