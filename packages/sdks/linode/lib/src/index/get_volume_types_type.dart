...
class GetVolumeTypesType {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'regionPrices':
          pulumi.Input.mapInputValue<
            List<GetVolumeTypesTypeRegionPrice>,
            List<Map<String, dynamic>>
          >(
            regionPrices,
            (value) =>
  ...
  factory GetVolumeTypesType.fromMap(Map<String, dynamic> map) {
    return GetVolumeTypesType(
      ...
      prices: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetVolumeTypesTypePrice>(
          map['prices']!,
          (value) => GetVolumeTypesTypePrice.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      regionPrices: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetVolumeTypesTypeRegionPrice>(
          map['regionPrices']!,
          (value) => GetVolumeTypesTypeRegionPrice.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
