...
class GetVolumeTypesType {
  ...
  factory GetVolumeTypesType.fromMap(Map<String, dynamic> map) {
    return GetVolumeTypesType(
      ...
      prices: (pulumi.Input.decodeList<GetVolumeTypesTypePrice>(map['prices'], (value) => GetVolumeTypesTypePrice.fromMap((value as Map).cast<String, dynamic>()))).input(),
      regionPrices: (pulumi.Input.decodeList<GetVolumeTypesTypeRegionPrice>(map['regionPrices'], (value) => GetVolumeTypesTypeRegionPrice.fromMap((value as Map).cast<String, dynamic>()))).input(),
