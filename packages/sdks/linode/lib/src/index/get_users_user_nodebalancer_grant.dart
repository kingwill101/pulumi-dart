...
class GetUsersUserNodebalancerGrant {
  ...
  /// Creates a new [GetUsersUserNodebalancerGrant].
  ...
  const GetUsersUserNodebalancerGrant({
    required this.id,
    required this.label,
  ...
  factory GetUsersUserNodebalancerGrant.fromMap(Map<String, dynamic> map) {
    return GetUsersUserNodebalancerGrant(
