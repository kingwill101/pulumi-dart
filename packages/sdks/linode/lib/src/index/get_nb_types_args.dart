...
class GetNbTypesArgs {
  ...
  factory GetNbTypesArgs.fromMap(Map<String, dynamic> map) {
    return GetNbTypesArgs(
      filters: (() { final guardedValue = map['filters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetNbTypesFilter>(guardedValue, (value) => GetNbTypesFilter.fromMap((value as Map).cast<String, dynamic>()))); })(),
