...
class ProviderArgs {
  ...
  factory ProviderArgs.fromMap(Map<String, dynamic> map) {
    return ProviderArgs(
      apiCaPath: (() { final guardedValue = map['apiCaPath']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      apiVersion: (() { final guardedValue = map['apiVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      configPath: (() { final guardedValue = map['configPath']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      configProfile: (() { final guardedValue = map['configProfile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      disableInternalCache: (() { final guardedValue = map['disableInternalCache']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      eventPollMs: (() { final guardedValue = map['eventPollMs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      lkeEventPollMs: (() { final guardedValue = map['lkeEventPollMs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      lkeNodeReadyPollMs: (() { final guardedValue = map['lkeNodeReadyPollMs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      maxRetryDelayMs: (() { final guardedValue = map['maxRetryDelayMs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      minRetryDelayMs: (() { final guardedValue = map['minRetryDelayMs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      objAccessKey: (() { final guardedValue = map['objAccessKey']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      objBucketForceDelete: (() { final guardedValue = map['objBucketForceDelete']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      objSecretKey: (() { final guardedValue = map['objSecretKey']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      objUseTempKeys: (() { final guardedValue = map['objUseTempKeys']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      skipImplicitReboots: (() { final guardedValue = map['skipImplicitReboots']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      skipInstanceDeletePoll: (() { final guardedValue = map['skipInstanceDeletePoll']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      skipInstanceReadyPoll: (() { final guardedValue = map['skipInstanceReadyPoll']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      token: (() { final guardedValue = map['token']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      uaPrefix: (() { final guardedValue = map['uaPrefix']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
