...
class ServiceTemplateSpecVolume {
  ...
  factory ServiceTemplateSpecVolume.fromMap(Map<String, dynamic> map) {
    return ServiceTemplateSpecVolume(
      csi: (() { final guardedValue = map['csi']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServiceTemplateSpecVolumeCsi.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      emptyDir: (() { final guardedValue = map['emptyDir']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServiceTemplateSpecVolumeEmptyDir.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      name: pulumi.Input.fromValue(map['name'] as String),
      nfs: (() { final guardedValue = map['nfs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServiceTemplateSpecVolumeNfs.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      secret: (() { final guardedValue = map['secret']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServiceTemplateSpecVolumeSecret.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
