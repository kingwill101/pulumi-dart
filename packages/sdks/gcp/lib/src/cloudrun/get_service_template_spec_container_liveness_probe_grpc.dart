...
class GetServiceTemplateSpecContainerLivenessProbeGrpc {
  ...
  /// Creates a new [GetServiceTemplateSpecContainerLivenessProbeGrpc].
  ...
  factory GetServiceTemplateSpecContainerLivenessProbeGrpc.fromMap(
