...
class GetServiceTemplateSpecContainerEnvFromSecretRef {
  ...
  factory GetServiceTemplateSpecContainerEnvFromSecretRef.fromMap(Map<String, dynamic> map) {
    return GetServiceTemplateSpecContainerEnvFromSecretRef(
      localObjectReferences: (pulumi.Input.decodeList<GetServiceTemplateSpecContainerEnvFromSecretRefLocalObjectReference>(map['localObjectReferences'], (value) => GetServiceTemplateSpecContainerEnvFromSecretRefLocalObjectReference.fromMap((value as Map).cast<String, dynamic>()))).input(),
