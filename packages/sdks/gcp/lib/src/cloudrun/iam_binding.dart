...
class IamBinding extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [IamBinding]. {@macro pulumi_cloudrun_iam_binding_iam_binding_args_doc}
  ...
  IamBinding(
    ...
    condition = registerOutput<IamBindingCondition?>('condition');
