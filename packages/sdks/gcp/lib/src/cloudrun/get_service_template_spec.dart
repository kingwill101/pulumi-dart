...
class GetServiceTemplateSpec {
    ...
    return <String, dynamic>{
      ...
      'containers':
          pulumi.Input.mapInputValue<
            List<GetServiceTemplateSpecContainer>,
      ...
      'volumes':
          pulumi.Input.mapInputValue<
            List<GetServiceTemplateSpecVolume>,
            List<Map<String, dynamic>>
          >(
            volumes,
            (value) =>
  ...
  factory GetServiceTemplateSpec.fromMap(Map<String, dynamic> map) {
    return GetServiceTemplateSpec(
      containerConcurrency: pulumi.Input.fromValue(
        map['containerConcurrency'] as int,
      ),
      containers: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetServiceTemplateSpecContainer>(
          map['containers']!,
      ...
      volumes: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetServiceTemplateSpecVolume>(
          map['volumes']!,
