...
class GetServiceTemplateSpecContainerStartupProbe {
  ...
  final pulumi.Input<List<GetServiceTemplateSpecContainerStartupProbeGrpc>>
  grpcs;

  /// HttpGet specifies the http request to perform.
  final pulumi.Input<List<GetServiceTemplateSpecContainerStartupProbeHttpGet>>
  httpGets;
  ...
  final pulumi.Input<List<GetServiceTemplateSpecContainerStartupProbeTcpSocket>>
  tcpSockets;
    ...
    return <String, dynamic>{
      ...
      'grpcs':
          pulumi.Input.mapInputValue<
            List<GetServiceTemplateSpecContainerStartupProbeGrpc>,
      ...
      'httpGets':
          pulumi.Input.mapInputValue<
            List<GetServiceTemplateSpecContainerStartupProbeHttpGet>,
            List<Map<String, dynamic>>
          >(
            httpGets,
            (value) =>
      ...
      'tcpSockets':
          pulumi.Input.mapInputValue<
            List<GetServiceTemplateSpecContainerStartupProbeTcpSocket>,
            List<Map<String, dynamic>>
          >(
            tcpSockets,
            (value) =>
  ...
  factory GetServiceTemplateSpecContainerStartupProbe.fromMap(
    ...
    return GetServiceTemplateSpecContainerStartupProbe(
      ...
      grpcs: pulumi.Input.fromValue(
        pulumi
            .Input.decodeList<GetServiceTemplateSpecContainerStartupProbeGrpc>(
          map['grpcs']!,
