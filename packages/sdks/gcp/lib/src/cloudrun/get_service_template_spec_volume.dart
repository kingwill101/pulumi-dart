...
class GetServiceTemplateSpecVolume {
  ...
  factory GetServiceTemplateSpecVolume.fromMap(Map<String, dynamic> map) {
    return GetServiceTemplateSpecVolume(
      csis: (pulumi.Input.decodeList<GetServiceTemplateSpecVolumeCsi>(map['csis'], (value) => GetServiceTemplateSpecVolumeCsi.fromMap((value as Map).cast<String, dynamic>()))).input(),
      emptyDirs: (pulumi.Input.decodeList<GetServiceTemplateSpecVolumeEmptyDir>(map['emptyDirs'], (value) => GetServiceTemplateSpecVolumeEmptyDir.fromMap((value as Map).cast<String, dynamic>()))).input(),
      name: (map['name'] as String).input(),
      nfs: (pulumi.Input.decodeList<GetServiceTemplateSpecVolumeNf>(map['nfs'], (value) => GetServiceTemplateSpecVolumeNf.fromMap((value as Map).cast<String, dynamic>()))).input(),
      secrets: (pulumi.Input.decodeList<GetServiceTemplateSpecVolumeSecret>(map['secrets'], (value) => GetServiceTemplateSpecVolumeSecret.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
