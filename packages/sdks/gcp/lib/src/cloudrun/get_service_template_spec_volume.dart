...
class GetServiceTemplateSpecVolume {
    ...
    return <String, dynamic>{
      'csis':
          pulumi.Input.mapInputValue<
            List<GetServiceTemplateSpecVolumeCsi>,
      ...
      'emptyDirs':
          pulumi.Input.mapInputValue<
            List<GetServiceTemplateSpecVolumeEmptyDir>,
            List<Map<String, dynamic>>
          >(
            emptyDirs,
            (value) =>
      ...
      'nfs':
          pulumi.Input.mapInputValue<
            List<GetServiceTemplateSpecVolumeNf>,
            List<Map<String, dynamic>>
          >(
            nfs,
            (value) =>
      ...
      'secrets':
          pulumi.Input.mapInputValue<
            List<GetServiceTemplateSpecVolumeSecret>,
            List<Map<String, dynamic>>
          >(
            secrets,
            (value) =>
  ...
  factory GetServiceTemplateSpecVolume.fromMap(Map<String, dynamic> map) {
    return GetServiceTemplateSpecVolume(
      csis: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetServiceTemplateSpecVolumeCsi>(
          map['csis']!,
      ...
      emptyDirs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetServiceTemplateSpecVolumeEmptyDir>(
          map['emptyDirs']!,
      ...
      nfs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetServiceTemplateSpecVolumeNf>(
          map['nfs']!,
      ...
      secrets: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetServiceTemplateSpecVolumeSecret>(
          map['secrets']!,
