...
class GetServiceTemplateSpecContainerReadinessProbe {
  ...
  final pulumi.Input<List<GetServiceTemplateSpecContainerReadinessProbeGrpc>>
  grpcs;

  /// HttpGet specifies the http request to perform.
  final pulumi.Input<List<GetServiceTemplateSpecContainerReadinessProbeHttpGet>>
  httpGets;
    ...
    return <String, dynamic>{
      ...
      'grpcs':
          pulumi.Input.mapInputValue<
            List<GetServiceTemplateSpecContainerReadinessProbeGrpc>,
      ...
      'httpGets':
          pulumi.Input.mapInputValue<
            List<GetServiceTemplateSpecContainerReadinessProbeHttpGet>,
            List<Map<String, dynamic>>
          >(
            httpGets,
            (value) =>
