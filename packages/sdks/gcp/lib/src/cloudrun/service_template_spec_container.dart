...
class ServiceTemplateSpecContainer {
  ...
  factory ServiceTemplateSpecContainer.fromMap(Map<String, dynamic> map) {
    return ServiceTemplateSpecContainer(
      ...
      envFroms: (() { final guardedValue = map['envFroms']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ServiceTemplateSpecContainerEnvFrom>(guardedValue, (value) => ServiceTemplateSpecContainerEnvFrom.fromMap((value as Map).cast<String, dynamic>()))); })(),
      envs: (() { final guardedValue = map['envs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ServiceTemplateSpecContainerEnv>(guardedValue, (value) => ServiceTemplateSpecContainerEnv.fromMap((value as Map).cast<String, dynamic>()))); })(),
      image: pulumi.Input.fromValue(map['image'] as String),
      livenessProbe: (() { final guardedValue = map['livenessProbe']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServiceTemplateSpecContainerLivenessProbe.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
