...
class ServiceTemplateSpecContainer {
  ...
  /// Structure is documented below.
  final pulumi.Input<ServiceTemplateSpecContainerReadinessProbe>?
  readinessProbe;
  ...
  /// Structure is documented below.
  final pulumi.Input<List<ServiceTemplateSpecContainerVolumeMount>>?
  volumeMounts;
    ...
    return <String, dynamic>{
      ...
      'envFroms':
          ?pulumi.Input.mapOptionalInputValue<
            List<ServiceTemplateSpecContainerEnvFrom>,
      ...
      'envs':
          ?pulumi.Input.mapOptionalInputValue<
            List<ServiceTemplateSpecContainerEnv>,
            List<Map<String, dynamic>>
          >(
            envs,
            (value) =>
      ...
      'ports':
          ?pulumi.Input.mapOptionalInputValue<
            List<ServiceTemplateSpecContainerPort>,
            List<Map<String, dynamic>>
          >(
            ports,
            (value) =>
      ...
      'volumeMounts':
          ?pulumi.Input.mapOptionalInputValue<
            List<ServiceTemplateSpecContainerVolumeMount>,
            List<Map<String, dynamic>>
          >(
            volumeMounts,
            (value) =>
  ...
  factory ServiceTemplateSpecContainer.fromMap(Map<String, dynamic> map) {
    return ServiceTemplateSpecContainer(
      ...
      envFroms: (() {
        final guardedValue = map['envFroms'];
        if (guardedValue == null) return null;
