...
class ServiceTemplateSpecContainer {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'args': ?args,
      'commands': ?commands,
      'envFroms': ?envFroms == null ? null : pulumi.Input.encodeList<ServiceTemplateSpecContainerEnvFrom, Map<String, dynamic>>(envFroms!, (value) => value.toMap()),
      'envs': ?envs == null ? null : pulumi.Input.encodeList<ServiceTemplateSpecContainerEnv, Map<String, dynamic>>(envs!, (value) => value.toMap()),
      'image': image,
      'livenessProbe': ?livenessProbe == null ? null : livenessProbe!.toMap(),
      'name': ?name,
      'ports': ?ports == null ? null : pulumi.Input.encodeList<ServiceTemplateSpecContainerPort, Map<String, dynamic>>(ports!, (value) => value.toMap()),
      ...
      'volumeMounts': ?volumeMounts == null ? null : pulumi.Input.encodeList<ServiceTemplateSpecContainerVolumeMount, Map<String, dynamic>>(volumeMounts!, (value) => value.toMap()),
  ...
  factory ServiceTemplateSpecContainer.fromMap(Map<String, dynamic> map) {
    return ServiceTemplateSpecContainer(
      ...
      envFroms: map['envFroms'] == null ? null : pulumi.Input.decodeList<ServiceTemplateSpecContainerEnvFrom>(map['envFroms'], (value) => ServiceTemplateSpecContainerEnvFrom.fromMap((value as Map).cast<String, dynamic>())),
      envs: map['envs'] == null ? null : pulumi.Input.decodeList<ServiceTemplateSpecContainerEnv>(map['envs'], (value) => ServiceTemplateSpecContainerEnv.fromMap((value as Map).cast<String, dynamic>())),
      image: map['image'] as String,
      livenessProbe: map['livenessProbe'] == null ? null : ServiceTemplateSpecContainerLivenessProbe.fromMap((map['livenessProbe'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      ports: map['ports'] == null ? null : pulumi.Input.decodeList<ServiceTemplateSpecContainerPort>(map['ports'], (value) => ServiceTemplateSpecContainerPort.fromMap((value as Map).cast<String, dynamic>())),
      readinessProbe: map['readinessProbe'] == null ? null : ServiceTemplateSpecContainerReadinessProbe.fromMap((map['readinessProbe'] as Map).cast<String, dynamic>()),
      resources: map['resources'] == null ? null : ServiceTemplateSpecContainerResources.fromMap((map['resources'] as Map).cast<String, dynamic>()),
      startupProbe: map['startupProbe'] == null ? null : ServiceTemplateSpecContainerStartupProbe.fromMap((map['startupProbe'] as Map).cast<String, dynamic>()),
      volumeMounts: map['volumeMounts'] == null ? null : pulumi.Input.decodeList<ServiceTemplateSpecContainerVolumeMount>(map['volumeMounts'], (value) => ServiceTemplateSpecContainerVolumeMount.fromMap((value as Map).cast<String, dynamic>())),
