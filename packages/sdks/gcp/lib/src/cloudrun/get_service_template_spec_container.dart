...
class GetServiceTemplateSpecContainer {
  ...
  final pulumi.Input<List<GetServiceTemplateSpecContainerLivenessProbe>>
  livenessProbes;
  ...
  final pulumi.Input<List<GetServiceTemplateSpecContainerReadinessProbe>>
  readinessProbes;
  ...
  final pulumi.Input<List<GetServiceTemplateSpecContainerStartupProbe>>
  startupProbes;

  /// Volume to mount into the container's filesystem.
  /// Only supports SecretVolumeSources.
  final pulumi.Input<List<GetServiceTemplateSpecContainerVolumeMount>>
  volumeMounts;
    ...
    return <String, dynamic>{
      ...
      'envFroms':
          pulumi.Input.mapInputValue<
            List<GetServiceTemplateSpecContainerEnvFrom>,
      ...
      'envs':
          pulumi.Input.mapInputValue<
            List<GetServiceTemplateSpecContainerEnv>,
            List<Map<String, dynamic>>
          >(
            envs,
            (value) =>
      ...
      'livenessProbes':
          pulumi.Input.mapInputValue<
            List<GetServiceTemplateSpecContainerLivenessProbe>,
            List<Map<String, dynamic>>
          >(
            livenessProbes,
            (value) =>
      ...
      'ports':
          pulumi.Input.mapInputValue<
            List<GetServiceTemplateSpecContainerPort>,
            List<Map<String, dynamic>>
          >(
            ports,
            (value) =>
      ...
      'readinessProbes':
          pulumi.Input.mapInputValue<
            List<GetServiceTemplateSpecContainerReadinessProbe>,
            List<Map<String, dynamic>>
          >(
            readinessProbes,
            (value) =>
      ...
      'resources':
          pulumi.Input.mapInputValue<
            List<GetServiceTemplateSpecContainerResource>,
            List<Map<String, dynamic>>
          >(
            resources,
            (value) =>
      ...
      'startupProbes':
          pulumi.Input.mapInputValue<
            List<GetServiceTemplateSpecContainerStartupProbe>,
            List<Map<String, dynamic>>
          >(
            startupProbes,
            (value) =>
      ...
      'volumeMounts':
          pulumi.Input.mapInputValue<
            List<GetServiceTemplateSpecContainerVolumeMount>,
            List<Map<String, dynamic>>
          >(
            volumeMounts,
            (value) =>
  ...
  factory GetServiceTemplateSpecContainer.fromMap(Map<String, dynamic> map) {
    return GetServiceTemplateSpecContainer(
      ...
      envFroms: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetServiceTemplateSpecContainerEnvFrom>(
          map['envFroms']!,
      ...
      envs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetServiceTemplateSpecContainerEnv>(
          map['envs']!,
      ...
      ports: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetServiceTemplateSpecContainerPort>(
          map['ports']!,
      ...
      readinessProbes: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetServiceTemplateSpecContainerReadinessProbe>(
          map['readinessProbes']!,
