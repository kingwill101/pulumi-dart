    ...
    return <String, dynamic>{
      'conditions':
          pulumi.Input.mapInputValue<
            List<GetServiceStatusCondition>,
  ...
  factory GetServiceStatus.fromMap(Map<String, dynamic> map) {
    return GetServiceStatus(
      conditions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetServiceStatusCondition>(
          map['conditions']!,
      ...
      latestCreatedRevisionName: pulumi.Input.fromValue(
        map['latestCreatedRevisionName'] as String,
      ),
      latestReadyRevisionName: pulumi.Input.fromValue(
        map['latestReadyRevisionName'] as String,
      ),
      observedGeneration: pulumi.Input.fromValue(
        map['observedGeneration'] as int,
      ),
      traffics: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetServiceStatusTraffic>(
          map['traffics']!,
