...
class DomainMappingArgs {
  ...
  DomainMappingArgs({
    ...
    required pulumi.Output<DomainMappingSpec> spec,
  }) :
  ...
  factory DomainMappingArgs.fromMap(Map<String, dynamic> map) {
    return DomainMappingArgs(
      ...
      spec: pulumi.Output.create<DomainMappingSpec>(DomainMappingSpec.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
