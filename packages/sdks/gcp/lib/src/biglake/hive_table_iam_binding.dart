...
import 'hive_table_iam_binding_args.dart';
import 'hive_table_iam_binding_condition.dart';
import 'hive_table_iam_binding_state.dart';
...
class HiveTableIamBinding extends pulumi.CustomResource {
  ...
  late final pulumi.Output<HiveTableIamBindingCondition?> condition;
  ...
  /// Creates a new [HiveTableIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [HiveTableIamBinding]. {@macro pulumi_biglake_hive_table_iam_binding_hive_table_iam_binding_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  HiveTableIamBinding(
    String name, {
    HiveTableIamBindingArgs? args,
  ...
  /// Gets an existing [HiveTableIamBinding] resource's state with the given [name] and [id].
  static HiveTableIamBinding get(
    String name,
