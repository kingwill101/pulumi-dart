...
class HiveTableIamMemberState {
  ...
  final pulumi.Input<HiveTableIamMemberCondition>? condition;
  ...
  /// Creates a new [HiveTableIamMemberState].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'catalog': ?catalog,
      'condition': ?pulumi.Input.mapOptionalInputValue<HiveTableIamMemberCondition, Map<String, dynamic>>(condition, (value) => value.toMap()),
      'database': ?database,
      'etag': ?etag,
      'member': ?member,
      'name': ?name,
  ...
  factory HiveTableIamMemberState.fromMap(Map<String, dynamic> map) {
    return HiveTableIamMemberState(
      ...
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HiveTableIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
