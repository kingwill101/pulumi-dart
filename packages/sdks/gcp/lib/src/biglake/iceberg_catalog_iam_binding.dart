...
import 'iceberg_catalog_iam_binding_state.dart';
...
class IcebergCatalogIamBinding extends pulumi.CustomResource {
  ...
  IcebergCatalogIamBinding(
    ...
    condition = registerOutput<IcebergCatalogIamBindingCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return IcebergCatalogIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [IcebergCatalogIamBinding] resource's state with the given [name] and [id].
  static IcebergCatalogIamBinding get(
    String name,
    pulumi.Input<String> id, {
    IcebergCatalogIamBindingState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return IcebergCatalogIamBinding._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [IcebergCatalogIamBinding] resource.
  IcebergCatalogIamBinding.reference(String urn)
    : super(
        'gcp:biglake/icebergCatalogIamBinding:IcebergCatalogIamBinding',
