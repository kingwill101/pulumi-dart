...
/// {@template pulumi_biglake_iceberg_table_iceberg_table_args_doc}
/// The set of arguments for IcebergTable.
/// {@endtemplate}
/// {@macro pulumi_biglake_iceberg_table_iceberg_table_args_doc}
class IcebergTableArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'schema': pulumi.Input.mapInputValue<IcebergTableSchema, Map<String, dynamic>>(schema, (value) => value.toMap()),
      'sortOrder': ?pulumi.Input.mapOptionalInputValue<IcebergTableSortOrder, Map<String, dynamic>>(sortOrder, (value) => value.toMap()),
    };
  }

  factory IcebergTableArgs.fromMap(Map<String, dynamic> map) {
    return IcebergTableArgs(
      ...
      schema: pulumi.Input.fromValue(IcebergTableSchema.fromMap((map['schema']! as Map).cast<String, dynamic>())),
