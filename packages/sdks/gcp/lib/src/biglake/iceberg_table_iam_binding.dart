...
import 'iceberg_table_iam_binding_args.dart';
import 'iceberg_table_iam_binding_condition.dart';
import 'iceberg_table_iam_binding_state.dart';
...
class IcebergTableIamBinding extends pulumi.CustomResource {
  ...
  late final pulumi.Output<IcebergTableIamBindingCondition?> condition;
  ...
  /// Creates a new [IcebergTableIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [IcebergTableIamBinding]. {@macro pulumi_biglake_iceberg_table_iam_binding_iceberg_table_iam_binding_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  IcebergTableIamBinding(
    String name, {
    IcebergTableIamBindingArgs? args,
  ...
  /// Gets an existing [IcebergTableIamBinding] resource's state with the given [name] and [id].
  static IcebergTableIamBinding get(
    String name,
