...
import 'iceberg_catalog_iam_member_state.dart';
...
class IcebergCatalogIamMember extends pulumi.CustomResource {
  ...
  IcebergCatalogIamMember(
    ...
    condition = registerOutput<IcebergCatalogIamMemberCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return IcebergCatalogIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [IcebergCatalogIamMember] resource's state with the given [name] and [id].
  static IcebergCatalogIamMember get(
    String name,
    pulumi.Input<String> id, {
    IcebergCatalogIamMemberState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return IcebergCatalogIamMember._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [IcebergCatalogIamMember] resource.
  IcebergCatalogIamMember.reference(String urn)
    : super(
        'gcp:biglake/icebergCatalogIamMember:IcebergCatalogIamMember',
