...
import 'iceberg_namespace_iam_member_args.dart';
import 'iceberg_namespace_iam_member_condition.dart';
import 'iceberg_namespace_iam_member_state.dart';
...
class IcebergNamespaceIamMember extends pulumi.CustomResource {
  /// The name of the IcebergCatalog.
  /// Used to find the parent resource to bind the IAM policy to
  late final pulumi.Output<String> catalog;
  late final pulumi.Output<IcebergNamespaceIamMemberCondition?> condition;
  ...
  /// Creates a new [IcebergNamespaceIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [IcebergNamespaceIamMember]. {@macro pulumi_biglake_iceberg_namespace_iam_member_iceberg_namespace_iam_member_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  IcebergNamespaceIamMember(
    String name, {
    IcebergNamespaceIamMemberArgs? args,
  ...
  /// Gets an existing [IcebergNamespaceIamMember] resource's state with the given [name] and [id].
  static IcebergNamespaceIamMember get(
    String name,
  ...
  IcebergNamespaceIamMember._get(
    String name, {
