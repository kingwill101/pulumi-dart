...
class HiveDatabaseIamPolicyState {
  ...
  /// Creates a new [HiveDatabaseIamPolicyState].
  ...
  const HiveDatabaseIamPolicyState({
    this.catalog,
    this.etag,
    this.name,
    this.policyData,
  ...
  factory HiveDatabaseIamPolicyState.fromMap(Map<String, dynamic> map) {
    return HiveDatabaseIamPolicyState(
