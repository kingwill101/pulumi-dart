...
import 'hive_database_iam_member_args.dart';
import 'hive_database_iam_member_condition.dart';
import 'hive_database_iam_member_state.dart';
...
class HiveDatabaseIamMember extends pulumi.CustomResource {
  /// Hive catalog where the database to create is located.
  /// Used to find the parent resource to bind the IAM policy to
  late final pulumi.Output<String> catalog;
  late final pulumi.Output<HiveDatabaseIamMemberCondition?> condition;
  ...
  /// Creates a new [HiveDatabaseIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [HiveDatabaseIamMember]. {@macro pulumi_biglake_hive_database_iam_member_hive_database_iam_member_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  HiveDatabaseIamMember(
    String name, {
    HiveDatabaseIamMemberArgs? args,
  ...
  /// Gets an existing [HiveDatabaseIamMember] resource's state with the given [name] and [id].
  static HiveDatabaseIamMember get(
    String name,
