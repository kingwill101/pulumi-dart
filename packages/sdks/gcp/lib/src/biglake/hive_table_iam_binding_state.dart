...
class HiveTableIamBindingState {
  ...
  final pulumi.Input<HiveTableIamBindingCondition?>? condition;
  ...
  /// Creates a new [HiveTableIamBindingState].
  ...
  const HiveTableIamBindingState({
    this.catalog,
    this.condition,
    this.database,
    this.etag,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'catalog': ?catalog,
      'condition': ?pulumi.Input.mapOptionalInputValue<HiveTableIamBindingCondition, Map<String, dynamic>>(condition, (value) => value.toMap()),
      'database': ?database,
      'etag': ?etag,
      'members': ?members,
      'name': ?name,
  ...
  factory HiveTableIamBindingState.fromMap(Map<String, dynamic> map) {
    return HiveTableIamBindingState(
      ...
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HiveTableIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
