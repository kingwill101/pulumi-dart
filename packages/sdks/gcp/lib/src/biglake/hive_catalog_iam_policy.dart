...
import 'hive_catalog_iam_policy_args.dart';
import 'hive_catalog_iam_policy_state.dart';
...
class HiveCatalogIamPolicy extends pulumi.CustomResource {
  ...
  /// Creates a new [HiveCatalogIamPolicy].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [HiveCatalogIamPolicy]. {@macro pulumi_biglake_hive_catalog_iam_policy_hive_catalog_iam_policy_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  HiveCatalogIamPolicy(
    String name, {
    HiveCatalogIamPolicyArgs? args,
  ...
  /// Gets an existing [HiveCatalogIamPolicy] resource's state with the given [name] and [id].
  static HiveCatalogIamPolicy get(
    String name,
    pulumi.Input<String> id, {
    HiveCatalogIamPolicyState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return HiveCatalogIamPolicy._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [HiveCatalogIamPolicy] resource.
  HiveCatalogIamPolicy.reference(String urn)
    : super(
        'gcp:biglake/hiveCatalogIamPolicy:HiveCatalogIamPolicy',
