...
/// {@template pulumi_biglake_hive_database_iam_member_hive_database_iam_member_args_doc}
/// The set of arguments for HiveDatabaseIamMember.
/// {@endtemplate}
/// {@macro pulumi_biglake_hive_database_iam_member_hive_database_iam_member_args_doc}
class HiveDatabaseIamMemberArgs {
  ...
  /// Creates a new [HiveDatabaseIamMemberArgs].
  ...
  const HiveDatabaseIamMemberArgs({
  ...
  factory HiveDatabaseIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return HiveDatabaseIamMemberArgs(
