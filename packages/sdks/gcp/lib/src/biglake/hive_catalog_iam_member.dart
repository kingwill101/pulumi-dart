...
import 'hive_catalog_iam_member_args.dart';
import 'hive_catalog_iam_member_condition.dart';
import 'hive_catalog_iam_member_state.dart';
...
class HiveCatalogIamMember extends pulumi.CustomResource {
  late final pulumi.Output<HiveCatalogIamMemberCondition?> condition;
  ...
  /// Creates a new [HiveCatalogIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [HiveCatalogIamMember]. {@macro pulumi_biglake_hive_catalog_iam_member_hive_catalog_iam_member_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  HiveCatalogIamMember(
    String name, {
    HiveCatalogIamMemberArgs? args,
    ...
    condition = registerOutput<HiveCatalogIamMemberCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return HiveCatalogIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [HiveCatalogIamMember] resource's state with the given [name] and [id].
  static HiveCatalogIamMember get(
    String name,
    pulumi.Input<String> id, {
    HiveCatalogIamMemberState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return HiveCatalogIamMember._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [HiveCatalogIamMember] resource.
  HiveCatalogIamMember.reference(String urn)
    : super(
        'gcp:biglake/hiveCatalogIamMember:HiveCatalogIamMember',
