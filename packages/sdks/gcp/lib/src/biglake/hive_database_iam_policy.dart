...
import 'hive_database_iam_policy_args.dart';
import 'hive_database_iam_policy_state.dart';
...
class HiveDatabaseIamPolicy extends pulumi.CustomResource {
  ...
  /// Creates a new [HiveDatabaseIamPolicy].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [HiveDatabaseIamPolicy]. {@macro pulumi_biglake_hive_database_iam_policy_hive_database_iam_policy_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  HiveDatabaseIamPolicy(
    String name, {
    HiveDatabaseIamPolicyArgs? args,
  ...
  /// Gets an existing [HiveDatabaseIamPolicy] resource's state with the given [name] and [id].
  static HiveDatabaseIamPolicy get(
    String name,
