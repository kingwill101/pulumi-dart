...
class GetClusterDiscoveryEndpoint {
  ...
  factory GetClusterDiscoveryEndpoint.fromMap(Map<String, dynamic> map) {
    return GetClusterDiscoveryEndpoint(
      ...
      pscConfigs: (pulumi.Input.decodeList<GetClusterDiscoveryEndpointPscConfig>(map['pscConfigs'], (value) => GetClusterDiscoveryEndpointPscConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
