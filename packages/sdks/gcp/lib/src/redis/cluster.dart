...
class Cluster extends pulumi.CustomResource {
  ...
  Cluster(
    ...
    this.automatedBackupConfig = registerOutput<ClusterAutomatedBackupConfig?>('automatedBackupConfig');
    ...
    this.crossClusterReplicationConfig = registerOutput<ClusterCrossClusterReplicationConfig>('crossClusterReplicationConfig');
    this.deletionProtectionEnabled = registerOutput<bool?>('deletionProtectionEnabled');
    this.discoveryEndpoints = registerOutput<List<ClusterDiscoveryEndpoint>>('discoveryEndpoints');
    ...
    this.maintenancePolicy = registerOutput<ClusterMaintenancePolicy?>('maintenancePolicy');
    this.maintenanceSchedules = registerOutput<List<ClusterMaintenanceSchedule>>('maintenanceSchedules');
    this.maintenanceVersion = registerOutput<String?>('maintenanceVersion');
    this.managedBackupSource = registerOutput<ClusterManagedBackupSource?>('managedBackupSource');
    this.managedServerCas = registerOutput<List<ClusterManagedServerCa>>('managedServerCas');
    this.name = registerOutput<String>('name');
    this.nodeType = registerOutput<String>('nodeType');
    this.persistenceConfig = registerOutput<ClusterPersistenceConfig>('persistenceConfig');
    ...
    this.pscConnections = registerOutput<List<ClusterPscConnection>>('pscConnections');
    this.pscServiceAttachments = registerOutput<List<ClusterPscServiceAttachment>>('pscServiceAttachments');
    ...
    this.zoneDistributionConfig = registerOutput<ClusterZoneDistributionConfig>('zoneDistributionConfig');
  }
