...
class GetClusterCrossClusterReplicationConfigMembership {
  ...
  final pulumi.Input<
    List<GetClusterCrossClusterReplicationConfigMembershipPrimaryCluster>
  >
  primaryClusters;

  /// List of secondary clusters that are replicating from the primary cluster.
  final pulumi.Input<
    List<GetClusterCrossClusterReplicationConfigMembershipSecondaryCluster>
  >
  secondaryClusters;
    ...
    return GetClusterCrossClusterReplicationConfigMembership(
      primaryClusters: pulumi.Input.fromValue(
        ...
        >(
          map['primaryClusters']!,
          (value) =>
              GetClusterCrossClusterReplicationConfigMembershipPrimaryCluster.fromMap(
      ...
      secondaryClusters: pulumi.Input.fromValue(
        ...
        >(
          ...
          (value) =>
              GetClusterCrossClusterReplicationConfigMembershipSecondaryCluster.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
