...
class GetClusterCrossClusterReplicationConfigMembership {
  ...
  factory GetClusterCrossClusterReplicationConfigMembership.fromMap(Map<String, dynamic> map) {
    return GetClusterCrossClusterReplicationConfigMembership(
      primaryClusters: (pulumi.Input.decodeList<GetClusterCrossClusterReplicationConfigMembershipPrimaryCluster>(map['primaryClusters'], (value) => GetClusterCrossClusterReplicationConfigMembershipPrimaryCluster.fromMap((value as Map).cast<String, dynamic>()))).input(),
      secondaryClusters: (pulumi.Input.decodeList<GetClusterCrossClusterReplicationConfigMembershipSecondaryCluster>(map['secondaryClusters'], (value) => GetClusterCrossClusterReplicationConfigMembershipSecondaryCluster.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
