...
class GetClusterPersistenceConfig {
    ...
    return <String, dynamic>{
      'aofConfigs':
          pulumi.Input.mapInputValue<
            List<GetClusterPersistenceConfigAofConfig>,
      ...
      'rdbConfigs':
          pulumi.Input.mapInputValue<
            List<GetClusterPersistenceConfigRdbConfig>,
            List<Map<String, dynamic>>
          >(
            rdbConfigs,
            (value) =>
  ...
  factory GetClusterPersistenceConfig.fromMap(Map<String, dynamic> map) {
    return GetClusterPersistenceConfig(
      aofConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetClusterPersistenceConfigAofConfig>(
          map['aofConfigs']!,
      ...
      rdbConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetClusterPersistenceConfigRdbConfig>(
          map['rdbConfigs']!,
