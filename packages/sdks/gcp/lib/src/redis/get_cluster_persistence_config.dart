...
class GetClusterPersistenceConfig {
  ...
  factory GetClusterPersistenceConfig.fromMap(Map<String, dynamic> map) {
    return GetClusterPersistenceConfig(
      aofConfigs: (pulumi.Input.decodeList<GetClusterPersistenceConfigAofConfig>(map['aofConfigs'], (value) => GetClusterPersistenceConfigAofConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
      mode: (map['mode'] as String).input(),
      rdbConfigs: (pulumi.Input.decodeList<GetClusterPersistenceConfigRdbConfig>(map['rdbConfigs'], (value) => GetClusterPersistenceConfigRdbConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
