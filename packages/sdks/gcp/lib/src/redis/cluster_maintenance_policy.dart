...
class ClusterMaintenancePolicy {
  ...
  final pulumi.Input<List<ClusterMaintenancePolicyWeeklyMaintenanceWindow>>?
    ...
    return <String, dynamic>{
      ...
      'weeklyMaintenanceWindows':
          ?pulumi.Input.mapOptionalInputValue<
            List<ClusterMaintenancePolicyWeeklyMaintenanceWindow>,
  ...
  factory ClusterMaintenancePolicy.fromMap(Map<String, dynamic> map) {
    return ClusterMaintenancePolicy(
      ...
      weeklyMaintenanceWindows: (() {
        final guardedValue = map['weeklyMaintenanceWindows'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => ClusterMaintenancePolicyWeeklyMaintenanceWindow.fromMap(
