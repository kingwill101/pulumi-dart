...
class ClusterPersistenceConfig {
  ...
  factory ClusterPersistenceConfig.fromMap(Map<String, dynamic> map) {
    return ClusterPersistenceConfig(
      aofConfig: (() { final guardedValue = map['aofConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterPersistenceConfigAofConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      mode: (() { final guardedValue = map['mode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      rdbConfig: (() { final guardedValue = map['rdbConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterPersistenceConfigRdbConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
