...
class GetClusterStateInfo {
  ...
  factory GetClusterStateInfo.fromMap(Map<String, dynamic> map) {
    return GetClusterStateInfo(
      updateInfos: pulumi.Input.fromValue(pulumi.Input.decodeList<GetClusterStateInfoUpdateInfo>(map['updateInfos']!, (value) => GetClusterStateInfoUpdateInfo.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
