...
class InstanceMaintenancePolicyWeeklyMaintenanceWindowStartTime {
  ...
  /// Creates a new [InstanceMaintenancePolicyWeeklyMaintenanceWindowStartTime].
  ...
  const InstanceMaintenancePolicyWeeklyMaintenanceWindowStartTime({
    this.hours,
    this.minutes,
    this.nanos,
    this.seconds,
