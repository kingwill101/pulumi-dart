...
class GetClusterMaintenancePolicyWeeklyMaintenanceWindow {
  ...
  factory GetClusterMaintenancePolicyWeeklyMaintenanceWindow.fromMap(Map<String, dynamic> map) {
    return GetClusterMaintenancePolicyWeeklyMaintenanceWindow(
      ...
      startTimes: (pulumi.Input.decodeList<GetClusterMaintenancePolicyWeeklyMaintenanceWindowStartTime>(map['startTimes'], (value) => GetClusterMaintenancePolicyWeeklyMaintenanceWindowStartTime.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
