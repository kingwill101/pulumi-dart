...
class ClusterAclPolicyRule {
  ...
  /// Creates a new [ClusterAclPolicyRule].
  ...
  factory ClusterAclPolicyRule.fromMap(Map<String, dynamic> map) {
    return ClusterAclPolicyRule(
