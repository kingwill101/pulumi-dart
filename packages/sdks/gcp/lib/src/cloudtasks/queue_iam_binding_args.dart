...
class QueueIamBindingArgs {
  ...
  factory QueueIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return QueueIamBindingArgs(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(QueueIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
