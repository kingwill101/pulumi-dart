...
/// {@template pulumi_cloudtasks_get_queue_iam_policy_get_queue_iam_policy_args_doc}
/// Arguments for getQueueIamPolicy.
/// {@endtemplate}
/// {@macro pulumi_cloudtasks_get_queue_iam_policy_get_queue_iam_policy_args_doc}
class GetQueueIamPolicyArgs {
  ...
  GetQueueIamPolicyArgs({this.location, required this.name, this.project});
