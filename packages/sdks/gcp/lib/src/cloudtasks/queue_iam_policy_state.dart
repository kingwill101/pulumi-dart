...
class QueueIamPolicyState {
  ...
  /// Creates a new [QueueIamPolicyState].
  ...
  factory QueueIamPolicyState.fromMap(Map<String, dynamic> map) {
    return QueueIamPolicyState(
