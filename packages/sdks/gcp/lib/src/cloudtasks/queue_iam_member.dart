...
import 'queue_iam_member_condition.dart';
import 'queue_iam_member_state.dart';
...
class QueueIamMember extends pulumi.CustomResource {
  late final pulumi.Output<QueueIamMemberCondition?> condition;
  ...
  /// Creates a new [QueueIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [QueueIamMember]. {@macro pulumi_cloudtasks_queue_iam_member_queue_iam_member_args_doc}
  ...
  QueueIamMember(
    ...
    condition = registerOutput<QueueIamMemberCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return QueueIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [QueueIamMember] resource's state with the given [name] and [id].
  static QueueIamMember get(
    String name,
    pulumi.Input<String> id, {
    QueueIamMemberState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return QueueIamMember._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [QueueIamMember] resource.
  QueueIamMember.reference(String urn)
    : super(
        'gcp:cloudtasks/queueIamMember:QueueIamMember',
