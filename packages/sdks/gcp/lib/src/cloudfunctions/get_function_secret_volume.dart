...
class GetFunctionSecretVolume {
  ...
  factory GetFunctionSecretVolume.fromMap(Map<String, dynamic> map) {
    return GetFunctionSecretVolume(
      ...
      versions: pulumi.Input.fromValue(pulumi.Input.decodeList<GetFunctionSecretVolumeVersion>(map['versions']!, (value) => GetFunctionSecretVolumeVersion.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
