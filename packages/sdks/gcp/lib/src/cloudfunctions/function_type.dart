...
class FunctionType extends pulumi.CustomResource {
  ...
  FunctionType(
    ...
    this.automaticUpdatePolicy = registerOutput<Map<String, dynamic>>('automaticUpdatePolicy');
    this.availableMemoryMb = registerOutput<int?>('availableMemoryMb');
    this.buildEnvironmentVariables = registerOutput<Map<String, String>?>('buildEnvironmentVariables');
    ...
    this.httpsTriggerSecurityLevel = registerOutput<String>('httpsTriggerSecurityLevel');
    ...
    this.onDeployUpdatePolicy = registerOutput<FunctionOnDeployUpdatePolicy?>('onDeployUpdatePolicy');
    this.project = registerOutput<String>('project');
    this.pulumiLabels = registerOutput<Map<String, String>>('pulumiLabels');
    this.region = registerOutput<String>('region');
    this.runtime = registerOutput<String>('runtime');
    this.secretEnvironmentVariables = registerOutput<List<FunctionSecretEnvironmentVariable>?>('secretEnvironmentVariables');
    this.secretVolumes = registerOutput<List<FunctionSecretVolume>?>('secretVolumes');
    ...
    this.sourceRepository = registerOutput<FunctionSourceRepository?>('sourceRepository');
    ...
    this.vpcConnectorEgressSettings = registerOutput<String>('vpcConnectorEgressSettings');
  }
