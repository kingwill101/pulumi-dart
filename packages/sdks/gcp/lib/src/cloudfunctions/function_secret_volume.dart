...
class FunctionSecretVolume {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'projectId': ?projectId,
      'secret': secret,
      'versions': ?versions == null ? null : pulumi.Input.encodeList<FunctionSecretVolumeVersion, Map<String, dynamic>>(versions!, (value) => value.toMap()),
    };
  }
  ...
  factory FunctionSecretVolume.fromMap(Map<String, dynamic> map) {
    return FunctionSecretVolume(
      ...
      versions: map['versions'] == null ? null : pulumi.Input.decodeList<FunctionSecretVolumeVersion>(map['versions'], (value) => FunctionSecretVolumeVersion.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
