...
class FunctionEventTrigger {
  ...
  factory FunctionEventTrigger.fromMap(Map<String, dynamic> map) {
    return FunctionEventTrigger(
      ...
      failurePolicy: (() { final guardedValue = map['failurePolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FunctionEventTriggerFailurePolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
