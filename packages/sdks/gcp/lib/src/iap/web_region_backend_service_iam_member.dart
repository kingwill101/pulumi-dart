...
import 'web_region_backend_service_iam_member_state.dart';
...
class WebRegionBackendServiceIamMember extends pulumi.CustomResource {
  ...
  /// Creates a new [WebRegionBackendServiceIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [WebRegionBackendServiceIamMember]. {@macro pulumi_iap_web_region_backend_service_iam_member_web_region_backend_service_iam_member_args_doc}
  ...
  /// Gets an existing [WebRegionBackendServiceIamMember] resource's state with the given [name] and [id].
  static WebRegionBackendServiceIamMember get(
    String name,
  ...
  WebRegionBackendServiceIamMember._get(
    String name, {
