...
import 'web_type_app_enging_iam_member_args.dart';
import 'web_type_app_enging_iam_member_condition.dart';
import 'web_type_app_enging_iam_member_state.dart';
...
class WebTypeAppEngingIamMember extends pulumi.CustomResource {
  ...
  late final pulumi.Output<WebTypeAppEngingIamMemberCondition?> condition;
  ...
  /// Creates a new [WebTypeAppEngingIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [WebTypeAppEngingIamMember]. {@macro pulumi_iap_web_type_app_enging_iam_member_web_type_app_enging_iam_member_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  WebTypeAppEngingIamMember(
    String name, {
    WebTypeAppEngingIamMemberArgs? args,
    ...
    this.condition = registerOutput<WebTypeAppEngingIamMemberCondition?>('condition');
  ...
  /// Gets an existing [WebTypeAppEngingIamMember] resource's state with the given [name] and [id].
  static WebTypeAppEngingIamMember get(
    String name,
  ...
  WebTypeAppEngingIamMember._get(
    String name, {
