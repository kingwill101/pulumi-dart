...
import 'web_backend_service_iam_member_state.dart';
...
class WebBackendServiceIamMember extends pulumi.CustomResource {
  ...
  WebBackendServiceIamMember(
    ...
    condition = registerOutput<WebBackendServiceIamMemberCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return WebBackendServiceIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [WebBackendServiceIamMember] resource's state with the given [name] and [id].
  static WebBackendServiceIamMember get(
    String name,
    pulumi.Input<String> id, {
    WebBackendServiceIamMemberState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return WebBackendServiceIamMember._get(
      name,
      state: state?.toMap(),
  ...
  WebBackendServiceIamMember._get(
    String name, {
  ...
  /// Creates a typed reference to an existing [WebBackendServiceIamMember] resource.
  WebBackendServiceIamMember.reference(String urn)
    : super(
        'gcp:iap/webBackendServiceIamMember:WebBackendServiceIamMember',
