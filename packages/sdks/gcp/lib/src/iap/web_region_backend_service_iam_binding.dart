...
import 'web_region_backend_service_iam_binding_args.dart';
import 'web_region_backend_service_iam_binding_condition.dart';
import 'web_region_backend_service_iam_binding_state.dart';
...
/// }
///
/// resource "gcp_iap_webregionbackendserviceiampolicy" "policy" {
///   project                    = default.project
///   region                     = default.region
///   web_region_backend_service = default.name
...
/// }
///
/// resource "gcp_iap_webregionbackendserviceiambinding" "binding" {
///   project                    = default.project
///   region                     = default.region
///   web_region_backend_service = default.name
///   role                       = "roles/iap.httpsResourceAccessor"
...
/// }
///
/// resource "gcp_iap_webregionbackendserviceiammember" "member" {
///   project                    = default.project
///   region                     = default.region
///   web_region_backend_service = default.name
///   role                       = "roles/iap.httpsResourceAccessor"
...
class WebRegionBackendServiceIamBinding extends pulumi.CustomResource {
  ...
  late final pulumi.Output<WebRegionBackendServiceIamBindingCondition?> condition;
  ...
  /// Creates a new [WebRegionBackendServiceIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [WebRegionBackendServiceIamBinding]. {@macro pulumi_iap_web_region_backend_service_iam_binding_web_region_backend_service_iam_binding_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  WebRegionBackendServiceIamBinding(
    String name, {
    WebRegionBackendServiceIamBindingArgs? args,
    ...
    condition = registerOutput<WebRegionBackendServiceIamBindingCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return WebRegionBackendServiceIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [WebRegionBackendServiceIamBinding] resource's state with the given [name] and [id].
  static WebRegionBackendServiceIamBinding get(
    String name,
    pulumi.Input<String> id, {
    WebRegionBackendServiceIamBindingState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return WebRegionBackendServiceIamBinding._get(
      name,
      state: state?.toMap(),
  ...
  WebRegionBackendServiceIamBinding._get(
    String name, {
  ...
  /// Creates a typed reference to an existing [WebRegionBackendServiceIamBinding] resource.
  WebRegionBackendServiceIamBinding.reference(String urn)
    : super(
        'gcp:iap/webRegionBackendServiceIamBinding:WebRegionBackendServiceIamBinding',
