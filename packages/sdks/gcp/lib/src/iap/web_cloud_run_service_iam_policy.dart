...
import 'web_cloud_run_service_iam_policy_state.dart';
...
class WebCloudRunServiceIamPolicy extends pulumi.CustomResource {
  ...
  /// Gets an existing [WebCloudRunServiceIamPolicy] resource's state with the given [name] and [id].
  static WebCloudRunServiceIamPolicy get(
    String name,
  ...
  WebCloudRunServiceIamPolicy._get(
    String name, {
