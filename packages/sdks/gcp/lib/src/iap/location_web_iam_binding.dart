...
import 'location_web_iam_binding_args.dart';
import 'location_web_iam_binding_condition.dart';
import 'location_web_iam_binding_state.dart';
...
class LocationWebIamBinding extends pulumi.CustomResource {
  ...
  late final pulumi.Output<LocationWebIamBindingCondition?> condition;
  ...
  /// Creates a new [LocationWebIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [LocationWebIamBinding]. {@macro pulumi_iap_location_web_iam_binding_location_web_iam_binding_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  LocationWebIamBinding(
    String name, {
    LocationWebIamBindingArgs? args,
    pulumi.CustomResourceOptions? options,
  }) : super(
          'gcp:iap/locationWebIamBinding:LocationWebIamBinding',
          name,
          pulumi.Input.mapToInputs(args?.toMap() ?? const {}),
          pulumi.CustomResourceOptions(version: '9.35.1').merge(options),
        ) {
    condition = registerOutput<LocationWebIamBindingCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return LocationWebIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [LocationWebIamBinding] resource's state with the given [name] and [id].
  static LocationWebIamBinding get(
    String name,
    pulumi.Input<String> id, {
    LocationWebIamBindingState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return LocationWebIamBinding._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [LocationWebIamBinding] resource.
  LocationWebIamBinding.reference(String urn)
    : super(
        'gcp:iap/locationWebIamBinding:LocationWebIamBinding',
