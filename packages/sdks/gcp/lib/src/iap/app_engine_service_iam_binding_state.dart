...
import 'app_engine_service_iam_binding_condition.dart';

/// Input properties used for looking up and filtering AppEngineServiceIamBinding resources.
class AppEngineServiceIamBindingState {
  /// Used to find the parent resource to bind the IAM policy to
  final pulumi.Input<String>? appId;
  /// An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
  /// Structure is documented below.
  final pulumi.Input<AppEngineServiceIamBindingCondition>? condition;
  ...
  /// Creates a new [AppEngineServiceIamBindingState].
  ...
  AppEngineServiceIamBindingState({
    ...
    pulumi.Output<AppEngineServiceIamBindingCondition>? condition,
    ...
    pulumi.Output<String>? service,
      ...
      condition = pulumi.Input.asOptionalInput<AppEngineServiceIamBindingCondition>(condition),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'appId': ?appId,
      'condition': ?pulumi.Input.mapOptionalInputValue<AppEngineServiceIamBindingCondition, Map<String, dynamic>>(condition, (value) => value.toMap()),
      'etag': ?etag,
      'members': ?members,
      'project': ?project,
      'role': ?role,
  ...
  factory AppEngineServiceIamBindingState.fromMap(Map<String, dynamic> map) {
    return AppEngineServiceIamBindingState(
      ...
      condition: map['condition'] == null ? null : pulumi.Output.create<AppEngineServiceIamBindingCondition>(AppEngineServiceIamBindingCondition.fromMap((map['condition'] as Map).cast<String, dynamic>())),
