...
import 'web_region_forwarding_rule_service_iam_member_args.dart';
import 'web_region_forwarding_rule_service_iam_member_condition.dart';
import 'web_region_forwarding_rule_service_iam_member_state.dart';
...
class WebRegionForwardingRuleServiceIamMember extends pulumi.CustomResource {
  ...
  late final pulumi.Output<WebRegionForwardingRuleServiceIamMemberCondition?> condition;
  ...
  /// Creates a new [WebRegionForwardingRuleServiceIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [WebRegionForwardingRuleServiceIamMember]. {@macro pulumi_iap_web_region_forwarding_rule_service_iam_member_web_region_forwarding_rule_service_iam_member_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  WebRegionForwardingRuleServiceIamMember(
    String name, {
    WebRegionForwardingRuleServiceIamMemberArgs? args,
  ...
  /// Gets an existing [WebRegionForwardingRuleServiceIamMember] resource's state with the given [name] and [id].
  static WebRegionForwardingRuleServiceIamMember get(
    String name,
  ...
  WebRegionForwardingRuleServiceIamMember._get(
    String name, {
