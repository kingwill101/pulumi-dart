...
class AgentRegistryAgentIamBindingState {
  ...
  /// Creates a new [AgentRegistryAgentIamBindingState].
  ...
  const AgentRegistryAgentIamBindingState({
    this.agentId,
    this.condition,
    this.etag,
    this.location,
  ...
  factory AgentRegistryAgentIamBindingState.fromMap(Map<String, dynamic> map) {
    return AgentRegistryAgentIamBindingState(
