...
/// {@template pulumi_iap_app_engine_version_iam_binding_app_engine_version_iam_binding_args_doc}
/// The set of arguments for AppEngineVersionIamBinding.
/// {@endtemplate}
/// {@macro pulumi_iap_app_engine_version_iam_binding_app_engine_version_iam_binding_args_doc}
class AppEngineVersionIamBindingArgs {
  ...
  /// Creates a new [AppEngineVersionIamBindingArgs].
  ...
  AppEngineVersionIamBindingArgs({
    ...
    pulumi.Output<AppEngineVersionIamBindingCondition>? condition,
    ...
    required pulumi.Output<String> versionId,
      ...
      condition = pulumi.Input.asOptionalInput<AppEngineVersionIamBindingCondition>(condition),
  ...
  factory AppEngineVersionIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return AppEngineVersionIamBindingArgs(
      ...
      condition: map['condition'] == null ? null : pulumi.Output.create<AppEngineVersionIamBindingCondition>(AppEngineVersionIamBindingCondition.fromMap((map['condition'] as Map).cast<String, dynamic>())),
