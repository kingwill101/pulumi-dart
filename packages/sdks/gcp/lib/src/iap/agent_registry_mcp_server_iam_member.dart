...
import 'agent_registry_mcp_server_iam_member_args.dart';
import 'agent_registry_mcp_server_iam_member_condition.dart';
import 'agent_registry_mcp_server_iam_member_state.dart';
...
class AgentRegistryMcpServerIamMember extends pulumi.CustomResource {
  /// An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
  /// Structure is documented below.
  late final pulumi.Output<AgentRegistryMcpServerIamMemberCondition?> condition;
  ...
  /// Creates a new [AgentRegistryMcpServerIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [AgentRegistryMcpServerIamMember]. {@macro pulumi_iap_agent_registry_mcp_server_iam_member_agent_registry_mcp_server_iam_member_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  AgentRegistryMcpServerIamMember(
    String name, {
    AgentRegistryMcpServerIamMemberArgs? args,
  ...
  /// Gets an existing [AgentRegistryMcpServerIamMember] resource's state with the given [name] and [id].
  static AgentRegistryMcpServerIamMember get(
    String name,
  ...
  AgentRegistryMcpServerIamMember._get(
    String name, {
