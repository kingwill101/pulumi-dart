...
class AgentRegistryMcpServerIamMemberState {
  ...
  /// Creates a new [AgentRegistryMcpServerIamMemberState].
  ...
  const AgentRegistryMcpServerIamMemberState({
    this.condition,
    this.etag,
    this.location,
    this.mcpServerId,
  ...
  factory AgentRegistryMcpServerIamMemberState.fromMap(Map<String, dynamic> map) {
    return AgentRegistryMcpServerIamMemberState(
