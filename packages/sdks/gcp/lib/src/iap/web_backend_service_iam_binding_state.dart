...
class WebBackendServiceIamBindingState {
  ...
  /// Creates a new [WebBackendServiceIamBindingState].
  ...
  const WebBackendServiceIamBindingState({
    this.condition,
    this.etag,
    this.members,
    this.project,
  ...
  factory WebBackendServiceIamBindingState.fromMap(Map<String, dynamic> map) {
    return WebBackendServiceIamBindingState(
