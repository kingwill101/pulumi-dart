...
class AgentRegistryMcpServerIamBindingState {
  ...
  /// Creates a new [AgentRegistryMcpServerIamBindingState].
  ...
  const AgentRegistryMcpServerIamBindingState({
    this.condition,
    this.etag,
    this.location,
    this.mcpServerId,
  ...
  factory AgentRegistryMcpServerIamBindingState.fromMap(Map<String, dynamic> map) {
    return AgentRegistryMcpServerIamBindingState(
