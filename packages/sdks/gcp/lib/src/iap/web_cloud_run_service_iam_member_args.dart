...
class WebCloudRunServiceIamMemberArgs {
  ...
  const WebCloudRunServiceIamMemberArgs({
  ...
  factory WebCloudRunServiceIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return WebCloudRunServiceIamMemberArgs(
      ...
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WebCloudRunServiceIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
