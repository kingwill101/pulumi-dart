...
import 'web_cloud_run_service_iam_binding_condition.dart';

/// {@template pulumi_iap_web_cloud_run_service_iam_binding_web_cloud_run_service_iam_binding_args_doc}
/// The set of arguments for WebCloudRunServiceIamBinding.
/// {@endtemplate}
/// {@macro pulumi_iap_web_cloud_run_service_iam_binding_web_cloud_run_service_iam_binding_args_doc}
class WebCloudRunServiceIamBindingArgs {
  /// Used to find the parent resource to bind the IAM policy to
  final pulumi.Input<String> cloudRunServiceName;
  /// An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
  /// Structure is documented below.
  final pulumi.Input<WebCloudRunServiceIamBindingCondition>? condition;
  ...
  /// Creates a new [WebCloudRunServiceIamBindingArgs].
  ...
  WebCloudRunServiceIamBindingArgs({
    ...
    pulumi.Output<WebCloudRunServiceIamBindingCondition>? condition,
    ...
    required pulumi.Output<String> role,
      ...
      condition = pulumi.Input.asOptionalInput<WebCloudRunServiceIamBindingCondition>(condition),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'condition': ?pulumi.Input.mapOptionalInputValue<WebCloudRunServiceIamBindingCondition, Map<String, dynamic>>(condition, (value) => value.toMap()),
      'location': ?location,
      'members': members,
      'project': ?project,
      'role': role,
  ...
  factory WebCloudRunServiceIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return WebCloudRunServiceIamBindingArgs(
      ...
      condition: map['condition'] == null ? null : pulumi.Output.create<WebCloudRunServiceIamBindingCondition>(WebCloudRunServiceIamBindingCondition.fromMap((map['condition'] as Map).cast<String, dynamic>())),
