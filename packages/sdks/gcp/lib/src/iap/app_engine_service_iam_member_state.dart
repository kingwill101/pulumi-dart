...
class AppEngineServiceIamMemberState {
  ...
  /// Creates a new [AppEngineServiceIamMemberState].
  ...
  factory AppEngineServiceIamMemberState.fromMap(Map<String, dynamic> map) {
    return AppEngineServiceIamMemberState(
