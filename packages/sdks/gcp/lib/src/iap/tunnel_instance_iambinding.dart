...
import 'tunnel_instance_iambinding_args.dart';
import 'tunnel_instance_iambinding_condition.dart';
import 'tunnel_instance_iambinding_state.dart';
...
class TunnelInstanceIAMBinding extends pulumi.CustomResource {
  ...
  late final pulumi.Output<TunnelInstanceIAMBindingCondition?> condition;
  ...
  /// Creates a new [TunnelInstanceIAMBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [TunnelInstanceIAMBinding]. {@macro pulumi_iap_tunnel_instance_iambinding_tunnel_instance_iambinding_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  TunnelInstanceIAMBinding(
    String name, {
    TunnelInstanceIAMBindingArgs? args,
    ...
    this.condition = registerOutput<TunnelInstanceIAMBindingCondition?>('condition');
  ...
  /// Gets an existing [TunnelInstanceIAMBinding] resource's state with the given [name] and [id].
  static TunnelInstanceIAMBinding get(
    String name,
