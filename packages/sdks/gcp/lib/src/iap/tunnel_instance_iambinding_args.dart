...
class TunnelInstanceIAMBindingArgs {
  ...
  const TunnelInstanceIAMBindingArgs({
    this.condition,
  ...
  factory TunnelInstanceIAMBindingArgs.fromMap(Map<String, dynamic> map) {
    return TunnelInstanceIAMBindingArgs(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TunnelInstanceIAMBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
