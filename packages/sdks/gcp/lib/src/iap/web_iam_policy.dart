...
import 'web_iam_policy_state.dart';
...
class WebIamPolicy extends pulumi.CustomResource {
  ...
  /// Creates a new [WebIamPolicy].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [WebIamPolicy]. {@macro pulumi_iap_web_iam_policy_web_iam_policy_args_doc}
  ...
  /// Gets an existing [WebIamPolicy] resource's state with the given [name] and [id].
  static WebIamPolicy get(
    String name,
