...
import 'web_cloud_run_service_iam_member_state.dart';
...
/// }
///
/// resource "gcp_iap_webcloudrunserviceiampolicy" "policy" {
///   project                = default.project
///   location               = default.location
///   cloud_run_service_name = default.name
...
/// }
///
/// resource "gcp_iap_webcloudrunserviceiambinding" "binding" {
///   project                = default.project
///   location               = default.location
///   cloud_run_service_name = default.name
///   role                   = "roles/iap.httpsResourceAccessor"
...
/// }
///
/// resource "gcp_iap_webcloudrunserviceiammember" "member" {
///   project                = default.project
///   location               = default.location
///   cloud_run_service_name = default.name
///   role                   = "roles/iap.httpsResourceAccessor"
...
class WebCloudRunServiceIamMember extends pulumi.CustomResource {
  ...
  late final pulumi.Output<WebCloudRunServiceIamMemberCondition?> condition;
  ...
  /// Creates a new [WebCloudRunServiceIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [WebCloudRunServiceIamMember]. {@macro pulumi_iap_web_cloud_run_service_iam_member_web_cloud_run_service_iam_member_args_doc}
  ...
  /// Gets an existing [WebCloudRunServiceIamMember] resource's state with the given [name] and [id].
  static WebCloudRunServiceIamMember get(
    String name,
  ...
  WebCloudRunServiceIamMember._get(
    String name, {
