...
import 'web_type_app_enging_iam_binding_args.dart';
import 'web_type_app_enging_iam_binding_condition.dart';
import 'web_type_app_enging_iam_binding_state.dart';
...
class WebTypeAppEngingIamBinding extends pulumi.CustomResource {
  ...
  late final pulumi.Output<WebTypeAppEngingIamBindingCondition?> condition;
  ...
  /// Creates a new [WebTypeAppEngingIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [WebTypeAppEngingIamBinding]. {@macro pulumi_iap_web_type_app_enging_iam_binding_web_type_app_enging_iam_binding_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  WebTypeAppEngingIamBinding(
    String name, {
    WebTypeAppEngingIamBindingArgs? args,
    ...
    condition = registerOutput<WebTypeAppEngingIamBindingCondition?>(
      'condition',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return WebTypeAppEngingIamBindingCondition.fromMap(
  ...
  /// Gets an existing [WebTypeAppEngingIamBinding] resource's state with the given [name] and [id].
  static WebTypeAppEngingIamBinding get(
    String name,
  ...
  WebTypeAppEngingIamBinding._get(
    String name, {
