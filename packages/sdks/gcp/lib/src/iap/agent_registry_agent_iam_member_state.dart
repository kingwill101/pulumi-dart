...
class AgentRegistryAgentIamMemberState {
  ...
  /// Creates a new [AgentRegistryAgentIamMemberState].
  ...
  const AgentRegistryAgentIamMemberState({
    this.agentId,
    this.condition,
    this.etag,
    this.location,
  ...
  factory AgentRegistryAgentIamMemberState.fromMap(Map<String, dynamic> map) {
    return AgentRegistryAgentIamMemberState(
