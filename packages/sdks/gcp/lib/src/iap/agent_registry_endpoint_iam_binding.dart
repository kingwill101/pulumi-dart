...
import 'agent_registry_endpoint_iam_binding_args.dart';
import 'agent_registry_endpoint_iam_binding_condition.dart';
import 'agent_registry_endpoint_iam_binding_state.dart';
...
class AgentRegistryEndpointIamBinding extends pulumi.CustomResource {
  /// An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
  /// Structure is documented below.
  late final pulumi.Output<AgentRegistryEndpointIamBindingCondition?> condition;
  ...
  /// Creates a new [AgentRegistryEndpointIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [AgentRegistryEndpointIamBinding]. {@macro pulumi_iap_agent_registry_endpoint_iam_binding_agent_registry_endpoint_iam_binding_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  AgentRegistryEndpointIamBinding(
    String name, {
    AgentRegistryEndpointIamBindingArgs? args,
    ...
    condition = registerOutput<AgentRegistryEndpointIamBindingCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return AgentRegistryEndpointIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [AgentRegistryEndpointIamBinding] resource's state with the given [name] and [id].
  static AgentRegistryEndpointIamBinding get(
    String name,
    pulumi.Input<String> id, {
    AgentRegistryEndpointIamBindingState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return AgentRegistryEndpointIamBinding._get(
      name,
      state: state?.toMap(),
  ...
  AgentRegistryEndpointIamBinding._get(
    String name, {
  ...
  /// Creates a typed reference to an existing [AgentRegistryEndpointIamBinding] resource.
  AgentRegistryEndpointIamBinding.reference(String urn)
    : super(
        'gcp:iap/agentRegistryEndpointIamBinding:AgentRegistryEndpointIamBinding',
