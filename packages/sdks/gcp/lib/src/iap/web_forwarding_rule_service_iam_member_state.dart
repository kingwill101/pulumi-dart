...
class WebForwardingRuleServiceIamMemberState {
  ...
  const WebForwardingRuleServiceIamMemberState({
    this.condition,
    this.etag,
  ...
  factory WebForwardingRuleServiceIamMemberState.fromMap(Map<String, dynamic> map) {
    return WebForwardingRuleServiceIamMemberState(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WebForwardingRuleServiceIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
