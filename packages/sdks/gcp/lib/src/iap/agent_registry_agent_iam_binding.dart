...
import 'agent_registry_agent_iam_binding_args.dart';
import 'agent_registry_agent_iam_binding_condition.dart';
import 'agent_registry_agent_iam_binding_state.dart';
...
class AgentRegistryAgentIamBinding extends pulumi.CustomResource {
  /// Used to find the parent resource to bind the IAM policy to
  late final pulumi.Output<String> agentId;
  /// An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
  /// Structure is documented below.
  late final pulumi.Output<AgentRegistryAgentIamBindingCondition?> condition;
  ...
  /// Creates a new [AgentRegistryAgentIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [AgentRegistryAgentIamBinding]. {@macro pulumi_iap_agent_registry_agent_iam_binding_agent_registry_agent_iam_binding_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  AgentRegistryAgentIamBinding(
    String name, {
    AgentRegistryAgentIamBindingArgs? args,
  ...
  /// Gets an existing [AgentRegistryAgentIamBinding] resource's state with the given [name] and [id].
  static AgentRegistryAgentIamBinding get(
    String name,
  ...
  AgentRegistryAgentIamBinding._get(
    String name, {
