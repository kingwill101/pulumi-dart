...
import 'app_engine_service_iam_member_condition.dart';
import 'app_engine_service_iam_member_state.dart';
...
/// }
///
/// resource "gcp_iap_appengineserviceiampolicy" "policy" {
///   project     = version.project
///   app_id      = version.project
///   service     = version.service
...
/// }
///
/// resource "gcp_iap_appengineserviceiambinding" "binding" {
///   project = version.project
///   app_id  = version.project
///   service = version.service
///   role    = "roles/iap.httpsResourceAccessor"
...
/// }
///
/// resource "gcp_iap_appengineserviceiammember" "member" {
///   project = version.project
///   app_id  = version.project
///   service = version.service
///   role    = "roles/iap.httpsResourceAccessor"
...
class AppEngineServiceIamMember extends pulumi.CustomResource {
  ...
  /// Creates a new [AppEngineServiceIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [AppEngineServiceIamMember]. {@macro pulumi_iap_app_engine_service_iam_member_app_engine_service_iam_member_args_doc}
  ...
  /// Gets an existing [AppEngineServiceIamMember] resource's state with the given [name] and [id].
  static AppEngineServiceIamMember get(
    String name,
    pulumi.Input<String> id, {
    AppEngineServiceIamMemberState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return AppEngineServiceIamMember._get(
      name,
      state: state?.toMap(),
  ...
  AppEngineServiceIamMember._get(
    String name, {
  ...
  /// Creates a typed reference to an existing [AppEngineServiceIamMember] resource.
  AppEngineServiceIamMember.reference(String urn)
    : super(
        'gcp:iap/appEngineServiceIamMember:AppEngineServiceIamMember',
