...
import 'location_web_iam_member_args.dart';
import 'location_web_iam_member_condition.dart';
import 'location_web_iam_member_state.dart';
...
class LocationWebIamMember extends pulumi.CustomResource {
  ...
  late final pulumi.Output<LocationWebIamMemberCondition?> condition;
  ...
  /// Creates a new [LocationWebIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [LocationWebIamMember]. {@macro pulumi_iap_location_web_iam_member_location_web_iam_member_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  LocationWebIamMember(
    String name, {
    LocationWebIamMemberArgs? args,
    ...
    condition = registerOutput<LocationWebIamMemberCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return LocationWebIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [LocationWebIamMember] resource's state with the given [name] and [id].
  static LocationWebIamMember get(
    String name,
    pulumi.Input<String> id, {
    LocationWebIamMemberState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return LocationWebIamMember._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [LocationWebIamMember] resource.
  LocationWebIamMember.reference(String urn)
    : super(
        'gcp:iap/locationWebIamMember:LocationWebIamMember',
