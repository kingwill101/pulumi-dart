...
import 'agent_registry_endpoint_iam_member_args.dart';
import 'agent_registry_endpoint_iam_member_condition.dart';
import 'agent_registry_endpoint_iam_member_state.dart';
...
class AgentRegistryEndpointIamMember extends pulumi.CustomResource {
  /// An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
  /// Structure is documented below.
  late final pulumi.Output<AgentRegistryEndpointIamMemberCondition?> condition;
  ...
  /// Creates a new [AgentRegistryEndpointIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [AgentRegistryEndpointIamMember]. {@macro pulumi_iap_agent_registry_endpoint_iam_member_agent_registry_endpoint_iam_member_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  AgentRegistryEndpointIamMember(
    String name, {
    AgentRegistryEndpointIamMemberArgs? args,
  ...
  /// Gets an existing [AgentRegistryEndpointIamMember] resource's state with the given [name] and [id].
  static AgentRegistryEndpointIamMember get(
    String name,
  ...
  AgentRegistryEndpointIamMember._get(
    String name, {
