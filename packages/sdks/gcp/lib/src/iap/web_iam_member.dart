...
import 'web_iam_member_args.dart';
import 'web_iam_member_condition.dart';
import 'web_iam_member_state.dart';
...
/// }
///
/// resource "gcp_iap_webiampolicy" "policy" {
///   project     = projectService.project
...
/// }
///
/// resource "gcp_iap_webiambinding" "binding" {
///   project = projectService.project
///   role    = "roles/iap.httpsResourceAccessor"
///   members = ["user:jane@example.com"]
/// }
...
/// }
///
/// resource "gcp_iap_webiammember" "member" {
///   project = projectService.project
///   role    = "roles/iap.httpsResourceAccessor"
///   member  = "user:jane@example.com"
/// }
...
class WebIamMember extends pulumi.CustomResource {
  ...
  late final pulumi.Output<WebIamMemberCondition?> condition;
  ...
  /// Creates a new [WebIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [WebIamMember]. {@macro pulumi_iap_web_iam_member_web_iam_member_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  WebIamMember(
    String name, {
    WebIamMemberArgs? args,
    ...
    condition = registerOutput<WebIamMemberCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return WebIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [WebIamMember] resource's state with the given [name] and [id].
  static WebIamMember get(
    String name,
    pulumi.Input<String> id, {
    WebIamMemberState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return WebIamMember._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [WebIamMember] resource.
  WebIamMember.reference(String urn)
    : super(
        'gcp:iap/webIamMember:WebIamMember',
