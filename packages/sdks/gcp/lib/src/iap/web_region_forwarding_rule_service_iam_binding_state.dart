...
class WebRegionForwardingRuleServiceIamBindingState {
  ...
  /// Creates a new [WebRegionForwardingRuleServiceIamBindingState].
  ...
  WebRegionForwardingRuleServiceIamBindingState({
    pulumi.Output<WebRegionForwardingRuleServiceIamBindingCondition>? condition,
    pulumi.Output<String>? etag,
    pulumi.Output<String>? forwardingRuleRegionServiceName,
    ...
    pulumi.Output<String>? role,
      ...
      forwardingRuleRegionServiceName = pulumi.Input.asOptionalInput<String>(forwardingRuleRegionServiceName),
  ...
  factory WebRegionForwardingRuleServiceIamBindingState.fromMap(Map<String, dynamic> map) {
    return WebRegionForwardingRuleServiceIamBindingState(
      ...
      forwardingRuleRegionServiceName: map['forwardingRuleRegionServiceName'] == null ? null : pulumi.Output.create<String>(map['forwardingRuleRegionServiceName'] as String),
