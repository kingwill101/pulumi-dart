...
class WebRegionForwardingRuleServiceIamBindingState {
  ...
  final pulumi.Input<WebRegionForwardingRuleServiceIamBindingCondition>?
  condition;
  ...
  factory WebRegionForwardingRuleServiceIamBindingState.fromMap(
    ...
    return WebRegionForwardingRuleServiceIamBindingState(
      condition: (() {
        ...
        return pulumi.Input.fromValue(
          WebRegionForwardingRuleServiceIamBindingCondition.fromMap(
      ...
      forwardingRuleRegionServiceName: (() {
        final guardedValue = map['forwardingRuleRegionServiceName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      members: (() {
