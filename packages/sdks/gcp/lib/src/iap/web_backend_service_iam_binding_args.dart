...
class WebBackendServiceIamBindingArgs {
  ...
  factory WebBackendServiceIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return WebBackendServiceIamBindingArgs(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WebBackendServiceIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
