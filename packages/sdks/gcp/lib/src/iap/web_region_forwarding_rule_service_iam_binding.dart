...
class WebRegionForwardingRuleServiceIamBinding extends pulumi.CustomResource {
  ...
  WebRegionForwardingRuleServiceIamBinding(
    ...
    this.condition = registerOutput<WebRegionForwardingRuleServiceIamBindingCondition?>('condition');
    this.etag = registerOutput<String>('etag');
    this.forwardingRuleRegionServiceName = registerOutput<String>('forwardingRuleRegionServiceName');
