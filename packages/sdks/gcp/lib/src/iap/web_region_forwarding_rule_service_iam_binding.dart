...
import 'web_region_forwarding_rule_service_iam_binding_args.dart';
import 'web_region_forwarding_rule_service_iam_binding_condition.dart';
import 'web_region_forwarding_rule_service_iam_binding_state.dart';
...
/// }
///
/// resource "gcp_iap_webregionforwardingruleserviceiampolicy" "policy" {
///   project                             = default.project
///   region                              = default.region
///   forwarding_rule_region_service_name = default.name
...
/// }
///
/// resource "gcp_iap_webregionforwardingruleserviceiambinding" "binding" {
///   project                             = default.project
///   region                              = default.region
///   forwarding_rule_region_service_name = default.name
///   role                                = "roles/iap.httpsResourceAccessor"
...
/// }
///
/// resource "gcp_iap_webregionforwardingruleserviceiammember" "member" {
///   project                             = default.project
///   region                              = default.region
///   forwarding_rule_region_service_name = default.name
///   role                                = "roles/iap.httpsResourceAccessor"
...
class WebRegionForwardingRuleServiceIamBinding extends pulumi.CustomResource {
  ...
  late final pulumi.Output<WebRegionForwardingRuleServiceIamBindingCondition?> condition;
  ...
  /// Creates a new [WebRegionForwardingRuleServiceIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [WebRegionForwardingRuleServiceIamBinding]. {@macro pulumi_iap_web_region_forwarding_rule_service_iam_binding_web_region_forwarding_rule_service_iam_binding_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  WebRegionForwardingRuleServiceIamBinding(
    String name, {
    WebRegionForwardingRuleServiceIamBindingArgs? args,
  ...
  /// Gets an existing [WebRegionForwardingRuleServiceIamBinding] resource's state with the given [name] and [id].
  static WebRegionForwardingRuleServiceIamBinding get(
    String name,
    pulumi.Input<String> id, {
    WebRegionForwardingRuleServiceIamBindingState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return WebRegionForwardingRuleServiceIamBinding._get(
      name,
      state: state?.toMap(),
  ...
  WebRegionForwardingRuleServiceIamBinding._get(
    String name, {
  ...
  /// Creates a typed reference to an existing [WebRegionForwardingRuleServiceIamBinding] resource.
  WebRegionForwardingRuleServiceIamBinding.reference(String urn)
    : super(
        'gcp:iap/webRegionForwardingRuleServiceIamBinding:WebRegionForwardingRuleServiceIamBinding',
