...
import 'web_forwarding_rule_service_iam_binding_state.dart';
...
class WebForwardingRuleServiceIamBinding extends pulumi.CustomResource {
  ...
  late final pulumi.Output<WebForwardingRuleServiceIamBindingCondition?> condition;
  ...
  /// Creates a new [WebForwardingRuleServiceIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [WebForwardingRuleServiceIamBinding]. {@macro pulumi_iap_web_forwarding_rule_service_iam_binding_web_forwarding_rule_service_iam_binding_args_doc}
  ...
  /// Gets an existing [WebForwardingRuleServiceIamBinding] resource's state with the given [name] and [id].
  static WebForwardingRuleServiceIamBinding get(
    String name,
  ...
  WebForwardingRuleServiceIamBinding._get(
    String name, {
