...
import 'tunnel_iam_binding_args.dart';
import 'tunnel_iam_binding_condition.dart';
import 'tunnel_iam_binding_state.dart';
...
class TunnelIamBinding extends pulumi.CustomResource {
  ...
  late final pulumi.Output<TunnelIamBindingCondition?> condition;
  ...
  /// Creates a new [TunnelIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [TunnelIamBinding]. {@macro pulumi_iap_tunnel_iam_binding_tunnel_iam_binding_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  TunnelIamBinding(
    String name, {
    TunnelIamBindingArgs? args,
    ...
    condition = registerOutput<TunnelIamBindingCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return TunnelIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [TunnelIamBinding] resource's state with the given [name] and [id].
  static TunnelIamBinding get(
    String name,
    pulumi.Input<String> id, {
    TunnelIamBindingState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return TunnelIamBinding._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [TunnelIamBinding] resource.
  TunnelIamBinding.reference(String urn)
    : super(
        'gcp:iap/tunnelIamBinding:TunnelIamBinding',
