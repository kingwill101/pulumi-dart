...
import 'web_backend_service_iam_binding_state.dart';
...
class WebBackendServiceIamBinding extends pulumi.CustomResource {
  ...
  WebBackendServiceIamBinding(
    ...
    condition = registerOutput<WebBackendServiceIamBindingCondition?>(
      'condition',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return WebBackendServiceIamBindingCondition.fromMap(
  ...
  /// Gets an existing [WebBackendServiceIamBinding] resource's state with the given [name] and [id].
  static WebBackendServiceIamBinding get(
    String name,
  ...
  WebBackendServiceIamBinding._get(
    String name, {
