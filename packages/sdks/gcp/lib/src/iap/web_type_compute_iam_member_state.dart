...
class WebTypeComputeIamMemberState {
  ...
  /// Creates a new [WebTypeComputeIamMemberState].
  ...
  WebTypeComputeIamMemberState({
    pulumi.Output<WebTypeComputeIamMemberCondition>? condition,
  ...
  factory WebTypeComputeIamMemberState.fromMap(Map<String, dynamic> map) {
    return WebTypeComputeIamMemberState(
      condition: map['condition'] == null ? null : pulumi.Output.create<WebTypeComputeIamMemberCondition>(WebTypeComputeIamMemberCondition.fromMap((map['condition'] as Map).cast<String, dynamic>())),
