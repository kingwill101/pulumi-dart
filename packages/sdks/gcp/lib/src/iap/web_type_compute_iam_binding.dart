...
import 'web_type_compute_iam_binding_condition.dart';
import 'web_type_compute_iam_binding_state.dart';
...
/// }
///
/// resource "gcp_iap_webtypecomputeiampolicy" "policy" {
///   project     = projectService.project
...
/// }
///
/// resource "gcp_iap_webtypecomputeiambinding" "binding" {
///   project = projectService.project
///   role    = "roles/iap.httpsResourceAccessor"
///   members = ["user:jane@example.com"]
/// }
...
/// }
///
/// resource "gcp_iap_webtypecomputeiammember" "member" {
///   project = projectService.project
///   role    = "roles/iap.httpsResourceAccessor"
///   member  = "user:jane@example.com"
/// }
...
class WebTypeComputeIamBinding extends pulumi.CustomResource {
  ...
  late final pulumi.Output<WebTypeComputeIamBindingCondition?> condition;
  ...
  /// Creates a new [WebTypeComputeIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [WebTypeComputeIamBinding]. {@macro pulumi_iap_web_type_compute_iam_binding_web_type_compute_iam_binding_args_doc}
  ...
  WebTypeComputeIamBinding(
    ...
    condition = registerOutput<WebTypeComputeIamBindingCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return WebTypeComputeIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [WebTypeComputeIamBinding] resource's state with the given [name] and [id].
  static WebTypeComputeIamBinding get(
    String name,
    pulumi.Input<String> id, {
    WebTypeComputeIamBindingState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return WebTypeComputeIamBinding._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [WebTypeComputeIamBinding] resource.
  WebTypeComputeIamBinding.reference(String urn)
    : super(
        'gcp:iap/webTypeComputeIamBinding:WebTypeComputeIamBinding',
