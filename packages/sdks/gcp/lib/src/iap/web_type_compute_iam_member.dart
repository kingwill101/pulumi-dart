...
import 'web_type_compute_iam_member_state.dart';
...
class WebTypeComputeIamMember extends pulumi.CustomResource {
  ...
  late final pulumi.Output<WebTypeComputeIamMemberCondition?> condition;
  ...
  /// Creates a new [WebTypeComputeIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [WebTypeComputeIamMember]. {@macro pulumi_iap_web_type_compute_iam_member_web_type_compute_iam_member_args_doc}
  ...
  WebTypeComputeIamMember(
    ...
    condition = registerOutput<WebTypeComputeIamMemberCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return WebTypeComputeIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [WebTypeComputeIamMember] resource's state with the given [name] and [id].
  static WebTypeComputeIamMember get(
    String name,
    pulumi.Input<String> id, {
    WebTypeComputeIamMemberState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return WebTypeComputeIamMember._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [WebTypeComputeIamMember] resource.
  WebTypeComputeIamMember.reference(String urn)
    : super(
        'gcp:iap/webTypeComputeIamMember:WebTypeComputeIamMember',
