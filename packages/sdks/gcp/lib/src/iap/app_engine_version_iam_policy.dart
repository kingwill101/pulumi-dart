...
import 'app_engine_version_iam_policy_state.dart';
...
class AppEngineVersionIamPolicy extends pulumi.CustomResource {
  ...
  /// Creates a new [AppEngineVersionIamPolicy].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [AppEngineVersionIamPolicy]. {@macro pulumi_iap_app_engine_version_iam_policy_app_engine_version_iam_policy_args_doc}
  ...
  /// Gets an existing [AppEngineVersionIamPolicy] resource's state with the given [name] and [id].
  static AppEngineVersionIamPolicy get(
    String name,
  ...
  AppEngineVersionIamPolicy._get(
    String name, {
