...
import 'tunnel_iam_member_args.dart';
import 'tunnel_iam_member_condition.dart';
import 'tunnel_iam_member_state.dart';
...
class TunnelIamMember extends pulumi.CustomResource {
  ...
  late final pulumi.Output<TunnelIamMemberCondition?> condition;
  ...
  /// Creates a new [TunnelIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [TunnelIamMember]. {@macro pulumi_iap_tunnel_iam_member_tunnel_iam_member_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  TunnelIamMember(
    String name, {
    TunnelIamMemberArgs? args,
    ...
    condition = registerOutput<TunnelIamMemberCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return TunnelIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [TunnelIamMember] resource's state with the given [name] and [id].
  static TunnelIamMember get(
    String name,
    pulumi.Input<String> id, {
    TunnelIamMemberState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return TunnelIamMember._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [TunnelIamMember] resource.
  TunnelIamMember.reference(String urn)
    : super(
        'gcp:iap/tunnelIamMember:TunnelIamMember',
