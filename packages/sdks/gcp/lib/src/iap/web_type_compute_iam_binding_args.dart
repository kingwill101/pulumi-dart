...
class WebTypeComputeIamBindingArgs {
  ...
  factory WebTypeComputeIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return WebTypeComputeIamBindingArgs(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WebTypeComputeIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
