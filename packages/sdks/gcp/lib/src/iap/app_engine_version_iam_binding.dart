...
import 'app_engine_version_iam_binding_args.dart';
import 'app_engine_version_iam_binding_condition.dart';
import 'app_engine_version_iam_binding_state.dart';
...
class AppEngineVersionIamBinding extends pulumi.CustomResource {
  ...
  late final pulumi.Output<AppEngineVersionIamBindingCondition?> condition;
  ...
  /// Creates a new [AppEngineVersionIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [AppEngineVersionIamBinding]. {@macro pulumi_iap_app_engine_version_iam_binding_app_engine_version_iam_binding_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  AppEngineVersionIamBinding(
    String name, {
    AppEngineVersionIamBindingArgs? args,
    ...
    condition = registerOutput<AppEngineVersionIamBindingCondition?>(
      'condition',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return AppEngineVersionIamBindingCondition.fromMap(
  ...
  /// Gets an existing [AppEngineVersionIamBinding] resource's state with the given [name] and [id].
  static AppEngineVersionIamBinding get(
    String name,
  ...
  AppEngineVersionIamBinding._get(
    String name, {
