...
class AgentRegistryEndpointIamPolicyState {
  ...
  /// Creates a new [AgentRegistryEndpointIamPolicyState].
  ...
  const AgentRegistryEndpointIamPolicyState({
    this.endpointId,
    this.etag,
    this.location,
    this.policyData,
  ...
  factory AgentRegistryEndpointIamPolicyState.fromMap(Map<String, dynamic> map) {
    return AgentRegistryEndpointIamPolicyState(
