...
class WebRegionBackendServiceIamMemberState {
  ...
  /// Creates a new [WebRegionBackendServiceIamMemberState].
  ...
  const WebRegionBackendServiceIamMemberState({
    this.condition,
    this.etag,
    this.member,
    this.project,
  ...
  factory WebRegionBackendServiceIamMemberState.fromMap(Map<String, dynamic> map) {
    return WebRegionBackendServiceIamMemberState(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WebRegionBackendServiceIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
