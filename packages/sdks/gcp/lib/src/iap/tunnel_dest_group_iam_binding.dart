...
import 'tunnel_dest_group_iam_binding_args.dart';
import 'tunnel_dest_group_iam_binding_condition.dart';
import 'tunnel_dest_group_iam_binding_state.dart';
...
class TunnelDestGroupIamBinding extends pulumi.CustomResource {
  ...
  late final pulumi.Output<TunnelDestGroupIamBindingCondition?> condition;
  ...
  /// Creates a new [TunnelDestGroupIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [TunnelDestGroupIamBinding]. {@macro pulumi_iap_tunnel_dest_group_iam_binding_tunnel_dest_group_iam_binding_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  TunnelDestGroupIamBinding(
    String name, {
    TunnelDestGroupIamBindingArgs? args,
    ...
    this.condition = registerOutput<TunnelDestGroupIamBindingCondition?>('condition');
  ...
  /// Gets an existing [TunnelDestGroupIamBinding] resource's state with the given [name] and [id].
  static TunnelDestGroupIamBinding get(
    String name,
  ...
  TunnelDestGroupIamBinding._get(
    String name, {
