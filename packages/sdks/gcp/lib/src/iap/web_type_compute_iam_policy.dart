...
import 'web_type_compute_iam_policy_state.dart';
...
class WebTypeComputeIamPolicy extends pulumi.CustomResource {
  ...
  /// Creates a new [WebTypeComputeIamPolicy].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [WebTypeComputeIamPolicy]. {@macro pulumi_iap_web_type_compute_iam_policy_web_type_compute_iam_policy_args_doc}
  ...
  /// Gets an existing [WebTypeComputeIamPolicy] resource's state with the given [name] and [id].
  static WebTypeComputeIamPolicy get(
    String name,
    pulumi.Input<String> id, {
    WebTypeComputeIamPolicyState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return WebTypeComputeIamPolicy._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [WebTypeComputeIamPolicy] resource.
  WebTypeComputeIamPolicy.reference(String urn)
    : super(
        'gcp:iap/webTypeComputeIamPolicy:WebTypeComputeIamPolicy',
