...
class AgentRegistryAgentIamPolicyState {
  ...
  /// Creates a new [AgentRegistryAgentIamPolicyState].
  ...
  const AgentRegistryAgentIamPolicyState({
    this.agentId,
    this.etag,
    this.location,
    this.policyData,
  ...
  factory AgentRegistryAgentIamPolicyState.fromMap(Map<String, dynamic> map) {
    return AgentRegistryAgentIamPolicyState(
