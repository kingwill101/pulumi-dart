...
import 'agent_registry_iam_member_args.dart';
import 'agent_registry_iam_member_condition.dart';
import 'agent_registry_iam_member_state.dart';
...
class AgentRegistryIamMember extends pulumi.CustomResource {
  ...
  late final pulumi.Output<AgentRegistryIamMemberCondition?> condition;
  ...
  /// Creates a new [AgentRegistryIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [AgentRegistryIamMember]. {@macro pulumi_iap_agent_registry_iam_member_agent_registry_iam_member_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  AgentRegistryIamMember(
    String name, {
    AgentRegistryIamMemberArgs? args,
    pulumi.CustomResourceOptions? options,
  }) : super(
          'gcp:iap/agentRegistryIamMember:AgentRegistryIamMember',
          name,
          pulumi.Input.mapToInputs(args?.toMap() ?? const {}),
          pulumi.CustomResourceOptions(version: '9.36.1').merge(options),
        ) {
    condition = registerOutput<AgentRegistryIamMemberCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return AgentRegistryIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [AgentRegistryIamMember] resource's state with the given [name] and [id].
  static AgentRegistryIamMember get(
    String name,
    pulumi.Input<String> id, {
    AgentRegistryIamMemberState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return AgentRegistryIamMember._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [AgentRegistryIamMember] resource.
  AgentRegistryIamMember.reference(String urn)
    : super(
        'gcp:iap/agentRegistryIamMember:AgentRegistryIamMember',
