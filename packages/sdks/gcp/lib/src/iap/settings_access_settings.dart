...
class SettingsAccessSettings {
  ...
  factory SettingsAccessSettings.fromMap(Map<String, dynamic> map) {
    return SettingsAccessSettings(
      allowedDomainsSettings: (() { final guardedValue = map['allowedDomainsSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SettingsAccessSettingsAllowedDomainsSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      corsSettings: (() { final guardedValue = map['corsSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SettingsAccessSettingsCorsSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      gcipSettings: (() { final guardedValue = map['gcipSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SettingsAccessSettingsGcipSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      oauthSettings: (() { final guardedValue = map['oauthSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SettingsAccessSettingsOauthSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      reauthSettings: (() { final guardedValue = map['reauthSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SettingsAccessSettingsReauthSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      workforceIdentitySettings: (() { final guardedValue = map['workforceIdentitySettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SettingsAccessSettingsWorkforceIdentitySettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
