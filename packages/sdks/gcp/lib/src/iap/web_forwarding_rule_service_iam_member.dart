...
import 'web_forwarding_rule_service_iam_member_state.dart';
...
/// }
///
/// resource "gcp_iap_webforwardingruleserviceiampolicy" "policy" {
///   project                      = default.project
///   forwarding_rule_service_name = default.name
...
/// }
///
/// resource "gcp_iap_webforwardingruleserviceiambinding" "binding" {
///   project                      = default.project
///   forwarding_rule_service_name = default.name
///   role                         = "roles/iap.httpsResourceAccessor"
///   members                      = ["user:jane@example.com"]
...
/// }
///
/// resource "gcp_iap_webforwardingruleserviceiammember" "member" {
///   project                      = default.project
///   forwarding_rule_service_name = default.name
///   role                         = "roles/iap.httpsResourceAccessor"
///   member                       = "user:jane@example.com"
...
class WebForwardingRuleServiceIamMember extends pulumi.CustomResource {
  ...
  WebForwardingRuleServiceIamMember(
    ...
    condition = registerOutput<WebForwardingRuleServiceIamMemberCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return WebForwardingRuleServiceIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [WebForwardingRuleServiceIamMember] resource's state with the given [name] and [id].
  static WebForwardingRuleServiceIamMember get(
    String name,
    pulumi.Input<String> id, {
    WebForwardingRuleServiceIamMemberState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return WebForwardingRuleServiceIamMember._get(
      name,
      state: state?.toMap(),
  ...
  WebForwardingRuleServiceIamMember._get(
    String name, {
  ...
  /// Creates a typed reference to an existing [WebForwardingRuleServiceIamMember] resource.
  WebForwardingRuleServiceIamMember.reference(String urn)
    : super(
        'gcp:iap/webForwardingRuleServiceIamMember:WebForwardingRuleServiceIamMember',
