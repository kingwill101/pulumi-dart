...
import 'agent_registry_agent_iam_policy_args.dart';
import 'agent_registry_agent_iam_policy_state.dart';
...
class AgentRegistryAgentIamPolicy extends pulumi.CustomResource {
  ...
  /// Creates a new [AgentRegistryAgentIamPolicy].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [AgentRegistryAgentIamPolicy]. {@macro pulumi_iap_agent_registry_agent_iam_policy_agent_registry_agent_iam_policy_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  AgentRegistryAgentIamPolicy(
    String name, {
    AgentRegistryAgentIamPolicyArgs? args,
    pulumi.CustomResourceOptions? options,
  }) : super(
          'gcp:iap/agentRegistryAgentIamPolicy:AgentRegistryAgentIamPolicy',
          name,
  ...
  /// Gets an existing [AgentRegistryAgentIamPolicy] resource's state with the given [name] and [id].
  static AgentRegistryAgentIamPolicy get(
    String name,
    pulumi.Input<String> id, {
    AgentRegistryAgentIamPolicyState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return AgentRegistryAgentIamPolicy._get(
      name,
      state: state?.toMap(),
  ...
  AgentRegistryAgentIamPolicy._get(
    String name, {
  ...
  /// Creates a typed reference to an existing [AgentRegistryAgentIamPolicy] resource.
  AgentRegistryAgentIamPolicy.reference(String urn)
    : super(
        'gcp:iap/agentRegistryAgentIamPolicy:AgentRegistryAgentIamPolicy',
