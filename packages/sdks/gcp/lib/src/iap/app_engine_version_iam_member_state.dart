...
class AppEngineVersionIamMemberState {
  ...
  factory AppEngineVersionIamMemberState.fromMap(Map<String, dynamic> map) {
    return AppEngineVersionIamMemberState(
      ...
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AppEngineVersionIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
