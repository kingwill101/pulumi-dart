...
import 'web_region_forwarding_rule_service_iam_policy_state.dart';
...
class WebRegionForwardingRuleServiceIamPolicy extends pulumi.CustomResource {
  ...
  /// Creates a new [WebRegionForwardingRuleServiceIamPolicy].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [WebRegionForwardingRuleServiceIamPolicy]. {@macro pulumi_iap_web_region_forwarding_rule_service_iam_policy_web_region_forwarding_rule_service_iam_policy_args_doc}
  ...
  /// Gets an existing [WebRegionForwardingRuleServiceIamPolicy] resource's state with the given [name] and [id].
  static WebRegionForwardingRuleServiceIamPolicy get(
    String name,
  ...
  WebRegionForwardingRuleServiceIamPolicy._get(
    String name, {
