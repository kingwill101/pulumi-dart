...
class InstanceMaintenancePolicyMaintenanceExclusionWindowTime {
  ...
  /// Creates a new [InstanceMaintenancePolicyMaintenanceExclusionWindowTime].
  ...
  const InstanceMaintenancePolicyMaintenanceExclusionWindowTime({
    this.hours,
    this.minutes,
    this.nanos,
    this.seconds,
  ...
  factory InstanceMaintenancePolicyMaintenanceExclusionWindowTime.fromMap(Map<String, dynamic> map) {
    return InstanceMaintenancePolicyMaintenanceExclusionWindowTime(
