...
class InstanceMaintenancePolicyMaintenanceExclusionWindowEndDate {
  ...
  /// Creates a new [InstanceMaintenancePolicyMaintenanceExclusionWindowEndDate].
  ...
  const InstanceMaintenancePolicyMaintenanceExclusionWindowEndDate({
    this.day,
    this.month,
    this.year,
  });
  ...
  factory InstanceMaintenancePolicyMaintenanceExclusionWindowEndDate.fromMap(Map<String, dynamic> map) {
    return InstanceMaintenancePolicyMaintenanceExclusionWindowEndDate(
