...
class AppVersionSnapshotGuardrailActionRespondImmediately {
  ...
  factory AppVersionSnapshotGuardrailActionRespondImmediately.fromMap(Map<String, dynamic> map) {
    return AppVersionSnapshotGuardrailActionRespondImmediately(
      responses: (() { final guardedValue = map['responses']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AppVersionSnapshotGuardrailActionRespondImmediatelyResponse>(guardedValue, (value) => AppVersionSnapshotGuardrailActionRespondImmediatelyResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
