...
class AppVersionSnapshotGuardrailLlmPromptSecurity {
  ...
  final pulumi.Input<
    List<AppVersionSnapshotGuardrailLlmPromptSecurityCustomPolicy>
  >?
  customPolicies;
  ...
  /// Structure is documented below.
  final pulumi.Input<
    List<AppVersionSnapshotGuardrailLlmPromptSecurityDefaultSetting>
  >?
  defaultSettings;
  ...
  factory AppVersionSnapshotGuardrailLlmPromptSecurity.fromMap(
    ...
    return AppVersionSnapshotGuardrailLlmPromptSecurity(
      customPolicies: (() {
        final guardedValue = map['customPolicies'];
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                AppVersionSnapshotGuardrailLlmPromptSecurityCustomPolicy.fromMap(
      ...
      defaultSettings: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                AppVersionSnapshotGuardrailLlmPromptSecurityDefaultSetting.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
