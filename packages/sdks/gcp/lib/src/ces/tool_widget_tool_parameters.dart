...
class ToolWidgetToolParameters {
  ...
  /// Creates a new [ToolWidgetToolParameters].
  ...
  const ToolWidgetToolParameters({
  ...
  factory ToolWidgetToolParameters.fromMap(Map<String, dynamic> map) {
    return ToolWidgetToolParameters(
