...
class AppVersionSnapshotApp {
  ...
  final pulumi.Input<List<AppVersionSnapshotAppAudioProcessingConfig>>?
  audioProcessingConfigs;

  /// (Output)
  /// The default client certificate settings for the app.
  /// Structure is documented below.
  final pulumi.Input<List<AppVersionSnapshotAppClientCertificateSetting>>?
  ...
  /// Structure is documented below.
  final pulumi.Input<List<AppVersionSnapshotAppDataStoreSetting>>?
  dataStoreSettings;
  ...
  /// Structure is documented below.
  final pulumi.Input<List<AppVersionSnapshotAppDefaultChannelProfile>>?
  ...
  /// Structure is documented below.
  final pulumi.Input<List<AppVersionSnapshotAppEvaluationMetricsThreshold>>?
  ...
  /// Structure is documented below.
  final pulumi.Input<List<AppVersionSnapshotAppLanguageSetting>>?
  languageSettings;

  /// (Output)
  /// Settings to describe the logging behaviors for the app.
  /// Structure is documented below.
  final pulumi.Input<List<AppVersionSnapshotAppLoggingSetting>>?
  loggingSettings;
  ...
  /// Structure is documented below.
  final pulumi.Input<List<AppVersionSnapshotAppTimeZoneSetting>>?
  timeZoneSettings;
  ...
  /// Structure is documented below.
  final pulumi.Input<List<AppVersionSnapshotAppVariableDeclaration>>?
    ...
    return <String, dynamic>{
      'audioProcessingConfigs':
          ?pulumi.Input.mapOptionalInputValue<
            List<AppVersionSnapshotAppAudioProcessingConfig>,
      ...
      'clientCertificateSettings':
          ?pulumi.Input.mapOptionalInputValue<
            List<AppVersionSnapshotAppClientCertificateSetting>,
            List<Map<String, dynamic>>
          >(
            clientCertificateSettings,
            (value) =>
      ...
      'dataStoreSettings':
          ?pulumi.Input.mapOptionalInputValue<
            List<AppVersionSnapshotAppDataStoreSetting>,
            List<Map<String, dynamic>>
          >(
            dataStoreSettings,
            (value) =>
      ...
      'defaultChannelProfiles':
          ?pulumi.Input.mapOptionalInputValue<
            List<AppVersionSnapshotAppDefaultChannelProfile>,
            List<Map<String, dynamic>>
          >(
            defaultChannelProfiles,
            (value) =>
      ...
      'evaluationMetricsThresholds':
          ?pulumi.Input.mapOptionalInputValue<
            List<AppVersionSnapshotAppEvaluationMetricsThreshold>,
            List<Map<String, dynamic>>
          >(
            evaluationMetricsThresholds,
            (value) =>
      ...
      'languageSettings':
          ?pulumi.Input.mapOptionalInputValue<
            List<AppVersionSnapshotAppLanguageSetting>,
            List<Map<String, dynamic>>
          >(
            languageSettings,
            (value) =>
      ...
      'loggingSettings':
          ?pulumi.Input.mapOptionalInputValue<
            List<AppVersionSnapshotAppLoggingSetting>,
            List<Map<String, dynamic>>
          >(
            loggingSettings,
            (value) =>
      ...
      'modelSettings':
          ?pulumi.Input.mapOptionalInputValue<
            List<AppVersionSnapshotAppModelSetting>,
            List<Map<String, dynamic>>
          >(
            modelSettings,
            (value) =>
      ...
      'timeZoneSettings':
          ?pulumi.Input.mapOptionalInputValue<
            List<AppVersionSnapshotAppTimeZoneSetting>,
            List<Map<String, dynamic>>
          >(
            timeZoneSettings,
            (value) =>
      ...
      'variableDeclarations':
          ?pulumi.Input.mapOptionalInputValue<
            List<AppVersionSnapshotAppVariableDeclaration>,
            List<Map<String, dynamic>>
          >(
            variableDeclarations,
            (value) =>
  ...
  factory AppVersionSnapshotApp.fromMap(Map<String, dynamic> map) {
    return AppVersionSnapshotApp(
      audioProcessingConfigs: (() {
        final guardedValue = map['audioProcessingConfigs'];
      ...
      defaultChannelProfiles: (() {
        final guardedValue = map['defaultChannelProfiles'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      evaluationMetricsThresholds: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => AppVersionSnapshotAppEvaluationMetricsThreshold.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
