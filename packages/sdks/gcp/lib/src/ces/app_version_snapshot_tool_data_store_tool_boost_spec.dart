...
class AppVersionSnapshotToolDataStoreToolBoostSpec {
  ...
  /// [dataStores] (Output)
  /// [specs] (Output)
  const AppVersionSnapshotToolDataStoreToolBoostSpec({
    this.dataStores,
    this.specs,
  });
  ...
  factory AppVersionSnapshotToolDataStoreToolBoostSpec.fromMap(Map<String, dynamic> map) {
    return AppVersionSnapshotToolDataStoreToolBoostSpec(
      ...
      specs: (() { final guardedValue = map['specs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AppVersionSnapshotToolDataStoreToolBoostSpecSpec>(guardedValue, (value) => AppVersionSnapshotToolDataStoreToolBoostSpecSpec.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
