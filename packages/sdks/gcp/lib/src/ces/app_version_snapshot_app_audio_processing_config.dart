...
class AppVersionSnapshotAppAudioProcessingConfig {
  ...
  final pulumi.Input<
    List<AppVersionSnapshotAppAudioProcessingConfigAmbientSoundConfig>
  >?
  ambientSoundConfigs;
  ...
  /// Structure is documented below.
  final pulumi.Input<
    List<AppVersionSnapshotAppAudioProcessingConfigBargeInConfig>
  >?
  bargeInConfigs;
  ...
  factory AppVersionSnapshotAppAudioProcessingConfig.fromMap(
    ...
    return AppVersionSnapshotAppAudioProcessingConfig(
      ambientSoundConfigs: (() {
        final guardedValue = map['ambientSoundConfigs'];
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                AppVersionSnapshotAppAudioProcessingConfigAmbientSoundConfig.fromMap(
      ...
      bargeInConfigs: (() {
        final guardedValue = map['bargeInConfigs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<
            AppVersionSnapshotAppAudioProcessingConfigBargeInConfig
          >(
            guardedValue,
            (value) =>
                AppVersionSnapshotAppAudioProcessingConfigBargeInConfig.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      synthesizeSpeechConfigs: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                AppVersionSnapshotAppAudioProcessingConfigSynthesizeSpeechConfig.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
