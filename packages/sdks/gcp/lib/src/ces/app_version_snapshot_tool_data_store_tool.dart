...
class AppVersionSnapshotToolDataStoreTool {
  ...
  final pulumi.Input<List<AppVersionSnapshotToolDataStoreToolBoostSpec>>?
  boostSpecs;
  ...
  /// specific DataStores.
  /// Structure is documented below.
  final pulumi.Input<List<AppVersionSnapshotToolDataStoreToolEngineSource>>?
  engineSources;
  ...
  /// Structure is documented below.
  final pulumi.Input<List<AppVersionSnapshotToolDataStoreToolModalityConfig>>?
  modalityConfigs;
    ...
    return <String, dynamic>{
      'boostSpecs':
          ?pulumi.Input.mapOptionalInputValue<
            List<AppVersionSnapshotToolDataStoreToolBoostSpec>,
      ...
      'engineSources':
          ?pulumi.Input.mapOptionalInputValue<
            List<AppVersionSnapshotToolDataStoreToolEngineSource>,
            List<Map<String, dynamic>>
          >(
            engineSources,
            (value) =>
      ...
      'modalityConfigs':
          ?pulumi.Input.mapOptionalInputValue<
            List<AppVersionSnapshotToolDataStoreToolModalityConfig>,
            List<Map<String, dynamic>>
          >(
            modalityConfigs,
            (value) =>
  ...
  factory AppVersionSnapshotToolDataStoreTool.fromMap(
    ...
    return AppVersionSnapshotToolDataStoreTool(
      boostSpecs: (() {
        final guardedValue = map['boostSpecs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AppVersionSnapshotToolDataStoreToolBoostSpec>(
            guardedValue,
      ...
      engineSources: (() {
        final guardedValue = map['engineSources'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => AppVersionSnapshotToolDataStoreToolEngineSource.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      modalityConfigs: (() {
        final guardedValue = map['modalityConfigs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<
            AppVersionSnapshotToolDataStoreToolModalityConfig
