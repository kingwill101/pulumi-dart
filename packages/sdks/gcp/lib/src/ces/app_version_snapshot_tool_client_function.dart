...
class AppVersionSnapshotToolClientFunction {
  ...
  final pulumi.Input<List<AppVersionSnapshotToolClientFunctionParameter>>?
  parameters;

  /// (Output)
  /// Represents a select subset of an OpenAPI 3.0 schema object.
  /// Structure is documented below.
  final pulumi.Input<List<AppVersionSnapshotToolClientFunctionResponse>>?
  responses;
    ...
    return <String, dynamic>{
      ...
      'parameters':
          ?pulumi.Input.mapOptionalInputValue<
            List<AppVersionSnapshotToolClientFunctionParameter>,
      ...
      'responses':
          ?pulumi.Input.mapOptionalInputValue<
            List<AppVersionSnapshotToolClientFunctionResponse>,
            List<Map<String, dynamic>>
          >(
            responses,
            (value) =>
  ...
  factory AppVersionSnapshotToolClientFunction.fromMap(
    ...
    return AppVersionSnapshotToolClientFunction(
      ...
      responses: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AppVersionSnapshotToolClientFunctionResponse>(
            guardedValue,
