...
class AppVersionSnapshotGuardrailCodeCallback {
  ...
  final pulumi.Input<
    List<AppVersionSnapshotGuardrailCodeCallbackAfterAgentCallback>
  >?
  afterAgentCallbacks;
  ...
  /// Structure is documented below.
  final pulumi.Input<
    List<AppVersionSnapshotGuardrailCodeCallbackAfterModelCallback>
  >?
  afterModelCallbacks;
  ...
  /// Structure is documented below.
  final pulumi.Input<
    List<AppVersionSnapshotGuardrailCodeCallbackBeforeAgentCallback>
  >?
  ...
  /// Structure is documented below.
  final pulumi.Input<
    List<AppVersionSnapshotGuardrailCodeCallbackBeforeModelCallback>
  >?
