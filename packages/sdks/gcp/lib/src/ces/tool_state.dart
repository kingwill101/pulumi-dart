...
class ToolState {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'openApiTools':
          ?pulumi.Input.mapOptionalInputValue<
            List<ToolOpenApiTool>,
            List<Map<String, dynamic>>
          >(
            openApiTools,
            (value) =>
                pulumi.Input.encodeList<ToolOpenApiTool, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      ...
      'systemTools':
          ...
          >(
            systemTools,
            (value) =>
                pulumi.Input.encodeList<ToolSystemTool, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory ToolState.fromMap(Map<String, dynamic> map) {
    return ToolState(
      ...
      openApiTools: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ToolOpenApiTool>(
            guardedValue,
            (value) =>
                ToolOpenApiTool.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      project: (() {
      ...
      systemTools: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ToolSystemTool>(
            guardedValue,
            (value) =>
                ToolSystemTool.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      toolId: (() {
