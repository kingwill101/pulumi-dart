...
class ToolOpenApiTool {
  ...
  factory ToolOpenApiTool.fromMap(Map<String, dynamic> map) {
    return ToolOpenApiTool(
      apiAuthentications: (() { final guardedValue = map['apiAuthentications']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ToolOpenApiToolApiAuthentication>(guardedValue, (value) => ToolOpenApiToolApiAuthentication.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      serviceDirectoryConfigs: (() { final guardedValue = map['serviceDirectoryConfigs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ToolOpenApiToolServiceDirectoryConfig>(guardedValue, (value) => ToolOpenApiToolServiceDirectoryConfig.fromMap((value as Map).cast<String, dynamic>()))); })(),
      tlsConfigs: (() { final guardedValue = map['tlsConfigs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ToolOpenApiToolTlsConfig>(guardedValue, (value) => ToolOpenApiToolTlsConfig.fromMap((value as Map).cast<String, dynamic>()))); })(),
