...
class ToolsetMcpToolsetApiAuthenticationOauthConfig {
  ...
  /// Creates a new [ToolsetMcpToolsetApiAuthenticationOauthConfig].
  ...
  const ToolsetMcpToolsetApiAuthenticationOauthConfig({
  ...
  factory ToolsetMcpToolsetApiAuthenticationOauthConfig.fromMap(Map<String, dynamic> map) {
    return ToolsetMcpToolsetApiAuthenticationOauthConfig(
