...
class AppVersionSnapshotAppVariableDeclaration {
  ...
  factory AppVersionSnapshotAppVariableDeclaration.fromMap(Map<String, dynamic> map) {
    return AppVersionSnapshotAppVariableDeclaration(
      ...
      schemas: (() { final guardedValue = map['schemas']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AppVersionSnapshotAppVariableDeclarationSchema>(guardedValue, (value) => AppVersionSnapshotAppVariableDeclarationSchema.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
