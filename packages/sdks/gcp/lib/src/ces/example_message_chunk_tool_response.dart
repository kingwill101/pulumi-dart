...
class ExampleMessageChunkToolResponse {
  ...
  factory ExampleMessageChunkToolResponse.fromMap(Map<String, dynamic> map) {
    return ExampleMessageChunkToolResponse(
      ...
      toolsetTool: (() { final guardedValue = map['toolsetTool']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ExampleMessageChunkToolResponseToolsetTool.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
