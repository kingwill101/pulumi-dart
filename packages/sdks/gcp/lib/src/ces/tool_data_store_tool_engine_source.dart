...
class ToolDataStoreToolEngineSource {
  ...
  factory ToolDataStoreToolEngineSource.fromMap(Map<String, dynamic> map) {
    return ToolDataStoreToolEngineSource(
      dataStoreSources: (() { final guardedValue = map['dataStoreSources']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ToolDataStoreToolEngineSourceDataStoreSource>(guardedValue, (value) => ToolDataStoreToolEngineSourceDataStoreSource.fromMap((value as Map).cast<String, dynamic>()))); })(),
