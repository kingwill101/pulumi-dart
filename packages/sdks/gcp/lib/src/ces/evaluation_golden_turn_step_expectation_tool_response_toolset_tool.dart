...
class EvaluationGoldenTurnStepExpectationToolResponseToolsetTool {
  ...
  factory EvaluationGoldenTurnStepExpectationToolResponseToolsetTool.fromMap(Map<String, dynamic> map) {
    return EvaluationGoldenTurnStepExpectationToolResponseToolsetTool(
