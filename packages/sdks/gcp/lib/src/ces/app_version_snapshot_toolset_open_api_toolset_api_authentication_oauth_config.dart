...
class AppVersionSnapshotToolsetOpenApiToolsetApiAuthenticationOauthConfig {
  ...
  const AppVersionSnapshotToolsetOpenApiToolsetApiAuthenticationOauthConfig({
    this.clientId,
  ...
  factory AppVersionSnapshotToolsetOpenApiToolsetApiAuthenticationOauthConfig.fromMap(Map<String, dynamic> map) {
    return AppVersionSnapshotToolsetOpenApiToolsetApiAuthenticationOauthConfig(
      ...
      clientSecretVersion: (() { final guardedValue = map['clientSecretVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      oauthGrantType: (() { final guardedValue = map['oauthGrantType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
