...
class AgentBeforeToolCallback {
  ...
  /// Creates a new [AgentBeforeToolCallback].
  ...
  factory AgentBeforeToolCallback.fromMap(Map<String, dynamic> map) {
    return AgentBeforeToolCallback(
