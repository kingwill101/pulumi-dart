...
class ExampleMessageChunk {
    ...
    return <String, dynamic>{
      'agentTransfer':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(agentTransfer, (value) => value.toMap()),
      'image':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'toolCall':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(toolCall, (value) => value.toMap()),
      'toolResponse':
          ?pulumi.Input.mapOptionalInputValue<
            ExampleMessageChunkToolResponse,
            Map<String, dynamic>
          >(toolResponse, (value) => value.toMap()),
  ...
  factory ExampleMessageChunk.fromMap(Map<String, dynamic> map) {
    return ExampleMessageChunk(
      agentTransfer: (() {
        final guardedValue = map['agentTransfer'];
      ...
      toolCall: (() {
        final guardedValue = map['toolCall'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      toolResponse: (() {
        final guardedValue = map['toolResponse'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
