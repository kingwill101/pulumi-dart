...
class AgentState {
  ...
  factory AgentState.fromMap(Map<String, dynamic> map) {
    return AgentState(
      afterAgentCallbacks: (() { final guardedValue = map['afterAgentCallbacks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AgentAfterAgentCallback>(guardedValue, (value) => AgentAfterAgentCallback.fromMap((value as Map).cast<String, dynamic>()))); })(),
      afterModelCallbacks: (() { final guardedValue = map['afterModelCallbacks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AgentAfterModelCallback>(guardedValue, (value) => AgentAfterModelCallback.fromMap((value as Map).cast<String, dynamic>()))); })(),
      afterToolCallbacks: (() { final guardedValue = map['afterToolCallbacks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AgentAfterToolCallback>(guardedValue, (value) => AgentAfterToolCallback.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      beforeAgentCallbacks: (() { final guardedValue = map['beforeAgentCallbacks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AgentBeforeAgentCallback>(guardedValue, (value) => AgentBeforeAgentCallback.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      llmAgent: (() { final guardedValue = map['llmAgent']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, dynamic>()); })(),
      location: (() { final guardedValue = map['location']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      modelSettings: (() { final guardedValue = map['modelSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AgentModelSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      project: (() { final guardedValue = map['project']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      remoteDialogflowAgent: (() { final guardedValue = map['remoteDialogflowAgent']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AgentRemoteDialogflowAgent.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      toolsets: (() { final guardedValue = map['toolsets']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AgentToolset>(guardedValue, (value) => AgentToolset.fromMap((value as Map).cast<String, dynamic>()))); })(),
