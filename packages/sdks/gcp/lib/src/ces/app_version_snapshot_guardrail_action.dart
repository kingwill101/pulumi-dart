...
class AppVersionSnapshotGuardrailAction {
  ...
  final pulumi.Input<List<AppVersionSnapshotGuardrailActionGenerativeAnswer>>?
  generativeAnswers;

  /// (Output)
  /// The agent will immediately respond with a preconfigured response.
  /// Structure is documented below.
  final pulumi.Input<List<AppVersionSnapshotGuardrailActionRespondImmediately>>?
  respondImmediatelies;

  /// (Output)
  /// The agent will transfer the conversation to a different agent.
  /// Structure is documented below.
  final pulumi.Input<List<AppVersionSnapshotGuardrailActionTransferAgent>>?
  transferAgents;
    ...
    return <String, dynamic>{
      'generativeAnswers':
          ?pulumi.Input.mapOptionalInputValue<
            List<AppVersionSnapshotGuardrailActionGenerativeAnswer>,
      ...
      'respondImmediatelies':
          ?pulumi.Input.mapOptionalInputValue<
            List<AppVersionSnapshotGuardrailActionRespondImmediately>,
            List<Map<String, dynamic>>
          >(
            respondImmediatelies,
            (value) =>
      ...
      'transferAgents':
          ?pulumi.Input.mapOptionalInputValue<
            List<AppVersionSnapshotGuardrailActionTransferAgent>,
            List<Map<String, dynamic>>
          >(
            transferAgents,
            (value) =>
  ...
  factory AppVersionSnapshotGuardrailAction.fromMap(Map<String, dynamic> map) {
    return AppVersionSnapshotGuardrailAction(
      generativeAnswers: (() {
        final guardedValue = map['generativeAnswers'];
      ...
      respondImmediatelies: (() {
        final guardedValue = map['respondImmediatelies'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<
            AppVersionSnapshotGuardrailActionRespondImmediately
      ...
      transferAgents: (() {
        final guardedValue = map['transferAgents'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<AppVersionSnapshotGuardrailActionTransferAgent>(
            guardedValue,
