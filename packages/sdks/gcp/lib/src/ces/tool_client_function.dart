...
class ToolClientFunction {
  ...
  factory ToolClientFunction.fromMap(Map<String, dynamic> map) {
    return ToolClientFunction(
      ...
      parameters: (() { final guardedValue = map['parameters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ToolClientFunctionParameters.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      response: (() { final guardedValue = map['response']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ToolClientFunctionResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
