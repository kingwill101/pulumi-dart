...
class GuardrailArgs {
    ...
    return <String, dynamic>{
      ...
      'codeCallback':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(codeCallback, (value) => value.toMap()),
      'contentFilter':
          ?pulumi.Input.mapOptionalInputValue<
            GuardrailContentFilter,
            Map<String, dynamic>
          >(contentFilter, (value) => value.toMap()),
      ...
      'llmPolicy':
          ?pulumi.Input.mapOptionalInputValue<
            GuardrailLlmPolicy,
            Map<String, dynamic>
          >(llmPolicy, (value) => value.toMap()),
      'llmPromptSecurity':
          ?pulumi.Input.mapOptionalInputValue<
            GuardrailLlmPromptSecurity,
            Map<String, dynamic>
          >(llmPromptSecurity, (value) => value.toMap()),
      'location': location,
      'modelSafety':
          ?pulumi.Input.mapOptionalInputValue<
            GuardrailModelSafety,
            Map<String, dynamic>
          >(modelSafety, (value) => value.toMap()),
      'project': ?project,
    };
  }
  ...
  factory GuardrailArgs.fromMap(Map<String, dynamic> map) {
    return GuardrailArgs(
      ...
      codeCallback: (() {
        final guardedValue = map['codeCallback'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      contentFilter: (() {
        final guardedValue = map['contentFilter'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      llmPolicy: (() {
        final guardedValue = map['llmPolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      llmPromptSecurity: (() {
        final guardedValue = map['llmPromptSecurity'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      modelSafety: (() {
        final guardedValue = map['modelSafety'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
