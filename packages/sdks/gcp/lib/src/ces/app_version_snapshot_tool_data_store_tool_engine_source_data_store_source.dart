...
class AppVersionSnapshotToolDataStoreToolEngineSourceDataStoreSource {
  ...
  factory AppVersionSnapshotToolDataStoreToolEngineSourceDataStoreSource.fromMap(Map<String, dynamic> map) {
    return AppVersionSnapshotToolDataStoreToolEngineSourceDataStoreSource(
      dataStores: (() { final guardedValue = map['dataStores']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AppVersionSnapshotToolDataStoreToolEngineSourceDataStoreSourceDataStore>(guardedValue, (value) => AppVersionSnapshotToolDataStoreToolEngineSourceDataStoreSourceDataStore.fromMap((value as Map).cast<String, dynamic>()))); })(),
