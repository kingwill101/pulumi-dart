...
class ToolMcpToolApiAuthenticationApiKeyConfig {
  /// (Output)
  ...
  /// Creates a new [ToolMcpToolApiAuthenticationApiKeyConfig].
  /// [apiKeySecretVersion] (Output)
  /// [keyName] (Output)
  /// [requestLocation] (Output)
  const ToolMcpToolApiAuthenticationApiKeyConfig({
  ...
  factory ToolMcpToolApiAuthenticationApiKeyConfig.fromMap(Map<String, dynamic> map) {
    return ToolMcpToolApiAuthenticationApiKeyConfig(
