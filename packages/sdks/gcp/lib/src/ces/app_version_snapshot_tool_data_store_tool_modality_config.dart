...
class AppVersionSnapshotToolDataStoreToolModalityConfig {
  ...
  final pulumi.Input<
    List<AppVersionSnapshotToolDataStoreToolModalityConfigGroundingConfig>
  >?
  groundingConfigs;
  ...
  /// Structure is documented below.
  final pulumi.Input<
    List<AppVersionSnapshotToolDataStoreToolModalityConfigRewriterConfig>
  >?
  rewriterConfigs;
  ...
  /// Structure is documented below.
  final pulumi.Input<
    List<AppVersionSnapshotToolDataStoreToolModalityConfigSummarizationConfig>
  >?
  ...
  factory AppVersionSnapshotToolDataStoreToolModalityConfig.fromMap(
    ...
    return AppVersionSnapshotToolDataStoreToolModalityConfig(
      groundingConfigs: (() {
        final guardedValue = map['groundingConfigs'];
      ...
      modalityType: (() {
        final guardedValue = map['modalityType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      rewriterConfigs: (() {
        final guardedValue = map['rewriterConfigs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<
            AppVersionSnapshotToolDataStoreToolModalityConfigRewriterConfig
      ...
      summarizationConfigs: (() {
        final guardedValue = map['summarizationConfigs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<
            AppVersionSnapshotToolDataStoreToolModalityConfigSummarizationConfig
