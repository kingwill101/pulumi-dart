...
class GuardrailModelSafety {
  ...
  factory GuardrailModelSafety.fromMap(Map<String, dynamic> map) {
    return GuardrailModelSafety(
      safetySettings: pulumi.Input.fromValue(pulumi.Input.decodeList<GuardrailModelSafetySafetySetting>(map['safetySettings']!, (value) => GuardrailModelSafetySafetySetting.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
