...
class AppVersionSnapshotGuardrail {
  ...
  /// provided.
  /// Structure is documented below.
  final pulumi.Input<List<AppVersionSnapshotGuardrailCodeCallback>>?
  codeCallbacks;

  /// (Output)
  /// Guardrail that bans certain content from being used in the conversation.
  /// Structure is documented below.
  final pulumi.Input<List<AppVersionSnapshotGuardrailContentFilter>>?
  contentFilters;
  ...
  /// Structure is documented below.
  final pulumi.Input<List<AppVersionSnapshotGuardrailLlmPromptSecurity>>?
  llmPromptSecurities;
  ...
  /// unsafe.
  /// Structure is documented below.
  final pulumi.Input<List<AppVersionSnapshotGuardrailModelSafety>>?
  modelSafeties;
    ...
    return <String, dynamic>{
      'actions':
          ?pulumi.Input.mapOptionalInputValue<
            List<AppVersionSnapshotGuardrailAction>,
      ...
      'codeCallbacks':
          ?pulumi.Input.mapOptionalInputValue<
            List<AppVersionSnapshotGuardrailCodeCallback>,
            List<Map<String, dynamic>>
          >(
            codeCallbacks,
            (value) =>
      ...
      'contentFilters':
          ?pulumi.Input.mapOptionalInputValue<
            List<AppVersionSnapshotGuardrailContentFilter>,
            List<Map<String, dynamic>>
          >(
            contentFilters,
            (value) =>
      ...
      'llmPolicies':
          ?pulumi.Input.mapOptionalInputValue<
            List<AppVersionSnapshotGuardrailLlmPolicy>,
            List<Map<String, dynamic>>
          >(
            llmPolicies,
            (value) =>
      ...
      'llmPromptSecurities':
          ?pulumi.Input.mapOptionalInputValue<
            List<AppVersionSnapshotGuardrailLlmPromptSecurity>,
            List<Map<String, dynamic>>
          >(
            llmPromptSecurities,
            (value) =>
      ...
      'modelSafeties':
          ?pulumi.Input.mapOptionalInputValue<
            List<AppVersionSnapshotGuardrailModelSafety>,
            List<Map<String, dynamic>>
          >(
            modelSafeties,
            (value) =>
  ...
  factory AppVersionSnapshotGuardrail.fromMap(Map<String, dynamic> map) {
    return AppVersionSnapshotGuardrail(
      ...
      codeCallbacks: (() {
        final guardedValue = map['codeCallbacks'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      llmPolicies: (() {
        final guardedValue = map['llmPolicies'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      llmPromptSecurities: (() {
        final guardedValue = map['llmPromptSecurities'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AppVersionSnapshotGuardrailLlmPromptSecurity>(
            guardedValue,
      ...
      modelSafeties: (() {
        final guardedValue = map['modelSafeties'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
