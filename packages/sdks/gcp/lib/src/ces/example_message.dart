...
class ExampleMessage {
  ...
  factory ExampleMessage.fromMap(Map<String, dynamic> map) {
    return ExampleMessage(
      chunks: (() { final guardedValue = map['chunks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ExampleMessageChunk>(guardedValue, (value) => ExampleMessageChunk.fromMap((value as Map).cast<String, dynamic>()))); })(),
