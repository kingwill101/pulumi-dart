...
class AppVersionSnapshotGuardrailModelSafety {
  ...
  factory AppVersionSnapshotGuardrailModelSafety.fromMap(Map<String, dynamic> map) {
    return AppVersionSnapshotGuardrailModelSafety(
      safetySettings: (() { final guardedValue = map['safetySettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AppVersionSnapshotGuardrailModelSafetySafetySetting>(guardedValue, (value) => AppVersionSnapshotGuardrailModelSafetySafetySetting.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
