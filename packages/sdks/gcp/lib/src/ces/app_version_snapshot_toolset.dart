...
class AppVersionSnapshotToolset {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'openApiToolsets': ?openApiToolsets == null ? null : pulumi.Input.encodeList<AppVersionSnapshotToolsetOpenApiToolset, Map<String, dynamic>>(openApiToolsets!, (value) => value.toMap()),
  ...
  factory AppVersionSnapshotToolset.fromMap(Map<String, dynamic> map) {
    return AppVersionSnapshotToolset(
      ...
      openApiToolsets: map['openApiToolsets'] == null ? null : pulumi.Input.decodeList<AppVersionSnapshotToolsetOpenApiToolset>(map['openApiToolsets'], (value) => AppVersionSnapshotToolsetOpenApiToolset.fromMap((value as Map).cast<String, dynamic>())),
