...
class ToolDataStoreToolDataStoreSourceDataStoreConnectorConfig {
  ...
  /// Creates a new [ToolDataStoreToolDataStoreSourceDataStoreConnectorConfig].
  ...
  const ToolDataStoreToolDataStoreSourceDataStoreConnectorConfig({
    this.collection,
  ...
  factory ToolDataStoreToolDataStoreSourceDataStoreConnectorConfig.fromMap(Map<String, dynamic> map) {
    return ToolDataStoreToolDataStoreSourceDataStoreConnectorConfig(
