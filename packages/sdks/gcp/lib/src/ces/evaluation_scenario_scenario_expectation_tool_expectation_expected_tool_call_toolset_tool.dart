...
class EvaluationScenarioScenarioExpectationToolExpectationExpectedToolCallToolsetTool {
  ...
  const EvaluationScenarioScenarioExpectationToolExpectationExpectedToolCallToolsetTool({
    this.toolId,
    this.toolset,
  });
  ...
  factory EvaluationScenarioScenarioExpectationToolExpectationExpectedToolCallToolsetTool.fromMap(Map<String, dynamic> map) {
    return EvaluationScenarioScenarioExpectationToolExpectationExpectedToolCallToolsetTool(
