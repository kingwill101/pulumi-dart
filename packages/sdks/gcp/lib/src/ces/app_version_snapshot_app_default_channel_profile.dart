...
class AppVersionSnapshotAppDefaultChannelProfile {
  ...
  final pulumi.Input<
    List<AppVersionSnapshotAppDefaultChannelProfilePersonaProperty>
  >?
  personaProperties;
  ...
  /// Structure is documented below.
  final pulumi.Input<
    List<AppVersionSnapshotAppDefaultChannelProfileWebWidgetConfig>
  >?
  webWidgetConfigs;
  ...
  factory AppVersionSnapshotAppDefaultChannelProfile.fromMap(
    ...
    return AppVersionSnapshotAppDefaultChannelProfile(
      ...
      webWidgetConfigs: (() {
        final guardedValue = map['webWidgetConfigs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<
            AppVersionSnapshotAppDefaultChannelProfileWebWidgetConfig
