...
class ToolDataStoreToolEngineSourceDataStoreSourceDataStore {
  ...
  factory ToolDataStoreToolEngineSourceDataStoreSourceDataStore.fromMap(Map<String, dynamic> map) {
    return ToolDataStoreToolEngineSourceDataStoreSourceDataStore(
      connectorConfigs: (() { final guardedValue = map['connectorConfigs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ToolDataStoreToolEngineSourceDataStoreSourceDataStoreConnectorConfig>(guardedValue, (value) => ToolDataStoreToolEngineSourceDataStoreSourceDataStoreConnectorConfig.fromMap((value as Map).cast<String, dynamic>()))); })(),
