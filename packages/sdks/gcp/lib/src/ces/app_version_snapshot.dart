...
class AppVersionSnapshot {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'examples':
          ?pulumi.Input.mapOptionalInputValue<
            List<AppVersionSnapshotExample>,
            List<Map<String, dynamic>>
          >(
            examples,
            (value) =>
      ...
      'guardrails':
          ?pulumi.Input.mapOptionalInputValue<
            List<AppVersionSnapshotGuardrail>,
            List<Map<String, dynamic>>
          >(
            guardrails,
            (value) =>
      ...
      'toolsets':
          ?pulumi.Input.mapOptionalInputValue<
            List<AppVersionSnapshotToolset>,
            List<Map<String, dynamic>>
          >(
            toolsets,
            (value) =>
