...
class ConnectClusterGcpConfigAccessConfig {
  ...
  final pulumi.Input<List<ConnectClusterGcpConfigAccessConfigNetworkConfig>>
  networkConfigs;
  ...
  ConnectClusterGcpConfigAccessConfig({required this.networkConfigs});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'networkConfigs':
          pulumi.Input.mapInputValue<
            List<ConnectClusterGcpConfigAccessConfigNetworkConfig>,
