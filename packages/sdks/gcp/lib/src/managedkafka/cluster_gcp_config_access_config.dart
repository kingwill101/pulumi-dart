...
class ClusterGcpConfigAccessConfig {
  ...
  final pulumi.Input<List<ClusterGcpConfigAccessConfigNetworkConfig>>
  networkConfigs;
  ...
  ClusterGcpConfigAccessConfig({required this.networkConfigs});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'networkConfigs':
          pulumi.Input.mapInputValue<
            List<ClusterGcpConfigAccessConfigNetworkConfig>,
