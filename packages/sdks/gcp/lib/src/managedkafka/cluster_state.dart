...
class ClusterState {
    ...
    return <String, dynamic>{
      'brokerCapacityConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(brokerCapacityConfig, (value) => value.toMap()),
      'capacityConfig':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'rebalanceConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(rebalanceConfig, (value) => value.toMap()),
      'state': ?state,
      'tlsConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ClusterTlsConfig,
  ...
  factory ClusterState.fromMap(Map<String, dynamic> map) {
    return ClusterState(
      brokerCapacityConfig: (() {
        final guardedValue = map['brokerCapacityConfig'];
      ...
      capacityConfig: (() {
        final guardedValue = map['capacityConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ClusterCapacityConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      gcpConfig: (() {
        final guardedValue = map['gcpConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ClusterGcpConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      rebalanceConfig: (() {
        final guardedValue = map['rebalanceConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
