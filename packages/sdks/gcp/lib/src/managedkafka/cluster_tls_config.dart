...
class ClusterTlsConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'trustConfig': ?trustConfig == null ? null : trustConfig!.toMap(),
    };
  }

  factory ClusterTlsConfig.fromMap(Map<String, dynamic> map) {
    return ClusterTlsConfig(
      sslPrincipalMappingRules: map['sslPrincipalMappingRules'] == null ? null : map['sslPrincipalMappingRules'] as String,
      trustConfig: map['trustConfig'] == null ? null : ClusterTlsConfigTrustConfig.fromMap((map['trustConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
