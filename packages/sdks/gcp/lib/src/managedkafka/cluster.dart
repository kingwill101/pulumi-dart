...
class Cluster extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [Cluster]. {@macro pulumi_managedkafka_cluster_cluster_args_doc}
  ...
  Cluster(
    ...
    this.brokerCapacityConfig = registerOutput<ClusterBrokerCapacityConfig?>('brokerCapacityConfig');
    this.capacityConfig = registerOutput<ClusterCapacityConfig>('capacityConfig');
    ...
    this.rebalanceConfig = registerOutput<ClusterRebalanceConfig?>('rebalanceConfig');
