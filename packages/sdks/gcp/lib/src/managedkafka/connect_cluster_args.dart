...
class ConnectClusterArgs {
  ...
  factory ConnectClusterArgs.fromMap(Map<String, dynamic> map) {
    return ConnectClusterArgs(
      capacityConfig: pulumi.Input.fromValue(
        ConnectClusterCapacityConfig.fromMap(
          (map['capacityConfig']! as Map).cast<String, dynamic>(),
        ),
      ),
      connectClusterId: pulumi.Input.fromValue(
        map['connectClusterId'] as String,
      ),
      gcpConfig: pulumi.Input.fromValue(
        ConnectClusterGcpConfig.fromMap(
