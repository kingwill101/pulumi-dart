...
import 'repository_group_iam_member_args.dart';
import 'repository_group_iam_member_condition.dart';
import 'repository_group_iam_member_state.dart';
...
class RepositoryGroupIamMember extends pulumi.CustomResource {
  ...
  late final pulumi.Output<RepositoryGroupIamMemberCondition?> condition;
  ...
  /// Creates a new [RepositoryGroupIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [RepositoryGroupIamMember]. {@macro pulumi_gemini_repository_group_iam_member_repository_group_iam_member_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  RepositoryGroupIamMember(
    String name, {
    RepositoryGroupIamMemberArgs? args,
    ...
    this.condition = registerOutput<RepositoryGroupIamMemberCondition?>('condition');
  ...
  /// Gets an existing [RepositoryGroupIamMember] resource's state with the given [name] and [id].
  static RepositoryGroupIamMember get(
    String name,
