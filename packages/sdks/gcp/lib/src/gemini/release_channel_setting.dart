...
import 'release_channel_setting_state.dart';
...
/// }
///
/// resource "gcp_gemini_releasechannelsetting" "example" {
///   release_channel_setting_id = "ls1-tf"
///   location                   = "global"
///   labels = {
///     "my_key" = "my_value"
...
class ReleaseChannelSetting extends pulumi.CustomResource {
  ...
  /// Gets an existing [ReleaseChannelSetting] resource's state with the given [name] and [id].
  static ReleaseChannelSetting get(
    String name,
    pulumi.Input<String> id, {
    ReleaseChannelSettingState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return ReleaseChannelSetting._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [ReleaseChannelSetting] resource.
  ReleaseChannelSetting.reference(String urn)
    : super(
        'gcp:gemini/releaseChannelSetting:ReleaseChannelSetting',
