...
class GeminiGcpEnablementSetting extends pulumi.CustomResource {
  ...
  GeminiGcpEnablementSetting(
    ...
    this.enableCustomerDataSharing = registerOutput<bool?>('enableCustomerDataSharing');
    this.geminiGcpEnablementSettingId = registerOutput<String>('geminiGcpEnablementSettingId');
