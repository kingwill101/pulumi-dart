...
class CodeToolsSettingArgs {
    ...
    return <String, dynamic>{
      ...
      'enabledTools':
          pulumi.Input.mapInputValue<
            List<CodeToolsSettingEnabledTool>,
  ...
  factory CodeToolsSettingArgs.fromMap(Map<String, dynamic> map) {
    return CodeToolsSettingArgs(
      codeToolsSettingId: pulumi.Input.fromValue(
        map['codeToolsSettingId'] as String,
      ),
      enabledTools: pulumi.Input.fromValue(
        pulumi.Input.decodeList<CodeToolsSettingEnabledTool>(
          map['enabledTools']!,
