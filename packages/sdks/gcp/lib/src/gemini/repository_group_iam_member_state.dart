...
class RepositoryGroupIamMemberState {
  ...
  /// Creates a new [RepositoryGroupIamMemberState].
  ...
  const RepositoryGroupIamMemberState({
  ...
  factory RepositoryGroupIamMemberState.fromMap(Map<String, dynamic> map) {
    return RepositoryGroupIamMemberState(
