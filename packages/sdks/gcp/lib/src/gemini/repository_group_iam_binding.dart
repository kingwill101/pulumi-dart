...
import 'repository_group_iam_binding_state.dart';
...
class RepositoryGroupIamBinding extends pulumi.CustomResource {
  ...
  late final pulumi.Output<RepositoryGroupIamBindingCondition?> condition;
  ...
  /// Creates a new [RepositoryGroupIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [RepositoryGroupIamBinding]. {@macro pulumi_gemini_repository_group_iam_binding_repository_group_iam_binding_args_doc}
  ...
  RepositoryGroupIamBinding(
    ...
    condition = registerOutput<RepositoryGroupIamBindingCondition?>(
      'condition',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return RepositoryGroupIamBindingCondition.fromMap(
  ...
  /// Gets an existing [RepositoryGroupIamBinding] resource's state with the given [name] and [id].
  static RepositoryGroupIamBinding get(
    String name,
  ...
  RepositoryGroupIamBinding._get(
    String name, {
