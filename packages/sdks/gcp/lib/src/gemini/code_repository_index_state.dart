...
class CodeRepositoryIndexState {
  ...
  factory CodeRepositoryIndexState.fromMap(Map<String, dynamic> map) {
    return CodeRepositoryIndexState(
      codeRepositoryIndexId: (() { final guardedValue = map['codeRepositoryIndexId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
