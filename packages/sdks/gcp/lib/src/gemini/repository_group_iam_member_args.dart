...
/// {@template pulumi_gemini_repository_group_iam_member_repository_group_iam_member_args_doc}
/// The set of arguments for RepositoryGroupIamMember.
/// {@endtemplate}
/// {@macro pulumi_gemini_repository_group_iam_member_repository_group_iam_member_args_doc}
class RepositoryGroupIamMemberArgs {
  ...
  /// Creates a new [RepositoryGroupIamMemberArgs].
  ...
  const RepositoryGroupIamMemberArgs({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'condition': ?pulumi.Input.mapOptionalInputValue<RepositoryGroupIamMemberCondition, Map<String, dynamic>>(condition, (value) => value.toMap()),
      'location': ?location,
      'member': member,
      'project': ?project,
  ...
  factory RepositoryGroupIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return RepositoryGroupIamMemberArgs(
      ...
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RepositoryGroupIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
