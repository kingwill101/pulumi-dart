...
class CodeToolsSettingBindingState {
  ...
  /// Creates a new [CodeToolsSettingBindingState].
  ...
  factory CodeToolsSettingBindingState.fromMap(Map<String, dynamic> map) {
    return CodeToolsSettingBindingState(
      codeToolsSettingId: (() {
        final guardedValue = map['codeToolsSettingId'];
      ...
      settingBindingId: (() {
        final guardedValue = map['settingBindingId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      target: (() {
