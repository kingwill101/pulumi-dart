...
class ReleaseChannelSettingBindingArgs {
  ...
  factory ReleaseChannelSettingBindingArgs.fromMap(Map<String, dynamic> map) {
    return ReleaseChannelSettingBindingArgs(
      ...
      releaseChannelSettingId: pulumi.Input.fromValue(
        map['releaseChannelSettingId'] as String,
      ),
      settingBindingId: pulumi.Input.fromValue(
        map['settingBindingId'] as String,
      ),
