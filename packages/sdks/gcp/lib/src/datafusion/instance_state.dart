...
import 'instance_maintenance_event.dart';
...
class InstanceState {
  ...
  /// Structure is documented below.
  final pulumi.Input<List<InstanceMaintenanceEvent>?>? maintenanceEvents;
  ...
  /// [maintenanceEvents] The maintenance events for this instance.
  ...
  /// [serviceAccount] (Beta, Deprecated)
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'gcsBucket': ?gcsBucket,
      'labels': ?labels,
      'maintenanceEvents': ?pulumi.Input.mapOptionalInputValue<List<InstanceMaintenanceEvent>, List<Map<String, dynamic>>>(maintenanceEvents, (value) => pulumi.Input.encodeList<InstanceMaintenanceEvent, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory InstanceState.fromMap(Map<String, dynamic> map) {
    return InstanceState(
      ...
      maintenanceEvents: (() { final guardedValue = map['maintenanceEvents']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InstanceMaintenanceEvent>(guardedValue, (value) => InstanceMaintenanceEvent.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      p4ServiceAccount: (() { final guardedValue = map['p4ServiceAccount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      tenantProjectId: (() { final guardedValue = map['tenantProjectId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
