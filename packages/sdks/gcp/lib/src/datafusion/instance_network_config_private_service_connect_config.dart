...
class InstanceNetworkConfigPrivateServiceConnectConfig {
  ...
  factory InstanceNetworkConfigPrivateServiceConnectConfig.fromMap(Map<String, dynamic> map) {
    return InstanceNetworkConfigPrivateServiceConnectConfig(
      effectiveUnreachableCidrBlock: (() { final guardedValue = map['effectiveUnreachableCidrBlock']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      unreachableCidrBlock: (() { final guardedValue = map['unreachableCidrBlock']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
