...
class ApplicationState {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'urlDispatchRules':
          ?pulumi.Input.mapOptionalInputValue<
            List<ApplicationUrlDispatchRule>,
  ...
  factory ApplicationState.fromMap(Map<String, dynamic> map) {
    return ApplicationState(
      ...
      codeBucket: (() {
        final guardedValue = map['codeBucket'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      databaseType: (() {
      ...
      defaultBucket: (() {
        final guardedValue = map['defaultBucket'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      defaultHostname: (() {
      ...
      gcrDomain: (() {
        final guardedValue = map['gcrDomain'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      iap: (() {
      ...
      urlDispatchRules: (() {
        final guardedValue = map['urlDispatchRules'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ApplicationUrlDispatchRule>(
            guardedValue,
            (value) => ApplicationUrlDispatchRule.fromMap(
