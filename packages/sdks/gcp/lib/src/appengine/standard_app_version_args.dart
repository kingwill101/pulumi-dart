...
class StandardAppVersionArgs {
  ...
  StandardAppVersionArgs({
    ...
    required pulumi.Output<StandardAppVersionDeployment> deployment,
    required pulumi.Output<StandardAppVersionEntrypoint> entrypoint,
  ...
  factory StandardAppVersionArgs.fromMap(Map<String, dynamic> map) {
    return StandardAppVersionArgs(
      ...
      deployment: pulumi.Output.create<StandardAppVersionDeployment>(StandardAppVersionDeployment.fromMap((map['deployment'] as Map).cast<String, dynamic>())),
      entrypoint: pulumi.Output.create<StandardAppVersionEntrypoint>(StandardAppVersionEntrypoint.fromMap((map['entrypoint'] as Map).cast<String, dynamic>())),
