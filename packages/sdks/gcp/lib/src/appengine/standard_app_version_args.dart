...
class StandardAppVersionArgs {
  ...
  factory StandardAppVersionArgs.fromMap(Map<String, dynamic> map) {
    return StandardAppVersionArgs(
      ...
      deployment: (StandardAppVersionDeployment.fromMap((map['deployment'] as Map).cast<String, dynamic>())).input(),
      entrypoint: (StandardAppVersionEntrypoint.fromMap((map['entrypoint'] as Map).cast<String, dynamic>())).input(),
