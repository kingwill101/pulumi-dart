...
class FlexibleAppVersionArgs {
  ...
  factory FlexibleAppVersionArgs.fromMap(Map<String, dynamic> map) {
    return FlexibleAppVersionArgs(
      ...
      livenessCheck: (FlexibleAppVersionLivenessCheck.fromMap((map['livenessCheck'] as Map).cast<String, dynamic>())).input(),
      ...
      readinessCheck: (FlexibleAppVersionReadinessCheck.fromMap((map['readinessCheck'] as Map).cast<String, dynamic>())).input(),
