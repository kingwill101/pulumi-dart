...
class ApplicationUrlDispatchRules extends pulumi.CustomResource {
  ...
  /// Creates a new [ApplicationUrlDispatchRules].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ApplicationUrlDispatchRules]. {@macro pulumi_appengine_application_url_dispatch_rules_application_url_dispatch_rules_args_doc}
  ...
  /// Gets an existing [ApplicationUrlDispatchRules] resource's state with the given [name] and [id].
  static ApplicationUrlDispatchRules get(
    String name,
  ...
  ApplicationUrlDispatchRules._get(
    String name, {
