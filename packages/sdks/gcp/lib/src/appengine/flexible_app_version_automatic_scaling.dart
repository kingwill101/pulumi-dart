...
class FlexibleAppVersionAutomaticScaling {
  ...
  final pulumi.Input<FlexibleAppVersionAutomaticScalingCpuUtilization>
  cpuUtilization;

  /// Target scaling by disk usage.
  /// Structure is documented below.
  final pulumi.Input<FlexibleAppVersionAutomaticScalingDiskUtilization>?
  diskUtilization;
  ...
  /// Structure is documented below.
  final pulumi.Input<FlexibleAppVersionAutomaticScalingNetworkUtilization>?
  networkUtilization;

  /// Target scaling by request utilization.
  /// Structure is documented below.
  final pulumi.Input<FlexibleAppVersionAutomaticScalingRequestUtilization>?
  requestUtilization;
  ...
  factory FlexibleAppVersionAutomaticScaling.fromMap(Map<String, dynamic> map) {
    return FlexibleAppVersionAutomaticScaling(
      coolDownPeriod: (() {
        final guardedValue = map['coolDownPeriod'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      cpuUtilization: pulumi.Input.fromValue(
        FlexibleAppVersionAutomaticScalingCpuUtilization.fromMap(
          (map['cpuUtilization']! as Map).cast<String, dynamic>(),
        ),
      ),
      diskUtilization: (() {
        final guardedValue = map['diskUtilization'];
        if (guardedValue == null) return null;
      ...
      maxTotalInstances: (() {
        final guardedValue = map['maxTotalInstances'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      minIdleInstances: (() {
      ...
      minTotalInstances: (() {
        final guardedValue = map['minTotalInstances'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      networkUtilization: (() {
        final guardedValue = map['networkUtilization'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      requestUtilization: (() {
        final guardedValue = map['requestUtilization'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
