...
class EngineSplitTrafficSplit {
  ...
  EngineSplitTrafficSplit({required this.allocations, this.shardBy});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'allocations': allocations, 'shardBy': ?shardBy};
  }

  factory EngineSplitTrafficSplit.fromMap(Map<String, dynamic> map) {
    return EngineSplitTrafficSplit(
      allocations: pulumi.Input.fromValue(
        (map['allocations'] as Map).cast<String, String>(),
      ),
      shardBy: (() {
        final guardedValue = map['shardBy'];
