...
class FlexibleAppVersionState {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'livenessCheck': ?pulumi.Input.mapOptionalInputValue<FlexibleAppVersionLivenessCheck, Map<String, dynamic>>(livenessCheck, (value) => value.toMap()),
      ...
      'project': ?project,
      'readinessCheck': ?pulumi.Input.mapOptionalInputValue<FlexibleAppVersionReadinessCheck, Map<String, dynamic>>(readinessCheck, (value) => value.toMap()),
  ...
  factory FlexibleAppVersionState.fromMap(Map<String, dynamic> map) {
    return FlexibleAppVersionState(
      apiConfig: map['apiConfig'] == null ? null : (FlexibleAppVersionApiConfig.fromMap((map['apiConfig']! as Map).cast<String, dynamic>())).input(),
      automaticScaling: map['automaticScaling'] == null ? null : (FlexibleAppVersionAutomaticScaling.fromMap((map['automaticScaling']! as Map).cast<String, dynamic>())).input(),
      ...
      deployment: map['deployment'] == null ? null : (FlexibleAppVersionDeployment.fromMap((map['deployment']! as Map).cast<String, dynamic>())).input(),
      endpointsApiService: map['endpointsApiService'] == null ? null : (FlexibleAppVersionEndpointsApiService.fromMap((map['endpointsApiService']! as Map).cast<String, dynamic>())).input(),
      entrypoint: map['entrypoint'] == null ? null : (FlexibleAppVersionEntrypoint.fromMap((map['entrypoint']! as Map).cast<String, dynamic>())).input(),
      envVariables: map['envVariables'] == null ? null : ((map['envVariables']! as Map).cast<String, String>()).input(),
      flexibleRuntimeSettings: map['flexibleRuntimeSettings'] == null ? null : (FlexibleAppVersionFlexibleRuntimeSettings.fromMap((map['flexibleRuntimeSettings']! as Map).cast<String, dynamic>())).input(),
      handlers: map['handlers'] == null ? null : (pulumi.Input.decodeList<FlexibleAppVersionHandler>(map['handlers']!, (value) => FlexibleAppVersionHandler.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      livenessCheck: map['livenessCheck'] == null ? null : (FlexibleAppVersionLivenessCheck.fromMap((map['livenessCheck']! as Map).cast<String, dynamic>())).input(),
      manualScaling: map['manualScaling'] == null ? null : (FlexibleAppVersionManualScaling.fromMap((map['manualScaling']! as Map).cast<String, dynamic>())).input(),
      name: map['name'] == null ? null : (map['name']! as String).input(),
      network: map['network'] == null ? null : (FlexibleAppVersionNetwork.fromMap((map['network']! as Map).cast<String, dynamic>())).input(),
      ...
      readinessCheck: map['readinessCheck'] == null ? null : (FlexibleAppVersionReadinessCheck.fromMap((map['readinessCheck']! as Map).cast<String, dynamic>())).input(),
      resources: map['resources'] == null ? null : (FlexibleAppVersionResources.fromMap((map['resources']! as Map).cast<String, dynamic>())).input(),
      ...
      vpcAccessConnector: map['vpcAccessConnector'] == null ? null : (FlexibleAppVersionVpcAccessConnector.fromMap((map['vpcAccessConnector']! as Map).cast<String, dynamic>())).input(),
    );
  }
}
