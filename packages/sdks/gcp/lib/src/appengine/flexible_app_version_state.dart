  ...
  factory FlexibleAppVersionState.fromMap(Map<String, dynamic> map) {
    return FlexibleAppVersionState(
      ...
      deleteServiceOnDestroy: (() {
        final guardedValue = map['deleteServiceOnDestroy'];
        if (guardedValue == null) return null;
      ...
      livenessCheck: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FlexibleAppVersionLivenessCheck.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      noopOnDestroy: (() {
        final guardedValue = map['noopOnDestroy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      project: (() {
      ...
      readinessCheck: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FlexibleAppVersionReadinessCheck.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
