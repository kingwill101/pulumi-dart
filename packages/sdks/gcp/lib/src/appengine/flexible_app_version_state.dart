...
class FlexibleAppVersionState {
  ...
  FlexibleAppVersionState({
    ...
    pulumi.Output<FlexibleAppVersionLivenessCheck>? livenessCheck,
    ...
    pulumi.Output<FlexibleAppVersionReadinessCheck>? readinessCheck,
    ...
    pulumi.Output<FlexibleAppVersionVpcAccessConnector>? vpcAccessConnector,
      ...
      livenessCheck = pulumi.Input.asOptionalInput<FlexibleAppVersionLivenessCheck>(livenessCheck),
      ...
      readinessCheck = pulumi.Input.asOptionalInput<FlexibleAppVersionReadinessCheck>(readinessCheck),
  ...
  factory FlexibleAppVersionState.fromMap(Map<String, dynamic> map) {
    return FlexibleAppVersionState(
      ...
      livenessCheck: map['livenessCheck'] == null ? null : pulumi.Output.create<FlexibleAppVersionLivenessCheck>(FlexibleAppVersionLivenessCheck.fromMap((map['livenessCheck'] as Map).cast<String, dynamic>())),
      ...
      readinessCheck: map['readinessCheck'] == null ? null : pulumi.Output.create<FlexibleAppVersionReadinessCheck>(FlexibleAppVersionReadinessCheck.fromMap((map['readinessCheck'] as Map).cast<String, dynamic>())),
