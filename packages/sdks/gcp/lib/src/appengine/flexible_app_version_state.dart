...
class FlexibleAppVersionState {
  ...
  factory FlexibleAppVersionState.fromMap(Map<String, dynamic> map) {
    return FlexibleAppVersionState(
      ...
      livenessCheck: (() { final guardedValue = map['livenessCheck']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FlexibleAppVersionLivenessCheck.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      readinessCheck: (() { final guardedValue = map['readinessCheck']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FlexibleAppVersionReadinessCheck.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
