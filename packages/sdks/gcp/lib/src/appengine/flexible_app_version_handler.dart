...
class FlexibleAppVersionHandler {
  ...
  factory FlexibleAppVersionHandler.fromMap(Map<String, dynamic> map) {
    return FlexibleAppVersionHandler(
      ...
      script: (() { final guardedValue = map['script']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FlexibleAppVersionHandlerScript.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      staticFiles: (() { final guardedValue = map['staticFiles']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FlexibleAppVersionHandlerStaticFiles.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
