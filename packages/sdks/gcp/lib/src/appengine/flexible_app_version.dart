...
class FlexibleAppVersion extends pulumi.CustomResource {
  ...
  FlexibleAppVersion(
    ...
    this.automaticScaling = registerOutput<FlexibleAppVersionAutomaticScaling?>('automaticScaling');
    ...
    this.deleteServiceOnDestroy = registerOutput<bool?>('deleteServiceOnDestroy');
    this.deployment = registerOutput<FlexibleAppVersionDeployment?>('deployment');
    this.endpointsApiService = registerOutput<FlexibleAppVersionEndpointsApiService?>('endpointsApiService');
    this.entrypoint = registerOutput<FlexibleAppVersionEntrypoint?>('entrypoint');
    this.envVariables = registerOutput<Map<String, String>?>('envVariables');
    this.flexibleRuntimeSettings = registerOutput<FlexibleAppVersionFlexibleRuntimeSettings?>('flexibleRuntimeSettings');
    ...
    this.livenessCheck = registerOutput<FlexibleAppVersionLivenessCheck>('livenessCheck');
    this.manualScaling = registerOutput<FlexibleAppVersionManualScaling?>('manualScaling');
    ...
    this.readinessCheck = registerOutput<FlexibleAppVersionReadinessCheck>('readinessCheck');
    ...
    this.runtimeMainExecutablePath = registerOutput<String?>('runtimeMainExecutablePath');
    this.service = registerOutput<String>('service');
    this.serviceAccount = registerOutput<String>('serviceAccount');
    this.servingStatus = registerOutput<String?>('servingStatus');
    this.versionId = registerOutput<String?>('versionId');
    this.vpcAccessConnector = registerOutput<FlexibleAppVersionVpcAccessConnector?>('vpcAccessConnector');
  }
