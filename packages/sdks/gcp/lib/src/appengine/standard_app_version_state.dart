...
class StandardAppVersionState {
  ...
  StandardAppVersionState({
    ...
    pulumi.Output<StandardAppVersionAutomaticScaling>? automaticScaling,
    pulumi.Output<StandardAppVersionBasicScaling>? basicScaling,
    pulumi.Output<bool>? deleteServiceOnDestroy,
    pulumi.Output<StandardAppVersionDeployment>? deployment,
    pulumi.Output<StandardAppVersionEntrypoint>? entrypoint,
    pulumi.Output<Map<String, String>>? envVariables,
    pulumi.Output<List<StandardAppVersionHandler>>? handlers,
    pulumi.Output<List<String>>? inboundServices,
    pulumi.Output<String>? instanceClass,
    pulumi.Output<List<StandardAppVersionLibrary>>? libraries,
    pulumi.Output<StandardAppVersionManualScaling>? manualScaling,
    ...
    pulumi.Output<StandardAppVersionVpcAccessConnector>? vpcAccessConnector,
  }) :
      ...
      deployment = pulumi.Input.asOptionalInput<StandardAppVersionDeployment>(deployment),
      entrypoint = pulumi.Input.asOptionalInput<StandardAppVersionEntrypoint>(entrypoint),
  ...
  factory StandardAppVersionState.fromMap(Map<String, dynamic> map) {
    return StandardAppVersionState(
      ...
      automaticScaling: map['automaticScaling'] == null ? null : pulumi.Output.create<StandardAppVersionAutomaticScaling>(StandardAppVersionAutomaticScaling.fromMap((map['automaticScaling'] as Map).cast<String, dynamic>())),
      basicScaling: map['basicScaling'] == null ? null : pulumi.Output.create<StandardAppVersionBasicScaling>(StandardAppVersionBasicScaling.fromMap((map['basicScaling'] as Map).cast<String, dynamic>())),
      deleteServiceOnDestroy: map['deleteServiceOnDestroy'] == null ? null : pulumi.Output.create<bool>(map['deleteServiceOnDestroy'] as bool),
      deployment: map['deployment'] == null ? null : pulumi.Output.create<StandardAppVersionDeployment>(StandardAppVersionDeployment.fromMap((map['deployment'] as Map).cast<String, dynamic>())),
      entrypoint: map['entrypoint'] == null ? null : pulumi.Output.create<StandardAppVersionEntrypoint>(StandardAppVersionEntrypoint.fromMap((map['entrypoint'] as Map).cast<String, dynamic>())),
      ...
      handlers: map['handlers'] == null ? null : pulumi.Output.create<List<StandardAppVersionHandler>>(pulumi.Input.decodeList<StandardAppVersionHandler>(map['handlers'], (value) => StandardAppVersionHandler.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      libraries: map['libraries'] == null ? null : pulumi.Output.create<List<StandardAppVersionLibrary>>(pulumi.Input.decodeList<StandardAppVersionLibrary>(map['libraries'], (value) => StandardAppVersionLibrary.fromMap((value as Map).cast<String, dynamic>()))),
      manualScaling: map['manualScaling'] == null ? null : pulumi.Output.create<StandardAppVersionManualScaling>(StandardAppVersionManualScaling.fromMap((map['manualScaling'] as Map).cast<String, dynamic>())),
      ...
      vpcAccessConnector: map['vpcAccessConnector'] == null ? null : pulumi.Output.create<StandardAppVersionVpcAccessConnector>(StandardAppVersionVpcAccessConnector.fromMap((map['vpcAccessConnector'] as Map).cast<String, dynamic>())),
    );
  }
}
