...
class PolicyDryRunSpecRuleCondition {
  ...
  /// Creates a new [PolicyDryRunSpecRuleCondition].
  ...
  const PolicyDryRunSpecRuleCondition({
    this.description,
    this.expression,
    this.location,
    this.title,
  ...
  factory PolicyDryRunSpecRuleCondition.fromMap(Map<String, dynamic> map) {
    return PolicyDryRunSpecRuleCondition(
