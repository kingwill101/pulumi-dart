...
class PolicySpec {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'reset': ?reset,
      'rules': ?rules == null ? null : pulumi.Input.encodeList<PolicySpecRule, Map<String, dynamic>>(rules!, (value) => value.toMap()),
  ...
  factory PolicySpec.fromMap(Map<String, dynamic> map) {
    return PolicySpec(
      ...
      rules: map['rules'] == null ? null : pulumi.Input.decodeList<PolicySpecRule>(map['rules'], (value) => PolicySpecRule.fromMap((value as Map).cast<String, dynamic>())),
