...
class PolicySpecRule {
  ...
  factory PolicySpecRule.fromMap(Map<String, dynamic> map) {
    return PolicySpecRule(
      ...
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PolicySpecRuleCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      values: (() { final guardedValue = map['values']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PolicySpecRuleValues.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
