...
import 'secret_iam_binding_args.dart';
import 'secret_iam_binding_condition.dart';
import 'secret_iam_binding_state.dart';
...
class SecretIamBinding extends pulumi.CustomResource {
  ...
  late final pulumi.Output<SecretIamBindingCondition?> condition;
  ...
  /// Creates a new [SecretIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [SecretIamBinding]. {@macro pulumi_secretmanager_secret_iam_binding_secret_iam_binding_args_doc}
  ...
  SecretIamBinding(
    ...
    condition = registerOutput<SecretIamBindingCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SecretIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [SecretIamBinding] resource's state with the given [name] and [id].
  static SecretIamBinding get(
    String name,
    pulumi.Input<String> id, {
    SecretIamBindingState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return SecretIamBinding._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [SecretIamBinding] resource.
  SecretIamBinding.reference(String urn)
    : super(
        'gcp:secretmanager/secretIamBinding:SecretIamBinding',
