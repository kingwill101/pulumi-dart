...
import 'secret_iam_policy_state.dart';
...
class SecretIamPolicy extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [SecretIamPolicy]. {@macro pulumi_secretmanager_secret_iam_policy_secret_iam_policy_args_doc}
  ...
  /// Gets an existing [SecretIamPolicy] resource's state with the given [name] and [id].
  static SecretIamPolicy get(
    String name,
    pulumi.Input<String> id, {
    SecretIamPolicyState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return SecretIamPolicy._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [SecretIamPolicy] resource.
  SecretIamPolicy.reference(String urn)
    : super(
        'gcp:secretmanager/secretIamPolicy:SecretIamPolicy',
