...
import 'secret_iam_member_condition.dart';

/// Input properties used for looking up and filtering SecretIamMember resources.
class SecretIamMemberState {
  /// An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
  /// Structure is documented below.
  final pulumi.Input<SecretIamMemberCondition>? condition;
  ...
  /// Creates a new [SecretIamMemberState].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'condition': ?pulumi.Input.mapOptionalInputValue<SecretIamMemberCondition, Map<String, dynamic>>(condition, (value) => value.toMap()),
      'etag': ?etag,
      'member': ?member,
      'project': ?project,
      'role': ?role,
  ...
  factory SecretIamMemberState.fromMap(Map<String, dynamic> map) {
    return SecretIamMemberState(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SecretIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
