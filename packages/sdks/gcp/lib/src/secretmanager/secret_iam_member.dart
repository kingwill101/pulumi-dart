...
import 'secret_iam_member_state.dart';
...
class SecretIamMember extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [SecretIamMember]. {@macro pulumi_secretmanager_secret_iam_member_secret_iam_member_args_doc}
  ...
  SecretIamMember(
    ...
    condition = registerOutput<SecretIamMemberCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SecretIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [SecretIamMember] resource's state with the given [name] and [id].
  static SecretIamMember get(
    String name,
    pulumi.Input<String> id, {
    SecretIamMemberState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return SecretIamMember._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [SecretIamMember] resource.
  SecretIamMember.reference(String urn)
    : super(
        'gcp:secretmanager/secretIamMember:SecretIamMember',
