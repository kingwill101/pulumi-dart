...
class GetSecretsSecretReplicationUserManaged {
  ...
  final pulumi.Input<List<GetSecretsSecretReplicationUserManagedReplica>>
  replicas;

  /// Creates a new [GetSecretsSecretReplicationUserManaged].
  /// [replicas] The list of Replicas for this Secret.
  GetSecretsSecretReplicationUserManaged({required this.replicas});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'replicas':
          pulumi.Input.mapInputValue<
            List<GetSecretsSecretReplicationUserManagedReplica>,
  ...
  factory GetSecretsSecretReplicationUserManaged.fromMap(
    ...
    return GetSecretsSecretReplicationUserManaged(
      replicas: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetSecretsSecretReplicationUserManagedReplica>(
          map['replicas']!,
