...
/// {@template pulumi_secretmanager_secret_iam_binding_secret_iam_binding_args_doc}
/// The set of arguments for SecretIamBinding.
/// {@endtemplate}
/// {@macro pulumi_secretmanager_secret_iam_binding_secret_iam_binding_args_doc}
class SecretIamBindingArgs {
  ...
  /// Creates a new [SecretIamBindingArgs].
  ...
  SecretIamBindingArgs({
    pulumi.Output<SecretIamBindingCondition>? condition,
    required pulumi.Output<List<String>> members,
    pulumi.Output<String>? project,
    required pulumi.Output<String> role,
    required pulumi.Output<String> secretId,
  }) :
      condition = pulumi.Input.asOptionalInput<SecretIamBindingCondition>(condition),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'condition': ?pulumi.Input.mapOptionalInputValue<SecretIamBindingCondition, Map<String, dynamic>>(condition, (value) => value.toMap()),
      'members': members,
      'project': ?project,
      'role': role,
      'secretId': secretId,
  ...
  factory SecretIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return SecretIamBindingArgs(
      condition: map['condition'] == null ? null : pulumi.Output.create<SecretIamBindingCondition>(SecretIamBindingCondition.fromMap((map['condition'] as Map).cast<String, dynamic>())),
