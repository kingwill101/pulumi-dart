...
import 'regional_secret_iam_member_args.dart';
import 'regional_secret_iam_member_condition.dart';
import 'regional_secret_iam_member_state.dart';
...
class RegionalSecretIamMember extends pulumi.CustomResource {
  ...
  late final pulumi.Output<RegionalSecretIamMemberCondition?> condition;
  ...
  /// Creates a new [RegionalSecretIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [RegionalSecretIamMember]. {@macro pulumi_secretmanager_regional_secret_iam_member_regional_secret_iam_member_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  RegionalSecretIamMember(
    String name, {
    RegionalSecretIamMemberArgs? args,
    ...
    condition = registerOutput<RegionalSecretIamMemberCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return RegionalSecretIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [RegionalSecretIamMember] resource's state with the given [name] and [id].
  static RegionalSecretIamMember get(
    String name,
    pulumi.Input<String> id, {
    RegionalSecretIamMemberState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return RegionalSecretIamMember._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [RegionalSecretIamMember] resource.
  RegionalSecretIamMember.reference(String urn)
    : super(
        'gcp:secretmanager/regionalSecretIamMember:RegionalSecretIamMember',
