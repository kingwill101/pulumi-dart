...
class GetSecretsSecretReplication {
  ...
  factory GetSecretsSecretReplication.fromMap(Map<String, dynamic> map) {
    return GetSecretsSecretReplication(
      autos: (pulumi.Input.decodeList<GetSecretsSecretReplicationAuto>(map['autos'], (value) => GetSecretsSecretReplicationAuto.fromMap((value as Map).cast<String, dynamic>()))).input(),
      userManageds: (pulumi.Input.decodeList<GetSecretsSecretReplicationUserManaged>(map['userManageds'], (value) => GetSecretsSecretReplicationUserManaged.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
