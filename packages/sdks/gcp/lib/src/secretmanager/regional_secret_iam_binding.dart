...
import 'regional_secret_iam_binding_args.dart';
import 'regional_secret_iam_binding_condition.dart';
import 'regional_secret_iam_binding_state.dart';
...
class RegionalSecretIamBinding extends pulumi.CustomResource {
  ...
  late final pulumi.Output<RegionalSecretIamBindingCondition?> condition;
  ...
  /// Creates a new [RegionalSecretIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [RegionalSecretIamBinding]. {@macro pulumi_secretmanager_regional_secret_iam_binding_regional_secret_iam_binding_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  RegionalSecretIamBinding(
    String name, {
    RegionalSecretIamBindingArgs? args,
    ...
    condition = registerOutput<RegionalSecretIamBindingCondition?>(
      'condition',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return RegionalSecretIamBindingCondition.fromMap(
  ...
  /// Gets an existing [RegionalSecretIamBinding] resource's state with the given [name] and [id].
  static RegionalSecretIamBinding get(
    String name,
