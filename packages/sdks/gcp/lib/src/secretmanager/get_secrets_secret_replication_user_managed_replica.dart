...
class GetSecretsSecretReplicationUserManagedReplica {
  ...
  factory GetSecretsSecretReplicationUserManagedReplica.fromMap(Map<String, dynamic> map) {
    return GetSecretsSecretReplicationUserManagedReplica(
      customerManagedEncryptions: pulumi.Input.fromValue(pulumi.Input.decodeList<GetSecretsSecretReplicationUserManagedReplicaCustomerManagedEncryption>(map['customerManagedEncryptions']!, (value) => GetSecretsSecretReplicationUserManagedReplicaCustomerManagedEncryption.fromMap((value as Map).cast<String, dynamic>()))),
