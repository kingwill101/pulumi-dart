...
class GetSecretReplicationUserManagedReplica {
  ...
  const GetSecretReplicationUserManagedReplica({
  ...
  factory GetSecretReplicationUserManagedReplica.fromMap(Map<String, dynamic> map) {
    return GetSecretReplicationUserManagedReplica(
      customerManagedEncryptions: pulumi.Input.fromValue(pulumi.Input.decodeList<GetSecretReplicationUserManagedReplicaCustomerManagedEncryption>(map['customerManagedEncryptions']!, (value) => GetSecretReplicationUserManagedReplicaCustomerManagedEncryption.fromMap((value as Map).cast<String, dynamic>()))),
