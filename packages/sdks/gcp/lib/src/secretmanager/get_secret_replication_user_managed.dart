...
class GetSecretReplicationUserManaged {
  ...
  GetSecretReplicationUserManaged({required this.replicas});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'replicas':
          pulumi.Input.mapInputValue<
            List<GetSecretReplicationUserManagedReplica>,
  ...
  factory GetSecretReplicationUserManaged.fromMap(Map<String, dynamic> map) {
    return GetSecretReplicationUserManaged(
      replicas: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetSecretReplicationUserManagedReplica>(
          map['replicas']!,
