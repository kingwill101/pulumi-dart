...
class SecretReplicationAuto {
  ...
  factory SecretReplicationAuto.fromMap(Map<String, dynamic> map) {
    return SecretReplicationAuto(
      customerManagedEncryption: (() { final guardedValue = map['customerManagedEncryption']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SecretReplicationAutoCustomerManagedEncryption.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
