...
class SecretReplicationUserManaged {
  ...
  const SecretReplicationUserManaged({
  ...
  factory SecretReplicationUserManaged.fromMap(Map<String, dynamic> map) {
    return SecretReplicationUserManaged(
      replicas: pulumi.Input.fromValue(pulumi.Input.decodeList<SecretReplicationUserManagedReplica>(map['replicas']!, (value) => SecretReplicationUserManagedReplica.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
