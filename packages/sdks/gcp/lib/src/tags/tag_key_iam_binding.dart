...
import 'tag_key_iam_binding_state.dart';
...
/// }
///
/// resource "gcp_tags_tagkeyiampolicy" "policy" {
///   tag_key     = key.name
...
/// }
///
/// resource "gcp_tags_tagkeyiambinding" "binding" {
///   tag_key = key.name
///   role    = "roles/viewer"
///   members = ["user:jane@example.com"]
/// }
...
/// }
///
/// resource "gcp_tags_tagkeyiammember" "member" {
///   tag_key = key.name
///   role    = "roles/viewer"
///   member  = "user:jane@example.com"
/// }
...
class TagKeyIamBinding extends pulumi.CustomResource {
  ...
  late final pulumi.Output<TagKeyIamBindingCondition?> condition;
  ...
  /// Creates a new [TagKeyIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [TagKeyIamBinding]. {@macro pulumi_tags_tag_key_iam_binding_tag_key_iam_binding_args_doc}
  ...
  /// Gets an existing [TagKeyIamBinding] resource's state with the given [name] and [id].
  static TagKeyIamBinding get(
    String name,
