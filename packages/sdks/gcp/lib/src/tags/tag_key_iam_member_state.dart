...
class TagKeyIamMemberState {
  ...
  /// Creates a new [TagKeyIamMemberState].
  ...
  factory TagKeyIamMemberState.fromMap(Map<String, dynamic> map) {
    return TagKeyIamMemberState(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TagKeyIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
