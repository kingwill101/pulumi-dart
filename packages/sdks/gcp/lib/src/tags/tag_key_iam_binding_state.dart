...
class TagKeyIamBindingState {
  ...
  factory TagKeyIamBindingState.fromMap(Map<String, dynamic> map) {
    return TagKeyIamBindingState(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TagKeyIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
