...
import 'backup_plan_iam_member_state.dart';
...
class BackupPlanIamMember extends pulumi.CustomResource {
  ...
  /// Gets an existing [BackupPlanIamMember] resource's state with the given [name] and [id].
  static BackupPlanIamMember get(
    String name,
    pulumi.Input<String> id, {
    BackupPlanIamMemberState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return BackupPlanIamMember._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [BackupPlanIamMember] resource.
  BackupPlanIamMember.reference(String urn)
    : super(
        'gcp:gkebackup/backupPlanIamMember:BackupPlanIamMember',
