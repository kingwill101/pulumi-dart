...
class BackupPlanBackupConfig {
  ...
  factory BackupPlanBackupConfig.fromMap(Map<String, dynamic> map) {
    return BackupPlanBackupConfig(
      ...
      encryptionKey: (() { final guardedValue = map['encryptionKey']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BackupPlanBackupConfigEncryptionKey.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      permissiveMode: (() { final guardedValue = map['permissiveMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      selectedApplications: (() { final guardedValue = map['selectedApplications']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BackupPlanBackupConfigSelectedApplications.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      selectedNamespaceLabels: (() { final guardedValue = map['selectedNamespaceLabels']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BackupPlanBackupConfigSelectedNamespaceLabels.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      selectedNamespaces: (() { final guardedValue = map['selectedNamespaces']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BackupPlanBackupConfigSelectedNamespaces.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
