...
class BackupPlanBackupConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'selectedNamespaceLabels': ?selectedNamespaceLabels == null ? null : selectedNamespaceLabels!.toMap(),
  ...
  factory BackupPlanBackupConfig.fromMap(Map<String, dynamic> map) {
    return BackupPlanBackupConfig(
      ...
      encryptionKey: map['encryptionKey'] == null ? null : BackupPlanBackupConfigEncryptionKey.fromMap((map['encryptionKey'] as Map).cast<String, dynamic>()),
      ...
      permissiveMode: map['permissiveMode'] == null ? null : map['permissiveMode'] as bool,
      selectedApplications: map['selectedApplications'] == null ? null : BackupPlanBackupConfigSelectedApplications.fromMap((map['selectedApplications'] as Map).cast<String, dynamic>()),
      selectedNamespaceLabels: map['selectedNamespaceLabels'] == null ? null : BackupPlanBackupConfigSelectedNamespaceLabels.fromMap((map['selectedNamespaceLabels'] as Map).cast<String, dynamic>()),
      selectedNamespaces: map['selectedNamespaces'] == null ? null : BackupPlanBackupConfigSelectedNamespaces.fromMap((map['selectedNamespaces'] as Map).cast<String, dynamic>()),
    );
  }
}
