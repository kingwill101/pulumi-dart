...
class BackupPlanBackupSchedule {
  ...
  factory BackupPlanBackupSchedule.fromMap(Map<String, dynamic> map) {
    return BackupPlanBackupSchedule(
      ...
      rpoConfig: (() { final guardedValue = map['rpoConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BackupPlanBackupScheduleRpoConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
