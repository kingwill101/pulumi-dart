...
class BackupPlan extends pulumi.CustomResource {
  ...
  BackupPlan(
    ...
    this.backupSchedule = registerOutput<BackupPlanBackupSchedule?>('backupSchedule');
    ...
    this.retentionPolicy = registerOutput<BackupPlanRetentionPolicy?>('retentionPolicy');
