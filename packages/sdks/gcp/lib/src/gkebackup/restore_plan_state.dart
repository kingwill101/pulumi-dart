...
class RestorePlanState {
  ...
  factory RestorePlanState.fromMap(Map<String, dynamic> map) {
    return RestorePlanState(
      ...
      restoreConfig: (() { final guardedValue = map['restoreConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RestorePlanRestoreConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
