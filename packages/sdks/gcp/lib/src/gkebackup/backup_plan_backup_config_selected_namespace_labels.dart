...
class BackupPlanBackupConfigSelectedNamespaceLabels {
  ...
  factory BackupPlanBackupConfigSelectedNamespaceLabels.fromMap(Map<String, dynamic> map) {
    return BackupPlanBackupConfigSelectedNamespaceLabels(
      resourceLabels: (pulumi.Input.decodeList<BackupPlanBackupConfigSelectedNamespaceLabelsResourceLabel>(map['resourceLabels'], (value) => BackupPlanBackupConfigSelectedNamespaceLabelsResourceLabel.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
