...
class BackupPlanState {
  ...
  factory BackupPlanState.fromMap(Map<String, dynamic> map) {
    return BackupPlanState(
      ...
      protectedNamespaceCount: (() { final guardedValue = map['protectedNamespaceCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      protectedPodCount: (() { final guardedValue = map['protectedPodCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
