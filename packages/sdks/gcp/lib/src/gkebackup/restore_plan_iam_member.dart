...
import 'restore_plan_iam_member_args.dart';
import 'restore_plan_iam_member_condition.dart';
import 'restore_plan_iam_member_state.dart';
...
class RestorePlanIamMember extends pulumi.CustomResource {
  late final pulumi.Output<RestorePlanIamMemberCondition?> condition;
  ...
  /// Creates a new [RestorePlanIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [RestorePlanIamMember]. {@macro pulumi_gkebackup_restore_plan_iam_member_restore_plan_iam_member_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  RestorePlanIamMember(
    String name, {
    RestorePlanIamMemberArgs? args,
    ...
    condition = registerOutput<RestorePlanIamMemberCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return RestorePlanIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [RestorePlanIamMember] resource's state with the given [name] and [id].
  static RestorePlanIamMember get(
    String name,
    pulumi.Input<String> id, {
    RestorePlanIamMemberState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return RestorePlanIamMember._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [RestorePlanIamMember] resource.
  RestorePlanIamMember.reference(String urn)
    : super(
        'gcp:gkebackup/restorePlanIamMember:RestorePlanIamMember',
