...
class RestorePlanRestoreConfigTransformationRule {
  ...
  factory RestorePlanRestoreConfigTransformationRule.fromMap(Map<String, dynamic> map) {
    return RestorePlanRestoreConfigTransformationRule(
      ...
      fieldActions: pulumi.Input.fromValue(pulumi.Input.decodeList<RestorePlanRestoreConfigTransformationRuleFieldAction>(map['fieldActions']!, (value) => RestorePlanRestoreConfigTransformationRuleFieldAction.fromMap((value as Map).cast<String, dynamic>()))),
      resourceFilter: (() { final guardedValue = map['resourceFilter']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RestorePlanRestoreConfigTransformationRuleResourceFilter.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
