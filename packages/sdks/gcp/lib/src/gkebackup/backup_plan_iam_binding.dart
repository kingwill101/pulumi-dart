...
import 'backup_plan_iam_binding_state.dart';
...
/// }
///
/// resource "gcp_gkebackup_backupplaniampolicy" "policy" {
///   project     = basic.project
///   location    = basic.location
///   name        = basic.name
...
/// }
///
/// resource "gcp_gkebackup_backupplaniambinding" "binding" {
///   project  = basic.project
///   location = basic.location
///   name     = basic.name
///   role     = "roles/viewer"
...
/// }
///
/// resource "gcp_gkebackup_backupplaniammember" "member" {
///   project  = basic.project
///   location = basic.location
///   name     = basic.name
///   role     = "roles/viewer"
...
class BackupPlanIamBinding extends pulumi.CustomResource {
  ...
  BackupPlanIamBinding(
    ...
    condition = registerOutput<BackupPlanIamBindingCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return BackupPlanIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [BackupPlanIamBinding] resource's state with the given [name] and [id].
  static BackupPlanIamBinding get(
    String name,
    pulumi.Input<String> id, {
    BackupPlanIamBindingState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return BackupPlanIamBinding._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [BackupPlanIamBinding] resource.
  BackupPlanIamBinding.reference(String urn)
    : super(
        'gcp:gkebackup/backupPlanIamBinding:BackupPlanIamBinding',
