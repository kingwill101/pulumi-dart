...
class RestorePlanRestoreConfig {
  ...
  final pulumi.Input<RestorePlanRestoreConfigClusterResourceRestoreScope>?
  clusterResourceRestoreScope;

  /// A list of selected namespaces excluded from restoration.
  /// All namespaces except those in this list will be restored.
  /// Structure is documented below.
  final pulumi.Input<RestorePlanRestoreConfigExcludedNamespaces>?
  excludedNamespaces;
  ...
  /// Structure is documented below.
  final pulumi.Input<RestorePlanRestoreConfigSelectedApplications>?
  ...
  /// Structure is documented below.
  final pulumi.Input<RestorePlanRestoreConfigSelectedNamespaces>?
  selectedNamespaces;
  ...
  /// Structure is documented below.
  final pulumi.Input<List<RestorePlanRestoreConfigTransformationRule>>?
  transformationRules;
    ...
    return <String, dynamic>{
      ...
      'excludedNamespaces':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(excludedNamespaces, (value) => value.toMap()),
      ...
      'restoreOrder':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(restoreOrder, (value) => value.toMap()),
      'selectedApplications':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'transformationRules':
          ?pulumi.Input.mapOptionalInputValue<
            List<RestorePlanRestoreConfigTransformationRule>,
  ...
  factory RestorePlanRestoreConfig.fromMap(Map<String, dynamic> map) {
    return RestorePlanRestoreConfig(
      ...
      restoreOrder: (() {
        final guardedValue = map['restoreOrder'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      volumeDataRestorePolicyBindings: (() {
        final guardedValue = map['volumeDataRestorePolicyBindings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                RestorePlanRestoreConfigVolumeDataRestorePolicyBinding.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
