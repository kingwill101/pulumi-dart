...
import 'backup_channel_state.dart';
...
/// }
///
/// resource "gcp_gkebackup_backupchannel" "basic" {
///   name                = "basic-channel"
///   location            = "us-central1"
///   description         = "Description"
///   destination_project = "projects/24240755850"
...
class BackupChannel extends pulumi.CustomResource {
  ...
  /// Gets an existing [BackupChannel] resource's state with the given [name] and [id].
  static BackupChannel get(
    String name,
    pulumi.Input<String> id, {
    BackupChannelState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return BackupChannel._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [BackupChannel] resource.
  BackupChannel.reference(String urn)
    : super(
        'gcp:gkebackup/backupChannel:BackupChannel',
