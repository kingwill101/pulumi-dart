...
class RestorePlanRestoreConfigRestoreOrder {
  ...
  factory RestorePlanRestoreConfigRestoreOrder.fromMap(Map<String, dynamic> map) {
    return RestorePlanRestoreConfigRestoreOrder(
      groupKindDependencies: (pulumi.Input.decodeList<RestorePlanRestoreConfigRestoreOrderGroupKindDependency>(map['groupKindDependencies'], (value) => RestorePlanRestoreConfigRestoreOrderGroupKindDependency.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
