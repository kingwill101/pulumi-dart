...
class BackupPlanBackupConfigSelectedApplications {
  ...
  factory BackupPlanBackupConfigSelectedApplications.fromMap(Map<String, dynamic> map) {
    return BackupPlanBackupConfigSelectedApplications(
      namespacedNames: (pulumi.Input.decodeList<BackupPlanBackupConfigSelectedApplicationsNamespacedName>(map['namespacedNames'], (value) => BackupPlanBackupConfigSelectedApplicationsNamespacedName.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
