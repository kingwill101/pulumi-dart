...
class MirroringEndpointGroupState {
  ...
  /// group.
  /// Structure is documented below.
  final pulumi.Input<List<MirroringEndpointGroupConnectedDeploymentGroup>>?
    ...
    return MirroringEndpointGroupState(
      associations: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MirroringEndpointGroupAssociation>(
            guardedValue,
            (value) => MirroringEndpointGroupAssociation.fromMap(
      ...
      connectedDeploymentGroups: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
            ...
            guardedValue,
            (value) => MirroringEndpointGroupConnectedDeploymentGroup.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      mirroringDeploymentGroup: (() {
        final guardedValue = map['mirroringDeploymentGroup'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ...
      mirroringEndpointGroupId: (() {
        final guardedValue = map['mirroringEndpointGroupId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      name: (() {
