...
class AuthorizationPolicyRuleDestination {
  ...
  factory AuthorizationPolicyRuleDestination.fromMap(Map<String, dynamic> map) {
    return AuthorizationPolicyRuleDestination(
      ...
      httpHeaderMatch: (() { final guardedValue = map['httpHeaderMatch']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AuthorizationPolicyRuleDestinationHttpHeaderMatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
