...
class AuthzPolicyCustomProvider {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'authzExtension': ?authzExtension == null ? null : authzExtension!.toMap(),
  ...
  factory AuthzPolicyCustomProvider.fromMap(Map<String, dynamic> map) {
    return AuthzPolicyCustomProvider(
      authzExtension: map['authzExtension'] == null ? null : AuthzPolicyCustomProviderAuthzExtension.fromMap((map['authzExtension'] as Map).cast<String, dynamic>()),
      cloudIap: map['cloudIap'] == null ? null : AuthzPolicyCustomProviderCloudIap.fromMap((map['cloudIap'] as Map).cast<String, dynamic>()),
    );
  }
}
