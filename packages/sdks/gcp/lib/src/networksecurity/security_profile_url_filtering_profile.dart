...
class SecurityProfileUrlFilteringProfile {
  ...
  final pulumi.Input<List<SecurityProfileUrlFilteringProfileUrlFilter>>?
  urlFilters;
    ...
    return <String, dynamic>{
      'urlFilters':
          ?pulumi.Input.mapOptionalInputValue<
            List<SecurityProfileUrlFilteringProfileUrlFilter>,
  ...
  factory SecurityProfileUrlFilteringProfile.fromMap(Map<String, dynamic> map) {
    return SecurityProfileUrlFilteringProfile(
      urlFilters: (() {
        final guardedValue = map['urlFilters'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SecurityProfileUrlFilteringProfileUrlFilter>(
            guardedValue,
