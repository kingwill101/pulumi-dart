...
class SecurityProfileThreatPreventionProfile {
  ...
  final pulumi.Input<
    List<SecurityProfileThreatPreventionProfileAntivirusOverride>
  >?
  antivirusOverrides;
  ...
  /// Structure is documented below.
  final pulumi.Input<
    List<SecurityProfileThreatPreventionProfileSeverityOverride>
  >?
  severityOverrides;
  ...
  /// Structure is documented below.
  final pulumi.Input<
    List<SecurityProfileThreatPreventionProfileThreatOverride>
  >?
  threatOverrides;
  ...
  factory SecurityProfileThreatPreventionProfile.fromMap(
    ...
    return SecurityProfileThreatPreventionProfile(
      antivirusOverrides: (() {
        final guardedValue = map['antivirusOverrides'];
      ...
      severityOverrides: (() {
        final guardedValue = map['severityOverrides'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<
            SecurityProfileThreatPreventionProfileSeverityOverride
      ...
      threatOverrides: (() {
        final guardedValue = map['threatOverrides'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<
            SecurityProfileThreatPreventionProfileThreatOverride
