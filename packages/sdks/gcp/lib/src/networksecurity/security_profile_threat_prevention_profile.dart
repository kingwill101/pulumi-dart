...
class SecurityProfileThreatPreventionProfile {
  ...
  factory SecurityProfileThreatPreventionProfile.fromMap(Map<String, dynamic> map) {
    return SecurityProfileThreatPreventionProfile(
      antivirusOverrides: (() { final guardedValue = map['antivirusOverrides']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SecurityProfileThreatPreventionProfileAntivirusOverride>(guardedValue, (value) => SecurityProfileThreatPreventionProfileAntivirusOverride.fromMap((value as Map).cast<String, dynamic>()))); })(),
      severityOverrides: (() { final guardedValue = map['severityOverrides']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SecurityProfileThreatPreventionProfileSeverityOverride>(guardedValue, (value) => SecurityProfileThreatPreventionProfileSeverityOverride.fromMap((value as Map).cast<String, dynamic>()))); })(),
      threatOverrides: (() { final guardedValue = map['threatOverrides']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SecurityProfileThreatPreventionProfileThreatOverride>(guardedValue, (value) => SecurityProfileThreatPreventionProfileThreatOverride.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
