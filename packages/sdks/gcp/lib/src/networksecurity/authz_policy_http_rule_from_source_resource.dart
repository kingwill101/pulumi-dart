...
class AuthzPolicyHttpRuleFromSourceResource {
  ...
  final pulumi.Input<AuthzPolicyHttpRuleFromSourceResourceIamServiceAccount>?
  iamServiceAccount;
  ...
  /// Structure is documented below.
  final pulumi.Input<AuthzPolicyHttpRuleFromSourceResourceTagValueIdSet>?
  tagValueIdSet;
    ...
    return <String, dynamic>{
      'iamServiceAccount':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(iamServiceAccount, (value) => value.toMap()),
      'tagValueIdSet':
          ?pulumi.Input.mapOptionalInputValue<
            AuthzPolicyHttpRuleFromSourceResourceTagValueIdSet,
            Map<String, dynamic>
          >(tagValueIdSet, (value) => value.toMap()),
    };
  }
  ...
  factory AuthzPolicyHttpRuleFromSourceResource.fromMap(
    ...
    return AuthzPolicyHttpRuleFromSourceResource(
      iamServiceAccount: (() {
        final guardedValue = map['iamServiceAccount'];
      ...
      tagValueIdSet: (() {
        final guardedValue = map['tagValueIdSet'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
