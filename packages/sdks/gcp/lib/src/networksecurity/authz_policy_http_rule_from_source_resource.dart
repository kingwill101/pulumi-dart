...
class AuthzPolicyHttpRuleFromSourceResource {
  ...
  final AuthzPolicyHttpRuleFromSourceResourceIamServiceAccount? iamServiceAccount;
  ...
  factory AuthzPolicyHttpRuleFromSourceResource.fromMap(Map<String, dynamic> map) {
    return AuthzPolicyHttpRuleFromSourceResource(
      iamServiceAccount: map['iamServiceAccount'] == null ? null : AuthzPolicyHttpRuleFromSourceResourceIamServiceAccount.fromMap((map['iamServiceAccount'] as Map).cast<String, dynamic>()),
      tagValueIdSet: map['tagValueIdSet'] == null ? null : AuthzPolicyHttpRuleFromSourceResourceTagValueIdSet.fromMap((map['tagValueIdSet'] as Map).cast<String, dynamic>()),
    );
  }
}
