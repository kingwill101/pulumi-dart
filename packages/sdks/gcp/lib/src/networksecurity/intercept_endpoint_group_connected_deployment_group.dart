...
class InterceptEndpointGroupConnectedDeploymentGroup {
  ...
  /// [locations] (Output)
  /// [name] (Output)
  const InterceptEndpointGroupConnectedDeploymentGroup({
    this.locations,
    this.name,
  });
  ...
  factory InterceptEndpointGroupConnectedDeploymentGroup.fromMap(Map<String, dynamic> map) {
    return InterceptEndpointGroupConnectedDeploymentGroup(
      locations: (() { final guardedValue = map['locations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InterceptEndpointGroupConnectedDeploymentGroupLocation>(guardedValue, (value) => InterceptEndpointGroupConnectedDeploymentGroupLocation.fromMap((value as Map).cast<String, dynamic>()))); })(),
