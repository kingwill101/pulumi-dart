...
import 'address_group_iam_binding_args.dart';
import 'address_group_iam_binding_condition.dart';
import 'address_group_iam_binding_state.dart';
...
class AddressGroupIamBinding extends pulumi.CustomResource {
  late final pulumi.Output<AddressGroupIamBindingCondition?> condition;
  ...
  /// Creates a new [AddressGroupIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [AddressGroupIamBinding]. {@macro pulumi_networksecurity_address_group_iam_binding_address_group_iam_binding_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  AddressGroupIamBinding(
    String name, {
    AddressGroupIamBindingArgs? args,
    ...
    condition = registerOutput<AddressGroupIamBindingCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return AddressGroupIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [AddressGroupIamBinding] resource's state with the given [name] and [id].
  static AddressGroupIamBinding get(
    String name,
    pulumi.Input<String> id, {
    AddressGroupIamBindingState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return AddressGroupIamBinding._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [AddressGroupIamBinding] resource.
  AddressGroupIamBinding.reference(String urn)
    : super(
        'gcp:networksecurity/addressGroupIamBinding:AddressGroupIamBinding',
