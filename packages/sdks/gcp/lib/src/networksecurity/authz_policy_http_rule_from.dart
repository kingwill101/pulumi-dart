...
class AuthzPolicyHttpRuleFrom {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'notSources': ?notSources == null ? null : pulumi.Input.encodeList<AuthzPolicyHttpRuleFromNotSource, Map<String, dynamic>>(notSources!, (value) => value.toMap()),
      'sources': ?sources == null ? null : pulumi.Input.encodeList<AuthzPolicyHttpRuleFromSource, Map<String, dynamic>>(sources!, (value) => value.toMap()),
    };
  }

  factory AuthzPolicyHttpRuleFrom.fromMap(Map<String, dynamic> map) {
    return AuthzPolicyHttpRuleFrom(
      notSources: map['notSources'] == null ? null : pulumi.Input.decodeList<AuthzPolicyHttpRuleFromNotSource>(map['notSources'], (value) => AuthzPolicyHttpRuleFromNotSource.fromMap((value as Map).cast<String, dynamic>())),
      sources: map['sources'] == null ? null : pulumi.Input.decodeList<AuthzPolicyHttpRuleFromSource>(map['sources'], (value) => AuthzPolicyHttpRuleFromSource.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
