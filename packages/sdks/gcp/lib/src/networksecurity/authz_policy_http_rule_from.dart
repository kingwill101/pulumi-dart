...
class AuthzPolicyHttpRuleFrom {
  ...
  factory AuthzPolicyHttpRuleFrom.fromMap(Map<String, dynamic> map) {
    return AuthzPolicyHttpRuleFrom(
      notSources: (() { final guardedValue = map['notSources']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AuthzPolicyHttpRuleFromNotSource>(guardedValue, (value) => AuthzPolicyHttpRuleFromNotSource.fromMap((value as Map).cast<String, dynamic>()))); })(),
      sources: (() { final guardedValue = map['sources']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AuthzPolicyHttpRuleFromSource>(guardedValue, (value) => AuthzPolicyHttpRuleFromSource.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
