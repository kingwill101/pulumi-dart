...
class AuthzPolicyHttpRuleFrom {
  ...
  AuthzPolicyHttpRuleFrom({this.notSources, this.sources});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'notSources':
          ?pulumi.Input.mapOptionalInputValue<
            List<AuthzPolicyHttpRuleFromNotSource>,
      ...
      'sources':
          ?pulumi.Input.mapOptionalInputValue<
            List<AuthzPolicyHttpRuleFromSource>,
            List<Map<String, dynamic>>
          >(
            sources,
            (value) =>
  ...
  factory AuthzPolicyHttpRuleFrom.fromMap(Map<String, dynamic> map) {
    return AuthzPolicyHttpRuleFrom(
      notSources: (() {
        final guardedValue = map['notSources'];
