...
class SecurityProfileGroup extends pulumi.CustomResource {
  ...
  SecurityProfileGroup(
    ...
    this.customInterceptProfile = registerOutput<String?>('customInterceptProfile');
    this.customMirroringProfile = registerOutput<String?>('customMirroringProfile');
    ...
    this.threatPreventionProfile = registerOutput<String?>('threatPreventionProfile');
