...
import 'backend_authentication_config_state.dart';
...
///   scope = "CLIENT_AUTH"
/// }
/// resource "gcp_certificatemanager_trustconfig" "trust_config" {
///   name        = "my-trust-config"
///   description = "sample description for the trust config"
///   location    = "global"
///   trust_stores {
...
///   description        = "my description"
///   well_known_roots   = "PUBLIC_ROOTS"
///   client_certificate = gcp_certificatemanager_certificate.certificate.id
///   trust_config       = gcp_certificatemanager_trustconfig.trust_config.id
/// }
/// ```
/// ```java
/// package generated_program;
...
class BackendAuthenticationConfig extends pulumi.CustomResource {
  ...
  BackendAuthenticationConfig(
    ...
    wellKnownRoots = registerOutput<String?>('wellKnownRoots');
  }

  /// Gets an existing [BackendAuthenticationConfig] resource's state with the given [name] and [id].
  static BackendAuthenticationConfig get(
    String name,
    pulumi.Input<String> id, {
    BackendAuthenticationConfigState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return BackendAuthenticationConfig._get(
      name,
      state: state?.toMap(),
  ...
  BackendAuthenticationConfig._get(
    String name, {
  ...
  /// Creates a typed reference to an existing [BackendAuthenticationConfig] resource.
  BackendAuthenticationConfig.reference(String urn)
    : super(
        'gcp:networksecurity/backendAuthenticationConfig:BackendAuthenticationConfig',
