...
import 'sac_attachment_state.dart';
...
class SacAttachment extends pulumi.CustomResource {
  ...
  SacAttachment(
    ...
    this.symantecOptions = registerOutput<SacAttachmentSymantecOptions?>('symantecOptions');
    this.timeZone = registerOutput<String?>('timeZone');
    this.updateTime = registerOutput<String>('updateTime');
  }

  /// Gets an existing [SacAttachment] resource's state with the given [name] and [id].
  static SacAttachment get(
    String name,
