...
class AuthzPolicyHttpRuleToNotOperationHeaderSet {
  ...
  final pulumi.Input<List<AuthzPolicyHttpRuleToNotOperationHeaderSetHeader>>? headers;
  ...
  const AuthzPolicyHttpRuleToNotOperationHeaderSet({
    this.headers,
  });

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'headers': ?pulumi.Input.mapOptionalInputValue<List<AuthzPolicyHttpRuleToNotOperationHeaderSetHeader>, List<Map<String, dynamic>>>(headers, (value) => pulumi.Input.encodeList<AuthzPolicyHttpRuleToNotOperationHeaderSetHeader, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory AuthzPolicyHttpRuleToNotOperationHeaderSet.fromMap(Map<String, dynamic> map) {
    return AuthzPolicyHttpRuleToNotOperationHeaderSet(
      headers: (() { final guardedValue = map['headers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AuthzPolicyHttpRuleToNotOperationHeaderSetHeader>(guardedValue, (value) => AuthzPolicyHttpRuleToNotOperationHeaderSetHeader.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
