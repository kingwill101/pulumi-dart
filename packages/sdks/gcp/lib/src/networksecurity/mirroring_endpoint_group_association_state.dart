...
class MirroringEndpointGroupAssociationState {
  ...
  final pulumi.Input<List<MirroringEndpointGroupAssociationLocation>>?
  locations;
  ...
  /// Structure is documented below.
  final pulumi.Input<List<MirroringEndpointGroupAssociationLocationsDetail>>?
  locationsDetails;
    ...
    return <String, dynamic>{
      ...
      'locations':
          ?pulumi.Input.mapOptionalInputValue<
            List<MirroringEndpointGroupAssociationLocation>,
  ...
  factory MirroringEndpointGroupAssociationState.fromMap(
    ...
    return MirroringEndpointGroupAssociationState(
      ...
      locations: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MirroringEndpointGroupAssociationLocation>(
            guardedValue,
            (value) => MirroringEndpointGroupAssociationLocation.fromMap(
      ...
      locationsDetails: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => MirroringEndpointGroupAssociationLocationsDetail.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      mirroringEndpointGroup: (() {
        final guardedValue = map['mirroringEndpointGroup'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      mirroringEndpointGroupAssociationId: (() {
        final guardedValue = map['mirroringEndpointGroupAssociationId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      name: (() {
