...
class GatewaySecurityPolicyRuleState {
  ...
  factory GatewaySecurityPolicyRuleState.fromMap(Map<String, dynamic> map) {
    return GatewaySecurityPolicyRuleState(
      ...
      basicProfile: (() { final guardedValue = map['basicProfile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      sessionMatcher: (() { final guardedValue = map['sessionMatcher']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
