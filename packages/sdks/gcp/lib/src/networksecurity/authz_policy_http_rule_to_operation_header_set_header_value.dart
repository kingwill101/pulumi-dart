...
class AuthzPolicyHttpRuleToOperationHeaderSetHeaderValue {
  ...
  /// Creates a new [AuthzPolicyHttpRuleToOperationHeaderSetHeaderValue].
  ...
  const AuthzPolicyHttpRuleToOperationHeaderSetHeaderValue({
    this.contains,
    this.exact,
    this.ignoreCase,
    this.prefix,
  ...
  factory AuthzPolicyHttpRuleToOperationHeaderSetHeaderValue.fromMap(Map<String, dynamic> map) {
    return AuthzPolicyHttpRuleToOperationHeaderSetHeaderValue(
