...
import 'mirroring_endpoint_state.dart';
...
/// }
/// resource "gcp_networksecurity_mirroringendpoint" "default" {
///   mirroring_endpoint_id    = "example-endpoint"
///   location                 = "us-west2-a"
...
class MirroringEndpoint extends pulumi.CustomResource {
  ...
  MirroringEndpoint(
    ...
    mirroringEndpointId = registerOutput<String>('mirroringEndpointId');
  ...
  /// Gets an existing [MirroringEndpoint] resource's state with the given [name] and [id].
  static MirroringEndpoint get(
    String name,
    pulumi.Input<String> id, {
    MirroringEndpointState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return MirroringEndpoint._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [MirroringEndpoint] resource.
  MirroringEndpoint.reference(String urn)
    : super(
        'gcp:networksecurity/mirroringEndpoint:MirroringEndpoint',
