...
class InterceptDeploymentState {
  ...
  const InterceptDeploymentState({
    this.createTime,
    this.description,
  ...
  factory InterceptDeploymentState.fromMap(Map<String, dynamic> map) {
    return InterceptDeploymentState(
      ...
      interceptDeploymentId: (() { final guardedValue = map['interceptDeploymentId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
