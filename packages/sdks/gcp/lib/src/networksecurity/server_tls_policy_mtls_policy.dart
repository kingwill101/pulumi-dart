...
class ServerTlsPolicyMtlsPolicy {
  ...
  final pulumi.Input<List<ServerTlsPolicyMtlsPolicyClientValidationCa>>?
  clientValidationCas;
    ...
    return <String, dynamic>{
      'clientValidationCas':
          ?pulumi.Input.mapOptionalInputValue<
            List<ServerTlsPolicyMtlsPolicyClientValidationCa>,
  ...
  factory ServerTlsPolicyMtlsPolicy.fromMap(Map<String, dynamic> map) {
    return ServerTlsPolicyMtlsPolicy(
      clientValidationCas: (() {
        final guardedValue = map['clientValidationCas'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ServerTlsPolicyMtlsPolicyClientValidationCa>(
            guardedValue,
      ...
      clientValidationMode: (() {
        final guardedValue = map['clientValidationMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      clientValidationTrustConfig: (() {
        final guardedValue = map['clientValidationTrustConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
