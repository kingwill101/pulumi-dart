...
class SecurityProfileCustomMirroringProfile {
  ...
  factory SecurityProfileCustomMirroringProfile.fromMap(Map<String, dynamic> map) {
    return SecurityProfileCustomMirroringProfile(
      mirroringDeploymentGroups: map['mirroringDeploymentGroups'] == null ? null : (map['mirroringDeploymentGroups'] as List).cast<String>(),
      mirroringEndpointGroup: map['mirroringEndpointGroup'] as String,
      mirroringEndpointGroupType: map['mirroringEndpointGroupType'] == null ? null : map['mirroringEndpointGroupType'] as String,
    );
  }
}
