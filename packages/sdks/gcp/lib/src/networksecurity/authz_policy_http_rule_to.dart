...
class AuthzPolicyHttpRuleTo {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'notOperations': ?notOperations == null ? null : pulumi.Input.encodeList<AuthzPolicyHttpRuleToNotOperation, Map<String, dynamic>>(notOperations!, (value) => value.toMap()),
      'operations': ?operations == null ? null : pulumi.Input.encodeList<AuthzPolicyHttpRuleToOperation, Map<String, dynamic>>(operations!, (value) => value.toMap()),
    };
  }

  factory AuthzPolicyHttpRuleTo.fromMap(Map<String, dynamic> map) {
    return AuthzPolicyHttpRuleTo(
      notOperations: map['notOperations'] == null ? null : pulumi.Input.decodeList<AuthzPolicyHttpRuleToNotOperation>(map['notOperations'], (value) => AuthzPolicyHttpRuleToNotOperation.fromMap((value as Map).cast<String, dynamic>())),
      operations: map['operations'] == null ? null : pulumi.Input.decodeList<AuthzPolicyHttpRuleToOperation>(map['operations'], (value) => AuthzPolicyHttpRuleToOperation.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
