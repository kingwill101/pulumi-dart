...
class AuthzPolicyHttpRuleTo {
  ...
  AuthzPolicyHttpRuleTo({this.notOperations, this.operations});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'notOperations':
          ?pulumi.Input.mapOptionalInputValue<
            List<AuthzPolicyHttpRuleToNotOperation>,
      ...
      'operations':
          ?pulumi.Input.mapOptionalInputValue<
            List<AuthzPolicyHttpRuleToOperation>,
            List<Map<String, dynamic>>
          >(
            operations,
            (value) =>
  ...
  factory AuthzPolicyHttpRuleTo.fromMap(Map<String, dynamic> map) {
    return AuthzPolicyHttpRuleTo(
      notOperations: (() {
        final guardedValue = map['notOperations'];
