...
class SacRealmState {
  ...
  factory SacRealmState.fromMap(Map<String, dynamic> map) {
    return SacRealmState(
      ...
      pairingKeys: (() {
        final guardedValue = map['pairingKeys'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SacRealmPairingKey>(
            guardedValue,
            (value) => SacRealmPairingKey.fromMap(
      ...
      securityService: (() {
        final guardedValue = map['securityService'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      state: (() {
      ...
      symantecOptions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SacRealmSymantecOptions.fromMap(
