...
class ServerTlsPolicyMtlsPolicyClientValidationCa {
  ...
  factory ServerTlsPolicyMtlsPolicyClientValidationCa.fromMap(Map<String, dynamic> map) {
    return ServerTlsPolicyMtlsPolicyClientValidationCa(
      certificateProviderInstance: (() { final guardedValue = map['certificateProviderInstance']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServerTlsPolicyMtlsPolicyClientValidationCaCertificateProviderInstance.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      grpcEndpoint: (() { final guardedValue = map['grpcEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServerTlsPolicyMtlsPolicyClientValidationCaGrpcEndpoint.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
