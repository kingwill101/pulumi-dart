...
class AuthzPolicyHttpRuleFromSource {
  ...
  const AuthzPolicyHttpRuleFromSource({
    this.ipBlocks,
    this.principals,
    this.resources,
  });
  ...
  factory AuthzPolicyHttpRuleFromSource.fromMap(Map<String, dynamic> map) {
    return AuthzPolicyHttpRuleFromSource(
      ipBlocks: (() { final guardedValue = map['ipBlocks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AuthzPolicyHttpRuleFromSourceIpBlock>(guardedValue, (value) => AuthzPolicyHttpRuleFromSourceIpBlock.fromMap((value as Map).cast<String, dynamic>()))); })(),
      principals: (() { final guardedValue = map['principals']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AuthzPolicyHttpRuleFromSourcePrincipal>(guardedValue, (value) => AuthzPolicyHttpRuleFromSourcePrincipal.fromMap((value as Map).cast<String, dynamic>()))); })(),
      resources: (() { final guardedValue = map['resources']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AuthzPolicyHttpRuleFromSourceResource>(guardedValue, (value) => AuthzPolicyHttpRuleFromSourceResource.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
