...
class InterceptEndpointGroupAssociationNetworksecurity extends pulumi.CustomResource {
  ...
  InterceptEndpointGroupAssociationNetworksecurity(
    ...
    this.interceptEndpointGroup = registerOutput<String>('interceptEndpointGroup');
    this.interceptEndpointGroupAssociationId = registerOutput<String?>('interceptEndpointGroupAssociationId');
    this.labels = registerOutput<Map<String, String>?>('labels');
    this.location = registerOutput<String>('location');
    this.locations = registerOutput<List<InterceptEndpointGroupAssociationLocation>>('locations');
    this.locationsDetails = registerOutput<List<InterceptEndpointGroupAssociationLocationsDetail>>('locationsDetails');
