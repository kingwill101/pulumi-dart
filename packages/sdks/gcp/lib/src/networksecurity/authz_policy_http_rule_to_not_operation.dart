...
class AuthzPolicyHttpRuleToNotOperation {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'hosts': ?hosts == null ? null : pulumi.Input.encodeList<AuthzPolicyHttpRuleToNotOperationHost, Map<String, dynamic>>(hosts!, (value) => value.toMap()),
      'methods': ?methods,
      'paths': ?paths == null ? null : pulumi.Input.encodeList<AuthzPolicyHttpRuleToNotOperationPath, Map<String, dynamic>>(paths!, (value) => value.toMap()),
    };
  }

  factory AuthzPolicyHttpRuleToNotOperation.fromMap(Map<String, dynamic> map) {
    return AuthzPolicyHttpRuleToNotOperation(
      headerSet: map['headerSet'] == null ? null : AuthzPolicyHttpRuleToNotOperationHeaderSet.fromMap((map['headerSet'] as Map).cast<String, dynamic>()),
      hosts: map['hosts'] == null ? null : pulumi.Input.decodeList<AuthzPolicyHttpRuleToNotOperationHost>(map['hosts'], (value) => AuthzPolicyHttpRuleToNotOperationHost.fromMap((value as Map).cast<String, dynamic>())),
      methods: map['methods'] == null ? null : (map['methods'] as List).cast<String>(),
      paths: map['paths'] == null ? null : pulumi.Input.decodeList<AuthzPolicyHttpRuleToNotOperationPath>(map['paths'], (value) => AuthzPolicyHttpRuleToNotOperationPath.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
