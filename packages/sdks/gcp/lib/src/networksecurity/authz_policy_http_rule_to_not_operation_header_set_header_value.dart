...
class AuthzPolicyHttpRuleToNotOperationHeaderSetHeaderValue {
  ...
  const AuthzPolicyHttpRuleToNotOperationHeaderSetHeaderValue({
    this.contains,
    this.exact,
    this.ignoreCase,
    this.prefix,
  ...
  factory AuthzPolicyHttpRuleToNotOperationHeaderSetHeaderValue.fromMap(Map<String, dynamic> map) {
