...
class MirroringDeploymentState {
  ...
  factory MirroringDeploymentState.fromMap(Map<String, dynamic> map) {
    return MirroringDeploymentState(
      ...
      mirroringDeploymentId: (() { final guardedValue = map['mirroringDeploymentId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
