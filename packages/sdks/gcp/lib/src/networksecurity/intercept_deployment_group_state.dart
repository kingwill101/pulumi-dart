...
class InterceptDeploymentGroupState {
  ...
  final pulumi.Input<List<InterceptDeploymentGroupConnectedEndpointGroup>>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'locations':
          ?pulumi.Input.mapOptionalInputValue<
            List<InterceptDeploymentGroupLocation>,
            List<Map<String, dynamic>>
          >(
            locations,
            (value) =>
  ...
  factory InterceptDeploymentGroupState.fromMap(Map<String, dynamic> map) {
    return InterceptDeploymentGroupState(
      connectedEndpointGroups: (() {
        final guardedValue = map['connectedEndpointGroups'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<InterceptDeploymentGroupConnectedEndpointGroup>(
            guardedValue,
            (value) => InterceptDeploymentGroupConnectedEndpointGroup.fromMap(
      ...
      interceptDeploymentGroupId: (() {
        final guardedValue = map['interceptDeploymentGroupId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      labels: (() {
      ...
      locations: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InterceptDeploymentGroupLocation>(
            guardedValue,
            (value) => InterceptDeploymentGroupLocation.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
