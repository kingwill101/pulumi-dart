...
class AuthzPolicyHttpRuleFromSourceResourceIamServiceAccount {
  ...
  /// Creates a new [AuthzPolicyHttpRuleFromSourceResourceIamServiceAccount].
  ...
  const AuthzPolicyHttpRuleFromSourceResourceIamServiceAccount({
    this.contains,
    this.exact,
    this.ignoreCase,
    this.prefix,
  ...
  factory AuthzPolicyHttpRuleFromSourceResourceIamServiceAccount.fromMap(Map<String, dynamic> map) {
    return AuthzPolicyHttpRuleFromSourceResourceIamServiceAccount(
