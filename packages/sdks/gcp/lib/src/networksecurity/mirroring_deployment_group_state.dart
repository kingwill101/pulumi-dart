...
class MirroringDeploymentGroupState {
  ...
  factory MirroringDeploymentGroupState.fromMap(Map<String, dynamic> map) {
    return MirroringDeploymentGroupState(
      ...
      locations: (() { final guardedValue = map['locations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<MirroringDeploymentGroupLocation>(guardedValue, (value) => MirroringDeploymentGroupLocation.fromMap((value as Map).cast<String, dynamic>()))); })(),
      mirroringDeploymentGroupId: (() { final guardedValue = map['mirroringDeploymentGroupId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
