...
class MirroringDeploymentGroupState {
  ...
  final pulumi.Input<List<MirroringDeploymentGroupConnectedEndpointGroup>>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'locations':
          ?pulumi.Input.mapOptionalInputValue<
            List<MirroringDeploymentGroupLocation>,
            List<Map<String, dynamic>>
          >(
            locations,
            (value) =>
    ...
    return MirroringDeploymentGroupState(
      connectedEndpointGroups: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<MirroringDeploymentGroupConnectedEndpointGroup>(
            guardedValue,
            (value) => MirroringDeploymentGroupConnectedEndpointGroup.fromMap(
      ...
      locations: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MirroringDeploymentGroupLocation>(
            guardedValue,
            (value) => MirroringDeploymentGroupLocation.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      mirroringDeploymentGroupId: (() {
        final guardedValue = map['mirroringDeploymentGroupId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      name: (() {
