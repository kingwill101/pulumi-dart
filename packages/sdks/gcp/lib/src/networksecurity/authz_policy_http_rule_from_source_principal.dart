...
class AuthzPolicyHttpRuleFromSourcePrincipal {
  ...
  final pulumi.Input<AuthzPolicyHttpRuleFromSourcePrincipalPrincipal>?
  principal;
  ...
  factory AuthzPolicyHttpRuleFromSourcePrincipal.fromMap(
    ...
    return AuthzPolicyHttpRuleFromSourcePrincipal(
      ...
      principal: (() {
        ...
        return pulumi.Input.fromValue(
          AuthzPolicyHttpRuleFromSourcePrincipalPrincipal.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      principalSelector: (() {
        final guardedValue = map['principalSelector'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      suffix: (() {
