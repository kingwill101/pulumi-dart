...
class AuthorizationPolicyRuleDestinationHttpHeaderMatch {
  ...
  /// Creates a new [AuthorizationPolicyRuleDestinationHttpHeaderMatch].
  ...
  const AuthorizationPolicyRuleDestinationHttpHeaderMatch({
  ...
  factory AuthorizationPolicyRuleDestinationHttpHeaderMatch.fromMap(Map<String, dynamic> map) {
