...
class SecurityActionFlag {
  ...
  factory SecurityActionFlag.fromMap(Map<String, dynamic> map) {
    return SecurityActionFlag(
      headers: (() { final guardedValue = map['headers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SecurityActionFlagHeader>(guardedValue, (value) => SecurityActionFlagHeader.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
