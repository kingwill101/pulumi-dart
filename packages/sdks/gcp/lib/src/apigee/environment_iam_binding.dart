...
import 'environment_iam_binding_state.dart';
...
class EnvironmentIamBinding extends pulumi.CustomResource {
  ...
  /// Creates a new [EnvironmentIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [EnvironmentIamBinding]. {@macro pulumi_apigee_environment_iam_binding_environment_iam_binding_args_doc}
  ...
  EnvironmentIamBinding(
    ...
    this.condition = registerOutput<EnvironmentIamBindingCondition?>('condition');
  ...
  /// Gets an existing [EnvironmentIamBinding] resource's state with the given [name] and [id].
  static EnvironmentIamBinding get(
    String name,
