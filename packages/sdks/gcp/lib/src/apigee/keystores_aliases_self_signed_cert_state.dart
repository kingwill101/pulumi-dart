...
class KeystoresAliasesSelfSignedCertState {
    ...
    return <String, dynamic>{
      ...
      'certsInfos':
          ?pulumi.Input.mapOptionalInputValue<
            List<KeystoresAliasesSelfSignedCertCertsInfo>,
  ...
  factory KeystoresAliasesSelfSignedCertState.fromMap(
    ...
    return KeystoresAliasesSelfSignedCertState(
      ...
      certsInfos: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<KeystoresAliasesSelfSignedCertCertsInfo>(
            guardedValue,
            (value) => KeystoresAliasesSelfSignedCertCertsInfo.fromMap(
