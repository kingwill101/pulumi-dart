...
class KeystoresAliasesKeyCertFileState {
    ...
    return <String, dynamic>{
      ...
      'certsInfos':
          ?pulumi.Input.mapOptionalInputValue<
            List<KeystoresAliasesKeyCertFileCertsInfo>,
  ...
  factory KeystoresAliasesKeyCertFileState.fromMap(Map<String, dynamic> map) {
    return KeystoresAliasesKeyCertFileState(
      ...
      certsInfos: (() {
        final guardedValue = map['certsInfos'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<KeystoresAliasesKeyCertFileCertsInfo>(
            guardedValue,
            (value) => KeystoresAliasesKeyCertFileCertsInfo.fromMap(
