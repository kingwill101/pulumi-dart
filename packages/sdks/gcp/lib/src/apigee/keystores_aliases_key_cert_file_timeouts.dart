...
class KeystoresAliasesKeyCertFileTimeouts {
  ...
  const KeystoresAliasesKeyCertFileTimeouts({
    this.create,
    this.delete,
    this.read,
    this.update,
  ...
  factory KeystoresAliasesKeyCertFileTimeouts.fromMap(Map<String, dynamic> map) {
    return KeystoresAliasesKeyCertFileTimeouts(
      ...
      read: (() { final guardedValue = map['read']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
