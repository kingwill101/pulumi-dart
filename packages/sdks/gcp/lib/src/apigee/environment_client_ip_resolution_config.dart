...
class EnvironmentClientIpResolutionConfig {
  ...
  factory EnvironmentClientIpResolutionConfig.fromMap(Map<String, dynamic> map) {
    return EnvironmentClientIpResolutionConfig(
      headerIndexAlgorithm: (() { final guardedValue = map['headerIndexAlgorithm']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EnvironmentClientIpResolutionConfigHeaderIndexAlgorithm.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
