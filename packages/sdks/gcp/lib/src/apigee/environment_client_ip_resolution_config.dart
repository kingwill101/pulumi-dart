...
class EnvironmentClientIpResolutionConfig {
  ...
  final pulumi.Input<EnvironmentClientIpResolutionConfigHeaderIndexAlgorithm>?
  ...
  EnvironmentClientIpResolutionConfig({this.headerIndexAlgorithm});
    ...
    return <String, dynamic>{
      'headerIndexAlgorithm':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(headerIndexAlgorithm, (value) => value.toMap()),
    };
  }
  ...
  factory EnvironmentClientIpResolutionConfig.fromMap(
    ...
    return EnvironmentClientIpResolutionConfig(
      headerIndexAlgorithm: (() {
        final guardedValue = map['headerIndexAlgorithm'];
