...
/// }
/// resource "gcp_apigee_space" "space" {
...
class Space extends pulumi.CustomResource {
  ...
  late final pulumi.Output<String> spaceId;
  /// Last modified timestamp of the space.
  late final pulumi.Output<String> updateTime;

  /// Creates a new [Space].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [Space]. {@macro pulumi_apigee_space_space_args_doc}
  ...
  Space(
    ...
    spaceId = registerOutput<String>('spaceId');
