...
import 'environment_keyvaluemaps_state.dart';
...
class EnvironmentKeyvaluemaps extends pulumi.CustomResource {
  ...
  /// Gets an existing [EnvironmentKeyvaluemaps] resource's state with the given [name] and [id].
  static EnvironmentKeyvaluemaps get(
    String name,
