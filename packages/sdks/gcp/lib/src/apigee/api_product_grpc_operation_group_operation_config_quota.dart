...
class ApiProductGrpcOperationGroupOperationConfigQuota {
  ...
  /// Creates a new [ApiProductGrpcOperationGroupOperationConfigQuota].
  ...
  const ApiProductGrpcOperationGroupOperationConfigQuota({
    this.interval,
    this.limit,
    this.timeUnit,
  });
  ...
  factory ApiProductGrpcOperationGroupOperationConfigQuota.fromMap(Map<String, dynamic> map) {
