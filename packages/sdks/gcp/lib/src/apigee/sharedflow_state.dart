...
class SharedflowState {
  ...
  factory SharedflowState.fromMap(Map<String, dynamic> map) {
    return SharedflowState(
      ...
      metaDatas: (() { final guardedValue = map['metaDatas']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SharedflowMetaData>(guardedValue, (value) => SharedflowMetaData.fromMap((value as Map).cast<String, dynamic>()))); })(),
