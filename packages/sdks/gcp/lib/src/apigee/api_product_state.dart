...
class ApiProductState {
  ...
  ApiProductState({
    ...
    pulumi.Output<List<ApiProductAttribute>>? attributes,
    pulumi.Output<String>? createdAt,
    pulumi.Output<String>? description,
    pulumi.Output<String>? displayName,
    pulumi.Output<List<String>>? environments,
    pulumi.Output<ApiProductGraphqlOperationGroup>? graphqlOperationGroup,
    pulumi.Output<ApiProductGrpcOperationGroup>? grpcOperationGroup,
    pulumi.Output<String>? lastModifiedAt,
    pulumi.Output<String>? name,
    pulumi.Output<ApiProductOperationGroup>? operationGroup,
    pulumi.Output<String>? orgId,
    pulumi.Output<List<String>>? proxies,
    pulumi.Output<String>? quota,
    pulumi.Output<String>? quotaCounterScope,
    pulumi.Output<String>? quotaInterval,
    pulumi.Output<String>? quotaTimeUnit,
    pulumi.Output<List<String>>? scopes,
    pulumi.Output<String>? space,
  }) :
      ...
      attributes = pulumi.Input.asOptionalInput<List<ApiProductAttribute>>(attributes),
      createdAt = pulumi.Input.asOptionalInput<String>(createdAt),
      description = pulumi.Input.asOptionalInput<String>(description),
      displayName = pulumi.Input.asOptionalInput<String>(displayName),
      environments = pulumi.Input.asOptionalInput<List<String>>(environments),
      graphqlOperationGroup = pulumi.Input.asOptionalInput<ApiProductGraphqlOperationGroup>(graphqlOperationGroup),
      grpcOperationGroup = pulumi.Input.asOptionalInput<ApiProductGrpcOperationGroup>(grpcOperationGroup),
      lastModifiedAt = pulumi.Input.asOptionalInput<String>(lastModifiedAt),
      name = pulumi.Input.asOptionalInput<String>(name),
      operationGroup = pulumi.Input.asOptionalInput<ApiProductOperationGroup>(operationGroup),
      ...
      quotaCounterScope = pulumi.Input.asOptionalInput<String>(quotaCounterScope),
  ...
  factory ApiProductState.fromMap(Map<String, dynamic> map) {
    return ApiProductState(
      ...
      attributes: map['attributes'] == null ? null : pulumi.Output.create<List<ApiProductAttribute>>(pulumi.Input.decodeList<ApiProductAttribute>(map['attributes'], (value) => ApiProductAttribute.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      graphqlOperationGroup: map['graphqlOperationGroup'] == null ? null : pulumi.Output.create<ApiProductGraphqlOperationGroup>(ApiProductGraphqlOperationGroup.fromMap((map['graphqlOperationGroup'] as Map).cast<String, dynamic>())),
      grpcOperationGroup: map['grpcOperationGroup'] == null ? null : pulumi.Output.create<ApiProductGrpcOperationGroup>(ApiProductGrpcOperationGroup.fromMap((map['grpcOperationGroup'] as Map).cast<String, dynamic>())),
      lastModifiedAt: map['lastModifiedAt'] == null ? null : pulumi.Output.create<String>(map['lastModifiedAt'] as String),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      operationGroup: map['operationGroup'] == null ? null : pulumi.Output.create<ApiProductOperationGroup>(ApiProductOperationGroup.fromMap((map['operationGroup'] as Map).cast<String, dynamic>())),
      ...
      quotaCounterScope: map['quotaCounterScope'] == null ? null : pulumi.Output.create<String>(map['quotaCounterScope'] as String),
      ...
      space: map['space'] == null ? null : pulumi.Output.create<String>(map['space'] as String),
    );
  }
}
