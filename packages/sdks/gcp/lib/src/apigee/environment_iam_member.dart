...
import 'environment_iam_member_state.dart';
...
class EnvironmentIamMember extends pulumi.CustomResource {
  late final pulumi.Output<EnvironmentIamMemberCondition?> condition;
  ...
  /// Creates a new [EnvironmentIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [EnvironmentIamMember]. {@macro pulumi_apigee_environment_iam_member_environment_iam_member_args_doc}
  ...
  EnvironmentIamMember(
    ...
    condition = registerOutput<EnvironmentIamMemberCondition?>(
      'condition',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return EnvironmentIamMemberCondition.fromMap(
  ...
  /// Gets an existing [EnvironmentIamMember] resource's state with the given [name] and [id].
  static EnvironmentIamMember get(
    String name,
