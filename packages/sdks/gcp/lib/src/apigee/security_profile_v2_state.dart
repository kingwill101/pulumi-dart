...
class SecurityProfileV2State {
  ...
  factory SecurityProfileV2State.fromMap(Map<String, dynamic> map) {
    return SecurityProfileV2State(
      ...
      profileAssessmentConfigs: (() {
        final guardedValue = map['profileAssessmentConfigs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SecurityProfileV2ProfileAssessmentConfig>(
            guardedValue,
            (value) => SecurityProfileV2ProfileAssessmentConfig.fromMap(
