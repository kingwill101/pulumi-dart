...
class ApiProductGraphqlOperationGroupOperationConfig {
  ...
  final pulumi.Input<
    List<ApiProductGraphqlOperationGroupOperationConfigAttribute>
  >?
  attributes;
  ...
  /// Structure is documented below.
  final pulumi.Input<
    List<ApiProductGraphqlOperationGroupOperationConfigOperation>
  >?
  operations;

  /// Quota parameters to be enforced for the resources, methods, and API source combination. If none are specified, quota enforcement will not be done.
  /// Structure is documented below.
  final pulumi.Input<ApiProductGraphqlOperationGroupOperationConfigQuota>?
  quota;
