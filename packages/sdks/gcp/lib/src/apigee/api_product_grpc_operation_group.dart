...
class ApiProductGrpcOperationGroup {
  ...
  final pulumi.Input<List<ApiProductGrpcOperationGroupOperationConfig>>?
  operationConfigs;
    ...
    return <String, dynamic>{
      'operationConfigs':
          ?pulumi.Input.mapOptionalInputValue<
            List<ApiProductGrpcOperationGroupOperationConfig>,
    ...
    return ApiProductGrpcOperationGroup(
      operationConfigs: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ApiProductGrpcOperationGroupOperationConfig>(
            guardedValue,
