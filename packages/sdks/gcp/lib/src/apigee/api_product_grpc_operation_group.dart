...
class ApiProductGrpcOperationGroup {
  ...
  factory ApiProductGrpcOperationGroup.fromMap(Map<String, dynamic> map) {
    return ApiProductGrpcOperationGroup(
      operationConfigs: (() { final guardedValue = map['operationConfigs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ApiProductGrpcOperationGroupOperationConfig>(guardedValue, (value) => ApiProductGrpcOperationGroupOperationConfig.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
