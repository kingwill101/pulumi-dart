...
class ApiProduct extends pulumi.CustomResource {
  ...
  ApiProduct(
    ...
    this.graphqlOperationGroup = registerOutput<ApiProductGraphqlOperationGroup?>('graphqlOperationGroup');
    this.grpcOperationGroup = registerOutput<ApiProductGrpcOperationGroup?>('grpcOperationGroup');
    this.lastModifiedAt = registerOutput<String>('lastModifiedAt');
    this.name = registerOutput<String>('name');
    this.operationGroup = registerOutput<ApiProductOperationGroup?>('operationGroup');
