...
class SecurityFeedback extends pulumi.CustomResource {
  ...
  /// Creates a new [SecurityFeedback].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [SecurityFeedback]. {@macro pulumi_apigee_security_feedback_security_feedback_args_doc}
