...
class ApiProductOperationGroup {
  ...
  final pulumi.Input<List<ApiProductOperationGroupOperationConfig>>?
  operationConfigs;
  ...
  ApiProductOperationGroup({this.operationConfigType, this.operationConfigs});
    ...
    return <String, dynamic>{
      ...
      'operationConfigs':
          ?pulumi.Input.mapOptionalInputValue<
            List<ApiProductOperationGroupOperationConfig>,
  ...
  factory ApiProductOperationGroup.fromMap(Map<String, dynamic> map) {
    return ApiProductOperationGroup(
      ...
      operationConfigs: (() {
        final guardedValue = map['operationConfigs'];
        if (guardedValue == null) return null;
