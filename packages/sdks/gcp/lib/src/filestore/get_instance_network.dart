...
class GetInstanceNetwork {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'modes': modes,
      'network': network,
      'pscConfigs': pulumi.Input.encodeList<GetInstanceNetworkPscConfig, Map<String, dynamic>>(pscConfigs, (value) => value.toMap()),
  ...
  factory GetInstanceNetwork.fromMap(Map<String, dynamic> map) {
    return GetInstanceNetwork(
      ...
      pscConfigs: pulumi.Input.decodeList<GetInstanceNetworkPscConfig>(map['pscConfigs'], (value) => GetInstanceNetworkPscConfig.fromMap((value as Map).cast<String, dynamic>())),
