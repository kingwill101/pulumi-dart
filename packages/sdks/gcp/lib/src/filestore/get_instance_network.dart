...
class GetInstanceNetwork {
  ...
  factory GetInstanceNetwork.fromMap(Map<String, dynamic> map) {
    return GetInstanceNetwork(
      connectMode: (map['connectMode'] as String).input(),
      ipAddresses: ((map['ipAddresses'] as List).cast<String>()).input(),
      modes: ((map['modes'] as List).cast<String>()).input(),
      network: (map['network'] as String).input(),
      pscConfigs: (pulumi.Input.decodeList<GetInstanceNetworkPscConfig>(map['pscConfigs'], (value) => GetInstanceNetworkPscConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
