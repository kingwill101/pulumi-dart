...
class GetInstanceInitialReplication {
  ...
  factory GetInstanceInitialReplication.fromMap(Map<String, dynamic> map) {
    return GetInstanceInitialReplication(
      replicas: pulumi.Input.fromValue(pulumi.Input.decodeList<GetInstanceInitialReplicationReplica>(map['replicas']!, (value) => GetInstanceInitialReplicationReplica.fromMap((value as Map).cast<String, dynamic>()))),
