...
class GetInstanceFileShare {
  ...
  factory GetInstanceFileShare.fromMap(Map<String, dynamic> map) {
    return GetInstanceFileShare(
      ...
      nfsExportOptions: (pulumi.Input.decodeList<GetInstanceFileShareNfsExportOption>(map['nfsExportOptions'], (value) => GetInstanceFileShareNfsExportOption.fromMap((value as Map).cast<String, dynamic>()))).input(),
