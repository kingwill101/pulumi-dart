...
class GetInstanceEffectiveReplication {
  ...
  factory GetInstanceEffectiveReplication.fromMap(Map<String, dynamic> map) {
    return GetInstanceEffectiveReplication(
      replicas: (pulumi.Input.decodeList<GetInstanceEffectiveReplicationReplica>(map['replicas'], (value) => GetInstanceEffectiveReplicationReplica.fromMap((value as Map).cast<String, dynamic>()))).input(),
