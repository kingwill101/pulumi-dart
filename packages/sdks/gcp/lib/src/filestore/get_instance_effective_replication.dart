...
class GetInstanceEffectiveReplication {
  ...
  GetInstanceEffectiveReplication({required this.replicas, required this.role});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'replicas':
          pulumi.Input.mapInputValue<
            List<GetInstanceEffectiveReplicationReplica>,
  ...
  factory GetInstanceEffectiveReplication.fromMap(Map<String, dynamic> map) {
    return GetInstanceEffectiveReplication(
      replicas: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetInstanceEffectiveReplicationReplica>(
          map['replicas']!,
