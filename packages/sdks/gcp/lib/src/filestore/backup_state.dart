...
class BackupState {
  ...
  factory BackupState.fromMap(Map<String, dynamic> map) {
    return BackupState(
      ...
      downloadBytes: map['downloadBytes'] == null ? null : (map['downloadBytes'] as String).input(),
      ...
      sourceInstanceTier: map['sourceInstanceTier'] == null ? null : (map['sourceInstanceTier'] as String).input(),
      state: map['state'] == null ? null : (map['state'] as String).input(),
      storageBytes: map['storageBytes'] == null ? null : (map['storageBytes'] as String).input(),
