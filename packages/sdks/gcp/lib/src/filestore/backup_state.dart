...
class BackupState {
  ...
  factory BackupState.fromMap(Map<String, dynamic> map) {
    return BackupState(
      ...
      sourceInstanceTier: (() { final guardedValue = map['sourceInstanceTier']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      state: (() { final guardedValue = map['state']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      storageBytes: (() { final guardedValue = map['storageBytes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
