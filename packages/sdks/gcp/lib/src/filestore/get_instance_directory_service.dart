...
class GetInstanceDirectoryService {
  ...
  GetInstanceDirectoryService({required this.ldaps});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'ldaps':
          pulumi.Input.mapInputValue<
            List<GetInstanceDirectoryServiceLdap>,
  ...
  factory GetInstanceDirectoryService.fromMap(Map<String, dynamic> map) {
    return GetInstanceDirectoryService(
      ldaps: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetInstanceDirectoryServiceLdap>(
          map['ldaps']!,
