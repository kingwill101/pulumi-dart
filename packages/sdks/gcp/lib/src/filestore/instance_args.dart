...
class InstanceArgs {
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      ...
      fileShares: pulumi.Output.create<InstanceFileShares>(InstanceFileShares.fromMap((map['fileShares'] as Map).cast<String, dynamic>())),
      ...
      networks: pulumi.Output.create<List<InstanceNetwork>>(pulumi.Input.decodeList<InstanceNetwork>(map['networks'], (value) => InstanceNetwork.fromMap((value as Map).cast<String, dynamic>()))),
