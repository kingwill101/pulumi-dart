...
class RepositoryRemoteRepositoryConfig {
  ...
  final pulumi.Input<RepositoryRemoteRepositoryConfigAptRepository>?
  aptRepository;

  /// Specific settings for an Artifact Registory remote repository.
  /// Structure is documented below.
  final pulumi.Input<RepositoryRemoteRepositoryConfigCommonRepository>?
  commonRepository;
  ...
  /// Structure is documented below.
  final pulumi.Input<RepositoryRemoteRepositoryConfigDockerRepository>?
  dockerRepository;

  /// Specific settings for a Maven remote repository.
  /// Structure is documented below.
  final pulumi.Input<RepositoryRemoteRepositoryConfigMavenRepository>?
  mavenRepository;

  /// Specific settings for an Npm remote repository.
  /// Structure is documented below.
  final pulumi.Input<RepositoryRemoteRepositoryConfigNpmRepository>?
  npmRepository;

  /// Specific settings for a Python remote repository.
  /// Structure is documented below.
  final pulumi.Input<RepositoryRemoteRepositoryConfigPythonRepository>?
  pythonRepository;

  /// The credentials used to access the remote repository.
  /// Structure is documented below.
  final pulumi.Input<RepositoryRemoteRepositoryConfigUpstreamCredentials>?
  upstreamCredentials;

  /// Specific settings for an Yum remote repository.
  /// Structure is documented below.
  final pulumi.Input<RepositoryRemoteRepositoryConfigYumRepository>?
  yumRepository;
    ...
    return <String, dynamic>{
      ...
      'commonRepository':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(commonRepository, (value) => value.toMap()),
  ...
  factory RepositoryRemoteRepositoryConfig.fromMap(Map<String, dynamic> map) {
    return RepositoryRemoteRepositoryConfig(
      ...
      commonRepository: (() {
        final guardedValue = map['commonRepository'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      disableUpstreamValidation: (() {
        final guardedValue = map['disableUpstreamValidation'];
        if (guardedValue == null) return null;
