...
class RepositoryCleanupPolicyCondition {
  ...
  factory RepositoryCleanupPolicyCondition.fromMap(Map<String, dynamic> map) {
    return RepositoryCleanupPolicyCondition(
      newerThan: (() {
        final guardedValue = map['newerThan'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      olderThan: (() {
        final guardedValue = map['olderThan'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      packageNamePrefixes: (() {
      ...
      tagPrefixes: (() {
        final guardedValue = map['tagPrefixes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      tagState: (() {
        final guardedValue = map['tagState'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      versionNamePrefixes: (() {
        final guardedValue = map['versionNamePrefixes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
    );
