...
class GetRepositoryRemoteRepositoryConfigUpstreamCredential {
  ...
  const GetRepositoryRemoteRepositoryConfigUpstreamCredential({
  ...
  factory GetRepositoryRemoteRepositoryConfigUpstreamCredential.fromMap(Map<String, dynamic> map) {
    return GetRepositoryRemoteRepositoryConfigUpstreamCredential(
      usernamePasswordCredentials: pulumi.Input.fromValue(pulumi.Input.decodeList<GetRepositoryRemoteRepositoryConfigUpstreamCredentialUsernamePasswordCredential>(map['usernamePasswordCredentials']!, (value) => GetRepositoryRemoteRepositoryConfigUpstreamCredentialUsernamePasswordCredential.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
