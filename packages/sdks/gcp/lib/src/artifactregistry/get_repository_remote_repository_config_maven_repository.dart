...
class GetRepositoryRemoteRepositoryConfigMavenRepository {
  ...
  final pulumi.Input<List<GetRepositoryRemoteRepositoryConfigMavenRepositoryCustomRepository>> customRepositories;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'customRepositories': pulumi.Input.mapInputValue<List<GetRepositoryRemoteRepositoryConfigMavenRepositoryCustomRepository>, List<Map<String, dynamic>>>(customRepositories, (value) => pulumi.Input.encodeList<GetRepositoryRemoteRepositoryConfigMavenRepositoryCustomRepository, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory GetRepositoryRemoteRepositoryConfigMavenRepository.fromMap(Map<String, dynamic> map) {
    return GetRepositoryRemoteRepositoryConfigMavenRepository(
      customRepositories: pulumi.Input.fromValue(pulumi.Input.decodeList<GetRepositoryRemoteRepositoryConfigMavenRepositoryCustomRepository>(map['customRepositories']!, (value) => GetRepositoryRemoteRepositoryConfigMavenRepositoryCustomRepository.fromMap((value as Map).cast<String, dynamic>()))),
