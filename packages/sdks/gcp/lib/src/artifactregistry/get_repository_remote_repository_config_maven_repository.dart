...
class GetRepositoryRemoteRepositoryConfigMavenRepository {
  ...
  factory GetRepositoryRemoteRepositoryConfigMavenRepository.fromMap(Map<String, dynamic> map) {
    return GetRepositoryRemoteRepositoryConfigMavenRepository(
      customRepositories: (pulumi.Input.decodeList<GetRepositoryRemoteRepositoryConfigMavenRepositoryCustomRepository>(map['customRepositories'], (value) => GetRepositoryRemoteRepositoryConfigMavenRepositoryCustomRepository.fromMap((value as Map).cast<String, dynamic>()))).input(),
