...
class GetRepositoryResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'labels': labels,
      'location': location,
      'mavenConfigs': pulumi.Input.encodeList<GetRepositoryMavenConfig, Map<String, dynamic>>(mavenConfigs, (value) => value.toMap()),
      'mode': mode,
      'name': name,
      'project': ?project,
      'pulumiLabels': pulumiLabels,
      'registryUri': registryUri,
      'remoteRepositoryConfigs': pulumi.Input.encodeList<GetRepositoryRemoteRepositoryConfig, Map<String, dynamic>>(remoteRepositoryConfigs, (value) => value.toMap()),
      'repositoryId': repositoryId,
      'updateTime': updateTime,
      'virtualRepositoryConfigs': pulumi.Input.encodeList<GetRepositoryVirtualRepositoryConfig, Map<String, dynamic>>(virtualRepositoryConfigs, (value) => value.toMap()),
      'vulnerabilityScanningConfigs': pulumi.Input.encodeList<GetRepositoryVulnerabilityScanningConfig, Map<String, dynamic>>(vulnerabilityScanningConfigs, (value) => value.toMap()),
    };
  }
  ...
  factory GetRepositoryResult.fromMap(Map<String, dynamic> map) {
    return GetRepositoryResult(
      ...
      virtualRepositoryConfigs: pulumi.Input.decodeList<GetRepositoryVirtualRepositoryConfig>(map['virtualRepositoryConfigs'], (value) => GetRepositoryVirtualRepositoryConfig.fromMap((value as Map).cast<String, dynamic>())),
      vulnerabilityScanningConfigs: pulumi.Input.decodeList<GetRepositoryVulnerabilityScanningConfig>(map['vulnerabilityScanningConfigs'], (value) => GetRepositoryVulnerabilityScanningConfig.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
