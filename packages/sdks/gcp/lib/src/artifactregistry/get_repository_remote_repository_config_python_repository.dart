...
class GetRepositoryRemoteRepositoryConfigPythonRepository {
  ...
  factory GetRepositoryRemoteRepositoryConfigPythonRepository.fromMap(Map<String, dynamic> map) {
    return GetRepositoryRemoteRepositoryConfigPythonRepository(
      customRepositories: pulumi.Input.fromValue(pulumi.Input.decodeList<GetRepositoryRemoteRepositoryConfigPythonRepositoryCustomRepository>(map['customRepositories']!, (value) => GetRepositoryRemoteRepositoryConfigPythonRepositoryCustomRepository.fromMap((value as Map).cast<String, dynamic>()))),
