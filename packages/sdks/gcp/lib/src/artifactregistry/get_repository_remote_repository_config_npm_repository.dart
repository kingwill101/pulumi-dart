...
class GetRepositoryRemoteRepositoryConfigNpmRepository {
  ...
  const GetRepositoryRemoteRepositoryConfigNpmRepository({
  ...
  factory GetRepositoryRemoteRepositoryConfigNpmRepository.fromMap(Map<String, dynamic> map) {
    return GetRepositoryRemoteRepositoryConfigNpmRepository(
      customRepositories: pulumi.Input.fromValue(pulumi.Input.decodeList<GetRepositoryRemoteRepositoryConfigNpmRepositoryCustomRepository>(map['customRepositories']!, (value) => GetRepositoryRemoteRepositoryConfigNpmRepositoryCustomRepository.fromMap((value as Map).cast<String, dynamic>()))),
