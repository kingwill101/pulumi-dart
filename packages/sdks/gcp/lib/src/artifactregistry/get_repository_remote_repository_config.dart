...
class GetRepositoryRemoteRepositoryConfig {
  ...
  const GetRepositoryRemoteRepositoryConfig({
  ...
  factory GetRepositoryRemoteRepositoryConfig.fromMap(Map<String, dynamic> map) {
    return GetRepositoryRemoteRepositoryConfig(
      aptRepositories: pulumi.Input.fromValue(pulumi.Input.decodeList<GetRepositoryRemoteRepositoryConfigAptRepository>(map['aptRepositories']!, (value) => GetRepositoryRemoteRepositoryConfigAptRepository.fromMap((value as Map).cast<String, dynamic>()))),
      commonRepositories: pulumi.Input.fromValue(pulumi.Input.decodeList<GetRepositoryRemoteRepositoryConfigCommonRepository>(map['commonRepositories']!, (value) => GetRepositoryRemoteRepositoryConfigCommonRepository.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      yumRepositories: pulumi.Input.fromValue(pulumi.Input.decodeList<GetRepositoryRemoteRepositoryConfigYumRepository>(map['yumRepositories']!, (value) => GetRepositoryRemoteRepositoryConfigYumRepository.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
