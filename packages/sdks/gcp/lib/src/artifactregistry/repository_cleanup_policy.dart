...
class RepositoryCleanupPolicy {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'id': id,
      'mostRecentVersions': ?mostRecentVersions == null ? null : mostRecentVersions!.toMap(),
    };
  }
  ...
  factory RepositoryCleanupPolicy.fromMap(Map<String, dynamic> map) {
    return RepositoryCleanupPolicy(
      ...
      condition: map['condition'] == null ? null : RepositoryCleanupPolicyCondition.fromMap((map['condition'] as Map).cast<String, dynamic>()),
      id: map['id'] as String,
      mostRecentVersions: map['mostRecentVersions'] == null ? null : RepositoryCleanupPolicyMostRecentVersions.fromMap((map['mostRecentVersions'] as Map).cast<String, dynamic>()),
    );
  }
}
