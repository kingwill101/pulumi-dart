...
class GetDockerImagesDockerImage {
  ...
  const GetDockerImagesDockerImage({
  ...
  factory GetDockerImagesDockerImage.fromMap(Map<String, dynamic> map) {
    return GetDockerImagesDockerImage(
      buildTime: pulumi.Input.fromValue(map['buildTime'] as String),
      imageName: pulumi.Input.fromValue(map['imageName'] as String),
      imageSizeBytes: pulumi.Input.fromValue(map['imageSizeBytes'] as String),
      ...
      uploadTime: pulumi.Input.fromValue(map['uploadTime'] as String),
    );
  }
}
