...
class RepositoryState {
  ...
  RepositoryState({
    pulumi.Output<List<RepositoryCleanupPolicy>>? cleanupPolicies,
    pulumi.Output<bool>? cleanupPolicyDryRun,
    pulumi.Output<String>? createTime,
    pulumi.Output<String>? description,
    pulumi.Output<RepositoryDockerConfig>? dockerConfig,
    pulumi.Output<Map<String, String>>? effectiveLabels,
    pulumi.Output<String>? format,
    pulumi.Output<String>? kmsKeyName,
    pulumi.Output<Map<String, String>>? labels,
    pulumi.Output<String>? location,
    pulumi.Output<RepositoryMavenConfig>? mavenConfig,
    pulumi.Output<String>? mode,
    pulumi.Output<String>? name,
    pulumi.Output<String>? project,
    pulumi.Output<Map<String, String>>? pulumiLabels,
    pulumi.Output<String>? registryUri,
    pulumi.Output<RepositoryRemoteRepositoryConfig>? remoteRepositoryConfig,
    pulumi.Output<String>? repositoryId,
    pulumi.Output<String>? updateTime,
    pulumi.Output<RepositoryVirtualRepositoryConfig>? virtualRepositoryConfig,
    pulumi.Output<RepositoryVulnerabilityScanningConfig>? vulnerabilityScanningConfig,
  }) :
      cleanupPolicies = pulumi.Input.asOptionalInput<List<RepositoryCleanupPolicy>>(cleanupPolicies),
      cleanupPolicyDryRun = pulumi.Input.asOptionalInput<bool>(cleanupPolicyDryRun),
      createTime = pulumi.Input.asOptionalInput<String>(createTime),
      description = pulumi.Input.asOptionalInput<String>(description),
      dockerConfig = pulumi.Input.asOptionalInput<RepositoryDockerConfig>(dockerConfig),
      effectiveLabels = pulumi.Input.asOptionalInput<Map<String, String>>(effectiveLabels),
      format = pulumi.Input.asOptionalInput<String>(format),
      kmsKeyName = pulumi.Input.asOptionalInput<String>(kmsKeyName),
      labels = pulumi.Input.asOptionalInput<Map<String, String>>(labels),
      location = pulumi.Input.asOptionalInput<String>(location),
      mavenConfig = pulumi.Input.asOptionalInput<RepositoryMavenConfig>(mavenConfig),
      mode = pulumi.Input.asOptionalInput<String>(mode),
      name = pulumi.Input.asOptionalInput<String>(name),
      project = pulumi.Input.asOptionalInput<String>(project),
      pulumiLabels = pulumi.Input.asOptionalInput<Map<String, String>>(pulumiLabels),
      registryUri = pulumi.Input.asOptionalInput<String>(registryUri),
      remoteRepositoryConfig = pulumi.Input.asOptionalInput<RepositoryRemoteRepositoryConfig>(remoteRepositoryConfig),
      repositoryId = pulumi.Input.asOptionalInput<String>(repositoryId),
      updateTime = pulumi.Input.asOptionalInput<String>(updateTime),
      virtualRepositoryConfig = pulumi.Input.asOptionalInput<RepositoryVirtualRepositoryConfig>(virtualRepositoryConfig),
      vulnerabilityScanningConfig = pulumi.Input.asOptionalInput<RepositoryVulnerabilityScanningConfig>(vulnerabilityScanningConfig);
  ...
  factory RepositoryState.fromMap(Map<String, dynamic> map) {
    return RepositoryState(
      cleanupPolicies: map['cleanupPolicies'] == null ? null : pulumi.Output.create<List<RepositoryCleanupPolicy>>(pulumi.Input.decodeList<RepositoryCleanupPolicy>(map['cleanupPolicies'], (value) => RepositoryCleanupPolicy.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      dockerConfig: map['dockerConfig'] == null ? null : pulumi.Output.create<RepositoryDockerConfig>(RepositoryDockerConfig.fromMap((map['dockerConfig'] as Map).cast<String, dynamic>())),
      ...
      mavenConfig: map['mavenConfig'] == null ? null : pulumi.Output.create<RepositoryMavenConfig>(RepositoryMavenConfig.fromMap((map['mavenConfig'] as Map).cast<String, dynamic>())),
      mode: map['mode'] == null ? null : pulumi.Output.create<String>(map['mode'] as String),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      project: map['project'] == null ? null : pulumi.Output.create<String>(map['project'] as String),
      pulumiLabels: map['pulumiLabels'] == null ? null : pulumi.Output.create<Map<String, String>>((map['pulumiLabels'] as Map).cast<String, String>()),
      registryUri: map['registryUri'] == null ? null : pulumi.Output.create<String>(map['registryUri'] as String),
      remoteRepositoryConfig: map['remoteRepositoryConfig'] == null ? null : pulumi.Output.create<RepositoryRemoteRepositoryConfig>(RepositoryRemoteRepositoryConfig.fromMap((map['remoteRepositoryConfig'] as Map).cast<String, dynamic>())),
      repositoryId: map['repositoryId'] == null ? null : pulumi.Output.create<String>(map['repositoryId'] as String),
      updateTime: map['updateTime'] == null ? null : pulumi.Output.create<String>(map['updateTime'] as String),
      virtualRepositoryConfig: map['virtualRepositoryConfig'] == null ? null : pulumi.Output.create<RepositoryVirtualRepositoryConfig>(RepositoryVirtualRepositoryConfig.fromMap((map['virtualRepositoryConfig'] as Map).cast<String, dynamic>())),
      vulnerabilityScanningConfig: map['vulnerabilityScanningConfig'] == null ? null : pulumi.Output.create<RepositoryVulnerabilityScanningConfig>(RepositoryVulnerabilityScanningConfig.fromMap((map['vulnerabilityScanningConfig'] as Map).cast<String, dynamic>())),
    );
  }
}
