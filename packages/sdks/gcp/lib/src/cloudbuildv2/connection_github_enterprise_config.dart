...
class ConnectionGithubEnterpriseConfig {
  ...
  final pulumi.Input<ConnectionGithubEnterpriseConfigServiceDirectoryConfig>?
  ...
  factory ConnectionGithubEnterpriseConfig.fromMap(Map<String, dynamic> map) {
    return ConnectionGithubEnterpriseConfig(
      ...
      appSlug: (() {
        final guardedValue = map['appSlug'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      hostUri: pulumi.Input.fromValue(map['hostUri'] as String),
      privateKeySecretVersion: (() {
        final guardedValue = map['privateKeySecretVersion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      serviceDirectoryConfig: (() {
      ...
      webhookSecretSecretVersion: (() {
        final guardedValue = map['webhookSecretSecretVersion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
