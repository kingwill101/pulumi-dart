...
import 'connection_iampolicy_state.dart';
...
class ConnectionIAMPolicy extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [ConnectionIAMPolicy]. {@macro pulumi_cloudbuildv2_connection_iampolicy_connection_iampolicy_args_doc}
  ...
  /// Creates a typed reference to an existing [ConnectionIAMPolicy] resource.
  ConnectionIAMPolicy.reference(String urn)
    : super(
        'gcp:cloudbuildv2/connectionIAMPolicy:ConnectionIAMPolicy',
