...
class ConnectionIAMBindingArgs {
  ...
  const ConnectionIAMBindingArgs({
    this.condition,
    this.location,
  ...
  factory ConnectionIAMBindingArgs.fromMap(Map<String, dynamic> map) {
    return ConnectionIAMBindingArgs(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConnectionIAMBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
