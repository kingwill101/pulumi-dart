...
import 'connection_iambinding_condition.dart';

/// {@template pulumi_cloudbuildv2_connection_iambinding_connection_iambinding_args_doc}
/// The set of arguments for ConnectionIAMBinding.
/// {@endtemplate}
/// {@macro pulumi_cloudbuildv2_connection_iambinding_connection_iambinding_args_doc}
class ConnectionIAMBindingArgs {
  ...
  ConnectionIAMBindingArgs({
    pulumi.Output<ConnectionIAMBindingCondition>? condition,
    ...
    required pulumi.Output<String> role,
      ...
      condition = pulumi.Input.asOptionalInput<ConnectionIAMBindingCondition>(condition),
  ...
  factory ConnectionIAMBindingArgs.fromMap(Map<String, dynamic> map) {
    return ConnectionIAMBindingArgs(
      condition: map['condition'] == null ? null : pulumi.Output.create<ConnectionIAMBindingCondition>(ConnectionIAMBindingCondition.fromMap((map['condition'] as Map).cast<String, dynamic>())),
