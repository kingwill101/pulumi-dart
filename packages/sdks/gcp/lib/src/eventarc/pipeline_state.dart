...
class PipelineState {
  ...
  factory PipelineState.fromMap(Map<String, dynamic> map) {
    return PipelineState(
      ...
      destinations: map['destinations'] == null ? null : (pulumi.Input.decodeList<PipelineDestination>(map['destinations'], (value) => PipelineDestination.fromMap((value as Map).cast<String, dynamic>()))).input(),
