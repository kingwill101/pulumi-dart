...
class MessageBus extends pulumi.CustomResource {
  ...
  MessageBus(
    ...
    loggingConfig = registerOutput<MessageBusLoggingConfig>('loggingConfig', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return MessageBusLoggingConfig.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Creates a typed reference to an existing [MessageBus] resource.
  MessageBus.reference(String urn)
    : super(
        'gcp:eventarc/messageBus:MessageBus',
