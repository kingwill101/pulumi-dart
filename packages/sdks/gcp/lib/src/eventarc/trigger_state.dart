...
class TriggerState {
  ...
  factory TriggerState.fromMap(Map<String, dynamic> map) {
    return TriggerState(
      ...
      destination: map['destination'] == null ? null : (TriggerDestination.fromMap((map['destination'] as Map).cast<String, dynamic>())).input(),
      ...
      matchingCriterias: map['matchingCriterias'] == null ? null : (pulumi.Input.decodeList<TriggerMatchingCriteria>(map['matchingCriterias'], (value) => TriggerMatchingCriteria.fromMap((value as Map).cast<String, dynamic>()))).input(),
