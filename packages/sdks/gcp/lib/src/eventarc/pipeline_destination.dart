...
class PipelineDestination {
  ...
  final pulumi.Input<PipelineDestinationAuthenticationConfig>?
  ...
  /// Structure is documented below.
  final pulumi.Input<PipelineDestinationOutputPayloadFormat>?
  outputPayloadFormat;
    ...
    return <String, dynamic>{
      ...
      'outputPayloadFormat':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(outputPayloadFormat, (value) => value.toMap()),
      'topic': ?topic,
      'workflow': ?workflow,
    };
  }
  ...
  factory PipelineDestination.fromMap(Map<String, dynamic> map) {
    return PipelineDestination(
      ...
      messageBus: (() {
        final guardedValue = map['messageBus'];
        if (guardedValue == null) return null;
      ...
      outputPayloadFormat: (() {
        final guardedValue = map['outputPayloadFormat'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
