...
class PipelineDestinationAuthenticationConfig {
  ...
  final pulumi.Input<PipelineDestinationAuthenticationConfigGoogleOidc>?
  googleOidc;
  ...
  /// Structure is documented below.
  final pulumi.Input<PipelineDestinationAuthenticationConfigOauthToken>?
  oauthToken;
  ...
  factory PipelineDestinationAuthenticationConfig.fromMap(
    ...
    return PipelineDestinationAuthenticationConfig(
      googleOidc: (() {
        final guardedValue = map['googleOidc'];
