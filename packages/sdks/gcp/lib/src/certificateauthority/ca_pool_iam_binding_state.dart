...
class CaPoolIamBindingState {
  ...
  /// Creates a new [CaPoolIamBindingState].
  ...
  factory CaPoolIamBindingState.fromMap(Map<String, dynamic> map) {
    return CaPoolIamBindingState(
      ...
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CaPoolIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
