...
class CaPoolIssuancePolicyAllowedKeyType {
  ...
  factory CaPoolIssuancePolicyAllowedKeyType.fromMap(Map<String, dynamic> map) {
    return CaPoolIssuancePolicyAllowedKeyType(
      ellipticCurve: (() { final guardedValue = map['ellipticCurve']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CaPoolIssuancePolicyAllowedKeyTypeEllipticCurve.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      rsa: (() { final guardedValue = map['rsa']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CaPoolIssuancePolicyAllowedKeyTypeRsa.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
