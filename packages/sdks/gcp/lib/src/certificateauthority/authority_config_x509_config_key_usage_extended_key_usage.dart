...
class AuthorityConfigX509ConfigKeyUsageExtendedKeyUsage {
  ...
  factory AuthorityConfigX509ConfigKeyUsageExtendedKeyUsage.fromMap(
    ...
    return AuthorityConfigX509ConfigKeyUsageExtendedKeyUsage(
      ...
      codeSigning: (() {
        final guardedValue = map['codeSigning'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      emailProtection: (() {
        final guardedValue = map['emailProtection'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      ocspSigning: (() {
        final guardedValue = map['ocspSigning'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      serverAuth: (() {
        final guardedValue = map['serverAuth'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      timeStamping: (() {
        final guardedValue = map['timeStamping'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
    );
