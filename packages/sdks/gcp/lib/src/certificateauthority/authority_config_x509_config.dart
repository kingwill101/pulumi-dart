...
class AuthorityConfigX509Config {
  ...
  final pulumi.Input<List<AuthorityConfigX509ConfigAdditionalExtension>>?
    ...
    return <String, dynamic>{
      'additionalExtensions':
          ?pulumi.Input.mapOptionalInputValue<
            List<AuthorityConfigX509ConfigAdditionalExtension>,
      ...
      'caOptions':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(caOptions, (value) => value.toMap()),
      'keyUsage':
          pulumi.Input.mapInputValue<
            AuthorityConfigX509ConfigKeyUsage,
            Map<String, dynamic>
          >(keyUsage, (value) => value.toMap()),
      'nameConstraints':
          ?pulumi.Input.mapOptionalInputValue<
            AuthorityConfigX509ConfigNameConstraints,
            Map<String, dynamic>
          >(nameConstraints, (value) => value.toMap()),
      'policyIds':
          ?pulumi.Input.mapOptionalInputValue<
            List<AuthorityConfigX509ConfigPolicyId>,
            List<Map<String, dynamic>>
          >(
            policyIds,
            (value) =>
    ...
    return AuthorityConfigX509Config(
      additionalExtensions: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AuthorityConfigX509ConfigAdditionalExtension>(
            guardedValue,
      ...
      aiaOcspServers: (() {
        final guardedValue = map['aiaOcspServers'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      caOptions: pulumi.Input.fromValue(
        AuthorityConfigX509ConfigCaOptions.fromMap(
          (map['caOptions']! as Map).cast<String, dynamic>(),
        ),
      ),
      keyUsage: pulumi.Input.fromValue(
        AuthorityConfigX509ConfigKeyUsage.fromMap(
          (map['keyUsage']! as Map).cast<String, dynamic>(),
        ),
      ),
      nameConstraints: (() {
        final guardedValue = map['nameConstraints'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      policyIds: (() {
        final guardedValue = map['policyIds'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
