...
class CertificateTemplateIamPolicyState {
  ...
  /// Creates a new [CertificateTemplateIamPolicyState].
  ...
  const CertificateTemplateIamPolicyState({
  ...
  factory CertificateTemplateIamPolicyState.fromMap(Map<String, dynamic> map) {
    return CertificateTemplateIamPolicyState(
