...
class CertificateConfigX509Config {
  ...
  final pulumi.Input<List<CertificateConfigX509ConfigAdditionalExtension>>?
  ...
  /// Structure is documented below.
  final pulumi.Input<CertificateConfigX509ConfigNameConstraints>?
  nameConstraints;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'policyIds':
          ?pulumi.Input.mapOptionalInputValue<
            List<CertificateConfigX509ConfigPolicyId>,
            List<Map<String, dynamic>>
          >(
            policyIds,
            (value) =>
  ...
  factory CertificateConfigX509Config.fromMap(Map<String, dynamic> map) {
    return CertificateConfigX509Config(
      ...
      keyUsage: pulumi.Input.fromValue(
        CertificateConfigX509ConfigKeyUsage.fromMap(
