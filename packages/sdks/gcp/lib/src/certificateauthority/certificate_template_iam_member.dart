...
import 'certificate_template_iam_member_args.dart';
import 'certificate_template_iam_member_condition.dart';
import 'certificate_template_iam_member_state.dart';
...
class CertificateTemplateIamMember extends pulumi.CustomResource {
  ...
  late final pulumi.Output<CertificateTemplateIamMemberCondition?> condition;
  ...
  /// Creates a new [CertificateTemplateIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [CertificateTemplateIamMember]. {@macro pulumi_certificateauthority_certificate_template_iam_member_certificate_template_iam_member_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  CertificateTemplateIamMember(
    String name, {
    CertificateTemplateIamMemberArgs? args,
    ...
    this.condition = registerOutput<CertificateTemplateIamMemberCondition?>('condition');
  ...
  /// Gets an existing [CertificateTemplateIamMember] resource's state with the given [name] and [id].
  static CertificateTemplateIamMember get(
    String name,
  ...
  CertificateTemplateIamMember._get(
    String name, {
