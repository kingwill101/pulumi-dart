...
class GetAuthorityConfig {
  ...
  factory GetAuthorityConfig.fromMap(Map<String, dynamic> map) {
    return GetAuthorityConfig(
      subjectConfigs: (pulumi.Input.decodeList<GetAuthorityConfigSubjectConfig>(map['subjectConfigs'], (value) => GetAuthorityConfigSubjectConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
      subjectKeyIds: (pulumi.Input.decodeList<GetAuthorityConfigSubjectKeyId>(map['subjectKeyIds'], (value) => GetAuthorityConfigSubjectKeyId.fromMap((value as Map).cast<String, dynamic>()))).input(),
      x509Configs: (pulumi.Input.decodeList<GetAuthorityConfigX509Config>(map['x509Configs'], (value) => GetAuthorityConfigX509Config.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
