...
class GetAuthorityConfig {
    ...
    return <String, dynamic>{
      'subjectConfigs':
          pulumi.Input.mapInputValue<
            List<GetAuthorityConfigSubjectConfig>,
      ...
      'subjectKeyIds':
          pulumi.Input.mapInputValue<
            List<GetAuthorityConfigSubjectKeyId>,
            List<Map<String, dynamic>>
          >(
            subjectKeyIds,
            (value) =>
      ...
      'x509Configs':
          pulumi.Input.mapInputValue<
            List<GetAuthorityConfigX509Config>,
            List<Map<String, dynamic>>
          >(
            x509Configs,
            (value) =>
  ...
  factory GetAuthorityConfig.fromMap(Map<String, dynamic> map) {
    return GetAuthorityConfig(
      subjectConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetAuthorityConfigSubjectConfig>(
          map['subjectConfigs']!,
      ...
      subjectKeyIds: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetAuthorityConfigSubjectKeyId>(
          map['subjectKeyIds']!,
      ...
      x509Configs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetAuthorityConfigX509Config>(
          map['x509Configs']!,
