...
class CertificateConfigX509ConfigKeyUsage {
  ...
  final pulumi.Input<CertificateConfigX509ConfigKeyUsageBaseKeyUsage>
  baseKeyUsage;

  /// Describes high-level ways in which a key may be used.
  /// Structure is documented below.
  final pulumi.Input<CertificateConfigX509ConfigKeyUsageExtendedKeyUsage>
  extendedKeyUsage;

  /// An ObjectId specifies an object identifier (OID). These provide context and describe types in ASN.1 messages.
  /// Structure is documented below.
  final pulumi.Input<
    List<CertificateConfigX509ConfigKeyUsageUnknownExtendedKeyUsage>
  >?
    ...
    return <String, dynamic>{
      'baseKeyUsage':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(baseKeyUsage, (value) => value.toMap()),
      'extendedKeyUsage':
          pulumi.Input.mapInputValue<
            CertificateConfigX509ConfigKeyUsageExtendedKeyUsage,
            Map<String, dynamic>
          >(extendedKeyUsage, (value) => value.toMap()),
      'unknownExtendedKeyUsages':
  ...
  factory CertificateConfigX509ConfigKeyUsage.fromMap(
    ...
    return CertificateConfigX509ConfigKeyUsage(
      baseKeyUsage: pulumi.Input.fromValue(
        CertificateConfigX509ConfigKeyUsageBaseKeyUsage.fromMap(
          (map['baseKeyUsage']! as Map).cast<String, dynamic>(),
        ),
      ),
      extendedKeyUsage: pulumi.Input.fromValue(
        CertificateConfigX509ConfigKeyUsageExtendedKeyUsage.fromMap(
          (map['extendedKeyUsage']! as Map).cast<String, dynamic>(),
        ),
      ),
      unknownExtendedKeyUsages: (() {
        final guardedValue = map['unknownExtendedKeyUsages'];
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                CertificateConfigX509ConfigKeyUsageUnknownExtendedKeyUsage.fromMap(
