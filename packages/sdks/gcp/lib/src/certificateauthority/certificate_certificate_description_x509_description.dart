...
class CertificateCertificateDescriptionX509Description {
  ...
  /// Structure is documented below.
  final pulumi.Input<
    List<CertificateCertificateDescriptionX509DescriptionCaOption>
  >?
  caOptions;
  ...
  /// Structure is documented below.
  final pulumi.Input<
    List<CertificateCertificateDescriptionX509DescriptionKeyUsage>
  >?
  keyUsages;
  ...
  /// Structure is documented below.
  final pulumi.Input<
    List<CertificateCertificateDescriptionX509DescriptionNameConstraint>
  >?
  nameConstraints;
  ...
  /// Structure is documented below.
  final pulumi.Input<
    List<CertificateCertificateDescriptionX509DescriptionPolicyId>
  >?
  policyIds;
  ...
  factory CertificateCertificateDescriptionX509Description.fromMap(
    ...
    return CertificateCertificateDescriptionX509Description(
      additionalExtensions: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                CertificateCertificateDescriptionX509DescriptionAdditionalExtension.fromMap(
      ...
      caOptions: (() {
        final guardedValue = map['caOptions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<
            CertificateCertificateDescriptionX509DescriptionCaOption
          >(
            guardedValue,
            (value) =>
                CertificateCertificateDescriptionX509DescriptionCaOption.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      keyUsages: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                CertificateCertificateDescriptionX509DescriptionKeyUsage.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      nameConstraints: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                CertificateCertificateDescriptionX509DescriptionNameConstraint.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      policyIds: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                CertificateCertificateDescriptionX509DescriptionPolicyId.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
