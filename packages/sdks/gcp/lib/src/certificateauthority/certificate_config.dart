    ...
    return <String, dynamic>{
      ...
      'subjectConfig':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(subjectConfig, (value) => value.toMap()),
      'subjectKeyId':
          ?pulumi.Input.mapOptionalInputValue<
            CertificateConfigSubjectKeyId,
            Map<String, dynamic>
          >(subjectKeyId, (value) => value.toMap()),
      'x509Config':
          pulumi.Input.mapInputValue<
            CertificateConfigX509Config,
            Map<String, dynamic>
          >(x509Config, (value) => value.toMap()),
    };
  }
  ...
  factory CertificateConfig.fromMap(Map<String, dynamic> map) {
    return CertificateConfig(
      ...
      x509Config: pulumi.Input.fromValue(
        CertificateConfigX509Config.fromMap(
