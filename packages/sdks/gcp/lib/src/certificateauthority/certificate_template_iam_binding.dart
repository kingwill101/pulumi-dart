...
import 'certificate_template_iam_binding_state.dart';
...
class CertificateTemplateIamBinding extends pulumi.CustomResource {
  ...
  /// Creates a new [CertificateTemplateIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [CertificateTemplateIamBinding]. {@macro pulumi_certificateauthority_certificate_template_iam_binding_certificate_template_iam_binding_args_doc}
  ...
  /// Gets an existing [CertificateTemplateIamBinding] resource's state with the given [name] and [id].
  static CertificateTemplateIamBinding get(
    String name,
    pulumi.Input<String> id, {
    CertificateTemplateIamBindingState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return CertificateTemplateIamBinding._get(
      name,
      state: state?.toMap(),
  ...
  CertificateTemplateIamBinding._get(
    String name, {
  ...
  /// Creates a typed reference to an existing [CertificateTemplateIamBinding] resource.
  CertificateTemplateIamBinding.reference(String urn)
    : super(
        'gcp:certificateauthority/certificateTemplateIamBinding:CertificateTemplateIamBinding',
