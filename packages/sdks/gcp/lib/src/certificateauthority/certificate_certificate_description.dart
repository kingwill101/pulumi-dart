...
class CertificateCertificateDescription {
  ...
  factory CertificateCertificateDescription.fromMap(Map<String, dynamic> map) {
    return CertificateCertificateDescription(
      ...
      authorityKeyIds: (() { final guardedValue = map['authorityKeyIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<CertificateCertificateDescriptionAuthorityKeyId>(guardedValue, (value) => CertificateCertificateDescriptionAuthorityKeyId.fromMap((value as Map).cast<String, dynamic>()))); })(),
      certFingerprints: (() { final guardedValue = map['certFingerprints']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<CertificateCertificateDescriptionCertFingerprint>(guardedValue, (value) => CertificateCertificateDescriptionCertFingerprint.fromMap((value as Map).cast<String, dynamic>()))); })(),
      crlDistributionPoints: (() { final guardedValue = map['crlDistributionPoints']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      publicKeys: (() { final guardedValue = map['publicKeys']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<CertificateCertificateDescriptionPublicKey>(guardedValue, (value) => CertificateCertificateDescriptionPublicKey.fromMap((value as Map).cast<String, dynamic>()))); })(),
      subjectDescriptions: (() { final guardedValue = map['subjectDescriptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<CertificateCertificateDescriptionSubjectDescription>(guardedValue, (value) => CertificateCertificateDescriptionSubjectDescription.fromMap((value as Map).cast<String, dynamic>()))); })(),
      subjectKeyIds: (() { final guardedValue = map['subjectKeyIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<CertificateCertificateDescriptionSubjectKeyId>(guardedValue, (value) => CertificateCertificateDescriptionSubjectKeyId.fromMap((value as Map).cast<String, dynamic>()))); })(),
      x509Descriptions: (() { final guardedValue = map['x509Descriptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<CertificateCertificateDescriptionX509Description>(guardedValue, (value) => CertificateCertificateDescriptionX509Description.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
