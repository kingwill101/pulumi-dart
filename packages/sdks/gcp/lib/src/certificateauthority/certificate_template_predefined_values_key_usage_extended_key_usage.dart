...
class CertificateTemplatePredefinedValuesKeyUsageExtendedKeyUsage {
  ...
  /// Creates a new [CertificateTemplatePredefinedValuesKeyUsageExtendedKeyUsage].
  ...
  const CertificateTemplatePredefinedValuesKeyUsageExtendedKeyUsage({
    this.clientAuth,
    this.codeSigning,
  ...
  factory CertificateTemplatePredefinedValuesKeyUsageExtendedKeyUsage.fromMap(Map<String, dynamic> map) {
