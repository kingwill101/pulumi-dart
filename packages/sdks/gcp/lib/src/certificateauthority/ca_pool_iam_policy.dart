...
import 'ca_pool_iam_policy_state.dart';
...
class CaPoolIamPolicy extends pulumi.CustomResource {
  ...
  /// Creates a new [CaPoolIamPolicy].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [CaPoolIamPolicy]. {@macro pulumi_certificateauthority_ca_pool_iam_policy_ca_pool_iam_policy_args_doc}
  ...
  /// Gets an existing [CaPoolIamPolicy] resource's state with the given [name] and [id].
  static CaPoolIamPolicy get(
    String name,
    pulumi.Input<String> id, {
    CaPoolIamPolicyState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return CaPoolIamPolicy._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [CaPoolIamPolicy] resource.
  CaPoolIamPolicy.reference(String urn)
    : super(
        'gcp:certificateauthority/caPoolIamPolicy:CaPoolIamPolicy',
