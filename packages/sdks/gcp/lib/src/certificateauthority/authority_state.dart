...
class AuthorityState {
  ...
  factory AuthorityState.fromMap(Map<String, dynamic> map) {
    return AuthorityState(
      accessUrls: (() { final guardedValue = map['accessUrls']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AuthorityAccessUrl>(guardedValue, (value) => AuthorityAccessUrl.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      keySpec: (() { final guardedValue = map['keySpec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AuthorityKeySpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      pemCaCertificates: (() { final guardedValue = map['pemCaCertificates']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
