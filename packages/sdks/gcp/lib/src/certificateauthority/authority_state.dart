...
class AuthorityState {
  ...
  factory AuthorityState.fromMap(Map<String, dynamic> map) {
    return AuthorityState(
      accessUrls: (() {
        final guardedValue = map['accessUrls'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AuthorityAccessUrl>(
            guardedValue,
            (value) => AuthorityAccessUrl.fromMap(
      ...
      pemCaCertificates: (() {
        final guardedValue = map['pemCaCertificates'];
        if (guardedValue == null) return null;
