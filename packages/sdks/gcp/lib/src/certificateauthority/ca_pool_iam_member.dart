...
import 'ca_pool_iam_member_state.dart';
...
class CaPoolIamMember extends pulumi.CustomResource {
  ...
  late final pulumi.Output<CaPoolIamMemberCondition?> condition;
  ...
  /// Creates a new [CaPoolIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [CaPoolIamMember]. {@macro pulumi_certificateauthority_ca_pool_iam_member_ca_pool_iam_member_args_doc}
  ...
  /// Gets an existing [CaPoolIamMember] resource's state with the given [name] and [id].
  static CaPoolIamMember get(
    String name,
