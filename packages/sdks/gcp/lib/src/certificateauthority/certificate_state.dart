...
class CertificateState {
  ...
  factory CertificateState.fromMap(Map<String, dynamic> map) {
    return CertificateState(
      ...
      certificateDescriptions: (() { final guardedValue = map['certificateDescriptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<CertificateCertificateDescription>(guardedValue, (value) => CertificateCertificateDescription.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      pemCertificateChains: (() { final guardedValue = map['pemCertificateChains']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      ...
      revocationDetails: (() { final guardedValue = map['revocationDetails']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<CertificateRevocationDetail>(guardedValue, (value) => CertificateRevocationDetail.fromMap((value as Map).cast<String, dynamic>()))); })(),
