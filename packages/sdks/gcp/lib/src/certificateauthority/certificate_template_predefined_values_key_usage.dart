...
class CertificateTemplatePredefinedValuesKeyUsage {
  ...
  final pulumi.Input<CertificateTemplatePredefinedValuesKeyUsageBaseKeyUsage>?
  baseKeyUsage;
  ...
  /// Structure is documented below.
  final pulumi.Input<
    List<CertificateTemplatePredefinedValuesKeyUsageUnknownExtendedKeyUsage>
  >?
  ...
  factory CertificateTemplatePredefinedValuesKeyUsage.fromMap(
    ...
    return CertificateTemplatePredefinedValuesKeyUsage(
      baseKeyUsage: (() {
        final guardedValue = map['baseKeyUsage'];
      ...
      extendedKeyUsage: (() {
        final guardedValue = map['extendedKeyUsage'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      unknownExtendedKeyUsages: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                CertificateTemplatePredefinedValuesKeyUsageUnknownExtendedKeyUsage.fromMap(
