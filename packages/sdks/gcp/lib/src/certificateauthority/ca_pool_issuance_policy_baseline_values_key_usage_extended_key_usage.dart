...
class CaPoolIssuancePolicyBaselineValuesKeyUsageExtendedKeyUsage {
  ...
  /// Creates a new [CaPoolIssuancePolicyBaselineValuesKeyUsageExtendedKeyUsage].
  ...
  const CaPoolIssuancePolicyBaselineValuesKeyUsageExtendedKeyUsage({
    this.clientAuth,
    this.codeSigning,
  ...
  factory CaPoolIssuancePolicyBaselineValuesKeyUsageExtendedKeyUsage.fromMap(Map<String, dynamic> map) {
