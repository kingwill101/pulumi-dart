...
class CertificateTemplateIdentityConstraints {
  ...
  const CertificateTemplateIdentityConstraints({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'celExpression': ?pulumi.Input.mapOptionalInputValue<CertificateTemplateIdentityConstraintsCelExpression, Map<String, dynamic>>(celExpression, (value) => value.toMap()),
    };
  }

  factory CertificateTemplateIdentityConstraints.fromMap(Map<String, dynamic> map) {
    return CertificateTemplateIdentityConstraints(
      ...
      celExpression: (() { final guardedValue = map['celExpression']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CertificateTemplateIdentityConstraintsCelExpression.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
