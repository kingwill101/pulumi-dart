...
class CaPoolIssuancePolicy {
  ...
  final pulumi.Input<CaPoolIssuancePolicyAllowedIssuanceModes>?
  ...
  /// Structure is documented below.
  final pulumi.Input<CaPoolIssuancePolicyIdentityConstraints>?
  identityConstraints;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'allowedKeyTypes':
          ?pulumi.Input.mapOptionalInputValue<
            List<CaPoolIssuancePolicyAllowedKeyType>,
  ...
  factory CaPoolIssuancePolicy.fromMap(Map<String, dynamic> map) {
    return CaPoolIssuancePolicy(
      allowedIssuanceModes: (() {
        final guardedValue = map['allowedIssuanceModes'];
      ...
      allowedKeyTypes: (() {
        final guardedValue = map['allowedKeyTypes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      backdateDuration: (() {
        final guardedValue = map['backdateDuration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      baselineValues: (() {
        final guardedValue = map['baselineValues'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
