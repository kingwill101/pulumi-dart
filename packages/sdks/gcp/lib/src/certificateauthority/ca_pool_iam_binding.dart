...
import 'ca_pool_iam_binding_state.dart';
...
class CaPoolIamBinding extends pulumi.CustomResource {
  ...
  CaPoolIamBinding(
    ...
    condition = registerOutput<CaPoolIamBindingCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return CaPoolIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [CaPoolIamBinding] resource's state with the given [name] and [id].
  static CaPoolIamBinding get(
    String name,
    pulumi.Input<String> id, {
    CaPoolIamBindingState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return CaPoolIamBinding._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [CaPoolIamBinding] resource.
  CaPoolIamBinding.reference(String urn)
    : super(
        'gcp:certificateauthority/caPoolIamBinding:CaPoolIamBinding',
