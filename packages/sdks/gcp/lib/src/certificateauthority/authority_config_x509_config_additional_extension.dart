...
class AuthorityConfigX509ConfigAdditionalExtension {
  ...
  final pulumi.Input<AuthorityConfigX509ConfigAdditionalExtensionObjectId> objectId;
  ...
  const AuthorityConfigX509ConfigAdditionalExtension({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'critical': critical,
      'objectId': pulumi.Input.mapInputValue<AuthorityConfigX509ConfigAdditionalExtensionObjectId, Map<String, dynamic>>(objectId, (value) => value.toMap()),
      'value': value,
    };
  }

  factory AuthorityConfigX509ConfigAdditionalExtension.fromMap(Map<String, dynamic> map) {
    return AuthorityConfigX509ConfigAdditionalExtension(
      critical: pulumi.Input.fromValue(map['critical'] as bool),
      objectId: pulumi.Input.fromValue(AuthorityConfigX509ConfigAdditionalExtensionObjectId.fromMap((map['objectId']! as Map).cast<String, dynamic>())),
