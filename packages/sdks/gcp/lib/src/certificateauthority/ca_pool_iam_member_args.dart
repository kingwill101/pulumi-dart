...
/// {@template pulumi_certificateauthority_ca_pool_iam_member_ca_pool_iam_member_args_doc}
/// The set of arguments for CaPoolIamMember.
/// {@endtemplate}
/// {@macro pulumi_certificateauthority_ca_pool_iam_member_ca_pool_iam_member_args_doc}
class CaPoolIamMemberArgs {
  ...
  /// Creates a new [CaPoolIamMemberArgs].
  ...
  CaPoolIamMemberArgs({
    ...
    pulumi.Output<CaPoolIamMemberCondition>? condition,
    ...
    required pulumi.Output<String> role,
      ...
      condition = pulumi.Input.asOptionalInput<CaPoolIamMemberCondition>(condition),
  ...
  factory CaPoolIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return CaPoolIamMemberArgs(
      ...
      condition: map['condition'] == null ? null : pulumi.Output.create<CaPoolIamMemberCondition>(CaPoolIamMemberCondition.fromMap((map['condition'] as Map).cast<String, dynamic>())),
