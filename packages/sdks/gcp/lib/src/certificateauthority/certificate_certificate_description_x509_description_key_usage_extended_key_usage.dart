...
class CertificateCertificateDescriptionX509DescriptionKeyUsageExtendedKeyUsage {
  ...
  const CertificateCertificateDescriptionX509DescriptionKeyUsageExtendedKeyUsage({
    this.clientAuth,
    this.codeSigning,
  ...
  factory CertificateCertificateDescriptionX509DescriptionKeyUsageExtendedKeyUsage.fromMap(Map<String, dynamic> map) {
