...
class GetAuthorityConfigX509ConfigNameConstraint {
  ...
  factory GetAuthorityConfigX509ConfigNameConstraint.fromMap(
    ...
    return GetAuthorityConfigX509ConfigNameConstraint(
      ...
      excludedDnsNames: pulumi.Input.fromValue(
        (map['excludedDnsNames'] as List).cast<String>(),
      ),
      excludedEmailAddresses: pulumi.Input.fromValue(
        (map['excludedEmailAddresses'] as List).cast<String>(),
      ),
      excludedIpRanges: pulumi.Input.fromValue(
        (map['excludedIpRanges'] as List).cast<String>(),
      ),
      excludedUris: pulumi.Input.fromValue(
        (map['excludedUris'] as List).cast<String>(),
      ),
      permittedDnsNames: pulumi.Input.fromValue(
        (map['permittedDnsNames'] as List).cast<String>(),
      ),
      permittedEmailAddresses: pulumi.Input.fromValue(
        (map['permittedEmailAddresses'] as List).cast<String>(),
      ),
      permittedIpRanges: pulumi.Input.fromValue(
        (map['permittedIpRanges'] as List).cast<String>(),
      ),
      permittedUris: pulumi.Input.fromValue(
