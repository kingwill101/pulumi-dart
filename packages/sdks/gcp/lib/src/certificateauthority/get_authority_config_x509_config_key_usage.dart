...
class GetAuthorityConfigX509ConfigKeyUsage {
  ...
  factory GetAuthorityConfigX509ConfigKeyUsage.fromMap(Map<String, dynamic> map) {
    return GetAuthorityConfigX509ConfigKeyUsage(
      baseKeyUsages: (pulumi.Input.decodeList<GetAuthorityConfigX509ConfigKeyUsageBaseKeyUsage>(map['baseKeyUsages'], (value) => GetAuthorityConfigX509ConfigKeyUsageBaseKeyUsage.fromMap((value as Map).cast<String, dynamic>()))).input(),
      extendedKeyUsages: (pulumi.Input.decodeList<GetAuthorityConfigX509ConfigKeyUsageExtendedKeyUsage>(map['extendedKeyUsages'], (value) => GetAuthorityConfigX509ConfigKeyUsageExtendedKeyUsage.fromMap((value as Map).cast<String, dynamic>()))).input(),
      unknownExtendedKeyUsages: (pulumi.Input.decodeList<GetAuthorityConfigX509ConfigKeyUsageUnknownExtendedKeyUsage>(map['unknownExtendedKeyUsages'], (value) => GetAuthorityConfigX509ConfigKeyUsageUnknownExtendedKeyUsage.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
