...
class GetAuthorityConfigX509ConfigKeyUsage {
  ...
  final pulumi.Input<List<GetAuthorityConfigX509ConfigKeyUsageBaseKeyUsage>>
  baseKeyUsages;

  /// Describes high-level ways in which a key may be used.
  final pulumi.Input<List<GetAuthorityConfigX509ConfigKeyUsageExtendedKeyUsage>>
  extendedKeyUsages;

  /// An ObjectId specifies an object identifier (OID). These provide context and describe types in ASN.1 messages.
  final pulumi.Input<
    List<GetAuthorityConfigX509ConfigKeyUsageUnknownExtendedKeyUsage>
  >
    ...
    return <String, dynamic>{
      'baseKeyUsages':
          pulumi.Input.mapInputValue<
            List<GetAuthorityConfigX509ConfigKeyUsageBaseKeyUsage>,
      ...
      'extendedKeyUsages':
          pulumi.Input.mapInputValue<
            List<GetAuthorityConfigX509ConfigKeyUsageExtendedKeyUsage>,
            List<Map<String, dynamic>>
          >(
            extendedKeyUsages,
            (value) =>
  ...
  factory GetAuthorityConfigX509ConfigKeyUsage.fromMap(
    ...
    return GetAuthorityConfigX509ConfigKeyUsage(
      baseKeyUsages: pulumi.Input.fromValue(
        pulumi
      ...
      unknownExtendedKeyUsages: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetAuthorityConfigX509ConfigKeyUsageUnknownExtendedKeyUsage
        >(
