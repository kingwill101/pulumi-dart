...
class CertificateCertificateDescriptionX509DescriptionNameConstraint {
  ...
  const CertificateCertificateDescriptionX509DescriptionNameConstraint({
    this.critical,
  ...
  factory CertificateCertificateDescriptionX509DescriptionNameConstraint.fromMap(Map<String, dynamic> map) {
