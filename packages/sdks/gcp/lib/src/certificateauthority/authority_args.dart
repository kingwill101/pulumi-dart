...
class AuthorityArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'config':
          pulumi.Input.mapInputValue<AuthorityConfig, Map<String, dynamic>>(
            config,
            (value) => value.toMap(),
          ),
      ...
      'keySpec':
          pulumi.Input.mapInputValue<AuthorityKeySpec, Map<String, dynamic>>(
            keySpec,
            (value) => value.toMap(),
          ),
      'labels': ?labels,
      ...
      'subordinateConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(subordinateConfig, (value) => value.toMap()),
      'type': ?type,
      'userDefinedAccessUrls':
          ?pulumi.Input.mapOptionalInputValue<
            AuthorityUserDefinedAccessUrls,
            Map<String, dynamic>
          >(userDefinedAccessUrls, (value) => value.toMap()),
    };
  }
  ...
  factory AuthorityArgs.fromMap(Map<String, dynamic> map) {
    return AuthorityArgs(
      ...
      ignoreActiveCertificatesOnDeletion: (() {
        final guardedValue = map['ignoreActiveCertificatesOnDeletion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      keySpec: pulumi.Input.fromValue(
        AuthorityKeySpec.fromMap(
      ...
      pemCaCertificate: (() {
        final guardedValue = map['pemCaCertificate'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ...
      skipGracePeriod: (() {
        final guardedValue = map['skipGracePeriod'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      subordinateConfig: (() {
        final guardedValue = map['subordinateConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AuthoritySubordinateConfig.fromMap(
      ...
      userDefinedAccessUrls: (() {
        final guardedValue = map['userDefinedAccessUrls'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AuthorityUserDefinedAccessUrls.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
