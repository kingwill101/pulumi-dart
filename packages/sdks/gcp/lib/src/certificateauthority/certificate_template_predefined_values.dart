...
class CertificateTemplatePredefinedValues {
  ...
  final pulumi.Input<
    List<CertificateTemplatePredefinedValuesAdditionalExtension>
  >?
  ...
  /// Structure is documented below.
  final pulumi.Input<CertificateTemplatePredefinedValuesNameConstraints>?
  nameConstraints;

  /// Optional. Describes the X.509 certificate policy object identifiers, per https://tools.ietf.org/html/rfc5280#section-4.2.1.4.
  /// Structure is documented below.
  final pulumi.Input<List<CertificateTemplatePredefinedValuesPolicyId>>?
  policyIds;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'policyIds':
          ?pulumi.Input.mapOptionalInputValue<
            List<CertificateTemplatePredefinedValuesPolicyId>,
            List<Map<String, dynamic>>
          >(
            policyIds,
            (value) =>
  ...
  factory CertificateTemplatePredefinedValues.fromMap(
    ...
    return CertificateTemplatePredefinedValues(
      additionalExtensions: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                CertificateTemplatePredefinedValuesAdditionalExtension.fromMap(
      ...
      policyIds: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<CertificateTemplatePredefinedValuesPolicyId>(
            guardedValue,
