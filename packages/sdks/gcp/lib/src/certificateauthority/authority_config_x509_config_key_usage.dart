...
class AuthorityConfigX509ConfigKeyUsage {
  ...
  final pulumi.Input<AuthorityConfigX509ConfigKeyUsageBaseKeyUsage>
  baseKeyUsage;

  /// Describes high-level ways in which a key may be used.
  /// Structure is documented below.
  final pulumi.Input<AuthorityConfigX509ConfigKeyUsageExtendedKeyUsage>
  extendedKeyUsage;

  /// An ObjectId specifies an object identifier (OID). These provide context and describe types in ASN.1 messages.
  /// Structure is documented below.
  final pulumi.Input<
    List<AuthorityConfigX509ConfigKeyUsageUnknownExtendedKeyUsage>
  >?
  ...
  factory AuthorityConfigX509ConfigKeyUsage.fromMap(Map<String, dynamic> map) {
    return AuthorityConfigX509ConfigKeyUsage(
      baseKeyUsage: pulumi.Input.fromValue(
        AuthorityConfigX509ConfigKeyUsageBaseKeyUsage.fromMap(
      ...
      unknownExtendedKeyUsages: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                AuthorityConfigX509ConfigKeyUsageUnknownExtendedKeyUsage.fromMap(
