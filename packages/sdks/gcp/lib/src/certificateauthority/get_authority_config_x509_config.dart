...
class GetAuthorityConfigX509Config {
  ...
  final pulumi.Input<List<GetAuthorityConfigX509ConfigAdditionalExtension>>
  ...
  final pulumi.Input<List<GetAuthorityConfigX509ConfigNameConstraint>>
  nameConstraints;
    ...
    return <String, dynamic>{
      'additionalExtensions':
          pulumi.Input.mapInputValue<
            List<GetAuthorityConfigX509ConfigAdditionalExtension>,
      ...
      'caOptions':
          pulumi.Input.mapInputValue<
            List<GetAuthorityConfigX509ConfigCaOption>,
            List<Map<String, dynamic>>
          >(
            caOptions,
            (value) =>
      ...
      'keyUsages':
          pulumi.Input.mapInputValue<
            List<GetAuthorityConfigX509ConfigKeyUsage>,
            List<Map<String, dynamic>>
          >(
            keyUsages,
            (value) =>
      ...
      'nameConstraints':
          pulumi.Input.mapInputValue<
            List<GetAuthorityConfigX509ConfigNameConstraint>,
            List<Map<String, dynamic>>
          >(
            nameConstraints,
            (value) =>
      ...
      'policyIds':
          pulumi.Input.mapInputValue<
            List<GetAuthorityConfigX509ConfigPolicyId>,
            List<Map<String, dynamic>>
          >(
            policyIds,
            (value) =>
  ...
  factory GetAuthorityConfigX509Config.fromMap(Map<String, dynamic> map) {
    return GetAuthorityConfigX509Config(
      additionalExtensions: pulumi.Input.fromValue(
        pulumi
      ...
      aiaOcspServers: pulumi.Input.fromValue(
        (map['aiaOcspServers'] as List).cast<String>(),
      ),
      caOptions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetAuthorityConfigX509ConfigCaOption>(
          map['caOptions']!,
      ...
      keyUsages: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetAuthorityConfigX509ConfigKeyUsage>(
          map['keyUsages']!,
      ...
      nameConstraints: pulumi.Input.fromValue(
      ...
      policyIds: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetAuthorityConfigX509ConfigPolicyId>(
          map['policyIds']!,
