...
class GetAuthorityConfigX509Config {
  ...
  factory GetAuthorityConfigX509Config.fromMap(Map<String, dynamic> map) {
    return GetAuthorityConfigX509Config(
      additionalExtensions: (pulumi.Input.decodeList<GetAuthorityConfigX509ConfigAdditionalExtension>(map['additionalExtensions'], (value) => GetAuthorityConfigX509ConfigAdditionalExtension.fromMap((value as Map).cast<String, dynamic>()))).input(),
      aiaOcspServers: ((map['aiaOcspServers'] as List).cast<String>()).input(),
      caOptions: (pulumi.Input.decodeList<GetAuthorityConfigX509ConfigCaOption>(map['caOptions'], (value) => GetAuthorityConfigX509ConfigCaOption.fromMap((value as Map).cast<String, dynamic>()))).input(),
      keyUsages: (pulumi.Input.decodeList<GetAuthorityConfigX509ConfigKeyUsage>(map['keyUsages'], (value) => GetAuthorityConfigX509ConfigKeyUsage.fromMap((value as Map).cast<String, dynamic>()))).input(),
      nameConstraints: (pulumi.Input.decodeList<GetAuthorityConfigX509ConfigNameConstraint>(map['nameConstraints'], (value) => GetAuthorityConfigX509ConfigNameConstraint.fromMap((value as Map).cast<String, dynamic>()))).input(),
      policyIds: (pulumi.Input.decodeList<GetAuthorityConfigX509ConfigPolicyId>(map['policyIds'], (value) => GetAuthorityConfigX509ConfigPolicyId.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
