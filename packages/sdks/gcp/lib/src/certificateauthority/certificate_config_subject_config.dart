...
class CertificateConfigSubjectConfig {
  ...
  factory CertificateConfigSubjectConfig.fromMap(Map<String, dynamic> map) {
    return CertificateConfigSubjectConfig(
      subject: pulumi.Input.fromValue(CertificateConfigSubjectConfigSubject.fromMap((map['subject']! as Map).cast<String, dynamic>())),
      subjectAltName: (() { final guardedValue = map['subjectAltName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CertificateConfigSubjectConfigSubjectAltName.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
