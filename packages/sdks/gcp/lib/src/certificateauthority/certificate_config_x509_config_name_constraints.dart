...
class CertificateConfigX509ConfigNameConstraints {
  ...
  /// Creates a new [CertificateConfigX509ConfigNameConstraints].
  ...
  factory CertificateConfigX509ConfigNameConstraints.fromMap(Map<String, dynamic> map) {
    return CertificateConfigX509ConfigNameConstraints(
      critical: pulumi.Input.fromValue(map['critical'] as bool),
      excludedDnsNames: (() { final guardedValue = map['excludedDnsNames']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      excludedEmailAddresses: (() { final guardedValue = map['excludedEmailAddresses']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      excludedIpRanges: (() { final guardedValue = map['excludedIpRanges']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      excludedUris: (() { final guardedValue = map['excludedUris']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      permittedDnsNames: (() { final guardedValue = map['permittedDnsNames']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      permittedEmailAddresses: (() { final guardedValue = map['permittedEmailAddresses']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      permittedIpRanges: (() { final guardedValue = map['permittedIpRanges']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      permittedUris: (() { final guardedValue = map['permittedUris']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
    );
  }
}
