...
class GetAuthorityConfigSubjectConfig {
  ...
  factory GetAuthorityConfigSubjectConfig.fromMap(Map<String, dynamic> map) {
    return GetAuthorityConfigSubjectConfig(
      subjectAltNames: pulumi.Input.fromValue(pulumi.Input.decodeList<GetAuthorityConfigSubjectConfigSubjectAltName>(map['subjectAltNames']!, (value) => GetAuthorityConfigSubjectConfigSubjectAltName.fromMap((value as Map).cast<String, dynamic>()))),
      subjects: pulumi.Input.fromValue(pulumi.Input.decodeList<GetAuthorityConfigSubjectConfigSubject>(map['subjects']!, (value) => GetAuthorityConfigSubjectConfigSubject.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
