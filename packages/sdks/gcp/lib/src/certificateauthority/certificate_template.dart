...
import 'certificate_template_state.dart';
...
class CertificateTemplate extends pulumi.CustomResource {
  ...
  /// Gets an existing [CertificateTemplate] resource's state with the given [name] and [id].
  static CertificateTemplate get(
    String name,
