...
class CaPoolIssuancePolicyBaselineValues {
  ...
  final pulumi.Input<
    List<CaPoolIssuancePolicyBaselineValuesAdditionalExtension>
  >?
  ...
  /// Structure is documented below.
  final pulumi.Input<CaPoolIssuancePolicyBaselineValuesNameConstraints>?
  nameConstraints;

  /// Describes the X.509 certificate policy object identifiers, per https://tools.ietf.org/html/rfc5280#section-4.2.1.4.
  /// Structure is documented below.
  final pulumi.Input<List<CaPoolIssuancePolicyBaselineValuesPolicyId>>?
  policyIds;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'policyIds':
          ?pulumi.Input.mapOptionalInputValue<
            List<CaPoolIssuancePolicyBaselineValuesPolicyId>,
            List<Map<String, dynamic>>
          >(
            policyIds,
            (value) =>
  ...
  factory CaPoolIssuancePolicyBaselineValues.fromMap(Map<String, dynamic> map) {
    return CaPoolIssuancePolicyBaselineValues(
      ...
      caOptions: pulumi.Input.fromValue(
        CaPoolIssuancePolicyBaselineValuesCaOptions.fromMap(
          (map['caOptions']! as Map).cast<String, dynamic>(),
        ),
      ),
      keyUsage: pulumi.Input.fromValue(
        CaPoolIssuancePolicyBaselineValuesKeyUsage.fromMap(
