...
class CaPoolIssuancePolicyBaselineValues {
  ...
  factory CaPoolIssuancePolicyBaselineValues.fromMap(Map<String, dynamic> map) {
    return CaPoolIssuancePolicyBaselineValues(
      additionalExtensions: (() { final guardedValue = map['additionalExtensions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<CaPoolIssuancePolicyBaselineValuesAdditionalExtension>(guardedValue, (value) => CaPoolIssuancePolicyBaselineValuesAdditionalExtension.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      caOptions: pulumi.Input.fromValue(CaPoolIssuancePolicyBaselineValuesCaOptions.fromMap((map['caOptions']! as Map).cast<String, dynamic>())),
      keyUsage: pulumi.Input.fromValue(CaPoolIssuancePolicyBaselineValuesKeyUsage.fromMap((map['keyUsage']! as Map).cast<String, dynamic>())),
      nameConstraints: (() { final guardedValue = map['nameConstraints']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CaPoolIssuancePolicyBaselineValuesNameConstraints.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      policyIds: (() { final guardedValue = map['policyIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<CaPoolIssuancePolicyBaselineValuesPolicyId>(guardedValue, (value) => CaPoolIssuancePolicyBaselineValuesPolicyId.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
