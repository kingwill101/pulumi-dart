...
class UserPasswordPolicy {
  ...
  factory UserPasswordPolicy.fromMap(Map<String, dynamic> map) {
    return UserPasswordPolicy(
      allowedFailedAttempts: (() { final guardedValue = map['allowedFailedAttempts']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      ...
      statuses: (() { final guardedValue = map['statuses']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<UserPasswordPolicyStatus>(guardedValue, (value) => UserPasswordPolicyStatus.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
