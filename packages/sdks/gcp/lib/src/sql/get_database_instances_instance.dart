...
class GetDatabaseInstancesInstance {
  ...
  final pulumi.Input<
    List<GetDatabaseInstancesInstancePointInTimeRestoreContext>
  >
  ...
  final pulumi.Input<List<GetDatabaseInstancesInstanceReplicaConfiguration>>
  ...
  final pulumi.Input<List<GetDatabaseInstancesInstanceReplicationCluster>>
  replicationClusters;
  final pulumi.Input<List<GetDatabaseInstancesInstanceRestoreBackupContext>>
  ...
  final pulumi.Input<List<GetDatabaseInstancesInstanceServerCaCert>>
  serverCaCerts;
    ...
    return <String, dynamic>{
      ...
      'clones':
          pulumi.Input.mapInputValue<
            List<GetDatabaseInstancesInstanceClone>,
      ...
      'dnsNames':
          pulumi.Input.mapInputValue<
            List<GetDatabaseInstancesInstanceDnsName>,
            List<Map<String, dynamic>>
          >(
            dnsNames,
            (value) =>
      ...
      'ipAddresses':
          pulumi.Input.mapInputValue<
            List<GetDatabaseInstancesInstanceIpAddress>,
            List<Map<String, dynamic>>
          >(
            ipAddresses,
            (value) =>
      ...
      'replicaConfigurations':
          pulumi.Input.mapInputValue<
            List<GetDatabaseInstancesInstanceReplicaConfiguration>,
            List<Map<String, dynamic>>
          >(
            replicaConfigurations,
            (value) =>
      ...
      'replicationClusters':
          pulumi.Input.mapInputValue<
            List<GetDatabaseInstancesInstanceReplicationCluster>,
            List<Map<String, dynamic>>
          >(
            replicationClusters,
            (value) =>
      ...
      'restoreBackupContexts':
          pulumi.Input.mapInputValue<
            List<GetDatabaseInstancesInstanceRestoreBackupContext>,
            List<Map<String, dynamic>>
          >(
            restoreBackupContexts,
            (value) =>
      ...
      'serverCaCerts':
          pulumi.Input.mapInputValue<
            List<GetDatabaseInstancesInstanceServerCaCert>,
            List<Map<String, dynamic>>
          >(
            serverCaCerts,
            (value) =>
      ...
      'settings':
          pulumi.Input.mapInputValue<
            List<GetDatabaseInstancesInstanceSetting>,
            List<Map<String, dynamic>>
          >(
            settings,
            (value) =>
  ...
  factory GetDatabaseInstancesInstance.fromMap(Map<String, dynamic> map) {
    return GetDatabaseInstancesInstance(
      availableMaintenanceVersions: pulumi.Input.fromValue(
        (map['availableMaintenanceVersions'] as List).cast<String>(),
      ),
      backupdrBackup: pulumi.Input.fromValue(map['backupdrBackup'] as String),
      clones: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetDatabaseInstancesInstanceClone>(
          map['clones']!,
      ...
      dnsNames: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetDatabaseInstancesInstanceDnsName>(
          map['dnsNames']!,
      ...
      finalBackupDescription: pulumi.Input.fromValue(
      ...
      maintenanceVersion: pulumi.Input.fromValue(
        map['maintenanceVersion'] as String,
      ),
      masterInstanceName: pulumi.Input.fromValue(
        map['masterInstanceName'] as String,
      ),
      name: pulumi.Input.fromValue(map['name'] as String),
      nodeCount: pulumi.Input.fromValue(map['nodeCount'] as int),
      pointInTimeRestoreContexts: pulumi.Input.fromValue(
      ...
      pscServiceAttachmentLink: pulumi.Input.fromValue(
        map['pscServiceAttachmentLink'] as String,
      ),
      publicIpAddress: pulumi.Input.fromValue(map['publicIpAddress'] as String),
      region: pulumi.Input.fromValue(map['region'] as String),
      replicaConfigurations: pulumi.Input.fromValue(
        pulumi
      ...
      replicaNames: pulumi.Input.fromValue(
        (map['replicaNames'] as List).cast<String>(),
      ),
      replicationClusters: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetDatabaseInstancesInstanceReplicationCluster>(
      ...
      restoreBackupContexts: pulumi.Input.fromValue(
        pulumi
      ...
      serviceAccountEmailAddress: pulumi.Input.fromValue(
        map['serviceAccountEmailAddress'] as String,
      ),
      settings: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetDatabaseInstancesInstanceSetting>(
          map['settings']!,
