...
class GetDatabaseInstancesInstance {
  ...
  factory GetDatabaseInstancesInstance.fromMap(Map<String, dynamic> map) {
    return GetDatabaseInstancesInstance(
      availableMaintenanceVersions: ((map['availableMaintenanceVersions'] as List).cast<String>()).input(),
      backupdrBackup: (map['backupdrBackup'] as String).input(),
      clones: (pulumi.Input.decodeList<GetDatabaseInstancesInstanceClone>(map['clones'], (value) => GetDatabaseInstancesInstanceClone.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      dnsNames: (pulumi.Input.decodeList<GetDatabaseInstancesInstanceDnsName>(map['dnsNames'], (value) => GetDatabaseInstancesInstanceDnsName.fromMap((value as Map).cast<String, dynamic>()))).input(),
      encryptionKeyName: (map['encryptionKeyName'] as String).input(),
      finalBackupDescription: (map['finalBackupDescription'] as String).input(),
      firstIpAddress: (map['firstIpAddress'] as String).input(),
      instanceType: (map['instanceType'] as String).input(),
      ipAddresses: (pulumi.Input.decodeList<GetDatabaseInstancesInstanceIpAddress>(map['ipAddresses'], (value) => GetDatabaseInstancesInstanceIpAddress.fromMap((value as Map).cast<String, dynamic>()))).input(),
      maintenanceVersion: (map['maintenanceVersion'] as String).input(),
      masterInstanceName: (map['masterInstanceName'] as String).input(),
      name: (map['name'] as String).input(),
      nodeCount: (map['nodeCount'] as int).input(),
      pointInTimeRestoreContexts: (pulumi.Input.decodeList<GetDatabaseInstancesInstancePointInTimeRestoreContext>(map['pointInTimeRestoreContexts'], (value) => GetDatabaseInstancesInstancePointInTimeRestoreContext.fromMap((value as Map).cast<String, dynamic>()))).input(),
      privateIpAddress: (map['privateIpAddress'] as String).input(),
      project: (map['project'] as String).input(),
      pscServiceAttachmentLink: (map['pscServiceAttachmentLink'] as String).input(),
      publicIpAddress: (map['publicIpAddress'] as String).input(),
      region: (map['region'] as String).input(),
      replicaConfigurations: (pulumi.Input.decodeList<GetDatabaseInstancesInstanceReplicaConfiguration>(map['replicaConfigurations'], (value) => GetDatabaseInstancesInstanceReplicaConfiguration.fromMap((value as Map).cast<String, dynamic>()))).input(),
      replicaNames: ((map['replicaNames'] as List).cast<String>()).input(),
      replicationClusters: (pulumi.Input.decodeList<GetDatabaseInstancesInstanceReplicationCluster>(map['replicationClusters'], (value) => GetDatabaseInstancesInstanceReplicationCluster.fromMap((value as Map).cast<String, dynamic>()))).input(),
      restoreBackupContexts: (pulumi.Input.decodeList<GetDatabaseInstancesInstanceRestoreBackupContext>(map['restoreBackupContexts'], (value) => GetDatabaseInstancesInstanceRestoreBackupContext.fromMap((value as Map).cast<String, dynamic>()))).input(),
      rootPassword: (map['rootPassword'] as String).input(),
      rootPasswordWo: (map['rootPasswordWo'] as String).input(),
      rootPasswordWoVersion: (map['rootPasswordWoVersion'] as String).input(),
      selfLink: (map['selfLink'] as String).input(),
      serverCaCerts: (pulumi.Input.decodeList<GetDatabaseInstancesInstanceServerCaCert>(map['serverCaCerts'], (value) => GetDatabaseInstancesInstanceServerCaCert.fromMap((value as Map).cast<String, dynamic>()))).input(),
      serviceAccountEmailAddress: (map['serviceAccountEmailAddress'] as String).input(),
      settings: (pulumi.Input.decodeList<GetDatabaseInstancesInstanceSetting>(map['settings'], (value) => GetDatabaseInstancesInstanceSetting.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
