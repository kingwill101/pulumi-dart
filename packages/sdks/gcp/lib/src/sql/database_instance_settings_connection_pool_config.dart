...
class DatabaseInstanceSettingsConnectionPoolConfig {
  ...
  final pulumi.Input<List<DatabaseInstanceSettingsConnectionPoolConfigFlag>>?
  flags;
    ...
    return <String, dynamic>{
      ...
      'flags':
          ?pulumi.Input.mapOptionalInputValue<
            List<DatabaseInstanceSettingsConnectionPoolConfigFlag>,
  ...
  factory DatabaseInstanceSettingsConnectionPoolConfig.fromMap(
    ...
    return DatabaseInstanceSettingsConnectionPoolConfig(
      connectionPoolingEnabled: (() {
        final guardedValue = map['connectionPoolingEnabled'];
      ...
      flags: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => DatabaseInstanceSettingsConnectionPoolConfigFlag.fromMap(
