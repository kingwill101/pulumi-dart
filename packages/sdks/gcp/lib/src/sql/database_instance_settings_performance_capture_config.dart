...
class DatabaseInstanceSettingsPerformanceCaptureConfig {
  ...
  factory DatabaseInstanceSettingsPerformanceCaptureConfig.fromMap(Map<String, dynamic> map) {
    return DatabaseInstanceSettingsPerformanceCaptureConfig(
      cpuUtilizationThresholdPercent: (() { final guardedValue = map['cpuUtilizationThresholdPercent']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      enabled: (() { final guardedValue = map['enabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      historyListLengthThresholdCount: (() { final guardedValue = map['historyListLengthThresholdCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      memoryUsageThresholdPercent: (() { final guardedValue = map['memoryUsageThresholdPercent']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      probingIntervalSeconds: (() { final guardedValue = map['probingIntervalSeconds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      runningThreadsThreshold: (() { final guardedValue = map['runningThreadsThreshold']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      secondsBehindSourceThreshold: (() { final guardedValue = map['secondsBehindSourceThreshold']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      semaphoreWaitThresholdCount: (() { final guardedValue = map['semaphoreWaitThresholdCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      transactionDurationThreshold: (() { final guardedValue = map['transactionDurationThreshold']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      transactionKillThresholdSeconds: (() { final guardedValue = map['transactionKillThresholdSeconds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      transactionLockWaitThresholdCount: (() { final guardedValue = map['transactionLockWaitThresholdCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
    );
  }
}
