...
class DatabaseInstanceReplicationCluster {
  ...
  factory DatabaseInstanceReplicationCluster.fromMap(Map<String, dynamic> map) {
    return DatabaseInstanceReplicationCluster(
      ...
      failoverDrReplicaName: map['failoverDrReplicaName'] == null ? null : map['failoverDrReplicaName'] as String,
      psaWriteEndpoint: map['psaWriteEndpoint'] == null ? null : map['psaWriteEndpoint'] as String,
    );
  }
}
