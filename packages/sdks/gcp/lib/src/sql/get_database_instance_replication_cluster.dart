...
class GetDatabaseInstanceReplicationCluster {
  ...
  factory GetDatabaseInstanceReplicationCluster.fromMap(Map<String, dynamic> map) {
    return GetDatabaseInstanceReplicationCluster(
      drReplica: (map['drReplica'] as bool).input(),
      failoverDrReplicaName: (map['failoverDrReplicaName'] as String).input(),
      psaWriteEndpoint: (map['psaWriteEndpoint'] as String).input(),
    );
  }
}
