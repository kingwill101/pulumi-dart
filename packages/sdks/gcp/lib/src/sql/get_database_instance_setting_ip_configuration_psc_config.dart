...
class GetDatabaseInstanceSettingIpConfigurationPscConfig {
  ...
  factory GetDatabaseInstanceSettingIpConfigurationPscConfig.fromMap(Map<String, dynamic> map) {
    return GetDatabaseInstanceSettingIpConfigurationPscConfig(
      ...
      pscAutoConnections: (pulumi.Input.decodeList<GetDatabaseInstanceSettingIpConfigurationPscConfigPscAutoConnection>(map['pscAutoConnections'], (value) => GetDatabaseInstanceSettingIpConfigurationPscConfigPscAutoConnection.fromMap((value as Map).cast<String, dynamic>()))).input(),
