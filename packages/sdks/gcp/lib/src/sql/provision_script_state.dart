...
class ProvisionScriptState {
  ...
  /// Creates a new [ProvisionScriptState].
  ...
  factory ProvisionScriptState.fromMap(Map<String, dynamic> map) {
    return ProvisionScriptState(
