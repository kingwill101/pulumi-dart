...
class DatabaseInstanceState {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ipAddresses':
          ?pulumi.Input.mapOptionalInputValue<
            List<DatabaseInstanceIpAddress>,
            List<Map<String, dynamic>>
          >(
            ipAddresses,
            (value) =>
      ...
      'serverCaCerts':
          ?pulumi.Input.mapOptionalInputValue<
            List<DatabaseInstanceServerCaCert>,
            List<Map<String, dynamic>>
          >(
            serverCaCerts,
            (value) =>
  ...
  factory DatabaseInstanceState.fromMap(Map<String, dynamic> map) {
    return DatabaseInstanceState(
      ...
      dnsNames: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DatabaseInstanceDnsName>(
            guardedValue,
            (value) => DatabaseInstanceDnsName.fromMap(
      ...
      firstIpAddress: (() {
        final guardedValue = map['firstIpAddress'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      instanceType: (() {
      ...
      ipAddresses: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DatabaseInstanceIpAddress>(
            guardedValue,
            (value) => DatabaseInstanceIpAddress.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      pscServiceAttachmentLink: (() {
        final guardedValue = map['pscServiceAttachmentLink'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      publicIpAddress: (() {
      ...
      serverCaCerts: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DatabaseInstanceServerCaCert>(
            guardedValue,
            (value) => DatabaseInstanceServerCaCert.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
