...
class GetDatabaseInstancesInstanceReplicaConfiguration {
  ...
  /// Creates a new [GetDatabaseInstancesInstanceReplicaConfiguration].
  ...
  factory GetDatabaseInstancesInstanceReplicaConfiguration.fromMap(Map<String, dynamic> map) {
    return GetDatabaseInstancesInstanceReplicaConfiguration(
      ...
      connectRetryInterval: pulumi.Input.fromValue((map['connectRetryInterval'] as num).toInt()),
      ...
      masterHeartbeatPeriod: pulumi.Input.fromValue((map['masterHeartbeatPeriod'] as num).toInt()),
