...
class GetDatabaseInstanceSettingIpConfiguration {
  ...
  final pulumi.Input<
    List<GetDatabaseInstanceSettingIpConfigurationAuthorizedNetwork>
  >
  authorizedNetworks;
  ...
  final pulumi.Input<List<GetDatabaseInstanceSettingIpConfigurationPscConfig>>
  pscConfigs;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'pscConfigs':
          pulumi.Input.mapInputValue<
            List<GetDatabaseInstanceSettingIpConfigurationPscConfig>,
            List<Map<String, dynamic>>
          >(
            pscConfigs,
            (value) =>
    ...
    return GetDatabaseInstanceSettingIpConfiguration(
      ...
      authorizedNetworks: pulumi.Input.fromValue(
        ...
        >(
          ...
          (value) =>
              GetDatabaseInstanceSettingIpConfigurationAuthorizedNetwork.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
      customSubjectAlternativeNames: pulumi.Input.fromValue(
