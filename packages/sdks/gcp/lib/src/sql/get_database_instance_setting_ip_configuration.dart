...
class GetDatabaseInstanceSettingIpConfiguration {
  ...
  factory GetDatabaseInstanceSettingIpConfiguration.fromMap(Map<String, dynamic> map) {
    return GetDatabaseInstanceSettingIpConfiguration(
      ...
      authorizedNetworks: pulumi.Input.fromValue(pulumi.Input.decodeList<GetDatabaseInstanceSettingIpConfigurationAuthorizedNetwork>(map['authorizedNetworks']!, (value) => GetDatabaseInstanceSettingIpConfigurationAuthorizedNetwork.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      pscConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetDatabaseInstanceSettingIpConfigurationPscConfig>(map['pscConfigs']!, (value) => GetDatabaseInstanceSettingIpConfigurationPscConfig.fromMap((value as Map).cast<String, dynamic>()))),
