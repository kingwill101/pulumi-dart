...
class DatabaseInstanceSettingsIpConfiguration {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'authorizedNetworks': ?pulumi.Input.mapOptionalInputValue<List<DatabaseInstanceSettingsIpConfigurationAuthorizedNetwork>, List<Map<String, dynamic>>>(authorizedNetworks, (value) => pulumi.Input.encodeList<DatabaseInstanceSettingsIpConfigurationAuthorizedNetwork, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory DatabaseInstanceSettingsIpConfiguration.fromMap(Map<String, dynamic> map) {
    return DatabaseInstanceSettingsIpConfiguration(
      ...
      authorizedNetworks: (() { final guardedValue = map['authorizedNetworks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DatabaseInstanceSettingsIpConfigurationAuthorizedNetwork>(guardedValue, (value) => DatabaseInstanceSettingsIpConfigurationAuthorizedNetwork.fromMap((value as Map).cast<String, dynamic>()))); })(),
      customSubjectAlternativeNames: (() { final guardedValue = map['customSubjectAlternativeNames']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
