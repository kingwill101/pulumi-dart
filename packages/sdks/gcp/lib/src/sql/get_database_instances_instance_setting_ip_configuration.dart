...
class GetDatabaseInstancesInstanceSettingIpConfiguration {
  ...
  final List<GetDatabaseInstancesInstanceSettingIpConfigurationAuthorizedNetwork> authorizedNetworks;
  ...
  final List<GetDatabaseInstancesInstanceSettingIpConfigurationPscConfig> pscConfigs;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'authorizedNetworks': pulumi.Input.encodeList<GetDatabaseInstancesInstanceSettingIpConfigurationAuthorizedNetwork, Map<String, dynamic>>(authorizedNetworks, (value) => value.toMap()),
      ...
      'pscConfigs': pulumi.Input.encodeList<GetDatabaseInstancesInstanceSettingIpConfigurationPscConfig, Map<String, dynamic>>(pscConfigs, (value) => value.toMap()),
  ...
  factory GetDatabaseInstancesInstanceSettingIpConfiguration.fromMap(Map<String, dynamic> map) {
    return GetDatabaseInstancesInstanceSettingIpConfiguration(
      ...
      authorizedNetworks: pulumi.Input.decodeList<GetDatabaseInstancesInstanceSettingIpConfigurationAuthorizedNetwork>(map['authorizedNetworks'], (value) => GetDatabaseInstancesInstanceSettingIpConfigurationAuthorizedNetwork.fromMap((value as Map).cast<String, dynamic>())),
      customSubjectAlternativeNames: (map['customSubjectAlternativeNames'] as List).cast<String>(),
      enablePrivatePathForGoogleCloudServices: map['enablePrivatePathForGoogleCloudServices'] as bool,
      ipv4Enabled: map['ipv4Enabled'] as bool,
      privateNetwork: map['privateNetwork'] as String,
      pscConfigs: pulumi.Input.decodeList<GetDatabaseInstancesInstanceSettingIpConfigurationPscConfig>(map['pscConfigs'], (value) => GetDatabaseInstancesInstanceSettingIpConfigurationPscConfig.fromMap((value as Map).cast<String, dynamic>())),
