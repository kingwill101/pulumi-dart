...
class GetDatabaseInstanceSettingPerformanceCaptureConfig {
  ...
  /// Creates a new [GetDatabaseInstanceSettingPerformanceCaptureConfig].
  ...
  const GetDatabaseInstanceSettingPerformanceCaptureConfig({
