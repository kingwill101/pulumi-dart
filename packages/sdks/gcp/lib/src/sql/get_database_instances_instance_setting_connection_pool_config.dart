...
class GetDatabaseInstancesInstanceSettingConnectionPoolConfig {
  ...
  final pulumi.Input<
    List<GetDatabaseInstancesInstanceSettingConnectionPoolConfigFlag>
  >
  flags;
  ...
  factory GetDatabaseInstancesInstanceSettingConnectionPoolConfig.fromMap(
    ...
    return GetDatabaseInstancesInstanceSettingConnectionPoolConfig(
      connectionPoolingEnabled: pulumi.Input.fromValue(
      ...
      flags: pulumi.Input.fromValue(
        ...
        >(
          map['flags']!,
          (value) =>
              GetDatabaseInstancesInstanceSettingConnectionPoolConfigFlag.fromMap(
