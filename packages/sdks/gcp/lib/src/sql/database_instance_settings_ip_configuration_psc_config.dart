...
class DatabaseInstanceSettingsIpConfigurationPscConfig {
  ...
  final pulumi.Input<
    List<DatabaseInstanceSettingsIpConfigurationPscConfigPscAutoConnection>
  >?
  pscAutoConnections;
  ...
  factory DatabaseInstanceSettingsIpConfigurationPscConfig.fromMap(
    ...
    return DatabaseInstanceSettingsIpConfigurationPscConfig(
      ...
      networkAttachmentUri: (() {
        final guardedValue = map['networkAttachmentUri'];
        if (guardedValue == null) return null;
      ...
      pscAutoConnections: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                DatabaseInstanceSettingsIpConfigurationPscConfigPscAutoConnection.fromMap(
