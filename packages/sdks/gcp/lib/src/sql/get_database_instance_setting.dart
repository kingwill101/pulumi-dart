...
class GetDatabaseInstanceSetting {
  ...
  factory GetDatabaseInstanceSetting.fromMap(Map<String, dynamic> map) {
    return GetDatabaseInstanceSetting(
      ...
      activeDirectoryConfigs: (pulumi.Input.decodeList<GetDatabaseInstanceSettingActiveDirectoryConfig>(map['activeDirectoryConfigs'], (value) => GetDatabaseInstanceSettingActiveDirectoryConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
      advancedMachineFeatures: (pulumi.Input.decodeList<GetDatabaseInstanceSettingAdvancedMachineFeature>(map['advancedMachineFeatures'], (value) => GetDatabaseInstanceSettingAdvancedMachineFeature.fromMap((value as Map).cast<String, dynamic>()))).input(),
      availabilityType: (map['availabilityType'] as String).input(),
      backupConfigurations: (pulumi.Input.decodeList<GetDatabaseInstanceSettingBackupConfiguration>(map['backupConfigurations'], (value) => GetDatabaseInstanceSettingBackupConfiguration.fromMap((value as Map).cast<String, dynamic>()))).input(),
      collation: (map['collation'] as String).input(),
      connectionPoolConfigs: (pulumi.Input.decodeList<GetDatabaseInstanceSettingConnectionPoolConfig>(map['connectionPoolConfigs'], (value) => GetDatabaseInstanceSettingConnectionPoolConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
      connectorEnforcement: (map['connectorEnforcement'] as String).input(),
      dataCacheConfigs: (pulumi.Input.decodeList<GetDatabaseInstanceSettingDataCacheConfig>(map['dataCacheConfigs'], (value) => GetDatabaseInstanceSettingDataCacheConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
      dataDiskProvisionedIops: (map['dataDiskProvisionedIops'] as int).input(),
      dataDiskProvisionedThroughput: (map['dataDiskProvisionedThroughput'] as int).input(),
      databaseFlags: (pulumi.Input.decodeList<GetDatabaseInstanceSettingDatabaseFlag>(map['databaseFlags'], (value) => GetDatabaseInstanceSettingDatabaseFlag.fromMap((value as Map).cast<String, dynamic>()))).input(),
      deletionProtectionEnabled: (map['deletionProtectionEnabled'] as bool).input(),
      denyMaintenancePeriods: (pulumi.Input.decodeList<GetDatabaseInstanceSettingDenyMaintenancePeriod>(map['denyMaintenancePeriods'], (value) => GetDatabaseInstanceSettingDenyMaintenancePeriod.fromMap((value as Map).cast<String, dynamic>()))).input(),
      diskAutoresize: (map['diskAutoresize'] as bool).input(),
      diskAutoresizeLimit: (map['diskAutoresizeLimit'] as int).input(),
      diskSize: (map['diskSize'] as int).input(),
      diskType: (map['diskType'] as String).input(),
      edition: (map['edition'] as String).input(),
      effectiveAvailabilityType: (map['effectiveAvailabilityType'] as String).input(),
      enableDataplexIntegration: (map['enableDataplexIntegration'] as bool).input(),
      enableGoogleMlIntegration: (map['enableGoogleMlIntegration'] as bool).input(),
      finalBackupConfigs: (pulumi.Input.decodeList<GetDatabaseInstanceSettingFinalBackupConfig>(map['finalBackupConfigs'], (value) => GetDatabaseInstanceSettingFinalBackupConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
      insightsConfigs: (pulumi.Input.decodeList<GetDatabaseInstanceSettingInsightsConfig>(map['insightsConfigs'], (value) => GetDatabaseInstanceSettingInsightsConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ipConfigurations: (pulumi.Input.decodeList<GetDatabaseInstanceSettingIpConfiguration>(map['ipConfigurations'], (value) => GetDatabaseInstanceSettingIpConfiguration.fromMap((value as Map).cast<String, dynamic>()))).input(),
      locationPreferences: (pulumi.Input.decodeList<GetDatabaseInstanceSettingLocationPreference>(map['locationPreferences'], (value) => GetDatabaseInstanceSettingLocationPreference.fromMap((value as Map).cast<String, dynamic>()))).input(),
      maintenanceWindows: (pulumi.Input.decodeList<GetDatabaseInstanceSettingMaintenanceWindow>(map['maintenanceWindows'], (value) => GetDatabaseInstanceSettingMaintenanceWindow.fromMap((value as Map).cast<String, dynamic>()))).input(),
      passwordValidationPolicies: (pulumi.Input.decodeList<GetDatabaseInstanceSettingPasswordValidationPolicy>(map['passwordValidationPolicies'], (value) => GetDatabaseInstanceSettingPasswordValidationPolicy.fromMap((value as Map).cast<String, dynamic>()))).input(),
      pricingPlan: (map['pricingPlan'] as String).input(),
      readPoolAutoScaleConfigs: (pulumi.Input.decodeList<GetDatabaseInstanceSettingReadPoolAutoScaleConfig>(map['readPoolAutoScaleConfigs'], (value) => GetDatabaseInstanceSettingReadPoolAutoScaleConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
      retainBackupsOnDelete: (map['retainBackupsOnDelete'] as bool).input(),
      sqlServerAuditConfigs: (pulumi.Input.decodeList<GetDatabaseInstanceSettingSqlServerAuditConfig>(map['sqlServerAuditConfigs'], (value) => GetDatabaseInstanceSettingSqlServerAuditConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
