...
class GetDatabaseInstanceSetting {
  ...
  final pulumi.Input<List<GetDatabaseInstanceSettingActiveDirectoryConfig>>
  activeDirectoryConfigs;
  final pulumi.Input<List<GetDatabaseInstanceSettingAdvancedMachineFeature>>
  ...
  final pulumi.Input<List<GetDatabaseInstanceSettingBackupConfiguration>>
  ...
  final pulumi.Input<List<GetDatabaseInstanceSettingConnectionPoolConfig>>
  ...
  final pulumi.Input<List<GetDatabaseInstanceSettingDataCacheConfig>>
  dataCacheConfigs;
  ...
  final pulumi.Input<List<GetDatabaseInstanceSettingDatabaseFlag>>
  databaseFlags;

  /// Configuration to protect against accidental instance deletion.
  final pulumi.Input<bool> deletionProtectionEnabled;
  final pulumi.Input<List<GetDatabaseInstanceSettingDenyMaintenancePeriod>>
  ...
  final pulumi.Input<List<GetDatabaseInstanceSettingFinalBackupConfig>>
  finalBackupConfigs;

  /// Configuration of Query Insights.
  final pulumi.Input<List<GetDatabaseInstanceSettingInsightsConfig>>
  insightsConfigs;
  final pulumi.Input<List<GetDatabaseInstanceSettingIpConfiguration>>
  ipConfigurations;
  final pulumi.Input<List<GetDatabaseInstanceSettingLocationPreference>>
  locationPreferences;

  /// Declares a one-hour maintenance window when an Instance can automatically restart to apply updates. The maintenance window is specified in UTC time.
  final pulumi.Input<List<GetDatabaseInstanceSettingMaintenanceWindow>>
  maintenanceWindows;
  final pulumi.Input<List<GetDatabaseInstanceSettingPasswordValidationPolicy>>
  ...
  final pulumi.Input<List<GetDatabaseInstanceSettingReadPoolAutoScaleConfig>>
  ...
  final pulumi.Input<List<GetDatabaseInstanceSettingSqlServerAuditConfig>>
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'advancedMachineFeatures':
          pulumi.Input.mapInputValue<
            List<GetDatabaseInstanceSettingAdvancedMachineFeature>,
            List<Map<String, dynamic>>
          >(
            advancedMachineFeatures,
            (value) =>
      ...
      'backupConfigurations':
          pulumi.Input.mapInputValue<
            List<GetDatabaseInstanceSettingBackupConfiguration>,
            List<Map<String, dynamic>>
          >(
            backupConfigurations,
            (value) =>
      ...
      'connectionPoolConfigs':
          pulumi.Input.mapInputValue<
            List<GetDatabaseInstanceSettingConnectionPoolConfig>,
            List<Map<String, dynamic>>
          >(
            connectionPoolConfigs,
            (value) =>
      ...
      'dataCacheConfigs':
          pulumi.Input.mapInputValue<
            List<GetDatabaseInstanceSettingDataCacheConfig>,
            List<Map<String, dynamic>>
          >(
            dataCacheConfigs,
            (value) =>
      ...
      'databaseFlags':
          pulumi.Input.mapInputValue<
            List<GetDatabaseInstanceSettingDatabaseFlag>,
            List<Map<String, dynamic>>
          >(
            databaseFlags,
            (value) =>
      ...
      'denyMaintenancePeriods':
          pulumi.Input.mapInputValue<
            List<GetDatabaseInstanceSettingDenyMaintenancePeriod>,
            List<Map<String, dynamic>>
          >(
            denyMaintenancePeriods,
            (value) =>
      ...
      'finalBackupConfigs':
          pulumi.Input.mapInputValue<
            List<GetDatabaseInstanceSettingFinalBackupConfig>,
            List<Map<String, dynamic>>
          >(
            finalBackupConfigs,
            (value) =>
      ...
      'insightsConfigs':
          pulumi.Input.mapInputValue<
            List<GetDatabaseInstanceSettingInsightsConfig>,
            List<Map<String, dynamic>>
          >(
            insightsConfigs,
            (value) =>
      ...
      'ipConfigurations':
          pulumi.Input.mapInputValue<
            List<GetDatabaseInstanceSettingIpConfiguration>,
            List<Map<String, dynamic>>
          >(
            ipConfigurations,
            (value) =>
      ...
      'locationPreferences':
          pulumi.Input.mapInputValue<
            List<GetDatabaseInstanceSettingLocationPreference>,
            List<Map<String, dynamic>>
          >(
            locationPreferences,
            (value) =>
      ...
      'maintenanceWindows':
          pulumi.Input.mapInputValue<
            List<GetDatabaseInstanceSettingMaintenanceWindow>,
            List<Map<String, dynamic>>
          >(
            maintenanceWindows,
            (value) =>
      ...
      'passwordValidationPolicies':
          pulumi.Input.mapInputValue<
            List<GetDatabaseInstanceSettingPasswordValidationPolicy>,
            List<Map<String, dynamic>>
          >(
            passwordValidationPolicies,
            (value) =>
      ...
      'readPoolAutoScaleConfigs':
          pulumi.Input.mapInputValue<
            List<GetDatabaseInstanceSettingReadPoolAutoScaleConfig>,
            List<Map<String, dynamic>>
          >(
            readPoolAutoScaleConfigs,
            (value) =>
      ...
      'sqlServerAuditConfigs':
          pulumi.Input.mapInputValue<
            List<GetDatabaseInstanceSettingSqlServerAuditConfig>,
            List<Map<String, dynamic>>
          >(
            sqlServerAuditConfigs,
            (value) =>
  ...
  factory GetDatabaseInstanceSetting.fromMap(Map<String, dynamic> map) {
    return GetDatabaseInstanceSetting(
      ...
      activeDirectoryConfigs: pulumi.Input.fromValue(
        pulumi
      ...
      backupConfigurations: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetDatabaseInstanceSettingBackupConfiguration>(
      ...
      connectionPoolConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetDatabaseInstanceSettingConnectionPoolConfig>(
      ...
      connectorEnforcement: pulumi.Input.fromValue(
        map['connectorEnforcement'] as String,
      ),
      dataCacheConfigs: pulumi.Input.fromValue(
      ...
      dataDiskProvisionedIops: pulumi.Input.fromValue(
        map['dataDiskProvisionedIops'] as int,
      ),
      dataDiskProvisionedThroughput: pulumi.Input.fromValue(
      ...
      deletionProtectionEnabled: pulumi.Input.fromValue(
        map['deletionProtectionEnabled'] as bool,
      ),
      denyMaintenancePeriods: pulumi.Input.fromValue(
        pulumi
      ...
      diskAutoresizeLimit: pulumi.Input.fromValue(
      ...
      effectiveAvailabilityType: pulumi.Input.fromValue(
        map['effectiveAvailabilityType'] as String,
      ),
      enableDataplexIntegration: pulumi.Input.fromValue(
        map['enableDataplexIntegration'] as bool,
      ),
      enableGoogleMlIntegration: pulumi.Input.fromValue(
        map['enableGoogleMlIntegration'] as bool,
      ),
      finalBackupConfigs: pulumi.Input.fromValue(
      ...
      insightsConfigs: pulumi.Input.fromValue(
      ...
      locationPreferences: pulumi.Input.fromValue(
      ...
      passwordValidationPolicies: pulumi.Input.fromValue(
      ...
      readPoolAutoScaleConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetDatabaseInstanceSettingReadPoolAutoScaleConfig
        >(
      ...
      retainBackupsOnDelete: pulumi.Input.fromValue(
        map['retainBackupsOnDelete'] as bool,
      ),
      sqlServerAuditConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetDatabaseInstanceSettingSqlServerAuditConfig>(
