...
class DatabaseInstanceSettingsBackupConfiguration {
  ...
  final pulumi.Input<DatabaseInstanceSettingsBackupConfigurationBackupRetentionSettings?>? backupRetentionSettings;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'backupRetentionSettings': ?pulumi.Input.mapOptionalInputValue<DatabaseInstanceSettingsBackupConfigurationBackupRetentionSettings, Map<String, dynamic>>(backupRetentionSettings, (value) => value.toMap()),
  ...
  factory DatabaseInstanceSettingsBackupConfiguration.fromMap(Map<String, dynamic> map) {
    return DatabaseInstanceSettingsBackupConfiguration(
      backupRetentionSettings: (() { final guardedValue = map['backupRetentionSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DatabaseInstanceSettingsBackupConfigurationBackupRetentionSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      transactionLogRetentionDays: (() { final guardedValue = map['transactionLogRetentionDays']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
    );
  }
}
