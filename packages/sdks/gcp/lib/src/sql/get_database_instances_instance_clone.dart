...
class GetDatabaseInstancesInstanceClone {
  ...
  factory GetDatabaseInstancesInstanceClone.fromMap(Map<String, dynamic> map) {
    return GetDatabaseInstancesInstanceClone(
      ...
      databaseNames: pulumi.Input.fromValue(
      ...
      sourceInstanceDeletionTime: pulumi.Input.fromValue(
        map['sourceInstanceDeletionTime'] as String,
      ),
      sourceInstanceName: pulumi.Input.fromValue(
        map['sourceInstanceName'] as String,
      ),
    );
  }
}
