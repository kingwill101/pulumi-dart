...
class BareMetalClusterLoadBalancer {
  ...
  /// Structure is documented below.
  final pulumi.Input<BareMetalClusterLoadBalancerManualLbConfig>?
  manualLbConfig;
  ...
  factory BareMetalClusterLoadBalancer.fromMap(Map<String, dynamic> map) {
    return BareMetalClusterLoadBalancer(
      ...
      portConfig: pulumi.Input.fromValue(
        BareMetalClusterLoadBalancerPortConfig.fromMap(
          (map['portConfig']! as Map).cast<String, dynamic>(),
        ),
      ),
      vipConfig: pulumi.Input.fromValue(
        BareMetalClusterLoadBalancerVipConfig.fromMap(
