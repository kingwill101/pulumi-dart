...
class BareMetalAdminClusterLoadBalancerBgpLbConfig {
  ...
  final pulumi.Input<
    List<BareMetalAdminClusterLoadBalancerBgpLbConfigAddressPool>
  >?
  addressPools;
  ...
  /// Structure is documented below.
  final pulumi.Input<
    List<BareMetalAdminClusterLoadBalancerBgpLbConfigBgpPeerConfig>
  >?
  bgpPeerConfigs;
  ...
  factory BareMetalAdminClusterLoadBalancerBgpLbConfig.fromMap(
    ...
    return BareMetalAdminClusterLoadBalancerBgpLbConfig(
      addressPools: (() {
        final guardedValue = map['addressPools'];
      ...
      bgpPeerConfigs: (() {
        final guardedValue = map['bgpPeerConfigs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<
            BareMetalAdminClusterLoadBalancerBgpLbConfigBgpPeerConfig
