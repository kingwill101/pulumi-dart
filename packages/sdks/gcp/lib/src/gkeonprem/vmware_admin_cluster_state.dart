...
class VmwareAdminClusterState {
  ...
  factory VmwareAdminClusterState.fromMap(Map<String, dynamic> map) {
    return VmwareAdminClusterState(
      addonNode: (() {
        final guardedValue = map['addonNode'];
      ...
      bootstrapClusterMembership: (() {
        final guardedValue = map['bootstrapClusterMembership'];
        if (guardedValue == null) return null;
      ...
      fleets: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VmwareAdminClusterFleet>(
            guardedValue,
            (value) => VmwareAdminClusterFleet.fromMap(
      ...
      networkConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VmwareAdminClusterNetworkConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      platformConfig: (() {
        final guardedValue = map['platformConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      privateRegistryConfig: (() {
        final guardedValue = map['privateRegistryConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      statuses: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VmwareAdminClusterStatus>(
            guardedValue,
            (value) => VmwareAdminClusterStatus.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
