...
class VmwareAdminClusterAuthorization {
  ...
  final pulumi.Input<List<VmwareAdminClusterAuthorizationViewerUser>>?
  viewerUsers;
  ...
  VmwareAdminClusterAuthorization({this.viewerUsers});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'viewerUsers':
          ?pulumi.Input.mapOptionalInputValue<
            List<VmwareAdminClusterAuthorizationViewerUser>,
  ...
  factory VmwareAdminClusterAuthorization.fromMap(Map<String, dynamic> map) {
    return VmwareAdminClusterAuthorization(
      viewerUsers: (() {
        final guardedValue = map['viewerUsers'];
