...
class VMwareClusterNetworkConfigStaticIpConfig {
  ...
  const VMwareClusterNetworkConfigStaticIpConfig({
  ...
  factory VMwareClusterNetworkConfigStaticIpConfig.fromMap(Map<String, dynamic> map) {
    return VMwareClusterNetworkConfigStaticIpConfig(
      ipBlocks: pulumi.Input.fromValue(pulumi.Input.decodeList<VMwareClusterNetworkConfigStaticIpConfigIpBlock>(map['ipBlocks']!, (value) => VMwareClusterNetworkConfigStaticIpConfigIpBlock.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
