...
class VMwareClusterNetworkConfigControlPlaneV2ConfigControlPlaneIpBlock {
  ...
  factory VMwareClusterNetworkConfigControlPlaneV2ConfigControlPlaneIpBlock.fromMap(Map<String, dynamic> map) {
    return VMwareClusterNetworkConfigControlPlaneV2ConfigControlPlaneIpBlock(
      ...
      ips: (() { final guardedValue = map['ips']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<VMwareClusterNetworkConfigControlPlaneV2ConfigControlPlaneIpBlockIp>(guardedValue, (value) => VMwareClusterNetworkConfigControlPlaneV2ConfigControlPlaneIpBlockIp.fromMap((value as Map).cast<String, dynamic>()))); })(),
