...
class BareMetalClusterValidationCheck {
  ...
  factory BareMetalClusterValidationCheck.fromMap(Map<String, dynamic> map) {
    return BareMetalClusterValidationCheck(
      ...
      statuses: (() { final guardedValue = map['statuses']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<BareMetalClusterValidationCheckStatus>(guardedValue, (value) => BareMetalClusterValidationCheckStatus.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
