...
class VmwareAdminClusterNetworkConfigStaticIpConfigIpBlock {
  ...
  const VmwareAdminClusterNetworkConfigStaticIpConfigIpBlock({
  ...
  factory VmwareAdminClusterNetworkConfigStaticIpConfigIpBlock.fromMap(Map<String, dynamic> map) {
    return VmwareAdminClusterNetworkConfigStaticIpConfigIpBlock(
      ...
      ips: pulumi.Input.fromValue(pulumi.Input.decodeList<VmwareAdminClusterNetworkConfigStaticIpConfigIpBlockIp>(map['ips']!, (value) => VmwareAdminClusterNetworkConfigStaticIpConfigIpBlockIp.fromMap((value as Map).cast<String, dynamic>()))),
