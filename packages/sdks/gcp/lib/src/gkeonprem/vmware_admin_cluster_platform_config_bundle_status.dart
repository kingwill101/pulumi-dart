...
class VmwareAdminClusterPlatformConfigBundleStatus {
  ...
  factory VmwareAdminClusterPlatformConfigBundleStatus.fromMap(Map<String, dynamic> map) {
    return VmwareAdminClusterPlatformConfigBundleStatus(
      conditions: (() { final guardedValue = map['conditions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<VmwareAdminClusterPlatformConfigBundleStatusCondition>(guardedValue, (value) => VmwareAdminClusterPlatformConfigBundleStatusCondition.fromMap((value as Map).cast<String, dynamic>()))); })(),
