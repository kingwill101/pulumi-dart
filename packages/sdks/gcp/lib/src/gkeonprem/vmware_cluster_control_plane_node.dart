...
class VMwareClusterControlPlaneNode {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'memory': ?memory,
      'replicas': ?replicas,
      'vsphereConfigs': ?vsphereConfigs == null ? null : pulumi.Input.encodeList<VMwareClusterControlPlaneNodeVsphereConfig, Map<String, dynamic>>(vsphereConfigs!, (value) => value.toMap()),
    };
  }

  factory VMwareClusterControlPlaneNode.fromMap(Map<String, dynamic> map) {
    return VMwareClusterControlPlaneNode(
      autoResizeConfig: map['autoResizeConfig'] == null ? null : VMwareClusterControlPlaneNodeAutoResizeConfig.fromMap((map['autoResizeConfig'] as Map).cast<String, dynamic>()),
      ...
      vsphereConfigs: map['vsphereConfigs'] == null ? null : pulumi.Input.decodeList<VMwareClusterControlPlaneNodeVsphereConfig>(map['vsphereConfigs'], (value) => VMwareClusterControlPlaneNodeVsphereConfig.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
