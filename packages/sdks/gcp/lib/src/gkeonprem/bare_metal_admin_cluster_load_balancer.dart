...
class BareMetalAdminClusterLoadBalancer {
  ...
  /// A nested object resource.
  /// Structure is documented below.
  final pulumi.Input<BareMetalAdminClusterLoadBalancerManualLbConfig>?
  manualLbConfig;
  ...
  factory BareMetalAdminClusterLoadBalancer.fromMap(Map<String, dynamic> map) {
    return BareMetalAdminClusterLoadBalancer(
      ...
      portConfig: pulumi.Input.fromValue(
        BareMetalAdminClusterLoadBalancerPortConfig.fromMap(
          (map['portConfig']! as Map).cast<String, dynamic>(),
        ),
      ),
      vipConfig: pulumi.Input.fromValue(
        BareMetalAdminClusterLoadBalancerVipConfig.fromMap(
