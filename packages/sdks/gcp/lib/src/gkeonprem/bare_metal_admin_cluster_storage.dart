...
class BareMetalAdminClusterStorage {
  ...
  factory BareMetalAdminClusterStorage.fromMap(Map<String, dynamic> map) {
    return BareMetalAdminClusterStorage(
      lvpNodeMountsConfig: pulumi.Input.fromValue(BareMetalAdminClusterStorageLvpNodeMountsConfig.fromMap((map['lvpNodeMountsConfig']! as Map).cast<String, dynamic>())),
      lvpShareConfig: pulumi.Input.fromValue(BareMetalAdminClusterStorageLvpShareConfig.fromMap((map['lvpShareConfig']! as Map).cast<String, dynamic>())),
    );
  }
}
