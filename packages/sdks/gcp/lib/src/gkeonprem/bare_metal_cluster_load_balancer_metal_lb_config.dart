...
class BareMetalClusterLoadBalancerMetalLbConfig {
  ...
  factory BareMetalClusterLoadBalancerMetalLbConfig.fromMap(Map<String, dynamic> map) {
    return BareMetalClusterLoadBalancerMetalLbConfig(
      addressPools: pulumi.Input.fromValue(pulumi.Input.decodeList<BareMetalClusterLoadBalancerMetalLbConfigAddressPool>(map['addressPools']!, (value) => BareMetalClusterLoadBalancerMetalLbConfigAddressPool.fromMap((value as Map).cast<String, dynamic>()))),
      loadBalancerNodePoolConfig: (() { final guardedValue = map['loadBalancerNodePoolConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BareMetalClusterLoadBalancerMetalLbConfigLoadBalancerNodePoolConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
