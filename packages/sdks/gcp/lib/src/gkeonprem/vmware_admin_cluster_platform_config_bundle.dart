...
class VmwareAdminClusterPlatformConfigBundle {
  ...
  final pulumi.Input<List<VmwareAdminClusterPlatformConfigBundleStatus>>?
  statuses;
    ...
    return <String, dynamic>{
      'statuses':
          ?pulumi.Input.mapOptionalInputValue<
            List<VmwareAdminClusterPlatformConfigBundleStatus>,
    ...
    return VmwareAdminClusterPlatformConfigBundle(
      statuses: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VmwareAdminClusterPlatformConfigBundleStatus>(
            guardedValue,
