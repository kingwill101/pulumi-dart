...
class BareMetalClusterControlPlane {
  ...
  final pulumi.Input<List<BareMetalClusterControlPlaneApiServerArg>>?
  apiServerArgs;

  /// Configures the node pool running the control plane. If specified the corresponding NodePool will be created for the cluster's control plane. The NodePool will have the same name and namespace as the cluster.
  /// Structure is documented below.
  final pulumi.Input<BareMetalClusterControlPlaneControlPlaneNodePoolConfig>
    ...
    return <String, dynamic>{
      'apiServerArgs':
          ?pulumi.Input.mapOptionalInputValue<
            List<BareMetalClusterControlPlaneApiServerArg>,
    ...
    return BareMetalClusterControlPlane(
      apiServerArgs: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<BareMetalClusterControlPlaneApiServerArg>(
            guardedValue,
