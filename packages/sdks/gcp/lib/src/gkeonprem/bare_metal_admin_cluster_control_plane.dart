...
class BareMetalAdminClusterControlPlane {
  ...
  final pulumi.Input<List<BareMetalAdminClusterControlPlaneApiServerArg>>?
  apiServerArgs;
    ...
    return <String, dynamic>{
      'apiServerArgs':
          ?pulumi.Input.mapOptionalInputValue<
            List<BareMetalAdminClusterControlPlaneApiServerArg>,
      ...
      'controlPlaneNodePoolConfig':
          pulumi.Input.mapInputValue<
            BareMetalAdminClusterControlPlaneControlPlaneNodePoolConfig,
            Map<String, dynamic>
          >(controlPlaneNodePoolConfig, (value) => value.toMap()),
    };
  }
  ...
  factory BareMetalAdminClusterControlPlane.fromMap(Map<String, dynamic> map) {
    return BareMetalAdminClusterControlPlane(
      apiServerArgs: (() {
        final guardedValue = map['apiServerArgs'];
      ...
      controlPlaneNodePoolConfig: pulumi.Input.fromValue(
