...
class VmwareAdminClusterPlatformConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'bundles': ?bundles == null ? null : pulumi.Input.encodeList<VmwareAdminClusterPlatformConfigBundle, Map<String, dynamic>>(bundles!, (value) => value.toMap()),
      'platformVersion': ?platformVersion,
      'requiredPlatformVersion': ?requiredPlatformVersion,
      'statuses': ?statuses == null ? null : pulumi.Input.encodeList<VmwareAdminClusterPlatformConfigStatus, Map<String, dynamic>>(statuses!, (value) => value.toMap()),
    };
  }

  factory VmwareAdminClusterPlatformConfig.fromMap(Map<String, dynamic> map) {
    return VmwareAdminClusterPlatformConfig(
      bundles: map['bundles'] == null ? null : pulumi.Input.decodeList<VmwareAdminClusterPlatformConfigBundle>(map['bundles'], (value) => VmwareAdminClusterPlatformConfigBundle.fromMap((value as Map).cast<String, dynamic>())),
      platformVersion: map['platformVersion'] == null ? null : map['platformVersion'] as String,
      requiredPlatformVersion: map['requiredPlatformVersion'] == null ? null : map['requiredPlatformVersion'] as String,
      statuses: map['statuses'] == null ? null : pulumi.Input.decodeList<VmwareAdminClusterPlatformConfigStatus>(map['statuses'], (value) => VmwareAdminClusterPlatformConfigStatus.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
