...
class BareMetalAdminClusterControlPlaneControlPlaneNodePoolConfig {
  ...
  const BareMetalAdminClusterControlPlaneControlPlaneNodePoolConfig({
  ...
  factory BareMetalAdminClusterControlPlaneControlPlaneNodePoolConfig.fromMap(Map<String, dynamic> map) {
    return BareMetalAdminClusterControlPlaneControlPlaneNodePoolConfig(
      nodePoolConfig: pulumi.Input.fromValue(BareMetalAdminClusterControlPlaneControlPlaneNodePoolConfigNodePoolConfig.fromMap((map['nodePoolConfig']! as Map).cast<String, dynamic>())),
    );
  }
}
