...
class VmwareAdminClusterNetworkConfig {
  ...
  /// Structure is documented below.
  final pulumi.Input<VmwareAdminClusterNetworkConfigHaControlPlaneConfig>?
  ...
  /// Structure is documented below.
  final pulumi.Input<VmwareAdminClusterNetworkConfigStaticIpConfig>?
  staticIpConfig;
    ...
    return <String, dynamic>{
      ...
      'haControlPlaneConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(haControlPlaneConfig, (value) => value.toMap()),
      'hostConfig':
          ?pulumi.Input.mapOptionalInputValue<
  ...
  factory VmwareAdminClusterNetworkConfig.fromMap(Map<String, dynamic> map) {
    return VmwareAdminClusterNetworkConfig(
      ...
      haControlPlaneConfig: (() {
        final guardedValue = map['haControlPlaneConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
