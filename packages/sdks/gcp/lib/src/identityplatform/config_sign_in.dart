...
class ConfigSignIn {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'hashConfigs': ?hashConfigs == null ? null : pulumi.Input.encodeList<ConfigSignInHashConfig, Map<String, dynamic>>(hashConfigs!, (value) => value.toMap()),
  ...
  factory ConfigSignIn.fromMap(Map<String, dynamic> map) {
    return ConfigSignIn(
      allowDuplicateEmails: map['allowDuplicateEmails'] == null ? null : map['allowDuplicateEmails'] as bool,
      anonymous: map['anonymous'] == null ? null : ConfigSignInAnonymous.fromMap((map['anonymous'] as Map).cast<String, dynamic>()),
      email: map['email'] == null ? null : ConfigSignInEmail.fromMap((map['email'] as Map).cast<String, dynamic>()),
      hashConfigs: map['hashConfigs'] == null ? null : pulumi.Input.decodeList<ConfigSignInHashConfig>(map['hashConfigs'], (value) => ConfigSignInHashConfig.fromMap((value as Map).cast<String, dynamic>())),
      phoneNumber: map['phoneNumber'] == null ? null : ConfigSignInPhoneNumber.fromMap((map['phoneNumber'] as Map).cast<String, dynamic>()),
    );
  }
}
