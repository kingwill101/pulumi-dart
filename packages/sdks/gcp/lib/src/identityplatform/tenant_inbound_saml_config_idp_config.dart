...
class TenantInboundSamlConfigIdpConfig {
  ...
  final pulumi.Input<List<TenantInboundSamlConfigIdpConfigIdpCertificate>>
  idpCertificates;
    ...
    return <String, dynamic>{
      'idpCertificates':
          pulumi.Input.mapInputValue<
            List<TenantInboundSamlConfigIdpConfigIdpCertificate>,
  ...
  factory TenantInboundSamlConfigIdpConfig.fromMap(Map<String, dynamic> map) {
    return TenantInboundSamlConfigIdpConfig(
      idpCertificates: pulumi.Input.fromValue(
        pulumi.Input.decodeList<TenantInboundSamlConfigIdpConfigIdpCertificate>(
          map['idpCertificates']!,
