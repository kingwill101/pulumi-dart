...
class ConfigArgs {
    ...
    return <String, dynamic>{
      ...
      'blockingFunctions':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(blockingFunctions, (value) => value.toMap()),
      'client':
          ?pulumi.Input.mapOptionalInputValue<
            ConfigClient,
            Map<String, dynamic>
  ...
  factory ConfigArgs.fromMap(Map<String, dynamic> map) {
    return ConfigArgs(
      authorizedDomains: (() {
        final guardedValue = map['authorizedDomains'];
      ...
      blockingFunctions: (() {
        final guardedValue = map['blockingFunctions'];
        if (guardedValue == null) return null;
      ...
      client: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ConfigClient.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      mfa: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ConfigMfa.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      monitoring: (() {
      ...
      quota: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ConfigQuota.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      signIn: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ConfigSignIn.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      smsRegionConfig: (() {
