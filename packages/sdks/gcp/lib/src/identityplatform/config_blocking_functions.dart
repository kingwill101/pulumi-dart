...
class ConfigBlockingFunctions {
  ...
  final pulumi.Input<ConfigBlockingFunctionsForwardInboundCredentials>?
    ...
    return <String, dynamic>{
      'forwardInboundCredentials':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(forwardInboundCredentials, (value) => value.toMap()),
      'triggers':
          pulumi.Input.mapInputValue<
            List<ConfigBlockingFunctionsTrigger>,
  ...
  factory ConfigBlockingFunctions.fromMap(Map<String, dynamic> map) {
    return ConfigBlockingFunctions(
      forwardInboundCredentials: (() {
        final guardedValue = map['forwardInboundCredentials'];
      ...
      triggers: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ConfigBlockingFunctionsTrigger>(
          map['triggers']!,
