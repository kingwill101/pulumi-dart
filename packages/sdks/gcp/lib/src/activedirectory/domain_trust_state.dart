  ...
  factory DomainTrustState.fromMap(Map<String, dynamic> map) {
    return DomainTrustState(
      ...
      selectiveAuthentication: (() {
        final guardedValue = map['selectiveAuthentication'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      targetDnsIpAddresses: (() {
        final guardedValue = map['targetDnsIpAddresses'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      targetDomainName: (() {
        final guardedValue = map['targetDomainName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      trustDirection: (() {
      ...
      trustHandshakeSecret: (() {
        final guardedValue = map['trustHandshakeSecret'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      trustType: (() {
