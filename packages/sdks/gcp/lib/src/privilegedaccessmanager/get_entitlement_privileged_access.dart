...
class GetEntitlementPrivilegedAccess {
  ...
  final pulumi.Input<List<GetEntitlementPrivilegedAccessGcpIamAccess>>
  gcpIamAccesses;
  ...
  GetEntitlementPrivilegedAccess({required this.gcpIamAccesses});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'gcpIamAccesses':
          pulumi.Input.mapInputValue<
            List<GetEntitlementPrivilegedAccessGcpIamAccess>,
  ...
  factory GetEntitlementPrivilegedAccess.fromMap(Map<String, dynamic> map) {
    return GetEntitlementPrivilegedAccess(
      gcpIamAccesses: pulumi.Input.fromValue(
