...
class GetEntitlementPrivilegedAccess {
  ...
  const GetEntitlementPrivilegedAccess({
  ...
  factory GetEntitlementPrivilegedAccess.fromMap(Map<String, dynamic> map) {
    return GetEntitlementPrivilegedAccess(
      gcpIamAccesses: pulumi.Input.fromValue(pulumi.Input.decodeList<GetEntitlementPrivilegedAccessGcpIamAccess>(map['gcpIamAccesses']!, (value) => GetEntitlementPrivilegedAccessGcpIamAccess.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
