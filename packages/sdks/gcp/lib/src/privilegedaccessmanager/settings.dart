...
class Settings extends pulumi.CustomResource {
  ...
  Settings(
    ...
    this.emailNotificationSettings = registerOutput<SettingsEmailNotificationSettings?>('emailNotificationSettings');
    this.etag = registerOutput<String>('etag');
    this.location = registerOutput<String>('location');
    this.name = registerOutput<String>('name');
    this.parent = registerOutput<String>('parent');
    this.serviceAccountApproverSettings = registerOutput<SettingsServiceAccountApproverSettings?>('serviceAccountApproverSettings');
