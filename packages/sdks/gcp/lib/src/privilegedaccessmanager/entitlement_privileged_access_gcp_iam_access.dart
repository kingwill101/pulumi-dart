...
class EntitlementPrivilegedAccessGcpIamAccess {
  ...
  final pulumi.Input<List<EntitlementPrivilegedAccessGcpIamAccessRoleBinding>>
  roleBindings;
    ...
    return <String, dynamic>{
      ...
      'roleBindings':
          pulumi.Input.mapInputValue<
            List<EntitlementPrivilegedAccessGcpIamAccessRoleBinding>,
  ...
  factory EntitlementPrivilegedAccessGcpIamAccess.fromMap(
    ...
    return EntitlementPrivilegedAccessGcpIamAccess(
      ...
      roleBindings: pulumi.Input.fromValue(
