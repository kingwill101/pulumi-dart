...
class GetEntitlementApprovalWorkflowManualApproval {
  ...
  final pulumi.Input<List<GetEntitlementApprovalWorkflowManualApprovalStep>>
  steps;
    ...
    return <String, dynamic>{
      ...
      'steps':
          pulumi.Input.mapInputValue<
            List<GetEntitlementApprovalWorkflowManualApprovalStep>,
  ...
  factory GetEntitlementApprovalWorkflowManualApproval.fromMap(
    ...
    return GetEntitlementApprovalWorkflowManualApproval(
      requireApproverJustification: pulumi.Input.fromValue(
        map['requireApproverJustification'] as bool,
      ),
      steps: pulumi.Input.fromValue(
        pulumi
            .Input.decodeList<GetEntitlementApprovalWorkflowManualApprovalStep>(
          map['steps']!,
