...
class EntitlementArgs {
  ...
  factory EntitlementArgs.fromMap(Map<String, dynamic> map) {
    return EntitlementArgs(
      ...
      maxRequestDuration: pulumi.Input.fromValue(map['maxRequestDuration'] as String),
      parent: pulumi.Input.fromValue(map['parent'] as String),
      privilegedAccess: pulumi.Input.fromValue(EntitlementPrivilegedAccess.fromMap((map['privilegedAccess']! as Map).cast<String, dynamic>())),
      requesterJustificationConfig: pulumi.Input.fromValue(EntitlementRequesterJustificationConfig.fromMap((map['requesterJustificationConfig']! as Map).cast<String, dynamic>())),
    );
  }
}
