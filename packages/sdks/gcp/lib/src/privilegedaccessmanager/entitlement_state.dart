...
class EntitlementState {
  ...
  factory EntitlementState.fromMap(Map<String, dynamic> map) {
    return EntitlementState(
      ...
      maxRequestDuration: (() { final guardedValue = map['maxRequestDuration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      parent: (() { final guardedValue = map['parent']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      privilegedAccess: (() { final guardedValue = map['privilegedAccess']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EntitlementPrivilegedAccess.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      requesterJustificationConfig: (() { final guardedValue = map['requesterJustificationConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EntitlementRequesterJustificationConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
