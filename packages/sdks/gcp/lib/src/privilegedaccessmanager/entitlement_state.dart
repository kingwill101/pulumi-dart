...
class EntitlementState {
  ...
  factory EntitlementState.fromMap(Map<String, dynamic> map) {
    return EntitlementState(
      ...
      eligibleUsers: (() {
        final guardedValue = map['eligibleUsers'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      maxRequestDuration: (() {
        final guardedValue = map['maxRequestDuration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      name: (() {
      ...
      privilegedAccess: (() {
        final guardedValue = map['privilegedAccess'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      requesterJustificationConfig: (() {
        final guardedValue = map['requesterJustificationConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
