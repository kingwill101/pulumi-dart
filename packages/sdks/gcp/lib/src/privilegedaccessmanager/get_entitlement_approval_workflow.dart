...
class GetEntitlementApprovalWorkflow {
  ...
  final pulumi.Input<List<GetEntitlementApprovalWorkflowManualApproval>>
  manualApprovals;
    ...
    return <String, dynamic>{
      'manualApprovals':
          pulumi.Input.mapInputValue<
            List<GetEntitlementApprovalWorkflowManualApproval>,
  ...
  factory GetEntitlementApprovalWorkflow.fromMap(Map<String, dynamic> map) {
    return GetEntitlementApprovalWorkflow(
      manualApprovals: pulumi.Input.fromValue(
