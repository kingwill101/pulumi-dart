...
class GetEntitlementApprovalWorkflow {
  ...
  const GetEntitlementApprovalWorkflow({
  ...
  factory GetEntitlementApprovalWorkflow.fromMap(Map<String, dynamic> map) {
    return GetEntitlementApprovalWorkflow(
      manualApprovals: pulumi.Input.fromValue(pulumi.Input.decodeList<GetEntitlementApprovalWorkflowManualApproval>(map['manualApprovals']!, (value) => GetEntitlementApprovalWorkflowManualApproval.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
