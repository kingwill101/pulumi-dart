...
class KeyState {
  ...
  factory KeyState.fromMap(Map<String, dynamic> map) {
    return KeyState(
      ...
      validAfter: (() { final guardedValue = map['validAfter']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      validBefore: (() { final guardedValue = map['validBefore']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
