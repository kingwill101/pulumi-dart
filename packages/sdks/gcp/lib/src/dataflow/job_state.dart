...
class JobState {
  ...
  JobState({
    ...
    pulumi.Output<String>? tempGcsLocation,
    pulumi.Output<String>? templateGcsPath,
    ...
    pulumi.Output<String>? zone,
      ...
      tempGcsLocation = pulumi.Input.asOptionalInput<String>(tempGcsLocation),
      templateGcsPath = pulumi.Input.asOptionalInput<String>(templateGcsPath),
  ...
  factory JobState.fromMap(Map<String, dynamic> map) {
    return JobState(
      ...
      tempGcsLocation: map['tempGcsLocation'] == null ? null : pulumi.Output.create<String>(map['tempGcsLocation'] as String),
      templateGcsPath: map['templateGcsPath'] == null ? null : pulumi.Output.create<String>(map['templateGcsPath'] as String),
