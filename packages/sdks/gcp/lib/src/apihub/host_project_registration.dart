...
import 'host_project_registration_state.dart';
...
class HostProjectRegistration extends pulumi.CustomResource {
  ...
  /// Creates a new [HostProjectRegistration].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [HostProjectRegistration]. {@macro pulumi_apihub_host_project_registration_host_project_registration_args_doc}
  ...
  static HostProjectRegistration get(
    String name,
