...
class PluginConfigTemplate {
  ...
  final pulumi.Input<List<PluginConfigTemplateAdditionalConfigTemplate>>?
  additionalConfigTemplates;

  /// AuthConfigTemplate represents the authentication template for a plugin.
  /// Structure is documented below.
  final pulumi.Input<PluginConfigTemplateAuthConfigTemplate>?
  authConfigTemplate;
    ...
    return <String, dynamic>{
      'additionalConfigTemplates':
          ?pulumi.Input.mapOptionalInputValue<
            List<PluginConfigTemplateAdditionalConfigTemplate>,
      ...
      'authConfigTemplate':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(authConfigTemplate, (value) => value.toMap()),
    };
  }
  ...
  factory PluginConfigTemplate.fromMap(Map<String, dynamic> map) {
    return PluginConfigTemplate(
      additionalConfigTemplates: (() {
        final guardedValue = map['additionalConfigTemplates'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PluginConfigTemplateAdditionalConfigTemplate>(
            guardedValue,
      ...
      authConfigTemplate: (() {
        final guardedValue = map['authConfigTemplate'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
