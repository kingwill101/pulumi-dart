...
class ApiHubInstanceConfig {
  ...
  factory ApiHubInstanceConfig.fromMap(Map<String, dynamic> map) {
    return ApiHubInstanceConfig(
      ...
      disableSearch: (() { final guardedValue = map['disableSearch']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      vertexLocation: (() { final guardedValue = map['vertexLocation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
