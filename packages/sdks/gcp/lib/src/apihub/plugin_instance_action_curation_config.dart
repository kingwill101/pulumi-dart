...
class PluginInstanceActionCurationConfig {
  ...
  final pulumi.Input<PluginInstanceActionCurationConfigCustomCuration>?
  customCuration;
  ...
  PluginInstanceActionCurationConfig({this.curationType, this.customCuration});
    ...
    return <String, dynamic>{
      ...
      'customCuration':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(customCuration, (value) => value.toMap()),
    };
  }
  ...
  factory PluginInstanceActionCurationConfig.fromMap(Map<String, dynamic> map) {
    return PluginInstanceActionCurationConfig(
      curationType: (() {
        final guardedValue = map['curationType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      customCuration: (() {
        final guardedValue = map['customCuration'];
        if (guardedValue == null) return null;
