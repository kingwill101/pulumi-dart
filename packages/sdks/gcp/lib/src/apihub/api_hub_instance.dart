...
import 'api_hub_instance_state.dart';
...
class ApiHubInstance extends pulumi.CustomResource {
  ...
  /// Creates a new [ApiHubInstance].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ApiHubInstance]. {@macro pulumi_apihub_api_hub_instance_api_hub_instance_args_doc}
  ...
  ApiHubInstance(
    ...
    config = registerOutput<ApiHubInstanceConfig>('config', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ApiHubInstanceConfig.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [ApiHubInstance] resource's state with the given [name] and [id].
  static ApiHubInstance get(
    String name,
    pulumi.Input<String> id, {
    ApiHubInstanceState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return ApiHubInstance._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [ApiHubInstance] resource.
  ApiHubInstance.reference(String urn)
    : super(
        'gcp:apihub/apiHubInstance:ApiHubInstance',
