...
class PluginInstanceActionHubInstanceAction {
  ...
  final pulumi.Input<List<PluginInstanceActionHubInstanceActionLastExecution>>?
  lastExecutions;
    ...
    return <String, dynamic>{
      ...
      'lastExecutions':
          ?pulumi.Input.mapOptionalInputValue<
            List<PluginInstanceActionHubInstanceActionLastExecution>,
  ...
  factory PluginInstanceActionHubInstanceAction.fromMap(
    ...
    return PluginInstanceActionHubInstanceAction(
      currentExecutionState: (() {
        final guardedValue = map['currentExecutionState'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      lastExecutions: (() {
        final guardedValue = map['lastExecutions'];
        if (guardedValue == null) return null;
