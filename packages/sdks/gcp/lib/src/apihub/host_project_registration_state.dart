...
class HostProjectRegistrationState {
  ...
  factory HostProjectRegistrationState.fromMap(Map<String, dynamic> map) {
    return HostProjectRegistrationState(
      ...
      hostProjectRegistrationId: (() { final guardedValue = map['hostProjectRegistrationId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
