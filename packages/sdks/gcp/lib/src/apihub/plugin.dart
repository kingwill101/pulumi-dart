...
class Plugin extends pulumi.CustomResource {
  ...
  Plugin(
    ...
    this.actionsConfigs = registerOutput<List<PluginActionsConfig>?>('actionsConfigs');
    this.configTemplate = registerOutput<PluginConfigTemplate>('configTemplate');
    this.createTime = registerOutput<String>('createTime');
    this.description = registerOutput<String?>('description');
    this.displayName = registerOutput<String>('displayName');
    this.documentation = registerOutput<PluginDocumentation?>('documentation');
    this.hostingService = registerOutput<PluginHostingService?>('hostingService');
