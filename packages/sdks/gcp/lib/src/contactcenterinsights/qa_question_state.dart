...
class QaQuestionState {
  ...
  /// [createTime] The time at which this question was created.
  ...
  /// [name] Identifier. The resource name of the question.
  ...
  /// [updateTime] The most recent time at which the question was updated.
  const QaQuestionState({
    this.abbreviation,
    this.answerChoices,
  ...
  factory QaQuestionState.fromMap(Map<String, dynamic> map) {
    return QaQuestionState(
