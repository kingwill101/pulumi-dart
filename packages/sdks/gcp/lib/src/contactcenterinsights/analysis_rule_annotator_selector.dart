...
class AnalysisRuleAnnotatorSelector {
  ...
  /// Structure is documented below.
  final pulumi.Input<AnalysisRuleAnnotatorSelectorSummarizationConfig>?
  summarizationConfig;
  ...
  factory AnalysisRuleAnnotatorSelector.fromMap(Map<String, dynamic> map) {
    return AnalysisRuleAnnotatorSelector(
      ...
      qaConfig: (() {
        final guardedValue = map['qaConfig'];
        if (guardedValue == null) return null;
      ...
      runQaAnnotator: (() {
        final guardedValue = map['runQaAnnotator'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
