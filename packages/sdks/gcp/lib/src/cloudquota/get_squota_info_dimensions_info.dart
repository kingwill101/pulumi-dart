...
class GetSQuotaInfoDimensionsInfo {
  ...
  final pulumi.Input<List<GetSQuotaInfoDimensionsInfoDetail>> details;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'details': pulumi.Input.mapInputValue<List<GetSQuotaInfoDimensionsInfoDetail>, List<Map<String, dynamic>>>(details, (value) => pulumi.Input.encodeList<GetSQuotaInfoDimensionsInfoDetail, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory GetSQuotaInfoDimensionsInfo.fromMap(Map<String, dynamic> map) {
    return GetSQuotaInfoDimensionsInfo(
      ...
      details: pulumi.Input.fromValue(pulumi.Input.decodeList<GetSQuotaInfoDimensionsInfoDetail>(map['details']!, (value) => GetSQuotaInfoDimensionsInfoDetail.fromMap((value as Map).cast<String, dynamic>()))),
