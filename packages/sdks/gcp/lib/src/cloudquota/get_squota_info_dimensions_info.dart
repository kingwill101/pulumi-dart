...
class GetSQuotaInfoDimensionsInfo {
  ...
  factory GetSQuotaInfoDimensionsInfo.fromMap(Map<String, dynamic> map) {
    return GetSQuotaInfoDimensionsInfo(
      ...
      details: (pulumi.Input.decodeList<GetSQuotaInfoDimensionsInfoDetail>(map['details'], (value) => GetSQuotaInfoDimensionsInfoDetail.fromMap((value as Map).cast<String, dynamic>()))).input(),
