...
class GetSQuotaInfosQuotaInfo {
  ...
  final pulumi.Input<List<GetSQuotaInfosQuotaInfoDimensionsInfo>>
  dimensionsInfos;
  ...
  final pulumi.Input<List<GetSQuotaInfosQuotaInfoQuotaIncreaseEligibility>>
    ...
    return <String, dynamic>{
      ...
      'dimensionsInfos':
          pulumi.Input.mapInputValue<
            List<GetSQuotaInfosQuotaInfoDimensionsInfo>,
      ...
      'quotaIncreaseEligibilities':
          pulumi.Input.mapInputValue<
            List<GetSQuotaInfosQuotaInfoQuotaIncreaseEligibility>,
            List<Map<String, dynamic>>
          >(
            quotaIncreaseEligibilities,
            (value) =>
  ...
  factory GetSQuotaInfosQuotaInfo.fromMap(Map<String, dynamic> map) {
    return GetSQuotaInfosQuotaInfo(
      ...
      dimensionsInfos: pulumi.Input.fromValue(
      ...
      metricDisplayName: pulumi.Input.fromValue(
        map['metricDisplayName'] as String,
      ),
      metricUnit: pulumi.Input.fromValue(map['metricUnit'] as String),
      name: pulumi.Input.fromValue(map['name'] as String),
      quotaDisplayName: pulumi.Input.fromValue(
        map['quotaDisplayName'] as String,
      ),
      quotaId: pulumi.Input.fromValue(map['quotaId'] as String),
      quotaIncreaseEligibilities: pulumi.Input.fromValue(
        pulumi
      ...
      serviceRequestQuotaUri: pulumi.Input.fromValue(
        map['serviceRequestQuotaUri'] as String,
      ),
    );
  }
}
