...
class GetSQuotaInfosQuotaInfo {
  ...
  factory GetSQuotaInfosQuotaInfo.fromMap(Map<String, dynamic> map) {
    return GetSQuotaInfosQuotaInfo(
      ...
      dimensionsInfos: (pulumi.Input.decodeList<GetSQuotaInfosQuotaInfoDimensionsInfo>(map['dimensionsInfos'], (value) => GetSQuotaInfosQuotaInfoDimensionsInfo.fromMap((value as Map).cast<String, dynamic>()))).input(),
      isConcurrent: (map['isConcurrent'] as bool).input(),
      isFixed: (map['isFixed'] as bool).input(),
      isPrecise: (map['isPrecise'] as bool).input(),
      metric: (map['metric'] as String).input(),
      metricDisplayName: (map['metricDisplayName'] as String).input(),
      metricUnit: (map['metricUnit'] as String).input(),
      name: (map['name'] as String).input(),
      quotaDisplayName: (map['quotaDisplayName'] as String).input(),
      quotaId: (map['quotaId'] as String).input(),
      quotaIncreaseEligibilities: (pulumi.Input.decodeList<GetSQuotaInfosQuotaInfoQuotaIncreaseEligibility>(map['quotaIncreaseEligibilities'], (value) => GetSQuotaInfosQuotaInfoQuotaIncreaseEligibility.fromMap((value as Map).cast<String, dynamic>()))).input(),
      refreshInterval: (map['refreshInterval'] as String).input(),
      service: (map['service'] as String).input(),
      serviceRequestQuotaUri: (map['serviceRequestQuotaUri'] as String).input(),
    );
  }
}
