...
class GetSQuotaInfoResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'dimensionsInfos': pulumi.Input.encodeList<GetSQuotaInfoDimensionsInfo, Map<String, dynamic>>(dimensionsInfos, (value) => value.toMap()),
      'id': id,
      ...
      'quotaId': quotaId,
      'quotaIncreaseEligibilities': pulumi.Input.encodeList<GetSQuotaInfoQuotaIncreaseEligibility, Map<String, dynamic>>(quotaIncreaseEligibilities, (value) => value.toMap()),
  ...
  factory GetSQuotaInfoResult.fromMap(Map<String, dynamic> map) {
    return GetSQuotaInfoResult(
      ...
      dimensionsInfos: pulumi.Input.decodeList<GetSQuotaInfoDimensionsInfo>(map['dimensionsInfos']!, (value) => GetSQuotaInfoDimensionsInfo.fromMap((value as Map).cast<String, dynamic>())),
      id: map['id'] as String,
      ...
      quotaIncreaseEligibilities: pulumi.Input.decodeList<GetSQuotaInfoQuotaIncreaseEligibility>(map['quotaIncreaseEligibilities']!, (value) => GetSQuotaInfoQuotaIncreaseEligibility.fromMap((value as Map).cast<String, dynamic>())),
