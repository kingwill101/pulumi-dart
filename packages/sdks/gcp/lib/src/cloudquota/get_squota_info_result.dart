...
class GetSQuotaInfoResult {
  ...
  const GetSQuotaInfoResult({
    ...
    this.name,
    this.parent,
    this.quotaDisplayName,
    this.quotaId,
    this.quotaIncreaseEligibilities,
    this.refreshInterval,
    this.service,
    this.serviceRequestQuotaUri,
  });
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'dimensionsInfos': ?(() { final guardedValue = dimensionsInfos; if (guardedValue == null) return null; return pulumi.Input.encodeList<GetSQuotaInfoDimensionsInfo, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
      'id': ?id,
      ...
      'quotaId': ?quotaId,
      'quotaIncreaseEligibilities': ?(() { final guardedValue = quotaIncreaseEligibilities; if (guardedValue == null) return null; return pulumi.Input.encodeList<GetSQuotaInfoQuotaIncreaseEligibility, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
  ...
  factory GetSQuotaInfoResult.fromMap(Map<String, dynamic> map) {
    return GetSQuotaInfoResult(
      ...
      dimensions: (() { final guardedValue = map['dimensions']; if (guardedValue == null) return null; return (guardedValue as List).cast<String>(); })(),
      dimensionsInfos: (() { final guardedValue = map['dimensionsInfos']; if (guardedValue == null) return null; return pulumi.Input.decodeList<GetSQuotaInfoDimensionsInfo>(guardedValue, (value) => GetSQuotaInfoDimensionsInfo.fromMap((value as Map).cast<String, dynamic>())); })(),
      id: (() { final guardedValue = map['id']; if (guardedValue == null) return null; return guardedValue as String; })(),
      isConcurrent: (() { final guardedValue = map['isConcurrent']; if (guardedValue == null) return null; return guardedValue as bool; })(),
      isFixed: (() { final guardedValue = map['isFixed']; if (guardedValue == null) return null; return guardedValue as bool; })(),
      isPrecise: (() { final guardedValue = map['isPrecise']; if (guardedValue == null) return null; return guardedValue as bool; })(),
      metric: (() { final guardedValue = map['metric']; if (guardedValue == null) return null; return guardedValue as String; })(),
      metricDisplayName: (() { final guardedValue = map['metricDisplayName']; if (guardedValue == null) return null; return guardedValue as String; })(),
      metricUnit: (() { final guardedValue = map['metricUnit']; if (guardedValue == null) return null; return guardedValue as String; })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return guardedValue as String; })(),
      parent: (() { final guardedValue = map['parent']; if (guardedValue == null) return null; return guardedValue as String; })(),
      quotaDisplayName: (() { final guardedValue = map['quotaDisplayName']; if (guardedValue == null) return null; return guardedValue as String; })(),
      quotaId: (() { final guardedValue = map['quotaId']; if (guardedValue == null) return null; return guardedValue as String; })(),
      quotaIncreaseEligibilities: (() { final guardedValue = map['quotaIncreaseEligibilities']; if (guardedValue == null) return null; return pulumi.Input.decodeList<GetSQuotaInfoQuotaIncreaseEligibility>(guardedValue, (value) => GetSQuotaInfoQuotaIncreaseEligibility.fromMap((value as Map).cast<String, dynamic>())); })(),
      refreshInterval: (() { final guardedValue = map['refreshInterval']; if (guardedValue == null) return null; return guardedValue as String; })(),
      service: (() { final guardedValue = map['service']; if (guardedValue == null) return null; return guardedValue as String; })(),
      serviceRequestQuotaUri: (() { final guardedValue = map['serviceRequestQuotaUri']; if (guardedValue == null) return null; return guardedValue as String; })(),
    );
  }
}
