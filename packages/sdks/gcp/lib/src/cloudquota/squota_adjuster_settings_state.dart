...
class SQuotaAdjusterSettingsState {
  ...
  factory SQuotaAdjusterSettingsState.fromMap(Map<String, dynamic> map) {
    return SQuotaAdjusterSettingsState(
      effectiveContainer: (() {
        final guardedValue = map['effectiveContainer'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      effectiveEnablement: (() {
        final guardedValue = map['effectiveEnablement'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      enablement: (() {
        final guardedValue = map['enablement'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      inherited: (() {
        final guardedValue = map['inherited'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      inheritedFrom: (() {
        final guardedValue = map['inheritedFrom'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      parent: (() {
