...
class GetSQuotaInfosQuotaInfoDimensionsInfo {
  ...
  factory GetSQuotaInfosQuotaInfoDimensionsInfo.fromMap(Map<String, dynamic> map) {
    return GetSQuotaInfosQuotaInfoDimensionsInfo(
      applicableLocations: ((map['applicableLocations'] as List).cast<String>()).input(),
      details: (pulumi.Input.decodeList<GetSQuotaInfosQuotaInfoDimensionsInfoDetail>(map['details'], (value) => GetSQuotaInfosQuotaInfoDimensionsInfoDetail.fromMap((value as Map).cast<String, dynamic>()))).input(),
