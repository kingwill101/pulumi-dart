...
class SQuotaPreferenceQuotaConfig {
  ...
  factory SQuotaPreferenceQuotaConfig.fromMap(Map<String, dynamic> map) {
    return SQuotaPreferenceQuotaConfig(
      ...
      grantedValue: (() { final guardedValue = map['grantedValue']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      preferredValue: pulumi.Input.fromValue(map['preferredValue'] as String),
      requestOrigin: (() { final guardedValue = map['requestOrigin']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      stateDetail: (() { final guardedValue = map['stateDetail']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      traceId: (() { final guardedValue = map['traceId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
