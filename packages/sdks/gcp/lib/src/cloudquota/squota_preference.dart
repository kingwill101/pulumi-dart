...
import 'squota_preference_state.dart';
...
class SQuotaPreference extends pulumi.CustomResource {
  ...
  /// Gets an existing [SQuotaPreference] resource's state with the given [name] and [id].
  static SQuotaPreference get(
    String name,
