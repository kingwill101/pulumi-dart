...
class SQuotaPreferenceArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'parent': ?parent,
      'quotaConfig': pulumi.Input.mapInputValue<SQuotaPreferenceQuotaConfig, Map<String, dynamic>>(quotaConfig, (value) => value.toMap()),
      'quotaId': ?quotaId,
      'service': ?service,
    };
  }
  ...
  factory SQuotaPreferenceArgs.fromMap(Map<String, dynamic> map) {
    return SQuotaPreferenceArgs(
      ...
      quotaConfig: pulumi.Input.fromValue(SQuotaPreferenceQuotaConfig.fromMap((map['quotaConfig']! as Map).cast<String, dynamic>())),
