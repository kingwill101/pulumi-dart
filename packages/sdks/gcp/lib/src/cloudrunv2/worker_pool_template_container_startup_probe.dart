...
class WorkerPoolTemplateContainerStartupProbe {
  ...
  factory WorkerPoolTemplateContainerStartupProbe.fromMap(Map<String, dynamic> map) {
    return WorkerPoolTemplateContainerStartupProbe(
      ...
      grpc: map['grpc'] == null ? null : WorkerPoolTemplateContainerStartupProbeGrpc.fromMap((map['grpc'] as Map).cast<String, dynamic>()),
      httpGet: map['httpGet'] == null ? null : WorkerPoolTemplateContainerStartupProbeHttpGet.fromMap((map['httpGet'] as Map).cast<String, dynamic>()),
      ...
      tcpSocket: map['tcpSocket'] == null ? null : WorkerPoolTemplateContainerStartupProbeTcpSocket.fromMap((map['tcpSocket'] as Map).cast<String, dynamic>()),
