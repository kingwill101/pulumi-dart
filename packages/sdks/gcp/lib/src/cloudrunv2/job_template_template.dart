...
class JobTemplateTemplate {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'containers': ?containers == null ? null : pulumi.Input.encodeList<JobTemplateTemplateContainer, Map<String, dynamic>>(containers!, (value) => value.toMap()),
      ...
      'timeout': ?timeout,
      'volumes': ?volumes == null ? null : pulumi.Input.encodeList<JobTemplateTemplateVolume, Map<String, dynamic>>(volumes!, (value) => value.toMap()),
  ...
  factory JobTemplateTemplate.fromMap(Map<String, dynamic> map) {
    return JobTemplateTemplate(
      containers: map['containers'] == null ? null : pulumi.Input.decodeList<JobTemplateTemplateContainer>(map['containers'], (value) => JobTemplateTemplateContainer.fromMap((value as Map).cast<String, dynamic>())),
      ...
      nodeSelector: map['nodeSelector'] == null ? null : JobTemplateTemplateNodeSelector.fromMap((map['nodeSelector'] as Map).cast<String, dynamic>()),
      serviceAccount: map['serviceAccount'] == null ? null : map['serviceAccount'] as String,
      timeout: map['timeout'] == null ? null : map['timeout'] as String,
      volumes: map['volumes'] == null ? null : pulumi.Input.decodeList<JobTemplateTemplateVolume>(map['volumes'], (value) => JobTemplateTemplateVolume.fromMap((value as Map).cast<String, dynamic>())),
      vpcAccess: map['vpcAccess'] == null ? null : JobTemplateTemplateVpcAccess.fromMap((map['vpcAccess'] as Map).cast<String, dynamic>()),
    );
  }
}
