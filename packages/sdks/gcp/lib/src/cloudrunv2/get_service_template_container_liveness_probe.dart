...
class GetServiceTemplateContainerLivenessProbe {
  ...
  final pulumi.Input<List<GetServiceTemplateContainerLivenessProbeHttpGet>>
  httpGets;
  ...
  final pulumi.Input<List<GetServiceTemplateContainerLivenessProbeTcpSocket>>
  tcpSockets;
    ...
    return <String, dynamic>{
      ...
      'grpcs':
          pulumi.Input.mapInputValue<
            List<GetServiceTemplateContainerLivenessProbeGrpc>,
      ...
      'httpGets':
          pulumi.Input.mapInputValue<
            List<GetServiceTemplateContainerLivenessProbeHttpGet>,
            List<Map<String, dynamic>>
          >(
            httpGets,
            (value) =>
      ...
      'tcpSockets':
          pulumi.Input.mapInputValue<
            List<GetServiceTemplateContainerLivenessProbeTcpSocket>,
            List<Map<String, dynamic>>
          >(
            tcpSockets,
            (value) =>
