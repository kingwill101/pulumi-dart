...
class GetWorkerPoolTemplateContainerLivenessProbe {
  ...
  factory GetWorkerPoolTemplateContainerLivenessProbe.fromMap(Map<String, dynamic> map) {
    return GetWorkerPoolTemplateContainerLivenessProbe(
      ...
      grpcs: (pulumi.Input.decodeList<GetWorkerPoolTemplateContainerLivenessProbeGrpc>(map['grpcs'], (value) => GetWorkerPoolTemplateContainerLivenessProbeGrpc.fromMap((value as Map).cast<String, dynamic>()))).input(),
      httpGets: (pulumi.Input.decodeList<GetWorkerPoolTemplateContainerLivenessProbeHttpGet>(map['httpGets'], (value) => GetWorkerPoolTemplateContainerLivenessProbeHttpGet.fromMap((value as Map).cast<String, dynamic>()))).input(),
      initialDelaySeconds: (map['initialDelaySeconds'] as int).input(),
      periodSeconds: (map['periodSeconds'] as int).input(),
      tcpSockets: (pulumi.Input.decodeList<GetWorkerPoolTemplateContainerLivenessProbeTcpSocket>(map['tcpSockets'], (value) => GetWorkerPoolTemplateContainerLivenessProbeTcpSocket.fromMap((value as Map).cast<String, dynamic>()))).input(),
