...
class GetWorkerPoolTemplateContainerLivenessProbe {
  ...
  final pulumi.Input<List<GetWorkerPoolTemplateContainerLivenessProbeGrpc>>
  grpcs;

  /// Optional. HTTPGet specifies the http request to perform. Exactly one of httpGet, tcpSocket, or grpc must be specified.
  final pulumi.Input<List<GetWorkerPoolTemplateContainerLivenessProbeHttpGet>>
  httpGets;
  ...
  final pulumi.Input<List<GetWorkerPoolTemplateContainerLivenessProbeTcpSocket>>
  tcpSockets;
    ...
    return <String, dynamic>{
      ...
      'grpcs':
          pulumi.Input.mapInputValue<
            List<GetWorkerPoolTemplateContainerLivenessProbeGrpc>,
      ...
      'httpGets':
          pulumi.Input.mapInputValue<
            List<GetWorkerPoolTemplateContainerLivenessProbeHttpGet>,
            List<Map<String, dynamic>>
          >(
            httpGets,
            (value) =>
      ...
      'tcpSockets':
          pulumi.Input.mapInputValue<
            List<GetWorkerPoolTemplateContainerLivenessProbeTcpSocket>,
            List<Map<String, dynamic>>
          >(
            tcpSockets,
            (value) =>
  ...
  factory GetWorkerPoolTemplateContainerLivenessProbe.fromMap(
    ...
    return GetWorkerPoolTemplateContainerLivenessProbe(
      ...
      grpcs: pulumi.Input.fromValue(
        pulumi
            .Input.decodeList<GetWorkerPoolTemplateContainerLivenessProbeGrpc>(
          map['grpcs']!,
      ...
      httpGets: pulumi.Input.fromValue(
        ...
        >(
          map['httpGets']!,
          (value) => GetWorkerPoolTemplateContainerLivenessProbeHttpGet.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
