...
class GetServiceTemplateVolumeSecret {
  ...
  factory GetServiceTemplateVolumeSecret.fromMap(Map<String, dynamic> map) {
    return GetServiceTemplateVolumeSecret(
      ...
      items: (pulumi.Input.decodeList<GetServiceTemplateVolumeSecretItem>(map['items'], (value) => GetServiceTemplateVolumeSecretItem.fromMap((value as Map).cast<String, dynamic>()))).input(),
