...
class GetServiceTemplateVolumeSecret {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'items': pulumi.Input.encodeList<GetServiceTemplateVolumeSecretItem, Map<String, dynamic>>(items, (value) => value.toMap()),
      'secret': secret,
    };
  }
  ...
  factory GetServiceTemplateVolumeSecret.fromMap(Map<String, dynamic> map) {
    return GetServiceTemplateVolumeSecret(
      ...
      items: pulumi.Input.decodeList<GetServiceTemplateVolumeSecretItem>(map['items'], (value) => GetServiceTemplateVolumeSecretItem.fromMap((value as Map).cast<String, dynamic>())),
