...
class GetServiceTemplateContainerSourceCode {
  ...
  factory GetServiceTemplateContainerSourceCode.fromMap(Map<String, dynamic> map) {
    return GetServiceTemplateContainerSourceCode(
      cloudStorageSources: (pulumi.Input.decodeList<GetServiceTemplateContainerSourceCodeCloudStorageSource>(map['cloudStorageSources'], (value) => GetServiceTemplateContainerSourceCodeCloudStorageSource.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
