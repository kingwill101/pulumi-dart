...
class GetServiceTemplateVolume {
  ...
  final pulumi.Input<List<GetServiceTemplateVolumeCloudSqlInstance>>
  cloudSqlInstances;
    ...
    return <String, dynamic>{
      'cloudSqlInstances':
          pulumi.Input.mapInputValue<
            List<GetServiceTemplateVolumeCloudSqlInstance>,
      ...
      'emptyDirs':
          pulumi.Input.mapInputValue<
            List<GetServiceTemplateVolumeEmptyDir>,
            List<Map<String, dynamic>>
          >(
            emptyDirs,
            (value) =>
      ...
      'gcs':
          pulumi.Input.mapInputValue<
            List<GetServiceTemplateVolumeGc>,
            List<Map<String, dynamic>>
          >(
            gcs,
            (value) =>
      ...
      'nfs':
          pulumi.Input.mapInputValue<
            List<GetServiceTemplateVolumeNf>,
            List<Map<String, dynamic>>
          >(
            nfs,
            (value) =>
      ...
      'secrets':
          pulumi.Input.mapInputValue<
            List<GetServiceTemplateVolumeSecret>,
            List<Map<String, dynamic>>
          >(
            secrets,
            (value) =>
  ...
  factory GetServiceTemplateVolume.fromMap(Map<String, dynamic> map) {
    return GetServiceTemplateVolume(
      ...
      emptyDirs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetServiceTemplateVolumeEmptyDir>(
          map['emptyDirs']!,
      ...
      gcs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetServiceTemplateVolumeGc>(
          map['gcs']!,
      ...
      nfs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetServiceTemplateVolumeNf>(
          map['nfs']!,
      ...
      secrets: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetServiceTemplateVolumeSecret>(
          map['secrets']!,
