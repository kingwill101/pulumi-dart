...
class GetServiceTemplateVolume {
  ...
  factory GetServiceTemplateVolume.fromMap(Map<String, dynamic> map) {
    return GetServiceTemplateVolume(
      cloudSqlInstances: (pulumi.Input.decodeList<GetServiceTemplateVolumeCloudSqlInstance>(map['cloudSqlInstances'], (value) => GetServiceTemplateVolumeCloudSqlInstance.fromMap((value as Map).cast<String, dynamic>()))).input(),
      emptyDirs: (pulumi.Input.decodeList<GetServiceTemplateVolumeEmptyDir>(map['emptyDirs'], (value) => GetServiceTemplateVolumeEmptyDir.fromMap((value as Map).cast<String, dynamic>()))).input(),
      gcs: (pulumi.Input.decodeList<GetServiceTemplateVolumeGc>(map['gcs'], (value) => GetServiceTemplateVolumeGc.fromMap((value as Map).cast<String, dynamic>()))).input(),
      name: (map['name'] as String).input(),
      nfs: (pulumi.Input.decodeList<GetServiceTemplateVolumeNf>(map['nfs'], (value) => GetServiceTemplateVolumeNf.fromMap((value as Map).cast<String, dynamic>()))).input(),
      secrets: (pulumi.Input.decodeList<GetServiceTemplateVolumeSecret>(map['secrets'], (value) => GetServiceTemplateVolumeSecret.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
