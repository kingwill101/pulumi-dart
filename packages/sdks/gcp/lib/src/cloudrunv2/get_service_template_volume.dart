...
class GetServiceTemplateVolume {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'cloudSqlInstances': pulumi.Input.encodeList<GetServiceTemplateVolumeCloudSqlInstance, Map<String, dynamic>>(cloudSqlInstances, (value) => value.toMap()),
      'emptyDirs': pulumi.Input.encodeList<GetServiceTemplateVolumeEmptyDir, Map<String, dynamic>>(emptyDirs, (value) => value.toMap()),
      'gcs': pulumi.Input.encodeList<GetServiceTemplateVolumeGc, Map<String, dynamic>>(gcs, (value) => value.toMap()),
      'name': name,
      'nfs': pulumi.Input.encodeList<GetServiceTemplateVolumeNf, Map<String, dynamic>>(nfs, (value) => value.toMap()),
      'secrets': pulumi.Input.encodeList<GetServiceTemplateVolumeSecret, Map<String, dynamic>>(secrets, (value) => value.toMap()),
    };
  }

  factory GetServiceTemplateVolume.fromMap(Map<String, dynamic> map) {
    return GetServiceTemplateVolume(
      cloudSqlInstances: pulumi.Input.decodeList<GetServiceTemplateVolumeCloudSqlInstance>(map['cloudSqlInstances'], (value) => GetServiceTemplateVolumeCloudSqlInstance.fromMap((value as Map).cast<String, dynamic>())),
      emptyDirs: pulumi.Input.decodeList<GetServiceTemplateVolumeEmptyDir>(map['emptyDirs'], (value) => GetServiceTemplateVolumeEmptyDir.fromMap((value as Map).cast<String, dynamic>())),
      gcs: pulumi.Input.decodeList<GetServiceTemplateVolumeGc>(map['gcs'], (value) => GetServiceTemplateVolumeGc.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] as String,
      nfs: pulumi.Input.decodeList<GetServiceTemplateVolumeNf>(map['nfs'], (value) => GetServiceTemplateVolumeNf.fromMap((value as Map).cast<String, dynamic>())),
      secrets: pulumi.Input.decodeList<GetServiceTemplateVolumeSecret>(map['secrets'], (value) => GetServiceTemplateVolumeSecret.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
