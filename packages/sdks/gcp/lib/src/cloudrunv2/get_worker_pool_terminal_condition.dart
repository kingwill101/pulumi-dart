...
class GetWorkerPoolTerminalCondition {
  ...
  /// Creates a new [GetWorkerPoolTerminalCondition].
  ...
  /// [reason] A common (workerPool-level) reason for this condition.
  ...
  const GetWorkerPoolTerminalCondition({
  ...
  factory GetWorkerPoolTerminalCondition.fromMap(Map<String, dynamic> map) {
    return GetWorkerPoolTerminalCondition(
