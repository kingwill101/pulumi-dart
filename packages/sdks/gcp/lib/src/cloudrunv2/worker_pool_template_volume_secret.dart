...
class WorkerPoolTemplateVolumeSecret {
  ...
  const WorkerPoolTemplateVolumeSecret({
    this.defaultMode,
    this.items,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'items': ?pulumi.Input.mapOptionalInputValue<List<WorkerPoolTemplateVolumeSecretItem>, List<Map<String, dynamic>>>(items, (value) => pulumi.Input.encodeList<WorkerPoolTemplateVolumeSecretItem, Map<String, dynamic>>(value, (value) => value.toMap())),
      'secret': secret,
    };
  }
