...
class GetServiceTemplate {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'containers': pulumi.Input.encodeList<GetServiceTemplateContainer, Map<String, dynamic>>(containers, (value) => value.toMap()),
      ...
      'nodeSelectors': pulumi.Input.encodeList<GetServiceTemplateNodeSelector, Map<String, dynamic>>(nodeSelectors, (value) => value.toMap()),
      'revision': revision,
      'scalings': pulumi.Input.encodeList<GetServiceTemplateScaling, Map<String, dynamic>>(scalings, (value) => value.toMap()),
      'serviceAccount': serviceAccount,
      'serviceMeshes': pulumi.Input.encodeList<GetServiceTemplateServiceMesh, Map<String, dynamic>>(serviceMeshes, (value) => value.toMap()),
      'sessionAffinity': sessionAffinity,
      'timeout': timeout,
      'volumes': pulumi.Input.encodeList<GetServiceTemplateVolume, Map<String, dynamic>>(volumes, (value) => value.toMap()),
      'vpcAccesses': pulumi.Input.encodeList<GetServiceTemplateVpcAccess, Map<String, dynamic>>(vpcAccesses, (value) => value.toMap()),
    };
  }
  ...
  factory GetServiceTemplate.fromMap(Map<String, dynamic> map) {
    return GetServiceTemplate(
      ...
      containers: pulumi.Input.decodeList<GetServiceTemplateContainer>(map['containers'], (value) => GetServiceTemplateContainer.fromMap((value as Map).cast<String, dynamic>())),
      ...
      nodeSelectors: pulumi.Input.decodeList<GetServiceTemplateNodeSelector>(map['nodeSelectors'], (value) => GetServiceTemplateNodeSelector.fromMap((value as Map).cast<String, dynamic>())),
      revision: map['revision'] as String,
      scalings: pulumi.Input.decodeList<GetServiceTemplateScaling>(map['scalings'], (value) => GetServiceTemplateScaling.fromMap((value as Map).cast<String, dynamic>())),
      serviceAccount: map['serviceAccount'] as String,
      serviceMeshes: pulumi.Input.decodeList<GetServiceTemplateServiceMesh>(map['serviceMeshes'], (value) => GetServiceTemplateServiceMesh.fromMap((value as Map).cast<String, dynamic>())),
      sessionAffinity: map['sessionAffinity'] as bool,
      timeout: map['timeout'] as String,
      volumes: pulumi.Input.decodeList<GetServiceTemplateVolume>(map['volumes'], (value) => GetServiceTemplateVolume.fromMap((value as Map).cast<String, dynamic>())),
      vpcAccesses: pulumi.Input.decodeList<GetServiceTemplateVpcAccess>(map['vpcAccesses'], (value) => GetServiceTemplateVpcAccess.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
