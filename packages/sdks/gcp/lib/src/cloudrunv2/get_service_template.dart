    ...
    return <String, dynamic>{
      ...
      'containers':
          pulumi.Input.mapInputValue<
            List<GetServiceTemplateContainer>,
      ...
      'nodeSelectors':
          pulumi.Input.mapInputValue<
            List<GetServiceTemplateNodeSelector>,
            List<Map<String, dynamic>>
          >(
            nodeSelectors,
            (value) =>
      ...
      'scalings':
          pulumi.Input.mapInputValue<
            List<GetServiceTemplateScaling>,
            List<Map<String, dynamic>>
          >(
            scalings,
            (value) =>
      ...
      'serviceMeshes':
          pulumi.Input.mapInputValue<
            List<GetServiceTemplateServiceMesh>,
            List<Map<String, dynamic>>
          >(
            serviceMeshes,
            (value) =>
      ...
      'vpcAccesses':
          pulumi.Input.mapInputValue<
            List<GetServiceTemplateVpcAccess>,
            List<Map<String, dynamic>>
          >(
            vpcAccesses,
            (value) =>
  ...
  factory GetServiceTemplate.fromMap(Map<String, dynamic> map) {
    return GetServiceTemplate(
      ...
      containers: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetServiceTemplateContainer>(
          map['containers']!,
      ...
      healthCheckDisabled: pulumi.Input.fromValue(
      ...
      nodeSelectors: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetServiceTemplateNodeSelector>(
          map['nodeSelectors']!,
      ...
      scalings: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetServiceTemplateScaling>(
          map['scalings']!,
      ...
      serviceMeshes: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetServiceTemplateServiceMesh>(
          map['serviceMeshes']!,
      ...
      volumes: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetServiceTemplateVolume>(
          map['volumes']!,
      ...
      vpcAccesses: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetServiceTemplateVpcAccess>(
          map['vpcAccesses']!,
