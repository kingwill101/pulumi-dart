...
class ServiceTemplateVpcAccess {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'connector': ?connector,
      'egress': ?egress,
      'networkInterfaces': ?networkInterfaces == null ? null : pulumi.Input.encodeList<ServiceTemplateVpcAccessNetworkInterface, Map<String, dynamic>>(networkInterfaces!, (value) => value.toMap()),
    };
  }
  ...
  factory ServiceTemplateVpcAccess.fromMap(Map<String, dynamic> map) {
    return ServiceTemplateVpcAccess(
      ...
      networkInterfaces: map['networkInterfaces'] == null ? null : pulumi.Input.decodeList<ServiceTemplateVpcAccessNetworkInterface>(map['networkInterfaces'], (value) => ServiceTemplateVpcAccessNetworkInterface.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
