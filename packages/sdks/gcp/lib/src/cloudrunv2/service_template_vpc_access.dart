...
class ServiceTemplateVpcAccess {
  ...
  const ServiceTemplateVpcAccess({
    this.connector,
    this.egress,
  ...
  factory ServiceTemplateVpcAccess.fromMap(Map<String, dynamic> map) {
    return ServiceTemplateVpcAccess(
      ...
      networkInterfaces: (() { final guardedValue = map['networkInterfaces']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ServiceTemplateVpcAccessNetworkInterface>(guardedValue, (value) => ServiceTemplateVpcAccessNetworkInterface.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
