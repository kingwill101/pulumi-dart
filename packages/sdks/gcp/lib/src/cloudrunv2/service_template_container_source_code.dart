...
class ServiceTemplateContainerSourceCode {
  ...
  factory ServiceTemplateContainerSourceCode.fromMap(Map<String, dynamic> map) {
    return ServiceTemplateContainerSourceCode(
      cloudStorageSource: (() { final guardedValue = map['cloudStorageSource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServiceTemplateContainerSourceCodeCloudStorageSource.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
