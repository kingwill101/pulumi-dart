...
class GetWorkerPoolTemplateContainerStartupProbe {
  ...
  final pulumi.Input<List<GetWorkerPoolTemplateContainerStartupProbeGrpc>>
  grpcs;

  /// Optional. HTTPGet specifies the http request to perform. Exactly one of httpGet, tcpSocket, or grpc must be specified.
  final pulumi.Input<List<GetWorkerPoolTemplateContainerStartupProbeHttpGet>>
  httpGets;
  ...
  final pulumi.Input<List<GetWorkerPoolTemplateContainerStartupProbeTcpSocket>>
  tcpSockets;
    ...
    return <String, dynamic>{
      ...
      'grpcs':
          pulumi.Input.mapInputValue<
            List<GetWorkerPoolTemplateContainerStartupProbeGrpc>,
      ...
      'httpGets':
          pulumi.Input.mapInputValue<
            List<GetWorkerPoolTemplateContainerStartupProbeHttpGet>,
            List<Map<String, dynamic>>
          >(
            httpGets,
            (value) =>
      ...
      'tcpSockets':
          pulumi.Input.mapInputValue<
            List<GetWorkerPoolTemplateContainerStartupProbeTcpSocket>,
            List<Map<String, dynamic>>
          >(
            tcpSockets,
            (value) =>
  ...
  factory GetWorkerPoolTemplateContainerStartupProbe.fromMap(
    ...
    return GetWorkerPoolTemplateContainerStartupProbe(
      ...
      grpcs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetWorkerPoolTemplateContainerStartupProbeGrpc>(
          map['grpcs']!,
