...
class Job extends pulumi.CustomResource {
  ...
  Job(
    ...
    this.binaryAuthorization = registerOutput<JobBinaryAuthorization?>('binaryAuthorization');
    ...
    this.latestCreatedExecutions = registerOutput<List<JobLatestCreatedExecution>>('latestCreatedExecutions');
    ...
    this.terminalConditions = registerOutput<List<JobTerminalCondition>>('terminalConditions');
