...
/// {@template pulumi_cloudrunv2_service_iam_member_service_iam_member_args_doc}
/// The set of arguments for ServiceIamMember.
/// {@endtemplate}
/// {@macro pulumi_cloudrunv2_service_iam_member_service_iam_member_args_doc}
class ServiceIamMemberArgs {
  ...
  /// Creates a new [ServiceIamMemberArgs].
  /// [condition] Optional.
  ...
  ServiceIamMemberArgs({
    pulumi.Output<ServiceIamMemberCondition>? condition,
    ...
    required pulumi.Output<String> role,
      ...
      condition = pulumi.Input.asOptionalInput<ServiceIamMemberCondition>(condition),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'condition': ?pulumi.Input.mapOptionalInputValue<ServiceIamMemberCondition, Map<String, dynamic>>(condition, (value) => value.toMap()),
      'location': ?location,
      'member': member,
      'name': ?name,
      'project': ?project,
  ...
  factory ServiceIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return ServiceIamMemberArgs(
      condition: map['condition'] == null ? null : pulumi.Output.create<ServiceIamMemberCondition>(ServiceIamMemberCondition.fromMap((map['condition'] as Map).cast<String, dynamic>())),
