...
class ServiceIamMemberArgs {
  ...
  factory ServiceIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return ServiceIamMemberArgs(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServiceIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
