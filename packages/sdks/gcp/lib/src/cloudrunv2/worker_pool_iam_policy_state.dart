...
class WorkerPoolIamPolicyState {
  ...
  /// Creates a new [WorkerPoolIamPolicyState].
  ...
  const WorkerPoolIamPolicyState({
    this.etag,
    this.location,
    this.name,
    this.policyData,
  ...
  factory WorkerPoolIamPolicyState.fromMap(Map<String, dynamic> map) {
    return WorkerPoolIamPolicyState(
