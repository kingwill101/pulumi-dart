...
class WorkerPoolArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'template': pulumi.Input.mapInputValue<WorkerPoolTemplate, Map<String, dynamic>>(template, (value) => value.toMap()),
    };
  }
  ...
  factory WorkerPoolArgs.fromMap(Map<String, dynamic> map) {
    return WorkerPoolArgs(
      ...
      binaryAuthorization: (() { final guardedValue = map['binaryAuthorization']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WorkerPoolBinaryAuthorization.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      instanceSplits: (() { final guardedValue = map['instanceSplits']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<WorkerPoolInstanceSplit>(guardedValue, (value) => WorkerPoolInstanceSplit.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      scaling: (() { final guardedValue = map['scaling']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WorkerPoolScaling.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      template: pulumi.Input.fromValue(WorkerPoolTemplate.fromMap((map['template']! as Map).cast<String, dynamic>())),
    );
  }
}
