...
class WorkerPoolArgs {
  ...
  WorkerPoolArgs({
    ...
    required pulumi.Output<WorkerPoolTemplate> template,
  }) :
      ...
      template = pulumi.Input.asInput<WorkerPoolTemplate>(template);
  ...
  factory WorkerPoolArgs.fromMap(Map<String, dynamic> map) {
    return WorkerPoolArgs(
      ...
      template: pulumi.Output.create<WorkerPoolTemplate>(WorkerPoolTemplate.fromMap((map['template'] as Map).cast<String, dynamic>())),
    );
  }
}
