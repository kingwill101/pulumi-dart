...
/// }
///
/// resource "gcp_cloudrunv2_serviceiampolicy" "policy" {
///   project     = default.project
///   location    = default.location
///   name        = default.name
...
/// }
///
/// resource "gcp_cloudrunv2_serviceiambinding" "binding" {
///   project  = default.project
///   location = default.location
///   name     = default.name
///   role     = "roles/viewer"
...
/// }
///
/// resource "gcp_cloudrunv2_serviceiammember" "member" {
///   project  = default.project
///   location = default.location
///   name     = default.name
///   role     = "roles/viewer"
...
class ServiceIamMember extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [ServiceIamMember]. {@macro pulumi_cloudrunv2_service_iam_member_service_iam_member_args_doc}
  ...
  /// Creates a typed reference to an existing [ServiceIamMember] resource.
  ServiceIamMember.reference(String urn)
    : super(
        'gcp:cloudrunv2/serviceIamMember:ServiceIamMember',
