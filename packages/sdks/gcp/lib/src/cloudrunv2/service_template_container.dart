...
class ServiceTemplateContainer {
    ...
    return <String, dynamic>{
      ...
      'buildInfos':
          ?pulumi.Input.mapOptionalInputValue<
            List<ServiceTemplateContainerBuildInfo>,
      ...
      'envs':
          ?pulumi.Input.mapOptionalInputValue<
            List<ServiceTemplateContainerEnv>,
            List<Map<String, dynamic>>
          >(
            envs,
            (value) =>
      ...
      'volumeMounts':
          ?pulumi.Input.mapOptionalInputValue<
            List<ServiceTemplateContainerVolumeMount>,
            List<Map<String, dynamic>>
          >(
            volumeMounts,
            (value) =>
  ...
  factory ServiceTemplateContainer.fromMap(Map<String, dynamic> map) {
    return ServiceTemplateContainer(
      ...
      baseImageUri: (() {
        final guardedValue = map['baseImageUri'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      buildInfos: (() {
        final guardedValue = map['buildInfos'];
        if (guardedValue == null) return null;
      ...
      sourceCode: (() {
        final guardedValue = map['sourceCode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
