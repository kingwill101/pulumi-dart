...
class GetWorkerPoolTemplateVolume {
  ...
  final pulumi.Input<List<GetWorkerPoolTemplateVolumeCloudSqlInstance>>
  cloudSqlInstances;
    ...
    return <String, dynamic>{
      'cloudSqlInstances':
          pulumi.Input.mapInputValue<
            List<GetWorkerPoolTemplateVolumeCloudSqlInstance>,
      ...
      'emptyDirs':
          pulumi.Input.mapInputValue<
            List<GetWorkerPoolTemplateVolumeEmptyDir>,
            List<Map<String, dynamic>>
          >(
            emptyDirs,
            (value) =>
      ...
      'gcs':
          pulumi.Input.mapInputValue<
            List<GetWorkerPoolTemplateVolumeGc>,
            List<Map<String, dynamic>>
          >(
            gcs,
            (value) =>
      ...
      'nfs':
          pulumi.Input.mapInputValue<
            List<GetWorkerPoolTemplateVolumeNf>,
            List<Map<String, dynamic>>
          >(
            nfs,
            (value) =>
      ...
      'secrets':
          pulumi.Input.mapInputValue<
            List<GetWorkerPoolTemplateVolumeSecret>,
            List<Map<String, dynamic>>
          >(
            secrets,
            (value) =>
  ...
  factory GetWorkerPoolTemplateVolume.fromMap(Map<String, dynamic> map) {
    return GetWorkerPoolTemplateVolume(
      cloudSqlInstances: pulumi.Input.fromValue(
      ...
      emptyDirs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetWorkerPoolTemplateVolumeEmptyDir>(
          map['emptyDirs']!,
      ...
      gcs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetWorkerPoolTemplateVolumeGc>(
          map['gcs']!,
      ...
      nfs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetWorkerPoolTemplateVolumeNf>(
          map['nfs']!,
      ...
      secrets: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetWorkerPoolTemplateVolumeSecret>(
          map['secrets']!,
