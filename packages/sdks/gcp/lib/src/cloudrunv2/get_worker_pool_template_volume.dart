...
class GetWorkerPoolTemplateVolume {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'cloudSqlInstances': pulumi.Input.encodeList<GetWorkerPoolTemplateVolumeCloudSqlInstance, Map<String, dynamic>>(cloudSqlInstances, (value) => value.toMap()),
      'emptyDirs': pulumi.Input.encodeList<GetWorkerPoolTemplateVolumeEmptyDir, Map<String, dynamic>>(emptyDirs, (value) => value.toMap()),
      'gcs': pulumi.Input.encodeList<GetWorkerPoolTemplateVolumeGc, Map<String, dynamic>>(gcs, (value) => value.toMap()),
      'name': name,
      'nfs': pulumi.Input.encodeList<GetWorkerPoolTemplateVolumeNf, Map<String, dynamic>>(nfs, (value) => value.toMap()),
      'secrets': pulumi.Input.encodeList<GetWorkerPoolTemplateVolumeSecret, Map<String, dynamic>>(secrets, (value) => value.toMap()),
    };
  }

  factory GetWorkerPoolTemplateVolume.fromMap(Map<String, dynamic> map) {
    return GetWorkerPoolTemplateVolume(
      cloudSqlInstances: pulumi.Input.decodeList<GetWorkerPoolTemplateVolumeCloudSqlInstance>(map['cloudSqlInstances'], (value) => GetWorkerPoolTemplateVolumeCloudSqlInstance.fromMap((value as Map).cast<String, dynamic>())),
      emptyDirs: pulumi.Input.decodeList<GetWorkerPoolTemplateVolumeEmptyDir>(map['emptyDirs'], (value) => GetWorkerPoolTemplateVolumeEmptyDir.fromMap((value as Map).cast<String, dynamic>())),
      gcs: pulumi.Input.decodeList<GetWorkerPoolTemplateVolumeGc>(map['gcs'], (value) => GetWorkerPoolTemplateVolumeGc.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] as String,
      nfs: pulumi.Input.decodeList<GetWorkerPoolTemplateVolumeNf>(map['nfs'], (value) => GetWorkerPoolTemplateVolumeNf.fromMap((value as Map).cast<String, dynamic>())),
      secrets: pulumi.Input.decodeList<GetWorkerPoolTemplateVolumeSecret>(map['secrets'], (value) => GetWorkerPoolTemplateVolumeSecret.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
