...
class GetWorkerPoolTemplateVolume {
  ...
  factory GetWorkerPoolTemplateVolume.fromMap(Map<String, dynamic> map) {
    return GetWorkerPoolTemplateVolume(
      cloudSqlInstances: (pulumi.Input.decodeList<GetWorkerPoolTemplateVolumeCloudSqlInstance>(map['cloudSqlInstances'], (value) => GetWorkerPoolTemplateVolumeCloudSqlInstance.fromMap((value as Map).cast<String, dynamic>()))).input(),
      emptyDirs: (pulumi.Input.decodeList<GetWorkerPoolTemplateVolumeEmptyDir>(map['emptyDirs'], (value) => GetWorkerPoolTemplateVolumeEmptyDir.fromMap((value as Map).cast<String, dynamic>()))).input(),
      gcs: (pulumi.Input.decodeList<GetWorkerPoolTemplateVolumeGc>(map['gcs'], (value) => GetWorkerPoolTemplateVolumeGc.fromMap((value as Map).cast<String, dynamic>()))).input(),
      name: (map['name'] as String).input(),
      nfs: (pulumi.Input.decodeList<GetWorkerPoolTemplateVolumeNf>(map['nfs'], (value) => GetWorkerPoolTemplateVolumeNf.fromMap((value as Map).cast<String, dynamic>()))).input(),
      secrets: (pulumi.Input.decodeList<GetWorkerPoolTemplateVolumeSecret>(map['secrets'], (value) => GetWorkerPoolTemplateVolumeSecret.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
