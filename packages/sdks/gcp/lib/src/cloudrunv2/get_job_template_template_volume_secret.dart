...
class GetJobTemplateTemplateVolumeSecret {
  ...
  factory GetJobTemplateTemplateVolumeSecret.fromMap(Map<String, dynamic> map) {
    return GetJobTemplateTemplateVolumeSecret(
      ...
      items: (pulumi.Input.decodeList<GetJobTemplateTemplateVolumeSecretItem>(map['items'], (value) => GetJobTemplateTemplateVolumeSecretItem.fromMap((value as Map).cast<String, dynamic>()))).input(),
