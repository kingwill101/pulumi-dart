...
class GetJobTerminalCondition {
  ...
  /// Creates a new [GetJobTerminalCondition].
  ...
  factory GetJobTerminalCondition.fromMap(Map<String, dynamic> map) {
    return GetJobTerminalCondition(
