...
class WorkerPoolState {
  ...
  factory WorkerPoolState.fromMap(Map<String, dynamic> map) {
    return WorkerPoolState(
      ...
      conditions: (() { final guardedValue = map['conditions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<WorkerPoolCondition>(guardedValue, (value) => WorkerPoolCondition.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      instanceSplitStatuses: (() { final guardedValue = map['instanceSplitStatuses']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<WorkerPoolInstanceSplitStatus>(guardedValue, (value) => WorkerPoolInstanceSplitStatus.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      template: (() { final guardedValue = map['template']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WorkerPoolTemplate.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      terminalConditions: (() { final guardedValue = map['terminalConditions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<WorkerPoolTerminalCondition>(guardedValue, (value) => WorkerPoolTerminalCondition.fromMap((value as Map).cast<String, dynamic>()))); })(),
