...
class GetJobTemplateTemplateContainer {
  ...
  factory GetJobTemplateTemplateContainer.fromMap(Map<String, dynamic> map) {
    return GetJobTemplateTemplateContainer(
      ...
      envs: (pulumi.Input.decodeList<GetJobTemplateTemplateContainerEnv>(map['envs'], (value) => GetJobTemplateTemplateContainerEnv.fromMap((value as Map).cast<String, dynamic>()))).input(),
      image: (map['image'] as String).input(),
      name: (map['name'] as String).input(),
      ports: (pulumi.Input.decodeList<GetJobTemplateTemplateContainerPort>(map['ports'], (value) => GetJobTemplateTemplateContainerPort.fromMap((value as Map).cast<String, dynamic>()))).input(),
      resources: (pulumi.Input.decodeList<GetJobTemplateTemplateContainerResource>(map['resources'], (value) => GetJobTemplateTemplateContainerResource.fromMap((value as Map).cast<String, dynamic>()))).input(),
      startupProbes: (pulumi.Input.decodeList<GetJobTemplateTemplateContainerStartupProbe>(map['startupProbes'], (value) => GetJobTemplateTemplateContainerStartupProbe.fromMap((value as Map).cast<String, dynamic>()))).input(),
      volumeMounts: (pulumi.Input.decodeList<GetJobTemplateTemplateContainerVolumeMount>(map['volumeMounts'], (value) => GetJobTemplateTemplateContainerVolumeMount.fromMap((value as Map).cast<String, dynamic>()))).input(),
