...
class GetJobTemplateTemplateContainer {
  ...
  final pulumi.Input<List<GetJobTemplateTemplateContainerStartupProbe>>
  startupProbes;

  /// Volume to mount into the container's filesystem.
  final pulumi.Input<List<GetJobTemplateTemplateContainerVolumeMount>>
  volumeMounts;
    ...
    return <String, dynamic>{
      ...
      'envs':
          pulumi.Input.mapInputValue<
            List<GetJobTemplateTemplateContainerEnv>,
      ...
      'ports':
          pulumi.Input.mapInputValue<
            List<GetJobTemplateTemplateContainerPort>,
            List<Map<String, dynamic>>
          >(
            ports,
            (value) =>
      ...
      'resources':
          pulumi.Input.mapInputValue<
            List<GetJobTemplateTemplateContainerResource>,
            List<Map<String, dynamic>>
          >(
            resources,
            (value) =>
      ...
      'startupProbes':
          pulumi.Input.mapInputValue<
            List<GetJobTemplateTemplateContainerStartupProbe>,
            List<Map<String, dynamic>>
          >(
            startupProbes,
            (value) =>
      ...
      'volumeMounts':
          pulumi.Input.mapInputValue<
            List<GetJobTemplateTemplateContainerVolumeMount>,
            List<Map<String, dynamic>>
          >(
            volumeMounts,
            (value) =>
  ...
  factory GetJobTemplateTemplateContainer.fromMap(Map<String, dynamic> map) {
    return GetJobTemplateTemplateContainer(
      ...
      envs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetJobTemplateTemplateContainerEnv>(
          map['envs']!,
      ...
      ports: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetJobTemplateTemplateContainerPort>(
          map['ports']!,
