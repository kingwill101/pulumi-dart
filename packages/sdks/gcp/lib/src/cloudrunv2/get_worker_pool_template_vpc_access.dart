...
class GetWorkerPoolTemplateVpcAccess {
  ...
  final pulumi.Input<List<GetWorkerPoolTemplateVpcAccessNetworkInterface>>
  networkInterfaces;
    ...
    return <String, dynamic>{
      ...
      'networkInterfaces':
          pulumi.Input.mapInputValue<
            List<GetWorkerPoolTemplateVpcAccessNetworkInterface>,
  ...
  factory GetWorkerPoolTemplateVpcAccess.fromMap(Map<String, dynamic> map) {
    return GetWorkerPoolTemplateVpcAccess(
      ...
      networkInterfaces: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetWorkerPoolTemplateVpcAccessNetworkInterface>(
