...
class GetJobTemplateTemplate {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'containers': pulumi.Input.encodeList<GetJobTemplateTemplateContainer, Map<String, dynamic>>(containers, (value) => value.toMap()),
      'encryptionKey': encryptionKey,
      'executionEnvironment': executionEnvironment,
      'gpuZonalRedundancyDisabled': gpuZonalRedundancyDisabled,
      'maxRetries': maxRetries,
      'nodeSelectors': pulumi.Input.encodeList<GetJobTemplateTemplateNodeSelector, Map<String, dynamic>>(nodeSelectors, (value) => value.toMap()),
      'serviceAccount': serviceAccount,
      'timeout': timeout,
      'volumes': pulumi.Input.encodeList<GetJobTemplateTemplateVolume, Map<String, dynamic>>(volumes, (value) => value.toMap()),
      'vpcAccesses': pulumi.Input.encodeList<GetJobTemplateTemplateVpcAccess, Map<String, dynamic>>(vpcAccesses, (value) => value.toMap()),
    };
  }

  factory GetJobTemplateTemplate.fromMap(Map<String, dynamic> map) {
    return GetJobTemplateTemplate(
      containers: pulumi.Input.decodeList<GetJobTemplateTemplateContainer>(map['containers'], (value) => GetJobTemplateTemplateContainer.fromMap((value as Map).cast<String, dynamic>())),
      ...
      nodeSelectors: pulumi.Input.decodeList<GetJobTemplateTemplateNodeSelector>(map['nodeSelectors'], (value) => GetJobTemplateTemplateNodeSelector.fromMap((value as Map).cast<String, dynamic>())),
      serviceAccount: map['serviceAccount'] as String,
      timeout: map['timeout'] as String,
      volumes: pulumi.Input.decodeList<GetJobTemplateTemplateVolume>(map['volumes'], (value) => GetJobTemplateTemplateVolume.fromMap((value as Map).cast<String, dynamic>())),
      vpcAccesses: pulumi.Input.decodeList<GetJobTemplateTemplateVpcAccess>(map['vpcAccesses'], (value) => GetJobTemplateTemplateVpcAccess.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
