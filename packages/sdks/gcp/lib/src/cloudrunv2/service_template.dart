...
class ServiceTemplate {
  ...
  factory ServiceTemplate.fromMap(Map<String, dynamic> map) {
    return ServiceTemplate(
      ...
      containers: map['containers'] == null ? null : (pulumi.Input.decodeList<ServiceTemplateContainer>(map['containers'], (value) => ServiceTemplateContainer.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      healthCheckDisabled: map['healthCheckDisabled'] == null ? null : (map['healthCheckDisabled'] as bool).input(),
      ...
      nodeSelector: map['nodeSelector'] == null ? null : (ServiceTemplateNodeSelector.fromMap((map['nodeSelector'] as Map).cast<String, dynamic>())).input(),
      revision: map['revision'] == null ? null : (map['revision'] as String).input(),
      scaling: map['scaling'] == null ? null : (ServiceTemplateScaling.fromMap((map['scaling'] as Map).cast<String, dynamic>())).input(),
      serviceAccount: map['serviceAccount'] == null ? null : (map['serviceAccount'] as String).input(),
      serviceMesh: map['serviceMesh'] == null ? null : (ServiceTemplateServiceMesh.fromMap((map['serviceMesh'] as Map).cast<String, dynamic>())).input(),
      sessionAffinity: map['sessionAffinity'] == null ? null : (map['sessionAffinity'] as bool).input(),
      timeout: map['timeout'] == null ? null : (map['timeout'] as String).input(),
      volumes: map['volumes'] == null ? null : (pulumi.Input.decodeList<ServiceTemplateVolume>(map['volumes'], (value) => ServiceTemplateVolume.fromMap((value as Map).cast<String, dynamic>()))).input(),
      vpcAccess: map['vpcAccess'] == null ? null : (ServiceTemplateVpcAccess.fromMap((map['vpcAccess'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
