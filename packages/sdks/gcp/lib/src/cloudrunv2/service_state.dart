...
class ServiceState {
  ...
  factory ServiceState.fromMap(Map<String, dynamic> map) {
    return ServiceState(
      ...
      conditions: map['conditions'] == null ? null : (pulumi.Input.decodeList<ServiceCondition>(map['conditions'], (value) => ServiceCondition.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      terminalConditions: map['terminalConditions'] == null ? null : (pulumi.Input.decodeList<ServiceTerminalCondition>(map['terminalConditions'], (value) => ServiceTerminalCondition.fromMap((value as Map).cast<String, dynamic>()))).input(),
      trafficStatuses: map['trafficStatuses'] == null ? null : (pulumi.Input.decodeList<ServiceTrafficStatus>(map['trafficStatuses'], (value) => ServiceTrafficStatus.fromMap((value as Map).cast<String, dynamic>()))).input(),
