...
class GetServiceTemplateVpcAccess {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'connector': connector,
      'egress': egress,
      'networkInterfaces': pulumi.Input.encodeList<GetServiceTemplateVpcAccessNetworkInterface, Map<String, dynamic>>(networkInterfaces, (value) => value.toMap()),
    };
  }
  ...
  factory GetServiceTemplateVpcAccess.fromMap(Map<String, dynamic> map) {
    return GetServiceTemplateVpcAccess(
      ...
      networkInterfaces: pulumi.Input.decodeList<GetServiceTemplateVpcAccessNetworkInterface>(map['networkInterfaces'], (value) => GetServiceTemplateVpcAccessNetworkInterface.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
