...
class WorkerPoolTemplate {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'containers': ?containers == null ? null : pulumi.Input.encodeList<WorkerPoolTemplateContainer, Map<String, dynamic>>(containers!, (value) => value.toMap()),
      ...
      'volumes': ?volumes == null ? null : pulumi.Input.encodeList<WorkerPoolTemplateVolume, Map<String, dynamic>>(volumes!, (value) => value.toMap()),
  ...
  factory WorkerPoolTemplate.fromMap(Map<String, dynamic> map) {
    return WorkerPoolTemplate(
      ...
      containers: map['containers'] == null ? null : pulumi.Input.decodeList<WorkerPoolTemplateContainer>(map['containers'], (value) => WorkerPoolTemplateContainer.fromMap((value as Map).cast<String, dynamic>())),
      encryptionKey: map['encryptionKey'] == null ? null : map['encryptionKey'] as String,
      encryptionKeyRevocationAction: map['encryptionKeyRevocationAction'] == null ? null : map['encryptionKeyRevocationAction'] as String,
      encryptionKeyShutdownDuration: map['encryptionKeyShutdownDuration'] == null ? null : map['encryptionKeyShutdownDuration'] as String,
      gpuZonalRedundancyDisabled: map['gpuZonalRedundancyDisabled'] == null ? null : map['gpuZonalRedundancyDisabled'] as bool,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      nodeSelector: map['nodeSelector'] == null ? null : WorkerPoolTemplateNodeSelector.fromMap((map['nodeSelector'] as Map).cast<String, dynamic>()),
      ...
      volumes: map['volumes'] == null ? null : pulumi.Input.decodeList<WorkerPoolTemplateVolume>(map['volumes'], (value) => WorkerPoolTemplateVolume.fromMap((value as Map).cast<String, dynamic>())),
      vpcAccess: map['vpcAccess'] == null ? null : WorkerPoolTemplateVpcAccess.fromMap((map['vpcAccess'] as Map).cast<String, dynamic>()),
    );
  }
}
