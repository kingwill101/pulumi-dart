    ...
    return <String, dynamic>{
      ...
      'containers':
          ?pulumi.Input.mapOptionalInputValue<
            List<WorkerPoolTemplateContainer>,
  ...
  factory WorkerPoolTemplate.fromMap(Map<String, dynamic> map) {
    return WorkerPoolTemplate(
      ...
      encryptionKeyRevocationAction: (() {
        final guardedValue = map['encryptionKeyRevocationAction'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      encryptionKeyShutdownDuration: (() {
        final guardedValue = map['encryptionKeyShutdownDuration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
