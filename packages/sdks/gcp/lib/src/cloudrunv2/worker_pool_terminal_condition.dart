...
class WorkerPoolTerminalCondition {
  /// (Output)
  ...
  /// Creates a new [WorkerPoolTerminalCondition].
  ...
  factory WorkerPoolTerminalCondition.fromMap(Map<String, dynamic> map) {
    return WorkerPoolTerminalCondition(
