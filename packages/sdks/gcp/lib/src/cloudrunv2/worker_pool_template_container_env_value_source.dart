...
class WorkerPoolTemplateContainerEnvValueSource {
  ...
  factory WorkerPoolTemplateContainerEnvValueSource.fromMap(Map<String, dynamic> map) {
    return WorkerPoolTemplateContainerEnvValueSource(
      secretKeyRef: (() { final guardedValue = map['secretKeyRef']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WorkerPoolTemplateContainerEnvValueSourceSecretKeyRef.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
