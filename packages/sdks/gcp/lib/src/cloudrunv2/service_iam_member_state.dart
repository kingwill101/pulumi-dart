...
class ServiceIamMemberState {
  ...
  /// Creates a new [ServiceIamMemberState].
  /// [condition] Optional.
  ...
  factory ServiceIamMemberState.fromMap(Map<String, dynamic> map) {
    return ServiceIamMemberState(
