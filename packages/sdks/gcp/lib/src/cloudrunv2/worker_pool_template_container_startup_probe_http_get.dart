...
class WorkerPoolTemplateContainerStartupProbeHttpGet {
  ...
  factory WorkerPoolTemplateContainerStartupProbeHttpGet.fromMap(Map<String, dynamic> map) {
    return WorkerPoolTemplateContainerStartupProbeHttpGet(
      httpHeaders: map['httpHeaders'] == null ? null : (WorkerPoolTemplateContainerStartupProbeHttpGetHttpHeaders.fromMap((map['httpHeaders']! as Map).cast<String, dynamic>())).input(),
