...
class GetServiceTemplateContainerEnvValueSource {
  ...
  factory GetServiceTemplateContainerEnvValueSource.fromMap(Map<String, dynamic> map) {
    return GetServiceTemplateContainerEnvValueSource(
      secretKeyReves: (pulumi.Input.decodeList<GetServiceTemplateContainerEnvValueSourceSecretKeyRef>(map['secretKeyReves'], (value) => GetServiceTemplateContainerEnvValueSourceSecretKeyRef.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
