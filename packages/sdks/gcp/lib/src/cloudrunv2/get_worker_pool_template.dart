    ...
    return <String, dynamic>{
      ...
      'containers':
          pulumi.Input.mapInputValue<
            List<GetWorkerPoolTemplateContainer>,
      ...
      'nodeSelectors':
          pulumi.Input.mapInputValue<
            List<GetWorkerPoolTemplateNodeSelector>,
            List<Map<String, dynamic>>
          >(
            nodeSelectors,
            (value) =>
      ...
      'volumes':
          pulumi.Input.mapInputValue<
            List<GetWorkerPoolTemplateVolume>,
            List<Map<String, dynamic>>
          >(
            volumes,
            (value) =>
      ...
      'vpcAccesses':
          pulumi.Input.mapInputValue<
            List<GetWorkerPoolTemplateVpcAccess>,
            List<Map<String, dynamic>>
          >(
            vpcAccesses,
            (value) =>
  ...
  factory GetWorkerPoolTemplate.fromMap(Map<String, dynamic> map) {
    return GetWorkerPoolTemplate(
      ...
      containers: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetWorkerPoolTemplateContainer>(
          map['containers']!,
      ...
      encryptionKeyRevocationAction: pulumi.Input.fromValue(
        map['encryptionKeyRevocationAction'] as String,
      ),
      encryptionKeyShutdownDuration: pulumi.Input.fromValue(
      ...
      nodeSelectors: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetWorkerPoolTemplateNodeSelector>(
          map['nodeSelectors']!,
      ...
      volumes: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetWorkerPoolTemplateVolume>(
          map['volumes']!,
      ...
      vpcAccesses: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetWorkerPoolTemplateVpcAccess>(
          map['vpcAccesses']!,
