...
class GetWorkerPoolTemplate {
  ...
  factory GetWorkerPoolTemplate.fromMap(Map<String, dynamic> map) {
    return GetWorkerPoolTemplate(
      ...
      containers: (pulumi.Input.decodeList<GetWorkerPoolTemplateContainer>(map['containers'], (value) => GetWorkerPoolTemplateContainer.fromMap((value as Map).cast<String, dynamic>()))).input(),
      encryptionKey: (map['encryptionKey'] as String).input(),
      encryptionKeyRevocationAction: (map['encryptionKeyRevocationAction'] as String).input(),
      encryptionKeyShutdownDuration: (map['encryptionKeyShutdownDuration'] as String).input(),
      gpuZonalRedundancyDisabled: (map['gpuZonalRedundancyDisabled'] as bool).input(),
      labels: ((map['labels'] as Map).cast<String, String>()).input(),
      nodeSelectors: (pulumi.Input.decodeList<GetWorkerPoolTemplateNodeSelector>(map['nodeSelectors'], (value) => GetWorkerPoolTemplateNodeSelector.fromMap((value as Map).cast<String, dynamic>()))).input(),
      revision: (map['revision'] as String).input(),
      serviceAccount: (map['serviceAccount'] as String).input(),
      volumes: (pulumi.Input.decodeList<GetWorkerPoolTemplateVolume>(map['volumes'], (value) => GetWorkerPoolTemplateVolume.fromMap((value as Map).cast<String, dynamic>()))).input(),
      vpcAccesses: (pulumi.Input.decodeList<GetWorkerPoolTemplateVpcAccess>(map['vpcAccesses'], (value) => GetWorkerPoolTemplateVpcAccess.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
