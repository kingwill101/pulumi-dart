...
class ServiceTemplateScaling {
  ...
  factory ServiceTemplateScaling.fromMap(Map<String, dynamic> map) {
    return ServiceTemplateScaling(
      concurrencyUtilization: (() { final guardedValue = map['concurrencyUtilization']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as double); })(),
