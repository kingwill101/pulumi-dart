...
class JobTemplateTemplateVpcAccess {
  ...
  final pulumi.Input<List<JobTemplateTemplateVpcAccessNetworkInterface>>?
  networkInterfaces;
    ...
    return <String, dynamic>{
      ...
      'networkInterfaces':
          ?pulumi.Input.mapOptionalInputValue<
            List<JobTemplateTemplateVpcAccessNetworkInterface>,
    ...
    return JobTemplateTemplateVpcAccess(
      ...
      networkInterfaces: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<JobTemplateTemplateVpcAccessNetworkInterface>(
            guardedValue,
