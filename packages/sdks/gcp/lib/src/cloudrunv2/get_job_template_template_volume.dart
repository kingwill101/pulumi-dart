...
class GetJobTemplateTemplateVolume {
  ...
  final pulumi.Input<List<GetJobTemplateTemplateVolumeCloudSqlInstance>>
  cloudSqlInstances;
    ...
    return <String, dynamic>{
      'cloudSqlInstances':
          pulumi.Input.mapInputValue<
            List<GetJobTemplateTemplateVolumeCloudSqlInstance>,
      ...
      'emptyDirs':
          pulumi.Input.mapInputValue<
            List<GetJobTemplateTemplateVolumeEmptyDir>,
            List<Map<String, dynamic>>
          >(
            emptyDirs,
            (value) =>
      ...
      'gcs':
          pulumi.Input.mapInputValue<
            List<GetJobTemplateTemplateVolumeGc>,
            List<Map<String, dynamic>>
          >(
            gcs,
            (value) =>
      ...
      'nfs':
          pulumi.Input.mapInputValue<
            List<GetJobTemplateTemplateVolumeNf>,
            List<Map<String, dynamic>>
          >(
            nfs,
            (value) =>
      ...
      'secrets':
          pulumi.Input.mapInputValue<
            List<GetJobTemplateTemplateVolumeSecret>,
            List<Map<String, dynamic>>
          >(
            secrets,
            (value) =>
  ...
  factory GetJobTemplateTemplateVolume.fromMap(Map<String, dynamic> map) {
    return GetJobTemplateTemplateVolume(
      ...
      emptyDirs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetJobTemplateTemplateVolumeEmptyDir>(
          map['emptyDirs']!,
      ...
      gcs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetJobTemplateTemplateVolumeGc>(
          map['gcs']!,
      ...
      nfs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetJobTemplateTemplateVolumeNf>(
          map['nfs']!,
      ...
      secrets: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetJobTemplateTemplateVolumeSecret>(
          map['secrets']!,
