...
import 'worker_pool_iam_binding_condition.dart';
import 'worker_pool_iam_binding_state.dart';
...
class WorkerPoolIamBinding extends pulumi.CustomResource {
  late final pulumi.Output<WorkerPoolIamBindingCondition?> condition;
  ...
  /// Creates a new [WorkerPoolIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [WorkerPoolIamBinding]. {@macro pulumi_cloudrunv2_worker_pool_iam_binding_worker_pool_iam_binding_args_doc}
  ...
  WorkerPoolIamBinding(
    ...
    condition = registerOutput<WorkerPoolIamBindingCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return WorkerPoolIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [WorkerPoolIamBinding] resource's state with the given [name] and [id].
  static WorkerPoolIamBinding get(
    String name,
    pulumi.Input<String> id, {
    WorkerPoolIamBindingState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return WorkerPoolIamBinding._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [WorkerPoolIamBinding] resource.
  WorkerPoolIamBinding.reference(String urn)
    : super(
        'gcp:cloudrunv2/workerPoolIamBinding:WorkerPoolIamBinding',
