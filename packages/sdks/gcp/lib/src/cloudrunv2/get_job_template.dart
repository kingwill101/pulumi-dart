...
import 'get_job_template_template.dart';
...
class GetJobTemplate {
  ...
  final pulumi.Input<List<GetJobTemplateTemplate>> templates;
  ...
  /// [templates] Describes the task(s) that will be created when executing an execution
  GetJobTemplate({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'taskCount': taskCount,
      'templates': pulumi.Input.mapInputValue<List<GetJobTemplateTemplate>, List<Map<String, dynamic>>>(templates, (value) => pulumi.Input.encodeList<GetJobTemplateTemplate, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory GetJobTemplate.fromMap(Map<String, dynamic> map) {
    return GetJobTemplate(
      ...
      templates: (pulumi.Input.decodeList<GetJobTemplateTemplate>(map['templates'], (value) => GetJobTemplateTemplate.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
