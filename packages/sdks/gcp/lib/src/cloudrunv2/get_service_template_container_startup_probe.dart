...
class GetServiceTemplateContainerStartupProbe {
  ...
  final pulumi.Input<List<GetServiceTemplateContainerStartupProbeHttpGet>>
  httpGets;
  ...
  final pulumi.Input<List<GetServiceTemplateContainerStartupProbeTcpSocket>>
  tcpSockets;
    ...
    return <String, dynamic>{
      ...
      'grpcs':
          pulumi.Input.mapInputValue<
            List<GetServiceTemplateContainerStartupProbeGrpc>,
      ...
      'httpGets':
          pulumi.Input.mapInputValue<
            List<GetServiceTemplateContainerStartupProbeHttpGet>,
            List<Map<String, dynamic>>
          >(
            httpGets,
            (value) =>
      ...
      'tcpSockets':
          pulumi.Input.mapInputValue<
            List<GetServiceTemplateContainerStartupProbeTcpSocket>,
            List<Map<String, dynamic>>
          >(
            tcpSockets,
            (value) =>
  ...
  factory GetServiceTemplateContainerStartupProbe.fromMap(
    ...
    return GetServiceTemplateContainerStartupProbe(
      ...
      grpcs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetServiceTemplateContainerStartupProbeGrpc>(
          map['grpcs']!,
      ...
      httpGets: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetServiceTemplateContainerStartupProbeHttpGet>(
          map['httpGets']!,
      ...
      tcpSockets: pulumi.Input.fromValue(
        pulumi
          ...
          map['tcpSockets']!,
          (value) => GetServiceTemplateContainerStartupProbeTcpSocket.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
