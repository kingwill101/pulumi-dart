...
class GetControlProjectIntelligenceFindingThrottledRequestsSpikeTopBucketContributionTopPrefix {
  ...
  /// Creates a new [GetControlProjectIntelligenceFindingThrottledRequestsSpikeTopBucketContributionTopPrefix].
  ...
  const GetControlProjectIntelligenceFindingThrottledRequestsSpikeTopBucketContributionTopPrefix({
  ...
  factory GetControlProjectIntelligenceFindingThrottledRequestsSpikeTopBucketContributionTopPrefix.fromMap(Map<String, dynamic> map) {
    return GetControlProjectIntelligenceFindingThrottledRequestsSpikeTopBucketContributionTopPrefix(
