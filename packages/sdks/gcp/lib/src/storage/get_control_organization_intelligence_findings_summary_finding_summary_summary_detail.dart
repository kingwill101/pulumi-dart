...
class GetControlOrganizationIntelligenceFindingsSummaryFindingSummarySummaryDetail {
  ...
  /// Creates a new [GetControlOrganizationIntelligenceFindingsSummaryFindingSummarySummaryDetail].
  ...
  const GetControlOrganizationIntelligenceFindingsSummaryFindingSummarySummaryDetail({
    required this.count,
  ...
  factory GetControlOrganizationIntelligenceFindingsSummaryFindingSummarySummaryDetail.fromMap(Map<String, dynamic> map) {
    return GetControlOrganizationIntelligenceFindingsSummaryFindingSummarySummaryDetail(
