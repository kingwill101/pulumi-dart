...
class TransferJobReplicationSpecTransferOptions {
  ...
  /// [overwriteWhen] When to overwrite objects that already exist in the sink. If not set, overwrite behavior is determined by `overwriteObjectsAlreadyExistingInSink`. Possible values: ALWAYS, DIFFERENT, NEVER.
  const TransferJobReplicationSpecTransferOptions({
