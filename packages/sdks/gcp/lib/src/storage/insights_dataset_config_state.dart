...
class InsightsDatasetConfigState {
  ...
  InsightsDatasetConfigState({
    ...
    pulumi.Output<String>? datasetConfigId,
    pulumi.Output<String>? datasetConfigState,
    ...
    pulumi.Output<InsightsDatasetConfigIdentity>? identity,
    ...
    pulumi.Output<String>? updateTime,
      ...
      datasetConfigId = pulumi.Input.asOptionalInput<String>(datasetConfigId),
      datasetConfigState = pulumi.Input.asOptionalInput<String>(datasetConfigState),
      ...
      identity = pulumi.Input.asOptionalInput<InsightsDatasetConfigIdentity>(identity),
      ...
      links = pulumi.Input.asOptionalInput<List<InsightsDatasetConfigLink>>(links),
      ...
      retentionPeriodDays = pulumi.Input.asOptionalInput<int>(retentionPeriodDays),
  ...
  factory InsightsDatasetConfigState.fromMap(Map<String, dynamic> map) {
    return InsightsDatasetConfigState(
      ...
      datasetConfigId: map['datasetConfigId'] == null ? null : pulumi.Output.create<String>(map['datasetConfigId'] as String),
      datasetConfigState: map['datasetConfigState'] == null ? null : pulumi.Output.create<String>(map['datasetConfigState'] as String),
      ...
      identity: map['identity'] == null ? null : pulumi.Output.create<InsightsDatasetConfigIdentity>(InsightsDatasetConfigIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>())),
      ...
      links: map['links'] == null ? null : pulumi.Output.create<List<InsightsDatasetConfigLink>>(pulumi.Input.decodeList<InsightsDatasetConfigLink>(map['links'], (value) => InsightsDatasetConfigLink.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      retentionPeriodDays: map['retentionPeriodDays'] == null ? null : pulumi.Output.create<int>(map['retentionPeriodDays'] as int),
