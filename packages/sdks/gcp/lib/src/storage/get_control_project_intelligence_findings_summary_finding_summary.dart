...
import 'get_control_project_intelligence_findings_summary_finding_summary_summary_detail.dart';

class GetControlProjectIntelligenceFindingsSummaryFindingSummary {
  ...
  final pulumi.Input<List<GetControlProjectIntelligenceFindingsSummaryFindingSummarySummaryDetail>> summaryDetails;
  ...
  /// Creates a new [GetControlProjectIntelligenceFindingsSummaryFindingSummary].
  ...
  const GetControlProjectIntelligenceFindingsSummaryFindingSummary({
  ...
  factory GetControlProjectIntelligenceFindingsSummaryFindingSummary.fromMap(Map<String, dynamic> map) {
    return GetControlProjectIntelligenceFindingsSummaryFindingSummary(
      category: pulumi.Input.fromValue(map['category'] as String),
      createTime: pulumi.Input.fromValue(map['createTime'] as String),
      severity: pulumi.Input.fromValue(map['severity'] as String),
      summaryDetails: pulumi.Input.fromValue(pulumi.Input.decodeList<GetControlProjectIntelligenceFindingsSummaryFindingSummarySummaryDetail>(map['summaryDetails']!, (value) => GetControlProjectIntelligenceFindingsSummaryFindingSummarySummaryDetail.fromMap((value as Map).cast<String, dynamic>()))),
