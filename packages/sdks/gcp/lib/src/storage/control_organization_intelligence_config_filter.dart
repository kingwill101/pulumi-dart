...
class ControlOrganizationIntelligenceConfigFilter {
  ...
  const ControlOrganizationIntelligenceConfigFilter({
  ...
  factory ControlOrganizationIntelligenceConfigFilter.fromMap(Map<String, dynamic> map) {
    return ControlOrganizationIntelligenceConfigFilter(
      excludedCloudStorageBuckets: (() { final guardedValue = map['excludedCloudStorageBuckets']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ControlOrganizationIntelligenceConfigFilterExcludedCloudStorageBuckets.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      excludedCloudStorageLocations: (() { final guardedValue = map['excludedCloudStorageLocations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ControlOrganizationIntelligenceConfigFilterExcludedCloudStorageLocations.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      includedCloudStorageBuckets: (() { final guardedValue = map['includedCloudStorageBuckets']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ControlOrganizationIntelligenceConfigFilterIncludedCloudStorageBuckets.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      includedCloudStorageLocations: (() { final guardedValue = map['includedCloudStorageLocations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ControlOrganizationIntelligenceConfigFilterIncludedCloudStorageLocations.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
