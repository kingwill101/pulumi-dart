...
class BucketObjectContexts {
  ...
  factory BucketObjectContexts.fromMap(Map<String, dynamic> map) {
    return BucketObjectContexts(
      customs: pulumi.Input.fromValue(pulumi.Input.decodeList<BucketObjectContextsCustom>(map['customs']!, (value) => BucketObjectContextsCustom.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
