...
class InsightsDatasetConfig extends pulumi.CustomResource {
  ...
  InsightsDatasetConfig(
    ...
    this.activityDataRetentionPeriodDays = registerOutput<int>('activityDataRetentionPeriodDays');
    ...
    this.excludeCloudStorageBuckets = registerOutput<InsightsDatasetConfigExcludeCloudStorageBuckets?>('excludeCloudStorageBuckets');
    this.excludeCloudStorageLocations = registerOutput<InsightsDatasetConfigExcludeCloudStorageLocations?>('excludeCloudStorageLocations');
    this.identity = registerOutput<InsightsDatasetConfigIdentity>('identity');
    this.includeCloudStorageBuckets = registerOutput<InsightsDatasetConfigIncludeCloudStorageBuckets?>('includeCloudStorageBuckets');
    this.includeCloudStorageLocations = registerOutput<InsightsDatasetConfigIncludeCloudStorageLocations?>('includeCloudStorageLocations');
    this.includeNewlyCreatedBuckets = registerOutput<bool?>('includeNewlyCreatedBuckets');
    ...
    this.sourceFolders = registerOutput<InsightsDatasetConfigSourceFolders?>('sourceFolders');
    this.sourceProjects = registerOutput<InsightsDatasetConfigSourceProjects?>('sourceProjects');
