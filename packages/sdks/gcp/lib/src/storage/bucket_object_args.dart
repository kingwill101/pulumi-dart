...
class BucketObjectArgs {
  ...
  factory BucketObjectArgs.fromMap(Map<String, dynamic> map) {
    return BucketObjectArgs(
      ...
      customerEncryption: (() {
        final guardedValue = map['customerEncryption'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      eventBasedHold: (() {
        final guardedValue = map['eventBasedHold'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      forceEmptyContentType: (() {
        final guardedValue = map['forceEmptyContentType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      kmsKeyName: (() {
      ...
      sourceMd5hash: (() {
        final guardedValue = map['sourceMd5hash'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      storageClass: (() {
