...
class BucketSoftDeletePolicy {
  ...
  factory BucketSoftDeletePolicy.fromMap(Map<String, dynamic> map) {
    return BucketSoftDeletePolicy(
      ...
      retentionDurationSeconds: (() { final guardedValue = map['retentionDurationSeconds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
    );
  }
}
