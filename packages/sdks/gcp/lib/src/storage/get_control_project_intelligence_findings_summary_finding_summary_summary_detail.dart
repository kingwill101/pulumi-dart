...
class GetControlProjectIntelligenceFindingsSummaryFindingSummarySummaryDetail {
  ...
  /// Creates a new [GetControlProjectIntelligenceFindingsSummaryFindingSummarySummaryDetail].
  ...
  const GetControlProjectIntelligenceFindingsSummaryFindingSummarySummaryDetail({
    required this.count,
  ...
  factory GetControlProjectIntelligenceFindingsSummaryFindingSummarySummaryDetail.fromMap(Map<String, dynamic> map) {
