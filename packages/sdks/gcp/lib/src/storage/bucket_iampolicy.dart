...
import 'bucket_iampolicy_state.dart';
...
class BucketIAMPolicy extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [BucketIAMPolicy]. {@macro pulumi_storage_bucket_iampolicy_bucket_iampolicy_args_doc}
  ...
  /// Gets an existing [BucketIAMPolicy] resource's state with the given [name] and [id].
  static BucketIAMPolicy get(
    String name,
