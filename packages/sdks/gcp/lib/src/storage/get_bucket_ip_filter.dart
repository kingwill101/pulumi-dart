...
class GetBucketIpFilter {
  ...
  factory GetBucketIpFilter.fromMap(Map<String, dynamic> map) {
    return GetBucketIpFilter(
      allowAllServiceAgentAccess: pulumi.Input.fromValue(map['allowAllServiceAgentAccess'] as bool),
      allowCrossOrgVpcs: pulumi.Input.fromValue(map['allowCrossOrgVpcs'] as bool),
      mode: pulumi.Input.fromValue(map['mode'] as String),
      publicNetworkSources: pulumi.Input.fromValue(pulumi.Input.decodeList<GetBucketIpFilterPublicNetworkSource>(map['publicNetworkSources']!, (value) => GetBucketIpFilterPublicNetworkSource.fromMap((value as Map).cast<String, dynamic>()))),
      vpcNetworkSources: pulumi.Input.fromValue(pulumi.Input.decodeList<GetBucketIpFilterVpcNetworkSource>(map['vpcNetworkSources']!, (value) => GetBucketIpFilterVpcNetworkSource.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
