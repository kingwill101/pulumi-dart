...
class NotificationState {
  ...
  factory NotificationState.fromMap(Map<String, dynamic> map) {
    return NotificationState(
      ...
      notificationId: (() { final guardedValue = map['notificationId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      payloadFormat: (() { final guardedValue = map['payloadFormat']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
