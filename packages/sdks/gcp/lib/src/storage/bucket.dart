...
class Bucket extends pulumi.CustomResource {
  ...
  Bucket(
    ...
    this.customPlacementConfig = registerOutput<BucketCustomPlacementConfig?>('customPlacementConfig');
    ...
    this.hierarchicalNamespace = registerOutput<BucketHierarchicalNamespace?>('hierarchicalNamespace');
    ...
    this.publicAccessPrevention = registerOutput<String>('publicAccessPrevention');
    this.pulumiLabels = registerOutput<Map<String, String>>('pulumiLabels');
    this.requesterPays = registerOutput<bool?>('requesterPays');
    this.retentionPolicy = registerOutput<BucketRetentionPolicy?>('retentionPolicy');
    this.rpo = registerOutput<String>('rpo');
    this.selfLink = registerOutput<String>('selfLink');
    this.softDeletePolicy = registerOutput<BucketSoftDeletePolicy>('softDeletePolicy');
    this.storageClass = registerOutput<String?>('storageClass');
    this.timeCreated = registerOutput<String>('timeCreated');
    this.uniformBucketLevelAccess = registerOutput<bool>('uniformBucketLevelAccess');
