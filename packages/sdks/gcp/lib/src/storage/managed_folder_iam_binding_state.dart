...
class ManagedFolderIamBindingState {
  ...
  /// Creates a new [ManagedFolderIamBindingState].
  ...
  const ManagedFolderIamBindingState({
    this.bucket,
    this.condition,
    this.etag,
    this.managedFolder,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'bucket': ?bucket,
      'condition': ?pulumi.Input.mapOptionalInputValue<ManagedFolderIamBindingCondition, Map<String, dynamic>>(condition, (value) => value.toMap()),
      'etag': ?etag,
  ...
  factory ManagedFolderIamBindingState.fromMap(Map<String, dynamic> map) {
    return ManagedFolderIamBindingState(
      ...
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagedFolderIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
