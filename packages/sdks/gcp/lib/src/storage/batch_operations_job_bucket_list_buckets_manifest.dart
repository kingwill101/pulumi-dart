...
class BatchOperationsJobBucketListBucketsManifest {
  ...
  BatchOperationsJobBucketListBucketsManifest({this.manifestLocation});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'manifestLocation': ?manifestLocation};
  }
  ...
  factory BatchOperationsJobBucketListBucketsManifest.fromMap(
    ...
    return BatchOperationsJobBucketListBucketsManifest(
      manifestLocation: (() {
        final guardedValue = map['manifestLocation'];
