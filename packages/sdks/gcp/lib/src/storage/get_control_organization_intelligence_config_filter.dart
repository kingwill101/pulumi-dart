...
class GetControlOrganizationIntelligenceConfigFilter {
  ...
  factory GetControlOrganizationIntelligenceConfigFilter.fromMap(Map<String, dynamic> map) {
    return GetControlOrganizationIntelligenceConfigFilter(
      excludedCloudStorageBuckets: (pulumi.Input.decodeList<GetControlOrganizationIntelligenceConfigFilterExcludedCloudStorageBucket>(map['excludedCloudStorageBuckets'], (value) => GetControlOrganizationIntelligenceConfigFilterExcludedCloudStorageBucket.fromMap((value as Map).cast<String, dynamic>()))).input(),
      excludedCloudStorageLocations: (pulumi.Input.decodeList<GetControlOrganizationIntelligenceConfigFilterExcludedCloudStorageLocation>(map['excludedCloudStorageLocations'], (value) => GetControlOrganizationIntelligenceConfigFilterExcludedCloudStorageLocation.fromMap((value as Map).cast<String, dynamic>()))).input(),
      includedCloudStorageBuckets: (pulumi.Input.decodeList<GetControlOrganizationIntelligenceConfigFilterIncludedCloudStorageBucket>(map['includedCloudStorageBuckets'], (value) => GetControlOrganizationIntelligenceConfigFilterIncludedCloudStorageBucket.fromMap((value as Map).cast<String, dynamic>()))).input(),
      includedCloudStorageLocations: (pulumi.Input.decodeList<GetControlOrganizationIntelligenceConfigFilterIncludedCloudStorageLocation>(map['includedCloudStorageLocations'], (value) => GetControlOrganizationIntelligenceConfigFilterIncludedCloudStorageLocation.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
