...
class BatchOperationsJob extends pulumi.CustomResource {
  ...
  BatchOperationsJob(
    ...
    this.bucketList = registerOutput<BatchOperationsJobBucketList?>('bucketList');
    this.completeTime = registerOutput<String>('completeTime');
    this.createTime = registerOutput<String>('createTime');
    this.deleteObject = registerOutput<BatchOperationsJobDeleteObject?>('deleteObject');
    this.deleteProtection = registerOutput<bool?>('deleteProtection');
    this.jobId = registerOutput<String?>('jobId');
    this.project = registerOutput<String>('project');
    this.putMetadata = registerOutput<BatchOperationsJobPutMetadata?>('putMetadata');
    this.putObjectHold = registerOutput<BatchOperationsJobPutObjectHold?>('putObjectHold');
    this.rewriteObject = registerOutput<BatchOperationsJobRewriteObject?>('rewriteObject');
