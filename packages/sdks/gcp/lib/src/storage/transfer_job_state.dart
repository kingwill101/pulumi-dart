...
class TransferJobState {
    ...
    return <String, dynamic>{
      ...
      'replicationSpec':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(replicationSpec, (value) => value.toMap()),
      'schedule':
          ?pulumi.Input.mapOptionalInputValue<
            TransferJobSchedule,
            Map<String, dynamic>
      ...
      'transferSpec':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(transferSpec, (value) => value.toMap()),
    };
  }
  ...
  factory TransferJobState.fromMap(Map<String, dynamic> map) {
    return TransferJobState(
      ...
      eventStream: (() {
        final guardedValue = map['eventStream'];
        if (guardedValue == null) return null;
      ...
      lastModificationTime: (() {
        final guardedValue = map['lastModificationTime'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      loggingConfig: (() {
      ...
      replicationSpec: (() {
        final guardedValue = map['replicationSpec'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      transferSpec: (() {
        final guardedValue = map['transferSpec'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
