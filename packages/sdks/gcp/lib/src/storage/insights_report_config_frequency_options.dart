...
class InsightsReportConfigFrequencyOptions {
  ...
  factory InsightsReportConfigFrequencyOptions.fromMap(Map<String, dynamic> map) {
    return InsightsReportConfigFrequencyOptions(
      endDate: pulumi.Input.fromValue(InsightsReportConfigFrequencyOptionsEndDate.fromMap((map['endDate']! as Map).cast<String, dynamic>())),
      frequency: pulumi.Input.fromValue(map['frequency'] as String),
      startDate: pulumi.Input.fromValue(InsightsReportConfigFrequencyOptionsStartDate.fromMap((map['startDate']! as Map).cast<String, dynamic>())),
    );
  }
}
