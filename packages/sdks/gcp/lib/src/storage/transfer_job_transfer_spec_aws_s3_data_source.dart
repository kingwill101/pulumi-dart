...
class TransferJobTransferSpecAwsS3DataSource {
  ...
  final pulumi.Input<TransferJobTransferSpecAwsS3DataSourceAwsAccessKey>?
  awsAccessKey;
    ...
    return <String, dynamic>{
      'awsAccessKey':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(awsAccessKey, (value) => value.toMap()),
  ...
  factory TransferJobTransferSpecAwsS3DataSource.fromMap(
    ...
    return TransferJobTransferSpecAwsS3DataSource(
      ...
      cloudfrontDomain: (() {
        final guardedValue = map['cloudfrontDomain'];
        if (guardedValue == null) return null;
      ...
      managedPrivateNetwork: (() {
        final guardedValue = map['managedPrivateNetwork'];
        if (guardedValue == null) return null;
