...
class BucketArgs {
    ...
    return <String, dynamic>{
      ...
      'hierarchicalNamespace':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(hierarchicalNamespace, (value) => value.toMap()),
      'ipFilter':
          ?pulumi.Input.mapOptionalInputValue<
            BucketIpFilter,
            Map<String, dynamic>
          >(ipFilter, (value) => value.toMap()),
      'labels': ?labels,
      'lifecycleRules':
          ?pulumi.Input.mapOptionalInputValue<
  ...
  factory BucketArgs.fromMap(Map<String, dynamic> map) {
    return BucketArgs(
      ...
      hierarchicalNamespace: (() {
        final guardedValue = map['hierarchicalNamespace'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      ipFilter: (() {
        final guardedValue = map['ipFilter'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          BucketIpFilter.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      labels: (() {
      ...
      publicAccessPrevention: (() {
        final guardedValue = map['publicAccessPrevention'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      requesterPays: (() {
      ...
      uniformBucketLevelAccess: (() {
        final guardedValue = map['uniformBucketLevelAccess'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      versioning: (() {
