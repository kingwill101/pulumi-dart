...
class GetControlProjectIntelligenceFindingsFindingStorageGrowthAboveTrendTopBucketContributionTopPrefix {
  ...
  /// Creates a new [GetControlProjectIntelligenceFindingsFindingStorageGrowthAboveTrendTopBucketContributionTopPrefix].
  ...
  const GetControlProjectIntelligenceFindingsFindingStorageGrowthAboveTrendTopBucketContributionTopPrefix({
  ...
  factory GetControlProjectIntelligenceFindingsFindingStorageGrowthAboveTrendTopBucketContributionTopPrefix.fromMap(Map<String, dynamic> map) {
    return GetControlProjectIntelligenceFindingsFindingStorageGrowthAboveTrendTopBucketContributionTopPrefix(
