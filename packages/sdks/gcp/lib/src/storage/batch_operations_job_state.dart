...
class BatchOperationsJobState {
  ...
  factory BatchOperationsJobState.fromMap(Map<String, dynamic> map) {
    return BatchOperationsJobState(
      bucketList: (() { final guardedValue = map['bucketList']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BatchOperationsJobBucketList.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      putObjectHold: (() { final guardedValue = map['putObjectHold']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BatchOperationsJobPutObjectHold.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      rewriteObject: (() { final guardedValue = map['rewriteObject']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BatchOperationsJobRewriteObject.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
