...
class TransferJobTransferSpec {
  ...
  /// [objectConditions] Only objects that satisfy these object conditions are included in the set of data source and data sink objects. Object conditions based on objects' `lastModificationTime` do not exclude objects in a data sink. Structure documented below.
  ...
  /// [transferOptions] Characteristics of how to treat files from datasource and sink during job. If the option `deleteObjectsUniqueInSink` is true, object conditions based on objects' `lastModificationTime` are ignored and do not exclude objects in a data source or a data sink. Structure documented below.
  ...
  factory TransferJobTransferSpec.fromMap(Map<String, dynamic> map) {
    return TransferJobTransferSpec(
      awsS3CompatibleDataSource: (() { final guardedValue = map['awsS3CompatibleDataSource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TransferJobTransferSpecAwsS3CompatibleDataSource.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      awsS3DataSource: (() { final guardedValue = map['awsS3DataSource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TransferJobTransferSpecAwsS3DataSource.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      azureBlobStorageDataSource: (() { final guardedValue = map['azureBlobStorageDataSource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TransferJobTransferSpecAzureBlobStorageDataSource.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      gcsDataSink: (() { final guardedValue = map['gcsDataSink']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TransferJobTransferSpecGcsDataSink.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      gcsDataSource: (() { final guardedValue = map['gcsDataSource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TransferJobTransferSpecGcsDataSource.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      hdfsDataSource: (() { final guardedValue = map['hdfsDataSource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TransferJobTransferSpecHdfsDataSource.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      httpDataSource: (() { final guardedValue = map['httpDataSource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TransferJobTransferSpecHttpDataSource.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      objectConditions: (() { final guardedValue = map['objectConditions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TransferJobTransferSpecObjectConditions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      posixDataSink: (() { final guardedValue = map['posixDataSink']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TransferJobTransferSpecPosixDataSink.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      posixDataSource: (() { final guardedValue = map['posixDataSource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TransferJobTransferSpecPosixDataSource.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      transferManifest: (() { final guardedValue = map['transferManifest']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TransferJobTransferSpecTransferManifest.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      transferOptions: (() { final guardedValue = map['transferOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TransferJobTransferSpecTransferOptions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
