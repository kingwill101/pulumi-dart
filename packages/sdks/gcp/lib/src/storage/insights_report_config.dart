...
import 'insights_report_config_state.dart';
...
class InsightsReportConfig extends pulumi.CustomResource {
  ...
  /// Gets an existing [InsightsReportConfig] resource's state with the given [name] and [id].
  static InsightsReportConfig get(
    String name,
