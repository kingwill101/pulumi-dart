...
import 'get_control_project_intelligence_finding_throttled_requests_spike_top_bucket_contribution.dart';
import 'get_control_project_intelligence_finding_throttled_requests_spike_top_bucket_error.dart';

class GetControlProjectIntelligenceFindingThrottledRequestsSpikeTopBucket {
  /// The resource name of the bucket.
  final pulumi.Input<String> bucket;
  /// The breakdown of prefixes contributing to the spike. Structure is documented below.
  final pulumi.Input<List<GetControlProjectIntelligenceFindingThrottledRequestsSpikeTopBucketContribution>> contributions;
  /// Error details if the bucket details cannot be retrieved. Structure is documented below.
  final pulumi.Input<List<GetControlProjectIntelligenceFindingThrottledRequestsSpikeTopBucketError>> errors;
  ...
  /// Creates a new [GetControlProjectIntelligenceFindingThrottledRequestsSpikeTopBucket].
  ...
  const GetControlProjectIntelligenceFindingThrottledRequestsSpikeTopBucket({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'errors': pulumi.Input.mapInputValue<List<GetControlProjectIntelligenceFindingThrottledRequestsSpikeTopBucketError>, List<Map<String, dynamic>>>(errors, (value) => pulumi.Input.encodeList<GetControlProjectIntelligenceFindingThrottledRequestsSpikeTopBucketError, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory GetControlProjectIntelligenceFindingThrottledRequestsSpikeTopBucket.fromMap(Map<String, dynamic> map) {
    return GetControlProjectIntelligenceFindingThrottledRequestsSpikeTopBucket(
