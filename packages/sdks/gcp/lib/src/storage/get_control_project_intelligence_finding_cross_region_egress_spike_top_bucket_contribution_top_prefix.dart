...
class GetControlProjectIntelligenceFindingCrossRegionEgressSpikeTopBucketContributionTopPrefix {
  ...
  /// Creates a new [GetControlProjectIntelligenceFindingCrossRegionEgressSpikeTopBucketContributionTopPrefix].
  ...
  const GetControlProjectIntelligenceFindingCrossRegionEgressSpikeTopBucketContributionTopPrefix({
  ...
  factory GetControlProjectIntelligenceFindingCrossRegionEgressSpikeTopBucketContributionTopPrefix.fromMap(Map<String, dynamic> map) {
    return GetControlProjectIntelligenceFindingCrossRegionEgressSpikeTopBucketContributionTopPrefix(
