...
class ControlFolderIntelligenceConfigState {
  ...
  /// Structure is documented below.
  final pulumi.Input<List<ControlFolderIntelligenceConfigTrialConfig>>?
  trialConfigs;
  ...
  factory ControlFolderIntelligenceConfigState.fromMap(
    ...
    return ControlFolderIntelligenceConfigState(
      ...
      effectiveIntelligenceConfigs: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                ControlFolderIntelligenceConfigEffectiveIntelligenceConfig.fromMap(
      ...
      trialConfigs: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ControlFolderIntelligenceConfigTrialConfig>(
            guardedValue,
            (value) => ControlFolderIntelligenceConfigTrialConfig.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
