...
import 'bucket_iambinding_state.dart';
...
class BucketIAMBinding extends pulumi.CustomResource {
  ...
  /// Creates a new [BucketIAMBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [BucketIAMBinding]. {@macro pulumi_storage_bucket_iambinding_bucket_iambinding_args_doc}
  ...
  /// Gets an existing [BucketIAMBinding] resource's state with the given [name] and [id].
  static BucketIAMBinding get(
    String name,
