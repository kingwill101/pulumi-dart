...
class ControlOrganizationIntelligenceConfigState {
  ...
  /// Structure is documented below.
  final pulumi.Input<List<ControlOrganizationIntelligenceConfigTrialConfig>>?
  trialConfigs;
  ...
  factory ControlOrganizationIntelligenceConfigState.fromMap(
    ...
    return ControlOrganizationIntelligenceConfigState(
      ...
      effectiveIntelligenceConfigs: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                ControlOrganizationIntelligenceConfigEffectiveIntelligenceConfig.fromMap(
      ...
      trialConfigs: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => ControlOrganizationIntelligenceConfigTrialConfig.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
