...
import 'managed_folder_iam_member_state.dart';
...
class ManagedFolderIamMember extends pulumi.CustomResource {
  ...
  /// Creates a new [ManagedFolderIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ManagedFolderIamMember]. {@macro pulumi_storage_managed_folder_iam_member_managed_folder_iam_member_args_doc}
  ...
  ManagedFolderIamMember(
    ...
    condition = registerOutput<ManagedFolderIamMemberCondition?>(
      'condition',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return ManagedFolderIamMemberCondition.fromMap(
  ...
  /// Gets an existing [ManagedFolderIamMember] resource's state with the given [name] and [id].
  static ManagedFolderIamMember get(
    String name,
