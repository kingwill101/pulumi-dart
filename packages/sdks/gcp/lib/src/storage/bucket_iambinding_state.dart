...
class BucketIAMBindingState {
  ...
  factory BucketIAMBindingState.fromMap(Map<String, dynamic> map) {
    return BucketIAMBindingState(
      bucket: (() { final guardedValue = map['bucket']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BucketIAMBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
