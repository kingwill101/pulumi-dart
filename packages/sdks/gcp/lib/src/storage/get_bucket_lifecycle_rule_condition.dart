...
class GetBucketLifecycleRuleCondition {
  ...
  factory GetBucketLifecycleRuleCondition.fromMap(Map<String, dynamic> map) {
    return GetBucketLifecycleRuleCondition(
      ...
      customTimeBefore: pulumi.Input.fromValue(
        map['customTimeBefore'] as String,
      ),
      daysSinceCustomTime: pulumi.Input.fromValue(
        map['daysSinceCustomTime'] as int,
      ),
      daysSinceNoncurrentTime: pulumi.Input.fromValue(
        map['daysSinceNoncurrentTime'] as int,
      ),
      matchesPrefixes: pulumi.Input.fromValue(
        (map['matchesPrefixes'] as List).cast<String>(),
      ),
      matchesStorageClasses: pulumi.Input.fromValue(
        (map['matchesStorageClasses'] as List).cast<String>(),
      ),
      matchesSuffixes: pulumi.Input.fromValue(
        (map['matchesSuffixes'] as List).cast<String>(),
      ),
      noncurrentTimeBefore: pulumi.Input.fromValue(
      ...
      sendDaysSinceCustomTimeIfZero: pulumi.Input.fromValue(
        map['sendDaysSinceCustomTimeIfZero'] as bool,
      ),
      sendDaysSinceNoncurrentTimeIfZero: pulumi.Input.fromValue(
        map['sendDaysSinceNoncurrentTimeIfZero'] as bool,
      ),
      sendNumNewerVersionsIfZero: pulumi.Input.fromValue(
