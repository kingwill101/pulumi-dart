...
import 'bucket_iammember_state.dart';
...
class BucketIAMMember extends pulumi.CustomResource {
  ...
  /// Gets an existing [BucketIAMMember] resource's state with the given [name] and [id].
  static BucketIAMMember get(
    String name,
    pulumi.Input<String> id, {
    BucketIAMMemberState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return BucketIAMMember._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [BucketIAMMember] resource.
  BucketIAMMember.reference(String urn)
    : super(
        'gcp:storage/bucketIAMMember:BucketIAMMember',
