...
class GetControlProjectIntelligenceFindingsFindingCrossRegionEgressSpikeTopBucketContributionTopPrefix {
  ...
  /// Creates a new [GetControlProjectIntelligenceFindingsFindingCrossRegionEgressSpikeTopBucketContributionTopPrefix].
  ...
  const GetControlProjectIntelligenceFindingsFindingCrossRegionEgressSpikeTopBucketContributionTopPrefix({
  ...
  factory GetControlProjectIntelligenceFindingsFindingCrossRegionEgressSpikeTopBucketContributionTopPrefix.fromMap(Map<String, dynamic> map) {
    return GetControlProjectIntelligenceFindingsFindingCrossRegionEgressSpikeTopBucketContributionTopPrefix(
