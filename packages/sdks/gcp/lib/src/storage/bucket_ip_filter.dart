    ...
    return <String, dynamic>{
      ...
      'publicNetworkSource':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(publicNetworkSource, (value) => value.toMap()),
      'vpcNetworkSources':
          ?pulumi.Input.mapOptionalInputValue<
            List<BucketIpFilterVpcNetworkSource>,
  ...
  factory BucketIpFilter.fromMap(Map<String, dynamic> map) {
    return BucketIpFilter(
      allowAllServiceAgentAccess: (() {
        final guardedValue = map['allowAllServiceAgentAccess'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      allowCrossOrgVpcs: (() {
        final guardedValue = map['allowCrossOrgVpcs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      mode: pulumi.Input.fromValue(map['mode'] as String),
      publicNetworkSource: (() {
        final guardedValue = map['publicNetworkSource'];
        if (guardedValue == null) return null;
