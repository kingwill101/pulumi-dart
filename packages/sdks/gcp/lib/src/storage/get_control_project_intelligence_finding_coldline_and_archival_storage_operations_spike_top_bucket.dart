...
import 'get_control_project_intelligence_finding_coldline_and_archival_storage_operations_spike_top_bucket_contribution.dart';
import 'get_control_project_intelligence_finding_coldline_and_archival_storage_operations_spike_top_bucket_error.dart';

class GetControlProjectIntelligenceFindingColdlineAndArchivalStorageOperationsSpikeTopBucket {
  /// The resource name of the bucket.
  final pulumi.Input<String> bucket;
  /// The breakdown of prefixes contributing to the spike. Structure is documented below.
  final pulumi.Input<List<GetControlProjectIntelligenceFindingColdlineAndArchivalStorageOperationsSpikeTopBucketContribution>> contributions;
  /// Error details if the bucket details cannot be retrieved. Structure is documented below.
  final pulumi.Input<List<GetControlProjectIntelligenceFindingColdlineAndArchivalStorageOperationsSpikeTopBucketError>> errors;
  ...
  /// Creates a new [GetControlProjectIntelligenceFindingColdlineAndArchivalStorageOperationsSpikeTopBucket].
  ...
  const GetControlProjectIntelligenceFindingColdlineAndArchivalStorageOperationsSpikeTopBucket({
  ...
  factory GetControlProjectIntelligenceFindingColdlineAndArchivalStorageOperationsSpikeTopBucket.fromMap(Map<String, dynamic> map) {
    return GetControlProjectIntelligenceFindingColdlineAndArchivalStorageOperationsSpikeTopBucket(
      bucket: pulumi.Input.fromValue(map['bucket'] as String),
      contributions: pulumi.Input.fromValue(pulumi.Input.decodeList<GetControlProjectIntelligenceFindingColdlineAndArchivalStorageOperationsSpikeTopBucketContribution>(map['contributions']!, (value) => GetControlProjectIntelligenceFindingColdlineAndArchivalStorageOperationsSpikeTopBucketContribution.fromMap((value as Map).cast<String, dynamic>()))),
      errors: pulumi.Input.fromValue(pulumi.Input.decodeList<GetControlProjectIntelligenceFindingColdlineAndArchivalStorageOperationsSpikeTopBucketError>(map['errors']!, (value) => GetControlProjectIntelligenceFindingColdlineAndArchivalStorageOperationsSpikeTopBucketError.fromMap((value as Map).cast<String, dynamic>()))),
