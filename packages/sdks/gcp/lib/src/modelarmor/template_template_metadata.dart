...
class TemplateTemplateMetadata {
  ...
  final pulumi.Input<TemplateTemplateMetadataMultiLanguageDetection>?
    ...
    return <String, dynamic>{
      ...
      'multiLanguageDetection':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(multiLanguageDetection, (value) => value.toMap()),
    };
  }
  ...
  factory TemplateTemplateMetadata.fromMap(Map<String, dynamic> map) {
    return TemplateTemplateMetadata(
      customLlmResponseSafetyErrorCode: (() {
        final guardedValue = map['customLlmResponseSafetyErrorCode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      customLlmResponseSafetyErrorMessage: (() {
        final guardedValue = map['customLlmResponseSafetyErrorMessage'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      customPromptSafetyErrorCode: (() {
        final guardedValue = map['customPromptSafetyErrorCode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      customPromptSafetyErrorMessage: (() {
        final guardedValue = map['customPromptSafetyErrorMessage'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      enforcementType: (() {
        final guardedValue = map['enforcementType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ignorePartialInvocationFailures: (() {
        final guardedValue = map['ignorePartialInvocationFailures'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      logSanitizeOperations: (() {
        final guardedValue = map['logSanitizeOperations'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      logTemplateOperations: (() {
        final guardedValue = map['logTemplateOperations'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      multiLanguageDetection: (() {
        final guardedValue = map['multiLanguageDetection'];
        if (guardedValue == null) return null;
