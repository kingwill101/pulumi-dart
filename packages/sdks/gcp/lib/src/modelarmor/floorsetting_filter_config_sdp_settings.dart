...
class FloorsettingFilterConfigSdpSettings {
  ...
  final pulumi.Input<FloorsettingFilterConfigSdpSettingsAdvancedConfig>?
  advancedConfig;

  /// Sensitive Data Protection basic configuration.
  /// Structure is documented below.
  final pulumi.Input<FloorsettingFilterConfigSdpSettingsBasicConfig>?
  basicConfig;
    ...
    return <String, dynamic>{
      'advancedConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(advancedConfig, (value) => value.toMap()),
      'basicConfig':
          ?pulumi.Input.mapOptionalInputValue<
            FloorsettingFilterConfigSdpSettingsBasicConfig,
            Map<String, dynamic>
          >(basicConfig, (value) => value.toMap()),
    };
  }
  ...
  factory FloorsettingFilterConfigSdpSettings.fromMap(
    ...
    return FloorsettingFilterConfigSdpSettings(
      advancedConfig: (() {
        final guardedValue = map['advancedConfig'];
      ...
      basicConfig: (() {
        final guardedValue = map['basicConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
