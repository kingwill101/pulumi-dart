...
class FloorsettingFloorSettingMetadata {
  ...
  final FloorsettingFloorSettingMetadataMultiLanguageDetection? multiLanguageDetection;
  ...
  factory FloorsettingFloorSettingMetadata.fromMap(Map<String, dynamic> map) {
    return FloorsettingFloorSettingMetadata(
      multiLanguageDetection: map['multiLanguageDetection'] == null ? null : FloorsettingFloorSettingMetadataMultiLanguageDetection.fromMap((map['multiLanguageDetection'] as Map).cast<String, dynamic>()),
    );
  }
}
