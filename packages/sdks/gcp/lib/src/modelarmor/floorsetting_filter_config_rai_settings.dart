...
class FloorsettingFilterConfigRaiSettings {
  ...
  factory FloorsettingFilterConfigRaiSettings.fromMap(Map<String, dynamic> map) {
    return FloorsettingFilterConfigRaiSettings(
      raiFilters: (pulumi.Input.decodeList<FloorsettingFilterConfigRaiSettingsRaiFilter>(map['raiFilters'], (value) => FloorsettingFilterConfigRaiSettingsRaiFilter.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
