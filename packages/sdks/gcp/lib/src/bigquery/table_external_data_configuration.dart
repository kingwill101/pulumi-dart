...
class TableExternalDataConfiguration {
  ...
  factory TableExternalDataConfiguration.fromMap(Map<String, dynamic> map) {
    return TableExternalDataConfiguration(
      ...
      avroOptions: map['avroOptions'] == null ? null : (TableExternalDataConfigurationAvroOptions.fromMap((map['avroOptions']! as Map).cast<String, dynamic>())).input(),
      bigtableOptions: map['bigtableOptions'] == null ? null : (TableExternalDataConfigurationBigtableOptions.fromMap((map['bigtableOptions']! as Map).cast<String, dynamic>())).input(),
      ...
      csvOptions: map['csvOptions'] == null ? null : (TableExternalDataConfigurationCsvOptions.fromMap((map['csvOptions']! as Map).cast<String, dynamic>())).input(),
      ...
      googleSheetsOptions: map['googleSheetsOptions'] == null ? null : (TableExternalDataConfigurationGoogleSheetsOptions.fromMap((map['googleSheetsOptions']! as Map).cast<String, dynamic>())).input(),
      hivePartitioningOptions: map['hivePartitioningOptions'] == null ? null : (TableExternalDataConfigurationHivePartitioningOptions.fromMap((map['hivePartitioningOptions']! as Map).cast<String, dynamic>())).input(),
      ...
      jsonOptions: map['jsonOptions'] == null ? null : (TableExternalDataConfigurationJsonOptions.fromMap((map['jsonOptions']! as Map).cast<String, dynamic>())).input(),
      ...
      parquetOptions: map['parquetOptions'] == null ? null : (TableExternalDataConfigurationParquetOptions.fromMap((map['parquetOptions']! as Map).cast<String, dynamic>())).input(),
