...
class TableExternalDataConfiguration {
  ...
  final pulumi.Input<TableExternalDataConfigurationBigtableOptions>?
  bigtableOptions;
  ...
  /// documented below.
  final pulumi.Input<TableExternalDataConfigurationGoogleSheetsOptions>?
  googleSheetsOptions;
  ...
  final pulumi.Input<TableExternalDataConfigurationHivePartitioningOptions>?
  ...
  final pulumi.Input<TableExternalDataConfigurationParquetOptions>?
  parquetOptions;
  ...
  factory TableExternalDataConfiguration.fromMap(Map<String, dynamic> map) {
    return TableExternalDataConfiguration(
      ...
      jsonExtension: (() {
        final guardedValue = map['jsonExtension'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      jsonOptions: (() {
      ...
      sourceUris: pulumi.Input.fromValue(
