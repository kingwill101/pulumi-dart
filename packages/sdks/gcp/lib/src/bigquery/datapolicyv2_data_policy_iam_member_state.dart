...
class Datapolicyv2DataPolicyIamMemberState {
  ...
  /// Creates a new [Datapolicyv2DataPolicyIamMemberState].
  /// [condition] Optional.
  ...
  factory Datapolicyv2DataPolicyIamMemberState.fromMap(
    ...
    return Datapolicyv2DataPolicyIamMemberState(
      condition: (() {
        ...
        return pulumi.Input.fromValue(
          Datapolicyv2DataPolicyIamMemberCondition.fromMap(
