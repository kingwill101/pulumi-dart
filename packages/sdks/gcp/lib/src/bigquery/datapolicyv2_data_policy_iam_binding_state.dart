...
class Datapolicyv2DataPolicyIamBindingState {
  ...
  const Datapolicyv2DataPolicyIamBindingState({
    this.condition,
    this.dataPolicyId,
    this.etag,
    this.location,
  ...
  factory Datapolicyv2DataPolicyIamBindingState.fromMap(Map<String, dynamic> map) {
    return Datapolicyv2DataPolicyIamBindingState(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Datapolicyv2DataPolicyIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
