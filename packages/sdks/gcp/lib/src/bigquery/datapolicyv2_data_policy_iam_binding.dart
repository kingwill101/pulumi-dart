...
import 'datapolicyv2_data_policy_iam_binding_state.dart';
...
class Datapolicyv2DataPolicyIamBinding extends pulumi.CustomResource {
  ...
  /// Gets an existing [Datapolicyv2DataPolicyIamBinding] resource's state with the given [name] and [id].
  static Datapolicyv2DataPolicyIamBinding get(
    String name,
  ...
  Datapolicyv2DataPolicyIamBinding._get(
    String name, {
