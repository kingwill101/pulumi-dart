...
class RoutineIamMemberState {
  ...
  /// Creates a new [RoutineIamMemberState].
  /// [condition] Optional.
  ...
  factory RoutineIamMemberState.fromMap(Map<String, dynamic> map) {
    return RoutineIamMemberState(
