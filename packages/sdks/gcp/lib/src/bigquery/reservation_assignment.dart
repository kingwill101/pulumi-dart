...
import 'reservation_assignment_state.dart';
...
class ReservationAssignment extends pulumi.CustomResource {
  ...
  /// Creates a new [ReservationAssignment].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ReservationAssignment]. {@macro pulumi_bigquery_reservation_assignment_reservation_assignment_args_doc}
  ...
  /// Gets an existing [ReservationAssignment] resource's state with the given [name] and [id].
  static ReservationAssignment get(
    String name,
