...
class GetTableExternalDataConfigurationBigtableOption {
  ...
  final pulumi.Input<
    List<GetTableExternalDataConfigurationBigtableOptionColumnFamily>
  >
  columnFamilies;
  ...
  factory GetTableExternalDataConfigurationBigtableOption.fromMap(
    ...
    return GetTableExternalDataConfigurationBigtableOption(
      columnFamilies: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetTableExternalDataConfigurationBigtableOptionColumnFamily
        >(
          map['columnFamilies']!,
          (value) =>
              GetTableExternalDataConfigurationBigtableOptionColumnFamily.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
      ignoreUnspecifiedColumnFamilies: pulumi.Input.fromValue(
        map['ignoreUnspecifiedColumnFamilies'] as bool,
      ),
      outputColumnFamiliesAsJson: pulumi.Input.fromValue(
        map['outputColumnFamiliesAsJson'] as bool,
      ),
      readRowkeyAsString: pulumi.Input.fromValue(
