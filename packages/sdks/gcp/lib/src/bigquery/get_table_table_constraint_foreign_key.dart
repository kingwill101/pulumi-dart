...
class GetTableTableConstraintForeignKey {
  ...
  final pulumi.Input<List<GetTableTableConstraintForeignKeyColumnReference>>
  columnReferences;
  ...
  final pulumi.Input<List<GetTableTableConstraintForeignKeyReferencedTable>>
  referencedTables;
    ...
    return <String, dynamic>{
      'columnReferences':
          pulumi.Input.mapInputValue<
            List<GetTableTableConstraintForeignKeyColumnReference>,
      ...
      'referencedTables':
          pulumi.Input.mapInputValue<
            List<GetTableTableConstraintForeignKeyReferencedTable>,
            List<Map<String, dynamic>>
          >(
            referencedTables,
            (value) =>
  ...
  factory GetTableTableConstraintForeignKey.fromMap(Map<String, dynamic> map) {
    return GetTableTableConstraintForeignKey(
      columnReferences: pulumi.Input.fromValue(
        pulumi
            .Input.decodeList<GetTableTableConstraintForeignKeyColumnReference>(
      ...
      referencedTables: pulumi.Input.fromValue(
        pulumi
            .Input.decodeList<GetTableTableConstraintForeignKeyReferencedTable>(
