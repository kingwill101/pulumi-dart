...
class GetTableExternalCatalogTableOption {
  ...
  factory GetTableExternalCatalogTableOption.fromMap(Map<String, dynamic> map) {
    return GetTableExternalCatalogTableOption(
      ...
      storageDescriptors: (pulumi.Input.decodeList<GetTableExternalCatalogTableOptionStorageDescriptor>(map['storageDescriptors'], (value) => GetTableExternalCatalogTableOptionStorageDescriptor.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
