...
class GetTableExternalCatalogTableOption {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'storageDescriptors': pulumi.Input.mapInputValue<List<GetTableExternalCatalogTableOptionStorageDescriptor>, List<Map<String, dynamic>>>(storageDescriptors, (value) => pulumi.Input.encodeList<GetTableExternalCatalogTableOptionStorageDescriptor, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory GetTableExternalCatalogTableOption.fromMap(Map<String, dynamic> map) {
    return GetTableExternalCatalogTableOption(
      ...
      storageDescriptors: pulumi.Input.fromValue(pulumi.Input.decodeList<GetTableExternalCatalogTableOptionStorageDescriptor>(map['storageDescriptors']!, (value) => GetTableExternalCatalogTableOptionStorageDescriptor.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
