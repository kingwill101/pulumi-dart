...
class RoutineArgs {
  ...
  factory RoutineArgs.fromMap(Map<String, dynamic> map) {
    return RoutineArgs(
      arguments: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RoutineArgument>(
            guardedValue,
            (value) =>
                RoutineArgument.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      dataGovernanceType: (() {
        final guardedValue = map['dataGovernanceType'];
        if (guardedValue == null) return null;
      ...
      determinismLevel: (() {
        final guardedValue = map['determinismLevel'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      externalRuntimeOptions: (() {
        final guardedValue = map['externalRuntimeOptions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      pythonOptions: (() {
        final guardedValue = map['pythonOptions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      remoteFunctionOptions: (() {
        final guardedValue = map['remoteFunctionOptions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      returnTableType: (() {
        final guardedValue = map['returnTableType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      returnType: (() {
        final guardedValue = map['returnType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ...
      securityMode: (() {
        final guardedValue = map['securityMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      sparkOptions: (() {
        final guardedValue = map['sparkOptions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
