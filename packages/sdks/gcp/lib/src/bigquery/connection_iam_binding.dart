...
import 'connection_iam_binding_state.dart';
...
/// }
///
/// resource "gcp_bigquery_connectioniampolicy" "policy" {
///   project       = connection.project
///   location      = connection.location
///   connection_id = connection.connectionId
...
/// }
///
/// resource "gcp_bigquery_connectioniambinding" "binding" {
///   project       = connection.project
///   location      = connection.location
///   connection_id = connection.connectionId
///   role          = "roles/viewer"
...
/// }
///
/// resource "gcp_bigquery_connectioniammember" "member" {
///   project       = connection.project
///   location      = connection.location
///   connection_id = connection.connectionId
///   role          = "roles/viewer"
...
class ConnectionIamBinding extends pulumi.CustomResource {
  late final pulumi.Output<ConnectionIamBindingCondition?> condition;
  ...
  /// Creates a new [ConnectionIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ConnectionIamBinding]. {@macro pulumi_bigquery_connection_iam_binding_connection_iam_binding_args_doc}
  ...
  /// Gets an existing [ConnectionIamBinding] resource's state with the given [name] and [id].
  static ConnectionIamBinding get(
    String name,
