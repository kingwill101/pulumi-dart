...
class RoutineSparkOptions {
  ...
  factory RoutineSparkOptions.fromMap(Map<String, dynamic> map) {
    return RoutineSparkOptions(
      ...
      connection: map['connection'] == null ? null : map['connection'] as String,
      ...
      jarUris: map['jarUris'] == null ? null : (map['jarUris'] as List).cast<String>(),
      mainClass: map['mainClass'] == null ? null : map['mainClass'] as String,
      mainFileUri: map['mainFileUri'] == null ? null : map['mainFileUri'] as String,
      properties: map['properties'] == null ? null : (map['properties'] as Map).cast<String, String>(),
      pyFileUris: map['pyFileUris'] == null ? null : (map['pyFileUris'] as List).cast<String>(),
