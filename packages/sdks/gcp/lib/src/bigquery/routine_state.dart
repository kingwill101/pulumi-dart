...
class RoutineState {
  ...
  RoutineState({
    ...
    pulumi.Output<String>? definitionBody,
    ...
    pulumi.Output<String>? routineId,
    pulumi.Output<String>? routineType,
    ...
    pulumi.Output<RoutineSparkOptions>? sparkOptions,
      ...
      definitionBody = pulumi.Input.asOptionalInput<String>(definitionBody),
      ...
      routineId = pulumi.Input.asOptionalInput<String>(routineId),
      routineType = pulumi.Input.asOptionalInput<String>(routineType),
  ...
  factory RoutineState.fromMap(Map<String, dynamic> map) {
    return RoutineState(
      ...
      definitionBody: map['definitionBody'] == null ? null : pulumi.Output.create<String>(map['definitionBody'] as String),
      ...
      routineId: map['routineId'] == null ? null : pulumi.Output.create<String>(map['routineId'] as String),
      routineType: map['routineType'] == null ? null : pulumi.Output.create<String>(map['routineType'] as String),
