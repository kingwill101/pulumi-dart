...
class ConnectionIamBindingState {
  ...
  /// Creates a new [ConnectionIamBindingState].
  /// [condition] Optional.
  ...
  const ConnectionIamBindingState({
    this.condition,
    this.connectionId,
    this.etag,
    this.location,
  ...
  factory ConnectionIamBindingState.fromMap(Map<String, dynamic> map) {
    return ConnectionIamBindingState(
