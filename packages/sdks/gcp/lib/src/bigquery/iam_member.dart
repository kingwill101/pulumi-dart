...
import 'iam_member_args.dart';
import 'iam_member_condition.dart';
import 'iam_member_state.dart';
...
class IamMember extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [IamMember]. {@macro pulumi_bigquery_iam_member_iam_member_args_doc}
