...
class TableTableConstraints {
  ...
  factory TableTableConstraints.fromMap(Map<String, dynamic> map) {
    return TableTableConstraints(
      foreignKeys: (() { final guardedValue = map['foreignKeys']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<TableTableConstraintsForeignKey>(guardedValue, (value) => TableTableConstraintsForeignKey.fromMap((value as Map).cast<String, dynamic>()))); })(),
      primaryKey: (() { final guardedValue = map['primaryKey']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TableTableConstraintsPrimaryKey.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
