...
class GetDatasetAccess {
  ...
  factory GetDatasetAccess.fromMap(Map<String, dynamic> map) {
    return GetDatasetAccess(
      conditions: (pulumi.Input.decodeList<GetDatasetAccessCondition>(map['conditions'], (value) => GetDatasetAccessCondition.fromMap((value as Map).cast<String, dynamic>()))).input(),
      datasets: (pulumi.Input.decodeList<GetDatasetAccessDataset>(map['datasets'], (value) => GetDatasetAccessDataset.fromMap((value as Map).cast<String, dynamic>()))).input(),
      domain: (map['domain'] as String).input(),
      groupByEmail: (map['groupByEmail'] as String).input(),
      iamMember: (map['iamMember'] as String).input(),
      role: (map['role'] as String).input(),
      routines: (pulumi.Input.decodeList<GetDatasetAccessRoutine>(map['routines'], (value) => GetDatasetAccessRoutine.fromMap((value as Map).cast<String, dynamic>()))).input(),
      specialGroup: (map['specialGroup'] as String).input(),
      userByEmail: (map['userByEmail'] as String).input(),
      views: (pulumi.Input.decodeList<GetDatasetAccessView>(map['views'], (value) => GetDatasetAccessView.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
