    ...
    return <String, dynamic>{
      'conditions':
          pulumi.Input.mapInputValue<
            List<GetDatasetAccessCondition>,
  ...
  factory GetDatasetAccess.fromMap(Map<String, dynamic> map) {
    return GetDatasetAccess(
      conditions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetDatasetAccessCondition>(
          map['conditions']!,
      ...
      datasets: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetDatasetAccessDataset>(
          map['datasets']!,
      ...
      routines: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetDatasetAccessRoutine>(
          map['routines']!,
      ...
      views: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetDatasetAccessView>(
          map['views']!,
