...
class Table extends pulumi.CustomResource {
  ...
  Table(
    ...
    clusterings = registerOutput<List<String>?>('clusterings', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return (guardedValue as List).cast<String>(); });
    ...
    ignoreSchemaChanges = registerOutput<List<String>?>('ignoreSchemaChanges', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return (guardedValue as List).cast<String>(); });
