...
import 'datapolicyv2_data_policy_iam_policy_state.dart';
...
class Datapolicyv2DataPolicyIamPolicy extends pulumi.CustomResource {
  ...
  /// Gets an existing [Datapolicyv2DataPolicyIamPolicy] resource's state with the given [name] and [id].
  static Datapolicyv2DataPolicyIamPolicy get(
    String name,
    pulumi.Input<String> id, {
    Datapolicyv2DataPolicyIamPolicyState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return Datapolicyv2DataPolicyIamPolicy._get(
      name,
      state: state?.toMap(),
  ...
  Datapolicyv2DataPolicyIamPolicy._get(
    String name, {
  ...
  /// Creates a typed reference to an existing [Datapolicyv2DataPolicyIamPolicy] resource.
  Datapolicyv2DataPolicyIamPolicy.reference(String urn)
    : super(
        'gcp:bigquery/datapolicyv2DataPolicyIamPolicy:Datapolicyv2DataPolicyIamPolicy',
