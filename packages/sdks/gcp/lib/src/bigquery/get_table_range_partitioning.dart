...
class GetTableRangePartitioning {
  ...
  factory GetTableRangePartitioning.fromMap(Map<String, dynamic> map) {
    return GetTableRangePartitioning(
      ...
      ranges: pulumi.Input.fromValue(pulumi.Input.decodeList<GetTableRangePartitioningRange>(map['ranges']!, (value) => GetTableRangePartitioningRange.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
