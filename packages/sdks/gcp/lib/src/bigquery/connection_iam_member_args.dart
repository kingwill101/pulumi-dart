...
import 'connection_iam_member_condition.dart';

/// {@template pulumi_bigquery_connection_iam_member_connection_iam_member_args_doc}
/// The set of arguments for ConnectionIamMember.
/// {@endtemplate}
/// {@macro pulumi_bigquery_connection_iam_member_connection_iam_member_args_doc}
class ConnectionIamMemberArgs {
  final pulumi.Input<ConnectionIamMemberCondition?>? condition;
  ...
  /// Creates a new [ConnectionIamMemberArgs].
  /// [condition] Optional.
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'condition': ?pulumi.Input.mapOptionalInputValue<ConnectionIamMemberCondition, Map<String, dynamic>>(condition, (value) => value.toMap()),
  ...
  factory ConnectionIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return ConnectionIamMemberArgs(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConnectionIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
