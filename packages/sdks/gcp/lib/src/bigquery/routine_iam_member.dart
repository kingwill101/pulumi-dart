...
import 'routine_iam_member_args.dart';
import 'routine_iam_member_condition.dart';
import 'routine_iam_member_state.dart';
...
class RoutineIamMember extends pulumi.CustomResource {
  late final pulumi.Output<RoutineIamMemberCondition?> condition;
  ...
  /// Creates a new [RoutineIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [RoutineIamMember]. {@macro pulumi_bigquery_routine_iam_member_routine_iam_member_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  RoutineIamMember(
    String name, {
    RoutineIamMemberArgs? args,
    ...
    condition = registerOutput<RoutineIamMemberCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return RoutineIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [RoutineIamMember] resource's state with the given [name] and [id].
  static RoutineIamMember get(
    String name,
    pulumi.Input<String> id, {
    RoutineIamMemberState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return RoutineIamMember._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [RoutineIamMember] resource.
  RoutineIamMember.reference(String urn)
    : super(
        'gcp:bigquery/routineIamMember:RoutineIamMember',
