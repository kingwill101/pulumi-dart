...
import 'datapolicyv2_data_policy_iam_member_args.dart';
import 'datapolicyv2_data_policy_iam_member_condition.dart';
import 'datapolicyv2_data_policy_iam_member_state.dart';
...
/// }
///
/// resource "gcp_bigquery_datapolicyv2datapolicyiampolicy" "policy" {
///   project        = basicDataPolicy.project
///   location       = basicDataPolicy.location
...
/// }
///
/// resource "gcp_bigquery_datapolicyv2datapolicyiambinding" "binding" {
///   project        = basicDataPolicy.project
///   location       = basicDataPolicy.location
///   data_policy_id = basicDataPolicy.dataPolicyId
///   role           = "roles/viewer"
...
/// }
///
/// resource "gcp_bigquery_datapolicyv2datapolicyiammember" "member" {
///   project        = basicDataPolicy.project
///   location       = basicDataPolicy.location
///   data_policy_id = basicDataPolicy.dataPolicyId
///   role           = "roles/viewer"
...
class Datapolicyv2DataPolicyIamMember extends pulumi.CustomResource {
  late final pulumi.Output<Datapolicyv2DataPolicyIamMemberCondition?> condition;
  ...
  /// Creates a new [Datapolicyv2DataPolicyIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [Datapolicyv2DataPolicyIamMember]. {@macro pulumi_bigquery_datapolicyv2_data_policy_iam_member_datapolicyv2_data_policy_iam_member_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  Datapolicyv2DataPolicyIamMember(
    String name, {
    Datapolicyv2DataPolicyIamMemberArgs? args,
  ...
  /// Gets an existing [Datapolicyv2DataPolicyIamMember] resource's state with the given [name] and [id].
  static Datapolicyv2DataPolicyIamMember get(
    String name,
  ...
  Datapolicyv2DataPolicyIamMember._get(
    String name, {
