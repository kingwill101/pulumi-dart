...
class TableExternalDataConfigurationBigtableOptionsColumnFamily {
  ...
  final pulumi.Input<
    List<TableExternalDataConfigurationBigtableOptionsColumnFamilyColumn>
  >?
  columns;
  ...
  factory TableExternalDataConfigurationBigtableOptionsColumnFamily.fromMap(
    ...
    return TableExternalDataConfigurationBigtableOptionsColumnFamily(
      columns: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                TableExternalDataConfigurationBigtableOptionsColumnFamilyColumn.fromMap(
      ...
      familyId: (() {
        final guardedValue = map['familyId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      onlyReadLatest: (() {
        final guardedValue = map['onlyReadLatest'];
        if (guardedValue == null) return null;
