...
class ConnectionSpark {
  ...
  final pulumi.Input<ConnectionSparkMetastoreServiceConfig>?
  ...
  /// Structure is documented below.
  final pulumi.Input<ConnectionSparkSparkHistoryServerConfig>?
    ...
    return <String, dynamic>{
      'metastoreServiceConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(metastoreServiceConfig, (value) => value.toMap()),
  ...
  factory ConnectionSpark.fromMap(Map<String, dynamic> map) {
    return ConnectionSpark(
      metastoreServiceConfig: (() {
        final guardedValue = map['metastoreServiceConfig'];
