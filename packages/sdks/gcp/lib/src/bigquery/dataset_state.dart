...
class DatasetState {
  ...
  factory DatasetState.fromMap(Map<String, dynamic> map) {
    return DatasetState(
      accesses: map['accesses'] == null ? null : (pulumi.Input.decodeList<DatasetAccess>(map['accesses']!, (value) => DatasetAccess.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      defaultEncryptionConfiguration: map['defaultEncryptionConfiguration'] == null ? null : (DatasetDefaultEncryptionConfiguration.fromMap((map['defaultEncryptionConfiguration']! as Map).cast<String, dynamic>())).input(),
      defaultPartitionExpirationMs: map['defaultPartitionExpirationMs'] == null ? null : (map['defaultPartitionExpirationMs']! as int).input(),
      defaultTableExpirationMs: map['defaultTableExpirationMs'] == null ? null : (map['defaultTableExpirationMs']! as int).input(),
      deleteContentsOnDestroy: map['deleteContentsOnDestroy'] == null ? null : (map['deleteContentsOnDestroy']! as bool).input(),
      description: map['description'] == null ? null : (map['description']! as String).input(),
      effectiveLabels: map['effectiveLabels'] == null ? null : ((map['effectiveLabels']! as Map).cast<String, String>()).input(),
      etag: map['etag'] == null ? null : (map['etag']! as String).input(),
      externalCatalogDatasetOptions: map['externalCatalogDatasetOptions'] == null ? null : (DatasetExternalCatalogDatasetOptions.fromMap((map['externalCatalogDatasetOptions']! as Map).cast<String, dynamic>())).input(),
      externalDatasetReference: map['externalDatasetReference'] == null ? null : (DatasetExternalDatasetReference.fromMap((map['externalDatasetReference']! as Map).cast<String, dynamic>())).input(),
