...
class DatasetState {
  ...
  factory DatasetState.fromMap(Map<String, dynamic> map) {
    return DatasetState(
      ...
      defaultEncryptionConfiguration: (() {
        final guardedValue = map['defaultEncryptionConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      defaultPartitionExpirationMs: (() {
        final guardedValue = map['defaultPartitionExpirationMs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      defaultTableExpirationMs: (() {
        final guardedValue = map['defaultTableExpirationMs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      deleteContentsOnDestroy: (() {
        final guardedValue = map['deleteContentsOnDestroy'];
        if (guardedValue == null) return null;
      ...
      externalCatalogDatasetOptions: (() {
        final guardedValue = map['externalCatalogDatasetOptions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      externalDatasetReference: (() {
        final guardedValue = map['externalDatasetReference'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      isCaseInsensitive: (() {
        final guardedValue = map['isCaseInsensitive'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      labels: (() {
      ...
      maxTimeTravelHours: (() {
        final guardedValue = map['maxTimeTravelHours'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      project: (() {
      ...
      storageBillingModel: (() {
        final guardedValue = map['storageBillingModel'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
