...
class GetTableExternalDataConfigurationBigtableOptionColumnFamily {
  ...
  factory GetTableExternalDataConfigurationBigtableOptionColumnFamily.fromMap(Map<String, dynamic> map) {
    return GetTableExternalDataConfigurationBigtableOptionColumnFamily(
      columns: (pulumi.Input.decodeList<GetTableExternalDataConfigurationBigtableOptionColumnFamilyColumn>(map['columns'], (value) => GetTableExternalDataConfigurationBigtableOptionColumnFamilyColumn.fromMap((value as Map).cast<String, dynamic>()))).input(),
      encoding: (map['encoding'] as String).input(),
      familyId: (map['familyId'] as String).input(),
