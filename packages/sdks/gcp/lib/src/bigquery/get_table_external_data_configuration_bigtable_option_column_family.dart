...
class GetTableExternalDataConfigurationBigtableOptionColumnFamily {
  ...
  final pulumi.Input<List<GetTableExternalDataConfigurationBigtableOptionColumnFamilyColumn>> columns;
  ...
  const GetTableExternalDataConfigurationBigtableOptionColumnFamily({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'columns': pulumi.Input.mapInputValue<List<GetTableExternalDataConfigurationBigtableOptionColumnFamilyColumn>, List<Map<String, dynamic>>>(columns, (value) => pulumi.Input.encodeList<GetTableExternalDataConfigurationBigtableOptionColumnFamilyColumn, Map<String, dynamic>>(value, (value) => value.toMap())),
      'encoding': encoding,
      'familyId': familyId,
  ...
  factory GetTableExternalDataConfigurationBigtableOptionColumnFamily.fromMap(Map<String, dynamic> map) {
    return GetTableExternalDataConfigurationBigtableOptionColumnFamily(
      columns: pulumi.Input.fromValue(pulumi.Input.decodeList<GetTableExternalDataConfigurationBigtableOptionColumnFamilyColumn>(map['columns']!, (value) => GetTableExternalDataConfigurationBigtableOptionColumnFamilyColumn.fromMap((value as Map).cast<String, dynamic>()))),
