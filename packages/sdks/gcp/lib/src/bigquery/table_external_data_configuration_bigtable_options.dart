...
class TableExternalDataConfigurationBigtableOptions {
  ...
  final List<TableExternalDataConfigurationBigtableOptionsColumnFamily>? columnFamilies;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'columnFamilies': ?columnFamilies == null ? null : pulumi.Input.encodeList<TableExternalDataConfigurationBigtableOptionsColumnFamily, Map<String, dynamic>>(columnFamilies!, (value) => value.toMap()),
  ...
  factory TableExternalDataConfigurationBigtableOptions.fromMap(Map<String, dynamic> map) {
    return TableExternalDataConfigurationBigtableOptions(
      columnFamilies: map['columnFamilies'] == null ? null : pulumi.Input.decodeList<TableExternalDataConfigurationBigtableOptionsColumnFamily>(map['columnFamilies'], (value) => TableExternalDataConfigurationBigtableOptionsColumnFamily.fromMap((value as Map).cast<String, dynamic>())),
      ...
      outputColumnFamiliesAsJson: map['outputColumnFamiliesAsJson'] == null ? null : map['outputColumnFamiliesAsJson'] as bool,
