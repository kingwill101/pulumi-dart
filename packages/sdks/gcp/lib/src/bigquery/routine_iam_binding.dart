...
import 'routine_iam_binding_args.dart';
import 'routine_iam_binding_condition.dart';
import 'routine_iam_binding_state.dart';
...
class RoutineIamBinding extends pulumi.CustomResource {
  late final pulumi.Output<RoutineIamBindingCondition?> condition;
  ...
  /// Creates a new [RoutineIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [RoutineIamBinding]. {@macro pulumi_bigquery_routine_iam_binding_routine_iam_binding_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  RoutineIamBinding(
    String name, {
    RoutineIamBindingArgs? args,
  ...
  /// Gets an existing [RoutineIamBinding] resource's state with the given [name] and [id].
  static RoutineIamBinding get(
    String name,
