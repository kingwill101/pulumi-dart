...
class ConnectionArgs {
  ...
  factory ConnectionArgs.fromMap(Map<String, dynamic> map) {
    return ConnectionArgs(
      aws: (() { final guardedValue = map['aws']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConnectionAws.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      azure: (() { final guardedValue = map['azure']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConnectionAzure.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      spark: (() { final guardedValue = map['spark']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConnectionSpark.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
