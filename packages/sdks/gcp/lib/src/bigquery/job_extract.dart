...
class JobExtract {
  ...
  factory JobExtract.fromMap(Map<String, dynamic> map) {
    return JobExtract(
      ...
      sourceModel: (() { final guardedValue = map['sourceModel']; if (guardedValue == null) return null; return pulumi.Input.fromValue(JobExtractSourceModel.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      sourceTable: (() { final guardedValue = map['sourceTable']; if (guardedValue == null) return null; return pulumi.Input.fromValue(JobExtractSourceTable.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
