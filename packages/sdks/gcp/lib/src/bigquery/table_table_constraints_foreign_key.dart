...
class TableTableConstraintsForeignKey {
  ...
  const TableTableConstraintsForeignKey({
  ...
  factory TableTableConstraintsForeignKey.fromMap(Map<String, dynamic> map) {
    return TableTableConstraintsForeignKey(
      columnReferences: pulumi.Input.fromValue(TableTableConstraintsForeignKeyColumnReferences.fromMap((map['columnReferences']! as Map).cast<String, dynamic>())),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      referencedTable: pulumi.Input.fromValue(TableTableConstraintsForeignKeyReferencedTable.fromMap((map['referencedTable']! as Map).cast<String, dynamic>())),
    );
  }
}
