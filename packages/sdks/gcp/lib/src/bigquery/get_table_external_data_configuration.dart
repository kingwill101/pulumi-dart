...
class GetTableExternalDataConfiguration {
  ...
  final pulumi.Input<List<GetTableExternalDataConfigurationAvroOption>>
  avroOptions;

  /// Additional options if sourceFormat is set to BIGTABLE.
  final pulumi.Input<List<GetTableExternalDataConfigurationBigtableOption>>
  bigtableOptions;
  ...
  final pulumi.Input<List<GetTableExternalDataConfigurationCsvOption>>
  csvOptions;
  ...
  final pulumi.Input<List<GetTableExternalDataConfigurationGoogleSheetsOption>>
  googleSheetsOptions;
  ...
  final pulumi.Input<
    List<GetTableExternalDataConfigurationHivePartitioningOption>
  >
  ...
  final pulumi.Input<List<GetTableExternalDataConfigurationJsonOption>>
  jsonOptions;
  ...
  final pulumi.Input<List<GetTableExternalDataConfigurationParquetOption>>
  parquetOptions;
    ...
    return <String, dynamic>{
      ...
      'avroOptions':
          pulumi.Input.mapInputValue<
            List<GetTableExternalDataConfigurationAvroOption>,
      ...
      'bigtableOptions':
          pulumi.Input.mapInputValue<
            List<GetTableExternalDataConfigurationBigtableOption>,
            List<Map<String, dynamic>>
          >(
            bigtableOptions,
            (value) =>
      ...
      'csvOptions':
          pulumi.Input.mapInputValue<
            List<GetTableExternalDataConfigurationCsvOption>,
            List<Map<String, dynamic>>
          >(
            csvOptions,
            (value) =>
      ...
      'googleSheetsOptions':
          pulumi.Input.mapInputValue<
            List<GetTableExternalDataConfigurationGoogleSheetsOption>,
            List<Map<String, dynamic>>
          >(
            googleSheetsOptions,
            (value) =>
      ...
      'jsonOptions':
          pulumi.Input.mapInputValue<
            List<GetTableExternalDataConfigurationJsonOption>,
            List<Map<String, dynamic>>
          >(
            jsonOptions,
            (value) =>
      ...
      'parquetOptions':
          pulumi.Input.mapInputValue<
            List<GetTableExternalDataConfigurationParquetOption>,
            List<Map<String, dynamic>>
          >(
            parquetOptions,
            (value) =>
  ...
  factory GetTableExternalDataConfiguration.fromMap(Map<String, dynamic> map) {
    return GetTableExternalDataConfiguration(
      ...
      avroOptions: pulumi.Input.fromValue(
      ...
      bigtableOptions: pulumi.Input.fromValue(
        pulumi
      ...
      hivePartitioningOptions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetTableExternalDataConfigurationHivePartitioningOption
        >(
      ...
      ignoreUnknownValues: pulumi.Input.fromValue(
      ...
      metadataCacheMode: pulumi.Input.fromValue(
        map['metadataCacheMode'] as String,
      ),
      objectMetadata: pulumi.Input.fromValue(map['objectMetadata'] as String),
      parquetOptions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetTableExternalDataConfigurationParquetOption>(
          map['parquetOptions']!,
      ...
      referenceFileSchemaUri: pulumi.Input.fromValue(
