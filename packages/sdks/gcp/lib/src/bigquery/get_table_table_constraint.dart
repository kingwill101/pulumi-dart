...
class GetTableTableConstraint {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'foreignKeys': pulumi.Input.mapInputValue<List<GetTableTableConstraintForeignKey>, List<Map<String, dynamic>>>(foreignKeys, (value) => pulumi.Input.encodeList<GetTableTableConstraintForeignKey, Map<String, dynamic>>(value, (value) => value.toMap())),
      'primaryKeys': pulumi.Input.mapInputValue<List<GetTableTableConstraintPrimaryKey>, List<Map<String, dynamic>>>(primaryKeys, (value) => pulumi.Input.encodeList<GetTableTableConstraintPrimaryKey, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory GetTableTableConstraint.fromMap(Map<String, dynamic> map) {
    return GetTableTableConstraint(
      foreignKeys: pulumi.Input.fromValue(pulumi.Input.decodeList<GetTableTableConstraintForeignKey>(map['foreignKeys']!, (value) => GetTableTableConstraintForeignKey.fromMap((value as Map).cast<String, dynamic>()))),
      primaryKeys: pulumi.Input.fromValue(pulumi.Input.decodeList<GetTableTableConstraintPrimaryKey>(map['primaryKeys']!, (value) => GetTableTableConstraintPrimaryKey.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
