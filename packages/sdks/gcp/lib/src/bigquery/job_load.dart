...
class JobLoad {
  ...
  factory JobLoad.fromMap(Map<String, dynamic> map) {
    return JobLoad(
      ...
      destinationEncryptionConfiguration: map['destinationEncryptionConfiguration'] == null ? null : (JobLoadDestinationEncryptionConfiguration.fromMap((map['destinationEncryptionConfiguration']! as Map).cast<String, dynamic>())).input(),
      destinationTable: (JobLoadDestinationTable.fromMap((map['destinationTable'] as Map).cast<String, dynamic>())).input(),
      ...
      parquetOptions: map['parquetOptions'] == null ? null : (JobLoadParquetOptions.fromMap((map['parquetOptions']! as Map).cast<String, dynamic>())).input(),
      ...
      timePartitioning: map['timePartitioning'] == null ? null : (JobLoadTimePartitioning.fromMap((map['timePartitioning']! as Map).cast<String, dynamic>())).input(),
