...
class RoutineIamBindingState {
  ...
  /// Creates a new [RoutineIamBindingState].
  /// [condition] Optional.
  ...
  factory RoutineIamBindingState.fromMap(Map<String, dynamic> map) {
    return RoutineIamBindingState(
