...
class NoteIamBindingState {
  ...
  /// Creates a new [NoteIamBindingState].
  /// [condition] Optional.
  ...
  factory NoteIamBindingState.fromMap(Map<String, dynamic> map) {
    return NoteIamBindingState(
