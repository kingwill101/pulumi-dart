...
/// {@template pulumi_containeranalysis_note_iam_member_note_iam_member_args_doc}
/// The set of arguments for NoteIamMember.
/// {@endtemplate}
/// {@macro pulumi_containeranalysis_note_iam_member_note_iam_member_args_doc}
class NoteIamMemberArgs {
  ...
  factory NoteIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return NoteIamMemberArgs(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NoteIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
