...
import 'note_iam_binding_state.dart';
...
class NoteIamBinding extends pulumi.CustomResource {
  late final pulumi.Output<NoteIamBindingCondition?> condition;
  ...
  /// Creates a new [NoteIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [NoteIamBinding]. {@macro pulumi_containeranalysis_note_iam_binding_note_iam_binding_args_doc}
  ...
  NoteIamBinding(
    ...
    condition = registerOutput<NoteIamBindingCondition?>(
      'condition',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return NoteIamBindingCondition.fromMap(
  ...
  /// Gets an existing [NoteIamBinding] resource's state with the given [name] and [id].
  static NoteIamBinding get(
    String name,
