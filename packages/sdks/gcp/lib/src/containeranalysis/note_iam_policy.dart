...
import 'note_iam_policy_state.dart';
...
class NoteIamPolicy extends pulumi.CustomResource {
  ...
  /// Creates a new [NoteIamPolicy].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [NoteIamPolicy]. {@macro pulumi_containeranalysis_note_iam_policy_note_iam_policy_args_doc}
  ...
  /// Gets an existing [NoteIamPolicy] resource's state with the given [name] and [id].
  static NoteIamPolicy get(
    String name,
    pulumi.Input<String> id, {
    NoteIamPolicyState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return NoteIamPolicy._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [NoteIamPolicy] resource.
  NoteIamPolicy.reference(String urn)
    : super(
        'gcp:containeranalysis/noteIamPolicy:NoteIamPolicy',
