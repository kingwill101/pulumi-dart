...
import 'note_iam_binding_condition.dart';

/// {@template pulumi_containeranalysis_note_iam_binding_note_iam_binding_args_doc}
...
class NoteIamBindingArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'condition': ?pulumi.Input.mapOptionalInputValue<NoteIamBindingCondition, Map<String, dynamic>>(condition, (value) => value.toMap()),
      'members': members,
      'note': note,
      'project': ?project,
      'role': role,
  ...
  factory NoteIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return NoteIamBindingArgs(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NoteIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
