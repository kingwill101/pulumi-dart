...
class GetTriggerBuildSource {
  ...
  factory GetTriggerBuildSource.fromMap(Map<String, dynamic> map) {
    return GetTriggerBuildSource(
      repoSources: (pulumi.Input.decodeList<GetTriggerBuildSourceRepoSource>(map['repoSources'], (value) => GetTriggerBuildSourceRepoSource.fromMap((value as Map).cast<String, dynamic>()))).input(),
      storageSources: (pulumi.Input.decodeList<GetTriggerBuildSourceStorageSource>(map['storageSources'], (value) => GetTriggerBuildSourceStorageSource.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
