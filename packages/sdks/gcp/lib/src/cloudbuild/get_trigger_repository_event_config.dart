...
class GetTriggerRepositoryEventConfig {
  ...
  final pulumi.Input<List<GetTriggerRepositoryEventConfigPullRequest>>
  pullRequests;
    ...
    return <String, dynamic>{
      'pullRequests':
          pulumi.Input.mapInputValue<
            List<GetTriggerRepositoryEventConfigPullRequest>,
      ...
      'pushes':
          pulumi.Input.mapInputValue<
            List<GetTriggerRepositoryEventConfigPush>,
            List<Map<String, dynamic>>
          >(
            pushes,
            (value) =>
  ...
  factory GetTriggerRepositoryEventConfig.fromMap(Map<String, dynamic> map) {
    return GetTriggerRepositoryEventConfig(
      ...
      pushes: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetTriggerRepositoryEventConfigPush>(
          map['pushes']!,
