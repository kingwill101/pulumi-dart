...
class GetTriggerBuild {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'availableSecrets':
          pulumi.Input.mapInputValue<
            List<GetTriggerBuildAvailableSecret>,
            List<Map<String, dynamic>>
          >(
            availableSecrets,
            (value) =>
  ...
  factory GetTriggerBuild.fromMap(Map<String, dynamic> map) {
    return GetTriggerBuild(
      artifacts: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetTriggerBuildArtifact>(
          map['artifacts']!,
      ...
      availableSecrets: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetTriggerBuildAvailableSecret>(
      ...
      options: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetTriggerBuildOption>(
          map['options']!,
      ...
      secrets: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetTriggerBuildSecret>(
          map['secrets']!,
      ...
      sources: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetTriggerBuildSource>(
          map['sources']!,
      ...
      steps: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetTriggerBuildStep>(
          map['steps']!,
