...
class GetTriggerBuild {
  ...
  factory GetTriggerBuild.fromMap(Map<String, dynamic> map) {
    return GetTriggerBuild(
      artifacts: (pulumi.Input.decodeList<GetTriggerBuildArtifact>(map['artifacts'], (value) => GetTriggerBuildArtifact.fromMap((value as Map).cast<String, dynamic>()))).input(),
      availableSecrets: (pulumi.Input.decodeList<GetTriggerBuildAvailableSecret>(map['availableSecrets'], (value) => GetTriggerBuildAvailableSecret.fromMap((value as Map).cast<String, dynamic>()))).input(),
      images: ((map['images'] as List).cast<String>()).input(),
      logsBucket: (map['logsBucket'] as String).input(),
      options: (pulumi.Input.decodeList<GetTriggerBuildOption>(map['options'], (value) => GetTriggerBuildOption.fromMap((value as Map).cast<String, dynamic>()))).input(),
      queueTtl: (map['queueTtl'] as String).input(),
      secrets: (pulumi.Input.decodeList<GetTriggerBuildSecret>(map['secrets'], (value) => GetTriggerBuildSecret.fromMap((value as Map).cast<String, dynamic>()))).input(),
      sources: (pulumi.Input.decodeList<GetTriggerBuildSource>(map['sources'], (value) => GetTriggerBuildSource.fromMap((value as Map).cast<String, dynamic>()))).input(),
      steps: (pulumi.Input.decodeList<GetTriggerBuildStep>(map['steps'], (value) => GetTriggerBuildStep.fromMap((value as Map).cast<String, dynamic>()))).input(),
