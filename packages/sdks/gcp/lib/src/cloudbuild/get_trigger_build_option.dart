...
class GetTriggerBuildOption {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'volumes': pulumi.Input.encodeList<GetTriggerBuildOptionVolume, Map<String, dynamic>>(volumes, (value) => value.toMap()),
  ...
  factory GetTriggerBuildOption.fromMap(Map<String, dynamic> map) {
    return GetTriggerBuildOption(
      ...
      sourceProvenanceHashes: (map['sourceProvenanceHashes'] as List).cast<String>(),
      substitutionOption: map['substitutionOption'] as String,
      volumes: pulumi.Input.decodeList<GetTriggerBuildOptionVolume>(map['volumes'], (value) => GetTriggerBuildOptionVolume.fromMap((value as Map).cast<String, dynamic>())),
