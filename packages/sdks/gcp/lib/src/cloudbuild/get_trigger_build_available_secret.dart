...
class GetTriggerBuildAvailableSecret {
  ...
  final pulumi.Input<List<GetTriggerBuildAvailableSecretSecretManager>>
  secretManagers;
  ...
  GetTriggerBuildAvailableSecret({required this.secretManagers});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'secretManagers':
          pulumi.Input.mapInputValue<
            List<GetTriggerBuildAvailableSecretSecretManager>,
  ...
  factory GetTriggerBuildAvailableSecret.fromMap(Map<String, dynamic> map) {
    return GetTriggerBuildAvailableSecret(
      secretManagers: pulumi.Input.fromValue(
