...
class TriggerBuildStep {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'timeout': ?timeout,
      'timing': ?timing,
      'volumes': ?pulumi.Input.mapOptionalInputValue<List<TriggerBuildStepVolume>, List<Map<String, dynamic>>>(volumes, (value) => pulumi.Input.encodeList<TriggerBuildStepVolume, Map<String, dynamic>>(value, (value) => value.toMap())),
      'waitFors': ?waitFors,
    };
  }
  ...
  factory TriggerBuildStep.fromMap(Map<String, dynamic> map) {
    return TriggerBuildStep(
      ...
      timing: (() { final guardedValue = map['timing']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      volumes: (() { final guardedValue = map['volumes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<TriggerBuildStepVolume>(guardedValue, (value) => TriggerBuildStepVolume.fromMap((value as Map).cast<String, dynamic>()))); })(),
      waitFors: (() { final guardedValue = map['waitFors']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
    );
  }
}
