...
class TriggerBuildStep {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'timeout': ?timeout,
      'timing': ?timing,
      'volumes': ?volumes == null ? null : pulumi.Input.encodeList<TriggerBuildStepVolume, Map<String, dynamic>>(volumes!, (value) => value.toMap()),
      'waitFors': ?waitFors,
    };
  }
  ...
  factory TriggerBuildStep.fromMap(Map<String, dynamic> map) {
    return TriggerBuildStep(
      ...
      volumes: map['volumes'] == null ? null : pulumi.Input.decodeList<TriggerBuildStepVolume>(map['volumes'], (value) => TriggerBuildStepVolume.fromMap((value as Map).cast<String, dynamic>())),
      waitFors: map['waitFors'] == null ? null : (map['waitFors'] as List).cast<String>(),
    );
  }
}
