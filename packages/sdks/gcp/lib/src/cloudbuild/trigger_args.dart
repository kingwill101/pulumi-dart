...
class TriggerArgs {
  ...
  TriggerArgs({
    pulumi.Output<TriggerApprovalConfig>? approvalConfig,
    pulumi.Output<TriggerBitbucketServerTriggerConfig>? bitbucketServerTriggerConfig,
    pulumi.Output<TriggerBuild>? build,
    pulumi.Output<String>? description,
    pulumi.Output<TriggerDeveloperConnectEventConfig>? developerConnectEventConfig,
    pulumi.Output<bool>? disabled,
    pulumi.Output<String>? filename,
    pulumi.Output<String>? filter,
    pulumi.Output<TriggerGitFileSource>? gitFileSource,
    pulumi.Output<TriggerGithub>? github,
    pulumi.Output<List<String>>? ignoredFiles,
    pulumi.Output<String>? includeBuildLogs,
    pulumi.Output<List<String>>? includedFiles,
    pulumi.Output<String>? location,
    pulumi.Output<String>? name,
    pulumi.Output<String>? project,
    pulumi.Output<TriggerPubsubConfig>? pubsubConfig,
    pulumi.Output<TriggerRepositoryEventConfig>? repositoryEventConfig,
    pulumi.Output<String>? serviceAccount,
    pulumi.Output<TriggerSourceToBuild>? sourceToBuild,
    pulumi.Output<Map<String, String>>? substitutions,
    pulumi.Output<List<String>>? tags,
    pulumi.Output<TriggerTriggerTemplate>? triggerTemplate,
    pulumi.Output<TriggerWebhookConfig>? webhookConfig,
  }) :
  ...
  factory TriggerArgs.fromMap(Map<String, dynamic> map) {
    return TriggerArgs(
      approvalConfig: map['approvalConfig'] == null ? null : pulumi.Output.create<TriggerApprovalConfig>(TriggerApprovalConfig.fromMap((map['approvalConfig'] as Map).cast<String, dynamic>())),
      bitbucketServerTriggerConfig: map['bitbucketServerTriggerConfig'] == null ? null : pulumi.Output.create<TriggerBitbucketServerTriggerConfig>(TriggerBitbucketServerTriggerConfig.fromMap((map['bitbucketServerTriggerConfig'] as Map).cast<String, dynamic>())),
      build: map['build'] == null ? null : pulumi.Output.create<TriggerBuild>(TriggerBuild.fromMap((map['build'] as Map).cast<String, dynamic>())),
      description: map['description'] == null ? null : pulumi.Output.create<String>(map['description'] as String),
      developerConnectEventConfig: map['developerConnectEventConfig'] == null ? null : pulumi.Output.create<TriggerDeveloperConnectEventConfig>(TriggerDeveloperConnectEventConfig.fromMap((map['developerConnectEventConfig'] as Map).cast<String, dynamic>())),
      disabled: map['disabled'] == null ? null : pulumi.Output.create<bool>(map['disabled'] as bool),
      filename: map['filename'] == null ? null : pulumi.Output.create<String>(map['filename'] as String),
      filter: map['filter'] == null ? null : pulumi.Output.create<String>(map['filter'] as String),
      gitFileSource: map['gitFileSource'] == null ? null : pulumi.Output.create<TriggerGitFileSource>(TriggerGitFileSource.fromMap((map['gitFileSource'] as Map).cast<String, dynamic>())),
      github: map['github'] == null ? null : pulumi.Output.create<TriggerGithub>(TriggerGithub.fromMap((map['github'] as Map).cast<String, dynamic>())),
      ignoredFiles: map['ignoredFiles'] == null ? null : pulumi.Output.create<List<String>>((map['ignoredFiles'] as List).cast<String>()),
      includeBuildLogs: map['includeBuildLogs'] == null ? null : pulumi.Output.create<String>(map['includeBuildLogs'] as String),
      includedFiles: map['includedFiles'] == null ? null : pulumi.Output.create<List<String>>((map['includedFiles'] as List).cast<String>()),
      location: map['location'] == null ? null : pulumi.Output.create<String>(map['location'] as String),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      project: map['project'] == null ? null : pulumi.Output.create<String>(map['project'] as String),
      pubsubConfig: map['pubsubConfig'] == null ? null : pulumi.Output.create<TriggerPubsubConfig>(TriggerPubsubConfig.fromMap((map['pubsubConfig'] as Map).cast<String, dynamic>())),
      repositoryEventConfig: map['repositoryEventConfig'] == null ? null : pulumi.Output.create<TriggerRepositoryEventConfig>(TriggerRepositoryEventConfig.fromMap((map['repositoryEventConfig'] as Map).cast<String, dynamic>())),
      serviceAccount: map['serviceAccount'] == null ? null : pulumi.Output.create<String>(map['serviceAccount'] as String),
      sourceToBuild: map['sourceToBuild'] == null ? null : pulumi.Output.create<TriggerSourceToBuild>(TriggerSourceToBuild.fromMap((map['sourceToBuild'] as Map).cast<String, dynamic>())),
      ...
      triggerTemplate: map['triggerTemplate'] == null ? null : pulumi.Output.create<TriggerTriggerTemplate>(TriggerTriggerTemplate.fromMap((map['triggerTemplate'] as Map).cast<String, dynamic>())),
      webhookConfig: map['webhookConfig'] == null ? null : pulumi.Output.create<TriggerWebhookConfig>(TriggerWebhookConfig.fromMap((map['webhookConfig'] as Map).cast<String, dynamic>())),
    );
  }
}
