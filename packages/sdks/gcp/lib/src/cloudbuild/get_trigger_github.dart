    ...
    return <String, dynamic>{
      ...
      'pullRequests':
          pulumi.Input.mapInputValue<
            List<GetTriggerGithubPullRequest>,
  ...
  factory GetTriggerGithub.fromMap(Map<String, dynamic> map) {
    return GetTriggerGithub(
      ...
      pullRequests: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetTriggerGithubPullRequest>(
          map['pullRequests']!,
      ...
      pushes: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetTriggerGithubPush>(
          map['pushes']!,
