...
class TriggerRepositoryEventConfig {
  ...
  factory TriggerRepositoryEventConfig.fromMap(Map<String, dynamic> map) {
    return TriggerRepositoryEventConfig(
      pullRequest: (() { final guardedValue = map['pullRequest']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TriggerRepositoryEventConfigPullRequest.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      push: (() { final guardedValue = map['push']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TriggerRepositoryEventConfigPush.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
