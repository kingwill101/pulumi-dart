...
import 'service_iam_binding_args.dart';
import 'service_iam_binding_condition.dart';
import 'service_iam_binding_state.dart';
...
/// }
///
/// resource "gcp_servicedirectory_serviceiampolicy" "policy" {
///   name        = example.name
...
/// }
///
/// resource "gcp_servicedirectory_serviceiambinding" "binding" {
///   name    = example.name
///   role    = "roles/viewer"
///   members = ["user:jane@example.com"]
/// }
...
/// }
///
/// resource "gcp_servicedirectory_serviceiammember" "member" {
///   name   = example.name
///   role   = "roles/viewer"
///   member = "user:jane@example.com"
/// }
...
class ServiceIamBinding extends pulumi.CustomResource {
  late final pulumi.Output<ServiceIamBindingCondition?> condition;
  ...
  /// Creates a new [ServiceIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ServiceIamBinding]. {@macro pulumi_servicedirectory_service_iam_binding_service_iam_binding_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  ServiceIamBinding(
    String name, {
    ServiceIamBindingArgs? args,
    ...
    condition = registerOutput<ServiceIamBindingCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ServiceIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [ServiceIamBinding] resource's state with the given [name] and [id].
  static ServiceIamBinding get(
    String name,
    pulumi.Input<String> id, {
    ServiceIamBindingState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return ServiceIamBinding._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [ServiceIamBinding] resource.
  ServiceIamBinding.reference(String urn)
    : super(
        'gcp:servicedirectory/serviceIamBinding:ServiceIamBinding',
