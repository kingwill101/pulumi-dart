...
class AuthConfigDecryptedCredential {
  ...
  /// Structure is documented below.
  final pulumi.Input<AuthConfigDecryptedCredentialOauth2AuthorizationCode>?
  oauth2AuthorizationCode;

  /// OAuth2 client credentials.
  /// Structure is documented below.
  final pulumi.Input<AuthConfigDecryptedCredentialOauth2ClientCredentials>?
  ...
  /// Structure is documented below.
  final pulumi.Input<AuthConfigDecryptedCredentialServiceAccountCredentials>?
  serviceAccountCredentials;

  /// Username and password credential.
  /// Structure is documented below.
  final pulumi.Input<AuthConfigDecryptedCredentialUsernameAndPassword>?
  usernameAndPassword;
