...
import 'v2_policy_orchestrator_for_organization_orchestrated_resource_os_policy_assignment_v1_payload.dart';
...
class V2PolicyOrchestratorForOrganizationOrchestratedResource {
  ...
  const V2PolicyOrchestratorForOrganizationOrchestratedResource({
    this.id,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'id': ?id,
      'osPolicyAssignmentV1Payload': ?pulumi.Input.mapOptionalInputValue<V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1Payload, Map<String, dynamic>>(osPolicyAssignmentV1Payload, (value) => value.toMap()),
    };
  }
  ...
  factory V2PolicyOrchestratorForOrganizationOrchestratedResource.fromMap(Map<String, dynamic> map) {
    return V2PolicyOrchestratorForOrganizationOrchestratedResource(
      ...
      osPolicyAssignmentV1Payload: (() { final guardedValue = map['osPolicyAssignmentV1Payload']; if (guardedValue == null) return null; return pulumi.Input.fromValue(V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1Payload.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
