...
class V2PolicyOrchestratorForOrganizationOrchestrationStateCurrentIterationState {
  ...
  final pulumi.Input<V2PolicyOrchestratorForOrganizationOrchestrationStateCurrentIterationStateError>? error;
  /// (Output)
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'error': ?pulumi.Input.mapOptionalInputValue<V2PolicyOrchestratorForOrganizationOrchestrationStateCurrentIterationStateError, Map<String, dynamic>>(error, (value) => value.toMap()),
  ...
  factory V2PolicyOrchestratorForOrganizationOrchestrationStateCurrentIterationState.fromMap(Map<String, dynamic> map) {
    return V2PolicyOrchestratorForOrganizationOrchestrationStateCurrentIterationState(
      error: (() { final guardedValue = map['error']; if (guardedValue == null) return null; return pulumi.Input.fromValue(V2PolicyOrchestratorForOrganizationOrchestrationStateCurrentIterationStateError.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
