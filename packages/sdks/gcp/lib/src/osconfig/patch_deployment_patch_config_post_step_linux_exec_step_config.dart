...
import 'patch_deployment_patch_config_post_step_linux_exec_step_config_gcs_object.dart';
...
class PatchDeploymentPatchConfigPostStepLinuxExecStepConfig {
  ...
  /// Creates a new [PatchDeploymentPatchConfigPostStepLinuxExecStepConfig].
  ...
  factory PatchDeploymentPatchConfigPostStepLinuxExecStepConfig.fromMap(Map<String, dynamic> map) {
    return PatchDeploymentPatchConfigPostStepLinuxExecStepConfig(
      ...
      gcsObject: map['gcsObject'] == null ? null : (PatchDeploymentPatchConfigPostStepLinuxExecStepConfigGcsObject.fromMap((map['gcsObject']! as Map).cast<String, dynamic>())).input(),
