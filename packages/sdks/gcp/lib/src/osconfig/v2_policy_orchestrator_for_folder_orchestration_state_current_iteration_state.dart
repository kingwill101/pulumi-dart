...
class V2PolicyOrchestratorForFolderOrchestrationStateCurrentIterationState {
  ...
  const V2PolicyOrchestratorForFolderOrchestrationStateCurrentIterationState({
    this.errors,
    this.failedActions,
    this.finishTime,
  ...
  factory V2PolicyOrchestratorForFolderOrchestrationStateCurrentIterationState.fromMap(Map<String, dynamic> map) {
    return V2PolicyOrchestratorForFolderOrchestrationStateCurrentIterationState(
      errors: (() { final guardedValue = map['errors']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<V2PolicyOrchestratorForFolderOrchestrationStateCurrentIterationStateError>(guardedValue, (value) => V2PolicyOrchestratorForFolderOrchestrationStateCurrentIterationStateError.fromMap((value as Map).cast<String, dynamic>()))); })(),
