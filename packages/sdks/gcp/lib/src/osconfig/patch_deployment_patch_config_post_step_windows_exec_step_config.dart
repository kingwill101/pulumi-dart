...
class PatchDeploymentPatchConfigPostStepWindowsExecStepConfig {
  ...
  final PatchDeploymentPatchConfigPostStepWindowsExecStepConfigGcsObject? gcsObject;
  ...
  factory PatchDeploymentPatchConfigPostStepWindowsExecStepConfig.fromMap(Map<String, dynamic> map) {
    return PatchDeploymentPatchConfigPostStepWindowsExecStepConfig(
      ...
      gcsObject: map['gcsObject'] == null ? null : PatchDeploymentPatchConfigPostStepWindowsExecStepConfigGcsObject.fromMap((map['gcsObject'] as Map).cast<String, dynamic>()),
