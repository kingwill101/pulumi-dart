...
class GuestPoliciesRecipeUpdateStepFileCopy {
  ...
  /// Creates a new [GuestPoliciesRecipeUpdateStepFileCopy].
  ...
  factory GuestPoliciesRecipeUpdateStepFileCopy.fromMap(Map<String, dynamic> map) {
    return GuestPoliciesRecipeUpdateStepFileCopy(
