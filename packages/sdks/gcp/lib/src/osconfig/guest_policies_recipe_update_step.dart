...
class GuestPoliciesRecipeUpdateStep {
  ...
  final pulumi.Input<GuestPoliciesRecipeUpdateStepArchiveExtraction>?
  archiveExtraction;

  /// Installs a deb file via dpkg.
  /// Structure is documented below.
  final pulumi.Input<GuestPoliciesRecipeUpdateStepDpkgInstallation>?
  dpkgInstallation;
  ...
  /// Structure is documented below.
  final pulumi.Input<GuestPoliciesRecipeUpdateStepMsiInstallation>?
  msiInstallation;

  /// Installs an rpm file via the rpm utility.
  /// Structure is documented below.
  final pulumi.Input<GuestPoliciesRecipeUpdateStepRpmInstallation>?
  rpmInstallation;
