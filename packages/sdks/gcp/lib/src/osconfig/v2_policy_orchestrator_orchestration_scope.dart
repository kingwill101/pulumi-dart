...
class V2PolicyOrchestratorOrchestrationScope {
  ...
  final pulumi.Input<List<V2PolicyOrchestratorOrchestrationScopeSelector>>?
  selectors;
  ...
  V2PolicyOrchestratorOrchestrationScope({this.selectors});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'selectors':
          ?pulumi.Input.mapOptionalInputValue<
            List<V2PolicyOrchestratorOrchestrationScopeSelector>,
