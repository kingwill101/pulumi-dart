...
class PatchDeploymentRecurringSchedule {
  ...
  factory PatchDeploymentRecurringSchedule.fromMap(Map<String, dynamic> map) {
    return PatchDeploymentRecurringSchedule(
      ...
      monthly: (() { final guardedValue = map['monthly']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PatchDeploymentRecurringScheduleMonthly.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      nextExecuteTime: (() { final guardedValue = map['nextExecuteTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      startTime: (() { final guardedValue = map['startTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      timeOfDay: pulumi.Input.fromValue(PatchDeploymentRecurringScheduleTimeOfDay.fromMap((map['timeOfDay']! as Map).cast<String, dynamic>())),
      timeZone: pulumi.Input.fromValue(PatchDeploymentRecurringScheduleTimeZone.fromMap((map['timeZone']! as Map).cast<String, dynamic>())),
      weekly: (() { final guardedValue = map['weekly']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PatchDeploymentRecurringScheduleWeekly.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
