...
class PatchDeploymentPatchConfigPreStepLinuxExecStepConfig {
  ...
  const PatchDeploymentPatchConfigPreStepLinuxExecStepConfig({
  ...
  factory PatchDeploymentPatchConfigPreStepLinuxExecStepConfig.fromMap(Map<String, dynamic> map) {
    return PatchDeploymentPatchConfigPreStepLinuxExecStepConfig(
      ...
      gcsObject: (() { final guardedValue = map['gcsObject']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PatchDeploymentPatchConfigPreStepLinuxExecStepConfigGcsObject.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
