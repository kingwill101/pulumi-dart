...
class PatchDeploymentPatchConfigPostStep {
  ...
  final PatchDeploymentPatchConfigPostStepLinuxExecStepConfig? linuxExecStepConfig;
  /// The ExecStepConfig for all Windows VMs targeted by the PatchJob.
  /// Structure is documented below.
  final PatchDeploymentPatchConfigPostStepWindowsExecStepConfig? windowsExecStepConfig;
  ...
  factory PatchDeploymentPatchConfigPostStep.fromMap(Map<String, dynamic> map) {
    return PatchDeploymentPatchConfigPostStep(
      linuxExecStepConfig: map['linuxExecStepConfig'] == null ? null : PatchDeploymentPatchConfigPostStepLinuxExecStepConfig.fromMap((map['linuxExecStepConfig'] as Map).cast<String, dynamic>()),
      windowsExecStepConfig: map['windowsExecStepConfig'] == null ? null : PatchDeploymentPatchConfigPostStepWindowsExecStepConfig.fromMap((map['windowsExecStepConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
