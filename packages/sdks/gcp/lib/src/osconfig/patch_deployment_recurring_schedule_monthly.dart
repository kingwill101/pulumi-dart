...
class PatchDeploymentRecurringScheduleMonthly {
  ...
  final pulumi.Input<PatchDeploymentRecurringScheduleMonthlyWeekDayOfMonth>?
  weekDayOfMonth;
  ...
  PatchDeploymentRecurringScheduleMonthly({this.monthDay, this.weekDayOfMonth});
  ...
  factory PatchDeploymentRecurringScheduleMonthly.fromMap(
    ...
    return PatchDeploymentRecurringScheduleMonthly(
      monthDay: (() {
        final guardedValue = map['monthDay'];
