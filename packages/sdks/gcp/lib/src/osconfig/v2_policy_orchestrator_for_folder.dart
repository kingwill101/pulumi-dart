...
class V2PolicyOrchestratorForFolder extends pulumi.CustomResource {
  ...
  V2PolicyOrchestratorForFolder(
    ...
    orchestratedResource = registerOutput<V2PolicyOrchestratorForFolderOrchestratedResource>('orchestratedResource', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return V2PolicyOrchestratorForFolderOrchestratedResource.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    orchestrationScope = registerOutput<V2PolicyOrchestratorForFolderOrchestrationScope?>('orchestrationScope', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return V2PolicyOrchestratorForFolderOrchestrationScope.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    orchestrationStates = registerOutput<List<V2PolicyOrchestratorForFolderOrchestrationState>>('orchestrationStates', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return pulumi.Input.decodeList<V2PolicyOrchestratorForFolderOrchestrationState>(guardedValue, (value) => V2PolicyOrchestratorForFolderOrchestrationState.fromMap((value as Map).cast<String, dynamic>())); });
  ...
  /// Creates a typed reference to an existing [V2PolicyOrchestratorForFolder] resource.
  V2PolicyOrchestratorForFolder.reference(String urn)
    : super(
        'gcp:osconfig/v2PolicyOrchestratorForFolder:V2PolicyOrchestratorForFolder',
