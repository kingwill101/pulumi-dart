...
class GuestPoliciesRecipeInstallStep {
  ...
  final pulumi.Input<GuestPoliciesRecipeInstallStepArchiveExtraction>?
  archiveExtraction;

  /// Installs a deb file via dpkg.
  /// Structure is documented below.
  final pulumi.Input<GuestPoliciesRecipeInstallStepDpkgInstallation>?
  dpkgInstallation;
  ...
  /// Structure is documented below.
  final pulumi.Input<GuestPoliciesRecipeInstallStepMsiInstallation>?
  msiInstallation;

  /// Installs an rpm file via the rpm utility.
  /// Structure is documented below.
  final pulumi.Input<GuestPoliciesRecipeInstallStepRpmInstallation>?
  rpmInstallation;
  ...
  factory GuestPoliciesRecipeInstallStep.fromMap(Map<String, dynamic> map) {
    return GuestPoliciesRecipeInstallStep(
      archiveExtraction: (() {
        final guardedValue = map['archiveExtraction'];
      ...
      dpkgInstallation: (() {
        final guardedValue = map['dpkgInstallation'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      fileCopy: (() {
        final guardedValue = map['fileCopy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      fileExec: (() {
        final guardedValue = map['fileExec'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      msiInstallation: (() {
        final guardedValue = map['msiInstallation'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      rpmInstallation: (() {
        final guardedValue = map['rpmInstallation'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      scriptRun: (() {
        final guardedValue = map['scriptRun'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
