...
class OsPolicyAssignmentOsPolicyResourceGroupResourceFileFile {
  ...
  factory OsPolicyAssignmentOsPolicyResourceGroupResourceFileFile.fromMap(Map<String, dynamic> map) {
    return OsPolicyAssignmentOsPolicyResourceGroupResourceFileFile(
      ...
      gcs: map['gcs'] == null ? null : (OsPolicyAssignmentOsPolicyResourceGroupResourceFileFileGcs.fromMap((map['gcs'] as Map).cast<String, dynamic>())).input(),
      localPath: map['localPath'] == null ? null : (map['localPath'] as String).input(),
      remote: map['remote'] == null ? null : (OsPolicyAssignmentOsPolicyResourceGroupResourceFileFileRemote.fromMap((map['remote'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
