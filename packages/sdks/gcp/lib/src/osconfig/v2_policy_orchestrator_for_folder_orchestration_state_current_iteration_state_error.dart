...
class V2PolicyOrchestratorForFolderOrchestrationStateCurrentIterationStateError {
  ...
  factory V2PolicyOrchestratorForFolderOrchestrationStateCurrentIterationStateError.fromMap(
      ...
      details: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                V2PolicyOrchestratorForFolderOrchestrationStateCurrentIterationStateErrorDetail.fromMap(
