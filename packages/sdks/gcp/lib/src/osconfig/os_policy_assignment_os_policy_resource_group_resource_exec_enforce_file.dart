...
class OsPolicyAssignmentOsPolicyResourceGroupResourceExecEnforceFile {
  ...
  factory OsPolicyAssignmentOsPolicyResourceGroupResourceExecEnforceFile.fromMap(Map<String, dynamic> map) {
    return OsPolicyAssignmentOsPolicyResourceGroupResourceExecEnforceFile(
      ...
      gcs: map['gcs'] == null ? null : (OsPolicyAssignmentOsPolicyResourceGroupResourceExecEnforceFileGcs.fromMap((map['gcs']! as Map).cast<String, dynamic>())).input(),
      localPath: map['localPath'] == null ? null : (map['localPath']! as String).input(),
      remote: map['remote'] == null ? null : (OsPolicyAssignmentOsPolicyResourceGroupResourceExecEnforceFileRemote.fromMap((map['remote']! as Map).cast<String, dynamic>())).input(),
    );
  }
}
