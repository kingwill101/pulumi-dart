...
class GuestPoliciesRecipeInstallStepFileExec {
  ...
  const GuestPoliciesRecipeInstallStepFileExec({
  ...
  factory GuestPoliciesRecipeInstallStepFileExec.fromMap(Map<String, dynamic> map) {
    return GuestPoliciesRecipeInstallStepFileExec(
      allowedExitCodes: (() { final guardedValue = map['allowedExitCodes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
