...
class OsPolicyAssignmentInstanceFilter {
  ...
  /// documented below.
  final pulumi.Input<List<OsPolicyAssignmentInstanceFilterExclusionLabel>>?
  exclusionLabels;
  ...
  /// documented below.
  final pulumi.Input<List<OsPolicyAssignmentInstanceFilterInclusionLabel>>?
  inclusionLabels;
    ...
    return <String, dynamic>{
      ...
      'exclusionLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<OsPolicyAssignmentInstanceFilterExclusionLabel>,
      ...
      'inclusionLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<OsPolicyAssignmentInstanceFilterInclusionLabel>,
            List<Map<String, dynamic>>
          >(
            inclusionLabels,
            (value) =>
    ...
    return OsPolicyAssignmentInstanceFilter(
      ...
      exclusionLabels: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<OsPolicyAssignmentInstanceFilterExclusionLabel>(
            guardedValue,
      ...
      inclusionLabels: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<OsPolicyAssignmentInstanceFilterInclusionLabel>(
            guardedValue,
