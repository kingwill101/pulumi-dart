...
class V2PolicyOrchestratorOrchestrationState {
  ...
  factory V2PolicyOrchestratorOrchestrationState.fromMap(Map<String, dynamic> map) {
    return V2PolicyOrchestratorOrchestrationState(
      currentIterationStates: (() { final guardedValue = map['currentIterationStates']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<V2PolicyOrchestratorOrchestrationStateCurrentIterationState>(guardedValue, (value) => V2PolicyOrchestratorOrchestrationStateCurrentIterationState.fromMap((value as Map).cast<String, dynamic>()))); })(),
      previousIterationState: (() { final guardedValue = map['previousIterationState']; if (guardedValue == null) return null; return pulumi.Input.fromValue(V2PolicyOrchestratorOrchestrationStatePreviousIterationState.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
