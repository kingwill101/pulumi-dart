...
class PatchDeploymentRecurringScheduleTimeOfDay {
  ...
  /// Creates a new [PatchDeploymentRecurringScheduleTimeOfDay].
  ...
  const PatchDeploymentRecurringScheduleTimeOfDay({
    this.hours,
    this.minutes,
    this.nanos,
    this.seconds,
  ...
  factory PatchDeploymentRecurringScheduleTimeOfDay.fromMap(Map<String, dynamic> map) {
