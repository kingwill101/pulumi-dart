...
class GuestPoliciesAssignment {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'groupLabels': ?groupLabels == null ? null : pulumi.Input.encodeList<GuestPoliciesAssignmentGroupLabel, Map<String, dynamic>>(groupLabels!, (value) => value.toMap()),
      'instanceNamePrefixes': ?instanceNamePrefixes,
      'instances': ?instances,
      'osTypes': ?osTypes == null ? null : pulumi.Input.encodeList<GuestPoliciesAssignmentOsType, Map<String, dynamic>>(osTypes!, (value) => value.toMap()),
      'zones': ?zones,
    };
  }
  ...
  factory GuestPoliciesAssignment.fromMap(Map<String, dynamic> map) {
    return GuestPoliciesAssignment(
      groupLabels: map['groupLabels'] == null ? null : pulumi.Input.decodeList<GuestPoliciesAssignmentGroupLabel>(map['groupLabels'], (value) => GuestPoliciesAssignmentGroupLabel.fromMap((value as Map).cast<String, dynamic>())),
      instanceNamePrefixes: map['instanceNamePrefixes'] == null ? null : (map['instanceNamePrefixes'] as List).cast<String>(),
      instances: map['instances'] == null ? null : (map['instances'] as List).cast<String>(),
      osTypes: map['osTypes'] == null ? null : pulumi.Input.decodeList<GuestPoliciesAssignmentOsType>(map['osTypes'], (value) => GuestPoliciesAssignmentOsType.fromMap((value as Map).cast<String, dynamic>())),
