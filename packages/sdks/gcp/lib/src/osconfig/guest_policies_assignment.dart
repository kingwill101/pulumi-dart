...
class GuestPoliciesAssignment {
  ...
  factory GuestPoliciesAssignment.fromMap(Map<String, dynamic> map) {
    return GuestPoliciesAssignment(
      groupLabels: (() { final guardedValue = map['groupLabels']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GuestPoliciesAssignmentGroupLabel>(guardedValue, (value) => GuestPoliciesAssignmentGroupLabel.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      osTypes: (() { final guardedValue = map['osTypes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GuestPoliciesAssignmentOsType>(guardedValue, (value) => GuestPoliciesAssignmentOsType.fromMap((value as Map).cast<String, dynamic>()))); })(),
