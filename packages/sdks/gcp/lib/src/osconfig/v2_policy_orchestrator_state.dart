...
class V2PolicyOrchestratorState {
  ...
  factory V2PolicyOrchestratorState.fromMap(Map<String, dynamic> map) {
    return V2PolicyOrchestratorState(
      ...
      orchestratedResource: (() { final guardedValue = map['orchestratedResource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(V2PolicyOrchestratorOrchestratedResource.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      orchestrationScope: (() { final guardedValue = map['orchestrationScope']; if (guardedValue == null) return null; return pulumi.Input.fromValue(V2PolicyOrchestratorOrchestrationScope.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      orchestrationStates: (() { final guardedValue = map['orchestrationStates']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<V2PolicyOrchestratorOrchestrationState>(guardedValue, (value) => V2PolicyOrchestratorOrchestrationState.fromMap((value as Map).cast<String, dynamic>()))); })(),
