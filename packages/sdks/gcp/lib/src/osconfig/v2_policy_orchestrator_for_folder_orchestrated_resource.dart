...
class V2PolicyOrchestratorForFolderOrchestratedResource {
  ...
  const V2PolicyOrchestratorForFolderOrchestratedResource({
    this.id,
  ...
  factory V2PolicyOrchestratorForFolderOrchestratedResource.fromMap(Map<String, dynamic> map) {
    return V2PolicyOrchestratorForFolderOrchestratedResource(
      ...
      osPolicyAssignmentV1Payload: (() { final guardedValue = map['osPolicyAssignmentV1Payload']; if (guardedValue == null) return null; return pulumi.Input.fromValue(V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1Payload.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
