...
class V2PolicyOrchestratorForFolderArgs {
  ...
  factory V2PolicyOrchestratorForFolderArgs.fromMap(Map<String, dynamic> map) {
    return V2PolicyOrchestratorForFolderArgs(
      ...
      orchestratedResource: pulumi.Input.fromValue(V2PolicyOrchestratorForFolderOrchestratedResource.fromMap((map['orchestratedResource']! as Map).cast<String, dynamic>())),
