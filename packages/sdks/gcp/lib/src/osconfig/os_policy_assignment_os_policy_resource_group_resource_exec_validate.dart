...
class OsPolicyAssignmentOsPolicyResourceGroupResourceExecValidate {
  ...
  const OsPolicyAssignmentOsPolicyResourceGroupResourceExecValidate({
    this.args,
    this.file,
  ...
  factory OsPolicyAssignmentOsPolicyResourceGroupResourceExecValidate.fromMap(Map<String, dynamic> map) {
    return OsPolicyAssignmentOsPolicyResourceGroupResourceExecValidate(
      ...
      file: (() { final guardedValue = map['file']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OsPolicyAssignmentOsPolicyResourceGroupResourceExecValidateFile.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
