...
class V2PolicyOrchestratorForOrganizationOrchestrationScopeSelector {
  ...
  const V2PolicyOrchestratorForOrganizationOrchestrationScopeSelector({
  ...
  factory V2PolicyOrchestratorForOrganizationOrchestrationScopeSelector.fromMap(Map<String, dynamic> map) {
    return V2PolicyOrchestratorForOrganizationOrchestrationScopeSelector(
      locationSelector: (() { final guardedValue = map['locationSelector']; if (guardedValue == null) return null; return pulumi.Input.fromValue(V2PolicyOrchestratorForOrganizationOrchestrationScopeSelectorLocationSelector.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      resourceHierarchySelector: (() { final guardedValue = map['resourceHierarchySelector']; if (guardedValue == null) return null; return pulumi.Input.fromValue(V2PolicyOrchestratorForOrganizationOrchestrationScopeSelectorResourceHierarchySelector.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
