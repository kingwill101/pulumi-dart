...
class OsPolicyAssignmentOsPolicyResourceGroupResourcePkg {
  ...
  /// documented below.
  final pulumi.Input<OsPolicyAssignmentOsPolicyResourceGroupResourcePkgApt>?
  apt;

  /// A deb package file. Structure is
  /// documented below.
  final pulumi.Input<OsPolicyAssignmentOsPolicyResourceGroupResourcePkgDeb>?
  deb;
  ...
  /// documented below.
  final pulumi.Input<OsPolicyAssignmentOsPolicyResourceGroupResourcePkgGooget>?
  googet;

  /// An MSI package. Structure is
  /// documented below.
  final pulumi.Input<OsPolicyAssignmentOsPolicyResourceGroupResourcePkgMsi>?
  msi;

  /// An rpm package file. Structure is
  /// documented below.
  final pulumi.Input<OsPolicyAssignmentOsPolicyResourceGroupResourcePkgRpm>?
  rpm;

  /// A package managed by YUM. Structure is
  /// documented below.
  final pulumi.Input<OsPolicyAssignmentOsPolicyResourceGroupResourcePkgYum>?
  yum;

  /// A package managed by Zypper. Structure is
  /// documented below.
  final pulumi.Input<OsPolicyAssignmentOsPolicyResourceGroupResourcePkgZypper>?
  zypper;
