...
class V2PolicyOrchestratorOrchestrationStatePreviousIterationState {
  ...
  const V2PolicyOrchestratorOrchestrationStatePreviousIterationState({
    this.error,
    this.failedActions,
    this.finishTime,
  ...
  factory V2PolicyOrchestratorOrchestrationStatePreviousIterationState.fromMap(Map<String, dynamic> map) {
    return V2PolicyOrchestratorOrchestrationStatePreviousIterationState(
      error: (() { final guardedValue = map['error']; if (guardedValue == null) return null; return pulumi.Input.fromValue(V2PolicyOrchestratorOrchestrationStatePreviousIterationStateError.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
