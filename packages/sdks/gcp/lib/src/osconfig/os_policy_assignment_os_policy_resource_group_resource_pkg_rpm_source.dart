...
class OsPolicyAssignmentOsPolicyResourceGroupResourcePkgRpmSource {
  ...
  const OsPolicyAssignmentOsPolicyResourceGroupResourcePkgRpmSource({
    this.allowInsecure,
    this.gcs,
    this.localPath,
    this.remote,
  ...
  factory OsPolicyAssignmentOsPolicyResourceGroupResourcePkgRpmSource.fromMap(Map<String, dynamic> map) {
    return OsPolicyAssignmentOsPolicyResourceGroupResourcePkgRpmSource(
      ...
      gcs: (() { final guardedValue = map['gcs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OsPolicyAssignmentOsPolicyResourceGroupResourcePkgRpmSourceGcs.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      remote: (() { final guardedValue = map['remote']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OsPolicyAssignmentOsPolicyResourceGroupResourcePkgRpmSourceRemote.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
