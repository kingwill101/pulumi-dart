...
class GetInstanceAutomatedBackupConfig {
  ...
  factory GetInstanceAutomatedBackupConfig.fromMap(Map<String, dynamic> map) {
    return GetInstanceAutomatedBackupConfig(
      fixedFrequencySchedules: (pulumi.Input.decodeList<GetInstanceAutomatedBackupConfigFixedFrequencySchedule>(map['fixedFrequencySchedules'], (value) => GetInstanceAutomatedBackupConfigFixedFrequencySchedule.fromMap((value as Map).cast<String, dynamic>()))).input(),
