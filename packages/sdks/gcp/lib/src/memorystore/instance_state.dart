...
class InstanceState {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'discoveryEndpoints':
          ?pulumi.Input.mapOptionalInputValue<
            List<InstanceDiscoveryEndpoint>,
            List<Map<String, dynamic>>
          >(
            discoveryEndpoints,
            (value) =>
      ...
      'maintenanceSchedules':
          ?pulumi.Input.mapOptionalInputValue<
            List<InstanceMaintenanceSchedule>,
            List<Map<String, dynamic>>
          >(
            maintenanceSchedules,
            (value) =>
      ...
      'pscAttachmentDetails':
          ?pulumi.Input.mapOptionalInputValue<
            List<InstancePscAttachmentDetail>,
            List<Map<String, dynamic>>
          >(
            pscAttachmentDetails,
            (value) =>
      ...
      'pscAutoConnections':
          ?pulumi.Input.mapOptionalInputValue<
            List<InstancePscAutoConnection>,
            List<Map<String, dynamic>>
          >(
            pscAutoConnections,
            (value) =>
  ...
  factory InstanceState.fromMap(Map<String, dynamic> map) {
    return InstanceState(
      ...
      availableMaintenanceVersions: (() {
        final guardedValue = map['availableMaintenanceVersions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      backupCollection: (() {
        final guardedValue = map['backupCollection'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      createTime: (() {
      ...
      crossInstanceReplicationConfig: (() {
        final guardedValue = map['crossInstanceReplicationConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      desiredAutoCreatedEndpoints: (() {
        final guardedValue = map['desiredAutoCreatedEndpoints'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      desiredPscAutoConnections: (() {
        final guardedValue = map['desiredPscAutoConnections'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      discoveryEndpoints: (() {
        final guardedValue = map['discoveryEndpoints'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InstanceDiscoveryEndpoint>(
            guardedValue,
            (value) => InstanceDiscoveryEndpoint.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      effectiveMaintenanceVersion: (() {
        final guardedValue = map['effectiveMaintenanceVersion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      endpoints: (() {
      ...
      engineConfigs: (() {
        final guardedValue = map['engineConfigs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as Map).cast<String, String>(),
        );
      ...
      maintenanceSchedules: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InstanceMaintenanceSchedule>(
            guardedValue,
            (value) => InstanceMaintenanceSchedule.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      managedServerCas: (() {
        final guardedValue = map['managedServerCas'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InstanceManagedServerCa>(
            guardedValue,
            (value) => InstanceManagedServerCa.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      nodeConfigs: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InstanceNodeConfig>(
            guardedValue,
            (value) => InstanceNodeConfig.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      pscAttachmentDetails: (() {
        final guardedValue = map['pscAttachmentDetails'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InstancePscAttachmentDetail>(
            guardedValue,
            (value) => InstancePscAttachmentDetail.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      pscAutoConnections: (() {
        final guardedValue = map['pscAutoConnections'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InstancePscAutoConnection>(
            guardedValue,
            (value) => InstancePscAutoConnection.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      stateInfos: (() {
        final guardedValue = map['stateInfos'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InstanceStateInfo>(
            guardedValue,
            (value) => InstanceStateInfo.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
