...
class GetInstancePersistenceConfig {
  ...
  factory GetInstancePersistenceConfig.fromMap(Map<String, dynamic> map) {
    return GetInstancePersistenceConfig(
      aofConfigs: (pulumi.Input.decodeList<GetInstancePersistenceConfigAofConfig>(map['aofConfigs'], (value) => GetInstancePersistenceConfigAofConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
      mode: (map['mode'] as String).input(),
      rdbConfigs: (pulumi.Input.decodeList<GetInstancePersistenceConfigRdbConfig>(map['rdbConfigs'], (value) => GetInstancePersistenceConfigRdbConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
