...
class GetInstanceEndpoint {
  ...
  factory GetInstanceEndpoint.fromMap(Map<String, dynamic> map) {
    return GetInstanceEndpoint(
      connections: pulumi.Input.fromValue(pulumi.Input.decodeList<GetInstanceEndpointConnection>(map['connections']!, (value) => GetInstanceEndpointConnection.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
