...
class GetInstanceCrossInstanceReplicationConfigMembership {
  ...
  final pulumi.Input<
    List<GetInstanceCrossInstanceReplicationConfigMembershipPrimaryInstance>
  >
  primaryInstances;

  /// List of secondary instances that are replicating from the primary instance.
  final pulumi.Input<
    List<GetInstanceCrossInstanceReplicationConfigMembershipSecondaryInstance>
  >
  secondaryInstances;
    ...
    return GetInstanceCrossInstanceReplicationConfigMembership(
      primaryInstances: pulumi.Input.fromValue(
        ...
        >(
          ...
          (value) =>
              GetInstanceCrossInstanceReplicationConfigMembershipPrimaryInstance.fromMap(
      ...
      secondaryInstances: pulumi.Input.fromValue(
        ...
        >(
          ...
          (value) =>
              GetInstanceCrossInstanceReplicationConfigMembershipSecondaryInstance.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
