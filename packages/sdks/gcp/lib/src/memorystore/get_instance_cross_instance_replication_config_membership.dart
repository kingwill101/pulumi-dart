...
class GetInstanceCrossInstanceReplicationConfigMembership {
  ...
  const GetInstanceCrossInstanceReplicationConfigMembership({
  ...
  factory GetInstanceCrossInstanceReplicationConfigMembership.fromMap(Map<String, dynamic> map) {
    return GetInstanceCrossInstanceReplicationConfigMembership(
      primaryInstances: pulumi.Input.fromValue(pulumi.Input.decodeList<GetInstanceCrossInstanceReplicationConfigMembershipPrimaryInstance>(map['primaryInstances']!, (value) => GetInstanceCrossInstanceReplicationConfigMembershipPrimaryInstance.fromMap((value as Map).cast<String, dynamic>()))),
      secondaryInstances: pulumi.Input.fromValue(pulumi.Input.decodeList<GetInstanceCrossInstanceReplicationConfigMembershipSecondaryInstance>(map['secondaryInstances']!, (value) => GetInstanceCrossInstanceReplicationConfigMembershipSecondaryInstance.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
