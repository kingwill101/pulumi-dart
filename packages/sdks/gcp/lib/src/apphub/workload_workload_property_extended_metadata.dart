...
class WorkloadWorkloadPropertyExtendedMetadata {
  ...
  final pulumi.Input<List<WorkloadWorkloadPropertyExtendedMetadataValue>>?
  values;

  /// Creates a new [WorkloadWorkloadPropertyExtendedMetadata].
  /// [key] (Output)
  /// [values] (Output)
  WorkloadWorkloadPropertyExtendedMetadata({this.key, this.values});
    ...
    return <String, dynamic>{
      ...
      'values':
          ?pulumi.Input.mapOptionalInputValue<
            List<WorkloadWorkloadPropertyExtendedMetadataValue>,
