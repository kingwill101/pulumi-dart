...
class GetApplicationAttribute {
  ...
  final pulumi.Input<List<GetApplicationAttributeDeveloperOwner>>
  developerOwners;
    ...
    return <String, dynamic>{
      'businessOwners':
          pulumi.Input.mapInputValue<
            List<GetApplicationAttributeBusinessOwner>,
      ...
      'criticalities':
          pulumi.Input.mapInputValue<
            List<GetApplicationAttributeCriticality>,
            List<Map<String, dynamic>>
          >(
            criticalities,
            (value) =>
      ...
      'developerOwners':
          pulumi.Input.mapInputValue<
            List<GetApplicationAttributeDeveloperOwner>,
            List<Map<String, dynamic>>
          >(
            developerOwners,
            (value) =>
      ...
      'environments':
          pulumi.Input.mapInputValue<
            List<GetApplicationAttributeEnvironment>,
            List<Map<String, dynamic>>
          >(
            environments,
            (value) =>
      ...
      'operatorOwners':
          pulumi.Input.mapInputValue<
            List<GetApplicationAttributeOperatorOwner>,
            List<Map<String, dynamic>>
          >(
            operatorOwners,
            (value) =>
  ...
  factory GetApplicationAttribute.fromMap(Map<String, dynamic> map) {
    return GetApplicationAttribute(
      businessOwners: pulumi.Input.fromValue(
      ...
      criticalities: pulumi.Input.fromValue(
      ...
      developerOwners: pulumi.Input.fromValue(
      ...
      environments: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetApplicationAttributeEnvironment>(
          map['environments']!,
      ...
      operatorOwners: pulumi.Input.fromValue(
