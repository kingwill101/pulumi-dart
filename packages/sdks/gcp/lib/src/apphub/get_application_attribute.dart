...
class GetApplicationAttribute {
  ...
  factory GetApplicationAttribute.fromMap(Map<String, dynamic> map) {
    return GetApplicationAttribute(
      businessOwners: (pulumi.Input.decodeList<GetApplicationAttributeBusinessOwner>(map['businessOwners'], (value) => GetApplicationAttributeBusinessOwner.fromMap((value as Map).cast<String, dynamic>()))).input(),
      criticalities: (pulumi.Input.decodeList<GetApplicationAttributeCriticality>(map['criticalities'], (value) => GetApplicationAttributeCriticality.fromMap((value as Map).cast<String, dynamic>()))).input(),
      developerOwners: (pulumi.Input.decodeList<GetApplicationAttributeDeveloperOwner>(map['developerOwners'], (value) => GetApplicationAttributeDeveloperOwner.fromMap((value as Map).cast<String, dynamic>()))).input(),
      environments: (pulumi.Input.decodeList<GetApplicationAttributeEnvironment>(map['environments'], (value) => GetApplicationAttributeEnvironment.fromMap((value as Map).cast<String, dynamic>()))).input(),
      operatorOwners: (pulumi.Input.decodeList<GetApplicationAttributeOperatorOwner>(map['operatorOwners'], (value) => GetApplicationAttributeOperatorOwner.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
