...
class ServiceState {
  ...
  factory ServiceState.fromMap(Map<String, dynamic> map) {
    return ServiceState(
      ...
      discoveredService: (() {
        final guardedValue = map['discoveredService'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      displayName: (() {
      ...
      serviceProperties: (() {
        final guardedValue = map['serviceProperties'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ServiceServiceProperty>(
            guardedValue,
            (value) => ServiceServiceProperty.fromMap(
      ...
      serviceReferences: (() {
        final guardedValue = map['serviceReferences'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ServiceServiceReference>(
            guardedValue,
            (value) => ServiceServiceReference.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
