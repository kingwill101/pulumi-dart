...
class ServiceServiceProperty {
  ...
  final pulumi.Input<List<ServiceServicePropertyExtendedMetadata>>?
  extendedMetadatas;

  /// (Output)
  /// Output only. The type of the service.
  /// Structure is documented below.
  final pulumi.Input<List<ServiceServicePropertyFunctionalType>>?
  functionalTypes;
  ...
  /// Structure is documented below.
  final pulumi.Input<List<ServiceServicePropertyRegistrationType>>?
  registrationTypes;
    ...
    return <String, dynamic>{
      'extendedMetadatas':
          ?pulumi.Input.mapOptionalInputValue<
            List<ServiceServicePropertyExtendedMetadata>,
      ...
      'functionalTypes':
          ?pulumi.Input.mapOptionalInputValue<
            List<ServiceServicePropertyFunctionalType>,
            List<Map<String, dynamic>>
          >(
            functionalTypes,
            (value) =>
      ...
      'identities':
          ?pulumi.Input.mapOptionalInputValue<
            List<ServiceServicePropertyIdentity>,
            List<Map<String, dynamic>>
          >(
            identities,
            (value) =>
      ...
      'registrationTypes':
          ?pulumi.Input.mapOptionalInputValue<
            List<ServiceServicePropertyRegistrationType>,
            List<Map<String, dynamic>>
          >(
            registrationTypes,
            (value) =>
  ...
  factory ServiceServiceProperty.fromMap(Map<String, dynamic> map) {
    return ServiceServiceProperty(
      ...
      registrationTypes: (() {
        final guardedValue = map['registrationTypes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
