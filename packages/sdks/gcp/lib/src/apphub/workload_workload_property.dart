...
class WorkloadWorkloadProperty {
  ...
  final pulumi.Input<List<WorkloadWorkloadPropertyExtendedMetadata>>?
  extendedMetadatas;

  /// (Output)
  /// Output only. The functional type of a service or workload.
  /// Structure is documented below.
  final pulumi.Input<List<WorkloadWorkloadPropertyFunctionalType>>?
  functionalTypes;
    ...
    return <String, dynamic>{
      'extendedMetadatas':
          ?pulumi.Input.mapOptionalInputValue<
            List<WorkloadWorkloadPropertyExtendedMetadata>,
      ...
      'functionalTypes':
          ?pulumi.Input.mapOptionalInputValue<
            List<WorkloadWorkloadPropertyFunctionalType>,
            List<Map<String, dynamic>>
          >(
            functionalTypes,
            (value) =>
      ...
      'identities':
          ?pulumi.Input.mapOptionalInputValue<
            List<WorkloadWorkloadPropertyIdentity>,
            List<Map<String, dynamic>>
          >(
            identities,
            (value) =>
  ...
  factory WorkloadWorkloadProperty.fromMap(Map<String, dynamic> map) {
    return WorkloadWorkloadProperty(
      extendedMetadatas: (() {
        final guardedValue = map['extendedMetadatas'];
      ...
      functionalTypes: (() {
        final guardedValue = map['functionalTypes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      gcpProject: (() {
        final guardedValue = map['gcpProject'];
        if (guardedValue == null) return null;
