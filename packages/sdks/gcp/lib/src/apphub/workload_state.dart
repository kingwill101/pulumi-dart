...
class WorkloadState {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'workloadReferences':
          ?pulumi.Input.mapOptionalInputValue<
            List<WorkloadWorkloadReference>,
            List<Map<String, dynamic>>
          >(
            workloadReferences,
            (value) =>
  ...
  factory WorkloadState.fromMap(Map<String, dynamic> map) {
    return WorkloadState(
      ...
      discoveredWorkload: (() {
        final guardedValue = map['discoveredWorkload'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      displayName: (() {
      ...
      workloadProperties: (() {
        final guardedValue = map['workloadProperties'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<WorkloadWorkloadProperty>(
            guardedValue,
            (value) => WorkloadWorkloadProperty.fromMap(
      ...
      workloadReferences: (() {
        final guardedValue = map['workloadReferences'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<WorkloadWorkloadReference>(
            guardedValue,
            (value) => WorkloadWorkloadReference.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
