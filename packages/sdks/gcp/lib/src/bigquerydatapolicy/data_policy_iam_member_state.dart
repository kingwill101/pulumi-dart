...
class DataPolicyIamMemberState {
  ...
  /// Creates a new [DataPolicyIamMemberState].
  /// [condition] Optional.
  ...
  factory DataPolicyIamMemberState.fromMap(Map<String, dynamic> map) {
    return DataPolicyIamMemberState(
