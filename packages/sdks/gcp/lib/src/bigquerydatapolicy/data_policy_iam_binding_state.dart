...
class DataPolicyIamBindingState {
  ...
  /// Creates a new [DataPolicyIamBindingState].
  /// [condition] Optional.
  ...
  factory DataPolicyIamBindingState.fromMap(Map<String, dynamic> map) {
    return DataPolicyIamBindingState(
      condition: (() {
