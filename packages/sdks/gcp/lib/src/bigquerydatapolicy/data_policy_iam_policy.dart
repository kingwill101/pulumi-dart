...
import 'data_policy_iam_policy_state.dart';
...
/// }
///
/// resource "gcp_bigquerydatapolicy_datapolicyiampolicy" "policy" {
///   project        = dataPolicy.project
///   location       = dataPolicy.location
...
/// }
///
/// resource "gcp_bigquerydatapolicy_datapolicyiambinding" "binding" {
///   project        = dataPolicy.project
///   location       = dataPolicy.location
///   data_policy_id = dataPolicy.dataPolicyId
///   role           = "roles/viewer"
...
/// }
///
/// resource "gcp_bigquerydatapolicy_datapolicyiammember" "member" {
///   project        = dataPolicy.project
///   location       = dataPolicy.location
///   data_policy_id = dataPolicy.dataPolicyId
///   role           = "roles/viewer"
...
class DataPolicyIamPolicy extends pulumi.CustomResource {
  ...
  /// Gets an existing [DataPolicyIamPolicy] resource's state with the given [name] and [id].
  static DataPolicyIamPolicy get(
    String name,
    pulumi.Input<String> id, {
    DataPolicyIamPolicyState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return DataPolicyIamPolicy._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [DataPolicyIamPolicy] resource.
  DataPolicyIamPolicy.reference(String urn)
    : super(
        'gcp:bigquerydatapolicy/dataPolicyIamPolicy:DataPolicyIamPolicy',
