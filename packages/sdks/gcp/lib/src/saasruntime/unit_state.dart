    ...
    return <String, dynamic>{
      ...
      'conditions':
          ...
          >(
            conditions,
            (value) =>
                pulumi.Input.encodeList<UnitCondition, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      ...
      'dependencies':
          ...
          >(
            dependencies,
            (value) =>
                pulumi.Input.encodeList<UnitDependency, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      'dependents':
          ...
          >(
            dependents,
            (value) =>
                pulumi.Input.encodeList<UnitDependent, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory UnitState.fromMap(Map<String, dynamic> map) {
    return UnitState(
      ...
      conditions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<UnitCondition>(
            guardedValue,
            (value) =>
                UnitCondition.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      createTime: (() {
      ...
      dependencies: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<UnitDependency>(
            guardedValue,
            (value) =>
                UnitDependency.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      dependents: (() {
        final guardedValue = map['dependents'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<UnitDependent>(
            guardedValue,
            (value) =>
                UnitDependent.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      ...
      inputVariables: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<UnitInputVariable>(
            guardedValue,
            (value) => UnitInputVariable.fromMap(
      ...
      ongoingOperations: (() {
        final guardedValue = map['ongoingOperations'];
        if (guardedValue == null) return null;
      ...
      outputVariables: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<UnitOutputVariable>(
            guardedValue,
            (value) => UnitOutputVariable.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      pendingOperations: (() {
        final guardedValue = map['pendingOperations'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      project: (() {
      ...
      scheduledOperations: (() {
        final guardedValue = map['scheduledOperations'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      state: (() {
      ...
      systemCleanupAt: (() {
        final guardedValue = map['systemCleanupAt'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      systemManagedState: (() {
        final guardedValue = map['systemManagedState'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      tenant: (() {
