...
class ReleaseState {
  ...
  factory ReleaseState.fromMap(Map<String, dynamic> map) {
    return ReleaseState(
      ...
      inputVariables: (() { final guardedValue = map['inputVariables']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ReleaseInputVariable>(guardedValue, (value) => ReleaseInputVariable.fromMap((value as Map).cast<String, dynamic>()))); })(),
      labels: (() { final guardedValue = map['labels']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      location: (() { final guardedValue = map['location']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      outputVariables: (() { final guardedValue = map['outputVariables']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ReleaseOutputVariable>(guardedValue, (value) => ReleaseOutputVariable.fromMap((value as Map).cast<String, dynamic>()))); })(),
