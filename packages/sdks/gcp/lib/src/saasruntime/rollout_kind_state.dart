...
class RolloutKindState {
  ...
  RolloutKindState({
    ...
    pulumi.Output<String>? rolloutKindId,
    ...
    pulumi.Output<String>? updateUnitKindStrategy,
      ...
      rolloutKindId = pulumi.Input.asOptionalInput<String>(rolloutKindId),
  ...
  factory RolloutKindState.fromMap(Map<String, dynamic> map) {
    return RolloutKindState(
      ...
      rolloutKindId: map['rolloutKindId'] == null ? null : pulumi.Output.create<String>(map['rolloutKindId'] as String),
