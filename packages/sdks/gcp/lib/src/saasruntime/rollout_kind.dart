...
class RolloutKind extends pulumi.CustomResource {
  ...
  RolloutKind(
    ...
    this.rolloutOrchestrationStrategy = registerOutput<String?>('rolloutOrchestrationStrategy');
    this.uid = registerOutput<String>('uid');
    this.unitFilter = registerOutput<String?>('unitFilter');
    this.unitKind = registerOutput<String>('unitKind');
    this.updateTime = registerOutput<String>('updateTime');
    this.updateUnitKindStrategy = registerOutput<String?>('updateUnitKindStrategy');
  }
