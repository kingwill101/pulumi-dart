  ...
  factory UnitOperationState.fromMap(Map<String, dynamic> map) {
    return UnitOperationState(
      ...
      conditions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<UnitOperationCondition>(
            guardedValue,
            (value) => UnitOperationCondition.fromMap(
      ...
      deprovision: (() {
        final guardedValue = map['deprovision'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      engineState: (() {
        final guardedValue = map['engineState'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      errorCategory: (() {
      ...
      unitOperationId: (() {
        final guardedValue = map['unitOperationId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      updateTime: (() {
