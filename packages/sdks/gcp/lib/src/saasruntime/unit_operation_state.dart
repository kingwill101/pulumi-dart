...
class UnitOperationState {
  ...
  factory UnitOperationState.fromMap(Map<String, dynamic> map) {
    return UnitOperationState(
      ...
      conditions: map['conditions'] == null ? null : (pulumi.Input.decodeList<UnitOperationCondition>(map['conditions']!, (value) => UnitOperationCondition.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      engineState: map['engineState'] == null ? null : (map['engineState']! as String).input(),
      ...
      unitOperationId: map['unitOperationId'] == null ? null : (map['unitOperationId']! as String).input(),
