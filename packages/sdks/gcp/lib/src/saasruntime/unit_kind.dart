...
class UnitKind extends pulumi.CustomResource {
  ...
  UnitKind(
    ...
    this.dependencies = registerOutput<List<UnitKindDependency>?>('dependencies');
    this.effectiveAnnotations = registerOutput<Map<String, String>>('effectiveAnnotations');
    this.effectiveLabels = registerOutput<Map<String, String>>('effectiveLabels');
    this.etag = registerOutput<String>('etag');
    this.inputVariableMappings = registerOutput<List<UnitKindInputVariableMapping>?>('inputVariableMappings');
    this.labels = registerOutput<Map<String, String>?>('labels');
    this.location = registerOutput<String>('location');
    this.name = registerOutput<String>('name');
    this.outputVariableMappings = registerOutput<List<UnitKindOutputVariableMapping>?>('outputVariableMappings');
