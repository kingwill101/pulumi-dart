...
class RolloutKindArgs {
  ...
  factory RolloutKindArgs.fromMap(Map<String, dynamic> map) {
    return RolloutKindArgs(
      ...
      errorBudget: (() {
        final guardedValue = map['errorBudget'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      rolloutOrchestrationStrategy: (() {
        final guardedValue = map['rolloutOrchestrationStrategy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      unitFilter: (() {
        final guardedValue = map['unitFilter'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      unitKind: pulumi.Input.fromValue(map['unitKind'] as String),
      updateUnitKindStrategy: (() {
        final guardedValue = map['updateUnitKindStrategy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
