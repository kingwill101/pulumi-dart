...
class GetPoliciesPolicy {
  ...
  factory GetPoliciesPolicy.fromMap(Map<String, dynamic> map) {
    return GetPoliciesPolicy(
      ...
      policyQueries: pulumi.Input.fromValue(pulumi.Input.decodeList<GetPoliciesPolicyPolicyQuery>(map['policyQueries']!, (value) => GetPoliciesPolicyPolicyQuery.fromMap((value as Map).cast<String, dynamic>()))),
