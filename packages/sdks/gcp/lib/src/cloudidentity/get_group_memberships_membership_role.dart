...
class GetGroupMembershipsMembershipRole {
  ...
  final pulumi.Input<List<GetGroupMembershipsMembershipRoleExpiryDetail>>
  expiryDetails;
    ...
    return <String, dynamic>{
      'expiryDetails':
          pulumi.Input.mapInputValue<
            List<GetGroupMembershipsMembershipRoleExpiryDetail>,
  ...
  factory GetGroupMembershipsMembershipRole.fromMap(Map<String, dynamic> map) {
    return GetGroupMembershipsMembershipRole(
      expiryDetails: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetGroupMembershipsMembershipRoleExpiryDetail>(
          map['expiryDetails']!,
