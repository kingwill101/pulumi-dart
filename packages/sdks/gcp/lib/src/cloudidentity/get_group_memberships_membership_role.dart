...
class GetGroupMembershipsMembershipRole {
  ...
  factory GetGroupMembershipsMembershipRole.fromMap(Map<String, dynamic> map) {
    return GetGroupMembershipsMembershipRole(
      expiryDetails: (pulumi.Input.decodeList<GetGroupMembershipsMembershipRoleExpiryDetail>(map['expiryDetails'], (value) => GetGroupMembershipsMembershipRoleExpiryDetail.fromMap((value as Map).cast<String, dynamic>()))).input(),
