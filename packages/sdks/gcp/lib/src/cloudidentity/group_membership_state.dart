...
class GroupMembershipState {
  ...
  factory GroupMembershipState.fromMap(Map<String, dynamic> map) {
    return GroupMembershipState(
      ...
      roles: (() { final guardedValue = map['roles']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GroupMembershipRole>(guardedValue, (value) => GroupMembershipRole.fromMap((value as Map).cast<String, dynamic>()))); })(),
