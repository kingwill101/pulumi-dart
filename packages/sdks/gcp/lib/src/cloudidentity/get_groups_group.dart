...
class GetGroupsGroup {
  ...
  final pulumi.Input<List<GetGroupsGroupAdditionalGroupKey>>
  additionalGroupKeys;
    ...
    return <String, dynamic>{
      'additionalGroupKeys':
          pulumi.Input.mapInputValue<
            List<GetGroupsGroupAdditionalGroupKey>,
  ...
  factory GetGroupsGroup.fromMap(Map<String, dynamic> map) {
    return GetGroupsGroup(
      additionalGroupKeys: pulumi.Input.fromValue(
      ...
      groupKeys: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetGroupsGroupGroupKey>(
          map['groupKeys']!,
