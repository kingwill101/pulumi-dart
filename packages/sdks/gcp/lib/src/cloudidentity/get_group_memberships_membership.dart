...
class GetGroupMembershipsMembership {
  ...
  /// EntityKey of the member.  Structure is documented below.
  final pulumi.Input<List<GetGroupMembershipsMembershipPreferredMemberKey>>
  preferredMemberKeys;
    ...
    return <String, dynamic>{
      ...
      'memberKeys':
          pulumi.Input.mapInputValue<
            List<GetGroupMembershipsMembershipMemberKey>,
      ...
      'preferredMemberKeys':
          pulumi.Input.mapInputValue<
            List<GetGroupMembershipsMembershipPreferredMemberKey>,
            List<Map<String, dynamic>>
          >(
            preferredMemberKeys,
            (value) =>
      ...
      'roles':
          pulumi.Input.mapInputValue<
            List<GetGroupMembershipsMembershipRole>,
            List<Map<String, dynamic>>
          >(
            roles,
            (value) =>
  ...
  factory GetGroupMembershipsMembership.fromMap(Map<String, dynamic> map) {
    return GetGroupMembershipsMembership(
      ...
      roles: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetGroupMembershipsMembershipRole>(
          map['roles']!,
