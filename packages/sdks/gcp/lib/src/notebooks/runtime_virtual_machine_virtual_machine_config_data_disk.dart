...
class RuntimeVirtualMachineVirtualMachineConfigDataDisk {
  ...
  final RuntimeVirtualMachineVirtualMachineConfigDataDiskInitializeParams? initializeParams;
  ...
  factory RuntimeVirtualMachineVirtualMachineConfigDataDisk.fromMap(Map<String, dynamic> map) {
    return RuntimeVirtualMachineVirtualMachineConfigDataDisk(
      ...
      initializeParams: map['initializeParams'] == null ? null : RuntimeVirtualMachineVirtualMachineConfigDataDiskInitializeParams.fromMap((map['initializeParams'] as Map).cast<String, dynamic>()),
