...
import 'runtime_iam_member_state.dart';
...
class RuntimeIamMember extends pulumi.CustomResource {
  ...
  RuntimeIamMember(
    ...
    condition = registerOutput<RuntimeIamMemberCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return RuntimeIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [RuntimeIamMember] resource's state with the given [name] and [id].
  static RuntimeIamMember get(
    String name,
    pulumi.Input<String> id, {
    RuntimeIamMemberState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return RuntimeIamMember._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [RuntimeIamMember] resource.
  RuntimeIamMember.reference(String urn)
    : super(
        'gcp:notebooks/runtimeIamMember:RuntimeIamMember',
