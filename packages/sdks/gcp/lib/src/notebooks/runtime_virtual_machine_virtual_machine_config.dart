...
class RuntimeVirtualMachineVirtualMachineConfig {
  ...
  /// Structure is documented below.
  final pulumi.Input<RuntimeVirtualMachineVirtualMachineConfigDataDisk>
  dataDisk;

  /// Encryption settings for virtual machine data disk.
  /// Structure is documented below.
  final pulumi.Input<RuntimeVirtualMachineVirtualMachineConfigEncryptionConfig>?
  encryptionConfig;
  ...
  factory RuntimeVirtualMachineVirtualMachineConfig.fromMap(
    ...
    return RuntimeVirtualMachineVirtualMachineConfig(
      ...
      dataDisk: pulumi.Input.fromValue(
        RuntimeVirtualMachineVirtualMachineConfigDataDisk.fromMap(
      ...
      guestAttributes: (() {
        final guardedValue = map['guestAttributes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
