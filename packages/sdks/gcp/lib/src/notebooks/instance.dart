...
class Instance extends pulumi.CustomResource {
  ...
  Instance(
    ...
    this.acceleratorConfig = registerOutput<InstanceAcceleratorConfig?>('acceleratorConfig');
    this.bootDiskSizeGb = registerOutput<int?>('bootDiskSizeGb');
    this.bootDiskType = registerOutput<String?>('bootDiskType');
    this.containerImage = registerOutput<InstanceContainerImage?>('containerImage');
