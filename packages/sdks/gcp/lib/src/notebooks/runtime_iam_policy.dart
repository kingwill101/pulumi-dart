...
import 'runtime_iam_policy_state.dart';
...
class RuntimeIamPolicy extends pulumi.CustomResource {
  ...
  /// Gets an existing [RuntimeIamPolicy] resource's state with the given [name] and [id].
  static RuntimeIamPolicy get(
    String name,
    pulumi.Input<String> id, {
    RuntimeIamPolicyState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return RuntimeIamPolicy._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [RuntimeIamPolicy] resource.
  RuntimeIamPolicy.reference(String urn)
    : super(
        'gcp:notebooks/runtimeIamPolicy:RuntimeIamPolicy',
