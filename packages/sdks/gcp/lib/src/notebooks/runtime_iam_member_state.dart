...
class RuntimeIamMemberState {
  ...
  /// Creates a new [RuntimeIamMemberState].
  /// [condition] Optional.
  ...
  factory RuntimeIamMemberState.fromMap(Map<String, dynamic> map) {
    return RuntimeIamMemberState(
