...
class EnvironmentConfigSoftwareConfig {
  ...
  final pulumi.Input<EnvironmentConfigSoftwareConfigCloudDataLineageIntegration?>? cloudDataLineageIntegration;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'cloudDataLineageIntegration': ?pulumi.Input.mapOptionalInputValue<EnvironmentConfigSoftwareConfigCloudDataLineageIntegration, Map<String, dynamic>>(cloudDataLineageIntegration, (value) => value.toMap()),
  ...
  factory EnvironmentConfigSoftwareConfig.fromMap(Map<String, dynamic> map) {
    return EnvironmentConfigSoftwareConfig(
      ...
      cloudDataLineageIntegration: (() { final guardedValue = map['cloudDataLineageIntegration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EnvironmentConfigSoftwareConfigCloudDataLineageIntegration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      schedulerCount: (() { final guardedValue = map['schedulerCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      webServerPluginsMode: (() { final guardedValue = map['webServerPluginsMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
