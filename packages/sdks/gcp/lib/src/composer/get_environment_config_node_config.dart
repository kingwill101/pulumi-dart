...
class GetEnvironmentConfigNodeConfig {
  ...
  final pulumi.Input<List<GetEnvironmentConfigNodeConfigIpAllocationPolicy>> ipAllocationPolicies;
  ...
  /// Creates a new [GetEnvironmentConfigNodeConfig].
  ...
  /// [ipAllocationPolicies] Configuration for controlling how IPs are allocated in the GKE cluster. Cannot be updated.
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ipAllocationPolicies': pulumi.Input.mapInputValue<List<GetEnvironmentConfigNodeConfigIpAllocationPolicy>, List<Map<String, dynamic>>>(ipAllocationPolicies, (value) => pulumi.Input.encodeList<GetEnvironmentConfigNodeConfigIpAllocationPolicy, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory GetEnvironmentConfigNodeConfig.fromMap(Map<String, dynamic> map) {
    return GetEnvironmentConfigNodeConfig(
      composerInternalIpv4CidrBlock: (map['composerInternalIpv4CidrBlock'] as String).input(),
      composerNetworkAttachment: (map['composerNetworkAttachment'] as String).input(),
      diskSizeGb: (map['diskSizeGb'] as int).input(),
      enableIpMasqAgent: (map['enableIpMasqAgent'] as bool).input(),
      ipAllocationPolicies: (pulumi.Input.decodeList<GetEnvironmentConfigNodeConfigIpAllocationPolicy>(map['ipAllocationPolicies'], (value) => GetEnvironmentConfigNodeConfigIpAllocationPolicy.fromMap((value as Map).cast<String, dynamic>()))).input(),
