...
class GetEnvironmentConfigWorkloadsConfig {
  ...
  factory GetEnvironmentConfigWorkloadsConfig.fromMap(Map<String, dynamic> map) {
    return GetEnvironmentConfigWorkloadsConfig(
      dagProcessors: pulumi.Input.fromValue(pulumi.Input.decodeList<GetEnvironmentConfigWorkloadsConfigDagProcessor>(map['dagProcessors']!, (value) => GetEnvironmentConfigWorkloadsConfigDagProcessor.fromMap((value as Map).cast<String, dynamic>()))),
      schedulers: pulumi.Input.fromValue(pulumi.Input.decodeList<GetEnvironmentConfigWorkloadsConfigScheduler>(map['schedulers']!, (value) => GetEnvironmentConfigWorkloadsConfigScheduler.fromMap((value as Map).cast<String, dynamic>()))),
      triggerers: pulumi.Input.fromValue(pulumi.Input.decodeList<GetEnvironmentConfigWorkloadsConfigTriggerer>(map['triggerers']!, (value) => GetEnvironmentConfigWorkloadsConfigTriggerer.fromMap((value as Map).cast<String, dynamic>()))),
      webServers: pulumi.Input.fromValue(pulumi.Input.decodeList<GetEnvironmentConfigWorkloadsConfigWebServer>(map['webServers']!, (value) => GetEnvironmentConfigWorkloadsConfigWebServer.fromMap((value as Map).cast<String, dynamic>()))),
      workers: pulumi.Input.fromValue(pulumi.Input.decodeList<GetEnvironmentConfigWorkloadsConfigWorker>(map['workers']!, (value) => GetEnvironmentConfigWorkloadsConfigWorker.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
