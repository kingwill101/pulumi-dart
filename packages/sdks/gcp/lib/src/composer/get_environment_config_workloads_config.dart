...
class GetEnvironmentConfigWorkloadsConfig {
  ...
  final pulumi.Input<List<GetEnvironmentConfigWorkloadsConfigDagProcessor>>
  dagProcessors;

  /// Configuration for resources used by Airflow schedulers.
  final pulumi.Input<List<GetEnvironmentConfigWorkloadsConfigScheduler>>
  schedulers;

  /// Configuration for resources used by Airflow triggerers.
  final pulumi.Input<List<GetEnvironmentConfigWorkloadsConfigTriggerer>>
  triggerers;

  /// Configuration for resources used by Airflow web server.
  final pulumi.Input<List<GetEnvironmentConfigWorkloadsConfigWebServer>>
  webServers;
    ...
    return <String, dynamic>{
      'dagProcessors':
          pulumi.Input.mapInputValue<
            List<GetEnvironmentConfigWorkloadsConfigDagProcessor>,
      ...
      'schedulers':
          pulumi.Input.mapInputValue<
            List<GetEnvironmentConfigWorkloadsConfigScheduler>,
            List<Map<String, dynamic>>
          >(
            schedulers,
            (value) =>
      ...
      'triggerers':
          pulumi.Input.mapInputValue<
            List<GetEnvironmentConfigWorkloadsConfigTriggerer>,
            List<Map<String, dynamic>>
          >(
            triggerers,
            (value) =>
      ...
      'webServers':
          pulumi.Input.mapInputValue<
            List<GetEnvironmentConfigWorkloadsConfigWebServer>,
            List<Map<String, dynamic>>
          >(
            webServers,
            (value) =>
      ...
      'workers':
          pulumi.Input.mapInputValue<
            List<GetEnvironmentConfigWorkloadsConfigWorker>,
            List<Map<String, dynamic>>
          >(
            workers,
            (value) =>
  ...
  factory GetEnvironmentConfigWorkloadsConfig.fromMap(
    ...
    return GetEnvironmentConfigWorkloadsConfig(
      dagProcessors: pulumi.Input.fromValue(
        pulumi
      ...
      schedulers: pulumi.Input.fromValue(
      ...
      triggerers: pulumi.Input.fromValue(
      ...
      webServers: pulumi.Input.fromValue(
      ...
      workers: pulumi.Input.fromValue(
