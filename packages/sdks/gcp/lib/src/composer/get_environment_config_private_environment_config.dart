...
class GetEnvironmentConfigPrivateEnvironmentConfig {
  ...
  factory GetEnvironmentConfigPrivateEnvironmentConfig.fromMap(Map<String, dynamic> map) {
    return GetEnvironmentConfigPrivateEnvironmentConfig(
      cloudComposerConnectionSubnetwork: map['cloudComposerConnectionSubnetwork'] as String,
      cloudComposerNetworkIpv4CidrBlock: map['cloudComposerNetworkIpv4CidrBlock'] as String,
