...
class GetEnvironmentConfig {
  ...
  factory GetEnvironmentConfig.fromMap(Map<String, dynamic> map) {
    return GetEnvironmentConfig(
      ...
      dataRetentionConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetEnvironmentConfigDataRetentionConfig>(map['dataRetentionConfigs']!, (value) => GetEnvironmentConfigDataRetentionConfig.fromMap((value as Map).cast<String, dynamic>()))),
      databaseConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetEnvironmentConfigDatabaseConfig>(map['databaseConfigs']!, (value) => GetEnvironmentConfigDatabaseConfig.fromMap((value as Map).cast<String, dynamic>()))),
      enablePrivateBuildsOnly: pulumi.Input.fromValue(map['enablePrivateBuildsOnly'] as bool),
      enablePrivateEnvironment: pulumi.Input.fromValue(map['enablePrivateEnvironment'] as bool),
      encryptionConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetEnvironmentConfigEncryptionConfig>(map['encryptionConfigs']!, (value) => GetEnvironmentConfigEncryptionConfig.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      softwareConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetEnvironmentConfigSoftwareConfig>(map['softwareConfigs']!, (value) => GetEnvironmentConfigSoftwareConfig.fromMap((value as Map).cast<String, dynamic>()))),
      webServerConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetEnvironmentConfigWebServerConfig>(map['webServerConfigs']!, (value) => GetEnvironmentConfigWebServerConfig.fromMap((value as Map).cast<String, dynamic>()))),
      webServerNetworkAccessControls: pulumi.Input.fromValue(pulumi.Input.decodeList<GetEnvironmentConfigWebServerNetworkAccessControl>(map['webServerNetworkAccessControls']!, (value) => GetEnvironmentConfigWebServerNetworkAccessControl.fromMap((value as Map).cast<String, dynamic>()))),
      workloadsConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetEnvironmentConfigWorkloadsConfig>(map['workloadsConfigs']!, (value) => GetEnvironmentConfigWorkloadsConfig.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
