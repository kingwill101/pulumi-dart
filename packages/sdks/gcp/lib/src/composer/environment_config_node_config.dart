...
class EnvironmentConfigNodeConfig {
  ...
  factory EnvironmentConfigNodeConfig.fromMap(Map<String, dynamic> map) {
    return EnvironmentConfigNodeConfig(
      composerInternalIpv4CidrBlock: map['composerInternalIpv4CidrBlock'] == null ? null : map['composerInternalIpv4CidrBlock'] as String,
      composerNetworkAttachment: map['composerNetworkAttachment'] == null ? null : map['composerNetworkAttachment'] as String,
      diskSizeGb: map['diskSizeGb'] == null ? null : map['diskSizeGb'] as int,
      enableIpMasqAgent: map['enableIpMasqAgent'] == null ? null : map['enableIpMasqAgent'] as bool,
      ipAllocationPolicy: map['ipAllocationPolicy'] == null ? null : EnvironmentConfigNodeConfigIpAllocationPolicy.fromMap((map['ipAllocationPolicy'] as Map).cast<String, dynamic>()),
