...
class EnvironmentConfigNodeConfig {
  ...
  final pulumi.Input<EnvironmentConfigNodeConfigIpAllocationPolicy>?
  ipAllocationPolicy;
  ...
  factory EnvironmentConfigNodeConfig.fromMap(Map<String, dynamic> map) {
    return EnvironmentConfigNodeConfig(
      composerInternalIpv4CidrBlock: (() {
        final guardedValue = map['composerInternalIpv4CidrBlock'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      composerNetworkAttachment: (() {
        final guardedValue = map['composerNetworkAttachment'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      diskSizeGb: (() {
