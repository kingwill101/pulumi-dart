...
class EnvironmentConfig {
  ...
  factory EnvironmentConfig.fromMap(Map<String, dynamic> map) {
    return EnvironmentConfig(
      airflowUri: (() { final guardedValue = map['airflowUri']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      dagGcsPrefix: (() { final guardedValue = map['dagGcsPrefix']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      dataRetentionConfig: (() { final guardedValue = map['dataRetentionConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EnvironmentConfigDataRetentionConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      databaseConfig: (() { final guardedValue = map['databaseConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EnvironmentConfigDatabaseConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      enablePrivateBuildsOnly: (() { final guardedValue = map['enablePrivateBuildsOnly']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      encryptionConfig: (() { final guardedValue = map['encryptionConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EnvironmentConfigEncryptionConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      environmentSize: (() { final guardedValue = map['environmentSize']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      gkeCluster: (() { final guardedValue = map['gkeCluster']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      softwareConfig: (() { final guardedValue = map['softwareConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EnvironmentConfigSoftwareConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      webServerConfig: (() { final guardedValue = map['webServerConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EnvironmentConfigWebServerConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      webServerNetworkAccessControl: (() { final guardedValue = map['webServerNetworkAccessControl']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EnvironmentConfigWebServerNetworkAccessControl.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      workloadsConfig: (() { final guardedValue = map['workloadsConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EnvironmentConfigWorkloadsConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
