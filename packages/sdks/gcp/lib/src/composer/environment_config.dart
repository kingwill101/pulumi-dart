...
class EnvironmentConfig {
  ...
  final EnvironmentConfigMasterAuthorizedNetworksConfig? masterAuthorizedNetworksConfig;
  ...
  final EnvironmentConfigWebServerNetworkAccessControl? webServerNetworkAccessControl;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'dataRetentionConfig': ?dataRetentionConfig == null ? null : dataRetentionConfig!.toMap(),
  ...
  factory EnvironmentConfig.fromMap(Map<String, dynamic> map) {
    return EnvironmentConfig(
      airflowUri: map['airflowUri'] == null ? null : map['airflowUri'] as String,
      dagGcsPrefix: map['dagGcsPrefix'] == null ? null : map['dagGcsPrefix'] as String,
      dataRetentionConfig: map['dataRetentionConfig'] == null ? null : EnvironmentConfigDataRetentionConfig.fromMap((map['dataRetentionConfig'] as Map).cast<String, dynamic>()),
      databaseConfig: map['databaseConfig'] == null ? null : EnvironmentConfigDatabaseConfig.fromMap((map['databaseConfig'] as Map).cast<String, dynamic>()),
      enablePrivateBuildsOnly: map['enablePrivateBuildsOnly'] == null ? null : map['enablePrivateBuildsOnly'] as bool,
      enablePrivateEnvironment: map['enablePrivateEnvironment'] == null ? null : map['enablePrivateEnvironment'] as bool,
      encryptionConfig: map['encryptionConfig'] == null ? null : EnvironmentConfigEncryptionConfig.fromMap((map['encryptionConfig'] as Map).cast<String, dynamic>()),
      environmentSize: map['environmentSize'] == null ? null : map['environmentSize'] as String,
      gkeCluster: map['gkeCluster'] == null ? null : map['gkeCluster'] as String,
      maintenanceWindow: map['maintenanceWindow'] == null ? null : EnvironmentConfigMaintenanceWindow.fromMap((map['maintenanceWindow'] as Map).cast<String, dynamic>()),
      masterAuthorizedNetworksConfig: map['masterAuthorizedNetworksConfig'] == null ? null : EnvironmentConfigMasterAuthorizedNetworksConfig.fromMap((map['masterAuthorizedNetworksConfig'] as Map).cast<String, dynamic>()),
      nodeConfig: map['nodeConfig'] == null ? null : EnvironmentConfigNodeConfig.fromMap((map['nodeConfig'] as Map).cast<String, dynamic>()),
      nodeCount: map['nodeCount'] == null ? null : map['nodeCount'] as int,
      privateEnvironmentConfig: map['privateEnvironmentConfig'] == null ? null : EnvironmentConfigPrivateEnvironmentConfig.fromMap((map['privateEnvironmentConfig'] as Map).cast<String, dynamic>()),
      recoveryConfig: map['recoveryConfig'] == null ? null : EnvironmentConfigRecoveryConfig.fromMap((map['recoveryConfig'] as Map).cast<String, dynamic>()),
      resilienceMode: map['resilienceMode'] == null ? null : map['resilienceMode'] as String,
      softwareConfig: map['softwareConfig'] == null ? null : EnvironmentConfigSoftwareConfig.fromMap((map['softwareConfig'] as Map).cast<String, dynamic>()),
      webServerConfig: map['webServerConfig'] == null ? null : EnvironmentConfigWebServerConfig.fromMap((map['webServerConfig'] as Map).cast<String, dynamic>()),
      webServerNetworkAccessControl: map['webServerNetworkAccessControl'] == null ? null : EnvironmentConfigWebServerNetworkAccessControl.fromMap((map['webServerNetworkAccessControl'] as Map).cast<String, dynamic>()),
      workloadsConfig: map['workloadsConfig'] == null ? null : EnvironmentConfigWorkloadsConfig.fromMap((map['workloadsConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
