...
class GetEnvironmentConfigDataRetentionConfig {
  ...
  final pulumi.Input<
    List<GetEnvironmentConfigDataRetentionConfigAirflowMetadataRetentionConfig>
  >
  airflowMetadataRetentionConfigs;

  /// Optional. The configuration setting for Task Logs.
  final pulumi.Input<
    List<GetEnvironmentConfigDataRetentionConfigTaskLogsRetentionConfig>
  >
  ...
  factory GetEnvironmentConfigDataRetentionConfig.fromMap(
    ...
    return GetEnvironmentConfigDataRetentionConfig(
      airflowMetadataRetentionConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetEnvironmentConfigDataRetentionConfigAirflowMetadataRetentionConfig
        >(
          map['airflowMetadataRetentionConfigs']!,
          (value) =>
              GetEnvironmentConfigDataRetentionConfigAirflowMetadataRetentionConfig.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
      taskLogsRetentionConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetEnvironmentConfigDataRetentionConfigTaskLogsRetentionConfig
        >(
          map['taskLogsRetentionConfigs']!,
          (value) =>
              GetEnvironmentConfigDataRetentionConfigTaskLogsRetentionConfig.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
