...
class GetEnvironmentConfigSoftwareConfig {
  ...
  final pulumi.Input<List<GetEnvironmentConfigSoftwareConfigCloudDataLineageIntegration>> cloudDataLineageIntegrations;
  ...
  factory GetEnvironmentConfigSoftwareConfig.fromMap(Map<String, dynamic> map) {
    return GetEnvironmentConfigSoftwareConfig(
      airflowConfigOverrides: ((map['airflowConfigOverrides'] as Map).cast<String, String>()).input(),
      cloudDataLineageIntegrations: (pulumi.Input.decodeList<GetEnvironmentConfigSoftwareConfigCloudDataLineageIntegration>(map['cloudDataLineageIntegrations'], (value) => GetEnvironmentConfigSoftwareConfigCloudDataLineageIntegration.fromMap((value as Map).cast<String, dynamic>()))).input(),
      envVariables: ((map['envVariables'] as Map).cast<String, String>()).input(),
      imageVersion: (map['imageVersion'] as String).input(),
      pypiPackages: ((map['pypiPackages'] as Map).cast<String, String>()).input(),
      pythonVersion: (map['pythonVersion'] as String).input(),
      schedulerCount: (map['schedulerCount'] as int).input(),
      webServerPluginsMode: (map['webServerPluginsMode'] as String).input(),
    );
  }
}
