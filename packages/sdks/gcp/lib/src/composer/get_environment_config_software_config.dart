...
class GetEnvironmentConfigSoftwareConfig {
  ...
  const GetEnvironmentConfigSoftwareConfig({
  ...
  factory GetEnvironmentConfigSoftwareConfig.fromMap(Map<String, dynamic> map) {
    return GetEnvironmentConfigSoftwareConfig(
      airflowConfigOverrides: pulumi.Input.fromValue((map['airflowConfigOverrides'] as Map).cast<String, String>()),
      cloudDataLineageIntegrations: pulumi.Input.fromValue(pulumi.Input.decodeList<GetEnvironmentConfigSoftwareConfigCloudDataLineageIntegration>(map['cloudDataLineageIntegrations']!, (value) => GetEnvironmentConfigSoftwareConfigCloudDataLineageIntegration.fromMap((value as Map).cast<String, dynamic>()))),
      envVariables: pulumi.Input.fromValue((map['envVariables'] as Map).cast<String, String>()),
