...
class GetEnvironmentConfigSoftwareConfig {
  ...
  final List<GetEnvironmentConfigSoftwareConfigCloudDataLineageIntegration> cloudDataLineageIntegrations;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'cloudDataLineageIntegrations': pulumi.Input.encodeList<GetEnvironmentConfigSoftwareConfigCloudDataLineageIntegration, Map<String, dynamic>>(cloudDataLineageIntegrations, (value) => value.toMap()),
  ...
  factory GetEnvironmentConfigSoftwareConfig.fromMap(Map<String, dynamic> map) {
    return GetEnvironmentConfigSoftwareConfig(
      airflowConfigOverrides: (map['airflowConfigOverrides'] as Map).cast<String, String>(),
      cloudDataLineageIntegrations: pulumi.Input.decodeList<GetEnvironmentConfigSoftwareConfigCloudDataLineageIntegration>(map['cloudDataLineageIntegrations'], (value) => GetEnvironmentConfigSoftwareConfigCloudDataLineageIntegration.fromMap((value as Map).cast<String, dynamic>())),
