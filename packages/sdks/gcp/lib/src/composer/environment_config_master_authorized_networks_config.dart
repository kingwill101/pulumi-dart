...
class EnvironmentConfigMasterAuthorizedNetworksConfig {
  ...
  const EnvironmentConfigMasterAuthorizedNetworksConfig({
    this.cidrBlocks,
  ...
  factory EnvironmentConfigMasterAuthorizedNetworksConfig.fromMap(Map<String, dynamic> map) {
    return EnvironmentConfigMasterAuthorizedNetworksConfig(
      cidrBlocks: (() { final guardedValue = map['cidrBlocks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<EnvironmentConfigMasterAuthorizedNetworksConfigCidrBlock>(guardedValue, (value) => EnvironmentConfigMasterAuthorizedNetworksConfigCidrBlock.fromMap((value as Map).cast<String, dynamic>()))); })(),
