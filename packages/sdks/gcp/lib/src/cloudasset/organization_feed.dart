...
import 'organization_feed_state.dart';
...
/// # Create a feed that sends notifications about network resource updates under a
/// # particular organization.
/// resource "gcp_cloudasset_organizationfeed" "organization_feed" {
///   billing_project = "my-project-name"
///   org_id          = "123456789"
///   feed_id         = "network-updates"
///   content_type    = "RESOURCE"
...
class OrganizationFeed extends pulumi.CustomResource {
  ...
  /// Gets an existing [OrganizationFeed] resource's state with the given [name] and [id].
  static OrganizationFeed get(
    String name,
    pulumi.Input<String> id, {
    OrganizationFeedState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return OrganizationFeed._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [OrganizationFeed] resource.
  OrganizationFeed.reference(String urn)
    : super(
        'gcp:cloudasset/organizationFeed:OrganizationFeed',
