...
class FolderFeedCondition {
  ...
  /// Creates a new [FolderFeedCondition].
  ...
  factory FolderFeedCondition.fromMap(Map<String, dynamic> map) {
    return FolderFeedCondition(
