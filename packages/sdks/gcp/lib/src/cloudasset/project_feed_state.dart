...
class ProjectFeedState {
  ...
  factory ProjectFeedState.fromMap(Map<String, dynamic> map) {
    return ProjectFeedState(
      ...
      feedOutputConfig: (() { final guardedValue = map['feedOutputConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ProjectFeedFeedOutputConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
