...
import 'project_feed_state.dart';
...
///
/// # Create a feed that sends notifications about network resource updates.
/// resource "gcp_cloudasset_projectfeed" "project_feed" {
///   project      = "my-project-name"
///   feed_id      = "network-updates"
///   content_type = "RESOURCE"
...
class ProjectFeed extends pulumi.CustomResource {
  ...
  /// Gets an existing [ProjectFeed] resource's state with the given [name] and [id].
  static ProjectFeed get(
    String name,
