...
class ApiConfigIamMemberState {
  ...
  /// Creates a new [ApiConfigIamMemberState].
  ...
  factory ApiConfigIamMemberState.fromMap(Map<String, dynamic> map) {
    return ApiConfigIamMemberState(
      api: (() {
