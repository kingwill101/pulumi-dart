...
import 'api_iam_binding_state.dart';
...
class ApiIamBinding extends pulumi.CustomResource {
  ...
  ApiIamBinding(
    ...
    condition = registerOutput<ApiIamBindingCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ApiIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [ApiIamBinding] resource's state with the given [name] and [id].
  static ApiIamBinding get(
    String name,
    pulumi.Input<String> id, {
    ApiIamBindingState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return ApiIamBinding._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [ApiIamBinding] resource.
  ApiIamBinding.reference(String urn)
    : super(
        'gcp:apigateway/apiIamBinding:ApiIamBinding',
