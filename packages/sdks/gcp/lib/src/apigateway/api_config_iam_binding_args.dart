...
/// {@template pulumi_apigateway_api_config_iam_binding_api_config_iam_binding_args_doc}
/// The set of arguments for ApiConfigIamBinding.
/// {@endtemplate}
/// {@macro pulumi_apigateway_api_config_iam_binding_api_config_iam_binding_args_doc}
class ApiConfigIamBindingArgs {
  ...
  ApiConfigIamBindingArgs({
    ...
    pulumi.Output<ApiConfigIamBindingCondition>? condition,
    ...
    required pulumi.Output<String> role,
      ...
      condition = pulumi.Input.asOptionalInput<ApiConfigIamBindingCondition>(condition),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'api': api,
      'apiConfig': apiConfig,
      'condition': ?pulumi.Input.mapOptionalInputValue<ApiConfigIamBindingCondition, Map<String, dynamic>>(condition, (value) => value.toMap()),
      'members': members,
      'project': ?project,
      'role': role,
    };
  ...
  factory ApiConfigIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return ApiConfigIamBindingArgs(
      ...
      condition: map['condition'] == null ? null : pulumi.Output.create<ApiConfigIamBindingCondition>(ApiConfigIamBindingCondition.fromMap((map['condition'] as Map).cast<String, dynamic>())),
