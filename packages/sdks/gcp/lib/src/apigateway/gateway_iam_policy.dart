...
import 'gateway_iam_policy_state.dart';
...
class GatewayIamPolicy extends pulumi.CustomResource {
  ...
  /// Gets an existing [GatewayIamPolicy] resource's state with the given [name] and [id].
  static GatewayIamPolicy get(
    String name,
