...
import 'api_config_iam_member_args.dart';
import 'api_config_iam_member_condition.dart';
import 'api_config_iam_member_state.dart';
...
class ApiConfigIamMember extends pulumi.CustomResource {
  ...
  late final pulumi.Output<ApiConfigIamMemberCondition?> condition;
  ...
  /// Creates a new [ApiConfigIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ApiConfigIamMember]. {@macro pulumi_apigateway_api_config_iam_member_api_config_iam_member_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  ApiConfigIamMember(
    String name, {
    ApiConfigIamMemberArgs? args,
    ...
    condition = registerOutput<ApiConfigIamMemberCondition?>(
      'condition',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return ApiConfigIamMemberCondition.fromMap(
  ...
  /// Gets an existing [ApiConfigIamMember] resource's state with the given [name] and [id].
  static ApiConfigIamMember get(
    String name,
