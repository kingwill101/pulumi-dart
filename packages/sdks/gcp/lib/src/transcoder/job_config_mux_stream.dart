...
class JobConfigMuxStream {
  ...
  factory JobConfigMuxStream.fromMap(Map<String, dynamic> map) {
    return JobConfigMuxStream(
      ...
      segmentSettings: (() { final guardedValue = map['segmentSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(JobConfigMuxStreamSegmentSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
