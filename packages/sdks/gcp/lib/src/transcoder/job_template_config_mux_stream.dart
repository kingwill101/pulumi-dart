...
class JobTemplateConfigMuxStream {
  ...
  const JobTemplateConfigMuxStream({
    this.container,
  ...
  factory JobTemplateConfigMuxStream.fromMap(Map<String, dynamic> map) {
    return JobTemplateConfigMuxStream(
      ...
      segmentSettings: (() { final guardedValue = map['segmentSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(JobTemplateConfigMuxStreamSegmentSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
