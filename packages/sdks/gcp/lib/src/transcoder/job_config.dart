...
class JobConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'elementaryStreams':
          ?pulumi.Input.mapOptionalInputValue<
            List<JobConfigElementaryStream>,
            List<Map<String, dynamic>>
          >(
            elementaryStreams,
            (value) =>
      ...
      inputs: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<JobConfigInput>(
            guardedValue,
            (value) =>
                JobConfigInput.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      manifests: (() {
