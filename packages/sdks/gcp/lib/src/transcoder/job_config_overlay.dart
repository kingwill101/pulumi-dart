...
class JobConfigOverlay {
  ...
  factory JobConfigOverlay.fromMap(Map<String, dynamic> map) {
    return JobConfigOverlay(
      animations: (() { final guardedValue = map['animations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<JobConfigOverlayAnimation>(guardedValue, (value) => JobConfigOverlayAnimation.fromMap((value as Map).cast<String, dynamic>()))); })(),
      image: (() { final guardedValue = map['image']; if (guardedValue == null) return null; return pulumi.Input.fromValue(JobConfigOverlayImage.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
