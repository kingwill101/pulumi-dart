...
class JobTemplateConfigOverlayAnimation {
  ...
  const JobTemplateConfigOverlayAnimation({
    this.animationFade,
  });
  ...
  factory JobTemplateConfigOverlayAnimation.fromMap(Map<String, dynamic> map) {
    return JobTemplateConfigOverlayAnimation(
      animationFade: (() { final guardedValue = map['animationFade']; if (guardedValue == null) return null; return pulumi.Input.fromValue(JobTemplateConfigOverlayAnimationAnimationFade.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
