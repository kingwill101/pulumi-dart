...
class JobTemplateConfig {
  ...
  /// List of input assets stored in Cloud Storage.
  /// Structure is documented below.
  final pulumi.Input<List<JobTemplateConfigElementaryStream>>?
  elementaryStreams;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'editLists':
          ?pulumi.Input.mapOptionalInputValue<
            List<JobTemplateConfigEditList>,
            List<Map<String, dynamic>>
          >(
            editLists,
            (value) =>
      ...
      'elementaryStreams':
          ?pulumi.Input.mapOptionalInputValue<
            List<JobTemplateConfigElementaryStream>,
            List<Map<String, dynamic>>
          >(
            elementaryStreams,
            (value) =>
      ...
      'encryptions':
          ?pulumi.Input.mapOptionalInputValue<
            List<JobTemplateConfigEncryption>,
            List<Map<String, dynamic>>
          >(
            encryptions,
            (value) =>
      ...
      'manifests':
          ?pulumi.Input.mapOptionalInputValue<
            List<JobTemplateConfigManifest>,
            List<Map<String, dynamic>>
          >(
            manifests,
            (value) =>
      ...
      'muxStreams':
          ?pulumi.Input.mapOptionalInputValue<
            List<JobTemplateConfigMuxStream>,
            List<Map<String, dynamic>>
          >(
            muxStreams,
            (value) =>
  ...
  factory JobTemplateConfig.fromMap(Map<String, dynamic> map) {
    return JobTemplateConfig(
      adBreaks: (() {
        final guardedValue = map['adBreaks'];
      ...
      editLists: (() {
        final guardedValue = map['editLists'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      manifests: (() {
        final guardedValue = map['manifests'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      overlays: (() {
        final guardedValue = map['overlays'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      pubsubDestination: (() {
        final guardedValue = map['pubsubDestination'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
