...
class JobTemplateConfigEncryption {
  ...
  const JobTemplateConfigEncryption({
    this.aes128,
    this.drmSystems,
    required this.id,
    this.mpegCenc,
  ...
  factory JobTemplateConfigEncryption.fromMap(Map<String, dynamic> map) {
    return JobTemplateConfigEncryption(
      ...
      drmSystems: (() { final guardedValue = map['drmSystems']; if (guardedValue == null) return null; return pulumi.Input.fromValue(JobTemplateConfigEncryptionDrmSystems.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      id: pulumi.Input.fromValue(map['id'] as String),
      mpegCenc: (() { final guardedValue = map['mpegCenc']; if (guardedValue == null) return null; return pulumi.Input.fromValue(JobTemplateConfigEncryptionMpegCenc.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      secretManagerKeySource: (() { final guardedValue = map['secretManagerKeySource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(JobTemplateConfigEncryptionSecretManagerKeySource.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
