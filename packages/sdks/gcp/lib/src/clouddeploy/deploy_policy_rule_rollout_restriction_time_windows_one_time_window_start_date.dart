...
class DeployPolicyRuleRolloutRestrictionTimeWindowsOneTimeWindowStartDate {
  ...
  /// Creates a new [DeployPolicyRuleRolloutRestrictionTimeWindowsOneTimeWindowStartDate].
  ...
  const DeployPolicyRuleRolloutRestrictionTimeWindowsOneTimeWindowStartDate({
    this.day,
    this.month,
    this.year,
  });
