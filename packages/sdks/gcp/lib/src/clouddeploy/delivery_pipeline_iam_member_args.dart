...
class DeliveryPipelineIamMemberArgs {
  ...
  factory DeliveryPipelineIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return DeliveryPipelineIamMemberArgs(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DeliveryPipelineIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
