...
class DeployPolicyState {
  ...
  DeployPolicyState({
    ...
    pulumi.Output<List<DeployPolicyRule>>? rules,
    pulumi.Output<List<DeployPolicySelector>>? selectors,
    ...
    pulumi.Output<String>? updateTime,
      ...
      rules = pulumi.Input.asOptionalInput<List<DeployPolicyRule>>(rules),
      selectors = pulumi.Input.asOptionalInput<List<DeployPolicySelector>>(selectors),
  ...
  factory DeployPolicyState.fromMap(Map<String, dynamic> map) {
    return DeployPolicyState(
      ...
      rules: map['rules'] == null ? null : pulumi.Output.create<List<DeployPolicyRule>>(pulumi.Input.decodeList<DeployPolicyRule>(map['rules'], (value) => DeployPolicyRule.fromMap((value as Map).cast<String, dynamic>()))),
      selectors: map['selectors'] == null ? null : pulumi.Output.create<List<DeployPolicySelector>>(pulumi.Input.decodeList<DeployPolicySelector>(map['selectors'], (value) => DeployPolicySelector.fromMap((value as Map).cast<String, dynamic>()))),
