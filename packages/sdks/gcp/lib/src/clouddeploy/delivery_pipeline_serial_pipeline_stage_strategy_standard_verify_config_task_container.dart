...
class DeliveryPipelineSerialPipelineStageStrategyStandardVerifyConfigTaskContainer {
  ...
  /// Creates a new [DeliveryPipelineSerialPipelineStageStrategyStandardVerifyConfigTaskContainer].
  ...
  const DeliveryPipelineSerialPipelineStageStrategyStandardVerifyConfigTaskContainer({
    this.args,
    this.commands,
    this.env,
    required this.image,
  ...
  factory DeliveryPipelineSerialPipelineStageStrategyStandardVerifyConfigTaskContainer.fromMap(Map<String, dynamic> map) {
    return DeliveryPipelineSerialPipelineStageStrategyStandardVerifyConfigTaskContainer(
