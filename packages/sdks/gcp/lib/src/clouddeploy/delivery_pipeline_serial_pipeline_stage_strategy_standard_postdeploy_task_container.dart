...
class DeliveryPipelineSerialPipelineStageStrategyStandardPostdeployTaskContainer {
  ...
  /// Creates a new [DeliveryPipelineSerialPipelineStageStrategyStandardPostdeployTaskContainer].
  ...
  const DeliveryPipelineSerialPipelineStageStrategyStandardPostdeployTaskContainer({
    this.args,
    this.commands,
    this.env,
    required this.image,
  ...
  factory DeliveryPipelineSerialPipelineStageStrategyStandardPostdeployTaskContainer.fromMap(Map<String, dynamic> map) {
    return DeliveryPipelineSerialPipelineStageStrategyStandardPostdeployTaskContainer(
