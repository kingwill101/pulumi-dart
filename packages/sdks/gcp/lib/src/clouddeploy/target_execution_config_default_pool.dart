...
class TargetExecutionConfigDefaultPool {
  ...
  /// Creates a new [TargetExecutionConfigDefaultPool].
  ...
  const TargetExecutionConfigDefaultPool({
  ...
  factory TargetExecutionConfigDefaultPool.fromMap(Map<String, dynamic> map) {
    return TargetExecutionConfigDefaultPool(
