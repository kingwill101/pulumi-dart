...
class DeliveryPipelineSerialPipelineStageStrategyStandardAnalysisCustomCheckTaskContainer {
  ...
  /// Creates a new [DeliveryPipelineSerialPipelineStageStrategyStandardAnalysisCustomCheckTaskContainer].
  ...
  const DeliveryPipelineSerialPipelineStageStrategyStandardAnalysisCustomCheckTaskContainer({
    this.args,
    this.commands,
    this.env,
    required this.image,
  ...
  factory DeliveryPipelineSerialPipelineStageStrategyStandardAnalysisCustomCheckTaskContainer.fromMap(Map<String, dynamic> map) {
    return DeliveryPipelineSerialPipelineStageStrategyStandardAnalysisCustomCheckTaskContainer(
