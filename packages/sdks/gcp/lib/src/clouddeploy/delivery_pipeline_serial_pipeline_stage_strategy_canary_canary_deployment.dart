    ...
    return DeliveryPipelineSerialPipelineStageStrategyCanaryCanaryDeployment(
      ...
      postdeploy: (() {
        ...
        return pulumi.Input.fromValue(
          DeliveryPipelineSerialPipelineStageStrategyCanaryCanaryDeploymentPostdeploy.fromMap(
      ...
      predeploy: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DeliveryPipelineSerialPipelineStageStrategyCanaryCanaryDeploymentPredeploy.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
