...
class AutomationSelector {
  ...
  factory AutomationSelector.fromMap(Map<String, dynamic> map) {
    return AutomationSelector(
      targets: pulumi.Input.fromValue(pulumi.Input.decodeList<AutomationSelectorTarget>(map['targets']!, (value) => AutomationSelectorTarget.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
