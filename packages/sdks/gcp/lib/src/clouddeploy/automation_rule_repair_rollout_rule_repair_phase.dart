...
class AutomationRuleRepairRolloutRuleRepairPhase {
  ...
  /// Structure is documented below.
  final pulumi.Input<AutomationRuleRepairRolloutRuleRepairPhaseRollback>?
  rollback;
  ...
  AutomationRuleRepairRolloutRuleRepairPhase({this.retry, this.rollback});
