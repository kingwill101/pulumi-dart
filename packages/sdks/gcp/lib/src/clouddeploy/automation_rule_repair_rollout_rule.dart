...
class AutomationRuleRepairRolloutRule {
  ...
  final pulumi.Input<List<AutomationRuleRepairRolloutRuleRepairPhase>>?
  repairPhases;
    ...
    return <String, dynamic>{
      ...
      'repairPhases':
          ?pulumi.Input.mapOptionalInputValue<
            List<AutomationRuleRepairRolloutRuleRepairPhase>,
  ...
  factory AutomationRuleRepairRolloutRule.fromMap(Map<String, dynamic> map) {
    return AutomationRuleRepairRolloutRule(
      ...
      phases: (() {
        final guardedValue = map['phases'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      repairPhases: (() {
        final guardedValue = map['repairPhases'];
        if (guardedValue == null) return null;
