...
/// {@template pulumi_clouddeploy_get_target_iam_policy_get_target_iam_policy_args_doc}
/// Arguments for getTargetIamPolicy.
/// {@endtemplate}
/// {@macro pulumi_clouddeploy_get_target_iam_policy_get_target_iam_policy_args_doc}
class GetTargetIamPolicyArgs {
  ...
  GetTargetIamPolicyArgs({this.location, required this.name, this.project});
