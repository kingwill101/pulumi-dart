  ...
  factory DeliveryPipelineSerialPipelineStageStrategyCanaryRuntimeConfigCloudRun.fromMap(
    ...
    return DeliveryPipelineSerialPipelineStageStrategyCanaryRuntimeConfigCloudRun(
      automaticTrafficControl: (() {
        final guardedValue = map['automaticTrafficControl'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      canaryRevisionTags: (() {
        final guardedValue = map['canaryRevisionTags'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      priorRevisionTags: (() {
        final guardedValue = map['priorRevisionTags'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      stableRevisionTags: (() {
        final guardedValue = map['stableRevisionTags'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
    );
