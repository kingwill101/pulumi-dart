...
class DeliveryPipelineCondition {
  ...
  factory DeliveryPipelineCondition.fromMap(Map<String, dynamic> map) {
    return DeliveryPipelineCondition(
      pipelineReadyConditions: (() { final guardedValue = map['pipelineReadyConditions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DeliveryPipelineConditionPipelineReadyCondition>(guardedValue, (value) => DeliveryPipelineConditionPipelineReadyCondition.fromMap((value as Map).cast<String, dynamic>()))); })(),
      targetsPresentConditions: (() { final guardedValue = map['targetsPresentConditions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DeliveryPipelineConditionTargetsPresentCondition>(guardedValue, (value) => DeliveryPipelineConditionTargetsPresentCondition.fromMap((value as Map).cast<String, dynamic>()))); })(),
      targetsTypeConditions: (() { final guardedValue = map['targetsTypeConditions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DeliveryPipelineConditionTargetsTypeCondition>(guardedValue, (value) => DeliveryPipelineConditionTargetsTypeCondition.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
