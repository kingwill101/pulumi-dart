...
class DeployPolicyRuleRolloutRestriction {
  ...
  final pulumi.Input<DeployPolicyRuleRolloutRestrictionTimeWindows>?
  timeWindows;
  ...
  factory DeployPolicyRuleRolloutRestriction.fromMap(Map<String, dynamic> map) {
    return DeployPolicyRuleRolloutRestriction(
      ...
      invokers: (() {
        final guardedValue = map['invokers'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      timeWindows: (() {
        final guardedValue = map['timeWindows'];
        if (guardedValue == null) return null;
