...
class GetAutonomousDatabasesAutonomousDatabasePropertyConnectionString {
  ...
  factory GetAutonomousDatabasesAutonomousDatabasePropertyConnectionString.fromMap(Map<String, dynamic> map) {
    return GetAutonomousDatabasesAutonomousDatabasePropertyConnectionString(
      allConnectionStrings: (pulumi.Input.decodeList<GetAutonomousDatabasesAutonomousDatabasePropertyConnectionStringAllConnectionString>(map['allConnectionStrings'], (value) => GetAutonomousDatabasesAutonomousDatabasePropertyConnectionStringAllConnectionString.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      profiles: (pulumi.Input.decodeList<GetAutonomousDatabasesAutonomousDatabasePropertyConnectionStringProfile>(map['profiles'], (value) => GetAutonomousDatabasesAutonomousDatabasePropertyConnectionStringProfile.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
