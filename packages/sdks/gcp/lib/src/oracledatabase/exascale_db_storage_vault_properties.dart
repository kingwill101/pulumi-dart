...
class ExascaleDbStorageVaultProperties {
  ...
  final pulumi.Input<ExascaleDbStorageVaultPropertiesExascaleDbStorageDetails>
    ...
    return <String, dynamic>{
      ...
      'exascaleDbStorageDetails':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(exascaleDbStorageDetails, (value) => value.toMap()),
      'ociUri': ?ociUri,
      'ocid': ?ocid,
      'state': ?state,
      'timeZone':
  ...
  factory ExascaleDbStorageVaultProperties.fromMap(Map<String, dynamic> map) {
    return ExascaleDbStorageVaultProperties(
      additionalFlashCachePercent: (() {
        final guardedValue = map['additionalFlashCachePercent'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      attachedShapeAttributes: (() {
        final guardedValue = map['attachedShapeAttributes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      availableShapeAttributes: (() {
        final guardedValue = map['availableShapeAttributes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      exascaleDbStorageDetails: pulumi.Input.fromValue(
        ExascaleDbStorageVaultPropertiesExascaleDbStorageDetails.fromMap(
          (map['exascaleDbStorageDetails']! as Map).cast<String, dynamic>(),
        ),
      ),
      ociUri: (() {
        final guardedValue = map['ociUri'];
        if (guardedValue == null) return null;
      ...
      vmClusterCount: (() {
        final guardedValue = map['vmClusterCount'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      vmClusterIds: (() {
        final guardedValue = map['vmClusterIds'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
    );
