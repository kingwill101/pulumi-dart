...
class GetAutonomousDatabasePropertyConnectionString {
  ...
  /// Autonomous Database.
  final pulumi.Input<
    List<GetAutonomousDatabasePropertyConnectionStringAllConnectionString>
  >
  ...
  final pulumi.Input<List<GetAutonomousDatabasePropertyConnectionStringProfile>>
  profiles;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'profiles':
          pulumi.Input.mapInputValue<
            List<GetAutonomousDatabasePropertyConnectionStringProfile>,
            List<Map<String, dynamic>>
          >(
            profiles,
            (value) =>
  ...
  factory GetAutonomousDatabasePropertyConnectionString.fromMap(
    ...
    return GetAutonomousDatabasePropertyConnectionString(
      allConnectionStrings: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetAutonomousDatabasePropertyConnectionStringAllConnectionString
        >(
          map['allConnectionStrings']!,
          (value) =>
              GetAutonomousDatabasePropertyConnectionStringAllConnectionString.fromMap(
