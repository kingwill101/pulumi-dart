...
class GetAutonomousDatabasePropertyConnectionString {
  ...
  const GetAutonomousDatabasePropertyConnectionString({
  ...
  factory GetAutonomousDatabasePropertyConnectionString.fromMap(Map<String, dynamic> map) {
    return GetAutonomousDatabasePropertyConnectionString(
      allConnectionStrings: pulumi.Input.fromValue(pulumi.Input.decodeList<GetAutonomousDatabasePropertyConnectionStringAllConnectionString>(map['allConnectionStrings']!, (value) => GetAutonomousDatabasePropertyConnectionStringAllConnectionString.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      profiles: pulumi.Input.fromValue(pulumi.Input.decodeList<GetAutonomousDatabasePropertyConnectionStringProfile>(map['profiles']!, (value) => GetAutonomousDatabasePropertyConnectionStringProfile.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
