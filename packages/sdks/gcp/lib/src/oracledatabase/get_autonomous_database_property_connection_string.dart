...
class GetAutonomousDatabasePropertyConnectionString {
  ...
  /// Autonomous Database.
  final List<GetAutonomousDatabasePropertyConnectionStringAllConnectionString> allConnectionStrings;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'allConnectionStrings': pulumi.Input.encodeList<GetAutonomousDatabasePropertyConnectionStringAllConnectionString, Map<String, dynamic>>(allConnectionStrings, (value) => value.toMap()),
      'dedicated': dedicated,
      'high': high,
      'low': low,
      'medium': medium,
      'profiles': pulumi.Input.encodeList<GetAutonomousDatabasePropertyConnectionStringProfile, Map<String, dynamic>>(profiles, (value) => value.toMap()),
    };
  }
  ...
  factory GetAutonomousDatabasePropertyConnectionString.fromMap(Map<String, dynamic> map) {
    return GetAutonomousDatabasePropertyConnectionString(
      allConnectionStrings: pulumi.Input.decodeList<GetAutonomousDatabasePropertyConnectionStringAllConnectionString>(map['allConnectionStrings'], (value) => GetAutonomousDatabasePropertyConnectionStringAllConnectionString.fromMap((value as Map).cast<String, dynamic>())),
      dedicated: map['dedicated'] as String,
      high: map['high'] as String,
      low: map['low'] as String,
      medium: map['medium'] as String,
      profiles: pulumi.Input.decodeList<GetAutonomousDatabasePropertyConnectionStringProfile>(map['profiles'], (value) => GetAutonomousDatabasePropertyConnectionStringProfile.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
