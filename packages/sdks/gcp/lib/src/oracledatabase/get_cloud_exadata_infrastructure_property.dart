...
class GetCloudExadataInfrastructureProperty {
  ...
  final pulumi.Input<List<GetCloudExadataInfrastructurePropertyCustomerContact>>
  customerContacts;
  ...
  final pulumi.Input<
    List<GetCloudExadataInfrastructurePropertyMaintenanceWindow>
  >
  maintenanceWindows;
  ...
  factory GetCloudExadataInfrastructureProperty.fromMap(
    ...
    return GetCloudExadataInfrastructureProperty(
      ...
      customerContacts: pulumi.Input.fromValue(
        ...
        >(
          ...
          (value) =>
              GetCloudExadataInfrastructurePropertyCustomerContact.fromMap(
      ...
      maintenanceWindows: pulumi.Input.fromValue(
        ...
        >(
          ...
          (value) =>
              GetCloudExadataInfrastructurePropertyMaintenanceWindow.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
