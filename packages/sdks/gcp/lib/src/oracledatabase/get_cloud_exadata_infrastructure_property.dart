...
class GetCloudExadataInfrastructureProperty {
  ...
  const GetCloudExadataInfrastructureProperty({
  ...
  factory GetCloudExadataInfrastructureProperty.fromMap(Map<String, dynamic> map) {
    return GetCloudExadataInfrastructureProperty(
      activatedStorageCount: pulumi.Input.fromValue(map['activatedStorageCount'] as int),
      additionalStorageCount: pulumi.Input.fromValue(map['additionalStorageCount'] as int),
      availableStorageSizeGb: pulumi.Input.fromValue(map['availableStorageSizeGb'] as int),
      computeCount: pulumi.Input.fromValue(map['computeCount'] as int),
      cpuCount: pulumi.Input.fromValue(map['cpuCount'] as int),
      customerContacts: pulumi.Input.fromValue(pulumi.Input.decodeList<GetCloudExadataInfrastructurePropertyCustomerContact>(map['customerContacts']!, (value) => GetCloudExadataInfrastructurePropertyCustomerContact.fromMap((value as Map).cast<String, dynamic>()))),
      dataStorageSizeTb: pulumi.Input.fromValue(map['dataStorageSizeTb'] as double),
      ...
      maintenanceWindows: pulumi.Input.fromValue(pulumi.Input.decodeList<GetCloudExadataInfrastructurePropertyMaintenanceWindow>(map['maintenanceWindows']!, (value) => GetCloudExadataInfrastructurePropertyMaintenanceWindow.fromMap((value as Map).cast<String, dynamic>()))),
      maxCpuCount: pulumi.Input.fromValue(map['maxCpuCount'] as int),
      maxDataStorageTb: pulumi.Input.fromValue(map['maxDataStorageTb'] as double),
