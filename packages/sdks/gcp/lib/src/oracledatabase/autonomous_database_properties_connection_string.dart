...
class AutonomousDatabasePropertiesConnectionString {
  ...
  /// Autonomous Database.
  final pulumi.Input<
    List<AutonomousDatabasePropertiesConnectionStringAllConnectionString>
  >?
  ...
  final pulumi.Input<List<AutonomousDatabasePropertiesConnectionStringProfile>>?
  profiles;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'profiles':
          ?pulumi.Input.mapOptionalInputValue<
            List<AutonomousDatabasePropertiesConnectionStringProfile>,
            List<Map<String, dynamic>>
          >(
            profiles,
            (value) =>
  ...
  factory AutonomousDatabasePropertiesConnectionString.fromMap(
    ...
    return AutonomousDatabasePropertiesConnectionString(
      allConnectionStrings: (() {
        final guardedValue = map['allConnectionStrings'];
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                AutonomousDatabasePropertiesConnectionStringAllConnectionString.fromMap(
      ...
      dedicated: (() {
        final guardedValue = map['dedicated'];
        if (guardedValue == null) return null;
