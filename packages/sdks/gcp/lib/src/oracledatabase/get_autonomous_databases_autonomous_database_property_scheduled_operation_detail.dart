...
class GetAutonomousDatabasesAutonomousDatabasePropertyScheduledOperationDetail {
  ...
  factory GetAutonomousDatabasesAutonomousDatabasePropertyScheduledOperationDetail.fromMap(Map<String, dynamic> map) {
    return GetAutonomousDatabasesAutonomousDatabasePropertyScheduledOperationDetail(
      ...
      startTimes: (pulumi.Input.decodeList<GetAutonomousDatabasesAutonomousDatabasePropertyScheduledOperationDetailStartTime>(map['startTimes'], (value) => GetAutonomousDatabasesAutonomousDatabasePropertyScheduledOperationDetailStartTime.fromMap((value as Map).cast<String, dynamic>()))).input(),
      stopTimes: (pulumi.Input.decodeList<GetAutonomousDatabasesAutonomousDatabasePropertyScheduledOperationDetailStopTime>(map['stopTimes'], (value) => GetAutonomousDatabasesAutonomousDatabasePropertyScheduledOperationDetailStopTime.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
