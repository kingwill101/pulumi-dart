...
class AutonomousDatabase extends pulumi.CustomResource {
  ...
  AutonomousDatabase(
    ...
    this.disasterRecoverySupportedLocations = registerOutput<List<String>>('disasterRecoverySupportedLocations');
    ...
    this.peerAutonomousDatabases = registerOutput<List<String>>('peerAutonomousDatabases');
    this.project = registerOutput<String>('project');
    this.properties = registerOutput<AutonomousDatabaseProperties>('properties');
    this.pulumiLabels = registerOutput<Map<String, String>>('pulumiLabels');
    this.sourceConfig = registerOutput<AutonomousDatabaseSourceConfig?>('sourceConfig');
  }
