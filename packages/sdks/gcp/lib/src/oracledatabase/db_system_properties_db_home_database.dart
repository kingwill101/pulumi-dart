...
class DbSystemPropertiesDbHomeDatabase {
  ...
  factory DbSystemPropertiesDbHomeDatabase.fromMap(Map<String, dynamic> map) {
    return DbSystemPropertiesDbHomeDatabase(
      ...
      dbHomeName: (() { final guardedValue = map['dbHomeName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      dbUniqueName: (() { final guardedValue = map['dbUniqueName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
