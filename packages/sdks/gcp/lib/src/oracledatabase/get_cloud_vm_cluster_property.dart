...
class GetCloudVmClusterProperty {
  ...
  final pulumi.Input<
    List<GetCloudVmClusterPropertyDiagnosticsDataCollectionOption>
  >
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'timeZones':
          pulumi.Input.mapInputValue<
            List<GetCloudVmClusterPropertyTimeZone>,
            List<Map<String, dynamic>>
          >(
            timeZones,
            (value) =>
  ...
  factory GetCloudVmClusterProperty.fromMap(Map<String, dynamic> map) {
    return GetCloudVmClusterProperty(
      ...
      timeZones: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetCloudVmClusterPropertyTimeZone>(
          map['timeZones']!,
