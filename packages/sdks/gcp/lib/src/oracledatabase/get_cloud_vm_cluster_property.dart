...
class GetCloudVmClusterProperty {
  ...
  const GetCloudVmClusterProperty({
  ...
  factory GetCloudVmClusterProperty.fromMap(Map<String, dynamic> map) {
    return GetCloudVmClusterProperty(
      ...
      diagnosticsDataCollectionOptions: pulumi.Input.fromValue(pulumi.Input.decodeList<GetCloudVmClusterPropertyDiagnosticsDataCollectionOption>(map['diagnosticsDataCollectionOptions']!, (value) => GetCloudVmClusterPropertyDiagnosticsDataCollectionOption.fromMap((value as Map).cast<String, dynamic>()))),
