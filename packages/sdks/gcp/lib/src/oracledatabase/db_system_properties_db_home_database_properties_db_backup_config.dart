...
class DbSystemPropertiesDbHomeDatabasePropertiesDbBackupConfig {
  ...
  factory DbSystemPropertiesDbHomeDatabasePropertiesDbBackupConfig.fromMap(Map<String, dynamic> map) {
    return DbSystemPropertiesDbHomeDatabasePropertiesDbBackupConfig(
      autoBackupEnabled: (() { final guardedValue = map['autoBackupEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      autoFullBackupDay: (() { final guardedValue = map['autoFullBackupDay']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      autoFullBackupWindow: (() { final guardedValue = map['autoFullBackupWindow']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
