...
import 'get_autonomous_database_property_apex_detail.dart';
import 'get_autonomous_database_property_connection_string.dart';
import 'get_autonomous_database_property_connection_url.dart';
import 'get_autonomous_database_property_customer_contact.dart';
import 'get_autonomous_database_property_local_standby_db.dart';
import 'get_autonomous_database_property_scheduled_operation_detail.dart';
...
class GetAutonomousDatabaseProperty {
  ...
  final pulumi.Input<List<GetAutonomousDatabasePropertyConnectionString>>
  connectionStrings;

  /// The URLs for accessing Oracle Application Express (APEX) and SQL Developer
  /// Web with a browser from a Compute instance.
  /// https://docs.oracle.com/en-us/iaas/api/#/en/database/20160918/datatypes/AutonomousDatabaseConnectionUrls
  final pulumi.Input<List<GetAutonomousDatabasePropertyConnectionUrl>>
  connectionUrls;
  ...
  final pulumi.Input<List<GetAutonomousDatabasePropertyCustomerContact>>
  customerContacts;
  ...
  final pulumi.Input<List<GetAutonomousDatabasePropertyLocalStandbyDb>>
  localStandbyDbs;
  ...
  /// Database.
  final pulumi.Input<
    List<GetAutonomousDatabasePropertyScheduledOperationDetail>
  >
    ...
    return <String, dynamic>{
      ...
      'apexDetails':
          pulumi.Input.mapInputValue<
            List<GetAutonomousDatabasePropertyApexDetail>,
      ...
      'connectionStrings':
          pulumi.Input.mapInputValue<
            List<GetAutonomousDatabasePropertyConnectionString>,
            List<Map<String, dynamic>>
          >(
            connectionStrings,
            (value) =>
      ...
      'connectionUrls':
          pulumi.Input.mapInputValue<
            List<GetAutonomousDatabasePropertyConnectionUrl>,
            List<Map<String, dynamic>>
          >(
            connectionUrls,
            (value) =>
      ...
      'customerContacts':
          pulumi.Input.mapInputValue<
            List<GetAutonomousDatabasePropertyCustomerContact>,
            List<Map<String, dynamic>>
          >(
            customerContacts,
            (value) =>
      ...
      'localStandbyDbs':
          pulumi.Input.mapInputValue<
            List<GetAutonomousDatabasePropertyLocalStandbyDb>,
            List<Map<String, dynamic>>
          >(
            localStandbyDbs,
            (value) =>
  ...
  factory GetAutonomousDatabaseProperty.fromMap(Map<String, dynamic> map) {
    return GetAutonomousDatabaseProperty(
      actualUsedDataStorageSizeTb: pulumi.Input.fromValue(
        map['actualUsedDataStorageSizeTb'] as double,
      ),
      allocatedStorageSizeTb: pulumi.Input.fromValue(
        map['allocatedStorageSizeTb'] as double,
      ),
      apexDetails: pulumi.Input.fromValue(
      ...
      arePrimaryAllowlistedIpsUsed: pulumi.Input.fromValue(
        map['arePrimaryAllowlistedIpsUsed'] as bool,
      ),
      autonomousContainerDatabaseId: pulumi.Input.fromValue(
        map['autonomousContainerDatabaseId'] as String,
      ),
      availableUpgradeVersions: pulumi.Input.fromValue(
        (map['availableUpgradeVersions'] as List).cast<String>(),
      ),
      backupRetentionPeriodDays: pulumi.Input.fromValue(
        map['backupRetentionPeriodDays'] as int,
      ),
      ...
      connectionStrings: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetAutonomousDatabasePropertyConnectionString>(
      ...
      connectionUrls: pulumi.Input.fromValue(
      ...
      dataStorageSizeGb: pulumi.Input.fromValue(
        map['dataStorageSizeGb'] as int,
      ),
      dataStorageSizeTb: pulumi.Input.fromValue(
        map['dataStorageSizeTb'] as int,
      ),
      databaseManagementState: pulumi.Input.fromValue(
        map['databaseManagementState'] as String,
      ),
      ...
      failedDataRecoveryDuration: pulumi.Input.fromValue(
        map['failedDataRecoveryDuration'] as String,
      ),
      isAutoScalingEnabled: pulumi.Input.fromValue(
        map['isAutoScalingEnabled'] as bool,
      ),
      isLocalDataGuardEnabled: pulumi.Input.fromValue(
        map['isLocalDataGuardEnabled'] as bool,
      ),
      isStorageAutoScalingEnabled: pulumi.Input.fromValue(
        map['isStorageAutoScalingEnabled'] as bool,
      ),
      ...
      localAdgAutoFailoverMaxDataLossLimit: pulumi.Input.fromValue(
        map['localAdgAutoFailoverMaxDataLossLimit'] as int,
      ),
      localDisasterRecoveryType: pulumi.Input.fromValue(
        map['localDisasterRecoveryType'] as String,
      ),
      localStandbyDbs: pulumi.Input.fromValue(
      ...
      maintenanceBeginTime: pulumi.Input.fromValue(
        map['maintenanceBeginTime'] as String,
      ),
      maintenanceEndTime: pulumi.Input.fromValue(
        map['maintenanceEndTime'] as String,
      ),
      maintenanceScheduleType: pulumi.Input.fromValue(
        map['maintenanceScheduleType'] as String,
      ),
      memoryPerOracleComputeUnitGbs: pulumi.Input.fromValue(
      ...
      nextLongTermBackupTime: pulumi.Input.fromValue(
        map['nextLongTermBackupTime'] as String,
      ),
      ...
      operationsInsightsState: pulumi.Input.fromValue(
        map['operationsInsightsState'] as String,
      ),
      peerDbIds: pulumi.Input.fromValue(
        (map['peerDbIds'] as List).cast<String>(),
      ),
      ...
      privateEndpointIp: pulumi.Input.fromValue(
        map['privateEndpointIp'] as String,
      ),
      privateEndpointLabel: pulumi.Input.fromValue(
        map['privateEndpointLabel'] as String,
      ),
      refreshableMode: pulumi.Input.fromValue(map['refreshableMode'] as String),
      refreshableState: pulumi.Input.fromValue(
        map['refreshableState'] as String,
      ),
      role: pulumi.Input.fromValue(map['role'] as String),
      scheduledOperationDetails: pulumi.Input.fromValue(
      ...
      sqlWebDeveloperUrl: pulumi.Input.fromValue(
        map['sqlWebDeveloperUrl'] as String,
      ),
      state: pulumi.Input.fromValue(map['state'] as String),
      supportedCloneRegions: pulumi.Input.fromValue(
        (map['supportedCloneRegions'] as List).cast<String>(),
      ),
      totalAutoBackupStorageSizeGbs: pulumi.Input.fromValue(
        map['totalAutoBackupStorageSizeGbs'] as double,
      ),
      usedDataStorageSizeTbs: pulumi.Input.fromValue(
        map['usedDataStorageSizeTbs'] as int,
      ),
