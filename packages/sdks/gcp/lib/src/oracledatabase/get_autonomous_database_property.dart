...
class GetAutonomousDatabaseProperty {
  ...
  const GetAutonomousDatabaseProperty({
  ...
  factory GetAutonomousDatabaseProperty.fromMap(Map<String, dynamic> map) {
    return GetAutonomousDatabaseProperty(
      actualUsedDataStorageSizeTb: pulumi.Input.fromValue((map['actualUsedDataStorageSizeTb'] as num).toDouble()),
      allocatedStorageSizeTb: pulumi.Input.fromValue((map['allocatedStorageSizeTb'] as num).toDouble()),
      apexDetails: pulumi.Input.fromValue(pulumi.Input.decodeList<GetAutonomousDatabasePropertyApexDetail>(map['apexDetails']!, (value) => GetAutonomousDatabasePropertyApexDetail.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      backupRetentionPeriodDays: pulumi.Input.fromValue((map['backupRetentionPeriodDays'] as num).toInt()),
      ...
      connectionStrings: pulumi.Input.fromValue(pulumi.Input.decodeList<GetAutonomousDatabasePropertyConnectionString>(map['connectionStrings']!, (value) => GetAutonomousDatabasePropertyConnectionString.fromMap((value as Map).cast<String, dynamic>()))),
      connectionUrls: pulumi.Input.fromValue(pulumi.Input.decodeList<GetAutonomousDatabasePropertyConnectionUrl>(map['connectionUrls']!, (value) => GetAutonomousDatabasePropertyConnectionUrl.fromMap((value as Map).cast<String, dynamic>()))),
      cpuCoreCount: pulumi.Input.fromValue((map['cpuCoreCount'] as num).toInt()),
      customerContacts: pulumi.Input.fromValue(pulumi.Input.decodeList<GetAutonomousDatabasePropertyCustomerContact>(map['customerContacts']!, (value) => GetAutonomousDatabasePropertyCustomerContact.fromMap((value as Map).cast<String, dynamic>()))),
      dataSafeState: pulumi.Input.fromValue(map['dataSafeState'] as String),
      dataStorageSizeGb: pulumi.Input.fromValue((map['dataStorageSizeGb'] as num).toInt()),
      dataStorageSizeTb: pulumi.Input.fromValue((map['dataStorageSizeTb'] as num).toInt()),
      ...
      localAdgAutoFailoverMaxDataLossLimit: pulumi.Input.fromValue((map['localAdgAutoFailoverMaxDataLossLimit'] as num).toInt()),
      localDisasterRecoveryType: pulumi.Input.fromValue(map['localDisasterRecoveryType'] as String),
      localStandbyDbs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetAutonomousDatabasePropertyLocalStandbyDb>(map['localStandbyDbs']!, (value) => GetAutonomousDatabasePropertyLocalStandbyDb.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      memoryPerOracleComputeUnitGbs: pulumi.Input.fromValue((map['memoryPerOracleComputeUnitGbs'] as num).toInt()),
      memoryTableGbs: pulumi.Input.fromValue((map['memoryTableGbs'] as num).toInt()),
      ...
      scheduledOperationDetails: pulumi.Input.fromValue(pulumi.Input.decodeList<GetAutonomousDatabasePropertyScheduledOperationDetail>(map['scheduledOperationDetails']!, (value) => GetAutonomousDatabasePropertyScheduledOperationDetail.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      totalAutoBackupStorageSizeGbs: pulumi.Input.fromValue((map['totalAutoBackupStorageSizeGbs'] as num).toDouble()),
      usedDataStorageSizeTbs: pulumi.Input.fromValue((map['usedDataStorageSizeTbs'] as num).toInt()),
