...
class CloudExadataInfrastructurePropertiesMaintenanceWindow {
  ...
  factory CloudExadataInfrastructurePropertiesMaintenanceWindow.fromMap(Map<String, dynamic> map) {
    return CloudExadataInfrastructurePropertiesMaintenanceWindow(
      customActionTimeoutMins: (() { final guardedValue = map['customActionTimeoutMins']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      leadTimeWeek: (() { final guardedValue = map['leadTimeWeek']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
