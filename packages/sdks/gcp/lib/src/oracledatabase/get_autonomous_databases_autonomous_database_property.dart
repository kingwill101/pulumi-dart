...
class GetAutonomousDatabasesAutonomousDatabaseProperty {
  ...
  factory GetAutonomousDatabasesAutonomousDatabaseProperty.fromMap(Map<String, dynamic> map) {
    return GetAutonomousDatabasesAutonomousDatabaseProperty(
      ...
      apexDetails: (pulumi.Input.decodeList<GetAutonomousDatabasesAutonomousDatabasePropertyApexDetail>(map['apexDetails'], (value) => GetAutonomousDatabasesAutonomousDatabasePropertyApexDetail.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      connectionStrings: (pulumi.Input.decodeList<GetAutonomousDatabasesAutonomousDatabasePropertyConnectionString>(map['connectionStrings'], (value) => GetAutonomousDatabasesAutonomousDatabasePropertyConnectionString.fromMap((value as Map).cast<String, dynamic>()))).input(),
      connectionUrls: (pulumi.Input.decodeList<GetAutonomousDatabasesAutonomousDatabasePropertyConnectionUrl>(map['connectionUrls'], (value) => GetAutonomousDatabasesAutonomousDatabasePropertyConnectionUrl.fromMap((value as Map).cast<String, dynamic>()))).input(),
      cpuCoreCount: (map['cpuCoreCount'] as int).input(),
      customerContacts: (pulumi.Input.decodeList<GetAutonomousDatabasesAutonomousDatabasePropertyCustomerContact>(map['customerContacts'], (value) => GetAutonomousDatabasesAutonomousDatabasePropertyCustomerContact.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      localStandbyDbs: (pulumi.Input.decodeList<GetAutonomousDatabasesAutonomousDatabasePropertyLocalStandbyDb>(map['localStandbyDbs'], (value) => GetAutonomousDatabasesAutonomousDatabasePropertyLocalStandbyDb.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      scheduledOperationDetails: (pulumi.Input.decodeList<GetAutonomousDatabasesAutonomousDatabasePropertyScheduledOperationDetail>(map['scheduledOperationDetails'], (value) => GetAutonomousDatabasesAutonomousDatabasePropertyScheduledOperationDetail.fromMap((value as Map).cast<String, dynamic>()))).input(),
