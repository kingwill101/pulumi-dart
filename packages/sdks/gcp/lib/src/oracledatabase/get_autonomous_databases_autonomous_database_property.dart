...
class GetAutonomousDatabasesAutonomousDatabaseProperty {
  ...
  final List<GetAutonomousDatabasesAutonomousDatabasePropertyApexDetail> apexDetails;
  ...
  final List<GetAutonomousDatabasesAutonomousDatabasePropertyConnectionString> connectionStrings;
  /// The URLs for accessing Oracle Application Express (APEX) and SQL Developer
  /// Web with a browser from a Compute instance.
  /// https://docs.oracle.com/en-us/iaas/api/#/en/database/20160918/datatypes/AutonomousDatabaseConnectionUrls
  final List<GetAutonomousDatabasesAutonomousDatabasePropertyConnectionUrl> connectionUrls;
  /// The number of CPU cores to be made available to the database.
  final int cpuCoreCount;
  /// The list of customer contacts.
  final List<GetAutonomousDatabasesAutonomousDatabasePropertyCustomerContact> customerContacts;
  ...
  final List<GetAutonomousDatabasesAutonomousDatabasePropertyLocalStandbyDb> localStandbyDbs;
  ...
  /// Database.
  final List<GetAutonomousDatabasesAutonomousDatabasePropertyScheduledOperationDetail> scheduledOperationDetails;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'apexDetails': pulumi.Input.encodeList<GetAutonomousDatabasesAutonomousDatabasePropertyApexDetail, Map<String, dynamic>>(apexDetails, (value) => value.toMap()),
      ...
      'connectionStrings': pulumi.Input.encodeList<GetAutonomousDatabasesAutonomousDatabasePropertyConnectionString, Map<String, dynamic>>(connectionStrings, (value) => value.toMap()),
      'connectionUrls': pulumi.Input.encodeList<GetAutonomousDatabasesAutonomousDatabasePropertyConnectionUrl, Map<String, dynamic>>(connectionUrls, (value) => value.toMap()),
      'cpuCoreCount': cpuCoreCount,
      'customerContacts': pulumi.Input.encodeList<GetAutonomousDatabasesAutonomousDatabasePropertyCustomerContact, Map<String, dynamic>>(customerContacts, (value) => value.toMap()),
      ...
      'localStandbyDbs': pulumi.Input.encodeList<GetAutonomousDatabasesAutonomousDatabasePropertyLocalStandbyDb, Map<String, dynamic>>(localStandbyDbs, (value) => value.toMap()),
      ...
      'role': role,
      'scheduledOperationDetails': pulumi.Input.encodeList<GetAutonomousDatabasesAutonomousDatabasePropertyScheduledOperationDetail, Map<String, dynamic>>(scheduledOperationDetails, (value) => value.toMap()),
      'secretId': secretId,
  ...
  factory GetAutonomousDatabasesAutonomousDatabaseProperty.fromMap(Map<String, dynamic> map) {
    return GetAutonomousDatabasesAutonomousDatabaseProperty(
      ...
      apexDetails: pulumi.Input.decodeList<GetAutonomousDatabasesAutonomousDatabasePropertyApexDetail>(map['apexDetails'], (value) => GetAutonomousDatabasesAutonomousDatabasePropertyApexDetail.fromMap((value as Map).cast<String, dynamic>())),
      ...
      connectionStrings: pulumi.Input.decodeList<GetAutonomousDatabasesAutonomousDatabasePropertyConnectionString>(map['connectionStrings'], (value) => GetAutonomousDatabasesAutonomousDatabasePropertyConnectionString.fromMap((value as Map).cast<String, dynamic>())),
      connectionUrls: pulumi.Input.decodeList<GetAutonomousDatabasesAutonomousDatabasePropertyConnectionUrl>(map['connectionUrls'], (value) => GetAutonomousDatabasesAutonomousDatabasePropertyConnectionUrl.fromMap((value as Map).cast<String, dynamic>())),
      cpuCoreCount: map['cpuCoreCount'] as int,
      customerContacts: pulumi.Input.decodeList<GetAutonomousDatabasesAutonomousDatabasePropertyCustomerContact>(map['customerContacts'], (value) => GetAutonomousDatabasesAutonomousDatabasePropertyCustomerContact.fromMap((value as Map).cast<String, dynamic>())),
      ...
      localStandbyDbs: pulumi.Input.decodeList<GetAutonomousDatabasesAutonomousDatabasePropertyLocalStandbyDb>(map['localStandbyDbs'], (value) => GetAutonomousDatabasesAutonomousDatabasePropertyLocalStandbyDb.fromMap((value as Map).cast<String, dynamic>())),
      ...
      scheduledOperationDetails: pulumi.Input.decodeList<GetAutonomousDatabasesAutonomousDatabasePropertyScheduledOperationDetail>(map['scheduledOperationDetails'], (value) => GetAutonomousDatabasesAutonomousDatabasePropertyScheduledOperationDetail.fromMap((value as Map).cast<String, dynamic>())),
