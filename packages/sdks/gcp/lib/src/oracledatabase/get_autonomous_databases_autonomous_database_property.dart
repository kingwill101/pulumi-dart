...
class GetAutonomousDatabasesAutonomousDatabaseProperty {
  ...
  final pulumi.Input<
    List<GetAutonomousDatabasesAutonomousDatabasePropertyApexDetail>
  >
  apexDetails;
  ...
  final pulumi.Input<
    List<GetAutonomousDatabasesAutonomousDatabasePropertyConnectionString>
  >
  connectionStrings;
  ...
  final pulumi.Input<
    List<GetAutonomousDatabasesAutonomousDatabasePropertyConnectionUrl>
  >
  connectionUrls;
  ...
  final pulumi.Input<
    List<GetAutonomousDatabasesAutonomousDatabasePropertyCustomerContact>
  >
  customerContacts;
  ...
  final pulumi.Input<
    List<GetAutonomousDatabasesAutonomousDatabasePropertyLocalStandbyDb>
  >
  localStandbyDbs;
  ...
  factory GetAutonomousDatabasesAutonomousDatabaseProperty.fromMap(
    ...
    return GetAutonomousDatabasesAutonomousDatabaseProperty(
      ...
      apexDetails: pulumi.Input.fromValue(
        ...
        >(
          map['apexDetails']!,
          (value) =>
              GetAutonomousDatabasesAutonomousDatabasePropertyApexDetail.fromMap(
      ...
      connectionStrings: pulumi.Input.fromValue(
        ...
        >(
          ...
          (value) =>
              GetAutonomousDatabasesAutonomousDatabasePropertyConnectionString.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
      connectionUrls: pulumi.Input.fromValue(
        ...
        >(
          map['connectionUrls']!,
          (value) =>
              GetAutonomousDatabasesAutonomousDatabasePropertyConnectionUrl.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
      ...
      customerContacts: pulumi.Input.fromValue(
        ...
        >(
          ...
          (value) =>
              GetAutonomousDatabasesAutonomousDatabasePropertyCustomerContact.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
      ...
      localStandbyDbs: pulumi.Input.fromValue(
        ...
        >(
          map['localStandbyDbs']!,
          (value) =>
              GetAutonomousDatabasesAutonomousDatabasePropertyLocalStandbyDb.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
      ...
      scheduledOperationDetails: pulumi.Input.fromValue(
        ...
        >(
          ...
          (value) =>
              GetAutonomousDatabasesAutonomousDatabasePropertyScheduledOperationDetail.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
