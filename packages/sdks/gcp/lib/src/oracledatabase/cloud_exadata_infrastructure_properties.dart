...
class CloudExadataInfrastructureProperties {
  ...
  factory CloudExadataInfrastructureProperties.fromMap(Map<String, dynamic> map) {
    return CloudExadataInfrastructureProperties(
      ...
      availableStorageSizeGb: map['availableStorageSizeGb'] == null ? null : (map['availableStorageSizeGb'] as int).input(),
      ...
      customerContacts: map['customerContacts'] == null ? null : (pulumi.Input.decodeList<CloudExadataInfrastructurePropertiesCustomerContact>(map['customerContacts'], (value) => CloudExadataInfrastructurePropertiesCustomerContact.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      maintenanceWindow: map['maintenanceWindow'] == null ? null : (CloudExadataInfrastructurePropertiesMaintenanceWindow.fromMap((map['maintenanceWindow'] as Map).cast<String, dynamic>())).input(),
      maxCpuCount: map['maxCpuCount'] == null ? null : (map['maxCpuCount'] as int).input(),
      maxDataStorageTb: map['maxDataStorageTb'] == null ? null : (map['maxDataStorageTb'] as double).input(),
      maxDbNodeStorageSizeGb: map['maxDbNodeStorageSizeGb'] == null ? null : (map['maxDbNodeStorageSizeGb'] as int).input(),
      maxMemoryGb: map['maxMemoryGb'] == null ? null : (map['maxMemoryGb'] as int).input(),
      ...
      nextMaintenanceRunTime: map['nextMaintenanceRunTime'] == null ? null : (map['nextMaintenanceRunTime'] as String).input(),
      nextSecurityMaintenanceRunTime: map['nextSecurityMaintenanceRunTime'] == null ? null : (map['nextSecurityMaintenanceRunTime'] as String).input(),
      ...
      totalStorageSizeGb: map['totalStorageSizeGb'] == null ? null : (map['totalStorageSizeGb'] as int).input(),
    );
  }
}
