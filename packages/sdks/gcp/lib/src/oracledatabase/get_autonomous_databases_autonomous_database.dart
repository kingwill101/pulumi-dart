...
class GetAutonomousDatabasesAutonomousDatabase {
  ...
  final pulumi.Input<List<GetAutonomousDatabasesAutonomousDatabaseProperty>>
  properties;
  ...
  final pulumi.Input<List<GetAutonomousDatabasesAutonomousDatabaseSourceConfig>>
  sourceConfigs;
    ...
    return <String, dynamic>{
      ...
      'properties':
          pulumi.Input.mapInputValue<
            List<GetAutonomousDatabasesAutonomousDatabaseProperty>,
      ...
      'sourceConfigs':
          pulumi.Input.mapInputValue<
            List<GetAutonomousDatabasesAutonomousDatabaseSourceConfig>,
            List<Map<String, dynamic>>
          >(
            sourceConfigs,
            (value) =>
  ...
  factory GetAutonomousDatabasesAutonomousDatabase.fromMap(
    ...
    return GetAutonomousDatabasesAutonomousDatabase(
      ...
      disasterRecoverySupportedLocations: pulumi.Input.fromValue(
      ...
      peerAutonomousDatabases: pulumi.Input.fromValue(
      ...
      sourceConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetAutonomousDatabasesAutonomousDatabaseSourceConfig
        >(
          map['sourceConfigs']!,
          (value) =>
              GetAutonomousDatabasesAutonomousDatabaseSourceConfig.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
