...
class AutonomousDatabasePropertiesConnectionUrl {
  ...
  const AutonomousDatabasePropertiesConnectionUrl({
    this.apexUri,
  ...
  factory AutonomousDatabasePropertiesConnectionUrl.fromMap(Map<String, dynamic> map) {
    return AutonomousDatabasePropertiesConnectionUrl(
      apexUri: (() { final guardedValue = map['apexUri']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      databaseTransformsUri: (() { final guardedValue = map['databaseTransformsUri']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      graphStudioUri: (() { final guardedValue = map['graphStudioUri']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      machineLearningNotebookUri: (() { final guardedValue = map['machineLearningNotebookUri']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      machineLearningUserManagementUri: (() { final guardedValue = map['machineLearningUserManagementUri']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      mongoDbUri: (() { final guardedValue = map['mongoDbUri']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ordsUri: (() { final guardedValue = map['ordsUri']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      sqlDevWebUri: (() { final guardedValue = map['sqlDevWebUri']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
