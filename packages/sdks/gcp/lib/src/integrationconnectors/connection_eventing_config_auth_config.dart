...
class ConnectionEventingConfigAuthConfig {
  ...
  final pulumi.Input<
    List<ConnectionEventingConfigAuthConfigAdditionalVariable>
  >?
  additionalVariables;
  ...
  /// Structure is documented below.
  final pulumi.Input<ConnectionEventingConfigAuthConfigUserPassword>
  userPassword;
  ...
  factory ConnectionEventingConfigAuthConfig.fromMap(Map<String, dynamic> map) {
    return ConnectionEventingConfigAuthConfig(
      ...
      userPassword: pulumi.Input.fromValue(
        ConnectionEventingConfigAuthConfigUserPassword.fromMap(
