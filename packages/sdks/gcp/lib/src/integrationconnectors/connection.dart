...
class Connection extends pulumi.CustomResource {
  ...
  Connection(
    ...
    this.configVariables = registerOutput<List<ConnectionConfigVariable>?>('configVariables');
    ...
    this.connectorVersionInfraConfigs = registerOutput<List<ConnectionConnectorVersionInfraConfig>>('connectorVersionInfraConfigs');
    this.connectorVersionLaunchStage = registerOutput<String>('connectorVersionLaunchStage');
    this.createTime = registerOutput<String>('createTime');
    this.description = registerOutput<String?>('description');
    this.destinationConfigs = registerOutput<List<ConnectionDestinationConfig>?>('destinationConfigs');
    this.effectiveLabels = registerOutput<Map<String, String>>('effectiveLabels');
    this.eventingConfig = registerOutput<ConnectionEventingConfig?>('eventingConfig');
    this.eventingEnablementType = registerOutput<String?>('eventingEnablementType');
    this.eventingRuntimeDatas = registerOutput<List<ConnectionEventingRuntimeData>>('eventingRuntimeDatas');
