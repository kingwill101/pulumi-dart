...
class ConnectionSslConfig {
  ...
  final pulumi.Input<List<ConnectionSslConfigAdditionalVariable>>?
  additionalVariables;
  ...
  /// Structure is documented below.
  final pulumi.Input<ConnectionSslConfigClientPrivateKeyPass>?
  clientPrivateKeyPass;

  /// Private Server Certificate. Needs to be specified if trust model is PRIVATE.
  /// Structure is documented below.
  final pulumi.Input<ConnectionSslConfigPrivateServerCertificate>?
    ...
    return <String, dynamic>{
      'additionalVariables':
          ?pulumi.Input.mapOptionalInputValue<
            List<ConnectionSslConfigAdditionalVariable>,
      ...
      'clientPrivateKey':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(clientPrivateKey, (value) => value.toMap()),
      'clientPrivateKeyPass':
          ?pulumi.Input.mapOptionalInputValue<
            ConnectionSslConfigClientPrivateKeyPass,
            Map<String, dynamic>
          >(clientPrivateKeyPass, (value) => value.toMap()),
      'privateServerCertificate':
          ?pulumi.Input.mapOptionalInputValue<
            ConnectionSslConfigPrivateServerCertificate,
            Map<String, dynamic>
          >(privateServerCertificate, (value) => value.toMap()),
  ...
  factory ConnectionSslConfig.fromMap(Map<String, dynamic> map) {
    return ConnectionSslConfig(
      ...
      clientCertType: (() {
        final guardedValue = map['clientCertType'];
        if (guardedValue == null) return null;
      ...
      clientPrivateKey: (() {
        final guardedValue = map['clientPrivateKey'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      clientPrivateKeyPass: (() {
        final guardedValue = map['clientPrivateKeyPass'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      privateServerCertificate: (() {
        final guardedValue = map['privateServerCertificate'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      serverCertType: (() {
        final guardedValue = map['serverCertType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      trustModel: (() {
        final guardedValue = map['trustModel'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
