...
class ConnectionConfigVariable {
  ...
  factory ConnectionConfigVariable.fromMap(Map<String, dynamic> map) {
    return ConnectionConfigVariable(
      ...
      encryptionKeyValue: map['encryptionKeyValue'] == null ? null : ConnectionConfigVariableEncryptionKeyValue.fromMap((map['encryptionKeyValue'] as Map).cast<String, dynamic>()),
      integerValue: map['integerValue'] == null ? null : map['integerValue'] as int,
      key: map['key'] as String,
      secretValue: map['secretValue'] == null ? null : ConnectionConfigVariableSecretValue.fromMap((map['secretValue'] as Map).cast<String, dynamic>()),
