...
class ConnectionEventingRuntimeData {
  ...
  factory ConnectionEventingRuntimeData.fromMap(Map<String, dynamic> map) {
    return ConnectionEventingRuntimeData(
      eventsListenerEndpoint: (() { final guardedValue = map['eventsListenerEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      statuses: (() { final guardedValue = map['statuses']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ConnectionEventingRuntimeDataStatus>(guardedValue, (value) => ConnectionEventingRuntimeDataStatus.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
