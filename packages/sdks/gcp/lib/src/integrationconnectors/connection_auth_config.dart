...
class ConnectionAuthConfig {
  ...
  factory ConnectionAuthConfig.fromMap(Map<String, dynamic> map) {
    return ConnectionAuthConfig(
      additionalVariables: (() { final guardedValue = map['additionalVariables']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ConnectionAuthConfigAdditionalVariable>(guardedValue, (value) => ConnectionAuthConfigAdditionalVariable.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      oauth2AuthCodeFlow: (() { final guardedValue = map['oauth2AuthCodeFlow']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConnectionAuthConfigOauth2AuthCodeFlow.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      oauth2ClientCredentials: (() { final guardedValue = map['oauth2ClientCredentials']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConnectionAuthConfigOauth2ClientCredentials.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      oauth2JwtBearer: (() { final guardedValue = map['oauth2JwtBearer']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConnectionAuthConfigOauth2JwtBearer.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      sshPublicKey: (() { final guardedValue = map['sshPublicKey']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConnectionAuthConfigSshPublicKey.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      userPassword: (() { final guardedValue = map['userPassword']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConnectionAuthConfigUserPassword.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
