...
class AlertPolicyCondition {
  ...
  /// Structure is documented below.
  final AlertPolicyConditionConditionMonitoringQueryLanguage? conditionMonitoringQueryLanguage;
  /// A condition type that allows alert policies to be defined using
  /// Prometheus Query Language (PromQL).
  /// The PrometheusQueryLanguageCondition message contains information
  /// from a Prometheus alerting rule and its associated rule group.
  /// Structure is documented below.
  final AlertPolicyConditionConditionPrometheusQueryLanguage? conditionPrometheusQueryLanguage;
  ...
  factory AlertPolicyCondition.fromMap(Map<String, dynamic> map) {
    return AlertPolicyCondition(
      conditionAbsent: map['conditionAbsent'] == null ? null : AlertPolicyConditionConditionAbsent.fromMap((map['conditionAbsent'] as Map).cast<String, dynamic>()),
      conditionMatchedLog: map['conditionMatchedLog'] == null ? null : AlertPolicyConditionConditionMatchedLog.fromMap((map['conditionMatchedLog'] as Map).cast<String, dynamic>()),
      conditionMonitoringQueryLanguage: map['conditionMonitoringQueryLanguage'] == null ? null : AlertPolicyConditionConditionMonitoringQueryLanguage.fromMap((map['conditionMonitoringQueryLanguage'] as Map).cast<String, dynamic>()),
      conditionPrometheusQueryLanguage: map['conditionPrometheusQueryLanguage'] == null ? null : AlertPolicyConditionConditionPrometheusQueryLanguage.fromMap((map['conditionPrometheusQueryLanguage'] as Map).cast<String, dynamic>()),
      conditionSql: map['conditionSql'] == null ? null : AlertPolicyConditionConditionSql.fromMap((map['conditionSql'] as Map).cast<String, dynamic>()),
      conditionThreshold: map['conditionThreshold'] == null ? null : AlertPolicyConditionConditionThreshold.fromMap((map['conditionThreshold'] as Map).cast<String, dynamic>()),
