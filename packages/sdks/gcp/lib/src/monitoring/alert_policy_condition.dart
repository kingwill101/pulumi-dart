...
class AlertPolicyCondition {
  ...
  /// Structure is documented below.
  final pulumi.Input<AlertPolicyConditionConditionMatchedLog>?
  conditionMatchedLog;

  /// A Monitoring Query Language query that outputs a boolean stream
  /// Structure is documented below.
  final pulumi.Input<AlertPolicyConditionConditionMonitoringQueryLanguage>?
  ...
  /// Structure is documented below.
  final pulumi.Input<AlertPolicyConditionConditionPrometheusQueryLanguage>?
  ...
  /// threshold.
  /// Structure is documented below.
  final pulumi.Input<AlertPolicyConditionConditionThreshold>?
  conditionThreshold;
    ...
    return <String, dynamic>{
      ...
      'conditionMatchedLog':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(conditionMatchedLog, (value) => value.toMap()),
      'conditionMonitoringQueryLanguage':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'conditionSql':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(conditionSql, (value) => value.toMap()),
      'conditionThreshold':
          ?pulumi.Input.mapOptionalInputValue<
  ...
  factory AlertPolicyCondition.fromMap(Map<String, dynamic> map) {
    return AlertPolicyCondition(
      ...
      conditionSql: (() {
        final guardedValue = map['conditionSql'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
