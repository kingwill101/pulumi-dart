...
class UptimeCheckConfigArgs {
  ...
  factory UptimeCheckConfigArgs.fromMap(Map<String, dynamic> map) {
    return UptimeCheckConfigArgs(
      checkerType: (() {
        final guardedValue = map['checkerType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      contentMatchers: (() {
        final guardedValue = map['contentMatchers'];
        if (guardedValue == null) return null;
      ...
      httpCheck: (() {
        final guardedValue = map['httpCheck'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      logCheckFailures: (() {
        final guardedValue = map['logCheckFailures'];
        if (guardedValue == null) return null;
      ...
      selectedRegions: (() {
        final guardedValue = map['selectedRegions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      syntheticMonitor: (() {
        final guardedValue = map['syntheticMonitor'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      tcpCheck: (() {
        final guardedValue = map['tcpCheck'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
