    ...
    return SloState(
      basicSli: (() {
        ...
        return pulumi.Input.fromValue(
          SloBasicSli.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      calendarPeriod: (() {
      ...
      requestBasedSli: (() {
        final guardedValue = map['requestBasedSli'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      rollingPeriodDays: (() {
        final guardedValue = map['rollingPeriodDays'];
        if (guardedValue == null) return null;
      ...
      windowsBasedSli: (() {
        final guardedValue = map['windowsBasedSli'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
