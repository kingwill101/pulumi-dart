...
class AlertPolicyConditionConditionSql {
  ...
  factory AlertPolicyConditionConditionSql.fromMap(Map<String, dynamic> map) {
    return AlertPolicyConditionConditionSql(
      booleanTest: (() { final guardedValue = map['booleanTest']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AlertPolicyConditionConditionSqlBooleanTest.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      daily: (() { final guardedValue = map['daily']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AlertPolicyConditionConditionSqlDaily.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      hourly: (() { final guardedValue = map['hourly']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AlertPolicyConditionConditionSqlHourly.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      minutes: (() { final guardedValue = map['minutes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AlertPolicyConditionConditionSqlMinutes.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      query: pulumi.Input.fromValue(map['query'] as String),
      rowCountTest: (() { final guardedValue = map['rowCountTest']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AlertPolicyConditionConditionSqlRowCountTest.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
