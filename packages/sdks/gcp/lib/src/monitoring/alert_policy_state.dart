...
class AlertPolicyState {
    ...
    return <String, dynamic>{
      'alertStrategy':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(alertStrategy, (value) => value.toMap()),
      'combiner': ?combiner,
      'conditions':
          ?pulumi.Input.mapOptionalInputValue<
            List<AlertPolicyCondition>,
      ...
      'creationRecords':
          ?pulumi.Input.mapOptionalInputValue<
            List<AlertPolicyCreationRecord>,
            List<Map<String, dynamic>>
          >(
            creationRecords,
            (value) =>
  ...
  factory AlertPolicyState.fromMap(Map<String, dynamic> map) {
    return AlertPolicyState(
      alertStrategy: (() {
        final guardedValue = map['alertStrategy'];
      ...
      combiner: (() {
        final guardedValue = map['combiner'];
        if (guardedValue == null) return null;
      ...
      conditions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AlertPolicyCondition>(
            guardedValue,
      ...
      creationRecords: (() {
        final guardedValue = map['creationRecords'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AlertPolicyCreationRecord>(
            guardedValue,
            (value) => AlertPolicyCreationRecord.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
