...
class UptimeCheckConfigMonitoredResource {
  ...
  /// [labels] Values for all of the labels listed in the associated monitored resource descriptor. For example, Compute Engine VM instances use the labels `projectId`, `instanceId`, and `zone`.
  ...
  const UptimeCheckConfigMonitoredResource({
