...
class UptimeCheckConfigHttpCheck {
  ...
  final pulumi.Input<
    List<UptimeCheckConfigHttpCheckAcceptedResponseStatusCode>
  >?
  ...
  /// Structure is documented below.
  final pulumi.Input<UptimeCheckConfigHttpCheckServiceAgentAuthentication>?
    ...
    return <String, dynamic>{
      ...
      'serviceAgentAuthentication':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(serviceAgentAuthentication, (value) => value.toMap()),
      'useSsl': ?useSsl,
  ...
  factory UptimeCheckConfigHttpCheck.fromMap(Map<String, dynamic> map) {
    return UptimeCheckConfigHttpCheck(
      acceptedResponseStatusCodes: (() {
        final guardedValue = map['acceptedResponseStatusCodes'];
      ...
      customContentType: (() {
        final guardedValue = map['customContentType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      headers: (() {
      ...
      maskHeaders: (() {
        final guardedValue = map['maskHeaders'];
        if (guardedValue == null) return null;
      ...
      pingConfig: (() {
        final guardedValue = map['pingConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      serviceAgentAuthentication: (() {
        final guardedValue = map['serviceAgentAuthentication'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      validateSsl: (() {
        final guardedValue = map['validateSsl'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
    );
