...
class AlertPolicyAlertStrategy {
  ...
  final pulumi.Input<List<AlertPolicyAlertStrategyNotificationChannelStrategy>>?
  ...
  /// Structure is documented below.
  final pulumi.Input<AlertPolicyAlertStrategyNotificationRateLimit>?
    ...
    return <String, dynamic>{
      ...
      'notificationChannelStrategies':
          ?pulumi.Input.mapOptionalInputValue<
            List<AlertPolicyAlertStrategyNotificationChannelStrategy>,
  ...
  factory AlertPolicyAlertStrategy.fromMap(Map<String, dynamic> map) {
    return AlertPolicyAlertStrategy(
      ...
      notificationChannelStrategies: (() {
        final guardedValue = map['notificationChannelStrategies'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                AlertPolicyAlertStrategyNotificationChannelStrategy.fromMap(
      ...
      notificationPrompts: (() {
        final guardedValue = map['notificationPrompts'];
        if (guardedValue == null) return null;
      ...
      notificationRateLimit: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AlertPolicyAlertStrategyNotificationRateLimit.fromMap(
