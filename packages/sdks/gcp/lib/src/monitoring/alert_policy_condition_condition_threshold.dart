...
class AlertPolicyConditionConditionThreshold {
  ...
  final pulumi.Input<List<AlertPolicyConditionConditionThresholdAggregation>>?
  aggregations;
  ...
  /// Structure is documented below.
  final pulumi.Input<AlertPolicyConditionConditionThresholdForecastOptions>?
  forecastOptions;
    ...
    return <String, dynamic>{
      'aggregations':
          ?pulumi.Input.mapOptionalInputValue<
            List<AlertPolicyConditionConditionThresholdAggregation>,
      ...
      denominatorAggregations: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                AlertPolicyConditionConditionThresholdDenominatorAggregation.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
