...
class UptimeCheckConfigState {
  ...
  UptimeCheckConfigState({
    ...
    pulumi.Output<String>? uptimeCheckId,
    pulumi.Output<Map<String, String>>? userLabels,
      ...
      uptimeCheckId = pulumi.Input.asOptionalInput<String>(uptimeCheckId),
  ...
  factory UptimeCheckConfigState.fromMap(Map<String, dynamic> map) {
    return UptimeCheckConfigState(
      ...
      uptimeCheckId: map['uptimeCheckId'] == null ? null : pulumi.Output.create<String>(map['uptimeCheckId'] as String),
