...
class UptimeCheckConfigState {
  ...
  factory UptimeCheckConfigState.fromMap(Map<String, dynamic> map) {
    return UptimeCheckConfigState(
      ...
      uptimeCheckId: (() { final guardedValue = map['uptimeCheckId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
