...
class SloBasicSli {
  ...
  factory SloBasicSli.fromMap(Map<String, dynamic> map) {
    return SloBasicSli(
      availability: (() { final guardedValue = map['availability']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SloBasicSliAvailability.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      latency: (() { final guardedValue = map['latency']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SloBasicSliLatency.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
