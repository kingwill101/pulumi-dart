    ...
    return <String, dynamic>{
      'allows':
          pulumi.Input.mapInputValue<
            List<GetOrganizationPolicyListPolicyAllow>,
      ...
      'denies':
          pulumi.Input.mapInputValue<
            List<GetOrganizationPolicyListPolicyDeny>,
            List<Map<String, dynamic>>
          >(
            denies,
            (value) =>
  ...
  factory GetOrganizationPolicyListPolicy.fromMap(Map<String, dynamic> map) {
    return GetOrganizationPolicyListPolicy(
      allows: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetOrganizationPolicyListPolicyAllow>(
          map['allows']!,
      ...
      denies: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetOrganizationPolicyListPolicyDeny>(
          map['denies']!,
