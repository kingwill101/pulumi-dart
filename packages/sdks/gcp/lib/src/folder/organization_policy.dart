...
/// }
///
/// resource "gcp_folder_organizationpolicy" "serial_port_policy" {
///   folder     = "folders/123456789"
///   constraint = "compute.disableSerialPortAccess"
///   boolean_policy = {
///     enforced = true
...
/// }
///
/// resource "gcp_folder_organizationpolicy" "services_policy" {
///   folder     = "folders/123456789"
///   constraint = "serviceuser.services"
///   list_policy = {
///     allow = {
...
class OrganizationPolicy extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [OrganizationPolicy]. {@macro pulumi_folder_organization_policy_organization_policy_args_doc}
