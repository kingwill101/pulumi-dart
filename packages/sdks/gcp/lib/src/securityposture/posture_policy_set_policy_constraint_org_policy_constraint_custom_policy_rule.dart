    ...
    return PosturePolicySetPolicyConstraintOrgPolicyConstraintCustomPolicyRule(
      ...
      condition: (() {
        ...
        return pulumi.Input.fromValue(
          PosturePolicySetPolicyConstraintOrgPolicyConstraintCustomPolicyRuleCondition.fromMap(
      ...
      values: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PosturePolicySetPolicyConstraintOrgPolicyConstraintCustomPolicyRuleValues.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
