...
import 'posture_policy_set_policy_constraint_org_policy_constraint_custom_policy_rule_condition.dart';
import 'posture_policy_set_policy_constraint_org_policy_constraint_custom_policy_rule_values.dart';
...
class PosturePolicySetPolicyConstraintOrgPolicyConstraintCustomPolicyRule {
  ...
  const PosturePolicySetPolicyConstraintOrgPolicyConstraintCustomPolicyRule({
    this.allowAll,
    this.condition,
    this.denyAll,
    this.enforce,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'allowAll': ?allowAll,
      'condition': ?pulumi.Input.mapOptionalInputValue<PosturePolicySetPolicyConstraintOrgPolicyConstraintCustomPolicyRuleCondition, Map<String, dynamic>>(condition, (value) => value.toMap()),
      'denyAll': ?denyAll,
      'enforce': ?enforce,
      'values': ?pulumi.Input.mapOptionalInputValue<PosturePolicySetPolicyConstraintOrgPolicyConstraintCustomPolicyRuleValues, Map<String, dynamic>>(values, (value) => value.toMap()),
    };
  }

  factory PosturePolicySetPolicyConstraintOrgPolicyConstraintCustomPolicyRule.fromMap(Map<String, dynamic> map) {
    return PosturePolicySetPolicyConstraintOrgPolicyConstraintCustomPolicyRule(
      ...
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PosturePolicySetPolicyConstraintOrgPolicyConstraintCustomPolicyRuleCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      values: (() { final guardedValue = map['values']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PosturePolicySetPolicyConstraintOrgPolicyConstraintCustomPolicyRuleValues.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
