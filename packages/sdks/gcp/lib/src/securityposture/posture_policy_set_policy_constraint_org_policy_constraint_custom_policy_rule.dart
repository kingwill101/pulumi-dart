...
class PosturePolicySetPolicyConstraintOrgPolicyConstraintCustomPolicyRule {
  ...
  final PosturePolicySetPolicyConstraintOrgPolicyConstraintCustomPolicyRuleCondition? condition;
  ...
  /// Structure is documented below.
  final PosturePolicySetPolicyConstraintOrgPolicyConstraintCustomPolicyRuleValues? values;
  ...
  factory PosturePolicySetPolicyConstraintOrgPolicyConstraintCustomPolicyRule.fromMap(Map<String, dynamic> map) {
    return PosturePolicySetPolicyConstraintOrgPolicyConstraintCustomPolicyRule(
      ...
      condition: map['condition'] == null ? null : PosturePolicySetPolicyConstraintOrgPolicyConstraintCustomPolicyRuleCondition.fromMap((map['condition'] as Map).cast<String, dynamic>()),
      denyAll: map['denyAll'] == null ? null : map['denyAll'] as bool,
      enforce: map['enforce'] == null ? null : map['enforce'] as bool,
      values: map['values'] == null ? null : PosturePolicySetPolicyConstraintOrgPolicyConstraintCustomPolicyRuleValues.fromMap((map['values'] as Map).cast<String, dynamic>()),
    );
  }
}
