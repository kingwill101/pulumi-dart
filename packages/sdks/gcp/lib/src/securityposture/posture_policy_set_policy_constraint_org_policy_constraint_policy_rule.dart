...
class PosturePolicySetPolicyConstraintOrgPolicyConstraintPolicyRule {
  ...
  final pulumi.Input<PosturePolicySetPolicyConstraintOrgPolicyConstraintPolicyRuleCondition?>? condition;
  ...
  /// Structure is documented below.
  final pulumi.Input<PosturePolicySetPolicyConstraintOrgPolicyConstraintPolicyRuleValues?>? values;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'allowAll': ?allowAll,
      'condition': ?pulumi.Input.mapOptionalInputValue<PosturePolicySetPolicyConstraintOrgPolicyConstraintPolicyRuleCondition, Map<String, dynamic>>(condition, (value) => value.toMap()),
      'denyAll': ?denyAll,
      'enforce': ?enforce,
      'values': ?pulumi.Input.mapOptionalInputValue<PosturePolicySetPolicyConstraintOrgPolicyConstraintPolicyRuleValues, Map<String, dynamic>>(values, (value) => value.toMap()),
    };
  }
  ...
  factory PosturePolicySetPolicyConstraintOrgPolicyConstraintPolicyRule.fromMap(Map<String, dynamic> map) {
    return PosturePolicySetPolicyConstraintOrgPolicyConstraintPolicyRule(
      ...
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PosturePolicySetPolicyConstraintOrgPolicyConstraintPolicyRuleCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      values: (() { final guardedValue = map['values']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PosturePolicySetPolicyConstraintOrgPolicyConstraintPolicyRuleValues.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
