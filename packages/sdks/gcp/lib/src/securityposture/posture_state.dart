...
class PostureState {
  ...
  factory PostureState.fromMap(Map<String, dynamic> map) {
    return PostureState(
      ...
      policySets: (() { final guardedValue = map['policySets']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PosturePolicySet>(guardedValue, (value) => PosturePolicySet.fromMap((value as Map).cast<String, dynamic>()))); })(),
