...
class PosturePolicySet {
  ...
  factory PosturePolicySet.fromMap(Map<String, dynamic> map) {
    return PosturePolicySet(
      ...
      policies: pulumi.Input.fromValue(pulumi.Input.decodeList<PosturePolicySetPolicy>(map['policies']!, (value) => PosturePolicySetPolicy.fromMap((value as Map).cast<String, dynamic>()))),
