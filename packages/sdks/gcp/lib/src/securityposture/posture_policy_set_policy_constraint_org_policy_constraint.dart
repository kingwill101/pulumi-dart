...
class PosturePolicySetPolicyConstraintOrgPolicyConstraint {
  ...
  factory PosturePolicySetPolicyConstraintOrgPolicyConstraint.fromMap(Map<String, dynamic> map) {
    return PosturePolicySetPolicyConstraintOrgPolicyConstraint(
      cannedConstraintId: pulumi.Input.fromValue(map['cannedConstraintId'] as String),
      policyRules: pulumi.Input.fromValue(pulumi.Input.decodeList<PosturePolicySetPolicyConstraintOrgPolicyConstraintPolicyRule>(map['policyRules']!, (value) => PosturePolicySetPolicyConstraintOrgPolicyConstraintPolicyRule.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
