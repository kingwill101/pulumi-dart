...
class PostureDeploymentState {
  ...
  factory PostureDeploymentState.fromMap(Map<String, dynamic> map) {
    return PostureDeploymentState(
      ...
      desiredPostureId: (() {
        final guardedValue = map['desiredPostureId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      desiredPostureRevisionId: (() {
        final guardedValue = map['desiredPostureRevisionId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      etag: (() {
      ...
      failureMessage: (() {
        final guardedValue = map['failureMessage'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      location: (() {
      ...
      postureDeploymentId: (() {
        final guardedValue = map['postureDeploymentId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      postureId: (() {
      ...
      postureRevisionId: (() {
        final guardedValue = map['postureRevisionId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      reconciling: (() {
