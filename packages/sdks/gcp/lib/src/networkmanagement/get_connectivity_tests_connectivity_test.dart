...
class GetConnectivityTestsConnectivityTest {
  ...
  final pulumi.Input<List<GetConnectivityTestsConnectivityTestDestination>>
  destinations;
    ...
    return <String, dynamic>{
      ...
      'destinations':
          pulumi.Input.mapInputValue<
            List<GetConnectivityTestsConnectivityTestDestination>,
      ...
      'sources':
          pulumi.Input.mapInputValue<
            List<GetConnectivityTestsConnectivityTestSource>,
            List<Map<String, dynamic>>
          >(
            sources,
            (value) =>
  ...
  factory GetConnectivityTestsConnectivityTest.fromMap(
    ...
    return GetConnectivityTestsConnectivityTest(
      bypassFirewallChecks: pulumi.Input.fromValue(
      ...
      relatedProjects: pulumi.Input.fromValue(
