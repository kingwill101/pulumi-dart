...
class ConnectivityTestState {
  ...
  factory ConnectivityTestState.fromMap(Map<String, dynamic> map) {
    return ConnectivityTestState(
      ...
      source: (() { final guardedValue = map['source']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConnectivityTestSource.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
