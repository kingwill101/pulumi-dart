...
class VpcFlowLogsConfigState {
  ...
  VpcFlowLogsConfigState({
    ...
    pulumi.Output<String>? targetResourceState,
    pulumi.Output<String>? updateTime,
    pulumi.Output<String>? vpcFlowLogsConfigId,
    pulumi.Output<String>? vpnTunnel,
      ...
      targetResourceState = pulumi.Input.asOptionalInput<String>(targetResourceState),
      updateTime = pulumi.Input.asOptionalInput<String>(updateTime),
      vpcFlowLogsConfigId = pulumi.Input.asOptionalInput<String>(vpcFlowLogsConfigId),
  ...
  factory VpcFlowLogsConfigState.fromMap(Map<String, dynamic> map) {
    return VpcFlowLogsConfigState(
      ...
      targetResourceState: map['targetResourceState'] == null ? null : pulumi.Output.create<String>(map['targetResourceState'] as String),
      updateTime: map['updateTime'] == null ? null : pulumi.Output.create<String>(map['updateTime'] as String),
      vpcFlowLogsConfigId: map['vpcFlowLogsConfigId'] == null ? null : pulumi.Output.create<String>(map['vpcFlowLogsConfigId'] as String),
