...
class ApiKeyRestrictions {
  ...
  final pulumi.Input<ApiKeyRestrictionsAndroidKeyRestrictions>?
  ...
  final pulumi.Input<ApiKeyRestrictionsBrowserKeyRestrictions>?
  ...
  final pulumi.Input<ApiKeyRestrictionsServerKeyRestrictions>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'apiTargets':
          ?pulumi.Input.mapOptionalInputValue<
            List<ApiKeyRestrictionsApiTarget>,
  ...
  factory ApiKeyRestrictions.fromMap(Map<String, dynamic> map) {
    return ApiKeyRestrictions(
      androidKeyRestrictions: (() {
        final guardedValue = map['androidKeyRestrictions'];
      ...
      apiTargets: (() {
        final guardedValue = map['apiTargets'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ApiKeyRestrictionsApiTarget>(
            guardedValue,
      ...
      browserKeyRestrictions: (() {
        final guardedValue = map['browserKeyRestrictions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      iosKeyRestrictions: (() {
        final guardedValue = map['iosKeyRestrictions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      serverKeyRestrictions: (() {
        final guardedValue = map['serverKeyRestrictions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
