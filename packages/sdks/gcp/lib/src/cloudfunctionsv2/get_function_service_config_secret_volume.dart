...
class GetFunctionServiceConfigSecretVolume {
  ...
  final pulumi.Input<List<GetFunctionServiceConfigSecretVolumeVersion>>
  versions;
    ...
    return <String, dynamic>{
      ...
      'versions':
          pulumi.Input.mapInputValue<
            List<GetFunctionServiceConfigSecretVolumeVersion>,
  ...
  factory GetFunctionServiceConfigSecretVolume.fromMap(
    ...
    return GetFunctionServiceConfigSecretVolume(
      ...
      versions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetFunctionServiceConfigSecretVolumeVersion>(
          map['versions']!,
          (value) => GetFunctionServiceConfigSecretVolumeVersion.fromMap(
