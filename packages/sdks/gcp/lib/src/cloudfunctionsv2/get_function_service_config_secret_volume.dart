...
class GetFunctionServiceConfigSecretVolume {
  ...
  factory GetFunctionServiceConfigSecretVolume.fromMap(Map<String, dynamic> map) {
    return GetFunctionServiceConfigSecretVolume(
      ...
      versions: (pulumi.Input.decodeList<GetFunctionServiceConfigSecretVolumeVersion>(map['versions'], (value) => GetFunctionServiceConfigSecretVolumeVersion.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
