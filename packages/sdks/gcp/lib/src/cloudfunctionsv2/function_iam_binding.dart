...
import 'function_iam_binding_state.dart';
...
class FunctionIamBinding extends pulumi.CustomResource {
  ...
  late final pulumi.Output<FunctionIamBindingCondition?> condition;
  ...
  /// Creates a new [FunctionIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [FunctionIamBinding]. {@macro pulumi_cloudfunctionsv2_function_iam_binding_function_iam_binding_args_doc}
  ...
  /// Gets an existing [FunctionIamBinding] resource's state with the given [name] and [id].
  static FunctionIamBinding get(
    String name,
    pulumi.Input<String> id, {
    FunctionIamBindingState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return FunctionIamBinding._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [FunctionIamBinding] resource.
  FunctionIamBinding.reference(String urn)
    : super(
        'gcp:cloudfunctionsv2/functionIamBinding:FunctionIamBinding',
