...
class FunctionIamMember extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [FunctionIamMember]. {@macro pulumi_cloudfunctionsv2_function_iam_member_function_iam_member_args_doc}
  ...
  FunctionIamMember(
    ...
    condition = registerOutput<FunctionIamMemberCondition?>(
      'condition',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return FunctionIamMemberCondition.fromMap(
