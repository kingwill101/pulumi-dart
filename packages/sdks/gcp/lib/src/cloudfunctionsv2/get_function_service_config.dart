...
class GetFunctionServiceConfig {
  ...
  final List<GetFunctionServiceConfigDirectVpcNetworkInterface> directVpcNetworkInterfaces;
  ...
  final List<GetFunctionServiceConfigSecretEnvironmentVariable> secretEnvironmentVariables;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'directVpcNetworkInterfaces': pulumi.Input.encodeList<GetFunctionServiceConfigDirectVpcNetworkInterface, Map<String, dynamic>>(directVpcNetworkInterfaces, (value) => value.toMap()),
      ...
      'secretEnvironmentVariables': pulumi.Input.encodeList<GetFunctionServiceConfigSecretEnvironmentVariable, Map<String, dynamic>>(secretEnvironmentVariables, (value) => value.toMap()),
      'secretVolumes': pulumi.Input.encodeList<GetFunctionServiceConfigSecretVolume, Map<String, dynamic>>(secretVolumes, (value) => value.toMap()),
      'service': service,
  ...
  factory GetFunctionServiceConfig.fromMap(Map<String, dynamic> map) {
    return GetFunctionServiceConfig(
      ...
      directVpcNetworkInterfaces: pulumi.Input.decodeList<GetFunctionServiceConfigDirectVpcNetworkInterface>(map['directVpcNetworkInterfaces'], (value) => GetFunctionServiceConfigDirectVpcNetworkInterface.fromMap((value as Map).cast<String, dynamic>())),
      ...
      maxInstanceRequestConcurrency: map['maxInstanceRequestConcurrency'] as int,
      minInstanceCount: map['minInstanceCount'] as int,
      secretEnvironmentVariables: pulumi.Input.decodeList<GetFunctionServiceConfigSecretEnvironmentVariable>(map['secretEnvironmentVariables'], (value) => GetFunctionServiceConfigSecretEnvironmentVariable.fromMap((value as Map).cast<String, dynamic>())),
      secretVolumes: pulumi.Input.decodeList<GetFunctionServiceConfigSecretVolume>(map['secretVolumes'], (value) => GetFunctionServiceConfigSecretVolume.fromMap((value as Map).cast<String, dynamic>())),
