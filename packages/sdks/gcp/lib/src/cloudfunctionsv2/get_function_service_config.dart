...
class GetFunctionServiceConfig {
  ...
  final pulumi.Input<List<GetFunctionServiceConfigDirectVpcNetworkInterface>>
  ...
  final pulumi.Input<List<GetFunctionServiceConfigSecretEnvironmentVariable>>
    ...
    return <String, dynamic>{
      ...
      'directVpcNetworkInterfaces':
          pulumi.Input.mapInputValue<
            List<GetFunctionServiceConfigDirectVpcNetworkInterface>,
      ...
      'secretEnvironmentVariables':
          pulumi.Input.mapInputValue<
            List<GetFunctionServiceConfigSecretEnvironmentVariable>,
            List<Map<String, dynamic>>
          >(
            secretEnvironmentVariables,
            (value) =>
      ...
      'secretVolumes':
          pulumi.Input.mapInputValue<
            List<GetFunctionServiceConfigSecretVolume>,
            List<Map<String, dynamic>>
          >(
            secretVolumes,
            (value) =>
  ...
  factory GetFunctionServiceConfig.fromMap(Map<String, dynamic> map) {
    return GetFunctionServiceConfig(
      allTrafficOnLatestRevision: pulumi.Input.fromValue(
      ...
      secretVolumes: pulumi.Input.fromValue(
      ...
      vpcConnectorEgressSettings: pulumi.Input.fromValue(
