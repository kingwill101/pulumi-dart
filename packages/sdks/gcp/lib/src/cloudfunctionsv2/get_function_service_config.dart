...
class GetFunctionServiceConfig {
  ...
  factory GetFunctionServiceConfig.fromMap(Map<String, dynamic> map) {
    return GetFunctionServiceConfig(
      ...
      binaryAuthorizationPolicy: pulumi.Input.fromValue(map['binaryAuthorizationPolicy'] as String),
      directVpcEgress: pulumi.Input.fromValue(map['directVpcEgress'] as String),
      directVpcNetworkInterfaces: pulumi.Input.fromValue(pulumi.Input.decodeList<GetFunctionServiceConfigDirectVpcNetworkInterface>(map['directVpcNetworkInterfaces']!, (value) => GetFunctionServiceConfigDirectVpcNetworkInterface.fromMap((value as Map).cast<String, dynamic>()))),
      environmentVariables: pulumi.Input.fromValue((map['environmentVariables'] as Map).cast<String, String>()),
      gcfUri: pulumi.Input.fromValue(map['gcfUri'] as String),
      ...
      secretEnvironmentVariables: pulumi.Input.fromValue(pulumi.Input.decodeList<GetFunctionServiceConfigSecretEnvironmentVariable>(map['secretEnvironmentVariables']!, (value) => GetFunctionServiceConfigSecretEnvironmentVariable.fromMap((value as Map).cast<String, dynamic>()))),
      secretVolumes: pulumi.Input.fromValue(pulumi.Input.decodeList<GetFunctionServiceConfigSecretVolume>(map['secretVolumes']!, (value) => GetFunctionServiceConfigSecretVolume.fromMap((value as Map).cast<String, dynamic>()))),
