...
class GetFunctionEventTrigger {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'eventFilters': pulumi.Input.mapInputValue<List<GetFunctionEventTriggerEventFilter>, List<Map<String, dynamic>>>(eventFilters, (value) => pulumi.Input.encodeList<GetFunctionEventTriggerEventFilter, Map<String, dynamic>>(value, (value) => value.toMap())),
      'eventType': eventType,
  ...
  factory GetFunctionEventTrigger.fromMap(Map<String, dynamic> map) {
    return GetFunctionEventTrigger(
      eventFilters: (pulumi.Input.decodeList<GetFunctionEventTriggerEventFilter>(map['eventFilters'], (value) => GetFunctionEventTriggerEventFilter.fromMap((value as Map).cast<String, dynamic>()))).input(),
      eventType: (map['eventType'] as String).input(),
      pubsubTopic: (map['pubsubTopic'] as String).input(),
      retryPolicy: (map['retryPolicy'] as String).input(),
      serviceAccountEmail: (map['serviceAccountEmail'] as String).input(),
      trigger: (map['trigger'] as String).input(),
      triggerRegion: (map['triggerRegion'] as String).input(),
    );
  }
}
