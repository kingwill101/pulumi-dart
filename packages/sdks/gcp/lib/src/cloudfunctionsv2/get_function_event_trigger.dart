...
class GetFunctionEventTrigger {
  ...
  factory GetFunctionEventTrigger.fromMap(Map<String, dynamic> map) {
    return GetFunctionEventTrigger(
      eventFilters: pulumi.Input.fromValue(pulumi.Input.decodeList<GetFunctionEventTriggerEventFilter>(map['eventFilters']!, (value) => GetFunctionEventTriggerEventFilter.fromMap((value as Map).cast<String, dynamic>()))),
