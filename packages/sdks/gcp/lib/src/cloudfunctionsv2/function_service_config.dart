...
class FunctionServiceConfig {
  ...
  final pulumi.Input<List<FunctionServiceConfigDirectVpcNetworkInterface>>?
  ...
  /// Structure is documented below.
  final pulumi.Input<List<FunctionServiceConfigSecretEnvironmentVariable>>?
    ...
    return <String, dynamic>{
      ...
      'directVpcNetworkInterfaces':
          ?pulumi.Input.mapOptionalInputValue<
            List<FunctionServiceConfigDirectVpcNetworkInterface>,
      ...
      'secretEnvironmentVariables':
          ?pulumi.Input.mapOptionalInputValue<
            List<FunctionServiceConfigSecretEnvironmentVariable>,
            List<Map<String, dynamic>>
          >(
            secretEnvironmentVariables,
            (value) =>
      ...
      'secretVolumes':
          ?pulumi.Input.mapOptionalInputValue<
            List<FunctionServiceConfigSecretVolume>,
            List<Map<String, dynamic>>
          >(
            secretVolumes,
            (value) =>
  ...
  factory FunctionServiceConfig.fromMap(Map<String, dynamic> map) {
    return FunctionServiceConfig(
      ...
      binaryAuthorizationPolicy: (() {
        final guardedValue = map['binaryAuthorizationPolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      directVpcEgress: (() {
        final guardedValue = map['directVpcEgress'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      directVpcNetworkInterfaces: (() {
        final guardedValue = map['directVpcNetworkInterfaces'];
        if (guardedValue == null) return null;
