...
class GetFunctionBuildConfig {
  ...
  factory GetFunctionBuildConfig.fromMap(Map<String, dynamic> map) {
    return GetFunctionBuildConfig(
      automaticUpdatePolicies: ((map['automaticUpdatePolicies'] as List).cast<Map<String, dynamic>>()).input(),
      ...
      onDeployUpdatePolicies: (pulumi.Input.decodeList<GetFunctionBuildConfigOnDeployUpdatePolicy>(map['onDeployUpdatePolicies'], (value) => GetFunctionBuildConfigOnDeployUpdatePolicy.fromMap((value as Map).cast<String, dynamic>()))).input(),
      runtime: (map['runtime'] as String).input(),
      serviceAccount: (map['serviceAccount'] as String).input(),
      sources: (pulumi.Input.decodeList<GetFunctionBuildConfigSource>(map['sources'], (value) => GetFunctionBuildConfigSource.fromMap((value as Map).cast<String, dynamic>()))).input(),
