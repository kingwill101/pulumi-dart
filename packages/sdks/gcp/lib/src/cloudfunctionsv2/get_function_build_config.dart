...
class GetFunctionBuildConfig {
  ...
  final pulumi.Input<List<GetFunctionBuildConfigOnDeployUpdatePolicy>>
    ...
    return <String, dynamic>{
      ...
      'onDeployUpdatePolicies':
          pulumi.Input.mapInputValue<
            List<GetFunctionBuildConfigOnDeployUpdatePolicy>,
      ...
      'sources':
          pulumi.Input.mapInputValue<
            List<GetFunctionBuildConfigSource>,
            List<Map<String, dynamic>>
          >(
            sources,
            (value) =>
  ...
  factory GetFunctionBuildConfig.fromMap(Map<String, dynamic> map) {
    return GetFunctionBuildConfig(
      automaticUpdatePolicies: pulumi.Input.fromValue(
      ...
      onDeployUpdatePolicies: pulumi.Input.fromValue(
      ...
      sources: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetFunctionBuildConfigSource>(
          map['sources']!,
