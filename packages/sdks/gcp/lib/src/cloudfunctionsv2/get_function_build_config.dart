...
class GetFunctionBuildConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'onDeployUpdatePolicies': pulumi.Input.encodeList<GetFunctionBuildConfigOnDeployUpdatePolicy, Map<String, dynamic>>(onDeployUpdatePolicies, (value) => value.toMap()),
      'runtime': runtime,
      'serviceAccount': serviceAccount,
      'sources': pulumi.Input.encodeList<GetFunctionBuildConfigSource, Map<String, dynamic>>(sources, (value) => value.toMap()),
  ...
  factory GetFunctionBuildConfig.fromMap(Map<String, dynamic> map) {
    return GetFunctionBuildConfig(
      ...
      onDeployUpdatePolicies: pulumi.Input.decodeList<GetFunctionBuildConfigOnDeployUpdatePolicy>(map['onDeployUpdatePolicies'], (value) => GetFunctionBuildConfigOnDeployUpdatePolicy.fromMap((value as Map).cast<String, dynamic>())),
      runtime: map['runtime'] as String,
      serviceAccount: map['serviceAccount'] as String,
      sources: pulumi.Input.decodeList<GetFunctionBuildConfigSource>(map['sources'], (value) => GetFunctionBuildConfigSource.fromMap((value as Map).cast<String, dynamic>())),
