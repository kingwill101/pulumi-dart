...
class FunctionServiceConfigSecretVolume {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'projectId': projectId,
      'secret': secret,
      'versions': ?versions == null ? null : pulumi.Input.encodeList<FunctionServiceConfigSecretVolumeVersion, Map<String, dynamic>>(versions!, (value) => value.toMap()),
    };
  }
  ...
  factory FunctionServiceConfigSecretVolume.fromMap(Map<String, dynamic> map) {
    return FunctionServiceConfigSecretVolume(
      ...
      versions: map['versions'] == null ? null : pulumi.Input.decodeList<FunctionServiceConfigSecretVolumeVersion>(map['versions'], (value) => FunctionServiceConfigSecretVolumeVersion.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
