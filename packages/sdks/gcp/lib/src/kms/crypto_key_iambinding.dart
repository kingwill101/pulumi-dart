...
import 'crypto_key_iambinding_state.dart';
...
class CryptoKeyIAMBinding extends pulumi.CustomResource {
  ...
  /// Creates a new [CryptoKeyIAMBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [CryptoKeyIAMBinding]. {@macro pulumi_kms_crypto_key_iambinding_crypto_key_iambinding_args_doc}
  ...
  CryptoKeyIAMBinding(
    ...
    condition = registerOutput<CryptoKeyIAMBindingCondition?>(
      'condition',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return CryptoKeyIAMBindingCondition.fromMap(
  ...
  /// Gets an existing [CryptoKeyIAMBinding] resource's state with the given [name] and [id].
  static CryptoKeyIAMBinding get(
    String name,
