...
class CryptoKeyState {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'primaries':
          ?pulumi.Input.mapOptionalInputValue<
            List<CryptoKeyPrimary>,
            List<Map<String, dynamic>>
          >(
            primaries,
            (value) =>
                pulumi.Input.encodeList<CryptoKeyPrimary, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory CryptoKeyState.fromMap(Map<String, dynamic> map) {
    return CryptoKeyState(
      ...
      keyAccessJustificationsPolicy: (() {
        final guardedValue = map['keyAccessJustificationsPolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      primaries: (() {
        final guardedValue = map['primaries'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<CryptoKeyPrimary>(
            guardedValue,
            (value) => CryptoKeyPrimary.fromMap(
