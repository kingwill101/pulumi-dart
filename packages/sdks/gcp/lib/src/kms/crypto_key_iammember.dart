...
import 'crypto_key_iammember_state.dart';
...
class CryptoKeyIAMMember extends pulumi.CustomResource {
  ...
  /// Creates a new [CryptoKeyIAMMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [CryptoKeyIAMMember]. {@macro pulumi_kms_crypto_key_iammember_crypto_key_iammember_args_doc}
  ...
  /// Gets an existing [CryptoKeyIAMMember] resource's state with the given [name] and [id].
  static CryptoKeyIAMMember get(
    String name,
