...
import 'ekm_connection_iam_policy_state.dart';
...
class EkmConnectionIamPolicy extends pulumi.CustomResource {
  ...
  /// Gets an existing [EkmConnectionIamPolicy] resource's state with the given [name] and [id].
  static EkmConnectionIamPolicy get(
    String name,
