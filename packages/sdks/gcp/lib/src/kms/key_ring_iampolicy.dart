...
import 'key_ring_iampolicy_state.dart';
...
class KeyRingIAMPolicy extends pulumi.CustomResource {
  ...
  /// Creates a new [KeyRingIAMPolicy].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [KeyRingIAMPolicy]. {@macro pulumi_kms_key_ring_iampolicy_key_ring_iampolicy_args_doc}
  ...
  /// Gets an existing [KeyRingIAMPolicy] resource's state with the given [name] and [id].
  static KeyRingIAMPolicy get(
    String name,
