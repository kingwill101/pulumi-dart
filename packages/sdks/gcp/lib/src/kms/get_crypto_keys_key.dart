...
class GetCryptoKeysKey {
  ...
  factory GetCryptoKeysKey.fromMap(Map<String, dynamic> map) {
    return GetCryptoKeysKey(
      cryptoKeyBackend: (map['cryptoKeyBackend'] as String).input(),
      destroyScheduledDuration: (map['destroyScheduledDuration'] as String).input(),
      effectiveLabels: ((map['effectiveLabels'] as Map).cast<String, String>()).input(),
      id: (map['id'] as String).input(),
      importOnly: (map['importOnly'] as bool).input(),
      keyAccessJustificationsPolicies: (pulumi.Input.decodeList<GetCryptoKeysKeyKeyAccessJustificationsPolicy>(map['keyAccessJustificationsPolicies'], (value) => GetCryptoKeysKeyKeyAccessJustificationsPolicy.fromMap((value as Map).cast<String, dynamic>()))).input(),
      keyRing: map['keyRing'] == null ? null : (map['keyRing'] as String).input(),
      labels: ((map['labels'] as Map).cast<String, String>()).input(),
      name: map['name'] == null ? null : (map['name'] as String).input(),
      primaries: (pulumi.Input.decodeList<GetCryptoKeysKeyPrimary>(map['primaries'], (value) => GetCryptoKeysKeyPrimary.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      skipInitialVersionCreation: (map['skipInitialVersionCreation'] as bool).input(),
      versionTemplates: (pulumi.Input.decodeList<GetCryptoKeysKeyVersionTemplate>(map['versionTemplates'], (value) => GetCryptoKeysKeyVersionTemplate.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
