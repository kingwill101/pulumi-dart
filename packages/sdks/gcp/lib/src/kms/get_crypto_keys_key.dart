...
class GetCryptoKeysKey {
  ...
  final pulumi.Input<List<GetCryptoKeysKeyKeyAccessJustificationsPolicy>>
    ...
    return <String, dynamic>{
      ...
      'keyAccessJustificationsPolicies':
          pulumi.Input.mapInputValue<
            List<GetCryptoKeysKeyKeyAccessJustificationsPolicy>,
      ...
      'versionTemplates':
          pulumi.Input.mapInputValue<
            List<GetCryptoKeysKeyVersionTemplate>,
            List<Map<String, dynamic>>
          >(
            versionTemplates,
            (value) =>
  ...
  factory GetCryptoKeysKey.fromMap(Map<String, dynamic> map) {
    return GetCryptoKeysKey(
      cryptoKeyBackend: pulumi.Input.fromValue(
        map['cryptoKeyBackend'] as String,
      ),
      destroyScheduledDuration: pulumi.Input.fromValue(
      ...
      keyAccessJustificationsPolicies: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetCryptoKeysKeyKeyAccessJustificationsPolicy>(
      ...
      primaries: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetCryptoKeysKeyPrimary>(
          map['primaries']!,
      ...
      skipInitialVersionCreation: pulumi.Input.fromValue(
        map['skipInitialVersionCreation'] as bool,
      ),
      versionTemplates: pulumi.Input.fromValue(
