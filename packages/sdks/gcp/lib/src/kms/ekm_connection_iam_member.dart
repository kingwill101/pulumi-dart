...
import 'ekm_connection_iam_member_state.dart';
...
class EkmConnectionIamMember extends pulumi.CustomResource {
  ...
  EkmConnectionIamMember(
    ...
    condition = registerOutput<EkmConnectionIamMemberCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return EkmConnectionIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [EkmConnectionIamMember] resource's state with the given [name] and [id].
  static EkmConnectionIamMember get(
    String name,
    pulumi.Input<String> id, {
    EkmConnectionIamMemberState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return EkmConnectionIamMember._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [EkmConnectionIamMember] resource.
  EkmConnectionIamMember.reference(String urn)
    : super(
        'gcp:kms/ekmConnectionIamMember:EkmConnectionIamMember',
