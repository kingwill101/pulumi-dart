...
class EkmConnectionServiceResolver {
  ...
  final pulumi.Input<List<EkmConnectionServiceResolverServerCertificate>> serverCertificates;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'hostname': hostname,
      'serverCertificates': pulumi.Input.mapInputValue<List<EkmConnectionServiceResolverServerCertificate>, List<Map<String, dynamic>>>(serverCertificates, (value) => pulumi.Input.encodeList<EkmConnectionServiceResolverServerCertificate, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory EkmConnectionServiceResolver.fromMap(Map<String, dynamic> map) {
    return EkmConnectionServiceResolver(
      ...
      serverCertificates: pulumi.Input.fromValue(pulumi.Input.decodeList<EkmConnectionServiceResolverServerCertificate>(map['serverCertificates']!, (value) => EkmConnectionServiceResolverServerCertificate.fromMap((value as Map).cast<String, dynamic>()))),
