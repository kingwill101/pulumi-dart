...
class KeyRingIAMBindingState {
  ...
  factory KeyRingIAMBindingState.fromMap(Map<String, dynamic> map) {
    return KeyRingIAMBindingState(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(KeyRingIAMBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
