...
class EkmConnectionState {
  ...
  factory EkmConnectionState.fromMap(Map<String, dynamic> map) {
    return EkmConnectionState(
      ...
      serviceResolvers: (() { final guardedValue = map['serviceResolvers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<EkmConnectionServiceResolver>(guardedValue, (value) => EkmConnectionServiceResolver.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
