...
class EkmConnectionIamMemberArgs {
  ...
  const EkmConnectionIamMemberArgs({
    this.condition,
    this.location,
  ...
  factory EkmConnectionIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return EkmConnectionIamMemberArgs(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EkmConnectionIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
