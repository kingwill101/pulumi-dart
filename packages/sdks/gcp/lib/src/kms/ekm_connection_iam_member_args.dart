...
class EkmConnectionIamMemberArgs {
  ...
  EkmConnectionIamMemberArgs({
    pulumi.Output<EkmConnectionIamMemberCondition>? condition,
    ...
    required pulumi.Output<String> role,
      ...
      condition = pulumi.Input.asOptionalInput<EkmConnectionIamMemberCondition>(condition),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'condition': ?pulumi.Input.mapOptionalInputValue<EkmConnectionIamMemberCondition, Map<String, dynamic>>(condition, (value) => value.toMap()),
      'location': ?location,
      'member': member,
      'name': ?name,
      'project': ?project,
  ...
  factory EkmConnectionIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return EkmConnectionIamMemberArgs(
      condition: map['condition'] == null ? null : pulumi.Output.create<EkmConnectionIamMemberCondition>(EkmConnectionIamMemberCondition.fromMap((map['condition'] as Map).cast<String, dynamic>())),
