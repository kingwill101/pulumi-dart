...
class CryptoKey extends pulumi.CustomResource {
  ...
  CryptoKey(
    ...
    this.destroyScheduledDuration = registerOutput<String>('destroyScheduledDuration');
    this.effectiveLabels = registerOutput<Map<String, String>>('effectiveLabels');
    this.importOnly = registerOutput<bool>('importOnly');
    this.keyAccessJustificationsPolicy = registerOutput<CryptoKeyKeyAccessJustificationsPolicy>('keyAccessJustificationsPolicy');
    ...
    this.skipInitialVersionCreation = registerOutput<bool?>('skipInitialVersionCreation');
    this.versionTemplate = registerOutput<CryptoKeyVersionTemplate>('versionTemplate');
  }
