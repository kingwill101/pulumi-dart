...
class FeedDetailsCloudPassageSettingsAuthentication {
  ...
  /// Creates a new [FeedDetailsCloudPassageSettingsAuthentication].
  ...
  const FeedDetailsCloudPassageSettingsAuthentication({
    this.secret,
    this.user,
  });
  ...
  factory FeedDetailsCloudPassageSettingsAuthentication.fromMap(Map<String, dynamic> map) {
    return FeedDetailsCloudPassageSettingsAuthentication(
