    ...
    return <String, dynamic>{
      ...
      'compilationDiagnostics':
          ?pulumi.Input.mapOptionalInputValue<
            List<RuleCompilationDiagnostic>,
      ...
      'severities':
          ...
          >(
            severities,
            (value) =>
                pulumi.Input.encodeList<RuleSeverity, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory RuleState.fromMap(Map<String, dynamic> map) {
    return RuleState(
      allowedRunFrequencies: (() {
        final guardedValue = map['allowedRunFrequencies'];
      ...
      compilationDiagnostics: (() {
        final guardedValue = map['compilationDiagnostics'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RuleCompilationDiagnostic>(
            guardedValue,
            (value) => RuleCompilationDiagnostic.fromMap(
      ...
      compilationState: (() {
        final guardedValue = map['compilationState'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      createTime: (() {
      ...
      dataTables: (() {
        final guardedValue = map['dataTables'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      deletionPolicy: (() {
      ...
      nearRealTimeLiveRuleEligible: (() {
        final guardedValue = map['nearRealTimeLiveRuleEligible'];
        if (guardedValue == null) return null;
      ...
      referenceLists: (() {
        final guardedValue = map['referenceLists'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      revisionCreateTime: (() {
      ...
      severities: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RuleSeverity>(
            guardedValue,
            (value) =>
                RuleSeverity.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      text: (() {
