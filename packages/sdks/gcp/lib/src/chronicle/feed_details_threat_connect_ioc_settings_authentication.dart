...
class FeedDetailsThreatConnectIocSettingsAuthentication {
  ...
  /// Creates a new [FeedDetailsThreatConnectIocSettingsAuthentication].
  ...
  const FeedDetailsThreatConnectIocSettingsAuthentication({
    this.secret,
    this.user,
  });
  ...
  factory FeedDetailsThreatConnectIocSettingsAuthentication.fromMap(Map<String, dynamic> map) {
    return FeedDetailsThreatConnectIocSettingsAuthentication(
