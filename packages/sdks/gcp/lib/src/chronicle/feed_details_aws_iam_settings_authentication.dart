...
class FeedDetailsAwsIamSettingsAuthentication {
  ...
  /// Creates a new [FeedDetailsAwsIamSettingsAuthentication].
  ...
  const FeedDetailsAwsIamSettingsAuthentication({
    this.secret,
    this.user,
  });
  ...
  factory FeedDetailsAwsIamSettingsAuthentication.fromMap(Map<String, dynamic> map) {
    return FeedDetailsAwsIamSettingsAuthentication(
