...
class RetrohuntState {
    ...
    return <String, dynamic>{
      ...
      'executionIntervals':
          ?pulumi.Input.mapOptionalInputValue<
            List<RetrohuntExecutionInterval>,
  ...
  factory RetrohuntState.fromMap(Map<String, dynamic> map) {
    return RetrohuntState(
      retrohuntId: (() {
        final guardedValue = map['RetrohuntId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      executionIntervals: (() {
        final guardedValue = map['executionIntervals'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RetrohuntExecutionInterval>(
            guardedValue,
            (value) => RetrohuntExecutionInterval.fromMap(
      ...
      processInterval: (() {
        final guardedValue = map['processInterval'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RetrohuntProcessInterval.fromMap(
