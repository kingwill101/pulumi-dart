...
class FeedDetailsAnomaliSettingsAuthentication {
  ...
  /// Creates a new [FeedDetailsAnomaliSettingsAuthentication].
  ...
  const FeedDetailsAnomaliSettingsAuthentication({
    this.secret,
    this.user,
  });
  ...
  factory FeedDetailsAnomaliSettingsAuthentication.fromMap(Map<String, dynamic> map) {
    return FeedDetailsAnomaliSettingsAuthentication(
