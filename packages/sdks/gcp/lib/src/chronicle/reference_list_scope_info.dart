...
class ReferenceListScopeInfo {
  ...
  factory ReferenceListScopeInfo.fromMap(Map<String, dynamic> map) {
    return ReferenceListScopeInfo(
      referenceListScope: (() { final guardedValue = map['referenceListScope']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ReferenceListScopeInfoReferenceListScope.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
