...
class FeedDetailsSalesforceSettingsOauthJwtCredentialsClaims {
  /// Audience.
  ...
  /// Creates a new [FeedDetailsSalesforceSettingsOauthJwtCredentialsClaims].
  /// [audience] Audience.
  /// [issuer] Issuer. Usually the client_id.
  /// [subject] Subject. Usually the email.
  const FeedDetailsSalesforceSettingsOauthJwtCredentialsClaims({
    this.audience,
    this.issuer,
    this.subject,
  });
  ...
  factory FeedDetailsSalesforceSettingsOauthJwtCredentialsClaims.fromMap(Map<String, dynamic> map) {
    return FeedDetailsSalesforceSettingsOauthJwtCredentialsClaims(
