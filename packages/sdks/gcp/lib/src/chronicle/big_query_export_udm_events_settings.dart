...
class BigQueryExportUdmEventsSettings {
  /// (Output)
  ...
  /// Creates a new [BigQueryExportUdmEventsSettings].
  ...
  const BigQueryExportUdmEventsSettings({
  ...
  factory BigQueryExportUdmEventsSettings.fromMap(Map<String, dynamic> map) {
    return BigQueryExportUdmEventsSettings(
