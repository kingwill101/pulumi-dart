...
class BigQueryExportIocMatchesSettings {
  /// (Output)
  ...
  /// Creates a new [BigQueryExportIocMatchesSettings].
  ...
  const BigQueryExportIocMatchesSettings({
  ...
  factory BigQueryExportIocMatchesSettings.fromMap(Map<String, dynamic> map) {
    return BigQueryExportIocMatchesSettings(
