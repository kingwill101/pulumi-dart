...
class FeedDetailsDuoUserContextSettingsAuthentication {
  ...
  /// Creates a new [FeedDetailsDuoUserContextSettingsAuthentication].
  ...
  const FeedDetailsDuoUserContextSettingsAuthentication({
    this.secret,
    this.user,
  });
  ...
  factory FeedDetailsDuoUserContextSettingsAuthentication.fromMap(Map<String, dynamic> map) {
    return FeedDetailsDuoUserContextSettingsAuthentication(
