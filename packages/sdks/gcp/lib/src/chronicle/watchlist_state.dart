...
class WatchlistState {
  ...
  factory WatchlistState.fromMap(Map<String, dynamic> map) {
    return WatchlistState(
      ...
      entityCounts: (() {
        final guardedValue = map['entityCounts'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<WatchlistEntityCount>(
            guardedValue,
            (value) => WatchlistEntityCount.fromMap(
      ...
      entityPopulationMechanism: (() {
        final guardedValue = map['entityPopulationMechanism'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          WatchlistEntityPopulationMechanism.fromMap(
      ...
      multiplyingFactor: (() {
        final guardedValue = map['multiplyingFactor'];
        if (guardedValue == null) return null;
      ...
      watchlistUserPreferences: (() {
        final guardedValue = map['watchlistUserPreferences'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
