...
class FeedDetailsWorkspaceGroupsSettingsAuthenticationClaims {
  /// Audience.
  ...
  /// Creates a new [FeedDetailsWorkspaceGroupsSettingsAuthenticationClaims].
  /// [audience] Audience.
  /// [issuer] Issuer. Usually the client_id.
  /// [subject] Subject. Usually the email.
  const FeedDetailsWorkspaceGroupsSettingsAuthenticationClaims({
    this.audience,
    this.issuer,
    this.subject,
  });
  ...
  factory FeedDetailsWorkspaceGroupsSettingsAuthenticationClaims.fromMap(Map<String, dynamic> map) {
    return FeedDetailsWorkspaceGroupsSettingsAuthenticationClaims(
