...
class FeedDetailsAwsEc2HostsSettingsAuthentication {
  ...
  /// Creates a new [FeedDetailsAwsEc2HostsSettingsAuthentication].
  ...
  const FeedDetailsAwsEc2HostsSettingsAuthentication({
    this.secret,
    this.user,
  });
  ...
  factory FeedDetailsAwsEc2HostsSettingsAuthentication.fromMap(Map<String, dynamic> map) {
    return FeedDetailsAwsEc2HostsSettingsAuthentication(
