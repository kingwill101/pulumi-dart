...
class FeedDetailsWorkspacePrivilegesSettingsAuthenticationClaims {
  ...
  const FeedDetailsWorkspacePrivilegesSettingsAuthenticationClaims({
    this.audience,
    this.issuer,
    this.subject,
  });
  ...
  factory FeedDetailsWorkspacePrivilegesSettingsAuthenticationClaims.fromMap(Map<String, dynamic> map) {
    return FeedDetailsWorkspacePrivilegesSettingsAuthenticationClaims(
