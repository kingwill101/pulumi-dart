...
class ParserExtensionFieldExtractorsExtractor {
  ...
  /// Creates a new [ParserExtensionFieldExtractorsExtractor].
  ...
  const ParserExtensionFieldExtractorsExtractor({
  ...
  factory ParserExtensionFieldExtractorsExtractor.fromMap(Map<String, dynamic> map) {
    return ParserExtensionFieldExtractorsExtractor(
