...
class DataAccessScope extends pulumi.CustomResource {
  ...
  DataAccessScope(
    ...
    allowedDataAccessLabels = registerOutput<List<Map<String, dynamic>>?>(
      'allowedDataAccessLabels',
    );
    author = registerOutput<String>('author');
    createTime = registerOutput<String>('createTime');
    dataAccessScopeId = registerOutput<String>('dataAccessScopeId');
    deniedDataAccessLabels = registerOutput<List<Map<String, dynamic>>?>(
      'deniedDataAccessLabels',
    );
  ...
  /// Gets an existing [DataAccessScope] resource's state with the given [name] and [id].
  static DataAccessScope get(
    String name,
