...
class FeedDetailsTrellixHxHostsSettingsAuthenticationMsso {
  ...
  /// Creates a new [FeedDetailsTrellixHxHostsSettingsAuthenticationMsso].
  ...
  const FeedDetailsTrellixHxHostsSettingsAuthenticationMsso({
  ...
  factory FeedDetailsTrellixHxHostsSettingsAuthenticationMsso.fromMap(Map<String, dynamic> map) {
    return FeedDetailsTrellixHxHostsSettingsAuthenticationMsso(
