...
class FeedDetailsAwsEc2InstancesSettingsAuthentication {
  ...
  /// Creates a new [FeedDetailsAwsEc2InstancesSettingsAuthentication].
  ...
  const FeedDetailsAwsEc2InstancesSettingsAuthentication({
    this.secret,
    this.user,
  });
  ...
  factory FeedDetailsAwsEc2InstancesSettingsAuthentication.fromMap(Map<String, dynamic> map) {
    return FeedDetailsAwsEc2InstancesSettingsAuthentication(
