...
class FeedDetailsQualysVmSettingsAuthentication {
  ...
  /// Creates a new [FeedDetailsQualysVmSettingsAuthentication].
  ...
  const FeedDetailsQualysVmSettingsAuthentication({
    this.secret,
    this.user,
  });
  ...
  factory FeedDetailsQualysVmSettingsAuthentication.fromMap(Map<String, dynamic> map) {
    return FeedDetailsQualysVmSettingsAuthentication(
