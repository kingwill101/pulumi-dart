...
class RuleDeploymentState {
  ...
  factory RuleDeploymentState.fromMap(Map<String, dynamic> map) {
    return RuleDeploymentState(
      ...
      archiveTime: (() {
        final guardedValue = map['archiveTime'];
        if (guardedValue == null) return null;
      ...
      consumerRules: (() {
        final guardedValue = map['consumerRules'];
        if (guardedValue == null) return null;
      ...
      lastAlertStatusChangeTime: (() {
        final guardedValue = map['lastAlertStatusChangeTime'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      location: (() {
      ...
      producerRules: (() {
        final guardedValue = map['producerRules'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      project: (() {
