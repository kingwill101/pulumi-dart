...
class FeedDetailsThreatConnectIocV3SettingsAuthentication {
  ...
  /// Creates a new [FeedDetailsThreatConnectIocV3SettingsAuthentication].
  ...
  const FeedDetailsThreatConnectIocV3SettingsAuthentication({
    this.secret,
    this.user,
  });
  ...
  factory FeedDetailsThreatConnectIocV3SettingsAuthentication.fromMap(Map<String, dynamic> map) {
    return FeedDetailsThreatConnectIocV3SettingsAuthentication(
