...
class FeedDetailsProofpointMailSettingsAuthentication {
  ...
  const FeedDetailsProofpointMailSettingsAuthentication({
    this.secret,
    this.user,
  });
  ...
  factory FeedDetailsProofpointMailSettingsAuthentication.fromMap(Map<String, dynamic> map) {
    return FeedDetailsProofpointMailSettingsAuthentication(
