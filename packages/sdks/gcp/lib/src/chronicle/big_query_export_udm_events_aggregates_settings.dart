...
class BigQueryExportUdmEventsAggregatesSettings {
  /// (Output)
  ...
  /// Creates a new [BigQueryExportUdmEventsAggregatesSettings].
  ...
  const BigQueryExportUdmEventsAggregatesSettings({
  ...
  factory BigQueryExportUdmEventsAggregatesSettings.fromMap(Map<String, dynamic> map) {
    return BigQueryExportUdmEventsAggregatesSettings(
