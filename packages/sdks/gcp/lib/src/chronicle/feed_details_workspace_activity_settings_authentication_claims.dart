...
class FeedDetailsWorkspaceActivitySettingsAuthenticationClaims {
  /// Audience.
  ...
  /// Creates a new [FeedDetailsWorkspaceActivitySettingsAuthenticationClaims].
  /// [audience] Audience.
  /// [issuer] Issuer. Usually the client_id.
  /// [subject] Subject. Usually the email.
  const FeedDetailsWorkspaceActivitySettingsAuthenticationClaims({
    this.audience,
    this.issuer,
    this.subject,
  });
  ...
  factory FeedDetailsWorkspaceActivitySettingsAuthenticationClaims.fromMap(Map<String, dynamic> map) {
    return FeedDetailsWorkspaceActivitySettingsAuthenticationClaims(
