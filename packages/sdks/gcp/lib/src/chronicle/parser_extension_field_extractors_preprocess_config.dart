...
class ParserExtensionFieldExtractorsPreprocessConfig {
  ...
  /// Creates a new [ParserExtensionFieldExtractorsPreprocessConfig].
  ...
  const ParserExtensionFieldExtractorsPreprocessConfig({
    this.grokRegex,
    this.target,
  });
  ...
  factory ParserExtensionFieldExtractorsPreprocessConfig.fromMap(Map<String, dynamic> map) {
    return ParserExtensionFieldExtractorsPreprocessConfig(
