...
class FeedDetailsFoxItStixSettingsAuthentication {
  ...
  /// Creates a new [FeedDetailsFoxItStixSettingsAuthentication].
  ...
  const FeedDetailsFoxItStixSettingsAuthentication({
    this.secret,
    this.user,
  });
  ...
  factory FeedDetailsFoxItStixSettingsAuthentication.fromMap(Map<String, dynamic> map) {
    return FeedDetailsFoxItStixSettingsAuthentication(
