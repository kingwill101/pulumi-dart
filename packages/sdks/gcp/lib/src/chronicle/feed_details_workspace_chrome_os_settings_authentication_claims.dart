...
class FeedDetailsWorkspaceChromeOsSettingsAuthenticationClaims {
  /// Audience.
  ...
  /// Creates a new [FeedDetailsWorkspaceChromeOsSettingsAuthenticationClaims].
  /// [audience] Audience.
  /// [issuer] Issuer. Usually the client_id.
  /// [subject] Subject. Usually the email.
  const FeedDetailsWorkspaceChromeOsSettingsAuthenticationClaims({
    this.audience,
    this.issuer,
    this.subject,
  });
  ...
  factory FeedDetailsWorkspaceChromeOsSettingsAuthenticationClaims.fromMap(Map<String, dynamic> map) {
    return FeedDetailsWorkspaceChromeOsSettingsAuthenticationClaims(
