...
class BigQueryExportEntityGraphSettings {
  /// (Output)
  ...
  /// Creates a new [BigQueryExportEntityGraphSettings].
  ...
  const BigQueryExportEntityGraphSettings({
  ...
  factory BigQueryExportEntityGraphSettings.fromMap(Map<String, dynamic> map) {
    return BigQueryExportEntityGraphSettings(
