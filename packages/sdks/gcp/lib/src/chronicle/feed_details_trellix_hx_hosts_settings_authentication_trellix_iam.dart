...
class FeedDetailsTrellixHxHostsSettingsAuthenticationTrellixIam {
  ...
  /// Creates a new [FeedDetailsTrellixHxHostsSettingsAuthenticationTrellixIam].
  ...
  const FeedDetailsTrellixHxHostsSettingsAuthenticationTrellixIam({
  ...
  factory FeedDetailsTrellixHxHostsSettingsAuthenticationTrellixIam.fromMap(Map<String, dynamic> map) {
    return FeedDetailsTrellixHxHostsSettingsAuthenticationTrellixIam(
