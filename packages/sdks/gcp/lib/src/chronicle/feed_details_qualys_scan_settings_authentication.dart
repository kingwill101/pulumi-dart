...
class FeedDetailsQualysScanSettingsAuthentication {
  ...
  /// Creates a new [FeedDetailsQualysScanSettingsAuthentication].
  ...
  const FeedDetailsQualysScanSettingsAuthentication({
    this.secret,
    this.user,
  });
  ...
  factory FeedDetailsQualysScanSettingsAuthentication.fromMap(Map<String, dynamic> map) {
    return FeedDetailsQualysScanSettingsAuthentication(
