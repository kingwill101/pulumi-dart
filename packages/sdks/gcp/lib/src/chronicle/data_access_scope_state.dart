...
class DataAccessScopeState {
  ...
  factory DataAccessScopeState.fromMap(Map<String, dynamic> map) {
    return DataAccessScopeState(
      ...
      dataAccessScopeId: (() { final guardedValue = map['dataAccessScopeId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
