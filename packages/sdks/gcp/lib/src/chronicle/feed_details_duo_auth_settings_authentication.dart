...
class FeedDetailsDuoAuthSettingsAuthentication {
  ...
  /// Creates a new [FeedDetailsDuoAuthSettingsAuthentication].
  ...
  const FeedDetailsDuoAuthSettingsAuthentication({
    this.secret,
    this.user,
  });
  ...
  factory FeedDetailsDuoAuthSettingsAuthentication.fromMap(Map<String, dynamic> map) {
    return FeedDetailsDuoAuthSettingsAuthentication(
