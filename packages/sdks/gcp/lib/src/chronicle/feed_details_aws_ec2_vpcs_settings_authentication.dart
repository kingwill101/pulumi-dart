...
class FeedDetailsAwsEc2VpcsSettingsAuthentication {
  ...
  /// Creates a new [FeedDetailsAwsEc2VpcsSettingsAuthentication].
  ...
  const FeedDetailsAwsEc2VpcsSettingsAuthentication({
    this.secret,
    this.user,
  });
  ...
  factory FeedDetailsAwsEc2VpcsSettingsAuthentication.fromMap(Map<String, dynamic> map) {
    return FeedDetailsAwsEc2VpcsSettingsAuthentication(
