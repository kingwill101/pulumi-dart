...
class BackupPolicyState {
  ...
  factory BackupPolicyState.fromMap(Map<String, dynamic> map) {
    return BackupPolicyState(
      assignedVolumeCount: (() {
        final guardedValue = map['assignedVolumeCount'];
      ...
      dailyBackupLimit: (() {
        final guardedValue = map['dailyBackupLimit'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      description: (() {
      ...
      monthlyBackupLimit: (() {
        final guardedValue = map['monthlyBackupLimit'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      name: (() {
      ...
      weeklyBackupLimit: (() {
        final guardedValue = map['weeklyBackupLimit'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
    );
