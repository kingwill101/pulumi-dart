...
class VolumeReplicationDestinationVolumeParameters {
  ...
  factory VolumeReplicationDestinationVolumeParameters.fromMap(Map<String, dynamic> map) {
    return VolumeReplicationDestinationVolumeParameters(
      ...
      tieringPolicy: (() { final guardedValue = map['tieringPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VolumeReplicationDestinationVolumeParametersTieringPolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
