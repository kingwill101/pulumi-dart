...
class AuthorizedViewSubsetView {
  ...
  AuthorizedViewSubsetView({this.familySubsets, this.rowPrefixes});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'familySubsets':
          ?pulumi.Input.mapOptionalInputValue<
            List<AuthorizedViewSubsetViewFamilySubset>,
  ...
  factory AuthorizedViewSubsetView.fromMap(Map<String, dynamic> map) {
    return AuthorizedViewSubsetView(
      familySubsets: (() {
        final guardedValue = map['familySubsets'];
      ...
      rowPrefixes: (() {
        final guardedValue = map['rowPrefixes'];
        if (guardedValue == null) return null;
