...
import 'table_iam_policy_state.dart';
...
class TableIamPolicy extends pulumi.CustomResource {
  ...
  /// Gets an existing [TableIamPolicy] resource's state with the given [name] and [id].
  static TableIamPolicy get(
    String name,
    pulumi.Input<String> id, {
    TableIamPolicyState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return TableIamPolicy._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [TableIamPolicy] resource.
  TableIamPolicy.reference(String urn)
    : super(
        'gcp:bigtable/tableIamPolicy:TableIamPolicy',
