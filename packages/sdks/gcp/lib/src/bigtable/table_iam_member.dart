...
import 'table_iam_member_state.dart';
...
class TableIamMember extends pulumi.CustomResource {
  ...
  TableIamMember(
    ...
    condition = registerOutput<TableIamMemberCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return TableIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  static TableIamMember get(
    String name,
    pulumi.Input<String> id, {
    TableIamMemberState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return TableIamMember._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [TableIamMember] resource.
  TableIamMember.reference(String urn)
    : super(
        'gcp:bigtable/tableIamMember:TableIamMember',
