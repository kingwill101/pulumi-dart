...
class AuthorizedViewSubsetViewFamilySubset {
  ...
  factory AuthorizedViewSubsetViewFamilySubset.fromMap(Map<String, dynamic> map) {
    return AuthorizedViewSubsetViewFamilySubset(
      ...
      qualifierPrefixes: map['qualifierPrefixes'] == null ? null : (map['qualifierPrefixes'] as List).cast<String>(),
      qualifiers: map['qualifiers'] == null ? null : (map['qualifiers'] as List).cast<String>(),
    );
  }
}
