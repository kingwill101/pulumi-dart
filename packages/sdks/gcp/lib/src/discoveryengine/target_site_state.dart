...
class TargetSiteState {
  ...
  /// Structure is documented below.
  final pulumi.Input<List<TargetSiteSiteVerificationInfo>>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'siteVerificationInfos':
          ?pulumi.Input.mapOptionalInputValue<
            List<TargetSiteSiteVerificationInfo>,
            List<Map<String, dynamic>>
          >(
            siteVerificationInfos,
            (value) =>
  ...
  factory TargetSiteState.fromMap(Map<String, dynamic> map) {
    return TargetSiteState(
      ...
      failureReasons: (() {
        final guardedValue = map['failureReasons'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<TargetSiteFailureReason>(
            guardedValue,
            (value) => TargetSiteFailureReason.fromMap(
      ...
      generatedUriPattern: (() {
        final guardedValue = map['generatedUriPattern'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      indexingStatus: (() {
        final guardedValue = map['indexingStatus'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      location: (() {
      ...
      providedUriPattern: (() {
        final guardedValue = map['providedUriPattern'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      rootDomainUri: (() {
        final guardedValue = map['rootDomainUri'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      siteVerificationInfos: (() {
        final guardedValue = map['siteVerificationInfos'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<TargetSiteSiteVerificationInfo>(
            guardedValue,
            (value) => TargetSiteSiteVerificationInfo.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      targetSiteId: (() {
        final guardedValue = map['targetSiteId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      type: (() {
