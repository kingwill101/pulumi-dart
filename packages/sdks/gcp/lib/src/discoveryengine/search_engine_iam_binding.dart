...
import 'search_engine_iam_binding_args.dart';
import 'search_engine_iam_binding_condition.dart';
import 'search_engine_iam_binding_state.dart';
...
class SearchEngineIamBinding extends pulumi.CustomResource {
  /// The collection ID.
  /// Used to find the parent resource to bind the IAM policy to
  late final pulumi.Output<String> collectionId;
  late final pulumi.Output<SearchEngineIamBindingCondition?> condition;
  /// Used to find the parent resource to bind the IAM policy to
  ...
  /// Creates a new [SearchEngineIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [SearchEngineIamBinding]. {@macro pulumi_discoveryengine_search_engine_iam_binding_search_engine_iam_binding_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  SearchEngineIamBinding(
    String name, {
    SearchEngineIamBindingArgs? args,
  ...
  /// Gets an existing [SearchEngineIamBinding] resource's state with the given [name] and [id].
  static SearchEngineIamBinding get(
    String name,
