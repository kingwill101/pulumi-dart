...
class DataConnectorEntity {
  ...
  factory DataConnectorEntity.fromMap(Map<String, dynamic> map) {
    return DataConnectorEntity(
      ...
      keyPropertyMappings: (() { final guardedValue = map['keyPropertyMappings']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
