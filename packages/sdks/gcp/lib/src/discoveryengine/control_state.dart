...
class ControlState {
  ...
  ControlState({
    ...
    pulumi.Output<String>? solutionType,
    ...
    pulumi.Output<List<String>>? useCases,
      ...
      solutionType = pulumi.Input.asOptionalInput<String>(solutionType),
  ...
  factory ControlState.fromMap(Map<String, dynamic> map) {
    return ControlState(
      ...
      solutionType: map['solutionType'] == null ? null : pulumi.Output.create<String>(map['solutionType'] as String),
