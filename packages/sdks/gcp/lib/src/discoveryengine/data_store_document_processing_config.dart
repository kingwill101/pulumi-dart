...
class DataStoreDocumentProcessingConfig {
  ...
  final pulumi.Input<DataStoreDocumentProcessingConfigChunkingConfig>?
  chunkingConfig;
  ...
  /// Structure is documented below.
  final pulumi.Input<DataStoreDocumentProcessingConfigDefaultParsingConfig>?
  ...
  final pulumi.Input<
    List<DataStoreDocumentProcessingConfigParsingConfigOverride>
  >?
    ...
    return <String, dynamic>{
      'chunkingConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(chunkingConfig, (value) => value.toMap()),
      'defaultParsingConfig':
          ?pulumi.Input.mapOptionalInputValue<
            DataStoreDocumentProcessingConfigDefaultParsingConfig,
            Map<String, dynamic>
          >(defaultParsingConfig, (value) => value.toMap()),
      'name': ?name,
      'parsingConfigOverrides':
          ?pulumi.Input.mapOptionalInputValue<
            List<DataStoreDocumentProcessingConfigParsingConfigOverride>,
  ...
  factory DataStoreDocumentProcessingConfig.fromMap(Map<String, dynamic> map) {
    return DataStoreDocumentProcessingConfig(
      chunkingConfig: (() {
        final guardedValue = map['chunkingConfig'];
      ...
      defaultParsingConfig: (() {
        final guardedValue = map['defaultParsingConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      parsingConfigOverrides: (() {
        final guardedValue = map['parsingConfigOverrides'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                DataStoreDocumentProcessingConfigParsingConfigOverride.fromMap(
