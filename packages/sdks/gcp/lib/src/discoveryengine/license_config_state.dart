...
class LicenseConfigState {
  ...
  factory LicenseConfigState.fromMap(Map<String, dynamic> map) {
    return LicenseConfigState(
      ...
      licenseConfigId: (() {
        final guardedValue = map['licenseConfigId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      licenseCount: (() {
        final guardedValue = map['licenseCount'];
        if (guardedValue == null) return null;
      ...
      startDate: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          LicenseConfigStartDate.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      subscriptionTerm: (() {
        final guardedValue = map['subscriptionTerm'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      subscriptionTier: (() {
        final guardedValue = map['subscriptionTier'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
