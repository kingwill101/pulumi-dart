...
class ControlCondition {
  ...
  factory ControlCondition.fromMap(Map<String, dynamic> map) {
    return ControlCondition(
      activeTimeRanges: (() { final guardedValue = map['activeTimeRanges']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ControlConditionActiveTimeRange>(guardedValue, (value) => ControlConditionActiveTimeRange.fromMap((value as Map).cast<String, dynamic>()))); })(),
      queryRegex: (() { final guardedValue = map['queryRegex']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      queryTerms: (() { final guardedValue = map['queryTerms']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ControlConditionQueryTerm>(guardedValue, (value) => ControlConditionQueryTerm.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
