...
class ControlBoostAction {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'interpolationBoostSpec': ?pulumi.Input.mapOptionalInputValue<ControlBoostActionInterpolationBoostSpec, Map<String, dynamic>>(interpolationBoostSpec, (value) => value.toMap()),
    };
  }
