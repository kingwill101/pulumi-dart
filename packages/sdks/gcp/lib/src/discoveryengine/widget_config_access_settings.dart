...
class WidgetConfigAccessSettings {
  ...
  factory WidgetConfigAccessSettings.fromMap(Map<String, dynamic> map) {
    return WidgetConfigAccessSettings(
      allowPublicAccess: map['allowPublicAccess'] == null ? null : map['allowPublicAccess'] as bool,
      allowlistedDomains: map['allowlistedDomains'] == null ? null : (map['allowlistedDomains'] as List).cast<String>(),
      enableWebApp: map['enableWebApp'] == null ? null : map['enableWebApp'] as bool,
      languageCode: map['languageCode'] == null ? null : map['languageCode'] as String,
      workforceIdentityPoolProvider: map['workforceIdentityPoolProvider'] == null ? null : map['workforceIdentityPoolProvider'] as String,
    );
  }
}
