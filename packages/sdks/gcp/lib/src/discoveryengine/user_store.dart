...
class UserStore extends pulumi.CustomResource {
  ...
  UserStore(
    ...
    enableExpiredLicenseAutoUpdate = registerOutput<bool?>(
      'enableExpiredLicenseAutoUpdate',
    );
    enableLicenseAutoRegister = registerOutput<bool?>(
  ...
  /// Gets an existing [UserStore] resource's state with the given [name] and [id].
