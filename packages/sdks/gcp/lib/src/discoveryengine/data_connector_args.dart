...
class DataConnectorArgs {
  ...
  DataConnectorArgs({
    ...
    required pulumi.Output<String> collectionDisplayName,
    ...
    required pulumi.Output<String> refreshInterval,
  ...
  factory DataConnectorArgs.fromMap(Map<String, dynamic> map) {
    return DataConnectorArgs(
      ...
      collectionDisplayName: pulumi.Output.create<String>(map['collectionDisplayName'] as String),
      ...
      refreshInterval: pulumi.Output.create<String>(map['refreshInterval'] as String),
