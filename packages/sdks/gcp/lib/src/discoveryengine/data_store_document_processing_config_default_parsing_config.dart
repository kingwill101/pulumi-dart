...
class DataStoreDocumentProcessingConfigDefaultParsingConfig {
  ...
  factory DataStoreDocumentProcessingConfigDefaultParsingConfig.fromMap(Map<String, dynamic> map) {
    return DataStoreDocumentProcessingConfigDefaultParsingConfig(
      ...
      layoutParsingConfig: (() { final guardedValue = map['layoutParsingConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DataStoreDocumentProcessingConfigDefaultParsingConfigLayoutParsingConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ocrParsingConfig: (() { final guardedValue = map['ocrParsingConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DataStoreDocumentProcessingConfigDefaultParsingConfigOcrParsingConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
