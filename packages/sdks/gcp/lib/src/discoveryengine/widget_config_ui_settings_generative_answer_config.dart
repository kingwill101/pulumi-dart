  ...
  factory WidgetConfigUiSettingsGenerativeAnswerConfig.fromMap(
    ...
    return WidgetConfigUiSettingsGenerativeAnswerConfig(
      disableRelatedQuestions: (() {
        final guardedValue = map['disableRelatedQuestions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      ignoreAdversarialQuery: (() {
        final guardedValue = map['ignoreAdversarialQuery'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      ignoreLowRelevantContent: (() {
        final guardedValue = map['ignoreLowRelevantContent'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      ignoreNonAnswerSeekingQuery: (() {
        final guardedValue = map['ignoreNonAnswerSeekingQuery'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      imageSource: (() {
        final guardedValue = map['imageSource'];
        if (guardedValue == null) return null;
      ...
      maxRephraseSteps: (() {
        final guardedValue = map['maxRephraseSteps'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      modelPromptPreamble: (() {
        final guardedValue = map['modelPromptPreamble'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      modelVersion: (() {
        final guardedValue = map['modelVersion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      resultCount: (() {
