...
class TargetSite extends pulumi.CustomResource {
  ...
  TargetSite(
    ...
    this.failureReasons = registerOutput<List<TargetSiteFailureReason>>('failureReasons');
    ...
    this.siteVerificationInfos = registerOutput<List<TargetSiteSiteVerificationInfo>>('siteVerificationInfos');
