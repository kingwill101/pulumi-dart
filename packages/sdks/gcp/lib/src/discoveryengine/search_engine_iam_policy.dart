...
import 'search_engine_iam_policy_args.dart';
import 'search_engine_iam_policy_state.dart';
...
class SearchEngineIamPolicy extends pulumi.CustomResource {
  /// The collection ID.
  ...
  /// Creates a new [SearchEngineIamPolicy].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [SearchEngineIamPolicy]. {@macro pulumi_discoveryengine_search_engine_iam_policy_search_engine_iam_policy_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  SearchEngineIamPolicy(
    String name, {
    SearchEngineIamPolicyArgs? args,
  ...
  /// Gets an existing [SearchEngineIamPolicy] resource's state with the given [name] and [id].
  static SearchEngineIamPolicy get(
    String name,
