...
class RecommendationEngineMediaRecommendationEngineConfig {
  ...
  final pulumi.Input<RecommendationEngineMediaRecommendationEngineConfigEngineFeaturesConfig>? engineFeaturesConfig;
  ...
  final pulumi.Input<String>? trainingState;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'engineFeaturesConfig': ?pulumi.Input.mapOptionalInputValue<RecommendationEngineMediaRecommendationEngineConfigEngineFeaturesConfig, Map<String, dynamic>>(engineFeaturesConfig, (value) => value.toMap()),
      'optimizationObjective': ?optimizationObjective,
      'optimizationObjectiveConfig': ?pulumi.Input.mapOptionalInputValue<RecommendationEngineMediaRecommendationEngineConfigOptimizationObjectiveConfig, Map<String, dynamic>>(optimizationObjectiveConfig, (value) => value.toMap()),
  ...
  factory RecommendationEngineMediaRecommendationEngineConfig.fromMap(Map<String, dynamic> map) {
    return RecommendationEngineMediaRecommendationEngineConfig(
      engineFeaturesConfig: (() { final guardedValue = map['engineFeaturesConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RecommendationEngineMediaRecommendationEngineConfigEngineFeaturesConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      optimizationObjectiveConfig: (() { final guardedValue = map['optimizationObjectiveConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RecommendationEngineMediaRecommendationEngineConfigOptimizationObjectiveConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      trainingState: (() { final guardedValue = map['trainingState']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
