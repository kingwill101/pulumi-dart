...
class AssistantGenerationConfig {
  ...
  factory AssistantGenerationConfig.fromMap(Map<String, dynamic> map) {
    return AssistantGenerationConfig(
      ...
      systemInstruction: (() { final guardedValue = map['systemInstruction']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AssistantGenerationConfigSystemInstruction.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
