...
class GetDataStoreDocumentProcessingConfigParsingConfigOverrideLayoutParsingConfig {
  ...
  /// Creates a new [GetDataStoreDocumentProcessingConfigParsingConfigOverrideLayoutParsingConfig].
  ...
  const GetDataStoreDocumentProcessingConfigParsingConfigOverrideLayoutParsingConfig({
  ...
  factory GetDataStoreDocumentProcessingConfigParsingConfigOverrideLayoutParsingConfig.fromMap(Map<String, dynamic> map) {
    return GetDataStoreDocumentProcessingConfigParsingConfigOverrideLayoutParsingConfig(
