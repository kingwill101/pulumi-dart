...
class WidgetConfigUiSettingsDataStoreUiConfig {
  ...
  /// Structure is documented below.
  final List<WidgetConfigUiSettingsDataStoreUiConfigFieldsUiComponentsMap>? fieldsUiComponentsMaps;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'facetFields': ?facetFields == null ? null : pulumi.Input.encodeList<WidgetConfigUiSettingsDataStoreUiConfigFacetField, Map<String, dynamic>>(facetFields!, (value) => value.toMap()),
      'fieldsUiComponentsMaps': ?fieldsUiComponentsMaps == null ? null : pulumi.Input.encodeList<WidgetConfigUiSettingsDataStoreUiConfigFieldsUiComponentsMap, Map<String, dynamic>>(fieldsUiComponentsMaps!, (value) => value.toMap()),
      'name': ?name,
    };
  }
  ...
  factory WidgetConfigUiSettingsDataStoreUiConfig.fromMap(Map<String, dynamic> map) {
    return WidgetConfigUiSettingsDataStoreUiConfig(
      facetFields: map['facetFields'] == null ? null : pulumi.Input.decodeList<WidgetConfigUiSettingsDataStoreUiConfigFacetField>(map['facetFields'], (value) => WidgetConfigUiSettingsDataStoreUiConfigFacetField.fromMap((value as Map).cast<String, dynamic>())),
      fieldsUiComponentsMaps: map['fieldsUiComponentsMaps'] == null ? null : pulumi.Input.decodeList<WidgetConfigUiSettingsDataStoreUiConfigFieldsUiComponentsMap>(map['fieldsUiComponentsMaps'], (value) => WidgetConfigUiSettingsDataStoreUiConfigFieldsUiComponentsMap.fromMap((value as Map).cast<String, dynamic>())),
