...
class ParameterPolicyMember {
  ...
  factory ParameterPolicyMember.fromMap(Map<String, dynamic> map) {
    return ParameterPolicyMember(
      iamPolicyNamePrincipal: (() { final guardedValue = map['iamPolicyNamePrincipal']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      iamPolicyUidPrincipal: (() { final guardedValue = map['iamPolicyUidPrincipal']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
