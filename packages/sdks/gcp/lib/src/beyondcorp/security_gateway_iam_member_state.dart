...
class SecurityGatewayIamMemberState {
  ...
  /// Creates a new [SecurityGatewayIamMemberState].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'condition': ?pulumi.Input.mapOptionalInputValue<SecurityGatewayIamMemberCondition, Map<String, dynamic>>(condition, (value) => value.toMap()),
      'etag': ?etag,
      'location': ?location,
      'member': ?member,
      'project': ?project,
  ...
  factory SecurityGatewayIamMemberState.fromMap(Map<String, dynamic> map) {
    return SecurityGatewayIamMemberState(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SecurityGatewayIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
