...
import 'security_gateway_iam_binding_state.dart';
...
class SecurityGatewayIamBinding extends pulumi.CustomResource {
  ...
  /// Creates a new [SecurityGatewayIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [SecurityGatewayIamBinding]. {@macro pulumi_beyondcorp_security_gateway_iam_binding_security_gateway_iam_binding_args_doc}
  ...
  SecurityGatewayIamBinding(
    ...
    condition = registerOutput<SecurityGatewayIamBindingCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SecurityGatewayIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [SecurityGatewayIamBinding] resource's state with the given [name] and [id].
  static SecurityGatewayIamBinding get(
    String name,
    pulumi.Input<String> id, {
    SecurityGatewayIamBindingState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return SecurityGatewayIamBinding._get(
      name,
      state: state?.toMap(),
  ...
  SecurityGatewayIamBinding._get(
    String name, {
  ...
  /// Creates a typed reference to an existing [SecurityGatewayIamBinding] resource.
  SecurityGatewayIamBinding.reference(String urn)
    : super(
        'gcp:beyondcorp/securityGatewayIamBinding:SecurityGatewayIamBinding',
