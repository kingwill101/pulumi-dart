...
class SecurityGatewayApplicationIamBindingState {
  ...
  /// Creates a new [SecurityGatewayApplicationIamBindingState].
  ...
  SecurityGatewayApplicationIamBindingState({
    ...
    pulumi.Output<SecurityGatewayApplicationIamBindingCondition>? condition,
  ...
  factory SecurityGatewayApplicationIamBindingState.fromMap(Map<String, dynamic> map) {
    return SecurityGatewayApplicationIamBindingState(
      ...
      condition: map['condition'] == null ? null : pulumi.Output.create<SecurityGatewayApplicationIamBindingCondition>(SecurityGatewayApplicationIamBindingCondition.fromMap((map['condition'] as Map).cast<String, dynamic>())),
