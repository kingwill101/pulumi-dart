...
import 'security_gateway_application_iam_binding_state.dart';
...
class SecurityGatewayApplicationIamBinding extends pulumi.CustomResource {
  ...
  /// Gets an existing [SecurityGatewayApplicationIamBinding] resource's state with the given [name] and [id].
  static SecurityGatewayApplicationIamBinding get(
    String name,
  ...
  SecurityGatewayApplicationIamBinding._get(
    String name, {
