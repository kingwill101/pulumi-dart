...
class SecurityGatewayIamBindingState {
  ...
  const SecurityGatewayIamBindingState({
    this.condition,
    this.etag,
    this.location,
    this.members,
  ...
  factory SecurityGatewayIamBindingState.fromMap(Map<String, dynamic> map) {
    return SecurityGatewayIamBindingState(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SecurityGatewayIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
