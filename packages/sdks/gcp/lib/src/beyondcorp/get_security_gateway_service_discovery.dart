...
class GetSecurityGatewayServiceDiscovery {
  ...
  final pulumi.Input<List<GetSecurityGatewayServiceDiscoveryApiGateway>>
  apiGateways;
    ...
    return <String, dynamic>{
      'apiGateways':
          pulumi.Input.mapInputValue<
            List<GetSecurityGatewayServiceDiscoveryApiGateway>,
  ...
  factory GetSecurityGatewayServiceDiscovery.fromMap(Map<String, dynamic> map) {
    return GetSecurityGatewayServiceDiscovery(
      apiGateways: pulumi.Input.fromValue(
