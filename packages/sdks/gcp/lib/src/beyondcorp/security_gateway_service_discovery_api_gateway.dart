...
class SecurityGatewayServiceDiscoveryApiGateway {
  ...
  factory SecurityGatewayServiceDiscoveryApiGateway.fromMap(Map<String, dynamic> map) {
    return SecurityGatewayServiceDiscoveryApiGateway(
      resourceOverride: (() { final guardedValue = map['resourceOverride']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SecurityGatewayServiceDiscoveryApiGatewayResourceOverride.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
