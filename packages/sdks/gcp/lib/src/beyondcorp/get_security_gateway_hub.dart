...
class GetSecurityGatewayHub {
  ...
  factory GetSecurityGatewayHub.fromMap(Map<String, dynamic> map) {
    return GetSecurityGatewayHub(
      internetGateways: pulumi.Input.fromValue(pulumi.Input.decodeList<GetSecurityGatewayHubInternetGateway>(map['internetGateways']!, (value) => GetSecurityGatewayHubInternetGateway.fromMap((value as Map).cast<String, dynamic>()))),
