...
class SecurityGatewayHub {
  ...
  factory SecurityGatewayHub.fromMap(Map<String, dynamic> map) {
    return SecurityGatewayHub(
      internetGateway: (() { final guardedValue = map['internetGateway']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SecurityGatewayHubInternetGateway.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
