...
import 'security_gateway_iam_member_state.dart';
...
class SecurityGatewayIamMember extends pulumi.CustomResource {
  ...
  late final pulumi.Output<SecurityGatewayIamMemberCondition?> condition;
  ...
  /// Creates a new [SecurityGatewayIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [SecurityGatewayIamMember]. {@macro pulumi_beyondcorp_security_gateway_iam_member_security_gateway_iam_member_args_doc}
  ...
  SecurityGatewayIamMember(
    ...
    condition = registerOutput<SecurityGatewayIamMemberCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SecurityGatewayIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [SecurityGatewayIamMember] resource's state with the given [name] and [id].
  static SecurityGatewayIamMember get(
    String name,
    pulumi.Input<String> id, {
    SecurityGatewayIamMemberState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return SecurityGatewayIamMember._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [SecurityGatewayIamMember] resource.
  SecurityGatewayIamMember.reference(String urn)
    : super(
        'gcp:beyondcorp/securityGatewayIamMember:SecurityGatewayIamMember',
