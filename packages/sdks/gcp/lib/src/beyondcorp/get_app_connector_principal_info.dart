...
class GetAppConnectorPrincipalInfo {
  ...
  const GetAppConnectorPrincipalInfo({
  ...
  factory GetAppConnectorPrincipalInfo.fromMap(Map<String, dynamic> map) {
    return GetAppConnectorPrincipalInfo(
      serviceAccounts: pulumi.Input.fromValue(pulumi.Input.decodeList<GetAppConnectorPrincipalInfoServiceAccount>(map['serviceAccounts']!, (value) => GetAppConnectorPrincipalInfoServiceAccount.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
