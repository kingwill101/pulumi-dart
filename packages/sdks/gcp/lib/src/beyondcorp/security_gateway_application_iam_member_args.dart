...
class SecurityGatewayApplicationIamMemberArgs {
  ...
  factory SecurityGatewayApplicationIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return SecurityGatewayApplicationIamMemberArgs(
      ...
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SecurityGatewayApplicationIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
