...
import 'security_gateway_iam_policy_state.dart';
...
class SecurityGatewayIamPolicy extends pulumi.CustomResource {
  ...
  /// Gets an existing [SecurityGatewayIamPolicy] resource's state with the given [name] and [id].
  static SecurityGatewayIamPolicy get(
    String name,
