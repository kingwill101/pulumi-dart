...
/// }
///
/// resource "gcp_firebaserules_ruleset" "primary" {
///   source = {
///     files = [{
///       "content"     = "service cloud.firestore {match /databases/{database}/documents { match /{document=**} { allow read, write: if false; } } }"
///       "name"        = "firestore.rules"
...
class Ruleset extends pulumi.CustomResource {
  ...
  Ruleset(
    ...
    metadatas = registerOutput<List<RulesetMetadata>>('metadatas', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return pulumi.Input.decodeList<RulesetMetadata>(guardedValue, (value) => RulesetMetadata.fromMap((value as Map).cast<String, dynamic>())); });
