...
class AspectTypeIamMemberState {
  ...
  const AspectTypeIamMemberState({
    this.aspectTypeId,
    this.condition,
    this.etag,
    this.location,
  ...
  factory AspectTypeIamMemberState.fromMap(Map<String, dynamic> map) {
    return AspectTypeIamMemberState(
      ...
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AspectTypeIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
