...
class DatascanIamPolicyState {
  ...
  /// Creates a new [DatascanIamPolicyState].
  ...
  factory DatascanIamPolicyState.fromMap(Map<String, dynamic> map) {
    return DatascanIamPolicyState(
