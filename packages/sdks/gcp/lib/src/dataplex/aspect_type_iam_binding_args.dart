...
import 'aspect_type_iam_binding_condition.dart';

/// {@template pulumi_dataplex_aspect_type_iam_binding_aspect_type_iam_binding_args_doc}
/// The set of arguments for AspectTypeIamBinding.
/// {@endtemplate}
/// {@macro pulumi_dataplex_aspect_type_iam_binding_aspect_type_iam_binding_args_doc}
class AspectTypeIamBindingArgs {
  /// Used to find the parent resource to bind the IAM policy to
  final pulumi.Input<String> aspectTypeId;
  final pulumi.Input<AspectTypeIamBindingCondition>? condition;
  ...
  /// Creates a new [AspectTypeIamBindingArgs].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'condition': ?pulumi.Input.mapOptionalInputValue<AspectTypeIamBindingCondition, Map<String, dynamic>>(condition, (value) => value.toMap()),
      'location': ?location,
      'members': members,
      'project': ?project,
      'role': role,
  ...
  factory AspectTypeIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return AspectTypeIamBindingArgs(
      ...
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AspectTypeIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
