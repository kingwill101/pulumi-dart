    ...
    return <String, dynamic>{
      'assetStatuses':
          ?pulumi.Input.mapOptionalInputValue<
            List<LakeAssetStatus>,
            List<Map<String, dynamic>>
          >(
            assetStatuses,
            (value) =>
                pulumi.Input.encodeList<LakeAssetStatus, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return LakeState(
      assetStatuses: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<LakeAssetStatus>(
            guardedValue,
            (value) =>
                LakeAssetStatus.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      createTime: (() {
      ...
      metastoreStatuses: (() {
        final guardedValue = map['metastoreStatuses'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<LakeMetastoreStatus>(
            guardedValue,
            (value) => LakeMetastoreStatus.fromMap(
