...
class GlossaryIamBindingState {
  ...
  /// Creates a new [GlossaryIamBindingState].
  /// [condition] Optional.
  ...
  factory GlossaryIamBindingState.fromMap(Map<String, dynamic> map) {
    return GlossaryIamBindingState(
