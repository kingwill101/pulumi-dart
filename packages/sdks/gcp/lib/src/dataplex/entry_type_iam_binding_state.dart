...
class EntryTypeIamBindingState {
  ...
  const EntryTypeIamBindingState({
    this.condition,
    this.entryTypeId,
    this.etag,
    this.location,
  ...
  factory EntryTypeIamBindingState.fromMap(Map<String, dynamic> map) {
    return EntryTypeIamBindingState(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EntryTypeIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
