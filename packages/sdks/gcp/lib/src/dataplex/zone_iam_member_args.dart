...
class ZoneIamMemberArgs {
  ...
  factory ZoneIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return ZoneIamMemberArgs(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ZoneIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
