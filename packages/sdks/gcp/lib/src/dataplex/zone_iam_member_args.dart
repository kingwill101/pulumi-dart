...
/// {@template pulumi_dataplex_zone_iam_member_zone_iam_member_args_doc}
/// The set of arguments for ZoneIamMember.
/// {@endtemplate}
/// {@macro pulumi_dataplex_zone_iam_member_zone_iam_member_args_doc}
class ZoneIamMemberArgs {
  final pulumi.Input<ZoneIamMemberCondition>? condition;
  ...
  /// Creates a new [ZoneIamMemberArgs].
  /// [condition] Optional.
  ...
  ZoneIamMemberArgs({
    pulumi.Output<ZoneIamMemberCondition>? condition,
    ...
    required pulumi.Output<String> role,
      ...
      condition = pulumi.Input.asOptionalInput<ZoneIamMemberCondition>(condition),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'condition': ?pulumi.Input.mapOptionalInputValue<ZoneIamMemberCondition, Map<String, dynamic>>(condition, (value) => value.toMap()),
  ...
  factory ZoneIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return ZoneIamMemberArgs(
      condition: map['condition'] == null ? null : pulumi.Output.create<ZoneIamMemberCondition>(ZoneIamMemberCondition.fromMap((map['condition'] as Map).cast<String, dynamic>())),
