...
import 'aspect_type_iam_member_state.dart';
...
class AspectTypeIamMember extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [AspectTypeIamMember]. {@macro pulumi_dataplex_aspect_type_iam_member_aspect_type_iam_member_args_doc}
  ...
  AspectTypeIamMember(
    ...
    condition = registerOutput<AspectTypeIamMemberCondition?>(
      'condition',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return AspectTypeIamMemberCondition.fromMap(
  ...
  /// Gets an existing [AspectTypeIamMember] resource's state with the given [name] and [id].
  static AspectTypeIamMember get(
    String name,
