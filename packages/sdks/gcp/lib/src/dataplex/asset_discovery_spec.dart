...
class AssetDiscoverySpec {
  ...
  factory AssetDiscoverySpec.fromMap(Map<String, dynamic> map) {
    return AssetDiscoverySpec(
      csvOptions: map['csvOptions'] == null ? null : AssetDiscoverySpecCsvOptions.fromMap((map['csvOptions'] as Map).cast<String, dynamic>()),
      ...
      jsonOptions: map['jsonOptions'] == null ? null : AssetDiscoverySpecJsonOptions.fromMap((map['jsonOptions'] as Map).cast<String, dynamic>()),
