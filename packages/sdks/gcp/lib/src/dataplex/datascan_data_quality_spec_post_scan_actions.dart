...
class DatascanDataQualitySpecPostScanActions {
  ...
  final pulumi.Input<DatascanDataQualitySpecPostScanActionsBigqueryExport>?
  bigqueryExport;

  /// The configuration of notification report post scan action.
  /// Structure is documented below.
  final pulumi.Input<DatascanDataQualitySpecPostScanActionsNotificationReport>?
  notificationReport;
    ...
    return <String, dynamic>{
      ...
      'notificationReport':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(notificationReport, (value) => value.toMap()),
    };
  }
  ...
  factory DatascanDataQualitySpecPostScanActions.fromMap(
    ...
    return DatascanDataQualitySpecPostScanActions(
      ...
      notificationReport: (() {
        final guardedValue = map['notificationReport'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
