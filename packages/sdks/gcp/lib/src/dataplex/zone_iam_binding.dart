...
import 'zone_iam_binding_state.dart';
...
class ZoneIamBinding extends pulumi.CustomResource {
  late final pulumi.Output<ZoneIamBindingCondition?> condition;
  ...
  /// Creates a new [ZoneIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ZoneIamBinding]. {@macro pulumi_dataplex_zone_iam_binding_zone_iam_binding_args_doc}
  ...
  ZoneIamBinding(
    ...
    condition = registerOutput<ZoneIamBindingCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ZoneIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [ZoneIamBinding] resource's state with the given [name] and [id].
  static ZoneIamBinding get(
    String name,
    pulumi.Input<String> id, {
    ZoneIamBindingState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return ZoneIamBinding._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [ZoneIamBinding] resource.
  ZoneIamBinding.reference(String urn)
    : super(
        'gcp:dataplex/zoneIamBinding:ZoneIamBinding',
