    ...
    return AssetState(
      ...
      discoverySpec: (() {
        ...
        return pulumi.Input.fromValue(
          AssetDiscoverySpec.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      discoveryStatuses: (() {
        final guardedValue = map['discoveryStatuses'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AssetDiscoveryStatus>(
            guardedValue,
            (value) => AssetDiscoveryStatus.fromMap(
      ...
      resourceStatuses: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AssetResourceStatus>(
            guardedValue,
            (value) => AssetResourceStatus.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      securityStatuses: (() {
        final guardedValue = map['securityStatuses'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AssetSecurityStatus>(
            guardedValue,
            (value) => AssetSecurityStatus.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
