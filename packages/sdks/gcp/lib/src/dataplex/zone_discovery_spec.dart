...
class ZoneDiscoverySpec {
  ...
  factory ZoneDiscoverySpec.fromMap(Map<String, dynamic> map) {
    return ZoneDiscoverySpec(
      csvOptions: (() { final guardedValue = map['csvOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ZoneDiscoverySpecCsvOptions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      jsonOptions: (() { final guardedValue = map['jsonOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ZoneDiscoverySpecJsonOptions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
