...
class DatascanDataDiscoverySpec {
  ...
  final pulumi.Input<DatascanDataDiscoverySpecBigqueryPublishingConfig>?
    ...
    return <String, dynamic>{
      'bigqueryPublishingConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(bigqueryPublishingConfig, (value) => value.toMap()),
      'storageConfig':
          ?pulumi.Input.mapOptionalInputValue<
  ...
  factory DatascanDataDiscoverySpec.fromMap(Map<String, dynamic> map) {
    return DatascanDataDiscoverySpec(
      bigqueryPublishingConfig: (() {
        final guardedValue = map['bigqueryPublishingConfig'];
