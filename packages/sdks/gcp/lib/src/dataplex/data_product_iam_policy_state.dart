...
class DataProductIamPolicyState {
  ...
  /// Creates a new [DataProductIamPolicyState].
  ...
  const DataProductIamPolicyState({
    this.dataProductId,
    this.etag,
    this.location,
    this.policyData,
  ...
  factory DataProductIamPolicyState.fromMap(Map<String, dynamic> map) {
    return DataProductIamPolicyState(
