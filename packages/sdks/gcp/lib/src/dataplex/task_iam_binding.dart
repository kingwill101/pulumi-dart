...
import 'task_iam_binding_state.dart';
...
class TaskIamBinding extends pulumi.CustomResource {
  ...
  TaskIamBinding(
    ...
    condition = registerOutput<TaskIamBindingCondition?>(
      'condition',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return TaskIamBindingCondition.fromMap(
  ...
  /// Gets an existing [TaskIamBinding] resource's state with the given [name] and [id].
  static TaskIamBinding get(
    String name,
