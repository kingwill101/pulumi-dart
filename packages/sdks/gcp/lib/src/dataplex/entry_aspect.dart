...
class EntryAspect {
  ...
  EntryAspect({required this.aspect, required this.aspectKey});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'aspect':
          pulumi.Input.mapInputValue<EntryAspectAspect, Map<String, dynamic>>(
            aspect,
            (value) => value.toMap(),
          ),
      'aspectKey': aspectKey,
  ...
  factory EntryAspect.fromMap(Map<String, dynamic> map) {
    return EntryAspect(
      aspect: pulumi.Input.fromValue(
        EntryAspectAspect.fromMap(
