...
import 'lake_iam_policy_state.dart';
...
class LakeIamPolicy extends pulumi.CustomResource {
  ...
  /// Gets an existing [LakeIamPolicy] resource's state with the given [name] and [id].
  static LakeIamPolicy get(
    String name,
    pulumi.Input<String> id, {
    LakeIamPolicyState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return LakeIamPolicy._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [LakeIamPolicy] resource.
  LakeIamPolicy.reference(String urn)
    : super(
        'gcp:dataplex/lakeIamPolicy:LakeIamPolicy',
