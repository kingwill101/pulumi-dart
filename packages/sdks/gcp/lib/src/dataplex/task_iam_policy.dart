...
import 'task_iam_policy_state.dart';
...
class TaskIamPolicy extends pulumi.CustomResource {
  ...
  /// Gets an existing [TaskIamPolicy] resource's state with the given [name] and [id].
  static TaskIamPolicy get(
    String name,
    pulumi.Input<String> id, {
    TaskIamPolicyState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return TaskIamPolicy._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [TaskIamPolicy] resource.
  TaskIamPolicy.reference(String urn)
    : super(
        'gcp:dataplex/taskIamPolicy:TaskIamPolicy',
