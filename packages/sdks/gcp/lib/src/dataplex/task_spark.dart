...
class TaskSpark {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'fileUris': ?fileUris,
      'infrastructureSpec': ?pulumi.Input.mapOptionalInputValue<TaskSparkInfrastructureSpec, Map<String, dynamic>>(infrastructureSpec, (value) => value.toMap()),
      'mainClass': ?mainClass,
  ...
  factory TaskSpark.fromMap(Map<String, dynamic> map) {
    return TaskSpark(
      ...
      infrastructureSpec: (() { final guardedValue = map['infrastructureSpec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TaskSparkInfrastructureSpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
