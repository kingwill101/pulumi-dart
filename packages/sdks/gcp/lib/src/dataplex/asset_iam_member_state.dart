...
class AssetIamMemberState {
  ...
  /// Creates a new [AssetIamMemberState].
  ...
  AssetIamMemberState({
    pulumi.Output<String>? asset,
    pulumi.Output<AssetIamMemberCondition>? condition,
    ...
    pulumi.Output<String>? role,
      ...
      asset = pulumi.Input.asOptionalInput<String>(asset),
      condition = pulumi.Input.asOptionalInput<AssetIamMemberCondition>(condition),
  ...
  factory AssetIamMemberState.fromMap(Map<String, dynamic> map) {
    return AssetIamMemberState(
      asset: map['asset'] == null ? null : pulumi.Output.create<String>(map['asset'] as String),
      condition: map['condition'] == null ? null : pulumi.Output.create<AssetIamMemberCondition>(AssetIamMemberCondition.fromMap((map['condition'] as Map).cast<String, dynamic>())),
