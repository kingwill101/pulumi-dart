...
class AssetIamMemberState {
  ...
  factory AssetIamMemberState.fromMap(Map<String, dynamic> map) {
    return AssetIamMemberState(
      ...
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AssetIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
