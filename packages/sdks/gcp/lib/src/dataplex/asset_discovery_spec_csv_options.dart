...
class AssetDiscoverySpecCsvOptions {
  ...
  const AssetDiscoverySpecCsvOptions({
    this.delimiter,
  ...
  factory AssetDiscoverySpecCsvOptions.fromMap(Map<String, dynamic> map) {
    return AssetDiscoverySpecCsvOptions(
      ...
      headerRows: (() { final guardedValue = map['headerRows']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
    );
  }
}
