...
class LakeIamBindingState {
  ...
  /// Creates a new [LakeIamBindingState].
  /// [condition] Optional.
  ...
  factory LakeIamBindingState.fromMap(Map<String, dynamic> map) {
    return LakeIamBindingState(
