...
import 'zone_iam_policy_state.dart';
...
/// }
///
/// resource "gcp_dataplex_zoneiampolicy" "policy" {
///   project       = example.project
///   location      = example.location
///   lake          = example.lake
///   dataplex_zone = example.name
...
/// }
///
/// resource "gcp_dataplex_zoneiambinding" "binding" {
///   project       = example.project
///   location      = example.location
///   lake          = example.lake
///   dataplex_zone = example.name
...
/// }
///
/// resource "gcp_dataplex_zoneiammember" "member" {
///   project       = example.project
///   location      = example.location
///   lake          = example.lake
///   dataplex_zone = example.name
...
class ZoneIamPolicy extends pulumi.CustomResource {
  ...
  /// Creates a new [ZoneIamPolicy].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ZoneIamPolicy]. {@macro pulumi_dataplex_zone_iam_policy_zone_iam_policy_args_doc}
  ...
  /// Gets an existing [ZoneIamPolicy] resource's state with the given [name] and [id].
  static ZoneIamPolicy get(
    String name,
    pulumi.Input<String> id, {
    ZoneIamPolicyState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return ZoneIamPolicy._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [ZoneIamPolicy] resource.
  ZoneIamPolicy.reference(String urn)
    : super(
        'gcp:dataplex/zoneIamPolicy:ZoneIamPolicy',
