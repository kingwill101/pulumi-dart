...
import 'data_product_iam_member_args.dart';
import 'data_product_iam_member_condition.dart';
import 'data_product_iam_member_state.dart';
...
class DataProductIamMember extends pulumi.CustomResource {
  late final pulumi.Output<DataProductIamMemberCondition?> condition;
  ...
  /// Creates a new [DataProductIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [DataProductIamMember]. {@macro pulumi_dataplex_data_product_iam_member_data_product_iam_member_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  DataProductIamMember(
    String name, {
    DataProductIamMemberArgs? args,
  ...
  /// Gets an existing [DataProductIamMember] resource's state with the given [name] and [id].
  static DataProductIamMember get(
    String name,
