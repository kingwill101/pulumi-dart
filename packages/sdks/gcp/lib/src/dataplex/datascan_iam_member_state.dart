...
class DatascanIamMemberState {
  ...
  factory DatascanIamMemberState.fromMap(Map<String, dynamic> map) {
    return DatascanIamMemberState(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DatascanIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
