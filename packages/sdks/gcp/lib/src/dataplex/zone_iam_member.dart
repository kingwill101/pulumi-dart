...
import 'zone_iam_member_state.dart';
...
class ZoneIamMember extends pulumi.CustomResource {
  ...
  /// Gets an existing [ZoneIamMember] resource's state with the given [name] and [id].
  static ZoneIamMember get(
    String name,
    pulumi.Input<String> id, {
    ZoneIamMemberState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return ZoneIamMember._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [ZoneIamMember] resource.
  ZoneIamMember.reference(String urn)
    : super(
        'gcp:dataplex/zoneIamMember:ZoneIamMember',
