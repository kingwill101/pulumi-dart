...
class ZoneIamBindingArgs {
  ...
  factory ZoneIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return ZoneIamBindingArgs(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ZoneIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
