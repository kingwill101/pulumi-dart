...
class DatascanIamMember extends pulumi.CustomResource {
  ...
  DatascanIamMember(
    ...
    condition = registerOutput<DatascanIamMemberCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return DatascanIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Creates a typed reference to an existing [DatascanIamMember] resource.
  DatascanIamMember.reference(String urn)
    : super(
        'gcp:dataplex/datascanIamMember:DatascanIamMember',
