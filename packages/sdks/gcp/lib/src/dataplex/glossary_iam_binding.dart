...
import 'glossary_iam_binding_condition.dart';
import 'glossary_iam_binding_state.dart';
...
class GlossaryIamBinding extends pulumi.CustomResource {
  late final pulumi.Output<GlossaryIamBindingCondition?> condition;
  ...
  /// Creates a new [GlossaryIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [GlossaryIamBinding]. {@macro pulumi_dataplex_glossary_iam_binding_glossary_iam_binding_args_doc}
  ...
  GlossaryIamBinding(
    ...
    condition = registerOutput<GlossaryIamBindingCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return GlossaryIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [GlossaryIamBinding] resource's state with the given [name] and [id].
  static GlossaryIamBinding get(
    String name,
    pulumi.Input<String> id, {
    GlossaryIamBindingState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return GlossaryIamBinding._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [GlossaryIamBinding] resource.
  GlossaryIamBinding.reference(String urn)
    : super(
        'gcp:dataplex/glossaryIamBinding:GlossaryIamBinding',
