...
class EntryLinkAspectAspect {
  ...
  /// Creates a new [EntryLinkAspectAspect].
  /// [aspectType] (Output)
  /// [createTime] (Output)
  ...
  factory EntryLinkAspectAspect.fromMap(Map<String, dynamic> map) {
    return EntryLinkAspectAspect(
