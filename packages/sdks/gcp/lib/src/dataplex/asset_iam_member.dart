...
import 'asset_iam_member_args.dart';
import 'asset_iam_member_condition.dart';
import 'asset_iam_member_state.dart';
...
class AssetIamMember extends pulumi.CustomResource {
  ...
  late final pulumi.Output<AssetIamMemberCondition?> condition;
  ...
  /// Creates a new [AssetIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [AssetIamMember]. {@macro pulumi_dataplex_asset_iam_member_asset_iam_member_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  AssetIamMember(
    String name, {
    AssetIamMemberArgs? args,
  ...
  /// Gets an existing [AssetIamMember] resource's state with the given [name] and [id].
  static AssetIamMember get(
    String name,
