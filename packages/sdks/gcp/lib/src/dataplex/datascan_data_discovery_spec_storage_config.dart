...
class DatascanDataDiscoverySpecStorageConfig {
  ...
  final pulumi.Input<DatascanDataDiscoverySpecStorageConfigCsvOptions>?
  csvOptions;
  ...
  /// Structure is documented below.
  final pulumi.Input<DatascanDataDiscoverySpecStorageConfigJsonOptions>?
  jsonOptions;
  ...
  factory DatascanDataDiscoverySpecStorageConfig.fromMap(
    ...
    return DatascanDataDiscoverySpecStorageConfig(
      ...
      excludePatterns: (() {
        final guardedValue = map['excludePatterns'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      includePatterns: (() {
        final guardedValue = map['includePatterns'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      jsonOptions: (() {
