...
class GetDataQualityRulesRule {
  ...
  final List<GetDataQualityRulesRuleRowConditionExpectation> rowConditionExpectations;
  ...
  final List<GetDataQualityRulesRuleStatisticRangeExpectation> statisticRangeExpectations;
  /// Whether the Rule is active or suspended. Default is false.
  final bool suspended;
  /// Aggregate rule which evaluates whether the provided expression is true for a table.
  final List<GetDataQualityRulesRuleTableConditionExpectation> tableConditionExpectations;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'rangeExpectations': pulumi.Input.encodeList<GetDataQualityRulesRuleRangeExpectation, Map<String, dynamic>>(rangeExpectations, (value) => value.toMap()),
      'regexExpectations': pulumi.Input.encodeList<GetDataQualityRulesRuleRegexExpectation, Map<String, dynamic>>(regexExpectations, (value) => value.toMap()),
      'rowConditionExpectations': pulumi.Input.encodeList<GetDataQualityRulesRuleRowConditionExpectation, Map<String, dynamic>>(rowConditionExpectations, (value) => value.toMap()),
      'setExpectations': pulumi.Input.encodeList<GetDataQualityRulesRuleSetExpectation, Map<String, dynamic>>(setExpectations, (value) => value.toMap()),
      'sqlAssertions': pulumi.Input.encodeList<GetDataQualityRulesRuleSqlAssertion, Map<String, dynamic>>(sqlAssertions, (value) => value.toMap()),
      'statisticRangeExpectations': pulumi.Input.encodeList<GetDataQualityRulesRuleStatisticRangeExpectation, Map<String, dynamic>>(statisticRangeExpectations, (value) => value.toMap()),
      'suspended': suspended,
      'tableConditionExpectations': pulumi.Input.encodeList<GetDataQualityRulesRuleTableConditionExpectation, Map<String, dynamic>>(tableConditionExpectations, (value) => value.toMap()),
      'threshold': threshold,
  ...
  factory GetDataQualityRulesRule.fromMap(Map<String, dynamic> map) {
    return GetDataQualityRulesRule(
      ...
      nonNullExpectations: (map['nonNullExpectations'] as List).cast<Map<String, dynamic>>(),
      rangeExpectations: pulumi.Input.decodeList<GetDataQualityRulesRuleRangeExpectation>(map['rangeExpectations'], (value) => GetDataQualityRulesRuleRangeExpectation.fromMap((value as Map).cast<String, dynamic>())),
      regexExpectations: pulumi.Input.decodeList<GetDataQualityRulesRuleRegexExpectation>(map['regexExpectations'], (value) => GetDataQualityRulesRuleRegexExpectation.fromMap((value as Map).cast<String, dynamic>())),
      rowConditionExpectations: pulumi.Input.decodeList<GetDataQualityRulesRuleRowConditionExpectation>(map['rowConditionExpectations'], (value) => GetDataQualityRulesRuleRowConditionExpectation.fromMap((value as Map).cast<String, dynamic>())),
      setExpectations: pulumi.Input.decodeList<GetDataQualityRulesRuleSetExpectation>(map['setExpectations'], (value) => GetDataQualityRulesRuleSetExpectation.fromMap((value as Map).cast<String, dynamic>())),
      sqlAssertions: pulumi.Input.decodeList<GetDataQualityRulesRuleSqlAssertion>(map['sqlAssertions'], (value) => GetDataQualityRulesRuleSqlAssertion.fromMap((value as Map).cast<String, dynamic>())),
      statisticRangeExpectations: pulumi.Input.decodeList<GetDataQualityRulesRuleStatisticRangeExpectation>(map['statisticRangeExpectations'], (value) => GetDataQualityRulesRuleStatisticRangeExpectation.fromMap((value as Map).cast<String, dynamic>())),
      suspended: map['suspended'] as bool,
      tableConditionExpectations: pulumi.Input.decodeList<GetDataQualityRulesRuleTableConditionExpectation>(map['tableConditionExpectations'], (value) => GetDataQualityRulesRuleTableConditionExpectation.fromMap((value as Map).cast<String, dynamic>())),
      threshold: map['threshold'] as double,
      uniquenessExpectations: (map['uniquenessExpectations'] as List).cast<Map<String, dynamic>>(),
    );
  }
}
