...
class GetDataQualityRulesRule {
  ...
  factory GetDataQualityRulesRule.fromMap(Map<String, dynamic> map) {
    return GetDataQualityRulesRule(
      ...
      nonNullExpectations: pulumi.Input.fromValue((map['nonNullExpectations'] as List).cast<Map<String, dynamic>>()),
      rangeExpectations: pulumi.Input.fromValue(pulumi.Input.decodeList<GetDataQualityRulesRuleRangeExpectation>(map['rangeExpectations']!, (value) => GetDataQualityRulesRuleRangeExpectation.fromMap((value as Map).cast<String, dynamic>()))),
      regexExpectations: pulumi.Input.fromValue(pulumi.Input.decodeList<GetDataQualityRulesRuleRegexExpectation>(map['regexExpectations']!, (value) => GetDataQualityRulesRuleRegexExpectation.fromMap((value as Map).cast<String, dynamic>()))),
      rowConditionExpectations: pulumi.Input.fromValue(pulumi.Input.decodeList<GetDataQualityRulesRuleRowConditionExpectation>(map['rowConditionExpectations']!, (value) => GetDataQualityRulesRuleRowConditionExpectation.fromMap((value as Map).cast<String, dynamic>()))),
      setExpectations: pulumi.Input.fromValue(pulumi.Input.decodeList<GetDataQualityRulesRuleSetExpectation>(map['setExpectations']!, (value) => GetDataQualityRulesRuleSetExpectation.fromMap((value as Map).cast<String, dynamic>()))),
      sqlAssertions: pulumi.Input.fromValue(pulumi.Input.decodeList<GetDataQualityRulesRuleSqlAssertion>(map['sqlAssertions']!, (value) => GetDataQualityRulesRuleSqlAssertion.fromMap((value as Map).cast<String, dynamic>()))),
