...
class GetDataQualityRulesRule {
  ...
  final pulumi.Input<List<GetDataQualityRulesRuleRangeExpectation>> rangeExpectations;
  /// Row-level rule which evaluates whether each column value matches a specified regex.
  final pulumi.Input<List<GetDataQualityRulesRuleRegexExpectation>> regexExpectations;
  /// Row-level rule which evaluates whether each row in a table passes the specified condition.
  final pulumi.Input<List<GetDataQualityRulesRuleRowConditionExpectation>> rowConditionExpectations;
  /// Row-level rule which evaluates whether each column value is contained by a specified set.
  final pulumi.Input<List<GetDataQualityRulesRuleSetExpectation>> setExpectations;
  ...
  final pulumi.Input<List<GetDataQualityRulesRuleStatisticRangeExpectation>> statisticRangeExpectations;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'rangeExpectations': pulumi.Input.mapInputValue<List<GetDataQualityRulesRuleRangeExpectation>, List<Map<String, dynamic>>>(rangeExpectations, (value) => pulumi.Input.encodeList<GetDataQualityRulesRuleRangeExpectation, Map<String, dynamic>>(value, (value) => value.toMap())),
      'regexExpectations': pulumi.Input.mapInputValue<List<GetDataQualityRulesRuleRegexExpectation>, List<Map<String, dynamic>>>(regexExpectations, (value) => pulumi.Input.encodeList<GetDataQualityRulesRuleRegexExpectation, Map<String, dynamic>>(value, (value) => value.toMap())),
      'rowConditionExpectations': pulumi.Input.mapInputValue<List<GetDataQualityRulesRuleRowConditionExpectation>, List<Map<String, dynamic>>>(rowConditionExpectations, (value) => pulumi.Input.encodeList<GetDataQualityRulesRuleRowConditionExpectation, Map<String, dynamic>>(value, (value) => value.toMap())),
      'setExpectations': pulumi.Input.mapInputValue<List<GetDataQualityRulesRuleSetExpectation>, List<Map<String, dynamic>>>(setExpectations, (value) => pulumi.Input.encodeList<GetDataQualityRulesRuleSetExpectation, Map<String, dynamic>>(value, (value) => value.toMap())),
      'sqlAssertions': pulumi.Input.mapInputValue<List<GetDataQualityRulesRuleSqlAssertion>, List<Map<String, dynamic>>>(sqlAssertions, (value) => pulumi.Input.encodeList<GetDataQualityRulesRuleSqlAssertion, Map<String, dynamic>>(value, (value) => value.toMap())),
      'statisticRangeExpectations': pulumi.Input.mapInputValue<List<GetDataQualityRulesRuleStatisticRangeExpectation>, List<Map<String, dynamic>>>(statisticRangeExpectations, (value) => pulumi.Input.encodeList<GetDataQualityRulesRuleStatisticRangeExpectation, Map<String, dynamic>>(value, (value) => value.toMap())),
      'suspended': suspended,
      'tableConditionExpectations': pulumi.Input.mapInputValue<List<GetDataQualityRulesRuleTableConditionExpectation>, List<Map<String, dynamic>>>(tableConditionExpectations, (value) => pulumi.Input.encodeList<GetDataQualityRulesRuleTableConditionExpectation, Map<String, dynamic>>(value, (value) => value.toMap())),
      'threshold': threshold,
  ...
  factory GetDataQualityRulesRule.fromMap(Map<String, dynamic> map) {
    return GetDataQualityRulesRule(
      ...
      ignoreNull: (map['ignoreNull'] as bool).input(),
      name: (map['name'] as String).input(),
      nonNullExpectations: ((map['nonNullExpectations'] as List).cast<Map<String, dynamic>>()).input(),
      rangeExpectations: (pulumi.Input.decodeList<GetDataQualityRulesRuleRangeExpectation>(map['rangeExpectations'], (value) => GetDataQualityRulesRuleRangeExpectation.fromMap((value as Map).cast<String, dynamic>()))).input(),
      regexExpectations: (pulumi.Input.decodeList<GetDataQualityRulesRuleRegexExpectation>(map['regexExpectations'], (value) => GetDataQualityRulesRuleRegexExpectation.fromMap((value as Map).cast<String, dynamic>()))).input(),
      rowConditionExpectations: (pulumi.Input.decodeList<GetDataQualityRulesRuleRowConditionExpectation>(map['rowConditionExpectations'], (value) => GetDataQualityRulesRuleRowConditionExpectation.fromMap((value as Map).cast<String, dynamic>()))).input(),
      setExpectations: (pulumi.Input.decodeList<GetDataQualityRulesRuleSetExpectation>(map['setExpectations'], (value) => GetDataQualityRulesRuleSetExpectation.fromMap((value as Map).cast<String, dynamic>()))).input(),
      sqlAssertions: (pulumi.Input.decodeList<GetDataQualityRulesRuleSqlAssertion>(map['sqlAssertions'], (value) => GetDataQualityRulesRuleSqlAssertion.fromMap((value as Map).cast<String, dynamic>()))).input(),
      statisticRangeExpectations: (pulumi.Input.decodeList<GetDataQualityRulesRuleStatisticRangeExpectation>(map['statisticRangeExpectations'], (value) => GetDataQualityRulesRuleStatisticRangeExpectation.fromMap((value as Map).cast<String, dynamic>()))).input(),
      suspended: (map['suspended'] as bool).input(),
      tableConditionExpectations: (pulumi.Input.decodeList<GetDataQualityRulesRuleTableConditionExpectation>(map['tableConditionExpectations'], (value) => GetDataQualityRulesRuleTableConditionExpectation.fromMap((value as Map).cast<String, dynamic>()))).input(),
      threshold: (map['threshold'] as double).input(),
      uniquenessExpectations: ((map['uniquenessExpectations'] as List).cast<Map<String, dynamic>>()).input(),
    );
  }
}
