...
/// {@template pulumi_dataplex_glossary_iam_binding_glossary_iam_binding_args_doc}
/// The set of arguments for GlossaryIamBinding.
/// {@endtemplate}
/// {@macro pulumi_dataplex_glossary_iam_binding_glossary_iam_binding_args_doc}
class GlossaryIamBindingArgs {
  ...
  /// Creates a new [GlossaryIamBindingArgs].
  /// [condition] Optional.
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'condition': ?pulumi.Input.mapOptionalInputValue<GlossaryIamBindingCondition, Map<String, dynamic>>(condition, (value) => value.toMap()),
  ...
  factory GlossaryIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return GlossaryIamBindingArgs(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GlossaryIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
