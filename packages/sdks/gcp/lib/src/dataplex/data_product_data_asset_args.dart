...
/// {@template pulumi_dataplex_data_product_data_asset_data_product_data_asset_args_doc}
/// The set of arguments for DataProductDataAsset.
/// {@endtemplate}
/// {@macro pulumi_dataplex_data_product_data_asset_data_product_data_asset_args_doc}
class DataProductDataAssetArgs {
  ...
  /// Creates a new [DataProductDataAssetArgs].
  ...
  const DataProductDataAssetArgs({
  ...
  factory DataProductDataAssetArgs.fromMap(Map<String, dynamic> map) {
    return DataProductDataAssetArgs(
