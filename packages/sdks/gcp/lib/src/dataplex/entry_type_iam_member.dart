...
import 'entry_type_iam_member_state.dart';
...
class EntryTypeIamMember extends pulumi.CustomResource {
  ...
  /// Gets an existing [EntryTypeIamMember] resource's state with the given [name] and [id].
  static EntryTypeIamMember get(
    String name,
