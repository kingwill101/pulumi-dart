...
import 'aspect_type_iam_binding_state.dart';
...
class AspectTypeIamBinding extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [AspectTypeIamBinding]. {@macro pulumi_dataplex_aspect_type_iam_binding_aspect_type_iam_binding_args_doc}
  ...
  AspectTypeIamBinding(
    ...
    condition = registerOutput<AspectTypeIamBindingCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return AspectTypeIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [AspectTypeIamBinding] resource's state with the given [name] and [id].
  static AspectTypeIamBinding get(
    String name,
    pulumi.Input<String> id, {
    AspectTypeIamBindingState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return AspectTypeIamBinding._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [AspectTypeIamBinding] resource.
  AspectTypeIamBinding.reference(String urn)
    : super(
        'gcp:dataplex/aspectTypeIamBinding:AspectTypeIamBinding',
