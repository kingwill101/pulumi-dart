...
class AssetResourceSpec {
  ...
  factory AssetResourceSpec.fromMap(Map<String, dynamic> map) {
    return AssetResourceSpec(
      ...
      readAccessMode: (() { final guardedValue = map['readAccessMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
