...
/// {@template pulumi_dataplex_glossary_iam_member_glossary_iam_member_args_doc}
/// The set of arguments for GlossaryIamMember.
/// {@endtemplate}
/// {@macro pulumi_dataplex_glossary_iam_member_glossary_iam_member_args_doc}
class GlossaryIamMemberArgs {
  ...
  /// Creates a new [GlossaryIamMemberArgs].
  /// [condition] Optional.
  ...
  GlossaryIamMemberArgs({
    pulumi.Output<GlossaryIamMemberCondition>? condition,
    ...
    required pulumi.Output<String> role,
      ...
      condition = pulumi.Input.asOptionalInput<GlossaryIamMemberCondition>(condition),
  ...
  factory GlossaryIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return GlossaryIamMemberArgs(
      condition: map['condition'] == null ? null : pulumi.Output.create<GlossaryIamMemberCondition>(GlossaryIamMemberCondition.fromMap((map['condition'] as Map).cast<String, dynamic>())),
