...
class GlossaryIamMemberArgs {
  ...
  factory GlossaryIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return GlossaryIamMemberArgs(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GlossaryIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
