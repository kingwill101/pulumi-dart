...
class AssetIamBindingArgs {
  ...
  factory AssetIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return AssetIamBindingArgs(
      ...
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AssetIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
