...
/// {@template pulumi_dataplex_asset_iam_binding_asset_iam_binding_args_doc}
/// The set of arguments for AssetIamBinding.
/// {@endtemplate}
/// {@macro pulumi_dataplex_asset_iam_binding_asset_iam_binding_args_doc}
class AssetIamBindingArgs {
  /// Used to find the parent resource to bind the IAM policy to
  final pulumi.Input<String> asset;
  final pulumi.Input<AssetIamBindingCondition>? condition;
  /// Used to find the parent resource to bind the IAM policy to
  ...
  /// Creates a new [AssetIamBindingArgs].
  ...
  AssetIamBindingArgs({
    ...
    pulumi.Output<AssetIamBindingCondition>? condition,
    ...
    required pulumi.Output<String> role,
      ...
      condition = pulumi.Input.asOptionalInput<AssetIamBindingCondition>(condition),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'asset': asset,
      'condition': ?pulumi.Input.mapOptionalInputValue<AssetIamBindingCondition, Map<String, dynamic>>(condition, (value) => value.toMap()),
  ...
  factory AssetIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return AssetIamBindingArgs(
      ...
      condition: map['condition'] == null ? null : pulumi.Output.create<AssetIamBindingCondition>(AssetIamBindingCondition.fromMap((map['condition'] as Map).cast<String, dynamic>())),
