...
class DatascanDataQualitySpecRule {
  ...
  final pulumi.Input<DatascanDataQualitySpecRuleRangeExpectation>?
  rangeExpectation;

  /// ColumnMap rule which evaluates whether each column value matches a specified regex.
  /// Structure is documented below.
  final pulumi.Input<DatascanDataQualitySpecRuleRegexExpectation>?
  regexExpectation;

  /// Table rule which evaluates whether each row passes the specified condition.
  /// Structure is documented below.
  final pulumi.Input<DatascanDataQualitySpecRuleRowConditionExpectation>?
  ...
  /// Structure is documented below.
  final pulumi.Input<DatascanDataQualitySpecRuleStatisticRangeExpectation>?
  ...
  /// Structure is documented below.
  final pulumi.Input<DatascanDataQualitySpecRuleTableConditionExpectation>?
  ...
  factory DatascanDataQualitySpecRule.fromMap(Map<String, dynamic> map) {
    return DatascanDataQualitySpecRule(
      ...
      ignoreNull: (() {
        final guardedValue = map['ignoreNull'];
        if (guardedValue == null) return null;
      ...
      nonNullExpectation: (() {
        final guardedValue = map['nonNullExpectation'];
        if (guardedValue == null) return null;
      ...
      rangeExpectation: (() {
        final guardedValue = map['rangeExpectation'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      regexExpectation: (() {
        final guardedValue = map['regexExpectation'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      rowConditionExpectation: (() {
        final guardedValue = map['rowConditionExpectation'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      setExpectation: (() {
        final guardedValue = map['setExpectation'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      sqlAssertion: (() {
        final guardedValue = map['sqlAssertion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      statisticRangeExpectation: (() {
        final guardedValue = map['statisticRangeExpectation'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      tableConditionExpectation: (() {
        final guardedValue = map['tableConditionExpectation'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      uniquenessExpectation: (() {
        final guardedValue = map['uniquenessExpectation'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as Map).cast<String, dynamic>(),
        );
