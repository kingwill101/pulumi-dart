...
import 'datascan_iam_binding_state.dart';
...
class DatascanIamBinding extends pulumi.CustomResource {
  ...
  DatascanIamBinding(
    ...
    condition = registerOutput<DatascanIamBindingCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return DatascanIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [DatascanIamBinding] resource's state with the given [name] and [id].
  static DatascanIamBinding get(
    String name,
    pulumi.Input<String> id, {
    DatascanIamBindingState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return DatascanIamBinding._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [DatascanIamBinding] resource.
  DatascanIamBinding.reference(String urn)
    : super(
        'gcp:dataplex/datascanIamBinding:DatascanIamBinding',
