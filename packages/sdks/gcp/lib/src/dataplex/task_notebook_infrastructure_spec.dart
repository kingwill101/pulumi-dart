...
class TaskNotebookInfrastructureSpec {
  ...
  factory TaskNotebookInfrastructureSpec.fromMap(Map<String, dynamic> map) {
    return TaskNotebookInfrastructureSpec(
      batch: (() { final guardedValue = map['batch']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TaskNotebookInfrastructureSpecBatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      containerImage: (() { final guardedValue = map['containerImage']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TaskNotebookInfrastructureSpecContainerImage.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      vpcNetwork: (() { final guardedValue = map['vpcNetwork']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TaskNotebookInfrastructureSpecVpcNetwork.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
