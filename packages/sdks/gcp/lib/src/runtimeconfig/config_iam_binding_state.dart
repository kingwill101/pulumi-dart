...
class ConfigIamBindingState {
  ...
  /// Creates a new [ConfigIamBindingState].
  /// [condition] Optional.
  ...
  factory ConfigIamBindingState.fromMap(Map<String, dynamic> map) {
    return ConfigIamBindingState(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConfigIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
