...
import 'config_iam_binding_args.dart';
import 'config_iam_binding_condition.dart';
import 'config_iam_binding_state.dart';
...
class ConfigIamBinding extends pulumi.CustomResource {
  late final pulumi.Output<ConfigIamBindingCondition?> condition;
  ...
  /// Creates a new [ConfigIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ConfigIamBinding]. {@macro pulumi_runtimeconfig_config_iam_binding_config_iam_binding_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  ConfigIamBinding(
    String name, {
    ConfigIamBindingArgs? args,
    ...
    condition = registerOutput<ConfigIamBindingCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ConfigIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [ConfigIamBinding] resource's state with the given [name] and [id].
  static ConfigIamBinding get(
    String name,
    pulumi.Input<String> id, {
    ConfigIamBindingState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return ConfigIamBinding._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [ConfigIamBinding] resource.
  ConfigIamBinding.reference(String urn)
    : super(
        'gcp:runtimeconfig/configIamBinding:ConfigIamBinding',
