...
class ConfigIamMemberState {
  ...
  factory ConfigIamMemberState.fromMap(Map<String, dynamic> map) {
    return ConfigIamMemberState(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConfigIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
