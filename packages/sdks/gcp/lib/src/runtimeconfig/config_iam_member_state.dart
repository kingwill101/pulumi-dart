...
class ConfigIamMemberState {
  ...
  /// Creates a new [ConfigIamMemberState].
  /// [condition] Optional.
  ...
  ConfigIamMemberState({
    pulumi.Output<ConfigIamMemberCondition>? condition,
    ...
    pulumi.Output<String>? role,
      ...
      condition = pulumi.Input.asOptionalInput<ConfigIamMemberCondition>(condition),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'condition': ?pulumi.Input.mapOptionalInputValue<ConfigIamMemberCondition, Map<String, dynamic>>(condition, (value) => value.toMap()),
      'config': ?config,
      'etag': ?etag,
      'member': ?member,
      'project': ?project,
  ...
  factory ConfigIamMemberState.fromMap(Map<String, dynamic> map) {
    return ConfigIamMemberState(
      condition: map['condition'] == null ? null : pulumi.Output.create<ConfigIamMemberCondition>(ConfigIamMemberCondition.fromMap((map['condition'] as Map).cast<String, dynamic>())),
