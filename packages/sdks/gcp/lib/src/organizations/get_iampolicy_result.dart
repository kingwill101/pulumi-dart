...
class GetIAMPolicyResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'auditConfigs': ?(() {
        final guardedValue = auditConfigs;
  ...
  factory GetIAMPolicyResult.fromMap(Map<String, dynamic> map) {
    return GetIAMPolicyResult(
      auditConfigs: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<GetIAMPolicyAuditConfig>(
          guardedValue,
      ...
      bindings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<GetIAMPolicyBinding>(
          guardedValue,
