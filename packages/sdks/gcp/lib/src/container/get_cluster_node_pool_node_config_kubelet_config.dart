...
class GetClusterNodePoolNodeConfigKubeletConfig {
  ...
  factory GetClusterNodePoolNodeConfigKubeletConfig.fromMap(Map<String, dynamic> map) {
    return GetClusterNodePoolNodeConfigKubeletConfig(
      ...
      evictionMinimumReclaims: (pulumi.Input.decodeList<GetClusterNodePoolNodeConfigKubeletConfigEvictionMinimumReclaim>(map['evictionMinimumReclaims'], (value) => GetClusterNodePoolNodeConfigKubeletConfigEvictionMinimumReclaim.fromMap((value as Map).cast<String, dynamic>()))).input(),
      evictionSoftGracePeriods: (pulumi.Input.decodeList<GetClusterNodePoolNodeConfigKubeletConfigEvictionSoftGracePeriod>(map['evictionSoftGracePeriods'], (value) => GetClusterNodePoolNodeConfigKubeletConfigEvictionSoftGracePeriod.fromMap((value as Map).cast<String, dynamic>()))).input(),
      evictionSofts: (pulumi.Input.decodeList<GetClusterNodePoolNodeConfigKubeletConfigEvictionSoft>(map['evictionSofts'], (value) => GetClusterNodePoolNodeConfigKubeletConfigEvictionSoft.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      memoryManagers: (pulumi.Input.decodeList<GetClusterNodePoolNodeConfigKubeletConfigMemoryManager>(map['memoryManagers'], (value) => GetClusterNodePoolNodeConfigKubeletConfigMemoryManager.fromMap((value as Map).cast<String, dynamic>()))).input(),
      podPidsLimit: (map['podPidsLimit'] as int).input(),
      singleProcessOomKill: (map['singleProcessOomKill'] as bool).input(),
      topologyManagers: (pulumi.Input.decodeList<GetClusterNodePoolNodeConfigKubeletConfigTopologyManager>(map['topologyManagers'], (value) => GetClusterNodePoolNodeConfigKubeletConfigTopologyManager.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
