...
class ClusterNodePoolNetworkConfig {
  ...
  final List<ClusterNodePoolNetworkConfigAdditionalNodeNetworkConfig>? additionalNodeNetworkConfigs;
  /// We specify the additional pod networks for this node pool using this list. Each pod network corresponds to an additional alias IP range for the node
  final List<ClusterNodePoolNetworkConfigAdditionalPodNetworkConfig>? additionalPodNetworkConfigs;
  /// Whether to create a new range for pod IPs in this node pool. Defaults are provided for pod_range and pod_ipv4_cidr_block if they are not specified.
  final bool? createPodRange;
  /// Whether nodes have internal IP addresses only.
  final bool? enablePrivateNodes;
  /// Network bandwidth tier configuration.
  final ClusterNodePoolNetworkConfigNetworkPerformanceConfig? networkPerformanceConfig;
  /// Configuration for node-pool level pod cidr overprovision. If not set, the cluster level setting will be inherited
  final ClusterNodePoolNetworkConfigPodCidrOverprovisionConfig? podCidrOverprovisionConfig;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'additionalNodeNetworkConfigs': ?additionalNodeNetworkConfigs == null ? null : pulumi.Input.encodeList<ClusterNodePoolNetworkConfigAdditionalNodeNetworkConfig, Map<String, dynamic>>(additionalNodeNetworkConfigs!, (value) => value.toMap()),
      'additionalPodNetworkConfigs': ?additionalPodNetworkConfigs == null ? null : pulumi.Input.encodeList<ClusterNodePoolNetworkConfigAdditionalPodNetworkConfig, Map<String, dynamic>>(additionalPodNetworkConfigs!, (value) => value.toMap()),
  ...
  factory ClusterNodePoolNetworkConfig.fromMap(Map<String, dynamic> map) {
    return ClusterNodePoolNetworkConfig(
      ...
      additionalNodeNetworkConfigs: map['additionalNodeNetworkConfigs'] == null ? null : pulumi.Input.decodeList<ClusterNodePoolNetworkConfigAdditionalNodeNetworkConfig>(map['additionalNodeNetworkConfigs'], (value) => ClusterNodePoolNetworkConfigAdditionalNodeNetworkConfig.fromMap((value as Map).cast<String, dynamic>())),
      additionalPodNetworkConfigs: map['additionalPodNetworkConfigs'] == null ? null : pulumi.Input.decodeList<ClusterNodePoolNetworkConfigAdditionalPodNetworkConfig>(map['additionalPodNetworkConfigs'], (value) => ClusterNodePoolNetworkConfigAdditionalPodNetworkConfig.fromMap((value as Map).cast<String, dynamic>())),
      ...
      networkPerformanceConfig: map['networkPerformanceConfig'] == null ? null : ClusterNodePoolNetworkConfigNetworkPerformanceConfig.fromMap((map['networkPerformanceConfig'] as Map).cast<String, dynamic>()),
      podCidrOverprovisionConfig: map['podCidrOverprovisionConfig'] == null ? null : ClusterNodePoolNetworkConfigPodCidrOverprovisionConfig.fromMap((map['podCidrOverprovisionConfig'] as Map).cast<String, dynamic>()),
