...
class ClusterNodePoolNetworkConfig {
  ...
  final pulumi.Input<
    List<ClusterNodePoolNetworkConfigAdditionalNodeNetworkConfig>
  >?
  additionalNodeNetworkConfigs;

  /// We specify the additional pod networks for this node pool using this list. Each pod network corresponds to an additional alias IP range for the node
  final pulumi.Input<
    List<ClusterNodePoolNetworkConfigAdditionalPodNetworkConfig>
  >?
  ...
  final pulumi.Input<ClusterNodePoolNetworkConfigNetworkPerformanceConfig>?
  networkPerformanceConfig;

  /// Configuration for node-pool level pod cidr overprovision. If not set, the cluster level setting will be inherited
  final pulumi.Input<ClusterNodePoolNetworkConfigPodCidrOverprovisionConfig>?
      ...
      additionalNodeNetworkConfigs: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                ClusterNodePoolNetworkConfigAdditionalNodeNetworkConfig.fromMap(
      ...
      additionalPodNetworkConfigs: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                ClusterNodePoolNetworkConfigAdditionalPodNetworkConfig.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
