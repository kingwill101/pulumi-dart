...
class AwsNodePoolConfig {
  ...
  final pulumi.Input<AwsNodePoolConfigAutoscalingMetricsCollection>?
    ...
    return <String, dynamic>{
      'autoscalingMetricsCollection':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(autoscalingMetricsCollection, (value) => value.toMap()),
      'configEncryption':
  ...
  factory AwsNodePoolConfig.fromMap(Map<String, dynamic> map) {
    return AwsNodePoolConfig(
      autoscalingMetricsCollection: (() {
        final guardedValue = map['autoscalingMetricsCollection'];
      ...
      configEncryption: pulumi.Input.fromValue(
        AwsNodePoolConfigConfigEncryption.fromMap(
      ...
      spotConfig: (() {
        final guardedValue = map['spotConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
