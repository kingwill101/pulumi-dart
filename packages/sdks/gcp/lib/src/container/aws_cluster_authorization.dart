...
class AwsClusterAuthorization {
  ...
  factory AwsClusterAuthorization.fromMap(Map<String, dynamic> map) {
    return AwsClusterAuthorization(
      adminGroups: (() { final guardedValue = map['adminGroups']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AwsClusterAuthorizationAdminGroup>(guardedValue, (value) => AwsClusterAuthorizationAdminGroup.fromMap((value as Map).cast<String, dynamic>()))); })(),
      adminUsers: pulumi.Input.fromValue(pulumi.Input.decodeList<AwsClusterAuthorizationAdminUser>(map['adminUsers']!, (value) => AwsClusterAuthorizationAdminUser.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
