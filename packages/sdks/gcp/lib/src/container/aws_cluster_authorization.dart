...
class AwsClusterAuthorization {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'adminGroups': ?adminGroups == null ? null : pulumi.Input.encodeList<AwsClusterAuthorizationAdminGroup, Map<String, dynamic>>(adminGroups!, (value) => value.toMap()),
      'adminUsers': pulumi.Input.encodeList<AwsClusterAuthorizationAdminUser, Map<String, dynamic>>(adminUsers, (value) => value.toMap()),
    };
  }

  factory AwsClusterAuthorization.fromMap(Map<String, dynamic> map) {
    return AwsClusterAuthorization(
      adminGroups: map['adminGroups'] == null ? null : pulumi.Input.decodeList<AwsClusterAuthorizationAdminGroup>(map['adminGroups'], (value) => AwsClusterAuthorizationAdminGroup.fromMap((value as Map).cast<String, dynamic>())),
      adminUsers: pulumi.Input.decodeList<AwsClusterAuthorizationAdminUser>(map['adminUsers'], (value) => AwsClusterAuthorizationAdminUser.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
