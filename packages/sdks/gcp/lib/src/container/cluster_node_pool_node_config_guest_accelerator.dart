...
class ClusterNodePoolNodeConfigGuestAccelerator {
  ...
  final ClusterNodePoolNodeConfigGuestAcceleratorGpuDriverInstallationConfig? gpuDriverInstallationConfig;
  /// Size of partitions to create on the GPU. Valid values are described in the NVIDIA mig [user guide](https://docs.nvidia.com/datacenter/tesla/mig-user-guide/#partitioning).
  final String? gpuPartitionSize;
  /// Configuration for GPU sharing. Structure is documented below.
  final ClusterNodePoolNodeConfigGuestAcceleratorGpuSharingConfig? gpuSharingConfig;
  ...
  factory ClusterNodePoolNodeConfigGuestAccelerator.fromMap(Map<String, dynamic> map) {
    return ClusterNodePoolNodeConfigGuestAccelerator(
      ...
      gpuDriverInstallationConfig: map['gpuDriverInstallationConfig'] == null ? null : ClusterNodePoolNodeConfigGuestAcceleratorGpuDriverInstallationConfig.fromMap((map['gpuDriverInstallationConfig'] as Map).cast<String, dynamic>()),
      gpuPartitionSize: map['gpuPartitionSize'] == null ? null : map['gpuPartitionSize'] as String,
      gpuSharingConfig: map['gpuSharingConfig'] == null ? null : ClusterNodePoolNodeConfigGuestAcceleratorGpuSharingConfig.fromMap((map['gpuSharingConfig'] as Map).cast<String, dynamic>()),
