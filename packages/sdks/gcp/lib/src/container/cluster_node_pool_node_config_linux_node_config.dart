...
import 'cluster_node_pool_node_config_linux_node_config_accurate_time_config.dart';
import 'cluster_node_pool_node_config_linux_node_config_custom_node_init.dart';
...
import 'cluster_node_pool_node_config_linux_node_config_swap_config.dart';
...
class ClusterNodePoolNodeConfigLinuxNodeConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'accurateTimeConfig': ?pulumi.Input.mapOptionalInputValue<ClusterNodePoolNodeConfigLinuxNodeConfigAccurateTimeConfig, Map<String, dynamic>>(accurateTimeConfig, (value) => value.toMap()),
      'cgroupMode': ?cgroupMode,
      'customNodeInit': ?pulumi.Input.mapOptionalInputValue<ClusterNodePoolNodeConfigLinuxNodeConfigCustomNodeInit, Map<String, dynamic>>(customNodeInit, (value) => value.toMap()),
      ...
      'swapConfig': ?pulumi.Input.mapOptionalInputValue<ClusterNodePoolNodeConfigLinuxNodeConfigSwapConfig, Map<String, dynamic>>(swapConfig, (value) => value.toMap()),
      'sysctls': ?sysctls,
  ...
  factory ClusterNodePoolNodeConfigLinuxNodeConfig.fromMap(Map<String, dynamic> map) {
    return ClusterNodePoolNodeConfigLinuxNodeConfig(
      accurateTimeConfig: (() { final guardedValue = map['accurateTimeConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterNodePoolNodeConfigLinuxNodeConfigAccurateTimeConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      customNodeInit: (() { final guardedValue = map['customNodeInit']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterNodePoolNodeConfigLinuxNodeConfigCustomNodeInit.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      swapConfig: (() { final guardedValue = map['swapConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterNodePoolNodeConfigLinuxNodeConfigSwapConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
