...
class ClusterNodePoolNodeConfigLinuxNodeConfig {
  ...
  final pulumi.Input<ClusterNodePoolNodeConfigLinuxNodeConfigHugepagesConfig>?
  hugepagesConfig;
  ...
  factory ClusterNodePoolNodeConfigLinuxNodeConfig.fromMap(
    ...
    return ClusterNodePoolNodeConfigLinuxNodeConfig(
      ...
      hugepagesConfig: (() {
        ...
        return pulumi.Input.fromValue(
          ClusterNodePoolNodeConfigLinuxNodeConfigHugepagesConfig.fromMap(
      ...
      nodeKernelModuleLoading: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ClusterNodePoolNodeConfigLinuxNodeConfigNodeKernelModuleLoading.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
