...
class ClusterNodePoolNodeConfigLinuxNodeConfig {
  ...
  factory ClusterNodePoolNodeConfigLinuxNodeConfig.fromMap(Map<String, dynamic> map) {
    return ClusterNodePoolNodeConfigLinuxNodeConfig(
      ...
      hugepagesConfig: map['hugepagesConfig'] == null ? null : (ClusterNodePoolNodeConfigLinuxNodeConfigHugepagesConfig.fromMap((map['hugepagesConfig'] as Map).cast<String, dynamic>())).input(),
      nodeKernelModuleLoading: map['nodeKernelModuleLoading'] == null ? null : (ClusterNodePoolNodeConfigLinuxNodeConfigNodeKernelModuleLoading.fromMap((map['nodeKernelModuleLoading'] as Map).cast<String, dynamic>())).input(),
