...
class NodePoolNetworkConfig {
  ...
  final pulumi.Input<List<NodePoolNetworkConfigAdditionalNodeNetworkConfig>>?
  additionalNodeNetworkConfigs;

  /// We specify the additional pod networks for this node pool using this list. Each pod network corresponds to an additional alias IP range for the node.
  /// Structure is documented below
  final pulumi.Input<List<NodePoolNetworkConfigAdditionalPodNetworkConfig>>?
  ...
  final pulumi.Input<NodePoolNetworkConfigNetworkPerformanceConfig>?
  ...
  final pulumi.Input<NodePoolNetworkConfigPodCidrOverprovisionConfig>?
    ...
    return <String, dynamic>{
      ...
      'additionalNodeNetworkConfigs':
          ?pulumi.Input.mapOptionalInputValue<
            List<NodePoolNetworkConfigAdditionalNodeNetworkConfig>,
      ...
      'additionalPodNetworkConfigs':
          ?pulumi.Input.mapOptionalInputValue<
            List<NodePoolNetworkConfigAdditionalPodNetworkConfig>,
            List<Map<String, dynamic>>
          >(
            additionalPodNetworkConfigs,
            (value) =>
  ...
  factory NodePoolNetworkConfig.fromMap(Map<String, dynamic> map) {
    return NodePoolNetworkConfig(
      acceleratorNetworkProfile: (() {
        final guardedValue = map['acceleratorNetworkProfile'];
      ...
      additionalNodeNetworkConfigs: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => NodePoolNetworkConfigAdditionalNodeNetworkConfig.fromMap(
      ...
      additionalPodNetworkConfigs: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => NodePoolNetworkConfigAdditionalPodNetworkConfig.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
