...
class ClusterArgs {
  ...
  ClusterArgs({
    pulumi.Output<ClusterAddonsConfig>? addonsConfig,
    pulumi.Output<bool>? allowNetAdmin,
    pulumi.Output<ClusterAnonymousAuthenticationConfig>? anonymousAuthenticationConfig,
    pulumi.Output<ClusterAuthenticatorGroupsConfig>? authenticatorGroupsConfig,
    pulumi.Output<ClusterBinaryAuthorization>? binaryAuthorization,
    pulumi.Output<ClusterClusterAutoscaling>? clusterAutoscaling,
    pulumi.Output<String>? clusterIpv4Cidr,
    pulumi.Output<ClusterClusterTelemetry>? clusterTelemetry,
    pulumi.Output<ClusterConfidentialNodes>? confidentialNodes,
    pulumi.Output<ClusterControlPlaneEndpointsConfig>? controlPlaneEndpointsConfig,
    pulumi.Output<ClusterCostManagementConfig>? costManagementConfig,
    pulumi.Output<ClusterDatabaseEncryption>? databaseEncryption,
    pulumi.Output<String>? datapathProvider,
    pulumi.Output<int>? defaultMaxPodsPerNode,
    pulumi.Output<ClusterDefaultSnatStatus>? defaultSnatStatus,
    pulumi.Output<bool>? deletionProtection,
    pulumi.Output<String>? description,
    pulumi.Output<bool>? disableL4LbFirewallReconciliation,
    pulumi.Output<ClusterDnsConfig>? dnsConfig,
    pulumi.Output<bool>? enableAutopilot,
    pulumi.Output<bool>? enableCiliumClusterwideNetworkPolicy,
    pulumi.Output<bool>? enableFqdnNetworkPolicy,
    pulumi.Output<bool>? enableIntranodeVisibility,
    pulumi.Output<ClusterEnableK8sBetaApis>? enableK8sBetaApis,
    pulumi.Output<bool>? enableKubernetesAlpha,
    pulumi.Output<bool>? enableL4IlbSubsetting,
    pulumi.Output<bool>? enableLegacyAbac,
    pulumi.Output<bool>? enableMultiNetworking,
    pulumi.Output<bool>? enableShieldedNodes,
    pulumi.Output<bool>? enableTpu,
    pulumi.Output<ClusterEnterpriseConfig>? enterpriseConfig,
    pulumi.Output<ClusterFleet>? fleet,
    pulumi.Output<ClusterGatewayApiConfig>? gatewayApiConfig,
    pulumi.Output<ClusterGkeAutoUpgradeConfig>? gkeAutoUpgradeConfig,
    pulumi.Output<ClusterIdentityServiceConfig>? identityServiceConfig,
    pulumi.Output<String>? inTransitEncryptionConfig,
    pulumi.Output<int>? initialNodeCount,
    pulumi.Output<ClusterIpAllocationPolicy>? ipAllocationPolicy,
    pulumi.Output<String>? location,
    pulumi.Output<ClusterLoggingConfig>? loggingConfig,
    pulumi.Output<String>? loggingService,
    pulumi.Output<ClusterMaintenancePolicy>? maintenancePolicy,
    pulumi.Output<ClusterManagedOpentelemetryConfig>? managedOpentelemetryConfig,
    pulumi.Output<ClusterMasterAuth>? masterAuth,
    pulumi.Output<ClusterMasterAuthorizedNetworksConfig>? masterAuthorizedNetworksConfig,
    pulumi.Output<ClusterMeshCertificates>? meshCertificates,
    pulumi.Output<String>? minMasterVersion,
    pulumi.Output<ClusterMonitoringConfig>? monitoringConfig,
    pulumi.Output<String>? monitoringService,
    pulumi.Output<String>? name,
    pulumi.Output<String>? network,
    pulumi.Output<ClusterNetworkPerformanceConfig>? networkPerformanceConfig,
    pulumi.Output<ClusterNetworkPolicy>? networkPolicy,
    pulumi.Output<String>? networkingMode,
    pulumi.Output<ClusterNodeConfig>? nodeConfig,
    pulumi.Output<List<String>>? nodeLocations,
    pulumi.Output<ClusterNodePoolAutoConfig>? nodePoolAutoConfig,
    pulumi.Output<ClusterNodePoolDefaults>? nodePoolDefaults,
    pulumi.Output<List<ClusterNodePool>>? nodePools,
    pulumi.Output<String>? nodeVersion,
    pulumi.Output<ClusterNotificationConfig>? notificationConfig,
    pulumi.Output<ClusterPodAutoscaling>? podAutoscaling,
    pulumi.Output<ClusterPodSecurityPolicyConfig>? podSecurityPolicyConfig,
    pulumi.Output<ClusterPrivateClusterConfig>? privateClusterConfig,
    pulumi.Output<String>? privateIpv6GoogleAccess,
    pulumi.Output<String>? project,
    pulumi.Output<ClusterProtectConfig>? protectConfig,
    pulumi.Output<ClusterRbacBindingConfig>? rbacBindingConfig,
    pulumi.Output<ClusterReleaseChannel>? releaseChannel,
    pulumi.Output<bool>? removeDefaultNodePool,
    pulumi.Output<Map<String, String>>? resourceLabels,
    pulumi.Output<ClusterResourceUsageExportConfig>? resourceUsageExportConfig,
    pulumi.Output<ClusterSecretManagerConfig>? secretManagerConfig,
    pulumi.Output<ClusterSecretSyncConfig>? secretSyncConfig,
    pulumi.Output<ClusterSecurityPostureConfig>? securityPostureConfig,
    pulumi.Output<ClusterServiceExternalIpsConfig>? serviceExternalIpsConfig,
    pulumi.Output<String>? subnetwork,
    pulumi.Output<ClusterTpuConfig>? tpuConfig,
    pulumi.Output<ClusterUserManagedKeysConfig>? userManagedKeysConfig,
    pulumi.Output<ClusterVerticalPodAutoscaling>? verticalPodAutoscaling,
    pulumi.Output<ClusterWorkloadAltsConfig>? workloadAltsConfig,
    pulumi.Output<ClusterWorkloadIdentityConfig>? workloadIdentityConfig,
  }) :
  ...
  factory ClusterArgs.fromMap(Map<String, dynamic> map) {
    return ClusterArgs(
      addonsConfig: map['addonsConfig'] == null ? null : pulumi.Output.create<ClusterAddonsConfig>(ClusterAddonsConfig.fromMap((map['addonsConfig'] as Map).cast<String, dynamic>())),
      allowNetAdmin: map['allowNetAdmin'] == null ? null : pulumi.Output.create<bool>(map['allowNetAdmin'] as bool),
      anonymousAuthenticationConfig: map['anonymousAuthenticationConfig'] == null ? null : pulumi.Output.create<ClusterAnonymousAuthenticationConfig>(ClusterAnonymousAuthenticationConfig.fromMap((map['anonymousAuthenticationConfig'] as Map).cast<String, dynamic>())),
      authenticatorGroupsConfig: map['authenticatorGroupsConfig'] == null ? null : pulumi.Output.create<ClusterAuthenticatorGroupsConfig>(ClusterAuthenticatorGroupsConfig.fromMap((map['authenticatorGroupsConfig'] as Map).cast<String, dynamic>())),
      binaryAuthorization: map['binaryAuthorization'] == null ? null : pulumi.Output.create<ClusterBinaryAuthorization>(ClusterBinaryAuthorization.fromMap((map['binaryAuthorization'] as Map).cast<String, dynamic>())),
      clusterAutoscaling: map['clusterAutoscaling'] == null ? null : pulumi.Output.create<ClusterClusterAutoscaling>(ClusterClusterAutoscaling.fromMap((map['clusterAutoscaling'] as Map).cast<String, dynamic>())),
      clusterIpv4Cidr: map['clusterIpv4Cidr'] == null ? null : pulumi.Output.create<String>(map['clusterIpv4Cidr'] as String),
      clusterTelemetry: map['clusterTelemetry'] == null ? null : pulumi.Output.create<ClusterClusterTelemetry>(ClusterClusterTelemetry.fromMap((map['clusterTelemetry'] as Map).cast<String, dynamic>())),
      confidentialNodes: map['confidentialNodes'] == null ? null : pulumi.Output.create<ClusterConfidentialNodes>(ClusterConfidentialNodes.fromMap((map['confidentialNodes'] as Map).cast<String, dynamic>())),
      controlPlaneEndpointsConfig: map['controlPlaneEndpointsConfig'] == null ? null : pulumi.Output.create<ClusterControlPlaneEndpointsConfig>(ClusterControlPlaneEndpointsConfig.fromMap((map['controlPlaneEndpointsConfig'] as Map).cast<String, dynamic>())),
      costManagementConfig: map['costManagementConfig'] == null ? null : pulumi.Output.create<ClusterCostManagementConfig>(ClusterCostManagementConfig.fromMap((map['costManagementConfig'] as Map).cast<String, dynamic>())),
      databaseEncryption: map['databaseEncryption'] == null ? null : pulumi.Output.create<ClusterDatabaseEncryption>(ClusterDatabaseEncryption.fromMap((map['databaseEncryption'] as Map).cast<String, dynamic>())),
      datapathProvider: map['datapathProvider'] == null ? null : pulumi.Output.create<String>(map['datapathProvider'] as String),
      defaultMaxPodsPerNode: map['defaultMaxPodsPerNode'] == null ? null : pulumi.Output.create<int>(map['defaultMaxPodsPerNode'] as int),
      defaultSnatStatus: map['defaultSnatStatus'] == null ? null : pulumi.Output.create<ClusterDefaultSnatStatus>(ClusterDefaultSnatStatus.fromMap((map['defaultSnatStatus'] as Map).cast<String, dynamic>())),
      deletionProtection: map['deletionProtection'] == null ? null : pulumi.Output.create<bool>(map['deletionProtection'] as bool),
      description: map['description'] == null ? null : pulumi.Output.create<String>(map['description'] as String),
      disableL4LbFirewallReconciliation: map['disableL4LbFirewallReconciliation'] == null ? null : pulumi.Output.create<bool>(map['disableL4LbFirewallReconciliation'] as bool),
      dnsConfig: map['dnsConfig'] == null ? null : pulumi.Output.create<ClusterDnsConfig>(ClusterDnsConfig.fromMap((map['dnsConfig'] as Map).cast<String, dynamic>())),
      enableAutopilot: map['enableAutopilot'] == null ? null : pulumi.Output.create<bool>(map['enableAutopilot'] as bool),
      enableCiliumClusterwideNetworkPolicy: map['enableCiliumClusterwideNetworkPolicy'] == null ? null : pulumi.Output.create<bool>(map['enableCiliumClusterwideNetworkPolicy'] as bool),
      enableFqdnNetworkPolicy: map['enableFqdnNetworkPolicy'] == null ? null : pulumi.Output.create<bool>(map['enableFqdnNetworkPolicy'] as bool),
      enableIntranodeVisibility: map['enableIntranodeVisibility'] == null ? null : pulumi.Output.create<bool>(map['enableIntranodeVisibility'] as bool),
      enableK8sBetaApis: map['enableK8sBetaApis'] == null ? null : pulumi.Output.create<ClusterEnableK8sBetaApis>(ClusterEnableK8sBetaApis.fromMap((map['enableK8sBetaApis'] as Map).cast<String, dynamic>())),
      enableKubernetesAlpha: map['enableKubernetesAlpha'] == null ? null : pulumi.Output.create<bool>(map['enableKubernetesAlpha'] as bool),
      enableL4IlbSubsetting: map['enableL4IlbSubsetting'] == null ? null : pulumi.Output.create<bool>(map['enableL4IlbSubsetting'] as bool),
      enableLegacyAbac: map['enableLegacyAbac'] == null ? null : pulumi.Output.create<bool>(map['enableLegacyAbac'] as bool),
      enableMultiNetworking: map['enableMultiNetworking'] == null ? null : pulumi.Output.create<bool>(map['enableMultiNetworking'] as bool),
      enableShieldedNodes: map['enableShieldedNodes'] == null ? null : pulumi.Output.create<bool>(map['enableShieldedNodes'] as bool),
      enableTpu: map['enableTpu'] == null ? null : pulumi.Output.create<bool>(map['enableTpu'] as bool),
      enterpriseConfig: map['enterpriseConfig'] == null ? null : pulumi.Output.create<ClusterEnterpriseConfig>(ClusterEnterpriseConfig.fromMap((map['enterpriseConfig'] as Map).cast<String, dynamic>())),
      fleet: map['fleet'] == null ? null : pulumi.Output.create<ClusterFleet>(ClusterFleet.fromMap((map['fleet'] as Map).cast<String, dynamic>())),
      gatewayApiConfig: map['gatewayApiConfig'] == null ? null : pulumi.Output.create<ClusterGatewayApiConfig>(ClusterGatewayApiConfig.fromMap((map['gatewayApiConfig'] as Map).cast<String, dynamic>())),
      gkeAutoUpgradeConfig: map['gkeAutoUpgradeConfig'] == null ? null : pulumi.Output.create<ClusterGkeAutoUpgradeConfig>(ClusterGkeAutoUpgradeConfig.fromMap((map['gkeAutoUpgradeConfig'] as Map).cast<String, dynamic>())),
      identityServiceConfig: map['identityServiceConfig'] == null ? null : pulumi.Output.create<ClusterIdentityServiceConfig>(ClusterIdentityServiceConfig.fromMap((map['identityServiceConfig'] as Map).cast<String, dynamic>())),
      inTransitEncryptionConfig: map['inTransitEncryptionConfig'] == null ? null : pulumi.Output.create<String>(map['inTransitEncryptionConfig'] as String),
      initialNodeCount: map['initialNodeCount'] == null ? null : pulumi.Output.create<int>(map['initialNodeCount'] as int),
      ipAllocationPolicy: map['ipAllocationPolicy'] == null ? null : pulumi.Output.create<ClusterIpAllocationPolicy>(ClusterIpAllocationPolicy.fromMap((map['ipAllocationPolicy'] as Map).cast<String, dynamic>())),
      location: map['location'] == null ? null : pulumi.Output.create<String>(map['location'] as String),
      loggingConfig: map['loggingConfig'] == null ? null : pulumi.Output.create<ClusterLoggingConfig>(ClusterLoggingConfig.fromMap((map['loggingConfig'] as Map).cast<String, dynamic>())),
      ...
      managedOpentelemetryConfig: map['managedOpentelemetryConfig'] == null ? null : pulumi.Output.create<ClusterManagedOpentelemetryConfig>(ClusterManagedOpentelemetryConfig.fromMap((map['managedOpentelemetryConfig'] as Map).cast<String, dynamic>())),
      masterAuth: map['masterAuth'] == null ? null : pulumi.Output.create<ClusterMasterAuth>(ClusterMasterAuth.fromMap((map['masterAuth'] as Map).cast<String, dynamic>())),
      masterAuthorizedNetworksConfig: map['masterAuthorizedNetworksConfig'] == null ? null : pulumi.Output.create<ClusterMasterAuthorizedNetworksConfig>(ClusterMasterAuthorizedNetworksConfig.fromMap((map['masterAuthorizedNetworksConfig'] as Map).cast<String, dynamic>())),
      meshCertificates: map['meshCertificates'] == null ? null : pulumi.Output.create<ClusterMeshCertificates>(ClusterMeshCertificates.fromMap((map['meshCertificates'] as Map).cast<String, dynamic>())),
      minMasterVersion: map['minMasterVersion'] == null ? null : pulumi.Output.create<String>(map['minMasterVersion'] as String),
      monitoringConfig: map['monitoringConfig'] == null ? null : pulumi.Output.create<ClusterMonitoringConfig>(ClusterMonitoringConfig.fromMap((map['monitoringConfig'] as Map).cast<String, dynamic>())),
      ...
      networkPerformanceConfig: map['networkPerformanceConfig'] == null ? null : pulumi.Output.create<ClusterNetworkPerformanceConfig>(ClusterNetworkPerformanceConfig.fromMap((map['networkPerformanceConfig'] as Map).cast<String, dynamic>())),
      networkPolicy: map['networkPolicy'] == null ? null : pulumi.Output.create<ClusterNetworkPolicy>(ClusterNetworkPolicy.fromMap((map['networkPolicy'] as Map).cast<String, dynamic>())),
      networkingMode: map['networkingMode'] == null ? null : pulumi.Output.create<String>(map['networkingMode'] as String),
      nodeConfig: map['nodeConfig'] == null ? null : pulumi.Output.create<ClusterNodeConfig>(ClusterNodeConfig.fromMap((map['nodeConfig'] as Map).cast<String, dynamic>())),
      nodeLocations: map['nodeLocations'] == null ? null : pulumi.Output.create<List<String>>((map['nodeLocations'] as List).cast<String>()),
      nodePoolAutoConfig: map['nodePoolAutoConfig'] == null ? null : pulumi.Output.create<ClusterNodePoolAutoConfig>(ClusterNodePoolAutoConfig.fromMap((map['nodePoolAutoConfig'] as Map).cast<String, dynamic>())),
      nodePoolDefaults: map['nodePoolDefaults'] == null ? null : pulumi.Output.create<ClusterNodePoolDefaults>(ClusterNodePoolDefaults.fromMap((map['nodePoolDefaults'] as Map).cast<String, dynamic>())),
      nodePools: map['nodePools'] == null ? null : pulumi.Output.create<List<ClusterNodePool>>(pulumi.Input.decodeList<ClusterNodePool>(map['nodePools'], (value) => ClusterNodePool.fromMap((value as Map).cast<String, dynamic>()))),
      nodeVersion: map['nodeVersion'] == null ? null : pulumi.Output.create<String>(map['nodeVersion'] as String),
      notificationConfig: map['notificationConfig'] == null ? null : pulumi.Output.create<ClusterNotificationConfig>(ClusterNotificationConfig.fromMap((map['notificationConfig'] as Map).cast<String, dynamic>())),
      podAutoscaling: map['podAutoscaling'] == null ? null : pulumi.Output.create<ClusterPodAutoscaling>(ClusterPodAutoscaling.fromMap((map['podAutoscaling'] as Map).cast<String, dynamic>())),
      podSecurityPolicyConfig: map['podSecurityPolicyConfig'] == null ? null : pulumi.Output.create<ClusterPodSecurityPolicyConfig>(ClusterPodSecurityPolicyConfig.fromMap((map['podSecurityPolicyConfig'] as Map).cast<String, dynamic>())),
      privateClusterConfig: map['privateClusterConfig'] == null ? null : pulumi.Output.create<ClusterPrivateClusterConfig>(ClusterPrivateClusterConfig.fromMap((map['privateClusterConfig'] as Map).cast<String, dynamic>())),
      ...
      protectConfig: map['protectConfig'] == null ? null : pulumi.Output.create<ClusterProtectConfig>(ClusterProtectConfig.fromMap((map['protectConfig'] as Map).cast<String, dynamic>())),
      rbacBindingConfig: map['rbacBindingConfig'] == null ? null : pulumi.Output.create<ClusterRbacBindingConfig>(ClusterRbacBindingConfig.fromMap((map['rbacBindingConfig'] as Map).cast<String, dynamic>())),
      releaseChannel: map['releaseChannel'] == null ? null : pulumi.Output.create<ClusterReleaseChannel>(ClusterReleaseChannel.fromMap((map['releaseChannel'] as Map).cast<String, dynamic>())),
      removeDefaultNodePool: map['removeDefaultNodePool'] == null ? null : pulumi.Output.create<bool>(map['removeDefaultNodePool'] as bool),
      ...
      resourceUsageExportConfig: map['resourceUsageExportConfig'] == null ? null : pulumi.Output.create<ClusterResourceUsageExportConfig>(ClusterResourceUsageExportConfig.fromMap((map['resourceUsageExportConfig'] as Map).cast<String, dynamic>())),
      secretManagerConfig: map['secretManagerConfig'] == null ? null : pulumi.Output.create<ClusterSecretManagerConfig>(ClusterSecretManagerConfig.fromMap((map['secretManagerConfig'] as Map).cast<String, dynamic>())),
      secretSyncConfig: map['secretSyncConfig'] == null ? null : pulumi.Output.create<ClusterSecretSyncConfig>(ClusterSecretSyncConfig.fromMap((map['secretSyncConfig'] as Map).cast<String, dynamic>())),
      securityPostureConfig: map['securityPostureConfig'] == null ? null : pulumi.Output.create<ClusterSecurityPostureConfig>(ClusterSecurityPostureConfig.fromMap((map['securityPostureConfig'] as Map).cast<String, dynamic>())),
      serviceExternalIpsConfig: map['serviceExternalIpsConfig'] == null ? null : pulumi.Output.create<ClusterServiceExternalIpsConfig>(ClusterServiceExternalIpsConfig.fromMap((map['serviceExternalIpsConfig'] as Map).cast<String, dynamic>())),
      subnetwork: map['subnetwork'] == null ? null : pulumi.Output.create<String>(map['subnetwork'] as String),
      tpuConfig: map['tpuConfig'] == null ? null : pulumi.Output.create<ClusterTpuConfig>(ClusterTpuConfig.fromMap((map['tpuConfig'] as Map).cast<String, dynamic>())),
      userManagedKeysConfig: map['userManagedKeysConfig'] == null ? null : pulumi.Output.create<ClusterUserManagedKeysConfig>(ClusterUserManagedKeysConfig.fromMap((map['userManagedKeysConfig'] as Map).cast<String, dynamic>())),
      verticalPodAutoscaling: map['verticalPodAutoscaling'] == null ? null : pulumi.Output.create<ClusterVerticalPodAutoscaling>(ClusterVerticalPodAutoscaling.fromMap((map['verticalPodAutoscaling'] as Map).cast<String, dynamic>())),
      workloadAltsConfig: map['workloadAltsConfig'] == null ? null : pulumi.Output.create<ClusterWorkloadAltsConfig>(ClusterWorkloadAltsConfig.fromMap((map['workloadAltsConfig'] as Map).cast<String, dynamic>())),
      workloadIdentityConfig: map['workloadIdentityConfig'] == null ? null : pulumi.Output.create<ClusterWorkloadIdentityConfig>(ClusterWorkloadIdentityConfig.fromMap((map['workloadIdentityConfig'] as Map).cast<String, dynamic>())),
    );
  }
}
