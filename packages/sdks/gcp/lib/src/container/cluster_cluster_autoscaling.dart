...
class ClusterClusterAutoscaling {
  ...
  factory ClusterClusterAutoscaling.fromMap(Map<String, dynamic> map) {
    return ClusterClusterAutoscaling(
      autoProvisioningDefaults: (() { final guardedValue = map['autoProvisioningDefaults']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterClusterAutoscalingAutoProvisioningDefaults.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      autoscalingProfile: (() { final guardedValue = map['autoscalingProfile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      defaultComputeClassEnabled: (() { final guardedValue = map['defaultComputeClassEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      enabled: (() { final guardedValue = map['enabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      resourceLimits: (() { final guardedValue = map['resourceLimits']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ClusterClusterAutoscalingResourceLimit>(guardedValue, (value) => ClusterClusterAutoscalingResourceLimit.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
