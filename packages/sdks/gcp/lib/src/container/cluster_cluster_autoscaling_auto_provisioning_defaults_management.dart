...
class ClusterClusterAutoscalingAutoProvisioningDefaultsManagement {
  ...
  /// [upgradeOptions] Specifies the [Auto Upgrade knobs](https://cloud.google.com/kubernetes-engine/docs/reference/rest/v1beta1/NodeManagement#AutoUpgradeOptions) for the node pool.
