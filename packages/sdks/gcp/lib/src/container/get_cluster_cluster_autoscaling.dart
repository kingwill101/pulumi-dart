...
class GetClusterClusterAutoscaling {
  ...
  final pulumi.Input<List<GetClusterClusterAutoscalingAutoProvisioningDefault>>
  ...
  final pulumi.Input<List<GetClusterClusterAutoscalingResourceLimit>>
  resourceLimits;
    ...
    return <String, dynamic>{
      'autoProvisioningDefaults':
          pulumi.Input.mapInputValue<
            List<GetClusterClusterAutoscalingAutoProvisioningDefault>,
      ...
      'resourceLimits':
          pulumi.Input.mapInputValue<
            List<GetClusterClusterAutoscalingResourceLimit>,
            List<Map<String, dynamic>>
          >(
            resourceLimits,
            (value) =>
  ...
  factory GetClusterClusterAutoscaling.fromMap(Map<String, dynamic> map) {
    return GetClusterClusterAutoscaling(
      autoProvisioningDefaults: pulumi.Input.fromValue(
      ...
      defaultComputeClassEnabled: pulumi.Input.fromValue(
