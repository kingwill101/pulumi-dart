...
class GetClusterClusterAutoscaling {
  ...
  factory GetClusterClusterAutoscaling.fromMap(Map<String, dynamic> map) {
    return GetClusterClusterAutoscaling(
      autoProvisioningDefaults: (pulumi.Input.decodeList<GetClusterClusterAutoscalingAutoProvisioningDefault>(map['autoProvisioningDefaults'], (value) => GetClusterClusterAutoscalingAutoProvisioningDefault.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      defaultComputeClassEnabled: (map['defaultComputeClassEnabled'] as bool).input(),
      enabled: (map['enabled'] as bool).input(),
      resourceLimits: (pulumi.Input.decodeList<GetClusterClusterAutoscalingResourceLimit>(map['resourceLimits'], (value) => GetClusterClusterAutoscalingResourceLimit.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
