...
import 'cluster_node_pool_node_config_node_image_config.dart';
...
import 'cluster_node_pool_node_config_taint_config.dart';
...
class ClusterNodePoolNodeConfig {
  ...
  final pulumi.Input<List<ClusterNodePoolNodeConfigNodeImageConfig>>? nodeImageConfigs;
  ...
  final pulumi.Input<ClusterNodePoolNodeConfigTaintConfig>? taintConfig;
  /// A list of
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'nodeGroup': ?nodeGroup,
      'nodeImageConfigs': ?pulumi.Input.mapOptionalInputValue<List<ClusterNodePoolNodeConfigNodeImageConfig>, List<Map<String, dynamic>>>(nodeImageConfigs, (value) => pulumi.Input.encodeList<ClusterNodePoolNodeConfigNodeImageConfig, Map<String, dynamic>>(value, (value) => value.toMap())),
      ...
      'tags': ?tags,
      'taintConfig': ?pulumi.Input.mapOptionalInputValue<ClusterNodePoolNodeConfigTaintConfig, Map<String, dynamic>>(taintConfig, (value) => value.toMap()),
  ...
  factory ClusterNodePoolNodeConfig.fromMap(Map<String, dynamic> map) {
    return ClusterNodePoolNodeConfig(
      ...
      nodeImageConfigs: (() { final guardedValue = map['nodeImageConfigs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ClusterNodePoolNodeConfigNodeImageConfig>(guardedValue, (value) => ClusterNodePoolNodeConfigNodeImageConfig.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      taintConfig: (() { final guardedValue = map['taintConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterNodePoolNodeConfigTaintConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
