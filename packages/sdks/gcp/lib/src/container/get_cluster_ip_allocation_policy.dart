...
class GetClusterIpAllocationPolicy {
  ...
  final List<GetClusterIpAllocationPolicyAdditionalIpRangesConfig> additionalIpRangesConfigs;
  /// AdditionalPodRangesConfig is the configuration for additional pod secondary ranges supporting the ClusterUpdate message.
  final List<GetClusterIpAllocationPolicyAdditionalPodRangesConfig> additionalPodRangesConfigs;
  ...
  final List<GetClusterIpAllocationPolicyPodCidrOverprovisionConfig> podCidrOverprovisionConfigs;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'additionalIpRangesConfigs': pulumi.Input.encodeList<GetClusterIpAllocationPolicyAdditionalIpRangesConfig, Map<String, dynamic>>(additionalIpRangesConfigs, (value) => value.toMap()),
      'additionalPodRangesConfigs': pulumi.Input.encodeList<GetClusterIpAllocationPolicyAdditionalPodRangesConfig, Map<String, dynamic>>(additionalPodRangesConfigs, (value) => value.toMap()),
      'autoIpamConfigs': pulumi.Input.encodeList<GetClusterIpAllocationPolicyAutoIpamConfig, Map<String, dynamic>>(autoIpamConfigs, (value) => value.toMap()),
      'clusterIpv4CidrBlock': clusterIpv4CidrBlock,
      'clusterSecondaryRangeName': clusterSecondaryRangeName,
      'networkTierConfigs': pulumi.Input.encodeList<GetClusterIpAllocationPolicyNetworkTierConfig, Map<String, dynamic>>(networkTierConfigs, (value) => value.toMap()),
      'podCidrOverprovisionConfigs': pulumi.Input.encodeList<GetClusterIpAllocationPolicyPodCidrOverprovisionConfig, Map<String, dynamic>>(podCidrOverprovisionConfigs, (value) => value.toMap()),
  ...
  factory GetClusterIpAllocationPolicy.fromMap(Map<String, dynamic> map) {
    return GetClusterIpAllocationPolicy(
      additionalIpRangesConfigs: pulumi.Input.decodeList<GetClusterIpAllocationPolicyAdditionalIpRangesConfig>(map['additionalIpRangesConfigs'], (value) => GetClusterIpAllocationPolicyAdditionalIpRangesConfig.fromMap((value as Map).cast<String, dynamic>())),
      additionalPodRangesConfigs: pulumi.Input.decodeList<GetClusterIpAllocationPolicyAdditionalPodRangesConfig>(map['additionalPodRangesConfigs'], (value) => GetClusterIpAllocationPolicyAdditionalPodRangesConfig.fromMap((value as Map).cast<String, dynamic>())),
      autoIpamConfigs: pulumi.Input.decodeList<GetClusterIpAllocationPolicyAutoIpamConfig>(map['autoIpamConfigs'], (value) => GetClusterIpAllocationPolicyAutoIpamConfig.fromMap((value as Map).cast<String, dynamic>())),
      clusterIpv4CidrBlock: map['clusterIpv4CidrBlock'] as String,
      clusterSecondaryRangeName: map['clusterSecondaryRangeName'] as String,
      networkTierConfigs: pulumi.Input.decodeList<GetClusterIpAllocationPolicyNetworkTierConfig>(map['networkTierConfigs'], (value) => GetClusterIpAllocationPolicyNetworkTierConfig.fromMap((value as Map).cast<String, dynamic>())),
      podCidrOverprovisionConfigs: pulumi.Input.decodeList<GetClusterIpAllocationPolicyPodCidrOverprovisionConfig>(map['podCidrOverprovisionConfigs'], (value) => GetClusterIpAllocationPolicyPodCidrOverprovisionConfig.fromMap((value as Map).cast<String, dynamic>())),
