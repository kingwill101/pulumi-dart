...
class GetClusterIpAllocationPolicy {
  ...
  final pulumi.Input<List<GetClusterIpAllocationPolicyAdditionalIpRangesConfig>>
  additionalIpRangesConfigs;

  /// AdditionalPodRangesConfig is the configuration for additional pod secondary ranges supporting the ClusterUpdate message.
  final pulumi.Input<
    List<GetClusterIpAllocationPolicyAdditionalPodRangesConfig>
  >
  additionalPodRangesConfigs;

  /// AutoIpamConfig contains all information related to Auto IPAM.
  final pulumi.Input<List<GetClusterIpAllocationPolicyAutoIpamConfig>>
  autoIpamConfigs;
  ...
  final pulumi.Input<List<GetClusterIpAllocationPolicyNetworkTierConfig>>
  networkTierConfigs;

  /// Configuration for cluster level pod cidr overprovision. Default is disabled=false.
  final pulumi.Input<
    List<GetClusterIpAllocationPolicyPodCidrOverprovisionConfig>
  >
    ...
    return <String, dynamic>{
      'additionalIpRangesConfigs':
          pulumi.Input.mapInputValue<
            List<GetClusterIpAllocationPolicyAdditionalIpRangesConfig>,
      ...
      'autoIpamConfigs':
          pulumi.Input.mapInputValue<
            List<GetClusterIpAllocationPolicyAutoIpamConfig>,
            List<Map<String, dynamic>>
          >(
            autoIpamConfigs,
            (value) =>
      ...
      'networkTierConfigs':
          pulumi.Input.mapInputValue<
            List<GetClusterIpAllocationPolicyNetworkTierConfig>,
            List<Map<String, dynamic>>
          >(
            networkTierConfigs,
            (value) =>
  ...
  factory GetClusterIpAllocationPolicy.fromMap(Map<String, dynamic> map) {
    return GetClusterIpAllocationPolicy(
      additionalIpRangesConfigs: pulumi.Input.fromValue(
      ...
      additionalPodRangesConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetClusterIpAllocationPolicyAdditionalPodRangesConfig
        >(
      ...
      autoIpamConfigs: pulumi.Input.fromValue(
      ...
      networkTierConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetClusterIpAllocationPolicyNetworkTierConfig>(
      ...
      podCidrOverprovisionConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetClusterIpAllocationPolicyPodCidrOverprovisionConfig
        >(
