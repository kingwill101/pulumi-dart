...
class GetClusterIpAllocationPolicy {
  ...
  factory GetClusterIpAllocationPolicy.fromMap(Map<String, dynamic> map) {
    return GetClusterIpAllocationPolicy(
      additionalIpRangesConfigs: (pulumi.Input.decodeList<GetClusterIpAllocationPolicyAdditionalIpRangesConfig>(map['additionalIpRangesConfigs'], (value) => GetClusterIpAllocationPolicyAdditionalIpRangesConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
      additionalPodRangesConfigs: (pulumi.Input.decodeList<GetClusterIpAllocationPolicyAdditionalPodRangesConfig>(map['additionalPodRangesConfigs'], (value) => GetClusterIpAllocationPolicyAdditionalPodRangesConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
      autoIpamConfigs: (pulumi.Input.decodeList<GetClusterIpAllocationPolicyAutoIpamConfig>(map['autoIpamConfigs'], (value) => GetClusterIpAllocationPolicyAutoIpamConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      networkTierConfigs: (pulumi.Input.decodeList<GetClusterIpAllocationPolicyNetworkTierConfig>(map['networkTierConfigs'], (value) => GetClusterIpAllocationPolicyNetworkTierConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
      podCidrOverprovisionConfigs: (pulumi.Input.decodeList<GetClusterIpAllocationPolicyPodCidrOverprovisionConfig>(map['podCidrOverprovisionConfigs'], (value) => GetClusterIpAllocationPolicyPodCidrOverprovisionConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
