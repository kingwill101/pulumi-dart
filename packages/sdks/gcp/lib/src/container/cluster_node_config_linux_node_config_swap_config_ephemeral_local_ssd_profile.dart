...
class ClusterNodeConfigLinuxNodeConfigSwapConfigEphemeralLocalSsdProfile {
  ...
  /// Creates a new [ClusterNodeConfigLinuxNodeConfigSwapConfigEphemeralLocalSsdProfile].
  ...
  const ClusterNodeConfigLinuxNodeConfigSwapConfigEphemeralLocalSsdProfile({
    this.swapSizeGib,
  ...
  factory ClusterNodeConfigLinuxNodeConfigSwapConfigEphemeralLocalSsdProfile.fromMap(Map<String, dynamic> map) {
    return ClusterNodeConfigLinuxNodeConfigSwapConfigEphemeralLocalSsdProfile(
