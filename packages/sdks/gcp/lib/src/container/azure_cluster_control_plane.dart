...
class AzureClusterControlPlane {
  ...
  final pulumi.Input<AzureClusterControlPlaneDatabaseEncryption>?
  databaseEncryption;
  ...
  final pulumi.Input<List<AzureClusterControlPlaneReplicaPlacement>>?
  replicaPlacements;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'replicaPlacements':
          ?pulumi.Input.mapOptionalInputValue<
            List<AzureClusterControlPlaneReplicaPlacement>,
  ...
  factory AzureClusterControlPlane.fromMap(Map<String, dynamic> map) {
    return AzureClusterControlPlane(
      ...
      replicaPlacements: (() {
        final guardedValue = map['replicaPlacements'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      sshConfig: pulumi.Input.fromValue(
        AzureClusterControlPlaneSshConfig.fromMap(
