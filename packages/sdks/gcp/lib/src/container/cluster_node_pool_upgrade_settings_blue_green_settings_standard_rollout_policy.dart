...
class ClusterNodePoolUpgradeSettingsBlueGreenSettingsStandardRolloutPolicy {
  ...
  /// [batchPercentage] Percentage of the bool pool nodes to drain in a batch. The range of this field should be (0.0, 1.0). Only one of the batchPercentage or batchNodeCount can be specified.
  ...
  const ClusterNodePoolUpgradeSettingsBlueGreenSettingsStandardRolloutPolicy({
    this.batchNodeCount,
