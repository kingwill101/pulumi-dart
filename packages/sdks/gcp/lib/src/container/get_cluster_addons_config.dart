...
class GetClusterAddonsConfig {
  ...
  factory GetClusterAddonsConfig.fromMap(Map<String, dynamic> map) {
    return GetClusterAddonsConfig(
      cloudrunConfigs: (pulumi.Input.decodeList<GetClusterAddonsConfigCloudrunConfig>(map['cloudrunConfigs'], (value) => GetClusterAddonsConfigCloudrunConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
      configConnectorConfigs: (pulumi.Input.decodeList<GetClusterAddonsConfigConfigConnectorConfig>(map['configConnectorConfigs'], (value) => GetClusterAddonsConfigConfigConnectorConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
      dnsCacheConfigs: (pulumi.Input.decodeList<GetClusterAddonsConfigDnsCacheConfig>(map['dnsCacheConfigs'], (value) => GetClusterAddonsConfigDnsCacheConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
      gcePersistentDiskCsiDriverConfigs: (pulumi.Input.decodeList<GetClusterAddonsConfigGcePersistentDiskCsiDriverConfig>(map['gcePersistentDiskCsiDriverConfigs'], (value) => GetClusterAddonsConfigGcePersistentDiskCsiDriverConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
      gcpFilestoreCsiDriverConfigs: (pulumi.Input.decodeList<GetClusterAddonsConfigGcpFilestoreCsiDriverConfig>(map['gcpFilestoreCsiDriverConfigs'], (value) => GetClusterAddonsConfigGcpFilestoreCsiDriverConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
      gcsFuseCsiDriverConfigs: (pulumi.Input.decodeList<GetClusterAddonsConfigGcsFuseCsiDriverConfig>(map['gcsFuseCsiDriverConfigs'], (value) => GetClusterAddonsConfigGcsFuseCsiDriverConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
      gkeBackupAgentConfigs: (pulumi.Input.decodeList<GetClusterAddonsConfigGkeBackupAgentConfig>(map['gkeBackupAgentConfigs'], (value) => GetClusterAddonsConfigGkeBackupAgentConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
      horizontalPodAutoscalings: (pulumi.Input.decodeList<GetClusterAddonsConfigHorizontalPodAutoscaling>(map['horizontalPodAutoscalings'], (value) => GetClusterAddonsConfigHorizontalPodAutoscaling.fromMap((value as Map).cast<String, dynamic>()))).input(),
      httpLoadBalancings: (pulumi.Input.decodeList<GetClusterAddonsConfigHttpLoadBalancing>(map['httpLoadBalancings'], (value) => GetClusterAddonsConfigHttpLoadBalancing.fromMap((value as Map).cast<String, dynamic>()))).input(),
      istioConfigs: (pulumi.Input.decodeList<GetClusterAddonsConfigIstioConfig>(map['istioConfigs'], (value) => GetClusterAddonsConfigIstioConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
      kalmConfigs: (pulumi.Input.decodeList<GetClusterAddonsConfigKalmConfig>(map['kalmConfigs'], (value) => GetClusterAddonsConfigKalmConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
      lustreCsiDriverConfigs: (pulumi.Input.decodeList<GetClusterAddonsConfigLustreCsiDriverConfig>(map['lustreCsiDriverConfigs'], (value) => GetClusterAddonsConfigLustreCsiDriverConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
      networkPolicyConfigs: (pulumi.Input.decodeList<GetClusterAddonsConfigNetworkPolicyConfig>(map['networkPolicyConfigs'], (value) => GetClusterAddonsConfigNetworkPolicyConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
      parallelstoreCsiDriverConfigs: (pulumi.Input.decodeList<GetClusterAddonsConfigParallelstoreCsiDriverConfig>(map['parallelstoreCsiDriverConfigs'], (value) => GetClusterAddonsConfigParallelstoreCsiDriverConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
      podSnapshotConfigs: (pulumi.Input.decodeList<GetClusterAddonsConfigPodSnapshotConfig>(map['podSnapshotConfigs'], (value) => GetClusterAddonsConfigPodSnapshotConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
      rayOperatorConfigs: (pulumi.Input.decodeList<GetClusterAddonsConfigRayOperatorConfig>(map['rayOperatorConfigs'], (value) => GetClusterAddonsConfigRayOperatorConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
      statefulHaConfigs: (pulumi.Input.decodeList<GetClusterAddonsConfigStatefulHaConfig>(map['statefulHaConfigs'], (value) => GetClusterAddonsConfigStatefulHaConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
