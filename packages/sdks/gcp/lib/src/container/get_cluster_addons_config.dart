...
import 'get_cluster_addons_config_agent_sandbox_config.dart';
...
import 'get_cluster_addons_config_high_scale_checkpointing_config.dart';
...
import 'get_cluster_addons_config_node_readiness_config.dart';
...
import 'get_cluster_addons_config_slice_controller_config.dart';
import 'get_cluster_addons_config_slurm_operator_config.dart';
...
class GetClusterAddonsConfig {
  ...
  final pulumi.Input<List<GetClusterAddonsConfigAgentSandboxConfig>> agentSandboxConfigs;
  ...
  final pulumi.Input<List<GetClusterAddonsConfigHighScaleCheckpointingConfig>> highScaleCheckpointingConfigs;
  ...
  final pulumi.Input<List<GetClusterAddonsConfigNodeReadinessConfig>> nodeReadinessConfigs;
  ...
  final pulumi.Input<List<GetClusterAddonsConfigSliceControllerConfig>> sliceControllerConfigs;
  ...
  final pulumi.Input<List<GetClusterAddonsConfigSlurmOperatorConfig>> slurmOperatorConfigs;
  ...
  /// [agentSandboxConfigs] The status of the Agent Sandbox addon. It is disabled by default. Set enabled = true to enable.
  ...
  /// [highScaleCheckpointingConfigs] The status of the High Scale Checkpointing addon. Defaults to disabled; set enabled = true to enable.
  ...
  /// [nodeReadinessConfigs] The status of the Node Readiness Controller addon.
  ...
  /// [sliceControllerConfigs] The status of the Slice Controller addon. It is disabled by default; set enabled = true to enable.
  /// [slurmOperatorConfigs] The status of the Slurm Operator addon, which creates slurm related CRDs and KCP pods to manage them. Defaults to disabled for Standard clusters; set enabled = true to enable. It can not be enabled for Autopilot clusters.
  ...
  const GetClusterAddonsConfig({
    required this.agentSandboxConfigs,
    ...
    required this.highScaleCheckpointingConfigs,
    ...
    required this.nodeReadinessConfigs,
    required this.parallelstoreCsiDriverConfigs,
    required this.podSnapshotConfigs,
    required this.rayOperatorConfigs,
    required this.sliceControllerConfigs,
    required this.slurmOperatorConfigs,
    required this.statefulHaConfigs,
  });

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'agentSandboxConfigs': pulumi.Input.mapInputValue<List<GetClusterAddonsConfigAgentSandboxConfig>, List<Map<String, dynamic>>>(agentSandboxConfigs, (value) => pulumi.Input.encodeList<GetClusterAddonsConfigAgentSandboxConfig, Map<String, dynamic>>(value, (value) => value.toMap())),
      ...
      'highScaleCheckpointingConfigs': pulumi.Input.mapInputValue<List<GetClusterAddonsConfigHighScaleCheckpointingConfig>, List<Map<String, dynamic>>>(highScaleCheckpointingConfigs, (value) => pulumi.Input.encodeList<GetClusterAddonsConfigHighScaleCheckpointingConfig, Map<String, dynamic>>(value, (value) => value.toMap())),
      ...
      'nodeReadinessConfigs': pulumi.Input.mapInputValue<List<GetClusterAddonsConfigNodeReadinessConfig>, List<Map<String, dynamic>>>(nodeReadinessConfigs, (value) => pulumi.Input.encodeList<GetClusterAddonsConfigNodeReadinessConfig, Map<String, dynamic>>(value, (value) => value.toMap())),
      ...
      'sliceControllerConfigs': pulumi.Input.mapInputValue<List<GetClusterAddonsConfigSliceControllerConfig>, List<Map<String, dynamic>>>(sliceControllerConfigs, (value) => pulumi.Input.encodeList<GetClusterAddonsConfigSliceControllerConfig, Map<String, dynamic>>(value, (value) => value.toMap())),
      'slurmOperatorConfigs': pulumi.Input.mapInputValue<List<GetClusterAddonsConfigSlurmOperatorConfig>, List<Map<String, dynamic>>>(slurmOperatorConfigs, (value) => pulumi.Input.encodeList<GetClusterAddonsConfigSlurmOperatorConfig, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory GetClusterAddonsConfig.fromMap(Map<String, dynamic> map) {
    return GetClusterAddonsConfig(
      agentSandboxConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetClusterAddonsConfigAgentSandboxConfig>(map['agentSandboxConfigs']!, (value) => GetClusterAddonsConfigAgentSandboxConfig.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      highScaleCheckpointingConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetClusterAddonsConfigHighScaleCheckpointingConfig>(map['highScaleCheckpointingConfigs']!, (value) => GetClusterAddonsConfigHighScaleCheckpointingConfig.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      nodeReadinessConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetClusterAddonsConfigNodeReadinessConfig>(map['nodeReadinessConfigs']!, (value) => GetClusterAddonsConfigNodeReadinessConfig.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      sliceControllerConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetClusterAddonsConfigSliceControllerConfig>(map['sliceControllerConfigs']!, (value) => GetClusterAddonsConfigSliceControllerConfig.fromMap((value as Map).cast<String, dynamic>()))),
      slurmOperatorConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetClusterAddonsConfigSlurmOperatorConfig>(map['slurmOperatorConfigs']!, (value) => GetClusterAddonsConfigSlurmOperatorConfig.fromMap((value as Map).cast<String, dynamic>()))),
