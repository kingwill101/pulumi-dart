...
class GetClusterAddonsConfig {
  ...
  final pulumi.Input<List<GetClusterAddonsConfigCloudrunConfig>>
  cloudrunConfigs;

  /// The of the Config Connector addon.
  final pulumi.Input<List<GetClusterAddonsConfigConfigConnectorConfig>>
  configConnectorConfigs;

  /// The status of the NodeLocal DNSCache addon. It is disabled by default. Set enabled = true to enable.
  final pulumi.Input<List<GetClusterAddonsConfigDnsCacheConfig>>
  dnsCacheConfigs;
  ...
  final pulumi.Input<
    List<GetClusterAddonsConfigGcePersistentDiskCsiDriverConfig>
  >
  ...
  final pulumi.Input<List<GetClusterAddonsConfigGcpFilestoreCsiDriverConfig>>
  ...
  final pulumi.Input<List<GetClusterAddonsConfigGcsFuseCsiDriverConfig>>
  gcsFuseCsiDriverConfigs;

  /// The status of the Backup for GKE Agent addon. It is disabled by default. Set enabled = true to enable.
  final pulumi.Input<List<GetClusterAddonsConfigGkeBackupAgentConfig>>
  gkeBackupAgentConfigs;

  /// The status of the Horizontal Pod Autoscaling addon, which increases or decreases the number of replica pods a replication controller has based on the resource usage of the existing pods. It ensures that a Heapster pod is running in the cluster, which is also used by the Cloud Monitoring service. It is enabled by default; set disabled = true to disable.
  final pulumi.Input<List<GetClusterAddonsConfigHorizontalPodAutoscaling>>
  horizontalPodAutoscalings;

  /// The status of the HTTP (L7) load balancing controller addon, which makes it easy to set up HTTP load balancers for services in a cluster. It is enabled by default; set disabled = true to disable.
  final pulumi.Input<List<GetClusterAddonsConfigHttpLoadBalancing>>
  httpLoadBalancings;
  ...
  final pulumi.Input<List<GetClusterAddonsConfigLustreCsiDriverConfig>>
  lustreCsiDriverConfigs;

  /// Whether we should enable the network policy addon for the master. This must be enabled in order to enable network policy for the nodes. To enable this, you must also define a network_policy block, otherwise nothing will happen. It can only be disabled if the nodes already do not have network policies enabled. Defaults to disabled; set disabled = false to enable.
  final pulumi.Input<List<GetClusterAddonsConfigNetworkPolicyConfig>>
  ...
  final pulumi.Input<List<GetClusterAddonsConfigParallelstoreCsiDriverConfig>>
  parallelstoreCsiDriverConfigs;

  /// Configuration for the Pod Snapshot feature.
  final pulumi.Input<List<GetClusterAddonsConfigPodSnapshotConfig>>
  podSnapshotConfigs;
  ...
  final pulumi.Input<List<GetClusterAddonsConfigRayOperatorConfig>>
  rayOperatorConfigs;
  ...
  final pulumi.Input<List<GetClusterAddonsConfigStatefulHaConfig>>
  statefulHaConfigs;
    ...
    return <String, dynamic>{
      'cloudrunConfigs':
          pulumi.Input.mapInputValue<
            List<GetClusterAddonsConfigCloudrunConfig>,
      ...
      'dnsCacheConfigs':
          pulumi.Input.mapInputValue<
            List<GetClusterAddonsConfigDnsCacheConfig>,
            List<Map<String, dynamic>>
          >(
            dnsCacheConfigs,
            (value) =>
      ...
      'gcpFilestoreCsiDriverConfigs':
          pulumi.Input.mapInputValue<
            List<GetClusterAddonsConfigGcpFilestoreCsiDriverConfig>,
            List<Map<String, dynamic>>
          >(
            gcpFilestoreCsiDriverConfigs,
            (value) =>
      ...
      'gcsFuseCsiDriverConfigs':
          pulumi.Input.mapInputValue<
            List<GetClusterAddonsConfigGcsFuseCsiDriverConfig>,
            List<Map<String, dynamic>>
          >(
            gcsFuseCsiDriverConfigs,
            (value) =>
      ...
      'gkeBackupAgentConfigs':
          pulumi.Input.mapInputValue<
            List<GetClusterAddonsConfigGkeBackupAgentConfig>,
            List<Map<String, dynamic>>
          >(
            gkeBackupAgentConfigs,
            (value) =>
      ...
      'horizontalPodAutoscalings':
          pulumi.Input.mapInputValue<
            List<GetClusterAddonsConfigHorizontalPodAutoscaling>,
            List<Map<String, dynamic>>
          >(
            horizontalPodAutoscalings,
            (value) =>
      ...
      'istioConfigs':
          pulumi.Input.mapInputValue<
            List<GetClusterAddonsConfigIstioConfig>,
            List<Map<String, dynamic>>
          >(
            istioConfigs,
            (value) =>
      ...
      'kalmConfigs':
          pulumi.Input.mapInputValue<
            List<GetClusterAddonsConfigKalmConfig>,
            List<Map<String, dynamic>>
          >(
            kalmConfigs,
            (value) =>
      ...
      'lustreCsiDriverConfigs':
          pulumi.Input.mapInputValue<
            List<GetClusterAddonsConfigLustreCsiDriverConfig>,
            List<Map<String, dynamic>>
          >(
            lustreCsiDriverConfigs,
            (value) =>
      ...
      'networkPolicyConfigs':
          pulumi.Input.mapInputValue<
            List<GetClusterAddonsConfigNetworkPolicyConfig>,
            List<Map<String, dynamic>>
          >(
            networkPolicyConfigs,
            (value) =>
      ...
      'parallelstoreCsiDriverConfigs':
          pulumi.Input.mapInputValue<
            List<GetClusterAddonsConfigParallelstoreCsiDriverConfig>,
            List<Map<String, dynamic>>
          >(
            parallelstoreCsiDriverConfigs,
            (value) =>
      ...
      'podSnapshotConfigs':
          pulumi.Input.mapInputValue<
            List<GetClusterAddonsConfigPodSnapshotConfig>,
            List<Map<String, dynamic>>
          >(
            podSnapshotConfigs,
            (value) =>
      ...
      'rayOperatorConfigs':
          pulumi.Input.mapInputValue<
            List<GetClusterAddonsConfigRayOperatorConfig>,
            List<Map<String, dynamic>>
          >(
            rayOperatorConfigs,
            (value) =>
      ...
      'statefulHaConfigs':
          pulumi.Input.mapInputValue<
            List<GetClusterAddonsConfigStatefulHaConfig>,
            List<Map<String, dynamic>>
          >(
            statefulHaConfigs,
            (value) =>
  ...
  factory GetClusterAddonsConfig.fromMap(Map<String, dynamic> map) {
    return GetClusterAddonsConfig(
      cloudrunConfigs: pulumi.Input.fromValue(
      ...
      configConnectorConfigs: pulumi.Input.fromValue(
      ...
      dnsCacheConfigs: pulumi.Input.fromValue(
      ...
      gcePersistentDiskCsiDriverConfigs: pulumi.Input.fromValue(
      ...
      gcpFilestoreCsiDriverConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetClusterAddonsConfigGcpFilestoreCsiDriverConfig
        >(
      ...
      gcsFuseCsiDriverConfigs: pulumi.Input.fromValue(
      ...
      gkeBackupAgentConfigs: pulumi.Input.fromValue(
      ...
      horizontalPodAutoscalings: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetClusterAddonsConfigHorizontalPodAutoscaling>(
      ...
      httpLoadBalancings: pulumi.Input.fromValue(
      ...
      istioConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetClusterAddonsConfigIstioConfig>(
          map['istioConfigs']!,
      ...
      kalmConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetClusterAddonsConfigKalmConfig>(
          map['kalmConfigs']!,
      ...
      lustreCsiDriverConfigs: pulumi.Input.fromValue(
      ...
      networkPolicyConfigs: pulumi.Input.fromValue(
      ...
      parallelstoreCsiDriverConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetClusterAddonsConfigParallelstoreCsiDriverConfig
        >(
      ...
      podSnapshotConfigs: pulumi.Input.fromValue(
      ...
      rayOperatorConfigs: pulumi.Input.fromValue(
      ...
      statefulHaConfigs: pulumi.Input.fromValue(
