...
class GetClusterNodePoolAutoConfigLinuxNodeConfig {
  ...
  factory GetClusterNodePoolAutoConfigLinuxNodeConfig.fromMap(Map<String, dynamic> map) {
    return GetClusterNodePoolAutoConfigLinuxNodeConfig(
      ...
      nodeKernelModuleLoadings: (pulumi.Input.decodeList<GetClusterNodePoolAutoConfigLinuxNodeConfigNodeKernelModuleLoading>(map['nodeKernelModuleLoadings'], (value) => GetClusterNodePoolAutoConfigLinuxNodeConfigNodeKernelModuleLoading.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
