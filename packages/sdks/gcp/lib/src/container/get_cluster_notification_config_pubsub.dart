...
class GetClusterNotificationConfigPubsub {
  ...
  const GetClusterNotificationConfigPubsub({
  ...
  factory GetClusterNotificationConfigPubsub.fromMap(Map<String, dynamic> map) {
    return GetClusterNotificationConfigPubsub(
      ...
      filters: pulumi.Input.fromValue(pulumi.Input.decodeList<GetClusterNotificationConfigPubsubFilter>(map['filters']!, (value) => GetClusterNotificationConfigPubsubFilter.fromMap((value as Map).cast<String, dynamic>()))),
