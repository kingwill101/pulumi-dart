...
class ClusterIpAllocationPolicy {
  ...
  factory ClusterIpAllocationPolicy.fromMap(Map<String, dynamic> map) {
    return ClusterIpAllocationPolicy(
      additionalIpRangesConfigs: (() { final guardedValue = map['additionalIpRangesConfigs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ClusterIpAllocationPolicyAdditionalIpRangesConfig>(guardedValue, (value) => ClusterIpAllocationPolicyAdditionalIpRangesConfig.fromMap((value as Map).cast<String, dynamic>()))); })(),
      additionalPodRangesConfig: (() { final guardedValue = map['additionalPodRangesConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterIpAllocationPolicyAdditionalPodRangesConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      autoIpamConfig: (() { final guardedValue = map['autoIpamConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterIpAllocationPolicyAutoIpamConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      networkTierConfig: (() { final guardedValue = map['networkTierConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterIpAllocationPolicyNetworkTierConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      podCidrOverprovisionConfig: (() { final guardedValue = map['podCidrOverprovisionConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterIpAllocationPolicyPodCidrOverprovisionConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
