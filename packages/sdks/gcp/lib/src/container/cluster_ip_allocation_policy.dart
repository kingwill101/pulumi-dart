...
class ClusterIpAllocationPolicy {
  ...
  final List<ClusterIpAllocationPolicyAdditionalIpRangesConfig>? additionalIpRangesConfigs;
  /// The configuration for additional pod secondary ranges at
  /// the cluster level. Used for Autopilot clusters and Standard clusters with which control of the
  /// secondary Pod IP address assignment to node pools isn't needed. Structure is documented below.
  final ClusterIpAllocationPolicyAdditionalPodRangesConfig? additionalPodRangesConfig;
  ...
  final ClusterIpAllocationPolicyPodCidrOverprovisionConfig? podCidrOverprovisionConfig;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'additionalIpRangesConfigs': ?additionalIpRangesConfigs == null ? null : pulumi.Input.encodeList<ClusterIpAllocationPolicyAdditionalIpRangesConfig, Map<String, dynamic>>(additionalIpRangesConfigs!, (value) => value.toMap()),
      'additionalPodRangesConfig': ?additionalPodRangesConfig == null ? null : additionalPodRangesConfig!.toMap(),
      'autoIpamConfig': ?autoIpamConfig == null ? null : autoIpamConfig!.toMap(),
      'clusterIpv4CidrBlock': ?clusterIpv4CidrBlock,
      'clusterSecondaryRangeName': ?clusterSecondaryRangeName,
      'networkTierConfig': ?networkTierConfig == null ? null : networkTierConfig!.toMap(),
  ...
  factory ClusterIpAllocationPolicy.fromMap(Map<String, dynamic> map) {
    return ClusterIpAllocationPolicy(
      additionalIpRangesConfigs: map['additionalIpRangesConfigs'] == null ? null : pulumi.Input.decodeList<ClusterIpAllocationPolicyAdditionalIpRangesConfig>(map['additionalIpRangesConfigs'], (value) => ClusterIpAllocationPolicyAdditionalIpRangesConfig.fromMap((value as Map).cast<String, dynamic>())),
      additionalPodRangesConfig: map['additionalPodRangesConfig'] == null ? null : ClusterIpAllocationPolicyAdditionalPodRangesConfig.fromMap((map['additionalPodRangesConfig'] as Map).cast<String, dynamic>()),
      autoIpamConfig: map['autoIpamConfig'] == null ? null : ClusterIpAllocationPolicyAutoIpamConfig.fromMap((map['autoIpamConfig'] as Map).cast<String, dynamic>()),
      ...
      networkTierConfig: map['networkTierConfig'] == null ? null : ClusterIpAllocationPolicyNetworkTierConfig.fromMap((map['networkTierConfig'] as Map).cast<String, dynamic>()),
      podCidrOverprovisionConfig: map['podCidrOverprovisionConfig'] == null ? null : ClusterIpAllocationPolicyPodCidrOverprovisionConfig.fromMap((map['podCidrOverprovisionConfig'] as Map).cast<String, dynamic>()),
