...
class AzureClusterState {
  ...
  final pulumi.Input<List<AzureClusterWorkloadIdentityConfig>>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'workloadIdentityConfigs':
          ?pulumi.Input.mapOptionalInputValue<
            List<AzureClusterWorkloadIdentityConfig>,
  ...
  factory AzureClusterState.fromMap(Map<String, dynamic> map) {
    return AzureClusterState(
      ...
      azureRegion: (() {
        final guardedValue = map['azureRegion'];
        if (guardedValue == null) return null;
      ...
      workloadIdentityConfigs: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AzureClusterWorkloadIdentityConfig>(
            guardedValue,
            (value) => AzureClusterWorkloadIdentityConfig.fromMap(
