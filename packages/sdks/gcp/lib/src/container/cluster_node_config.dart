...
class ClusterNodeConfig {
  ...
  /// Parameters for the ephemeral storage filesystem. If unspecified, ephemeral storage is backed by the boot disk. Structure is documented below.
  final ClusterNodeConfigEphemeralStorageLocalSsdConfig? ephemeralStorageLocalSsdConfig;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'diskType': ?diskType,
      'effectiveTaints': ?effectiveTaints == null ? null : pulumi.Input.encodeList<ClusterNodeConfigEffectiveTaint, Map<String, dynamic>>(effectiveTaints!, (value) => value.toMap()),
      ...
      'guestAccelerators': ?guestAccelerators == null ? null : pulumi.Input.encodeList<ClusterNodeConfigGuestAccelerator, Map<String, dynamic>>(guestAccelerators!, (value) => value.toMap()),
      ...
      'secondaryBootDisks': ?secondaryBootDisks == null ? null : pulumi.Input.encodeList<ClusterNodeConfigSecondaryBootDisk, Map<String, dynamic>>(secondaryBootDisks!, (value) => value.toMap()),
      ...
      'tags': ?tags,
      'taints': ?taints == null ? null : pulumi.Input.encodeList<ClusterNodeConfigTaint, Map<String, dynamic>>(taints!, (value) => value.toMap()),
  ...
  factory ClusterNodeConfig.fromMap(Map<String, dynamic> map) {
    return ClusterNodeConfig(
      advancedMachineFeatures: map['advancedMachineFeatures'] == null ? null : ClusterNodeConfigAdvancedMachineFeatures.fromMap((map['advancedMachineFeatures'] as Map).cast<String, dynamic>()),
      bootDisk: map['bootDisk'] == null ? null : ClusterNodeConfigBootDisk.fromMap((map['bootDisk'] as Map).cast<String, dynamic>()),
      bootDiskKmsKey: map['bootDiskKmsKey'] == null ? null : map['bootDiskKmsKey'] as String,
      confidentialNodes: map['confidentialNodes'] == null ? null : ClusterNodeConfigConfidentialNodes.fromMap((map['confidentialNodes'] as Map).cast<String, dynamic>()),
      containerdConfig: map['containerdConfig'] == null ? null : ClusterNodeConfigContainerdConfig.fromMap((map['containerdConfig'] as Map).cast<String, dynamic>()),
      diskSizeGb: map['diskSizeGb'] == null ? null : map['diskSizeGb'] as int,
      diskType: map['diskType'] == null ? null : map['diskType'] as String,
      effectiveTaints: map['effectiveTaints'] == null ? null : pulumi.Input.decodeList<ClusterNodeConfigEffectiveTaint>(map['effectiveTaints'], (value) => ClusterNodeConfigEffectiveTaint.fromMap((value as Map).cast<String, dynamic>())),
      enableConfidentialStorage: map['enableConfidentialStorage'] == null ? null : map['enableConfidentialStorage'] as bool,
      ephemeralStorageConfig: map['ephemeralStorageConfig'] == null ? null : ClusterNodeConfigEphemeralStorageConfig.fromMap((map['ephemeralStorageConfig'] as Map).cast<String, dynamic>()),
      ephemeralStorageLocalSsdConfig: map['ephemeralStorageLocalSsdConfig'] == null ? null : ClusterNodeConfigEphemeralStorageLocalSsdConfig.fromMap((map['ephemeralStorageLocalSsdConfig'] as Map).cast<String, dynamic>()),
      fastSocket: map['fastSocket'] == null ? null : ClusterNodeConfigFastSocket.fromMap((map['fastSocket'] as Map).cast<String, dynamic>()),
      flexStart: map['flexStart'] == null ? null : map['flexStart'] as bool,
      gcfsConfig: map['gcfsConfig'] == null ? null : ClusterNodeConfigGcfsConfig.fromMap((map['gcfsConfig'] as Map).cast<String, dynamic>()),
      guestAccelerators: map['guestAccelerators'] == null ? null : pulumi.Input.decodeList<ClusterNodeConfigGuestAccelerator>(map['guestAccelerators'], (value) => ClusterNodeConfigGuestAccelerator.fromMap((value as Map).cast<String, dynamic>())),
      gvnic: map['gvnic'] == null ? null : ClusterNodeConfigGvnic.fromMap((map['gvnic'] as Map).cast<String, dynamic>()),
      hostMaintenancePolicy: map['hostMaintenancePolicy'] == null ? null : ClusterNodeConfigHostMaintenancePolicy.fromMap((map['hostMaintenancePolicy'] as Map).cast<String, dynamic>()),
      imageType: map['imageType'] == null ? null : map['imageType'] as String,
      kubeletConfig: map['kubeletConfig'] == null ? null : ClusterNodeConfigKubeletConfig.fromMap((map['kubeletConfig'] as Map).cast<String, dynamic>()),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      linuxNodeConfig: map['linuxNodeConfig'] == null ? null : ClusterNodeConfigLinuxNodeConfig.fromMap((map['linuxNodeConfig'] as Map).cast<String, dynamic>()),
      localNvmeSsdBlockConfig: map['localNvmeSsdBlockConfig'] == null ? null : ClusterNodeConfigLocalNvmeSsdBlockConfig.fromMap((map['localNvmeSsdBlockConfig'] as Map).cast<String, dynamic>()),
      ...
      reservationAffinity: map['reservationAffinity'] == null ? null : ClusterNodeConfigReservationAffinity.fromMap((map['reservationAffinity'] as Map).cast<String, dynamic>()),
      ...
      sandboxConfig: map['sandboxConfig'] == null ? null : ClusterNodeConfigSandboxConfig.fromMap((map['sandboxConfig'] as Map).cast<String, dynamic>()),
      secondaryBootDisks: map['secondaryBootDisks'] == null ? null : pulumi.Input.decodeList<ClusterNodeConfigSecondaryBootDisk>(map['secondaryBootDisks'], (value) => ClusterNodeConfigSecondaryBootDisk.fromMap((value as Map).cast<String, dynamic>())),
      serviceAccount: map['serviceAccount'] == null ? null : map['serviceAccount'] as String,
      shieldedInstanceConfig: map['shieldedInstanceConfig'] == null ? null : ClusterNodeConfigShieldedInstanceConfig.fromMap((map['shieldedInstanceConfig'] as Map).cast<String, dynamic>()),
      soleTenantConfig: map['soleTenantConfig'] == null ? null : ClusterNodeConfigSoleTenantConfig.fromMap((map['soleTenantConfig'] as Map).cast<String, dynamic>()),
      ...
      taints: map['taints'] == null ? null : pulumi.Input.decodeList<ClusterNodeConfigTaint>(map['taints'], (value) => ClusterNodeConfigTaint.fromMap((value as Map).cast<String, dynamic>())),
      windowsNodeConfig: map['windowsNodeConfig'] == null ? null : ClusterNodeConfigWindowsNodeConfig.fromMap((map['windowsNodeConfig'] as Map).cast<String, dynamic>()),
      workloadMetadataConfig: map['workloadMetadataConfig'] == null ? null : ClusterNodeConfigWorkloadMetadataConfig.fromMap((map['workloadMetadataConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
