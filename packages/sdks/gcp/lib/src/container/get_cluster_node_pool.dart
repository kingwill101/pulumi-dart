...
class GetClusterNodePool {
  ...
  final pulumi.Input<List<GetClusterNodePoolQueuedProvisioning>>
  queuedProvisionings;
    ...
    return <String, dynamic>{
      'autoscalings':
          pulumi.Input.mapInputValue<
            List<GetClusterNodePoolAutoscaling>,
      ...
      'managements':
          pulumi.Input.mapInputValue<
            List<GetClusterNodePoolManagement>,
            List<Map<String, dynamic>>
          >(
            managements,
            (value) =>
      ...
      'networkConfigs':
          pulumi.Input.mapInputValue<
            List<GetClusterNodePoolNetworkConfig>,
            List<Map<String, dynamic>>
          >(
            networkConfigs,
            (value) =>
      ...
      'nodeConfigs':
          pulumi.Input.mapInputValue<
            List<GetClusterNodePoolNodeConfig>,
            List<Map<String, dynamic>>
          >(
            nodeConfigs,
            (value) =>
      ...
      'nodeDrainConfigs':
          pulumi.Input.mapInputValue<
            List<GetClusterNodePoolNodeDrainConfig>,
            List<Map<String, dynamic>>
          >(
            nodeDrainConfigs,
            (value) =>
      ...
      'placementPolicies':
          pulumi.Input.mapInputValue<
            List<GetClusterNodePoolPlacementPolicy>,
            List<Map<String, dynamic>>
          >(
            placementPolicies,
            (value) =>
      ...
      'queuedProvisionings':
          pulumi.Input.mapInputValue<
            List<GetClusterNodePoolQueuedProvisioning>,
            List<Map<String, dynamic>>
          >(
            queuedProvisionings,
            (value) =>
      ...
      'upgradeSettings':
          pulumi.Input.mapInputValue<
            List<GetClusterNodePoolUpgradeSetting>,
            List<Map<String, dynamic>>
          >(
            upgradeSettings,
            (value) =>
  ...
  factory GetClusterNodePool.fromMap(Map<String, dynamic> map) {
    return GetClusterNodePool(
      autoscalings: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetClusterNodePoolAutoscaling>(
          map['autoscalings']!,
      ...
      instanceGroupUrls: pulumi.Input.fromValue(
        (map['instanceGroupUrls'] as List).cast<String>(),
      ),
      managedInstanceGroupUrls: pulumi.Input.fromValue(
        (map['managedInstanceGroupUrls'] as List).cast<String>(),
      ),
      managements: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetClusterNodePoolManagement>(
          map['managements']!,
      ...
      networkConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetClusterNodePoolNetworkConfig>(
          map['networkConfigs']!,
      ...
      nodeConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetClusterNodePoolNodeConfig>(
          map['nodeConfigs']!,
      ...
      nodeDrainConfigs: pulumi.Input.fromValue(
      ...
      nodeLocations: pulumi.Input.fromValue(
        (map['nodeLocations'] as List).cast<String>(),
      ),
      placementPolicies: pulumi.Input.fromValue(
      ...
      queuedProvisionings: pulumi.Input.fromValue(
