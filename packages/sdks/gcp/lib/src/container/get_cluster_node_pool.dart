...
class GetClusterNodePool {
  ...
  factory GetClusterNodePool.fromMap(Map<String, dynamic> map) {
    return GetClusterNodePool(
      autoscalings: (pulumi.Input.decodeList<GetClusterNodePoolAutoscaling>(map['autoscalings'], (value) => GetClusterNodePoolAutoscaling.fromMap((value as Map).cast<String, dynamic>()))).input(),
      initialNodeCount: (map['initialNodeCount'] as int).input(),
      instanceGroupUrls: ((map['instanceGroupUrls'] as List).cast<String>()).input(),
      managedInstanceGroupUrls: ((map['managedInstanceGroupUrls'] as List).cast<String>()).input(),
      managements: (pulumi.Input.decodeList<GetClusterNodePoolManagement>(map['managements'], (value) => GetClusterNodePoolManagement.fromMap((value as Map).cast<String, dynamic>()))).input(),
      maxPodsPerNode: (map['maxPodsPerNode'] as int).input(),
      name: (map['name'] as String).input(),
      namePrefix: (map['namePrefix'] as String).input(),
      networkConfigs: (pulumi.Input.decodeList<GetClusterNodePoolNetworkConfig>(map['networkConfigs'], (value) => GetClusterNodePoolNetworkConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
      nodeConfigs: (pulumi.Input.decodeList<GetClusterNodePoolNodeConfig>(map['nodeConfigs'], (value) => GetClusterNodePoolNodeConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
      nodeCount: (map['nodeCount'] as int).input(),
      nodeDrainConfigs: (pulumi.Input.decodeList<GetClusterNodePoolNodeDrainConfig>(map['nodeDrainConfigs'], (value) => GetClusterNodePoolNodeDrainConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
      nodeLocations: ((map['nodeLocations'] as List).cast<String>()).input(),
      placementPolicies: (pulumi.Input.decodeList<GetClusterNodePoolPlacementPolicy>(map['placementPolicies'], (value) => GetClusterNodePoolPlacementPolicy.fromMap((value as Map).cast<String, dynamic>()))).input(),
      queuedProvisionings: (pulumi.Input.decodeList<GetClusterNodePoolQueuedProvisioning>(map['queuedProvisionings'], (value) => GetClusterNodePoolQueuedProvisioning.fromMap((value as Map).cast<String, dynamic>()))).input(),
      upgradeSettings: (pulumi.Input.decodeList<GetClusterNodePoolUpgradeSetting>(map['upgradeSettings'], (value) => GetClusterNodePoolUpgradeSetting.fromMap((value as Map).cast<String, dynamic>()))).input(),
