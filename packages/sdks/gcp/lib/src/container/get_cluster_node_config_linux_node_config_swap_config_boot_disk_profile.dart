...
class GetClusterNodeConfigLinuxNodeConfigSwapConfigBootDiskProfile {
  ...
  /// Creates a new [GetClusterNodeConfigLinuxNodeConfigSwapConfigBootDiskProfile].
  ...
  const GetClusterNodeConfigLinuxNodeConfigSwapConfigBootDiskProfile({
