...
class ClusterUserManagedKeysConfig {
  ...
  /// [controlPlaneDiskEncryptionKeyVersions] The Cloud KMS cryptoKey versions to use for Confidential Hyperdisk on the control plane nodes.
  ...
  factory ClusterUserManagedKeysConfig.fromMap(Map<String, dynamic> map) {
    return ClusterUserManagedKeysConfig(
      ...
      controlPlaneDiskEncryptionKeyVersions: (() { final guardedValue = map['controlPlaneDiskEncryptionKeyVersions']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
