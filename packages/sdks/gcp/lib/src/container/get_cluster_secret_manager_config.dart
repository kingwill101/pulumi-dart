...
class GetClusterSecretManagerConfig {
  ...
  final pulumi.Input<List<GetClusterSecretManagerConfigRotationConfig>>
  rotationConfigs;
    ...
    return <String, dynamic>{
      ...
      'rotationConfigs':
          pulumi.Input.mapInputValue<
            List<GetClusterSecretManagerConfigRotationConfig>,
  ...
  factory GetClusterSecretManagerConfig.fromMap(Map<String, dynamic> map) {
    return GetClusterSecretManagerConfig(
      ...
      rotationConfigs: pulumi.Input.fromValue(
