...
class GetClusterSecretManagerConfig {
  ...
  factory GetClusterSecretManagerConfig.fromMap(Map<String, dynamic> map) {
    return GetClusterSecretManagerConfig(
      ...
      rotationConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetClusterSecretManagerConfigRotationConfig>(map['rotationConfigs']!, (value) => GetClusterSecretManagerConfigRotationConfig.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
