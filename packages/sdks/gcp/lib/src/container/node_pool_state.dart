...
class NodePoolState {
  ...
  NodePoolState({
    pulumi.Output<NodePoolAutoscaling>? autoscaling,
    pulumi.Output<String>? cluster,
    pulumi.Output<int>? initialNodeCount,
    pulumi.Output<List<String>>? instanceGroupUrls,
    pulumi.Output<String>? location,
    pulumi.Output<List<String>>? managedInstanceGroupUrls,
    pulumi.Output<NodePoolManagement>? management,
    pulumi.Output<int>? maxPodsPerNode,
    pulumi.Output<String>? name,
    pulumi.Output<String>? namePrefix,
    pulumi.Output<NodePoolNetworkConfig>? networkConfig,
    pulumi.Output<NodePoolNodeConfig>? nodeConfig,
    pulumi.Output<int>? nodeCount,
    pulumi.Output<List<NodePoolNodeDrainConfig>>? nodeDrainConfigs,
    pulumi.Output<List<String>>? nodeLocations,
    pulumi.Output<String>? operation,
    pulumi.Output<NodePoolPlacementPolicy>? placementPolicy,
    pulumi.Output<String>? project,
    pulumi.Output<NodePoolQueuedProvisioning>? queuedProvisioning,
    pulumi.Output<NodePoolUpgradeSettings>? upgradeSettings,
    pulumi.Output<String>? version,
      ...
      managedInstanceGroupUrls = pulumi.Input.asOptionalInput<List<String>>(managedInstanceGroupUrls),
      ...
      networkConfig = pulumi.Input.asOptionalInput<NodePoolNetworkConfig>(networkConfig),
      ...
      nodeDrainConfigs = pulumi.Input.asOptionalInput<List<NodePoolNodeDrainConfig>>(nodeDrainConfigs),
      ...
      placementPolicy = pulumi.Input.asOptionalInput<NodePoolPlacementPolicy>(placementPolicy),
      project = pulumi.Input.asOptionalInput<String>(project),
      queuedProvisioning = pulumi.Input.asOptionalInput<NodePoolQueuedProvisioning>(queuedProvisioning),
      upgradeSettings = pulumi.Input.asOptionalInput<NodePoolUpgradeSettings>(upgradeSettings),
  ...
  factory NodePoolState.fromMap(Map<String, dynamic> map) {
    return NodePoolState(
      autoscaling: map['autoscaling'] == null ? null : pulumi.Output.create<NodePoolAutoscaling>(NodePoolAutoscaling.fromMap((map['autoscaling'] as Map).cast<String, dynamic>())),
      ...
      managedInstanceGroupUrls: map['managedInstanceGroupUrls'] == null ? null : pulumi.Output.create<List<String>>((map['managedInstanceGroupUrls'] as List).cast<String>()),
      ...
      maxPodsPerNode: map['maxPodsPerNode'] == null ? null : pulumi.Output.create<int>(map['maxPodsPerNode'] as int),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      namePrefix: map['namePrefix'] == null ? null : pulumi.Output.create<String>(map['namePrefix'] as String),
      networkConfig: map['networkConfig'] == null ? null : pulumi.Output.create<NodePoolNetworkConfig>(NodePoolNetworkConfig.fromMap((map['networkConfig'] as Map).cast<String, dynamic>())),
      ...
      nodeDrainConfigs: map['nodeDrainConfigs'] == null ? null : pulumi.Output.create<List<NodePoolNodeDrainConfig>>(pulumi.Input.decodeList<NodePoolNodeDrainConfig>(map['nodeDrainConfigs'], (value) => NodePoolNodeDrainConfig.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      placementPolicy: map['placementPolicy'] == null ? null : pulumi.Output.create<NodePoolPlacementPolicy>(NodePoolPlacementPolicy.fromMap((map['placementPolicy'] as Map).cast<String, dynamic>())),
      project: map['project'] == null ? null : pulumi.Output.create<String>(map['project'] as String),
      queuedProvisioning: map['queuedProvisioning'] == null ? null : pulumi.Output.create<NodePoolQueuedProvisioning>(NodePoolQueuedProvisioning.fromMap((map['queuedProvisioning'] as Map).cast<String, dynamic>())),
      upgradeSettings: map['upgradeSettings'] == null ? null : pulumi.Output.create<NodePoolUpgradeSettings>(NodePoolUpgradeSettings.fromMap((map['upgradeSettings'] as Map).cast<String, dynamic>())),
