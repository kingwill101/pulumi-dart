...
class GetClusterMonitoringConfig {
  ...
  factory GetClusterMonitoringConfig.fromMap(Map<String, dynamic> map) {
    return GetClusterMonitoringConfig(
      advancedDatapathObservabilityConfigs: (pulumi.Input.decodeList<GetClusterMonitoringConfigAdvancedDatapathObservabilityConfig>(map['advancedDatapathObservabilityConfigs'], (value) => GetClusterMonitoringConfigAdvancedDatapathObservabilityConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
      enableComponents: ((map['enableComponents'] as List).cast<String>()).input(),
      managedPrometheuses: (pulumi.Input.decodeList<GetClusterMonitoringConfigManagedPrometheus>(map['managedPrometheuses'], (value) => GetClusterMonitoringConfigManagedPrometheus.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
