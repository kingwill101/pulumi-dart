...
class GetClusterMonitoringConfig {
  ...
  final pulumi.Input<List<GetClusterMonitoringConfigAdvancedDatapathObservabilityConfig>> advancedDatapathObservabilityConfigs;
  ...
  final pulumi.Input<List<GetClusterMonitoringConfigManagedPrometheus>> managedPrometheuses;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'advancedDatapathObservabilityConfigs': pulumi.Input.mapInputValue<List<GetClusterMonitoringConfigAdvancedDatapathObservabilityConfig>, List<Map<String, dynamic>>>(advancedDatapathObservabilityConfigs, (value) => pulumi.Input.encodeList<GetClusterMonitoringConfigAdvancedDatapathObservabilityConfig, Map<String, dynamic>>(value, (value) => value.toMap())),
      'enableComponents': enableComponents,
      'managedPrometheuses': pulumi.Input.mapInputValue<List<GetClusterMonitoringConfigManagedPrometheus>, List<Map<String, dynamic>>>(managedPrometheuses, (value) => pulumi.Input.encodeList<GetClusterMonitoringConfigManagedPrometheus, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory GetClusterMonitoringConfig.fromMap(Map<String, dynamic> map) {
    return GetClusterMonitoringConfig(
      advancedDatapathObservabilityConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetClusterMonitoringConfigAdvancedDatapathObservabilityConfig>(map['advancedDatapathObservabilityConfigs']!, (value) => GetClusterMonitoringConfigAdvancedDatapathObservabilityConfig.fromMap((value as Map).cast<String, dynamic>()))),
      enableComponents: pulumi.Input.fromValue((map['enableComponents'] as List).cast<String>()),
      managedPrometheuses: pulumi.Input.fromValue(pulumi.Input.decodeList<GetClusterMonitoringConfigManagedPrometheus>(map['managedPrometheuses']!, (value) => GetClusterMonitoringConfigManagedPrometheus.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
