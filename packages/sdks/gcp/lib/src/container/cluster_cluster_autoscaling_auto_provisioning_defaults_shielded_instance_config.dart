...
class ClusterClusterAutoscalingAutoProvisioningDefaultsShieldedInstanceConfig {
  ...
  const ClusterClusterAutoscalingAutoProvisioningDefaultsShieldedInstanceConfig({
  ...
  factory ClusterClusterAutoscalingAutoProvisioningDefaultsShieldedInstanceConfig.fromMap(Map<String, dynamic> map) {
