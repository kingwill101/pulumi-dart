...
class ClusterControlPlaneEndpointsConfig {
  ...
  final pulumi.Input<ClusterControlPlaneEndpointsConfigDnsEndpointConfig>?
  dnsEndpointConfig;

  /// IP endpoint configuration.
  final pulumi.Input<ClusterControlPlaneEndpointsConfigIpEndpointsConfig>?
  ipEndpointsConfig;
    ...
    return <String, dynamic>{
      'dnsEndpointConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(dnsEndpointConfig, (value) => value.toMap()),
      'ipEndpointsConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ClusterControlPlaneEndpointsConfigIpEndpointsConfig,
            Map<String, dynamic>
          >(ipEndpointsConfig, (value) => value.toMap()),
    };
  }
  ...
  factory ClusterControlPlaneEndpointsConfig.fromMap(Map<String, dynamic> map) {
    return ClusterControlPlaneEndpointsConfig(
      dnsEndpointConfig: (() {
        final guardedValue = map['dnsEndpointConfig'];
      ...
      ipEndpointsConfig: (() {
        final guardedValue = map['ipEndpointsConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
