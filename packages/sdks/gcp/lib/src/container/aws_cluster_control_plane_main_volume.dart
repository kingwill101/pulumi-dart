...
class AwsClusterControlPlaneMainVolume {
  ...
  /// Creates a new [AwsClusterControlPlaneMainVolume].
  ...
  const AwsClusterControlPlaneMainVolume({
    this.iops,
    this.kmsKeyArn,
    this.sizeGib,
    this.throughput,
  ...
  factory AwsClusterControlPlaneMainVolume.fromMap(Map<String, dynamic> map) {
