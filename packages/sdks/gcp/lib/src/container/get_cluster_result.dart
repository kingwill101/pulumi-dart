    ...
    return <String, dynamic>{
      ...
      'clusterAutoscalings':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(clusterAutoscalings, (value) => value.toMap()),
      'clusterIpv4Cidr': clusterIpv4Cidr,
      'clusterTelemetries':
          pulumi.Input.encodeList<
            GetClusterClusterTelemetry,
            Map<String, dynamic>
          >(clusterTelemetries, (value) => value.toMap()),
      'confidentialNodes':
          pulumi.Input.encodeList<
      ...
      'costManagementConfigs':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(costManagementConfigs, (value) => value.toMap()),
      'databaseEncryptions':
          pulumi.Input.encodeList<
            GetClusterDatabaseEncryption,
            Map<String, dynamic>
          >(databaseEncryptions, (value) => value.toMap()),
      ...
      'defaultSnatStatuses':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(defaultSnatStatuses, (value) => value.toMap()),
      ...
      'enterpriseConfigs':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(enterpriseConfigs, (value) => value.toMap()),
      'fleets': pulumi.Input.encodeList<GetClusterFleet, Map<String, dynamic>>(
        fleets,
        (value) => value.toMap(),
      ),
      'gatewayApiConfigs':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(gatewayApiConfigs, (value) => value.toMap()),
      'gkeAutoUpgradeConfigs':
          pulumi.Input.encodeList<
            GetClusterGkeAutoUpgradeConfig,
            Map<String, dynamic>
          >(gkeAutoUpgradeConfigs, (value) => value.toMap()),
      'id': id,
      'identityServiceConfigs':
          pulumi.Input.encodeList<
            GetClusterIdentityServiceConfig,
            Map<String, dynamic>
          >(identityServiceConfigs, (value) => value.toMap()),
      ...
      'ipAllocationPolicies':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(ipAllocationPolicies, (value) => value.toMap()),
      ...
      'monitoringConfigs':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(monitoringConfigs, (value) => value.toMap()),
      ...
      'nodePoolAutoConfigs':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(nodePoolAutoConfigs, (value) => value.toMap()),
      'nodePoolDefaults':
          pulumi.Input.encodeList<
      ...
      'privateClusterConfigs':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(privateClusterConfigs, (value) => value.toMap()),
      ...
      'rbacBindingConfigs':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(rbacBindingConfigs, (value) => value.toMap()),
      'releaseChannels':
          pulumi.Input.encodeList<
      ...
      'secretManagerConfigs':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(secretManagerConfigs, (value) => value.toMap()),
      'secretSyncConfigs':
          pulumi.Input.encodeList<
            GetClusterSecretSyncConfig,
            Map<String, dynamic>
          >(secretSyncConfigs, (value) => value.toMap()),
      'securityPostureConfigs':
          pulumi.Input.encodeList<
            GetClusterSecurityPostureConfig,
            Map<String, dynamic>
          >(securityPostureConfigs, (value) => value.toMap()),
      'selfLink': selfLink,
      ...
      'userManagedKeysConfigs':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(userManagedKeysConfigs, (value) => value.toMap()),
      ...
      'workloadAltsConfigs':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(workloadAltsConfigs, (value) => value.toMap()),
  ...
  factory GetClusterResult.fromMap(Map<String, dynamic> map) {
    return GetClusterResult(
      ...
      dnsConfigs: pulumi.Input.decodeList<GetClusterDnsConfig>(
        map['dnsConfigs']!,
        (value) =>
            GetClusterDnsConfig.fromMap((value as Map).cast<String, dynamic>()),
      ),
      ...
      nodePools: pulumi.Input.decodeList<GetClusterNodePool>(
        map['nodePools']!,
        (value) =>
            GetClusterNodePool.fromMap((value as Map).cast<String, dynamic>()),
      ),
      ...
      tpuConfigs: pulumi.Input.decodeList<GetClusterTpuConfig>(
        map['tpuConfigs']!,
        (value) =>
            GetClusterTpuConfig.fromMap((value as Map).cast<String, dynamic>()),
      ),
