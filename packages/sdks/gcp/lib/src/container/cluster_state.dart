...
class ClusterState {
  ...
  /// [masterVersion] The current version of the master in the cluster. This may be different than the min_master_version set in the config if the master has been updated by GKE.
  ...
  /// [servicesIpv4Cidr] The IP address range of the Kubernetes services in this cluster, in CIDR notation (e.g. 1.2.3.4/29). Service addresses are typically put in the last /16 from the container CIDR.
  /// [subnetwork] The name or self_link of the Google Compute Engine
  /// [tpuConfig] TPU configuration for the cluster.
  /// [tpuIpv4CidrBlock] The IP address range of the Cloud TPUs in this cluster, in CIDR notation (e.g. 1.2.3.4/29).
  ...
  ClusterState({
    ...
    pulumi.Output<String>? masterVersion,
    ...
    pulumi.Output<String>? servicesIpv4Cidr,
    pulumi.Output<String>? subnetwork,
    pulumi.Output<ClusterTpuConfig>? tpuConfig,
    pulumi.Output<String>? tpuIpv4CidrBlock,
    ...
    pulumi.Output<ClusterWorkloadIdentityConfig>? workloadIdentityConfig,
      ...
      masterVersion = pulumi.Input.asOptionalInput<String>(masterVersion),
      ...
      servicesIpv4Cidr = pulumi.Input.asOptionalInput<String>(servicesIpv4Cidr),
      ...
      tpuIpv4CidrBlock = pulumi.Input.asOptionalInput<String>(tpuIpv4CidrBlock),
  ...
  factory ClusterState.fromMap(Map<String, dynamic> map) {
    return ClusterState(
      ...
      masterVersion: map['masterVersion'] == null ? null : pulumi.Output.create<String>(map['masterVersion'] as String),
      ...
      servicesIpv4Cidr: map['servicesIpv4Cidr'] == null ? null : pulumi.Output.create<String>(map['servicesIpv4Cidr'] as String),
      ...
      tpuIpv4CidrBlock: map['tpuIpv4CidrBlock'] == null ? null : pulumi.Output.create<String>(map['tpuIpv4CidrBlock'] as String),
