...
class ClusterNodePoolNodeConfigKubeletConfig {
  ...
  final pulumi.Input<ClusterNodePoolNodeConfigKubeletConfigEvictionSoft>?
  evictionSoft;
  ...
  final pulumi.Input<ClusterNodePoolNodeConfigKubeletConfigMemoryManager>?
  memoryManager;
  ...
  final pulumi.Input<ClusterNodePoolNodeConfigKubeletConfigTopologyManager>?
  topologyManager;
