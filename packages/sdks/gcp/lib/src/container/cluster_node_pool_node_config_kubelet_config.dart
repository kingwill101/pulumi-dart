...
import 'cluster_node_pool_node_config_kubelet_config_crash_loop_back_off.dart';
...
class ClusterNodePoolNodeConfigKubeletConfig {
  ...
  final pulumi.Input<ClusterNodePoolNodeConfigKubeletConfigCrashLoopBackOff?>? crashLoopBackOff;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'crashLoopBackOff': ?pulumi.Input.mapOptionalInputValue<ClusterNodePoolNodeConfigKubeletConfigCrashLoopBackOff, Map<String, dynamic>>(crashLoopBackOff, (value) => value.toMap()),
  ...
  factory ClusterNodePoolNodeConfigKubeletConfig.fromMap(Map<String, dynamic> map) {
    return ClusterNodePoolNodeConfigKubeletConfig(
      ...
      crashLoopBackOff: (() { final guardedValue = map['crashLoopBackOff']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterNodePoolNodeConfigKubeletConfigCrashLoopBackOff.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      evictionMinimumReclaim: (() { final guardedValue = map['evictionMinimumReclaim']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterNodePoolNodeConfigKubeletConfigEvictionMinimumReclaim.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      evictionSoft: (() { final guardedValue = map['evictionSoft']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterNodePoolNodeConfigKubeletConfigEvictionSoft.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      evictionSoftGracePeriod: (() { final guardedValue = map['evictionSoftGracePeriod']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterNodePoolNodeConfigKubeletConfigEvictionSoftGracePeriod.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      memoryManager: (() { final guardedValue = map['memoryManager']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterNodePoolNodeConfigKubeletConfigMemoryManager.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      topologyManager: (() { final guardedValue = map['topologyManager']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterNodePoolNodeConfigKubeletConfigTopologyManager.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
