...
class GetClusterNodePoolNodeConfigContainerdConfig {
  ...
  final pulumi.Input<
    List<GetClusterNodePoolNodeConfigContainerdConfigRegistryHost>
  >
  registryHosts;

  /// Parameters for writable cgroups configuration.
  final pulumi.Input<
    List<GetClusterNodePoolNodeConfigContainerdConfigWritableCgroup>
  >
  writableCgroups;
    ...
    return GetClusterNodePoolNodeConfigContainerdConfig(
      privateRegistryAccessConfigs: pulumi.Input.fromValue(
        ...
        >(
          ...
          (value) =>
              GetClusterNodePoolNodeConfigContainerdConfigPrivateRegistryAccessConfig.fromMap(
      ...
      writableCgroups: pulumi.Input.fromValue(
        ...
        >(
          map['writableCgroups']!,
          (value) =>
              GetClusterNodePoolNodeConfigContainerdConfigWritableCgroup.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
