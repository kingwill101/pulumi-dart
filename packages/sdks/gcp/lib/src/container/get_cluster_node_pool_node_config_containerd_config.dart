...
class GetClusterNodePoolNodeConfigContainerdConfig {
  ...
  factory GetClusterNodePoolNodeConfigContainerdConfig.fromMap(Map<String, dynamic> map) {
    return GetClusterNodePoolNodeConfigContainerdConfig(
      privateRegistryAccessConfigs: (pulumi.Input.decodeList<GetClusterNodePoolNodeConfigContainerdConfigPrivateRegistryAccessConfig>(map['privateRegistryAccessConfigs'], (value) => GetClusterNodePoolNodeConfigContainerdConfigPrivateRegistryAccessConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
      registryHosts: (pulumi.Input.decodeList<GetClusterNodePoolNodeConfigContainerdConfigRegistryHost>(map['registryHosts'], (value) => GetClusterNodePoolNodeConfigContainerdConfigRegistryHost.fromMap((value as Map).cast<String, dynamic>()))).input(),
      writableCgroups: (pulumi.Input.decodeList<GetClusterNodePoolNodeConfigContainerdConfigWritableCgroup>(map['writableCgroups'], (value) => GetClusterNodePoolNodeConfigContainerdConfigWritableCgroup.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
