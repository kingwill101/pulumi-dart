...
class GetClusterNodePoolNodeConfigHostMaintenancePolicyOpportunisticMaintenanceStrategy {
  ...
  /// Creates a new [GetClusterNodePoolNodeConfigHostMaintenancePolicyOpportunisticMaintenanceStrategy].
  ...
  const GetClusterNodePoolNodeConfigHostMaintenancePolicyOpportunisticMaintenanceStrategy({
  ...
  factory GetClusterNodePoolNodeConfigHostMaintenancePolicyOpportunisticMaintenanceStrategy.fromMap(Map<String, dynamic> map) {
    return GetClusterNodePoolNodeConfigHostMaintenancePolicyOpportunisticMaintenanceStrategy(
