...
class NodePoolNodeConfigHostMaintenancePolicyOpportunisticMaintenanceStrategy {
  ...
  /// Creates a new [NodePoolNodeConfigHostMaintenancePolicyOpportunisticMaintenanceStrategy].
  ...
  const NodePoolNodeConfigHostMaintenancePolicyOpportunisticMaintenanceStrategy({
  ...
  factory NodePoolNodeConfigHostMaintenancePolicyOpportunisticMaintenanceStrategy.fromMap(Map<String, dynamic> map) {
    return NodePoolNodeConfigHostMaintenancePolicyOpportunisticMaintenanceStrategy(
