...
class ClusterNodeConfigLinuxNodeConfigCustomNodeInitInitScript {
  ...
  /// Creates a new [ClusterNodeConfigLinuxNodeConfigCustomNodeInitInitScript].
  ...
  const ClusterNodeConfigLinuxNodeConfigCustomNodeInitInitScript({
  ...
  factory ClusterNodeConfigLinuxNodeConfigCustomNodeInitInitScript.fromMap(Map<String, dynamic> map) {
    return ClusterNodeConfigLinuxNodeConfigCustomNodeInitInitScript(
