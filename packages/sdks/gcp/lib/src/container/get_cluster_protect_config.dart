...
class GetClusterProtectConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'workloadConfigs': pulumi.Input.encodeList<GetClusterProtectConfigWorkloadConfig, Map<String, dynamic>>(workloadConfigs, (value) => value.toMap()),
  ...
  factory GetClusterProtectConfig.fromMap(Map<String, dynamic> map) {
    return GetClusterProtectConfig(
      workloadConfigs: pulumi.Input.decodeList<GetClusterProtectConfigWorkloadConfig>(map['workloadConfigs'], (value) => GetClusterProtectConfigWorkloadConfig.fromMap((value as Map).cast<String, dynamic>())),
