...
class GetClusterProtectConfig {
  ...
  factory GetClusterProtectConfig.fromMap(Map<String, dynamic> map) {
    return GetClusterProtectConfig(
      workloadConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetClusterProtectConfigWorkloadConfig>(map['workloadConfigs']!, (value) => GetClusterProtectConfigWorkloadConfig.fromMap((value as Map).cast<String, dynamic>()))),
      workloadVulnerabilityMode: pulumi.Input.fromValue(map['workloadVulnerabilityMode'] as String),
    );
  }
}
