...
class GetClusterNodeConfigContainerdConfigRegistryHostHost {
  ...
  final pulumi.Input<
    List<GetClusterNodeConfigContainerdConfigRegistryHostHostCa>
  >
  cas;

  /// Configures the registry host client certificate and key.
  final pulumi.Input<
    List<GetClusterNodeConfigContainerdConfigRegistryHostHostClient>
  >
  clients;
  ...
  final pulumi.Input<
    List<GetClusterNodeConfigContainerdConfigRegistryHostHostHeader>
  >
  headers;
