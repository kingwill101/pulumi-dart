...
class GetClusterMasterAuthorizedNetworksConfig {
  ...
  final pulumi.Input<List<GetClusterMasterAuthorizedNetworksConfigCidrBlock>>
  cidrBlocks;
    ...
    return <String, dynamic>{
      'cidrBlocks':
          pulumi.Input.mapInputValue<
            List<GetClusterMasterAuthorizedNetworksConfigCidrBlock>,
  ...
  factory GetClusterMasterAuthorizedNetworksConfig.fromMap(
    ...
    return GetClusterMasterAuthorizedNetworksConfig(
      ...
      privateEndpointEnforcementEnabled: pulumi.Input.fromValue(
