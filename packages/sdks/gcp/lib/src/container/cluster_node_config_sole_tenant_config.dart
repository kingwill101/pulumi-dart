...
class ClusterNodeConfigSoleTenantConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'nodeAffinities': pulumi.Input.encodeList<ClusterNodeConfigSoleTenantConfigNodeAffinity, Map<String, dynamic>>(nodeAffinities, (value) => value.toMap()),
    };
  }
  ...
  factory ClusterNodeConfigSoleTenantConfig.fromMap(Map<String, dynamic> map) {
    return ClusterNodeConfigSoleTenantConfig(
      ...
      nodeAffinities: pulumi.Input.decodeList<ClusterNodeConfigSoleTenantConfigNodeAffinity>(map['nodeAffinities'], (value) => ClusterNodeConfigSoleTenantConfigNodeAffinity.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
