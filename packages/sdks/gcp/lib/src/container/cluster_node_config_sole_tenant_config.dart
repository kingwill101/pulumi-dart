...
class ClusterNodeConfigSoleTenantConfig {
  ...
  final pulumi.Input<List<ClusterNodeConfigSoleTenantConfigNodeAffinity>>
  nodeAffinities;
    ...
    return <String, dynamic>{
      ...
      'nodeAffinities':
          pulumi.Input.mapInputValue<
            List<ClusterNodeConfigSoleTenantConfigNodeAffinity>,
  ...
  factory ClusterNodeConfigSoleTenantConfig.fromMap(Map<String, dynamic> map) {
    return ClusterNodeConfigSoleTenantConfig(
      ...
      nodeAffinities: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ClusterNodeConfigSoleTenantConfigNodeAffinity>(
          map['nodeAffinities']!,
