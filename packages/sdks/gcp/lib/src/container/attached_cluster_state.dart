...
class AttachedClusterState {
  ...
  AttachedClusterState({
    ...
    pulumi.Output<String>? clusterRegion,
    ...
    pulumi.Output<List<AttachedClusterError>>? errors,
    pulumi.Output<AttachedClusterFleet>? fleet,
    ...
    pulumi.Output<AttachedClusterOidcConfig>? oidcConfig,
    ...
    pulumi.Output<List<AttachedClusterWorkloadIdentityConfig>>? workloadIdentityConfigs,
  }) :
      ...
      clusterRegion = pulumi.Input.asOptionalInput<String>(clusterRegion),
      ...
      errors = pulumi.Input.asOptionalInput<List<AttachedClusterError>>(errors),
      fleet = pulumi.Input.asOptionalInput<AttachedClusterFleet>(fleet),
      ...
      oidcConfig = pulumi.Input.asOptionalInput<AttachedClusterOidcConfig>(oidcConfig),
      ...
      workloadIdentityConfigs = pulumi.Input.asOptionalInput<List<AttachedClusterWorkloadIdentityConfig>>(workloadIdentityConfigs);
  ...
  factory AttachedClusterState.fromMap(Map<String, dynamic> map) {
    return AttachedClusterState(
      ...
      clusterRegion: map['clusterRegion'] == null ? null : pulumi.Output.create<String>(map['clusterRegion'] as String),
      ...
      errors: map['errors'] == null ? null : pulumi.Output.create<List<AttachedClusterError>>(pulumi.Input.decodeList<AttachedClusterError>(map['errors'], (value) => AttachedClusterError.fromMap((value as Map).cast<String, dynamic>()))),
      fleet: map['fleet'] == null ? null : pulumi.Output.create<AttachedClusterFleet>(AttachedClusterFleet.fromMap((map['fleet'] as Map).cast<String, dynamic>())),
      ...
      oidcConfig: map['oidcConfig'] == null ? null : pulumi.Output.create<AttachedClusterOidcConfig>(AttachedClusterOidcConfig.fromMap((map['oidcConfig'] as Map).cast<String, dynamic>())),
      ...
      workloadIdentityConfigs: map['workloadIdentityConfigs'] == null ? null : pulumi.Output.create<List<AttachedClusterWorkloadIdentityConfig>>(pulumi.Input.decodeList<AttachedClusterWorkloadIdentityConfig>(map['workloadIdentityConfigs'], (value) => AttachedClusterWorkloadIdentityConfig.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
