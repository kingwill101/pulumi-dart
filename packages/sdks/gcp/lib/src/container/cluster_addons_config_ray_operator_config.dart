...
class ClusterAddonsConfigRayOperatorConfig {
    ...
    return <String, dynamic>{
      ...
      'rayClusterLoggingConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ClusterAddonsConfigRayOperatorConfigRayClusterLoggingConfig,
            Map<String, dynamic>
          >(rayClusterLoggingConfig, (value) => value.toMap()),
      'rayClusterMonitoringConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ClusterAddonsConfigRayOperatorConfigRayClusterMonitoringConfig,
            Map<String, dynamic>
          >(rayClusterMonitoringConfig, (value) => value.toMap()),
    };
  }
  ...
  factory ClusterAddonsConfigRayOperatorConfig.fromMap(
    ...
    return ClusterAddonsConfigRayOperatorConfig(
      ...
      rayClusterLoggingConfig: (() {
        final guardedValue = map['rayClusterLoggingConfig'];
      ...
      rayClusterMonitoringConfig: (() {
        final guardedValue = map['rayClusterMonitoringConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
