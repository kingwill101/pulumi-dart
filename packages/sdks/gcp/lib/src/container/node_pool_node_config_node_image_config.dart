...
class NodePoolNodeConfigNodeImageConfig {
  ...
  const NodePoolNodeConfigNodeImageConfig({
    this.image,
    this.imageProject,
  });
  ...
  factory NodePoolNodeConfigNodeImageConfig.fromMap(Map<String, dynamic> map) {
    return NodePoolNodeConfigNodeImageConfig(
