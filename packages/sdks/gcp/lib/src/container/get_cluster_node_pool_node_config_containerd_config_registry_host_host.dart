...
class GetClusterNodePoolNodeConfigContainerdConfigRegistryHostHost {
  ...
  final pulumi.Input<
    List<GetClusterNodePoolNodeConfigContainerdConfigRegistryHostHostCa>
  >
  cas;

  /// Configures the registry host client certificate and key.
  final pulumi.Input<
    List<GetClusterNodePoolNodeConfigContainerdConfigRegistryHostHostClient>
  >
  clients;
  ...
  final pulumi.Input<
    List<GetClusterNodePoolNodeConfigContainerdConfigRegistryHostHostHeader>
  >
  headers;
