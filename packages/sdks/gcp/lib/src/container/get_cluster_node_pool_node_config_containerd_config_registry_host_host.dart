...
class GetClusterNodePoolNodeConfigContainerdConfigRegistryHostHost {
  ...
  const GetClusterNodePoolNodeConfigContainerdConfigRegistryHostHost({
  ...
  factory GetClusterNodePoolNodeConfigContainerdConfigRegistryHostHost.fromMap(Map<String, dynamic> map) {
    return GetClusterNodePoolNodeConfigContainerdConfigRegistryHostHost(
      ...
      cas: pulumi.Input.fromValue(pulumi.Input.decodeList<GetClusterNodePoolNodeConfigContainerdConfigRegistryHostHostCa>(map['cas']!, (value) => GetClusterNodePoolNodeConfigContainerdConfigRegistryHostHostCa.fromMap((value as Map).cast<String, dynamic>()))),
      clients: pulumi.Input.fromValue(pulumi.Input.decodeList<GetClusterNodePoolNodeConfigContainerdConfigRegistryHostHostClient>(map['clients']!, (value) => GetClusterNodePoolNodeConfigContainerdConfigRegistryHostHostClient.fromMap((value as Map).cast<String, dynamic>()))),
      dialTimeout: pulumi.Input.fromValue(map['dialTimeout'] as String),
      headers: pulumi.Input.fromValue(pulumi.Input.decodeList<GetClusterNodePoolNodeConfigContainerdConfigRegistryHostHostHeader>(map['headers']!, (value) => GetClusterNodePoolNodeConfigContainerdConfigRegistryHostHostHeader.fromMap((value as Map).cast<String, dynamic>()))),
