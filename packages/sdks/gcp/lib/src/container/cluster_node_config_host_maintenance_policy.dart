...
import 'cluster_node_config_host_maintenance_policy_opportunistic_maintenance_strategy.dart';
...
class ClusterNodeConfigHostMaintenancePolicy {
  ...
  final pulumi.Input<ClusterNodeConfigHostMaintenancePolicyOpportunisticMaintenanceStrategy?>? opportunisticMaintenanceStrategy;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'opportunisticMaintenanceStrategy': ?pulumi.Input.mapOptionalInputValue<ClusterNodeConfigHostMaintenancePolicyOpportunisticMaintenanceStrategy, Map<String, dynamic>>(opportunisticMaintenanceStrategy, (value) => value.toMap()),
    };
  }
  ...
  factory ClusterNodeConfigHostMaintenancePolicy.fromMap(Map<String, dynamic> map) {
    return ClusterNodeConfigHostMaintenancePolicy(
      ...
      opportunisticMaintenanceStrategy: (() { final guardedValue = map['opportunisticMaintenanceStrategy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterNodeConfigHostMaintenancePolicyOpportunisticMaintenanceStrategy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
