...
class ClusterNodePoolUpgradeSettings {
  ...
  factory ClusterNodePoolUpgradeSettings.fromMap(Map<String, dynamic> map) {
    return ClusterNodePoolUpgradeSettings(
      blueGreenSettings: map['blueGreenSettings'] == null ? null : ClusterNodePoolUpgradeSettingsBlueGreenSettings.fromMap((map['blueGreenSettings'] as Map).cast<String, dynamic>()),
