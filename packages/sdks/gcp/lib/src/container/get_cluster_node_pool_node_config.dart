...
class GetClusterNodePoolNodeConfig {
  ...
  final pulumi.Input<List<GetClusterNodePoolNodeConfigAdvancedMachineFeature>>
  ...
  final pulumi.Input<List<GetClusterNodePoolNodeConfigConfidentialNode>>
  confidentialNodes;

  /// Parameters for containerd configuration.
  final pulumi.Input<List<GetClusterNodePoolNodeConfigContainerdConfig>>
  containerdConfigs;
  ...
  final pulumi.Input<List<GetClusterNodePoolNodeConfigEffectiveTaint>>
  effectiveTaints;
  ...
  final pulumi.Input<List<GetClusterNodePoolNodeConfigEphemeralStorageConfig>>
  ephemeralStorageConfigs;

  /// Parameters for the ephemeral storage filesystem. If unspecified, ephemeral storage is backed by the boot disk.
  final pulumi.Input<
    List<GetClusterNodePoolNodeConfigEphemeralStorageLocalSsdConfig>
  >
  ...
  final pulumi.Input<List<GetClusterNodePoolNodeConfigGuestAccelerator>>
  guestAccelerators;
  ...
  final pulumi.Input<List<GetClusterNodePoolNodeConfigHostMaintenancePolicy>>
  ...
  final pulumi.Input<List<GetClusterNodePoolNodeConfigKubeletConfig>>
  kubeletConfigs;
  ...
  final pulumi.Input<List<GetClusterNodePoolNodeConfigLinuxNodeConfig>>
  linuxNodeConfigs;

  /// Parameters for raw-block local NVMe SSDs.
  final pulumi.Input<List<GetClusterNodePoolNodeConfigLocalNvmeSsdBlockConfig>>
  ...
  final pulumi.Input<List<GetClusterNodePoolNodeConfigReservationAffinity>>
  ...
  final pulumi.Input<List<GetClusterNodePoolNodeConfigSandboxConfig>>
  sandboxConfigs;

  /// Secondary boot disks for preloading data or container images.
  final pulumi.Input<List<GetClusterNodePoolNodeConfigSecondaryBootDisk>>
  secondaryBootDisks;
  ...
  final pulumi.Input<List<GetClusterNodePoolNodeConfigShieldedInstanceConfig>>
  shieldedInstanceConfigs;

  /// Node affinity options for sole tenant node pools.
  final pulumi.Input<List<GetClusterNodePoolNodeConfigSoleTenantConfig>>
  soleTenantConfigs;
  ...
  final pulumi.Input<List<GetClusterNodePoolNodeConfigWindowsNodeConfig>>
  windowsNodeConfigs;

  /// The workload metadata configuration for this node.
  final pulumi.Input<List<GetClusterNodePoolNodeConfigWorkloadMetadataConfig>>
    ...
    return <String, dynamic>{
      'advancedMachineFeatures':
          pulumi.Input.mapInputValue<
            List<GetClusterNodePoolNodeConfigAdvancedMachineFeature>,
      ...
      'bootDisks':
          pulumi.Input.mapInputValue<
            List<GetClusterNodePoolNodeConfigBootDisk>,
            List<Map<String, dynamic>>
          >(
            bootDisks,
            (value) =>
      ...
      'confidentialNodes':
          pulumi.Input.mapInputValue<
            List<GetClusterNodePoolNodeConfigConfidentialNode>,
            List<Map<String, dynamic>>
          >(
            confidentialNodes,
            (value) =>
      ...
      'containerdConfigs':
          pulumi.Input.mapInputValue<
            List<GetClusterNodePoolNodeConfigContainerdConfig>,
            List<Map<String, dynamic>>
          >(
            containerdConfigs,
            (value) =>
      ...
      'effectiveTaints':
          pulumi.Input.mapInputValue<
            List<GetClusterNodePoolNodeConfigEffectiveTaint>,
            List<Map<String, dynamic>>
          >(
            effectiveTaints,
            (value) =>
      ...
      'ephemeralStorageConfigs':
          pulumi.Input.mapInputValue<
            List<GetClusterNodePoolNodeConfigEphemeralStorageConfig>,
            List<Map<String, dynamic>>
          >(
            ephemeralStorageConfigs,
            (value) =>
      ...
      'fastSockets':
          pulumi.Input.mapInputValue<
            List<GetClusterNodePoolNodeConfigFastSocket>,
            List<Map<String, dynamic>>
          >(
            fastSockets,
            (value) =>
      ...
      'gcfsConfigs':
          pulumi.Input.mapInputValue<
            List<GetClusterNodePoolNodeConfigGcfsConfig>,
            List<Map<String, dynamic>>
          >(
            gcfsConfigs,
            (value) =>
      ...
      'guestAccelerators':
          pulumi.Input.mapInputValue<
            List<GetClusterNodePoolNodeConfigGuestAccelerator>,
            List<Map<String, dynamic>>
          >(
            guestAccelerators,
            (value) =>
      ...
      'gvnics':
          pulumi.Input.mapInputValue<
            List<GetClusterNodePoolNodeConfigGvnic>,
            List<Map<String, dynamic>>
          >(
            gvnics,
            (value) =>
      ...
      'kubeletConfigs':
          pulumi.Input.mapInputValue<
            List<GetClusterNodePoolNodeConfigKubeletConfig>,
            List<Map<String, dynamic>>
          >(
            kubeletConfigs,
            (value) =>
      ...
      'linuxNodeConfigs':
          pulumi.Input.mapInputValue<
            List<GetClusterNodePoolNodeConfigLinuxNodeConfig>,
            List<Map<String, dynamic>>
          >(
            linuxNodeConfigs,
            (value) =>
      ...
      'reservationAffinities':
          pulumi.Input.mapInputValue<
            List<GetClusterNodePoolNodeConfigReservationAffinity>,
            List<Map<String, dynamic>>
          >(
            reservationAffinities,
            (value) =>
      ...
      'sandboxConfigs':
          pulumi.Input.mapInputValue<
            List<GetClusterNodePoolNodeConfigSandboxConfig>,
            List<Map<String, dynamic>>
          >(
            sandboxConfigs,
            (value) =>
      ...
      'shieldedInstanceConfigs':
          pulumi.Input.mapInputValue<
            List<GetClusterNodePoolNodeConfigShieldedInstanceConfig>,
            List<Map<String, dynamic>>
          >(
            shieldedInstanceConfigs,
            (value) =>
      ...
      'soleTenantConfigs':
          pulumi.Input.mapInputValue<
            List<GetClusterNodePoolNodeConfigSoleTenantConfig>,
            List<Map<String, dynamic>>
          >(
            soleTenantConfigs,
            (value) =>
      ...
      'taints':
          pulumi.Input.mapInputValue<
            List<GetClusterNodePoolNodeConfigTaint>,
            List<Map<String, dynamic>>
          >(
            taints,
            (value) =>
      ...
      'windowsNodeConfigs':
          pulumi.Input.mapInputValue<
            List<GetClusterNodePoolNodeConfigWindowsNodeConfig>,
            List<Map<String, dynamic>>
          >(
            windowsNodeConfigs,
            (value) =>
      ...
      'workloadMetadataConfigs':
          pulumi.Input.mapInputValue<
            List<GetClusterNodePoolNodeConfigWorkloadMetadataConfig>,
            List<Map<String, dynamic>>
          >(
            workloadMetadataConfigs,
            (value) =>
  ...
  factory GetClusterNodePoolNodeConfig.fromMap(Map<String, dynamic> map) {
    return GetClusterNodePoolNodeConfig(
      ...
      bootDisks: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetClusterNodePoolNodeConfigBootDisk>(
          map['bootDisks']!,
      ...
      containerdConfigs: pulumi.Input.fromValue(
      ...
      effectiveTaints: pulumi.Input.fromValue(
      ...
      ephemeralStorageConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetClusterNodePoolNodeConfigEphemeralStorageConfig
        >(
      ...
      ephemeralStorageLocalSsdConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetClusterNodePoolNodeConfigEphemeralStorageLocalSsdConfig
        >(
      ...
      fastSockets: pulumi.Input.fromValue(
      ...
      gcfsConfigs: pulumi.Input.fromValue(
      ...
      gvnics: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetClusterNodePoolNodeConfigGvnic>(
          map['gvnics']!,
      ...
      hostMaintenancePolicies: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetClusterNodePoolNodeConfigHostMaintenancePolicy
        >(
      ...
      kubeletConfigs: pulumi.Input.fromValue(
      ...
      linuxNodeConfigs: pulumi.Input.fromValue(
      ...
      localNvmeSsdBlockConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetClusterNodePoolNodeConfigLocalNvmeSsdBlockConfig
        >(
      ...
      localSsdEncryptionMode: pulumi.Input.fromValue(
      ...
      reservationAffinities: pulumi.Input.fromValue(
        pulumi
            .Input.decodeList<GetClusterNodePoolNodeConfigReservationAffinity>(
      ...
      sandboxConfigs: pulumi.Input.fromValue(
      ...
      secondaryBootDisks: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetClusterNodePoolNodeConfigSecondaryBootDisk>(
      ...
      shieldedInstanceConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetClusterNodePoolNodeConfigShieldedInstanceConfig
        >(
      ...
      soleTenantConfigs: pulumi.Input.fromValue(
      ...
      storagePools: pulumi.Input.fromValue(
        (map['storagePools'] as List).cast<String>(),
      ),
      tags: pulumi.Input.fromValue((map['tags'] as List).cast<String>()),
      taints: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetClusterNodePoolNodeConfigTaint>(
          map['taints']!,
      ...
      windowsNodeConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetClusterNodePoolNodeConfigWindowsNodeConfig>(
      ...
      workloadMetadataConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetClusterNodePoolNodeConfigWorkloadMetadataConfig
        >(
