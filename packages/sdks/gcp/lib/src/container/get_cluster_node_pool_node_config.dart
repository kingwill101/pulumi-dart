...
class GetClusterNodePoolNodeConfig {
  ...
  final List<GetClusterNodePoolNodeConfigAdvancedMachineFeature> advancedMachineFeatures;
  ...
  final List<GetClusterNodePoolNodeConfigEphemeralStorageConfig> ephemeralStorageConfigs;
  /// Parameters for the ephemeral storage filesystem. If unspecified, ephemeral storage is backed by the boot disk.
  final List<GetClusterNodePoolNodeConfigEphemeralStorageLocalSsdConfig> ephemeralStorageLocalSsdConfigs;
  ...
  final List<GetClusterNodePoolNodeConfigHostMaintenancePolicy> hostMaintenancePolicies;
  ...
  final List<GetClusterNodePoolNodeConfigLocalNvmeSsdBlockConfig> localNvmeSsdBlockConfigs;
  ...
  final List<GetClusterNodePoolNodeConfigReservationAffinity> reservationAffinities;
  ...
  final List<GetClusterNodePoolNodeConfigShieldedInstanceConfig> shieldedInstanceConfigs;
  ...
  final List<GetClusterNodePoolNodeConfigWorkloadMetadataConfig> workloadMetadataConfigs;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'advancedMachineFeatures': pulumi.Input.encodeList<GetClusterNodePoolNodeConfigAdvancedMachineFeature, Map<String, dynamic>>(advancedMachineFeatures, (value) => value.toMap()),
      'bootDiskKmsKey': bootDiskKmsKey,
      'bootDisks': pulumi.Input.encodeList<GetClusterNodePoolNodeConfigBootDisk, Map<String, dynamic>>(bootDisks, (value) => value.toMap()),
      'confidentialNodes': pulumi.Input.encodeList<GetClusterNodePoolNodeConfigConfidentialNode, Map<String, dynamic>>(confidentialNodes, (value) => value.toMap()),
      'containerdConfigs': pulumi.Input.encodeList<GetClusterNodePoolNodeConfigContainerdConfig, Map<String, dynamic>>(containerdConfigs, (value) => value.toMap()),
      'diskSizeGb': diskSizeGb,
      'diskType': diskType,
      'effectiveTaints': pulumi.Input.encodeList<GetClusterNodePoolNodeConfigEffectiveTaint, Map<String, dynamic>>(effectiveTaints, (value) => value.toMap()),
      'enableConfidentialStorage': enableConfidentialStorage,
      'ephemeralStorageConfigs': pulumi.Input.encodeList<GetClusterNodePoolNodeConfigEphemeralStorageConfig, Map<String, dynamic>>(ephemeralStorageConfigs, (value) => value.toMap()),
      'ephemeralStorageLocalSsdConfigs': pulumi.Input.encodeList<GetClusterNodePoolNodeConfigEphemeralStorageLocalSsdConfig, Map<String, dynamic>>(ephemeralStorageLocalSsdConfigs, (value) => value.toMap()),
      'fastSockets': pulumi.Input.encodeList<GetClusterNodePoolNodeConfigFastSocket, Map<String, dynamic>>(fastSockets, (value) => value.toMap()),
      'flexStart': flexStart,
      'gcfsConfigs': pulumi.Input.encodeList<GetClusterNodePoolNodeConfigGcfsConfig, Map<String, dynamic>>(gcfsConfigs, (value) => value.toMap()),
      'guestAccelerators': pulumi.Input.encodeList<GetClusterNodePoolNodeConfigGuestAccelerator, Map<String, dynamic>>(guestAccelerators, (value) => value.toMap()),
      'gvnics': pulumi.Input.encodeList<GetClusterNodePoolNodeConfigGvnic, Map<String, dynamic>>(gvnics, (value) => value.toMap()),
      'hostMaintenancePolicies': pulumi.Input.encodeList<GetClusterNodePoolNodeConfigHostMaintenancePolicy, Map<String, dynamic>>(hostMaintenancePolicies, (value) => value.toMap()),
      'imageType': imageType,
      'kubeletConfigs': pulumi.Input.encodeList<GetClusterNodePoolNodeConfigKubeletConfig, Map<String, dynamic>>(kubeletConfigs, (value) => value.toMap()),
      'labels': labels,
      'linuxNodeConfigs': pulumi.Input.encodeList<GetClusterNodePoolNodeConfigLinuxNodeConfig, Map<String, dynamic>>(linuxNodeConfigs, (value) => value.toMap()),
      'localNvmeSsdBlockConfigs': pulumi.Input.encodeList<GetClusterNodePoolNodeConfigLocalNvmeSsdBlockConfig, Map<String, dynamic>>(localNvmeSsdBlockConfigs, (value) => value.toMap()),
      ...
      'reservationAffinities': pulumi.Input.encodeList<GetClusterNodePoolNodeConfigReservationAffinity, Map<String, dynamic>>(reservationAffinities, (value) => value.toMap()),
      'resourceLabels': resourceLabels,
      'resourceManagerTags': resourceManagerTags,
      'sandboxConfigs': pulumi.Input.encodeList<GetClusterNodePoolNodeConfigSandboxConfig, Map<String, dynamic>>(sandboxConfigs, (value) => value.toMap()),
      'secondaryBootDisks': pulumi.Input.encodeList<GetClusterNodePoolNodeConfigSecondaryBootDisk, Map<String, dynamic>>(secondaryBootDisks, (value) => value.toMap()),
      'serviceAccount': serviceAccount,
      'shieldedInstanceConfigs': pulumi.Input.encodeList<GetClusterNodePoolNodeConfigShieldedInstanceConfig, Map<String, dynamic>>(shieldedInstanceConfigs, (value) => value.toMap()),
      'soleTenantConfigs': pulumi.Input.encodeList<GetClusterNodePoolNodeConfigSoleTenantConfig, Map<String, dynamic>>(soleTenantConfigs, (value) => value.toMap()),
      'spot': spot,
      'storagePools': storagePools,
      'tags': tags,
      'taints': pulumi.Input.encodeList<GetClusterNodePoolNodeConfigTaint, Map<String, dynamic>>(taints, (value) => value.toMap()),
      'windowsNodeConfigs': pulumi.Input.encodeList<GetClusterNodePoolNodeConfigWindowsNodeConfig, Map<String, dynamic>>(windowsNodeConfigs, (value) => value.toMap()),
      'workloadMetadataConfigs': pulumi.Input.encodeList<GetClusterNodePoolNodeConfigWorkloadMetadataConfig, Map<String, dynamic>>(workloadMetadataConfigs, (value) => value.toMap()),
    };
  }

  factory GetClusterNodePoolNodeConfig.fromMap(Map<String, dynamic> map) {
    return GetClusterNodePoolNodeConfig(
      advancedMachineFeatures: pulumi.Input.decodeList<GetClusterNodePoolNodeConfigAdvancedMachineFeature>(map['advancedMachineFeatures'], (value) => GetClusterNodePoolNodeConfigAdvancedMachineFeature.fromMap((value as Map).cast<String, dynamic>())),
      bootDiskKmsKey: map['bootDiskKmsKey'] as String,
      bootDisks: pulumi.Input.decodeList<GetClusterNodePoolNodeConfigBootDisk>(map['bootDisks'], (value) => GetClusterNodePoolNodeConfigBootDisk.fromMap((value as Map).cast<String, dynamic>())),
      confidentialNodes: pulumi.Input.decodeList<GetClusterNodePoolNodeConfigConfidentialNode>(map['confidentialNodes'], (value) => GetClusterNodePoolNodeConfigConfidentialNode.fromMap((value as Map).cast<String, dynamic>())),
      containerdConfigs: pulumi.Input.decodeList<GetClusterNodePoolNodeConfigContainerdConfig>(map['containerdConfigs'], (value) => GetClusterNodePoolNodeConfigContainerdConfig.fromMap((value as Map).cast<String, dynamic>())),
      diskSizeGb: map['diskSizeGb'] as int,
      diskType: map['diskType'] as String,
      effectiveTaints: pulumi.Input.decodeList<GetClusterNodePoolNodeConfigEffectiveTaint>(map['effectiveTaints'], (value) => GetClusterNodePoolNodeConfigEffectiveTaint.fromMap((value as Map).cast<String, dynamic>())),
      enableConfidentialStorage: map['enableConfidentialStorage'] as bool,
      ephemeralStorageConfigs: pulumi.Input.decodeList<GetClusterNodePoolNodeConfigEphemeralStorageConfig>(map['ephemeralStorageConfigs'], (value) => GetClusterNodePoolNodeConfigEphemeralStorageConfig.fromMap((value as Map).cast<String, dynamic>())),
      ephemeralStorageLocalSsdConfigs: pulumi.Input.decodeList<GetClusterNodePoolNodeConfigEphemeralStorageLocalSsdConfig>(map['ephemeralStorageLocalSsdConfigs'], (value) => GetClusterNodePoolNodeConfigEphemeralStorageLocalSsdConfig.fromMap((value as Map).cast<String, dynamic>())),
      fastSockets: pulumi.Input.decodeList<GetClusterNodePoolNodeConfigFastSocket>(map['fastSockets'], (value) => GetClusterNodePoolNodeConfigFastSocket.fromMap((value as Map).cast<String, dynamic>())),
      flexStart: map['flexStart'] as bool,
      gcfsConfigs: pulumi.Input.decodeList<GetClusterNodePoolNodeConfigGcfsConfig>(map['gcfsConfigs'], (value) => GetClusterNodePoolNodeConfigGcfsConfig.fromMap((value as Map).cast<String, dynamic>())),
      guestAccelerators: pulumi.Input.decodeList<GetClusterNodePoolNodeConfigGuestAccelerator>(map['guestAccelerators'], (value) => GetClusterNodePoolNodeConfigGuestAccelerator.fromMap((value as Map).cast<String, dynamic>())),
      gvnics: pulumi.Input.decodeList<GetClusterNodePoolNodeConfigGvnic>(map['gvnics'], (value) => GetClusterNodePoolNodeConfigGvnic.fromMap((value as Map).cast<String, dynamic>())),
      hostMaintenancePolicies: pulumi.Input.decodeList<GetClusterNodePoolNodeConfigHostMaintenancePolicy>(map['hostMaintenancePolicies'], (value) => GetClusterNodePoolNodeConfigHostMaintenancePolicy.fromMap((value as Map).cast<String, dynamic>())),
      imageType: map['imageType'] as String,
      kubeletConfigs: pulumi.Input.decodeList<GetClusterNodePoolNodeConfigKubeletConfig>(map['kubeletConfigs'], (value) => GetClusterNodePoolNodeConfigKubeletConfig.fromMap((value as Map).cast<String, dynamic>())),
      labels: (map['labels'] as Map).cast<String, String>(),
      linuxNodeConfigs: pulumi.Input.decodeList<GetClusterNodePoolNodeConfigLinuxNodeConfig>(map['linuxNodeConfigs'], (value) => GetClusterNodePoolNodeConfigLinuxNodeConfig.fromMap((value as Map).cast<String, dynamic>())),
      localNvmeSsdBlockConfigs: pulumi.Input.decodeList<GetClusterNodePoolNodeConfigLocalNvmeSsdBlockConfig>(map['localNvmeSsdBlockConfigs'], (value) => GetClusterNodePoolNodeConfigLocalNvmeSsdBlockConfig.fromMap((value as Map).cast<String, dynamic>())),
      ...
      reservationAffinities: pulumi.Input.decodeList<GetClusterNodePoolNodeConfigReservationAffinity>(map['reservationAffinities'], (value) => GetClusterNodePoolNodeConfigReservationAffinity.fromMap((value as Map).cast<String, dynamic>())),
      ...
      sandboxConfigs: pulumi.Input.decodeList<GetClusterNodePoolNodeConfigSandboxConfig>(map['sandboxConfigs'], (value) => GetClusterNodePoolNodeConfigSandboxConfig.fromMap((value as Map).cast<String, dynamic>())),
      secondaryBootDisks: pulumi.Input.decodeList<GetClusterNodePoolNodeConfigSecondaryBootDisk>(map['secondaryBootDisks'], (value) => GetClusterNodePoolNodeConfigSecondaryBootDisk.fromMap((value as Map).cast<String, dynamic>())),
      serviceAccount: map['serviceAccount'] as String,
      shieldedInstanceConfigs: pulumi.Input.decodeList<GetClusterNodePoolNodeConfigShieldedInstanceConfig>(map['shieldedInstanceConfigs'], (value) => GetClusterNodePoolNodeConfigShieldedInstanceConfig.fromMap((value as Map).cast<String, dynamic>())),
      soleTenantConfigs: pulumi.Input.decodeList<GetClusterNodePoolNodeConfigSoleTenantConfig>(map['soleTenantConfigs'], (value) => GetClusterNodePoolNodeConfigSoleTenantConfig.fromMap((value as Map).cast<String, dynamic>())),
      spot: map['spot'] as bool,
      storagePools: (map['storagePools'] as List).cast<String>(),
      tags: (map['tags'] as List).cast<String>(),
      taints: pulumi.Input.decodeList<GetClusterNodePoolNodeConfigTaint>(map['taints'], (value) => GetClusterNodePoolNodeConfigTaint.fromMap((value as Map).cast<String, dynamic>())),
      windowsNodeConfigs: pulumi.Input.decodeList<GetClusterNodePoolNodeConfigWindowsNodeConfig>(map['windowsNodeConfigs'], (value) => GetClusterNodePoolNodeConfigWindowsNodeConfig.fromMap((value as Map).cast<String, dynamic>())),
      workloadMetadataConfigs: pulumi.Input.decodeList<GetClusterNodePoolNodeConfigWorkloadMetadataConfig>(map['workloadMetadataConfigs'], (value) => GetClusterNodePoolNodeConfigWorkloadMetadataConfig.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
