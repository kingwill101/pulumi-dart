...
class GetClusterAddonsConfigRayOperatorConfig {
  ...
  final pulumi.Input<
    List<GetClusterAddonsConfigRayOperatorConfigRayClusterLoggingConfig>
  >
  ...
  final pulumi.Input<
    List<GetClusterAddonsConfigRayOperatorConfigRayClusterMonitoringConfig>
  >
  ...
  factory GetClusterAddonsConfigRayOperatorConfig.fromMap(
    ...
    return GetClusterAddonsConfigRayOperatorConfig(
      ...
      rayClusterLoggingConfigs: pulumi.Input.fromValue(
      ...
      rayClusterMonitoringConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetClusterAddonsConfigRayOperatorConfigRayClusterMonitoringConfig
        >(
