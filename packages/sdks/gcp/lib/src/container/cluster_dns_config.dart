...
class ClusterDnsConfig {
  ...
  factory ClusterDnsConfig.fromMap(Map<String, dynamic> map) {
    return ClusterDnsConfig(
      additiveVpcScopeDnsDomain: map['additiveVpcScopeDnsDomain'] == null ? null : map['additiveVpcScopeDnsDomain'] as String,
      clusterDns: map['clusterDns'] == null ? null : map['clusterDns'] as String,
      clusterDnsDomain: map['clusterDnsDomain'] == null ? null : map['clusterDnsDomain'] as String,
      clusterDnsScope: map['clusterDnsScope'] == null ? null : map['clusterDnsScope'] as String,
    );
  }
}
