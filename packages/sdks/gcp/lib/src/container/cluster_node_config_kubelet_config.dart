...
class ClusterNodeConfigKubeletConfig {
  ...
  factory ClusterNodeConfigKubeletConfig.fromMap(Map<String, dynamic> map) {
    return ClusterNodeConfigKubeletConfig(
      ...
      evictionMinimumReclaim: map['evictionMinimumReclaim'] == null ? null : (ClusterNodeConfigKubeletConfigEvictionMinimumReclaim.fromMap((map['evictionMinimumReclaim'] as Map).cast<String, dynamic>())).input(),
      evictionSoft: map['evictionSoft'] == null ? null : (ClusterNodeConfigKubeletConfigEvictionSoft.fromMap((map['evictionSoft'] as Map).cast<String, dynamic>())).input(),
      evictionSoftGracePeriod: map['evictionSoftGracePeriod'] == null ? null : (ClusterNodeConfigKubeletConfigEvictionSoftGracePeriod.fromMap((map['evictionSoftGracePeriod'] as Map).cast<String, dynamic>())).input(),
      ...
      memoryManager: map['memoryManager'] == null ? null : (ClusterNodeConfigKubeletConfigMemoryManager.fromMap((map['memoryManager'] as Map).cast<String, dynamic>())).input(),
      ...
      topologyManager: map['topologyManager'] == null ? null : (ClusterNodeConfigKubeletConfigTopologyManager.fromMap((map['topologyManager'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
