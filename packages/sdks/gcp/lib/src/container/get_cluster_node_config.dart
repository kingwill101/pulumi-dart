...
class GetClusterNodeConfig {
  ...
  final pulumi.Input<List<GetClusterNodeConfigAdvancedMachineFeature>>
  ...
  final pulumi.Input<List<GetClusterNodeConfigConfidentialNode>>
  confidentialNodes;

  /// Parameters for containerd configuration.
  final pulumi.Input<List<GetClusterNodeConfigContainerdConfig>>
  containerdConfigs;
  ...
  final pulumi.Input<List<GetClusterNodeConfigEphemeralStorageConfig>>
  ephemeralStorageConfigs;

  /// Parameters for the ephemeral storage filesystem. If unspecified, ephemeral storage is backed by the boot disk.
  final pulumi.Input<List<GetClusterNodeConfigEphemeralStorageLocalSsdConfig>>
  ...
  final pulumi.Input<List<GetClusterNodeConfigGuestAccelerator>>
  guestAccelerators;
  ...
  final pulumi.Input<List<GetClusterNodeConfigHostMaintenancePolicy>>
  ...
  final pulumi.Input<List<GetClusterNodeConfigLinuxNodeConfig>>
  linuxNodeConfigs;

  /// Parameters for raw-block local NVMe SSDs.
  final pulumi.Input<List<GetClusterNodeConfigLocalNvmeSsdBlockConfig>>
  ...
  final pulumi.Input<List<GetClusterNodeConfigReservationAffinity>>
  ...
  final pulumi.Input<List<GetClusterNodeConfigSecondaryBootDisk>>
  secondaryBootDisks;
  ...
  final pulumi.Input<List<GetClusterNodeConfigShieldedInstanceConfig>>
  shieldedInstanceConfigs;

  /// Node affinity options for sole tenant node pools.
  final pulumi.Input<List<GetClusterNodeConfigSoleTenantConfig>>
  soleTenantConfigs;
  ...
  final pulumi.Input<List<GetClusterNodeConfigWindowsNodeConfig>>
  windowsNodeConfigs;

  /// The workload metadata configuration for this node.
  final pulumi.Input<List<GetClusterNodeConfigWorkloadMetadataConfig>>
    ...
    return <String, dynamic>{
      'advancedMachineFeatures':
          pulumi.Input.mapInputValue<
            List<GetClusterNodeConfigAdvancedMachineFeature>,
      ...
      'bootDisks':
          pulumi.Input.mapInputValue<
            List<GetClusterNodeConfigBootDisk>,
            List<Map<String, dynamic>>
          >(
            bootDisks,
            (value) =>
      ...
      'confidentialNodes':
          pulumi.Input.mapInputValue<
            List<GetClusterNodeConfigConfidentialNode>,
            List<Map<String, dynamic>>
          >(
            confidentialNodes,
            (value) =>
      ...
      'containerdConfigs':
          pulumi.Input.mapInputValue<
            List<GetClusterNodeConfigContainerdConfig>,
            List<Map<String, dynamic>>
          >(
            containerdConfigs,
            (value) =>
      ...
      'effectiveTaints':
          pulumi.Input.mapInputValue<
            List<GetClusterNodeConfigEffectiveTaint>,
            List<Map<String, dynamic>>
          >(
            effectiveTaints,
            (value) =>
      ...
      'ephemeralStorageConfigs':
          pulumi.Input.mapInputValue<
            List<GetClusterNodeConfigEphemeralStorageConfig>,
            List<Map<String, dynamic>>
          >(
            ephemeralStorageConfigs,
            (value) =>
      ...
      'ephemeralStorageLocalSsdConfigs':
          pulumi.Input.mapInputValue<
            List<GetClusterNodeConfigEphemeralStorageLocalSsdConfig>,
            List<Map<String, dynamic>>
          >(
            ephemeralStorageLocalSsdConfigs,
            (value) =>
      ...
      'fastSockets':
          pulumi.Input.mapInputValue<
            List<GetClusterNodeConfigFastSocket>,
            List<Map<String, dynamic>>
          >(
            fastSockets,
            (value) =>
      ...
      'gcfsConfigs':
          pulumi.Input.mapInputValue<
            List<GetClusterNodeConfigGcfsConfig>,
            List<Map<String, dynamic>>
          >(
            gcfsConfigs,
            (value) =>
      ...
      'guestAccelerators':
          pulumi.Input.mapInputValue<
            List<GetClusterNodeConfigGuestAccelerator>,
            List<Map<String, dynamic>>
          >(
            guestAccelerators,
            (value) =>
      ...
      'gvnics':
          pulumi.Input.mapInputValue<
            List<GetClusterNodeConfigGvnic>,
            List<Map<String, dynamic>>
          >(
            gvnics,
            (value) =>
      ...
      'kubeletConfigs':
          pulumi.Input.mapInputValue<
            List<GetClusterNodeConfigKubeletConfig>,
            List<Map<String, dynamic>>
          >(
            kubeletConfigs,
            (value) =>
      ...
      'linuxNodeConfigs':
          pulumi.Input.mapInputValue<
            List<GetClusterNodeConfigLinuxNodeConfig>,
            List<Map<String, dynamic>>
          >(
            linuxNodeConfigs,
            (value) =>
      ...
      'localNvmeSsdBlockConfigs':
          pulumi.Input.mapInputValue<
            List<GetClusterNodeConfigLocalNvmeSsdBlockConfig>,
            List<Map<String, dynamic>>
          >(
            localNvmeSsdBlockConfigs,
            (value) =>
      ...
      'reservationAffinities':
          pulumi.Input.mapInputValue<
            List<GetClusterNodeConfigReservationAffinity>,
            List<Map<String, dynamic>>
          >(
            reservationAffinities,
            (value) =>
      ...
      'sandboxConfigs':
          pulumi.Input.mapInputValue<
            List<GetClusterNodeConfigSandboxConfig>,
            List<Map<String, dynamic>>
          >(
            sandboxConfigs,
            (value) =>
      ...
      'secondaryBootDisks':
          pulumi.Input.mapInputValue<
            List<GetClusterNodeConfigSecondaryBootDisk>,
            List<Map<String, dynamic>>
          >(
            secondaryBootDisks,
            (value) =>
      ...
      'shieldedInstanceConfigs':
          pulumi.Input.mapInputValue<
            List<GetClusterNodeConfigShieldedInstanceConfig>,
            List<Map<String, dynamic>>
          >(
            shieldedInstanceConfigs,
            (value) =>
      ...
      'soleTenantConfigs':
          pulumi.Input.mapInputValue<
            List<GetClusterNodeConfigSoleTenantConfig>,
            List<Map<String, dynamic>>
          >(
            soleTenantConfigs,
            (value) =>
      ...
      'taints':
          pulumi.Input.mapInputValue<
            List<GetClusterNodeConfigTaint>,
            List<Map<String, dynamic>>
          >(
            taints,
            (value) =>
      ...
      'windowsNodeConfigs':
          pulumi.Input.mapInputValue<
            List<GetClusterNodeConfigWindowsNodeConfig>,
            List<Map<String, dynamic>>
          >(
            windowsNodeConfigs,
            (value) =>
      ...
      'workloadMetadataConfigs':
          pulumi.Input.mapInputValue<
            List<GetClusterNodeConfigWorkloadMetadataConfig>,
            List<Map<String, dynamic>>
          >(
            workloadMetadataConfigs,
            (value) =>
  ...
  factory GetClusterNodeConfig.fromMap(Map<String, dynamic> map) {
    return GetClusterNodeConfig(
      ...
      bootDisks: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetClusterNodeConfigBootDisk>(
          map['bootDisks']!,
      ...
      fastSockets: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetClusterNodeConfigFastSocket>(
          map['fastSockets']!,
      ...
      gcfsConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetClusterNodeConfigGcfsConfig>(
          map['gcfsConfigs']!,
      ...
      gvnics: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetClusterNodeConfigGvnic>(
          map['gvnics']!,
      ...
      taints: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetClusterNodeConfigTaint>(
          map['taints']!,
