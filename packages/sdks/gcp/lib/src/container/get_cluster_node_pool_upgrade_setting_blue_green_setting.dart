...
class GetClusterNodePoolUpgradeSettingBlueGreenSetting {
  ...
  factory GetClusterNodePoolUpgradeSettingBlueGreenSetting.fromMap(Map<String, dynamic> map) {
    return GetClusterNodePoolUpgradeSettingBlueGreenSetting(
      autoscaledRolloutPolicies: (pulumi.Input.decodeList<GetClusterNodePoolUpgradeSettingBlueGreenSettingAutoscaledRolloutPolicy>(map['autoscaledRolloutPolicies'], (value) => GetClusterNodePoolUpgradeSettingBlueGreenSettingAutoscaledRolloutPolicy.fromMap((value as Map).cast<String, dynamic>()))).input(),
      nodePoolSoakDuration: (map['nodePoolSoakDuration'] as String).input(),
      standardRolloutPolicies: (pulumi.Input.decodeList<GetClusterNodePoolUpgradeSettingBlueGreenSettingStandardRolloutPolicy>(map['standardRolloutPolicies'], (value) => GetClusterNodePoolUpgradeSettingBlueGreenSettingStandardRolloutPolicy.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
