...
class GetClusterControlPlaneEndpointsConfig {
  ...
  factory GetClusterControlPlaneEndpointsConfig.fromMap(Map<String, dynamic> map) {
    return GetClusterControlPlaneEndpointsConfig(
      dnsEndpointConfigs: (pulumi.Input.decodeList<GetClusterControlPlaneEndpointsConfigDnsEndpointConfig>(map['dnsEndpointConfigs'], (value) => GetClusterControlPlaneEndpointsConfigDnsEndpointConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ipEndpointsConfigs: (pulumi.Input.decodeList<GetClusterControlPlaneEndpointsConfigIpEndpointsConfig>(map['ipEndpointsConfigs'], (value) => GetClusterControlPlaneEndpointsConfigIpEndpointsConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
