...
class GetClusterControlPlaneEndpointsConfig {
  ...
  final pulumi.Input<
    List<GetClusterControlPlaneEndpointsConfigDnsEndpointConfig>
  >
  dnsEndpointConfigs;

  /// IP endpoint configuration.
  final pulumi.Input<
    List<GetClusterControlPlaneEndpointsConfigIpEndpointsConfig>
  >
  ipEndpointsConfigs;
  ...
  factory GetClusterControlPlaneEndpointsConfig.fromMap(
    ...
    return GetClusterControlPlaneEndpointsConfig(
      dnsEndpointConfigs: pulumi.Input.fromValue(
      ...
      ipEndpointsConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetClusterControlPlaneEndpointsConfigIpEndpointsConfig
        >(
