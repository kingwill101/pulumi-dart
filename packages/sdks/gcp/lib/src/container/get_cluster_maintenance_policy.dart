...
class GetClusterMaintenancePolicy {
  ...
  final pulumi.Input<List<GetClusterMaintenancePolicyDailyMaintenanceWindow>>
  dailyMaintenanceWindows;

  /// Exceptions to maintenance window. Non-emergency maintenance should not occur in these windows.
  final pulumi.Input<List<GetClusterMaintenancePolicyMaintenanceExclusion>>
  maintenanceExclusions;

  /// Time window for recurring maintenance operations.
  final pulumi.Input<List<GetClusterMaintenancePolicyRecurringWindow>>
  recurringWindows;
    ...
    return <String, dynamic>{
      'dailyMaintenanceWindows':
          pulumi.Input.mapInputValue<
            List<GetClusterMaintenancePolicyDailyMaintenanceWindow>,
      ...
      'maintenanceExclusions':
          pulumi.Input.mapInputValue<
            List<GetClusterMaintenancePolicyMaintenanceExclusion>,
            List<Map<String, dynamic>>
          >(
            maintenanceExclusions,
            (value) =>
      ...
      'recurringWindows':
          pulumi.Input.mapInputValue<
            List<GetClusterMaintenancePolicyRecurringWindow>,
            List<Map<String, dynamic>>
          >(
            recurringWindows,
            (value) =>
  ...
  factory GetClusterMaintenancePolicy.fromMap(Map<String, dynamic> map) {
    return GetClusterMaintenancePolicy(
      dailyMaintenanceWindows: pulumi.Input.fromValue(
      ...
      recurringWindows: pulumi.Input.fromValue(
