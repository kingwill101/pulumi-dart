...
class GetClusterMaintenancePolicy {
  ...
  factory GetClusterMaintenancePolicy.fromMap(Map<String, dynamic> map) {
    return GetClusterMaintenancePolicy(
      dailyMaintenanceWindows: (pulumi.Input.decodeList<GetClusterMaintenancePolicyDailyMaintenanceWindow>(map['dailyMaintenanceWindows'], (value) => GetClusterMaintenancePolicyDailyMaintenanceWindow.fromMap((value as Map).cast<String, dynamic>()))).input(),
      maintenanceExclusions: (pulumi.Input.decodeList<GetClusterMaintenancePolicyMaintenanceExclusion>(map['maintenanceExclusions'], (value) => GetClusterMaintenancePolicyMaintenanceExclusion.fromMap((value as Map).cast<String, dynamic>()))).input(),
      recurringWindows: (pulumi.Input.decodeList<GetClusterMaintenancePolicyRecurringWindow>(map['recurringWindows'], (value) => GetClusterMaintenancePolicyRecurringWindow.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
