...
class GetClusterNodeConfigContainerdConfigRegistryHost {
  ...
  factory GetClusterNodeConfigContainerdConfigRegistryHost.fromMap(Map<String, dynamic> map) {
    return GetClusterNodeConfigContainerdConfigRegistryHost(
      hosts: (pulumi.Input.decodeList<GetClusterNodeConfigContainerdConfigRegistryHostHost>(map['hosts'], (value) => GetClusterNodeConfigContainerdConfigRegistryHostHost.fromMap((value as Map).cast<String, dynamic>()))).input(),
