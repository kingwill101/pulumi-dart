...
class GetClusterNodePoolDefaultNodeConfigDefaultContainerdConfig {
  ...
  factory GetClusterNodePoolDefaultNodeConfigDefaultContainerdConfig.fromMap(Map<String, dynamic> map) {
    return GetClusterNodePoolDefaultNodeConfigDefaultContainerdConfig(
      privateRegistryAccessConfigs: (pulumi.Input.decodeList<GetClusterNodePoolDefaultNodeConfigDefaultContainerdConfigPrivateRegistryAccessConfig>(map['privateRegistryAccessConfigs'], (value) => GetClusterNodePoolDefaultNodeConfigDefaultContainerdConfigPrivateRegistryAccessConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
      registryHosts: (pulumi.Input.decodeList<GetClusterNodePoolDefaultNodeConfigDefaultContainerdConfigRegistryHost>(map['registryHosts'], (value) => GetClusterNodePoolDefaultNodeConfigDefaultContainerdConfigRegistryHost.fromMap((value as Map).cast<String, dynamic>()))).input(),
      writableCgroups: (pulumi.Input.decodeList<GetClusterNodePoolDefaultNodeConfigDefaultContainerdConfigWritableCgroup>(map['writableCgroups'], (value) => GetClusterNodePoolDefaultNodeConfigDefaultContainerdConfigWritableCgroup.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
