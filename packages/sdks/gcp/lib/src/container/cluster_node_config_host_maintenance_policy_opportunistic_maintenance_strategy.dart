...
class ClusterNodeConfigHostMaintenancePolicyOpportunisticMaintenanceStrategy {
  ...
  /// Creates a new [ClusterNodeConfigHostMaintenancePolicyOpportunisticMaintenanceStrategy].
  ...
  const ClusterNodeConfigHostMaintenancePolicyOpportunisticMaintenanceStrategy({
  ...
  factory ClusterNodeConfigHostMaintenancePolicyOpportunisticMaintenanceStrategy.fromMap(Map<String, dynamic> map) {
    return ClusterNodeConfigHostMaintenancePolicyOpportunisticMaintenanceStrategy(
