...
class ClusterNodeConfigContainerdConfig {
  ...
  final pulumi.Input<List<ClusterNodeConfigContainerdConfigRegistryHost>>?
  registryHosts;
  ...
  final pulumi.Input<ClusterNodeConfigContainerdConfigWritableCgroups>?
  writableCgroups;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'registryHosts':
          ?pulumi.Input.mapOptionalInputValue<
            List<ClusterNodeConfigContainerdConfigRegistryHost>,
    ...
    return ClusterNodeConfigContainerdConfig(
      privateRegistryAccessConfig: (() {
        ...
        return pulumi.Input.fromValue(
          ClusterNodeConfigContainerdConfigPrivateRegistryAccessConfig.fromMap(
