...
class ClusterResourceUsageExportConfig {
  ...
  const ClusterResourceUsageExportConfig({
  ...
  factory ClusterResourceUsageExportConfig.fromMap(Map<String, dynamic> map) {
    return ClusterResourceUsageExportConfig(
      bigqueryDestination: pulumi.Input.fromValue(ClusterResourceUsageExportConfigBigqueryDestination.fromMap((map['bigqueryDestination']! as Map).cast<String, dynamic>())),
      ...
      enableResourceConsumptionMetering: (() { final guardedValue = map['enableResourceConsumptionMetering']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
    );
  }
}
