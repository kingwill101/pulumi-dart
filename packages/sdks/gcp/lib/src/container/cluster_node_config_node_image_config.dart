...
class ClusterNodeConfigNodeImageConfig {
  ...
  /// Creates a new [ClusterNodeConfigNodeImageConfig].
  ...
  const ClusterNodeConfigNodeImageConfig({
    this.image,
    this.imageProject,
  });
  ...
  factory ClusterNodeConfigNodeImageConfig.fromMap(Map<String, dynamic> map) {
    return ClusterNodeConfigNodeImageConfig(
