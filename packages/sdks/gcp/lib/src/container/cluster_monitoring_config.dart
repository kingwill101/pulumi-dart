...
class ClusterMonitoringConfig {
  ...
  final pulumi.Input<ClusterMonitoringConfigManagedPrometheus>?
  managedPrometheus;
    ...
    return <String, dynamic>{
      ...
      'managedPrometheus':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(managedPrometheus, (value) => value.toMap()),
    };
  }
    ...
    return ClusterMonitoringConfig(
      advancedDatapathObservabilityConfig: (() {
        ...
        return pulumi.Input.fromValue(
          ClusterMonitoringConfigAdvancedDatapathObservabilityConfig.fromMap(
      ...
      managedPrometheus: (() {
        final guardedValue = map['managedPrometheus'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
