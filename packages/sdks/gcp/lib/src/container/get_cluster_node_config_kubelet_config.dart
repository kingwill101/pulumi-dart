...
class GetClusterNodeConfigKubeletConfig {
  ...
  final pulumi.Input<
    List<GetClusterNodeConfigKubeletConfigEvictionMinimumReclaim>
  >
  ...
  final pulumi.Input<
    List<GetClusterNodeConfigKubeletConfigEvictionSoftGracePeriod>
  >
  evictionSoftGracePeriods;

  /// Defines a map of signal names to quantities or percentage that defines soft eviction thresholds.
  final pulumi.Input<List<GetClusterNodeConfigKubeletConfigEvictionSoft>>
  evictionSofts;
  ...
  final pulumi.Input<List<GetClusterNodeConfigKubeletConfigMemoryManager>>
  memoryManagers;
  ...
  final pulumi.Input<List<GetClusterNodeConfigKubeletConfigTopologyManager>>
  topologyManagers;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'evictionSofts':
          pulumi.Input.mapInputValue<
            List<GetClusterNodeConfigKubeletConfigEvictionSoft>,
            List<Map<String, dynamic>>
          >(
            evictionSofts,
            (value) =>
      ...
      'memoryManagers':
          pulumi.Input.mapInputValue<
            List<GetClusterNodeConfigKubeletConfigMemoryManager>,
            List<Map<String, dynamic>>
          >(
            memoryManagers,
            (value) =>
      ...
      'topologyManagers':
          pulumi.Input.mapInputValue<
            List<GetClusterNodeConfigKubeletConfigTopologyManager>,
            List<Map<String, dynamic>>
          >(
            topologyManagers,
            (value) =>
  ...
  factory GetClusterNodeConfigKubeletConfig.fromMap(Map<String, dynamic> map) {
    return GetClusterNodeConfigKubeletConfig(
      ...
      evictionMaxPodGracePeriodSeconds: pulumi.Input.fromValue(
        map['evictionMaxPodGracePeriodSeconds'] as int,
      ),
      evictionMinimumReclaims: pulumi.Input.fromValue(
      ...
      evictionSoftGracePeriods: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetClusterNodeConfigKubeletConfigEvictionSoftGracePeriod
        >(
      ...
      evictionSofts: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetClusterNodeConfigKubeletConfigEvictionSoft>(
          map['evictionSofts']!,
      ...
      imageMaximumGcAge: pulumi.Input.fromValue(
        map['imageMaximumGcAge'] as String,
      ),
      imageMinimumGcAge: pulumi.Input.fromValue(
      ...
      maxParallelImagePulls: pulumi.Input.fromValue(
        map['maxParallelImagePulls'] as int,
      ),
      memoryManagers: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetClusterNodeConfigKubeletConfigMemoryManager>(
          map['memoryManagers']!,
      ...
      singleProcessOomKill: pulumi.Input.fromValue(
        map['singleProcessOomKill'] as bool,
      ),
      topologyManagers: pulumi.Input.fromValue(
        pulumi
            .Input.decodeList<GetClusterNodeConfigKubeletConfigTopologyManager>(
