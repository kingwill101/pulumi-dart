...
import 'get_cluster_node_config_kubelet_config_crash_loop_back_off.dart';
...
class GetClusterNodeConfigKubeletConfig {
  ...
  final pulumi.Input<List<GetClusterNodeConfigKubeletConfigCrashLoopBackOff>> crashLoopBackOffs;
  ...
  const GetClusterNodeConfigKubeletConfig({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'crashLoopBackOffs': pulumi.Input.mapInputValue<List<GetClusterNodeConfigKubeletConfigCrashLoopBackOff>, List<Map<String, dynamic>>>(crashLoopBackOffs, (value) => pulumi.Input.encodeList<GetClusterNodeConfigKubeletConfigCrashLoopBackOff, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory GetClusterNodeConfigKubeletConfig.fromMap(Map<String, dynamic> map) {
    return GetClusterNodeConfigKubeletConfig(
      ...
      containerLogMaxFiles: pulumi.Input.fromValue(map['containerLogMaxFiles'] as int),
      ...
      crashLoopBackOffs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetClusterNodeConfigKubeletConfigCrashLoopBackOff>(map['crashLoopBackOffs']!, (value) => GetClusterNodeConfigKubeletConfigCrashLoopBackOff.fromMap((value as Map).cast<String, dynamic>()))),
      evictionMaxPodGracePeriodSeconds: pulumi.Input.fromValue(map['evictionMaxPodGracePeriodSeconds'] as int),
      evictionMinimumReclaims: pulumi.Input.fromValue(pulumi.Input.decodeList<GetClusterNodeConfigKubeletConfigEvictionMinimumReclaim>(map['evictionMinimumReclaims']!, (value) => GetClusterNodeConfigKubeletConfigEvictionMinimumReclaim.fromMap((value as Map).cast<String, dynamic>()))),
      evictionSoftGracePeriods: pulumi.Input.fromValue(pulumi.Input.decodeList<GetClusterNodeConfigKubeletConfigEvictionSoftGracePeriod>(map['evictionSoftGracePeriods']!, (value) => GetClusterNodeConfigKubeletConfigEvictionSoftGracePeriod.fromMap((value as Map).cast<String, dynamic>()))),
      evictionSofts: pulumi.Input.fromValue(pulumi.Input.decodeList<GetClusterNodeConfigKubeletConfigEvictionSoft>(map['evictionSofts']!, (value) => GetClusterNodeConfigKubeletConfigEvictionSoft.fromMap((value as Map).cast<String, dynamic>()))),
      imageGcHighThresholdPercent: pulumi.Input.fromValue(map['imageGcHighThresholdPercent'] as int),
      imageGcLowThresholdPercent: pulumi.Input.fromValue(map['imageGcLowThresholdPercent'] as int),
      ...
      maxParallelImagePulls: pulumi.Input.fromValue(map['maxParallelImagePulls'] as int),
      memoryManagers: pulumi.Input.fromValue(pulumi.Input.decodeList<GetClusterNodeConfigKubeletConfigMemoryManager>(map['memoryManagers']!, (value) => GetClusterNodeConfigKubeletConfigMemoryManager.fromMap((value as Map).cast<String, dynamic>()))),
      podPidsLimit: pulumi.Input.fromValue(map['podPidsLimit'] as int),
      shutdownGracePeriodCriticalPodsSeconds: pulumi.Input.fromValue(map['shutdownGracePeriodCriticalPodsSeconds'] as int),
      shutdownGracePeriodSeconds: pulumi.Input.fromValue(map['shutdownGracePeriodSeconds'] as int),
      singleProcessOomKill: pulumi.Input.fromValue(map['singleProcessOomKill'] as bool),
      topologyManagers: pulumi.Input.fromValue(pulumi.Input.decodeList<GetClusterNodeConfigKubeletConfigTopologyManager>(map['topologyManagers']!, (value) => GetClusterNodeConfigKubeletConfigTopologyManager.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
