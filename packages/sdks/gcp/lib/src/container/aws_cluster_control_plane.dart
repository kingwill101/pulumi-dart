...
class AwsClusterControlPlane {
  ...
  final AwsClusterControlPlaneAwsServicesAuthentication awsServicesAuthentication;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'awsServicesAuthentication': awsServicesAuthentication.toMap(),
      'configEncryption': configEncryption.toMap(),
      'databaseEncryption': databaseEncryption.toMap(),
      'iamInstanceProfile': iamInstanceProfile,
      'instancePlacement': ?instancePlacement == null ? null : instancePlacement!.toMap(),
      ...
      'sshConfig': ?sshConfig == null ? null : sshConfig!.toMap(),
      'subnetIds': subnetIds,
      'tags': ?tags,
      'version': version,
    };
  ...
  factory AwsClusterControlPlane.fromMap(Map<String, dynamic> map) {
    return AwsClusterControlPlane(
      awsServicesAuthentication: AwsClusterControlPlaneAwsServicesAuthentication.fromMap((map['awsServicesAuthentication'] as Map).cast<String, dynamic>()),
      configEncryption: AwsClusterControlPlaneConfigEncryption.fromMap((map['configEncryption'] as Map).cast<String, dynamic>()),
      databaseEncryption: AwsClusterControlPlaneDatabaseEncryption.fromMap((map['databaseEncryption'] as Map).cast<String, dynamic>()),
      iamInstanceProfile: map['iamInstanceProfile'] as String,
      instancePlacement: map['instancePlacement'] == null ? null : AwsClusterControlPlaneInstancePlacement.fromMap((map['instancePlacement'] as Map).cast<String, dynamic>()),
      instanceType: map['instanceType'] == null ? null : map['instanceType'] as String,
      mainVolume: map['mainVolume'] == null ? null : AwsClusterControlPlaneMainVolume.fromMap((map['mainVolume'] as Map).cast<String, dynamic>()),
      proxyConfig: map['proxyConfig'] == null ? null : AwsClusterControlPlaneProxyConfig.fromMap((map['proxyConfig'] as Map).cast<String, dynamic>()),
      rootVolume: map['rootVolume'] == null ? null : AwsClusterControlPlaneRootVolume.fromMap((map['rootVolume'] as Map).cast<String, dynamic>()),
      securityGroupIds: map['securityGroupIds'] == null ? null : (map['securityGroupIds'] as List).cast<String>(),
      sshConfig: map['sshConfig'] == null ? null : AwsClusterControlPlaneSshConfig.fromMap((map['sshConfig'] as Map).cast<String, dynamic>()),
