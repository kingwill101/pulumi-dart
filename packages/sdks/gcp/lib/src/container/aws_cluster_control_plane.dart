...
class AwsClusterControlPlane {
  ...
  factory AwsClusterControlPlane.fromMap(Map<String, dynamic> map) {
    return AwsClusterControlPlane(
      awsServicesAuthentication: pulumi.Input.fromValue(AwsClusterControlPlaneAwsServicesAuthentication.fromMap((map['awsServicesAuthentication']! as Map).cast<String, dynamic>())),
      configEncryption: pulumi.Input.fromValue(AwsClusterControlPlaneConfigEncryption.fromMap((map['configEncryption']! as Map).cast<String, dynamic>())),
      databaseEncryption: pulumi.Input.fromValue(AwsClusterControlPlaneDatabaseEncryption.fromMap((map['databaseEncryption']! as Map).cast<String, dynamic>())),
      iamInstanceProfile: pulumi.Input.fromValue(map['iamInstanceProfile'] as String),
      instancePlacement: (() { final guardedValue = map['instancePlacement']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsClusterControlPlaneInstancePlacement.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      instanceType: (() { final guardedValue = map['instanceType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      mainVolume: (() { final guardedValue = map['mainVolume']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsClusterControlPlaneMainVolume.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      proxyConfig: (() { final guardedValue = map['proxyConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsClusterControlPlaneProxyConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      rootVolume: (() { final guardedValue = map['rootVolume']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsClusterControlPlaneRootVolume.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      securityGroupIds: (() { final guardedValue = map['securityGroupIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      sshConfig: (() { final guardedValue = map['sshConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsClusterControlPlaneSshConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
