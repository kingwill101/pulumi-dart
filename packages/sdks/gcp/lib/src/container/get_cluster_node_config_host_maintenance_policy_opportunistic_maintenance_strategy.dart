...
class GetClusterNodeConfigHostMaintenancePolicyOpportunisticMaintenanceStrategy {
  ...
  /// Creates a new [GetClusterNodeConfigHostMaintenancePolicyOpportunisticMaintenanceStrategy].
  ...
  const GetClusterNodeConfigHostMaintenancePolicyOpportunisticMaintenanceStrategy({
  ...
  factory GetClusterNodeConfigHostMaintenancePolicyOpportunisticMaintenanceStrategy.fromMap(Map<String, dynamic> map) {
    return GetClusterNodeConfigHostMaintenancePolicyOpportunisticMaintenanceStrategy(
