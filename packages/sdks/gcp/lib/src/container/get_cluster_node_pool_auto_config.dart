...
class GetClusterNodePoolAutoConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'linuxNodeConfigs': pulumi.Input.encodeList<GetClusterNodePoolAutoConfigLinuxNodeConfig, Map<String, dynamic>>(linuxNodeConfigs, (value) => value.toMap()),
      'networkTags': pulumi.Input.encodeList<GetClusterNodePoolAutoConfigNetworkTag, Map<String, dynamic>>(networkTags, (value) => value.toMap()),
      'nodeKubeletConfigs': pulumi.Input.encodeList<GetClusterNodePoolAutoConfigNodeKubeletConfig, Map<String, dynamic>>(nodeKubeletConfigs, (value) => value.toMap()),
  ...
  factory GetClusterNodePoolAutoConfig.fromMap(Map<String, dynamic> map) {
    return GetClusterNodePoolAutoConfig(
      linuxNodeConfigs: pulumi.Input.decodeList<GetClusterNodePoolAutoConfigLinuxNodeConfig>(map['linuxNodeConfigs'], (value) => GetClusterNodePoolAutoConfigLinuxNodeConfig.fromMap((value as Map).cast<String, dynamic>())),
      networkTags: pulumi.Input.decodeList<GetClusterNodePoolAutoConfigNetworkTag>(map['networkTags'], (value) => GetClusterNodePoolAutoConfigNetworkTag.fromMap((value as Map).cast<String, dynamic>())),
      nodeKubeletConfigs: pulumi.Input.decodeList<GetClusterNodePoolAutoConfigNodeKubeletConfig>(map['nodeKubeletConfigs'], (value) => GetClusterNodePoolAutoConfigNodeKubeletConfig.fromMap((value as Map).cast<String, dynamic>())),
