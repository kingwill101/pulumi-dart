...
class GetClusterNodePoolAutoConfig {
  ...
  const GetClusterNodePoolAutoConfig({
  ...
  factory GetClusterNodePoolAutoConfig.fromMap(Map<String, dynamic> map) {
    return GetClusterNodePoolAutoConfig(
      linuxNodeConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetClusterNodePoolAutoConfigLinuxNodeConfig>(map['linuxNodeConfigs']!, (value) => GetClusterNodePoolAutoConfigLinuxNodeConfig.fromMap((value as Map).cast<String, dynamic>()))),
      networkTags: pulumi.Input.fromValue(pulumi.Input.decodeList<GetClusterNodePoolAutoConfigNetworkTag>(map['networkTags']!, (value) => GetClusterNodePoolAutoConfigNetworkTag.fromMap((value as Map).cast<String, dynamic>()))),
      nodeKubeletConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetClusterNodePoolAutoConfigNodeKubeletConfig>(map['nodeKubeletConfigs']!, (value) => GetClusterNodePoolAutoConfigNodeKubeletConfig.fromMap((value as Map).cast<String, dynamic>()))),
