...
class GetClusterNodePoolAutoConfig {
  ...
  final pulumi.Input<List<GetClusterNodePoolAutoConfigLinuxNodeConfig>>
  linuxNodeConfigs;
  ...
  final pulumi.Input<List<GetClusterNodePoolAutoConfigNodeKubeletConfig>>
  nodeKubeletConfigs;
    ...
    return <String, dynamic>{
      'linuxNodeConfigs':
          pulumi.Input.mapInputValue<
            List<GetClusterNodePoolAutoConfigLinuxNodeConfig>,
      ...
      'networkTags':
          pulumi.Input.mapInputValue<
            List<GetClusterNodePoolAutoConfigNetworkTag>,
            List<Map<String, dynamic>>
          >(
            networkTags,
            (value) =>
      ...
      'nodeKubeletConfigs':
          pulumi.Input.mapInputValue<
            List<GetClusterNodePoolAutoConfigNodeKubeletConfig>,
            List<Map<String, dynamic>>
          >(
            nodeKubeletConfigs,
            (value) =>
  ...
  factory GetClusterNodePoolAutoConfig.fromMap(Map<String, dynamic> map) {
    return GetClusterNodePoolAutoConfig(
      ...
      nodeKubeletConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetClusterNodePoolAutoConfigNodeKubeletConfig>(
