...
class GetClusterPrivateClusterConfig {
  ...
  factory GetClusterPrivateClusterConfig.fromMap(Map<String, dynamic> map) {
    return GetClusterPrivateClusterConfig(
      ...
      masterGlobalAccessConfigs: (pulumi.Input.decodeList<GetClusterPrivateClusterConfigMasterGlobalAccessConfig>(map['masterGlobalAccessConfigs'], (value) => GetClusterPrivateClusterConfigMasterGlobalAccessConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
