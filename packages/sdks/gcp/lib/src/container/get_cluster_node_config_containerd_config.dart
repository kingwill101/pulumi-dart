...
class GetClusterNodeConfigContainerdConfig {
  ...
  final pulumi.Input<
    List<GetClusterNodeConfigContainerdConfigPrivateRegistryAccessConfig>
  >
  ...
  final pulumi.Input<List<GetClusterNodeConfigContainerdConfigRegistryHost>>
  registryHosts;

  /// Parameters for writable cgroups configuration.
  final pulumi.Input<List<GetClusterNodeConfigContainerdConfigWritableCgroup>>
  writableCgroups;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'registryHosts':
          pulumi.Input.mapInputValue<
            List<GetClusterNodeConfigContainerdConfigRegistryHost>,
            List<Map<String, dynamic>>
          >(
            registryHosts,
            (value) =>
      ...
      'writableCgroups':
          pulumi.Input.mapInputValue<
            List<GetClusterNodeConfigContainerdConfigWritableCgroup>,
            List<Map<String, dynamic>>
          >(
            writableCgroups,
            (value) =>
  ...
  factory GetClusterNodeConfigContainerdConfig.fromMap(
    ...
    return GetClusterNodeConfigContainerdConfig(
      privateRegistryAccessConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetClusterNodeConfigContainerdConfigPrivateRegistryAccessConfig
        >(
          map['privateRegistryAccessConfigs']!,
          (value) =>
              GetClusterNodeConfigContainerdConfigPrivateRegistryAccessConfig.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
      registryHosts: pulumi.Input.fromValue(
        pulumi
            .Input.decodeList<GetClusterNodeConfigContainerdConfigRegistryHost>(
          map['registryHosts']!,
      ...
      writableCgroups: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetClusterNodeConfigContainerdConfigWritableCgroup
        >(
          map['writableCgroups']!,
