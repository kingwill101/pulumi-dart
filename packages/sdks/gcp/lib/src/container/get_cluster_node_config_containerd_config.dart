...
class GetClusterNodeConfigContainerdConfig {
  ...
  factory GetClusterNodeConfigContainerdConfig.fromMap(Map<String, dynamic> map) {
    return GetClusterNodeConfigContainerdConfig(
      privateRegistryAccessConfigs: (pulumi.Input.decodeList<GetClusterNodeConfigContainerdConfigPrivateRegistryAccessConfig>(map['privateRegistryAccessConfigs'], (value) => GetClusterNodeConfigContainerdConfigPrivateRegistryAccessConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
      registryHosts: (pulumi.Input.decodeList<GetClusterNodeConfigContainerdConfigRegistryHost>(map['registryHosts'], (value) => GetClusterNodeConfigContainerdConfigRegistryHost.fromMap((value as Map).cast<String, dynamic>()))).input(),
      writableCgroups: (pulumi.Input.decodeList<GetClusterNodeConfigContainerdConfigWritableCgroup>(map['writableCgroups'], (value) => GetClusterNodeConfigContainerdConfigWritableCgroup.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
