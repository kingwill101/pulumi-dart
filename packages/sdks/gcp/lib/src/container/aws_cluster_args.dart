...
class AwsClusterArgs {
  ...
  factory AwsClusterArgs.fromMap(Map<String, dynamic> map) {
    return AwsClusterArgs(
      ...
      authorization: pulumi.Input.fromValue(AwsClusterAuthorization.fromMap((map['authorization']! as Map).cast<String, dynamic>())),
      ...
      networking: pulumi.Input.fromValue(AwsClusterNetworking.fromMap((map['networking']! as Map).cast<String, dynamic>())),
