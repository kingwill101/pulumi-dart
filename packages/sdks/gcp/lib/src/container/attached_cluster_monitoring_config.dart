...
class AttachedClusterMonitoringConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'managedPrometheusConfig': ?pulumi.Input.mapOptionalInputValue<AttachedClusterMonitoringConfigManagedPrometheusConfig, Map<String, dynamic>>(managedPrometheusConfig, (value) => value.toMap()),
    };
  }

  factory AttachedClusterMonitoringConfig.fromMap(Map<String, dynamic> map) {
    return AttachedClusterMonitoringConfig(
      managedPrometheusConfig: (() { final guardedValue = map['managedPrometheusConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AttachedClusterMonitoringConfigManagedPrometheusConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
