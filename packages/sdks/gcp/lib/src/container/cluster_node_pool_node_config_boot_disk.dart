...
class ClusterNodePoolNodeConfigBootDisk {
  ...
  /// [provisionedIops] Configure disk IOPs. This is only valid if the `diskType` is 'hyperdisk-balanced'. See [performance limit documention](https://cloud.google.com/compute/docs/disks/hyperdisk-perf-limits) for more information about valid values.
  /// [provisionedThroughput] Configure disk throughput. This is only valid if the `diskType` is 'hyperdisk-balanced'. See [performance limit documention](https://cloud.google.com/compute/docs/disks/hyperdisk-perf-limits) for more information about valid values.
  /// [sizeGb] Size of the disk attached to each node, specified
  const ClusterNodePoolNodeConfigBootDisk({
    this.diskType,
