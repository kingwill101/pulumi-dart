...
class PrivateCloudManagementCluster {
  ...
  final pulumi.Input<PrivateCloudManagementClusterAutoscalingSettings>?
  autoscalingSettings;
  ...
  /// Structure is documented below.
  final pulumi.Input<List<PrivateCloudManagementClusterNodeTypeConfig>>?
  nodeTypeConfigs;

  /// The stretched cluster configuration for the private cloud.
  /// Structure is documented below.
  final pulumi.Input<PrivateCloudManagementClusterStretchedClusterConfig>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'nodeTypeConfigs':
          ?pulumi.Input.mapOptionalInputValue<
            List<PrivateCloudManagementClusterNodeTypeConfig>,
  ...
  factory PrivateCloudManagementCluster.fromMap(Map<String, dynamic> map) {
    return PrivateCloudManagementCluster(
      ...
      nodeTypeConfigs: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PrivateCloudManagementClusterNodeTypeConfig>(
            guardedValue,
