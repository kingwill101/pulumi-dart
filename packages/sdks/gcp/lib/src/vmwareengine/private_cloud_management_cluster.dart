...
class PrivateCloudManagementCluster {
  ...
  factory PrivateCloudManagementCluster.fromMap(Map<String, dynamic> map) {
    return PrivateCloudManagementCluster(
      autoscalingSettings: (() { final guardedValue = map['autoscalingSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PrivateCloudManagementClusterAutoscalingSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      clusterId: pulumi.Input.fromValue(map['clusterId'] as String),
      nodeTypeConfigs: (() { final guardedValue = map['nodeTypeConfigs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PrivateCloudManagementClusterNodeTypeConfig>(guardedValue, (value) => PrivateCloudManagementClusterNodeTypeConfig.fromMap((value as Map).cast<String, dynamic>()))); })(),
      stretchedClusterConfig: (() { final guardedValue = map['stretchedClusterConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PrivateCloudManagementClusterStretchedClusterConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
