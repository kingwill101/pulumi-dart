...
class GetPrivateCloudManagementClusterAutoscalingSettingAutoscalingPolicy {
  ...
  factory GetPrivateCloudManagementClusterAutoscalingSettingAutoscalingPolicy.fromMap(Map<String, dynamic> map) {
    return GetPrivateCloudManagementClusterAutoscalingSettingAutoscalingPolicy(
      ...
      cpuThresholds: (pulumi.Input.decodeList<GetPrivateCloudManagementClusterAutoscalingSettingAutoscalingPolicyCpuThreshold>(map['cpuThresholds'], (value) => GetPrivateCloudManagementClusterAutoscalingSettingAutoscalingPolicyCpuThreshold.fromMap((value as Map).cast<String, dynamic>()))).input(),
      nodeTypeId: (map['nodeTypeId'] as String).input(),
      scaleOutSize: (map['scaleOutSize'] as int).input(),
      storageThresholds: (pulumi.Input.decodeList<GetPrivateCloudManagementClusterAutoscalingSettingAutoscalingPolicyStorageThreshold>(map['storageThresholds'], (value) => GetPrivateCloudManagementClusterAutoscalingSettingAutoscalingPolicyStorageThreshold.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
