...
class PrivateCloud extends pulumi.CustomResource {
  ...
  PrivateCloud(
    ...
    this.networkConfig = registerOutput<PrivateCloudNetworkConfig>('networkConfig');
    this.nsxes = registerOutput<List<PrivateCloudNsx>>('nsxes');
    this.project = registerOutput<String>('project');
    this.sendDeletionDelayHoursIfZero = registerOutput<bool?>('sendDeletionDelayHoursIfZero');
