...
class GetClusterAutoscalingSettingAutoscalingPolicy {
  ...
  final pulumi.Input<
    List<GetClusterAutoscalingSettingAutoscalingPolicyConsumedMemoryThreshold>
  >
  consumedMemoryThresholds;

  /// Utilization thresholds pertaining to CPU utilization.
  final pulumi.Input<
    List<GetClusterAutoscalingSettingAutoscalingPolicyCpuThreshold>
  >
  cpuThresholds;
  ...
  final pulumi.Input<
    List<GetClusterAutoscalingSettingAutoscalingPolicyStorageThreshold>
  >
  storageThresholds;
  ...
  factory GetClusterAutoscalingSettingAutoscalingPolicy.fromMap(
    ...
    return GetClusterAutoscalingSettingAutoscalingPolicy(
      autoscalePolicyId: pulumi.Input.fromValue(
        map['autoscalePolicyId'] as String,
      ),
      consumedMemoryThresholds: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetClusterAutoscalingSettingAutoscalingPolicyConsumedMemoryThreshold
        >(
          map['consumedMemoryThresholds']!,
          (value) =>
              GetClusterAutoscalingSettingAutoscalingPolicyConsumedMemoryThreshold.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
      cpuThresholds: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetClusterAutoscalingSettingAutoscalingPolicyCpuThreshold
        >(
          map['cpuThresholds']!,
      ...
      storageThresholds: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetClusterAutoscalingSettingAutoscalingPolicyStorageThreshold
        >(
          map['storageThresholds']!,
          (value) =>
              GetClusterAutoscalingSettingAutoscalingPolicyStorageThreshold.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
