...
class GetDatastoreNfsDatastore {
  ...
  factory GetDatastoreNfsDatastore.fromMap(Map<String, dynamic> map) {
    return GetDatastoreNfsDatastore(
      googleFileServices: pulumi.Input.fromValue(pulumi.Input.decodeList<GetDatastoreNfsDatastoreGoogleFileService>(map['googleFileServices']!, (value) => GetDatastoreNfsDatastoreGoogleFileService.fromMap((value as Map).cast<String, dynamic>()))),
      thirdPartyFileServices: pulumi.Input.fromValue(pulumi.Input.decodeList<GetDatastoreNfsDatastoreThirdPartyFileService>(map['thirdPartyFileServices']!, (value) => GetDatastoreNfsDatastoreThirdPartyFileService.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
