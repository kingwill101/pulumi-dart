...
class GetDatastoreNfsDatastore {
  ...
  final pulumi.Input<List<GetDatastoreNfsDatastoreGoogleFileService>>
  googleFileServices;

  /// Third party file service configuration
  final pulumi.Input<List<GetDatastoreNfsDatastoreThirdPartyFileService>>
    ...
    return <String, dynamic>{
      'googleFileServices':
          pulumi.Input.mapInputValue<
            List<GetDatastoreNfsDatastoreGoogleFileService>,
      ...
      'thirdPartyFileServices':
          pulumi.Input.mapInputValue<
            List<GetDatastoreNfsDatastoreThirdPartyFileService>,
            List<Map<String, dynamic>>
          >(
            thirdPartyFileServices,
            (value) =>
  ...
  factory GetDatastoreNfsDatastore.fromMap(Map<String, dynamic> map) {
    return GetDatastoreNfsDatastore(
      googleFileServices: pulumi.Input.fromValue(
      ...
      thirdPartyFileServices: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetDatastoreNfsDatastoreThirdPartyFileService>(
