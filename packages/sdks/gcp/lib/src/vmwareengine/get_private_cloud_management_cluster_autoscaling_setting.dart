...
class GetPrivateCloudManagementClusterAutoscalingSetting {
  ...
  factory GetPrivateCloudManagementClusterAutoscalingSetting.fromMap(Map<String, dynamic> map) {
    return GetPrivateCloudManagementClusterAutoscalingSetting(
      autoscalingPolicies: (pulumi.Input.decodeList<GetPrivateCloudManagementClusterAutoscalingSettingAutoscalingPolicy>(map['autoscalingPolicies'], (value) => GetPrivateCloudManagementClusterAutoscalingSettingAutoscalingPolicy.fromMap((value as Map).cast<String, dynamic>()))).input(),
