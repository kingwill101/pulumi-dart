...
class SubnetState {
  ...
  factory SubnetState.fromMap(Map<String, dynamic> map) {
    return SubnetState(
      ...
      dhcpAddressRanges: (() {
        final guardedValue = map['dhcpAddressRanges'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SubnetDhcpAddressRange>(
            guardedValue,
            (value) => SubnetDhcpAddressRange.fromMap(
      ...
      standardConfig: (() {
        final guardedValue = map['standardConfig'];
        if (guardedValue == null) return null;
