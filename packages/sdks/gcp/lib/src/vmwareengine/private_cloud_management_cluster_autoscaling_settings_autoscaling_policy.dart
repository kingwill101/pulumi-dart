...
class PrivateCloudManagementClusterAutoscalingSettingsAutoscalingPolicy {
  ...
  final PrivateCloudManagementClusterAutoscalingSettingsAutoscalingPolicyConsumedMemoryThresholds? consumedMemoryThresholds;
  /// Utilization thresholds pertaining to CPU utilization.
  /// Structure is documented below.
  final PrivateCloudManagementClusterAutoscalingSettingsAutoscalingPolicyCpuThresholds? cpuThresholds;
  ...
  /// Structure is documented below.
  final PrivateCloudManagementClusterAutoscalingSettingsAutoscalingPolicyStorageThresholds? storageThresholds;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'consumedMemoryThresholds': ?consumedMemoryThresholds == null ? null : consumedMemoryThresholds!.toMap(),
      'cpuThresholds': ?cpuThresholds == null ? null : cpuThresholds!.toMap(),
      'nodeTypeId': nodeTypeId,
      'scaleOutSize': scaleOutSize,
      'storageThresholds': ?storageThresholds == null ? null : storageThresholds!.toMap(),
    };
  }
  ...
  factory PrivateCloudManagementClusterAutoscalingSettingsAutoscalingPolicy.fromMap(Map<String, dynamic> map) {
    return PrivateCloudManagementClusterAutoscalingSettingsAutoscalingPolicy(
      ...
      consumedMemoryThresholds: map['consumedMemoryThresholds'] == null ? null : PrivateCloudManagementClusterAutoscalingSettingsAutoscalingPolicyConsumedMemoryThresholds.fromMap((map['consumedMemoryThresholds'] as Map).cast<String, dynamic>()),
      cpuThresholds: map['cpuThresholds'] == null ? null : PrivateCloudManagementClusterAutoscalingSettingsAutoscalingPolicyCpuThresholds.fromMap((map['cpuThresholds'] as Map).cast<String, dynamic>()),
      nodeTypeId: map['nodeTypeId'] as String,
      scaleOutSize: map['scaleOutSize'] as int,
      storageThresholds: map['storageThresholds'] == null ? null : PrivateCloudManagementClusterAutoscalingSettingsAutoscalingPolicyStorageThresholds.fromMap((map['storageThresholds'] as Map).cast<String, dynamic>()),
    );
  }
}
