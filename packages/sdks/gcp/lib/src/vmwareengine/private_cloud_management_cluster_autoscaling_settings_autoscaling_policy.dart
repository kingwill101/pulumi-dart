...
class PrivateCloudManagementClusterAutoscalingSettingsAutoscalingPolicy {
  ...
  factory PrivateCloudManagementClusterAutoscalingSettingsAutoscalingPolicy.fromMap(
    ...
    return PrivateCloudManagementClusterAutoscalingSettingsAutoscalingPolicy(
      ...
      consumedMemoryThresholds: (() {
        final guardedValue = map['consumedMemoryThresholds'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PrivateCloudManagementClusterAutoscalingSettingsAutoscalingPolicyConsumedMemoryThresholds.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      cpuThresholds: (() {
        final guardedValue = map['cpuThresholds'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PrivateCloudManagementClusterAutoscalingSettingsAutoscalingPolicyCpuThresholds.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      storageThresholds: (() {
        final guardedValue = map['storageThresholds'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PrivateCloudManagementClusterAutoscalingSettingsAutoscalingPolicyStorageThresholds.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
