...
class PrivateCloudManagementClusterAutoscalingSettingsAutoscalingPolicyCpuThresholds {
  ...
  const PrivateCloudManagementClusterAutoscalingSettingsAutoscalingPolicyCpuThresholds({
  ...
  factory PrivateCloudManagementClusterAutoscalingSettingsAutoscalingPolicyCpuThresholds.fromMap(Map<String, dynamic> map) {
