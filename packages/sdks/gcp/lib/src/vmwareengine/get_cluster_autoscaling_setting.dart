...
class GetClusterAutoscalingSetting {
  ...
  final pulumi.Input<List<GetClusterAutoscalingSettingAutoscalingPolicy>> autoscalingPolicies;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'autoscalingPolicies': pulumi.Input.mapInputValue<List<GetClusterAutoscalingSettingAutoscalingPolicy>, List<Map<String, dynamic>>>(autoscalingPolicies, (value) => pulumi.Input.encodeList<GetClusterAutoscalingSettingAutoscalingPolicy, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory GetClusterAutoscalingSetting.fromMap(Map<String, dynamic> map) {
    return GetClusterAutoscalingSetting(
      autoscalingPolicies: (pulumi.Input.decodeList<GetClusterAutoscalingSettingAutoscalingPolicy>(map['autoscalingPolicies'], (value) => GetClusterAutoscalingSettingAutoscalingPolicy.fromMap((value as Map).cast<String, dynamic>()))).input(),
      coolDownPeriod: (map['coolDownPeriod'] as String).input(),
      maxClusterNodeCount: (map['maxClusterNodeCount'] as int).input(),
      minClusterNodeCount: (map['minClusterNodeCount'] as int).input(),
    );
  }
}
