...
class PrivateCloudManagementClusterAutoscalingSettings {
  ...
  final pulumi.Input<
    List<PrivateCloudManagementClusterAutoscalingSettingsAutoscalingPolicy>
  >
  autoscalingPolicies;
    ...
    return PrivateCloudManagementClusterAutoscalingSettings(
      autoscalingPolicies: pulumi.Input.fromValue(
        ...
        >(
          ...
          (value) =>
              PrivateCloudManagementClusterAutoscalingSettingsAutoscalingPolicy.fromMap(
      ...
      maxClusterNodeCount: (() {
        final guardedValue = map['maxClusterNodeCount'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      minClusterNodeCount: (() {
        final guardedValue = map['minClusterNodeCount'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
    );
