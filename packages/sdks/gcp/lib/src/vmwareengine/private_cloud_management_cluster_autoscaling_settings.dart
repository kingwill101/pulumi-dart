...
class PrivateCloudManagementClusterAutoscalingSettings {
  ...
  final List<PrivateCloudManagementClusterAutoscalingSettingsAutoscalingPolicy> autoscalingPolicies;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'autoscalingPolicies': pulumi.Input.encodeList<PrivateCloudManagementClusterAutoscalingSettingsAutoscalingPolicy, Map<String, dynamic>>(autoscalingPolicies, (value) => value.toMap()),
  ...
  factory PrivateCloudManagementClusterAutoscalingSettings.fromMap(Map<String, dynamic> map) {
    return PrivateCloudManagementClusterAutoscalingSettings(
      autoscalingPolicies: pulumi.Input.decodeList<PrivateCloudManagementClusterAutoscalingSettingsAutoscalingPolicy>(map['autoscalingPolicies'], (value) => PrivateCloudManagementClusterAutoscalingSettingsAutoscalingPolicy.fromMap((value as Map).cast<String, dynamic>())),
