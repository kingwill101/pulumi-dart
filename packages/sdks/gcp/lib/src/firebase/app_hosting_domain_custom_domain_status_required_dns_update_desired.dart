...
class AppHostingDomainCustomDomainStatusRequiredDnsUpdateDesired {
  ...
  factory AppHostingDomainCustomDomainStatusRequiredDnsUpdateDesired.fromMap(Map<String, dynamic> map) {
    return AppHostingDomainCustomDomainStatusRequiredDnsUpdateDesired(
      checkErrors: (() { final guardedValue = map['checkErrors']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AppHostingDomainCustomDomainStatusRequiredDnsUpdateDesiredCheckError>(guardedValue, (value) => AppHostingDomainCustomDomainStatusRequiredDnsUpdateDesiredCheckError.fromMap((value as Map).cast<String, dynamic>()))); })(),
      domainName: (() { final guardedValue = map['domainName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      records: (() { final guardedValue = map['records']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AppHostingDomainCustomDomainStatusRequiredDnsUpdateDesiredRecord>(guardedValue, (value) => AppHostingDomainCustomDomainStatusRequiredDnsUpdateDesiredRecord.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
