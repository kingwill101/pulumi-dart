...
class AppCheckResourcePolicyState {
  ...
  /// [enforcementMode] The App Check enforcement mode for a service supported by App Check. This will override the EnforcementMode setting on the service.
  ...
  /// [resourcePolicyId] The server-generated UID for the Resource Policy.
  /// [serviceId] The identifier of the service to configure a Resource Policy for.
  /// [targetResource] Service specific name of the resource object to which this policy applies, in the format:
  /// [updateTime] Output only. Timestamp when this resource policy configuration object was most recently updated.
  const AppCheckResourcePolicyState({
    this.deletionPolicy,
    this.enforcementMode,
    this.etag,
    this.project,
    this.resourcePolicyId,
    this.serviceId,
    this.targetResource,
    this.updateTime,
  });
  ...
  factory AppCheckResourcePolicyState.fromMap(Map<String, dynamic> map) {
    return AppCheckResourcePolicyState(
      ...
      resourcePolicyId: (() { final guardedValue = map['resourcePolicyId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
