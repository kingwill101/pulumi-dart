...
class HostingVersionConfig {
  ...
  HostingVersionConfig({this.headers, this.redirects, this.rewrites});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'headers':
          ?pulumi.Input.mapOptionalInputValue<
            List<HostingVersionConfigHeader>,
      ...
      'redirects':
          ?pulumi.Input.mapOptionalInputValue<
            List<HostingVersionConfigRedirect>,
            List<Map<String, dynamic>>
          >(
            redirects,
            (value) =>
      ...
      'rewrites':
          ?pulumi.Input.mapOptionalInputValue<
            List<HostingVersionConfigRewrite>,
            List<Map<String, dynamic>>
          >(
            rewrites,
            (value) =>
