...
/// {@template pulumi_firebase_app_check_resource_policy_app_check_resource_policy_args_doc}
/// The set of arguments for AppCheckResourcePolicy.
/// {@endtemplate}
/// {@macro pulumi_firebase_app_check_resource_policy_app_check_resource_policy_args_doc}
class AppCheckResourcePolicyArgs {
  ...
  /// Creates a new [AppCheckResourcePolicyArgs].
  ...
  const AppCheckResourcePolicyArgs({
    this.deletionPolicy,
  ...
  factory AppCheckResourcePolicyArgs.fromMap(Map<String, dynamic> map) {
    return AppCheckResourcePolicyArgs(
