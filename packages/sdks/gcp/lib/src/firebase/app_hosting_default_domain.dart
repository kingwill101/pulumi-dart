...
import 'app_hosting_default_domain_state.dart';
...
class AppHostingDefaultDomain extends pulumi.CustomResource {
  ...
  /// Gets an existing [AppHostingDefaultDomain] resource's state with the given [name] and [id].
  static AppHostingDefaultDomain get(
    String name,
