...
class HostingCustomDomain extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [HostingCustomDomain]. {@macro pulumi_firebase_hosting_custom_domain_hosting_custom_domain_args_doc}
  ...
  HostingCustomDomain(
    ...
    this.requiredDnsUpdates = registerOutput<List<HostingCustomDomainRequiredDnsUpdate>>('requiredDnsUpdates');
    this.siteId = registerOutput<String>('siteId');
    this.updateTime = registerOutput<String>('updateTime');
    this.waitDnsVerification = registerOutput<bool?>('waitDnsVerification');
  }

  /// Gets an existing [HostingCustomDomain] resource's state with the given [name] and [id].
  static HostingCustomDomain get(
    String name,
