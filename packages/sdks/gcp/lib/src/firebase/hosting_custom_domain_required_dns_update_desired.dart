...
class HostingCustomDomainRequiredDnsUpdateDesired {
  ...
  factory HostingCustomDomainRequiredDnsUpdateDesired.fromMap(Map<String, dynamic> map) {
    return HostingCustomDomainRequiredDnsUpdateDesired(
      ...
      records: (() { final guardedValue = map['records']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<HostingCustomDomainRequiredDnsUpdateDesiredRecord>(guardedValue, (value) => HostingCustomDomainRequiredDnsUpdateDesiredRecord.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
