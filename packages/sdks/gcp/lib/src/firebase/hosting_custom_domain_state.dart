...
class HostingCustomDomainState {
  ...
  HostingCustomDomainState({
    ...
    pulumi.Output<List<HostingCustomDomainCert>>? certs,
    pulumi.Output<String>? createTime,
    pulumi.Output<String>? customDomain,
    pulumi.Output<String>? deleteTime,
    pulumi.Output<String>? etag,
    pulumi.Output<String>? expireTime,
    pulumi.Output<String>? hostState,
    pulumi.Output<List<HostingCustomDomainIssue>>? issues,
    pulumi.Output<String>? name,
    pulumi.Output<String>? ownershipState,
    pulumi.Output<String>? project,
    pulumi.Output<bool>? reconciling,
    pulumi.Output<String>? redirectTarget,
    pulumi.Output<List<HostingCustomDomainRequiredDnsUpdate>>? requiredDnsUpdates,
    ...
    pulumi.Output<bool>? waitDnsVerification,
      ...
      certs = pulumi.Input.asOptionalInput<List<HostingCustomDomainCert>>(certs),
      ...
      hostState = pulumi.Input.asOptionalInput<String>(hostState),
      issues = pulumi.Input.asOptionalInput<List<HostingCustomDomainIssue>>(issues),
      name = pulumi.Input.asOptionalInput<String>(name),
      ownershipState = pulumi.Input.asOptionalInput<String>(ownershipState),
      ...
      requiredDnsUpdates = pulumi.Input.asOptionalInput<List<HostingCustomDomainRequiredDnsUpdate>>(requiredDnsUpdates),
  ...
  factory HostingCustomDomainState.fromMap(Map<String, dynamic> map) {
    return HostingCustomDomainState(
      ...
      certs: map['certs'] == null ? null : pulumi.Output.create<List<HostingCustomDomainCert>>(pulumi.Input.decodeList<HostingCustomDomainCert>(map['certs'], (value) => HostingCustomDomainCert.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      hostState: map['hostState'] == null ? null : pulumi.Output.create<String>(map['hostState'] as String),
      issues: map['issues'] == null ? null : pulumi.Output.create<List<HostingCustomDomainIssue>>(pulumi.Input.decodeList<HostingCustomDomainIssue>(map['issues'], (value) => HostingCustomDomainIssue.fromMap((value as Map).cast<String, dynamic>()))),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      ownershipState: map['ownershipState'] == null ? null : pulumi.Output.create<String>(map['ownershipState'] as String),
      ...
      requiredDnsUpdates: map['requiredDnsUpdates'] == null ? null : pulumi.Output.create<List<HostingCustomDomainRequiredDnsUpdate>>(pulumi.Input.decodeList<HostingCustomDomainRequiredDnsUpdate>(map['requiredDnsUpdates'], (value) => HostingCustomDomainRequiredDnsUpdate.fromMap((value as Map).cast<String, dynamic>()))),
