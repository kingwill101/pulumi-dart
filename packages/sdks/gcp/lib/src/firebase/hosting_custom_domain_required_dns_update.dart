...
class HostingCustomDomainRequiredDnsUpdate {
  ...
  final pulumi.Input<List<HostingCustomDomainRequiredDnsUpdateDesired>>?
  desireds;

  /// Whether Hosting was able to find the required file contents on the
  /// specified path during its last check.
  final pulumi.Input<List<HostingCustomDomainRequiredDnsUpdateDiscovered>>?
  discovereds;
    ...
    return <String, dynamic>{
      ...
      'desireds':
          ?pulumi.Input.mapOptionalInputValue<
            List<HostingCustomDomainRequiredDnsUpdateDesired>,
      ...
      'discovereds':
          ?pulumi.Input.mapOptionalInputValue<
            List<HostingCustomDomainRequiredDnsUpdateDiscovered>,
            List<Map<String, dynamic>>
          >(
            discovereds,
            (value) =>
    ...
    return HostingCustomDomainRequiredDnsUpdate(
      ...
      desireds: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<HostingCustomDomainRequiredDnsUpdateDesired>(
            guardedValue,
      ...
      discovereds: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<HostingCustomDomainRequiredDnsUpdateDiscovered>(
            guardedValue,
