...
class HostingCustomDomainCertVerificationDnsDesired {
  ...
  factory HostingCustomDomainCertVerificationDnsDesired.fromMap(Map<String, dynamic> map) {
    return HostingCustomDomainCertVerificationDnsDesired(
      ...
      records: (() { final guardedValue = map['records']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<HostingCustomDomainCertVerificationDnsDesiredRecord>(guardedValue, (value) => HostingCustomDomainCertVerificationDnsDesiredRecord.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
