...
class AppCheckRecaptchaV3ConfigState {
  ...
  factory AppCheckRecaptchaV3ConfigState.fromMap(Map<String, dynamic> map) {
    return AppCheckRecaptchaV3ConfigState(
      ...
      siteSecret: (() { final guardedValue = map['siteSecret']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      siteSecretSet: (() { final guardedValue = map['siteSecretSet']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
