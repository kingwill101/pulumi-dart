...
class AppCheckDeviceCheckConfig extends pulumi.CustomResource {
  ...
  /// Creates a new [AppCheckDeviceCheckConfig].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [AppCheckDeviceCheckConfig]. {@macro pulumi_firebase_app_check_device_check_config_app_check_device_check_config_args_doc}
  ...
  /// Gets an existing [AppCheckDeviceCheckConfig] resource's state with the given [name] and [id].
  static AppCheckDeviceCheckConfig get(
    String name,
  ...
  AppCheckDeviceCheckConfig._get(
    String name, {
