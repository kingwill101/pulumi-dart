...
class AppHostingBuildState {
  ...
  factory AppHostingBuildState.fromMap(Map<String, dynamic> map) {
    return AppHostingBuildState(
      ...
      buildLogsUri: (() { final guardedValue = map['buildLogsUri']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      errors: (() { final guardedValue = map['errors']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AppHostingBuildError>(guardedValue, (value) => AppHostingBuildError.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      source: (() { final guardedValue = map['source']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AppHostingBuildSource.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
