...
class AppHostingBackendState {
  ...
  factory AppHostingBackendState.fromMap(Map<String, dynamic> map) {
    return AppHostingBackendState(
      ...
      managedResources: (() {
        final guardedValue = map['managedResources'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AppHostingBackendManagedResource>(
            guardedValue,
            (value) => AppHostingBackendManagedResource.fromMap(
      ...
      servingLocality: (() {
        final guardedValue = map['servingLocality'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      uid: (() {
