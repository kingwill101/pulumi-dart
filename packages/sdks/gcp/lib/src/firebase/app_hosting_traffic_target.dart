...
class AppHostingTrafficTarget {
  ...
  factory AppHostingTrafficTarget.fromMap(Map<String, dynamic> map) {
    return AppHostingTrafficTarget(
      splits: (pulumi.Input.decodeList<AppHostingTrafficTargetSplit>(map['splits'], (value) => AppHostingTrafficTargetSplit.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
