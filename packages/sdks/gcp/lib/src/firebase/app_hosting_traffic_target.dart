...
class AppHostingTrafficTarget {
  ...
  AppHostingTrafficTarget({required this.splits});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'splits':
          pulumi.Input.mapInputValue<
            List<AppHostingTrafficTargetSplit>,
  ...
  factory AppHostingTrafficTarget.fromMap(Map<String, dynamic> map) {
    return AppHostingTrafficTarget(
      splits: pulumi.Input.fromValue(
        pulumi.Input.decodeList<AppHostingTrafficTargetSplit>(
          map['splits']!,
