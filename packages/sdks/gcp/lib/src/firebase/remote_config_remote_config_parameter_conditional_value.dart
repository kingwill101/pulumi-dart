...
class RemoteConfigRemoteConfigParameterConditionalValue {
  ...
  /// Creates a new [RemoteConfigRemoteConfigParameterConditionalValue].
  ...
  const RemoteConfigRemoteConfigParameterConditionalValue({
  ...
  factory RemoteConfigRemoteConfigParameterConditionalValue.fromMap(Map<String, dynamic> map) {
    return RemoteConfigRemoteConfigParameterConditionalValue(
