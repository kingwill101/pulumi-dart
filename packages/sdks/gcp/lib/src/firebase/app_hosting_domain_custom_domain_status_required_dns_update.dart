...
class AppHostingDomainCustomDomainStatusRequiredDnsUpdate {
  ...
  factory AppHostingDomainCustomDomainStatusRequiredDnsUpdate.fromMap(Map<String, dynamic> map) {
    return AppHostingDomainCustomDomainStatusRequiredDnsUpdate(
      ...
      desireds: (() { final guardedValue = map['desireds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AppHostingDomainCustomDomainStatusRequiredDnsUpdateDesired>(guardedValue, (value) => AppHostingDomainCustomDomainStatusRequiredDnsUpdateDesired.fromMap((value as Map).cast<String, dynamic>()))); })(),
      discovereds: (() { final guardedValue = map['discovereds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AppHostingDomainCustomDomainStatusRequiredDnsUpdateDiscovered>(guardedValue, (value) => AppHostingDomainCustomDomainStatusRequiredDnsUpdateDiscovered.fromMap((value as Map).cast<String, dynamic>()))); })(),
