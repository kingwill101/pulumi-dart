...
import 'account_iam_member_state.dart';
...
class AccountIamMember extends pulumi.CustomResource {
  ...
  /// Creates a new [AccountIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [AccountIamMember]. {@macro pulumi_billing_account_iam_member_account_iam_member_args_doc}
  ...
  AccountIamMember(
    ...
    condition = registerOutput<AccountIamMemberCondition?>('condition');
    etag = registerOutput<String>('etag');
    member = registerOutput<String>('member');
    role = registerOutput<String>('role');
  }

  /// Gets an existing [AccountIamMember] resource's state with the given [name] and [id].
  static AccountIamMember get(
    String name,
