...
import 'account_iam_policy_state.dart';
...
class AccountIamPolicy extends pulumi.CustomResource {
  ...
  /// Gets an existing [AccountIamPolicy] resource's state with the given [name] and [id].
  static AccountIamPolicy get(
    String name,
    pulumi.Input<String> id, {
    AccountIamPolicyState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return AccountIamPolicy._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [AccountIamPolicy] resource.
  AccountIamPolicy.reference(String urn)
    : super(
        'gcp:billing/accountIamPolicy:AccountIamPolicy',
