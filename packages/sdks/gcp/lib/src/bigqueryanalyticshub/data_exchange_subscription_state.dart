...
class DataExchangeSubscriptionState {
  ...
  /// Structure is documented below.
  final pulumi.Input<List<DataExchangeSubscriptionLinkedDatasetMap>>?
  linkedDatasetMaps;

  /// Output only. Linked resources created in the subscription. Only contains values if state = STATE_ACTIVE.
  /// Structure is documented below.
  final pulumi.Input<List<DataExchangeSubscriptionLinkedResource>>?
  linkedResources;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'linkedDatasetMaps':
          ?pulumi.Input.mapOptionalInputValue<
            List<DataExchangeSubscriptionLinkedDatasetMap>,
      ...
      'linkedResources':
          ?pulumi.Input.mapOptionalInputValue<
            List<DataExchangeSubscriptionLinkedResource>,
            List<Map<String, dynamic>>
          >(
            linkedResources,
            (value) =>
  ...
  factory DataExchangeSubscriptionState.fromMap(Map<String, dynamic> map) {
    return DataExchangeSubscriptionState(
      ...
      dataExchangeLocation: (() {
        final guardedValue = map['dataExchangeLocation'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      dataExchangeProject: (() {
        final guardedValue = map['dataExchangeProject'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      destinationDataset: (() {
      ...
      linkedDatasetMaps: (() {
        final guardedValue = map['linkedDatasetMaps'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DataExchangeSubscriptionLinkedDatasetMap>(
            guardedValue,
            (value) => DataExchangeSubscriptionLinkedDatasetMap.fromMap(
      ...
      linkedResources: (() {
        final guardedValue = map['linkedResources'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DataExchangeSubscriptionLinkedResource>(
            guardedValue,
            (value) => DataExchangeSubscriptionLinkedResource.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      organizationDisplayName: (() {
        final guardedValue = map['organizationDisplayName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      organizationId: (() {
