...
/// {@template pulumi_bigqueryanalyticshub_data_exchange_iam_binding_data_exchange_iam_binding_args_doc}
...
class DataExchangeIamBindingArgs {
  ...
  /// Creates a new [DataExchangeIamBindingArgs].
  /// [condition] Optional.
  ...
  const DataExchangeIamBindingArgs({
    this.condition,
  ...
  factory DataExchangeIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return DataExchangeIamBindingArgs(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DataExchangeIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
