...
class ListingSubscription extends pulumi.CustomResource {
  ...
  ListingSubscription(
    ...
    this.commercialInfos = registerOutput<List<ListingSubscriptionCommercialInfo>>('commercialInfos');
    this.creationTime = registerOutput<String>('creationTime');
    this.dataExchangeId = registerOutput<String>('dataExchangeId');
    this.destinationDataset = registerOutput<ListingSubscriptionDestinationDataset>('destinationDataset');
    this.lastModifyTime = registerOutput<String>('lastModifyTime');
    this.linkedDatasetMaps = registerOutput<List<ListingSubscriptionLinkedDatasetMap>>('linkedDatasetMaps');
    this.linkedResources = registerOutput<List<ListingSubscriptionLinkedResource>>('linkedResources');
