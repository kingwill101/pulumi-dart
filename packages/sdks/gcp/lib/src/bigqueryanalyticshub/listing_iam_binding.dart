...
import 'listing_iam_binding_state.dart';
...
class ListingIamBinding extends pulumi.CustomResource {
  ...
  /// Gets an existing [ListingIamBinding] resource's state with the given [name] and [id].
  static ListingIamBinding get(
    String name,
    pulumi.Input<String> id, {
    ListingIamBindingState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return ListingIamBinding._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [ListingIamBinding] resource.
  ListingIamBinding.reference(String urn)
    : super(
        'gcp:bigqueryanalyticshub/listingIamBinding:ListingIamBinding',
