...
class ListingSubscriptionState {
  ...
  /// Structure is documented below.
  final pulumi.Input<List<ListingSubscriptionLinkedDatasetMap>>?
  linkedDatasetMaps;
    ...
    return <String, dynamic>{
      'commercialInfos':
          ?pulumi.Input.mapOptionalInputValue<
            List<ListingSubscriptionCommercialInfo>,
      ...
      'linkedDatasetMaps':
          ?pulumi.Input.mapOptionalInputValue<
            List<ListingSubscriptionLinkedDatasetMap>,
            List<Map<String, dynamic>>
          >(
            linkedDatasetMaps,
            (value) =>
      ...
      'linkedResources':
          ?pulumi.Input.mapOptionalInputValue<
            List<ListingSubscriptionLinkedResource>,
            List<Map<String, dynamic>>
          >(
            linkedResources,
            (value) =>
    ...
    return ListingSubscriptionState(
      commercialInfos: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ListingSubscriptionCommercialInfo>(
            guardedValue,
            (value) => ListingSubscriptionCommercialInfo.fromMap(
      ...
      linkedDatasetMaps: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ListingSubscriptionLinkedDatasetMap>(
            guardedValue,
            (value) => ListingSubscriptionLinkedDatasetMap.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      linkedResources: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ListingSubscriptionLinkedResource>(
            guardedValue,
            (value) => ListingSubscriptionLinkedResource.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
