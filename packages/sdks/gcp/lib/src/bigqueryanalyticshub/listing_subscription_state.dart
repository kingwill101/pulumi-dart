...
class ListingSubscriptionState {
  ...
  factory ListingSubscriptionState.fromMap(Map<String, dynamic> map) {
    return ListingSubscriptionState(
      commercialInfos: map['commercialInfos'] == null ? null : (pulumi.Input.decodeList<ListingSubscriptionCommercialInfo>(map['commercialInfos'], (value) => ListingSubscriptionCommercialInfo.fromMap((value as Map).cast<String, dynamic>()))).input(),
      creationTime: map['creationTime'] == null ? null : (map['creationTime'] as String).input(),
      dataExchangeId: map['dataExchangeId'] == null ? null : (map['dataExchangeId'] as String).input(),
      destinationDataset: map['destinationDataset'] == null ? null : (ListingSubscriptionDestinationDataset.fromMap((map['destinationDataset'] as Map).cast<String, dynamic>())).input(),
      lastModifyTime: map['lastModifyTime'] == null ? null : (map['lastModifyTime'] as String).input(),
      linkedDatasetMaps: map['linkedDatasetMaps'] == null ? null : (pulumi.Input.decodeList<ListingSubscriptionLinkedDatasetMap>(map['linkedDatasetMaps'], (value) => ListingSubscriptionLinkedDatasetMap.fromMap((value as Map).cast<String, dynamic>()))).input(),
      linkedResources: map['linkedResources'] == null ? null : (pulumi.Input.decodeList<ListingSubscriptionLinkedResource>(map['linkedResources'], (value) => ListingSubscriptionLinkedResource.fromMap((value as Map).cast<String, dynamic>()))).input(),
