...
class DataExchangeSubscriptionArgs {
  ...
  factory DataExchangeSubscriptionArgs.fromMap(Map<String, dynamic> map) {
    return DataExchangeSubscriptionArgs(
      ...
      dataExchangeLocation: pulumi.Input.fromValue(
        map['dataExchangeLocation'] as String,
      ),
      dataExchangeProject: pulumi.Input.fromValue(
        map['dataExchangeProject'] as String,
      ),
      destinationDataset: (() {
        final guardedValue = map['destinationDataset'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DataExchangeSubscriptionDestinationDataset.fromMap(
      ...
      refreshPolicy: (() {
        final guardedValue = map['refreshPolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      subscriberContact: (() {
        final guardedValue = map['subscriberContact'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
