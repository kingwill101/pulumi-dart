...
class ListingSubscriptionCommercialInfo {
  ...
  final pulumi.Input<List<ListingSubscriptionCommercialInfoCloudMarketplace>>?
  cloudMarketplaces;
    ...
    return <String, dynamic>{
      'cloudMarketplaces':
          ?pulumi.Input.mapOptionalInputValue<
            List<ListingSubscriptionCommercialInfoCloudMarketplace>,
  ...
  factory ListingSubscriptionCommercialInfo.fromMap(Map<String, dynamic> map) {
    return ListingSubscriptionCommercialInfo(
      cloudMarketplaces: (() {
        final guardedValue = map['cloudMarketplaces'];
