...
class ListingBigqueryDataset {
  ...
  factory ListingBigqueryDataset.fromMap(Map<String, dynamic> map) {
    return ListingBigqueryDataset(
      ...
      effectiveReplicas: (() { final guardedValue = map['effectiveReplicas']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ListingBigqueryDatasetEffectiveReplica>(guardedValue, (value) => ListingBigqueryDatasetEffectiveReplica.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      selectedResources: (() { final guardedValue = map['selectedResources']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ListingBigqueryDatasetSelectedResource>(guardedValue, (value) => ListingBigqueryDatasetSelectedResource.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
