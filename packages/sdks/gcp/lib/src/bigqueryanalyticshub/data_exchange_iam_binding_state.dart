...
class DataExchangeIamBindingState {
  ...
  /// Creates a new [DataExchangeIamBindingState].
  /// [condition] Optional.
  ...
  const DataExchangeIamBindingState({
    this.condition,
    this.dataExchangeId,
    this.etag,
    this.location,
  ...
  factory DataExchangeIamBindingState.fromMap(Map<String, dynamic> map) {
    return DataExchangeIamBindingState(
