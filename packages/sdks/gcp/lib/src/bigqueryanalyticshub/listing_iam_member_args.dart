...
import 'listing_iam_member_condition.dart';

/// {@template pulumi_bigqueryanalyticshub_listing_iam_member_listing_iam_member_args_doc}
/// The set of arguments for ListingIamMember.
/// {@endtemplate}
/// {@macro pulumi_bigqueryanalyticshub_listing_iam_member_listing_iam_member_args_doc}
class ListingIamMemberArgs {
  ...
  /// Creates a new [ListingIamMemberArgs].
  /// [condition] Optional.
  ...
  ListingIamMemberArgs({
    pulumi.Output<ListingIamMemberCondition>? condition,
    ...
    required pulumi.Output<String> role,
      ...
      condition = pulumi.Input.asOptionalInput<ListingIamMemberCondition>(condition),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'condition': ?pulumi.Input.mapOptionalInputValue<ListingIamMemberCondition, Map<String, dynamic>>(condition, (value) => value.toMap()),
  ...
  factory ListingIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return ListingIamMemberArgs(
      condition: map['condition'] == null ? null : pulumi.Output.create<ListingIamMemberCondition>(ListingIamMemberCondition.fromMap((map['condition'] as Map).cast<String, dynamic>())),
