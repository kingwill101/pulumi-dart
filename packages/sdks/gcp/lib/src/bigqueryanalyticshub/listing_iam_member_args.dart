...
class ListingIamMemberArgs {
  ...
  factory ListingIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return ListingIamMemberArgs(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ListingIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
