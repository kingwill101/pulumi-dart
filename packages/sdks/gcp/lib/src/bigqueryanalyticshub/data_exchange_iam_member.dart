...
import 'data_exchange_iam_member_state.dart';
...
class DataExchangeIamMember extends pulumi.CustomResource {
  late final pulumi.Output<DataExchangeIamMemberCondition?> condition;
  ...
  /// Creates a new [DataExchangeIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [DataExchangeIamMember]. {@macro pulumi_bigqueryanalyticshub_data_exchange_iam_member_data_exchange_iam_member_args_doc}
  ...
  /// Gets an existing [DataExchangeIamMember] resource's state with the given [name] and [id].
  static DataExchangeIamMember get(
    String name,
    pulumi.Input<String> id, {
    DataExchangeIamMemberState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return DataExchangeIamMember._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [DataExchangeIamMember] resource.
  DataExchangeIamMember.reference(String urn)
    : super(
        'gcp:bigqueryanalyticshub/dataExchangeIamMember:DataExchangeIamMember',
