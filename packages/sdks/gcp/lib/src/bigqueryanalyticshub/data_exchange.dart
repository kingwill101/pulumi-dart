...
import 'data_exchange_state.dart';
...
class DataExchange extends pulumi.CustomResource {
  ...
  late final pulumi.Output<DataExchangeSharingEnvironmentConfig> sharingEnvironmentConfig;

  /// Creates a new [DataExchange].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [DataExchange]. {@macro pulumi_bigqueryanalyticshub_data_exchange_data_exchange_args_doc}
  ...
  DataExchange(
    ...
    this.sharingEnvironmentConfig = registerOutput<DataExchangeSharingEnvironmentConfig>('sharingEnvironmentConfig');
  }

  /// Gets an existing [DataExchange] resource's state with the given [name] and [id].
  static DataExchange get(
    String name,
