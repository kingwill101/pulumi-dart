...
import 'data_exchange_iam_policy_state.dart';
...
class DataExchangeIamPolicy extends pulumi.CustomResource {
  ...
  /// Gets an existing [DataExchangeIamPolicy] resource's state with the given [name] and [id].
  static DataExchangeIamPolicy get(
    String name,
    pulumi.Input<String> id, {
    DataExchangeIamPolicyState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return DataExchangeIamPolicy._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [DataExchangeIamPolicy] resource.
  DataExchangeIamPolicy.reference(String urn)
    : super(
        'gcp:bigqueryanalyticshub/dataExchangeIamPolicy:DataExchangeIamPolicy',
