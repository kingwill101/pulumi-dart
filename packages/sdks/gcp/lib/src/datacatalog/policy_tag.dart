...
class PolicyTag extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [PolicyTag]. {@macro pulumi_datacatalog_policy_tag_policy_tag_args_doc}
  ...
  /// Gets an existing [PolicyTag] resource's state with the given [name] and [id].
  static PolicyTag get(
    String name,
