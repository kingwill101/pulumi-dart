...
import 'tag_template_iam_member_args.dart';
...
class TagTemplateIamMember extends pulumi.CustomResource {
  ...
  /// Creates a new [TagTemplateIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [TagTemplateIamMember]. {@macro pulumi_datacatalog_tag_template_iam_member_tag_template_iam_member_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  TagTemplateIamMember(
    String name, {
    TagTemplateIamMemberArgs? args,
    ...
    condition = registerOutput<TagTemplateIamMemberCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return TagTemplateIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [TagTemplateIamMember] resource's state with the given [name] and [id].
  static TagTemplateIamMember get(
    String name,
    pulumi.Input<String> id, {
    TagTemplateIamMemberState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return TagTemplateIamMember._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [TagTemplateIamMember] resource.
  TagTemplateIamMember.reference(String urn)
    : super(
        'gcp:datacatalog/tagTemplateIamMember:TagTemplateIamMember',
