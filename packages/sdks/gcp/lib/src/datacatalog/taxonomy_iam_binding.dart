...
import 'taxonomy_iam_binding_args.dart';
import 'taxonomy_iam_binding_condition.dart';
import 'taxonomy_iam_binding_state.dart';
...
class TaxonomyIamBinding extends pulumi.CustomResource {
  ...
  /// Creates a new [TaxonomyIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [TaxonomyIamBinding]. {@macro pulumi_datacatalog_taxonomy_iam_binding_taxonomy_iam_binding_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  TaxonomyIamBinding(
    String name, {
    TaxonomyIamBindingArgs? args,
    ...
    condition = registerOutput<TaxonomyIamBindingCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return TaxonomyIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [TaxonomyIamBinding] resource's state with the given [name] and [id].
  static TaxonomyIamBinding get(
    String name,
    pulumi.Input<String> id, {
    TaxonomyIamBindingState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return TaxonomyIamBinding._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [TaxonomyIamBinding] resource.
  TaxonomyIamBinding.reference(String urn)
    : super(
        'gcp:datacatalog/taxonomyIamBinding:TaxonomyIamBinding',
