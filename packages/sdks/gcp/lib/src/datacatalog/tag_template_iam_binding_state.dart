...
class TagTemplateIamBindingState {
  ...
  /// Creates a new [TagTemplateIamBindingState].
  /// [condition] Optional.
  ...
  const TagTemplateIamBindingState({
    this.condition,
    this.etag,
    this.members,
    this.project,
  ...
  factory TagTemplateIamBindingState.fromMap(Map<String, dynamic> map) {
    return TagTemplateIamBindingState(
