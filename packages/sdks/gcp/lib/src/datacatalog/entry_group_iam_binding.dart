...
import 'entry_group_iam_binding_state.dart';
...
class EntryGroupIamBinding extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [EntryGroupIamBinding]. {@macro pulumi_datacatalog_entry_group_iam_binding_entry_group_iam_binding_args_doc}
  ...
  /// Gets an existing [EntryGroupIamBinding] resource's state with the given [name] and [id].
  static EntryGroupIamBinding get(
    String name,
