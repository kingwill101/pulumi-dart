...
class EntryBigqueryTableSpec {
    ...
    return <String, dynamic>{
      ...
      'tableSpecs':
          ?pulumi.Input.mapOptionalInputValue<
            List<EntryBigqueryTableSpecTableSpec>,
      ...
      'viewSpecs':
          ?pulumi.Input.mapOptionalInputValue<
            List<EntryBigqueryTableSpecViewSpec>,
            List<Map<String, dynamic>>
          >(
            viewSpecs,
            (value) =>
  ...
  factory EntryBigqueryTableSpec.fromMap(Map<String, dynamic> map) {
    return EntryBigqueryTableSpec(
      tableSourceType: (() {
        final guardedValue = map['tableSourceType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      tableSpecs: (() {
        final guardedValue = map['tableSpecs'];
        if (guardedValue == null) return null;
      ...
      viewSpecs: (() {
        final guardedValue = map['viewSpecs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
