...
class TaxonomyIamMemberState {
  ...
  /// Creates a new [TaxonomyIamMemberState].
  /// [condition] Optional.
  ...
  factory TaxonomyIamMemberState.fromMap(Map<String, dynamic> map) {
    return TaxonomyIamMemberState(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TaxonomyIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
