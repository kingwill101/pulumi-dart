...
class EntryGroupIamBindingState {
  ...
  factory EntryGroupIamBindingState.fromMap(Map<String, dynamic> map) {
    return EntryGroupIamBindingState(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EntryGroupIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
