...
class TaxonomyIamBindingArgs {
  ...
  factory TaxonomyIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return TaxonomyIamBindingArgs(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TaxonomyIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
