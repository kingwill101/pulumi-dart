...
import 'tag_template_iam_policy_state.dart';
...
class TagTemplateIamPolicy extends pulumi.CustomResource {
  ...
  /// Gets an existing [TagTemplateIamPolicy] resource's state with the given [name] and [id].
  static TagTemplateIamPolicy get(
    String name,
    pulumi.Input<String> id, {
    TagTemplateIamPolicyState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return TagTemplateIamPolicy._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [TagTemplateIamPolicy] resource.
  TagTemplateIamPolicy.reference(String urn)
    : super(
        'gcp:datacatalog/tagTemplateIamPolicy:TagTemplateIamPolicy',
