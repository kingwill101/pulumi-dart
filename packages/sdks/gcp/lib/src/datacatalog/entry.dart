...
class Entry extends pulumi.CustomResource {
  ...
  Entry(String name, {EntryArgs? args, pulumi.CustomResourceOptions? options})
    ...
    bigqueryDateShardedSpecs = registerOutput<List<Map<String, dynamic>>>(
      'bigqueryDateShardedSpecs',
    );
    bigqueryTableSpecs = registerOutput<List<Map<String, dynamic>>>(
      'bigqueryTableSpecs',
    );
  ...
  static Entry get(String name, pulumi.Input<String> id, {EntryState? state}) {
    return Entry._get(
      name,
      state: state?.toMap(),
