...
import 'policy_tag_iam_member_state.dart';
...
class PolicyTagIamMember extends pulumi.CustomResource {
  ...
  PolicyTagIamMember(
    ...
    condition = registerOutput<PolicyTagIamMemberCondition?>(
      'condition',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return PolicyTagIamMemberCondition.fromMap(
  ...
  /// Gets an existing [PolicyTagIamMember] resource's state with the given [name] and [id].
  static PolicyTagIamMember get(
    String name,
