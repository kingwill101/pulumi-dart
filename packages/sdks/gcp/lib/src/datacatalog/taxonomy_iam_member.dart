...
import 'taxonomy_iam_member_state.dart';
...
class TaxonomyIamMember extends pulumi.CustomResource {
  late final pulumi.Output<TaxonomyIamMemberCondition?> condition;
  ...
  /// Creates a new [TaxonomyIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [TaxonomyIamMember]. {@macro pulumi_datacatalog_taxonomy_iam_member_taxonomy_iam_member_args_doc}
  ...
  TaxonomyIamMember(
    ...
    condition = registerOutput<TaxonomyIamMemberCondition?>(
      'condition',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return TaxonomyIamMemberCondition.fromMap(
  ...
  /// Gets an existing [TaxonomyIamMember] resource's state with the given [name] and [id].
  static TaxonomyIamMember get(
    String name,
