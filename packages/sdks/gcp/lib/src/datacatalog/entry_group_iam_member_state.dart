...
class EntryGroupIamMemberState {
  ...
  /// Creates a new [EntryGroupIamMemberState].
  /// [condition] Optional.
  ...
  factory EntryGroupIamMemberState.fromMap(Map<String, dynamic> map) {
    return EntryGroupIamMemberState(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EntryGroupIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      entryGroup: (() { final guardedValue = map['entryGroup']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
