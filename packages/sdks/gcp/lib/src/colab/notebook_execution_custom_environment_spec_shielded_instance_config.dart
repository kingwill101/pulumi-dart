...
class NotebookExecutionCustomEnvironmentSpecShieldedInstanceConfig {
  ...
  /// Creates a new [NotebookExecutionCustomEnvironmentSpecShieldedInstanceConfig].
  ...
  const NotebookExecutionCustomEnvironmentSpecShieldedInstanceConfig({
  ...
  factory NotebookExecutionCustomEnvironmentSpecShieldedInstanceConfig.fromMap(Map<String, dynamic> map) {
    return NotebookExecutionCustomEnvironmentSpecShieldedInstanceConfig(
