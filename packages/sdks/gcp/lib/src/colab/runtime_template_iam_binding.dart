...
import 'runtime_template_iam_binding_state.dart';
...
class RuntimeTemplateIamBinding extends pulumi.CustomResource {
  ...
  /// Gets an existing [RuntimeTemplateIamBinding] resource's state with the given [name] and [id].
  static RuntimeTemplateIamBinding get(
    String name,
  ...
  RuntimeTemplateIamBinding._get(
    String name, {
