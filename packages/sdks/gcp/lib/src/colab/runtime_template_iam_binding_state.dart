...
class RuntimeTemplateIamBindingState {
  ...
  /// Creates a new [RuntimeTemplateIamBindingState].
  /// [condition] Optional.
  ...
  factory RuntimeTemplateIamBindingState.fromMap(Map<String, dynamic> map) {
    return RuntimeTemplateIamBindingState(
      ...
      runtimeTemplate: (() { final guardedValue = map['runtimeTemplate']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
