...
/// {@template pulumi_colab_runtime_template_iam_member_runtime_template_iam_member_args_doc}
/// The set of arguments for RuntimeTemplateIamMember.
/// {@endtemplate}
/// {@macro pulumi_colab_runtime_template_iam_member_runtime_template_iam_member_args_doc}
class RuntimeTemplateIamMemberArgs {
  ...
  /// Creates a new [RuntimeTemplateIamMemberArgs].
  /// [condition] Optional.
  ...
  const RuntimeTemplateIamMemberArgs({
    this.condition,
    this.location,
  ...
  factory RuntimeTemplateIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return RuntimeTemplateIamMemberArgs(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RuntimeTemplateIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
