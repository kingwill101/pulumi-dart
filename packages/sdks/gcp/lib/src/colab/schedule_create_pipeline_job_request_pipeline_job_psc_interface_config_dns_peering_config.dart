...
class ScheduleCreatePipelineJobRequestPipelineJobPscInterfaceConfigDnsPeeringConfig {
  ...
  /// Creates a new [ScheduleCreatePipelineJobRequestPipelineJobPscInterfaceConfigDnsPeeringConfig].
  ...
  const ScheduleCreatePipelineJobRequestPipelineJobPscInterfaceConfigDnsPeeringConfig({
  ...
  factory ScheduleCreatePipelineJobRequestPipelineJobPscInterfaceConfigDnsPeeringConfig.fromMap(Map<String, dynamic> map) {
    return ScheduleCreatePipelineJobRequestPipelineJobPscInterfaceConfigDnsPeeringConfig(
