...
class GcpConfig {
  ...
  Batching? get batching {
    ...
    return (() { final guardedValue = raw; if (guardedValue == null) return null; return Batching.fromMap((jsonDecode(guardedValue) as Map).cast<String, dynamic>()); })();
  }
  ...
  ExternalCredentials? get externalCredentials {
    ...
    return (() { final guardedValue = raw; if (guardedValue == null) return null; return ExternalCredentials.fromMap((jsonDecode(guardedValue) as Map).cast<String, dynamic>()); })();
  }
