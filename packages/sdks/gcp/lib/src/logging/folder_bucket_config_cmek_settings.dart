...
class FolderBucketConfigCmekSettings {
  ...
  /// Creates a new [FolderBucketConfigCmekSettings].
  ...
  factory FolderBucketConfigCmekSettings.fromMap(Map<String, dynamic> map) {
    return FolderBucketConfigCmekSettings(
