...
class MetricState {
  ...
  factory MetricState.fromMap(Map<String, dynamic> map) {
    return MetricState(
      ...
      labelExtractors: (() { final guardedValue = map['labelExtractors']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      metricDescriptor: (() { final guardedValue = map['metricDescriptor']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MetricMetricDescriptor.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      project: (() { final guardedValue = map['project']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      valueExtractor: (() { final guardedValue = map['valueExtractor']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
