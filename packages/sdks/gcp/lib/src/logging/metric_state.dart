...
class MetricState {
  ...
  factory MetricState.fromMap(Map<String, dynamic> map) {
    return MetricState(
      ...
      bucketOptions: (() {
        final guardedValue = map['bucketOptions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          MetricBucketOptions.fromMap(
      ...
      metricDescriptor: (() {
        final guardedValue = map['metricDescriptor'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          MetricMetricDescriptor.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      valueExtractor: (() {
        final guardedValue = map['valueExtractor'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
