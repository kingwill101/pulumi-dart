...
class LinkedDataset extends pulumi.CustomResource {
  ...
  LinkedDataset(
    ...
    this.bigqueryDatasets = registerOutput<List<LinkedDatasetBigqueryDataset>>('bigqueryDatasets');
  ...
  /// Gets an existing [LinkedDataset] resource's state with the given [name] and [id].
  static LinkedDataset get(
    String name,
