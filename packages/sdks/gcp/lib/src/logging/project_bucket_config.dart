...
class ProjectBucketConfig extends pulumi.CustomResource {
  ...
  ProjectBucketConfig(
    ...
    this.cmekSettings = registerOutput<ProjectBucketConfigCmekSettings?>('cmekSettings');
    this.description = registerOutput<String>('description');
    this.enableAnalytics = registerOutput<bool?>('enableAnalytics');
    this.indexConfigs = registerOutput<List<ProjectBucketConfigIndexConfig>?>('indexConfigs');
