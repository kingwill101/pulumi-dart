...
import 'log_view_iam_member_state.dart';
...
class LogViewIamMember extends pulumi.CustomResource {
  ...
  /// Creates a new [LogViewIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [LogViewIamMember]. {@macro pulumi_logging_log_view_iam_member_log_view_iam_member_args_doc}
  ...
  LogViewIamMember(
    ...
    condition = registerOutput<LogViewIamMemberCondition?>(
      'condition',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return LogViewIamMemberCondition.fromMap(
  ...
  /// Gets an existing [LogViewIamMember] resource's state with the given [name] and [id].
  static LogViewIamMember get(
    String name,
