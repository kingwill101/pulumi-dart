...
class FolderBucketConfig extends pulumi.CustomResource {
  ...
  FolderBucketConfig(
    ...
    this.cmekSettings = registerOutput<FolderBucketConfigCmekSettings?>('cmekSettings');
    this.description = registerOutput<String>('description');
    this.folder = registerOutput<String>('folder');
    this.indexConfigs = registerOutput<List<FolderBucketConfigIndexConfig>>('indexConfigs');
