...
class FolderSinkArgs {
  ...
  factory FolderSinkArgs.fromMap(Map<String, dynamic> map) {
    return FolderSinkArgs(
      ...
      exclusions: (() { final guardedValue = map['exclusions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FolderSinkExclusion>(guardedValue, (value) => FolderSinkExclusion.fromMap((value as Map).cast<String, dynamic>()))); })(),
