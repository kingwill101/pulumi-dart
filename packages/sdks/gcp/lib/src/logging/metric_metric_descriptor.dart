...
class MetricMetricDescriptor {
  ...
  factory MetricMetricDescriptor.fromMap(Map<String, dynamic> map) {
    return MetricMetricDescriptor(
      ...
      labels: (() { final guardedValue = map['labels']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<MetricMetricDescriptorLabel>(guardedValue, (value) => MetricMetricDescriptorLabel.fromMap((value as Map).cast<String, dynamic>()))); })(),
