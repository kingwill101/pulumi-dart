...
class MetricBucketOptions {
  ...
  factory MetricBucketOptions.fromMap(Map<String, dynamic> map) {
    return MetricBucketOptions(
      explicitBuckets: (() { final guardedValue = map['explicitBuckets']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MetricBucketOptionsExplicitBuckets.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      exponentialBuckets: (() { final guardedValue = map['exponentialBuckets']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MetricBucketOptionsExponentialBuckets.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      linearBuckets: (() { final guardedValue = map['linearBuckets']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MetricBucketOptionsLinearBuckets.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
