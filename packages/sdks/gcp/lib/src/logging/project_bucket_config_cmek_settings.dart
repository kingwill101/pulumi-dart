...
class ProjectBucketConfigCmekSettings {
  ...
  /// Creates a new [ProjectBucketConfigCmekSettings].
  ...
  factory ProjectBucketConfigCmekSettings.fromMap(Map<String, dynamic> map) {
    return ProjectBucketConfigCmekSettings(
