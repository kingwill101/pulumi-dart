...
class AnalystAgentPersonaResourceGoogleDriveResource {
  ...
  const AnalystAgentPersonaResourceGoogleDriveResource({
  ...
  factory AnalystAgentPersonaResourceGoogleDriveResource.fromMap(Map<String, dynamic> map) {
    return AnalystAgentPersonaResourceGoogleDriveResource(
