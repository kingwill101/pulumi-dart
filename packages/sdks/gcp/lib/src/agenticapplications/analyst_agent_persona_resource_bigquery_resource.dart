...
class AnalystAgentPersonaResourceBigqueryResource {
  ...
  /// Creates a new [AnalystAgentPersonaResourceBigqueryResource].
  ...
  const AnalystAgentPersonaResourceBigqueryResource({
  ...
  factory AnalystAgentPersonaResourceBigqueryResource.fromMap(Map<String, dynamic> map) {
    return AnalystAgentPersonaResourceBigqueryResource(
