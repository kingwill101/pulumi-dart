...
class AnalystAgentPersonaArtifactExampleResourceBigqueryResource {
  ...
  const AnalystAgentPersonaArtifactExampleResourceBigqueryResource({
  ...
  factory AnalystAgentPersonaArtifactExampleResourceBigqueryResource.fromMap(Map<String, dynamic> map) {
    return AnalystAgentPersonaArtifactExampleResourceBigqueryResource(
