...
class AnalystAgentPersonaArtifactExampleResourceF1Resource {
  ...
  const AnalystAgentPersonaArtifactExampleResourceF1Resource({
    this.f1Table,
  });
  ...
  factory AnalystAgentPersonaArtifactExampleResourceF1Resource.fromMap(Map<String, dynamic> map) {
    return AnalystAgentPersonaArtifactExampleResourceF1Resource(
