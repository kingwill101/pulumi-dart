...
class AnalystAgentPersonaResourceGoogleCloudStorageResource {
  ...
  /// Creates a new [AnalystAgentPersonaResourceGoogleCloudStorageResource].
  ...
  const AnalystAgentPersonaResourceGoogleCloudStorageResource({
  ...
  factory AnalystAgentPersonaResourceGoogleCloudStorageResource.fromMap(Map<String, dynamic> map) {
    return AnalystAgentPersonaResourceGoogleCloudStorageResource(
