...
class ClusterState {
  ...
  factory ClusterState.fromMap(Map<String, dynamic> map) {
    return ClusterState(
      ...
      controlPlaneVersion: (() {
        final guardedValue = map['controlPlaneVersion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      createTime: (() {
      ...
      maintenanceEvents: (() {
        final guardedValue = map['maintenanceEvents'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ClusterMaintenanceEvent>(
            guardedValue,
            (value) => ClusterMaintenanceEvent.fromMap(
