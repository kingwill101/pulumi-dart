...
class ClusterMaintenancePolicyWindow {
  ...
  final pulumi.Input<ClusterMaintenancePolicyWindowRecurringWindow> recurringWindow;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'recurringWindow': pulumi.Input.mapInputValue<ClusterMaintenancePolicyWindowRecurringWindow, Map<String, dynamic>>(recurringWindow, (value) => value.toMap()),
    };
  }

  factory ClusterMaintenancePolicyWindow.fromMap(Map<String, dynamic> map) {
    return ClusterMaintenancePolicyWindow(
      recurringWindow: pulumi.Input.fromValue(ClusterMaintenancePolicyWindowRecurringWindow.fromMap((map['recurringWindow']! as Map).cast<String, dynamic>())),
    );
  }
}
