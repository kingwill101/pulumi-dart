...
class ClusterMaintenancePolicyWindowRecurringWindow {
  ...
  factory ClusterMaintenancePolicyWindowRecurringWindow.fromMap(Map<String, dynamic> map) {
    return ClusterMaintenancePolicyWindowRecurringWindow(
      ...
      window: (() { final guardedValue = map['window']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterMaintenancePolicyWindowRecurringWindowWindow.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
