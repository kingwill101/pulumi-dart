...
class ClusterArgs {
  ...
  ClusterArgs({
    required pulumi.Output<ClusterAuthorization> authorization,
    ...
    required pulumi.Output<ClusterFleet> fleet,
    pulumi.Output<Map<String, String>>? labels,
    required pulumi.Output<String> location,
    pulumi.Output<ClusterMaintenancePolicy>? maintenancePolicy,
    pulumi.Output<String>? name,
    required pulumi.Output<ClusterNetworking> networking,
    ...
    pulumi.Output<String>? targetVersion,
      ...
      authorization = pulumi.Input.asInput<ClusterAuthorization>(authorization),
  ...
  factory ClusterArgs.fromMap(Map<String, dynamic> map) {
    return ClusterArgs(
      authorization: pulumi.Output.create<ClusterAuthorization>(ClusterAuthorization.fromMap((map['authorization'] as Map).cast<String, dynamic>())),
      ...
      fleet: pulumi.Output.create<ClusterFleet>(ClusterFleet.fromMap((map['fleet'] as Map).cast<String, dynamic>())),
      ...
      networking: pulumi.Output.create<ClusterNetworking>(ClusterNetworking.fromMap((map['networking'] as Map).cast<String, dynamic>())),
