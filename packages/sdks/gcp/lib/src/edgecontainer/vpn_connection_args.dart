  ...
  factory VpnConnectionArgs.fromMap(Map<String, dynamic> map) {
    return VpnConnectionArgs(
      ...
      enableHighAvailability: (() {
        final guardedValue = map['enableHighAvailability'];
      ...
      natGatewayIp: (() {
        final guardedValue = map['natGatewayIp'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      project: (() {
      ...
      vpcProject: (() {
        final guardedValue = map['vpcProject'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VpnConnectionVpcProject.fromMap(
