...
class Instance extends pulumi.CustomResource {
  ...
  Instance(
    ...
    this.memcacheNodes = registerOutput<List<InstanceMemcacheNode>>('memcacheNodes');
    this.memcacheParameters = registerOutput<InstanceMemcacheParameters?>('memcacheParameters');
    ...
    this.reservedIpRangeIds = registerOutput<List<String>?>('reservedIpRangeIds');
