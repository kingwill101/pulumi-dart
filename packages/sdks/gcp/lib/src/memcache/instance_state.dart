...
class InstanceState {
  ...
  factory InstanceState.fromMap(Map<String, dynamic> map) {
    return InstanceState(
      ...
      discoveryEndpoint: (() {
        final guardedValue = map['discoveryEndpoint'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      displayName: (() {
      ...
      memcacheFullVersion: (() {
        final guardedValue = map['memcacheFullVersion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      memcacheNodes: (() {
        final guardedValue = map['memcacheNodes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InstanceMemcacheNode>(
            guardedValue,
            (value) => InstanceMemcacheNode.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
