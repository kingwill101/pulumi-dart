...
class BlockchainNodes extends pulumi.CustomResource {
  ...
  BlockchainNodes(
    ...
    this.connectionInfos = registerOutput<List<BlockchainNodesConnectionInfo>>('connectionInfos');
    this.createTime = registerOutput<String>('createTime');
    this.effectiveLabels = registerOutput<Map<String, String>>('effectiveLabels');
    this.ethereumDetails = registerOutput<BlockchainNodesEthereumDetails?>('ethereumDetails');
