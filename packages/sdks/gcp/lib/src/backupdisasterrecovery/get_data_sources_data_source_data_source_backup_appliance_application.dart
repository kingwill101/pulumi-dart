...
class GetDataSourcesDataSourceDataSourceBackupApplianceApplication {
  ...
  /// Creates a new [GetDataSourcesDataSourceDataSourceBackupApplianceApplication].
  ...
  const GetDataSourcesDataSourceDataSourceBackupApplianceApplication({
  ...
  factory GetDataSourcesDataSourceDataSourceBackupApplianceApplication.fromMap(Map<String, dynamic> map) {
    return GetDataSourcesDataSourceDataSourceBackupApplianceApplication(
