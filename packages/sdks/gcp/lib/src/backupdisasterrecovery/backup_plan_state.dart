...
class BackupPlanState {
  ...
  factory BackupPlanState.fromMap(Map<String, dynamic> map) {
    return BackupPlanState(
      backupPlanId: (() {
        final guardedValue = map['backupPlanId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      backupRules: (() {
        final guardedValue = map['backupRules'];
        if (guardedValue == null) return null;
      ...
      backupVaultServiceAccount: (() {
        final guardedValue = map['backupVaultServiceAccount'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      createTime: (() {
      ...
      supportedResourceTypes: (() {
        final guardedValue = map['supportedResourceTypes'];
        if (guardedValue == null) return null;
