...
class RestoreWorkloadComputeInstanceRestoreProperties {
  ...
  /// Structure is documented below.
  final pulumi.Input<List<RestoreWorkloadComputeInstanceRestorePropertiesDisk>>?
  disks;
  ...
  /// Structure is documented below.
  final pulumi.Input<
    List<RestoreWorkloadComputeInstanceRestorePropertiesGuestAccelerator>
  >?
  guestAccelerators;
  ...
  /// Structure is documented below.
  final pulumi.Input<
    List<RestoreWorkloadComputeInstanceRestorePropertiesLabel>
  >?
  labels;
  ...
  /// Structure is documented below.
  final pulumi.Input<RestoreWorkloadComputeInstanceRestorePropertiesMetadata>?
  metadata;
  ...
  /// Structure is documented below.
  final pulumi.Input<
    List<RestoreWorkloadComputeInstanceRestorePropertiesNetworkInterface>
  >?
  networkInterfaces;
  ...
  /// Structure is documented below.
  final pulumi.Input<RestoreWorkloadComputeInstanceRestorePropertiesParams>?
  params;
  ...
  /// Structure is documented below.
  final pulumi.Input<RestoreWorkloadComputeInstanceRestorePropertiesScheduling>?
  scheduling;

  /// Optional. A list of service accounts, with their specified scopes, authorized for this instance.
  /// Structure is documented below.
  final pulumi.Input<
    List<RestoreWorkloadComputeInstanceRestorePropertiesServiceAccount>
  >?
  serviceAccounts;
    ...
    return <String, dynamic>{
      ...
      'allocationAffinity':
          ?pulumi.Input.mapOptionalInputValue<
            RestoreWorkloadComputeInstanceRestorePropertiesAllocationAffinity,
            Map<String, dynamic>
          >(allocationAffinity, (value) => value.toMap()),
      ...
      'disks':
          ?pulumi.Input.mapOptionalInputValue<
            List<RestoreWorkloadComputeInstanceRestorePropertiesDisk>,
  ...
  factory RestoreWorkloadComputeInstanceRestoreProperties.fromMap(
    ...
    return RestoreWorkloadComputeInstanceRestoreProperties(
      ...
      allocationAffinity: (() {
        final guardedValue = map['allocationAffinity'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
