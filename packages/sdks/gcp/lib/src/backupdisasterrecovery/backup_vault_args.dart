...
class BackupVaultArgs {
  ...
  BackupVaultArgs({
    ...
    required pulumi.Output<String> backupMinimumEnforcedRetentionDuration,
  ...
  factory BackupVaultArgs.fromMap(Map<String, dynamic> map) {
    return BackupVaultArgs(
      ...
      backupMinimumEnforcedRetentionDuration: pulumi.Output.create<String>(map['backupMinimumEnforcedRetentionDuration'] as String),
