...
class GetDataSourcesDataSourceBackupConfigInfoBackupApplianceBackupConfig {
  ...
  /// Creates a new [GetDataSourcesDataSourceBackupConfigInfoBackupApplianceBackupConfig].
  ...
  const GetDataSourcesDataSourceBackupConfigInfoBackupApplianceBackupConfig({
  ...
  factory GetDataSourcesDataSourceBackupConfigInfoBackupApplianceBackupConfig.fromMap(Map<String, dynamic> map) {
    return GetDataSourcesDataSourceBackupConfigInfoBackupApplianceBackupConfig(
