...
class RestoreWorkloadDiskRestoreProperties {
  ...
  final pulumi.Input<RestoreWorkloadDiskRestorePropertiesDiskEncryptionKey>?
  diskEncryptionKey;
  ...
  /// Structure is documented below.
  final pulumi.Input<List<RestoreWorkloadDiskRestorePropertiesGuestOsFeature>>?
  guestOsFeatures;
  ...
  /// Structure is documented below.
  final pulumi.Input<
    List<RestoreWorkloadDiskRestorePropertiesResourceManagerTag>
  >?
  resourceManagerTags;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'guestOsFeatures':
          ?pulumi.Input.mapOptionalInputValue<
            List<RestoreWorkloadDiskRestorePropertiesGuestOsFeature>,
      ...
      'labels':
          ?pulumi.Input.mapOptionalInputValue<
            List<RestoreWorkloadDiskRestorePropertiesLabel>,
            List<Map<String, dynamic>>
          >(
            labels,
            (value) =>
