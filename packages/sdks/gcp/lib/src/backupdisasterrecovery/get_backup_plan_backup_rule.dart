...
class GetBackupPlanBackupRule {
  ...
  factory GetBackupPlanBackupRule.fromMap(Map<String, dynamic> map) {
    return GetBackupPlanBackupRule(
      ...
      standardSchedules: (pulumi.Input.decodeList<GetBackupPlanBackupRuleStandardSchedule>(map['standardSchedules'], (value) => GetBackupPlanBackupRuleStandardSchedule.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
