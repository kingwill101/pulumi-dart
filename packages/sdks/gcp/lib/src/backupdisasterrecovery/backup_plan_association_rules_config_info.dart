...
class BackupPlanAssociationRulesConfigInfo {
  ...
  final pulumi.Input<List<BackupPlanAssociationRulesConfigInfoLastBackupError>>?
  lastBackupErrors;
    ...
    return <String, dynamic>{
      'lastBackupErrors':
          ?pulumi.Input.mapOptionalInputValue<
            List<BackupPlanAssociationRulesConfigInfoLastBackupError>,
  ...
  factory BackupPlanAssociationRulesConfigInfo.fromMap(
    ...
    return BackupPlanAssociationRulesConfigInfo(
      lastBackupErrors: (() {
        final guardedValue = map['lastBackupErrors'];
      ...
      lastBackupState: (() {
        final guardedValue = map['lastBackupState'];
        if (guardedValue == null) return null;
