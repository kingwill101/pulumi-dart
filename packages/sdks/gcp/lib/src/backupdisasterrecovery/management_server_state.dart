...
class ManagementServerState {
    ...
    return <String, dynamic>{
      ...
      'managementUris':
          ?pulumi.Input.mapOptionalInputValue<
            List<ManagementServerManagementUri>,
  ...
  factory ManagementServerState.fromMap(Map<String, dynamic> map) {
    return ManagementServerState(
      ...
      managementUris: (() {
        final guardedValue = map['managementUris'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ManagementServerManagementUri>(
            guardedValue,
            (value) => ManagementServerManagementUri.fromMap(
