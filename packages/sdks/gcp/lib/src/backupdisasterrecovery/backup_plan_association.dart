...
class BackupPlanAssociation extends pulumi.CustomResource {
  ...
  BackupPlanAssociation(
    ...
    this.backupPlanAssociationId = registerOutput<String>('backupPlanAssociationId');
    this.createTime = registerOutput<String>('createTime');
    this.dataSource = registerOutput<String>('dataSource');
    this.lastSuccessfulBackupConsistencyTime = registerOutput<String>('lastSuccessfulBackupConsistencyTime');
    this.location = registerOutput<String>('location');
    this.name = registerOutput<String>('name');
    this.project = registerOutput<String>('project');
    this.resource = registerOutput<String>('resource');
    this.resourceType = registerOutput<String>('resourceType');
    this.rulesConfigInfos = registerOutput<List<BackupPlanAssociationRulesConfigInfo>>('rulesConfigInfos');
