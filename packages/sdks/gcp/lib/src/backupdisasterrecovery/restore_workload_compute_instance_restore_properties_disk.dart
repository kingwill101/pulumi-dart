...
class RestoreWorkloadComputeInstanceRestorePropertiesDisk {
  ...
  factory RestoreWorkloadComputeInstanceRestorePropertiesDisk.fromMap(Map<String, dynamic> map) {
    return RestoreWorkloadComputeInstanceRestorePropertiesDisk(
      ...
      diskEncryptionKey: (() { final guardedValue = map['diskEncryptionKey']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RestoreWorkloadComputeInstanceRestorePropertiesDiskDiskEncryptionKey.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      guestOsFeatures: (() { final guardedValue = map['guestOsFeatures']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RestoreWorkloadComputeInstanceRestorePropertiesDiskGuestOsFeature>(guardedValue, (value) => RestoreWorkloadComputeInstanceRestorePropertiesDiskGuestOsFeature.fromMap((value as Map).cast<String, dynamic>()))); })(),
      index: (() { final guardedValue = map['index']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      initializeParams: (() { final guardedValue = map['initializeParams']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RestoreWorkloadComputeInstanceRestorePropertiesDiskInitializeParams.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      savedState: (() { final guardedValue = map['savedState']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
