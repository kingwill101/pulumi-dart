...
class BackupPlanBackupRuleStandardSchedule {
  ...
  factory BackupPlanBackupRuleStandardSchedule.fromMap(Map<String, dynamic> map) {
    return BackupPlanBackupRuleStandardSchedule(
      backupWindow: (() { final guardedValue = map['backupWindow']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BackupPlanBackupRuleStandardScheduleBackupWindow.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      hourlyFrequency: (() { final guardedValue = map['hourlyFrequency']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      ...
      weekDayOfMonth: (() { final guardedValue = map['weekDayOfMonth']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BackupPlanBackupRuleStandardScheduleWeekDayOfMonth.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
