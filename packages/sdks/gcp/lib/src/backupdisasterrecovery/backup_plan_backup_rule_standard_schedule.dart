...
class BackupPlanBackupRuleStandardSchedule {
  ...
  final pulumi.Input<BackupPlanBackupRuleStandardScheduleBackupWindow>?
  backupWindow;
  ...
  /// Structure is documented below.
  final pulumi.Input<BackupPlanBackupRuleStandardScheduleWeekDayOfMonth>?
  weekDayOfMonth;
    ...
    return <String, dynamic>{
      'backupWindow':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(backupWindow, (value) => value.toMap()),
  ...
  factory BackupPlanBackupRuleStandardSchedule.fromMap(
    ...
    return BackupPlanBackupRuleStandardSchedule(
      ...
      hourlyFrequency: (() {
        final guardedValue = map['hourlyFrequency'];
        if (guardedValue == null) return null;
      ...
      weekDayOfMonth: (() {
        final guardedValue = map['weekDayOfMonth'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
