...
class GetBackupPlanBackupRuleStandardSchedule {
  ...
  final pulumi.Input<List<GetBackupPlanBackupRuleStandardScheduleBackupWindow>>
  backupWindows;
  ...
  final pulumi.Input<
    List<GetBackupPlanBackupRuleStandardScheduleWeekDayOfMonth>
  >
  weekDayOfMonths;
    ...
    return <String, dynamic>{
      'backupWindows':
          pulumi.Input.mapInputValue<
            List<GetBackupPlanBackupRuleStandardScheduleBackupWindow>,
  ...
  factory GetBackupPlanBackupRuleStandardSchedule.fromMap(
    ...
    return GetBackupPlanBackupRuleStandardSchedule(
      backupWindows: pulumi.Input.fromValue(
      ...
      weekDayOfMonths: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetBackupPlanBackupRuleStandardScheduleWeekDayOfMonth
        >(
          map['weekDayOfMonths']!,
