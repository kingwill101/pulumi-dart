...
class GetBackupPlanBackupRuleStandardSchedule {
  ...
  factory GetBackupPlanBackupRuleStandardSchedule.fromMap(Map<String, dynamic> map) {
    return GetBackupPlanBackupRuleStandardSchedule(
      backupWindows: (pulumi.Input.decodeList<GetBackupPlanBackupRuleStandardScheduleBackupWindow>(map['backupWindows'], (value) => GetBackupPlanBackupRuleStandardScheduleBackupWindow.fromMap((value as Map).cast<String, dynamic>()))).input(),
      daysOfMonths: ((map['daysOfMonths'] as List).cast<int>()).input(),
      daysOfWeeks: ((map['daysOfWeeks'] as List).cast<String>()).input(),
      hourlyFrequency: (map['hourlyFrequency'] as int).input(),
      months: ((map['months'] as List).cast<String>()).input(),
      recurrenceType: (map['recurrenceType'] as String).input(),
      timeZone: (map['timeZone'] as String).input(),
      weekDayOfMonths: (pulumi.Input.decodeList<GetBackupPlanBackupRuleStandardScheduleWeekDayOfMonth>(map['weekDayOfMonths'], (value) => GetBackupPlanBackupRuleStandardScheduleWeekDayOfMonth.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
