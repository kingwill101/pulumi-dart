...
class GetBackupPlanDiskBackupPlanProperty {
  ...
  /// Creates a new [GetBackupPlanDiskBackupPlanProperty].
  /// [guestFlush] Indicates whether to perform a guest flush operation before taking a disk
  const GetBackupPlanDiskBackupPlanProperty({
  ...
  factory GetBackupPlanDiskBackupPlanProperty.fromMap(Map<String, dynamic> map) {
    return GetBackupPlanDiskBackupPlanProperty(
