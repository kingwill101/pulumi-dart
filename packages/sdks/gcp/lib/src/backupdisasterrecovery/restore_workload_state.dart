...
class RestoreWorkloadState {
  ...
  factory RestoreWorkloadState.fromMap(Map<String, dynamic> map) {
    return RestoreWorkloadState(
      ...
      targetResources: (() { final guardedValue = map['targetResources']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RestoreWorkloadTargetResource>(guardedValue, (value) => RestoreWorkloadTargetResource.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
