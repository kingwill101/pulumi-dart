...
class GetDataSourcesDataSourceBackupConfigInfoGcpBackupConfig {
  ...
  /// Creates a new [GetDataSourcesDataSourceBackupConfigInfoGcpBackupConfig].
  ...
  const GetDataSourcesDataSourceBackupConfigInfoGcpBackupConfig({
  ...
  factory GetDataSourcesDataSourceBackupConfigInfoGcpBackupConfig.fromMap(Map<String, dynamic> map) {
    return GetDataSourcesDataSourceBackupConfigInfoGcpBackupConfig(
