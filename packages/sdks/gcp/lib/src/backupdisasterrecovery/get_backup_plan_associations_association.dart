...
class GetBackupPlanAssociationsAssociation {
  ...
  final pulumi.Input<List<GetBackupPlanAssociationsAssociationRulesConfigInfo>>
  rulesConfigInfos;
    ...
    return <String, dynamic>{
      ...
      'rulesConfigInfos':
          pulumi.Input.mapInputValue<
            List<GetBackupPlanAssociationsAssociationRulesConfigInfo>,
  ...
  factory GetBackupPlanAssociationsAssociation.fromMap(
    ...
    return GetBackupPlanAssociationsAssociation(
      ...
      rulesConfigInfos: pulumi.Input.fromValue(
