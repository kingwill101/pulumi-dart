...
class SessionTemplateEnvironmentConfig {
  ...
  factory SessionTemplateEnvironmentConfig.fromMap(Map<String, dynamic> map) {
    return SessionTemplateEnvironmentConfig(
      executionConfig: (() { final guardedValue = map['executionConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SessionTemplateEnvironmentConfigExecutionConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      peripheralsConfig: (() { final guardedValue = map['peripheralsConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SessionTemplateEnvironmentConfigPeripheralsConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
