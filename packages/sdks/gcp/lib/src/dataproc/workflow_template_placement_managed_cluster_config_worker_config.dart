...
class WorkflowTemplatePlacementManagedClusterConfigWorkerConfig {
  ...
  final pulumi.Input<
    List<WorkflowTemplatePlacementManagedClusterConfigWorkerConfigAccelerator>
  >?
  accelerators;
  ...
  factory WorkflowTemplatePlacementManagedClusterConfigWorkerConfig.fromMap(
    ...
    return WorkflowTemplatePlacementManagedClusterConfigWorkerConfig(
      accelerators: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                WorkflowTemplatePlacementManagedClusterConfigWorkerConfigAccelerator.fromMap(
      ...
      diskConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          WorkflowTemplatePlacementManagedClusterConfigWorkerConfigDiskConfig.fromMap(
      ...
      managedGroupConfigs: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                WorkflowTemplatePlacementManagedClusterConfigWorkerConfigManagedGroupConfig.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
