...
import 'session_template_state.dart';
...
class SessionTemplate extends pulumi.CustomResource {
  ...
  SessionTemplate(
    ...
    this.environmentConfig = registerOutput<SessionTemplateEnvironmentConfig?>('environmentConfig');
    this.jupyterSession = registerOutput<SessionTemplateJupyterSession?>('jupyterSession');
    this.labels = registerOutput<Map<String, String>?>('labels');
    this.location = registerOutput<String?>('location');
    this.name = registerOutput<String>('name');
    this.project = registerOutput<String>('project');
    this.pulumiLabels = registerOutput<Map<String, String>>('pulumiLabels');
    this.runtimeConfig = registerOutput<SessionTemplateRuntimeConfig?>('runtimeConfig');
    this.sparkConnectSession = registerOutput<Map<String, dynamic>?>('sparkConnectSession');
    this.updateTime = registerOutput<String>('updateTime');
    this.uuid = registerOutput<String>('uuid');
  }

  /// Gets an existing [SessionTemplate] resource's state with the given [name] and [id].
  static SessionTemplate get(
    String name,
