...
class BatchRuntimeInfoCurrentUsage {
  ...
  factory BatchRuntimeInfoCurrentUsage.fromMap(Map<String, dynamic> map) {
    return BatchRuntimeInfoCurrentUsage(
      ...
      milliAccelerator: (() {
        final guardedValue = map['milliAccelerator'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      milliDcu: (() {
        final guardedValue = map['milliDcu'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      milliDcuPremium: (() {
        final guardedValue = map['milliDcuPremium'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      shuffleStorageGb: (() {
        final guardedValue = map['shuffleStorageGb'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      shuffleStorageGbPremium: (() {
        final guardedValue = map['shuffleStorageGbPremium'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      snapshotTime: (() {
