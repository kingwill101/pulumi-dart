...
class WorkflowTemplateJobPysparkJob {
  ...
  const WorkflowTemplateJobPysparkJob({
    this.archiveUris,
    this.args,
    this.fileUris,
    this.jarFileUris,
  ...
  factory WorkflowTemplateJobPysparkJob.fromMap(Map<String, dynamic> map) {
    return WorkflowTemplateJobPysparkJob(
      ...
      loggingConfig: (() { final guardedValue = map['loggingConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WorkflowTemplateJobPysparkJobLoggingConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
