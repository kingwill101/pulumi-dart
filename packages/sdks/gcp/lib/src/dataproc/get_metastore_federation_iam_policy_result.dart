...
class GetMetastoreFederationIamPolicyResult {
  ...
  /// [project] Optional.
  const GetMetastoreFederationIamPolicyResult({
    this.etag,
    this.federationId,
    this.id,
    this.location,
  ...
  factory GetMetastoreFederationIamPolicyResult.fromMap(Map<String, dynamic> map) {
    return GetMetastoreFederationIamPolicyResult(
      ...
      federationId: (() { final guardedValue = map['federationId']; if (guardedValue == null) return null; return guardedValue as String; })(),
