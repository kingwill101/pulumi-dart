...
class MetastoreServiceHiveMetastoreConfig {
  ...
  final pulumi.Input<List<MetastoreServiceHiveMetastoreConfigAuxiliaryVersion>>?
  auxiliaryVersions;
  ...
  /// Structure is documented below.
  final pulumi.Input<MetastoreServiceHiveMetastoreConfigKerberosConfig>?
  kerberosConfig;
    ...
    return <String, dynamic>{
      'auxiliaryVersions':
          ?pulumi.Input.mapOptionalInputValue<
            List<MetastoreServiceHiveMetastoreConfigAuxiliaryVersion>,
