...
class WorkflowTemplatePlacement {
  ...
  factory WorkflowTemplatePlacement.fromMap(Map<String, dynamic> map) {
    return WorkflowTemplatePlacement(
      clusterSelector: (() { final guardedValue = map['clusterSelector']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WorkflowTemplatePlacementClusterSelector.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      managedCluster: (() { final guardedValue = map['managedCluster']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WorkflowTemplatePlacementManagedCluster.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
