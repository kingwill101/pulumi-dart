...
class MetastoreServiceIamMemberState {
  ...
  /// Creates a new [MetastoreServiceIamMemberState].
  /// [condition] Optional.
  ...
  const MetastoreServiceIamMemberState({
    this.condition,
    this.etag,
    this.location,
    this.member,
  ...
  factory MetastoreServiceIamMemberState.fromMap(Map<String, dynamic> map) {
    return MetastoreServiceIamMemberState(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MetastoreServiceIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
