...
class MetastoreDatabaseIamMemberState {
  ...
  /// Creates a new [MetastoreDatabaseIamMemberState].
  /// [condition] Optional.
  ...
  factory MetastoreDatabaseIamMemberState.fromMap(Map<String, dynamic> map) {
    return MetastoreDatabaseIamMemberState(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MetastoreDatabaseIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
