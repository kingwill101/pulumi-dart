...
class ClusterIAMBindingState {
  ...
  factory ClusterIAMBindingState.fromMap(Map<String, dynamic> map) {
    return ClusterIAMBindingState(
      ...
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterIAMBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
