...
class WorkflowTemplateParameter {
  ...
  const WorkflowTemplateParameter({
    this.description,
  ...
  factory WorkflowTemplateParameter.fromMap(Map<String, dynamic> map) {
    return WorkflowTemplateParameter(
      ...
      validation: (() { final guardedValue = map['validation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WorkflowTemplateParameterValidation.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
