...
import 'metastore_federation_iam_member_condition.dart';

/// Input properties used for looking up and filtering MetastoreFederationIamMember resources.
class MetastoreFederationIamMemberState {
  final pulumi.Input<MetastoreFederationIamMemberCondition>? condition;
  ...
  /// Creates a new [MetastoreFederationIamMemberState].
  /// [condition] Optional.
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'condition': ?pulumi.Input.mapOptionalInputValue<MetastoreFederationIamMemberCondition, Map<String, dynamic>>(condition, (value) => value.toMap()),
      'etag': ?etag,
  ...
  factory MetastoreFederationIamMemberState.fromMap(Map<String, dynamic> map) {
    return MetastoreFederationIamMemberState(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MetastoreFederationIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
