...
import 'metastore_federation_iam_policy_state.dart';
...
class MetastoreFederationIamPolicy extends pulumi.CustomResource {
  ...
  /// Gets an existing [MetastoreFederationIamPolicy] resource's state with the given [name] and [id].
  static MetastoreFederationIamPolicy get(
    String name,
    pulumi.Input<String> id, {
    MetastoreFederationIamPolicyState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return MetastoreFederationIamPolicy._get(
      name,
      state: state?.toMap(),
  ...
  MetastoreFederationIamPolicy._get(
    String name, {
  ...
  /// Creates a typed reference to an existing [MetastoreFederationIamPolicy] resource.
  MetastoreFederationIamPolicy.reference(String urn)
    : super(
        'gcp:dataproc/metastoreFederationIamPolicy:MetastoreFederationIamPolicy',
