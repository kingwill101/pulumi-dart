...
class GdcSparkApplicationState {
  ...
  factory GdcSparkApplicationState.fromMap(Map<String, dynamic> map) {
    return GdcSparkApplicationState(
      ...
      monitoringEndpoint: map['monitoringEndpoint'] == null ? null : (map['monitoringEndpoint']! as String).input(),
      ...
      sparkApplicationId: map['sparkApplicationId'] == null ? null : (map['sparkApplicationId']! as String).input(),
