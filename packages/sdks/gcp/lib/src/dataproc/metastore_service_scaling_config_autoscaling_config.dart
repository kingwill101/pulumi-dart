...
class MetastoreServiceScalingConfigAutoscalingConfig {
  ...
  final pulumi.Input<MetastoreServiceScalingConfigAutoscalingConfigLimitConfig>?
  limitConfig;
  ...
  factory MetastoreServiceScalingConfigAutoscalingConfig.fromMap(
    ...
    return MetastoreServiceScalingConfigAutoscalingConfig(
      ...
      autoscalingFactor: (() {
        final guardedValue = map['autoscalingFactor'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as double);
      })(),
      limitConfig: (() {
        final guardedValue = map['limitConfig'];
        if (guardedValue == null) return null;
