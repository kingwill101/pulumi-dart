...
class MetastoreTableIamBindingState {
  ...
  const MetastoreTableIamBindingState({
    this.condition,
    this.databaseId,
    this.etag,
    this.location,
  ...
  factory MetastoreTableIamBindingState.fromMap(Map<String, dynamic> map) {
    return MetastoreTableIamBindingState(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MetastoreTableIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
