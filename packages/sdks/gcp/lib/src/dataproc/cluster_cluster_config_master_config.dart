...
class ClusterClusterConfigMasterConfig {
  ...
  final pulumi.Input<List<ClusterClusterConfigMasterConfigAccelerator>>?
  accelerators;
    ...
    return <String, dynamic>{
      'accelerators':
          ?pulumi.Input.mapOptionalInputValue<
            List<ClusterClusterConfigMasterConfigAccelerator>,
    ...
    return ClusterClusterConfigMasterConfig(
      accelerators: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ClusterClusterConfigMasterConfigAccelerator>(
            guardedValue,
