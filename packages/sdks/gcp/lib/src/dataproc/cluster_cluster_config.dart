...
class ClusterClusterConfig {
  ...
  /// Structure defined below.
  final pulumi.Input<List<ClusterClusterConfigAuxiliaryNodeGroup>>?
  auxiliaryNodeGroups;
  ...
  /// Structure defined below.
  final pulumi.Input<ClusterClusterConfigDataprocMetricConfig>?
  ...
  final pulumi.Input<List<ClusterClusterConfigInitializationAction>>?
  ...
  final pulumi.Input<ClusterClusterConfigPreemptibleWorkerConfig>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'auxiliaryNodeGroups':
          ?pulumi.Input.mapOptionalInputValue<
            List<ClusterClusterConfigAuxiliaryNodeGroup>,
      ...
      'initializationActions':
          ?pulumi.Input.mapOptionalInputValue<
            List<ClusterClusterConfigInitializationAction>,
            List<Map<String, dynamic>>
          >(
            initializationActions,
            (value) =>
      ...
      'preemptibleWorkerConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(preemptibleWorkerConfig, (value) => value.toMap()),
      'securityConfig':
          ?pulumi.Input.mapOptionalInputValue<
  ...
  factory ClusterClusterConfig.fromMap(Map<String, dynamic> map) {
    return ClusterClusterConfig(
      ...
      preemptibleWorkerConfig: (() {
        final guardedValue = map['preemptibleWorkerConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
