...
class WorkflowTemplateJobPigJob {
  ...
  factory WorkflowTemplateJobPigJob.fromMap(Map<String, dynamic> map) {
    return WorkflowTemplateJobPigJob(
      ...
      loggingConfig: (() { final guardedValue = map['loggingConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WorkflowTemplateJobPigJobLoggingConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      queryList: (() { final guardedValue = map['queryList']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WorkflowTemplateJobPigJobQueryList.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
