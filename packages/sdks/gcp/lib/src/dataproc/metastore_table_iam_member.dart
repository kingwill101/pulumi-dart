...
import 'metastore_table_iam_member_args.dart';
import 'metastore_table_iam_member_condition.dart';
import 'metastore_table_iam_member_state.dart';
...
/// }
///
/// resource "gcp_dataproc_metastoretableiampolicy" "policy" {
///   project     = dpmsService.project
///   location    = dpmsService.location
...
/// }
///
/// resource "gcp_dataproc_metastoretableiambinding" "binding" {
///   project     = dpmsService.project
///   location    = dpmsService.location
///   service_id  = dpmsService.serviceId
///   database_id = hive.hiveConfig[0].properties["database"]
...
/// }
///
/// resource "gcp_dataproc_metastoretableiammember" "member" {
///   project     = dpmsService.project
///   location    = dpmsService.location
///   service_id  = dpmsService.serviceId
///   database_id = hive.hiveConfig[0].properties["database"]
...
class MetastoreTableIamMember extends pulumi.CustomResource {
  late final pulumi.Output<MetastoreTableIamMemberCondition?> condition;
  ...
  /// Creates a new [MetastoreTableIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [MetastoreTableIamMember]. {@macro pulumi_dataproc_metastore_table_iam_member_metastore_table_iam_member_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  MetastoreTableIamMember(
    String name, {
    MetastoreTableIamMemberArgs? args,
  ...
  /// Gets an existing [MetastoreTableIamMember] resource's state with the given [name] and [id].
  static MetastoreTableIamMember get(
    String name,
