...
import 'workflow_template_job_spark_job_logging_config.dart';

class WorkflowTemplateJobSparkJob {
  ...
  /// Creates a new [WorkflowTemplateJobSparkJob].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'loggingConfig': ?pulumi.Input.mapOptionalInputValue<WorkflowTemplateJobSparkJobLoggingConfig, Map<String, dynamic>>(loggingConfig, (value) => value.toMap()),
      'mainClass': ?mainClass,
  ...
  factory WorkflowTemplateJobSparkJob.fromMap(Map<String, dynamic> map) {
    return WorkflowTemplateJobSparkJob(
      ...
      loggingConfig: (() { final guardedValue = map['loggingConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WorkflowTemplateJobSparkJobLoggingConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
