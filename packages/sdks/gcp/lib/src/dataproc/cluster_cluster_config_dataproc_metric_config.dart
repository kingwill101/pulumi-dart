...
class ClusterClusterConfigDataprocMetricConfig {
  ...
  final pulumi.Input<List<ClusterClusterConfigDataprocMetricConfigMetric>>
  metrics;
    ...
    return <String, dynamic>{
      'metrics':
          pulumi.Input.mapInputValue<
            List<ClusterClusterConfigDataprocMetricConfigMetric>,
  ...
  factory ClusterClusterConfigDataprocMetricConfig.fromMap(
    ...
    return ClusterClusterConfigDataprocMetricConfig(
      metrics: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ClusterClusterConfigDataprocMetricConfigMetric>(
          map['metrics']!,
