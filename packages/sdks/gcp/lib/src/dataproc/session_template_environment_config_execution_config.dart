...
class SessionTemplateEnvironmentConfigExecutionConfig {
  ...
  final pulumi.Input<SessionTemplateEnvironmentConfigExecutionConfigAuthenticationConfig>? authenticationConfig;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'authenticationConfig': ?pulumi.Input.mapOptionalInputValue<SessionTemplateEnvironmentConfigExecutionConfigAuthenticationConfig, Map<String, dynamic>>(authenticationConfig, (value) => value.toMap()),
      'idleTtl': ?idleTtl,
      'kmsKey': ?kmsKey,
  ...
  factory SessionTemplateEnvironmentConfigExecutionConfig.fromMap(Map<String, dynamic> map) {
    return SessionTemplateEnvironmentConfigExecutionConfig(
      authenticationConfig: (() { final guardedValue = map['authenticationConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SessionTemplateEnvironmentConfigExecutionConfigAuthenticationConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      idleTtl: (() { final guardedValue = map['idleTtl']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
