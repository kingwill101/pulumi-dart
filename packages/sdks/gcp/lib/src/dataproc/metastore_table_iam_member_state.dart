...
class MetastoreTableIamMemberState {
  ...
  factory MetastoreTableIamMemberState.fromMap(Map<String, dynamic> map) {
    return MetastoreTableIamMemberState(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MetastoreTableIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
