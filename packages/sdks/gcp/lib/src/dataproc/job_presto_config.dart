...
class JobPrestoConfig {
  ...
  factory JobPrestoConfig.fromMap(Map<String, dynamic> map) {
    return JobPrestoConfig(
      ...
      loggingConfig: (() { final guardedValue = map['loggingConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(JobPrestoConfigLoggingConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
