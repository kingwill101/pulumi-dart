...
import 'job_iammember_state.dart';
...
class JobIAMMember extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [JobIAMMember]. {@macro pulumi_dataproc_job_iammember_job_iammember_args_doc}
  ...
  /// Creates a typed reference to an existing [JobIAMMember] resource.
  JobIAMMember.reference(String urn)
    : super(
        'gcp:dataproc/jobIAMMember:JobIAMMember',
