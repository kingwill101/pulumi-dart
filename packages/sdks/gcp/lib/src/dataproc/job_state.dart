  ...
  factory JobState.fromMap(Map<String, dynamic> map) {
    return JobState(
      driverControlsFilesUri: (() {
        final guardedValue = map['driverControlsFilesUri'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      driverOutputResourceUri: (() {
        final guardedValue = map['driverOutputResourceUri'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      effectiveLabels: (() {
      ...
      placement: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          JobPlacement.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      prestoConfig: (() {
