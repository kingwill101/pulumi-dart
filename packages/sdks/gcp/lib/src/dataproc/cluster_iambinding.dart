...
import 'cluster_iambinding_state.dart';
...
class ClusterIAMBinding extends pulumi.CustomResource {
  ...
  /// Creates a new [ClusterIAMBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ClusterIAMBinding]. {@macro pulumi_dataproc_cluster_iambinding_cluster_iambinding_args_doc}
  ...
  /// Gets an existing [ClusterIAMBinding] resource's state with the given [name] and [id].
  static ClusterIAMBinding get(
    String name,
    pulumi.Input<String> id, {
    ClusterIAMBindingState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return ClusterIAMBinding._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [ClusterIAMBinding] resource.
  ClusterIAMBinding.reference(String urn)
    : super(
        'gcp:dataproc/clusterIAMBinding:ClusterIAMBinding',
