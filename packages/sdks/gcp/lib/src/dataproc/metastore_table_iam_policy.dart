...
import 'metastore_table_iam_policy_state.dart';
...
class MetastoreTableIamPolicy extends pulumi.CustomResource {
  ...
  /// Creates a new [MetastoreTableIamPolicy].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [MetastoreTableIamPolicy]. {@macro pulumi_dataproc_metastore_table_iam_policy_metastore_table_iam_policy_args_doc}
  ...
  /// Gets an existing [MetastoreTableIamPolicy] resource's state with the given [name] and [id].
  static MetastoreTableIamPolicy get(
    String name,
