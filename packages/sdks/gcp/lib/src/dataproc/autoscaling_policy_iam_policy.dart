...
import 'autoscaling_policy_iam_policy_state.dart';
...
class AutoscalingPolicyIamPolicy extends pulumi.CustomResource {
  ...
  /// Gets an existing [AutoscalingPolicyIamPolicy] resource's state with the given [name] and [id].
  static AutoscalingPolicyIamPolicy get(
    String name,
    pulumi.Input<String> id, {
    AutoscalingPolicyIamPolicyState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return AutoscalingPolicyIamPolicy._get(
      name,
      state: state?.toMap(),
  ...
  AutoscalingPolicyIamPolicy._get(
    String name, {
  ...
  /// Creates a typed reference to an existing [AutoscalingPolicyIamPolicy] resource.
  AutoscalingPolicyIamPolicy.reference(String urn)
    : super(
        'gcp:dataproc/autoscalingPolicyIamPolicy:AutoscalingPolicyIamPolicy',
