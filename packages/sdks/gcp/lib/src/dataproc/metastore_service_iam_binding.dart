...
import 'metastore_service_iam_binding_args.dart';
import 'metastore_service_iam_binding_condition.dart';
import 'metastore_service_iam_binding_state.dart';
...
class MetastoreServiceIamBinding extends pulumi.CustomResource {
  late final pulumi.Output<MetastoreServiceIamBindingCondition?> condition;
  ...
  /// Creates a new [MetastoreServiceIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [MetastoreServiceIamBinding]. {@macro pulumi_dataproc_metastore_service_iam_binding_metastore_service_iam_binding_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  MetastoreServiceIamBinding(
    String name, {
    MetastoreServiceIamBindingArgs? args,
    ...
    condition = registerOutput<MetastoreServiceIamBindingCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return MetastoreServiceIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [MetastoreServiceIamBinding] resource's state with the given [name] and [id].
  static MetastoreServiceIamBinding get(
    String name,
    pulumi.Input<String> id, {
    MetastoreServiceIamBindingState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return MetastoreServiceIamBinding._get(
      name,
      state: state?.toMap(),
  ...
  MetastoreServiceIamBinding._get(
    String name, {
  ...
  /// Creates a typed reference to an existing [MetastoreServiceIamBinding] resource.
  MetastoreServiceIamBinding.reference(String urn)
    : super(
        'gcp:dataproc/metastoreServiceIamBinding:MetastoreServiceIamBinding',
