...
class ClusterClusterConfigPreemptibleWorkerConfigDiskConfigAttachedDiskConfig {
  ...
  /// Creates a new [ClusterClusterConfigPreemptibleWorkerConfigDiskConfigAttachedDiskConfig].
  ...
  const ClusterClusterConfigPreemptibleWorkerConfigDiskConfigAttachedDiskConfig({
    this.diskSizeGb,
    this.diskType,
  ...
  factory ClusterClusterConfigPreemptibleWorkerConfigDiskConfigAttachedDiskConfig.fromMap(Map<String, dynamic> map) {
    return ClusterClusterConfigPreemptibleWorkerConfigDiskConfigAttachedDiskConfig(
