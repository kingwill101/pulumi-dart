  ...
  factory GdcServiceInstanceState.fromMap(Map<String, dynamic> map) {
    return GdcServiceInstanceState(
      ...
      effectiveServiceAccount: (() {
        final guardedValue = map['effectiveServiceAccount'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      gdceCluster: (() {
        final guardedValue = map['gdceCluster'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      serviceInstanceId: (() {
        final guardedValue = map['serviceInstanceId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      sparkServiceInstanceConfig: (() {
        final guardedValue = map['sparkServiceInstanceConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as Map).cast<String, dynamic>(),
        );
