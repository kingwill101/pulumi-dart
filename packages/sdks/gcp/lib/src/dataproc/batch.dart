...
class Batch extends pulumi.CustomResource {
  ...
  Batch(
    ...
    this.environmentConfig = registerOutput<BatchEnvironmentConfig?>('environmentConfig');
    ...
    this.stateHistories = registerOutput<List<BatchStateHistory>>('stateHistories');
