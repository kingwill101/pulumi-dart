...
class MetastoreFederationIamBindingState {
  ...
  /// Creates a new [MetastoreFederationIamBindingState].
  /// [condition] Optional.
  ...
  const MetastoreFederationIamBindingState({
    this.condition,
    this.etag,
    this.federationId,
    this.location,
  ...
  factory MetastoreFederationIamBindingState.fromMap(Map<String, dynamic> map) {
    return MetastoreFederationIamBindingState(
