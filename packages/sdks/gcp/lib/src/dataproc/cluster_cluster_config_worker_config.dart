...
import 'cluster_cluster_config_worker_config_instance_flexibility_policy.dart';
...
class ClusterClusterConfigWorkerConfig {
  ...
  final pulumi.Input<ClusterClusterConfigWorkerConfigInstanceFlexibilityPolicy?>? instanceFlexibilityPolicy;
  ...
  /// [minNumInstances] The minimum number of primary worker instances to create.  If `minNumInstances` is set, cluster creation will succeed if the number of primary workers created is at least equal to the `minNumInstances` number.
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'imageUri': ?imageUri,
      'instanceFlexibilityPolicy': ?pulumi.Input.mapOptionalInputValue<ClusterClusterConfigWorkerConfigInstanceFlexibilityPolicy, Map<String, dynamic>>(instanceFlexibilityPolicy, (value) => value.toMap()),
  ...
  factory ClusterClusterConfigWorkerConfig.fromMap(Map<String, dynamic> map) {
    return ClusterClusterConfigWorkerConfig(
      ...
      instanceFlexibilityPolicy: (() { final guardedValue = map['instanceFlexibilityPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterClusterConfigWorkerConfigInstanceFlexibilityPolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      minNumInstances: (() { final guardedValue = map['minNumInstances']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
