...
class ClusterClusterConfigWorkerConfig {
  ...
  final pulumi.Input<List<ClusterClusterConfigWorkerConfigAccelerator>>?
  accelerators;
    ...
    return <String, dynamic>{
      'accelerators':
          ?pulumi.Input.mapOptionalInputValue<
            List<ClusterClusterConfigWorkerConfigAccelerator>,
    ...
    return ClusterClusterConfigWorkerConfig(
      accelerators: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ClusterClusterConfigWorkerConfigAccelerator>(
            guardedValue,
