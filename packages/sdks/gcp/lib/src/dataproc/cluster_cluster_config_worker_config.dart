...
class ClusterClusterConfigWorkerConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'accelerators': ?accelerators == null ? null : pulumi.Input.encodeList<ClusterClusterConfigWorkerConfigAccelerator, Map<String, dynamic>>(accelerators!, (value) => value.toMap()),
  ...
  factory ClusterClusterConfigWorkerConfig.fromMap(Map<String, dynamic> map) {
    return ClusterClusterConfigWorkerConfig(
      accelerators: map['accelerators'] == null ? null : pulumi.Input.decodeList<ClusterClusterConfigWorkerConfigAccelerator>(map['accelerators'], (value) => ClusterClusterConfigWorkerConfigAccelerator.fromMap((value as Map).cast<String, dynamic>())),
      diskConfig: map['diskConfig'] == null ? null : ClusterClusterConfigWorkerConfigDiskConfig.fromMap((map['diskConfig'] as Map).cast<String, dynamic>()),
