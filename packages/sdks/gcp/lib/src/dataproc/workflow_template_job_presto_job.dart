...
class WorkflowTemplateJobPrestoJob {
  ...
  factory WorkflowTemplateJobPrestoJob.fromMap(Map<String, dynamic> map) {
    return WorkflowTemplateJobPrestoJob(
      ...
      loggingConfig: (() { final guardedValue = map['loggingConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WorkflowTemplateJobPrestoJobLoggingConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      queryList: (() { final guardedValue = map['queryList']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WorkflowTemplateJobPrestoJobQueryList.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
