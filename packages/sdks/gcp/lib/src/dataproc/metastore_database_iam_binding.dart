...
import 'metastore_database_iam_binding_args.dart';
import 'metastore_database_iam_binding_condition.dart';
import 'metastore_database_iam_binding_state.dart';
...
class MetastoreDatabaseIamBinding extends pulumi.CustomResource {
  late final pulumi.Output<MetastoreDatabaseIamBindingCondition?> condition;
  ...
  /// Creates a new [MetastoreDatabaseIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [MetastoreDatabaseIamBinding]. {@macro pulumi_dataproc_metastore_database_iam_binding_metastore_database_iam_binding_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  MetastoreDatabaseIamBinding(
    String name, {
    MetastoreDatabaseIamBindingArgs? args,
    ...
    condition = registerOutput<MetastoreDatabaseIamBindingCondition?>(
      'condition',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return MetastoreDatabaseIamBindingCondition.fromMap(
  ...
  /// Gets an existing [MetastoreDatabaseIamBinding] resource's state with the given [name] and [id].
  static MetastoreDatabaseIamBinding get(
    String name,
  ...
  MetastoreDatabaseIamBinding._get(
    String name, {
