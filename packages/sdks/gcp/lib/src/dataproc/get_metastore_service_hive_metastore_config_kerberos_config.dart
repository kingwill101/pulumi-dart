...
class GetMetastoreServiceHiveMetastoreConfigKerberosConfig {
  ...
  final pulumi.Input<List<GetMetastoreServiceHiveMetastoreConfigKerberosConfigKeytab>> keytabs;
  ...
  const GetMetastoreServiceHiveMetastoreConfigKerberosConfig({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'keytabs': pulumi.Input.mapInputValue<List<GetMetastoreServiceHiveMetastoreConfigKerberosConfigKeytab>, List<Map<String, dynamic>>>(keytabs, (value) => pulumi.Input.encodeList<GetMetastoreServiceHiveMetastoreConfigKerberosConfigKeytab, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory GetMetastoreServiceHiveMetastoreConfigKerberosConfig.fromMap(Map<String, dynamic> map) {
    return GetMetastoreServiceHiveMetastoreConfigKerberosConfig(
      keytabs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetMetastoreServiceHiveMetastoreConfigKerberosConfigKeytab>(map['keytabs']!, (value) => GetMetastoreServiceHiveMetastoreConfigKerberosConfigKeytab.fromMap((value as Map).cast<String, dynamic>()))),
