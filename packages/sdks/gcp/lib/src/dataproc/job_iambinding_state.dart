...
class JobIAMBindingState {
  ...
  factory JobIAMBindingState.fromMap(Map<String, dynamic> map) {
    return JobIAMBindingState(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(JobIAMBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
