...
class BatchRuntimeInfo {
  ...
  factory BatchRuntimeInfo.fromMap(Map<String, dynamic> map) {
    return BatchRuntimeInfo(
      approximateUsages: (() { final guardedValue = map['approximateUsages']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<BatchRuntimeInfoApproximateUsage>(guardedValue, (value) => BatchRuntimeInfoApproximateUsage.fromMap((value as Map).cast<String, dynamic>()))); })(),
      currentUsages: (() { final guardedValue = map['currentUsages']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<BatchRuntimeInfoCurrentUsage>(guardedValue, (value) => BatchRuntimeInfoCurrentUsage.fromMap((value as Map).cast<String, dynamic>()))); })(),
      diagnosticOutputUri: (() { final guardedValue = map['diagnosticOutputUri']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
