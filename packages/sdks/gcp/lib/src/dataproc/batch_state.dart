...
class BatchState {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'runtimeInfos':
          ?pulumi.Input.mapOptionalInputValue<
            List<BatchRuntimeInfo>,
            List<Map<String, dynamic>>
          >(
            runtimeInfos,
            (value) =>
                pulumi.Input.encodeList<BatchRuntimeInfo, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory BatchState.fromMap(Map<String, dynamic> map) {
    return BatchState(
      ...
      runtimeInfos: (() {
        final guardedValue = map['runtimeInfos'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<BatchRuntimeInfo>(
            guardedValue,
            (value) => BatchRuntimeInfo.fromMap(
      ...
      stateHistories: (() {
        final guardedValue = map['stateHistories'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<BatchStateHistory>(
            guardedValue,
            (value) => BatchStateHistory.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      stateTime: (() {
        final guardedValue = map['stateTime'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      uuid: (() {
