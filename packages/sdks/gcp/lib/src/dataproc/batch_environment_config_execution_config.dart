...
class BatchEnvironmentConfigExecutionConfig {
  ...
  factory BatchEnvironmentConfigExecutionConfig.fromMap(Map<String, dynamic> map) {
    return BatchEnvironmentConfigExecutionConfig(
      authenticationConfig: (() { final guardedValue = map['authenticationConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BatchEnvironmentConfigExecutionConfigAuthenticationConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
