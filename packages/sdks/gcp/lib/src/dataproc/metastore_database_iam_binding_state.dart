...
class MetastoreDatabaseIamBindingState {
  ...
  const MetastoreDatabaseIamBindingState({
    this.condition,
    this.database,
    this.etag,
    this.location,
  ...
  factory MetastoreDatabaseIamBindingState.fromMap(Map<String, dynamic> map) {
    return MetastoreDatabaseIamBindingState(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MetastoreDatabaseIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
