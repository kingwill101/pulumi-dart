...
class MetastoreServiceIamBindingState {
  ...
  factory MetastoreServiceIamBindingState.fromMap(Map<String, dynamic> map) {
    return MetastoreServiceIamBindingState(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MetastoreServiceIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
