...
import 'autoscaling_policy_iam_member_state.dart';
...
class AutoscalingPolicyIamMember extends pulumi.CustomResource {
  late final pulumi.Output<AutoscalingPolicyIamMemberCondition?> condition;
  ...
  /// Creates a new [AutoscalingPolicyIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [AutoscalingPolicyIamMember]. {@macro pulumi_dataproc_autoscaling_policy_iam_member_autoscaling_policy_iam_member_args_doc}
  ...
  AutoscalingPolicyIamMember(
    ...
    this.condition = registerOutput<AutoscalingPolicyIamMemberCondition?>('condition');
  ...
  /// Gets an existing [AutoscalingPolicyIamMember] resource's state with the given [name] and [id].
  static AutoscalingPolicyIamMember get(
    String name,
  ...
  AutoscalingPolicyIamMember._get(
    String name, {
