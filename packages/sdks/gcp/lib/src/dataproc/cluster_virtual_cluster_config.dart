...
class ClusterVirtualClusterConfig {
  ...
  factory ClusterVirtualClusterConfig.fromMap(Map<String, dynamic> map) {
    return ClusterVirtualClusterConfig(
      auxiliaryServicesConfig: (() { final guardedValue = map['auxiliaryServicesConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterVirtualClusterConfigAuxiliaryServicesConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      kubernetesClusterConfig: (() { final guardedValue = map['kubernetesClusterConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterVirtualClusterConfigKubernetesClusterConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
