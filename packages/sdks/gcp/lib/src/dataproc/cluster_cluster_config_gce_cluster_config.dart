...
class ClusterClusterConfigGceClusterConfig {
  ...
  final ClusterClusterConfigGceClusterConfigConfidentialInstanceConfig? confidentialInstanceConfig;
  ...
  final ClusterClusterConfigGceClusterConfigNodeGroupAffinity? nodeGroupAffinity;
  /// Reservation Affinity for consuming zonal reservation.
  final ClusterClusterConfigGceClusterConfigReservationAffinity? reservationAffinity;
  ...
  ///
  /// - - -
  final ClusterClusterConfigGceClusterConfigShieldedInstanceConfig? shieldedInstanceConfig;
  /// The name or self_link of the Google Compute Engine
  ...
  factory ClusterClusterConfigGceClusterConfig.fromMap(Map<String, dynamic> map) {
    return ClusterClusterConfigGceClusterConfig(
      confidentialInstanceConfig: map['confidentialInstanceConfig'] == null ? null : ClusterClusterConfigGceClusterConfigConfidentialInstanceConfig.fromMap((map['confidentialInstanceConfig'] as Map).cast<String, dynamic>()),
      internalIpOnly: map['internalIpOnly'] == null ? null : map['internalIpOnly'] as bool,
      metadata: map['metadata'] == null ? null : (map['metadata'] as Map).cast<String, String>(),
      network: map['network'] == null ? null : map['network'] as String,
      nodeGroupAffinity: map['nodeGroupAffinity'] == null ? null : ClusterClusterConfigGceClusterConfigNodeGroupAffinity.fromMap((map['nodeGroupAffinity'] as Map).cast<String, dynamic>()),
      reservationAffinity: map['reservationAffinity'] == null ? null : ClusterClusterConfigGceClusterConfigReservationAffinity.fromMap((map['reservationAffinity'] as Map).cast<String, dynamic>()),
      ...
      shieldedInstanceConfig: map['shieldedInstanceConfig'] == null ? null : ClusterClusterConfigGceClusterConfigShieldedInstanceConfig.fromMap((map['shieldedInstanceConfig'] as Map).cast<String, dynamic>()),
