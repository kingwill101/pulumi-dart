...
class MetastoreServiceScalingConfig {
  ...
  factory MetastoreServiceScalingConfig.fromMap(Map<String, dynamic> map) {
    return MetastoreServiceScalingConfig(
      autoscalingConfig: (() { final guardedValue = map['autoscalingConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MetastoreServiceScalingConfigAutoscalingConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
