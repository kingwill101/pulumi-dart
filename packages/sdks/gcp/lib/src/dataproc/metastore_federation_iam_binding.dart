...
import 'metastore_federation_iam_binding_state.dart';
...
/// }
///
/// resource "gcp_dataproc_metastorefederationiampolicy" "policy" {
///   project       = default.project
///   location      = default.location
///   federation_id = default.federationId
...
/// }
///
/// resource "gcp_dataproc_metastorefederationiambinding" "binding" {
///   project       = default.project
///   location      = default.location
///   federation_id = default.federationId
///   role          = "roles/viewer"
...
/// }
///
/// resource "gcp_dataproc_metastorefederationiammember" "member" {
///   project       = default.project
///   location      = default.location
///   federation_id = default.federationId
///   role          = "roles/viewer"
...
class MetastoreFederationIamBinding extends pulumi.CustomResource {
  ...
  MetastoreFederationIamBinding(
    ...
    condition = registerOutput<MetastoreFederationIamBindingCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return MetastoreFederationIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [MetastoreFederationIamBinding] resource's state with the given [name] and [id].
  static MetastoreFederationIamBinding get(
    String name,
    pulumi.Input<String> id, {
    MetastoreFederationIamBindingState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return MetastoreFederationIamBinding._get(
      name,
      state: state?.toMap(),
  ...
  MetastoreFederationIamBinding._get(
    String name, {
  ...
  /// Creates a typed reference to an existing [MetastoreFederationIamBinding] resource.
  MetastoreFederationIamBinding.reference(String urn)
    : super(
        'gcp:dataproc/metastoreFederationIamBinding:MetastoreFederationIamBinding',
