...
class WorkflowTemplatePlacementManagedClusterConfigMasterConfigDiskConfig {
  ...
  const WorkflowTemplatePlacementManagedClusterConfigMasterConfigDiskConfig({
    this.bootDiskSizeGb,
    this.bootDiskType,
    this.numLocalSsds,
  });
  ...
  factory WorkflowTemplatePlacementManagedClusterConfigMasterConfigDiskConfig.fromMap(Map<String, dynamic> map) {
