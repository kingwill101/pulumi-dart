...
class ClusterClusterConfigWorkerConfigDiskConfigAttachedDiskConfig {
  ...
  /// Creates a new [ClusterClusterConfigWorkerConfigDiskConfigAttachedDiskConfig].
  ...
  const ClusterClusterConfigWorkerConfigDiskConfigAttachedDiskConfig({
    this.diskSizeGb,
    this.diskType,
  ...
  factory ClusterClusterConfigWorkerConfigDiskConfigAttachedDiskConfig.fromMap(Map<String, dynamic> map) {
    return ClusterClusterConfigWorkerConfigDiskConfigAttachedDiskConfig(
