...
class GetMetastoreServiceScalingConfig {
  ...
  final pulumi.Input<List<GetMetastoreServiceScalingConfigAutoscalingConfig>>
  autoscalingConfigs;
    ...
    return <String, dynamic>{
      'autoscalingConfigs':
          pulumi.Input.mapInputValue<
            List<GetMetastoreServiceScalingConfigAutoscalingConfig>,
  ...
  factory GetMetastoreServiceScalingConfig.fromMap(Map<String, dynamic> map) {
    return GetMetastoreServiceScalingConfig(
      autoscalingConfigs: pulumi.Input.fromValue(
