...
class WorkflowTemplate extends pulumi.CustomResource {
  ...
  WorkflowTemplate(
    ...
    this.encryptionConfig = registerOutput<WorkflowTemplateEncryptionConfig?>('encryptionConfig');
    this.jobs = registerOutput<List<WorkflowTemplateJob>>('jobs');
    this.labels = registerOutput<Map<String, String>?>('labels');
    this.location = registerOutput<String>('location');
    this.name = registerOutput<String>('name');
    this.parameters = registerOutput<List<WorkflowTemplateParameter>?>('parameters');
