...
class RepositoryWorkflowConfigState {
  ...
  const RepositoryWorkflowConfigState({
    this.cronSchedule,
    this.deletionPolicy,
    this.disabled,
  ...
  factory RepositoryWorkflowConfigState.fromMap(Map<String, dynamic> map) {
    return RepositoryWorkflowConfigState(
      ...
      recentScheduledExecutionRecords: (() { final guardedValue = map['recentScheduledExecutionRecords']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RepositoryWorkflowConfigRecentScheduledExecutionRecord>(guardedValue, (value) => RepositoryWorkflowConfigRecentScheduledExecutionRecord.fromMap((value as Map).cast<String, dynamic>()))); })(),
      region: (() { final guardedValue = map['region']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      releaseConfig: (() { final guardedValue = map['releaseConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
