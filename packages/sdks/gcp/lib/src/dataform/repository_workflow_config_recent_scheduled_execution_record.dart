...
class RepositoryWorkflowConfigRecentScheduledExecutionRecord {
  ...
  final pulumi.Input<
    List<RepositoryWorkflowConfigRecentScheduledExecutionRecordErrorStatus>
  >?
  errorStatuses;
  ...
  factory RepositoryWorkflowConfigRecentScheduledExecutionRecord.fromMap(
    ...
    return RepositoryWorkflowConfigRecentScheduledExecutionRecord(
      errorStatuses: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                RepositoryWorkflowConfigRecentScheduledExecutionRecordErrorStatus.fromMap(
      ...
      workflowInvocation: (() {
        final guardedValue = map['workflowInvocation'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
