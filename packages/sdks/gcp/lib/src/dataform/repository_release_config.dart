...
class RepositoryReleaseConfig extends pulumi.CustomResource {
  ...
  RepositoryReleaseConfig(
    ...
    this.codeCompilationConfig = registerOutput<RepositoryReleaseConfigCodeCompilationConfig?>('codeCompilationConfig');
    this.cronSchedule = registerOutput<String?>('cronSchedule');
    this.gitCommitish = registerOutput<String>('gitCommitish');
    this.name = registerOutput<String>('name');
    this.project = registerOutput<String>('project');
    this.recentScheduledReleaseRecords = registerOutput<List<RepositoryReleaseConfigRecentScheduledReleaseRecord>>('recentScheduledReleaseRecords');
