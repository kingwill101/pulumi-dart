...
class RepositoryReleaseConfigState {
  ...
  factory RepositoryReleaseConfigState.fromMap(Map<String, dynamic> map) {
    return RepositoryReleaseConfigState(
      ...
      recentScheduledReleaseRecords: (() { final guardedValue = map['recentScheduledReleaseRecords']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RepositoryReleaseConfigRecentScheduledReleaseRecord>(guardedValue, (value) => RepositoryReleaseConfigRecentScheduledReleaseRecord.fromMap((value as Map).cast<String, dynamic>()))); })(),
