...
class PipelineJobReconciliationPipelineJob {
  ...
  factory PipelineJobReconciliationPipelineJob.fromMap(Map<String, dynamic> map) {
    return PipelineJobReconciliationPipelineJob(
      ...
      matchingUriPrefix: pulumi.Input.fromValue(map['matchingUriPrefix'] as String),
      mergeConfig: pulumi.Input.fromValue(PipelineJobReconciliationPipelineJobMergeConfig.fromMap((map['mergeConfig']! as Map).cast<String, dynamic>())),
    );
  }
}
