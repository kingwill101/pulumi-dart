...
/// {@template pulumi_healthcare_dataset_iam_member_dataset_iam_member_args_doc}
...
class DatasetIamMemberArgs {
  ...
  factory DatasetIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return DatasetIamMemberArgs(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DatasetIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
