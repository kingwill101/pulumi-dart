...
class DatasetIamMember extends pulumi.CustomResource {
  ...
  /// Creates a new [DatasetIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [DatasetIamMember]. {@macro pulumi_healthcare_dataset_iam_member_dataset_iam_member_args_doc}
