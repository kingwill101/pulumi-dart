...
class Hl7StoreIamMemberState {
  ...
  factory Hl7StoreIamMemberState.fromMap(Map<String, dynamic> map) {
    return Hl7StoreIamMemberState(
      ...
      hl7V2StoreId: (() { final guardedValue = map['hl7V2StoreId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
