...
class FhirStore extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [FhirStore]. {@macro pulumi_healthcare_fhir_store_fhir_store_args_doc}
  ...
  FhirStore(
    ...
    this.consentConfig = registerOutput<FhirStoreConsentConfig?>('consentConfig');
    ...
    this.enableHistoryModifications = registerOutput<bool?>('enableHistoryModifications');
    this.enableUpdateCreate = registerOutput<bool?>('enableUpdateCreate');
    this.labels = registerOutput<Map<String, String>?>('labels');
    this.name = registerOutput<String>('name');
    this.notificationConfig = registerOutput<FhirStoreNotificationConfig?>('notificationConfig');
    this.notificationConfigs = registerOutput<List<FhirStoreNotificationConfig>?>('notificationConfigs');
    this.pulumiLabels = registerOutput<Map<String, String>>('pulumiLabels');
    this.selfLink = registerOutput<String>('selfLink');
    this.streamConfigs = registerOutput<List<FhirStoreStreamConfig>?>('streamConfigs');
    this.validationConfig = registerOutput<FhirStoreValidationConfig?>('validationConfig');
    this.version = registerOutput<String?>('version');
  }

  /// Gets an existing [FhirStore] resource's state with the given [name] and [id].
  static FhirStore get(
    String name,
