...
class Hl7Store extends pulumi.CustomResource {
  ...
  /// Creates a new [Hl7Store].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [Hl7Store]. {@macro pulumi_healthcare_hl7_store_hl7_store_args_doc}
  ...
  Hl7Store(
    ...
    this.notificationConfig = registerOutput<Hl7StoreNotificationConfig?>('notificationConfig');
    this.notificationConfigs = registerOutput<List<Hl7StoreNotificationConfigs>?>('notificationConfigs');
  ...
  /// Gets an existing [Hl7Store] resource's state with the given [name] and [id].
  static Hl7Store get(
    String name,
