...
class Hl7StoreIamBindingArgs {
  ...
  factory Hl7StoreIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return Hl7StoreIamBindingArgs(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Hl7StoreIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
