...
import 'dicom_store_iam_binding_state.dart';
...
class DicomStoreIamBinding extends pulumi.CustomResource {
  ...
  /// Gets an existing [DicomStoreIamBinding] resource's state with the given [name] and [id].
  static DicomStoreIamBinding get(
    String name,
    pulumi.Input<String> id, {
    DicomStoreIamBindingState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return DicomStoreIamBinding._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [DicomStoreIamBinding] resource.
  DicomStoreIamBinding.reference(String urn)
    : super(
        'gcp:healthcare/dicomStoreIamBinding:DicomStoreIamBinding',
