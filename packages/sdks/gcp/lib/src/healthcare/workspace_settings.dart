...
class WorkspaceSettings {
  ...
  WorkspaceSettings({required this.dataProjectIds});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'dataProjectIds': dataProjectIds};
  }

  factory WorkspaceSettings.fromMap(Map<String, dynamic> map) {
    return WorkspaceSettings(
      dataProjectIds: pulumi.Input.fromValue(
        (map['dataProjectIds'] as List).cast<String>(),
      ),
    );
  }
}
