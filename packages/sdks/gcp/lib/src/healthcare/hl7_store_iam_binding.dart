...
import 'hl7_store_iam_binding_state.dart';
...
class Hl7StoreIamBinding extends pulumi.CustomResource {
  ...
  Hl7StoreIamBinding(
    ...
    condition = registerOutput<Hl7StoreIamBindingCondition?>(
      'condition',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return Hl7StoreIamBindingCondition.fromMap(
  ...
  /// Gets an existing [Hl7StoreIamBinding] resource's state with the given [name] and [id].
  static Hl7StoreIamBinding get(
    String name,
