...
import 'dicom_store_iam_policy_state.dart';
...
class DicomStoreIamPolicy extends pulumi.CustomResource {
  ...
  /// Creates a new [DicomStoreIamPolicy].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [DicomStoreIamPolicy]. {@macro pulumi_healthcare_dicom_store_iam_policy_dicom_store_iam_policy_args_doc}
  ...
  /// Gets an existing [DicomStoreIamPolicy] resource's state with the given [name] and [id].
  static DicomStoreIamPolicy get(
    String name,
