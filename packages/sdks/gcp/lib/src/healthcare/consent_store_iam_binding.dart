...
import 'consent_store_iam_binding_args.dart';
import 'consent_store_iam_binding_condition.dart';
import 'consent_store_iam_binding_state.dart';
...
class ConsentStoreIamBinding extends pulumi.CustomResource {
  ...
  /// Creates a new [ConsentStoreIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ConsentStoreIamBinding]. {@macro pulumi_healthcare_consent_store_iam_binding_consent_store_iam_binding_args_doc}
  ...
  /// Gets an existing [ConsentStoreIamBinding] resource's state with the given [name] and [id].
  static ConsentStoreIamBinding get(
    String name,
