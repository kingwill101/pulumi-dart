...
class FhirStoreIamMember extends pulumi.CustomResource {
  ...
  /// Creates a new [FhirStoreIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [FhirStoreIamMember]. {@macro pulumi_healthcare_fhir_store_iam_member_fhir_store_iam_member_args_doc}
  ...
  FhirStoreIamMember(
    ...
    condition = registerOutput<FhirStoreIamMemberCondition?>(
      'condition',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return FhirStoreIamMemberCondition.fromMap(
