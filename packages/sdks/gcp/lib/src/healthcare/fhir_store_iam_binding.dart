...
import 'fhir_store_iam_binding_state.dart';
...
class FhirStoreIamBinding extends pulumi.CustomResource {
  ...
  /// Gets an existing [FhirStoreIamBinding] resource's state with the given [name] and [id].
  static FhirStoreIamBinding get(
    String name,
