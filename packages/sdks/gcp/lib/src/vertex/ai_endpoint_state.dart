...
class AiEndpointState {
  ...
  factory AiEndpointState.fromMap(Map<String, dynamic> map) {
    return AiEndpointState(
      ...
      dedicatedEndpointDns: map['dedicatedEndpointDns'] == null ? null : (map['dedicatedEndpointDns'] as String).input(),
      dedicatedEndpointEnabled: map['dedicatedEndpointEnabled'] == null ? null : (map['dedicatedEndpointEnabled'] as bool).input(),
      deployedModels: map['deployedModels'] == null ? null : (pulumi.Input.decodeList<AiEndpointDeployedModel>(map['deployedModels'], (value) => AiEndpointDeployedModel.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      modelDeploymentMonitoringJob: map['modelDeploymentMonitoringJob'] == null ? null : (map['modelDeploymentMonitoringJob'] as String).input(),
