...
class AiEndpointState {
  ...
  AiEndpointState({
    ...
    pulumi.Output<String>? dedicatedEndpointDns,
    pulumi.Output<bool>? dedicatedEndpointEnabled,
    pulumi.Output<List<AiEndpointDeployedModel>>? deployedModels,
    ...
    pulumi.Output<String>? modelDeploymentMonitoringJob,
    ...
    pulumi.Output<String>? updateTime,
      ...
      dedicatedEndpointDns = pulumi.Input.asOptionalInput<String>(dedicatedEndpointDns),
      dedicatedEndpointEnabled = pulumi.Input.asOptionalInput<bool>(dedicatedEndpointEnabled),
      deployedModels = pulumi.Input.asOptionalInput<List<AiEndpointDeployedModel>>(deployedModels),
      ...
      modelDeploymentMonitoringJob = pulumi.Input.asOptionalInput<String>(modelDeploymentMonitoringJob),
  ...
  factory AiEndpointState.fromMap(Map<String, dynamic> map) {
    return AiEndpointState(
      ...
      dedicatedEndpointDns: map['dedicatedEndpointDns'] == null ? null : pulumi.Output.create<String>(map['dedicatedEndpointDns'] as String),
      ...
      deployedModels: map['deployedModels'] == null ? null : pulumi.Output.create<List<AiEndpointDeployedModel>>(pulumi.Input.decodeList<AiEndpointDeployedModel>(map['deployedModels'], (value) => AiEndpointDeployedModel.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      modelDeploymentMonitoringJob: map['modelDeploymentMonitoringJob'] == null ? null : pulumi.Output.create<String>(map['modelDeploymentMonitoringJob'] as String),
