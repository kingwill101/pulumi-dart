  ...
  factory AiEndpointState.fromMap(Map<String, dynamic> map) {
    return AiEndpointState(
      ...
      dedicatedEndpointDns: (() {
        final guardedValue = map['dedicatedEndpointDns'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      dedicatedEndpointEnabled: (() {
      ...
      deployedModels: (() {
        final guardedValue = map['deployedModels'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AiEndpointDeployedModel>(
            guardedValue,
            (value) => AiEndpointDeployedModel.fromMap(
      ...
      modelDeploymentMonitoringJob: (() {
        final guardedValue = map['modelDeploymentMonitoringJob'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      name: (() {
