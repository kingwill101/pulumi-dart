...
class AiFeatureOnlineStoreFeatureviewIamBindingState {
  ...
  const AiFeatureOnlineStoreFeatureviewIamBindingState({
    this.condition,
    this.etag,
  ...
  factory AiFeatureOnlineStoreFeatureviewIamBindingState.fromMap(Map<String, dynamic> map) {
    return AiFeatureOnlineStoreFeatureviewIamBindingState(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AiFeatureOnlineStoreFeatureviewIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
