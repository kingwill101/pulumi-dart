...
import 'ai_feature_online_store_iam_member_state.dart';
...
class AiFeatureOnlineStoreIamMember extends pulumi.CustomResource {
  ...
  /// Gets an existing [AiFeatureOnlineStoreIamMember] resource's state with the given [name] and [id].
  static AiFeatureOnlineStoreIamMember get(
    String name,
  ...
  AiFeatureOnlineStoreIamMember._get(
    String name, {
