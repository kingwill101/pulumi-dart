...
import 'ai_feature_store_iam_policy_state.dart';
...
class AiFeatureStoreIamPolicy extends pulumi.CustomResource {
  ...
  /// Gets an existing [AiFeatureStoreIamPolicy] resource's state with the given [name] and [id].
  static AiFeatureStoreIamPolicy get(
    String name,
