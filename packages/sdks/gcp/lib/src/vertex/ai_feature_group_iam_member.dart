...
import 'ai_feature_group_iam_member_state.dart';
...
class AiFeatureGroupIamMember extends pulumi.CustomResource {
  late final pulumi.Output<AiFeatureGroupIamMemberCondition?> condition;
  ...
  /// Creates a new [AiFeatureGroupIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [AiFeatureGroupIamMember]. {@macro pulumi_vertex_ai_feature_group_iam_member_ai_feature_group_iam_member_args_doc}
  ...
  AiFeatureGroupIamMember(
    ...
    condition = registerOutput<AiFeatureGroupIamMemberCondition?>(
      'condition',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return AiFeatureGroupIamMemberCondition.fromMap(
  ...
  /// Gets an existing [AiFeatureGroupIamMember] resource's state with the given [name] and [id].
  static AiFeatureGroupIamMember get(
    String name,
