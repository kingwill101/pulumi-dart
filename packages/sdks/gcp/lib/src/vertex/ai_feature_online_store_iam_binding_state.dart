...
class AiFeatureOnlineStoreIamBindingState {
  ...
  /// Creates a new [AiFeatureOnlineStoreIamBindingState].
  /// [condition] Optional.
  ...
  const AiFeatureOnlineStoreIamBindingState({
    this.condition,
    this.etag,
  ...
  factory AiFeatureOnlineStoreIamBindingState.fromMap(Map<String, dynamic> map) {
    return AiFeatureOnlineStoreIamBindingState(
