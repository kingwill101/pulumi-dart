...
import 'ai_reasoning_engine_iam_binding_args.dart';
import 'ai_reasoning_engine_iam_binding_condition.dart';
import 'ai_reasoning_engine_iam_binding_state.dart';
...
class AiReasoningEngineIamBinding extends pulumi.CustomResource {
  late final pulumi.Output<AiReasoningEngineIamBindingCondition?> condition;
  ...
  /// Creates a new [AiReasoningEngineIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [AiReasoningEngineIamBinding]. {@macro pulumi_vertex_ai_reasoning_engine_iam_binding_ai_reasoning_engine_iam_binding_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  AiReasoningEngineIamBinding(
    String name, {
    AiReasoningEngineIamBindingArgs? args,
    ...
    condition = registerOutput<AiReasoningEngineIamBindingCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return AiReasoningEngineIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [AiReasoningEngineIamBinding] resource's state with the given [name] and [id].
  static AiReasoningEngineIamBinding get(
    String name,
    pulumi.Input<String> id, {
    AiReasoningEngineIamBindingState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return AiReasoningEngineIamBinding._get(
      name,
      state: state?.toMap(),
  ...
  AiReasoningEngineIamBinding._get(
    String name, {
  ...
  /// Creates a typed reference to an existing [AiReasoningEngineIamBinding] resource.
  AiReasoningEngineIamBinding.reference(String urn)
    : super(
        'gcp:vertex/aiReasoningEngineIamBinding:AiReasoningEngineIamBinding',
