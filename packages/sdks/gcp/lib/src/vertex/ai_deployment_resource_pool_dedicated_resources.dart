...
class AiDeploymentResourcePoolDedicatedResources {
  ...
  const AiDeploymentResourcePoolDedicatedResources({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'autoscalingMetricSpecs': ?pulumi.Input.mapOptionalInputValue<List<AiDeploymentResourcePoolDedicatedResourcesAutoscalingMetricSpec>, List<Map<String, dynamic>>>(autoscalingMetricSpecs, (value) => pulumi.Input.encodeList<AiDeploymentResourcePoolDedicatedResourcesAutoscalingMetricSpec, Map<String, dynamic>>(value, (value) => value.toMap())),
      'machineSpec': pulumi.Input.mapInputValue<AiDeploymentResourcePoolDedicatedResourcesMachineSpec, Map<String, dynamic>>(machineSpec, (value) => value.toMap()),
