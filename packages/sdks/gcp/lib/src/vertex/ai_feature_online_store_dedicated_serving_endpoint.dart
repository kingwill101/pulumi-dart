...
class AiFeatureOnlineStoreDedicatedServingEndpoint {
  ...
  factory AiFeatureOnlineStoreDedicatedServingEndpoint.fromMap(Map<String, dynamic> map) {
    return AiFeatureOnlineStoreDedicatedServingEndpoint(
      privateServiceConnectConfig: (() { final guardedValue = map['privateServiceConnectConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AiFeatureOnlineStoreDedicatedServingEndpointPrivateServiceConnectConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
