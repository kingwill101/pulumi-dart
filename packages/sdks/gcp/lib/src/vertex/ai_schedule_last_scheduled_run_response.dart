...
class AiScheduleLastScheduledRunResponse {
  /// (Output)
  ...
  /// Creates a new [AiScheduleLastScheduledRunResponse].
  /// [runResponse] (Output)
  /// [scheduledRunTime] (Output)
  const AiScheduleLastScheduledRunResponse({
    this.runResponse,
  ...
  factory AiScheduleLastScheduledRunResponse.fromMap(Map<String, dynamic> map) {
    return AiScheduleLastScheduledRunResponse(
