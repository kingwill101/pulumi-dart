...
import 'ai_endpoint_with_model_garden_deployment_state.dart';
...
class AiEndpointWithModelGardenDeployment extends pulumi.CustomResource {
  ...
  /// Gets an existing [AiEndpointWithModelGardenDeployment] resource's state with the given [name] and [id].
  static AiEndpointWithModelGardenDeployment get(
    String name,
    pulumi.Input<String> id, {
    AiEndpointWithModelGardenDeploymentState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return AiEndpointWithModelGardenDeployment._get(
      name,
      state: state?.toMap(),
  ...
  AiEndpointWithModelGardenDeployment._get(
    String name, {
  ...
  /// Creates a typed reference to an existing [AiEndpointWithModelGardenDeployment] resource.
  AiEndpointWithModelGardenDeployment.reference(String urn)
    : super(
        'gcp:vertex/aiEndpointWithModelGardenDeployment:AiEndpointWithModelGardenDeployment',
