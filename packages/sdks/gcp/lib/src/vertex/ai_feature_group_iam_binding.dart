...
import 'ai_feature_group_iam_binding_state.dart';
...
class AiFeatureGroupIamBinding extends pulumi.CustomResource {
  ...
  /// Gets an existing [AiFeatureGroupIamBinding] resource's state with the given [name] and [id].
  static AiFeatureGroupIamBinding get(
    String name,
