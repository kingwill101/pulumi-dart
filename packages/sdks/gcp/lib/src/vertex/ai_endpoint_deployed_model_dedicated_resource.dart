...
class AiEndpointDeployedModelDedicatedResource {
  ...
  final pulumi.Input<List<AiEndpointDeployedModelDedicatedResourceAutoscalingMetricSpec>>? autoscalingMetricSpecs;
  /// (Output)
  /// The specification of a single machine used by the prediction.
  /// Structure is documented below.
  final pulumi.Input<List<AiEndpointDeployedModelDedicatedResourceMachineSpec>>? machineSpecs;
  /// (Output)
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'autoscalingMetricSpecs': ?pulumi.Input.mapOptionalInputValue<List<AiEndpointDeployedModelDedicatedResourceAutoscalingMetricSpec>, List<Map<String, dynamic>>>(autoscalingMetricSpecs, (value) => pulumi.Input.encodeList<AiEndpointDeployedModelDedicatedResourceAutoscalingMetricSpec, Map<String, dynamic>>(value, (value) => value.toMap())),
      'machineSpecs': ?pulumi.Input.mapOptionalInputValue<List<AiEndpointDeployedModelDedicatedResourceMachineSpec>, List<Map<String, dynamic>>>(machineSpecs, (value) => pulumi.Input.encodeList<AiEndpointDeployedModelDedicatedResourceMachineSpec, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory AiEndpointDeployedModelDedicatedResource.fromMap(Map<String, dynamic> map) {
    return AiEndpointDeployedModelDedicatedResource(
      autoscalingMetricSpecs: (() { final guardedValue = map['autoscalingMetricSpecs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AiEndpointDeployedModelDedicatedResourceAutoscalingMetricSpec>(guardedValue, (value) => AiEndpointDeployedModelDedicatedResourceAutoscalingMetricSpec.fromMap((value as Map).cast<String, dynamic>()))); })(),
      machineSpecs: (() { final guardedValue = map['machineSpecs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AiEndpointDeployedModelDedicatedResourceMachineSpec>(guardedValue, (value) => AiEndpointDeployedModelDedicatedResourceMachineSpec.fromMap((value as Map).cast<String, dynamic>()))); })(),
