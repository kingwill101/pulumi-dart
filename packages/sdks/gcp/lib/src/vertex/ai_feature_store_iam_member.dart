...
import 'ai_feature_store_iam_member_condition.dart';
import 'ai_feature_store_iam_member_state.dart';
...
class AiFeatureStoreIamMember extends pulumi.CustomResource {
  late final pulumi.Output<AiFeatureStoreIamMemberCondition?> condition;
  ...
  /// Creates a new [AiFeatureStoreIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [AiFeatureStoreIamMember]. {@macro pulumi_vertex_ai_feature_store_iam_member_ai_feature_store_iam_member_args_doc}
  ...
  AiFeatureStoreIamMember(
    ...
    condition = registerOutput<AiFeatureStoreIamMemberCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return AiFeatureStoreIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [AiFeatureStoreIamMember] resource's state with the given [name] and [id].
  static AiFeatureStoreIamMember get(
    String name,
    pulumi.Input<String> id, {
    AiFeatureStoreIamMemberState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return AiFeatureStoreIamMember._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [AiFeatureStoreIamMember] resource.
  AiFeatureStoreIamMember.reference(String urn)
    : super(
        'gcp:vertex/aiFeatureStoreIamMember:AiFeatureStoreIamMember',
