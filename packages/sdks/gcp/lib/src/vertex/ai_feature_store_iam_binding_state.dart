...
class AiFeatureStoreIamBindingState {
  ...
  const AiFeatureStoreIamBindingState({
    this.condition,
    this.etag,
    this.featurestore,
    this.members,
  ...
  factory AiFeatureStoreIamBindingState.fromMap(Map<String, dynamic> map) {
    return AiFeatureStoreIamBindingState(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AiFeatureStoreIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
