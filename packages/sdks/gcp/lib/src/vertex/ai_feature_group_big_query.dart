...
class AiFeatureGroupBigQuery {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'bigQuerySource': pulumi.Input.mapInputValue<AiFeatureGroupBigQueryBigQuerySource, Map<String, dynamic>>(bigQuerySource, (value) => value.toMap()),
  ...
  factory AiFeatureGroupBigQuery.fromMap(Map<String, dynamic> map) {
    return AiFeatureGroupBigQuery(
      bigQuerySource: pulumi.Input.fromValue(AiFeatureGroupBigQueryBigQuerySource.fromMap((map['bigQuerySource']! as Map).cast<String, dynamic>())),
      entityIdColumns: (() { final guardedValue = map['entityIdColumns']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
    );
  }
}
