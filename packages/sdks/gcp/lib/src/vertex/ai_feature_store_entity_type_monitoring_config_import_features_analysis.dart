...
class AiFeatureStoreEntityTypeMonitoringConfigImportFeaturesAnalysis {
  ...
  factory AiFeatureStoreEntityTypeMonitoringConfigImportFeaturesAnalysis.fromMap(Map<String, dynamic> map) {
    return AiFeatureStoreEntityTypeMonitoringConfigImportFeaturesAnalysis(
      anomalyDetectionBaseline: (() { final guardedValue = map['anomalyDetectionBaseline']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
