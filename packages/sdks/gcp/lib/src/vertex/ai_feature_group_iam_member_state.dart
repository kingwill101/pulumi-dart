...
class AiFeatureGroupIamMemberState {
  ...
  /// Creates a new [AiFeatureGroupIamMemberState].
  /// [condition] Optional.
  ...
  AiFeatureGroupIamMemberState({
    pulumi.Output<AiFeatureGroupIamMemberCondition>? condition,
    ...
    pulumi.Output<String>? role,
      ...
      condition = pulumi.Input.asOptionalInput<AiFeatureGroupIamMemberCondition>(condition),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'condition': ?pulumi.Input.mapOptionalInputValue<AiFeatureGroupIamMemberCondition, Map<String, dynamic>>(condition, (value) => value.toMap()),
      'etag': ?etag,
  ...
  factory AiFeatureGroupIamMemberState.fromMap(Map<String, dynamic> map) {
    return AiFeatureGroupIamMemberState(
      condition: map['condition'] == null ? null : pulumi.Output.create<AiFeatureGroupIamMemberCondition>(AiFeatureGroupIamMemberCondition.fromMap((map['condition'] as Map).cast<String, dynamic>())),
