...
class AiFeatureGroupIamMemberState {
  ...
  const AiFeatureGroupIamMemberState({
    this.condition,
    this.etag,
    this.featureGroup,
    this.member,
  ...
  factory AiFeatureGroupIamMemberState.fromMap(Map<String, dynamic> map) {
    return AiFeatureGroupIamMemberState(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AiFeatureGroupIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
