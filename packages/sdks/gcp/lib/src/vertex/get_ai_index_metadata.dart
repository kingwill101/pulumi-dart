...
class GetAiIndexMetadata {
  ...
  factory GetAiIndexMetadata.fromMap(Map<String, dynamic> map) {
    return GetAiIndexMetadata(
      configs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetAiIndexMetadataConfig>(map['configs']!, (value) => GetAiIndexMetadataConfig.fromMap((value as Map).cast<String, dynamic>()))),
      contentsDeltaUri: pulumi.Input.fromValue(map['contentsDeltaUri'] as String),
      isCompleteOverwrite: pulumi.Input.fromValue(map['isCompleteOverwrite'] as bool),
    );
  }
}
