...
class AiEndpointWithModelGardenDeploymentModelConfig {
  ...
  factory AiEndpointWithModelGardenDeploymentModelConfig.fromMap(Map<String, dynamic> map) {
    return AiEndpointWithModelGardenDeploymentModelConfig(
      ...
      containerSpec: (() { final guardedValue = map['containerSpec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AiEndpointWithModelGardenDeploymentModelConfigContainerSpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      huggingFaceAccessToken: (() { final guardedValue = map['huggingFaceAccessToken']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      huggingFaceCacheEnabled: (() { final guardedValue = map['huggingFaceCacheEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      modelDisplayName: (() { final guardedValue = map['modelDisplayName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
