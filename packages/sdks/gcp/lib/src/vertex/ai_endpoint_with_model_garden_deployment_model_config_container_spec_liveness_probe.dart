...
class AiEndpointWithModelGardenDeploymentModelConfigContainerSpecLivenessProbe {
  ...
  final AiEndpointWithModelGardenDeploymentModelConfigContainerSpecLivenessProbeExec? exec;
  ...
  /// Structure is documented below.
  final AiEndpointWithModelGardenDeploymentModelConfigContainerSpecLivenessProbeGrpc? grpc;
  /// HttpGetAction describes an action based on HTTP Get requests.
  /// Structure is documented below.
  final AiEndpointWithModelGardenDeploymentModelConfigContainerSpecLivenessProbeHttpGet? httpGet;
  ...
  /// connection.
  /// Structure is documented below.
  final AiEndpointWithModelGardenDeploymentModelConfigContainerSpecLivenessProbeTcpSocket? tcpSocket;
  ...
  factory AiEndpointWithModelGardenDeploymentModelConfigContainerSpecLivenessProbe.fromMap(Map<String, dynamic> map) {
    return AiEndpointWithModelGardenDeploymentModelConfigContainerSpecLivenessProbe(
      exec: map['exec'] == null ? null : AiEndpointWithModelGardenDeploymentModelConfigContainerSpecLivenessProbeExec.fromMap((map['exec'] as Map).cast<String, dynamic>()),
      failureThreshold: map['failureThreshold'] == null ? null : map['failureThreshold'] as int,
      grpc: map['grpc'] == null ? null : AiEndpointWithModelGardenDeploymentModelConfigContainerSpecLivenessProbeGrpc.fromMap((map['grpc'] as Map).cast<String, dynamic>()),
      httpGet: map['httpGet'] == null ? null : AiEndpointWithModelGardenDeploymentModelConfigContainerSpecLivenessProbeHttpGet.fromMap((map['httpGet'] as Map).cast<String, dynamic>()),
      ...
      tcpSocket: map['tcpSocket'] == null ? null : AiEndpointWithModelGardenDeploymentModelConfigContainerSpecLivenessProbeTcpSocket.fromMap((map['tcpSocket'] as Map).cast<String, dynamic>()),
