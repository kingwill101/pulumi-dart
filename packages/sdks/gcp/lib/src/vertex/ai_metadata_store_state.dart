...
class AiMetadataStoreState {
  ...
  factory AiMetadataStoreState.fromMap(Map<String, dynamic> map) {
    return AiMetadataStoreState(
      diskUtilizationBytes: (() { final guardedValue = map['diskUtilizationBytes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
