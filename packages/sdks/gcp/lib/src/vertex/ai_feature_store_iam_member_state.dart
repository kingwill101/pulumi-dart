...
class AiFeatureStoreIamMemberState {
  ...
  /// Creates a new [AiFeatureStoreIamMemberState].
  /// [condition] Optional.
  ...
  const AiFeatureStoreIamMemberState({
    this.condition,
    this.etag,
    this.featurestore,
    this.member,
  ...
  factory AiFeatureStoreIamMemberState.fromMap(Map<String, dynamic> map) {
    return AiFeatureStoreIamMemberState(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AiFeatureStoreIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
