...
import 'ai_feature_online_store_featureview_iam_member_state.dart';
...
class AiFeatureOnlineStoreFeatureviewIamMember extends pulumi.CustomResource {
  late final pulumi.Output<AiFeatureOnlineStoreFeatureviewIamMemberCondition?> condition;
  ...
  /// Creates a new [AiFeatureOnlineStoreFeatureviewIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [AiFeatureOnlineStoreFeatureviewIamMember]. {@macro pulumi_vertex_ai_feature_online_store_featureview_iam_member_ai_feature_online_store_featureview_iam_member_args_doc}
  ...
  AiFeatureOnlineStoreFeatureviewIamMember(
    ...
    condition = registerOutput<AiFeatureOnlineStoreFeatureviewIamMemberCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return AiFeatureOnlineStoreFeatureviewIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [AiFeatureOnlineStoreFeatureviewIamMember] resource's state with the given [name] and [id].
  static AiFeatureOnlineStoreFeatureviewIamMember get(
    String name,
    pulumi.Input<String> id, {
    AiFeatureOnlineStoreFeatureviewIamMemberState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return AiFeatureOnlineStoreFeatureviewIamMember._get(
      name,
      state: state?.toMap(),
  ...
  AiFeatureOnlineStoreFeatureviewIamMember._get(
    String name, {
  ...
  /// Creates a typed reference to an existing [AiFeatureOnlineStoreFeatureviewIamMember] resource.
  AiFeatureOnlineStoreFeatureviewIamMember.reference(String urn)
    : super(
        'gcp:vertex/aiFeatureOnlineStoreFeatureviewIamMember:AiFeatureOnlineStoreFeatureviewIamMember',
