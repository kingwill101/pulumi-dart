...
import 'ai_feature_store_entity_type_iam_binding_state.dart';
...
class AiFeatureStoreEntityTypeIamBinding extends pulumi.CustomResource {
  late final pulumi.Output<AiFeatureStoreEntityTypeIamBindingCondition?> condition;
  ...
  /// Creates a new [AiFeatureStoreEntityTypeIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [AiFeatureStoreEntityTypeIamBinding]. {@macro pulumi_vertex_ai_feature_store_entity_type_iam_binding_ai_feature_store_entity_type_iam_binding_args_doc}
  ...
  AiFeatureStoreEntityTypeIamBinding(
    ...
    this.condition = registerOutput<AiFeatureStoreEntityTypeIamBindingCondition?>('condition');
  ...
  /// Gets an existing [AiFeatureStoreEntityTypeIamBinding] resource's state with the given [name] and [id].
  static AiFeatureStoreEntityTypeIamBinding get(
    String name,
  ...
  AiFeatureStoreEntityTypeIamBinding._get(
    String name, {
