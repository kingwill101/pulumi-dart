...
class AiIndexEndpointState {
  ...
  factory AiIndexEndpointState.fromMap(Map<String, dynamic> map) {
    return AiIndexEndpointState(
      ...
      publicEndpointDomainName: (() { final guardedValue = map['publicEndpointDomainName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
