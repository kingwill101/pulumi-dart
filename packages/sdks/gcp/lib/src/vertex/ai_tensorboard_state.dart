...
class AiTensorboardState {
  ...
  factory AiTensorboardState.fromMap(Map<String, dynamic> map) {
    return AiTensorboardState(
      blobStoragePathPrefix: (() { final guardedValue = map['blobStoragePathPrefix']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      runCount: (() { final guardedValue = map['runCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
