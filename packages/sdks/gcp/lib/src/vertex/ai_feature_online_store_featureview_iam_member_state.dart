...
class AiFeatureOnlineStoreFeatureviewIamMemberState {
  ...
  factory AiFeatureOnlineStoreFeatureviewIamMemberState.fromMap(
    ...
    return AiFeatureOnlineStoreFeatureviewIamMemberState(
      condition: (() {
        ...
        return pulumi.Input.fromValue(
          AiFeatureOnlineStoreFeatureviewIamMemberCondition.fromMap(
      ...
      featureView: (() {
        final guardedValue = map['featureView'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      member: (() {
