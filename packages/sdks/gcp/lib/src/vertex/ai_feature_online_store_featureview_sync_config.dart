...
class AiFeatureOnlineStoreFeatureviewSyncConfig {
  ...
  AiFeatureOnlineStoreFeatureviewSyncConfig({this.continuous, this.cron});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'continuous': ?continuous, 'cron': ?cron};
  }
  ...
  factory AiFeatureOnlineStoreFeatureviewSyncConfig.fromMap(
    ...
    return AiFeatureOnlineStoreFeatureviewSyncConfig(
      continuous: (() {
        final guardedValue = map['continuous'];
