...
class GetAiIndexMetadataConfigAlgorithmConfig {
  ...
  final pulumi.Input<List<GetAiIndexMetadataConfigAlgorithmConfigTreeAhConfig>>
  treeAhConfigs;
    ...
    return <String, dynamic>{
      ...
      'treeAhConfigs':
          pulumi.Input.mapInputValue<
            List<GetAiIndexMetadataConfigAlgorithmConfigTreeAhConfig>,
  ...
  factory GetAiIndexMetadataConfigAlgorithmConfig.fromMap(
    ...
    return GetAiIndexMetadataConfigAlgorithmConfig(
      bruteForceConfigs: pulumi.Input.fromValue(
        (map['bruteForceConfigs'] as List).cast<Map<String, dynamic>>(),
      ),
      treeAhConfigs: pulumi.Input.fromValue(
