...
class AiReasoningEngineSpec {
    ...
    return <String, dynamic>{
      ...
      'packageSpec':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(packageSpec, (value) => value.toMap()),
      'serviceAccount': ?serviceAccount,
      'sourceCodeSpec':
          ?pulumi.Input.mapOptionalInputValue<
            AiReasoningEngineSpecSourceCodeSpec,
            Map<String, dynamic>
          >(sourceCodeSpec, (value) => value.toMap()),
    };
  }
  ...
  factory AiReasoningEngineSpec.fromMap(Map<String, dynamic> map) {
    return AiReasoningEngineSpec(
      agentFramework: (() {
        final guardedValue = map['agentFramework'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      classMethods: (() {
        final guardedValue = map['classMethods'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      deploymentSpec: (() {
      ...
      packageSpec: (() {
        final guardedValue = map['packageSpec'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      sourceCodeSpec: (() {
        final guardedValue = map['sourceCodeSpec'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
