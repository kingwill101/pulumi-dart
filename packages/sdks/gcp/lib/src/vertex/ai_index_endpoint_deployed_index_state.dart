...
class AiIndexEndpointDeployedIndexState {
  ...
  /// Structure is documented below.
  final pulumi.Input<List<AiIndexEndpointDeployedIndexPrivateEndpoint>>?
  privateEndpoints;
  ...
  factory AiIndexEndpointDeployedIndexState.fromMap(Map<String, dynamic> map) {
    return AiIndexEndpointDeployedIndexState(
      ...
      indexSyncTime: (() {
        final guardedValue = map['indexSyncTime'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      name: (() {
      ...
      privateEndpoints: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AiIndexEndpointDeployedIndexPrivateEndpoint>(
            guardedValue,
            (value) => AiIndexEndpointDeployedIndexPrivateEndpoint.fromMap(
