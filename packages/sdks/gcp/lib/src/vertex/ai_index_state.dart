...
class AiIndexState {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'indexStats':
          ?pulumi.Input.mapOptionalInputValue<
            List<AiIndexIndexStat>,
            List<Map<String, dynamic>>
          >(
            indexStats,
            (value) =>
                pulumi.Input.encodeList<AiIndexIndexStat, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory AiIndexState.fromMap(Map<String, dynamic> map) {
    return AiIndexState(
      ...
      deployedIndexes: (() {
        final guardedValue = map['deployedIndexes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AiIndexDeployedIndex>(
            guardedValue,
            (value) => AiIndexDeployedIndex.fromMap(
      ...
      indexStats: (() {
        final guardedValue = map['indexStats'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AiIndexIndexStat>(
            guardedValue,
            (value) => AiIndexIndexStat.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
