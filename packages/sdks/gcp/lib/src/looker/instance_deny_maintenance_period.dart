...
class InstanceDenyMaintenancePeriod {
  ...
  factory InstanceDenyMaintenancePeriod.fromMap(Map<String, dynamic> map) {
    return InstanceDenyMaintenancePeriod(
      endDate: pulumi.Input.fromValue(InstanceDenyMaintenancePeriodEndDate.fromMap((map['endDate']! as Map).cast<String, dynamic>())),
      startDate: pulumi.Input.fromValue(InstanceDenyMaintenancePeriodStartDate.fromMap((map['startDate']! as Map).cast<String, dynamic>())),
      time: pulumi.Input.fromValue(InstanceDenyMaintenancePeriodTime.fromMap((map['time']! as Map).cast<String, dynamic>())),
    );
  }
}
