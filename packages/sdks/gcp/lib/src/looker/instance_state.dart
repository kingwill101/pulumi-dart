...
class InstanceState {
  ...
  factory InstanceState.fromMap(Map<String, dynamic> map) {
    return InstanceState(
      ...
      controlledEgressConfig: (() {
        final guardedValue = map['controlledEgressConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      controlledEgressEnabled: (() {
        final guardedValue = map['controlledEgressEnabled'];
        if (guardedValue == null) return null;
      ...
      egressPublicIp: (() {
        final guardedValue = map['egressPublicIp'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      encryptionConfig: (() {
      ...
      geminiEnabled: (() {
        final guardedValue = map['geminiEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      ingressPrivateIp: (() {
        final guardedValue = map['ingressPrivateIp'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ingressPublicIp: (() {
        final guardedValue = map['ingressPublicIp'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      lookerUri: (() {
        final guardedValue = map['lookerUri'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      lookerVersion: (() {
        final guardedValue = map['lookerVersion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      maintenanceWindow: (() {
      ...
      oauthConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          InstanceOauthConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      periodicExportConfig: (() {
        final guardedValue = map['periodicExportConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
