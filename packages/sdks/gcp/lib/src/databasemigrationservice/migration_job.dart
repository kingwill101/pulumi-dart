...
class MigrationJob extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [MigrationJob]. {@macro pulumi_databasemigrationservice_migration_job_migration_job_args_doc}
  ...
  MigrationJob(
    ...
    this.performanceConfig = registerOutput<MigrationJobPerformanceConfig?>('performanceConfig');
    this.phase = registerOutput<String>('phase');
    this.project = registerOutput<String>('project');
    this.pulumiLabels = registerOutput<Map<String, String>>('pulumiLabels');
    this.reverseSshConnectivity = registerOutput<MigrationJobReverseSshConnectivity?>('reverseSshConnectivity');
    this.source = registerOutput<String>('source');
    this.state = registerOutput<String>('state');
    this.staticIpConnectivity = registerOutput<Map<String, dynamic>?>('staticIpConnectivity');
    this.type = registerOutput<String>('type');
    this.vpcPeeringConnectivity = registerOutput<MigrationJobVpcPeeringConnectivity?>('vpcPeeringConnectivity');
  }

  /// Gets an existing [MigrationJob] resource's state with the given [name] and [id].
  static MigrationJob get(
    String name,
