...
class MigrationJobDumpFlags {
  ...
  factory MigrationJobDumpFlags.fromMap(Map<String, dynamic> map) {
    return MigrationJobDumpFlags(
      dumpFlags: (() { final guardedValue = map['dumpFlags']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<MigrationJobDumpFlagsDumpFlag>(guardedValue, (value) => MigrationJobDumpFlagsDumpFlag.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
