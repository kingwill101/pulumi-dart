...
class ConnectionProfileCloudsqlSettings {
  ...
  factory ConnectionProfileCloudsqlSettings.fromMap(Map<String, dynamic> map) {
    return ConnectionProfileCloudsqlSettings(
      ...
      ipConfig: map['ipConfig'] == null ? null : (ConnectionProfileCloudsqlSettingsIpConfig.fromMap((map['ipConfig'] as Map).cast<String, dynamic>())).input(),
      rootPassword: map['rootPassword'] == null ? null : (map['rootPassword'] as String).input(),
      rootPasswordSet: map['rootPasswordSet'] == null ? null : (map['rootPasswordSet'] as bool).input(),
