...
import 'document_ai_warehouse_location_state.dart';
...
class DocumentAiWarehouseLocation extends pulumi.CustomResource {
  ...
  /// Gets an existing [DocumentAiWarehouseLocation] resource's state with the given [name] and [id].
  static DocumentAiWarehouseLocation get(
    String name,
  ...
  DocumentAiWarehouseLocation._get(
    String name, {
