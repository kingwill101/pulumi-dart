...
class PreventionInspectTemplateInspectConfig {
  ...
  final pulumi.Input<
    List<PreventionInspectTemplateInspectConfigCustomInfoType>
  >?
  customInfoTypes;
  ...
  /// Structure is documented below.
  final pulumi.Input<List<PreventionInspectTemplateInspectConfigInfoType>>?
  infoTypes;
  ...
  /// Structure is documented below.
  final pulumi.Input<List<PreventionInspectTemplateInspectConfigRuleSet>>?
  ruleSets;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'infoTypes':
          ?pulumi.Input.mapOptionalInputValue<
            List<PreventionInspectTemplateInspectConfigInfoType>,
            List<Map<String, dynamic>>
          >(
            infoTypes,
            (value) =>
      ...
      'ruleSets':
          ?pulumi.Input.mapOptionalInputValue<
            List<PreventionInspectTemplateInspectConfigRuleSet>,
            List<Map<String, dynamic>>
          >(
            ruleSets,
            (value) =>
