...
class PreventionJobTriggerInspectJobInspectConfigRuleSet {
  ...
  final pulumi.Input<
    List<PreventionJobTriggerInspectJobInspectConfigRuleSetInfoType>
  >?
  infoTypes;
  ...
  /// Structure is documented below.
  final pulumi.Input<
    List<PreventionJobTriggerInspectJobInspectConfigRuleSetRule>
  >
  rules;
      ...
      infoTypes: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                PreventionJobTriggerInspectJobInspectConfigRuleSetInfoType.fromMap(
