...
class PreventionDeidentifyTemplateDeidentifyConfigImageTransformationsTransform {
  ...
  factory PreventionDeidentifyTemplateDeidentifyConfigImageTransformationsTransform.fromMap(Map<String, dynamic> map) {
    return PreventionDeidentifyTemplateDeidentifyConfigImageTransformationsTransform(
      allInfoTypes: (() { final guardedValue = map['allInfoTypes']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, dynamic>()); })(),
      allText: (() { final guardedValue = map['allText']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, dynamic>()); })(),
      redactionColor: (() { final guardedValue = map['redactionColor']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PreventionDeidentifyTemplateDeidentifyConfigImageTransformationsTransformRedactionColor.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      selectedInfoTypes: (() { final guardedValue = map['selectedInfoTypes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PreventionDeidentifyTemplateDeidentifyConfigImageTransformationsTransformSelectedInfoTypes.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
