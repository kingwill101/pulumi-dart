...
class PreventionJobTriggerInspectJobInspectConfigRuleSetRule {
  ...
  factory PreventionJobTriggerInspectJobInspectConfigRuleSetRule.fromMap(Map<String, dynamic> map) {
    return PreventionJobTriggerInspectJobInspectConfigRuleSetRule(
      exclusionRule: (() { final guardedValue = map['exclusionRule']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PreventionJobTriggerInspectJobInspectConfigRuleSetRuleExclusionRule.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      hotwordRule: (() { final guardedValue = map['hotwordRule']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PreventionJobTriggerInspectJobInspectConfigRuleSetRuleHotwordRule.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
