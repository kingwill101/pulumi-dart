...
class PreventionJobTriggerInspectJobStorageConfigDatastoreOptions {
  ...
  factory PreventionJobTriggerInspectJobStorageConfigDatastoreOptions.fromMap(Map<String, dynamic> map) {
    return PreventionJobTriggerInspectJobStorageConfigDatastoreOptions(
      kind: (PreventionJobTriggerInspectJobStorageConfigDatastoreOptionsKind.fromMap((map['kind'] as Map).cast<String, dynamic>())).input(),
      partitionId: (PreventionJobTriggerInspectJobStorageConfigDatastoreOptionsPartitionId.fromMap((map['partitionId'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
