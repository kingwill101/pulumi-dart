...
class PreventionDiscoveryConfigTargetOtherCloudTarget {
  ...
  final pulumi.Input<PreventionDiscoveryConfigTargetOtherCloudTargetConditions>?
  conditions;
  ...
  /// Structure is documented below.
  final pulumi.Input<PreventionDiscoveryConfigTargetOtherCloudTargetFilter>
  filter;
    ...
    return <String, dynamic>{
      ...
      'dataSourceType':
          ?pulumi.Input.mapOptionalInputValue<
            PreventionDiscoveryConfigTargetOtherCloudTargetDataSourceType,
            Map<String, dynamic>
          >(dataSourceType, (value) => value.toMap()),
      'disabled': ?disabled,
      'filter':
  ...
  factory PreventionDiscoveryConfigTargetOtherCloudTarget.fromMap(
    ...
    return PreventionDiscoveryConfigTargetOtherCloudTarget(
      ...
      filter: pulumi.Input.fromValue(
        PreventionDiscoveryConfigTargetOtherCloudTargetFilter.fromMap(
