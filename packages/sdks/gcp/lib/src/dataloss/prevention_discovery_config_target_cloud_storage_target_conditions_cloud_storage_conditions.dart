...
class PreventionDiscoveryConfigTargetCloudStorageTargetConditionsCloudStorageConditions {
  ...
  factory PreventionDiscoveryConfigTargetCloudStorageTargetConditionsCloudStorageConditions.fromMap(Map<String, dynamic> map) {
    return PreventionDiscoveryConfigTargetCloudStorageTargetConditionsCloudStorageConditions(
      includedBucketAttributes: (() { final guardedValue = map['includedBucketAttributes']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      includedObjectAttributes: (() { final guardedValue = map['includedObjectAttributes']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
    );
  }
}
