...
class PreventionJobTriggerInspectJobAction {
  ...
  final pulumi.Input<PreventionJobTriggerInspectJobActionDeidentify>?
  deidentify;
  ...
  /// Structure is documented below.
  final pulumi.Input<PreventionJobTriggerInspectJobActionSaveFindings>?
  saveFindings;
    ...
    return <String, dynamic>{
      ...
      'saveFindings':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(saveFindings, (value) => value.toMap()),
    };
  }
  ...
  factory PreventionJobTriggerInspectJobAction.fromMap(
    ...
    return PreventionJobTriggerInspectJobAction(
      deidentify: (() {
        final guardedValue = map['deidentify'];
      ...
      jobNotificationEmails: (() {
        final guardedValue = map['jobNotificationEmails'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      ...
      publishFindingsToCloudDataCatalog: (() {
        final guardedValue = map['publishFindingsToCloudDataCatalog'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      ...
      publishFindingsToDataplexCatalog: (() {
        final guardedValue = map['publishFindingsToDataplexCatalog'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      ...
      publishSummaryToCscc: (() {
        final guardedValue = map['publishSummaryToCscc'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      ...
      publishToStackdriver: (() {
        final guardedValue = map['publishToStackdriver'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      ...
      saveFindings: (() {
        final guardedValue = map['saveFindings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
