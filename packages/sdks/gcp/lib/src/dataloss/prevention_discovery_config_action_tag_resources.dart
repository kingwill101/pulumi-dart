...
class PreventionDiscoveryConfigActionTagResources {
  ...
  final pulumi.Input<
    List<PreventionDiscoveryConfigActionTagResourcesTagCondition>
  >?
  tagConditions;
  ...
  factory PreventionDiscoveryConfigActionTagResources.fromMap(
    ...
    return PreventionDiscoveryConfigActionTagResources(
      lowerDataRiskToLow: (() {
        final guardedValue = map['lowerDataRiskToLow'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      profileGenerationsToTags: (() {
        final guardedValue = map['profileGenerationsToTags'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      tagConditions: (() {
        final guardedValue = map['tagConditions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                PreventionDiscoveryConfigActionTagResourcesTagCondition.fromMap(
