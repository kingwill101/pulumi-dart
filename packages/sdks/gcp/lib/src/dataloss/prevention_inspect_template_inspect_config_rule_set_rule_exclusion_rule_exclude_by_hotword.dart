...
class PreventionInspectTemplateInspectConfigRuleSetRuleExclusionRuleExcludeByHotword {
  ...
  factory PreventionInspectTemplateInspectConfigRuleSetRuleExclusionRuleExcludeByHotword.fromMap(Map<String, dynamic> map) {
    return PreventionInspectTemplateInspectConfigRuleSetRuleExclusionRuleExcludeByHotword(
      hotwordRegex: (PreventionInspectTemplateInspectConfigRuleSetRuleExclusionRuleExcludeByHotwordHotwordRegex.fromMap((map['hotwordRegex'] as Map).cast<String, dynamic>())).input(),
      proximity: (PreventionInspectTemplateInspectConfigRuleSetRuleExclusionRuleExcludeByHotwordProximity.fromMap((map['proximity'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
