...
class PreventionJobTriggerInspectJobInspectConfigCustomInfoTypeInfoType {
  ...
  const PreventionJobTriggerInspectJobInspectConfigCustomInfoTypeInfoType({
    required this.name,
  ...
  factory PreventionJobTriggerInspectJobInspectConfigCustomInfoTypeInfoType.fromMap(Map<String, dynamic> map) {
    return PreventionJobTriggerInspectJobInspectConfigCustomInfoTypeInfoType(
      ...
      sensitivityScore: (() { final guardedValue = map['sensitivityScore']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PreventionJobTriggerInspectJobInspectConfigCustomInfoTypeInfoTypeSensitivityScore.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
