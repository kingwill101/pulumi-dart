...
class PreventionDiscoveryConfigTargetBigQueryTargetConditions {
  ...
  factory PreventionDiscoveryConfigTargetBigQueryTargetConditions.fromMap(Map<String, dynamic> map) {
    return PreventionDiscoveryConfigTargetBigQueryTargetConditions(
      ...
      orConditions: (() { final guardedValue = map['orConditions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PreventionDiscoveryConfigTargetBigQueryTargetConditionsOrConditions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      typeCollection: (() { final guardedValue = map['typeCollection']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      types: (() { final guardedValue = map['types']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PreventionDiscoveryConfigTargetBigQueryTargetConditionsTypes.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
