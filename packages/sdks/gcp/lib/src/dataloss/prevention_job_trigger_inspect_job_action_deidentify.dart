...
class PreventionJobTriggerInspectJobActionDeidentify {
  ...
  factory PreventionJobTriggerInspectJobActionDeidentify.fromMap(Map<String, dynamic> map) {
    return PreventionJobTriggerInspectJobActionDeidentify(
      ...
      fileTypesToTransforms: (() { final guardedValue = map['fileTypesToTransforms']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      transformationConfig: (() { final guardedValue = map['transformationConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PreventionJobTriggerInspectJobActionDeidentifyTransformationConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      transformationDetailsStorageConfig: (() { final guardedValue = map['transformationDetailsStorageConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PreventionJobTriggerInspectJobActionDeidentifyTransformationDetailsStorageConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
