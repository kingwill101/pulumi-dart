...
class PreventionInspectTemplateInspectConfigCustomInfoTypeRegex {
  ...
  const PreventionInspectTemplateInspectConfigCustomInfoTypeRegex({
    this.groupIndexes,
  ...
  factory PreventionInspectTemplateInspectConfigCustomInfoTypeRegex.fromMap(Map<String, dynamic> map) {
