...
class PreventionJobTriggerInspectJobInspectConfig {
  ...
  factory PreventionJobTriggerInspectJobInspectConfig.fromMap(Map<String, dynamic> map) {
    return PreventionJobTriggerInspectJobInspectConfig(
      customInfoTypes: (() { final guardedValue = map['customInfoTypes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PreventionJobTriggerInspectJobInspectConfigCustomInfoType>(guardedValue, (value) => PreventionJobTriggerInspectJobInspectConfigCustomInfoType.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      infoTypes: (() { final guardedValue = map['infoTypes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PreventionJobTriggerInspectJobInspectConfigInfoType>(guardedValue, (value) => PreventionJobTriggerInspectJobInspectConfigInfoType.fromMap((value as Map).cast<String, dynamic>()))); })(),
      limits: (() { final guardedValue = map['limits']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PreventionJobTriggerInspectJobInspectConfigLimits.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      ruleSets: (() { final guardedValue = map['ruleSets']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PreventionJobTriggerInspectJobInspectConfigRuleSet>(guardedValue, (value) => PreventionJobTriggerInspectJobInspectConfigRuleSet.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
