...
class PreventionJobTriggerInspectJobInspectConfig {
  ...
  final pulumi.Input<
    List<PreventionJobTriggerInspectJobInspectConfigCustomInfoType>
  >?
  customInfoTypes;
  ...
  /// Structure is documented below.
  final pulumi.Input<List<PreventionJobTriggerInspectJobInspectConfigInfoType>>?
  infoTypes;
  ...
  /// Structure is documented below.
  final pulumi.Input<List<PreventionJobTriggerInspectJobInspectConfigRuleSet>>?
  ruleSets;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'infoTypes':
          ?pulumi.Input.mapOptionalInputValue<
            List<PreventionJobTriggerInspectJobInspectConfigInfoType>,
            List<Map<String, dynamic>>
          >(
            infoTypes,
            (value) =>
      ...
      'ruleSets':
          ?pulumi.Input.mapOptionalInputValue<
            List<PreventionJobTriggerInspectJobInspectConfigRuleSet>,
            List<Map<String, dynamic>>
          >(
            ruleSets,
            (value) =>
