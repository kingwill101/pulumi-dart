...
class PreventionDiscoveryConfigTargetCloudStorageTargetGenerationCadence {
  ...
  const PreventionDiscoveryConfigTargetCloudStorageTargetGenerationCadence({
  ...
  factory PreventionDiscoveryConfigTargetCloudStorageTargetGenerationCadence.fromMap(Map<String, dynamic> map) {
    return PreventionDiscoveryConfigTargetCloudStorageTargetGenerationCadence(
      inspectTemplateModifiedCadence: (() { final guardedValue = map['inspectTemplateModifiedCadence']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PreventionDiscoveryConfigTargetCloudStorageTargetGenerationCadenceInspectTemplateModifiedCadence.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
