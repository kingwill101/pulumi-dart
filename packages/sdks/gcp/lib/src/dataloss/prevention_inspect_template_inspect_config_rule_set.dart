...
class PreventionInspectTemplateInspectConfigRuleSet {
  ...
  factory PreventionInspectTemplateInspectConfigRuleSet.fromMap(Map<String, dynamic> map) {
    return PreventionInspectTemplateInspectConfigRuleSet(
      infoTypes: (pulumi.Input.decodeList<PreventionInspectTemplateInspectConfigRuleSetInfoType>(map['infoTypes'], (value) => PreventionInspectTemplateInspectConfigRuleSetInfoType.fromMap((value as Map).cast<String, dynamic>()))).input(),
      rules: (pulumi.Input.decodeList<PreventionInspectTemplateInspectConfigRuleSetRule>(map['rules'], (value) => PreventionInspectTemplateInspectConfigRuleSetRule.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
