...
class PreventionInspectTemplateInspectConfigRuleSet {
  ...
  final pulumi.Input<
    List<PreventionInspectTemplateInspectConfigRuleSetInfoType>
  >
  infoTypes;

  /// Set of rules to be applied to infoTypes. The rules are applied in order.
  /// Structure is documented below.
  final pulumi.Input<List<PreventionInspectTemplateInspectConfigRuleSetRule>>
  rules;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'rules':
          pulumi.Input.mapInputValue<
            List<PreventionInspectTemplateInspectConfigRuleSetRule>,
            List<Map<String, dynamic>>
          >(
            rules,
            (value) =>
