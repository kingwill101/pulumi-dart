...
class PreventionJobTriggerInspectJobStorageConfigBigQueryOptions {
  ...
  factory PreventionJobTriggerInspectJobStorageConfigBigQueryOptions.fromMap(Map<String, dynamic> map) {
    return PreventionJobTriggerInspectJobStorageConfigBigQueryOptions(
      ...
      rowsLimit: (() { final guardedValue = map['rowsLimit']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      rowsLimitPercent: (() { final guardedValue = map['rowsLimitPercent']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
