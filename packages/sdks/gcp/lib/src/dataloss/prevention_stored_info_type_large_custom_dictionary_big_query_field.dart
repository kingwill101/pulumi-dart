...
class PreventionStoredInfoTypeLargeCustomDictionaryBigQueryField {
  ...
  factory PreventionStoredInfoTypeLargeCustomDictionaryBigQueryField.fromMap(Map<String, dynamic> map) {
    return PreventionStoredInfoTypeLargeCustomDictionaryBigQueryField(
      field: pulumi.Input.fromValue(PreventionStoredInfoTypeLargeCustomDictionaryBigQueryFieldField.fromMap((map['field']! as Map).cast<String, dynamic>())),
      table: pulumi.Input.fromValue(PreventionStoredInfoTypeLargeCustomDictionaryBigQueryFieldTable.fromMap((map['table']! as Map).cast<String, dynamic>())),
    );
  }
}
