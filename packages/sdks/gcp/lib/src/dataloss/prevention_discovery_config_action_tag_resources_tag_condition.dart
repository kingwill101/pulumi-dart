...
class PreventionDiscoveryConfigActionTagResourcesTagCondition {
  ...
  factory PreventionDiscoveryConfigActionTagResourcesTagCondition.fromMap(Map<String, dynamic> map) {
    return PreventionDiscoveryConfigActionTagResourcesTagCondition(
      sensitivityScore: (() { final guardedValue = map['sensitivityScore']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PreventionDiscoveryConfigActionTagResourcesTagConditionSensitivityScore.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      tag: (() { final guardedValue = map['tag']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PreventionDiscoveryConfigActionTagResourcesTagConditionTag.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
