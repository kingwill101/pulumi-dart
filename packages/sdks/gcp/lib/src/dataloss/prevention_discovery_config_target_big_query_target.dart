...
class PreventionDiscoveryConfigTargetBigQueryTarget {
  ...
  final pulumi.Input<PreventionDiscoveryConfigTargetBigQueryTargetCadence>?
  cadence;

  /// In addition to matching the filter, these conditions must be true before a profile is generated
  /// Structure is documented below.
  final pulumi.Input<PreventionDiscoveryConfigTargetBigQueryTargetConditions>?
  conditions;
  ...
  /// Structure is documented below.
  final pulumi.Input<PreventionDiscoveryConfigTargetBigQueryTargetFilter>?
  filter;
