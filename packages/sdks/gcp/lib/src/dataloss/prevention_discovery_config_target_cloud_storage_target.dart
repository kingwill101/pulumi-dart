...
class PreventionDiscoveryConfigTargetCloudStorageTarget {
  ...
  /// [filter] The buckets the generationCadence applies to. The first target with a matching filter will be the one to apply to a bucket.
  ...
  factory PreventionDiscoveryConfigTargetCloudStorageTarget.fromMap(Map<String, dynamic> map) {
    return PreventionDiscoveryConfigTargetCloudStorageTarget(
      conditions: (() { final guardedValue = map['conditions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PreventionDiscoveryConfigTargetCloudStorageTargetConditions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      filter: pulumi.Input.fromValue(PreventionDiscoveryConfigTargetCloudStorageTargetFilter.fromMap((map['filter']! as Map).cast<String, dynamic>())),
      generationCadence: (() { final guardedValue = map['generationCadence']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PreventionDiscoveryConfigTargetCloudStorageTargetGenerationCadence.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
