...
class PreventionDiscoveryConfigTarget {
  ...
  factory PreventionDiscoveryConfigTarget.fromMap(Map<String, dynamic> map) {
    return PreventionDiscoveryConfigTarget(
      bigQueryTarget: (() { final guardedValue = map['bigQueryTarget']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PreventionDiscoveryConfigTargetBigQueryTarget.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      cloudSqlTarget: (() { final guardedValue = map['cloudSqlTarget']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PreventionDiscoveryConfigTargetCloudSqlTarget.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      cloudStorageTarget: (() { final guardedValue = map['cloudStorageTarget']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PreventionDiscoveryConfigTargetCloudStorageTarget.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      otherCloudTarget: (() { final guardedValue = map['otherCloudTarget']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PreventionDiscoveryConfigTargetOtherCloudTarget.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      secretsTarget: (() { final guardedValue = map['secretsTarget']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, dynamic>()); })(),
    );
  }
}
