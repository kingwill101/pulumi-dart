...
class PreventionDiscoveryConfigTarget {
  ...
  final pulumi.Input<PreventionDiscoveryConfigTargetBigQueryTarget>?
  bigQueryTarget;

  /// Cloud SQL target for Discovery. The first target to match a table will be the one applied.
  /// Structure is documented below.
  final pulumi.Input<PreventionDiscoveryConfigTargetCloudSqlTarget>?
  cloudSqlTarget;

  /// Cloud Storage target for Discovery. The first target to match a bucket will be the one applied.
  /// Structure is documented below.
  final pulumi.Input<PreventionDiscoveryConfigTargetCloudStorageTarget>?
  cloudStorageTarget;

  /// Other clouds target for discovery. The first target to match a resource will be the one applied.
  /// Structure is documented below.
  final pulumi.Input<PreventionDiscoveryConfigTargetOtherCloudTarget>?
  otherCloudTarget;
    ...
    return <String, dynamic>{
      ...
      'cloudSqlTarget':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(cloudSqlTarget, (value) => value.toMap()),
      'cloudStorageTarget':
          ?pulumi.Input.mapOptionalInputValue<
            PreventionDiscoveryConfigTargetCloudStorageTarget,
            Map<String, dynamic>
          >(cloudStorageTarget, (value) => value.toMap()),
      'otherCloudTarget':
          ?pulumi.Input.mapOptionalInputValue<
            PreventionDiscoveryConfigTargetOtherCloudTarget,
            Map<String, dynamic>
          >(otherCloudTarget, (value) => value.toMap()),
  ...
  factory PreventionDiscoveryConfigTarget.fromMap(Map<String, dynamic> map) {
    return PreventionDiscoveryConfigTarget(
      ...
      cloudSqlTarget: (() {
        final guardedValue = map['cloudSqlTarget'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      cloudStorageTarget: (() {
        final guardedValue = map['cloudStorageTarget'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      otherCloudTarget: (() {
        final guardedValue = map['otherCloudTarget'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      secretsTarget: (() {
        final guardedValue = map['secretsTarget'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as Map).cast<String, dynamic>(),
        );
