...
class PreventionDiscoveryConfigTargetBigQueryTargetFilter {
  ...
  const PreventionDiscoveryConfigTargetBigQueryTargetFilter({
    this.otherTables,
    this.tableReference,
    this.tables,
  });
  ...
  factory PreventionDiscoveryConfigTargetBigQueryTargetFilter.fromMap(Map<String, dynamic> map) {
    return PreventionDiscoveryConfigTargetBigQueryTargetFilter(
      ...
      tableReference: (() { final guardedValue = map['tableReference']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PreventionDiscoveryConfigTargetBigQueryTargetFilterTableReference.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      tables: (() { final guardedValue = map['tables']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PreventionDiscoveryConfigTargetBigQueryTargetFilterTables.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
