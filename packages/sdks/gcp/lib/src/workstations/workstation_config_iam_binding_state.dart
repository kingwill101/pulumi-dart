...
class WorkstationConfigIamBindingState {
  ...
  /// Creates a new [WorkstationConfigIamBindingState].
  /// [condition] Optional.
  ...
  const WorkstationConfigIamBindingState({
    this.condition,
    this.etag,
    this.location,
    this.members,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'condition': ?pulumi.Input.mapOptionalInputValue<WorkstationConfigIamBindingCondition, Map<String, dynamic>>(condition, (value) => value.toMap()),
      'etag': ?etag,
      'location': ?location,
      'members': ?members,
      'project': ?project,
  ...
  factory WorkstationConfigIamBindingState.fromMap(Map<String, dynamic> map) {
    return WorkstationConfigIamBindingState(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WorkstationConfigIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
