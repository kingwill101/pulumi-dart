...
class WorkstationConfigHostGceInstance {
  ...
  final pulumi.Input<List<WorkstationConfigHostGceInstanceAccelerator>>?
  accelerators;

  /// A list of the boost configurations that workstations created using this workstation configuration are allowed to use.
  /// Structure is documented below.
  final pulumi.Input<List<WorkstationConfigHostGceInstanceBoostConfig>>?
  boostConfigs;
  ...
  /// Structure is documented below.
  final pulumi.Input<WorkstationConfigHostGceInstanceShieldedInstanceConfig>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'boostConfigs':
          ?pulumi.Input.mapOptionalInputValue<
            List<WorkstationConfigHostGceInstanceBoostConfig>,
            List<Map<String, dynamic>>
          >(
            boostConfigs,
            (value) =>
    ...
    return WorkstationConfigHostGceInstance(
      accelerators: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<WorkstationConfigHostGceInstanceAccelerator>(
            guardedValue,
      ...
      boostConfigs: (() {
        final guardedValue = map['boostConfigs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<WorkstationConfigHostGceInstanceBoostConfig>(
            guardedValue,
      ...
      disablePublicIpAddresses: (() {
        final guardedValue = map['disablePublicIpAddresses'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      disableSsh: (() {
        final guardedValue = map['disableSsh'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      ...
      poolSize: (() {
        final guardedValue = map['poolSize'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      serviceAccount: (() {
