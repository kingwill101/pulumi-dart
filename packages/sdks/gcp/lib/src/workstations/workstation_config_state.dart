...
class WorkstationConfigState {
  ...
  factory WorkstationConfigState.fromMap(Map<String, dynamic> map) {
    return WorkstationConfigState(
      ...
      conditions: map['conditions'] == null ? null : (pulumi.Input.decodeList<WorkstationConfigCondition>(map['conditions']!, (value) => WorkstationConfigCondition.fromMap((value as Map).cast<String, dynamic>()))).input(),
