    ...
    return <String, dynamic>{
      'allowedPorts':
          ?pulumi.Input.mapOptionalInputValue<
            List<WorkstationConfigAllowedPort>,
      ...
      'conditions':
          ?pulumi.Input.mapOptionalInputValue<
            List<WorkstationConfigCondition>,
            List<Map<String, dynamic>>
          >(
            conditions,
            (value) =>
  ...
  factory WorkstationConfigState.fromMap(Map<String, dynamic> map) {
    return WorkstationConfigState(
      ...
      conditions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<WorkstationConfigCondition>(
            guardedValue,
            (value) => WorkstationConfigCondition.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      disableTcpConnections: (() {
        final guardedValue = map['disableTcpConnections'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      displayName: (() {
      ...
      enableAuditAgent: (() {
        final guardedValue = map['enableAuditAgent'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      encryptionKey: (() {
      ...
      ephemeralDirectories: (() {
        final guardedValue = map['ephemeralDirectories'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      maxUsableWorkstations: (() {
        final guardedValue = map['maxUsableWorkstations'];
        if (guardedValue == null) return null;
      ...
      workstationConfigId: (() {
        final guardedValue = map['workstationConfigId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
