...
import 'workstation_iam_binding_state.dart';
...
class WorkstationIamBinding extends pulumi.CustomResource {
  ...
  WorkstationIamBinding(
    ...
    condition = registerOutput<WorkstationIamBindingCondition?>(
      'condition',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return WorkstationIamBindingCondition.fromMap(
  ...
  /// Gets an existing [WorkstationIamBinding] resource's state with the given [name] and [id].
  static WorkstationIamBinding get(
    String name,
