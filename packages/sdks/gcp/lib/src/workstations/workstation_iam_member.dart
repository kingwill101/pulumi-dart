...
import 'workstation_iam_member_args.dart';
import 'workstation_iam_member_condition.dart';
import 'workstation_iam_member_state.dart';
...
class WorkstationIamMember extends pulumi.CustomResource {
  late final pulumi.Output<WorkstationIamMemberCondition?> condition;
  ...
  /// Creates a new [WorkstationIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [WorkstationIamMember]. {@macro pulumi_workstations_workstation_iam_member_workstation_iam_member_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  WorkstationIamMember(
    String name, {
    WorkstationIamMemberArgs? args,
    ...
    condition = registerOutput<WorkstationIamMemberCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return WorkstationIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [WorkstationIamMember] resource's state with the given [name] and [id].
  static WorkstationIamMember get(
    String name,
    pulumi.Input<String> id, {
    WorkstationIamMemberState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return WorkstationIamMember._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [WorkstationIamMember] resource.
  WorkstationIamMember.reference(String urn)
    : super(
        'gcp:workstations/workstationIamMember:WorkstationIamMember',
