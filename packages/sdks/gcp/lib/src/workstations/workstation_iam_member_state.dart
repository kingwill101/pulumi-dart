...
class WorkstationIamMemberState {
  ...
  /// Creates a new [WorkstationIamMemberState].
  /// [condition] Optional.
  ...
  const WorkstationIamMemberState({
    this.condition,
    this.etag,
    this.location,
    this.member,
  ...
  factory WorkstationIamMemberState.fromMap(Map<String, dynamic> map) {
    return WorkstationIamMemberState(
