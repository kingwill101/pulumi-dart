...
class Workstation extends pulumi.CustomResource {
  ...
  Workstation(
    ...
    env = registerOutput<Map<String, String>?>('env', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return (guardedValue as Map).cast<String, String>(); });
  ...
  static Workstation get(
    String name,
    pulumi.Input<String> id, {
    WorkstationState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return Workstation._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [Workstation] resource.
  Workstation.reference(String urn)
    : super(
        'gcp:workstations/workstation:Workstation',
