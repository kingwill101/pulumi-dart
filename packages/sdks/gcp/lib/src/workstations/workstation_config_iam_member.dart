...
import 'workstation_config_iam_member_state.dart';
...
class WorkstationConfigIamMember extends pulumi.CustomResource {
  ...
  WorkstationConfigIamMember(
    ...
    condition = registerOutput<WorkstationConfigIamMemberCondition?>(
      'condition',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return WorkstationConfigIamMemberCondition.fromMap(
  ...
  /// Gets an existing [WorkstationConfigIamMember] resource's state with the given [name] and [id].
  static WorkstationConfigIamMember get(
    String name,
  ...
  WorkstationConfigIamMember._get(
    String name, {
