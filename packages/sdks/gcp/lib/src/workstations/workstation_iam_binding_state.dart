...
class WorkstationIamBindingState {
  ...
  const WorkstationIamBindingState({
    this.condition,
    this.etag,
    this.location,
    this.members,
  ...
  factory WorkstationIamBindingState.fromMap(Map<String, dynamic> map) {
    return WorkstationIamBindingState(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WorkstationIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
