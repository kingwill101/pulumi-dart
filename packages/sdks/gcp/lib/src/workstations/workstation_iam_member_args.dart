...
class WorkstationIamMemberArgs {
  ...
  factory WorkstationIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return WorkstationIamMemberArgs(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WorkstationIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
