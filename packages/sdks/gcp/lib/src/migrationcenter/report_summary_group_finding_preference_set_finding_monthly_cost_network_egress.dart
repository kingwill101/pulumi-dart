...
class ReportSummaryGroupFindingPreferenceSetFindingMonthlyCostNetworkEgress {
  /// (Output)
  ...
  /// Creates a new [ReportSummaryGroupFindingPreferenceSetFindingMonthlyCostNetworkEgress].
  /// [currencyCode] (Output)
  /// [nanos] (Output)
  /// [units] (Output)
  const ReportSummaryGroupFindingPreferenceSetFindingMonthlyCostNetworkEgress({
    this.currencyCode,
    this.nanos,
    this.units,
  });
  ...
  factory ReportSummaryGroupFindingPreferenceSetFindingMonthlyCostNetworkEgress.fromMap(Map<String, dynamic> map) {
    return ReportSummaryGroupFindingPreferenceSetFindingMonthlyCostNetworkEgress(
