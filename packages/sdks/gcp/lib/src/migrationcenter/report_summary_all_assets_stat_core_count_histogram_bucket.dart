...
class ReportSummaryAllAssetsStatCoreCountHistogramBucket {
  /// (Output)
  ...
  /// Creates a new [ReportSummaryAllAssetsStatCoreCountHistogramBucket].
  /// [count] (Output)
  /// [lowerBound] (Output)
  /// [upperBound] (Output)
  const ReportSummaryAllAssetsStatCoreCountHistogramBucket({
    this.count,
    this.lowerBound,
    this.upperBound,
  });
  ...
  factory ReportSummaryAllAssetsStatCoreCountHistogramBucket.fromMap(Map<String, dynamic> map) {
    return ReportSummaryAllAssetsStatCoreCountHistogramBucket(
