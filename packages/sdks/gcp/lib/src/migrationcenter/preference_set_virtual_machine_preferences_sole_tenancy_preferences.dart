...
class PreferenceSetVirtualMachinePreferencesSoleTenancyPreferences {
  ...
  final List<PreferenceSetVirtualMachinePreferencesSoleTenancyPreferencesNodeType>? nodeTypes;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'nodeTypes': ?nodeTypes == null ? null : pulumi.Input.encodeList<PreferenceSetVirtualMachinePreferencesSoleTenancyPreferencesNodeType, Map<String, dynamic>>(nodeTypes!, (value) => value.toMap()),
    };
  }
  ...
  factory PreferenceSetVirtualMachinePreferencesSoleTenancyPreferences.fromMap(Map<String, dynamic> map) {
    return PreferenceSetVirtualMachinePreferencesSoleTenancyPreferences(
      ...
      hostMaintenancePolicy: map['hostMaintenancePolicy'] == null ? null : map['hostMaintenancePolicy'] as String,
      nodeTypes: map['nodeTypes'] == null ? null : pulumi.Input.decodeList<PreferenceSetVirtualMachinePreferencesSoleTenancyPreferencesNodeType>(map['nodeTypes'], (value) => PreferenceSetVirtualMachinePreferencesSoleTenancyPreferencesNodeType.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
