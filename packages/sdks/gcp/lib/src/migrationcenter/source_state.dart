...
class SourceState {
  ...
  factory SourceState.fromMap(Map<String, dynamic> map) {
    return SourceState(
      ...
      errorFrameCount: (() { final guardedValue = map['errorFrameCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      ...
      pendingFrameCount: (() { final guardedValue = map['pendingFrameCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
