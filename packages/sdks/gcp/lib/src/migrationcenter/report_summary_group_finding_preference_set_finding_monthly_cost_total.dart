...
class ReportSummaryGroupFindingPreferenceSetFindingMonthlyCostTotal {
  /// (Output)
  ...
  /// Creates a new [ReportSummaryGroupFindingPreferenceSetFindingMonthlyCostTotal].
  /// [currencyCode] (Output)
  /// [nanos] (Output)
  /// [units] (Output)
  const ReportSummaryGroupFindingPreferenceSetFindingMonthlyCostTotal({
    this.currencyCode,
    this.nanos,
    this.units,
  });
  ...
  factory ReportSummaryGroupFindingPreferenceSetFindingMonthlyCostTotal.fromMap(Map<String, dynamic> map) {
    return ReportSummaryGroupFindingPreferenceSetFindingMonthlyCostTotal(
