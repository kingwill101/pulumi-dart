...
class ReportSummaryGroupFindingPreferenceSetFindingMonthlyCostCompute {
  /// (Output)
  ...
  /// Creates a new [ReportSummaryGroupFindingPreferenceSetFindingMonthlyCostCompute].
  /// [currencyCode] (Output)
  /// [nanos] (Output)
  /// [units] (Output)
  const ReportSummaryGroupFindingPreferenceSetFindingMonthlyCostCompute({
    this.currencyCode,
    this.nanos,
    this.units,
  });
  ...
  factory ReportSummaryGroupFindingPreferenceSetFindingMonthlyCostCompute.fromMap(Map<String, dynamic> map) {
    return ReportSummaryGroupFindingPreferenceSetFindingMonthlyCostCompute(
