...
class ReportConfigState {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'groupPreferencesetAssignments': ?pulumi.Input.mapOptionalInputValue<List<ReportConfigGroupPreferencesetAssignment>, List<Map<String, dynamic>>>(groupPreferencesetAssignments, (value) => pulumi.Input.encodeList<ReportConfigGroupPreferencesetAssignment, Map<String, dynamic>>(value, (value) => value.toMap())),
      'location': ?location,
      'name': ?name,
      'project': ?project,
  ...
  factory ReportConfigState.fromMap(Map<String, dynamic> map) {
    return ReportConfigState(
      createTime: (() { final guardedValue = map['createTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      deletionPolicy: (() { final guardedValue = map['deletionPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      description: (() { final guardedValue = map['description']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      displayName: (() { final guardedValue = map['displayName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      groupPreferencesetAssignments: (() { final guardedValue = map['groupPreferencesetAssignments']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ReportConfigGroupPreferencesetAssignment>(guardedValue, (value) => ReportConfigGroupPreferencesetAssignment.fromMap((value as Map).cast<String, dynamic>()))); })(),
      location: (() { final guardedValue = map['location']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      project: (() { final guardedValue = map['project']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      reportConfigId: (() { final guardedValue = map['reportConfigId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
