...
class PreferenceSetVirtualMachinePreferences {
  ...
  factory PreferenceSetVirtualMachinePreferences.fromMap(Map<String, dynamic> map) {
    return PreferenceSetVirtualMachinePreferences(
      ...
      computeEnginePreferences: (() { final guardedValue = map['computeEnginePreferences']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PreferenceSetVirtualMachinePreferencesComputeEnginePreferences.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      regionPreferences: (() { final guardedValue = map['regionPreferences']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PreferenceSetVirtualMachinePreferencesRegionPreferences.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      soleTenancyPreferences: (() { final guardedValue = map['soleTenancyPreferences']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PreferenceSetVirtualMachinePreferencesSoleTenancyPreferences.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      vmwareEnginePreferences: (() { final guardedValue = map['vmwareEnginePreferences']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PreferenceSetVirtualMachinePreferencesVmwareEnginePreferences.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
