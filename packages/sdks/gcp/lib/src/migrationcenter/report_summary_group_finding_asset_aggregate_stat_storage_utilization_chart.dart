...
class ReportSummaryGroupFindingAssetAggregateStatStorageUtilizationChart {
  ...
  /// [free] (Output)
  /// [used] (Output)
  const ReportSummaryGroupFindingAssetAggregateStatStorageUtilizationChart({
    this.free,
    this.used,
  });
  ...
  factory ReportSummaryGroupFindingAssetAggregateStatStorageUtilizationChart.fromMap(Map<String, dynamic> map) {
    return ReportSummaryGroupFindingAssetAggregateStatStorageUtilizationChart(
