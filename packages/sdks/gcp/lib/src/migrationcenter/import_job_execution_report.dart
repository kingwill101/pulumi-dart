...
class ImportJobExecutionReport {
  ...
  factory ImportJobExecutionReport.fromMap(Map<String, dynamic> map) {
    return ImportJobExecutionReport(
      ...
      framesReported: (() { final guardedValue = map['framesReported']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      totalRowsCount: (() { final guardedValue = map['totalRowsCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
    );
  }
}
