...
class AssetsExportJobRecentExecutionResultError {
  /// (Output)
  ...
  /// Creates a new [AssetsExportJobRecentExecutionResultError].
  /// [code] (Output)
  /// [details] (Output)
  /// [message] (Output)
  const AssetsExportJobRecentExecutionResultError({
    this.code,
    this.details,
    this.message,
  });
  ...
  factory AssetsExportJobRecentExecutionResultError.fromMap(Map<String, dynamic> map) {
    return AssetsExportJobRecentExecutionResultError(
