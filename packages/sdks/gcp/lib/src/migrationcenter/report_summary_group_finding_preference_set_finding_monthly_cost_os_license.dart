...
class ReportSummaryGroupFindingPreferenceSetFindingMonthlyCostOsLicense {
  /// (Output)
  ...
  /// Creates a new [ReportSummaryGroupFindingPreferenceSetFindingMonthlyCostOsLicense].
  /// [currencyCode] (Output)
  /// [nanos] (Output)
  /// [units] (Output)
  const ReportSummaryGroupFindingPreferenceSetFindingMonthlyCostOsLicense({
    this.currencyCode,
    this.nanos,
    this.units,
  });
  ...
  factory ReportSummaryGroupFindingPreferenceSetFindingMonthlyCostOsLicense.fromMap(Map<String, dynamic> map) {
    return ReportSummaryGroupFindingPreferenceSetFindingMonthlyCostOsLicense(
