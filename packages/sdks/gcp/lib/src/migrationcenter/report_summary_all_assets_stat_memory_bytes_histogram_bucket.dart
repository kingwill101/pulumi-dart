...
class ReportSummaryAllAssetsStatMemoryBytesHistogramBucket {
  /// (Output)
  ...
  /// Creates a new [ReportSummaryAllAssetsStatMemoryBytesHistogramBucket].
  /// [count] (Output)
  /// [lowerBound] (Output)
  /// [upperBound] (Output)
  const ReportSummaryAllAssetsStatMemoryBytesHistogramBucket({
    this.count,
    this.lowerBound,
    this.upperBound,
  });
  ...
  factory ReportSummaryAllAssetsStatMemoryBytesHistogramBucket.fromMap(Map<String, dynamic> map) {
    return ReportSummaryAllAssetsStatMemoryBytesHistogramBucket(
