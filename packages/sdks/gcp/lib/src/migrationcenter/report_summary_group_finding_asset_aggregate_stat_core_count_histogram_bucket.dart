...
class ReportSummaryGroupFindingAssetAggregateStatCoreCountHistogramBucket {
  /// (Output)
  ...
  /// Creates a new [ReportSummaryGroupFindingAssetAggregateStatCoreCountHistogramBucket].
  /// [count] (Output)
  /// [lowerBound] (Output)
  /// [upperBound] (Output)
  const ReportSummaryGroupFindingAssetAggregateStatCoreCountHistogramBucket({
    this.count,
    this.lowerBound,
    this.upperBound,
  });
  ...
  factory ReportSummaryGroupFindingAssetAggregateStatCoreCountHistogramBucket.fromMap(Map<String, dynamic> map) {
    return ReportSummaryGroupFindingAssetAggregateStatCoreCountHistogramBucket(
