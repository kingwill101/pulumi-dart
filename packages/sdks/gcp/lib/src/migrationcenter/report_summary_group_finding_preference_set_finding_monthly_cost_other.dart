...
class ReportSummaryGroupFindingPreferenceSetFindingMonthlyCostOther {
  /// (Output)
  ...
  /// Creates a new [ReportSummaryGroupFindingPreferenceSetFindingMonthlyCostOther].
  /// [currencyCode] (Output)
  /// [nanos] (Output)
  /// [units] (Output)
  const ReportSummaryGroupFindingPreferenceSetFindingMonthlyCostOther({
    this.currencyCode,
    this.nanos,
    this.units,
  });
  ...
  factory ReportSummaryGroupFindingPreferenceSetFindingMonthlyCostOther.fromMap(Map<String, dynamic> map) {
    return ReportSummaryGroupFindingPreferenceSetFindingMonthlyCostOther(
