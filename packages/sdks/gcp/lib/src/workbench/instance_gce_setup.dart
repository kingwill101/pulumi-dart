...
class InstanceGceSetup {
  ...
  final pulumi.Input<List<InstanceGceSetupAcceleratorConfig>>?
  acceleratorConfigs;
  ...
  /// Structure is documented below.
  final pulumi.Input<InstanceGceSetupConfidentialInstanceConfig>?
  ...
  /// Structure is documented below.
  final pulumi.Input<InstanceGceSetupShieldedInstanceConfig>?
    ...
    return <String, dynamic>{
      'acceleratorConfigs':
          ?pulumi.Input.mapOptionalInputValue<
            List<InstanceGceSetupAcceleratorConfig>,
      ...
      'networkInterfaces':
          ?pulumi.Input.mapOptionalInputValue<
            List<InstanceGceSetupNetworkInterface>,
            List<Map<String, dynamic>>
          >(
            networkInterfaces,
            (value) =>
      ...
      'serviceAccounts':
          ?pulumi.Input.mapOptionalInputValue<
            List<InstanceGceSetupServiceAccount>,
            List<Map<String, dynamic>>
          >(
            serviceAccounts,
            (value) =>
