...
class GetInstanceAutoscalingConfigAsymmetricAutoscalingOptionOverride {
  ...
  factory GetInstanceAutoscalingConfigAsymmetricAutoscalingOptionOverride.fromMap(Map<String, dynamic> map) {
    return GetInstanceAutoscalingConfigAsymmetricAutoscalingOptionOverride(
      autoscalingLimits: (pulumi.Input.decodeList<GetInstanceAutoscalingConfigAsymmetricAutoscalingOptionOverrideAutoscalingLimit>(map['autoscalingLimits'], (value) => GetInstanceAutoscalingConfigAsymmetricAutoscalingOptionOverrideAutoscalingLimit.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
