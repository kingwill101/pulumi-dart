...
class GetInstanceAutoscalingConfig {
  ...
  final pulumi.Input<
    List<GetInstanceAutoscalingConfigAsymmetricAutoscalingOption>
  >
  ...
  final pulumi.Input<List<GetInstanceAutoscalingConfigAutoscalingLimit>>
  autoscalingLimits;

  /// Defines scale in controls to reduce the risk of response latency
  /// and outages due to abrupt scale-in events
  final pulumi.Input<List<GetInstanceAutoscalingConfigAutoscalingTarget>>
  autoscalingTargets;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'autoscalingLimits':
          pulumi.Input.mapInputValue<
            List<GetInstanceAutoscalingConfigAutoscalingLimit>,
            List<Map<String, dynamic>>
          >(
            autoscalingLimits,
            (value) =>
      ...
      'autoscalingTargets':
          pulumi.Input.mapInputValue<
            List<GetInstanceAutoscalingConfigAutoscalingTarget>,
            List<Map<String, dynamic>>
          >(
            autoscalingTargets,
            (value) =>
  ...
  factory GetInstanceAutoscalingConfig.fromMap(Map<String, dynamic> map) {
    return GetInstanceAutoscalingConfig(
      asymmetricAutoscalingOptions: pulumi.Input.fromValue(
      ...
      autoscalingTargets: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetInstanceAutoscalingConfigAutoscalingTarget>(
