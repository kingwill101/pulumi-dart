...
class GetInstanceAutoscalingConfig {
  ...
  factory GetInstanceAutoscalingConfig.fromMap(Map<String, dynamic> map) {
    return GetInstanceAutoscalingConfig(
      asymmetricAutoscalingOptions: pulumi.Input.fromValue(pulumi.Input.decodeList<GetInstanceAutoscalingConfigAsymmetricAutoscalingOption>(map['asymmetricAutoscalingOptions']!, (value) => GetInstanceAutoscalingConfigAsymmetricAutoscalingOption.fromMap((value as Map).cast<String, dynamic>()))),
      autoscalingLimits: pulumi.Input.fromValue(pulumi.Input.decodeList<GetInstanceAutoscalingConfigAutoscalingLimit>(map['autoscalingLimits']!, (value) => GetInstanceAutoscalingConfigAutoscalingLimit.fromMap((value as Map).cast<String, dynamic>()))),
      autoscalingTargets: pulumi.Input.fromValue(pulumi.Input.decodeList<GetInstanceAutoscalingConfigAutoscalingTarget>(map['autoscalingTargets']!, (value) => GetInstanceAutoscalingConfigAutoscalingTarget.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
