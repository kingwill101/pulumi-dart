...
class TrustConfigState {
  ...
  factory TrustConfigState.fromMap(Map<String, dynamic> map) {
    return TrustConfigState(
      allowlistedCertificates: (() {
        final guardedValue = map['allowlistedCertificates'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<TrustConfigAllowlistedCertificate>(
            guardedValue,
            (value) => TrustConfigAllowlistedCertificate.fromMap(
      ...
      trustStores: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<TrustConfigTrustStore>(
            guardedValue,
            (value) => TrustConfigTrustStore.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
