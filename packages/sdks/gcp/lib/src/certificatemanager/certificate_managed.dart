...
class CertificateManaged {
  ...
  factory CertificateManaged.fromMap(Map<String, dynamic> map) {
    return CertificateManaged(
      authorizationAttemptInfos: (() { final guardedValue = map['authorizationAttemptInfos']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<CertificateManagedAuthorizationAttemptInfo>(guardedValue, (value) => CertificateManagedAuthorizationAttemptInfo.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      provisioningIssues: (() { final guardedValue = map['provisioningIssues']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<CertificateManagedProvisioningIssue>(guardedValue, (value) => CertificateManagedProvisioningIssue.fromMap((value as Map).cast<String, dynamic>()))); })(),
