...
class TrustConfigTrustStore {
  ...
  final pulumi.Input<List<TrustConfigTrustStoreIntermediateCa>>?
  intermediateCas;
  ...
  TrustConfigTrustStore({this.intermediateCas, this.trustAnchors});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'intermediateCas':
          ?pulumi.Input.mapOptionalInputValue<
            List<TrustConfigTrustStoreIntermediateCa>,
      ...
      'trustAnchors':
          ?pulumi.Input.mapOptionalInputValue<
            List<TrustConfigTrustStoreTrustAnchor>,
            List<Map<String, dynamic>>
          >(
            trustAnchors,
            (value) =>
  ...
  factory TrustConfigTrustStore.fromMap(Map<String, dynamic> map) {
    return TrustConfigTrustStore(
      ...
      trustAnchors: (() {
        final guardedValue = map['trustAnchors'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
