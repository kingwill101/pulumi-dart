...
class GetCertificatesCertificateManaged {
  ...
  final List<GetCertificatesCertificateManagedAuthorizationAttemptInfo> authorizationAttemptInfos;
  ...
  final List<GetCertificatesCertificateManagedProvisioningIssue> provisioningIssues;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'authorizationAttemptInfos': pulumi.Input.encodeList<GetCertificatesCertificateManagedAuthorizationAttemptInfo, Map<String, dynamic>>(authorizationAttemptInfos, (value) => value.toMap()),
      'dnsAuthorizations': dnsAuthorizations,
      'domains': domains,
      'issuanceConfig': issuanceConfig,
      'provisioningIssues': pulumi.Input.encodeList<GetCertificatesCertificateManagedProvisioningIssue, Map<String, dynamic>>(provisioningIssues, (value) => value.toMap()),
      'state': state,
    };
  }
  ...
  factory GetCertificatesCertificateManaged.fromMap(Map<String, dynamic> map) {
    return GetCertificatesCertificateManaged(
      authorizationAttemptInfos: pulumi.Input.decodeList<GetCertificatesCertificateManagedAuthorizationAttemptInfo>(map['authorizationAttemptInfos'], (value) => GetCertificatesCertificateManagedAuthorizationAttemptInfo.fromMap((value as Map).cast<String, dynamic>())),
      ...
      provisioningIssues: pulumi.Input.decodeList<GetCertificatesCertificateManagedProvisioningIssue>(map['provisioningIssues'], (value) => GetCertificatesCertificateManagedProvisioningIssue.fromMap((value as Map).cast<String, dynamic>())),
