...
class GetCertificatesCertificateManaged {
  ...
  factory GetCertificatesCertificateManaged.fromMap(Map<String, dynamic> map) {
    return GetCertificatesCertificateManaged(
      authorizationAttemptInfos: (pulumi.Input.decodeList<GetCertificatesCertificateManagedAuthorizationAttemptInfo>(map['authorizationAttemptInfos'], (value) => GetCertificatesCertificateManagedAuthorizationAttemptInfo.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      provisioningIssues: (pulumi.Input.decodeList<GetCertificatesCertificateManagedProvisioningIssue>(map['provisioningIssues'], (value) => GetCertificatesCertificateManagedProvisioningIssue.fromMap((value as Map).cast<String, dynamic>()))).input(),
