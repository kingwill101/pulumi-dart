...
class GetCertificatesCertificateManaged {
  ...
  final pulumi.Input<
    List<GetCertificatesCertificateManagedAuthorizationAttemptInfo>
  >
  ...
  final pulumi.Input<List<GetCertificatesCertificateManagedProvisioningIssue>>
  provisioningIssues;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'provisioningIssues':
          pulumi.Input.mapInputValue<
            List<GetCertificatesCertificateManagedProvisioningIssue>,
            List<Map<String, dynamic>>
          >(
            provisioningIssues,
            (value) =>
  ...
  factory GetCertificatesCertificateManaged.fromMap(Map<String, dynamic> map) {
    return GetCertificatesCertificateManaged(
      authorizationAttemptInfos: pulumi.Input.fromValue(
