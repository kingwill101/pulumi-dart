...
class GetCertificateMapGclbTarget {
  ...
  const GetCertificateMapGclbTarget({
  ...
  factory GetCertificateMapGclbTarget.fromMap(Map<String, dynamic> map) {
    return GetCertificateMapGclbTarget(
      ipConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetCertificateMapGclbTargetIpConfig>(map['ipConfigs']!, (value) => GetCertificateMapGclbTargetIpConfig.fromMap((value as Map).cast<String, dynamic>()))),
