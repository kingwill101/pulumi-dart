...
class LiteTopic extends pulumi.CustomResource {
  ...
  /// Creates a new [LiteTopic].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [LiteTopic]. {@macro pulumi_pubsub_lite_topic_lite_topic_args_doc}
  ...
  /// Gets an existing [LiteTopic] resource's state with the given [name] and [id].
  static LiteTopic get(
    String name,
