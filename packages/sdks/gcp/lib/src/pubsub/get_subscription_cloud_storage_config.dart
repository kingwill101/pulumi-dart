...
class GetSubscriptionCloudStorageConfig {
  ...
  final pulumi.Input<List<GetSubscriptionCloudStorageConfigAvroConfig>>
  avroConfigs;
    ...
    return <String, dynamic>{
      'avroConfigs':
          pulumi.Input.mapInputValue<
            List<GetSubscriptionCloudStorageConfigAvroConfig>,
  ...
  factory GetSubscriptionCloudStorageConfig.fromMap(Map<String, dynamic> map) {
    return GetSubscriptionCloudStorageConfig(
      avroConfigs: pulumi.Input.fromValue(
      ...
      filenameDatetimeFormat: pulumi.Input.fromValue(
