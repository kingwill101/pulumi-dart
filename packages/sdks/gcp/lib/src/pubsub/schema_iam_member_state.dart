...
class SchemaIamMemberState {
  ...
  factory SchemaIamMemberState.fromMap(Map<String, dynamic> map) {
    return SchemaIamMemberState(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SchemaIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
