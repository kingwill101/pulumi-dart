...
class GetTopicMessageTransform {
  ...
  factory GetTopicMessageTransform.fromMap(Map<String, dynamic> map) {
    return GetTopicMessageTransform(
      ...
      javascriptUdfs: (pulumi.Input.decodeList<GetTopicMessageTransformJavascriptUdf>(map['javascriptUdfs'], (value) => GetTopicMessageTransformJavascriptUdf.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
