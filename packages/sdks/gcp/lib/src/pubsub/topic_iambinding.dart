...
import 'topic_iambinding_state.dart';
...
/// }
///
/// resource "gcp_pubsub_topiciampolicy" "policy" {
///   project     = example.project
///   topic       = example.name
...
/// }
///
/// resource "gcp_pubsub_topiciammember" "member" {
///   project = example.project
///   topic   = example.name
///   role    = "roles/viewer"
///   member  = "user:jane@example.com"
...
class TopicIAMBinding extends pulumi.CustomResource {
  ...
  /// Creates a new [TopicIAMBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [TopicIAMBinding]. {@macro pulumi_pubsub_topic_iambinding_topic_iambinding_args_doc}
  ...
  TopicIAMBinding(
    ...
    condition = registerOutput<TopicIAMBindingCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return TopicIAMBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [TopicIAMBinding] resource's state with the given [name] and [id].
  static TopicIAMBinding get(
    String name,
    pulumi.Input<String> id, {
    TopicIAMBindingState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return TopicIAMBinding._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [TopicIAMBinding] resource.
  TopicIAMBinding.reference(String urn)
    : super(
        'gcp:pubsub/topicIAMBinding:TopicIAMBinding',
