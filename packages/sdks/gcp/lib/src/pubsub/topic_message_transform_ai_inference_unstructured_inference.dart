...
class TopicMessageTransformAiInferenceUnstructuredInference {
  ...
  const TopicMessageTransformAiInferenceUnstructuredInference({
    this.parameters,
  });
  ...
  factory TopicMessageTransformAiInferenceUnstructuredInference.fromMap(Map<String, dynamic> map) {
    return TopicMessageTransformAiInferenceUnstructuredInference(
