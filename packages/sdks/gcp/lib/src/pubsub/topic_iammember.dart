...
import 'topic_iammember_state.dart';
...
class TopicIAMMember extends pulumi.CustomResource {
  ...
  TopicIAMMember(
    ...
    condition = registerOutput<TopicIAMMemberCondition?>(
      'condition',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return TopicIAMMemberCondition.fromMap(
  ...
  /// Gets an existing [TopicIAMMember] resource's state with the given [name] and [id].
  static TopicIAMMember get(
    String name,
