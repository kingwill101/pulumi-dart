...
class SubscriptionState {
  ...
  factory SubscriptionState.fromMap(Map<String, dynamic> map) {
    return SubscriptionState(
      ...
      bigqueryConfig: map['bigqueryConfig'] == null ? null : (SubscriptionBigqueryConfig.fromMap((map['bigqueryConfig']! as Map).cast<String, dynamic>())).input(),
      cloudStorageConfig: map['cloudStorageConfig'] == null ? null : (SubscriptionCloudStorageConfig.fromMap((map['cloudStorageConfig']! as Map).cast<String, dynamic>())).input(),
      deadLetterPolicy: map['deadLetterPolicy'] == null ? null : (SubscriptionDeadLetterPolicy.fromMap((map['deadLetterPolicy']! as Map).cast<String, dynamic>())).input(),
      effectiveLabels: map['effectiveLabels'] == null ? null : ((map['effectiveLabels']! as Map).cast<String, String>()).input(),
      enableExactlyOnceDelivery: map['enableExactlyOnceDelivery'] == null ? null : (map['enableExactlyOnceDelivery']! as bool).input(),
      enableMessageOrdering: map['enableMessageOrdering'] == null ? null : (map['enableMessageOrdering']! as bool).input(),
      expirationPolicy: map['expirationPolicy'] == null ? null : (SubscriptionExpirationPolicy.fromMap((map['expirationPolicy']! as Map).cast<String, dynamic>())).input(),
      ...
      messageTransforms: map['messageTransforms'] == null ? null : (pulumi.Input.decodeList<SubscriptionMessageTransform>(map['messageTransforms']!, (value) => SubscriptionMessageTransform.fromMap((value as Map).cast<String, dynamic>()))).input(),
      name: map['name'] == null ? null : (map['name']! as String).input(),
      project: map['project'] == null ? null : (map['project']! as String).input(),
      pulumiLabels: map['pulumiLabels'] == null ? null : ((map['pulumiLabels']! as Map).cast<String, String>()).input(),
      pushConfig: map['pushConfig'] == null ? null : (SubscriptionPushConfig.fromMap((map['pushConfig']! as Map).cast<String, dynamic>())).input(),
      retainAckedMessages: map['retainAckedMessages'] == null ? null : (map['retainAckedMessages']! as bool).input(),
      retryPolicy: map['retryPolicy'] == null ? null : (SubscriptionRetryPolicy.fromMap((map['retryPolicy']! as Map).cast<String, dynamic>())).input(),
