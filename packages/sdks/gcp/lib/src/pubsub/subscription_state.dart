...
class SubscriptionState {
  ...
  SubscriptionState({
    ...
    pulumi.Output<SubscriptionBigqueryConfig>? bigqueryConfig,
    pulumi.Output<SubscriptionCloudStorageConfig>? cloudStorageConfig,
    pulumi.Output<SubscriptionDeadLetterPolicy>? deadLetterPolicy,
    pulumi.Output<Map<String, String>>? effectiveLabels,
    pulumi.Output<bool>? enableExactlyOnceDelivery,
    pulumi.Output<bool>? enableMessageOrdering,
    pulumi.Output<SubscriptionExpirationPolicy>? expirationPolicy,
    pulumi.Output<String>? filter,
    pulumi.Output<Map<String, String>>? labels,
    pulumi.Output<String>? messageRetentionDuration,
    pulumi.Output<List<SubscriptionMessageTransform>>? messageTransforms,
    pulumi.Output<String>? name,
    pulumi.Output<String>? project,
    pulumi.Output<Map<String, String>>? pulumiLabels,
    pulumi.Output<SubscriptionPushConfig>? pushConfig,
    pulumi.Output<bool>? retainAckedMessages,
    pulumi.Output<SubscriptionRetryPolicy>? retryPolicy,
    pulumi.Output<Map<String, String>>? tags,
    pulumi.Output<String>? topic,
  }) :
      ackDeadlineSeconds = pulumi.Input.asOptionalInput<int>(ackDeadlineSeconds),
      bigqueryConfig = pulumi.Input.asOptionalInput<SubscriptionBigqueryConfig>(bigqueryConfig),
      cloudStorageConfig = pulumi.Input.asOptionalInput<SubscriptionCloudStorageConfig>(cloudStorageConfig),
      deadLetterPolicy = pulumi.Input.asOptionalInput<SubscriptionDeadLetterPolicy>(deadLetterPolicy),
      ...
      expirationPolicy = pulumi.Input.asOptionalInput<SubscriptionExpirationPolicy>(expirationPolicy),
      filter = pulumi.Input.asOptionalInput<String>(filter),
      labels = pulumi.Input.asOptionalInput<Map<String, String>>(labels),
      messageRetentionDuration = pulumi.Input.asOptionalInput<String>(messageRetentionDuration),
      messageTransforms = pulumi.Input.asOptionalInput<List<SubscriptionMessageTransform>>(messageTransforms),
      name = pulumi.Input.asOptionalInput<String>(name),
      project = pulumi.Input.asOptionalInput<String>(project),
      pulumiLabels = pulumi.Input.asOptionalInput<Map<String, String>>(pulumiLabels),
      pushConfig = pulumi.Input.asOptionalInput<SubscriptionPushConfig>(pushConfig),
      retainAckedMessages = pulumi.Input.asOptionalInput<bool>(retainAckedMessages),
      retryPolicy = pulumi.Input.asOptionalInput<SubscriptionRetryPolicy>(retryPolicy),
  ...
  factory SubscriptionState.fromMap(Map<String, dynamic> map) {
    return SubscriptionState(
      ...
      bigqueryConfig: map['bigqueryConfig'] == null ? null : pulumi.Output.create<SubscriptionBigqueryConfig>(SubscriptionBigqueryConfig.fromMap((map['bigqueryConfig'] as Map).cast<String, dynamic>())),
      cloudStorageConfig: map['cloudStorageConfig'] == null ? null : pulumi.Output.create<SubscriptionCloudStorageConfig>(SubscriptionCloudStorageConfig.fromMap((map['cloudStorageConfig'] as Map).cast<String, dynamic>())),
      deadLetterPolicy: map['deadLetterPolicy'] == null ? null : pulumi.Output.create<SubscriptionDeadLetterPolicy>(SubscriptionDeadLetterPolicy.fromMap((map['deadLetterPolicy'] as Map).cast<String, dynamic>())),
      ...
      expirationPolicy: map['expirationPolicy'] == null ? null : pulumi.Output.create<SubscriptionExpirationPolicy>(SubscriptionExpirationPolicy.fromMap((map['expirationPolicy'] as Map).cast<String, dynamic>())),
      ...
      messageTransforms: map['messageTransforms'] == null ? null : pulumi.Output.create<List<SubscriptionMessageTransform>>(pulumi.Input.decodeList<SubscriptionMessageTransform>(map['messageTransforms'], (value) => SubscriptionMessageTransform.fromMap((value as Map).cast<String, dynamic>()))),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      project: map['project'] == null ? null : pulumi.Output.create<String>(map['project'] as String),
      pulumiLabels: map['pulumiLabels'] == null ? null : pulumi.Output.create<Map<String, String>>((map['pulumiLabels'] as Map).cast<String, String>()),
      pushConfig: map['pushConfig'] == null ? null : pulumi.Output.create<SubscriptionPushConfig>(SubscriptionPushConfig.fromMap((map['pushConfig'] as Map).cast<String, dynamic>())),
      retainAckedMessages: map['retainAckedMessages'] == null ? null : pulumi.Output.create<bool>(map['retainAckedMessages'] as bool),
      retryPolicy: map['retryPolicy'] == null ? null : pulumi.Output.create<SubscriptionRetryPolicy>(SubscriptionRetryPolicy.fromMap((map['retryPolicy'] as Map).cast<String, dynamic>())),
