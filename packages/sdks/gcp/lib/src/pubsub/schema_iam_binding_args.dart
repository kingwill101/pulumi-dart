...
class SchemaIamBindingArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'condition': ?pulumi.Input.mapOptionalInputValue<SchemaIamBindingCondition, Map<String, dynamic>>(condition, (value) => value.toMap()),
      'members': members,
      'project': ?project,
      'role': role,
      'schema': schema,
  ...
  factory SchemaIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return SchemaIamBindingArgs(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SchemaIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
