...
class TopicIAMBindingState {
  ...
  /// Creates a new [TopicIAMBindingState].
  /// [condition] Optional.
  ...
  factory TopicIAMBindingState.fromMap(Map<String, dynamic> map) {
    return TopicIAMBindingState(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TopicIAMBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
