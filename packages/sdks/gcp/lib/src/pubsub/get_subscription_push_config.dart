...
class GetSubscriptionPushConfig {
  ...
  factory GetSubscriptionPushConfig.fromMap(Map<String, dynamic> map) {
    return GetSubscriptionPushConfig(
      ...
      noWrappers: (pulumi.Input.decodeList<GetSubscriptionPushConfigNoWrapper>(map['noWrappers'], (value) => GetSubscriptionPushConfigNoWrapper.fromMap((value as Map).cast<String, dynamic>()))).input(),
      oidcTokens: (pulumi.Input.decodeList<GetSubscriptionPushConfigOidcToken>(map['oidcTokens'], (value) => GetSubscriptionPushConfigOidcToken.fromMap((value as Map).cast<String, dynamic>()))).input(),
