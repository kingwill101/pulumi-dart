...
class GetSubscriptionPushConfig {
    ...
    return <String, dynamic>{
      ...
      'noWrappers':
          pulumi.Input.mapInputValue<
            List<GetSubscriptionPushConfigNoWrapper>,
      ...
      'oidcTokens':
          pulumi.Input.mapInputValue<
            List<GetSubscriptionPushConfigOidcToken>,
            List<Map<String, dynamic>>
          >(
            oidcTokens,
            (value) =>
  ...
  factory GetSubscriptionPushConfig.fromMap(Map<String, dynamic> map) {
    return GetSubscriptionPushConfig(
      ...
      noWrappers: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetSubscriptionPushConfigNoWrapper>(
          map['noWrappers']!,
      ...
      oidcTokens: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetSubscriptionPushConfigOidcToken>(
          map['oidcTokens']!,
