...
class GetTopicIngestionDataSourceSettingCloudStorage {
  ...
  factory GetTopicIngestionDataSourceSettingCloudStorage.fromMap(Map<String, dynamic> map) {
    return GetTopicIngestionDataSourceSettingCloudStorage(
      avroFormats: ((map['avroFormats'] as List).cast<Map<String, dynamic>>()).input(),
      bucket: (map['bucket'] as String).input(),
      matchGlob: (map['matchGlob'] as String).input(),
      minimumObjectCreateTime: (map['minimumObjectCreateTime'] as String).input(),
      pubsubAvroFormats: ((map['pubsubAvroFormats'] as List).cast<Map<String, dynamic>>()).input(),
      textFormats: (pulumi.Input.decodeList<GetTopicIngestionDataSourceSettingCloudStorageTextFormat>(map['textFormats'], (value) => GetTopicIngestionDataSourceSettingCloudStorageTextFormat.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
