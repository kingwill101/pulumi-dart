...
class GetTopicIngestionDataSourceSettingCloudStorage {
  ...
  factory GetTopicIngestionDataSourceSettingCloudStorage.fromMap(
    ...
    return GetTopicIngestionDataSourceSettingCloudStorage(
      avroFormats: pulumi.Input.fromValue(
        (map['avroFormats'] as List).cast<Map<String, dynamic>>(),
      ),
      bucket: pulumi.Input.fromValue(map['bucket'] as String),
      matchGlob: pulumi.Input.fromValue(map['matchGlob'] as String),
      minimumObjectCreateTime: pulumi.Input.fromValue(
        map['minimumObjectCreateTime'] as String,
      ),
      pubsubAvroFormats: pulumi.Input.fromValue(
        (map['pubsubAvroFormats'] as List).cast<Map<String, dynamic>>(),
      ),
      textFormats: pulumi.Input.fromValue(
