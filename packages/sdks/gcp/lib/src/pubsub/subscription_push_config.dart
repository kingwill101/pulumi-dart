...
class SubscriptionPushConfig {
  ...
  factory SubscriptionPushConfig.fromMap(Map<String, dynamic> map) {
    return SubscriptionPushConfig(
      ...
      noWrapper: (() { final guardedValue = map['noWrapper']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SubscriptionPushConfigNoWrapper.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      oidcToken: (() { final guardedValue = map['oidcToken']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SubscriptionPushConfigOidcToken.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
