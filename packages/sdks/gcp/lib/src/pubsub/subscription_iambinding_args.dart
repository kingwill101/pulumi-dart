...
class SubscriptionIAMBindingArgs {
  ...
  factory SubscriptionIAMBindingArgs.fromMap(Map<String, dynamic> map) {
    return SubscriptionIAMBindingArgs(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SubscriptionIAMBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
