...
import 'subscription_iambinding_args.dart';
import 'subscription_iambinding_condition.dart';
import 'subscription_iambinding_state.dart';
...
class SubscriptionIAMBinding extends pulumi.CustomResource {
  ...
  /// Creates a new [SubscriptionIAMBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [SubscriptionIAMBinding]. {@macro pulumi_pubsub_subscription_iambinding_subscription_iambinding_args_doc}
  ...
  SubscriptionIAMBinding(
    ...
    condition = registerOutput<SubscriptionIAMBindingCondition?>(
      'condition',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return SubscriptionIAMBindingCondition.fromMap(
  ...
  static SubscriptionIAMBinding get(
    String name,
