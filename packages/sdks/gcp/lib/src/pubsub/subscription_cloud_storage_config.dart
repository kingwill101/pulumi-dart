...
class SubscriptionCloudStorageConfig {
  ...
  factory SubscriptionCloudStorageConfig.fromMap(Map<String, dynamic> map) {
    return SubscriptionCloudStorageConfig(
      avroConfig: map['avroConfig'] == null ? null : SubscriptionCloudStorageConfigAvroConfig.fromMap((map['avroConfig'] as Map).cast<String, dynamic>()),
      bucket: map['bucket'] as String,
      filenameDatetimeFormat: map['filenameDatetimeFormat'] == null ? null : map['filenameDatetimeFormat'] as String,
      filenamePrefix: map['filenamePrefix'] == null ? null : map['filenamePrefix'] as String,
      filenameSuffix: map['filenameSuffix'] == null ? null : map['filenameSuffix'] as String,
