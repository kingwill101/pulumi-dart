...
class CloudControlParameterSpec {
  ...
  /// Structure is documented below.
  final pulumi.Input<List<CloudControlParameterSpecSubParameter>>?
  subParameters;

  /// List of parameter substitutions.
  /// Structure is documented below.
  final pulumi.Input<List<CloudControlParameterSpecSubstitutionRule>>?
  substitutionRules;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'subParameters':
          ?pulumi.Input.mapOptionalInputValue<
            List<CloudControlParameterSpecSubParameter>,
      ...
      'substitutionRules':
          ?pulumi.Input.mapOptionalInputValue<
            List<CloudControlParameterSpecSubstitutionRule>,
            List<Map<String, dynamic>>
          >(
            substitutionRules,
            (value) =>
  ...
  factory CloudControlParameterSpec.fromMap(Map<String, dynamic> map) {
    return CloudControlParameterSpec(
      ...
      subParameters: (() {
        final guardedValue = map['subParameters'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
