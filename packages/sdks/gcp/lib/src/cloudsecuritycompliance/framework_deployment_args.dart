...
class FrameworkDeploymentArgs {
  ...
  factory FrameworkDeploymentArgs.fromMap(Map<String, dynamic> map) {
    return FrameworkDeploymentArgs(
      cloudControlMetadatas: pulumi.Input.fromValue(
      ...
      framework: pulumi.Input.fromValue(
        FrameworkDeploymentFramework.fromMap(
          (map['framework']! as Map).cast<String, dynamic>(),
        ),
      ),
      frameworkDeploymentId: pulumi.Input.fromValue(
        map['frameworkDeploymentId'] as String,
      ),
      location: pulumi.Input.fromValue(map['location'] as String),
      organization: pulumi.Input.fromValue(map['organization'] as String),
      targetResourceConfig: pulumi.Input.fromValue(
