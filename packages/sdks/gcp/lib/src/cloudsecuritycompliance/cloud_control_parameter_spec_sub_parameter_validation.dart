...
class CloudControlParameterSpecSubParameterValidation {
  ...
  /// Structure is documented below.
  final pulumi.Input<CloudControlParameterSpecSubParameterValidationIntRange>?
  intRange;
    ...
    return <String, dynamic>{
      ...
      'regexpPattern':
          ?pulumi.Input.mapOptionalInputValue<
            CloudControlParameterSpecSubParameterValidationRegexpPattern,
            Map<String, dynamic>
          >(regexpPattern, (value) => value.toMap()),
    };
  }
    ...
    return CloudControlParameterSpecSubParameterValidation(
      allowedValues: (() {
        ...
        return pulumi.Input.fromValue(
          CloudControlParameterSpecSubParameterValidationAllowedValues.fromMap(
      ...
      regexpPattern: (() {
        final guardedValue = map['regexpPattern'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CloudControlParameterSpecSubParameterValidationRegexpPattern.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
