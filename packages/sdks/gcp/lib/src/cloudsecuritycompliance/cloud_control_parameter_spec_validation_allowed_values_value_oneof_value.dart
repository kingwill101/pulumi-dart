...
class CloudControlParameterSpecValidationAllowedValuesValueOneofValue {
  ...
  const CloudControlParameterSpecValidationAllowedValuesValueOneofValue({
    this.name,
    this.parameterValue,
  });
  ...
  factory CloudControlParameterSpecValidationAllowedValuesValueOneofValue.fromMap(Map<String, dynamic> map) {
    return CloudControlParameterSpecValidationAllowedValuesValueOneofValue(
      ...
      parameterValue: (() { final guardedValue = map['parameterValue']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CloudControlParameterSpecValidationAllowedValuesValueOneofValueParameterValue.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
