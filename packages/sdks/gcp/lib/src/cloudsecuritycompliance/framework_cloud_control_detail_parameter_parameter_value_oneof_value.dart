...
class FrameworkCloudControlDetailParameterParameterValueOneofValue {
  ...
  factory FrameworkCloudControlDetailParameterParameterValueOneofValue.fromMap(Map<String, dynamic> map) {
    return FrameworkCloudControlDetailParameterParameterValueOneofValue(
      ...
      parameterValue: (() { final guardedValue = map['parameterValue']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FrameworkCloudControlDetailParameterParameterValueOneofValueParameterValue.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
