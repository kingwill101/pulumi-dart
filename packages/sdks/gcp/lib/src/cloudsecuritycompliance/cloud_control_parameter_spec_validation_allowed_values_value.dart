...
class CloudControlParameterSpecValidationAllowedValuesValue {
  ...
  final pulumi.Input<CloudControlParameterSpecValidationAllowedValuesValueOneofValue>? oneofValue;
  /// A list of strings.
  /// Structure is documented below.
  final pulumi.Input<CloudControlParameterSpecValidationAllowedValuesValueStringListValue>? stringListValue;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'oneofValue': ?pulumi.Input.mapOptionalInputValue<CloudControlParameterSpecValidationAllowedValuesValueOneofValue, Map<String, dynamic>>(oneofValue, (value) => value.toMap()),
      'stringListValue': ?pulumi.Input.mapOptionalInputValue<CloudControlParameterSpecValidationAllowedValuesValueStringListValue, Map<String, dynamic>>(stringListValue, (value) => value.toMap()),
  ...
  factory CloudControlParameterSpecValidationAllowedValuesValue.fromMap(Map<String, dynamic> map) {
    return CloudControlParameterSpecValidationAllowedValuesValue(
      ...
      oneofValue: (() { final guardedValue = map['oneofValue']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CloudControlParameterSpecValidationAllowedValuesValueOneofValue.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      stringListValue: (() { final guardedValue = map['stringListValue']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CloudControlParameterSpecValidationAllowedValuesValueStringListValue.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
