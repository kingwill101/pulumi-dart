...
class CloudControlState {
  ...
  factory CloudControlState.fromMap(Map<String, dynamic> map) {
    return CloudControlState(
      ...
      cloudControlId: map['cloudControlId'] == null ? null : (map['cloudControlId']! as String).input(),
      ...
      relatedFrameworks: map['relatedFrameworks'] == null ? null : ((map['relatedFrameworks']! as List).cast<String>()).input(),
