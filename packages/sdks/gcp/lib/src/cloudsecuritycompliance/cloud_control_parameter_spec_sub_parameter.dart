...
class CloudControlParameterSpecSubParameter {
  ...
  final pulumi.Input<CloudControlParameterSpecSubParameterDefaultValue>?
  defaultValue;
  ...
  /// Structure is documented below.
  final pulumi.Input<
    List<CloudControlParameterSpecSubParameterSubstitutionRule>
  >?
  substitutionRules;

  /// Validation of the parameter.
  /// Structure is documented below.
  final pulumi.Input<CloudControlParameterSpecSubParameterValidation>?
  validation;
