...
class PolicyState {
  ...
  factory PolicyState.fromMap(Map<String, dynamic> map) {
    return PolicyState(
      alternativeNameServerConfig: (() {
        final guardedValue = map['alternativeNameServerConfig'];
      ...
      dns64Config: (() {
        final guardedValue = map['dns64Config'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      enableInboundForwarding: (() {
        final guardedValue = map['enableInboundForwarding'];
        if (guardedValue == null) return null;
