...
class ManagedZonePrivateVisibilityConfig {
  ...
  final pulumi.Input<List<ManagedZonePrivateVisibilityConfigGkeCluster>>?
  gkeClusters;
  ...
  /// [networks] Optional.
  ManagedZonePrivateVisibilityConfig({this.gkeClusters, this.networks});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'gkeClusters':
          ?pulumi.Input.mapOptionalInputValue<
            List<ManagedZonePrivateVisibilityConfigGkeCluster>,
      ...
      'networks':
          ?pulumi.Input.mapOptionalInputValue<
            List<ManagedZonePrivateVisibilityConfigNetwork>,
            List<Map<String, dynamic>>
          >(
            networks,
            (value) =>
    ...
    return ManagedZonePrivateVisibilityConfig(
      gkeClusters: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ManagedZonePrivateVisibilityConfigGkeCluster>(
            guardedValue,
