...
class RecordSetRoutingPolicyWrrHealthCheckedTargets {
  ...
  factory RecordSetRoutingPolicyWrrHealthCheckedTargets.fromMap(Map<String, dynamic> map) {
    return RecordSetRoutingPolicyWrrHealthCheckedTargets(
      ...
      internalLoadBalancers: (() { final guardedValue = map['internalLoadBalancers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RecordSetRoutingPolicyWrrHealthCheckedTargetsInternalLoadBalancer>(guardedValue, (value) => RecordSetRoutingPolicyWrrHealthCheckedTargetsInternalLoadBalancer.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
