...
class RecordSetRoutingPolicyWrrHealthCheckedTargetsInternalLoadBalancer {
  ...
  /// Creates a new [RecordSetRoutingPolicyWrrHealthCheckedTargetsInternalLoadBalancer].
  ...
  const RecordSetRoutingPolicyWrrHealthCheckedTargetsInternalLoadBalancer({
