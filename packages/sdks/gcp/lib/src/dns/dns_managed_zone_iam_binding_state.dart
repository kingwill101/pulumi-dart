...
class DnsManagedZoneIamBindingState {
  ...
  /// Creates a new [DnsManagedZoneIamBindingState].
  ...
  const DnsManagedZoneIamBindingState({
    this.condition,
    this.etag,
    this.managedZone,
    this.members,
  ...
  factory DnsManagedZoneIamBindingState.fromMap(Map<String, dynamic> map) {
    return DnsManagedZoneIamBindingState(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DnsManagedZoneIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
