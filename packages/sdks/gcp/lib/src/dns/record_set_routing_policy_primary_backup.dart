...
class RecordSetRoutingPolicyPrimaryBackup {
  ...
  final pulumi.Input<List<RecordSetRoutingPolicyPrimaryBackupBackupGeo>>
  backupGeos;
    ...
    return <String, dynamic>{
      'backupGeos':
          pulumi.Input.mapInputValue<
            List<RecordSetRoutingPolicyPrimaryBackupBackupGeo>,
  ...
  factory RecordSetRoutingPolicyPrimaryBackup.fromMap(
    ...
    return RecordSetRoutingPolicyPrimaryBackup(
      backupGeos: pulumi.Input.fromValue(
      ...
      enableGeoFencingForBackups: (() {
        final guardedValue = map['enableGeoFencingForBackups'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      primary: pulumi.Input.fromValue(
        RecordSetRoutingPolicyPrimaryBackupPrimary.fromMap(
          (map['primary']! as Map).cast<String, dynamic>(),
        ),
      ),
      trickleRatio: (() {
        final guardedValue = map['trickleRatio'];
        if (guardedValue == null) return null;
