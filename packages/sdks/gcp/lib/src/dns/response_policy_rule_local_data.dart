...
class ResponsePolicyRuleLocalData {
  ...
  ResponsePolicyRuleLocalData({required this.localDatas});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'localDatas':
          pulumi.Input.mapInputValue<
            List<ResponsePolicyRuleLocalDataLocalData>,
  ...
  factory ResponsePolicyRuleLocalData.fromMap(Map<String, dynamic> map) {
    return ResponsePolicyRuleLocalData(
      localDatas: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ResponsePolicyRuleLocalDataLocalData>(
          map['localDatas']!,
