...
import 'dns_managed_zone_iam_member_args.dart';
import 'dns_managed_zone_iam_member_condition.dart';
import 'dns_managed_zone_iam_member_state.dart';
...
class DnsManagedZoneIamMember extends pulumi.CustomResource {
  late final pulumi.Output<DnsManagedZoneIamMemberCondition?> condition;
  ...
  /// Creates a new [DnsManagedZoneIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [DnsManagedZoneIamMember]. {@macro pulumi_dns_dns_managed_zone_iam_member_dns_managed_zone_iam_member_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  DnsManagedZoneIamMember(
    String name, {
    DnsManagedZoneIamMemberArgs? args,
    ...
    condition = registerOutput<DnsManagedZoneIamMemberCondition?>(
      'condition',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return DnsManagedZoneIamMemberCondition.fromMap(
  ...
  /// Gets an existing [DnsManagedZoneIamMember] resource's state with the given [name] and [id].
  static DnsManagedZoneIamMember get(
    String name,
