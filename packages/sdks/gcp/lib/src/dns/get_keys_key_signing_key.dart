...
class GetKeysKeySigningKey {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'digests': pulumi.Input.encodeList<GetKeysKeySigningKeyDigest, Map<String, dynamic>>(digests, (value) => value.toMap()),
      'dsRecord': dsRecord,
      'id': id,
      'isActive': isActive,
      'keyLength': keyLength,
  ...
  factory GetKeysKeySigningKey.fromMap(Map<String, dynamic> map) {
    return GetKeysKeySigningKey(
      ...
      digests: pulumi.Input.decodeList<GetKeysKeySigningKeyDigest>(map['digests'], (value) => GetKeysKeySigningKeyDigest.fromMap((value as Map).cast<String, dynamic>())),
