...
import 'dns_managed_zone_iam_member_condition.dart';
...
class DnsManagedZoneIamMemberState {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'condition': ?pulumi.Input.mapOptionalInputValue<DnsManagedZoneIamMemberCondition, Map<String, dynamic>>(condition, (value) => value.toMap()),
      'etag': ?etag,
  ...
  factory DnsManagedZoneIamMemberState.fromMap(Map<String, dynamic> map) {
    return DnsManagedZoneIamMemberState(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DnsManagedZoneIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
