...
import 'workforce_pool_iam_member_state.dart';
...
class WorkforcePoolIamMember extends pulumi.CustomResource {
  ...
  WorkforcePoolIamMember(
    ...
    condition = registerOutput<WorkforcePoolIamMemberCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return WorkforcePoolIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [WorkforcePoolIamMember] resource's state with the given [name] and [id].
  static WorkforcePoolIamMember get(
    String name,
    pulumi.Input<String> id, {
    WorkforcePoolIamMemberState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return WorkforcePoolIamMember._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [WorkforcePoolIamMember] resource.
  WorkforcePoolIamMember.reference(String urn)
    : super(
        'gcp:iam/workforcePoolIamMember:WorkforcePoolIamMember',
