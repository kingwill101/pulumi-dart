...
class FoldersPolicyBindingState {
  ...
  FoldersPolicyBindingState({
    ...
    pulumi.Output<FoldersPolicyBindingTarget>? target,
    ...
    pulumi.Output<String>? updateTime,
      ...
      target = pulumi.Input.asOptionalInput<FoldersPolicyBindingTarget>(target),
  ...
  factory FoldersPolicyBindingState.fromMap(Map<String, dynamic> map) {
    return FoldersPolicyBindingState(
      ...
      target: map['target'] == null ? null : pulumi.Output.create<FoldersPolicyBindingTarget>(FoldersPolicyBindingTarget.fromMap((map['target'] as Map).cast<String, dynamic>())),
