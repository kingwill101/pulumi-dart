...
class FoldersPolicyBindingState {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'policyUid': ?policyUid,
      'target': ?pulumi.Input.mapOptionalInputValue<FoldersPolicyBindingTarget, Map<String, dynamic>>(target, (value) => value.toMap()),
      'uid': ?uid,
  ...
  factory FoldersPolicyBindingState.fromMap(Map<String, dynamic> map) {
    return FoldersPolicyBindingState(
      ...
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FoldersPolicyBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      policyBindingId: (() { final guardedValue = map['policyBindingId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      policyUid: (() { final guardedValue = map['policyUid']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      target: (() { final guardedValue = map['target']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FoldersPolicyBindingTarget.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
