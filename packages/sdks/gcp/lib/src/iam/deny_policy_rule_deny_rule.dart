...
class DenyPolicyRuleDenyRule {
    ...
    return <String, dynamic>{
      'denialCondition':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(denialCondition, (value) => value.toMap()),
  ...
  factory DenyPolicyRuleDenyRule.fromMap(Map<String, dynamic> map) {
    return DenyPolicyRuleDenyRule(
      denialCondition: (() {
        final guardedValue = map['denialCondition'];
      ...
      deniedPermissions: (() {
        final guardedValue = map['deniedPermissions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      deniedPrincipals: (() {
        final guardedValue = map['deniedPrincipals'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      exceptionPermissions: (() {
        final guardedValue = map['exceptionPermissions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      exceptionPrincipals: (() {
        final guardedValue = map['exceptionPrincipals'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
    );
