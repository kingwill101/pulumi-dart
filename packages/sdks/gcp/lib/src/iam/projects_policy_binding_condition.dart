...
class ProjectsPolicyBindingCondition {
  ...
  /// Creates a new [ProjectsPolicyBindingCondition].
  ...
  const ProjectsPolicyBindingCondition({
    this.description,
    this.expression,
    this.location,
    this.title,
  ...
  factory ProjectsPolicyBindingCondition.fromMap(Map<String, dynamic> map) {
    return ProjectsPolicyBindingCondition(
