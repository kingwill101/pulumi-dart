...
class GetWorkloadIdentityPoolProviderX509TrustStore {
  ...
  factory GetWorkloadIdentityPoolProviderX509TrustStore.fromMap(Map<String, dynamic> map) {
    return GetWorkloadIdentityPoolProviderX509TrustStore(
      intermediateCas: (pulumi.Input.decodeList<GetWorkloadIdentityPoolProviderX509TrustStoreIntermediateCa>(map['intermediateCas'], (value) => GetWorkloadIdentityPoolProviderX509TrustStoreIntermediateCa.fromMap((value as Map).cast<String, dynamic>()))).input(),
      trustAnchors: (pulumi.Input.decodeList<GetWorkloadIdentityPoolProviderX509TrustStoreTrustAnchor>(map['trustAnchors'], (value) => GetWorkloadIdentityPoolProviderX509TrustStoreTrustAnchor.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
