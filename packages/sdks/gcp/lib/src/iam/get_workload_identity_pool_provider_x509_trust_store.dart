...
class GetWorkloadIdentityPoolProviderX509TrustStore {
  ...
  final pulumi.Input<
    List<GetWorkloadIdentityPoolProviderX509TrustStoreIntermediateCa>
  >
  intermediateCas;
  ...
  final pulumi.Input<
    List<GetWorkloadIdentityPoolProviderX509TrustStoreTrustAnchor>
  >
  trustAnchors;
    ...
    return GetWorkloadIdentityPoolProviderX509TrustStore(
      intermediateCas: pulumi.Input.fromValue(
        ...
        >(
          map['intermediateCas']!,
          (value) =>
              GetWorkloadIdentityPoolProviderX509TrustStoreIntermediateCa.fromMap(
