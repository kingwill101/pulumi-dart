...
class GetWorkloadIdentityPoolProviderX509TrustStore {
  ...
  final List<GetWorkloadIdentityPoolProviderX509TrustStoreIntermediateCa> intermediateCas;
  ...
  final List<GetWorkloadIdentityPoolProviderX509TrustStoreTrustAnchor> trustAnchors;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'intermediateCas': pulumi.Input.encodeList<GetWorkloadIdentityPoolProviderX509TrustStoreIntermediateCa, Map<String, dynamic>>(intermediateCas, (value) => value.toMap()),
      'trustAnchors': pulumi.Input.encodeList<GetWorkloadIdentityPoolProviderX509TrustStoreTrustAnchor, Map<String, dynamic>>(trustAnchors, (value) => value.toMap()),
    };
  }
  ...
  factory GetWorkloadIdentityPoolProviderX509TrustStore.fromMap(Map<String, dynamic> map) {
    return GetWorkloadIdentityPoolProviderX509TrustStore(
      intermediateCas: pulumi.Input.decodeList<GetWorkloadIdentityPoolProviderX509TrustStoreIntermediateCa>(map['intermediateCas'], (value) => GetWorkloadIdentityPoolProviderX509TrustStoreIntermediateCa.fromMap((value as Map).cast<String, dynamic>())),
      trustAnchors: pulumi.Input.decodeList<GetWorkloadIdentityPoolProviderX509TrustStoreTrustAnchor>(map['trustAnchors'], (value) => GetWorkloadIdentityPoolProviderX509TrustStoreTrustAnchor.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
