...
/// }
/// resource "gcp_iam_folderspolicybinding" "binding-for-all-folder-principals" {
...
///   target = {
///     principal_set ="//cloudresourcemanager.googleapis.com/folders/${gcp_organizations_folder.folder.folder_id}"
///   }
/// }
/// ```
/// ```java
