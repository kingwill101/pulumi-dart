...
import 'folders_policy_binding_state.dart';
...
class FoldersPolicyBinding extends pulumi.CustomResource {
  ...
  FoldersPolicyBinding(
    ...
    condition = registerOutput<FoldersPolicyBindingCondition?>(
      'condition',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return FoldersPolicyBindingCondition.fromMap(
    ...
    target = registerOutput<FoldersPolicyBindingTarget>(
      'target',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return FoldersPolicyBindingTarget.fromMap(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      },
    );
  ...
  /// Gets an existing [FoldersPolicyBinding] resource's state with the given [name] and [id].
  static FoldersPolicyBinding get(
    String name,
