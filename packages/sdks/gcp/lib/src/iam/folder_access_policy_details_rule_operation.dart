...
class FolderAccessPolicyDetailsRuleOperation {
  ...
  /// Creates a new [FolderAccessPolicyDetailsRuleOperation].
  ...
  const FolderAccessPolicyDetailsRuleOperation({
  ...
  factory FolderAccessPolicyDetailsRuleOperation.fromMap(Map<String, dynamic> map) {
    return FolderAccessPolicyDetailsRuleOperation(
