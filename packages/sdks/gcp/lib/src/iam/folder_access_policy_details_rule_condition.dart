...
class FolderAccessPolicyDetailsRuleCondition {
  ...
  /// Creates a new [FolderAccessPolicyDetailsRuleCondition].
  ...
  const FolderAccessPolicyDetailsRuleCondition({
    this.expression,
  ...
  factory FolderAccessPolicyDetailsRuleCondition.fromMap(Map<String, dynamic> map) {
    return FolderAccessPolicyDetailsRuleCondition(
