...
class OrganizationsPolicyBindingState {
  ...
  factory OrganizationsPolicyBindingState.fromMap(Map<String, dynamic> map) {
    return OrganizationsPolicyBindingState(
      ...
      target: (() { final guardedValue = map['target']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OrganizationsPolicyBindingTarget.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
