...
import 'workload_identity_pool_iam_policy_state.dart';
...
class WorkloadIdentityPoolIamPolicy extends pulumi.CustomResource {
  ...
  /// Gets an existing [WorkloadIdentityPoolIamPolicy] resource's state with the given [name] and [id].
  static WorkloadIdentityPoolIamPolicy get(
    String name,
    pulumi.Input<String> id, {
    WorkloadIdentityPoolIamPolicyState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return WorkloadIdentityPoolIamPolicy._get(
      name,
      state: state?.toMap(),
  ...
  WorkloadIdentityPoolIamPolicy._get(
    String name, {
  ...
  /// Creates a typed reference to an existing [WorkloadIdentityPoolIamPolicy] resource.
  WorkloadIdentityPoolIamPolicy.reference(String urn)
    : super(
        'gcp:iam/workloadIdentityPoolIamPolicy:WorkloadIdentityPoolIamPolicy',
