...
class WorkforcePoolProviderExtendedAttributesOauth2ClientClientSecret {
  ...
  const WorkforcePoolProviderExtendedAttributesOauth2ClientClientSecret({
    this.value,
  });
  ...
  factory WorkforcePoolProviderExtendedAttributesOauth2ClientClientSecret.fromMap(Map<String, dynamic> map) {
    return WorkforcePoolProviderExtendedAttributesOauth2ClientClientSecret(
      value: (() { final guardedValue = map['value']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WorkforcePoolProviderExtendedAttributesOauth2ClientClientSecretValue.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
