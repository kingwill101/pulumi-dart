...
import 'folder_access_policy_details_rule_condition.dart';
import 'folder_access_policy_details_rule_operation.dart';

class FolderAccessPolicyDetailsRule {
  ...
  /// request.
  /// Structure is documented below.
  final pulumi.Input<FolderAccessPolicyDetailsRuleOperation> operation;
  ...
  /// Creates a new [FolderAccessPolicyDetailsRule].
  ...
  const FolderAccessPolicyDetailsRule({
    this.conditions,
    this.description,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'conditions': ?pulumi.Input.mapOptionalInputValue<List<FolderAccessPolicyDetailsRuleCondition>, List<Map<String, dynamic>>>(conditions, (value) => pulumi.Input.encodeList<FolderAccessPolicyDetailsRuleCondition, Map<String, dynamic>>(value, (value) => value.toMap())),
      'description': ?description,
      'effect': effect,
      'excludedPrincipals': ?excludedPrincipals,
      'operation': pulumi.Input.mapInputValue<FolderAccessPolicyDetailsRuleOperation, Map<String, dynamic>>(operation, (value) => value.toMap()),
      'principals': principals,
    };
  }

  factory FolderAccessPolicyDetailsRule.fromMap(Map<String, dynamic> map) {
    return FolderAccessPolicyDetailsRule(
      conditions: (() { final guardedValue = map['conditions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FolderAccessPolicyDetailsRuleCondition>(guardedValue, (value) => FolderAccessPolicyDetailsRuleCondition.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      operation: pulumi.Input.fromValue(FolderAccessPolicyDetailsRuleOperation.fromMap((map['operation']! as Map).cast<String, dynamic>())),
