...
import 'organization_access_policy_details_rule_condition.dart';
import 'organization_access_policy_details_rule_operation.dart';

class OrganizationAccessPolicyDetailsRule {
  ...
  final pulumi.Input<List<OrganizationAccessPolicyDetailsRuleCondition>?>? conditions;
  ...
  /// request.
  /// Structure is documented below.
  final pulumi.Input<OrganizationAccessPolicyDetailsRuleOperation> operation;
  ...
  /// Creates a new [OrganizationAccessPolicyDetailsRule].
  ...
  const OrganizationAccessPolicyDetailsRule({
    this.conditions,
    this.description,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'conditions': ?pulumi.Input.mapOptionalInputValue<List<OrganizationAccessPolicyDetailsRuleCondition>, List<Map<String, dynamic>>>(conditions, (value) => pulumi.Input.encodeList<OrganizationAccessPolicyDetailsRuleCondition, Map<String, dynamic>>(value, (value) => value.toMap())),
      'description': ?description,
      'effect': effect,
      'excludedPrincipals': ?excludedPrincipals,
      'operation': pulumi.Input.mapInputValue<OrganizationAccessPolicyDetailsRuleOperation, Map<String, dynamic>>(operation, (value) => value.toMap()),
      'principals': principals,
    };
  }

  factory OrganizationAccessPolicyDetailsRule.fromMap(Map<String, dynamic> map) {
    return OrganizationAccessPolicyDetailsRule(
      conditions: (() { final guardedValue = map['conditions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OrganizationAccessPolicyDetailsRuleCondition>(guardedValue, (value) => OrganizationAccessPolicyDetailsRuleCondition.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      operation: pulumi.Input.fromValue(OrganizationAccessPolicyDetailsRuleOperation.fromMap((map['operation']! as Map).cast<String, dynamic>())),
