...
class WorkloadIdentityPoolProviderX509TrustStore {
  ...
  final pulumi.Input<
    List<WorkloadIdentityPoolProviderX509TrustStoreIntermediateCa>
  >?
  intermediateCas;
  ...
  /// Structure is documented below.
  final pulumi.Input<
    List<WorkloadIdentityPoolProviderX509TrustStoreTrustAnchor>
  >
  trustAnchors;
  ...
  factory WorkloadIdentityPoolProviderX509TrustStore.fromMap(
    ...
    return WorkloadIdentityPoolProviderX509TrustStore(
      intermediateCas: (() {
        final guardedValue = map['intermediateCas'];
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                WorkloadIdentityPoolProviderX509TrustStoreIntermediateCa.fromMap(
