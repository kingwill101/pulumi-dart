...
class WorkforcePoolIamBindingState {
  ...
  const WorkforcePoolIamBindingState({
    this.condition,
    this.etag,
    this.location,
    this.members,
  ...
  factory WorkforcePoolIamBindingState.fromMap(Map<String, dynamic> map) {
    return WorkforcePoolIamBindingState(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WorkforcePoolIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
