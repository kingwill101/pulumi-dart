...
class WorkforcePoolIamBindingState {
  ...
  /// Creates a new [WorkforcePoolIamBindingState].
  /// [condition] Optional.
  ...
  WorkforcePoolIamBindingState({
    pulumi.Output<WorkforcePoolIamBindingCondition>? condition,
    ...
    pulumi.Output<String>? workforcePoolId,
      ...
      condition = pulumi.Input.asOptionalInput<WorkforcePoolIamBindingCondition>(condition),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'condition': ?pulumi.Input.mapOptionalInputValue<WorkforcePoolIamBindingCondition, Map<String, dynamic>>(condition, (value) => value.toMap()),
      'etag': ?etag,
      'location': ?location,
      'members': ?members,
      'role': ?role,
  ...
  factory WorkforcePoolIamBindingState.fromMap(Map<String, dynamic> map) {
    return WorkforcePoolIamBindingState(
      condition: map['condition'] == null ? null : pulumi.Output.create<WorkforcePoolIamBindingCondition>(WorkforcePoolIamBindingCondition.fromMap((map['condition'] as Map).cast<String, dynamic>())),
