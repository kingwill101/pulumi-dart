...
class WorkloadIdentityServiceAgent extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<WorkloadIdentityServiceAgentServiceAgent>> serviceAgents;
  ...
  /// Creates a typed reference to an existing [WorkloadIdentityServiceAgent] resource.
  WorkloadIdentityServiceAgent.reference(String urn)
    : super(
        'gcp:iam/workloadIdentityServiceAgent:WorkloadIdentityServiceAgent',
