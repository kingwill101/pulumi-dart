...
class FolderAccessPolicyState {
  ...
  /// Creates a new [FolderAccessPolicyState].
  ...
  factory FolderAccessPolicyState.fromMap(Map<String, dynamic> map) {
    return FolderAccessPolicyState(
