...
import 'workforce_pool_iam_binding_state.dart';
...
class WorkforcePoolIamBinding extends pulumi.CustomResource {
  ...
  /// Creates a new [WorkforcePoolIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [WorkforcePoolIamBinding]. {@macro pulumi_iam_workforce_pool_iam_binding_workforce_pool_iam_binding_args_doc}
  ...
  WorkforcePoolIamBinding(
    ...
    condition = registerOutput<WorkforcePoolIamBindingCondition?>(
      'condition',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return WorkforcePoolIamBindingCondition.fromMap(
  ...
  /// Gets an existing [WorkforcePoolIamBinding] resource's state with the given [name] and [id].
  static WorkforcePoolIamBinding get(
    String name,
