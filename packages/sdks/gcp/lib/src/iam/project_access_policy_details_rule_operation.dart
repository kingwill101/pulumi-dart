...
class ProjectAccessPolicyDetailsRuleOperation {
  ...
  /// Creates a new [ProjectAccessPolicyDetailsRuleOperation].
  ...
  const ProjectAccessPolicyDetailsRuleOperation({
  ...
  factory ProjectAccessPolicyDetailsRuleOperation.fromMap(Map<String, dynamic> map) {
    return ProjectAccessPolicyDetailsRuleOperation(
