...
import 'workforce_pool_provider_scim_tenant_state.dart';
...
class WorkforcePoolProviderScimTenant extends pulumi.CustomResource {
  ...
  /// Gets an existing [WorkforcePoolProviderScimTenant] resource's state with the given [name] and [id].
  static WorkforcePoolProviderScimTenant get(
    String name,
  ...
  WorkforcePoolProviderScimTenant._get(
    String name, {
