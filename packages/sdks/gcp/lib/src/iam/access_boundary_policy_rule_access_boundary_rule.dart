...
class AccessBoundaryPolicyRuleAccessBoundaryRule {
  ...
  final AccessBoundaryPolicyRuleAccessBoundaryRuleAvailabilityCondition? availabilityCondition;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'availabilityCondition': ?availabilityCondition == null ? null : availabilityCondition!.toMap(),
  ...
  factory AccessBoundaryPolicyRuleAccessBoundaryRule.fromMap(Map<String, dynamic> map) {
    return AccessBoundaryPolicyRuleAccessBoundaryRule(
      availabilityCondition: map['availabilityCondition'] == null ? null : AccessBoundaryPolicyRuleAccessBoundaryRuleAvailabilityCondition.fromMap((map['availabilityCondition'] as Map).cast<String, dynamic>()),
      availablePermissions: map['availablePermissions'] == null ? null : (map['availablePermissions'] as List).cast<String>(),
      availableResource: map['availableResource'] == null ? null : map['availableResource'] as String,
    );
  }
}
