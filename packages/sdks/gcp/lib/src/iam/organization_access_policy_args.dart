...
/// {@template pulumi_iam_organization_access_policy_organization_access_policy_args_doc}
/// The set of arguments for OrganizationAccessPolicy.
/// {@endtemplate}
/// {@macro pulumi_iam_organization_access_policy_organization_access_policy_args_doc}
class OrganizationAccessPolicyArgs {
  ...
  /// Creates a new [OrganizationAccessPolicyArgs].
  ...
  const OrganizationAccessPolicyArgs({
  ...
  factory OrganizationAccessPolicyArgs.fromMap(Map<String, dynamic> map) {
    return OrganizationAccessPolicyArgs(
