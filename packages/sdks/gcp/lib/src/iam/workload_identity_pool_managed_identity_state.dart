...
class WorkloadIdentityPoolManagedIdentityState {
  ...
  factory WorkloadIdentityPoolManagedIdentityState.fromMap(
    Map<String, dynamic> map,
  ) {
    return WorkloadIdentityPoolManagedIdentityState(
      attestationRules: (() {
        final guardedValue = map['attestationRules'];
      ...
      workloadIdentityPoolManagedIdentityId: (() {
        final guardedValue = map['workloadIdentityPoolManagedIdentityId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
