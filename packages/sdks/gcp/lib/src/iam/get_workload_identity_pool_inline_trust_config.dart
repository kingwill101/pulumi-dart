...
class GetWorkloadIdentityPoolInlineTrustConfig {
  ...
  factory GetWorkloadIdentityPoolInlineTrustConfig.fromMap(Map<String, dynamic> map) {
    return GetWorkloadIdentityPoolInlineTrustConfig(
      additionalTrustBundles: (pulumi.Input.decodeList<GetWorkloadIdentityPoolInlineTrustConfigAdditionalTrustBundle>(map['additionalTrustBundles'], (value) => GetWorkloadIdentityPoolInlineTrustConfigAdditionalTrustBundle.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
