...
import 'workforce_pool_provider_scim_token_state.dart';
...
class WorkforcePoolProviderScimToken extends pulumi.CustomResource {
  ...
  /// Creates a new [WorkforcePoolProviderScimToken].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [WorkforcePoolProviderScimToken]. {@macro pulumi_iam_workforce_pool_provider_scim_token_workforce_pool_provider_scim_token_args_doc}
  ...
  static WorkforcePoolProviderScimToken get(
    String name,
  ...
  WorkforcePoolProviderScimToken._get(
    String name, {
