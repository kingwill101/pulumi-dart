...
class WorkloadIdentityPoolAttestationRule {
  ...
  /// Creates a new [WorkloadIdentityPoolAttestationRule].
  /// [googleCloudResource] A single workload operating on Google Cloud. For example:
  const WorkloadIdentityPoolAttestationRule({
  ...
  factory WorkloadIdentityPoolAttestationRule.fromMap(Map<String, dynamic> map) {
    return WorkloadIdentityPoolAttestationRule(
