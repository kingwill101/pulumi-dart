...
class ProjectAccessPolicyState {
  ...
  /// Creates a new [ProjectAccessPolicyState].
  ...
  const ProjectAccessPolicyState({
    this.accessPolicyId,
    this.annotations,
    this.createTime,
    this.deletionPolicy,
  ...
  factory ProjectAccessPolicyState.fromMap(Map<String, dynamic> map) {
    return ProjectAccessPolicyState(
