...
import 'workforce_pool_iam_member_condition.dart';

/// {@template pulumi_iam_workforce_pool_iam_member_workforce_pool_iam_member_args_doc}
/// The set of arguments for WorkforcePoolIamMember.
/// {@endtemplate}
...
class WorkforcePoolIamMemberArgs {
  ...
  /// Creates a new [WorkforcePoolIamMemberArgs].
  /// [condition] Optional.
  ...
  const WorkforcePoolIamMemberArgs({
    this.condition,
    this.location,
  ...
  factory WorkforcePoolIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return WorkforcePoolIamMemberArgs(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WorkforcePoolIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
