...
import 'workforce_pool_state.dart';
...
class WorkforcePool extends pulumi.CustomResource {
  ...
  WorkforcePool(
    ...
    this.accessRestrictions = registerOutput<WorkforcePoolAccessRestrictions?>('accessRestrictions');
  ...
  /// Gets an existing [WorkforcePool] resource's state with the given [name] and [id].
  static WorkforcePool get(
    String name,
