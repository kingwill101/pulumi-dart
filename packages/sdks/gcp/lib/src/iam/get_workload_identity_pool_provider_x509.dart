...
class GetWorkloadIdentityPoolProviderX509 {
  ...
  /// supported.
  final pulumi.Input<List<GetWorkloadIdentityPoolProviderX509TrustStore>>
  trustStores;
    ...
    return <String, dynamic>{
      'trustStores':
          pulumi.Input.mapInputValue<
            List<GetWorkloadIdentityPoolProviderX509TrustStore>,
  ...
  factory GetWorkloadIdentityPoolProviderX509.fromMap(
    ...
    return GetWorkloadIdentityPoolProviderX509(
      trustStores: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetWorkloadIdentityPoolProviderX509TrustStore>(
          map['trustStores']!,
