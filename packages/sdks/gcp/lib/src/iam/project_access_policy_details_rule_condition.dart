...
class ProjectAccessPolicyDetailsRuleCondition {
  ...
  /// Creates a new [ProjectAccessPolicyDetailsRuleCondition].
  ...
  const ProjectAccessPolicyDetailsRuleCondition({
    this.expression,
  ...
  factory ProjectAccessPolicyDetailsRuleCondition.fromMap(Map<String, dynamic> map) {
    return ProjectAccessPolicyDetailsRuleCondition(
