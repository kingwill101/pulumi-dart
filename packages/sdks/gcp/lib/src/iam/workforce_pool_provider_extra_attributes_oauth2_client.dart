...
class WorkforcePoolProviderExtraAttributesOauth2Client {
  ...
  /// [clientId] The OAuth 2.0 client ID for retrieving extra attributes from the identity provider. Required to get the Access Token using client credentials grant flow.
  /// [clientSecret] The OAuth 2.0 client secret for retrieving extra attributes from the identity provider. Required to get the Access Token using client credentials grant flow.
  ...
  const WorkforcePoolProviderExtraAttributesOauth2Client({
  ...
  factory WorkforcePoolProviderExtraAttributesOauth2Client.fromMap(Map<String, dynamic> map) {
    return WorkforcePoolProviderExtraAttributesOauth2Client(
      ...
      clientSecret: pulumi.Input.fromValue(WorkforcePoolProviderExtraAttributesOauth2ClientClientSecret.fromMap((map['clientSecret']! as Map).cast<String, dynamic>())),
      issuerUri: pulumi.Input.fromValue(map['issuerUri'] as String),
      queryParameters: (() { final guardedValue = map['queryParameters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WorkforcePoolProviderExtraAttributesOauth2ClientQueryParameters.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
