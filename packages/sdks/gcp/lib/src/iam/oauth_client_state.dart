...
class OauthClientState {
  ...
  factory OauthClientState.fromMap(Map<String, dynamic> map) {
    return OauthClientState(
      allowedGrantTypes: (() { final guardedValue = map['allowedGrantTypes']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      allowedRedirectUris: (() { final guardedValue = map['allowedRedirectUris']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
