...
import 'workload_identity_pool_iam_member_args.dart';
import 'workload_identity_pool_iam_member_condition.dart';
import 'workload_identity_pool_iam_member_state.dart';
...
class WorkloadIdentityPoolIamMember extends pulumi.CustomResource {
  ...
  late final pulumi.Output<WorkloadIdentityPoolIamMemberCondition?> condition;
  ...
  /// Creates a new [WorkloadIdentityPoolIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [WorkloadIdentityPoolIamMember]. {@macro pulumi_iam_workload_identity_pool_iam_member_workload_identity_pool_iam_member_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  WorkloadIdentityPoolIamMember(
    String name, {
    WorkloadIdentityPoolIamMemberArgs? args,
    ...
    this.condition = registerOutput<WorkloadIdentityPoolIamMemberCondition?>('condition');
  ...
  /// Gets an existing [WorkloadIdentityPoolIamMember] resource's state with the given [name] and [id].
  static WorkloadIdentityPoolIamMember get(
    String name,
  ...
  WorkloadIdentityPoolIamMember._get(
    String name, {
