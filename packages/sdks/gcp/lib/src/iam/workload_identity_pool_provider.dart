...
import 'workload_identity_pool_provider_state.dart';
...
class WorkloadIdentityPoolProvider extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [WorkloadIdentityPoolProvider]. {@macro pulumi_iam_workload_identity_pool_provider_workload_identity_pool_provider_args_doc}
  ...
  static WorkloadIdentityPoolProvider get(
    String name,
  ...
  WorkloadIdentityPoolProvider._get(
    String name, {
