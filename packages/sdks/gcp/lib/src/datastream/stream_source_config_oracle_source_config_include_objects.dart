...
class StreamSourceConfigOracleSourceConfigIncludeObjects {
  ...
  factory StreamSourceConfigOracleSourceConfigIncludeObjects.fromMap(Map<String, dynamic> map) {
    return StreamSourceConfigOracleSourceConfigIncludeObjects(
      oracleSchemas: pulumi.Input.fromValue(pulumi.Input.decodeList<StreamSourceConfigOracleSourceConfigIncludeObjectsOracleSchema>(map['oracleSchemas']!, (value) => StreamSourceConfigOracleSourceConfigIncludeObjectsOracleSchema.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
