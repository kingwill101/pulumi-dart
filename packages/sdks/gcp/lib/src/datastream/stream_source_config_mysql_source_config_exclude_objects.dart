...
class StreamSourceConfigMysqlSourceConfigExcludeObjects {
  ...
  factory StreamSourceConfigMysqlSourceConfigExcludeObjects.fromMap(Map<String, dynamic> map) {
    return StreamSourceConfigMysqlSourceConfigExcludeObjects(
      mysqlDatabases: pulumi.Input.fromValue(pulumi.Input.decodeList<StreamSourceConfigMysqlSourceConfigExcludeObjectsMysqlDatabase>(map['mysqlDatabases']!, (value) => StreamSourceConfigMysqlSourceConfigExcludeObjectsMysqlDatabase.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
