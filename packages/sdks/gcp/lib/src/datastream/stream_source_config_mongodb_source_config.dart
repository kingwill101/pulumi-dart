...
class StreamSourceConfigMongodbSourceConfig {
  ...
  factory StreamSourceConfigMongodbSourceConfig.fromMap(Map<String, dynamic> map) {
    return StreamSourceConfigMongodbSourceConfig(
      excludeObjects: map['excludeObjects'] == null ? null : StreamSourceConfigMongodbSourceConfigExcludeObjects.fromMap((map['excludeObjects'] as Map).cast<String, dynamic>()),
      includeObjects: map['includeObjects'] == null ? null : StreamSourceConfigMongodbSourceConfigIncludeObjects.fromMap((map['includeObjects'] as Map).cast<String, dynamic>()),
