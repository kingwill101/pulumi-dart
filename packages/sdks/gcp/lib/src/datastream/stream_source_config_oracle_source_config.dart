...
class StreamSourceConfigOracleSourceConfig {
  ...
  final pulumi.Input<StreamSourceConfigOracleSourceConfigExcludeObjects>?
  excludeObjects;

  /// Oracle objects to retrieve from the source.
  /// Structure is documented below.
  final pulumi.Input<StreamSourceConfigOracleSourceConfigIncludeObjects>?
  includeObjects;
  ...
  factory StreamSourceConfigOracleSourceConfig.fromMap(
    ...
    return StreamSourceConfigOracleSourceConfig(
      ...
      streamLargeObjects: (() {
        final guardedValue = map['streamLargeObjects'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as Map).cast<String, dynamic>(),
        );
