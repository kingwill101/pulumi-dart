...
class StreamBackfillAllMysqlExcludedObjectsMysqlDatabaseMysqlTable {
  ...
  factory StreamBackfillAllMysqlExcludedObjectsMysqlDatabaseMysqlTable.fromMap(Map<String, dynamic> map) {
    return StreamBackfillAllMysqlExcludedObjectsMysqlDatabaseMysqlTable(
      mysqlColumns: (() { final guardedValue = map['mysqlColumns']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<StreamBackfillAllMysqlExcludedObjectsMysqlDatabaseMysqlTableMysqlColumn>(guardedValue, (value) => StreamBackfillAllMysqlExcludedObjectsMysqlDatabaseMysqlTableMysqlColumn.fromMap((value as Map).cast<String, dynamic>()))); })(),
