...
class StreamRuleSetObjectFilter {
  ...
  final pulumi.Input<StreamRuleSetObjectFilterSourceObjectIdentifier>?
    ...
    return <String, dynamic>{
      'sourceObjectIdentifier':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(sourceObjectIdentifier, (value) => value.toMap()),
    };
  }
  ...
  factory StreamRuleSetObjectFilter.fromMap(Map<String, dynamic> map) {
    return StreamRuleSetObjectFilter(
      sourceObjectIdentifier: (() {
        final guardedValue = map['sourceObjectIdentifier'];
