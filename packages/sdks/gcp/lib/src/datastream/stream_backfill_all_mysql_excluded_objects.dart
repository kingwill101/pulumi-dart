...
class StreamBackfillAllMysqlExcludedObjects {
  ...
  final pulumi.Input<List<StreamBackfillAllMysqlExcludedObjectsMysqlDatabase>>
  mysqlDatabases;

  /// Creates a new [StreamBackfillAllMysqlExcludedObjects].
  /// [mysqlDatabases] MySQL databases on the server
  StreamBackfillAllMysqlExcludedObjects({required this.mysqlDatabases});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'mysqlDatabases':
          pulumi.Input.mapInputValue<
            List<StreamBackfillAllMysqlExcludedObjectsMysqlDatabase>,
