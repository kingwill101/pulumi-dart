...
class StreamBackfillAllPostgresqlExcludedObjects {
  ...
  const StreamBackfillAllPostgresqlExcludedObjects({
  ...
  factory StreamBackfillAllPostgresqlExcludedObjects.fromMap(Map<String, dynamic> map) {
    return StreamBackfillAllPostgresqlExcludedObjects(
      postgresqlSchemas: pulumi.Input.fromValue(pulumi.Input.decodeList<StreamBackfillAllPostgresqlExcludedObjectsPostgresqlSchema>(map['postgresqlSchemas']!, (value) => StreamBackfillAllPostgresqlExcludedObjectsPostgresqlSchema.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
