...
class StreamSourceConfigMysqlSourceConfigIncludeObjectsMysqlDatabase {
  ...
  const StreamSourceConfigMysqlSourceConfigIncludeObjectsMysqlDatabase({
  ...
  factory StreamSourceConfigMysqlSourceConfigIncludeObjectsMysqlDatabase.fromMap(Map<String, dynamic> map) {
    return StreamSourceConfigMysqlSourceConfigIncludeObjectsMysqlDatabase(
      ...
      mysqlTables: (() { final guardedValue = map['mysqlTables']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<StreamSourceConfigMysqlSourceConfigIncludeObjectsMysqlDatabaseMysqlTable>(guardedValue, (value) => StreamSourceConfigMysqlSourceConfigIncludeObjectsMysqlDatabaseMysqlTable.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
