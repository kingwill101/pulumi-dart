...
class StreamSourceConfigMysqlSourceConfigIncludeObjects {
  ...
  factory StreamSourceConfigMysqlSourceConfigIncludeObjects.fromMap(Map<String, dynamic> map) {
    return StreamSourceConfigMysqlSourceConfigIncludeObjects(
      mysqlDatabases: pulumi.Input.fromValue(pulumi.Input.decodeList<StreamSourceConfigMysqlSourceConfigIncludeObjectsMysqlDatabase>(map['mysqlDatabases']!, (value) => StreamSourceConfigMysqlSourceConfigIncludeObjectsMysqlDatabase.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
