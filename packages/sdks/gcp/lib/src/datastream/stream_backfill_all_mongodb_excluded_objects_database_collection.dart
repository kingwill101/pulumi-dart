...
class StreamBackfillAllMongodbExcludedObjectsDatabaseCollection {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'fields': ?pulumi.Input.mapOptionalInputValue<List<StreamBackfillAllMongodbExcludedObjectsDatabaseCollectionField>, List<Map<String, dynamic>>>(fields, (value) => pulumi.Input.encodeList<StreamBackfillAllMongodbExcludedObjectsDatabaseCollectionField, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory StreamBackfillAllMongodbExcludedObjectsDatabaseCollection.fromMap(Map<String, dynamic> map) {
    return StreamBackfillAllMongodbExcludedObjectsDatabaseCollection(
      ...
      fields: (() { final guardedValue = map['fields']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<StreamBackfillAllMongodbExcludedObjectsDatabaseCollectionField>(guardedValue, (value) => StreamBackfillAllMongodbExcludedObjectsDatabaseCollectionField.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
