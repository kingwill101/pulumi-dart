...
class StreamSourceConfigPostgresqlSourceConfigExcludeObjects {
  ...
  final pulumi.Input<
    List<StreamSourceConfigPostgresqlSourceConfigExcludeObjectsPostgresqlSchema>
  >
  postgresqlSchemas;
    ...
    return StreamSourceConfigPostgresqlSourceConfigExcludeObjects(
      postgresqlSchemas: pulumi.Input.fromValue(
        ...
        >(
          ...
          (value) =>
              StreamSourceConfigPostgresqlSourceConfigExcludeObjectsPostgresqlSchema.fromMap(
