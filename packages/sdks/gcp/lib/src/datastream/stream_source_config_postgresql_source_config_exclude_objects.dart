...
class StreamSourceConfigPostgresqlSourceConfigExcludeObjects {
  ...
  factory StreamSourceConfigPostgresqlSourceConfigExcludeObjects.fromMap(Map<String, dynamic> map) {
    return StreamSourceConfigPostgresqlSourceConfigExcludeObjects(
      postgresqlSchemas: (pulumi.Input.decodeList<StreamSourceConfigPostgresqlSourceConfigExcludeObjectsPostgresqlSchema>(map['postgresqlSchemas'], (value) => StreamSourceConfigPostgresqlSourceConfigExcludeObjectsPostgresqlSchema.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
