...
class StreamBackfillAllSalesforceExcludedObjects {
  ...
  factory StreamBackfillAllSalesforceExcludedObjects.fromMap(Map<String, dynamic> map) {
    return StreamBackfillAllSalesforceExcludedObjects(
      objects: pulumi.Input.fromValue(pulumi.Input.decodeList<StreamBackfillAllSalesforceExcludedObjectsObject>(map['objects']!, (value) => StreamBackfillAllSalesforceExcludedObjectsObject.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
