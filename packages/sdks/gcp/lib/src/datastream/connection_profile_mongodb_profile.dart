...
class ConnectionProfileMongodbProfile {
  ...
  final pulumi.Input<List<ConnectionProfileMongodbProfileHostAddress>>
  hostAddresses;
  ...
  /// Structure is documented below.
  final pulumi.Input<ConnectionProfileMongodbProfileStandardConnectionFormat>?
    ...
    return <String, dynamic>{
      'hostAddresses':
          pulumi.Input.mapInputValue<
            List<ConnectionProfileMongodbProfileHostAddress>,
      ...
      'standardConnectionFormat':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(standardConnectionFormat, (value) => value.toMap()),
      'username': username,
    };
  }
  ...
  factory ConnectionProfileMongodbProfile.fromMap(Map<String, dynamic> map) {
    return ConnectionProfileMongodbProfile(
      hostAddresses: pulumi.Input.fromValue(
      ...
      replicaSet: (() {
        final guardedValue = map['replicaSet'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      secretManagerStoredPassword: (() {
      ...
      srvConnectionFormat: (() {
        final guardedValue = map['srvConnectionFormat'];
        if (guardedValue == null) return null;
      ...
      standardConnectionFormat: (() {
        final guardedValue = map['standardConnectionFormat'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
