...
class PrivateConnection extends pulumi.CustomResource {
  ...
  PrivateConnection(
    ...
    this.pscInterfaceConfig = registerOutput<PrivateConnectionPscInterfaceConfig?>('pscInterfaceConfig');
    this.pulumiLabels = registerOutput<Map<String, String>>('pulumiLabels');
    this.state = registerOutput<String>('state');
    this.vpcPeeringConfig = registerOutput<PrivateConnectionVpcPeeringConfig?>('vpcPeeringConfig');
  }
