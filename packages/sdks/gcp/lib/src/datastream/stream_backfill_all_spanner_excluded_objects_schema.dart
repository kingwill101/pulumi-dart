...
class StreamBackfillAllSpannerExcludedObjectsSchema {
  ...
  factory StreamBackfillAllSpannerExcludedObjectsSchema.fromMap(Map<String, dynamic> map) {
    return StreamBackfillAllSpannerExcludedObjectsSchema(
      ...
      tables: (() { final guardedValue = map['tables']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<StreamBackfillAllSpannerExcludedObjectsSchemaTable>(guardedValue, (value) => StreamBackfillAllSpannerExcludedObjectsSchemaTable.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
