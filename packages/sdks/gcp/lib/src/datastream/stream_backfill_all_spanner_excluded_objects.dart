...
class StreamBackfillAllSpannerExcludedObjects {
  ...
  final pulumi.Input<List<StreamBackfillAllSpannerExcludedObjectsSchema>>
  schemas;

  /// Creates a new [StreamBackfillAllSpannerExcludedObjects].
  /// [schemas] Spanner schemas in the database
  StreamBackfillAllSpannerExcludedObjects({required this.schemas});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'schemas':
          pulumi.Input.mapInputValue<
            List<StreamBackfillAllSpannerExcludedObjectsSchema>,
  ...
  factory StreamBackfillAllSpannerExcludedObjects.fromMap(
    ...
    return StreamBackfillAllSpannerExcludedObjects(
      schemas: pulumi.Input.fromValue(
        pulumi.Input.decodeList<StreamBackfillAllSpannerExcludedObjectsSchema>(
          map['schemas']!,
