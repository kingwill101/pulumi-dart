...
class StreamBackfillAllOracleExcludedObjects {
  ...
  final pulumi.Input<List<StreamBackfillAllOracleExcludedObjectsOracleSchema>>
  oracleSchemas;

  /// Creates a new [StreamBackfillAllOracleExcludedObjects].
  /// [oracleSchemas] Oracle schemas/databases in the database server
  StreamBackfillAllOracleExcludedObjects({required this.oracleSchemas});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'oracleSchemas':
          pulumi.Input.mapInputValue<
            List<StreamBackfillAllOracleExcludedObjectsOracleSchema>,
