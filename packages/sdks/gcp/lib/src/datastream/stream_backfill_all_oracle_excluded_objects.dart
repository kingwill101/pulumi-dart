...
class StreamBackfillAllOracleExcludedObjects {
  ...
  factory StreamBackfillAllOracleExcludedObjects.fromMap(Map<String, dynamic> map) {
    return StreamBackfillAllOracleExcludedObjects(
      oracleSchemas: pulumi.Input.fromValue(pulumi.Input.decodeList<StreamBackfillAllOracleExcludedObjectsOracleSchema>(map['oracleSchemas']!, (value) => StreamBackfillAllOracleExcludedObjectsOracleSchema.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
