...
class StreamSourceConfigMongodbSourceConfigExcludeObjects {
  ...
  final pulumi.Input<
    List<StreamSourceConfigMongodbSourceConfigExcludeObjectsDatabase>
  >?
  databases;

  /// Creates a new [StreamSourceConfigMongodbSourceConfigExcludeObjects].
  /// [databases] MongoDB databases in the cluster.
  StreamSourceConfigMongodbSourceConfigExcludeObjects({this.databases});
      ...
      databases: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                StreamSourceConfigMongodbSourceConfigExcludeObjectsDatabase.fromMap(
