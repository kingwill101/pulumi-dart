...
class StreamBackfillAllSpannerExcludedObjectsSchemaTable {
  ...
  factory StreamBackfillAllSpannerExcludedObjectsSchemaTable.fromMap(Map<String, dynamic> map) {
    return StreamBackfillAllSpannerExcludedObjectsSchemaTable(
      columns: (() { final guardedValue = map['columns']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<StreamBackfillAllSpannerExcludedObjectsSchemaTableColumn>(guardedValue, (value) => StreamBackfillAllSpannerExcludedObjectsSchemaTableColumn.fromMap((value as Map).cast<String, dynamic>()))); })(),
