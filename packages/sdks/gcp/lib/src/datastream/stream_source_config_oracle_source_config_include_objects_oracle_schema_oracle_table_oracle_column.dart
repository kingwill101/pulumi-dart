...
class StreamSourceConfigOracleSourceConfigIncludeObjectsOracleSchemaOracleTableOracleColumn {
  ...
  /// Creates a new [StreamSourceConfigOracleSourceConfigIncludeObjectsOracleSchemaOracleTableOracleColumn].
  /// [column] Column name.
  ...
  /// [primaryKey] (Output)
  /// [scale] (Output)
  const StreamSourceConfigOracleSourceConfigIncludeObjectsOracleSchemaOracleTableOracleColumn({
    this.column,
    this.dataType,
    this.encoding,
    this.length,
  ...
  factory StreamSourceConfigOracleSourceConfigIncludeObjectsOracleSchemaOracleTableOracleColumn.fromMap(Map<String, dynamic> map) {
