...
class StreamSourceConfigSqlServerSourceConfig {
  ...
  final pulumi.Input<StreamSourceConfigSqlServerSourceConfigExcludeObjects>?
  excludeObjects;

  /// SQL Server objects to retrieve from the source.
  /// Structure is documented below.
  final pulumi.Input<StreamSourceConfigSqlServerSourceConfigIncludeObjects>?
  includeObjects;
  ...
  factory StreamSourceConfigSqlServerSourceConfig.fromMap(
    ...
    return StreamSourceConfigSqlServerSourceConfig(
      changeTables: (() {
        final guardedValue = map['changeTables'];
      ...
      transactionLogs: (() {
        final guardedValue = map['transactionLogs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as Map).cast<String, dynamic>(),
        );
