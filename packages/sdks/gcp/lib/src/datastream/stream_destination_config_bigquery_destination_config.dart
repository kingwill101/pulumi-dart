...
class StreamDestinationConfigBigqueryDestinationConfig {
  ...
  factory StreamDestinationConfigBigqueryDestinationConfig.fromMap(
    ...
    return StreamDestinationConfigBigqueryDestinationConfig(
      ...
      blmtConfig: (() {
        final guardedValue = map['blmtConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      singleTargetDataset: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          StreamDestinationConfigBigqueryDestinationConfigSingleTargetDataset.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      sourceHierarchyDatasets: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          StreamDestinationConfigBigqueryDestinationConfigSourceHierarchyDatasets.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
