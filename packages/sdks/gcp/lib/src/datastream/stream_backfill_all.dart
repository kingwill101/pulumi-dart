...
class StreamBackfillAll {
  ...
  final pulumi.Input<StreamBackfillAllMongodbExcludedObjects>?
  mongodbExcludedObjects;

  /// MySQL data source objects to avoid backfilling.
  /// Structure is documented below.
  final pulumi.Input<StreamBackfillAllMysqlExcludedObjects>?
  mysqlExcludedObjects;

  /// PostgreSQL data source objects to avoid backfilling.
  /// Structure is documented below.
  final pulumi.Input<StreamBackfillAllOracleExcludedObjects>?
  oracleExcludedObjects;

  /// PostgreSQL data source objects to avoid backfilling.
  /// Structure is documented below.
  final pulumi.Input<StreamBackfillAllPostgresqlExcludedObjects>?
  postgresqlExcludedObjects;

  /// Salesforce objects to avoid backfilling.
  /// Structure is documented below.
  final pulumi.Input<StreamBackfillAllSalesforceExcludedObjects>?
  salesforceExcludedObjects;

  /// Spanner objects to avoid backfilling.
  /// Structure is documented below.
  final pulumi.Input<StreamBackfillAllSpannerExcludedObjects>?
  spannerExcludedObjects;

  /// SQL Server data source objects to avoid backfilling.
  /// Structure is documented below.
  final pulumi.Input<StreamBackfillAllSqlServerExcludedObjects>?
    ...
    return <String, dynamic>{
      'mongodbExcludedObjects':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(mongodbExcludedObjects, (value) => value.toMap()),
      'mysqlExcludedObjects':
          ?pulumi.Input.mapOptionalInputValue<
            StreamBackfillAllMysqlExcludedObjects,
            Map<String, dynamic>
          >(mysqlExcludedObjects, (value) => value.toMap()),
      'oracleExcludedObjects':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'salesforceExcludedObjects':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(salesforceExcludedObjects, (value) => value.toMap()),
      'spannerExcludedObjects':
          ?pulumi.Input.mapOptionalInputValue<
            StreamBackfillAllSpannerExcludedObjects,
            Map<String, dynamic>
          >(spannerExcludedObjects, (value) => value.toMap()),
      'sqlServerExcludedObjects':
          ?pulumi.Input.mapOptionalInputValue<
            StreamBackfillAllSqlServerExcludedObjects,
            Map<String, dynamic>
          >(sqlServerExcludedObjects, (value) => value.toMap()),
    };
  }
  ...
  factory StreamBackfillAll.fromMap(Map<String, dynamic> map) {
    return StreamBackfillAll(
      mongodbExcludedObjects: (() {
        final guardedValue = map['mongodbExcludedObjects'];
      ...
      salesforceExcludedObjects: (() {
        final guardedValue = map['salesforceExcludedObjects'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      spannerExcludedObjects: (() {
        final guardedValue = map['spannerExcludedObjects'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      sqlServerExcludedObjects: (() {
        final guardedValue = map['sqlServerExcludedObjects'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
