...
class StreamSourceConfigSqlServerSourceConfigIncludeObjectsSchemaTableColumn {
  /// Column name.
  ...
  /// Creates a new [StreamSourceConfigSqlServerSourceConfigIncludeObjectsSchemaTableColumn].
  /// [column] Column name.
  /// [dataType] (Output)
  /// [length] (Output)
  /// [nullable] (Output)
  ...
  factory StreamSourceConfigSqlServerSourceConfigIncludeObjectsSchemaTableColumn.fromMap(Map<String, dynamic> map) {
    return StreamSourceConfigSqlServerSourceConfigIncludeObjectsSchemaTableColumn(
