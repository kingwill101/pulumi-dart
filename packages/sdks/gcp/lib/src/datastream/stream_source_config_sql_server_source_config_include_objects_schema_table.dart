...
class StreamSourceConfigSqlServerSourceConfigIncludeObjectsSchemaTable {
  ...
  final pulumi.Input<
    List<StreamSourceConfigSqlServerSourceConfigIncludeObjectsSchemaTableColumn>
  >?
  columns;
      ...
      columns: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                StreamSourceConfigSqlServerSourceConfigIncludeObjectsSchemaTableColumn.fromMap(
