  ...
  factory PrivateConnectionState.fromMap(Map<String, dynamic> map) {
    return PrivateConnectionState(
      ...
      errors: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PrivateConnectionError>(
            guardedValue,
            (value) => PrivateConnectionError.fromMap(
      ...
      privateConnectionId: (() {
        final guardedValue = map['privateConnectionId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      project: (() {
