...
class StreamSourceConfigPostgresqlSourceConfigIncludeObjects {
  ...
  const StreamSourceConfigPostgresqlSourceConfigIncludeObjects({
  ...
  factory StreamSourceConfigPostgresqlSourceConfigIncludeObjects.fromMap(Map<String, dynamic> map) {
    return StreamSourceConfigPostgresqlSourceConfigIncludeObjects(
      postgresqlSchemas: pulumi.Input.fromValue(pulumi.Input.decodeList<StreamSourceConfigPostgresqlSourceConfigIncludeObjectsPostgresqlSchema>(map['postgresqlSchemas']!, (value) => StreamSourceConfigPostgresqlSourceConfigIncludeObjectsPostgresqlSchema.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
