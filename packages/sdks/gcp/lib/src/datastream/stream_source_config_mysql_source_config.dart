...
class StreamSourceConfigMysqlSourceConfig {
  ...
  final pulumi.Input<StreamSourceConfigMysqlSourceConfigExcludeObjects>?
  excludeObjects;
  ...
  /// Structure is documented below.
  final pulumi.Input<StreamSourceConfigMysqlSourceConfigIncludeObjects>?
  includeObjects;
  ...
  factory StreamSourceConfigMysqlSourceConfig.fromMap(
    ...
    return StreamSourceConfigMysqlSourceConfig(
      binaryLogPosition: (() {
        final guardedValue = map['binaryLogPosition'];
