...
import 'attestor_iam_policy_state.dart';
...
class AttestorIamPolicy extends pulumi.CustomResource {
  ...
  /// Gets an existing [AttestorIamPolicy] resource's state with the given [name] and [id].
  static AttestorIamPolicy get(
    String name,
    pulumi.Input<String> id, {
    AttestorIamPolicyState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return AttestorIamPolicy._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [AttestorIamPolicy] resource.
  AttestorIamPolicy.reference(String urn)
    : super(
        'gcp:binaryauthorization/attestorIamPolicy:AttestorIamPolicy',
