...
import 'attestor_iam_member_state.dart';
...
/// }
///
/// resource "gcp_binaryauthorization_attestoriampolicy" "policy" {
///   project     = attestor.project
///   attestor    = attestor.name
...
/// }
///
/// resource "gcp_binaryauthorization_attestoriambinding" "binding" {
///   project  = attestor.project
///   attestor = attestor.name
///   role     = "roles/viewer"
///   members  = ["user:jane@example.com"]
...
/// }
///
/// resource "gcp_binaryauthorization_attestoriammember" "member" {
///   project  = attestor.project
///   attestor = attestor.name
///   role     = "roles/viewer"
///   member   = "user:jane@example.com"
...
class AttestorIamMember extends pulumi.CustomResource {
  ...
  late final pulumi.Output<AttestorIamMemberCondition?> condition;
  ...
  /// Creates a new [AttestorIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [AttestorIamMember]. {@macro pulumi_binaryauthorization_attestor_iam_member_attestor_iam_member_args_doc}
  ...
  /// Gets an existing [AttestorIamMember] resource's state with the given [name] and [id].
  static AttestorIamMember get(
    String name,
