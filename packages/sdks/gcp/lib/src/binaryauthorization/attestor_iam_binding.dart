...
import 'attestor_iam_binding_state.dart';
...
class AttestorIamBinding extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [AttestorIamBinding]. {@macro pulumi_binaryauthorization_attestor_iam_binding_attestor_iam_binding_args_doc}
  ...
  AttestorIamBinding(
    ...
    condition = registerOutput<AttestorIamBindingCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return AttestorIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [AttestorIamBinding] resource's state with the given [name] and [id].
  static AttestorIamBinding get(
    String name,
    pulumi.Input<String> id, {
    AttestorIamBindingState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return AttestorIamBinding._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [AttestorIamBinding] resource.
  AttestorIamBinding.reference(String urn)
    : super(
        'gcp:binaryauthorization/attestorIamBinding:AttestorIamBinding',
