...
class AttestorIamMemberState {
  ...
  /// Creates a new [AttestorIamMemberState].
  ...
  factory AttestorIamMemberState.fromMap(Map<String, dynamic> map) {
    return AttestorIamMemberState(
