...
class ServicePerimeterIngressPolicyIngressTo {
  ...
  const ServicePerimeterIngressPolicyIngressTo({
    this.operations,
    this.resources,
    this.roles,
  });
  ...
  factory ServicePerimeterIngressPolicyIngressTo.fromMap(Map<String, dynamic> map) {
    return ServicePerimeterIngressPolicyIngressTo(
      operations: (() { final guardedValue = map['operations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ServicePerimeterIngressPolicyIngressToOperation>(guardedValue, (value) => ServicePerimeterIngressPolicyIngressToOperation.fromMap((value as Map).cast<String, dynamic>()))); })(),
