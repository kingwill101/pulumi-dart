...
class AccessPolicyIamBindingArgs {
  ...
  const AccessPolicyIamBindingArgs({
    this.condition,
  ...
  factory AccessPolicyIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return AccessPolicyIamBindingArgs(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AccessPolicyIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
