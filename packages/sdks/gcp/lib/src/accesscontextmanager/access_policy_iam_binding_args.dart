...
class AccessPolicyIamBindingArgs {
  ...
  AccessPolicyIamBindingArgs({
    pulumi.Output<AccessPolicyIamBindingCondition>? condition,
    required pulumi.Output<List<String>> members,
    pulumi.Output<String>? name,
    required pulumi.Output<String> role,
  }) :
      condition = pulumi.Input.asOptionalInput<AccessPolicyIamBindingCondition>(condition),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'condition': ?pulumi.Input.mapOptionalInputValue<AccessPolicyIamBindingCondition, Map<String, dynamic>>(condition, (value) => value.toMap()),
      'members': members,
      'name': ?name,
      'role': role,
    };
  ...
  factory AccessPolicyIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return AccessPolicyIamBindingArgs(
      condition: map['condition'] == null ? null : pulumi.Output.create<AccessPolicyIamBindingCondition>(AccessPolicyIamBindingCondition.fromMap((map['condition'] as Map).cast<String, dynamic>())),
