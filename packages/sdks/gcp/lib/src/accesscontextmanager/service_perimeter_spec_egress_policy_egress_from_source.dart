...
import 'service_perimeter_spec_egress_policy_egress_from_source_psc_endpoint.dart';
...
class ServicePerimeterSpecEgressPolicyEgressFromSource {
  ...
  final pulumi.Input<ServicePerimeterSpecEgressPolicyEgressFromSourcePscEndpoint?>? pscEndpoint;
  ...
  const ServicePerimeterSpecEgressPolicyEgressFromSource({
    this.accessLevel,
    this.pscEndpoint,
    this.resource,
  });
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'pscEndpoint': ?pulumi.Input.mapOptionalInputValue<ServicePerimeterSpecEgressPolicyEgressFromSourcePscEndpoint, Map<String, dynamic>>(pscEndpoint, (value) => value.toMap()),
      'resource': ?resource,
    };
  }
  ...
  factory ServicePerimeterSpecEgressPolicyEgressFromSource.fromMap(Map<String, dynamic> map) {
    return ServicePerimeterSpecEgressPolicyEgressFromSource(
      ...
      pscEndpoint: (() { final guardedValue = map['pscEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServicePerimeterSpecEgressPolicyEgressFromSourcePscEndpoint.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
