...
class ServicePerimeterIngressPolicyIngressFrom {
  ...
  final pulumi.Input<List<ServicePerimeterIngressPolicyIngressFromSource>>?
  sources;
    ...
    return <String, dynamic>{
      ...
      'sources':
          ?pulumi.Input.mapOptionalInputValue<
            List<ServicePerimeterIngressPolicyIngressFromSource>,
    ...
    return ServicePerimeterIngressPolicyIngressFrom(
      ...
      sources: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<ServicePerimeterIngressPolicyIngressFromSource>(
            guardedValue,
