...
import 'service_perimeter_status_ingress_policy_ingress_from_source_psc_endpoint.dart';
...
class ServicePerimeterStatusIngressPolicyIngressFromSource {
  ...
  final pulumi.Input<ServicePerimeterStatusIngressPolicyIngressFromSourcePscEndpoint>? pscEndpoint;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'pscEndpoint': ?pulumi.Input.mapOptionalInputValue<ServicePerimeterStatusIngressPolicyIngressFromSourcePscEndpoint, Map<String, dynamic>>(pscEndpoint, (value) => value.toMap()),
      'resource': ?resource,
    };
  }
  ...
  factory ServicePerimeterStatusIngressPolicyIngressFromSource.fromMap(Map<String, dynamic> map) {
    return ServicePerimeterStatusIngressPolicyIngressFromSource(
      ...
      pscEndpoint: (() { final guardedValue = map['pscEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServicePerimeterStatusIngressPolicyIngressFromSourcePscEndpoint.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
