...
class ServicePerimeterStatusIngressPolicyIngressFrom {
  ...
  factory ServicePerimeterStatusIngressPolicyIngressFrom.fromMap(Map<String, dynamic> map) {
    return ServicePerimeterStatusIngressPolicyIngressFrom(
      ...
      sources: map['sources'] == null ? null : (pulumi.Input.decodeList<ServicePerimeterStatusIngressPolicyIngressFromSource>(map['sources']!, (value) => ServicePerimeterStatusIngressPolicyIngressFromSource.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
