...
import 'service_perimeter_dry_run_egress_policy_egress_from_source_psc_endpoint.dart';

class ServicePerimeterDryRunEgressPolicyEgressFromSource {
  ...
  final pulumi.Input<ServicePerimeterDryRunEgressPolicyEgressFromSourcePscEndpoint?>? pscEndpoint;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'pscEndpoint': ?pulumi.Input.mapOptionalInputValue<ServicePerimeterDryRunEgressPolicyEgressFromSourcePscEndpoint, Map<String, dynamic>>(pscEndpoint, (value) => value.toMap()),
      'resource': ?resource,
    };
  }
  ...
  factory ServicePerimeterDryRunEgressPolicyEgressFromSource.fromMap(Map<String, dynamic> map) {
    return ServicePerimeterDryRunEgressPolicyEgressFromSource(
      ...
      pscEndpoint: (() { final guardedValue = map['pscEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServicePerimeterDryRunEgressPolicyEgressFromSourcePscEndpoint.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
