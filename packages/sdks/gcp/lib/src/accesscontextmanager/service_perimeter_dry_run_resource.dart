...
import 'service_perimeter_dry_run_resource_state.dart';
...
class ServicePerimeterDryRunResource extends pulumi.CustomResource {
  ...
  /// Gets an existing [ServicePerimeterDryRunResource] resource's state with the given [name] and [id].
  static ServicePerimeterDryRunResource get(
    String name,
  ...
  ServicePerimeterDryRunResource._get(
    String name, {
