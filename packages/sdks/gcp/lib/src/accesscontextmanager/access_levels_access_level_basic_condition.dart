...
class AccessLevelsAccessLevelBasicCondition {
  ...
  final pulumi.Input<AccessLevelsAccessLevelBasicConditionDevicePolicy>? devicePolicy;
  ...
  /// Structure is documented below.
  final pulumi.Input<List<AccessLevelsAccessLevelBasicConditionVpcNetworkSource>>? vpcNetworkSources;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'devicePolicy': ?pulumi.Input.mapOptionalInputValue<AccessLevelsAccessLevelBasicConditionDevicePolicy, Map<String, dynamic>>(devicePolicy, (value) => value.toMap()),
      'ipSubnetworks': ?ipSubnetworks,
      'members': ?members,
      'negate': ?negate,
      'regions': ?regions,
      'requiredAccessLevels': ?requiredAccessLevels,
      'vpcNetworkSources': ?pulumi.Input.mapOptionalInputValue<List<AccessLevelsAccessLevelBasicConditionVpcNetworkSource>, List<Map<String, dynamic>>>(vpcNetworkSources, (value) => pulumi.Input.encodeList<AccessLevelsAccessLevelBasicConditionVpcNetworkSource, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory AccessLevelsAccessLevelBasicCondition.fromMap(Map<String, dynamic> map) {
    return AccessLevelsAccessLevelBasicCondition(
      devicePolicy: (() { final guardedValue = map['devicePolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AccessLevelsAccessLevelBasicConditionDevicePolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      vpcNetworkSources: (() { final guardedValue = map['vpcNetworkSources']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AccessLevelsAccessLevelBasicConditionVpcNetworkSource>(guardedValue, (value) => AccessLevelsAccessLevelBasicConditionVpcNetworkSource.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
