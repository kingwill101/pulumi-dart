...
import 'access_policy_iam_policy_state.dart';
...
class AccessPolicyIamPolicy extends pulumi.CustomResource {
  ...
  /// Gets an existing [AccessPolicyIamPolicy] resource's state with the given [name] and [id].
  static AccessPolicyIamPolicy get(
    String name,
    pulumi.Input<String> id, {
    AccessPolicyIamPolicyState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return AccessPolicyIamPolicy._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [AccessPolicyIamPolicy] resource.
  AccessPolicyIamPolicy.reference(String urn)
    : super(
        'gcp:accesscontextmanager/accessPolicyIamPolicy:AccessPolicyIamPolicy',
