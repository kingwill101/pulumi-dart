...
class ServicePerimeterStatus {
  ...
  factory ServicePerimeterStatus.fromMap(Map<String, dynamic> map) {
    return ServicePerimeterStatus(
      ...
      egressPolicies: (() { final guardedValue = map['egressPolicies']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ServicePerimeterStatusEgressPolicy>(guardedValue, (value) => ServicePerimeterStatusEgressPolicy.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ingressPolicies: (() { final guardedValue = map['ingressPolicies']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ServicePerimeterStatusIngressPolicy>(guardedValue, (value) => ServicePerimeterStatusIngressPolicy.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      vpcAccessibleServices: (() { final guardedValue = map['vpcAccessibleServices']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServicePerimeterStatusVpcAccessibleServices.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
