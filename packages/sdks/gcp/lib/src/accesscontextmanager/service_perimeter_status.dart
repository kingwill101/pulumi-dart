...
class ServicePerimeterStatus {
  ...
  /// Structure is documented below.
  final pulumi.Input<List<ServicePerimeterStatusIngressPolicy>>?
  ingressPolicies;
  ...
  /// Perimeter.
  /// Structure is documented below.
  final pulumi.Input<ServicePerimeterStatusVpcAccessibleServices>?
    ...
    return <String, dynamic>{
      ...
      'egressPolicies':
          ?pulumi.Input.mapOptionalInputValue<
            List<ServicePerimeterStatusEgressPolicy>,
      ...
      'ingressPolicies':
          ?pulumi.Input.mapOptionalInputValue<
            List<ServicePerimeterStatusIngressPolicy>,
            List<Map<String, dynamic>>
          >(
            ingressPolicies,
            (value) =>
