...
class ServicePerimeterSpecIngressPolicyIngressToOperationMethodSelector {
  ...
  const ServicePerimeterSpecIngressPolicyIngressToOperationMethodSelector({
    this.method,
    this.permission,
  });
  ...
  factory ServicePerimeterSpecIngressPolicyIngressToOperationMethodSelector.fromMap(Map<String, dynamic> map) {
