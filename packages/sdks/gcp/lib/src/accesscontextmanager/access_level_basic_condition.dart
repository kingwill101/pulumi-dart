...
class AccessLevelBasicCondition {
  ...
  factory AccessLevelBasicCondition.fromMap(Map<String, dynamic> map) {
    return AccessLevelBasicCondition(
      devicePolicy: map['devicePolicy'] == null ? null : (AccessLevelBasicConditionDevicePolicy.fromMap((map['devicePolicy'] as Map).cast<String, dynamic>())).input(),
      ...
      vpcNetworkSources: map['vpcNetworkSources'] == null ? null : (pulumi.Input.decodeList<AccessLevelBasicConditionVpcNetworkSource>(map['vpcNetworkSources'], (value) => AccessLevelBasicConditionVpcNetworkSource.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
