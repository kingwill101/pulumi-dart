...
class AccessLevelBasicCondition {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'devicePolicy': ?pulumi.Input.mapOptionalInputValue<AccessLevelBasicConditionDevicePolicy, Map<String, dynamic>>(devicePolicy, (value) => value.toMap()),
      'ipSubnetworks': ?ipSubnetworks,
      'members': ?members,
      'negate': ?negate,
      'regions': ?regions,
      'requiredAccessLevels': ?requiredAccessLevels,
      'vpcNetworkSources': ?pulumi.Input.mapOptionalInputValue<List<AccessLevelBasicConditionVpcNetworkSource>, List<Map<String, dynamic>>>(vpcNetworkSources, (value) => pulumi.Input.encodeList<AccessLevelBasicConditionVpcNetworkSource, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory AccessLevelBasicCondition.fromMap(Map<String, dynamic> map) {
    return AccessLevelBasicCondition(
      devicePolicy: (() { final guardedValue = map['devicePolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AccessLevelBasicConditionDevicePolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      vpcNetworkSources: (() { final guardedValue = map['vpcNetworkSources']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AccessLevelBasicConditionVpcNetworkSource>(guardedValue, (value) => AccessLevelBasicConditionVpcNetworkSource.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
