...
class ServicePerimetersServicePerimeterStatus {
  ...
  factory ServicePerimetersServicePerimeterStatus.fromMap(Map<String, dynamic> map) {
    return ServicePerimetersServicePerimeterStatus(
      ...
      egressPolicies: (() { final guardedValue = map['egressPolicies']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ServicePerimetersServicePerimeterStatusEgressPolicy>(guardedValue, (value) => ServicePerimetersServicePerimeterStatusEgressPolicy.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ingressPolicies: (() { final guardedValue = map['ingressPolicies']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ServicePerimetersServicePerimeterStatusIngressPolicy>(guardedValue, (value) => ServicePerimetersServicePerimeterStatusIngressPolicy.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      vpcAccessibleServices: (() { final guardedValue = map['vpcAccessibleServices']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServicePerimetersServicePerimeterStatusVpcAccessibleServices.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
