...
class ServicePerimetersServicePerimeterStatus {
  ...
  final pulumi.Input<List<ServicePerimetersServicePerimeterStatusEgressPolicy>>?
  egressPolicies;
  ...
  /// Structure is documented below.
  final pulumi.Input<
    List<ServicePerimetersServicePerimeterStatusIngressPolicy>
  >?
  ingressPolicies;
    ...
    return <String, dynamic>{
      ...
      'egressPolicies':
          ?pulumi.Input.mapOptionalInputValue<
            List<ServicePerimetersServicePerimeterStatusEgressPolicy>,
