...
class AccessLevelsAccessLevelBasicConditionDevicePolicy {
  ...
  final pulumi.Input<List<AccessLevelsAccessLevelBasicConditionDevicePolicyOsConstraint>>? osConstraints;
  ...
  const AccessLevelsAccessLevelBasicConditionDevicePolicy({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'osConstraints': ?pulumi.Input.mapOptionalInputValue<List<AccessLevelsAccessLevelBasicConditionDevicePolicyOsConstraint>, List<Map<String, dynamic>>>(osConstraints, (value) => pulumi.Input.encodeList<AccessLevelsAccessLevelBasicConditionDevicePolicyOsConstraint, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory AccessLevelsAccessLevelBasicConditionDevicePolicy.fromMap(Map<String, dynamic> map) {
    return AccessLevelsAccessLevelBasicConditionDevicePolicy(
      ...
      osConstraints: (() { final guardedValue = map['osConstraints']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AccessLevelsAccessLevelBasicConditionDevicePolicyOsConstraint>(guardedValue, (value) => AccessLevelsAccessLevelBasicConditionDevicePolicyOsConstraint.fromMap((value as Map).cast<String, dynamic>()))); })(),
