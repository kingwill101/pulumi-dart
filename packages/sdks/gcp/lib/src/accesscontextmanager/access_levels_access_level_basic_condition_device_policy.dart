...
class AccessLevelsAccessLevelBasicConditionDevicePolicy {
  ...
  factory AccessLevelsAccessLevelBasicConditionDevicePolicy.fromMap(Map<String, dynamic> map) {
    return AccessLevelsAccessLevelBasicConditionDevicePolicy(
      ...
      osConstraints: map['osConstraints'] == null ? null : (pulumi.Input.decodeList<AccessLevelsAccessLevelBasicConditionDevicePolicyOsConstraint>(map['osConstraints'], (value) => AccessLevelsAccessLevelBasicConditionDevicePolicyOsConstraint.fromMap((value as Map).cast<String, dynamic>()))).input(),
