...
class AccessLevelBasic {
  ...
  factory AccessLevelBasic.fromMap(Map<String, dynamic> map) {
    return AccessLevelBasic(
      ...
      conditions: pulumi.Input.fromValue(pulumi.Input.decodeList<AccessLevelBasicCondition>(map['conditions']!, (value) => AccessLevelBasicCondition.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
