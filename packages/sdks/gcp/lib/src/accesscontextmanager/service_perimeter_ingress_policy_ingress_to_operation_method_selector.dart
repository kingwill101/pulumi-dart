...
class ServicePerimeterIngressPolicyIngressToOperationMethodSelector {
  ...
  /// Creates a new [ServicePerimeterIngressPolicyIngressToOperationMethodSelector].
  ...
  const ServicePerimeterIngressPolicyIngressToOperationMethodSelector({
    this.method,
    this.permission,
  });
  ...
  factory ServicePerimeterIngressPolicyIngressToOperationMethodSelector.fromMap(Map<String, dynamic> map) {
    return ServicePerimeterIngressPolicyIngressToOperationMethodSelector(
