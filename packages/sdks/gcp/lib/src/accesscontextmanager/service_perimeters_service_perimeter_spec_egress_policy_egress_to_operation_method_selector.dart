...
class ServicePerimetersServicePerimeterSpecEgressPolicyEgressToOperationMethodSelector {
  ...
  const ServicePerimetersServicePerimeterSpecEgressPolicyEgressToOperationMethodSelector({
    this.method,
    this.permission,
  });
  ...
  factory ServicePerimetersServicePerimeterSpecEgressPolicyEgressToOperationMethodSelector.fromMap(Map<String, dynamic> map) {
