...
import 'service_perimeter_egress_policy_egress_from_source_psc_endpoint.dart';
...
class ServicePerimeterEgressPolicyEgressFromSource {
  ...
  final pulumi.Input<ServicePerimeterEgressPolicyEgressFromSourcePscEndpoint?>? pscEndpoint;
  ...
  const ServicePerimeterEgressPolicyEgressFromSource({
    this.accessLevel,
    this.pscEndpoint,
    this.resource,
  });
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'pscEndpoint': ?pulumi.Input.mapOptionalInputValue<ServicePerimeterEgressPolicyEgressFromSourcePscEndpoint, Map<String, dynamic>>(pscEndpoint, (value) => value.toMap()),
      'resource': ?resource,
    };
  }
  ...
  factory ServicePerimeterEgressPolicyEgressFromSource.fromMap(Map<String, dynamic> map) {
    return ServicePerimeterEgressPolicyEgressFromSource(
      ...
      pscEndpoint: (() { final guardedValue = map['pscEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServicePerimeterEgressPolicyEgressFromSourcePscEndpoint.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
