...
class ServicePerimeterStatusEgressPolicyEgressTo {
  ...
  final pulumi.Input<List<ServicePerimeterStatusEgressPolicyEgressToOperation>>? operations;
  ...
  const ServicePerimeterStatusEgressPolicyEgressTo({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'operations': ?pulumi.Input.mapOptionalInputValue<List<ServicePerimeterStatusEgressPolicyEgressToOperation>, List<Map<String, dynamic>>>(operations, (value) => pulumi.Input.encodeList<ServicePerimeterStatusEgressPolicyEgressToOperation, Map<String, dynamic>>(value, (value) => value.toMap())),
      'resources': ?resources,
      'roles': ?roles,
    };
  }
  ...
  factory ServicePerimeterStatusEgressPolicyEgressTo.fromMap(Map<String, dynamic> map) {
    return ServicePerimeterStatusEgressPolicyEgressTo(
      ...
      operations: (() { final guardedValue = map['operations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ServicePerimeterStatusEgressPolicyEgressToOperation>(guardedValue, (value) => ServicePerimeterStatusEgressPolicyEgressToOperation.fromMap((value as Map).cast<String, dynamic>()))); })(),
