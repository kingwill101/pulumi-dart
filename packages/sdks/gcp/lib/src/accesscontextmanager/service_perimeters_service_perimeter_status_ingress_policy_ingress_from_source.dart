...
import 'service_perimeters_service_perimeter_status_ingress_policy_ingress_from_source_psc_endpoint.dart';
...
class ServicePerimetersServicePerimeterStatusIngressPolicyIngressFromSource {
  ...
  const ServicePerimetersServicePerimeterStatusIngressPolicyIngressFromSource({
    this.accessLevel,
    this.pscEndpoint,
    this.resource,
  });
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'pscEndpoint': ?pulumi.Input.mapOptionalInputValue<ServicePerimetersServicePerimeterStatusIngressPolicyIngressFromSourcePscEndpoint, Map<String, dynamic>>(pscEndpoint, (value) => value.toMap()),
      'resource': ?resource,
    };
  }

  factory ServicePerimetersServicePerimeterStatusIngressPolicyIngressFromSource.fromMap(Map<String, dynamic> map) {
    return ServicePerimetersServicePerimeterStatusIngressPolicyIngressFromSource(
      ...
      pscEndpoint: (() { final guardedValue = map['pscEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServicePerimetersServicePerimeterStatusIngressPolicyIngressFromSourcePscEndpoint.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
