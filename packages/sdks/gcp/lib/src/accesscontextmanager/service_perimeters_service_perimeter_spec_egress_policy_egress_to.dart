...
class ServicePerimetersServicePerimeterSpecEgressPolicyEgressTo {
  ...
  final pulumi.Input<List<ServicePerimetersServicePerimeterSpecEgressPolicyEgressToOperation>>? operations;
  ...
  const ServicePerimetersServicePerimeterSpecEgressPolicyEgressTo({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'operations': ?pulumi.Input.mapOptionalInputValue<List<ServicePerimetersServicePerimeterSpecEgressPolicyEgressToOperation>, List<Map<String, dynamic>>>(operations, (value) => pulumi.Input.encodeList<ServicePerimetersServicePerimeterSpecEgressPolicyEgressToOperation, Map<String, dynamic>>(value, (value) => value.toMap())),
      'resources': ?resources,
      'roles': ?roles,
    };
  }
  ...
  factory ServicePerimetersServicePerimeterSpecEgressPolicyEgressTo.fromMap(Map<String, dynamic> map) {
    return ServicePerimetersServicePerimeterSpecEgressPolicyEgressTo(
      ...
      operations: (() { final guardedValue = map['operations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ServicePerimetersServicePerimeterSpecEgressPolicyEgressToOperation>(guardedValue, (value) => ServicePerimetersServicePerimeterSpecEgressPolicyEgressToOperation.fromMap((value as Map).cast<String, dynamic>()))); })(),
