...
class ServicePerimetersServicePerimeterSpecEgressPolicyEgressTo {
  ...
  factory ServicePerimetersServicePerimeterSpecEgressPolicyEgressTo.fromMap(Map<String, dynamic> map) {
    return ServicePerimetersServicePerimeterSpecEgressPolicyEgressTo(
      ...
      operations: map['operations'] == null ? null : (pulumi.Input.decodeList<ServicePerimetersServicePerimeterSpecEgressPolicyEgressToOperation>(map['operations']!, (value) => ServicePerimetersServicePerimeterSpecEgressPolicyEgressToOperation.fromMap((value as Map).cast<String, dynamic>()))).input(),
