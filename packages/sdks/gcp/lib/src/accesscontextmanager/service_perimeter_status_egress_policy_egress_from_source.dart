...
import 'service_perimeter_status_egress_policy_egress_from_source_psc_endpoint.dart';
...
class ServicePerimeterStatusEgressPolicyEgressFromSource {
  ...
  final pulumi.Input<ServicePerimeterStatusEgressPolicyEgressFromSourcePscEndpoint>? pscEndpoint;
  ...
  /// Creates a new [ServicePerimeterStatusEgressPolicyEgressFromSource].
  ...
  const ServicePerimeterStatusEgressPolicyEgressFromSource({
    this.accessLevel,
    this.pscEndpoint,
    this.resource,
  });
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'pscEndpoint': ?pulumi.Input.mapOptionalInputValue<ServicePerimeterStatusEgressPolicyEgressFromSourcePscEndpoint, Map<String, dynamic>>(pscEndpoint, (value) => value.toMap()),
      'resource': ?resource,
    };
  }

  factory ServicePerimeterStatusEgressPolicyEgressFromSource.fromMap(Map<String, dynamic> map) {
    return ServicePerimeterStatusEgressPolicyEgressFromSource(
      ...
      pscEndpoint: (() { final guardedValue = map['pscEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServicePerimeterStatusEgressPolicyEgressFromSourcePscEndpoint.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
