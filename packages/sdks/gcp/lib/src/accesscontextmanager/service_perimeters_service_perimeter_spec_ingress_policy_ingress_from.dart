...
class ServicePerimetersServicePerimeterSpecIngressPolicyIngressFrom {
  ...
  final pulumi.Input<
    List<ServicePerimetersServicePerimeterSpecIngressPolicyIngressFromSource>
  >?
  sources;
  ...
  factory ServicePerimetersServicePerimeterSpecIngressPolicyIngressFrom.fromMap(
      ...
      sources: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                ServicePerimetersServicePerimeterSpecIngressPolicyIngressFromSource.fromMap(
