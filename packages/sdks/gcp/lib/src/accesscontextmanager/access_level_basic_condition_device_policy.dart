...
class AccessLevelBasicConditionDevicePolicy {
  ...
  final List<AccessLevelBasicConditionDevicePolicyOsConstraint>? osConstraints;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'osConstraints': ?osConstraints == null ? null : pulumi.Input.encodeList<AccessLevelBasicConditionDevicePolicyOsConstraint, Map<String, dynamic>>(osConstraints!, (value) => value.toMap()),
  ...
  factory AccessLevelBasicConditionDevicePolicy.fromMap(Map<String, dynamic> map) {
    return AccessLevelBasicConditionDevicePolicy(
      ...
      osConstraints: map['osConstraints'] == null ? null : pulumi.Input.decodeList<AccessLevelBasicConditionDevicePolicyOsConstraint>(map['osConstraints'], (value) => AccessLevelBasicConditionDevicePolicyOsConstraint.fromMap((value as Map).cast<String, dynamic>())),
