...
class ServicePerimeterEgressPolicyEgressFrom {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'sources': ?sources == null ? null : pulumi.Input.encodeList<ServicePerimeterEgressPolicyEgressFromSource, Map<String, dynamic>>(sources!, (value) => value.toMap()),
    };
  }
  ...
  factory ServicePerimeterEgressPolicyEgressFrom.fromMap(Map<String, dynamic> map) {
    return ServicePerimeterEgressPolicyEgressFrom(
      ...
      sources: map['sources'] == null ? null : pulumi.Input.decodeList<ServicePerimeterEgressPolicyEgressFromSource>(map['sources'], (value) => ServicePerimeterEgressPolicyEgressFromSource.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
