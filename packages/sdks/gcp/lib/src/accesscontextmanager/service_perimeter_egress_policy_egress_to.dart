...
class ServicePerimeterEgressPolicyEgressTo {
  ...
  final pulumi.Input<List<ServicePerimeterEgressPolicyEgressToOperation>>? operations;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'operations': ?pulumi.Input.mapOptionalInputValue<List<ServicePerimeterEgressPolicyEgressToOperation>, List<Map<String, dynamic>>>(operations, (value) => pulumi.Input.encodeList<ServicePerimeterEgressPolicyEgressToOperation, Map<String, dynamic>>(value, (value) => value.toMap())),
      'resources': ?resources,
      'roles': ?roles,
    };
  }

  factory ServicePerimeterEgressPolicyEgressTo.fromMap(Map<String, dynamic> map) {
    return ServicePerimeterEgressPolicyEgressTo(
      ...
      operations: (() { final guardedValue = map['operations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ServicePerimeterEgressPolicyEgressToOperation>(guardedValue, (value) => ServicePerimeterEgressPolicyEgressToOperation.fromMap((value as Map).cast<String, dynamic>()))); })(),
