...
class ServicePerimeterSpec {
  ...
  factory ServicePerimeterSpec.fromMap(Map<String, dynamic> map) {
    return ServicePerimeterSpec(
      ...
      egressPolicies: (() { final guardedValue = map['egressPolicies']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ServicePerimeterSpecEgressPolicy>(guardedValue, (value) => ServicePerimeterSpecEgressPolicy.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ingressPolicies: (() { final guardedValue = map['ingressPolicies']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ServicePerimeterSpecIngressPolicy>(guardedValue, (value) => ServicePerimeterSpecIngressPolicy.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      vpcAccessibleServices: (() { final guardedValue = map['vpcAccessibleServices']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServicePerimeterSpecVpcAccessibleServices.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
