...
class ServicePerimeterDryRunIngressPolicyIngressTo {
  ...
  final pulumi.Input<
    List<ServicePerimeterDryRunIngressPolicyIngressToOperation>
  >?
  operations;
  ...
  factory ServicePerimeterDryRunIngressPolicyIngressTo.fromMap(
      ...
      operations: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                ServicePerimeterDryRunIngressPolicyIngressToOperation.fromMap(
