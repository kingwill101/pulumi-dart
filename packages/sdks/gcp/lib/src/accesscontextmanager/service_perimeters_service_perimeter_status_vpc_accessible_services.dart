...
import 'service_perimeters_service_perimeter_status_vpc_accessible_services_allowed_service_pattern.dart';
...
class ServicePerimetersServicePerimeterStatusVpcAccessibleServices {
  ...
  final pulumi.Input<List<ServicePerimetersServicePerimeterStatusVpcAccessibleServicesAllowedServicePattern>>? allowedServicePatterns;
  ...
  const ServicePerimetersServicePerimeterStatusVpcAccessibleServices({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'allowedServicePatterns': ?pulumi.Input.mapOptionalInputValue<List<ServicePerimetersServicePerimeterStatusVpcAccessibleServicesAllowedServicePattern>, List<Map<String, dynamic>>>(allowedServicePatterns, (value) => pulumi.Input.encodeList<ServicePerimetersServicePerimeterStatusVpcAccessibleServicesAllowedServicePattern, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory ServicePerimetersServicePerimeterStatusVpcAccessibleServices.fromMap(Map<String, dynamic> map) {
    return ServicePerimetersServicePerimeterStatusVpcAccessibleServices(
      allowedServicePatterns: (() { final guardedValue = map['allowedServicePatterns']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ServicePerimetersServicePerimeterStatusVpcAccessibleServicesAllowedServicePattern>(guardedValue, (value) => ServicePerimetersServicePerimeterStatusVpcAccessibleServicesAllowedServicePattern.fromMap((value as Map).cast<String, dynamic>()))); })(),
