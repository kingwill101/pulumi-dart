...
class ServicePerimeterEgressPolicyEgressFromSourcePscEndpoint {
  ...
  /// Creates a new [ServicePerimeterEgressPolicyEgressFromSourcePscEndpoint].
  /// [forwardingRule] The full resource name of the global forwarding rule that identifies a Private Service Connect endpoint.
  const ServicePerimeterEgressPolicyEgressFromSourcePscEndpoint({
    this.forwardingRule,
  });
  ...
  factory ServicePerimeterEgressPolicyEgressFromSourcePscEndpoint.fromMap(Map<String, dynamic> map) {
    return ServicePerimeterEgressPolicyEgressFromSourcePscEndpoint(
