...
import 'service_perimeters_service_perimeter_spec_vpc_accessible_services_allowed_service_pattern.dart';
...
class ServicePerimetersServicePerimeterSpecVpcAccessibleServices {
  ...
  const ServicePerimetersServicePerimeterSpecVpcAccessibleServices({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'allowedServicePatterns': ?pulumi.Input.mapOptionalInputValue<List<ServicePerimetersServicePerimeterSpecVpcAccessibleServicesAllowedServicePattern>, List<Map<String, dynamic>>>(allowedServicePatterns, (value) => pulumi.Input.encodeList<ServicePerimetersServicePerimeterSpecVpcAccessibleServicesAllowedServicePattern, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory ServicePerimetersServicePerimeterSpecVpcAccessibleServices.fromMap(Map<String, dynamic> map) {
    return ServicePerimetersServicePerimeterSpecVpcAccessibleServices(
      allowedServicePatterns: (() { final guardedValue = map['allowedServicePatterns']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ServicePerimetersServicePerimeterSpecVpcAccessibleServicesAllowedServicePattern>(guardedValue, (value) => ServicePerimetersServicePerimeterSpecVpcAccessibleServicesAllowedServicePattern.fromMap((value as Map).cast<String, dynamic>()))); })(),
