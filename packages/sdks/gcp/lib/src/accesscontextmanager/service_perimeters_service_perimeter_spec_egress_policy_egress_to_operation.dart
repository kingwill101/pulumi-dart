...
class ServicePerimetersServicePerimeterSpecEgressPolicyEgressToOperation {
  ...
  final pulumi.Input<List<ServicePerimetersServicePerimeterSpecEgressPolicyEgressToOperationMethodSelector>>? methodSelectors;
  ...
  const ServicePerimetersServicePerimeterSpecEgressPolicyEgressToOperation({
  ...
  factory ServicePerimetersServicePerimeterSpecEgressPolicyEgressToOperation.fromMap(Map<String, dynamic> map) {
    return ServicePerimetersServicePerimeterSpecEgressPolicyEgressToOperation(
      methodSelectors: (() { final guardedValue = map['methodSelectors']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ServicePerimetersServicePerimeterSpecEgressPolicyEgressToOperationMethodSelector>(guardedValue, (value) => ServicePerimetersServicePerimeterSpecEgressPolicyEgressToOperationMethodSelector.fromMap((value as Map).cast<String, dynamic>()))); })(),
