...
class ServicePerimetersServicePerimeterSpecIngressPolicyIngressFromSourcePscEndpoint {
  ...
  /// Creates a new [ServicePerimetersServicePerimeterSpecIngressPolicyIngressFromSourcePscEndpoint].
  /// [forwardingRule] The full resource name of the global forwarding rule that identifies a Private Service Connect endpoint.
  const ServicePerimetersServicePerimeterSpecIngressPolicyIngressFromSourcePscEndpoint({
    this.forwardingRule,
  });
  ...
  factory ServicePerimetersServicePerimeterSpecIngressPolicyIngressFromSourcePscEndpoint.fromMap(Map<String, dynamic> map) {
    return ServicePerimetersServicePerimeterSpecIngressPolicyIngressFromSourcePscEndpoint(
