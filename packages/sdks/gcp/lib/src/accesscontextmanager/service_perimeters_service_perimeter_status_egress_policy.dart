...
class ServicePerimetersServicePerimeterStatusEgressPolicy {
  ...
  factory ServicePerimetersServicePerimeterStatusEgressPolicy.fromMap(Map<String, dynamic> map) {
    return ServicePerimetersServicePerimeterStatusEgressPolicy(
      egressFrom: map['egressFrom'] == null ? null : (ServicePerimetersServicePerimeterStatusEgressPolicyEgressFrom.fromMap((map['egressFrom']! as Map).cast<String, dynamic>())).input(),
      egressTo: map['egressTo'] == null ? null : (ServicePerimetersServicePerimeterStatusEgressPolicyEgressTo.fromMap((map['egressTo']! as Map).cast<String, dynamic>())).input(),
