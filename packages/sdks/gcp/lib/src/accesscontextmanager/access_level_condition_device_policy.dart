...
class AccessLevelConditionDevicePolicy {
  ...
  final pulumi.Input<List<AccessLevelConditionDevicePolicyOsConstraint>>?
  osConstraints;
    ...
    return <String, dynamic>{
      ...
      'osConstraints':
          ?pulumi.Input.mapOptionalInputValue<
            List<AccessLevelConditionDevicePolicyOsConstraint>,
    ...
    return AccessLevelConditionDevicePolicy(
      ...
      osConstraints: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AccessLevelConditionDevicePolicyOsConstraint>(
            guardedValue,
