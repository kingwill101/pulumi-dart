...
import 'authorized_orgs_desc_state.dart';
...
class AuthorizedOrgsDesc extends pulumi.CustomResource {
  ...
  /// Gets an existing [AuthorizedOrgsDesc] resource's state with the given [name] and [id].
  static AuthorizedOrgsDesc get(
    String name,
