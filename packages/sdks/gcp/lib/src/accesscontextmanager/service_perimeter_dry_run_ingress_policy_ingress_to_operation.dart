...
class ServicePerimeterDryRunIngressPolicyIngressToOperation {
  ...
  const ServicePerimeterDryRunIngressPolicyIngressToOperation({
  ...
  factory ServicePerimeterDryRunIngressPolicyIngressToOperation.fromMap(Map<String, dynamic> map) {
    return ServicePerimeterDryRunIngressPolicyIngressToOperation(
      methodSelectors: (() { final guardedValue = map['methodSelectors']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ServicePerimeterDryRunIngressPolicyIngressToOperationMethodSelector>(guardedValue, (value) => ServicePerimeterDryRunIngressPolicyIngressToOperationMethodSelector.fromMap((value as Map).cast<String, dynamic>()))); })(),
