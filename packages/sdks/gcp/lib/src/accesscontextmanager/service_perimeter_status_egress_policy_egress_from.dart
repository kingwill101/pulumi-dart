...
class ServicePerimeterStatusEgressPolicyEgressFrom {
  ...
  final pulumi.Input<List<ServicePerimeterStatusEgressPolicyEgressFromSource>>?
  sources;
    ...
    return <String, dynamic>{
      ...
      'sources':
          ?pulumi.Input.mapOptionalInputValue<
            List<ServicePerimeterStatusEgressPolicyEgressFromSource>,
  ...
  factory ServicePerimeterStatusEgressPolicyEgressFrom.fromMap(
      ...
      sources: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                ServicePerimeterStatusEgressPolicyEgressFromSource.fromMap(
