...
import 'service_perimeter_status_egress_policy_egress_from_source.dart';
...
class ServicePerimeterStatusEgressPolicyEgressFrom {
  ...
  const ServicePerimeterStatusEgressPolicyEgressFrom({
    this.identities,
    this.identityType,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'sources': ?pulumi.Input.mapOptionalInputValue<List<ServicePerimeterStatusEgressPolicyEgressFromSource>, List<Map<String, dynamic>>>(sources, (value) => pulumi.Input.encodeList<ServicePerimeterStatusEgressPolicyEgressFromSource, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory ServicePerimeterStatusEgressPolicyEgressFrom.fromMap(Map<String, dynamic> map) {
    return ServicePerimeterStatusEgressPolicyEgressFrom(
      ...
      sources: (() { final guardedValue = map['sources']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ServicePerimeterStatusEgressPolicyEgressFromSource>(guardedValue, (value) => ServicePerimeterStatusEgressPolicyEgressFromSource.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
