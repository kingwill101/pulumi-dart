...
class GcpUserAccessBindingScopedAccessSettingActiveSettingsSessionSettings {
  ...
  factory GcpUserAccessBindingScopedAccessSettingActiveSettingsSessionSettings.fromMap(
    ...
    return GcpUserAccessBindingScopedAccessSettingActiveSettingsSessionSettings(
      maxInactivity: (() {
        final guardedValue = map['maxInactivity'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      sessionLength: (() {
        final guardedValue = map['sessionLength'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      sessionLengthEnabled: (() {
        final guardedValue = map['sessionLengthEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      sessionReauthMethod: (() {
        final guardedValue = map['sessionReauthMethod'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      useOidcMaxAge: (() {
        final guardedValue = map['useOidcMaxAge'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
    );
