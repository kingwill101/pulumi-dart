...
class GcpUserAccessBindingScopedAccessSetting {
  ...
  final pulumi.Input<GcpUserAccessBindingScopedAccessSettingActiveSettings>?
  activeSettings;
  ...
  /// Structure is documented below.
  final pulumi.Input<GcpUserAccessBindingScopedAccessSettingDryRunSettings>?
  dryRunSettings;
    ...
    return <String, dynamic>{
      'activeSettings':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(activeSettings, (value) => value.toMap()),
      'dryRunSettings':
          ?pulumi.Input.mapOptionalInputValue<
            GcpUserAccessBindingScopedAccessSettingDryRunSettings,
            Map<String, dynamic>
          >(dryRunSettings, (value) => value.toMap()),
      'scope':
          ?pulumi.Input.mapOptionalInputValue<
  ...
  factory GcpUserAccessBindingScopedAccessSetting.fromMap(
    ...
    return GcpUserAccessBindingScopedAccessSetting(
      activeSettings: (() {
        final guardedValue = map['activeSettings'];
      ...
      dryRunSettings: (() {
        final guardedValue = map['dryRunSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
