...
class ServicePerimeterSpecEgressPolicyEgressFromSourcePscEndpoint {
  ...
  /// Creates a new [ServicePerimeterSpecEgressPolicyEgressFromSourcePscEndpoint].
  /// [forwardingRule] The full resource name of the global forwarding rule that identifies a Private Service Connect endpoint.
  const ServicePerimeterSpecEgressPolicyEgressFromSourcePscEndpoint({
    this.forwardingRule,
  });
  ...
  factory ServicePerimeterSpecEgressPolicyEgressFromSourcePscEndpoint.fromMap(Map<String, dynamic> map) {
    return ServicePerimeterSpecEgressPolicyEgressFromSourcePscEndpoint(
