...
import 'service_perimeters_service_perimeter_status_egress_policy_egress_to_operation.dart';
...
class ServicePerimetersServicePerimeterStatusEgressPolicyEgressTo {
  ...
  final pulumi.Input<List<ServicePerimetersServicePerimeterStatusEgressPolicyEgressToOperation>>? operations;
  ...
  /// Creates a new [ServicePerimetersServicePerimeterStatusEgressPolicyEgressTo].
  ...
  const ServicePerimetersServicePerimeterStatusEgressPolicyEgressTo({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'operations': ?pulumi.Input.mapOptionalInputValue<List<ServicePerimetersServicePerimeterStatusEgressPolicyEgressToOperation>, List<Map<String, dynamic>>>(operations, (value) => pulumi.Input.encodeList<ServicePerimetersServicePerimeterStatusEgressPolicyEgressToOperation, Map<String, dynamic>>(value, (value) => value.toMap())),
      'resources': ?resources,
      'roles': ?roles,
    };
  }

  factory ServicePerimetersServicePerimeterStatusEgressPolicyEgressTo.fromMap(Map<String, dynamic> map) {
    return ServicePerimetersServicePerimeterStatusEgressPolicyEgressTo(
      ...
      operations: (() { final guardedValue = map['operations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ServicePerimetersServicePerimeterStatusEgressPolicyEgressToOperation>(guardedValue, (value) => ServicePerimetersServicePerimeterStatusEgressPolicyEgressToOperation.fromMap((value as Map).cast<String, dynamic>()))); })(),
