...
import 'access_policy_iam_member_args.dart';
import 'access_policy_iam_member_condition.dart';
import 'access_policy_iam_member_state.dart';
...
class AccessPolicyIamMember extends pulumi.CustomResource {
  late final pulumi.Output<AccessPolicyIamMemberCondition?> condition;
  ...
  /// Creates a new [AccessPolicyIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [AccessPolicyIamMember]. {@macro pulumi_accesscontextmanager_access_policy_iam_member_access_policy_iam_member_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  AccessPolicyIamMember(
    String name, {
    AccessPolicyIamMemberArgs? args,
    ...
    condition = registerOutput<AccessPolicyIamMemberCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return AccessPolicyIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [AccessPolicyIamMember] resource's state with the given [name] and [id].
  static AccessPolicyIamMember get(
    String name,
    pulumi.Input<String> id, {
    AccessPolicyIamMemberState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return AccessPolicyIamMember._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [AccessPolicyIamMember] resource.
  AccessPolicyIamMember.reference(String urn)
    : super(
        'gcp:accesscontextmanager/accessPolicyIamMember:AccessPolicyIamMember',
