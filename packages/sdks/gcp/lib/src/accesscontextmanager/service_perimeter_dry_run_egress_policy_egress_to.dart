...
class ServicePerimeterDryRunEgressPolicyEgressTo {
  ...
  factory ServicePerimeterDryRunEgressPolicyEgressTo.fromMap(Map<String, dynamic> map) {
    return ServicePerimeterDryRunEgressPolicyEgressTo(
      ...
      operations: map['operations'] == null ? null : (pulumi.Input.decodeList<ServicePerimeterDryRunEgressPolicyEgressToOperation>(map['operations']!, (value) => ServicePerimeterDryRunEgressPolicyEgressToOperation.fromMap((value as Map).cast<String, dynamic>()))).input(),
