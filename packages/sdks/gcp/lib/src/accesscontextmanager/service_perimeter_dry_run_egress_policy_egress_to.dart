...
class ServicePerimeterDryRunEgressPolicyEgressTo {
  ...
  final pulumi.Input<List<ServicePerimeterDryRunEgressPolicyEgressToOperation>>?
  operations;
    ...
    return <String, dynamic>{
      ...
      'operations':
          ?pulumi.Input.mapOptionalInputValue<
            List<ServicePerimeterDryRunEgressPolicyEgressToOperation>,
  ...
  factory ServicePerimeterDryRunEgressPolicyEgressTo.fromMap(
      ...
      operations: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                ServicePerimeterDryRunEgressPolicyEgressToOperation.fromMap(
