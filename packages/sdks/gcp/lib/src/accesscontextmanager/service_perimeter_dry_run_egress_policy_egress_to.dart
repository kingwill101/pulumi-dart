...
class ServicePerimeterDryRunEgressPolicyEgressTo {
  ...
  final List<ServicePerimeterDryRunEgressPolicyEgressToOperation>? operations;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'operations': ?operations == null ? null : pulumi.Input.encodeList<ServicePerimeterDryRunEgressPolicyEgressToOperation, Map<String, dynamic>>(operations!, (value) => value.toMap()),
      'resources': ?resources,
      'roles': ?roles,
    };
  }
  ...
  factory ServicePerimeterDryRunEgressPolicyEgressTo.fromMap(Map<String, dynamic> map) {
    return ServicePerimeterDryRunEgressPolicyEgressTo(
      ...
      operations: map['operations'] == null ? null : pulumi.Input.decodeList<ServicePerimeterDryRunEgressPolicyEgressToOperation>(map['operations'], (value) => ServicePerimeterDryRunEgressPolicyEgressToOperation.fromMap((value as Map).cast<String, dynamic>())),
