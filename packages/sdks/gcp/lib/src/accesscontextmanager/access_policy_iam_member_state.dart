...
class AccessPolicyIamMemberState {
  ...
  const AccessPolicyIamMemberState({
    this.condition,
    this.etag,
    this.member,
    this.name,
  ...
  factory AccessPolicyIamMemberState.fromMap(Map<String, dynamic> map) {
    return AccessPolicyIamMemberState(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AccessPolicyIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
