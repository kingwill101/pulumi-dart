...
class ServicePerimeterSpecEgressPolicyEgressFrom {
  ...
  final pulumi.Input<List<ServicePerimeterSpecEgressPolicyEgressFromSource>>?
  sources;
    ...
    return <String, dynamic>{
      ...
      'sources':
          ?pulumi.Input.mapOptionalInputValue<
            List<ServicePerimeterSpecEgressPolicyEgressFromSource>,
    ...
    return ServicePerimeterSpecEgressPolicyEgressFrom(
      ...
      sources: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => ServicePerimeterSpecEgressPolicyEgressFromSource.fromMap(
