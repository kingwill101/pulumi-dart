...
class ServicePerimeterSpecEgressPolicyEgressTo {
  ...
  factory ServicePerimeterSpecEgressPolicyEgressTo.fromMap(Map<String, dynamic> map) {
    return ServicePerimeterSpecEgressPolicyEgressTo(
      ...
      operations: map['operations'] == null ? null : (pulumi.Input.decodeList<ServicePerimeterSpecEgressPolicyEgressToOperation>(map['operations']!, (value) => ServicePerimeterSpecEgressPolicyEgressToOperation.fromMap((value as Map).cast<String, dynamic>()))).input(),
