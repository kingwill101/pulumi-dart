...
class ServicePerimeterSpecEgressPolicyEgressTo {
  ...
  final pulumi.Input<List<ServicePerimeterSpecEgressPolicyEgressToOperation>>? operations;
  ...
  const ServicePerimeterSpecEgressPolicyEgressTo({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'operations': ?pulumi.Input.mapOptionalInputValue<List<ServicePerimeterSpecEgressPolicyEgressToOperation>, List<Map<String, dynamic>>>(operations, (value) => pulumi.Input.encodeList<ServicePerimeterSpecEgressPolicyEgressToOperation, Map<String, dynamic>>(value, (value) => value.toMap())),
      'resources': ?resources,
      'roles': ?roles,
    };
  }
  ...
  factory ServicePerimeterSpecEgressPolicyEgressTo.fromMap(Map<String, dynamic> map) {
    return ServicePerimeterSpecEgressPolicyEgressTo(
      ...
      operations: (() { final guardedValue = map['operations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ServicePerimeterSpecEgressPolicyEgressToOperation>(guardedValue, (value) => ServicePerimeterSpecEgressPolicyEgressToOperation.fromMap((value as Map).cast<String, dynamic>()))); })(),
