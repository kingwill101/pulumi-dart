...
class ServicePerimetersServicePerimeterSpecEgressPolicyEgressFrom {
  ...
  final pulumi.Input<List<ServicePerimetersServicePerimeterSpecEgressPolicyEgressFromSource>>? sources;
  ...
  const ServicePerimetersServicePerimeterSpecEgressPolicyEgressFrom({
    this.identities,
    this.identityType,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'sources': ?pulumi.Input.mapOptionalInputValue<List<ServicePerimetersServicePerimeterSpecEgressPolicyEgressFromSource>, List<Map<String, dynamic>>>(sources, (value) => pulumi.Input.encodeList<ServicePerimetersServicePerimeterSpecEgressPolicyEgressFromSource, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory ServicePerimetersServicePerimeterSpecEgressPolicyEgressFrom.fromMap(Map<String, dynamic> map) {
    return ServicePerimetersServicePerimeterSpecEgressPolicyEgressFrom(
      ...
      sources: (() { final guardedValue = map['sources']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ServicePerimetersServicePerimeterSpecEgressPolicyEgressFromSource>(guardedValue, (value) => ServicePerimetersServicePerimeterSpecEgressPolicyEgressFromSource.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
