...
class ServicePerimeterStatusIngressPolicyIngressToOperation {
  ...
  final pulumi.Input<
    List<ServicePerimeterStatusIngressPolicyIngressToOperationMethodSelector>
  >?
  methodSelectors;
  ...
  factory ServicePerimeterStatusIngressPolicyIngressToOperation.fromMap(
      ...
      methodSelectors: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                ServicePerimeterStatusIngressPolicyIngressToOperationMethodSelector.fromMap(
