...
class ServicePerimetersServicePerimeterStatusEgressPolicyEgressFromSourcePscEndpoint {
  ...
  /// Creates a new [ServicePerimetersServicePerimeterStatusEgressPolicyEgressFromSourcePscEndpoint].
  /// [forwardingRule] The full resource name of the global forwarding rule that identifies a Private Service Connect endpoint.
  const ServicePerimetersServicePerimeterStatusEgressPolicyEgressFromSourcePscEndpoint({
    this.forwardingRule,
  });
  ...
  factory ServicePerimetersServicePerimeterStatusEgressPolicyEgressFromSourcePscEndpoint.fromMap(Map<String, dynamic> map) {
    return ServicePerimetersServicePerimeterStatusEgressPolicyEgressFromSourcePscEndpoint(
