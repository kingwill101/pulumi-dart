...
import 'consumers_iam_binding_state.dart';
...
class ConsumersIamBinding extends pulumi.CustomResource {
  ...
  /// Creates a new [ConsumersIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ConsumersIamBinding]. {@macro pulumi_endpoints_consumers_iam_binding_consumers_iam_binding_args_doc}
  ...
  /// Gets an existing [ConsumersIamBinding] resource's state with the given [name] and [id].
  static ConsumersIamBinding get(
    String name,
