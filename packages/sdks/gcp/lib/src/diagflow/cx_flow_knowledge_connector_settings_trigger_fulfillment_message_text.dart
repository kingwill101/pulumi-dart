...
class CxFlowKnowledgeConnectorSettingsTriggerFulfillmentMessageText {
  ...
  const CxFlowKnowledgeConnectorSettingsTriggerFulfillmentMessageText({
  ...
  factory CxFlowKnowledgeConnectorSettingsTriggerFulfillmentMessageText.fromMap(Map<String, dynamic> map) {
