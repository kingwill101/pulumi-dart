...
class CxPageFormParameterFillBehaviorInitialPromptFulfillment {
  ...
  final pulumi.Input<
    List<CxPageFormParameterFillBehaviorInitialPromptFulfillmentConditionalCase>
  >?
  conditionalCases;
  ...
  /// Structure is documented below.
  final pulumi.Input<
    List<CxPageFormParameterFillBehaviorInitialPromptFulfillmentMessage>
  >?
  messages;
      ...
      conditionalCases: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                CxPageFormParameterFillBehaviorInitialPromptFulfillmentConditionalCase.fromMap(
      ...
      messages: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                CxPageFormParameterFillBehaviorInitialPromptFulfillmentMessage.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      setParameterActions: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                CxPageFormParameterFillBehaviorInitialPromptFulfillmentSetParameterAction.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
