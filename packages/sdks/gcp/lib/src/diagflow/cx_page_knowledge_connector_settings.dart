...
class CxPageKnowledgeConnectorSettings {
  ...
  final pulumi.Input<List<CxPageKnowledgeConnectorSettingsDataStoreConnection>>?
  ...
  /// Structure is documented below.
  final pulumi.Input<CxPageKnowledgeConnectorSettingsTriggerFulfillment>?
  triggerFulfillment;
    ...
    return <String, dynamic>{
      'dataStoreConnections':
          ?pulumi.Input.mapOptionalInputValue<
            List<CxPageKnowledgeConnectorSettingsDataStoreConnection>,
  ...
  factory CxPageKnowledgeConnectorSettings.fromMap(Map<String, dynamic> map) {
    return CxPageKnowledgeConnectorSettings(
      dataStoreConnections: (() {
        final guardedValue = map['dataStoreConnections'];
