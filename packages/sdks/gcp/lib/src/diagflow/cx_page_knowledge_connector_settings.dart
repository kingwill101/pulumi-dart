...
class CxPageKnowledgeConnectorSettings {
  ...
  factory CxPageKnowledgeConnectorSettings.fromMap(Map<String, dynamic> map) {
    return CxPageKnowledgeConnectorSettings(
      dataStoreConnections: (() { final guardedValue = map['dataStoreConnections']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<CxPageKnowledgeConnectorSettingsDataStoreConnection>(guardedValue, (value) => CxPageKnowledgeConnectorSettingsDataStoreConnection.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      triggerFulfillment: (() { final guardedValue = map['triggerFulfillment']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CxPageKnowledgeConnectorSettingsTriggerFulfillment.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
