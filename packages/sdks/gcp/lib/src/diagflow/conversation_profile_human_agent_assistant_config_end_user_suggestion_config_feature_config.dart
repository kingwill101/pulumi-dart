...
class ConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfigFeatureConfig {
  ...
  const ConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfigFeatureConfig({
  ...
  factory ConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfigFeatureConfig.fromMap(Map<String, dynamic> map) {
    return ConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfigFeatureConfig(
      conversationModelConfig: (() { final guardedValue = map['conversationModelConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfigFeatureConfigConversationModelConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      conversationProcessConfig: (() { final guardedValue = map['conversationProcessConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfigFeatureConfigConversationProcessConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      queryConfig: (() { final guardedValue = map['queryConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfigFeatureConfigQueryConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      suggestionFeature: (() { final guardedValue = map['suggestionFeature']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfigFeatureConfigSuggestionFeature.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      suggestionTriggerSettings: (() { final guardedValue = map['suggestionTriggerSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfigFeatureConfigSuggestionTriggerSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
