...
class CxToolOpenApiSpecAuthenticationApiKeyConfig {
  ...
  const CxToolOpenApiSpecAuthenticationApiKeyConfig({
    this.apiKey,
  ...
  factory CxToolOpenApiSpecAuthenticationApiKeyConfig.fromMap(Map<String, dynamic> map) {
    return CxToolOpenApiSpecAuthenticationApiKeyConfig(
      ...
      secretVersionForApiKey: (() { final guardedValue = map['secretVersionForApiKey']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
