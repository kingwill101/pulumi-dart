...
class GeneratorSummarizationContextFewShotExampleOutputSummarySuggestion {
  ...
  final pulumi.Input<List<GeneratorSummarizationContextFewShotExampleOutputSummarySuggestionSummarySection>> summarySections;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'summarySections': pulumi.Input.mapInputValue<List<GeneratorSummarizationContextFewShotExampleOutputSummarySuggestionSummarySection>, List<Map<String, dynamic>>>(summarySections, (value) => pulumi.Input.encodeList<GeneratorSummarizationContextFewShotExampleOutputSummarySuggestionSummarySection, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory GeneratorSummarizationContextFewShotExampleOutputSummarySuggestion.fromMap(Map<String, dynamic> map) {
    return GeneratorSummarizationContextFewShotExampleOutputSummarySuggestion(
      summarySections: pulumi.Input.fromValue(pulumi.Input.decodeList<GeneratorSummarizationContextFewShotExampleOutputSummarySuggestionSummarySection>(map['summarySections']!, (value) => GeneratorSummarizationContextFewShotExampleOutputSummarySuggestionSummarySection.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
