...
class CxFlowEventHandler {
  ...
  factory CxFlowEventHandler.fromMap(Map<String, dynamic> map) {
    return CxFlowEventHandler(
      ...
      triggerFulfillment: (() { final guardedValue = map['triggerFulfillment']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CxFlowEventHandlerTriggerFulfillment.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
