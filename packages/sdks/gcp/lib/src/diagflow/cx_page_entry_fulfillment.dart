...
class CxPageEntryFulfillment {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'conditionalCases': ?conditionalCases == null ? null : pulumi.Input.encodeList<CxPageEntryFulfillmentConditionalCase, Map<String, dynamic>>(conditionalCases!, (value) => value.toMap()),
      'messages': ?messages == null ? null : pulumi.Input.encodeList<CxPageEntryFulfillmentMessage, Map<String, dynamic>>(messages!, (value) => value.toMap()),
      'returnPartialResponses': ?returnPartialResponses,
      'setParameterActions': ?setParameterActions == null ? null : pulumi.Input.encodeList<CxPageEntryFulfillmentSetParameterAction, Map<String, dynamic>>(setParameterActions!, (value) => value.toMap()),
      'tag': ?tag,
      'webhook': ?webhook,
    };
  }
  ...
  factory CxPageEntryFulfillment.fromMap(Map<String, dynamic> map) {
    return CxPageEntryFulfillment(
      conditionalCases: map['conditionalCases'] == null ? null : pulumi.Input.decodeList<CxPageEntryFulfillmentConditionalCase>(map['conditionalCases'], (value) => CxPageEntryFulfillmentConditionalCase.fromMap((value as Map).cast<String, dynamic>())),
      messages: map['messages'] == null ? null : pulumi.Input.decodeList<CxPageEntryFulfillmentMessage>(map['messages'], (value) => CxPageEntryFulfillmentMessage.fromMap((value as Map).cast<String, dynamic>())),
      returnPartialResponses: map['returnPartialResponses'] == null ? null : map['returnPartialResponses'] as bool,
      setParameterActions: map['setParameterActions'] == null ? null : pulumi.Input.decodeList<CxPageEntryFulfillmentSetParameterAction>(map['setParameterActions'], (value) => CxPageEntryFulfillmentSetParameterAction.fromMap((value as Map).cast<String, dynamic>())),
