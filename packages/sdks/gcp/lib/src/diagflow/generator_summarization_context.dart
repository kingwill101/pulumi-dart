...
class GeneratorSummarizationContext {
  ...
  final pulumi.Input<List<GeneratorSummarizationContextFewShotExample>>?
  fewShotExamples;
  ...
  /// Structure is documented below.
  final pulumi.Input<List<GeneratorSummarizationContextSummarizationSection>>?
    ...
    return <String, dynamic>{
      'fewShotExamples':
          ?pulumi.Input.mapOptionalInputValue<
            List<GeneratorSummarizationContextFewShotExample>,
      ...
      'summarizationSections':
          ?pulumi.Input.mapOptionalInputValue<
            List<GeneratorSummarizationContextSummarizationSection>,
            List<Map<String, dynamic>>
          >(
            summarizationSections,
            (value) =>
  ...
  factory GeneratorSummarizationContext.fromMap(Map<String, dynamic> map) {
    return GeneratorSummarizationContext(
      fewShotExamples: (() {
        final guardedValue = map['fewShotExamples'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GeneratorSummarizationContextFewShotExample>(
            guardedValue,
      ...
      outputLanguageCode: (() {
        final guardedValue = map['outputLanguageCode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      summarizationSections: (() {
        final guardedValue = map['summarizationSections'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
