...
class CxEntityType extends pulumi.CustomResource {
  ...
  CxEntityType(
    ...
    this.excludedPhrases = registerOutput<List<CxEntityTypeExcludedPhrase>?>('excludedPhrases');
  ...
  /// Gets an existing [CxEntityType] resource's state with the given [name] and [id].
  static CxEntityType get(
    String name,
