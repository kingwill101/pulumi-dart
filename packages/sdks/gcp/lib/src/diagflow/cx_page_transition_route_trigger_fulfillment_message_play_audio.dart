...
class CxPageTransitionRouteTriggerFulfillmentMessagePlayAudio {
  ...
  const CxPageTransitionRouteTriggerFulfillmentMessagePlayAudio({
  ...
  factory CxPageTransitionRouteTriggerFulfillmentMessagePlayAudio.fromMap(Map<String, dynamic> map) {
