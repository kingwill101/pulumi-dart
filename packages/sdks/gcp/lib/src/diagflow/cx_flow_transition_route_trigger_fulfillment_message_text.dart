...
class CxFlowTransitionRouteTriggerFulfillmentMessageText {
  /// (Output)
  ...
  factory CxFlowTransitionRouteTriggerFulfillmentMessageText.fromMap(Map<String, dynamic> map) {
    return CxFlowTransitionRouteTriggerFulfillmentMessageText(
