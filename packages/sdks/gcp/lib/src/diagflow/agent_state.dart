...
class AgentState {
  ...
  factory AgentState.fromMap(Map<String, dynamic> map) {
    return AgentState(
      ...
      avatarUriBackend: (() { final guardedValue = map['avatarUriBackend']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      classificationThreshold: (() { final guardedValue = map['classificationThreshold']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
