...
class IntentState {
  ...
  factory IntentState.fromMap(Map<String, dynamic> map) {
    return IntentState(
      ...
      followupIntentInfos: (() {
        final guardedValue = map['followupIntentInfos'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<IntentFollowupIntentInfo>(
            guardedValue,
            (value) => IntentFollowupIntentInfo.fromMap(
      ...
      rootFollowupIntentName: (() {
        final guardedValue = map['rootFollowupIntentName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      webhookState: (() {
