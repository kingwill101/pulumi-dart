...
class ConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfig {
  ...
  factory ConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfig.fromMap(Map<String, dynamic> map) {
    return ConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfig(
      ...
      featureConfigs: (() { final guardedValue = map['featureConfigs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfigFeatureConfig>(guardedValue, (value) => ConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfigFeatureConfig.fromMap((value as Map).cast<String, dynamic>()))); })(),
