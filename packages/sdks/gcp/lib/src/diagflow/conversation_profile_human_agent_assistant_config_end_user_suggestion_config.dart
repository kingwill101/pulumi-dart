...
class ConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfig {
  ...
  final List<ConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfigFeatureConfig>? featureConfigs;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'featureConfigs': ?featureConfigs == null ? null : pulumi.Input.encodeList<ConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfigFeatureConfig, Map<String, dynamic>>(featureConfigs!, (value) => value.toMap()),
  ...
  factory ConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfig.fromMap(Map<String, dynamic> map) {
    return ConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfig(
      ...
      featureConfigs: map['featureConfigs'] == null ? null : pulumi.Input.decodeList<ConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfigFeatureConfig>(map['featureConfigs'], (value) => ConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfigFeatureConfig.fromMap((value as Map).cast<String, dynamic>())),
