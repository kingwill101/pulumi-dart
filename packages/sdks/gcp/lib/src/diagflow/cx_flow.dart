...
class CxFlow extends pulumi.CustomResource {
  ...
  /// Structure is documented below.
  late final pulumi.Output<CxFlowKnowledgeConnectorSettings?> knowledgeConnectorSettings;
  ...
  CxFlow(
    ...
    this.advancedSettings = registerOutput<CxFlowAdvancedSettings?>('advancedSettings');
    this.description = registerOutput<String?>('description');
    this.displayName = registerOutput<String>('displayName');
    this.eventHandlers = registerOutput<List<CxFlowEventHandler>>('eventHandlers');
    this.isDefaultStartFlow = registerOutput<bool?>('isDefaultStartFlow');
    this.knowledgeConnectorSettings = registerOutput<CxFlowKnowledgeConnectorSettings?>('knowledgeConnectorSettings');
    ...
    this.transitionRoutes = registerOutput<List<CxFlowTransitionRoute>?>('transitionRoutes');
  }
