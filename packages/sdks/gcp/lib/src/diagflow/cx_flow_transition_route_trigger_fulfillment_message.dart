...
class CxFlowTransitionRouteTriggerFulfillmentMessage {
  ...
  /// This field is part of a union field `message`: Only one of `text`, `payload`, `conversationSuccess`, `outputAudioText`, `liveAgentHandoff`, `endInteraction`, `playAudio`, `mixedAudio`, `telephonyTransferCall`, or `knowledgeInfoCard` may be set.
  /// Structure is documented below.
  final pulumi.Input<CxFlowTransitionRouteTriggerFulfillmentMessagePlayAudio>?
  playAudio;
    ...
    return CxFlowTransitionRouteTriggerFulfillmentMessage(
      ...
      conversationSuccess: (() {
        ...
        return pulumi.Input.fromValue(
          CxFlowTransitionRouteTriggerFulfillmentMessageConversationSuccess.fromMap(
      ...
      liveAgentHandoff: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CxFlowTransitionRouteTriggerFulfillmentMessageLiveAgentHandoff.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      outputAudioText: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CxFlowTransitionRouteTriggerFulfillmentMessageOutputAudioText.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      telephonyTransferCall: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CxFlowTransitionRouteTriggerFulfillmentMessageTelephonyTransferCall.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
