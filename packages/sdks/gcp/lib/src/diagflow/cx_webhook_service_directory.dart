...
class CxWebhookServiceDirectory {
  ...
  factory CxWebhookServiceDirectory.fromMap(Map<String, dynamic> map) {
    return CxWebhookServiceDirectory(
      genericWebService: (() { final guardedValue = map['genericWebService']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CxWebhookServiceDirectoryGenericWebService.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
