...
class CxPageAdvancedSettings {
  ...
  factory CxPageAdvancedSettings.fromMap(Map<String, dynamic> map) {
    return CxPageAdvancedSettings(
      dtmfSettings: (() { final guardedValue = map['dtmfSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CxPageAdvancedSettingsDtmfSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
