...
import 'cx_security_settings_state.dart';
...
class CxSecuritySettings extends pulumi.CustomResource {
  ...
  /// Gets an existing [CxSecuritySettings] resource's state with the given [name] and [id].
  static CxSecuritySettings get(
    String name,
