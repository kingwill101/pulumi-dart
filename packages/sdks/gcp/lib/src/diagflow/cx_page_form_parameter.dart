...
class CxPageFormParameter {
  ...
  factory CxPageFormParameter.fromMap(Map<String, dynamic> map) {
    return CxPageFormParameter(
      advancedSettings: map['advancedSettings'] == null ? null : CxPageFormParameterAdvancedSettings.fromMap((map['advancedSettings'] as Map).cast<String, dynamic>()),
      ...
      fillBehavior: map['fillBehavior'] == null ? null : CxPageFormParameterFillBehavior.fromMap((map['fillBehavior'] as Map).cast<String, dynamic>()),
