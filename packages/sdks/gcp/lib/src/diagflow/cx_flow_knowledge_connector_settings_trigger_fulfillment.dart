...
class CxFlowKnowledgeConnectorSettingsTriggerFulfillment {
  ...
  /// Structure is documented below.
  final pulumi.Input<
    List<CxFlowKnowledgeConnectorSettingsTriggerFulfillmentConditionalCase>
  >?
  conditionalCases;
  ...
  /// Structure is documented below.
  final pulumi.Input<
    List<CxFlowKnowledgeConnectorSettingsTriggerFulfillmentMessage>
  >?
  messages;
  ...
  /// Structure is documented below.
  final pulumi.Input<
    List<CxFlowKnowledgeConnectorSettingsTriggerFulfillmentSetParameterAction>
  >?
  setParameterActions;
    ...
    return CxFlowKnowledgeConnectorSettingsTriggerFulfillment(
      advancedSettings: (() {
        ...
        return pulumi.Input.fromValue(
          CxFlowKnowledgeConnectorSettingsTriggerFulfillmentAdvancedSettings.fromMap(
      ...
      conditionalCases: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                CxFlowKnowledgeConnectorSettingsTriggerFulfillmentConditionalCase.fromMap(
      ...
      messages: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                CxFlowKnowledgeConnectorSettingsTriggerFulfillmentMessage.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      setParameterActions: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                CxFlowKnowledgeConnectorSettingsTriggerFulfillmentSetParameterAction.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
