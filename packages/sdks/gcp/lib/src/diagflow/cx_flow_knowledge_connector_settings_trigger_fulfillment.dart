...
class CxFlowKnowledgeConnectorSettingsTriggerFulfillment {
  ...
  const CxFlowKnowledgeConnectorSettingsTriggerFulfillment({
  ...
  factory CxFlowKnowledgeConnectorSettingsTriggerFulfillment.fromMap(Map<String, dynamic> map) {
    return CxFlowKnowledgeConnectorSettingsTriggerFulfillment(
      advancedSettings: (() { final guardedValue = map['advancedSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CxFlowKnowledgeConnectorSettingsTriggerFulfillmentAdvancedSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      conditionalCases: (() { final guardedValue = map['conditionalCases']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<CxFlowKnowledgeConnectorSettingsTriggerFulfillmentConditionalCase>(guardedValue, (value) => CxFlowKnowledgeConnectorSettingsTriggerFulfillmentConditionalCase.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      messages: (() { final guardedValue = map['messages']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<CxFlowKnowledgeConnectorSettingsTriggerFulfillmentMessage>(guardedValue, (value) => CxFlowKnowledgeConnectorSettingsTriggerFulfillmentMessage.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      setParameterActions: (() { final guardedValue = map['setParameterActions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<CxFlowKnowledgeConnectorSettingsTriggerFulfillmentSetParameterAction>(guardedValue, (value) => CxFlowKnowledgeConnectorSettingsTriggerFulfillmentSetParameterAction.fromMap((value as Map).cast<String, dynamic>()))); })(),
