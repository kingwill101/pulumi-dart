...
class CxToolOpenApiSpec {
  ...
  factory CxToolOpenApiSpec.fromMap(Map<String, dynamic> map) {
    return CxToolOpenApiSpec(
      authentication: (() { final guardedValue = map['authentication']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CxToolOpenApiSpecAuthentication.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      serviceDirectoryConfig: (() { final guardedValue = map['serviceDirectoryConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CxToolOpenApiSpecServiceDirectoryConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      textSchema: pulumi.Input.fromValue(map['textSchema'] as String),
      tlsConfig: (() { final guardedValue = map['tlsConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CxToolOpenApiSpecTlsConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
