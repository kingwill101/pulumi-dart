...
class CxPageFormParameterFillBehaviorRepromptEventHandler {
  ...
  const CxPageFormParameterFillBehaviorRepromptEventHandler({
    this.event,
    this.name,
    this.targetFlow,
    this.targetPage,
  ...
  factory CxPageFormParameterFillBehaviorRepromptEventHandler.fromMap(Map<String, dynamic> map) {
    return CxPageFormParameterFillBehaviorRepromptEventHandler(
      ...
      triggerFulfillment: (() { final guardedValue = map['triggerFulfillment']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CxPageFormParameterFillBehaviorRepromptEventHandlerTriggerFulfillment.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
