...
class CxToolVersionToolConnectorSpec {
  ...
  /// Structure is documented below.
  final pulumi.Input<CxToolVersionToolConnectorSpecEndUserAuthConfig>?
  endUserAuthConfig;
    ...
    return <String, dynamic>{
      'actions':
          pulumi.Input.mapInputValue<
            List<CxToolVersionToolConnectorSpecAction>,
      ...
      'endUserAuthConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(endUserAuthConfig, (value) => value.toMap()),
      'name': name,
    };
  }
  ...
  factory CxToolVersionToolConnectorSpec.fromMap(Map<String, dynamic> map) {
    return CxToolVersionToolConnectorSpec(
      actions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<CxToolVersionToolConnectorSpecAction>(
          map['actions']!,
      ...
      endUserAuthConfig: (() {
        final guardedValue = map['endUserAuthConfig'];
