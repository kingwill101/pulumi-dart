...
class CxToolVersionToolDataStoreSpec {
  ...
  factory CxToolVersionToolDataStoreSpec.fromMap(Map<String, dynamic> map) {
    return CxToolVersionToolDataStoreSpec(
      dataStoreConnections: (pulumi.Input.decodeList<CxToolVersionToolDataStoreSpecDataStoreConnection>(map['dataStoreConnections'], (value) => CxToolVersionToolDataStoreSpecDataStoreConnection.fromMap((value as Map).cast<String, dynamic>()))).input(),
      fallbackPrompt: ((map['fallbackPrompt'] as Map).cast<String, dynamic>()).input(),
    );
  }
}
