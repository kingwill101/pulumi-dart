...
class CxToolVersionToolDataStoreSpec {
  ...
  final pulumi.Input<List<CxToolVersionToolDataStoreSpecDataStoreConnection>>
    ...
    return <String, dynamic>{
      'dataStoreConnections':
          pulumi.Input.mapInputValue<
            List<CxToolVersionToolDataStoreSpecDataStoreConnection>,
  ...
  factory CxToolVersionToolDataStoreSpec.fromMap(Map<String, dynamic> map) {
    return CxToolVersionToolDataStoreSpec(
      ...
      fallbackPrompt: pulumi.Input.fromValue(
        (map['fallbackPrompt']! as Map).cast<String, dynamic>(),
      ),
    );
  }
}
