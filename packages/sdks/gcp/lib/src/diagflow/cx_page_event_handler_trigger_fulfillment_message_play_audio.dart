...
class CxPageEventHandlerTriggerFulfillmentMessagePlayAudio {
  /// (Output)
  ...
  /// Creates a new [CxPageEventHandlerTriggerFulfillmentMessagePlayAudio].
  ...
  factory CxPageEventHandlerTriggerFulfillmentMessagePlayAudio.fromMap(
