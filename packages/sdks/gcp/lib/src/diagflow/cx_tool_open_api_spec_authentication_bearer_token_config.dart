...
class CxToolOpenApiSpecAuthenticationBearerTokenConfig {
  ...
  const CxToolOpenApiSpecAuthenticationBearerTokenConfig({
  ...
  factory CxToolOpenApiSpecAuthenticationBearerTokenConfig.fromMap(Map<String, dynamic> map) {
    return CxToolOpenApiSpecAuthenticationBearerTokenConfig(
      secretVersionForToken: (() { final guardedValue = map['secretVersionForToken']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
