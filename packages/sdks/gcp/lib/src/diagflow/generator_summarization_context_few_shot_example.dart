...
class GeneratorSummarizationContextFewShotExample {
    ...
    return <String, dynamic>{
      'conversationContext':
          ?pulumi.Input.mapOptionalInputValue<
            GeneratorSummarizationContextFewShotExampleConversationContext,
            Map<String, dynamic>
          >(conversationContext, (value) => value.toMap()),
      'extraInfo': ?extraInfo,
      'output':
      ...
      'summarizationSectionList':
          ?pulumi.Input.mapOptionalInputValue<
            GeneratorSummarizationContextFewShotExampleSummarizationSectionList,
            Map<String, dynamic>
          >(summarizationSectionList, (value) => value.toMap()),
    };
  }
  ...
  factory GeneratorSummarizationContextFewShotExample.fromMap(
    ...
    return GeneratorSummarizationContextFewShotExample(
      conversationContext: (() {
        final guardedValue = map['conversationContext'];
      ...
      output: pulumi.Input.fromValue(
        GeneratorSummarizationContextFewShotExampleOutput.fromMap(
          (map['output']! as Map).cast<String, dynamic>(),
        ),
      ),
      summarizationSectionList: (() {
        final guardedValue = map['summarizationSectionList'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
