...
class CxPageKnowledgeConnectorSettingsTriggerFulfillment {
  ...
  /// Structure is documented below.
  final pulumi.Input<
    List<CxPageKnowledgeConnectorSettingsTriggerFulfillmentConditionalCase>
  >?
  conditionalCases;
  ...
  /// Structure is documented below.
  final pulumi.Input<
    List<CxPageKnowledgeConnectorSettingsTriggerFulfillmentMessage>
  >?
  messages;
    ...
    return CxPageKnowledgeConnectorSettingsTriggerFulfillment(
      advancedSettings: (() {
        ...
        return pulumi.Input.fromValue(
          CxPageKnowledgeConnectorSettingsTriggerFulfillmentAdvancedSettings.fromMap(
      ...
      conditionalCases: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                CxPageKnowledgeConnectorSettingsTriggerFulfillmentConditionalCase.fromMap(
      ...
      messages: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                CxPageKnowledgeConnectorSettingsTriggerFulfillmentMessage.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      setParameterActions: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                CxPageKnowledgeConnectorSettingsTriggerFulfillmentSetParameterAction.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
