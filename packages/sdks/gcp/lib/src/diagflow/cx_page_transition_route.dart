...
class CxPageTransitionRoute {
  ...
  factory CxPageTransitionRoute.fromMap(Map<String, dynamic> map) {
    return CxPageTransitionRoute(
      ...
      triggerFulfillment: map['triggerFulfillment'] == null ? null : (CxPageTransitionRouteTriggerFulfillment.fromMap((map['triggerFulfillment']! as Map).cast<String, dynamic>())).input(),
    );
  }
}
