...
class CxPageTransitionRouteTriggerFulfillment {
  ...
  final pulumi.Input<
    List<CxPageTransitionRouteTriggerFulfillmentConditionalCase>
  >?
  conditionalCases;

  /// The list of rich message responses to present to the user.
  /// Structure is documented below.
  final pulumi.Input<List<CxPageTransitionRouteTriggerFulfillmentMessage>>?
  messages;
  ...
  /// Structure is documented below.
  final pulumi.Input<
    List<CxPageTransitionRouteTriggerFulfillmentSetParameterAction>
  >?
  setParameterActions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'messages':
          ?pulumi.Input.mapOptionalInputValue<
            List<CxPageTransitionRouteTriggerFulfillmentMessage>,
            List<Map<String, dynamic>>
          >(
            messages,
            (value) =>
      ...
      conditionalCases: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                CxPageTransitionRouteTriggerFulfillmentConditionalCase.fromMap(
      ...
      setParameterActions: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                CxPageTransitionRouteTriggerFulfillmentSetParameterAction.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
