...
class CxToolOpenApiSpecTlsConfig {
  ...
  const CxToolOpenApiSpecTlsConfig({
  ...
  factory CxToolOpenApiSpecTlsConfig.fromMap(Map<String, dynamic> map) {
    return CxToolOpenApiSpecTlsConfig(
      caCerts: pulumi.Input.fromValue(pulumi.Input.decodeList<CxToolOpenApiSpecTlsConfigCaCert>(map['caCerts']!, (value) => CxToolOpenApiSpecTlsConfigCaCert.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
