...
class CxToolDataStoreSpec {
  ...
  factory CxToolDataStoreSpec.fromMap(Map<String, dynamic> map) {
    return CxToolDataStoreSpec(
      dataStoreConnections: (pulumi.Input.decodeList<CxToolDataStoreSpecDataStoreConnection>(map['dataStoreConnections'], (value) => CxToolDataStoreSpecDataStoreConnection.fromMap((value as Map).cast<String, dynamic>()))).input(),
