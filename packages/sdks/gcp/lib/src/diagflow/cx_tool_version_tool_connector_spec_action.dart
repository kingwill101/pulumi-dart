...
class CxToolVersionToolConnectorSpecAction {
  ...
  final pulumi.Input<CxToolVersionToolConnectorSpecActionEntityOperation>?
  entityOperation;
    ...
    return <String, dynamic>{
      ...
      'entityOperation':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(entityOperation, (value) => value.toMap()),
  ...
  factory CxToolVersionToolConnectorSpecAction.fromMap(
    ...
    return CxToolVersionToolConnectorSpecAction(
      connectionActionId: (() {
        final guardedValue = map['connectionActionId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      entityOperation: (() {
        final guardedValue = map['entityOperation'];
        if (guardedValue == null) return null;
      ...
      inputFields: (() {
        final guardedValue = map['inputFields'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      outputFields: (() {
        final guardedValue = map['outputFields'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
    );
