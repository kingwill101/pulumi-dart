...
class CxPageEventHandlerTriggerFulfillment {
  ...
  const CxPageEventHandlerTriggerFulfillment({
  ...
  factory CxPageEventHandlerTriggerFulfillment.fromMap(Map<String, dynamic> map) {
    return CxPageEventHandlerTriggerFulfillment(
      conditionalCases: (() { final guardedValue = map['conditionalCases']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<CxPageEventHandlerTriggerFulfillmentConditionalCase>(guardedValue, (value) => CxPageEventHandlerTriggerFulfillmentConditionalCase.fromMap((value as Map).cast<String, dynamic>()))); })(),
      messages: (() { final guardedValue = map['messages']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<CxPageEventHandlerTriggerFulfillmentMessage>(guardedValue, (value) => CxPageEventHandlerTriggerFulfillmentMessage.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      setParameterActions: (() { final guardedValue = map['setParameterActions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<CxPageEventHandlerTriggerFulfillmentSetParameterAction>(guardedValue, (value) => CxPageEventHandlerTriggerFulfillmentSetParameterAction.fromMap((value as Map).cast<String, dynamic>()))); })(),
