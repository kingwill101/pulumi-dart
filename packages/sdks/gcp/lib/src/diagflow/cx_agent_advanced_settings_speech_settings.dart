...
class CxAgentAdvancedSettingsSpeechSettings {
  ...
  /// Creates a new [CxAgentAdvancedSettingsSpeechSettings].
  ...
  const CxAgentAdvancedSettingsSpeechSettings({
  ...
  factory CxAgentAdvancedSettingsSpeechSettings.fromMap(Map<String, dynamic> map) {
    return CxAgentAdvancedSettingsSpeechSettings(
      endpointerSensitivity: (() { final guardedValue = map['endpointerSensitivity']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
