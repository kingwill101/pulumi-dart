    ...
    return <String, dynamic>{
      ...
      'personalizationSettings':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(personalizationSettings, (value) => value.toMap()),
      'project': ?project,
  ...
  factory CxAgentState.fromMap(Map<String, dynamic> map) {
    return CxAgentState(
      ...
      deleteChatEngineOnDestroy: (() {
        final guardedValue = map['deleteChatEngineOnDestroy'];
        if (guardedValue == null) return null;
      ...
      enableMultiLanguageTraining: (() {
        final guardedValue = map['enableMultiLanguageTraining'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      ...
      personalizationSettings: (() {
        final guardedValue = map['personalizationSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      satisfiesPzi: (() {
        final guardedValue = map['satisfiesPzi'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      satisfiesPzs: (() {
      ...
      startPlaybook: (() {
        final guardedValue = map['startPlaybook'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
