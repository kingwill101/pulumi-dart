...
class EnvironmentFulfillmentGenericWebService {
  ...
  /// Creates a new [EnvironmentFulfillmentGenericWebService].
  ...
  const EnvironmentFulfillmentGenericWebService({
    this.password,
    this.requestHeaders,
    required this.uri,
    this.username,
  ...
  factory EnvironmentFulfillmentGenericWebService.fromMap(Map<String, dynamic> map) {
    return EnvironmentFulfillmentGenericWebService(
