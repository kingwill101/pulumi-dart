...
class ConversationProfileTtsConfig {
  ...
  factory ConversationProfileTtsConfig.fromMap(Map<String, dynamic> map) {
    return ConversationProfileTtsConfig(
      ...
      voice: (() { final guardedValue = map['voice']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConversationProfileTtsConfigVoice.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
