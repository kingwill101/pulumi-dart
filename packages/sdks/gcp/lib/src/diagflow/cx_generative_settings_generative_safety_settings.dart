...
class CxGenerativeSettingsGenerativeSafetySettings {
  ...
  final pulumi.Input<
    List<CxGenerativeSettingsGenerativeSafetySettingsBannedPhrase>
  >?
  bannedPhrases;
  ...
  factory CxGenerativeSettingsGenerativeSafetySettings.fromMap(
    ...
    return CxGenerativeSettingsGenerativeSafetySettings(
      bannedPhrases: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                CxGenerativeSettingsGenerativeSafetySettingsBannedPhrase.fromMap(
      ...
      defaultBannedPhraseMatchStrategy: (() {
        final guardedValue = map['defaultBannedPhraseMatchStrategy'];
        if (guardedValue == null) return null;
