...
class CxFlowKnowledgeConnectorSettings {
  ...
  final pulumi.Input<List<CxFlowKnowledgeConnectorSettingsDataStoreConnection>>?
  ...
  /// Structure is documented below.
  final pulumi.Input<CxFlowKnowledgeConnectorSettingsTriggerFulfillment>?
  triggerFulfillment;
    ...
    return <String, dynamic>{
      'dataStoreConnections':
          ?pulumi.Input.mapOptionalInputValue<
            List<CxFlowKnowledgeConnectorSettingsDataStoreConnection>,
