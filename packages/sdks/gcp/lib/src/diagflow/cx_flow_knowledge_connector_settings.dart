...
class CxFlowKnowledgeConnectorSettings {
  ...
  final List<CxFlowKnowledgeConnectorSettingsDataStoreConnection>? dataStoreConnections;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'dataStoreConnections': ?dataStoreConnections == null ? null : pulumi.Input.encodeList<CxFlowKnowledgeConnectorSettingsDataStoreConnection, Map<String, dynamic>>(dataStoreConnections!, (value) => value.toMap()),
      'enabled': ?enabled,
  ...
  factory CxFlowKnowledgeConnectorSettings.fromMap(Map<String, dynamic> map) {
    return CxFlowKnowledgeConnectorSettings(
      dataStoreConnections: map['dataStoreConnections'] == null ? null : pulumi.Input.decodeList<CxFlowKnowledgeConnectorSettingsDataStoreConnection>(map['dataStoreConnections'], (value) => CxFlowKnowledgeConnectorSettingsDataStoreConnection.fromMap((value as Map).cast<String, dynamic>())),
      ...
      triggerFulfillment: map['triggerFulfillment'] == null ? null : CxFlowKnowledgeConnectorSettingsTriggerFulfillment.fromMap((map['triggerFulfillment'] as Map).cast<String, dynamic>()),
    );
  }
}
