...
class CxToolVersionState {
  ...
  factory CxToolVersionState.fromMap(Map<String, dynamic> map) {
    return CxToolVersionState(
      ...
      tool: (() { final guardedValue = map['tool']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CxToolVersionTool.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
