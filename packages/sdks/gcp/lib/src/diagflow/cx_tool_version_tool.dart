...
class CxToolVersionTool {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'connectorSpec': ?connectorSpec == null ? null : connectorSpec!.toMap(),
      'dataStoreSpec': ?dataStoreSpec == null ? null : dataStoreSpec!.toMap(),
      'description': description,
      'displayName': displayName,
      'functionSpec': ?functionSpec == null ? null : functionSpec!.toMap(),
      'name': ?name,
      'openApiSpec': ?openApiSpec == null ? null : openApiSpec!.toMap(),
      'toolType': ?toolType,
    };
  }
  ...
  factory CxToolVersionTool.fromMap(Map<String, dynamic> map) {
    return CxToolVersionTool(
      connectorSpec: map['connectorSpec'] == null ? null : CxToolVersionToolConnectorSpec.fromMap((map['connectorSpec'] as Map).cast<String, dynamic>()),
      dataStoreSpec: map['dataStoreSpec'] == null ? null : CxToolVersionToolDataStoreSpec.fromMap((map['dataStoreSpec'] as Map).cast<String, dynamic>()),
      description: map['description'] as String,
      displayName: map['displayName'] as String,
      functionSpec: map['functionSpec'] == null ? null : CxToolVersionToolFunctionSpec.fromMap((map['functionSpec'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      openApiSpec: map['openApiSpec'] == null ? null : CxToolVersionToolOpenApiSpec.fromMap((map['openApiSpec'] as Map).cast<String, dynamic>()),
