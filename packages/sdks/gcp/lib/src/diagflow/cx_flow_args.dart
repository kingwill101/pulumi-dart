...
class CxFlowArgs {
  ...
  factory CxFlowArgs.fromMap(Map<String, dynamic> map) {
    return CxFlowArgs(
      ...
      isDefaultStartFlow: (() { final guardedValue = map['isDefaultStartFlow']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      knowledgeConnectorSettings: (() { final guardedValue = map['knowledgeConnectorSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CxFlowKnowledgeConnectorSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      nluSettings: (() { final guardedValue = map['nluSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CxFlowNluSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      transitionRoutes: (() { final guardedValue = map['transitionRoutes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<CxFlowTransitionRoute>(guardedValue, (value) => CxFlowTransitionRoute.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
