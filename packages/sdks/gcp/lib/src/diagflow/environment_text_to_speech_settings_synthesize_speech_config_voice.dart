...
class EnvironmentTextToSpeechSettingsSynthesizeSpeechConfigVoice {
  ...
  /// Creates a new [EnvironmentTextToSpeechSettingsSynthesizeSpeechConfigVoice].
  /// [name] The name of the voice.
  /// [ssmlGender] The preferred gender of the voice.
  const EnvironmentTextToSpeechSettingsSynthesizeSpeechConfigVoice({
    this.name,
    this.ssmlGender,
  });
  ...
  factory EnvironmentTextToSpeechSettingsSynthesizeSpeechConfigVoice.fromMap(Map<String, dynamic> map) {
    return EnvironmentTextToSpeechSettingsSynthesizeSpeechConfigVoice(
