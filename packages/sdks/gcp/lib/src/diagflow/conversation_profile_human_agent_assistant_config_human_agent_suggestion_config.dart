...
class ConversationProfileHumanAgentAssistantConfigHumanAgentSuggestionConfig {
  ...
  factory ConversationProfileHumanAgentAssistantConfigHumanAgentSuggestionConfig.fromMap(
    Map<String, dynamic> map,
  ) {
    return ConversationProfileHumanAgentAssistantConfigHumanAgentSuggestionConfig(
      disableHighLatencyFeaturesSyncDelivery: (() {
        final guardedValue = map['disableHighLatencyFeaturesSyncDelivery'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      featureConfigs: (() {
        final guardedValue = map['featureConfigs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                ConversationProfileHumanAgentAssistantConfigHumanAgentSuggestionConfigFeatureConfig.fromMap(
      ...
      generators: (() {
        final guardedValue = map['generators'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      groupSuggestionResponses: (() {
        final guardedValue = map['groupSuggestionResponses'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
    );
