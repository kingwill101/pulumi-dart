...
class CxFlowTransitionRoute {
  ...
  factory CxFlowTransitionRoute.fromMap(Map<String, dynamic> map) {
    return CxFlowTransitionRoute(
      ...
      triggerFulfillment: (() { final guardedValue = map['triggerFulfillment']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CxFlowTransitionRouteTriggerFulfillment.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
