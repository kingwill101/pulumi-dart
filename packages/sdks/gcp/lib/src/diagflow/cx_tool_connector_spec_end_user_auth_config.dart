...
class CxToolConnectorSpecEndUserAuthConfig {
  ...
  final pulumi.Input<CxToolConnectorSpecEndUserAuthConfigOauth2AuthCodeConfig>?
  ...
  final pulumi.Input<CxToolConnectorSpecEndUserAuthConfigOauth2JwtBearerConfig>?
    ...
    return <String, dynamic>{
      'oauth2AuthCodeConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(oauth2AuthCodeConfig, (value) => value.toMap()),
      'oauth2JwtBearerConfig':
          ?pulumi.Input.mapOptionalInputValue<
            CxToolConnectorSpecEndUserAuthConfigOauth2JwtBearerConfig,
            Map<String, dynamic>
          >(oauth2JwtBearerConfig, (value) => value.toMap()),
    };
  }
  ...
  factory CxToolConnectorSpecEndUserAuthConfig.fromMap(
    ...
    return CxToolConnectorSpecEndUserAuthConfig(
      oauth2AuthCodeConfig: (() {
        final guardedValue = map['oauth2AuthCodeConfig'];
      ...
      oauth2JwtBearerConfig: (() {
        final guardedValue = map['oauth2JwtBearerConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
