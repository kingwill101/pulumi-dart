...
class CxGenerativeSettingsState {
  ...
  factory CxGenerativeSettingsState.fromMap(Map<String, dynamic> map) {
    return CxGenerativeSettingsState(
      fallbackSettings: (() { final guardedValue = map['fallbackSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CxGenerativeSettingsFallbackSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      generativeSafetySettings: (() { final guardedValue = map['generativeSafetySettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CxGenerativeSettingsGenerativeSafetySettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      knowledgeConnectorSettings: (() { final guardedValue = map['knowledgeConnectorSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CxGenerativeSettingsKnowledgeConnectorSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      llmModelSettings: (() { final guardedValue = map['llmModelSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CxGenerativeSettingsLlmModelSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
