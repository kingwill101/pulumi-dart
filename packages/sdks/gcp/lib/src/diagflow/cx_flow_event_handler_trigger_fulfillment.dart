...
class CxFlowEventHandlerTriggerFulfillment {
  ...
  final pulumi.Input<List<CxFlowEventHandlerTriggerFulfillmentConditionalCase>>?
  conditionalCases;
  ...
  /// Structure is documented below.
  final pulumi.Input<List<CxFlowEventHandlerTriggerFulfillmentMessage>>?
  messages;
  ...
  /// Structure is documented below.
  final pulumi.Input<
    List<CxFlowEventHandlerTriggerFulfillmentSetParameterAction>
  >?
  setParameterActions;
    ...
    return <String, dynamic>{
      'conditionalCases':
          ?pulumi.Input.mapOptionalInputValue<
            List<CxFlowEventHandlerTriggerFulfillmentConditionalCase>,
      ...
      'messages':
          ?pulumi.Input.mapOptionalInputValue<
            List<CxFlowEventHandlerTriggerFulfillmentMessage>,
            List<Map<String, dynamic>>
          >(
            messages,
            (value) =>
  ...
  factory CxFlowEventHandlerTriggerFulfillment.fromMap(
    ...
    return CxFlowEventHandlerTriggerFulfillment(
      conditionalCases: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                CxFlowEventHandlerTriggerFulfillmentConditionalCase.fromMap(
      ...
      enableGenerativeFallback: (() {
        final guardedValue = map['enableGenerativeFallback'];
        if (guardedValue == null) return null;
      ...
      messages: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<CxFlowEventHandlerTriggerFulfillmentMessage>(
            guardedValue,
      ...
      setParameterActions: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                CxFlowEventHandlerTriggerFulfillmentSetParameterAction.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
