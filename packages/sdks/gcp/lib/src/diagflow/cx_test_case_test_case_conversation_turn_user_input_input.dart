...
class CxTestCaseTestCaseConversationTurnUserInputInput {
  ...
  final pulumi.Input<CxTestCaseTestCaseConversationTurnUserInputInputDtmf>?
  dtmf;

  /// The event to be triggered.
  /// Structure is documented below.
  final pulumi.Input<CxTestCaseTestCaseConversationTurnUserInputInputEvent>?
  event;
  ...
  /// Structure is documented below.
  final pulumi.Input<CxTestCaseTestCaseConversationTurnUserInputInputText>?
  text;
