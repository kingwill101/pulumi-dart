...
class CxSecuritySettingsState {
  ...
  /// [name] The unique identifier of the settings.
  ...
  factory CxSecuritySettingsState.fromMap(Map<String, dynamic> map) {
    return CxSecuritySettingsState(
      ...
      retentionWindowDays: (() { final guardedValue = map['retentionWindowDays']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
    );
  }
}
