...
class GetInstanceBootDiskInitializeParamSourceImageEncryptionKey {
  ...
  /// Creates a new [GetInstanceBootDiskInitializeParamSourceImageEncryptionKey].
  ...
  const GetInstanceBootDiskInitializeParamSourceImageEncryptionKey({
  ...
  factory GetInstanceBootDiskInitializeParamSourceImageEncryptionKey.fromMap(Map<String, dynamic> map) {
    return GetInstanceBootDiskInitializeParamSourceImageEncryptionKey(
