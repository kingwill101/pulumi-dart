...
class RouteWarning {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'code': ?code,
      'datas': ?datas == null ? null : pulumi.Input.encodeList<RouteWarningData, Map<String, dynamic>>(datas!, (value) => value.toMap()),
      'message': ?message,
    };
  }
  ...
  factory RouteWarning.fromMap(Map<String, dynamic> map) {
    return RouteWarning(
      ...
      datas: map['datas'] == null ? null : pulumi.Input.decodeList<RouteWarningData>(map['datas'], (value) => RouteWarningData.fromMap((value as Map).cast<String, dynamic>())),
