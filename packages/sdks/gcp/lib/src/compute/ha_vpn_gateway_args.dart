...
class HaVpnGatewayArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'network': network,
      'params': ?pulumi.Input.mapOptionalInputValue<HaVpnGatewayParams, Map<String, dynamic>>(params, (value) => value.toMap()),
      'project': ?project,
      'region': ?region,
      'stackType': ?stackType,
  ...
  factory HaVpnGatewayArgs.fromMap(Map<String, dynamic> map) {
    return HaVpnGatewayArgs(
      ...
      params: (() { final guardedValue = map['params']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HaVpnGatewayParams.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
