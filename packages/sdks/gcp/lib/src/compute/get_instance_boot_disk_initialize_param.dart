...
class GetInstanceBootDiskInitializeParam {
  ...
  final pulumi.Input<
    List<GetInstanceBootDiskInitializeParamSourceImageEncryptionKey>
  >
  sourceImageEncryptionKeys;

  /// The encryption key used to decrypt the source snapshot.
  final pulumi.Input<
    List<GetInstanceBootDiskInitializeParamSourceSnapshotEncryptionKey>
  >
    ...
    return GetInstanceBootDiskInitializeParam(
      ...
      sourceImageEncryptionKeys: pulumi.Input.fromValue(
        ...
        >(
          ...
          (value) =>
              GetInstanceBootDiskInitializeParamSourceImageEncryptionKey.fromMap(
      ...
      sourceSnapshotEncryptionKeys: pulumi.Input.fromValue(
        ...
        >(
          ...
          (value) =>
              GetInstanceBootDiskInitializeParamSourceSnapshotEncryptionKey.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
