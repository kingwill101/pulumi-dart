...
class VPNTunnel extends pulumi.CustomResource {
  ...
  VPNTunnel(
    ...
    this.localTrafficSelectors = registerOutput<List<String>>('localTrafficSelectors');
    this.name = registerOutput<String>('name');
    this.peerExternalGateway = registerOutput<String?>('peerExternalGateway');
    this.peerExternalGatewayInterface = registerOutput<int?>('peerExternalGatewayInterface');
    ...
    this.remoteTrafficSelectors = registerOutput<List<String>>('remoteTrafficSelectors');
    ...
    this.sharedSecretWoVersion = registerOutput<String?>('sharedSecretWoVersion');
  ...
  /// Gets an existing [VPNTunnel] resource's state with the given [name] and [id].
  static VPNTunnel get(
    String name,
