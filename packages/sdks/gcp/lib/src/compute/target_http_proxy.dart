...
///   timeout_sec        = 1
/// }
/// output "targetHttpProxyFingerprint" {
///   value = gcp_compute_targethttpproxy.default.fingerprint
/// }
/// ```
/// ```java
/// package generated_program;
...
class TargetHttpProxy extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [TargetHttpProxy] resource.
  TargetHttpProxy.reference(String urn)
    : super(
        'gcp:compute/targetHttpProxy:TargetHttpProxy',
