...
class GetRegionSecurityPolicyAdvancedOptionsConfig {
  ...
  factory GetRegionSecurityPolicyAdvancedOptionsConfig.fromMap(Map<String, dynamic> map) {
    return GetRegionSecurityPolicyAdvancedOptionsConfig(
      jsonCustomConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetRegionSecurityPolicyAdvancedOptionsConfigJsonCustomConfig>(map['jsonCustomConfigs']!, (value) => GetRegionSecurityPolicyAdvancedOptionsConfigJsonCustomConfig.fromMap((value as Map).cast<String, dynamic>()))),
