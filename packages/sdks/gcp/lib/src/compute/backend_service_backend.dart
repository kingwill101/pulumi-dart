...
class BackendServiceBackend {
  ...
  factory BackendServiceBackend.fromMap(Map<String, dynamic> map) {
    return BackendServiceBackend(
      ...
      customMetrics: (() { final guardedValue = map['customMetrics']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<BackendServiceBackendCustomMetric>(guardedValue, (value) => BackendServiceBackendCustomMetric.fromMap((value as Map).cast<String, dynamic>()))); })(),
