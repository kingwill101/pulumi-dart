    ...
    return <String, dynamic>{
      'asPaths':
          pulumi.Input.mapInputValue<
            List<RouterStatusBestRouteAsPath>,
      ...
      'params':
          pulumi.Input.mapInputValue<
            List<RouterStatusBestRouteParam>,
            List<Map<String, dynamic>>
          >(
            params,
            (value) =>
  ...
  factory RouterStatusBestRoute.fromMap(Map<String, dynamic> map) {
    return RouterStatusBestRoute(
      asPaths: pulumi.Input.fromValue(
        pulumi.Input.decodeList<RouterStatusBestRouteAsPath>(
          map['asPaths']!,
      ...
      params: pulumi.Input.fromValue(
        pulumi.Input.decodeList<RouterStatusBestRouteParam>(
          map['params']!,
      ...
      warnings: pulumi.Input.fromValue(
        pulumi.Input.decodeList<RouterStatusBestRouteWarning>(
          map['warnings']!,
