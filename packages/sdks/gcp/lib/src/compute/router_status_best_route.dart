...
class RouterStatusBestRoute {
  ...
  factory RouterStatusBestRoute.fromMap(Map<String, dynamic> map) {
    return RouterStatusBestRoute(
      asPaths: (pulumi.Input.decodeList<RouterStatusBestRouteAsPath>(map['asPaths'], (value) => RouterStatusBestRouteAsPath.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      params: (pulumi.Input.decodeList<RouterStatusBestRouteParam>(map['params'], (value) => RouterStatusBestRouteParam.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      warnings: (pulumi.Input.decodeList<RouterStatusBestRouteWarning>(map['warnings'], (value) => RouterStatusBestRouteWarning.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
