...
import 'region_network_firewall_policy_iam_member_state.dart';
...
class RegionNetworkFirewallPolicyIamMember extends pulumi.CustomResource {
  late final pulumi.Output<RegionNetworkFirewallPolicyIamMemberCondition?> condition;
  ...
  /// [args] Arguments used to configure this [RegionNetworkFirewallPolicyIamMember]. {@macro pulumi_compute_region_network_firewall_policy_iam_member_region_network_firewall_policy_iam_member_args_doc}
  ...
  RegionNetworkFirewallPolicyIamMember(
    ...
    condition = registerOutput<RegionNetworkFirewallPolicyIamMemberCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return RegionNetworkFirewallPolicyIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [RegionNetworkFirewallPolicyIamMember] resource's state with the given [name] and [id].
  static RegionNetworkFirewallPolicyIamMember get(
    String name,
    pulumi.Input<String> id, {
    RegionNetworkFirewallPolicyIamMemberState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return RegionNetworkFirewallPolicyIamMember._get(
      name,
      state: state?.toMap(),
  ...
  RegionNetworkFirewallPolicyIamMember._get(
    String name, {
  ...
  /// Creates a typed reference to an existing [RegionNetworkFirewallPolicyIamMember] resource.
  RegionNetworkFirewallPolicyIamMember.reference(String urn)
    : super(
        'gcp:compute/regionNetworkFirewallPolicyIamMember:RegionNetworkFirewallPolicyIamMember',
