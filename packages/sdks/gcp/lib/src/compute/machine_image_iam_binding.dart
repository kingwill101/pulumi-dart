...
import 'machine_image_iam_binding_state.dart';
...
class MachineImageIamBinding extends pulumi.CustomResource {
  ...
  MachineImageIamBinding(
    ...
    condition = registerOutput<MachineImageIamBindingCondition?>(
      'condition',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return MachineImageIamBindingCondition.fromMap(
  ...
  /// Gets an existing [MachineImageIamBinding] resource's state with the given [name] and [id].
  static MachineImageIamBinding get(
    String name,
