...
class InterconnectArgs {
  ...
  InterconnectArgs({
    ...
    required pulumi.Output<String> interconnectType,
    pulumi.Output<Map<String, String>>? labels,
    required pulumi.Output<String> linkType,
    ...
    required pulumi.Output<int> requestedLinkCount,
  }) :
  ...
  factory InterconnectArgs.fromMap(Map<String, dynamic> map) {
    return InterconnectArgs(
      ...
      interconnectType: pulumi.Output.create<String>(map['interconnectType'] as String),
      labels: map['labels'] == null ? null : pulumi.Output.create<Map<String, String>>((map['labels'] as Map).cast<String, String>()),
      linkType: pulumi.Output.create<String>(map['linkType'] as String),
      ...
      requestedLinkCount: pulumi.Output.create<int>(map['requestedLinkCount'] as int),
    );
  }
}
