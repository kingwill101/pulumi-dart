...
class InterconnectAttachment extends pulumi.CustomResource {
  ...
  InterconnectAttachment(
    ...
    candidateCloudRouterIpAddress = registerOutput<String?>(
      'candidateCloudRouterIpAddress',
    );
    candidateCloudRouterIpv6Address = registerOutput<String?>(
      'candidateCloudRouterIpv6Address',
    );
    candidateCustomerRouterIpAddress = registerOutput<String?>(
      'candidateCustomerRouterIpAddress',
    );
    candidateCustomerRouterIpv6Address = registerOutput<String?>(
    ...
    privateInterconnectInfos = registerOutput<List<Map<String, dynamic>>>(
