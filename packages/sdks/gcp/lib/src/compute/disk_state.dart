...
class DiskState {
  ...
  DiskState({
    ...
    pulumi.Output<String>? sourceInstantSnapshotId,
    ...
    pulumi.Output<String>? zone,
      ...
      sourceInstantSnapshotId = pulumi.Input.asOptionalInput<String>(sourceInstantSnapshotId),
  ...
  factory DiskState.fromMap(Map<String, dynamic> map) {
    return DiskState(
      ...
      sourceInstantSnapshotId: map['sourceInstantSnapshotId'] == null ? null : pulumi.Output.create<String>(map['sourceInstantSnapshotId'] as String),
