...
class URLMapPathMatcherRouteRuleRouteActionMaxStreamDuration {
  ...
  /// Creates a new [URLMapPathMatcherRouteRuleRouteActionMaxStreamDuration].
  ...
  const URLMapPathMatcherRouteRuleRouteActionMaxStreamDuration({
    this.nanos,
  ...
  factory URLMapPathMatcherRouteRuleRouteActionMaxStreamDuration.fromMap(Map<String, dynamic> map) {
    return URLMapPathMatcherRouteRuleRouteActionMaxStreamDuration(
