...
class URLMapPathMatcherPathRule {
  ...
  factory URLMapPathMatcherPathRule.fromMap(Map<String, dynamic> map) {
    return URLMapPathMatcherPathRule(
      customErrorResponsePolicy: (() { final guardedValue = map['customErrorResponsePolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(URLMapPathMatcherPathRuleCustomErrorResponsePolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      paths: pulumi.Input.fromValue((map['paths'] as List).cast<String>()),
      routeAction: (() { final guardedValue = map['routeAction']; if (guardedValue == null) return null; return pulumi.Input.fromValue(URLMapPathMatcherPathRuleRouteAction.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      service: (() { final guardedValue = map['service']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      urlRedirect: (() { final guardedValue = map['urlRedirect']; if (guardedValue == null) return null; return pulumi.Input.fromValue(URLMapPathMatcherPathRuleUrlRedirect.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
