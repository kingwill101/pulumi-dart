...
/// {@template pulumi_compute_region_disk_iam_member_region_disk_iam_member_args_doc}
/// The set of arguments for RegionDiskIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_region_disk_iam_member_region_disk_iam_member_args_doc}
class RegionDiskIamMemberArgs {
  ...
  factory RegionDiskIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return RegionDiskIamMemberArgs(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionDiskIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
