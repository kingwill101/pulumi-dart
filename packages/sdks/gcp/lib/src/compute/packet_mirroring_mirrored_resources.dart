...
class PacketMirroringMirroredResources {
  ...
  /// Structure is documented below.
  final pulumi.Input<List<PacketMirroringMirroredResourcesSubnetwork>>?
  subnetworks;
    ...
    return <String, dynamic>{
      'instances':
          ?pulumi.Input.mapOptionalInputValue<
            List<PacketMirroringMirroredResourcesInstance>,
      ...
      'subnetworks':
          ?pulumi.Input.mapOptionalInputValue<
            List<PacketMirroringMirroredResourcesSubnetwork>,
            List<Map<String, dynamic>>
          >(
            subnetworks,
            (value) =>
