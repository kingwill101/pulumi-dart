...
class InstanceFromTemplateArgs {
  ...
  InstanceFromTemplateArgs({
    ...
    required pulumi.Output<String> sourceInstanceTemplate,
    ...
    pulumi.Output<String>? zone,
      ...
      sourceInstanceTemplate = pulumi.Input.asInput<String>(sourceInstanceTemplate),
  ...
  factory InstanceFromTemplateArgs.fromMap(Map<String, dynamic> map) {
    return InstanceFromTemplateArgs(
      ...
      sourceInstanceTemplate: pulumi.Output.create<String>(map['sourceInstanceTemplate'] as String),
