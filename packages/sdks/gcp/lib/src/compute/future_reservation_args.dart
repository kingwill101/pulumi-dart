...
class FutureReservationArgs {
  ...
  FutureReservationArgs({
    ...
    required pulumi.Output<FutureReservationTimeWindow> timeWindow,
  }) :
  ...
  factory FutureReservationArgs.fromMap(Map<String, dynamic> map) {
    return FutureReservationArgs(
      ...
      timeWindow: pulumi.Output.create<FutureReservationTimeWindow>(FutureReservationTimeWindow.fromMap((map['timeWindow'] as Map).cast<String, dynamic>())),
    );
  }
}
