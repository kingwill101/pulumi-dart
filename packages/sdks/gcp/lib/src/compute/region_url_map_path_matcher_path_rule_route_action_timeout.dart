...
class RegionUrlMapPathMatcherPathRuleRouteActionTimeout {
  ...
  /// Creates a new [RegionUrlMapPathMatcherPathRuleRouteActionTimeout].
  ...
  const RegionUrlMapPathMatcherPathRuleRouteActionTimeout({
    this.nanos,
  ...
  factory RegionUrlMapPathMatcherPathRuleRouteActionTimeout.fromMap(Map<String, dynamic> map) {
