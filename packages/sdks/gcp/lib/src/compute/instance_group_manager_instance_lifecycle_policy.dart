...
class InstanceGroupManagerInstanceLifecyclePolicy {
  ...
  /// - - -
  final pulumi.Input<InstanceGroupManagerInstanceLifecyclePolicyOnRepair>?
  onRepair;
    ...
    return <String, dynamic>{
      ...
      'onRepair':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(onRepair, (value) => value.toMap()),
    };
  }

  factory InstanceGroupManagerInstanceLifecyclePolicy.fromMap(
    Map<String, dynamic> map,
  ) {
    return InstanceGroupManagerInstanceLifecyclePolicy(
      defaultActionOnFailure: (() {
        final guardedValue = map['defaultActionOnFailure'];
      ...
      onFailedHealthCheck: (() {
        final guardedValue = map['onFailedHealthCheck'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      onRepair: (() {
        final guardedValue = map['onRepair'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          InstanceGroupManagerInstanceLifecyclePolicyOnRepair.fromMap(
