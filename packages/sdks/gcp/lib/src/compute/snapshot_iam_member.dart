...
import 'snapshot_iam_member_condition.dart';
import 'snapshot_iam_member_state.dart';
...
class SnapshotIamMember extends pulumi.CustomResource {
  late final pulumi.Output<SnapshotIamMemberCondition?> condition;
  ...
  /// Creates a new [SnapshotIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [SnapshotIamMember]. {@macro pulumi_compute_snapshot_iam_member_snapshot_iam_member_args_doc}
  ...
  SnapshotIamMember(
    ...
    condition = registerOutput<SnapshotIamMemberCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SnapshotIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [SnapshotIamMember] resource's state with the given [name] and [id].
  static SnapshotIamMember get(
    String name,
    pulumi.Input<String> id, {
    SnapshotIamMemberState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return SnapshotIamMember._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [SnapshotIamMember] resource.
  SnapshotIamMember.reference(String urn)
    : super(
        'gcp:compute/snapshotIamMember:SnapshotIamMember',
