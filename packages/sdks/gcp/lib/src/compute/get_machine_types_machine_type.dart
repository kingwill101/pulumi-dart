...
class GetMachineTypesMachineType {
  ...
  final pulumi.Input<List<GetMachineTypesMachineTypeBundledLocalSsd>>
  bundledLocalSsds;
    ...
    return <String, dynamic>{
      'accelerators':
          pulumi.Input.mapInputValue<
            List<GetMachineTypesMachineTypeAccelerator>,
      ...
      'bundledLocalSsds':
          pulumi.Input.mapInputValue<
            List<GetMachineTypesMachineTypeBundledLocalSsd>,
            List<Map<String, dynamic>>
          >(
            bundledLocalSsds,
            (value) =>
      ...
      'deprecateds':
          pulumi.Input.mapInputValue<
            List<GetMachineTypesMachineTypeDeprecated>,
            List<Map<String, dynamic>>
          >(
            deprecateds,
            (value) =>
  ...
  factory GetMachineTypesMachineType.fromMap(Map<String, dynamic> map) {
    return GetMachineTypesMachineType(
      ...
      bundledLocalSsds: pulumi.Input.fromValue(
      ...
      deprecateds: pulumi.Input.fromValue(
      ...
      maximumPersistentDisks: pulumi.Input.fromValue(
        map['maximumPersistentDisks'] as int,
      ),
      maximumPersistentDisksSizeGb: pulumi.Input.fromValue(
        map['maximumPersistentDisksSizeGb'] as int,
      ),
