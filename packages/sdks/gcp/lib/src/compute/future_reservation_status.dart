...
class FutureReservationStatus {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'lastKnownGoodState': ?lastKnownGoodState == null ? null : lastKnownGoodState!.toMap(),
      'lockTime': ?lockTime,
  ...
  factory FutureReservationStatus.fromMap(Map<String, dynamic> map) {
    return FutureReservationStatus(
      amendmentStatus: map['amendmentStatus'] == null ? null : map['amendmentStatus'] as String,
      autoCreatedReservations: map['autoCreatedReservations'] == null ? null : (map['autoCreatedReservations'] as List).cast<String>(),
      fulfilledCount: map['fulfilledCount'] == null ? null : map['fulfilledCount'] as String,
      lastKnownGoodState: map['lastKnownGoodState'] == null ? null : FutureReservationStatusLastKnownGoodState.fromMap((map['lastKnownGoodState'] as Map).cast<String, dynamic>()),
      ...
      specificSkuProperties: map['specificSkuProperties'] == null ? null : FutureReservationStatusSpecificSkuProperties.fromMap((map['specificSkuProperties'] as Map).cast<String, dynamic>()),
    );
  }
}
