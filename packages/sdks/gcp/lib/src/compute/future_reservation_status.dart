...
class FutureReservationStatus {
  ...
  final pulumi.Input<FutureReservationStatusLastKnownGoodState>?
  lastKnownGoodState;
  ...
  /// Structure is documented below.
  final pulumi.Input<FutureReservationStatusSpecificSkuProperties>?
  ...
  factory FutureReservationStatus.fromMap(Map<String, dynamic> map) {
    return FutureReservationStatus(
      amendmentStatus: (() {
        final guardedValue = map['amendmentStatus'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      autoCreatedReservations: (() {
        final guardedValue = map['autoCreatedReservations'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      fulfilledCount: (() {
        final guardedValue = map['fulfilledCount'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      lastKnownGoodState: (() {
        final guardedValue = map['lastKnownGoodState'];
        if (guardedValue == null) return null;
