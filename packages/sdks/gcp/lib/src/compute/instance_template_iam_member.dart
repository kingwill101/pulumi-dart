...
import 'instance_template_iam_member_args.dart';
import 'instance_template_iam_member_condition.dart';
import 'instance_template_iam_member_state.dart';
...
/// }
///
/// resource "gcp_compute_instancetemplateiampolicy" "policy" {
///   project     = default.project
///   name        = default.name
...
/// }
///
/// resource "gcp_compute_instancetemplateiambinding" "binding" {
///   project = default.project
///   name    = default.name
///   role    = "roles/compute.instanceAdmin"
///   members = ["user:jane@example.com"]
...
/// }
///
/// resource "gcp_compute_instancetemplateiammember" "member" {
///   project = default.project
///   name    = default.name
///   role    = "roles/compute.instanceAdmin"
///   member  = "user:jane@example.com"
...
class InstanceTemplateIamMember extends pulumi.CustomResource {
  ...
  late final pulumi.Output<InstanceTemplateIamMemberCondition?> condition;
  ...
  /// Creates a new [InstanceTemplateIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [InstanceTemplateIamMember]. {@macro pulumi_compute_instance_template_iam_member_instance_template_iam_member_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  InstanceTemplateIamMember(
    String name, {
    InstanceTemplateIamMemberArgs? args,
    ...
    condition = registerOutput<InstanceTemplateIamMemberCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return InstanceTemplateIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [InstanceTemplateIamMember] resource's state with the given [name] and [id].
  static InstanceTemplateIamMember get(
    String name,
    pulumi.Input<String> id, {
    InstanceTemplateIamMemberState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return InstanceTemplateIamMember._get(
      name,
      state: state?.toMap(),
  ...
  InstanceTemplateIamMember._get(
    String name, {
  ...
  /// Creates a typed reference to an existing [InstanceTemplateIamMember] resource.
  InstanceTemplateIamMember.reference(String urn)
    : super(
        'gcp:compute/instanceTemplateIamMember:InstanceTemplateIamMember',
