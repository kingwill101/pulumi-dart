...
class RegionUrlMapPathMatcherPathRuleRouteActionWeightedBackendService {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'headerAction': ?pulumi.Input.mapOptionalInputValue<RegionUrlMapPathMatcherPathRuleRouteActionWeightedBackendServiceHeaderAction, Map<String, dynamic>>(headerAction, (value) => value.toMap()),
      'weight': weight,
    };
  }
  ...
  factory RegionUrlMapPathMatcherPathRuleRouteActionWeightedBackendService.fromMap(Map<String, dynamic> map) {
    return RegionUrlMapPathMatcherPathRuleRouteActionWeightedBackendService(
      ...
      headerAction: map['headerAction'] == null ? null : (RegionUrlMapPathMatcherPathRuleRouteActionWeightedBackendServiceHeaderAction.fromMap((map['headerAction'] as Map).cast<String, dynamic>())).input(),
