...
class RouterPeerState {
  ...
  RouterPeerState({
    ...
    pulumi.Output<bool>? isAdvertisedRoutePrioritySet,
    pulumi.Output<bool>? isCustomLearnedPrioritySet,
    pulumi.Output<String>? managementType,
    ...
    pulumi.Output<bool>? zeroCustomLearnedRoutePriority,
      ...
      isAdvertisedRoutePrioritySet = pulumi.Input.asOptionalInput<bool>(isAdvertisedRoutePrioritySet),
      isCustomLearnedPrioritySet = pulumi.Input.asOptionalInput<bool>(isCustomLearnedPrioritySet),
      managementType = pulumi.Input.asOptionalInput<String>(managementType),
  ...
  factory RouterPeerState.fromMap(Map<String, dynamic> map) {
    return RouterPeerState(
      ...
      isAdvertisedRoutePrioritySet: map['isAdvertisedRoutePrioritySet'] == null ? null : pulumi.Output.create<bool>(map['isAdvertisedRoutePrioritySet'] as bool),
      isCustomLearnedPrioritySet: map['isCustomLearnedPrioritySet'] == null ? null : pulumi.Output.create<bool>(map['isCustomLearnedPrioritySet'] as bool),
      managementType: map['managementType'] == null ? null : pulumi.Output.create<String>(map['managementType'] as String),
