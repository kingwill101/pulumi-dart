...
class RouterPeerState {
  ...
  factory RouterPeerState.fromMap(Map<String, dynamic> map) {
    return RouterPeerState(
      ...
      advertisedIpRanges: map['advertisedIpRanges'] == null ? null : (pulumi.Input.decodeList<RouterPeerAdvertisedIpRange>(map['advertisedIpRanges']!, (value) => RouterPeerAdvertisedIpRange.fromMap((value as Map).cast<String, dynamic>()))).input(),
      advertisedRoutePriority: map['advertisedRoutePriority'] == null ? null : (map['advertisedRoutePriority']! as int).input(),
      bfd: map['bfd'] == null ? null : (RouterPeerBfd.fromMap((map['bfd']! as Map).cast<String, dynamic>())).input(),
      customLearnedIpRanges: map['customLearnedIpRanges'] == null ? null : (pulumi.Input.decodeList<RouterPeerCustomLearnedIpRange>(map['customLearnedIpRanges']!, (value) => RouterPeerCustomLearnedIpRange.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      exportPolicies: map['exportPolicies'] == null ? null : ((map['exportPolicies']! as List).cast<String>()).input(),
      importPolicies: map['importPolicies'] == null ? null : ((map['importPolicies']! as List).cast<String>()).input(),
      interface: map['interface'] == null ? null : (map['interface']! as String).input(),
      ipAddress: map['ipAddress'] == null ? null : (map['ipAddress']! as String).input(),
      ipv4NexthopAddress: map['ipv4NexthopAddress'] == null ? null : (map['ipv4NexthopAddress']! as String).input(),
      ipv6NexthopAddress: map['ipv6NexthopAddress'] == null ? null : (map['ipv6NexthopAddress']! as String).input(),
      isAdvertisedRoutePrioritySet: map['isAdvertisedRoutePrioritySet'] == null ? null : (map['isAdvertisedRoutePrioritySet']! as bool).input(),
      isCustomLearnedPrioritySet: map['isCustomLearnedPrioritySet'] == null ? null : (map['isCustomLearnedPrioritySet']! as bool).input(),
      managementType: map['managementType'] == null ? null : (map['managementType']! as String).input(),
      md5AuthenticationKey: map['md5AuthenticationKey'] == null ? null : (RouterPeerMd5AuthenticationKey.fromMap((map['md5AuthenticationKey']! as Map).cast<String, dynamic>())).input(),
      ...
      peerIpv4NexthopAddress: map['peerIpv4NexthopAddress'] == null ? null : (map['peerIpv4NexthopAddress']! as String).input(),
      ...
      zeroAdvertisedRoutePriority: map['zeroAdvertisedRoutePriority'] == null ? null : (map['zeroAdvertisedRoutePriority']! as bool).input(),
      zeroCustomLearnedRoutePriority: map['zeroCustomLearnedRoutePriority'] == null ? null : (map['zeroCustomLearnedRoutePriority']! as bool).input(),
    );
  }
}
