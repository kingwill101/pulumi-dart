...
import 'urlmap_default_route_action_cache_policy_cache_key_policy.dart';
import 'urlmap_default_route_action_cache_policy_client_ttl.dart';
import 'urlmap_default_route_action_cache_policy_default_ttl.dart';
import 'urlmap_default_route_action_cache_policy_max_ttl.dart';
import 'urlmap_default_route_action_cache_policy_negative_caching_policy.dart';
import 'urlmap_default_route_action_cache_policy_serve_while_stale.dart';

class URLMapDefaultRouteActionCachePolicy {
  ...
  final pulumi.Input<URLMapDefaultRouteActionCachePolicyCacheKeyPolicy?>? cacheKeyPolicy;
  ...
  /// Structure is documented below.
  final pulumi.Input<URLMapDefaultRouteActionCachePolicyClientTtl?>? clientTtl;
  ...
  /// USE_ORIGIN_HEADERS.
  /// Structure is documented below.
  final pulumi.Input<URLMapDefaultRouteActionCachePolicyDefaultTtl?>? defaultTtl;
  ...
  /// mode.
  /// Structure is documented below.
  final pulumi.Input<URLMapDefaultRouteActionCachePolicyMaxTtl?>? maxTtl;
  ...
  /// a policy exists.
  /// Structure is documented below.
  final pulumi.Input<List<URLMapDefaultRouteActionCachePolicyNegativeCachingPolicy>?>? negativeCachingPolicies;
  ...
  /// Structure is documented below.
  final pulumi.Input<URLMapDefaultRouteActionCachePolicyServeWhileStale?>? serveWhileStale;

  /// Creates a new [URLMapDefaultRouteActionCachePolicy].
  ...
  const URLMapDefaultRouteActionCachePolicy({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'cacheKeyPolicy': ?pulumi.Input.mapOptionalInputValue<URLMapDefaultRouteActionCachePolicyCacheKeyPolicy, Map<String, dynamic>>(cacheKeyPolicy, (value) => value.toMap()),
      'cacheMode': ?cacheMode,
      'clientTtl': ?pulumi.Input.mapOptionalInputValue<URLMapDefaultRouteActionCachePolicyClientTtl, Map<String, dynamic>>(clientTtl, (value) => value.toMap()),
      'defaultTtl': ?pulumi.Input.mapOptionalInputValue<URLMapDefaultRouteActionCachePolicyDefaultTtl, Map<String, dynamic>>(defaultTtl, (value) => value.toMap()),
      'maxTtl': ?pulumi.Input.mapOptionalInputValue<URLMapDefaultRouteActionCachePolicyMaxTtl, Map<String, dynamic>>(maxTtl, (value) => value.toMap()),
      'negativeCaching': ?negativeCaching,
      'negativeCachingPolicies': ?pulumi.Input.mapOptionalInputValue<List<URLMapDefaultRouteActionCachePolicyNegativeCachingPolicy>, List<Map<String, dynamic>>>(negativeCachingPolicies, (value) => pulumi.Input.encodeList<URLMapDefaultRouteActionCachePolicyNegativeCachingPolicy, Map<String, dynamic>>(value, (value) => value.toMap())),
      'requestCoalescing': ?requestCoalescing,
      'serveWhileStale': ?pulumi.Input.mapOptionalInputValue<URLMapDefaultRouteActionCachePolicyServeWhileStale, Map<String, dynamic>>(serveWhileStale, (value) => value.toMap()),
    };
  }

  factory URLMapDefaultRouteActionCachePolicy.fromMap(Map<String, dynamic> map) {
    return URLMapDefaultRouteActionCachePolicy(
      ...
      cacheKeyPolicy: (() { final guardedValue = map['cacheKeyPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(URLMapDefaultRouteActionCachePolicyCacheKeyPolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      clientTtl: (() { final guardedValue = map['clientTtl']; if (guardedValue == null) return null; return pulumi.Input.fromValue(URLMapDefaultRouteActionCachePolicyClientTtl.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      defaultTtl: (() { final guardedValue = map['defaultTtl']; if (guardedValue == null) return null; return pulumi.Input.fromValue(URLMapDefaultRouteActionCachePolicyDefaultTtl.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      maxTtl: (() { final guardedValue = map['maxTtl']; if (guardedValue == null) return null; return pulumi.Input.fromValue(URLMapDefaultRouteActionCachePolicyMaxTtl.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      negativeCachingPolicies: (() { final guardedValue = map['negativeCachingPolicies']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<URLMapDefaultRouteActionCachePolicyNegativeCachingPolicy>(guardedValue, (value) => URLMapDefaultRouteActionCachePolicyNegativeCachingPolicy.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      serveWhileStale: (() { final guardedValue = map['serveWhileStale']; if (guardedValue == null) return null; return pulumi.Input.fromValue(URLMapDefaultRouteActionCachePolicyServeWhileStale.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
