...
/// {@template pulumi_compute_get_instant_snapshot_iam_policy_get_instant_snapshot_iam_policy_args_doc}
/// Arguments for getInstantSnapshotIamPolicy.
/// {@endtemplate}
/// {@macro pulumi_compute_get_instant_snapshot_iam_policy_get_instant_snapshot_iam_policy_args_doc}
class GetInstantSnapshotIamPolicyArgs {
  ...
  /// Creates a new [GetInstantSnapshotIamPolicyArgs].
  ...
  const GetInstantSnapshotIamPolicyArgs({
    required this.name,
    this.project,
    this.zone,
  });
