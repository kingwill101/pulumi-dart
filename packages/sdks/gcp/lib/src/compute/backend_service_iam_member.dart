...
import 'backend_service_iam_member_state.dart';
...
/// }
///
/// resource "gcp_compute_backendserviceiampolicy" "policy" {
///   project     = default.project
///   name        = default.name
...
/// }
///
/// resource "gcp_compute_backendserviceiambinding" "binding" {
///   project = default.project
///   name    = default.name
///   role    = "roles/compute.admin"
///   members = ["user:jane@example.com"]
...
/// }
///
/// resource "gcp_compute_backendserviceiammember" "member" {
///   project = default.project
///   name    = default.name
///   role    = "roles/compute.admin"
///   member  = "user:jane@example.com"
...
class BackendServiceIamMember extends pulumi.CustomResource {
  ...
  /// Creates a new [BackendServiceIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [BackendServiceIamMember]. {@macro pulumi_compute_backend_service_iam_member_backend_service_iam_member_args_doc}
  ...
  BackendServiceIamMember(
    ...
    condition = registerOutput<BackendServiceIamMemberCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return BackendServiceIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [BackendServiceIamMember] resource's state with the given [name] and [id].
  static BackendServiceIamMember get(
    String name,
    pulumi.Input<String> id, {
    BackendServiceIamMemberState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return BackendServiceIamMember._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [BackendServiceIamMember] resource.
  BackendServiceIamMember.reference(String urn)
    : super(
        'gcp:compute/backendServiceIamMember:BackendServiceIamMember',
