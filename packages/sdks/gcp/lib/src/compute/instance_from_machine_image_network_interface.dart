...
class InstanceFromMachineImageNetworkInterface {
  ...
  final pulumi.Input<
    List<InstanceFromMachineImageNetworkInterfaceAccessConfig>
  >?
  accessConfigs;

  /// An array of alias IP ranges for this network interface.
  final pulumi.Input<
    List<InstanceFromMachineImageNetworkInterfaceAliasIpRange>
  >?
  aliasIpRanges;
  ...
  final pulumi.Input<
    List<InstanceFromMachineImageNetworkInterfaceIpv6AccessConfig>
  >?
  ipv6AccessConfigs;
