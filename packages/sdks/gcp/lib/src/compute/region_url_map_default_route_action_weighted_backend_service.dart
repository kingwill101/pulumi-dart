...
class RegionUrlMapDefaultRouteActionWeightedBackendService {
  ...
  final RegionUrlMapDefaultRouteActionWeightedBackendServiceHeaderAction? headerAction;
  ...
  factory RegionUrlMapDefaultRouteActionWeightedBackendService.fromMap(Map<String, dynamic> map) {
    return RegionUrlMapDefaultRouteActionWeightedBackendService(
      ...
      headerAction: map['headerAction'] == null ? null : RegionUrlMapDefaultRouteActionWeightedBackendServiceHeaderAction.fromMap((map['headerAction'] as Map).cast<String, dynamic>()),
