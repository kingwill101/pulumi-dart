...
class RegionBackendServiceOutlierDetection {
  ...
  factory RegionBackendServiceOutlierDetection.fromMap(Map<String, dynamic> map) {
    return RegionBackendServiceOutlierDetection(
      baseEjectionTime: map['baseEjectionTime'] == null ? null : (RegionBackendServiceOutlierDetectionBaseEjectionTime.fromMap((map['baseEjectionTime'] as Map).cast<String, dynamic>())).input(),
      ...
      interval: map['interval'] == null ? null : (RegionBackendServiceOutlierDetectionInterval.fromMap((map['interval'] as Map).cast<String, dynamic>())).input(),
