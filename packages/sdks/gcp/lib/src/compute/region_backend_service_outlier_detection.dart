...
import 'region_backend_service_outlier_detection_base_ejection_time.dart';
import 'region_backend_service_outlier_detection_interval.dart';
...
class RegionBackendServiceOutlierDetection {
  ...
  final pulumi.Input<RegionBackendServiceOutlierDetectionBaseEjectionTime>? baseEjectionTime;
  ...
  /// Structure is documented below.
  final pulumi.Input<RegionBackendServiceOutlierDetectionInterval>? interval;
  ...
  /// Creates a new [RegionBackendServiceOutlierDetection].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'baseEjectionTime': ?pulumi.Input.mapOptionalInputValue<RegionBackendServiceOutlierDetectionBaseEjectionTime, Map<String, dynamic>>(baseEjectionTime, (value) => value.toMap()),
      ...
      'interval': ?pulumi.Input.mapOptionalInputValue<RegionBackendServiceOutlierDetectionInterval, Map<String, dynamic>>(interval, (value) => value.toMap()),
  ...
  factory RegionBackendServiceOutlierDetection.fromMap(Map<String, dynamic> map) {
    return RegionBackendServiceOutlierDetection(
      baseEjectionTime: (() { final guardedValue = map['baseEjectionTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionBackendServiceOutlierDetectionBaseEjectionTime.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      interval: (() { final guardedValue = map['interval']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionBackendServiceOutlierDetectionInterval.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
