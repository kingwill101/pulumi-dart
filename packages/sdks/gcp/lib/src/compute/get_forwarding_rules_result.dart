...
class GetForwardingRulesResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'project': ?project,
      'region': ?region,
      'rules': ?(() { final guardedValue = rules; if (guardedValue == null) return null; return pulumi.Input.encodeList<GetForwardingRulesRule, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
    };
  }
  ...
  factory GetForwardingRulesResult.fromMap(Map<String, dynamic> map) {
    return GetForwardingRulesResult(
      ...
      rules: (() { final guardedValue = map['rules']; if (guardedValue == null) return null; return pulumi.Input.decodeList<GetForwardingRulesRule>(guardedValue, (value) => GetForwardingRulesRule.fromMap((value as Map).cast<String, dynamic>())); })(),
    );
  }
}
