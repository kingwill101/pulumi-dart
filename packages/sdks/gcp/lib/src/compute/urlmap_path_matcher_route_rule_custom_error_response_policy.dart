...
class URLMapPathMatcherRouteRuleCustomErrorResponsePolicy {
  ...
  final pulumi.Input<List<URLMapPathMatcherRouteRuleCustomErrorResponsePolicyErrorResponseRule>>? errorResponseRules;
  ...
  factory URLMapPathMatcherRouteRuleCustomErrorResponsePolicy.fromMap(Map<String, dynamic> map) {
    return URLMapPathMatcherRouteRuleCustomErrorResponsePolicy(
      errorResponseRules: (() { final guardedValue = map['errorResponseRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<URLMapPathMatcherRouteRuleCustomErrorResponsePolicyErrorResponseRule>(guardedValue, (value) => URLMapPathMatcherRouteRuleCustomErrorResponsePolicyErrorResponseRule.fromMap((value as Map).cast<String, dynamic>()))); })(),
