...
/// }
///
/// resource "gcp_compute_instantsnapshotiampolicy" "policy" {
///   project     = default.project
///   zone        = default.zone
///   name        = default.name
...
/// }
///
/// resource "gcp_compute_instantsnapshotiambinding" "binding" {
///   project = default.project
///   zone    = default.zone
///   name    = default.name
///   role    = "roles/compute.storageAdmin"
...
/// }
///
/// resource "gcp_compute_instantsnapshotiammember" "member" {
///   project = default.project
///   zone    = default.zone
///   name    = default.name
///   role    = "roles/compute.storageAdmin"
