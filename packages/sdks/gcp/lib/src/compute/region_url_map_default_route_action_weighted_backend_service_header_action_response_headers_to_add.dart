...
class RegionUrlMapDefaultRouteActionWeightedBackendServiceHeaderActionResponseHeadersToAdd {
  ...
  /// Creates a new [RegionUrlMapDefaultRouteActionWeightedBackendServiceHeaderActionResponseHeadersToAdd].
  ...
  const RegionUrlMapDefaultRouteActionWeightedBackendServiceHeaderActionResponseHeadersToAdd({
    this.headerName,
    this.headerValue,
    this.replace,
  });
  ...
  factory RegionUrlMapDefaultRouteActionWeightedBackendServiceHeaderActionResponseHeadersToAdd.fromMap(Map<String, dynamic> map) {
