...
class URLMapPathMatcherPathRuleRouteActionCachePolicyMaxTtl {
  /// Span of time that's a fraction of a second at nanosecond resolution.
  final pulumi.Input<int>? nanos;
  /// Span of time at a resolution of a second. Must be from 0 to 315,576,000,000 inclusive.
  final pulumi.Input<String> seconds;

  /// Creates a new [URLMapPathMatcherPathRuleRouteActionCachePolicyMaxTtl].
  ...
  const URLMapPathMatcherPathRuleRouteActionCachePolicyMaxTtl({
    this.nanos,
  ...
  factory URLMapPathMatcherPathRuleRouteActionCachePolicyMaxTtl.fromMap(Map<String, dynamic> map) {
    return URLMapPathMatcherPathRuleRouteActionCachePolicyMaxTtl(
