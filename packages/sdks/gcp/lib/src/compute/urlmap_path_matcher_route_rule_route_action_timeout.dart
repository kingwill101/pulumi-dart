...
class URLMapPathMatcherRouteRuleRouteActionTimeout {
  ...
  /// Creates a new [URLMapPathMatcherRouteRuleRouteActionTimeout].
  ...
  const URLMapPathMatcherRouteRuleRouteActionTimeout({
    this.nanos,
  ...
  factory URLMapPathMatcherRouteRuleRouteActionTimeout.fromMap(Map<String, dynamic> map) {
