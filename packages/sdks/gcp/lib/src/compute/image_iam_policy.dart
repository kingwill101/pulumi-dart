...
import 'image_iam_policy_state.dart';
...
class ImageIamPolicy extends pulumi.CustomResource {
  ...
  /// Creates a new [ImageIamPolicy].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ImageIamPolicy]. {@macro pulumi_compute_image_iam_policy_image_iam_policy_args_doc}
  ...
  /// Gets an existing [ImageIamPolicy] resource's state with the given [name] and [id].
  static ImageIamPolicy get(
    String name,
    pulumi.Input<String> id, {
    ImageIamPolicyState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return ImageIamPolicy._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [ImageIamPolicy] resource.
  ImageIamPolicy.reference(String urn)
    : super(
        'gcp:compute/imageIamPolicy:ImageIamPolicy',
