...
class NetworkFirewallPolicyWithRules extends pulumi.CustomResource {
  ...
  /// Gets an existing [NetworkFirewallPolicyWithRules] resource's state with the given [name] and [id].
  static NetworkFirewallPolicyWithRules get(
    String name,
  ...
  NetworkFirewallPolicyWithRules._get(
    String name, {
