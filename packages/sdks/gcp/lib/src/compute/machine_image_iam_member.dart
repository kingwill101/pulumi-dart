...
import 'machine_image_iam_member_state.dart';
...
class MachineImageIamMember extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [MachineImageIamMember]. {@macro pulumi_compute_machine_image_iam_member_machine_image_iam_member_args_doc}
  ...
  MachineImageIamMember(
    ...
    condition = registerOutput<MachineImageIamMemberCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return MachineImageIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [MachineImageIamMember] resource's state with the given [name] and [id].
  static MachineImageIamMember get(
    String name,
    pulumi.Input<String> id, {
    MachineImageIamMemberState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return MachineImageIamMember._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [MachineImageIamMember] resource.
  MachineImageIamMember.reference(String urn)
    : super(
        'gcp:compute/machineImageIamMember:MachineImageIamMember',
