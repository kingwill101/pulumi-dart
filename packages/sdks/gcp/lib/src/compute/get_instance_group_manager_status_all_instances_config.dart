...
class GetInstanceGroupManagerStatusAllInstancesConfig {
  /// Current all-instances configuration revision. This value is in RFC3339 text format.
  final pulumi.Input<String> currentRevision;
  /// A bit indicating whether this configuration has been applied to all managed instances in the group.
  final pulumi.Input<bool> effective;

  /// Creates a new [GetInstanceGroupManagerStatusAllInstancesConfig].
  ...
  const GetInstanceGroupManagerStatusAllInstancesConfig({
  ...
  factory GetInstanceGroupManagerStatusAllInstancesConfig.fromMap(Map<String, dynamic> map) {
    return GetInstanceGroupManagerStatusAllInstancesConfig(
