...
class GetRegionSecurityPolicyRuleMatch {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'configs': pulumi.Input.mapInputValue<List<GetRegionSecurityPolicyRuleMatchConfig>, List<Map<String, dynamic>>>(configs, (value) => pulumi.Input.encodeList<GetRegionSecurityPolicyRuleMatchConfig, Map<String, dynamic>>(value, (value) => value.toMap())),
      'exprs': pulumi.Input.mapInputValue<List<GetRegionSecurityPolicyRuleMatchExpr>, List<Map<String, dynamic>>>(exprs, (value) => pulumi.Input.encodeList<GetRegionSecurityPolicyRuleMatchExpr, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory GetRegionSecurityPolicyRuleMatch.fromMap(Map<String, dynamic> map) {
    return GetRegionSecurityPolicyRuleMatch(
      configs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetRegionSecurityPolicyRuleMatchConfig>(map['configs']!, (value) => GetRegionSecurityPolicyRuleMatchConfig.fromMap((value as Map).cast<String, dynamic>()))),
      exprs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetRegionSecurityPolicyRuleMatchExpr>(map['exprs']!, (value) => GetRegionSecurityPolicyRuleMatchExpr.fromMap((value as Map).cast<String, dynamic>()))),
