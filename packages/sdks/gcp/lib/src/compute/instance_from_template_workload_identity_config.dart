...
class InstanceFromTemplateWorkloadIdentityConfig {
  ...
  factory InstanceFromTemplateWorkloadIdentityConfig.fromMap(Map<String, dynamic> map) {
    return InstanceFromTemplateWorkloadIdentityConfig(
