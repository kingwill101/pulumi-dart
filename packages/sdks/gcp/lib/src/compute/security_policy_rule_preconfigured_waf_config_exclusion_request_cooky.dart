...
class SecurityPolicyRulePreconfiguredWafConfigExclusionRequestCooky {
  ...
  /// Creates a new [SecurityPolicyRulePreconfiguredWafConfigExclusionRequestCooky].
  ...
  const SecurityPolicyRulePreconfiguredWafConfigExclusionRequestCooky({
