...
class RegionResizeRequestStatusLastAttemptErrorErrorErrorDetailQuotaInfo {
  ...
  const RegionResizeRequestStatusLastAttemptErrorErrorErrorDetailQuotaInfo({
    this.dimensions,
    this.futureLimit,
    this.limit,
    this.limitName,
  ...
  factory RegionResizeRequestStatusLastAttemptErrorErrorErrorDetailQuotaInfo.fromMap(Map<String, dynamic> map) {
    return RegionResizeRequestStatusLastAttemptErrorErrorErrorDetailQuotaInfo(
      ...
      futureLimit: (() { final guardedValue = map['futureLimit']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
