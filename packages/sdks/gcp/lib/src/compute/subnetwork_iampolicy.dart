...
import 'subnetwork_iampolicy_state.dart';
...
class SubnetworkIAMPolicy extends pulumi.CustomResource {
  ...
  /// Gets an existing [SubnetworkIAMPolicy] resource's state with the given [name] and [id].
  static SubnetworkIAMPolicy get(
    String name,
