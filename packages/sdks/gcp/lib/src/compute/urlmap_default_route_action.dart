...
class URLMapDefaultRouteAction {
  ...
  /// Structure is documented below.
  final pulumi.Input<URLMapDefaultRouteActionFaultInjectionPolicy>?
  ...
  /// Structure is documented below.
  final pulumi.Input<URLMapDefaultRouteActionMaxStreamDuration>?
  maxStreamDuration;
  ...
  /// Structure is documented below.
  final pulumi.Input<URLMapDefaultRouteActionRequestMirrorPolicy>?
  requestMirrorPolicy;
  ...
  /// Structure is documented below.
  final pulumi.Input<List<URLMapDefaultRouteActionWeightedBackendService>>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'weightedBackendServices':
          ?pulumi.Input.mapOptionalInputValue<
            List<URLMapDefaultRouteActionWeightedBackendService>,
  ...
  factory URLMapDefaultRouteAction.fromMap(Map<String, dynamic> map) {
    return URLMapDefaultRouteAction(
      ...
      weightedBackendServices: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<URLMapDefaultRouteActionWeightedBackendService>(
            guardedValue,
