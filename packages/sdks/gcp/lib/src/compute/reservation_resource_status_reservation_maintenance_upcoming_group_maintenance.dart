  ...
  factory ReservationResourceStatusReservationMaintenanceUpcomingGroupMaintenance.fromMap(
    ...
    return ReservationResourceStatusReservationMaintenanceUpcomingGroupMaintenance(
      ...
      latestWindowStartTime: (() {
        final guardedValue = map['latestWindowStartTime'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      maintenanceOnShutdown: (() {
        final guardedValue = map['maintenanceOnShutdown'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      maintenanceReasons: (() {
        final guardedValue = map['maintenanceReasons'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      maintenanceStatus: (() {
        final guardedValue = map['maintenanceStatus'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      type: (() {
      ...
      windowEndTime: (() {
        final guardedValue = map['windowEndTime'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      windowStartTime: (() {
