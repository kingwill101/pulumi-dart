...
/// }
///
/// resource "gcp_compute_instanceiampolicy" "policy" {
///   project       = default.project
///   zone          = default.zone
///   instance_name = default.name
...
/// }
///
/// resource "gcp_compute_instanceiambinding" "binding" {
///   project       = default.project
///   zone          = default.zone
///   instance_name = default.name
///   role          = "roles/compute.osLogin"
...
/// }
///
/// resource "gcp_compute_instanceiammember" "member" {
///   project       = default.project
///   zone          = default.zone
///   instance_name = default.name
///   role          = "roles/compute.osLogin"
...
class InstanceIAMMember extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [InstanceIAMMember]. {@macro pulumi_compute_instance_iammember_instance_iammember_args_doc}
