...
class NetworkFirewallPolicyWithRulesPredefinedRule {
  ...
  final pulumi.Input<List<NetworkFirewallPolicyWithRulesPredefinedRuleMatch>>?
  matches;
  ...
  /// Structure is documented below.
  final pulumi.Input<
    List<NetworkFirewallPolicyWithRulesPredefinedRuleTargetSecureTag>
  >?
  targetSecureTags;
    ...
    return <String, dynamic>{
      ...
      'matches':
          ?pulumi.Input.mapOptionalInputValue<
            List<NetworkFirewallPolicyWithRulesPredefinedRuleMatch>,
      ...
      targetSecureTags: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                NetworkFirewallPolicyWithRulesPredefinedRuleTargetSecureTag.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
