...
class InstanceFromTemplateBootDisk {
  ...
  factory InstanceFromTemplateBootDisk.fromMap(Map<String, dynamic> map) {
    return InstanceFromTemplateBootDisk(
      ...
      initializeParams: map['initializeParams'] == null ? null : (InstanceFromTemplateBootDiskInitializeParams.fromMap((map['initializeParams']! as Map).cast<String, dynamic>())).input(),
