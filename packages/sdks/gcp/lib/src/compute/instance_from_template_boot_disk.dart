...
class InstanceFromTemplateBootDisk {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'initializeParams': ?pulumi.Input.mapOptionalInputValue<InstanceFromTemplateBootDiskInitializeParams, Map<String, dynamic>>(initializeParams, (value) => value.toMap()),
      'interface': ?interface,
  ...
  factory InstanceFromTemplateBootDisk.fromMap(Map<String, dynamic> map) {
    return InstanceFromTemplateBootDisk(
      ...
      initializeParams: (() { final guardedValue = map['initializeParams']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceFromTemplateBootDiskInitializeParams.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
