...
class URLMapPathMatcherRouteRuleCustomErrorResponsePolicyErrorResponseRule {
  ...
  /// Creates a new [URLMapPathMatcherRouteRuleCustomErrorResponsePolicyErrorResponseRule].
  ...
  const URLMapPathMatcherRouteRuleCustomErrorResponsePolicyErrorResponseRule({
  ...
  factory URLMapPathMatcherRouteRuleCustomErrorResponsePolicyErrorResponseRule.fromMap(Map<String, dynamic> map) {
    return URLMapPathMatcherRouteRuleCustomErrorResponsePolicyErrorResponseRule(
      matchResponseCodes: (() { final guardedValue = map['matchResponseCodes']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      overrideResponseCode: (() { final guardedValue = map['overrideResponseCode']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
