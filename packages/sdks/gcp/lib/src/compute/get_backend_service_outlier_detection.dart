...
class GetBackendServiceOutlierDetection {
  ...
  factory GetBackendServiceOutlierDetection.fromMap(Map<String, dynamic> map) {
    return GetBackendServiceOutlierDetection(
      baseEjectionTimes: (pulumi.Input.decodeList<GetBackendServiceOutlierDetectionBaseEjectionTime>(map['baseEjectionTimes'], (value) => GetBackendServiceOutlierDetectionBaseEjectionTime.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      intervals: (pulumi.Input.decodeList<GetBackendServiceOutlierDetectionInterval>(map['intervals'], (value) => GetBackendServiceOutlierDetectionInterval.fromMap((value as Map).cast<String, dynamic>()))).input(),
