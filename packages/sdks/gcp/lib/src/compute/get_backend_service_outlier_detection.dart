...
class GetBackendServiceOutlierDetection {
  ...
  /// 30000ms or 30s.
  final pulumi.Input<List<GetBackendServiceOutlierDetectionBaseEjectionTime>>
  baseEjectionTimes;
    ...
    return <String, dynamic>{
      'baseEjectionTimes':
          pulumi.Input.mapInputValue<
            List<GetBackendServiceOutlierDetectionBaseEjectionTime>,
      ...
      'intervals':
          pulumi.Input.mapInputValue<
            List<GetBackendServiceOutlierDetectionInterval>,
            List<Map<String, dynamic>>
          >(
            intervals,
            (value) =>
