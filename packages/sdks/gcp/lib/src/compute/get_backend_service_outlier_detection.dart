...
class GetBackendServiceOutlierDetection {
  ...
  /// 30000ms or 30s.
  final pulumi.Input<List<GetBackendServiceOutlierDetectionBaseEjectionTime>> baseEjectionTimes;
  ...
  final pulumi.Input<List<GetBackendServiceOutlierDetectionInterval>> intervals;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'baseEjectionTimes': pulumi.Input.mapInputValue<List<GetBackendServiceOutlierDetectionBaseEjectionTime>, List<Map<String, dynamic>>>(baseEjectionTimes, (value) => pulumi.Input.encodeList<GetBackendServiceOutlierDetectionBaseEjectionTime, Map<String, dynamic>>(value, (value) => value.toMap())),
      ...
      'intervals': pulumi.Input.mapInputValue<List<GetBackendServiceOutlierDetectionInterval>, List<Map<String, dynamic>>>(intervals, (value) => pulumi.Input.encodeList<GetBackendServiceOutlierDetectionInterval, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory GetBackendServiceOutlierDetection.fromMap(Map<String, dynamic> map) {
    return GetBackendServiceOutlierDetection(
      baseEjectionTimes: pulumi.Input.fromValue(pulumi.Input.decodeList<GetBackendServiceOutlierDetectionBaseEjectionTime>(map['baseEjectionTimes']!, (value) => GetBackendServiceOutlierDetectionBaseEjectionTime.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      intervals: pulumi.Input.fromValue(pulumi.Input.decodeList<GetBackendServiceOutlierDetectionInterval>(map['intervals']!, (value) => GetBackendServiceOutlierDetectionInterval.fromMap((value as Map).cast<String, dynamic>()))),
