...
class GetInstanceSchedulingGracefulShutdownMaxDuration {
  ...
  /// Creates a new [GetInstanceSchedulingGracefulShutdownMaxDuration].
  ...
  factory GetInstanceSchedulingGracefulShutdownMaxDuration.fromMap(
