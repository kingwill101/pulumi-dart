...
class GetInstanceGroupManagerStatusStateful {
  ...
  factory GetInstanceGroupManagerStatusStateful.fromMap(Map<String, dynamic> map) {
    return GetInstanceGroupManagerStatusStateful(
      ...
      perInstanceConfigs: (pulumi.Input.decodeList<GetInstanceGroupManagerStatusStatefulPerInstanceConfig>(map['perInstanceConfigs'], (value) => GetInstanceGroupManagerStatusStatefulPerInstanceConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
