...
import 'backend_bucket_iam_member_condition.dart';
import 'backend_bucket_iam_member_state.dart';
...
class BackendBucketIamMember extends pulumi.CustomResource {
  ...
  /// Creates a new [BackendBucketIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [BackendBucketIamMember]. {@macro pulumi_compute_backend_bucket_iam_member_backend_bucket_iam_member_args_doc}
  ...
  BackendBucketIamMember(
    ...
    condition = registerOutput<BackendBucketIamMemberCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return BackendBucketIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [BackendBucketIamMember] resource's state with the given [name] and [id].
  static BackendBucketIamMember get(
    String name,
    pulumi.Input<String> id, {
    BackendBucketIamMemberState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return BackendBucketIamMember._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [BackendBucketIamMember] resource.
  BackendBucketIamMember.reference(String urn)
    : super(
        'gcp:compute/backendBucketIamMember:BackendBucketIamMember',
