...
class RegionDiskIamBindingState {
  ...
  factory RegionDiskIamBindingState.fromMap(Map<String, dynamic> map) {
    return RegionDiskIamBindingState(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionDiskIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
