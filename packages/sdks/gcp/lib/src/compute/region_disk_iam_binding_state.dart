...
class RegionDiskIamBindingState {
  ...
  /// Creates a new [RegionDiskIamBindingState].
  /// [condition] Optional.
  ...
  RegionDiskIamBindingState({
    pulumi.Output<RegionDiskIamBindingCondition>? condition,
    ...
    pulumi.Output<String>? role,
      ...
      condition = pulumi.Input.asOptionalInput<RegionDiskIamBindingCondition>(condition),
  ...
  factory RegionDiskIamBindingState.fromMap(Map<String, dynamic> map) {
    return RegionDiskIamBindingState(
      condition: map['condition'] == null ? null : pulumi.Output.create<RegionDiskIamBindingCondition>(RegionDiskIamBindingCondition.fromMap((map['condition'] as Map).cast<String, dynamic>())),
