...
class RegionInstanceGroupManagerArgs {
  ...
  RegionInstanceGroupManagerArgs({
    ...
    required pulumi.Output<String> baseInstanceName,
    ...
    required pulumi.Output<List<RegionInstanceGroupManagerVersion>> versions,
    ...
    pulumi.Output<String>? waitForInstancesStatus,
      ...
      versions = pulumi.Input.asInput<List<RegionInstanceGroupManagerVersion>>(versions),
  ...
  factory RegionInstanceGroupManagerArgs.fromMap(Map<String, dynamic> map) {
    return RegionInstanceGroupManagerArgs(
      ...
      baseInstanceName: pulumi.Output.create<String>(map['baseInstanceName'] as String),
      ...
      versions: pulumi.Output.create<List<RegionInstanceGroupManagerVersion>>(pulumi.Input.decodeList<RegionInstanceGroupManagerVersion>(map['versions'], (value) => RegionInstanceGroupManagerVersion.fromMap((value as Map).cast<String, dynamic>()))),
