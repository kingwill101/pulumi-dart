...
class RegionInstanceTemplate extends pulumi.CustomResource {
  ...
  late final pulumi.Output<RegionInstanceTemplateAdvancedMachineFeatures?>
  ...
  late final pulumi.Output<RegionInstanceTemplateConfidentialInstanceConfig>
  ...
  late final pulumi.Output<RegionInstanceTemplateNetworkPerformanceConfig?>
  ...
  /// Structure is documented below.
  late final pulumi.Output<RegionInstanceTemplateReservationAffinity?>
  reservationAffinity;
  ...
  late final pulumi.Output<RegionInstanceTemplateServiceAccount?>
  serviceAccount;

  /// Enable [Shielded VM](https://cloud.google.com/security/shielded-cloud/shielded-vm) on this instance. Shielded VM provides verifiable integrity to prevent against malware and rootkits. Defaults to disabled. Structure is documented below.
  /// **Note**: `shielded_instance_config` can only be used with boot images with shielded vm support. See the complete list [here](https://cloud.google.com/compute/docs/images#shielded-images).
  late final pulumi.Output<RegionInstanceTemplateShieldedInstanceConfig>
