...
class ExternalVpnGateway extends pulumi.CustomResource {
  ...
  ExternalVpnGateway(
    ...
    this.interfaces = registerOutput<List<ExternalVpnGatewayInterface>?>('interfaces');
  ...
  /// Gets an existing [ExternalVpnGateway] resource's state with the given [name] and [id].
  static ExternalVpnGateway get(
    String name,
