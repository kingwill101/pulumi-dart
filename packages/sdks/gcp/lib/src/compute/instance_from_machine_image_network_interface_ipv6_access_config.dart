...
class InstanceFromMachineImageNetworkInterfaceIpv6AccessConfig {
  ...
  /// Creates a new [InstanceFromMachineImageNetworkInterfaceIpv6AccessConfig].
  ...
  const InstanceFromMachineImageNetworkInterfaceIpv6AccessConfig({
    this.externalIpv6,
  ...
  factory InstanceFromMachineImageNetworkInterfaceIpv6AccessConfig.fromMap(Map<String, dynamic> map) {
    return InstanceFromMachineImageNetworkInterfaceIpv6AccessConfig(
