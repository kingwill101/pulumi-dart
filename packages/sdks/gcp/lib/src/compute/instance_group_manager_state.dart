...
class InstanceGroupManagerState {
  ...
  InstanceGroupManagerState({
    ...
    pulumi.Output<List<InstanceGroupManagerStatus>>? statuses,
    ...
    pulumi.Output<String>? zone,
      ...
      statuses = pulumi.Input.asOptionalInput<List<InstanceGroupManagerStatus>>(statuses),
  ...
  factory InstanceGroupManagerState.fromMap(Map<String, dynamic> map) {
    return InstanceGroupManagerState(
      ...
      statuses: map['statuses'] == null ? null : pulumi.Output.create<List<InstanceGroupManagerStatus>>(pulumi.Input.decodeList<InstanceGroupManagerStatus>(map['statuses'], (value) => InstanceGroupManagerStatus.fromMap((value as Map).cast<String, dynamic>()))),
