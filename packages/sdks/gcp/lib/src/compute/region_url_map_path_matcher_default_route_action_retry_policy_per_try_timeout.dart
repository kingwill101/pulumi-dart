...
class RegionUrlMapPathMatcherDefaultRouteActionRetryPolicyPerTryTimeout {
  ...
  const RegionUrlMapPathMatcherDefaultRouteActionRetryPolicyPerTryTimeout({
    this.nanos,
    this.seconds,
  });
  ...
  factory RegionUrlMapPathMatcherDefaultRouteActionRetryPolicyPerTryTimeout.fromMap(Map<String, dynamic> map) {
