...
class HttpHealthCheckState {
  ...
  /// Creates a new [HttpHealthCheckState].
  ...
  factory HttpHealthCheckState.fromMap(Map<String, dynamic> map) {
    return HttpHealthCheckState(
