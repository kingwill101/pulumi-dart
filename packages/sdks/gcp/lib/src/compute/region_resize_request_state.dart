...
class RegionResizeRequestState {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'statuses':
          ?pulumi.Input.mapOptionalInputValue<
            List<RegionResizeRequestStatus>,
  ...
  factory RegionResizeRequestState.fromMap(Map<String, dynamic> map) {
    return RegionResizeRequestState(
      ...
      instanceGroupManager: (() {
        final guardedValue = map['instanceGroupManager'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      name: (() {
      ...
      statuses: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RegionResizeRequestStatus>(
            guardedValue,
            (value) => RegionResizeRequestStatus.fromMap(
