...
class NetworkFirewallPolicyWithRulesRuleMatch {
  ...
  final pulumi.Input<List<NetworkFirewallPolicyWithRulesRuleMatchLayer4Config>> layer4Configs;
  ...
  final pulumi.Input<List<NetworkFirewallPolicyWithRulesRuleMatchSrcSecureTag>>? srcSecureTags;
  /// Names of Network Threat Intelligence lists.
  ...
  const NetworkFirewallPolicyWithRulesRuleMatch({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'layer4Configs': pulumi.Input.mapInputValue<List<NetworkFirewallPolicyWithRulesRuleMatchLayer4Config>, List<Map<String, dynamic>>>(layer4Configs, (value) => pulumi.Input.encodeList<NetworkFirewallPolicyWithRulesRuleMatchLayer4Config, Map<String, dynamic>>(value, (value) => value.toMap())),
      ...
      'srcSecureTags': ?pulumi.Input.mapOptionalInputValue<List<NetworkFirewallPolicyWithRulesRuleMatchSrcSecureTag>, List<Map<String, dynamic>>>(srcSecureTags, (value) => pulumi.Input.encodeList<NetworkFirewallPolicyWithRulesRuleMatchSrcSecureTag, Map<String, dynamic>>(value, (value) => value.toMap())),
      'srcThreatIntelligences': ?srcThreatIntelligences,
    };
  }

  factory NetworkFirewallPolicyWithRulesRuleMatch.fromMap(Map<String, dynamic> map) {
    return NetworkFirewallPolicyWithRulesRuleMatch(
      ...
      layer4Configs: pulumi.Input.fromValue(pulumi.Input.decodeList<NetworkFirewallPolicyWithRulesRuleMatchLayer4Config>(map['layer4Configs']!, (value) => NetworkFirewallPolicyWithRulesRuleMatchLayer4Config.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      srcSecureTags: (() { final guardedValue = map['srcSecureTags']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NetworkFirewallPolicyWithRulesRuleMatchSrcSecureTag>(guardedValue, (value) => NetworkFirewallPolicyWithRulesRuleMatchSrcSecureTag.fromMap((value as Map).cast<String, dynamic>()))); })(),
