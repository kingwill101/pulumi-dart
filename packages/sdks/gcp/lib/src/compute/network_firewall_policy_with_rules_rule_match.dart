...
class NetworkFirewallPolicyWithRulesRuleMatch {
  ...
  final pulumi.Input<List<NetworkFirewallPolicyWithRulesRuleMatchLayer4Config>>
  layer4Configs;
  ...
  final pulumi.Input<List<NetworkFirewallPolicyWithRulesRuleMatchSrcSecureTag>>?
  srcSecureTags;
    ...
    return <String, dynamic>{
      ...
      'layer4Configs':
          pulumi.Input.mapInputValue<
            List<NetworkFirewallPolicyWithRulesRuleMatchLayer4Config>,
      ...
      'srcSecureTags':
          ?pulumi.Input.mapOptionalInputValue<
            List<NetworkFirewallPolicyWithRulesRuleMatchSrcSecureTag>,
            List<Map<String, dynamic>>
          >(
            srcSecureTags,
            (value) =>
