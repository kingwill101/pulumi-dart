...
class NetworkFirewallPolicyWithRulesRuleMatch {
  ...
  final List<NetworkFirewallPolicyWithRulesRuleMatchSrcSecureTag>? srcSecureTags;
  /// Names of Network Threat Intelligence lists.
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'layer4Configs': pulumi.Input.encodeList<NetworkFirewallPolicyWithRulesRuleMatchLayer4Config, Map<String, dynamic>>(layer4Configs, (value) => value.toMap()),
      ...
      'srcSecureTags': ?srcSecureTags == null ? null : pulumi.Input.encodeList<NetworkFirewallPolicyWithRulesRuleMatchSrcSecureTag, Map<String, dynamic>>(srcSecureTags!, (value) => value.toMap()),
  ...
  factory NetworkFirewallPolicyWithRulesRuleMatch.fromMap(Map<String, dynamic> map) {
    return NetworkFirewallPolicyWithRulesRuleMatch(
      ...
      destNetworkScope: map['destNetworkScope'] == null ? null : map['destNetworkScope'] as String,
      ...
      layer4Configs: pulumi.Input.decodeList<NetworkFirewallPolicyWithRulesRuleMatchLayer4Config>(map['layer4Configs'], (value) => NetworkFirewallPolicyWithRulesRuleMatchLayer4Config.fromMap((value as Map).cast<String, dynamic>())),
      ...
      srcNetworkScope: map['srcNetworkScope'] == null ? null : map['srcNetworkScope'] as String,
      srcNetworks: map['srcNetworks'] == null ? null : (map['srcNetworks'] as List).cast<String>(),
      srcRegionCodes: map['srcRegionCodes'] == null ? null : (map['srcRegionCodes'] as List).cast<String>(),
      srcSecureTags: map['srcSecureTags'] == null ? null : pulumi.Input.decodeList<NetworkFirewallPolicyWithRulesRuleMatchSrcSecureTag>(map['srcSecureTags'], (value) => NetworkFirewallPolicyWithRulesRuleMatchSrcSecureTag.fromMap((value as Map).cast<String, dynamic>())),
