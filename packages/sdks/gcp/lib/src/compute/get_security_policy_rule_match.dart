...
class GetSecurityPolicyRuleMatch {
  ...
  /// [configs] The configuration options available when specifying versioned_expr. This field must be specified if versionedExpr is specified and cannot be specified if versionedExpr is not specified.
  ...
  /// [versionedExpr] Predefined rule expression. If this field is specified, config must also be specified. Available options:   SRC_IPS_V1: Must specify the corresponding srcIpRanges field in config.
  ...
  factory GetSecurityPolicyRuleMatch.fromMap(Map<String, dynamic> map) {
    return GetSecurityPolicyRuleMatch(
      configs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetSecurityPolicyRuleMatchConfig>(map['configs']!, (value) => GetSecurityPolicyRuleMatchConfig.fromMap((value as Map).cast<String, dynamic>()))),
      exprOptions: pulumi.Input.fromValue(pulumi.Input.decodeList<GetSecurityPolicyRuleMatchExprOption>(map['exprOptions']!, (value) => GetSecurityPolicyRuleMatchExprOption.fromMap((value as Map).cast<String, dynamic>()))),
      exprs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetSecurityPolicyRuleMatchExpr>(map['exprs']!, (value) => GetSecurityPolicyRuleMatchExpr.fromMap((value as Map).cast<String, dynamic>()))),
