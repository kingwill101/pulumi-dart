    ...
    return <String, dynamic>{
      'configs':
          pulumi.Input.mapInputValue<
            List<GetSecurityPolicyRuleMatchConfig>,
      ...
      'exprOptions':
          pulumi.Input.mapInputValue<
            List<GetSecurityPolicyRuleMatchExprOption>,
            List<Map<String, dynamic>>
          >(
            exprOptions,
            (value) =>
      ...
      'exprs':
          pulumi.Input.mapInputValue<
            List<GetSecurityPolicyRuleMatchExpr>,
            List<Map<String, dynamic>>
          >(
            exprs,
            (value) =>
  ...
  factory GetSecurityPolicyRuleMatch.fromMap(Map<String, dynamic> map) {
    return GetSecurityPolicyRuleMatch(
      configs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetSecurityPolicyRuleMatchConfig>(
          map['configs']!,
      ...
      exprs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetSecurityPolicyRuleMatchExpr>(
          map['exprs']!,
