...
class BackendServiceIamBindingArgs {
  ...
  BackendServiceIamBindingArgs({
    pulumi.Output<BackendServiceIamBindingCondition>? condition,
    required pulumi.Output<List<String>> members,
    pulumi.Output<String>? name,
    pulumi.Output<String>? project,
    required pulumi.Output<String> role,
  }) :
      condition = pulumi.Input.asOptionalInput<BackendServiceIamBindingCondition>(condition),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'condition': ?pulumi.Input.mapOptionalInputValue<BackendServiceIamBindingCondition, Map<String, dynamic>>(condition, (value) => value.toMap()),
      'members': members,
      'name': ?name,
      'project': ?project,
      'role': role,
  ...
  factory BackendServiceIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return BackendServiceIamBindingArgs(
      condition: map['condition'] == null ? null : pulumi.Output.create<BackendServiceIamBindingCondition>(BackendServiceIamBindingCondition.fromMap((map['condition'] as Map).cast<String, dynamic>())),
