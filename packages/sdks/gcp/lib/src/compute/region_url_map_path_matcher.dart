...
class RegionUrlMapPathMatcher {
  ...
  final pulumi.Input<RegionUrlMapPathMatcherDefaultRouteAction>?
  defaultRouteAction;
  ...
  /// Structure is documented below.
  final pulumi.Input<RegionUrlMapPathMatcherDefaultUrlRedirect>?
  defaultUrlRedirect;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'pathRules':
          ?pulumi.Input.mapOptionalInputValue<
            List<RegionUrlMapPathMatcherPathRule>,
      ...
      'routeRules':
          ?pulumi.Input.mapOptionalInputValue<
            List<RegionUrlMapPathMatcherRouteRule>,
            List<Map<String, dynamic>>
          >(
            routeRules,
            (value) =>
