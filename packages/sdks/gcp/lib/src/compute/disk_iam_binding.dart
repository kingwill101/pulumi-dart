...
import 'disk_iam_binding_state.dart';
...
class DiskIamBinding extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [DiskIamBinding]. {@macro pulumi_compute_disk_iam_binding_disk_iam_binding_args_doc}
  ...
  DiskIamBinding(
    ...
    condition = registerOutput<DiskIamBindingCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return DiskIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [DiskIamBinding] resource's state with the given [name] and [id].
  static DiskIamBinding get(
    String name,
    pulumi.Input<String> id, {
    DiskIamBindingState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return DiskIamBinding._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [DiskIamBinding] resource.
  DiskIamBinding.reference(String urn)
    : super(
        'gcp:compute/diskIamBinding:DiskIamBinding',
