...
class GetSecurityPolicyRulePreconfiguredWafConfigExclusionRequestUri {
  ...
  const GetSecurityPolicyRulePreconfiguredWafConfigExclusionRequestUri({
  ...
  factory GetSecurityPolicyRulePreconfiguredWafConfigExclusionRequestUri.fromMap(Map<String, dynamic> map) {
