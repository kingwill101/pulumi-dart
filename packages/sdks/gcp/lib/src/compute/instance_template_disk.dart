...
class InstanceTemplateDisk {
  ...
  /// documented below.
  final InstanceTemplateDiskSourceSnapshotEncryptionKey? sourceSnapshotEncryptionKey;
  ...
  factory InstanceTemplateDisk.fromMap(Map<String, dynamic> map) {
    return InstanceTemplateDisk(
      ...
      diskEncryptionKey: map['diskEncryptionKey'] == null ? null : InstanceTemplateDiskDiskEncryptionKey.fromMap((map['diskEncryptionKey'] as Map).cast<String, dynamic>()),
      ...
      sourceImageEncryptionKey: map['sourceImageEncryptionKey'] == null ? null : InstanceTemplateDiskSourceImageEncryptionKey.fromMap((map['sourceImageEncryptionKey'] as Map).cast<String, dynamic>()),
      sourceSnapshot: map['sourceSnapshot'] == null ? null : map['sourceSnapshot'] as String,
      sourceSnapshotEncryptionKey: map['sourceSnapshotEncryptionKey'] == null ? null : InstanceTemplateDiskSourceSnapshotEncryptionKey.fromMap((map['sourceSnapshotEncryptionKey'] as Map).cast<String, dynamic>()),
