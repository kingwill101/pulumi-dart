...
class RegionUrlMapPathMatcherPathRuleRouteActionRetryPolicy {
  ...
  const RegionUrlMapPathMatcherPathRuleRouteActionRetryPolicy({
    this.numRetries,
    this.perTryTimeout,
  ...
  factory RegionUrlMapPathMatcherPathRuleRouteActionRetryPolicy.fromMap(Map<String, dynamic> map) {
    return RegionUrlMapPathMatcherPathRuleRouteActionRetryPolicy(
      ...
      perTryTimeout: (() { final guardedValue = map['perTryTimeout']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionUrlMapPathMatcherPathRuleRouteActionRetryPolicyPerTryTimeout.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
