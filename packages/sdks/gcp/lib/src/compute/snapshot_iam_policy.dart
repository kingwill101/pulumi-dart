...
import 'snapshot_iam_policy_state.dart';
...
class SnapshotIamPolicy extends pulumi.CustomResource {
  ...
  /// Gets an existing [SnapshotIamPolicy] resource's state with the given [name] and [id].
  static SnapshotIamPolicy get(
    String name,
    pulumi.Input<String> id, {
    SnapshotIamPolicyState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return SnapshotIamPolicy._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [SnapshotIamPolicy] resource.
  SnapshotIamPolicy.reference(String urn)
    : super(
        'gcp:compute/snapshotIamPolicy:SnapshotIamPolicy',
