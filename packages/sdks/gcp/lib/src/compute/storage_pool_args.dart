...
class StoragePoolArgs {
  ...
  factory StoragePoolArgs.fromMap(Map<String, dynamic> map) {
    return StoragePoolArgs(
      ...
      poolProvisionedCapacityGb: pulumi.Input.fromValue(
        map['poolProvisionedCapacityGb'] as String,
      ),
      poolProvisionedIops: (() {
      ...
      poolProvisionedThroughput: pulumi.Input.fromValue(
        map['poolProvisionedThroughput'] as String,
      ),
      project: (() {
