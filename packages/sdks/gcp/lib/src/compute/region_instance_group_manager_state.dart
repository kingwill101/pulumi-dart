...
class RegionInstanceGroupManagerState {
  ...
  RegionInstanceGroupManagerState({
    pulumi.Output<RegionInstanceGroupManagerAllInstancesConfig>? allInstancesConfig,
    pulumi.Output<RegionInstanceGroupManagerAutoHealingPolicies>? autoHealingPolicies,
    pulumi.Output<String>? baseInstanceName,
    pulumi.Output<String>? creationTimestamp,
    pulumi.Output<String>? description,
    pulumi.Output<String>? distributionPolicyTargetShape,
    pulumi.Output<List<String>>? distributionPolicyZones,
    pulumi.Output<String>? fingerprint,
    pulumi.Output<RegionInstanceGroupManagerInstanceFlexibilityPolicy>? instanceFlexibilityPolicy,
    pulumi.Output<String>? instanceGroup,
    pulumi.Output<int>? instanceGroupManagerId,
    pulumi.Output<RegionInstanceGroupManagerInstanceLifecyclePolicy>? instanceLifecyclePolicy,
    pulumi.Output<String>? listManagedInstancesResults,
    pulumi.Output<String>? name,
    pulumi.Output<List<RegionInstanceGroupManagerNamedPort>>? namedPorts,
    pulumi.Output<RegionInstanceGroupManagerParams>? params,
    pulumi.Output<String>? project,
    pulumi.Output<String>? region,
    pulumi.Output<String>? selfLink,
    pulumi.Output<RegionInstanceGroupManagerStandbyPolicy>? standbyPolicy,
    pulumi.Output<List<RegionInstanceGroupManagerStatefulDisk>>? statefulDisks,
    pulumi.Output<List<RegionInstanceGroupManagerStatefulExternalIp>>? statefulExternalIps,
    pulumi.Output<List<RegionInstanceGroupManagerStatefulInternalIp>>? statefulInternalIps,
    pulumi.Output<List<RegionInstanceGroupManagerStatus>>? statuses,
    pulumi.Output<List<String>>? targetPools,
    pulumi.Output<int>? targetSize,
    pulumi.Output<int>? targetStoppedSize,
    pulumi.Output<int>? targetSuspendedSize,
    pulumi.Output<RegionInstanceGroupManagerUpdatePolicy>? updatePolicy,
    pulumi.Output<List<RegionInstanceGroupManagerVersion>>? versions,
    pulumi.Output<bool>? waitForInstances,
    pulumi.Output<String>? waitForInstancesStatus,
  }) :
      allInstancesConfig = pulumi.Input.asOptionalInput<RegionInstanceGroupManagerAllInstancesConfig>(allInstancesConfig),
      autoHealingPolicies = pulumi.Input.asOptionalInput<RegionInstanceGroupManagerAutoHealingPolicies>(autoHealingPolicies),
      baseInstanceName = pulumi.Input.asOptionalInput<String>(baseInstanceName),
      creationTimestamp = pulumi.Input.asOptionalInput<String>(creationTimestamp),
      description = pulumi.Input.asOptionalInput<String>(description),
      distributionPolicyTargetShape = pulumi.Input.asOptionalInput<String>(distributionPolicyTargetShape),
      distributionPolicyZones = pulumi.Input.asOptionalInput<List<String>>(distributionPolicyZones),
      fingerprint = pulumi.Input.asOptionalInput<String>(fingerprint),
      instanceFlexibilityPolicy = pulumi.Input.asOptionalInput<RegionInstanceGroupManagerInstanceFlexibilityPolicy>(instanceFlexibilityPolicy),
      instanceGroup = pulumi.Input.asOptionalInput<String>(instanceGroup),
      instanceGroupManagerId = pulumi.Input.asOptionalInput<int>(instanceGroupManagerId),
      instanceLifecyclePolicy = pulumi.Input.asOptionalInput<RegionInstanceGroupManagerInstanceLifecyclePolicy>(instanceLifecyclePolicy),
      listManagedInstancesResults = pulumi.Input.asOptionalInput<String>(listManagedInstancesResults),
      name = pulumi.Input.asOptionalInput<String>(name),
      namedPorts = pulumi.Input.asOptionalInput<List<RegionInstanceGroupManagerNamedPort>>(namedPorts),
      params = pulumi.Input.asOptionalInput<RegionInstanceGroupManagerParams>(params),
      project = pulumi.Input.asOptionalInput<String>(project),
      region = pulumi.Input.asOptionalInput<String>(region),
      selfLink = pulumi.Input.asOptionalInput<String>(selfLink),
      standbyPolicy = pulumi.Input.asOptionalInput<RegionInstanceGroupManagerStandbyPolicy>(standbyPolicy),
      statefulDisks = pulumi.Input.asOptionalInput<List<RegionInstanceGroupManagerStatefulDisk>>(statefulDisks),
      statefulExternalIps = pulumi.Input.asOptionalInput<List<RegionInstanceGroupManagerStatefulExternalIp>>(statefulExternalIps),
      statefulInternalIps = pulumi.Input.asOptionalInput<List<RegionInstanceGroupManagerStatefulInternalIp>>(statefulInternalIps),
      statuses = pulumi.Input.asOptionalInput<List<RegionInstanceGroupManagerStatus>>(statuses),
      ...
      targetSuspendedSize = pulumi.Input.asOptionalInput<int>(targetSuspendedSize),
      updatePolicy = pulumi.Input.asOptionalInput<RegionInstanceGroupManagerUpdatePolicy>(updatePolicy),
      versions = pulumi.Input.asOptionalInput<List<RegionInstanceGroupManagerVersion>>(versions),
      waitForInstances = pulumi.Input.asOptionalInput<bool>(waitForInstances),
      waitForInstancesStatus = pulumi.Input.asOptionalInput<String>(waitForInstancesStatus);
  ...
  factory RegionInstanceGroupManagerState.fromMap(Map<String, dynamic> map) {
    return RegionInstanceGroupManagerState(
      allInstancesConfig: map['allInstancesConfig'] == null ? null : pulumi.Output.create<RegionInstanceGroupManagerAllInstancesConfig>(RegionInstanceGroupManagerAllInstancesConfig.fromMap((map['allInstancesConfig'] as Map).cast<String, dynamic>())),
      autoHealingPolicies: map['autoHealingPolicies'] == null ? null : pulumi.Output.create<RegionInstanceGroupManagerAutoHealingPolicies>(RegionInstanceGroupManagerAutoHealingPolicies.fromMap((map['autoHealingPolicies'] as Map).cast<String, dynamic>())),
      baseInstanceName: map['baseInstanceName'] == null ? null : pulumi.Output.create<String>(map['baseInstanceName'] as String),
      creationTimestamp: map['creationTimestamp'] == null ? null : pulumi.Output.create<String>(map['creationTimestamp'] as String),
      description: map['description'] == null ? null : pulumi.Output.create<String>(map['description'] as String),
      distributionPolicyTargetShape: map['distributionPolicyTargetShape'] == null ? null : pulumi.Output.create<String>(map['distributionPolicyTargetShape'] as String),
      distributionPolicyZones: map['distributionPolicyZones'] == null ? null : pulumi.Output.create<List<String>>((map['distributionPolicyZones'] as List).cast<String>()),
      fingerprint: map['fingerprint'] == null ? null : pulumi.Output.create<String>(map['fingerprint'] as String),
      instanceFlexibilityPolicy: map['instanceFlexibilityPolicy'] == null ? null : pulumi.Output.create<RegionInstanceGroupManagerInstanceFlexibilityPolicy>(RegionInstanceGroupManagerInstanceFlexibilityPolicy.fromMap((map['instanceFlexibilityPolicy'] as Map).cast<String, dynamic>())),
      instanceGroup: map['instanceGroup'] == null ? null : pulumi.Output.create<String>(map['instanceGroup'] as String),
      instanceGroupManagerId: map['instanceGroupManagerId'] == null ? null : pulumi.Output.create<int>(map['instanceGroupManagerId'] as int),
      instanceLifecyclePolicy: map['instanceLifecyclePolicy'] == null ? null : pulumi.Output.create<RegionInstanceGroupManagerInstanceLifecyclePolicy>(RegionInstanceGroupManagerInstanceLifecyclePolicy.fromMap((map['instanceLifecyclePolicy'] as Map).cast<String, dynamic>())),
      listManagedInstancesResults: map['listManagedInstancesResults'] == null ? null : pulumi.Output.create<String>(map['listManagedInstancesResults'] as String),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      namedPorts: map['namedPorts'] == null ? null : pulumi.Output.create<List<RegionInstanceGroupManagerNamedPort>>(pulumi.Input.decodeList<RegionInstanceGroupManagerNamedPort>(map['namedPorts'], (value) => RegionInstanceGroupManagerNamedPort.fromMap((value as Map).cast<String, dynamic>()))),
      params: map['params'] == null ? null : pulumi.Output.create<RegionInstanceGroupManagerParams>(RegionInstanceGroupManagerParams.fromMap((map['params'] as Map).cast<String, dynamic>())),
      project: map['project'] == null ? null : pulumi.Output.create<String>(map['project'] as String),
      region: map['region'] == null ? null : pulumi.Output.create<String>(map['region'] as String),
      selfLink: map['selfLink'] == null ? null : pulumi.Output.create<String>(map['selfLink'] as String),
      standbyPolicy: map['standbyPolicy'] == null ? null : pulumi.Output.create<RegionInstanceGroupManagerStandbyPolicy>(RegionInstanceGroupManagerStandbyPolicy.fromMap((map['standbyPolicy'] as Map).cast<String, dynamic>())),
      statefulDisks: map['statefulDisks'] == null ? null : pulumi.Output.create<List<RegionInstanceGroupManagerStatefulDisk>>(pulumi.Input.decodeList<RegionInstanceGroupManagerStatefulDisk>(map['statefulDisks'], (value) => RegionInstanceGroupManagerStatefulDisk.fromMap((value as Map).cast<String, dynamic>()))),
      statefulExternalIps: map['statefulExternalIps'] == null ? null : pulumi.Output.create<List<RegionInstanceGroupManagerStatefulExternalIp>>(pulumi.Input.decodeList<RegionInstanceGroupManagerStatefulExternalIp>(map['statefulExternalIps'], (value) => RegionInstanceGroupManagerStatefulExternalIp.fromMap((value as Map).cast<String, dynamic>()))),
      statefulInternalIps: map['statefulInternalIps'] == null ? null : pulumi.Output.create<List<RegionInstanceGroupManagerStatefulInternalIp>>(pulumi.Input.decodeList<RegionInstanceGroupManagerStatefulInternalIp>(map['statefulInternalIps'], (value) => RegionInstanceGroupManagerStatefulInternalIp.fromMap((value as Map).cast<String, dynamic>()))),
      statuses: map['statuses'] == null ? null : pulumi.Output.create<List<RegionInstanceGroupManagerStatus>>(pulumi.Input.decodeList<RegionInstanceGroupManagerStatus>(map['statuses'], (value) => RegionInstanceGroupManagerStatus.fromMap((value as Map).cast<String, dynamic>()))),
      targetPools: map['targetPools'] == null ? null : pulumi.Output.create<List<String>>((map['targetPools'] as List).cast<String>()),
      targetSize: map['targetSize'] == null ? null : pulumi.Output.create<int>(map['targetSize'] as int),
      targetStoppedSize: map['targetStoppedSize'] == null ? null : pulumi.Output.create<int>(map['targetStoppedSize'] as int),
      targetSuspendedSize: map['targetSuspendedSize'] == null ? null : pulumi.Output.create<int>(map['targetSuspendedSize'] as int),
      updatePolicy: map['updatePolicy'] == null ? null : pulumi.Output.create<RegionInstanceGroupManagerUpdatePolicy>(RegionInstanceGroupManagerUpdatePolicy.fromMap((map['updatePolicy'] as Map).cast<String, dynamic>())),
      versions: map['versions'] == null ? null : pulumi.Output.create<List<RegionInstanceGroupManagerVersion>>(pulumi.Input.decodeList<RegionInstanceGroupManagerVersion>(map['versions'], (value) => RegionInstanceGroupManagerVersion.fromMap((value as Map).cast<String, dynamic>()))),
      waitForInstances: map['waitForInstances'] == null ? null : pulumi.Output.create<bool>(map['waitForInstances'] as bool),
      waitForInstancesStatus: map['waitForInstancesStatus'] == null ? null : pulumi.Output.create<String>(map['waitForInstancesStatus'] as String),
    );
  }
}
