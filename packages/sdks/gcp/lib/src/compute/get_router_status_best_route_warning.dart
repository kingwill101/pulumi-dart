...
class GetRouterStatusBestRouteWarning {
  ...
  const GetRouterStatusBestRouteWarning({
    required this.code,
    required this.datas,
  ...
  factory GetRouterStatusBestRouteWarning.fromMap(Map<String, dynamic> map) {
    return GetRouterStatusBestRouteWarning(
      ...
      datas: pulumi.Input.fromValue(pulumi.Input.decodeList<GetRouterStatusBestRouteWarningData>(map['datas']!, (value) => GetRouterStatusBestRouteWarningData.fromMap((value as Map).cast<String, dynamic>()))),
