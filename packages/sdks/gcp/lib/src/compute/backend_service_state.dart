...
class BackendServiceState {
  ...
  BackendServiceState({
    ...
    pulumi.Output<List<BackendServiceBackend>>? backends,
    pulumi.Output<BackendServiceCdnPolicy>? cdnPolicy,
    pulumi.Output<BackendServiceCircuitBreakers>? circuitBreakers,
    pulumi.Output<String>? compressionMode,
    pulumi.Output<int>? connectionDrainingTimeoutSec,
    pulumi.Output<BackendServiceConsistentHash>? consistentHash,
    pulumi.Output<String>? creationTimestamp,
    pulumi.Output<List<BackendServiceCustomMetric>>? customMetrics,
    pulumi.Output<List<String>>? customRequestHeaders,
    pulumi.Output<List<String>>? customResponseHeaders,
    pulumi.Output<String>? description,
    pulumi.Output<BackendServiceDynamicForwarding>? dynamicForwarding,
    pulumi.Output<String>? edgeSecurityPolicy,
    pulumi.Output<bool>? enableCdn,
    pulumi.Output<String>? externalManagedMigrationState,
    pulumi.Output<double>? externalManagedMigrationTestingPercentage,
    ...
    pulumi.Output<String>? ipAddressSelectionPolicy,
    pulumi.Output<String>? loadBalancingScheme,
    pulumi.Output<List<BackendServiceLocalityLbPolicy>>? localityLbPolicies,
    pulumi.Output<String>? localityLbPolicy,
    pulumi.Output<BackendServiceLogConfig>? logConfig,
    pulumi.Output<BackendServiceMaxStreamDuration>? maxStreamDuration,
    pulumi.Output<String>? name,
    pulumi.Output<BackendServiceNetworkPassThroughLbTrafficPolicy>? networkPassThroughLbTrafficPolicy,
    pulumi.Output<BackendServiceOutlierDetection>? outlierDetection,
    pulumi.Output<BackendServiceParams>? params,
    pulumi.Output<String>? portName,
    pulumi.Output<String>? project,
    pulumi.Output<String>? protocol,
    pulumi.Output<String>? securityPolicy,
    pulumi.Output<BackendServiceSecuritySettings>? securitySettings,
    pulumi.Output<String>? selfLink,
    pulumi.Output<String>? serviceLbPolicy,
    pulumi.Output<String>? sessionAffinity,
    pulumi.Output<BackendServiceStrongSessionAffinityCookie>? strongSessionAffinityCookie,
    pulumi.Output<int>? timeoutSec,
    pulumi.Output<BackendServiceTlsSettings>? tlsSettings,
  }) :
      affinityCookieTtlSec = pulumi.Input.asOptionalInput<int>(affinityCookieTtlSec),
      backends = pulumi.Input.asOptionalInput<List<BackendServiceBackend>>(backends),
      cdnPolicy = pulumi.Input.asOptionalInput<BackendServiceCdnPolicy>(cdnPolicy),
      circuitBreakers = pulumi.Input.asOptionalInput<BackendServiceCircuitBreakers>(circuitBreakers),
      ...
      consistentHash = pulumi.Input.asOptionalInput<BackendServiceConsistentHash>(consistentHash),
      creationTimestamp = pulumi.Input.asOptionalInput<String>(creationTimestamp),
      customMetrics = pulumi.Input.asOptionalInput<List<BackendServiceCustomMetric>>(customMetrics),
      ...
      dynamicForwarding = pulumi.Input.asOptionalInput<BackendServiceDynamicForwarding>(dynamicForwarding),
      ...
      externalManagedMigrationState = pulumi.Input.asOptionalInput<String>(externalManagedMigrationState),
      externalManagedMigrationTestingPercentage = pulumi.Input.asOptionalInput<double>(externalManagedMigrationTestingPercentage),
      ...
      localityLbPolicies = pulumi.Input.asOptionalInput<List<BackendServiceLocalityLbPolicy>>(localityLbPolicies),
      ...
      maxStreamDuration = pulumi.Input.asOptionalInput<BackendServiceMaxStreamDuration>(maxStreamDuration),
      name = pulumi.Input.asOptionalInput<String>(name),
      networkPassThroughLbTrafficPolicy = pulumi.Input.asOptionalInput<BackendServiceNetworkPassThroughLbTrafficPolicy>(networkPassThroughLbTrafficPolicy),
      outlierDetection = pulumi.Input.asOptionalInput<BackendServiceOutlierDetection>(outlierDetection),
      params = pulumi.Input.asOptionalInput<BackendServiceParams>(params),
      ...
      securitySettings = pulumi.Input.asOptionalInput<BackendServiceSecuritySettings>(securitySettings),
      ...
      strongSessionAffinityCookie = pulumi.Input.asOptionalInput<BackendServiceStrongSessionAffinityCookie>(strongSessionAffinityCookie),
      timeoutSec = pulumi.Input.asOptionalInput<int>(timeoutSec),
      tlsSettings = pulumi.Input.asOptionalInput<BackendServiceTlsSettings>(tlsSettings);
  ...
  factory BackendServiceState.fromMap(Map<String, dynamic> map) {
    return BackendServiceState(
      ...
      backends: map['backends'] == null ? null : pulumi.Output.create<List<BackendServiceBackend>>(pulumi.Input.decodeList<BackendServiceBackend>(map['backends'], (value) => BackendServiceBackend.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      circuitBreakers: map['circuitBreakers'] == null ? null : pulumi.Output.create<BackendServiceCircuitBreakers>(BackendServiceCircuitBreakers.fromMap((map['circuitBreakers'] as Map).cast<String, dynamic>())),
      compressionMode: map['compressionMode'] == null ? null : pulumi.Output.create<String>(map['compressionMode'] as String),
      connectionDrainingTimeoutSec: map['connectionDrainingTimeoutSec'] == null ? null : pulumi.Output.create<int>(map['connectionDrainingTimeoutSec'] as int),
      consistentHash: map['consistentHash'] == null ? null : pulumi.Output.create<BackendServiceConsistentHash>(BackendServiceConsistentHash.fromMap((map['consistentHash'] as Map).cast<String, dynamic>())),
      creationTimestamp: map['creationTimestamp'] == null ? null : pulumi.Output.create<String>(map['creationTimestamp'] as String),
      customMetrics: map['customMetrics'] == null ? null : pulumi.Output.create<List<BackendServiceCustomMetric>>(pulumi.Input.decodeList<BackendServiceCustomMetric>(map['customMetrics'], (value) => BackendServiceCustomMetric.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      dynamicForwarding: map['dynamicForwarding'] == null ? null : pulumi.Output.create<BackendServiceDynamicForwarding>(BackendServiceDynamicForwarding.fromMap((map['dynamicForwarding'] as Map).cast<String, dynamic>())),
      ...
      externalManagedMigrationState: map['externalManagedMigrationState'] == null ? null : pulumi.Output.create<String>(map['externalManagedMigrationState'] as String),
      externalManagedMigrationTestingPercentage: map['externalManagedMigrationTestingPercentage'] == null ? null : pulumi.Output.create<double>(map['externalManagedMigrationTestingPercentage'] as double),
      ...
      ipAddressSelectionPolicy: map['ipAddressSelectionPolicy'] == null ? null : pulumi.Output.create<String>(map['ipAddressSelectionPolicy'] as String),
      loadBalancingScheme: map['loadBalancingScheme'] == null ? null : pulumi.Output.create<String>(map['loadBalancingScheme'] as String),
      localityLbPolicies: map['localityLbPolicies'] == null ? null : pulumi.Output.create<List<BackendServiceLocalityLbPolicy>>(pulumi.Input.decodeList<BackendServiceLocalityLbPolicy>(map['localityLbPolicies'], (value) => BackendServiceLocalityLbPolicy.fromMap((value as Map).cast<String, dynamic>()))),
      localityLbPolicy: map['localityLbPolicy'] == null ? null : pulumi.Output.create<String>(map['localityLbPolicy'] as String),
      ...
      maxStreamDuration: map['maxStreamDuration'] == null ? null : pulumi.Output.create<BackendServiceMaxStreamDuration>(BackendServiceMaxStreamDuration.fromMap((map['maxStreamDuration'] as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      networkPassThroughLbTrafficPolicy: map['networkPassThroughLbTrafficPolicy'] == null ? null : pulumi.Output.create<BackendServiceNetworkPassThroughLbTrafficPolicy>(BackendServiceNetworkPassThroughLbTrafficPolicy.fromMap((map['networkPassThroughLbTrafficPolicy'] as Map).cast<String, dynamic>())),
      outlierDetection: map['outlierDetection'] == null ? null : pulumi.Output.create<BackendServiceOutlierDetection>(BackendServiceOutlierDetection.fromMap((map['outlierDetection'] as Map).cast<String, dynamic>())),
      params: map['params'] == null ? null : pulumi.Output.create<BackendServiceParams>(BackendServiceParams.fromMap((map['params'] as Map).cast<String, dynamic>())),
      ...
      securitySettings: map['securitySettings'] == null ? null : pulumi.Output.create<BackendServiceSecuritySettings>(BackendServiceSecuritySettings.fromMap((map['securitySettings'] as Map).cast<String, dynamic>())),
      ...
      strongSessionAffinityCookie: map['strongSessionAffinityCookie'] == null ? null : pulumi.Output.create<BackendServiceStrongSessionAffinityCookie>(BackendServiceStrongSessionAffinityCookie.fromMap((map['strongSessionAffinityCookie'] as Map).cast<String, dynamic>())),
      timeoutSec: map['timeoutSec'] == null ? null : pulumi.Output.create<int>(map['timeoutSec'] as int),
      tlsSettings: map['tlsSettings'] == null ? null : pulumi.Output.create<BackendServiceTlsSettings>(BackendServiceTlsSettings.fromMap((map['tlsSettings'] as Map).cast<String, dynamic>())),
    );
  }
}
