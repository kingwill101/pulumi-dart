...
class URLMapPathMatcherRouteRuleMatchRule {
  ...
  final pulumi.Input<List<URLMapPathMatcherRouteRuleMatchRuleHeaderMatch>>?
  headerMatches;
  ...
  /// Structure is documented below.
  final pulumi.Input<List<URLMapPathMatcherRouteRuleMatchRuleMetadataFilter>>?
  metadataFilters;
  ...
  /// Structure is documented below.
  final pulumi.Input<
    List<URLMapPathMatcherRouteRuleMatchRuleQueryParameterMatch>
  >?
    ...
    return <String, dynamic>{
      ...
      'headerMatches':
          ?pulumi.Input.mapOptionalInputValue<
            List<URLMapPathMatcherRouteRuleMatchRuleHeaderMatch>,
      ...
      'metadataFilters':
          ?pulumi.Input.mapOptionalInputValue<
            List<URLMapPathMatcherRouteRuleMatchRuleMetadataFilter>,
            List<Map<String, dynamic>>
          >(
            metadataFilters,
            (value) =>
