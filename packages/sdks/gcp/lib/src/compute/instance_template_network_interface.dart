...
import 'instance_template_network_interface_alias_ipv6_range.dart';
...
class InstanceTemplateNetworkInterface {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'aliasIpv6Ranges': ?pulumi.Input.mapOptionalInputValue<List<InstanceTemplateNetworkInterfaceAliasIpv6Range>, List<Map<String, dynamic>>>(aliasIpv6Ranges, (value) => pulumi.Input.encodeList<InstanceTemplateNetworkInterfaceAliasIpv6Range, Map<String, dynamic>>(value, (value) => value.toMap())),
      'igmpQuery': ?igmpQuery,
  ...
  factory InstanceTemplateNetworkInterface.fromMap(Map<String, dynamic> map) {
    return InstanceTemplateNetworkInterface(
      accessConfigs: (() { final guardedValue = map['accessConfigs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InstanceTemplateNetworkInterfaceAccessConfig>(guardedValue, (value) => InstanceTemplateNetworkInterfaceAccessConfig.fromMap((value as Map).cast<String, dynamic>()))); })(),
