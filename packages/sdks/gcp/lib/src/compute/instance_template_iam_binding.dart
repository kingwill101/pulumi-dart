...
import 'instance_template_iam_binding_condition.dart';
import 'instance_template_iam_binding_state.dart';
...
class InstanceTemplateIamBinding extends pulumi.CustomResource {
  ...
  late final pulumi.Output<InstanceTemplateIamBindingCondition?> condition;
  ...
  /// Creates a new [InstanceTemplateIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [InstanceTemplateIamBinding]. {@macro pulumi_compute_instance_template_iam_binding_instance_template_iam_binding_args_doc}
  ...
  InstanceTemplateIamBinding(
    ...
    condition = registerOutput<InstanceTemplateIamBindingCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return InstanceTemplateIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [InstanceTemplateIamBinding] resource's state with the given [name] and [id].
  static InstanceTemplateIamBinding get(
    String name,
    pulumi.Input<String> id, {
    InstanceTemplateIamBindingState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return InstanceTemplateIamBinding._get(
      name,
      state: state?.toMap(),
  ...
  InstanceTemplateIamBinding._get(
    String name, {
  ...
  /// Creates a typed reference to an existing [InstanceTemplateIamBinding] resource.
  InstanceTemplateIamBinding.reference(String urn)
    : super(
        'gcp:compute/instanceTemplateIamBinding:InstanceTemplateIamBinding',
