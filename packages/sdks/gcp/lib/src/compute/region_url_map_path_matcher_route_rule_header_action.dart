...
class RegionUrlMapPathMatcherRouteRuleHeaderAction {
  ...
  const RegionUrlMapPathMatcherRouteRuleHeaderAction({
  ...
  factory RegionUrlMapPathMatcherRouteRuleHeaderAction.fromMap(Map<String, dynamic> map) {
    return RegionUrlMapPathMatcherRouteRuleHeaderAction(
      requestHeadersToAdds: (() { final guardedValue = map['requestHeadersToAdds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RegionUrlMapPathMatcherRouteRuleHeaderActionRequestHeadersToAdd>(guardedValue, (value) => RegionUrlMapPathMatcherRouteRuleHeaderActionRequestHeadersToAdd.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      responseHeadersToAdds: (() { final guardedValue = map['responseHeadersToAdds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RegionUrlMapPathMatcherRouteRuleHeaderActionResponseHeadersToAdd>(guardedValue, (value) => RegionUrlMapPathMatcherRouteRuleHeaderActionResponseHeadersToAdd.fromMap((value as Map).cast<String, dynamic>()))); })(),
