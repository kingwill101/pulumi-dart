...
class RegionInstantSnapshotIamMemberState {
  ...
  /// Creates a new [RegionInstantSnapshotIamMemberState].
  ...
  const RegionInstantSnapshotIamMemberState({
    this.condition,
    this.etag,
    this.member,
    this.name,
  ...
  factory RegionInstantSnapshotIamMemberState.fromMap(Map<String, dynamic> map) {
    return RegionInstantSnapshotIamMemberState(
