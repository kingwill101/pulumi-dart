...
class RegionUrlMapPathMatcherRouteRuleUrlRedirect {
  ...
  /// Creates a new [RegionUrlMapPathMatcherRouteRuleUrlRedirect].
  ...
  factory RegionUrlMapPathMatcherRouteRuleUrlRedirect.fromMap(
