...
class GetSecurityPolicyRuleMatchExprOption {
  ...
  final pulumi.Input<List<GetSecurityPolicyRuleMatchExprOptionRecaptchaOption>>
  recaptchaOptions;
  ...
  GetSecurityPolicyRuleMatchExprOption({required this.recaptchaOptions});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'recaptchaOptions':
          pulumi.Input.mapInputValue<
            List<GetSecurityPolicyRuleMatchExprOptionRecaptchaOption>,
