...
class URLMapPathMatcherRouteRuleMatchRuleHeaderMatch {
  ...
  final pulumi.Input<URLMapPathMatcherRouteRuleMatchRuleHeaderMatchRangeMatch>?
  rangeMatch;
  ...
  factory URLMapPathMatcherRouteRuleMatchRuleHeaderMatch.fromMap(
    ...
    return URLMapPathMatcherRouteRuleMatchRuleHeaderMatch(
      ...
      rangeMatch: (() {
        ...
        return pulumi.Input.fromValue(
          URLMapPathMatcherRouteRuleMatchRuleHeaderMatchRangeMatch.fromMap(
