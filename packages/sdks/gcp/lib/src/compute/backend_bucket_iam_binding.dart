...
import 'backend_bucket_iam_binding_state.dart';
...
class BackendBucketIamBinding extends pulumi.CustomResource {
  ...
  /// Creates a new [BackendBucketIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [BackendBucketIamBinding]. {@macro pulumi_compute_backend_bucket_iam_binding_backend_bucket_iam_binding_args_doc}
  ...
  BackendBucketIamBinding(
    ...
    condition = registerOutput<BackendBucketIamBindingCondition?>(
      'condition',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return BackendBucketIamBindingCondition.fromMap(
  ...
  /// Gets an existing [BackendBucketIamBinding] resource's state with the given [name] and [id].
  static BackendBucketIamBinding get(
    String name,
