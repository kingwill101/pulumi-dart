  ...
  factory VPNTunnelArgs.fromMap(Map<String, dynamic> map) {
    return VPNTunnelArgs(
      ...
      localTrafficSelectors: (() {
        final guardedValue = map['localTrafficSelectors'];
        if (guardedValue == null) return null;
      ...
      remoteTrafficSelectors: (() {
        final guardedValue = map['remoteTrafficSelectors'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      router: (() {
      ...
      sharedSecretWo: (() {
        final guardedValue = map['sharedSecretWo'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      sharedSecretWoVersion: (() {
        final guardedValue = map['sharedSecretWoVersion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      targetVpnGateway: (() {
