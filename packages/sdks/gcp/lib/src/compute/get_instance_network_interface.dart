...
class GetInstanceNetworkInterface {
  ...
  factory GetInstanceNetworkInterface.fromMap(Map<String, dynamic> map) {
    return GetInstanceNetworkInterface(
      accessConfigs: (pulumi.Input.decodeList<GetInstanceNetworkInterfaceAccessConfig>(map['accessConfigs'], (value) => GetInstanceNetworkInterfaceAccessConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
      aliasIpRanges: (pulumi.Input.decodeList<GetInstanceNetworkInterfaceAliasIpRange>(map['aliasIpRanges'], (value) => GetInstanceNetworkInterfaceAliasIpRange.fromMap((value as Map).cast<String, dynamic>()))).input(),
      igmpQuery: (map['igmpQuery'] as String).input(),
      internalIpv6PrefixLength: (map['internalIpv6PrefixLength'] as int).input(),
      ipv6AccessConfigs: (pulumi.Input.decodeList<GetInstanceNetworkInterfaceIpv6AccessConfig>(map['ipv6AccessConfigs'], (value) => GetInstanceNetworkInterfaceIpv6AccessConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
