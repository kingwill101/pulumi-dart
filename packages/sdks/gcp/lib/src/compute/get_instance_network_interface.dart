...
class GetInstanceNetworkInterface {
  ...
  final pulumi.Input<List<GetInstanceNetworkInterfaceAccessConfig>>
  accessConfigs;

  /// An array of alias IP ranges for this network interface. Structure documented below.
  final pulumi.Input<List<GetInstanceNetworkInterfaceAliasIpRange>>
  aliasIpRanges;
  ...
  final pulumi.Input<List<GetInstanceNetworkInterfaceIpv6AccessConfig>>
  ipv6AccessConfigs;
    ...
    return <String, dynamic>{
      'accessConfigs':
          pulumi.Input.mapInputValue<
            List<GetInstanceNetworkInterfaceAccessConfig>,
      ...
      'aliasIpRanges':
          pulumi.Input.mapInputValue<
            List<GetInstanceNetworkInterfaceAliasIpRange>,
            List<Map<String, dynamic>>
          >(
            aliasIpRanges,
            (value) =>
      ...
      'ipv6AccessConfigs':
          pulumi.Input.mapInputValue<
            List<GetInstanceNetworkInterfaceIpv6AccessConfig>,
            List<Map<String, dynamic>>
          >(
            ipv6AccessConfigs,
            (value) =>
