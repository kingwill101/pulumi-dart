...
class GetRegionBackendServiceDynamicForwarding {
  ...
  factory GetRegionBackendServiceDynamicForwarding.fromMap(Map<String, dynamic> map) {
    return GetRegionBackendServiceDynamicForwarding(
      ipPortSelections: (pulumi.Input.decodeList<GetRegionBackendServiceDynamicForwardingIpPortSelection>(map['ipPortSelections'], (value) => GetRegionBackendServiceDynamicForwardingIpPortSelection.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
