...
class ReservationResourceStatusReservationMaintenance {
  ...
  factory ReservationResourceStatusReservationMaintenance.fromMap(Map<String, dynamic> map) {
    return ReservationResourceStatusReservationMaintenance(
      instanceMaintenanceOngoingCount: (() { final guardedValue = map['instanceMaintenanceOngoingCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      instanceMaintenancePendingCount: (() { final guardedValue = map['instanceMaintenancePendingCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      maintenanceOngoingCount: (() { final guardedValue = map['maintenanceOngoingCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      maintenancePendingCount: (() { final guardedValue = map['maintenancePendingCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      subblockInfraMaintenanceOngoingCount: (() { final guardedValue = map['subblockInfraMaintenanceOngoingCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      subblockInfraMaintenancePendingCount: (() { final guardedValue = map['subblockInfraMaintenancePendingCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
