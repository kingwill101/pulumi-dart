...
class FutureReservationStatusLastKnownGoodStateFutureReservationSpecs {
  ...
  factory FutureReservationStatusLastKnownGoodStateFutureReservationSpecs.fromMap(Map<String, dynamic> map) {
    return FutureReservationStatusLastKnownGoodStateFutureReservationSpecs(
      shareSettings: (() { final guardedValue = map['shareSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FutureReservationStatusLastKnownGoodStateFutureReservationSpecsShareSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      specificSkuProperties: (() { final guardedValue = map['specificSkuProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FutureReservationStatusLastKnownGoodStateFutureReservationSpecsSpecificSkuProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      timeWindow: (() { final guardedValue = map['timeWindow']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FutureReservationStatusLastKnownGoodStateFutureReservationSpecsTimeWindow.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
