...
class DiskAsyncReplicationState {
  ...
  factory DiskAsyncReplicationState.fromMap(Map<String, dynamic> map) {
    return DiskAsyncReplicationState(
      ...
      primaryDisk: (() { final guardedValue = map['primaryDisk']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      secondaryDisk: (() { final guardedValue = map['secondaryDisk']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DiskAsyncReplicationSecondaryDisk.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
