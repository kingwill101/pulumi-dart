...
class URLMapPathMatcherHeaderAction {
  ...
  final pulumi.Input<List<URLMapPathMatcherHeaderActionRequestHeadersToAdd>>?
  ...
  /// Structure is documented below.
  final pulumi.Input<List<URLMapPathMatcherHeaderActionResponseHeadersToAdd>>?
    ...
    return <String, dynamic>{
      'requestHeadersToAdds':
          ?pulumi.Input.mapOptionalInputValue<
            List<URLMapPathMatcherHeaderActionRequestHeadersToAdd>,
      ...
      'responseHeadersToAdds':
          ?pulumi.Input.mapOptionalInputValue<
            List<URLMapPathMatcherHeaderActionResponseHeadersToAdd>,
            List<Map<String, dynamic>>
          >(
            responseHeadersToAdds,
            (value) =>
    ...
    return URLMapPathMatcherHeaderAction(
      requestHeadersToAdds: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => URLMapPathMatcherHeaderActionRequestHeadersToAdd.fromMap(
