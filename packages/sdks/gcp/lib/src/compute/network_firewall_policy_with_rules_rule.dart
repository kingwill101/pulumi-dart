...
class NetworkFirewallPolicyWithRulesRule {
  ...
  /// Structure is documented below.
  final pulumi.Input<List<NetworkFirewallPolicyWithRulesRuleTargetSecureTag>>?
  targetSecureTags;
    ...
    return <String, dynamic>{
      ...
      'targetSecureTags':
          ?pulumi.Input.mapOptionalInputValue<
            List<NetworkFirewallPolicyWithRulesRuleTargetSecureTag>,
  ...
  factory NetworkFirewallPolicyWithRulesRule.fromMap(Map<String, dynamic> map) {
    return NetworkFirewallPolicyWithRulesRule(
      ...
      match: pulumi.Input.fromValue(
        NetworkFirewallPolicyWithRulesRuleMatch.fromMap(
