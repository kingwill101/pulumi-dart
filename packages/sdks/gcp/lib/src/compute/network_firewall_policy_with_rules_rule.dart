...
class NetworkFirewallPolicyWithRulesRule {
  ...
  final pulumi.Input<NetworkFirewallPolicyWithRulesRuleMatch> match;
  ...
  /// Structure is documented below.
  final pulumi.Input<List<NetworkFirewallPolicyWithRulesRuleTargetSecureTag>>? targetSecureTags;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'match': pulumi.Input.mapInputValue<NetworkFirewallPolicyWithRulesRuleMatch, Map<String, dynamic>>(match, (value) => value.toMap()),
      'priority': priority,
      'ruleName': ?ruleName,
      'securityProfileGroup': ?securityProfileGroup,
      'targetSecureTags': ?pulumi.Input.mapOptionalInputValue<List<NetworkFirewallPolicyWithRulesRuleTargetSecureTag>, List<Map<String, dynamic>>>(targetSecureTags, (value) => pulumi.Input.encodeList<NetworkFirewallPolicyWithRulesRuleTargetSecureTag, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory NetworkFirewallPolicyWithRulesRule.fromMap(Map<String, dynamic> map) {
    return NetworkFirewallPolicyWithRulesRule(
      ...
      match: pulumi.Input.fromValue(NetworkFirewallPolicyWithRulesRuleMatch.fromMap((map['match']! as Map).cast<String, dynamic>())),
      ...
      targetSecureTags: (() { final guardedValue = map['targetSecureTags']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NetworkFirewallPolicyWithRulesRuleTargetSecureTag>(guardedValue, (value) => NetworkFirewallPolicyWithRulesRuleTargetSecureTag.fromMap((value as Map).cast<String, dynamic>()))); })(),
