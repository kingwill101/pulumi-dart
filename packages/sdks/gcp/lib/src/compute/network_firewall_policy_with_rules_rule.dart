...
class NetworkFirewallPolicyWithRulesRule {
  ...
  factory NetworkFirewallPolicyWithRulesRule.fromMap(Map<String, dynamic> map) {
    return NetworkFirewallPolicyWithRulesRule(
      ...
      match: (NetworkFirewallPolicyWithRulesRuleMatch.fromMap((map['match'] as Map).cast<String, dynamic>())).input(),
      priority: (map['priority'] as int).input(),
      ruleName: map['ruleName'] == null ? null : (map['ruleName']! as String).input(),
      securityProfileGroup: map['securityProfileGroup'] == null ? null : (map['securityProfileGroup']! as String).input(),
      targetSecureTags: map['targetSecureTags'] == null ? null : (pulumi.Input.decodeList<NetworkFirewallPolicyWithRulesRuleTargetSecureTag>(map['targetSecureTags']!, (value) => NetworkFirewallPolicyWithRulesRuleTargetSecureTag.fromMap((value as Map).cast<String, dynamic>()))).input(),
