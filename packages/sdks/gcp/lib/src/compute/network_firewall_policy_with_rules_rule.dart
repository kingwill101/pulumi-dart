...
class NetworkFirewallPolicyWithRulesRule {
  ...
  /// Structure is documented below.
  final List<NetworkFirewallPolicyWithRulesRuleTargetSecureTag>? targetSecureTags;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'targetSecureTags': ?targetSecureTags == null ? null : pulumi.Input.encodeList<NetworkFirewallPolicyWithRulesRuleTargetSecureTag, Map<String, dynamic>>(targetSecureTags!, (value) => value.toMap()),
  ...
  factory NetworkFirewallPolicyWithRulesRule.fromMap(Map<String, dynamic> map) {
    return NetworkFirewallPolicyWithRulesRule(
      ...
      match: NetworkFirewallPolicyWithRulesRuleMatch.fromMap((map['match'] as Map).cast<String, dynamic>()),
      ...
      targetSecureTags: map['targetSecureTags'] == null ? null : pulumi.Input.decodeList<NetworkFirewallPolicyWithRulesRuleTargetSecureTag>(map['targetSecureTags'], (value) => NetworkFirewallPolicyWithRulesRuleTargetSecureTag.fromMap((value as Map).cast<String, dynamic>())),
