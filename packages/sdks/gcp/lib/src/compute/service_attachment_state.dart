...
class ServiceAttachmentState {
  ...
  final pulumi.Input<List<ServiceAttachmentConnectedEndpoint>>?
  connectedEndpoints;
  ...
  /// Structure is documented below.
  final pulumi.Input<List<ServiceAttachmentPscServiceAttachmentId>>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'pscServiceAttachmentIds':
          ?pulumi.Input.mapOptionalInputValue<
            List<ServiceAttachmentPscServiceAttachmentId>,
            List<Map<String, dynamic>>
          >(
            pscServiceAttachmentIds,
            (value) =>
      ...
      'tunnelingConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(tunnelingConfig, (value) => value.toMap()),
    };
  }
  ...
  factory ServiceAttachmentState.fromMap(Map<String, dynamic> map) {
    return ServiceAttachmentState(
      connectedEndpoints: (() {
        final guardedValue = map['connectedEndpoints'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ServiceAttachmentConnectedEndpoint>(
            guardedValue,
            (value) => ServiceAttachmentConnectedEndpoint.fromMap(
      ...
      consumerRejectLists: (() {
        final guardedValue = map['consumerRejectLists'];
        if (guardedValue == null) return null;
      ...
      natSubnets: (() {
        final guardedValue = map['natSubnets'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      project: (() {
      ...
      propagatedConnectionLimit: (() {
        final guardedValue = map['propagatedConnectionLimit'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      pscServiceAttachmentIds: (() {
        final guardedValue = map['pscServiceAttachmentIds'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ServiceAttachmentPscServiceAttachmentId>(
            guardedValue,
            (value) => ServiceAttachmentPscServiceAttachmentId.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      reconcileConnections: (() {
        final guardedValue = map['reconcileConnections'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      region: (() {
      ...
      sendPropagatedConnectionLimitIfZero: (() {
        final guardedValue = map['sendPropagatedConnectionLimitIfZero'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      showNatIps: (() {
        final guardedValue = map['showNatIps'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      targetService: (() {
      ...
      tunnelingConfig: (() {
        final guardedValue = map['tunnelingConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
