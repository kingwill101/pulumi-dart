...
class FutureReservationShareSettings {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'projectMaps': ?pulumi.Input.mapOptionalInputValue<List<FutureReservationShareSettingsProjectMap>, List<Map<String, dynamic>>>(projectMaps, (value) => pulumi.Input.encodeList<FutureReservationShareSettingsProjectMap, Map<String, dynamic>>(value, (value) => value.toMap())),
      'projects': ?projects,
      'shareType': ?shareType,
    };
  }
  ...
  factory FutureReservationShareSettings.fromMap(Map<String, dynamic> map) {
    return FutureReservationShareSettings(
      projectMaps: (() { final guardedValue = map['projectMaps']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FutureReservationShareSettingsProjectMap>(guardedValue, (value) => FutureReservationShareSettingsProjectMap.fromMap((value as Map).cast<String, dynamic>()))); })(),
