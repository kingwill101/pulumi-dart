...
class SecurityPolicyAdaptiveProtectionConfigLayer7DdosDefenseConfigThresholdConfig {
  ...
  final List<SecurityPolicyAdaptiveProtectionConfigLayer7DdosDefenseConfigThresholdConfigTrafficGranularityConfig>? trafficGranularityConfigs;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': name,
      'trafficGranularityConfigs': ?trafficGranularityConfigs == null ? null : pulumi.Input.encodeList<SecurityPolicyAdaptiveProtectionConfigLayer7DdosDefenseConfigThresholdConfigTrafficGranularityConfig, Map<String, dynamic>>(trafficGranularityConfigs!, (value) => value.toMap()),
    };
  }
  ...
  factory SecurityPolicyAdaptiveProtectionConfigLayer7DdosDefenseConfigThresholdConfig.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyAdaptiveProtectionConfigLayer7DdosDefenseConfigThresholdConfig(
      ...
      detectionAbsoluteQps: map['detectionAbsoluteQps'] == null ? null : map['detectionAbsoluteQps'] as double,
      detectionLoadThreshold: map['detectionLoadThreshold'] == null ? null : map['detectionLoadThreshold'] as double,
      detectionRelativeToBaselineQps: map['detectionRelativeToBaselineQps'] == null ? null : map['detectionRelativeToBaselineQps'] as double,
