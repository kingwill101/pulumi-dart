  ...
  factory SecurityPolicyAdaptiveProtectionConfigLayer7DdosDefenseConfigThresholdConfig.fromMap(
    ...
    return SecurityPolicyAdaptiveProtectionConfigLayer7DdosDefenseConfigThresholdConfig(
      ...
      detectionAbsoluteQps: (() {
        final guardedValue = map['detectionAbsoluteQps'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as double);
      })(),
      detectionLoadThreshold: (() {
        final guardedValue = map['detectionLoadThreshold'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as double);
      })(),
      detectionRelativeToBaselineQps: (() {
        final guardedValue = map['detectionRelativeToBaselineQps'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as double);
      })(),
      name: pulumi.Input.fromValue(map['name'] as String),
      trafficGranularityConfigs: (() {
        final guardedValue = map['trafficGranularityConfigs'];
        if (guardedValue == null) return null;
