...
class NetworkFirewallPolicyRuleState {
  ...
  const NetworkFirewallPolicyRuleState({
    this.action,
  ...
  factory NetworkFirewallPolicyRuleState.fromMap(Map<String, dynamic> map) {
    return NetworkFirewallPolicyRuleState(
      ...
      match: (() { final guardedValue = map['match']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkFirewallPolicyRuleMatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
