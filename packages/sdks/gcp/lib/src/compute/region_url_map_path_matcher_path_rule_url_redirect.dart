...
class RegionUrlMapPathMatcherPathRuleUrlRedirect {
  ...
  /// Creates a new [RegionUrlMapPathMatcherPathRuleUrlRedirect].
  ...
  const RegionUrlMapPathMatcherPathRuleUrlRedirect({
    this.hostRedirect,
    this.httpsRedirect,
    this.pathRedirect,
    this.prefixRedirect,
  ...
  factory RegionUrlMapPathMatcherPathRuleUrlRedirect.fromMap(Map<String, dynamic> map) {
    return RegionUrlMapPathMatcherPathRuleUrlRedirect(
