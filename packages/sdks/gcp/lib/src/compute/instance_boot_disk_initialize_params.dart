...
class InstanceBootDiskInitializeParams {
  ...
  factory InstanceBootDiskInitializeParams.fromMap(Map<String, dynamic> map) {
    return InstanceBootDiskInitializeParams(
      ...
      sourceImageEncryptionKey: map['sourceImageEncryptionKey'] == null ? null : (InstanceBootDiskInitializeParamsSourceImageEncryptionKey.fromMap((map['sourceImageEncryptionKey']! as Map).cast<String, dynamic>())).input(),
      sourceSnapshotEncryptionKey: map['sourceSnapshotEncryptionKey'] == null ? null : (InstanceBootDiskInitializeParamsSourceSnapshotEncryptionKey.fromMap((map['sourceSnapshotEncryptionKey']! as Map).cast<String, dynamic>())).input(),
