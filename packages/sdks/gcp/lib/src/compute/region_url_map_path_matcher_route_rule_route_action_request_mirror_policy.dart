...
class RegionUrlMapPathMatcherRouteRuleRouteActionRequestMirrorPolicy {
  ...
  /// Creates a new [RegionUrlMapPathMatcherRouteRuleRouteActionRequestMirrorPolicy].
  /// [backendService] The full or partial URL to the RegionBackendService resource being mirrored to.
  /// [mirrorPercent] (Optional, Beta)
  const RegionUrlMapPathMatcherRouteRuleRouteActionRequestMirrorPolicy({
  ...
  factory RegionUrlMapPathMatcherRouteRuleRouteActionRequestMirrorPolicy.fromMap(Map<String, dynamic> map) {
    return RegionUrlMapPathMatcherRouteRuleRouteActionRequestMirrorPolicy(
