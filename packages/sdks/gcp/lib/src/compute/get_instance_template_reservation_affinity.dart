...
class GetInstanceTemplateReservationAffinity {
  ...
  const GetInstanceTemplateReservationAffinity({
  ...
  factory GetInstanceTemplateReservationAffinity.fromMap(Map<String, dynamic> map) {
    return GetInstanceTemplateReservationAffinity(
      specificReservations: pulumi.Input.fromValue(pulumi.Input.decodeList<GetInstanceTemplateReservationAffinitySpecificReservation>(map['specificReservations']!, (value) => GetInstanceTemplateReservationAffinitySpecificReservation.fromMap((value as Map).cast<String, dynamic>()))),
