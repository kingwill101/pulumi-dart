...
class GetReservationResourceStatus {
  ...
  final pulumi.Input<List<GetReservationResourceStatusReservationMaintenance>>
  reservationMaintenances;

  /// Allocation Properties of this reservation.
  final pulumi.Input<List<GetReservationResourceStatusSpecificSkuAllocation>>
    ...
    return <String, dynamic>{
      'healthInfos':
          pulumi.Input.mapInputValue<
            List<GetReservationResourceStatusHealthInfo>,
      ...
      'reservationMaintenances':
          pulumi.Input.mapInputValue<
            List<GetReservationResourceStatusReservationMaintenance>,
            List<Map<String, dynamic>>
          >(
            reservationMaintenances,
            (value) =>
      ...
      'specificSkuAllocations':
          pulumi.Input.mapInputValue<
            List<GetReservationResourceStatusSpecificSkuAllocation>,
            List<Map<String, dynamic>>
          >(
            specificSkuAllocations,
            (value) =>
  ...
  factory GetReservationResourceStatus.fromMap(Map<String, dynamic> map) {
    return GetReservationResourceStatus(
      healthInfos: pulumi.Input.fromValue(
      ...
      reservationBlockCount: pulumi.Input.fromValue(
        map['reservationBlockCount'] as int,
      ),
      reservationMaintenances: pulumi.Input.fromValue(
      ...
      specificSkuAllocations: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetReservationResourceStatusSpecificSkuAllocation
        >(
