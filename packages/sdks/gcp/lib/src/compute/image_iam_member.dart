...
import 'image_iam_member_args.dart';
import 'image_iam_member_condition.dart';
import 'image_iam_member_state.dart';
...
/// }
///
/// resource "gcp_compute_imageiampolicy" "policy" {
///   project     = example.project
///   image       = example.name
...
/// }
///
/// resource "gcp_compute_imageiambinding" "binding" {
///   project = example.project
///   image   = example.name
///   role    = "roles/compute.imageUser"
///   members = ["user:jane@example.com"]
...
/// }
///
/// resource "gcp_compute_imageiammember" "member" {
///   project = example.project
///   image   = example.name
///   role    = "roles/compute.imageUser"
///   member  = "user:jane@example.com"
...
class ImageIamMember extends pulumi.CustomResource {
  ...
  late final pulumi.Output<ImageIamMemberCondition?> condition;
  ...
  /// Creates a new [ImageIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ImageIamMember]. {@macro pulumi_compute_image_iam_member_image_iam_member_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  ImageIamMember(
    String name, {
    ImageIamMemberArgs? args,
    ...
    condition = registerOutput<ImageIamMemberCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ImageIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [ImageIamMember] resource's state with the given [name] and [id].
  static ImageIamMember get(
    String name,
    pulumi.Input<String> id, {
    ImageIamMemberState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return ImageIamMember._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [ImageIamMember] resource.
  ImageIamMember.reference(String urn)
    : super(
        'gcp:compute/imageIamMember:ImageIamMember',
