...
class GetReservationShareSetting {
  ...
  const GetReservationShareSetting({
  ...
  factory GetReservationShareSetting.fromMap(Map<String, dynamic> map) {
    return GetReservationShareSetting(
      projectMaps: pulumi.Input.fromValue(pulumi.Input.decodeList<GetReservationShareSettingProjectMap>(map['projectMaps']!, (value) => GetReservationShareSettingProjectMap.fromMap((value as Map).cast<String, dynamic>()))),
