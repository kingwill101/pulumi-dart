...
class RegionUrlMapPathMatcherRouteRuleMatchRuleMetadataFilter {
  ...
  factory RegionUrlMapPathMatcherRouteRuleMatchRuleMetadataFilter.fromMap(Map<String, dynamic> map) {
    return RegionUrlMapPathMatcherRouteRuleMatchRuleMetadataFilter(
      filterLabels: (pulumi.Input.decodeList<RegionUrlMapPathMatcherRouteRuleMatchRuleMetadataFilterFilterLabel>(map['filterLabels'], (value) => RegionUrlMapPathMatcherRouteRuleMatchRuleMetadataFilterFilterLabel.fromMap((value as Map).cast<String, dynamic>()))).input(),
