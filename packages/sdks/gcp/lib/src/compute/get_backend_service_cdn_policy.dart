...
class GetBackendServiceCdnPolicy {
  ...
  final pulumi.Input<List<GetBackendServiceCdnPolicyBypassCacheOnRequestHeader>>
  bypassCacheOnRequestHeaders;

  /// The CacheKeyPolicy for this CdnPolicy.
  final pulumi.Input<List<GetBackendServiceCdnPolicyCacheKeyPolicy>>
  cacheKeyPolicies;
  ...
  final pulumi.Input<List<GetBackendServiceCdnPolicyNegativeCachingPolicy>>
    ...
    return <String, dynamic>{
      'bypassCacheOnRequestHeaders':
          pulumi.Input.mapInputValue<
            List<GetBackendServiceCdnPolicyBypassCacheOnRequestHeader>,
      ...
      'cacheKeyPolicies':
          pulumi.Input.mapInputValue<
            List<GetBackendServiceCdnPolicyCacheKeyPolicy>,
            List<Map<String, dynamic>>
          >(
            cacheKeyPolicies,
            (value) =>
      ...
      'negativeCachingPolicies':
          pulumi.Input.mapInputValue<
            List<GetBackendServiceCdnPolicyNegativeCachingPolicy>,
            List<Map<String, dynamic>>
          >(
            negativeCachingPolicies,
            (value) =>
  ...
  factory GetBackendServiceCdnPolicy.fromMap(Map<String, dynamic> map) {
    return GetBackendServiceCdnPolicy(
      ...
      negativeCachingPolicies: pulumi.Input.fromValue(
        pulumi
            .Input.decodeList<GetBackendServiceCdnPolicyNegativeCachingPolicy>(
