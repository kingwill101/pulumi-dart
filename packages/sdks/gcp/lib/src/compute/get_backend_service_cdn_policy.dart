...
class GetBackendServiceCdnPolicy {
  ...
  factory GetBackendServiceCdnPolicy.fromMap(Map<String, dynamic> map) {
    return GetBackendServiceCdnPolicy(
      bypassCacheOnRequestHeaders: pulumi.Input.fromValue(pulumi.Input.decodeList<GetBackendServiceCdnPolicyBypassCacheOnRequestHeader>(map['bypassCacheOnRequestHeaders']!, (value) => GetBackendServiceCdnPolicyBypassCacheOnRequestHeader.fromMap((value as Map).cast<String, dynamic>()))),
      cacheKeyPolicies: pulumi.Input.fromValue(pulumi.Input.decodeList<GetBackendServiceCdnPolicyCacheKeyPolicy>(map['cacheKeyPolicies']!, (value) => GetBackendServiceCdnPolicyCacheKeyPolicy.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      negativeCachingPolicies: pulumi.Input.fromValue(pulumi.Input.decodeList<GetBackendServiceCdnPolicyNegativeCachingPolicy>(map['negativeCachingPolicies']!, (value) => GetBackendServiceCdnPolicyNegativeCachingPolicy.fromMap((value as Map).cast<String, dynamic>()))),
