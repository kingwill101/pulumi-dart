...
class InstanceTemplateDiskSourceImageEncryptionKey {
  ...
  /// Creates a new [InstanceTemplateDiskSourceImageEncryptionKey].
  ...
  const InstanceTemplateDiskSourceImageEncryptionKey({
    this.kmsKeySelfLink,
  ...
  factory InstanceTemplateDiskSourceImageEncryptionKey.fromMap(Map<String, dynamic> map) {
