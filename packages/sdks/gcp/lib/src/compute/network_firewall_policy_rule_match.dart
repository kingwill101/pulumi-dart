...
class NetworkFirewallPolicyRuleMatch {
  ...
  final List<NetworkFirewallPolicyRuleMatchLayer4Config> layer4Configs;
  ...
  /// Structure is documented below.
  final List<NetworkFirewallPolicyRuleMatchSrcSecureTag>? srcSecureTags;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'layer4Configs': pulumi.Input.encodeList<NetworkFirewallPolicyRuleMatchLayer4Config, Map<String, dynamic>>(layer4Configs, (value) => value.toMap()),
      ...
      'srcSecureTags': ?srcSecureTags == null ? null : pulumi.Input.encodeList<NetworkFirewallPolicyRuleMatchSrcSecureTag, Map<String, dynamic>>(srcSecureTags!, (value) => value.toMap()),
  ...
  factory NetworkFirewallPolicyRuleMatch.fromMap(Map<String, dynamic> map) {
    return NetworkFirewallPolicyRuleMatch(
      ...
      layer4Configs: pulumi.Input.decodeList<NetworkFirewallPolicyRuleMatchLayer4Config>(map['layer4Configs'], (value) => NetworkFirewallPolicyRuleMatchLayer4Config.fromMap((value as Map).cast<String, dynamic>())),
      ...
      srcSecureTags: map['srcSecureTags'] == null ? null : pulumi.Input.decodeList<NetworkFirewallPolicyRuleMatchSrcSecureTag>(map['srcSecureTags'], (value) => NetworkFirewallPolicyRuleMatchSrcSecureTag.fromMap((value as Map).cast<String, dynamic>())),
