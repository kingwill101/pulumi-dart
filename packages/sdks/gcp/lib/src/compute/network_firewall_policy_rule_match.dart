...
class NetworkFirewallPolicyRuleMatch {
  ...
  final pulumi.Input<List<NetworkFirewallPolicyRuleMatchLayer4Config>>
  layer4Configs;
  ...
  /// Structure is documented below.
  final pulumi.Input<List<NetworkFirewallPolicyRuleMatchSrcSecureTag>>?
  srcSecureTags;
    ...
    return <String, dynamic>{
      ...
      'layer4Configs':
          pulumi.Input.mapInputValue<
            List<NetworkFirewallPolicyRuleMatchLayer4Config>,
      ...
      'srcSecureTags':
          ?pulumi.Input.mapOptionalInputValue<
            List<NetworkFirewallPolicyRuleMatchSrcSecureTag>,
            List<Map<String, dynamic>>
          >(
            srcSecureTags,
            (value) =>
