...
class RolloutPlanState {
  ...
  /// Creates a new [RolloutPlanState].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'project': ?project,
      'selfLink': ?selfLink,
      'waves': ?pulumi.Input.mapOptionalInputValue<List<RolloutPlanWave>, List<Map<String, dynamic>>>(waves, (value) => pulumi.Input.encodeList<RolloutPlanWave, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory RolloutPlanState.fromMap(Map<String, dynamic> map) {
    return RolloutPlanState(
      ...
      waves: (() { final guardedValue = map['waves']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RolloutPlanWave>(guardedValue, (value) => RolloutPlanWave.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
