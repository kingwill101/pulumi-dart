...
class RegionUrlMapDefaultRouteActionFaultInjectionPolicyDelayFixedDelay {
  ...
  /// Creates a new [RegionUrlMapDefaultRouteActionFaultInjectionPolicyDelayFixedDelay].
  ...
  const RegionUrlMapDefaultRouteActionFaultInjectionPolicyDelayFixedDelay({
    this.nanos,
    this.seconds,
  });
  ...
  factory RegionUrlMapDefaultRouteActionFaultInjectionPolicyDelayFixedDelay.fromMap(Map<String, dynamic> map) {
