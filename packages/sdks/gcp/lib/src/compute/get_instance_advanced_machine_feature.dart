...
class GetInstanceAdvancedMachineFeature {
  ...
  /// Creates a new [GetInstanceAdvancedMachineFeature].
  ...
  const GetInstanceAdvancedMachineFeature({
  ...
  factory GetInstanceAdvancedMachineFeature.fromMap(Map<String, dynamic> map) {
    return GetInstanceAdvancedMachineFeature(
