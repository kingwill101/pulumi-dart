...
class NetworkFirewallPolicyPacketMirroringRuleMatchLayer4Config {
  ...
  const NetworkFirewallPolicyPacketMirroringRuleMatchLayer4Config({
  ...
  factory NetworkFirewallPolicyPacketMirroringRuleMatchLayer4Config.fromMap(Map<String, dynamic> map) {
