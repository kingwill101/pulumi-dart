...
class InstanceNetworkInterface {
  ...
  final pulumi.Input<List<InstanceNetworkInterfaceIpv6AccessConfig>>?
  ipv6AccessConfigs;
    ...
    return <String, dynamic>{
      'accessConfigs':
          ?pulumi.Input.mapOptionalInputValue<
            List<InstanceNetworkInterfaceAccessConfig>,
      ...
      'aliasIpRanges':
          ?pulumi.Input.mapOptionalInputValue<
            List<InstanceNetworkInterfaceAliasIpRange>,
            List<Map<String, dynamic>>
          >(
            aliasIpRanges,
            (value) =>
    ...
    return InstanceNetworkInterface(
      accessConfigs: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InstanceNetworkInterfaceAccessConfig>(
            guardedValue,
      ...
      aliasIpRanges: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InstanceNetworkInterfaceAliasIpRange>(
            guardedValue,
      ...
      ipv6AccessConfigs: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InstanceNetworkInterfaceIpv6AccessConfig>(
            guardedValue,
