...
class GetRegionBackendServiceCircuitBreakerConnectTimeout {
  ...
  factory GetRegionBackendServiceCircuitBreakerConnectTimeout.fromMap(Map<String, dynamic> map) {
    return GetRegionBackendServiceCircuitBreakerConnectTimeout(
