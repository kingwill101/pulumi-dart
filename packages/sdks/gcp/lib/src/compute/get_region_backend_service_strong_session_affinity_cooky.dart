...
class GetRegionBackendServiceStrongSessionAffinityCooky {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'name': name,
      'path': path,
      'ttls': pulumi.Input.encodeList<GetRegionBackendServiceStrongSessionAffinityCookyTtl, Map<String, dynamic>>(ttls, (value) => value.toMap()),
    };
  }
  ...
  factory GetRegionBackendServiceStrongSessionAffinityCooky.fromMap(Map<String, dynamic> map) {
    return GetRegionBackendServiceStrongSessionAffinityCooky(
      ...
      ttls: pulumi.Input.decodeList<GetRegionBackendServiceStrongSessionAffinityCookyTtl>(map['ttls'], (value) => GetRegionBackendServiceStrongSessionAffinityCookyTtl.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
