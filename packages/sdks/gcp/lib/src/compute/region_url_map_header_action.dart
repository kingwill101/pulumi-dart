...
class RegionUrlMapHeaderAction {
  ...
  final pulumi.Input<List<RegionUrlMapHeaderActionRequestHeadersToAdd>>?
  ...
  /// Structure is documented below.
  final pulumi.Input<List<RegionUrlMapHeaderActionResponseHeadersToAdd>>?
    ...
    return <String, dynamic>{
      'requestHeadersToAdds':
          ?pulumi.Input.mapOptionalInputValue<
            List<RegionUrlMapHeaderActionRequestHeadersToAdd>,
      ...
      'responseHeadersToAdds':
          ?pulumi.Input.mapOptionalInputValue<
            List<RegionUrlMapHeaderActionResponseHeadersToAdd>,
            List<Map<String, dynamic>>
          >(
            responseHeadersToAdds,
            (value) =>
    ...
    return RegionUrlMapHeaderAction(
      requestHeadersToAdds: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RegionUrlMapHeaderActionRequestHeadersToAdd>(
            guardedValue,
      ...
      responseHeadersToAdds: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RegionUrlMapHeaderActionResponseHeadersToAdd>(
            guardedValue,
