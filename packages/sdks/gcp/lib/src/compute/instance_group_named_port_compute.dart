...
import 'instance_group_named_port_state.dart';
...
class InstanceGroupNamedPortCompute extends pulumi.CustomResource {
  ...
  /// Gets an existing [InstanceGroupNamedPortCompute] resource's state with the given [name] and [id].
  static InstanceGroupNamedPortCompute get(
    String name,
  ...
  InstanceGroupNamedPortCompute._get(
    String name, {
