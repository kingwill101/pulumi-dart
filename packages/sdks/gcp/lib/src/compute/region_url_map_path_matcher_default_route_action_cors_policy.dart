...
class RegionUrlMapPathMatcherDefaultRouteActionCorsPolicy {
  ...
  /// Creates a new [RegionUrlMapPathMatcherDefaultRouteActionCorsPolicy].
  ...
  const RegionUrlMapPathMatcherDefaultRouteActionCorsPolicy({
  ...
  factory RegionUrlMapPathMatcherDefaultRouteActionCorsPolicy.fromMap(Map<String, dynamic> map) {
    return RegionUrlMapPathMatcherDefaultRouteActionCorsPolicy(
