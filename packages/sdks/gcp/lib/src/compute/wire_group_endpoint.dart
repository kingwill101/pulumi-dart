...
class WireGroupEndpoint {
  ...
  factory WireGroupEndpoint.fromMap(Map<String, dynamic> map) {
    return WireGroupEndpoint(
      ...
      interconnects: (() { final guardedValue = map['interconnects']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<WireGroupEndpointInterconnect>(guardedValue, (value) => WireGroupEndpointInterconnect.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
