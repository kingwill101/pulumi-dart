...
class InstanceTemplateScheduling {
  ...
  final pulumi.Input<InstanceTemplateSchedulingGracefulShutdown>?
  gracefulShutdown;
  ...
  /// hour.
  final pulumi.Input<List<InstanceTemplateSchedulingLocalSsdRecoveryTimeout>>?
  ...
  final pulumi.Input<List<InstanceTemplateSchedulingNodeAffinity>>?
  nodeAffinities;
  ...
  final pulumi.Input<InstanceTemplateSchedulingOnInstanceStopAction>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'localSsdRecoveryTimeouts':
          ?pulumi.Input.mapOptionalInputValue<
            List<InstanceTemplateSchedulingLocalSsdRecoveryTimeout>,
      ...
      'nodeAffinities':
          ?pulumi.Input.mapOptionalInputValue<
            List<InstanceTemplateSchedulingNodeAffinity>,
            List<Map<String, dynamic>>
          >(
            nodeAffinities,
            (value) =>
