...
class RegionNetworkFirewallPolicyWithRulesRule {
  ...
  /// Structure is documented below.
  final pulumi.Input<
    List<RegionNetworkFirewallPolicyWithRulesRuleTargetSecureTag>
  >?
  targetSecureTags;
  ...
  factory RegionNetworkFirewallPolicyWithRulesRule.fromMap(
    ...
    return RegionNetworkFirewallPolicyWithRulesRule(
      ...
      match: pulumi.Input.fromValue(
        RegionNetworkFirewallPolicyWithRulesRuleMatch.fromMap(
      ...
      targetSecureTags: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                RegionNetworkFirewallPolicyWithRulesRuleTargetSecureTag.fromMap(
