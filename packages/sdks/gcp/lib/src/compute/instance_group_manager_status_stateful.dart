...
class InstanceGroupManagerStatusStateful {
  ...
  const InstanceGroupManagerStatusStateful({
  ...
  factory InstanceGroupManagerStatusStateful.fromMap(Map<String, dynamic> map) {
    return InstanceGroupManagerStatusStateful(
      ...
      perInstanceConfigs: (() { final guardedValue = map['perInstanceConfigs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InstanceGroupManagerStatusStatefulPerInstanceConfig>(guardedValue, (value) => InstanceGroupManagerStatusStatefulPerInstanceConfig.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
