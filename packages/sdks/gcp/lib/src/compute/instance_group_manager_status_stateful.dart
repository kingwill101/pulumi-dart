...
class InstanceGroupManagerStatusStateful {
  ...
  final pulumi.Input<List<InstanceGroupManagerStatusStatefulPerInstanceConfig>>?
  perInstanceConfigs;
    ...
    return <String, dynamic>{
      ...
      'perInstanceConfigs':
          ?pulumi.Input.mapOptionalInputValue<
            List<InstanceGroupManagerStatusStatefulPerInstanceConfig>,
  ...
  factory InstanceGroupManagerStatusStateful.fromMap(Map<String, dynamic> map) {
    return InstanceGroupManagerStatusStateful(
      hasStatefulConfig: (() {
        final guardedValue = map['hasStatefulConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      perInstanceConfigs: (() {
        final guardedValue = map['perInstanceConfigs'];
        if (guardedValue == null) return null;
