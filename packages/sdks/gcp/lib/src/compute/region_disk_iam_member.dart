...
import 'region_disk_iam_member_state.dart';
...
class RegionDiskIamMember extends pulumi.CustomResource {
  ...
  RegionDiskIamMember(
    ...
    condition = registerOutput<RegionDiskIamMemberCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return RegionDiskIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [RegionDiskIamMember] resource's state with the given [name] and [id].
  static RegionDiskIamMember get(
    String name,
    pulumi.Input<String> id, {
    RegionDiskIamMemberState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return RegionDiskIamMember._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [RegionDiskIamMember] resource.
  RegionDiskIamMember.reference(String urn)
    : super(
        'gcp:compute/regionDiskIamMember:RegionDiskIamMember',
