...
import 'subnetwork_iambinding_args.dart';
import 'subnetwork_iambinding_condition.dart';
import 'subnetwork_iambinding_state.dart';
...
class SubnetworkIAMBinding extends pulumi.CustomResource {
  ...
  late final pulumi.Output<SubnetworkIAMBindingCondition?> condition;
  ...
  /// [args] Arguments used to configure this [SubnetworkIAMBinding]. {@macro pulumi_compute_subnetwork_iambinding_subnetwork_iambinding_args_doc}
  ...
  SubnetworkIAMBinding(
    ...
    condition = registerOutput<SubnetworkIAMBindingCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SubnetworkIAMBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [SubnetworkIAMBinding] resource's state with the given [name] and [id].
  static SubnetworkIAMBinding get(
    String name,
    pulumi.Input<String> id, {
    SubnetworkIAMBindingState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return SubnetworkIAMBinding._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [SubnetworkIAMBinding] resource.
  SubnetworkIAMBinding.reference(String urn)
    : super(
        'gcp:compute/subnetworkIAMBinding:SubnetworkIAMBinding',
