...
import 'instant_snapshot_iam_policy_state.dart';
...
class InstantSnapshotIamPolicy extends pulumi.CustomResource {
  ...
  /// Gets an existing [InstantSnapshotIamPolicy] resource's state with the given [name] and [id].
  static InstantSnapshotIamPolicy get(
    String name,
    pulumi.Input<String> id, {
    InstantSnapshotIamPolicyState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return InstantSnapshotIamPolicy._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [InstantSnapshotIamPolicy] resource.
  InstantSnapshotIamPolicy.reference(String urn)
    : super(
        'gcp:compute/instantSnapshotIamPolicy:InstantSnapshotIamPolicy',
