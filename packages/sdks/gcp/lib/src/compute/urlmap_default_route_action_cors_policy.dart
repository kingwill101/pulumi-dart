...
class URLMapDefaultRouteActionCorsPolicy {
  ...
  /// Creates a new [URLMapDefaultRouteActionCorsPolicy].
  ...
  const URLMapDefaultRouteActionCorsPolicy({
  ...
  factory URLMapDefaultRouteActionCorsPolicy.fromMap(Map<String, dynamic> map) {
