...
class SecurityPolicyRulePreconfiguredWafConfigExclusion {
  ...
  final pulumi.Input<
    List<SecurityPolicyRulePreconfiguredWafConfigExclusionRequestCooky>
  >?
  requestCookies;
  ...
  /// Structure is documented below.
  final pulumi.Input<
    List<SecurityPolicyRulePreconfiguredWafConfigExclusionRequestHeader>
  >?
  requestHeaders;
  ...
  /// Structure is documented below.
  final pulumi.Input<
    List<SecurityPolicyRulePreconfiguredWafConfigExclusionRequestUri>
  >?
  requestUris;
      ...
      requestCookies: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                SecurityPolicyRulePreconfiguredWafConfigExclusionRequestCooky.fromMap(
      ...
      requestHeaders: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                SecurityPolicyRulePreconfiguredWafConfigExclusionRequestHeader.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      requestQueryParams: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                SecurityPolicyRulePreconfiguredWafConfigExclusionRequestQueryParam.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      requestUris: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                SecurityPolicyRulePreconfiguredWafConfigExclusionRequestUri.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
