...
import 'network_firewall_policy_state.dart';
...
class NetworkFirewallPolicy extends pulumi.CustomResource {
  ...
  /// Gets an existing [NetworkFirewallPolicy] resource's state with the given [name] and [id].
  static NetworkFirewallPolicy get(
    String name,
    pulumi.Input<String> id, {
    NetworkFirewallPolicyState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return NetworkFirewallPolicy._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [NetworkFirewallPolicy] resource.
  NetworkFirewallPolicy.reference(String urn)
    : super(
        'gcp:compute/networkFirewallPolicy:NetworkFirewallPolicy',
