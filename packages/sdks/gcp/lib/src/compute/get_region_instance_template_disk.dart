...
class GetRegionInstanceTemplateDisk {
  ...
  final pulumi.Input<List<GetRegionInstanceTemplateDiskDiskEncryptionKey>> diskEncryptionKeys;
  ...
  final pulumi.Input<List<GetRegionInstanceTemplateDiskSourceImageEncryptionKey>> sourceImageEncryptionKeys;
  ...
  final pulumi.Input<List<GetRegionInstanceTemplateDiskSourceSnapshotEncryptionKey>> sourceSnapshotEncryptionKeys;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'diskEncryptionKeys': pulumi.Input.mapInputValue<List<GetRegionInstanceTemplateDiskDiskEncryptionKey>, List<Map<String, dynamic>>>(diskEncryptionKeys, (value) => pulumi.Input.encodeList<GetRegionInstanceTemplateDiskDiskEncryptionKey, Map<String, dynamic>>(value, (value) => value.toMap())),
      'diskName': diskName,
      ...
      'sourceImageEncryptionKeys': pulumi.Input.mapInputValue<List<GetRegionInstanceTemplateDiskSourceImageEncryptionKey>, List<Map<String, dynamic>>>(sourceImageEncryptionKeys, (value) => pulumi.Input.encodeList<GetRegionInstanceTemplateDiskSourceImageEncryptionKey, Map<String, dynamic>>(value, (value) => value.toMap())),
      'sourceSnapshot': sourceSnapshot,
      'sourceSnapshotEncryptionKeys': pulumi.Input.mapInputValue<List<GetRegionInstanceTemplateDiskSourceSnapshotEncryptionKey>, List<Map<String, dynamic>>>(sourceSnapshotEncryptionKeys, (value) => pulumi.Input.encodeList<GetRegionInstanceTemplateDiskSourceSnapshotEncryptionKey, Map<String, dynamic>>(value, (value) => value.toMap())),
      'type': type,
    };
  }
  ...
  factory GetRegionInstanceTemplateDisk.fromMap(Map<String, dynamic> map) {
    return GetRegionInstanceTemplateDisk(
      ...
      diskEncryptionKeys: pulumi.Input.fromValue(pulumi.Input.decodeList<GetRegionInstanceTemplateDiskDiskEncryptionKey>(map['diskEncryptionKeys']!, (value) => GetRegionInstanceTemplateDiskDiskEncryptionKey.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      sourceImageEncryptionKeys: pulumi.Input.fromValue(pulumi.Input.decodeList<GetRegionInstanceTemplateDiskSourceImageEncryptionKey>(map['sourceImageEncryptionKeys']!, (value) => GetRegionInstanceTemplateDiskSourceImageEncryptionKey.fromMap((value as Map).cast<String, dynamic>()))),
      sourceSnapshot: pulumi.Input.fromValue(map['sourceSnapshot'] as String),
      sourceSnapshotEncryptionKeys: pulumi.Input.fromValue(pulumi.Input.decodeList<GetRegionInstanceTemplateDiskSourceSnapshotEncryptionKey>(map['sourceSnapshotEncryptionKeys']!, (value) => GetRegionInstanceTemplateDiskSourceSnapshotEncryptionKey.fromMap((value as Map).cast<String, dynamic>()))),
