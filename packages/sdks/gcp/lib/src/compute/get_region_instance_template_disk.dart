...
class GetRegionInstanceTemplateDisk {
  ...
  final pulumi.Input<List<GetRegionInstanceTemplateDiskDiskEncryptionKey>>
  diskEncryptionKeys;
  ...
  final pulumi.Input<
    List<GetRegionInstanceTemplateDiskSourceImageEncryptionKey>
  >
  ...
  final pulumi.Input<
    List<GetRegionInstanceTemplateDiskSourceSnapshotEncryptionKey>
  >
    ...
    return <String, dynamic>{
      ...
      'diskEncryptionKeys':
          pulumi.Input.mapInputValue<
            List<GetRegionInstanceTemplateDiskDiskEncryptionKey>,
  ...
  factory GetRegionInstanceTemplateDisk.fromMap(Map<String, dynamic> map) {
    return GetRegionInstanceTemplateDisk(
      ...
      diskEncryptionKeys: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetRegionInstanceTemplateDiskDiskEncryptionKey>(
      ...
      sourceImageEncryptionKeys: pulumi.Input.fromValue(
      ...
      sourceSnapshotEncryptionKeys: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetRegionInstanceTemplateDiskSourceSnapshotEncryptionKey
        >(
