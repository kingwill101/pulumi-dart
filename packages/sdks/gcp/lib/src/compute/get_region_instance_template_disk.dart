...
class GetRegionInstanceTemplateDisk {
  ...
  factory GetRegionInstanceTemplateDisk.fromMap(Map<String, dynamic> map) {
    return GetRegionInstanceTemplateDisk(
      ...
      diskEncryptionKeys: (pulumi.Input.decodeList<GetRegionInstanceTemplateDiskDiskEncryptionKey>(map['diskEncryptionKeys'], (value) => GetRegionInstanceTemplateDiskDiskEncryptionKey.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      sourceImageEncryptionKeys: (pulumi.Input.decodeList<GetRegionInstanceTemplateDiskSourceImageEncryptionKey>(map['sourceImageEncryptionKeys'], (value) => GetRegionInstanceTemplateDiskSourceImageEncryptionKey.fromMap((value as Map).cast<String, dynamic>()))).input(),
      sourceSnapshot: (map['sourceSnapshot'] as String).input(),
      sourceSnapshotEncryptionKeys: (pulumi.Input.decodeList<GetRegionInstanceTemplateDiskSourceSnapshotEncryptionKey>(map['sourceSnapshotEncryptionKeys'], (value) => GetRegionInstanceTemplateDiskSourceSnapshotEncryptionKey.fromMap((value as Map).cast<String, dynamic>()))).input(),
