...
///   display_name = "Custom SA for VM Instance"
/// }
/// resource "gcp_compute_instance" "confidential_instance" {
///   network_interfaces {
///     access_configs {
///     }
///     network = "default"
...
class Instance extends pulumi.CustomResource {
  ...
  /// this configuration option are detailed below.
  late final pulumi.Output<InstanceWorkloadIdentityConfig?> workloadIdentityConfig;
  ...
  Instance(
    ...
    attachedDisks = registerOutput<List<InstanceAttachedDisk>?>('attachedDisks', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return pulumi.Input.decodeList<InstanceAttachedDisk>(guardedValue, (value) => InstanceAttachedDisk.fromMap((value as Map).cast<String, dynamic>())); });
    ...
    guestAccelerators = registerOutput<List<InstanceGuestAccelerator>>('guestAccelerators', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return pulumi.Input.decodeList<InstanceGuestAccelerator>(guardedValue, (value) => InstanceGuestAccelerator.fromMap((value as Map).cast<String, dynamic>())); });
    ...
    scratchDisks = registerOutput<List<InstanceScratchDisk>?>('scratchDisks', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return pulumi.Input.decodeList<InstanceScratchDisk>(guardedValue, (value) => InstanceScratchDisk.fromMap((value as Map).cast<String, dynamic>())); });
    ...
    workloadIdentityConfig = registerOutput<InstanceWorkloadIdentityConfig?>('workloadIdentityConfig', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return InstanceWorkloadIdentityConfig.fromMap((guardedValue as Map).cast<String, dynamic>()); });
