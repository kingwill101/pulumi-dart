...
import 'image_iam_binding_state.dart';
...
class ImageIamBinding extends pulumi.CustomResource {
  ...
  late final pulumi.Output<ImageIamBindingCondition?> condition;
  ...
  /// [args] Arguments used to configure this [ImageIamBinding]. {@macro pulumi_compute_image_iam_binding_image_iam_binding_args_doc}
  ...
  ImageIamBinding(
    ...
    condition = registerOutput<ImageIamBindingCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ImageIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [ImageIamBinding] resource's state with the given [name] and [id].
  static ImageIamBinding get(
    String name,
    pulumi.Input<String> id, {
    ImageIamBindingState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return ImageIamBinding._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [ImageIamBinding] resource.
  ImageIamBinding.reference(String urn)
    : super(
        'gcp:compute/imageIamBinding:ImageIamBinding',
