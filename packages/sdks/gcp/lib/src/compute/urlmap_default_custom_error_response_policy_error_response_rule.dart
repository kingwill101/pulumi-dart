...
class URLMapDefaultCustomErrorResponsePolicyErrorResponseRule {
  ...
  /// Creates a new [URLMapDefaultCustomErrorResponsePolicyErrorResponseRule].
  ...
  const URLMapDefaultCustomErrorResponsePolicyErrorResponseRule({
  ...
  factory URLMapDefaultCustomErrorResponsePolicyErrorResponseRule.fromMap(Map<String, dynamic> map) {
    return URLMapDefaultCustomErrorResponsePolicyErrorResponseRule(
