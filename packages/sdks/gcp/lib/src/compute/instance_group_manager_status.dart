...
class InstanceGroupManagerStatus {
  ...
  const InstanceGroupManagerStatus({
  ...
  factory InstanceGroupManagerStatus.fromMap(Map<String, dynamic> map) {
    return InstanceGroupManagerStatus(
      allInstancesConfigs: (() { final guardedValue = map['allInstancesConfigs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InstanceGroupManagerStatusAllInstancesConfig>(guardedValue, (value) => InstanceGroupManagerStatusAllInstancesConfig.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      statefuls: (() { final guardedValue = map['statefuls']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InstanceGroupManagerStatusStateful>(guardedValue, (value) => InstanceGroupManagerStatusStateful.fromMap((value as Map).cast<String, dynamic>()))); })(),
      versionTargets: (() { final guardedValue = map['versionTargets']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InstanceGroupManagerStatusVersionTarget>(guardedValue, (value) => InstanceGroupManagerStatusVersionTarget.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
