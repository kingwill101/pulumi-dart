...
class RegionDiskSourceImageEncryptionKey {
  ...
  /// Creates a new [RegionDiskSourceImageEncryptionKey].
  ...
  /// [sha256] (Output)
  const RegionDiskSourceImageEncryptionKey({
    this.kmsKeyName,
  ...
  factory RegionDiskSourceImageEncryptionKey.fromMap(Map<String, dynamic> map) {
    return RegionDiskSourceImageEncryptionKey(
