...
class AutoscalerAutoscalingPolicyMetric {
  ...
  /// Creates a new [AutoscalerAutoscalingPolicyMetric].
  /// [filter] A filter string to be used as the filter string for
  /// [name] The identifier (type) of the Stackdriver Monitoring metric.
  ...
  const AutoscalerAutoscalingPolicyMetric({
    this.filter,
    required this.name,
