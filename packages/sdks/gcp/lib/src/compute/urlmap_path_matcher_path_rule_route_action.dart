...
import 'urlmap_path_matcher_path_rule_route_action_request_mirror_policy.dart';
import 'urlmap_path_matcher_path_rule_route_action_retry_policy.dart';
import 'urlmap_path_matcher_path_rule_route_action_timeout.dart';
import 'urlmap_path_matcher_path_rule_route_action_url_rewrite.dart';
...
class URLMapPathMatcherPathRuleRouteAction {
  ...
  /// Structure is documented below.
  final pulumi.Input<URLMapPathMatcherPathRuleRouteActionCorsPolicy?>? corsPolicy;
  ...
  /// Structure is documented below.
  final pulumi.Input<URLMapPathMatcherPathRuleRouteActionMaxStreamDuration?>? maxStreamDuration;
  /// Specifies the policy on how requests intended for the route's backends are
  /// shadowed to a separate mirrored backend service. Loadbalancer does not wait for
  /// responses from the shadow service. Prior to sending traffic to the shadow
  /// service, the host / authority header is suffixed with -shadow.
  /// Structure is documented below.
  final pulumi.Input<URLMapPathMatcherPathRuleRouteActionRequestMirrorPolicy?>? requestMirrorPolicy;
  /// Specifies the retry policy associated with this route.
  /// Structure is documented below.
  final pulumi.Input<URLMapPathMatcherPathRuleRouteActionRetryPolicy?>? retryPolicy;
  /// Specifies the timeout for the selected route. Timeout is computed from the time
  /// the request is has been fully processed (i.e. end-of-stream) up until the
  /// response has been completely processed. Timeout includes all retries. If not
  /// specified, the default value is 15 seconds.
  /// Structure is documented below.
  final pulumi.Input<URLMapPathMatcherPathRuleRouteActionTimeout?>? timeout;
  /// The spec to modify the URL of the request, prior to forwarding the request to
  /// the matched service
  /// Structure is documented below.
  final pulumi.Input<URLMapPathMatcherPathRuleRouteActionUrlRewrite?>? urlRewrite;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'requestMirrorPolicy': ?pulumi.Input.mapOptionalInputValue<URLMapPathMatcherPathRuleRouteActionRequestMirrorPolicy, Map<String, dynamic>>(requestMirrorPolicy, (value) => value.toMap()),
      'retryPolicy': ?pulumi.Input.mapOptionalInputValue<URLMapPathMatcherPathRuleRouteActionRetryPolicy, Map<String, dynamic>>(retryPolicy, (value) => value.toMap()),
      'timeout': ?pulumi.Input.mapOptionalInputValue<URLMapPathMatcherPathRuleRouteActionTimeout, Map<String, dynamic>>(timeout, (value) => value.toMap()),
      'urlRewrite': ?pulumi.Input.mapOptionalInputValue<URLMapPathMatcherPathRuleRouteActionUrlRewrite, Map<String, dynamic>>(urlRewrite, (value) => value.toMap()),
      'weightedBackendServices': ?pulumi.Input.mapOptionalInputValue<List<URLMapPathMatcherPathRuleRouteActionWeightedBackendService>, List<Map<String, dynamic>>>(weightedBackendServices, (value) => pulumi.Input.encodeList<URLMapPathMatcherPathRuleRouteActionWeightedBackendService, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory URLMapPathMatcherPathRuleRouteAction.fromMap(Map<String, dynamic> map) {
    return URLMapPathMatcherPathRuleRouteAction(
      ...
      requestMirrorPolicy: (() { final guardedValue = map['requestMirrorPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(URLMapPathMatcherPathRuleRouteActionRequestMirrorPolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      retryPolicy: (() { final guardedValue = map['retryPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(URLMapPathMatcherPathRuleRouteActionRetryPolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      timeout: (() { final guardedValue = map['timeout']; if (guardedValue == null) return null; return pulumi.Input.fromValue(URLMapPathMatcherPathRuleRouteActionTimeout.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      urlRewrite: (() { final guardedValue = map['urlRewrite']; if (guardedValue == null) return null; return pulumi.Input.fromValue(URLMapPathMatcherPathRuleRouteActionUrlRewrite.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      weightedBackendServices: (() { final guardedValue = map['weightedBackendServices']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<URLMapPathMatcherPathRuleRouteActionWeightedBackendService>(guardedValue, (value) => URLMapPathMatcherPathRuleRouteActionWeightedBackendService.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
