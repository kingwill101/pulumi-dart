...
class ReservationShareSettings {
  ...
  ReservationShareSettings({this.projectMaps, this.projects, this.shareType});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'projectMaps':
          ?pulumi.Input.mapOptionalInputValue<
            List<ReservationShareSettingsProjectMap>,
    ...
    return ReservationShareSettings(
      projectMaps: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ReservationShareSettingsProjectMap>(
            guardedValue,
