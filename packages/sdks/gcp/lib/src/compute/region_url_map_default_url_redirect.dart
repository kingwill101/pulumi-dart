...
class RegionUrlMapDefaultUrlRedirect {
  ...
  /// Creates a new [RegionUrlMapDefaultUrlRedirect].
  ...
  const RegionUrlMapDefaultUrlRedirect({
    this.hostRedirect,
    this.httpsRedirect,
    this.pathRedirect,
    this.prefixRedirect,
  ...
  factory RegionUrlMapDefaultUrlRedirect.fromMap(Map<String, dynamic> map) {
    return RegionUrlMapDefaultUrlRedirect(
