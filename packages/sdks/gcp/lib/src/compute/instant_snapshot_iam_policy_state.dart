...
class InstantSnapshotIamPolicyState {
  ...
  /// Creates a new [InstantSnapshotIamPolicyState].
  ...
  const InstantSnapshotIamPolicyState({
    this.etag,
    this.name,
    this.policyData,
    this.project,
  ...
  factory InstantSnapshotIamPolicyState.fromMap(Map<String, dynamic> map) {
    return InstantSnapshotIamPolicyState(
