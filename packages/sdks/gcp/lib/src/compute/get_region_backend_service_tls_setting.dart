...
class GetRegionBackendServiceTlsSetting {
  ...
  /// subjectAltNames.
  final pulumi.Input<List<GetRegionBackendServiceTlsSettingSubjectAltName>> subjectAltNames;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'sni': sni,
      'subjectAltNames': pulumi.Input.mapInputValue<List<GetRegionBackendServiceTlsSettingSubjectAltName>, List<Map<String, dynamic>>>(subjectAltNames, (value) => pulumi.Input.encodeList<GetRegionBackendServiceTlsSettingSubjectAltName, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory GetRegionBackendServiceTlsSetting.fromMap(Map<String, dynamic> map) {
    return GetRegionBackendServiceTlsSetting(
      authenticationConfig: (map['authenticationConfig'] as String).input(),
      sni: (map['sni'] as String).input(),
      subjectAltNames: (pulumi.Input.decodeList<GetRegionBackendServiceTlsSettingSubjectAltName>(map['subjectAltNames'], (value) => GetRegionBackendServiceTlsSettingSubjectAltName.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
