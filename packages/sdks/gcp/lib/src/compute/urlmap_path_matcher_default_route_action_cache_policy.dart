...
import 'urlmap_path_matcher_default_route_action_cache_policy_cache_key_policy.dart';
import 'urlmap_path_matcher_default_route_action_cache_policy_client_ttl.dart';
import 'urlmap_path_matcher_default_route_action_cache_policy_default_ttl.dart';
import 'urlmap_path_matcher_default_route_action_cache_policy_max_ttl.dart';
import 'urlmap_path_matcher_default_route_action_cache_policy_negative_caching_policy.dart';
import 'urlmap_path_matcher_default_route_action_cache_policy_serve_while_stale.dart';

class URLMapPathMatcherDefaultRouteActionCachePolicy {
  ...
  final pulumi.Input<URLMapPathMatcherDefaultRouteActionCachePolicyCacheKeyPolicy>? cacheKeyPolicy;
  ...
  /// Structure is documented below.
  final pulumi.Input<URLMapPathMatcherDefaultRouteActionCachePolicyClientTtl>? clientTtl;
  ...
  /// USE_ORIGIN_HEADERS.
  /// Structure is documented below.
  final pulumi.Input<URLMapPathMatcherDefaultRouteActionCachePolicyDefaultTtl>? defaultTtl;
  ...
  /// mode.
  /// Structure is documented below.
  final pulumi.Input<URLMapPathMatcherDefaultRouteActionCachePolicyMaxTtl>? maxTtl;
  ...
  /// a policy exists.
  /// Structure is documented below.
  final pulumi.Input<List<URLMapPathMatcherDefaultRouteActionCachePolicyNegativeCachingPolicy>>? negativeCachingPolicies;
  ...
  /// Structure is documented below.
  final pulumi.Input<URLMapPathMatcherDefaultRouteActionCachePolicyServeWhileStale>? serveWhileStale;

  /// Creates a new [URLMapPathMatcherDefaultRouteActionCachePolicy].
  ...
  const URLMapPathMatcherDefaultRouteActionCachePolicy({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'cacheKeyPolicy': ?pulumi.Input.mapOptionalInputValue<URLMapPathMatcherDefaultRouteActionCachePolicyCacheKeyPolicy, Map<String, dynamic>>(cacheKeyPolicy, (value) => value.toMap()),
      'cacheMode': ?cacheMode,
      'clientTtl': ?pulumi.Input.mapOptionalInputValue<URLMapPathMatcherDefaultRouteActionCachePolicyClientTtl, Map<String, dynamic>>(clientTtl, (value) => value.toMap()),
      'defaultTtl': ?pulumi.Input.mapOptionalInputValue<URLMapPathMatcherDefaultRouteActionCachePolicyDefaultTtl, Map<String, dynamic>>(defaultTtl, (value) => value.toMap()),
      'maxTtl': ?pulumi.Input.mapOptionalInputValue<URLMapPathMatcherDefaultRouteActionCachePolicyMaxTtl, Map<String, dynamic>>(maxTtl, (value) => value.toMap()),
      'negativeCaching': ?negativeCaching,
      'negativeCachingPolicies': ?pulumi.Input.mapOptionalInputValue<List<URLMapPathMatcherDefaultRouteActionCachePolicyNegativeCachingPolicy>, List<Map<String, dynamic>>>(negativeCachingPolicies, (value) => pulumi.Input.encodeList<URLMapPathMatcherDefaultRouteActionCachePolicyNegativeCachingPolicy, Map<String, dynamic>>(value, (value) => value.toMap())),
      'requestCoalescing': ?requestCoalescing,
      'serveWhileStale': ?pulumi.Input.mapOptionalInputValue<URLMapPathMatcherDefaultRouteActionCachePolicyServeWhileStale, Map<String, dynamic>>(serveWhileStale, (value) => value.toMap()),
    };
  }

  factory URLMapPathMatcherDefaultRouteActionCachePolicy.fromMap(Map<String, dynamic> map) {
    return URLMapPathMatcherDefaultRouteActionCachePolicy(
      ...
      cacheKeyPolicy: (() { final guardedValue = map['cacheKeyPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(URLMapPathMatcherDefaultRouteActionCachePolicyCacheKeyPolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      clientTtl: (() { final guardedValue = map['clientTtl']; if (guardedValue == null) return null; return pulumi.Input.fromValue(URLMapPathMatcherDefaultRouteActionCachePolicyClientTtl.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      defaultTtl: (() { final guardedValue = map['defaultTtl']; if (guardedValue == null) return null; return pulumi.Input.fromValue(URLMapPathMatcherDefaultRouteActionCachePolicyDefaultTtl.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      maxTtl: (() { final guardedValue = map['maxTtl']; if (guardedValue == null) return null; return pulumi.Input.fromValue(URLMapPathMatcherDefaultRouteActionCachePolicyMaxTtl.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      negativeCachingPolicies: (() { final guardedValue = map['negativeCachingPolicies']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<URLMapPathMatcherDefaultRouteActionCachePolicyNegativeCachingPolicy>(guardedValue, (value) => URLMapPathMatcherDefaultRouteActionCachePolicyNegativeCachingPolicy.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      serveWhileStale: (() { final guardedValue = map['serveWhileStale']; if (guardedValue == null) return null; return pulumi.Input.fromValue(URLMapPathMatcherDefaultRouteActionCachePolicyServeWhileStale.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
