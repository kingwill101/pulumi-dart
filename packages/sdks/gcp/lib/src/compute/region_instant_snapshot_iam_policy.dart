...
import 'region_instant_snapshot_iam_policy_state.dart';
...
class RegionInstantSnapshotIamPolicy extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [RegionInstantSnapshotIamPolicy]. {@macro pulumi_compute_region_instant_snapshot_iam_policy_region_instant_snapshot_iam_policy_args_doc}
  ...
  /// Gets an existing [RegionInstantSnapshotIamPolicy] resource's state with the given [name] and [id].
  static RegionInstantSnapshotIamPolicy get(
    String name,
    pulumi.Input<String> id, {
    RegionInstantSnapshotIamPolicyState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return RegionInstantSnapshotIamPolicy._get(
      name,
      state: state?.toMap(),
  ...
  RegionInstantSnapshotIamPolicy._get(
    String name, {
  ...
  /// Creates a typed reference to an existing [RegionInstantSnapshotIamPolicy] resource.
  RegionInstantSnapshotIamPolicy.reference(String urn)
    : super(
        'gcp:compute/regionInstantSnapshotIamPolicy:RegionInstantSnapshotIamPolicy',
