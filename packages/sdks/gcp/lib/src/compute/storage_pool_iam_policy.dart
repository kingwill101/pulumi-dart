...
import 'storage_pool_iam_policy_state.dart';
...
class StoragePoolIamPolicy extends pulumi.CustomResource {
  ...
  /// Gets an existing [StoragePoolIamPolicy] resource's state with the given [name] and [id].
  static StoragePoolIamPolicy get(
    String name,
