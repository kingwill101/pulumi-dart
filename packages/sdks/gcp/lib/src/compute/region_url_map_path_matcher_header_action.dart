...
class RegionUrlMapPathMatcherHeaderAction {
  ...
  final pulumi.Input<
    List<RegionUrlMapPathMatcherHeaderActionRequestHeadersToAdd>
  >?
  ...
  /// Structure is documented below.
  final pulumi.Input<
    List<RegionUrlMapPathMatcherHeaderActionResponseHeadersToAdd>
  >?
      ...
      requestHeadersToAdds: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                RegionUrlMapPathMatcherHeaderActionRequestHeadersToAdd.fromMap(
      ...
      responseHeadersToAdds: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                RegionUrlMapPathMatcherHeaderActionResponseHeadersToAdd.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
