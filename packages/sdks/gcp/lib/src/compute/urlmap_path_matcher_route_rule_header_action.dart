...
class URLMapPathMatcherRouteRuleHeaderAction {
  ...
  final pulumi.Input<
    List<URLMapPathMatcherRouteRuleHeaderActionRequestHeadersToAdd>
  >?
  ...
  /// Structure is documented below.
  final pulumi.Input<
    List<URLMapPathMatcherRouteRuleHeaderActionResponseHeadersToAdd>
  >?
      ...
      requestHeadersToAdds: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                URLMapPathMatcherRouteRuleHeaderActionRequestHeadersToAdd.fromMap(
      ...
      responseHeadersToAdds: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                URLMapPathMatcherRouteRuleHeaderActionResponseHeadersToAdd.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
