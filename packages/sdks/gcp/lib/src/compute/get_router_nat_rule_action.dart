...
class GetRouterNatRuleAction {
  ...
  /// Creates a new [GetRouterNatRuleAction].
  ...
  factory GetRouterNatRuleAction.fromMap(Map<String, dynamic> map) {
    return GetRouterNatRuleAction(
