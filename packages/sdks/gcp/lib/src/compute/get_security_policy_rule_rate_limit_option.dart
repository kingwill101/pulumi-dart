...
class GetSecurityPolicyRuleRateLimitOption {
  ...
  final pulumi.Input<List<GetSecurityPolicyRuleRateLimitOptionBanThreshold>>
  banThresholds;
  ...
  final pulumi.Input<
    List<GetSecurityPolicyRuleRateLimitOptionEnforceOnKeyConfig>
  >
  enforceOnKeyConfigs;
  ...
  final pulumi.Input<
    List<GetSecurityPolicyRuleRateLimitOptionExceedRedirectOption>
  >
    ...
    return <String, dynamic>{
      ...
      'banThresholds':
          pulumi.Input.mapInputValue<
            List<GetSecurityPolicyRuleRateLimitOptionBanThreshold>,
  ...
  factory GetSecurityPolicyRuleRateLimitOption.fromMap(
    ...
    return GetSecurityPolicyRuleRateLimitOption(
      ...
      banThresholds: pulumi.Input.fromValue(
        pulumi
      ...
      rateLimitThresholds: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetSecurityPolicyRuleRateLimitOptionRateLimitThreshold
        >(
