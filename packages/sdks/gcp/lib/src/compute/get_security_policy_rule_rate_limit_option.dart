...
class GetSecurityPolicyRuleRateLimitOption {
  ...
  const GetSecurityPolicyRuleRateLimitOption({
  ...
  factory GetSecurityPolicyRuleRateLimitOption.fromMap(Map<String, dynamic> map) {
    return GetSecurityPolicyRuleRateLimitOption(
      ...
      enforceOnKeyConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetSecurityPolicyRuleRateLimitOptionEnforceOnKeyConfig>(map['enforceOnKeyConfigs']!, (value) => GetSecurityPolicyRuleRateLimitOptionEnforceOnKeyConfig.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      exceedRedirectOptions: pulumi.Input.fromValue(pulumi.Input.decodeList<GetSecurityPolicyRuleRateLimitOptionExceedRedirectOption>(map['exceedRedirectOptions']!, (value) => GetSecurityPolicyRuleRateLimitOptionExceedRedirectOption.fromMap((value as Map).cast<String, dynamic>()))),
      rateLimitThresholds: pulumi.Input.fromValue(pulumi.Input.decodeList<GetSecurityPolicyRuleRateLimitOptionRateLimitThreshold>(map['rateLimitThresholds']!, (value) => GetSecurityPolicyRuleRateLimitOptionRateLimitThreshold.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
