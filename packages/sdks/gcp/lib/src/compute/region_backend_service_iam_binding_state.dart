...
class RegionBackendServiceIamBindingState {
  ...
  /// Creates a new [RegionBackendServiceIamBindingState].
  ...
  factory RegionBackendServiceIamBindingState.fromMap(Map<String, dynamic> map) {
    return RegionBackendServiceIamBindingState(
