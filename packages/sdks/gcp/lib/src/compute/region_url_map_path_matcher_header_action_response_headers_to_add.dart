...
class RegionUrlMapPathMatcherHeaderActionResponseHeadersToAdd {
  ...
  const RegionUrlMapPathMatcherHeaderActionResponseHeadersToAdd({
    this.headerName,
    this.headerValue,
    this.replace,
  });
  ...
  factory RegionUrlMapPathMatcherHeaderActionResponseHeadersToAdd.fromMap(Map<String, dynamic> map) {
