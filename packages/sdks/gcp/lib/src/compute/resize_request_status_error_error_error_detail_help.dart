...
class ResizeRequestStatusErrorErrorErrorDetailHelp {
  ...
  final pulumi.Input<List<ResizeRequestStatusErrorErrorErrorDetailHelpLink>>?
  links;
    ...
    return <String, dynamic>{
      'links':
          ?pulumi.Input.mapOptionalInputValue<
            List<ResizeRequestStatusErrorErrorErrorDetailHelpLink>,
    ...
    return ResizeRequestStatusErrorErrorErrorDetailHelp(
      links: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => ResizeRequestStatusErrorErrorErrorDetailHelpLink.fromMap(
