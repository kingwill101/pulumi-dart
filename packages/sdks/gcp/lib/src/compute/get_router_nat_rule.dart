...
class GetRouterNatRule {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'actions': pulumi.Input.encodeList<GetRouterNatRuleAction, Map<String, dynamic>>(actions, (value) => value.toMap()),
  ...
  factory GetRouterNatRule.fromMap(Map<String, dynamic> map) {
    return GetRouterNatRule(
      actions: pulumi.Input.decodeList<GetRouterNatRuleAction>(map['actions'], (value) => GetRouterNatRuleAction.fromMap((value as Map).cast<String, dynamic>())),
