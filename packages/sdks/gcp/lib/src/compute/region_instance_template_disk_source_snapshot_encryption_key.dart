...
class RegionInstanceTemplateDiskSourceSnapshotEncryptionKey {
  ...
  /// Creates a new [RegionInstanceTemplateDiskSourceSnapshotEncryptionKey].
  ...
  /// [rsaEncryptedKey] Specifies an RFC 4648 base64 encoded, RSA-wrapped 2048-bit [customer-supplied encryption key](https://cloud.google.com/compute/docs/disks/customer-supplied-encryption) to decrypt this snapshot. Only one of `kmsKeySelfLink`, `rsaEncryptedKey` and `rawKey`
  const RegionInstanceTemplateDiskSourceSnapshotEncryptionKey({
    this.kmsKeySelfLink,
