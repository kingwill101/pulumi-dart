...
class FutureReservationStatusLastKnownGoodState {
  ...
  factory FutureReservationStatusLastKnownGoodState.fromMap(Map<String, dynamic> map) {
    return FutureReservationStatusLastKnownGoodState(
      ...
      existingMatchingUsageInfo: (() { final guardedValue = map['existingMatchingUsageInfo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FutureReservationStatusLastKnownGoodStateExistingMatchingUsageInfo.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      futureReservationSpecs: (() { final guardedValue = map['futureReservationSpecs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FutureReservationStatusLastKnownGoodStateFutureReservationSpecs.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
