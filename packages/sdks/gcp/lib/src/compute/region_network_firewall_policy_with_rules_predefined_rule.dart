...
class RegionNetworkFirewallPolicyWithRulesPredefinedRule {
  ...
  final pulumi.Input<
    List<RegionNetworkFirewallPolicyWithRulesPredefinedRuleMatch>
  >?
  matches;
      ...
      matches: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                RegionNetworkFirewallPolicyWithRulesPredefinedRuleMatch.fromMap(
      ...
      targetSecureTags: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                RegionNetworkFirewallPolicyWithRulesPredefinedRuleTargetSecureTag.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
