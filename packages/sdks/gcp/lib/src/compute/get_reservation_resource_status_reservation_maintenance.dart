...
class GetReservationResourceStatusReservationMaintenance {
  ...
  final List<GetReservationResourceStatusReservationMaintenanceUpcomingGroupMaintenance> upcomingGroupMaintenances;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'upcomingGroupMaintenances': pulumi.Input.encodeList<GetReservationResourceStatusReservationMaintenanceUpcomingGroupMaintenance, Map<String, dynamic>>(upcomingGroupMaintenances, (value) => value.toMap()),
    };
  }
  ...
  factory GetReservationResourceStatusReservationMaintenance.fromMap(Map<String, dynamic> map) {
    return GetReservationResourceStatusReservationMaintenance(
      ...
      upcomingGroupMaintenances: pulumi.Input.decodeList<GetReservationResourceStatusReservationMaintenanceUpcomingGroupMaintenance>(map['upcomingGroupMaintenances'], (value) => GetReservationResourceStatusReservationMaintenanceUpcomingGroupMaintenance.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
