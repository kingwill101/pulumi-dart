...
class DiskIamBindingState {
  ...
  /// Creates a new [DiskIamBindingState].
  /// [condition] Optional.
  ...
  DiskIamBindingState({
    pulumi.Output<DiskIamBindingCondition>? condition,
    ...
    pulumi.Output<String>? zone,
      ...
      condition = pulumi.Input.asOptionalInput<DiskIamBindingCondition>(condition),
  ...
  factory DiskIamBindingState.fromMap(Map<String, dynamic> map) {
    return DiskIamBindingState(
      condition: map['condition'] == null ? null : pulumi.Output.create<DiskIamBindingCondition>(DiskIamBindingCondition.fromMap((map['condition'] as Map).cast<String, dynamic>())),
