...
class GetRegionInstanceTemplateScheduling {
  ...
  final pulumi.Input<List<GetRegionInstanceTemplateSchedulingGracefulShutdown>>
  gracefulShutdowns;
  ...
  /// hour.
  final pulumi.Input<
    List<GetRegionInstanceTemplateSchedulingLocalSsdRecoveryTimeout>
  >
  ...
  final pulumi.Input<List<GetRegionInstanceTemplateSchedulingMaxRunDuration>>
  maxRunDurations;
  ...
  final pulumi.Input<List<GetRegionInstanceTemplateSchedulingNodeAffinity>>
  nodeAffinities;
  ...
  final pulumi.Input<
    List<GetRegionInstanceTemplateSchedulingOnInstanceStopAction>
  >
    ...
    return <String, dynamic>{
      ...
      'gracefulShutdowns':
          pulumi.Input.mapInputValue<
            List<GetRegionInstanceTemplateSchedulingGracefulShutdown>,
      ...
      'maxRunDurations':
          pulumi.Input.mapInputValue<
            List<GetRegionInstanceTemplateSchedulingMaxRunDuration>,
            List<Map<String, dynamic>>
          >(
            maxRunDurations,
            (value) =>
      ...
      'nodeAffinities':
          pulumi.Input.mapInputValue<
            List<GetRegionInstanceTemplateSchedulingNodeAffinity>,
            List<Map<String, dynamic>>
          >(
            nodeAffinities,
            (value) =>
    ...
    return GetRegionInstanceTemplateScheduling(
      ...
      localSsdRecoveryTimeouts: pulumi.Input.fromValue(
        ...
        >(
          ...
          (value) =>
              GetRegionInstanceTemplateSchedulingLocalSsdRecoveryTimeout.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
