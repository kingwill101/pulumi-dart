...
class GetRegionInstanceTemplateNetworkInterface {
  final pulumi.Input<
    List<GetRegionInstanceTemplateNetworkInterfaceAccessConfig>
  >
  accessConfigs;
  ...
  final pulumi.Input<
    List<GetRegionInstanceTemplateNetworkInterfaceAliasIpRange>
  >
  aliasIpRanges;
  ...
  final pulumi.Input<
    List<GetRegionInstanceTemplateNetworkInterfaceIpv6AccessConfig>
  >
  ipv6AccessConfigs;
