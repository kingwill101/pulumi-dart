...
class RegionInstanceGroupManagerStatus {
  ...
  const RegionInstanceGroupManagerStatus({
  ...
  factory RegionInstanceGroupManagerStatus.fromMap(Map<String, dynamic> map) {
    return RegionInstanceGroupManagerStatus(
      allInstancesConfigs: (() { final guardedValue = map['allInstancesConfigs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RegionInstanceGroupManagerStatusAllInstancesConfig>(guardedValue, (value) => RegionInstanceGroupManagerStatusAllInstancesConfig.fromMap((value as Map).cast<String, dynamic>()))); })(),
      isStable: (() { final guardedValue = map['isStable']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      statefuls: (() { final guardedValue = map['statefuls']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RegionInstanceGroupManagerStatusStateful>(guardedValue, (value) => RegionInstanceGroupManagerStatusStateful.fromMap((value as Map).cast<String, dynamic>()))); })(),
      versionTargets: (() { final guardedValue = map['versionTargets']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RegionInstanceGroupManagerStatusVersionTarget>(guardedValue, (value) => RegionInstanceGroupManagerStatusVersionTarget.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
