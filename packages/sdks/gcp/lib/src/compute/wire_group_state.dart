...
class WireGroupState {
  ...
  factory WireGroupState.fromMap(Map<String, dynamic> map) {
    return WireGroupState(
      ...
      topologies: (() { final guardedValue = map['topologies']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<WireGroupTopology>(guardedValue, (value) => WireGroupTopology.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      wires: (() { final guardedValue = map['wires']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<WireGroupWire>(guardedValue, (value) => WireGroupWire.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
