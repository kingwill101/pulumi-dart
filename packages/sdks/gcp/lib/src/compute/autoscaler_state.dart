...
class AutoscalerState {
  ...
  factory AutoscalerState.fromMap(Map<String, dynamic> map) {
    return AutoscalerState(
      autoscalingPolicy: (() { final guardedValue = map['autoscalingPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AutoscalerAutoscalingPolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
