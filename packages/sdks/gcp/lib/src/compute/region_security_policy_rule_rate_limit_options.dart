...
class RegionSecurityPolicyRuleRateLimitOptions {
  ...
  /// Structure is documented below.
  final pulumi.Input<List<RegionSecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfig>>? enforceOnKeyConfigs;
  ...
  const RegionSecurityPolicyRuleRateLimitOptions({
    this.banDurationSec,
    this.banThreshold,
    this.conformAction,
    this.enforceOnKey,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'banThreshold': ?pulumi.Input.mapOptionalInputValue<RegionSecurityPolicyRuleRateLimitOptionsBanThreshold, Map<String, dynamic>>(banThreshold, (value) => value.toMap()),
      'conformAction': ?conformAction,
      'enforceOnKey': ?enforceOnKey,
      'enforceOnKeyConfigs': ?pulumi.Input.mapOptionalInputValue<List<RegionSecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfig>, List<Map<String, dynamic>>>(enforceOnKeyConfigs, (value) => pulumi.Input.encodeList<RegionSecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfig, Map<String, dynamic>>(value, (value) => value.toMap())),
      'enforceOnKeyName': ?enforceOnKeyName,
      'exceedAction': ?exceedAction,
      'rateLimitThreshold': ?pulumi.Input.mapOptionalInputValue<RegionSecurityPolicyRuleRateLimitOptionsRateLimitThreshold, Map<String, dynamic>>(rateLimitThreshold, (value) => value.toMap()),
    };
  }
  ...
  factory RegionSecurityPolicyRuleRateLimitOptions.fromMap(Map<String, dynamic> map) {
    return RegionSecurityPolicyRuleRateLimitOptions(
      ...
      banThreshold: (() { final guardedValue = map['banThreshold']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionSecurityPolicyRuleRateLimitOptionsBanThreshold.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      enforceOnKeyConfigs: (() { final guardedValue = map['enforceOnKeyConfigs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RegionSecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfig>(guardedValue, (value) => RegionSecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfig.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      rateLimitThreshold: (() { final guardedValue = map['rateLimitThreshold']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionSecurityPolicyRuleRateLimitOptionsRateLimitThreshold.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
