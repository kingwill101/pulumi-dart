...
class RegionUrlMapPathMatcherDefaultRouteActionMaxStreamDuration {
  ...
  factory RegionUrlMapPathMatcherDefaultRouteActionMaxStreamDuration.fromMap(Map<String, dynamic> map) {
    return RegionUrlMapPathMatcherDefaultRouteActionMaxStreamDuration(
