...
class RegionUrlMapPathMatcherDefaultRouteAction {
  ...
  final pulumi.Input<RegionUrlMapPathMatcherDefaultRouteActionCorsPolicy>?
  corsPolicy;
  ...
  /// Structure is documented below.
  final pulumi.Input<RegionUrlMapPathMatcherDefaultRouteActionRetryPolicy>?
  retryPolicy;
  ...
  /// Not supported when the URL map is bound to a target gRPC proxy that has the validateForProxyless field set to true.
  /// Structure is documented below.
  final pulumi.Input<RegionUrlMapPathMatcherDefaultRouteActionUrlRewrite>?
  urlRewrite;
  ...
  /// Structure is documented below.
  final pulumi.Input<
    List<RegionUrlMapPathMatcherDefaultRouteActionWeightedBackendService>
  >?
