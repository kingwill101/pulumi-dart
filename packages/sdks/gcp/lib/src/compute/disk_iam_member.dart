...
import 'disk_iam_member_state.dart';
...
class DiskIamMember extends pulumi.CustomResource {
  late final pulumi.Output<DiskIamMemberCondition?> condition;
  ...
  /// Creates a new [DiskIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [DiskIamMember]. {@macro pulumi_compute_disk_iam_member_disk_iam_member_args_doc}
  ...
  DiskIamMember(
    ...
    condition = registerOutput<DiskIamMemberCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return DiskIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [DiskIamMember] resource's state with the given [name] and [id].
  static DiskIamMember get(
    String name,
    pulumi.Input<String> id, {
    DiskIamMemberState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return DiskIamMember._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [DiskIamMember] resource.
  DiskIamMember.reference(String urn)
    : super(
        'gcp:compute/diskIamMember:DiskIamMember',
