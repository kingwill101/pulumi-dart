...
class URLMapPathMatcherRouteRuleRouteAction {
  ...
  final pulumi.Input<URLMapPathMatcherRouteRuleRouteActionCorsPolicy>?
  corsPolicy;
  ...
  /// Structure is documented below.
  final pulumi.Input<URLMapPathMatcherRouteRuleRouteActionFaultInjectionPolicy>?
  ...
  /// Structure is documented below.
  final pulumi.Input<URLMapPathMatcherRouteRuleRouteActionMaxStreamDuration>?
  maxStreamDuration;
  ...
  /// Structure is documented below.
  final pulumi.Input<URLMapPathMatcherRouteRuleRouteActionRequestMirrorPolicy>?
  requestMirrorPolicy;

  /// Specifies the retry policy associated with this route.
  /// Structure is documented below.
  final pulumi.Input<URLMapPathMatcherRouteRuleRouteActionRetryPolicy>?
  retryPolicy;
  ...
  /// the matched service
  /// Structure is documented below.
  final pulumi.Input<URLMapPathMatcherRouteRuleRouteActionUrlRewrite>?
  urlRewrite;
  ...
  /// Structure is documented below.
  final pulumi.Input<
    List<URLMapPathMatcherRouteRuleRouteActionWeightedBackendService>
  >?
