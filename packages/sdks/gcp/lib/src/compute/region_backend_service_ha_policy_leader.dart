...
class RegionBackendServiceHaPolicyLeader {
  ...
  final pulumi.Input<RegionBackendServiceHaPolicyLeaderNetworkEndpoint>?
  networkEndpoint;
    ...
    return <String, dynamic>{
      ...
      'networkEndpoint':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(networkEndpoint, (value) => value.toMap()),
    };
  }
  ...
  factory RegionBackendServiceHaPolicyLeader.fromMap(Map<String, dynamic> map) {
    return RegionBackendServiceHaPolicyLeader(
      backendGroup: (() {
        final guardedValue = map['backendGroup'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      networkEndpoint: (() {
        final guardedValue = map['networkEndpoint'];
        if (guardedValue == null) return null;
