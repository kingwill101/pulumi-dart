...
class RegionBackendServiceHaPolicyLeader {
  ...
  factory RegionBackendServiceHaPolicyLeader.fromMap(Map<String, dynamic> map) {
    return RegionBackendServiceHaPolicyLeader(
      backendGroup: (() { final guardedValue = map['backendGroup']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      networkEndpoint: (() { final guardedValue = map['networkEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionBackendServiceHaPolicyLeaderNetworkEndpoint.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
