...
class FutureReservationCommitmentInfo {
  ...
  factory FutureReservationCommitmentInfo.fromMap(Map<String, dynamic> map) {
    return FutureReservationCommitmentInfo(
      commitmentName: (() { final guardedValue = map['commitmentName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      previousCommitmentTerms: (() { final guardedValue = map['previousCommitmentTerms']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
