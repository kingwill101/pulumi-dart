...
class InstantSnapshotIamMemberState {
  ...
  /// Creates a new [InstantSnapshotIamMemberState].
  ...
  const InstantSnapshotIamMemberState({
    this.condition,
    this.etag,
    this.member,
    this.name,
  ...
  factory InstantSnapshotIamMemberState.fromMap(Map<String, dynamic> map) {
    return InstantSnapshotIamMemberState(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstantSnapshotIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
