...
class URLMapPathMatcherDefaultRouteAction {
  ...
  factory URLMapPathMatcherDefaultRouteAction.fromMap(Map<String, dynamic> map) {
    return URLMapPathMatcherDefaultRouteAction(
      ...
      requestMirrorPolicy: (() { final guardedValue = map['requestMirrorPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(URLMapPathMatcherDefaultRouteActionRequestMirrorPolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      retryPolicy: (() { final guardedValue = map['retryPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(URLMapPathMatcherDefaultRouteActionRetryPolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      timeout: (() { final guardedValue = map['timeout']; if (guardedValue == null) return null; return pulumi.Input.fromValue(URLMapPathMatcherDefaultRouteActionTimeout.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      urlRewrite: (() { final guardedValue = map['urlRewrite']; if (guardedValue == null) return null; return pulumi.Input.fromValue(URLMapPathMatcherDefaultRouteActionUrlRewrite.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      weightedBackendServices: (() { final guardedValue = map['weightedBackendServices']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<URLMapPathMatcherDefaultRouteActionWeightedBackendService>(guardedValue, (value) => URLMapPathMatcherDefaultRouteActionWeightedBackendService.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
