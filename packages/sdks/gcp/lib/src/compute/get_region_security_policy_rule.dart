...
class GetRegionSecurityPolicyRule {
  ...
  factory GetRegionSecurityPolicyRule.fromMap(Map<String, dynamic> map) {
    return GetRegionSecurityPolicyRule(
      ...
      matches: (pulumi.Input.decodeList<GetRegionSecurityPolicyRuleMatch>(map['matches'], (value) => GetRegionSecurityPolicyRuleMatch.fromMap((value as Map).cast<String, dynamic>()))).input(),
      networkMatches: (pulumi.Input.decodeList<GetRegionSecurityPolicyRuleNetworkMatch>(map['networkMatches'], (value) => GetRegionSecurityPolicyRuleNetworkMatch.fromMap((value as Map).cast<String, dynamic>()))).input(),
      preconfiguredWafConfigs: (pulumi.Input.decodeList<GetRegionSecurityPolicyRulePreconfiguredWafConfig>(map['preconfiguredWafConfigs'], (value) => GetRegionSecurityPolicyRulePreconfiguredWafConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
      preview: (map['preview'] as bool).input(),
      priority: (map['priority'] as int).input(),
      rateLimitOptions: (pulumi.Input.decodeList<GetRegionSecurityPolicyRuleRateLimitOption>(map['rateLimitOptions'], (value) => GetRegionSecurityPolicyRuleRateLimitOption.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
