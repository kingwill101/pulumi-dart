...
class GetRegionSecurityPolicyRule {
  ...
  final pulumi.Input<List<GetRegionSecurityPolicyRuleNetworkMatch>>
  networkMatches;

  /// Preconfigured WAF configuration to be applied for the rule.
  /// If the rule does not evaluate preconfigured WAF rules, i.e., if evaluatePreconfiguredWaf() is not used, this field will have no effect.
  final pulumi.Input<List<GetRegionSecurityPolicyRulePreconfiguredWafConfig>>
  ...
  final pulumi.Input<List<GetRegionSecurityPolicyRuleRateLimitOption>>
  rateLimitOptions;
    ...
    return <String, dynamic>{
      ...
      'matches':
          pulumi.Input.mapInputValue<
            List<GetRegionSecurityPolicyRuleMatch>,
      ...
      'networkMatches':
          pulumi.Input.mapInputValue<
            List<GetRegionSecurityPolicyRuleNetworkMatch>,
            List<Map<String, dynamic>>
          >(
            networkMatches,
            (value) =>
      ...
      'preconfiguredWafConfigs':
          pulumi.Input.mapInputValue<
            List<GetRegionSecurityPolicyRulePreconfiguredWafConfig>,
            List<Map<String, dynamic>>
          >(
            preconfiguredWafConfigs,
            (value) =>
      ...
      'rateLimitOptions':
          pulumi.Input.mapInputValue<
            List<GetRegionSecurityPolicyRuleRateLimitOption>,
            List<Map<String, dynamic>>
          >(
            rateLimitOptions,
            (value) =>
  ...
  factory GetRegionSecurityPolicyRule.fromMap(Map<String, dynamic> map) {
    return GetRegionSecurityPolicyRule(
      ...
      matches: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetRegionSecurityPolicyRuleMatch>(
          map['matches']!,
      ...
      networkMatches: pulumi.Input.fromValue(
      ...
      preconfiguredWafConfigs: pulumi.Input.fromValue(
