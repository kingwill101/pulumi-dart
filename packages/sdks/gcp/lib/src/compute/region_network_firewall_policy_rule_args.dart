...
class RegionNetworkFirewallPolicyRuleArgs {
  ...
  RegionNetworkFirewallPolicyRuleArgs({
    ...
    required pulumi.Output<RegionNetworkFirewallPolicyRuleMatch> match,
  ...
  factory RegionNetworkFirewallPolicyRuleArgs.fromMap(Map<String, dynamic> map) {
    return RegionNetworkFirewallPolicyRuleArgs(
      ...
      match: pulumi.Output.create<RegionNetworkFirewallPolicyRuleMatch>(RegionNetworkFirewallPolicyRuleMatch.fromMap((map['match'] as Map).cast<String, dynamic>())),
