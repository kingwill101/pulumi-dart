...
import 'firewall_policy_iam_policy_args.dart';
import 'firewall_policy_iam_policy_state.dart';
...
/// &gt; **Custom Roles** If you're importing a IAM resource with a custom role, make sure to use the
/// full name of the custom role, e.g. `[projects/my-project|organizations/my-org]/roles/my-custom-role`.
class FirewallPolicyIamPolicy extends pulumi.CustomResource {
  ...
  /// Creates a new [FirewallPolicyIamPolicy].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [FirewallPolicyIamPolicy]. {@macro pulumi_compute_firewall_policy_iam_policy_firewall_policy_iam_policy_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  FirewallPolicyIamPolicy(
    String name, {
    FirewallPolicyIamPolicyArgs? args,
  ...
  /// Gets an existing [FirewallPolicyIamPolicy] resource's state with the given [name] and [id].
  static FirewallPolicyIamPolicy get(
    String name,
