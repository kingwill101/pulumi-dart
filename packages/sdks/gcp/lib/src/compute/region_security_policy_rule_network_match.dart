...
class RegionSecurityPolicyRuleNetworkMatch {
  ...
  const RegionSecurityPolicyRuleNetworkMatch({
    this.destIpRanges,
    this.destPorts,
    this.ipProtocols,
    this.srcAsns,
  ...
  factory RegionSecurityPolicyRuleNetworkMatch.fromMap(Map<String, dynamic> map) {
    return RegionSecurityPolicyRuleNetworkMatch(
      ...
      userDefinedFields: (() { final guardedValue = map['userDefinedFields']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RegionSecurityPolicyRuleNetworkMatchUserDefinedField>(guardedValue, (value) => RegionSecurityPolicyRuleNetworkMatchUserDefinedField.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
