...
import 'region_url_map_path_matcher_default_route_action_weighted_backend_service_header_action.dart';
...
class RegionUrlMapPathMatcherDefaultRouteActionWeightedBackendService {
  ...
  final pulumi.Input<RegionUrlMapPathMatcherDefaultRouteActionWeightedBackendServiceHeaderAction>? headerAction;
  /// Specifies the fraction of traffic sent to a backend service, computed as weight / (sum of all weightedBackendService weights in routeAction) .
  /// The selection of a backend service is determined only for new traffic. Once a user's request has been directed to a backend service, subsequent requests are sent to the same backend service as determined by the backend service's session affinity policy.
  /// The value must be from 0 to 1000.
  final pulumi.Input<int>? weight;

  /// Creates a new [RegionUrlMapPathMatcherDefaultRouteActionWeightedBackendService].
  ...
  const RegionUrlMapPathMatcherDefaultRouteActionWeightedBackendService({
    this.backendService,
    this.headerAction,
    this.weight,
  });
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'headerAction': ?pulumi.Input.mapOptionalInputValue<RegionUrlMapPathMatcherDefaultRouteActionWeightedBackendServiceHeaderAction, Map<String, dynamic>>(headerAction, (value) => value.toMap()),
      'weight': ?weight,
    };
  }

  factory RegionUrlMapPathMatcherDefaultRouteActionWeightedBackendService.fromMap(Map<String, dynamic> map) {
    return RegionUrlMapPathMatcherDefaultRouteActionWeightedBackendService(
      ...
      headerAction: (() { final guardedValue = map['headerAction']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionUrlMapPathMatcherDefaultRouteActionWeightedBackendServiceHeaderAction.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
