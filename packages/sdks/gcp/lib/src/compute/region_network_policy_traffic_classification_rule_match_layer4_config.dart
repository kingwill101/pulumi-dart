...
class RegionNetworkPolicyTrafficClassificationRuleMatchLayer4Config {
  ...
  /// Creates a new [RegionNetworkPolicyTrafficClassificationRuleMatchLayer4Config].
  /// [ipProtocol] The IP protocol to which this rule applies. The protocol type is required when creating a traffic classification rule.
  ...
  const RegionNetworkPolicyTrafficClassificationRuleMatchLayer4Config({
  ...
  factory RegionNetworkPolicyTrafficClassificationRuleMatchLayer4Config.fromMap(Map<String, dynamic> map) {
    return RegionNetworkPolicyTrafficClassificationRuleMatchLayer4Config(
