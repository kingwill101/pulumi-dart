...
class InstanceFromMachineImageBootDisk {
  ...
  const InstanceFromMachineImageBootDisk({
    this.autoDelete,
    this.deviceName,
  ...
  factory InstanceFromMachineImageBootDisk.fromMap(Map<String, dynamic> map) {
    return InstanceFromMachineImageBootDisk(
      ...
      initializeParams: (() { final guardedValue = map['initializeParams']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceFromMachineImageBootDiskInitializeParams.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
