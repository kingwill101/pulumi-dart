...
class InstanceFromMachineImageBootDisk {
  ...
  factory InstanceFromMachineImageBootDisk.fromMap(Map<String, dynamic> map) {
    return InstanceFromMachineImageBootDisk(
      ...
      initializeParams: map['initializeParams'] == null ? null : InstanceFromMachineImageBootDiskInitializeParams.fromMap((map['initializeParams'] as Map).cast<String, dynamic>()),
