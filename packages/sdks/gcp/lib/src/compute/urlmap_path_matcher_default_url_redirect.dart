...
class URLMapPathMatcherDefaultUrlRedirect {
  ...
  /// Creates a new [URLMapPathMatcherDefaultUrlRedirect].
  ...
  const URLMapPathMatcherDefaultUrlRedirect({
    this.hostRedirect,
    this.httpsRedirect,
    this.pathRedirect,
    this.prefixRedirect,
  ...
  factory URLMapPathMatcherDefaultUrlRedirect.fromMap(Map<String, dynamic> map) {
