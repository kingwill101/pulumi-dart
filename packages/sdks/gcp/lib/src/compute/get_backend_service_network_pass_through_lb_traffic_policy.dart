...
class GetBackendServiceNetworkPassThroughLbTrafficPolicy {
  ...
  final pulumi.Input<List<GetBackendServiceNetworkPassThroughLbTrafficPolicyZonalAffinity>> zonalAffinities;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'zonalAffinities': pulumi.Input.mapInputValue<List<GetBackendServiceNetworkPassThroughLbTrafficPolicyZonalAffinity>, List<Map<String, dynamic>>>(zonalAffinities, (value) => pulumi.Input.encodeList<GetBackendServiceNetworkPassThroughLbTrafficPolicyZonalAffinity, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory GetBackendServiceNetworkPassThroughLbTrafficPolicy.fromMap(Map<String, dynamic> map) {
    return GetBackendServiceNetworkPassThroughLbTrafficPolicy(
      zonalAffinities: pulumi.Input.fromValue(pulumi.Input.decodeList<GetBackendServiceNetworkPassThroughLbTrafficPolicyZonalAffinity>(map['zonalAffinities']!, (value) => GetBackendServiceNetworkPassThroughLbTrafficPolicyZonalAffinity.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
