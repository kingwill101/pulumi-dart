...
class GetBackendServiceOutlierDetectionBaseEjectionTime {
  ...
  /// Creates a new [GetBackendServiceOutlierDetectionBaseEjectionTime].
  ...
  factory GetBackendServiceOutlierDetectionBaseEjectionTime.fromMap(
