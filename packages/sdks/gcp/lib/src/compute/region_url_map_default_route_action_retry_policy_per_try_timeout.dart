...
class RegionUrlMapDefaultRouteActionRetryPolicyPerTryTimeout {
  ...
  /// Creates a new [RegionUrlMapDefaultRouteActionRetryPolicyPerTryTimeout].
  ...
  const RegionUrlMapDefaultRouteActionRetryPolicyPerTryTimeout({
    this.nanos,
    this.seconds,
  });
  ...
  factory RegionUrlMapDefaultRouteActionRetryPolicyPerTryTimeout.fromMap(Map<String, dynamic> map) {
