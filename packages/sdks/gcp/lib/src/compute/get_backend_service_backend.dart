...
import 'get_backend_service_backend_custom_metric.dart';
...
class GetBackendServiceBackend {
  ...
  final pulumi.Input<List<GetBackendServiceBackendCustomMetric>> customMetrics;
  ...
  /// Creates a new [GetBackendServiceBackend].
  ...
  const GetBackendServiceBackend({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'customMetrics': pulumi.Input.mapInputValue<List<GetBackendServiceBackendCustomMetric>, List<Map<String, dynamic>>>(customMetrics, (value) => pulumi.Input.encodeList<GetBackendServiceBackendCustomMetric, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory GetBackendServiceBackend.fromMap(Map<String, dynamic> map) {
    return GetBackendServiceBackend(
      ...
      capacityScaler: pulumi.Input.fromValue((map['capacityScaler'] as num).toDouble()),
      customMetrics: pulumi.Input.fromValue(pulumi.Input.decodeList<GetBackendServiceBackendCustomMetric>(map['customMetrics']!, (value) => GetBackendServiceBackendCustomMetric.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      maxConnectionsPerEndpoint: pulumi.Input.fromValue((map['maxConnectionsPerEndpoint'] as num).toInt()),
      maxConnectionsPerInstance: pulumi.Input.fromValue((map['maxConnectionsPerInstance'] as num).toInt()),
      maxInFlightRequests: pulumi.Input.fromValue((map['maxInFlightRequests'] as num).toInt()),
      maxInFlightRequestsPerEndpoint: pulumi.Input.fromValue((map['maxInFlightRequestsPerEndpoint'] as num).toInt()),
      maxInFlightRequestsPerInstance: pulumi.Input.fromValue((map['maxInFlightRequestsPerInstance'] as num).toInt()),
      maxRate: pulumi.Input.fromValue((map['maxRate'] as num).toInt()),
      maxRatePerEndpoint: pulumi.Input.fromValue((map['maxRatePerEndpoint'] as num).toDouble()),
      maxRatePerInstance: pulumi.Input.fromValue((map['maxRatePerInstance'] as num).toDouble()),
