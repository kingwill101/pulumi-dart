...
class RegionSecurityPolicyRuleMatch {
  ...
  factory RegionSecurityPolicyRuleMatch.fromMap(Map<String, dynamic> map) {
    return RegionSecurityPolicyRuleMatch(
      config: (() { final guardedValue = map['config']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionSecurityPolicyRuleMatchConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      expr: (() { final guardedValue = map['expr']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionSecurityPolicyRuleMatchExpr.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
