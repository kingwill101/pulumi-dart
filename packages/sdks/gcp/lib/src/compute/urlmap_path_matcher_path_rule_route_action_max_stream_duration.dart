...
class URLMapPathMatcherPathRuleRouteActionMaxStreamDuration {
  ...
  const URLMapPathMatcherPathRuleRouteActionMaxStreamDuration({
    this.nanos,
  ...
  factory URLMapPathMatcherPathRuleRouteActionMaxStreamDuration.fromMap(Map<String, dynamic> map) {
