...
class InstanceFromTemplateSchedulingMaxRunDuration {
  ...
  factory InstanceFromTemplateSchedulingMaxRunDuration.fromMap(Map<String, dynamic> map) {
    return InstanceFromTemplateSchedulingMaxRunDuration(
