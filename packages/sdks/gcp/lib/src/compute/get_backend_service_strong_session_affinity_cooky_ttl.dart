...
class GetBackendServiceStrongSessionAffinityCookyTtl {
  ...
  factory GetBackendServiceStrongSessionAffinityCookyTtl.fromMap(Map<String, dynamic> map) {
    return GetBackendServiceStrongSessionAffinityCookyTtl(
