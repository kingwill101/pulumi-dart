...
class GetRegionSecurityPolicyRulePreconfiguredWafConfigExclusion {
  ...
  final pulumi.Input<
    List<GetRegionSecurityPolicyRulePreconfiguredWafConfigExclusionRequestCooky>
  >
  requestCookies;
  ...
  final pulumi.Input<
    List<GetRegionSecurityPolicyRulePreconfiguredWafConfigExclusionRequestUri>
  >
  requestUris;
  ...
  factory GetRegionSecurityPolicyRulePreconfiguredWafConfigExclusion.fromMap(
    ...
    return GetRegionSecurityPolicyRulePreconfiguredWafConfigExclusion(
      requestCookies: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetRegionSecurityPolicyRulePreconfiguredWafConfigExclusionRequestCooky
        >(
          map['requestCookies']!,
          (value) =>
              GetRegionSecurityPolicyRulePreconfiguredWafConfigExclusionRequestCooky.fromMap(
      ...
      requestHeaders: pulumi.Input.fromValue(
        ...
        >(
          map['requestHeaders']!,
          (value) =>
              GetRegionSecurityPolicyRulePreconfiguredWafConfigExclusionRequestHeader.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
      requestQueryParams: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetRegionSecurityPolicyRulePreconfiguredWafConfigExclusionRequestQueryParam
        >(
          map['requestQueryParams']!,
          (value) =>
              GetRegionSecurityPolicyRulePreconfiguredWafConfigExclusionRequestQueryParam.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
      requestUris: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetRegionSecurityPolicyRulePreconfiguredWafConfigExclusionRequestUri
        >(
          map['requestUris']!,
          (value) =>
              GetRegionSecurityPolicyRulePreconfiguredWafConfigExclusionRequestUri.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
      targetRuleIds: pulumi.Input.fromValue(
