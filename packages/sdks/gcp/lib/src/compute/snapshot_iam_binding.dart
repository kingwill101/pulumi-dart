...
import 'snapshot_iam_binding_condition.dart';
import 'snapshot_iam_binding_state.dart';
...
class SnapshotIamBinding extends pulumi.CustomResource {
  ...
  /// Creates a new [SnapshotIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [SnapshotIamBinding]. {@macro pulumi_compute_snapshot_iam_binding_snapshot_iam_binding_args_doc}
  ...
  SnapshotIamBinding(
    ...
    condition = registerOutput<SnapshotIamBindingCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SnapshotIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [SnapshotIamBinding] resource's state with the given [name] and [id].
  static SnapshotIamBinding get(
    String name,
    pulumi.Input<String> id, {
    SnapshotIamBindingState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return SnapshotIamBinding._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [SnapshotIamBinding] resource.
  SnapshotIamBinding.reference(String urn)
    : super(
        'gcp:compute/snapshotIamBinding:SnapshotIamBinding',
