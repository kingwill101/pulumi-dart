...
class GetRegionInstanceGroupManagerVersion {
  ...
  factory GetRegionInstanceGroupManagerVersion.fromMap(Map<String, dynamic> map) {
    return GetRegionInstanceGroupManagerVersion(
      ...
      targetSizes: pulumi.Input.fromValue(pulumi.Input.decodeList<GetRegionInstanceGroupManagerVersionTargetSize>(map['targetSizes']!, (value) => GetRegionInstanceGroupManagerVersionTargetSize.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
