...
class GetRegionInstanceGroupManagerVersion {
  ...
  final pulumi.Input<List<GetRegionInstanceGroupManagerVersionTargetSize>>
  targetSizes;
    ...
    return <String, dynamic>{
      ...
      'targetSizes':
          pulumi.Input.mapInputValue<
            List<GetRegionInstanceGroupManagerVersionTargetSize>,
  ...
  factory GetRegionInstanceGroupManagerVersion.fromMap(
    ...
    return GetRegionInstanceGroupManagerVersion(
      ...
      targetSizes: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetRegionInstanceGroupManagerVersionTargetSize>(
          map['targetSizes']!,
