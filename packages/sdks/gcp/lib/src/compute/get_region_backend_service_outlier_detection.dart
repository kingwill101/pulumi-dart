...
class GetRegionBackendServiceOutlierDetection {
  ...
  /// 30000ms or 30s.
  final List<GetRegionBackendServiceOutlierDetectionBaseEjectionTime> baseEjectionTimes;
  ...
  final List<GetRegionBackendServiceOutlierDetectionInterval> intervals;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'baseEjectionTimes': pulumi.Input.encodeList<GetRegionBackendServiceOutlierDetectionBaseEjectionTime, Map<String, dynamic>>(baseEjectionTimes, (value) => value.toMap()),
      ...
      'intervals': pulumi.Input.encodeList<GetRegionBackendServiceOutlierDetectionInterval, Map<String, dynamic>>(intervals, (value) => value.toMap()),
  ...
  factory GetRegionBackendServiceOutlierDetection.fromMap(Map<String, dynamic> map) {
    return GetRegionBackendServiceOutlierDetection(
      baseEjectionTimes: pulumi.Input.decodeList<GetRegionBackendServiceOutlierDetectionBaseEjectionTime>(map['baseEjectionTimes'], (value) => GetRegionBackendServiceOutlierDetectionBaseEjectionTime.fromMap((value as Map).cast<String, dynamic>())),
      ...
      intervals: pulumi.Input.decodeList<GetRegionBackendServiceOutlierDetectionInterval>(map['intervals'], (value) => GetRegionBackendServiceOutlierDetectionInterval.fromMap((value as Map).cast<String, dynamic>())),
