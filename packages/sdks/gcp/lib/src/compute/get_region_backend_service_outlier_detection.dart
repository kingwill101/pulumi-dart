...
class GetRegionBackendServiceOutlierDetection {
  ...
  /// 30000ms or 30s.
  final pulumi.Input<
    List<GetRegionBackendServiceOutlierDetectionBaseEjectionTime>
  >
  baseEjectionTimes;
  ...
  final pulumi.Input<List<GetRegionBackendServiceOutlierDetectionInterval>>
  intervals;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'intervals':
          pulumi.Input.mapInputValue<
            List<GetRegionBackendServiceOutlierDetectionInterval>,
            List<Map<String, dynamic>>
          >(
            intervals,
            (value) =>
  ...
  factory GetRegionBackendServiceOutlierDetection.fromMap(
    Map<String, dynamic> map,
  ) {
    return GetRegionBackendServiceOutlierDetection(
      baseEjectionTimes: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetRegionBackendServiceOutlierDetectionBaseEjectionTime
        >(
          map['baseEjectionTimes']!,
          (value) =>
              GetRegionBackendServiceOutlierDetectionBaseEjectionTime.fromMap(
      ...
      intervals: pulumi.Input.fromValue(
        pulumi
            .Input.decodeList<GetRegionBackendServiceOutlierDetectionInterval>(
          map['intervals']!,
          (value) => GetRegionBackendServiceOutlierDetectionInterval.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
