...
class RegionBackendServiceState {
  ...
  factory RegionBackendServiceState.fromMap(Map<String, dynamic> map) {
    return RegionBackendServiceState(
      ...
      backends: map['backends'] == null ? null : (pulumi.Input.decodeList<RegionBackendServiceBackend>(map['backends'], (value) => RegionBackendServiceBackend.fromMap((value as Map).cast<String, dynamic>()))).input(),
      cdnPolicy: map['cdnPolicy'] == null ? null : (RegionBackendServiceCdnPolicy.fromMap((map['cdnPolicy'] as Map).cast<String, dynamic>())).input(),
      circuitBreakers: map['circuitBreakers'] == null ? null : (RegionBackendServiceCircuitBreakers.fromMap((map['circuitBreakers'] as Map).cast<String, dynamic>())).input(),
      connectionDrainingTimeoutSec: map['connectionDrainingTimeoutSec'] == null ? null : (map['connectionDrainingTimeoutSec'] as int).input(),
      connectionTrackingPolicy: map['connectionTrackingPolicy'] == null ? null : (RegionBackendServiceConnectionTrackingPolicy.fromMap((map['connectionTrackingPolicy'] as Map).cast<String, dynamic>())).input(),
      consistentHash: map['consistentHash'] == null ? null : (RegionBackendServiceConsistentHash.fromMap((map['consistentHash'] as Map).cast<String, dynamic>())).input(),
      creationTimestamp: map['creationTimestamp'] == null ? null : (map['creationTimestamp'] as String).input(),
      customMetrics: map['customMetrics'] == null ? null : (pulumi.Input.decodeList<RegionBackendServiceCustomMetric>(map['customMetrics'], (value) => RegionBackendServiceCustomMetric.fromMap((value as Map).cast<String, dynamic>()))).input(),
      description: map['description'] == null ? null : (map['description'] as String).input(),
      dynamicForwarding: map['dynamicForwarding'] == null ? null : (RegionBackendServiceDynamicForwarding.fromMap((map['dynamicForwarding'] as Map).cast<String, dynamic>())).input(),
      enableCdn: map['enableCdn'] == null ? null : (map['enableCdn'] as bool).input(),
      failoverPolicy: map['failoverPolicy'] == null ? null : (RegionBackendServiceFailoverPolicy.fromMap((map['failoverPolicy'] as Map).cast<String, dynamic>())).input(),
      fingerprint: map['fingerprint'] == null ? null : (map['fingerprint'] as String).input(),
      generatedId: map['generatedId'] == null ? null : (map['generatedId'] as int).input(),
      haPolicy: map['haPolicy'] == null ? null : (RegionBackendServiceHaPolicy.fromMap((map['haPolicy'] as Map).cast<String, dynamic>())).input(),
      healthChecks: map['healthChecks'] == null ? null : (map['healthChecks'] as String).input(),
      iap: map['iap'] == null ? null : (RegionBackendServiceIap.fromMap((map['iap'] as Map).cast<String, dynamic>())).input(),
      ...
      logConfig: map['logConfig'] == null ? null : (RegionBackendServiceLogConfig.fromMap((map['logConfig'] as Map).cast<String, dynamic>())).input(),
      name: map['name'] == null ? null : (map['name'] as String).input(),
      network: map['network'] == null ? null : (map['network'] as String).input(),
      networkPassThroughLbTrafficPolicy: map['networkPassThroughLbTrafficPolicy'] == null ? null : (RegionBackendServiceNetworkPassThroughLbTrafficPolicy.fromMap((map['networkPassThroughLbTrafficPolicy'] as Map).cast<String, dynamic>())).input(),
      outlierDetection: map['outlierDetection'] == null ? null : (RegionBackendServiceOutlierDetection.fromMap((map['outlierDetection'] as Map).cast<String, dynamic>())).input(),
      params: map['params'] == null ? null : (RegionBackendServiceParams.fromMap((map['params'] as Map).cast<String, dynamic>())).input(),
      ...
      strongSessionAffinityCookie: map['strongSessionAffinityCookie'] == null ? null : (RegionBackendServiceStrongSessionAffinityCookie.fromMap((map['strongSessionAffinityCookie'] as Map).cast<String, dynamic>())).input(),
      subsetting: map['subsetting'] == null ? null : (RegionBackendServiceSubsetting.fromMap((map['subsetting'] as Map).cast<String, dynamic>())).input(),
      timeoutSec: map['timeoutSec'] == null ? null : (map['timeoutSec'] as int).input(),
      tlsSettings: map['tlsSettings'] == null ? null : (RegionBackendServiceTlsSettings.fromMap((map['tlsSettings'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
