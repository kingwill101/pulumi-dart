...
class RegionBackendServiceState {
  ...
  RegionBackendServiceState({
    ...
    pulumi.Output<List<RegionBackendServiceBackend>>? backends,
    pulumi.Output<RegionBackendServiceCdnPolicy>? cdnPolicy,
    pulumi.Output<RegionBackendServiceCircuitBreakers>? circuitBreakers,
    pulumi.Output<int>? connectionDrainingTimeoutSec,
    pulumi.Output<RegionBackendServiceConnectionTrackingPolicy>? connectionTrackingPolicy,
    pulumi.Output<RegionBackendServiceConsistentHash>? consistentHash,
    pulumi.Output<String>? creationTimestamp,
    pulumi.Output<List<RegionBackendServiceCustomMetric>>? customMetrics,
    pulumi.Output<String>? description,
    pulumi.Output<RegionBackendServiceDynamicForwarding>? dynamicForwarding,
    pulumi.Output<bool>? enableCdn,
    pulumi.Output<RegionBackendServiceFailoverPolicy>? failoverPolicy,
    pulumi.Output<String>? fingerprint,
    pulumi.Output<int>? generatedId,
    pulumi.Output<RegionBackendServiceHaPolicy>? haPolicy,
    pulumi.Output<String>? healthChecks,
    pulumi.Output<RegionBackendServiceIap>? iap,
    ...
    pulumi.Output<RegionBackendServiceLogConfig>? logConfig,
    pulumi.Output<String>? name,
    pulumi.Output<String>? network,
    pulumi.Output<RegionBackendServiceNetworkPassThroughLbTrafficPolicy>? networkPassThroughLbTrafficPolicy,
    pulumi.Output<RegionBackendServiceOutlierDetection>? outlierDetection,
    pulumi.Output<RegionBackendServiceParams>? params,
    ...
    pulumi.Output<RegionBackendServiceStrongSessionAffinityCookie>? strongSessionAffinityCookie,
    pulumi.Output<RegionBackendServiceSubsetting>? subsetting,
    pulumi.Output<int>? timeoutSec,
    pulumi.Output<RegionBackendServiceTlsSettings>? tlsSettings,
  }) :
  ...
  factory RegionBackendServiceState.fromMap(Map<String, dynamic> map) {
    return RegionBackendServiceState(
      ...
      backends: map['backends'] == null ? null : pulumi.Output.create<List<RegionBackendServiceBackend>>(pulumi.Input.decodeList<RegionBackendServiceBackend>(map['backends'], (value) => RegionBackendServiceBackend.fromMap((value as Map).cast<String, dynamic>()))),
      cdnPolicy: map['cdnPolicy'] == null ? null : pulumi.Output.create<RegionBackendServiceCdnPolicy>(RegionBackendServiceCdnPolicy.fromMap((map['cdnPolicy'] as Map).cast<String, dynamic>())),
      circuitBreakers: map['circuitBreakers'] == null ? null : pulumi.Output.create<RegionBackendServiceCircuitBreakers>(RegionBackendServiceCircuitBreakers.fromMap((map['circuitBreakers'] as Map).cast<String, dynamic>())),
      ...
      connectionTrackingPolicy: map['connectionTrackingPolicy'] == null ? null : pulumi.Output.create<RegionBackendServiceConnectionTrackingPolicy>(RegionBackendServiceConnectionTrackingPolicy.fromMap((map['connectionTrackingPolicy'] as Map).cast<String, dynamic>())),
      consistentHash: map['consistentHash'] == null ? null : pulumi.Output.create<RegionBackendServiceConsistentHash>(RegionBackendServiceConsistentHash.fromMap((map['consistentHash'] as Map).cast<String, dynamic>())),
      creationTimestamp: map['creationTimestamp'] == null ? null : pulumi.Output.create<String>(map['creationTimestamp'] as String),
      customMetrics: map['customMetrics'] == null ? null : pulumi.Output.create<List<RegionBackendServiceCustomMetric>>(pulumi.Input.decodeList<RegionBackendServiceCustomMetric>(map['customMetrics'], (value) => RegionBackendServiceCustomMetric.fromMap((value as Map).cast<String, dynamic>()))),
      description: map['description'] == null ? null : pulumi.Output.create<String>(map['description'] as String),
      dynamicForwarding: map['dynamicForwarding'] == null ? null : pulumi.Output.create<RegionBackendServiceDynamicForwarding>(RegionBackendServiceDynamicForwarding.fromMap((map['dynamicForwarding'] as Map).cast<String, dynamic>())),
      enableCdn: map['enableCdn'] == null ? null : pulumi.Output.create<bool>(map['enableCdn'] as bool),
      failoverPolicy: map['failoverPolicy'] == null ? null : pulumi.Output.create<RegionBackendServiceFailoverPolicy>(RegionBackendServiceFailoverPolicy.fromMap((map['failoverPolicy'] as Map).cast<String, dynamic>())),
      ...
      haPolicy: map['haPolicy'] == null ? null : pulumi.Output.create<RegionBackendServiceHaPolicy>(RegionBackendServiceHaPolicy.fromMap((map['haPolicy'] as Map).cast<String, dynamic>())),
      healthChecks: map['healthChecks'] == null ? null : pulumi.Output.create<String>(map['healthChecks'] as String),
      iap: map['iap'] == null ? null : pulumi.Output.create<RegionBackendServiceIap>(RegionBackendServiceIap.fromMap((map['iap'] as Map).cast<String, dynamic>())),
      ...
      logConfig: map['logConfig'] == null ? null : pulumi.Output.create<RegionBackendServiceLogConfig>(RegionBackendServiceLogConfig.fromMap((map['logConfig'] as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      network: map['network'] == null ? null : pulumi.Output.create<String>(map['network'] as String),
      networkPassThroughLbTrafficPolicy: map['networkPassThroughLbTrafficPolicy'] == null ? null : pulumi.Output.create<RegionBackendServiceNetworkPassThroughLbTrafficPolicy>(RegionBackendServiceNetworkPassThroughLbTrafficPolicy.fromMap((map['networkPassThroughLbTrafficPolicy'] as Map).cast<String, dynamic>())),
      outlierDetection: map['outlierDetection'] == null ? null : pulumi.Output.create<RegionBackendServiceOutlierDetection>(RegionBackendServiceOutlierDetection.fromMap((map['outlierDetection'] as Map).cast<String, dynamic>())),
      params: map['params'] == null ? null : pulumi.Output.create<RegionBackendServiceParams>(RegionBackendServiceParams.fromMap((map['params'] as Map).cast<String, dynamic>())),
      ...
      strongSessionAffinityCookie: map['strongSessionAffinityCookie'] == null ? null : pulumi.Output.create<RegionBackendServiceStrongSessionAffinityCookie>(RegionBackendServiceStrongSessionAffinityCookie.fromMap((map['strongSessionAffinityCookie'] as Map).cast<String, dynamic>())),
      subsetting: map['subsetting'] == null ? null : pulumi.Output.create<RegionBackendServiceSubsetting>(RegionBackendServiceSubsetting.fromMap((map['subsetting'] as Map).cast<String, dynamic>())),
      timeoutSec: map['timeoutSec'] == null ? null : pulumi.Output.create<int>(map['timeoutSec'] as int),
      tlsSettings: map['tlsSettings'] == null ? null : pulumi.Output.create<RegionBackendServiceTlsSettings>(RegionBackendServiceTlsSettings.fromMap((map['tlsSettings'] as Map).cast<String, dynamic>())),
    );
  }
}
