...
class BackendServiceTlsSettings {
  ...
  factory BackendServiceTlsSettings.fromMap(Map<String, dynamic> map) {
    return BackendServiceTlsSettings(
      ...
      subjectAltNames: (() { final guardedValue = map['subjectAltNames']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<BackendServiceTlsSettingsSubjectAltName>(guardedValue, (value) => BackendServiceTlsSettingsSubjectAltName.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
