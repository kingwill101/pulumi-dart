...
class RouterPeer extends pulumi.CustomResource {
  ...
  RouterPeer(
    ...
    this.advertisedIpRanges = registerOutput<List<RouterPeerAdvertisedIpRange>?>('advertisedIpRanges');
    this.advertisedRoutePriority = registerOutput<int?>('advertisedRoutePriority');
    this.bfd = registerOutput<RouterPeerBfd>('bfd');
    this.customLearnedIpRanges = registerOutput<List<RouterPeerCustomLearnedIpRange>?>('customLearnedIpRanges');
    this.customLearnedRoutePriority = registerOutput<int?>('customLearnedRoutePriority');
    ...
    this.isAdvertisedRoutePrioritySet = registerOutput<bool>('isAdvertisedRoutePrioritySet');
    this.isCustomLearnedPrioritySet = registerOutput<bool>('isCustomLearnedPrioritySet');
    this.managementType = registerOutput<String>('managementType');
    this.md5AuthenticationKey = registerOutput<RouterPeerMd5AuthenticationKey?>('md5AuthenticationKey');
    this.name = registerOutput<String>('name');
    this.peerAsn = registerOutput<int>('peerAsn');
    this.peerIpAddress = registerOutput<String>('peerIpAddress');
    this.peerIpv4NexthopAddress = registerOutput<String>('peerIpv4NexthopAddress');
    this.peerIpv6NexthopAddress = registerOutput<String>('peerIpv6NexthopAddress');
    this.project = registerOutput<String>('project');
    this.region = registerOutput<String>('region');
    this.router = registerOutput<String>('router');
    this.routerApplianceInstance = registerOutput<String?>('routerApplianceInstance');
    this.zeroAdvertisedRoutePriority = registerOutput<bool?>('zeroAdvertisedRoutePriority');
    this.zeroCustomLearnedRoutePriority = registerOutput<bool?>('zeroCustomLearnedRoutePriority');
  }
