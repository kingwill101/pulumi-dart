...
class RouterPeer extends pulumi.CustomResource {
  ...
  RouterPeer(
    ...
    advertisedIpRanges = registerOutput<List<Map<String, dynamic>>?>(
      'advertisedIpRanges',
    );
    ...
    customLearnedRoutePriority = registerOutput<int?>(
    ...
    isAdvertisedRoutePrioritySet = registerOutput<bool>(
      'isAdvertisedRoutePrioritySet',
    );
    isCustomLearnedPrioritySet = registerOutput<bool>(
    ...
    routerApplianceInstance = registerOutput<String?>(
      'routerApplianceInstance',
    );
    zeroAdvertisedRoutePriority = registerOutput<bool?>(
      'zeroAdvertisedRoutePriority',
    );
    zeroCustomLearnedRoutePriority = registerOutput<bool?>(
