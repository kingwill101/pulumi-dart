...
class GetInstanceSchedulingGracefulShutdown {
  ...
  final pulumi.Input<List<GetInstanceSchedulingGracefulShutdownMaxDuration>>
  maxDurations;
    ...
    return <String, dynamic>{
      ...
      'maxDurations':
          pulumi.Input.mapInputValue<
            List<GetInstanceSchedulingGracefulShutdownMaxDuration>,
  ...
  factory GetInstanceSchedulingGracefulShutdown.fromMap(
    ...
    return GetInstanceSchedulingGracefulShutdown(
      ...
      maxDurations: pulumi.Input.fromValue(
        pulumi
