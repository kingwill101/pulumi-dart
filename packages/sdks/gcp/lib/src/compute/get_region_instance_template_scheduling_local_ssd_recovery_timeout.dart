...
class GetRegionInstanceTemplateSchedulingLocalSsdRecoveryTimeout {
  ...
  factory GetRegionInstanceTemplateSchedulingLocalSsdRecoveryTimeout.fromMap(Map<String, dynamic> map) {
    return GetRegionInstanceTemplateSchedulingLocalSsdRecoveryTimeout(
