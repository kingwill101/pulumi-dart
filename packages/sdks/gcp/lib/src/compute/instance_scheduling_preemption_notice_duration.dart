...
class InstanceSchedulingPreemptionNoticeDuration {
  ...
  /// Creates a new [InstanceSchedulingPreemptionNoticeDuration].
  ...
  const InstanceSchedulingPreemptionNoticeDuration({
    this.nanos,
  ...
  factory InstanceSchedulingPreemptionNoticeDuration.fromMap(Map<String, dynamic> map) {
    return InstanceSchedulingPreemptionNoticeDuration(
