...
class ReservationResourceStatus {
  ...
  /// Structure is documented below.
  final pulumi.Input<List<ReservationResourceStatusReservationMaintenance>>?
  reservationMaintenances;

  /// (Output)
  /// Allocation Properties of this reservation.
  /// Structure is documented below.
  final pulumi.Input<List<ReservationResourceStatusSpecificSkuAllocation>>?
    ...
    return <String, dynamic>{
      'healthInfos':
          ?pulumi.Input.mapOptionalInputValue<
            List<ReservationResourceStatusHealthInfo>,
      ...
      'reservationMaintenances':
          ?pulumi.Input.mapOptionalInputValue<
            List<ReservationResourceStatusReservationMaintenance>,
            List<Map<String, dynamic>>
          >(
            reservationMaintenances,
            (value) =>
      ...
      'specificSkuAllocations':
          ?pulumi.Input.mapOptionalInputValue<
            List<ReservationResourceStatusSpecificSkuAllocation>,
            List<Map<String, dynamic>>
          >(
            specificSkuAllocations,
            (value) =>
  ...
  factory ReservationResourceStatus.fromMap(Map<String, dynamic> map) {
    return ReservationResourceStatus(
      ...
      reservationMaintenances: (() {
        final guardedValue = map['reservationMaintenances'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => ReservationResourceStatusReservationMaintenance.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      specificSkuAllocations: (() {
        final guardedValue = map['specificSkuAllocations'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi
