...
class NetworkFirewallPolicyWithRulesState {
  ...
  final pulumi.Input<List<NetworkFirewallPolicyWithRulesPredefinedRule>>?
  predefinedRules;
  ...
  factory NetworkFirewallPolicyWithRulesState.fromMap(
    ...
    return NetworkFirewallPolicyWithRulesState(
      ...
      predefinedRules: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NetworkFirewallPolicyWithRulesPredefinedRule>(
            guardedValue,
            (value) => NetworkFirewallPolicyWithRulesPredefinedRule.fromMap(
