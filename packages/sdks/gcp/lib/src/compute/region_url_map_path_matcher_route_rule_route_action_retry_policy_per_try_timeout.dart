...
class RegionUrlMapPathMatcherRouteRuleRouteActionRetryPolicyPerTryTimeout {
  ...
  /// Creates a new [RegionUrlMapPathMatcherRouteRuleRouteActionRetryPolicyPerTryTimeout].
  ...
  const RegionUrlMapPathMatcherRouteRuleRouteActionRetryPolicyPerTryTimeout({
    this.nanos,
  ...
  factory RegionUrlMapPathMatcherRouteRuleRouteActionRetryPolicyPerTryTimeout.fromMap(Map<String, dynamic> map) {
    return RegionUrlMapPathMatcherRouteRuleRouteActionRetryPolicyPerTryTimeout(
