...
class URLMapPathMatcherRouteRule {
  ...
  final pulumi.Input<URLMapPathMatcherRouteRuleCustomErrorResponsePolicy>?
  ...
  /// Structure is documented below.
  final pulumi.Input<List<URLMapPathMatcherRouteRuleHttpFilterConfig>>?
  httpFilterConfigs;
  ...
  /// Not supported when the URL map is bound to a target gRPC proxy that has validateForProxyless field set to true.
  /// Structure is documented below.
  final pulumi.Input<List<URLMapPathMatcherRouteRuleHttpFilterMetadata>>?
  httpFilterMetadatas;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'httpFilterConfigs':
          ?pulumi.Input.mapOptionalInputValue<
            List<URLMapPathMatcherRouteRuleHttpFilterConfig>,
      ...
      'httpFilterMetadatas':
          ?pulumi.Input.mapOptionalInputValue<
            List<URLMapPathMatcherRouteRuleHttpFilterMetadata>,
            List<Map<String, dynamic>>
          >(
            httpFilterMetadatas,
            (value) =>
      ...
      'matchRules':
          ?pulumi.Input.mapOptionalInputValue<
            List<URLMapPathMatcherRouteRuleMatchRule>,
            List<Map<String, dynamic>>
          >(
            matchRules,
            (value) =>
  ...
  factory URLMapPathMatcherRouteRule.fromMap(Map<String, dynamic> map) {
    return URLMapPathMatcherRouteRule(
      ...
      httpFilterMetadatas: (() {
        final guardedValue = map['httpFilterMetadatas'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<URLMapPathMatcherRouteRuleHttpFilterMetadata>(
            guardedValue,
