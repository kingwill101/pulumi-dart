...
class URLMapPathMatcherDefaultRouteActionRetryPolicyPerTryTimeout {
  ...
  /// Creates a new [URLMapPathMatcherDefaultRouteActionRetryPolicyPerTryTimeout].
  ...
  const URLMapPathMatcherDefaultRouteActionRetryPolicyPerTryTimeout({
    this.nanos,
    this.seconds,
  });
  ...
  factory URLMapPathMatcherDefaultRouteActionRetryPolicyPerTryTimeout.fromMap(Map<String, dynamic> map) {
