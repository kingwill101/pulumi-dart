...
class StoragePoolIamPolicyState {
  ...
  /// Creates a new [StoragePoolIamPolicyState].
  ...
  const StoragePoolIamPolicyState({
    this.etag,
    this.name,
    this.policyData,
    this.project,
  ...
  factory StoragePoolIamPolicyState.fromMap(Map<String, dynamic> map) {
    return StoragePoolIamPolicyState(
