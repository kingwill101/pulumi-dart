...
class RegionNetworkFirewallPolicyState {
  ...
  factory RegionNetworkFirewallPolicyState.fromMap(Map<String, dynamic> map) {
    return RegionNetworkFirewallPolicyState(
      ...
      regionNetworkFirewallPolicyId: (() { final guardedValue = map['regionNetworkFirewallPolicyId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
