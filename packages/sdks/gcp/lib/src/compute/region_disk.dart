...
class RegionDisk extends pulumi.CustomResource {
  ...
  RegionDisk(
    ...
    this.asyncPrimaryDisk = registerOutput<RegionDiskAsyncPrimaryDisk?>('asyncPrimaryDisk');
    ...
    this.diskEncryptionKey = registerOutput<RegionDiskDiskEncryptionKey?>('diskEncryptionKey');
    this.diskId = registerOutput<String>('diskId');
    this.effectiveLabels = registerOutput<Map<String, String>>('effectiveLabels');
    this.guestOsFeatures = registerOutput<List<RegionDiskGuestOsFeature>>('guestOsFeatures');
    ...
    this.sourceSnapshotEncryptionKey = registerOutput<RegionDiskSourceSnapshotEncryptionKey?>('sourceSnapshotEncryptionKey');
