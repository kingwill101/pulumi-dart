...
class InstanceFromMachineImageScheduling {
  ...
  final pulumi.Input<InstanceFromMachineImageSchedulingGracefulShutdown>?
  gracefulShutdown;
  ...
  /// hour.
  final pulumi.Input<InstanceFromMachineImageSchedulingLocalSsdRecoveryTimeout>?
  ...
  final pulumi.Input<InstanceFromMachineImageSchedulingMaxRunDuration>?
  maxRunDuration;
  final pulumi.Input<int>? minNodeCpus;

  /// Specifies node affinities or anti-affinities to determine which sole-tenant nodes your instances and managed instance groups will use as host systems.
  final pulumi.Input<List<InstanceFromMachineImageSchedulingNodeAffinity>>?
  nodeAffinities;
  ...
  final pulumi.Input<InstanceFromMachineImageSchedulingOnInstanceStopAction>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'nodeAffinities':
          ?pulumi.Input.mapOptionalInputValue<
            List<InstanceFromMachineImageSchedulingNodeAffinity>,
    ...
    return InstanceFromMachineImageScheduling(
      ...
      gracefulShutdown: (() {
        ...
        return pulumi.Input.fromValue(
          InstanceFromMachineImageSchedulingGracefulShutdown.fromMap(
      ...
      localSsdRecoveryTimeout: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          InstanceFromMachineImageSchedulingLocalSsdRecoveryTimeout.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      maxRunDuration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          InstanceFromMachineImageSchedulingMaxRunDuration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      onInstanceStopAction: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          InstanceFromMachineImageSchedulingOnInstanceStopAction.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
