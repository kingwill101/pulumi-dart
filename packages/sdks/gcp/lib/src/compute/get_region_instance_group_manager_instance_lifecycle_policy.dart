...
class GetRegionInstanceGroupManagerInstanceLifecyclePolicy {
  ...
  final pulumi.Input<List<GetRegionInstanceGroupManagerInstanceLifecyclePolicyOnRepair>> onRepairs;
  ...
  const GetRegionInstanceGroupManagerInstanceLifecyclePolicy({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'onRepairs': pulumi.Input.mapInputValue<List<GetRegionInstanceGroupManagerInstanceLifecyclePolicyOnRepair>, List<Map<String, dynamic>>>(onRepairs, (value) => pulumi.Input.encodeList<GetRegionInstanceGroupManagerInstanceLifecyclePolicyOnRepair, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory GetRegionInstanceGroupManagerInstanceLifecyclePolicy.fromMap(Map<String, dynamic> map) {
    return GetRegionInstanceGroupManagerInstanceLifecyclePolicy(
      ...
      onRepairs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetRegionInstanceGroupManagerInstanceLifecyclePolicyOnRepair>(map['onRepairs']!, (value) => GetRegionInstanceGroupManagerInstanceLifecyclePolicyOnRepair.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
