...
class ResizeRequestStatusLastAttemptErrorErrorErrorDetail {
  ...
  final pulumi.Input<
    List<ResizeRequestStatusLastAttemptErrorErrorErrorDetailErrorInfo>
  >?
  errorInfos;
  ...
  /// Structure is documented below.
  final pulumi.Input<
    List<ResizeRequestStatusLastAttemptErrorErrorErrorDetailHelp>
  >?
  helps;
  ...
  /// Structure is documented below.
  final pulumi.Input<
    List<ResizeRequestStatusLastAttemptErrorErrorErrorDetailQuotaInfo>
  >?
  quotaInfos;
      ...
      errorInfos: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                ResizeRequestStatusLastAttemptErrorErrorErrorDetailErrorInfo.fromMap(
      ...
      helps: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                ResizeRequestStatusLastAttemptErrorErrorErrorDetailHelp.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      localizedMessages: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                ResizeRequestStatusLastAttemptErrorErrorErrorDetailLocalizedMessage.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      quotaInfos: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                ResizeRequestStatusLastAttemptErrorErrorErrorDetailQuotaInfo.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
