...
class RegionNetworkFirewallPolicyWithRulesState {
  ...
  factory RegionNetworkFirewallPolicyWithRulesState.fromMap(Map<String, dynamic> map) {
    return RegionNetworkFirewallPolicyWithRulesState(
      ...
      predefinedRules: (() { final guardedValue = map['predefinedRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RegionNetworkFirewallPolicyWithRulesPredefinedRule>(guardedValue, (value) => RegionNetworkFirewallPolicyWithRulesPredefinedRule.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      rules: (() { final guardedValue = map['rules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RegionNetworkFirewallPolicyWithRulesRule>(guardedValue, (value) => RegionNetworkFirewallPolicyWithRulesRule.fromMap((value as Map).cast<String, dynamic>()))); })(),
