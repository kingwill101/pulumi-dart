...
import 'firewall_policy_iam_member_condition.dart';
import 'firewall_policy_iam_member_state.dart';
...
class FirewallPolicyIamMember extends pulumi.CustomResource {
  late final pulumi.Output<FirewallPolicyIamMemberCondition?> condition;
  ...
  /// [args] Arguments used to configure this [FirewallPolicyIamMember]. {@macro pulumi_compute_firewall_policy_iam_member_firewall_policy_iam_member_args_doc}
  ...
  FirewallPolicyIamMember(
    ...
    condition = registerOutput<FirewallPolicyIamMemberCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return FirewallPolicyIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [FirewallPolicyIamMember] resource's state with the given [name] and [id].
  static FirewallPolicyIamMember get(
    String name,
    pulumi.Input<String> id, {
    FirewallPolicyIamMemberState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return FirewallPolicyIamMember._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [FirewallPolicyIamMember] resource.
  FirewallPolicyIamMember.reference(String urn)
    : super(
        'gcp:compute/firewallPolicyIamMember:FirewallPolicyIamMember',
