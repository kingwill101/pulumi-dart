...
class RegionUrlMapPathMatcherPathRuleRouteActionCorsPolicy {
  ...
  /// Creates a new [RegionUrlMapPathMatcherPathRuleRouteActionCorsPolicy].
  ...
  const RegionUrlMapPathMatcherPathRuleRouteActionCorsPolicy({
  ...
  factory RegionUrlMapPathMatcherPathRuleRouteActionCorsPolicy.fromMap(Map<String, dynamic> map) {
