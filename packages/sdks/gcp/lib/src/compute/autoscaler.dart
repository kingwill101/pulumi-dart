...
class Autoscaler extends pulumi.CustomResource {
  ...
  /// Gets an existing [Autoscaler] resource's state with the given [name] and [id].
  static Autoscaler get(
    String name,
    pulumi.Input<String> id, {
    AutoscalerState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return Autoscaler._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [Autoscaler] resource.
  Autoscaler.reference(String urn)
    : super(
        'gcp:compute/autoscaler:Autoscaler',
