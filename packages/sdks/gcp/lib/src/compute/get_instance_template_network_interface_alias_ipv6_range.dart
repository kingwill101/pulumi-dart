...
class GetInstanceTemplateNetworkInterfaceAliasIpv6Range {
  ...
  /// Creates a new [GetInstanceTemplateNetworkInterfaceAliasIpv6Range].
  ...
  const GetInstanceTemplateNetworkInterfaceAliasIpv6Range({
  ...
  factory GetInstanceTemplateNetworkInterfaceAliasIpv6Range.fromMap(Map<String, dynamic> map) {
    return GetInstanceTemplateNetworkInterfaceAliasIpv6Range(
