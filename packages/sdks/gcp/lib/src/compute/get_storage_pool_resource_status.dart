...
class GetStoragePoolResourceStatus {
  ...
  /// Creates a new [GetStoragePoolResourceStatus].
  ...
  factory GetStoragePoolResourceStatus.fromMap(Map<String, dynamic> map) {
    return GetStoragePoolResourceStatus(
      ...
      maxTotalProvisionedDiskCapacityGb: pulumi.Input.fromValue(
        map['maxTotalProvisionedDiskCapacityGb'] as String,
      ),
      poolUsedCapacityBytes: pulumi.Input.fromValue(
        map['poolUsedCapacityBytes'] as String,
      ),
      poolUsedIops: pulumi.Input.fromValue(map['poolUsedIops'] as String),
      poolUsedThroughput: pulumi.Input.fromValue(
        map['poolUsedThroughput'] as String,
      ),
      poolUserWrittenBytes: pulumi.Input.fromValue(
        map['poolUserWrittenBytes'] as String,
      ),
      totalProvisionedDiskCapacityGb: pulumi.Input.fromValue(
        map['totalProvisionedDiskCapacityGb'] as String,
      ),
      totalProvisionedDiskIops: pulumi.Input.fromValue(
        map['totalProvisionedDiskIops'] as String,
      ),
      totalProvisionedDiskThroughput: pulumi.Input.fromValue(
