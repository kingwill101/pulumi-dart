...
class ResizeRequestStatusLastAttemptErrorError {
  ...
  factory ResizeRequestStatusLastAttemptErrorError.fromMap(Map<String, dynamic> map) {
    return ResizeRequestStatusLastAttemptErrorError(
      ...
      errorDetails: (() { final guardedValue = map['errorDetails']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ResizeRequestStatusLastAttemptErrorErrorErrorDetail>(guardedValue, (value) => ResizeRequestStatusLastAttemptErrorErrorErrorDetail.fromMap((value as Map).cast<String, dynamic>()))); })(),
