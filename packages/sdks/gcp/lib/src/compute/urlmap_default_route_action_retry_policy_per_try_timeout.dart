...
class URLMapDefaultRouteActionRetryPolicyPerTryTimeout {
  ...
  /// Creates a new [URLMapDefaultRouteActionRetryPolicyPerTryTimeout].
  ...
  const URLMapDefaultRouteActionRetryPolicyPerTryTimeout({
    this.nanos,
    this.seconds,
  });
  ...
  factory URLMapDefaultRouteActionRetryPolicyPerTryTimeout.fromMap(Map<String, dynamic> map) {
