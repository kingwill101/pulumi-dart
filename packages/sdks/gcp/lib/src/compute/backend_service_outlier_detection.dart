...
class BackendServiceOutlierDetection {
  ...
  factory BackendServiceOutlierDetection.fromMap(Map<String, dynamic> map) {
    return BackendServiceOutlierDetection(
      baseEjectionTime: (() { final guardedValue = map['baseEjectionTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BackendServiceOutlierDetectionBaseEjectionTime.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      consecutiveErrors: (() { final guardedValue = map['consecutiveErrors']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      consecutiveGatewayFailure: (() { final guardedValue = map['consecutiveGatewayFailure']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      enforcingConsecutiveErrors: (() { final guardedValue = map['enforcingConsecutiveErrors']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      enforcingConsecutiveGatewayFailure: (() { final guardedValue = map['enforcingConsecutiveGatewayFailure']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      enforcingSuccessRate: (() { final guardedValue = map['enforcingSuccessRate']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      interval: (() { final guardedValue = map['interval']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BackendServiceOutlierDetectionInterval.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      maxEjectionPercent: (() { final guardedValue = map['maxEjectionPercent']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      successRateMinimumHosts: (() { final guardedValue = map['successRateMinimumHosts']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      successRateRequestVolume: (() { final guardedValue = map['successRateRequestVolume']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      successRateStdevFactor: (() { final guardedValue = map['successRateStdevFactor']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
    );
  }
}
