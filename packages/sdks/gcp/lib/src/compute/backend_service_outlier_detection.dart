...
class BackendServiceOutlierDetection {
  ...
  final pulumi.Input<BackendServiceOutlierDetectionBaseEjectionTime>?
  baseEjectionTime;
  ...
  factory BackendServiceOutlierDetection.fromMap(Map<String, dynamic> map) {
    return BackendServiceOutlierDetection(
      baseEjectionTime: (() {
        final guardedValue = map['baseEjectionTime'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          BackendServiceOutlierDetectionBaseEjectionTime.fromMap(
      ...
      consecutiveGatewayFailure: (() {
        final guardedValue = map['consecutiveGatewayFailure'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      enforcingConsecutiveErrors: (() {
        final guardedValue = map['enforcingConsecutiveErrors'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      enforcingConsecutiveGatewayFailure: (() {
        final guardedValue = map['enforcingConsecutiveGatewayFailure'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      enforcingSuccessRate: (() {
        final guardedValue = map['enforcingSuccessRate'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      interval: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          BackendServiceOutlierDetectionInterval.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      successRateMinimumHosts: (() {
        final guardedValue = map['successRateMinimumHosts'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      successRateRequestVolume: (() {
        final guardedValue = map['successRateRequestVolume'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      successRateStdevFactor: (() {
        final guardedValue = map['successRateStdevFactor'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
    );
