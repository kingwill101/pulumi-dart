...
class ImageParams {
  ...
  /// Creates a new [ImageParams].
  /// [resourceManagerTags] Resource manager tags to be bound to the image. Tag keys and values have the
  const ImageParams({
  ...
  factory ImageParams.fromMap(Map<String, dynamic> map) {
    return ImageParams(
