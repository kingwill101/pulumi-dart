...
import 'get_instance_template_network_interface_alias_ipv6_range.dart';
...
class GetInstanceTemplateNetworkInterface {
  ...
  final pulumi.Input<List<GetInstanceTemplateNetworkInterfaceAliasIpv6Range>> aliasIpv6Ranges;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'aliasIpv6Ranges': pulumi.Input.mapInputValue<List<GetInstanceTemplateNetworkInterfaceAliasIpv6Range>, List<Map<String, dynamic>>>(aliasIpv6Ranges, (value) => pulumi.Input.encodeList<GetInstanceTemplateNetworkInterfaceAliasIpv6Range, Map<String, dynamic>>(value, (value) => value.toMap())),
      'igmpQuery': igmpQuery,
  ...
  factory GetInstanceTemplateNetworkInterface.fromMap(Map<String, dynamic> map) {
    return GetInstanceTemplateNetworkInterface(
      accessConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetInstanceTemplateNetworkInterfaceAccessConfig>(map['accessConfigs']!, (value) => GetInstanceTemplateNetworkInterfaceAccessConfig.fromMap((value as Map).cast<String, dynamic>()))),
