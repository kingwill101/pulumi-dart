...
class GetRegionInstanceGroupManagerStatus {
  ...
  final pulumi.Input<
    List<GetRegionInstanceGroupManagerStatusAllInstancesConfig>
  >
  allInstancesConfigs;
  ...
  final pulumi.Input<List<GetRegionInstanceGroupManagerStatusStateful>>
  statefuls;

  /// A status of consistency of Instances' versions with their target version specified by version field on Instance Group Manager.
  final pulumi.Input<List<GetRegionInstanceGroupManagerStatusVersionTarget>>
  versionTargets;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'statefuls':
          pulumi.Input.mapInputValue<
            List<GetRegionInstanceGroupManagerStatusStateful>,
            List<Map<String, dynamic>>
          >(
            statefuls,
            (value) =>
      ...
      'versionTargets':
          pulumi.Input.mapInputValue<
            List<GetRegionInstanceGroupManagerStatusVersionTarget>,
            List<Map<String, dynamic>>
          >(
            versionTargets,
            (value) =>
  ...
  factory GetRegionInstanceGroupManagerStatus.fromMap(
    ...
    return GetRegionInstanceGroupManagerStatus(
      ...
      statefuls: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetRegionInstanceGroupManagerStatusStateful>(
          map['statefuls']!,
      ...
      versionTargets: pulumi.Input.fromValue(
        pulumi
          ...
          map['versionTargets']!,
          (value) => GetRegionInstanceGroupManagerStatusVersionTarget.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
