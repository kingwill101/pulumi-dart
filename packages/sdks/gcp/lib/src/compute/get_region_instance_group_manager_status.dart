...
class GetRegionInstanceGroupManagerStatus {
  ...
  factory GetRegionInstanceGroupManagerStatus.fromMap(Map<String, dynamic> map) {
    return GetRegionInstanceGroupManagerStatus(
      allInstancesConfigs: (pulumi.Input.decodeList<GetRegionInstanceGroupManagerStatusAllInstancesConfig>(map['allInstancesConfigs'], (value) => GetRegionInstanceGroupManagerStatusAllInstancesConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
      isStable: (map['isStable'] as bool).input(),
      statefuls: (pulumi.Input.decodeList<GetRegionInstanceGroupManagerStatusStateful>(map['statefuls'], (value) => GetRegionInstanceGroupManagerStatusStateful.fromMap((value as Map).cast<String, dynamic>()))).input(),
      versionTargets: (pulumi.Input.decodeList<GetRegionInstanceGroupManagerStatusVersionTarget>(map['versionTargets'], (value) => GetRegionInstanceGroupManagerStatusVersionTarget.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
