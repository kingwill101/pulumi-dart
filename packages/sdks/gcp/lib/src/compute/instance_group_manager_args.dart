...
class InstanceGroupManagerArgs {
  ...
  InstanceGroupManagerArgs({
    pulumi.Output<InstanceGroupManagerAllInstancesConfig>? allInstancesConfig,
    pulumi.Output<InstanceGroupManagerAutoHealingPolicies>? autoHealingPolicies,
    required pulumi.Output<String> baseInstanceName,
    pulumi.Output<String>? description,
    pulumi.Output<InstanceGroupManagerInstanceLifecyclePolicy>? instanceLifecyclePolicy,
    pulumi.Output<String>? listManagedInstancesResults,
    pulumi.Output<String>? name,
    pulumi.Output<List<InstanceGroupManagerNamedPort>>? namedPorts,
    pulumi.Output<InstanceGroupManagerParams>? params,
    pulumi.Output<String>? project,
    pulumi.Output<InstanceGroupManagerResourcePolicies>? resourcePolicies,
    pulumi.Output<InstanceGroupManagerStandbyPolicy>? standbyPolicy,
    pulumi.Output<List<InstanceGroupManagerStatefulDisk>>? statefulDisks,
    pulumi.Output<List<InstanceGroupManagerStatefulExternalIp>>? statefulExternalIps,
    pulumi.Output<List<InstanceGroupManagerStatefulInternalIp>>? statefulInternalIps,
    ...
    pulumi.Output<InstanceGroupManagerUpdatePolicy>? updatePolicy,
    required pulumi.Output<List<InstanceGroupManagerVersion>> versions,
    pulumi.Output<bool>? waitForInstances,
    pulumi.Output<String>? waitForInstancesStatus,
    pulumi.Output<String>? zone,
  }) :
      allInstancesConfig = pulumi.Input.asOptionalInput<InstanceGroupManagerAllInstancesConfig>(allInstancesConfig),
      autoHealingPolicies = pulumi.Input.asOptionalInput<InstanceGroupManagerAutoHealingPolicies>(autoHealingPolicies),
      baseInstanceName = pulumi.Input.asInput<String>(baseInstanceName),
      description = pulumi.Input.asOptionalInput<String>(description),
      instanceLifecyclePolicy = pulumi.Input.asOptionalInput<InstanceGroupManagerInstanceLifecyclePolicy>(instanceLifecyclePolicy),
      listManagedInstancesResults = pulumi.Input.asOptionalInput<String>(listManagedInstancesResults),
      name = pulumi.Input.asOptionalInput<String>(name),
      namedPorts = pulumi.Input.asOptionalInput<List<InstanceGroupManagerNamedPort>>(namedPorts),
      params = pulumi.Input.asOptionalInput<InstanceGroupManagerParams>(params),
      project = pulumi.Input.asOptionalInput<String>(project),
      resourcePolicies = pulumi.Input.asOptionalInput<InstanceGroupManagerResourcePolicies>(resourcePolicies),
      standbyPolicy = pulumi.Input.asOptionalInput<InstanceGroupManagerStandbyPolicy>(standbyPolicy),
      statefulDisks = pulumi.Input.asOptionalInput<List<InstanceGroupManagerStatefulDisk>>(statefulDisks),
      statefulExternalIps = pulumi.Input.asOptionalInput<List<InstanceGroupManagerStatefulExternalIp>>(statefulExternalIps),
      statefulInternalIps = pulumi.Input.asOptionalInput<List<InstanceGroupManagerStatefulInternalIp>>(statefulInternalIps),
      ...
      updatePolicy = pulumi.Input.asOptionalInput<InstanceGroupManagerUpdatePolicy>(updatePolicy),
      versions = pulumi.Input.asInput<List<InstanceGroupManagerVersion>>(versions),
  ...
  factory InstanceGroupManagerArgs.fromMap(Map<String, dynamic> map) {
    return InstanceGroupManagerArgs(
      allInstancesConfig: map['allInstancesConfig'] == null ? null : pulumi.Output.create<InstanceGroupManagerAllInstancesConfig>(InstanceGroupManagerAllInstancesConfig.fromMap((map['allInstancesConfig'] as Map).cast<String, dynamic>())),
      autoHealingPolicies: map['autoHealingPolicies'] == null ? null : pulumi.Output.create<InstanceGroupManagerAutoHealingPolicies>(InstanceGroupManagerAutoHealingPolicies.fromMap((map['autoHealingPolicies'] as Map).cast<String, dynamic>())),
      baseInstanceName: pulumi.Output.create<String>(map['baseInstanceName'] as String),
      description: map['description'] == null ? null : pulumi.Output.create<String>(map['description'] as String),
      instanceLifecyclePolicy: map['instanceLifecyclePolicy'] == null ? null : pulumi.Output.create<InstanceGroupManagerInstanceLifecyclePolicy>(InstanceGroupManagerInstanceLifecyclePolicy.fromMap((map['instanceLifecyclePolicy'] as Map).cast<String, dynamic>())),
      ...
      namedPorts: map['namedPorts'] == null ? null : pulumi.Output.create<List<InstanceGroupManagerNamedPort>>(pulumi.Input.decodeList<InstanceGroupManagerNamedPort>(map['namedPorts'], (value) => InstanceGroupManagerNamedPort.fromMap((value as Map).cast<String, dynamic>()))),
      params: map['params'] == null ? null : pulumi.Output.create<InstanceGroupManagerParams>(InstanceGroupManagerParams.fromMap((map['params'] as Map).cast<String, dynamic>())),
      project: map['project'] == null ? null : pulumi.Output.create<String>(map['project'] as String),
      resourcePolicies: map['resourcePolicies'] == null ? null : pulumi.Output.create<InstanceGroupManagerResourcePolicies>(InstanceGroupManagerResourcePolicies.fromMap((map['resourcePolicies'] as Map).cast<String, dynamic>())),
      standbyPolicy: map['standbyPolicy'] == null ? null : pulumi.Output.create<InstanceGroupManagerStandbyPolicy>(InstanceGroupManagerStandbyPolicy.fromMap((map['standbyPolicy'] as Map).cast<String, dynamic>())),
      statefulDisks: map['statefulDisks'] == null ? null : pulumi.Output.create<List<InstanceGroupManagerStatefulDisk>>(pulumi.Input.decodeList<InstanceGroupManagerStatefulDisk>(map['statefulDisks'], (value) => InstanceGroupManagerStatefulDisk.fromMap((value as Map).cast<String, dynamic>()))),
      statefulExternalIps: map['statefulExternalIps'] == null ? null : pulumi.Output.create<List<InstanceGroupManagerStatefulExternalIp>>(pulumi.Input.decodeList<InstanceGroupManagerStatefulExternalIp>(map['statefulExternalIps'], (value) => InstanceGroupManagerStatefulExternalIp.fromMap((value as Map).cast<String, dynamic>()))),
      statefulInternalIps: map['statefulInternalIps'] == null ? null : pulumi.Output.create<List<InstanceGroupManagerStatefulInternalIp>>(pulumi.Input.decodeList<InstanceGroupManagerStatefulInternalIp>(map['statefulInternalIps'], (value) => InstanceGroupManagerStatefulInternalIp.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      updatePolicy: map['updatePolicy'] == null ? null : pulumi.Output.create<InstanceGroupManagerUpdatePolicy>(InstanceGroupManagerUpdatePolicy.fromMap((map['updatePolicy'] as Map).cast<String, dynamic>())),
      versions: pulumi.Output.create<List<InstanceGroupManagerVersion>>(pulumi.Input.decodeList<InstanceGroupManagerVersion>(map['versions'], (value) => InstanceGroupManagerVersion.fromMap((value as Map).cast<String, dynamic>()))),
