...
class InstanceGroupManagerArgs {
  ...
  factory InstanceGroupManagerArgs.fromMap(Map<String, dynamic> map) {
    return InstanceGroupManagerArgs(
      ...
      autoHealingPolicies: map['autoHealingPolicies'] == null ? null : (InstanceGroupManagerAutoHealingPolicies.fromMap((map['autoHealingPolicies'] as Map).cast<String, dynamic>())).input(),
      baseInstanceName: (map['baseInstanceName'] as String).input(),
      ...
      namedPorts: map['namedPorts'] == null ? null : (pulumi.Input.decodeList<InstanceGroupManagerNamedPort>(map['namedPorts'], (value) => InstanceGroupManagerNamedPort.fromMap((value as Map).cast<String, dynamic>()))).input(),
      params: map['params'] == null ? null : (InstanceGroupManagerParams.fromMap((map['params'] as Map).cast<String, dynamic>())).input(),
      project: map['project'] == null ? null : (map['project'] as String).input(),
      resourcePolicies: map['resourcePolicies'] == null ? null : (InstanceGroupManagerResourcePolicies.fromMap((map['resourcePolicies'] as Map).cast<String, dynamic>())).input(),
      ...
      statefulDisks: map['statefulDisks'] == null ? null : (pulumi.Input.decodeList<InstanceGroupManagerStatefulDisk>(map['statefulDisks'], (value) => InstanceGroupManagerStatefulDisk.fromMap((value as Map).cast<String, dynamic>()))).input(),
      statefulExternalIps: map['statefulExternalIps'] == null ? null : (pulumi.Input.decodeList<InstanceGroupManagerStatefulExternalIp>(map['statefulExternalIps'], (value) => InstanceGroupManagerStatefulExternalIp.fromMap((value as Map).cast<String, dynamic>()))).input(),
      statefulInternalIps: map['statefulInternalIps'] == null ? null : (pulumi.Input.decodeList<InstanceGroupManagerStatefulInternalIp>(map['statefulInternalIps'], (value) => InstanceGroupManagerStatefulInternalIp.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      versions: (pulumi.Input.decodeList<InstanceGroupManagerVersion>(map['versions'], (value) => InstanceGroupManagerVersion.fromMap((value as Map).cast<String, dynamic>()))).input(),
