...
class RouteState {
  ...
  RouteState({
    pulumi.Output<List<RouteAsPath>>? asPaths,
    ...
    pulumi.Output<String>? nextHopHub,
    pulumi.Output<String>? nextHopIlb,
    pulumi.Output<String>? nextHopInstance,
    pulumi.Output<String>? nextHopInstanceZone,
    pulumi.Output<String>? nextHopInterRegionCost,
    pulumi.Output<String>? nextHopIp,
    pulumi.Output<String>? nextHopMed,
    pulumi.Output<String>? nextHopNetwork,
    pulumi.Output<String>? nextHopOrigin,
    pulumi.Output<String>? nextHopPeering,
    pulumi.Output<String>? nextHopVpnTunnel,
    pulumi.Output<RouteParams>? params,
    pulumi.Output<int>? priority,
    pulumi.Output<String>? project,
    pulumi.Output<String>? routeStatus,
    pulumi.Output<String>? routeType,
    pulumi.Output<String>? selfLink,
    pulumi.Output<List<String>>? tags,
    pulumi.Output<List<RouteWarning>>? warnings,
  }) :
      asPaths = pulumi.Input.asOptionalInput<List<RouteAsPath>>(asPaths),
      ...
      nextHopHub = pulumi.Input.asOptionalInput<String>(nextHopHub),
      ...
      nextHopInterRegionCost = pulumi.Input.asOptionalInput<String>(nextHopInterRegionCost),
      nextHopIp = pulumi.Input.asOptionalInput<String>(nextHopIp),
      nextHopMed = pulumi.Input.asOptionalInput<String>(nextHopMed),
      nextHopNetwork = pulumi.Input.asOptionalInput<String>(nextHopNetwork),
      nextHopOrigin = pulumi.Input.asOptionalInput<String>(nextHopOrigin),
      nextHopPeering = pulumi.Input.asOptionalInput<String>(nextHopPeering),
      ...
      routeStatus = pulumi.Input.asOptionalInput<String>(routeStatus),
      routeType = pulumi.Input.asOptionalInput<String>(routeType),
      selfLink = pulumi.Input.asOptionalInput<String>(selfLink),
      tags = pulumi.Input.asOptionalInput<List<String>>(tags),
      warnings = pulumi.Input.asOptionalInput<List<RouteWarning>>(warnings);
  ...
  factory RouteState.fromMap(Map<String, dynamic> map) {
    return RouteState(
      asPaths: map['asPaths'] == null ? null : pulumi.Output.create<List<RouteAsPath>>(pulumi.Input.decodeList<RouteAsPath>(map['asPaths'], (value) => RouteAsPath.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      nextHopHub: map['nextHopHub'] == null ? null : pulumi.Output.create<String>(map['nextHopHub'] as String),
      ...
      nextHopInterRegionCost: map['nextHopInterRegionCost'] == null ? null : pulumi.Output.create<String>(map['nextHopInterRegionCost'] as String),
      nextHopIp: map['nextHopIp'] == null ? null : pulumi.Output.create<String>(map['nextHopIp'] as String),
      nextHopMed: map['nextHopMed'] == null ? null : pulumi.Output.create<String>(map['nextHopMed'] as String),
      nextHopNetwork: map['nextHopNetwork'] == null ? null : pulumi.Output.create<String>(map['nextHopNetwork'] as String),
      nextHopOrigin: map['nextHopOrigin'] == null ? null : pulumi.Output.create<String>(map['nextHopOrigin'] as String),
      nextHopPeering: map['nextHopPeering'] == null ? null : pulumi.Output.create<String>(map['nextHopPeering'] as String),
      ...
      routeStatus: map['routeStatus'] == null ? null : pulumi.Output.create<String>(map['routeStatus'] as String),
      routeType: map['routeType'] == null ? null : pulumi.Output.create<String>(map['routeType'] as String),
      selfLink: map['selfLink'] == null ? null : pulumi.Output.create<String>(map['selfLink'] as String),
      tags: map['tags'] == null ? null : pulumi.Output.create<List<String>>((map['tags'] as List).cast<String>()),
      warnings: map['warnings'] == null ? null : pulumi.Output.create<List<RouteWarning>>(pulumi.Input.decodeList<RouteWarning>(map['warnings'], (value) => RouteWarning.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
