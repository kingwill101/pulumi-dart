    ...
    return <String, dynamic>{
      'asPaths':
          ...
          >(
            asPaths,
            (value) =>
                pulumi.Input.encodeList<RouteAsPath, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      ...
      'warnings':
          ...
          >(
            warnings,
            (value) =>
                pulumi.Input.encodeList<RouteWarning, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return RouteState(
      asPaths: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RouteAsPath>(
            guardedValue,
            (value) =>
                RouteAsPath.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      creationTimestamp: (() {
      ...
      nextHopHub: (() {
        final guardedValue = map['nextHopHub'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      nextHopIlb: (() {
      ...
      nextHopInterRegionCost: (() {
        final guardedValue = map['nextHopInterRegionCost'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      nextHopIp: (() {
      ...
      nextHopMed: (() {
        final guardedValue = map['nextHopMed'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      nextHopNetwork: (() {
        final guardedValue = map['nextHopNetwork'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      nextHopOrigin: (() {
        final guardedValue = map['nextHopOrigin'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      nextHopPeering: (() {
        final guardedValue = map['nextHopPeering'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      nextHopVpnTunnel: (() {
      ...
      routeStatus: (() {
        final guardedValue = map['routeStatus'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      routeType: (() {
      ...
      warnings: (() {
        final guardedValue = map['warnings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RouteWarning>(
            guardedValue,
            (value) =>
                RouteWarning.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
    );
