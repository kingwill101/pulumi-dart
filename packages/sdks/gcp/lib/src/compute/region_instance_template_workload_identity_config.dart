...
class RegionInstanceTemplateWorkloadIdentityConfig {
  ...
  factory RegionInstanceTemplateWorkloadIdentityConfig.fromMap(Map<String, dynamic> map) {
    return RegionInstanceTemplateWorkloadIdentityConfig(
