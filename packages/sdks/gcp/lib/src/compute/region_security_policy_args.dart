    ...
    return RegionSecurityPolicyArgs(
      advancedOptionsConfig: (() {
        ...
        return pulumi.Input.fromValue(
          RegionSecurityPolicyAdvancedOptionsConfig.fromMap(
      ...
      ddosProtectionConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RegionSecurityPolicyDdosProtectionConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      rules: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RegionSecurityPolicyRule>(
            guardedValue,
            (value) => RegionSecurityPolicyRule.fromMap(
      ...
      userDefinedFields: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RegionSecurityPolicyUserDefinedField>(
            guardedValue,
            (value) => RegionSecurityPolicyUserDefinedField.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
