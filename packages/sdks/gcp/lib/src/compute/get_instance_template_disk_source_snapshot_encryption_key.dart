...
class GetInstanceTemplateDiskSourceSnapshotEncryptionKey {
  ...
  /// Creates a new [GetInstanceTemplateDiskSourceSnapshotEncryptionKey].
  ...
  const GetInstanceTemplateDiskSourceSnapshotEncryptionKey({
  ...
  factory GetInstanceTemplateDiskSourceSnapshotEncryptionKey.fromMap(Map<String, dynamic> map) {
    return GetInstanceTemplateDiskSourceSnapshotEncryptionKey(
