...
class GetRegionBackendServiceOutlierDetectionBaseEjectionTime {
  ...
  /// Creates a new [GetRegionBackendServiceOutlierDetectionBaseEjectionTime].
  ...
  const GetRegionBackendServiceOutlierDetectionBaseEjectionTime({
    required this.nanos,
