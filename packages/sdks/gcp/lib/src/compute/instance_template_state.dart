...
class InstanceTemplateState {
  ...
  factory InstanceTemplateState.fromMap(Map<String, dynamic> map) {
    return InstanceTemplateState(
      ...
      disks: (() { final guardedValue = map['disks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InstanceTemplateDisk>(guardedValue, (value) => InstanceTemplateDisk.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      selfLinkUnique: (() { final guardedValue = map['selfLinkUnique']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
