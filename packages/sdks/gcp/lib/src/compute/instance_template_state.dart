...
class InstanceTemplateState {
  ...
  InstanceTemplateState({
    pulumi.Output<InstanceTemplateAdvancedMachineFeatures>? advancedMachineFeatures,
    pulumi.Output<bool>? canIpForward,
    pulumi.Output<InstanceTemplateConfidentialInstanceConfig>? confidentialInstanceConfig,
    pulumi.Output<String>? creationTimestamp,
    pulumi.Output<String>? description,
    pulumi.Output<List<InstanceTemplateDisk>>? disks,
    pulumi.Output<Map<String, String>>? effectiveLabels,
    pulumi.Output<bool>? enableDisplay,
    pulumi.Output<List<InstanceTemplateGuestAccelerator>>? guestAccelerators,
    ...
    pulumi.Output<List<InstanceTemplateNetworkInterface>>? networkInterfaces,
    pulumi.Output<InstanceTemplateNetworkPerformanceConfig>? networkPerformanceConfig,
    pulumi.Output<String>? numericId,
    pulumi.Output<Map<String, String>>? partnerMetadata,
    pulumi.Output<String>? project,
    pulumi.Output<Map<String, String>>? pulumiLabels,
    pulumi.Output<String>? region,
    pulumi.Output<InstanceTemplateReservationAffinity>? reservationAffinity,
    pulumi.Output<Map<String, String>>? resourceManagerTags,
    pulumi.Output<String>? resourcePolicies,
    pulumi.Output<InstanceTemplateScheduling>? scheduling,
    pulumi.Output<String>? selfLink,
    pulumi.Output<String>? selfLinkUnique,
    pulumi.Output<InstanceTemplateServiceAccount>? serviceAccount,
    pulumi.Output<InstanceTemplateShieldedInstanceConfig>? shieldedInstanceConfig,
    pulumi.Output<List<String>>? tags,
    pulumi.Output<String>? tagsFingerprint,
  }) :
      advancedMachineFeatures = pulumi.Input.asOptionalInput<InstanceTemplateAdvancedMachineFeatures>(advancedMachineFeatures),
      canIpForward = pulumi.Input.asOptionalInput<bool>(canIpForward),
      confidentialInstanceConfig = pulumi.Input.asOptionalInput<InstanceTemplateConfidentialInstanceConfig>(confidentialInstanceConfig),
      creationTimestamp = pulumi.Input.asOptionalInput<String>(creationTimestamp),
      description = pulumi.Input.asOptionalInput<String>(description),
      disks = pulumi.Input.asOptionalInput<List<InstanceTemplateDisk>>(disks),
      effectiveLabels = pulumi.Input.asOptionalInput<Map<String, String>>(effectiveLabels),
      enableDisplay = pulumi.Input.asOptionalInput<bool>(enableDisplay),
      guestAccelerators = pulumi.Input.asOptionalInput<List<InstanceTemplateGuestAccelerator>>(guestAccelerators),
      ...
      networkInterfaces = pulumi.Input.asOptionalInput<List<InstanceTemplateNetworkInterface>>(networkInterfaces),
      networkPerformanceConfig = pulumi.Input.asOptionalInput<InstanceTemplateNetworkPerformanceConfig>(networkPerformanceConfig),
      ...
      reservationAffinity = pulumi.Input.asOptionalInput<InstanceTemplateReservationAffinity>(reservationAffinity),
      ...
      scheduling = pulumi.Input.asOptionalInput<InstanceTemplateScheduling>(scheduling),
      selfLink = pulumi.Input.asOptionalInput<String>(selfLink),
      selfLinkUnique = pulumi.Input.asOptionalInput<String>(selfLinkUnique),
      serviceAccount = pulumi.Input.asOptionalInput<InstanceTemplateServiceAccount>(serviceAccount),
      shieldedInstanceConfig = pulumi.Input.asOptionalInput<InstanceTemplateShieldedInstanceConfig>(shieldedInstanceConfig),
  ...
  factory InstanceTemplateState.fromMap(Map<String, dynamic> map) {
    return InstanceTemplateState(
      advancedMachineFeatures: map['advancedMachineFeatures'] == null ? null : pulumi.Output.create<InstanceTemplateAdvancedMachineFeatures>(InstanceTemplateAdvancedMachineFeatures.fromMap((map['advancedMachineFeatures'] as Map).cast<String, dynamic>())),
      canIpForward: map['canIpForward'] == null ? null : pulumi.Output.create<bool>(map['canIpForward'] as bool),
      confidentialInstanceConfig: map['confidentialInstanceConfig'] == null ? null : pulumi.Output.create<InstanceTemplateConfidentialInstanceConfig>(InstanceTemplateConfidentialInstanceConfig.fromMap((map['confidentialInstanceConfig'] as Map).cast<String, dynamic>())),
      creationTimestamp: map['creationTimestamp'] == null ? null : pulumi.Output.create<String>(map['creationTimestamp'] as String),
      description: map['description'] == null ? null : pulumi.Output.create<String>(map['description'] as String),
      disks: map['disks'] == null ? null : pulumi.Output.create<List<InstanceTemplateDisk>>(pulumi.Input.decodeList<InstanceTemplateDisk>(map['disks'], (value) => InstanceTemplateDisk.fromMap((value as Map).cast<String, dynamic>()))),
      effectiveLabels: map['effectiveLabels'] == null ? null : pulumi.Output.create<Map<String, String>>((map['effectiveLabels'] as Map).cast<String, String>()),
      enableDisplay: map['enableDisplay'] == null ? null : pulumi.Output.create<bool>(map['enableDisplay'] as bool),
      guestAccelerators: map['guestAccelerators'] == null ? null : pulumi.Output.create<List<InstanceTemplateGuestAccelerator>>(pulumi.Input.decodeList<InstanceTemplateGuestAccelerator>(map['guestAccelerators'], (value) => InstanceTemplateGuestAccelerator.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      networkInterfaces: map['networkInterfaces'] == null ? null : pulumi.Output.create<List<InstanceTemplateNetworkInterface>>(pulumi.Input.decodeList<InstanceTemplateNetworkInterface>(map['networkInterfaces'], (value) => InstanceTemplateNetworkInterface.fromMap((value as Map).cast<String, dynamic>()))),
      networkPerformanceConfig: map['networkPerformanceConfig'] == null ? null : pulumi.Output.create<InstanceTemplateNetworkPerformanceConfig>(InstanceTemplateNetworkPerformanceConfig.fromMap((map['networkPerformanceConfig'] as Map).cast<String, dynamic>())),
      ...
      reservationAffinity: map['reservationAffinity'] == null ? null : pulumi.Output.create<InstanceTemplateReservationAffinity>(InstanceTemplateReservationAffinity.fromMap((map['reservationAffinity'] as Map).cast<String, dynamic>())),
      ...
      scheduling: map['scheduling'] == null ? null : pulumi.Output.create<InstanceTemplateScheduling>(InstanceTemplateScheduling.fromMap((map['scheduling'] as Map).cast<String, dynamic>())),
      selfLink: map['selfLink'] == null ? null : pulumi.Output.create<String>(map['selfLink'] as String),
      selfLinkUnique: map['selfLinkUnique'] == null ? null : pulumi.Output.create<String>(map['selfLinkUnique'] as String),
      serviceAccount: map['serviceAccount'] == null ? null : pulumi.Output.create<InstanceTemplateServiceAccount>(InstanceTemplateServiceAccount.fromMap((map['serviceAccount'] as Map).cast<String, dynamic>())),
      shieldedInstanceConfig: map['shieldedInstanceConfig'] == null ? null : pulumi.Output.create<InstanceTemplateShieldedInstanceConfig>(InstanceTemplateShieldedInstanceConfig.fromMap((map['shieldedInstanceConfig'] as Map).cast<String, dynamic>())),
