...
class GetInstanceTemplateDisk {
  ...
  final List<GetInstanceTemplateDiskSourceImageEncryptionKey> sourceImageEncryptionKeys;
  ...
  final List<GetInstanceTemplateDiskSourceSnapshotEncryptionKey> sourceSnapshotEncryptionKeys;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'diskEncryptionKeys': pulumi.Input.encodeList<GetInstanceTemplateDiskDiskEncryptionKey, Map<String, dynamic>>(diskEncryptionKeys, (value) => value.toMap()),
      'diskName': diskName,
      ...
      'sourceImageEncryptionKeys': pulumi.Input.encodeList<GetInstanceTemplateDiskSourceImageEncryptionKey, Map<String, dynamic>>(sourceImageEncryptionKeys, (value) => value.toMap()),
      'sourceSnapshot': sourceSnapshot,
      'sourceSnapshotEncryptionKeys': pulumi.Input.encodeList<GetInstanceTemplateDiskSourceSnapshotEncryptionKey, Map<String, dynamic>>(sourceSnapshotEncryptionKeys, (value) => value.toMap()),
      'type': type,
    };
  }
  ...
  factory GetInstanceTemplateDisk.fromMap(Map<String, dynamic> map) {
    return GetInstanceTemplateDisk(
      ...
      diskEncryptionKeys: pulumi.Input.decodeList<GetInstanceTemplateDiskDiskEncryptionKey>(map['diskEncryptionKeys'], (value) => GetInstanceTemplateDiskDiskEncryptionKey.fromMap((value as Map).cast<String, dynamic>())),
      ...
      sourceImageEncryptionKeys: pulumi.Input.decodeList<GetInstanceTemplateDiskSourceImageEncryptionKey>(map['sourceImageEncryptionKeys'], (value) => GetInstanceTemplateDiskSourceImageEncryptionKey.fromMap((value as Map).cast<String, dynamic>())),
      sourceSnapshot: map['sourceSnapshot'] as String,
      sourceSnapshotEncryptionKeys: pulumi.Input.decodeList<GetInstanceTemplateDiskSourceSnapshotEncryptionKey>(map['sourceSnapshotEncryptionKeys'], (value) => GetInstanceTemplateDiskSourceSnapshotEncryptionKey.fromMap((value as Map).cast<String, dynamic>())),
