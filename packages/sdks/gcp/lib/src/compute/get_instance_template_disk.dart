...
class GetInstanceTemplateDisk {
  ...
  final pulumi.Input<List<GetInstanceTemplateDiskDiskEncryptionKey>>
  diskEncryptionKeys;
  ...
  final pulumi.Input<List<GetInstanceTemplateDiskSourceImageEncryptionKey>>
  ...
  final pulumi.Input<List<GetInstanceTemplateDiskSourceSnapshotEncryptionKey>>
    ...
    return <String, dynamic>{
      ...
      'diskEncryptionKeys':
          pulumi.Input.mapInputValue<
            List<GetInstanceTemplateDiskDiskEncryptionKey>,
      ...
      'sourceImageEncryptionKeys':
          pulumi.Input.mapInputValue<
            List<GetInstanceTemplateDiskSourceImageEncryptionKey>,
            List<Map<String, dynamic>>
          >(
            sourceImageEncryptionKeys,
            (value) =>
      ...
      'sourceSnapshotEncryptionKeys':
          pulumi.Input.mapInputValue<
            List<GetInstanceTemplateDiskSourceSnapshotEncryptionKey>,
            List<Map<String, dynamic>>
          >(
            sourceSnapshotEncryptionKeys,
            (value) =>
