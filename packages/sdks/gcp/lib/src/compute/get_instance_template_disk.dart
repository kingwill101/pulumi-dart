...
class GetInstanceTemplateDisk {
  ...
  factory GetInstanceTemplateDisk.fromMap(Map<String, dynamic> map) {
    return GetInstanceTemplateDisk(
      ...
      diskEncryptionKeys: (pulumi.Input.decodeList<GetInstanceTemplateDiskDiskEncryptionKey>(map['diskEncryptionKeys'], (value) => GetInstanceTemplateDiskDiskEncryptionKey.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      sourceImageEncryptionKeys: (pulumi.Input.decodeList<GetInstanceTemplateDiskSourceImageEncryptionKey>(map['sourceImageEncryptionKeys'], (value) => GetInstanceTemplateDiskSourceImageEncryptionKey.fromMap((value as Map).cast<String, dynamic>()))).input(),
      sourceSnapshot: (map['sourceSnapshot'] as String).input(),
      sourceSnapshotEncryptionKeys: (pulumi.Input.decodeList<GetInstanceTemplateDiskSourceSnapshotEncryptionKey>(map['sourceSnapshotEncryptionKeys'], (value) => GetInstanceTemplateDiskSourceSnapshotEncryptionKey.fromMap((value as Map).cast<String, dynamic>()))).input(),
