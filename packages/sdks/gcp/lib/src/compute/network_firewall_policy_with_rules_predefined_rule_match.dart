...
class NetworkFirewallPolicyWithRulesPredefinedRuleMatch {
  ...
  final List<NetworkFirewallPolicyWithRulesPredefinedRuleMatchLayer4Config>? layer4Configs;
  ...
  final List<NetworkFirewallPolicyWithRulesPredefinedRuleMatchSrcSecureTag>? srcSecureTags;
  /// Names of Network Threat Intelligence lists.
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'layer4Configs': ?layer4Configs == null ? null : pulumi.Input.encodeList<NetworkFirewallPolicyWithRulesPredefinedRuleMatchLayer4Config, Map<String, dynamic>>(layer4Configs!, (value) => value.toMap()),
      'srcAddressGroups': ?srcAddressGroups,
      'srcFqdns': ?srcFqdns,
      'srcIpRanges': ?srcIpRanges,
      'srcRegionCodes': ?srcRegionCodes,
      'srcSecureTags': ?srcSecureTags == null ? null : pulumi.Input.encodeList<NetworkFirewallPolicyWithRulesPredefinedRuleMatchSrcSecureTag, Map<String, dynamic>>(srcSecureTags!, (value) => value.toMap()),
  ...
  factory NetworkFirewallPolicyWithRulesPredefinedRuleMatch.fromMap(Map<String, dynamic> map) {
    return NetworkFirewallPolicyWithRulesPredefinedRuleMatch(
      ...
      layer4Configs: map['layer4Configs'] == null ? null : pulumi.Input.decodeList<NetworkFirewallPolicyWithRulesPredefinedRuleMatchLayer4Config>(map['layer4Configs'], (value) => NetworkFirewallPolicyWithRulesPredefinedRuleMatchLayer4Config.fromMap((value as Map).cast<String, dynamic>())),
      ...
      srcSecureTags: map['srcSecureTags'] == null ? null : pulumi.Input.decodeList<NetworkFirewallPolicyWithRulesPredefinedRuleMatchSrcSecureTag>(map['srcSecureTags'], (value) => NetworkFirewallPolicyWithRulesPredefinedRuleMatchSrcSecureTag.fromMap((value as Map).cast<String, dynamic>())),
