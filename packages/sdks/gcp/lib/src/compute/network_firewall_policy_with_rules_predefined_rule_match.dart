...
class NetworkFirewallPolicyWithRulesPredefinedRuleMatch {
  ...
  const NetworkFirewallPolicyWithRulesPredefinedRuleMatch({
  ...
  factory NetworkFirewallPolicyWithRulesPredefinedRuleMatch.fromMap(Map<String, dynamic> map) {
    return NetworkFirewallPolicyWithRulesPredefinedRuleMatch(
      ...
      layer4Configs: (() { final guardedValue = map['layer4Configs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NetworkFirewallPolicyWithRulesPredefinedRuleMatchLayer4Config>(guardedValue, (value) => NetworkFirewallPolicyWithRulesPredefinedRuleMatchLayer4Config.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      srcSecureTags: (() { final guardedValue = map['srcSecureTags']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NetworkFirewallPolicyWithRulesPredefinedRuleMatchSrcSecureTag>(guardedValue, (value) => NetworkFirewallPolicyWithRulesPredefinedRuleMatchSrcSecureTag.fromMap((value as Map).cast<String, dynamic>()))); })(),
