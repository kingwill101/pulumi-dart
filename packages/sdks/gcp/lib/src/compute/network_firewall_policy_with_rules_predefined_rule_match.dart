...
class NetworkFirewallPolicyWithRulesPredefinedRuleMatch {
  ...
  final pulumi.Input<
    List<NetworkFirewallPolicyWithRulesPredefinedRuleMatchLayer4Config>
  >?
  layer4Configs;
  ...
  final pulumi.Input<
    List<NetworkFirewallPolicyWithRulesPredefinedRuleMatchSrcSecureTag>
  >?
  srcSecureTags;
      ...
      layer4Configs: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                NetworkFirewallPolicyWithRulesPredefinedRuleMatchLayer4Config.fromMap(
      ...
      srcSecureTags: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                NetworkFirewallPolicyWithRulesPredefinedRuleMatchSrcSecureTag.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
