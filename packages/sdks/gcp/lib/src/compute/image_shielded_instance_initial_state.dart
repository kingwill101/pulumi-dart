...
class ImageShieldedInstanceInitialState {
  ...
  factory ImageShieldedInstanceInitialState.fromMap(Map<String, dynamic> map) {
    return ImageShieldedInstanceInitialState(
      dbs: (() { final guardedValue = map['dbs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ImageShieldedInstanceInitialStateDb>(guardedValue, (value) => ImageShieldedInstanceInitialStateDb.fromMap((value as Map).cast<String, dynamic>()))); })(),
      dbxs: (() { final guardedValue = map['dbxs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ImageShieldedInstanceInitialStateDbx>(guardedValue, (value) => ImageShieldedInstanceInitialStateDbx.fromMap((value as Map).cast<String, dynamic>()))); })(),
      keks: (() { final guardedValue = map['keks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ImageShieldedInstanceInitialStateKek>(guardedValue, (value) => ImageShieldedInstanceInitialStateKek.fromMap((value as Map).cast<String, dynamic>()))); })(),
      pk: (() { final guardedValue = map['pk']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ImageShieldedInstanceInitialStatePk.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
