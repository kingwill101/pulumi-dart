...
class RegionInstanceGroupManagerInstanceFlexibilityPolicyInstanceSelectionDisk {
  ...
  factory RegionInstanceGroupManagerInstanceFlexibilityPolicyInstanceSelectionDisk.fromMap(Map<String, dynamic> map) {
    return RegionInstanceGroupManagerInstanceFlexibilityPolicyInstanceSelectionDisk(
      ...
      diskEncryptionKey: map['diskEncryptionKey'] == null ? null : (RegionInstanceGroupManagerInstanceFlexibilityPolicyInstanceSelectionDiskDiskEncryptionKey.fromMap((map['diskEncryptionKey'] as Map).cast<String, dynamic>())).input(),
      ...
      labels: map['labels'] == null ? null : (pulumi.Input.decodeList<RegionInstanceGroupManagerInstanceFlexibilityPolicyInstanceSelectionDiskLabel>(map['labels'], (value) => RegionInstanceGroupManagerInstanceFlexibilityPolicyInstanceSelectionDiskLabel.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      sourceImageEncryptionKey: map['sourceImageEncryptionKey'] == null ? null : (RegionInstanceGroupManagerInstanceFlexibilityPolicyInstanceSelectionDiskSourceImageEncryptionKey.fromMap((map['sourceImageEncryptionKey'] as Map).cast<String, dynamic>())).input(),
      sourceSnapshot: map['sourceSnapshot'] == null ? null : (map['sourceSnapshot'] as String).input(),
      sourceSnapshotEncryptionKey: map['sourceSnapshotEncryptionKey'] == null ? null : (RegionInstanceGroupManagerInstanceFlexibilityPolicyInstanceSelectionDiskSourceSnapshotEncryptionKey.fromMap((map['sourceSnapshotEncryptionKey'] as Map).cast<String, dynamic>())).input(),
