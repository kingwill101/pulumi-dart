...
class InterconnectState {
  ...
  factory InterconnectState.fromMap(Map<String, dynamic> map) {
    return InterconnectState(
      ...
      availableFeatures: (() { final guardedValue = map['availableFeatures']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      ...
      interconnectAttachments: (() { final guardedValue = map['interconnectAttachments']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      interconnectGroups: (() { final guardedValue = map['interconnectGroups']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      interconnectType: (() { final guardedValue = map['interconnectType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      operationalStatus: (() { final guardedValue = map['operationalStatus']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      provisionedLinkCount: (() { final guardedValue = map['provisionedLinkCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      ...
      requestedLinkCount: (() { final guardedValue = map['requestedLinkCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      ...
      wireGroups: (() { final guardedValue = map['wireGroups']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
    );
  }
}
