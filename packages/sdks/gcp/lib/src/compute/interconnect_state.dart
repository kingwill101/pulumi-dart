...
class InterconnectState {
  ...
  factory InterconnectState.fromMap(Map<String, dynamic> map) {
    return InterconnectState(
      ...
      provisionedLinkCount: (() { final guardedValue = map['provisionedLinkCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      requestedLinkCount: (() { final guardedValue = map['requestedLinkCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
