  ...
  factory NetworkState.fromMap(Map<String, dynamic> map) {
    return NetworkState(
      ...
      deleteBgpAlwaysCompareMed: (() {
        final guardedValue = map['deleteBgpAlwaysCompareMed'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      deleteDefaultRoutesOnCreate: (() {
        final guardedValue = map['deleteDefaultRoutesOnCreate'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      description: (() {
      ...
      gatewayIpv4: (() {
        final guardedValue = map['gatewayIpv4'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      internalIpv6Range: (() {
      ...
      params: (() {
        ...
        return pulumi.Input.fromValue(
          NetworkParams.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      project: (() {
