...
class RegionInstanceTemplateAdvancedMachineFeatures {
  ...
  /// Creates a new [RegionInstanceTemplateAdvancedMachineFeatures].
  ...
  factory RegionInstanceTemplateAdvancedMachineFeatures.fromMap(
    Map<String, dynamic> map,
  ) {
    return RegionInstanceTemplateAdvancedMachineFeatures(
      ...
      turboMode: (() {
        final guardedValue = map['turboMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      visibleCoreCount: (() {
