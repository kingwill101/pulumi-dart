...
class InstanceFromMachineImageBootDiskInitializeParamsSourceSnapshotEncryptionKey {
  ...
  /// Creates a new [InstanceFromMachineImageBootDiskInitializeParamsSourceSnapshotEncryptionKey].
  ...
  const InstanceFromMachineImageBootDiskInitializeParamsSourceSnapshotEncryptionKey({
    this.kmsKeySelfLink,
