...
class GetBackendServiceLocalityLbPolicy {
  ...
  final pulumi.Input<List<GetBackendServiceLocalityLbPolicyCustomPolicy>>
  customPolicies;
    ...
    return <String, dynamic>{
      'customPolicies':
          pulumi.Input.mapInputValue<
            List<GetBackendServiceLocalityLbPolicyCustomPolicy>,
      ...
      'policies':
          pulumi.Input.mapInputValue<
            List<GetBackendServiceLocalityLbPolicyPolicy>,
            List<Map<String, dynamic>>
          >(
            policies,
            (value) =>
  ...
  factory GetBackendServiceLocalityLbPolicy.fromMap(Map<String, dynamic> map) {
    return GetBackendServiceLocalityLbPolicy(
      customPolicies: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetBackendServiceLocalityLbPolicyCustomPolicy>(
          map['customPolicies']!,
