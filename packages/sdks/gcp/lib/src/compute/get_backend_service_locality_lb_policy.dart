...
class GetBackendServiceLocalityLbPolicy {
  ...
  factory GetBackendServiceLocalityLbPolicy.fromMap(Map<String, dynamic> map) {
    return GetBackendServiceLocalityLbPolicy(
      customPolicies: (pulumi.Input.decodeList<GetBackendServiceLocalityLbPolicyCustomPolicy>(map['customPolicies'], (value) => GetBackendServiceLocalityLbPolicyCustomPolicy.fromMap((value as Map).cast<String, dynamic>()))).input(),
      policies: (pulumi.Input.decodeList<GetBackendServiceLocalityLbPolicyPolicy>(map['policies'], (value) => GetBackendServiceLocalityLbPolicyPolicy.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
