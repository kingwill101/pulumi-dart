...
class GetSecurityPolicyRulePreconfiguredWafConfigExclusionRequestHeader {
  ...
  /// Creates a new [GetSecurityPolicyRulePreconfiguredWafConfigExclusionRequestHeader].
  ...
  const GetSecurityPolicyRulePreconfiguredWafConfigExclusionRequestHeader({
  ...
  factory GetSecurityPolicyRulePreconfiguredWafConfigExclusionRequestHeader.fromMap(Map<String, dynamic> map) {
