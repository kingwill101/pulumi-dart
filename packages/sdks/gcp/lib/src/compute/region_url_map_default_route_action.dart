...
class RegionUrlMapDefaultRouteAction {
  ...
  /// Structure is documented below.
  final RegionUrlMapDefaultRouteActionFaultInjectionPolicy? faultInjectionPolicy;
  ...
  /// Structure is documented below.
  final List<RegionUrlMapDefaultRouteActionWeightedBackendService>? weightedBackendServices;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'weightedBackendServices': ?weightedBackendServices == null ? null : pulumi.Input.encodeList<RegionUrlMapDefaultRouteActionWeightedBackendService, Map<String, dynamic>>(weightedBackendServices!, (value) => value.toMap()),
    };
  }

  factory RegionUrlMapDefaultRouteAction.fromMap(Map<String, dynamic> map) {
    return RegionUrlMapDefaultRouteAction(
      corsPolicy: map['corsPolicy'] == null ? null : RegionUrlMapDefaultRouteActionCorsPolicy.fromMap((map['corsPolicy'] as Map).cast<String, dynamic>()),
      faultInjectionPolicy: map['faultInjectionPolicy'] == null ? null : RegionUrlMapDefaultRouteActionFaultInjectionPolicy.fromMap((map['faultInjectionPolicy'] as Map).cast<String, dynamic>()),
      requestMirrorPolicy: map['requestMirrorPolicy'] == null ? null : RegionUrlMapDefaultRouteActionRequestMirrorPolicy.fromMap((map['requestMirrorPolicy'] as Map).cast<String, dynamic>()),
      retryPolicy: map['retryPolicy'] == null ? null : RegionUrlMapDefaultRouteActionRetryPolicy.fromMap((map['retryPolicy'] as Map).cast<String, dynamic>()),
      timeout: map['timeout'] == null ? null : RegionUrlMapDefaultRouteActionTimeout.fromMap((map['timeout'] as Map).cast<String, dynamic>()),
      urlRewrite: map['urlRewrite'] == null ? null : RegionUrlMapDefaultRouteActionUrlRewrite.fromMap((map['urlRewrite'] as Map).cast<String, dynamic>()),
      weightedBackendServices: map['weightedBackendServices'] == null ? null : pulumi.Input.decodeList<RegionUrlMapDefaultRouteActionWeightedBackendService>(map['weightedBackendServices'], (value) => RegionUrlMapDefaultRouteActionWeightedBackendService.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
