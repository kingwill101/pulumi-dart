...
class InterconnectGroupState {
  ...
  /// Structure is documented below.
  final pulumi.Input<List<InterconnectGroupPhysicalStructure>>?
  physicalStructures;
    ...
    return <String, dynamic>{
      'configureds':
          ?pulumi.Input.mapOptionalInputValue<
            List<InterconnectGroupConfigured>,
      ...
      'physicalStructures':
          ?pulumi.Input.mapOptionalInputValue<
            List<InterconnectGroupPhysicalStructure>,
            List<Map<String, dynamic>>
          >(
            physicalStructures,
            (value) =>
    ...
    return InterconnectGroupState(
      configureds: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InterconnectGroupConfigured>(
            guardedValue,
            (value) => InterconnectGroupConfigured.fromMap(
      ...
      intent: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          InterconnectGroupIntent.fromMap(
      ...
      physicalStructures: (() {
        final guardedValue = map['physicalStructures'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InterconnectGroupPhysicalStructure>(
            guardedValue,
            (value) => InterconnectGroupPhysicalStructure.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
