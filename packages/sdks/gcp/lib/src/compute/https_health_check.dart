...
import 'https_health_check_state.dart';
...
/// }
///
/// resource "gcp_compute_httpshealthcheck" "default" {
///   name               = "authentication-health-check"
///   request_path       = "/health_check"
///   timeout_sec        = 1
///   check_interval_sec = 1
...
class HttpsHealthCheck extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [HttpsHealthCheck]. {@macro pulumi_compute_https_health_check_https_health_check_args_doc}
  ...
  /// Gets an existing [HttpsHealthCheck] resource's state with the given [name] and [id].
  static HttpsHealthCheck get(
    String name,
