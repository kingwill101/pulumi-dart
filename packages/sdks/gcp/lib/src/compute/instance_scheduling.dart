...
class InstanceScheduling {
  ...
  factory InstanceScheduling.fromMap(Map<String, dynamic> map) {
    return InstanceScheduling(
      ...
      gracefulShutdown: map['gracefulShutdown'] == null ? null : (InstanceSchedulingGracefulShutdown.fromMap((map['gracefulShutdown']! as Map).cast<String, dynamic>())).input(),
      ...
      localSsdRecoveryTimeout: map['localSsdRecoveryTimeout'] == null ? null : (InstanceSchedulingLocalSsdRecoveryTimeout.fromMap((map['localSsdRecoveryTimeout']! as Map).cast<String, dynamic>())).input(),
      maintenanceInterval: map['maintenanceInterval'] == null ? null : (map['maintenanceInterval']! as String).input(),
      maxRunDuration: map['maxRunDuration'] == null ? null : (InstanceSchedulingMaxRunDuration.fromMap((map['maxRunDuration']! as Map).cast<String, dynamic>())).input(),
      minNodeCpus: map['minNodeCpus'] == null ? null : (map['minNodeCpus']! as int).input(),
      nodeAffinities: map['nodeAffinities'] == null ? null : (pulumi.Input.decodeList<InstanceSchedulingNodeAffinity>(map['nodeAffinities']!, (value) => InstanceSchedulingNodeAffinity.fromMap((value as Map).cast<String, dynamic>()))).input(),
      onHostMaintenance: map['onHostMaintenance'] == null ? null : (map['onHostMaintenance']! as String).input(),
      onInstanceStopAction: map['onInstanceStopAction'] == null ? null : (InstanceSchedulingOnInstanceStopAction.fromMap((map['onInstanceStopAction']! as Map).cast<String, dynamic>())).input(),
