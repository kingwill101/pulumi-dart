...
class FirewallPolicyRuleMatch {
  ...
  factory FirewallPolicyRuleMatch.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyRuleMatch(
      ...
      layer4Configs: pulumi.Input.fromValue(pulumi.Input.decodeList<FirewallPolicyRuleMatchLayer4Config>(map['layer4Configs']!, (value) => FirewallPolicyRuleMatchLayer4Config.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      srcSecureTags: (() { final guardedValue = map['srcSecureTags']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FirewallPolicyRuleMatchSrcSecureTag>(guardedValue, (value) => FirewallPolicyRuleMatchSrcSecureTag.fromMap((value as Map).cast<String, dynamic>()))); })(),
