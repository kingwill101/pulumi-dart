    ...
    return <String, dynamic>{
      'asPaths':
          pulumi.Input.mapInputValue<
            List<GetRouterStatusBestRoutesForRouterAsPath>,
      ...
      'params':
          pulumi.Input.mapInputValue<
            List<GetRouterStatusBestRoutesForRouterParam>,
            List<Map<String, dynamic>>
          >(
            params,
            (value) =>
      ...
      'warnings':
          pulumi.Input.mapInputValue<
            List<GetRouterStatusBestRoutesForRouterWarning>,
            List<Map<String, dynamic>>
          >(
            warnings,
            (value) =>
  ...
  factory GetRouterStatusBestRoutesForRouter.fromMap(Map<String, dynamic> map) {
    return GetRouterStatusBestRoutesForRouter(
      ...
      params: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetRouterStatusBestRoutesForRouterParam>(
          map['params']!,
