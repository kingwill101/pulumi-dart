...
class GetRouterStatusBestRoutesForRouter {
  ...
  factory GetRouterStatusBestRoutesForRouter.fromMap(Map<String, dynamic> map) {
    return GetRouterStatusBestRoutesForRouter(
      asPaths: (pulumi.Input.decodeList<GetRouterStatusBestRoutesForRouterAsPath>(map['asPaths'], (value) => GetRouterStatusBestRoutesForRouterAsPath.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      params: (pulumi.Input.decodeList<GetRouterStatusBestRoutesForRouterParam>(map['params'], (value) => GetRouterStatusBestRoutesForRouterParam.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      warnings: (pulumi.Input.decodeList<GetRouterStatusBestRoutesForRouterWarning>(map['warnings'], (value) => GetRouterStatusBestRoutesForRouterWarning.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
