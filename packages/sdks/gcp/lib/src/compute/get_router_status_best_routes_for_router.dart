...
class GetRouterStatusBestRoutesForRouter {
  final pulumi.Input<List<GetRouterStatusBestRoutesForRouterAsPath>> asPaths;
  ...
  final pulumi.Input<List<GetRouterStatusBestRoutesForRouterParam>> params;
  ...
  final pulumi.Input<List<GetRouterStatusBestRoutesForRouterWarning>> warnings;
  ...
  const GetRouterStatusBestRoutesForRouter({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'asPaths': pulumi.Input.mapInputValue<List<GetRouterStatusBestRoutesForRouterAsPath>, List<Map<String, dynamic>>>(asPaths, (value) => pulumi.Input.encodeList<GetRouterStatusBestRoutesForRouterAsPath, Map<String, dynamic>>(value, (value) => value.toMap())),
      ...
      'params': pulumi.Input.mapInputValue<List<GetRouterStatusBestRoutesForRouterParam>, List<Map<String, dynamic>>>(params, (value) => pulumi.Input.encodeList<GetRouterStatusBestRoutesForRouterParam, Map<String, dynamic>>(value, (value) => value.toMap())),
      'priority': priority,
      'project': project,
      ...
      'selfLink': selfLink,
      'tags': tags,
      'warnings': pulumi.Input.mapInputValue<List<GetRouterStatusBestRoutesForRouterWarning>, List<Map<String, dynamic>>>(warnings, (value) => pulumi.Input.encodeList<GetRouterStatusBestRoutesForRouterWarning, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory GetRouterStatusBestRoutesForRouter.fromMap(Map<String, dynamic> map) {
    return GetRouterStatusBestRoutesForRouter(
      asPaths: pulumi.Input.fromValue(pulumi.Input.decodeList<GetRouterStatusBestRoutesForRouterAsPath>(map['asPaths']!, (value) => GetRouterStatusBestRoutesForRouterAsPath.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      params: pulumi.Input.fromValue(pulumi.Input.decodeList<GetRouterStatusBestRoutesForRouterParam>(map['params']!, (value) => GetRouterStatusBestRoutesForRouterParam.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      warnings: pulumi.Input.fromValue(pulumi.Input.decodeList<GetRouterStatusBestRoutesForRouterWarning>(map['warnings']!, (value) => GetRouterStatusBestRoutesForRouterWarning.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
