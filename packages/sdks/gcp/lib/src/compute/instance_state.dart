...
class InstanceState {
  ...
  InstanceState({
    ...
    pulumi.Output<InstanceBootDisk>? bootDisk,
    ...
    pulumi.Output<String>? zone,
      ...
      bootDisk = pulumi.Input.asOptionalInput<InstanceBootDisk>(bootDisk),
  ...
  factory InstanceState.fromMap(Map<String, dynamic> map) {
    return InstanceState(
      ...
      bootDisk: map['bootDisk'] == null ? null : pulumi.Output.create<InstanceBootDisk>(InstanceBootDisk.fromMap((map['bootDisk'] as Map).cast<String, dynamic>())),
