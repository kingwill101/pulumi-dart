...
class RegionResizeRequestStatusErrorErrorErrorDetail {
  ...
  final pulumi.Input<
    List<RegionResizeRequestStatusErrorErrorErrorDetailErrorInfo>
  >?
  errorInfos;
  ...
  /// A nested object resource.
  /// Structure is documented below.
  final pulumi.Input<List<RegionResizeRequestStatusErrorErrorErrorDetailHelp>>?
  helps;
  ...
  /// Structure is documented below.
  final pulumi.Input<
    List<RegionResizeRequestStatusErrorErrorErrorDetailLocalizedMessage>
  >?
  localizedMessages;
  ...
  /// Structure is documented below.
  final pulumi.Input<
    List<RegionResizeRequestStatusErrorErrorErrorDetailQuotaInfo>
  >?
  quotaInfos;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'helps':
          ?pulumi.Input.mapOptionalInputValue<
            List<RegionResizeRequestStatusErrorErrorErrorDetailHelp>,
            List<Map<String, dynamic>>
          >(
            helps,
            (value) =>
