...
class NetworkFirewallPolicyWithRulesRuleMatchLayer4Config {
  /// (Output)
  ...
  /// [ipProtocol] (Output)
  /// [ports] (Output)
  const NetworkFirewallPolicyWithRulesRuleMatchLayer4Config({
  ...
  factory NetworkFirewallPolicyWithRulesRuleMatchLayer4Config.fromMap(Map<String, dynamic> map) {
    return NetworkFirewallPolicyWithRulesRuleMatchLayer4Config(
