...
class StoragePoolIamMemberState {
  ...
  /// Creates a new [StoragePoolIamMemberState].
  ...
  const StoragePoolIamMemberState({
    this.condition,
    this.etag,
    this.member,
    this.name,
  ...
  factory StoragePoolIamMemberState.fromMap(Map<String, dynamic> map) {
    return StoragePoolIamMemberState(
