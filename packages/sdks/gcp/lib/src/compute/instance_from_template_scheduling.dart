...
class InstanceFromTemplateScheduling {
  ...
  final pulumi.Input<InstanceFromTemplateSchedulingGracefulShutdown>?
  gracefulShutdown;
  ...
  /// hour.
  final pulumi.Input<InstanceFromTemplateSchedulingLocalSsdRecoveryTimeout>?
  ...
  final pulumi.Input<InstanceFromTemplateSchedulingMaxRunDuration>?
  maxRunDuration;
  final pulumi.Input<int>? minNodeCpus;

  /// Specifies node affinities or anti-affinities to determine which sole-tenant nodes your instances and managed instance groups will use as host systems.
  final pulumi.Input<List<InstanceFromTemplateSchedulingNodeAffinity>>?
  nodeAffinities;
  ...
  final pulumi.Input<InstanceFromTemplateSchedulingOnInstanceStopAction>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'nodeAffinities':
          ?pulumi.Input.mapOptionalInputValue<
            List<InstanceFromTemplateSchedulingNodeAffinity>,
    ...
    return InstanceFromTemplateScheduling(
      ...
      gracefulShutdown: (() {
        ...
        return pulumi.Input.fromValue(
          InstanceFromTemplateSchedulingGracefulShutdown.fromMap(
      ...
      localSsdRecoveryTimeout: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          InstanceFromTemplateSchedulingLocalSsdRecoveryTimeout.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      maxRunDuration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          InstanceFromTemplateSchedulingMaxRunDuration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      nodeAffinities: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InstanceFromTemplateSchedulingNodeAffinity>(
            guardedValue,
            (value) => InstanceFromTemplateSchedulingNodeAffinity.fromMap(
      ...
      onInstanceStopAction: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          InstanceFromTemplateSchedulingOnInstanceStopAction.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
