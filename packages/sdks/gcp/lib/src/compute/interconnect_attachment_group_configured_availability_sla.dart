...
class InterconnectAttachmentGroupConfiguredAvailabilitySla {
  ...
  factory InterconnectAttachmentGroupConfiguredAvailabilitySla.fromMap(Map<String, dynamic> map) {
    return InterconnectAttachmentGroupConfiguredAvailabilitySla(
      effectiveSla: (() { final guardedValue = map['effectiveSla']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      intendedSlaBlockers: (() { final guardedValue = map['intendedSlaBlockers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InterconnectAttachmentGroupConfiguredAvailabilitySlaIntendedSlaBlocker>(guardedValue, (value) => InterconnectAttachmentGroupConfiguredAvailabilitySlaIntendedSlaBlocker.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
