    ...
    return <String, dynamic>{
      'asPaths':
          pulumi.Input.mapInputValue<
            List<RouterStatusBestRoutesForRouterAsPath>,
      ...
      'params':
          pulumi.Input.mapInputValue<
            List<RouterStatusBestRoutesForRouterParam>,
            List<Map<String, dynamic>>
          >(
            params,
            (value) =>
      ...
      'warnings':
          pulumi.Input.mapInputValue<
            List<RouterStatusBestRoutesForRouterWarning>,
            List<Map<String, dynamic>>
          >(
            warnings,
            (value) =>
  ...
  factory RouterStatusBestRoutesForRouter.fromMap(Map<String, dynamic> map) {
    return RouterStatusBestRoutesForRouter(
      asPaths: pulumi.Input.fromValue(
        pulumi.Input.decodeList<RouterStatusBestRoutesForRouterAsPath>(
          map['asPaths']!,
      ...
      params: pulumi.Input.fromValue(
        pulumi.Input.decodeList<RouterStatusBestRoutesForRouterParam>(
          map['params']!,
      ...
      warnings: pulumi.Input.fromValue(
        pulumi.Input.decodeList<RouterStatusBestRoutesForRouterWarning>(
          map['warnings']!,
