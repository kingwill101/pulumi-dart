...
class RouterStatusBestRoutesForRouter {
  ...
  const RouterStatusBestRoutesForRouter({
  ...
  factory RouterStatusBestRoutesForRouter.fromMap(Map<String, dynamic> map) {
    return RouterStatusBestRoutesForRouter(
      asPaths: pulumi.Input.fromValue(pulumi.Input.decodeList<RouterStatusBestRoutesForRouterAsPath>(map['asPaths']!, (value) => RouterStatusBestRoutesForRouterAsPath.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      params: pulumi.Input.fromValue(pulumi.Input.decodeList<RouterStatusBestRoutesForRouterParam>(map['params']!, (value) => RouterStatusBestRoutesForRouterParam.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      warnings: pulumi.Input.fromValue(pulumi.Input.decodeList<RouterStatusBestRoutesForRouterWarning>(map['warnings']!, (value) => RouterStatusBestRoutesForRouterWarning.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
