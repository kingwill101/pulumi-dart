...
import 'region_composite_health_check_state.dart';
...
class RegionCompositeHealthCheck extends pulumi.CustomResource {
  ...
  /// Creates a new [RegionCompositeHealthCheck].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [RegionCompositeHealthCheck]. {@macro pulumi_compute_region_composite_health_check_region_composite_health_check_args_doc}
  ...
  /// Gets an existing [RegionCompositeHealthCheck] resource's state with the given [name] and [id].
  static RegionCompositeHealthCheck get(
    String name,
  ...
  RegionCompositeHealthCheck._get(
    String name, {
