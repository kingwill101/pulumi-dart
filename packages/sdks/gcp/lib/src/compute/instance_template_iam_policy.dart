...
import 'instance_template_iam_policy_state.dart';
...
class InstanceTemplateIamPolicy extends pulumi.CustomResource {
  ...
  /// Gets an existing [InstanceTemplateIamPolicy] resource's state with the given [name] and [id].
  static InstanceTemplateIamPolicy get(
    String name,
    pulumi.Input<String> id, {
    InstanceTemplateIamPolicyState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return InstanceTemplateIamPolicy._get(
      name,
      state: state?.toMap(),
  ...
  InstanceTemplateIamPolicy._get(
    String name, {
  ...
  /// Creates a typed reference to an existing [InstanceTemplateIamPolicy] resource.
  InstanceTemplateIamPolicy.reference(String urn)
    : super(
        'gcp:compute/instanceTemplateIamPolicy:InstanceTemplateIamPolicy',
