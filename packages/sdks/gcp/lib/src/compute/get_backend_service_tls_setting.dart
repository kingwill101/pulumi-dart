...
class GetBackendServiceTlsSetting {
  ...
  factory GetBackendServiceTlsSetting.fromMap(Map<String, dynamic> map) {
    return GetBackendServiceTlsSetting(
      ...
      subjectAltNames: (pulumi.Input.decodeList<GetBackendServiceTlsSettingSubjectAltName>(map['subjectAltNames'], (value) => GetBackendServiceTlsSettingSubjectAltName.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
