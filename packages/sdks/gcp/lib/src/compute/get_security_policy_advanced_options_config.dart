...
class GetSecurityPolicyAdvancedOptionsConfig {
  ...
  const GetSecurityPolicyAdvancedOptionsConfig({
  ...
  factory GetSecurityPolicyAdvancedOptionsConfig.fromMap(Map<String, dynamic> map) {
    return GetSecurityPolicyAdvancedOptionsConfig(
      jsonCustomConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetSecurityPolicyAdvancedOptionsConfigJsonCustomConfig>(map['jsonCustomConfigs']!, (value) => GetSecurityPolicyAdvancedOptionsConfigJsonCustomConfig.fromMap((value as Map).cast<String, dynamic>()))),
      jsonParsing: pulumi.Input.fromValue(map['jsonParsing'] as String),
      logLevel: pulumi.Input.fromValue(map['logLevel'] as String),
      requestBodyInspectionSize: pulumi.Input.fromValue(map['requestBodyInspectionSize'] as String),
