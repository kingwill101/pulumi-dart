...
class URLMapPathMatcherRouteRuleRouteActionCachePolicyCacheKeyPolicy {
  ...
  /// Creates a new [URLMapPathMatcherRouteRuleRouteActionCachePolicyCacheKeyPolicy].
  ...
  const URLMapPathMatcherRouteRuleRouteActionCachePolicyCacheKeyPolicy({
  ...
  factory URLMapPathMatcherRouteRuleRouteActionCachePolicyCacheKeyPolicy.fromMap(Map<String, dynamic> map) {
    return URLMapPathMatcherRouteRuleRouteActionCachePolicyCacheKeyPolicy(
