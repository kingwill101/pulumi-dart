...
class RegionUrlMapPathMatcherDefaultRouteActionRetryPolicy {
  ...
  final RegionUrlMapPathMatcherDefaultRouteActionRetryPolicyPerTryTimeout? perTryTimeout;
  ...
  factory RegionUrlMapPathMatcherDefaultRouteActionRetryPolicy.fromMap(Map<String, dynamic> map) {
    return RegionUrlMapPathMatcherDefaultRouteActionRetryPolicy(
      ...
      perTryTimeout: map['perTryTimeout'] == null ? null : RegionUrlMapPathMatcherDefaultRouteActionRetryPolicyPerTryTimeout.fromMap((map['perTryTimeout'] as Map).cast<String, dynamic>()),
