...
class ImageIamMemberState {
  ...
  /// Creates a new [ImageIamMemberState].
  ...
  factory ImageIamMemberState.fromMap(Map<String, dynamic> map) {
    return ImageIamMemberState(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ImageIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
