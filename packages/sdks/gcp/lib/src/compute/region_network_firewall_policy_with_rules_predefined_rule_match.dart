...
class RegionNetworkFirewallPolicyWithRulesPredefinedRuleMatch {
  ...
  final List<RegionNetworkFirewallPolicyWithRulesPredefinedRuleMatchLayer4Config>? layer4Configs;
  ...
  final List<RegionNetworkFirewallPolicyWithRulesPredefinedRuleMatchSrcSecureTag>? srcSecureTags;
  /// Names of Network Threat Intelligence lists.
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'layer4Configs': ?layer4Configs == null ? null : pulumi.Input.encodeList<RegionNetworkFirewallPolicyWithRulesPredefinedRuleMatchLayer4Config, Map<String, dynamic>>(layer4Configs!, (value) => value.toMap()),
      'srcAddressGroups': ?srcAddressGroups,
      'srcFqdns': ?srcFqdns,
      'srcIpRanges': ?srcIpRanges,
      'srcRegionCodes': ?srcRegionCodes,
      'srcSecureTags': ?srcSecureTags == null ? null : pulumi.Input.encodeList<RegionNetworkFirewallPolicyWithRulesPredefinedRuleMatchSrcSecureTag, Map<String, dynamic>>(srcSecureTags!, (value) => value.toMap()),
  ...
  factory RegionNetworkFirewallPolicyWithRulesPredefinedRuleMatch.fromMap(Map<String, dynamic> map) {
    return RegionNetworkFirewallPolicyWithRulesPredefinedRuleMatch(
      ...
      layer4Configs: map['layer4Configs'] == null ? null : pulumi.Input.decodeList<RegionNetworkFirewallPolicyWithRulesPredefinedRuleMatchLayer4Config>(map['layer4Configs'], (value) => RegionNetworkFirewallPolicyWithRulesPredefinedRuleMatchLayer4Config.fromMap((value as Map).cast<String, dynamic>())),
      ...
      srcSecureTags: map['srcSecureTags'] == null ? null : pulumi.Input.decodeList<RegionNetworkFirewallPolicyWithRulesPredefinedRuleMatchSrcSecureTag>(map['srcSecureTags'], (value) => RegionNetworkFirewallPolicyWithRulesPredefinedRuleMatchSrcSecureTag.fromMap((value as Map).cast<String, dynamic>())),
