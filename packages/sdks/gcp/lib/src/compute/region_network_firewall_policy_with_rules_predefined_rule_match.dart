...
class RegionNetworkFirewallPolicyWithRulesPredefinedRuleMatch {
  ...
  final pulumi.Input<List<RegionNetworkFirewallPolicyWithRulesPredefinedRuleMatchLayer4Config>>? layer4Configs;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'layer4Configs': ?pulumi.Input.mapOptionalInputValue<List<RegionNetworkFirewallPolicyWithRulesPredefinedRuleMatchLayer4Config>, List<Map<String, dynamic>>>(layer4Configs, (value) => pulumi.Input.encodeList<RegionNetworkFirewallPolicyWithRulesPredefinedRuleMatchLayer4Config, Map<String, dynamic>>(value, (value) => value.toMap())),
      'srcAddressGroups': ?srcAddressGroups,
      'srcFqdns': ?srcFqdns,
      'srcIpRanges': ?srcIpRanges,
      'srcRegionCodes': ?srcRegionCodes,
      'srcSecureTags': ?pulumi.Input.mapOptionalInputValue<List<RegionNetworkFirewallPolicyWithRulesPredefinedRuleMatchSrcSecureTag>, List<Map<String, dynamic>>>(srcSecureTags, (value) => pulumi.Input.encodeList<RegionNetworkFirewallPolicyWithRulesPredefinedRuleMatchSrcSecureTag, Map<String, dynamic>>(value, (value) => value.toMap())),
      'srcThreatIntelligences': ?srcThreatIntelligences,
    };
  }

  factory RegionNetworkFirewallPolicyWithRulesPredefinedRuleMatch.fromMap(Map<String, dynamic> map) {
    return RegionNetworkFirewallPolicyWithRulesPredefinedRuleMatch(
      ...
      layer4Configs: (() { final guardedValue = map['layer4Configs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RegionNetworkFirewallPolicyWithRulesPredefinedRuleMatchLayer4Config>(guardedValue, (value) => RegionNetworkFirewallPolicyWithRulesPredefinedRuleMatchLayer4Config.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      srcSecureTags: (() { final guardedValue = map['srcSecureTags']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RegionNetworkFirewallPolicyWithRulesPredefinedRuleMatchSrcSecureTag>(guardedValue, (value) => RegionNetworkFirewallPolicyWithRulesPredefinedRuleMatchSrcSecureTag.fromMap((value as Map).cast<String, dynamic>()))); })(),
