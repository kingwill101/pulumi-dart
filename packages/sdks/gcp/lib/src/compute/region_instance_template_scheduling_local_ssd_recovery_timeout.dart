...
class RegionInstanceTemplateSchedulingLocalSsdRecoveryTimeout {
  ...
  /// Creates a new [RegionInstanceTemplateSchedulingLocalSsdRecoveryTimeout].
  ...
  factory RegionInstanceTemplateSchedulingLocalSsdRecoveryTimeout.fromMap(
