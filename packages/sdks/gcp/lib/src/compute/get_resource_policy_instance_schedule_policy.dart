...
class GetResourcePolicyInstanceSchedulePolicy {
  ...
  factory GetResourcePolicyInstanceSchedulePolicy.fromMap(Map<String, dynamic> map) {
    return GetResourcePolicyInstanceSchedulePolicy(
      ...
      vmStartSchedules: (pulumi.Input.decodeList<GetResourcePolicyInstanceSchedulePolicyVmStartSchedule>(map['vmStartSchedules'], (value) => GetResourcePolicyInstanceSchedulePolicyVmStartSchedule.fromMap((value as Map).cast<String, dynamic>()))).input(),
      vmStopSchedules: (pulumi.Input.decodeList<GetResourcePolicyInstanceSchedulePolicyVmStopSchedule>(map['vmStopSchedules'], (value) => GetResourcePolicyInstanceSchedulePolicyVmStopSchedule.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
