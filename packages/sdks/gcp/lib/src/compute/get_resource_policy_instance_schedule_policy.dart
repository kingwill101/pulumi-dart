...
class GetResourcePolicyInstanceSchedulePolicy {
  ...
  final pulumi.Input<
    List<GetResourcePolicyInstanceSchedulePolicyVmStartSchedule>
  >
  vmStartSchedules;

  /// Specifies the schedule for stopping instances.
  final pulumi.Input<
    List<GetResourcePolicyInstanceSchedulePolicyVmStopSchedule>
  >
  vmStopSchedules;
  ...
  factory GetResourcePolicyInstanceSchedulePolicy.fromMap(
    ...
    return GetResourcePolicyInstanceSchedulePolicy(
      ...
      vmStartSchedules: pulumi.Input.fromValue(
      ...
      vmStopSchedules: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetResourcePolicyInstanceSchedulePolicyVmStopSchedule
        >(
          map['vmStopSchedules']!,
