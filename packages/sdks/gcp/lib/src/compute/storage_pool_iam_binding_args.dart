...
class StoragePoolIamBindingArgs {
  ...
  const StoragePoolIamBindingArgs({
    this.condition,
  ...
  factory StoragePoolIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return StoragePoolIamBindingArgs(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(StoragePoolIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
