...
class ServiceAttachmentArgs {
  ...
  ServiceAttachmentArgs({
    ...
    required pulumi.Output<bool> enableProxyProtocol,
    pulumi.Output<String>? name,
    required pulumi.Output<List<String>> natSubnets,
    ...
    required pulumi.Output<String> targetService,
  ...
  factory ServiceAttachmentArgs.fromMap(Map<String, dynamic> map) {
    return ServiceAttachmentArgs(
      ...
      enableProxyProtocol: pulumi.Output.create<bool>(map['enableProxyProtocol'] as bool),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      natSubnets: pulumi.Output.create<List<String>>((map['natSubnets'] as List).cast<String>()),
      ...
      targetService: pulumi.Output.create<String>(map['targetService'] as String),
