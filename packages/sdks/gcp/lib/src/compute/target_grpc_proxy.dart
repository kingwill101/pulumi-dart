...
import 'target_grpc_proxy_state.dart';
...
class TargetGrpcProxy extends pulumi.CustomResource {
  ...
  /// Gets an existing [TargetGrpcProxy] resource's state with the given [name] and [id].
  static TargetGrpcProxy get(
    String name,
