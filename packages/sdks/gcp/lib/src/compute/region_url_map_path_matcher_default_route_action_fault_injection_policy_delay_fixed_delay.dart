...
class RegionUrlMapPathMatcherDefaultRouteActionFaultInjectionPolicyDelayFixedDelay {
  ...
  const RegionUrlMapPathMatcherDefaultRouteActionFaultInjectionPolicyDelayFixedDelay({
    this.nanos,
    this.seconds,
  });
  ...
  factory RegionUrlMapPathMatcherDefaultRouteActionFaultInjectionPolicyDelayFixedDelay.fromMap(Map<String, dynamic> map) {
