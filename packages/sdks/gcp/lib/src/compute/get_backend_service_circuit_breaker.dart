...
class GetBackendServiceCircuitBreaker {
  ...
  final pulumi.Input<List<GetBackendServiceCircuitBreakerConnectTimeout>> connectTimeouts;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'connectTimeouts': pulumi.Input.mapInputValue<List<GetBackendServiceCircuitBreakerConnectTimeout>, List<Map<String, dynamic>>>(connectTimeouts, (value) => pulumi.Input.encodeList<GetBackendServiceCircuitBreakerConnectTimeout, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory GetBackendServiceCircuitBreaker.fromMap(Map<String, dynamic> map) {
    return GetBackendServiceCircuitBreaker(
      connectTimeouts: (pulumi.Input.decodeList<GetBackendServiceCircuitBreakerConnectTimeout>(map['connectTimeouts'], (value) => GetBackendServiceCircuitBreakerConnectTimeout.fromMap((value as Map).cast<String, dynamic>()))).input(),
