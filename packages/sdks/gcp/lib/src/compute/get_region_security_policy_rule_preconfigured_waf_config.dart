...
class GetRegionSecurityPolicyRulePreconfiguredWafConfig {
  ...
  factory GetRegionSecurityPolicyRulePreconfiguredWafConfig.fromMap(Map<String, dynamic> map) {
    return GetRegionSecurityPolicyRulePreconfiguredWafConfig(
      exclusions: (pulumi.Input.decodeList<GetRegionSecurityPolicyRulePreconfiguredWafConfigExclusion>(map['exclusions'], (value) => GetRegionSecurityPolicyRulePreconfiguredWafConfigExclusion.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
