...
class PerInstanceConfigPreservedState {
  ...
  /// Structure is documented below.
  final pulumi.Input<List<PerInstanceConfigPreservedStateExternalIp>>?
  externalIps;

  /// Preserved internal IPs defined for this instance. This map is keyed with the name of the network interface.
  /// Structure is documented below.
  final pulumi.Input<List<PerInstanceConfigPreservedStateInternalIp>>?
  internalIps;
    ...
    return <String, dynamic>{
      'disks':
          ?pulumi.Input.mapOptionalInputValue<
            List<PerInstanceConfigPreservedStateDisk>,
      ...
      'externalIps':
          ?pulumi.Input.mapOptionalInputValue<
            List<PerInstanceConfigPreservedStateExternalIp>,
            List<Map<String, dynamic>>
          >(
            externalIps,
            (value) =>
      ...
      'internalIps':
          ?pulumi.Input.mapOptionalInputValue<
            List<PerInstanceConfigPreservedStateInternalIp>,
            List<Map<String, dynamic>>
          >(
            internalIps,
            (value) =>
