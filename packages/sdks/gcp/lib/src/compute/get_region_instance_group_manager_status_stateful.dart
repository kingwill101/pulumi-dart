...
class GetRegionInstanceGroupManagerStatusStateful {
  ...
  final pulumi.Input<List<GetRegionInstanceGroupManagerStatusStatefulPerInstanceConfig>> perInstanceConfigs;
  ...
  const GetRegionInstanceGroupManagerStatusStateful({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'perInstanceConfigs': pulumi.Input.mapInputValue<List<GetRegionInstanceGroupManagerStatusStatefulPerInstanceConfig>, List<Map<String, dynamic>>>(perInstanceConfigs, (value) => pulumi.Input.encodeList<GetRegionInstanceGroupManagerStatusStatefulPerInstanceConfig, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory GetRegionInstanceGroupManagerStatusStateful.fromMap(Map<String, dynamic> map) {
    return GetRegionInstanceGroupManagerStatusStateful(
      ...
      perInstanceConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetRegionInstanceGroupManagerStatusStatefulPerInstanceConfig>(map['perInstanceConfigs']!, (value) => GetRegionInstanceGroupManagerStatusStatefulPerInstanceConfig.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
