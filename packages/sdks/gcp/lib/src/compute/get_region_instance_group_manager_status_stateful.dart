...
class GetRegionInstanceGroupManagerStatusStateful {
  ...
  factory GetRegionInstanceGroupManagerStatusStateful.fromMap(Map<String, dynamic> map) {
    return GetRegionInstanceGroupManagerStatusStateful(
      ...
      perInstanceConfigs: (pulumi.Input.decodeList<GetRegionInstanceGroupManagerStatusStatefulPerInstanceConfig>(map['perInstanceConfigs'], (value) => GetRegionInstanceGroupManagerStatusStatefulPerInstanceConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
