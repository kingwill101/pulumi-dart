...
class GetBackendServiceSecuritySetting {
  ...
  final pulumi.Input<List<GetBackendServiceSecuritySettingAwsV4Authentication>>
    ...
    return <String, dynamic>{
      'awsV4Authentications':
          pulumi.Input.mapInputValue<
            List<GetBackendServiceSecuritySettingAwsV4Authentication>,
  ...
  factory GetBackendServiceSecuritySetting.fromMap(Map<String, dynamic> map) {
    return GetBackendServiceSecuritySetting(
      awsV4Authentications: pulumi.Input.fromValue(
