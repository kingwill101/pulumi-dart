...
class StoragePoolResourceStatus {
  ...
  factory StoragePoolResourceStatus.fromMap(Map<String, dynamic> map) {
    return StoragePoolResourceStatus(
      ...
      lastResizeTimestamp: map['lastResizeTimestamp'] == null ? null : map['lastResizeTimestamp'] as String,
      maxTotalProvisionedDiskCapacityGb: map['maxTotalProvisionedDiskCapacityGb'] == null ? null : map['maxTotalProvisionedDiskCapacityGb'] as String,
      poolUsedCapacityBytes: map['poolUsedCapacityBytes'] == null ? null : map['poolUsedCapacityBytes'] as String,
      poolUsedIops: map['poolUsedIops'] == null ? null : map['poolUsedIops'] as String,
      poolUsedThroughput: map['poolUsedThroughput'] == null ? null : map['poolUsedThroughput'] as String,
      poolUserWrittenBytes: map['poolUserWrittenBytes'] == null ? null : map['poolUserWrittenBytes'] as String,
      totalProvisionedDiskCapacityGb: map['totalProvisionedDiskCapacityGb'] == null ? null : map['totalProvisionedDiskCapacityGb'] as String,
      totalProvisionedDiskIops: map['totalProvisionedDiskIops'] == null ? null : map['totalProvisionedDiskIops'] as String,
      totalProvisionedDiskThroughput: map['totalProvisionedDiskThroughput'] == null ? null : map['totalProvisionedDiskThroughput'] as String,
    );
  }
}
