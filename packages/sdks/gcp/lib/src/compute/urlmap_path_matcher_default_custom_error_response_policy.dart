...
class URLMapPathMatcherDefaultCustomErrorResponsePolicy {
  ...
  const URLMapPathMatcherDefaultCustomErrorResponsePolicy({
  ...
  factory URLMapPathMatcherDefaultCustomErrorResponsePolicy.fromMap(Map<String, dynamic> map) {
    return URLMapPathMatcherDefaultCustomErrorResponsePolicy(
      errorResponseRules: (() { final guardedValue = map['errorResponseRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<URLMapPathMatcherDefaultCustomErrorResponsePolicyErrorResponseRule>(guardedValue, (value) => URLMapPathMatcherDefaultCustomErrorResponsePolicyErrorResponseRule.fromMap((value as Map).cast<String, dynamic>()))); })(),
