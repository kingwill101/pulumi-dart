...
class InstanceTemplateArgs {
  ...
  InstanceTemplateArgs({
    ...
    required pulumi.Output<List<InstanceTemplateDisk>> disks,
  ...
  factory InstanceTemplateArgs.fromMap(Map<String, dynamic> map) {
    return InstanceTemplateArgs(
      ...
      disks: pulumi.Output.create<List<InstanceTemplateDisk>>(pulumi.Input.decodeList<InstanceTemplateDisk>(map['disks'], (value) => InstanceTemplateDisk.fromMap((value as Map).cast<String, dynamic>()))),
