...
class GetRoutersRouter {
  ...
  factory GetRoutersRouter.fromMap(Map<String, dynamic> map) {
    return GetRoutersRouter(
      bgpPeers: pulumi.Input.fromValue(pulumi.Input.decodeList<GetRoutersRouterBgpPeer>(map['bgpPeers']!, (value) => GetRoutersRouterBgpPeer.fromMap((value as Map).cast<String, dynamic>()))),
      bgps: pulumi.Input.fromValue(pulumi.Input.decodeList<GetRoutersRouterBgp>(map['bgps']!, (value) => GetRoutersRouterBgp.fromMap((value as Map).cast<String, dynamic>()))),
      creationTimestamp: pulumi.Input.fromValue(map['creationTimestamp'] as String),
      description: pulumi.Input.fromValue(map['description'] as String),
      encryptedInterconnectRouter: pulumi.Input.fromValue(map['encryptedInterconnectRouter'] as bool),
      interfaces: pulumi.Input.fromValue(pulumi.Input.decodeList<GetRoutersRouterInterface>(map['interfaces']!, (value) => GetRoutersRouterInterface.fromMap((value as Map).cast<String, dynamic>()))),
      md5AuthenticationKeys: pulumi.Input.fromValue(pulumi.Input.decodeList<GetRoutersRouterMd5AuthenticationKey>(map['md5AuthenticationKeys']!, (value) => GetRoutersRouterMd5AuthenticationKey.fromMap((value as Map).cast<String, dynamic>()))),
      name: pulumi.Input.fromValue(map['name'] as String),
      nats: pulumi.Input.fromValue(pulumi.Input.decodeList<GetRoutersRouterNat>(map['nats']!, (value) => GetRoutersRouterNat.fromMap((value as Map).cast<String, dynamic>()))),
