...
class StoragePoolState {
  ...
  factory StoragePoolState.fromMap(Map<String, dynamic> map) {
    return StoragePoolState(
      ...
      poolProvisionedThroughput: (() { final guardedValue = map['poolProvisionedThroughput']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      project: (() { final guardedValue = map['project']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      pulumiLabels: (() { final guardedValue = map['pulumiLabels']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      resourceStatuses: (() { final guardedValue = map['resourceStatuses']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<StoragePoolResourceStatus>(guardedValue, (value) => StoragePoolResourceStatus.fromMap((value as Map).cast<String, dynamic>()))); })(),
      statuses: (() { final guardedValue = map['statuses']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<StoragePoolStatus>(guardedValue, (value) => StoragePoolStatus.fromMap((value as Map).cast<String, dynamic>()))); })(),
