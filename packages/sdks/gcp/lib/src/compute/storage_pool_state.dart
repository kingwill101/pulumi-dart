...
class StoragePoolState {
  ...
  factory StoragePoolState.fromMap(Map<String, dynamic> map) {
    return StoragePoolState(
      ...
      poolProvisionedCapacityGb: map['poolProvisionedCapacityGb'] == null ? null : (map['poolProvisionedCapacityGb'] as String).input(),
      poolProvisionedIops: map['poolProvisionedIops'] == null ? null : (map['poolProvisionedIops'] as String).input(),
      poolProvisionedThroughput: map['poolProvisionedThroughput'] == null ? null : (map['poolProvisionedThroughput'] as String).input(),
      project: map['project'] == null ? null : (map['project'] as String).input(),
      pulumiLabels: map['pulumiLabels'] == null ? null : ((map['pulumiLabels'] as Map).cast<String, String>()).input(),
      resourceStatuses: map['resourceStatuses'] == null ? null : (pulumi.Input.decodeList<StoragePoolResourceStatus>(map['resourceStatuses'], (value) => StoragePoolResourceStatus.fromMap((value as Map).cast<String, dynamic>()))).input(),
      statuses: map['statuses'] == null ? null : (pulumi.Input.decodeList<StoragePoolStatus>(map['statuses'], (value) => StoragePoolStatus.fromMap((value as Map).cast<String, dynamic>()))).input(),
