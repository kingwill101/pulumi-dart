...
class DiskIamMemberState {
  ...
  /// Creates a new [DiskIamMemberState].
  /// [condition] Optional.
  ...
  factory DiskIamMemberState.fromMap(Map<String, dynamic> map) {
    return DiskIamMemberState(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DiskIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
