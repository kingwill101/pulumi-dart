...
class GetRegionSecurityPolicyRuleRateLimitOption {
  ...
  final pulumi.Input<
    List<GetRegionSecurityPolicyRuleRateLimitOptionBanThreshold>
  >
  banThresholds;
  ...
  final pulumi.Input<
    List<GetRegionSecurityPolicyRuleRateLimitOptionEnforceOnKeyConfig>
  >
  enforceOnKeyConfigs;
  ...
  final pulumi.Input<
    List<GetRegionSecurityPolicyRuleRateLimitOptionRateLimitThreshold>
  >
  rateLimitThresholds;
