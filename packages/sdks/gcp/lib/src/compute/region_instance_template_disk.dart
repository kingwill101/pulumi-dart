...
class RegionInstanceTemplateDisk {
  ...
  final pulumi.Input<RegionInstanceTemplateDiskDiskEncryptionKey>?
  diskEncryptionKey;
  ...
  /// documented below.
  final pulumi.Input<RegionInstanceTemplateDiskSourceImageEncryptionKey>?
  ...
  /// documented below.
  final pulumi.Input<RegionInstanceTemplateDiskSourceSnapshotEncryptionKey>?
