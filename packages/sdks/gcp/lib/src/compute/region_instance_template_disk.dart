...
class RegionInstanceTemplateDisk {
  ...
  final pulumi.Input<RegionInstanceTemplateDiskDiskEncryptionKey>? diskEncryptionKey;
  ...
  /// documented below.
  final pulumi.Input<RegionInstanceTemplateDiskSourceImageEncryptionKey>? sourceImageEncryptionKey;
  ...
  /// documented below.
  final pulumi.Input<RegionInstanceTemplateDiskSourceSnapshotEncryptionKey>? sourceSnapshotEncryptionKey;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'diskEncryptionKey': ?pulumi.Input.mapOptionalInputValue<RegionInstanceTemplateDiskDiskEncryptionKey, Map<String, dynamic>>(diskEncryptionKey, (value) => value.toMap()),
      'diskName': ?diskName,
      ...
      'sourceImageEncryptionKey': ?pulumi.Input.mapOptionalInputValue<RegionInstanceTemplateDiskSourceImageEncryptionKey, Map<String, dynamic>>(sourceImageEncryptionKey, (value) => value.toMap()),
      'sourceSnapshot': ?sourceSnapshot,
      'sourceSnapshotEncryptionKey': ?pulumi.Input.mapOptionalInputValue<RegionInstanceTemplateDiskSourceSnapshotEncryptionKey, Map<String, dynamic>>(sourceSnapshotEncryptionKey, (value) => value.toMap()),
  ...
  factory RegionInstanceTemplateDisk.fromMap(Map<String, dynamic> map) {
    return RegionInstanceTemplateDisk(
      ...
      diskEncryptionKey: (() { final guardedValue = map['diskEncryptionKey']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionInstanceTemplateDiskDiskEncryptionKey.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      sourceImageEncryptionKey: (() { final guardedValue = map['sourceImageEncryptionKey']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionInstanceTemplateDiskSourceImageEncryptionKey.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      sourceSnapshotEncryptionKey: (() { final guardedValue = map['sourceSnapshotEncryptionKey']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionInstanceTemplateDiskSourceSnapshotEncryptionKey.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
