...
class RegionInstanceTemplateDisk {
  ...
  factory RegionInstanceTemplateDisk.fromMap(Map<String, dynamic> map) {
    return RegionInstanceTemplateDisk(
      ...
      diskEncryptionKey: map['diskEncryptionKey'] == null ? null : (RegionInstanceTemplateDiskDiskEncryptionKey.fromMap((map['diskEncryptionKey']! as Map).cast<String, dynamic>())).input(),
      ...
      sourceImageEncryptionKey: map['sourceImageEncryptionKey'] == null ? null : (RegionInstanceTemplateDiskSourceImageEncryptionKey.fromMap((map['sourceImageEncryptionKey']! as Map).cast<String, dynamic>())).input(),
      sourceSnapshot: map['sourceSnapshot'] == null ? null : (map['sourceSnapshot']! as String).input(),
      sourceSnapshotEncryptionKey: map['sourceSnapshotEncryptionKey'] == null ? null : (RegionInstanceTemplateDiskSourceSnapshotEncryptionKey.fromMap((map['sourceSnapshotEncryptionKey']! as Map).cast<String, dynamic>())).input(),
