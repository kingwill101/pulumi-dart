    ...
    return RouterState(
      bgp: (() {
        ...
        return pulumi.Input.fromValue(
          RouterBgp.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      creationTimestamp: (() {
      ...
      nccGateway: (() {
        final guardedValue = map['nccGateway'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      network: (() {
      ...
      params: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RouterParams.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      project: (() {
