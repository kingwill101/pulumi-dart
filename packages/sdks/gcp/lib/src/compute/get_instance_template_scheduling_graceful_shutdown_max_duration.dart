...
class GetInstanceTemplateSchedulingGracefulShutdownMaxDuration {
  ...
  const GetInstanceTemplateSchedulingGracefulShutdownMaxDuration({
    required this.nanos,
  ...
  factory GetInstanceTemplateSchedulingGracefulShutdownMaxDuration.fromMap(Map<String, dynamic> map) {
