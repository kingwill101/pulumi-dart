...
class InstanceFromTemplateNetworkInterfaceAliasIpv6Range {
  ...
  /// Creates a new [InstanceFromTemplateNetworkInterfaceAliasIpv6Range].
  ...
  const InstanceFromTemplateNetworkInterfaceAliasIpv6Range({
  ...
  factory InstanceFromTemplateNetworkInterfaceAliasIpv6Range.fromMap(Map<String, dynamic> map) {
    return InstanceFromTemplateNetworkInterfaceAliasIpv6Range(
