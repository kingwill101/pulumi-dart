...
class URLMapPathMatcher {
  ...
  factory URLMapPathMatcher.fromMap(Map<String, dynamic> map) {
    return URLMapPathMatcher(
      defaultCustomErrorResponsePolicy: (() { final guardedValue = map['defaultCustomErrorResponsePolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(URLMapPathMatcherDefaultCustomErrorResponsePolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      defaultRouteAction: (() { final guardedValue = map['defaultRouteAction']; if (guardedValue == null) return null; return pulumi.Input.fromValue(URLMapPathMatcherDefaultRouteAction.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      defaultUrlRedirect: (() { final guardedValue = map['defaultUrlRedirect']; if (guardedValue == null) return null; return pulumi.Input.fromValue(URLMapPathMatcherDefaultUrlRedirect.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      description: (() { final guardedValue = map['description']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      headerAction: (() { final guardedValue = map['headerAction']; if (guardedValue == null) return null; return pulumi.Input.fromValue(URLMapPathMatcherHeaderAction.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      name: pulumi.Input.fromValue(map['name'] as String),
      pathRules: (() { final guardedValue = map['pathRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<URLMapPathMatcherPathRule>(guardedValue, (value) => URLMapPathMatcherPathRule.fromMap((value as Map).cast<String, dynamic>()))); })(),
      routeRules: (() { final guardedValue = map['routeRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<URLMapPathMatcherRouteRule>(guardedValue, (value) => URLMapPathMatcherRouteRule.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
