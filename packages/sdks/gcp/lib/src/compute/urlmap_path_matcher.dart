...
class URLMapPathMatcher {
  ...
  final pulumi.Input<URLMapPathMatcherDefaultCustomErrorResponsePolicy>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'pathRules':
          ?pulumi.Input.mapOptionalInputValue<
            List<URLMapPathMatcherPathRule>,
      ...
      'routeRules':
          ?pulumi.Input.mapOptionalInputValue<
            List<URLMapPathMatcherRouteRule>,
            List<Map<String, dynamic>>
          >(
            routeRules,
            (value) =>
    ...
    return URLMapPathMatcher(
      defaultCustomErrorResponsePolicy: (() {
        ...
        return pulumi.Input.fromValue(
          URLMapPathMatcherDefaultCustomErrorResponsePolicy.fromMap(
      ...
      defaultRouteAction: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          URLMapPathMatcherDefaultRouteAction.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      defaultUrlRedirect: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          URLMapPathMatcherDefaultUrlRedirect.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      headerAction: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          URLMapPathMatcherHeaderAction.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
