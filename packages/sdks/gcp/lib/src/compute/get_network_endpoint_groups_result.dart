...
class GetNetworkEndpointGroupsResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'filter': ?filter,
      'id': id,
      'networkEndpointGroups': pulumi.Input.encodeList<GetNetworkEndpointGroupsNetworkEndpointGroup, Map<String, dynamic>>(networkEndpointGroups, (value) => value.toMap()),
      'project': ?project,
      'zone': ?zone,
    };
  }
  ...
  factory GetNetworkEndpointGroupsResult.fromMap(Map<String, dynamic> map) {
    return GetNetworkEndpointGroupsResult(
      ...
      id: map['id'] as String,
      networkEndpointGroups: pulumi.Input.decodeList<GetNetworkEndpointGroupsNetworkEndpointGroup>(map['networkEndpointGroups']!, (value) => GetNetworkEndpointGroupsNetworkEndpointGroup.fromMap((value as Map).cast<String, dynamic>())),
