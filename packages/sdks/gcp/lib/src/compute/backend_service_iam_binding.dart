...
import 'backend_service_iam_binding_state.dart';
...
class BackendServiceIamBinding extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [BackendServiceIamBinding]. {@macro pulumi_compute_backend_service_iam_binding_backend_service_iam_binding_args_doc}
  ...
  BackendServiceIamBinding(
    ...
    condition = registerOutput<BackendServiceIamBindingCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return BackendServiceIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [BackendServiceIamBinding] resource's state with the given [name] and [id].
  static BackendServiceIamBinding get(
    String name,
    pulumi.Input<String> id, {
    BackendServiceIamBindingState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return BackendServiceIamBinding._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [BackendServiceIamBinding] resource.
  BackendServiceIamBinding.reference(String urn)
    : super(
        'gcp:compute/backendServiceIamBinding:BackendServiceIamBinding',
