...
class RegionInstanceTemplateReservationAffinity {
  ...
  factory RegionInstanceTemplateReservationAffinity.fromMap(Map<String, dynamic> map) {
    return RegionInstanceTemplateReservationAffinity(
      specificReservation: (() { final guardedValue = map['specificReservation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionInstanceTemplateReservationAffinitySpecificReservation.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
