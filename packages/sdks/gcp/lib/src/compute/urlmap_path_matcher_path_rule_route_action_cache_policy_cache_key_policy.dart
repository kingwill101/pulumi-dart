...
class URLMapPathMatcherPathRuleRouteActionCachePolicyCacheKeyPolicy {
  ...
  const URLMapPathMatcherPathRuleRouteActionCachePolicyCacheKeyPolicy({
  ...
  factory URLMapPathMatcherPathRuleRouteActionCachePolicyCacheKeyPolicy.fromMap(Map<String, dynamic> map) {
    return URLMapPathMatcherPathRuleRouteActionCachePolicyCacheKeyPolicy(
