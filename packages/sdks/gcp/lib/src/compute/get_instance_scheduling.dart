...
class GetInstanceScheduling {
  ...
  factory GetInstanceScheduling.fromMap(Map<String, dynamic> map) {
    return GetInstanceScheduling(
      ...
      gracefulShutdowns: (pulumi.Input.decodeList<GetInstanceSchedulingGracefulShutdown>(map['gracefulShutdowns'], (value) => GetInstanceSchedulingGracefulShutdown.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      localSsdRecoveryTimeouts: (pulumi.Input.decodeList<GetInstanceSchedulingLocalSsdRecoveryTimeout>(map['localSsdRecoveryTimeouts'], (value) => GetInstanceSchedulingLocalSsdRecoveryTimeout.fromMap((value as Map).cast<String, dynamic>()))).input(),
      maintenanceInterval: (map['maintenanceInterval'] as String).input(),
      maxRunDurations: (pulumi.Input.decodeList<GetInstanceSchedulingMaxRunDuration>(map['maxRunDurations'], (value) => GetInstanceSchedulingMaxRunDuration.fromMap((value as Map).cast<String, dynamic>()))).input(),
      minNodeCpus: (map['minNodeCpus'] as int).input(),
      nodeAffinities: (pulumi.Input.decodeList<GetInstanceSchedulingNodeAffinity>(map['nodeAffinities'], (value) => GetInstanceSchedulingNodeAffinity.fromMap((value as Map).cast<String, dynamic>()))).input(),
      onHostMaintenance: (map['onHostMaintenance'] as String).input(),
      onInstanceStopActions: (pulumi.Input.decodeList<GetInstanceSchedulingOnInstanceStopAction>(map['onInstanceStopActions'], (value) => GetInstanceSchedulingOnInstanceStopAction.fromMap((value as Map).cast<String, dynamic>()))).input(),
