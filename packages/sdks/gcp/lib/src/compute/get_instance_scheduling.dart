...
class GetInstanceScheduling {
  ...
  final pulumi.Input<List<GetInstanceSchedulingGracefulShutdown>>
  gracefulShutdowns;
  ...
  /// hour.
  final pulumi.Input<List<GetInstanceSchedulingLocalSsdRecoveryTimeout>>
  ...
  final pulumi.Input<List<GetInstanceSchedulingOnInstanceStopAction>>
    ...
    return <String, dynamic>{
      ...
      'gracefulShutdowns':
          pulumi.Input.mapInputValue<
            List<GetInstanceSchedulingGracefulShutdown>,
      ...
      'localSsdRecoveryTimeouts':
          pulumi.Input.mapInputValue<
            List<GetInstanceSchedulingLocalSsdRecoveryTimeout>,
            List<Map<String, dynamic>>
          >(
            localSsdRecoveryTimeouts,
            (value) =>
      ...
      'maxRunDurations':
          pulumi.Input.mapInputValue<
            List<GetInstanceSchedulingMaxRunDuration>,
            List<Map<String, dynamic>>
          >(
            maxRunDurations,
            (value) =>
      ...
      'nodeAffinities':
          pulumi.Input.mapInputValue<
            List<GetInstanceSchedulingNodeAffinity>,
            List<Map<String, dynamic>>
          >(
            nodeAffinities,
            (value) =>
      ...
      'onInstanceStopActions':
          pulumi.Input.mapInputValue<
            List<GetInstanceSchedulingOnInstanceStopAction>,
            List<Map<String, dynamic>>
          >(
            onInstanceStopActions,
            (value) =>
