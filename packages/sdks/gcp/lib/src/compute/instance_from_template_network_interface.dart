...
class InstanceFromTemplateNetworkInterface {
  ...
  final pulumi.Input<List<InstanceFromTemplateNetworkInterfaceAccessConfig>>?
  accessConfigs;

  /// An array of alias IP ranges for this network interface.
  final pulumi.Input<List<InstanceFromTemplateNetworkInterfaceAliasIpRange>>?
  aliasIpRanges;
  ...
  final pulumi.Input<
    List<InstanceFromTemplateNetworkInterfaceIpv6AccessConfig>
  >?
  ipv6AccessConfigs;
    ...
    return <String, dynamic>{
      'accessConfigs':
          ?pulumi.Input.mapOptionalInputValue<
            List<InstanceFromTemplateNetworkInterfaceAccessConfig>,
      ...
      'aliasIpRanges':
          ?pulumi.Input.mapOptionalInputValue<
            List<InstanceFromTemplateNetworkInterfaceAliasIpRange>,
            List<Map<String, dynamic>>
          >(
            aliasIpRanges,
            (value) =>
    ...
    return InstanceFromTemplateNetworkInterface(
      accessConfigs: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => InstanceFromTemplateNetworkInterfaceAccessConfig.fromMap(
      ...
      aliasIpRanges: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => InstanceFromTemplateNetworkInterfaceAliasIpRange.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
