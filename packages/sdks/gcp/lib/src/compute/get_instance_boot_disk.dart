...
class GetInstanceBootDisk {
  ...
  factory GetInstanceBootDisk.fromMap(Map<String, dynamic> map) {
    return GetInstanceBootDisk(
      ...
      initializeParams: pulumi.Input.fromValue(pulumi.Input.decodeList<GetInstanceBootDiskInitializeParam>(map['initializeParams']!, (value) => GetInstanceBootDiskInitializeParam.fromMap((value as Map).cast<String, dynamic>()))),
