...
class FirewallPolicyWithRulesRule {
  ...
  /// Structure is documented below.
  final pulumi.Input<List<FirewallPolicyWithRulesRuleTargetSecureTag>>?
  targetSecureTags;
    ...
    return <String, dynamic>{
      ...
      'targetSecureTags':
          ?pulumi.Input.mapOptionalInputValue<
            List<FirewallPolicyWithRulesRuleTargetSecureTag>,
  ...
  factory FirewallPolicyWithRulesRule.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyWithRulesRule(
      ...
      match: pulumi.Input.fromValue(
        FirewallPolicyWithRulesRuleMatch.fromMap(
