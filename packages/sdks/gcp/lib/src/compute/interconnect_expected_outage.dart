...
class InterconnectExpectedOutage {
  ...
  factory InterconnectExpectedOutage.fromMap(Map<String, dynamic> map) {
    return InterconnectExpectedOutage(
      affectedCircuits: (() { final guardedValue = map['affectedCircuits']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
