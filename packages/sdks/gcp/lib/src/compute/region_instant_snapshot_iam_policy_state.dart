...
class RegionInstantSnapshotIamPolicyState {
  ...
  /// Creates a new [RegionInstantSnapshotIamPolicyState].
  ...
  const RegionInstantSnapshotIamPolicyState({
    this.etag,
    this.name,
    this.policyData,
    this.project,
  ...
  factory RegionInstantSnapshotIamPolicyState.fromMap(Map<String, dynamic> map) {
    return RegionInstantSnapshotIamPolicyState(
