...
class FirewallPolicyWithRulesRuleMatch {
  ...
  final pulumi.Input<List<FirewallPolicyWithRulesRuleMatchLayer4Config>>
  layer4Configs;
  ...
  /// Structure is documented below.
  final pulumi.Input<List<FirewallPolicyWithRulesRuleMatchSrcSecureTag>>?
  srcSecureTags;
    ...
    return <String, dynamic>{
      ...
      'layer4Configs':
          pulumi.Input.mapInputValue<
            List<FirewallPolicyWithRulesRuleMatchLayer4Config>,
      ...
      'srcSecureTags':
          ?pulumi.Input.mapOptionalInputValue<
            List<FirewallPolicyWithRulesRuleMatchSrcSecureTag>,
            List<Map<String, dynamic>>
          >(
            srcSecureTags,
            (value) =>
    ...
    return FirewallPolicyWithRulesRuleMatch(
      ...
      srcSecureTags: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FirewallPolicyWithRulesRuleMatchSrcSecureTag>(
            guardedValue,
