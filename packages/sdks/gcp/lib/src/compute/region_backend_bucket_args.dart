...
/// {@template pulumi_compute_region_backend_bucket_region_backend_bucket_args_doc}
/// The set of arguments for RegionBackendBucket.
/// {@endtemplate}
/// {@macro pulumi_compute_region_backend_bucket_region_backend_bucket_args_doc}
class RegionBackendBucketArgs {
  ...
  /// Creates a new [RegionBackendBucketArgs].
  ...
  factory RegionBackendBucketArgs.fromMap(Map<String, dynamic> map) {
    return RegionBackendBucketArgs(
