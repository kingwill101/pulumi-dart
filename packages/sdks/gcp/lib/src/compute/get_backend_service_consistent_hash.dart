...
class GetBackendServiceConsistentHash {
  ...
  factory GetBackendServiceConsistentHash.fromMap(Map<String, dynamic> map) {
    return GetBackendServiceConsistentHash(
      httpCookies: (pulumi.Input.decodeList<GetBackendServiceConsistentHashHttpCooky>(map['httpCookies'], (value) => GetBackendServiceConsistentHashHttpCooky.fromMap((value as Map).cast<String, dynamic>()))).input(),
