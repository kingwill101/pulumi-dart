...
class ResizeRequestStatus {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'errors': ?errors == null ? null : pulumi.Input.encodeList<ResizeRequestStatusError, Map<String, dynamic>>(errors!, (value) => value.toMap()),
      'lastAttempts': ?lastAttempts == null ? null : pulumi.Input.encodeList<ResizeRequestStatusLastAttempt, Map<String, dynamic>>(lastAttempts!, (value) => value.toMap()),
    };
  }

  factory ResizeRequestStatus.fromMap(Map<String, dynamic> map) {
    return ResizeRequestStatus(
      errors: map['errors'] == null ? null : pulumi.Input.decodeList<ResizeRequestStatusError>(map['errors'], (value) => ResizeRequestStatusError.fromMap((value as Map).cast<String, dynamic>())),
      lastAttempts: map['lastAttempts'] == null ? null : pulumi.Input.decodeList<ResizeRequestStatusLastAttempt>(map['lastAttempts'], (value) => ResizeRequestStatusLastAttempt.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
