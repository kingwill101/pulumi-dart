...
class ServiceAttachment extends pulumi.CustomResource {
  ...
  ServiceAttachment(
    ...
    this.connectedEndpoints = registerOutput<List<ServiceAttachmentConnectedEndpoint>>('connectedEndpoints');
    this.connectionPreference = registerOutput<String>('connectionPreference');
    this.consumerAcceptLists = registerOutput<List<ServiceAttachmentConsumerAcceptList>?>('consumerAcceptLists');
    ...
    this.pscServiceAttachmentIds = registerOutput<List<ServiceAttachmentPscServiceAttachmentId>>('pscServiceAttachmentIds');
    this.reconcileConnections = registerOutput<bool>('reconcileConnections');
    this.region = registerOutput<String>('region');
    this.selfLink = registerOutput<String>('selfLink');
    this.sendPropagatedConnectionLimitIfZero = registerOutput<bool?>('sendPropagatedConnectionLimitIfZero');
    this.showNatIps = registerOutput<bool?>('showNatIps');
    this.targetService = registerOutput<String>('targetService');
    this.tunnelingConfig = registerOutput<ServiceAttachmentTunnelingConfig?>('tunnelingConfig');
  }
