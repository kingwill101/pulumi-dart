...
class RegionHealthCheckHttpsHealthCheck {
  ...
  /// Creates a new [RegionHealthCheckHttpsHealthCheck].
  ...
  const RegionHealthCheckHttpsHealthCheck({
    this.host,
    this.port,
    this.portName,
  ...
  factory RegionHealthCheckHttpsHealthCheck.fromMap(Map<String, dynamic> map) {
    return RegionHealthCheckHttpsHealthCheck(
