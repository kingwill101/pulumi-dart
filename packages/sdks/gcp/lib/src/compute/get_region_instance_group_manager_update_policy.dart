...
class GetRegionInstanceGroupManagerUpdatePolicy {
  ...
  /// Creates a new [GetRegionInstanceGroupManagerUpdatePolicy].
  ...
  factory GetRegionInstanceGroupManagerUpdatePolicy.fromMap(
    ...
    return GetRegionInstanceGroupManagerUpdatePolicy(
      ...
      maxUnavailableFixed: pulumi.Input.fromValue(
        map['maxUnavailableFixed'] as int,
      ),
      maxUnavailablePercent: pulumi.Input.fromValue(
