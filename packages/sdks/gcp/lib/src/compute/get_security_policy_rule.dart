...
class GetSecurityPolicyRule {
  ...
  final pulumi.Input<List<GetSecurityPolicyRulePreconfiguredWafConfig>>
  ...
  final pulumi.Input<List<GetSecurityPolicyRuleRateLimitOption>>
  rateLimitOptions;
    ...
    return <String, dynamic>{
      ...
      'headerActions':
          pulumi.Input.mapInputValue<
            List<GetSecurityPolicyRuleHeaderAction>,
      ...
      'matches':
          pulumi.Input.mapInputValue<
            List<GetSecurityPolicyRuleMatch>,
            List<Map<String, dynamic>>
          >(
            matches,
            (value) =>
      ...
      'preconfiguredWafConfigs':
          pulumi.Input.mapInputValue<
            List<GetSecurityPolicyRulePreconfiguredWafConfig>,
            List<Map<String, dynamic>>
          >(
            preconfiguredWafConfigs,
            (value) =>
      ...
      'rateLimitOptions':
          pulumi.Input.mapInputValue<
            List<GetSecurityPolicyRuleRateLimitOption>,
            List<Map<String, dynamic>>
          >(
            rateLimitOptions,
            (value) =>
      ...
      'redirectOptions':
          pulumi.Input.mapInputValue<
            List<GetSecurityPolicyRuleRedirectOption>,
            List<Map<String, dynamic>>
          >(
            redirectOptions,
            (value) =>
  ...
  factory GetSecurityPolicyRule.fromMap(Map<String, dynamic> map) {
    return GetSecurityPolicyRule(
      ...
      headerActions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetSecurityPolicyRuleHeaderAction>(
          map['headerActions']!,
      ...
      matches: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetSecurityPolicyRuleMatch>(
          map['matches']!,
