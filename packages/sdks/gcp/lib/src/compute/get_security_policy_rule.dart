...
class GetSecurityPolicyRule {
  ...
  factory GetSecurityPolicyRule.fromMap(Map<String, dynamic> map) {
    return GetSecurityPolicyRule(
      ...
      headerActions: (pulumi.Input.decodeList<GetSecurityPolicyRuleHeaderAction>(map['headerActions'], (value) => GetSecurityPolicyRuleHeaderAction.fromMap((value as Map).cast<String, dynamic>()))).input(),
      matches: (pulumi.Input.decodeList<GetSecurityPolicyRuleMatch>(map['matches'], (value) => GetSecurityPolicyRuleMatch.fromMap((value as Map).cast<String, dynamic>()))).input(),
      preconfiguredWafConfigs: (pulumi.Input.decodeList<GetSecurityPolicyRulePreconfiguredWafConfig>(map['preconfiguredWafConfigs'], (value) => GetSecurityPolicyRulePreconfiguredWafConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
      preview: (map['preview'] as bool).input(),
      priority: (map['priority'] as int).input(),
      rateLimitOptions: (pulumi.Input.decodeList<GetSecurityPolicyRuleRateLimitOption>(map['rateLimitOptions'], (value) => GetSecurityPolicyRuleRateLimitOption.fromMap((value as Map).cast<String, dynamic>()))).input(),
      redirectOptions: (pulumi.Input.decodeList<GetSecurityPolicyRuleRedirectOption>(map['redirectOptions'], (value) => GetSecurityPolicyRuleRedirectOption.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
