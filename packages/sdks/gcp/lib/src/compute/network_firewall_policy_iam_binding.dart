...
import 'network_firewall_policy_iam_binding_state.dart';
...
class NetworkFirewallPolicyIamBinding extends pulumi.CustomResource {
  late final pulumi.Output<NetworkFirewallPolicyIamBindingCondition?> condition;
  ...
  /// [args] Arguments used to configure this [NetworkFirewallPolicyIamBinding]. {@macro pulumi_compute_network_firewall_policy_iam_binding_network_firewall_policy_iam_binding_args_doc}
  ...
  NetworkFirewallPolicyIamBinding(
    ...
    condition = registerOutput<NetworkFirewallPolicyIamBindingCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return NetworkFirewallPolicyIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [NetworkFirewallPolicyIamBinding] resource's state with the given [name] and [id].
  static NetworkFirewallPolicyIamBinding get(
    String name,
    pulumi.Input<String> id, {
    NetworkFirewallPolicyIamBindingState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return NetworkFirewallPolicyIamBinding._get(
      name,
      state: state?.toMap(),
  ...
  NetworkFirewallPolicyIamBinding._get(
    String name, {
  ...
  /// Creates a typed reference to an existing [NetworkFirewallPolicyIamBinding] resource.
  NetworkFirewallPolicyIamBinding.reference(String urn)
    : super(
        'gcp:compute/networkFirewallPolicyIamBinding:NetworkFirewallPolicyIamBinding',
