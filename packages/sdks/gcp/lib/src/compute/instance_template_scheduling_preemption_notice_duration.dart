...
class InstanceTemplateSchedulingPreemptionNoticeDuration {
  ...
  /// Creates a new [InstanceTemplateSchedulingPreemptionNoticeDuration].
  ...
  const InstanceTemplateSchedulingPreemptionNoticeDuration({
    this.nanos,
  ...
  factory InstanceTemplateSchedulingPreemptionNoticeDuration.fromMap(Map<String, dynamic> map) {
    return InstanceTemplateSchedulingPreemptionNoticeDuration(
