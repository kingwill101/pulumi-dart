...
import 'region_disk_iam_binding_state.dart';
...
class RegionDiskIamBinding extends pulumi.CustomResource {
  ...
  RegionDiskIamBinding(
    ...
    condition = registerOutput<RegionDiskIamBindingCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return RegionDiskIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [RegionDiskIamBinding] resource's state with the given [name] and [id].
  static RegionDiskIamBinding get(
    String name,
    pulumi.Input<String> id, {
    RegionDiskIamBindingState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return RegionDiskIamBinding._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [RegionDiskIamBinding] resource.
  RegionDiskIamBinding.reference(String urn)
    : super(
        'gcp:compute/regionDiskIamBinding:RegionDiskIamBinding',
