...
class Interconnect extends pulumi.CustomResource {
  ...
  late final pulumi.Output<InterconnectApplicationAwareInterconnect?> applicationAwareInterconnect;
  ...
  Interconnect(
    ...
    this.applicationAwareInterconnect = registerOutput<InterconnectApplicationAwareInterconnect?>('applicationAwareInterconnect');
    this.availableFeatures = registerOutput<List<String>>('availableFeatures');
    this.circuitInfos = registerOutput<List<InterconnectCircuitInfo>>('circuitInfos');
    this.creationTimestamp = registerOutput<String>('creationTimestamp');
    this.customerName = registerOutput<String?>('customerName');
    this.description = registerOutput<String?>('description');
    this.effectiveLabels = registerOutput<Map<String, String>>('effectiveLabels');
    this.expectedOutages = registerOutput<List<InterconnectExpectedOutage>>('expectedOutages');
    this.googleIpAddress = registerOutput<String>('googleIpAddress');
    this.googleReferenceId = registerOutput<String>('googleReferenceId');
    this.interconnectAttachments = registerOutput<List<String>>('interconnectAttachments');
    this.interconnectGroups = registerOutput<List<String>>('interconnectGroups');
