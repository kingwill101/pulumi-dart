...
class OrganizationSecurityPolicyRuleState {
  ...
  const OrganizationSecurityPolicyRuleState({
    this.action,
    this.deletionPolicy,
    this.description,
    this.direction,
  ...
  factory OrganizationSecurityPolicyRuleState.fromMap(Map<String, dynamic> map) {
    return OrganizationSecurityPolicyRuleState(
      ...
      match: (() { final guardedValue = map['match']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OrganizationSecurityPolicyRuleMatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
