...
class RegionUrlMapPathMatcherRouteRuleMatchRule {
  ...
  final pulumi.Input<
    List<RegionUrlMapPathMatcherRouteRuleMatchRuleHeaderMatch>
  >?
  headerMatches;
  ...
  /// Structure is documented below.
  final pulumi.Input<
    List<RegionUrlMapPathMatcherRouteRuleMatchRuleMetadataFilter>
  >?
  metadataFilters;
      ...
      metadataFilters: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                RegionUrlMapPathMatcherRouteRuleMatchRuleMetadataFilter.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      queryParameterMatches: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                RegionUrlMapPathMatcherRouteRuleMatchRuleQueryParameterMatch.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
