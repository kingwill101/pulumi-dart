...
class FutureReservationState {
  ...
  factory FutureReservationState.fromMap(Map<String, dynamic> map) {
    return FutureReservationState(
      ...
      commitmentInfo: (() {
        final guardedValue = map['commitmentInfo'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      reservationMode: (() {
        final guardedValue = map['reservationMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      reservationName: (() {
        final guardedValue = map['reservationName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      schedulingType: (() {
      ...
      statuses: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FutureReservationStatus>(
            guardedValue,
            (value) => FutureReservationStatus.fromMap(
