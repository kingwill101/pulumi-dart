...
class RegionBackendServiceCircuitBreakersConnectTimeout {
  ...
  /// Creates a new [RegionBackendServiceCircuitBreakersConnectTimeout].
  /// [nanos] Span of time that's a fraction of a second at nanosecond
  /// [seconds] Span of time at a resolution of a second.
  const RegionBackendServiceCircuitBreakersConnectTimeout({
    this.nanos,
  ...
  factory RegionBackendServiceCircuitBreakersConnectTimeout.fromMap(Map<String, dynamic> map) {
    return RegionBackendServiceCircuitBreakersConnectTimeout(
