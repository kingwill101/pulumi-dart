...
class URLMapDefaultCustomErrorResponsePolicy {
  ...
  final pulumi.Input<
    List<URLMapDefaultCustomErrorResponsePolicyErrorResponseRule>
  >?
  errorResponseRules;
  ...
  factory URLMapDefaultCustomErrorResponsePolicy.fromMap(
      ...
      errorResponseRules: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                URLMapDefaultCustomErrorResponsePolicyErrorResponseRule.fromMap(
