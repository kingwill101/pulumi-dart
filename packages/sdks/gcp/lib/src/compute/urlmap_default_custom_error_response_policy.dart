...
import 'urlmap_default_custom_error_response_policy_error_response_rule.dart';

class URLMapDefaultCustomErrorResponsePolicy {
  ...
  final pulumi.Input<List<URLMapDefaultCustomErrorResponsePolicyErrorResponseRule>>? errorResponseRules;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'errorResponseRules': ?pulumi.Input.mapOptionalInputValue<List<URLMapDefaultCustomErrorResponsePolicyErrorResponseRule>, List<Map<String, dynamic>>>(errorResponseRules, (value) => pulumi.Input.encodeList<URLMapDefaultCustomErrorResponsePolicyErrorResponseRule, Map<String, dynamic>>(value, (value) => value.toMap())),
      'errorService': ?errorService,
    };
  }

  factory URLMapDefaultCustomErrorResponsePolicy.fromMap(Map<String, dynamic> map) {
    return URLMapDefaultCustomErrorResponsePolicy(
      errorResponseRules: (() { final guardedValue = map['errorResponseRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<URLMapDefaultCustomErrorResponsePolicyErrorResponseRule>(guardedValue, (value) => URLMapDefaultCustomErrorResponsePolicyErrorResponseRule.fromMap((value as Map).cast<String, dynamic>()))); })(),
