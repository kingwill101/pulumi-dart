...
class URLMapDefaultCustomErrorResponsePolicy {
  ...
  factory URLMapDefaultCustomErrorResponsePolicy.fromMap(Map<String, dynamic> map) {
    return URLMapDefaultCustomErrorResponsePolicy(
      errorResponseRules: map['errorResponseRules'] == null ? null : (pulumi.Input.decodeList<URLMapDefaultCustomErrorResponsePolicyErrorResponseRule>(map['errorResponseRules'], (value) => URLMapDefaultCustomErrorResponsePolicyErrorResponseRule.fromMap((value as Map).cast<String, dynamic>()))).input(),
