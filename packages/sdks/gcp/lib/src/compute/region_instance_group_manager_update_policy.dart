...
class RegionInstanceGroupManagerUpdatePolicy {
  ...
  factory RegionInstanceGroupManagerUpdatePolicy.fromMap(Map<String, dynamic> map) {
    return RegionInstanceGroupManagerUpdatePolicy(
      ...
      maxSurgeFixed: (() { final guardedValue = map['maxSurgeFixed']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      maxSurgePercent: (() { final guardedValue = map['maxSurgePercent']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      maxUnavailableFixed: (() { final guardedValue = map['maxUnavailableFixed']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      maxUnavailablePercent: (() { final guardedValue = map['maxUnavailablePercent']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
