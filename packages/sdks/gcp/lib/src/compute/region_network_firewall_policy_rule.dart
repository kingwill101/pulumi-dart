...
class RegionNetworkFirewallPolicyRule extends pulumi.CustomResource {
  ...
  late final pulumi.Output<RegionNetworkFirewallPolicyRuleMatch> match;
  ...
  /// Creates a new [RegionNetworkFirewallPolicyRule].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [RegionNetworkFirewallPolicyRule]. {@macro pulumi_compute_region_network_firewall_policy_rule_region_network_firewall_policy_rule_args_doc}
  ...
  RegionNetworkFirewallPolicyRule(
    ...
    this.targetSecureTags = registerOutput<List<RegionNetworkFirewallPolicyRuleTargetSecureTag>?>('targetSecureTags');
  ...
  /// Gets an existing [RegionNetworkFirewallPolicyRule] resource's state with the given [name] and [id].
  static RegionNetworkFirewallPolicyRule get(
    String name,
  ...
  RegionNetworkFirewallPolicyRule._get(
    String name, {
