...
class GetReservationSpecificReservationInstanceProperty {
  ...
  factory GetReservationSpecificReservationInstanceProperty.fromMap(Map<String, dynamic> map) {
    return GetReservationSpecificReservationInstanceProperty(
      guestAccelerators: pulumi.Input.fromValue(pulumi.Input.decodeList<GetReservationSpecificReservationInstancePropertyGuestAccelerator>(map['guestAccelerators']!, (value) => GetReservationSpecificReservationInstancePropertyGuestAccelerator.fromMap((value as Map).cast<String, dynamic>()))),
      localSsds: pulumi.Input.fromValue(pulumi.Input.decodeList<GetReservationSpecificReservationInstancePropertyLocalSsd>(map['localSsds']!, (value) => GetReservationSpecificReservationInstancePropertyLocalSsd.fromMap((value as Map).cast<String, dynamic>()))),
