...
class ImageArgs {
  ...
  factory ImageArgs.fromMap(Map<String, dynamic> map) {
    return ImageArgs(
      ...
      guestOsFeatures: map['guestOsFeatures'] == null ? null : (pulumi.Input.decodeList<ImageGuestOsFeature>(map['guestOsFeatures'], (value) => ImageGuestOsFeature.fromMap((value as Map).cast<String, dynamic>()))).input(),
      imageEncryptionKey: map['imageEncryptionKey'] == null ? null : (ImageImageEncryptionKey.fromMap((map['imageEncryptionKey'] as Map).cast<String, dynamic>())).input(),
      ...
      shieldedInstanceInitialState: map['shieldedInstanceInitialState'] == null ? null : (ImageShieldedInstanceInitialState.fromMap((map['shieldedInstanceInitialState'] as Map).cast<String, dynamic>())).input(),
      sourceDisk: map['sourceDisk'] == null ? null : (map['sourceDisk'] as String).input(),
      sourceDiskEncryptionKey: map['sourceDiskEncryptionKey'] == null ? null : (ImageSourceDiskEncryptionKey.fromMap((map['sourceDiskEncryptionKey'] as Map).cast<String, dynamic>())).input(),
      sourceImage: map['sourceImage'] == null ? null : (map['sourceImage'] as String).input(),
      sourceImageEncryptionKey: map['sourceImageEncryptionKey'] == null ? null : (ImageSourceImageEncryptionKey.fromMap((map['sourceImageEncryptionKey'] as Map).cast<String, dynamic>())).input(),
      sourceSnapshot: map['sourceSnapshot'] == null ? null : (map['sourceSnapshot'] as String).input(),
      sourceSnapshotEncryptionKey: map['sourceSnapshotEncryptionKey'] == null ? null : (ImageSourceSnapshotEncryptionKey.fromMap((map['sourceSnapshotEncryptionKey'] as Map).cast<String, dynamic>())).input(),
