    ...
    return ImageArgs(
      ...
      guestOsFeatures: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ImageGuestOsFeature>(
            guardedValue,
            (value) => ImageGuestOsFeature.fromMap(
      ...
      imageEncryptionKey: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ImageImageEncryptionKey.fromMap(
      ...
      shieldedInstanceInitialState: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ImageShieldedInstanceInitialState.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      sourceDiskEncryptionKey: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ImageSourceDiskEncryptionKey.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      sourceImageEncryptionKey: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ImageSourceImageEncryptionKey.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      sourceSnapshotEncryptionKey: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ImageSourceSnapshotEncryptionKey.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
