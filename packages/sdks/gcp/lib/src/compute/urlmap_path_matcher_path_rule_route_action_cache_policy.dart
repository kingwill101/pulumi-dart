...
import 'urlmap_path_matcher_path_rule_route_action_cache_policy_cache_key_policy.dart';
import 'urlmap_path_matcher_path_rule_route_action_cache_policy_client_ttl.dart';
import 'urlmap_path_matcher_path_rule_route_action_cache_policy_default_ttl.dart';
import 'urlmap_path_matcher_path_rule_route_action_cache_policy_max_ttl.dart';
import 'urlmap_path_matcher_path_rule_route_action_cache_policy_negative_caching_policy.dart';
import 'urlmap_path_matcher_path_rule_route_action_cache_policy_serve_while_stale.dart';

class URLMapPathMatcherPathRuleRouteActionCachePolicy {
  ...
  final pulumi.Input<URLMapPathMatcherPathRuleRouteActionCachePolicyCacheKeyPolicy?>? cacheKeyPolicy;
  ...
  /// Structure is documented below.
  final pulumi.Input<URLMapPathMatcherPathRuleRouteActionCachePolicyClientTtl?>? clientTtl;
  ...
  /// USE_ORIGIN_HEADERS.
  /// Structure is documented below.
  final pulumi.Input<URLMapPathMatcherPathRuleRouteActionCachePolicyDefaultTtl?>? defaultTtl;
  ...
  /// mode.
  /// Structure is documented below.
  final pulumi.Input<URLMapPathMatcherPathRuleRouteActionCachePolicyMaxTtl?>? maxTtl;
  ...
  /// a policy exists.
  /// Structure is documented below.
  final pulumi.Input<List<URLMapPathMatcherPathRuleRouteActionCachePolicyNegativeCachingPolicy>?>? negativeCachingPolicies;
  ...
  /// Structure is documented below.
  final pulumi.Input<URLMapPathMatcherPathRuleRouteActionCachePolicyServeWhileStale?>? serveWhileStale;

  /// Creates a new [URLMapPathMatcherPathRuleRouteActionCachePolicy].
  ...
  const URLMapPathMatcherPathRuleRouteActionCachePolicy({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'cacheKeyPolicy': ?pulumi.Input.mapOptionalInputValue<URLMapPathMatcherPathRuleRouteActionCachePolicyCacheKeyPolicy, Map<String, dynamic>>(cacheKeyPolicy, (value) => value.toMap()),
      'cacheMode': ?cacheMode,
      'clientTtl': ?pulumi.Input.mapOptionalInputValue<URLMapPathMatcherPathRuleRouteActionCachePolicyClientTtl, Map<String, dynamic>>(clientTtl, (value) => value.toMap()),
      'defaultTtl': ?pulumi.Input.mapOptionalInputValue<URLMapPathMatcherPathRuleRouteActionCachePolicyDefaultTtl, Map<String, dynamic>>(defaultTtl, (value) => value.toMap()),
      'maxTtl': ?pulumi.Input.mapOptionalInputValue<URLMapPathMatcherPathRuleRouteActionCachePolicyMaxTtl, Map<String, dynamic>>(maxTtl, (value) => value.toMap()),
      'negativeCaching': ?negativeCaching,
      'negativeCachingPolicies': ?pulumi.Input.mapOptionalInputValue<List<URLMapPathMatcherPathRuleRouteActionCachePolicyNegativeCachingPolicy>, List<Map<String, dynamic>>>(negativeCachingPolicies, (value) => pulumi.Input.encodeList<URLMapPathMatcherPathRuleRouteActionCachePolicyNegativeCachingPolicy, Map<String, dynamic>>(value, (value) => value.toMap())),
      'requestCoalescing': ?requestCoalescing,
      'serveWhileStale': ?pulumi.Input.mapOptionalInputValue<URLMapPathMatcherPathRuleRouteActionCachePolicyServeWhileStale, Map<String, dynamic>>(serveWhileStale, (value) => value.toMap()),
    };
  }

  factory URLMapPathMatcherPathRuleRouteActionCachePolicy.fromMap(Map<String, dynamic> map) {
    return URLMapPathMatcherPathRuleRouteActionCachePolicy(
      ...
      cacheKeyPolicy: (() { final guardedValue = map['cacheKeyPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(URLMapPathMatcherPathRuleRouteActionCachePolicyCacheKeyPolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      clientTtl: (() { final guardedValue = map['clientTtl']; if (guardedValue == null) return null; return pulumi.Input.fromValue(URLMapPathMatcherPathRuleRouteActionCachePolicyClientTtl.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      defaultTtl: (() { final guardedValue = map['defaultTtl']; if (guardedValue == null) return null; return pulumi.Input.fromValue(URLMapPathMatcherPathRuleRouteActionCachePolicyDefaultTtl.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      maxTtl: (() { final guardedValue = map['maxTtl']; if (guardedValue == null) return null; return pulumi.Input.fromValue(URLMapPathMatcherPathRuleRouteActionCachePolicyMaxTtl.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      negativeCachingPolicies: (() { final guardedValue = map['negativeCachingPolicies']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<URLMapPathMatcherPathRuleRouteActionCachePolicyNegativeCachingPolicy>(guardedValue, (value) => URLMapPathMatcherPathRuleRouteActionCachePolicyNegativeCachingPolicy.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      serveWhileStale: (() { final guardedValue = map['serveWhileStale']; if (guardedValue == null) return null; return pulumi.Input.fromValue(URLMapPathMatcherPathRuleRouteActionCachePolicyServeWhileStale.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
