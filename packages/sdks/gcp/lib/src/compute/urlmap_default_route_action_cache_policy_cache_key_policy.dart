...
class URLMapDefaultRouteActionCachePolicyCacheKeyPolicy {
  ...
  /// Creates a new [URLMapDefaultRouteActionCachePolicyCacheKeyPolicy].
  ...
  const URLMapDefaultRouteActionCachePolicyCacheKeyPolicy({
  ...
  factory URLMapDefaultRouteActionCachePolicyCacheKeyPolicy.fromMap(Map<String, dynamic> map) {
    return URLMapDefaultRouteActionCachePolicyCacheKeyPolicy(
