...
class InterconnectGroupConfigured {
  ...
  final pulumi.Input<List<InterconnectGroupConfiguredTopologyCapability>>?
    ...
    return <String, dynamic>{
      'topologyCapabilities':
          ?pulumi.Input.mapOptionalInputValue<
            List<InterconnectGroupConfiguredTopologyCapability>,
  ...
  factory InterconnectGroupConfigured.fromMap(Map<String, dynamic> map) {
    return InterconnectGroupConfigured(
      topologyCapabilities: (() {
        final guardedValue = map['topologyCapabilities'];
