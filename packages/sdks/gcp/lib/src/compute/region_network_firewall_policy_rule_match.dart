...
class RegionNetworkFirewallPolicyRuleMatch {
  ...
  final pulumi.Input<List<RegionNetworkFirewallPolicyRuleMatchLayer4Config>>
  layer4Configs;
  ...
  /// Structure is documented below.
  final pulumi.Input<List<RegionNetworkFirewallPolicyRuleMatchSrcSecureTag>>?
  srcSecureTags;
    ...
    return <String, dynamic>{
      ...
      'layer4Configs':
          pulumi.Input.mapInputValue<
            List<RegionNetworkFirewallPolicyRuleMatchLayer4Config>,
      ...
      'srcSecureTags':
          ?pulumi.Input.mapOptionalInputValue<
            List<RegionNetworkFirewallPolicyRuleMatchSrcSecureTag>,
            List<Map<String, dynamic>>
          >(
            srcSecureTags,
            (value) =>
    ...
    return RegionNetworkFirewallPolicyRuleMatch(
      ...
      layer4Configs: pulumi.Input.fromValue(
        pulumi
          ...
          map['layer4Configs']!,
          (value) => RegionNetworkFirewallPolicyRuleMatchLayer4Config.fromMap(
      ...
      srcSecureTags: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => RegionNetworkFirewallPolicyRuleMatchSrcSecureTag.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
