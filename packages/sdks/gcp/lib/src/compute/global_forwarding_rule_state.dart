...
class GlobalForwardingRuleState {
  ...
  GlobalForwardingRuleState({
    ...
    pulumi.Output<String>? baseForwardingRule,
    pulumi.Output<String>? description,
    pulumi.Output<Map<String, String>>? effectiveLabels,
    pulumi.Output<String>? externalManagedBackendBucketMigrationState,
    pulumi.Output<double>? externalManagedBackendBucketMigrationTestingPercentage,
    pulumi.Output<int>? forwardingRuleId,
    ...
    pulumi.Output<List<GlobalForwardingRuleMetadataFilter>>? metadataFilters,
    ...
    pulumi.Output<String>? pscConnectionId,
    pulumi.Output<String>? pscConnectionStatus,
    pulumi.Output<Map<String, String>>? pulumiLabels,
    pulumi.Output<String>? selfLink,
    pulumi.Output<GlobalForwardingRuleServiceDirectoryRegistrations>? serviceDirectoryRegistrations,
    ...
    pulumi.Output<String>? target,
      ...
      baseForwardingRule = pulumi.Input.asOptionalInput<String>(baseForwardingRule),
      description = pulumi.Input.asOptionalInput<String>(description),
      effectiveLabels = pulumi.Input.asOptionalInput<Map<String, String>>(effectiveLabels),
      externalManagedBackendBucketMigrationState = pulumi.Input.asOptionalInput<String>(externalManagedBackendBucketMigrationState),
      externalManagedBackendBucketMigrationTestingPercentage = pulumi.Input.asOptionalInput<double>(externalManagedBackendBucketMigrationTestingPercentage),
      forwardingRuleId = pulumi.Input.asOptionalInput<int>(forwardingRuleId),
      ...
      metadataFilters = pulumi.Input.asOptionalInput<List<GlobalForwardingRuleMetadataFilter>>(metadataFilters),
      ...
      pscConnectionId = pulumi.Input.asOptionalInput<String>(pscConnectionId),
      pscConnectionStatus = pulumi.Input.asOptionalInput<String>(pscConnectionStatus),
      pulumiLabels = pulumi.Input.asOptionalInput<Map<String, String>>(pulumiLabels),
      selfLink = pulumi.Input.asOptionalInput<String>(selfLink),
      serviceDirectoryRegistrations = pulumi.Input.asOptionalInput<GlobalForwardingRuleServiceDirectoryRegistrations>(serviceDirectoryRegistrations),
  ...
  factory GlobalForwardingRuleState.fromMap(Map<String, dynamic> map) {
    return GlobalForwardingRuleState(
      ...
      baseForwardingRule: map['baseForwardingRule'] == null ? null : pulumi.Output.create<String>(map['baseForwardingRule'] as String),
      description: map['description'] == null ? null : pulumi.Output.create<String>(map['description'] as String),
      effectiveLabels: map['effectiveLabels'] == null ? null : pulumi.Output.create<Map<String, String>>((map['effectiveLabels'] as Map).cast<String, String>()),
      externalManagedBackendBucketMigrationState: map['externalManagedBackendBucketMigrationState'] == null ? null : pulumi.Output.create<String>(map['externalManagedBackendBucketMigrationState'] as String),
      externalManagedBackendBucketMigrationTestingPercentage: map['externalManagedBackendBucketMigrationTestingPercentage'] == null ? null : pulumi.Output.create<double>(map['externalManagedBackendBucketMigrationTestingPercentage'] as double),
      forwardingRuleId: map['forwardingRuleId'] == null ? null : pulumi.Output.create<int>(map['forwardingRuleId'] as int),
      ...
      metadataFilters: map['metadataFilters'] == null ? null : pulumi.Output.create<List<GlobalForwardingRuleMetadataFilter>>(pulumi.Input.decodeList<GlobalForwardingRuleMetadataFilter>(map['metadataFilters'], (value) => GlobalForwardingRuleMetadataFilter.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      pscConnectionId: map['pscConnectionId'] == null ? null : pulumi.Output.create<String>(map['pscConnectionId'] as String),
      pscConnectionStatus: map['pscConnectionStatus'] == null ? null : pulumi.Output.create<String>(map['pscConnectionStatus'] as String),
      pulumiLabels: map['pulumiLabels'] == null ? null : pulumi.Output.create<Map<String, String>>((map['pulumiLabels'] as Map).cast<String, String>()),
      selfLink: map['selfLink'] == null ? null : pulumi.Output.create<String>(map['selfLink'] as String),
      serviceDirectoryRegistrations: map['serviceDirectoryRegistrations'] == null ? null : pulumi.Output.create<GlobalForwardingRuleServiceDirectoryRegistrations>(GlobalForwardingRuleServiceDirectoryRegistrations.fromMap((map['serviceDirectoryRegistrations'] as Map).cast<String, dynamic>())),
