...
class GlobalForwardingRuleState {
  ...
  factory GlobalForwardingRuleState.fromMap(Map<String, dynamic> map) {
    return GlobalForwardingRuleState(
      ...
      baseForwardingRule: map['baseForwardingRule'] == null ? null : (map['baseForwardingRule'] as String).input(),
      description: map['description'] == null ? null : (map['description'] as String).input(),
      effectiveLabels: map['effectiveLabels'] == null ? null : ((map['effectiveLabels'] as Map).cast<String, String>()).input(),
      externalManagedBackendBucketMigrationState: map['externalManagedBackendBucketMigrationState'] == null ? null : (map['externalManagedBackendBucketMigrationState'] as String).input(),
      externalManagedBackendBucketMigrationTestingPercentage: map['externalManagedBackendBucketMigrationTestingPercentage'] == null ? null : (map['externalManagedBackendBucketMigrationTestingPercentage'] as double).input(),
      forwardingRuleId: map['forwardingRuleId'] == null ? null : (map['forwardingRuleId'] as int).input(),
      ...
      metadataFilters: map['metadataFilters'] == null ? null : (pulumi.Input.decodeList<GlobalForwardingRuleMetadataFilter>(map['metadataFilters'], (value) => GlobalForwardingRuleMetadataFilter.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      serviceDirectoryRegistrations: map['serviceDirectoryRegistrations'] == null ? null : (GlobalForwardingRuleServiceDirectoryRegistrations.fromMap((map['serviceDirectoryRegistrations'] as Map).cast<String, dynamic>())).input(),
