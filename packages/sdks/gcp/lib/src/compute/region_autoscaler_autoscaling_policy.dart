...
class RegionAutoscalerAutoscalingPolicy {
  ...
  final pulumi.Input<RegionAutoscalerAutoscalingPolicyCpuUtilization>?
  cpuUtilization;

  /// Configuration parameters of autoscaling based on a load balancer.
  /// Structure is documented below.
  final pulumi.Input<RegionAutoscalerAutoscalingPolicyLoadBalancingUtilization>?
  ...
  /// Structure is documented below.
  final pulumi.Input<RegionAutoscalerAutoscalingPolicyScaleDownControl>?
  scaleDownControl;

  /// Defines scale in controls to reduce the risk of response latency
  /// and outages due to abrupt scale-in events
  /// Structure is documented below.
  final pulumi.Input<RegionAutoscalerAutoscalingPolicyScaleInControl>?
  scaleInControl;

  /// Scaling schedules defined for an autoscaler. Multiple schedules can be set on an autoscaler and they can overlap.
  /// Structure is documented below.
  final pulumi.Input<List<RegionAutoscalerAutoscalingPolicyScalingSchedule>>?
  scalingSchedules;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'metrics':
          ?pulumi.Input.mapOptionalInputValue<
            List<RegionAutoscalerAutoscalingPolicyMetric>,
      ...
      'scalingSchedules':
          ?pulumi.Input.mapOptionalInputValue<
            List<RegionAutoscalerAutoscalingPolicyScalingSchedule>,
            List<Map<String, dynamic>>
          >(
            scalingSchedules,
            (value) =>
  ...
  factory RegionAutoscalerAutoscalingPolicy.fromMap(Map<String, dynamic> map) {
    return RegionAutoscalerAutoscalingPolicy(
      ...
      scaleDownControl: (() {
        final guardedValue = map['scaleDownControl'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      scalingSchedules: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => RegionAutoscalerAutoscalingPolicyScalingSchedule.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
