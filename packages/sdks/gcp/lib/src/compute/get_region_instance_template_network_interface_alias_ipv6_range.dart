...
class GetRegionInstanceTemplateNetworkInterfaceAliasIpv6Range {
  ...
  /// Creates a new [GetRegionInstanceTemplateNetworkInterfaceAliasIpv6Range].
  ...
  const GetRegionInstanceTemplateNetworkInterfaceAliasIpv6Range({
  ...
  factory GetRegionInstanceTemplateNetworkInterfaceAliasIpv6Range.fromMap(Map<String, dynamic> map) {
    return GetRegionInstanceTemplateNetworkInterfaceAliasIpv6Range(
