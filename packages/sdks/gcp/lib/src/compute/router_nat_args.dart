...
class RouterNatArgs {
  ...
  RouterNatArgs({
    ...
    required pulumi.Output<String> sourceSubnetworkIpRangesToNat,
  ...
  factory RouterNatArgs.fromMap(Map<String, dynamic> map) {
    return RouterNatArgs(
      ...
      sourceSubnetworkIpRangesToNat: pulumi.Output.create<String>(map['sourceSubnetworkIpRangesToNat'] as String),
