...
class RegionBackendServiceNetworkPassThroughLbTrafficPolicy {
  ...
  factory RegionBackendServiceNetworkPassThroughLbTrafficPolicy.fromMap(Map<String, dynamic> map) {
    return RegionBackendServiceNetworkPassThroughLbTrafficPolicy(
      zonalAffinity: (() { final guardedValue = map['zonalAffinity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionBackendServiceNetworkPassThroughLbTrafficPolicyZonalAffinity.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
