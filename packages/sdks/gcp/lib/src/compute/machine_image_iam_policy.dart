...
import 'machine_image_iam_policy_state.dart';
...
class MachineImageIamPolicy extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [MachineImageIamPolicy]. {@macro pulumi_compute_machine_image_iam_policy_machine_image_iam_policy_args_doc}
  ...
  /// Gets an existing [MachineImageIamPolicy] resource's state with the given [name] and [id].
  static MachineImageIamPolicy get(
    String name,
