...
class RegionInstanceGroupManagerInstanceFlexibilityPolicy {
  ...
  factory RegionInstanceGroupManagerInstanceFlexibilityPolicy.fromMap(Map<String, dynamic> map) {
    return RegionInstanceGroupManagerInstanceFlexibilityPolicy(
      instanceSelections: (() { final guardedValue = map['instanceSelections']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RegionInstanceGroupManagerInstanceFlexibilityPolicyInstanceSelection>(guardedValue, (value) => RegionInstanceGroupManagerInstanceFlexibilityPolicyInstanceSelection.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
