...
class RepositoryIamBinding extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [RepositoryIamBinding]. {@macro pulumi_securesourcemanager_repository_iam_binding_repository_iam_binding_args_doc}
  ...
  RepositoryIamBinding(
    ...
    condition = registerOutput<RepositoryIamBindingCondition?>(
      'condition',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return RepositoryIamBindingCondition.fromMap(
