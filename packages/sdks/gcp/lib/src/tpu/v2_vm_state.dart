...
class V2VmState {
    ...
    return <String, dynamic>{
      ...
      'symptoms':
          ...
          >(
            symptoms,
            (value) =>
                pulumi.Input.encodeList<V2VmSymptom, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory V2VmState.fromMap(Map<String, dynamic> map) {
    return V2VmState(
      ...
      healthDescription: (() {
        final guardedValue = map['healthDescription'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      labels: (() {
      ...
      multisliceNode: (() {
        final guardedValue = map['multisliceNode'];
        if (guardedValue == null) return null;
      ...
      networkConfigs: (() {
        final guardedValue = map['networkConfigs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      networkEndpoints: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<V2VmNetworkEndpoint>(
            guardedValue,
            (value) => V2VmNetworkEndpoint.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      queuedResource: (() {
        final guardedValue = map['queuedResource'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      runtimeVersion: (() {
      ...
      symptoms: (() {
        final guardedValue = map['symptoms'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<V2VmSymptom>(
            guardedValue,
            (value) =>
                V2VmSymptom.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      tags: (() {
