...
class V2QueuedResourceTpu {
  ...
  factory V2QueuedResourceTpu.fromMap(Map<String, dynamic> map) {
    return V2QueuedResourceTpu(
      nodeSpecs: (() { final guardedValue = map['nodeSpecs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<V2QueuedResourceTpuNodeSpec>(guardedValue, (value) => V2QueuedResourceTpuNodeSpec.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
