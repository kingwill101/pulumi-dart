...
/// {@template pulumi_index_project_from_id_project_from_id_args_doc}
/// Arguments for projectFromId.
/// {@endtemplate}
/// {@macro pulumi_index_project_from_id_project_from_id_args_doc}
class ProjectFromIdArgs {
  ...
  factory ProjectFromIdArgs.fromMap(Map<String, dynamic> map) {
    return ProjectFromIdArgs(
