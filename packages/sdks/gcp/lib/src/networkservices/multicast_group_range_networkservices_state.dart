...
class MulticastGroupRangeNetworkservicesState {
  ...
  factory MulticastGroupRangeNetworkservicesState.fromMap(Map<String, dynamic> map) {
    return MulticastGroupRangeNetworkservicesState(
      ...
      logConfig: (() { final guardedValue = map['logConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MulticastGroupRangeLogConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      multicastDomain: (() { final guardedValue = map['multicastDomain']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      multicastGroupRangeId: (() { final guardedValue = map['multicastGroupRangeId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      project: (() { final guardedValue = map['project']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      pulumiLabels: (() { final guardedValue = map['pulumiLabels']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      requireExplicitAccept: (() { final guardedValue = map['requireExplicitAccept']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      states: (() { final guardedValue = map['states']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<MulticastGroupRangeState>(guardedValue, (value) => MulticastGroupRangeState.fromMap((value as Map).cast<String, dynamic>()))); })(),
