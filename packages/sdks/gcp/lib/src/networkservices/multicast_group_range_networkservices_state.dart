...
class MulticastGroupRangeNetworkservicesState {
  ...
  factory MulticastGroupRangeNetworkservicesState.fromMap(Map<String, dynamic> map) {
    return MulticastGroupRangeNetworkservicesState(
      ...
      multicastGroupRangeId: map['multicastGroupRangeId'] == null ? null : (map['multicastGroupRangeId']! as String).input(),
      ...
      states: map['states'] == null ? null : (pulumi.Input.decodeList<MulticastGroupRangeState>(map['states']!, (value) => MulticastGroupRangeState.fromMap((value as Map).cast<String, dynamic>()))).input(),
