...
class TlsRouteRule {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'action':
          pulumi.Input.mapInputValue<TlsRouteRuleAction, Map<String, dynamic>>(
            action,
            (value) => value.toMap(),
          ),
      'matches':
          pulumi.Input.mapInputValue<
            List<TlsRouteRuleMatch>,
  ...
  factory TlsRouteRule.fromMap(Map<String, dynamic> map) {
    return TlsRouteRule(
      action: pulumi.Input.fromValue(
        TlsRouteRuleAction.fromMap(
          (map['action']! as Map).cast<String, dynamic>(),
        ),
      ),
      matches: pulumi.Input.fromValue(
        pulumi.Input.decodeList<TlsRouteRuleMatch>(
          map['matches']!,
          (value) =>
