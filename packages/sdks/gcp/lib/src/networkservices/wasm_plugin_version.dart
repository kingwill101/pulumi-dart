...
class WasmPluginVersion {
  ...
  factory WasmPluginVersion.fromMap(Map<String, dynamic> map) {
    return WasmPluginVersion(
      ...
      pluginConfigData: map['pluginConfigData'] == null ? null : map['pluginConfigData'] as String,
      pluginConfigDigest: map['pluginConfigDigest'] == null ? null : map['pluginConfigDigest'] as String,
      pluginConfigUri: map['pluginConfigUri'] == null ? null : map['pluginConfigUri'] as String,
