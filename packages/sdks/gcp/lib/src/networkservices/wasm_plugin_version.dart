...
class WasmPluginVersion {
  ...
  factory WasmPluginVersion.fromMap(Map<String, dynamic> map) {
    return WasmPluginVersion(
      ...
      pluginConfigData: (() { final guardedValue = map['pluginConfigData']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      pluginConfigDigest: (() { final guardedValue = map['pluginConfigDigest']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      pluginConfigUri: (() { final guardedValue = map['pluginConfigUri']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
