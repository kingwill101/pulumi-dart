...
class MulticastGroupConsumerActivationNetworkservicesState {
  ...
  factory MulticastGroupConsumerActivationNetworkservicesState.fromMap(Map<String, dynamic> map) {
    return MulticastGroupConsumerActivationNetworkservicesState(
      ...
      multicastConsumerAssociation: (() { final guardedValue = map['multicastConsumerAssociation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      multicastGroupConsumerActivationId: (() { final guardedValue = map['multicastGroupConsumerActivationId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      states: (() { final guardedValue = map['states']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<MulticastGroupConsumerActivationState>(guardedValue, (value) => MulticastGroupConsumerActivationState.fromMap((value as Map).cast<String, dynamic>()))); })(),
