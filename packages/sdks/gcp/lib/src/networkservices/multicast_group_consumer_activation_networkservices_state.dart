...
class MulticastGroupConsumerActivationNetworkservicesState {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'states':
          ?pulumi.Input.mapOptionalInputValue<
            List<MulticastGroupConsumerActivationState>,
  ...
  factory MulticastGroupConsumerActivationNetworkservicesState.fromMap(
    ...
    return MulticastGroupConsumerActivationNetworkservicesState(
      ...
      multicastConsumerAssociation: (() {
        final guardedValue = map['multicastConsumerAssociation'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      multicastGroupConsumerActivationId: (() {
        final guardedValue = map['multicastGroupConsumerActivationId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      multicastGroupRangeActivation: (() {
        final guardedValue = map['multicastGroupRangeActivation'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      name: (() {
      ...
      states: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MulticastGroupConsumerActivationState>(
            guardedValue,
            (value) => MulticastGroupConsumerActivationState.fromMap(
