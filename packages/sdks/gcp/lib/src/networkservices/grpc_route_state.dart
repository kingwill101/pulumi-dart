...
class GrpcRouteState {
  ...
  factory GrpcRouteState.fromMap(Map<String, dynamic> map) {
    return GrpcRouteState(
      ...
      rules: (() { final guardedValue = map['rules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GrpcRouteRule>(guardedValue, (value) => GrpcRouteRule.fromMap((value as Map).cast<String, dynamic>()))); })(),
