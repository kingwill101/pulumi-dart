...
class MulticastDomainNetworkservicesState {
  ...
  factory MulticastDomainNetworkservicesState.fromMap(
    ...
    return MulticastDomainNetworkservicesState(
      ...
      connectionConfig: (() {
        final guardedValue = map['connectionConfig'];
        if (guardedValue == null) return null;
      ...
      multicastDomainId: (() {
        final guardedValue = map['multicastDomainId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      name: (() {
      ...
      states: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MulticastDomainState>(
            guardedValue,
            (value) => MulticastDomainState.fromMap(
