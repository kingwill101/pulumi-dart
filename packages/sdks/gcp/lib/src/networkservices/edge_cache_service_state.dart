...
class EdgeCacheServiceState {
  ...
  EdgeCacheServiceState({
    ...
    pulumi.Output<List<String>>? ipv4Addresses,
    ...
    pulumi.Output<EdgeCacheServiceRouting>? routing,
    pulumi.Output<String>? sslPolicy,
      ...
      ipv4Addresses = pulumi.Input.asOptionalInput<List<String>>(ipv4Addresses),
      ...
      routing = pulumi.Input.asOptionalInput<EdgeCacheServiceRouting>(routing),
  ...
  factory EdgeCacheServiceState.fromMap(Map<String, dynamic> map) {
    return EdgeCacheServiceState(
      ...
      ipv4Addresses: map['ipv4Addresses'] == null ? null : pulumi.Output.create<List<String>>((map['ipv4Addresses'] as List).cast<String>()),
      ...
      routing: map['routing'] == null ? null : pulumi.Output.create<EdgeCacheServiceRouting>(EdgeCacheServiceRouting.fromMap((map['routing'] as Map).cast<String, dynamic>())),
