...
class EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCdnPolicy {
  ...
  final EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCdnPolicyAddSignatures? addSignatures;
  /// Defines the request parameters that contribute to the cache key.
  /// Structure is documented below.
  final EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCdnPolicyCacheKeyPolicy? cacheKeyPolicy;
  ...
  /// Structure is documented below.
  final EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCdnPolicySignedTokenOptions? signedTokenOptions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'addSignatures': ?addSignatures == null ? null : addSignatures!.toMap(),
      ...
      'signedTokenOptions': ?signedTokenOptions == null ? null : signedTokenOptions!.toMap(),
    };
  }
  ...
  factory EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCdnPolicy.fromMap(Map<String, dynamic> map) {
    return EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCdnPolicy(
      addSignatures: map['addSignatures'] == null ? null : EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCdnPolicyAddSignatures.fromMap((map['addSignatures'] as Map).cast<String, dynamic>()),
      cacheKeyPolicy: map['cacheKeyPolicy'] == null ? null : EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCdnPolicyCacheKeyPolicy.fromMap((map['cacheKeyPolicy'] as Map).cast<String, dynamic>()),
      ...
      negativeCachingPolicy: map['negativeCachingPolicy'] == null ? null : (map['negativeCachingPolicy'] as Map).cast<String, String>(),
      signedRequestKeyset: map['signedRequestKeyset'] == null ? null : map['signedRequestKeyset'] as String,
      signedRequestMaximumExpirationTtl: map['signedRequestMaximumExpirationTtl'] == null ? null : map['signedRequestMaximumExpirationTtl'] as String,
      signedRequestMode: map['signedRequestMode'] == null ? null : map['signedRequestMode'] as String,
      signedTokenOptions: map['signedTokenOptions'] == null ? null : EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCdnPolicySignedTokenOptions.fromMap((map['signedTokenOptions'] as Map).cast<String, dynamic>()),
    );
  }
}
