...
class LbEdgeExtensionArgs {
  ...
  LbEdgeExtensionArgs({
    ...
    required pulumi.Output<List<LbEdgeExtensionExtensionChain>> extensionChains,
    ...
    pulumi.Output<String>? project,
      ...
      extensionChains = pulumi.Input.asInput<List<LbEdgeExtensionExtensionChain>>(extensionChains),
  ...
  factory LbEdgeExtensionArgs.fromMap(Map<String, dynamic> map) {
    return LbEdgeExtensionArgs(
      ...
      extensionChains: pulumi.Output.create<List<LbEdgeExtensionExtensionChain>>(pulumi.Input.decodeList<LbEdgeExtensionExtensionChain>(map['extensionChains'], (value) => LbEdgeExtensionExtensionChain.fromMap((value as Map).cast<String, dynamic>()))),
