...
import 'service_lb_policies_state.dart';
...
class ServiceLbPolicies extends pulumi.CustomResource {
  ...
  ServiceLbPolicies(
    ...
    this.autoCapacityDrain = registerOutput<ServiceLbPoliciesAutoCapacityDrain?>('autoCapacityDrain');
    this.createTime = registerOutput<String>('createTime');
    this.description = registerOutput<String?>('description');
    this.effectiveLabels = registerOutput<Map<String, String>>('effectiveLabels');
    this.failoverConfig = registerOutput<ServiceLbPoliciesFailoverConfig?>('failoverConfig');
    this.isolationConfig = registerOutput<ServiceLbPoliciesIsolationConfig?>('isolationConfig');
  ...
  /// Gets an existing [ServiceLbPolicies] resource's state with the given [name] and [id].
  static ServiceLbPolicies get(
    String name,
    pulumi.Input<String> id, {
    ServiceLbPoliciesState? state,
  }) {
    return ServiceLbPolicies._get(
      name,
      state: state?.toMap(),
