...
class MulticastGroupRangeActivationNetworkservicesState {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'states':
          ?pulumi.Input.mapOptionalInputValue<
            List<MulticastGroupRangeActivationState>,
  ...
  factory MulticastGroupRangeActivationNetworkservicesState.fromMap(
    ...
    return MulticastGroupRangeActivationNetworkservicesState(
      ...
      multicastDomainActivation: (() {
        final guardedValue = map['multicastDomainActivation'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      multicastGroupConsumerActivations: (() {
        final guardedValue = map['multicastGroupConsumerActivations'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      multicastGroupRange: (() {
        final guardedValue = map['multicastGroupRange'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      multicastGroupRangeActivationId: (() {
        final guardedValue = map['multicastGroupRangeActivationId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      name: (() {
      ...
      states: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MulticastGroupRangeActivationState>(
            guardedValue,
            (value) => MulticastGroupRangeActivationState.fromMap(
