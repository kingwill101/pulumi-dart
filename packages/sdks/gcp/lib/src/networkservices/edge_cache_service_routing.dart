...
class EdgeCacheServiceRouting {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'hostRules': pulumi.Input.mapInputValue<List<EdgeCacheServiceRoutingHostRule>, List<Map<String, dynamic>>>(hostRules, (value) => pulumi.Input.encodeList<EdgeCacheServiceRoutingHostRule, Map<String, dynamic>>(value, (value) => value.toMap())),
      'pathMatchers': pulumi.Input.mapInputValue<List<EdgeCacheServiceRoutingPathMatcher>, List<Map<String, dynamic>>>(pathMatchers, (value) => pulumi.Input.encodeList<EdgeCacheServiceRoutingPathMatcher, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory EdgeCacheServiceRouting.fromMap(Map<String, dynamic> map) {
    return EdgeCacheServiceRouting(
      hostRules: pulumi.Input.fromValue(pulumi.Input.decodeList<EdgeCacheServiceRoutingHostRule>(map['hostRules']!, (value) => EdgeCacheServiceRoutingHostRule.fromMap((value as Map).cast<String, dynamic>()))),
      pathMatchers: pulumi.Input.fromValue(pulumi.Input.decodeList<EdgeCacheServiceRoutingPathMatcher>(map['pathMatchers']!, (value) => EdgeCacheServiceRoutingPathMatcher.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
