...
class EdgeCacheServiceRouting {
  ...
  factory EdgeCacheServiceRouting.fromMap(Map<String, dynamic> map) {
    return EdgeCacheServiceRouting(
      hostRules: (pulumi.Input.decodeList<EdgeCacheServiceRoutingHostRule>(map['hostRules'], (value) => EdgeCacheServiceRoutingHostRule.fromMap((value as Map).cast<String, dynamic>()))).input(),
      pathMatchers: (pulumi.Input.decodeList<EdgeCacheServiceRoutingPathMatcher>(map['pathMatchers'], (value) => EdgeCacheServiceRoutingPathMatcher.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
