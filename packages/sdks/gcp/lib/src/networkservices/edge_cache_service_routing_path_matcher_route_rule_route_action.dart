...
class EdgeCacheServiceRoutingPathMatcherRouteRuleRouteAction {
  ...
  final EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCdnPolicy? cdnPolicy;
  ...
  /// Structure is documented below.
  final EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCorsPolicy? corsPolicy;
  /// The URL rewrite configuration for requests that match this route.
  /// Structure is documented below.
  final EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionUrlRewrite? urlRewrite;
  ...
  factory EdgeCacheServiceRoutingPathMatcherRouteRuleRouteAction.fromMap(Map<String, dynamic> map) {
    return EdgeCacheServiceRoutingPathMatcherRouteRuleRouteAction(
      cdnPolicy: map['cdnPolicy'] == null ? null : EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCdnPolicy.fromMap((map['cdnPolicy'] as Map).cast<String, dynamic>()),
      compressionMode: map['compressionMode'] == null ? null : map['compressionMode'] as String,
      corsPolicy: map['corsPolicy'] == null ? null : EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCorsPolicy.fromMap((map['corsPolicy'] as Map).cast<String, dynamic>()),
      urlRewrite: map['urlRewrite'] == null ? null : EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionUrlRewrite.fromMap((map['urlRewrite'] as Map).cast<String, dynamic>()),
    );
  }
}
