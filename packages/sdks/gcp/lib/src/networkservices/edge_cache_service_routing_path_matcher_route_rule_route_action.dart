...
class EdgeCacheServiceRoutingPathMatcherRouteRuleRouteAction {
  ...
  factory EdgeCacheServiceRoutingPathMatcherRouteRuleRouteAction.fromMap(Map<String, dynamic> map) {
    return EdgeCacheServiceRoutingPathMatcherRouteRuleRouteAction(
      cdnPolicy: (() { final guardedValue = map['cdnPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCdnPolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      corsPolicy: (() { final guardedValue = map['corsPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCorsPolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      urlRewrite: (() { final guardedValue = map['urlRewrite']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionUrlRewrite.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
