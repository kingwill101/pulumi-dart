...
class MulticastProducerAssociation extends pulumi.CustomResource {
  ...
  MulticastProducerAssociation(
    ...
    this.multicastProducerAssociationId = registerOutput<String>('multicastProducerAssociationId');
    this.name = registerOutput<String>('name');
    this.network = registerOutput<String>('network');
    this.project = registerOutput<String>('project');
    this.pulumiLabels = registerOutput<Map<String, String>>('pulumiLabels');
    this.states = registerOutput<List<MulticastProducerAssociationState>>('states');
