...
class EndpointPolicyEndpointMatcher {
  ...
  final pulumi.Input<EndpointPolicyEndpointMatcherMetadataLabelMatcher> metadataLabelMatcher;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'metadataLabelMatcher': pulumi.Input.mapInputValue<EndpointPolicyEndpointMatcherMetadataLabelMatcher, Map<String, dynamic>>(metadataLabelMatcher, (value) => value.toMap()),
    };
  }

  factory EndpointPolicyEndpointMatcher.fromMap(Map<String, dynamic> map) {
    return EndpointPolicyEndpointMatcher(
      metadataLabelMatcher: pulumi.Input.fromValue(EndpointPolicyEndpointMatcherMetadataLabelMatcher.fromMap((map['metadataLabelMatcher']! as Map).cast<String, dynamic>())),
    );
  }
}
