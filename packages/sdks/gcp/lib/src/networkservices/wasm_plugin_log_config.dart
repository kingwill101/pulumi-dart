...
class WasmPluginLogConfig {
  ...
  factory WasmPluginLogConfig.fromMap(Map<String, dynamic> map) {
    return WasmPluginLogConfig(
      ...
      minLogLevel: (() { final guardedValue = map['minLogLevel']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
