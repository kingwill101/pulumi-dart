...
class LbRouteExtensionExtensionChain {
  ...
  const LbRouteExtensionExtensionChain({
  ...
  factory LbRouteExtensionExtensionChain.fromMap(Map<String, dynamic> map) {
    return LbRouteExtensionExtensionChain(
      extensions: pulumi.Input.fromValue(pulumi.Input.decodeList<LbRouteExtensionExtensionChainExtension>(map['extensions']!, (value) => LbRouteExtensionExtensionChainExtension.fromMap((value as Map).cast<String, dynamic>()))),
      matchCondition: pulumi.Input.fromValue(LbRouteExtensionExtensionChainMatchCondition.fromMap((map['matchCondition']! as Map).cast<String, dynamic>())),
