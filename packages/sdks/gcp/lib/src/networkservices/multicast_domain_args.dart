...
class MulticastDomainArgs {
    ...
    return <String, dynamic>{
      ...
      'connectionConfig':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(connectionConfig, (value) => value.toMap()),
  ...
  factory MulticastDomainArgs.fromMap(Map<String, dynamic> map) {
    return MulticastDomainArgs(
      ...
      connectionConfig: pulumi.Input.fromValue(
        MulticastDomainConnectionConfig.fromMap(
          (map['connectionConfig']! as Map).cast<String, dynamic>(),
        ),
      ),
      description: (() {
      ...
      multicastDomainGroup: (() {
        final guardedValue = map['multicastDomainGroup'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      multicastDomainId: pulumi.Input.fromValue(
        map['multicastDomainId'] as String,
      ),
      project: (() {
