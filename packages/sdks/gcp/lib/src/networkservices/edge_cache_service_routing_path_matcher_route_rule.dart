...
class EdgeCacheServiceRoutingPathMatcherRouteRule {
  ...
  final pulumi.Input<EdgeCacheServiceRoutingPathMatcherRouteRuleHeaderAction>?
  headerAction;
  ...
  /// Structure is documented below.
  final pulumi.Input<List<EdgeCacheServiceRoutingPathMatcherRouteRuleMatchRule>>
  matchRules;
  ...
  /// Structure is documented below.
  final pulumi.Input<EdgeCacheServiceRoutingPathMatcherRouteRuleRouteAction>?
  routeAction;
  ...
  /// Structure is documented below.
  final pulumi.Input<EdgeCacheServiceRoutingPathMatcherRouteRuleRouteMethods>?
  routeMethods;

  /// The URL redirect configuration for requests that match this route.
  /// Structure is documented below.
  final pulumi.Input<EdgeCacheServiceRoutingPathMatcherRouteRuleUrlRedirect>?
  urlRedirect;
    ...
    return <String, dynamic>{
      ...
      'matchRules':
          pulumi.Input.mapInputValue<
            List<EdgeCacheServiceRoutingPathMatcherRouteRuleMatchRule>,
      ...
      'routeMethods':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(routeMethods, (value) => value.toMap()),
      'urlRedirect':
          ?pulumi.Input.mapOptionalInputValue<
  ...
  factory EdgeCacheServiceRoutingPathMatcherRouteRule.fromMap(
    ...
    return EdgeCacheServiceRoutingPathMatcherRouteRule(
      ...
      routeMethods: (() {
        final guardedValue = map['routeMethods'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
