...
class EdgeCacheServiceRoutingPathMatcherRouteRule {
  ...
  factory EdgeCacheServiceRoutingPathMatcherRouteRule.fromMap(Map<String, dynamic> map) {
    return EdgeCacheServiceRoutingPathMatcherRouteRule(
      ...
      headerAction: (() { final guardedValue = map['headerAction']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EdgeCacheServiceRoutingPathMatcherRouteRuleHeaderAction.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      matchRules: pulumi.Input.fromValue(pulumi.Input.decodeList<EdgeCacheServiceRoutingPathMatcherRouteRuleMatchRule>(map['matchRules']!, (value) => EdgeCacheServiceRoutingPathMatcherRouteRuleMatchRule.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      routeAction: (() { final guardedValue = map['routeAction']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EdgeCacheServiceRoutingPathMatcherRouteRuleRouteAction.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      routeMethods: (() { final guardedValue = map['routeMethods']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EdgeCacheServiceRoutingPathMatcherRouteRuleRouteMethods.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      urlRedirect: (() { final guardedValue = map['urlRedirect']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EdgeCacheServiceRoutingPathMatcherRouteRuleUrlRedirect.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
