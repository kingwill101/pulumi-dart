...
class TcpRouteState {
  ...
  factory TcpRouteState.fromMap(Map<String, dynamic> map) {
    return TcpRouteState(
      ...
      rules: (() { final guardedValue = map['rules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<TcpRouteRule>(guardedValue, (value) => TcpRouteRule.fromMap((value as Map).cast<String, dynamic>()))); })(),
