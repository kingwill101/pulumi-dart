...
class LbTrafficExtension extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<LbTrafficExtensionExtensionChain>> extensionChains;
  ...
  LbTrafficExtension(
    ...
    extensionChains = registerOutput<List<LbTrafficExtensionExtensionChain>>('extensionChains', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return pulumi.Input.decodeList<LbTrafficExtensionExtensionChain>(guardedValue, (value) => LbTrafficExtensionExtensionChain.fromMap((value as Map).cast<String, dynamic>())); });
  ...
  /// Creates a typed reference to an existing [LbTrafficExtension] resource.
  LbTrafficExtension.reference(String urn)
    : super(
        'gcp:networkservices/lbTrafficExtension:LbTrafficExtension',
