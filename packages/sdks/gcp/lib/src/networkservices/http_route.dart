...
class HttpRoute extends pulumi.CustomResource {
  ...
  HttpRoute(
    ...
    rules = registerOutput<List<HttpRouteRule>>('rules', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return pulumi.Input.decodeList<HttpRouteRule>(guardedValue, (value) => HttpRouteRule.fromMap((value as Map).cast<String, dynamic>())); });
    selfLink = registerOutput<String>('selfLink');
    updateTime = registerOutput<String>('updateTime');
  }

  /// Gets an existing [HttpRoute] resource's state with the given [name] and [id].
  static HttpRoute get(
    String name,
    pulumi.Input<String> id, {
    HttpRouteState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return HttpRoute._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [HttpRoute] resource.
  HttpRoute.reference(String urn)
    : super(
        'gcp:networkservices/httpRoute:HttpRoute',
