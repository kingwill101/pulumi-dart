...
class EdgeCacheOriginOriginOverrideActionHeaderAction {
  ...
  factory EdgeCacheOriginOriginOverrideActionHeaderAction.fromMap(Map<String, dynamic> map) {
    return EdgeCacheOriginOriginOverrideActionHeaderAction(
      requestHeadersToAdds: (() { final guardedValue = map['requestHeadersToAdds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<EdgeCacheOriginOriginOverrideActionHeaderActionRequestHeadersToAdd>(guardedValue, (value) => EdgeCacheOriginOriginOverrideActionHeaderActionRequestHeadersToAdd.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
