...
class MulticastGroupRangeActivationArgs {
  ...
  factory MulticastGroupRangeActivationArgs.fromMap(Map<String, dynamic> map) {
    return MulticastGroupRangeActivationArgs(
      ...
      multicastDomainActivation: pulumi.Input.fromValue(
        map['multicastDomainActivation'] as String,
      ),
      multicastGroupRange: pulumi.Input.fromValue(
        map['multicastGroupRange'] as String,
      ),
      multicastGroupRangeActivationId: pulumi.Input.fromValue(
