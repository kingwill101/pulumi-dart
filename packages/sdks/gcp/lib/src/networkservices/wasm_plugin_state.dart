...
class WasmPluginState {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'usedBies':
          ?pulumi.Input.mapOptionalInputValue<
            List<WasmPluginUsedBy>,
            List<Map<String, dynamic>>
          >(
            usedBies,
            (value) =>
                pulumi.Input.encodeList<WasmPluginUsedBy, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory WasmPluginState.fromMap(Map<String, dynamic> map) {
    return WasmPluginState(
      ...
      logConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          WasmPluginLogConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      mainVersionId: (() {
        final guardedValue = map['mainVersionId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      name: (() {
      ...
      usedBies: (() {
        final guardedValue = map['usedBies'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<WasmPluginUsedBy>(
            guardedValue,
            (value) => WasmPluginUsedBy.fromMap(
      ...
      versions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<WasmPluginVersion>(
            guardedValue,
            (value) => WasmPluginVersion.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
