...
class TlsRouteRuleAction {
  ...
  factory TlsRouteRuleAction.fromMap(Map<String, dynamic> map) {
    return TlsRouteRuleAction(
      destinations: (() { final guardedValue = map['destinations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<TlsRouteRuleActionDestination>(guardedValue, (value) => TlsRouteRuleActionDestination.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
