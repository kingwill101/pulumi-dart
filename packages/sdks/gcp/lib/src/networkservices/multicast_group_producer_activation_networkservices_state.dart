...
class MulticastGroupProducerActivationNetworkservicesState {
    ...
    return <String, dynamic>{
      ...
      'states':
          ?pulumi.Input.mapOptionalInputValue<
            List<MulticastGroupProducerActivationState>,
  ...
  factory MulticastGroupProducerActivationNetworkservicesState.fromMap(
    ...
    return MulticastGroupProducerActivationNetworkservicesState(
      ...
      multicastGroupProducerActivationId: (() {
        final guardedValue = map['multicastGroupProducerActivationId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ...
      multicastProducerAssociation: (() {
        final guardedValue = map['multicastProducerAssociation'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      name: (() {
      ...
      states: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MulticastGroupProducerActivationState>(
            guardedValue,
            (value) => MulticastGroupProducerActivationState.fromMap(
