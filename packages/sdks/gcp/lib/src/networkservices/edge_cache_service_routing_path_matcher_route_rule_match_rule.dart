...
class EdgeCacheServiceRoutingPathMatcherRouteRuleMatchRule {
  ...
  final pulumi.Input<
    List<EdgeCacheServiceRoutingPathMatcherRouteRuleMatchRuleHeaderMatch>
  >?
  headerMatches;
      ...
      headerMatches: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                EdgeCacheServiceRoutingPathMatcherRouteRuleMatchRuleHeaderMatch.fromMap(
      ...
      queryParameterMatches: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                EdgeCacheServiceRoutingPathMatcherRouteRuleMatchRuleQueryParameterMatch.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
