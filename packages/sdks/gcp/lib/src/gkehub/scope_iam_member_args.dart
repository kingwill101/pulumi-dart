...
class ScopeIamMemberArgs {
  ...
  factory ScopeIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return ScopeIamMemberArgs(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ScopeIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
