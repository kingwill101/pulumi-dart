...
class FeatureSpecClusterupgradeGkeUpgradeOverride {
  ...
  final pulumi.Input<FeatureSpecClusterupgradeGkeUpgradeOverridePostConditions>
  postConditions;

  /// Which upgrade to override.
  /// Structure is documented below.
  final pulumi.Input<FeatureSpecClusterupgradeGkeUpgradeOverrideUpgrade>
  upgrade;
  ...
  factory FeatureSpecClusterupgradeGkeUpgradeOverride.fromMap(
    ...
    return FeatureSpecClusterupgradeGkeUpgradeOverride(
      ...
      upgrade: pulumi.Input.fromValue(
        FeatureSpecClusterupgradeGkeUpgradeOverrideUpgrade.fromMap(
