...
class GetFeatureSpecFleetobservability {
  ...
  final pulumi.Input<List<GetFeatureSpecFleetobservabilityLoggingConfig>>
  loggingConfigs;
  ...
  GetFeatureSpecFleetobservability({required this.loggingConfigs});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'loggingConfigs':
          pulumi.Input.mapInputValue<
            List<GetFeatureSpecFleetobservabilityLoggingConfig>,
  ...
  factory GetFeatureSpecFleetobservability.fromMap(Map<String, dynamic> map) {
    return GetFeatureSpecFleetobservability(
      loggingConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetFeatureSpecFleetobservabilityLoggingConfig>(
          map['loggingConfigs']!,
