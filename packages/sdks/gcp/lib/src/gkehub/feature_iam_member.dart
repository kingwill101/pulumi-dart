...
import 'feature_iam_member_state.dart';
...
/// }
///
/// resource "gcp_gkehub_featureiampolicy" "policy" {
///   project     = feature.project
///   location    = feature.location
///   name        = feature.name
...
/// }
///
/// resource "gcp_gkehub_featureiambinding" "binding" {
///   project  = feature.project
///   location = feature.location
///   name     = feature.name
///   role     = "roles/viewer"
...
/// }
///
/// resource "gcp_gkehub_featureiammember" "member" {
///   project  = feature.project
///   location = feature.location
///   name     = feature.name
///   role     = "roles/viewer"
...
class FeatureIamMember extends pulumi.CustomResource {
  ...
  /// Gets an existing [FeatureIamMember] resource's state with the given [name] and [id].
  static FeatureIamMember get(
    String name,
