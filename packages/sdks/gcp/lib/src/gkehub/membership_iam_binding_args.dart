...
class MembershipIamBindingArgs {
  ...
  factory MembershipIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return MembershipIamBindingArgs(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MembershipIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
