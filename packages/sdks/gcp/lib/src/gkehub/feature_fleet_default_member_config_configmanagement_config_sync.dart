...
class FeatureFleetDefaultMemberConfigConfigmanagementConfigSync {
  ...
  const FeatureFleetDefaultMemberConfigConfigmanagementConfigSync({
    this.enabled,
    this.git,
  ...
  factory FeatureFleetDefaultMemberConfigConfigmanagementConfigSync.fromMap(Map<String, dynamic> map) {
    return FeatureFleetDefaultMemberConfigConfigmanagementConfigSync(
      ...
      git: (() { final guardedValue = map['git']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FeatureFleetDefaultMemberConfigConfigmanagementConfigSyncGit.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      oci: (() { final guardedValue = map['oci']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FeatureFleetDefaultMemberConfigConfigmanagementConfigSyncOci.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
