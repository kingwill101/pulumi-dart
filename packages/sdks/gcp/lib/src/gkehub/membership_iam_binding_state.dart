...
class MembershipIamBindingState {
  ...
  /// Creates a new [MembershipIamBindingState].
  /// [condition] Optional.
  ...
  const MembershipIamBindingState({
    this.condition,
    this.etag,
    this.location,
    this.members,
  ...
  factory MembershipIamBindingState.fromMap(Map<String, dynamic> map) {
    return MembershipIamBindingState(
