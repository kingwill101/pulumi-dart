...
class GetFeatureFleetDefaultMemberConfig {
  ...
  final pulumi.Input<List<GetFeatureFleetDefaultMemberConfigConfigmanagement>>
  configmanagements;
  ...
  final pulumi.Input<List<GetFeatureFleetDefaultMemberConfigPolicycontroller>>
  policycontrollers;
    ...
    return <String, dynamic>{
      'configmanagements':
          pulumi.Input.mapInputValue<
            List<GetFeatureFleetDefaultMemberConfigConfigmanagement>,
      ...
      'meshes':
          pulumi.Input.mapInputValue<
            List<GetFeatureFleetDefaultMemberConfigMesh>,
            List<Map<String, dynamic>>
          >(
            meshes,
            (value) =>
      ...
      'policycontrollers':
          pulumi.Input.mapInputValue<
            List<GetFeatureFleetDefaultMemberConfigPolicycontroller>,
            List<Map<String, dynamic>>
          >(
            policycontrollers,
            (value) =>
  ...
  factory GetFeatureFleetDefaultMemberConfig.fromMap(Map<String, dynamic> map) {
    return GetFeatureFleetDefaultMemberConfig(
      configmanagements: pulumi.Input.fromValue(
      ...
      meshes: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetFeatureFleetDefaultMemberConfigMesh>(
          map['meshes']!,
      ...
      policycontrollers: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetFeatureFleetDefaultMemberConfigPolicycontroller
        >(
