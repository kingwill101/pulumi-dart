...
import 'membership_iam_binding_state.dart';
...
class MembershipIamBinding extends pulumi.CustomResource {
  ...
  MembershipIamBinding(
    ...
    condition = registerOutput<MembershipIamBindingCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return MembershipIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [MembershipIamBinding] resource's state with the given [name] and [id].
  static MembershipIamBinding get(
    String name,
    pulumi.Input<String> id, {
    MembershipIamBindingState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return MembershipIamBinding._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [MembershipIamBinding] resource.
  MembershipIamBinding.reference(String urn)
    : super(
        'gcp:gkehub/membershipIamBinding:MembershipIamBinding',
