...
import 'scope_iam_member_state.dart';
...
class ScopeIamMember extends pulumi.CustomResource {
  late final pulumi.Output<ScopeIamMemberCondition?> condition;
  ...
  /// Creates a new [ScopeIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ScopeIamMember]. {@macro pulumi_gkehub_scope_iam_member_scope_iam_member_args_doc}
  ...
  ScopeIamMember(
    ...
    condition = registerOutput<ScopeIamMemberCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ScopeIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [ScopeIamMember] resource's state with the given [name] and [id].
  static ScopeIamMember get(
    String name,
    pulumi.Input<String> id, {
    ScopeIamMemberState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return ScopeIamMember._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [ScopeIamMember] resource.
  ScopeIamMember.reference(String urn)
    : super(
        'gcp:gkehub/scopeIamMember:ScopeIamMember',
