...
class FeatureGkehubState {
    ...
    return <String, dynamic>{
      ...
      'states':
          ...
          >(
            states,
            (value) =>
                pulumi.Input.encodeList<FeatureState, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory FeatureGkehubState.fromMap(Map<String, dynamic> map) {
    return FeatureGkehubState(
      ...
      resourceStates: (() {
        final guardedValue = map['resourceStates'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FeatureResourceState>(
            guardedValue,
            (value) => FeatureResourceState.fromMap(
      ...
      states: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FeatureState>(
            guardedValue,
            (value) =>
                FeatureState.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      updateTime: (() {
