...
class GetFeatureSpecClusterupgrade {
  ...
  factory GetFeatureSpecClusterupgrade.fromMap(Map<String, dynamic> map) {
    return GetFeatureSpecClusterupgrade(
      gkeUpgradeOverrides: pulumi.Input.fromValue(pulumi.Input.decodeList<GetFeatureSpecClusterupgradeGkeUpgradeOverride>(map['gkeUpgradeOverrides']!, (value) => GetFeatureSpecClusterupgradeGkeUpgradeOverride.fromMap((value as Map).cast<String, dynamic>()))),
      postConditions: pulumi.Input.fromValue(pulumi.Input.decodeList<GetFeatureSpecClusterupgradePostCondition>(map['postConditions']!, (value) => GetFeatureSpecClusterupgradePostCondition.fromMap((value as Map).cast<String, dynamic>()))),
