...
class GetFeatureSpecClusterupgrade {
  ...
  final pulumi.Input<List<GetFeatureSpecClusterupgradeGkeUpgradeOverride>>
  gkeUpgradeOverrides;

  /// Post conditions to override for the specified upgrade.
  final pulumi.Input<List<GetFeatureSpecClusterupgradePostCondition>>
  postConditions;
    ...
    return <String, dynamic>{
      'gkeUpgradeOverrides':
          pulumi.Input.mapInputValue<
            List<GetFeatureSpecClusterupgradeGkeUpgradeOverride>,
      ...
      'postConditions':
          pulumi.Input.mapInputValue<
            List<GetFeatureSpecClusterupgradePostCondition>,
            List<Map<String, dynamic>>
          >(
            postConditions,
            (value) =>
  ...
  factory GetFeatureSpecClusterupgrade.fromMap(Map<String, dynamic> map) {
    return GetFeatureSpecClusterupgrade(
      gkeUpgradeOverrides: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetFeatureSpecClusterupgradeGkeUpgradeOverride>(
      ...
      upstreamFleets: pulumi.Input.fromValue(
