  ...
  factory FeatureMembershipPolicycontrollerPolicyControllerHubConfigPolicyContent.fromMap(
    ...
    return FeatureMembershipPolicycontrollerPolicyControllerHubConfigPolicyContent(
      bundles: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                FeatureMembershipPolicycontrollerPolicyControllerHubConfigPolicyContentBundle.fromMap(
      ...
      templateLibrary: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FeatureMembershipPolicycontrollerPolicyControllerHubConfigPolicyContentTemplateLibrary.fromMap(
