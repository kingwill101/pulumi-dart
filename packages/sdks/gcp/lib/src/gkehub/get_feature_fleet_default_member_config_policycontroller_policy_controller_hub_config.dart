    ...
    return GetFeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfig(
      ...
      deploymentConfigs: pulumi.Input.fromValue(
        ...
        >(
          ...
          (value) =>
              GetFeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigDeploymentConfig.fromMap(
      ...
      monitorings: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetFeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigMonitoring
        >(
          map['monitorings']!,
          (value) =>
              GetFeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigMonitoring.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
      mutationEnabled: pulumi.Input.fromValue(map['mutationEnabled'] as bool),
      policyContents: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetFeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigPolicyContent
        >(
          map['policyContents']!,
          (value) =>
              GetFeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigPolicyContent.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
