...
class GetFeatureSpecFleetobservabilityLoggingConfig {
  ...
  factory GetFeatureSpecFleetobservabilityLoggingConfig.fromMap(Map<String, dynamic> map) {
    return GetFeatureSpecFleetobservabilityLoggingConfig(
      defaultConfigs: (pulumi.Input.decodeList<GetFeatureSpecFleetobservabilityLoggingConfigDefaultConfig>(map['defaultConfigs'], (value) => GetFeatureSpecFleetobservabilityLoggingConfigDefaultConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
      fleetScopeLogsConfigs: (pulumi.Input.decodeList<GetFeatureSpecFleetobservabilityLoggingConfigFleetScopeLogsConfig>(map['fleetScopeLogsConfigs'], (value) => GetFeatureSpecFleetobservabilityLoggingConfigFleetScopeLogsConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
