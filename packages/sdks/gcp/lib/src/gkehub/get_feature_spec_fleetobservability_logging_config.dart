...
class GetFeatureSpecFleetobservabilityLoggingConfig {
  ...
  final pulumi.Input<
    List<GetFeatureSpecFleetobservabilityLoggingConfigDefaultConfig>
  >
  defaultConfigs;

  /// Specified if applying the routing config to all logs for all fleet scopes.
  final pulumi.Input<
    List<GetFeatureSpecFleetobservabilityLoggingConfigFleetScopeLogsConfig>
  >
  ...
  factory GetFeatureSpecFleetobservabilityLoggingConfig.fromMap(
    ...
    return GetFeatureSpecFleetobservabilityLoggingConfig(
      defaultConfigs: pulumi.Input.fromValue(
      ...
      fleetScopeLogsConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetFeatureSpecFleetobservabilityLoggingConfigFleetScopeLogsConfig
        >(
