...
import 'membership_iam_member_state.dart';
...
class MembershipIamMember extends pulumi.CustomResource {
  ...
  MembershipIamMember(
    ...
    condition = registerOutput<MembershipIamMemberCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return MembershipIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [MembershipIamMember] resource's state with the given [name] and [id].
  static MembershipIamMember get(
    String name,
    pulumi.Input<String> id, {
    MembershipIamMemberState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return MembershipIamMember._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [MembershipIamMember] resource.
  MembershipIamMember.reference(String urn)
    : super(
        'gcp:gkehub/membershipIamMember:MembershipIamMember',
