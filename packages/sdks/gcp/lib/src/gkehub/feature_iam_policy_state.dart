...
class FeatureIamPolicyState {
  ...
  /// Creates a new [FeatureIamPolicyState].
  ...
  factory FeatureIamPolicyState.fromMap(Map<String, dynamic> map) {
    return FeatureIamPolicyState(
