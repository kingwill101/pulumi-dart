...
class FeatureMembershipPolicycontroller {
  ...
  factory FeatureMembershipPolicycontroller.fromMap(Map<String, dynamic> map) {
    return FeatureMembershipPolicycontroller(
      policyControllerHubConfig: pulumi.Input.fromValue(FeatureMembershipPolicycontrollerPolicyControllerHubConfig.fromMap((map['policyControllerHubConfig']! as Map).cast<String, dynamic>())),
