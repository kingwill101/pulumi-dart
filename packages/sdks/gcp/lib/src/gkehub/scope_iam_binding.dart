...
import 'scope_iam_binding_args.dart';
import 'scope_iam_binding_condition.dart';
import 'scope_iam_binding_state.dart';
...
class ScopeIamBinding extends pulumi.CustomResource {
  late final pulumi.Output<ScopeIamBindingCondition?> condition;
  ...
  /// Creates a new [ScopeIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ScopeIamBinding]. {@macro pulumi_gkehub_scope_iam_binding_scope_iam_binding_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  ScopeIamBinding(
    String name, {
    ScopeIamBindingArgs? args,
    ...
    condition = registerOutput<ScopeIamBindingCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ScopeIamBindingCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [ScopeIamBinding] resource's state with the given [name] and [id].
  static ScopeIamBinding get(
    String name,
    pulumi.Input<String> id, {
    ScopeIamBindingState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return ScopeIamBinding._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [ScopeIamBinding] resource.
  ScopeIamBinding.reference(String urn)
    : super(
        'gcp:gkehub/scopeIamBinding:ScopeIamBinding',
