...
class ScopeRbacRoleBindingGkehubState {
  ...
  factory ScopeRbacRoleBindingGkehubState.fromMap(Map<String, dynamic> map) {
    return ScopeRbacRoleBindingGkehubState(
      ...
      role: (() { final guardedValue = map['role']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ScopeRbacRoleBindingRole.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      scopeRbacRoleBindingId: (() { final guardedValue = map['scopeRbacRoleBindingId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      states: (() { final guardedValue = map['states']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ScopeRbacRoleBindingState>(guardedValue, (value) => ScopeRbacRoleBindingState.fromMap((value as Map).cast<String, dynamic>()))); })(),
