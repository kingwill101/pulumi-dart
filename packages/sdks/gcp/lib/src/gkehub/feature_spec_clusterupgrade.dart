...
class FeatureSpecClusterupgrade {
  ...
  final pulumi.Input<List<FeatureSpecClusterupgradeGkeUpgradeOverride>>?
  gkeUpgradeOverrides;
    ...
    return <String, dynamic>{
      'gkeUpgradeOverrides':
          ?pulumi.Input.mapOptionalInputValue<
            List<FeatureSpecClusterupgradeGkeUpgradeOverride>,
    ...
    return FeatureSpecClusterupgrade(
      gkeUpgradeOverrides: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FeatureSpecClusterupgradeGkeUpgradeOverride>(
            guardedValue,
      ...
      postConditions: (() {
        final guardedValue = map['postConditions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
