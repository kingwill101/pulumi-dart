...
class MembershipRbacRoleBinding extends pulumi.CustomResource {
  ...
  MembershipRbacRoleBinding(
    ...
    membershipRbacRoleBindingId = registerOutput<String>(
  ...
  /// Gets an existing [MembershipRbacRoleBinding] resource's state with the given [name] and [id].
  static MembershipRbacRoleBinding get(
    String name,
  ...
  MembershipRbacRoleBinding._get(
    String name, {
