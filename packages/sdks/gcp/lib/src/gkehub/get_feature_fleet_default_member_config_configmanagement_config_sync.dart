...
class GetFeatureFleetDefaultMemberConfigConfigmanagementConfigSync {
  ...
  factory GetFeatureFleetDefaultMemberConfigConfigmanagementConfigSync.fromMap(Map<String, dynamic> map) {
    return GetFeatureFleetDefaultMemberConfigConfigmanagementConfigSync(
      ...
      gits: pulumi.Input.fromValue(pulumi.Input.decodeList<GetFeatureFleetDefaultMemberConfigConfigmanagementConfigSyncGit>(map['gits']!, (value) => GetFeatureFleetDefaultMemberConfigConfigmanagementConfigSyncGit.fromMap((value as Map).cast<String, dynamic>()))),
      metricsGcpServiceAccountEmail: pulumi.Input.fromValue(map['metricsGcpServiceAccountEmail'] as String),
      ocis: pulumi.Input.fromValue(pulumi.Input.decodeList<GetFeatureFleetDefaultMemberConfigConfigmanagementConfigSyncOci>(map['ocis']!, (value) => GetFeatureFleetDefaultMemberConfigConfigmanagementConfigSyncOci.fromMap((value as Map).cast<String, dynamic>()))),
