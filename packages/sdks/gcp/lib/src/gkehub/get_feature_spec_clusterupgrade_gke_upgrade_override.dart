...
class GetFeatureSpecClusterupgradeGkeUpgradeOverride {
  ...
  final pulumi.Input<
    List<GetFeatureSpecClusterupgradeGkeUpgradeOverridePostCondition>
  >
  postConditions;

  /// Which upgrade to override.
  final pulumi.Input<
    List<GetFeatureSpecClusterupgradeGkeUpgradeOverrideUpgrade>
  >
  upgrades;
  ...
  factory GetFeatureSpecClusterupgradeGkeUpgradeOverride.fromMap(
    ...
    return GetFeatureSpecClusterupgradeGkeUpgradeOverride(
      ...
      upgrades: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetFeatureSpecClusterupgradeGkeUpgradeOverrideUpgrade
        >(
          map['upgrades']!,
