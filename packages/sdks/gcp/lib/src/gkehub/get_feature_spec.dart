...
class GetFeatureSpec {
  ...
  final pulumi.Input<List<GetFeatureSpecFleetobservability>>
  fleetobservabilities;

  /// Multicluster Ingress-specific spec.
  final pulumi.Input<List<GetFeatureSpecMulticlusteringress>>
  multiclusteringresses;

  /// RBACRolebinding Actuation feature spec.
  final pulumi.Input<List<GetFeatureSpecRbacrolebindingactuation>>
    ...
    return <String, dynamic>{
      'clusterupgrades':
          pulumi.Input.mapInputValue<
            List<GetFeatureSpecClusterupgrade>,
      ...
      'fleetobservabilities':
          pulumi.Input.mapInputValue<
            List<GetFeatureSpecFleetobservability>,
            List<Map<String, dynamic>>
          >(
            fleetobservabilities,
            (value) =>
      ...
      'multiclusteringresses':
          pulumi.Input.mapInputValue<
            List<GetFeatureSpecMulticlusteringress>,
            List<Map<String, dynamic>>
          >(
            multiclusteringresses,
            (value) =>
      ...
      'rbacrolebindingactuations':
          pulumi.Input.mapInputValue<
            List<GetFeatureSpecRbacrolebindingactuation>,
            List<Map<String, dynamic>>
          >(
            rbacrolebindingactuations,
            (value) =>
  ...
  factory GetFeatureSpec.fromMap(Map<String, dynamic> map) {
    return GetFeatureSpec(
      clusterupgrades: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetFeatureSpecClusterupgrade>(
          map['clusterupgrades']!,
      ...
      fleetobservabilities: pulumi.Input.fromValue(
      ...
      multiclusteringresses: pulumi.Input.fromValue(
      ...
      rbacrolebindingactuations: pulumi.Input.fromValue(
