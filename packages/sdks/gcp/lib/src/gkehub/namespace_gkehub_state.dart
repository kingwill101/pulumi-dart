...
class NamespaceGkehubState {
    ...
    return <String, dynamic>{
      ...
      'states':
          ...
          >(
            states,
            (value) =>
                pulumi.Input.encodeList<NamespaceState, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory NamespaceGkehubState.fromMap(Map<String, dynamic> map) {
    return NamespaceGkehubState(
      ...
      scopeNamespaceId: (() {
        final guardedValue = map['scopeNamespaceId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      states: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NamespaceState>(
            guardedValue,
            (value) =>
                NamespaceState.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      uid: (() {
