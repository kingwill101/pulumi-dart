...
class ProjectCustomModuleCustomConfigCustomOutput {
  ...
  factory ProjectCustomModuleCustomConfigCustomOutput.fromMap(Map<String, dynamic> map) {
    return ProjectCustomModuleCustomConfigCustomOutput(
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ProjectCustomModuleCustomConfigCustomOutputProperty>(guardedValue, (value) => ProjectCustomModuleCustomConfigCustomOutputProperty.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
