...
import 'v2_organization_source_iam_binding_args.dart';
import 'v2_organization_source_iam_binding_condition.dart';
import 'v2_organization_source_iam_binding_state.dart';
...
class V2OrganizationSourceIamBinding extends pulumi.CustomResource {
  late final pulumi.Output<V2OrganizationSourceIamBindingCondition?> condition;
  ...
  /// Creates a new [V2OrganizationSourceIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [V2OrganizationSourceIamBinding]. {@macro pulumi_securitycenter_v2_organization_source_iam_binding_v2_organization_source_iam_binding_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  V2OrganizationSourceIamBinding(
    String name, {
    V2OrganizationSourceIamBindingArgs? args,
    ...
    this.condition = registerOutput<V2OrganizationSourceIamBindingCondition?>('condition');
  ...
  /// Gets an existing [V2OrganizationSourceIamBinding] resource's state with the given [name] and [id].
  static V2OrganizationSourceIamBinding get(
    String name,
  ...
  V2OrganizationSourceIamBinding._get(
    String name, {
