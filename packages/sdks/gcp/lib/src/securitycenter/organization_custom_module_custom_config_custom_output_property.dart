...
class OrganizationCustomModuleCustomConfigCustomOutputProperty {
  ...
  final OrganizationCustomModuleCustomConfigCustomOutputPropertyValueExpression? valueExpression;
  ...
  factory OrganizationCustomModuleCustomConfigCustomOutputProperty.fromMap(Map<String, dynamic> map) {
    return OrganizationCustomModuleCustomConfigCustomOutputProperty(
      ...
      valueExpression: map['valueExpression'] == null ? null : OrganizationCustomModuleCustomConfigCustomOutputPropertyValueExpression.fromMap((map['valueExpression'] as Map).cast<String, dynamic>()),
    );
  }
}
