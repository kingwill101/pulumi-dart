...
import 'v2_organization_scc_big_query_exports_state.dart';
...
///   }
/// }
/// resource "gcp_securitycenter_v2organizationsccbigqueryexports" "custom_big_query_export_config" {
///   name                = "my-export"
///   big_query_export_id = "my-export"
///   organization        = "123456789"
...
class V2OrganizationSccBigQueryExports extends pulumi.CustomResource {
  ...
  /// Gets an existing [V2OrganizationSccBigQueryExports] resource's state with the given [name] and [id].
  static V2OrganizationSccBigQueryExports get(
    String name,
    pulumi.Input<String> id, {
    V2OrganizationSccBigQueryExportsState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return V2OrganizationSccBigQueryExports._get(
      name,
      state: state?.toMap(),
  ...
  V2OrganizationSccBigQueryExports._get(
    String name, {
  ...
  /// Creates a typed reference to an existing [V2OrganizationSccBigQueryExports] resource.
  V2OrganizationSccBigQueryExports.reference(String urn)
    : super(
        'gcp:securitycenter/v2OrganizationSccBigQueryExports:V2OrganizationSccBigQueryExports',
