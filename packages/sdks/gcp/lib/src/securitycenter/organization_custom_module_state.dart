...
class OrganizationCustomModuleState {
  ...
  factory OrganizationCustomModuleState.fromMap(Map<String, dynamic> map) {
    return OrganizationCustomModuleState(
      ...
      customConfig: (() { final guardedValue = map['customConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OrganizationCustomModuleCustomConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
