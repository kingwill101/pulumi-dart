...
import 'management_organization_security_health_analytics_custom_module_state.dart';
...
class ManagementOrganizationSecurityHealthAnalyticsCustomModule extends pulumi.CustomResource {
  ...
  /// Gets an existing [ManagementOrganizationSecurityHealthAnalyticsCustomModule] resource's state with the given [name] and [id].
  static ManagementOrganizationSecurityHealthAnalyticsCustomModule get(
    String name,
    pulumi.Input<String> id, {
    ManagementOrganizationSecurityHealthAnalyticsCustomModuleState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return ManagementOrganizationSecurityHealthAnalyticsCustomModule._get(
      name,
      state: state?.toMap(),
  ...
  ManagementOrganizationSecurityHealthAnalyticsCustomModule._get(
    String name, {
  ...
  /// Creates a typed reference to an existing [ManagementOrganizationSecurityHealthAnalyticsCustomModule] resource.
  ManagementOrganizationSecurityHealthAnalyticsCustomModule.reference(String urn)
    : super(
        'gcp:securitycenter/managementOrganizationSecurityHealthAnalyticsCustomModule:ManagementOrganizationSecurityHealthAnalyticsCustomModule',
