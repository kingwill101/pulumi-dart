...
class V2OrganizationSourceIamMemberState {
  ...
  /// Creates a new [V2OrganizationSourceIamMemberState].
  /// [condition] Optional.
  ...
  const V2OrganizationSourceIamMemberState({
    this.condition,
    this.etag,
    this.member,
    this.organization,
  ...
  factory V2OrganizationSourceIamMemberState.fromMap(Map<String, dynamic> map) {
    return V2OrganizationSourceIamMemberState(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(V2OrganizationSourceIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
