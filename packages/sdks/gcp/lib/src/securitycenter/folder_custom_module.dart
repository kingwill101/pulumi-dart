...
import 'folder_custom_module_state.dart';
...
class FolderCustomModule extends pulumi.CustomResource {
  ...
  FolderCustomModule(
    ...
    customConfig = registerOutput<FolderCustomModuleCustomConfig>(
      'customConfig',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return FolderCustomModuleCustomConfig.fromMap(
  ...
  /// Gets an existing [FolderCustomModule] resource's state with the given [name] and [id].
  static FolderCustomModule get(
    String name,
