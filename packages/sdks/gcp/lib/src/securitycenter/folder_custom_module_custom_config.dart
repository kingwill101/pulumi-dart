...
class FolderCustomModuleCustomConfig {
  ...
  /// Structure is documented below.
  final pulumi.Input<FolderCustomModuleCustomConfigResourceSelector>
  resourceSelector;
  ...
  factory FolderCustomModuleCustomConfig.fromMap(Map<String, dynamic> map) {
    return FolderCustomModuleCustomConfig(
      ...
      predicate: pulumi.Input.fromValue(
        FolderCustomModuleCustomConfigPredicate.fromMap(
      ...
      resourceSelector: pulumi.Input.fromValue(
        FolderCustomModuleCustomConfigResourceSelector.fromMap(
