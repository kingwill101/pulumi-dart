...
import 'v2_folder_mute_config_state.dart';
...
class V2FolderMuteConfig extends pulumi.CustomResource {
  ...
  /// Gets an existing [V2FolderMuteConfig] resource's state with the given [name] and [id].
  static V2FolderMuteConfig get(
    String name,
