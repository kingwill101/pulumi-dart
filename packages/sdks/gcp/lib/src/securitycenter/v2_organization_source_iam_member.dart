...
import 'v2_organization_source_iam_member_state.dart';
...
class V2OrganizationSourceIamMember extends pulumi.CustomResource {
  ...
  V2OrganizationSourceIamMember(
    ...
    condition = registerOutput<V2OrganizationSourceIamMemberCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return V2OrganizationSourceIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  static V2OrganizationSourceIamMember get(
    String name,
    pulumi.Input<String> id, {
    V2OrganizationSourceIamMemberState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return V2OrganizationSourceIamMember._get(
      name,
      state: state?.toMap(),
  ...
  V2OrganizationSourceIamMember._get(
    String name, {
  ...
  /// Creates a typed reference to an existing [V2OrganizationSourceIamMember] resource.
  V2OrganizationSourceIamMember.reference(String urn)
    : super(
        'gcp:securitycenter/v2OrganizationSourceIamMember:V2OrganizationSourceIamMember',
