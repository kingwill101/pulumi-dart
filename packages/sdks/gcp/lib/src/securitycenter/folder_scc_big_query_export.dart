...
import 'folder_scc_big_query_export_state.dart';
...
///   }
/// }
/// resource "gcp_securitycenter_foldersccbigqueryexport" "custom_big_query_export_config" {
///   big_query_export_id = "my-export"
...
class FolderSccBigQueryExport extends pulumi.CustomResource {
  ...
  /// Gets an existing [FolderSccBigQueryExport] resource's state with the given [name] and [id].
  static FolderSccBigQueryExport get(
    String name,
    pulumi.Input<String> id, {
    FolderSccBigQueryExportState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return FolderSccBigQueryExport._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [FolderSccBigQueryExport] resource.
  FolderSccBigQueryExport.reference(String urn)
    : super(
        'gcp:securitycenter/folderSccBigQueryExport:FolderSccBigQueryExport',
