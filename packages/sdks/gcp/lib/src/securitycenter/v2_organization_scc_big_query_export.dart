...
import 'v2_organization_scc_big_query_export_state.dart';
...
///   }
/// }
/// resource "gcp_securitycenter_v2organizationsccbigqueryexport" "custom_big_query_export_config" {
///   name                = "my-export"
///   big_query_export_id = "my-export"
///   organization        = "123456789"
...
class V2OrganizationSccBigQueryExport extends pulumi.CustomResource {
  ...
  /// Creates a new [V2OrganizationSccBigQueryExport].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [V2OrganizationSccBigQueryExport]. {@macro pulumi_securitycenter_v2_organization_scc_big_query_export_v2_organization_scc_big_query_export_args_doc}
  ...
  /// Gets an existing [V2OrganizationSccBigQueryExport] resource's state with the given [name] and [id].
  static V2OrganizationSccBigQueryExport get(
    String name,
  ...
  V2OrganizationSccBigQueryExport._get(
    String name, {
