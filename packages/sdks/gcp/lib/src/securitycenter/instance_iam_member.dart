...
class InstanceIamMember extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [InstanceIamMember]. {@macro pulumi_securitycenter_instance_iam_member_instance_iam_member_args_doc}
  ...
  InstanceIamMember(
    ...
    condition = registerOutput<InstanceIamMemberCondition?>('condition');
