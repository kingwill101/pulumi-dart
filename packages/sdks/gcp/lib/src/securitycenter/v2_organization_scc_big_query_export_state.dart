...
class V2OrganizationSccBigQueryExportState {
  ...
  /// Creates a new [V2OrganizationSccBigQueryExportState].
  ...
  const V2OrganizationSccBigQueryExportState({
  ...
  factory V2OrganizationSccBigQueryExportState.fromMap(Map<String, dynamic> map) {
    return V2OrganizationSccBigQueryExportState(
