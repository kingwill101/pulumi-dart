...
import 'source_iam_member_state.dart';
...
class SourceIamMember extends pulumi.CustomResource {
  ...
  /// Creates a new [SourceIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [SourceIamMember]. {@macro pulumi_securitycenter_source_iam_member_source_iam_member_args_doc}
  ...
  SourceIamMember(
    ...
    condition = registerOutput<SourceIamMemberCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SourceIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  static SourceIamMember get(
    String name,
    pulumi.Input<String> id, {
    SourceIamMemberState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return SourceIamMember._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [SourceIamMember] resource.
  SourceIamMember.reference(String urn)
    : super(
        'gcp:securitycenter/sourceIamMember:SourceIamMember',
