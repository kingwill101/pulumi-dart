...
import 'v2_organization_mute_config_state.dart';
...
/// }
///
/// resource "gcp_securitycenter_v2organizationmuteconfig" "default" {
///   mute_config_id = "my-config"
///   organization   = "123456789"
///   location       = "global"
///   description    = "My custom Cloud Security Command Center Finding Organization mute Configuration"
...
class V2OrganizationMuteConfig extends pulumi.CustomResource {
  ...
  static V2OrganizationMuteConfig get(
    String name,
    pulumi.Input<String> id, {
    V2OrganizationMuteConfigState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return V2OrganizationMuteConfig._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [V2OrganizationMuteConfig] resource.
  V2OrganizationMuteConfig.reference(String urn)
    : super(
        'gcp:securitycenter/v2OrganizationMuteConfig:V2OrganizationMuteConfig',
