...
class V2FolderSccBigQueryExportState {
  ...
  /// Creates a new [V2FolderSccBigQueryExportState].
  ...
  const V2FolderSccBigQueryExportState({
  ...
  factory V2FolderSccBigQueryExportState.fromMap(Map<String, dynamic> map) {
    return V2FolderSccBigQueryExportState(
