...
import 'source_iam_policy_state.dart';
...
class SourceIamPolicy extends pulumi.CustomResource {
  ...
  /// Creates a new [SourceIamPolicy].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [SourceIamPolicy]. {@macro pulumi_securitycenter_source_iam_policy_source_iam_policy_args_doc}
  ...
  /// Gets an existing [SourceIamPolicy] resource's state with the given [name] and [id].
  static SourceIamPolicy get(
    String name,
    pulumi.Input<String> id, {
    SourceIamPolicyState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return SourceIamPolicy._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [SourceIamPolicy] resource.
  SourceIamPolicy.reference(String urn)
    : super(
        'gcp:securitycenter/sourceIamPolicy:SourceIamPolicy',
