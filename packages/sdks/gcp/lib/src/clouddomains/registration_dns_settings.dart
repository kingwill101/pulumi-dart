...
class RegistrationDnsSettings {
  ...
  factory RegistrationDnsSettings.fromMap(Map<String, dynamic> map) {
    return RegistrationDnsSettings(
      customDns: (() { final guardedValue = map['customDns']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegistrationDnsSettingsCustomDns.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      glueRecords: (() { final guardedValue = map['glueRecords']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RegistrationDnsSettingsGlueRecord>(guardedValue, (value) => RegistrationDnsSettingsGlueRecord.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
