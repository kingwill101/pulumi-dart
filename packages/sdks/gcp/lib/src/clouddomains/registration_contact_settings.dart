...
class RegistrationContactSettings {
  ...
  factory RegistrationContactSettings.fromMap(Map<String, dynamic> map) {
    return RegistrationContactSettings(
      adminContact: pulumi.Input.fromValue(RegistrationContactSettingsAdminContact.fromMap((map['adminContact']! as Map).cast<String, dynamic>())),
      privacy: pulumi.Input.fromValue(map['privacy'] as String),
      registrantContact: pulumi.Input.fromValue(RegistrationContactSettingsRegistrantContact.fromMap((map['registrantContact']! as Map).cast<String, dynamic>())),
      technicalContact: pulumi.Input.fromValue(RegistrationContactSettingsTechnicalContact.fromMap((map['technicalContact']! as Map).cast<String, dynamic>())),
    );
  }
}
