...
class RegistrationContactSettingsRegistrantContactPostalAddress {
  ...
  /// Creates a new [RegistrationContactSettingsRegistrantContactPostalAddress].
  ...
  const RegistrationContactSettingsRegistrantContactPostalAddress({
    this.addressLines,
  ...
  factory RegistrationContactSettingsRegistrantContactPostalAddress.fromMap(Map<String, dynamic> map) {
    return RegistrationContactSettingsRegistrantContactPostalAddress(
