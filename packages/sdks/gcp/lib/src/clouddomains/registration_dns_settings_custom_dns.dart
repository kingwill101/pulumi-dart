...
class RegistrationDnsSettingsCustomDns {
  ...
  factory RegistrationDnsSettingsCustomDns.fromMap(Map<String, dynamic> map) {
    return RegistrationDnsSettingsCustomDns(
      dsRecords: (() { final guardedValue = map['dsRecords']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RegistrationDnsSettingsCustomDnsDsRecord>(guardedValue, (value) => RegistrationDnsSettingsCustomDnsDsRecord.fromMap((value as Map).cast<String, dynamic>()))); })(),
