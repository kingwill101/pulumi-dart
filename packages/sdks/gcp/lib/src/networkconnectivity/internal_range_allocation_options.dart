...
class InternalRangeAllocationOptions {
  ...
  factory InternalRangeAllocationOptions.fromMap(Map<String, dynamic> map) {
    return InternalRangeAllocationOptions(
      ...
      firstAvailableRangesLookupSize: (() { final guardedValue = map['firstAvailableRangesLookupSize']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
    );
  }
}
