...
import 'hub_iam_policy_state.dart';
...
class HubIamPolicy extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [HubIamPolicy]. {@macro pulumi_networkconnectivity_hub_iam_policy_hub_iam_policy_args_doc}
  ...
  /// Gets an existing [HubIamPolicy] resource's state with the given [name] and [id].
  static HubIamPolicy get(
    String name,
    pulumi.Input<String> id, {
    HubIamPolicyState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return HubIamPolicy._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [HubIamPolicy] resource.
  HubIamPolicy.reference(String urn)
    : super(
        'gcp:networkconnectivity/hubIamPolicy:HubIamPolicy',
