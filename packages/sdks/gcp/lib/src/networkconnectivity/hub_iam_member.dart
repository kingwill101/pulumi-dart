...
import 'hub_iam_member_state.dart';
...
class HubIamMember extends pulumi.CustomResource {
  late final pulumi.Output<HubIamMemberCondition?> condition;
  ...
  /// [args] Arguments used to configure this [HubIamMember]. {@macro pulumi_networkconnectivity_hub_iam_member_hub_iam_member_args_doc}
  ...
  HubIamMember(
    ...
    condition = registerOutput<HubIamMemberCondition?>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return HubIamMemberCondition.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [HubIamMember] resource's state with the given [name] and [id].
  static HubIamMember get(
    String name,
    pulumi.Input<String> id, {
    HubIamMemberState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return HubIamMember._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [HubIamMember] resource.
  HubIamMember.reference(String urn)
    : super(
        'gcp:networkconnectivity/hubIamMember:HubIamMember',
