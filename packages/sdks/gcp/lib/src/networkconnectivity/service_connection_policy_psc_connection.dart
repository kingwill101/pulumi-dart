...
class ServiceConnectionPolicyPscConnection {
  ...
  factory ServiceConnectionPolicyPscConnection.fromMap(
    ...
    return ServiceConnectionPolicyPscConnection(
      consumerAddress: (() {
        final guardedValue = map['consumerAddress'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      consumerForwardingRule: (() {
        final guardedValue = map['consumerForwardingRule'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      consumerTargetProject: (() {
        final guardedValue = map['consumerTargetProject'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      error: (() {
      ...
      errorInfo: (() {
        final guardedValue = map['errorInfo'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      gceOperation: (() {
        final guardedValue = map['gceOperation'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      pscConnectionId: (() {
