    ...
    return <String, dynamic>{
      ...
      'linkedInterconnectAttachments':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(linkedInterconnectAttachments, (value) => value.toMap()),
      'linkedProducerVpcNetwork':
          ?pulumi.Input.mapOptionalInputValue<
            SpokeLinkedProducerVpcNetwork,
            Map<String, dynamic>
          >(linkedProducerVpcNetwork, (value) => value.toMap()),
      'linkedRouterApplianceInstances':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'linkedVpcNetwork':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(linkedVpcNetwork, (value) => value.toMap()),
      'linkedVpnTunnels':
          ?pulumi.Input.mapOptionalInputValue<
            SpokeLinkedVpnTunnels,
            Map<String, dynamic>
          >(linkedVpnTunnels, (value) => value.toMap()),
      'location': ?location,
      'name': ?name,
      'project': ?project,
      ...
      'reasons':
          ...
          >(
            reasons,
            (value) =>
                pulumi.Input.encodeList<SpokeReason, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory SpokeState.fromMap(Map<String, dynamic> map) {
    return SpokeState(
      ...
      gateway: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SpokeGateway.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      group: (() {
      ...
      linkedInterconnectAttachments: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SpokeLinkedInterconnectAttachments.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      linkedProducerVpcNetwork: (() {
        final guardedValue = map['linkedProducerVpcNetwork'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SpokeLinkedProducerVpcNetwork.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      linkedRouterApplianceInstances: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SpokeLinkedRouterApplianceInstances.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      linkedVpcNetwork: (() {
        final guardedValue = map['linkedVpcNetwork'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SpokeLinkedVpcNetwork.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      reasons: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SpokeReason>(
            guardedValue,
            (value) =>
                SpokeReason.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      state: (() {
