...
class DestinationState {
  ...
  factory DestinationState.fromMap(Map<String, dynamic> map) {
    return DestinationState(
      ...
      endpoints: (() { final guardedValue = map['endpoints']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DestinationEndpoint>(guardedValue, (value) => DestinationEndpoint.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      multicloudDataTransferConfig: (() { final guardedValue = map['multicloudDataTransferConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      project: (() { final guardedValue = map['project']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      pulumiLabels: (() { final guardedValue = map['pulumiLabels']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      stateTimelines: (() { final guardedValue = map['stateTimelines']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DestinationStateTimeline>(guardedValue, (value) => DestinationStateTimeline.fromMap((value as Map).cast<String, dynamic>()))); })(),
