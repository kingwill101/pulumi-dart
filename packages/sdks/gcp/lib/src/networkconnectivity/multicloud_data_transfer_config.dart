...
class MulticloudDataTransferConfig extends pulumi.CustomResource {
  ...
  MulticloudDataTransferConfig(
    ...
    this.destinationsActiveCount = registerOutput<int>('destinationsActiveCount');
    ...
    this.services = registerOutput<List<MulticloudDataTransferConfigService>?>('services');
    this.uid = registerOutput<String>('uid');
    this.updateTime = registerOutput<String>('updateTime');
  }

  /// Gets an existing [MulticloudDataTransferConfig] resource's state with the given [name] and [id].
  static MulticloudDataTransferConfig get(
    String name,
  ...
  MulticloudDataTransferConfig._get(
    String name, {
