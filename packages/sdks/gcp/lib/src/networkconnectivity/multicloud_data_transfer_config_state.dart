  ...
  factory MulticloudDataTransferConfigState.fromMap(Map<String, dynamic> map) {
    return MulticloudDataTransferConfigState(
      ...
      destinationsActiveCount: (() {
        final guardedValue = map['destinationsActiveCount'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      destinationsCount: (() {
        final guardedValue = map['destinationsCount'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      effectiveLabels: (() {
      ...
      services: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MulticloudDataTransferConfigService>(
            guardedValue,
            (value) => MulticloudDataTransferConfigService.fromMap(
