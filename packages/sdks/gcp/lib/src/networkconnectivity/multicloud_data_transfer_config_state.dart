...
class MulticloudDataTransferConfigState {
  ...
  factory MulticloudDataTransferConfigState.fromMap(Map<String, dynamic> map) {
    return MulticloudDataTransferConfigState(
      ...
      destinationsActiveCount: (() { final guardedValue = map['destinationsActiveCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      destinationsCount: (() { final guardedValue = map['destinationsCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
