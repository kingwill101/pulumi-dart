...
class ServiceConnectionPolicyState {
  ...
  /// Structure is documented below.
  final pulumi.Input<List<ServiceConnectionPolicyPscConnection>>?
  pscConnections;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'pscConnections':
          ?pulumi.Input.mapOptionalInputValue<
            List<ServiceConnectionPolicyPscConnection>,
  ...
  factory ServiceConnectionPolicyState.fromMap(Map<String, dynamic> map) {
    return ServiceConnectionPolicyState(
      ...
      pscConnections: (() {
        final guardedValue = map['pscConnections'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ServiceConnectionPolicyPscConnection>(
            guardedValue,
            (value) => ServiceConnectionPolicyPscConnection.fromMap(
