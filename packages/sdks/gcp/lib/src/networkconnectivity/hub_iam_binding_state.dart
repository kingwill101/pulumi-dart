...
class HubIamBindingState {
  ...
  /// Creates a new [HubIamBindingState].
  /// [condition] Optional.
  ...
  factory HubIamBindingState.fromMap(Map<String, dynamic> map) {
    return HubIamBindingState(
