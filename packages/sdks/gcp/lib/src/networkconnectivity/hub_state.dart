...
class HubState {
  ...
  factory HubState.fromMap(Map<String, dynamic> map) {
    return HubState(
      ...
      routingVpcs: (() { final guardedValue = map['routingVpcs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<HubRoutingVpc>(guardedValue, (value) => HubRoutingVpc.fromMap((value as Map).cast<String, dynamic>()))); })(),
