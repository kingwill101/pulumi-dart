...
import 'regional_endpoint_state.dart';
...
class RegionalEndpoint extends pulumi.CustomResource {
  ...
  /// Gets an existing [RegionalEndpoint] resource's state with the given [name] and [id].
  static RegionalEndpoint get(
    String name,
