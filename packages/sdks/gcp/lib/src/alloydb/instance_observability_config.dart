  ...
  factory InstanceObservabilityConfig.fromMap(Map<String, dynamic> map) {
    return InstanceObservabilityConfig(
      assistiveExperiencesEnabled: (() {
        final guardedValue = map['assistiveExperiencesEnabled'];
      ...
      maxQueryStringLength: (() {
        final guardedValue = map['maxQueryStringLength'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      preserveComments: (() {
        final guardedValue = map['preserveComments'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      queryPlansPerMinute: (() {
      ...
      trackActiveQueries: (() {
        final guardedValue = map['trackActiveQueries'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      trackWaitEventTypes: (() {
        final guardedValue = map['trackWaitEventTypes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      trackWaitEvents: (() {
        final guardedValue = map['trackWaitEvents'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
    );
