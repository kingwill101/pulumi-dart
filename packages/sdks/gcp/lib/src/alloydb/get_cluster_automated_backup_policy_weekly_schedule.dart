...
class GetClusterAutomatedBackupPolicyWeeklySchedule {
  ...
  const GetClusterAutomatedBackupPolicyWeeklySchedule({
  ...
  factory GetClusterAutomatedBackupPolicyWeeklySchedule.fromMap(Map<String, dynamic> map) {
    return GetClusterAutomatedBackupPolicyWeeklySchedule(
      ...
      startTimes: pulumi.Input.fromValue(pulumi.Input.decodeList<GetClusterAutomatedBackupPolicyWeeklyScheduleStartTime>(map['startTimes']!, (value) => GetClusterAutomatedBackupPolicyWeeklyScheduleStartTime.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
