...
class GetInstancePscInstanceConfig {
  ...
  factory GetInstancePscInstanceConfig.fromMap(Map<String, dynamic> map) {
    return GetInstancePscInstanceConfig(
      ...
      pscAutoConnections: (pulumi.Input.decodeList<GetInstancePscInstanceConfigPscAutoConnection>(map['pscAutoConnections'], (value) => GetInstancePscInstanceConfigPscAutoConnection.fromMap((value as Map).cast<String, dynamic>()))).input(),
      pscDnsName: (map['pscDnsName'] as String).input(),
      pscInterfaceConfigs: (pulumi.Input.decodeList<GetInstancePscInstanceConfigPscInterfaceConfig>(map['pscInterfaceConfigs'], (value) => GetInstancePscInstanceConfigPscInterfaceConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
      serviceAttachmentLink: (map['serviceAttachmentLink'] as String).input(),
    );
  }
}
