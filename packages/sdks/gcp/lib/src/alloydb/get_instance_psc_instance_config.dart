...
class GetInstancePscInstanceConfig {
  ...
  final pulumi.Input<List<GetInstancePscInstanceConfigPscAutoConnection>>
  pscAutoConnections;
  ...
  final pulumi.Input<List<GetInstancePscInstanceConfigPscInterfaceConfig>>
  pscInterfaceConfigs;
    ...
    return <String, dynamic>{
      ...
      'pscAutoConnections':
          pulumi.Input.mapInputValue<
            List<GetInstancePscInstanceConfigPscAutoConnection>,
      ...
      'pscInterfaceConfigs':
          pulumi.Input.mapInputValue<
            List<GetInstancePscInstanceConfigPscInterfaceConfig>,
            List<Map<String, dynamic>>
          >(
            pscInterfaceConfigs,
            (value) =>
  ...
  factory GetInstancePscInstanceConfig.fromMap(Map<String, dynamic> map) {
    return GetInstancePscInstanceConfig(
      ...
      pscAutoConnections: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetInstancePscInstanceConfigPscAutoConnection>(
      ...
      pscInterfaceConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetInstancePscInstanceConfigPscInterfaceConfig>(
      ...
      serviceAttachmentLink: pulumi.Input.fromValue(
