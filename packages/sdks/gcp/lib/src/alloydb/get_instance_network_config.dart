...
class GetInstanceNetworkConfig {
  ...
  factory GetInstanceNetworkConfig.fromMap(Map<String, dynamic> map) {
    return GetInstanceNetworkConfig(
      allocatedIpRangeOverride: (map['allocatedIpRangeOverride'] as String).input(),
      authorizedExternalNetworks: (pulumi.Input.decodeList<GetInstanceNetworkConfigAuthorizedExternalNetwork>(map['authorizedExternalNetworks'], (value) => GetInstanceNetworkConfigAuthorizedExternalNetwork.fromMap((value as Map).cast<String, dynamic>()))).input(),
      enableOutboundPublicIp: (map['enableOutboundPublicIp'] as bool).input(),
      enablePublicIp: (map['enablePublicIp'] as bool).input(),
    );
  }
}
