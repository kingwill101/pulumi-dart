...
class GetInstanceNetworkConfig {
  ...
  /// true.
  final pulumi.Input<List<GetInstanceNetworkConfigAuthorizedExternalNetwork>> authorizedExternalNetworks;
  ...
  const GetInstanceNetworkConfig({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'authorizedExternalNetworks': pulumi.Input.mapInputValue<List<GetInstanceNetworkConfigAuthorizedExternalNetwork>, List<Map<String, dynamic>>>(authorizedExternalNetworks, (value) => pulumi.Input.encodeList<GetInstanceNetworkConfigAuthorizedExternalNetwork, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory GetInstanceNetworkConfig.fromMap(Map<String, dynamic> map) {
    return GetInstanceNetworkConfig(
      allocatedIpRangeOverride: pulumi.Input.fromValue(map['allocatedIpRangeOverride'] as String),
      authorizedExternalNetworks: pulumi.Input.fromValue(pulumi.Input.decodeList<GetInstanceNetworkConfigAuthorizedExternalNetwork>(map['authorizedExternalNetworks']!, (value) => GetInstanceNetworkConfigAuthorizedExternalNetwork.fromMap((value as Map).cast<String, dynamic>()))),
      enableOutboundPublicIp: pulumi.Input.fromValue(map['enableOutboundPublicIp'] as bool),
