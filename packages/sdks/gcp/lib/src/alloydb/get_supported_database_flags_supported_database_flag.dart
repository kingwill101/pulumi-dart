...
class GetSupportedDatabaseFlagsSupportedDatabaseFlag {
    ...
    return <String, dynamic>{
      ...
      'integerRestrictions':
          pulumi.Input.mapInputValue<
            GetSupportedDatabaseFlagsSupportedDatabaseFlagIntegerRestrictions,
            Map<String, dynamic>
          >(integerRestrictions, (value) => value.toMap()),
      'name': name,
      ...
      'stringRestrictions':
          pulumi.Input.mapInputValue<
            GetSupportedDatabaseFlagsSupportedDatabaseFlagStringRestrictions,
            Map<String, dynamic>
          >(stringRestrictions, (value) => value.toMap()),
  ...
  factory GetSupportedDatabaseFlagsSupportedDatabaseFlag.fromMap(
    ...
    return GetSupportedDatabaseFlagsSupportedDatabaseFlag(
      acceptsMultipleValues: pulumi.Input.fromValue(
        map['acceptsMultipleValues'] as bool,
      ),
      flagName: pulumi.Input.fromValue(map['flagName'] as String),
      integerRestrictions: pulumi.Input.fromValue(
        GetSupportedDatabaseFlagsSupportedDatabaseFlagIntegerRestrictions.fromMap(
          (map['integerRestrictions']! as Map).cast<String, dynamic>(),
        ),
      ),
      name: pulumi.Input.fromValue(map['name'] as String),
      requiresDbRestart: pulumi.Input.fromValue(
        map['requiresDbRestart'] as bool,
      ),
      stringRestrictions: pulumi.Input.fromValue(
        GetSupportedDatabaseFlagsSupportedDatabaseFlagStringRestrictions.fromMap(
          (map['stringRestrictions']! as Map).cast<String, dynamic>(),
        ),
      ),
      supportedDbVersions: pulumi.Input.fromValue(
        (map['supportedDbVersions'] as List).cast<String>(),
      ),
