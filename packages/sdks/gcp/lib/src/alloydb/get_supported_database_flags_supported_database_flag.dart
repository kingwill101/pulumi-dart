...
class GetSupportedDatabaseFlagsSupportedDatabaseFlag {
  ...
  factory GetSupportedDatabaseFlagsSupportedDatabaseFlag.fromMap(Map<String, dynamic> map) {
    return GetSupportedDatabaseFlagsSupportedDatabaseFlag(
      acceptsMultipleValues: (map['acceptsMultipleValues'] as bool).input(),
      flagName: (map['flagName'] as String).input(),
      integerRestrictions: (GetSupportedDatabaseFlagsSupportedDatabaseFlagIntegerRestrictions.fromMap((map['integerRestrictions'] as Map).cast<String, dynamic>())).input(),
      name: (map['name'] as String).input(),
      requiresDbRestart: (map['requiresDbRestart'] as bool).input(),
      stringRestrictions: (GetSupportedDatabaseFlagsSupportedDatabaseFlagStringRestrictions.fromMap((map['stringRestrictions'] as Map).cast<String, dynamic>())).input(),
      supportedDbVersions: ((map['supportedDbVersions'] as List).cast<String>()).input(),
