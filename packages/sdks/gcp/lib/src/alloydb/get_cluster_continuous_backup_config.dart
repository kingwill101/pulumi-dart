...
class GetClusterContinuousBackupConfig {
  ...
  final pulumi.Input<List<GetClusterContinuousBackupConfigEncryptionConfig>>
  encryptionConfigs;
    ...
    return <String, dynamic>{
      ...
      'encryptionConfigs':
          pulumi.Input.mapInputValue<
            List<GetClusterContinuousBackupConfigEncryptionConfig>,
  ...
  factory GetClusterContinuousBackupConfig.fromMap(Map<String, dynamic> map) {
    return GetClusterContinuousBackupConfig(
      ...
      recoveryWindowDays: pulumi.Input.fromValue(
