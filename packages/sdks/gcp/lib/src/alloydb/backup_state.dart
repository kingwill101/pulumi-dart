...
class BackupState {
  ...
  factory BackupState.fromMap(Map<String, dynamic> map) {
    return BackupState(
      ...
      clusterUid: (() {
        final guardedValue = map['clusterUid'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      createTime: (() {
      ...
      encryptionConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          BackupEncryptionConfig.fromMap(
      ...
      encryptionInfos: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<BackupEncryptionInfo>(
            guardedValue,
            (value) => BackupEncryptionInfo.fromMap(
      ...
      expiryQuantities: (() {
        final guardedValue = map['expiryQuantities'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<BackupExpiryQuantity>(
            guardedValue,
            (value) => BackupExpiryQuantity.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
