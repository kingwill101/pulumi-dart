...
class ClusterAutomatedBackupPolicy {
  ...
  final pulumi.Input<ClusterAutomatedBackupPolicyEncryptionConfig>?
  encryptionConfig;
  ...
  /// Structure is documented below.
  final pulumi.Input<ClusterAutomatedBackupPolicyQuantityBasedRetention>?
  quantityBasedRetention;

  /// Time-based Backup retention policy. Conflicts with 'quantity_based_retention', both can't be set together.
  /// Structure is documented below.
  final pulumi.Input<ClusterAutomatedBackupPolicyTimeBasedRetention>?
  timeBasedRetention;

  /// Weekly schedule for the Backup.
  /// Structure is documented below.
  final pulumi.Input<ClusterAutomatedBackupPolicyWeeklySchedule>?
  weeklySchedule;
