...
class ClusterContinuousBackupInfo {
  ...
  final pulumi.Input<List<ClusterContinuousBackupInfoEncryptionInfo>>?
  encryptionInfos;
    ...
    return <String, dynamic>{
      ...
      'encryptionInfos':
          ?pulumi.Input.mapOptionalInputValue<
            List<ClusterContinuousBackupInfoEncryptionInfo>,
  ...
  factory ClusterContinuousBackupInfo.fromMap(Map<String, dynamic> map) {
    return ClusterContinuousBackupInfo(
      earliestRestorableTime: (() {
        final guardedValue = map['earliestRestorableTime'];
