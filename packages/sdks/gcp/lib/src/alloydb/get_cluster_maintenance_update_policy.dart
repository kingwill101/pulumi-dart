...
class GetClusterMaintenanceUpdatePolicy {
  ...
  factory GetClusterMaintenanceUpdatePolicy.fromMap(Map<String, dynamic> map) {
    return GetClusterMaintenanceUpdatePolicy(
      maintenanceWindows: (pulumi.Input.decodeList<GetClusterMaintenanceUpdatePolicyMaintenanceWindow>(map['maintenanceWindows'], (value) => GetClusterMaintenanceUpdatePolicyMaintenanceWindow.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
