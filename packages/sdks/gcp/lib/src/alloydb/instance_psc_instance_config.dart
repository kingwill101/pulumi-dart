...
class InstancePscInstanceConfig {
  ...
  final pulumi.Input<List<InstancePscInstanceConfigPscAutoConnection>>?
  pscAutoConnections;
  ...
  /// Structure is documented below.
  final pulumi.Input<List<InstancePscInstanceConfigPscInterfaceConfig>>?
  pscInterfaceConfigs;
    ...
    return <String, dynamic>{
      ...
      'pscAutoConnections':
          ?pulumi.Input.mapOptionalInputValue<
            List<InstancePscInstanceConfigPscAutoConnection>,
      ...
      'pscInterfaceConfigs':
          ?pulumi.Input.mapOptionalInputValue<
            List<InstancePscInstanceConfigPscInterfaceConfig>,
            List<Map<String, dynamic>>
          >(
            pscInterfaceConfigs,
            (value) =>
  ...
  factory InstancePscInstanceConfig.fromMap(Map<String, dynamic> map) {
    return InstancePscInstanceConfig(
      ...
      pscDnsName: (() {
        final guardedValue = map['pscDnsName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      pscInterfaceConfigs: (() {
        final guardedValue = map['pscInterfaceConfigs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InstancePscInstanceConfigPscInterfaceConfig>(
            guardedValue,
      ...
      serviceAttachmentLink: (() {
        final guardedValue = map['serviceAttachmentLink'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
