...
class GetServicePrincipalsServicePrincipal {
  ...
  factory GetServicePrincipalsServicePrincipal.fromMap(
    Map<String, dynamic> map,
  ) {
    return GetServicePrincipalsServicePrincipal(
      accountEnabled: pulumi.Input.fromValue(map['accountEnabled'] as bool),
      appRoleAssignmentRequired: pulumi.Input.fromValue(
        map['appRoleAssignmentRequired'] as bool,
      ),
      applicationTenantId: pulumi.Input.fromValue(
        map['applicationTenantId'] as String,
      ),
      clientId: pulumi.Input.fromValue(map['clientId'] as String),
      displayName: pulumi.Input.fromValue(map['displayName'] as String),
      objectId: pulumi.Input.fromValue(map['objectId'] as String),
      preferredSingleSignOnMode: pulumi.Input.fromValue(
        map['preferredSingleSignOnMode'] as String,
      ),
      samlMetadataUrl: pulumi.Input.fromValue(map['samlMetadataUrl'] as String),
      servicePrincipalNames: pulumi.Input.fromValue(
        (map['servicePrincipalNames'] as List).cast<String>(),
      ),
