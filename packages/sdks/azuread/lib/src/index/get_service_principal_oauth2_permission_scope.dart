...
class GetServicePrincipalOauth2PermissionScope {
  ...
  factory GetServicePrincipalOauth2PermissionScope.fromMap(
    Map<String, dynamic> map,
  ) {
    return GetServicePrincipalOauth2PermissionScope(
      adminConsentDescription: pulumi.Input.fromValue(
        map['adminConsentDescription'] as String,
      ),
      adminConsentDisplayName: pulumi.Input.fromValue(
        map['adminConsentDisplayName'] as String,
      ),
      enabled: pulumi.Input.fromValue(map['enabled'] as bool),
      id: pulumi.Input.fromValue(map['id'] as String),
      type: pulumi.Input.fromValue(map['type'] as String),
      userConsentDescription: pulumi.Input.fromValue(
        map['userConsentDescription'] as String,
      ),
      userConsentDisplayName: pulumi.Input.fromValue(
        map['userConsentDisplayName'] as String,
      ),
