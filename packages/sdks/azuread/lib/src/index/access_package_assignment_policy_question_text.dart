...
class AccessPackageAssignmentPolicyQuestionText {
  ...
  final pulumi.Input<
    List<AccessPackageAssignmentPolicyQuestionTextLocalizedText>
  >?
  localizedTexts;
  ...
  factory AccessPackageAssignmentPolicyQuestionText.fromMap(
      ...
      localizedTexts: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                AccessPackageAssignmentPolicyQuestionTextLocalizedText.fromMap(
