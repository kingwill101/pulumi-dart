...
class GroupWithoutMembersState {
  ...
  GroupWithoutMembersState({
    ...
    pulumi.Output<GroupWithoutMembersDynamicMembership>? dynamicMembership,
  ...
  factory GroupWithoutMembersState.fromMap(Map<String, dynamic> map) {
    return GroupWithoutMembersState(
      ...
      dynamicMembership: map['dynamicMembership'] == null ? null : pulumi.Output.create<GroupWithoutMembersDynamicMembership>(GroupWithoutMembersDynamicMembership.fromMap((map['dynamicMembership'] as Map).cast<String, dynamic>())),
