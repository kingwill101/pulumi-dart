...
class UserState {
  ...
  factory UserState.fromMap(Map<String, dynamic> map) {
    return UserState(
      aboutMe: map['aboutMe'] == null ? null : (map['aboutMe'] as String).input(),
      accountEnabled: map['accountEnabled'] == null ? null : (map['accountEnabled'] as bool).input(),
      ageGroup: map['ageGroup'] == null ? null : (map['ageGroup'] as String).input(),
      businessPhones: map['businessPhones'] == null ? null : ((map['businessPhones'] as List).cast<String>()).input(),
      city: map['city'] == null ? null : (map['city'] as String).input(),
      companyName: map['companyName'] == null ? null : (map['companyName'] as String).input(),
      consentProvidedForMinor: map['consentProvidedForMinor'] == null ? null : (map['consentProvidedForMinor'] as String).input(),
      costCenter: map['costCenter'] == null ? null : (map['costCenter'] as String).input(),
      country: map['country'] == null ? null : (map['country'] as String).input(),
      creationType: map['creationType'] == null ? null : (map['creationType'] as String).input(),
      department: map['department'] == null ? null : (map['department'] as String).input(),
      disablePasswordExpiration: map['disablePasswordExpiration'] == null ? null : (map['disablePasswordExpiration'] as bool).input(),
      disableStrongPassword: map['disableStrongPassword'] == null ? null : (map['disableStrongPassword'] as bool).input(),
      displayName: map['displayName'] == null ? null : (map['displayName'] as String).input(),
      division: map['division'] == null ? null : (map['division'] as String).input(),
      employeeHireDate: map['employeeHireDate'] == null ? null : (map['employeeHireDate'] as String).input(),
      employeeId: map['employeeId'] == null ? null : (map['employeeId'] as String).input(),
      employeeType: map['employeeType'] == null ? null : (map['employeeType'] as String).input(),
      externalUserState: map['externalUserState'] == null ? null : (map['externalUserState'] as String).input(),
      faxNumber: map['faxNumber'] == null ? null : (map['faxNumber'] as String).input(),
      forcePasswordChange: map['forcePasswordChange'] == null ? null : (map['forcePasswordChange'] as bool).input(),
      givenName: map['givenName'] == null ? null : (map['givenName'] as String).input(),
      imAddresses: map['imAddresses'] == null ? null : ((map['imAddresses'] as List).cast<String>()).input(),
      ...
      managerId: map['managerId'] == null ? null : (map['managerId'] as String).input(),
      mobilePhone: map['mobilePhone'] == null ? null : (map['mobilePhone'] as String).input(),
      objectId: map['objectId'] == null ? null : (map['objectId'] as String).input(),
      officeLocation: map['officeLocation'] == null ? null : (map['officeLocation'] as String).input(),
      onpremisesDistinguishedName: map['onpremisesDistinguishedName'] == null ? null : (map['onpremisesDistinguishedName'] as String).input(),
      onpremisesDomainName: map['onpremisesDomainName'] == null ? null : (map['onpremisesDomainName'] as String).input(),
      onpremisesImmutableId: map['onpremisesImmutableId'] == null ? null : (map['onpremisesImmutableId'] as String).input(),
      ...
      onpremisesUserPrincipalName: map['onpremisesUserPrincipalName'] == null ? null : (map['onpremisesUserPrincipalName'] as String).input(),
      otherMails: map['otherMails'] == null ? null : ((map['otherMails'] as List).cast<String>()).input(),
      ...
      showInAddressList: map['showInAddressList'] == null ? null : (map['showInAddressList'] as bool).input(),
      ...
      usageLocation: map['usageLocation'] == null ? null : (map['usageLocation'] as String).input(),
