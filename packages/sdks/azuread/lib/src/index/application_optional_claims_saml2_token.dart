...
class ApplicationOptionalClaimsSaml2Token {
  ...
  /// Creates a new [ApplicationOptionalClaimsSaml2Token].
  ...
  const ApplicationOptionalClaimsSaml2Token({
  ...
  factory ApplicationOptionalClaimsSaml2Token.fromMap(Map<String, dynamic> map) {
    return ApplicationOptionalClaimsSaml2Token(
