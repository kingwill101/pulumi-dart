...
class GetApplicationPublishedAppIdsResult {
  ...
  GetApplicationPublishedAppIdsResult({required this.id, required this.result});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'id': id, 'result': result};
  }

  factory GetApplicationPublishedAppIdsResult.fromMap(
