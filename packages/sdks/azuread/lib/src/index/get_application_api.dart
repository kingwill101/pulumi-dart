...
class GetApplicationApi {
  ...
  final pulumi.Input<List<GetApplicationApiOauth2PermissionScope>>
    ...
    return <String, dynamic>{
      ...
      'oauth2PermissionScopes':
          pulumi.Input.mapInputValue<
            List<GetApplicationApiOauth2PermissionScope>,
  ...
  factory GetApplicationApi.fromMap(Map<String, dynamic> map) {
    return GetApplicationApi(
      knownClientApplications: pulumi.Input.fromValue(
        (map['knownClientApplications'] as List).cast<String>(),
      ),
      mappedClaimsEnabled: pulumi.Input.fromValue(
        map['mappedClaimsEnabled'] as bool,
      ),
      oauth2PermissionScopes: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetApplicationApiOauth2PermissionScope>(
          map['oauth2PermissionScopes']!,
          (value) => GetApplicationApiOauth2PermissionScope.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      requestedAccessTokenVersion: pulumi.Input.fromValue(
        map['requestedAccessTokenVersion'] as int,
      ),
    );
  }
}
