...
import 'application_flexible_federated_identity_credential_state.dart';
...
class ApplicationFlexibleFederatedIdentityCredential
  ...
  static ApplicationFlexibleFederatedIdentityCredential get(
    String name,
  ...
  ApplicationFlexibleFederatedIdentityCredential._get(
    String name, {
