...
class GetApplicationWebImplicitGrant {
  ...
  factory GetApplicationWebImplicitGrant.fromMap(Map<String, dynamic> map) {
    return GetApplicationWebImplicitGrant(
      accessTokenIssuanceEnabled: pulumi.Input.fromValue(
        map['accessTokenIssuanceEnabled'] as bool,
      ),
      idTokenIssuanceEnabled: pulumi.Input.fromValue(
        map['idTokenIssuanceEnabled'] as bool,
      ),
    );
  }
}
