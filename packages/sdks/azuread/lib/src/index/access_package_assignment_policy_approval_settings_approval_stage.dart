...
class AccessPackageAssignmentPolicyApprovalSettingsApprovalStage {
  ...
  factory AccessPackageAssignmentPolicyApprovalSettingsApprovalStage.fromMap(Map<String, dynamic> map) {
    return AccessPackageAssignmentPolicyApprovalSettingsApprovalStage(
      ...
      approvalTimeoutInDays: pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(map['approvalTimeoutInDays'])),
      ...
      enableAlternativeApprovalInDays: (() { final guardedValue = map['enableAlternativeApprovalInDays']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
