...
class ApplicationApiAccessState {
  ...
  factory ApplicationApiAccessState.fromMap(Map<String, dynamic> map) {
    return ApplicationApiAccessState(
      apiClientId: (() { final guardedValue = map['apiClientId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      applicationId: (() { final guardedValue = map['applicationId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      roleIds: (() { final guardedValue = map['roleIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      scopeIds: (() { final guardedValue = map['scopeIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
    );
  }
}
