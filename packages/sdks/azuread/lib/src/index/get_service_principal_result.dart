...
class GetServicePrincipalResult {
    ...
    return <String, dynamic>{
      ...
      'oauth2PermissionScopes':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(oauth2PermissionScopes, (value) => value.toMap()),
      'objectId': objectId,
      ...
      'samlSingleSignOns':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(samlSingleSignOns, (value) => value.toMap()),
  ...
  factory GetServicePrincipalResult.fromMap(Map<String, dynamic> map) {
    return GetServicePrincipalResult(
      ...
      appRoles: pulumi.Input.decodeList<GetServicePrincipalAppRole>(
        map['appRoles']!,
        (value) => GetServicePrincipalAppRole.fromMap(
      ...
      featureTags: pulumi.Input.decodeList<GetServicePrincipalFeatureTag>(
        map['featureTags']!,
        (value) => GetServicePrincipalFeatureTag.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      features: pulumi.Input.decodeList<GetServicePrincipalFeature>(
        map['features']!,
        (value) => GetServicePrincipalFeature.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      ...
      notificationEmailAddresses: (map['notificationEmailAddresses'] as List)
          .cast<String>(),
      oauth2PermissionScopeIds: (map['oauth2PermissionScopeIds'] as Map)
          .cast<String, String>(),
      oauth2PermissionScopes:
          pulumi.Input.decodeList<GetServicePrincipalOauth2PermissionScope>(
            map['oauth2PermissionScopes']!,
            (value) => GetServicePrincipalOauth2PermissionScope.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      ...
      samlSingleSignOns:
          pulumi.Input.decodeList<GetServicePrincipalSamlSingleSignOn>(
            map['samlSingleSignOns']!,
            (value) => GetServicePrincipalSamlSingleSignOn.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      servicePrincipalNames: (map['servicePrincipalNames'] as List)
          .cast<String>(),
