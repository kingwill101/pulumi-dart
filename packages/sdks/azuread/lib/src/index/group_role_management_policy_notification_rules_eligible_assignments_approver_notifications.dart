...
class GroupRoleManagementPolicyNotificationRulesEligibleAssignmentsApproverNotifications {
  ...
  /// Creates a new [GroupRoleManagementPolicyNotificationRulesEligibleAssignmentsApproverNotifications].
  ...
  const GroupRoleManagementPolicyNotificationRulesEligibleAssignmentsApproverNotifications({
  ...
  factory GroupRoleManagementPolicyNotificationRulesEligibleAssignmentsApproverNotifications.fromMap(Map<String, dynamic> map) {
    return GroupRoleManagementPolicyNotificationRulesEligibleAssignmentsApproverNotifications(
