...
class ConditionalAccessPolicyGrantControls {
  ...
  factory ConditionalAccessPolicyGrantControls.fromMap(
    Map<String, dynamic> map,
  ) {
    return ConditionalAccessPolicyGrantControls(
      authenticationStrengthPolicyId: (() {
        final guardedValue = map['authenticationStrengthPolicyId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      builtInControls: (() {
        final guardedValue = map['builtInControls'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      customAuthenticationFactors: (() {
        final guardedValue = map['customAuthenticationFactors'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      operator: pulumi.Input.fromValue(map['operator'] as String),
      termsOfUses: (() {
        final guardedValue = map['termsOfUses'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
    );
