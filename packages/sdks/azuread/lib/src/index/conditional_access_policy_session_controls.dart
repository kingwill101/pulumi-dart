...
class ConditionalAccessPolicySessionControls {
  ...
  factory ConditionalAccessPolicySessionControls.fromMap(
    Map<String, dynamic> map,
  ) {
    return ConditionalAccessPolicySessionControls(
      applicationEnforcedRestrictionsEnabled: (() {
        final guardedValue = map['applicationEnforcedRestrictionsEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      cloudAppSecurityPolicy: (() {
        final guardedValue = map['cloudAppSecurityPolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      disableResilienceDefaults: (() {
        final guardedValue = map['disableResilienceDefaults'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      persistentBrowserMode: (() {
        final guardedValue = map['persistentBrowserMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      signInFrequency: (() {
        final guardedValue = map['signInFrequency'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      signInFrequencyAuthenticationType: (() {
        final guardedValue = map['signInFrequencyAuthenticationType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      signInFrequencyInterval: (() {
        final guardedValue = map['signInFrequencyInterval'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      signInFrequencyPeriod: (() {
        final guardedValue = map['signInFrequencyPeriod'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
