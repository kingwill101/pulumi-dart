...
class ServicePrincipalDelegatedPermissionGrantArgs {
  ...
  factory ServicePrincipalDelegatedPermissionGrantArgs.fromMap(
    Map<String, dynamic> map,
  ) {
    return ServicePrincipalDelegatedPermissionGrantArgs(
      claimValues: pulumi.Input.fromValue(
        (map['claimValues'] as List).cast<String>(),
      ),
      resourceServicePrincipalObjectId: pulumi.Input.fromValue(
        map['resourceServicePrincipalObjectId'] as String,
      ),
      servicePrincipalObjectId: pulumi.Input.fromValue(
        map['servicePrincipalObjectId'] as String,
      ),
      userObjectId: (() {
