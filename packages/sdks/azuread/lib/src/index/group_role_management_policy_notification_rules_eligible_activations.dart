...
class GroupRoleManagementPolicyNotificationRulesEligibleActivations {
  ...
  factory GroupRoleManagementPolicyNotificationRulesEligibleActivations.fromMap(
    ...
    return GroupRoleManagementPolicyNotificationRulesEligibleActivations(
      adminNotifications: (() {
        ...
        return pulumi.Input.fromValue(
          GroupRoleManagementPolicyNotificationRulesEligibleActivationsAdminNotifications.fromMap(
      ...
      approverNotifications: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GroupRoleManagementPolicyNotificationRulesEligibleActivationsApproverNotifications.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      assigneeNotifications: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GroupRoleManagementPolicyNotificationRulesEligibleActivationsAssigneeNotifications.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
