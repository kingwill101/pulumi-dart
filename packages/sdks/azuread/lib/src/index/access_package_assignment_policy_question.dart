...
class AccessPackageAssignmentPolicyQuestion {
  ...
  final pulumi.Input<List<AccessPackageAssignmentPolicyQuestionChoice>>?
  choices;
    ...
    return <String, dynamic>{
      'choices':
          ?pulumi.Input.mapOptionalInputValue<
            List<AccessPackageAssignmentPolicyQuestionChoice>,
  ...
  factory AccessPackageAssignmentPolicyQuestion.fromMap(
    Map<String, dynamic> map,
  ) {
    return AccessPackageAssignmentPolicyQuestion(
      choices: (() {
        final guardedValue = map['choices'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AccessPackageAssignmentPolicyQuestionChoice>(
            guardedValue,
            (value) => AccessPackageAssignmentPolicyQuestionChoice.fromMap(
      ...
      text: pulumi.Input.fromValue(
        AccessPackageAssignmentPolicyQuestionText.fromMap(
