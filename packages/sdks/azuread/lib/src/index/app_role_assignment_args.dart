...
class AppRoleAssignmentArgs {
  ...
  AppRoleAssignmentArgs({
    required pulumi.Output<String> appRoleId,
    required pulumi.Output<String> principalObjectId,
    required pulumi.Output<String> resourceObjectId,
  }) :
      appRoleId = pulumi.Input.asInput<String>(appRoleId),
      principalObjectId = pulumi.Input.asInput<String>(principalObjectId),
      resourceObjectId = pulumi.Input.asInput<String>(resourceObjectId);
  ...
  factory AppRoleAssignmentArgs.fromMap(Map<String, dynamic> map) {
    return AppRoleAssignmentArgs(
      appRoleId: pulumi.Output.create<String>(map['appRoleId'] as String),
      principalObjectId: pulumi.Output.create<String>(map['principalObjectId'] as String),
      resourceObjectId: pulumi.Output.create<String>(map['resourceObjectId'] as String),
    );
  }
}
