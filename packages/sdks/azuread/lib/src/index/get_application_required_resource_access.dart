...
class GetApplicationRequiredResourceAccess {
  ...
  factory GetApplicationRequiredResourceAccess.fromMap(Map<String, dynamic> map) {
    return GetApplicationRequiredResourceAccess(
      resourceAccesses: pulumi.Input.fromValue(pulumi.Input.decodeList<GetApplicationRequiredResourceAccessResourceAccess>(map['resourceAccesses']!, (value) => GetApplicationRequiredResourceAccessResourceAccess.fromMap((value as Map).cast<String, dynamic>()))),
