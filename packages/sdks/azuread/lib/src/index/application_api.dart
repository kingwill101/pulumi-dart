...
class ApplicationApi {
  ...
  final pulumi.Input<List<ApplicationApiOauth2PermissionScope>>?
    ...
    return <String, dynamic>{
      ...
      'oauth2PermissionScopes':
          ?pulumi.Input.mapOptionalInputValue<
            List<ApplicationApiOauth2PermissionScope>,
  ...
  factory ApplicationApi.fromMap(Map<String, dynamic> map) {
    return ApplicationApi(
      knownClientApplications: (() {
        final guardedValue = map['knownClientApplications'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      mappedClaimsEnabled: (() {
        final guardedValue = map['mappedClaimsEnabled'];
        if (guardedValue == null) return null;
      ...
      oauth2PermissionScopes: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ApplicationApiOauth2PermissionScope>(
            guardedValue,
            (value) => ApplicationApiOauth2PermissionScope.fromMap(
