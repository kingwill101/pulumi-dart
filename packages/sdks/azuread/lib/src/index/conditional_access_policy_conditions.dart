...
class ConditionalAccessPolicyConditions {
  ...
  final pulumi.Input<ConditionalAccessPolicyConditionsApplications>
  applications;
  ...
  final pulumi.Input<ConditionalAccessPolicyConditionsClientApplications>?
  clientApplications;
    ...
    return <String, dynamic>{
      ...
      'clientApplications':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(clientApplications, (value) => value.toMap()),
      'devices':
          ?pulumi.Input.mapOptionalInputValue<
  ...
  factory ConditionalAccessPolicyConditions.fromMap(Map<String, dynamic> map) {
    return ConditionalAccessPolicyConditions(
      applications: pulumi.Input.fromValue(
        ConditionalAccessPolicyConditionsApplications.fromMap(
          (map['applications']! as Map).cast<String, dynamic>(),
        ),
      ),
      authenticationFlowTransferMethods: (() {
        final guardedValue = map['authenticationFlowTransferMethods'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      clientAppTypes: pulumi.Input.fromValue(
        (map['clientAppTypes'] as List).cast<String>(),
      ),
      clientApplications: (() {
        final guardedValue = map['clientApplications'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ConditionalAccessPolicyConditionsClientApplications.fromMap(
      ...
      devices: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ConditionalAccessPolicyConditionsDevices.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      insiderRiskLevels: (() {
        final guardedValue = map['insiderRiskLevels'];
        if (guardedValue == null) return null;
      ...
      locations: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ConditionalAccessPolicyConditionsLocations.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      platforms: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ConditionalAccessPolicyConditionsPlatforms.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      servicePrincipalRiskLevels: (() {
        final guardedValue = map['servicePrincipalRiskLevels'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      signInRiskLevels: (() {
        final guardedValue = map['signInRiskLevels'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      userRiskLevels: (() {
        final guardedValue = map['userRiskLevels'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      users: pulumi.Input.fromValue(
        ConditionalAccessPolicyConditionsUsers.fromMap(
          (map['users']! as Map).cast<String, dynamic>(),
        ),
      ),
    );
  }
