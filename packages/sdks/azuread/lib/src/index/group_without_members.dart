...
import 'group_without_members_args.dart';
import 'group_without_members_dynamic_membership.dart';
import 'group_without_members_state.dart';
...
/// }
///
/// resource "azuread_groupwithoutmembers" "example" {
///   display_name     = "example"
...
class GroupWithoutMembers extends pulumi.CustomResource {
  ...
  late final pulumi.Output<GroupWithoutMembersDynamicMembership?> dynamicMembership;
  ...
  /// Creates a new [GroupWithoutMembers].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [GroupWithoutMembers]. {@macro pulumi_index_group_without_members_group_without_members_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  GroupWithoutMembers(
    String name, {
    GroupWithoutMembersArgs? args,
    ...
    dynamicMembership = registerOutput<GroupWithoutMembersDynamicMembership?>('dynamicMembership', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return GroupWithoutMembersDynamicMembership.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [GroupWithoutMembers] resource's state with the given [name] and [id].
  static GroupWithoutMembers get(
    String name,
    pulumi.Input<String> id, {
    GroupWithoutMembersState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return GroupWithoutMembers._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [GroupWithoutMembers] resource.
  GroupWithoutMembers.reference(String urn)
    : super(
        'azuread:index/groupWithoutMembers:GroupWithoutMembers',
