...
import 'directory_role_eligibility_schedule_request_state.dart';
...
class DirectoryRoleEligibilityScheduleRequest extends pulumi.CustomResource {
  ...
  static DirectoryRoleEligibilityScheduleRequest get(
    String name,
  ...
  DirectoryRoleEligibilityScheduleRequest._get(
    String name, {
