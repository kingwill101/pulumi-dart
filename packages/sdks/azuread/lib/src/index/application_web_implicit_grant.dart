...
class ApplicationWebImplicitGrant {
  ...
  const ApplicationWebImplicitGrant({
  ...
  factory ApplicationWebImplicitGrant.fromMap(Map<String, dynamic> map) {
    return ApplicationWebImplicitGrant(
      accessTokenIssuanceEnabled: (() { final guardedValue = map['accessTokenIssuanceEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      idTokenIssuanceEnabled: (() { final guardedValue = map['idTokenIssuanceEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
    );
  }
}
