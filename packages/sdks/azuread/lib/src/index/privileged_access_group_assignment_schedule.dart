...
import 'privileged_access_group_assignment_schedule_args.dart';
import 'privileged_access_group_assignment_schedule_state.dart';
...
class PrivilegedAccessGroupAssignmentSchedule extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [PrivilegedAccessGroupAssignmentSchedule]. {@macro pulumi_index_privileged_access_group_assignment_schedule_privileged_access_group_assignment_schedule_args_doc}
  ...
  /// Gets an existing [PrivilegedAccessGroupAssignmentSchedule] resource's state with the given [name] and [id].
  static PrivilegedAccessGroupAssignmentSchedule get(
    String name,
  ...
  PrivilegedAccessGroupAssignmentSchedule._get(
    String name, {
