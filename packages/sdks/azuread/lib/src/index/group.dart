...
class Group extends pulumi.CustomResource {
  ...
  Group(
    ...
    this.administrativeUnitIds = registerOutput<List<String>?>('administrativeUnitIds');
    this.assignableToRole = registerOutput<bool?>('assignableToRole');
    this.autoSubscribeNewMembers = registerOutput<bool>('autoSubscribeNewMembers');
    this.behaviors = registerOutput<List<String>?>('behaviors');
    this.description = registerOutput<String?>('description');
    this.displayName = registerOutput<String>('displayName');
    this.dynamicMembership = registerOutput<GroupDynamicMembership?>('dynamicMembership');
    this.externalSendersAllowed = registerOutput<bool>('externalSendersAllowed');
    this.hideFromAddressLists = registerOutput<bool>('hideFromAddressLists');
    this.hideFromOutlookClients = registerOutput<bool>('hideFromOutlookClients');
    this.mail = registerOutput<String>('mail');
    this.mailEnabled = registerOutput<bool?>('mailEnabled');
    ...
    this.onpremisesGroupType = registerOutput<String>('onpremisesGroupType');
    this.onpremisesNetbiosName = registerOutput<String>('onpremisesNetbiosName');
    ...
    this.provisioningOptions = registerOutput<List<String>?>('provisioningOptions');
    this.proxyAddresses = registerOutput<List<String>>('proxyAddresses');
    this.securityEnabled = registerOutput<bool?>('securityEnabled');
    this.theme = registerOutput<String?>('theme');
    this.types = registerOutput<List<String>?>('types');
    this.visibility = registerOutput<String>('visibility');
    this.writebackEnabled = registerOutput<bool?>('writebackEnabled');
  }
