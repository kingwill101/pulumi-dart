...
class ConditionalAccessPolicyConditionsClientApplications {
  ...
  final pulumi.Input<ConditionalAccessPolicyConditionsClientApplicationsFilter>?
  filter;
  ...
  factory ConditionalAccessPolicyConditionsClientApplications.fromMap(
    Map<String, dynamic> map,
  ) {
    return ConditionalAccessPolicyConditionsClientApplications(
      excludedServicePrincipals: (() {
        final guardedValue = map['excludedServicePrincipals'];
      ...
      filter: (() {
        ...
        return pulumi.Input.fromValue(
          ConditionalAccessPolicyConditionsClientApplicationsFilter.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      includedServicePrincipals: (() {
        final guardedValue = map['includedServicePrincipals'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
    );
