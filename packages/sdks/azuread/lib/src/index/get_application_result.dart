...
class GetApplicationResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'apis': pulumi.Input.encodeList<GetApplicationApi, Map<String, dynamic>>(
        apis,
        (value) => value.toMap(),
      ),
      'appRoleIds': appRoleIds,
      'appRoles':
          pulumi.Input.encodeList<GetApplicationAppRole, Map<String, dynamic>>(
            appRoles,
            (value) => value.toMap(),
          ),
      'clientId': clientId,
      ...
      'publicClients':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(publicClients, (value) => value.toMap()),
      'publisherDomain': publisherDomain,
      'requiredResourceAccesses':
          pulumi.Input.encodeList<
            GetApplicationRequiredResourceAccess,
            Map<String, dynamic>
          >(requiredResourceAccesses, (value) => value.toMap()),
      ...
      'singlePageApplications':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(singlePageApplications, (value) => value.toMap()),
      'supportUrl': supportUrl,
      'tags': tags,
      'termsOfServiceUrl': termsOfServiceUrl,
      'webs': pulumi.Input.encodeList<GetApplicationWeb, Map<String, dynamic>>(
        webs,
        (value) => value.toMap(),
      ),
    };
  ...
  factory GetApplicationResult.fromMap(Map<String, dynamic> map) {
    return GetApplicationResult(
      apis: pulumi.Input.decodeList<GetApplicationApi>(
        map['apis']!,
        (value) =>
            GetApplicationApi.fromMap((value as Map).cast<String, dynamic>()),
      ),
      appRoleIds: (map['appRoleIds'] as Map).cast<String, String>(),
      appRoles: pulumi.Input.decodeList<GetApplicationAppRole>(
        map['appRoles']!,
        (value) => GetApplicationAppRole.fromMap(
      ...
      featureTags: pulumi.Input.decodeList<GetApplicationFeatureTag>(
        map['featureTags']!,
        (value) => GetApplicationFeatureTag.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      groupMembershipClaims: (map['groupMembershipClaims'] as List)
          .cast<String>(),
      id: map['id'] as String,
      ...
      oauth2PermissionScopeIds: (map['oauth2PermissionScopeIds'] as Map)
          .cast<String, String>(),
      oauth2PostResponseRequired: map['oauth2PostResponseRequired'] as bool,
      objectId: map['objectId'] as String,
      optionalClaims: pulumi.Input.decodeList<GetApplicationOptionalClaim>(
        map['optionalClaims']!,
        (value) => GetApplicationOptionalClaim.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      owners: (map['owners'] as List).cast<String>(),
      privacyStatementUrl: map['privacyStatementUrl'] as String,
      publicClients: pulumi.Input.decodeList<GetApplicationPublicClient>(
        map['publicClients']!,
        (value) => GetApplicationPublicClient.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      publisherDomain: map['publisherDomain'] as String,
      requiredResourceAccesses:
          pulumi.Input.decodeList<GetApplicationRequiredResourceAccess>(
            map['requiredResourceAccesses']!,
            (value) => GetApplicationRequiredResourceAccess.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      ...
      singlePageApplications:
          pulumi.Input.decodeList<GetApplicationSinglePageApplication>(
            map['singlePageApplications']!,
            (value) => GetApplicationSinglePageApplication.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      ...
      webs: pulumi.Input.decodeList<GetApplicationWeb>(
        map['webs']!,
        (value) =>
            GetApplicationWeb.fromMap((value as Map).cast<String, dynamic>()),
      ),
    );
  }
}
