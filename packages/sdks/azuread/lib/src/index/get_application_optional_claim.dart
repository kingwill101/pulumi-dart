...
class GetApplicationOptionalClaim {
  ...
  factory GetApplicationOptionalClaim.fromMap(Map<String, dynamic> map) {
    return GetApplicationOptionalClaim(
      accessTokens: (() { final guardedValue = map['accessTokens']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetApplicationOptionalClaimAccessToken>(guardedValue, (value) => GetApplicationOptionalClaimAccessToken.fromMap((value as Map).cast<String, dynamic>()))); })(),
      idTokens: (() { final guardedValue = map['idTokens']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetApplicationOptionalClaimIdToken>(guardedValue, (value) => GetApplicationOptionalClaimIdToken.fromMap((value as Map).cast<String, dynamic>()))); })(),
      saml2Tokens: (() { final guardedValue = map['saml2Tokens']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetApplicationOptionalClaimSaml2Token>(guardedValue, (value) => GetApplicationOptionalClaimSaml2Token.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
