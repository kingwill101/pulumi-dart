...
class AccessPackageAssignmentPolicyQuestionChoice {
  ...
  final pulumi.Input<AccessPackageAssignmentPolicyQuestionChoiceDisplayValue>
  displayValue;
    ...
    return <String, dynamic>{
      ...
      'displayValue':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(displayValue, (value) => value.toMap()),
    };
  }

  factory AccessPackageAssignmentPolicyQuestionChoice.fromMap(
    Map<String, dynamic> map,
  ) {
    return AccessPackageAssignmentPolicyQuestionChoice(
      actualValue: pulumi.Input.fromValue(map['actualValue'] as String),
      displayValue: pulumi.Input.fromValue(
        AccessPackageAssignmentPolicyQuestionChoiceDisplayValue.fromMap(
          (map['displayValue']! as Map).cast<String, dynamic>(),
        ),
      ),
    );
  }
