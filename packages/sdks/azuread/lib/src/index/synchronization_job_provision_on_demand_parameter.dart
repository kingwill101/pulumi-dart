...
class SynchronizationJobProvisionOnDemandParameter {
  ...
  final pulumi.Input<List<SynchronizationJobProvisionOnDemandParameterSubject>>
  subjects;
    ...
    return <String, dynamic>{
      ...
      'subjects':
          pulumi.Input.mapInputValue<
            List<SynchronizationJobProvisionOnDemandParameterSubject>,
  ...
  factory SynchronizationJobProvisionOnDemandParameter.fromMap(
    ...
    return SynchronizationJobProvisionOnDemandParameter(
      ...
      subjects: pulumi.Input.fromValue(
        ...
        >(
          map['subjects']!,
          (value) =>
              SynchronizationJobProvisionOnDemandParameterSubject.fromMap(
