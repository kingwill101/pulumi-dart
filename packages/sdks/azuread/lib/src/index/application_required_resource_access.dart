...
class ApplicationRequiredResourceAccess {
  ...
  factory ApplicationRequiredResourceAccess.fromMap(Map<String, dynamic> map) {
    return ApplicationRequiredResourceAccess(
      resourceAccesses: (pulumi.Input.decodeList<ApplicationRequiredResourceAccessResourceAccess>(map['resourceAccesses'], (value) => ApplicationRequiredResourceAccessResourceAccess.fromMap((value as Map).cast<String, dynamic>()))).input(),
