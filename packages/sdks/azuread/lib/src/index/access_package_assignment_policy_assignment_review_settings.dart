...
class AccessPackageAssignmentPolicyAssignmentReviewSettings {
  ...
  final pulumi.Input<
    List<AccessPackageAssignmentPolicyAssignmentReviewSettingsReviewer>
  >?
  reviewers;
  ...
  factory AccessPackageAssignmentPolicyAssignmentReviewSettings.fromMap(
    Map<String, dynamic> map,
  ) {
    return AccessPackageAssignmentPolicyAssignmentReviewSettings(
      accessRecommendationEnabled: (() {
        final guardedValue = map['accessRecommendationEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      accessReviewTimeoutBehavior: (() {
        final guardedValue = map['accessReviewTimeoutBehavior'];
        if (guardedValue == null) return null;
      ...
      reviewFrequency: (() {
        final guardedValue = map['reviewFrequency'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      reviewType: (() {
        final guardedValue = map['reviewType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      reviewers: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                AccessPackageAssignmentPolicyAssignmentReviewSettingsReviewer.fromMap(
      ...
      startingOn: (() {
        final guardedValue = map['startingOn'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
