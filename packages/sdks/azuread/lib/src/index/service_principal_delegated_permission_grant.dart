...
import 'service_principal_delegated_permission_grant_state.dart';
...
class ServicePrincipalDelegatedPermissionGrant extends pulumi.CustomResource {
  ...
  /// Gets an existing [ServicePrincipalDelegatedPermissionGrant] resource's state with the given [name] and [id].
  static ServicePrincipalDelegatedPermissionGrant get(
    String name,
  ...
  ServicePrincipalDelegatedPermissionGrant._get(
    String name, {
