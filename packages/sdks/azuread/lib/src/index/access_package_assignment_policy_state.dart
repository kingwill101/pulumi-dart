...
class AccessPackageAssignmentPolicyState {
  ...
  final pulumi.Input<AccessPackageAssignmentPolicyApprovalSettings>?
  approvalSettings;
  ...
  final pulumi.Input<AccessPackageAssignmentPolicyAssignmentReviewSettings>?
  ...
  final pulumi.Input<AccessPackageAssignmentPolicyRequestorSettings>?
  requestorSettings;
    ...
    return <String, dynamic>{
      ...
      'approvalSettings':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(approvalSettings, (value) => value.toMap()),
      'assignmentReviewSettings':
          ?pulumi.Input.mapOptionalInputValue<
            AccessPackageAssignmentPolicyAssignmentReviewSettings,
            Map<String, dynamic>
          >(assignmentReviewSettings, (value) => value.toMap()),
      ...
      'questions':
          ?pulumi.Input.mapOptionalInputValue<
            List<AccessPackageAssignmentPolicyQuestion>,
      ...
      'requestorSettings':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(requestorSettings, (value) => value.toMap()),
    };
  }
  ...
  factory AccessPackageAssignmentPolicyState.fromMap(Map<String, dynamic> map) {
    return AccessPackageAssignmentPolicyState(
      ...
      approvalSettings: (() {
        final guardedValue = map['approvalSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AccessPackageAssignmentPolicyApprovalSettings.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      assignmentReviewSettings: (() {
        final guardedValue = map['assignmentReviewSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AccessPackageAssignmentPolicyAssignmentReviewSettings.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      durationInDays: (() {
        final guardedValue = map['durationInDays'];
        if (guardedValue == null) return null;
      ...
      extensionEnabled: (() {
        final guardedValue = map['extensionEnabled'];
        if (guardedValue == null) return null;
      ...
      questions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AccessPackageAssignmentPolicyQuestion>(
            guardedValue,
            (value) => AccessPackageAssignmentPolicyQuestion.fromMap(
      ...
      requestorSettings: (() {
        final guardedValue = map['requestorSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AccessPackageAssignmentPolicyRequestorSettings.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
