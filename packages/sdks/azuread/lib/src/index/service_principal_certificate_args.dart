...
/// {@template pulumi_index_service_principal_certificate_service_principal_certificate_args_doc}
/// The set of arguments for ServicePrincipalCertificate.
/// {@endtemplate}
/// {@macro pulumi_index_service_principal_certificate_service_principal_certificate_args_doc}
class ServicePrincipalCertificateArgs {
  ...
  /// Creates a new [ServicePrincipalCertificateArgs].
  ...
  const ServicePrincipalCertificateArgs({
    this.encoding,
    this.endDate,
  ...
  factory ServicePrincipalCertificateArgs.fromMap(Map<String, dynamic> map) {
    return ServicePrincipalCertificateArgs(
