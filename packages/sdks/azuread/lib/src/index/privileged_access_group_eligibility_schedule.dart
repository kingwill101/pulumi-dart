...
import 'privileged_access_group_eligibility_schedule_state.dart';
...
///   password            = "SecretP@sswd99!"
/// }
/// resource "azuread_privilegedaccessgroupeligibilityschedule" "example" {
///   group_id        = pim.id
...
class PrivilegedAccessGroupEligibilitySchedule extends pulumi.CustomResource {
  ...
  /// Gets an existing [PrivilegedAccessGroupEligibilitySchedule] resource's state with the given [name] and [id].
  static PrivilegedAccessGroupEligibilitySchedule get(
    String name,
    pulumi.Input<String> id, {
    PrivilegedAccessGroupEligibilityScheduleState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return PrivilegedAccessGroupEligibilitySchedule._get(
      name,
      state: state?.toMap(),
  ...
  PrivilegedAccessGroupEligibilitySchedule._get(
    String name, {
  ...
  /// Creates a typed reference to an existing [PrivilegedAccessGroupEligibilitySchedule] resource.
  PrivilegedAccessGroupEligibilitySchedule.reference(String urn)
    : super(
        'azuread:index/privilegedAccessGroupEligibilitySchedule:PrivilegedAccessGroupEligibilitySchedule',
