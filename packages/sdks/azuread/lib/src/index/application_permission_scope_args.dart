...
class ApplicationPermissionScopeArgs {
  ...
  ApplicationPermissionScopeArgs({
    required pulumi.Output<String> adminConsentDescription,
    required pulumi.Output<String> adminConsentDisplayName,
    ...
    required pulumi.Output<String> value,
      ...
      adminConsentDescription = pulumi.Input.asInput<String>(adminConsentDescription),
      adminConsentDisplayName = pulumi.Input.asInput<String>(adminConsentDisplayName),
  ...
  factory ApplicationPermissionScopeArgs.fromMap(Map<String, dynamic> map) {
    return ApplicationPermissionScopeArgs(
      adminConsentDescription: pulumi.Output.create<String>(map['adminConsentDescription'] as String),
      adminConsentDisplayName: pulumi.Output.create<String>(map['adminConsentDisplayName'] as String),
