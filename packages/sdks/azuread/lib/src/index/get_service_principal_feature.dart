...
class GetServicePrincipalFeature {
  ...
  factory GetServicePrincipalFeature.fromMap(Map<String, dynamic> map) {
    return GetServicePrincipalFeature(
      customSingleSignOnApp: pulumi.Input.fromValue(map['customSingleSignOnApp'] as bool),
      enterpriseApplication: pulumi.Input.fromValue(map['enterpriseApplication'] as bool),
      galleryApplication: pulumi.Input.fromValue(map['galleryApplication'] as bool),
