...
class GetGenaiAgentsByOpenaiApiKeyAgentChildAgentApiKeyInfo {
  /// API Key value
  ...
  /// Creates a new [GetGenaiAgentsByOpenaiApiKeyAgentChildAgentApiKeyInfo].
  ...
  factory GetGenaiAgentsByOpenaiApiKeyAgentChildAgentApiKeyInfo.fromMap(
