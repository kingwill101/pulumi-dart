  ...
  factory DatabaseMysqlConfigArgs.fromMap(Map<String, dynamic> map) {
    return DatabaseMysqlConfigArgs(
      ...
      binlogRetentionPeriod: (() {
        final guardedValue = map['binlogRetentionPeriod'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      ...
      groupConcatMaxLen: (() {
        final guardedValue = map['groupConcatMaxLen'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      informationSchemaStatsExpiry: (() {
        final guardedValue = map['informationSchemaStatsExpiry'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      innodbFtMinTokenSize: (() {
        final guardedValue = map['innodbFtMinTokenSize'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      innodbFtServerStopwordTable: (() {
        final guardedValue = map['innodbFtServerStopwordTable'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      innodbLockWaitTimeout: (() {
        final guardedValue = map['innodbLockWaitTimeout'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      innodbLogBufferSize: (() {
        final guardedValue = map['innodbLogBufferSize'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      innodbOnlineAlterLogMaxSize: (() {
        final guardedValue = map['innodbOnlineAlterLogMaxSize'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      innodbPrintAllDeadlocks: (() {
        final guardedValue = map['innodbPrintAllDeadlocks'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      innodbRollbackOnTimeout: (() {
        final guardedValue = map['innodbRollbackOnTimeout'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      interactiveTimeout: (() {
        final guardedValue = map['interactiveTimeout'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      internalTmpMemStorageEngine: (() {
        final guardedValue = map['internalTmpMemStorageEngine'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      longQueryTime: (() {
        final guardedValue = map['longQueryTime'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as double);
      })(),
      maxAllowedPacket: (() {
        final guardedValue = map['maxAllowedPacket'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      maxHeapTableSize: (() {
        final guardedValue = map['maxHeapTableSize'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      netReadTimeout: (() {
        final guardedValue = map['netReadTimeout'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      netWriteTimeout: (() {
        final guardedValue = map['netWriteTimeout'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      slowQueryLog: (() {
        final guardedValue = map['slowQueryLog'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      sortBufferSize: (() {
        final guardedValue = map['sortBufferSize'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      sqlMode: (() {
        final guardedValue = map['sqlMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      sqlRequirePrimaryKey: (() {
        final guardedValue = map['sqlRequirePrimaryKey'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      tmpTableSize: (() {
        final guardedValue = map['tmpTableSize'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      waitTimeout: (() {
