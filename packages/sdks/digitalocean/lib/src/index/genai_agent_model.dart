...
class GenaiAgentModel {
  ...
  final List<GenaiAgentModelAgreement>? agreements;
  ...
  /// URL of the Model
  final List<GenaiAgentModelVersion>? versions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'agreements': ?agreements == null ? null : pulumi.Input.encodeList<GenaiAgentModelAgreement, Map<String, dynamic>>(agreements!, (value) => value.toMap()),
      'createdAt': ?createdAt,
      ...
      'url': ?url,
      'usecases': ?usecases,
      'versions': ?versions == null ? null : pulumi.Input.encodeList<GenaiAgentModelVersion, Map<String, dynamic>>(versions!, (value) => value.toMap()),
    };
  }

  factory GenaiAgentModel.fromMap(Map<String, dynamic> map) {
    return GenaiAgentModel(
      agreements: map['agreements'] == null ? null : pulumi.Input.decodeList<GenaiAgentModelAgreement>(map['agreements'], (value) => GenaiAgentModelAgreement.fromMap((value as Map).cast<String, dynamic>())),
      ...
      versions: map['versions'] == null ? null : pulumi.Input.decodeList<GenaiAgentModelVersion>(map['versions'], (value) => GenaiAgentModelVersion.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
