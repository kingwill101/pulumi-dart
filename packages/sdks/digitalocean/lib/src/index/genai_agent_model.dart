...
class GenaiAgentModel {
  ...
  factory GenaiAgentModel.fromMap(Map<String, dynamic> map) {
    return GenaiAgentModel(
      agreements: (() { final guardedValue = map['agreements']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GenaiAgentModelAgreement>(guardedValue, (value) => GenaiAgentModelAgreement.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      versions: (() { final guardedValue = map['versions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GenaiAgentModelVersion>(guardedValue, (value) => GenaiAgentModelVersion.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
