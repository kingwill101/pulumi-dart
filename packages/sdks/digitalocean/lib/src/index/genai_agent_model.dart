    ...
    return GenaiAgentModel(
      agreements: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GenaiAgentModelAgreement>(
            guardedValue,
            (value) => GenaiAgentModelAgreement.fromMap(
      ...
      versions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GenaiAgentModelVersion>(
            guardedValue,
            (value) => GenaiAgentModelVersion.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
