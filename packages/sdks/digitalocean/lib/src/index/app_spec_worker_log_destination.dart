    ...
    return AppSpecWorkerLogDestination(
      datadog: (() {
        ...
        return pulumi.Input.fromValue(
          AppSpecWorkerLogDestinationDatadog.fromMap(
      ...
      logtail: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AppSpecWorkerLogDestinationLogtail.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      openSearch: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AppSpecWorkerLogDestinationOpenSearch.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      papertrail: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AppSpecWorkerLogDestinationPapertrail.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
