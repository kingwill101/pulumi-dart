...
class GetGenaiAgentAgentGuardrail {
  ...
  /// Creates a new [GetGenaiAgentAgentGuardrail].
  ...
  factory GetGenaiAgentAgentGuardrail.fromMap(Map<String, dynamic> map) {
    return GetGenaiAgentAgentGuardrail(
