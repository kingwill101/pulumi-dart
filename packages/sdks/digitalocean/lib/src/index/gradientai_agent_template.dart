...
class GradientaiAgentTemplate {
  ...
  final pulumi.Input<List<GradientaiAgentTemplateKnowledgeBase>>?
  knowledgeBases;
    ...
    return <String, dynamic>{
      ...
      'knowledgeBases':
          ?pulumi.Input.mapOptionalInputValue<
            List<GradientaiAgentTemplateKnowledgeBase>,
      ...
      'models':
          ?pulumi.Input.mapOptionalInputValue<
            List<GradientaiAgentTemplateModel>,
            List<Map<String, dynamic>>
          >(
            models,
            (value) =>
    ...
    return GradientaiAgentTemplate(
      ...
      knowledgeBases: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GradientaiAgentTemplateKnowledgeBase>(
            guardedValue,
            (value) => GradientaiAgentTemplateKnowledgeBase.fromMap(
      ...
      models: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GradientaiAgentTemplateModel>(
            guardedValue,
            (value) => GradientaiAgentTemplateModel.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
