...
class AppSpecJobAlertDestinations {
  ...
  final pulumi.Input<List<AppSpecJobAlertDestinationsSlackWebhook>>?
  slackWebhooks;
  ...
  AppSpecJobAlertDestinations({this.emails, this.slackWebhooks});
    ...
    return <String, dynamic>{
      ...
      'slackWebhooks':
          ?pulumi.Input.mapOptionalInputValue<
            List<AppSpecJobAlertDestinationsSlackWebhook>,
    ...
    return AppSpecJobAlertDestinations(
      ...
      slackWebhooks: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AppSpecJobAlertDestinationsSlackWebhook>(
            guardedValue,
            (value) => AppSpecJobAlertDestinationsSlackWebhook.fromMap(
