...
class AppSpecServiceAlert {
  ...
  final AppSpecServiceAlertDestinations? destinations;
  ...
  factory AppSpecServiceAlert.fromMap(Map<String, dynamic> map) {
    return AppSpecServiceAlert(
      destinations: map['destinations'] == null ? null : AppSpecServiceAlertDestinations.fromMap((map['destinations'] as Map).cast<String, dynamic>()),
