...
class AppSpecServiceAlert {
  ...
  factory AppSpecServiceAlert.fromMap(Map<String, dynamic> map) {
    return AppSpecServiceAlert(
      destinations: (() { final guardedValue = map['destinations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AppSpecServiceAlertDestinations.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
