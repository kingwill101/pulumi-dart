...
class GetGradientaiAgentsAgentChildAgentDeployment {
  /// API Key value
  ...
  /// Creates a new [GetGradientaiAgentsAgentChildAgentDeployment].
  ...
  factory GetGradientaiAgentsAgentChildAgentDeployment.fromMap(Map<String, dynamic> map) {
    return GetGradientaiAgentsAgentChildAgentDeployment(
