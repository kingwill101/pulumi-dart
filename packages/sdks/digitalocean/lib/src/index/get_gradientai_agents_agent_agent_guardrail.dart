...
class GetGradientaiAgentsAgentAgentGuardrail {
  ...
  /// Creates a new [GetGradientaiAgentsAgentAgentGuardrail].
  ...
  factory GetGradientaiAgentsAgentAgentGuardrail.fromMap(Map<String, dynamic> map) {
    return GetGradientaiAgentsAgentAgentGuardrail(
