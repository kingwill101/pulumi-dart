...
class DropletArgs {
  ...
  factory DropletArgs.fromMap(Map<String, dynamic> map) {
    return DropletArgs(
      backupPolicy: (() { final guardedValue = map['backupPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DropletBackupPolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      volumeIds: (() { final guardedValue = map['volumeIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
