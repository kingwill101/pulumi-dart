...
class KubernetesClusterArgs {
  ...
  KubernetesClusterArgs({
    ...
    required pulumi.Output<KubernetesClusterNodePool> nodePool,
  ...
  factory KubernetesClusterArgs.fromMap(Map<String, dynamic> map) {
    return KubernetesClusterArgs(
      ...
      nodePool: pulumi.Output.create<KubernetesClusterNodePool>(KubernetesClusterNodePool.fromMap((map['nodePool'] as Map).cast<String, dynamic>())),
