...
class AppSpecFunctionGitlab {
  ...
  /// Creates a new [AppSpecFunctionGitlab].
  ...
  AppSpecFunctionGitlab({this.branch, this.deployOnPush, this.repo});
  ...
  factory AppSpecFunctionGitlab.fromMap(Map<String, dynamic> map) {
    return AppSpecFunctionGitlab(
      branch: (() {
