...
class GetGradientaiAgentsByOpenaiApiKeyAgentChildAgentAnthropicApiKey {
  ...
  /// Creates a new [GetGradientaiAgentsByOpenaiApiKeyAgentChildAgentAnthropicApiKey].
  ...
  /// [uuid] API Key value
  const GetGradientaiAgentsByOpenaiApiKeyAgentChildAgentAnthropicApiKey({
  ...
  factory GetGradientaiAgentsByOpenaiApiKeyAgentChildAgentAnthropicApiKey.fromMap(Map<String, dynamic> map) {
    return GetGradientaiAgentsByOpenaiApiKeyAgentChildAgentAnthropicApiKey(
