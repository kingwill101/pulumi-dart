...
class GetAppSpecAlertDestinations {
  ...
  const GetAppSpecAlertDestinations({
    this.emails,
    this.slackWebhooks,
  });
  ...
  factory GetAppSpecAlertDestinations.fromMap(Map<String, dynamic> map) {
    return GetAppSpecAlertDestinations(
      ...
      slackWebhooks: (() { final guardedValue = map['slackWebhooks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetAppSpecAlertDestinationsSlackWebhook>(guardedValue, (value) => GetAppSpecAlertDestinationsSlackWebhook.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
