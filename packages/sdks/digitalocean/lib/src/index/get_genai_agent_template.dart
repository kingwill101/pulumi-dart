    ...
    return <String, dynamic>{
      ...
      'knowledgeBases':
          ?pulumi.Input.mapOptionalInputValue<
            List<GetGenaiAgentTemplateKnowledgeBase>,
      ...
      'models':
          ?pulumi.Input.mapOptionalInputValue<
            List<GetGenaiAgentTemplateModel>,
            List<Map<String, dynamic>>
          >(
            models,
            (value) =>
    ...
    return GetGenaiAgentTemplate(
      ...
      knowledgeBases: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GetGenaiAgentTemplateKnowledgeBase>(
            guardedValue,
            (value) => GetGenaiAgentTemplateKnowledgeBase.fromMap(
      ...
      models: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GetGenaiAgentTemplateModel>(
            guardedValue,
            (value) => GetGenaiAgentTemplateModel.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
