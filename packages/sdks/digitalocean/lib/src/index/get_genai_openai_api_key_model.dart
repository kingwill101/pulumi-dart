...
import 'get_genai_openai_api_key_model_agreement.dart';
import 'get_genai_openai_api_key_model_version.dart';

class GetGenaiOpenaiApiKeyModel {
  /// Agreement information for the model
  final pulumi.Input<List<GetGenaiOpenaiApiKeyModelAgreement>>? agreements;
  ...
  /// URL of the Model
  final pulumi.Input<List<GetGenaiOpenaiApiKeyModelVersion>>? versions;

  /// Creates a new [GetGenaiOpenaiApiKeyModel].
  ...
  const GetGenaiOpenaiApiKeyModel({
    this.agreements,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'agreements': ?pulumi.Input.mapOptionalInputValue<List<GetGenaiOpenaiApiKeyModelAgreement>, List<Map<String, dynamic>>>(agreements, (value) => pulumi.Input.encodeList<GetGenaiOpenaiApiKeyModelAgreement, Map<String, dynamic>>(value, (value) => value.toMap())),
      'createdAt': createdAt,
      ...
      'url': ?url,
      'usecases': ?usecases,
      'versions': ?pulumi.Input.mapOptionalInputValue<List<GetGenaiOpenaiApiKeyModelVersion>, List<Map<String, dynamic>>>(versions, (value) => pulumi.Input.encodeList<GetGenaiOpenaiApiKeyModelVersion, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory GetGenaiOpenaiApiKeyModel.fromMap(Map<String, dynamic> map) {
    return GetGenaiOpenaiApiKeyModel(
      agreements: (() { final guardedValue = map['agreements']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetGenaiOpenaiApiKeyModelAgreement>(guardedValue, (value) => GetGenaiOpenaiApiKeyModelAgreement.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      versions: (() { final guardedValue = map['versions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetGenaiOpenaiApiKeyModelVersion>(guardedValue, (value) => GetGenaiOpenaiApiKeyModelVersion.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
