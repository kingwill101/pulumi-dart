...
class GetGenaiOpenaiApiKeyModel {
  ...
  factory GetGenaiOpenaiApiKeyModel.fromMap(Map<String, dynamic> map) {
    return GetGenaiOpenaiApiKeyModel(
      agreements: map['agreements'] == null ? null : (pulumi.Input.decodeList<GetGenaiOpenaiApiKeyModelAgreement>(map['agreements'], (value) => GetGenaiOpenaiApiKeyModelAgreement.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      versions: map['versions'] == null ? null : (pulumi.Input.decodeList<GetGenaiOpenaiApiKeyModelVersion>(map['versions'], (value) => GetGenaiOpenaiApiKeyModelVersion.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
