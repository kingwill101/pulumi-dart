...
class GetGenaiOpenaiApiKeyModel {
  ...
  final List<GetGenaiOpenaiApiKeyModelAgreement>? agreements;
  ...
  /// URL of the Model
  final List<GetGenaiOpenaiApiKeyModelVersion>? versions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'agreements': ?agreements == null ? null : pulumi.Input.encodeList<GetGenaiOpenaiApiKeyModelAgreement, Map<String, dynamic>>(agreements!, (value) => value.toMap()),
      'createdAt': createdAt,
      ...
      'url': ?url,
      'usecases': ?usecases,
      'versions': ?versions == null ? null : pulumi.Input.encodeList<GetGenaiOpenaiApiKeyModelVersion, Map<String, dynamic>>(versions!, (value) => value.toMap()),
    };
  }

  factory GetGenaiOpenaiApiKeyModel.fromMap(Map<String, dynamic> map) {
    return GetGenaiOpenaiApiKeyModel(
      agreements: map['agreements'] == null ? null : pulumi.Input.decodeList<GetGenaiOpenaiApiKeyModelAgreement>(map['agreements'], (value) => GetGenaiOpenaiApiKeyModelAgreement.fromMap((value as Map).cast<String, dynamic>())),
      ...
      versions: map['versions'] == null ? null : pulumi.Input.decodeList<GetGenaiOpenaiApiKeyModelVersion>(map['versions'], (value) => GetGenaiOpenaiApiKeyModelVersion.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
