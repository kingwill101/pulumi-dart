...
class AppSpecAlertDestinations {
  ...
  factory AppSpecAlertDestinations.fromMap(Map<String, dynamic> map) {
    return AppSpecAlertDestinations(
      ...
      slackWebhooks: map['slackWebhooks'] == null ? null : (pulumi.Input.decodeList<AppSpecAlertDestinationsSlackWebhook>(map['slackWebhooks'], (value) => AppSpecAlertDestinationsSlackWebhook.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
