...
class AppSpecAlertDestinations {
  ...
  const AppSpecAlertDestinations({
    this.emails,
    this.slackWebhooks,
  });
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'emails': ?emails,
      'slackWebhooks': ?pulumi.Input.mapOptionalInputValue<List<AppSpecAlertDestinationsSlackWebhook>, List<Map<String, dynamic>>>(slackWebhooks, (value) => pulumi.Input.encodeList<AppSpecAlertDestinationsSlackWebhook, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory AppSpecAlertDestinations.fromMap(Map<String, dynamic> map) {
    return AppSpecAlertDestinations(
      ...
      slackWebhooks: (() { final guardedValue = map['slackWebhooks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AppSpecAlertDestinationsSlackWebhook>(guardedValue, (value) => AppSpecAlertDestinationsSlackWebhook.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
