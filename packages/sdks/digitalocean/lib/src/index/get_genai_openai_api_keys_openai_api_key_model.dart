...
class GetGenaiOpenaiApiKeysOpenaiApiKeyModel {
  ...
  final pulumi.Input<List<GetGenaiOpenaiApiKeysOpenaiApiKeyModelAgreement>>?
  agreements;
  ...
  /// URL of the Model
  final pulumi.Input<List<GetGenaiOpenaiApiKeysOpenaiApiKeyModelVersion>>?
  versions;
    ...
    return <String, dynamic>{
      'agreements':
          ?pulumi.Input.mapOptionalInputValue<
            List<GetGenaiOpenaiApiKeysOpenaiApiKeyModelAgreement>,
      ...
      'versions':
          ?pulumi.Input.mapOptionalInputValue<
            List<GetGenaiOpenaiApiKeysOpenaiApiKeyModelVersion>,
            List<Map<String, dynamic>>
          >(
            versions,
            (value) =>
  ...
  factory GetGenaiOpenaiApiKeysOpenaiApiKeyModel.fromMap(
    ...
    return GetGenaiOpenaiApiKeysOpenaiApiKeyModel(
      agreements: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => GetGenaiOpenaiApiKeysOpenaiApiKeyModelAgreement.fromMap(
      ...
      versions: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<GetGenaiOpenaiApiKeysOpenaiApiKeyModelVersion>(
            guardedValue,
            (value) => GetGenaiOpenaiApiKeysOpenaiApiKeyModelVersion.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
