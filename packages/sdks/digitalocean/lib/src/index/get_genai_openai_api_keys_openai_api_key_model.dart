...
import 'get_genai_openai_api_keys_openai_api_key_model_agreement.dart';
import 'get_genai_openai_api_keys_openai_api_key_model_version.dart';

class GetGenaiOpenaiApiKeysOpenaiApiKeyModel {
  /// Agreement information for the model
  final pulumi.Input<List<GetGenaiOpenaiApiKeysOpenaiApiKeyModelAgreement>>? agreements;
  ...
  /// URL of the Model
  final pulumi.Input<List<GetGenaiOpenaiApiKeysOpenaiApiKeyModelVersion>>? versions;

  /// Creates a new [GetGenaiOpenaiApiKeysOpenaiApiKeyModel].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'agreements': ?pulumi.Input.mapOptionalInputValue<List<GetGenaiOpenaiApiKeysOpenaiApiKeyModelAgreement>, List<Map<String, dynamic>>>(agreements, (value) => pulumi.Input.encodeList<GetGenaiOpenaiApiKeysOpenaiApiKeyModelAgreement, Map<String, dynamic>>(value, (value) => value.toMap())),
      'createdAt': createdAt,
      ...
      'url': ?url,
      'usecases': ?usecases,
      'versions': ?pulumi.Input.mapOptionalInputValue<List<GetGenaiOpenaiApiKeysOpenaiApiKeyModelVersion>, List<Map<String, dynamic>>>(versions, (value) => pulumi.Input.encodeList<GetGenaiOpenaiApiKeysOpenaiApiKeyModelVersion, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory GetGenaiOpenaiApiKeysOpenaiApiKeyModel.fromMap(Map<String, dynamic> map) {
    return GetGenaiOpenaiApiKeysOpenaiApiKeyModel(
      agreements: (() { final guardedValue = map['agreements']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetGenaiOpenaiApiKeysOpenaiApiKeyModelAgreement>(guardedValue, (value) => GetGenaiOpenaiApiKeysOpenaiApiKeyModelAgreement.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      versions: (() { final guardedValue = map['versions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetGenaiOpenaiApiKeysOpenaiApiKeyModelVersion>(guardedValue, (value) => GetGenaiOpenaiApiKeysOpenaiApiKeyModelVersion.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
