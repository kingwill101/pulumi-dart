...
class DatabaseMongodbConfig extends pulumi.CustomResource {
  ...
  DatabaseMongodbConfig(
    ...
    this.defaultReadConcern = registerOutput<String>('defaultReadConcern');
    this.defaultWriteConcern = registerOutput<String>('defaultWriteConcern');
    this.slowOpThresholdMs = registerOutput<int>('slowOpThresholdMs');
    this.transactionLifetimeLimitSeconds = registerOutput<int>('transactionLifetimeLimitSeconds');
    this.verbosity = registerOutput<int>('verbosity');
  }
