  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'filters': ?(() {
        ...
        return pulumi.Input.encodeList<GetSizesFilter, Map<String, dynamic>>(
          guardedValue,
          (value) => value.toMap(),
        );
      })(),
      'id': id,
      'sizes': pulumi.Input.encodeList<GetSizesSize, Map<String, dynamic>>(
        sizes,
        (value) => value.toMap(),
      ),
      'sorts': ?(() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.encodeList<GetSizesSort, Map<String, dynamic>>(
          guardedValue,
          (value) => value.toMap(),
        );
      })(),
  ...
  factory GetSizesResult.fromMap(Map<String, dynamic> map) {
    return GetSizesResult(
      filters: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<GetSizesFilter>(
          guardedValue,
          (value) =>
      ...
      id: map['id'] as String,
      sizes: pulumi.Input.decodeList<GetSizesSize>(
        map['sizes']!,
        (value) => GetSizesSize.fromMap((value as Map).cast<String, dynamic>()),
      ),
      sorts: (() {
        final guardedValue = map['sorts'];
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<GetSizesSort>(
          guardedValue,
          (value) =>
