...
class GetSizesResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'id': ?id,
      'sizes': ?(() { final guardedValue = sizes; if (guardedValue == null) return null; return pulumi.Input.encodeList<GetSizesSize, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
  ...
  factory GetSizesResult.fromMap(Map<String, dynamic> map) {
    return GetSizesResult(
      ...
      sizes: (() { final guardedValue = map['sizes']; if (guardedValue == null) return null; return pulumi.Input.decodeList<GetSizesSize>(guardedValue, (value) => GetSizesSize.fromMap((value as Map).cast<String, dynamic>())); })(),
