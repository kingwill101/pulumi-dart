...
class GetAppSpecStaticSite {
  ...
  factory GetAppSpecStaticSite.fromMap(Map<String, dynamic> map) {
    return GetAppSpecStaticSite(
      bitbucket: (() { final guardedValue = map['bitbucket']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GetAppSpecStaticSiteBitbucket.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      catchallDocument: (() { final guardedValue = map['catchallDocument']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      cors: (() { final guardedValue = map['cors']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GetAppSpecStaticSiteCors.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      envs: (() { final guardedValue = map['envs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetAppSpecStaticSiteEnv>(guardedValue, (value) => GetAppSpecStaticSiteEnv.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      git: (() { final guardedValue = map['git']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GetAppSpecStaticSiteGit.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      github: (() { final guardedValue = map['github']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GetAppSpecStaticSiteGithub.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      gitlab: (() { final guardedValue = map['gitlab']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GetAppSpecStaticSiteGitlab.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      outputDir: (() { final guardedValue = map['outputDir']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      routes: pulumi.Input.fromValue(pulumi.Input.decodeList<GetAppSpecStaticSiteRoute>(map['routes']!, (value) => GetAppSpecStaticSiteRoute.fromMap((value as Map).cast<String, dynamic>()))),
