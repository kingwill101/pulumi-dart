...
class GetGradientaiAgentTemplate {
  ...
  final pulumi.Input<List<GetGradientaiAgentTemplateKnowledgeBase>>?
  knowledgeBases;
    ...
    return <String, dynamic>{
      ...
      'knowledgeBases':
          ?pulumi.Input.mapOptionalInputValue<
            List<GetGradientaiAgentTemplateKnowledgeBase>,
      ...
      'models':
          ?pulumi.Input.mapOptionalInputValue<
            List<GetGradientaiAgentTemplateModel>,
            List<Map<String, dynamic>>
          >(
            models,
            (value) =>
    ...
    return GetGradientaiAgentTemplate(
      ...
      knowledgeBases: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GetGradientaiAgentTemplateKnowledgeBase>(
            guardedValue,
            (value) => GetGradientaiAgentTemplateKnowledgeBase.fromMap(
      ...
      models: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GetGradientaiAgentTemplateModel>(
            guardedValue,
            (value) => GetGradientaiAgentTemplateModel.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
