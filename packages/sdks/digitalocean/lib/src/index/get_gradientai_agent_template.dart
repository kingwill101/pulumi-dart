...
class GetGradientaiAgentTemplate {
  ...
  const GetGradientaiAgentTemplate({
  ...
  factory GetGradientaiAgentTemplate.fromMap(Map<String, dynamic> map) {
    return GetGradientaiAgentTemplate(
      ...
      knowledgeBases: (() { final guardedValue = map['knowledgeBases']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetGradientaiAgentTemplateKnowledgeBase>(guardedValue, (value) => GetGradientaiAgentTemplateKnowledgeBase.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      models: (() { final guardedValue = map['models']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetGradientaiAgentTemplateModel>(guardedValue, (value) => GetGradientaiAgentTemplateModel.fromMap((value as Map).cast<String, dynamic>()))); })(),
