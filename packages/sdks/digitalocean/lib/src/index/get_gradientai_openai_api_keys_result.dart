...
class GetGradientaiOpenaiApiKeysResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'id': ?id,
      'openaiApiKeys': ?(() { final guardedValue = openaiApiKeys; if (guardedValue == null) return null; return pulumi.Input.encodeList<GetGradientaiOpenaiApiKeysOpenaiApiKey, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
  ...
  factory GetGradientaiOpenaiApiKeysResult.fromMap(Map<String, dynamic> map) {
    return GetGradientaiOpenaiApiKeysResult(
      ...
      openaiApiKeys: (() { final guardedValue = map['openaiApiKeys']; if (guardedValue == null) return null; return pulumi.Input.decodeList<GetGradientaiOpenaiApiKeysOpenaiApiKey>(guardedValue, (value) => GetGradientaiOpenaiApiKeysOpenaiApiKey.fromMap((value as Map).cast<String, dynamic>())); })(),
