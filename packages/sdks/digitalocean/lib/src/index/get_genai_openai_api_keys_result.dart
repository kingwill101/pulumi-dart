    ...
    return <String, dynamic>{
      ...
      'openaiApiKeys':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(openaiApiKeys, (value) => value.toMap()),
      'sorts': ?(() {
  ...
  factory GetGenaiOpenaiApiKeysResult.fromMap(Map<String, dynamic> map) {
    return GetGenaiOpenaiApiKeysResult(
      filters: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<GetGenaiOpenaiApiKeysFilter>(
          guardedValue,
          (value) => GetGenaiOpenaiApiKeysFilter.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      id: map['id'] as String,
      openaiApiKeys: pulumi.Input.decodeList<GetGenaiOpenaiApiKeysOpenaiApiKey>(
        map['openaiApiKeys']!,
        (value) => GetGenaiOpenaiApiKeysOpenaiApiKey.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      sorts: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<GetGenaiOpenaiApiKeysSort>(
          guardedValue,
          (value) => GetGenaiOpenaiApiKeysSort.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        );
      })(),
