...
class DatabaseKafkaConfigState {
  ...
  const DatabaseKafkaConfigState({
  ...
  factory DatabaseKafkaConfigState.fromMap(Map<String, dynamic> map) {
    return DatabaseKafkaConfigState(
      ...
      groupInitialRebalanceDelayMs: (() { final guardedValue = map['groupInitialRebalanceDelayMs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      groupMaxSessionTimeoutMs: (() { final guardedValue = map['groupMaxSessionTimeoutMs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      groupMinSessionTimeoutMs: (() { final guardedValue = map['groupMinSessionTimeoutMs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      logCleanerDeleteRetentionMs: (() { final guardedValue = map['logCleanerDeleteRetentionMs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      ...
      logIndexIntervalBytes: (() { final guardedValue = map['logIndexIntervalBytes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      ...
      logRetentionHours: (() { final guardedValue = map['logRetentionHours']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      ...
      logSegmentDeleteDelayMs: (() { final guardedValue = map['logSegmentDeleteDelayMs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
