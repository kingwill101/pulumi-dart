...
class GetGenaiAgentsArgs {
  ...
  /// [sorts] Optional.
  GetGenaiAgentsArgs({
    pulumi.Output<List<GetGenaiAgentsFilter>>? filters,
    pulumi.Output<bool>? onlyDeployed,
    pulumi.Output<List<GetGenaiAgentsSort>>? sorts,
  }) :
      filters = pulumi.Input.asOptionalInput<List<GetGenaiAgentsFilter>>(filters),
      onlyDeployed = pulumi.Input.asOptionalInput<bool>(onlyDeployed),
      sorts = pulumi.Input.asOptionalInput<List<GetGenaiAgentsSort>>(sorts);
  ...
  factory GetGenaiAgentsArgs.fromMap(Map<String, dynamic> map) {
    return GetGenaiAgentsArgs(
      filters: map['filters'] == null ? null : pulumi.Output.create<List<GetGenaiAgentsFilter>>(pulumi.Input.decodeList<GetGenaiAgentsFilter>(map['filters'], (value) => GetGenaiAgentsFilter.fromMap((value as Map).cast<String, dynamic>()))),
      onlyDeployed: map['onlyDeployed'] == null ? null : pulumi.Output.create<bool>(map['onlyDeployed'] as bool),
      sorts: map['sorts'] == null ? null : pulumi.Output.create<List<GetGenaiAgentsSort>>(pulumi.Input.decodeList<GetGenaiAgentsSort>(map['sorts'], (value) => GetGenaiAgentsSort.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
