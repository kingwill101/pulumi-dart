...
class GetGenaiAgentsArgs {
  ...
  /// [sorts] Optional.
  GetGenaiAgentsArgs({this.filters, this.onlyDeployed, this.sorts});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'filters':
          ?pulumi.Input.mapOptionalInputValue<
            List<GetGenaiAgentsFilter>,
    ...
    return GetGenaiAgentsArgs(
      filters: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GetGenaiAgentsFilter>(
            guardedValue,
      ...
      sorts: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GetGenaiAgentsSort>(
            guardedValue,
