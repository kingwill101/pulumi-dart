...
class GetAppSpecWorkerImage {
  ...
  factory GetAppSpecWorkerImage.fromMap(Map<String, dynamic> map) {
    return GetAppSpecWorkerImage(
      deployOnPushes: (pulumi.Input.decodeList<GetAppSpecWorkerImageDeployOnPush>(map['deployOnPushes'], (value) => GetAppSpecWorkerImageDeployOnPush.fromMap((value as Map).cast<String, dynamic>()))).input(),
