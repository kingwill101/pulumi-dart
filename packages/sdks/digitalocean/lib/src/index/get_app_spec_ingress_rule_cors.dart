...
class GetAppSpecIngressRuleCors {
  ...
  final GetAppSpecIngressRuleCorsAllowOrigins? allowOrigins;
  ...
  factory GetAppSpecIngressRuleCors.fromMap(Map<String, dynamic> map) {
    return GetAppSpecIngressRuleCors(
      ...
      allowOrigins: map['allowOrigins'] == null ? null : GetAppSpecIngressRuleCorsAllowOrigins.fromMap((map['allowOrigins'] as Map).cast<String, dynamic>()),
