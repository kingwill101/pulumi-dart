...
import 'get_app_spec_ingress_rule_cors_allow_origins.dart';
...
class GetAppSpecIngressRuleCors {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'allowOrigins': ?pulumi.Input.mapOptionalInputValue<GetAppSpecIngressRuleCorsAllowOrigins, Map<String, dynamic>>(allowOrigins, (value) => value.toMap()),
      'exposeHeaders': ?exposeHeaders,
      'maxAge': ?maxAge,
    };
  }

  factory GetAppSpecIngressRuleCors.fromMap(Map<String, dynamic> map) {
    return GetAppSpecIngressRuleCors(
      ...
      allowOrigins: (() { final guardedValue = map['allowOrigins']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GetAppSpecIngressRuleCorsAllowOrigins.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
