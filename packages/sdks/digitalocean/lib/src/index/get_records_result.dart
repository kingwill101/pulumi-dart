...
class GetRecordsResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'id': ?id,
      'records': ?(() { final guardedValue = records; if (guardedValue == null) return null; return pulumi.Input.encodeList<GetRecordsRecord, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
  ...
  factory GetRecordsResult.fromMap(Map<String, dynamic> map) {
    return GetRecordsResult(
      ...
      records: (() { final guardedValue = map['records']; if (guardedValue == null) return null; return pulumi.Input.decodeList<GetRecordsRecord>(guardedValue, (value) => GetRecordsRecord.fromMap((value as Map).cast<String, dynamic>())); })(),
