...
class GetGenaiAgentsAgentParentAgentDeployment {
  /// API Key value
  ...
  /// Creates a new [GetGenaiAgentsAgentParentAgentDeployment].
  ...
  factory GetGenaiAgentsAgentParentAgentDeployment.fromMap(
