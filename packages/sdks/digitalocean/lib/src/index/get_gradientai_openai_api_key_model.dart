...
import 'get_gradientai_openai_api_key_model_agreement.dart';
import 'get_gradientai_openai_api_key_model_version.dart';

class GetGradientaiOpenaiApiKeyModel {
  /// Agreement information for the model
  final pulumi.Input<List<GetGradientaiOpenaiApiKeyModelAgreement>>? agreements;
  ...
  /// URL of the Model
  final pulumi.Input<List<GetGradientaiOpenaiApiKeyModelVersion>>? versions;

  /// Creates a new [GetGradientaiOpenaiApiKeyModel].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'agreements': ?pulumi.Input.mapOptionalInputValue<List<GetGradientaiOpenaiApiKeyModelAgreement>, List<Map<String, dynamic>>>(agreements, (value) => pulumi.Input.encodeList<GetGradientaiOpenaiApiKeyModelAgreement, Map<String, dynamic>>(value, (value) => value.toMap())),
      'createdAt': createdAt,
      ...
      'url': ?url,
      'usecases': ?usecases,
      'versions': ?pulumi.Input.mapOptionalInputValue<List<GetGradientaiOpenaiApiKeyModelVersion>, List<Map<String, dynamic>>>(versions, (value) => pulumi.Input.encodeList<GetGradientaiOpenaiApiKeyModelVersion, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory GetGradientaiOpenaiApiKeyModel.fromMap(Map<String, dynamic> map) {
    return GetGradientaiOpenaiApiKeyModel(
      agreements: (() { final guardedValue = map['agreements']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetGradientaiOpenaiApiKeyModelAgreement>(guardedValue, (value) => GetGradientaiOpenaiApiKeyModelAgreement.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      versions: (() { final guardedValue = map['versions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetGradientaiOpenaiApiKeyModelVersion>(guardedValue, (value) => GetGradientaiOpenaiApiKeyModelVersion.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
