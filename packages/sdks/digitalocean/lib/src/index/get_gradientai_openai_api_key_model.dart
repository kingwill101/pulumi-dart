...
class GetGradientaiOpenaiApiKeyModel {
  ...
  factory GetGradientaiOpenaiApiKeyModel.fromMap(Map<String, dynamic> map) {
    return GetGradientaiOpenaiApiKeyModel(
      agreements: map['agreements'] == null ? null : (pulumi.Input.decodeList<GetGradientaiOpenaiApiKeyModelAgreement>(map['agreements'], (value) => GetGradientaiOpenaiApiKeyModelAgreement.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      versions: map['versions'] == null ? null : (pulumi.Input.decodeList<GetGradientaiOpenaiApiKeyModelVersion>(map['versions'], (value) => GetGradientaiOpenaiApiKeyModelVersion.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
