    ...
    return <String, dynamic>{
      'agreements':
          ?pulumi.Input.mapOptionalInputValue<
            List<GetGradientaiOpenaiApiKeyModelAgreement>,
            List<Map<String, dynamic>>
          >(
            agreements,
            (value) =>
                pulumi.Input.encodeList<
                  GetGradientaiOpenaiApiKeyModelAgreement,
                  Map<String, dynamic>
      ...
      'versions':
          ?pulumi.Input.mapOptionalInputValue<
            List<GetGradientaiOpenaiApiKeyModelVersion>,
            List<Map<String, dynamic>>
          >(
            versions,
            (value) =>
    ...
    return GetGradientaiOpenaiApiKeyModel(
      agreements: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GetGradientaiOpenaiApiKeyModelAgreement>(
            guardedValue,
            (value) => GetGradientaiOpenaiApiKeyModelAgreement.fromMap(
      ...
      versions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GetGradientaiOpenaiApiKeyModelVersion>(
            guardedValue,
            (value) => GetGradientaiOpenaiApiKeyModelVersion.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
