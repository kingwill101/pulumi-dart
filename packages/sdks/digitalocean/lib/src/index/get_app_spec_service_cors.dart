...
class GetAppSpecServiceCors {
  ...
  factory GetAppSpecServiceCors.fromMap(Map<String, dynamic> map) {
    return GetAppSpecServiceCors(
      ...
      allowOrigins: (() { final guardedValue = map['allowOrigins']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GetAppSpecServiceCorsAllowOrigins.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
