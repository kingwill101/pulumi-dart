...
class GetAppSpecServiceCors {
  ...
  final GetAppSpecServiceCorsAllowOrigins? allowOrigins;
  ...
  factory GetAppSpecServiceCors.fromMap(Map<String, dynamic> map) {
    return GetAppSpecServiceCors(
      ...
      allowOrigins: map['allowOrigins'] == null ? null : GetAppSpecServiceCorsAllowOrigins.fromMap((map['allowOrigins'] as Map).cast<String, dynamic>()),
