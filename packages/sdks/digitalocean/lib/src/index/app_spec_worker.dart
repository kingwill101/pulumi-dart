...
class AppSpecWorker {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'envs':
          ?pulumi.Input.mapOptionalInputValue<
            List<AppSpecWorkerEnv>,
            List<Map<String, dynamic>>
          >(
            envs,
            (value) =>
                pulumi.Input.encodeList<AppSpecWorkerEnv, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return AppSpecWorker(
      alerts: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AppSpecWorkerAlert>(
            guardedValue,
            (value) => AppSpecWorkerAlert.fromMap(
      ...
      autoscaling: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AppSpecWorkerAutoscaling.fromMap(
      ...
      bitbucket: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AppSpecWorkerBitbucket.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      envs: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AppSpecWorkerEnv>(
            guardedValue,
            (value) => AppSpecWorkerEnv.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      logDestinations: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AppSpecWorkerLogDestination>(
            guardedValue,
            (value) => AppSpecWorkerLogDestination.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      termination: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AppSpecWorkerTermination.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
