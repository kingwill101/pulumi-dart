...
class GetGradientaiAgentParentAgentApiKeyInfo {
  /// API Key value
  ...
  /// Creates a new [GetGradientaiAgentParentAgentApiKeyInfo].
  ...
  /// [uuid] API Key value
  const GetGradientaiAgentParentAgentApiKeyInfo({
  ...
  factory GetGradientaiAgentParentAgentApiKeyInfo.fromMap(Map<String, dynamic> map) {
    return GetGradientaiAgentParentAgentApiKeyInfo(
