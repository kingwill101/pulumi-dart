...
class GradientaiKnowledgeBaseDataSource {
  ...
  factory GradientaiKnowledgeBaseDataSource.fromMap(Map<String, dynamic> map) {
    return GradientaiKnowledgeBaseDataSource(
      ...
      fileUploadDataSources: (() { final guardedValue = map['fileUploadDataSources']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GradientaiKnowledgeBaseDataSourceFileUploadDataSource>(guardedValue, (value) => GradientaiKnowledgeBaseDataSourceFileUploadDataSource.fromMap((value as Map).cast<String, dynamic>()))); })(),
      lastIndexingJobs: (() { final guardedValue = map['lastIndexingJobs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GradientaiKnowledgeBaseDataSourceLastIndexingJob>(guardedValue, (value) => GradientaiKnowledgeBaseDataSourceLastIndexingJob.fromMap((value as Map).cast<String, dynamic>()))); })(),
      spacesDataSources: (() { final guardedValue = map['spacesDataSources']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GradientaiKnowledgeBaseDataSourceSpacesDataSource>(guardedValue, (value) => GradientaiKnowledgeBaseDataSourceSpacesDataSource.fromMap((value as Map).cast<String, dynamic>()))); })(),
      updatedAt: (() { final guardedValue = map['updatedAt']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      uuid: (() { final guardedValue = map['uuid']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      webCrawlerDataSources: (() { final guardedValue = map['webCrawlerDataSources']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GradientaiKnowledgeBaseDataSourceWebCrawlerDataSource>(guardedValue, (value) => GradientaiKnowledgeBaseDataSourceWebCrawlerDataSource.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
