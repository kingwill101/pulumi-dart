...
class AppSpecJobGithub {
  ...
  /// Creates a new [AppSpecJobGithub].
  ...
  AppSpecJobGithub({this.branch, this.deployOnPush, this.repo});
  ...
  factory AppSpecJobGithub.fromMap(Map<String, dynamic> map) {
    return AppSpecJobGithub(
      branch: (() {
