...
class GetGenaiKnowledgeBasesKnowledgeBaseLastIndexingJob {
  ...
  /// Creates a new [GetGenaiKnowledgeBasesKnowledgeBaseLastIndexingJob].
  ...
  const GetGenaiKnowledgeBasesKnowledgeBaseLastIndexingJob({
  ...
  factory GetGenaiKnowledgeBasesKnowledgeBaseLastIndexingJob.fromMap(Map<String, dynamic> map) {
    return GetGenaiKnowledgeBasesKnowledgeBaseLastIndexingJob(
