...
class DropletAutoscaleState {
  ...
  final pulumi.Input<List<DropletAutoscaleCurrentUtilization>>?
  currentUtilizations;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'currentUtilizations':
          ?pulumi.Input.mapOptionalInputValue<
            List<DropletAutoscaleCurrentUtilization>,
  ...
  factory DropletAutoscaleState.fromMap(Map<String, dynamic> map) {
    return DropletAutoscaleState(
      ...
      currentUtilizations: (() {
        final guardedValue = map['currentUtilizations'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DropletAutoscaleCurrentUtilization>(
            guardedValue,
            (value) => DropletAutoscaleCurrentUtilization.fromMap(
      ...
      dropletTemplate: (() {
        final guardedValue = map['dropletTemplate'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
