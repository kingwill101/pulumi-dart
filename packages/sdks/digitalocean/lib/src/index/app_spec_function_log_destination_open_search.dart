...
class AppSpecFunctionLogDestinationOpenSearch {
  ...
  final pulumi.Input<AppSpecFunctionLogDestinationOpenSearchBasicAuth>
  basicAuth;
  ...
  factory AppSpecFunctionLogDestinationOpenSearch.fromMap(
    Map<String, dynamic> map,
  ) {
    return AppSpecFunctionLogDestinationOpenSearch(
      basicAuth: pulumi.Input.fromValue(
        AppSpecFunctionLogDestinationOpenSearchBasicAuth.fromMap(
