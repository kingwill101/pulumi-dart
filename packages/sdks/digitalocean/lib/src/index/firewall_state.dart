    ...
    return FirewallState(
      ...
      inboundRules: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FirewallInboundRule>(
            guardedValue,
            (value) => FirewallInboundRule.fromMap(
      ...
      outboundRules: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FirewallOutboundRule>(
            guardedValue,
            (value) => FirewallOutboundRule.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      pendingChanges: (() {
        final guardedValue = map['pendingChanges'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FirewallPendingChange>(
            guardedValue,
            (value) => FirewallPendingChange.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
