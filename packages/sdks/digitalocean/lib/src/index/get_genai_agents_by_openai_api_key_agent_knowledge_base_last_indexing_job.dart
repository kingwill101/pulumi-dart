...
class GetGenaiAgentsByOpenaiApiKeyAgentKnowledgeBaseLastIndexingJob {
  ...
  /// Creates a new [GetGenaiAgentsByOpenaiApiKeyAgentKnowledgeBaseLastIndexingJob].
  ...
  const GetGenaiAgentsByOpenaiApiKeyAgentKnowledgeBaseLastIndexingJob({
  ...
  factory GetGenaiAgentsByOpenaiApiKeyAgentKnowledgeBaseLastIndexingJob.fromMap(Map<String, dynamic> map) {
    return GetGenaiAgentsByOpenaiApiKeyAgentKnowledgeBaseLastIndexingJob(
