...
class GetGenaiAgentsByOpenaiApiKeyAgentDeployment {
  /// API Key value
  ...
  /// Creates a new [GetGenaiAgentsByOpenaiApiKeyAgentDeployment].
  ...
  factory GetGenaiAgentsByOpenaiApiKeyAgentDeployment.fromMap(Map<String, dynamic> map) {
    return GetGenaiAgentsByOpenaiApiKeyAgentDeployment(
