...
class AppSpecFunctionAlertDestinations {
  ...
  final pulumi.Input<List<AppSpecFunctionAlertDestinationsSlackWebhook>>?
  slackWebhooks;
  ...
  AppSpecFunctionAlertDestinations({this.emails, this.slackWebhooks});
    ...
    return <String, dynamic>{
      ...
      'slackWebhooks':
          ?pulumi.Input.mapOptionalInputValue<
            List<AppSpecFunctionAlertDestinationsSlackWebhook>,
    ...
    return AppSpecFunctionAlertDestinations(
      ...
      slackWebhooks: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AppSpecFunctionAlertDestinationsSlackWebhook>(
            guardedValue,
            (value) => AppSpecFunctionAlertDestinationsSlackWebhook.fromMap(
