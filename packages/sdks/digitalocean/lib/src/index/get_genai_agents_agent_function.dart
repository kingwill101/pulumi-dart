...
class GetGenaiAgentsAgentFunction {
  /// API Key value
  ...
  /// Creates a new [GetGenaiAgentsAgentFunction].
  ...
  factory GetGenaiAgentsAgentFunction.fromMap(Map<String, dynamic> map) {
    return GetGenaiAgentsAgentFunction(
      apiKey: (() {
