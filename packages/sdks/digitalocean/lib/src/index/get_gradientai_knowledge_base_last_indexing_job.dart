...
class GetGradientaiKnowledgeBaseLastIndexingJob {
  ...
  /// Creates a new [GetGradientaiKnowledgeBaseLastIndexingJob].
  ...
  const GetGradientaiKnowledgeBaseLastIndexingJob({
  ...
  factory GetGradientaiKnowledgeBaseLastIndexingJob.fromMap(Map<String, dynamic> map) {
    return GetGradientaiKnowledgeBaseLastIndexingJob(
