...
import 'get_genai_agent_template_model_agreement.dart';
import 'get_genai_agent_template_model_version.dart';

class GetGenaiAgentTemplateModel {
  /// Agreement information for the model
  final pulumi.Input<List<GetGenaiAgentTemplateModelAgreement>>? agreements;
  ...
  /// URL of the Model
  final pulumi.Input<List<GetGenaiAgentTemplateModelVersion>>? versions;

  /// Creates a new [GetGenaiAgentTemplateModel].
  ...
  const GetGenaiAgentTemplateModel({
    this.agreements,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'agreements': ?pulumi.Input.mapOptionalInputValue<List<GetGenaiAgentTemplateModelAgreement>, List<Map<String, dynamic>>>(agreements, (value) => pulumi.Input.encodeList<GetGenaiAgentTemplateModelAgreement, Map<String, dynamic>>(value, (value) => value.toMap())),
      'createdAt': createdAt,
      ...
      'url': ?url,
      'usecases': ?usecases,
      'versions': ?pulumi.Input.mapOptionalInputValue<List<GetGenaiAgentTemplateModelVersion>, List<Map<String, dynamic>>>(versions, (value) => pulumi.Input.encodeList<GetGenaiAgentTemplateModelVersion, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory GetGenaiAgentTemplateModel.fromMap(Map<String, dynamic> map) {
    return GetGenaiAgentTemplateModel(
      agreements: (() { final guardedValue = map['agreements']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetGenaiAgentTemplateModelAgreement>(guardedValue, (value) => GetGenaiAgentTemplateModelAgreement.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      versions: (() { final guardedValue = map['versions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetGenaiAgentTemplateModelVersion>(guardedValue, (value) => GetGenaiAgentTemplateModelVersion.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
