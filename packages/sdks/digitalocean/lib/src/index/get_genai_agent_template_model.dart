...
class GetGenaiAgentTemplateModel {
  ...
  factory GetGenaiAgentTemplateModel.fromMap(Map<String, dynamic> map) {
    return GetGenaiAgentTemplateModel(
      agreements: map['agreements'] == null ? null : (pulumi.Input.decodeList<GetGenaiAgentTemplateModelAgreement>(map['agreements'], (value) => GetGenaiAgentTemplateModelAgreement.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      versions: map['versions'] == null ? null : (pulumi.Input.decodeList<GetGenaiAgentTemplateModelVersion>(map['versions'], (value) => GetGenaiAgentTemplateModelVersion.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
