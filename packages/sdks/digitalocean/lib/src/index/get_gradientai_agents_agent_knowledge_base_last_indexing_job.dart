...
class GetGradientaiAgentsAgentKnowledgeBaseLastIndexingJob {
  ...
  /// Creates a new [GetGradientaiAgentsAgentKnowledgeBaseLastIndexingJob].
  ...
  const GetGradientaiAgentsAgentKnowledgeBaseLastIndexingJob({
  ...
  factory GetGradientaiAgentsAgentKnowledgeBaseLastIndexingJob.fromMap(Map<String, dynamic> map) {
    return GetGradientaiAgentsAgentKnowledgeBaseLastIndexingJob(
