...
class GetGradientaiAgentsByOpenaiApiKeyAgentModel {
  ...
  final pulumi.Input<
    List<GetGradientaiAgentsByOpenaiApiKeyAgentModelAgreement>
  >?
  agreements;
  ...
  /// URL of the Model
  final pulumi.Input<List<GetGradientaiAgentsByOpenaiApiKeyAgentModelVersion>>?
  versions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'versions':
          ?pulumi.Input.mapOptionalInputValue<
            List<GetGradientaiAgentsByOpenaiApiKeyAgentModelVersion>,
            List<Map<String, dynamic>>
          >(
            versions,
            (value) =>
  ...
  factory GetGradientaiAgentsByOpenaiApiKeyAgentModel.fromMap(
      ...
      agreements: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                GetGradientaiAgentsByOpenaiApiKeyAgentModelAgreement.fromMap(
      ...
      versions: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                GetGradientaiAgentsByOpenaiApiKeyAgentModelVersion.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
