...
class GetGradientaiAgentsByOpenaiApiKeyAgentModel {
  ...
  factory GetGradientaiAgentsByOpenaiApiKeyAgentModel.fromMap(Map<String, dynamic> map) {
    return GetGradientaiAgentsByOpenaiApiKeyAgentModel(
      agreements: (() { final guardedValue = map['agreements']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetGradientaiAgentsByOpenaiApiKeyAgentModelAgreement>(guardedValue, (value) => GetGradientaiAgentsByOpenaiApiKeyAgentModelAgreement.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      versions: (() { final guardedValue = map['versions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetGradientaiAgentsByOpenaiApiKeyAgentModelVersion>(guardedValue, (value) => GetGradientaiAgentsByOpenaiApiKeyAgentModelVersion.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
