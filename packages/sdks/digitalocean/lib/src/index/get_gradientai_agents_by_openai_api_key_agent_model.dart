...
class GetGradientaiAgentsByOpenaiApiKeyAgentModel {
  ...
  final List<GetGradientaiAgentsByOpenaiApiKeyAgentModelAgreement>? agreements;
  ...
  /// URL of the Model
  final List<GetGradientaiAgentsByOpenaiApiKeyAgentModelVersion>? versions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'agreements': ?agreements == null ? null : pulumi.Input.encodeList<GetGradientaiAgentsByOpenaiApiKeyAgentModelAgreement, Map<String, dynamic>>(agreements!, (value) => value.toMap()),
      'createdAt': createdAt,
      ...
      'url': ?url,
      'usecases': ?usecases,
      'versions': ?versions == null ? null : pulumi.Input.encodeList<GetGradientaiAgentsByOpenaiApiKeyAgentModelVersion, Map<String, dynamic>>(versions!, (value) => value.toMap()),
    };
  }
  ...
  factory GetGradientaiAgentsByOpenaiApiKeyAgentModel.fromMap(Map<String, dynamic> map) {
    return GetGradientaiAgentsByOpenaiApiKeyAgentModel(
      agreements: map['agreements'] == null ? null : pulumi.Input.decodeList<GetGradientaiAgentsByOpenaiApiKeyAgentModelAgreement>(map['agreements'], (value) => GetGradientaiAgentsByOpenaiApiKeyAgentModelAgreement.fromMap((value as Map).cast<String, dynamic>())),
      ...
      versions: map['versions'] == null ? null : pulumi.Input.decodeList<GetGradientaiAgentsByOpenaiApiKeyAgentModelVersion>(map['versions'], (value) => GetGradientaiAgentsByOpenaiApiKeyAgentModelVersion.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
