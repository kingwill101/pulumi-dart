    ...
    return <String, dynamic>{
      'agreements':
          ?pulumi.Input.mapOptionalInputValue<
            List<GetGradientaiAgentModelAgreement>,
      ...
      'versions':
          ?pulumi.Input.mapOptionalInputValue<
            List<GetGradientaiAgentModelVersion>,
            List<Map<String, dynamic>>
          >(
            versions,
            (value) =>
    ...
    return GetGradientaiAgentModel(
      agreements: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GetGradientaiAgentModelAgreement>(
            guardedValue,
            (value) => GetGradientaiAgentModelAgreement.fromMap(
      ...
      versions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GetGradientaiAgentModelVersion>(
            guardedValue,
            (value) => GetGradientaiAgentModelVersion.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
