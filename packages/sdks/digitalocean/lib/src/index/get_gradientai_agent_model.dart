...
import 'get_gradientai_agent_model_agreement.dart';
import 'get_gradientai_agent_model_version.dart';

class GetGradientaiAgentModel {
  /// Agreement information for the model
  final pulumi.Input<List<GetGradientaiAgentModelAgreement>>? agreements;
  ...
  /// URL of the Model
  final pulumi.Input<List<GetGradientaiAgentModelVersion>>? versions;

  /// Creates a new [GetGradientaiAgentModel].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'agreements': ?pulumi.Input.mapOptionalInputValue<List<GetGradientaiAgentModelAgreement>, List<Map<String, dynamic>>>(agreements, (value) => pulumi.Input.encodeList<GetGradientaiAgentModelAgreement, Map<String, dynamic>>(value, (value) => value.toMap())),
      'createdAt': createdAt,
      ...
      'url': ?url,
      'usecases': ?usecases,
      'versions': ?pulumi.Input.mapOptionalInputValue<List<GetGradientaiAgentModelVersion>, List<Map<String, dynamic>>>(versions, (value) => pulumi.Input.encodeList<GetGradientaiAgentModelVersion, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory GetGradientaiAgentModel.fromMap(Map<String, dynamic> map) {
    return GetGradientaiAgentModel(
      agreements: (() { final guardedValue = map['agreements']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetGradientaiAgentModelAgreement>(guardedValue, (value) => GetGradientaiAgentModelAgreement.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      versions: (() { final guardedValue = map['versions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetGradientaiAgentModelVersion>(guardedValue, (value) => GetGradientaiAgentModelVersion.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
