...
class GetGradientaiAgentModel {
  ...
  final List<GetGradientaiAgentModelAgreement>? agreements;
  ...
  /// URL of the Model
  final List<GetGradientaiAgentModelVersion>? versions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'agreements': ?agreements == null ? null : pulumi.Input.encodeList<GetGradientaiAgentModelAgreement, Map<String, dynamic>>(agreements!, (value) => value.toMap()),
      'createdAt': createdAt,
      ...
      'url': ?url,
      'usecases': ?usecases,
      'versions': ?versions == null ? null : pulumi.Input.encodeList<GetGradientaiAgentModelVersion, Map<String, dynamic>>(versions!, (value) => value.toMap()),
    };
  }

  factory GetGradientaiAgentModel.fromMap(Map<String, dynamic> map) {
    return GetGradientaiAgentModel(
      agreements: map['agreements'] == null ? null : pulumi.Input.decodeList<GetGradientaiAgentModelAgreement>(map['agreements'], (value) => GetGradientaiAgentModelAgreement.fromMap((value as Map).cast<String, dynamic>())),
      ...
      versions: map['versions'] == null ? null : pulumi.Input.decodeList<GetGradientaiAgentModelVersion>(map['versions'], (value) => GetGradientaiAgentModelVersion.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
