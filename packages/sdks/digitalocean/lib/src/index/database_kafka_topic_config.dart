...
class DatabaseKafkaTopicConfig {
  ...
  factory DatabaseKafkaTopicConfig.fromMap(Map<String, dynamic> map) {
    return DatabaseKafkaTopicConfig(
      ...
      deleteRetentionMs: (() {
        final guardedValue = map['deleteRetentionMs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      fileDeleteDelayMs: (() {
        final guardedValue = map['fileDeleteDelayMs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      flushMessages: (() {
        final guardedValue = map['flushMessages'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      flushMs: (() {
        final guardedValue = map['flushMs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      indexIntervalBytes: (() {
        final guardedValue = map['indexIntervalBytes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      maxCompactionLagMs: (() {
        final guardedValue = map['maxCompactionLagMs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      maxMessageBytes: (() {
        final guardedValue = map['maxMessageBytes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      messageDownConversionEnable: (() {
        final guardedValue = map['messageDownConversionEnable'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      messageFormatVersion: (() {
        final guardedValue = map['messageFormatVersion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      messageTimestampDifferenceMaxMs: (() {
        final guardedValue = map['messageTimestampDifferenceMaxMs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      messageTimestampType: (() {
        final guardedValue = map['messageTimestampType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      minCleanableDirtyRatio: (() {
        final guardedValue = map['minCleanableDirtyRatio'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as double);
      })(),
      minCompactionLagMs: (() {
        final guardedValue = map['minCompactionLagMs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      minInsyncReplicas: (() {
        final guardedValue = map['minInsyncReplicas'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      preallocate: (() {
        final guardedValue = map['preallocate'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      retentionBytes: (() {
        final guardedValue = map['retentionBytes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      retentionMs: (() {
        final guardedValue = map['retentionMs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      segmentBytes: (() {
        final guardedValue = map['segmentBytes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      segmentIndexBytes: (() {
        final guardedValue = map['segmentIndexBytes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      segmentJitterMs: (() {
        final guardedValue = map['segmentJitterMs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      segmentMs: (() {
        final guardedValue = map['segmentMs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
