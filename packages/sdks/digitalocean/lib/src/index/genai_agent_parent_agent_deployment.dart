...
class GenaiAgentParentAgentDeployment {
  /// API Key value
  ...
  /// Creates a new [GenaiAgentParentAgentDeployment].
  ...
  const GenaiAgentParentAgentDeployment({
    this.createdAt,
    this.name,
    this.status,
    this.updatedAt,
  ...
  factory GenaiAgentParentAgentDeployment.fromMap(Map<String, dynamic> map) {
    return GenaiAgentParentAgentDeployment(
