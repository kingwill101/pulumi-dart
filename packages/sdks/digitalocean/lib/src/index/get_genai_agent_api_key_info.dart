...
class GetGenaiAgentApiKeyInfo {
  ...
  /// Creates a new [GetGenaiAgentApiKeyInfo].
  ...
  factory GetGenaiAgentApiKeyInfo.fromMap(Map<String, dynamic> map) {
    return GetGenaiAgentApiKeyInfo(
