...
class GetGradientaiCustomModelsCustomModel {
  ...
  factory GetGradientaiCustomModelsCustomModel.fromMap(Map<String, dynamic> map) {
    return GetGradientaiCustomModelsCustomModel(
      ...
      contextLength: pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(map['contextLength'])),
      costEstimatePerMonth: pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(map['costEstimatePerMonth'])),
      createdAt: pulumi.Input.fromValue(map['createdAt'] as String),
      description: pulumi.Input.fromValue(map['description'] as String),
      errorMessage: pulumi.Input.fromValue(map['errorMessage'] as String),
      fileCount: pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(map['fileCount'])),
