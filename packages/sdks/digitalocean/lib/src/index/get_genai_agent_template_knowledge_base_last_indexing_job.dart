...
class GetGenaiAgentTemplateKnowledgeBaseLastIndexingJob {
  ...
  /// Creates a new [GetGenaiAgentTemplateKnowledgeBaseLastIndexingJob].
  ...
  factory GetGenaiAgentTemplateKnowledgeBaseLastIndexingJob.fromMap(Map<String, dynamic> map) {
    return GetGenaiAgentTemplateKnowledgeBaseLastIndexingJob(
