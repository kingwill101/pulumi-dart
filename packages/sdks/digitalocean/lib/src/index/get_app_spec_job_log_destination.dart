    ...
    return GetAppSpecJobLogDestination(
      datadog: (() {
        ...
        return pulumi.Input.fromValue(
          GetAppSpecJobLogDestinationDatadog.fromMap(
      ...
      logtail: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GetAppSpecJobLogDestinationLogtail.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      openSearch: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GetAppSpecJobLogDestinationOpenSearch.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      papertrail: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GetAppSpecJobLogDestinationPapertrail.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
