...
class GetKubernetesClusterNodePool {
  ...
  factory GetKubernetesClusterNodePool.fromMap(Map<String, dynamic> map) {
    return GetKubernetesClusterNodePool(
      ...
      taints: pulumi.Input.fromValue(pulumi.Input.decodeList<GetKubernetesClusterNodePoolTaint>(map['taints']!, (value) => GetKubernetesClusterNodePoolTaint.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
