...
class GradientaiAgentKnowledgeBaseLastIndexingJob {
  ...
  /// Creates a new [GradientaiAgentKnowledgeBaseLastIndexingJob].
  ...
  const GradientaiAgentKnowledgeBaseLastIndexingJob({
  ...
  factory GradientaiAgentKnowledgeBaseLastIndexingJob.fromMap(Map<String, dynamic> map) {
    return GradientaiAgentKnowledgeBaseLastIndexingJob(
