...
class GetGradientaiAgentsByOpenaiApiKeyAgentAnthropicApiKey {
  ...
  /// Creates a new [GetGradientaiAgentsByOpenaiApiKeyAgentAnthropicApiKey].
  ...
  /// [uuid] API Key value
  const GetGradientaiAgentsByOpenaiApiKeyAgentAnthropicApiKey({
  ...
  factory GetGradientaiAgentsByOpenaiApiKeyAgentAnthropicApiKey.fromMap(Map<String, dynamic> map) {
    return GetGradientaiAgentsByOpenaiApiKeyAgentAnthropicApiKey(
