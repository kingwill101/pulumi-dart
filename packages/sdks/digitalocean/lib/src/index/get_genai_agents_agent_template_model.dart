...
class GetGenaiAgentsAgentTemplateModel {
  ...
  factory GetGenaiAgentsAgentTemplateModel.fromMap(Map<String, dynamic> map) {
    return GetGenaiAgentsAgentTemplateModel(
      agreements: map['agreements'] == null ? null : (pulumi.Input.decodeList<GetGenaiAgentsAgentTemplateModelAgreement>(map['agreements'], (value) => GetGenaiAgentsAgentTemplateModelAgreement.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      versions: map['versions'] == null ? null : (pulumi.Input.decodeList<GetGenaiAgentsAgentTemplateModelVersion>(map['versions'], (value) => GetGenaiAgentsAgentTemplateModelVersion.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
