...
import 'get_genai_agents_agent_template_model_agreement.dart';
import 'get_genai_agents_agent_template_model_version.dart';

class GetGenaiAgentsAgentTemplateModel {
  /// Agreement information for the model
  final List<GetGenaiAgentsAgentTemplateModelAgreement>? agreements;
  ...
  /// URL of the Model
  final List<GetGenaiAgentsAgentTemplateModelVersion>? versions;

  /// Creates a new [GetGenaiAgentsAgentTemplateModel].
  ...
  GetGenaiAgentsAgentTemplateModel({
    this.agreements,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'agreements': ?agreements == null ? null : pulumi.Input.encodeList<GetGenaiAgentsAgentTemplateModelAgreement, Map<String, dynamic>>(agreements!, (value) => value.toMap()),
      'createdAt': createdAt,
      ...
      'url': ?url,
      'usecases': ?usecases,
      'versions': ?versions == null ? null : pulumi.Input.encodeList<GetGenaiAgentsAgentTemplateModelVersion, Map<String, dynamic>>(versions!, (value) => value.toMap()),
    };
  }

  factory GetGenaiAgentsAgentTemplateModel.fromMap(Map<String, dynamic> map) {
    return GetGenaiAgentsAgentTemplateModel(
      agreements: map['agreements'] == null ? null : pulumi.Input.decodeList<GetGenaiAgentsAgentTemplateModelAgreement>(map['agreements'], (value) => GetGenaiAgentsAgentTemplateModelAgreement.fromMap((value as Map).cast<String, dynamic>())),
      ...
      versions: map['versions'] == null ? null : pulumi.Input.decodeList<GetGenaiAgentsAgentTemplateModelVersion>(map['versions'], (value) => GetGenaiAgentsAgentTemplateModelVersion.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
