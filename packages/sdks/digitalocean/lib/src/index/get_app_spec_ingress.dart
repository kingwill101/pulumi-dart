...
class GetAppSpecIngress {
  ...
  GetAppSpecIngress({this.rules, required this.secureHeader});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'rules':
          ?pulumi.Input.mapOptionalInputValue<
            List<GetAppSpecIngressRule>,
    ...
    return GetAppSpecIngress(
      rules: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GetAppSpecIngressRule>(
            guardedValue,
            (value) => GetAppSpecIngressRule.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      })(),
      secureHeader: pulumi.Input.fromValue(
        GetAppSpecIngressSecureHeader.fromMap(
          (map['secureHeader']! as Map).cast<String, dynamic>(),
        ),
      ),
    );
  }
