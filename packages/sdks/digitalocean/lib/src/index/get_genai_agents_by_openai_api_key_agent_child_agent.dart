...
class GetGenaiAgentsByOpenaiApiKeyAgentChildAgent {
  ...
  final pulumi.Input<
    List<GetGenaiAgentsByOpenaiApiKeyAgentChildAgentAnthropicApiKey>
  >?
  anthropicApiKeys;

  /// List of API Key Infos
  final pulumi.Input<
    List<GetGenaiAgentsByOpenaiApiKeyAgentChildAgentApiKeyInfo>
  >?
  apiKeyInfos;

  /// List of API Keys
  final pulumi.Input<List<GetGenaiAgentsByOpenaiApiKeyAgentChildAgentApiKey>>?
  apiKeys;

  /// List of Chatbot Identifiers
  final pulumi.Input<
    List<GetGenaiAgentsByOpenaiApiKeyAgentChildAgentChatbotIdentifier>
  >?
  chatbotIdentifiers;

  /// ChatBot configuration
  final pulumi.Input<List<GetGenaiAgentsByOpenaiApiKeyAgentChildAgentChatbot>>?
  chatbots;

  /// List of API Key Infos
  final pulumi.Input<
    List<GetGenaiAgentsByOpenaiApiKeyAgentChildAgentDeployment>
  >?
  deployments;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'apiKeys':
          ?pulumi.Input.mapOptionalInputValue<
            List<GetGenaiAgentsByOpenaiApiKeyAgentChildAgentApiKey>,
            List<Map<String, dynamic>>
          >(
            apiKeys,
            (value) =>
      ...
      'chatbots':
          ?pulumi.Input.mapOptionalInputValue<
            List<GetGenaiAgentsByOpenaiApiKeyAgentChildAgentChatbot>,
            List<Map<String, dynamic>>
          >(
            chatbots,
            (value) =>
  ...
  factory GetGenaiAgentsByOpenaiApiKeyAgentChildAgent.fromMap(
      ...
      anthropicApiKeys: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                GetGenaiAgentsByOpenaiApiKeyAgentChildAgentAnthropicApiKey.fromMap(
      ...
      apiKeyInfos: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                GetGenaiAgentsByOpenaiApiKeyAgentChildAgentApiKeyInfo.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      apiKeys: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                GetGenaiAgentsByOpenaiApiKeyAgentChildAgentApiKey.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      chatbotIdentifiers: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                GetGenaiAgentsByOpenaiApiKeyAgentChildAgentChatbotIdentifier.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      chatbots: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                GetGenaiAgentsByOpenaiApiKeyAgentChildAgentChatbot.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      deployments: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                GetGenaiAgentsByOpenaiApiKeyAgentChildAgentDeployment.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
