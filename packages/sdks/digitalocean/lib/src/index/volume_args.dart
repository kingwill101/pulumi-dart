...
class VolumeArgs {
  ...
  final pulumi.Input<dynamic>? initialFilesystemType;
  ...
  factory VolumeArgs.fromMap(Map<String, dynamic> map) {
    return VolumeArgs(
      ...
      initialFilesystemType: (() { final guardedValue = map['initialFilesystemType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
