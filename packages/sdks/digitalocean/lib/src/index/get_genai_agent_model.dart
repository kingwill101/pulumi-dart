...
class GetGenaiAgentModel {
  ...
  final List<GetGenaiAgentModelAgreement>? agreements;
  ...
  /// URL of the Model
  final List<GetGenaiAgentModelVersion>? versions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'agreements': ?agreements == null ? null : pulumi.Input.encodeList<GetGenaiAgentModelAgreement, Map<String, dynamic>>(agreements!, (value) => value.toMap()),
      'createdAt': createdAt,
      ...
      'url': ?url,
      'usecases': ?usecases,
      'versions': ?versions == null ? null : pulumi.Input.encodeList<GetGenaiAgentModelVersion, Map<String, dynamic>>(versions!, (value) => value.toMap()),
    };
  }

  factory GetGenaiAgentModel.fromMap(Map<String, dynamic> map) {
    return GetGenaiAgentModel(
      agreements: map['agreements'] == null ? null : pulumi.Input.decodeList<GetGenaiAgentModelAgreement>(map['agreements'], (value) => GetGenaiAgentModelAgreement.fromMap((value as Map).cast<String, dynamic>())),
      ...
      versions: map['versions'] == null ? null : pulumi.Input.decodeList<GetGenaiAgentModelVersion>(map['versions'], (value) => GetGenaiAgentModelVersion.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
