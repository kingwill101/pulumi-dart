...
class GetDropletAutoscaleConfig {
  ...
  factory GetDropletAutoscaleConfig.fromMap(Map<String, dynamic> map) {
    return GetDropletAutoscaleConfig(
      cooldownMinutes: (map['cooldownMinutes'] as int).input(),
      ...
      targetMemoryUtilization: (map['targetMemoryUtilization'] as double).input(),
      targetNumberInstances: (map['targetNumberInstances'] as int).input(),
    );
  }
}
