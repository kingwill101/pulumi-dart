...
class GetDropletAutoscaleConfig {
  ...
  factory GetDropletAutoscaleConfig.fromMap(Map<String, dynamic> map) {
    return GetDropletAutoscaleConfig(
      ...
      targetMemoryUtilization: pulumi.Input.fromValue(
        map['targetMemoryUtilization'] as double,
      ),
      targetNumberInstances: pulumi.Input.fromValue(
        map['targetNumberInstances'] as int,
      ),
    );
  }
}
