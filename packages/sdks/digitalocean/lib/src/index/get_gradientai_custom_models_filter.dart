...
class GetGradientaiCustomModelsFilter {
  final pulumi.Input<bool>? all;
  final pulumi.Input<String> key;
  final pulumi.Input<String>? matchBy;
  final pulumi.Input<List<String>> values;

  /// Creates a new [GetGradientaiCustomModelsFilter].
  /// [all] Optional.
  /// [key] Required.
  /// [matchBy] Optional.
  /// [values] Required.
  const GetGradientaiCustomModelsFilter({
    this.all,
    required this.key,
    this.matchBy,
  ...
  factory GetGradientaiCustomModelsFilter.fromMap(Map<String, dynamic> map) {
    return GetGradientaiCustomModelsFilter(
