...
class AppSpecFunctionCors {
  ...
  final AppSpecFunctionCorsAllowOrigins? allowOrigins;
  ...
  factory AppSpecFunctionCors.fromMap(Map<String, dynamic> map) {
    return AppSpecFunctionCors(
      ...
      allowOrigins: map['allowOrigins'] == null ? null : AppSpecFunctionCorsAllowOrigins.fromMap((map['allowOrigins'] as Map).cast<String, dynamic>()),
