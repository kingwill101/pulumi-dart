...
class AppSpecFunctionCors {
  ...
  factory AppSpecFunctionCors.fromMap(Map<String, dynamic> map) {
    return AppSpecFunctionCors(
      ...
      allowOrigins: (() { final guardedValue = map['allowOrigins']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AppSpecFunctionCorsAllowOrigins.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
