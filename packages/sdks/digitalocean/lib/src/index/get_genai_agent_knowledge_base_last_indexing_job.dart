...
class GetGenaiAgentKnowledgeBaseLastIndexingJob {
  ...
  /// Creates a new [GetGenaiAgentKnowledgeBaseLastIndexingJob].
  ...
  const GetGenaiAgentKnowledgeBaseLastIndexingJob({
  ...
  factory GetGenaiAgentKnowledgeBaseLastIndexingJob.fromMap(Map<String, dynamic> map) {
    return GetGenaiAgentKnowledgeBaseLastIndexingJob(
