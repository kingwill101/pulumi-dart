...
class GetGenaiAgentParentAgentDeployment {
  /// API Key value
  ...
  /// Creates a new [GetGenaiAgentParentAgentDeployment].
  ...
  const GetGenaiAgentParentAgentDeployment({
  ...
  factory GetGenaiAgentParentAgentDeployment.fromMap(Map<String, dynamic> map) {
    return GetGenaiAgentParentAgentDeployment(
