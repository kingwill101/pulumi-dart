...
class GetAppSpecIngressRuleMatch {
  ...
  GetAppSpecIngressRuleMatch({required this.authority, required this.path});
  ...
  factory GetAppSpecIngressRuleMatch.fromMap(Map<String, dynamic> map) {
    return GetAppSpecIngressRuleMatch(
      authority: pulumi.Input.fromValue(
        GetAppSpecIngressRuleMatchAuthority.fromMap(
          (map['authority']! as Map).cast<String, dynamic>(),
        ),
      ),
      path: pulumi.Input.fromValue(
        GetAppSpecIngressRuleMatchPath.fromMap(
