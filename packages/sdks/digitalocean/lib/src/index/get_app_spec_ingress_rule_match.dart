...
class GetAppSpecIngressRuleMatch {
  ...
  factory GetAppSpecIngressRuleMatch.fromMap(Map<String, dynamic> map) {
    return GetAppSpecIngressRuleMatch(
      authority: (GetAppSpecIngressRuleMatchAuthority.fromMap((map['authority'] as Map).cast<String, dynamic>())).input(),
      path: (GetAppSpecIngressRuleMatchPath.fromMap((map['path'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
