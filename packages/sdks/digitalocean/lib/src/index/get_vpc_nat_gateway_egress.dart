...
class GetVpcNatGatewayEgress {
  ...
  factory GetVpcNatGatewayEgress.fromMap(Map<String, dynamic> map) {
    return GetVpcNatGatewayEgress(
      publicGateways: (pulumi.Input.decodeList<GetVpcNatGatewayEgressPublicGateway>(map['publicGateways'], (value) => GetVpcNatGatewayEgressPublicGateway.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
