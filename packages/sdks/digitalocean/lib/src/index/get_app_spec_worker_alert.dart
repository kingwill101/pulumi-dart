...
class GetAppSpecWorkerAlert {
  ...
  factory GetAppSpecWorkerAlert.fromMap(Map<String, dynamic> map) {
    return GetAppSpecWorkerAlert(
      destinations: (() { final guardedValue = map['destinations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GetAppSpecWorkerAlertDestinations.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
