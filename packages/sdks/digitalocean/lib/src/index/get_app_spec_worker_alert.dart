...
class GetAppSpecWorkerAlert {
  final GetAppSpecWorkerAlertDestinations? destinations;
  ...
  factory GetAppSpecWorkerAlert.fromMap(Map<String, dynamic> map) {
    return GetAppSpecWorkerAlert(
      destinations: map['destinations'] == null ? null : GetAppSpecWorkerAlertDestinations.fromMap((map['destinations'] as Map).cast<String, dynamic>()),
