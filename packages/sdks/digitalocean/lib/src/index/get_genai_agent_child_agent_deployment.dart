...
class GetGenaiAgentChildAgentDeployment {
  /// API Key value
  ...
  /// Creates a new [GetGenaiAgentChildAgentDeployment].
  ...
  const GetGenaiAgentChildAgentDeployment({
  ...
  factory GetGenaiAgentChildAgentDeployment.fromMap(Map<String, dynamic> map) {
    return GetGenaiAgentChildAgentDeployment(
