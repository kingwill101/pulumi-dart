...
class AppSpecIngressRuleCors {
  ...
  final pulumi.Input<AppSpecIngressRuleCorsAllowOrigins>? allowOrigins;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'allowOrigins': ?pulumi.Input.mapOptionalInputValue<AppSpecIngressRuleCorsAllowOrigins, Map<String, dynamic>>(allowOrigins, (value) => value.toMap()),
  ...
  factory AppSpecIngressRuleCors.fromMap(Map<String, dynamic> map) {
    return AppSpecIngressRuleCors(
      ...
      allowOrigins: (() { final guardedValue = map['allowOrigins']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AppSpecIngressRuleCorsAllowOrigins.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
