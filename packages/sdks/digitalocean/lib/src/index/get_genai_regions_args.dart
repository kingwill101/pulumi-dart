...
class GetGenaiRegionsArgs {
  ...
  factory GetGenaiRegionsArgs.fromMap(Map<String, dynamic> map) {
    return GetGenaiRegionsArgs(
      filters: (() { final guardedValue = map['filters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetGenaiRegionsFilter>(guardedValue, (value) => GetGenaiRegionsFilter.fromMap((value as Map).cast<String, dynamic>()))); })(),
      sorts: (() { final guardedValue = map['sorts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetGenaiRegionsSort>(guardedValue, (value) => GetGenaiRegionsSort.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
