...
class GetGradientaiAgentsAgentTemplate {
  ...
  factory GetGradientaiAgentsAgentTemplate.fromMap(Map<String, dynamic> map) {
    return GetGradientaiAgentsAgentTemplate(
      ...
      knowledgeBases: (() { final guardedValue = map['knowledgeBases']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetGradientaiAgentsAgentTemplateKnowledgeBase>(guardedValue, (value) => GetGradientaiAgentsAgentTemplateKnowledgeBase.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      models: (() { final guardedValue = map['models']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetGradientaiAgentsAgentTemplateModel>(guardedValue, (value) => GetGradientaiAgentsAgentTemplateModel.fromMap((value as Map).cast<String, dynamic>()))); })(),
