...
class DatabasePostgresqlConfig extends pulumi.CustomResource {
  ...
  DatabasePostgresqlConfig(
    ...
    autovacuumAnalyzeScaleFactor = registerOutput<double>(
      'autovacuumAnalyzeScaleFactor',
    );
    autovacuumAnalyzeThreshold = registerOutput<int>(
    ...
    autovacuumVacuumCostDelay = registerOutput<int>(
      'autovacuumVacuumCostDelay',
    );
    autovacuumVacuumCostLimit = registerOutput<int>(
      'autovacuumVacuumCostLimit',
    );
    autovacuumVacuumScaleFactor = registerOutput<double>(
      'autovacuumVacuumScaleFactor',
    );
    autovacuumVacuumThreshold = registerOutput<int>(
    ...
    idleInTransactionSessionTimeout = registerOutput<int>(
    ...
    maxLogicalReplicationWorkers = registerOutput<int>(
      'maxLogicalReplicationWorkers',
    );
    maxParallelWorkers = registerOutput<int>('maxParallelWorkers');
    maxParallelWorkersPerGather = registerOutput<int>(
      'maxParallelWorkersPerGather',
    );
    maxPredLocksPerTransaction = registerOutput<int>(
