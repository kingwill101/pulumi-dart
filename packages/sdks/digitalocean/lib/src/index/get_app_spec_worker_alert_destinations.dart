...
class GetAppSpecWorkerAlertDestinations {
  ...
  const GetAppSpecWorkerAlertDestinations({
    this.emails,
    this.slackWebhooks,
  });
  ...
  factory GetAppSpecWorkerAlertDestinations.fromMap(Map<String, dynamic> map) {
    return GetAppSpecWorkerAlertDestinations(
      ...
      slackWebhooks: (() { final guardedValue = map['slackWebhooks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetAppSpecWorkerAlertDestinationsSlackWebhook>(guardedValue, (value) => GetAppSpecWorkerAlertDestinationsSlackWebhook.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
