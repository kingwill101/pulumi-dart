...
class GetAppSpecStaticSiteBitbucket {
  ...
  /// Creates a new [GetAppSpecStaticSiteBitbucket].
  ...
  GetAppSpecStaticSiteBitbucket({this.branch, this.deployOnPush, this.repo});
  ...
  factory GetAppSpecStaticSiteBitbucket.fromMap(Map<String, dynamic> map) {
    return GetAppSpecStaticSiteBitbucket(
      branch: (() {
