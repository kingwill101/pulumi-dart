    ...
    return AppSpecFunctionLogDestination(
      datadog: (() {
        ...
        return pulumi.Input.fromValue(
          AppSpecFunctionLogDestinationDatadog.fromMap(
      ...
      logtail: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AppSpecFunctionLogDestinationLogtail.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      openSearch: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AppSpecFunctionLogDestinationOpenSearch.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      papertrail: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AppSpecFunctionLogDestinationPapertrail.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
