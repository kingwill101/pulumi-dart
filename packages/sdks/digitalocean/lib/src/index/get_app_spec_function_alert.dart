...
class GetAppSpecFunctionAlert {
  ...
  factory GetAppSpecFunctionAlert.fromMap(Map<String, dynamic> map) {
    return GetAppSpecFunctionAlert(
      destinations: (() { final guardedValue = map['destinations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GetAppSpecFunctionAlertDestinations.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
