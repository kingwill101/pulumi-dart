...
class GradientaiAgentTemplateKnowledgeBaseLastIndexingJob {
  ...
  /// Creates a new [GradientaiAgentTemplateKnowledgeBaseLastIndexingJob].
  ...
  factory GradientaiAgentTemplateKnowledgeBaseLastIndexingJob.fromMap(Map<String, dynamic> map) {
    return GradientaiAgentTemplateKnowledgeBaseLastIndexingJob(
