...
class GenaiAgentChildAgentDeployment {
  /// API Key value
  ...
  /// Creates a new [GenaiAgentChildAgentDeployment].
  ...
  const GenaiAgentChildAgentDeployment({
    this.createdAt,
    this.name,
    this.status,
    this.updatedAt,
  ...
  factory GenaiAgentChildAgentDeployment.fromMap(Map<String, dynamic> map) {
    return GenaiAgentChildAgentDeployment(
