...
class GetLoadBalancerGlbSetting {
    ...
    return <String, dynamic>{
      'cdns':
          pulumi.Input.mapInputValue<
            List<GetLoadBalancerGlbSettingCdn>,
  ...
  factory GetLoadBalancerGlbSetting.fromMap(Map<String, dynamic> map) {
    return GetLoadBalancerGlbSetting(
      cdns: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetLoadBalancerGlbSettingCdn>(
          map['cdns']!,
          (value) => GetLoadBalancerGlbSettingCdn.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      failoverThreshold: pulumi.Input.fromValue(
        map['failoverThreshold'] as int,
      ),
      regionPriorities: pulumi.Input.fromValue(
        (map['regionPriorities'] as Map).cast<String, int>(),
      ),
