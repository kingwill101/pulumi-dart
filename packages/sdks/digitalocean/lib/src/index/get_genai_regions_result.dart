...
class GetGenaiRegionsResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'id': ?id,
      'regions': ?(() { final guardedValue = regions; if (guardedValue == null) return null; return pulumi.Input.encodeList<GetGenaiRegionsRegion, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
  ...
  factory GetGenaiRegionsResult.fromMap(Map<String, dynamic> map) {
    return GetGenaiRegionsResult(
      ...
      regions: (() { final guardedValue = map['regions']; if (guardedValue == null) return null; return pulumi.Input.decodeList<GetGenaiRegionsRegion>(guardedValue, (value) => GetGenaiRegionsRegion.fromMap((value as Map).cast<String, dynamic>())); })(),
