...
class GetGenaiRegionsResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'id': id,
      'regions':
          pulumi.Input.encodeList<GetGenaiRegionsRegion, Map<String, dynamic>>(
            regions,
            (value) => value.toMap(),
          ),
      'sorts': ?(() {
  ...
  factory GetGenaiRegionsResult.fromMap(Map<String, dynamic> map) {
    return GetGenaiRegionsResult(
      filters: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<GetGenaiRegionsFilter>(
          guardedValue,
      ...
      id: map['id'] as String,
      regions: pulumi.Input.decodeList<GetGenaiRegionsRegion>(
        map['regions']!,
        (value) => GetGenaiRegionsRegion.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      sorts: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<GetGenaiRegionsSort>(
          guardedValue,
