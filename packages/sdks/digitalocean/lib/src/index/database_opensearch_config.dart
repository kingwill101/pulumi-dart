...
class DatabaseOpensearchConfig extends pulumi.CustomResource {
  ...
  DatabaseOpensearchConfig(
    ...
    actionAutoCreateIndexEnabled = registerOutput<bool>(
      'actionAutoCreateIndexEnabled',
    );
    actionDestructiveRequiresName = registerOutput<bool>(
      'actionDestructiveRequiresName',
    );
    clusterId = registerOutput<String>('clusterId');
    clusterMaxShardsPerNode = registerOutput<int>('clusterMaxShardsPerNode');
    clusterRoutingAllocationNodeConcurrentRecoveries = registerOutput<int>(
      'clusterRoutingAllocationNodeConcurrentRecoveries',
    );
    enableSecurityAudit = registerOutput<bool>('enableSecurityAudit');
    httpMaxContentLengthBytes = registerOutput<int>(
      'httpMaxContentLengthBytes',
    );
    httpMaxHeaderSizeBytes = registerOutput<int>('httpMaxHeaderSizeBytes');
    httpMaxInitialLineLengthBytes = registerOutput<int>(
      'httpMaxInitialLineLengthBytes',
    );
    indicesFielddataCacheSizePercentage = registerOutput<int>(
      'indicesFielddataCacheSizePercentage',
    );
    indicesMemoryIndexBufferSizePercentage = registerOutput<int>(
      'indicesMemoryIndexBufferSizePercentage',
    );
    indicesMemoryMaxIndexBufferSizeMb = registerOutput<int>(
      'indicesMemoryMaxIndexBufferSizeMb',
    );
    indicesMemoryMinIndexBufferSizeMb = registerOutput<int>(
      'indicesMemoryMinIndexBufferSizeMb',
    );
    indicesQueriesCacheSizePercentage = registerOutput<int>(
      'indicesQueriesCacheSizePercentage',
    );
    indicesQueryBoolMaxClauseCount = registerOutput<int>(
      'indicesQueryBoolMaxClauseCount',
    );
    indicesRecoveryMaxConcurrentFileChunks = registerOutput<int>(
      'indicesRecoveryMaxConcurrentFileChunks',
    );
    indicesRecoveryMaxMbPerSec = registerOutput<int>(
    ...
    ismHistoryRolloverCheckPeriodHours = registerOutput<int>(
      'ismHistoryRolloverCheckPeriodHours',
    );
    ismHistoryRolloverRetentionPeriodDays = registerOutput<int>(
      'ismHistoryRolloverRetentionPeriodDays',
    );
    overrideMainResponseVersion = registerOutput<bool>(
      'overrideMainResponseVersion',
    );
    pluginsAlertingFilterByBackendRolesEnabled = registerOutput<bool>(
      'pluginsAlertingFilterByBackendRolesEnabled',
    );
    reindexRemoteWhitelists = registerOutput<List<String>?>(
      'reindexRemoteWhitelists',
    );
    scriptMaxCompilationsRate = registerOutput<String>(
      'scriptMaxCompilationsRate',
    );
    searchMaxBuckets = registerOutput<int>('searchMaxBuckets');
    threadPoolAnalyzeQueueSize = registerOutput<int>(
    ...
    threadPoolSearchQueueSize = registerOutput<int>(
      'threadPoolSearchQueueSize',
    );
    threadPoolSearchSize = registerOutput<int>('threadPoolSearchSize');
    threadPoolSearchThrottledQueueSize = registerOutput<int>(
      'threadPoolSearchThrottledQueueSize',
    );
    threadPoolSearchThrottledSize = registerOutput<int>(
