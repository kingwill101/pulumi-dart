...
class GetGradientaiAgentArgs {
  ...
  factory GetGradientaiAgentArgs.fromMap(Map<String, dynamic> map) {
    return GetGradientaiAgentArgs(
      agentGuardrails: map['agentGuardrails'] == null ? null : (pulumi.Input.decodeList<GetGradientaiAgentAgentGuardrail>(map['agentGuardrails']!, (value) => GetGradientaiAgentAgentGuardrail.fromMap((value as Map).cast<String, dynamic>()))).input(),
      agentId: (map['agentId'] as String).input(),
      anthropicApiKeys: map['anthropicApiKeys'] == null ? null : (pulumi.Input.decodeList<GetGradientaiAgentAnthropicApiKey>(map['anthropicApiKeys']!, (value) => GetGradientaiAgentAnthropicApiKey.fromMap((value as Map).cast<String, dynamic>()))).input(),
      apiKeyInfos: map['apiKeyInfos'] == null ? null : (pulumi.Input.decodeList<GetGradientaiAgentApiKeyInfo>(map['apiKeyInfos']!, (value) => GetGradientaiAgentApiKeyInfo.fromMap((value as Map).cast<String, dynamic>()))).input(),
      apiKeys: map['apiKeys'] == null ? null : (pulumi.Input.decodeList<GetGradientaiAgentApiKey>(map['apiKeys']!, (value) => GetGradientaiAgentApiKey.fromMap((value as Map).cast<String, dynamic>()))).input(),
      chatbotIdentifiers: map['chatbotIdentifiers'] == null ? null : (pulumi.Input.decodeList<GetGradientaiAgentChatbotIdentifier>(map['chatbotIdentifiers']!, (value) => GetGradientaiAgentChatbotIdentifier.fromMap((value as Map).cast<String, dynamic>()))).input(),
      chatbots: map['chatbots'] == null ? null : (pulumi.Input.decodeList<GetGradientaiAgentChatbot>(map['chatbots']!, (value) => GetGradientaiAgentChatbot.fromMap((value as Map).cast<String, dynamic>()))).input(),
      deployments: map['deployments'] == null ? null : (pulumi.Input.decodeList<GetGradientaiAgentDeployment>(map['deployments']!, (value) => GetGradientaiAgentDeployment.fromMap((value as Map).cast<String, dynamic>()))).input(),
      description: map['description'] == null ? null : (map['description']! as String).input(),
      functions: map['functions'] == null ? null : (pulumi.Input.decodeList<GetGradientaiAgentFunction>(map['functions']!, (value) => GetGradientaiAgentFunction.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ifCase: map['ifCase'] == null ? null : (map['ifCase']! as String).input(),
      k: map['k'] == null ? null : (map['k']! as int).input(),
      knowledgeBases: map['knowledgeBases'] == null ? null : (pulumi.Input.decodeList<GetGradientaiAgentKnowledgeBase>(map['knowledgeBases']!, (value) => GetGradientaiAgentKnowledgeBase.fromMap((value as Map).cast<String, dynamic>()))).input(),
      maxTokens: map['maxTokens'] == null ? null : (map['maxTokens']! as int).input(),
      models: map['models'] == null ? null : (pulumi.Input.decodeList<GetGradientaiAgentModel>(map['models']!, (value) => GetGradientaiAgentModel.fromMap((value as Map).cast<String, dynamic>()))).input(),
      openAiApiKeys: map['openAiApiKeys'] == null ? null : (pulumi.Input.decodeList<GetGradientaiAgentOpenAiApiKey>(map['openAiApiKeys']!, (value) => GetGradientaiAgentOpenAiApiKey.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      templates: map['templates'] == null ? null : (pulumi.Input.decodeList<GetGradientaiAgentTemplate>(map['templates']!, (value) => GetGradientaiAgentTemplate.fromMap((value as Map).cast<String, dynamic>()))).input(),
