...
import 'database_valkey_config_state.dart';
...
class DatabaseValkeyConfig extends pulumi.CustomResource {
  ...
  /// Gets an existing [DatabaseValkeyConfig] resource's state with the given [name] and [id].
  static DatabaseValkeyConfig get(
    String name,
