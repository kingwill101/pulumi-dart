...
class GetGradientaiAgentDeployment {
  /// API Key value
  ...
  /// Creates a new [GetGradientaiAgentDeployment].
  ...
  const GetGradientaiAgentDeployment({
  ...
  factory GetGradientaiAgentDeployment.fromMap(Map<String, dynamic> map) {
    return GetGradientaiAgentDeployment(
