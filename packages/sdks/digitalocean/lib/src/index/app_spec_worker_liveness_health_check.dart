...
class AppSpecWorkerLivenessHealthCheck {
  ...
  /// Creates a new [AppSpecWorkerLivenessHealthCheck].
  ...
  const AppSpecWorkerLivenessHealthCheck({
  ...
  factory AppSpecWorkerLivenessHealthCheck.fromMap(Map<String, dynamic> map) {
    return AppSpecWorkerLivenessHealthCheck(
