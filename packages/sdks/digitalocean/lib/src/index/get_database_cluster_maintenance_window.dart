...
class GetDatabaseClusterMaintenanceWindow {
  ...
  GetDatabaseClusterMaintenanceWindow({required this.day, required this.hour});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'day': day, 'hour': hour};
  }

  factory GetDatabaseClusterMaintenanceWindow.fromMap(
