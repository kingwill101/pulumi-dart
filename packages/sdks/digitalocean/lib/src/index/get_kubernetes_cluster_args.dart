...
class GetKubernetesClusterArgs {
  final pulumi.Input<GetKubernetesClusterAmdGpuDeviceMetricsExporterPlugin>?
  amdGpuDeviceMetricsExporterPlugin;
  final pulumi.Input<GetKubernetesClusterAmdGpuDevicePlugin>?
  amdGpuDevicePlugin;
  final pulumi.Input<List<GetKubernetesClusterClusterAutoscalerConfiguration>>?
  clusterAutoscalerConfigurations;
  final pulumi.Input<int>? kubeconfigExpireSeconds;

  /// The name of Kubernetes cluster.
  final pulumi.Input<String> name;
  final pulumi.Input<GetKubernetesClusterNvidiaGpuDevicePlugin>?
  nvidiaGpuDevicePlugin;
  final pulumi.Input<GetKubernetesClusterRdmaSharedDevicePlugin>?
  ...
  factory GetKubernetesClusterArgs.fromMap(Map<String, dynamic> map) {
    return GetKubernetesClusterArgs(
      ...
      amdGpuDevicePlugin: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GetKubernetesClusterAmdGpuDevicePlugin.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      clusterAutoscalerConfigurations: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                GetKubernetesClusterClusterAutoscalerConfiguration.fromMap(
      ...
      nvidiaGpuDevicePlugin: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GetKubernetesClusterNvidiaGpuDevicePlugin.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      routingAgent: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GetKubernetesClusterRoutingAgent.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
