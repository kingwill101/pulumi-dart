    ...
    return <String, dynamic>{
      ...
      'filters':
          ?pulumi.Input.mapOptionalInputValue<
            List<GetGradientaiAgentVersionsFilter>,
      ...
      'sorts':
          ?pulumi.Input.mapOptionalInputValue<
            List<GetGradientaiAgentVersionsSort>,
            List<Map<String, dynamic>>
          >(
            sorts,
            (value) =>
    ...
    return GetGradientaiAgentVersionsArgs(
      ...
      filters: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GetGradientaiAgentVersionsFilter>(
            guardedValue,
      ...
      sorts: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GetGradientaiAgentVersionsSort>(
            guardedValue,
