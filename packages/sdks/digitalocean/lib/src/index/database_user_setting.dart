...
class DatabaseUserSetting {
  ...
  DatabaseUserSetting({this.acls, this.opensearchAcls});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'acls':
          ?pulumi.Input.mapOptionalInputValue<
            List<DatabaseUserSettingAcl>,
      ...
      'opensearchAcls':
          ?pulumi.Input.mapOptionalInputValue<
            List<DatabaseUserSettingOpensearchAcl>,
            List<Map<String, dynamic>>
          >(
            opensearchAcls,
            (value) =>
    ...
    return DatabaseUserSetting(
      acls: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DatabaseUserSettingAcl>(
            guardedValue,
            (value) => DatabaseUserSettingAcl.fromMap(
      ...
      opensearchAcls: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DatabaseUserSettingOpensearchAcl>(
            guardedValue,
            (value) => DatabaseUserSettingOpensearchAcl.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
