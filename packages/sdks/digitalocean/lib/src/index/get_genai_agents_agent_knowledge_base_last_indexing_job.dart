...
class GetGenaiAgentsAgentKnowledgeBaseLastIndexingJob {
  ...
  /// Creates a new [GetGenaiAgentsAgentKnowledgeBaseLastIndexingJob].
  ...
  const GetGenaiAgentsAgentKnowledgeBaseLastIndexingJob({
  ...
  factory GetGenaiAgentsAgentKnowledgeBaseLastIndexingJob.fromMap(Map<String, dynamic> map) {
    return GetGenaiAgentsAgentKnowledgeBaseLastIndexingJob(
