...
class SpacesBucketLifecycleRule {
  ...
  final pulumi.Input<SpacesBucketLifecycleRuleNoncurrentVersionExpiration>?
    ...
    return SpacesBucketLifecycleRule(
      ...
      expiration: (() {
        ...
        return pulumi.Input.fromValue(
          SpacesBucketLifecycleRuleExpiration.fromMap(
      ...
      noncurrentVersionExpiration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SpacesBucketLifecycleRuleNoncurrentVersionExpiration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
