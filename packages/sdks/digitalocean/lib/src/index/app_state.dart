...
class AppState {
  ...
  factory AppState.fromMap(Map<String, dynamic> map) {
    return AppState(
      activeDeploymentId: (() {
        final guardedValue = map['activeDeploymentId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      appUrn: (() {
        final guardedValue = map['appUrn'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      createdAt: (() {
      ...
      defaultIngress: (() {
        final guardedValue = map['defaultIngress'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      deploymentPerPage: (() {
      ...
      liveDomain: (() {
        final guardedValue = map['liveDomain'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      liveUrl: (() {
        final guardedValue = map['liveUrl'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      projectId: (() {
