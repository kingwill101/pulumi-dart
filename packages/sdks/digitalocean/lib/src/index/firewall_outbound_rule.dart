...
class FirewallOutboundRule {
  ...
  factory FirewallOutboundRule.fromMap(Map<String, dynamic> map) {
    return FirewallOutboundRule(
      ...
      destinationLoadBalancerUids: (() { final guardedValue = map['destinationLoadBalancerUids']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      destinationTags: (() { final guardedValue = map['destinationTags']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
