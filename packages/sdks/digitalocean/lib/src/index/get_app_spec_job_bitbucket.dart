...
class GetAppSpecJobBitbucket {
  ...
  /// Creates a new [GetAppSpecJobBitbucket].
  ...
  GetAppSpecJobBitbucket({this.branch, this.deployOnPush, this.repo});
  ...
  factory GetAppSpecJobBitbucket.fromMap(Map<String, dynamic> map) {
    return GetAppSpecJobBitbucket(
      branch: (() {
