...
class AppSpecIngress {
  ...
  factory AppSpecIngress.fromMap(Map<String, dynamic> map) {
    return AppSpecIngress(
      rules: (() { final guardedValue = map['rules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AppSpecIngressRule>(guardedValue, (value) => AppSpecIngressRule.fromMap((value as Map).cast<String, dynamic>()))); })(),
      secureHeader: (() { final guardedValue = map['secureHeader']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AppSpecIngressSecureHeader.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
