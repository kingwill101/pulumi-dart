...
class AppSpecFunctionAlert {
  ...
  factory AppSpecFunctionAlert.fromMap(Map<String, dynamic> map) {
    return AppSpecFunctionAlert(
      destinations: (() { final guardedValue = map['destinations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AppSpecFunctionAlertDestinations.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
