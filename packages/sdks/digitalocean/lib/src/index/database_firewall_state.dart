...
class DatabaseFirewallState {
  ...
  factory DatabaseFirewallState.fromMap(Map<String, dynamic> map) {
    return DatabaseFirewallState(
      ...
      rules: (() { final guardedValue = map['rules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DatabaseFirewallRule>(guardedValue, (value) => DatabaseFirewallRule.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
