...
class GetGenaiOpenaiApiKeysArgs {
  ...
  /// [filters] Optional.
  /// [sorts] Optional.
  GetGenaiOpenaiApiKeysArgs({this.filters, this.sorts});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'filters':
          ?pulumi.Input.mapOptionalInputValue<
            List<GetGenaiOpenaiApiKeysFilter>,
      ...
      'sorts':
          ?pulumi.Input.mapOptionalInputValue<
            List<GetGenaiOpenaiApiKeysSort>,
            List<Map<String, dynamic>>
          >(
            sorts,
            (value) =>
    ...
    return GetGenaiOpenaiApiKeysArgs(
      filters: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GetGenaiOpenaiApiKeysFilter>(
            guardedValue,
      ...
      sorts: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GetGenaiOpenaiApiKeysSort>(
            guardedValue,
