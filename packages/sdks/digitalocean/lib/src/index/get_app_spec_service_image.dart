...
class GetAppSpecServiceImage {
    ...
    return <String, dynamic>{
      'deployOnPushes':
          pulumi.Input.mapInputValue<
            List<GetAppSpecServiceImageDeployOnPush>,
  ...
  factory GetAppSpecServiceImage.fromMap(Map<String, dynamic> map) {
    return GetAppSpecServiceImage(
      deployOnPushes: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetAppSpecServiceImageDeployOnPush>(
          map['deployOnPushes']!,
          (value) => GetAppSpecServiceImageDeployOnPush.fromMap(
