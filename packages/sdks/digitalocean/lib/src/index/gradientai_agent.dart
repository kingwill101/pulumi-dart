...
class GradientaiAgent extends pulumi.CustomResource {
  ...
  GradientaiAgent(
    ...
    agentGuardrails = registerOutput<List<Map<String, dynamic>>?>(
      'agentGuardrails',
    );
    anthropicApiKeys = registerOutput<List<Map<String, dynamic>>?>(
      'anthropicApiKeys',
    );
    ...
    chatbotIdentifiers = registerOutput<List<Map<String, dynamic>>?>(
      'chatbotIdentifiers',
    );
    ...
    knowledgeBases = registerOutput<List<Map<String, dynamic>>>(
      'knowledgeBases',
    );
    ...
    openAiApiKeys = registerOutput<List<Map<String, dynamic>>?>(
      'openAiApiKeys',
    );
