...
class GetGradientaiAgentsByOpenaiApiKeyAgentKnowledgeBaseLastIndexingJob {
  ...
  /// Creates a new [GetGradientaiAgentsByOpenaiApiKeyAgentKnowledgeBaseLastIndexingJob].
  ...
  const GetGradientaiAgentsByOpenaiApiKeyAgentKnowledgeBaseLastIndexingJob({
  ...
  factory GetGradientaiAgentsByOpenaiApiKeyAgentKnowledgeBaseLastIndexingJob.fromMap(Map<String, dynamic> map) {
    return GetGradientaiAgentsByOpenaiApiKeyAgentKnowledgeBaseLastIndexingJob(
