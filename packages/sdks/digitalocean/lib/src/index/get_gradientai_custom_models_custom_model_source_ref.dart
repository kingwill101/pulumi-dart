...
class GetGradientaiCustomModelsCustomModelSourceRef {
  ...
  /// Creates a new [GetGradientaiCustomModelsCustomModelSourceRef].
  ...
  const GetGradientaiCustomModelsCustomModelSourceRef({
  ...
  factory GetGradientaiCustomModelsCustomModelSourceRef.fromMap(Map<String, dynamic> map) {
    return GetGradientaiCustomModelsCustomModelSourceRef(
