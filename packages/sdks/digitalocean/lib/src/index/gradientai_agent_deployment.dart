...
class GradientaiAgentDeployment {
  /// API Key value
  ...
  /// Creates a new [GradientaiAgentDeployment].
  ...
  factory GradientaiAgentDeployment.fromMap(Map<String, dynamic> map) {
    return GradientaiAgentDeployment(
