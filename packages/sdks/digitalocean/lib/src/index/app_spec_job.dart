    ...
    return <String, dynamic>{
      'alerts':
          ?pulumi.Input.mapOptionalInputValue<
            List<AppSpecJobAlert>,
            List<Map<String, dynamic>>
          >(
            alerts,
            (value) =>
                pulumi.Input.encodeList<AppSpecJobAlert, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      ...
      'envs':
          ...
          >(
            envs,
            (value) =>
                pulumi.Input.encodeList<AppSpecJobEnv, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return AppSpecJob(
      alerts: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AppSpecJobAlert>(
            guardedValue,
            (value) =>
                AppSpecJobAlert.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      bitbucket: (() {
      ...
      envs: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AppSpecJobEnv>(
            guardedValue,
            (value) =>
                AppSpecJobEnv.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      git: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AppSpecJobGit.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      github: (() {
      ...
      logDestinations: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AppSpecJobLogDestination>(
            guardedValue,
            (value) => AppSpecJobLogDestination.fromMap(
