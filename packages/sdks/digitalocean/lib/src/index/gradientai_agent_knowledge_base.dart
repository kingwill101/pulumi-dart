...
class GradientaiAgentKnowledgeBase {
  ...
  factory GradientaiAgentKnowledgeBase.fromMap(Map<String, dynamic> map) {
    return GradientaiAgentKnowledgeBase(
      ...
      lastIndexingJob: map['lastIndexingJob'] == null ? null : (GradientaiAgentKnowledgeBaseLastIndexingJob.fromMap((map['lastIndexingJob'] as Map).cast<String, dynamic>())).input(),
