...
class GradientaiAgentKnowledgeBase {
  ...
  final pulumi.Input<GradientaiAgentKnowledgeBaseLastIndexingJob>?
  lastIndexingJob;
    ...
    return <String, dynamic>{
      ...
      'lastIndexingJob':
          ?pulumi.Input.mapOptionalInputValue<
            GradientaiAgentKnowledgeBaseLastIndexingJob,
            Map<String, dynamic>
    ...
    return GradientaiAgentKnowledgeBase(
      ...
      lastIndexingJob: (() {
        ...
        return pulumi.Input.fromValue(
          GradientaiAgentKnowledgeBaseLastIndexingJob.fromMap(
