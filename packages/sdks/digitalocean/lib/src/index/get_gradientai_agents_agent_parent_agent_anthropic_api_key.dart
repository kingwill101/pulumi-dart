...
class GetGradientaiAgentsAgentParentAgentAnthropicApiKey {
  ...
  /// Creates a new [GetGradientaiAgentsAgentParentAgentAnthropicApiKey].
  ...
  /// [uuid] API Key value
  const GetGradientaiAgentsAgentParentAgentAnthropicApiKey({
  ...
  factory GetGradientaiAgentsAgentParentAgentAnthropicApiKey.fromMap(Map<String, dynamic> map) {
    return GetGradientaiAgentsAgentParentAgentAnthropicApiKey(
