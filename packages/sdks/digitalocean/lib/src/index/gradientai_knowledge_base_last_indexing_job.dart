...
class GradientaiKnowledgeBaseLastIndexingJob {
  ...
  /// Creates a new [GradientaiKnowledgeBaseLastIndexingJob].
  ...
  const GradientaiKnowledgeBaseLastIndexingJob({
  ...
  factory GradientaiKnowledgeBaseLastIndexingJob.fromMap(Map<String, dynamic> map) {
    return GradientaiKnowledgeBaseLastIndexingJob(
