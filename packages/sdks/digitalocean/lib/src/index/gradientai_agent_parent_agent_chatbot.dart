...
class GradientaiAgentParentAgentChatbot {
  ...
  /// Creates a new [GradientaiAgentParentAgentChatbot].
  ...
  factory GradientaiAgentParentAgentChatbot.fromMap(Map<String, dynamic> map) {
    return GradientaiAgentParentAgentChatbot(
