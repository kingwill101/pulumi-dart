...
class GetGenaiAgentsByOpenaiApiKeyAgentAnthropicApiKey {
  ...
  /// Creates a new [GetGenaiAgentsByOpenaiApiKeyAgentAnthropicApiKey].
  ...
  /// [uuid] API Key value
  const GetGenaiAgentsByOpenaiApiKeyAgentAnthropicApiKey({
  ...
  factory GetGenaiAgentsByOpenaiApiKeyAgentAnthropicApiKey.fromMap(Map<String, dynamic> map) {
    return GetGenaiAgentsByOpenaiApiKeyAgentAnthropicApiKey(
