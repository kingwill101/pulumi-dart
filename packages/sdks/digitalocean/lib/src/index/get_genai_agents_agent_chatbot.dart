...
class GetGenaiAgentsAgentChatbot {
  ...
  /// Creates a new [GetGenaiAgentsAgentChatbot].
  ...
  factory GetGenaiAgentsAgentChatbot.fromMap(Map<String, dynamic> map) {
    return GetGenaiAgentsAgentChatbot(
