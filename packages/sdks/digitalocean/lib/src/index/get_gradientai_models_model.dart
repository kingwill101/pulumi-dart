...
class GetGradientaiModelsModel {
  ...
  factory GetGradientaiModelsModel.fromMap(Map<String, dynamic> map) {
    return GetGradientaiModelsModel(
      agreements: pulumi.Input.fromValue(pulumi.Input.decodeList<GetGradientaiModelsModelAgreement>(map['agreements']!, (value) => GetGradientaiModelsModelAgreement.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      versions: pulumi.Input.fromValue(pulumi.Input.decodeList<GetGradientaiModelsModelVersion>(map['versions']!, (value) => GetGradientaiModelsModelVersion.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
