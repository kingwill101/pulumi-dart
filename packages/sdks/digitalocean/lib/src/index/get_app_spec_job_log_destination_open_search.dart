...
class GetAppSpecJobLogDestinationOpenSearch {
  ...
  final GetAppSpecJobLogDestinationOpenSearchBasicAuth basicAuth;
  ...
  factory GetAppSpecJobLogDestinationOpenSearch.fromMap(Map<String, dynamic> map) {
    return GetAppSpecJobLogDestinationOpenSearch(
      basicAuth: GetAppSpecJobLogDestinationOpenSearchBasicAuth.fromMap((map['basicAuth'] as Map).cast<String, dynamic>()),
