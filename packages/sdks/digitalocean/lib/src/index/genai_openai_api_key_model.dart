...
class GenaiOpenaiApiKeyModel {
  ...
  factory GenaiOpenaiApiKeyModel.fromMap(Map<String, dynamic> map) {
    return GenaiOpenaiApiKeyModel(
      agreements: (() { final guardedValue = map['agreements']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GenaiOpenaiApiKeyModelAgreement>(guardedValue, (value) => GenaiOpenaiApiKeyModelAgreement.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      versions: (() { final guardedValue = map['versions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GenaiOpenaiApiKeyModelVersion>(guardedValue, (value) => GenaiOpenaiApiKeyModelVersion.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
