    ...
    return GetAppSpecServiceLogDestination(
      datadog: (() {
        ...
        return pulumi.Input.fromValue(
          GetAppSpecServiceLogDestinationDatadog.fromMap(
      ...
      logtail: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GetAppSpecServiceLogDestinationLogtail.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      openSearch: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GetAppSpecServiceLogDestinationOpenSearch.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      papertrail: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GetAppSpecServiceLogDestinationPapertrail.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
