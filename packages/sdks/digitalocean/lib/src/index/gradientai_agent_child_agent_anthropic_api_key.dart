...
class GradientaiAgentChildAgentAnthropicApiKey {
  ...
  /// Creates a new [GradientaiAgentChildAgentAnthropicApiKey].
  ...
  /// [uuid] API Key value
  const GradientaiAgentChildAgentAnthropicApiKey({
    this.createdAt,
    this.createdBy,
    this.deletedAt,
    this.name,
  ...
  factory GradientaiAgentChildAgentAnthropicApiKey.fromMap(Map<String, dynamic> map) {
    return GradientaiAgentChildAgentAnthropicApiKey(
