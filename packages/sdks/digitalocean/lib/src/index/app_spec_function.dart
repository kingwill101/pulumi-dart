...
class AppSpecFunction {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'logDestinations':
          ?pulumi.Input.mapOptionalInputValue<
            List<AppSpecFunctionLogDestination>,
            List<Map<String, dynamic>>
          >(
            logDestinations,
            (value) =>
    ...
    return AppSpecFunction(
      alerts: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AppSpecFunctionAlert>(
            guardedValue,
            (value) => AppSpecFunctionAlert.fromMap(
      ...
      bitbucket: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AppSpecFunctionBitbucket.fromMap(
      ...
      envs: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AppSpecFunctionEnv>(
            guardedValue,
            (value) => AppSpecFunctionEnv.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      logDestinations: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AppSpecFunctionLogDestination>(
            guardedValue,
            (value) => AppSpecFunctionLogDestination.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      routes: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AppSpecFunctionRoute>(
            guardedValue,
            (value) => AppSpecFunctionRoute.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
