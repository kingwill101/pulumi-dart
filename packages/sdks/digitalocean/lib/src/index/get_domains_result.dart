  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'sorts': ?(() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.encodeList<GetDomainsSort, Map<String, dynamic>>(
          guardedValue,
          (value) => value.toMap(),
        );
      })(),
  ...
  factory GetDomainsResult.fromMap(Map<String, dynamic> map) {
    return GetDomainsResult(
      ...
      sorts: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<GetDomainsSort>(
          guardedValue,
          (value) =>
              GetDomainsSort.fromMap((value as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
