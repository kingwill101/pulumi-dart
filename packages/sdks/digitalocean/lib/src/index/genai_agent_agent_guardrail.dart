...
class GenaiAgentAgentGuardrail {
  ...
  /// Creates a new [GenaiAgentAgentGuardrail].
  ...
  /// [uuid] Guardrail UUID
  const GenaiAgentAgentGuardrail({
    this.agentUuid,
    this.createdAt,
  ...
  factory GenaiAgentAgentGuardrail.fromMap(Map<String, dynamic> map) {
    return GenaiAgentAgentGuardrail(
      ...
      isAttached: (() { final guardedValue = map['isAttached']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
