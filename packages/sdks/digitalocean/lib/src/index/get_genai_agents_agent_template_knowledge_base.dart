...
class GetGenaiAgentsAgentTemplateKnowledgeBase {
  ...
  final pulumi.Input<GetGenaiAgentsAgentTemplateKnowledgeBaseLastIndexingJob>?
  lastIndexingJob;
    ...
    return <String, dynamic>{
      ...
      'lastIndexingJob':
          ?pulumi.Input.mapOptionalInputValue<
            GetGenaiAgentsAgentTemplateKnowledgeBaseLastIndexingJob,
            Map<String, dynamic>
  ...
  factory GetGenaiAgentsAgentTemplateKnowledgeBase.fromMap(
    ...
    return GetGenaiAgentsAgentTemplateKnowledgeBase(
      ...
      lastIndexingJob: (() {
        ...
        return pulumi.Input.fromValue(
          GetGenaiAgentsAgentTemplateKnowledgeBaseLastIndexingJob.fromMap(
