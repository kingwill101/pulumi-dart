...
class GetGenaiAgentsAgentTemplateKnowledgeBase {
  ...
  final GetGenaiAgentsAgentTemplateKnowledgeBaseLastIndexingJob? lastIndexingJob;
  ...
  factory GetGenaiAgentsAgentTemplateKnowledgeBase.fromMap(Map<String, dynamic> map) {
    return GetGenaiAgentsAgentTemplateKnowledgeBase(
      ...
      lastIndexingJob: map['lastIndexingJob'] == null ? null : GetGenaiAgentsAgentTemplateKnowledgeBaseLastIndexingJob.fromMap((map['lastIndexingJob'] as Map).cast<String, dynamic>()),
