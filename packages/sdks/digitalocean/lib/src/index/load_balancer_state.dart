...
class LoadBalancerState {
  ...
  LoadBalancerState({
    ...
    pulumi.Output<String>? loadBalancerUrn,
    ...
    pulumi.Output<String>? vpcUuid,
      ...
      loadBalancerUrn = pulumi.Input.asOptionalInput<String>(loadBalancerUrn),
  ...
  factory LoadBalancerState.fromMap(Map<String, dynamic> map) {
    return LoadBalancerState(
      ...
      loadBalancerUrn: map['loadBalancerUrn'] == null ? null : pulumi.Output.create<String>(map['loadBalancerUrn'] as String),
