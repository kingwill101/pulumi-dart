...
class AppSpecWorkerAlertDestinations {
  ...
  final pulumi.Input<List<AppSpecWorkerAlertDestinationsSlackWebhook>>?
  slackWebhooks;
  ...
  AppSpecWorkerAlertDestinations({this.emails, this.slackWebhooks});
    ...
    return <String, dynamic>{
      ...
      'slackWebhooks':
          ?pulumi.Input.mapOptionalInputValue<
            List<AppSpecWorkerAlertDestinationsSlackWebhook>,
    ...
    return AppSpecWorkerAlertDestinations(
      ...
      slackWebhooks: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AppSpecWorkerAlertDestinationsSlackWebhook>(
            guardedValue,
            (value) => AppSpecWorkerAlertDestinationsSlackWebhook.fromMap(
