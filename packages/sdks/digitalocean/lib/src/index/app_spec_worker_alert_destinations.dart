...
class AppSpecWorkerAlertDestinations {
  ...
  factory AppSpecWorkerAlertDestinations.fromMap(Map<String, dynamic> map) {
    return AppSpecWorkerAlertDestinations(
      ...
      slackWebhooks: (() { final guardedValue = map['slackWebhooks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AppSpecWorkerAlertDestinationsSlackWebhook>(guardedValue, (value) => AppSpecWorkerAlertDestinationsSlackWebhook.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
