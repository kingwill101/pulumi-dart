...
class GetGradientaiIndexingJobDataSourcesIndexedDataSource {
  ...
  factory GetGradientaiIndexingJobDataSourcesIndexedDataSource.fromMap(
    ...
    return GetGradientaiIndexingJobDataSourcesIndexedDataSource(
      ...
      indexedFileCount: pulumi.Input.fromValue(
        map['indexedFileCount'] as String,
      ),
      indexedItemCount: pulumi.Input.fromValue(
        map['indexedItemCount'] as String,
      ),
      removedItemCount: pulumi.Input.fromValue(
        map['removedItemCount'] as String,
      ),
      skippedItemCount: pulumi.Input.fromValue(
        map['skippedItemCount'] as String,
      ),
      ...
      totalBytesIndexed: pulumi.Input.fromValue(
        map['totalBytesIndexed'] as String,
      ),
