...
class GenaiKnowledgeBaseDataSourceArgs {
  ...
  const GenaiKnowledgeBaseDataSourceArgs({
  ...
  factory GenaiKnowledgeBaseDataSourceArgs.fromMap(Map<String, dynamic> map) {
    return GenaiKnowledgeBaseDataSourceArgs(
      ...
      spacesDataSource: (() { final guardedValue = map['spacesDataSource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GenaiKnowledgeBaseDataSourceSpacesDataSource.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      webCrawlerDataSource: (() { final guardedValue = map['webCrawlerDataSource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GenaiKnowledgeBaseDataSourceWebCrawlerDataSource.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
