...
class GradientaiOpenaiApiKeyModel {
  ...
  factory GradientaiOpenaiApiKeyModel.fromMap(Map<String, dynamic> map) {
    return GradientaiOpenaiApiKeyModel(
      agreements: map['agreements'] == null ? null : (pulumi.Input.decodeList<GradientaiOpenaiApiKeyModelAgreement>(map['agreements'], (value) => GradientaiOpenaiApiKeyModelAgreement.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      versions: map['versions'] == null ? null : (pulumi.Input.decodeList<GradientaiOpenaiApiKeyModelVersion>(map['versions'], (value) => GradientaiOpenaiApiKeyModelVersion.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
