...
class GetGradientaiKnowledgeBaseDataSourcesDatasource {
  ...
  final pulumi.Input<
    List<GetGradientaiKnowledgeBaseDataSourcesDatasourceFileUploadDataSource>
  >?
  fileUploadDataSources;

  /// Last indexing job for the data source
  final pulumi.Input<
    List<GetGradientaiKnowledgeBaseDataSourcesDatasourceLastIndexingJob>
  >?
  lastIndexingJobs;

  /// Spaces data source configuration
  final pulumi.Input<
    List<GetGradientaiKnowledgeBaseDataSourcesDatasourceSpacesDataSource>
  >?
  spacesDataSources;
  ...
  final pulumi.Input<
    List<GetGradientaiKnowledgeBaseDataSourcesDatasourceWebCrawlerDataSource>
  >?
  ...
  factory GetGradientaiKnowledgeBaseDataSourcesDatasource.fromMap(
      ...
      fileUploadDataSources: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                GetGradientaiKnowledgeBaseDataSourcesDatasourceFileUploadDataSource.fromMap(
      ...
      lastIndexingJobs: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                GetGradientaiKnowledgeBaseDataSourcesDatasourceLastIndexingJob.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      spacesDataSources: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                GetGradientaiKnowledgeBaseDataSourcesDatasourceSpacesDataSource.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      webCrawlerDataSources: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                GetGradientaiKnowledgeBaseDataSourcesDatasourceWebCrawlerDataSource.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
