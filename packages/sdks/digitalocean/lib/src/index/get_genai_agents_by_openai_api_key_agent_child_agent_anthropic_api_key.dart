...
class GetGenaiAgentsByOpenaiApiKeyAgentChildAgentAnthropicApiKey {
  ...
  /// Creates a new [GetGenaiAgentsByOpenaiApiKeyAgentChildAgentAnthropicApiKey].
  ...
  /// [uuid] API Key value
  const GetGenaiAgentsByOpenaiApiKeyAgentChildAgentAnthropicApiKey({
  ...
  factory GetGenaiAgentsByOpenaiApiKeyAgentChildAgentAnthropicApiKey.fromMap(Map<String, dynamic> map) {
    return GetGenaiAgentsByOpenaiApiKeyAgentChildAgentAnthropicApiKey(
