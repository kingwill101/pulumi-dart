...
class AppSpecServiceImage {
  ...
  factory AppSpecServiceImage.fromMap(Map<String, dynamic> map) {
    return AppSpecServiceImage(
      deployOnPushes: (() { final guardedValue = map['deployOnPushes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AppSpecServiceImageDeployOnPush>(guardedValue, (value) => AppSpecServiceImageDeployOnPush.fromMap((value as Map).cast<String, dynamic>()))); })(),
