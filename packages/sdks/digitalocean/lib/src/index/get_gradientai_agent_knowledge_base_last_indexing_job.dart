...
class GetGradientaiAgentKnowledgeBaseLastIndexingJob {
  ...
  /// Creates a new [GetGradientaiAgentKnowledgeBaseLastIndexingJob].
  ...
  const GetGradientaiAgentKnowledgeBaseLastIndexingJob({
  ...
  factory GetGradientaiAgentKnowledgeBaseLastIndexingJob.fromMap(Map<String, dynamic> map) {
    return GetGradientaiAgentKnowledgeBaseLastIndexingJob(
