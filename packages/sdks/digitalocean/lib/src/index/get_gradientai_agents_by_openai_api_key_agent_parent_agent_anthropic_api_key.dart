...
class GetGradientaiAgentsByOpenaiApiKeyAgentParentAgentAnthropicApiKey {
  ...
  /// Creates a new [GetGradientaiAgentsByOpenaiApiKeyAgentParentAgentAnthropicApiKey].
  ...
  /// [uuid] API Key value
  const GetGradientaiAgentsByOpenaiApiKeyAgentParentAgentAnthropicApiKey({
  ...
  factory GetGradientaiAgentsByOpenaiApiKeyAgentParentAgentAnthropicApiKey.fromMap(Map<String, dynamic> map) {
    return GetGradientaiAgentsByOpenaiApiKeyAgentParentAgentAnthropicApiKey(
