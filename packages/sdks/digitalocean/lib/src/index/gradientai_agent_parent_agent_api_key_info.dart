...
class GradientaiAgentParentAgentApiKeyInfo {
  /// API Key value
  ...
  /// Creates a new [GradientaiAgentParentAgentApiKeyInfo].
  ...
  /// [uuid] API Key value
  const GradientaiAgentParentAgentApiKeyInfo({
    this.createdAt,
    this.createdBy,
    this.deletedAt,
    this.name,
  ...
  factory GradientaiAgentParentAgentApiKeyInfo.fromMap(Map<String, dynamic> map) {
    return GradientaiAgentParentAgentApiKeyInfo(
