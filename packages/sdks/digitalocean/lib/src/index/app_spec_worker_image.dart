...
class AppSpecWorkerImage {
  ...
  factory AppSpecWorkerImage.fromMap(Map<String, dynamic> map) {
    return AppSpecWorkerImage(
      deployOnPushes: (() { final guardedValue = map['deployOnPushes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AppSpecWorkerImageDeployOnPush>(guardedValue, (value) => AppSpecWorkerImageDeployOnPush.fromMap((value as Map).cast<String, dynamic>()))); })(),
