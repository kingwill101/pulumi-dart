...
class MonitorAlertAlerts {
  ...
  /// [slacks] Optional.
  MonitorAlertAlerts({this.emails, this.slacks});
    ...
    return MonitorAlertAlerts(
      ...
      slacks: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MonitorAlertAlertsSlack>(
            guardedValue,
            (value) => MonitorAlertAlertsSlack.fromMap(
