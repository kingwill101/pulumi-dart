    ...
    return <String, dynamic>{
      ...
      'pgbouncers':
          ?pulumi.Input.mapOptionalInputValue<
            List<DatabasePostgresqlConfigPgbouncer>,
      ...
      'timescaledbs':
          ?pulumi.Input.mapOptionalInputValue<
            List<DatabasePostgresqlConfigTimescaledb>,
            List<Map<String, dynamic>>
          >(
            timescaledbs,
            (value) =>
  ...
  factory DatabasePostgresqlConfigState.fromMap(Map<String, dynamic> map) {
    return DatabasePostgresqlConfigState(
      autovacuumAnalyzeScaleFactor: (() {
        final guardedValue = map['autovacuumAnalyzeScaleFactor'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as double);
      })(),
      autovacuumAnalyzeThreshold: (() {
        final guardedValue = map['autovacuumAnalyzeThreshold'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      autovacuumFreezeMaxAge: (() {
        final guardedValue = map['autovacuumFreezeMaxAge'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      autovacuumMaxWorkers: (() {
        final guardedValue = map['autovacuumMaxWorkers'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      autovacuumNaptime: (() {
        final guardedValue = map['autovacuumNaptime'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      autovacuumVacuumCostDelay: (() {
        final guardedValue = map['autovacuumVacuumCostDelay'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      autovacuumVacuumCostLimit: (() {
        final guardedValue = map['autovacuumVacuumCostLimit'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      autovacuumVacuumScaleFactor: (() {
        final guardedValue = map['autovacuumVacuumScaleFactor'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as double);
      })(),
      autovacuumVacuumThreshold: (() {
        final guardedValue = map['autovacuumVacuumThreshold'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      backupHour: (() {
        final guardedValue = map['backupHour'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      backupMinute: (() {
        final guardedValue = map['backupMinute'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      bgwriterDelay: (() {
        final guardedValue = map['bgwriterDelay'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      bgwriterFlushAfter: (() {
        final guardedValue = map['bgwriterFlushAfter'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      bgwriterLruMaxpages: (() {
        final guardedValue = map['bgwriterLruMaxpages'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      bgwriterLruMultiplier: (() {
        final guardedValue = map['bgwriterLruMultiplier'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as double);
      })(),
      clusterId: (() {
      ...
      deadlockTimeout: (() {
        final guardedValue = map['deadlockTimeout'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      defaultToastCompression: (() {
        final guardedValue = map['defaultToastCompression'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ...
      jit: (() {
        final guardedValue = map['jit'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      logAutovacuumMinDuration: (() {
        final guardedValue = map['logAutovacuumMinDuration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      logErrorVerbosity: (() {
        final guardedValue = map['logErrorVerbosity'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      logLinePrefix: (() {
        final guardedValue = map['logLinePrefix'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      logMinDurationStatement: (() {
        final guardedValue = map['logMinDurationStatement'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      maxFilesPerProcess: (() {
        final guardedValue = map['maxFilesPerProcess'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      maxLocksPerTransaction: (() {
        final guardedValue = map['maxLocksPerTransaction'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      maxLogicalReplicationWorkers: (() {
        final guardedValue = map['maxLogicalReplicationWorkers'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      maxParallelWorkers: (() {
        final guardedValue = map['maxParallelWorkers'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      maxParallelWorkersPerGather: (() {
        final guardedValue = map['maxParallelWorkersPerGather'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      maxPredLocksPerTransaction: (() {
        final guardedValue = map['maxPredLocksPerTransaction'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      maxPreparedTransactions: (() {
        final guardedValue = map['maxPreparedTransactions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      maxReplicationSlots: (() {
        final guardedValue = map['maxReplicationSlots'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      maxStackDepth: (() {
        final guardedValue = map['maxStackDepth'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      maxStandbyArchiveDelay: (() {
        final guardedValue = map['maxStandbyArchiveDelay'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      maxStandbyStreamingDelay: (() {
        final guardedValue = map['maxStandbyStreamingDelay'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      maxWalSenders: (() {
        final guardedValue = map['maxWalSenders'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      maxWorkerProcesses: (() {
        final guardedValue = map['maxWorkerProcesses'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      pgPartmanBgwInterval: (() {
        final guardedValue = map['pgPartmanBgwInterval'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      pgPartmanBgwRole: (() {
        final guardedValue = map['pgPartmanBgwRole'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      pgStatStatementsTrack: (() {
        final guardedValue = map['pgStatStatementsTrack'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      pgbouncers: (() {
        final guardedValue = map['pgbouncers'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DatabasePostgresqlConfigPgbouncer>(
            guardedValue,
            (value) => DatabasePostgresqlConfigPgbouncer.fromMap(
      ...
      sharedBuffersPercentage: (() {
        final guardedValue = map['sharedBuffersPercentage'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as double);
      })(),
      tempFileLimit: (() {
        final guardedValue = map['tempFileLimit'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      timescaledbs: (() {
        final guardedValue = map['timescaledbs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DatabasePostgresqlConfigTimescaledb>(
            guardedValue,
            (value) => DatabasePostgresqlConfigTimescaledb.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      trackActivityQuerySize: (() {
        final guardedValue = map['trackActivityQuerySize'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      trackCommitTimestamp: (() {
        final guardedValue = map['trackCommitTimestamp'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      trackFunctions: (() {
        final guardedValue = map['trackFunctions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      trackIoTiming: (() {
        final guardedValue = map['trackIoTiming'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      walSenderTimeout: (() {
        final guardedValue = map['walSenderTimeout'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      walWriterDelay: (() {
        final guardedValue = map['walWriterDelay'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      workMem: (() {
        final guardedValue = map['workMem'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
    );
