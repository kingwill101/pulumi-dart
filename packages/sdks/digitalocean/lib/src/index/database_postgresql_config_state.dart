...
class DatabasePostgresqlConfigState {
  ...
  DatabasePostgresqlConfigState({
    pulumi.Output<double>? autovacuumAnalyzeScaleFactor,
    pulumi.Output<int>? autovacuumAnalyzeThreshold,
    pulumi.Output<int>? autovacuumFreezeMaxAge,
    pulumi.Output<int>? autovacuumMaxWorkers,
    pulumi.Output<int>? autovacuumNaptime,
    pulumi.Output<int>? autovacuumVacuumCostDelay,
    pulumi.Output<int>? autovacuumVacuumCostLimit,
    pulumi.Output<double>? autovacuumVacuumScaleFactor,
    pulumi.Output<int>? autovacuumVacuumThreshold,
    pulumi.Output<int>? backupHour,
    pulumi.Output<int>? backupMinute,
    pulumi.Output<int>? bgwriterDelay,
    pulumi.Output<int>? bgwriterFlushAfter,
    pulumi.Output<int>? bgwriterLruMaxpages,
    pulumi.Output<double>? bgwriterLruMultiplier,
    pulumi.Output<String>? clusterId,
    pulumi.Output<int>? deadlockTimeout,
    pulumi.Output<String>? defaultToastCompression,
    pulumi.Output<int>? idleInTransactionSessionTimeout,
    pulumi.Output<bool>? jit,
    pulumi.Output<int>? logAutovacuumMinDuration,
    pulumi.Output<String>? logErrorVerbosity,
    pulumi.Output<String>? logLinePrefix,
    pulumi.Output<int>? logMinDurationStatement,
    pulumi.Output<int>? maxFilesPerProcess,
    pulumi.Output<int>? maxLocksPerTransaction,
    pulumi.Output<int>? maxLogicalReplicationWorkers,
    pulumi.Output<int>? maxParallelWorkers,
    pulumi.Output<int>? maxParallelWorkersPerGather,
    pulumi.Output<int>? maxPredLocksPerTransaction,
    pulumi.Output<int>? maxPreparedTransactions,
    pulumi.Output<int>? maxReplicationSlots,
    pulumi.Output<int>? maxStackDepth,
    pulumi.Output<int>? maxStandbyArchiveDelay,
    pulumi.Output<int>? maxStandbyStreamingDelay,
    pulumi.Output<int>? maxWalSenders,
    pulumi.Output<int>? maxWorkerProcesses,
    pulumi.Output<int>? pgPartmanBgwInterval,
    pulumi.Output<String>? pgPartmanBgwRole,
    pulumi.Output<String>? pgStatStatementsTrack,
    pulumi.Output<List<DatabasePostgresqlConfigPgbouncer>>? pgbouncers,
    pulumi.Output<double>? sharedBuffersPercentage,
    pulumi.Output<int>? tempFileLimit,
    pulumi.Output<List<DatabasePostgresqlConfigTimescaledb>>? timescaledbs,
    pulumi.Output<String>? timezone,
    pulumi.Output<int>? trackActivityQuerySize,
    pulumi.Output<String>? trackCommitTimestamp,
    pulumi.Output<String>? trackFunctions,
    pulumi.Output<String>? trackIoTiming,
    pulumi.Output<int>? walSenderTimeout,
    pulumi.Output<int>? walWriterDelay,
    pulumi.Output<int>? workMem,
  }) :
  ...
  factory DatabasePostgresqlConfigState.fromMap(Map<String, dynamic> map) {
    return DatabasePostgresqlConfigState(
      autovacuumAnalyzeScaleFactor: map['autovacuumAnalyzeScaleFactor'] == null ? null : pulumi.Output.create<double>(map['autovacuumAnalyzeScaleFactor'] as double),
      autovacuumAnalyzeThreshold: map['autovacuumAnalyzeThreshold'] == null ? null : pulumi.Output.create<int>(map['autovacuumAnalyzeThreshold'] as int),
      autovacuumFreezeMaxAge: map['autovacuumFreezeMaxAge'] == null ? null : pulumi.Output.create<int>(map['autovacuumFreezeMaxAge'] as int),
      autovacuumMaxWorkers: map['autovacuumMaxWorkers'] == null ? null : pulumi.Output.create<int>(map['autovacuumMaxWorkers'] as int),
      autovacuumNaptime: map['autovacuumNaptime'] == null ? null : pulumi.Output.create<int>(map['autovacuumNaptime'] as int),
      autovacuumVacuumCostDelay: map['autovacuumVacuumCostDelay'] == null ? null : pulumi.Output.create<int>(map['autovacuumVacuumCostDelay'] as int),
      autovacuumVacuumCostLimit: map['autovacuumVacuumCostLimit'] == null ? null : pulumi.Output.create<int>(map['autovacuumVacuumCostLimit'] as int),
      autovacuumVacuumScaleFactor: map['autovacuumVacuumScaleFactor'] == null ? null : pulumi.Output.create<double>(map['autovacuumVacuumScaleFactor'] as double),
      autovacuumVacuumThreshold: map['autovacuumVacuumThreshold'] == null ? null : pulumi.Output.create<int>(map['autovacuumVacuumThreshold'] as int),
      ...
      bgwriterDelay: map['bgwriterDelay'] == null ? null : pulumi.Output.create<int>(map['bgwriterDelay'] as int),
      bgwriterFlushAfter: map['bgwriterFlushAfter'] == null ? null : pulumi.Output.create<int>(map['bgwriterFlushAfter'] as int),
      bgwriterLruMaxpages: map['bgwriterLruMaxpages'] == null ? null : pulumi.Output.create<int>(map['bgwriterLruMaxpages'] as int),
      bgwriterLruMultiplier: map['bgwriterLruMultiplier'] == null ? null : pulumi.Output.create<double>(map['bgwriterLruMultiplier'] as double),
      clusterId: map['clusterId'] == null ? null : pulumi.Output.create<String>(map['clusterId'] as String),
      deadlockTimeout: map['deadlockTimeout'] == null ? null : pulumi.Output.create<int>(map['deadlockTimeout'] as int),
      defaultToastCompression: map['defaultToastCompression'] == null ? null : pulumi.Output.create<String>(map['defaultToastCompression'] as String),
      idleInTransactionSessionTimeout: map['idleInTransactionSessionTimeout'] == null ? null : pulumi.Output.create<int>(map['idleInTransactionSessionTimeout'] as int),
      jit: map['jit'] == null ? null : pulumi.Output.create<bool>(map['jit'] as bool),
      logAutovacuumMinDuration: map['logAutovacuumMinDuration'] == null ? null : pulumi.Output.create<int>(map['logAutovacuumMinDuration'] as int),
      logErrorVerbosity: map['logErrorVerbosity'] == null ? null : pulumi.Output.create<String>(map['logErrorVerbosity'] as String),
      logLinePrefix: map['logLinePrefix'] == null ? null : pulumi.Output.create<String>(map['logLinePrefix'] as String),
      logMinDurationStatement: map['logMinDurationStatement'] == null ? null : pulumi.Output.create<int>(map['logMinDurationStatement'] as int),
      maxFilesPerProcess: map['maxFilesPerProcess'] == null ? null : pulumi.Output.create<int>(map['maxFilesPerProcess'] as int),
      maxLocksPerTransaction: map['maxLocksPerTransaction'] == null ? null : pulumi.Output.create<int>(map['maxLocksPerTransaction'] as int),
      maxLogicalReplicationWorkers: map['maxLogicalReplicationWorkers'] == null ? null : pulumi.Output.create<int>(map['maxLogicalReplicationWorkers'] as int),
      maxParallelWorkers: map['maxParallelWorkers'] == null ? null : pulumi.Output.create<int>(map['maxParallelWorkers'] as int),
      maxParallelWorkersPerGather: map['maxParallelWorkersPerGather'] == null ? null : pulumi.Output.create<int>(map['maxParallelWorkersPerGather'] as int),
      maxPredLocksPerTransaction: map['maxPredLocksPerTransaction'] == null ? null : pulumi.Output.create<int>(map['maxPredLocksPerTransaction'] as int),
      maxPreparedTransactions: map['maxPreparedTransactions'] == null ? null : pulumi.Output.create<int>(map['maxPreparedTransactions'] as int),
      maxReplicationSlots: map['maxReplicationSlots'] == null ? null : pulumi.Output.create<int>(map['maxReplicationSlots'] as int),
      maxStackDepth: map['maxStackDepth'] == null ? null : pulumi.Output.create<int>(map['maxStackDepth'] as int),
      maxStandbyArchiveDelay: map['maxStandbyArchiveDelay'] == null ? null : pulumi.Output.create<int>(map['maxStandbyArchiveDelay'] as int),
      maxStandbyStreamingDelay: map['maxStandbyStreamingDelay'] == null ? null : pulumi.Output.create<int>(map['maxStandbyStreamingDelay'] as int),
      maxWalSenders: map['maxWalSenders'] == null ? null : pulumi.Output.create<int>(map['maxWalSenders'] as int),
      maxWorkerProcesses: map['maxWorkerProcesses'] == null ? null : pulumi.Output.create<int>(map['maxWorkerProcesses'] as int),
      pgPartmanBgwInterval: map['pgPartmanBgwInterval'] == null ? null : pulumi.Output.create<int>(map['pgPartmanBgwInterval'] as int),
      pgPartmanBgwRole: map['pgPartmanBgwRole'] == null ? null : pulumi.Output.create<String>(map['pgPartmanBgwRole'] as String),
      pgStatStatementsTrack: map['pgStatStatementsTrack'] == null ? null : pulumi.Output.create<String>(map['pgStatStatementsTrack'] as String),
      pgbouncers: map['pgbouncers'] == null ? null : pulumi.Output.create<List<DatabasePostgresqlConfigPgbouncer>>(pulumi.Input.decodeList<DatabasePostgresqlConfigPgbouncer>(map['pgbouncers'], (value) => DatabasePostgresqlConfigPgbouncer.fromMap((value as Map).cast<String, dynamic>()))),
      sharedBuffersPercentage: map['sharedBuffersPercentage'] == null ? null : pulumi.Output.create<double>(map['sharedBuffersPercentage'] as double),
      tempFileLimit: map['tempFileLimit'] == null ? null : pulumi.Output.create<int>(map['tempFileLimit'] as int),
      timescaledbs: map['timescaledbs'] == null ? null : pulumi.Output.create<List<DatabasePostgresqlConfigTimescaledb>>(pulumi.Input.decodeList<DatabasePostgresqlConfigTimescaledb>(map['timescaledbs'], (value) => DatabasePostgresqlConfigTimescaledb.fromMap((value as Map).cast<String, dynamic>()))),
      timezone: map['timezone'] == null ? null : pulumi.Output.create<String>(map['timezone'] as String),
      trackActivityQuerySize: map['trackActivityQuerySize'] == null ? null : pulumi.Output.create<int>(map['trackActivityQuerySize'] as int),
      trackCommitTimestamp: map['trackCommitTimestamp'] == null ? null : pulumi.Output.create<String>(map['trackCommitTimestamp'] as String),
      trackFunctions: map['trackFunctions'] == null ? null : pulumi.Output.create<String>(map['trackFunctions'] as String),
      trackIoTiming: map['trackIoTiming'] == null ? null : pulumi.Output.create<String>(map['trackIoTiming'] as String),
      walSenderTimeout: map['walSenderTimeout'] == null ? null : pulumi.Output.create<int>(map['walSenderTimeout'] as int),
      walWriterDelay: map['walWriterDelay'] == null ? null : pulumi.Output.create<int>(map['walWriterDelay'] as int),
      workMem: map['workMem'] == null ? null : pulumi.Output.create<int>(map['workMem'] as int),
    );
  }
}
