...
class GetGenaiAgentAnthropicApiKey {
  ...
  /// Creates a new [GetGenaiAgentAnthropicApiKey].
  ...
  /// [uuid] API Key value
  const GetGenaiAgentAnthropicApiKey({
  ...
  factory GetGenaiAgentAnthropicApiKey.fromMap(Map<String, dynamic> map) {
    return GetGenaiAgentAnthropicApiKey(
