...
class GetAppSpecServiceAlert {
  final GetAppSpecServiceAlertDestinations? destinations;
  ...
  factory GetAppSpecServiceAlert.fromMap(Map<String, dynamic> map) {
    return GetAppSpecServiceAlert(
      destinations: map['destinations'] == null ? null : GetAppSpecServiceAlertDestinations.fromMap((map['destinations'] as Map).cast<String, dynamic>()),
