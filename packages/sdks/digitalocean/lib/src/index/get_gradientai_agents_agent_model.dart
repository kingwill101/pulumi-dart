...
import 'get_gradientai_agents_agent_model_agreement.dart';
import 'get_gradientai_agents_agent_model_version.dart';

class GetGradientaiAgentsAgentModel {
  /// Agreement information for the model
  final pulumi.Input<List<GetGradientaiAgentsAgentModelAgreement>>? agreements;
  ...
  /// URL of the Model
  final pulumi.Input<List<GetGradientaiAgentsAgentModelVersion>>? versions;

  /// Creates a new [GetGradientaiAgentsAgentModel].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'agreements': ?pulumi.Input.mapOptionalInputValue<List<GetGradientaiAgentsAgentModelAgreement>, List<Map<String, dynamic>>>(agreements, (value) => pulumi.Input.encodeList<GetGradientaiAgentsAgentModelAgreement, Map<String, dynamic>>(value, (value) => value.toMap())),
      'createdAt': createdAt,
      ...
      'url': ?url,
      'usecases': ?usecases,
      'versions': ?pulumi.Input.mapOptionalInputValue<List<GetGradientaiAgentsAgentModelVersion>, List<Map<String, dynamic>>>(versions, (value) => pulumi.Input.encodeList<GetGradientaiAgentsAgentModelVersion, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory GetGradientaiAgentsAgentModel.fromMap(Map<String, dynamic> map) {
    return GetGradientaiAgentsAgentModel(
      agreements: (() { final guardedValue = map['agreements']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetGradientaiAgentsAgentModelAgreement>(guardedValue, (value) => GetGradientaiAgentsAgentModelAgreement.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      versions: (() { final guardedValue = map['versions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetGradientaiAgentsAgentModelVersion>(guardedValue, (value) => GetGradientaiAgentsAgentModelVersion.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
