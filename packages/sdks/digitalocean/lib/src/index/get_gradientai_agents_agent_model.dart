...
class GetGradientaiAgentsAgentModel {
  ...
  factory GetGradientaiAgentsAgentModel.fromMap(Map<String, dynamic> map) {
    return GetGradientaiAgentsAgentModel(
      agreements: map['agreements'] == null ? null : (pulumi.Input.decodeList<GetGradientaiAgentsAgentModelAgreement>(map['agreements']!, (value) => GetGradientaiAgentsAgentModelAgreement.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      versions: map['versions'] == null ? null : (pulumi.Input.decodeList<GetGradientaiAgentsAgentModelVersion>(map['versions']!, (value) => GetGradientaiAgentsAgentModelVersion.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
