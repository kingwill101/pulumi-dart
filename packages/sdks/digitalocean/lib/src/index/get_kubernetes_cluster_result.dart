...
class GetKubernetesClusterResult {
  ...
  final List<GetKubernetesClusterClusterAutoscalerConfiguration>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'clusterAutoscalerConfigurations': ?(() {
        final guardedValue = clusterAutoscalerConfigurations;
      ...
      'controlPlaneFirewalls':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(controlPlaneFirewalls, (value) => value.toMap()),
      'createdAt': createdAt,
      'endpoint': endpoint,
      'ha': ha,
      'id': id,
  ...
  factory GetKubernetesClusterResult.fromMap(Map<String, dynamic> map) {
    return GetKubernetesClusterResult(
      amdGpuDeviceMetricsExporterPlugin:
          GetKubernetesClusterAmdGpuDeviceMetricsExporterPlugin.fromMap(
            (map['amdGpuDeviceMetricsExporterPlugin']! as Map)
                .cast<String, dynamic>(),
          ),
      amdGpuDevicePlugin: GetKubernetesClusterAmdGpuDevicePlugin.fromMap(
        (map['amdGpuDevicePlugin']! as Map).cast<String, dynamic>(),
      ),
      ...
      clusterAutoscalerConfigurations: (() {
        ...
        >(
          guardedValue,
          (value) => GetKubernetesClusterClusterAutoscalerConfiguration.fromMap(
      ...
      controlPlaneFirewalls:
          pulumi.Input.decodeList<GetKubernetesClusterControlPlaneFirewall>(
            map['controlPlaneFirewalls']!,
            (value) => GetKubernetesClusterControlPlaneFirewall.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      ...
      kubeConfigs: pulumi.Input.decodeList<GetKubernetesClusterKubeConfig>(
        map['kubeConfigs']!,
        (value) => GetKubernetesClusterKubeConfig.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      ...
      maintenancePolicies:
          pulumi.Input.decodeList<GetKubernetesClusterMaintenancePolicy>(
            map['maintenancePolicies']!,
            (value) => GetKubernetesClusterMaintenancePolicy.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      name: map['name'] as String,
      nodePools: pulumi.Input.decodeList<GetKubernetesClusterNodePool>(
        map['nodePools']!,
        (value) => GetKubernetesClusterNodePool.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      nvidiaGpuDevicePlugin: GetKubernetesClusterNvidiaGpuDevicePlugin.fromMap(
        (map['nvidiaGpuDevicePlugin']! as Map).cast<String, dynamic>(),
      ),
      rdmaSharedDevicePlugin:
          GetKubernetesClusterRdmaSharedDevicePlugin.fromMap(
            (map['rdmaSharedDevicePlugin']! as Map).cast<String, dynamic>(),
          ),
      region: map['region'] as String,
      routingAgent: GetKubernetesClusterRoutingAgent.fromMap(
        (map['routingAgent']! as Map).cast<String, dynamic>(),
      ),
