...
class GetKubernetesClusterResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'clusterAutoscalerConfigurations': ?clusterAutoscalerConfigurations == null ? null : pulumi.Input.encodeList<GetKubernetesClusterClusterAutoscalerConfiguration, Map<String, dynamic>>(clusterAutoscalerConfigurations!, (value) => value.toMap()),
