...
class GenaiAgentKnowledgeBase {
  ...
  final GenaiAgentKnowledgeBaseLastIndexingJob? lastIndexingJob;
  ...
  factory GenaiAgentKnowledgeBase.fromMap(Map<String, dynamic> map) {
    return GenaiAgentKnowledgeBase(
      ...
      lastIndexingJob: map['lastIndexingJob'] == null ? null : GenaiAgentKnowledgeBaseLastIndexingJob.fromMap((map['lastIndexingJob'] as Map).cast<String, dynamic>()),
