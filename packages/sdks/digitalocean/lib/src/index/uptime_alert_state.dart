...
class UptimeAlertState {
  ...
  factory UptimeAlertState.fromMap(Map<String, dynamic> map) {
    return UptimeAlertState(
      checkId: (() { final guardedValue = map['checkId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      notifications: (() { final guardedValue = map['notifications']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<UptimeAlertNotification>(guardedValue, (value) => UptimeAlertNotification.fromMap((value as Map).cast<String, dynamic>()))); })(),
