...
class GenaiAgentChildAgentAnthropicApiKey {
  ...
  /// Creates a new [GenaiAgentChildAgentAnthropicApiKey].
  ...
  /// [uuid] API Key value
  const GenaiAgentChildAgentAnthropicApiKey({
    this.createdAt,
    this.createdBy,
    this.deletedAt,
    this.name,
  ...
  factory GenaiAgentChildAgentAnthropicApiKey.fromMap(Map<String, dynamic> map) {
    return GenaiAgentChildAgentAnthropicApiKey(
