...
class TagState {
  ...
  factory TagState.fromMap(Map<String, dynamic> map) {
    return TagState(
      databasesCount: (() {
        final guardedValue = map['databasesCount'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      dropletsCount: (() {
        final guardedValue = map['dropletsCount'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      imagesCount: (() {
      ...
      totalResourceCount: (() {
        final guardedValue = map['totalResourceCount'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      volumeSnapshotsCount: (() {
        final guardedValue = map['volumeSnapshotsCount'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      volumesCount: (() {
        final guardedValue = map['volumesCount'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
    );
