...
class GetGenaiAgentKnowledgeBase {
  ...
  final GetGenaiAgentKnowledgeBaseLastIndexingJob? lastIndexingJob;
  ...
  factory GetGenaiAgentKnowledgeBase.fromMap(Map<String, dynamic> map) {
    return GetGenaiAgentKnowledgeBase(
      ...
      lastIndexingJob: map['lastIndexingJob'] == null ? null : GetGenaiAgentKnowledgeBaseLastIndexingJob.fromMap((map['lastIndexingJob'] as Map).cast<String, dynamic>()),
