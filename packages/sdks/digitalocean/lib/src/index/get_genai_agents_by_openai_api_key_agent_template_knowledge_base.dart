...
import 'get_genai_agents_by_openai_api_key_agent_template_knowledge_base_last_indexing_job.dart';

class GetGenaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBase {
  ...
  final pulumi.Input<GetGenaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBaseLastIndexingJob>? lastIndexingJob;
  ...
  /// Creates a new [GetGenaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBase].
  ...
  const GetGenaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBase({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'isPublic': ?isPublic,
      'lastIndexingJob': ?pulumi.Input.mapOptionalInputValue<GetGenaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBaseLastIndexingJob, Map<String, dynamic>>(lastIndexingJob, (value) => value.toMap()),
      'name': ?name,
      'projectId': ?projectId,
      'region': ?region,
      'tags': ?tags,
  ...
  factory GetGenaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBase.fromMap(Map<String, dynamic> map) {
    return GetGenaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBase(
      ...
      lastIndexingJob: (() { final guardedValue = map['lastIndexingJob']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GetGenaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBaseLastIndexingJob.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
