...
import 'spaces_bucket_object_state.dart';
...
class SpacesBucketObject extends pulumi.CustomResource {
  ...
  /// Gets an existing [SpacesBucketObject] resource's state with the given [name] and [id].
  static SpacesBucketObject get(
    String name,
