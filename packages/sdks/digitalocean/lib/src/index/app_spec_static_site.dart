...
class AppSpecStaticSite {
  ...
  factory AppSpecStaticSite.fromMap(Map<String, dynamic> map) {
    return AppSpecStaticSite(
      bitbucket: (() { final guardedValue = map['bitbucket']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AppSpecStaticSiteBitbucket.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      cors: (() { final guardedValue = map['cors']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AppSpecStaticSiteCors.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      envs: (() { final guardedValue = map['envs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AppSpecStaticSiteEnv>(guardedValue, (value) => AppSpecStaticSiteEnv.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      git: (() { final guardedValue = map['git']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AppSpecStaticSiteGit.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      github: (() { final guardedValue = map['github']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AppSpecStaticSiteGithub.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      gitlab: (() { final guardedValue = map['gitlab']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AppSpecStaticSiteGitlab.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      routes: (() { final guardedValue = map['routes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AppSpecStaticSiteRoute>(guardedValue, (value) => AppSpecStaticSiteRoute.fromMap((value as Map).cast<String, dynamic>()))); })(),
