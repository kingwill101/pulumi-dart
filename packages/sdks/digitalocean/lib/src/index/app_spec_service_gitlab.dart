...
class AppSpecServiceGitlab {
  ...
  /// Creates a new [AppSpecServiceGitlab].
  ...
  AppSpecServiceGitlab({this.branch, this.deployOnPush, this.repo});
  ...
  factory AppSpecServiceGitlab.fromMap(Map<String, dynamic> map) {
    return AppSpecServiceGitlab(
      branch: (() {
