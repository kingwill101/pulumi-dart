...
class GetGenaiAgentsByOpenaiApiKeyAgentParentAgentAnthropicApiKey {
  ...
  /// Creates a new [GetGenaiAgentsByOpenaiApiKeyAgentParentAgentAnthropicApiKey].
  ...
  /// [uuid] API Key value
  const GetGenaiAgentsByOpenaiApiKeyAgentParentAgentAnthropicApiKey({
  ...
  factory GetGenaiAgentsByOpenaiApiKeyAgentParentAgentAnthropicApiKey.fromMap(Map<String, dynamic> map) {
    return GetGenaiAgentsByOpenaiApiKeyAgentParentAgentAnthropicApiKey(
