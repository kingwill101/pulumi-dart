...
class GetGenaiAgentsByOpenaiApiKeyAgentTemplate {
  ...
  factory GetGenaiAgentsByOpenaiApiKeyAgentTemplate.fromMap(Map<String, dynamic> map) {
    return GetGenaiAgentsByOpenaiApiKeyAgentTemplate(
      ...
      knowledgeBases: (() { final guardedValue = map['knowledgeBases']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetGenaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBase>(guardedValue, (value) => GetGenaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBase.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      models: (() { final guardedValue = map['models']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetGenaiAgentsByOpenaiApiKeyAgentTemplateModel>(guardedValue, (value) => GetGenaiAgentsByOpenaiApiKeyAgentTemplateModel.fromMap((value as Map).cast<String, dynamic>()))); })(),
