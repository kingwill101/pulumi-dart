...
class GetGradientaiAgentsByOpenaiApiKeyAgentTemplateModel {
  ...
  factory GetGradientaiAgentsByOpenaiApiKeyAgentTemplateModel.fromMap(Map<String, dynamic> map) {
    return GetGradientaiAgentsByOpenaiApiKeyAgentTemplateModel(
      agreements: map['agreements'] == null ? null : (pulumi.Input.decodeList<GetGradientaiAgentsByOpenaiApiKeyAgentTemplateModelAgreement>(map['agreements'], (value) => GetGradientaiAgentsByOpenaiApiKeyAgentTemplateModelAgreement.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      versions: map['versions'] == null ? null : (pulumi.Input.decodeList<GetGradientaiAgentsByOpenaiApiKeyAgentTemplateModelVersion>(map['versions'], (value) => GetGradientaiAgentsByOpenaiApiKeyAgentTemplateModelVersion.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
