...
class GetGradientaiAgentsByOpenaiApiKeyAgentTemplateModel {
  ...
  final pulumi.Input<
    List<GetGradientaiAgentsByOpenaiApiKeyAgentTemplateModelAgreement>
  >?
  agreements;
  ...
  /// URL of the Model
  final pulumi.Input<
    List<GetGradientaiAgentsByOpenaiApiKeyAgentTemplateModelVersion>
  >?
  versions;
  ...
  factory GetGradientaiAgentsByOpenaiApiKeyAgentTemplateModel.fromMap(
      ...
      agreements: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                GetGradientaiAgentsByOpenaiApiKeyAgentTemplateModelAgreement.fromMap(
      ...
      versions: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                GetGradientaiAgentsByOpenaiApiKeyAgentTemplateModelVersion.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
