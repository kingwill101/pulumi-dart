...
class GetAppSpecJobAlertDestinations {
  ...
  final pulumi.Input<List<GetAppSpecJobAlertDestinationsSlackWebhook>>?
  slackWebhooks;

  /// Creates a new [GetAppSpecJobAlertDestinations].
  /// [emails] Optional.
  /// [slackWebhooks] Optional.
  GetAppSpecJobAlertDestinations({this.emails, this.slackWebhooks});
    ...
    return <String, dynamic>{
      ...
      'slackWebhooks':
          ?pulumi.Input.mapOptionalInputValue<
            List<GetAppSpecJobAlertDestinationsSlackWebhook>,
    ...
    return GetAppSpecJobAlertDestinations(
      ...
      slackWebhooks: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GetAppSpecJobAlertDestinationsSlackWebhook>(
            guardedValue,
            (value) => GetAppSpecJobAlertDestinationsSlackWebhook.fromMap(
