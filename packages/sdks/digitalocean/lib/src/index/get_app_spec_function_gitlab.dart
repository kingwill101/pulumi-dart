...
class GetAppSpecFunctionGitlab {
  ...
  /// Creates a new [GetAppSpecFunctionGitlab].
  ...
  GetAppSpecFunctionGitlab({this.branch, this.deployOnPush, this.repo});
  ...
  factory GetAppSpecFunctionGitlab.fromMap(Map<String, dynamic> map) {
    return GetAppSpecFunctionGitlab(
      branch: (() {
