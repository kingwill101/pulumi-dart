...
class DatabaseClusterState {
  ...
  final pulumi.Input<List<DatabaseClusterMaintenanceWindow>>?
  maintenanceWindows;
    ...
    return <String, dynamic>{
      'backupRestore':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(backupRestore, (value) => value.toMap()),
      ...
      'maintenanceWindows':
          ?pulumi.Input.mapOptionalInputValue<
            List<DatabaseClusterMaintenanceWindow>,
  ...
  factory DatabaseClusterState.fromMap(Map<String, dynamic> map) {
    return DatabaseClusterState(
      backupRestore: (() {
        final guardedValue = map['backupRestore'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DatabaseClusterBackupRestore.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      clusterUrn: (() {
        final guardedValue = map['clusterUrn'];
        if (guardedValue == null) return null;
      ...
      maintenanceWindows: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DatabaseClusterMaintenanceWindow>(
            guardedValue,
            (value) => DatabaseClusterMaintenanceWindow.fromMap(
      ...
      metricsEndpoints: (() {
        final guardedValue = map['metricsEndpoints'];
        if (guardedValue == null) return null;
      ...
      privateHost: (() {
        final guardedValue = map['privateHost'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      privateNetworkUuid: (() {
      ...
      privateUri: (() {
        final guardedValue = map['privateUri'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      projectId: (() {
      ...
      uiDatabase: (() {
        final guardedValue = map['uiDatabase'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      uiHost: (() {
        final guardedValue = map['uiHost'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      uiPassword: (() {
        final guardedValue = map['uiPassword'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      uiPort: (() {
        final guardedValue = map['uiPort'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      uiUri: (() {
        final guardedValue = map['uiUri'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      uiUser: (() {
        final guardedValue = map['uiUser'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      uri: (() {
