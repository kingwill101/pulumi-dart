...
class GetGenaiAgentsByOpenaiApiKeyAgentParentAgentApiKeyInfo {
  /// API Key value
  ...
  /// Creates a new [GetGenaiAgentsByOpenaiApiKeyAgentParentAgentApiKeyInfo].
  ...
  /// [uuid] API Key value
  const GetGenaiAgentsByOpenaiApiKeyAgentParentAgentApiKeyInfo({
  ...
  factory GetGenaiAgentsByOpenaiApiKeyAgentParentAgentApiKeyInfo.fromMap(Map<String, dynamic> map) {
    return GetGenaiAgentsByOpenaiApiKeyAgentParentAgentApiKeyInfo(
