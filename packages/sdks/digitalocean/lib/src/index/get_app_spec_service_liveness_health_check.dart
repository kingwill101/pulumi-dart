...
class GetAppSpecServiceLivenessHealthCheck {
  ...
  /// Creates a new [GetAppSpecServiceLivenessHealthCheck].
  ...
  const GetAppSpecServiceLivenessHealthCheck({
  ...
  factory GetAppSpecServiceLivenessHealthCheck.fromMap(Map<String, dynamic> map) {
    return GetAppSpecServiceLivenessHealthCheck(
