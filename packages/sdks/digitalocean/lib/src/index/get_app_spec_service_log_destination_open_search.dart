...
class GetAppSpecServiceLogDestinationOpenSearch {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'basicAuth': pulumi.Input.mapInputValue<GetAppSpecServiceLogDestinationOpenSearchBasicAuth, Map<String, dynamic>>(basicAuth, (value) => value.toMap()),
  ...
  factory GetAppSpecServiceLogDestinationOpenSearch.fromMap(Map<String, dynamic> map) {
    return GetAppSpecServiceLogDestinationOpenSearch(
      basicAuth: pulumi.Input.fromValue(GetAppSpecServiceLogDestinationOpenSearchBasicAuth.fromMap((map['basicAuth']! as Map).cast<String, dynamic>())),
