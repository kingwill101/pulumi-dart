...
class GetAppSpecJob {
  ...
  factory GetAppSpecJob.fromMap(Map<String, dynamic> map) {
    return GetAppSpecJob(
      alerts: (() { final guardedValue = map['alerts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetAppSpecJobAlert>(guardedValue, (value) => GetAppSpecJobAlert.fromMap((value as Map).cast<String, dynamic>()))); })(),
      bitbucket: (() { final guardedValue = map['bitbucket']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GetAppSpecJobBitbucket.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      envs: (() { final guardedValue = map['envs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetAppSpecJobEnv>(guardedValue, (value) => GetAppSpecJobEnv.fromMap((value as Map).cast<String, dynamic>()))); })(),
      git: (() { final guardedValue = map['git']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GetAppSpecJobGit.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      termination: (() { final guardedValue = map['termination']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GetAppSpecJobTermination.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
