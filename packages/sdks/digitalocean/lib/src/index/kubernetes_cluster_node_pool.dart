...
class KubernetesClusterNodePool {
    ...
    return <String, dynamic>{
      ...
      'nodes':
          ?pulumi.Input.mapOptionalInputValue<
            List<KubernetesClusterNodePoolNode>,
      ...
      'taints':
          ?pulumi.Input.mapOptionalInputValue<
            List<KubernetesClusterNodePoolTaint>,
            List<Map<String, dynamic>>
          >(
            taints,
            (value) =>
  ...
  factory KubernetesClusterNodePool.fromMap(Map<String, dynamic> map) {
    return KubernetesClusterNodePool(
      actualNodeCount: (() {
        final guardedValue = map['actualNodeCount'];
      ...
      nodes: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<KubernetesClusterNodePoolNode>(
            guardedValue,
            (value) => KubernetesClusterNodePoolNode.fromMap(
      ...
      taints: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<KubernetesClusterNodePoolTaint>(
            guardedValue,
            (value) => KubernetesClusterNodePoolTaint.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
