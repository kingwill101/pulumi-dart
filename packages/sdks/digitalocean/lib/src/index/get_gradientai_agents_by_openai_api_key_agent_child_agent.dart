...
class GetGradientaiAgentsByOpenaiApiKeyAgentChildAgent {
  ...
  final pulumi.Input<
    List<GetGradientaiAgentsByOpenaiApiKeyAgentChildAgentAnthropicApiKey>
  >?
  anthropicApiKeys;

  /// List of API Key Infos
  final pulumi.Input<
    List<GetGradientaiAgentsByOpenaiApiKeyAgentChildAgentApiKeyInfo>
  >?
  apiKeyInfos;

  /// List of API Keys
  final pulumi.Input<
    List<GetGradientaiAgentsByOpenaiApiKeyAgentChildAgentApiKey>
  >?
  apiKeys;

  /// List of Chatbot Identifiers
  final pulumi.Input<
    List<GetGradientaiAgentsByOpenaiApiKeyAgentChildAgentChatbotIdentifier>
  >?
  chatbotIdentifiers;

  /// ChatBot configuration
  final pulumi.Input<
    List<GetGradientaiAgentsByOpenaiApiKeyAgentChildAgentChatbot>
  >?
  chatbots;

  /// List of API Key Infos
  final pulumi.Input<
    List<GetGradientaiAgentsByOpenaiApiKeyAgentChildAgentDeployment>
  >?
  deployments;
  ...
  factory GetGradientaiAgentsByOpenaiApiKeyAgentChildAgent.fromMap(
      ...
      anthropicApiKeys: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                GetGradientaiAgentsByOpenaiApiKeyAgentChildAgentAnthropicApiKey.fromMap(
      ...
      apiKeyInfos: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                GetGradientaiAgentsByOpenaiApiKeyAgentChildAgentApiKeyInfo.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      apiKeys: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                GetGradientaiAgentsByOpenaiApiKeyAgentChildAgentApiKey.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      chatbotIdentifiers: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                GetGradientaiAgentsByOpenaiApiKeyAgentChildAgentChatbotIdentifier.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      chatbots: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                GetGradientaiAgentsByOpenaiApiKeyAgentChildAgentChatbot.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      deployments: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                GetGradientaiAgentsByOpenaiApiKeyAgentChildAgentDeployment.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
