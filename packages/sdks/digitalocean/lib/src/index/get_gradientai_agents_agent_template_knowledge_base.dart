...
class GetGradientaiAgentsAgentTemplateKnowledgeBase {
  ...
  const GetGradientaiAgentsAgentTemplateKnowledgeBase({
  ...
  factory GetGradientaiAgentsAgentTemplateKnowledgeBase.fromMap(Map<String, dynamic> map) {
    return GetGradientaiAgentsAgentTemplateKnowledgeBase(
      ...
      lastIndexingJob: (() { final guardedValue = map['lastIndexingJob']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GetGradientaiAgentsAgentTemplateKnowledgeBaseLastIndexingJob.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
