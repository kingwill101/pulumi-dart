...
class GetGradientaiAgentsAgentTemplateKnowledgeBase {
  ...
  final GetGradientaiAgentsAgentTemplateKnowledgeBaseLastIndexingJob? lastIndexingJob;
  ...
  factory GetGradientaiAgentsAgentTemplateKnowledgeBase.fromMap(Map<String, dynamic> map) {
    return GetGradientaiAgentsAgentTemplateKnowledgeBase(
      ...
      lastIndexingJob: map['lastIndexingJob'] == null ? null : GetGradientaiAgentsAgentTemplateKnowledgeBaseLastIndexingJob.fromMap((map['lastIndexingJob'] as Map).cast<String, dynamic>()),
