...
class GetGradientaiAgentTemplateModel {
  ...
  const GetGradientaiAgentTemplateModel({
    this.agreements,
  ...
  factory GetGradientaiAgentTemplateModel.fromMap(Map<String, dynamic> map) {
    return GetGradientaiAgentTemplateModel(
      agreements: (() { final guardedValue = map['agreements']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetGradientaiAgentTemplateModelAgreement>(guardedValue, (value) => GetGradientaiAgentTemplateModelAgreement.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      versions: (() { final guardedValue = map['versions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetGradientaiAgentTemplateModelVersion>(guardedValue, (value) => GetGradientaiAgentTemplateModelVersion.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
