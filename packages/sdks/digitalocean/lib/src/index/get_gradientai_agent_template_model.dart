...
class GetGradientaiAgentTemplateModel {
  ...
  final pulumi.Input<List<GetGradientaiAgentTemplateModelAgreement>>?
  agreements;
    ...
    return <String, dynamic>{
      'agreements':
          ?pulumi.Input.mapOptionalInputValue<
            List<GetGradientaiAgentTemplateModelAgreement>,
      ...
      'versions':
          ?pulumi.Input.mapOptionalInputValue<
            List<GetGradientaiAgentTemplateModelVersion>,
            List<Map<String, dynamic>>
          >(
            versions,
            (value) =>
    ...
    return GetGradientaiAgentTemplateModel(
      agreements: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GetGradientaiAgentTemplateModelAgreement>(
            guardedValue,
            (value) => GetGradientaiAgentTemplateModelAgreement.fromMap(
      ...
      versions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GetGradientaiAgentTemplateModelVersion>(
            guardedValue,
            (value) => GetGradientaiAgentTemplateModelVersion.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
