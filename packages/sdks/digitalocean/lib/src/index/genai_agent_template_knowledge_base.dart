...
import 'genai_agent_template_knowledge_base_last_indexing_job.dart';
...
class GenaiAgentTemplateKnowledgeBase {
  ...
  /// Creates a new [GenaiAgentTemplateKnowledgeBase].
  ...
  factory GenaiAgentTemplateKnowledgeBase.fromMap(Map<String, dynamic> map) {
    return GenaiAgentTemplateKnowledgeBase(
      ...
      lastIndexingJob: map['lastIndexingJob'] == null ? null : (GenaiAgentTemplateKnowledgeBaseLastIndexingJob.fromMap((map['lastIndexingJob']! as Map).cast<String, dynamic>())).input(),
