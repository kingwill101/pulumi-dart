...
class GetGradientaiAgentTemplateKnowledgeBaseLastIndexingJob {
  ...
  /// Creates a new [GetGradientaiAgentTemplateKnowledgeBaseLastIndexingJob].
  ...
  const GetGradientaiAgentTemplateKnowledgeBaseLastIndexingJob({
  ...
  factory GetGradientaiAgentTemplateKnowledgeBaseLastIndexingJob.fromMap(Map<String, dynamic> map) {
    return GetGradientaiAgentTemplateKnowledgeBaseLastIndexingJob(
