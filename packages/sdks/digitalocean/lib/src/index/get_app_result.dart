...
class GetAppResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'createdAt': createdAt,
      'dedicatedIps':
          pulumi.Input.encodeList<GetAppDedicatedIp, Map<String, dynamic>>(
            dedicatedIps,
            (value) => value.toMap(),
          ),
      ...
      'liveUrl': liveUrl,
      'projectId': projectId,
      'specs': pulumi.Input.encodeList<GetAppSpec, Map<String, dynamic>>(
        specs,
        (value) => value.toMap(),
      ),
      'updatedAt': updatedAt,
  ...
  factory GetAppResult.fromMap(Map<String, dynamic> map) {
    return GetAppResult(
      ...
      dedicatedIps: pulumi.Input.decodeList<GetAppDedicatedIp>(
        map['dedicatedIps']!,
        (value) =>
            GetAppDedicatedIp.fromMap((value as Map).cast<String, dynamic>()),
      ),
      ...
      specs: pulumi.Input.decodeList<GetAppSpec>(
        map['specs']!,
        (value) => GetAppSpec.fromMap((value as Map).cast<String, dynamic>()),
      ),
