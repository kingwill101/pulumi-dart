...
class GetGenaiAgentsAgentModel {
  ...
  factory GetGenaiAgentsAgentModel.fromMap(Map<String, dynamic> map) {
    return GetGenaiAgentsAgentModel(
      agreements: map['agreements'] == null ? null : (pulumi.Input.decodeList<GetGenaiAgentsAgentModelAgreement>(map['agreements'], (value) => GetGenaiAgentsAgentModelAgreement.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      versions: map['versions'] == null ? null : (pulumi.Input.decodeList<GetGenaiAgentsAgentModelVersion>(map['versions'], (value) => GetGenaiAgentsAgentModelVersion.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
