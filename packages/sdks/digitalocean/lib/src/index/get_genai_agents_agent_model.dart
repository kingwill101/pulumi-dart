...
class GetGenaiAgentsAgentModel {
  ...
  final List<GetGenaiAgentsAgentModelAgreement>? agreements;
  ...
  /// URL of the Model
  final List<GetGenaiAgentsAgentModelVersion>? versions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'agreements': ?agreements == null ? null : pulumi.Input.encodeList<GetGenaiAgentsAgentModelAgreement, Map<String, dynamic>>(agreements!, (value) => value.toMap()),
      'createdAt': createdAt,
      ...
      'url': ?url,
      'usecases': ?usecases,
      'versions': ?versions == null ? null : pulumi.Input.encodeList<GetGenaiAgentsAgentModelVersion, Map<String, dynamic>>(versions!, (value) => value.toMap()),
    };
  }

  factory GetGenaiAgentsAgentModel.fromMap(Map<String, dynamic> map) {
    return GetGenaiAgentsAgentModel(
      agreements: map['agreements'] == null ? null : pulumi.Input.decodeList<GetGenaiAgentsAgentModelAgreement>(map['agreements'], (value) => GetGenaiAgentsAgentModelAgreement.fromMap((value as Map).cast<String, dynamic>())),
      ...
      versions: map['versions'] == null ? null : pulumi.Input.decodeList<GetGenaiAgentsAgentModelVersion>(map['versions'], (value) => GetGenaiAgentsAgentModelVersion.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
