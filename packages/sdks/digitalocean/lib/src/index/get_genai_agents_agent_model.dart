...
import 'get_genai_agents_agent_model_agreement.dart';
import 'get_genai_agents_agent_model_version.dart';

class GetGenaiAgentsAgentModel {
  /// Agreement information for the model
  final pulumi.Input<List<GetGenaiAgentsAgentModelAgreement>>? agreements;
  ...
  /// URL of the Model
  final pulumi.Input<List<GetGenaiAgentsAgentModelVersion>>? versions;

  /// Creates a new [GetGenaiAgentsAgentModel].
  ...
  const GetGenaiAgentsAgentModel({
    this.agreements,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'agreements': ?pulumi.Input.mapOptionalInputValue<List<GetGenaiAgentsAgentModelAgreement>, List<Map<String, dynamic>>>(agreements, (value) => pulumi.Input.encodeList<GetGenaiAgentsAgentModelAgreement, Map<String, dynamic>>(value, (value) => value.toMap())),
      'createdAt': createdAt,
      ...
      'url': ?url,
      'usecases': ?usecases,
      'versions': ?pulumi.Input.mapOptionalInputValue<List<GetGenaiAgentsAgentModelVersion>, List<Map<String, dynamic>>>(versions, (value) => pulumi.Input.encodeList<GetGenaiAgentsAgentModelVersion, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory GetGenaiAgentsAgentModel.fromMap(Map<String, dynamic> map) {
    return GetGenaiAgentsAgentModel(
      agreements: (() { final guardedValue = map['agreements']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetGenaiAgentsAgentModelAgreement>(guardedValue, (value) => GetGenaiAgentsAgentModelAgreement.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      versions: (() { final guardedValue = map['versions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetGenaiAgentsAgentModelVersion>(guardedValue, (value) => GetGenaiAgentsAgentModelVersion.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
