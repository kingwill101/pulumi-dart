...
class GetGradientaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBase {
  ...
  const GetGradientaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBase({
  ...
  factory GetGradientaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBase.fromMap(Map<String, dynamic> map) {
    return GetGradientaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBase(
      ...
      lastIndexingJob: (() { final guardedValue = map['lastIndexingJob']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GetGradientaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBaseLastIndexingJob.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
