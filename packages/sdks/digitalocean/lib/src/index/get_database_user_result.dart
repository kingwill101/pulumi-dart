...
class GetDatabaseUserResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'role': role,
      'settings':
          pulumi.Input.encodeList<GetDatabaseUserSetting, Map<String, dynamic>>(
            settings,
            (value) => value.toMap(),
          ),
    };
  ...
  factory GetDatabaseUserResult.fromMap(Map<String, dynamic> map) {
    return GetDatabaseUserResult(
      ...
      settings: pulumi.Input.decodeList<GetDatabaseUserSetting>(
        map['settings']!,
        (value) => GetDatabaseUserSetting.fromMap(
