...
class GetAppSpecService {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'alerts': ?pulumi.Input.mapOptionalInputValue<List<GetAppSpecServiceAlert>, List<Map<String, dynamic>>>(alerts, (value) => pulumi.Input.encodeList<GetAppSpecServiceAlert, Map<String, dynamic>>(value, (value) => value.toMap())),
      'autoscaling': ?pulumi.Input.mapOptionalInputValue<GetAppSpecServiceAutoscaling, Map<String, dynamic>>(autoscaling, (value) => value.toMap()),
      'bitbucket': ?pulumi.Input.mapOptionalInputValue<GetAppSpecServiceBitbucket, Map<String, dynamic>>(bitbucket, (value) => value.toMap()),
      'buildCommand': ?buildCommand,
      'cors': ?pulumi.Input.mapOptionalInputValue<GetAppSpecServiceCors, Map<String, dynamic>>(cors, (value) => value.toMap()),
      'dockerfilePath': ?dockerfilePath,
      'environmentSlug': ?environmentSlug,
      'envs': ?pulumi.Input.mapOptionalInputValue<List<GetAppSpecServiceEnv>, List<Map<String, dynamic>>>(envs, (value) => pulumi.Input.encodeList<GetAppSpecServiceEnv, Map<String, dynamic>>(value, (value) => value.toMap())),
      'git': ?pulumi.Input.mapOptionalInputValue<GetAppSpecServiceGit, Map<String, dynamic>>(git, (value) => value.toMap()),
      'github': ?pulumi.Input.mapOptionalInputValue<GetAppSpecServiceGithub, Map<String, dynamic>>(github, (value) => value.toMap()),
      'gitlab': ?pulumi.Input.mapOptionalInputValue<GetAppSpecServiceGitlab, Map<String, dynamic>>(gitlab, (value) => value.toMap()),
      'healthCheck': ?pulumi.Input.mapOptionalInputValue<GetAppSpecServiceHealthCheck, Map<String, dynamic>>(healthCheck, (value) => value.toMap()),
      'httpPort': httpPort,
      'image': ?pulumi.Input.mapOptionalInputValue<GetAppSpecServiceImage, Map<String, dynamic>>(image, (value) => value.toMap()),
  ...
  factory GetAppSpecService.fromMap(Map<String, dynamic> map) {
    return GetAppSpecService(
      alerts: (() { final guardedValue = map['alerts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetAppSpecServiceAlert>(guardedValue, (value) => GetAppSpecServiceAlert.fromMap((value as Map).cast<String, dynamic>()))); })(),
      autoscaling: (() { final guardedValue = map['autoscaling']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GetAppSpecServiceAutoscaling.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      bitbucket: (() { final guardedValue = map['bitbucket']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GetAppSpecServiceBitbucket.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      cors: (() { final guardedValue = map['cors']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GetAppSpecServiceCors.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      envs: (() { final guardedValue = map['envs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetAppSpecServiceEnv>(guardedValue, (value) => GetAppSpecServiceEnv.fromMap((value as Map).cast<String, dynamic>()))); })(),
      git: (() { final guardedValue = map['git']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GetAppSpecServiceGit.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      github: (() { final guardedValue = map['github']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GetAppSpecServiceGithub.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      gitlab: (() { final guardedValue = map['gitlab']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GetAppSpecServiceGitlab.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      healthCheck: (() { final guardedValue = map['healthCheck']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GetAppSpecServiceHealthCheck.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      httpPort: pulumi.Input.fromValue(map['httpPort'] as int),
      image: (() { final guardedValue = map['image']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GetAppSpecServiceImage.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
