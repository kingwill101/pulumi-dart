...
class GenaiAgentTemplate {
  ...
  factory GenaiAgentTemplate.fromMap(Map<String, dynamic> map) {
    return GenaiAgentTemplate(
      ...
      knowledgeBases: (() { final guardedValue = map['knowledgeBases']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GenaiAgentTemplateKnowledgeBase>(guardedValue, (value) => GenaiAgentTemplateKnowledgeBase.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      models: (() { final guardedValue = map['models']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GenaiAgentTemplateModel>(guardedValue, (value) => GenaiAgentTemplateModel.fromMap((value as Map).cast<String, dynamic>()))); })(),
