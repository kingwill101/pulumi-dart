  ...
  factory DatabaseOpensearchConfigState.fromMap(Map<String, dynamic> map) {
    return DatabaseOpensearchConfigState(
      actionAutoCreateIndexEnabled: (() {
        final guardedValue = map['actionAutoCreateIndexEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      actionDestructiveRequiresName: (() {
        final guardedValue = map['actionDestructiveRequiresName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      clusterId: (() {
      ...
      clusterMaxShardsPerNode: (() {
        final guardedValue = map['clusterMaxShardsPerNode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      clusterRoutingAllocationNodeConcurrentRecoveries: (() {
        final guardedValue =
            map['clusterRoutingAllocationNodeConcurrentRecoveries'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      enableSecurityAudit: (() {
        final guardedValue = map['enableSecurityAudit'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      httpMaxContentLengthBytes: (() {
        final guardedValue = map['httpMaxContentLengthBytes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      httpMaxHeaderSizeBytes: (() {
        final guardedValue = map['httpMaxHeaderSizeBytes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      httpMaxInitialLineLengthBytes: (() {
        final guardedValue = map['httpMaxInitialLineLengthBytes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      indicesFielddataCacheSizePercentage: (() {
        final guardedValue = map['indicesFielddataCacheSizePercentage'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      indicesMemoryIndexBufferSizePercentage: (() {
        final guardedValue = map['indicesMemoryIndexBufferSizePercentage'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      indicesMemoryMaxIndexBufferSizeMb: (() {
        final guardedValue = map['indicesMemoryMaxIndexBufferSizeMb'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      indicesMemoryMinIndexBufferSizeMb: (() {
        final guardedValue = map['indicesMemoryMinIndexBufferSizeMb'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      indicesQueriesCacheSizePercentage: (() {
        final guardedValue = map['indicesQueriesCacheSizePercentage'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      indicesQueryBoolMaxClauseCount: (() {
        final guardedValue = map['indicesQueryBoolMaxClauseCount'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      indicesRecoveryMaxConcurrentFileChunks: (() {
        final guardedValue = map['indicesRecoveryMaxConcurrentFileChunks'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      indicesRecoveryMaxMbPerSec: (() {
        final guardedValue = map['indicesRecoveryMaxMbPerSec'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      ismEnabled: (() {
        final guardedValue = map['ismEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      ismHistoryEnabled: (() {
        final guardedValue = map['ismHistoryEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      ismHistoryMaxAgeHours: (() {
        final guardedValue = map['ismHistoryMaxAgeHours'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      ismHistoryMaxDocs: (() {
        final guardedValue = map['ismHistoryMaxDocs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      ismHistoryRolloverCheckPeriodHours: (() {
        final guardedValue = map['ismHistoryRolloverCheckPeriodHours'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      ismHistoryRolloverRetentionPeriodDays: (() {
        final guardedValue = map['ismHistoryRolloverRetentionPeriodDays'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      overrideMainResponseVersion: (() {
        final guardedValue = map['overrideMainResponseVersion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      pluginsAlertingFilterByBackendRolesEnabled: (() {
        final guardedValue = map['pluginsAlertingFilterByBackendRolesEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      reindexRemoteWhitelists: (() {
        final guardedValue = map['reindexRemoteWhitelists'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      scriptMaxCompilationsRate: (() {
        final guardedValue = map['scriptMaxCompilationsRate'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      searchMaxBuckets: (() {
        final guardedValue = map['searchMaxBuckets'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      threadPoolAnalyzeQueueSize: (() {
        final guardedValue = map['threadPoolAnalyzeQueueSize'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      threadPoolAnalyzeSize: (() {
        final guardedValue = map['threadPoolAnalyzeSize'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      threadPoolForceMergeSize: (() {
        final guardedValue = map['threadPoolForceMergeSize'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      threadPoolGetQueueSize: (() {
        final guardedValue = map['threadPoolGetQueueSize'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      threadPoolGetSize: (() {
        final guardedValue = map['threadPoolGetSize'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      threadPoolSearchQueueSize: (() {
        final guardedValue = map['threadPoolSearchQueueSize'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      threadPoolSearchSize: (() {
        final guardedValue = map['threadPoolSearchSize'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      threadPoolSearchThrottledQueueSize: (() {
        final guardedValue = map['threadPoolSearchThrottledQueueSize'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      threadPoolSearchThrottledSize: (() {
        final guardedValue = map['threadPoolSearchThrottledSize'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      threadPoolWriteQueueSize: (() {
        final guardedValue = map['threadPoolWriteQueueSize'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      threadPoolWriteSize: (() {
        final guardedValue = map['threadPoolWriteSize'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
    );
