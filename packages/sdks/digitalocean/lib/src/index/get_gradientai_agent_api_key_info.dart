...
class GetGradientaiAgentApiKeyInfo {
  /// API Key value
  ...
  /// [uuid] API Key value
  const GetGradientaiAgentApiKeyInfo({
  ...
  factory GetGradientaiAgentApiKeyInfo.fromMap(Map<String, dynamic> map) {
    return GetGradientaiAgentApiKeyInfo(
