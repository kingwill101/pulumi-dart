...
class GetAppSpecFunctionLogDestinationOpenSearch {
  ...
  final pulumi.Input<GetAppSpecFunctionLogDestinationOpenSearchBasicAuth>
  basicAuth;
  ...
  factory GetAppSpecFunctionLogDestinationOpenSearch.fromMap(
    Map<String, dynamic> map,
  ) {
    return GetAppSpecFunctionLogDestinationOpenSearch(
      basicAuth: pulumi.Input.fromValue(
        GetAppSpecFunctionLogDestinationOpenSearchBasicAuth.fromMap(
