...
class GetAppSpecAlert {
  ...
  factory GetAppSpecAlert.fromMap(Map<String, dynamic> map) {
    return GetAppSpecAlert(
      destinations: (() { final guardedValue = map['destinations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GetAppSpecAlertDestinations.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
