...
class GetAppSpecWorkerGitlab {
  ...
  /// Creates a new [GetAppSpecWorkerGitlab].
  ...
  GetAppSpecWorkerGitlab({this.branch, this.deployOnPush, this.repo});
  ...
  factory GetAppSpecWorkerGitlab.fromMap(Map<String, dynamic> map) {
    return GetAppSpecWorkerGitlab(
      branch: (() {
