...
class GetGradientaiAgentsAgentTemplateModel {
  ...
  final pulumi.Input<List<GetGradientaiAgentsAgentTemplateModelAgreement>>?
  agreements;
  ...
  /// URL of the Model
  final pulumi.Input<List<GetGradientaiAgentsAgentTemplateModelVersion>>?
  versions;
    ...
    return <String, dynamic>{
      'agreements':
          ?pulumi.Input.mapOptionalInputValue<
            List<GetGradientaiAgentsAgentTemplateModelAgreement>,
            List<Map<String, dynamic>>
          >(
            agreements,
            (value) =>
                pulumi.Input.encodeList<
                  GetGradientaiAgentsAgentTemplateModelAgreement,
                  Map<String, dynamic>
      ...
      'versions':
          ?pulumi.Input.mapOptionalInputValue<
            List<GetGradientaiAgentsAgentTemplateModelVersion>,
            List<Map<String, dynamic>>
          >(
            versions,
            (value) =>
  ...
  factory GetGradientaiAgentsAgentTemplateModel.fromMap(
    ...
    return GetGradientaiAgentsAgentTemplateModel(
      agreements: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<GetGradientaiAgentsAgentTemplateModelAgreement>(
            guardedValue,
            (value) => GetGradientaiAgentsAgentTemplateModelAgreement.fromMap(
      ...
      versions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GetGradientaiAgentsAgentTemplateModelVersion>(
            guardedValue,
            (value) => GetGradientaiAgentsAgentTemplateModelVersion.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
