...
class GradientaiAgentApiKeyInfo {
  /// API Key value
  ...
  /// Creates a new [GradientaiAgentApiKeyInfo].
  ...
  /// [uuid] API Key value
  const GradientaiAgentApiKeyInfo({
    this.createdAt,
    this.createdBy,
    this.deletedAt,
    this.name,
  ...
  factory GradientaiAgentApiKeyInfo.fromMap(Map<String, dynamic> map) {
    return GradientaiAgentApiKeyInfo(
