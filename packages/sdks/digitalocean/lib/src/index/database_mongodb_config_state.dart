...
class DatabaseMongodbConfigState {
  ...
  factory DatabaseMongodbConfigState.fromMap(Map<String, dynamic> map) {
    return DatabaseMongodbConfigState(
      ...
      slowOpThresholdMs: (() { final guardedValue = map['slowOpThresholdMs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      transactionLifetimeLimitSeconds: (() { final guardedValue = map['transactionLifetimeLimitSeconds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      verbosity: (() { final guardedValue = map['verbosity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
    );
  }
}
