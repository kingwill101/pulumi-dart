...
class DatabaseMongodbConfigState {
  ...
  /// Creates a new [DatabaseMongodbConfigState].
  ...
  /// [verbosity] The log message verbosity level. The verbosity level determines the amount of Informational and Debug messages MongoDB outputs. 0 includes informational messages while 1...5 increases the level to include debug messages. &lt;em&gt;Changing this parameter will lead to a restart of the MongoDB service.&lt;/em&gt; Learn more [here](https://www.mongodb.com/docs/manual/reference/configuration-options/#mongodb-setting-systemLog.verbosity).
  const DatabaseMongodbConfigState({
    this.clusterId,
  ...
  factory DatabaseMongodbConfigState.fromMap(Map<String, dynamic> map) {
    return DatabaseMongodbConfigState(
      ...
      defaultReadConcern: (() { final guardedValue = map['defaultReadConcern']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      defaultWriteConcern: (() { final guardedValue = map['defaultWriteConcern']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      slowOpThresholdMs: (() { final guardedValue = map['slowOpThresholdMs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      transactionLifetimeLimitSeconds: (() { final guardedValue = map['transactionLifetimeLimitSeconds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      verbosity: (() { final guardedValue = map['verbosity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
    );
  }
}
