...
class DatabaseMongodbConfigState {
  ...
  factory DatabaseMongodbConfigState.fromMap(Map<String, dynamic> map) {
    return DatabaseMongodbConfigState(
      ...
      defaultReadConcern: (() {
        final guardedValue = map['defaultReadConcern'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      defaultWriteConcern: (() {
        final guardedValue = map['defaultWriteConcern'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      slowOpThresholdMs: (() {
        final guardedValue = map['slowOpThresholdMs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      transactionLifetimeLimitSeconds: (() {
        final guardedValue = map['transactionLifetimeLimitSeconds'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      verbosity: (() {
