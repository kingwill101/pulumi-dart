...
class GetGenaiAgentsAgentChildAgentDeployment {
  /// API Key value
  ...
  /// Creates a new [GetGenaiAgentsAgentChildAgentDeployment].
  ...
  const GetGenaiAgentsAgentChildAgentDeployment({
  ...
  factory GetGenaiAgentsAgentChildAgentDeployment.fromMap(Map<String, dynamic> map) {
    return GetGenaiAgentsAgentChildAgentDeployment(
