...
class GradientaiAgentTemplateKnowledgeBase {
  ...
  final pulumi.Input<GradientaiAgentTemplateKnowledgeBaseLastIndexingJob>?
  lastIndexingJob;
  ...
  factory GradientaiAgentTemplateKnowledgeBase.fromMap(
    ...
    return GradientaiAgentTemplateKnowledgeBase(
      ...
      lastIndexingJob: (() {
        ...
        return pulumi.Input.fromValue(
          GradientaiAgentTemplateKnowledgeBaseLastIndexingJob.fromMap(
