...
import 'get_genai_agents_agent_knowledge_base_last_indexing_job.dart';

class GetGenaiAgentsAgentKnowledgeBase {
  ...
  final pulumi.Input<GetGenaiAgentsAgentKnowledgeBaseLastIndexingJob>? lastIndexingJob;
  ...
  /// Creates a new [GetGenaiAgentsAgentKnowledgeBase].
  ...
  const GetGenaiAgentsAgentKnowledgeBase({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'isPublic': ?isPublic,
      'lastIndexingJob': ?pulumi.Input.mapOptionalInputValue<GetGenaiAgentsAgentKnowledgeBaseLastIndexingJob, Map<String, dynamic>>(lastIndexingJob, (value) => value.toMap()),
      'name': ?name,
      'projectId': ?projectId,
      'region': ?region,
      'tags': ?tags,
  ...
  factory GetGenaiAgentsAgentKnowledgeBase.fromMap(Map<String, dynamic> map) {
    return GetGenaiAgentsAgentKnowledgeBase(
      ...
      lastIndexingJob: (() { final guardedValue = map['lastIndexingJob']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GetGenaiAgentsAgentKnowledgeBaseLastIndexingJob.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
