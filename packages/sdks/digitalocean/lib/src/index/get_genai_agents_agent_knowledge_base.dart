...
class GetGenaiAgentsAgentKnowledgeBase {
  ...
  factory GetGenaiAgentsAgentKnowledgeBase.fromMap(Map<String, dynamic> map) {
    return GetGenaiAgentsAgentKnowledgeBase(
      ...
      lastIndexingJob: map['lastIndexingJob'] == null ? null : (GetGenaiAgentsAgentKnowledgeBaseLastIndexingJob.fromMap((map['lastIndexingJob'] as Map).cast<String, dynamic>())).input(),
