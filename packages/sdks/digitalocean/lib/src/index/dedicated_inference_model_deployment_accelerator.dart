...
class DedicatedInferenceModelDeploymentAccelerator {
  ...
  /// Creates a new [DedicatedInferenceModelDeploymentAccelerator].
  /// [acceleratorSlug] The slug identifier for the GPU accelerator type.
  /// [scale] The number of accelerator units to allocate. Must be at least 1.
  /// [type] The accelerator type.
  const DedicatedInferenceModelDeploymentAccelerator({
