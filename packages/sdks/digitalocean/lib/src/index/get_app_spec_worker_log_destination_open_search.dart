...
class GetAppSpecWorkerLogDestinationOpenSearch {
  ...
  final pulumi.Input<GetAppSpecWorkerLogDestinationOpenSearchBasicAuth>
  basicAuth;
  ...
  factory GetAppSpecWorkerLogDestinationOpenSearch.fromMap(
    Map<String, dynamic> map,
  ) {
    return GetAppSpecWorkerLogDestinationOpenSearch(
      basicAuth: pulumi.Input.fromValue(
        GetAppSpecWorkerLogDestinationOpenSearchBasicAuth.fromMap(
