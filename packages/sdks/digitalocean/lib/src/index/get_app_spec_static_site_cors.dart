...
class GetAppSpecStaticSiteCors {
  ...
  final pulumi.Input<GetAppSpecStaticSiteCorsAllowOrigins>? allowOrigins;
  ...
  const GetAppSpecStaticSiteCors({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'allowOrigins': ?pulumi.Input.mapOptionalInputValue<GetAppSpecStaticSiteCorsAllowOrigins, Map<String, dynamic>>(allowOrigins, (value) => value.toMap()),
  ...
  factory GetAppSpecStaticSiteCors.fromMap(Map<String, dynamic> map) {
    return GetAppSpecStaticSiteCors(
      ...
      allowOrigins: (() { final guardedValue = map['allowOrigins']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GetAppSpecStaticSiteCorsAllowOrigins.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
