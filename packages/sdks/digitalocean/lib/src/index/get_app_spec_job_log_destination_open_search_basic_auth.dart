...
class GetAppSpecJobLogDestinationOpenSearchBasicAuth {
  ...
  /// Creates a new [GetAppSpecJobLogDestinationOpenSearchBasicAuth].
  ...
  /// [user] Username to authenticate with. Only required when endpoint is set. Defaults to doadmin when clusterName is set.
  const GetAppSpecJobLogDestinationOpenSearchBasicAuth({
    this.password,
    this.user,
  });
  ...
  factory GetAppSpecJobLogDestinationOpenSearchBasicAuth.fromMap(Map<String, dynamic> map) {
    return GetAppSpecJobLogDestinationOpenSearchBasicAuth(
