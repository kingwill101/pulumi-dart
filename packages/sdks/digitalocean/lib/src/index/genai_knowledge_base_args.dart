...
/// {@template pulumi_index_genai_knowledge_base_genai_knowledge_base_args_doc}
/// The set of arguments for GenaiKnowledgeBase.
/// {@endtemplate}
/// {@macro pulumi_index_genai_knowledge_base_genai_knowledge_base_args_doc}
class GenaiKnowledgeBaseArgs {
  ...
  /// Creates a new [GenaiKnowledgeBaseArgs].
  ...
  factory GenaiKnowledgeBaseArgs.fromMap(Map<String, dynamic> map) {
    return GenaiKnowledgeBaseArgs(
      ...
      lastIndexingJobs: (() { final guardedValue = map['lastIndexingJobs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GenaiKnowledgeBaseLastIndexingJob>(guardedValue, (value) => GenaiKnowledgeBaseLastIndexingJob.fromMap((value as Map).cast<String, dynamic>()))); })(),
