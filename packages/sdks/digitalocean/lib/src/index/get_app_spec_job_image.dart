...
class GetAppSpecJobImage {
  ...
  factory GetAppSpecJobImage.fromMap(Map<String, dynamic> map) {
    return GetAppSpecJobImage(
      deployOnPushes: pulumi.Input.fromValue(pulumi.Input.decodeList<GetAppSpecJobImageDeployOnPush>(map['deployOnPushes']!, (value) => GetAppSpecJobImageDeployOnPush.fromMap((value as Map).cast<String, dynamic>()))),
