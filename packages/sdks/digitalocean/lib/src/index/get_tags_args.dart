...
class GetTagsArgs {
  ...
  factory GetTagsArgs.fromMap(Map<String, dynamic> map) {
    return GetTagsArgs(
      filters: (() { final guardedValue = map['filters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetTagsFilter>(guardedValue, (value) => GetTagsFilter.fromMap((value as Map).cast<String, dynamic>()))); })(),
      sorts: (() { final guardedValue = map['sorts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetTagsSort>(guardedValue, (value) => GetTagsSort.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
