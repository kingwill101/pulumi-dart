...
class GetAppSpecServiceBitbucket {
  ...
  /// Creates a new [GetAppSpecServiceBitbucket].
  ...
  GetAppSpecServiceBitbucket({this.branch, this.deployOnPush, this.repo});
  ...
  factory GetAppSpecServiceBitbucket.fromMap(Map<String, dynamic> map) {
    return GetAppSpecServiceBitbucket(
      branch: (() {
