...
class GetGenaiAgentsByOpenaiApiKeyAgentModelVersion {
  ...
  /// Creates a new [GetGenaiAgentsByOpenaiApiKeyAgentModelVersion].
  /// [major] Major version of the model
  /// [minor] Minor version of the model
  /// [patch] Patch version of the model
  const GetGenaiAgentsByOpenaiApiKeyAgentModelVersion({
    this.major,
    this.minor,
    this.patch,
  });
  ...
  factory GetGenaiAgentsByOpenaiApiKeyAgentModelVersion.fromMap(Map<String, dynamic> map) {
    return GetGenaiAgentsByOpenaiApiKeyAgentModelVersion(
