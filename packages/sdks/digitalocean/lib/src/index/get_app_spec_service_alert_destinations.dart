...
class GetAppSpecServiceAlertDestinations {
  ...
  final pulumi.Input<List<GetAppSpecServiceAlertDestinationsSlackWebhook>>?
  slackWebhooks;

  /// Creates a new [GetAppSpecServiceAlertDestinations].
  /// [emails] Optional.
  /// [slackWebhooks] Optional.
  GetAppSpecServiceAlertDestinations({this.emails, this.slackWebhooks});
    ...
    return <String, dynamic>{
      ...
      'slackWebhooks':
          ?pulumi.Input.mapOptionalInputValue<
            List<GetAppSpecServiceAlertDestinationsSlackWebhook>,
    ...
    return GetAppSpecServiceAlertDestinations(
      ...
      slackWebhooks: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<GetAppSpecServiceAlertDestinationsSlackWebhook>(
            guardedValue,
            (value) => GetAppSpecServiceAlertDestinationsSlackWebhook.fromMap(
