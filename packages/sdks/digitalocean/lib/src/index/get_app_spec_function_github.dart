...
class GetAppSpecFunctionGithub {
  ...
  /// Creates a new [GetAppSpecFunctionGithub].
  ...
  GetAppSpecFunctionGithub({this.branch, this.deployOnPush, this.repo});
  ...
  factory GetAppSpecFunctionGithub.fromMap(Map<String, dynamic> map) {
    return GetAppSpecFunctionGithub(
      branch: (() {
