...
class GetGradientaiAgentsAgentKnowledgeBase {
  ...
  final pulumi.Input<GetGradientaiAgentsAgentKnowledgeBaseLastIndexingJob>?
  lastIndexingJob;
    ...
    return <String, dynamic>{
      ...
      'lastIndexingJob':
          ?pulumi.Input.mapOptionalInputValue<
            GetGradientaiAgentsAgentKnowledgeBaseLastIndexingJob,
            Map<String, dynamic>
  ...
  factory GetGradientaiAgentsAgentKnowledgeBase.fromMap(
    ...
    return GetGradientaiAgentsAgentKnowledgeBase(
      ...
      lastIndexingJob: (() {
        ...
        return pulumi.Input.fromValue(
          GetGradientaiAgentsAgentKnowledgeBaseLastIndexingJob.fromMap(
