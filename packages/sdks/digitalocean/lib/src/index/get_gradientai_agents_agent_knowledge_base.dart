...
class GetGradientaiAgentsAgentKnowledgeBase {
  ...
  final GetGradientaiAgentsAgentKnowledgeBaseLastIndexingJob? lastIndexingJob;
  ...
  factory GetGradientaiAgentsAgentKnowledgeBase.fromMap(Map<String, dynamic> map) {
    return GetGradientaiAgentsAgentKnowledgeBase(
      ...
      lastIndexingJob: map['lastIndexingJob'] == null ? null : GetGradientaiAgentsAgentKnowledgeBaseLastIndexingJob.fromMap((map['lastIndexingJob'] as Map).cast<String, dynamic>()),
