...
import 'get_gradientai_agents_agent_knowledge_base_last_indexing_job.dart';

class GetGradientaiAgentsAgentKnowledgeBase {
  ...
  final pulumi.Input<GetGradientaiAgentsAgentKnowledgeBaseLastIndexingJob>? lastIndexingJob;
  ...
  /// Creates a new [GetGradientaiAgentsAgentKnowledgeBase].
  ...
  const GetGradientaiAgentsAgentKnowledgeBase({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'isPublic': ?isPublic,
      'lastIndexingJob': ?pulumi.Input.mapOptionalInputValue<GetGradientaiAgentsAgentKnowledgeBaseLastIndexingJob, Map<String, dynamic>>(lastIndexingJob, (value) => value.toMap()),
      'name': ?name,
      'projectId': ?projectId,
      'region': ?region,
      'tags': ?tags,
  ...
  factory GetGradientaiAgentsAgentKnowledgeBase.fromMap(Map<String, dynamic> map) {
    return GetGradientaiAgentsAgentKnowledgeBase(
      ...
      lastIndexingJob: (() { final guardedValue = map['lastIndexingJob']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GetGradientaiAgentsAgentKnowledgeBaseLastIndexingJob.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
