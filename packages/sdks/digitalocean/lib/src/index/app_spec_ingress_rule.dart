...
class AppSpecIngressRule {
  ...
  factory AppSpecIngressRule.fromMap(Map<String, dynamic> map) {
    return AppSpecIngressRule(
      component: (() { final guardedValue = map['component']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AppSpecIngressRuleComponent.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      cors: (() { final guardedValue = map['cors']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AppSpecIngressRuleCors.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      match: (() { final guardedValue = map['match']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AppSpecIngressRuleMatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      redirect: (() { final guardedValue = map['redirect']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AppSpecIngressRuleRedirect.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
