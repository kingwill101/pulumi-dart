...
class GetAppSpecFunctionAlertDestinations {
  ...
  final pulumi.Input<List<GetAppSpecFunctionAlertDestinationsSlackWebhook>>?
  slackWebhooks;

  /// Creates a new [GetAppSpecFunctionAlertDestinations].
  /// [emails] Optional.
  /// [slackWebhooks] Optional.
  GetAppSpecFunctionAlertDestinations({this.emails, this.slackWebhooks});
    ...
    return <String, dynamic>{
      ...
      'slackWebhooks':
          ?pulumi.Input.mapOptionalInputValue<
            List<GetAppSpecFunctionAlertDestinationsSlackWebhook>,
  ...
  factory GetAppSpecFunctionAlertDestinations.fromMap(
    ...
    return GetAppSpecFunctionAlertDestinations(
      ...
      slackWebhooks: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => GetAppSpecFunctionAlertDestinationsSlackWebhook.fromMap(
