...
import 'database_advanced_postgresql_config_args.dart';
import 'database_advanced_postgresql_config_state.dart';
...
/// ```
class DatabaseAdvancedPostgresqlConfig extends pulumi.CustomResource {
  ...
  late final pulumi.Output<Map<String, String>?> pgParameters;

  /// Creates a new [DatabaseAdvancedPostgresqlConfig].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [DatabaseAdvancedPostgresqlConfig]. {@macro pulumi_index_database_advanced_postgresql_config_database_advanced_postgresql_config_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  DatabaseAdvancedPostgresqlConfig(
    String name, {
    DatabaseAdvancedPostgresqlConfigArgs? args,
  ...
  static DatabaseAdvancedPostgresqlConfig get(
    String name,
  ...
  DatabaseAdvancedPostgresqlConfig._get(
    String name, {
