...
class GetGenaiAgentsAgentTemplate {
  ...
  const GetGenaiAgentsAgentTemplate({
  ...
  factory GetGenaiAgentsAgentTemplate.fromMap(Map<String, dynamic> map) {
    return GetGenaiAgentsAgentTemplate(
      ...
      knowledgeBases: (() { final guardedValue = map['knowledgeBases']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetGenaiAgentsAgentTemplateKnowledgeBase>(guardedValue, (value) => GetGenaiAgentsAgentTemplateKnowledgeBase.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      models: (() { final guardedValue = map['models']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetGenaiAgentsAgentTemplateModel>(guardedValue, (value) => GetGenaiAgentsAgentTemplateModel.fromMap((value as Map).cast<String, dynamic>()))); })(),
