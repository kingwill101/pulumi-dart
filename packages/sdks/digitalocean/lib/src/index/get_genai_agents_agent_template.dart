...
class GetGenaiAgentsAgentTemplate {
  ...
  final List<GetGenaiAgentsAgentTemplateKnowledgeBase>? knowledgeBases;
  /// Maximum tokens allowed
  final int? maxTokens;
  /// Model of the Agent Template
  final List<GetGenaiAgentsAgentTemplateModel>? models;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'k': ?k,
      'knowledgeBases': ?knowledgeBases == null ? null : pulumi.Input.encodeList<GetGenaiAgentsAgentTemplateKnowledgeBase, Map<String, dynamic>>(knowledgeBases!, (value) => value.toMap()),
      'maxTokens': ?maxTokens,
      'models': ?models == null ? null : pulumi.Input.encodeList<GetGenaiAgentsAgentTemplateModel, Map<String, dynamic>>(models!, (value) => value.toMap()),
      'name': ?name,
  ...
  factory GetGenaiAgentsAgentTemplate.fromMap(Map<String, dynamic> map) {
    return GetGenaiAgentsAgentTemplate(
      ...
      knowledgeBases: map['knowledgeBases'] == null ? null : pulumi.Input.decodeList<GetGenaiAgentsAgentTemplateKnowledgeBase>(map['knowledgeBases'], (value) => GetGenaiAgentsAgentTemplateKnowledgeBase.fromMap((value as Map).cast<String, dynamic>())),
      maxTokens: map['maxTokens'] == null ? null : map['maxTokens'] as int,
      models: map['models'] == null ? null : pulumi.Input.decodeList<GetGenaiAgentsAgentTemplateModel>(map['models'], (value) => GetGenaiAgentsAgentTemplateModel.fromMap((value as Map).cast<String, dynamic>())),
