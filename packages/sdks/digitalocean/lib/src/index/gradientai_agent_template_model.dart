...
class GradientaiAgentTemplateModel {
  ...
  factory GradientaiAgentTemplateModel.fromMap(Map<String, dynamic> map) {
    return GradientaiAgentTemplateModel(
      agreements: map['agreements'] == null ? null : (pulumi.Input.decodeList<GradientaiAgentTemplateModelAgreement>(map['agreements'], (value) => GradientaiAgentTemplateModelAgreement.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      versions: map['versions'] == null ? null : (pulumi.Input.decodeList<GradientaiAgentTemplateModelVersion>(map['versions'], (value) => GradientaiAgentTemplateModelVersion.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
