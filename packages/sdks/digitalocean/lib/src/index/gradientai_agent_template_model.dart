...
import 'gradientai_agent_template_model_agreement.dart';
import 'gradientai_agent_template_model_version.dart';

class GradientaiAgentTemplateModel {
  /// Agreement information for the model
  final pulumi.Input<List<GradientaiAgentTemplateModelAgreement>>? agreements;
  ...
  /// URL of the Model
  final pulumi.Input<List<GradientaiAgentTemplateModelVersion>>? versions;

  /// Creates a new [GradientaiAgentTemplateModel].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'agreements': ?pulumi.Input.mapOptionalInputValue<List<GradientaiAgentTemplateModelAgreement>, List<Map<String, dynamic>>>(agreements, (value) => pulumi.Input.encodeList<GradientaiAgentTemplateModelAgreement, Map<String, dynamic>>(value, (value) => value.toMap())),
      'createdAt': ?createdAt,
      ...
      'url': ?url,
      'usecases': ?usecases,
      'versions': ?pulumi.Input.mapOptionalInputValue<List<GradientaiAgentTemplateModelVersion>, List<Map<String, dynamic>>>(versions, (value) => pulumi.Input.encodeList<GradientaiAgentTemplateModelVersion, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory GradientaiAgentTemplateModel.fromMap(Map<String, dynamic> map) {
    return GradientaiAgentTemplateModel(
      agreements: (() { final guardedValue = map['agreements']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GradientaiAgentTemplateModelAgreement>(guardedValue, (value) => GradientaiAgentTemplateModelAgreement.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      versions: (() { final guardedValue = map['versions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GradientaiAgentTemplateModelVersion>(guardedValue, (value) => GradientaiAgentTemplateModelVersion.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
