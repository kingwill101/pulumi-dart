    ...
    return <String, dynamic>{
      'agreements':
          ?pulumi.Input.mapOptionalInputValue<
            List<GradientaiAgentTemplateModelAgreement>,
      ...
      'versions':
          ?pulumi.Input.mapOptionalInputValue<
            List<GradientaiAgentTemplateModelVersion>,
            List<Map<String, dynamic>>
          >(
            versions,
            (value) =>
    ...
    return GradientaiAgentTemplateModel(
      agreements: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GradientaiAgentTemplateModelAgreement>(
            guardedValue,
            (value) => GradientaiAgentTemplateModelAgreement.fromMap(
      ...
      versions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GradientaiAgentTemplateModelVersion>(
            guardedValue,
            (value) => GradientaiAgentTemplateModelVersion.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
