...
class GetGenaiAgentsByOpenaiApiKeyAgentModel {
  ...
  final pulumi.Input<List<GetGenaiAgentsByOpenaiApiKeyAgentModelAgreement>>? agreements;
  ...
  /// URL of the Model
  final pulumi.Input<List<GetGenaiAgentsByOpenaiApiKeyAgentModelVersion>>? versions;
  ...
  const GetGenaiAgentsByOpenaiApiKeyAgentModel({
    this.agreements,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'agreements': ?pulumi.Input.mapOptionalInputValue<List<GetGenaiAgentsByOpenaiApiKeyAgentModelAgreement>, List<Map<String, dynamic>>>(agreements, (value) => pulumi.Input.encodeList<GetGenaiAgentsByOpenaiApiKeyAgentModelAgreement, Map<String, dynamic>>(value, (value) => value.toMap())),
      'createdAt': createdAt,
      ...
      'url': ?url,
      'usecases': ?usecases,
      'versions': ?pulumi.Input.mapOptionalInputValue<List<GetGenaiAgentsByOpenaiApiKeyAgentModelVersion>, List<Map<String, dynamic>>>(versions, (value) => pulumi.Input.encodeList<GetGenaiAgentsByOpenaiApiKeyAgentModelVersion, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory GetGenaiAgentsByOpenaiApiKeyAgentModel.fromMap(Map<String, dynamic> map) {
    return GetGenaiAgentsByOpenaiApiKeyAgentModel(
      agreements: (() { final guardedValue = map['agreements']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetGenaiAgentsByOpenaiApiKeyAgentModelAgreement>(guardedValue, (value) => GetGenaiAgentsByOpenaiApiKeyAgentModelAgreement.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      versions: (() { final guardedValue = map['versions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetGenaiAgentsByOpenaiApiKeyAgentModelVersion>(guardedValue, (value) => GetGenaiAgentsByOpenaiApiKeyAgentModelVersion.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
