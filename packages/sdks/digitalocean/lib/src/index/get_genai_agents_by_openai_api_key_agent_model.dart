...
class GetGenaiAgentsByOpenaiApiKeyAgentModel {
  ...
  final pulumi.Input<List<GetGenaiAgentsByOpenaiApiKeyAgentModelAgreement>>?
  agreements;
  ...
  /// URL of the Model
  final pulumi.Input<List<GetGenaiAgentsByOpenaiApiKeyAgentModelVersion>>?
  versions;
    ...
    return <String, dynamic>{
      'agreements':
          ?pulumi.Input.mapOptionalInputValue<
            List<GetGenaiAgentsByOpenaiApiKeyAgentModelAgreement>,
      ...
      'versions':
          ?pulumi.Input.mapOptionalInputValue<
            List<GetGenaiAgentsByOpenaiApiKeyAgentModelVersion>,
            List<Map<String, dynamic>>
          >(
            versions,
            (value) =>
  ...
  factory GetGenaiAgentsByOpenaiApiKeyAgentModel.fromMap(
    ...
    return GetGenaiAgentsByOpenaiApiKeyAgentModel(
      agreements: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => GetGenaiAgentsByOpenaiApiKeyAgentModelAgreement.fromMap(
      ...
      versions: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<GetGenaiAgentsByOpenaiApiKeyAgentModelVersion>(
            guardedValue,
            (value) => GetGenaiAgentsByOpenaiApiKeyAgentModelVersion.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
