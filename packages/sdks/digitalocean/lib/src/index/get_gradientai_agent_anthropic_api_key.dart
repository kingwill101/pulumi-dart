...
class GetGradientaiAgentAnthropicApiKey {
  ...
  /// Creates a new [GetGradientaiAgentAnthropicApiKey].
  ...
  factory GetGradientaiAgentAnthropicApiKey.fromMap(Map<String, dynamic> map) {
    return GetGradientaiAgentAnthropicApiKey(
