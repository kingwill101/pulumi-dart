...
class GetGradientaiCustomModelsCustomModelActiveDeploymentEndpoint {
  ...
  /// Creates a new [GetGradientaiCustomModelsCustomModelActiveDeploymentEndpoint].
  /// [privateEndpointFqdn] Private endpoint FQDN.
  /// [publicEndpointFqdn] Public endpoint FQDN, if enabled.
  const GetGradientaiCustomModelsCustomModelActiveDeploymentEndpoint({
  ...
  factory GetGradientaiCustomModelsCustomModelActiveDeploymentEndpoint.fromMap(Map<String, dynamic> map) {
    return GetGradientaiCustomModelsCustomModelActiveDeploymentEndpoint(
