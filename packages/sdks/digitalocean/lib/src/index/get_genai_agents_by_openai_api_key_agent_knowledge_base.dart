...
import 'get_genai_agents_by_openai_api_key_agent_knowledge_base_last_indexing_job.dart';
...
class GetGenaiAgentsByOpenaiApiKeyAgentKnowledgeBase {
  ...
  /// Creates a new [GetGenaiAgentsByOpenaiApiKeyAgentKnowledgeBase].
  ...
  const GetGenaiAgentsByOpenaiApiKeyAgentKnowledgeBase({
  ...
  factory GetGenaiAgentsByOpenaiApiKeyAgentKnowledgeBase.fromMap(Map<String, dynamic> map) {
    return GetGenaiAgentsByOpenaiApiKeyAgentKnowledgeBase(
      ...
      lastIndexingJob: (() { final guardedValue = map['lastIndexingJob']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GetGenaiAgentsByOpenaiApiKeyAgentKnowledgeBaseLastIndexingJob.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
