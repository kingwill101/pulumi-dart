...
import 'get_gradientai_agent_knowledge_base_last_indexing_job.dart';

class GetGradientaiAgentKnowledgeBase {
  ...
  final pulumi.Input<GetGradientaiAgentKnowledgeBaseLastIndexingJob>? lastIndexingJob;
  ...
  /// Creates a new [GetGradientaiAgentKnowledgeBase].
  ...
  const GetGradientaiAgentKnowledgeBase({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'isPublic': ?isPublic,
      'lastIndexingJob': ?pulumi.Input.mapOptionalInputValue<GetGradientaiAgentKnowledgeBaseLastIndexingJob, Map<String, dynamic>>(lastIndexingJob, (value) => value.toMap()),
      'name': ?name,
      'projectId': ?projectId,
      'region': ?region,
      'tags': ?tags,
  ...
  factory GetGradientaiAgentKnowledgeBase.fromMap(Map<String, dynamic> map) {
    return GetGradientaiAgentKnowledgeBase(
      ...
      lastIndexingJob: (() { final guardedValue = map['lastIndexingJob']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GetGradientaiAgentKnowledgeBaseLastIndexingJob.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
