...
class GetGradientaiAgentKnowledgeBase {
  ...
  final GetGradientaiAgentKnowledgeBaseLastIndexingJob? lastIndexingJob;
  ...
  factory GetGradientaiAgentKnowledgeBase.fromMap(Map<String, dynamic> map) {
    return GetGradientaiAgentKnowledgeBase(
      ...
      lastIndexingJob: map['lastIndexingJob'] == null ? null : GetGradientaiAgentKnowledgeBaseLastIndexingJob.fromMap((map['lastIndexingJob'] as Map).cast<String, dynamic>()),
