...
class GradientaiAgentChildAgentDeployment {
  /// API Key value
  ...
  /// Creates a new [GradientaiAgentChildAgentDeployment].
  ...
  const GradientaiAgentChildAgentDeployment({
    this.createdAt,
    this.name,
    this.status,
    this.updatedAt,
  ...
  factory GradientaiAgentChildAgentDeployment.fromMap(Map<String, dynamic> map) {
    return GradientaiAgentChildAgentDeployment(
