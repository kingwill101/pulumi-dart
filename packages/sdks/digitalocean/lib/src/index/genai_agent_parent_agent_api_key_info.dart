...
class GenaiAgentParentAgentApiKeyInfo {
  /// API Key value
  ...
  /// Creates a new [GenaiAgentParentAgentApiKeyInfo].
  ...
  /// [uuid] API Key value
  const GenaiAgentParentAgentApiKeyInfo({
    this.createdAt,
    this.createdBy,
    this.deletedAt,
    this.name,
  ...
  factory GenaiAgentParentAgentApiKeyInfo.fromMap(Map<String, dynamic> map) {
    return GenaiAgentParentAgentApiKeyInfo(
