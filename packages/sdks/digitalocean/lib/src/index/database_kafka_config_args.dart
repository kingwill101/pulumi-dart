  ...
  factory DatabaseKafkaConfigArgs.fromMap(Map<String, dynamic> map) {
    return DatabaseKafkaConfigArgs(
      autoCreateTopicsEnable: (() {
        final guardedValue = map['autoCreateTopicsEnable'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      clusterId: pulumi.Input.fromValue(map['clusterId'] as String),
      groupInitialRebalanceDelayMs: (() {
        final guardedValue = map['groupInitialRebalanceDelayMs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      groupMaxSessionTimeoutMs: (() {
        final guardedValue = map['groupMaxSessionTimeoutMs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      groupMinSessionTimeoutMs: (() {
        final guardedValue = map['groupMinSessionTimeoutMs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      logCleanerDeleteRetentionMs: (() {
        final guardedValue = map['logCleanerDeleteRetentionMs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      logCleanerMinCompactionLagMs: (() {
        final guardedValue = map['logCleanerMinCompactionLagMs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      logFlushIntervalMs: (() {
        final guardedValue = map['logFlushIntervalMs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      logIndexIntervalBytes: (() {
        final guardedValue = map['logIndexIntervalBytes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      logMessageDownconversionEnable: (() {
        final guardedValue = map['logMessageDownconversionEnable'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      logMessageTimestampDifferenceMaxMs: (() {
        final guardedValue = map['logMessageTimestampDifferenceMaxMs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      logPreallocate: (() {
        final guardedValue = map['logPreallocate'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      logRetentionBytes: (() {
        final guardedValue = map['logRetentionBytes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      logRetentionHours: (() {
        final guardedValue = map['logRetentionHours'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      logRetentionMs: (() {
        final guardedValue = map['logRetentionMs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      logRollJitterMs: (() {
        final guardedValue = map['logRollJitterMs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      logSegmentDeleteDelayMs: (() {
        final guardedValue = map['logSegmentDeleteDelayMs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      messageMaxBytes: (() {
