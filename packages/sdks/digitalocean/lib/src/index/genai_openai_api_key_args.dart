...
class GenaiOpenaiApiKeyArgs {
  ...
  GenaiOpenaiApiKeyArgs({required this.apiKey, this.models, this.name});
    ...
    return GenaiOpenaiApiKeyArgs(
      ...
      models: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GenaiOpenaiApiKeyModel>(
            guardedValue,
            (value) => GenaiOpenaiApiKeyModel.fromMap(
