...
class GetGradientaiAgentsAgentTemplateKnowledgeBaseLastIndexingJob {
  ...
  /// Creates a new [GetGradientaiAgentsAgentTemplateKnowledgeBaseLastIndexingJob].
  ...
  const GetGradientaiAgentsAgentTemplateKnowledgeBaseLastIndexingJob({
  ...
  factory GetGradientaiAgentsAgentTemplateKnowledgeBaseLastIndexingJob.fromMap(Map<String, dynamic> map) {
    return GetGradientaiAgentsAgentTemplateKnowledgeBaseLastIndexingJob(
