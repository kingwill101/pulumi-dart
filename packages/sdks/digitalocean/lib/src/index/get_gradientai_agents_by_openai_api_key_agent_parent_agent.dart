...
class GetGradientaiAgentsByOpenaiApiKeyAgentParentAgent {
  ...
  factory GetGradientaiAgentsByOpenaiApiKeyAgentParentAgent.fromMap(Map<String, dynamic> map) {
    return GetGradientaiAgentsByOpenaiApiKeyAgentParentAgent(
      ...
      anthropicApiKeys: (() { final guardedValue = map['anthropicApiKeys']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetGradientaiAgentsByOpenaiApiKeyAgentParentAgentAnthropicApiKey>(guardedValue, (value) => GetGradientaiAgentsByOpenaiApiKeyAgentParentAgentAnthropicApiKey.fromMap((value as Map).cast<String, dynamic>()))); })(),
      apiKeyInfos: (() { final guardedValue = map['apiKeyInfos']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetGradientaiAgentsByOpenaiApiKeyAgentParentAgentApiKeyInfo>(guardedValue, (value) => GetGradientaiAgentsByOpenaiApiKeyAgentParentAgentApiKeyInfo.fromMap((value as Map).cast<String, dynamic>()))); })(),
      apiKeys: (() { final guardedValue = map['apiKeys']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetGradientaiAgentsByOpenaiApiKeyAgentParentAgentApiKey>(guardedValue, (value) => GetGradientaiAgentsByOpenaiApiKeyAgentParentAgentApiKey.fromMap((value as Map).cast<String, dynamic>()))); })(),
      chatbotIdentifiers: (() { final guardedValue = map['chatbotIdentifiers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetGradientaiAgentsByOpenaiApiKeyAgentParentAgentChatbotIdentifier>(guardedValue, (value) => GetGradientaiAgentsByOpenaiApiKeyAgentParentAgentChatbotIdentifier.fromMap((value as Map).cast<String, dynamic>()))); })(),
      chatbots: (() { final guardedValue = map['chatbots']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetGradientaiAgentsByOpenaiApiKeyAgentParentAgentChatbot>(guardedValue, (value) => GetGradientaiAgentsByOpenaiApiKeyAgentParentAgentChatbot.fromMap((value as Map).cast<String, dynamic>()))); })(),
      deployments: (() { final guardedValue = map['deployments']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetGradientaiAgentsByOpenaiApiKeyAgentParentAgentDeployment>(guardedValue, (value) => GetGradientaiAgentsByOpenaiApiKeyAgentParentAgentDeployment.fromMap((value as Map).cast<String, dynamic>()))); })(),
