...
class GetGenaiAgentParentAgentAnthropicApiKey {
  ...
  /// Creates a new [GetGenaiAgentParentAgentAnthropicApiKey].
  ...
  factory GetGenaiAgentParentAgentAnthropicApiKey.fromMap(
