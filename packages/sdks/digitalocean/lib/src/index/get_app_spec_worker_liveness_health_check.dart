...
class GetAppSpecWorkerLivenessHealthCheck {
  ...
  /// Creates a new [GetAppSpecWorkerLivenessHealthCheck].
  ...
  const GetAppSpecWorkerLivenessHealthCheck({
  ...
  factory GetAppSpecWorkerLivenessHealthCheck.fromMap(Map<String, dynamic> map) {
    return GetAppSpecWorkerLivenessHealthCheck(
