...
class GetGenaiOpenaiApiKeysOpenaiApiKeyModelVersion {
  ...
  /// Creates a new [GetGenaiOpenaiApiKeysOpenaiApiKeyModelVersion].
  ...
  factory GetGenaiOpenaiApiKeysOpenaiApiKeyModelVersion.fromMap(Map<String, dynamic> map) {
    return GetGenaiOpenaiApiKeysOpenaiApiKeyModelVersion(
