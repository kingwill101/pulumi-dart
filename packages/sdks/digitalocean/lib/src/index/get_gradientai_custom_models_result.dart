...
class GetGradientaiCustomModelsResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'customModels': ?(() { final guardedValue = customModels; if (guardedValue == null) return null; return pulumi.Input.encodeList<GetGradientaiCustomModelsCustomModel, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
  ...
  factory GetGradientaiCustomModelsResult.fromMap(Map<String, dynamic> map) {
    return GetGradientaiCustomModelsResult(
      customModels: (() { final guardedValue = map['customModels']; if (guardedValue == null) return null; return pulumi.Input.decodeList<GetGradientaiCustomModelsCustomModel>(guardedValue, (value) => GetGradientaiCustomModelsCustomModel.fromMap((value as Map).cast<String, dynamic>())); })(),
