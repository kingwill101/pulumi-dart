...
class GenaiAgentTemplateModel {
  ...
  factory GenaiAgentTemplateModel.fromMap(Map<String, dynamic> map) {
    return GenaiAgentTemplateModel(
      agreements: map['agreements'] == null ? null : (pulumi.Input.decodeList<GenaiAgentTemplateModelAgreement>(map['agreements'], (value) => GenaiAgentTemplateModelAgreement.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      versions: map['versions'] == null ? null : (pulumi.Input.decodeList<GenaiAgentTemplateModelVersion>(map['versions'], (value) => GenaiAgentTemplateModelVersion.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
