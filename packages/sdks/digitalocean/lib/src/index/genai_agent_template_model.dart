    ...
    return <String, dynamic>{
      'agreements':
          ?pulumi.Input.mapOptionalInputValue<
            List<GenaiAgentTemplateModelAgreement>,
      ...
      'versions':
          ?pulumi.Input.mapOptionalInputValue<
            List<GenaiAgentTemplateModelVersion>,
            List<Map<String, dynamic>>
          >(
            versions,
            (value) =>
    ...
    return GenaiAgentTemplateModel(
      agreements: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GenaiAgentTemplateModelAgreement>(
            guardedValue,
            (value) => GenaiAgentTemplateModelAgreement.fromMap(
      ...
      versions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GenaiAgentTemplateModelVersion>(
            guardedValue,
            (value) => GenaiAgentTemplateModelVersion.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
