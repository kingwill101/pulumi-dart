...
class GetAppSpecFunctionCorsAllowOrigins {
  ...
  /// Creates a new [GetAppSpecFunctionCorsAllowOrigins].
  ...
  GetAppSpecFunctionCorsAllowOrigins({this.exact, this.prefix, this.regex});
  ...
  factory GetAppSpecFunctionCorsAllowOrigins.fromMap(Map<String, dynamic> map) {
    return GetAppSpecFunctionCorsAllowOrigins(
      exact: (() {
