...
class GetDedicatedInferenceAcceleratorsResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'accelerators': ?(() { final guardedValue = accelerators; if (guardedValue == null) return null; return pulumi.Input.encodeList<GetDedicatedInferenceAcceleratorsAccelerator, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
  ...
  factory GetDedicatedInferenceAcceleratorsResult.fromMap(Map<String, dynamic> map) {
    return GetDedicatedInferenceAcceleratorsResult(
      accelerators: (() { final guardedValue = map['accelerators']; if (guardedValue == null) return null; return pulumi.Input.decodeList<GetDedicatedInferenceAcceleratorsAccelerator>(guardedValue, (value) => GetDedicatedInferenceAcceleratorsAccelerator.fromMap((value as Map).cast<String, dynamic>())); })(),
