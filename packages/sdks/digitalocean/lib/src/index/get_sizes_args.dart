...
class GetSizesArgs {
  ...
  factory GetSizesArgs.fromMap(Map<String, dynamic> map) {
    return GetSizesArgs(
      filters: (() { final guardedValue = map['filters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetSizesFilter>(guardedValue, (value) => GetSizesFilter.fromMap((value as Map).cast<String, dynamic>()))); })(),
      sorts: (() { final guardedValue = map['sorts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetSizesSort>(guardedValue, (value) => GetSizesSort.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
