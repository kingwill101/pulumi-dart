...
class GetAppSpecFunction {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'logDestinations':
          ?pulumi.Input.mapOptionalInputValue<
            List<GetAppSpecFunctionLogDestination>,
            List<Map<String, dynamic>>
          >(
            logDestinations,
            (value) =>
    ...
    return GetAppSpecFunction(
      alerts: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GetAppSpecFunctionAlert>(
            guardedValue,
            (value) => GetAppSpecFunctionAlert.fromMap(
      ...
      bitbucket: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GetAppSpecFunctionBitbucket.fromMap(
      ...
      cors: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GetAppSpecFunctionCors.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      envs: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GetAppSpecFunctionEnv>(
            guardedValue,
            (value) => GetAppSpecFunctionEnv.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      github: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GetAppSpecFunctionGithub.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      gitlab: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GetAppSpecFunctionGitlab.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      logDestinations: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GetAppSpecFunctionLogDestination>(
            guardedValue,
            (value) => GetAppSpecFunctionLogDestination.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      routes: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetAppSpecFunctionRoute>(
          map['routes']!,
          (value) => GetAppSpecFunctionRoute.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
