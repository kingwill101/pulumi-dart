...
class GetGradientaiAgentTemplateKnowledgeBase {
  ...
  final pulumi.Input<GetGradientaiAgentTemplateKnowledgeBaseLastIndexingJob>?
  lastIndexingJob;
  ...
  factory GetGradientaiAgentTemplateKnowledgeBase.fromMap(
    ...
    return GetGradientaiAgentTemplateKnowledgeBase(
      ...
      lastIndexingJob: (() {
        ...
        return pulumi.Input.fromValue(
          GetGradientaiAgentTemplateKnowledgeBaseLastIndexingJob.fromMap(
