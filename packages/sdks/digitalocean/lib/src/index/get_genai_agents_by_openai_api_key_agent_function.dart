...
class GetGenaiAgentsByOpenaiApiKeyAgentFunction {
  ...
  /// [uuid] API Key value
  const GetGenaiAgentsByOpenaiApiKeyAgentFunction({
    this.apiKey,
  ...
  factory GetGenaiAgentsByOpenaiApiKeyAgentFunction.fromMap(Map<String, dynamic> map) {
    return GetGenaiAgentsByOpenaiApiKeyAgentFunction(
