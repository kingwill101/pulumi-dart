...
import 'get_gradientai_agents_by_openai_api_key_agent_knowledge_base_last_indexing_job.dart';

class GetGradientaiAgentsByOpenaiApiKeyAgentKnowledgeBase {
  ...
  final pulumi.Input<GetGradientaiAgentsByOpenaiApiKeyAgentKnowledgeBaseLastIndexingJob>? lastIndexingJob;
  ...
  /// Creates a new [GetGradientaiAgentsByOpenaiApiKeyAgentKnowledgeBase].
  ...
  const GetGradientaiAgentsByOpenaiApiKeyAgentKnowledgeBase({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'isPublic': ?isPublic,
      'lastIndexingJob': ?pulumi.Input.mapOptionalInputValue<GetGradientaiAgentsByOpenaiApiKeyAgentKnowledgeBaseLastIndexingJob, Map<String, dynamic>>(lastIndexingJob, (value) => value.toMap()),
      'name': ?name,
      'projectId': ?projectId,
      'region': ?region,
      'tags': ?tags,
  ...
  factory GetGradientaiAgentsByOpenaiApiKeyAgentKnowledgeBase.fromMap(Map<String, dynamic> map) {
    return GetGradientaiAgentsByOpenaiApiKeyAgentKnowledgeBase(
      ...
      lastIndexingJob: (() { final guardedValue = map['lastIndexingJob']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GetGradientaiAgentsByOpenaiApiKeyAgentKnowledgeBaseLastIndexingJob.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
