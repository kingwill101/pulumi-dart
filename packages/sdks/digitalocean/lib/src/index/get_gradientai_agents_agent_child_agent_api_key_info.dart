...
class GetGradientaiAgentsAgentChildAgentApiKeyInfo {
  /// API Key value
  ...
  /// Creates a new [GetGradientaiAgentsAgentChildAgentApiKeyInfo].
  ...
  factory GetGradientaiAgentsAgentChildAgentApiKeyInfo.fromMap(Map<String, dynamic> map) {
    return GetGradientaiAgentsAgentChildAgentApiKeyInfo(
