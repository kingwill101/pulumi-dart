...
import 'gradientai_agent_model_agreement.dart';
import 'gradientai_agent_model_version.dart';
...
class GradientaiAgentModel {
  ...
  factory GradientaiAgentModel.fromMap(Map<String, dynamic> map) {
    return GradientaiAgentModel(
      agreements: (() { final guardedValue = map['agreements']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GradientaiAgentModelAgreement>(guardedValue, (value) => GradientaiAgentModelAgreement.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      versions: (() { final guardedValue = map['versions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GradientaiAgentModelVersion>(guardedValue, (value) => GradientaiAgentModelVersion.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
