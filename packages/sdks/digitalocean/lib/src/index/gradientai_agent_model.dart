    ...
    return <String, dynamic>{
      'agreements':
          ?pulumi.Input.mapOptionalInputValue<
            List<GradientaiAgentModelAgreement>,
      ...
      'versions':
          ?pulumi.Input.mapOptionalInputValue<
            List<GradientaiAgentModelVersion>,
            List<Map<String, dynamic>>
          >(
            versions,
            (value) =>
    ...
    return GradientaiAgentModel(
      agreements: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GradientaiAgentModelAgreement>(
            guardedValue,
            (value) => GradientaiAgentModelAgreement.fromMap(
      ...
      versions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GradientaiAgentModelVersion>(
            guardedValue,
            (value) => GradientaiAgentModelVersion.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
