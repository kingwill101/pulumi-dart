...
class GetGenaiKnowledgeBaseDataSourcesDatasource {
  ...
  factory GetGenaiKnowledgeBaseDataSourcesDatasource.fromMap(Map<String, dynamic> map) {
    return GetGenaiKnowledgeBaseDataSourcesDatasource(
      ...
      fileUploadDataSources: (() { final guardedValue = map['fileUploadDataSources']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetGenaiKnowledgeBaseDataSourcesDatasourceFileUploadDataSource>(guardedValue, (value) => GetGenaiKnowledgeBaseDataSourcesDatasourceFileUploadDataSource.fromMap((value as Map).cast<String, dynamic>()))); })(),
      lastIndexingJobs: (() { final guardedValue = map['lastIndexingJobs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetGenaiKnowledgeBaseDataSourcesDatasourceLastIndexingJob>(guardedValue, (value) => GetGenaiKnowledgeBaseDataSourcesDatasourceLastIndexingJob.fromMap((value as Map).cast<String, dynamic>()))); })(),
      spacesDataSources: (() { final guardedValue = map['spacesDataSources']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetGenaiKnowledgeBaseDataSourcesDatasourceSpacesDataSource>(guardedValue, (value) => GetGenaiKnowledgeBaseDataSourcesDatasourceSpacesDataSource.fromMap((value as Map).cast<String, dynamic>()))); })(),
      updatedAt: pulumi.Input.fromValue(map['updatedAt'] as String),
      uuid: (() { final guardedValue = map['uuid']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      webCrawlerDataSources: (() { final guardedValue = map['webCrawlerDataSources']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetGenaiKnowledgeBaseDataSourcesDatasourceWebCrawlerDataSource>(guardedValue, (value) => GetGenaiKnowledgeBaseDataSourcesDatasourceWebCrawlerDataSource.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
