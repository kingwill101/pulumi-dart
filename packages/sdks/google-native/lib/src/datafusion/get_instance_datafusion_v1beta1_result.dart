...
class GetInstanceDatafusionV1beta1Result {
  ...
  const GetInstanceDatafusionV1beta1Result({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'accelerators': pulumi.Input.encodeList<AcceleratorResponseDatafusionV1beta1, Map<String, dynamic>>(accelerators, (value) => value.toMap()),
      'apiEndpoint': apiEndpoint,
      'availableVersion': pulumi.Input.encodeList<VersionResponseDatafusionV1beta1, Map<String, dynamic>>(availableVersion, (value) => value.toMap()),
  ...
  factory GetInstanceDatafusionV1beta1Result.fromMap(Map<String, dynamic> map) {
    return GetInstanceDatafusionV1beta1Result(
      accelerators: pulumi.Input.decodeList<AcceleratorResponseDatafusionV1beta1>(map['accelerators']!, (value) => AcceleratorResponseDatafusionV1beta1.fromMap((value as Map).cast<String, dynamic>())),
      apiEndpoint: map['apiEndpoint'] as String,
      availableVersion: pulumi.Input.decodeList<VersionResponseDatafusionV1beta1>(map['availableVersion']!, (value) => VersionResponseDatafusionV1beta1.fromMap((value as Map).cast<String, dynamic>())),
      createTime: map['createTime'] as String,
      cryptoKeyConfig: CryptoKeyConfigResponseDatafusionV1beta1.fromMap((map['cryptoKeyConfig']! as Map).cast<String, dynamic>()),
      ...
      eventPublishConfig: EventPublishConfigResponseDatafusionV1beta1.fromMap((map['eventPublishConfig']! as Map).cast<String, dynamic>()),
      gcsBucket: map['gcsBucket'] as String,
      labels: (map['labels'] as Map).cast<String, String>(),
      name: map['name'] as String,
      networkConfig: NetworkConfigResponseDatafusionV1beta1.fromMap((map['networkConfig']! as Map).cast<String, dynamic>()),
