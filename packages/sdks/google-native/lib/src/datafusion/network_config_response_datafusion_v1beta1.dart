...
class NetworkConfigResponseDatafusionV1beta1 {
  ...
  factory NetworkConfigResponseDatafusionV1beta1.fromMap(Map<String, dynamic> map) {
    return NetworkConfigResponseDatafusionV1beta1(
      ...
      ipAllocation: (map['ipAllocation'] as String).input(),
      network: (map['network'] as String).input(),
      privateServiceConnectConfig: (PrivateServiceConnectConfigResponse.fromMap((map['privateServiceConnectConfig'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
