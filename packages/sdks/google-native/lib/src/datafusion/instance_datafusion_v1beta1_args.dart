...
class InstanceDatafusionV1beta1Args {
  ...
  factory InstanceDatafusionV1beta1Args.fromMap(Map<String, dynamic> map) {
    return InstanceDatafusionV1beta1Args(
      cryptoKeyConfig: map['cryptoKeyConfig'] == null ? null : (CryptoKeyConfigDatafusionV1beta1.fromMap((map['cryptoKeyConfig']! as Map).cast<String, dynamic>())).input(),
      ...
      eventPublishConfig: map['eventPublishConfig'] == null ? null : (EventPublishConfigDatafusionV1beta1.fromMap((map['eventPublishConfig']! as Map).cast<String, dynamic>())).input(),
      instanceId: (map['instanceId'] as String).input(),
      labels: map['labels'] == null ? null : ((map['labels']! as Map).cast<String, String>()).input(),
      location: map['location'] == null ? null : (map['location']! as String).input(),
      networkConfig: map['networkConfig'] == null ? null : (NetworkConfigDatafusionV1beta1.fromMap((map['networkConfig']! as Map).cast<String, dynamic>())).input(),
      ...
      type: (InstanceTypeDatafusionV1beta1.fromValue(map['type'] as String)).input(),
