...
class InstanceDatafusionV1beta1Args {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'project': ?project,
      'type': pulumi.Input.mapInputValue<InstanceTypeDatafusionV1beta1, String>(type, (value) => value.wireValue),
      'version': ?version,
      'zone': ?zone,
    };
  }
  ...
  factory InstanceDatafusionV1beta1Args.fromMap(Map<String, dynamic> map) {
    return InstanceDatafusionV1beta1Args(
      cryptoKeyConfig: (() { final guardedValue = map['cryptoKeyConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CryptoKeyConfigDatafusionV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      eventPublishConfig: (() { final guardedValue = map['eventPublishConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EventPublishConfigDatafusionV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      instanceId: pulumi.Input.fromValue(map['instanceId'] as String),
      labels: (() { final guardedValue = map['labels']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      location: (() { final guardedValue = map['location']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      networkConfig: (() { final guardedValue = map['networkConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkConfigDatafusionV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      type: pulumi.Input.fromValue(InstanceTypeDatafusionV1beta1.fromValue(map['type']! as String)),
