...
class InstanceDatafusionV1beta1Args {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'project': ?project,
      'type': pulumi.Input.mapInputValue<InstanceTypeDatafusionV1beta1, String>(
        type,
    ...
    return InstanceDatafusionV1beta1Args(
      cryptoKeyConfig: (() {
        ...
        return pulumi.Input.fromValue(
          CryptoKeyConfigDatafusionV1beta1.fromMap(
      ...
      enableZoneSeparation: (() {
        final guardedValue = map['enableZoneSeparation'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      eventPublishConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          EventPublishConfigDatafusionV1beta1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      networkConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          NetworkConfigDatafusionV1beta1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      patchRevision: (() {
        final guardedValue = map['patchRevision'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      privateInstance: (() {
      ...
      type: pulumi.Input.fromValue(
        InstanceTypeDatafusionV1beta1.fromValue(map['type']! as String),
      ),
      version: (() {
