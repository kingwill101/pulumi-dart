...
class Instance extends pulumi.CustomResource {
  ...
  Instance(
    ...
    this.accelerators = registerOutput<List<AcceleratorResponse>>('accelerators');
    this.apiEndpoint = registerOutput<String>('apiEndpoint');
    this.availableVersion = registerOutput<List<VersionResponse>>('availableVersion');
    this.createTime = registerOutput<String>('createTime');
    this.cryptoKeyConfig = registerOutput<CryptoKeyConfigResponse>('cryptoKeyConfig');
    ...
    this.eventPublishConfig = registerOutput<EventPublishConfigResponse>('eventPublishConfig');
