...
class Instance extends pulumi.CustomResource {
  ...
  Instance(
    ...
    cryptoKeyConfig = registerOutput<CryptoKeyConfigResponse>('cryptoKeyConfig', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return CryptoKeyConfigResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    eventPublishConfig = registerOutput<EventPublishConfigResponse>('eventPublishConfig', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return EventPublishConfigResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
