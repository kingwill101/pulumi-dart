...
/// {@template pulumi_datafusion_v1beta1_instance_namespace_iam_member_args_doc}
/// The set of arguments for InstanceNamespaceIamMember.
/// {@endtemplate}
/// {@macro pulumi_datafusion_v1beta1_instance_namespace_iam_member_args_doc}
class InstanceNamespaceIamMemberArgs {
  ...
  /// Creates a new [InstanceNamespaceIamMemberArgs].
  ...
  const InstanceNamespaceIamMemberArgs({
    this.condition,
  ...
  factory InstanceNamespaceIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return InstanceNamespaceIamMemberArgs(
