...
class PrivateServiceConnectConfigResponse {
  ...
  const PrivateServiceConnectConfigResponse({
  ...
  factory PrivateServiceConnectConfigResponse.fromMap(Map<String, dynamic> map) {
    return PrivateServiceConnectConfigResponse(
      effectiveUnreachableCidrBlock: pulumi.Input.fromValue(map['effectiveUnreachableCidrBlock'] as String),
      networkAttachment: pulumi.Input.fromValue(map['networkAttachment'] as String),
      unreachableCidrBlock: pulumi.Input.fromValue(map['unreachableCidrBlock'] as String),
    );
  }
}
