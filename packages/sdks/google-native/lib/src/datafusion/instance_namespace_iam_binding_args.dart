...
/// {@template pulumi_datafusion_v1beta1_instance_namespace_iam_binding_args_doc}
/// The set of arguments for InstanceNamespaceIamBinding.
/// {@endtemplate}
/// {@macro pulumi_datafusion_v1beta1_instance_namespace_iam_binding_args_doc}
class InstanceNamespaceIamBindingArgs {
  ...
  /// Creates a new [InstanceNamespaceIamBindingArgs].
  ...
  const InstanceNamespaceIamBindingArgs({
    this.condition,
  ...
  factory InstanceNamespaceIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return InstanceNamespaceIamBindingArgs(
