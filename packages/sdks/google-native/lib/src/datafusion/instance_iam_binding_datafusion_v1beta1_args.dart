...
/// {@template pulumi_datafusion_v1beta1_instance_iam_binding_datafusion_v1beta1_args_doc}
/// The set of arguments for InstanceIamBinding.
/// {@endtemplate}
/// {@macro pulumi_datafusion_v1beta1_instance_iam_binding_datafusion_v1beta1_args_doc}
class InstanceIamBindingDatafusionV1beta1Args {
  ...
  /// Creates a new [InstanceIamBindingDatafusionV1beta1Args].
  ...
  const InstanceIamBindingDatafusionV1beta1Args({
    this.condition,
  ...
  factory InstanceIamBindingDatafusionV1beta1Args.fromMap(Map<String, dynamic> map) {
