...
class ExprResponseDatafusionV1beta1 {
  ...
  /// Creates a new [ExprResponseDatafusionV1beta1].
  ...
  const ExprResponseDatafusionV1beta1({
  ...
  factory ExprResponseDatafusionV1beta1.fromMap(Map<String, dynamic> map) {
    return ExprResponseDatafusionV1beta1(
