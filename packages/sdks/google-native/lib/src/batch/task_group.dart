...
class TaskGroup {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'schedulingPolicy': ?schedulingPolicy == null ? null : schedulingPolicy!.value,
      'taskCount': ?taskCount,
      'taskCountPerNode': ?taskCountPerNode,
      'taskEnvironments': ?taskEnvironments == null ? null : pulumi.Input.encodeList<Environment, Map<String, dynamic>>(taskEnvironments!, (value) => value.toMap()),
  ...
  factory TaskGroup.fromMap(Map<String, dynamic> map) {
    return TaskGroup(
      parallelism: map['parallelism'] == null ? null : map['parallelism'] as String,
      permissiveSsh: map['permissiveSsh'] == null ? null : map['permissiveSsh'] as bool,
      requireHostsFile: map['requireHostsFile'] == null ? null : map['requireHostsFile'] as bool,
      schedulingPolicy: map['schedulingPolicy'] == null ? null : TaskGroupSchedulingPolicy.fromValue(map['schedulingPolicy'] as String),
      taskCount: map['taskCount'] == null ? null : map['taskCount'] as String,
      taskCountPerNode: map['taskCountPerNode'] == null ? null : map['taskCountPerNode'] as String,
      taskEnvironments: map['taskEnvironments'] == null ? null : pulumi.Input.decodeList<Environment>(map['taskEnvironments'], (value) => Environment.fromMap((value as Map).cast<String, dynamic>())),
      taskSpec: TaskSpec.fromMap((map['taskSpec'] as Map).cast<String, dynamic>()),
    );
  }
}
