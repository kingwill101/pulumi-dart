...
class AllocationPolicyResponse {
  ...
  factory AllocationPolicyResponse.fromMap(Map<String, dynamic> map) {
    return AllocationPolicyResponse(
      instances: (pulumi.Input.decodeList<InstancePolicyOrTemplateResponse>(map['instances'], (value) => InstancePolicyOrTemplateResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      labels: ((map['labels'] as Map).cast<String, String>()).input(),
      location: (LocationPolicyResponse.fromMap((map['location'] as Map).cast<String, dynamic>())).input(),
      network: (NetworkPolicyResponse.fromMap((map['network'] as Map).cast<String, dynamic>())).input(),
      placement: (PlacementPolicyResponse.fromMap((map['placement'] as Map).cast<String, dynamic>())).input(),
