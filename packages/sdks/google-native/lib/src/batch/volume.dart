...
class Volume {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'gcs': ?pulumi.Input.mapOptionalInputValue<GCS, Map<String, dynamic>>(
        gcs,
        (value) => value.toMap(),
      ),
      'mountOptions': ?mountOptions,
      'mountPath': ?mountPath,
      'nfs': ?pulumi.Input.mapOptionalInputValue<NFS, Map<String, dynamic>>(
        nfs,
        (value) => value.toMap(),
      ),
    };
    ...
    return Volume(
      ...
      gcs: (() {
        ...
        return pulumi.Input.fromValue(
          GCS.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      mountOptions: (() {
      ...
      nfs: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          NFS.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
