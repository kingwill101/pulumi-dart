...
class RunnableResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'barrier':
          pulumi.Input.mapInputValue<BarrierResponse, Map<String, dynamic>>(
            barrier,
            (value) => value.toMap(),
          ),
      'container':
          pulumi.Input.mapInputValue<ContainerResponse, Map<String, dynamic>>(
            container,
            (value) => value.toMap(),
          ),
      ...
      'labels': labels,
      'script':
          pulumi.Input.mapInputValue<ScriptResponse, Map<String, dynamic>>(
            script,
            (value) => value.toMap(),
          ),
      'timeout': timeout,
  ...
  factory RunnableResponse.fromMap(Map<String, dynamic> map) {
    return RunnableResponse(
      ...
      barrier: pulumi.Input.fromValue(
        BarrierResponse.fromMap(
      ...
      script: pulumi.Input.fromValue(
        ScriptResponse.fromMap((map['script']! as Map).cast<String, dynamic>()),
      ),
