...
class JobNotificationResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'message': pulumi.Input.mapInputValue<MessageResponse, Map<String, dynamic>>(message, (value) => value.toMap()),
  ...
  factory JobNotificationResponse.fromMap(Map<String, dynamic> map) {
    return JobNotificationResponse(
      message: pulumi.Input.fromValue(MessageResponse.fromMap((map['message']! as Map).cast<String, dynamic>())),
