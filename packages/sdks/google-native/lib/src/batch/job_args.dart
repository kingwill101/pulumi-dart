...
class JobArgs {
    ...
    return <String, dynamic>{
      'allocationPolicy':
          ?pulumi.Input.mapOptionalInputValue<
            AllocationPolicy,
            Map<String, dynamic>
          >(allocationPolicy, (value) => value.toMap()),
      'jobId': ?jobId,
      'labels': ?labels,
      'location': ?location,
      'logsPolicy':
  ...
  factory JobArgs.fromMap(Map<String, dynamic> map) {
    return JobArgs(
      ...
      logsPolicy: (() {
        final guardedValue = map['logsPolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          LogsPolicy.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      notifications: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<JobNotification>(
            guardedValue,
            (value) =>
                JobNotification.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      priority: (() {
      ...
      taskGroups: pulumi.Input.fromValue(
        pulumi.Input.decodeList<TaskGroup>(
          map['taskGroups']!,
