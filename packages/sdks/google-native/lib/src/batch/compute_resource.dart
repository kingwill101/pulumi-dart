...
class ComputeResource {
  ...
  factory ComputeResource.fromMap(Map<String, dynamic> map) {
    return ComputeResource(
      bootDiskMib: (() { final guardedValue = map['bootDiskMib']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      cpuMilli: (() { final guardedValue = map['cpuMilli']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      memoryMib: (() { final guardedValue = map['memoryMib']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
