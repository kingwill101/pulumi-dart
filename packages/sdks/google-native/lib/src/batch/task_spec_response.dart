...
class TaskSpecResponse {
  ...
  factory TaskSpecResponse.fromMap(Map<String, dynamic> map) {
    return TaskSpecResponse(
      computeResource: (ComputeResourceResponse.fromMap((map['computeResource'] as Map).cast<String, dynamic>())).input(),
      environment: (EnvironmentResponse.fromMap((map['environment'] as Map).cast<String, dynamic>())).input(),
      environments: ((map['environments'] as Map).cast<String, String>()).input(),
      lifecyclePolicies: (pulumi.Input.decodeList<LifecyclePolicyResponse>(map['lifecyclePolicies'], (value) => LifecyclePolicyResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      maxRetryCount: (map['maxRetryCount'] as int).input(),
      maxRunDuration: (map['maxRunDuration'] as String).input(),
      runnables: (pulumi.Input.decodeList<RunnableResponse>(map['runnables'], (value) => RunnableResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
