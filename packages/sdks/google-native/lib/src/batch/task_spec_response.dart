...
class TaskSpecResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'computeResource': pulumi.Input.mapInputValue<ComputeResourceResponse, Map<String, dynamic>>(computeResource, (value) => value.toMap()),
      'environment': pulumi.Input.mapInputValue<EnvironmentResponse, Map<String, dynamic>>(environment, (value) => value.toMap()),
      'environments': environments,
      'lifecyclePolicies': pulumi.Input.mapInputValue<List<LifecyclePolicyResponse>, List<Map<String, dynamic>>>(lifecyclePolicies, (value) => pulumi.Input.encodeList<LifecyclePolicyResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'maxRetryCount': maxRetryCount,
      'maxRunDuration': maxRunDuration,
      'runnables': pulumi.Input.mapInputValue<List<RunnableResponse>, List<Map<String, dynamic>>>(runnables, (value) => pulumi.Input.encodeList<RunnableResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory TaskSpecResponse.fromMap(Map<String, dynamic> map) {
    return TaskSpecResponse(
      computeResource: pulumi.Input.fromValue(ComputeResourceResponse.fromMap((map['computeResource']! as Map).cast<String, dynamic>())),
      environment: pulumi.Input.fromValue(EnvironmentResponse.fromMap((map['environment']! as Map).cast<String, dynamic>())),
      environments: pulumi.Input.fromValue((map['environments'] as Map).cast<String, String>()),
      lifecyclePolicies: pulumi.Input.fromValue(pulumi.Input.decodeList<LifecyclePolicyResponse>(map['lifecyclePolicies']!, (value) => LifecyclePolicyResponse.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      runnables: pulumi.Input.fromValue(pulumi.Input.decodeList<RunnableResponse>(map['runnables']!, (value) => RunnableResponse.fromMap((value as Map).cast<String, dynamic>()))),
