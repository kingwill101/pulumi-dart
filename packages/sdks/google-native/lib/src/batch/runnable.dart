...
class Runnable {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'barrier':
          ?pulumi.Input.mapOptionalInputValue<Barrier, Map<String, dynamic>>(
            barrier,
            (value) => value.toMap(),
          ),
      'container':
      ...
      'labels': ?labels,
      'script':
          ?pulumi.Input.mapOptionalInputValue<Script, Map<String, dynamic>>(
            script,
            (value) => value.toMap(),
          ),
      'timeout': ?timeout,
  ...
  factory Runnable.fromMap(Map<String, dynamic> map) {
    return Runnable(
      alwaysRun: (() {
        final guardedValue = map['alwaysRun'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      background: (() {
        final guardedValue = map['background'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      barrier: (() {
        final guardedValue = map['barrier'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          Barrier.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      container: (() {
      ...
      ignoreExitStatus: (() {
        final guardedValue = map['ignoreExitStatus'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      labels: (() {
      ...
      script: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          Script.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      timeout: (() {
