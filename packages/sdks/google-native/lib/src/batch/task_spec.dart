...
class TaskSpec {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'runnables':
          ...
          >(
            runnables,
            (value) => pulumi.Input.encodeList<Runnable, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
  ...
  factory TaskSpec.fromMap(Map<String, dynamic> map) {
    return TaskSpec(
      ...
      lifecyclePolicies: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<LifecyclePolicy>(
            guardedValue,
            (value) =>
                LifecyclePolicy.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      maxRetryCount: (() {
      ...
      runnables: (() {
        final guardedValue = map['runnables'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<Runnable>(
            guardedValue,
            (value) => Runnable.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      volumes: (() {
