...
class LocationPolicy {
  ...
  final pulumi.Input<List<String>>? allowedLocations;
  ...
  factory LocationPolicy.fromMap(Map<String, dynamic> map) {
    return LocationPolicy(
      allowedLocations: (() { final guardedValue = map['allowedLocations']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
    );
  }
}
