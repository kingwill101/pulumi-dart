...
class VolumeResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'gcs': pulumi.Input.mapInputValue<GCSResponse, Map<String, dynamic>>(
        gcs,
        (value) => value.toMap(),
      ),
      'mountOptions': mountOptions,
      'mountPath': mountPath,
      'nfs': pulumi.Input.mapInputValue<NFSResponse, Map<String, dynamic>>(
        nfs,
        (value) => value.toMap(),
      ),
    };
  ...
  factory VolumeResponse.fromMap(Map<String, dynamic> map) {
    return VolumeResponse(
      ...
      gcs: pulumi.Input.fromValue(
        GCSResponse.fromMap((map['gcs']! as Map).cast<String, dynamic>()),
      ),
      ...
      nfs: pulumi.Input.fromValue(
        NFSResponse.fromMap((map['nfs']! as Map).cast<String, dynamic>()),
      ),
    );
  }
}
