...
class JobNotification {
  ...
  factory JobNotification.fromMap(Map<String, dynamic> map) {
    return JobNotification(
      message: (() { final guardedValue = map['message']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Message.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
