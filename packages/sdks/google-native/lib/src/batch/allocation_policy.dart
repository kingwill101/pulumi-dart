...
class AllocationPolicy {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'instances': ?instances == null ? null : pulumi.Input.encodeList<InstancePolicyOrTemplate, Map<String, dynamic>>(instances!, (value) => value.toMap()),
      'labels': ?labels,
  ...
  factory AllocationPolicy.fromMap(Map<String, dynamic> map) {
    return AllocationPolicy(
      instances: map['instances'] == null ? null : pulumi.Input.decodeList<InstancePolicyOrTemplate>(map['instances'], (value) => InstancePolicyOrTemplate.fromMap((value as Map).cast<String, dynamic>())),
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      location: map['location'] == null ? null : LocationPolicy.fromMap((map['location'] as Map).cast<String, dynamic>()),
      network: map['network'] == null ? null : NetworkPolicy.fromMap((map['network'] as Map).cast<String, dynamic>()),
      placement: map['placement'] == null ? null : PlacementPolicy.fromMap((map['placement'] as Map).cast<String, dynamic>()),
