...
class AllocationPolicy {
  ...
  factory AllocationPolicy.fromMap(Map<String, dynamic> map) {
    return AllocationPolicy(
      instances: (() { final guardedValue = map['instances']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InstancePolicyOrTemplate>(guardedValue, (value) => InstancePolicyOrTemplate.fromMap((value as Map).cast<String, dynamic>()))); })(),
      labels: (() { final guardedValue = map['labels']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      location: (() { final guardedValue = map['location']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LocationPolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      network: (() { final guardedValue = map['network']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkPolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      placement: (() { final guardedValue = map['placement']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PlacementPolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
