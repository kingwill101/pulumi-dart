...
class TaskGroupResponse {
  ...
  factory TaskGroupResponse.fromMap(Map<String, dynamic> map) {
    return TaskGroupResponse(
      ...
      schedulingPolicy: pulumi.Input.fromValue(
        map['schedulingPolicy'] as String,
      ),
      taskCount: pulumi.Input.fromValue(map['taskCount'] as String),
      taskCountPerNode: pulumi.Input.fromValue(
        map['taskCountPerNode'] as String,
      ),
      taskEnvironments: pulumi.Input.fromValue(
        pulumi.Input.decodeList<EnvironmentResponse>(
      ...
      taskSpec: pulumi.Input.fromValue(
        TaskSpecResponse.fromMap(
          (map['taskSpec']! as Map).cast<String, dynamic>(),
        ),
      ),
    );
  }
