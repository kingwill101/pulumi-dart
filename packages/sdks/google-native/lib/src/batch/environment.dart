...
class Environment {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'encryptedVariables':
          ?pulumi.Input.mapOptionalInputValue<KMSEnvMap, Map<String, dynamic>>(
            encryptedVariables,
            (value) => value.toMap(),
          ),
  ...
  factory Environment.fromMap(Map<String, dynamic> map) {
    return Environment(
      encryptedVariables: (() {
        final guardedValue = map['encryptedVariables'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          KMSEnvMap.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      secretVariables: (() {
        final guardedValue = map['secretVariables'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
