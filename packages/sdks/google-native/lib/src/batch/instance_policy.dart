...
class InstancePolicy {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'provisioningModel': ?pulumi.Input.mapOptionalInputValue<InstancePolicyProvisioningModel, String>(provisioningModel, (value) => value.wireValue),
  ...
  factory InstancePolicy.fromMap(Map<String, dynamic> map) {
    return InstancePolicy(
      accelerators: (() { final guardedValue = map['accelerators']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<Accelerator>(guardedValue, (value) => Accelerator.fromMap((value as Map).cast<String, dynamic>()))); })(),
      bootDisk: (() { final guardedValue = map['bootDisk']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Disk.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      provisioningModel: (() { final guardedValue = map['provisioningModel']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstancePolicyProvisioningModel.fromValue(guardedValue as String)); })(),
