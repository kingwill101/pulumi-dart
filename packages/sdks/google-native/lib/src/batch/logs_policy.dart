...
class LogsPolicy {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'destination': ?pulumi.Input.mapOptionalInputValue<LogsPolicyDestination, String>(destination, (value) => value.wireValue),
      'logsPath': ?logsPath,
    };
  }
  ...
  factory LogsPolicy.fromMap(Map<String, dynamic> map) {
    return LogsPolicy(
      cloudLoggingOption: (() { final guardedValue = map['cloudLoggingOption']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, dynamic>()); })(),
      destination: (() { final guardedValue = map['destination']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LogsPolicyDestination.fromValue(guardedValue as String)); })(),
      logsPath: (() { final guardedValue = map['logsPath']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
