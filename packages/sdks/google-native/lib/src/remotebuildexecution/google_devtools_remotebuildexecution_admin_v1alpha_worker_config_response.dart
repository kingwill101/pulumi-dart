...
class GoogleDevtoolsRemotebuildexecutionAdminV1alphaWorkerConfigResponse {
  ...
  final pulumi.Input<GoogleDevtoolsRemotebuildexecutionAdminV1alphaAcceleratorConfigResponse> accelerator;
  ...
  const GoogleDevtoolsRemotebuildexecutionAdminV1alphaWorkerConfigResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'accelerator': pulumi.Input.mapInputValue<GoogleDevtoolsRemotebuildexecutionAdminV1alphaAcceleratorConfigResponse, Map<String, dynamic>>(accelerator, (value) => value.toMap()),
  ...
  factory GoogleDevtoolsRemotebuildexecutionAdminV1alphaWorkerConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleDevtoolsRemotebuildexecutionAdminV1alphaWorkerConfigResponse(
      accelerator: pulumi.Input.fromValue(GoogleDevtoolsRemotebuildexecutionAdminV1alphaAcceleratorConfigResponse.fromMap((map['accelerator']! as Map).cast<String, dynamic>())),
      ...
      maxConcurrentActions: pulumi.Input.fromValue(map['maxConcurrentActions'] as String),
      minCpuPlatform: pulumi.Input.fromValue(map['minCpuPlatform'] as String),
      networkAccess: pulumi.Input.fromValue(map['networkAccess'] as String),
      reserved: pulumi.Input.fromValue(map['reserved'] as bool),
      soleTenantNodeType: pulumi.Input.fromValue(map['soleTenantNodeType'] as String),
