...
class GoogleDevtoolsRemotebuildexecutionAdminV1alphaWorkerConfig {
  ...
  final GoogleDevtoolsRemotebuildexecutionAdminV1alphaAcceleratorConfig? accelerator;
  ...
  factory GoogleDevtoolsRemotebuildexecutionAdminV1alphaWorkerConfig.fromMap(Map<String, dynamic> map) {
    return GoogleDevtoolsRemotebuildexecutionAdminV1alphaWorkerConfig(
      accelerator: map['accelerator'] == null ? null : GoogleDevtoolsRemotebuildexecutionAdminV1alphaAcceleratorConfig.fromMap((map['accelerator'] as Map).cast<String, dynamic>()),
      diskSizeGb: map['diskSizeGb'] as String,
      diskType: map['diskType'] as String,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      machineType: map['machineType'] as String,
      maxConcurrentActions: map['maxConcurrentActions'] == null ? null : map['maxConcurrentActions'] as String,
      minCpuPlatform: map['minCpuPlatform'] == null ? null : map['minCpuPlatform'] as String,
      networkAccess: map['networkAccess'] == null ? null : map['networkAccess'] as String,
      reserved: map['reserved'] == null ? null : map['reserved'] as bool,
      soleTenantNodeType: map['soleTenantNodeType'] == null ? null : map['soleTenantNodeType'] as String,
