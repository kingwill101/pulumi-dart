    ...
    return GoogleDevtoolsRemotebuildexecutionAdminV1alphaWorkerConfig(
      accelerator: (() {
        ...
        return pulumi.Input.fromValue(
          GoogleDevtoolsRemotebuildexecutionAdminV1alphaAcceleratorConfig.fromMap(
      ...
      maxConcurrentActions: (() {
        final guardedValue = map['maxConcurrentActions'];
        if (guardedValue == null) return null;
      ...
      soleTenantNodeType: (() {
        final guardedValue = map['soleTenantNodeType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      vmImage: (() {
