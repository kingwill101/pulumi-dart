...
class WorkerPool extends pulumi.CustomResource {
  ...
  WorkerPool(
    ...
    this.autoscale = registerOutput<GoogleDevtoolsRemotebuildexecutionAdminV1alphaAutoscaleResponse>('autoscale');
    this.channel = registerOutput<String>('channel');
    this.instanceId = registerOutput<String>('instanceId');
    this.name = registerOutput<String>('name');
    this.project = registerOutput<String>('project');
    this.state = registerOutput<String>('state');
    this.workerConfig = registerOutput<GoogleDevtoolsRemotebuildexecutionAdminV1alphaWorkerConfigResponse>('workerConfig');
