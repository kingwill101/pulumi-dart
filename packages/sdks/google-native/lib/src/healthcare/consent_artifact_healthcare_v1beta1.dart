...
class ConsentArtifactHealthcareV1beta1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<ImageResponseHealthcareV1beta1>> consentContentScreenshots;
  ...
  ConsentArtifactHealthcareV1beta1(
    ...
    this.consentContentScreenshots = registerOutput<List<ImageResponseHealthcareV1beta1>>('consentContentScreenshots');
    this.consentContentVersion = registerOutput<String>('consentContentVersion');
    this.consentStoreId = registerOutput<String>('consentStoreId');
    this.datasetId = registerOutput<String>('datasetId');
    this.guardianSignature = registerOutput<SignatureResponseHealthcareV1beta1>('guardianSignature');
    this.location = registerOutput<String>('location');
    this.metadata = registerOutput<Map<String, String>>('metadata');
    this.name = registerOutput<String>('name');
    this.project = registerOutput<String>('project');
    this.userId = registerOutput<String>('userId');
    this.userSignature = registerOutput<SignatureResponseHealthcareV1beta1>('userSignature');
    this.witnessSignature = registerOutput<SignatureResponseHealthcareV1beta1>('witnessSignature');
  }
}
