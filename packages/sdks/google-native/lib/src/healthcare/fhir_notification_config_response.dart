...
class FhirNotificationConfigResponse {
  ...
  /// Creates a new [FhirNotificationConfigResponse].
  ...
  const FhirNotificationConfigResponse({
  ...
  factory FhirNotificationConfigResponse.fromMap(Map<String, dynamic> map) {
    return FhirNotificationConfigResponse(
      pubsubTopic: pulumi.Input.fromValue(map['pubsubTopic'] as String),
      sendFullResource: pulumi.Input.fromValue(map['sendFullResource'] as bool),
      sendPreviousResourceOnDelete: pulumi.Input.fromValue(map['sendPreviousResourceOnDelete'] as bool),
    );
  }
}
