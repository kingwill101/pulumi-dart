...
import 'dataset_dicom_store_iam_member_args.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class DatasetDicomStoreIamMember extends pulumi.CustomResource {
  ...
  /// Creates a new [DatasetDicomStoreIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [DatasetDicomStoreIamMember]. {@macro pulumi_healthcare_v1_dataset_dicom_store_iam_member_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  DatasetDicomStoreIamMember(
    String name, {
    DatasetDicomStoreIamMemberArgs? args,
