...
class FhirConfigResponse {
  ...
  factory FhirConfigResponse.fromMap(Map<String, dynamic> map) {
    return FhirConfigResponse(
      ...
      fieldMetadataList: (pulumi.Input.decodeList<FieldMetadataResponse>(map['fieldMetadataList'], (value) => FieldMetadataResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
