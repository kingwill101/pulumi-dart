...
class GoogleCloudHealthcareV1ConsentPolicy {
  ...
  final pulumi.Input<Expr> authorizationRule;
  ...
  const GoogleCloudHealthcareV1ConsentPolicy({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'authorizationRule': pulumi.Input.mapInputValue<Expr, Map<String, dynamic>>(authorizationRule, (value) => value.toMap()),
  ...
  factory GoogleCloudHealthcareV1ConsentPolicy.fromMap(Map<String, dynamic> map) {
    return GoogleCloudHealthcareV1ConsentPolicy(
      authorizationRule: pulumi.Input.fromValue(Expr.fromMap((map['authorizationRule']! as Map).cast<String, dynamic>())),
