...
class Options {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'cleanImage': ?pulumi.Input.mapOptionalInputValue<ImageConfigHealthcareV1beta1, Map<String, dynamic>>(cleanImage, (value) => value.toMap()),
      'primaryIds': ?pulumi.Input.mapOptionalInputValue<OptionsPrimaryIds, String>(primaryIds, (value) => value.wireValue),
    };
  }

  factory Options.fromMap(Map<String, dynamic> map) {
    return Options(
      cleanDescriptors: (() { final guardedValue = map['cleanDescriptors']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, dynamic>()); })(),
      cleanImage: (() { final guardedValue = map['cleanImage']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ImageConfigHealthcareV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      primaryIds: (() { final guardedValue = map['primaryIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OptionsPrimaryIds.fromValue(guardedValue as String)); })(),
    );
  }
}
