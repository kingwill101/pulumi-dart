...
class DeidentifiedStoreDestinationResponseHealthcareV1beta1 {
  ...
  const DeidentifiedStoreDestinationResponseHealthcareV1beta1({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'config': pulumi.Input.mapInputValue<DeidentifyConfigResponseHealthcareV1beta1, Map<String, dynamic>>(config, (value) => value.toMap()),
      'store': store,
    };
  }

  factory DeidentifiedStoreDestinationResponseHealthcareV1beta1.fromMap(Map<String, dynamic> map) {
    return DeidentifiedStoreDestinationResponseHealthcareV1beta1(
      config: pulumi.Input.fromValue(DeidentifyConfigResponseHealthcareV1beta1.fromMap((map['config']! as Map).cast<String, dynamic>())),
