...
class GoogleCloudHealthcareV1FhirBigQueryDestination {
  ...
  const GoogleCloudHealthcareV1FhirBigQueryDestination({
    this.datasetUri,
    this.force,
    this.schemaConfig,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'writeDisposition': ?pulumi.Input.mapOptionalInputValue<GoogleCloudHealthcareV1FhirBigQueryDestinationWriteDisposition, String>(writeDisposition, (value) => value.wireValue),
    };
  }
  ...
  factory GoogleCloudHealthcareV1FhirBigQueryDestination.fromMap(Map<String, dynamic> map) {
    return GoogleCloudHealthcareV1FhirBigQueryDestination(
      ...
      schemaConfig: (() { final guardedValue = map['schemaConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SchemaConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      writeDisposition: (() { final guardedValue = map['writeDisposition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudHealthcareV1FhirBigQueryDestinationWriteDisposition.fromValue(guardedValue as String)); })(),
    );
  }
}
