...
class Hl7TypesConfigHealthcareV1beta1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'type': ?pulumi.Input.mapOptionalInputValue<List<TypeHealthcareV1beta1>, List<Map<String, dynamic>>>(type, (value) => pulumi.Input.encodeList<TypeHealthcareV1beta1, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory Hl7TypesConfigHealthcareV1beta1.fromMap(Map<String, dynamic> map) {
    return Hl7TypesConfigHealthcareV1beta1(
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<TypeHealthcareV1beta1>(guardedValue, (value) => TypeHealthcareV1beta1.fromMap((value as Map).cast<String, dynamic>()))); })(),
      version: (() { final guardedValue = map['version']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<VersionSourceHealthcareV1beta1>(guardedValue, (value) => VersionSourceHealthcareV1beta1.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
