...
class ConsentArtifactArgs {
  ...
  factory ConsentArtifactArgs.fromMap(Map<String, dynamic> map) {
    return ConsentArtifactArgs(
      consentContentScreenshots: (() {
        final guardedValue = map['consentContentScreenshots'];
      ...
      consentContentVersion: (() {
        final guardedValue = map['consentContentVersion'];
        if (guardedValue == null) return null;
      ...
      guardianSignature: (() {
        final guardedValue = map['guardianSignature'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          Signature.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      location: (() {
      ...
      userSignature: (() {
        final guardedValue = map['userSignature'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          Signature.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      ...
      witnessSignature: (() {
        final guardedValue = map['witnessSignature'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          Signature.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
