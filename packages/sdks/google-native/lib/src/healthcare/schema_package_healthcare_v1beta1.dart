...
class SchemaPackageHealthcareV1beta1 {
  ...
  final SchemaPackageSchematizedParsingTypeHealthcareV1beta1? schematizedParsingType;
  /// Schema type definitions that are layered based on their VersionSources that match the incoming message. Type definitions present in higher indices override those in lower indices with the same type name if their VersionSources all match an incoming message.
  final List<Hl7TypesConfigHealthcareV1beta1>? types;
  /// Determines how unexpected segments (segments not matched to the schema) are handled.
  final SchemaPackageUnexpectedSegmentHandlingHealthcareV1beta1? unexpectedSegmentHandling;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'schemas': ?schemas == null ? null : pulumi.Input.encodeList<Hl7SchemaConfigHealthcareV1beta1, Map<String, dynamic>>(schemas!, (value) => value.toMap()),
      'schematizedParsingType': ?schematizedParsingType == null ? null : schematizedParsingType!.value,
      'types': ?types == null ? null : pulumi.Input.encodeList<Hl7TypesConfigHealthcareV1beta1, Map<String, dynamic>>(types!, (value) => value.toMap()),
  ...
  factory SchemaPackageHealthcareV1beta1.fromMap(Map<String, dynamic> map) {
    return SchemaPackageHealthcareV1beta1(
      ...
      schemas: map['schemas'] == null ? null : pulumi.Input.decodeList<Hl7SchemaConfigHealthcareV1beta1>(map['schemas'], (value) => Hl7SchemaConfigHealthcareV1beta1.fromMap((value as Map).cast<String, dynamic>())),
      schematizedParsingType: map['schematizedParsingType'] == null ? null : SchemaPackageSchematizedParsingTypeHealthcareV1beta1.fromValue(map['schematizedParsingType'] as String),
      types: map['types'] == null ? null : pulumi.Input.decodeList<Hl7TypesConfigHealthcareV1beta1>(map['types'], (value) => Hl7TypesConfigHealthcareV1beta1.fromMap((value as Map).cast<String, dynamic>())),
      unexpectedSegmentHandling: map['unexpectedSegmentHandling'] == null ? null : SchemaPackageUnexpectedSegmentHandlingHealthcareV1beta1.fromValue(map['unexpectedSegmentHandling'] as String),
    );
  }
}
