...
class SchemaPackageHealthcareV1beta1 {
  ...
  final pulumi.Input<SchemaPackageSchematizedParsingTypeHealthcareV1beta1>?
  ...
  final pulumi.Input<SchemaPackageUnexpectedSegmentHandlingHealthcareV1beta1>?
    ...
    return <String, dynamic>{
      ...
      'schemas':
          ?pulumi.Input.mapOptionalInputValue<
            List<Hl7SchemaConfigHealthcareV1beta1>,
      ...
      'schematizedParsingType':
          ?pulumi.Input.mapOptionalInputValue<
            SchemaPackageSchematizedParsingTypeHealthcareV1beta1,
            String
          >(schematizedParsingType, (value) => value.wireValue),
      'types':
          ?pulumi.Input.mapOptionalInputValue<
            List<Hl7TypesConfigHealthcareV1beta1>,
            List<Map<String, dynamic>>
          >(
            types,
            (value) =>
      ...
      'unexpectedSegmentHandling':
          ?pulumi.Input.mapOptionalInputValue<
            SchemaPackageUnexpectedSegmentHandlingHealthcareV1beta1,
            String
          >(unexpectedSegmentHandling, (value) => value.wireValue),
    };
  }
  ...
  factory SchemaPackageHealthcareV1beta1.fromMap(Map<String, dynamic> map) {
    return SchemaPackageHealthcareV1beta1(
      ignoreMinOccurs: (() {
        final guardedValue = map['ignoreMinOccurs'];
      ...
      schematizedParsingType: (() {
        final guardedValue = map['schematizedParsingType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      unexpectedSegmentHandling: (() {
        final guardedValue = map['unexpectedSegmentHandling'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
