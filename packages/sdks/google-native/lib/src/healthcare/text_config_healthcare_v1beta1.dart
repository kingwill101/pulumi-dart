...
class TextConfigHealthcareV1beta1 {
  ...
  final pulumi.Input<List<InfoTypeTransformationHealthcareV1beta1>>? transformations;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'profileType': ?pulumi.Input.mapOptionalInputValue<TextConfigProfileType, String>(profileType, (value) => value.value),
      'transformations': ?pulumi.Input.mapOptionalInputValue<List<InfoTypeTransformationHealthcareV1beta1>, List<Map<String, dynamic>>>(transformations, (value) => pulumi.Input.encodeList<InfoTypeTransformationHealthcareV1beta1, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
