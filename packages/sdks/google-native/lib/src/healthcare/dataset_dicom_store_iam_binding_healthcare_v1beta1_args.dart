...
/// {@template pulumi_healthcare_v1beta1_dataset_dicom_store_iam_binding_healthcare_v1beta1_args_doc}
/// The set of arguments for DatasetDicomStoreIamBinding.
/// {@endtemplate}
/// {@macro pulumi_healthcare_v1beta1_dataset_dicom_store_iam_binding_healthcare_v1beta1_args_doc}
class DatasetDicomStoreIamBindingHealthcareV1beta1Args {
  ...
  /// Creates a new [DatasetDicomStoreIamBindingHealthcareV1beta1Args].
  ...
  const DatasetDicomStoreIamBindingHealthcareV1beta1Args({
    this.condition,
  ...
  factory DatasetDicomStoreIamBindingHealthcareV1beta1Args.fromMap(Map<String, dynamic> map) {
    return DatasetDicomStoreIamBindingHealthcareV1beta1Args(
