...
class Hl7V2Store extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<Hl7V2NotificationConfigResponse>> notificationConfigs;
  ...
  /// Creates a new [Hl7V2Store].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [Hl7V2Store]. {@macro pulumi_healthcare_v1_hl7_v2_store_args_doc}
  ...
  Hl7V2Store(
    ...
    this.notificationConfigs = registerOutput<List<Hl7V2NotificationConfigResponse>>('notificationConfigs');
