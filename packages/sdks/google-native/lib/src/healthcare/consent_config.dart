...
class ConsentConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'version': pulumi.Input.mapInputValue<ConsentConfigVersion, String>(version, (value) => value.wireValue),
    };
  }

  factory ConsentConfig.fromMap(Map<String, dynamic> map) {
    return ConsentConfig(
      accessDeterminationLogConfig: (() { final guardedValue = map['accessDeterminationLogConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AccessDeterminationLogConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      consentHeaderHandling: (() { final guardedValue = map['consentHeaderHandling']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConsentHeaderHandling.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      version: pulumi.Input.fromValue(ConsentConfigVersion.fromValue(map['version']! as String)),
    );
  }
}
