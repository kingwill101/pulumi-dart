...
class ConsentConfig {
  ...
  final pulumi.Input<AccessDeterminationLogConfig>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'version': pulumi.Input.mapInputValue<ConsentConfigVersion, String>(
        version,
  ...
  factory ConsentConfig.fromMap(Map<String, dynamic> map) {
    return ConsentConfig(
      ...
      version: pulumi.Input.fromValue(
        ConsentConfigVersion.fromValue(map['version']! as String),
      ),
    );
  }
}
