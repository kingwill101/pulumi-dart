...
class ParserConfigHealthcareV1beta1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'version': ?pulumi.Input.mapOptionalInputValue<ParserConfigVersionHealthcareV1beta1, String>(version, (value) => value.wireValue),
    };
  }
  ...
  factory ParserConfigHealthcareV1beta1.fromMap(Map<String, dynamic> map) {
    return ParserConfigHealthcareV1beta1(
      ...
      schema: (() { final guardedValue = map['schema']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SchemaPackageHealthcareV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      version: (() { final guardedValue = map['version']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ParserConfigVersionHealthcareV1beta1.fromValue(guardedValue as String)); })(),
    );
  }
}
