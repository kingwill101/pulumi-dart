...
class Hl7V2StoreHealthcareV1beta1Args {
  ...
  const Hl7V2StoreHealthcareV1beta1Args({
  ...
  factory Hl7V2StoreHealthcareV1beta1Args.fromMap(Map<String, dynamic> map) {
    return Hl7V2StoreHealthcareV1beta1Args(
      ...
      notificationConfigs: (() { final guardedValue = map['notificationConfigs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<Hl7V2NotificationConfigHealthcareV1beta1>(guardedValue, (value) => Hl7V2NotificationConfigHealthcareV1beta1.fromMap((value as Map).cast<String, dynamic>()))); })(),
      parserConfig: (() { final guardedValue = map['parserConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ParserConfigHealthcareV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
