...
class DicomConfigResponseHealthcareV1beta1 {
  ...
  factory DicomConfigResponseHealthcareV1beta1.fromMap(Map<String, dynamic> map) {
    return DicomConfigResponseHealthcareV1beta1(
      ...
      keepList: (TagFilterListResponseHealthcareV1beta1.fromMap((map['keepList'] as Map).cast<String, dynamic>())).input(),
      removeList: (TagFilterListResponseHealthcareV1beta1.fromMap((map['removeList'] as Map).cast<String, dynamic>())).input(),
