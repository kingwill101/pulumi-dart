...
/// {@template pulumi_healthcare_v1beta1_dataset_dicom_store_iam_member_healthcare_v1beta1_args_doc}
/// The set of arguments for DatasetDicomStoreIamMember.
/// {@endtemplate}
/// {@macro pulumi_healthcare_v1beta1_dataset_dicom_store_iam_member_healthcare_v1beta1_args_doc}
class DatasetDicomStoreIamMemberHealthcareV1beta1Args {
  ...
  /// Creates a new [DatasetDicomStoreIamMemberHealthcareV1beta1Args].
  ...
  const DatasetDicomStoreIamMemberHealthcareV1beta1Args({
    this.condition,
  ...
  factory DatasetDicomStoreIamMemberHealthcareV1beta1Args.fromMap(Map<String, dynamic> map) {
    return DatasetDicomStoreIamMemberHealthcareV1beta1Args(
