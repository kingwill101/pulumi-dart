...
/// {@template pulumi_healthcare_v1_dataset_dicom_store_iam_binding_args_doc}
/// The set of arguments for DatasetDicomStoreIamBinding.
/// {@endtemplate}
/// {@macro pulumi_healthcare_v1_dataset_dicom_store_iam_binding_args_doc}
class DatasetDicomStoreIamBindingArgs {
  ...
  /// Creates a new [DatasetDicomStoreIamBindingArgs].
  ...
  const DatasetDicomStoreIamBindingArgs({
    this.condition,
