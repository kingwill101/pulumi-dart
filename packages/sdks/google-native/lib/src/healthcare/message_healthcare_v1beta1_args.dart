...
/// {@template pulumi_healthcare_v1beta1_message_healthcare_v1beta1_args_doc}
/// The set of arguments for Message.
/// {@endtemplate}
/// {@macro pulumi_healthcare_v1beta1_message_healthcare_v1beta1_args_doc}
class MessageHealthcareV1beta1Args {
  ...
  /// Creates a new [MessageHealthcareV1beta1Args].
  ...
  const MessageHealthcareV1beta1Args({
    this.data,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'patientIds': ?pulumi.Input.mapOptionalInputValue<List<PatientIdHealthcareV1beta1>, List<Map<String, dynamic>>>(patientIds, (value) => pulumi.Input.encodeList<PatientIdHealthcareV1beta1, Map<String, dynamic>>(value, (value) => value.toMap())),
      'project': ?project,
      'schematizedData': ?pulumi.Input.mapOptionalInputValue<SchematizedDataHealthcareV1beta1, Map<String, dynamic>>(schematizedData, (value) => value.toMap()),
  ...
  factory MessageHealthcareV1beta1Args.fromMap(Map<String, dynamic> map) {
    return MessageHealthcareV1beta1Args(
      ...
      patientIds: (() { final guardedValue = map['patientIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PatientIdHealthcareV1beta1>(guardedValue, (value) => PatientIdHealthcareV1beta1.fromMap((value as Map).cast<String, dynamic>()))); })(),
      project: (() { final guardedValue = map['project']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      schematizedData: (() { final guardedValue = map['schematizedData']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SchematizedDataHealthcareV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      sendFacility: (() { final guardedValue = map['sendFacility']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      sendTime: (() { final guardedValue = map['sendTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
