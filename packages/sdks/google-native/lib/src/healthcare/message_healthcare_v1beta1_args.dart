...
class MessageHealthcareV1beta1Args {
  ...
  MessageHealthcareV1beta1Args({
    ...
    pulumi.Output<List<PatientIdHealthcareV1beta1>>? patientIds,
    pulumi.Output<String>? project,
    pulumi.Output<SchematizedDataHealthcareV1beta1>? schematizedData,
    ...
    pulumi.Output<String>? sendTime,
      ...
      patientIds = pulumi.Input.asOptionalInput<List<PatientIdHealthcareV1beta1>>(patientIds),
      project = pulumi.Input.asOptionalInput<String>(project),
      schematizedData = pulumi.Input.asOptionalInput<SchematizedDataHealthcareV1beta1>(schematizedData),
  ...
  factory MessageHealthcareV1beta1Args.fromMap(Map<String, dynamic> map) {
    return MessageHealthcareV1beta1Args(
      ...
      patientIds: map['patientIds'] == null ? null : pulumi.Output.create<List<PatientIdHealthcareV1beta1>>(pulumi.Input.decodeList<PatientIdHealthcareV1beta1>(map['patientIds'], (value) => PatientIdHealthcareV1beta1.fromMap((value as Map).cast<String, dynamic>()))),
      project: map['project'] == null ? null : pulumi.Output.create<String>(map['project'] as String),
      schematizedData: map['schematizedData'] == null ? null : pulumi.Output.create<SchematizedDataHealthcareV1beta1>(SchematizedDataHealthcareV1beta1.fromMap((map['schematizedData'] as Map).cast<String, dynamic>())),
