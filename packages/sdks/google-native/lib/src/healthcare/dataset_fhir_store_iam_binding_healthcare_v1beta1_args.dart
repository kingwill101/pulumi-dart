...
/// {@template pulumi_healthcare_v1beta1_dataset_fhir_store_iam_binding_healthcare_v1beta1_args_doc}
/// The set of arguments for DatasetFhirStoreIamBinding.
/// {@endtemplate}
/// {@macro pulumi_healthcare_v1beta1_dataset_fhir_store_iam_binding_healthcare_v1beta1_args_doc}
class DatasetFhirStoreIamBindingHealthcareV1beta1Args {
  ...
  /// Creates a new [DatasetFhirStoreIamBindingHealthcareV1beta1Args].
  ...
  const DatasetFhirStoreIamBindingHealthcareV1beta1Args({
    this.condition,
  ...
  factory DatasetFhirStoreIamBindingHealthcareV1beta1Args.fromMap(Map<String, dynamic> map) {
    return DatasetFhirStoreIamBindingHealthcareV1beta1Args(
