...
class GetMessageResult {
  ...
  /// Creates a new [GetMessageResult].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'patientIds': pulumi.Input.encodeList<PatientIdResponse, Map<String, dynamic>>(patientIds, (value) => value.toMap()),
  ...
  factory GetMessageResult.fromMap(Map<String, dynamic> map) {
    return GetMessageResult(
      ...
      parsedData: ParsedDataResponse.fromMap((map['parsedData']! as Map).cast<String, dynamic>()),
      patientIds: pulumi.Input.decodeList<PatientIdResponse>(map['patientIds']!, (value) => PatientIdResponse.fromMap((value as Map).cast<String, dynamic>())),
      schematizedData: SchematizedDataResponse.fromMap((map['schematizedData']! as Map).cast<String, dynamic>()),
