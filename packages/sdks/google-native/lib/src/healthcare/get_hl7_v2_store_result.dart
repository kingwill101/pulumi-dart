...
class GetHl7V2StoreResult {
  ...
  /// Creates a new [GetHl7V2StoreResult].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'labels': labels,
      'name': name,
      'notificationConfigs': pulumi.Input.encodeList<Hl7V2NotificationConfigResponse, Map<String, dynamic>>(notificationConfigs, (value) => value.toMap()),
  ...
  factory GetHl7V2StoreResult.fromMap(Map<String, dynamic> map) {
    return GetHl7V2StoreResult(
      ...
      notificationConfigs: pulumi.Input.decodeList<Hl7V2NotificationConfigResponse>(map['notificationConfigs']!, (value) => Hl7V2NotificationConfigResponse.fromMap((value as Map).cast<String, dynamic>())),
      parserConfig: ParserConfigResponse.fromMap((map['parserConfig']! as Map).cast<String, dynamic>()),
