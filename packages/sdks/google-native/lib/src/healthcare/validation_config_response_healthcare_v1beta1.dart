...
class ValidationConfigResponseHealthcareV1beta1 {
  ...
  /// Creates a new [ValidationConfigResponseHealthcareV1beta1].
  ...
  const ValidationConfigResponseHealthcareV1beta1({
  ...
  factory ValidationConfigResponseHealthcareV1beta1.fromMap(Map<String, dynamic> map) {
    return ValidationConfigResponseHealthcareV1beta1(
      disableFhirpathValidation: pulumi.Input.fromValue(map['disableFhirpathValidation'] as bool),
      disableProfileValidation: pulumi.Input.fromValue(map['disableProfileValidation'] as bool),
      disableReferenceTypeValidation: pulumi.Input.fromValue(map['disableReferenceTypeValidation'] as bool),
      disableRequiredFieldValidation: pulumi.Input.fromValue(map['disableRequiredFieldValidation'] as bool),
      enabledImplementationGuides: pulumi.Input.fromValue((map['enabledImplementationGuides'] as List).cast<String>()),
    );
  }
}
