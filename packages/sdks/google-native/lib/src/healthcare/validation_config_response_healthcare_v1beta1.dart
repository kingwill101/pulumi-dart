...
class ValidationConfigResponseHealthcareV1beta1 {
  ...
  factory ValidationConfigResponseHealthcareV1beta1.fromMap(Map<String, dynamic> map) {
    return ValidationConfigResponseHealthcareV1beta1(
      disableFhirpathValidation: (map['disableFhirpathValidation'] as bool).input(),
      disableProfileValidation: (map['disableProfileValidation'] as bool).input(),
      disableReferenceTypeValidation: (map['disableReferenceTypeValidation'] as bool).input(),
      disableRequiredFieldValidation: (map['disableRequiredFieldValidation'] as bool).input(),
      enabledImplementationGuides: ((map['enabledImplementationGuides'] as List).cast<String>()).input(),
    );
  }
}
