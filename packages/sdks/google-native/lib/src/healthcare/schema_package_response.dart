...
class SchemaPackageResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'schemas': pulumi.Input.encodeList<Hl7SchemaConfigResponse, Map<String, dynamic>>(schemas, (value) => value.toMap()),
      'schematizedParsingType': schematizedParsingType,
      'types': pulumi.Input.encodeList<Hl7TypesConfigResponse, Map<String, dynamic>>(types, (value) => value.toMap()),
  ...
  factory SchemaPackageResponse.fromMap(Map<String, dynamic> map) {
    return SchemaPackageResponse(
      ...
      schemas: pulumi.Input.decodeList<Hl7SchemaConfigResponse>(map['schemas'], (value) => Hl7SchemaConfigResponse.fromMap((value as Map).cast<String, dynamic>())),
      schematizedParsingType: map['schematizedParsingType'] as String,
      types: pulumi.Input.decodeList<Hl7TypesConfigResponse>(map['types'], (value) => Hl7TypesConfigResponse.fromMap((value as Map).cast<String, dynamic>())),
