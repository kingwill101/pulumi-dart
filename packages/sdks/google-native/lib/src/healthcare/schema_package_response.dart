...
class SchemaPackageResponse {
  ...
  factory SchemaPackageResponse.fromMap(Map<String, dynamic> map) {
    return SchemaPackageResponse(
      ...
      schemas: (pulumi.Input.decodeList<Hl7SchemaConfigResponse>(map['schemas'], (value) => Hl7SchemaConfigResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      schematizedParsingType: (map['schematizedParsingType'] as String).input(),
      types: (pulumi.Input.decodeList<Hl7TypesConfigResponse>(map['types'], (value) => Hl7TypesConfigResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
