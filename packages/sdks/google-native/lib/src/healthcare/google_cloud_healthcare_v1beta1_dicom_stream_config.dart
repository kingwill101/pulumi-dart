...
class GoogleCloudHealthcareV1beta1DicomStreamConfig {
  ...
  final pulumi.Input<GoogleCloudHealthcareV1beta1DicomBigQueryDestination>? bigqueryDestination;

  /// Creates a new [GoogleCloudHealthcareV1beta1DicomStreamConfig].
  ...
  const GoogleCloudHealthcareV1beta1DicomStreamConfig({
    this.bigqueryDestination,
  });

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'bigqueryDestination': ?pulumi.Input.mapOptionalInputValue<GoogleCloudHealthcareV1beta1DicomBigQueryDestination, Map<String, dynamic>>(bigqueryDestination, (value) => value.toMap()),
    };
  }
  ...
  factory GoogleCloudHealthcareV1beta1DicomStreamConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudHealthcareV1beta1DicomStreamConfig(
      bigqueryDestination: (() { final guardedValue = map['bigqueryDestination']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudHealthcareV1beta1DicomBigQueryDestination.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
