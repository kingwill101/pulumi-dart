...
class AttributeDefinitionHealthcareV1beta1Args {
  ...
  AttributeDefinitionHealthcareV1beta1Args({
    ...
    required pulumi.Output<AttributeDefinitionCategoryHealthcareV1beta1> category,
  ...
  factory AttributeDefinitionHealthcareV1beta1Args.fromMap(Map<String, dynamic> map) {
    return AttributeDefinitionHealthcareV1beta1Args(
      ...
      category: pulumi.Output.create<AttributeDefinitionCategoryHealthcareV1beta1>(AttributeDefinitionCategoryHealthcareV1beta1.fromValue(map['category'] as String)),
