...
class AttributeDefinitionHealthcareV1beta1Args {
  ...
  /// [project] Optional.
  const AttributeDefinitionHealthcareV1beta1Args({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'category': pulumi.Input.mapInputValue<AttributeDefinitionCategoryHealthcareV1beta1, String>(category, (value) => value.wireValue),
  ...
  factory AttributeDefinitionHealthcareV1beta1Args.fromMap(Map<String, dynamic> map) {
    return AttributeDefinitionHealthcareV1beta1Args(
      ...
      category: pulumi.Input.fromValue(AttributeDefinitionCategoryHealthcareV1beta1.fromValue(map['category']! as String)),
