...
class FhirStoreArgs {
  ...
  FhirStoreArgs({
    pulumi.Output<FhirStoreComplexDataTypeReferenceParsing>? complexDataTypeReferenceParsing,
    ...
    pulumi.Output<List<FhirNotificationConfig>>? notificationConfigs,
    pulumi.Output<String>? project,
    pulumi.Output<List<StreamConfig>>? streamConfigs,
    pulumi.Output<ValidationConfig>? validationConfig,
    pulumi.Output<FhirStoreVersion>? version,
  }) :
  ...
  factory FhirStoreArgs.fromMap(Map<String, dynamic> map) {
    return FhirStoreArgs(
      complexDataTypeReferenceParsing: map['complexDataTypeReferenceParsing'] == null ? null : pulumi.Output.create<FhirStoreComplexDataTypeReferenceParsing>(FhirStoreComplexDataTypeReferenceParsing.fromValue(map['complexDataTypeReferenceParsing'] as String)),
      ...
      notificationConfigs: map['notificationConfigs'] == null ? null : pulumi.Output.create<List<FhirNotificationConfig>>(pulumi.Input.decodeList<FhirNotificationConfig>(map['notificationConfigs'], (value) => FhirNotificationConfig.fromMap((value as Map).cast<String, dynamic>()))),
      project: map['project'] == null ? null : pulumi.Output.create<String>(map['project'] as String),
      streamConfigs: map['streamConfigs'] == null ? null : pulumi.Output.create<List<StreamConfig>>(pulumi.Input.decodeList<StreamConfig>(map['streamConfigs'], (value) => StreamConfig.fromMap((value as Map).cast<String, dynamic>()))),
      validationConfig: map['validationConfig'] == null ? null : pulumi.Output.create<ValidationConfig>(ValidationConfig.fromMap((map['validationConfig'] as Map).cast<String, dynamic>())),
      version: map['version'] == null ? null : pulumi.Output.create<FhirStoreVersion>(FhirStoreVersion.fromValue(map['version'] as String)),
    );
  }
}
