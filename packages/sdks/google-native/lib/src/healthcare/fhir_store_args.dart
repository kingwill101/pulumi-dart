...
class FhirStoreArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'complexDataTypeReferenceParsing': ?pulumi.Input.mapOptionalInputValue<FhirStoreComplexDataTypeReferenceParsing, String>(complexDataTypeReferenceParsing, (value) => value.wireValue),
      'datasetId': datasetId,
      ...
      'version': ?pulumi.Input.mapOptionalInputValue<FhirStoreVersion, String>(version, (value) => value.wireValue),
    };
  }

  factory FhirStoreArgs.fromMap(Map<String, dynamic> map) {
    return FhirStoreArgs(
      complexDataTypeReferenceParsing: (() { final guardedValue = map['complexDataTypeReferenceParsing']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FhirStoreComplexDataTypeReferenceParsing.fromValue(guardedValue as String)); })(),
      ...
      notificationConfigs: (() { final guardedValue = map['notificationConfigs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FhirNotificationConfig>(guardedValue, (value) => FhirNotificationConfig.fromMap((value as Map).cast<String, dynamic>()))); })(),
      project: (() { final guardedValue = map['project']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      streamConfigs: (() { final guardedValue = map['streamConfigs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<StreamConfig>(guardedValue, (value) => StreamConfig.fromMap((value as Map).cast<String, dynamic>()))); })(),
      validationConfig: (() { final guardedValue = map['validationConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ValidationConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      version: (() { final guardedValue = map['version']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FhirStoreVersion.fromValue(guardedValue as String)); })(),
    );
  }
}
