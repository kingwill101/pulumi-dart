...
class FhirConfigHealthcareV1beta1 {
  ...
  /// Creates a new [FhirConfigHealthcareV1beta1].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'fieldMetadataList': ?fieldMetadataList == null ? null : pulumi.Input.encodeList<FieldMetadataHealthcareV1beta1, Map<String, dynamic>>(fieldMetadataList!, (value) => value.toMap()),
    };
  }

  factory FhirConfigHealthcareV1beta1.fromMap(Map<String, dynamic> map) {
    return FhirConfigHealthcareV1beta1(
      defaultKeepExtensions: map['defaultKeepExtensions'] == null ? null : map['defaultKeepExtensions'] as bool,
      fieldMetadataList: map['fieldMetadataList'] == null ? null : pulumi.Input.decodeList<FieldMetadataHealthcareV1beta1>(map['fieldMetadataList'], (value) => FieldMetadataHealthcareV1beta1.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
