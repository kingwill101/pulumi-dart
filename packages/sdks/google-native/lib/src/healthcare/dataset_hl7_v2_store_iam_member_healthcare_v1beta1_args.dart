...
/// {@template pulumi_healthcare_v1beta1_dataset_hl7_v2_store_iam_member_healthcare_v1beta1_args_doc}
/// The set of arguments for DatasetHl7V2StoreIamMember.
/// {@endtemplate}
/// {@macro pulumi_healthcare_v1beta1_dataset_hl7_v2_store_iam_member_healthcare_v1beta1_args_doc}
class DatasetHl7V2StoreIamMemberHealthcareV1beta1Args {
  ...
  /// Creates a new [DatasetHl7V2StoreIamMemberHealthcareV1beta1Args].
  ...
  const DatasetHl7V2StoreIamMemberHealthcareV1beta1Args({
    this.condition,
  ...
  factory DatasetHl7V2StoreIamMemberHealthcareV1beta1Args.fromMap(Map<String, dynamic> map) {
    return DatasetHl7V2StoreIamMemberHealthcareV1beta1Args(
