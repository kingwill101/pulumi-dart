...
class TypeHealthcareV1beta1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'primitive':
          ?pulumi.Input.mapOptionalInputValue<
            TypePrimitiveHealthcareV1beta1,
            String
          >(primitive, (value) => value.wireValue),
    };
  }
  ...
  factory TypeHealthcareV1beta1.fromMap(Map<String, dynamic> map) {
    return TypeHealthcareV1beta1(
      ...
      primitive: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TypePrimitiveHealthcareV1beta1.fromValue(guardedValue as String),
        );
      })(),
    );
  }
