...
/// {@template pulumi_healthcare_v1_dataset_consent_store_iam_binding_args_doc}
/// The set of arguments for DatasetConsentStoreIamBinding.
/// {@endtemplate}
/// {@macro pulumi_healthcare_v1_dataset_consent_store_iam_binding_args_doc}
class DatasetConsentStoreIamBindingArgs {
  ...
  /// Creates a new [DatasetConsentStoreIamBindingArgs].
  ...
  const DatasetConsentStoreIamBindingArgs({
    this.condition,
  ...
  factory DatasetConsentStoreIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return DatasetConsentStoreIamBindingArgs(
