...
class FhirStoreHealthcareV1beta1Args {
    ...
    return <String, dynamic>{
      'complexDataTypeReferenceParsing':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(complexDataTypeReferenceParsing, (value) => value.wireValue),
      'consentConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ConsentConfig,
            Map<String, dynamic>
      ...
      'searchConfig':
          ?pulumi.Input.mapOptionalInputValue<
            SearchConfig,
            Map<String, dynamic>
          >(searchConfig, (value) => value.toMap()),
      'streamConfigs':
          ?pulumi.Input.mapOptionalInputValue<
            List<StreamConfigHealthcareV1beta1>,
            List<Map<String, dynamic>>
          >(
            streamConfigs,
            (value) =>
                pulumi.Input.encodeList<
                  StreamConfigHealthcareV1beta1,
                  Map<String, dynamic>
                >(value, (value) => value.toMap()),
          ),
      'validationConfig':
  ...
  factory FhirStoreHealthcareV1beta1Args.fromMap(Map<String, dynamic> map) {
    return FhirStoreHealthcareV1beta1Args(
      complexDataTypeReferenceParsing: (() {
        final guardedValue = map['complexDataTypeReferenceParsing'];
      ...
      consentConfig: (() {
        final guardedValue = map['consentConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ConsentConfig.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      datasetId: pulumi.Input.fromValue(map['datasetId'] as String),
      defaultSearchHandlingStrict: (() {
        final guardedValue = map['defaultSearchHandlingStrict'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      disableReferentialIntegrity: (() {
        final guardedValue = map['disableReferentialIntegrity'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      disableResourceVersioning: (() {
        final guardedValue = map['disableResourceVersioning'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      enableUpdateCreate: (() {
        final guardedValue = map['enableUpdateCreate'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      fhirStoreId: (() {
      ...
      searchConfig: (() {
        final guardedValue = map['searchConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SearchConfig.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      streamConfigs: (() {
      ...
      validationConfig: (() {
        final guardedValue = map['validationConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      version: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FhirStoreVersionHealthcareV1beta1.fromValue(guardedValue as String),
        );
      })(),
    );
  }
