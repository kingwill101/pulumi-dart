...
class FhirStoreHealthcareV1beta1Args {
  ...
  FhirStoreHealthcareV1beta1Args({
    pulumi.Output<FhirStoreComplexDataTypeReferenceParsingHealthcareV1beta1>? complexDataTypeReferenceParsing,
    pulumi.Output<ConsentConfig>? consentConfig,
    required pulumi.Output<String> datasetId,
    pulumi.Output<bool>? defaultSearchHandlingStrict,
    pulumi.Output<bool>? disableReferentialIntegrity,
    pulumi.Output<bool>? disableResourceVersioning,
    pulumi.Output<bool>? enableUpdateCreate,
    pulumi.Output<String>? fhirStoreId,
    pulumi.Output<Map<String, String>>? labels,
    pulumi.Output<String>? location,
    pulumi.Output<NotificationConfigHealthcareV1beta1>? notificationConfig,
    pulumi.Output<List<FhirNotificationConfigHealthcareV1beta1>>? notificationConfigs,
    pulumi.Output<String>? project,
    pulumi.Output<SearchConfig>? searchConfig,
    pulumi.Output<List<StreamConfigHealthcareV1beta1>>? streamConfigs,
    pulumi.Output<ValidationConfigHealthcareV1beta1>? validationConfig,
    pulumi.Output<FhirStoreVersionHealthcareV1beta1>? version,
  }) :
      complexDataTypeReferenceParsing = pulumi.Input.asOptionalInput<FhirStoreComplexDataTypeReferenceParsingHealthcareV1beta1>(complexDataTypeReferenceParsing),
      consentConfig = pulumi.Input.asOptionalInput<ConsentConfig>(consentConfig),
      datasetId = pulumi.Input.asInput<String>(datasetId),
      defaultSearchHandlingStrict = pulumi.Input.asOptionalInput<bool>(defaultSearchHandlingStrict),
      disableReferentialIntegrity = pulumi.Input.asOptionalInput<bool>(disableReferentialIntegrity),
      disableResourceVersioning = pulumi.Input.asOptionalInput<bool>(disableResourceVersioning),
      enableUpdateCreate = pulumi.Input.asOptionalInput<bool>(enableUpdateCreate),
      ...
      notificationConfigs = pulumi.Input.asOptionalInput<List<FhirNotificationConfigHealthcareV1beta1>>(notificationConfigs),
      project = pulumi.Input.asOptionalInput<String>(project),
      searchConfig = pulumi.Input.asOptionalInput<SearchConfig>(searchConfig),
      streamConfigs = pulumi.Input.asOptionalInput<List<StreamConfigHealthcareV1beta1>>(streamConfigs),
      validationConfig = pulumi.Input.asOptionalInput<ValidationConfigHealthcareV1beta1>(validationConfig),
      version = pulumi.Input.asOptionalInput<FhirStoreVersionHealthcareV1beta1>(version);
  ...
  factory FhirStoreHealthcareV1beta1Args.fromMap(Map<String, dynamic> map) {
    return FhirStoreHealthcareV1beta1Args(
      complexDataTypeReferenceParsing: map['complexDataTypeReferenceParsing'] == null ? null : pulumi.Output.create<FhirStoreComplexDataTypeReferenceParsingHealthcareV1beta1>(FhirStoreComplexDataTypeReferenceParsingHealthcareV1beta1.fromValue(map['complexDataTypeReferenceParsing'] as String)),
      consentConfig: map['consentConfig'] == null ? null : pulumi.Output.create<ConsentConfig>(ConsentConfig.fromMap((map['consentConfig'] as Map).cast<String, dynamic>())),
      datasetId: pulumi.Output.create<String>(map['datasetId'] as String),
      defaultSearchHandlingStrict: map['defaultSearchHandlingStrict'] == null ? null : pulumi.Output.create<bool>(map['defaultSearchHandlingStrict'] as bool),
      disableReferentialIntegrity: map['disableReferentialIntegrity'] == null ? null : pulumi.Output.create<bool>(map['disableReferentialIntegrity'] as bool),
      disableResourceVersioning: map['disableResourceVersioning'] == null ? null : pulumi.Output.create<bool>(map['disableResourceVersioning'] as bool),
      enableUpdateCreate: map['enableUpdateCreate'] == null ? null : pulumi.Output.create<bool>(map['enableUpdateCreate'] as bool),
      ...
      notificationConfigs: map['notificationConfigs'] == null ? null : pulumi.Output.create<List<FhirNotificationConfigHealthcareV1beta1>>(pulumi.Input.decodeList<FhirNotificationConfigHealthcareV1beta1>(map['notificationConfigs'], (value) => FhirNotificationConfigHealthcareV1beta1.fromMap((value as Map).cast<String, dynamic>()))),
      project: map['project'] == null ? null : pulumi.Output.create<String>(map['project'] as String),
      searchConfig: map['searchConfig'] == null ? null : pulumi.Output.create<SearchConfig>(SearchConfig.fromMap((map['searchConfig'] as Map).cast<String, dynamic>())),
      streamConfigs: map['streamConfigs'] == null ? null : pulumi.Output.create<List<StreamConfigHealthcareV1beta1>>(pulumi.Input.decodeList<StreamConfigHealthcareV1beta1>(map['streamConfigs'], (value) => StreamConfigHealthcareV1beta1.fromMap((value as Map).cast<String, dynamic>()))),
      validationConfig: map['validationConfig'] == null ? null : pulumi.Output.create<ValidationConfigHealthcareV1beta1>(ValidationConfigHealthcareV1beta1.fromMap((map['validationConfig'] as Map).cast<String, dynamic>())),
      version: map['version'] == null ? null : pulumi.Output.create<FhirStoreVersionHealthcareV1beta1>(FhirStoreVersionHealthcareV1beta1.fromValue(map['version'] as String)),
    );
  }
}
