...
class InfoTypeTransformationResponse {
  ...
  factory InfoTypeTransformationResponse.fromMap(Map<String, dynamic> map) {
    return InfoTypeTransformationResponse(
      characterMaskConfig: pulumi.Input.fromValue(CharacterMaskConfigResponse.fromMap((map['characterMaskConfig']! as Map).cast<String, dynamic>())),
      cryptoHashConfig: pulumi.Input.fromValue(CryptoHashConfigResponse.fromMap((map['cryptoHashConfig']! as Map).cast<String, dynamic>())),
      dateShiftConfig: pulumi.Input.fromValue(DateShiftConfigResponse.fromMap((map['dateShiftConfig']! as Map).cast<String, dynamic>())),
