...
class GetConsentArtifactHealthcareV1beta1Result {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'consentContentScreenshots': pulumi.Input.encodeList<ImageResponseHealthcareV1beta1, Map<String, dynamic>>(consentContentScreenshots, (value) => value.toMap()),
  ...
  factory GetConsentArtifactHealthcareV1beta1Result.fromMap(Map<String, dynamic> map) {
    return GetConsentArtifactHealthcareV1beta1Result(
      consentContentScreenshots: pulumi.Input.decodeList<ImageResponseHealthcareV1beta1>(map['consentContentScreenshots'], (value) => ImageResponseHealthcareV1beta1.fromMap((value as Map).cast<String, dynamic>())),
      consentContentVersion: map['consentContentVersion'] as String,
      guardianSignature: SignatureResponseHealthcareV1beta1.fromMap((map['guardianSignature'] as Map).cast<String, dynamic>()),
      metadata: (map['metadata'] as Map).cast<String, String>(),
      name: map['name'] as String,
      userId: map['userId'] as String,
      userSignature: SignatureResponseHealthcareV1beta1.fromMap((map['userSignature'] as Map).cast<String, dynamic>()),
      witnessSignature: SignatureResponseHealthcareV1beta1.fromMap((map['witnessSignature'] as Map).cast<String, dynamic>()),
    );
  }
}
