...
class NotificationConfigResponseHealthcareV1beta1 {
  ...
  /// Creates a new [NotificationConfigResponseHealthcareV1beta1].
  ...
  const NotificationConfigResponseHealthcareV1beta1({
    required this.pubsubTopic,
    required this.sendForBulkImport,
  });
  ...
  factory NotificationConfigResponseHealthcareV1beta1.fromMap(Map<String, dynamic> map) {
    return NotificationConfigResponseHealthcareV1beta1(
      pubsubTopic: pulumi.Input.fromValue(map['pubsubTopic'] as String),
      sendForBulkImport: pulumi.Input.fromValue(map['sendForBulkImport'] as bool),
    );
  }
}
