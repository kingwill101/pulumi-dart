...
class DicomConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'filterProfile':
          ?pulumi.Input.mapOptionalInputValue<DicomConfigFilterProfile, String>(
            filterProfile,
    ...
    return DicomConfig(
      filterProfile: (() {
        ...
        return pulumi.Input.fromValue(
          DicomConfigFilterProfile.fromValue(guardedValue as String),
        );
      })(),
      keepList: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TagFilterList.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      removeList: (() {
