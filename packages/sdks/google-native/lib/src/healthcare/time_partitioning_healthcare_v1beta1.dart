...
class TimePartitioningHealthcareV1beta1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'type': ?pulumi.Input.mapOptionalInputValue<TimePartitioningTypeHealthcareV1beta1, String>(type, (value) => value.wireValue),
    };
  }
  ...
  factory TimePartitioningHealthcareV1beta1.fromMap(Map<String, dynamic> map) {
    return TimePartitioningHealthcareV1beta1(
      ...
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TimePartitioningTypeHealthcareV1beta1.fromValue(guardedValue as String)); })(),
    );
  }
}
