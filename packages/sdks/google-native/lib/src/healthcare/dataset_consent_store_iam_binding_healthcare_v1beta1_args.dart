...
/// {@template pulumi_healthcare_v1beta1_dataset_consent_store_iam_binding_healthcare_v1beta1_args_doc}
/// The set of arguments for DatasetConsentStoreIamBinding.
/// {@endtemplate}
/// {@macro pulumi_healthcare_v1beta1_dataset_consent_store_iam_binding_healthcare_v1beta1_args_doc}
class DatasetConsentStoreIamBindingHealthcareV1beta1Args {
  ...
  /// Creates a new [DatasetConsentStoreIamBindingHealthcareV1beta1Args].
  ...
  const DatasetConsentStoreIamBindingHealthcareV1beta1Args({
    this.condition,
  ...
  factory DatasetConsentStoreIamBindingHealthcareV1beta1Args.fromMap(Map<String, dynamic> map) {
