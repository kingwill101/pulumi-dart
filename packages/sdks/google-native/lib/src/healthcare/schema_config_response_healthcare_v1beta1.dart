...
class SchemaConfigResponseHealthcareV1beta1 {
  ...
  factory SchemaConfigResponseHealthcareV1beta1.fromMap(Map<String, dynamic> map) {
    return SchemaConfigResponseHealthcareV1beta1(
      lastUpdatedPartitionConfig: (TimePartitioningResponseHealthcareV1beta1.fromMap((map['lastUpdatedPartitionConfig'] as Map).cast<String, dynamic>())).input(),
      recursiveStructureDepth: (map['recursiveStructureDepth'] as String).input(),
