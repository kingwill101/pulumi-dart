...
class SchemaConfigResponseHealthcareV1beta1 {
  ...
  final pulumi.Input<TimePartitioningResponseHealthcareV1beta1>
    ...
    return <String, dynamic>{
      'lastUpdatedPartitionConfig':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(lastUpdatedPartitionConfig, (value) => value.toMap()),
      'recursiveStructureDepth': recursiveStructureDepth,
      'schemaType': schemaType,
    };
  }

  factory SchemaConfigResponseHealthcareV1beta1.fromMap(
    Map<String, dynamic> map,
  ) {
    return SchemaConfigResponseHealthcareV1beta1(
      lastUpdatedPartitionConfig: pulumi.Input.fromValue(
        TimePartitioningResponseHealthcareV1beta1.fromMap(
          (map['lastUpdatedPartitionConfig']! as Map).cast<String, dynamic>(),
        ),
      ),
      recursiveStructureDepth: pulumi.Input.fromValue(
