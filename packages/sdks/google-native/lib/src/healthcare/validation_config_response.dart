...
class ValidationConfigResponse {
  ...
  factory ValidationConfigResponse.fromMap(Map<String, dynamic> map) {
    return ValidationConfigResponse(
      ...
      disableReferenceTypeValidation: map['disableReferenceTypeValidation'] as bool,
      disableRequiredFieldValidation: map['disableRequiredFieldValidation'] as bool,
      enabledImplementationGuides: (map['enabledImplementationGuides'] as List).cast<String>(),
    );
  }
}
