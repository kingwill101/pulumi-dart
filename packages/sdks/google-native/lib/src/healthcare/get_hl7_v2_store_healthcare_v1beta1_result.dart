...
class GetHl7V2StoreHealthcareV1beta1Result {
  ...
  final List<Hl7V2NotificationConfigResponseHealthcareV1beta1> notificationConfigs;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'notificationConfigs': pulumi.Input.encodeList<Hl7V2NotificationConfigResponseHealthcareV1beta1, Map<String, dynamic>>(notificationConfigs, (value) => value.toMap()),
      'parserConfig': parserConfig.toMap(),
      'rejectDuplicateMessage': rejectDuplicateMessage,
    };
  }

  factory GetHl7V2StoreHealthcareV1beta1Result.fromMap(Map<String, dynamic> map) {
    return GetHl7V2StoreHealthcareV1beta1Result(
      ...
      notificationConfigs: pulumi.Input.decodeList<Hl7V2NotificationConfigResponseHealthcareV1beta1>(map['notificationConfigs']!, (value) => Hl7V2NotificationConfigResponseHealthcareV1beta1.fromMap((value as Map).cast<String, dynamic>())),
      parserConfig: ParserConfigResponseHealthcareV1beta1.fromMap((map['parserConfig']! as Map).cast<String, dynamic>()),
