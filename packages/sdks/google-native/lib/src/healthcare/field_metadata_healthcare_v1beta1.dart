...
class FieldMetadataHealthcareV1beta1 {
  ...
  final pulumi.Input<FieldMetadataActionHealthcareV1beta1>? action;
  ...
  const FieldMetadataHealthcareV1beta1({
    this.action,
    this.paths,
  });
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'action': ?pulumi.Input.mapOptionalInputValue<FieldMetadataActionHealthcareV1beta1, String>(action, (value) => value.wireValue),
      'paths': ?paths,
    };
  }
  ...
  factory FieldMetadataHealthcareV1beta1.fromMap(Map<String, dynamic> map) {
    return FieldMetadataHealthcareV1beta1(
      action: (() { final guardedValue = map['action']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FieldMetadataActionHealthcareV1beta1.fromValue(guardedValue as String)); })(),
