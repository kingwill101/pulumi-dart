...
class ConsentArtifact extends pulumi.CustomResource {
  ...
  ConsentArtifact(
    ...
    this.consentContentScreenshots = registerOutput<List<ImageResponse>>('consentContentScreenshots');
    ...
    this.guardianSignature = registerOutput<SignatureResponse>('guardianSignature');
    ...
    this.witnessSignature = registerOutput<SignatureResponse>('witnessSignature');
  }
}
