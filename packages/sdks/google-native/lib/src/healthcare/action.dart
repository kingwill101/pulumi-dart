...
class Action {
  ...
  factory Action.fromMap(Map<String, dynamic> map) {
    return Action(
      cleanImageTag: (() {
        final guardedValue = map['cleanImageTag'];
      ...
      cleanTextTag: (() {
        final guardedValue = map['cleanTextTag'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      ...
      deleteTag: (() {
        final guardedValue = map['deleteTag'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      ...
      keepTag: (() {
        final guardedValue = map['keepTag'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      ...
      recurseTag: (() {
        final guardedValue = map['recurseTag'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      ...
      regenUidTag: (() {
        final guardedValue = map['regenUidTag'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      ...
      removeTag: (() {
        final guardedValue = map['removeTag'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      ...
      resetTag: (() {
        final guardedValue = map['resetTag'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as Map).cast<String, dynamic>(),
        );
