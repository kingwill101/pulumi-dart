...
class GoogleCloudHealthcareV1beta1DeidentifyOptionsResponse {
  ...
  final pulumi.Input<CharacterMaskConfigResponseHealthcareV1beta1>
  characterMaskConfig;
  ...
  final pulumi.Input<CryptoHashConfigResponseHealthcareV1beta1>
  cryptoHashConfig;
