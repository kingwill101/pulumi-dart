...
import 'google_cloud_healthcare_v1_dicom_big_query_destination_response.dart';
...
class GoogleCloudHealthcareV1DicomStreamConfigResponse {
  ...
  final pulumi.Input<GoogleCloudHealthcareV1DicomBigQueryDestinationResponse> bigqueryDestination;
  ...
  const GoogleCloudHealthcareV1DicomStreamConfigResponse({
    required this.bigqueryDestination,
  });

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'bigqueryDestination': pulumi.Input.mapInputValue<GoogleCloudHealthcareV1DicomBigQueryDestinationResponse, Map<String, dynamic>>(bigqueryDestination, (value) => value.toMap()),
    };
  }
  ...
  factory GoogleCloudHealthcareV1DicomStreamConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudHealthcareV1DicomStreamConfigResponse(
      bigqueryDestination: pulumi.Input.fromValue(GoogleCloudHealthcareV1DicomBigQueryDestinationResponse.fromMap((map['bigqueryDestination']! as Map).cast<String, dynamic>())),
    );
  }
}
