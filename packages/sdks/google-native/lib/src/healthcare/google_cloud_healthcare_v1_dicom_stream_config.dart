...
import 'google_cloud_healthcare_v1_dicom_big_query_destination.dart';
...
class GoogleCloudHealthcareV1DicomStreamConfig {
  ...
  final pulumi.Input<GoogleCloudHealthcareV1DicomBigQueryDestination>? bigqueryDestination;

  /// Creates a new [GoogleCloudHealthcareV1DicomStreamConfig].
  ...
  const GoogleCloudHealthcareV1DicomStreamConfig({
    this.bigqueryDestination,
  });

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'bigqueryDestination': ?pulumi.Input.mapOptionalInputValue<GoogleCloudHealthcareV1DicomBigQueryDestination, Map<String, dynamic>>(bigqueryDestination, (value) => value.toMap()),
    };
  }
  ...
  factory GoogleCloudHealthcareV1DicomStreamConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudHealthcareV1DicomStreamConfig(
      bigqueryDestination: (() { final guardedValue = map['bigqueryDestination']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudHealthcareV1DicomBigQueryDestination.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
