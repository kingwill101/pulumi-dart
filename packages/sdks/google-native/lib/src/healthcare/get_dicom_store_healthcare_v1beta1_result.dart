...
class GetDicomStoreHealthcareV1beta1Result {
  ...
  final List<GoogleCloudHealthcareV1beta1DicomStreamConfigResponse> streamConfigs;
  ...
  const GetDicomStoreHealthcareV1beta1Result({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'streamConfigs': pulumi.Input.encodeList<GoogleCloudHealthcareV1beta1DicomStreamConfigResponse, Map<String, dynamic>>(streamConfigs, (value) => value.toMap()),
    };
  }

  factory GetDicomStoreHealthcareV1beta1Result.fromMap(Map<String, dynamic> map) {
    return GetDicomStoreHealthcareV1beta1Result(
      ...
      streamConfigs: pulumi.Input.decodeList<GoogleCloudHealthcareV1beta1DicomStreamConfigResponse>(map['streamConfigs']!, (value) => GoogleCloudHealthcareV1beta1DicomStreamConfigResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
