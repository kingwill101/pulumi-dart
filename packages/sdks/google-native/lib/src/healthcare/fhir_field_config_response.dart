...
class FhirFieldConfigResponse {
  ...
  final List<GoogleCloudHealthcareV1beta1DeidentifyFieldMetadataResponse> fieldMetadataList;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'fieldMetadataList': pulumi.Input.encodeList<GoogleCloudHealthcareV1beta1DeidentifyFieldMetadataResponse, Map<String, dynamic>>(fieldMetadataList, (value) => value.toMap()),
  ...
  factory FhirFieldConfigResponse.fromMap(Map<String, dynamic> map) {
    return FhirFieldConfigResponse(
      fieldMetadataList: pulumi.Input.decodeList<GoogleCloudHealthcareV1beta1DeidentifyFieldMetadataResponse>(map['fieldMetadataList'], (value) => GoogleCloudHealthcareV1beta1DeidentifyFieldMetadataResponse.fromMap((value as Map).cast<String, dynamic>())),
      options: GoogleCloudHealthcareV1beta1DeidentifyOptionsResponse.fromMap((map['options'] as Map).cast<String, dynamic>()),
