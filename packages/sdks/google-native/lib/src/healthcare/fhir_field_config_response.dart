...
class FhirFieldConfigResponse {
  ...
  final pulumi.Input<
    List<GoogleCloudHealthcareV1beta1DeidentifyFieldMetadataResponse>
  >
  fieldMetadataList;

  /// Specifies additional options, overriding the base ProfileType.
  final pulumi.Input<GoogleCloudHealthcareV1beta1DeidentifyOptionsResponse>
  options;
  ...
  factory FhirFieldConfigResponse.fromMap(Map<String, dynamic> map) {
    return FhirFieldConfigResponse(
      fieldMetadataList: pulumi.Input.fromValue(
      ...
      options: pulumi.Input.fromValue(
        GoogleCloudHealthcareV1beta1DeidentifyOptionsResponse.fromMap(
