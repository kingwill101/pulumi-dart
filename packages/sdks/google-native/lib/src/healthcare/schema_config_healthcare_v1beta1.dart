...
class SchemaConfigHealthcareV1beta1 {
  ...
  final pulumi.Input<TimePartitioningHealthcareV1beta1>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'schemaType':
          ?pulumi.Input.mapOptionalInputValue<
            SchemaConfigSchemaTypeHealthcareV1beta1,
            String
          >(schemaType, (value) => value.wireValue),
    };
  }
  ...
  factory SchemaConfigHealthcareV1beta1.fromMap(Map<String, dynamic> map) {
    return SchemaConfigHealthcareV1beta1(
      lastUpdatedPartitionConfig: (() {
        final guardedValue = map['lastUpdatedPartitionConfig'];
      ...
      recursiveStructureDepth: (() {
        final guardedValue = map['recursiveStructureDepth'];
        if (guardedValue == null) return null;
