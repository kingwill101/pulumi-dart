...
class ConsentConfigResponse {
  ...
  final pulumi.Input<AccessDeterminationLogConfigResponse>
  ...
  factory ConsentConfigResponse.fromMap(Map<String, dynamic> map) {
    return ConsentConfigResponse(
      accessDeterminationLogConfig: pulumi.Input.fromValue(
        AccessDeterminationLogConfigResponse.fromMap(
          (map['accessDeterminationLogConfig']! as Map).cast<String, dynamic>(),
        ),
      ),
      accessEnforced: pulumi.Input.fromValue(map['accessEnforced'] as bool),
      consentHeaderHandling: pulumi.Input.fromValue(
        ConsentHeaderHandlingResponse.fromMap(
          (map['consentHeaderHandling']! as Map).cast<String, dynamic>(),
        ),
      ),
      enforcedAdminConsents: pulumi.Input.fromValue(
