...
class ConsentConfigResponse {
  ...
  factory ConsentConfigResponse.fromMap(Map<String, dynamic> map) {
    return ConsentConfigResponse(
      accessDeterminationLogConfig: (AccessDeterminationLogConfigResponse.fromMap((map['accessDeterminationLogConfig'] as Map).cast<String, dynamic>())).input(),
      accessEnforced: (map['accessEnforced'] as bool).input(),
      consentHeaderHandling: (ConsentHeaderHandlingResponse.fromMap((map['consentHeaderHandling'] as Map).cast<String, dynamic>())).input(),
      enforcedAdminConsents: ((map['enforcedAdminConsents'] as List).cast<String>()).input(),
