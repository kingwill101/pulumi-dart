...
class GoogleCloudHealthcareV1beta1FhirBigQueryDestination {
  ...
  final GoogleCloudHealthcareV1beta1FhirBigQueryDestinationWriteDisposition? writeDisposition;
  ...
  factory GoogleCloudHealthcareV1beta1FhirBigQueryDestination.fromMap(Map<String, dynamic> map) {
    return GoogleCloudHealthcareV1beta1FhirBigQueryDestination(
      ...
      schemaConfig: map['schemaConfig'] == null ? null : SchemaConfigHealthcareV1beta1.fromMap((map['schemaConfig'] as Map).cast<String, dynamic>()),
      writeDisposition: map['writeDisposition'] == null ? null : GoogleCloudHealthcareV1beta1FhirBigQueryDestinationWriteDisposition.fromValue(map['writeDisposition'] as String),
    );
  }
}
