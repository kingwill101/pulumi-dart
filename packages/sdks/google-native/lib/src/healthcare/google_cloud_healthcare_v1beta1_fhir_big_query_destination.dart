...
class GoogleCloudHealthcareV1beta1FhirBigQueryDestination {
  ...
  const GoogleCloudHealthcareV1beta1FhirBigQueryDestination({
    this.datasetUri,
    this.force,
    this.schemaConfig,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'writeDisposition': ?pulumi.Input.mapOptionalInputValue<GoogleCloudHealthcareV1beta1FhirBigQueryDestinationWriteDisposition, String>(writeDisposition, (value) => value.wireValue),
    };
  }
  ...
  factory GoogleCloudHealthcareV1beta1FhirBigQueryDestination.fromMap(Map<String, dynamic> map) {
    return GoogleCloudHealthcareV1beta1FhirBigQueryDestination(
      datasetUri: (() { final guardedValue = map['datasetUri']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      force: (() { final guardedValue = map['force']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      schemaConfig: (() { final guardedValue = map['schemaConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SchemaConfigHealthcareV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      writeDisposition: (() { final guardedValue = map['writeDisposition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudHealthcareV1beta1FhirBigQueryDestinationWriteDisposition.fromValue(guardedValue as String)); })(),
    );
  }
}
