...
class MessageArgs {
  ...
  factory MessageArgs.fromMap(Map<String, dynamic> map) {
    return MessageArgs(
      ...
      patientIds: (() { final guardedValue = map['patientIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PatientId>(guardedValue, (value) => PatientId.fromMap((value as Map).cast<String, dynamic>()))); })(),
      project: (() { final guardedValue = map['project']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      schematizedData: (() { final guardedValue = map['schematizedData']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SchematizedData.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
