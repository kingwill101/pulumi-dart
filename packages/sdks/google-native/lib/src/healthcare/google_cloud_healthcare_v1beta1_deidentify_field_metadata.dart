...
class GoogleCloudHealthcareV1beta1DeidentifyFieldMetadata {
  ...
  factory GoogleCloudHealthcareV1beta1DeidentifyFieldMetadata.fromMap(
    ...
    return GoogleCloudHealthcareV1beta1DeidentifyFieldMetadata(
      characterMaskField: (() {
        final guardedValue = map['characterMaskField'];
      ...
      cleanTextField: (() {
        final guardedValue = map['cleanTextField'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      ...
      cryptoHashField: (() {
        final guardedValue = map['cryptoHashField'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      ...
      dateShiftField: (() {
        final guardedValue = map['dateShiftField'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      ...
      keepField: (() {
        final guardedValue = map['keepField'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      ...
      removeField: (() {
        final guardedValue = map['removeField'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as Map).cast<String, dynamic>(),
        );
