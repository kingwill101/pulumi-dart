...
class GoogleCloudHealthcareV1beta1DeidentifyFieldMetadataResponse {
  ...
  factory GoogleCloudHealthcareV1beta1DeidentifyFieldMetadataResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudHealthcareV1beta1DeidentifyFieldMetadataResponse(
      characterMaskField: ((map['characterMaskField'] as Map).cast<String, dynamic>()).input(),
      cleanTextField: ((map['cleanTextField'] as Map).cast<String, dynamic>()).input(),
      cryptoHashField: ((map['cryptoHashField'] as Map).cast<String, dynamic>()).input(),
      dateShiftField: ((map['dateShiftField'] as Map).cast<String, dynamic>()).input(),
      keepField: ((map['keepField'] as Map).cast<String, dynamic>()).input(),
      paths: ((map['paths'] as List).cast<String>()).input(),
      removeField: ((map['removeField'] as Map).cast<String, dynamic>()).input(),
    );
  }
}
