...
class GetFhirStoreResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'notificationConfigs': pulumi.Input.encodeList<FhirNotificationConfigResponse, Map<String, dynamic>>(notificationConfigs, (value) => value.toMap()),
      'streamConfigs': pulumi.Input.encodeList<StreamConfigResponse, Map<String, dynamic>>(streamConfigs, (value) => value.toMap()),
  ...
  factory GetFhirStoreResult.fromMap(Map<String, dynamic> map) {
    return GetFhirStoreResult(
      ...
      notificationConfigs: pulumi.Input.decodeList<FhirNotificationConfigResponse>(map['notificationConfigs']!, (value) => FhirNotificationConfigResponse.fromMap((value as Map).cast<String, dynamic>())),
      streamConfigs: pulumi.Input.decodeList<StreamConfigResponse>(map['streamConfigs']!, (value) => StreamConfigResponse.fromMap((value as Map).cast<String, dynamic>())),
      validationConfig: ValidationConfigResponse.fromMap((map['validationConfig']! as Map).cast<String, dynamic>()),
