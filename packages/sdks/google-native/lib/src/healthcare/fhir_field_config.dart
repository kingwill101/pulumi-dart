...
class FhirFieldConfig {
  ...
  final pulumi.Input<List<GoogleCloudHealthcareV1beta1DeidentifyFieldMetadata>>?
  fieldMetadataList;
    ...
    return <String, dynamic>{
      ...
      'profileType':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(profileType, (value) => value.wireValue),
    };
  }
  ...
  factory FhirFieldConfig.fromMap(Map<String, dynamic> map) {
    return FhirFieldConfig(
      ...
      profileType: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FhirFieldConfigProfileType.fromValue(guardedValue as String),
        );
      })(),
    );
  }
