...
class SchemaPackageResponseHealthcareV1beta1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'schemas': pulumi.Input.encodeList<Hl7SchemaConfigResponseHealthcareV1beta1, Map<String, dynamic>>(schemas, (value) => value.toMap()),
      'schematizedParsingType': schematizedParsingType,
      'types': pulumi.Input.encodeList<Hl7TypesConfigResponseHealthcareV1beta1, Map<String, dynamic>>(types, (value) => value.toMap()),
  ...
  factory SchemaPackageResponseHealthcareV1beta1.fromMap(Map<String, dynamic> map) {
    return SchemaPackageResponseHealthcareV1beta1(
      ...
      schemas: pulumi.Input.decodeList<Hl7SchemaConfigResponseHealthcareV1beta1>(map['schemas'], (value) => Hl7SchemaConfigResponseHealthcareV1beta1.fromMap((value as Map).cast<String, dynamic>())),
      schematizedParsingType: map['schematizedParsingType'] as String,
      types: pulumi.Input.decodeList<Hl7TypesConfigResponseHealthcareV1beta1>(map['types'], (value) => Hl7TypesConfigResponseHealthcareV1beta1.fromMap((value as Map).cast<String, dynamic>())),
