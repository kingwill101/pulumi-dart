...
class SchemaPackageResponseHealthcareV1beta1 {
  ...
  factory SchemaPackageResponseHealthcareV1beta1.fromMap(Map<String, dynamic> map) {
    return SchemaPackageResponseHealthcareV1beta1(
      ignoreMinOccurs: (map['ignoreMinOccurs'] as bool).input(),
      schemas: (pulumi.Input.decodeList<Hl7SchemaConfigResponseHealthcareV1beta1>(map['schemas'], (value) => Hl7SchemaConfigResponseHealthcareV1beta1.fromMap((value as Map).cast<String, dynamic>()))).input(),
      schematizedParsingType: (map['schematizedParsingType'] as String).input(),
      types: (pulumi.Input.decodeList<Hl7TypesConfigResponseHealthcareV1beta1>(map['types'], (value) => Hl7TypesConfigResponseHealthcareV1beta1.fromMap((value as Map).cast<String, dynamic>()))).input(),
      unexpectedSegmentHandling: (map['unexpectedSegmentHandling'] as String).input(),
    );
  }
}
