...
class SchemaPackageResponseHealthcareV1beta1 {
    ...
    return <String, dynamic>{
      ...
      'schemas':
          pulumi.Input.mapInputValue<
            List<Hl7SchemaConfigResponseHealthcareV1beta1>,
      ...
      'types':
          pulumi.Input.mapInputValue<
            List<Hl7TypesConfigResponseHealthcareV1beta1>,
            List<Map<String, dynamic>>
          >(
            types,
            (value) =>
  ...
  factory SchemaPackageResponseHealthcareV1beta1.fromMap(
    ...
    return SchemaPackageResponseHealthcareV1beta1(
      ...
      schematizedParsingType: pulumi.Input.fromValue(
        map['schematizedParsingType'] as String,
      ),
      types: pulumi.Input.fromValue(
        pulumi.Input.decodeList<Hl7TypesConfigResponseHealthcareV1beta1>(
          map['types']!,
      ...
      unexpectedSegmentHandling: pulumi.Input.fromValue(
