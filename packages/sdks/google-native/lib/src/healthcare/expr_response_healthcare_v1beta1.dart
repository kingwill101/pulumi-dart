...
class ExprResponseHealthcareV1beta1 {
  ...
  /// Creates a new [ExprResponseHealthcareV1beta1].
  ...
  const ExprResponseHealthcareV1beta1({
  ...
  factory ExprResponseHealthcareV1beta1.fromMap(Map<String, dynamic> map) {
    return ExprResponseHealthcareV1beta1(
