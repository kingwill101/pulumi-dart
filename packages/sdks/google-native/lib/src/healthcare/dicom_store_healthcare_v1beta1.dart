...
class DicomStoreHealthcareV1beta1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<GoogleCloudHealthcareV1beta1DicomStreamConfigResponse>> streamConfigs;

  /// Creates a new [DicomStoreHealthcareV1beta1].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [DicomStoreHealthcareV1beta1]. {@macro pulumi_healthcare_v1beta1_dicom_store_healthcare_v1beta1_args_doc}
  ...
  DicomStoreHealthcareV1beta1(
    ...
    this.streamConfigs = registerOutput<List<GoogleCloudHealthcareV1beta1DicomStreamConfigResponse>>('streamConfigs');
  }
}
