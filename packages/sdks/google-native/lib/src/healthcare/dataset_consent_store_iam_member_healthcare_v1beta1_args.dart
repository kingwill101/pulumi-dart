...
/// {@template pulumi_healthcare_v1beta1_dataset_consent_store_iam_member_healthcare_v1beta1_args_doc}
/// The set of arguments for DatasetConsentStoreIamMember.
/// {@endtemplate}
/// {@macro pulumi_healthcare_v1beta1_dataset_consent_store_iam_member_healthcare_v1beta1_args_doc}
class DatasetConsentStoreIamMemberHealthcareV1beta1Args {
  ...
  /// Creates a new [DatasetConsentStoreIamMemberHealthcareV1beta1Args].
  ...
  const DatasetConsentStoreIamMemberHealthcareV1beta1Args({
    this.condition,
  ...
  factory DatasetConsentStoreIamMemberHealthcareV1beta1Args.fromMap(Map<String, dynamic> map) {
    return DatasetConsentStoreIamMemberHealthcareV1beta1Args(
