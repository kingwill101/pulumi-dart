...
class TextConfigResponseHealthcareV1beta1 {
  ...
  final pulumi.Input<List<InfoTypeTransformationResponseHealthcareV1beta1>>
    ...
    return <String, dynamic>{
      'additionalTransformations':
          pulumi.Input.mapInputValue<
            List<InfoTypeTransformationResponseHealthcareV1beta1>,
  ...
  factory TextConfigResponseHealthcareV1beta1.fromMap(
    ...
    return TextConfigResponseHealthcareV1beta1(
      additionalTransformations: pulumi.Input.fromValue(
        pulumi
            .Input.decodeList<InfoTypeTransformationResponseHealthcareV1beta1>(
