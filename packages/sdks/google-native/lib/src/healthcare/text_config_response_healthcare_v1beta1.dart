...
class TextConfigResponseHealthcareV1beta1 {
  ...
  final pulumi.Input<List<InfoTypeTransformationResponseHealthcareV1beta1>> transformations;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'transformations': pulumi.Input.mapInputValue<List<InfoTypeTransformationResponseHealthcareV1beta1>, List<Map<String, dynamic>>>(transformations, (value) => pulumi.Input.encodeList<InfoTypeTransformationResponseHealthcareV1beta1, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory TextConfigResponseHealthcareV1beta1.fromMap(Map<String, dynamic> map) {
    return TextConfigResponseHealthcareV1beta1(
      additionalTransformations: (pulumi.Input.decodeList<InfoTypeTransformationResponseHealthcareV1beta1>(map['additionalTransformations'], (value) => InfoTypeTransformationResponseHealthcareV1beta1.fromMap((value as Map).cast<String, dynamic>()))).input(),
      excludeInfoTypes: ((map['excludeInfoTypes'] as List).cast<String>()).input(),
      profileType: (map['profileType'] as String).input(),
      transformations: (pulumi.Input.decodeList<InfoTypeTransformationResponseHealthcareV1beta1>(map['transformations'], (value) => InfoTypeTransformationResponseHealthcareV1beta1.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
