...
class DeidentifyConfigHealthcareV1beta1 {
  ...
  const DeidentifyConfigHealthcareV1beta1({
    this.annotation,
    this.dicom,
    this.dicomTagConfig,
    this.fhir,
  ...
  factory DeidentifyConfigHealthcareV1beta1.fromMap(Map<String, dynamic> map) {
    return DeidentifyConfigHealthcareV1beta1(
      annotation: (() { final guardedValue = map['annotation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AnnotationConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      dicom: (() { final guardedValue = map['dicom']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DicomConfigHealthcareV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      dicomTagConfig: (() { final guardedValue = map['dicomTagConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DicomTagConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      fhir: (() { final guardedValue = map['fhir']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FhirConfigHealthcareV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      fhirFieldConfig: (() { final guardedValue = map['fhirFieldConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FhirFieldConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      image: (() { final guardedValue = map['image']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ImageConfigHealthcareV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      operationMetadata: (() { final guardedValue = map['operationMetadata']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DeidentifyOperationMetadata.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      text: (() { final guardedValue = map['text']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TextConfigHealthcareV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
