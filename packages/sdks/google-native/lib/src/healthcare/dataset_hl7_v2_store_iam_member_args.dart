...
/// {@template pulumi_healthcare_v1_dataset_hl7_v2_store_iam_member_args_doc}
/// The set of arguments for DatasetHl7V2StoreIamMember.
/// {@endtemplate}
/// {@macro pulumi_healthcare_v1_dataset_hl7_v2_store_iam_member_args_doc}
class DatasetHl7V2StoreIamMemberArgs {
  ...
  /// Creates a new [DatasetHl7V2StoreIamMemberArgs].
  ...
  const DatasetHl7V2StoreIamMemberArgs({
    this.condition,
  ...
  factory DatasetHl7V2StoreIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return DatasetHl7V2StoreIamMemberArgs(
