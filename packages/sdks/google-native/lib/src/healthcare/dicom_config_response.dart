...
class DicomConfigResponse {
  ...
  factory DicomConfigResponse.fromMap(Map<String, dynamic> map) {
    return DicomConfigResponse(
      ...
      keepList: pulumi.Input.fromValue(TagFilterListResponse.fromMap((map['keepList']! as Map).cast<String, dynamic>())),
      removeList: pulumi.Input.fromValue(TagFilterListResponse.fromMap((map['removeList']! as Map).cast<String, dynamic>())),
