...
class DicomStoreArgs {
  ...
  factory DicomStoreArgs.fromMap(Map<String, dynamic> map) {
    return DicomStoreArgs(
      ...
      streamConfigs: (() { final guardedValue = map['streamConfigs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudHealthcareV1DicomStreamConfig>(guardedValue, (value) => GoogleCloudHealthcareV1DicomStreamConfig.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
