...
class Hl7V2StoreArgs {
  ...
  factory Hl7V2StoreArgs.fromMap(Map<String, dynamic> map) {
    return Hl7V2StoreArgs(
      ...
      notificationConfigs: (() { final guardedValue = map['notificationConfigs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<Hl7V2NotificationConfig>(guardedValue, (value) => Hl7V2NotificationConfig.fromMap((value as Map).cast<String, dynamic>()))); })(),
      parserConfig: (() { final guardedValue = map['parserConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ParserConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
