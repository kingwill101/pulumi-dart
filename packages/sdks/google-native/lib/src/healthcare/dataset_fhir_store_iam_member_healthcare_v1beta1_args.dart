...
/// {@template pulumi_healthcare_v1beta1_dataset_fhir_store_iam_member_healthcare_v1beta1_args_doc}
/// The set of arguments for DatasetFhirStoreIamMember.
/// {@endtemplate}
/// {@macro pulumi_healthcare_v1beta1_dataset_fhir_store_iam_member_healthcare_v1beta1_args_doc}
class DatasetFhirStoreIamMemberHealthcareV1beta1Args {
  ...
  /// Creates a new [DatasetFhirStoreIamMemberHealthcareV1beta1Args].
  ...
  const DatasetFhirStoreIamMemberHealthcareV1beta1Args({
    this.condition,
  ...
  factory DatasetFhirStoreIamMemberHealthcareV1beta1Args.fromMap(Map<String, dynamic> map) {
