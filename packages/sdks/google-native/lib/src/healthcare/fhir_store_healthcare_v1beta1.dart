...
class FhirStoreHealthcareV1beta1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<FhirNotificationConfigResponseHealthcareV1beta1>> notificationConfigs;
  ...
  late final pulumi.Output<List<StreamConfigResponseHealthcareV1beta1>> streamConfigs;
  ...
  FhirStoreHealthcareV1beta1(
    ...
    this.notificationConfigs = registerOutput<List<FhirNotificationConfigResponseHealthcareV1beta1>>('notificationConfigs');
    this.project = registerOutput<String>('project');
    this.searchConfig = registerOutput<SearchConfigResponse>('searchConfig');
    this.streamConfigs = registerOutput<List<StreamConfigResponseHealthcareV1beta1>>('streamConfigs');
    this.validationConfig = registerOutput<ValidationConfigResponseHealthcareV1beta1>('validationConfig');
