...
class KmsWrappedCryptoKeyResponseHealthcareV1beta1 {
  ...
  factory KmsWrappedCryptoKeyResponseHealthcareV1beta1.fromMap(Map<String, dynamic> map) {
    return KmsWrappedCryptoKeyResponseHealthcareV1beta1(
