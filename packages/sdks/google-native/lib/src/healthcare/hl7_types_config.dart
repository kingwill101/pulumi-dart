...
class Hl7TypesConfig {
  ...
  factory Hl7TypesConfig.fromMap(Map<String, dynamic> map) {
    return Hl7TypesConfig(
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<Type>(guardedValue, (value) => Type.fromMap((value as Map).cast<String, dynamic>()))); })(),
