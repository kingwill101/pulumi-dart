...
class StreamConfigResponse {
  ...
  final pulumi.Input<GoogleCloudHealthcareV1FhirBigQueryDestinationResponse>
  bigqueryDestination;
  ...
  final pulumi.Input<DeidentifiedStoreDestinationResponse>
  deidentifiedStoreDestination;

  /// Supply a FHIR resource type (such as "Patient" or "Observation"). See https://www.hl7.org/fhir/valueset-resource-types.html for a list of all FHIR resource types. The server treats an empty list as an intent to stream all the supported resource types in this FHIR store.
  final pulumi.Input<List<String>> resourceTypes;

  /// Creates a new [StreamConfigResponse].
  ...
  factory StreamConfigResponse.fromMap(Map<String, dynamic> map) {
    return StreamConfigResponse(
      ...
      deidentifiedStoreDestination: pulumi.Input.fromValue(
        DeidentifiedStoreDestinationResponse.fromMap(
          (map['deidentifiedStoreDestination']! as Map).cast<String, dynamic>(),
        ),
      ),
