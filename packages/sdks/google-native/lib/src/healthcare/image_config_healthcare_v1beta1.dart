...
class ImageConfigHealthcareV1beta1 {
  ...
  final pulumi.Input<ImageConfigTextRedactionModeHealthcareV1beta1>? textRedactionMode;
  ...
  const ImageConfigHealthcareV1beta1({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'textRedactionMode': ?pulumi.Input.mapOptionalInputValue<ImageConfigTextRedactionModeHealthcareV1beta1, String>(textRedactionMode, (value) => value.wireValue),
    };
  }

  factory ImageConfigHealthcareV1beta1.fromMap(Map<String, dynamic> map) {
    return ImageConfigHealthcareV1beta1(
      additionalInfoTypes: (() { final guardedValue = map['additionalInfoTypes']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      ...
      textRedactionMode: (() { final guardedValue = map['textRedactionMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ImageConfigTextRedactionModeHealthcareV1beta1.fromValue(guardedValue as String)); })(),
    );
  }
}
