...
class DeidentifyConfig {
  ...
  factory DeidentifyConfig.fromMap(Map<String, dynamic> map) {
    return DeidentifyConfig(
      dicom: map['dicom'] == null ? null : DicomConfig.fromMap((map['dicom'] as Map).cast<String, dynamic>()),
      fhir: map['fhir'] == null ? null : FhirConfig.fromMap((map['fhir'] as Map).cast<String, dynamic>()),
      image: map['image'] == null ? null : ImageConfig.fromMap((map['image'] as Map).cast<String, dynamic>()),
      text: map['text'] == null ? null : TextConfig.fromMap((map['text'] as Map).cast<String, dynamic>()),
