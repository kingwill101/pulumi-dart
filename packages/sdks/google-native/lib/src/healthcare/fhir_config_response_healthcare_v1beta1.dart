...
class FhirConfigResponseHealthcareV1beta1 {
  ...
  factory FhirConfigResponseHealthcareV1beta1.fromMap(Map<String, dynamic> map) {
    return FhirConfigResponseHealthcareV1beta1(
      defaultKeepExtensions: (map['defaultKeepExtensions'] as bool).input(),
      fieldMetadataList: (pulumi.Input.decodeList<FieldMetadataResponseHealthcareV1beta1>(map['fieldMetadataList'], (value) => FieldMetadataResponseHealthcareV1beta1.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
