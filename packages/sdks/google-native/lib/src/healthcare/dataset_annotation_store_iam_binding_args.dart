...
/// {@template pulumi_healthcare_v1beta1_dataset_annotation_store_iam_binding_args_doc}
/// The set of arguments for DatasetAnnotationStoreIamBinding.
/// {@endtemplate}
/// {@macro pulumi_healthcare_v1beta1_dataset_annotation_store_iam_binding_args_doc}
class DatasetAnnotationStoreIamBindingArgs {
  ...
  /// Creates a new [DatasetAnnotationStoreIamBindingArgs].
  ...
  const DatasetAnnotationStoreIamBindingArgs({
    this.condition,
  ...
  factory DatasetAnnotationStoreIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return DatasetAnnotationStoreIamBindingArgs(
