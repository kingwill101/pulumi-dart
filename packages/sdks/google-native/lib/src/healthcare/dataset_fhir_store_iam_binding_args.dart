...
/// {@template pulumi_healthcare_v1_dataset_fhir_store_iam_binding_args_doc}
/// The set of arguments for DatasetFhirStoreIamBinding.
/// {@endtemplate}
/// {@macro pulumi_healthcare_v1_dataset_fhir_store_iam_binding_args_doc}
class DatasetFhirStoreIamBindingArgs {
  ...
  /// Creates a new [DatasetFhirStoreIamBindingArgs].
  ...
  const DatasetFhirStoreIamBindingArgs({
    this.condition,
