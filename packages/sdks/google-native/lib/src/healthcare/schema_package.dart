...
class SchemaPackage {
  ...
  final pulumi.Input<SchemaPackageSchematizedParsingType>?
  ...
  final pulumi.Input<SchemaPackageUnexpectedSegmentHandling>?
      ...
      schemas: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<Hl7SchemaConfig>(
            guardedValue,
            (value) =>
                Hl7SchemaConfig.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      schematizedParsingType: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SchemaPackageSchematizedParsingType.fromValue(guardedValue as String),
        );
      })(),
      types: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<Hl7TypesConfig>(
            guardedValue,
            (value) =>
                Hl7TypesConfig.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      unexpectedSegmentHandling: (() {
