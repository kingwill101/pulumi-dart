...
class GoogleCloudHealthcareV1beta1DicomBigQueryDestination {
  ...
  final pulumi.Input<GoogleCloudHealthcareV1beta1DicomBigQueryDestinationWriteDisposition>? writeDisposition;
  ...
  const GoogleCloudHealthcareV1beta1DicomBigQueryDestination({
    this.force,
    this.tableUri,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'force': ?force,
      'tableUri': ?tableUri,
      'writeDisposition': ?pulumi.Input.mapOptionalInputValue<GoogleCloudHealthcareV1beta1DicomBigQueryDestinationWriteDisposition, String>(writeDisposition, (value) => value.wireValue),
    };
  }
  ...
  factory GoogleCloudHealthcareV1beta1DicomBigQueryDestination.fromMap(Map<String, dynamic> map) {
    return GoogleCloudHealthcareV1beta1DicomBigQueryDestination(
      ...
      writeDisposition: (() { final guardedValue = map['writeDisposition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudHealthcareV1beta1DicomBigQueryDestinationWriteDisposition.fromValue(guardedValue as String)); })(),
    );
  }
}
