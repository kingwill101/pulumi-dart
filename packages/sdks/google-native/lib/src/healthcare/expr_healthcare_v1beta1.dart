...
class ExprHealthcareV1beta1 {
  ...
  /// Creates a new [ExprHealthcareV1beta1].
  ...
  factory ExprHealthcareV1beta1.fromMap(Map<String, dynamic> map) {
    return ExprHealthcareV1beta1(
