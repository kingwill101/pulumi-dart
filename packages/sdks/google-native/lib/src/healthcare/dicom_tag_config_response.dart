...
class DicomTagConfigResponse {
  ...
  factory DicomTagConfigResponse.fromMap(Map<String, dynamic> map) {
    return DicomTagConfigResponse(
      actions: pulumi.Input.fromValue(pulumi.Input.decodeList<ActionResponse>(map['actions']!, (value) => ActionResponse.fromMap((value as Map).cast<String, dynamic>()))),
