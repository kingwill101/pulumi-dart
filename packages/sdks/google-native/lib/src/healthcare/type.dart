...
class Type {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'primitive': ?pulumi.Input.mapOptionalInputValue<TypePrimitive, String>(primitive, (value) => value.wireValue),
    };
  }
  ...
  factory Type.fromMap(Map<String, dynamic> map) {
    return Type(
      ...
      primitive: (() { final guardedValue = map['primitive']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TypePrimitive.fromValue(guardedValue as String)); })(),
    );
  }
}
