...
class DateShiftConfigResponseHealthcareV1beta1 {
  ...
  const DateShiftConfigResponseHealthcareV1beta1({
  ...
  factory DateShiftConfigResponseHealthcareV1beta1.fromMap(Map<String, dynamic> map) {
    return DateShiftConfigResponseHealthcareV1beta1(
      cryptoKey: pulumi.Input.fromValue(map['cryptoKey'] as String),
      kmsWrapped: pulumi.Input.fromValue(KmsWrappedCryptoKeyResponseHealthcareV1beta1.fromMap((map['kmsWrapped']! as Map).cast<String, dynamic>())),
    );
  }
}
