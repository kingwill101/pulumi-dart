...
class AnnotationArgs {
  ...
  factory AnnotationArgs.fromMap(Map<String, dynamic> map) {
    return AnnotationArgs(
      annotationSource: (() { final guardedValue = map['annotationSource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AnnotationSource.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      annotationStoreId: pulumi.Input.fromValue(map['annotationStoreId'] as String),
      customData: (() { final guardedValue = map['customData']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      datasetId: pulumi.Input.fromValue(map['datasetId'] as String),
      imageAnnotation: (() { final guardedValue = map['imageAnnotation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ImageAnnotation.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      location: (() { final guardedValue = map['location']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      project: (() { final guardedValue = map['project']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      resourceAnnotation: (() { final guardedValue = map['resourceAnnotation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResourceAnnotation.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      textAnnotation: (() { final guardedValue = map['textAnnotation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SensitiveTextAnnotation.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
