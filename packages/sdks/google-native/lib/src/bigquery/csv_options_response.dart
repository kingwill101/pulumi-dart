...
class CsvOptionsResponse {
  ...
  factory CsvOptionsResponse.fromMap(Map<String, dynamic> map) {
    return CsvOptionsResponse(
      ...
      nullMarker: (map['nullMarker'] as String).input(),
      preserveAsciiControlCharacters: (map['preserveAsciiControlCharacters'] as bool).input(),
      quote: (map['quote'] as String).input(),
      skipLeadingRows: (map['skipLeadingRows'] as String).input(),
    );
  }
}
