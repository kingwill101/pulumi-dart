  ...
  factory TableFieldSchema.fromMap(Map<String, dynamic> map) {
    return TableFieldSchema(
      ...
      defaultValueExpression: (() {
        final guardedValue = map['defaultValueExpression'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      description: (() {
      ...
      policyTags: (() {
        final guardedValue = map['policyTags'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      rangeElementType: (() {
        final guardedValue = map['rangeElementType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      roundingMode: (() {
        final guardedValue = map['roundingMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      scale: (() {
