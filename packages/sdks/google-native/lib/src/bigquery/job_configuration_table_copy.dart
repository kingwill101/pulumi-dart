...
class JobConfigurationTableCopy {
  ...
  const JobConfigurationTableCopy({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'sourceTables': ?pulumi.Input.mapOptionalInputValue<List<TableReference>, List<Map<String, dynamic>>>(sourceTables, (value) => pulumi.Input.encodeList<TableReference, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory JobConfigurationTableCopy.fromMap(Map<String, dynamic> map) {
    return JobConfigurationTableCopy(
      ...
      destinationExpirationTime: (() { final guardedValue = map['destinationExpirationTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      ...
      sourceTable: (() { final guardedValue = map['sourceTable']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TableReference.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      sourceTables: (() { final guardedValue = map['sourceTables']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<TableReference>(guardedValue, (value) => TableReference.fromMap((value as Map).cast<String, dynamic>()))); })(),
