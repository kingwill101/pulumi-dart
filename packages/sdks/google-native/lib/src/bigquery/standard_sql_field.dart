...
class StandardSqlField {
  ...
  factory StandardSqlField.fromMap(Map<String, dynamic> map) {
    return StandardSqlField(
      ...
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(StandardSqlDataType.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
