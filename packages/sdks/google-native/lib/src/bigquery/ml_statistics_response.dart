...
class MlStatisticsResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'iterationResults': pulumi.Input.encodeList<IterationResultResponse, Map<String, dynamic>>(iterationResults, (value) => value.toMap()),
  ...
  factory MlStatisticsResponse.fromMap(Map<String, dynamic> map) {
    return MlStatisticsResponse(
      iterationResults: pulumi.Input.decodeList<IterationResultResponse>(map['iterationResults'], (value) => IterationResultResponse.fromMap((value as Map).cast<String, dynamic>())),
