...
class ModelDefinitionResponse {
  ...
  factory ModelDefinitionResponse.fromMap(Map<String, dynamic> map) {
    return ModelDefinitionResponse(
      modelOptions: pulumi.Input.fromValue(
        ModelDefinitionModelOptionsResponse.fromMap(
          (map['modelOptions']! as Map).cast<String, dynamic>(),
        ),
      ),
      trainingRuns: pulumi.Input.fromValue(
        pulumi.Input.decodeList<BqmlTrainingRunResponse>(
          map['trainingRuns']!,
