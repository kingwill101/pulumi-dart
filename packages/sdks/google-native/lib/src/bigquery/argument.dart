...
class Argument {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'argumentKind':
          ?pulumi.Input.mapOptionalInputValue<ArgumentArgumentKind, String>(
            argumentKind,
      ...
      'dataType':
          ?pulumi.Input.mapOptionalInputValue<
            StandardSqlDataType,
            Map<String, dynamic>
          >(dataType, (value) => value.toMap()),
      'isAggregate': ?isAggregate,
      'mode': ?pulumi.Input.mapOptionalInputValue<ArgumentMode, String>(
        mode,
        (value) => value.wireValue,
      ),
      'name': ?name,
    ...
    return Argument(
      argumentKind: (() {
        ...
        return pulumi.Input.fromValue(
          ArgumentArgumentKind.fromValue(guardedValue as String),
        );
      })(),
      dataType: (() {
      ...
      isAggregate: (() {
        final guardedValue = map['isAggregate'];
        if (guardedValue == null) return null;
      ...
      mode: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ArgumentMode.fromValue(guardedValue as String),
        );
      })(),
      name: (() {
