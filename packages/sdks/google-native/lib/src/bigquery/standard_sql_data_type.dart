...
class StandardSqlDataType {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'typeKind':
          pulumi.Input.mapInputValue<StandardSqlDataTypeTypeKind, String>(
            typeKind,
  ...
  factory StandardSqlDataType.fromMap(Map<String, dynamic> map) {
    return StandardSqlDataType(
      arrayElementType: (() {
        final guardedValue = map['arrayElementType'];
      ...
      structType: (() {
        final guardedValue = map['structType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      typeKind: pulumi.Input.fromValue(
