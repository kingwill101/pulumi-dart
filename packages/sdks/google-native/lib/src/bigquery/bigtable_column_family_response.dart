...
class BigtableColumnFamilyResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'columns': pulumi.Input.encodeList<BigtableColumnResponse, Map<String, dynamic>>(columns, (value) => value.toMap()),
      'encoding': encoding,
      'familyId': familyId,
  ...
  factory BigtableColumnFamilyResponse.fromMap(Map<String, dynamic> map) {
    return BigtableColumnFamilyResponse(
      columns: pulumi.Input.decodeList<BigtableColumnResponse>(map['columns'], (value) => BigtableColumnResponse.fromMap((value as Map).cast<String, dynamic>())),
