...
class ExternalDataConfiguration {
  ...
  factory ExternalDataConfiguration.fromMap(Map<String, dynamic> map) {
    return ExternalDataConfiguration(
      ...
      avroOptions: (() { final guardedValue = map['avroOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AvroOptions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      bigtableOptions: (() { final guardedValue = map['bigtableOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BigtableOptions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      csvOptions: (() { final guardedValue = map['csvOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CsvOptions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      googleSheetsOptions: (() { final guardedValue = map['googleSheetsOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleSheetsOptions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      hivePartitioningOptions: (() { final guardedValue = map['hivePartitioningOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HivePartitioningOptions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      jsonOptions: (() { final guardedValue = map['jsonOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(JsonOptions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      parquetOptions: (() { final guardedValue = map['parquetOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ParquetOptions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      sourceUris: (() { final guardedValue = map['sourceUris']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
    );
  }
}
