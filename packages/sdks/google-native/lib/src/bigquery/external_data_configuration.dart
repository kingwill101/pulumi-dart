...
class ExternalDataConfiguration {
    ...
    return <String, dynamic>{
      ...
      'avroOptions':
          ?pulumi.Input.mapOptionalInputValue<
            AvroOptions,
            Map<String, dynamic>
          >(avroOptions, (value) => value.toMap()),
      'bigtableOptions':
          ?pulumi.Input.mapOptionalInputValue<
            BigtableOptions,
            Map<String, dynamic>
          >(bigtableOptions, (value) => value.toMap()),
      'compression': ?compression,
      'connectionId': ?connectionId,
      'csvOptions':
          ?pulumi.Input.mapOptionalInputValue<CsvOptions, Map<String, dynamic>>(
            csvOptions,
            (value) => value.toMap(),
          ),
      ...
      'googleSheetsOptions':
          ?pulumi.Input.mapOptionalInputValue<
            GoogleSheetsOptions,
            Map<String, dynamic>
          >(googleSheetsOptions, (value) => value.toMap()),
      ...
      'parquetOptions':
          ?pulumi.Input.mapOptionalInputValue<
            ParquetOptions,
            Map<String, dynamic>
          >(parquetOptions, (value) => value.toMap()),
  ...
  factory ExternalDataConfiguration.fromMap(Map<String, dynamic> map) {
    return ExternalDataConfiguration(
      autodetect: (() {
        final guardedValue = map['autodetect'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      avroOptions: (() {
        final guardedValue = map['avroOptions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AvroOptions.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      bigtableOptions: (() {
        final guardedValue = map['bigtableOptions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      csvOptions: (() {
        final guardedValue = map['csvOptions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CsvOptions.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      decimalTargetTypes: (() {
        final guardedValue = map['decimalTargetTypes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      fileSetSpecType: (() {
        final guardedValue = map['fileSetSpecType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      googleSheetsOptions: (() {
        final guardedValue = map['googleSheetsOptions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      hivePartitioningOptions: (() {
        final guardedValue = map['hivePartitioningOptions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      ignoreUnknownValues: (() {
        final guardedValue = map['ignoreUnknownValues'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      jsonOptions: (() {
        final guardedValue = map['jsonOptions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          JsonOptions.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      maxBadRecords: (() {
        final guardedValue = map['maxBadRecords'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      metadataCacheMode: (() {
        final guardedValue = map['metadataCacheMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      objectMetadata: (() {
        final guardedValue = map['objectMetadata'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      parquetOptions: (() {
        final guardedValue = map['parquetOptions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ParquetOptions.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      referenceFileSchemaUri: (() {
        final guardedValue = map['referenceFileSchemaUri'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      schema: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TableSchema.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      sourceFormat: (() {
      ...
      sourceUris: (() {
        final guardedValue = map['sourceUris'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
    );
