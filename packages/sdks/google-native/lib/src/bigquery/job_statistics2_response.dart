...
class JobStatistics2Response {
  ...
  factory JobStatistics2Response.fromMap(Map<String, dynamic> map) {
    return JobStatistics2Response(
      biEngineStatistics: (BiEngineStatisticsResponse.fromMap((map['biEngineStatistics'] as Map).cast<String, dynamic>())).input(),
      billingTier: (map['billingTier'] as int).input(),
      cacheHit: (map['cacheHit'] as bool).input(),
      ddlAffectedRowAccessPolicyCount: (map['ddlAffectedRowAccessPolicyCount'] as String).input(),
      ddlDestinationTable: (TableReferenceResponse.fromMap((map['ddlDestinationTable'] as Map).cast<String, dynamic>())).input(),
      ddlOperationPerformed: (map['ddlOperationPerformed'] as String).input(),
      ddlTargetDataset: (DatasetReferenceResponse.fromMap((map['ddlTargetDataset'] as Map).cast<String, dynamic>())).input(),
      ddlTargetRoutine: (RoutineReferenceResponse.fromMap((map['ddlTargetRoutine'] as Map).cast<String, dynamic>())).input(),
      ddlTargetRowAccessPolicy: (RowAccessPolicyReferenceResponse.fromMap((map['ddlTargetRowAccessPolicy'] as Map).cast<String, dynamic>())).input(),
      ddlTargetTable: (TableReferenceResponse.fromMap((map['ddlTargetTable'] as Map).cast<String, dynamic>())).input(),
      dmlStats: (DmlStatisticsResponse.fromMap((map['dmlStats'] as Map).cast<String, dynamic>())).input(),
      estimatedBytesProcessed: (map['estimatedBytesProcessed'] as String).input(),
      mlStatistics: (MlStatisticsResponse.fromMap((map['mlStatistics'] as Map).cast<String, dynamic>())).input(),
      modelTraining: (BigQueryModelTrainingResponse.fromMap((map['modelTraining'] as Map).cast<String, dynamic>())).input(),
      modelTrainingCurrentIteration: (map['modelTrainingCurrentIteration'] as int).input(),
      modelTrainingExpectedTotalIteration: (map['modelTrainingExpectedTotalIteration'] as String).input(),
      numDmlAffectedRows: (map['numDmlAffectedRows'] as String).input(),
      queryPlan: (pulumi.Input.decodeList<ExplainQueryStageResponse>(map['queryPlan'], (value) => ExplainQueryStageResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      referencedRoutines: (pulumi.Input.decodeList<RoutineReferenceResponse>(map['referencedRoutines'], (value) => RoutineReferenceResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      referencedTables: (pulumi.Input.decodeList<TableReferenceResponse>(map['referencedTables'], (value) => TableReferenceResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      reservationUsage: (pulumi.Input.decodeList<JobStatistics2ReservationUsageItemResponse>(map['reservationUsage'], (value) => JobStatistics2ReservationUsageItemResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      schema: (TableSchemaResponse.fromMap((map['schema'] as Map).cast<String, dynamic>())).input(),
      searchStatistics: (SearchStatisticsResponse.fromMap((map['searchStatistics'] as Map).cast<String, dynamic>())).input(),
      sparkStatistics: (SparkStatisticsResponse.fromMap((map['sparkStatistics'] as Map).cast<String, dynamic>())).input(),
      statementType: (map['statementType'] as String).input(),
      timeline: (pulumi.Input.decodeList<QueryTimelineSampleResponse>(map['timeline'], (value) => QueryTimelineSampleResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      totalBytesBilled: (map['totalBytesBilled'] as String).input(),
      totalBytesProcessed: (map['totalBytesProcessed'] as String).input(),
      totalBytesProcessedAccuracy: (map['totalBytesProcessedAccuracy'] as String).input(),
      totalPartitionsProcessed: (map['totalPartitionsProcessed'] as String).input(),
      totalSlotMs: (map['totalSlotMs'] as String).input(),
      transferredBytes: (map['transferredBytes'] as String).input(),
      undeclaredQueryParameters: (pulumi.Input.decodeList<QueryParameterResponse>(map['undeclaredQueryParameters'], (value) => QueryParameterResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
