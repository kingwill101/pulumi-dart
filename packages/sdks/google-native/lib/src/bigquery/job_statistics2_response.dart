...
class JobStatistics2Response {
  ...
  final pulumi.Input<List<JobStatistics2ReservationUsageItemResponse>>
  reservationUsage;
    ...
    return <String, dynamic>{
      'biEngineStatistics':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(biEngineStatistics, (value) => value.toMap()),
      ...
      'ddlDestinationTable':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(ddlDestinationTable, (value) => value.toMap()),
      'ddlOperationPerformed': ddlOperationPerformed,
      'ddlTargetDataset':
          pulumi.Input.mapInputValue<
            DatasetReferenceResponse,
            Map<String, dynamic>
          >(ddlTargetDataset, (value) => value.toMap()),
      'ddlTargetRoutine':
          pulumi.Input.mapInputValue<
            RoutineReferenceResponse,
            Map<String, dynamic>
          >(ddlTargetRoutine, (value) => value.toMap()),
      'ddlTargetRowAccessPolicy':
          pulumi.Input.mapInputValue<
            RowAccessPolicyReferenceResponse,
            Map<String, dynamic>
          >(ddlTargetRowAccessPolicy, (value) => value.toMap()),
      'ddlTargetTable':
          pulumi.Input.mapInputValue<
            TableReferenceResponse,
            Map<String, dynamic>
          >(ddlTargetTable, (value) => value.toMap()),
      'dmlStats':
          pulumi.Input.mapInputValue<
            DmlStatisticsResponse,
            Map<String, dynamic>
          >(dmlStats, (value) => value.toMap()),
      'estimatedBytesProcessed': estimatedBytesProcessed,
      'mlStatistics':
          pulumi.Input.mapInputValue<
            MlStatisticsResponse,
            Map<String, dynamic>
          >(mlStatistics, (value) => value.toMap()),
      'modelTraining':
          pulumi.Input.mapInputValue<
            BigQueryModelTrainingResponse,
            Map<String, dynamic>
          >(modelTraining, (value) => value.toMap()),
      ...
      'queryPlan':
          pulumi.Input.mapInputValue<
            List<ExplainQueryStageResponse>,
      ...
      'reservationUsage':
          pulumi.Input.mapInputValue<
            List<JobStatistics2ReservationUsageItemResponse>,
            List<Map<String, dynamic>>
          >(
            reservationUsage,
            (value) =>
      ...
      'schema':
          pulumi.Input.mapInputValue<TableSchemaResponse, Map<String, dynamic>>(
            schema,
            (value) => value.toMap(),
          ),
      'searchStatistics':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(searchStatistics, (value) => value.toMap()),
      'sparkStatistics':
          pulumi.Input.mapInputValue<
            SparkStatisticsResponse,
            Map<String, dynamic>
          >(sparkStatistics, (value) => value.toMap()),
      'statementType': statementType,
      'timeline':
          pulumi.Input.mapInputValue<
            List<QueryTimelineSampleResponse>,
            List<Map<String, dynamic>>
          >(
            timeline,
            (value) =>
  ...
  factory JobStatistics2Response.fromMap(Map<String, dynamic> map) {
    return JobStatistics2Response(
      biEngineStatistics: pulumi.Input.fromValue(
        BiEngineStatisticsResponse.fromMap(
      ...
      ddlAffectedRowAccessPolicyCount: pulumi.Input.fromValue(
        map['ddlAffectedRowAccessPolicyCount'] as String,
      ),
      ddlDestinationTable: pulumi.Input.fromValue(
        TableReferenceResponse.fromMap(
          (map['ddlDestinationTable']! as Map).cast<String, dynamic>(),
        ),
      ),
      ddlOperationPerformed: pulumi.Input.fromValue(
        map['ddlOperationPerformed'] as String,
      ),
      ddlTargetDataset: pulumi.Input.fromValue(
        DatasetReferenceResponse.fromMap(
          (map['ddlTargetDataset']! as Map).cast<String, dynamic>(),
        ),
      ),
      ddlTargetRoutine: pulumi.Input.fromValue(
        RoutineReferenceResponse.fromMap(
          (map['ddlTargetRoutine']! as Map).cast<String, dynamic>(),
        ),
      ),
      ddlTargetRowAccessPolicy: pulumi.Input.fromValue(
        RowAccessPolicyReferenceResponse.fromMap(
          (map['ddlTargetRowAccessPolicy']! as Map).cast<String, dynamic>(),
        ),
      ),
      ddlTargetTable: pulumi.Input.fromValue(
        TableReferenceResponse.fromMap(
          (map['ddlTargetTable']! as Map).cast<String, dynamic>(),
        ),
      ),
      dmlStats: pulumi.Input.fromValue(
        DmlStatisticsResponse.fromMap(
          (map['dmlStats']! as Map).cast<String, dynamic>(),
        ),
      ),
      estimatedBytesProcessed: pulumi.Input.fromValue(
        map['estimatedBytesProcessed'] as String,
      ),
      mlStatistics: pulumi.Input.fromValue(
        MlStatisticsResponse.fromMap(
          (map['mlStatistics']! as Map).cast<String, dynamic>(),
        ),
      ),
      modelTraining: pulumi.Input.fromValue(
        BigQueryModelTrainingResponse.fromMap(
          (map['modelTraining']! as Map).cast<String, dynamic>(),
        ),
      ),
      modelTrainingCurrentIteration: pulumi.Input.fromValue(
        map['modelTrainingCurrentIteration'] as int,
      ),
      modelTrainingExpectedTotalIteration: pulumi.Input.fromValue(
        map['modelTrainingExpectedTotalIteration'] as String,
      ),
      numDmlAffectedRows: pulumi.Input.fromValue(
        map['numDmlAffectedRows'] as String,
      ),
      queryPlan: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ExplainQueryStageResponse>(
          map['queryPlan']!,
      ...
      referencedRoutines: pulumi.Input.fromValue(
        pulumi.Input.decodeList<RoutineReferenceResponse>(
      ...
      referencedTables: pulumi.Input.fromValue(
        pulumi.Input.decodeList<TableReferenceResponse>(
      ...
      reservationUsage: pulumi.Input.fromValue(
      ...
      schema: pulumi.Input.fromValue(
        TableSchemaResponse.fromMap(
          (map['schema']! as Map).cast<String, dynamic>(),
        ),
      ),
      searchStatistics: pulumi.Input.fromValue(
        SearchStatisticsResponse.fromMap(
          (map['searchStatistics']! as Map).cast<String, dynamic>(),
        ),
      ),
      sparkStatistics: pulumi.Input.fromValue(
        SparkStatisticsResponse.fromMap(
          (map['sparkStatistics']! as Map).cast<String, dynamic>(),
        ),
      ),
      statementType: pulumi.Input.fromValue(map['statementType'] as String),
      timeline: pulumi.Input.fromValue(
        pulumi.Input.decodeList<QueryTimelineSampleResponse>(
          map['timeline']!,
      ...
      totalBytesBilled: pulumi.Input.fromValue(
        map['totalBytesBilled'] as String,
      ),
      totalBytesProcessed: pulumi.Input.fromValue(
        map['totalBytesProcessed'] as String,
      ),
      totalBytesProcessedAccuracy: pulumi.Input.fromValue(
        map['totalBytesProcessedAccuracy'] as String,
      ),
      totalPartitionsProcessed: pulumi.Input.fromValue(
        map['totalPartitionsProcessed'] as String,
      ),
      totalSlotMs: pulumi.Input.fromValue(map['totalSlotMs'] as String),
      transferredBytes: pulumi.Input.fromValue(
        map['transferredBytes'] as String,
      ),
      undeclaredQueryParameters: pulumi.Input.fromValue(
