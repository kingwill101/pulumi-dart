...
class TableConstraintsForeignKeysItem {
  ...
  factory TableConstraintsForeignKeysItem.fromMap(Map<String, dynamic> map) {
    return TableConstraintsForeignKeysItem(
      columnReferences: (() { final guardedValue = map['columnReferences']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<TableConstraintsForeignKeysItemColumnReferencesItem>(guardedValue, (value) => TableConstraintsForeignKeysItemColumnReferencesItem.fromMap((value as Map).cast<String, dynamic>()))); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      referencedTable: (() { final guardedValue = map['referencedTable']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TableConstraintsForeignKeysItemReferencedTable.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
