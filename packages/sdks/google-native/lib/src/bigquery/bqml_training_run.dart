...
class BqmlTrainingRun {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'iterationResults': ?iterationResults == null ? null : pulumi.Input.encodeList<BqmlIterationResult, Map<String, dynamic>>(iterationResults!, (value) => value.toMap()),
      'startTime': ?startTime,
      'state': ?state,
      'trainingOptions': ?trainingOptions == null ? null : trainingOptions!.toMap(),
    };
  }

  factory BqmlTrainingRun.fromMap(Map<String, dynamic> map) {
    return BqmlTrainingRun(
      iterationResults: map['iterationResults'] == null ? null : pulumi.Input.decodeList<BqmlIterationResult>(map['iterationResults'], (value) => BqmlIterationResult.fromMap((value as Map).cast<String, dynamic>())),
      startTime: map['startTime'] == null ? null : map['startTime'] as String,
      state: map['state'] == null ? null : map['state'] as String,
      trainingOptions: map['trainingOptions'] == null ? null : BqmlTrainingRunTrainingOptions.fromMap((map['trainingOptions'] as Map).cast<String, dynamic>()),
    );
  }
}
