...
class ExplainQueryStageResponse {
  ...
  factory ExplainQueryStageResponse.fromMap(Map<String, dynamic> map) {
    return ExplainQueryStageResponse(
      completedParallelInputs: pulumi.Input.fromValue(
        map['completedParallelInputs'] as String,
      ),
      ...
      inputStages: pulumi.Input.fromValue(
        (map['inputStages'] as List).cast<String>(),
      ),
      ...
      shuffleOutputBytes: pulumi.Input.fromValue(
        map['shuffleOutputBytes'] as String,
      ),
      shuffleOutputBytesSpilled: pulumi.Input.fromValue(
        map['shuffleOutputBytesSpilled'] as String,
      ),
      ...
      steps: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ExplainQueryStepResponse>(
          map['steps']!,
