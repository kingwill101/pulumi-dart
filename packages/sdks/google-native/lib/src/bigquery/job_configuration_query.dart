...
class JobConfigurationQuery {
  ...
  factory JobConfigurationQuery.fromMap(Map<String, dynamic> map) {
    return JobConfigurationQuery(
      ...
      defaultDataset: map['defaultDataset'] == null ? null : (DatasetReference.fromMap((map['defaultDataset'] as Map).cast<String, dynamic>())).input(),
      ...
      preserveNulls: map['preserveNulls'] == null ? null : (map['preserveNulls'] as bool).input(),
      priority: map['priority'] == null ? null : (map['priority'] as String).input(),
      query: map['query'] == null ? null : (map['query'] as String).input(),
      queryParameters: map['queryParameters'] == null ? null : (pulumi.Input.decodeList<QueryParameter>(map['queryParameters'], (value) => QueryParameter.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      tableDefinitions: map['tableDefinitions'] == null ? null : ((map['tableDefinitions'] as Map).cast<String, String>()).input(),
