...
class JobConfigurationQuery {
  ...
  final pulumi.Input<List<UserDefinedFunctionResource>>?
  ...
  factory JobConfigurationQuery.fromMap(Map<String, dynamic> map) {
    return JobConfigurationQuery(
      allowLargeResults: (() {
        final guardedValue = map['allowLargeResults'];
      ...
      defaultDataset: (() {
        final guardedValue = map['defaultDataset'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      flattenResults: (() {
        final guardedValue = map['flattenResults'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      maximumBillingTier: (() {
        final guardedValue = map['maximumBillingTier'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      maximumBytesBilled: (() {
        final guardedValue = map['maximumBytesBilled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      parameterMode: (() {
        final guardedValue = map['parameterMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      preserveNulls: (() {
        final guardedValue = map['preserveNulls'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      priority: (() {
      ...
      queryParameters: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<QueryParameter>(
            guardedValue,
            (value) =>
                QueryParameter.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      rangePartitioning: (() {
      ...
      tableDefinitions: (() {
        final guardedValue = map['tableDefinitions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      useQueryCache: (() {
        final guardedValue = map['useQueryCache'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      userDefinedFunctionResources: (() {
        final guardedValue = map['userDefinedFunctionResources'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
