...
class JobStatusResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'errorResult':
          pulumi.Input.mapInputValue<ErrorProtoResponse, Map<String, dynamic>>(
            errorResult,
            (value) => value.toMap(),
          ),
      'errors':
          pulumi.Input.mapInputValue<
            List<ErrorProtoResponse>,
  ...
  factory JobStatusResponse.fromMap(Map<String, dynamic> map) {
    return JobStatusResponse(
      errorResult: pulumi.Input.fromValue(
        ErrorProtoResponse.fromMap(
          (map['errorResult']! as Map).cast<String, dynamic>(),
        ),
      ),
      errors: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ErrorProtoResponse>(
          map['errors']!,
