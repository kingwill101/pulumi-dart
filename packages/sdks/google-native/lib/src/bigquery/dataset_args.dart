...
class DatasetArgs {
  ...
  DatasetArgs({
    pulumi.Output<List<DatasetAccessItem>>? access,
    pulumi.Output<DatasetReference>? datasetReference,
    pulumi.Output<EncryptionConfiguration>? defaultEncryptionConfiguration,
    pulumi.Output<String>? defaultPartitionExpirationMs,
    pulumi.Output<String>? defaultTableExpirationMs,
    pulumi.Output<String>? description,
    pulumi.Output<ExternalDatasetReference>? externalDatasetReference,
    ...
    pulumi.Output<List<DatasetTagsItem>>? tags,
  }) :
  ...
  factory DatasetArgs.fromMap(Map<String, dynamic> map) {
    return DatasetArgs(
      access: map['access'] == null ? null : pulumi.Output.create<List<DatasetAccessItem>>(pulumi.Input.decodeList<DatasetAccessItem>(map['access'], (value) => DatasetAccessItem.fromMap((value as Map).cast<String, dynamic>()))),
      datasetReference: map['datasetReference'] == null ? null : pulumi.Output.create<DatasetReference>(DatasetReference.fromMap((map['datasetReference'] as Map).cast<String, dynamic>())),
      defaultEncryptionConfiguration: map['defaultEncryptionConfiguration'] == null ? null : pulumi.Output.create<EncryptionConfiguration>(EncryptionConfiguration.fromMap((map['defaultEncryptionConfiguration'] as Map).cast<String, dynamic>())),
      defaultPartitionExpirationMs: map['defaultPartitionExpirationMs'] == null ? null : pulumi.Output.create<String>(map['defaultPartitionExpirationMs'] as String),
      defaultTableExpirationMs: map['defaultTableExpirationMs'] == null ? null : pulumi.Output.create<String>(map['defaultTableExpirationMs'] as String),
      description: map['description'] == null ? null : pulumi.Output.create<String>(map['description'] as String),
      externalDatasetReference: map['externalDatasetReference'] == null ? null : pulumi.Output.create<ExternalDatasetReference>(ExternalDatasetReference.fromMap((map['externalDatasetReference'] as Map).cast<String, dynamic>())),
      ...
      tags: map['tags'] == null ? null : pulumi.Output.create<List<DatasetTagsItem>>(pulumi.Input.decodeList<DatasetTagsItem>(map['tags'], (value) => DatasetTagsItem.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
