...
class GetRoutineResult {
  ...
  factory GetRoutineResult.fromMap(Map<String, dynamic> map) {
    return GetRoutineResult(
      ...
      remoteFunctionOptions: RemoteFunctionOptionsResponse.fromMap(
        (map['remoteFunctionOptions']! as Map).cast<String, dynamic>(),
      ),
      returnTableType: StandardSqlTableTypeResponse.fromMap(
        (map['returnTableType']! as Map).cast<String, dynamic>(),
      ),
      returnType: StandardSqlDataTypeResponse.fromMap(
        (map['returnType']! as Map).cast<String, dynamic>(),
      ),
      routineReference: RoutineReferenceResponse.fromMap(
      ...
      sparkOptions: SparkOptionsResponse.fromMap(
