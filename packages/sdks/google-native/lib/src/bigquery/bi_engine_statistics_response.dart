...
class BiEngineStatisticsResponse {
  ...
  factory BiEngineStatisticsResponse.fromMap(Map<String, dynamic> map) {
    return BiEngineStatisticsResponse(
      accelerationMode: (map['accelerationMode'] as String).input(),
      biEngineMode: (map['biEngineMode'] as String).input(),
      biEngineReasons: (pulumi.Input.decodeList<BiEngineReasonResponse>(map['biEngineReasons'], (value) => BiEngineReasonResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
