...
class ExternalDataConfigurationResponse {
  ...
  factory ExternalDataConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return ExternalDataConfigurationResponse(
      ...
      avroOptions: (AvroOptionsResponse.fromMap((map['avroOptions'] as Map).cast<String, dynamic>())).input(),
      bigtableOptions: (BigtableOptionsResponse.fromMap((map['bigtableOptions'] as Map).cast<String, dynamic>())).input(),
      compression: (map['compression'] as String).input(),
      connectionId: (map['connectionId'] as String).input(),
      csvOptions: (CsvOptionsResponse.fromMap((map['csvOptions'] as Map).cast<String, dynamic>())).input(),
      decimalTargetTypes: ((map['decimalTargetTypes'] as List).cast<String>()).input(),
      fileSetSpecType: (map['fileSetSpecType'] as String).input(),
      googleSheetsOptions: (GoogleSheetsOptionsResponse.fromMap((map['googleSheetsOptions'] as Map).cast<String, dynamic>())).input(),
      ...
      jsonOptions: (JsonOptionsResponse.fromMap((map['jsonOptions'] as Map).cast<String, dynamic>())).input(),
