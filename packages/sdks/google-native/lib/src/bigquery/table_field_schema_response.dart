...
class TableFieldSchemaResponse {
  ...
  factory TableFieldSchemaResponse.fromMap(Map<String, dynamic> map) {
    return TableFieldSchemaResponse(
      categories: (TableFieldSchemaCategoriesResponse.fromMap((map['categories'] as Map).cast<String, dynamic>())).input(),
      collation: (map['collation'] as String).input(),
      defaultValueExpression: (map['defaultValueExpression'] as String).input(),
      ...
      policyTags: (TableFieldSchemaPolicyTagsResponse.fromMap((map['policyTags'] as Map).cast<String, dynamic>())).input(),
      precision: (map['precision'] as String).input(),
      rangeElementType: (TableFieldSchemaRangeElementTypeResponse.fromMap((map['rangeElementType'] as Map).cast<String, dynamic>())).input(),
      roundingMode: (map['roundingMode'] as String).input(),
