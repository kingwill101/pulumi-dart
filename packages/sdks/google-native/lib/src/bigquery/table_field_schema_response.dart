...
class TableFieldSchemaResponse {
  ...
  factory TableFieldSchemaResponse.fromMap(Map<String, dynamic> map) {
    return TableFieldSchemaResponse(
      ...
      policyTags: pulumi.Input.fromValue(
        TableFieldSchemaPolicyTagsResponse.fromMap(
      ...
      rangeElementType: pulumi.Input.fromValue(
        TableFieldSchemaRangeElementTypeResponse.fromMap(
