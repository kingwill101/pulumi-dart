...
class JobConfigurationExtractResponse {
  ...
  factory JobConfigurationExtractResponse.fromMap(Map<String, dynamic> map) {
    return JobConfigurationExtractResponse(
      ...
      destinationFormat: (map['destinationFormat'] as String).input(),
      destinationUri: (map['destinationUri'] as String).input(),
      destinationUris: ((map['destinationUris'] as List).cast<String>()).input(),
      fieldDelimiter: (map['fieldDelimiter'] as String).input(),
      printHeader: (map['printHeader'] as bool).input(),
      sourceModel: (ModelReferenceResponse.fromMap((map['sourceModel'] as Map).cast<String, dynamic>())).input(),
