...
class DatasetAccessItemResponse {
  ...
  final pulumi.Input<DatasetAccessEntryResponse> dataset;
  ...
  final pulumi.Input<RoutineReferenceResponse> routine;
  ...
  final pulumi.Input<TableReferenceResponse> view;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'dataset': pulumi.Input.mapInputValue<DatasetAccessEntryResponse, Map<String, dynamic>>(dataset, (value) => value.toMap()),
      'domain': domain,
      'groupByEmail': groupByEmail,
      'iamMember': iamMember,
      'role': role,
      'routine': pulumi.Input.mapInputValue<RoutineReferenceResponse, Map<String, dynamic>>(routine, (value) => value.toMap()),
      'specialGroup': specialGroup,
      'userByEmail': userByEmail,
      'view': pulumi.Input.mapInputValue<TableReferenceResponse, Map<String, dynamic>>(view, (value) => value.toMap()),
    };
  }

  factory DatasetAccessItemResponse.fromMap(Map<String, dynamic> map) {
    return DatasetAccessItemResponse(
      dataset: (DatasetAccessEntryResponse.fromMap((map['dataset'] as Map).cast<String, dynamic>())).input(),
      domain: (map['domain'] as String).input(),
      groupByEmail: (map['groupByEmail'] as String).input(),
      iamMember: (map['iamMember'] as String).input(),
      role: (map['role'] as String).input(),
      routine: (RoutineReferenceResponse.fromMap((map['routine'] as Map).cast<String, dynamic>())).input(),
      specialGroup: (map['specialGroup'] as String).input(),
      userByEmail: (map['userByEmail'] as String).input(),
      view: (TableReferenceResponse.fromMap((map['view'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
