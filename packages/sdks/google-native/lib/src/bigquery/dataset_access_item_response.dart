...
class DatasetAccessItemResponse {
  ...
  const DatasetAccessItemResponse({
  ...
  factory DatasetAccessItemResponse.fromMap(Map<String, dynamic> map) {
    return DatasetAccessItemResponse(
      dataset: pulumi.Input.fromValue(DatasetAccessEntryResponse.fromMap((map['dataset']! as Map).cast<String, dynamic>())),
      ...
      routine: pulumi.Input.fromValue(RoutineReferenceResponse.fromMap((map['routine']! as Map).cast<String, dynamic>())),
      ...
      view: pulumi.Input.fromValue(TableReferenceResponse.fromMap((map['view']! as Map).cast<String, dynamic>())),
    );
  }
}
