...
class TableArgs {
  ...
  TableArgs({
    pulumi.Output<BigLakeConfiguration>? biglakeConfiguration,
    pulumi.Output<Clustering>? clustering,
    required pulumi.Output<String> datasetId,
    pulumi.Output<String>? description,
    pulumi.Output<EncryptionConfiguration>? encryptionConfiguration,
    pulumi.Output<String>? expirationTime,
    pulumi.Output<ExternalDataConfiguration>? externalDataConfiguration,
    pulumi.Output<String>? friendlyName,
    pulumi.Output<Map<String, String>>? labels,
    pulumi.Output<MaterializedViewDefinition>? materializedView,
    pulumi.Output<String>? maxStaleness,
    pulumi.Output<ModelDefinition>? model,
    pulumi.Output<String>? project,
    pulumi.Output<RangePartitioning>? rangePartitioning,
    pulumi.Output<bool>? requirePartitionFilter,
    pulumi.Output<Map<String, String>>? resourceTags,
    pulumi.Output<TableSchema>? schema,
    pulumi.Output<TableConstraints>? tableConstraints,
    pulumi.Output<TableReference>? tableReference,
    pulumi.Output<TimePartitioning>? timePartitioning,
    pulumi.Output<ViewDefinition>? view,
  }) :
  ...
  factory TableArgs.fromMap(Map<String, dynamic> map) {
    return TableArgs(
      biglakeConfiguration: map['biglakeConfiguration'] == null ? null : pulumi.Output.create<BigLakeConfiguration>(BigLakeConfiguration.fromMap((map['biglakeConfiguration'] as Map).cast<String, dynamic>())),
      clustering: map['clustering'] == null ? null : pulumi.Output.create<Clustering>(Clustering.fromMap((map['clustering'] as Map).cast<String, dynamic>())),
      ...
      externalDataConfiguration: map['externalDataConfiguration'] == null ? null : pulumi.Output.create<ExternalDataConfiguration>(ExternalDataConfiguration.fromMap((map['externalDataConfiguration'] as Map).cast<String, dynamic>())),
      friendlyName: map['friendlyName'] == null ? null : pulumi.Output.create<String>(map['friendlyName'] as String),
      labels: map['labels'] == null ? null : pulumi.Output.create<Map<String, String>>((map['labels'] as Map).cast<String, String>()),
      materializedView: map['materializedView'] == null ? null : pulumi.Output.create<MaterializedViewDefinition>(MaterializedViewDefinition.fromMap((map['materializedView'] as Map).cast<String, dynamic>())),
      maxStaleness: map['maxStaleness'] == null ? null : pulumi.Output.create<String>(map['maxStaleness'] as String),
      model: map['model'] == null ? null : pulumi.Output.create<ModelDefinition>(ModelDefinition.fromMap((map['model'] as Map).cast<String, dynamic>())),
      project: map['project'] == null ? null : pulumi.Output.create<String>(map['project'] as String),
      rangePartitioning: map['rangePartitioning'] == null ? null : pulumi.Output.create<RangePartitioning>(RangePartitioning.fromMap((map['rangePartitioning'] as Map).cast<String, dynamic>())),
      ...
      tableConstraints: map['tableConstraints'] == null ? null : pulumi.Output.create<TableConstraints>(TableConstraints.fromMap((map['tableConstraints'] as Map).cast<String, dynamic>())),
      tableReference: map['tableReference'] == null ? null : pulumi.Output.create<TableReference>(TableReference.fromMap((map['tableReference'] as Map).cast<String, dynamic>())),
      timePartitioning: map['timePartitioning'] == null ? null : pulumi.Output.create<TimePartitioning>(TimePartitioning.fromMap((map['timePartitioning'] as Map).cast<String, dynamic>())),
      view: map['view'] == null ? null : pulumi.Output.create<ViewDefinition>(ViewDefinition.fromMap((map['view'] as Map).cast<String, dynamic>())),
    );
  }
}
