...
class BigtableOptionsResponse {
  ...
  factory BigtableOptionsResponse.fromMap(Map<String, dynamic> map) {
    return BigtableOptionsResponse(
      columnFamilies: (pulumi.Input.decodeList<BigtableColumnFamilyResponse>(map['columnFamilies'], (value) => BigtableColumnFamilyResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
