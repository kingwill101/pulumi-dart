...
class JobStatisticsResponse {
  ...
  final pulumi.Input<List<JobStatisticsReservationUsageItemResponse>>
  reservationUsage;

  /// [Preview] Statistics for row-level security. Present only for query and extract jobs.
  final pulumi.Input<RowLevelSecurityStatisticsResponse>
    ...
    return <String, dynamic>{
      ...
      'copy':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(copy, (value) => value.toMap()),
      'creationTime': creationTime,
      'dataMaskingStatistics':
          pulumi.Input.mapInputValue<
            DataMaskingStatisticsResponse,
            Map<String, dynamic>
          >(dataMaskingStatistics, (value) => value.toMap()),
      'endTime': endTime,
      'extract':
          pulumi.Input.mapInputValue<
            JobStatistics4Response,
            Map<String, dynamic>
          >(extract, (value) => value.toMap()),
      'load':
          pulumi.Input.mapInputValue<
            JobStatistics3Response,
            Map<String, dynamic>
          >(load, (value) => value.toMap()),
      ...
      'reservationUsage':
          pulumi.Input.mapInputValue<
            List<JobStatisticsReservationUsageItemResponse>,
      ...
      'rowLevelSecurityStatistics':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(rowLevelSecurityStatistics, (value) => value.toMap()),
      'scriptStatistics':
          pulumi.Input.mapInputValue<
            ScriptStatisticsResponse,
            Map<String, dynamic>
          >(scriptStatistics, (value) => value.toMap()),
      'sessionInfo':
          pulumi.Input.mapInputValue<SessionInfoResponse, Map<String, dynamic>>(
            sessionInfo,
            (value) => value.toMap(),
          ),
      'startTime': startTime,
      ...
      'transactionInfo':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(transactionInfo, (value) => value.toMap()),
    };
  }
  ...
  factory JobStatisticsResponse.fromMap(Map<String, dynamic> map) {
    return JobStatisticsResponse(
      ...
      copy: pulumi.Input.fromValue(
        JobStatistics5Response.fromMap(
          (map['copy']! as Map).cast<String, dynamic>(),
        ),
      ),
      creationTime: pulumi.Input.fromValue(map['creationTime'] as String),
      dataMaskingStatistics: pulumi.Input.fromValue(
        DataMaskingStatisticsResponse.fromMap(
          (map['dataMaskingStatistics']! as Map).cast<String, dynamic>(),
        ),
      ),
      endTime: pulumi.Input.fromValue(map['endTime'] as String),
      extract: pulumi.Input.fromValue(
        JobStatistics4Response.fromMap(
          (map['extract']! as Map).cast<String, dynamic>(),
        ),
      ),
      load: pulumi.Input.fromValue(
        JobStatistics3Response.fromMap(
      ...
      query: pulumi.Input.fromValue(
        JobStatistics2Response.fromMap(
          (map['query']! as Map).cast<String, dynamic>(),
        ),
      ),
      quotaDeferments: pulumi.Input.fromValue(
        (map['quotaDeferments'] as List).cast<String>(),
      ),
      ...
      rowLevelSecurityStatistics: pulumi.Input.fromValue(
        RowLevelSecurityStatisticsResponse.fromMap(
          (map['rowLevelSecurityStatistics']! as Map).cast<String, dynamic>(),
        ),
      ),
      scriptStatistics: pulumi.Input.fromValue(
        ScriptStatisticsResponse.fromMap(
          (map['scriptStatistics']! as Map).cast<String, dynamic>(),
        ),
      ),
      sessionInfo: pulumi.Input.fromValue(
        SessionInfoResponse.fromMap(
      ...
      transactionInfo: pulumi.Input.fromValue(
        TransactionInfoResponse.fromMap(
