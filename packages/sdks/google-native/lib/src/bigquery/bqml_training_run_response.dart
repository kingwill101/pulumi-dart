...
class BqmlTrainingRunResponse {
  ...
  final List<BqmlIterationResultResponse> iterationResults;
  ...
  final BqmlTrainingRunTrainingOptionsResponse trainingOptions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'iterationResults': pulumi.Input.encodeList<BqmlIterationResultResponse, Map<String, dynamic>>(iterationResults, (value) => value.toMap()),
      'startTime': startTime,
      'state': state,
      'trainingOptions': trainingOptions.toMap(),
    };
  }

  factory BqmlTrainingRunResponse.fromMap(Map<String, dynamic> map) {
    return BqmlTrainingRunResponse(
      iterationResults: pulumi.Input.decodeList<BqmlIterationResultResponse>(map['iterationResults'], (value) => BqmlIterationResultResponse.fromMap((value as Map).cast<String, dynamic>())),
      startTime: map['startTime'] as String,
      state: map['state'] as String,
      trainingOptions: BqmlTrainingRunTrainingOptionsResponse.fromMap((map['trainingOptions'] as Map).cast<String, dynamic>()),
    );
  }
}
