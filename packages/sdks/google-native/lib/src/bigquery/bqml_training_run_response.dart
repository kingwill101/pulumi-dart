    ...
    return <String, dynamic>{
      'iterationResults':
          pulumi.Input.mapInputValue<
            List<BqmlIterationResultResponse>,
      ...
      'trainingOptions':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(trainingOptions, (value) => value.toMap()),
    };
  }
  ...
  factory BqmlTrainingRunResponse.fromMap(Map<String, dynamic> map) {
    return BqmlTrainingRunResponse(
      iterationResults: pulumi.Input.fromValue(
        pulumi.Input.decodeList<BqmlIterationResultResponse>(
      ...
      trainingOptions: pulumi.Input.fromValue(
        BqmlTrainingRunTrainingOptionsResponse.fromMap(
