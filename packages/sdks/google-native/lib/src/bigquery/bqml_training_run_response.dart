...
class BqmlTrainingRunResponse {
  ...
  factory BqmlTrainingRunResponse.fromMap(Map<String, dynamic> map) {
    return BqmlTrainingRunResponse(
      iterationResults: pulumi.Input.fromValue(pulumi.Input.decodeList<BqmlIterationResultResponse>(map['iterationResults']!, (value) => BqmlIterationResultResponse.fromMap((value as Map).cast<String, dynamic>()))),
      startTime: pulumi.Input.fromValue(map['startTime'] as String),
      state: pulumi.Input.fromValue(map['state'] as String),
      trainingOptions: pulumi.Input.fromValue(BqmlTrainingRunTrainingOptionsResponse.fromMap((map['trainingOptions']! as Map).cast<String, dynamic>())),
    );
  }
}
