...
class JobConfigurationLoad {
  ...
  factory JobConfigurationLoad.fromMap(Map<String, dynamic> map) {
    return JobConfigurationLoad(
      ...
      destinationTableProperties: (() { final guardedValue = map['destinationTableProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DestinationTableProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      preserveAsciiControlCharacters: (() { final guardedValue = map['preserveAsciiControlCharacters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      schemaInline: (() { final guardedValue = map['schemaInline']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      schemaInlineFormat: (() { final guardedValue = map['schemaInlineFormat']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      useAvroLogicalTypes: (() { final guardedValue = map['useAvroLogicalTypes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
