...
class JobConfigurationLoad {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'connectionProperties': ?connectionProperties == null ? null : pulumi.Input.encodeList<ConnectionProperty, Map<String, dynamic>>(connectionProperties!, (value) => value.toMap()),
      ...
      'destinationTableProperties': ?destinationTableProperties == null ? null : destinationTableProperties!.toMap(),
      'encoding': ?encoding,
      'fieldDelimiter': ?fieldDelimiter,
      'fileSetSpecType': ?fileSetSpecType,
      'hivePartitioningOptions': ?hivePartitioningOptions == null ? null : hivePartitioningOptions!.toMap(),
      'ignoreUnknownValues': ?ignoreUnknownValues,
      'jsonExtension': ?jsonExtension,
      'maxBadRecords': ?maxBadRecords,
      'nullMarker': ?nullMarker,
      'parquetOptions': ?parquetOptions == null ? null : parquetOptions!.toMap(),
      'preserveAsciiControlCharacters': ?preserveAsciiControlCharacters,
      'projectionFields': ?projectionFields,
      'quote': ?quote,
      'rangePartitioning': ?rangePartitioning == null ? null : rangePartitioning!.toMap(),
      ...
      'timePartitioning': ?timePartitioning == null ? null : timePartitioning!.toMap(),
  ...
  factory JobConfigurationLoad.fromMap(Map<String, dynamic> map) {
    return JobConfigurationLoad(
      ...
      connectionProperties: map['connectionProperties'] == null ? null : pulumi.Input.decodeList<ConnectionProperty>(map['connectionProperties'], (value) => ConnectionProperty.fromMap((value as Map).cast<String, dynamic>())),
      createDisposition: map['createDisposition'] == null ? null : map['createDisposition'] as String,
      createSession: map['createSession'] == null ? null : map['createSession'] as bool,
      decimalTargetTypes: map['decimalTargetTypes'] == null ? null : (map['decimalTargetTypes'] as List).cast<String>(),
      ...
      destinationTableProperties: map['destinationTableProperties'] == null ? null : DestinationTableProperties.fromMap((map['destinationTableProperties'] as Map).cast<String, dynamic>()),
      ...
      fileSetSpecType: map['fileSetSpecType'] == null ? null : map['fileSetSpecType'] as String,
      hivePartitioningOptions: map['hivePartitioningOptions'] == null ? null : HivePartitioningOptions.fromMap((map['hivePartitioningOptions'] as Map).cast<String, dynamic>()),
      ignoreUnknownValues: map['ignoreUnknownValues'] == null ? null : map['ignoreUnknownValues'] as bool,
      jsonExtension: map['jsonExtension'] == null ? null : map['jsonExtension'] as String,
      maxBadRecords: map['maxBadRecords'] == null ? null : map['maxBadRecords'] as int,
      nullMarker: map['nullMarker'] == null ? null : map['nullMarker'] as String,
      parquetOptions: map['parquetOptions'] == null ? null : ParquetOptions.fromMap((map['parquetOptions'] as Map).cast<String, dynamic>()),
      preserveAsciiControlCharacters: map['preserveAsciiControlCharacters'] == null ? null : map['preserveAsciiControlCharacters'] as bool,
      projectionFields: map['projectionFields'] == null ? null : (map['projectionFields'] as List).cast<String>(),
      ...
      referenceFileSchemaUri: map['referenceFileSchemaUri'] == null ? null : map['referenceFileSchemaUri'] as String,
      schema: map['schema'] == null ? null : TableSchema.fromMap((map['schema'] as Map).cast<String, dynamic>()),
      schemaInline: map['schemaInline'] == null ? null : map['schemaInline'] as String,
      schemaInlineFormat: map['schemaInlineFormat'] == null ? null : map['schemaInlineFormat'] as String,
      ...
      sourceUris: map['sourceUris'] == null ? null : (map['sourceUris'] as List).cast<String>(),
