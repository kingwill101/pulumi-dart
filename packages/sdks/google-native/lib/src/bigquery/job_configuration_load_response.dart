...
class JobConfigurationLoadResponse {
  ...
  final pulumi.Input<DestinationTablePropertiesResponse> destinationTableProperties;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'destinationTableProperties': pulumi.Input.mapInputValue<DestinationTablePropertiesResponse, Map<String, dynamic>>(destinationTableProperties, (value) => value.toMap()),
      'encoding': encoding,
  ...
  factory JobConfigurationLoadResponse.fromMap(Map<String, dynamic> map) {
    return JobConfigurationLoadResponse(
      ...
      destinationTableProperties: (DestinationTablePropertiesResponse.fromMap((map['destinationTableProperties'] as Map).cast<String, dynamic>())).input(),
      ...
      hivePartitioningOptions: (HivePartitioningOptionsResponse.fromMap((map['hivePartitioningOptions'] as Map).cast<String, dynamic>())).input(),
      ...
      parquetOptions: (ParquetOptionsResponse.fromMap((map['parquetOptions'] as Map).cast<String, dynamic>())).input(),
      preserveAsciiControlCharacters: (map['preserveAsciiControlCharacters'] as bool).input(),
      projectionFields: ((map['projectionFields'] as List).cast<String>()).input(),
      ...
      schemaInline: (map['schemaInline'] as String).input(),
      schemaInlineFormat: (map['schemaInlineFormat'] as String).input(),
