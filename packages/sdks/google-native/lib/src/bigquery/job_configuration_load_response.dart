...
class JobConfigurationLoadResponse {
  ...
  final pulumi.Input<DestinationTablePropertiesResponse>
  ...
  factory JobConfigurationLoadResponse.fromMap(Map<String, dynamic> map) {
    return JobConfigurationLoadResponse(
      ...
      destinationTableProperties: pulumi.Input.fromValue(
        DestinationTablePropertiesResponse.fromMap(
      ...
      projectionFields: pulumi.Input.fromValue(
      ...
      schemaInline: pulumi.Input.fromValue(map['schemaInline'] as String),
      schemaInlineFormat: pulumi.Input.fromValue(
