...
class JobConfigurationLoadResponse {
  ...
  const JobConfigurationLoadResponse({
  ...
  factory JobConfigurationLoadResponse.fromMap(Map<String, dynamic> map) {
    return JobConfigurationLoadResponse(
      ...
      destinationTableProperties: pulumi.Input.fromValue(DestinationTablePropertiesResponse.fromMap((map['destinationTableProperties']! as Map).cast<String, dynamic>())),
      ...
      projectionFields: pulumi.Input.fromValue((map['projectionFields'] as List).cast<String>()),
      ...
      schemaInlineFormat: pulumi.Input.fromValue(map['schemaInlineFormat'] as String),
