...
class QueryParameterValueResponse {
  ...
  factory QueryParameterValueResponse.fromMap(Map<String, dynamic> map) {
    return QueryParameterValueResponse(
      arrayValues: pulumi.Input.fromValue(pulumi.Input.decodeList<QueryParameterValueResponse>(map['arrayValues']!, (value) => QueryParameterValueResponse.fromMap((value as Map).cast<String, dynamic>()))),
      structValues: pulumi.Input.fromValue((map['structValues'] as Map).cast<String, String>()),
