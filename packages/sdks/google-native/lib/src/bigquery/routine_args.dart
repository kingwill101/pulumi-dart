    ...
    return <String, dynamic>{
      ...
      'dataGovernanceType':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(dataGovernanceType, (value) => value.wireValue),
      'datasetId': datasetId,
  ...
  factory RoutineArgs.fromMap(Map<String, dynamic> map) {
    return RoutineArgs(
      ...
      dataGovernanceType: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RoutineDataGovernanceType.fromValue(guardedValue as String),
        );
      })(),
      ...
      determinismLevel: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RoutineDeterminismLevel.fromValue(guardedValue as String),
        );
      })(),
      importedLibraries: (() {
      ...
      language: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RoutineLanguage.fromValue(guardedValue as String),
        );
      })(),
      project: (() {
      ...
      routineReference: pulumi.Input.fromValue(
        RoutineReference.fromMap(
          (map['routineReference']! as Map).cast<String, dynamic>(),
        ),
      ),
      routineType: pulumi.Input.fromValue(
        RoutineRoutineType.fromValue(map['routineType']! as String),
      ),
      securityMode: (() {
        final guardedValue = map['securityMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RoutineSecurityMode.fromValue(guardedValue as String),
        );
      })(),
      sparkOptions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SparkOptions.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      strictMode: (() {
