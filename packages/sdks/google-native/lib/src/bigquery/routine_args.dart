...
class RoutineArgs {
  ...
  RoutineArgs({
    pulumi.Output<List<Argument>>? arguments,
    pulumi.Output<RoutineDataGovernanceType>? dataGovernanceType,
    required pulumi.Output<String> datasetId,
    required pulumi.Output<String> definitionBody,
    pulumi.Output<String>? description,
    pulumi.Output<RoutineDeterminismLevel>? determinismLevel,
    pulumi.Output<List<String>>? importedLibraries,
    pulumi.Output<RoutineLanguage>? language,
    pulumi.Output<String>? project,
    pulumi.Output<RemoteFunctionOptions>? remoteFunctionOptions,
    pulumi.Output<StandardSqlTableType>? returnTableType,
    pulumi.Output<StandardSqlDataType>? returnType,
    required pulumi.Output<RoutineReference> routineReference,
    required pulumi.Output<RoutineRoutineType> routineType,
    pulumi.Output<RoutineSecurityMode>? securityMode,
    pulumi.Output<SparkOptions>? sparkOptions,
    pulumi.Output<bool>? strictMode,
  }) :
  ...
  factory RoutineArgs.fromMap(Map<String, dynamic> map) {
    return RoutineArgs(
      arguments: map['arguments'] == null ? null : pulumi.Output.create<List<Argument>>(pulumi.Input.decodeList<Argument>(map['arguments'], (value) => Argument.fromMap((value as Map).cast<String, dynamic>()))),
      dataGovernanceType: map['dataGovernanceType'] == null ? null : pulumi.Output.create<RoutineDataGovernanceType>(RoutineDataGovernanceType.fromValue(map['dataGovernanceType'] as String)),
      datasetId: pulumi.Output.create<String>(map['datasetId'] as String),
      definitionBody: pulumi.Output.create<String>(map['definitionBody'] as String),
      description: map['description'] == null ? null : pulumi.Output.create<String>(map['description'] as String),
      determinismLevel: map['determinismLevel'] == null ? null : pulumi.Output.create<RoutineDeterminismLevel>(RoutineDeterminismLevel.fromValue(map['determinismLevel'] as String)),
      ...
      language: map['language'] == null ? null : pulumi.Output.create<RoutineLanguage>(RoutineLanguage.fromValue(map['language'] as String)),
      project: map['project'] == null ? null : pulumi.Output.create<String>(map['project'] as String),
      remoteFunctionOptions: map['remoteFunctionOptions'] == null ? null : pulumi.Output.create<RemoteFunctionOptions>(RemoteFunctionOptions.fromMap((map['remoteFunctionOptions'] as Map).cast<String, dynamic>())),
      returnTableType: map['returnTableType'] == null ? null : pulumi.Output.create<StandardSqlTableType>(StandardSqlTableType.fromMap((map['returnTableType'] as Map).cast<String, dynamic>())),
      returnType: map['returnType'] == null ? null : pulumi.Output.create<StandardSqlDataType>(StandardSqlDataType.fromMap((map['returnType'] as Map).cast<String, dynamic>())),
      routineReference: pulumi.Output.create<RoutineReference>(RoutineReference.fromMap((map['routineReference'] as Map).cast<String, dynamic>())),
      routineType: pulumi.Output.create<RoutineRoutineType>(RoutineRoutineType.fromValue(map['routineType'] as String)),
      securityMode: map['securityMode'] == null ? null : pulumi.Output.create<RoutineSecurityMode>(RoutineSecurityMode.fromValue(map['securityMode'] as String)),
      sparkOptions: map['sparkOptions'] == null ? null : pulumi.Output.create<SparkOptions>(SparkOptions.fromMap((map['sparkOptions'] as Map).cast<String, dynamic>())),
      strictMode: map['strictMode'] == null ? null : pulumi.Output.create<bool>(map['strictMode'] as bool),
    );
  }
}
