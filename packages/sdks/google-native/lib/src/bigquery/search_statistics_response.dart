...
class SearchStatisticsResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'indexUnusedReasons': pulumi.Input.encodeList<IndexUnusedReasonResponse, Map<String, dynamic>>(indexUnusedReasons, (value) => value.toMap()),
  ...
  factory SearchStatisticsResponse.fromMap(Map<String, dynamic> map) {
    return SearchStatisticsResponse(
      indexUnusedReasons: pulumi.Input.decodeList<IndexUnusedReasonResponse>(map['indexUnusedReasons'], (value) => IndexUnusedReasonResponse.fromMap((value as Map).cast<String, dynamic>())),
