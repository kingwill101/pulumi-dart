...
class JobConfigurationExtract {
  ...
  factory JobConfigurationExtract.fromMap(Map<String, dynamic> map) {
    return JobConfigurationExtract(
      ...
      destinationFormat: (() { final guardedValue = map['destinationFormat']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      destinationUris: (() { final guardedValue = map['destinationUris']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      ...
      printHeader: (() { final guardedValue = map['printHeader']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      sourceModel: (() { final guardedValue = map['sourceModel']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ModelReference.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
