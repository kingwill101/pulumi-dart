...
class DataMaskingStatisticsResponse {
  ...
  DataMaskingStatisticsResponse({required this.dataMaskingApplied});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'dataMaskingApplied': dataMaskingApplied};
  }

  factory DataMaskingStatisticsResponse.fromMap(Map<String, dynamic> map) {
    return DataMaskingStatisticsResponse(
      dataMaskingApplied: pulumi.Input.fromValue(
        map['dataMaskingApplied'] as bool,
      ),
    );
  }
}
