...
class SparkOptionsResponse {
  ...
  factory SparkOptionsResponse.fromMap(Map<String, dynamic> map) {
    return SparkOptionsResponse(
      ...
      jarUris: pulumi.Input.fromValue((map['jarUris'] as List).cast<String>()),
      mainClass: pulumi.Input.fromValue(map['mainClass'] as String),
      mainFileUri: pulumi.Input.fromValue(map['mainFileUri'] as String),
      properties: pulumi.Input.fromValue((map['properties'] as Map).cast<String, String>()),
      pyFileUris: pulumi.Input.fromValue((map['pyFileUris'] as List).cast<String>()),
