...
class QueryParameterTypeResponse {
  ...
  factory QueryParameterTypeResponse.fromMap(Map<String, dynamic> map) {
    return QueryParameterTypeResponse(
      arrayType: (QueryParameterTypeResponse.fromMap((map['arrayType'] as Map).cast<String, dynamic>())).input(),
      structTypes: (pulumi.Input.decodeList<QueryParameterTypeStructTypesItemResponse>(map['structTypes'], (value) => QueryParameterTypeStructTypesItemResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
