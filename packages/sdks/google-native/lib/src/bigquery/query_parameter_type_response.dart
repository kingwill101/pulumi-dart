...
class QueryParameterTypeResponse {
  ...
  final pulumi.Input<List<QueryParameterTypeStructTypesItemResponse>>
  structTypes;
    ...
    return <String, dynamic>{
      'arrayType':
          pulumi.Input.mapInputValue<
            QueryParameterTypeResponse,
            Map<String, dynamic>
          >(arrayType, (value) => value.toMap()),
      'structTypes':
          pulumi.Input.mapInputValue<
            List<QueryParameterTypeStructTypesItemResponse>,
