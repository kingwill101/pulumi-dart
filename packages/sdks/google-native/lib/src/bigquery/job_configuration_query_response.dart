...
class JobConfigurationQueryResponse {
  ...
  final pulumi.Input<EncryptionConfigurationResponse>
  ...
  final pulumi.Input<List<UserDefinedFunctionResourceResponse>>
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'clustering':
          pulumi.Input.mapInputValue<ClusteringResponse, Map<String, dynamic>>(
            clustering,
            (value) => value.toMap(),
          ),
      'connectionProperties':
          pulumi.Input.mapInputValue<
            List<ConnectionPropertyResponse>,
      ...
      'defaultDataset':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(defaultDataset, (value) => value.toMap()),
      'destinationEncryptionConfiguration':
          pulumi.Input.mapInputValue<
      ...
      'userDefinedFunctionResources':
          pulumi.Input.mapInputValue<
            List<UserDefinedFunctionResourceResponse>,
            List<Map<String, dynamic>>
          >(
            userDefinedFunctionResources,
            (value) =>
  ...
  factory JobConfigurationQueryResponse.fromMap(Map<String, dynamic> map) {
    return JobConfigurationQueryResponse(
      allowLargeResults: pulumi.Input.fromValue(
        map['allowLargeResults'] as bool,
      ),
      clustering: pulumi.Input.fromValue(
        ClusteringResponse.fromMap(
          (map['clustering']! as Map).cast<String, dynamic>(),
        ),
      ),
      connectionProperties: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ConnectionPropertyResponse>(
      ...
      maximumBillingTier: pulumi.Input.fromValue(
        map['maximumBillingTier'] as int,
      ),
      maximumBytesBilled: pulumi.Input.fromValue(
      ...
      queryParameters: pulumi.Input.fromValue(
      ...
      rangePartitioning: pulumi.Input.fromValue(
        RangePartitioningResponse.fromMap(
          (map['rangePartitioning']! as Map).cast<String, dynamic>(),
        ),
      ),
      schemaUpdateOptions: pulumi.Input.fromValue(
        (map['schemaUpdateOptions'] as List).cast<String>(),
      ),
      tableDefinitions: pulumi.Input.fromValue(
        (map['tableDefinitions'] as Map).cast<String, String>(),
      ),
      timePartitioning: pulumi.Input.fromValue(
        TimePartitioningResponse.fromMap(
      ...
      userDefinedFunctionResources: pulumi.Input.fromValue(
