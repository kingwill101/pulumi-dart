...
class JobConfigurationQueryResponse {
  ...
  factory JobConfigurationQueryResponse.fromMap(Map<String, dynamic> map) {
    return JobConfigurationQueryResponse(
      allowLargeResults: (map['allowLargeResults'] as bool).input(),
      clustering: (ClusteringResponse.fromMap((map['clustering'] as Map).cast<String, dynamic>())).input(),
      connectionProperties: (pulumi.Input.decodeList<ConnectionPropertyResponse>(map['connectionProperties'], (value) => ConnectionPropertyResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      continuous: (map['continuous'] as bool).input(),
      createDisposition: (map['createDisposition'] as String).input(),
      createSession: (map['createSession'] as bool).input(),
      defaultDataset: (DatasetReferenceResponse.fromMap((map['defaultDataset'] as Map).cast<String, dynamic>())).input(),
      destinationEncryptionConfiguration: (EncryptionConfigurationResponse.fromMap((map['destinationEncryptionConfiguration'] as Map).cast<String, dynamic>())).input(),
      destinationTable: (TableReferenceResponse.fromMap((map['destinationTable'] as Map).cast<String, dynamic>())).input(),
      flattenResults: (map['flattenResults'] as bool).input(),
      maximumBillingTier: (map['maximumBillingTier'] as int).input(),
      maximumBytesBilled: (map['maximumBytesBilled'] as String).input(),
      parameterMode: (map['parameterMode'] as String).input(),
      preserveNulls: (map['preserveNulls'] as bool).input(),
      priority: (map['priority'] as String).input(),
      query: (map['query'] as String).input(),
      queryParameters: (pulumi.Input.decodeList<QueryParameterResponse>(map['queryParameters'], (value) => QueryParameterResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      rangePartitioning: (RangePartitioningResponse.fromMap((map['rangePartitioning'] as Map).cast<String, dynamic>())).input(),
      schemaUpdateOptions: ((map['schemaUpdateOptions'] as List).cast<String>()).input(),
      tableDefinitions: ((map['tableDefinitions'] as Map).cast<String, String>()).input(),
      timePartitioning: (TimePartitioningResponse.fromMap((map['timePartitioning'] as Map).cast<String, dynamic>())).input(),
      useLegacySql: (map['useLegacySql'] as bool).input(),
      useQueryCache: (map['useQueryCache'] as bool).input(),
      userDefinedFunctionResources: (pulumi.Input.decodeList<UserDefinedFunctionResourceResponse>(map['userDefinedFunctionResources'], (value) => UserDefinedFunctionResourceResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
