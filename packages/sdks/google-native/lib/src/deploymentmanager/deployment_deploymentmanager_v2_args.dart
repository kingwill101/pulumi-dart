...
class DeploymentDeploymentmanagerV2Args {
  ...
  const DeploymentDeploymentmanagerV2Args({
    this.createPolicy,
    this.description,
    this.id,
    this.labels,
  ...
  factory DeploymentDeploymentmanagerV2Args.fromMap(Map<String, dynamic> map) {
    return DeploymentDeploymentmanagerV2Args(
      ...
      labels: (() { final guardedValue = map['labels']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DeploymentLabelEntryDeploymentmanagerV2>(guardedValue, (value) => DeploymentLabelEntryDeploymentmanagerV2.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      target: (() { final guardedValue = map['target']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TargetConfigurationDeploymentmanagerV2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
