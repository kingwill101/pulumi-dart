...
class DeploymentDeploymentmanagerV2Args {
  ...
  DeploymentDeploymentmanagerV2Args({
    ...
    pulumi.Output<List<DeploymentLabelEntryDeploymentmanagerV2>>? labels,
    pulumi.Output<String>? name,
    pulumi.Output<bool>? preview,
    pulumi.Output<String>? project,
    pulumi.Output<TargetConfigurationDeploymentmanagerV2>? target,
  }) :
      createPolicy = pulumi.Input.asOptionalInput<String>(createPolicy),
      description = pulumi.Input.asOptionalInput<String>(description),
      id = pulumi.Input.asOptionalInput<String>(id),
      labels = pulumi.Input.asOptionalInput<List<DeploymentLabelEntryDeploymentmanagerV2>>(labels),
      name = pulumi.Input.asOptionalInput<String>(name),
      preview = pulumi.Input.asOptionalInput<bool>(preview),
      project = pulumi.Input.asOptionalInput<String>(project),
      target = pulumi.Input.asOptionalInput<TargetConfigurationDeploymentmanagerV2>(target);
  ...
  factory DeploymentDeploymentmanagerV2Args.fromMap(Map<String, dynamic> map) {
    return DeploymentDeploymentmanagerV2Args(
      ...
      labels: map['labels'] == null ? null : pulumi.Output.create<List<DeploymentLabelEntryDeploymentmanagerV2>>(pulumi.Input.decodeList<DeploymentLabelEntryDeploymentmanagerV2>(map['labels'], (value) => DeploymentLabelEntryDeploymentmanagerV2.fromMap((value as Map).cast<String, dynamic>()))),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      preview: map['preview'] == null ? null : pulumi.Output.create<bool>(map['preview'] as bool),
      project: map['project'] == null ? null : pulumi.Output.create<String>(map['project'] as String),
      target: map['target'] == null ? null : pulumi.Output.create<TargetConfigurationDeploymentmanagerV2>(TargetConfigurationDeploymentmanagerV2.fromMap((map['target'] as Map).cast<String, dynamic>())),
    );
  }
}
