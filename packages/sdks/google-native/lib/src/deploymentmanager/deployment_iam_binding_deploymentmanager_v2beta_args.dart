...
/// {@template pulumi_deploymentmanager_v2beta_deployment_iam_binding_deploymentmanager_v2beta_args_doc}
/// The set of arguments for DeploymentIamBinding.
/// {@endtemplate}
/// {@macro pulumi_deploymentmanager_v2beta_deployment_iam_binding_deploymentmanager_v2beta_args_doc}
class DeploymentIamBindingDeploymentmanagerV2betaArgs {
  ...
  /// Creates a new [DeploymentIamBindingDeploymentmanagerV2betaArgs].
  ...
  const DeploymentIamBindingDeploymentmanagerV2betaArgs({
    this.condition,
  ...
  factory DeploymentIamBindingDeploymentmanagerV2betaArgs.fromMap(Map<String, dynamic> map) {
    return DeploymentIamBindingDeploymentmanagerV2betaArgs(
