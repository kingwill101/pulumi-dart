...
class ExprDeploymentmanagerV2 {
  ...
  /// Creates a new [ExprDeploymentmanagerV2].
  ...
  factory ExprDeploymentmanagerV2.fromMap(Map<String, dynamic> map) {
    return ExprDeploymentmanagerV2(
