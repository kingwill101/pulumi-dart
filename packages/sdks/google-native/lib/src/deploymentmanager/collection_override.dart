...
class CollectionOverride {
  ...
  factory CollectionOverride.fromMap(Map<String, dynamic> map) {
    return CollectionOverride(
      ...
      methodMap: (() { final guardedValue = map['methodMap']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MethodMap.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
