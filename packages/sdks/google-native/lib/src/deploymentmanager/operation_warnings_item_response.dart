...
class OperationWarningsItemResponse {
  ...
  factory OperationWarningsItemResponse.fromMap(Map<String, dynamic> map) {
    return OperationWarningsItemResponse(
      ...
      data: pulumi.Input.fromValue(pulumi.Input.decodeList<OperationWarningsItemDataItemResponse>(map['data']!, (value) => OperationWarningsItemDataItemResponse.fromMap((value as Map).cast<String, dynamic>()))),
