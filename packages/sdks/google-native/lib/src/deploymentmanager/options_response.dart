  ...
  factory OptionsResponse.fromMap(Map<String, dynamic> map) {
    return OptionsResponse(
      asyncOptions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<AsyncOptionsResponse>(
          map['asyncOptions']!,
      ...
      inputMappings: pulumi.Input.fromValue(
        pulumi.Input.decodeList<InputMappingResponse>(
          map['inputMappings']!,
      ...
      validationOptions: pulumi.Input.fromValue(
        ValidationOptionsResponse.fromMap(
