...
class OptionsResponse {
  ...
  factory OptionsResponse.fromMap(Map<String, dynamic> map) {
    return OptionsResponse(
      asyncOptions: (pulumi.Input.decodeList<AsyncOptionsResponse>(map['asyncOptions'], (value) => AsyncOptionsResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      inputMappings: (pulumi.Input.decodeList<InputMappingResponse>(map['inputMappings'], (value) => InputMappingResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      nameProperty: (map['nameProperty'] as String).input(),
      validationOptions: (ValidationOptionsResponse.fromMap((map['validationOptions'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
