...
class DeploymentUpdateResponseDeploymentmanagerV2 {
  ...
  final pulumi.Input<
    List<DeploymentUpdateLabelEntryResponseDeploymentmanagerV2>
  >
  labels;
  ...
  factory DeploymentUpdateResponseDeploymentmanagerV2.fromMap(
    ...
    return DeploymentUpdateResponseDeploymentmanagerV2(
      ...
      labels: pulumi.Input.fromValue(
        ...
        >(
          map['labels']!,
          (value) =>
              DeploymentUpdateLabelEntryResponseDeploymentmanagerV2.fromMap(
