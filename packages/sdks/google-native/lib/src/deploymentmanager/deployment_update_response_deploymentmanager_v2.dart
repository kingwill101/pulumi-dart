...
class DeploymentUpdateResponseDeploymentmanagerV2 {
  ...
  factory DeploymentUpdateResponseDeploymentmanagerV2.fromMap(Map<String, dynamic> map) {
    return DeploymentUpdateResponseDeploymentmanagerV2(
      ...
      labels: (pulumi.Input.decodeList<DeploymentUpdateLabelEntryResponseDeploymentmanagerV2>(map['labels'], (value) => DeploymentUpdateLabelEntryResponseDeploymentmanagerV2.fromMap((value as Map).cast<String, dynamic>()))).input(),
