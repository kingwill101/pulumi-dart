...
class TargetConfigurationResponseDeploymentmanagerV2 {
  ...
  factory TargetConfigurationResponseDeploymentmanagerV2.fromMap(Map<String, dynamic> map) {
    return TargetConfigurationResponseDeploymentmanagerV2(
      config: (ConfigFileResponseDeploymentmanagerV2.fromMap((map['config'] as Map).cast<String, dynamic>())).input(),
      imports: (pulumi.Input.decodeList<ImportFileResponseDeploymentmanagerV2>(map['imports'], (value) => ImportFileResponseDeploymentmanagerV2.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
