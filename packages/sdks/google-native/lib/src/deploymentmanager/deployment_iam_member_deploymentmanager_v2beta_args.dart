...
/// {@template pulumi_deploymentmanager_v2beta_deployment_iam_member_deploymentmanager_v2beta_args_doc}
/// The set of arguments for DeploymentIamMember.
/// {@endtemplate}
/// {@macro pulumi_deploymentmanager_v2beta_deployment_iam_member_deploymentmanager_v2beta_args_doc}
class DeploymentIamMemberDeploymentmanagerV2betaArgs {
  ...
  /// Creates a new [DeploymentIamMemberDeploymentmanagerV2betaArgs].
  ...
  const DeploymentIamMemberDeploymentmanagerV2betaArgs({
    this.condition,
  ...
  factory DeploymentIamMemberDeploymentmanagerV2betaArgs.fromMap(Map<String, dynamic> map) {
    return DeploymentIamMemberDeploymentmanagerV2betaArgs(
