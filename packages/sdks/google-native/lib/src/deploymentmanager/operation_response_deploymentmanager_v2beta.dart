...
class OperationResponseDeploymentmanagerV2beta {
  ...
  final pulumi.Input<List<OperationWarningsItemResponseDeploymentmanagerV2beta>>
  warnings;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'warnings':
          pulumi.Input.mapInputValue<
            List<OperationWarningsItemResponseDeploymentmanagerV2beta>,
  ...
  factory OperationResponseDeploymentmanagerV2beta.fromMap(
    ...
    return OperationResponseDeploymentmanagerV2beta(
      ...
      error: pulumi.Input.fromValue(
        OperationErrorResponseDeploymentmanagerV2beta.fromMap(
      ...
      instancesBulkInsertOperationMetadata: pulumi.Input.fromValue(
        InstancesBulkInsertOperationMetadataResponseDeploymentmanagerV2beta.fromMap(
      ...
      setCommonInstanceMetadataOperationMetadata: pulumi.Input.fromValue(
        SetCommonInstanceMetadataOperationMetadataResponseDeploymentmanagerV2beta.fromMap(
