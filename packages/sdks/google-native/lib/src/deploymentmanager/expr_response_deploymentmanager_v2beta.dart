...
class ExprResponseDeploymentmanagerV2beta {
  ...
  /// Creates a new [ExprResponseDeploymentmanagerV2beta].
  ...
  const ExprResponseDeploymentmanagerV2beta({
  ...
  factory ExprResponseDeploymentmanagerV2beta.fromMap(Map<String, dynamic> map) {
    return ExprResponseDeploymentmanagerV2beta(
