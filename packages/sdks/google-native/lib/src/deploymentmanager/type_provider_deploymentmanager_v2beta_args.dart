...
class TypeProviderDeploymentmanagerV2betaArgs {
  ...
  /// [project] Optional.
  const TypeProviderDeploymentmanagerV2betaArgs({
  ...
  factory TypeProviderDeploymentmanagerV2betaArgs.fromMap(Map<String, dynamic> map) {
    return TypeProviderDeploymentmanagerV2betaArgs(
      collectionOverrides: (() { final guardedValue = map['collectionOverrides']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<CollectionOverrideDeploymentmanagerV2beta>(guardedValue, (value) => CollectionOverrideDeploymentmanagerV2beta.fromMap((value as Map).cast<String, dynamic>()))); })(),
      credential: (() { final guardedValue = map['credential']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CredentialDeploymentmanagerV2beta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      labels: (() { final guardedValue = map['labels']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<TypeProviderLabelEntryDeploymentmanagerV2beta>(guardedValue, (value) => TypeProviderLabelEntryDeploymentmanagerV2beta.fromMap((value as Map).cast<String, dynamic>()))); })(),
