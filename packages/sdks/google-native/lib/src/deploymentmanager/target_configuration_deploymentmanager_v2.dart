...
class TargetConfigurationDeploymentmanagerV2 {
  ...
  const TargetConfigurationDeploymentmanagerV2({
    this.config,
    this.imports,
  });
  ...
  factory TargetConfigurationDeploymentmanagerV2.fromMap(Map<String, dynamic> map) {
    return TargetConfigurationDeploymentmanagerV2(
      config: (() { final guardedValue = map['config']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConfigFileDeploymentmanagerV2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      imports: (() { final guardedValue = map['imports']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ImportFileDeploymentmanagerV2>(guardedValue, (value) => ImportFileDeploymentmanagerV2.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
