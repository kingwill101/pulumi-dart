...
class CredentialDeploymentmanagerV2beta {
  ...
  factory CredentialDeploymentmanagerV2beta.fromMap(Map<String, dynamic> map) {
    return CredentialDeploymentmanagerV2beta(
      basicAuth: (() { final guardedValue = map['basicAuth']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BasicAuthDeploymentmanagerV2beta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      serviceAccount: (() { final guardedValue = map['serviceAccount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServiceAccountDeploymentmanagerV2beta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
