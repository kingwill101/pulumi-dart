...
class PollingOptionsResponseDeploymentmanagerV2beta {
  ...
  factory PollingOptionsResponseDeploymentmanagerV2beta.fromMap(Map<String, dynamic> map) {
    return PollingOptionsResponseDeploymentmanagerV2beta(
      diagnostics: (pulumi.Input.decodeList<DiagnosticResponseDeploymentmanagerV2beta>(map['diagnostics'], (value) => DiagnosticResponseDeploymentmanagerV2beta.fromMap((value as Map).cast<String, dynamic>()))).input(),
