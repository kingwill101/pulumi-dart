...
class OperationResponse {
  ...
  factory OperationResponse.fromMap(Map<String, dynamic> map) {
    return OperationResponse(
      ...
      error: (OperationErrorResponse.fromMap((map['error'] as Map).cast<String, dynamic>())).input(),
      ...
      instancesBulkInsertOperationMetadata: (InstancesBulkInsertOperationMetadataResponse.fromMap((map['instancesBulkInsertOperationMetadata'] as Map).cast<String, dynamic>())).input(),
      ...
      setCommonInstanceMetadataOperationMetadata: (SetCommonInstanceMetadataOperationMetadataResponse.fromMap((map['setCommonInstanceMetadataOperationMetadata'] as Map).cast<String, dynamic>())).input(),
      ...
      warnings: (pulumi.Input.decodeList<OperationWarningsItemResponse>(map['warnings'], (value) => OperationWarningsItemResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
