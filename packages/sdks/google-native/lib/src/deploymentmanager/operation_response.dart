...
class OperationResponse {
  ...
  final pulumi.Input<InstancesBulkInsertOperationMetadataResponse>
  ...
  final pulumi.Input<SetCommonInstanceMetadataOperationMetadataResponse>
    ...
    return <String, dynamic>{
      ...
      'instancesBulkInsertOperationMetadata':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(instancesBulkInsertOperationMetadata, (value) => value.toMap()),
      'kind': kind,
      'name': name,
      ...
      'warnings':
          pulumi.Input.mapInputValue<
            List<OperationWarningsItemResponse>,
  ...
  factory OperationResponse.fromMap(Map<String, dynamic> map) {
    return OperationResponse(
      ...
      error: pulumi.Input.fromValue(
        OperationErrorResponse.fromMap(
          (map['error']! as Map).cast<String, dynamic>(),
        ),
      ),
      httpErrorMessage: pulumi.Input.fromValue(
        map['httpErrorMessage'] as String,
      ),
      httpErrorStatusCode: pulumi.Input.fromValue(
        map['httpErrorStatusCode'] as int,
      ),
      insertTime: pulumi.Input.fromValue(map['insertTime'] as String),
      instancesBulkInsertOperationMetadata: pulumi.Input.fromValue(
        InstancesBulkInsertOperationMetadataResponse.fromMap(
          (map['instancesBulkInsertOperationMetadata']! as Map)
              .cast<String, dynamic>(),
        ),
      ),
      kind: pulumi.Input.fromValue(map['kind'] as String),
      name: pulumi.Input.fromValue(map['name'] as String),
      operationGroupId: pulumi.Input.fromValue(
        map['operationGroupId'] as String,
      ),
      ...
      setCommonInstanceMetadataOperationMetadata: pulumi.Input.fromValue(
        SetCommonInstanceMetadataOperationMetadataResponse.fromMap(
      ...
      warnings: pulumi.Input.fromValue(
        pulumi.Input.decodeList<OperationWarningsItemResponse>(
          map['warnings']!,
          (value) => OperationWarningsItemResponse.fromMap(
