...
class OperationResponse {
  ...
  final pulumi.Input<OperationErrorResponse> error;
  ...
  final pulumi.Input<InstancesBulkInsertOperationMetadataResponse> instancesBulkInsertOperationMetadata;
  ...
  final pulumi.Input<SetCommonInstanceMetadataOperationMetadataResponse> setCommonInstanceMetadataOperationMetadata;
  ...
  final pulumi.Input<List<OperationWarningsItemResponse>> warnings;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'endTime': endTime,
      'error': pulumi.Input.mapInputValue<OperationErrorResponse, Map<String, dynamic>>(error, (value) => value.toMap()),
      'httpErrorMessage': httpErrorMessage,
      'httpErrorStatusCode': httpErrorStatusCode,
      'insertTime': insertTime,
      'instancesBulkInsertOperationMetadata': pulumi.Input.mapInputValue<InstancesBulkInsertOperationMetadataResponse, Map<String, dynamic>>(instancesBulkInsertOperationMetadata, (value) => value.toMap()),
      'kind': kind,
      'name': name,
      ...
      'region': region,
      'selfLink': selfLink,
      'setCommonInstanceMetadataOperationMetadata': pulumi.Input.mapInputValue<SetCommonInstanceMetadataOperationMetadataResponse, Map<String, dynamic>>(setCommonInstanceMetadataOperationMetadata, (value) => value.toMap()),
      'startTime': startTime,
      'status': status,
      ...
      'user': user,
      'warnings': pulumi.Input.mapInputValue<List<OperationWarningsItemResponse>, List<Map<String, dynamic>>>(warnings, (value) => pulumi.Input.encodeList<OperationWarningsItemResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'zone': zone,
    };
  }
  ...
  factory OperationResponse.fromMap(Map<String, dynamic> map) {
    return OperationResponse(
      ...
      error: pulumi.Input.fromValue(OperationErrorResponse.fromMap((map['error']! as Map).cast<String, dynamic>())),
      ...
      instancesBulkInsertOperationMetadata: pulumi.Input.fromValue(InstancesBulkInsertOperationMetadataResponse.fromMap((map['instancesBulkInsertOperationMetadata']! as Map).cast<String, dynamic>())),
      ...
      setCommonInstanceMetadataOperationMetadata: pulumi.Input.fromValue(SetCommonInstanceMetadataOperationMetadataResponse.fromMap((map['setCommonInstanceMetadataOperationMetadata']! as Map).cast<String, dynamic>())),
      ...
      warnings: pulumi.Input.fromValue(pulumi.Input.decodeList<OperationWarningsItemResponse>(map['warnings']!, (value) => OperationWarningsItemResponse.fromMap((value as Map).cast<String, dynamic>()))),
