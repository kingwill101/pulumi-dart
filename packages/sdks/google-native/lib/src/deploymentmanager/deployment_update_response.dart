...
class DeploymentUpdateResponse {
  ...
  factory DeploymentUpdateResponse.fromMap(Map<String, dynamic> map) {
    return DeploymentUpdateResponse(
      credential: (CredentialResponse.fromMap((map['credential'] as Map).cast<String, dynamic>())).input(),
      description: (map['description'] as String).input(),
      labels: (pulumi.Input.decodeList<DeploymentUpdateLabelEntryResponse>(map['labels'], (value) => DeploymentUpdateLabelEntryResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
