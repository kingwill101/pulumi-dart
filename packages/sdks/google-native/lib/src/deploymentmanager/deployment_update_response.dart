...
class DeploymentUpdateResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'credential':
          pulumi.Input.mapInputValue<CredentialResponse, Map<String, dynamic>>(
            credential,
            (value) => value.toMap(),
          ),
      ...
      'labels':
          pulumi.Input.mapInputValue<
            List<DeploymentUpdateLabelEntryResponse>,
  ...
  factory DeploymentUpdateResponse.fromMap(Map<String, dynamic> map) {
    return DeploymentUpdateResponse(
      credential: pulumi.Input.fromValue(
        CredentialResponse.fromMap(
          (map['credential']! as Map).cast<String, dynamic>(),
        ),
      ),
      description: pulumi.Input.fromValue(map['description'] as String),
      labels: pulumi.Input.fromValue(
        pulumi.Input.decodeList<DeploymentUpdateLabelEntryResponse>(
          map['labels']!,
