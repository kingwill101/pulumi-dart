...
class TypeProvider extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<CollectionOverrideResponse>> collectionOverrides;
  ...
  TypeProvider(
    ...
    this.collectionOverrides = registerOutput<List<CollectionOverrideResponse>>('collectionOverrides');
    this.credential = registerOutput<CredentialResponse>('credential');
    this.customCertificateAuthorityRoots = registerOutput<List<String>>('customCertificateAuthorityRoots');
    this.description = registerOutput<String>('description');
    this.descriptorUrl = registerOutput<String>('descriptorUrl');
    this.insertTime = registerOutput<String>('insertTime');
    this.labels = registerOutput<List<TypeProviderLabelEntryResponse>>('labels');
    this.name = registerOutput<String>('name');
    this.operation = registerOutput<OperationResponse>('operation');
