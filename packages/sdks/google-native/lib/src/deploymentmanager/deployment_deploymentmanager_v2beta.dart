...
import 'deployment_deploymentmanager_v2beta_args.dart';
...
class DeploymentDeploymentmanagerV2beta extends pulumi.CustomResource {
  ...
  late final pulumi.Output<TargetConfigurationResponseDeploymentmanagerV2beta> target;
  ...
  late final pulumi.Output<DeploymentUpdateResponseDeploymentmanagerV2beta> update;
  /// Update timestamp in RFC3339 text format.
  late final pulumi.Output<String> updateTime;

  /// Creates a new [DeploymentDeploymentmanagerV2beta].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [DeploymentDeploymentmanagerV2beta]. {@macro pulumi_deploymentmanager_v2beta_deployment_deploymentmanager_v2beta_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  DeploymentDeploymentmanagerV2beta(
    String name, {
    DeploymentDeploymentmanagerV2betaArgs? args,
    ...
    target = registerOutput<TargetConfigurationResponseDeploymentmanagerV2beta>('target', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return TargetConfigurationResponseDeploymentmanagerV2beta.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    update = registerOutput<DeploymentUpdateResponseDeploymentmanagerV2beta>('update', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return DeploymentUpdateResponseDeploymentmanagerV2beta.fromMap((guardedValue as Map).cast<String, dynamic>()); });
