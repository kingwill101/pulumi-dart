...
class OperationResponseDeploymentmanagerV2 {
  ...
  final pulumi.Input<OperationErrorResponseDeploymentmanagerV2> error;
  ...
  final pulumi.Input<InstancesBulkInsertOperationMetadataResponseDeploymentmanagerV2> instancesBulkInsertOperationMetadata;
  ...
  final pulumi.Input<SetCommonInstanceMetadataOperationMetadataResponseDeploymentmanagerV2> setCommonInstanceMetadataOperationMetadata;
  ...
  final pulumi.Input<List<OperationWarningsItemResponseDeploymentmanagerV2>> warnings;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'endTime': endTime,
      'error': pulumi.Input.mapInputValue<OperationErrorResponseDeploymentmanagerV2, Map<String, dynamic>>(error, (value) => value.toMap()),
      'httpErrorMessage': httpErrorMessage,
      'httpErrorStatusCode': httpErrorStatusCode,
      'insertTime': insertTime,
      'instancesBulkInsertOperationMetadata': pulumi.Input.mapInputValue<InstancesBulkInsertOperationMetadataResponseDeploymentmanagerV2, Map<String, dynamic>>(instancesBulkInsertOperationMetadata, (value) => value.toMap()),
      'kind': kind,
      'name': name,
      ...
      'region': region,
      'selfLink': selfLink,
      'setCommonInstanceMetadataOperationMetadata': pulumi.Input.mapInputValue<SetCommonInstanceMetadataOperationMetadataResponseDeploymentmanagerV2, Map<String, dynamic>>(setCommonInstanceMetadataOperationMetadata, (value) => value.toMap()),
      'startTime': startTime,
      'status': status,
      ...
      'user': user,
      'warnings': pulumi.Input.mapInputValue<List<OperationWarningsItemResponseDeploymentmanagerV2>, List<Map<String, dynamic>>>(warnings, (value) => pulumi.Input.encodeList<OperationWarningsItemResponseDeploymentmanagerV2, Map<String, dynamic>>(value, (value) => value.toMap())),
      'zone': zone,
    };
  }
  ...
  factory OperationResponseDeploymentmanagerV2.fromMap(Map<String, dynamic> map) {
    return OperationResponseDeploymentmanagerV2(
      ...
      error: pulumi.Input.fromValue(OperationErrorResponseDeploymentmanagerV2.fromMap((map['error']! as Map).cast<String, dynamic>())),
      ...
      instancesBulkInsertOperationMetadata: pulumi.Input.fromValue(InstancesBulkInsertOperationMetadataResponseDeploymentmanagerV2.fromMap((map['instancesBulkInsertOperationMetadata']! as Map).cast<String, dynamic>())),
      ...
      setCommonInstanceMetadataOperationMetadata: pulumi.Input.fromValue(SetCommonInstanceMetadataOperationMetadataResponseDeploymentmanagerV2.fromMap((map['setCommonInstanceMetadataOperationMetadata']! as Map).cast<String, dynamic>())),
      ...
      warnings: pulumi.Input.fromValue(pulumi.Input.decodeList<OperationWarningsItemResponseDeploymentmanagerV2>(map['warnings']!, (value) => OperationWarningsItemResponseDeploymentmanagerV2.fromMap((value as Map).cast<String, dynamic>()))),
