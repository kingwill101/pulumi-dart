...
class OperationResponseDeploymentmanagerV2 {
  ...
  final pulumi.Input<List<OperationWarningsItemResponseDeploymentmanagerV2>>
  warnings;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'warnings':
          pulumi.Input.mapInputValue<
            List<OperationWarningsItemResponseDeploymentmanagerV2>,
  ...
  factory OperationResponseDeploymentmanagerV2.fromMap(
    ...
    return OperationResponseDeploymentmanagerV2(
      ...
      error: pulumi.Input.fromValue(
        OperationErrorResponseDeploymentmanagerV2.fromMap(
      ...
      warnings: pulumi.Input.fromValue(
        pulumi
            .Input.decodeList<OperationWarningsItemResponseDeploymentmanagerV2>(
          map['warnings']!,
