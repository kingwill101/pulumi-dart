...
class DeploymentUpdateResponseDeploymentmanagerV2beta {
  ...
  factory DeploymentUpdateResponseDeploymentmanagerV2beta.fromMap(Map<String, dynamic> map) {
    return DeploymentUpdateResponseDeploymentmanagerV2beta(
      ...
      labels: (pulumi.Input.decodeList<DeploymentUpdateLabelEntryResponseDeploymentmanagerV2beta>(map['labels'], (value) => DeploymentUpdateLabelEntryResponseDeploymentmanagerV2beta.fromMap((value as Map).cast<String, dynamic>()))).input(),
