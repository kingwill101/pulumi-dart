...
class DeploymentUpdateResponseDeploymentmanagerV2beta {
  ...
  final pulumi.Input<List<DeploymentUpdateLabelEntryResponseDeploymentmanagerV2beta>> labels;
  ...
  const DeploymentUpdateResponseDeploymentmanagerV2beta({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'labels': pulumi.Input.mapInputValue<List<DeploymentUpdateLabelEntryResponseDeploymentmanagerV2beta>, List<Map<String, dynamic>>>(labels, (value) => pulumi.Input.encodeList<DeploymentUpdateLabelEntryResponseDeploymentmanagerV2beta, Map<String, dynamic>>(value, (value) => value.toMap())),
      'manifest': manifest,
    };
  }

  factory DeploymentUpdateResponseDeploymentmanagerV2beta.fromMap(Map<String, dynamic> map) {
    return DeploymentUpdateResponseDeploymentmanagerV2beta(
      description: pulumi.Input.fromValue(map['description'] as String),
      labels: pulumi.Input.fromValue(pulumi.Input.decodeList<DeploymentUpdateLabelEntryResponseDeploymentmanagerV2beta>(map['labels']!, (value) => DeploymentUpdateLabelEntryResponseDeploymentmanagerV2beta.fromMap((value as Map).cast<String, dynamic>()))),
