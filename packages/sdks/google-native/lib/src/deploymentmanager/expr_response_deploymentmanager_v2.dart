...
class ExprResponseDeploymentmanagerV2 {
  ...
  /// Creates a new [ExprResponseDeploymentmanagerV2].
  ...
  const ExprResponseDeploymentmanagerV2({
  ...
  factory ExprResponseDeploymentmanagerV2.fromMap(Map<String, dynamic> map) {
    return ExprResponseDeploymentmanagerV2(
