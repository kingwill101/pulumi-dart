...
/// {@template pulumi_deploymentmanager_v2_deployment_iam_member_deploymentmanager_v2_args_doc}
/// The set of arguments for DeploymentIamMember.
/// {@endtemplate}
/// {@macro pulumi_deploymentmanager_v2_deployment_iam_member_deploymentmanager_v2_args_doc}
class DeploymentIamMemberDeploymentmanagerV2Args {
  ...
  /// Creates a new [DeploymentIamMemberDeploymentmanagerV2Args].
  ...
  const DeploymentIamMemberDeploymentmanagerV2Args({
    this.condition,
  ...
  factory DeploymentIamMemberDeploymentmanagerV2Args.fromMap(Map<String, dynamic> map) {
    return DeploymentIamMemberDeploymentmanagerV2Args(
