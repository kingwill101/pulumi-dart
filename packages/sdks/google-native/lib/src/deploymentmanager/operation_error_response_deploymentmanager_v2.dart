...
class OperationErrorResponseDeploymentmanagerV2 {
  ...
  factory OperationErrorResponseDeploymentmanagerV2.fromMap(Map<String, dynamic> map) {
    return OperationErrorResponseDeploymentmanagerV2(
      errors: (pulumi.Input.decodeList<OperationErrorErrorsItemResponseDeploymentmanagerV2>(map['errors'], (value) => OperationErrorErrorsItemResponseDeploymentmanagerV2.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
