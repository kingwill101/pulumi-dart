...
/// {@template pulumi_deploymentmanager_alpha_deployment_iam_member_args_doc}
/// The set of arguments for DeploymentIamMember.
/// {@endtemplate}
/// {@macro pulumi_deploymentmanager_alpha_deployment_iam_member_args_doc}
class DeploymentIamMemberArgs {
  ...
  /// Creates a new [DeploymentIamMemberArgs].
  ...
  factory DeploymentIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return DeploymentIamMemberArgs(
