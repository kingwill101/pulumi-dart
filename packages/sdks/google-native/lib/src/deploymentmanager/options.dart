...
class Options {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'asyncOptions': ?asyncOptions == null ? null : pulumi.Input.encodeList<AsyncOptions, Map<String, dynamic>>(asyncOptions!, (value) => value.toMap()),
      'inputMappings': ?inputMappings == null ? null : pulumi.Input.encodeList<InputMapping, Map<String, dynamic>>(inputMappings!, (value) => value.toMap()),
  ...
  factory Options.fromMap(Map<String, dynamic> map) {
    return Options(
      asyncOptions: map['asyncOptions'] == null ? null : pulumi.Input.decodeList<AsyncOptions>(map['asyncOptions'], (value) => AsyncOptions.fromMap((value as Map).cast<String, dynamic>())),
      inputMappings: map['inputMappings'] == null ? null : pulumi.Input.decodeList<InputMapping>(map['inputMappings'], (value) => InputMapping.fromMap((value as Map).cast<String, dynamic>())),
      nameProperty: map['nameProperty'] == null ? null : map['nameProperty'] as String,
      validationOptions: map['validationOptions'] == null ? null : ValidationOptions.fromMap((map['validationOptions'] as Map).cast<String, dynamic>()),
    );
  }
}
