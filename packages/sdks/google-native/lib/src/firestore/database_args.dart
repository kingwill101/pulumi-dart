...
class DatabaseArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'appEngineIntegrationMode': ?pulumi.Input.mapOptionalInputValue<DatabaseAppEngineIntegrationMode, String>(appEngineIntegrationMode, (value) => value.wireValue),
      'concurrencyMode': ?pulumi.Input.mapOptionalInputValue<DatabaseConcurrencyMode, String>(concurrencyMode, (value) => value.wireValue),
      'databaseId': databaseId,
      'deleteProtectionState': ?pulumi.Input.mapOptionalInputValue<DatabaseDeleteProtectionState, String>(deleteProtectionState, (value) => value.wireValue),
      'etag': ?etag,
      'location': ?location,
      'name': ?name,
      'pointInTimeRecoveryEnablement': ?pulumi.Input.mapOptionalInputValue<DatabasePointInTimeRecoveryEnablement, String>(pointInTimeRecoveryEnablement, (value) => value.wireValue),
      'project': ?project,
  ...
  factory DatabaseArgs.fromMap(Map<String, dynamic> map) {
    return DatabaseArgs(
      appEngineIntegrationMode: (() { final guardedValue = map['appEngineIntegrationMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DatabaseAppEngineIntegrationMode.fromValue(guardedValue as String)); })(),
      concurrencyMode: (() { final guardedValue = map['concurrencyMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DatabaseConcurrencyMode.fromValue(guardedValue as String)); })(),
      databaseId: pulumi.Input.fromValue(map['databaseId'] as String),
      deleteProtectionState: (() { final guardedValue = map['deleteProtectionState']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DatabaseDeleteProtectionState.fromValue(guardedValue as String)); })(),
      etag: (() { final guardedValue = map['etag']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      location: (() { final guardedValue = map['location']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      pointInTimeRecoveryEnablement: (() { final guardedValue = map['pointInTimeRecoveryEnablement']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DatabasePointInTimeRecoveryEnablement.fromValue(guardedValue as String)); })(),
