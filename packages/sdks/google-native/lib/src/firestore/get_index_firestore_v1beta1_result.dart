...
class GetIndexFirestoreV1beta1Result {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'fields': pulumi.Input.encodeList<GoogleFirestoreAdminV1beta1IndexFieldResponse, Map<String, dynamic>>(fields, (value) => value.toMap()),
      'name': name,
      'state': state,
    };
  }
  ...
  factory GetIndexFirestoreV1beta1Result.fromMap(Map<String, dynamic> map) {
    return GetIndexFirestoreV1beta1Result(
      ...
      fields: pulumi.Input.decodeList<GoogleFirestoreAdminV1beta1IndexFieldResponse>(map['fields']!, (value) => GoogleFirestoreAdminV1beta1IndexFieldResponse.fromMap((value as Map).cast<String, dynamic>())),
