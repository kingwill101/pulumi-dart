...
class IndexFirestoreV1beta2 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<GoogleFirestoreAdminV1beta2IndexFieldResponse>> fields;
  ...
  IndexFirestoreV1beta2(
    ...
    this.fields = registerOutput<List<GoogleFirestoreAdminV1beta2IndexFieldResponse>>('fields');
