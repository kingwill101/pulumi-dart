...
class GoogleFirestoreAdminV1beta1IndexField {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'fieldPath': ?fieldPath,
      'mode': ?pulumi.Input.mapOptionalInputValue<GoogleFirestoreAdminV1beta1IndexFieldMode, String>(mode, (value) => value.wireValue),
    };
  }
  ...
  factory GoogleFirestoreAdminV1beta1IndexField.fromMap(Map<String, dynamic> map) {
    return GoogleFirestoreAdminV1beta1IndexField(
      ...
      mode: (() { final guardedValue = map['mode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleFirestoreAdminV1beta1IndexFieldMode.fromValue(guardedValue as String)); })(),
    );
  }
}
