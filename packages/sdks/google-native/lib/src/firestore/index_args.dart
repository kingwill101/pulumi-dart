...
class IndexArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'apiScope': ?pulumi.Input.mapOptionalInputValue<IndexApiScope, String>(apiScope, (value) => value.wireValue),
      'collectionGroupId': collectionGroupId,
      'databaseId': databaseId,
      'fields': ?pulumi.Input.mapOptionalInputValue<List<GoogleFirestoreAdminV1IndexField>, List<Map<String, dynamic>>>(fields, (value) => pulumi.Input.encodeList<GoogleFirestoreAdminV1IndexField, Map<String, dynamic>>(value, (value) => value.toMap())),
      'project': ?project,
      'queryScope': ?pulumi.Input.mapOptionalInputValue<IndexQueryScope, String>(queryScope, (value) => value.wireValue),
    };
  }

  factory IndexArgs.fromMap(Map<String, dynamic> map) {
    return IndexArgs(
      apiScope: (() { final guardedValue = map['apiScope']; if (guardedValue == null) return null; return pulumi.Input.fromValue(IndexApiScope.fromValue(guardedValue as String)); })(),
      ...
      fields: (() { final guardedValue = map['fields']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleFirestoreAdminV1IndexField>(guardedValue, (value) => GoogleFirestoreAdminV1IndexField.fromMap((value as Map).cast<String, dynamic>()))); })(),
      project: (() { final guardedValue = map['project']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      queryScope: (() { final guardedValue = map['queryScope']; if (guardedValue == null) return null; return pulumi.Input.fromValue(IndexQueryScope.fromValue(guardedValue as String)); })(),
    );
  }
}
