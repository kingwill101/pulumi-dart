...
class IndexArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'apiScope': ?pulumi.Input.mapOptionalInputValue<IndexApiScope, String>(apiScope, (value) => value.value),
      ...
      'project': ?project,
      'queryScope': ?pulumi.Input.mapOptionalInputValue<IndexQueryScope, String>(queryScope, (value) => value.value),
    };
  }
