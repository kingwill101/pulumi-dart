...
class AudioStreamResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'mapping': pulumi.Input.encodeList<AudioMappingResponse, Map<String, dynamic>>(mapping, (value) => value.toMap()),
  ...
  factory AudioStreamResponse.fromMap(Map<String, dynamic> map) {
    return AudioStreamResponse(
      ...
      mapping: pulumi.Input.decodeList<AudioMappingResponse>(map['mapping'], (value) => AudioMappingResponse.fromMap((value as Map).cast<String, dynamic>())),
