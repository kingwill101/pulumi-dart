...
class DeinterlaceResponse {
  ...
  DeinterlaceResponse({required this.bwdif, required this.yadif});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'bwdif':
          pulumi.Input.mapInputValue<BwdifConfigResponse, Map<String, dynamic>>(
            bwdif,
            (value) => value.toMap(),
          ),
      'yadif':
          pulumi.Input.mapInputValue<YadifConfigResponse, Map<String, dynamic>>(
            yadif,
            (value) => value.toMap(),
          ),
    };
  ...
  factory DeinterlaceResponse.fromMap(Map<String, dynamic> map) {
    return DeinterlaceResponse(
      bwdif: pulumi.Input.fromValue(
        BwdifConfigResponse.fromMap(
          (map['bwdif']! as Map).cast<String, dynamic>(),
        ),
      ),
      yadif: pulumi.Input.fromValue(
        YadifConfigResponse.fromMap(
