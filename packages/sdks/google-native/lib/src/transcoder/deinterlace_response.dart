...
class DeinterlaceResponse {
  ...
  factory DeinterlaceResponse.fromMap(Map<String, dynamic> map) {
    return DeinterlaceResponse(
      bwdif: (BwdifConfigResponse.fromMap((map['bwdif'] as Map).cast<String, dynamic>())).input(),
      yadif: (YadifConfigResponse.fromMap((map['yadif'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
