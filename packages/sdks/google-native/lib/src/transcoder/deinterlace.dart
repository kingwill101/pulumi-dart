...
class Deinterlace {
  ...
  factory Deinterlace.fromMap(Map<String, dynamic> map) {
    return Deinterlace(
      bwdif: (() { final guardedValue = map['bwdif']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BwdifConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      yadif: (() { final guardedValue = map['yadif']; if (guardedValue == null) return null; return pulumi.Input.fromValue(YadifConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
