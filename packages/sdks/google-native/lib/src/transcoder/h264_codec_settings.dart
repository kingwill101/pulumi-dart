...
class H264CodecSettings {
  ...
  factory H264CodecSettings.fromMap(Map<String, dynamic> map) {
    return H264CodecSettings(
      allowOpenGop: (() {
        final guardedValue = map['allowOpenGop'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      aqStrength: (() {
        final guardedValue = map['aqStrength'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as double);
      })(),
      bFrameCount: (() {
        final guardedValue = map['bFrameCount'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      bPyramid: (() {
        final guardedValue = map['bPyramid'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      bitrateBps: pulumi.Input.fromValue(map['bitrateBps'] as int),
      crfLevel: (() {
        final guardedValue = map['crfLevel'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      enableTwoPass: (() {
        final guardedValue = map['enableTwoPass'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      entropyCoder: (() {
        final guardedValue = map['entropyCoder'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      frameRate: pulumi.Input.fromValue(map['frameRate'] as double),
      gopDuration: (() {
        final guardedValue = map['gopDuration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      gopFrameCount: (() {
        final guardedValue = map['gopFrameCount'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      heightPixels: (() {
        final guardedValue = map['heightPixels'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      pixelFormat: (() {
        final guardedValue = map['pixelFormat'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      preset: (() {
        final guardedValue = map['preset'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      profile: (() {
      ...
      vbvFullnessBits: (() {
        final guardedValue = map['vbvFullnessBits'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      vbvSizeBits: (() {
        final guardedValue = map['vbvSizeBits'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      widthPixels: (() {
        final guardedValue = map['widthPixels'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
    );
