...
class H264CodecSettings {
  ...
  factory H264CodecSettings.fromMap(Map<String, dynamic> map) {
    return H264CodecSettings(
      allowOpenGop: (() { final guardedValue = map['allowOpenGop']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      aqStrength: (() { final guardedValue = map['aqStrength']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as double); })(),
      bFrameCount: (() { final guardedValue = map['bFrameCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      bPyramid: (() { final guardedValue = map['bPyramid']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      enableTwoPass: (() { final guardedValue = map['enableTwoPass']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      gopFrameCount: (() { final guardedValue = map['gopFrameCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      tune: (() { final guardedValue = map['tune']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
