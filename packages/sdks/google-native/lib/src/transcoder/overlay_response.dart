...
class OverlayResponse {
  ...
  factory OverlayResponse.fromMap(Map<String, dynamic> map) {
    return OverlayResponse(
      animations: pulumi.Input.fromValue(pulumi.Input.decodeList<AnimationResponse>(map['animations']!, (value) => AnimationResponse.fromMap((value as Map).cast<String, dynamic>()))),
      image: pulumi.Input.fromValue(ImageResponse.fromMap((map['image']! as Map).cast<String, dynamic>())),
    );
  }
}
