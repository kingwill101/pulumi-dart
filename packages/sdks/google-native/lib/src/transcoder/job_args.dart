...
class JobArgs {
  ...
  factory JobArgs.fromMap(Map<String, dynamic> map) {
    return JobArgs(
      batchModePriority: (() {
        final guardedValue = map['batchModePriority'];
      ...
      inputUri: (() {
        final guardedValue = map['inputUri'];
        if (guardedValue == null) return null;
      ...
      mode: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          JobMode.fromValue(guardedValue as String),
        );
      })(),
      name: (() {
      ...
      optimization: (() {
        final guardedValue = map['optimization'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          JobOptimization.fromValue(guardedValue as String),
        );
      })(),
      outputUri: (() {
      ...
      ttlAfterCompletionDays: (() {
        final guardedValue = map['ttlAfterCompletionDays'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
    );
