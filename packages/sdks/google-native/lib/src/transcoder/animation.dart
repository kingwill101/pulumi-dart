...
class Animation {
  ...
  factory Animation.fromMap(Map<String, dynamic> map) {
    return Animation(
      animationEnd: (() { final guardedValue = map['animationEnd']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AnimationEnd.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      animationFade: (() { final guardedValue = map['animationFade']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AnimationFade.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      animationStatic: (() { final guardedValue = map['animationStatic']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AnimationStatic.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
