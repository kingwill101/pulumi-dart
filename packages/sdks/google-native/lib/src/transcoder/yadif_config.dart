...
class YadifConfig {
  ...
  factory YadifConfig.fromMap(Map<String, dynamic> map) {
    return YadifConfig(
      deinterlaceAllFrames: map['deinterlaceAllFrames'] == null ? null : map['deinterlaceAllFrames'] as bool,
      disableSpatialInterlacing: map['disableSpatialInterlacing'] == null ? null : map['disableSpatialInterlacing'] as bool,
