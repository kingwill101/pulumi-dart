...
class Encryption {
  ...
  factory Encryption.fromMap(Map<String, dynamic> map) {
    return Encryption(
      ...
      drmSystems: pulumi.Input.fromValue(DrmSystems.fromMap((map['drmSystems']! as Map).cast<String, dynamic>())),
      id: pulumi.Input.fromValue(map['id'] as String),
      mpegCenc: (() { final guardedValue = map['mpegCenc']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MpegCommonEncryption.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      secretManagerKeySource: (() { final guardedValue = map['secretManagerKeySource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SecretManagerSource.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
