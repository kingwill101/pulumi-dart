...
class VideoStreamResponse {
  ...
  factory VideoStreamResponse.fromMap(Map<String, dynamic> map) {
    return VideoStreamResponse(
      h264: (H264CodecSettingsResponse.fromMap((map['h264'] as Map).cast<String, dynamic>())).input(),
      h265: (H265CodecSettingsResponse.fromMap((map['h265'] as Map).cast<String, dynamic>())).input(),
      vp9: (Vp9CodecSettingsResponse.fromMap((map['vp9'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
