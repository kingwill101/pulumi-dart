    ...
    return <String, dynamic>{
      ...
      'h265':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(h265, (value) => value.toMap()),
      'vp9':
          pulumi.Input.mapInputValue<
            Vp9CodecSettingsResponse,
            Map<String, dynamic>
          >(vp9, (value) => value.toMap()),
    };
  }

  factory VideoStreamResponse.fromMap(Map<String, dynamic> map) {
    return VideoStreamResponse(
      h264: pulumi.Input.fromValue(
        H264CodecSettingsResponse.fromMap(
          (map['h264']! as Map).cast<String, dynamic>(),
        ),
      ),
      h265: pulumi.Input.fromValue(
        H265CodecSettingsResponse.fromMap(
          (map['h265']! as Map).cast<String, dynamic>(),
        ),
      ),
      vp9: pulumi.Input.fromValue(
        Vp9CodecSettingsResponse.fromMap(
