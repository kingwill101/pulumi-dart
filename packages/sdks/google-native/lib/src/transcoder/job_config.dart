  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'adBreaks':
          ...
          >(
            adBreaks,
            (value) => pulumi.Input.encodeList<AdBreak, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
      'editList':
          ...
          >(
            editList,
            (value) => pulumi.Input.encodeList<EditAtom, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
      ...
      'inputs':
          ...
          >(
            inputs,
            (value) => pulumi.Input.encodeList<InputType, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
      'manifests':
          ...
          >(
            manifests,
            (value) => pulumi.Input.encodeList<Manifest, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
      'muxStreams':
          ...
          >(
            muxStreams,
            (value) => pulumi.Input.encodeList<MuxStream, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
      'output':
          ?pulumi.Input.mapOptionalInputValue<OutputType, Map<String, dynamic>>(
            output,
            (value) => value.toMap(),
          ),
      'overlays':
          ...
          >(
            overlays,
            (value) => pulumi.Input.encodeList<Overlay, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
  ...
  factory JobConfig.fromMap(Map<String, dynamic> map) {
    return JobConfig(
      adBreaks: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AdBreak>(
            guardedValue,
            (value) => AdBreak.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      editList: (() {
        final guardedValue = map['editList'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EditAtom>(
            guardedValue,
            (value) => EditAtom.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      elementaryStreams: (() {
      ...
      manifests: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<Manifest>(
            guardedValue,
            (value) => Manifest.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      muxStreams: (() {
      ...
      output: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          OutputType.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      overlays: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<Overlay>(
            guardedValue,
            (value) => Overlay.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      pubsubDestination: (() {
      ...
      spriteSheets: (() {
        final guardedValue = map['spriteSheets'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
