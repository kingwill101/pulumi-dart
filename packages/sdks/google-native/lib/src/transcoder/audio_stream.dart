...
class AudioStream {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'mapping': ?mapping == null ? null : pulumi.Input.encodeList<AudioMapping, Map<String, dynamic>>(mapping!, (value) => value.toMap()),
  ...
  factory AudioStream.fromMap(Map<String, dynamic> map) {
    return AudioStream(
      ...
      channelLayout: map['channelLayout'] == null ? null : (map['channelLayout'] as List).cast<String>(),
      ...
      mapping: map['mapping'] == null ? null : pulumi.Input.decodeList<AudioMapping>(map['mapping'], (value) => AudioMapping.fromMap((value as Map).cast<String, dynamic>())),
