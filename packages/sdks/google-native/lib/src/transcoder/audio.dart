...
class Audio {
  ...
  factory Audio.fromMap(Map<String, dynamic> map) {
    return Audio(
      highBoost: (() { final guardedValue = map['highBoost']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      lowBoost: (() { final guardedValue = map['lowBoost']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      lufs: (() { final guardedValue = map['lufs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as double); })(),
    );
  }
}
