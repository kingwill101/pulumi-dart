...
class AnimationFade {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'fadeType': pulumi.Input.mapInputValue<AnimationFadeFadeType, String>(
        fadeType,
  ...
  factory AnimationFade.fromMap(Map<String, dynamic> map) {
    return AnimationFade(
      ...
      fadeType: pulumi.Input.fromValue(
        AnimationFadeFadeType.fromValue(map['fadeType']! as String),
      ),
      startTimeOffset: (() {
