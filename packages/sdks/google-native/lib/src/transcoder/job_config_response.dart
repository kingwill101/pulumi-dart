...
class JobConfigResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'adBreaks': pulumi.Input.encodeList<AdBreakResponse, Map<String, dynamic>>(adBreaks, (value) => value.toMap()),
      'editList': pulumi.Input.encodeList<EditAtomResponse, Map<String, dynamic>>(editList, (value) => value.toMap()),
      'elementaryStreams': pulumi.Input.encodeList<ElementaryStreamResponse, Map<String, dynamic>>(elementaryStreams, (value) => value.toMap()),
      'encryptions': pulumi.Input.encodeList<EncryptionResponse, Map<String, dynamic>>(encryptions, (value) => value.toMap()),
      'inputs': pulumi.Input.encodeList<InputResponse, Map<String, dynamic>>(inputs, (value) => value.toMap()),
      'manifests': pulumi.Input.encodeList<ManifestResponse, Map<String, dynamic>>(manifests, (value) => value.toMap()),
      'muxStreams': pulumi.Input.encodeList<MuxStreamResponse, Map<String, dynamic>>(muxStreams, (value) => value.toMap()),
      'output': output.toMap(),
      'overlays': pulumi.Input.encodeList<OverlayResponse, Map<String, dynamic>>(overlays, (value) => value.toMap()),
      'pubsubDestination': pubsubDestination.toMap(),
      'spriteSheets': pulumi.Input.encodeList<SpriteSheetResponse, Map<String, dynamic>>(spriteSheets, (value) => value.toMap()),
    };
  }

  factory JobConfigResponse.fromMap(Map<String, dynamic> map) {
    return JobConfigResponse(
      adBreaks: pulumi.Input.decodeList<AdBreakResponse>(map['adBreaks'], (value) => AdBreakResponse.fromMap((value as Map).cast<String, dynamic>())),
      editList: pulumi.Input.decodeList<EditAtomResponse>(map['editList'], (value) => EditAtomResponse.fromMap((value as Map).cast<String, dynamic>())),
      elementaryStreams: pulumi.Input.decodeList<ElementaryStreamResponse>(map['elementaryStreams'], (value) => ElementaryStreamResponse.fromMap((value as Map).cast<String, dynamic>())),
      encryptions: pulumi.Input.decodeList<EncryptionResponse>(map['encryptions'], (value) => EncryptionResponse.fromMap((value as Map).cast<String, dynamic>())),
      inputs: pulumi.Input.decodeList<InputResponse>(map['inputs'], (value) => InputResponse.fromMap((value as Map).cast<String, dynamic>())),
      manifests: pulumi.Input.decodeList<ManifestResponse>(map['manifests'], (value) => ManifestResponse.fromMap((value as Map).cast<String, dynamic>())),
      muxStreams: pulumi.Input.decodeList<MuxStreamResponse>(map['muxStreams'], (value) => MuxStreamResponse.fromMap((value as Map).cast<String, dynamic>())),
      output: OutputResponse.fromMap((map['output'] as Map).cast<String, dynamic>()),
      overlays: pulumi.Input.decodeList<OverlayResponse>(map['overlays'], (value) => OverlayResponse.fromMap((value as Map).cast<String, dynamic>())),
      pubsubDestination: PubsubDestinationResponse.fromMap((map['pubsubDestination'] as Map).cast<String, dynamic>()),
      spriteSheets: pulumi.Input.decodeList<SpriteSheetResponse>(map['spriteSheets'], (value) => SpriteSheetResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
