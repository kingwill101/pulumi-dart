...
class EncryptionResponse {
  ...
  factory EncryptionResponse.fromMap(Map<String, dynamic> map) {
    return EncryptionResponse(
      aes128: ((map['aes128'] as Map).cast<String, dynamic>()).input(),
      drmSystems: (DrmSystemsResponse.fromMap((map['drmSystems'] as Map).cast<String, dynamic>())).input(),
      mpegCenc: (MpegCommonEncryptionResponse.fromMap((map['mpegCenc'] as Map).cast<String, dynamic>())).input(),
      sampleAes: ((map['sampleAes'] as Map).cast<String, dynamic>()).input(),
      secretManagerKeySource: (SecretManagerSourceResponse.fromMap((map['secretManagerKeySource'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
