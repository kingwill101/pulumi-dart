...
class Manifest {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'dash':
          ?pulumi.Input.mapOptionalInputValue<DashConfig, Map<String, dynamic>>(
            dash,
            (value) => value.toMap(),
          ),
      'fileName': ?fileName,
      'muxStreams': muxStreams,
      'type': pulumi.Input.mapInputValue<ManifestType, String>(
        type,
  ...
  factory Manifest.fromMap(Map<String, dynamic> map) {
    return Manifest(
      dash: (() {
        final guardedValue = map['dash'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DashConfig.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      fileName: (() {
      ...
      type: pulumi.Input.fromValue(
        ManifestType.fromValue(map['type']! as String),
      ),
    );
  }
}
