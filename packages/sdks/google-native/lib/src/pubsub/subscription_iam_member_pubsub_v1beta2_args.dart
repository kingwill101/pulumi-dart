...
/// {@template pulumi_pubsub_v1beta2_subscription_iam_member_pubsub_v1beta2_args_doc}
/// The set of arguments for SubscriptionIamMember.
/// {@endtemplate}
/// {@macro pulumi_pubsub_v1beta2_subscription_iam_member_pubsub_v1beta2_args_doc}
class SubscriptionIamMemberPubsubV1beta2Args {
  ...
  /// Creates a new [SubscriptionIamMemberPubsubV1beta2Args].
  ...
  const SubscriptionIamMemberPubsubV1beta2Args({
    this.condition,
  ...
  factory SubscriptionIamMemberPubsubV1beta2Args.fromMap(Map<String, dynamic> map) {
    return SubscriptionIamMemberPubsubV1beta2Args(
