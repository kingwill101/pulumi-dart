...
class SchemaSettings {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'encoding': ?pulumi.Input.mapOptionalInputValue<SchemaSettingsEncoding, String>(encoding, (value) => value.wireValue),
  ...
  factory SchemaSettings.fromMap(Map<String, dynamic> map) {
    return SchemaSettings(
      encoding: (() { final guardedValue = map['encoding']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SchemaSettingsEncoding.fromValue(guardedValue as String)); })(),
