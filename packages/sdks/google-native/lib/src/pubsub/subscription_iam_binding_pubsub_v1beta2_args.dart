...
/// {@template pulumi_pubsub_v1beta2_subscription_iam_binding_pubsub_v1beta2_args_doc}
/// The set of arguments for SubscriptionIamBinding.
/// {@endtemplate}
/// {@macro pulumi_pubsub_v1beta2_subscription_iam_binding_pubsub_v1beta2_args_doc}
class SubscriptionIamBindingPubsubV1beta2Args {
  ...
  /// Creates a new [SubscriptionIamBindingPubsubV1beta2Args].
  ...
  const SubscriptionIamBindingPubsubV1beta2Args({
    this.condition,
  ...
  factory SubscriptionIamBindingPubsubV1beta2Args.fromMap(Map<String, dynamic> map) {
    return SubscriptionIamBindingPubsubV1beta2Args(
