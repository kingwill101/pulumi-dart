...
class MessageStoragePolicy {
  ...
  factory MessageStoragePolicy.fromMap(Map<String, dynamic> map) {
    return MessageStoragePolicy(
      allowedPersistenceRegions: (() { final guardedValue = map['allowedPersistenceRegions']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
