...
/// {@template pulumi_pubsub_v1beta2_topic_iam_binding_pubsub_v1beta2_args_doc}
/// The set of arguments for TopicIamBinding.
/// {@endtemplate}
/// {@macro pulumi_pubsub_v1beta2_topic_iam_binding_pubsub_v1beta2_args_doc}
class TopicIamBindingPubsubV1beta2Args {
  ...
  /// Creates a new [TopicIamBindingPubsubV1beta2Args].
  ...
  const TopicIamBindingPubsubV1beta2Args({
    this.condition,
  ...
  factory TopicIamBindingPubsubV1beta2Args.fromMap(Map<String, dynamic> map) {
    return TopicIamBindingPubsubV1beta2Args(
