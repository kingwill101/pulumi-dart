...
class Subscription extends pulumi.CustomResource {
  ...
  Subscription(
    ...
    this.bigqueryConfig = registerOutput<BigQueryConfigResponse>('bigqueryConfig');
    this.cloudStorageConfig = registerOutput<CloudStorageConfigResponse>('cloudStorageConfig');
    this.deadLetterPolicy = registerOutput<DeadLetterPolicyResponse>('deadLetterPolicy');
    ...
    this.expirationPolicy = registerOutput<ExpirationPolicyResponse>('expirationPolicy');
    ...
    this.topicMessageRetentionDuration = registerOutput<String>('topicMessageRetentionDuration');
  }
}
