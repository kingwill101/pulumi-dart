...
class SubscriptionArgs {
  ...
  factory SubscriptionArgs.fromMap(Map<String, dynamic> map) {
    return SubscriptionArgs(
      ...
      bigqueryConfig: (() { final guardedValue = map['bigqueryConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BigQueryConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      cloudStorageConfig: (() { final guardedValue = map['cloudStorageConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CloudStorageConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      deadLetterPolicy: (() { final guardedValue = map['deadLetterPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DeadLetterPolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      detached: (() { final guardedValue = map['detached']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      expirationPolicy: (() { final guardedValue = map['expirationPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ExpirationPolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      pushConfig: (() { final guardedValue = map['pushConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PushConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
