...
class PushConfigResponsePubsubV1beta2 {
  ...
  const PushConfigResponsePubsubV1beta2({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'oidcToken': pulumi.Input.mapInputValue<OidcTokenResponsePubsubV1beta2, Map<String, dynamic>>(oidcToken, (value) => value.toMap()),
  ...
  factory PushConfigResponsePubsubV1beta2.fromMap(Map<String, dynamic> map) {
    return PushConfigResponsePubsubV1beta2(
      ...
      oidcToken: pulumi.Input.fromValue(OidcTokenResponsePubsubV1beta2.fromMap((map['oidcToken']! as Map).cast<String, dynamic>())),
