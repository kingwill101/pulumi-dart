...
class CloudStorageConfig {
  ...
  factory CloudStorageConfig.fromMap(Map<String, dynamic> map) {
    return CloudStorageConfig(
      avroConfig: (() { final guardedValue = map['avroConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AvroConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      maxBytes: (() { final guardedValue = map['maxBytes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      textConfig: (() { final guardedValue = map['textConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, dynamic>()); })(),
    );
  }
}
