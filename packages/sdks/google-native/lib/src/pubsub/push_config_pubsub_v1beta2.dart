...
import 'oidc_token_pubsub_v1beta2.dart';

/// Configuration for a push delivery endpoint.
class PushConfigPubsubV1beta2 {
  ...
  final pulumi.Input<OidcTokenPubsubV1beta2>? oidcToken;
  /// A URL locating the endpoint to which messages should be pushed. For example, a Webhook endpoint might use "https://example.com/push".
  final pulumi.Input<String>? pushEndpoint;

  /// Creates a new [PushConfigPubsubV1beta2].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'oidcToken': ?pulumi.Input.mapOptionalInputValue<OidcTokenPubsubV1beta2, Map<String, dynamic>>(oidcToken, (value) => value.toMap()),
  ...
  factory PushConfigPubsubV1beta2.fromMap(Map<String, dynamic> map) {
    return PushConfigPubsubV1beta2(
      ...
      oidcToken: (() { final guardedValue = map['oidcToken']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OidcTokenPubsubV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
