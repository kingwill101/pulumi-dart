...
class PushConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'noWrapper':
          ?pulumi.Input.mapOptionalInputValue<NoWrapper, Map<String, dynamic>>(
            noWrapper,
            (value) => value.toMap(),
          ),
      'oidcToken':
  ...
  factory PushConfig.fromMap(Map<String, dynamic> map) {
    return PushConfig(
      ...
      noWrapper: (() {
        final guardedValue = map['noWrapper'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          NoWrapper.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      oidcToken: (() {
      ...
      pubsubWrapper: (() {
        final guardedValue = map['pubsubWrapper'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
