...
class CloudStorageConfigResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'avroConfig':
          pulumi.Input.mapInputValue<AvroConfigResponse, Map<String, dynamic>>(
            avroConfig,
            (value) => value.toMap(),
          ),
      'bucket': bucket,
  ...
  factory CloudStorageConfigResponse.fromMap(Map<String, dynamic> map) {
    return CloudStorageConfigResponse(
      avroConfig: pulumi.Input.fromValue(
        AvroConfigResponse.fromMap(
      ...
      textConfig: pulumi.Input.fromValue(
