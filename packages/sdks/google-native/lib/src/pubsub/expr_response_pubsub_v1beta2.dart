...
class ExprResponsePubsubV1beta2 {
  ...
  /// Creates a new [ExprResponsePubsubV1beta2].
  ...
  const ExprResponsePubsubV1beta2({
  ...
  factory ExprResponsePubsubV1beta2.fromMap(Map<String, dynamic> map) {
    return ExprResponsePubsubV1beta2(
