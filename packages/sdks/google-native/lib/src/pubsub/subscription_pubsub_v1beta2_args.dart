...
class SubscriptionPubsubV1beta2Args {
  ...
  factory SubscriptionPubsubV1beta2Args.fromMap(Map<String, dynamic> map) {
    return SubscriptionPubsubV1beta2Args(
      ...
      pushConfig: (() { final guardedValue = map['pushConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PushConfigPubsubV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
