...
class GoogleCloudBillingBudgetsV1beta1Filter {
  ...
  final pulumi.Input<GoogleCloudBillingBudgetsV1beta1FilterCalendarPeriod>? calendarPeriod;
  ...
  final pulumi.Input<GoogleCloudBillingBudgetsV1beta1FilterCreditTypesTreatment>? creditTypesTreatment;
  /// Optional. Specifies to track usage from any start date (required) to any end date (optional). This time period is static, it does not recur.
  final pulumi.Input<GoogleCloudBillingBudgetsV1beta1CustomPeriod>? customPeriod;
  ...
  /// Creates a new [GoogleCloudBillingBudgetsV1beta1Filter].
  /// [calendarPeriod] Optional. Specifies to track usage for recurring calendar period. For example, assume that CalendarPeriod.QUARTER is set. The budget will track usage from April 1 to June 30, when the current calendar month is April, May, June. After that, it will track usage from July 1 to September 30 when the current calendar month is July, August, September, so on.
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'calendarPeriod': ?pulumi.Input.mapOptionalInputValue<GoogleCloudBillingBudgetsV1beta1FilterCalendarPeriod, String>(calendarPeriod, (value) => value.wireValue),
      'creditTypes': ?creditTypes,
      'creditTypesTreatment': ?pulumi.Input.mapOptionalInputValue<GoogleCloudBillingBudgetsV1beta1FilterCreditTypesTreatment, String>(creditTypesTreatment, (value) => value.wireValue),
      'customPeriod': ?pulumi.Input.mapOptionalInputValue<GoogleCloudBillingBudgetsV1beta1CustomPeriod, Map<String, dynamic>>(customPeriod, (value) => value.toMap()),
      'labels': ?labels,
      'projects': ?projects,
  ...
  factory GoogleCloudBillingBudgetsV1beta1Filter.fromMap(Map<String, dynamic> map) {
    return GoogleCloudBillingBudgetsV1beta1Filter(
      calendarPeriod: (() { final guardedValue = map['calendarPeriod']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudBillingBudgetsV1beta1FilterCalendarPeriod.fromValue(guardedValue as String)); })(),
      ...
      creditTypesTreatment: (() { final guardedValue = map['creditTypesTreatment']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudBillingBudgetsV1beta1FilterCreditTypesTreatment.fromValue(guardedValue as String)); })(),
      customPeriod: (() { final guardedValue = map['customPeriod']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudBillingBudgetsV1beta1CustomPeriod.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
