...
class GoogleCloudBillingBudgetsV1beta1Filter {
  ...
  final GoogleCloudBillingBudgetsV1beta1FilterCreditTypesTreatment? creditTypesTreatment;
  ...
  factory GoogleCloudBillingBudgetsV1beta1Filter.fromMap(Map<String, dynamic> map) {
    return GoogleCloudBillingBudgetsV1beta1Filter(
      calendarPeriod: map['calendarPeriod'] == null ? null : GoogleCloudBillingBudgetsV1beta1FilterCalendarPeriod.fromValue(map['calendarPeriod'] as String),
      creditTypes: map['creditTypes'] == null ? null : (map['creditTypes'] as List).cast<String>(),
      creditTypesTreatment: map['creditTypesTreatment'] == null ? null : GoogleCloudBillingBudgetsV1beta1FilterCreditTypesTreatment.fromValue(map['creditTypesTreatment'] as String),
      customPeriod: map['customPeriod'] == null ? null : GoogleCloudBillingBudgetsV1beta1CustomPeriod.fromMap((map['customPeriod'] as Map).cast<String, dynamic>()),
