...
class GoogleCloudBillingBudgetsV1beta1Filter {
  ...
  final pulumi.Input<GoogleCloudBillingBudgetsV1beta1FilterCalendarPeriod>?
  calendarPeriod;
  ...
  final pulumi.Input<GoogleCloudBillingBudgetsV1beta1CustomPeriod>?
  customPeriod;
    ...
    return <String, dynamic>{
      ...
      'creditTypesTreatment':
          ?pulumi.Input.mapOptionalInputValue<
            GoogleCloudBillingBudgetsV1beta1FilterCreditTypesTreatment,
            String
          >(creditTypesTreatment, (value) => value.wireValue),
      'customPeriod':
          ?pulumi.Input.mapOptionalInputValue<
  ...
  factory GoogleCloudBillingBudgetsV1beta1Filter.fromMap(
    ...
    return GoogleCloudBillingBudgetsV1beta1Filter(
      ...
      creditTypes: (() {
        final guardedValue = map['creditTypes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      creditTypesTreatment: (() {
        final guardedValue = map['creditTypesTreatment'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GoogleCloudBillingBudgetsV1beta1FilterCreditTypesTreatment.fromValue(
            guardedValue as String,
          ),
        );
      })(),
      ...
      resourceAncestors: (() {
        final guardedValue = map['resourceAncestors'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      services: (() {
      ...
      subaccounts: (() {
        final guardedValue = map['subaccounts'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
    );
