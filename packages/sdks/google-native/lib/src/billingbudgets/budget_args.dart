    ...
    return <String, dynamic>{
      ...
      'notificationsRule':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(notificationsRule, (value) => value.toMap()),
      'ownershipScope':
  ...
  factory BudgetArgs.fromMap(Map<String, dynamic> map) {
    return BudgetArgs(
      amount: pulumi.Input.fromValue(
        GoogleCloudBillingBudgetsV1BudgetAmount.fromMap(
      ...
      budgetFilter: (() {
        ...
        return pulumi.Input.fromValue(
          GoogleCloudBillingBudgetsV1Filter.fromMap(
      ...
      notificationsRule: (() {
        final guardedValue = map['notificationsRule'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GoogleCloudBillingBudgetsV1NotificationsRule.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ownershipScope: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          BudgetOwnershipScope.fromValue(guardedValue as String),
        );
      })(),
      thresholdRules: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GoogleCloudBillingBudgetsV1ThresholdRule>(
            guardedValue,
            (value) => GoogleCloudBillingBudgetsV1ThresholdRule.fromMap(
