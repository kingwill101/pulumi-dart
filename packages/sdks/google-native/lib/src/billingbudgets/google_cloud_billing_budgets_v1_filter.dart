...
class GoogleCloudBillingBudgetsV1Filter {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'calendarPeriod': ?pulumi.Input.mapOptionalInputValue<GoogleCloudBillingBudgetsV1FilterCalendarPeriod, String>(calendarPeriod, (value) => value.value),
      'creditTypes': ?creditTypes,
      'creditTypesTreatment': ?pulumi.Input.mapOptionalInputValue<GoogleCloudBillingBudgetsV1FilterCreditTypesTreatment, String>(creditTypesTreatment, (value) => value.value),
