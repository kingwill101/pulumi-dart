...
class GoogleCloudBillingBudgetsV1Filter {
  ...
  final pulumi.Input<GoogleCloudBillingBudgetsV1FilterCalendarPeriod>? calendarPeriod;
  ...
  final pulumi.Input<GoogleCloudBillingBudgetsV1FilterCreditTypesTreatment>? creditTypesTreatment;
  /// Optional. Specifies to track usage from any start date (required) to any end date (optional). This time period is static, it does not recur.
  final pulumi.Input<GoogleCloudBillingBudgetsV1CustomPeriod>? customPeriod;
  ...
  const GoogleCloudBillingBudgetsV1Filter({
    this.calendarPeriod,
    this.creditTypes,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'calendarPeriod': ?pulumi.Input.mapOptionalInputValue<GoogleCloudBillingBudgetsV1FilterCalendarPeriod, String>(calendarPeriod, (value) => value.wireValue),
      'creditTypes': ?creditTypes,
      'creditTypesTreatment': ?pulumi.Input.mapOptionalInputValue<GoogleCloudBillingBudgetsV1FilterCreditTypesTreatment, String>(creditTypesTreatment, (value) => value.wireValue),
      'customPeriod': ?pulumi.Input.mapOptionalInputValue<GoogleCloudBillingBudgetsV1CustomPeriod, Map<String, dynamic>>(customPeriod, (value) => value.toMap()),
      'labels': ?labels,
      'projects': ?projects,
  ...
  factory GoogleCloudBillingBudgetsV1Filter.fromMap(Map<String, dynamic> map) {
    return GoogleCloudBillingBudgetsV1Filter(
      calendarPeriod: (() { final guardedValue = map['calendarPeriod']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudBillingBudgetsV1FilterCalendarPeriod.fromValue(guardedValue as String)); })(),
      ...
      creditTypesTreatment: (() { final guardedValue = map['creditTypesTreatment']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudBillingBudgetsV1FilterCreditTypesTreatment.fromValue(guardedValue as String)); })(),
      customPeriod: (() { final guardedValue = map['customPeriod']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudBillingBudgetsV1CustomPeriod.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
