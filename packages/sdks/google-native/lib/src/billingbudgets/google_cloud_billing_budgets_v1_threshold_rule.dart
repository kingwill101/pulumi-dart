...
class GoogleCloudBillingBudgetsV1ThresholdRule {
  ...
  const GoogleCloudBillingBudgetsV1ThresholdRule({
    this.spendBasis,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'spendBasis': ?pulumi.Input.mapOptionalInputValue<GoogleCloudBillingBudgetsV1ThresholdRuleSpendBasis, String>(spendBasis, (value) => value.wireValue),
  ...
  factory GoogleCloudBillingBudgetsV1ThresholdRule.fromMap(Map<String, dynamic> map) {
    return GoogleCloudBillingBudgetsV1ThresholdRule(
      spendBasis: (() { final guardedValue = map['spendBasis']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudBillingBudgetsV1ThresholdRuleSpendBasis.fromValue(guardedValue as String)); })(),
