...
class GoogleCloudBillingBudgetsV1beta1CustomPeriod {
  ...
  const GoogleCloudBillingBudgetsV1beta1CustomPeriod({
    this.endDate,
  ...
  factory GoogleCloudBillingBudgetsV1beta1CustomPeriod.fromMap(Map<String, dynamic> map) {
    return GoogleCloudBillingBudgetsV1beta1CustomPeriod(
      endDate: (() { final guardedValue = map['endDate']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleTypeDateBillingbudgetsV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      startDate: pulumi.Input.fromValue(GoogleTypeDateBillingbudgetsV1beta1.fromMap((map['startDate']! as Map).cast<String, dynamic>())),
    );
  }
}
