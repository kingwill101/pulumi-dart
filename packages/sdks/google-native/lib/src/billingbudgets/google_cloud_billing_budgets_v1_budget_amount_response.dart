...
class GoogleCloudBillingBudgetsV1BudgetAmountResponse {
  ...
  final pulumi.Input<GoogleTypeMoneyResponse> specifiedAmount;
  ...
  const GoogleCloudBillingBudgetsV1BudgetAmountResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'specifiedAmount': pulumi.Input.mapInputValue<GoogleTypeMoneyResponse, Map<String, dynamic>>(specifiedAmount, (value) => value.toMap()),
    };
  }
  ...
  factory GoogleCloudBillingBudgetsV1BudgetAmountResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudBillingBudgetsV1BudgetAmountResponse(
      ...
      specifiedAmount: pulumi.Input.fromValue(GoogleTypeMoneyResponse.fromMap((map['specifiedAmount']! as Map).cast<String, dynamic>())),
    );
  }
}
