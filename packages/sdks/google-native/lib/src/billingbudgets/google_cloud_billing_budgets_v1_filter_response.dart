...
import 'google_cloud_billing_budgets_v1_custom_period_response.dart';

/// A filter for a budget, limiting the scope of the cost to calculate.
class GoogleCloudBillingBudgetsV1FilterResponse {
  ...
  final pulumi.Input<GoogleCloudBillingBudgetsV1CustomPeriodResponse> customPeriod;
  ...
  /// Creates a new [GoogleCloudBillingBudgetsV1FilterResponse].
  /// [calendarPeriod] Optional. Specifies to track usage for recurring calendar period. For example, assume that CalendarPeriod.QUARTER is set. The budget tracks usage from April 1 to June 30, when the current calendar month is April, May, June. After that, it tracks usage from July 1 to September 30 when the current calendar month is July, August, September, so on.
  ...
  const GoogleCloudBillingBudgetsV1FilterResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'customPeriod': pulumi.Input.mapInputValue<GoogleCloudBillingBudgetsV1CustomPeriodResponse, Map<String, dynamic>>(customPeriod, (value) => value.toMap()),
      'labels': labels,
      'projects': projects,
  ...
  factory GoogleCloudBillingBudgetsV1FilterResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudBillingBudgetsV1FilterResponse(
      calendarPeriod: pulumi.Input.fromValue(map['calendarPeriod'] as String),
      creditTypes: pulumi.Input.fromValue((map['creditTypes'] as List).cast<String>()),
      creditTypesTreatment: pulumi.Input.fromValue(map['creditTypesTreatment'] as String),
      customPeriod: pulumi.Input.fromValue(GoogleCloudBillingBudgetsV1CustomPeriodResponse.fromMap((map['customPeriod']! as Map).cast<String, dynamic>())),
      labels: pulumi.Input.fromValue((map['labels'] as Map).cast<String, String>()),
      projects: pulumi.Input.fromValue((map['projects'] as List).cast<String>()),
      resourceAncestors: pulumi.Input.fromValue((map['resourceAncestors'] as List).cast<String>()),
      services: pulumi.Input.fromValue((map['services'] as List).cast<String>()),
      subaccounts: pulumi.Input.fromValue((map['subaccounts'] as List).cast<String>()),
    );
  }
}
