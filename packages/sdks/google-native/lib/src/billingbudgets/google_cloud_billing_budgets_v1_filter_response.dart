...
class GoogleCloudBillingBudgetsV1FilterResponse {
  ...
  final pulumi.Input<GoogleCloudBillingBudgetsV1CustomPeriodResponse>
  customPeriod;
  ...
  factory GoogleCloudBillingBudgetsV1FilterResponse.fromMap(
    ...
    return GoogleCloudBillingBudgetsV1FilterResponse(
      ...
      creditTypes: pulumi.Input.fromValue(
        (map['creditTypes'] as List).cast<String>(),
      ),
      creditTypesTreatment: pulumi.Input.fromValue(
        map['creditTypesTreatment'] as String,
      ),
      customPeriod: pulumi.Input.fromValue(
        GoogleCloudBillingBudgetsV1CustomPeriodResponse.fromMap(
