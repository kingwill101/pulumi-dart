...
class GoogleCloudBillingBudgetsV1beta1FilterResponse {
  ...
  const GoogleCloudBillingBudgetsV1beta1FilterResponse({
  ...
  factory GoogleCloudBillingBudgetsV1beta1FilterResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudBillingBudgetsV1beta1FilterResponse(
      ...
      customPeriod: pulumi.Input.fromValue(GoogleCloudBillingBudgetsV1beta1CustomPeriodResponse.fromMap((map['customPeriod']! as Map).cast<String, dynamic>())),
