...
class GoogleCloudBillingBudgetsV1CustomPeriod {
  ...
  const GoogleCloudBillingBudgetsV1CustomPeriod({
    this.endDate,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'endDate': ?pulumi.Input.mapOptionalInputValue<GoogleTypeDate, Map<String, dynamic>>(endDate, (value) => value.toMap()),
      'startDate': pulumi.Input.mapInputValue<GoogleTypeDate, Map<String, dynamic>>(startDate, (value) => value.toMap()),
    };
  }
  ...
  factory GoogleCloudBillingBudgetsV1CustomPeriod.fromMap(Map<String, dynamic> map) {
    return GoogleCloudBillingBudgetsV1CustomPeriod(
      endDate: (() { final guardedValue = map['endDate']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleTypeDate.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      startDate: pulumi.Input.fromValue(GoogleTypeDate.fromMap((map['startDate']! as Map).cast<String, dynamic>())),
    );
  }
}
