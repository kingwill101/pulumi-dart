    ...
    return <String, dynamic>{
      ...
      'ownershipScope':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(ownershipScope, (value) => value.wireValue),
      'thresholdRules':
          ?pulumi.Input.mapOptionalInputValue<
    ...
    return BudgetBillingbudgetsV1beta1Args(
      allUpdatesRule: (() {
        ...
        return pulumi.Input.fromValue(
          GoogleCloudBillingBudgetsV1beta1AllUpdatesRule.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      amount: pulumi.Input.fromValue(
        GoogleCloudBillingBudgetsV1beta1BudgetAmount.fromMap(
      ...
      budgetFilter: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GoogleCloudBillingBudgetsV1beta1Filter.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      ownershipScope: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          BudgetOwnershipScopeBillingbudgetsV1beta1.fromValue(
      ...
      thresholdRules: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<GoogleCloudBillingBudgetsV1beta1ThresholdRule>(
            guardedValue,
            (value) => GoogleCloudBillingBudgetsV1beta1ThresholdRule.fromMap(
