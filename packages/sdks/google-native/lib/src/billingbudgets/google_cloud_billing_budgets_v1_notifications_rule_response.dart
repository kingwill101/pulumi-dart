...
class GoogleCloudBillingBudgetsV1NotificationsRuleResponse {
  ...
  factory GoogleCloudBillingBudgetsV1NotificationsRuleResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudBillingBudgetsV1NotificationsRuleResponse(
      ...
      monitoringNotificationChannels: (map['monitoringNotificationChannels'] as List).cast<String>(),
