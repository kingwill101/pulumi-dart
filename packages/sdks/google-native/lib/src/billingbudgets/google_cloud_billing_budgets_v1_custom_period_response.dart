...
class GoogleCloudBillingBudgetsV1CustomPeriodResponse {
  ...
  factory GoogleCloudBillingBudgetsV1CustomPeriodResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudBillingBudgetsV1CustomPeriodResponse(
      endDate: pulumi.Input.fromValue(GoogleTypeDateResponse.fromMap((map['endDate']! as Map).cast<String, dynamic>())),
      startDate: pulumi.Input.fromValue(GoogleTypeDateResponse.fromMap((map['startDate']! as Map).cast<String, dynamic>())),
    );
  }
}
