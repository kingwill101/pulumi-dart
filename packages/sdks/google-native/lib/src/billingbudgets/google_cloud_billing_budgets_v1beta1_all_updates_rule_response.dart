...
class GoogleCloudBillingBudgetsV1beta1AllUpdatesRuleResponse {
  ...
  const GoogleCloudBillingBudgetsV1beta1AllUpdatesRuleResponse({
  ...
  factory GoogleCloudBillingBudgetsV1beta1AllUpdatesRuleResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudBillingBudgetsV1beta1AllUpdatesRuleResponse(
      disableDefaultIamRecipients: pulumi.Input.fromValue(map['disableDefaultIamRecipients'] as bool),
      enableProjectLevelRecipients: pulumi.Input.fromValue(map['enableProjectLevelRecipients'] as bool),
      monitoringNotificationChannels: pulumi.Input.fromValue((map['monitoringNotificationChannels'] as List).cast<String>()),
