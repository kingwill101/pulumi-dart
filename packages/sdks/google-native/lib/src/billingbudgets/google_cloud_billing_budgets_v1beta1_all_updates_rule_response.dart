...
class GoogleCloudBillingBudgetsV1beta1AllUpdatesRuleResponse {
  ...
  factory GoogleCloudBillingBudgetsV1beta1AllUpdatesRuleResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudBillingBudgetsV1beta1AllUpdatesRuleResponse(
      disableDefaultIamRecipients: (map['disableDefaultIamRecipients'] as bool).input(),
      enableProjectLevelRecipients: (map['enableProjectLevelRecipients'] as bool).input(),
      monitoringNotificationChannels: ((map['monitoringNotificationChannels'] as List).cast<String>()).input(),
