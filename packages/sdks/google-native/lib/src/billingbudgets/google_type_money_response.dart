...
class GoogleTypeMoneyResponse {
  ...
  /// Creates a new [GoogleTypeMoneyResponse].
  ...
  factory GoogleTypeMoneyResponse.fromMap(Map<String, dynamic> map) {
    return GoogleTypeMoneyResponse(
