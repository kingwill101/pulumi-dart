...
class GoogleCloudBillingBudgetsV1beta1CustomPeriodResponse {
  ...
  const GoogleCloudBillingBudgetsV1beta1CustomPeriodResponse({
  ...
  factory GoogleCloudBillingBudgetsV1beta1CustomPeriodResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudBillingBudgetsV1beta1CustomPeriodResponse(
      endDate: pulumi.Input.fromValue(GoogleTypeDateResponseBillingbudgetsV1beta1.fromMap((map['endDate']! as Map).cast<String, dynamic>())),
      startDate: pulumi.Input.fromValue(GoogleTypeDateResponseBillingbudgetsV1beta1.fromMap((map['startDate']! as Map).cast<String, dynamic>())),
    );
  }
}
