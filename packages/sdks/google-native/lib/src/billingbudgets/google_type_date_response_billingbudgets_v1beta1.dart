...
class GoogleTypeDateResponseBillingbudgetsV1beta1 {
  ...
  /// Creates a new [GoogleTypeDateResponseBillingbudgetsV1beta1].
  ...
  const GoogleTypeDateResponseBillingbudgetsV1beta1({
    required this.day,
    required this.month,
    required this.year,
  });
  ...
  factory GoogleTypeDateResponseBillingbudgetsV1beta1.fromMap(Map<String, dynamic> map) {
