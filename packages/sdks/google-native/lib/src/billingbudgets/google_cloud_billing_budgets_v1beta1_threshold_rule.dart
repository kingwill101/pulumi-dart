...
class GoogleCloudBillingBudgetsV1beta1ThresholdRule {
  ...
  const GoogleCloudBillingBudgetsV1beta1ThresholdRule({
    this.spendBasis,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'spendBasis': ?pulumi.Input.mapOptionalInputValue<GoogleCloudBillingBudgetsV1beta1ThresholdRuleSpendBasis, String>(spendBasis, (value) => value.wireValue),
  ...
  factory GoogleCloudBillingBudgetsV1beta1ThresholdRule.fromMap(Map<String, dynamic> map) {
    return GoogleCloudBillingBudgetsV1beta1ThresholdRule(
      spendBasis: (() { final guardedValue = map['spendBasis']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudBillingBudgetsV1beta1ThresholdRuleSpendBasis.fromValue(guardedValue as String)); })(),
