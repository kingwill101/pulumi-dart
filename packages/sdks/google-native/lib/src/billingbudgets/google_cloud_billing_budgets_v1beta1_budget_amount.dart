...
class GoogleCloudBillingBudgetsV1beta1BudgetAmount {
  ...
  const GoogleCloudBillingBudgetsV1beta1BudgetAmount({
  ...
  factory GoogleCloudBillingBudgetsV1beta1BudgetAmount.fromMap(Map<String, dynamic> map) {
    return GoogleCloudBillingBudgetsV1beta1BudgetAmount(
      ...
      specifiedAmount: (() { final guardedValue = map['specifiedAmount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleTypeMoneyBillingbudgetsV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
