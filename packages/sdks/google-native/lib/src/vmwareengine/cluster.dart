...
class Cluster extends pulumi.CustomResource {
  ...
  Cluster(
    ...
    this.nodeTypeConfigs = registerOutput<Map<String, String>>('nodeTypeConfigs');
    this.privateCloudId = registerOutput<String>('privateCloudId');
    this.project = registerOutput<String>('project');
    this.requestId = registerOutput<String?>('requestId');
    this.state = registerOutput<String>('state');
    this.stretchedClusterConfig = registerOutput<StretchedClusterConfigResponse>('stretchedClusterConfig');
