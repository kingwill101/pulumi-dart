...
/// {@template pulumi_vmwareengine_v1_private_cloud_iam_binding_args_doc}
/// The set of arguments for PrivateCloudIamBinding.
/// {@endtemplate}
/// {@macro pulumi_vmwareengine_v1_private_cloud_iam_binding_args_doc}
class PrivateCloudIamBindingArgs {
  ...
  /// Creates a new [PrivateCloudIamBindingArgs].
  ...
  const PrivateCloudIamBindingArgs({
    this.condition,
  ...
  factory PrivateCloudIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return PrivateCloudIamBindingArgs(
