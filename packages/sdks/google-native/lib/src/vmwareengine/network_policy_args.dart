...
class NetworkPolicyArgs {
  ...
  factory NetworkPolicyArgs.fromMap(Map<String, dynamic> map) {
    return NetworkPolicyArgs(
      ...
      externalIp: (() { final guardedValue = map['externalIp']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkService.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      internetAccess: (() { final guardedValue = map['internetAccess']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkService.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
