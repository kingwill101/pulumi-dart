...
class VmwareEngineNetwork extends pulumi.CustomResource {
  ...
  late final pulumi.Output<String> vmwareEngineNetworkId;
  ...
  late final pulumi.Output<List<VpcNetworkResponse>> vpcNetworks;

  /// Creates a new [VmwareEngineNetwork].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [VmwareEngineNetwork]. {@macro pulumi_vmwareengine_v1_vmware_engine_network_args_doc}
  ...
  VmwareEngineNetwork(
    ...
    this.vmwareEngineNetworkId = registerOutput<String>('vmwareEngineNetworkId');
