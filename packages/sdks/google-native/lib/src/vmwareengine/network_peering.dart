...
class NetworkPeering extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [NetworkPeering]. {@macro pulumi_vmwareengine_v1_network_peering_args_doc}
  ...
  NetworkPeering(
    ...
    exchangeSubnetRoutes = registerOutput<bool>('exchangeSubnetRoutes');
    exportCustomRoutes = registerOutput<bool>('exportCustomRoutes');
    exportCustomRoutesWithPublicIp = registerOutput<bool>(
      'exportCustomRoutesWithPublicIp',
    );
    importCustomRoutes = registerOutput<bool>('importCustomRoutes');
    importCustomRoutesWithPublicIp = registerOutput<bool>(
      'importCustomRoutesWithPublicIp',
    );
    this.name = registerOutput<String>('name');
    networkPeeringId = registerOutput<String>('networkPeeringId');
    peerMtu = registerOutput<int>('peerMtu');
