...
class NetworkPeering extends pulumi.CustomResource {
  ...
  NetworkPeering(
    ...
    this.exportCustomRoutesWithPublicIp = registerOutput<bool>('exportCustomRoutesWithPublicIp');
    this.importCustomRoutes = registerOutput<bool>('importCustomRoutes');
    this.importCustomRoutesWithPublicIp = registerOutput<bool>('importCustomRoutesWithPublicIp');
