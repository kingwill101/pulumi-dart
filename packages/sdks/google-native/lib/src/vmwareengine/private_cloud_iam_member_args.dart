...
/// {@template pulumi_vmwareengine_v1_private_cloud_iam_member_args_doc}
/// The set of arguments for PrivateCloudIamMember.
/// {@endtemplate}
/// {@macro pulumi_vmwareengine_v1_private_cloud_iam_member_args_doc}
class PrivateCloudIamMemberArgs {
  ...
  /// Creates a new [PrivateCloudIamMemberArgs].
  ...
  const PrivateCloudIamMemberArgs({
    this.condition,
  ...
  factory PrivateCloudIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return PrivateCloudIamMemberArgs(
