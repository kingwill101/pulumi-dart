...
class PrivateConnectionArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'type': pulumi.Input.mapInputValue<PrivateConnectionType, String>(
        type,
    ...
    return PrivateConnectionArgs(
      ...
      routingMode: (() {
        ...
        return pulumi.Input.fromValue(
          PrivateConnectionRoutingMode.fromValue(guardedValue as String),
        );
      })(),
      serviceNetwork: pulumi.Input.fromValue(map['serviceNetwork'] as String),
      type: pulumi.Input.fromValue(
        PrivateConnectionType.fromValue(map['type']! as String),
      ),
