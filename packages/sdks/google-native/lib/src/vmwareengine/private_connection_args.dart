...
class PrivateConnectionArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'project': ?project,
      'requestId': ?requestId,
      'routingMode': ?pulumi.Input.mapOptionalInputValue<PrivateConnectionRoutingMode, String>(routingMode, (value) => value.wireValue),
      'serviceNetwork': serviceNetwork,
      'type': pulumi.Input.mapInputValue<PrivateConnectionType, String>(type, (value) => value.wireValue),
  ...
  factory PrivateConnectionArgs.fromMap(Map<String, dynamic> map) {
    return PrivateConnectionArgs(
      ...
      routingMode: (() { final guardedValue = map['routingMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PrivateConnectionRoutingMode.fromValue(guardedValue as String)); })(),
      serviceNetwork: pulumi.Input.fromValue(map['serviceNetwork'] as String),
      type: pulumi.Input.fromValue(PrivateConnectionType.fromValue(map['type']! as String)),
