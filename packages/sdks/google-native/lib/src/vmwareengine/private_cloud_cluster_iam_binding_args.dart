...
/// {@template pulumi_vmwareengine_v1_private_cloud_cluster_iam_binding_args_doc}
/// The set of arguments for PrivateCloudClusterIamBinding.
/// {@endtemplate}
/// {@macro pulumi_vmwareengine_v1_private_cloud_cluster_iam_binding_args_doc}
class PrivateCloudClusterIamBindingArgs {
  ...
  /// Creates a new [PrivateCloudClusterIamBindingArgs].
  ...
  const PrivateCloudClusterIamBindingArgs({
    this.condition,
  ...
  factory PrivateCloudClusterIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return PrivateCloudClusterIamBindingArgs(
