...
class GetExternalAccessRuleResult {
  ...
  /// [name] The resource name of this external access rule. Resource names are schemeless URIs that follow the conventions in https://cloud.google.com/apis/design/resource_names. For example: `projects/my-project/locations/us-central1/networkPolicies/my-policy/externalAccessRules/my-rule`
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'destinationIpRanges': pulumi.Input.encodeList<IpRangeResponse, Map<String, dynamic>>(destinationIpRanges, (value) => value.toMap()),
      'destinationPorts': destinationPorts,
      'ipProtocol': ipProtocol,
      'name': name,
      'priority': priority,
      'sourceIpRanges': pulumi.Input.encodeList<IpRangeResponse, Map<String, dynamic>>(sourceIpRanges, (value) => value.toMap()),
  ...
  factory GetExternalAccessRuleResult.fromMap(Map<String, dynamic> map) {
    return GetExternalAccessRuleResult(
      ...
      destinationIpRanges: pulumi.Input.decodeList<IpRangeResponse>(map['destinationIpRanges'], (value) => IpRangeResponse.fromMap((value as Map).cast<String, dynamic>())),
      destinationPorts: (map['destinationPorts'] as List).cast<String>(),
      ipProtocol: map['ipProtocol'] as String,
      name: map['name'] as String,
      priority: map['priority'] as int,
      sourceIpRanges: pulumi.Input.decodeList<IpRangeResponse>(map['sourceIpRanges'], (value) => IpRangeResponse.fromMap((value as Map).cast<String, dynamic>())),
