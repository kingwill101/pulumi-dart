...
/// {@template pulumi_vmwareengine_v1_private_cloud_hcx_activation_key_iam_member_args_doc}
/// The set of arguments for PrivateCloudHcxActivationKeyIamMember.
/// {@endtemplate}
/// {@macro pulumi_vmwareengine_v1_private_cloud_hcx_activation_key_iam_member_args_doc}
class PrivateCloudHcxActivationKeyIamMemberArgs {
  ...
  /// Creates a new [PrivateCloudHcxActivationKeyIamMemberArgs].
  ...
  const PrivateCloudHcxActivationKeyIamMemberArgs({
    this.condition,
  ...
  factory PrivateCloudHcxActivationKeyIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return PrivateCloudHcxActivationKeyIamMemberArgs(
