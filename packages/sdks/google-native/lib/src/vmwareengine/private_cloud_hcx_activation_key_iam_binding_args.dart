...
/// {@template pulumi_vmwareengine_v1_private_cloud_hcx_activation_key_iam_binding_args_doc}
/// The set of arguments for PrivateCloudHcxActivationKeyIamBinding.
/// {@endtemplate}
/// {@macro pulumi_vmwareengine_v1_private_cloud_hcx_activation_key_iam_binding_args_doc}
class PrivateCloudHcxActivationKeyIamBindingArgs {
  ...
  /// Creates a new [PrivateCloudHcxActivationKeyIamBindingArgs].
  ...
  const PrivateCloudHcxActivationKeyIamBindingArgs({
    this.condition,
  ...
  factory PrivateCloudHcxActivationKeyIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return PrivateCloudHcxActivationKeyIamBindingArgs(
