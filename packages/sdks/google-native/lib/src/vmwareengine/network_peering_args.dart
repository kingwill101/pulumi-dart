  ...
  factory NetworkPeeringArgs.fromMap(Map<String, dynamic> map) {
    return NetworkPeeringArgs(
      ...
      exchangeSubnetRoutes: (() {
        final guardedValue = map['exchangeSubnetRoutes'];
        if (guardedValue == null) return null;
      ...
      networkPeeringId: pulumi.Input.fromValue(
        map['networkPeeringId'] as String,
      ),
      peerMtu: (() {
        final guardedValue = map['peerMtu'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      peerNetwork: pulumi.Input.fromValue(map['peerNetwork'] as String),
      peerNetworkType: pulumi.Input.fromValue(
        NetworkPeeringPeerNetworkType.fromValue(
