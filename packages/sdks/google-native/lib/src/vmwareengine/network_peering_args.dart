...
class NetworkPeeringArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'peerNetworkType': pulumi.Input.mapInputValue<NetworkPeeringPeerNetworkType, String>(peerNetworkType, (value) => value.wireValue),
      'project': ?project,
      'requestId': ?requestId,
  ...
  factory NetworkPeeringArgs.fromMap(Map<String, dynamic> map) {
    return NetworkPeeringArgs(
      ...
      exchangeSubnetRoutes: (() { final guardedValue = map['exchangeSubnetRoutes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      peerMtu: (() { final guardedValue = map['peerMtu']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      peerNetwork: pulumi.Input.fromValue(map['peerNetwork'] as String),
      peerNetworkType: pulumi.Input.fromValue(NetworkPeeringPeerNetworkType.fromValue(map['peerNetworkType']! as String)),
