...
class PrivateCloudArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'networkConfig': pulumi.Input.mapInputValue<NetworkConfig, Map<String, dynamic>>(networkConfig, (value) => value.toMap()),
      'privateCloudId': privateCloudId,
      'project': ?project,
      'requestId': ?requestId,
      'type': ?pulumi.Input.mapOptionalInputValue<PrivateCloudType, String>(type, (value) => value.wireValue),
    };
  }
  ...
  factory PrivateCloudArgs.fromMap(Map<String, dynamic> map) {
    return PrivateCloudArgs(
      ...
      networkConfig: pulumi.Input.fromValue(NetworkConfig.fromMap((map['networkConfig']! as Map).cast<String, dynamic>())),
      privateCloudId: pulumi.Input.fromValue(map['privateCloudId'] as String),
      project: (() { final guardedValue = map['project']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      requestId: (() { final guardedValue = map['requestId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PrivateCloudType.fromValue(guardedValue as String)); })(),
    );
  }
}
