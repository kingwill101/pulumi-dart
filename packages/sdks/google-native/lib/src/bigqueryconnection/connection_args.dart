...
class ConnectionArgs {
  ...
  factory ConnectionArgs.fromMap(Map<String, dynamic> map) {
    return ConnectionArgs(
      cloudSql: (() { final guardedValue = map['cloudSql']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CloudSqlProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
