...
/// {@template pulumi_dataform_v1beta1_repository_workspace_iam_member_args_doc}
/// The set of arguments for RepositoryWorkspaceIamMember.
/// {@endtemplate}
/// {@macro pulumi_dataform_v1beta1_repository_workspace_iam_member_args_doc}
class RepositoryWorkspaceIamMemberArgs {
  ...
  /// Creates a new [RepositoryWorkspaceIamMemberArgs].
  ...
  const RepositoryWorkspaceIamMemberArgs({
    this.condition,
  ...
  factory RepositoryWorkspaceIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return RepositoryWorkspaceIamMemberArgs(
