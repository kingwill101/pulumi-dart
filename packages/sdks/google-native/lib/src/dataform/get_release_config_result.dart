...
class GetReleaseConfigResult {
  ...
  /// Creates a new [GetReleaseConfigResult].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'codeCompilationConfig': codeCompilationConfig.toMap(),
      'cronSchedule': cronSchedule,
      'gitCommitish': gitCommitish,
      'name': name,
      'recentScheduledReleaseRecords': pulumi.Input.encodeList<ScheduledReleaseRecordResponse, Map<String, dynamic>>(recentScheduledReleaseRecords, (value) => value.toMap()),
  ...
  factory GetReleaseConfigResult.fromMap(Map<String, dynamic> map) {
    return GetReleaseConfigResult(
      codeCompilationConfig: CodeCompilationConfigResponse.fromMap((map['codeCompilationConfig']! as Map).cast<String, dynamic>()),
      cronSchedule: map['cronSchedule'] as String,
      gitCommitish: map['gitCommitish'] as String,
      name: map['name'] as String,
      recentScheduledReleaseRecords: pulumi.Input.decodeList<ScheduledReleaseRecordResponse>(map['recentScheduledReleaseRecords']!, (value) => ScheduledReleaseRecordResponse.fromMap((value as Map).cast<String, dynamic>())),
