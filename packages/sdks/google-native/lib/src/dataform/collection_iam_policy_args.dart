...
/// {@template pulumi_dataform_v1beta1_collection_iam_policy_args_doc}
/// The set of arguments for CollectionIamPolicy.
/// {@endtemplate}
/// {@macro pulumi_dataform_v1beta1_collection_iam_policy_args_doc}
class CollectionIamPolicyArgs {
  ...
  /// Creates a new [CollectionIamPolicyArgs].
  ...
  factory CollectionIamPolicyArgs.fromMap(Map<String, dynamic> map) {
    return CollectionIamPolicyArgs(
