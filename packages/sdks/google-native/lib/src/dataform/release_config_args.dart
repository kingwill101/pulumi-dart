...
class ReleaseConfigArgs {
  ...
  factory ReleaseConfigArgs.fromMap(Map<String, dynamic> map) {
    return ReleaseConfigArgs(
      codeCompilationConfig: (() { final guardedValue = map['codeCompilationConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CodeCompilationConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      releaseCompilationResult: (() { final guardedValue = map['releaseCompilationResult']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
