...
class GetCompilationResultResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'compilationErrors': pulumi.Input.encodeList<CompilationErrorResponse, Map<String, dynamic>>(compilationErrors, (value) => value.toMap()),
  ...
  factory GetCompilationResultResult.fromMap(Map<String, dynamic> map) {
    return GetCompilationResultResult(
      ...
      compilationErrors: pulumi.Input.decodeList<CompilationErrorResponse>(map['compilationErrors']!, (value) => CompilationErrorResponse.fromMap((value as Map).cast<String, dynamic>())),
