...
/// {@template pulumi_dataform_v1beta1_collection_iam_member_args_doc}
/// The set of arguments for CollectionIamMember.
/// {@endtemplate}
/// {@macro pulumi_dataform_v1beta1_collection_iam_member_args_doc}
class CollectionIamMemberArgs {
  ...
  /// Creates a new [CollectionIamMemberArgs].
  ...
  factory CollectionIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return CollectionIamMemberArgs(
