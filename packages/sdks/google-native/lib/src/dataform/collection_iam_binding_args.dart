...
/// {@template pulumi_dataform_v1beta1_collection_iam_binding_args_doc}
/// The set of arguments for CollectionIamBinding.
/// {@endtemplate}
/// {@macro pulumi_dataform_v1beta1_collection_iam_binding_args_doc}
class CollectionIamBindingArgs {
  ...
  /// Creates a new [CollectionIamBindingArgs].
  ...
  const CollectionIamBindingArgs({
    this.condition,
  ...
  factory CollectionIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return CollectionIamBindingArgs(
