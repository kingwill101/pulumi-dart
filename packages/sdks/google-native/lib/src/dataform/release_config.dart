...
class ReleaseConfig extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<ScheduledReleaseRecordResponse>> recentScheduledReleaseRecords;
  ...
  ReleaseConfig(
    ...
    this.codeCompilationConfig = registerOutput<CodeCompilationConfigResponse>('codeCompilationConfig');
    ...
    this.recentScheduledReleaseRecords = registerOutput<List<ScheduledReleaseRecordResponse>>('recentScheduledReleaseRecords');
    this.releaseCompilationResult = registerOutput<String>('releaseCompilationResult');
