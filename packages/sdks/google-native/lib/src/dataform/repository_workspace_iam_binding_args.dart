...
/// {@template pulumi_dataform_v1beta1_repository_workspace_iam_binding_args_doc}
/// The set of arguments for RepositoryWorkspaceIamBinding.
/// {@endtemplate}
/// {@macro pulumi_dataform_v1beta1_repository_workspace_iam_binding_args_doc}
class RepositoryWorkspaceIamBindingArgs {
  ...
  /// Creates a new [RepositoryWorkspaceIamBindingArgs].
  ...
  const RepositoryWorkspaceIamBindingArgs({
    this.condition,
  ...
  factory RepositoryWorkspaceIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return RepositoryWorkspaceIamBindingArgs(
