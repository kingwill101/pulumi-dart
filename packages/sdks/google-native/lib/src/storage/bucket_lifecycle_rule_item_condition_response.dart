...
class BucketLifecycleRuleItemConditionResponse {
  ...
  factory BucketLifecycleRuleItemConditionResponse.fromMap(
    ...
    return BucketLifecycleRuleItemConditionResponse(
      ...
      isLive: pulumi.Input.fromValue(map['isLive'] as bool),
      matchesPattern: pulumi.Input.fromValue(map['matchesPattern'] as String),
      matchesPrefix: pulumi.Input.fromValue(
        (map['matchesPrefix'] as List).cast<String>(),
      ),
      matchesStorageClass: pulumi.Input.fromValue(
        (map['matchesStorageClass'] as List).cast<String>(),
      ),
      matchesSuffix: pulumi.Input.fromValue(
