...
/// Result data returned by getObjectIamPolicy.
class GetObjectIamPolicyResult {
  /// An association between a role, which comes with a set of permissions, and members who may assume that role.
  final List<ObjectIamPolicyBindingsItemResponse> bindings;
  ...
  /// Creates a new [GetObjectIamPolicyResult].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'bindings': pulumi.Input.encodeList<ObjectIamPolicyBindingsItemResponse, Map<String, dynamic>>(bindings, (value) => value.toMap()),
      'etag': etag,
      'kind': kind,
  ...
  factory GetObjectIamPolicyResult.fromMap(Map<String, dynamic> map) {
    return GetObjectIamPolicyResult(
      bindings: pulumi.Input.decodeList<ObjectIamPolicyBindingsItemResponse>(map['bindings']!, (value) => ObjectIamPolicyBindingsItemResponse.fromMap((value as Map).cast<String, dynamic>())),
