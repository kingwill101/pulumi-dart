...
class BucketAutoclass {
  ...
  factory BucketAutoclass.fromMap(Map<String, dynamic> map) {
    return BucketAutoclass(
      ...
      terminalStorageClassUpdateTime: map['terminalStorageClassUpdateTime'] == null ? null : map['terminalStorageClassUpdateTime'] as String,
      toggleTime: map['toggleTime'] == null ? null : map['toggleTime'] as String,
    );
  }
}
