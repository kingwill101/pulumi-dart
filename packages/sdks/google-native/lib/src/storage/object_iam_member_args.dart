...
/// {@template pulumi_storage_v1_object_iam_member_args_doc}
/// The set of arguments for ObjectIamMember.
/// {@endtemplate}
/// {@macro pulumi_storage_v1_object_iam_member_args_doc}
class ObjectIamMemberArgs {
  ...
  /// Creates a new [ObjectIamMemberArgs].
  ...
  factory ObjectIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return ObjectIamMemberArgs(
