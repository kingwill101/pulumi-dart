...
class DefaultObjectAccessControlArgs {
  ...
  factory DefaultObjectAccessControlArgs.fromMap(Map<String, dynamic> map) {
    return DefaultObjectAccessControlArgs(
      ...
      projectTeam: (() { final guardedValue = map['projectTeam']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DefaultObjectAccessControlProjectTeam.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
