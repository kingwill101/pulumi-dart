...
class BucketLifecycleRuleItemCondition {
  ...
  factory BucketLifecycleRuleItemCondition.fromMap(Map<String, dynamic> map) {
    return BucketLifecycleRuleItemCondition(
      ...
      createdBefore: (() {
        final guardedValue = map['createdBefore'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      customTimeBefore: (() {
        final guardedValue = map['customTimeBefore'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      daysSinceCustomTime: (() {
        final guardedValue = map['daysSinceCustomTime'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      daysSinceNoncurrentTime: (() {
        final guardedValue = map['daysSinceNoncurrentTime'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      isLive: (() {
        final guardedValue = map['isLive'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      matchesPattern: (() {
        final guardedValue = map['matchesPattern'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      matchesPrefix: (() {
        final guardedValue = map['matchesPrefix'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      matchesStorageClass: (() {
        final guardedValue = map['matchesStorageClass'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      matchesSuffix: (() {
        final guardedValue = map['matchesSuffix'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      noncurrentTimeBefore: (() {
        final guardedValue = map['noncurrentTimeBefore'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      numNewerVersions: (() {
        final guardedValue = map['numNewerVersions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
    );
