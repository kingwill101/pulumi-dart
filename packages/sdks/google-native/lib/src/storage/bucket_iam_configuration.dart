...
class BucketIamConfiguration {
  ...
  factory BucketIamConfiguration.fromMap(Map<String, dynamic> map) {
    return BucketIamConfiguration(
      bucketPolicyOnly: (() { final guardedValue = map['bucketPolicyOnly']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BucketIamConfigurationBucketPolicyOnly.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      uniformBucketLevelAccess: (() { final guardedValue = map['uniformBucketLevelAccess']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BucketIamConfigurationUniformBucketLevelAccess.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
