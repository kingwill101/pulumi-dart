...
class BucketObjectArgs {
  ...
  factory BucketObjectArgs.fromMap(Map<String, dynamic> map) {
    return BucketObjectArgs(
      acl: map['acl'] == null ? null : ((map['acl'] as List).cast<ObjectAccessControlStorageV1>()).input(),
      bucket: (map['bucket'] as String).input(),
      cacheControl: map['cacheControl'] == null ? null : (map['cacheControl'] as String).input(),
      componentCount: map['componentCount'] == null ? null : (map['componentCount'] as int).input(),
      ...
      hardDeleteTime: map['hardDeleteTime'] == null ? null : (map['hardDeleteTime'] as String).input(),
      ...
      owner: map['owner'] == null ? null : (BucketObjectOwner.fromMap((map['owner'] as Map).cast<String, dynamic>())).input(),
      ...
      retentionExpirationTime: map['retentionExpirationTime'] == null ? null : (map['retentionExpirationTime'] as String).input(),
      selfLink: map['selfLink'] == null ? null : (map['selfLink'] as String).input(),
      size: map['size'] == null ? null : (map['size'] as String).input(),
      softDeleteTime: map['softDeleteTime'] == null ? null : (map['softDeleteTime'] as String).input(),
      ...
      timeDeleted: map['timeDeleted'] == null ? null : (map['timeDeleted'] as String).input(),
      timeStorageClassUpdated: map['timeStorageClassUpdated'] == null ? null : (map['timeStorageClassUpdated'] as String).input(),
