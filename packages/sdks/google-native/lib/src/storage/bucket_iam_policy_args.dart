...
class BucketIamPolicyArgs {
  ...
  factory BucketIamPolicyArgs.fromMap(Map<String, dynamic> map) {
    return BucketIamPolicyArgs(
      bindings: (() { final guardedValue = map['bindings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<BucketIamPolicyBindingsItem>(guardedValue, (value) => BucketIamPolicyBindingsItem.fromMap((value as Map).cast<String, dynamic>()))); })(),
