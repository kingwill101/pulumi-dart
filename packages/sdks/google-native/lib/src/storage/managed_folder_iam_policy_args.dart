...
class ManagedFolderIamPolicyArgs {
  ...
  factory ManagedFolderIamPolicyArgs.fromMap(Map<String, dynamic> map) {
    return ManagedFolderIamPolicyArgs(
      bindings: (() { final guardedValue = map['bindings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ManagedFolderIamPolicyBindingsItem>(guardedValue, (value) => ManagedFolderIamPolicyBindingsItem.fromMap((value as Map).cast<String, dynamic>()))); })(),
