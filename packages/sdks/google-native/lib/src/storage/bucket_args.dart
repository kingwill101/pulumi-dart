...
class BucketArgs {
  ...
  BucketArgs({
    pulumi.Output<List<BucketAccessControlStorageV1>>? acl,
    pulumi.Output<BucketAutoclass>? autoclass,
    pulumi.Output<BucketBilling>? billing,
    pulumi.Output<List<BucketCorsItem>>? cors,
    pulumi.Output<BucketCustomPlacementConfig>? customPlacementConfig,
    pulumi.Output<bool>? defaultEventBasedHold,
    pulumi.Output<List<ObjectAccessControlStorageV1>>? defaultObjectAcl,
    pulumi.Output<bool>? enableObjectRetention,
    pulumi.Output<BucketEncryption>? encryption,
    pulumi.Output<String>? etag,
    pulumi.Output<BucketIamConfiguration>? iamConfiguration,
    pulumi.Output<String>? id,
    pulumi.Output<String>? kind,
    pulumi.Output<Map<String, String>>? labels,
    pulumi.Output<BucketLifecycle>? lifecycle,
    pulumi.Output<String>? location,
    pulumi.Output<String>? locationType,
    pulumi.Output<BucketLogging>? logging,
    pulumi.Output<String>? metageneration,
    pulumi.Output<String>? name,
    pulumi.Output<BucketObjectRetention>? objectRetention,
    pulumi.Output<BucketOwner>? owner,
    pulumi.Output<String>? predefinedAcl,
    pulumi.Output<String>? predefinedDefaultObjectAcl,
    ...
    pulumi.Output<BucketWebsite>? website,
      ...
      acl = pulumi.Input.asOptionalInput<List<BucketAccessControlStorageV1>>(acl),
      ...
      defaultObjectAcl = pulumi.Input.asOptionalInput<List<ObjectAccessControlStorageV1>>(defaultObjectAcl),
      ...
      iamConfiguration = pulumi.Input.asOptionalInput<BucketIamConfiguration>(iamConfiguration),
      ...
      objectRetention = pulumi.Input.asOptionalInput<BucketObjectRetention>(objectRetention),
      owner = pulumi.Input.asOptionalInput<BucketOwner>(owner),
      predefinedAcl = pulumi.Input.asOptionalInput<String>(predefinedAcl),
      predefinedDefaultObjectAcl = pulumi.Input.asOptionalInput<String>(predefinedDefaultObjectAcl),
  ...
  factory BucketArgs.fromMap(Map<String, dynamic> map) {
    return BucketArgs(
      acl: map['acl'] == null ? null : pulumi.Output.create<List<BucketAccessControlStorageV1>>((map['acl'] as List).cast<BucketAccessControlStorageV1>()),
      ...
      billing: map['billing'] == null ? null : pulumi.Output.create<BucketBilling>(BucketBilling.fromMap((map['billing'] as Map).cast<String, dynamic>())),
      cors: map['cors'] == null ? null : pulumi.Output.create<List<BucketCorsItem>>(pulumi.Input.decodeList<BucketCorsItem>(map['cors'], (value) => BucketCorsItem.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      defaultObjectAcl: map['defaultObjectAcl'] == null ? null : pulumi.Output.create<List<ObjectAccessControlStorageV1>>((map['defaultObjectAcl'] as List).cast<ObjectAccessControlStorageV1>()),
      ...
      iamConfiguration: map['iamConfiguration'] == null ? null : pulumi.Output.create<BucketIamConfiguration>(BucketIamConfiguration.fromMap((map['iamConfiguration'] as Map).cast<String, dynamic>())),
      id: map['id'] == null ? null : pulumi.Output.create<String>(map['id'] as String),
      kind: map['kind'] == null ? null : pulumi.Output.create<String>(map['kind'] as String),
      labels: map['labels'] == null ? null : pulumi.Output.create<Map<String, String>>((map['labels'] as Map).cast<String, String>()),
      lifecycle: map['lifecycle'] == null ? null : pulumi.Output.create<BucketLifecycle>(BucketLifecycle.fromMap((map['lifecycle'] as Map).cast<String, dynamic>())),
      ...
      objectRetention: map['objectRetention'] == null ? null : pulumi.Output.create<BucketObjectRetention>(BucketObjectRetention.fromMap((map['objectRetention'] as Map).cast<String, dynamic>())),
      owner: map['owner'] == null ? null : pulumi.Output.create<BucketOwner>(BucketOwner.fromMap((map['owner'] as Map).cast<String, dynamic>())),
      predefinedAcl: map['predefinedAcl'] == null ? null : pulumi.Output.create<String>(map['predefinedAcl'] as String),
      predefinedDefaultObjectAcl: map['predefinedDefaultObjectAcl'] == null ? null : pulumi.Output.create<String>(map['predefinedDefaultObjectAcl'] as String),
