...
class BucketCorsItem {
  ...
  factory BucketCorsItem.fromMap(Map<String, dynamic> map) {
    return BucketCorsItem(
      ...
      origin: (() { final guardedValue = map['origin']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      responseHeader: (() { final guardedValue = map['responseHeader']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
    );
  }
}
