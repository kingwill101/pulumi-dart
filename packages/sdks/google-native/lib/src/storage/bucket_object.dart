...
class BucketObject extends pulumi.CustomResource {
  ...
  BucketObject(
    ...
    this.customerEncryption = registerOutput<BucketObjectCustomerEncryptionResponse>('customerEncryption');
    ...
    this.ifMetagenerationMatch = registerOutput<String?>('ifMetagenerationMatch');
    this.ifMetagenerationNotMatch = registerOutput<String?>('ifMetagenerationNotMatch');
    ...
    this.retentionExpirationTime = registerOutput<String>('retentionExpirationTime');
    ...
    this.timeStorageClassUpdated = registerOutput<String>('timeStorageClassUpdated');
