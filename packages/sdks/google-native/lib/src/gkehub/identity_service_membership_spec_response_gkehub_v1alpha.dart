...
class IdentityServiceMembershipSpecResponseGkehubV1alpha {
  ...
  final pulumi.Input<List<IdentityServiceAuthMethodResponseGkehubV1alpha>>
  authMethods;
    ...
    return <String, dynamic>{
      'authMethods':
          pulumi.Input.mapInputValue<
            List<IdentityServiceAuthMethodResponseGkehubV1alpha>,
  ...
  factory IdentityServiceMembershipSpecResponseGkehubV1alpha.fromMap(
    ...
    return IdentityServiceMembershipSpecResponseGkehubV1alpha(
      authMethods: pulumi.Input.fromValue(
        pulumi.Input.decodeList<IdentityServiceAuthMethodResponseGkehubV1alpha>(
          map['authMethods']!,
