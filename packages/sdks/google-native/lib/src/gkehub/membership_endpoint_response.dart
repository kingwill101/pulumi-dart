...
class MembershipEndpointResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'edgeCluster':
          pulumi.Input.mapInputValue<EdgeClusterResponse, Map<String, dynamic>>(
            edgeCluster,
            (value) => value.toMap(),
          ),
      'gkeCluster':
