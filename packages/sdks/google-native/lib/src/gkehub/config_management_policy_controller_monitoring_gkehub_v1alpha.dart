...
class ConfigManagementPolicyControllerMonitoringGkehubV1alpha {
  ...
  const ConfigManagementPolicyControllerMonitoringGkehubV1alpha({
    this.backends,
  });

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'backends': ?pulumi.Input.mapOptionalInputValue<List<ConfigManagementPolicyControllerMonitoringBackendsItemGkehubV1alpha>, List<String>>(backends, (value) => pulumi.Input.encodeList<ConfigManagementPolicyControllerMonitoringBackendsItemGkehubV1alpha, String>(value, (value) => value.wireValue)),
    };
  }
  ...
  factory ConfigManagementPolicyControllerMonitoringGkehubV1alpha.fromMap(Map<String, dynamic> map) {
    return ConfigManagementPolicyControllerMonitoringGkehubV1alpha(
      backends: (() { final guardedValue = map['backends']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ConfigManagementPolicyControllerMonitoringBackendsItemGkehubV1alpha>(guardedValue, (value) => ConfigManagementPolicyControllerMonitoringBackendsItemGkehubV1alpha.fromValue(value as String))); })(),
    );
  }
}
