...
class ClusterUpgradeFleetSpecResponseGkehubV1alpha {
  ...
  final pulumi.Input<
    List<ClusterUpgradeGKEUpgradeOverrideResponseGkehubV1alpha>
  >
  gkeUpgradeOverrides;

  /// Post conditions to evaluate to mark an upgrade COMPLETE. Required.
  final pulumi.Input<ClusterUpgradePostConditionsResponseGkehubV1alpha>
  postConditions;
  ...
  factory ClusterUpgradeFleetSpecResponseGkehubV1alpha.fromMap(
    ...
    return ClusterUpgradeFleetSpecResponseGkehubV1alpha(
      ...
      postConditions: pulumi.Input.fromValue(
        ClusterUpgradePostConditionsResponseGkehubV1alpha.fromMap(
