...
class FleetObservabilityLoggingConfigResponseGkehubV1beta {
  ...
  const FleetObservabilityLoggingConfigResponseGkehubV1beta({
  ...
  factory FleetObservabilityLoggingConfigResponseGkehubV1beta.fromMap(Map<String, dynamic> map) {
    return FleetObservabilityLoggingConfigResponseGkehubV1beta(
      defaultConfig: pulumi.Input.fromValue(FleetObservabilityRoutingConfigResponseGkehubV1beta.fromMap((map['defaultConfig']! as Map).cast<String, dynamic>())),
      fleetScopeLogsConfig: pulumi.Input.fromValue(FleetObservabilityRoutingConfigResponseGkehubV1beta.fromMap((map['fleetScopeLogsConfig']! as Map).cast<String, dynamic>())),
    );
  }
}
