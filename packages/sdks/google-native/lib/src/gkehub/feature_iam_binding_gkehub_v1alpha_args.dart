...
/// {@template pulumi_gkehub_v1alpha_feature_iam_binding_gkehub_v1alpha_args_doc}
/// The set of arguments for FeatureIamBinding.
/// {@endtemplate}
/// {@macro pulumi_gkehub_v1alpha_feature_iam_binding_gkehub_v1alpha_args_doc}
class FeatureIamBindingGkehubV1alphaArgs {
  ...
  /// Creates a new [FeatureIamBindingGkehubV1alphaArgs].
  ...
  const FeatureIamBindingGkehubV1alphaArgs({
    this.condition,
  ...
  factory FeatureIamBindingGkehubV1alphaArgs.fromMap(Map<String, dynamic> map) {
    return FeatureIamBindingGkehubV1alphaArgs(
