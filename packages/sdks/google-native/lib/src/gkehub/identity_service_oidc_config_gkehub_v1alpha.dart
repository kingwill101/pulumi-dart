...
class IdentityServiceOidcConfigGkehubV1alpha {
  ...
  const IdentityServiceOidcConfigGkehubV1alpha({
  ...
  factory IdentityServiceOidcConfigGkehubV1alpha.fromMap(Map<String, dynamic> map) {
    return IdentityServiceOidcConfigGkehubV1alpha(
      certificateAuthorityData: (() { final guardedValue = map['certificateAuthorityData']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      clientId: (() { final guardedValue = map['clientId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      clientSecret: (() { final guardedValue = map['clientSecret']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      deployCloudConsoleProxy: (() { final guardedValue = map['deployCloudConsoleProxy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      enableAccessToken: (() { final guardedValue = map['enableAccessToken']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      extraParams: (() { final guardedValue = map['extraParams']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      groupPrefix: (() { final guardedValue = map['groupPrefix']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      userClaim: (() { final guardedValue = map['userClaim']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      userPrefix: (() { final guardedValue = map['userPrefix']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
