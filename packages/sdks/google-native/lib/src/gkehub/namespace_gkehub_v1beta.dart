...
class NamespaceGkehubV1beta extends pulumi.CustomResource {
  ...
  NamespaceGkehubV1beta(
    ...
    state = registerOutput<NamespaceLifecycleStateResponseGkehubV1beta>('state', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return NamespaceLifecycleStateResponseGkehubV1beta.fromMap((guardedValue as Map).cast<String, dynamic>()); });
