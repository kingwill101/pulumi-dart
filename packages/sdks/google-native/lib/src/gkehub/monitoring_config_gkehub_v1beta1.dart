...
class MonitoringConfigGkehubV1beta1 {
  ...
  const MonitoringConfigGkehubV1beta1({
    this.cluster,
    this.clusterHash,
  ...
  factory MonitoringConfigGkehubV1beta1.fromMap(Map<String, dynamic> map) {
    return MonitoringConfigGkehubV1beta1(
      ...
      clusterHash: (() { final guardedValue = map['clusterHash']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      kubernetesMetricsPrefix: (() { final guardedValue = map['kubernetesMetricsPrefix']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
