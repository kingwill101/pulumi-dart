...
class AuditLogConfigGkehubV1alpha {
  ...
  AuditLogConfigGkehubV1alpha({this.exemptedMembers, this.logType});
    ...
    return <String, dynamic>{
      ...
      'logType':
          ?pulumi.Input.mapOptionalInputValue<
            AuditLogConfigLogTypeGkehubV1alpha,
            String
    ...
    return AuditLogConfigGkehubV1alpha(
      ...
      logType: (() {
        ...
        return pulumi.Input.fromValue(
          AuditLogConfigLogTypeGkehubV1alpha.fromValue(guardedValue as String),
        );
      })(),
    );
  }
