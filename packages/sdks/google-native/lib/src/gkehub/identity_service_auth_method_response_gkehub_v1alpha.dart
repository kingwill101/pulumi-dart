...
class IdentityServiceAuthMethodResponseGkehubV1alpha {
  ...
  factory IdentityServiceAuthMethodResponseGkehubV1alpha.fromMap(Map<String, dynamic> map) {
    return IdentityServiceAuthMethodResponseGkehubV1alpha(
      azureadConfig: (IdentityServiceAzureADConfigResponseGkehubV1alpha.fromMap((map['azureadConfig'] as Map).cast<String, dynamic>())).input(),
      googleConfig: (IdentityServiceGoogleConfigResponseGkehubV1alpha.fromMap((map['googleConfig'] as Map).cast<String, dynamic>())).input(),
      name: (map['name'] as String).input(),
      oidcConfig: (IdentityServiceOidcConfigResponseGkehubV1alpha.fromMap((map['oidcConfig'] as Map).cast<String, dynamic>())).input(),
      proxy: (map['proxy'] as String).input(),
    );
  }
}
