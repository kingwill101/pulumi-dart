...
class IdentityServiceAuthMethodResponseGkehubV1alpha {
  ...
  final pulumi.Input<IdentityServiceAzureADConfigResponseGkehubV1alpha>
  azureadConfig;

  /// GoogleConfig specific configuration.
  final pulumi.Input<IdentityServiceGoogleConfigResponseGkehubV1alpha>
  googleConfig;
  ...
  factory IdentityServiceAuthMethodResponseGkehubV1alpha.fromMap(
    ...
    return IdentityServiceAuthMethodResponseGkehubV1alpha(
      azureadConfig: pulumi.Input.fromValue(
        IdentityServiceAzureADConfigResponseGkehubV1alpha.fromMap(
          (map['azureadConfig']! as Map).cast<String, dynamic>(),
        ),
      ),
      googleConfig: pulumi.Input.fromValue(
        IdentityServiceGoogleConfigResponseGkehubV1alpha.fromMap(
          (map['googleConfig']! as Map).cast<String, dynamic>(),
        ),
      ),
      name: pulumi.Input.fromValue(map['name'] as String),
      oidcConfig: pulumi.Input.fromValue(
        IdentityServiceOidcConfigResponseGkehubV1alpha.fromMap(
