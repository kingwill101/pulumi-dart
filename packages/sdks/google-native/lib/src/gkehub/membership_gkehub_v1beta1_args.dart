    ...
    return <String, dynamic>{
      ...
      'infrastructureType':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(infrastructureType, (value) => value.wireValue),
      'labels': ?labels,
      'location': ?location,
    ...
    return MembershipGkehubV1beta1Args(
      authority: (() {
        ...
        return pulumi.Input.fromValue(
          AuthorityGkehubV1beta1.fromMap(
      ...
      endpoint: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          MembershipEndpointGkehubV1beta1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      infrastructureType: (() {
        final guardedValue = map['infrastructureType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          MembershipInfrastructureTypeGkehubV1beta1.fromValue(
      ...
      monitoringConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          MonitoringConfigGkehubV1beta1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
