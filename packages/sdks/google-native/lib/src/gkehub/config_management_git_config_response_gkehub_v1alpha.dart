...
class ConfigManagementGitConfigResponseGkehubV1alpha {
  ...
  /// Creates a new [ConfigManagementGitConfigResponseGkehubV1alpha].
  ...
  const ConfigManagementGitConfigResponseGkehubV1alpha({
  ...
  factory ConfigManagementGitConfigResponseGkehubV1alpha.fromMap(Map<String, dynamic> map) {
