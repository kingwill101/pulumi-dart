...
class FleetObservabilityFeatureSpecResponseGkehubV1beta {
  ...
  final pulumi.Input<FleetObservabilityLoggingConfigResponseGkehubV1beta> loggingConfig;
  ...
  const FleetObservabilityFeatureSpecResponseGkehubV1beta({
    required this.loggingConfig,
  });

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'loggingConfig': pulumi.Input.mapInputValue<FleetObservabilityLoggingConfigResponseGkehubV1beta, Map<String, dynamic>>(loggingConfig, (value) => value.toMap()),
    };
  }
  ...
  factory FleetObservabilityFeatureSpecResponseGkehubV1beta.fromMap(Map<String, dynamic> map) {
    return FleetObservabilityFeatureSpecResponseGkehubV1beta(
      loggingConfig: pulumi.Input.fromValue(FleetObservabilityLoggingConfigResponseGkehubV1beta.fromMap((map['loggingConfig']! as Map).cast<String, dynamic>())),
    );
  }
}
