...
class FeatureGkehubV1alphaArgs {
  ...
  FeatureGkehubV1alphaArgs({
    ...
    pulumi.Output<CommonFleetDefaultMemberConfigSpecGkehubV1alpha>? fleetDefaultMemberConfig,
    ...
    pulumi.Output<CommonFeatureSpecGkehubV1alpha>? spec,
  }) :
      featureId = pulumi.Input.asOptionalInput<String>(featureId),
      fleetDefaultMemberConfig = pulumi.Input.asOptionalInput<CommonFleetDefaultMemberConfigSpecGkehubV1alpha>(fleetDefaultMemberConfig),
      ...
      spec = pulumi.Input.asOptionalInput<CommonFeatureSpecGkehubV1alpha>(spec);
  ...
  factory FeatureGkehubV1alphaArgs.fromMap(Map<String, dynamic> map) {
    return FeatureGkehubV1alphaArgs(
      ...
      fleetDefaultMemberConfig: map['fleetDefaultMemberConfig'] == null ? null : pulumi.Output.create<CommonFleetDefaultMemberConfigSpecGkehubV1alpha>(CommonFleetDefaultMemberConfigSpecGkehubV1alpha.fromMap((map['fleetDefaultMemberConfig'] as Map).cast<String, dynamic>())),
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<CommonFeatureSpecGkehubV1alpha>(CommonFeatureSpecGkehubV1alpha.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
