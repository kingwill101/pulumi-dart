...
class FeatureGkehubV1alphaArgs {
  ...
  const FeatureGkehubV1alphaArgs({
    this.featureId,
  ...
  factory FeatureGkehubV1alphaArgs.fromMap(Map<String, dynamic> map) {
    return FeatureGkehubV1alphaArgs(
      ...
      fleetDefaultMemberConfig: (() { final guardedValue = map['fleetDefaultMemberConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CommonFleetDefaultMemberConfigSpecGkehubV1alpha.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      spec: (() { final guardedValue = map['spec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CommonFeatureSpecGkehubV1alpha.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
