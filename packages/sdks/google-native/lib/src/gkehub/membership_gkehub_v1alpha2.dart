...
class MembershipGkehubV1alpha2 extends pulumi.CustomResource {
  ...
  MembershipGkehubV1alpha2(
    ...
    this.authority = registerOutput<AuthorityResponseGkehubV1alpha2>('authority');
    this.createTime = registerOutput<String>('createTime');
    this.deleteTime = registerOutput<String>('deleteTime');
    this.description = registerOutput<String>('description');
    this.endpoint = registerOutput<MembershipEndpointResponseGkehubV1alpha2>('endpoint');
    ...
    this.monitoringConfig = registerOutput<MonitoringConfigResponseGkehubV1alpha2>('monitoringConfig');
