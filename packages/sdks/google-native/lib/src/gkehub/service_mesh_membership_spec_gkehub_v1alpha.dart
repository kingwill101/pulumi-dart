...
class ServiceMeshMembershipSpecGkehubV1alpha {
  ...
  final pulumi.Input<ServiceMeshMembershipSpecControlPlaneGkehubV1alpha>?
  controlPlane;
  ...
  final pulumi.Input<ServiceMeshMembershipSpecManagementGkehubV1alpha>?
  management;
    ...
    return <String, dynamic>{
      'controlPlane':
          ?pulumi.Input.mapOptionalInputValue<
            ServiceMeshMembershipSpecControlPlaneGkehubV1alpha,
            String
      ...
      'defaultChannel':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(defaultChannel, (value) => value.wireValue),
      'management':
          ?pulumi.Input.mapOptionalInputValue<
            ServiceMeshMembershipSpecManagementGkehubV1alpha,
            String
  ...
  factory ServiceMeshMembershipSpecGkehubV1alpha.fromMap(
    ...
    return ServiceMeshMembershipSpecGkehubV1alpha(
      ...
      defaultChannel: (() {
        final guardedValue = map['defaultChannel'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
