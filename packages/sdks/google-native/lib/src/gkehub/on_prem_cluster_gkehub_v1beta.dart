...
import 'on_prem_cluster_cluster_type_gkehub_v1beta.dart';

/// OnPremCluster contains information specific to GKE On-Prem clusters.
class OnPremClusterGkehubV1beta {
  /// Immutable. Whether the cluster is an admin cluster.
  final pulumi.Input<bool>? adminCluster;
  /// Immutable. The on prem cluster's type.
  final pulumi.Input<OnPremClusterClusterTypeGkehubV1beta>? clusterType;
  ...
  /// Creates a new [OnPremClusterGkehubV1beta].
  ...
  const OnPremClusterGkehubV1beta({
    this.adminCluster,
    this.clusterType,
    this.resourceLink,
  });
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'clusterType': ?pulumi.Input.mapOptionalInputValue<OnPremClusterClusterTypeGkehubV1beta, String>(clusterType, (value) => value.wireValue),
      'resourceLink': ?resourceLink,
    };
  }

  factory OnPremClusterGkehubV1beta.fromMap(Map<String, dynamic> map) {
    return OnPremClusterGkehubV1beta(
      ...
      clusterType: (() { final guardedValue = map['clusterType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OnPremClusterClusterTypeGkehubV1beta.fromValue(guardedValue as String)); })(),
