...
class OnPremClusterGkehubV1beta {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'clusterType': ?pulumi.Input.mapOptionalInputValue<OnPremClusterClusterTypeGkehubV1beta, String>(clusterType, (value) => value.value),
  ...
  factory OnPremClusterGkehubV1beta.fromMap(Map<String, dynamic> map) {
    return OnPremClusterGkehubV1beta(
      ...
      clusterType: map['clusterType'] == null ? null : (OnPremClusterClusterTypeGkehubV1beta.fromValue(map['clusterType']! as String)).input(),
