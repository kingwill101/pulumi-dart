...
/// {@template pulumi_gkehub_v1beta1_membership_iam_member_gkehub_v1beta1_args_doc}
/// The set of arguments for MembershipIamMember.
/// {@endtemplate}
/// {@macro pulumi_gkehub_v1beta1_membership_iam_member_gkehub_v1beta1_args_doc}
class MembershipIamMemberGkehubV1beta1Args {
  ...
  /// Creates a new [MembershipIamMemberGkehubV1beta1Args].
  ...
  const MembershipIamMemberGkehubV1beta1Args({
    this.condition,
  ...
  factory MembershipIamMemberGkehubV1beta1Args.fromMap(Map<String, dynamic> map) {
    return MembershipIamMemberGkehubV1beta1Args(
