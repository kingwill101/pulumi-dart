...
class ExprGkehubV1alpha {
  ...
  /// Creates a new [ExprGkehubV1alpha].
  ...
  factory ExprGkehubV1alpha.fromMap(Map<String, dynamic> map) {
    return ExprGkehubV1alpha(
