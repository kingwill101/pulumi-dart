...
class IdentityServiceMembershipSpecResponseGkehubV1beta {
  ...
  final pulumi.Input<List<IdentityServiceAuthMethodResponseGkehubV1beta>>
  authMethods;
    ...
    return <String, dynamic>{
      'authMethods':
          pulumi.Input.mapInputValue<
            List<IdentityServiceAuthMethodResponseGkehubV1beta>,
  ...
  factory IdentityServiceMembershipSpecResponseGkehubV1beta.fromMap(
    ...
    return IdentityServiceMembershipSpecResponseGkehubV1beta(
      authMethods: pulumi.Input.fromValue(
        pulumi.Input.decodeList<IdentityServiceAuthMethodResponseGkehubV1beta>(
          map['authMethods']!,
