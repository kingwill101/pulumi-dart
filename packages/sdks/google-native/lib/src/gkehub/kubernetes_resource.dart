...
class KubernetesResource {
  ...
  factory KubernetesResource.fromMap(Map<String, dynamic> map) {
    return KubernetesResource(
      ...
      resourceOptions: (() { final guardedValue = map['resourceOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResourceOptionsType.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
