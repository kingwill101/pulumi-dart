...
class PolicyControllerMembershipSpecResponseGkehubV1alpha {
  ...
  const PolicyControllerMembershipSpecResponseGkehubV1alpha({
  ...
  factory PolicyControllerMembershipSpecResponseGkehubV1alpha.fromMap(Map<String, dynamic> map) {
    return PolicyControllerMembershipSpecResponseGkehubV1alpha(
      policyControllerHubConfig: pulumi.Input.fromValue(PolicyControllerHubConfigResponseGkehubV1alpha.fromMap((map['policyControllerHubConfig']! as Map).cast<String, dynamic>())),
