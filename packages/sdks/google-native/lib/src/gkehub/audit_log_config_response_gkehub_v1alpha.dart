...
class AuditLogConfigResponseGkehubV1alpha {
  ...
  factory AuditLogConfigResponseGkehubV1alpha.fromMap(Map<String, dynamic> map) {
    return AuditLogConfigResponseGkehubV1alpha(
