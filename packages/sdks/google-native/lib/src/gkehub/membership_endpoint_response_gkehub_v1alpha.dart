...
class MembershipEndpointResponseGkehubV1alpha {
  ...
  final pulumi.Input<KubernetesMetadataResponseGkehubV1alpha>
  kubernetesMetadata;

  /// Optional. The in-cluster Kubernetes Resources that should be applied for a correctly registered cluster, in the steady state. These resources: * Ensure that the cluster is exclusively registered to one and only one Hub Membership. * Propagate Workload Pool Information available in the Membership Authority field. * Ensure proper initial configuration of default Hub Features.
  final pulumi.Input<KubernetesResourceResponseGkehubV1alpha>
  kubernetesResource;
    ...
    return <String, dynamic>{
      'applianceCluster':
          pulumi.Input.mapInputValue<
            ApplianceClusterResponseGkehubV1alpha,
            Map<String, dynamic>
      ...
      'kubernetesMetadata':
          pulumi.Input.mapInputValue<
            KubernetesMetadataResponseGkehubV1alpha,
            Map<String, dynamic>
      ...
      'onPremCluster':
          pulumi.Input.mapInputValue<
            OnPremClusterResponseGkehubV1alpha,
            Map<String, dynamic>
