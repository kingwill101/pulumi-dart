...
class MembershipEndpointResponseGkehubV1alpha {
  ...
  const MembershipEndpointResponseGkehubV1alpha({
  ...
  factory MembershipEndpointResponseGkehubV1alpha.fromMap(Map<String, dynamic> map) {
    return MembershipEndpointResponseGkehubV1alpha(
      applianceCluster: pulumi.Input.fromValue(ApplianceClusterResponseGkehubV1alpha.fromMap((map['applianceCluster']! as Map).cast<String, dynamic>())),
      edgeCluster: pulumi.Input.fromValue(EdgeClusterResponseGkehubV1alpha.fromMap((map['edgeCluster']! as Map).cast<String, dynamic>())),
      gkeCluster: pulumi.Input.fromValue(GkeClusterResponseGkehubV1alpha.fromMap((map['gkeCluster']! as Map).cast<String, dynamic>())),
      googleManaged: pulumi.Input.fromValue(map['googleManaged'] as bool),
      kubernetesMetadata: pulumi.Input.fromValue(KubernetesMetadataResponseGkehubV1alpha.fromMap((map['kubernetesMetadata']! as Map).cast<String, dynamic>())),
      kubernetesResource: pulumi.Input.fromValue(KubernetesResourceResponseGkehubV1alpha.fromMap((map['kubernetesResource']! as Map).cast<String, dynamic>())),
      multiCloudCluster: pulumi.Input.fromValue(MultiCloudClusterResponseGkehubV1alpha.fromMap((map['multiCloudCluster']! as Map).cast<String, dynamic>())),
      onPremCluster: pulumi.Input.fromValue(OnPremClusterResponseGkehubV1alpha.fromMap((map['onPremCluster']! as Map).cast<String, dynamic>())),
    );
  }
}
