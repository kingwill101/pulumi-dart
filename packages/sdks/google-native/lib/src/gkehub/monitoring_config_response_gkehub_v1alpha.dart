...
class MonitoringConfigResponseGkehubV1alpha {
  ...
  /// Creates a new [MonitoringConfigResponseGkehubV1alpha].
  ...
  MonitoringConfigResponseGkehubV1alpha({
  ...
  factory MonitoringConfigResponseGkehubV1alpha.fromMap(Map<String, dynamic> map) {
    return MonitoringConfigResponseGkehubV1alpha(
      cluster: (map['cluster'] as String).input(),
      clusterHash: (map['clusterHash'] as String).input(),
      kubernetesMetricsPrefix: (map['kubernetesMetricsPrefix'] as String).input(),
