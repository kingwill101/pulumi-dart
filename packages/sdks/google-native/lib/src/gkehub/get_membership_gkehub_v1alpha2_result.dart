...
class GetMembershipGkehubV1alpha2Result {
  ...
  factory GetMembershipGkehubV1alpha2Result.fromMap(Map<String, dynamic> map) {
    return GetMembershipGkehubV1alpha2Result(
      authority: AuthorityResponseGkehubV1alpha2.fromMap(
        (map['authority']! as Map).cast<String, dynamic>(),
      ),
      createTime: map['createTime'] as String,
      deleteTime: map['deleteTime'] as String,
      description: map['description'] as String,
      endpoint: MembershipEndpointResponseGkehubV1alpha2.fromMap(
      ...
      monitoringConfig: MonitoringConfigResponseGkehubV1alpha2.fromMap(
        (map['monitoringConfig']! as Map).cast<String, dynamic>(),
      ),
      name: map['name'] as String,
      state: MembershipStateResponseGkehubV1alpha2.fromMap(
