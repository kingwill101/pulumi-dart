...
class GetMembershipGkehubV1alpha2Result {
  /// Optional. How to identify workloads from this Membership. See the documentation on Workload Identity for more details: https://cloud.google.com/kubernetes-engine/docs/how-to/workload-identity
  final AuthorityResponseGkehubV1alpha2 authority;
  ...
  final MembershipEndpointResponseGkehubV1alpha2 endpoint;
  ...
  final MonitoringConfigResponseGkehubV1alpha2 monitoringConfig;
  ...
  final MembershipStateResponseGkehubV1alpha2 state;
  ...
  /// Creates a new [GetMembershipGkehubV1alpha2Result].
  ...
  const GetMembershipGkehubV1alpha2Result({
  ...
  factory GetMembershipGkehubV1alpha2Result.fromMap(Map<String, dynamic> map) {
    return GetMembershipGkehubV1alpha2Result(
      authority: AuthorityResponseGkehubV1alpha2.fromMap((map['authority']! as Map).cast<String, dynamic>()),
      createTime: map['createTime'] as String,
      deleteTime: map['deleteTime'] as String,
      description: map['description'] as String,
      endpoint: MembershipEndpointResponseGkehubV1alpha2.fromMap((map['endpoint']! as Map).cast<String, dynamic>()),
      externalId: map['externalId'] as String,
      infrastructureType: map['infrastructureType'] as String,
      labels: (map['labels'] as Map).cast<String, String>(),
      lastConnectionTime: map['lastConnectionTime'] as String,
      monitoringConfig: MonitoringConfigResponseGkehubV1alpha2.fromMap((map['monitoringConfig']! as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      state: MembershipStateResponseGkehubV1alpha2.fromMap((map['state']! as Map).cast<String, dynamic>()),
