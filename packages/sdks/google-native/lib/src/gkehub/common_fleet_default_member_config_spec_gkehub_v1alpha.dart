...
class CommonFleetDefaultMemberConfigSpecGkehubV1alpha {
  ...
  factory CommonFleetDefaultMemberConfigSpecGkehubV1alpha.fromMap(Map<String, dynamic> map) {
    return CommonFleetDefaultMemberConfigSpecGkehubV1alpha(
      configmanagement: (() { final guardedValue = map['configmanagement']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConfigManagementMembershipSpecGkehubV1alpha.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      identityservice: (() { final guardedValue = map['identityservice']; if (guardedValue == null) return null; return pulumi.Input.fromValue(IdentityServiceMembershipSpecGkehubV1alpha.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      mesh: (() { final guardedValue = map['mesh']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServiceMeshMembershipSpecGkehubV1alpha.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      policycontroller: (() { final guardedValue = map['policycontroller']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PolicyControllerMembershipSpecGkehubV1alpha.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
