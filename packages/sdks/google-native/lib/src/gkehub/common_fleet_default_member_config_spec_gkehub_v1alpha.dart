...
class CommonFleetDefaultMemberConfigSpecGkehubV1alpha {
  ...
  final pulumi.Input<ConfigManagementMembershipSpecGkehubV1alpha>?
  configmanagement;

  /// Identity Service-specific spec.
  final pulumi.Input<IdentityServiceMembershipSpecGkehubV1alpha>?
  identityservice;
  ...
  final pulumi.Input<PolicyControllerMembershipSpecGkehubV1alpha>?
  policycontroller;
