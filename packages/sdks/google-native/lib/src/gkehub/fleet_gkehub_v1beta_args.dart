...
class FleetGkehubV1betaArgs {
  ...
  FleetGkehubV1betaArgs({
    pulumi.Output<DefaultClusterConfigGkehubV1beta>? defaultClusterConfig,
  ...
  factory FleetGkehubV1betaArgs.fromMap(Map<String, dynamic> map) {
    return FleetGkehubV1betaArgs(
      defaultClusterConfig: map['defaultClusterConfig'] == null ? null : pulumi.Output.create<DefaultClusterConfigGkehubV1beta>(DefaultClusterConfigGkehubV1beta.fromMap((map['defaultClusterConfig'] as Map).cast<String, dynamic>())),
