...
class FleetGkehubV1betaArgs {
  ...
  factory FleetGkehubV1betaArgs.fromMap(Map<String, dynamic> map) {
    return FleetGkehubV1betaArgs(
      defaultClusterConfig: (() { final guardedValue = map['defaultClusterConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DefaultClusterConfigGkehubV1beta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
