...
class ClusterUpgradeGKEUpgradeStateResponseGkehubV1beta {
  ...
  factory ClusterUpgradeGKEUpgradeStateResponseGkehubV1beta.fromMap(Map<String, dynamic> map) {
    return ClusterUpgradeGKEUpgradeStateResponseGkehubV1beta(
      ...
      status: (ClusterUpgradeUpgradeStatusResponseGkehubV1beta.fromMap((map['status'] as Map).cast<String, dynamic>())).input(),
      upgrade: (ClusterUpgradeGKEUpgradeResponseGkehubV1beta.fromMap((map['upgrade'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
