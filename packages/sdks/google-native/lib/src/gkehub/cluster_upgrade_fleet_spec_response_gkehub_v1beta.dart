...
class ClusterUpgradeFleetSpecResponseGkehubV1beta {
  ...
  final List<ClusterUpgradeGKEUpgradeOverrideResponseGkehubV1beta> gkeUpgradeOverrides;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'gkeUpgradeOverrides': pulumi.Input.encodeList<ClusterUpgradeGKEUpgradeOverrideResponseGkehubV1beta, Map<String, dynamic>>(gkeUpgradeOverrides, (value) => value.toMap()),
  ...
  factory ClusterUpgradeFleetSpecResponseGkehubV1beta.fromMap(Map<String, dynamic> map) {
    return ClusterUpgradeFleetSpecResponseGkehubV1beta(
      gkeUpgradeOverrides: pulumi.Input.decodeList<ClusterUpgradeGKEUpgradeOverrideResponseGkehubV1beta>(map['gkeUpgradeOverrides'], (value) => ClusterUpgradeGKEUpgradeOverrideResponseGkehubV1beta.fromMap((value as Map).cast<String, dynamic>())),
