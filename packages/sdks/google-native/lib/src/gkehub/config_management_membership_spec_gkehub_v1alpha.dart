...
class ConfigManagementMembershipSpecGkehubV1alpha {
  ...
  final pulumi.Input<ConfigManagementHierarchyControllerConfigGkehubV1alpha>?
  hierarchyController;

  /// Policy Controller configuration for the cluster.
  final pulumi.Input<ConfigManagementPolicyControllerGkehubV1alpha>?
  policyController;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'configSync':
          ?pulumi.Input.mapOptionalInputValue<
            ConfigManagementConfigSyncGkehubV1alpha,
            Map<String, dynamic>
