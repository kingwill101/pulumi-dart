...
class ConfigManagementMembershipSpecGkehubV1alpha {
  ...
  final ConfigManagementHierarchyControllerConfigGkehubV1alpha? hierarchyController;
  ...
  factory ConfigManagementMembershipSpecGkehubV1alpha.fromMap(Map<String, dynamic> map) {
    return ConfigManagementMembershipSpecGkehubV1alpha(
      binauthz: map['binauthz'] == null ? null : ConfigManagementBinauthzConfig.fromMap((map['binauthz'] as Map).cast<String, dynamic>()),
      cluster: map['cluster'] == null ? null : map['cluster'] as String,
      configSync: map['configSync'] == null ? null : ConfigManagementConfigSyncGkehubV1alpha.fromMap((map['configSync'] as Map).cast<String, dynamic>()),
      hierarchyController: map['hierarchyController'] == null ? null : ConfigManagementHierarchyControllerConfigGkehubV1alpha.fromMap((map['hierarchyController'] as Map).cast<String, dynamic>()),
      policyController: map['policyController'] == null ? null : ConfigManagementPolicyControllerGkehubV1alpha.fromMap((map['policyController'] as Map).cast<String, dynamic>()),
