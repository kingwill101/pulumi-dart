...
class ExprResponseGkehubV1alpha2 {
  ...
  /// Creates a new [ExprResponseGkehubV1alpha2].
  ...
  const ExprResponseGkehubV1alpha2({
  ...
  factory ExprResponseGkehubV1alpha2.fromMap(Map<String, dynamic> map) {
    return ExprResponseGkehubV1alpha2(
