...
class AnthosObservabilityFeatureSpecGkehubV1beta {
  ...
  final pulumi.Input<AnthosObservabilityMembershipSpecGkehubV1beta>? defaultMembershipSpec;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'defaultMembershipSpec': ?pulumi.Input.mapOptionalInputValue<AnthosObservabilityMembershipSpecGkehubV1beta, Map<String, dynamic>>(defaultMembershipSpec, (value) => value.toMap()),
    };
  }
  ...
  factory AnthosObservabilityFeatureSpecGkehubV1beta.fromMap(Map<String, dynamic> map) {
    return AnthosObservabilityFeatureSpecGkehubV1beta(
      defaultMembershipSpec: (() { final guardedValue = map['defaultMembershipSpec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AnthosObservabilityMembershipSpecGkehubV1beta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
