...
class GetFleetGkehubV1alphaResult {
  ...
  /// Creates a new [GetFleetGkehubV1alphaResult].
  ...
  factory GetFleetGkehubV1alphaResult.fromMap(Map<String, dynamic> map) {
    return GetFleetGkehubV1alphaResult(
      ...
      defaultClusterConfig: DefaultClusterConfigResponseGkehubV1alpha.fromMap((map['defaultClusterConfig']! as Map).cast<String, dynamic>()),
      deleteTime: map['deleteTime'] as String,
      displayName: map['displayName'] as String,
      labels: (map['labels'] as Map).cast<String, String>(),
      name: map['name'] as String,
      state: FleetLifecycleStateResponseGkehubV1alpha.fromMap((map['state']! as Map).cast<String, dynamic>()),
