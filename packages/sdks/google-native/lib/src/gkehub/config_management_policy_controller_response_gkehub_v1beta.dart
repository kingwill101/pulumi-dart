...
class ConfigManagementPolicyControllerResponseGkehubV1beta {
  ...
  final pulumi.Input<ConfigManagementPolicyControllerMonitoringResponseGkehubV1beta> monitoring;
  ...
  const ConfigManagementPolicyControllerResponseGkehubV1beta({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'monitoring': pulumi.Input.mapInputValue<ConfigManagementPolicyControllerMonitoringResponseGkehubV1beta, Map<String, dynamic>>(monitoring, (value) => value.toMap()),
  ...
  factory ConfigManagementPolicyControllerResponseGkehubV1beta.fromMap(Map<String, dynamic> map) {
    return ConfigManagementPolicyControllerResponseGkehubV1beta(
      ...
      monitoring: pulumi.Input.fromValue(ConfigManagementPolicyControllerMonitoringResponseGkehubV1beta.fromMap((map['monitoring']! as Map).cast<String, dynamic>())),
