...
class CommonFleetDefaultMemberConfigSpecGkehubV1beta {
  ...
  const CommonFleetDefaultMemberConfigSpecGkehubV1beta({
  ...
  factory CommonFleetDefaultMemberConfigSpecGkehubV1beta.fromMap(Map<String, dynamic> map) {
    return CommonFleetDefaultMemberConfigSpecGkehubV1beta(
      configmanagement: (() { final guardedValue = map['configmanagement']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConfigManagementMembershipSpecGkehubV1beta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      identityservice: (() { final guardedValue = map['identityservice']; if (guardedValue == null) return null; return pulumi.Input.fromValue(IdentityServiceMembershipSpecGkehubV1beta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      mesh: (() { final guardedValue = map['mesh']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServiceMeshMembershipSpecGkehubV1beta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      policycontroller: (() { final guardedValue = map['policycontroller']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PolicyControllerMembershipSpecGkehubV1beta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
