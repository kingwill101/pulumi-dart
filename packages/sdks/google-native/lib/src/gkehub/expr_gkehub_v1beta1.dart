...
class ExprGkehubV1beta1 {
  ...
  /// Creates a new [ExprGkehubV1beta1].
  ...
  factory ExprGkehubV1beta1.fromMap(Map<String, dynamic> map) {
    return ExprGkehubV1beta1(
