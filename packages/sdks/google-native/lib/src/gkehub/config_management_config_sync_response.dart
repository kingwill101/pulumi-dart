...
class ConfigManagementConfigSyncResponse {
  ...
  final ConfigManagementGitConfigResponse git;
  ...
  final ConfigManagementOciConfigResponse oci;
  ...
  factory ConfigManagementConfigSyncResponse.fromMap(Map<String, dynamic> map) {
    return ConfigManagementConfigSyncResponse(
      ...
      git: ConfigManagementGitConfigResponse.fromMap((map['git'] as Map).cast<String, dynamic>()),
      metricsGcpServiceAccountEmail: map['metricsGcpServiceAccountEmail'] as String,
      oci: ConfigManagementOciConfigResponse.fromMap((map['oci'] as Map).cast<String, dynamic>()),
