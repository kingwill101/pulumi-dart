...
class ConfigManagementConfigSyncResponse {
  ...
  const ConfigManagementConfigSyncResponse({
  ...
  factory ConfigManagementConfigSyncResponse.fromMap(Map<String, dynamic> map) {
    return ConfigManagementConfigSyncResponse(
      ...
      git: pulumi.Input.fromValue(ConfigManagementGitConfigResponse.fromMap((map['git']! as Map).cast<String, dynamic>())),
      metricsGcpServiceAccountEmail: pulumi.Input.fromValue(map['metricsGcpServiceAccountEmail'] as String),
      oci: pulumi.Input.fromValue(ConfigManagementOciConfigResponse.fromMap((map['oci']! as Map).cast<String, dynamic>())),
