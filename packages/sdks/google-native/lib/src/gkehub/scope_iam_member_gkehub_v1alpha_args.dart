...
/// {@template pulumi_gkehub_v1alpha_scope_iam_member_gkehub_v1alpha_args_doc}
/// The set of arguments for ScopeIamMember.
/// {@endtemplate}
/// {@macro pulumi_gkehub_v1alpha_scope_iam_member_gkehub_v1alpha_args_doc}
class ScopeIamMemberGkehubV1alphaArgs {
  ...
  /// Creates a new [ScopeIamMemberGkehubV1alphaArgs].
  ...
  const ScopeIamMemberGkehubV1alphaArgs({
    this.condition,
  ...
  factory ScopeIamMemberGkehubV1alphaArgs.fromMap(Map<String, dynamic> map) {
    return ScopeIamMemberGkehubV1alphaArgs(
