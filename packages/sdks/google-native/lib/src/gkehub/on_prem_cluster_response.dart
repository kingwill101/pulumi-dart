...
class OnPremClusterResponse {
  ...
  /// Creates a new [OnPremClusterResponse].
  ...
  factory OnPremClusterResponse.fromMap(Map<String, dynamic> map) {
    return OnPremClusterResponse(
