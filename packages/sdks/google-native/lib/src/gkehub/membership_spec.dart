...
class MembershipSpec {
  ...
  final pulumi.Input<MembershipSpecCertificateManagement>?
    ...
    return <String, dynamic>{
      'certificateManagement':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(certificateManagement, (value) => value.wireValue),
    };
  }
  ...
  factory MembershipSpec.fromMap(Map<String, dynamic> map) {
    return MembershipSpec(
      certificateManagement: (() {
        final guardedValue = map['certificateManagement'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          MembershipSpecCertificateManagement.fromValue(guardedValue as String),
        );
      })(),
    );
  }
