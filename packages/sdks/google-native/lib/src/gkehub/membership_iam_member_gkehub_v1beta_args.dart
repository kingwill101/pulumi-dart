...
/// {@template pulumi_gkehub_v1beta_membership_iam_member_gkehub_v1beta_args_doc}
/// The set of arguments for MembershipIamMember.
/// {@endtemplate}
/// {@macro pulumi_gkehub_v1beta_membership_iam_member_gkehub_v1beta_args_doc}
class MembershipIamMemberGkehubV1betaArgs {
  ...
  /// Creates a new [MembershipIamMemberGkehubV1betaArgs].
  ...
  const MembershipIamMemberGkehubV1betaArgs({
    this.condition,
  ...
  factory MembershipIamMemberGkehubV1betaArgs.fromMap(Map<String, dynamic> map) {
    return MembershipIamMemberGkehubV1betaArgs(
