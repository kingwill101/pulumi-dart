...
class MembershipIamPolicyGkehubV1alpha2Args {
  ...
  MembershipIamPolicyGkehubV1alpha2Args({
    pulumi.Output<List<AuditConfigGkehubV1alpha2>>? auditConfigs,
    pulumi.Output<List<BindingGkehubV1alpha2>>? bindings,
  ...
  factory MembershipIamPolicyGkehubV1alpha2Args.fromMap(Map<String, dynamic> map) {
    return MembershipIamPolicyGkehubV1alpha2Args(
      auditConfigs: map['auditConfigs'] == null ? null : pulumi.Output.create<List<AuditConfigGkehubV1alpha2>>(pulumi.Input.decodeList<AuditConfigGkehubV1alpha2>(map['auditConfigs'], (value) => AuditConfigGkehubV1alpha2.fromMap((value as Map).cast<String, dynamic>()))),
      bindings: map['bindings'] == null ? null : pulumi.Output.create<List<BindingGkehubV1alpha2>>(pulumi.Input.decodeList<BindingGkehubV1alpha2>(map['bindings'], (value) => BindingGkehubV1alpha2.fromMap((value as Map).cast<String, dynamic>()))),
