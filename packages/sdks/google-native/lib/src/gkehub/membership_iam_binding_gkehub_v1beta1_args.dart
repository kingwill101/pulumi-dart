...
/// {@template pulumi_gkehub_v1beta1_membership_iam_binding_gkehub_v1beta1_args_doc}
/// The set of arguments for MembershipIamBinding.
/// {@endtemplate}
/// {@macro pulumi_gkehub_v1beta1_membership_iam_binding_gkehub_v1beta1_args_doc}
class MembershipIamBindingGkehubV1beta1Args {
  ...
  /// Creates a new [MembershipIamBindingGkehubV1beta1Args].
  ...
  const MembershipIamBindingGkehubV1beta1Args({
    this.condition,
  ...
  factory MembershipIamBindingGkehubV1beta1Args.fromMap(Map<String, dynamic> map) {
    return MembershipIamBindingGkehubV1beta1Args(
