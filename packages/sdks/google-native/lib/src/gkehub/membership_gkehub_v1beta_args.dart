...
class MembershipGkehubV1betaArgs {
  ...
  MembershipGkehubV1betaArgs({
    pulumi.Output<AuthorityGkehubV1beta>? authority,
    pulumi.Output<MembershipEndpointGkehubV1beta>? endpoint,
    pulumi.Output<String>? externalId,
    pulumi.Output<Map<String, String>>? labels,
    pulumi.Output<String>? location,
    required pulumi.Output<String> membershipId,
    pulumi.Output<MonitoringConfigGkehubV1beta>? monitoringConfig,
  ...
  factory MembershipGkehubV1betaArgs.fromMap(Map<String, dynamic> map) {
    return MembershipGkehubV1betaArgs(
      authority: map['authority'] == null ? null : pulumi.Output.create<AuthorityGkehubV1beta>(AuthorityGkehubV1beta.fromMap((map['authority'] as Map).cast<String, dynamic>())),
      endpoint: map['endpoint'] == null ? null : pulumi.Output.create<MembershipEndpointGkehubV1beta>(MembershipEndpointGkehubV1beta.fromMap((map['endpoint'] as Map).cast<String, dynamic>())),
      ...
      monitoringConfig: map['monitoringConfig'] == null ? null : pulumi.Output.create<MonitoringConfigGkehubV1beta>(MonitoringConfigGkehubV1beta.fromMap((map['monitoringConfig'] as Map).cast<String, dynamic>())),
