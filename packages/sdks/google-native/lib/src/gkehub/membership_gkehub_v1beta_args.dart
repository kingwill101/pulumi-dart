...
class MembershipGkehubV1betaArgs {
  ...
  const MembershipGkehubV1betaArgs({
    this.authority,
    this.endpoint,
    this.externalId,
    this.labels,
  ...
  factory MembershipGkehubV1betaArgs.fromMap(Map<String, dynamic> map) {
    return MembershipGkehubV1betaArgs(
      authority: (() { final guardedValue = map['authority']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AuthorityGkehubV1beta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      endpoint: (() { final guardedValue = map['endpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MembershipEndpointGkehubV1beta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      monitoringConfig: (() { final guardedValue = map['monitoringConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MonitoringConfigGkehubV1beta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
