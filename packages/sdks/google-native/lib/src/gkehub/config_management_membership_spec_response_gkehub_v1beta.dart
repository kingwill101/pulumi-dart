...
class ConfigManagementMembershipSpecResponseGkehubV1beta {
  ...
  factory ConfigManagementMembershipSpecResponseGkehubV1beta.fromMap(Map<String, dynamic> map) {
    return ConfigManagementMembershipSpecResponseGkehubV1beta(
      binauthz: (ConfigManagementBinauthzConfigResponseGkehubV1beta.fromMap((map['binauthz'] as Map).cast<String, dynamic>())).input(),
      cluster: (map['cluster'] as String).input(),
      configSync: (ConfigManagementConfigSyncResponseGkehubV1beta.fromMap((map['configSync'] as Map).cast<String, dynamic>())).input(),
      hierarchyController: (ConfigManagementHierarchyControllerConfigResponseGkehubV1beta.fromMap((map['hierarchyController'] as Map).cast<String, dynamic>())).input(),
      policyController: (ConfigManagementPolicyControllerResponseGkehubV1beta.fromMap((map['policyController'] as Map).cast<String, dynamic>())).input(),
