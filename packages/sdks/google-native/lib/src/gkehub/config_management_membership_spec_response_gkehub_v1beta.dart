...
class ConfigManagementMembershipSpecResponseGkehubV1beta {
  ...
  final ConfigManagementHierarchyControllerConfigResponseGkehubV1beta hierarchyController;
  ...
  factory ConfigManagementMembershipSpecResponseGkehubV1beta.fromMap(Map<String, dynamic> map) {
    return ConfigManagementMembershipSpecResponseGkehubV1beta(
      binauthz: ConfigManagementBinauthzConfigResponseGkehubV1beta.fromMap((map['binauthz'] as Map).cast<String, dynamic>()),
      cluster: map['cluster'] as String,
      configSync: ConfigManagementConfigSyncResponseGkehubV1beta.fromMap((map['configSync'] as Map).cast<String, dynamic>()),
      hierarchyController: ConfigManagementHierarchyControllerConfigResponseGkehubV1beta.fromMap((map['hierarchyController'] as Map).cast<String, dynamic>()),
      policyController: ConfigManagementPolicyControllerResponseGkehubV1beta.fromMap((map['policyController'] as Map).cast<String, dynamic>()),
