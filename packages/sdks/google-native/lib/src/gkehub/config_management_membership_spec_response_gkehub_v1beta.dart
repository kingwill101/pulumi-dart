...
class ConfigManagementMembershipSpecResponseGkehubV1beta {
  ...
  final pulumi.Input<ConfigManagementBinauthzConfigResponseGkehubV1beta>
  binauthz;
  ...
  final pulumi.Input<ConfigManagementPolicyControllerResponseGkehubV1beta>
  policyController;
  ...
  factory ConfigManagementMembershipSpecResponseGkehubV1beta.fromMap(
    ...
    return ConfigManagementMembershipSpecResponseGkehubV1beta(
      binauthz: pulumi.Input.fromValue(
        ConfigManagementBinauthzConfigResponseGkehubV1beta.fromMap(
      ...
      configSync: pulumi.Input.fromValue(
        ConfigManagementConfigSyncResponseGkehubV1beta.fromMap(
