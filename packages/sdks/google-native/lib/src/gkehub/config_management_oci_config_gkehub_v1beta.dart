...
class ConfigManagementOciConfigGkehubV1beta {
  ...
  /// Creates a new [ConfigManagementOciConfigGkehubV1beta].
  ...
  const ConfigManagementOciConfigGkehubV1beta({
  ...
  factory ConfigManagementOciConfigGkehubV1beta.fromMap(Map<String, dynamic> map) {
