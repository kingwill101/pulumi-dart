...
class CommonFleetDefaultMemberConfigSpecResponseGkehubV1alpha {
  ...
  final pulumi.Input<ConfigManagementMembershipSpecResponseGkehubV1alpha>
  configmanagement;

  /// Identity Service-specific spec.
  final pulumi.Input<IdentityServiceMembershipSpecResponseGkehubV1alpha>
  identityservice;
  ...
  final pulumi.Input<PolicyControllerMembershipSpecResponseGkehubV1alpha>
  policycontroller;
  ...
  factory CommonFleetDefaultMemberConfigSpecResponseGkehubV1alpha.fromMap(
    ...
    return CommonFleetDefaultMemberConfigSpecResponseGkehubV1alpha(
      ...
      mesh: pulumi.Input.fromValue(
        ServiceMeshMembershipSpecResponseGkehubV1alpha.fromMap(
