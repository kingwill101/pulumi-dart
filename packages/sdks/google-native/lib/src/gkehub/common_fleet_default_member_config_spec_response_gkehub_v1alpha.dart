...
class CommonFleetDefaultMemberConfigSpecResponseGkehubV1alpha {
  ...
  factory CommonFleetDefaultMemberConfigSpecResponseGkehubV1alpha.fromMap(Map<String, dynamic> map) {
    return CommonFleetDefaultMemberConfigSpecResponseGkehubV1alpha(
      configmanagement: (ConfigManagementMembershipSpecResponseGkehubV1alpha.fromMap((map['configmanagement'] as Map).cast<String, dynamic>())).input(),
      identityservice: (IdentityServiceMembershipSpecResponseGkehubV1alpha.fromMap((map['identityservice'] as Map).cast<String, dynamic>())).input(),
      mesh: (ServiceMeshMembershipSpecResponseGkehubV1alpha.fromMap((map['mesh'] as Map).cast<String, dynamic>())).input(),
      policycontroller: (PolicyControllerMembershipSpecResponseGkehubV1alpha.fromMap((map['policycontroller'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
