...
class ConfigManagementPolicyController {
  ...
  final pulumi.Input<ConfigManagementPolicyControllerMonitoring>? monitoring;
  ...
  const ConfigManagementPolicyController({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'monitoring': ?pulumi.Input.mapOptionalInputValue<ConfigManagementPolicyControllerMonitoring, Map<String, dynamic>>(monitoring, (value) => value.toMap()),
  ...
  factory ConfigManagementPolicyController.fromMap(Map<String, dynamic> map) {
    return ConfigManagementPolicyController(
      ...
      monitoring: (() { final guardedValue = map['monitoring']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConfigManagementPolicyControllerMonitoring.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
