...
class KubernetesResourceResponseGkehubV1alpha2 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'connectResources': pulumi.Input.encodeList<ResourceManifestResponseGkehubV1alpha2, Map<String, dynamic>>(connectResources, (value) => value.toMap()),
      'membershipCrManifest': membershipCrManifest,
      'membershipResources': pulumi.Input.encodeList<ResourceManifestResponseGkehubV1alpha2, Map<String, dynamic>>(membershipResources, (value) => value.toMap()),
  ...
  factory KubernetesResourceResponseGkehubV1alpha2.fromMap(Map<String, dynamic> map) {
    return KubernetesResourceResponseGkehubV1alpha2(
      connectResources: pulumi.Input.decodeList<ResourceManifestResponseGkehubV1alpha2>(map['connectResources'], (value) => ResourceManifestResponseGkehubV1alpha2.fromMap((value as Map).cast<String, dynamic>())),
      membershipCrManifest: map['membershipCrManifest'] as String,
      membershipResources: pulumi.Input.decodeList<ResourceManifestResponseGkehubV1alpha2>(map['membershipResources'], (value) => ResourceManifestResponseGkehubV1alpha2.fromMap((value as Map).cast<String, dynamic>())),
      resourceOptions: ResourceOptionsResponseGkehubV1alpha2.fromMap((map['resourceOptions'] as Map).cast<String, dynamic>()),
    );
  }
}
