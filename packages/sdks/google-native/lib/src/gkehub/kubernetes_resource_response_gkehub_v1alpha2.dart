...
class KubernetesResourceResponseGkehubV1alpha2 {
  ...
  final pulumi.Input<List<ResourceManifestResponseGkehubV1alpha2>>
  connectResources;
    ...
    return <String, dynamic>{
      'connectResources':
          pulumi.Input.mapInputValue<
            List<ResourceManifestResponseGkehubV1alpha2>,
  ...
  factory KubernetesResourceResponseGkehubV1alpha2.fromMap(
    ...
    return KubernetesResourceResponseGkehubV1alpha2(
      ...
      resourceOptions: pulumi.Input.fromValue(
        ResourceOptionsResponseGkehubV1alpha2.fromMap(
