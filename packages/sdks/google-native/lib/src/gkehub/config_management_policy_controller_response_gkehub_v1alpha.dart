...
class ConfigManagementPolicyControllerResponseGkehubV1alpha {
  ...
  factory ConfigManagementPolicyControllerResponseGkehubV1alpha.fromMap(Map<String, dynamic> map) {
    return ConfigManagementPolicyControllerResponseGkehubV1alpha(
      ...
      monitoring: (ConfigManagementPolicyControllerMonitoringResponseGkehubV1alpha.fromMap((map['monitoring'] as Map).cast<String, dynamic>())).input(),
      mutationEnabled: (map['mutationEnabled'] as bool).input(),
      referentialRulesEnabled: (map['referentialRulesEnabled'] as bool).input(),
      templateLibraryInstalled: (map['templateLibraryInstalled'] as bool).input(),
