...
class FleetGkehubV1alphaArgs {
  ...
  factory FleetGkehubV1alphaArgs.fromMap(Map<String, dynamic> map) {
    return FleetGkehubV1alphaArgs(
      defaultClusterConfig: (() { final guardedValue = map['defaultClusterConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DefaultClusterConfigGkehubV1alpha.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
