...
class FleetGkehubV1beta extends pulumi.CustomResource {
  ...
  FleetGkehubV1beta(
    ...
    this.defaultClusterConfig = registerOutput<DefaultClusterConfigResponseGkehubV1beta>('defaultClusterConfig');
    ...
    this.state = registerOutput<FleetLifecycleStateResponseGkehubV1beta>('state');
