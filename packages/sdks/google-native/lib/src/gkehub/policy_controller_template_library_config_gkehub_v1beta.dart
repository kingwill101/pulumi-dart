...
class PolicyControllerTemplateLibraryConfigGkehubV1beta {
  ...
  final pulumi.Input<PolicyControllerTemplateLibraryConfigInstallationGkehubV1beta>? installation;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'installation': ?pulumi.Input.mapOptionalInputValue<PolicyControllerTemplateLibraryConfigInstallationGkehubV1beta, String>(installation, (value) => value.wireValue),
    };
  }
  ...
  factory PolicyControllerTemplateLibraryConfigGkehubV1beta.fromMap(Map<String, dynamic> map) {
    return PolicyControllerTemplateLibraryConfigGkehubV1beta(
      installation: (() { final guardedValue = map['installation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PolicyControllerTemplateLibraryConfigInstallationGkehubV1beta.fromValue(guardedValue as String)); })(),
    );
  }
}
