...
class PolicyControllerHubConfig {
  ...
  factory PolicyControllerHubConfig.fromMap(Map<String, dynamic> map) {
    return PolicyControllerHubConfig(
      ...
      installSpec: map['installSpec'] == null ? null : PolicyControllerHubConfigInstallSpec.fromValue(map['installSpec'] as String),
      logDeniesEnabled: map['logDeniesEnabled'] == null ? null : map['logDeniesEnabled'] as bool,
      monitoring: map['monitoring'] == null ? null : PolicyControllerMonitoringConfig.fromMap((map['monitoring'] as Map).cast<String, dynamic>()),
      mutationEnabled: map['mutationEnabled'] == null ? null : map['mutationEnabled'] as bool,
      policyContent: map['policyContent'] == null ? null : PolicyControllerPolicyContentSpec.fromMap((map['policyContent'] as Map).cast<String, dynamic>()),
