...
class CommonFeatureSpecResponseGkehubV1alpha {
  ...
  final pulumi.Input<AnthosObservabilityFeatureSpecResponse>
  anthosobservability;
  ...
  final pulumi.Input<ClusterUpgradeFleetSpecResponseGkehubV1alpha>
  clusterupgrade;

  /// FleetObservability feature spec.
  final pulumi.Input<FleetObservabilityFeatureSpecResponseGkehubV1alpha>
  fleetobservability;

  /// Multicluster Ingress-specific spec.
  final pulumi.Input<MultiClusterIngressFeatureSpecResponseGkehubV1alpha>
  multiclusteringress;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'workloadcertificate':
          pulumi.Input.mapInputValue<FeatureSpecResponse, Map<String, dynamic>>(
            workloadcertificate,
            (value) => value.toMap(),
          ),
    };
  ...
  factory CommonFeatureSpecResponseGkehubV1alpha.fromMap(
    ...
    return CommonFeatureSpecResponseGkehubV1alpha(
      anthosobservability: pulumi.Input.fromValue(
        AnthosObservabilityFeatureSpecResponse.fromMap(
      ...
      cloudauditlogging: pulumi.Input.fromValue(
        CloudAuditLoggingFeatureSpecResponse.fromMap(
          (map['cloudauditlogging']! as Map).cast<String, dynamic>(),
        ),
      ),
      clusterupgrade: pulumi.Input.fromValue(
        ClusterUpgradeFleetSpecResponseGkehubV1alpha.fromMap(
      ...
      namespaceactuation: pulumi.Input.fromValue(
        NamespaceActuationFeatureSpecResponse.fromMap(
          (map['namespaceactuation']! as Map).cast<String, dynamic>(),
        ),
      ),
      workloadcertificate: pulumi.Input.fromValue(
        FeatureSpecResponse.fromMap(
