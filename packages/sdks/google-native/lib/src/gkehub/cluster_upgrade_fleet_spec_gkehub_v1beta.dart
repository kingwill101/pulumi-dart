...
class ClusterUpgradeFleetSpecGkehubV1beta {
  ...
  const ClusterUpgradeFleetSpecGkehubV1beta({
  ...
  factory ClusterUpgradeFleetSpecGkehubV1beta.fromMap(Map<String, dynamic> map) {
    return ClusterUpgradeFleetSpecGkehubV1beta(
      gkeUpgradeOverrides: (() { final guardedValue = map['gkeUpgradeOverrides']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ClusterUpgradeGKEUpgradeOverrideGkehubV1beta>(guardedValue, (value) => ClusterUpgradeGKEUpgradeOverrideGkehubV1beta.fromMap((value as Map).cast<String, dynamic>()))); })(),
      postConditions: pulumi.Input.fromValue(ClusterUpgradePostConditionsGkehubV1beta.fromMap((map['postConditions']! as Map).cast<String, dynamic>())),
