...
class ClusterUpgradeFleetSpecGkehubV1beta {
  ...
  final pulumi.Input<List<ClusterUpgradeGKEUpgradeOverrideGkehubV1beta>>?
  gkeUpgradeOverrides;
    ...
    return <String, dynamic>{
      'gkeUpgradeOverrides':
          ?pulumi.Input.mapOptionalInputValue<
            List<ClusterUpgradeGKEUpgradeOverrideGkehubV1beta>,
    ...
    return ClusterUpgradeFleetSpecGkehubV1beta(
      gkeUpgradeOverrides: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ClusterUpgradeGKEUpgradeOverrideGkehubV1beta>(
            guardedValue,
      ...
      postConditions: pulumi.Input.fromValue(
        ClusterUpgradePostConditionsGkehubV1beta.fromMap(
