...
class GetNamespaceGkehubV1alphaResult {
  ...
  final NamespaceLifecycleStateResponseGkehubV1alpha state;
  ...
  /// Creates a new [GetNamespaceGkehubV1alphaResult].
  ...
  const GetNamespaceGkehubV1alphaResult({
  ...
  factory GetNamespaceGkehubV1alphaResult.fromMap(Map<String, dynamic> map) {
    return GetNamespaceGkehubV1alphaResult(
      ...
      state: NamespaceLifecycleStateResponseGkehubV1alpha.fromMap((map['state']! as Map).cast<String, dynamic>()),
