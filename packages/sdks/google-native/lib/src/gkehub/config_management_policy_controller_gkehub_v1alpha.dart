...
class ConfigManagementPolicyControllerGkehubV1alpha {
  ...
  final ConfigManagementPolicyControllerMonitoringGkehubV1alpha? monitoring;
  ...
  factory ConfigManagementPolicyControllerGkehubV1alpha.fromMap(Map<String, dynamic> map) {
    return ConfigManagementPolicyControllerGkehubV1alpha(
      ...
      monitoring: map['monitoring'] == null ? null : ConfigManagementPolicyControllerMonitoringGkehubV1alpha.fromMap((map['monitoring'] as Map).cast<String, dynamic>()),
