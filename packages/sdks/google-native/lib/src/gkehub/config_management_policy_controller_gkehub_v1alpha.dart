...
import 'config_management_policy_controller_monitoring_gkehub_v1alpha.dart';

/// Configuration for Policy Controller
class ConfigManagementPolicyControllerGkehubV1alpha {
  ...
  final pulumi.Input<ConfigManagementPolicyControllerMonitoringGkehubV1alpha>? monitoring;
  ...
  /// Creates a new [ConfigManagementPolicyControllerGkehubV1alpha].
  ...
  const ConfigManagementPolicyControllerGkehubV1alpha({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'monitoring': ?pulumi.Input.mapOptionalInputValue<ConfigManagementPolicyControllerMonitoringGkehubV1alpha, Map<String, dynamic>>(monitoring, (value) => value.toMap()),
  ...
  factory ConfigManagementPolicyControllerGkehubV1alpha.fromMap(Map<String, dynamic> map) {
    return ConfigManagementPolicyControllerGkehubV1alpha(
      ...
      monitoring: (() { final guardedValue = map['monitoring']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConfigManagementPolicyControllerMonitoringGkehubV1alpha.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
