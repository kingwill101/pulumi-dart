...
class ConfigManagementPolicyControllerGkehubV1alpha {
  ...
  final pulumi.Input<ConfigManagementPolicyControllerMonitoringGkehubV1alpha>?
  monitoring;
  ...
  factory ConfigManagementPolicyControllerGkehubV1alpha.fromMap(
    ...
    return ConfigManagementPolicyControllerGkehubV1alpha(
      ...
      monitoring: (() {
        ...
        return pulumi.Input.fromValue(
          ConfigManagementPolicyControllerMonitoringGkehubV1alpha.fromMap(
      ...
      templateLibraryInstalled: (() {
        final guardedValue = map['templateLibraryInstalled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
    );
