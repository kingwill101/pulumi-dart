...
class FleetObservabilityFeatureSpecResponse {
  ...
  const FleetObservabilityFeatureSpecResponse({
  ...
  factory FleetObservabilityFeatureSpecResponse.fromMap(Map<String, dynamic> map) {
    return FleetObservabilityFeatureSpecResponse(
      loggingConfig: pulumi.Input.fromValue(FleetObservabilityLoggingConfigResponse.fromMap((map['loggingConfig']! as Map).cast<String, dynamic>())),
    );
  }
}
