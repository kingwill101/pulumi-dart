...
class PolicyControllerHubConfigResponse {
  ...
  factory PolicyControllerHubConfigResponse.fromMap(Map<String, dynamic> map) {
    return PolicyControllerHubConfigResponse(
      ...
      monitoring: (PolicyControllerMonitoringConfigResponse.fromMap((map['monitoring'] as Map).cast<String, dynamic>())).input(),
      mutationEnabled: (map['mutationEnabled'] as bool).input(),
      policyContent: (PolicyControllerPolicyContentSpecResponse.fromMap((map['policyContent'] as Map).cast<String, dynamic>())).input(),
