...
class ConfigManagementConfigSyncGkehubV1beta {
  ...
  factory ConfigManagementConfigSyncGkehubV1beta.fromMap(Map<String, dynamic> map) {
    return ConfigManagementConfigSyncGkehubV1beta(
      ...
      git: map['git'] == null ? null : ConfigManagementGitConfigGkehubV1beta.fromMap((map['git'] as Map).cast<String, dynamic>()),
      metricsGcpServiceAccountEmail: map['metricsGcpServiceAccountEmail'] == null ? null : map['metricsGcpServiceAccountEmail'] as String,
      oci: map['oci'] == null ? null : ConfigManagementOciConfigGkehubV1beta.fromMap((map['oci'] as Map).cast<String, dynamic>()),
