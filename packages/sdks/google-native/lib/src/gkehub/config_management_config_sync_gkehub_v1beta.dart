...
class ConfigManagementConfigSyncGkehubV1beta {
  ...
  factory ConfigManagementConfigSyncGkehubV1beta.fromMap(Map<String, dynamic> map) {
    return ConfigManagementConfigSyncGkehubV1beta(
      ...
      git: (() { final guardedValue = map['git']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConfigManagementGitConfigGkehubV1beta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      oci: (() { final guardedValue = map['oci']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConfigManagementOciConfigGkehubV1beta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
