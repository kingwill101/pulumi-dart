...
class MembershipEndpointResponseGkehubV1alpha2 {
  ...
  factory MembershipEndpointResponseGkehubV1alpha2.fromMap(Map<String, dynamic> map) {
    return MembershipEndpointResponseGkehubV1alpha2(
      applianceCluster: ApplianceClusterResponseGkehubV1alpha2.fromMap((map['applianceCluster'] as Map).cast<String, dynamic>()),
      edgeCluster: EdgeClusterResponseGkehubV1alpha2.fromMap((map['edgeCluster'] as Map).cast<String, dynamic>()),
      gkeCluster: GkeClusterResponseGkehubV1alpha2.fromMap((map['gkeCluster'] as Map).cast<String, dynamic>()),
      kubernetesMetadata: KubernetesMetadataResponseGkehubV1alpha2.fromMap((map['kubernetesMetadata'] as Map).cast<String, dynamic>()),
      kubernetesResource: KubernetesResourceResponseGkehubV1alpha2.fromMap((map['kubernetesResource'] as Map).cast<String, dynamic>()),
      multiCloudCluster: MultiCloudClusterResponseGkehubV1alpha2.fromMap((map['multiCloudCluster'] as Map).cast<String, dynamic>()),
      onPremCluster: OnPremClusterResponseGkehubV1alpha2.fromMap((map['onPremCluster'] as Map).cast<String, dynamic>()),
    );
  }
}
