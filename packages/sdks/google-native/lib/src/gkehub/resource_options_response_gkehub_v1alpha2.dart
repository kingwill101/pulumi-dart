...
class ResourceOptionsResponseGkehubV1alpha2 {
  ...
  /// Creates a new [ResourceOptionsResponseGkehubV1alpha2].
  ...
  const ResourceOptionsResponseGkehubV1alpha2({
  ...
  factory ResourceOptionsResponseGkehubV1alpha2.fromMap(Map<String, dynamic> map) {
    return ResourceOptionsResponseGkehubV1alpha2(
      ...
      v1beta1Crd: pulumi.Input.fromValue(map['v1beta1Crd'] as bool),
    );
  }
}
