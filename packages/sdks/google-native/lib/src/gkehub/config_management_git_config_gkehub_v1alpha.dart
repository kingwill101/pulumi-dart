...
class ConfigManagementGitConfigGkehubV1alpha {
  ...
  /// Creates a new [ConfigManagementGitConfigGkehubV1alpha].
  ...
  ConfigManagementGitConfigGkehubV1alpha({
  ...
  factory ConfigManagementGitConfigGkehubV1alpha.fromMap(
