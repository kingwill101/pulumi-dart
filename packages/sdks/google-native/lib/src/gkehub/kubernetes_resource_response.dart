...
class KubernetesResourceResponse {
  ...
  factory KubernetesResourceResponse.fromMap(Map<String, dynamic> map) {
    return KubernetesResourceResponse(
      connectResources: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ResourceManifestResponse>(
      ...
      membershipCrManifest: pulumi.Input.fromValue(
        map['membershipCrManifest'] as String,
      ),
      membershipResources: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ResourceManifestResponse>(
      ...
      resourceOptions: pulumi.Input.fromValue(
        ResourceOptionsResponse.fromMap(
