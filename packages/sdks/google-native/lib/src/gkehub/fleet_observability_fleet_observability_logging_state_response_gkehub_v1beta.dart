...
class FleetObservabilityFleetObservabilityLoggingStateResponseGkehubV1beta {
  ...
  factory FleetObservabilityFleetObservabilityLoggingStateResponseGkehubV1beta.fromMap(Map<String, dynamic> map) {
    return FleetObservabilityFleetObservabilityLoggingStateResponseGkehubV1beta(
      defaultLog: (FleetObservabilityFleetObservabilityBaseFeatureStateResponseGkehubV1beta.fromMap((map['defaultLog'] as Map).cast<String, dynamic>())).input(),
      scopeLog: (FleetObservabilityFleetObservabilityBaseFeatureStateResponseGkehubV1beta.fromMap((map['scopeLog'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
