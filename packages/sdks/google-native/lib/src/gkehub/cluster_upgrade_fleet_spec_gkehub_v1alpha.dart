...
class ClusterUpgradeFleetSpecGkehubV1alpha {
  ...
  final pulumi.Input<List<ClusterUpgradeGKEUpgradeOverrideGkehubV1alpha>>?
  gkeUpgradeOverrides;
    ...
    return <String, dynamic>{
      'gkeUpgradeOverrides':
          ?pulumi.Input.mapOptionalInputValue<
            List<ClusterUpgradeGKEUpgradeOverrideGkehubV1alpha>,
    ...
    return ClusterUpgradeFleetSpecGkehubV1alpha(
      gkeUpgradeOverrides: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<ClusterUpgradeGKEUpgradeOverrideGkehubV1alpha>(
            guardedValue,
