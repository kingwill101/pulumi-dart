...
class ClusterUpgradeFleetSpecGkehubV1alpha {
  ...
  const ClusterUpgradeFleetSpecGkehubV1alpha({
  ...
  factory ClusterUpgradeFleetSpecGkehubV1alpha.fromMap(Map<String, dynamic> map) {
    return ClusterUpgradeFleetSpecGkehubV1alpha(
      gkeUpgradeOverrides: (() { final guardedValue = map['gkeUpgradeOverrides']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ClusterUpgradeGKEUpgradeOverrideGkehubV1alpha>(guardedValue, (value) => ClusterUpgradeGKEUpgradeOverrideGkehubV1alpha.fromMap((value as Map).cast<String, dynamic>()))); })(),
