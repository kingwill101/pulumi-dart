...
class MembershipEndpointGkehubV1beta1 {
  ...
  const MembershipEndpointGkehubV1beta1({
  ...
  factory MembershipEndpointGkehubV1beta1.fromMap(Map<String, dynamic> map) {
    return MembershipEndpointGkehubV1beta1(
      applianceCluster: (() { final guardedValue = map['applianceCluster']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ApplianceClusterGkehubV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      edgeCluster: (() { final guardedValue = map['edgeCluster']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EdgeClusterGkehubV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      gkeCluster: (() { final guardedValue = map['gkeCluster']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GkeClusterGkehubV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      kubernetesResource: (() { final guardedValue = map['kubernetesResource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(KubernetesResourceGkehubV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      multiCloudCluster: (() { final guardedValue = map['multiCloudCluster']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MultiCloudClusterGkehubV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      onPremCluster: (() { final guardedValue = map['onPremCluster']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OnPremClusterGkehubV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
