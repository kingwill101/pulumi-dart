...
class ScopeGkehubV1alpha extends pulumi.CustomResource {
  ...
  /// Creates a new [ScopeGkehubV1alpha].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ScopeGkehubV1alpha]. {@macro pulumi_gkehub_v1alpha_scope_gkehub_v1alpha_args_doc}
  ...
  ScopeGkehubV1alpha(
    ...
    state = registerOutput<ScopeLifecycleStateResponseGkehubV1alpha>('state', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ScopeLifecycleStateResponseGkehubV1alpha.fromMap((guardedValue as Map).cast<String, dynamic>()); });
