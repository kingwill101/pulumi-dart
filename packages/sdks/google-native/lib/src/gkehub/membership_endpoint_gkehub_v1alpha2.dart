...
class MembershipEndpointGkehubV1alpha2 {
  ...
  const MembershipEndpointGkehubV1alpha2({
  ...
  factory MembershipEndpointGkehubV1alpha2.fromMap(Map<String, dynamic> map) {
    return MembershipEndpointGkehubV1alpha2(
      applianceCluster: (() { final guardedValue = map['applianceCluster']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ApplianceClusterGkehubV1alpha2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      edgeCluster: (() { final guardedValue = map['edgeCluster']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EdgeClusterGkehubV1alpha2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      gkeCluster: (() { final guardedValue = map['gkeCluster']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GkeClusterGkehubV1alpha2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      kubernetesResource: (() { final guardedValue = map['kubernetesResource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(KubernetesResourceGkehubV1alpha2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      multiCloudCluster: (() { final guardedValue = map['multiCloudCluster']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MultiCloudClusterGkehubV1alpha2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      onPremCluster: (() { final guardedValue = map['onPremCluster']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OnPremClusterGkehubV1alpha2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
