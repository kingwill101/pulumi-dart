...
/// {@template pulumi_gkehub_v1beta_scope_iam_binding_gkehub_v1beta_args_doc}
/// The set of arguments for ScopeIamBinding.
/// {@endtemplate}
/// {@macro pulumi_gkehub_v1beta_scope_iam_binding_gkehub_v1beta_args_doc}
class ScopeIamBindingGkehubV1betaArgs {
  ...
  /// Creates a new [ScopeIamBindingGkehubV1betaArgs].
  ...
  const ScopeIamBindingGkehubV1betaArgs({
    this.condition,
  ...
  factory ScopeIamBindingGkehubV1betaArgs.fromMap(Map<String, dynamic> map) {
    return ScopeIamBindingGkehubV1betaArgs(
