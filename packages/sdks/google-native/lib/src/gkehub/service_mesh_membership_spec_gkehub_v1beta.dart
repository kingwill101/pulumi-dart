...
class ServiceMeshMembershipSpecGkehubV1beta {
  ...
  final pulumi.Input<ServiceMeshMembershipSpecControlPlaneGkehubV1beta>?
  controlPlane;

  /// Enables automatic Service Mesh management.
  final pulumi.Input<ServiceMeshMembershipSpecManagementGkehubV1beta>?
  management;
    ...
    return <String, dynamic>{
      'controlPlane':
          ?pulumi.Input.mapOptionalInputValue<
            ServiceMeshMembershipSpecControlPlaneGkehubV1beta,
            String
          >(controlPlane, (value) => value.wireValue),
      'management':
          ?pulumi.Input.mapOptionalInputValue<
            ServiceMeshMembershipSpecManagementGkehubV1beta,
            String
