...
class PolicyControllerHubConfigResponseGkehubV1alpha {
  ...
  factory PolicyControllerHubConfigResponseGkehubV1alpha.fromMap(Map<String, dynamic> map) {
    return PolicyControllerHubConfigResponseGkehubV1alpha(
      ...
      monitoring: (PolicyControllerMonitoringConfigResponseGkehubV1alpha.fromMap((map['monitoring'] as Map).cast<String, dynamic>())).input(),
      mutationEnabled: (map['mutationEnabled'] as bool).input(),
      policyContent: (PolicyControllerPolicyContentSpecResponseGkehubV1alpha.fromMap((map['policyContent'] as Map).cast<String, dynamic>())).input(),
