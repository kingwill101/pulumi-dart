...
class PolicyControllerHubConfigResponseGkehubV1alpha {
  ...
  final pulumi.Input<PolicyControllerMonitoringConfigResponseGkehubV1alpha>
  monitoring;
  ...
  final pulumi.Input<PolicyControllerPolicyContentSpecResponseGkehubV1alpha>
  policyContent;
  ...
  PolicyControllerHubConfigResponseGkehubV1alpha({
  ...
  factory PolicyControllerHubConfigResponseGkehubV1alpha.fromMap(
    ...
    return PolicyControllerHubConfigResponseGkehubV1alpha(
      ...
      monitoring: pulumi.Input.fromValue(
        PolicyControllerMonitoringConfigResponseGkehubV1alpha.fromMap(
      ...
      policyContent: pulumi.Input.fromValue(
        PolicyControllerPolicyContentSpecResponseGkehubV1alpha.fromMap(
