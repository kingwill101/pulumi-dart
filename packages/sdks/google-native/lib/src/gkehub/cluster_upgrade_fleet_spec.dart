...
class ClusterUpgradeFleetSpec {
  ...
  final pulumi.Input<List<ClusterUpgradeGKEUpgradeOverride>>? gkeUpgradeOverrides;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'gkeUpgradeOverrides': ?pulumi.Input.mapOptionalInputValue<List<ClusterUpgradeGKEUpgradeOverride>, List<Map<String, dynamic>>>(gkeUpgradeOverrides, (value) => pulumi.Input.encodeList<ClusterUpgradeGKEUpgradeOverride, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory ClusterUpgradeFleetSpec.fromMap(Map<String, dynamic> map) {
    return ClusterUpgradeFleetSpec(
      gkeUpgradeOverrides: (() { final guardedValue = map['gkeUpgradeOverrides']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ClusterUpgradeGKEUpgradeOverride>(guardedValue, (value) => ClusterUpgradeGKEUpgradeOverride.fromMap((value as Map).cast<String, dynamic>()))); })(),
      postConditions: pulumi.Input.fromValue(ClusterUpgradePostConditions.fromMap((map['postConditions']! as Map).cast<String, dynamic>())),
      upstreamFleets: (() { final guardedValue = map['upstreamFleets']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
    );
  }
}
