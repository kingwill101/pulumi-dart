...
class ClusterUpgradeFleetSpec {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'gkeUpgradeOverrides': ?gkeUpgradeOverrides == null ? null : pulumi.Input.encodeList<ClusterUpgradeGKEUpgradeOverride, Map<String, dynamic>>(gkeUpgradeOverrides!, (value) => value.toMap()),
  ...
  factory ClusterUpgradeFleetSpec.fromMap(Map<String, dynamic> map) {
    return ClusterUpgradeFleetSpec(
      gkeUpgradeOverrides: map['gkeUpgradeOverrides'] == null ? null : pulumi.Input.decodeList<ClusterUpgradeGKEUpgradeOverride>(map['gkeUpgradeOverrides'], (value) => ClusterUpgradeGKEUpgradeOverride.fromMap((value as Map).cast<String, dynamic>())),
      postConditions: ClusterUpgradePostConditions.fromMap((map['postConditions'] as Map).cast<String, dynamic>()),
