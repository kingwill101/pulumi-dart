...
class MembershipArgs {
  ...
  MembershipArgs({
    pulumi.Output<Authority>? authority,
  ...
  factory MembershipArgs.fromMap(Map<String, dynamic> map) {
    return MembershipArgs(
      authority: map['authority'] == null ? null : pulumi.Output.create<Authority>(Authority.fromMap((map['authority'] as Map).cast<String, dynamic>())),
