...
class KubernetesResourceGkehubV1beta {
  ...
  final ResourceOptionsGkehubV1beta? resourceOptions;
  ...
  factory KubernetesResourceGkehubV1beta.fromMap(Map<String, dynamic> map) {
    return KubernetesResourceGkehubV1beta(
      ...
      resourceOptions: map['resourceOptions'] == null ? null : ResourceOptionsGkehubV1beta.fromMap((map['resourceOptions'] as Map).cast<String, dynamic>()),
    );
  }
}
