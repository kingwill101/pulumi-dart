...
class FleetObservabilityLoggingConfig {
  ...
  factory FleetObservabilityLoggingConfig.fromMap(Map<String, dynamic> map) {
    return FleetObservabilityLoggingConfig(
      defaultConfig: (() { final guardedValue = map['defaultConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FleetObservabilityRoutingConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      fleetScopeLogsConfig: (() { final guardedValue = map['fleetScopeLogsConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FleetObservabilityRoutingConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
