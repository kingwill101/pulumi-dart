...
class IdentityServiceAuthMethodResponseGkehubV1beta {
  ...
  final pulumi.Input<IdentityServiceAzureADConfigResponseGkehubV1beta>
  azureadConfig;

  /// GoogleConfig specific configuration.
  final pulumi.Input<IdentityServiceGoogleConfigResponseGkehubV1beta>
  googleConfig;
  ...
  factory IdentityServiceAuthMethodResponseGkehubV1beta.fromMap(
    ...
    return IdentityServiceAuthMethodResponseGkehubV1beta(
      azureadConfig: pulumi.Input.fromValue(
        IdentityServiceAzureADConfigResponseGkehubV1beta.fromMap(
          (map['azureadConfig']! as Map).cast<String, dynamic>(),
        ),
      ),
      googleConfig: pulumi.Input.fromValue(
        IdentityServiceGoogleConfigResponseGkehubV1beta.fromMap(
          (map['googleConfig']! as Map).cast<String, dynamic>(),
        ),
      ),
      name: pulumi.Input.fromValue(map['name'] as String),
      oidcConfig: pulumi.Input.fromValue(
        IdentityServiceOidcConfigResponseGkehubV1beta.fromMap(
