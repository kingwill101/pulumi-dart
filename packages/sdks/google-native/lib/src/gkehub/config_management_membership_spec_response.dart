...
class ConfigManagementMembershipSpecResponse {
  ...
  final pulumi.Input<ConfigManagementHierarchyControllerConfigResponse>
  hierarchyController;
  ...
  factory ConfigManagementMembershipSpecResponse.fromMap(
    ...
    return ConfigManagementMembershipSpecResponse(
      ...
      configSync: pulumi.Input.fromValue(
        ConfigManagementConfigSyncResponse.fromMap(
      ...
      policyController: pulumi.Input.fromValue(
        ConfigManagementPolicyControllerResponse.fromMap(
