...
class FleetObservabilityFeatureStateResponseGkehubV1alpha {
  ...
  factory FleetObservabilityFeatureStateResponseGkehubV1alpha.fromMap(Map<String, dynamic> map) {
    return FleetObservabilityFeatureStateResponseGkehubV1alpha(
      logging: (FleetObservabilityFleetObservabilityLoggingStateResponseGkehubV1alpha.fromMap((map['logging'] as Map).cast<String, dynamic>())).input(),
      monitoring: (FleetObservabilityFleetObservabilityMonitoringStateResponseGkehubV1alpha.fromMap((map['monitoring'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
