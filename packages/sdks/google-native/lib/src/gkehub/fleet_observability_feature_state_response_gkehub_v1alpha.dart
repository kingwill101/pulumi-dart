...
class FleetObservabilityFeatureStateResponseGkehubV1alpha {
  ...
  final FleetObservabilityFleetObservabilityLoggingStateResponseGkehubV1alpha logging;
  /// The feature state of fleet monitoring.
  final FleetObservabilityFleetObservabilityMonitoringStateResponseGkehubV1alpha monitoring;
  ...
  factory FleetObservabilityFeatureStateResponseGkehubV1alpha.fromMap(Map<String, dynamic> map) {
    return FleetObservabilityFeatureStateResponseGkehubV1alpha(
      logging: FleetObservabilityFleetObservabilityLoggingStateResponseGkehubV1alpha.fromMap((map['logging'] as Map).cast<String, dynamic>()),
      monitoring: FleetObservabilityFleetObservabilityMonitoringStateResponseGkehubV1alpha.fromMap((map['monitoring'] as Map).cast<String, dynamic>()),
    );
  }
}
