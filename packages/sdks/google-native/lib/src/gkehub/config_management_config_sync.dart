...
class ConfigManagementConfigSync {
  ...
  const ConfigManagementConfigSync({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'enabled': ?enabled,
      'git': ?pulumi.Input.mapOptionalInputValue<ConfigManagementGitConfig, Map<String, dynamic>>(git, (value) => value.toMap()),
      'metricsGcpServiceAccountEmail': ?metricsGcpServiceAccountEmail,
      'oci': ?pulumi.Input.mapOptionalInputValue<ConfigManagementOciConfig, Map<String, dynamic>>(oci, (value) => value.toMap()),
  ...
  factory ConfigManagementConfigSync.fromMap(Map<String, dynamic> map) {
    return ConfigManagementConfigSync(
      allowVerticalScale: (() { final guardedValue = map['allowVerticalScale']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      enabled: (() { final guardedValue = map['enabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      git: (() { final guardedValue = map['git']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConfigManagementGitConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      oci: (() { final guardedValue = map['oci']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConfigManagementOciConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
