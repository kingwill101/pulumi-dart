...
class PolicyControllerHubConfigGkehubV1alpha {
  ...
  final pulumi.Input<PolicyControllerHubConfigInstallSpecGkehubV1alpha>?
  installSpec;
  ...
  final pulumi.Input<PolicyControllerPolicyContentSpecGkehubV1alpha>?
  policyContent;
    ...
    return <String, dynamic>{
      ...
      'installSpec':
          ?pulumi.Input.mapOptionalInputValue<
            PolicyControllerHubConfigInstallSpecGkehubV1alpha,
            String
