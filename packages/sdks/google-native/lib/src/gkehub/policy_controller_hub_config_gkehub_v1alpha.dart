...
class PolicyControllerHubConfigGkehubV1alpha {
  ...
  const PolicyControllerHubConfigGkehubV1alpha({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'installSpec': ?pulumi.Input.mapOptionalInputValue<PolicyControllerHubConfigInstallSpecGkehubV1alpha, String>(installSpec, (value) => value.wireValue),
  ...
  factory PolicyControllerHubConfigGkehubV1alpha.fromMap(Map<String, dynamic> map) {
    return PolicyControllerHubConfigGkehubV1alpha(
      ...
      installSpec: (() { final guardedValue = map['installSpec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PolicyControllerHubConfigInstallSpecGkehubV1alpha.fromValue(guardedValue as String)); })(),
      ...
      monitoring: (() { final guardedValue = map['monitoring']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PolicyControllerMonitoringConfigGkehubV1alpha.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      policyContent: (() { final guardedValue = map['policyContent']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PolicyControllerPolicyContentSpecGkehubV1alpha.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
