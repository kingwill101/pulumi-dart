...
class ClusterUpgradeFleetSpecResponse {
  ...
  factory ClusterUpgradeFleetSpecResponse.fromMap(Map<String, dynamic> map) {
    return ClusterUpgradeFleetSpecResponse(
      gkeUpgradeOverrides: (pulumi.Input.decodeList<ClusterUpgradeGKEUpgradeOverrideResponse>(map['gkeUpgradeOverrides'], (value) => ClusterUpgradeGKEUpgradeOverrideResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
