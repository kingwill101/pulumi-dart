...
class MembershipEndpointResponseGkehubV1beta {
  ...
  factory MembershipEndpointResponseGkehubV1beta.fromMap(Map<String, dynamic> map) {
    return MembershipEndpointResponseGkehubV1beta(
      applianceCluster: ApplianceClusterResponseGkehubV1beta.fromMap((map['applianceCluster'] as Map).cast<String, dynamic>()),
      edgeCluster: EdgeClusterResponseGkehubV1beta.fromMap((map['edgeCluster'] as Map).cast<String, dynamic>()),
      gkeCluster: GkeClusterResponseGkehubV1beta.fromMap((map['gkeCluster'] as Map).cast<String, dynamic>()),
      googleManaged: map['googleManaged'] as bool,
      kubernetesMetadata: KubernetesMetadataResponseGkehubV1beta.fromMap((map['kubernetesMetadata'] as Map).cast<String, dynamic>()),
      kubernetesResource: KubernetesResourceResponseGkehubV1beta.fromMap((map['kubernetesResource'] as Map).cast<String, dynamic>()),
      multiCloudCluster: MultiCloudClusterResponseGkehubV1beta.fromMap((map['multiCloudCluster'] as Map).cast<String, dynamic>()),
      onPremCluster: OnPremClusterResponseGkehubV1beta.fromMap((map['onPremCluster'] as Map).cast<String, dynamic>()),
    );
  }
}
