...
class MembershipEndpointResponseGkehubV1beta {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'kubernetesMetadata':
          pulumi.Input.mapInputValue<
            KubernetesMetadataResponseGkehubV1beta,
            Map<String, dynamic>
      ...
      'onPremCluster':
          pulumi.Input.mapInputValue<
            OnPremClusterResponseGkehubV1beta,
            Map<String, dynamic>
