...
class MembershipEndpointResponseGkehubV1beta {
  ...
  factory MembershipEndpointResponseGkehubV1beta.fromMap(Map<String, dynamic> map) {
    return MembershipEndpointResponseGkehubV1beta(
      applianceCluster: (ApplianceClusterResponseGkehubV1beta.fromMap((map['applianceCluster'] as Map).cast<String, dynamic>())).input(),
      edgeCluster: (EdgeClusterResponseGkehubV1beta.fromMap((map['edgeCluster'] as Map).cast<String, dynamic>())).input(),
      gkeCluster: (GkeClusterResponseGkehubV1beta.fromMap((map['gkeCluster'] as Map).cast<String, dynamic>())).input(),
      googleManaged: (map['googleManaged'] as bool).input(),
      kubernetesMetadata: (KubernetesMetadataResponseGkehubV1beta.fromMap((map['kubernetesMetadata'] as Map).cast<String, dynamic>())).input(),
      kubernetesResource: (KubernetesResourceResponseGkehubV1beta.fromMap((map['kubernetesResource'] as Map).cast<String, dynamic>())).input(),
      multiCloudCluster: (MultiCloudClusterResponseGkehubV1beta.fromMap((map['multiCloudCluster'] as Map).cast<String, dynamic>())).input(),
      onPremCluster: (OnPremClusterResponseGkehubV1beta.fromMap((map['onPremCluster'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
