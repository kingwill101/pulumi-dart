...
class IdentityServiceOidcConfigResponse {
  ...
  /// Creates a new [IdentityServiceOidcConfigResponse].
  ...
  factory IdentityServiceOidcConfigResponse.fromMap(Map<String, dynamic> map) {
    return IdentityServiceOidcConfigResponse(
