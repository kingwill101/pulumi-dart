...
class CommonFeatureSpecGkehubV1alpha {
  ...
  const CommonFeatureSpecGkehubV1alpha({
  ...
  factory CommonFeatureSpecGkehubV1alpha.fromMap(Map<String, dynamic> map) {
    return CommonFeatureSpecGkehubV1alpha(
      anthosobservability: (() { final guardedValue = map['anthosobservability']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AnthosObservabilityFeatureSpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      cloudauditlogging: (() { final guardedValue = map['cloudauditlogging']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CloudAuditLoggingFeatureSpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      clusterupgrade: (() { final guardedValue = map['clusterupgrade']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterUpgradeFleetSpecGkehubV1alpha.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      fleetobservability: (() { final guardedValue = map['fleetobservability']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FleetObservabilityFeatureSpecGkehubV1alpha.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      multiclusteringress: (() { final guardedValue = map['multiclusteringress']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MultiClusterIngressFeatureSpecGkehubV1alpha.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      namespaceactuation: (() { final guardedValue = map['namespaceactuation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NamespaceActuationFeatureSpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      workloadcertificate: (() { final guardedValue = map['workloadcertificate']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FeatureSpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
