...
class CommonFeatureSpecGkehubV1alpha {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'anthosobservability': ?anthosobservability == null ? null : anthosobservability!.toMap(),
      'appdevexperience': ?appdevexperience,
      'cloudauditlogging': ?cloudauditlogging == null ? null : cloudauditlogging!.toMap(),
      ...
      'namespaceactuation': ?namespaceactuation == null ? null : namespaceactuation!.toMap(),
      'workloadcertificate': ?workloadcertificate == null ? null : workloadcertificate!.toMap(),
    };
  }

  factory CommonFeatureSpecGkehubV1alpha.fromMap(Map<String, dynamic> map) {
    return CommonFeatureSpecGkehubV1alpha(
      anthosobservability: map['anthosobservability'] == null ? null : AnthosObservabilityFeatureSpec.fromMap((map['anthosobservability'] as Map).cast<String, dynamic>()),
      appdevexperience: map['appdevexperience'] == null ? null : (map['appdevexperience'] as Map).cast<String, dynamic>(),
      cloudauditlogging: map['cloudauditlogging'] == null ? null : CloudAuditLoggingFeatureSpec.fromMap((map['cloudauditlogging'] as Map).cast<String, dynamic>()),
      clusterupgrade: map['clusterupgrade'] == null ? null : ClusterUpgradeFleetSpecGkehubV1alpha.fromMap((map['clusterupgrade'] as Map).cast<String, dynamic>()),
      fleetobservability: map['fleetobservability'] == null ? null : FleetObservabilityFeatureSpecGkehubV1alpha.fromMap((map['fleetobservability'] as Map).cast<String, dynamic>()),
      multiclusteringress: map['multiclusteringress'] == null ? null : MultiClusterIngressFeatureSpecGkehubV1alpha.fromMap((map['multiclusteringress'] as Map).cast<String, dynamic>()),
      namespaceactuation: map['namespaceactuation'] == null ? null : NamespaceActuationFeatureSpec.fromMap((map['namespaceactuation'] as Map).cast<String, dynamic>()),
      workloadcertificate: map['workloadcertificate'] == null ? null : FeatureSpec.fromMap((map['workloadcertificate'] as Map).cast<String, dynamic>()),
    );
  }
}
