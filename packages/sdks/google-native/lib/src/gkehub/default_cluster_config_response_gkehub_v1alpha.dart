...
class DefaultClusterConfigResponseGkehubV1alpha {
  ...
  final pulumi.Input<BinaryAuthorizationConfigResponseGkehubV1alpha>
  binaryAuthorizationConfig;

  /// Enable/Disable Security Posture features for the cluster.
  final pulumi.Input<SecurityPostureConfigResponseGkehubV1alpha>
  ...
  factory DefaultClusterConfigResponseGkehubV1alpha.fromMap(
    ...
    return DefaultClusterConfigResponseGkehubV1alpha(
      binaryAuthorizationConfig: pulumi.Input.fromValue(
        BinaryAuthorizationConfigResponseGkehubV1alpha.fromMap(
          (map['binaryAuthorizationConfig']! as Map).cast<String, dynamic>(),
        ),
      ),
      securityPostureConfig: pulumi.Input.fromValue(
        SecurityPostureConfigResponseGkehubV1alpha.fromMap(
