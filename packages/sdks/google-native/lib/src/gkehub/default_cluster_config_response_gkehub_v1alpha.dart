...
class DefaultClusterConfigResponseGkehubV1alpha {
  ...
  const DefaultClusterConfigResponseGkehubV1alpha({
  ...
  factory DefaultClusterConfigResponseGkehubV1alpha.fromMap(Map<String, dynamic> map) {
    return DefaultClusterConfigResponseGkehubV1alpha(
      binaryAuthorizationConfig: pulumi.Input.fromValue(BinaryAuthorizationConfigResponseGkehubV1alpha.fromMap((map['binaryAuthorizationConfig']! as Map).cast<String, dynamic>())),
      securityPostureConfig: pulumi.Input.fromValue(SecurityPostureConfigResponseGkehubV1alpha.fromMap((map['securityPostureConfig']! as Map).cast<String, dynamic>())),
    );
  }
}
