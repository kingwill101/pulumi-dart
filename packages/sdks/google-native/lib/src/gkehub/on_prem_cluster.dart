...
class OnPremCluster {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'clusterType': ?pulumi.Input.mapOptionalInputValue<OnPremClusterClusterType, String>(clusterType, (value) => value.wireValue),
  ...
  factory OnPremCluster.fromMap(Map<String, dynamic> map) {
    return OnPremCluster(
      ...
      clusterType: (() { final guardedValue = map['clusterType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OnPremClusterClusterType.fromValue(guardedValue as String)); })(),
