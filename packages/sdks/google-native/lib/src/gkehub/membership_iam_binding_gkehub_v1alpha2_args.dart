...
/// {@template pulumi_gkehub_v1alpha2_membership_iam_binding_gkehub_v1alpha2_args_doc}
/// The set of arguments for MembershipIamBinding.
/// {@endtemplate}
/// {@macro pulumi_gkehub_v1alpha2_membership_iam_binding_gkehub_v1alpha2_args_doc}
class MembershipIamBindingGkehubV1alpha2Args {
  ...
  /// Creates a new [MembershipIamBindingGkehubV1alpha2Args].
  ...
  const MembershipIamBindingGkehubV1alpha2Args({
    this.condition,
  ...
  factory MembershipIamBindingGkehubV1alpha2Args.fromMap(Map<String, dynamic> map) {
    return MembershipIamBindingGkehubV1alpha2Args(
