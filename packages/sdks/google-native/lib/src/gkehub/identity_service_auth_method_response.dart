...
class IdentityServiceAuthMethodResponse {
  ...
  factory IdentityServiceAuthMethodResponse.fromMap(Map<String, dynamic> map) {
    return IdentityServiceAuthMethodResponse(
      azureadConfig: (IdentityServiceAzureADConfigResponse.fromMap((map['azureadConfig'] as Map).cast<String, dynamic>())).input(),
      googleConfig: (IdentityServiceGoogleConfigResponse.fromMap((map['googleConfig'] as Map).cast<String, dynamic>())).input(),
      name: (map['name'] as String).input(),
      oidcConfig: (IdentityServiceOidcConfigResponse.fromMap((map['oidcConfig'] as Map).cast<String, dynamic>())).input(),
