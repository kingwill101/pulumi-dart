...
class CommonFeatureSpecResponse {
  ...
  factory CommonFeatureSpecResponse.fromMap(Map<String, dynamic> map) {
    return CommonFeatureSpecResponse(
      ...
      clusterupgrade: ClusterUpgradeFleetSpecResponse.fromMap((map['clusterupgrade'] as Map).cast<String, dynamic>()),
      fleetobservability: FleetObservabilityFeatureSpecResponse.fromMap((map['fleetobservability'] as Map).cast<String, dynamic>()),
      multiclusteringress: MultiClusterIngressFeatureSpecResponse.fromMap((map['multiclusteringress'] as Map).cast<String, dynamic>()),
    );
  }
}
