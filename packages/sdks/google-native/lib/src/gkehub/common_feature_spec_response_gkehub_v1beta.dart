...
class CommonFeatureSpecResponseGkehubV1beta {
  ...
  const CommonFeatureSpecResponseGkehubV1beta({
  ...
  factory CommonFeatureSpecResponseGkehubV1beta.fromMap(Map<String, dynamic> map) {
    return CommonFeatureSpecResponseGkehubV1beta(
      anthosobservability: pulumi.Input.fromValue(AnthosObservabilityFeatureSpecResponseGkehubV1beta.fromMap((map['anthosobservability']! as Map).cast<String, dynamic>())),
      appdevexperience: pulumi.Input.fromValue((map['appdevexperience']! as Map).cast<String, dynamic>()),
      clusterupgrade: pulumi.Input.fromValue(ClusterUpgradeFleetSpecResponseGkehubV1beta.fromMap((map['clusterupgrade']! as Map).cast<String, dynamic>())),
      fleetobservability: pulumi.Input.fromValue(FleetObservabilityFeatureSpecResponseGkehubV1beta.fromMap((map['fleetobservability']! as Map).cast<String, dynamic>())),
      multiclusteringress: pulumi.Input.fromValue(MultiClusterIngressFeatureSpecResponseGkehubV1beta.fromMap((map['multiclusteringress']! as Map).cast<String, dynamic>())),
    );
  }
}
