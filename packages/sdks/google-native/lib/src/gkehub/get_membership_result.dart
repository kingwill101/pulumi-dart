...
class GetMembershipResult {
  ...
  factory GetMembershipResult.fromMap(Map<String, dynamic> map) {
    return GetMembershipResult(
      authority: AuthorityResponse.fromMap((map['authority']! as Map).cast<String, dynamic>()),
      createTime: map['createTime'] as String,
      deleteTime: map['deleteTime'] as String,
      description: map['description'] as String,
      endpoint: MembershipEndpointResponse.fromMap((map['endpoint']! as Map).cast<String, dynamic>()),
      ...
      state: MembershipStateResponse.fromMap((map['state']! as Map).cast<String, dynamic>()),
