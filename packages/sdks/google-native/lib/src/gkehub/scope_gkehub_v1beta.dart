...
class ScopeGkehubV1beta extends pulumi.CustomResource {
  ...
  ScopeGkehubV1beta(
    ...
    state = registerOutput<ScopeLifecycleStateResponseGkehubV1beta>('state', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ScopeLifecycleStateResponseGkehubV1beta.fromMap((guardedValue as Map).cast<String, dynamic>()); });
