...
/// {@template pulumi_gkehub_v1alpha_membership_iam_member_gkehub_v1alpha_args_doc}
/// The set of arguments for MembershipIamMember.
/// {@endtemplate}
/// {@macro pulumi_gkehub_v1alpha_membership_iam_member_gkehub_v1alpha_args_doc}
class MembershipIamMemberGkehubV1alphaArgs {
  ...
  /// Creates a new [MembershipIamMemberGkehubV1alphaArgs].
  ...
  const MembershipIamMemberGkehubV1alphaArgs({
    this.condition,
  ...
  factory MembershipIamMemberGkehubV1alphaArgs.fromMap(Map<String, dynamic> map) {
