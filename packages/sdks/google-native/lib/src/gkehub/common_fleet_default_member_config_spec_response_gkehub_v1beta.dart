...
class CommonFleetDefaultMemberConfigSpecResponseGkehubV1beta {
  ...
  final pulumi.Input<ConfigManagementMembershipSpecResponseGkehubV1beta>
  configmanagement;

  /// Identity Service-specific spec.
  final pulumi.Input<IdentityServiceMembershipSpecResponseGkehubV1beta>
  identityservice;
  ...
  final pulumi.Input<PolicyControllerMembershipSpecResponseGkehubV1beta>
  policycontroller;
  ...
  factory CommonFleetDefaultMemberConfigSpecResponseGkehubV1beta.fromMap(
    ...
    return CommonFleetDefaultMemberConfigSpecResponseGkehubV1beta(
      ...
      mesh: pulumi.Input.fromValue(
        ServiceMeshMembershipSpecResponseGkehubV1beta.fromMap(
