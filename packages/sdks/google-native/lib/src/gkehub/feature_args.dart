...
/// {@template pulumi_gkehub_v1_feature_args_doc}
/// The set of arguments for Feature.
/// {@endtemplate}
/// {@macro pulumi_gkehub_v1_feature_args_doc}
class FeatureArgs {
  ...
  factory FeatureArgs.fromMap(Map<String, dynamic> map) {
    return FeatureArgs(
      ...
      fleetDefaultMemberConfig: (() { final guardedValue = map['fleetDefaultMemberConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CommonFleetDefaultMemberConfigSpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      spec: (() { final guardedValue = map['spec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CommonFeatureSpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
