...
class BindingGkehubV1 extends pulumi.CustomResource {
  ...
  BindingGkehubV1(
    ...
    state = registerOutput<MembershipBindingLifecycleStateResponse>('state', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return MembershipBindingLifecycleStateResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
