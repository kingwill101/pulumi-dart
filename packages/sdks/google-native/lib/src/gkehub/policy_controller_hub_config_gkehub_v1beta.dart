...
class PolicyControllerHubConfigGkehubV1beta {
  ...
  final pulumi.Input<PolicyControllerHubConfigInstallSpecGkehubV1beta>? installSpec;
  /// Logs all denies and dry run failures.
  final pulumi.Input<bool>? logDeniesEnabled;
  /// Monitoring specifies the configuration of monitoring.
  final pulumi.Input<PolicyControllerMonitoringConfigGkehubV1beta>? monitoring;
  /// Enables the ability to mutate resources using Policy Controller.
  final pulumi.Input<bool>? mutationEnabled;
  /// Specifies the desired policy content on the cluster
  final pulumi.Input<PolicyControllerPolicyContentSpecGkehubV1beta>? policyContent;
  /// Enables the ability to use Constraint Templates that reference to objects other than the object currently being evaluated.
  final pulumi.Input<bool>? referentialRulesEnabled;

  /// Creates a new [PolicyControllerHubConfigGkehubV1beta].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'installSpec': ?pulumi.Input.mapOptionalInputValue<PolicyControllerHubConfigInstallSpecGkehubV1beta, String>(installSpec, (value) => value.wireValue),
      'logDeniesEnabled': ?logDeniesEnabled,
      'monitoring': ?pulumi.Input.mapOptionalInputValue<PolicyControllerMonitoringConfigGkehubV1beta, Map<String, dynamic>>(monitoring, (value) => value.toMap()),
      'mutationEnabled': ?mutationEnabled,
      'policyContent': ?pulumi.Input.mapOptionalInputValue<PolicyControllerPolicyContentSpecGkehubV1beta, Map<String, dynamic>>(policyContent, (value) => value.toMap()),
      'referentialRulesEnabled': ?referentialRulesEnabled,
    };
  }

  factory PolicyControllerHubConfigGkehubV1beta.fromMap(Map<String, dynamic> map) {
    return PolicyControllerHubConfigGkehubV1beta(
      ...
      installSpec: (() { final guardedValue = map['installSpec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PolicyControllerHubConfigInstallSpecGkehubV1beta.fromValue(guardedValue as String)); })(),
      ...
      monitoring: (() { final guardedValue = map['monitoring']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PolicyControllerMonitoringConfigGkehubV1beta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      policyContent: (() { final guardedValue = map['policyContent']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PolicyControllerPolicyContentSpecGkehubV1beta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
