...
class PolicyControllerHubConfigGkehubV1beta {
  ...
  final pulumi.Input<PolicyControllerHubConfigInstallSpecGkehubV1beta>?
  installSpec;
  ...
  final pulumi.Input<PolicyControllerPolicyContentSpecGkehubV1beta>?
  policyContent;
    ...
    return <String, dynamic>{
      ...
      'installSpec':
          ?pulumi.Input.mapOptionalInputValue<
            PolicyControllerHubConfigInstallSpecGkehubV1beta,
            String
          >(installSpec, (value) => value.wireValue),
  ...
  factory PolicyControllerHubConfigGkehubV1beta.fromMap(
    ...
    return PolicyControllerHubConfigGkehubV1beta(
      ...
      installSpec: (() {
        final guardedValue = map['installSpec'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
