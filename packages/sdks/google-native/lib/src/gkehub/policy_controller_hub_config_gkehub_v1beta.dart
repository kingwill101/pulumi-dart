...
class PolicyControllerHubConfigGkehubV1beta {
  ...
  factory PolicyControllerHubConfigGkehubV1beta.fromMap(Map<String, dynamic> map) {
    return PolicyControllerHubConfigGkehubV1beta(
      ...
      installSpec: map['installSpec'] == null ? null : PolicyControllerHubConfigInstallSpecGkehubV1beta.fromValue(map['installSpec'] as String),
      logDeniesEnabled: map['logDeniesEnabled'] == null ? null : map['logDeniesEnabled'] as bool,
      monitoring: map['monitoring'] == null ? null : PolicyControllerMonitoringConfigGkehubV1beta.fromMap((map['monitoring'] as Map).cast<String, dynamic>()),
      mutationEnabled: map['mutationEnabled'] == null ? null : map['mutationEnabled'] as bool,
      policyContent: map['policyContent'] == null ? null : PolicyControllerPolicyContentSpecGkehubV1beta.fromMap((map['policyContent'] as Map).cast<String, dynamic>()),
