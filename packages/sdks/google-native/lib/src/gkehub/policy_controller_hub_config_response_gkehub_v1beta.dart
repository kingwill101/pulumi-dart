...
class PolicyControllerHubConfigResponseGkehubV1beta {
  ...
  const PolicyControllerHubConfigResponseGkehubV1beta({
  ...
  factory PolicyControllerHubConfigResponseGkehubV1beta.fromMap(Map<String, dynamic> map) {
    return PolicyControllerHubConfigResponseGkehubV1beta(
      ...
      monitoring: pulumi.Input.fromValue(PolicyControllerMonitoringConfigResponseGkehubV1beta.fromMap((map['monitoring']! as Map).cast<String, dynamic>())),
      mutationEnabled: pulumi.Input.fromValue(map['mutationEnabled'] as bool),
      policyContent: pulumi.Input.fromValue(PolicyControllerPolicyContentSpecResponseGkehubV1beta.fromMap((map['policyContent']! as Map).cast<String, dynamic>())),
