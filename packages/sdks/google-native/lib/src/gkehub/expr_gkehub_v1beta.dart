...
class ExprGkehubV1beta {
  ...
  /// Creates a new [ExprGkehubV1beta].
  ...
  factory ExprGkehubV1beta.fromMap(Map<String, dynamic> map) {
    return ExprGkehubV1beta(
