...
class ClusterUpgradeGKEUpgradeFeatureStateResponseGkehubV1alpha {
  ...
  final pulumi.Input<
    List<ClusterUpgradeGKEUpgradeFeatureConditionResponseGkehubV1alpha>
  >
  conditions;

  /// Upgrade state. It will eventually replace `state`.
  final pulumi.Input<List<ClusterUpgradeGKEUpgradeStateResponseGkehubV1alpha>>
  upgradeState;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'upgradeState':
          pulumi.Input.mapInputValue<
            List<ClusterUpgradeGKEUpgradeStateResponseGkehubV1alpha>,
            List<Map<String, dynamic>>
          >(
            upgradeState,
            (value) =>
