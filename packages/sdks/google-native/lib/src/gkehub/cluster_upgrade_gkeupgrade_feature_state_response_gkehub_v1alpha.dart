...
class ClusterUpgradeGKEUpgradeFeatureStateResponseGkehubV1alpha {
  ...
  factory ClusterUpgradeGKEUpgradeFeatureStateResponseGkehubV1alpha.fromMap(Map<String, dynamic> map) {
    return ClusterUpgradeGKEUpgradeFeatureStateResponseGkehubV1alpha(
      conditions: (pulumi.Input.decodeList<ClusterUpgradeGKEUpgradeFeatureConditionResponseGkehubV1alpha>(map['conditions'], (value) => ClusterUpgradeGKEUpgradeFeatureConditionResponseGkehubV1alpha.fromMap((value as Map).cast<String, dynamic>()))).input(),
      upgradeState: (pulumi.Input.decodeList<ClusterUpgradeGKEUpgradeStateResponseGkehubV1alpha>(map['upgradeState'], (value) => ClusterUpgradeGKEUpgradeStateResponseGkehubV1alpha.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
