...
/// {@template pulumi_gkehub_v1alpha_scope_iam_binding_gkehub_v1alpha_args_doc}
/// The set of arguments for ScopeIamBinding.
/// {@endtemplate}
/// {@macro pulumi_gkehub_v1alpha_scope_iam_binding_gkehub_v1alpha_args_doc}
class ScopeIamBindingGkehubV1alphaArgs {
  ...
  /// Creates a new [ScopeIamBindingGkehubV1alphaArgs].
  ...
  const ScopeIamBindingGkehubV1alphaArgs({
    this.condition,
  ...
  factory ScopeIamBindingGkehubV1alphaArgs.fromMap(Map<String, dynamic> map) {
    return ScopeIamBindingGkehubV1alphaArgs(
