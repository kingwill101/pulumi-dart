...
class ServiceMeshAnalysisMessageResponse {
  ...
  factory ServiceMeshAnalysisMessageResponse.fromMap(Map<String, dynamic> map) {
    return ServiceMeshAnalysisMessageResponse(
      ...
      messageBase: pulumi.Input.fromValue(ServiceMeshAnalysisMessageBaseResponse.fromMap((map['messageBase']! as Map).cast<String, dynamic>())),
      resourcePaths: pulumi.Input.fromValue((map['resourcePaths'] as List).cast<String>()),
    );
  }
}
