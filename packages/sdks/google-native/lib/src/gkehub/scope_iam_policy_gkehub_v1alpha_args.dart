...
import 'binding_resource.dart';

/// {@template pulumi_gkehub_v1alpha_scope_iam_policy_gkehub_v1alpha_args_doc}
/// The set of arguments for ScopeIamPolicy.
/// {@endtemplate}
/// {@macro pulumi_gkehub_v1alpha_scope_iam_policy_gkehub_v1alpha_args_doc}
class ScopeIamPolicyGkehubV1alphaArgs {
  ...
  final pulumi.Input<List<BindingResource>>? bindings;
  ...
  /// Creates a new [ScopeIamPolicyGkehubV1alphaArgs].
  ...
  /// [version] Specifies the format of the policy. Valid values are `0`, `1`, and `3`. Requests that specify an invalid value are rejected. Any operation that affects conditional role bindings must specify version `3`. This requirement applies to the following operations: * Getting a policy that includes a conditional role binding * Adding a conditional role binding to a policy * Changing a conditional role binding in a policy * Removing any role binding, with or without a condition, from a policy that includes conditions **Important:** If you use IAM Conditions, you must include the `etag` field whenever you call `setIamPolicy`. If you omit this field, then IAM allows you to overwrite a version `3` policy with a version `1` policy, and all of the conditions in the version `3` policy are lost. If a policy does not include any conditions, operations on that policy may specify any valid version or leave the field unset. To learn which resources support conditions in their IAM policies, see the [IAM documentation](https://cloud.google.com/iam/help/conditions/resource-policies).
  ScopeIamPolicyGkehubV1alphaArgs({
    pulumi.Output<List<AuditConfigGkehubV1alpha>>? auditConfigs,
    pulumi.Output<List<BindingResource>>? bindings,
    ...
    pulumi.Output<int>? version,
      ...
      auditConfigs = pulumi.Input.asOptionalInput<List<AuditConfigGkehubV1alpha>>(auditConfigs),
      bindings = pulumi.Input.asOptionalInput<List<BindingResource>>(bindings),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'auditConfigs': ?pulumi.Input.mapOptionalInputValue<List<AuditConfigGkehubV1alpha>, List<Map<String, dynamic>>>(auditConfigs, (value) => pulumi.Input.encodeList<AuditConfigGkehubV1alpha, Map<String, dynamic>>(value, (value) => value.toMap())),
      'bindings': ?bindings,
      'etag': ?etag,
      'location': ?location,
      'project': ?project,
  ...
  factory ScopeIamPolicyGkehubV1alphaArgs.fromMap(Map<String, dynamic> map) {
    return ScopeIamPolicyGkehubV1alphaArgs(
      auditConfigs: map['auditConfigs'] == null ? null : pulumi.Output.create<List<AuditConfigGkehubV1alpha>>(pulumi.Input.decodeList<AuditConfigGkehubV1alpha>(map['auditConfigs'], (value) => AuditConfigGkehubV1alpha.fromMap((value as Map).cast<String, dynamic>()))),
      bindings: map['bindings'] == null ? null : pulumi.Output.create<List<BindingResource>>((map['bindings'] as List).cast<BindingResource>()),
