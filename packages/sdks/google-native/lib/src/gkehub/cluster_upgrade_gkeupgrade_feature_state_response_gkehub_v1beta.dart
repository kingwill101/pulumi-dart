...
class ClusterUpgradeGKEUpgradeFeatureStateResponseGkehubV1beta {
  ...
  final pulumi.Input<
    List<ClusterUpgradeGKEUpgradeFeatureConditionResponseGkehubV1beta>
  >
  conditions;

  /// Upgrade state. It will eventually replace `state`.
  final pulumi.Input<List<ClusterUpgradeGKEUpgradeStateResponseGkehubV1beta>>
  upgradeState;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'upgradeState':
          pulumi.Input.mapInputValue<
            List<ClusterUpgradeGKEUpgradeStateResponseGkehubV1beta>,
            List<Map<String, dynamic>>
          >(
            upgradeState,
            (value) =>
