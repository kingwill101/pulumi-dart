...
class ClusterUpgradeGKEUpgradeFeatureStateResponseGkehubV1beta {
  ...
  factory ClusterUpgradeGKEUpgradeFeatureStateResponseGkehubV1beta.fromMap(Map<String, dynamic> map) {
    return ClusterUpgradeGKEUpgradeFeatureStateResponseGkehubV1beta(
      conditions: (pulumi.Input.decodeList<ClusterUpgradeGKEUpgradeFeatureConditionResponseGkehubV1beta>(map['conditions'], (value) => ClusterUpgradeGKEUpgradeFeatureConditionResponseGkehubV1beta.fromMap((value as Map).cast<String, dynamic>()))).input(),
      upgradeState: (pulumi.Input.decodeList<ClusterUpgradeGKEUpgradeStateResponseGkehubV1beta>(map['upgradeState'], (value) => ClusterUpgradeGKEUpgradeStateResponseGkehubV1beta.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
