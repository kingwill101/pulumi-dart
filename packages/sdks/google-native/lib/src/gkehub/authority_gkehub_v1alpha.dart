...
class AuthorityGkehubV1alpha {
  ...
  /// Creates a new [AuthorityGkehubV1alpha].
  ...
  factory AuthorityGkehubV1alpha.fromMap(Map<String, dynamic> map) {
    return AuthorityGkehubV1alpha(
      ...
      oidcJwks: (() { final guardedValue = map['oidcJwks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
