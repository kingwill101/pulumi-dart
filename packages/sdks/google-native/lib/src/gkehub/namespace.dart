...
class Namespace extends pulumi.CustomResource {
  ...
  Namespace(
    ...
    state = registerOutput<NamespaceLifecycleStateResponse>('state', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return NamespaceLifecycleStateResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
