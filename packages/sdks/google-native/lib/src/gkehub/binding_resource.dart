...
class BindingResource extends pulumi.CustomResource {
  ...
  late final pulumi.Output<MembershipBindingLifecycleStateResponseGkehubV1alpha> state;
  ...
  BindingResource(
    ...
    state = registerOutput<MembershipBindingLifecycleStateResponseGkehubV1alpha>('state', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return MembershipBindingLifecycleStateResponseGkehubV1alpha.fromMap((guardedValue as Map).cast<String, dynamic>()); });
