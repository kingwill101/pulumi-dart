...
class ExprGkehubV1alpha2 {
  ...
  /// Creates a new [ExprGkehubV1alpha2].
  ...
  factory ExprGkehubV1alpha2.fromMap(Map<String, dynamic> map) {
    return ExprGkehubV1alpha2(
