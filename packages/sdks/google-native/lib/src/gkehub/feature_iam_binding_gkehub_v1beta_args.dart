...
/// {@template pulumi_gkehub_v1beta_feature_iam_binding_gkehub_v1beta_args_doc}
/// The set of arguments for FeatureIamBinding.
/// {@endtemplate}
/// {@macro pulumi_gkehub_v1beta_feature_iam_binding_gkehub_v1beta_args_doc}
class FeatureIamBindingGkehubV1betaArgs {
  ...
  /// Creates a new [FeatureIamBindingGkehubV1betaArgs].
  ...
  const FeatureIamBindingGkehubV1betaArgs({
    this.condition,
  ...
  factory FeatureIamBindingGkehubV1betaArgs.fromMap(Map<String, dynamic> map) {
    return FeatureIamBindingGkehubV1betaArgs(
