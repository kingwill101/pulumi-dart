...
class DefaultClusterConfigResponseGkehubV1beta {
  ...
  final pulumi.Input<BinaryAuthorizationConfigResponseGkehubV1beta>
  binaryAuthorizationConfig;

  /// Enable/Disable Security Posture features for the cluster.
  final pulumi.Input<SecurityPostureConfigResponseGkehubV1beta>
  ...
  factory DefaultClusterConfigResponseGkehubV1beta.fromMap(
    ...
    return DefaultClusterConfigResponseGkehubV1beta(
      ...
      securityPostureConfig: pulumi.Input.fromValue(
        SecurityPostureConfigResponseGkehubV1beta.fromMap(
