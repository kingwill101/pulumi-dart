...
class DefaultClusterConfigResponseGkehubV1beta {
  ...
  factory DefaultClusterConfigResponseGkehubV1beta.fromMap(Map<String, dynamic> map) {
    return DefaultClusterConfigResponseGkehubV1beta(
      binaryAuthorizationConfig: (BinaryAuthorizationConfigResponseGkehubV1beta.fromMap((map['binaryAuthorizationConfig'] as Map).cast<String, dynamic>())).input(),
      securityPostureConfig: (SecurityPostureConfigResponseGkehubV1beta.fromMap((map['securityPostureConfig'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
