...
/// {@template pulumi_gkehub_v1beta_scope_iam_member_gkehub_v1beta_args_doc}
/// The set of arguments for ScopeIamMember.
/// {@endtemplate}
/// {@macro pulumi_gkehub_v1beta_scope_iam_member_gkehub_v1beta_args_doc}
class ScopeIamMemberGkehubV1betaArgs {
  ...
  /// Creates a new [ScopeIamMemberGkehubV1betaArgs].
  ...
  const ScopeIamMemberGkehubV1betaArgs({
    this.condition,
  ...
  factory ScopeIamMemberGkehubV1betaArgs.fromMap(Map<String, dynamic> map) {
    return ScopeIamMemberGkehubV1betaArgs(
