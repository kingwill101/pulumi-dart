...
/// {@template pulumi_gkehub_v1beta_membership_iam_binding_gkehub_v1beta_args_doc}
/// The set of arguments for MembershipIamBinding.
/// {@endtemplate}
/// {@macro pulumi_gkehub_v1beta_membership_iam_binding_gkehub_v1beta_args_doc}
class MembershipIamBindingGkehubV1betaArgs {
  ...
  /// Creates a new [MembershipIamBindingGkehubV1betaArgs].
  ...
  const MembershipIamBindingGkehubV1betaArgs({
    this.condition,
  ...
  factory MembershipIamBindingGkehubV1betaArgs.fromMap(Map<String, dynamic> map) {
    return MembershipIamBindingGkehubV1betaArgs(
