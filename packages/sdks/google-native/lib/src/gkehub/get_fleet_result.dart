...
class GetFleetResult {
  ...
  factory GetFleetResult.fromMap(Map<String, dynamic> map) {
    return GetFleetResult(
      ...
      defaultClusterConfig: DefaultClusterConfigResponse.fromMap((map['defaultClusterConfig']! as Map).cast<String, dynamic>()),
      deleteTime: map['deleteTime'] as String,
      displayName: map['displayName'] as String,
      labels: (map['labels'] as Map).cast<String, String>(),
      name: map['name'] as String,
      state: FleetLifecycleStateResponse.fromMap((map['state']! as Map).cast<String, dynamic>()),
