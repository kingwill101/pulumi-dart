...
class AuditConfigResponseGkehubV1alpha2 {
  ...
  final pulumi.Input<List<AuditLogConfigResponseGkehubV1alpha2>>
  auditLogConfigs;
    ...
    return <String, dynamic>{
      'auditLogConfigs':
          pulumi.Input.mapInputValue<
            List<AuditLogConfigResponseGkehubV1alpha2>,
  ...
  factory AuditConfigResponseGkehubV1alpha2.fromMap(Map<String, dynamic> map) {
    return AuditConfigResponseGkehubV1alpha2(
      auditLogConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<AuditLogConfigResponseGkehubV1alpha2>(
          map['auditLogConfigs']!,
          (value) => AuditLogConfigResponseGkehubV1alpha2.fromMap(
