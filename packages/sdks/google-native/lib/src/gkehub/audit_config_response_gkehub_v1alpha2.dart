...
class AuditConfigResponseGkehubV1alpha2 {
  ...
  factory AuditConfigResponseGkehubV1alpha2.fromMap(Map<String, dynamic> map) {
    return AuditConfigResponseGkehubV1alpha2(
      auditLogConfigs: (pulumi.Input.decodeList<AuditLogConfigResponseGkehubV1alpha2>(map['auditLogConfigs'], (value) => AuditLogConfigResponseGkehubV1alpha2.fromMap((value as Map).cast<String, dynamic>()))).input(),
