...
class KubernetesResourceResponseGkehubV1beta1 {
  ...
  const KubernetesResourceResponseGkehubV1beta1({
  ...
  factory KubernetesResourceResponseGkehubV1beta1.fromMap(Map<String, dynamic> map) {
    return KubernetesResourceResponseGkehubV1beta1(
      connectResources: pulumi.Input.fromValue(pulumi.Input.decodeList<ResourceManifestResponseGkehubV1beta1>(map['connectResources']!, (value) => ResourceManifestResponseGkehubV1beta1.fromMap((value as Map).cast<String, dynamic>()))),
      membershipCrManifest: pulumi.Input.fromValue(map['membershipCrManifest'] as String),
      membershipResources: pulumi.Input.fromValue(pulumi.Input.decodeList<ResourceManifestResponseGkehubV1beta1>(map['membershipResources']!, (value) => ResourceManifestResponseGkehubV1beta1.fromMap((value as Map).cast<String, dynamic>()))),
      resourceOptions: pulumi.Input.fromValue(ResourceOptionsResponseGkehubV1beta1.fromMap((map['resourceOptions']! as Map).cast<String, dynamic>())),
    );
  }
}
