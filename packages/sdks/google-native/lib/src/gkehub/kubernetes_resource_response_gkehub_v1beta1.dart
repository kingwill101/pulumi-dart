...
class KubernetesResourceResponseGkehubV1beta1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'connectResources': pulumi.Input.encodeList<ResourceManifestResponseGkehubV1beta1, Map<String, dynamic>>(connectResources, (value) => value.toMap()),
      'membershipCrManifest': membershipCrManifest,
      'membershipResources': pulumi.Input.encodeList<ResourceManifestResponseGkehubV1beta1, Map<String, dynamic>>(membershipResources, (value) => value.toMap()),
  ...
  factory KubernetesResourceResponseGkehubV1beta1.fromMap(Map<String, dynamic> map) {
    return KubernetesResourceResponseGkehubV1beta1(
      connectResources: pulumi.Input.decodeList<ResourceManifestResponseGkehubV1beta1>(map['connectResources'], (value) => ResourceManifestResponseGkehubV1beta1.fromMap((value as Map).cast<String, dynamic>())),
      membershipCrManifest: map['membershipCrManifest'] as String,
      membershipResources: pulumi.Input.decodeList<ResourceManifestResponseGkehubV1beta1>(map['membershipResources'], (value) => ResourceManifestResponseGkehubV1beta1.fromMap((value as Map).cast<String, dynamic>())),
      resourceOptions: ResourceOptionsResponseGkehubV1beta1.fromMap((map['resourceOptions'] as Map).cast<String, dynamic>()),
    );
  }
}
