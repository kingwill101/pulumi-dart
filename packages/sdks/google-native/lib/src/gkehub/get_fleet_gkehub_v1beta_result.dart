...
class GetFleetGkehubV1betaResult {
  ...
  const GetFleetGkehubV1betaResult({
  ...
  factory GetFleetGkehubV1betaResult.fromMap(Map<String, dynamic> map) {
    return GetFleetGkehubV1betaResult(
      ...
      defaultClusterConfig: DefaultClusterConfigResponseGkehubV1beta.fromMap((map['defaultClusterConfig']! as Map).cast<String, dynamic>()),
      deleteTime: map['deleteTime'] as String,
      displayName: map['displayName'] as String,
      labels: (map['labels'] as Map).cast<String, String>(),
      name: map['name'] as String,
      state: FleetLifecycleStateResponseGkehubV1beta.fromMap((map['state']! as Map).cast<String, dynamic>()),
