...
class PolicyControllerMonitoringConfigResponseGkehubV1beta {
  ...
  /// Creates a new [PolicyControllerMonitoringConfigResponseGkehubV1beta].
  ...
  const PolicyControllerMonitoringConfigResponseGkehubV1beta({
  ...
  factory PolicyControllerMonitoringConfigResponseGkehubV1beta.fromMap(Map<String, dynamic> map) {
