...
class DefaultClusterConfigResponse {
  ...
  const DefaultClusterConfigResponse({
  ...
  factory DefaultClusterConfigResponse.fromMap(Map<String, dynamic> map) {
    return DefaultClusterConfigResponse(
      binaryAuthorizationConfig: pulumi.Input.fromValue(BinaryAuthorizationConfigResponse.fromMap((map['binaryAuthorizationConfig']! as Map).cast<String, dynamic>())),
      securityPostureConfig: pulumi.Input.fromValue(SecurityPostureConfigResponse.fromMap((map['securityPostureConfig']! as Map).cast<String, dynamic>())),
    );
  }
}
