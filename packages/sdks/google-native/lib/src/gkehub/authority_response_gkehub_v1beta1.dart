...
class AuthorityResponseGkehubV1beta1 {
  ...
  /// Creates a new [AuthorityResponseGkehubV1beta1].
  ...
  const AuthorityResponseGkehubV1beta1({
  ...
  factory AuthorityResponseGkehubV1beta1.fromMap(Map<String, dynamic> map) {
    return AuthorityResponseGkehubV1beta1(
