...
/// {@template pulumi_gkehub_v1alpha_feature_iam_member_gkehub_v1alpha_args_doc}
/// The set of arguments for FeatureIamMember.
/// {@endtemplate}
/// {@macro pulumi_gkehub_v1alpha_feature_iam_member_gkehub_v1alpha_args_doc}
class FeatureIamMemberGkehubV1alphaArgs {
  ...
  /// Creates a new [FeatureIamMemberGkehubV1alphaArgs].
  ...
  const FeatureIamMemberGkehubV1alphaArgs({
    this.condition,
