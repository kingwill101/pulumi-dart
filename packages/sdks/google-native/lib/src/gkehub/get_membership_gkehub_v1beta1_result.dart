...
class GetMembershipGkehubV1beta1Result {
  /// Optional. How to identify workloads from this Membership. See the documentation on Workload Identity for more details: https://cloud.google.com/kubernetes-engine/docs/how-to/workload-identity
  final AuthorityResponseGkehubV1beta1 authority;
  ...
  final MembershipEndpointResponseGkehubV1beta1 endpoint;
  ...
  final MonitoringConfigResponseGkehubV1beta1 monitoringConfig;
  ...
  final MembershipStateResponseGkehubV1beta1 state;
  ...
  /// Creates a new [GetMembershipGkehubV1beta1Result].
  ...
  factory GetMembershipGkehubV1beta1Result.fromMap(Map<String, dynamic> map) {
    return GetMembershipGkehubV1beta1Result(
      authority: AuthorityResponseGkehubV1beta1.fromMap((map['authority']! as Map).cast<String, dynamic>()),
      createTime: map['createTime'] as String,
      deleteTime: map['deleteTime'] as String,
      description: map['description'] as String,
      endpoint: MembershipEndpointResponseGkehubV1beta1.fromMap((map['endpoint']! as Map).cast<String, dynamic>()),
      externalId: map['externalId'] as String,
      infrastructureType: map['infrastructureType'] as String,
      labels: (map['labels'] as Map).cast<String, String>(),
      lastConnectionTime: map['lastConnectionTime'] as String,
      monitoringConfig: MonitoringConfigResponseGkehubV1beta1.fromMap((map['monitoringConfig']! as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      state: MembershipStateResponseGkehubV1beta1.fromMap((map['state']! as Map).cast<String, dynamic>()),
