...
class GetMembershipGkehubV1beta1Result {
  ...
  factory GetMembershipGkehubV1beta1Result.fromMap(Map<String, dynamic> map) {
    return GetMembershipGkehubV1beta1Result(
      authority: AuthorityResponseGkehubV1beta1.fromMap(
        (map['authority']! as Map).cast<String, dynamic>(),
      ),
      createTime: map['createTime'] as String,
      deleteTime: map['deleteTime'] as String,
      description: map['description'] as String,
      endpoint: MembershipEndpointResponseGkehubV1beta1.fromMap(
      ...
      monitoringConfig: MonitoringConfigResponseGkehubV1beta1.fromMap(
        (map['monitoringConfig']! as Map).cast<String, dynamic>(),
      ),
      name: map['name'] as String,
      state: MembershipStateResponseGkehubV1beta1.fromMap(
