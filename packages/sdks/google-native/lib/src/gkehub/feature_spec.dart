    ...
    return <String, dynamic>{
      ...
      'provisionGoogleCa':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(provisionGoogleCa, (value) => value.wireValue),
    };
  }
    ...
    return FeatureSpec(
      defaultConfig: (() {
        ...
        return pulumi.Input.fromValue(
          MembershipSpec.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      provisionGoogleCa: (() {
        final guardedValue = map['provisionGoogleCa'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FeatureSpecProvisionGoogleCa.fromValue(guardedValue as String),
        );
      })(),
    );
  }
