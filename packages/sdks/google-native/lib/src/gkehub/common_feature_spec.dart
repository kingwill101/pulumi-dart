...
class CommonFeatureSpec {
  ...
  factory CommonFeatureSpec.fromMap(Map<String, dynamic> map) {
    return CommonFeatureSpec(
      appdevexperience: (() { final guardedValue = map['appdevexperience']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, dynamic>()); })(),
      clusterupgrade: (() { final guardedValue = map['clusterupgrade']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterUpgradeFleetSpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      fleetobservability: (() { final guardedValue = map['fleetobservability']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FleetObservabilityFeatureSpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      multiclusteringress: (() { final guardedValue = map['multiclusteringress']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MultiClusterIngressFeatureSpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
