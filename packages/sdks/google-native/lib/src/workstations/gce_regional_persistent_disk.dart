...
class GceRegionalPersistentDisk {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'diskType': ?diskType,
      'fsType': ?fsType,
      'reclaimPolicy': ?pulumi.Input.mapOptionalInputValue<GceRegionalPersistentDiskReclaimPolicy, String>(reclaimPolicy, (value) => value.wireValue),
      'sizeGb': ?sizeGb,
  ...
  factory GceRegionalPersistentDisk.fromMap(Map<String, dynamic> map) {
    return GceRegionalPersistentDisk(
      ...
      reclaimPolicy: (() { final guardedValue = map['reclaimPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GceRegionalPersistentDiskReclaimPolicy.fromValue(guardedValue as String)); })(),
