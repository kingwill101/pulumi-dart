...
class EphemeralDirectory {
  ...
  factory EphemeralDirectory.fromMap(Map<String, dynamic> map) {
    return EphemeralDirectory(
      gcePd: (() { final guardedValue = map['gcePd']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GcePersistentDisk.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
