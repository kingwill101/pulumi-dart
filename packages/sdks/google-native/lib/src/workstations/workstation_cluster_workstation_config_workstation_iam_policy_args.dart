...
/// {@template pulumi_workstations_v1_workstation_cluster_workstation_config_workstation_iam_policy_args_doc}
/// The set of arguments for WorkstationClusterWorkstationConfigWorkstationIamPolicy.
/// {@endtemplate}
/// {@macro pulumi_workstations_v1_workstation_cluster_workstation_config_workstation_iam_policy_args_doc}
class WorkstationClusterWorkstationConfigWorkstationIamPolicyArgs {
  ...
  /// Creates a new [WorkstationClusterWorkstationConfigWorkstationIamPolicyArgs].
  ...
  const WorkstationClusterWorkstationConfigWorkstationIamPolicyArgs({
    this.auditConfigs,
    this.bindings,
    this.etag,
    this.location,
  ...
  factory WorkstationClusterWorkstationConfigWorkstationIamPolicyArgs.fromMap(Map<String, dynamic> map) {
