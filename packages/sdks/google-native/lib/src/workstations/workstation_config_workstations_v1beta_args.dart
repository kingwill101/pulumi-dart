...
class WorkstationConfigWorkstationsV1betaArgs {
  ...
  factory WorkstationConfigWorkstationsV1betaArgs.fromMap(Map<String, dynamic> map) {
    return WorkstationConfigWorkstationsV1betaArgs(
      ...
      container: map['container'] == null ? null : (ContainerWorkstationsV1beta.fromMap((map['container'] as Map).cast<String, dynamic>())).input(),
      ...
      encryptionKey: map['encryptionKey'] == null ? null : (CustomerEncryptionKeyWorkstationsV1beta.fromMap((map['encryptionKey'] as Map).cast<String, dynamic>())).input(),
      ephemeralDirectories: map['ephemeralDirectories'] == null ? null : (pulumi.Input.decodeList<EphemeralDirectory>(map['ephemeralDirectories'], (value) => EphemeralDirectory.fromMap((value as Map).cast<String, dynamic>()))).input(),
      etag: map['etag'] == null ? null : (map['etag'] as String).input(),
      host: map['host'] == null ? null : (HostWorkstationsV1beta.fromMap((map['host'] as Map).cast<String, dynamic>())).input(),
      idleTimeout: map['idleTimeout'] == null ? null : (map['idleTimeout'] as String).input(),
      labels: map['labels'] == null ? null : ((map['labels'] as Map).cast<String, String>()).input(),
      location: map['location'] == null ? null : (map['location'] as String).input(),
      name: map['name'] == null ? null : (map['name'] as String).input(),
      persistentDirectories: map['persistentDirectories'] == null ? null : (pulumi.Input.decodeList<PersistentDirectoryWorkstationsV1beta>(map['persistentDirectories'], (value) => PersistentDirectoryWorkstationsV1beta.fromMap((value as Map).cast<String, dynamic>()))).input(),
      project: map['project'] == null ? null : (map['project'] as String).input(),
      readinessChecks: map['readinessChecks'] == null ? null : (pulumi.Input.decodeList<ReadinessCheckWorkstationsV1beta>(map['readinessChecks'], (value) => ReadinessCheckWorkstationsV1beta.fromMap((value as Map).cast<String, dynamic>()))).input(),
