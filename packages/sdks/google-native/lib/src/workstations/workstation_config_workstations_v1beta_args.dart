...
class WorkstationConfigWorkstationsV1betaArgs {
  ...
  WorkstationConfigWorkstationsV1betaArgs({
    ...
    pulumi.Output<ContainerWorkstationsV1beta>? container,
    pulumi.Output<bool>? disableTcpConnections,
    pulumi.Output<String>? displayName,
    pulumi.Output<bool>? enableAuditAgent,
    pulumi.Output<CustomerEncryptionKeyWorkstationsV1beta>? encryptionKey,
    pulumi.Output<List<EphemeralDirectory>>? ephemeralDirectories,
    pulumi.Output<String>? etag,
    pulumi.Output<HostWorkstationsV1beta>? host,
    pulumi.Output<String>? idleTimeout,
    pulumi.Output<Map<String, String>>? labels,
    pulumi.Output<String>? location,
    pulumi.Output<String>? name,
    pulumi.Output<List<PersistentDirectoryWorkstationsV1beta>>? persistentDirectories,
    pulumi.Output<String>? project,
    pulumi.Output<List<ReadinessCheckWorkstationsV1beta>>? readinessChecks,
    ...
    required pulumi.Output<String> workstationConfigId,
      ...
      container = pulumi.Input.asOptionalInput<ContainerWorkstationsV1beta>(container),
      ...
      encryptionKey = pulumi.Input.asOptionalInput<CustomerEncryptionKeyWorkstationsV1beta>(encryptionKey),
      ephemeralDirectories = pulumi.Input.asOptionalInput<List<EphemeralDirectory>>(ephemeralDirectories),
      ...
      persistentDirectories = pulumi.Input.asOptionalInput<List<PersistentDirectoryWorkstationsV1beta>>(persistentDirectories),
      project = pulumi.Input.asOptionalInput<String>(project),
      readinessChecks = pulumi.Input.asOptionalInput<List<ReadinessCheckWorkstationsV1beta>>(readinessChecks),
  ...
  factory WorkstationConfigWorkstationsV1betaArgs.fromMap(Map<String, dynamic> map) {
    return WorkstationConfigWorkstationsV1betaArgs(
      ...
      container: map['container'] == null ? null : pulumi.Output.create<ContainerWorkstationsV1beta>(ContainerWorkstationsV1beta.fromMap((map['container'] as Map).cast<String, dynamic>())),
      ...
      encryptionKey: map['encryptionKey'] == null ? null : pulumi.Output.create<CustomerEncryptionKeyWorkstationsV1beta>(CustomerEncryptionKeyWorkstationsV1beta.fromMap((map['encryptionKey'] as Map).cast<String, dynamic>())),
      ephemeralDirectories: map['ephemeralDirectories'] == null ? null : pulumi.Output.create<List<EphemeralDirectory>>(pulumi.Input.decodeList<EphemeralDirectory>(map['ephemeralDirectories'], (value) => EphemeralDirectory.fromMap((value as Map).cast<String, dynamic>()))),
      etag: map['etag'] == null ? null : pulumi.Output.create<String>(map['etag'] as String),
      host: map['host'] == null ? null : pulumi.Output.create<HostWorkstationsV1beta>(HostWorkstationsV1beta.fromMap((map['host'] as Map).cast<String, dynamic>())),
      ...
      persistentDirectories: map['persistentDirectories'] == null ? null : pulumi.Output.create<List<PersistentDirectoryWorkstationsV1beta>>(pulumi.Input.decodeList<PersistentDirectoryWorkstationsV1beta>(map['persistentDirectories'], (value) => PersistentDirectoryWorkstationsV1beta.fromMap((value as Map).cast<String, dynamic>()))),
      project: map['project'] == null ? null : pulumi.Output.create<String>(map['project'] as String),
      readinessChecks: map['readinessChecks'] == null ? null : pulumi.Output.create<List<ReadinessCheckWorkstationsV1beta>>(pulumi.Input.decodeList<ReadinessCheckWorkstationsV1beta>(map['readinessChecks'], (value) => ReadinessCheckWorkstationsV1beta.fromMap((value as Map).cast<String, dynamic>()))),
