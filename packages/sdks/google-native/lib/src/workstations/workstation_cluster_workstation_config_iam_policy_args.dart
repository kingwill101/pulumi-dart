...
/// {@template pulumi_workstations_v1_workstation_cluster_workstation_config_iam_policy_args_doc}
/// The set of arguments for WorkstationClusterWorkstationConfigIamPolicy.
/// {@endtemplate}
/// {@macro pulumi_workstations_v1_workstation_cluster_workstation_config_iam_policy_args_doc}
class WorkstationClusterWorkstationConfigIamPolicyArgs {
  ...
  /// Creates a new [WorkstationClusterWorkstationConfigIamPolicyArgs].
  ...
  const WorkstationClusterWorkstationConfigIamPolicyArgs({
    this.auditConfigs,
    this.bindings,
    this.etag,
    this.location,
  ...
  factory WorkstationClusterWorkstationConfigIamPolicyArgs.fromMap(Map<String, dynamic> map) {
