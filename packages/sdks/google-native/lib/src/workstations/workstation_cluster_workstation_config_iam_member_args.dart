...
/// {@template pulumi_workstations_v1_workstation_cluster_workstation_config_iam_member_args_doc}
/// The set of arguments for WorkstationClusterWorkstationConfigIamMember.
/// {@endtemplate}
/// {@macro pulumi_workstations_v1_workstation_cluster_workstation_config_iam_member_args_doc}
class WorkstationClusterWorkstationConfigIamMemberArgs {
  ...
  /// Creates a new [WorkstationClusterWorkstationConfigIamMemberArgs].
  ...
  const WorkstationClusterWorkstationConfigIamMemberArgs({
    this.condition,
  ...
  factory WorkstationClusterWorkstationConfigIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return WorkstationClusterWorkstationConfigIamMemberArgs(
