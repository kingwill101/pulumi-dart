...
class GceInstanceWorkstationsV1beta {
  ...
  final pulumi.Input<GceConfidentialInstanceConfigWorkstationsV1beta>? confidentialInstanceConfig;
  ...
  final pulumi.Input<GceShieldedInstanceConfigWorkstationsV1beta>? shieldedInstanceConfig;
  ...
  const GceInstanceWorkstationsV1beta({
    this.accelerators,
    this.bootDiskSizeGb,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'confidentialInstanceConfig': ?pulumi.Input.mapOptionalInputValue<GceConfidentialInstanceConfigWorkstationsV1beta, Map<String, dynamic>>(confidentialInstanceConfig, (value) => value.toMap()),
      ...
      'shieldedInstanceConfig': ?pulumi.Input.mapOptionalInputValue<GceShieldedInstanceConfigWorkstationsV1beta, Map<String, dynamic>>(shieldedInstanceConfig, (value) => value.toMap()),
      'tags': ?tags,
    };
  }
  ...
  factory GceInstanceWorkstationsV1beta.fromMap(Map<String, dynamic> map) {
    return GceInstanceWorkstationsV1beta(
      ...
      confidentialInstanceConfig: (() { final guardedValue = map['confidentialInstanceConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GceConfidentialInstanceConfigWorkstationsV1beta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      shieldedInstanceConfig: (() { final guardedValue = map['shieldedInstanceConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GceShieldedInstanceConfigWorkstationsV1beta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
