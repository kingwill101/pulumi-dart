...
import 'gce_confidential_instance_config.dart';
import 'gce_shielded_instance_config.dart';
...
class GceInstance {
  ...
  final pulumi.Input<GceConfidentialInstanceConfig>? confidentialInstanceConfig;
  ...
  final pulumi.Input<GceShieldedInstanceConfig>? shieldedInstanceConfig;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'confidentialInstanceConfig': ?pulumi.Input.mapOptionalInputValue<GceConfidentialInstanceConfig, Map<String, dynamic>>(confidentialInstanceConfig, (value) => value.toMap()),
      ...
      'shieldedInstanceConfig': ?pulumi.Input.mapOptionalInputValue<GceShieldedInstanceConfig, Map<String, dynamic>>(shieldedInstanceConfig, (value) => value.toMap()),
      'tags': ?tags,
    };
  }
  ...
  factory GceInstance.fromMap(Map<String, dynamic> map) {
    return GceInstance(
      ...
      confidentialInstanceConfig: (() { final guardedValue = map['confidentialInstanceConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GceConfidentialInstanceConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      shieldedInstanceConfig: (() { final guardedValue = map['shieldedInstanceConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GceShieldedInstanceConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
