...
class GceRegionalPersistentDiskWorkstationsV1beta {
  ...
  final pulumi.Input<GceRegionalPersistentDiskReclaimPolicyWorkstationsV1beta>?
  reclaimPolicy;
  ...
  GceRegionalPersistentDiskWorkstationsV1beta({
    this.diskType,
    this.fsType,
    this.reclaimPolicy,
    this.sizeGb,
    ...
    return <String, dynamic>{
      ...
      'reclaimPolicy':
          ?pulumi.Input.mapOptionalInputValue<
            GceRegionalPersistentDiskReclaimPolicyWorkstationsV1beta,
            String
          >(reclaimPolicy, (value) => value.wireValue),
      'sizeGb': ?sizeGb,
      'sourceSnapshot': ?sourceSnapshot,
    };
  }

  factory GceRegionalPersistentDiskWorkstationsV1beta.fromMap(
    ...
    return GceRegionalPersistentDiskWorkstationsV1beta(
      ...
      reclaimPolicy: (() {
        ...
        return pulumi.Input.fromValue(
          GceRegionalPersistentDiskReclaimPolicyWorkstationsV1beta.fromValue(
