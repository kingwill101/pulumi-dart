...
class GceRegionalPersistentDiskWorkstationsV1beta {
  ...
  final GceRegionalPersistentDiskReclaimPolicyWorkstationsV1beta? reclaimPolicy;
  ...
  factory GceRegionalPersistentDiskWorkstationsV1beta.fromMap(Map<String, dynamic> map) {
    return GceRegionalPersistentDiskWorkstationsV1beta(
      ...
      reclaimPolicy: map['reclaimPolicy'] == null ? null : GceRegionalPersistentDiskReclaimPolicyWorkstationsV1beta.fromValue(map['reclaimPolicy'] as String),
