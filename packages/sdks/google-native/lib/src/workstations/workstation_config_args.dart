...
class WorkstationConfigArgs {
  ...
  factory WorkstationConfigArgs.fromMap(Map<String, dynamic> map) {
    return WorkstationConfigArgs(
      ...
      encryptionKey: map['encryptionKey'] == null ? null : (CustomerEncryptionKey.fromMap((map['encryptionKey']! as Map).cast<String, dynamic>())).input(),
      etag: map['etag'] == null ? null : (map['etag']! as String).input(),
      host: map['host'] == null ? null : (Host.fromMap((map['host']! as Map).cast<String, dynamic>())).input(),
      idleTimeout: map['idleTimeout'] == null ? null : (map['idleTimeout']! as String).input(),
      labels: map['labels'] == null ? null : ((map['labels']! as Map).cast<String, String>()).input(),
      location: map['location'] == null ? null : (map['location']! as String).input(),
      name: map['name'] == null ? null : (map['name']! as String).input(),
      persistentDirectories: map['persistentDirectories'] == null ? null : (pulumi.Input.decodeList<PersistentDirectory>(map['persistentDirectories']!, (value) => PersistentDirectory.fromMap((value as Map).cast<String, dynamic>()))).input(),
      project: map['project'] == null ? null : (map['project']! as String).input(),
      readinessChecks: map['readinessChecks'] == null ? null : (pulumi.Input.decodeList<ReadinessCheck>(map['readinessChecks']!, (value) => ReadinessCheck.fromMap((value as Map).cast<String, dynamic>()))).input(),
