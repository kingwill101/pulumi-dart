...
class WorkstationConfigArgs {
  ...
  WorkstationConfigArgs({
    ...
    pulumi.Output<Container>? container,
    pulumi.Output<String>? displayName,
    pulumi.Output<CustomerEncryptionKey>? encryptionKey,
    pulumi.Output<String>? etag,
    pulumi.Output<Host>? host,
    pulumi.Output<String>? idleTimeout,
    pulumi.Output<Map<String, String>>? labels,
    pulumi.Output<String>? location,
    pulumi.Output<String>? name,
    pulumi.Output<List<PersistentDirectory>>? persistentDirectories,
    pulumi.Output<String>? project,
    pulumi.Output<List<ReadinessCheck>>? readinessChecks,
    ...
    required pulumi.Output<String> workstationConfigId,
      ...
      encryptionKey = pulumi.Input.asOptionalInput<CustomerEncryptionKey>(encryptionKey),
      ...
      persistentDirectories = pulumi.Input.asOptionalInput<List<PersistentDirectory>>(persistentDirectories),
      project = pulumi.Input.asOptionalInput<String>(project),
      readinessChecks = pulumi.Input.asOptionalInput<List<ReadinessCheck>>(readinessChecks),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'encryptionKey': ?pulumi.Input.mapOptionalInputValue<CustomerEncryptionKey, Map<String, dynamic>>(encryptionKey, (value) => value.toMap()),
      'etag': ?etag,
      'host': ?pulumi.Input.mapOptionalInputValue<Host, Map<String, dynamic>>(host, (value) => value.toMap()),
      'idleTimeout': ?idleTimeout,
      'labels': ?labels,
      'location': ?location,
      'name': ?name,
      'persistentDirectories': ?pulumi.Input.mapOptionalInputValue<List<PersistentDirectory>, List<Map<String, dynamic>>>(persistentDirectories, (value) => pulumi.Input.encodeList<PersistentDirectory, Map<String, dynamic>>(value, (value) => value.toMap())),
      'project': ?project,
      'readinessChecks': ?pulumi.Input.mapOptionalInputValue<List<ReadinessCheck>, List<Map<String, dynamic>>>(readinessChecks, (value) => pulumi.Input.encodeList<ReadinessCheck, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory WorkstationConfigArgs.fromMap(Map<String, dynamic> map) {
    return WorkstationConfigArgs(
      ...
      container: map['container'] == null ? null : pulumi.Output.create<Container>(Container.fromMap((map['container'] as Map).cast<String, dynamic>())),
      displayName: map['displayName'] == null ? null : pulumi.Output.create<String>(map['displayName'] as String),
      encryptionKey: map['encryptionKey'] == null ? null : pulumi.Output.create<CustomerEncryptionKey>(CustomerEncryptionKey.fromMap((map['encryptionKey'] as Map).cast<String, dynamic>())),
      etag: map['etag'] == null ? null : pulumi.Output.create<String>(map['etag'] as String),
      host: map['host'] == null ? null : pulumi.Output.create<Host>(Host.fromMap((map['host'] as Map).cast<String, dynamic>())),
      ...
      persistentDirectories: map['persistentDirectories'] == null ? null : pulumi.Output.create<List<PersistentDirectory>>(pulumi.Input.decodeList<PersistentDirectory>(map['persistentDirectories'], (value) => PersistentDirectory.fromMap((value as Map).cast<String, dynamic>()))),
      project: map['project'] == null ? null : pulumi.Output.create<String>(map['project'] as String),
      readinessChecks: map['readinessChecks'] == null ? null : pulumi.Output.create<List<ReadinessCheck>>(pulumi.Input.decodeList<ReadinessCheck>(map['readinessChecks'], (value) => ReadinessCheck.fromMap((value as Map).cast<String, dynamic>()))),
