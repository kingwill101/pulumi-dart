...
/// {@template pulumi_workstations_v1_workstation_cluster_workstation_config_workstation_iam_binding_args_doc}
/// The set of arguments for WorkstationClusterWorkstationConfigWorkstationIamBinding.
/// {@endtemplate}
/// {@macro pulumi_workstations_v1_workstation_cluster_workstation_config_workstation_iam_binding_args_doc}
class WorkstationClusterWorkstationConfigWorkstationIamBindingArgs {
  ...
  /// Creates a new [WorkstationClusterWorkstationConfigWorkstationIamBindingArgs].
  ...
  const WorkstationClusterWorkstationConfigWorkstationIamBindingArgs({
    this.condition,
  ...
  factory WorkstationClusterWorkstationConfigWorkstationIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return WorkstationClusterWorkstationConfigWorkstationIamBindingArgs(
