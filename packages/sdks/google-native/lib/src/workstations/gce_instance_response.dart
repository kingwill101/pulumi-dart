...
class GceInstanceResponse {
  ...
  factory GceInstanceResponse.fromMap(Map<String, dynamic> map) {
    return GceInstanceResponse(
      ...
      confidentialInstanceConfig: GceConfidentialInstanceConfigResponse.fromMap((map['confidentialInstanceConfig'] as Map).cast<String, dynamic>()),
      ...
      shieldedInstanceConfig: GceShieldedInstanceConfigResponse.fromMap((map['shieldedInstanceConfig'] as Map).cast<String, dynamic>()),
