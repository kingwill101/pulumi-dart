...
class GceInstanceResponseWorkstationsV1beta {
  ...
  final pulumi.Input<GceConfidentialInstanceConfigResponseWorkstationsV1beta> confidentialInstanceConfig;
  ...
  final pulumi.Input<GceShieldedInstanceConfigResponseWorkstationsV1beta> shieldedInstanceConfig;
  ...
  const GceInstanceResponseWorkstationsV1beta({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'confidentialInstanceConfig': pulumi.Input.mapInputValue<GceConfidentialInstanceConfigResponseWorkstationsV1beta, Map<String, dynamic>>(confidentialInstanceConfig, (value) => value.toMap()),
      ...
      'shieldedInstanceConfig': pulumi.Input.mapInputValue<GceShieldedInstanceConfigResponseWorkstationsV1beta, Map<String, dynamic>>(shieldedInstanceConfig, (value) => value.toMap()),
      'tags': tags,
    };
  }
  ...
  factory GceInstanceResponseWorkstationsV1beta.fromMap(Map<String, dynamic> map) {
    return GceInstanceResponseWorkstationsV1beta(
      ...
      confidentialInstanceConfig: pulumi.Input.fromValue(GceConfidentialInstanceConfigResponseWorkstationsV1beta.fromMap((map['confidentialInstanceConfig']! as Map).cast<String, dynamic>())),
      disablePublicIpAddresses: pulumi.Input.fromValue(map['disablePublicIpAddresses'] as bool),
      ...
      poolSize: pulumi.Input.fromValue(map['poolSize'] as int),
      pooledInstances: pulumi.Input.fromValue(map['pooledInstances'] as int),
      serviceAccount: pulumi.Input.fromValue(map['serviceAccount'] as String),
      serviceAccountScopes: pulumi.Input.fromValue((map['serviceAccountScopes'] as List).cast<String>()),
      shieldedInstanceConfig: pulumi.Input.fromValue(GceShieldedInstanceConfigResponseWorkstationsV1beta.fromMap((map['shieldedInstanceConfig']! as Map).cast<String, dynamic>())),
