...
class GceInstanceResponseWorkstationsV1beta {
  ...
  final pulumi.Input<GceConfidentialInstanceConfigResponseWorkstationsV1beta>
  ...
  final pulumi.Input<GceShieldedInstanceConfigResponseWorkstationsV1beta>
  ...
  factory GceInstanceResponseWorkstationsV1beta.fromMap(
    ...
    return GceInstanceResponseWorkstationsV1beta(
      accelerators: pulumi.Input.fromValue(
        pulumi.Input.decodeList<AcceleratorResponse>(
          map['accelerators']!,
      ...
      disablePublicIpAddresses: pulumi.Input.fromValue(
      ...
      serviceAccountScopes: pulumi.Input.fromValue(
