...
class GceInstanceResponseWorkstationsV1beta {
  ...
  factory GceInstanceResponseWorkstationsV1beta.fromMap(Map<String, dynamic> map) {
    return GceInstanceResponseWorkstationsV1beta(
      accelerators: (pulumi.Input.decodeList<AcceleratorResponse>(map['accelerators'], (value) => AcceleratorResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      bootDiskSizeGb: (map['bootDiskSizeGb'] as int).input(),
      confidentialInstanceConfig: (GceConfidentialInstanceConfigResponseWorkstationsV1beta.fromMap((map['confidentialInstanceConfig'] as Map).cast<String, dynamic>())).input(),
      ...
      shieldedInstanceConfig: (GceShieldedInstanceConfigResponseWorkstationsV1beta.fromMap((map['shieldedInstanceConfig'] as Map).cast<String, dynamic>())).input(),
