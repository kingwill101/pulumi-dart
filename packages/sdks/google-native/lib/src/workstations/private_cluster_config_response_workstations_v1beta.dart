...
class PrivateClusterConfigResponseWorkstationsV1beta {
  ...
  const PrivateClusterConfigResponseWorkstationsV1beta({
  ...
  factory PrivateClusterConfigResponseWorkstationsV1beta.fromMap(Map<String, dynamic> map) {
    return PrivateClusterConfigResponseWorkstationsV1beta(
      allowedProjects: pulumi.Input.fromValue((map['allowedProjects'] as List).cast<String>()),
