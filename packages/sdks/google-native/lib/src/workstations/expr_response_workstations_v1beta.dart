...
class ExprResponseWorkstationsV1beta {
  ...
  /// Creates a new [ExprResponseWorkstationsV1beta].
  ...
  const ExprResponseWorkstationsV1beta({
  ...
  factory ExprResponseWorkstationsV1beta.fromMap(Map<String, dynamic> map) {
    return ExprResponseWorkstationsV1beta(
