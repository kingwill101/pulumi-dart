...
class ExprResponseMetastoreV1beta {
  ...
  /// Creates a new [ExprResponseMetastoreV1beta].
  ...
  const ExprResponseMetastoreV1beta({
  ...
  factory ExprResponseMetastoreV1beta.fromMap(Map<String, dynamic> map) {
    return ExprResponseMetastoreV1beta(
