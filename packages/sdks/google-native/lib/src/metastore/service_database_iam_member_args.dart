...
/// {@template pulumi_metastore_v1alpha_service_database_iam_member_args_doc}
/// The set of arguments for ServiceDatabaseIamMember.
/// {@endtemplate}
/// {@macro pulumi_metastore_v1alpha_service_database_iam_member_args_doc}
class ServiceDatabaseIamMemberArgs {
  ...
  /// Creates a new [ServiceDatabaseIamMemberArgs].
  ...
  const ServiceDatabaseIamMemberArgs({
    this.condition,
