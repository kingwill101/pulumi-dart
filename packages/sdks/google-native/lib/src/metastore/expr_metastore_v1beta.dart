...
class ExprMetastoreV1beta {
  ...
  /// Creates a new [ExprMetastoreV1beta].
  ...
  factory ExprMetastoreV1beta.fromMap(Map<String, dynamic> map) {
    return ExprMetastoreV1beta(
