...
import 'service_metastore_v1beta_args.dart';
...
class ServiceMetastoreV1beta extends pulumi.CustomResource {
  ...
  /// Creates a new [ServiceMetastoreV1beta].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ServiceMetastoreV1beta]. {@macro pulumi_metastore_v1beta_service_metastore_v1beta_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  ServiceMetastoreV1beta(
    String name, {
    ...
    this.encryptionConfig = registerOutput<EncryptionConfigResponseMetastoreV1beta>('encryptionConfig');
    this.endpointUri = registerOutput<String>('endpointUri');
    this.hiveMetastoreConfig = registerOutput<HiveMetastoreConfigResponseMetastoreV1beta>('hiveMetastoreConfig');
    this.labels = registerOutput<Map<String, String>>('labels');
    this.location = registerOutput<String>('location');
    this.maintenanceWindow = registerOutput<MaintenanceWindowResponseMetastoreV1beta>('maintenanceWindow');
    this.metadataIntegration = registerOutput<MetadataIntegrationResponseMetastoreV1beta>('metadataIntegration');
    this.metadataManagementActivity = registerOutput<MetadataManagementActivityResponseMetastoreV1beta>('metadataManagementActivity');
    this.name = registerOutput<String>('name');
    this.network = registerOutput<String>('network');
    this.networkConfig = registerOutput<NetworkConfigResponseMetastoreV1beta>('networkConfig');
    this.port = registerOutput<int>('port');
    this.project = registerOutput<String>('project');
    this.releaseChannel = registerOutput<String>('releaseChannel');
    this.requestId = registerOutput<String?>('requestId');
    this.scalingConfig = registerOutput<ScalingConfigResponseMetastoreV1beta>('scalingConfig');
    this.serviceId = registerOutput<String>('serviceId');
    this.state = registerOutput<String>('state');
    this.stateMessage = registerOutput<String>('stateMessage');
    this.telemetryConfig = registerOutput<TelemetryConfigResponseMetastoreV1beta>('telemetryConfig');
