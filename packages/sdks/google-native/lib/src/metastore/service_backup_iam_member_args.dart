...
/// {@template pulumi_metastore_v1_service_backup_iam_member_args_doc}
/// The set of arguments for ServiceBackupIamMember.
/// {@endtemplate}
/// {@macro pulumi_metastore_v1_service_backup_iam_member_args_doc}
class ServiceBackupIamMemberArgs {
  ...
  /// Creates a new [ServiceBackupIamMemberArgs].
  ...
  const ServiceBackupIamMemberArgs({
    this.condition,
  ...
  factory ServiceBackupIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return ServiceBackupIamMemberArgs(
