...
class AuditLogConfigMetastoreV1beta {
  ...
  final pulumi.Input<AuditLogConfigLogTypeMetastoreV1beta>? logType;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'logType': ?pulumi.Input.mapOptionalInputValue<AuditLogConfigLogTypeMetastoreV1beta, String>(logType, (value) => value.wireValue),
    };
  }
  ...
  factory AuditLogConfigMetastoreV1beta.fromMap(Map<String, dynamic> map) {
    return AuditLogConfigMetastoreV1beta(
      ...
      logType: (() { final guardedValue = map['logType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AuditLogConfigLogTypeMetastoreV1beta.fromValue(guardedValue as String)); })(),
    );
  }
}
