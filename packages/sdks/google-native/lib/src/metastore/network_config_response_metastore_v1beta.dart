...
class NetworkConfigResponseMetastoreV1beta {
  ...
  factory NetworkConfigResponseMetastoreV1beta.fromMap(Map<String, dynamic> map) {
    return NetworkConfigResponseMetastoreV1beta(
      consumers: (pulumi.Input.decodeList<ConsumerResponseMetastoreV1beta>(map['consumers'], (value) => ConsumerResponseMetastoreV1beta.fromMap((value as Map).cast<String, dynamic>()))).input(),
