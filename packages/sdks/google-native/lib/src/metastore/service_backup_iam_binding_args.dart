...
/// {@template pulumi_metastore_v1_service_backup_iam_binding_args_doc}
/// The set of arguments for ServiceBackupIamBinding.
/// {@endtemplate}
/// {@macro pulumi_metastore_v1_service_backup_iam_binding_args_doc}
class ServiceBackupIamBindingArgs {
  ...
  /// Creates a new [ServiceBackupIamBindingArgs].
  ...
  const ServiceBackupIamBindingArgs({
    this.condition,
  ...
  factory ServiceBackupIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return ServiceBackupIamBindingArgs(
