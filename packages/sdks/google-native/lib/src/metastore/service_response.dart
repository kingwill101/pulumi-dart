...
class ServiceResponse {
  ...
  final pulumi.Input<MetadataManagementActivityResponse>
  ...
  factory ServiceResponse.fromMap(Map<String, dynamic> map) {
    return ServiceResponse(
      ...
      hiveMetastoreConfig: pulumi.Input.fromValue(
        HiveMetastoreConfigResponse.fromMap(
      ...
      telemetryConfig: pulumi.Input.fromValue(
        TelemetryConfigResponse.fromMap(
