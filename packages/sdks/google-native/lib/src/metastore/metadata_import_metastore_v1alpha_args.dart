...
class MetadataImportMetastoreV1alphaArgs {
  ...
  /// [serviceId] Required.
  const MetadataImportMetastoreV1alphaArgs({
    this.databaseDump,
    this.description,
    this.location,
  ...
  factory MetadataImportMetastoreV1alphaArgs.fromMap(Map<String, dynamic> map) {
    return MetadataImportMetastoreV1alphaArgs(
      databaseDump: (() { final guardedValue = map['databaseDump']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DatabaseDumpMetastoreV1alpha.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
