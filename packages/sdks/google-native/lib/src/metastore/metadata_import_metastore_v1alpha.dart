...
class MetadataImportMetastoreV1alpha extends pulumi.CustomResource {
  ...
  MetadataImportMetastoreV1alpha(
    ...
    databaseDump = registerOutput<DatabaseDumpResponseMetastoreV1alpha>('databaseDump', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return DatabaseDumpResponseMetastoreV1alpha.fromMap((guardedValue as Map).cast<String, dynamic>()); });
