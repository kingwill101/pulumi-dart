...
class BackupMetastoreV1beta extends pulumi.CustomResource {
  ...
  BackupMetastoreV1beta(
    ...
    serviceRevision = registerOutput<ServiceResponseMetastoreV1beta>('serviceRevision', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ServiceResponseMetastoreV1beta.fromMap((guardedValue as Map).cast<String, dynamic>()); });
