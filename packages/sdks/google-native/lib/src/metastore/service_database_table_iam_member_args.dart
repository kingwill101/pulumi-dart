...
/// {@template pulumi_metastore_v1alpha_service_database_table_iam_member_args_doc}
/// The set of arguments for ServiceDatabaseTableIamMember.
/// {@endtemplate}
/// {@macro pulumi_metastore_v1alpha_service_database_table_iam_member_args_doc}
class ServiceDatabaseTableIamMemberArgs {
  ...
  /// Creates a new [ServiceDatabaseTableIamMemberArgs].
  ...
  const ServiceDatabaseTableIamMemberArgs({
    this.condition,
  ...
  factory ServiceDatabaseTableIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return ServiceDatabaseTableIamMemberArgs(
