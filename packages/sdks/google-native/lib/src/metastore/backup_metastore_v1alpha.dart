...
import 'backup_metastore_v1alpha_args.dart';
import 'service_response_metastore_v1alpha.dart';

/// Creates a new backup in a given project and location.
class BackupMetastoreV1alpha extends pulumi.CustomResource {
  ...
  late final pulumi.Output<ServiceResponseMetastoreV1alpha> serviceRevision;
  /// The current state of the backup.
  late final pulumi.Output<String> state;

  /// Creates a new [BackupMetastoreV1alpha].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [BackupMetastoreV1alpha]. {@macro pulumi_metastore_v1alpha_backup_metastore_v1alpha_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  BackupMetastoreV1alpha(
    String name, {
    BackupMetastoreV1alphaArgs? args,
    ...
    serviceRevision = registerOutput<ServiceResponseMetastoreV1alpha>('serviceRevision', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ServiceResponseMetastoreV1alpha.fromMap((guardedValue as Map).cast<String, dynamic>()); });
