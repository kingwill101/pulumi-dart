...
import 'federation_iam_binding_args.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy.Can return NOT_FOUND, INVALID_ARGUMENT, and PERMISSION_DENIED errors.
class FederationIamBinding extends pulumi.CustomResource {
  ...
  /// Creates a new [FederationIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [FederationIamBinding]. {@macro pulumi_metastore_v1_federation_iam_binding_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  FederationIamBinding(
    String name, {
    FederationIamBindingArgs? args,
