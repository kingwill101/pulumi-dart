...
class AuditConfigMetastoreV1alpha {
  ...
  const AuditConfigMetastoreV1alpha({
  ...
  factory AuditConfigMetastoreV1alpha.fromMap(Map<String, dynamic> map) {
    return AuditConfigMetastoreV1alpha(
      auditLogConfigs: (() { final guardedValue = map['auditLogConfigs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AuditLogConfigMetastoreV1alpha>(guardedValue, (value) => AuditLogConfigMetastoreV1alpha.fromMap((value as Map).cast<String, dynamic>()))); })(),
