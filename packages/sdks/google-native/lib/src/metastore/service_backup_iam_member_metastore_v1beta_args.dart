...
/// {@template pulumi_metastore_v1beta_service_backup_iam_member_metastore_v1beta_args_doc}
/// The set of arguments for ServiceBackupIamMember.
/// {@endtemplate}
/// {@macro pulumi_metastore_v1beta_service_backup_iam_member_metastore_v1beta_args_doc}
class ServiceBackupIamMemberMetastoreV1betaArgs {
  ...
  /// Creates a new [ServiceBackupIamMemberMetastoreV1betaArgs].
  ...
  const ServiceBackupIamMemberMetastoreV1betaArgs({
    this.condition,
  ...
  factory ServiceBackupIamMemberMetastoreV1betaArgs.fromMap(Map<String, dynamic> map) {
    return ServiceBackupIamMemberMetastoreV1betaArgs(
