...
/// {@template pulumi_metastore_v1alpha_service_iam_member_metastore_v1alpha_args_doc}
/// The set of arguments for ServiceIamMember.
/// {@endtemplate}
/// {@macro pulumi_metastore_v1alpha_service_iam_member_metastore_v1alpha_args_doc}
class ServiceIamMemberMetastoreV1alphaArgs {
  ...
  /// Creates a new [ServiceIamMemberMetastoreV1alphaArgs].
  ...
  const ServiceIamMemberMetastoreV1alphaArgs({
    this.condition,
  ...
  factory ServiceIamMemberMetastoreV1alphaArgs.fromMap(Map<String, dynamic> map) {
    return ServiceIamMemberMetastoreV1alphaArgs(
