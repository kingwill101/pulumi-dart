...
/// {@template pulumi_metastore_v1beta_service_database_table_iam_member_metastore_v1beta_args_doc}
/// The set of arguments for ServiceDatabaseTableIamMember.
/// {@endtemplate}
/// {@macro pulumi_metastore_v1beta_service_database_table_iam_member_metastore_v1beta_args_doc}
class ServiceDatabaseTableIamMemberMetastoreV1betaArgs {
  ...
  /// Creates a new [ServiceDatabaseTableIamMemberMetastoreV1betaArgs].
  ...
  const ServiceDatabaseTableIamMemberMetastoreV1betaArgs({
    this.condition,
  ...
  factory ServiceDatabaseTableIamMemberMetastoreV1betaArgs.fromMap(Map<String, dynamic> map) {
    return ServiceDatabaseTableIamMemberMetastoreV1betaArgs(
