...
/// {@template pulumi_metastore_v1beta_federation_iam_member_metastore_v1beta_args_doc}
/// The set of arguments for FederationIamMember.
/// {@endtemplate}
/// {@macro pulumi_metastore_v1beta_federation_iam_member_metastore_v1beta_args_doc}
class FederationIamMemberMetastoreV1betaArgs {
  ...
  /// Creates a new [FederationIamMemberMetastoreV1betaArgs].
  ...
  const FederationIamMemberMetastoreV1betaArgs({
    this.condition,
  ...
  factory FederationIamMemberMetastoreV1betaArgs.fromMap(Map<String, dynamic> map) {
