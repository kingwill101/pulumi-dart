...
class GetMetadataImportMetastoreV1alphaResult {
  ...
  /// Creates a new [GetMetadataImportMetastoreV1alphaResult].
  ...
  const GetMetadataImportMetastoreV1alphaResult({
  ...
  factory GetMetadataImportMetastoreV1alphaResult.fromMap(Map<String, dynamic> map) {
    return GetMetadataImportMetastoreV1alphaResult(
      createTime: map['createTime'] as String,
      databaseDump: DatabaseDumpResponseMetastoreV1alpha.fromMap((map['databaseDump']! as Map).cast<String, dynamic>()),
