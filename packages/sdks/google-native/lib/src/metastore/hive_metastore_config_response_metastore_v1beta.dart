...
class HiveMetastoreConfigResponseMetastoreV1beta {
  ...
  final KerberosConfigResponseMetastoreV1beta kerberosConfig;
  ...
  factory HiveMetastoreConfigResponseMetastoreV1beta.fromMap(Map<String, dynamic> map) {
    return HiveMetastoreConfigResponseMetastoreV1beta(
      auxiliaryVersions: (map['auxiliaryVersions'] as Map).cast<String, String>(),
      configOverrides: (map['configOverrides'] as Map).cast<String, String>(),
      endpointProtocol: map['endpointProtocol'] as String,
      kerberosConfig: KerberosConfigResponseMetastoreV1beta.fromMap((map['kerberosConfig'] as Map).cast<String, dynamic>()),
