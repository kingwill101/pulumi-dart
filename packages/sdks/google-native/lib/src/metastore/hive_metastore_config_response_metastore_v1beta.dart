...
import 'kerberos_config_response_metastore_v1beta.dart';

/// Specifies configuration information specific to running Hive metastore software as the metastore service.
class HiveMetastoreConfigResponseMetastoreV1beta {
  ...
  final pulumi.Input<KerberosConfigResponseMetastoreV1beta> kerberosConfig;
  /// Immutable. The Hive metastore schema version.
  final pulumi.Input<String> version;

  /// Creates a new [HiveMetastoreConfigResponseMetastoreV1beta].
  ...
  const HiveMetastoreConfigResponseMetastoreV1beta({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'kerberosConfig': pulumi.Input.mapInputValue<KerberosConfigResponseMetastoreV1beta, Map<String, dynamic>>(kerberosConfig, (value) => value.toMap()),
      'version': version,
    };
  }

  factory HiveMetastoreConfigResponseMetastoreV1beta.fromMap(Map<String, dynamic> map) {
    return HiveMetastoreConfigResponseMetastoreV1beta(
      auxiliaryVersions: pulumi.Input.fromValue((map['auxiliaryVersions'] as Map).cast<String, String>()),
      configOverrides: pulumi.Input.fromValue((map['configOverrides'] as Map).cast<String, String>()),
      endpointProtocol: pulumi.Input.fromValue(map['endpointProtocol'] as String),
      kerberosConfig: pulumi.Input.fromValue(KerberosConfigResponseMetastoreV1beta.fromMap((map['kerberosConfig']! as Map).cast<String, dynamic>())),
