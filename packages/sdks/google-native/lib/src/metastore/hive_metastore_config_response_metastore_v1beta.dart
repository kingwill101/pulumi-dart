...
class HiveMetastoreConfigResponseMetastoreV1beta {
  ...
  factory HiveMetastoreConfigResponseMetastoreV1beta.fromMap(
    Map<String, dynamic> map,
  ) {
    return HiveMetastoreConfigResponseMetastoreV1beta(
      auxiliaryVersions: pulumi.Input.fromValue(
      ...
      endpointProtocol: pulumi.Input.fromValue(
        map['endpointProtocol'] as String,
      ),
      kerberosConfig: pulumi.Input.fromValue(
        KerberosConfigResponseMetastoreV1beta.fromMap(
