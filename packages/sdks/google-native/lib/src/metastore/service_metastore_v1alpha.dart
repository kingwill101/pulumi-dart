...
class ServiceMetastoreV1alpha extends pulumi.CustomResource {
  ...
  ServiceMetastoreV1alpha(
    ...
    this.encryptionConfig = registerOutput<EncryptionConfigResponseMetastoreV1alpha>('encryptionConfig');
    this.endpointUri = registerOutput<String>('endpointUri');
    this.hiveMetastoreConfig = registerOutput<HiveMetastoreConfigResponseMetastoreV1alpha>('hiveMetastoreConfig');
    this.labels = registerOutput<Map<String, String>>('labels');
    this.location = registerOutput<String>('location');
    this.maintenanceWindow = registerOutput<MaintenanceWindowResponseMetastoreV1alpha>('maintenanceWindow');
    this.metadataIntegration = registerOutput<MetadataIntegrationResponseMetastoreV1alpha>('metadataIntegration');
    this.metadataManagementActivity = registerOutput<MetadataManagementActivityResponseMetastoreV1alpha>('metadataManagementActivity');
    this.name = registerOutput<String>('name');
    this.network = registerOutput<String>('network');
    this.networkConfig = registerOutput<NetworkConfigResponseMetastoreV1alpha>('networkConfig');
    this.port = registerOutput<int>('port');
    this.project = registerOutput<String>('project');
    this.releaseChannel = registerOutput<String>('releaseChannel');
    this.requestId = registerOutput<String?>('requestId');
    this.scalingConfig = registerOutput<ScalingConfigResponseMetastoreV1alpha>('scalingConfig');
    this.serviceId = registerOutput<String>('serviceId');
    this.state = registerOutput<String>('state');
    this.stateMessage = registerOutput<String>('stateMessage');
    this.telemetryConfig = registerOutput<TelemetryConfigResponseMetastoreV1alpha>('telemetryConfig');
