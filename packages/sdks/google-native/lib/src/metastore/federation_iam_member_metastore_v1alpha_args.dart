...
/// {@template pulumi_metastore_v1alpha_federation_iam_member_metastore_v1alpha_args_doc}
/// The set of arguments for FederationIamMember.
/// {@endtemplate}
/// {@macro pulumi_metastore_v1alpha_federation_iam_member_metastore_v1alpha_args_doc}
class FederationIamMemberMetastoreV1alphaArgs {
  ...
  /// Creates a new [FederationIamMemberMetastoreV1alphaArgs].
  ...
  const FederationIamMemberMetastoreV1alphaArgs({
    this.condition,
  ...
  factory FederationIamMemberMetastoreV1alphaArgs.fromMap(Map<String, dynamic> map) {
    return FederationIamMemberMetastoreV1alphaArgs(
