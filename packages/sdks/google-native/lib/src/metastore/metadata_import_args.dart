...
class MetadataImportArgs {
  ...
  /// [serviceId] Required.
  MetadataImportArgs({
    pulumi.Output<DatabaseDump>? databaseDump,
    ...
    required pulumi.Output<String> serviceId,
      ...
      databaseDump = pulumi.Input.asOptionalInput<DatabaseDump>(databaseDump),
  ...
  factory MetadataImportArgs.fromMap(Map<String, dynamic> map) {
    return MetadataImportArgs(
      databaseDump: map['databaseDump'] == null ? null : pulumi.Output.create<DatabaseDump>(DatabaseDump.fromMap((map['databaseDump'] as Map).cast<String, dynamic>())),
