...
import 'service_database_table_iam_policy_args.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy.Can return NOT_FOUND, INVALID_ARGUMENT, and PERMISSION_DENIED errors.
/// Note - this resource's API doesn't support deletion. When deleted, the resource will persist
/// on Google Cloud even though it will be deleted from Pulumi state.
class ServiceDatabaseTableIamPolicy extends pulumi.CustomResource {
  ...
  /// Creates a new [ServiceDatabaseTableIamPolicy].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ServiceDatabaseTableIamPolicy]. {@macro pulumi_metastore_v1alpha_service_database_table_iam_policy_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  ServiceDatabaseTableIamPolicy(
    String name, {
    ServiceDatabaseTableIamPolicyArgs? args,
