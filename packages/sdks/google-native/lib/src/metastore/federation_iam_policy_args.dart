...
/// {@template pulumi_metastore_v1_federation_iam_policy_args_doc}
/// The set of arguments for FederationIamPolicy.
/// {@endtemplate}
/// {@macro pulumi_metastore_v1_federation_iam_policy_args_doc}
class FederationIamPolicyArgs {
  ...
  /// Creates a new [FederationIamPolicyArgs].
  ...
  factory FederationIamPolicyArgs.fromMap(Map<String, dynamic> map) {
    return FederationIamPolicyArgs(
