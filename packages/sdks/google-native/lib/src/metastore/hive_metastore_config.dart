...
class HiveMetastoreConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'endpointProtocol': ?pulumi.Input.mapOptionalInputValue<HiveMetastoreConfigEndpointProtocol, String>(endpointProtocol, (value) => value.wireValue),
  ...
  factory HiveMetastoreConfig.fromMap(Map<String, dynamic> map) {
    return HiveMetastoreConfig(
      ...
      endpointProtocol: (() { final guardedValue = map['endpointProtocol']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HiveMetastoreConfigEndpointProtocol.fromValue(guardedValue as String)); })(),
