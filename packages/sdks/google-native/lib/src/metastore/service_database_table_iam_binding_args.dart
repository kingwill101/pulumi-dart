...
/// {@template pulumi_metastore_v1alpha_service_database_table_iam_binding_args_doc}
/// The set of arguments for ServiceDatabaseTableIamBinding.
/// {@endtemplate}
/// {@macro pulumi_metastore_v1alpha_service_database_table_iam_binding_args_doc}
class ServiceDatabaseTableIamBindingArgs {
  ...
  /// Creates a new [ServiceDatabaseTableIamBindingArgs].
  ...
  const ServiceDatabaseTableIamBindingArgs({
    this.condition,
  ...
  factory ServiceDatabaseTableIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return ServiceDatabaseTableIamBindingArgs(
