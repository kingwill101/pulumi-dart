...
/// {@template pulumi_metastore_v1_federation_iam_member_args_doc}
/// The set of arguments for FederationIamMember.
/// {@endtemplate}
/// {@macro pulumi_metastore_v1_federation_iam_member_args_doc}
class FederationIamMemberArgs {
  ...
  /// Creates a new [FederationIamMemberArgs].
  ...
  factory FederationIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return FederationIamMemberArgs(
