...
class MetadataIntegrationResponseMetastoreV1alpha {
  ...
  factory MetadataIntegrationResponseMetastoreV1alpha.fromMap(Map<String, dynamic> map) {
    return MetadataIntegrationResponseMetastoreV1alpha(
      dataCatalogConfig: (DataCatalogConfigResponseMetastoreV1alpha.fromMap((map['dataCatalogConfig'] as Map).cast<String, dynamic>())).input(),
      dataplexConfig: (DataplexConfigResponse.fromMap((map['dataplexConfig'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
