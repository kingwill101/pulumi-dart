...
class MetadataImportMetastoreV1betaArgs {
  ...
  /// [serviceId] Required.
  const MetadataImportMetastoreV1betaArgs({
    this.databaseDump,
    this.description,
    this.location,
  ...
  factory MetadataImportMetastoreV1betaArgs.fromMap(Map<String, dynamic> map) {
    return MetadataImportMetastoreV1betaArgs(
      databaseDump: (() { final guardedValue = map['databaseDump']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DatabaseDumpMetastoreV1beta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
