...
class MetadataImportMetastoreV1betaArgs {
  ...
  MetadataImportMetastoreV1betaArgs({
    pulumi.Output<DatabaseDumpMetastoreV1beta>? databaseDump,
    ...
    required pulumi.Output<String> serviceId,
      ...
      databaseDump = pulumi.Input.asOptionalInput<DatabaseDumpMetastoreV1beta>(databaseDump),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'databaseDump': ?pulumi.Input.mapOptionalInputValue<DatabaseDumpMetastoreV1beta, Map<String, dynamic>>(databaseDump, (value) => value.toMap()),
  ...
  factory MetadataImportMetastoreV1betaArgs.fromMap(Map<String, dynamic> map) {
    return MetadataImportMetastoreV1betaArgs(
      databaseDump: map['databaseDump'] == null ? null : pulumi.Output.create<DatabaseDumpMetastoreV1beta>(DatabaseDumpMetastoreV1beta.fromMap((map['databaseDump'] as Map).cast<String, dynamic>())),
