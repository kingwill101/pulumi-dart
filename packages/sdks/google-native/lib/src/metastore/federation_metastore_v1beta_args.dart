...
/// {@template pulumi_metastore_v1beta_federation_metastore_v1beta_args_doc}
/// The set of arguments for Federation.
/// {@endtemplate}
/// {@macro pulumi_metastore_v1beta_federation_metastore_v1beta_args_doc}
class FederationMetastoreV1betaArgs {
  ...
  /// Creates a new [FederationMetastoreV1betaArgs].
  ...
  const FederationMetastoreV1betaArgs({
  ...
  factory FederationMetastoreV1betaArgs.fromMap(Map<String, dynamic> map) {
    return FederationMetastoreV1betaArgs(
      backendMetastores: (() { final guardedValue = map['backendMetastores']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
