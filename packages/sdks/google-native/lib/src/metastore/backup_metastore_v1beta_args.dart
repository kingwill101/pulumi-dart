...
/// {@template pulumi_metastore_v1beta_backup_metastore_v1beta_args_doc}
/// The set of arguments for Backup.
/// {@endtemplate}
/// {@macro pulumi_metastore_v1beta_backup_metastore_v1beta_args_doc}
class BackupMetastoreV1betaArgs {
  ...
  /// Creates a new [BackupMetastoreV1betaArgs].
  ...
  /// [serviceId] Required.
  const BackupMetastoreV1betaArgs({
  ...
  factory BackupMetastoreV1betaArgs.fromMap(Map<String, dynamic> map) {
    return BackupMetastoreV1betaArgs(
