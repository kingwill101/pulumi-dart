...
/// {@template pulumi_metastore_v1beta_service_database_iam_binding_metastore_v1beta_args_doc}
/// The set of arguments for ServiceDatabaseIamBinding.
/// {@endtemplate}
/// {@macro pulumi_metastore_v1beta_service_database_iam_binding_metastore_v1beta_args_doc}
class ServiceDatabaseIamBindingMetastoreV1betaArgs {
  ...
  /// Creates a new [ServiceDatabaseIamBindingMetastoreV1betaArgs].
  ...
  const ServiceDatabaseIamBindingMetastoreV1betaArgs({
    this.condition,
  ...
  factory ServiceDatabaseIamBindingMetastoreV1betaArgs.fromMap(Map<String, dynamic> map) {
    return ServiceDatabaseIamBindingMetastoreV1betaArgs(
