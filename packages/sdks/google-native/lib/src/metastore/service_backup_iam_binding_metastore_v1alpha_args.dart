...
/// {@template pulumi_metastore_v1alpha_service_backup_iam_binding_metastore_v1alpha_args_doc}
/// The set of arguments for ServiceBackupIamBinding.
/// {@endtemplate}
/// {@macro pulumi_metastore_v1alpha_service_backup_iam_binding_metastore_v1alpha_args_doc}
class ServiceBackupIamBindingMetastoreV1alphaArgs {
  ...
  /// Creates a new [ServiceBackupIamBindingMetastoreV1alphaArgs].
  ...
  const ServiceBackupIamBindingMetastoreV1alphaArgs({
    this.condition,
  ...
  factory ServiceBackupIamBindingMetastoreV1alphaArgs.fromMap(Map<String, dynamic> map) {
    return ServiceBackupIamBindingMetastoreV1alphaArgs(
