...
/// {@template pulumi_metastore_v1alpha_service_backup_iam_member_metastore_v1alpha_args_doc}
/// The set of arguments for ServiceBackupIamMember.
/// {@endtemplate}
/// {@macro pulumi_metastore_v1alpha_service_backup_iam_member_metastore_v1alpha_args_doc}
class ServiceBackupIamMemberMetastoreV1alphaArgs {
  ...
  /// Creates a new [ServiceBackupIamMemberMetastoreV1alphaArgs].
  ...
  const ServiceBackupIamMemberMetastoreV1alphaArgs({
    this.condition,
  ...
  factory ServiceBackupIamMemberMetastoreV1alphaArgs.fromMap(Map<String, dynamic> map) {
    return ServiceBackupIamMemberMetastoreV1alphaArgs(
