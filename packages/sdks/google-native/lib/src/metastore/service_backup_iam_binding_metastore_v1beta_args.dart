...
/// {@template pulumi_metastore_v1beta_service_backup_iam_binding_metastore_v1beta_args_doc}
/// The set of arguments for ServiceBackupIamBinding.
/// {@endtemplate}
/// {@macro pulumi_metastore_v1beta_service_backup_iam_binding_metastore_v1beta_args_doc}
class ServiceBackupIamBindingMetastoreV1betaArgs {
  ...
  /// Creates a new [ServiceBackupIamBindingMetastoreV1betaArgs].
  ...
  const ServiceBackupIamBindingMetastoreV1betaArgs({
    this.condition,
  ...
  factory ServiceBackupIamBindingMetastoreV1betaArgs.fromMap(Map<String, dynamic> map) {
    return ServiceBackupIamBindingMetastoreV1betaArgs(
