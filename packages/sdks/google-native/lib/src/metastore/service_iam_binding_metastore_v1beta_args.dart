...
/// {@template pulumi_metastore_v1beta_service_iam_binding_metastore_v1beta_args_doc}
/// The set of arguments for ServiceIamBinding.
/// {@endtemplate}
/// {@macro pulumi_metastore_v1beta_service_iam_binding_metastore_v1beta_args_doc}
class ServiceIamBindingMetastoreV1betaArgs {
  ...
  /// Creates a new [ServiceIamBindingMetastoreV1betaArgs].
  ...
  const ServiceIamBindingMetastoreV1betaArgs({
    this.condition,
  ...
  factory ServiceIamBindingMetastoreV1betaArgs.fromMap(Map<String, dynamic> map) {
    return ServiceIamBindingMetastoreV1betaArgs(
