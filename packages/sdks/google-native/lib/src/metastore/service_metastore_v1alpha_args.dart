...
class ServiceMetastoreV1alphaArgs {
  ...
  const ServiceMetastoreV1alphaArgs({
    this.databaseType,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'databaseType': ?pulumi.Input.mapOptionalInputValue<ServiceDatabaseTypeMetastoreV1alpha, String>(databaseType, (value) => value.wireValue),
      ...
      'port': ?port,
      'project': ?project,
      'releaseChannel': ?pulumi.Input.mapOptionalInputValue<ServiceReleaseChannelMetastoreV1alpha, String>(releaseChannel, (value) => value.wireValue),
      'requestId': ?requestId,
      ...
      'tier': ?pulumi.Input.mapOptionalInputValue<ServiceTierMetastoreV1alpha, String>(tier, (value) => value.wireValue),
    };
  }

  factory ServiceMetastoreV1alphaArgs.fromMap(Map<String, dynamic> map) {
    return ServiceMetastoreV1alphaArgs(
      databaseType: (() { final guardedValue = map['databaseType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServiceDatabaseTypeMetastoreV1alpha.fromValue(guardedValue as String)); })(),
      encryptionConfig: (() { final guardedValue = map['encryptionConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EncryptionConfigMetastoreV1alpha.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      hiveMetastoreConfig: (() { final guardedValue = map['hiveMetastoreConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HiveMetastoreConfigMetastoreV1alpha.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      labels: (() { final guardedValue = map['labels']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      location: (() { final guardedValue = map['location']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      maintenanceWindow: (() { final guardedValue = map['maintenanceWindow']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MaintenanceWindowMetastoreV1alpha.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      metadataIntegration: (() { final guardedValue = map['metadataIntegration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MetadataIntegrationMetastoreV1alpha.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      network: (() { final guardedValue = map['network']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      networkConfig: (() { final guardedValue = map['networkConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkConfigMetastoreV1alpha.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      port: (() { final guardedValue = map['port']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      project: (() { final guardedValue = map['project']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      releaseChannel: (() { final guardedValue = map['releaseChannel']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServiceReleaseChannelMetastoreV1alpha.fromValue(guardedValue as String)); })(),
      requestId: (() { final guardedValue = map['requestId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      scalingConfig: (() { final guardedValue = map['scalingConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ScalingConfigMetastoreV1alpha.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      serviceId: pulumi.Input.fromValue(map['serviceId'] as String),
      telemetryConfig: (() { final guardedValue = map['telemetryConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TelemetryConfigMetastoreV1alpha.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      tier: (() { final guardedValue = map['tier']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServiceTierMetastoreV1alpha.fromValue(guardedValue as String)); })(),
    );
  }
}
