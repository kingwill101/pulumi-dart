...
class ServiceMetastoreV1alphaArgs {
  ...
  ServiceMetastoreV1alphaArgs({
    pulumi.Output<ServiceDatabaseTypeMetastoreV1alpha>? databaseType,
    pulumi.Output<EncryptionConfigMetastoreV1alpha>? encryptionConfig,
    pulumi.Output<HiveMetastoreConfigMetastoreV1alpha>? hiveMetastoreConfig,
    pulumi.Output<Map<String, String>>? labels,
    pulumi.Output<String>? location,
    pulumi.Output<MaintenanceWindowMetastoreV1alpha>? maintenanceWindow,
    pulumi.Output<MetadataIntegrationMetastoreV1alpha>? metadataIntegration,
    pulumi.Output<String>? name,
    pulumi.Output<String>? network,
    pulumi.Output<NetworkConfigMetastoreV1alpha>? networkConfig,
    pulumi.Output<int>? port,
    pulumi.Output<String>? project,
    pulumi.Output<ServiceReleaseChannelMetastoreV1alpha>? releaseChannel,
    pulumi.Output<String>? requestId,
    pulumi.Output<ScalingConfigMetastoreV1alpha>? scalingConfig,
    required pulumi.Output<String> serviceId,
    pulumi.Output<TelemetryConfigMetastoreV1alpha>? telemetryConfig,
    pulumi.Output<ServiceTierMetastoreV1alpha>? tier,
  }) :
      databaseType = pulumi.Input.asOptionalInput<ServiceDatabaseTypeMetastoreV1alpha>(databaseType),
      encryptionConfig = pulumi.Input.asOptionalInput<EncryptionConfigMetastoreV1alpha>(encryptionConfig),
      hiveMetastoreConfig = pulumi.Input.asOptionalInput<HiveMetastoreConfigMetastoreV1alpha>(hiveMetastoreConfig),
      labels = pulumi.Input.asOptionalInput<Map<String, String>>(labels),
      location = pulumi.Input.asOptionalInput<String>(location),
      maintenanceWindow = pulumi.Input.asOptionalInput<MaintenanceWindowMetastoreV1alpha>(maintenanceWindow),
      metadataIntegration = pulumi.Input.asOptionalInput<MetadataIntegrationMetastoreV1alpha>(metadataIntegration),
      name = pulumi.Input.asOptionalInput<String>(name),
      network = pulumi.Input.asOptionalInput<String>(network),
      networkConfig = pulumi.Input.asOptionalInput<NetworkConfigMetastoreV1alpha>(networkConfig),
      port = pulumi.Input.asOptionalInput<int>(port),
      project = pulumi.Input.asOptionalInput<String>(project),
      releaseChannel = pulumi.Input.asOptionalInput<ServiceReleaseChannelMetastoreV1alpha>(releaseChannel),
      requestId = pulumi.Input.asOptionalInput<String>(requestId),
      scalingConfig = pulumi.Input.asOptionalInput<ScalingConfigMetastoreV1alpha>(scalingConfig),
      serviceId = pulumi.Input.asInput<String>(serviceId),
      telemetryConfig = pulumi.Input.asOptionalInput<TelemetryConfigMetastoreV1alpha>(telemetryConfig),
  ...
  factory ServiceMetastoreV1alphaArgs.fromMap(Map<String, dynamic> map) {
    return ServiceMetastoreV1alphaArgs(
      databaseType: map['databaseType'] == null ? null : pulumi.Output.create<ServiceDatabaseTypeMetastoreV1alpha>(ServiceDatabaseTypeMetastoreV1alpha.fromValue(map['databaseType'] as String)),
      encryptionConfig: map['encryptionConfig'] == null ? null : pulumi.Output.create<EncryptionConfigMetastoreV1alpha>(EncryptionConfigMetastoreV1alpha.fromMap((map['encryptionConfig'] as Map).cast<String, dynamic>())),
      hiveMetastoreConfig: map['hiveMetastoreConfig'] == null ? null : pulumi.Output.create<HiveMetastoreConfigMetastoreV1alpha>(HiveMetastoreConfigMetastoreV1alpha.fromMap((map['hiveMetastoreConfig'] as Map).cast<String, dynamic>())),
      labels: map['labels'] == null ? null : pulumi.Output.create<Map<String, String>>((map['labels'] as Map).cast<String, String>()),
      location: map['location'] == null ? null : pulumi.Output.create<String>(map['location'] as String),
      maintenanceWindow: map['maintenanceWindow'] == null ? null : pulumi.Output.create<MaintenanceWindowMetastoreV1alpha>(MaintenanceWindowMetastoreV1alpha.fromMap((map['maintenanceWindow'] as Map).cast<String, dynamic>())),
      metadataIntegration: map['metadataIntegration'] == null ? null : pulumi.Output.create<MetadataIntegrationMetastoreV1alpha>(MetadataIntegrationMetastoreV1alpha.fromMap((map['metadataIntegration'] as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      network: map['network'] == null ? null : pulumi.Output.create<String>(map['network'] as String),
      networkConfig: map['networkConfig'] == null ? null : pulumi.Output.create<NetworkConfigMetastoreV1alpha>(NetworkConfigMetastoreV1alpha.fromMap((map['networkConfig'] as Map).cast<String, dynamic>())),
      port: map['port'] == null ? null : pulumi.Output.create<int>(map['port'] as int),
      project: map['project'] == null ? null : pulumi.Output.create<String>(map['project'] as String),
      releaseChannel: map['releaseChannel'] == null ? null : pulumi.Output.create<ServiceReleaseChannelMetastoreV1alpha>(ServiceReleaseChannelMetastoreV1alpha.fromValue(map['releaseChannel'] as String)),
      requestId: map['requestId'] == null ? null : pulumi.Output.create<String>(map['requestId'] as String),
      scalingConfig: map['scalingConfig'] == null ? null : pulumi.Output.create<ScalingConfigMetastoreV1alpha>(ScalingConfigMetastoreV1alpha.fromMap((map['scalingConfig'] as Map).cast<String, dynamic>())),
      serviceId: pulumi.Output.create<String>(map['serviceId'] as String),
      telemetryConfig: map['telemetryConfig'] == null ? null : pulumi.Output.create<TelemetryConfigMetastoreV1alpha>(TelemetryConfigMetastoreV1alpha.fromMap((map['telemetryConfig'] as Map).cast<String, dynamic>())),
      tier: map['tier'] == null ? null : pulumi.Output.create<ServiceTierMetastoreV1alpha>(ServiceTierMetastoreV1alpha.fromValue(map['tier'] as String)),
    );
  }
}
