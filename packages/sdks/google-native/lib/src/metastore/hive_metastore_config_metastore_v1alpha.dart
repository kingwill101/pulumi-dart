...
class HiveMetastoreConfigMetastoreV1alpha {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'endpointProtocol': ?endpointProtocol == null ? null : endpointProtocol!.value,
  ...
  factory HiveMetastoreConfigMetastoreV1alpha.fromMap(Map<String, dynamic> map) {
    return HiveMetastoreConfigMetastoreV1alpha(
      auxiliaryVersions: map['auxiliaryVersions'] == null ? null : (map['auxiliaryVersions'] as Map).cast<String, String>(),
      configOverrides: map['configOverrides'] == null ? null : (map['configOverrides'] as Map).cast<String, String>(),
      endpointProtocol: map['endpointProtocol'] == null ? null : HiveMetastoreConfigEndpointProtocolMetastoreV1alpha.fromValue(map['endpointProtocol'] as String),
      kerberosConfig: map['kerberosConfig'] == null ? null : KerberosConfigMetastoreV1alpha.fromMap((map['kerberosConfig'] as Map).cast<String, dynamic>()),
