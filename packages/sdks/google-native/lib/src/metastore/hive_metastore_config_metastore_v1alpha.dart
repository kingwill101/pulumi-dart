...
class HiveMetastoreConfigMetastoreV1alpha {
  ...
  const HiveMetastoreConfigMetastoreV1alpha({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'endpointProtocol': ?pulumi.Input.mapOptionalInputValue<HiveMetastoreConfigEndpointProtocolMetastoreV1alpha, String>(endpointProtocol, (value) => value.wireValue),
  ...
  factory HiveMetastoreConfigMetastoreV1alpha.fromMap(Map<String, dynamic> map) {
    return HiveMetastoreConfigMetastoreV1alpha(
      ...
      endpointProtocol: (() { final guardedValue = map['endpointProtocol']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HiveMetastoreConfigEndpointProtocolMetastoreV1alpha.fromValue(guardedValue as String)); })(),
      kerberosConfig: (() { final guardedValue = map['kerberosConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(KerberosConfigMetastoreV1alpha.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
