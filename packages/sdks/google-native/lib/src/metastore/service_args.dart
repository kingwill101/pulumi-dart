...
class ServiceArgs {
  ...
  factory ServiceArgs.fromMap(Map<String, dynamic> map) {
    return ServiceArgs(
      databaseType: map['databaseType'] == null ? null : (ServiceDatabaseType.fromValue(map['databaseType']! as String)).input(),
      ...
      hiveMetastoreConfig: map['hiveMetastoreConfig'] == null ? null : (HiveMetastoreConfig.fromMap((map['hiveMetastoreConfig']! as Map).cast<String, dynamic>())).input(),
      ...
      metadataIntegration: map['metadataIntegration'] == null ? null : (MetadataIntegration.fromMap((map['metadataIntegration']! as Map).cast<String, dynamic>())).input(),
      ...
      releaseChannel: map['releaseChannel'] == null ? null : (ServiceReleaseChannel.fromValue(map['releaseChannel']! as String)).input(),
      ...
      telemetryConfig: map['telemetryConfig'] == null ? null : (TelemetryConfig.fromMap((map['telemetryConfig']! as Map).cast<String, dynamic>())).input(),
      tier: map['tier'] == null ? null : (ServiceTier.fromValue(map['tier']! as String)).input(),
    );
  }
}
