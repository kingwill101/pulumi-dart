...
class ServiceArgs {
  ...
  ServiceArgs({
    pulumi.Output<ServiceDatabaseType>? databaseType,
    pulumi.Output<EncryptionConfig>? encryptionConfig,
    pulumi.Output<HiveMetastoreConfig>? hiveMetastoreConfig,
    pulumi.Output<Map<String, String>>? labels,
    pulumi.Output<String>? location,
    pulumi.Output<MaintenanceWindow>? maintenanceWindow,
    pulumi.Output<MetadataIntegration>? metadataIntegration,
    pulumi.Output<String>? name,
    pulumi.Output<String>? network,
    pulumi.Output<NetworkConfig>? networkConfig,
    pulumi.Output<int>? port,
    pulumi.Output<String>? project,
    pulumi.Output<ServiceReleaseChannel>? releaseChannel,
    pulumi.Output<String>? requestId,
    pulumi.Output<ScalingConfig>? scalingConfig,
    required pulumi.Output<String> serviceId,
    pulumi.Output<TelemetryConfig>? telemetryConfig,
    pulumi.Output<ServiceTier>? tier,
  }) :
      databaseType = pulumi.Input.asOptionalInput<ServiceDatabaseType>(databaseType),
      encryptionConfig = pulumi.Input.asOptionalInput<EncryptionConfig>(encryptionConfig),
      hiveMetastoreConfig = pulumi.Input.asOptionalInput<HiveMetastoreConfig>(hiveMetastoreConfig),
      labels = pulumi.Input.asOptionalInput<Map<String, String>>(labels),
      location = pulumi.Input.asOptionalInput<String>(location),
      maintenanceWindow = pulumi.Input.asOptionalInput<MaintenanceWindow>(maintenanceWindow),
      metadataIntegration = pulumi.Input.asOptionalInput<MetadataIntegration>(metadataIntegration),
      name = pulumi.Input.asOptionalInput<String>(name),
      network = pulumi.Input.asOptionalInput<String>(network),
      networkConfig = pulumi.Input.asOptionalInput<NetworkConfig>(networkConfig),
      port = pulumi.Input.asOptionalInput<int>(port),
      project = pulumi.Input.asOptionalInput<String>(project),
      releaseChannel = pulumi.Input.asOptionalInput<ServiceReleaseChannel>(releaseChannel),
      requestId = pulumi.Input.asOptionalInput<String>(requestId),
      scalingConfig = pulumi.Input.asOptionalInput<ScalingConfig>(scalingConfig),
      serviceId = pulumi.Input.asInput<String>(serviceId),
      telemetryConfig = pulumi.Input.asOptionalInput<TelemetryConfig>(telemetryConfig),
      tier = pulumi.Input.asOptionalInput<ServiceTier>(tier);

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'databaseType': ?pulumi.Input.mapOptionalInputValue<ServiceDatabaseType, String>(databaseType, (value) => value.value),
      ...
      'port': ?port,
      'project': ?project,
      'releaseChannel': ?pulumi.Input.mapOptionalInputValue<ServiceReleaseChannel, String>(releaseChannel, (value) => value.value),
      'requestId': ?requestId,
      ...
      'tier': ?pulumi.Input.mapOptionalInputValue<ServiceTier, String>(tier, (value) => value.value),
    };
  }

  factory ServiceArgs.fromMap(Map<String, dynamic> map) {
    return ServiceArgs(
      databaseType: map['databaseType'] == null ? null : pulumi.Output.create<ServiceDatabaseType>(ServiceDatabaseType.fromValue(map['databaseType'] as String)),
      ...
      hiveMetastoreConfig: map['hiveMetastoreConfig'] == null ? null : pulumi.Output.create<HiveMetastoreConfig>(HiveMetastoreConfig.fromMap((map['hiveMetastoreConfig'] as Map).cast<String, dynamic>())),
      ...
      metadataIntegration: map['metadataIntegration'] == null ? null : pulumi.Output.create<MetadataIntegration>(MetadataIntegration.fromMap((map['metadataIntegration'] as Map).cast<String, dynamic>())),
      ...
      releaseChannel: map['releaseChannel'] == null ? null : pulumi.Output.create<ServiceReleaseChannel>(ServiceReleaseChannel.fromValue(map['releaseChannel'] as String)),
      requestId: map['requestId'] == null ? null : pulumi.Output.create<String>(map['requestId'] as String),
      scalingConfig: map['scalingConfig'] == null ? null : pulumi.Output.create<ScalingConfig>(ScalingConfig.fromMap((map['scalingConfig'] as Map).cast<String, dynamic>())),
      serviceId: pulumi.Output.create<String>(map['serviceId'] as String),
      telemetryConfig: map['telemetryConfig'] == null ? null : pulumi.Output.create<TelemetryConfig>(TelemetryConfig.fromMap((map['telemetryConfig'] as Map).cast<String, dynamic>())),
      tier: map['tier'] == null ? null : pulumi.Output.create<ServiceTier>(ServiceTier.fromValue(map['tier'] as String)),
    );
  }
}
