...
/// {@template pulumi_metastore_v1alpha_service_iam_binding_metastore_v1alpha_args_doc}
/// The set of arguments for ServiceIamBinding.
/// {@endtemplate}
/// {@macro pulumi_metastore_v1alpha_service_iam_binding_metastore_v1alpha_args_doc}
class ServiceIamBindingMetastoreV1alphaArgs {
  ...
  /// Creates a new [ServiceIamBindingMetastoreV1alphaArgs].
  ...
  const ServiceIamBindingMetastoreV1alphaArgs({
    this.condition,
  ...
  factory ServiceIamBindingMetastoreV1alphaArgs.fromMap(Map<String, dynamic> map) {
    return ServiceIamBindingMetastoreV1alphaArgs(
