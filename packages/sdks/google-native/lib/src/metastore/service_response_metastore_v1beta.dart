...
class ServiceResponseMetastoreV1beta {
  ...
  final pulumi.Input<HiveMetastoreConfigResponseMetastoreV1beta>
  hiveMetastoreConfig;
  ...
  final pulumi.Input<MaintenanceWindowResponseMetastoreV1beta>
  maintenanceWindow;

  /// Optional. The setting that defines how metastore metadata should be integrated with external services and systems.
  final pulumi.Input<MetadataIntegrationResponseMetastoreV1beta>
  metadataIntegration;

  /// The metadata management activities of the metastore service.
  final pulumi.Input<MetadataManagementActivityResponseMetastoreV1beta>
  ...
  factory ServiceResponseMetastoreV1beta.fromMap(Map<String, dynamic> map) {
    return ServiceResponseMetastoreV1beta(
      ...
      maintenanceWindow: pulumi.Input.fromValue(
        MaintenanceWindowResponseMetastoreV1beta.fromMap(
          (map['maintenanceWindow']! as Map).cast<String, dynamic>(),
        ),
      ),
      metadataIntegration: pulumi.Input.fromValue(
        MetadataIntegrationResponseMetastoreV1beta.fromMap(
      ...
      networkConfig: pulumi.Input.fromValue(
        NetworkConfigResponseMetastoreV1beta.fromMap(
      ...
      scalingConfig: pulumi.Input.fromValue(
        ScalingConfigResponseMetastoreV1beta.fromMap(
      ...
      telemetryConfig: pulumi.Input.fromValue(
        TelemetryConfigResponseMetastoreV1beta.fromMap(
