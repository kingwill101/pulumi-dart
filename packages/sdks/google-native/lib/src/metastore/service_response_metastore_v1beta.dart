...
class ServiceResponseMetastoreV1beta {
  ...
  factory ServiceResponseMetastoreV1beta.fromMap(Map<String, dynamic> map) {
    return ServiceResponseMetastoreV1beta(
      ...
      encryptionConfig: (EncryptionConfigResponseMetastoreV1beta.fromMap((map['encryptionConfig'] as Map).cast<String, dynamic>())).input(),
      endpointUri: (map['endpointUri'] as String).input(),
      hiveMetastoreConfig: (HiveMetastoreConfigResponseMetastoreV1beta.fromMap((map['hiveMetastoreConfig'] as Map).cast<String, dynamic>())).input(),
      labels: ((map['labels'] as Map).cast<String, String>()).input(),
      maintenanceWindow: (MaintenanceWindowResponseMetastoreV1beta.fromMap((map['maintenanceWindow'] as Map).cast<String, dynamic>())).input(),
      metadataIntegration: (MetadataIntegrationResponseMetastoreV1beta.fromMap((map['metadataIntegration'] as Map).cast<String, dynamic>())).input(),
      metadataManagementActivity: (MetadataManagementActivityResponseMetastoreV1beta.fromMap((map['metadataManagementActivity'] as Map).cast<String, dynamic>())).input(),
      name: (map['name'] as String).input(),
      network: (map['network'] as String).input(),
      networkConfig: (NetworkConfigResponseMetastoreV1beta.fromMap((map['networkConfig'] as Map).cast<String, dynamic>())).input(),
      port: (map['port'] as int).input(),
      releaseChannel: (map['releaseChannel'] as String).input(),
      scalingConfig: (ScalingConfigResponseMetastoreV1beta.fromMap((map['scalingConfig'] as Map).cast<String, dynamic>())).input(),
      state: (map['state'] as String).input(),
      stateMessage: (map['stateMessage'] as String).input(),
      telemetryConfig: (TelemetryConfigResponseMetastoreV1beta.fromMap((map['telemetryConfig'] as Map).cast<String, dynamic>())).input(),
