...
/// {@template pulumi_metastore_v1beta_service_iam_member_metastore_v1beta_args_doc}
/// The set of arguments for ServiceIamMember.
/// {@endtemplate}
/// {@macro pulumi_metastore_v1beta_service_iam_member_metastore_v1beta_args_doc}
class ServiceIamMemberMetastoreV1betaArgs {
  ...
  /// Creates a new [ServiceIamMemberMetastoreV1betaArgs].
  ...
  const ServiceIamMemberMetastoreV1betaArgs({
    this.condition,
  ...
  factory ServiceIamMemberMetastoreV1betaArgs.fromMap(Map<String, dynamic> map) {
    return ServiceIamMemberMetastoreV1betaArgs(
