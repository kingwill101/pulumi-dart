    ...
    return <String, dynamic>{
      ...
      'releaseChannel':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(releaseChannel, (value) => value.wireValue),
      'requestId': ?requestId,
      'scalingConfig':
          ?pulumi.Input.mapOptionalInputValue<
    ...
    return ServiceMetastoreV1betaArgs(
      databaseType: (() {
        ...
        return pulumi.Input.fromValue(
          ServiceDatabaseTypeMetastoreV1beta.fromValue(guardedValue as String),
        );
      })(),
      encryptionConfig: (() {
      ...
      tier: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ServiceTierMetastoreV1beta.fromValue(guardedValue as String),
        );
      })(),
    );
  }
