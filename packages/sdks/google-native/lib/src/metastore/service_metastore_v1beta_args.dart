...
class ServiceMetastoreV1betaArgs {
  ...
  ServiceMetastoreV1betaArgs({
    pulumi.Output<ServiceDatabaseTypeMetastoreV1beta>? databaseType,
    pulumi.Output<EncryptionConfigMetastoreV1beta>? encryptionConfig,
    pulumi.Output<HiveMetastoreConfigMetastoreV1beta>? hiveMetastoreConfig,
    pulumi.Output<Map<String, String>>? labels,
    pulumi.Output<String>? location,
    pulumi.Output<MaintenanceWindowMetastoreV1beta>? maintenanceWindow,
    pulumi.Output<MetadataIntegrationMetastoreV1beta>? metadataIntegration,
    pulumi.Output<String>? name,
    pulumi.Output<String>? network,
    pulumi.Output<NetworkConfigMetastoreV1beta>? networkConfig,
    pulumi.Output<int>? port,
    pulumi.Output<String>? project,
    pulumi.Output<ServiceReleaseChannelMetastoreV1beta>? releaseChannel,
    pulumi.Output<String>? requestId,
    pulumi.Output<ScalingConfigMetastoreV1beta>? scalingConfig,
    required pulumi.Output<String> serviceId,
    pulumi.Output<TelemetryConfigMetastoreV1beta>? telemetryConfig,
    pulumi.Output<ServiceTierMetastoreV1beta>? tier,
  }) :
      databaseType = pulumi.Input.asOptionalInput<ServiceDatabaseTypeMetastoreV1beta>(databaseType),
      encryptionConfig = pulumi.Input.asOptionalInput<EncryptionConfigMetastoreV1beta>(encryptionConfig),
      hiveMetastoreConfig = pulumi.Input.asOptionalInput<HiveMetastoreConfigMetastoreV1beta>(hiveMetastoreConfig),
      labels = pulumi.Input.asOptionalInput<Map<String, String>>(labels),
      location = pulumi.Input.asOptionalInput<String>(location),
      maintenanceWindow = pulumi.Input.asOptionalInput<MaintenanceWindowMetastoreV1beta>(maintenanceWindow),
      metadataIntegration = pulumi.Input.asOptionalInput<MetadataIntegrationMetastoreV1beta>(metadataIntegration),
      name = pulumi.Input.asOptionalInput<String>(name),
      network = pulumi.Input.asOptionalInput<String>(network),
      networkConfig = pulumi.Input.asOptionalInput<NetworkConfigMetastoreV1beta>(networkConfig),
      port = pulumi.Input.asOptionalInput<int>(port),
      project = pulumi.Input.asOptionalInput<String>(project),
      releaseChannel = pulumi.Input.asOptionalInput<ServiceReleaseChannelMetastoreV1beta>(releaseChannel),
      requestId = pulumi.Input.asOptionalInput<String>(requestId),
      scalingConfig = pulumi.Input.asOptionalInput<ScalingConfigMetastoreV1beta>(scalingConfig),
      serviceId = pulumi.Input.asInput<String>(serviceId),
      telemetryConfig = pulumi.Input.asOptionalInput<TelemetryConfigMetastoreV1beta>(telemetryConfig),
  ...
  factory ServiceMetastoreV1betaArgs.fromMap(Map<String, dynamic> map) {
    return ServiceMetastoreV1betaArgs(
      databaseType: map['databaseType'] == null ? null : pulumi.Output.create<ServiceDatabaseTypeMetastoreV1beta>(ServiceDatabaseTypeMetastoreV1beta.fromValue(map['databaseType'] as String)),
      encryptionConfig: map['encryptionConfig'] == null ? null : pulumi.Output.create<EncryptionConfigMetastoreV1beta>(EncryptionConfigMetastoreV1beta.fromMap((map['encryptionConfig'] as Map).cast<String, dynamic>())),
      hiveMetastoreConfig: map['hiveMetastoreConfig'] == null ? null : pulumi.Output.create<HiveMetastoreConfigMetastoreV1beta>(HiveMetastoreConfigMetastoreV1beta.fromMap((map['hiveMetastoreConfig'] as Map).cast<String, dynamic>())),
      labels: map['labels'] == null ? null : pulumi.Output.create<Map<String, String>>((map['labels'] as Map).cast<String, String>()),
      location: map['location'] == null ? null : pulumi.Output.create<String>(map['location'] as String),
      maintenanceWindow: map['maintenanceWindow'] == null ? null : pulumi.Output.create<MaintenanceWindowMetastoreV1beta>(MaintenanceWindowMetastoreV1beta.fromMap((map['maintenanceWindow'] as Map).cast<String, dynamic>())),
      metadataIntegration: map['metadataIntegration'] == null ? null : pulumi.Output.create<MetadataIntegrationMetastoreV1beta>(MetadataIntegrationMetastoreV1beta.fromMap((map['metadataIntegration'] as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      network: map['network'] == null ? null : pulumi.Output.create<String>(map['network'] as String),
      networkConfig: map['networkConfig'] == null ? null : pulumi.Output.create<NetworkConfigMetastoreV1beta>(NetworkConfigMetastoreV1beta.fromMap((map['networkConfig'] as Map).cast<String, dynamic>())),
      port: map['port'] == null ? null : pulumi.Output.create<int>(map['port'] as int),
      project: map['project'] == null ? null : pulumi.Output.create<String>(map['project'] as String),
      releaseChannel: map['releaseChannel'] == null ? null : pulumi.Output.create<ServiceReleaseChannelMetastoreV1beta>(ServiceReleaseChannelMetastoreV1beta.fromValue(map['releaseChannel'] as String)),
      requestId: map['requestId'] == null ? null : pulumi.Output.create<String>(map['requestId'] as String),
      scalingConfig: map['scalingConfig'] == null ? null : pulumi.Output.create<ScalingConfigMetastoreV1beta>(ScalingConfigMetastoreV1beta.fromMap((map['scalingConfig'] as Map).cast<String, dynamic>())),
      serviceId: pulumi.Output.create<String>(map['serviceId'] as String),
      telemetryConfig: map['telemetryConfig'] == null ? null : pulumi.Output.create<TelemetryConfigMetastoreV1beta>(TelemetryConfigMetastoreV1beta.fromMap((map['telemetryConfig'] as Map).cast<String, dynamic>())),
      tier: map['tier'] == null ? null : pulumi.Output.create<ServiceTierMetastoreV1beta>(ServiceTierMetastoreV1beta.fromValue(map['tier'] as String)),
    );
  }
}
