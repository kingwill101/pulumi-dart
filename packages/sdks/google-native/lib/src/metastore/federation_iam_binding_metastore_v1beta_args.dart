...
/// {@template pulumi_metastore_v1beta_federation_iam_binding_metastore_v1beta_args_doc}
/// The set of arguments for FederationIamBinding.
/// {@endtemplate}
/// {@macro pulumi_metastore_v1beta_federation_iam_binding_metastore_v1beta_args_doc}
class FederationIamBindingMetastoreV1betaArgs {
  ...
  /// Creates a new [FederationIamBindingMetastoreV1betaArgs].
  ...
  const FederationIamBindingMetastoreV1betaArgs({
    this.condition,
  ...
  factory FederationIamBindingMetastoreV1betaArgs.fromMap(Map<String, dynamic> map) {
    return FederationIamBindingMetastoreV1betaArgs(
