...
class ScalingConfigMetastoreV1alpha {
  ...
  ScalingConfigMetastoreV1alpha({this.instanceSize, this.scalingFactor});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'instanceSize':
          ?pulumi.Input.mapOptionalInputValue<
            ScalingConfigInstanceSizeMetastoreV1alpha,
            String
    ...
    return ScalingConfigMetastoreV1alpha(
      instanceSize: (() {
        ...
        return pulumi.Input.fromValue(
          ScalingConfigInstanceSizeMetastoreV1alpha.fromValue(
