...
/// {@template pulumi_metastore_v1alpha_service_database_iam_binding_args_doc}
/// The set of arguments for ServiceDatabaseIamBinding.
/// {@endtemplate}
/// {@macro pulumi_metastore_v1alpha_service_database_iam_binding_args_doc}
class ServiceDatabaseIamBindingArgs {
  ...
  /// Creates a new [ServiceDatabaseIamBindingArgs].
  ...
  const ServiceDatabaseIamBindingArgs({
    this.condition,
