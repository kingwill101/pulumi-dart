...
class HiveMetastoreConfigMetastoreV1beta {
  ...
  final pulumi.Input<HiveMetastoreConfigEndpointProtocolMetastoreV1beta>?
  endpointProtocol;
    ...
    return <String, dynamic>{
      ...
      'endpointProtocol':
          ?pulumi.Input.mapOptionalInputValue<
            HiveMetastoreConfigEndpointProtocolMetastoreV1beta,
            String
          >(endpointProtocol, (value) => value.wireValue),
      'kerberosConfig':
          ?pulumi.Input.mapOptionalInputValue<
            KerberosConfigMetastoreV1beta,
            Map<String, dynamic>
  ...
  factory HiveMetastoreConfigMetastoreV1beta.fromMap(Map<String, dynamic> map) {
    return HiveMetastoreConfigMetastoreV1beta(
      ...
      endpointProtocol: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          HiveMetastoreConfigEndpointProtocolMetastoreV1beta.fromValue(
      ...
      kerberosConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          KerberosConfigMetastoreV1beta.fromMap(
