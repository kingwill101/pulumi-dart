...
class MetadataImport extends pulumi.CustomResource {
  /// The time when the metadata import was started.
  late final pulumi.Output<String> createTime;
  /// Immutable. A database dump from a pre-existing metastore's database.
  late final pulumi.Output<DatabaseDumpResponse> databaseDump;
  ...
  /// Creates a new [MetadataImport].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [MetadataImport]. {@macro pulumi_metastore_v1_metadata_import_args_doc}
  ...
  MetadataImport(
    ...
    databaseDump = registerOutput<DatabaseDumpResponse>('databaseDump', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return DatabaseDumpResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
