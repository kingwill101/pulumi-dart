...
/// {@template pulumi_metastore_v1_federation_iam_binding_args_doc}
/// The set of arguments for FederationIamBinding.
/// {@endtemplate}
/// {@macro pulumi_metastore_v1_federation_iam_binding_args_doc}
class FederationIamBindingArgs {
  ...
  /// Creates a new [FederationIamBindingArgs].
  ...
  const FederationIamBindingArgs({
    this.condition,
  ...
  factory FederationIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return FederationIamBindingArgs(
