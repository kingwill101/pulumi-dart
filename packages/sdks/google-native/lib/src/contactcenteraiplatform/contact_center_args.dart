...
class ContactCenterArgs {
  ...
  factory ContactCenterArgs.fromMap(Map<String, dynamic> map) {
    return ContactCenterArgs(
      adminUser: (() { final guardedValue = map['adminUser']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AdminUser.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ccaipManagedUsers: (() { final guardedValue = map['ccaipManagedUsers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      contactCenterId: pulumi.Input.fromValue(map['contactCenterId'] as String),
      customerDomainPrefix: pulumi.Input.fromValue(map['customerDomainPrefix'] as String),
      displayName: pulumi.Input.fromValue(map['displayName'] as String),
      instanceConfig: (() { final guardedValue = map['instanceConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      samlParams: (() { final guardedValue = map['samlParams']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SAMLParams.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
