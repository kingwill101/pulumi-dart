...
class InstanceConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'instanceSize': ?pulumi.Input.mapOptionalInputValue<InstanceConfigInstanceSize, String>(instanceSize, (value) => value.wireValue),
    };
  }

  factory InstanceConfig.fromMap(Map<String, dynamic> map) {
    return InstanceConfig(
      instanceSize: (() { final guardedValue = map['instanceSize']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceConfigInstanceSize.fromValue(guardedValue as String)); })(),
    );
  }
}
