...
class QueuedResourceStatusFailedDataErrorErrorsItemResponse {
  ...
  factory QueuedResourceStatusFailedDataErrorErrorsItemResponse.fromMap(Map<String, dynamic> map) {
    return QueuedResourceStatusFailedDataErrorErrorsItemResponse(
      ...
      errorDetails: pulumi.Input.fromValue(pulumi.Input.decodeList<QueuedResourceStatusFailedDataErrorErrorsItemErrorDetailsItemResponse>(map['errorDetails']!, (value) => QueuedResourceStatusFailedDataErrorErrorsItemErrorDetailsItemResponse.fromMap((value as Map).cast<String, dynamic>()))),
