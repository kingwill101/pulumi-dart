...
class ServiceAttachmentComputeBeta extends pulumi.CustomResource {
  ...
  ServiceAttachmentComputeBeta(
    ...
    pscServiceAttachmentId = registerOutput<Uint128ResponseComputeBeta>('pscServiceAttachmentId', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return Uint128ResponseComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    tunnelingConfig = registerOutput<ServiceAttachmentTunnelingConfigResponseComputeBeta>('tunnelingConfig', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ServiceAttachmentTunnelingConfigResponseComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  }
}
