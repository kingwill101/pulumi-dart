...
class InstancePropertiesResponseComputeV1 {
  ...
  final pulumi.Input<AdvancedMachineFeaturesResponseComputeV1> advancedMachineFeatures;
  /// Enables instances created based on these properties to send packets with source IP addresses other than their own and receive packets with destination IP addresses other than their own. If these instances will be used as an IP gateway or it will be set as the next-hop in a Route resource, specify true. If unsure, leave this set to false. See the Enable IP forwarding documentation for more information.
  final pulumi.Input<bool> canIpForward;
  /// Specifies the Confidential Instance options. Note that for MachineImage, this is not supported yet.
  final pulumi.Input<ConfidentialInstanceConfigResponseComputeV1> confidentialInstanceConfig;
  ...
  final pulumi.Input<NetworkPerformanceConfigResponseComputeV1> networkPerformanceConfig;
  ...
  /// Note that for MachineImage, this is not supported yet.
  final pulumi.Input<ShieldedInstanceConfigResponseComputeV1> shieldedInstanceConfig;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'advancedMachineFeatures': pulumi.Input.mapInputValue<AdvancedMachineFeaturesResponseComputeV1, Map<String, dynamic>>(advancedMachineFeatures, (value) => value.toMap()),
      'canIpForward': canIpForward,
      'confidentialInstanceConfig': pulumi.Input.mapInputValue<ConfidentialInstanceConfigResponseComputeV1, Map<String, dynamic>>(confidentialInstanceConfig, (value) => value.toMap()),
      'description': description,
      'disks': pulumi.Input.mapInputValue<List<AttachedDiskResponseComputeV1>, List<Map<String, dynamic>>>(disks, (value) => pulumi.Input.encodeList<AttachedDiskResponseComputeV1, Map<String, dynamic>>(value, (value) => value.toMap())),
      ...
      'metadata': pulumi.Input.mapInputValue<MetadataResponseComputeV1, Map<String, dynamic>>(metadata, (value) => value.toMap()),
      'minCpuPlatform': minCpuPlatform,
      'networkInterfaces': pulumi.Input.mapInputValue<List<NetworkInterfaceResponseComputeV1>, List<Map<String, dynamic>>>(networkInterfaces, (value) => pulumi.Input.encodeList<NetworkInterfaceResponseComputeV1, Map<String, dynamic>>(value, (value) => value.toMap())),
      'networkPerformanceConfig': pulumi.Input.mapInputValue<NetworkPerformanceConfigResponseComputeV1, Map<String, dynamic>>(networkPerformanceConfig, (value) => value.toMap()),
      'privateIpv6GoogleAccess': privateIpv6GoogleAccess,
      'reservationAffinity': pulumi.Input.mapInputValue<ReservationAffinityResponseComputeV1, Map<String, dynamic>>(reservationAffinity, (value) => value.toMap()),
      'resourceManagerTags': resourceManagerTags,
      'resourcePolicies': resourcePolicies,
      'scheduling': pulumi.Input.mapInputValue<SchedulingResponseComputeV1, Map<String, dynamic>>(scheduling, (value) => value.toMap()),
      'serviceAccounts': pulumi.Input.mapInputValue<List<ServiceAccountResponseComputeV1>, List<Map<String, dynamic>>>(serviceAccounts, (value) => pulumi.Input.encodeList<ServiceAccountResponseComputeV1, Map<String, dynamic>>(value, (value) => value.toMap())),
      'shieldedInstanceConfig': pulumi.Input.mapInputValue<ShieldedInstanceConfigResponseComputeV1, Map<String, dynamic>>(shieldedInstanceConfig, (value) => value.toMap()),
      'tags': pulumi.Input.mapInputValue<TagsResponseComputeV1, Map<String, dynamic>>(tags, (value) => value.toMap()),
    };
  }

  factory InstancePropertiesResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return InstancePropertiesResponseComputeV1(
      advancedMachineFeatures: pulumi.Input.fromValue(AdvancedMachineFeaturesResponseComputeV1.fromMap((map['advancedMachineFeatures']! as Map).cast<String, dynamic>())),
      canIpForward: pulumi.Input.fromValue(map['canIpForward'] as bool),
      confidentialInstanceConfig: pulumi.Input.fromValue(ConfidentialInstanceConfigResponseComputeV1.fromMap((map['confidentialInstanceConfig']! as Map).cast<String, dynamic>())),
      description: pulumi.Input.fromValue(map['description'] as String),
      disks: pulumi.Input.fromValue(pulumi.Input.decodeList<AttachedDiskResponseComputeV1>(map['disks']!, (value) => AttachedDiskResponseComputeV1.fromMap((value as Map).cast<String, dynamic>()))),
      guestAccelerators: pulumi.Input.fromValue(pulumi.Input.decodeList<AcceleratorConfigResponseComputeV1>(map['guestAccelerators']!, (value) => AcceleratorConfigResponseComputeV1.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      metadata: pulumi.Input.fromValue(MetadataResponseComputeV1.fromMap((map['metadata']! as Map).cast<String, dynamic>())),
      minCpuPlatform: pulumi.Input.fromValue(map['minCpuPlatform'] as String),
      networkInterfaces: pulumi.Input.fromValue(pulumi.Input.decodeList<NetworkInterfaceResponseComputeV1>(map['networkInterfaces']!, (value) => NetworkInterfaceResponseComputeV1.fromMap((value as Map).cast<String, dynamic>()))),
      networkPerformanceConfig: pulumi.Input.fromValue(NetworkPerformanceConfigResponseComputeV1.fromMap((map['networkPerformanceConfig']! as Map).cast<String, dynamic>())),
      privateIpv6GoogleAccess: pulumi.Input.fromValue(map['privateIpv6GoogleAccess'] as String),
      reservationAffinity: pulumi.Input.fromValue(ReservationAffinityResponseComputeV1.fromMap((map['reservationAffinity']! as Map).cast<String, dynamic>())),
      ...
      scheduling: pulumi.Input.fromValue(SchedulingResponseComputeV1.fromMap((map['scheduling']! as Map).cast<String, dynamic>())),
      serviceAccounts: pulumi.Input.fromValue(pulumi.Input.decodeList<ServiceAccountResponseComputeV1>(map['serviceAccounts']!, (value) => ServiceAccountResponseComputeV1.fromMap((value as Map).cast<String, dynamic>()))),
      shieldedInstanceConfig: pulumi.Input.fromValue(ShieldedInstanceConfigResponseComputeV1.fromMap((map['shieldedInstanceConfig']! as Map).cast<String, dynamic>())),
      tags: pulumi.Input.fromValue(TagsResponseComputeV1.fromMap((map['tags']! as Map).cast<String, dynamic>())),
    );
  }
}
