...
class InstancePropertiesResponseComputeV1 {
  ...
  factory InstancePropertiesResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return InstancePropertiesResponseComputeV1(
      advancedMachineFeatures: (AdvancedMachineFeaturesResponseComputeV1.fromMap((map['advancedMachineFeatures'] as Map).cast<String, dynamic>())).input(),
      canIpForward: (map['canIpForward'] as bool).input(),
      confidentialInstanceConfig: (ConfidentialInstanceConfigResponseComputeV1.fromMap((map['confidentialInstanceConfig'] as Map).cast<String, dynamic>())).input(),
      description: (map['description'] as String).input(),
      disks: (pulumi.Input.decodeList<AttachedDiskResponseComputeV1>(map['disks'], (value) => AttachedDiskResponseComputeV1.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      metadata: (MetadataResponseComputeV1.fromMap((map['metadata'] as Map).cast<String, dynamic>())).input(),
      minCpuPlatform: (map['minCpuPlatform'] as String).input(),
      networkInterfaces: (pulumi.Input.decodeList<NetworkInterfaceResponseComputeV1>(map['networkInterfaces'], (value) => NetworkInterfaceResponseComputeV1.fromMap((value as Map).cast<String, dynamic>()))).input(),
      networkPerformanceConfig: (NetworkPerformanceConfigResponseComputeV1.fromMap((map['networkPerformanceConfig'] as Map).cast<String, dynamic>())).input(),
      privateIpv6GoogleAccess: (map['privateIpv6GoogleAccess'] as String).input(),
      reservationAffinity: (ReservationAffinityResponseComputeV1.fromMap((map['reservationAffinity'] as Map).cast<String, dynamic>())).input(),
      ...
      scheduling: (SchedulingResponseComputeV1.fromMap((map['scheduling'] as Map).cast<String, dynamic>())).input(),
      serviceAccounts: (pulumi.Input.decodeList<ServiceAccountResponseComputeV1>(map['serviceAccounts'], (value) => ServiceAccountResponseComputeV1.fromMap((value as Map).cast<String, dynamic>()))).input(),
      shieldedInstanceConfig: (ShieldedInstanceConfigResponseComputeV1.fromMap((map['shieldedInstanceConfig'] as Map).cast<String, dynamic>())).input(),
      tags: (TagsResponseComputeV1.fromMap((map['tags'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
