...
class ReservationComputeBetaArgs {
  ...
  const ReservationComputeBetaArgs({
  ...
  factory ReservationComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return ReservationComputeBetaArgs(
      aggregateReservation: (() { final guardedValue = map['aggregateReservation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AllocationAggregateReservationComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      deleteAfterDuration: (() { final guardedValue = map['deleteAfterDuration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DurationComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      shareSettings: (() { final guardedValue = map['shareSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ShareSettingsComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      specificReservation: (() { final guardedValue = map['specificReservation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AllocationSpecificSKUReservationComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
