...
/// {@template pulumi_compute_beta_disk_iam_member_compute_beta_args_doc}
/// The set of arguments for DiskIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_disk_iam_member_compute_beta_args_doc}
class DiskIamMemberComputeBetaArgs {
  ...
  /// Creates a new [DiskIamMemberComputeBetaArgs].
  ...
  const DiskIamMemberComputeBetaArgs({
    this.condition,
  ...
  factory DiskIamMemberComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return DiskIamMemberComputeBetaArgs(
