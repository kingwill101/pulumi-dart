...
class BackendBucketCdnPolicyNegativeCachingPolicyResponseComputeBeta {
  ...
  const BackendBucketCdnPolicyNegativeCachingPolicyResponseComputeBeta({
    required this.code,
    required this.ttl,
  });
  ...
  factory BackendBucketCdnPolicyNegativeCachingPolicyResponseComputeBeta.fromMap(Map<String, dynamic> map) {
