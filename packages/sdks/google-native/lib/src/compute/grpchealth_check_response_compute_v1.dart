...
class GRPCHealthCheckResponseComputeV1 {
  ...
  /// Creates a new [GRPCHealthCheckResponseComputeV1].
  ...
  const GRPCHealthCheckResponseComputeV1({
  ...
  factory GRPCHealthCheckResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return GRPCHealthCheckResponseComputeV1(
