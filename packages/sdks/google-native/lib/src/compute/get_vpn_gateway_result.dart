...
class GetVpnGatewayResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'selfLink': selfLink,
      'stackType': stackType,
      'vpnInterfaces': pulumi.Input.encodeList<VpnGatewayVpnGatewayInterfaceResponse, Map<String, dynamic>>(vpnInterfaces, (value) => value.toMap()),
    };
  }
  ...
  factory GetVpnGatewayResult.fromMap(Map<String, dynamic> map) {
    return GetVpnGatewayResult(
      ...
      vpnInterfaces: pulumi.Input.decodeList<VpnGatewayVpnGatewayInterfaceResponse>(map['vpnInterfaces'], (value) => VpnGatewayVpnGatewayInterfaceResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
