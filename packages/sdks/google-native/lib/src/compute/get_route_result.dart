...
class GetRouteResult {
  ...
  /// [nextHopInterRegionCost] [Output only] Internal fixed region-to-region cost that Google Cloud calculates based on factors such as network performance, distance, and available bandwidth between regions.
  /// [nextHopInterconnectAttachment] The URL to an InterconnectAttachment which is the next hop for the route. This field will only be populated for the dynamic routes generated by Cloud Router with a linked interconnectAttachment.
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'asPaths': pulumi.Input.encodeList<RouteAsPathResponse, Map<String, dynamic>>(asPaths, (value) => value.toMap()),
      ...
      'tags': tags,
      'warnings': pulumi.Input.encodeList<RouteWarningsItemResponse, Map<String, dynamic>>(warnings, (value) => value.toMap()),
    };
  }
  ...
  factory GetRouteResult.fromMap(Map<String, dynamic> map) {
    return GetRouteResult(
      ...
      asPaths: pulumi.Input.decodeList<RouteAsPathResponse>(map['asPaths']!, (value) => RouteAsPathResponse.fromMap((value as Map).cast<String, dynamic>())),
      ...
      nextHopInterconnectAttachment: map['nextHopInterconnectAttachment'] as String,
      ...
      warnings: pulumi.Input.decodeList<RouteWarningsItemResponse>(map['warnings']!, (value) => RouteWarningsItemResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
