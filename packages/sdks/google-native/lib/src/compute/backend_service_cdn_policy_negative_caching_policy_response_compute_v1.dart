...
class BackendServiceCdnPolicyNegativeCachingPolicyResponseComputeV1 {
  ...
  const BackendServiceCdnPolicyNegativeCachingPolicyResponseComputeV1({
    required this.code,
    required this.ttl,
  });
  ...
  factory BackendServiceCdnPolicyNegativeCachingPolicyResponseComputeV1.fromMap(Map<String, dynamic> map) {
