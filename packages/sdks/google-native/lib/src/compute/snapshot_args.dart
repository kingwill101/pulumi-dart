...
class SnapshotArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'snapshotType': ?pulumi.Input.mapOptionalInputValue<SnapshotSnapshotType, String>(snapshotType, (value) => value.wireValue),
  ...
  factory SnapshotArgs.fromMap(Map<String, dynamic> map) {
    return SnapshotArgs(
      ...
      snapshotType: (() { final guardedValue = map['snapshotType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SnapshotSnapshotType.fromValue(guardedValue as String)); })(),
