...
class InstanceGroupManagerAutoHealingPolicyAutoHealingTriggers {
  ...
  const InstanceGroupManagerAutoHealingPolicyAutoHealingTriggers({
    this.onHealthCheck,
  });

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'onHealthCheck': ?pulumi.Input.mapOptionalInputValue<InstanceGroupManagerAutoHealingPolicyAutoHealingTriggersOnHealthCheck, String>(onHealthCheck, (value) => value.wireValue),
    };
  }
  ...
  factory InstanceGroupManagerAutoHealingPolicyAutoHealingTriggers.fromMap(Map<String, dynamic> map) {
    return InstanceGroupManagerAutoHealingPolicyAutoHealingTriggers(
      onHealthCheck: (() { final guardedValue = map['onHealthCheck']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceGroupManagerAutoHealingPolicyAutoHealingTriggersOnHealthCheck.fromValue(guardedValue as String)); })(),
    );
  }
}
