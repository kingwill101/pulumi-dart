...
class GetRouteComputeV1Result {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'asPaths': pulumi.Input.encodeList<RouteAsPathResponseComputeV1, Map<String, dynamic>>(asPaths, (value) => value.toMap()),
      ...
      'selfLink': selfLink,
      'tags': tags,
      'warnings': pulumi.Input.encodeList<RouteWarningsItemResponseComputeV1, Map<String, dynamic>>(warnings, (value) => value.toMap()),
    };
  }

  factory GetRouteComputeV1Result.fromMap(Map<String, dynamic> map) {
    return GetRouteComputeV1Result(
      asPaths: pulumi.Input.decodeList<RouteAsPathResponseComputeV1>(map['asPaths'], (value) => RouteAsPathResponseComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      ...
      warnings: pulumi.Input.decodeList<RouteWarningsItemResponseComputeV1>(map['warnings'], (value) => RouteWarningsItemResponseComputeV1.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
