...
class InterconnectAttachment extends pulumi.CustomResource {
  ...
  InterconnectAttachment(
    ...
    this.configurationConstraints = registerOutput<InterconnectAttachmentConfigurationConstraintsResponse>('configurationConstraints');
    ...
    this.partnerMetadata = registerOutput<InterconnectAttachmentPartnerMetadataResponse>('partnerMetadata');
    this.privateInterconnectInfo = registerOutput<InterconnectAttachmentPrivateInfoResponse>('privateInterconnectInfo');
