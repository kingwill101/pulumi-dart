...
class InterconnectAttachment extends pulumi.CustomResource {
  ...
  late final pulumi.Output<InterconnectAttachmentConfigurationConstraintsResponse> configurationConstraints;
  ...
  late final pulumi.Output<InterconnectAttachmentPartnerMetadataResponse> partnerMetadata;
  ...
  late final pulumi.Output<InterconnectAttachmentPrivateInfoResponse> privateInterconnectInfo;
  ...
  InterconnectAttachment(
    ...
    configurationConstraints = registerOutput<InterconnectAttachmentConfigurationConstraintsResponse>('configurationConstraints', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return InterconnectAttachmentConfigurationConstraintsResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    partnerMetadata = registerOutput<InterconnectAttachmentPartnerMetadataResponse>('partnerMetadata', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return InterconnectAttachmentPartnerMetadataResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    privateInterconnectInfo = registerOutput<InterconnectAttachmentPrivateInfoResponse>('privateInterconnectInfo', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return InterconnectAttachmentPrivateInfoResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
