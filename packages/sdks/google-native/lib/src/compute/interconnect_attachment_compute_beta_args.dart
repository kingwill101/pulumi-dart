...
class InterconnectAttachmentComputeBetaArgs {
  ...
  factory InterconnectAttachmentComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return InterconnectAttachmentComputeBetaArgs(
      ...
      bandwidth: map['bandwidth'] == null ? null : (InterconnectAttachmentBandwidthComputeBeta.fromValue(map['bandwidth'] as String)).input(),
      ...
      edgeAvailabilityDomain: map['edgeAvailabilityDomain'] == null ? null : (InterconnectAttachmentEdgeAvailabilityDomainComputeBeta.fromValue(map['edgeAvailabilityDomain'] as String)).input(),
      encryption: map['encryption'] == null ? null : (InterconnectAttachmentEncryptionComputeBeta.fromValue(map['encryption'] as String)).input(),
      ...
      partnerMetadata: map['partnerMetadata'] == null ? null : (InterconnectAttachmentPartnerMetadataComputeBeta.fromMap((map['partnerMetadata'] as Map).cast<String, dynamic>())).input(),
      project: map['project'] == null ? null : (map['project'] as String).input(),
      region: (map['region'] as String).input(),
      requestId: map['requestId'] == null ? null : (map['requestId'] as String).input(),
      router: map['router'] == null ? null : (map['router'] as String).input(),
      stackType: map['stackType'] == null ? null : (InterconnectAttachmentStackTypeComputeBeta.fromValue(map['stackType'] as String)).input(),
      subnetLength: map['subnetLength'] == null ? null : (map['subnetLength'] as int).input(),
      type: map['type'] == null ? null : (InterconnectAttachmentTypeComputeBeta.fromValue(map['type'] as String)).input(),
