...
class BackendBucketCdnPolicy {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'cacheMode': ?pulumi.Input.mapOptionalInputValue<BackendBucketCdnPolicyCacheMode, String>(cacheMode, (value) => value.wireValue),
      'clientTtl': ?clientTtl,
  ...
  factory BackendBucketCdnPolicy.fromMap(Map<String, dynamic> map) {
    return BackendBucketCdnPolicy(
      ...
      cacheMode: (() { final guardedValue = map['cacheMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BackendBucketCdnPolicyCacheMode.fromValue(guardedValue as String)); })(),
      ...
      negativeCachingPolicy: (() { final guardedValue = map['negativeCachingPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<BackendBucketCdnPolicyNegativeCachingPolicy>(guardedValue, (value) => BackendBucketCdnPolicyNegativeCachingPolicy.fromMap((value as Map).cast<String, dynamic>()))); })(),
