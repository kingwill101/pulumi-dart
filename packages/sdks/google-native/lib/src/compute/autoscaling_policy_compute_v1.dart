...
class AutoscalingPolicyComputeV1 {
  ...
  final pulumi.Input<List<AutoscalingPolicyCustomMetricUtilizationComputeV1>>? customMetricUtilizations;
  /// Configuration parameters of autoscaling based on load balancer.
  final pulumi.Input<AutoscalingPolicyLoadBalancingUtilizationComputeV1>? loadBalancingUtilization;
  ...
  const AutoscalingPolicyComputeV1({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'cpuUtilization': ?pulumi.Input.mapOptionalInputValue<AutoscalingPolicyCpuUtilizationComputeV1, Map<String, dynamic>>(cpuUtilization, (value) => value.toMap()),
      'customMetricUtilizations': ?pulumi.Input.mapOptionalInputValue<List<AutoscalingPolicyCustomMetricUtilizationComputeV1>, List<Map<String, dynamic>>>(customMetricUtilizations, (value) => pulumi.Input.encodeList<AutoscalingPolicyCustomMetricUtilizationComputeV1, Map<String, dynamic>>(value, (value) => value.toMap())),
      'loadBalancingUtilization': ?pulumi.Input.mapOptionalInputValue<AutoscalingPolicyLoadBalancingUtilizationComputeV1, Map<String, dynamic>>(loadBalancingUtilization, (value) => value.toMap()),
      'maxNumReplicas': ?maxNumReplicas,
      'minNumReplicas': ?minNumReplicas,
      'mode': ?pulumi.Input.mapOptionalInputValue<AutoscalingPolicyModeComputeV1, String>(mode, (value) => value.wireValue),
      'scaleInControl': ?pulumi.Input.mapOptionalInputValue<AutoscalingPolicyScaleInControlComputeV1, Map<String, dynamic>>(scaleInControl, (value) => value.toMap()),
  ...
  factory AutoscalingPolicyComputeV1.fromMap(Map<String, dynamic> map) {
    return AutoscalingPolicyComputeV1(
      ...
      cpuUtilization: (() { final guardedValue = map['cpuUtilization']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AutoscalingPolicyCpuUtilizationComputeV1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      customMetricUtilizations: (() { final guardedValue = map['customMetricUtilizations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AutoscalingPolicyCustomMetricUtilizationComputeV1>(guardedValue, (value) => AutoscalingPolicyCustomMetricUtilizationComputeV1.fromMap((value as Map).cast<String, dynamic>()))); })(),
      loadBalancingUtilization: (() { final guardedValue = map['loadBalancingUtilization']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AutoscalingPolicyLoadBalancingUtilizationComputeV1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      mode: (() { final guardedValue = map['mode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AutoscalingPolicyModeComputeV1.fromValue(guardedValue as String)); })(),
      scaleInControl: (() { final guardedValue = map['scaleInControl']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AutoscalingPolicyScaleInControlComputeV1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
