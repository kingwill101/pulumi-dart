...
class TargetHttpsProxyComputeBetaArgs {
  ...
  TargetHttpsProxyComputeBetaArgs({
    ...
    pulumi.Output<TargetHttpsProxyQuicOverrideComputeBeta>? quicOverride,
  ...
  factory TargetHttpsProxyComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return TargetHttpsProxyComputeBetaArgs(
      ...
      quicOverride: map['quicOverride'] == null ? null : pulumi.Output.create<TargetHttpsProxyQuicOverrideComputeBeta>(TargetHttpsProxyQuicOverrideComputeBeta.fromValue(map['quicOverride'] as String)),
