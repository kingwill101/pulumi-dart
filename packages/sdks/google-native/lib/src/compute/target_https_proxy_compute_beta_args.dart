...
class TargetHttpsProxyComputeBetaArgs {
  ...
  const TargetHttpsProxyComputeBetaArgs({
    this.authentication,
    this.authorization,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'project': ?project,
      'proxyBind': ?proxyBind,
      'quicOverride': ?pulumi.Input.mapOptionalInputValue<TargetHttpsProxyQuicOverrideComputeBeta, String>(quicOverride, (value) => value.wireValue),
      'requestId': ?requestId,
  ...
  factory TargetHttpsProxyComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return TargetHttpsProxyComputeBetaArgs(
      ...
      quicOverride: (() { final guardedValue = map['quicOverride']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TargetHttpsProxyQuicOverrideComputeBeta.fromValue(guardedValue as String)); })(),
