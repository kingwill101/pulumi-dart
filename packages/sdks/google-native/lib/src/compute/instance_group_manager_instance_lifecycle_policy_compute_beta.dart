...
class InstanceGroupManagerInstanceLifecyclePolicyComputeBeta {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'defaultActionOnFailure': ?pulumi.Input.mapOptionalInputValue<InstanceGroupManagerInstanceLifecyclePolicyDefaultActionOnFailureComputeBeta, String>(defaultActionOnFailure, (value) => value.value),
      'forceUpdateOnRepair': ?pulumi.Input.mapOptionalInputValue<InstanceGroupManagerInstanceLifecyclePolicyForceUpdateOnRepairComputeBeta, String>(forceUpdateOnRepair, (value) => value.value),
    };
  }
