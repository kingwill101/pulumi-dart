    ...
    return <String, dynamic>{
      'defaultActionOnFailure':
          ?pulumi.Input.mapOptionalInputValue<
            InstanceGroupManagerInstanceLifecyclePolicyDefaultActionOnFailureComputeBeta,
            String
          >(defaultActionOnFailure, (value) => value.wireValue),
      'forceUpdateOnRepair':
          ?pulumi.Input.mapOptionalInputValue<
            InstanceGroupManagerInstanceLifecyclePolicyForceUpdateOnRepairComputeBeta,
            String
    ...
    return InstanceGroupManagerInstanceLifecyclePolicyComputeBeta(
      defaultActionOnFailure: (() {
        ...
        return pulumi.Input.fromValue(
          InstanceGroupManagerInstanceLifecyclePolicyDefaultActionOnFailureComputeBeta.fromValue(
      ...
      forceUpdateOnRepair: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          InstanceGroupManagerInstanceLifecyclePolicyForceUpdateOnRepairComputeBeta.fromValue(
            guardedValue as String,
          ),
        );
      })(),
