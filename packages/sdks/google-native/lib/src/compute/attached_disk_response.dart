...
class AttachedDiskResponse {
  ...
  factory AttachedDiskResponse.fromMap(Map<String, dynamic> map) {
    return AttachedDiskResponse(
      ...
      initializeParams: pulumi.Input.fromValue(AttachedDiskInitializeParamsResponse.fromMap((map['initializeParams']! as Map).cast<String, dynamic>())),
      ...
      shieldedInstanceInitialState: pulumi.Input.fromValue(InitialStateConfigResponse.fromMap((map['shieldedInstanceInitialState']! as Map).cast<String, dynamic>())),
