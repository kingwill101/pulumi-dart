...
class AttachedDiskResponse {
  ...
  final pulumi.Input<AttachedDiskInitializeParamsResponse> initializeParams;
  ...
  final pulumi.Input<InitialStateConfigResponse> shieldedInstanceInitialState;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'index': index,
      'initializeParams': pulumi.Input.mapInputValue<AttachedDiskInitializeParamsResponse, Map<String, dynamic>>(initializeParams, (value) => value.toMap()),
      'interface': interface,
      'kind': kind,
      'licenses': licenses,
      'locked': locked,
      ...
      'shieldedInstanceInitialState': pulumi.Input.mapInputValue<InitialStateConfigResponse, Map<String, dynamic>>(shieldedInstanceInitialState, (value) => value.toMap()),
      'source': source,
      'type': type,
  ...
  factory AttachedDiskResponse.fromMap(Map<String, dynamic> map) {
    return AttachedDiskResponse(
      ...
      diskEncryptionKey: (CustomerEncryptionKeyResponse.fromMap((map['diskEncryptionKey'] as Map).cast<String, dynamic>())).input(),
      ...
      initializeParams: (AttachedDiskInitializeParamsResponse.fromMap((map['initializeParams'] as Map).cast<String, dynamic>())).input(),
      ...
      savedState: (map['savedState'] as String).input(),
      shieldedInstanceInitialState: (InitialStateConfigResponse.fromMap((map['shieldedInstanceInitialState'] as Map).cast<String, dynamic>())).input(),
      source: (map['source'] as String).input(),
      type: (map['type'] as String).input(),
      userLicenses: ((map['userLicenses'] as List).cast<String>()).input(),
    );
  }
}
