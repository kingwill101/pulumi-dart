...
class FirewallPolicyRuleMatcherComputeV1 {
  ...
  final pulumi.Input<List<FirewallPolicyRuleMatcherLayer4ConfigComputeV1>>? layer4Configs;
  ...
  final pulumi.Input<List<FirewallPolicyRuleSecureTagComputeV1>>? srcSecureTags;
  ...
  const FirewallPolicyRuleMatcherComputeV1({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'layer4Configs': ?pulumi.Input.mapOptionalInputValue<List<FirewallPolicyRuleMatcherLayer4ConfigComputeV1>, List<Map<String, dynamic>>>(layer4Configs, (value) => pulumi.Input.encodeList<FirewallPolicyRuleMatcherLayer4ConfigComputeV1, Map<String, dynamic>>(value, (value) => value.toMap())),
      'srcAddressGroups': ?srcAddressGroups,
      'srcFqdns': ?srcFqdns,
      'srcIpRanges': ?srcIpRanges,
      'srcRegionCodes': ?srcRegionCodes,
      'srcSecureTags': ?pulumi.Input.mapOptionalInputValue<List<FirewallPolicyRuleSecureTagComputeV1>, List<Map<String, dynamic>>>(srcSecureTags, (value) => pulumi.Input.encodeList<FirewallPolicyRuleSecureTagComputeV1, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory FirewallPolicyRuleMatcherComputeV1.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyRuleMatcherComputeV1(
      ...
      layer4Configs: (() { final guardedValue = map['layer4Configs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FirewallPolicyRuleMatcherLayer4ConfigComputeV1>(guardedValue, (value) => FirewallPolicyRuleMatcherLayer4ConfigComputeV1.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      srcSecureTags: (() { final guardedValue = map['srcSecureTags']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FirewallPolicyRuleSecureTagComputeV1>(guardedValue, (value) => FirewallPolicyRuleSecureTagComputeV1.fromMap((value as Map).cast<String, dynamic>()))); })(),
