...
class FirewallPolicyRuleMatcherComputeV1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'layer4Configs': ?layer4Configs == null ? null : pulumi.Input.encodeList<FirewallPolicyRuleMatcherLayer4ConfigComputeV1, Map<String, dynamic>>(layer4Configs!, (value) => value.toMap()),
      'srcAddressGroups': ?srcAddressGroups,
      'srcFqdns': ?srcFqdns,
      'srcIpRanges': ?srcIpRanges,
      'srcRegionCodes': ?srcRegionCodes,
      'srcSecureTags': ?srcSecureTags == null ? null : pulumi.Input.encodeList<FirewallPolicyRuleSecureTagComputeV1, Map<String, dynamic>>(srcSecureTags!, (value) => value.toMap()),
  ...
  factory FirewallPolicyRuleMatcherComputeV1.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyRuleMatcherComputeV1(
      ...
      layer4Configs: map['layer4Configs'] == null ? null : pulumi.Input.decodeList<FirewallPolicyRuleMatcherLayer4ConfigComputeV1>(map['layer4Configs'], (value) => FirewallPolicyRuleMatcherLayer4ConfigComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      ...
      srcSecureTags: map['srcSecureTags'] == null ? null : pulumi.Input.decodeList<FirewallPolicyRuleSecureTagComputeV1>(map['srcSecureTags'], (value) => FirewallPolicyRuleSecureTagComputeV1.fromMap((value as Map).cast<String, dynamic>())),
