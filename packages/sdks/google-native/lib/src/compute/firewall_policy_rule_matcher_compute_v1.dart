...
class FirewallPolicyRuleMatcherComputeV1 {
  ...
  final pulumi.Input<List<FirewallPolicyRuleMatcherLayer4ConfigComputeV1>>?
  layer4Configs;
    ...
    return <String, dynamic>{
      ...
      'layer4Configs':
          ?pulumi.Input.mapOptionalInputValue<
            List<FirewallPolicyRuleMatcherLayer4ConfigComputeV1>,
      ...
      'srcSecureTags':
          ?pulumi.Input.mapOptionalInputValue<
            List<FirewallPolicyRuleSecureTagComputeV1>,
            List<Map<String, dynamic>>
          >(
            srcSecureTags,
            (value) =>
    ...
    return FirewallPolicyRuleMatcherComputeV1(
      ...
      layer4Configs: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<FirewallPolicyRuleMatcherLayer4ConfigComputeV1>(
            guardedValue,
