...
class NodeGroupComputeV1 extends pulumi.CustomResource {
  ...
  NodeGroupComputeV1(
    ...
    this.autoscalingPolicy = registerOutput<NodeGroupAutoscalingPolicyResponseComputeV1>('autoscalingPolicy');
    ...
    this.maintenanceWindow = registerOutput<NodeGroupMaintenanceWindowResponseComputeV1>('maintenanceWindow');
    this.name = registerOutput<String>('name');
    this.nodeTemplate = registerOutput<String>('nodeTemplate');
    this.project = registerOutput<String>('project');
    this.requestId = registerOutput<String?>('requestId');
    this.selfLink = registerOutput<String>('selfLink');
    this.shareSettings = registerOutput<ShareSettingsResponseComputeV1>('shareSettings');
