...
class NodeGroupComputeV1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<NodeGroupAutoscalingPolicyResponseComputeV1> autoscalingPolicy;
  ...
  late final pulumi.Output<NodeGroupMaintenanceWindowResponseComputeV1> maintenanceWindow;
  ...
  NodeGroupComputeV1(
    ...
    autoscalingPolicy = registerOutput<NodeGroupAutoscalingPolicyResponseComputeV1>('autoscalingPolicy', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return NodeGroupAutoscalingPolicyResponseComputeV1.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    maintenanceWindow = registerOutput<NodeGroupMaintenanceWindowResponseComputeV1>('maintenanceWindow', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return NodeGroupMaintenanceWindowResponseComputeV1.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    this.name = registerOutput<String>('name');
    nodeTemplate = registerOutput<String>('nodeTemplate');
    project = registerOutput<String>('project');
    requestId = registerOutput<String?>('requestId');
    selfLink = registerOutput<String>('selfLink');
    shareSettings = registerOutput<ShareSettingsResponseComputeV1>('shareSettings', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ShareSettingsResponseComputeV1.fromMap((guardedValue as Map).cast<String, dynamic>()); });
