...
class BackendServiceLogConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'enable': ?enable,
      'optional': ?optional == null ? null : optional!.value,
  ...
  factory BackendServiceLogConfig.fromMap(Map<String, dynamic> map) {
    return BackendServiceLogConfig(
      ...
      optional: map['optional'] == null ? null : BackendServiceLogConfigOptional.fromValue(map['optional'] as String),
      optionalFields: map['optionalFields'] == null ? null : (map['optionalFields'] as List).cast<String>(),
      optionalMode: map['optionalMode'] == null ? null : BackendServiceLogConfigOptionalMode.fromValue(map['optionalMode'] as String),
