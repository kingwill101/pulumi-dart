...
class BackendServiceLogConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'enable': ?enable,
      'optional': ?pulumi.Input.mapOptionalInputValue<BackendServiceLogConfigOptional, String>(optional, (value) => value.wireValue),
      'optionalFields': ?optionalFields,
      'optionalMode': ?pulumi.Input.mapOptionalInputValue<BackendServiceLogConfigOptionalMode, String>(optionalMode, (value) => value.wireValue),
  ...
  factory BackendServiceLogConfig.fromMap(Map<String, dynamic> map) {
    return BackendServiceLogConfig(
      ...
      optional: (() { final guardedValue = map['optional']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BackendServiceLogConfigOptional.fromValue(guardedValue as String)); })(),
      ...
      optionalMode: (() { final guardedValue = map['optionalMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BackendServiceLogConfigOptionalMode.fromValue(guardedValue as String)); })(),
