...
class NetworkInterfaceResponseComputeV1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'accessConfigs': pulumi.Input.encodeList<AccessConfigResponseComputeV1, Map<String, dynamic>>(accessConfigs, (value) => value.toMap()),
      'aliasIpRanges': pulumi.Input.encodeList<AliasIpRangeResponseComputeV1, Map<String, dynamic>>(aliasIpRanges, (value) => value.toMap()),
      'fingerprint': fingerprint,
      'internalIpv6PrefixLength': internalIpv6PrefixLength,
      'ipv6AccessConfigs': pulumi.Input.encodeList<AccessConfigResponseComputeV1, Map<String, dynamic>>(ipv6AccessConfigs, (value) => value.toMap()),
  ...
  factory NetworkInterfaceResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return NetworkInterfaceResponseComputeV1(
      accessConfigs: pulumi.Input.decodeList<AccessConfigResponseComputeV1>(map['accessConfigs'], (value) => AccessConfigResponseComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      aliasIpRanges: pulumi.Input.decodeList<AliasIpRangeResponseComputeV1>(map['aliasIpRanges'], (value) => AliasIpRangeResponseComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      fingerprint: map['fingerprint'] as String,
      internalIpv6PrefixLength: map['internalIpv6PrefixLength'] as int,
      ipv6AccessConfigs: pulumi.Input.decodeList<AccessConfigResponseComputeV1>(map['ipv6AccessConfigs'], (value) => AccessConfigResponseComputeV1.fromMap((value as Map).cast<String, dynamic>())),
