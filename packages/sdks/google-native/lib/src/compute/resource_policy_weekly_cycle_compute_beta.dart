...
class ResourcePolicyWeeklyCycleComputeBeta {
  ...
  final pulumi.Input<List<ResourcePolicyWeeklyCycleDayOfWeekComputeBeta>>?
  dayOfWeeks;

  /// Creates a new [ResourcePolicyWeeklyCycleComputeBeta].
  /// [dayOfWeeks] Up to 7 intervals/windows, one for each day of the week.
  ResourcePolicyWeeklyCycleComputeBeta({this.dayOfWeeks});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'dayOfWeeks':
          ?pulumi.Input.mapOptionalInputValue<
            List<ResourcePolicyWeeklyCycleDayOfWeekComputeBeta>,
  ...
  factory ResourcePolicyWeeklyCycleComputeBeta.fromMap(
    ...
    return ResourcePolicyWeeklyCycleComputeBeta(
      dayOfWeeks: (() {
        final guardedValue = map['dayOfWeeks'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<ResourcePolicyWeeklyCycleDayOfWeekComputeBeta>(
            guardedValue,
