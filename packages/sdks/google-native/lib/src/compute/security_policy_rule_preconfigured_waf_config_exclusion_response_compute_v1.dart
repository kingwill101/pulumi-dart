...
class SecurityPolicyRulePreconfiguredWafConfigExclusionResponseComputeV1 {
  ...
  const SecurityPolicyRulePreconfiguredWafConfigExclusionResponseComputeV1({
  ...
  factory SecurityPolicyRulePreconfiguredWafConfigExclusionResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRulePreconfiguredWafConfigExclusionResponseComputeV1(
      requestCookiesToExclude: pulumi.Input.fromValue(pulumi.Input.decodeList<SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParamsResponseComputeV1>(map['requestCookiesToExclude']!, (value) => SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParamsResponseComputeV1.fromMap((value as Map).cast<String, dynamic>()))),
      requestHeadersToExclude: pulumi.Input.fromValue(pulumi.Input.decodeList<SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParamsResponseComputeV1>(map['requestHeadersToExclude']!, (value) => SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParamsResponseComputeV1.fromMap((value as Map).cast<String, dynamic>()))),
      requestQueryParamsToExclude: pulumi.Input.fromValue(pulumi.Input.decodeList<SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParamsResponseComputeV1>(map['requestQueryParamsToExclude']!, (value) => SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParamsResponseComputeV1.fromMap((value as Map).cast<String, dynamic>()))),
      requestUrisToExclude: pulumi.Input.fromValue(pulumi.Input.decodeList<SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParamsResponseComputeV1>(map['requestUrisToExclude']!, (value) => SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParamsResponseComputeV1.fromMap((value as Map).cast<String, dynamic>()))),
