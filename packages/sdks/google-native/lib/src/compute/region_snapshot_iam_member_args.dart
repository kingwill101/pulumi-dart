...
/// {@template pulumi_compute_alpha_region_snapshot_iam_member_args_doc}
/// The set of arguments for RegionSnapshotIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_alpha_region_snapshot_iam_member_args_doc}
class RegionSnapshotIamMemberArgs {
  ...
  /// Creates a new [RegionSnapshotIamMemberArgs].
  ...
  const RegionSnapshotIamMemberArgs({
    this.condition,
