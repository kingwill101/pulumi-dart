...
class Route extends pulumi.CustomResource {
  ...
  Route(
    ...
    this.allowConflictingSubnetworks = registerOutput<bool>('allowConflictingSubnetworks');
    ...
    this.ilbRouteBehaviorOnUnhealthy = registerOutput<String>('ilbRouteBehaviorOnUnhealthy');
    ...
    this.nextHopInterconnectAttachment = registerOutput<String>('nextHopInterconnectAttachment');
