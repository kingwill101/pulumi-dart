...
class InstanceTemplateComputeV1 extends pulumi.CustomResource {
  ...
  InstanceTemplateComputeV1(
    ...
    this.properties = registerOutput<InstancePropertiesResponseComputeV1>('properties');
    this.region = registerOutput<String>('region');
    this.requestId = registerOutput<String?>('requestId');
    this.selfLink = registerOutput<String>('selfLink');
    this.sourceInstance = registerOutput<String>('sourceInstance');
    this.sourceInstanceParams = registerOutput<SourceInstanceParamsResponseComputeV1>('sourceInstanceParams');
  }
}
