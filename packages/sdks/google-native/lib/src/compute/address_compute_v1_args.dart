...
class AddressComputeV1Args {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'address': ?address,
      'addressType': ?pulumi.Input.mapOptionalInputValue<AddressAddressTypeComputeV1, String>(addressType, (value) => value.wireValue),
      'description': ?description,
      'ipVersion': ?pulumi.Input.mapOptionalInputValue<AddressIpVersionComputeV1, String>(ipVersion, (value) => value.wireValue),
      'ipv6EndpointType': ?pulumi.Input.mapOptionalInputValue<AddressIpv6EndpointTypeComputeV1, String>(ipv6EndpointType, (value) => value.wireValue),
      'labels': ?labels,
      'name': ?name,
      'network': ?network,
      'networkTier': ?pulumi.Input.mapOptionalInputValue<AddressNetworkTierComputeV1, String>(networkTier, (value) => value.wireValue),
      'prefixLength': ?prefixLength,
      'project': ?project,
      'purpose': ?pulumi.Input.mapOptionalInputValue<AddressPurposeComputeV1, String>(purpose, (value) => value.wireValue),
      'region': region,
      'requestId': ?requestId,
  ...
  factory AddressComputeV1Args.fromMap(Map<String, dynamic> map) {
    return AddressComputeV1Args(
      ...
      addressType: (() { final guardedValue = map['addressType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AddressAddressTypeComputeV1.fromValue(guardedValue as String)); })(),
      description: (() { final guardedValue = map['description']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ipVersion: (() { final guardedValue = map['ipVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AddressIpVersionComputeV1.fromValue(guardedValue as String)); })(),
      ipv6EndpointType: (() { final guardedValue = map['ipv6EndpointType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AddressIpv6EndpointTypeComputeV1.fromValue(guardedValue as String)); })(),
      labels: (() { final guardedValue = map['labels']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      network: (() { final guardedValue = map['network']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      networkTier: (() { final guardedValue = map['networkTier']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AddressNetworkTierComputeV1.fromValue(guardedValue as String)); })(),
      ...
      purpose: (() { final guardedValue = map['purpose']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AddressPurposeComputeV1.fromValue(guardedValue as String)); })(),
