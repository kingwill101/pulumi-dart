...
class AddressComputeV1Args {
  ...
  AddressComputeV1Args({
    ...
    pulumi.Output<AddressAddressTypeComputeV1>? addressType,
    pulumi.Output<String>? description,
    pulumi.Output<AddressIpVersionComputeV1>? ipVersion,
    pulumi.Output<AddressIpv6EndpointTypeComputeV1>? ipv6EndpointType,
    pulumi.Output<Map<String, String>>? labels,
    pulumi.Output<String>? name,
    pulumi.Output<String>? network,
    pulumi.Output<AddressNetworkTierComputeV1>? networkTier,
    pulumi.Output<int>? prefixLength,
    pulumi.Output<String>? project,
    pulumi.Output<AddressPurposeComputeV1>? purpose,
    required pulumi.Output<String> region,
    pulumi.Output<String>? requestId,
    pulumi.Output<String>? subnetwork,
  }) :
      address = pulumi.Input.asOptionalInput<String>(address),
      addressType = pulumi.Input.asOptionalInput<AddressAddressTypeComputeV1>(addressType),
      description = pulumi.Input.asOptionalInput<String>(description),
      ipVersion = pulumi.Input.asOptionalInput<AddressIpVersionComputeV1>(ipVersion),
      ipv6EndpointType = pulumi.Input.asOptionalInput<AddressIpv6EndpointTypeComputeV1>(ipv6EndpointType),
      labels = pulumi.Input.asOptionalInput<Map<String, String>>(labels),
      name = pulumi.Input.asOptionalInput<String>(name),
      network = pulumi.Input.asOptionalInput<String>(network),
      networkTier = pulumi.Input.asOptionalInput<AddressNetworkTierComputeV1>(networkTier),
      prefixLength = pulumi.Input.asOptionalInput<int>(prefixLength),
      project = pulumi.Input.asOptionalInput<String>(project),
      purpose = pulumi.Input.asOptionalInput<AddressPurposeComputeV1>(purpose),
  ...
  factory AddressComputeV1Args.fromMap(Map<String, dynamic> map) {
    return AddressComputeV1Args(
      ...
      addressType: map['addressType'] == null ? null : pulumi.Output.create<AddressAddressTypeComputeV1>(AddressAddressTypeComputeV1.fromValue(map['addressType'] as String)),
      description: map['description'] == null ? null : pulumi.Output.create<String>(map['description'] as String),
      ipVersion: map['ipVersion'] == null ? null : pulumi.Output.create<AddressIpVersionComputeV1>(AddressIpVersionComputeV1.fromValue(map['ipVersion'] as String)),
      ipv6EndpointType: map['ipv6EndpointType'] == null ? null : pulumi.Output.create<AddressIpv6EndpointTypeComputeV1>(AddressIpv6EndpointTypeComputeV1.fromValue(map['ipv6EndpointType'] as String)),
      labels: map['labels'] == null ? null : pulumi.Output.create<Map<String, String>>((map['labels'] as Map).cast<String, String>()),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      network: map['network'] == null ? null : pulumi.Output.create<String>(map['network'] as String),
      networkTier: map['networkTier'] == null ? null : pulumi.Output.create<AddressNetworkTierComputeV1>(AddressNetworkTierComputeV1.fromValue(map['networkTier'] as String)),
      prefixLength: map['prefixLength'] == null ? null : pulumi.Output.create<int>(map['prefixLength'] as int),
      project: map['project'] == null ? null : pulumi.Output.create<String>(map['project'] as String),
      purpose: map['purpose'] == null ? null : pulumi.Output.create<AddressPurposeComputeV1>(AddressPurposeComputeV1.fromValue(map['purpose'] as String)),
