...
class RouterArgs {
  ...
  factory RouterArgs.fromMap(Map<String, dynamic> map) {
    return RouterArgs(
      ...
      bgpPeers: (() { final guardedValue = map['bgpPeers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RouterBgpPeer>(guardedValue, (value) => RouterBgpPeer.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      interfaces: (() { final guardedValue = map['interfaces']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RouterInterface>(guardedValue, (value) => RouterInterface.fromMap((value as Map).cast<String, dynamic>()))); })(),
      md5AuthenticationKeys: (() { final guardedValue = map['md5AuthenticationKeys']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RouterMd5AuthenticationKey>(guardedValue, (value) => RouterMd5AuthenticationKey.fromMap((value as Map).cast<String, dynamic>()))); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      nats: (() { final guardedValue = map['nats']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RouterNat>(guardedValue, (value) => RouterNat.fromMap((value as Map).cast<String, dynamic>()))); })(),
