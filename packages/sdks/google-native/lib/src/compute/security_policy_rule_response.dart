...
class SecurityPolicyRuleResponse {
  ...
  factory SecurityPolicyRuleResponse.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRuleResponse(
      ...
      headerAction: SecurityPolicyRuleHttpHeaderActionResponse.fromMap((map['headerAction'] as Map).cast<String, dynamic>()),
      kind: map['kind'] as String,
      match: SecurityPolicyRuleMatcherResponse.fromMap((map['match'] as Map).cast<String, dynamic>()),
      networkMatch: SecurityPolicyRuleNetworkMatcherResponse.fromMap((map['networkMatch'] as Map).cast<String, dynamic>()),
      preconfiguredWafConfig: SecurityPolicyRulePreconfiguredWafConfigResponse.fromMap((map['preconfiguredWafConfig'] as Map).cast<String, dynamic>()),
      preview: map['preview'] as bool,
      priority: map['priority'] as int,
      rateLimitOptions: SecurityPolicyRuleRateLimitOptionsResponse.fromMap((map['rateLimitOptions'] as Map).cast<String, dynamic>()),
      redirectOptions: SecurityPolicyRuleRedirectOptionsResponse.fromMap((map['redirectOptions'] as Map).cast<String, dynamic>()),
