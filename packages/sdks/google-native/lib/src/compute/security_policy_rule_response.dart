...
class SecurityPolicyRuleResponse {
  ...
  factory SecurityPolicyRuleResponse.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRuleResponse(
      ...
      headerAction: (SecurityPolicyRuleHttpHeaderActionResponse.fromMap((map['headerAction'] as Map).cast<String, dynamic>())).input(),
      kind: (map['kind'] as String).input(),
      match: (SecurityPolicyRuleMatcherResponse.fromMap((map['match'] as Map).cast<String, dynamic>())).input(),
      networkMatch: (SecurityPolicyRuleNetworkMatcherResponse.fromMap((map['networkMatch'] as Map).cast<String, dynamic>())).input(),
      preconfiguredWafConfig: (SecurityPolicyRulePreconfiguredWafConfigResponse.fromMap((map['preconfiguredWafConfig'] as Map).cast<String, dynamic>())).input(),
      preview: (map['preview'] as bool).input(),
      priority: (map['priority'] as int).input(),
      rateLimitOptions: (SecurityPolicyRuleRateLimitOptionsResponse.fromMap((map['rateLimitOptions'] as Map).cast<String, dynamic>())).input(),
      redirectOptions: (SecurityPolicyRuleRedirectOptionsResponse.fromMap((map['redirectOptions'] as Map).cast<String, dynamic>())).input(),
      redirectTarget: (map['redirectTarget'] as String).input(),
      ruleManagedProtectionTier: (map['ruleManagedProtectionTier'] as String).input(),
      ruleNumber: (map['ruleNumber'] as String).input(),
