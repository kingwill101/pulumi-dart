...
class SecurityPolicyRuleResponse {
  ...
  final pulumi.Input<SecurityPolicyRulePreconfiguredWafConfigResponse>
  ...
  final pulumi.Input<SecurityPolicyRuleRateLimitOptionsResponse>
  rateLimitOptions;
    ...
    return <String, dynamic>{
      ...
      'networkMatch':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(networkMatch, (value) => value.toMap()),
      'preconfiguredWafConfig':
          pulumi.Input.mapInputValue<
            SecurityPolicyRulePreconfiguredWafConfigResponse,
            Map<String, dynamic>
          >(preconfiguredWafConfig, (value) => value.toMap()),
      'preview': preview,
      'priority': priority,
      'rateLimitOptions':
          pulumi.Input.mapInputValue<
  ...
  factory SecurityPolicyRuleResponse.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRuleResponse(
      ...
      headerAction: pulumi.Input.fromValue(
        SecurityPolicyRuleHttpHeaderActionResponse.fromMap(
          (map['headerAction']! as Map).cast<String, dynamic>(),
        ),
      ),
      kind: pulumi.Input.fromValue(map['kind'] as String),
      match: pulumi.Input.fromValue(
        SecurityPolicyRuleMatcherResponse.fromMap(
          (map['match']! as Map).cast<String, dynamic>(),
        ),
      ),
      networkMatch: pulumi.Input.fromValue(
        SecurityPolicyRuleNetworkMatcherResponse.fromMap(
          (map['networkMatch']! as Map).cast<String, dynamic>(),
        ),
      ),
      preconfiguredWafConfig: pulumi.Input.fromValue(
      ...
      rateLimitOptions: pulumi.Input.fromValue(
        SecurityPolicyRuleRateLimitOptionsResponse.fromMap(
          (map['rateLimitOptions']! as Map).cast<String, dynamic>(),
        ),
      ),
      redirectOptions: pulumi.Input.fromValue(
      ...
      ruleManagedProtectionTier: pulumi.Input.fromValue(
        map['ruleManagedProtectionTier'] as String,
      ),
      ...
      targetResources: pulumi.Input.fromValue(
