...
class SecurityPolicyRuleResponse {
  ...
  final pulumi.Input<SecurityPolicyRuleHttpHeaderActionResponse> headerAction;
  /// [Output only] Type of the resource. Always compute#securityPolicyRule for security policy rules
  final pulumi.Input<String> kind;
  /// A match condition that incoming traffic is evaluated against. If it evaluates to true, the corresponding 'action' is enforced.
  final pulumi.Input<SecurityPolicyRuleMatcherResponse> match;
  ...
  final pulumi.Input<SecurityPolicyRuleNetworkMatcherResponse> networkMatch;
  /// Preconfigured WAF configuration to be applied for the rule. If the rule does not evaluate preconfigured WAF rules, i.e., if evaluatePreconfiguredWaf() is not used, this field will have no effect.
  final pulumi.Input<SecurityPolicyRulePreconfiguredWafConfigResponse> preconfiguredWafConfig;
  /// If set to true, the specified action is not enforced.
  final pulumi.Input<bool> preview;
  /// An integer indicating the priority of a rule in the list. The priority must be a positive value between 0 and 2147483647. Rules are evaluated from highest to lowest priority where 0 is the highest priority and 2147483647 is the lowest priority.
  final pulumi.Input<int> priority;
  /// Must be specified if the action is "rate_based_ban" or "throttle". Cannot be specified for any other actions.
  final pulumi.Input<SecurityPolicyRuleRateLimitOptionsResponse> rateLimitOptions;
  /// Parameters defining the redirect action. Cannot be specified for any other actions. This field is only supported in Global Security Policies of type CLOUD_ARMOR.
  final pulumi.Input<SecurityPolicyRuleRedirectOptionsResponse> redirectOptions;
  ...
  final pulumi.Input<String> ruleManagedProtectionTier;
  ...
  /// Creates a new [SecurityPolicyRuleResponse].
  ...
  /// [ruleManagedProtectionTier] The minimum managed protection tier required for this rule. [Deprecated] Use requiredManagedProtectionTiers instead.
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'headerAction': pulumi.Input.mapInputValue<SecurityPolicyRuleHttpHeaderActionResponse, Map<String, dynamic>>(headerAction, (value) => value.toMap()),
      'kind': kind,
      'match': pulumi.Input.mapInputValue<SecurityPolicyRuleMatcherResponse, Map<String, dynamic>>(match, (value) => value.toMap()),
      'networkMatch': pulumi.Input.mapInputValue<SecurityPolicyRuleNetworkMatcherResponse, Map<String, dynamic>>(networkMatch, (value) => value.toMap()),
      'preconfiguredWafConfig': pulumi.Input.mapInputValue<SecurityPolicyRulePreconfiguredWafConfigResponse, Map<String, dynamic>>(preconfiguredWafConfig, (value) => value.toMap()),
      'preview': preview,
      'priority': priority,
      'rateLimitOptions': pulumi.Input.mapInputValue<SecurityPolicyRuleRateLimitOptionsResponse, Map<String, dynamic>>(rateLimitOptions, (value) => value.toMap()),
      'redirectOptions': pulumi.Input.mapInputValue<SecurityPolicyRuleRedirectOptionsResponse, Map<String, dynamic>>(redirectOptions, (value) => value.toMap()),
  ...
  factory SecurityPolicyRuleResponse.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRuleResponse(
      ...
      headerAction: pulumi.Input.fromValue(SecurityPolicyRuleHttpHeaderActionResponse.fromMap((map['headerAction']! as Map).cast<String, dynamic>())),
      kind: pulumi.Input.fromValue(map['kind'] as String),
      match: pulumi.Input.fromValue(SecurityPolicyRuleMatcherResponse.fromMap((map['match']! as Map).cast<String, dynamic>())),
      networkMatch: pulumi.Input.fromValue(SecurityPolicyRuleNetworkMatcherResponse.fromMap((map['networkMatch']! as Map).cast<String, dynamic>())),
      preconfiguredWafConfig: pulumi.Input.fromValue(SecurityPolicyRulePreconfiguredWafConfigResponse.fromMap((map['preconfiguredWafConfig']! as Map).cast<String, dynamic>())),
      preview: pulumi.Input.fromValue(map['preview'] as bool),
      priority: pulumi.Input.fromValue(map['priority'] as int),
      rateLimitOptions: pulumi.Input.fromValue(SecurityPolicyRuleRateLimitOptionsResponse.fromMap((map['rateLimitOptions']! as Map).cast<String, dynamic>())),
      redirectOptions: pulumi.Input.fromValue(SecurityPolicyRuleRedirectOptionsResponse.fromMap((map['redirectOptions']! as Map).cast<String, dynamic>())),
      redirectTarget: pulumi.Input.fromValue(map['redirectTarget'] as String),
      ruleManagedProtectionTier: pulumi.Input.fromValue(map['ruleManagedProtectionTier'] as String),
