...
class CustomErrorResponsePolicyCustomErrorResponseRuleComputeBeta {
  ...
  const CustomErrorResponsePolicyCustomErrorResponseRuleComputeBeta({
  ...
  factory CustomErrorResponsePolicyCustomErrorResponseRuleComputeBeta.fromMap(Map<String, dynamic> map) {
