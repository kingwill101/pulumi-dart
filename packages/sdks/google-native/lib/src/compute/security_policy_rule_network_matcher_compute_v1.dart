...
class SecurityPolicyRuleNetworkMatcherComputeV1 {
  ...
  final pulumi.Input<
    List<SecurityPolicyRuleNetworkMatcherUserDefinedFieldMatchComputeV1>
  >?
  userDefinedFields;
  ...
  factory SecurityPolicyRuleNetworkMatcherComputeV1.fromMap(
      ...
      userDefinedFields: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                SecurityPolicyRuleNetworkMatcherUserDefinedFieldMatchComputeV1.fromMap(
