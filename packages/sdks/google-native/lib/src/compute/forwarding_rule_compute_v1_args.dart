...
class ForwardingRuleComputeV1Args {
  ...
  factory ForwardingRuleComputeV1Args.fromMap(Map<String, dynamic> map) {
    return ForwardingRuleComputeV1Args(
      ...
      ipProtocol: map['ipProtocol'] == null ? null : (ForwardingRuleIpProtocolComputeV1.fromValue(map['ipProtocol']! as String)).input(),
      ipVersion: map['ipVersion'] == null ? null : (ForwardingRuleIpVersionComputeV1.fromValue(map['ipVersion']! as String)).input(),
      isMirroringCollector: map['isMirroringCollector'] == null ? null : (map['isMirroringCollector']! as bool).input(),
      labels: map['labels'] == null ? null : ((map['labels']! as Map).cast<String, String>()).input(),
      loadBalancingScheme: map['loadBalancingScheme'] == null ? null : (ForwardingRuleLoadBalancingSchemeComputeV1.fromValue(map['loadBalancingScheme']! as String)).input(),
      ...
      networkTier: map['networkTier'] == null ? null : (ForwardingRuleNetworkTierComputeV1.fromValue(map['networkTier']! as String)).input(),
      ...
      pscConnectionStatus: map['pscConnectionStatus'] == null ? null : (ForwardingRulePscConnectionStatusComputeV1.fromValue(map['pscConnectionStatus']! as String)).input(),
