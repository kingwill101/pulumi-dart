...
class ForwardingRuleComputeV1Args {
  ...
  const ForwardingRuleComputeV1Args({
    this.allPorts,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ipAddress': ?ipAddress,
      'ipProtocol': ?pulumi.Input.mapOptionalInputValue<ForwardingRuleIpProtocolComputeV1, String>(ipProtocol, (value) => value.wireValue),
      'ipVersion': ?pulumi.Input.mapOptionalInputValue<ForwardingRuleIpVersionComputeV1, String>(ipVersion, (value) => value.wireValue),
      'isMirroringCollector': ?isMirroringCollector,
      'labels': ?labels,
      'loadBalancingScheme': ?pulumi.Input.mapOptionalInputValue<ForwardingRuleLoadBalancingSchemeComputeV1, String>(loadBalancingScheme, (value) => value.wireValue),
      ...
      'name': ?name,
      'network': ?network,
      'networkTier': ?pulumi.Input.mapOptionalInputValue<ForwardingRuleNetworkTierComputeV1, String>(networkTier, (value) => value.wireValue),
      'noAutomateDnsZone': ?noAutomateDnsZone,
      'portRange': ?portRange,
      'ports': ?ports,
      'project': ?project,
      'pscConnectionStatus': ?pulumi.Input.mapOptionalInputValue<ForwardingRulePscConnectionStatusComputeV1, String>(pscConnectionStatus, (value) => value.wireValue),
      'region': region,
      'requestId': ?requestId,
  ...
  factory ForwardingRuleComputeV1Args.fromMap(Map<String, dynamic> map) {
    return ForwardingRuleComputeV1Args(
      ...
      ipProtocol: (() { final guardedValue = map['ipProtocol']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ForwardingRuleIpProtocolComputeV1.fromValue(guardedValue as String)); })(),
      ipVersion: (() { final guardedValue = map['ipVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ForwardingRuleIpVersionComputeV1.fromValue(guardedValue as String)); })(),
      ...
      loadBalancingScheme: (() { final guardedValue = map['loadBalancingScheme']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ForwardingRuleLoadBalancingSchemeComputeV1.fromValue(guardedValue as String)); })(),
      ...
      networkTier: (() { final guardedValue = map['networkTier']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ForwardingRuleNetworkTierComputeV1.fromValue(guardedValue as String)); })(),
      ...
      pscConnectionStatus: (() { final guardedValue = map['pscConnectionStatus']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ForwardingRulePscConnectionStatusComputeV1.fromValue(guardedValue as String)); })(),
