...
class ForwardingRuleComputeV1Args {
  ...
  ForwardingRuleComputeV1Args({
    ...
    pulumi.Output<ForwardingRuleIpProtocolComputeV1>? ipProtocol,
    pulumi.Output<ForwardingRuleIpVersionComputeV1>? ipVersion,
    pulumi.Output<bool>? isMirroringCollector,
    pulumi.Output<Map<String, String>>? labels,
    pulumi.Output<ForwardingRuleLoadBalancingSchemeComputeV1>? loadBalancingScheme,
    pulumi.Output<List<MetadataFilterComputeV1>>? metadataFilters,
    pulumi.Output<String>? name,
    pulumi.Output<String>? network,
    pulumi.Output<ForwardingRuleNetworkTierComputeV1>? networkTier,
    pulumi.Output<bool>? noAutomateDnsZone,
    pulumi.Output<String>? portRange,
    pulumi.Output<List<String>>? ports,
    pulumi.Output<String>? project,
    pulumi.Output<ForwardingRulePscConnectionStatusComputeV1>? pscConnectionStatus,
  ...
  factory ForwardingRuleComputeV1Args.fromMap(Map<String, dynamic> map) {
    return ForwardingRuleComputeV1Args(
      ...
      ipProtocol: map['ipProtocol'] == null ? null : pulumi.Output.create<ForwardingRuleIpProtocolComputeV1>(ForwardingRuleIpProtocolComputeV1.fromValue(map['ipProtocol'] as String)),
      ipVersion: map['ipVersion'] == null ? null : pulumi.Output.create<ForwardingRuleIpVersionComputeV1>(ForwardingRuleIpVersionComputeV1.fromValue(map['ipVersion'] as String)),
      ...
      loadBalancingScheme: map['loadBalancingScheme'] == null ? null : pulumi.Output.create<ForwardingRuleLoadBalancingSchemeComputeV1>(ForwardingRuleLoadBalancingSchemeComputeV1.fromValue(map['loadBalancingScheme'] as String)),
      ...
      networkTier: map['networkTier'] == null ? null : pulumi.Output.create<ForwardingRuleNetworkTierComputeV1>(ForwardingRuleNetworkTierComputeV1.fromValue(map['networkTier'] as String)),
      ...
      pscConnectionStatus: map['pscConnectionStatus'] == null ? null : pulumi.Output.create<ForwardingRulePscConnectionStatusComputeV1>(ForwardingRulePscConnectionStatusComputeV1.fromValue(map['pscConnectionStatus'] as String)),
