...
/// {@template pulumi_compute_v1_http_health_check_compute_v1_args_doc}
/// The set of arguments for HttpHealthCheck.
/// {@endtemplate}
/// {@macro pulumi_compute_v1_http_health_check_compute_v1_args_doc}
class HttpHealthCheckComputeV1Args {
  ...
  /// Creates a new [HttpHealthCheckComputeV1Args].
  ...
  const HttpHealthCheckComputeV1Args({
  ...
  factory HttpHealthCheckComputeV1Args.fromMap(Map<String, dynamic> map) {
    return HttpHealthCheckComputeV1Args(
