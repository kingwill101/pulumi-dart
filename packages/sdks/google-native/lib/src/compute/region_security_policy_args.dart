...
class RegionSecurityPolicyArgs {
  ...
  RegionSecurityPolicyArgs({
    ...
    pulumi.Output<RegionSecurityPolicyType>? type,
  ...
  factory RegionSecurityPolicyArgs.fromMap(Map<String, dynamic> map) {
    return RegionSecurityPolicyArgs(
      ...
      type: map['type'] == null ? null : pulumi.Output.create<RegionSecurityPolicyType>(RegionSecurityPolicyType.fromValue(map['type'] as String)),
