...
class RegionDisk extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [RegionDisk]. {@macro pulumi_compute_alpha_region_disk_args_doc}
  ...
  RegionDisk(
    ...
    this.asyncPrimaryDisk = registerOutput<DiskAsyncReplicationResponse>('asyncPrimaryDisk');
    this.asyncSecondaryDisks = registerOutput<Map<String, String>>('asyncSecondaryDisks');
    this.creationTimestamp = registerOutput<String>('creationTimestamp');
    this.description = registerOutput<String>('description');
    this.diskEncryptionKey = registerOutput<CustomerEncryptionKeyResponse>('diskEncryptionKey');
    ...
    this.resourceStatus = registerOutput<DiskResourceStatusResponse>('resourceStatus');
