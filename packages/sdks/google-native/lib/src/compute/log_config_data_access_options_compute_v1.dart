...
class LogConfigDataAccessOptionsComputeV1 {
  ...
  const LogConfigDataAccessOptionsComputeV1({
    this.logMode,
  });

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'logMode': ?pulumi.Input.mapOptionalInputValue<LogConfigDataAccessOptionsLogModeComputeV1, String>(logMode, (value) => value.wireValue),
    };
  }

  factory LogConfigDataAccessOptionsComputeV1.fromMap(Map<String, dynamic> map) {
    return LogConfigDataAccessOptionsComputeV1(
      logMode: (() { final guardedValue = map['logMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LogConfigDataAccessOptionsLogModeComputeV1.fromValue(guardedValue as String)); })(),
    );
  }
}
