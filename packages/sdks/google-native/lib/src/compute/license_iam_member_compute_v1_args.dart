...
/// {@template pulumi_compute_v1_license_iam_member_compute_v1_args_doc}
/// The set of arguments for LicenseIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_v1_license_iam_member_compute_v1_args_doc}
class LicenseIamMemberComputeV1Args {
  ...
  /// Creates a new [LicenseIamMemberComputeV1Args].
  ...
  const LicenseIamMemberComputeV1Args({
    this.condition,
  ...
  factory LicenseIamMemberComputeV1Args.fromMap(Map<String, dynamic> map) {
    return LicenseIamMemberComputeV1Args(
