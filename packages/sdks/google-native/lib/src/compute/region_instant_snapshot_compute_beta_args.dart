...
/// {@template pulumi_compute_beta_region_instant_snapshot_compute_beta_args_doc}
/// The set of arguments for RegionInstantSnapshot.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_region_instant_snapshot_compute_beta_args_doc}
class RegionInstantSnapshotComputeBetaArgs {
  ...
  /// Creates a new [RegionInstantSnapshotComputeBetaArgs].
  ...
  const RegionInstantSnapshotComputeBetaArgs({
    this.description,
    this.labels,
    this.name,
    this.project,
