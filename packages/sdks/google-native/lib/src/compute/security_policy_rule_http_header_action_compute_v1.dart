...
class SecurityPolicyRuleHttpHeaderActionComputeV1 {
  ...
  final pulumi.Input<
    List<SecurityPolicyRuleHttpHeaderActionHttpHeaderOptionComputeV1>
  >?
  ...
  SecurityPolicyRuleHttpHeaderActionComputeV1({this.requestHeadersToAdds});
      ...
      requestHeadersToAdds: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                SecurityPolicyRuleHttpHeaderActionHttpHeaderOptionComputeV1.fromMap(
