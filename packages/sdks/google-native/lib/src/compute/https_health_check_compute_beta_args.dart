...
/// {@template pulumi_compute_beta_https_health_check_compute_beta_args_doc}
/// The set of arguments for HttpsHealthCheck.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_https_health_check_compute_beta_args_doc}
class HttpsHealthCheckComputeBetaArgs {
  ...
  /// Creates a new [HttpsHealthCheckComputeBetaArgs].
  ...
  const HttpsHealthCheckComputeBetaArgs({
