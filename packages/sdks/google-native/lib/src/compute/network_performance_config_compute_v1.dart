...
class NetworkPerformanceConfigComputeV1 {
  final pulumi.Input<NetworkPerformanceConfigTotalEgressBandwidthTierComputeV1>?
  totalEgressBandwidthTier;

  /// Creates a new [NetworkPerformanceConfigComputeV1].
  /// [totalEgressBandwidthTier] Optional.
  NetworkPerformanceConfigComputeV1({this.totalEgressBandwidthTier});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'totalEgressBandwidthTier':
          ?pulumi.Input.mapOptionalInputValue<
            NetworkPerformanceConfigTotalEgressBandwidthTierComputeV1,
            String
