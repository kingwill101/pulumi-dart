...
class RouterBgpPeerBfdComputeV1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'sessionInitializationMode': ?pulumi.Input.mapOptionalInputValue<RouterBgpPeerBfdSessionInitializationModeComputeV1, String>(sessionInitializationMode, (value) => value.value),
    };
  }
