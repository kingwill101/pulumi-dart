...
class RouterBgpPeerBfdComputeV1 {
  ...
  final pulumi.Input<RouterBgpPeerBfdSessionInitializationModeComputeV1>?
    ...
    return <String, dynamic>{
      ...
      'sessionInitializationMode':
          ?pulumi.Input.mapOptionalInputValue<
            RouterBgpPeerBfdSessionInitializationModeComputeV1,
            String
          >(sessionInitializationMode, (value) => value.wireValue),
    };
  }
  ...
  factory RouterBgpPeerBfdComputeV1.fromMap(Map<String, dynamic> map) {
    return RouterBgpPeerBfdComputeV1(
      minReceiveInterval: (() {
        final guardedValue = map['minReceiveInterval'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      minTransmitInterval: (() {
        final guardedValue = map['minTransmitInterval'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      multiplier: (() {
      ...
      sessionInitializationMode: (() {
        final guardedValue = map['sessionInitializationMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RouterBgpPeerBfdSessionInitializationModeComputeV1.fromValue(
