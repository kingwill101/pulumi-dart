...
class RouterBgpPeerComputeV1 {
  ...
  final pulumi.Input<List<RouterBgpPeerAdvertisedGroupsItemComputeV1>>?
  advertisedGroups;

  /// User-specified list of individual IP ranges to advertise in custom mode. This field can only be populated if advertise_mode is CUSTOM and overrides the list defined for the router (in the "bgp" message). These IP ranges are advertised in addition to any specified groups. Leave this field blank to advertise no custom IP ranges.
  final pulumi.Input<List<RouterAdvertisedIpRangeComputeV1>>?
  advertisedIpRanges;
  ...
  final pulumi.Input<List<RouterBgpPeerCustomLearnedIpRangeComputeV1>>?
    ...
    return <String, dynamic>{
      'advertiseMode':
          ?pulumi.Input.mapOptionalInputValue<
            RouterBgpPeerAdvertiseModeComputeV1,
            String
          >(advertiseMode, (value) => value.wireValue),
      'advertisedGroups':
          ?pulumi.Input.mapOptionalInputValue<
            List<RouterBgpPeerAdvertisedGroupsItemComputeV1>,
            List<String>
          >(
            advertisedGroups,
            (value) =>
      ...
      'advertisedIpRanges':
          ?pulumi.Input.mapOptionalInputValue<
            List<RouterAdvertisedIpRangeComputeV1>,
      ...
      'customLearnedIpRanges':
          ?pulumi.Input.mapOptionalInputValue<
            List<RouterBgpPeerCustomLearnedIpRangeComputeV1>,
            List<Map<String, dynamic>>
          >(
            customLearnedIpRanges,
            (value) =>
      ...
      'enable':
          ?pulumi.Input.mapOptionalInputValue<
            RouterBgpPeerEnableComputeV1,
            String
          >(enable, (value) => value.wireValue),
    ...
    return RouterBgpPeerComputeV1(
      advertiseMode: (() {
        ...
        return pulumi.Input.fromValue(
          RouterBgpPeerAdvertiseModeComputeV1.fromValue(guardedValue as String),
        );
      })(),
      advertisedGroups: (() {
      ...
      enable: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RouterBgpPeerEnableComputeV1.fromValue(guardedValue as String),
        );
      })(),
      enableIpv6: (() {
      ...
      md5AuthenticationKeyName: (() {
        final guardedValue = map['md5AuthenticationKeyName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      name: (() {
