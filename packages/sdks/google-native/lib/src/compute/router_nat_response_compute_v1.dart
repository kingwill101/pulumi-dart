...
class RouterNatResponseComputeV1 {
  ...
  const RouterNatResponseComputeV1({
  ...
  factory RouterNatResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return RouterNatResponseComputeV1(
      ...
      logConfig: pulumi.Input.fromValue(RouterNatLogConfigResponseComputeV1.fromMap((map['logConfig']! as Map).cast<String, dynamic>())),
      ...
      rules: pulumi.Input.fromValue(pulumi.Input.decodeList<RouterNatRuleResponseComputeV1>(map['rules']!, (value) => RouterNatRuleResponseComputeV1.fromMap((value as Map).cast<String, dynamic>()))),
      sourceSubnetworkIpRangesToNat: pulumi.Input.fromValue(map['sourceSubnetworkIpRangesToNat'] as String),
      subnetworks: pulumi.Input.fromValue(pulumi.Input.decodeList<RouterNatSubnetworkToNatResponseComputeV1>(map['subnetworks']!, (value) => RouterNatSubnetworkToNatResponseComputeV1.fromMap((value as Map).cast<String, dynamic>()))),
