...
class RouterNatResponseComputeV1 {
  ...
  final pulumi.Input<List<RouterNatSubnetworkToNatResponseComputeV1>>
  subnetworks;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'rules':
          pulumi.Input.mapInputValue<
            List<RouterNatRuleResponseComputeV1>,
      ...
      'subnetworks':
          pulumi.Input.mapInputValue<
            List<RouterNatSubnetworkToNatResponseComputeV1>,
            List<Map<String, dynamic>>
          >(
            subnetworks,
            (value) =>
  ...
  factory RouterNatResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return RouterNatResponseComputeV1(
      ...
      logConfig: pulumi.Input.fromValue(
        RouterNatLogConfigResponseComputeV1.fromMap(
      ...
      rules: pulumi.Input.fromValue(
        pulumi.Input.decodeList<RouterNatRuleResponseComputeV1>(
          map['rules']!,
