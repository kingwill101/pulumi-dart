...
class RouterNatResponseComputeV1 {
  ...
  final pulumi.Input<RouterNatLogConfigResponseComputeV1> logConfig;
  ...
  final pulumi.Input<List<RouterNatRuleResponseComputeV1>> rules;
  ...
  final pulumi.Input<List<RouterNatSubnetworkToNatResponseComputeV1>> subnetworks;
  ...
  /// Creates a new [RouterNatResponseComputeV1].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'logConfig': pulumi.Input.mapInputValue<RouterNatLogConfigResponseComputeV1, Map<String, dynamic>>(logConfig, (value) => value.toMap()),
      'maxPortsPerVm': maxPortsPerVm,
      'minPortsPerVm': minPortsPerVm,
      'name': name,
      'natIpAllocateOption': natIpAllocateOption,
      'natIps': natIps,
      'rules': pulumi.Input.mapInputValue<List<RouterNatRuleResponseComputeV1>, List<Map<String, dynamic>>>(rules, (value) => pulumi.Input.encodeList<RouterNatRuleResponseComputeV1, Map<String, dynamic>>(value, (value) => value.toMap())),
      'sourceSubnetworkIpRangesToNat': sourceSubnetworkIpRangesToNat,
      'subnetworks': pulumi.Input.mapInputValue<List<RouterNatSubnetworkToNatResponseComputeV1>, List<Map<String, dynamic>>>(subnetworks, (value) => pulumi.Input.encodeList<RouterNatSubnetworkToNatResponseComputeV1, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory RouterNatResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return RouterNatResponseComputeV1(
      ...
      logConfig: (RouterNatLogConfigResponseComputeV1.fromMap((map['logConfig'] as Map).cast<String, dynamic>())).input(),
      ...
      rules: (pulumi.Input.decodeList<RouterNatRuleResponseComputeV1>(map['rules'], (value) => RouterNatRuleResponseComputeV1.fromMap((value as Map).cast<String, dynamic>()))).input(),
      sourceSubnetworkIpRangesToNat: (map['sourceSubnetworkIpRangesToNat'] as String).input(),
      subnetworks: (pulumi.Input.decodeList<RouterNatSubnetworkToNatResponseComputeV1>(map['subnetworks'], (value) => RouterNatSubnetworkToNatResponseComputeV1.fromMap((value as Map).cast<String, dynamic>()))).input(),
