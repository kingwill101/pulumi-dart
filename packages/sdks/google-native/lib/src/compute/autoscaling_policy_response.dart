...
class AutoscalingPolicyResponse {
  ...
  final pulumi.Input<List<AutoscalingPolicyCustomMetricUtilizationResponse>>
  customMetricUtilizations;

  /// Configuration parameters of autoscaling based on load balancer.
  final pulumi.Input<AutoscalingPolicyLoadBalancingUtilizationResponse>
  ...
  final pulumi.Input<AutoscalingPolicyScaleDownControlResponse>
  scaleDownControl;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'customMetricUtilizations':
          pulumi.Input.mapInputValue<
            List<AutoscalingPolicyCustomMetricUtilizationResponse>,
  ...
  factory AutoscalingPolicyResponse.fromMap(Map<String, dynamic> map) {
    return AutoscalingPolicyResponse(
      ...
      cpuUtilization: pulumi.Input.fromValue(
        AutoscalingPolicyCpuUtilizationResponse.fromMap(
      ...
      scaleDownControl: pulumi.Input.fromValue(
        AutoscalingPolicyScaleDownControlResponse.fromMap(
          (map['scaleDownControl']! as Map).cast<String, dynamic>(),
        ),
      ),
      scaleInControl: pulumi.Input.fromValue(
        AutoscalingPolicyScaleInControlResponse.fromMap(
