...
/// {@template pulumi_compute_v1_region_disk_iam_binding_compute_v1_args_doc}
/// The set of arguments for RegionDiskIamBinding.
/// {@endtemplate}
/// {@macro pulumi_compute_v1_region_disk_iam_binding_compute_v1_args_doc}
class RegionDiskIamBindingComputeV1Args {
  ...
  /// Creates a new [RegionDiskIamBindingComputeV1Args].
  ...
  const RegionDiskIamBindingComputeV1Args({
    this.condition,
