...
class GetRegionTargetHttpsProxyComputeV1Result {
  ...
  /// Creates a new [GetRegionTargetHttpsProxyComputeV1Result].
  ...
  const GetRegionTargetHttpsProxyComputeV1Result({
  ...
  factory GetRegionTargetHttpsProxyComputeV1Result.fromMap(Map<String, dynamic> map) {
    return GetRegionTargetHttpsProxyComputeV1Result(
