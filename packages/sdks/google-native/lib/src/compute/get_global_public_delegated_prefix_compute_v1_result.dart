...
class GetGlobalPublicDelegatedPrefixComputeV1Result {
  ...
  final List<PublicDelegatedPrefixPublicDelegatedSubPrefixResponseComputeV1> publicDelegatedSubPrefixs;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'publicDelegatedSubPrefixs': pulumi.Input.encodeList<PublicDelegatedPrefixPublicDelegatedSubPrefixResponseComputeV1, Map<String, dynamic>>(publicDelegatedSubPrefixs, (value) => value.toMap()),
      'region': region,
      'selfLink': selfLink,
      'status': status,
    };
  ...
  factory GetGlobalPublicDelegatedPrefixComputeV1Result.fromMap(Map<String, dynamic> map) {
    return GetGlobalPublicDelegatedPrefixComputeV1Result(
      ...
      publicDelegatedSubPrefixs: pulumi.Input.decodeList<PublicDelegatedPrefixPublicDelegatedSubPrefixResponseComputeV1>(map['publicDelegatedSubPrefixs']!, (value) => PublicDelegatedPrefixPublicDelegatedSubPrefixResponseComputeV1.fromMap((value as Map).cast<String, dynamic>())),
