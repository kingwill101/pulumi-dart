...
class BackendServiceLocalityLoadBalancingPolicyConfigResponseComputeV1 {
  ...
  factory BackendServiceLocalityLoadBalancingPolicyConfigResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return BackendServiceLocalityLoadBalancingPolicyConfigResponseComputeV1(
      customPolicy: (BackendServiceLocalityLoadBalancingPolicyConfigCustomPolicyResponseComputeV1.fromMap((map['customPolicy'] as Map).cast<String, dynamic>())).input(),
      policy: (BackendServiceLocalityLoadBalancingPolicyConfigPolicyResponseComputeV1.fromMap((map['policy'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
