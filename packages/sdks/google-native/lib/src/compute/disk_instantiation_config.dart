...
class DiskInstantiationConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'instantiateFrom': ?pulumi.Input.mapOptionalInputValue<DiskInstantiationConfigInstantiateFrom, String>(instantiateFrom, (value) => value.wireValue),
    };
  }
  ...
  factory DiskInstantiationConfig.fromMap(Map<String, dynamic> map) {
    return DiskInstantiationConfig(
      ...
      instantiateFrom: (() { final guardedValue = map['instantiateFrom']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DiskInstantiationConfigInstantiateFrom.fromValue(guardedValue as String)); })(),
    );
  }
}
