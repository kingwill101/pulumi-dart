...
class DiskInstantiationConfig {
  ...
  final DiskInstantiationConfigInstantiateFrom? instantiateFrom;
  ...
  factory DiskInstantiationConfig.fromMap(Map<String, dynamic> map) {
    return DiskInstantiationConfig(
      ...
      instantiateFrom: map['instantiateFrom'] == null ? null : DiskInstantiationConfigInstantiateFrom.fromValue(map['instantiateFrom'] as String),
    );
  }
}
