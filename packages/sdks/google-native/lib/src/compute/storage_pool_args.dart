    ...
    return <String, dynamic>{
      'capacityProvisioningType':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(capacityProvisioningType, (value) => value.wireValue),
      ...
      'performanceProvisioningType':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(performanceProvisioningType, (value) => value.wireValue),
      'project': ?project,
    ...
    return StoragePoolArgs(
      capacityProvisioningType: (() {
        ...
        return pulumi.Input.fromValue(
          StoragePoolCapacityProvisioningType.fromValue(guardedValue as String),
        );
      })(),
      description: (() {
