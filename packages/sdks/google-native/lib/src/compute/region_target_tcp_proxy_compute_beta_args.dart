...
import 'region_target_tcp_proxy_proxy_header_compute_beta.dart';

/// {@template pulumi_compute_beta_region_target_tcp_proxy_compute_beta_args_doc}
/// The set of arguments for RegionTargetTcpProxy.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_region_target_tcp_proxy_compute_beta_args_doc}
class RegionTargetTcpProxyComputeBetaArgs {
  ...
  final pulumi.Input<RegionTargetTcpProxyProxyHeaderComputeBeta>? proxyHeader;
  ...
  /// Creates a new [RegionTargetTcpProxyComputeBetaArgs].
  ...
  RegionTargetTcpProxyComputeBetaArgs({
    pulumi.Output<String>? description,
    pulumi.Output<String>? name,
    pulumi.Output<String>? project,
    pulumi.Output<bool>? proxyBind,
    pulumi.Output<RegionTargetTcpProxyProxyHeaderComputeBeta>? proxyHeader,
    ...
    pulumi.Output<String>? service,
      ...
      proxyHeader = pulumi.Input.asOptionalInput<RegionTargetTcpProxyProxyHeaderComputeBeta>(proxyHeader),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'project': ?project,
      'proxyBind': ?proxyBind,
      'proxyHeader': ?pulumi.Input.mapOptionalInputValue<RegionTargetTcpProxyProxyHeaderComputeBeta, String>(proxyHeader, (value) => value.value),
      'region': region,
      'requestId': ?requestId,
      'service': ?service,
    };
  ...
  factory RegionTargetTcpProxyComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return RegionTargetTcpProxyComputeBetaArgs(
      ...
      proxyHeader: map['proxyHeader'] == null ? null : pulumi.Output.create<RegionTargetTcpProxyProxyHeaderComputeBeta>(RegionTargetTcpProxyProxyHeaderComputeBeta.fromValue(map['proxyHeader'] as String)),
