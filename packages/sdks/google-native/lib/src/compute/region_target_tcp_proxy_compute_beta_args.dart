...
class RegionTargetTcpProxyComputeBetaArgs {
  ...
  const RegionTargetTcpProxyComputeBetaArgs({
    this.description,
    this.name,
    this.project,
    this.proxyBind,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'project': ?project,
      'proxyBind': ?proxyBind,
      'proxyHeader': ?pulumi.Input.mapOptionalInputValue<RegionTargetTcpProxyProxyHeaderComputeBeta, String>(proxyHeader, (value) => value.wireValue),
      'region': region,
      'requestId': ?requestId,
      'service': ?service,
    };
  ...
  factory RegionTargetTcpProxyComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return RegionTargetTcpProxyComputeBetaArgs(
      ...
      proxyHeader: (() { final guardedValue = map['proxyHeader']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionTargetTcpProxyProxyHeaderComputeBeta.fromValue(guardedValue as String)); })(),
