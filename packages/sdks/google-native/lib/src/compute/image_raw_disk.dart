...
class ImageRawDisk {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'containerType': ?pulumi.Input.mapOptionalInputValue<ImageRawDiskContainerType, String>(containerType, (value) => value.wireValue),
  ...
  factory ImageRawDisk.fromMap(Map<String, dynamic> map) {
    return ImageRawDisk(
      containerType: (() { final guardedValue = map['containerType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ImageRawDiskContainerType.fromValue(guardedValue as String)); })(),
