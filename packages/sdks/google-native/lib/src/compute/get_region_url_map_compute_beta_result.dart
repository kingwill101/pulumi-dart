...
class GetRegionUrlMapComputeBetaResult {
  ...
  final CustomErrorResponsePolicyResponseComputeBeta
  ...
  factory GetRegionUrlMapComputeBetaResult.fromMap(Map<String, dynamic> map) {
    return GetRegionUrlMapComputeBetaResult(
      ...
      defaultRouteAction: HttpRouteActionResponseComputeBeta.fromMap(
        (map['defaultRouteAction']! as Map).cast<String, dynamic>(),
      ),
      defaultService: map['defaultService'] as String,
      defaultUrlRedirect: HttpRedirectActionResponseComputeBeta.fromMap(
      ...
      hostRules: pulumi.Input.decodeList<HostRuleResponseComputeBeta>(
        map['hostRules']!,
        (value) => HostRuleResponseComputeBeta.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      kind: map['kind'] as String,
      name: map['name'] as String,
      pathMatchers: pulumi.Input.decodeList<PathMatcherResponseComputeBeta>(
        map['pathMatchers']!,
        (value) => PathMatcherResponseComputeBeta.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      region: map['region'] as String,
      selfLink: map['selfLink'] as String,
      tests: pulumi.Input.decodeList<UrlMapTestResponseComputeBeta>(
        map['tests']!,
        (value) => UrlMapTestResponseComputeBeta.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
    );
