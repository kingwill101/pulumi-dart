...
class GetRegionUrlMapComputeBetaResult {
  ...
  final CustomErrorResponsePolicyResponseComputeBeta defaultCustomErrorResponsePolicy;
  ...
  final HttpRouteActionResponseComputeBeta defaultRouteAction;
  ...
  final HttpRedirectActionResponseComputeBeta defaultUrlRedirect;
  ...
  final List<HostRuleResponseComputeBeta> hostRules;
  ...
  final List<PathMatcherResponseComputeBeta> pathMatchers;
  ...
  final List<UrlMapTestResponseComputeBeta> tests;

  /// Creates a new [GetRegionUrlMapComputeBetaResult].
  ...
  const GetRegionUrlMapComputeBetaResult({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'hostRules': pulumi.Input.encodeList<HostRuleResponseComputeBeta, Map<String, dynamic>>(hostRules, (value) => value.toMap()),
      'kind': kind,
      'name': name,
      'pathMatchers': pulumi.Input.encodeList<PathMatcherResponseComputeBeta, Map<String, dynamic>>(pathMatchers, (value) => value.toMap()),
      'region': region,
      'selfLink': selfLink,
      'tests': pulumi.Input.encodeList<UrlMapTestResponseComputeBeta, Map<String, dynamic>>(tests, (value) => value.toMap()),
    };
  }

  factory GetRegionUrlMapComputeBetaResult.fromMap(Map<String, dynamic> map) {
    return GetRegionUrlMapComputeBetaResult(
      creationTimestamp: map['creationTimestamp'] as String,
      defaultCustomErrorResponsePolicy: CustomErrorResponsePolicyResponseComputeBeta.fromMap((map['defaultCustomErrorResponsePolicy']! as Map).cast<String, dynamic>()),
      defaultRouteAction: HttpRouteActionResponseComputeBeta.fromMap((map['defaultRouteAction']! as Map).cast<String, dynamic>()),
      defaultService: map['defaultService'] as String,
      defaultUrlRedirect: HttpRedirectActionResponseComputeBeta.fromMap((map['defaultUrlRedirect']! as Map).cast<String, dynamic>()),
      description: map['description'] as String,
      fingerprint: map['fingerprint'] as String,
      headerAction: HttpHeaderActionResponseComputeBeta.fromMap((map['headerAction']! as Map).cast<String, dynamic>()),
      hostRules: pulumi.Input.decodeList<HostRuleResponseComputeBeta>(map['hostRules']!, (value) => HostRuleResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      kind: map['kind'] as String,
      name: map['name'] as String,
      pathMatchers: pulumi.Input.decodeList<PathMatcherResponseComputeBeta>(map['pathMatchers']!, (value) => PathMatcherResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      region: map['region'] as String,
      selfLink: map['selfLink'] as String,
      tests: pulumi.Input.decodeList<UrlMapTestResponseComputeBeta>(map['tests']!, (value) => UrlMapTestResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
