...
/// {@template pulumi_compute_v1_firewall_policy_iam_binding_compute_v1_args_doc}
/// The set of arguments for FirewallPolicyIamBinding.
/// {@endtemplate}
/// {@macro pulumi_compute_v1_firewall_policy_iam_binding_compute_v1_args_doc}
class FirewallPolicyIamBindingComputeV1Args {
  ...
  /// Creates a new [FirewallPolicyIamBindingComputeV1Args].
  ...
  const FirewallPolicyIamBindingComputeV1Args({
    this.condition,
  ...
  factory FirewallPolicyIamBindingComputeV1Args.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyIamBindingComputeV1Args(
