...
class FutureReservationComputeBetaArgs {
  ...
  FutureReservationComputeBetaArgs({
    ...
    pulumi.Output<DurationComputeBeta>? autoCreatedReservationsDuration,
    pulumi.Output<bool>? autoDeleteAutoCreatedReservations,
    pulumi.Output<String>? description,
    pulumi.Output<String>? name,
    pulumi.Output<String>? namePrefix,
    pulumi.Output<FutureReservationPlanningStatusComputeBeta>? planningStatus,
    pulumi.Output<String>? project,
    pulumi.Output<String>? requestId,
    pulumi.Output<ShareSettingsComputeBeta>? shareSettings,
    pulumi.Output<FutureReservationSpecificSKUPropertiesComputeBeta>? specificSkuProperties,
    pulumi.Output<FutureReservationTimeWindowComputeBeta>? timeWindow,
  ...
  factory FutureReservationComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return FutureReservationComputeBetaArgs(
      ...
      autoCreatedReservationsDuration: map['autoCreatedReservationsDuration'] == null ? null : pulumi.Output.create<DurationComputeBeta>(DurationComputeBeta.fromMap((map['autoCreatedReservationsDuration'] as Map).cast<String, dynamic>())),
      ...
      planningStatus: map['planningStatus'] == null ? null : pulumi.Output.create<FutureReservationPlanningStatusComputeBeta>(FutureReservationPlanningStatusComputeBeta.fromValue(map['planningStatus'] as String)),
      ...
      specificSkuProperties: map['specificSkuProperties'] == null ? null : pulumi.Output.create<FutureReservationSpecificSKUPropertiesComputeBeta>(FutureReservationSpecificSKUPropertiesComputeBeta.fromMap((map['specificSkuProperties'] as Map).cast<String, dynamic>())),
      timeWindow: map['timeWindow'] == null ? null : pulumi.Output.create<FutureReservationTimeWindowComputeBeta>(FutureReservationTimeWindowComputeBeta.fromMap((map['timeWindow'] as Map).cast<String, dynamic>())),
