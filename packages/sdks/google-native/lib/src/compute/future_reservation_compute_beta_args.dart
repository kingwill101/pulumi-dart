...
class FutureReservationComputeBetaArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'planningStatus': ?pulumi.Input.mapOptionalInputValue<FutureReservationPlanningStatusComputeBeta, String>(planningStatus, (value) => value.wireValue),
      'project': ?project,
      'requestId': ?requestId,
  ...
  factory FutureReservationComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return FutureReservationComputeBetaArgs(
      ...
      autoCreatedReservationsDuration: (() { final guardedValue = map['autoCreatedReservationsDuration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DurationComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      planningStatus: (() { final guardedValue = map['planningStatus']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FutureReservationPlanningStatusComputeBeta.fromValue(guardedValue as String)); })(),
      ...
      specificSkuProperties: (() { final guardedValue = map['specificSkuProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FutureReservationSpecificSKUPropertiesComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      timeWindow: (() { final guardedValue = map['timeWindow']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FutureReservationTimeWindowComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
