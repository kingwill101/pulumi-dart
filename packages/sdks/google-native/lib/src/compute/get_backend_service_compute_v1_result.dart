...
import 'backend_response_compute_v1.dart';
import 'backend_service_cdn_policy_response_compute_v1.dart';
import 'backend_service_connection_tracking_policy_response_compute_v1.dart';
import 'backend_service_failover_policy_response_compute_v1.dart';
import 'backend_service_iapresponse_compute_v1.dart';
import 'backend_service_locality_load_balancing_policy_config_response_compute_v1.dart';
import 'backend_service_log_config_response_compute_v1.dart';
import 'backend_service_used_by_response_compute_v1.dart';
import 'circuit_breakers_response_compute_v1.dart';
import 'connection_draining_response_compute_v1.dart';
import 'consistent_hash_load_balancer_settings_response_compute_v1.dart';
import 'duration_response_compute_v1.dart';
import 'outlier_detection_response_compute_v1.dart';
import 'security_settings_response_compute_v1.dart';
import 'subsetting_response_compute_v1.dart';

/// Result data returned by getBackendService.
class GetBackendServiceComputeV1Result {
  ...
  final List<BackendResponseComputeV1> backends;
  /// Cloud CDN configuration for this BackendService. Only available for specified load balancer types.
  final BackendServiceCdnPolicyResponseComputeV1 cdnPolicy;
  final CircuitBreakersResponseComputeV1 circuitBreakers;
  /// Compress text responses using Brotli or gzip compression, based on the client's Accept-Encoding header.
  final String compressionMode;
  final ConnectionDrainingResponseComputeV1 connectionDraining;
  /// Connection Tracking configuration for this BackendService. Connection tracking policy settings are only available for Network Load Balancing and Internal TCP/UDP Load Balancing.
  final BackendServiceConnectionTrackingPolicyResponseComputeV1 connectionTrackingPolicy;
  ...
  final ConsistentHashLoadBalancerSettingsResponseComputeV1 consistentHash;
  ...
  final BackendServiceFailoverPolicyResponseComputeV1 failoverPolicy;
  ...
  final BackendServiceIAPResponseComputeV1 iap;
  ...
  final List<BackendServiceLocalityLoadBalancingPolicyConfigResponseComputeV1> localityLbPolicies;
  ...
  final BackendServiceLogConfigResponseComputeV1 logConfig;
  ...
  final OutlierDetectionResponseComputeV1 outlierDetection;
  ...
  final SecuritySettingsResponseComputeV1 securitySettings;
  ...
  final SubsettingResponseComputeV1 subsetting;
  /// The backend service timeout has a different meaning depending on the type of load balancer. For more information see, Backend service settings. The default is 30 seconds. The full range of timeout values allowed goes from 1 through 2,147,483,647 seconds. This value can be overridden in the PathMatcher configuration of the UrlMap that references this backend service. Not supported when the backend service is referenced by a URL map that is bound to target gRPC proxy that has validateForProxyless field set to true. Instead, use maxStreamDuration.
  final int timeoutSec;
  final List<BackendServiceUsedByResponseComputeV1> usedBy;

  /// Creates a new [GetBackendServiceComputeV1Result].
  ...
  /// [usedBy] Required.
  const GetBackendServiceComputeV1Result({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'backends': pulumi.Input.encodeList<BackendResponseComputeV1, Map<String, dynamic>>(backends, (value) => value.toMap()),
      ...
      'localityLbPolicies': pulumi.Input.encodeList<BackendServiceLocalityLoadBalancingPolicyConfigResponseComputeV1, Map<String, dynamic>>(localityLbPolicies, (value) => value.toMap()),
      ...
      'usedBy': pulumi.Input.encodeList<BackendServiceUsedByResponseComputeV1, Map<String, dynamic>>(usedBy, (value) => value.toMap()),
    };
  }

  factory GetBackendServiceComputeV1Result.fromMap(Map<String, dynamic> map) {
    return GetBackendServiceComputeV1Result(
      affinityCookieTtlSec: map['affinityCookieTtlSec'] as int,
      backends: pulumi.Input.decodeList<BackendResponseComputeV1>(map['backends']!, (value) => BackendResponseComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      cdnPolicy: BackendServiceCdnPolicyResponseComputeV1.fromMap((map['cdnPolicy']! as Map).cast<String, dynamic>()),
      circuitBreakers: CircuitBreakersResponseComputeV1.fromMap((map['circuitBreakers']! as Map).cast<String, dynamic>()),
      compressionMode: map['compressionMode'] as String,
      connectionDraining: ConnectionDrainingResponseComputeV1.fromMap((map['connectionDraining']! as Map).cast<String, dynamic>()),
      connectionTrackingPolicy: BackendServiceConnectionTrackingPolicyResponseComputeV1.fromMap((map['connectionTrackingPolicy']! as Map).cast<String, dynamic>()),
      consistentHash: ConsistentHashLoadBalancerSettingsResponseComputeV1.fromMap((map['consistentHash']! as Map).cast<String, dynamic>()),
      ...
      failoverPolicy: BackendServiceFailoverPolicyResponseComputeV1.fromMap((map['failoverPolicy']! as Map).cast<String, dynamic>()),
      fingerprint: map['fingerprint'] as String,
      healthChecks: (map['healthChecks'] as List).cast<String>(),
      iap: BackendServiceIAPResponseComputeV1.fromMap((map['iap']! as Map).cast<String, dynamic>()),
      kind: map['kind'] as String,
      loadBalancingScheme: map['loadBalancingScheme'] as String,
      localityLbPolicies: pulumi.Input.decodeList<BackendServiceLocalityLoadBalancingPolicyConfigResponseComputeV1>(map['localityLbPolicies']!, (value) => BackendServiceLocalityLoadBalancingPolicyConfigResponseComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      localityLbPolicy: map['localityLbPolicy'] as String,
      logConfig: BackendServiceLogConfigResponseComputeV1.fromMap((map['logConfig']! as Map).cast<String, dynamic>()),
      maxStreamDuration: DurationResponseComputeV1.fromMap((map['maxStreamDuration']! as Map).cast<String, dynamic>()),
      metadatas: (map['metadatas'] as Map).cast<String, String>(),
      name: map['name'] as String,
      network: map['network'] as String,
      outlierDetection: OutlierDetectionResponseComputeV1.fromMap((map['outlierDetection']! as Map).cast<String, dynamic>()),
      port: map['port'] as int,
      portName: map['portName'] as String,
      protocol: map['protocol'] as String,
      region: map['region'] as String,
      securityPolicy: map['securityPolicy'] as String,
      securitySettings: SecuritySettingsResponseComputeV1.fromMap((map['securitySettings']! as Map).cast<String, dynamic>()),
      selfLink: map['selfLink'] as String,
      serviceBindings: (map['serviceBindings'] as List).cast<String>(),
      sessionAffinity: map['sessionAffinity'] as String,
      subsetting: SubsettingResponseComputeV1.fromMap((map['subsetting']! as Map).cast<String, dynamic>()),
      timeoutSec: map['timeoutSec'] as int,
      usedBy: pulumi.Input.decodeList<BackendServiceUsedByResponseComputeV1>(map['usedBy']!, (value) => BackendServiceUsedByResponseComputeV1.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
