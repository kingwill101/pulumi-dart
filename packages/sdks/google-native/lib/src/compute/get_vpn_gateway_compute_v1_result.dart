...
class GetVpnGatewayComputeV1Result {
  ...
  /// Creates a new [GetVpnGatewayComputeV1Result].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'selfLink': selfLink,
      'stackType': stackType,
      'vpnInterfaces': pulumi.Input.encodeList<VpnGatewayVpnGatewayInterfaceResponseComputeV1, Map<String, dynamic>>(vpnInterfaces, (value) => value.toMap()),
    };
  }
  ...
  factory GetVpnGatewayComputeV1Result.fromMap(Map<String, dynamic> map) {
    return GetVpnGatewayComputeV1Result(
      ...
      vpnInterfaces: pulumi.Input.decodeList<VpnGatewayVpnGatewayInterfaceResponseComputeV1>(map['vpnInterfaces']!, (value) => VpnGatewayVpnGatewayInterfaceResponseComputeV1.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
