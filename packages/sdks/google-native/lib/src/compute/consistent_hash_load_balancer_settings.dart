...
import 'consistent_hash_load_balancer_settings_http_cookie.dart';
...
class ConsistentHashLoadBalancerSettings {
  ...
  final pulumi.Input<ConsistentHashLoadBalancerSettingsHttpCookie>? httpCookie;
  ...
  /// Creates a new [ConsistentHashLoadBalancerSettings].
  /// [httpCookie] Hash is based on HTTP Cookie. This field describes a HTTP cookie that will be used as the hash key for the consistent hash load balancer. If the cookie is not present, it will be generated. This field is applicable if the sessionAffinity is set to HTTP_COOKIE. Not supported when the backend service is referenced by a URL map that is bound to target gRPC proxy that has validateForProxyless field set to true.
  ...
  const ConsistentHashLoadBalancerSettings({
    this.httpCookie,
    this.httpHeaderName,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'httpCookie': ?pulumi.Input.mapOptionalInputValue<ConsistentHashLoadBalancerSettingsHttpCookie, Map<String, dynamic>>(httpCookie, (value) => value.toMap()),
      'httpHeaderName': ?httpHeaderName,
      'minimumRingSize': ?minimumRingSize,
    };
  }

  factory ConsistentHashLoadBalancerSettings.fromMap(Map<String, dynamic> map) {
    return ConsistentHashLoadBalancerSettings(
      httpCookie: (() { final guardedValue = map['httpCookie']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConsistentHashLoadBalancerSettingsHttpCookie.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
