...
class SecurityPolicyRuleRedirectOptionsComputeBeta {
  ...
  const SecurityPolicyRuleRedirectOptionsComputeBeta({
    this.target,
    this.type,
  });
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'target': ?target,
      'type': ?pulumi.Input.mapOptionalInputValue<SecurityPolicyRuleRedirectOptionsTypeComputeBeta, String>(type, (value) => value.wireValue),
    };
  }
  ...
  factory SecurityPolicyRuleRedirectOptionsComputeBeta.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRuleRedirectOptionsComputeBeta(
      ...
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SecurityPolicyRuleRedirectOptionsTypeComputeBeta.fromValue(guardedValue as String)); })(),
    );
  }
}
