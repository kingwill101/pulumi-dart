...
class MachineImageComputeBetaArgs {
  ...
  final pulumi.Input<List<SourceDiskEncryptionKeyComputeBeta>>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'sourceDiskEncryptionKeys':
          ?pulumi.Input.mapOptionalInputValue<
            List<SourceDiskEncryptionKeyComputeBeta>,
            List<Map<String, dynamic>>
          >(
            sourceDiskEncryptionKeys,
            (value) =>
  ...
  factory MachineImageComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return MachineImageComputeBetaArgs(
      ...
      machineImageEncryptionKey: (() {
        final guardedValue = map['machineImageEncryptionKey'];
        if (guardedValue == null) return null;
      ...
      savedDisks: (() {
        final guardedValue = map['savedDisks'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SavedDiskComputeBeta>(
            guardedValue,
            (value) => SavedDiskComputeBeta.fromMap(
      ...
      sourceDiskEncryptionKeys: (() {
        final guardedValue = map['sourceDiskEncryptionKeys'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SourceDiskEncryptionKeyComputeBeta>(
            guardedValue,
            (value) => SourceDiskEncryptionKeyComputeBeta.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
