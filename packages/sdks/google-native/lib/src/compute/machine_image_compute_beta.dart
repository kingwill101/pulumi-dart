...
class MachineImageComputeBeta extends pulumi.CustomResource {
  ...
  MachineImageComputeBeta(
    ...
    instanceProperties = registerOutput<InstancePropertiesResponseComputeBeta>('instanceProperties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return InstancePropertiesResponseComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    kind = registerOutput<String>('kind');
    machineImageEncryptionKey = registerOutput<CustomerEncryptionKeyResponseComputeBeta>('machineImageEncryptionKey', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return CustomerEncryptionKeyResponseComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    sourceInstanceProperties = registerOutput<SourceInstancePropertiesResponseComputeBeta>('sourceInstanceProperties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SourceInstancePropertiesResponseComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>()); });
