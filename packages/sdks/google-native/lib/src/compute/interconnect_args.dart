...
class InterconnectArgs {
  ...
  InterconnectArgs({
    ...
    pulumi.Output<InterconnectInterconnectType>? interconnectType,
    pulumi.Output<Map<String, String>>? labels,
    pulumi.Output<InterconnectLinkType>? linkType,
    ...
    pulumi.Output<List<InterconnectRequestedFeaturesItem>>? requestedFeatures,
    pulumi.Output<int>? requestedLinkCount,
      ...
      interconnectType = pulumi.Input.asOptionalInput<InterconnectInterconnectType>(interconnectType),
      labels = pulumi.Input.asOptionalInput<Map<String, String>>(labels),
      linkType = pulumi.Input.asOptionalInput<InterconnectLinkType>(linkType),
      ...
      requestedFeatures = pulumi.Input.asOptionalInput<List<InterconnectRequestedFeaturesItem>>(requestedFeatures),
  ...
  factory InterconnectArgs.fromMap(Map<String, dynamic> map) {
    return InterconnectArgs(
      ...
      interconnectType: map['interconnectType'] == null ? null : pulumi.Output.create<InterconnectInterconnectType>(InterconnectInterconnectType.fromValue(map['interconnectType'] as String)),
      labels: map['labels'] == null ? null : pulumi.Output.create<Map<String, String>>((map['labels'] as Map).cast<String, String>()),
      linkType: map['linkType'] == null ? null : pulumi.Output.create<InterconnectLinkType>(InterconnectLinkType.fromValue(map['linkType'] as String)),
      ...
      requestedFeatures: map['requestedFeatures'] == null ? null : pulumi.Output.create<List<InterconnectRequestedFeaturesItem>>(pulumi.Input.decodeList<InterconnectRequestedFeaturesItem>(map['requestedFeatures'], (value) => InterconnectRequestedFeaturesItem.fromValue(value as String))),
