...
class InterconnectArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'interconnectType': ?pulumi.Input.mapOptionalInputValue<InterconnectInterconnectType, String>(interconnectType, (value) => value.wireValue),
      'labels': ?labels,
      'linkType': ?pulumi.Input.mapOptionalInputValue<InterconnectLinkType, String>(linkType, (value) => value.wireValue),
      'location': ?location,
      ...
      'requestId': ?requestId,
      'requestedFeatures': ?pulumi.Input.mapOptionalInputValue<List<InterconnectRequestedFeaturesItem>, List<String>>(requestedFeatures, (value) => pulumi.Input.encodeList<InterconnectRequestedFeaturesItem, String>(value, (value) => value.wireValue)),
  ...
  factory InterconnectArgs.fromMap(Map<String, dynamic> map) {
    return InterconnectArgs(
      ...
      interconnectType: (() { final guardedValue = map['interconnectType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InterconnectInterconnectType.fromValue(guardedValue as String)); })(),
      labels: (() { final guardedValue = map['labels']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      linkType: (() { final guardedValue = map['linkType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InterconnectLinkType.fromValue(guardedValue as String)); })(),
      ...
      requestedFeatures: (() { final guardedValue = map['requestedFeatures']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InterconnectRequestedFeaturesItem>(guardedValue, (value) => InterconnectRequestedFeaturesItem.fromValue(value as String))); })(),
