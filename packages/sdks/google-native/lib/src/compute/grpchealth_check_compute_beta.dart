...
class GRPCHealthCheckComputeBeta {
  ...
  const GRPCHealthCheckComputeBeta({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'port': ?port,
      'portName': ?portName,
      'portSpecification': ?pulumi.Input.mapOptionalInputValue<GRPCHealthCheckPortSpecificationComputeBeta, String>(portSpecification, (value) => value.wireValue),
    };
  }
  ...
  factory GRPCHealthCheckComputeBeta.fromMap(Map<String, dynamic> map) {
    return GRPCHealthCheckComputeBeta(
      ...
      portSpecification: (() { final guardedValue = map['portSpecification']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GRPCHealthCheckPortSpecificationComputeBeta.fromValue(guardedValue as String)); })(),
    );
  }
}
