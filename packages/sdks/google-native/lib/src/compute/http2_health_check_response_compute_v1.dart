...
class HTTP2HealthCheckResponseComputeV1 {
  ...
  /// Creates a new [HTTP2HealthCheckResponseComputeV1].
  ...
  const HTTP2HealthCheckResponseComputeV1({
    required this.host,
    required this.port,
  ...
  factory HTTP2HealthCheckResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return HTTP2HealthCheckResponseComputeV1(
