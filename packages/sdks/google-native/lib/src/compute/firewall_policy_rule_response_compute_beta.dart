...
class FirewallPolicyRuleResponseComputeBeta {
  ...
  factory FirewallPolicyRuleResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyRuleResponseComputeBeta(
      ...
      match: (FirewallPolicyRuleMatcherResponseComputeBeta.fromMap((map['match'] as Map).cast<String, dynamic>())).input(),
      priority: (map['priority'] as int).input(),
      ruleName: (map['ruleName'] as String).input(),
      ruleTupleCount: (map['ruleTupleCount'] as int).input(),
      securityProfileGroup: (map['securityProfileGroup'] as String).input(),
      targetResources: ((map['targetResources'] as List).cast<String>()).input(),
      targetSecureTags: (pulumi.Input.decodeList<FirewallPolicyRuleSecureTagResponseComputeBeta>(map['targetSecureTags'], (value) => FirewallPolicyRuleSecureTagResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))).input(),
      targetServiceAccounts: ((map['targetServiceAccounts'] as List).cast<String>()).input(),
      tlsInspect: (map['tlsInspect'] as bool).input(),
    );
  }
}
