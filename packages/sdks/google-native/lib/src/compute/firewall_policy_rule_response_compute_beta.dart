...
class FirewallPolicyRuleResponseComputeBeta {
  ...
  final pulumi.Input<List<FirewallPolicyRuleSecureTagResponseComputeBeta>>
  targetSecureTags;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'targetSecureTags':
          pulumi.Input.mapInputValue<
            List<FirewallPolicyRuleSecureTagResponseComputeBeta>,
  ...
  factory FirewallPolicyRuleResponseComputeBeta.fromMap(
    ...
    return FirewallPolicyRuleResponseComputeBeta(
      ...
      match: pulumi.Input.fromValue(
        FirewallPolicyRuleMatcherResponseComputeBeta.fromMap(
      ...
      securityProfileGroup: pulumi.Input.fromValue(
      ...
      targetSecureTags: pulumi.Input.fromValue(
        pulumi.Input.decodeList<FirewallPolicyRuleSecureTagResponseComputeBeta>(
