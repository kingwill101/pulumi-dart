...
import 'firewall_policy_rule_matcher_response_compute_beta.dart';
import 'firewall_policy_rule_secure_tag_response_compute_beta.dart';

/// Represents a rule that describes one or more match conditions along with the action to be taken when traffic matches this condition (allow or deny).
class FirewallPolicyRuleResponseComputeBeta {
  ...
  final pulumi.Input<FirewallPolicyRuleMatcherResponseComputeBeta> match;
  ...
  final pulumi.Input<List<FirewallPolicyRuleSecureTagResponseComputeBeta>> targetSecureTags;
  ...
  /// Creates a new [FirewallPolicyRuleResponseComputeBeta].
  ...
  const FirewallPolicyRuleResponseComputeBeta({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'kind': kind,
      'match': pulumi.Input.mapInputValue<FirewallPolicyRuleMatcherResponseComputeBeta, Map<String, dynamic>>(match, (value) => value.toMap()),
      'priority': priority,
      'ruleName': ruleName,
      'ruleTupleCount': ruleTupleCount,
      'securityProfileGroup': securityProfileGroup,
      'targetResources': targetResources,
      'targetSecureTags': pulumi.Input.mapInputValue<List<FirewallPolicyRuleSecureTagResponseComputeBeta>, List<Map<String, dynamic>>>(targetSecureTags, (value) => pulumi.Input.encodeList<FirewallPolicyRuleSecureTagResponseComputeBeta, Map<String, dynamic>>(value, (value) => value.toMap())),
      'targetServiceAccounts': targetServiceAccounts,
      'tlsInspect': tlsInspect,
    };
  }

  factory FirewallPolicyRuleResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyRuleResponseComputeBeta(
      ...
      match: pulumi.Input.fromValue(FirewallPolicyRuleMatcherResponseComputeBeta.fromMap((map['match']! as Map).cast<String, dynamic>())),
      priority: pulumi.Input.fromValue(map['priority'] as int),
      ruleName: pulumi.Input.fromValue(map['ruleName'] as String),
      ruleTupleCount: pulumi.Input.fromValue(map['ruleTupleCount'] as int),
      securityProfileGroup: pulumi.Input.fromValue(map['securityProfileGroup'] as String),
      targetResources: pulumi.Input.fromValue((map['targetResources'] as List).cast<String>()),
      targetSecureTags: pulumi.Input.fromValue(pulumi.Input.decodeList<FirewallPolicyRuleSecureTagResponseComputeBeta>(map['targetSecureTags']!, (value) => FirewallPolicyRuleSecureTagResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))),
      targetServiceAccounts: pulumi.Input.fromValue((map['targetServiceAccounts'] as List).cast<String>()),
      tlsInspect: pulumi.Input.fromValue(map['tlsInspect'] as bool),
    );
  }
}
