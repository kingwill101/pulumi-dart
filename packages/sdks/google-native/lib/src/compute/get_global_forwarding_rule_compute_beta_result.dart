...
class GetGlobalForwardingRuleComputeBetaResult {
  ...
  final List<ForwardingRuleServiceDirectoryRegistrationResponseComputeBeta>
  ...
  /// Creates a new [GetGlobalForwardingRuleComputeBetaResult].
  ...
  GetGlobalForwardingRuleComputeBetaResult({
  ...
  factory GetGlobalForwardingRuleComputeBetaResult.fromMap(
    Map<String, dynamic> map,
  ) {
    return GetGlobalForwardingRuleComputeBetaResult(
      ...
      serviceDirectoryRegistrations:
          ...
          >(
            ...
            (value) =>
                ForwardingRuleServiceDirectoryRegistrationResponseComputeBeta.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
