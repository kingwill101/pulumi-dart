...
class RouterNatResponseComputeBeta {
  ...
  final pulumi.Input<RouterNatLogConfigResponseComputeBeta> logConfig;
  ...
  final pulumi.Input<List<RouterNatRuleResponseComputeBeta>> rules;
  ...
  final pulumi.Input<List<RouterNatSubnetworkToNatResponseComputeBeta>> subnetworks;
  ...
  /// Creates a new [RouterNatResponseComputeBeta].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'logConfig': pulumi.Input.mapInputValue<RouterNatLogConfigResponseComputeBeta, Map<String, dynamic>>(logConfig, (value) => value.toMap()),
      'maxPortsPerVm': maxPortsPerVm,
      'minPortsPerVm': minPortsPerVm,
      'name': name,
      'natIpAllocateOption': natIpAllocateOption,
      'natIps': natIps,
      'rules': pulumi.Input.mapInputValue<List<RouterNatRuleResponseComputeBeta>, List<Map<String, dynamic>>>(rules, (value) => pulumi.Input.encodeList<RouterNatRuleResponseComputeBeta, Map<String, dynamic>>(value, (value) => value.toMap())),
      'sourceSubnetworkIpRangesToNat': sourceSubnetworkIpRangesToNat,
      'subnetworks': pulumi.Input.mapInputValue<List<RouterNatSubnetworkToNatResponseComputeBeta>, List<Map<String, dynamic>>>(subnetworks, (value) => pulumi.Input.encodeList<RouterNatSubnetworkToNatResponseComputeBeta, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory RouterNatResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return RouterNatResponseComputeBeta(
      autoNetworkTier: (map['autoNetworkTier'] as String).input(),
      drainNatIps: ((map['drainNatIps'] as List).cast<String>()).input(),
      enableDynamicPortAllocation: (map['enableDynamicPortAllocation'] as bool).input(),
      enableEndpointIndependentMapping: (map['enableEndpointIndependentMapping'] as bool).input(),
      endpointTypes: ((map['endpointTypes'] as List).cast<String>()).input(),
      icmpIdleTimeoutSec: (map['icmpIdleTimeoutSec'] as int).input(),
      logConfig: (RouterNatLogConfigResponseComputeBeta.fromMap((map['logConfig'] as Map).cast<String, dynamic>())).input(),
      maxPortsPerVm: (map['maxPortsPerVm'] as int).input(),
      ...
      rules: (pulumi.Input.decodeList<RouterNatRuleResponseComputeBeta>(map['rules'], (value) => RouterNatRuleResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))).input(),
      sourceSubnetworkIpRangesToNat: (map['sourceSubnetworkIpRangesToNat'] as String).input(),
      subnetworks: (pulumi.Input.decodeList<RouterNatSubnetworkToNatResponseComputeBeta>(map['subnetworks'], (value) => RouterNatSubnetworkToNatResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))).input(),
      tcpEstablishedIdleTimeoutSec: (map['tcpEstablishedIdleTimeoutSec'] as int).input(),
      tcpTimeWaitTimeoutSec: (map['tcpTimeWaitTimeoutSec'] as int).input(),
