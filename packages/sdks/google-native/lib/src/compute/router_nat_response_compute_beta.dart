...
class RouterNatResponseComputeBeta {
  ...
  const RouterNatResponseComputeBeta({
  ...
  factory RouterNatResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return RouterNatResponseComputeBeta(
      ...
      logConfig: pulumi.Input.fromValue(RouterNatLogConfigResponseComputeBeta.fromMap((map['logConfig']! as Map).cast<String, dynamic>())),
      ...
      rules: pulumi.Input.fromValue(pulumi.Input.decodeList<RouterNatRuleResponseComputeBeta>(map['rules']!, (value) => RouterNatRuleResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))),
      sourceSubnetworkIpRangesToNat: pulumi.Input.fromValue(map['sourceSubnetworkIpRangesToNat'] as String),
      subnetworks: pulumi.Input.fromValue(pulumi.Input.decodeList<RouterNatSubnetworkToNatResponseComputeBeta>(map['subnetworks']!, (value) => RouterNatSubnetworkToNatResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))),
