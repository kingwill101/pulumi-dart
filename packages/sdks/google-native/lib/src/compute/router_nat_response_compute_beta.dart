...
class RouterNatResponseComputeBeta {
  ...
  final pulumi.Input<List<RouterNatSubnetworkToNatResponseComputeBeta>>
  subnetworks;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'rules':
          pulumi.Input.mapInputValue<
            List<RouterNatRuleResponseComputeBeta>,
      ...
      'subnetworks':
          pulumi.Input.mapInputValue<
            List<RouterNatSubnetworkToNatResponseComputeBeta>,
            List<Map<String, dynamic>>
          >(
            subnetworks,
            (value) =>
  ...
  factory RouterNatResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return RouterNatResponseComputeBeta(
      ...
      drainNatIps: pulumi.Input.fromValue(
        (map['drainNatIps'] as List).cast<String>(),
      ),
      enableDynamicPortAllocation: pulumi.Input.fromValue(
      ...
      endpointTypes: pulumi.Input.fromValue(
      ...
      logConfig: pulumi.Input.fromValue(
        RouterNatLogConfigResponseComputeBeta.fromMap(
      ...
      rules: pulumi.Input.fromValue(
        pulumi.Input.decodeList<RouterNatRuleResponseComputeBeta>(
          map['rules']!,
      ...
      tcpTimeWaitTimeoutSec: pulumi.Input.fromValue(
