...
class PacketMirroringFilter {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'direction': ?pulumi.Input.mapOptionalInputValue<PacketMirroringFilterDirection, String>(direction, (value) => value.value),
  ...
  factory PacketMirroringFilter.fromMap(Map<String, dynamic> map) {
    return PacketMirroringFilter(
      ...
      direction: map['direction'] == null ? null : (PacketMirroringFilterDirection.fromValue(map['direction']! as String)).input(),
