...
class GetImageComputeV1Result {
  ...
  factory GetImageComputeV1Result.fromMap(Map<String, dynamic> map) {
    return GetImageComputeV1Result(
      ...
      deprecated: DeprecationStatusResponseComputeV1.fromMap((map['deprecated']! as Map).cast<String, dynamic>()),
      ...
      imageEncryptionKey: CustomerEncryptionKeyResponseComputeV1.fromMap((map['imageEncryptionKey']! as Map).cast<String, dynamic>()),
      ...
      rawDisk: ImageRawDiskResponseComputeV1.fromMap((map['rawDisk']! as Map).cast<String, dynamic>()),
      satisfiesPzs: map['satisfiesPzs'] as bool,
      selfLink: map['selfLink'] as String,
      shieldedInstanceInitialState: InitialStateConfigResponseComputeV1.fromMap((map['shieldedInstanceInitialState']! as Map).cast<String, dynamic>()),
