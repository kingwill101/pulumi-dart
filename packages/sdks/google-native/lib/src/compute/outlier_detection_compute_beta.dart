...
class OutlierDetectionComputeBeta {
  ...
  factory OutlierDetectionComputeBeta.fromMap(Map<String, dynamic> map) {
    return OutlierDetectionComputeBeta(
      baseEjectionTime: map['baseEjectionTime'] == null ? null : (DurationComputeBeta.fromMap((map['baseEjectionTime'] as Map).cast<String, dynamic>())).input(),
      ...
      interval: map['interval'] == null ? null : (DurationComputeBeta.fromMap((map['interval'] as Map).cast<String, dynamic>())).input(),
