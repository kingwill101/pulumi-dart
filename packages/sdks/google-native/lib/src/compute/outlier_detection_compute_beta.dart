...
class OutlierDetectionComputeBeta {
  ...
  final pulumi.Input<DurationComputeBeta>? baseEjectionTime;
  ...
  final pulumi.Input<DurationComputeBeta>? interval;
  ...
  /// Creates a new [OutlierDetectionComputeBeta].
  ...
  const OutlierDetectionComputeBeta({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'baseEjectionTime': ?pulumi.Input.mapOptionalInputValue<DurationComputeBeta, Map<String, dynamic>>(baseEjectionTime, (value) => value.toMap()),
      ...
      'interval': ?pulumi.Input.mapOptionalInputValue<DurationComputeBeta, Map<String, dynamic>>(interval, (value) => value.toMap()),
  ...
  factory OutlierDetectionComputeBeta.fromMap(Map<String, dynamic> map) {
    return OutlierDetectionComputeBeta(
      baseEjectionTime: (() { final guardedValue = map['baseEjectionTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DurationComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      interval: (() { final guardedValue = map['interval']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DurationComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
