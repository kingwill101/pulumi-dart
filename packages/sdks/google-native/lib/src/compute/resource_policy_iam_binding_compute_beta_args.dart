...
/// {@template pulumi_compute_beta_resource_policy_iam_binding_compute_beta_args_doc}
/// The set of arguments for ResourcePolicyIamBinding.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_resource_policy_iam_binding_compute_beta_args_doc}
class ResourcePolicyIamBindingComputeBetaArgs {
  ...
  /// Creates a new [ResourcePolicyIamBindingComputeBetaArgs].
  ...
  const ResourcePolicyIamBindingComputeBetaArgs({
    this.condition,
  ...
  factory ResourcePolicyIamBindingComputeBetaArgs.fromMap(Map<String, dynamic> map) {
