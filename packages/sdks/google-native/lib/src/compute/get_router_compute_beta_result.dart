...
class GetRouterComputeBetaResult {
  ...
  final List<RouterMd5AuthenticationKeyResponseComputeBeta>
  ...
  factory GetRouterComputeBetaResult.fromMap(Map<String, dynamic> map) {
    return GetRouterComputeBetaResult(
      bgp: RouterBgpResponseComputeBeta.fromMap(
        (map['bgp']! as Map).cast<String, dynamic>(),
      ),
      bgpPeers: pulumi.Input.decodeList<RouterBgpPeerResponseComputeBeta>(
        map['bgpPeers']!,
        (value) => RouterBgpPeerResponseComputeBeta.fromMap(
      ...
      interfaces: pulumi.Input.decodeList<RouterInterfaceResponseComputeBeta>(
        map['interfaces']!,
        (value) => RouterInterfaceResponseComputeBeta.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      ...
      md5AuthenticationKeys:
          pulumi
              .Input.decodeList<RouterMd5AuthenticationKeyResponseComputeBeta>(
            map['md5AuthenticationKeys']!,
            (value) => RouterMd5AuthenticationKeyResponseComputeBeta.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      name: map['name'] as String,
      nats: pulumi.Input.decodeList<RouterNatResponseComputeBeta>(
        map['nats']!,
        (value) => RouterNatResponseComputeBeta.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
