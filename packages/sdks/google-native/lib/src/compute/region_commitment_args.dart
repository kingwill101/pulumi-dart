...
class RegionCommitmentArgs {
  ...
  RegionCommitmentArgs({
    ...
    pulumi.Output<RegionCommitmentCategory>? category,
    pulumi.Output<String>? description,
    pulumi.Output<List<String>>? existingReservations,
    pulumi.Output<LicenseResourceCommitment>? licenseResource,
    pulumi.Output<List<String>>? mergeSourceCommitments,
    pulumi.Output<String>? name,
    pulumi.Output<RegionCommitmentPlan>? plan,
    pulumi.Output<String>? project,
    required pulumi.Output<String> region,
    pulumi.Output<String>? requestId,
    pulumi.Output<List<ReservationComputeAlpha>>? reservations,
    pulumi.Output<List<ResourceCommitment>>? resources,
    pulumi.Output<String>? splitSourceCommitment,
    pulumi.Output<RegionCommitmentType>? type,
  }) :
  ...
  factory RegionCommitmentArgs.fromMap(Map<String, dynamic> map) {
    return RegionCommitmentArgs(
      ...
      category: map['category'] == null ? null : pulumi.Output.create<RegionCommitmentCategory>(RegionCommitmentCategory.fromValue(map['category'] as String)),
      description: map['description'] == null ? null : pulumi.Output.create<String>(map['description'] as String),
      existingReservations: map['existingReservations'] == null ? null : pulumi.Output.create<List<String>>((map['existingReservations'] as List).cast<String>()),
      licenseResource: map['licenseResource'] == null ? null : pulumi.Output.create<LicenseResourceCommitment>(LicenseResourceCommitment.fromMap((map['licenseResource'] as Map).cast<String, dynamic>())),
      ...
      plan: map['plan'] == null ? null : pulumi.Output.create<RegionCommitmentPlan>(RegionCommitmentPlan.fromValue(map['plan'] as String)),
      project: map['project'] == null ? null : pulumi.Output.create<String>(map['project'] as String),
      region: pulumi.Output.create<String>(map['region'] as String),
      requestId: map['requestId'] == null ? null : pulumi.Output.create<String>(map['requestId'] as String),
      reservations: map['reservations'] == null ? null : pulumi.Output.create<List<ReservationComputeAlpha>>((map['reservations'] as List).cast<ReservationComputeAlpha>()),
      resources: map['resources'] == null ? null : pulumi.Output.create<List<ResourceCommitment>>(pulumi.Input.decodeList<ResourceCommitment>(map['resources'], (value) => ResourceCommitment.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      type: map['type'] == null ? null : pulumi.Output.create<RegionCommitmentType>(RegionCommitmentType.fromValue(map['type'] as String)),
    );
  }
}
