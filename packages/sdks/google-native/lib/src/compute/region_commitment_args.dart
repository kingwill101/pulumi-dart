...
class RegionCommitmentArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'autoRenew': ?autoRenew,
      'category': ?pulumi.Input.mapOptionalInputValue<RegionCommitmentCategory, String>(category, (value) => value.wireValue),
      ...
      'name': ?name,
      'plan': ?pulumi.Input.mapOptionalInputValue<RegionCommitmentPlan, String>(plan, (value) => value.wireValue),
      'project': ?project,
      'region': region,
      'requestId': ?requestId,
      ...
      'type': ?pulumi.Input.mapOptionalInputValue<RegionCommitmentType, String>(type, (value) => value.wireValue),
    };
  }
  ...
  factory RegionCommitmentArgs.fromMap(Map<String, dynamic> map) {
    return RegionCommitmentArgs(
      ...
      category: (() { final guardedValue = map['category']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionCommitmentCategory.fromValue(guardedValue as String)); })(),
      description: (() { final guardedValue = map['description']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      existingReservations: (() { final guardedValue = map['existingReservations']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      licenseResource: (() { final guardedValue = map['licenseResource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LicenseResourceCommitment.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      plan: (() { final guardedValue = map['plan']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionCommitmentPlan.fromValue(guardedValue as String)); })(),
      project: (() { final guardedValue = map['project']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      region: pulumi.Input.fromValue(map['region'] as String),
      requestId: (() { final guardedValue = map['requestId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      reservations: (() { final guardedValue = map['reservations']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<ReservationComputeAlpha>()); })(),
      resources: (() { final guardedValue = map['resources']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ResourceCommitment>(guardedValue, (value) => ResourceCommitment.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionCommitmentType.fromValue(guardedValue as String)); })(),
    );
  }
}
