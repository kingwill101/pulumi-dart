...
class RouterNatSubnetworkToNatComputeV1 {
  ...
  const RouterNatSubnetworkToNatComputeV1({
    this.name,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'sourceIpRangesToNat': ?pulumi.Input.mapOptionalInputValue<List<RouterNatSubnetworkToNatSourceIpRangesToNatItemComputeV1>, List<String>>(sourceIpRangesToNat, (value) => pulumi.Input.encodeList<RouterNatSubnetworkToNatSourceIpRangesToNatItemComputeV1, String>(value, (value) => value.wireValue)),
    };
  }
  ...
  factory RouterNatSubnetworkToNatComputeV1.fromMap(Map<String, dynamic> map) {
    return RouterNatSubnetworkToNatComputeV1(
      ...
      sourceIpRangesToNat: (() { final guardedValue = map['sourceIpRangesToNat']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RouterNatSubnetworkToNatSourceIpRangesToNatItemComputeV1>(guardedValue, (value) => RouterNatSubnetworkToNatSourceIpRangesToNatItemComputeV1.fromValue(value as String))); })(),
    );
  }
}
