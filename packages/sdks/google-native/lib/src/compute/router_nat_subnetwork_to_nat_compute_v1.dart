...
class RouterNatSubnetworkToNatComputeV1 {
  ...
  final pulumi.Input<
    List<RouterNatSubnetworkToNatSourceIpRangesToNatItemComputeV1>
  >?
  sourceIpRangesToNat;
          ...
          >(
            ...
            (value) =>
                pulumi.Input.encodeList<
                  RouterNatSubnetworkToNatSourceIpRangesToNatItemComputeV1,
                  String
  ...
  factory RouterNatSubnetworkToNatComputeV1.fromMap(Map<String, dynamic> map) {
    return RouterNatSubnetworkToNatComputeV1(
      ...
      sourceIpRangesToNat: (() {
        final guardedValue = map['sourceIpRangesToNat'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                RouterNatSubnetworkToNatSourceIpRangesToNatItemComputeV1.fromValue(
                  value as String,
                ),
          ),
        );
