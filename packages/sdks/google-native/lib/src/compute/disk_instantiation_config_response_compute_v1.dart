...
class DiskInstantiationConfigResponseComputeV1 {
  ...
  /// Creates a new [DiskInstantiationConfigResponseComputeV1].
  ...
  const DiskInstantiationConfigResponseComputeV1({
  ...
  factory DiskInstantiationConfigResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return DiskInstantiationConfigResponseComputeV1(
      autoDelete: pulumi.Input.fromValue(map['autoDelete'] as bool),
      customImage: pulumi.Input.fromValue(map['customImage'] as String),
      deviceName: pulumi.Input.fromValue(map['deviceName'] as String),
      instantiateFrom: pulumi.Input.fromValue(map['instantiateFrom'] as String),
    );
  }
}
