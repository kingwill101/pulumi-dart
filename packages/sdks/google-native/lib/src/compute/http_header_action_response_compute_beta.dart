...
class HttpHeaderActionResponseComputeBeta {
  ...
  factory HttpHeaderActionResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return HttpHeaderActionResponseComputeBeta(
      requestHeadersToAdd: (pulumi.Input.decodeList<HttpHeaderOptionResponseComputeBeta>(map['requestHeadersToAdd'], (value) => HttpHeaderOptionResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))).input(),
      requestHeadersToRemove: ((map['requestHeadersToRemove'] as List).cast<String>()).input(),
      responseHeadersToAdd: (pulumi.Input.decodeList<HttpHeaderOptionResponseComputeBeta>(map['responseHeadersToAdd'], (value) => HttpHeaderOptionResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))).input(),
