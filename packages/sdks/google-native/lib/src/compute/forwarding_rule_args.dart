...
class ForwardingRuleArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ipProtocol': ?pulumi.Input.mapOptionalInputValue<ForwardingRuleIpProtocol, String>(ipProtocol, (value) => value.wireValue),
      'ipVersion': ?pulumi.Input.mapOptionalInputValue<ForwardingRuleIpVersion, String>(ipVersion, (value) => value.wireValue),
      'isMirroringCollector': ?isMirroringCollector,
      'labels': ?labels,
      'loadBalancingScheme': ?pulumi.Input.mapOptionalInputValue<ForwardingRuleLoadBalancingScheme, String>(loadBalancingScheme, (value) => value.wireValue),
      ...
      'name': ?name,
      'network': ?network,
      'networkTier': ?pulumi.Input.mapOptionalInputValue<ForwardingRuleNetworkTier, String>(networkTier, (value) => value.wireValue),
      'noAutomateDnsZone': ?noAutomateDnsZone,
      'portRange': ?portRange,
      'ports': ?ports,
      'project': ?project,
      'pscConnectionStatus': ?pulumi.Input.mapOptionalInputValue<ForwardingRulePscConnectionStatus, String>(pscConnectionStatus, (value) => value.wireValue),
      'region': region,
      'requestId': ?requestId,
  ...
  factory ForwardingRuleArgs.fromMap(Map<String, dynamic> map) {
    return ForwardingRuleArgs(
      ...
      ipProtocol: (() { final guardedValue = map['ipProtocol']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ForwardingRuleIpProtocol.fromValue(guardedValue as String)); })(),
      ipVersion: (() { final guardedValue = map['ipVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ForwardingRuleIpVersion.fromValue(guardedValue as String)); })(),
      ...
      loadBalancingScheme: (() { final guardedValue = map['loadBalancingScheme']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ForwardingRuleLoadBalancingScheme.fromValue(guardedValue as String)); })(),
      ...
      networkTier: (() { final guardedValue = map['networkTier']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ForwardingRuleNetworkTier.fromValue(guardedValue as String)); })(),
      ...
      pscConnectionStatus: (() { final guardedValue = map['pscConnectionStatus']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ForwardingRulePscConnectionStatus.fromValue(guardedValue as String)); })(),
