...
class ForwardingRuleArgs {
  ...
  factory ForwardingRuleArgs.fromMap(Map<String, dynamic> map) {
    return ForwardingRuleArgs(
      ...
      ipProtocol: map['ipProtocol'] == null ? null : (ForwardingRuleIpProtocol.fromValue(map['ipProtocol'] as String)).input(),
      ipVersion: map['ipVersion'] == null ? null : (ForwardingRuleIpVersion.fromValue(map['ipVersion'] as String)).input(),
      isMirroringCollector: map['isMirroringCollector'] == null ? null : (map['isMirroringCollector'] as bool).input(),
      labels: map['labels'] == null ? null : ((map['labels'] as Map).cast<String, String>()).input(),
      loadBalancingScheme: map['loadBalancingScheme'] == null ? null : (ForwardingRuleLoadBalancingScheme.fromValue(map['loadBalancingScheme'] as String)).input(),
      ...
      networkTier: map['networkTier'] == null ? null : (ForwardingRuleNetworkTier.fromValue(map['networkTier'] as String)).input(),
      ...
      pscConnectionStatus: map['pscConnectionStatus'] == null ? null : (ForwardingRulePscConnectionStatus.fromValue(map['pscConnectionStatus'] as String)).input(),
