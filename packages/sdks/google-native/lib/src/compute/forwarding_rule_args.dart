...
/// {@template pulumi_compute_alpha_forwarding_rule_args_doc}
/// The set of arguments for ForwardingRule.
/// {@endtemplate}
/// {@macro pulumi_compute_alpha_forwarding_rule_args_doc}
class ForwardingRuleArgs {
  ...
  ForwardingRuleArgs({
    ...
    pulumi.Output<ForwardingRuleIpProtocol>? ipProtocol,
    pulumi.Output<ForwardingRuleIpVersion>? ipVersion,
    pulumi.Output<bool>? isMirroringCollector,
    pulumi.Output<Map<String, String>>? labels,
    pulumi.Output<ForwardingRuleLoadBalancingScheme>? loadBalancingScheme,
    pulumi.Output<List<MetadataFilter>>? metadataFilters,
    pulumi.Output<String>? name,
    pulumi.Output<String>? network,
    pulumi.Output<ForwardingRuleNetworkTier>? networkTier,
    pulumi.Output<bool>? noAutomateDnsZone,
    pulumi.Output<String>? portRange,
    pulumi.Output<List<String>>? ports,
    pulumi.Output<String>? project,
    pulumi.Output<ForwardingRulePscConnectionStatus>? pscConnectionStatus,
    ...
    pulumi.Output<String>? target,
      ...
      ipProtocol = pulumi.Input.asOptionalInput<ForwardingRuleIpProtocol>(ipProtocol),
      ipVersion = pulumi.Input.asOptionalInput<ForwardingRuleIpVersion>(ipVersion),
      isMirroringCollector = pulumi.Input.asOptionalInput<bool>(isMirroringCollector),
      labels = pulumi.Input.asOptionalInput<Map<String, String>>(labels),
      loadBalancingScheme = pulumi.Input.asOptionalInput<ForwardingRuleLoadBalancingScheme>(loadBalancingScheme),
      metadataFilters = pulumi.Input.asOptionalInput<List<MetadataFilter>>(metadataFilters),
      name = pulumi.Input.asOptionalInput<String>(name),
      network = pulumi.Input.asOptionalInput<String>(network),
      networkTier = pulumi.Input.asOptionalInput<ForwardingRuleNetworkTier>(networkTier),
      ...
      pscConnectionStatus = pulumi.Input.asOptionalInput<ForwardingRulePscConnectionStatus>(pscConnectionStatus),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ipProtocol': ?pulumi.Input.mapOptionalInputValue<ForwardingRuleIpProtocol, String>(ipProtocol, (value) => value.value),
      'ipVersion': ?pulumi.Input.mapOptionalInputValue<ForwardingRuleIpVersion, String>(ipVersion, (value) => value.value),
      'isMirroringCollector': ?isMirroringCollector,
      'labels': ?labels,
      'loadBalancingScheme': ?pulumi.Input.mapOptionalInputValue<ForwardingRuleLoadBalancingScheme, String>(loadBalancingScheme, (value) => value.value),
      ...
      'name': ?name,
      'network': ?network,
      'networkTier': ?pulumi.Input.mapOptionalInputValue<ForwardingRuleNetworkTier, String>(networkTier, (value) => value.value),
      'noAutomateDnsZone': ?noAutomateDnsZone,
      'portRange': ?portRange,
      'ports': ?ports,
      'project': ?project,
      'pscConnectionStatus': ?pulumi.Input.mapOptionalInputValue<ForwardingRulePscConnectionStatus, String>(pscConnectionStatus, (value) => value.value),
      'region': region,
      'requestId': ?requestId,
  ...
  factory ForwardingRuleArgs.fromMap(Map<String, dynamic> map) {
    return ForwardingRuleArgs(
      ...
      ipProtocol: map['ipProtocol'] == null ? null : pulumi.Output.create<ForwardingRuleIpProtocol>(ForwardingRuleIpProtocol.fromValue(map['ipProtocol'] as String)),
      ipVersion: map['ipVersion'] == null ? null : pulumi.Output.create<ForwardingRuleIpVersion>(ForwardingRuleIpVersion.fromValue(map['ipVersion'] as String)),
      ...
      loadBalancingScheme: map['loadBalancingScheme'] == null ? null : pulumi.Output.create<ForwardingRuleLoadBalancingScheme>(ForwardingRuleLoadBalancingScheme.fromValue(map['loadBalancingScheme'] as String)),
      ...
      networkTier: map['networkTier'] == null ? null : pulumi.Output.create<ForwardingRuleNetworkTier>(ForwardingRuleNetworkTier.fromValue(map['networkTier'] as String)),
      ...
      pscConnectionStatus: map['pscConnectionStatus'] == null ? null : pulumi.Output.create<ForwardingRulePscConnectionStatus>(ForwardingRulePscConnectionStatus.fromValue(map['pscConnectionStatus'] as String)),
