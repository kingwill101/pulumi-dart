...
class GetReservationComputeV1Result {
  ...
  /// Creates a new [GetReservationComputeV1Result].
  ...
  const GetReservationComputeV1Result({
  ...
  factory GetReservationComputeV1Result.fromMap(Map<String, dynamic> map) {
    return GetReservationComputeV1Result(
      ...
      resourceStatus: AllocationResourceStatusResponseComputeV1.fromMap((map['resourceStatus']! as Map).cast<String, dynamic>()),
      ...
      specificReservation: AllocationSpecificSKUReservationResponseComputeV1.fromMap((map['specificReservation']! as Map).cast<String, dynamic>()),
