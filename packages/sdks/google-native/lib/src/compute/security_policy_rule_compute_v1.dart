...
class SecurityPolicyRuleComputeV1 {
  ...
  final SecurityPolicyRulePreconfiguredWafConfigComputeV1? preconfiguredWafConfig;
  ...
  factory SecurityPolicyRuleComputeV1.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRuleComputeV1(
      ...
      headerAction: map['headerAction'] == null ? null : SecurityPolicyRuleHttpHeaderActionComputeV1.fromMap((map['headerAction'] as Map).cast<String, dynamic>()),
      match: map['match'] == null ? null : SecurityPolicyRuleMatcherComputeV1.fromMap((map['match'] as Map).cast<String, dynamic>()),
      networkMatch: map['networkMatch'] == null ? null : SecurityPolicyRuleNetworkMatcherComputeV1.fromMap((map['networkMatch'] as Map).cast<String, dynamic>()),
      preconfiguredWafConfig: map['preconfiguredWafConfig'] == null ? null : SecurityPolicyRulePreconfiguredWafConfigComputeV1.fromMap((map['preconfiguredWafConfig'] as Map).cast<String, dynamic>()),
      preview: map['preview'] == null ? null : map['preview'] as bool,
      priority: map['priority'] == null ? null : map['priority'] as int,
      rateLimitOptions: map['rateLimitOptions'] == null ? null : SecurityPolicyRuleRateLimitOptionsComputeV1.fromMap((map['rateLimitOptions'] as Map).cast<String, dynamic>()),
      redirectOptions: map['redirectOptions'] == null ? null : SecurityPolicyRuleRedirectOptionsComputeV1.fromMap((map['redirectOptions'] as Map).cast<String, dynamic>()),
    );
  }
}
