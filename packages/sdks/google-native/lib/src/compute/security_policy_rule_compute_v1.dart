...
class SecurityPolicyRuleComputeV1 {
  ...
  final pulumi.Input<SecurityPolicyRulePreconfiguredWafConfigComputeV1>?
  ...
  final pulumi.Input<SecurityPolicyRuleRateLimitOptionsComputeV1>?
  rateLimitOptions;
  ...
  factory SecurityPolicyRuleComputeV1.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRuleComputeV1(
      ...
      networkMatch: (() {
        final guardedValue = map['networkMatch'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      preconfiguredWafConfig: (() {
        final guardedValue = map['preconfiguredWafConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      rateLimitOptions: (() {
        final guardedValue = map['rateLimitOptions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      redirectOptions: (() {
        final guardedValue = map['redirectOptions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
