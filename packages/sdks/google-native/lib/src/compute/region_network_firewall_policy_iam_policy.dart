...
class RegionNetworkFirewallPolicyIamPolicy extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [RegionNetworkFirewallPolicyIamPolicy]. {@macro pulumi_compute_alpha_region_network_firewall_policy_iam_policy_args_doc}
