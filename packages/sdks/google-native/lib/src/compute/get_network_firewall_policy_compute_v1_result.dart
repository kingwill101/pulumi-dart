...
class GetNetworkFirewallPolicyComputeV1Result {
  ...
  /// Creates a new [GetNetworkFirewallPolicyComputeV1Result].
  ...
  const GetNetworkFirewallPolicyComputeV1Result({
  ...
  factory GetNetworkFirewallPolicyComputeV1Result.fromMap(Map<String, dynamic> map) {
