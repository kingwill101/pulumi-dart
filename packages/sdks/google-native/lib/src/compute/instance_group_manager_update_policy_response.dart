...
class InstanceGroupManagerUpdatePolicyResponse {
  ...
  final pulumi.Input<FixedOrPercentResponse> maxSurge;
  ...
  /// Creates a new [InstanceGroupManagerUpdatePolicyResponse].
  ...
  const InstanceGroupManagerUpdatePolicyResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'maxSurge': pulumi.Input.mapInputValue<FixedOrPercentResponse, Map<String, dynamic>>(maxSurge, (value) => value.toMap()),
  ...
  factory InstanceGroupManagerUpdatePolicyResponse.fromMap(Map<String, dynamic> map) {
    return InstanceGroupManagerUpdatePolicyResponse(
      instanceRedistributionType: pulumi.Input.fromValue(map['instanceRedistributionType'] as String),
      maxSurge: pulumi.Input.fromValue(FixedOrPercentResponse.fromMap((map['maxSurge']! as Map).cast<String, dynamic>())),
