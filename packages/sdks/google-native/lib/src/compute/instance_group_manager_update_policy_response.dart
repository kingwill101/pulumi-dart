...
class InstanceGroupManagerUpdatePolicyResponse {
  ...
  factory InstanceGroupManagerUpdatePolicyResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return InstanceGroupManagerUpdatePolicyResponse(
      instanceRedistributionType: pulumi.Input.fromValue(
        map['instanceRedistributionType'] as String,
      ),
      maxSurge: pulumi.Input.fromValue(
      ...
      mostDisruptiveAllowedAction: pulumi.Input.fromValue(
        map['mostDisruptiveAllowedAction'] as String,
      ),
      replacementMethod: pulumi.Input.fromValue(
