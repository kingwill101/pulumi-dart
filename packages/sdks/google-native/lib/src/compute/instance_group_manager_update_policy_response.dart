...
class InstanceGroupManagerUpdatePolicyResponse {
  ...
  factory InstanceGroupManagerUpdatePolicyResponse.fromMap(Map<String, dynamic> map) {
    return InstanceGroupManagerUpdatePolicyResponse(
      instanceRedistributionType: (map['instanceRedistributionType'] as String).input(),
      maxSurge: (FixedOrPercentResponse.fromMap((map['maxSurge'] as Map).cast<String, dynamic>())).input(),
      maxUnavailable: (FixedOrPercentResponse.fromMap((map['maxUnavailable'] as Map).cast<String, dynamic>())).input(),
