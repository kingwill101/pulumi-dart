...
/// {@template pulumi_compute_beta_node_group_iam_member_compute_beta_args_doc}
/// The set of arguments for NodeGroupIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_node_group_iam_member_compute_beta_args_doc}
class NodeGroupIamMemberComputeBetaArgs {
  ...
  /// Creates a new [NodeGroupIamMemberComputeBetaArgs].
  ...
  const NodeGroupIamMemberComputeBetaArgs({
    this.condition,
  ...
  factory NodeGroupIamMemberComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return NodeGroupIamMemberComputeBetaArgs(
