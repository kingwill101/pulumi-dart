...
class HttpHeaderMatch {
  ...
  factory HttpHeaderMatch.fromMap(Map<String, dynamic> map) {
    return HttpHeaderMatch(
      ...
      rangeMatch: (() { final guardedValue = map['rangeMatch']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Int64RangeMatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
