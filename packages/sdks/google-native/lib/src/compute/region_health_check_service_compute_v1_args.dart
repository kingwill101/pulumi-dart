...
class RegionHealthCheckServiceComputeV1Args {
  ...
  const RegionHealthCheckServiceComputeV1Args({
    this.description,
    this.healthChecks,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'healthStatusAggregationPolicy': ?pulumi.Input.mapOptionalInputValue<RegionHealthCheckServiceHealthStatusAggregationPolicyComputeV1, String>(healthStatusAggregationPolicy, (value) => value.wireValue),
      'name': ?name,
  ...
  factory RegionHealthCheckServiceComputeV1Args.fromMap(Map<String, dynamic> map) {
    return RegionHealthCheckServiceComputeV1Args(
      ...
      healthStatusAggregationPolicy: (() { final guardedValue = map['healthStatusAggregationPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionHealthCheckServiceHealthStatusAggregationPolicyComputeV1.fromValue(guardedValue as String)); })(),
