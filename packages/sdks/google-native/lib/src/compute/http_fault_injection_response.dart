...
class HttpFaultInjectionResponse {
  ...
  factory HttpFaultInjectionResponse.fromMap(Map<String, dynamic> map) {
    return HttpFaultInjectionResponse(
      abort: pulumi.Input.fromValue(HttpFaultAbortResponse.fromMap((map['abort']! as Map).cast<String, dynamic>())),
      delay: pulumi.Input.fromValue(HttpFaultDelayResponse.fromMap((map['delay']! as Map).cast<String, dynamic>())),
    );
  }
}
