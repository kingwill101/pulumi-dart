    ...
    return <String, dynamic>{
      ...
      'linkType':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(linkType, (value) => value.wireValue),
      'location': ?location,
      'macsec':
          ?pulumi.Input.mapOptionalInputValue<
  ...
  factory InterconnectComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return InterconnectComputeBetaArgs(
      ...
      linkType: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          InterconnectLinkTypeComputeBeta.fromValue(guardedValue as String),
        );
      })(),
      location: (() {
      ...
      requestedFeatures: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InterconnectRequestedFeaturesItemComputeBeta>(
            guardedValue,
