...
class InterconnectComputeBetaArgs {
  ...
  factory InterconnectComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return InterconnectComputeBetaArgs(
      ...
      interconnectType: map['interconnectType'] == null ? null : (InterconnectInterconnectTypeComputeBeta.fromValue(map['interconnectType'] as String)).input(),
      labels: map['labels'] == null ? null : ((map['labels'] as Map).cast<String, String>()).input(),
      linkType: map['linkType'] == null ? null : (InterconnectLinkTypeComputeBeta.fromValue(map['linkType'] as String)).input(),
      location: map['location'] == null ? null : (map['location'] as String).input(),
      macsec: map['macsec'] == null ? null : (InterconnectMacsecComputeBeta.fromMap((map['macsec'] as Map).cast<String, dynamic>())).input(),
      ...
      requestedFeatures: map['requestedFeatures'] == null ? null : (pulumi.Input.decodeList<InterconnectRequestedFeaturesItemComputeBeta>(map['requestedFeatures'], (value) => InterconnectRequestedFeaturesItemComputeBeta.fromValue(value as String))).input(),
