...
class InterconnectComputeBetaArgs {
  ...
  final pulumi.Input<List<InterconnectRequestedFeaturesItemComputeBeta>>? requestedFeatures;
  ...
  InterconnectComputeBetaArgs({
    ...
    pulumi.Output<InterconnectInterconnectTypeComputeBeta>? interconnectType,
    pulumi.Output<Map<String, String>>? labels,
    pulumi.Output<InterconnectLinkTypeComputeBeta>? linkType,
    pulumi.Output<String>? location,
    pulumi.Output<InterconnectMacsecComputeBeta>? macsec,
    ...
    pulumi.Output<List<InterconnectRequestedFeaturesItemComputeBeta>>? requestedFeatures,
    pulumi.Output<int>? requestedLinkCount,
      ...
      interconnectType = pulumi.Input.asOptionalInput<InterconnectInterconnectTypeComputeBeta>(interconnectType),
      labels = pulumi.Input.asOptionalInput<Map<String, String>>(labels),
      linkType = pulumi.Input.asOptionalInput<InterconnectLinkTypeComputeBeta>(linkType),
      location = pulumi.Input.asOptionalInput<String>(location),
      macsec = pulumi.Input.asOptionalInput<InterconnectMacsecComputeBeta>(macsec),
      ...
      requestedFeatures = pulumi.Input.asOptionalInput<List<InterconnectRequestedFeaturesItemComputeBeta>>(requestedFeatures),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'interconnectType': ?pulumi.Input.mapOptionalInputValue<InterconnectInterconnectTypeComputeBeta, String>(interconnectType, (value) => value.value),
      'labels': ?labels,
      'linkType': ?pulumi.Input.mapOptionalInputValue<InterconnectLinkTypeComputeBeta, String>(linkType, (value) => value.value),
      'location': ?location,
      'macsec': ?pulumi.Input.mapOptionalInputValue<InterconnectMacsecComputeBeta, Map<String, dynamic>>(macsec, (value) => value.toMap()),
      ...
      'requestId': ?requestId,
      'requestedFeatures': ?pulumi.Input.mapOptionalInputValue<List<InterconnectRequestedFeaturesItemComputeBeta>, List<String>>(requestedFeatures, (value) => pulumi.Input.encodeList<InterconnectRequestedFeaturesItemComputeBeta, String>(value, (value) => value.value)),
  ...
  factory InterconnectComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return InterconnectComputeBetaArgs(
      ...
      interconnectType: map['interconnectType'] == null ? null : pulumi.Output.create<InterconnectInterconnectTypeComputeBeta>(InterconnectInterconnectTypeComputeBeta.fromValue(map['interconnectType'] as String)),
      labels: map['labels'] == null ? null : pulumi.Output.create<Map<String, String>>((map['labels'] as Map).cast<String, String>()),
      linkType: map['linkType'] == null ? null : pulumi.Output.create<InterconnectLinkTypeComputeBeta>(InterconnectLinkTypeComputeBeta.fromValue(map['linkType'] as String)),
      location: map['location'] == null ? null : pulumi.Output.create<String>(map['location'] as String),
      macsec: map['macsec'] == null ? null : pulumi.Output.create<InterconnectMacsecComputeBeta>(InterconnectMacsecComputeBeta.fromMap((map['macsec'] as Map).cast<String, dynamic>())),
      ...
      requestedFeatures: map['requestedFeatures'] == null ? null : pulumi.Output.create<List<InterconnectRequestedFeaturesItemComputeBeta>>(pulumi.Input.decodeList<InterconnectRequestedFeaturesItemComputeBeta>(map['requestedFeatures'], (value) => InterconnectRequestedFeaturesItemComputeBeta.fromValue(value as String))),
