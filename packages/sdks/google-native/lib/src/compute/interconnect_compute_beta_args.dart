...
class InterconnectComputeBetaArgs {
  ...
  const InterconnectComputeBetaArgs({
    this.adminEnabled,
    this.customerName,
    this.description,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'interconnectType': ?pulumi.Input.mapOptionalInputValue<InterconnectInterconnectTypeComputeBeta, String>(interconnectType, (value) => value.wireValue),
      'labels': ?labels,
      'linkType': ?pulumi.Input.mapOptionalInputValue<InterconnectLinkTypeComputeBeta, String>(linkType, (value) => value.wireValue),
      'location': ?location,
      ...
      'requestId': ?requestId,
      'requestedFeatures': ?pulumi.Input.mapOptionalInputValue<List<InterconnectRequestedFeaturesItemComputeBeta>, List<String>>(requestedFeatures, (value) => pulumi.Input.encodeList<InterconnectRequestedFeaturesItemComputeBeta, String>(value, (value) => value.wireValue)),
  ...
  factory InterconnectComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return InterconnectComputeBetaArgs(
      ...
      interconnectType: (() { final guardedValue = map['interconnectType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InterconnectInterconnectTypeComputeBeta.fromValue(guardedValue as String)); })(),
      labels: (() { final guardedValue = map['labels']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      linkType: (() { final guardedValue = map['linkType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InterconnectLinkTypeComputeBeta.fromValue(guardedValue as String)); })(),
      location: (() { final guardedValue = map['location']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      macsec: (() { final guardedValue = map['macsec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InterconnectMacsecComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      requestedFeatures: (() { final guardedValue = map['requestedFeatures']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InterconnectRequestedFeaturesItemComputeBeta>(guardedValue, (value) => InterconnectRequestedFeaturesItemComputeBeta.fromValue(value as String))); })(),
