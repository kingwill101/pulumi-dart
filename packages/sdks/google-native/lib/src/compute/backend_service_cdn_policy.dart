...
class BackendServiceCdnPolicy {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'cacheMode': ?pulumi.Input.mapOptionalInputValue<BackendServiceCdnPolicyCacheMode, String>(cacheMode, (value) => value.value),
      'clientTtl': ?clientTtl,
  ...
  factory BackendServiceCdnPolicy.fromMap(Map<String, dynamic> map) {
    return BackendServiceCdnPolicy(
      ...
      cacheKeyPolicy: map['cacheKeyPolicy'] == null ? null : (CacheKeyPolicy.fromMap((map['cacheKeyPolicy']! as Map).cast<String, dynamic>())).input(),
      cacheMode: map['cacheMode'] == null ? null : (BackendServiceCdnPolicyCacheMode.fromValue(map['cacheMode']! as String)).input(),
      ...
      negativeCachingPolicy: map['negativeCachingPolicy'] == null ? null : (pulumi.Input.decodeList<BackendServiceCdnPolicyNegativeCachingPolicy>(map['negativeCachingPolicy']!, (value) => BackendServiceCdnPolicyNegativeCachingPolicy.fromMap((value as Map).cast<String, dynamic>()))).input(),
