...
class BackendServiceCdnPolicy {
  ...
  final pulumi.Input<CacheKeyPolicy>? cacheKeyPolicy;
  ...
  final pulumi.Input<BackendServiceCdnPolicyCacheMode>? cacheMode;
  ...
  final pulumi.Input<List<BackendServiceCdnPolicyNegativeCachingPolicy>>? negativeCachingPolicy;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'cacheKeyPolicy': ?pulumi.Input.mapOptionalInputValue<CacheKeyPolicy, Map<String, dynamic>>(cacheKeyPolicy, (value) => value.toMap()),
      'cacheMode': ?pulumi.Input.mapOptionalInputValue<BackendServiceCdnPolicyCacheMode, String>(cacheMode, (value) => value.wireValue),
      'clientTtl': ?clientTtl,
      'defaultTtl': ?defaultTtl,
      'maxTtl': ?maxTtl,
      'negativeCaching': ?negativeCaching,
      'negativeCachingPolicy': ?pulumi.Input.mapOptionalInputValue<List<BackendServiceCdnPolicyNegativeCachingPolicy>, List<Map<String, dynamic>>>(negativeCachingPolicy, (value) => pulumi.Input.encodeList<BackendServiceCdnPolicyNegativeCachingPolicy, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory BackendServiceCdnPolicy.fromMap(Map<String, dynamic> map) {
    return BackendServiceCdnPolicy(
      ...
      cacheKeyPolicy: (() { final guardedValue = map['cacheKeyPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CacheKeyPolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      cacheMode: (() { final guardedValue = map['cacheMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BackendServiceCdnPolicyCacheMode.fromValue(guardedValue as String)); })(),
      ...
      negativeCachingPolicy: (() { final guardedValue = map['negativeCachingPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<BackendServiceCdnPolicyNegativeCachingPolicy>(guardedValue, (value) => BackendServiceCdnPolicyNegativeCachingPolicy.fromMap((value as Map).cast<String, dynamic>()))); })(),
