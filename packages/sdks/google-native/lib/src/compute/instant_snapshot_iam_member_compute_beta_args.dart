...
/// {@template pulumi_compute_beta_instant_snapshot_iam_member_compute_beta_args_doc}
/// The set of arguments for InstantSnapshotIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_instant_snapshot_iam_member_compute_beta_args_doc}
class InstantSnapshotIamMemberComputeBetaArgs {
  ...
  /// Creates a new [InstantSnapshotIamMemberComputeBetaArgs].
  ...
  const InstantSnapshotIamMemberComputeBetaArgs({
    this.condition,
  ...
  factory InstantSnapshotIamMemberComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return InstantSnapshotIamMemberComputeBetaArgs(
