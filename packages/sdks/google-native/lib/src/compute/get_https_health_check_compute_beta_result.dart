...
class GetHttpsHealthCheckComputeBetaResult {
  ...
  /// Creates a new [GetHttpsHealthCheckComputeBetaResult].
  ...
  const GetHttpsHealthCheckComputeBetaResult({
  ...
  factory GetHttpsHealthCheckComputeBetaResult.fromMap(Map<String, dynamic> map) {
    return GetHttpsHealthCheckComputeBetaResult(
