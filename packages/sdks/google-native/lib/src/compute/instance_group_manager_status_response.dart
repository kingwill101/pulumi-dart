...
class InstanceGroupManagerStatusResponse {
  ...
  final pulumi.Input<InstanceGroupManagerStatusAllInstancesConfigResponse>
  allInstancesConfig;
  ...
  final pulumi.Input<InstanceGroupManagerStatusVersionTargetResponse>
  versionTarget;
  ...
  factory InstanceGroupManagerStatusResponse.fromMap(Map<String, dynamic> map) {
    return InstanceGroupManagerStatusResponse(
      ...
      stateful: pulumi.Input.fromValue(
        InstanceGroupManagerStatusStatefulResponse.fromMap(
          (map['stateful']! as Map).cast<String, dynamic>(),
        ),
      ),
      versionTarget: pulumi.Input.fromValue(
        InstanceGroupManagerStatusVersionTargetResponse.fromMap(
