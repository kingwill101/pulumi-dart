...
class InstanceGroupManagerStatusResponse {
  ...
  factory InstanceGroupManagerStatusResponse.fromMap(Map<String, dynamic> map) {
    return InstanceGroupManagerStatusResponse(
      allInstancesConfig: (InstanceGroupManagerStatusAllInstancesConfigResponse.fromMap((map['allInstancesConfig'] as Map).cast<String, dynamic>())).input(),
      autoscaler: (map['autoscaler'] as String).input(),
      isStable: (map['isStable'] as bool).input(),
      stateful: (InstanceGroupManagerStatusStatefulResponse.fromMap((map['stateful'] as Map).cast<String, dynamic>())).input(),
      versionTarget: (InstanceGroupManagerStatusVersionTargetResponse.fromMap((map['versionTarget'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
