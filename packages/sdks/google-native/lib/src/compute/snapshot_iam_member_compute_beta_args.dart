...
/// {@template pulumi_compute_beta_snapshot_iam_member_compute_beta_args_doc}
/// The set of arguments for SnapshotIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_snapshot_iam_member_compute_beta_args_doc}
class SnapshotIamMemberComputeBetaArgs {
  ...
  /// Creates a new [SnapshotIamMemberComputeBetaArgs].
  ...
  const SnapshotIamMemberComputeBetaArgs({
    this.condition,
  ...
  factory SnapshotIamMemberComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return SnapshotIamMemberComputeBetaArgs(
