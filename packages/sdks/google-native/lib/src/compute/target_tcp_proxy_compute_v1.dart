...
import 'target_tcp_proxy_compute_v1_args.dart';

/// Creates a TargetTcpProxy resource in the specified project using the data included in the request.
class TargetTcpProxyComputeV1 extends pulumi.CustomResource {
  ...
  /// Creates a new [TargetTcpProxyComputeV1].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [TargetTcpProxyComputeV1]. {@macro pulumi_compute_v1_target_tcp_proxy_compute_v1_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  TargetTcpProxyComputeV1(
    String name, {
    TargetTcpProxyComputeV1Args? args,
