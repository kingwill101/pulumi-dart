...
/// {@template pulumi_compute_beta_service_attachment_iam_member_compute_beta_args_doc}
/// The set of arguments for ServiceAttachmentIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_service_attachment_iam_member_compute_beta_args_doc}
class ServiceAttachmentIamMemberComputeBetaArgs {
  ...
  /// Creates a new [ServiceAttachmentIamMemberComputeBetaArgs].
  ...
  const ServiceAttachmentIamMemberComputeBetaArgs({
    this.condition,
  ...
  factory ServiceAttachmentIamMemberComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return ServiceAttachmentIamMemberComputeBetaArgs(
