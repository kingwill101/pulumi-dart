...
/// {@template pulumi_compute_v1_region_autoscaler_compute_v1_args_doc}
/// The set of arguments for RegionAutoscaler.
/// {@endtemplate}
/// {@macro pulumi_compute_v1_region_autoscaler_compute_v1_args_doc}
class RegionAutoscalerComputeV1Args {
  ...
  /// Creates a new [RegionAutoscalerComputeV1Args].
  ...
  const RegionAutoscalerComputeV1Args({
  ...
  factory RegionAutoscalerComputeV1Args.fromMap(Map<String, dynamic> map) {
    return RegionAutoscalerComputeV1Args(
      autoscalingPolicy: (() { final guardedValue = map['autoscalingPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AutoscalingPolicyComputeV1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
