...
class GetRegionInstanceTemplateComputeBetaResult {
  ...
  const GetRegionInstanceTemplateComputeBetaResult({
  ...
  factory GetRegionInstanceTemplateComputeBetaResult.fromMap(Map<String, dynamic> map) {
    return GetRegionInstanceTemplateComputeBetaResult(
      creationTimestamp: map['creationTimestamp'] as String,
      description: map['description'] as String,
      kind: map['kind'] as String,
      name: map['name'] as String,
      properties: InstancePropertiesResponseComputeBeta.fromMap((map['properties']! as Map).cast<String, dynamic>()),
      region: map['region'] as String,
      selfLink: map['selfLink'] as String,
      sourceInstance: map['sourceInstance'] as String,
      sourceInstanceParams: SourceInstanceParamsResponseComputeBeta.fromMap((map['sourceInstanceParams']! as Map).cast<String, dynamic>()),
    );
  }
}
