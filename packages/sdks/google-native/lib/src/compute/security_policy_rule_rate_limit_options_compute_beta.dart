...
class SecurityPolicyRuleRateLimitOptionsComputeBeta {
  ...
  final pulumi.Input<SecurityPolicyRuleRateLimitOptionsThresholdComputeBeta>?
  banThreshold;
  ...
  final pulumi.Input<SecurityPolicyRuleRateLimitOptionsEnforceOnKeyComputeBeta>?
  enforceOnKey;
  ...
  final pulumi.Input<SecurityPolicyRuleRedirectOptionsComputeBeta>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'enforceOnKey':
          ?pulumi.Input.mapOptionalInputValue<
            SecurityPolicyRuleRateLimitOptionsEnforceOnKeyComputeBeta,
            String
      ...
      enforceOnKeyConfigs: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigComputeBeta.fromMap(
