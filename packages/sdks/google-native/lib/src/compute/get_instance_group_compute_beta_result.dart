...
class GetInstanceGroupComputeBetaResult {
  ...
  /// Creates a new [GetInstanceGroupComputeBetaResult].
  ...
  const GetInstanceGroupComputeBetaResult({
  ...
  factory GetInstanceGroupComputeBetaResult.fromMap(Map<String, dynamic> map) {
    return GetInstanceGroupComputeBetaResult(
