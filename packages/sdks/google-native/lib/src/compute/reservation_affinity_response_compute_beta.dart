...
class ReservationAffinityResponseComputeBeta {
  ...
  /// Creates a new [ReservationAffinityResponseComputeBeta].
  ...
  const ReservationAffinityResponseComputeBeta({
  ...
  factory ReservationAffinityResponseComputeBeta.fromMap(Map<String, dynamic> map) {
