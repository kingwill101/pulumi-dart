...
class RegionBackendServiceComputeV1Args {
  ...
  RegionBackendServiceComputeV1Args({
    ...
    pulumi.Output<RegionBackendServiceCompressionModeComputeV1>? compressionMode,
    ...
    pulumi.Output<RegionBackendServiceLoadBalancingSchemeComputeV1>? loadBalancingScheme,
    pulumi.Output<List<BackendServiceLocalityLoadBalancingPolicyConfigComputeV1>>? localityLbPolicies,
    pulumi.Output<RegionBackendServiceLocalityLbPolicyComputeV1>? localityLbPolicy,
    ...
    pulumi.Output<RegionBackendServiceProtocolComputeV1>? protocol,
    required pulumi.Output<String> region,
    pulumi.Output<String>? requestId,
    pulumi.Output<SecuritySettingsComputeV1>? securitySettings,
    pulumi.Output<List<String>>? serviceBindings,
    pulumi.Output<RegionBackendServiceSessionAffinityComputeV1>? sessionAffinity,
    ...
    pulumi.Output<List<BackendServiceUsedByComputeV1>>? usedBy,
      ...
      compressionMode = pulumi.Input.asOptionalInput<RegionBackendServiceCompressionModeComputeV1>(compressionMode),
      ...
      loadBalancingScheme = pulumi.Input.asOptionalInput<RegionBackendServiceLoadBalancingSchemeComputeV1>(loadBalancingScheme),
      ...
      localityLbPolicy = pulumi.Input.asOptionalInput<RegionBackendServiceLocalityLbPolicyComputeV1>(localityLbPolicy),
      ...
      protocol = pulumi.Input.asOptionalInput<RegionBackendServiceProtocolComputeV1>(protocol),
      ...
      sessionAffinity = pulumi.Input.asOptionalInput<RegionBackendServiceSessionAffinityComputeV1>(sessionAffinity),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'compressionMode': ?pulumi.Input.mapOptionalInputValue<RegionBackendServiceCompressionModeComputeV1, String>(compressionMode, (value) => value.value),
      ...
      'loadBalancingScheme': ?pulumi.Input.mapOptionalInputValue<RegionBackendServiceLoadBalancingSchemeComputeV1, String>(loadBalancingScheme, (value) => value.value),
      ...
      'localityLbPolicy': ?pulumi.Input.mapOptionalInputValue<RegionBackendServiceLocalityLbPolicyComputeV1, String>(localityLbPolicy, (value) => value.value),
      ...
      'portName': ?portName,
      'project': ?project,
      'protocol': ?pulumi.Input.mapOptionalInputValue<RegionBackendServiceProtocolComputeV1, String>(protocol, (value) => value.value),
      'region': region,
      'requestId': ?requestId,
      ...
      'sessionAffinity': ?pulumi.Input.mapOptionalInputValue<RegionBackendServiceSessionAffinityComputeV1, String>(sessionAffinity, (value) => value.value),
  ...
  factory RegionBackendServiceComputeV1Args.fromMap(Map<String, dynamic> map) {
    return RegionBackendServiceComputeV1Args(
      ...
      compressionMode: map['compressionMode'] == null ? null : pulumi.Output.create<RegionBackendServiceCompressionModeComputeV1>(RegionBackendServiceCompressionModeComputeV1.fromValue(map['compressionMode'] as String)),
      ...
      loadBalancingScheme: map['loadBalancingScheme'] == null ? null : pulumi.Output.create<RegionBackendServiceLoadBalancingSchemeComputeV1>(RegionBackendServiceLoadBalancingSchemeComputeV1.fromValue(map['loadBalancingScheme'] as String)),
      ...
      localityLbPolicy: map['localityLbPolicy'] == null ? null : pulumi.Output.create<RegionBackendServiceLocalityLbPolicyComputeV1>(RegionBackendServiceLocalityLbPolicyComputeV1.fromValue(map['localityLbPolicy'] as String)),
      ...
      protocol: map['protocol'] == null ? null : pulumi.Output.create<RegionBackendServiceProtocolComputeV1>(RegionBackendServiceProtocolComputeV1.fromValue(map['protocol'] as String)),
      ...
      sessionAffinity: map['sessionAffinity'] == null ? null : pulumi.Output.create<RegionBackendServiceSessionAffinityComputeV1>(RegionBackendServiceSessionAffinityComputeV1.fromValue(map['sessionAffinity'] as String)),
