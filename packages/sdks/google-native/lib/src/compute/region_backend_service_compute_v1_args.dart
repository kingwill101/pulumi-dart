...
class RegionBackendServiceComputeV1Args {
  ...
  final pulumi.Input<RegionBackendServiceCompressionModeComputeV1>? compressionMode;
  ...
  final pulumi.Input<RegionBackendServiceLoadBalancingSchemeComputeV1>? loadBalancingScheme;
  ...
  final pulumi.Input<RegionBackendServiceLocalityLbPolicyComputeV1>? localityLbPolicy;
  ...
  final pulumi.Input<RegionBackendServiceSessionAffinityComputeV1>? sessionAffinity;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'compressionMode': ?pulumi.Input.mapOptionalInputValue<RegionBackendServiceCompressionModeComputeV1, String>(compressionMode, (value) => value.wireValue),
      ...
      'loadBalancingScheme': ?pulumi.Input.mapOptionalInputValue<RegionBackendServiceLoadBalancingSchemeComputeV1, String>(loadBalancingScheme, (value) => value.wireValue),
      ...
      'localityLbPolicy': ?pulumi.Input.mapOptionalInputValue<RegionBackendServiceLocalityLbPolicyComputeV1, String>(localityLbPolicy, (value) => value.wireValue),
      ...
      'portName': ?portName,
      'project': ?project,
      'protocol': ?pulumi.Input.mapOptionalInputValue<RegionBackendServiceProtocolComputeV1, String>(protocol, (value) => value.wireValue),
      'region': region,
      'requestId': ?requestId,
      ...
      'sessionAffinity': ?pulumi.Input.mapOptionalInputValue<RegionBackendServiceSessionAffinityComputeV1, String>(sessionAffinity, (value) => value.wireValue),
  ...
  factory RegionBackendServiceComputeV1Args.fromMap(Map<String, dynamic> map) {
    return RegionBackendServiceComputeV1Args(
      ...
      backends: (() { final guardedValue = map['backends']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<BackendComputeV1>(guardedValue, (value) => BackendComputeV1.fromMap((value as Map).cast<String, dynamic>()))); })(),
      cdnPolicy: (() { final guardedValue = map['cdnPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BackendServiceCdnPolicyComputeV1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      circuitBreakers: (() { final guardedValue = map['circuitBreakers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CircuitBreakersComputeV1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      compressionMode: (() { final guardedValue = map['compressionMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionBackendServiceCompressionModeComputeV1.fromValue(guardedValue as String)); })(),
      connectionDraining: (() { final guardedValue = map['connectionDraining']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConnectionDrainingComputeV1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      connectionTrackingPolicy: (() { final guardedValue = map['connectionTrackingPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BackendServiceConnectionTrackingPolicyComputeV1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      consistentHash: (() { final guardedValue = map['consistentHash']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConsistentHashLoadBalancerSettingsComputeV1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      failoverPolicy: (() { final guardedValue = map['failoverPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BackendServiceFailoverPolicyComputeV1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      iap: (() { final guardedValue = map['iap']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BackendServiceIAPComputeV1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      loadBalancingScheme: (() { final guardedValue = map['loadBalancingScheme']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionBackendServiceLoadBalancingSchemeComputeV1.fromValue(guardedValue as String)); })(),
      localityLbPolicies: (() { final guardedValue = map['localityLbPolicies']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<BackendServiceLocalityLoadBalancingPolicyConfigComputeV1>(guardedValue, (value) => BackendServiceLocalityLoadBalancingPolicyConfigComputeV1.fromMap((value as Map).cast<String, dynamic>()))); })(),
      localityLbPolicy: (() { final guardedValue = map['localityLbPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionBackendServiceLocalityLbPolicyComputeV1.fromValue(guardedValue as String)); })(),
      logConfig: (() { final guardedValue = map['logConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BackendServiceLogConfigComputeV1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      maxStreamDuration: (() { final guardedValue = map['maxStreamDuration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DurationComputeV1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      outlierDetection: (() { final guardedValue = map['outlierDetection']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OutlierDetectionComputeV1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      protocol: (() { final guardedValue = map['protocol']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionBackendServiceProtocolComputeV1.fromValue(guardedValue as String)); })(),
      region: pulumi.Input.fromValue(map['region'] as String),
      requestId: (() { final guardedValue = map['requestId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      securitySettings: (() { final guardedValue = map['securitySettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SecuritySettingsComputeV1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      sessionAffinity: (() { final guardedValue = map['sessionAffinity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionBackendServiceSessionAffinityComputeV1.fromValue(guardedValue as String)); })(),
      subsetting: (() { final guardedValue = map['subsetting']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SubsettingComputeV1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      usedBy: (() { final guardedValue = map['usedBy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<BackendServiceUsedByComputeV1>(guardedValue, (value) => BackendServiceUsedByComputeV1.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
