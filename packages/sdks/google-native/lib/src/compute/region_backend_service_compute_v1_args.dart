...
class RegionBackendServiceComputeV1Args {
  ...
  factory RegionBackendServiceComputeV1Args.fromMap(Map<String, dynamic> map) {
    return RegionBackendServiceComputeV1Args(
      ...
      compressionMode: map['compressionMode'] == null ? null : (RegionBackendServiceCompressionModeComputeV1.fromValue(map['compressionMode']! as String)).input(),
      ...
      loadBalancingScheme: map['loadBalancingScheme'] == null ? null : (RegionBackendServiceLoadBalancingSchemeComputeV1.fromValue(map['loadBalancingScheme']! as String)).input(),
      ...
      localityLbPolicy: map['localityLbPolicy'] == null ? null : (RegionBackendServiceLocalityLbPolicyComputeV1.fromValue(map['localityLbPolicy']! as String)).input(),
      ...
      protocol: map['protocol'] == null ? null : (RegionBackendServiceProtocolComputeV1.fromValue(map['protocol']! as String)).input(),
      ...
      sessionAffinity: map['sessionAffinity'] == null ? null : (RegionBackendServiceSessionAffinityComputeV1.fromValue(map['sessionAffinity']! as String)).input(),
