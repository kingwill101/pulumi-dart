...
/// {@template pulumi_compute_v1_region_network_firewall_policy_iam_member_compute_v1_args_doc}
/// The set of arguments for RegionNetworkFirewallPolicyIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_v1_region_network_firewall_policy_iam_member_compute_v1_args_doc}
class RegionNetworkFirewallPolicyIamMemberComputeV1Args {
  ...
  /// Creates a new [RegionNetworkFirewallPolicyIamMemberComputeV1Args].
  ...
  const RegionNetworkFirewallPolicyIamMemberComputeV1Args({
    this.condition,
  ...
  factory RegionNetworkFirewallPolicyIamMemberComputeV1Args.fromMap(Map<String, dynamic> map) {
