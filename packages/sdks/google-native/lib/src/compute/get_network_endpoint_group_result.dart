...
class GetNetworkEndpointGroupResult {
  ...
  factory GetNetworkEndpointGroupResult.fromMap(Map<String, dynamic> map) {
    return GetNetworkEndpointGroupResult(
      ...
      appEngine: NetworkEndpointGroupAppEngineResponse.fromMap((map['appEngine']! as Map).cast<String, dynamic>()),
      clientPortMappingMode: map['clientPortMappingMode'] as String,
      cloudFunction: NetworkEndpointGroupCloudFunctionResponse.fromMap((map['cloudFunction']! as Map).cast<String, dynamic>()),
      cloudRun: NetworkEndpointGroupCloudRunResponse.fromMap((map['cloudRun']! as Map).cast<String, dynamic>()),
      creationTimestamp: map['creationTimestamp'] as String,
      defaultPort: map['defaultPort'] as int,
      description: map['description'] as String,
      kind: map['kind'] as String,
      loadBalancer: NetworkEndpointGroupLbNetworkEndpointGroupResponse.fromMap((map['loadBalancer']! as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      network: map['network'] as String,
      networkEndpointType: map['networkEndpointType'] as String,
      pscData: NetworkEndpointGroupPscDataResponse.fromMap((map['pscData']! as Map).cast<String, dynamic>()),
      pscTargetService: map['pscTargetService'] as String,
      region: map['region'] as String,
      selfLink: map['selfLink'] as String,
      selfLinkWithId: map['selfLinkWithId'] as String,
      serverlessDeployment: NetworkEndpointGroupServerlessDeploymentResponse.fromMap((map['serverlessDeployment']! as Map).cast<String, dynamic>()),
