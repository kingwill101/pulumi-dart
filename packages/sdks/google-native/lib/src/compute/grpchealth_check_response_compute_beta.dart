...
class GRPCHealthCheckResponseComputeBeta {
  ...
  /// Creates a new [GRPCHealthCheckResponseComputeBeta].
  ...
  const GRPCHealthCheckResponseComputeBeta({
  ...
  factory GRPCHealthCheckResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return GRPCHealthCheckResponseComputeBeta(
