...
class OutlierDetectionResponseComputeV1 {
  ...
  factory OutlierDetectionResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return OutlierDetectionResponseComputeV1(
      baseEjectionTime: (DurationResponseComputeV1.fromMap((map['baseEjectionTime'] as Map).cast<String, dynamic>())).input(),
      ...
      interval: (DurationResponseComputeV1.fromMap((map['interval'] as Map).cast<String, dynamic>())).input(),
