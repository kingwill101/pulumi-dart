...
class OutlierDetectionResponseComputeV1 {
  ...
  final pulumi.Input<DurationResponseComputeV1> baseEjectionTime;
  ...
  final pulumi.Input<DurationResponseComputeV1> interval;
  ...
  const OutlierDetectionResponseComputeV1({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'baseEjectionTime': pulumi.Input.mapInputValue<DurationResponseComputeV1, Map<String, dynamic>>(baseEjectionTime, (value) => value.toMap()),
      ...
      'interval': pulumi.Input.mapInputValue<DurationResponseComputeV1, Map<String, dynamic>>(interval, (value) => value.toMap()),
  ...
  factory OutlierDetectionResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return OutlierDetectionResponseComputeV1(
      baseEjectionTime: pulumi.Input.fromValue(DurationResponseComputeV1.fromMap((map['baseEjectionTime']! as Map).cast<String, dynamic>())),
      ...
      interval: pulumi.Input.fromValue(DurationResponseComputeV1.fromMap((map['interval']! as Map).cast<String, dynamic>())),
