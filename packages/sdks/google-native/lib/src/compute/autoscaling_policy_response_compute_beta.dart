...
class AutoscalingPolicyResponseComputeBeta {
  ...
  factory AutoscalingPolicyResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return AutoscalingPolicyResponseComputeBeta(
      ...
      cpuUtilization: (AutoscalingPolicyCpuUtilizationResponseComputeBeta.fromMap((map['cpuUtilization'] as Map).cast<String, dynamic>())).input(),
      customMetricUtilizations: (pulumi.Input.decodeList<AutoscalingPolicyCustomMetricUtilizationResponseComputeBeta>(map['customMetricUtilizations'], (value) => AutoscalingPolicyCustomMetricUtilizationResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))).input(),
      loadBalancingUtilization: (AutoscalingPolicyLoadBalancingUtilizationResponseComputeBeta.fromMap((map['loadBalancingUtilization'] as Map).cast<String, dynamic>())).input(),
      maxNumReplicas: (map['maxNumReplicas'] as int).input(),
      minNumReplicas: (map['minNumReplicas'] as int).input(),
      mode: (map['mode'] as String).input(),
      scaleDownControl: (AutoscalingPolicyScaleDownControlResponseComputeBeta.fromMap((map['scaleDownControl'] as Map).cast<String, dynamic>())).input(),
      scaleInControl: (AutoscalingPolicyScaleInControlResponseComputeBeta.fromMap((map['scaleInControl'] as Map).cast<String, dynamic>())).input(),
