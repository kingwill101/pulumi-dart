...
class AutoscalingPolicyResponseComputeBeta {
  ...
  final pulumi.Input<AutoscalingPolicyCpuUtilizationResponseComputeBeta> cpuUtilization;
  /// Configuration parameters of autoscaling based on a custom metric.
  final pulumi.Input<List<AutoscalingPolicyCustomMetricUtilizationResponseComputeBeta>> customMetricUtilizations;
  /// Configuration parameters of autoscaling based on load balancer.
  final pulumi.Input<AutoscalingPolicyLoadBalancingUtilizationResponseComputeBeta> loadBalancingUtilization;
  ...
  final pulumi.Input<AutoscalingPolicyScaleDownControlResponseComputeBeta> scaleDownControl;
  final pulumi.Input<AutoscalingPolicyScaleInControlResponseComputeBeta> scaleInControl;
  ...
  const AutoscalingPolicyResponseComputeBeta({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'cpuUtilization': pulumi.Input.mapInputValue<AutoscalingPolicyCpuUtilizationResponseComputeBeta, Map<String, dynamic>>(cpuUtilization, (value) => value.toMap()),
      'customMetricUtilizations': pulumi.Input.mapInputValue<List<AutoscalingPolicyCustomMetricUtilizationResponseComputeBeta>, List<Map<String, dynamic>>>(customMetricUtilizations, (value) => pulumi.Input.encodeList<AutoscalingPolicyCustomMetricUtilizationResponseComputeBeta, Map<String, dynamic>>(value, (value) => value.toMap())),
      'loadBalancingUtilization': pulumi.Input.mapInputValue<AutoscalingPolicyLoadBalancingUtilizationResponseComputeBeta, Map<String, dynamic>>(loadBalancingUtilization, (value) => value.toMap()),
      'maxNumReplicas': maxNumReplicas,
      'minNumReplicas': minNumReplicas,
      'mode': mode,
      'scaleDownControl': pulumi.Input.mapInputValue<AutoscalingPolicyScaleDownControlResponseComputeBeta, Map<String, dynamic>>(scaleDownControl, (value) => value.toMap()),
      'scaleInControl': pulumi.Input.mapInputValue<AutoscalingPolicyScaleInControlResponseComputeBeta, Map<String, dynamic>>(scaleInControl, (value) => value.toMap()),
      'scalingSchedules': scalingSchedules,
    };
  }

  factory AutoscalingPolicyResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return AutoscalingPolicyResponseComputeBeta(
      coolDownPeriodSec: pulumi.Input.fromValue(map['coolDownPeriodSec'] as int),
      cpuUtilization: pulumi.Input.fromValue(AutoscalingPolicyCpuUtilizationResponseComputeBeta.fromMap((map['cpuUtilization']! as Map).cast<String, dynamic>())),
      customMetricUtilizations: pulumi.Input.fromValue(pulumi.Input.decodeList<AutoscalingPolicyCustomMetricUtilizationResponseComputeBeta>(map['customMetricUtilizations']!, (value) => AutoscalingPolicyCustomMetricUtilizationResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))),
      loadBalancingUtilization: pulumi.Input.fromValue(AutoscalingPolicyLoadBalancingUtilizationResponseComputeBeta.fromMap((map['loadBalancingUtilization']! as Map).cast<String, dynamic>())),
      ...
      scaleDownControl: pulumi.Input.fromValue(AutoscalingPolicyScaleDownControlResponseComputeBeta.fromMap((map['scaleDownControl']! as Map).cast<String, dynamic>())),
      scaleInControl: pulumi.Input.fromValue(AutoscalingPolicyScaleInControlResponseComputeBeta.fromMap((map['scaleInControl']! as Map).cast<String, dynamic>())),
      scalingSchedules: pulumi.Input.fromValue((map['scalingSchedules'] as Map).cast<String, String>()),
    );
  }
}
