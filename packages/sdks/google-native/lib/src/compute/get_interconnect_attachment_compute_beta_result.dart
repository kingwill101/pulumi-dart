...
class GetInterconnectAttachmentComputeBetaResult {
  ...
  factory GetInterconnectAttachmentComputeBetaResult.fromMap(
    ...
    return GetInterconnectAttachmentComputeBetaResult(
      ...
      candidateIpv6Subnets: (map['candidateIpv6Subnets'] as List)
          .cast<String>(),
      ...
      configurationConstraints:
          InterconnectAttachmentConfigurationConstraintsResponseComputeBeta.fromMap(
      ...
      ipsecInternalAddresses: (map['ipsecInternalAddresses'] as List)
          .cast<String>(),
