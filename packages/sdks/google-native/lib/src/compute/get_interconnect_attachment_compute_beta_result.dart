...
class GetInterconnectAttachmentComputeBetaResult {
  ...
  final InterconnectAttachmentConfigurationConstraintsResponseComputeBeta configurationConstraints;
  ...
  final InterconnectAttachmentPartnerMetadataResponseComputeBeta partnerMetadata;
  ...
  final InterconnectAttachmentPrivateInfoResponseComputeBeta privateInterconnectInfo;
  ...
  /// Creates a new [GetInterconnectAttachmentComputeBetaResult].
  ...
  const GetInterconnectAttachmentComputeBetaResult({
  ...
  factory GetInterconnectAttachmentComputeBetaResult.fromMap(Map<String, dynamic> map) {
    return GetInterconnectAttachmentComputeBetaResult(
      ...
      configurationConstraints: InterconnectAttachmentConfigurationConstraintsResponseComputeBeta.fromMap((map['configurationConstraints']! as Map).cast<String, dynamic>()),
      ...
      partnerMetadata: InterconnectAttachmentPartnerMetadataResponseComputeBeta.fromMap((map['partnerMetadata']! as Map).cast<String, dynamic>()),
      privateInterconnectInfo: InterconnectAttachmentPrivateInfoResponseComputeBeta.fromMap((map['privateInterconnectInfo']! as Map).cast<String, dynamic>()),
