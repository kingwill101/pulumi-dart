...
/// {@template pulumi_compute_beta_region_instant_snapshot_iam_member_compute_beta_args_doc}
/// The set of arguments for RegionInstantSnapshotIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_region_instant_snapshot_iam_member_compute_beta_args_doc}
class RegionInstantSnapshotIamMemberComputeBetaArgs {
  ...
  /// Creates a new [RegionInstantSnapshotIamMemberComputeBetaArgs].
  ...
  const RegionInstantSnapshotIamMemberComputeBetaArgs({
    this.condition,
  ...
  factory RegionInstantSnapshotIamMemberComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return RegionInstantSnapshotIamMemberComputeBetaArgs(
