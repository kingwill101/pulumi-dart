...
class InstanceGroupManagerInstanceLifecyclePolicy {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'defaultActionOnFailure': ?pulumi.Input.mapOptionalInputValue<InstanceGroupManagerInstanceLifecyclePolicyDefaultActionOnFailure, String>(defaultActionOnFailure, (value) => value.wireValue),
      'forceUpdateOnRepair': ?pulumi.Input.mapOptionalInputValue<InstanceGroupManagerInstanceLifecyclePolicyForceUpdateOnRepair, String>(forceUpdateOnRepair, (value) => value.wireValue),
  ...
  factory InstanceGroupManagerInstanceLifecyclePolicy.fromMap(Map<String, dynamic> map) {
    return InstanceGroupManagerInstanceLifecyclePolicy(
      defaultActionOnFailure: (() { final guardedValue = map['defaultActionOnFailure']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceGroupManagerInstanceLifecyclePolicyDefaultActionOnFailure.fromValue(guardedValue as String)); })(),
      forceUpdateOnRepair: (() { final guardedValue = map['forceUpdateOnRepair']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceGroupManagerInstanceLifecyclePolicyForceUpdateOnRepair.fromValue(guardedValue as String)); })(),
      metadataBasedReadinessSignal: (() { final guardedValue = map['metadataBasedReadinessSignal']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceGroupManagerInstanceLifecyclePolicyMetadataBasedReadinessSignal.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
