...
class SchedulingResponseComputeBeta {
  ...
  final pulumi.Input<List<SchedulingNodeAffinityResponseComputeBeta>>
  nodeAffinities;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'nodeAffinities':
          pulumi.Input.mapInputValue<
            List<SchedulingNodeAffinityResponseComputeBeta>,
  ...
  factory SchedulingResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return SchedulingResponseComputeBeta(
      ...
      hostErrorTimeoutSeconds: pulumi.Input.fromValue(
      ...
      maxRunDuration: pulumi.Input.fromValue(
        DurationResponseComputeBeta.fromMap(
