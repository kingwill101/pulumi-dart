...
import 'security_policy_rule_rate_limit_options_enforce_on_key_config_enforce_on_key_type.dart';
...
class SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfig {
  ...
  final pulumi.Input<SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigEnforceOnKeyType>? enforceOnKeyType;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'enforceOnKeyType': ?pulumi.Input.mapOptionalInputValue<SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigEnforceOnKeyType, String>(enforceOnKeyType, (value) => value.wireValue),
    };
  }
  ...
  factory SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfig.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfig(
      ...
      enforceOnKeyType: (() { final guardedValue = map['enforceOnKeyType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigEnforceOnKeyType.fromValue(guardedValue as String)); })(),
    );
  }
}
