...
class AutoscalingPolicyCustomMetricUtilizationResponseComputeBeta {
  ...
  final pulumi.Input<String> utilizationTargetType;

  /// Creates a new [AutoscalingPolicyCustomMetricUtilizationResponseComputeBeta].
  ...
  const AutoscalingPolicyCustomMetricUtilizationResponseComputeBeta({
    required this.filter,
    required this.metric,
    required this.singleInstanceAssignment,
    required this.utilizationTarget,
    required this.utilizationTargetType,
  });
  ...
  factory AutoscalingPolicyCustomMetricUtilizationResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return AutoscalingPolicyCustomMetricUtilizationResponseComputeBeta(
      ...
      utilizationTargetType: pulumi.Input.fromValue(map['utilizationTargetType'] as String),
    );
  }
}
