...
class HttpRouteRuleMatchResponse {
  ...
  factory HttpRouteRuleMatchResponse.fromMap(Map<String, dynamic> map) {
    return HttpRouteRuleMatchResponse(
      ...
      headerMatches: (pulumi.Input.decodeList<HttpHeaderMatchResponse>(map['headerMatches'], (value) => HttpHeaderMatchResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ignoreCase: (map['ignoreCase'] as bool).input(),
      metadataFilters: (pulumi.Input.decodeList<MetadataFilterResponse>(map['metadataFilters'], (value) => MetadataFilterResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      pathTemplateMatch: (map['pathTemplateMatch'] as String).input(),
      prefixMatch: (map['prefixMatch'] as String).input(),
      queryParameterMatches: (pulumi.Input.decodeList<HttpQueryParameterMatchResponse>(map['queryParameterMatches'], (value) => HttpQueryParameterMatchResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
