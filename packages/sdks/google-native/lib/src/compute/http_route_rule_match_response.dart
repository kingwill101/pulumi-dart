...
class HttpRouteRuleMatchResponse {
  ...
  final pulumi.Input<List<HttpQueryParameterMatchResponse>>
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'queryParameterMatches':
          pulumi.Input.mapInputValue<
            List<HttpQueryParameterMatchResponse>,
            List<Map<String, dynamic>>
          >(
            queryParameterMatches,
            (value) =>
  ...
  factory HttpRouteRuleMatchResponse.fromMap(Map<String, dynamic> map) {
    return HttpRouteRuleMatchResponse(
      ...
      headerMatches: pulumi.Input.fromValue(
        pulumi.Input.decodeList<HttpHeaderMatchResponse>(
          map['headerMatches']!,
          (value) => HttpHeaderMatchResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      ignoreCase: pulumi.Input.fromValue(map['ignoreCase'] as bool),
      metadataFilters: pulumi.Input.fromValue(
        pulumi.Input.decodeList<MetadataFilterResponse>(
          map['metadataFilters']!,
      ...
      pathTemplateMatch: pulumi.Input.fromValue(
        map['pathTemplateMatch'] as String,
      ),
      prefixMatch: pulumi.Input.fromValue(map['prefixMatch'] as String),
      queryParameterMatches: pulumi.Input.fromValue(
        pulumi.Input.decodeList<HttpQueryParameterMatchResponse>(
          map['queryParameterMatches']!,
          (value) => HttpQueryParameterMatchResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
