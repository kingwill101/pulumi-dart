...
class HttpRouteRuleMatchResponse {
  ...
  final pulumi.Input<List<MetadataFilterResponse>> metadataFilters;
  ...
  final pulumi.Input<List<HttpQueryParameterMatchResponse>> queryParameterMatches;
  /// For satisfying the matchRule condition, the path of the request must satisfy the regular expression specified in regexMatch after removing any query parameters and anchor supplied with the original URL. For more information about regular expression syntax, see Syntax. Only one of prefixMatch, fullPathMatch or regexMatch must be specified. Regular expressions can only be used when the loadBalancingScheme is set to INTERNAL_SELF_MANAGED.
  final pulumi.Input<String> regexMatch;

  /// Creates a new [HttpRouteRuleMatchResponse].
  ...
  const HttpRouteRuleMatchResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'headerMatches': pulumi.Input.mapInputValue<List<HttpHeaderMatchResponse>, List<Map<String, dynamic>>>(headerMatches, (value) => pulumi.Input.encodeList<HttpHeaderMatchResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'ignoreCase': ignoreCase,
      'metadataFilters': pulumi.Input.mapInputValue<List<MetadataFilterResponse>, List<Map<String, dynamic>>>(metadataFilters, (value) => pulumi.Input.encodeList<MetadataFilterResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'pathTemplateMatch': pathTemplateMatch,
      'prefixMatch': prefixMatch,
      'queryParameterMatches': pulumi.Input.mapInputValue<List<HttpQueryParameterMatchResponse>, List<Map<String, dynamic>>>(queryParameterMatches, (value) => pulumi.Input.encodeList<HttpQueryParameterMatchResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'regexMatch': regexMatch,
    };
  }

  factory HttpRouteRuleMatchResponse.fromMap(Map<String, dynamic> map) {
    return HttpRouteRuleMatchResponse(
      fullPathMatch: pulumi.Input.fromValue(map['fullPathMatch'] as String),
      headerMatches: pulumi.Input.fromValue(pulumi.Input.decodeList<HttpHeaderMatchResponse>(map['headerMatches']!, (value) => HttpHeaderMatchResponse.fromMap((value as Map).cast<String, dynamic>()))),
      ignoreCase: pulumi.Input.fromValue(map['ignoreCase'] as bool),
      metadataFilters: pulumi.Input.fromValue(pulumi.Input.decodeList<MetadataFilterResponse>(map['metadataFilters']!, (value) => MetadataFilterResponse.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      queryParameterMatches: pulumi.Input.fromValue(pulumi.Input.decodeList<HttpQueryParameterMatchResponse>(map['queryParameterMatches']!, (value) => HttpQueryParameterMatchResponse.fromMap((value as Map).cast<String, dynamic>()))),
