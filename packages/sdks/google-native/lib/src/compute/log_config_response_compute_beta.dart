...
class LogConfigResponseComputeBeta {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'cloudAudit': pulumi.Input.mapInputValue<LogConfigCloudAuditOptionsResponseComputeBeta, Map<String, dynamic>>(cloudAudit, (value) => value.toMap()),
      'counter': pulumi.Input.mapInputValue<LogConfigCounterOptionsResponseComputeBeta, Map<String, dynamic>>(counter, (value) => value.toMap()),
      'dataAccess': pulumi.Input.mapInputValue<LogConfigDataAccessOptionsResponseComputeBeta, Map<String, dynamic>>(dataAccess, (value) => value.toMap()),
    };
  }

  factory LogConfigResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return LogConfigResponseComputeBeta(
      cloudAudit: pulumi.Input.fromValue(LogConfigCloudAuditOptionsResponseComputeBeta.fromMap((map['cloudAudit']! as Map).cast<String, dynamic>())),
      counter: pulumi.Input.fromValue(LogConfigCounterOptionsResponseComputeBeta.fromMap((map['counter']! as Map).cast<String, dynamic>())),
      dataAccess: pulumi.Input.fromValue(LogConfigDataAccessOptionsResponseComputeBeta.fromMap((map['dataAccess']! as Map).cast<String, dynamic>())),
    );
  }
}
