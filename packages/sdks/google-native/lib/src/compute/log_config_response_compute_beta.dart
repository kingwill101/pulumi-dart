...
class LogConfigResponseComputeBeta {
  ...
  factory LogConfigResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return LogConfigResponseComputeBeta(
      cloudAudit: (LogConfigCloudAuditOptionsResponseComputeBeta.fromMap((map['cloudAudit'] as Map).cast<String, dynamic>())).input(),
      counter: (LogConfigCounterOptionsResponseComputeBeta.fromMap((map['counter'] as Map).cast<String, dynamic>())).input(),
      dataAccess: (LogConfigDataAccessOptionsResponseComputeBeta.fromMap((map['dataAccess'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
