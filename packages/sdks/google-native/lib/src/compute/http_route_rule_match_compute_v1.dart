...
class HttpRouteRuleMatchComputeV1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'headerMatches': ?headerMatches == null ? null : pulumi.Input.encodeList<HttpHeaderMatchComputeV1, Map<String, dynamic>>(headerMatches!, (value) => value.toMap()),
      'ignoreCase': ?ignoreCase,
      'metadataFilters': ?metadataFilters == null ? null : pulumi.Input.encodeList<MetadataFilterComputeV1, Map<String, dynamic>>(metadataFilters!, (value) => value.toMap()),
      'pathTemplateMatch': ?pathTemplateMatch,
      'prefixMatch': ?prefixMatch,
      'queryParameterMatches': ?queryParameterMatches == null ? null : pulumi.Input.encodeList<HttpQueryParameterMatchComputeV1, Map<String, dynamic>>(queryParameterMatches!, (value) => value.toMap()),
  ...
  factory HttpRouteRuleMatchComputeV1.fromMap(Map<String, dynamic> map) {
    return HttpRouteRuleMatchComputeV1(
      ...
      headerMatches: map['headerMatches'] == null ? null : pulumi.Input.decodeList<HttpHeaderMatchComputeV1>(map['headerMatches'], (value) => HttpHeaderMatchComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      ...
      queryParameterMatches: map['queryParameterMatches'] == null ? null : pulumi.Input.decodeList<HttpQueryParameterMatchComputeV1>(map['queryParameterMatches'], (value) => HttpQueryParameterMatchComputeV1.fromMap((value as Map).cast<String, dynamic>())),
