...
class CustomErrorResponsePolicyComputeBeta {
  ...
  final pulumi.Input<
    List<CustomErrorResponsePolicyCustomErrorResponseRuleComputeBeta>
  >?
  errorResponseRules;
  ...
  factory CustomErrorResponsePolicyComputeBeta.fromMap(
    ...
    return CustomErrorResponsePolicyComputeBeta(
      errorResponseRules: (() {
        final guardedValue = map['errorResponseRules'];
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                CustomErrorResponsePolicyCustomErrorResponseRuleComputeBeta.fromMap(
      ...
      errorService: (() {
        final guardedValue = map['errorService'];
        if (guardedValue == null) return null;
