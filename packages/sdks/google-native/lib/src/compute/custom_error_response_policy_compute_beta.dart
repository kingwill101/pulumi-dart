...
import 'custom_error_response_policy_custom_error_response_rule_compute_beta.dart';

/// Specifies the custom error response policy that must be applied when the backend service or backend bucket responds with an error.
class CustomErrorResponsePolicyComputeBeta {
  ...
  final pulumi.Input<List<CustomErrorResponsePolicyCustomErrorResponseRuleComputeBeta>>? errorResponseRules;
  ...
  /// Creates a new [CustomErrorResponsePolicyComputeBeta].
  ...
  const CustomErrorResponsePolicyComputeBeta({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'errorResponseRules': ?pulumi.Input.mapOptionalInputValue<List<CustomErrorResponsePolicyCustomErrorResponseRuleComputeBeta>, List<Map<String, dynamic>>>(errorResponseRules, (value) => pulumi.Input.encodeList<CustomErrorResponsePolicyCustomErrorResponseRuleComputeBeta, Map<String, dynamic>>(value, (value) => value.toMap())),
      'errorService': ?errorService,
    };
  }

  factory CustomErrorResponsePolicyComputeBeta.fromMap(Map<String, dynamic> map) {
    return CustomErrorResponsePolicyComputeBeta(
      errorResponseRules: (() { final guardedValue = map['errorResponseRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<CustomErrorResponsePolicyCustomErrorResponseRuleComputeBeta>(guardedValue, (value) => CustomErrorResponsePolicyCustomErrorResponseRuleComputeBeta.fromMap((value as Map).cast<String, dynamic>()))); })(),
      errorService: (() { final guardedValue = map['errorService']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
