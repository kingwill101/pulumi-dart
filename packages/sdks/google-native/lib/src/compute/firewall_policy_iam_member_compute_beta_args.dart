...
/// {@template pulumi_compute_beta_firewall_policy_iam_member_compute_beta_args_doc}
/// The set of arguments for FirewallPolicyIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_firewall_policy_iam_member_compute_beta_args_doc}
class FirewallPolicyIamMemberComputeBetaArgs {
  ...
  /// Creates a new [FirewallPolicyIamMemberComputeBetaArgs].
  ...
  const FirewallPolicyIamMemberComputeBetaArgs({
    this.condition,
  ...
  factory FirewallPolicyIamMemberComputeBetaArgs.fromMap(Map<String, dynamic> map) {
