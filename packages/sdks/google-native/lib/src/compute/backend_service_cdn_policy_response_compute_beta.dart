...
class BackendServiceCdnPolicyResponseComputeBeta {
  ...
  factory BackendServiceCdnPolicyResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return BackendServiceCdnPolicyResponseComputeBeta(
      bypassCacheOnRequestHeaders: (pulumi.Input.decodeList<BackendServiceCdnPolicyBypassCacheOnRequestHeaderResponseComputeBeta>(map['bypassCacheOnRequestHeaders'], (value) => BackendServiceCdnPolicyBypassCacheOnRequestHeaderResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))).input(),
      cacheKeyPolicy: (CacheKeyPolicyResponseComputeBeta.fromMap((map['cacheKeyPolicy'] as Map).cast<String, dynamic>())).input(),
      ...
      negativeCachingPolicy: (pulumi.Input.decodeList<BackendServiceCdnPolicyNegativeCachingPolicyResponseComputeBeta>(map['negativeCachingPolicy'], (value) => BackendServiceCdnPolicyNegativeCachingPolicyResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))).input(),
      requestCoalescing: (map['requestCoalescing'] as bool).input(),
      serveWhileStale: (map['serveWhileStale'] as int).input(),
      signedUrlCacheMaxAgeSec: (map['signedUrlCacheMaxAgeSec'] as String).input(),
      signedUrlKeyNames: ((map['signedUrlKeyNames'] as List).cast<String>()).input(),
    );
  }
}
