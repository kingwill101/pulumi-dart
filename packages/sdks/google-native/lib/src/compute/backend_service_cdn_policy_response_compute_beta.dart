...
import 'backend_service_cdn_policy_bypass_cache_on_request_header_response_compute_beta.dart';
import 'backend_service_cdn_policy_negative_caching_policy_response_compute_beta.dart';
import 'cache_key_policy_response_compute_beta.dart';

/// Message containing Cloud CDN configuration for a backend service.
class BackendServiceCdnPolicyResponseComputeBeta {
  /// Bypass the cache when the specified request headers are matched - e.g. Pragma or Authorization headers. Up to 5 headers can be specified. The cache is bypassed for all cdnPolicy.cacheMode settings.
  final pulumi.Input<List<BackendServiceCdnPolicyBypassCacheOnRequestHeaderResponseComputeBeta>> bypassCacheOnRequestHeaders;
  /// The CacheKeyPolicy for this CdnPolicy.
  final pulumi.Input<CacheKeyPolicyResponseComputeBeta> cacheKeyPolicy;
  ...
  final pulumi.Input<List<BackendServiceCdnPolicyNegativeCachingPolicyResponseComputeBeta>> negativeCachingPolicy;
  ...
  final pulumi.Input<List<String>> signedUrlKeyNames;

  /// Creates a new [BackendServiceCdnPolicyResponseComputeBeta].
  ...
  /// [signedUrlKeyNames] Names of the keys for signing request URLs.
  const BackendServiceCdnPolicyResponseComputeBeta({
    required this.bypassCacheOnRequestHeaders,
    required this.cacheKeyPolicy,
    required this.cacheMode,
    required this.clientTtl,
    required this.defaultTtl,
    required this.maxTtl,
    required this.negativeCaching,
    required this.negativeCachingPolicy,
    required this.requestCoalescing,
    required this.serveWhileStale,
    required this.signedUrlCacheMaxAgeSec,
    required this.signedUrlKeyNames,
  });

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'bypassCacheOnRequestHeaders': pulumi.Input.mapInputValue<List<BackendServiceCdnPolicyBypassCacheOnRequestHeaderResponseComputeBeta>, List<Map<String, dynamic>>>(bypassCacheOnRequestHeaders, (value) => pulumi.Input.encodeList<BackendServiceCdnPolicyBypassCacheOnRequestHeaderResponseComputeBeta, Map<String, dynamic>>(value, (value) => value.toMap())),
      'cacheKeyPolicy': pulumi.Input.mapInputValue<CacheKeyPolicyResponseComputeBeta, Map<String, dynamic>>(cacheKeyPolicy, (value) => value.toMap()),
      'cacheMode': cacheMode,
      'clientTtl': clientTtl,
      'defaultTtl': defaultTtl,
      'maxTtl': maxTtl,
      'negativeCaching': negativeCaching,
      'negativeCachingPolicy': pulumi.Input.mapInputValue<List<BackendServiceCdnPolicyNegativeCachingPolicyResponseComputeBeta>, List<Map<String, dynamic>>>(negativeCachingPolicy, (value) => pulumi.Input.encodeList<BackendServiceCdnPolicyNegativeCachingPolicyResponseComputeBeta, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory BackendServiceCdnPolicyResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return BackendServiceCdnPolicyResponseComputeBeta(
      bypassCacheOnRequestHeaders: pulumi.Input.fromValue(pulumi.Input.decodeList<BackendServiceCdnPolicyBypassCacheOnRequestHeaderResponseComputeBeta>(map['bypassCacheOnRequestHeaders']!, (value) => BackendServiceCdnPolicyBypassCacheOnRequestHeaderResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))),
      cacheKeyPolicy: pulumi.Input.fromValue(CacheKeyPolicyResponseComputeBeta.fromMap((map['cacheKeyPolicy']! as Map).cast<String, dynamic>())),
      ...
      negativeCachingPolicy: pulumi.Input.fromValue(pulumi.Input.decodeList<BackendServiceCdnPolicyNegativeCachingPolicyResponseComputeBeta>(map['negativeCachingPolicy']!, (value) => BackendServiceCdnPolicyNegativeCachingPolicyResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))),
      requestCoalescing: pulumi.Input.fromValue(map['requestCoalescing'] as bool),
      serveWhileStale: pulumi.Input.fromValue(map['serveWhileStale'] as int),
      signedUrlCacheMaxAgeSec: pulumi.Input.fromValue(map['signedUrlCacheMaxAgeSec'] as String),
      signedUrlKeyNames: pulumi.Input.fromValue((map['signedUrlKeyNames'] as List).cast<String>()),
    );
  }
}
