...
class BackendServiceCdnPolicyResponseComputeBeta {
  ...
  final pulumi.Input<
    List<BackendServiceCdnPolicyBypassCacheOnRequestHeaderResponseComputeBeta>
  >
  ...
  final pulumi.Input<
    List<BackendServiceCdnPolicyNegativeCachingPolicyResponseComputeBeta>
  >
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'cacheKeyPolicy':
          pulumi.Input.mapInputValue<
            CacheKeyPolicyResponseComputeBeta,
            Map<String, dynamic>
      ...
      'negativeCachingPolicy':
          pulumi.Input.mapInputValue<
            List<
              BackendServiceCdnPolicyNegativeCachingPolicyResponseComputeBeta
            >,
            List<Map<String, dynamic>>
          >(
            negativeCachingPolicy,
  ...
  factory BackendServiceCdnPolicyResponseComputeBeta.fromMap(
    Map<String, dynamic> map,
  ) {
    return BackendServiceCdnPolicyResponseComputeBeta(
      bypassCacheOnRequestHeaders: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          BackendServiceCdnPolicyBypassCacheOnRequestHeaderResponseComputeBeta
        >(
          map['bypassCacheOnRequestHeaders']!,
          (value) =>
              BackendServiceCdnPolicyBypassCacheOnRequestHeaderResponseComputeBeta.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
      cacheKeyPolicy: pulumi.Input.fromValue(
        CacheKeyPolicyResponseComputeBeta.fromMap(
      ...
      negativeCachingPolicy: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          BackendServiceCdnPolicyNegativeCachingPolicyResponseComputeBeta
        >(
          map['negativeCachingPolicy']!,
          (value) =>
              BackendServiceCdnPolicyNegativeCachingPolicyResponseComputeBeta.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
      requestCoalescing: pulumi.Input.fromValue(
      ...
      signedUrlKeyNames: pulumi.Input.fromValue(
        (map['signedUrlKeyNames'] as List).cast<String>(),
      ),
    );
  }
}
