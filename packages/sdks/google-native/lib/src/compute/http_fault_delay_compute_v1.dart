...
class HttpFaultDelayComputeV1 {
  ...
  factory HttpFaultDelayComputeV1.fromMap(Map<String, dynamic> map) {
    return HttpFaultDelayComputeV1(
      fixedDelay: (() { final guardedValue = map['fixedDelay']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DurationComputeV1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
