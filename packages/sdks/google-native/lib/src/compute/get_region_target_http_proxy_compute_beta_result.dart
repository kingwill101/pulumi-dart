...
class GetRegionTargetHttpProxyComputeBetaResult {
  ...
  /// Creates a new [GetRegionTargetHttpProxyComputeBetaResult].
  ...
  const GetRegionTargetHttpProxyComputeBetaResult({
  ...
  factory GetRegionTargetHttpProxyComputeBetaResult.fromMap(Map<String, dynamic> map) {
    return GetRegionTargetHttpProxyComputeBetaResult(
