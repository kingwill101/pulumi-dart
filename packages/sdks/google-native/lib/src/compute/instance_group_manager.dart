...
class InstanceGroupManager extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<InstanceGroupManagerAutoHealingPolicyResponse>> autoHealingPolicies;
  ...
  InstanceGroupManager(
    ...
    this.allInstancesConfig = registerOutput<InstanceGroupManagerAllInstancesConfigResponse>('allInstancesConfig');
    this.autoHealingPolicies = registerOutput<List<InstanceGroupManagerAutoHealingPolicyResponse>>('autoHealingPolicies');
    this.baseInstanceName = registerOutput<String>('baseInstanceName');
    this.creationTimestamp = registerOutput<String>('creationTimestamp');
    this.currentActions = registerOutput<InstanceGroupManagerActionsSummaryResponse>('currentActions');
    this.description = registerOutput<String>('description');
    this.distributionPolicy = registerOutput<DistributionPolicyResponse>('distributionPolicy');
    this.failoverAction = registerOutput<String>('failoverAction');
    this.fingerprint = registerOutput<String>('fingerprint');
    this.instanceFlexibilityPolicy = registerOutput<InstanceGroupManagerInstanceFlexibilityPolicyResponse>('instanceFlexibilityPolicy');
    this.instanceGroup = registerOutput<String>('instanceGroup');
    this.instanceLifecyclePolicy = registerOutput<InstanceGroupManagerInstanceLifecyclePolicyResponse>('instanceLifecyclePolicy');
    ...
    this.standbyPolicy = registerOutput<InstanceGroupManagerStandbyPolicyResponse>('standbyPolicy');
    this.statefulPolicy = registerOutput<StatefulPolicyResponse>('statefulPolicy');
    ...
    this.updatePolicy = registerOutput<InstanceGroupManagerUpdatePolicyResponse>('updatePolicy');
    this.versions = registerOutput<List<InstanceGroupManagerVersionResponse>>('versions');
