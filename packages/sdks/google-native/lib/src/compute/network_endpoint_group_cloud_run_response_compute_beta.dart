...
class NetworkEndpointGroupCloudRunResponseComputeBeta {
  ...
  /// Creates a new [NetworkEndpointGroupCloudRunResponseComputeBeta].
  ...
  const NetworkEndpointGroupCloudRunResponseComputeBeta({
  ...
  factory NetworkEndpointGroupCloudRunResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return NetworkEndpointGroupCloudRunResponseComputeBeta(
