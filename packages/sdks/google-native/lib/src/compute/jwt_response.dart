...
class JwtResponse {
  ...
  final pulumi.Input<List<JwtHeaderResponse>> jwtHeaders;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'jwtHeaders': pulumi.Input.mapInputValue<List<JwtHeaderResponse>, List<Map<String, dynamic>>>(jwtHeaders, (value) => pulumi.Input.encodeList<JwtHeaderResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'jwtParams': jwtParams,
    };
  }
  ...
  factory JwtResponse.fromMap(Map<String, dynamic> map) {
    return JwtResponse(
      ...
      jwksPublicKeys: pulumi.Input.fromValue(map['jwksPublicKeys'] as String),
      jwtHeaders: pulumi.Input.fromValue(pulumi.Input.decodeList<JwtHeaderResponse>(map['jwtHeaders']!, (value) => JwtHeaderResponse.fromMap((value as Map).cast<String, dynamic>()))),
      jwtParams: pulumi.Input.fromValue((map['jwtParams'] as List).cast<String>()),
    );
  }
}
