...
class JwtResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'jwtHeaders': pulumi.Input.encodeList<JwtHeaderResponse, Map<String, dynamic>>(jwtHeaders, (value) => value.toMap()),
      'jwtParams': jwtParams,
    };
  }
  ...
  factory JwtResponse.fromMap(Map<String, dynamic> map) {
    return JwtResponse(
      ...
      jwtHeaders: pulumi.Input.decodeList<JwtHeaderResponse>(map['jwtHeaders'], (value) => JwtHeaderResponse.fromMap((value as Map).cast<String, dynamic>())),
