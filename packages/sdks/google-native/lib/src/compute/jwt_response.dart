...
class JwtResponse {
  ...
  factory JwtResponse.fromMap(Map<String, dynamic> map) {
    return JwtResponse(
      ...
      jwksPublicKeys: (map['jwksPublicKeys'] as String).input(),
      jwtHeaders: (pulumi.Input.decodeList<JwtHeaderResponse>(map['jwtHeaders'], (value) => JwtHeaderResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      jwtParams: ((map['jwtParams'] as List).cast<String>()).input(),
    );
  }
}
