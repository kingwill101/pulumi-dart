...
class UrlMapTestComputeV1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'headers': ?headers == null ? null : pulumi.Input.encodeList<UrlMapTestHeaderComputeV1, Map<String, dynamic>>(headers!, (value) => value.toMap()),
      'host': ?host,
      'path': ?path,
      'service': ?service,
    };
  ...
  factory UrlMapTestComputeV1.fromMap(Map<String, dynamic> map) {
    return UrlMapTestComputeV1(
      ...
      headers: map['headers'] == null ? null : pulumi.Input.decodeList<UrlMapTestHeaderComputeV1>(map['headers'], (value) => UrlMapTestHeaderComputeV1.fromMap((value as Map).cast<String, dynamic>())),
