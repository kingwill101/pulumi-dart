...
class UrlMapTestComputeV1 {
  ...
  factory UrlMapTestComputeV1.fromMap(Map<String, dynamic> map) {
    return UrlMapTestComputeV1(
      ...
      headers: (() { final guardedValue = map['headers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<UrlMapTestHeaderComputeV1>(guardedValue, (value) => UrlMapTestHeaderComputeV1.fromMap((value as Map).cast<String, dynamic>()))); })(),
