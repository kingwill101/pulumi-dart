...
class FirewallPolicyRuleMatcherResponseComputeBeta {
  ...
  final pulumi.Input<List<FirewallPolicyRuleMatcherLayer4ConfigResponseComputeBeta>> layer4Configs;
  ...
  final pulumi.Input<List<FirewallPolicyRuleSecureTagResponseComputeBeta>> srcSecureTags;
  /// Names of Network Threat Intelligence lists. The IPs in these lists will be matched against traffic source.
  final pulumi.Input<List<String>> srcThreatIntelligences;

  /// Creates a new [FirewallPolicyRuleMatcherResponseComputeBeta].
  ...
  const FirewallPolicyRuleMatcherResponseComputeBeta({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'layer4Configs': pulumi.Input.mapInputValue<List<FirewallPolicyRuleMatcherLayer4ConfigResponseComputeBeta>, List<Map<String, dynamic>>>(layer4Configs, (value) => pulumi.Input.encodeList<FirewallPolicyRuleMatcherLayer4ConfigResponseComputeBeta, Map<String, dynamic>>(value, (value) => value.toMap())),
      'srcAddressGroups': srcAddressGroups,
      'srcFqdns': srcFqdns,
      'srcIpRanges': srcIpRanges,
      'srcRegionCodes': srcRegionCodes,
      'srcSecureTags': pulumi.Input.mapInputValue<List<FirewallPolicyRuleSecureTagResponseComputeBeta>, List<Map<String, dynamic>>>(srcSecureTags, (value) => pulumi.Input.encodeList<FirewallPolicyRuleSecureTagResponseComputeBeta, Map<String, dynamic>>(value, (value) => value.toMap())),
      'srcThreatIntelligences': srcThreatIntelligences,
    };
  }

  factory FirewallPolicyRuleMatcherResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyRuleMatcherResponseComputeBeta(
      ...
      layer4Configs: pulumi.Input.fromValue(pulumi.Input.decodeList<FirewallPolicyRuleMatcherLayer4ConfigResponseComputeBeta>(map['layer4Configs']!, (value) => FirewallPolicyRuleMatcherLayer4ConfigResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      srcSecureTags: pulumi.Input.fromValue(pulumi.Input.decodeList<FirewallPolicyRuleSecureTagResponseComputeBeta>(map['srcSecureTags']!, (value) => FirewallPolicyRuleSecureTagResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))),
