...
class PacketMirroringArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'enable':
          ?pulumi.Input.mapOptionalInputValue<PacketMirroringEnable, String>(
            enable,
  ...
  factory PacketMirroringArgs.fromMap(Map<String, dynamic> map) {
    return PacketMirroringArgs(
      collectorIlb: (() {
        final guardedValue = map['collectorIlb'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PacketMirroringForwardingRuleInfo.fromMap(
      ...
      enable: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PacketMirroringEnable.fromValue(guardedValue as String),
        );
      })(),
      filter: (() {
      ...
      mirroredResources: (() {
        final guardedValue = map['mirroredResources'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PacketMirroringMirroredResourceInfo.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      network: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PacketMirroringNetworkInfo.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
