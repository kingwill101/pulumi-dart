...
class PacketMirroringArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'enable': ?pulumi.Input.mapOptionalInputValue<PacketMirroringEnable, String>(enable, (value) => value.wireValue),
  ...
  factory PacketMirroringArgs.fromMap(Map<String, dynamic> map) {
    return PacketMirroringArgs(
      collectorIlb: (() { final guardedValue = map['collectorIlb']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PacketMirroringForwardingRuleInfo.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      description: (() { final guardedValue = map['description']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      enable: (() { final guardedValue = map['enable']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PacketMirroringEnable.fromValue(guardedValue as String)); })(),
      ...
      mirroredResources: (() { final guardedValue = map['mirroredResources']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PacketMirroringMirroredResourceInfo.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      network: (() { final guardedValue = map['network']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PacketMirroringNetworkInfo.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
