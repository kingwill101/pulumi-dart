...
/// {@template pulumi_compute_v1_firewall_policy_iam_member_compute_v1_args_doc}
/// The set of arguments for FirewallPolicyIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_v1_firewall_policy_iam_member_compute_v1_args_doc}
class FirewallPolicyIamMemberComputeV1Args {
  ...
  /// Creates a new [FirewallPolicyIamMemberComputeV1Args].
  ...
  const FirewallPolicyIamMemberComputeV1Args({
    this.condition,
  ...
  factory FirewallPolicyIamMemberComputeV1Args.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyIamMemberComputeV1Args(
