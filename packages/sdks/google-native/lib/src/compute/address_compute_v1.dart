...
import 'address_compute_v1_args.dart';

/// Creates an address resource in the specified project by using the data included in the request.
class AddressComputeV1 extends pulumi.CustomResource {
  ...
  /// Creates a new [AddressComputeV1].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [AddressComputeV1]. {@macro pulumi_compute_v1_address_compute_v1_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  AddressComputeV1(
    String name, {
    AddressComputeV1Args? args,
