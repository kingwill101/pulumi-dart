...
class OutlierDetection {
  ...
  factory OutlierDetection.fromMap(Map<String, dynamic> map) {
    return OutlierDetection(
      baseEjectionTime: map['baseEjectionTime'] == null ? null : Duration.fromMap((map['baseEjectionTime'] as Map).cast<String, dynamic>()),
      ...
      interval: map['interval'] == null ? null : Duration.fromMap((map['interval'] as Map).cast<String, dynamic>()),
