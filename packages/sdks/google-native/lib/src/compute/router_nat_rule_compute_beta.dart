...
class RouterNatRuleComputeBeta {
  ...
  final pulumi.Input<RouterNatRuleActionComputeBeta>? action;
  ...
  const RouterNatRuleComputeBeta({
    this.action,
    this.description,
    this.match,
    this.ruleNumber,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'action': ?pulumi.Input.mapOptionalInputValue<RouterNatRuleActionComputeBeta, Map<String, dynamic>>(action, (value) => value.toMap()),
  ...
  factory RouterNatRuleComputeBeta.fromMap(Map<String, dynamic> map) {
    return RouterNatRuleComputeBeta(
      action: (() { final guardedValue = map['action']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RouterNatRuleActionComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
