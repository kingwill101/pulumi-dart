...
class NodeTemplateComputeBeta extends pulumi.CustomResource {
  ...
  late final pulumi.Output<NodeTemplateNodeTypeFlexibilityResponseComputeBeta> nodeTypeFlexibility;
  ...
  NodeTemplateComputeBeta(
    ...
    nodeTypeFlexibility = registerOutput<NodeTemplateNodeTypeFlexibilityResponseComputeBeta>('nodeTypeFlexibility', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return NodeTemplateNodeTypeFlexibilityResponseComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    project = registerOutput<String>('project');
    region = registerOutput<String>('region');
    requestId = registerOutput<String?>('requestId');
    selfLink = registerOutput<String>('selfLink');
    serverBinding = registerOutput<ServerBindingResponseComputeBeta>('serverBinding', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ServerBindingResponseComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>()); });
