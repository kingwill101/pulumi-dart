...
class ResourcePolicyHourlyCycleResponse {
  ...
  /// Creates a new [ResourcePolicyHourlyCycleResponse].
  ...
  factory ResourcePolicyHourlyCycleResponse.fromMap(Map<String, dynamic> map) {
    return ResourcePolicyHourlyCycleResponse(
      duration: (map['duration'] as String).input(),
      hoursInCycle: (map['hoursInCycle'] as int).input(),
