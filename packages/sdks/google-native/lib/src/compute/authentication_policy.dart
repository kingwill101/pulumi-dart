...
class AuthenticationPolicy {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'origins': ?origins == null ? null : pulumi.Input.encodeList<OriginAuthenticationMethod, Map<String, dynamic>>(origins!, (value) => value.toMap()),
      'peers': ?peers == null ? null : pulumi.Input.encodeList<PeerAuthenticationMethod, Map<String, dynamic>>(peers!, (value) => value.toMap()),
      'principalBinding': ?principalBinding == null ? null : principalBinding!.value,
      'serverTlsContext': ?serverTlsContext == null ? null : serverTlsContext!.toMap(),
    };
  }

  factory AuthenticationPolicy.fromMap(Map<String, dynamic> map) {
    return AuthenticationPolicy(
      origins: map['origins'] == null ? null : pulumi.Input.decodeList<OriginAuthenticationMethod>(map['origins'], (value) => OriginAuthenticationMethod.fromMap((value as Map).cast<String, dynamic>())),
      peers: map['peers'] == null ? null : pulumi.Input.decodeList<PeerAuthenticationMethod>(map['peers'], (value) => PeerAuthenticationMethod.fromMap((value as Map).cast<String, dynamic>())),
      principalBinding: map['principalBinding'] == null ? null : AuthenticationPolicyPrincipalBinding.fromValue(map['principalBinding'] as String),
      serverTlsContext: map['serverTlsContext'] == null ? null : TlsContext.fromMap((map['serverTlsContext'] as Map).cast<String, dynamic>()),
    );
  }
}
