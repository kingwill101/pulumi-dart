...
class BackendServiceLocalityLoadBalancingPolicyConfigCustomPolicyResponse {
  ...
  const BackendServiceLocalityLoadBalancingPolicyConfigCustomPolicyResponse({
    required this.data,
    required this.name,
  });
  ...
  factory BackendServiceLocalityLoadBalancingPolicyConfigCustomPolicyResponse.fromMap(Map<String, dynamic> map) {
