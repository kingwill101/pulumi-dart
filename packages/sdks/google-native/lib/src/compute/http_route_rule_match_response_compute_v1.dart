...
class HttpRouteRuleMatchResponseComputeV1 {
  ...
  factory HttpRouteRuleMatchResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return HttpRouteRuleMatchResponseComputeV1(
      ...
      headerMatches: (pulumi.Input.decodeList<HttpHeaderMatchResponseComputeV1>(map['headerMatches'], (value) => HttpHeaderMatchResponseComputeV1.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ignoreCase: (map['ignoreCase'] as bool).input(),
      metadataFilters: (pulumi.Input.decodeList<MetadataFilterResponseComputeV1>(map['metadataFilters'], (value) => MetadataFilterResponseComputeV1.fromMap((value as Map).cast<String, dynamic>()))).input(),
      pathTemplateMatch: (map['pathTemplateMatch'] as String).input(),
      prefixMatch: (map['prefixMatch'] as String).input(),
      queryParameterMatches: (pulumi.Input.decodeList<HttpQueryParameterMatchResponseComputeV1>(map['queryParameterMatches'], (value) => HttpQueryParameterMatchResponseComputeV1.fromMap((value as Map).cast<String, dynamic>()))).input(),
