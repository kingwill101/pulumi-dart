...
class HttpRouteRuleMatchResponseComputeV1 {
  ...
  final pulumi.Input<List<HttpQueryParameterMatchResponseComputeV1>>
    ...
    return <String, dynamic>{
      ...
      'headerMatches':
          pulumi.Input.mapInputValue<
            List<HttpHeaderMatchResponseComputeV1>,
      ...
      'metadataFilters':
          pulumi.Input.mapInputValue<
            List<MetadataFilterResponseComputeV1>,
            List<Map<String, dynamic>>
          >(
            metadataFilters,
            (value) =>
      ...
      'queryParameterMatches':
          pulumi.Input.mapInputValue<
            List<HttpQueryParameterMatchResponseComputeV1>,
            List<Map<String, dynamic>>
          >(
            queryParameterMatches,
            (value) =>
  ...
  factory HttpRouteRuleMatchResponseComputeV1.fromMap(
    ...
    return HttpRouteRuleMatchResponseComputeV1(
      ...
      headerMatches: pulumi.Input.fromValue(
        pulumi.Input.decodeList<HttpHeaderMatchResponseComputeV1>(
          map['headerMatches']!,
          (value) => HttpHeaderMatchResponseComputeV1.fromMap(
      ...
      metadataFilters: pulumi.Input.fromValue(
        pulumi.Input.decodeList<MetadataFilterResponseComputeV1>(
          map['metadataFilters']!,
          (value) => MetadataFilterResponseComputeV1.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      ...
      queryParameterMatches: pulumi.Input.fromValue(
        pulumi.Input.decodeList<HttpQueryParameterMatchResponseComputeV1>(
          map['queryParameterMatches']!,
          (value) => HttpQueryParameterMatchResponseComputeV1.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
