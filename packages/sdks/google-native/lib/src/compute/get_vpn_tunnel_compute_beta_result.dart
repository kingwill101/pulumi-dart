...
class GetVpnTunnelComputeBetaResult {
  ...
  /// Creates a new [GetVpnTunnelComputeBetaResult].
  ...
  const GetVpnTunnelComputeBetaResult({
  ...
  factory GetVpnTunnelComputeBetaResult.fromMap(Map<String, dynamic> map) {
    return GetVpnTunnelComputeBetaResult(
      ...
      localTrafficSelector: (map['localTrafficSelector'] as List).cast<String>(),
      ...
      remoteTrafficSelector: (map['remoteTrafficSelector'] as List).cast<String>(),
