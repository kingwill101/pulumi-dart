...
class PacketMirroringMirroredResourceInfoResponseComputeBeta {
  ...
  final pulumi.Input<
    List<PacketMirroringMirroredResourceInfoInstanceInfoResponseComputeBeta>
  >
  instances;

  /// A set of subnetworks for which traffic from/to all VM instances will be mirrored. They must live in the same region as this packetMirroring. You may specify a maximum of 5 subnetworks.
  final pulumi.Input<
    List<PacketMirroringMirroredResourceInfoSubnetInfoResponseComputeBeta>
  >
  subnetworks;
    ...
    return PacketMirroringMirroredResourceInfoResponseComputeBeta(
      instances: pulumi.Input.fromValue(
        ...
        >(
          map['instances']!,
          (value) =>
              PacketMirroringMirroredResourceInfoInstanceInfoResponseComputeBeta.fromMap(
      ...
      subnetworks: pulumi.Input.fromValue(
        ...
        >(
          map['subnetworks']!,
          (value) =>
              PacketMirroringMirroredResourceInfoSubnetInfoResponseComputeBeta.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
