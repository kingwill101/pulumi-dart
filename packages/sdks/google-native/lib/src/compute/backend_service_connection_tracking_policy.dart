...
import 'backend_service_connection_tracking_policy_connection_persistence_on_unhealthy_backends.dart';
import 'backend_service_connection_tracking_policy_tracking_mode.dart';
...
class BackendServiceConnectionTrackingPolicy {
  ...
  final pulumi.Input<BackendServiceConnectionTrackingPolicyConnectionPersistenceOnUnhealthyBackends>? connectionPersistenceOnUnhealthyBackends;
  ...
  final pulumi.Input<BackendServiceConnectionTrackingPolicyTrackingMode>? trackingMode;

  /// Creates a new [BackendServiceConnectionTrackingPolicy].
  ...
  const BackendServiceConnectionTrackingPolicy({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'connectionPersistenceOnUnhealthyBackends': ?pulumi.Input.mapOptionalInputValue<BackendServiceConnectionTrackingPolicyConnectionPersistenceOnUnhealthyBackends, String>(connectionPersistenceOnUnhealthyBackends, (value) => value.wireValue),
      'enableStrongAffinity': ?enableStrongAffinity,
      'idleTimeoutSec': ?idleTimeoutSec,
      'trackingMode': ?pulumi.Input.mapOptionalInputValue<BackendServiceConnectionTrackingPolicyTrackingMode, String>(trackingMode, (value) => value.wireValue),
    };
  }
  ...
  factory BackendServiceConnectionTrackingPolicy.fromMap(Map<String, dynamic> map) {
    return BackendServiceConnectionTrackingPolicy(
      connectionPersistenceOnUnhealthyBackends: (() { final guardedValue = map['connectionPersistenceOnUnhealthyBackends']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BackendServiceConnectionTrackingPolicyConnectionPersistenceOnUnhealthyBackends.fromValue(guardedValue as String)); })(),
      ...
      trackingMode: (() { final guardedValue = map['trackingMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BackendServiceConnectionTrackingPolicyTrackingMode.fromValue(guardedValue as String)); })(),
    );
  }
}
