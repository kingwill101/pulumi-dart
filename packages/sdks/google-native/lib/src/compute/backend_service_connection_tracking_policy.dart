...
class BackendServiceConnectionTrackingPolicy {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'connectionPersistenceOnUnhealthyBackends': ?pulumi.Input.mapOptionalInputValue<BackendServiceConnectionTrackingPolicyConnectionPersistenceOnUnhealthyBackends, String>(connectionPersistenceOnUnhealthyBackends, (value) => value.value),
      'enableStrongAffinity': ?enableStrongAffinity,
      'idleTimeoutSec': ?idleTimeoutSec,
      'trackingMode': ?pulumi.Input.mapOptionalInputValue<BackendServiceConnectionTrackingPolicyTrackingMode, String>(trackingMode, (value) => value.value),
    };
  }
