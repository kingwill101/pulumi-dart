...
class SslCertificateComputeV1Args {
  ...
  const SslCertificateComputeV1Args({
    this.certificate,
    this.description,
    this.managed,
    this.name,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'type': ?pulumi.Input.mapOptionalInputValue<SslCertificateTypeComputeV1, String>(type, (value) => value.wireValue),
    };
  }
  ...
  factory SslCertificateComputeV1Args.fromMap(Map<String, dynamic> map) {
    return SslCertificateComputeV1Args(
      ...
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SslCertificateTypeComputeV1.fromValue(guardedValue as String)); })(),
    );
  }
}
