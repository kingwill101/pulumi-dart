...
/// {@template pulumi_compute_v1_backend_bucket_iam_member_compute_v1_args_doc}
/// The set of arguments for BackendBucketIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_v1_backend_bucket_iam_member_compute_v1_args_doc}
class BackendBucketIamMemberComputeV1Args {
  ...
  /// Creates a new [BackendBucketIamMemberComputeV1Args].
  ...
  const BackendBucketIamMemberComputeV1Args({
    this.condition,
  ...
  factory BackendBucketIamMemberComputeV1Args.fromMap(Map<String, dynamic> map) {
    return BackendBucketIamMemberComputeV1Args(
