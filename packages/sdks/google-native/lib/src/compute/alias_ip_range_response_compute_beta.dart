...
class AliasIpRangeResponseComputeBeta {
  ...
  /// Creates a new [AliasIpRangeResponseComputeBeta].
  ...
  const AliasIpRangeResponseComputeBeta({
  ...
  factory AliasIpRangeResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return AliasIpRangeResponseComputeBeta(
