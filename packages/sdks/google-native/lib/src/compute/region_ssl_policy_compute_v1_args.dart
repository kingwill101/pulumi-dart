...
class RegionSslPolicyComputeV1Args {
  ...
  const RegionSslPolicyComputeV1Args({
    this.customFeatures,
    this.description,
    this.minTlsVersion,
    this.name,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'minTlsVersion': ?pulumi.Input.mapOptionalInputValue<RegionSslPolicyMinTlsVersionComputeV1, String>(minTlsVersion, (value) => value.wireValue),
      'name': ?name,
      'profile': ?pulumi.Input.mapOptionalInputValue<RegionSslPolicyProfileComputeV1, String>(profile, (value) => value.wireValue),
      'project': ?project,
      'region': region,
      'requestId': ?requestId,
    };
  ...
  factory RegionSslPolicyComputeV1Args.fromMap(Map<String, dynamic> map) {
    return RegionSslPolicyComputeV1Args(
      ...
      minTlsVersion: (() { final guardedValue = map['minTlsVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionSslPolicyMinTlsVersionComputeV1.fromValue(guardedValue as String)); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      profile: (() { final guardedValue = map['profile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionSslPolicyProfileComputeV1.fromValue(guardedValue as String)); })(),
