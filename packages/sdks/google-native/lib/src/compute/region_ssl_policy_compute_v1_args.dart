...
/// {@template pulumi_compute_v1_region_ssl_policy_compute_v1_args_doc}
/// The set of arguments for RegionSslPolicy.
/// {@endtemplate}
/// {@macro pulumi_compute_v1_region_ssl_policy_compute_v1_args_doc}
class RegionSslPolicyComputeV1Args {
  ...
  /// Creates a new [RegionSslPolicyComputeV1Args].
  ...
  RegionSslPolicyComputeV1Args({
    ...
    pulumi.Output<RegionSslPolicyMinTlsVersionComputeV1>? minTlsVersion,
    pulumi.Output<String>? name,
    pulumi.Output<RegionSslPolicyProfileComputeV1>? profile,
    ...
    pulumi.Output<String>? requestId,
      ...
      minTlsVersion = pulumi.Input.asOptionalInput<RegionSslPolicyMinTlsVersionComputeV1>(minTlsVersion),
      name = pulumi.Input.asOptionalInput<String>(name),
      profile = pulumi.Input.asOptionalInput<RegionSslPolicyProfileComputeV1>(profile),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'minTlsVersion': ?pulumi.Input.mapOptionalInputValue<RegionSslPolicyMinTlsVersionComputeV1, String>(minTlsVersion, (value) => value.value),
      'name': ?name,
      'profile': ?pulumi.Input.mapOptionalInputValue<RegionSslPolicyProfileComputeV1, String>(profile, (value) => value.value),
      'project': ?project,
      'region': region,
      'requestId': ?requestId,
    };
  ...
  factory RegionSslPolicyComputeV1Args.fromMap(Map<String, dynamic> map) {
    return RegionSslPolicyComputeV1Args(
      ...
      minTlsVersion: map['minTlsVersion'] == null ? null : pulumi.Output.create<RegionSslPolicyMinTlsVersionComputeV1>(RegionSslPolicyMinTlsVersionComputeV1.fromValue(map['minTlsVersion'] as String)),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      profile: map['profile'] == null ? null : pulumi.Output.create<RegionSslPolicyProfileComputeV1>(RegionSslPolicyProfileComputeV1.fromValue(map['profile'] as String)),
