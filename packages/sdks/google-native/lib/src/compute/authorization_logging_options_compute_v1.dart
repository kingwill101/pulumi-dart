...
class AuthorizationLoggingOptionsComputeV1 {
  /// This is deprecated and has no effect. Do not use.
  final pulumi.Input<AuthorizationLoggingOptionsPermissionTypeComputeV1>?
  permissionType;

  /// Creates a new [AuthorizationLoggingOptionsComputeV1].
  /// [permissionType] This is deprecated and has no effect. Do not use.
  AuthorizationLoggingOptionsComputeV1({this.permissionType});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'permissionType':
          ?pulumi.Input.mapOptionalInputValue<
            AuthorizationLoggingOptionsPermissionTypeComputeV1,
            String
