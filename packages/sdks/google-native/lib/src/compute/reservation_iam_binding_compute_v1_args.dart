...
/// {@template pulumi_compute_v1_reservation_iam_binding_compute_v1_args_doc}
/// The set of arguments for ReservationIamBinding.
/// {@endtemplate}
/// {@macro pulumi_compute_v1_reservation_iam_binding_compute_v1_args_doc}
class ReservationIamBindingComputeV1Args {
  ...
  /// Creates a new [ReservationIamBindingComputeV1Args].
  ...
  const ReservationIamBindingComputeV1Args({
    this.condition,
  ...
  factory ReservationIamBindingComputeV1Args.fromMap(Map<String, dynamic> map) {
    return ReservationIamBindingComputeV1Args(
