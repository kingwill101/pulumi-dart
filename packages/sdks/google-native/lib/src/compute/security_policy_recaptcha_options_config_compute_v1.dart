...
class SecurityPolicyRecaptchaOptionsConfigComputeV1 {
  ...
  /// Creates a new [SecurityPolicyRecaptchaOptionsConfigComputeV1].
  ...
  SecurityPolicyRecaptchaOptionsConfigComputeV1({this.redirectSiteKey});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'redirectSiteKey': ?redirectSiteKey};
  }

  factory SecurityPolicyRecaptchaOptionsConfigComputeV1.fromMap(
    Map<String, dynamic> map,
  ) {
    return SecurityPolicyRecaptchaOptionsConfigComputeV1(
      redirectSiteKey: (() {
        final guardedValue = map['redirectSiteKey'];
