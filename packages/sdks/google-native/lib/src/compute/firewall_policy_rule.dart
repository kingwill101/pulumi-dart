...
class FirewallPolicyRule {
  ...
  final pulumi.Input<FirewallPolicyRuleDirection>? direction;
  ...
  final pulumi.Input<FirewallPolicyRuleMatcher>? match;
  ...
  final pulumi.Input<List<FirewallPolicyRuleSecureTag>>? targetSecureTags;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'direction': ?pulumi.Input.mapOptionalInputValue<FirewallPolicyRuleDirection, String>(direction, (value) => value.wireValue),
      'disabled': ?disabled,
      'enableLogging': ?enableLogging,
      'match': ?pulumi.Input.mapOptionalInputValue<FirewallPolicyRuleMatcher, Map<String, dynamic>>(match, (value) => value.toMap()),
      'priority': ?priority,
      'ruleName': ?ruleName,
      'securityProfileGroup': ?securityProfileGroup,
      'targetResources': ?targetResources,
      'targetSecureTags': ?pulumi.Input.mapOptionalInputValue<List<FirewallPolicyRuleSecureTag>, List<Map<String, dynamic>>>(targetSecureTags, (value) => pulumi.Input.encodeList<FirewallPolicyRuleSecureTag, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory FirewallPolicyRule.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyRule(
      ...
      direction: (() { final guardedValue = map['direction']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FirewallPolicyRuleDirection.fromValue(guardedValue as String)); })(),
      ...
      match: (() { final guardedValue = map['match']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FirewallPolicyRuleMatcher.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      targetSecureTags: (() { final guardedValue = map['targetSecureTags']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FirewallPolicyRuleSecureTag>(guardedValue, (value) => FirewallPolicyRuleSecureTag.fromMap((value as Map).cast<String, dynamic>()))); })(),
