...
class SubnetworkComputeV1Args {
  ...
  factory SubnetworkComputeV1Args.fromMap(Map<String, dynamic> map) {
    return SubnetworkComputeV1Args(
      ...
      ipv6AccessType: map['ipv6AccessType'] == null ? null : (SubnetworkIpv6AccessTypeComputeV1.fromValue(map['ipv6AccessType'] as String)).input(),
      logConfig: map['logConfig'] == null ? null : (SubnetworkLogConfigComputeV1.fromMap((map['logConfig'] as Map).cast<String, dynamic>())).input(),
      name: map['name'] == null ? null : (map['name'] as String).input(),
      network: map['network'] == null ? null : (map['network'] as String).input(),
      privateIpGoogleAccess: map['privateIpGoogleAccess'] == null ? null : (map['privateIpGoogleAccess'] as bool).input(),
      privateIpv6GoogleAccess: map['privateIpv6GoogleAccess'] == null ? null : (SubnetworkPrivateIpv6GoogleAccessComputeV1.fromValue(map['privateIpv6GoogleAccess'] as String)).input(),
      project: map['project'] == null ? null : (map['project'] as String).input(),
      purpose: map['purpose'] == null ? null : (SubnetworkPurposeComputeV1.fromValue(map['purpose'] as String)).input(),
      region: (map['region'] as String).input(),
      requestId: map['requestId'] == null ? null : (map['requestId'] as String).input(),
      role: map['role'] == null ? null : (SubnetworkRoleComputeV1.fromValue(map['role'] as String)).input(),
      secondaryIpRanges: map['secondaryIpRanges'] == null ? null : (pulumi.Input.decodeList<SubnetworkSecondaryRangeComputeV1>(map['secondaryIpRanges'], (value) => SubnetworkSecondaryRangeComputeV1.fromMap((value as Map).cast<String, dynamic>()))).input(),
      stackType: map['stackType'] == null ? null : (SubnetworkStackTypeComputeV1.fromValue(map['stackType'] as String)).input(),
    );
  }
}
