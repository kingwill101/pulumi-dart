    ...
    return SubnetworkComputeV1Args(
      ...
      ipv6AccessType: (() {
        ...
        return pulumi.Input.fromValue(
          SubnetworkIpv6AccessTypeComputeV1.fromValue(guardedValue as String),
        );
      })(),
      logConfig: (() {
      ...
      purpose: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SubnetworkPurposeComputeV1.fromValue(guardedValue as String),
        );
      })(),
      ...
      role: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SubnetworkRoleComputeV1.fromValue(guardedValue as String),
        );
      })(),
      secondaryIpRanges: (() {
      ...
      stackType: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SubnetworkStackTypeComputeV1.fromValue(guardedValue as String),
        );
      })(),
    );
  }
