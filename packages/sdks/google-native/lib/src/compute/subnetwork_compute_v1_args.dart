...
class SubnetworkComputeV1Args {
  ...
  SubnetworkComputeV1Args({
    ...
    pulumi.Output<SubnetworkIpv6AccessTypeComputeV1>? ipv6AccessType,
    pulumi.Output<SubnetworkLogConfigComputeV1>? logConfig,
    pulumi.Output<String>? name,
    pulumi.Output<String>? network,
    pulumi.Output<bool>? privateIpGoogleAccess,
    pulumi.Output<SubnetworkPrivateIpv6GoogleAccessComputeV1>? privateIpv6GoogleAccess,
    pulumi.Output<String>? project,
    pulumi.Output<SubnetworkPurposeComputeV1>? purpose,
    required pulumi.Output<String> region,
    pulumi.Output<String>? requestId,
    pulumi.Output<SubnetworkRoleComputeV1>? role,
    pulumi.Output<List<SubnetworkSecondaryRangeComputeV1>>? secondaryIpRanges,
    pulumi.Output<SubnetworkStackTypeComputeV1>? stackType,
  }) :
  ...
  factory SubnetworkComputeV1Args.fromMap(Map<String, dynamic> map) {
    return SubnetworkComputeV1Args(
      ...
      ipv6AccessType: map['ipv6AccessType'] == null ? null : pulumi.Output.create<SubnetworkIpv6AccessTypeComputeV1>(SubnetworkIpv6AccessTypeComputeV1.fromValue(map['ipv6AccessType'] as String)),
      logConfig: map['logConfig'] == null ? null : pulumi.Output.create<SubnetworkLogConfigComputeV1>(SubnetworkLogConfigComputeV1.fromMap((map['logConfig'] as Map).cast<String, dynamic>())),
      ...
      privateIpv6GoogleAccess: map['privateIpv6GoogleAccess'] == null ? null : pulumi.Output.create<SubnetworkPrivateIpv6GoogleAccessComputeV1>(SubnetworkPrivateIpv6GoogleAccessComputeV1.fromValue(map['privateIpv6GoogleAccess'] as String)),
      project: map['project'] == null ? null : pulumi.Output.create<String>(map['project'] as String),
      purpose: map['purpose'] == null ? null : pulumi.Output.create<SubnetworkPurposeComputeV1>(SubnetworkPurposeComputeV1.fromValue(map['purpose'] as String)),
      region: pulumi.Output.create<String>(map['region'] as String),
      requestId: map['requestId'] == null ? null : pulumi.Output.create<String>(map['requestId'] as String),
      role: map['role'] == null ? null : pulumi.Output.create<SubnetworkRoleComputeV1>(SubnetworkRoleComputeV1.fromValue(map['role'] as String)),
      secondaryIpRanges: map['secondaryIpRanges'] == null ? null : pulumi.Output.create<List<SubnetworkSecondaryRangeComputeV1>>(pulumi.Input.decodeList<SubnetworkSecondaryRangeComputeV1>(map['secondaryIpRanges'], (value) => SubnetworkSecondaryRangeComputeV1.fromMap((value as Map).cast<String, dynamic>()))),
      stackType: map['stackType'] == null ? null : pulumi.Output.create<SubnetworkStackTypeComputeV1>(SubnetworkStackTypeComputeV1.fromValue(map['stackType'] as String)),
    );
  }
}
