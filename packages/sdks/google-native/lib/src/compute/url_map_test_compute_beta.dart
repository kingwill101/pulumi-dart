...
class UrlMapTestComputeBeta {
  ...
  final List<UrlMapTestHeaderComputeBeta>? headers;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'headers': ?headers == null ? null : pulumi.Input.encodeList<UrlMapTestHeaderComputeBeta, Map<String, dynamic>>(headers!, (value) => value.toMap()),
      'host': ?host,
      'path': ?path,
      'service': ?service,
    };
  ...
  factory UrlMapTestComputeBeta.fromMap(Map<String, dynamic> map) {
    return UrlMapTestComputeBeta(
      ...
      expectedOutputUrl: map['expectedOutputUrl'] == null ? null : map['expectedOutputUrl'] as String,
      expectedRedirectResponseCode: map['expectedRedirectResponseCode'] == null ? null : map['expectedRedirectResponseCode'] as int,
      headers: map['headers'] == null ? null : pulumi.Input.decodeList<UrlMapTestHeaderComputeBeta>(map['headers'], (value) => UrlMapTestHeaderComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
