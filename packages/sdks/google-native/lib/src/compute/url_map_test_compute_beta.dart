...
class UrlMapTestComputeBeta {
    ...
    return <String, dynamic>{
      ...
      'headers':
          ?pulumi.Input.mapOptionalInputValue<
            List<UrlMapTestHeaderComputeBeta>,
  ...
  factory UrlMapTestComputeBeta.fromMap(Map<String, dynamic> map) {
    return UrlMapTestComputeBeta(
      ...
      expectedOutputUrl: (() {
        final guardedValue = map['expectedOutputUrl'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      expectedRedirectResponseCode: (() {
        final guardedValue = map['expectedRedirectResponseCode'];
        if (guardedValue == null) return null;
      ...
      headers: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<UrlMapTestHeaderComputeBeta>(
            guardedValue,
            (value) => UrlMapTestHeaderComputeBeta.fromMap(
