...
class RegionSslCertificateComputeBetaArgs {
  ...
  RegionSslCertificateComputeBetaArgs({
    ...
    pulumi.Output<RegionSslCertificateTypeComputeBeta>? type,
  }) :
      ...
      type = pulumi.Input.asOptionalInput<RegionSslCertificateTypeComputeBeta>(type);
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'type': ?pulumi.Input.mapOptionalInputValue<RegionSslCertificateTypeComputeBeta, String>(type, (value) => value.value),
    };
  }
  ...
  factory RegionSslCertificateComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return RegionSslCertificateComputeBetaArgs(
      ...
      type: map['type'] == null ? null : pulumi.Output.create<RegionSslCertificateTypeComputeBeta>(RegionSslCertificateTypeComputeBeta.fromValue(map['type'] as String)),
    );
  }
}
