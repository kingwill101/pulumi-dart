...
class RegionSslCertificateComputeBetaArgs {
  ...
  const RegionSslCertificateComputeBetaArgs({
    this.certificate,
    this.description,
    this.managed,
    this.name,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'type': ?pulumi.Input.mapOptionalInputValue<RegionSslCertificateTypeComputeBeta, String>(type, (value) => value.wireValue),
    };
  }

  factory RegionSslCertificateComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return RegionSslCertificateComputeBetaArgs(
      ...
      managed: (() { final guardedValue = map['managed']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SslCertificateManagedSslCertificateComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      privateKey: (() { final guardedValue = map['privateKey']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      project: (() { final guardedValue = map['project']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      region: pulumi.Input.fromValue(map['region'] as String),
      requestId: (() { final guardedValue = map['requestId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      selfManaged: (() { final guardedValue = map['selfManaged']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SslCertificateSelfManagedSslCertificateComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionSslCertificateTypeComputeBeta.fromValue(guardedValue as String)); })(),
    );
  }
}
