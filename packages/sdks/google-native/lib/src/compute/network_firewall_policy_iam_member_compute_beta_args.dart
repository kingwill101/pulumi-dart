...
/// {@template pulumi_compute_beta_network_firewall_policy_iam_member_compute_beta_args_doc}
/// The set of arguments for NetworkFirewallPolicyIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_network_firewall_policy_iam_member_compute_beta_args_doc}
class NetworkFirewallPolicyIamMemberComputeBetaArgs {
  ...
  /// Creates a new [NetworkFirewallPolicyIamMemberComputeBetaArgs].
  ...
  const NetworkFirewallPolicyIamMemberComputeBetaArgs({
    this.condition,
  ...
  factory NetworkFirewallPolicyIamMemberComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return NetworkFirewallPolicyIamMemberComputeBetaArgs(
