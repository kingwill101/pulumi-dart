...
/// {@template pulumi_compute_alpha_reservation_iam_member_args_doc}
/// The set of arguments for ReservationIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_alpha_reservation_iam_member_args_doc}
class ReservationIamMemberArgs {
  ...
  /// Creates a new [ReservationIamMemberArgs].
  ...
  const ReservationIamMemberArgs({
    this.condition,
  ...
  factory ReservationIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return ReservationIamMemberArgs(
