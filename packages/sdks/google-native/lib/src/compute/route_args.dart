...
class RouteArgs {
  ...
  RouteArgs({
    pulumi.Output<bool>? allowConflictingSubnetworks,
    pulumi.Output<String>? description,
    pulumi.Output<String>? destRange,
    pulumi.Output<RouteIlbRouteBehaviorOnUnhealthy>? ilbRouteBehaviorOnUnhealthy,
  ...
  factory RouteArgs.fromMap(Map<String, dynamic> map) {
    return RouteArgs(
      allowConflictingSubnetworks: map['allowConflictingSubnetworks'] == null ? null : pulumi.Output.create<bool>(map['allowConflictingSubnetworks'] as bool),
      description: map['description'] == null ? null : pulumi.Output.create<String>(map['description'] as String),
      destRange: map['destRange'] == null ? null : pulumi.Output.create<String>(map['destRange'] as String),
      ilbRouteBehaviorOnUnhealthy: map['ilbRouteBehaviorOnUnhealthy'] == null ? null : pulumi.Output.create<RouteIlbRouteBehaviorOnUnhealthy>(RouteIlbRouteBehaviorOnUnhealthy.fromValue(map['ilbRouteBehaviorOnUnhealthy'] as String)),
