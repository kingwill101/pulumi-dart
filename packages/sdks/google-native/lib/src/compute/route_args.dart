    ...
    return <String, dynamic>{
      ...
      'ilbRouteBehaviorOnUnhealthy':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(ilbRouteBehaviorOnUnhealthy, (value) => value.wireValue),
      'name': ?name,
      'network': ?network,
  ...
  factory RouteArgs.fromMap(Map<String, dynamic> map) {
    return RouteArgs(
      allowConflictingSubnetworks: (() {
        final guardedValue = map['allowConflictingSubnetworks'];
      ...
      ilbRouteBehaviorOnUnhealthy: (() {
        final guardedValue = map['ilbRouteBehaviorOnUnhealthy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RouteIlbRouteBehaviorOnUnhealthy.fromValue(guardedValue as String),
        );
      })(),
      name: (() {
