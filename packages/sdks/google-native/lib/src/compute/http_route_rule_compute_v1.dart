...
class HttpRouteRuleComputeV1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'matchRules': ?matchRules == null ? null : pulumi.Input.encodeList<HttpRouteRuleMatchComputeV1, Map<String, dynamic>>(matchRules!, (value) => value.toMap()),
      'priority': ?priority,
  ...
  factory HttpRouteRuleComputeV1.fromMap(Map<String, dynamic> map) {
    return HttpRouteRuleComputeV1(
      ...
      matchRules: map['matchRules'] == null ? null : pulumi.Input.decodeList<HttpRouteRuleMatchComputeV1>(map['matchRules'], (value) => HttpRouteRuleMatchComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      priority: map['priority'] == null ? null : map['priority'] as int,
      routeAction: map['routeAction'] == null ? null : HttpRouteActionComputeV1.fromMap((map['routeAction'] as Map).cast<String, dynamic>()),
      service: map['service'] == null ? null : map['service'] as String,
      urlRedirect: map['urlRedirect'] == null ? null : HttpRedirectActionComputeV1.fromMap((map['urlRedirect'] as Map).cast<String, dynamic>()),
    );
  }
}
