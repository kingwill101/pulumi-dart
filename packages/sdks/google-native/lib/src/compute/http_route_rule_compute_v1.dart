...
class HttpRouteRuleComputeV1 {
  ...
  final pulumi.Input<List<HttpRouteRuleMatchComputeV1>>? matchRules;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'matchRules': ?pulumi.Input.mapOptionalInputValue<List<HttpRouteRuleMatchComputeV1>, List<Map<String, dynamic>>>(matchRules, (value) => pulumi.Input.encodeList<HttpRouteRuleMatchComputeV1, Map<String, dynamic>>(value, (value) => value.toMap())),
      'priority': ?priority,
  ...
  factory HttpRouteRuleComputeV1.fromMap(Map<String, dynamic> map) {
    return HttpRouteRuleComputeV1(
      ...
      matchRules: (() { final guardedValue = map['matchRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<HttpRouteRuleMatchComputeV1>(guardedValue, (value) => HttpRouteRuleMatchComputeV1.fromMap((value as Map).cast<String, dynamic>()))); })(),
