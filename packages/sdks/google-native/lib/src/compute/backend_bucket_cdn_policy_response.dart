...
class BackendBucketCdnPolicyResponse {
  ...
  final pulumi.Input<
    List<BackendBucketCdnPolicyBypassCacheOnRequestHeaderResponse>
  >
  bypassCacheOnRequestHeaders;

  /// The CacheKeyPolicy for this CdnPolicy.
  final pulumi.Input<BackendBucketCdnPolicyCacheKeyPolicyResponse>
  cacheKeyPolicy;
  ...
  final pulumi.Input<List<BackendBucketCdnPolicyNegativeCachingPolicyResponse>>
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'negativeCachingPolicy':
          pulumi.Input.mapInputValue<
            List<BackendBucketCdnPolicyNegativeCachingPolicyResponse>,
            List<Map<String, dynamic>>
          >(
            negativeCachingPolicy,
            (value) =>
    ...
    return BackendBucketCdnPolicyResponse(
      bypassCacheOnRequestHeaders: pulumi.Input.fromValue(
        ...
        >(
          ...
          (value) =>
              BackendBucketCdnPolicyBypassCacheOnRequestHeaderResponse.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
      cacheKeyPolicy: pulumi.Input.fromValue(
        BackendBucketCdnPolicyCacheKeyPolicyResponse.fromMap(
      ...
      negativeCachingPolicy: pulumi.Input.fromValue(
        ...
        >(
          ...
          (value) =>
              BackendBucketCdnPolicyNegativeCachingPolicyResponse.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
