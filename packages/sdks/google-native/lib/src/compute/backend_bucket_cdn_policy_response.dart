...
import 'backend_bucket_cdn_policy_bypass_cache_on_request_header_response.dart';
import 'backend_bucket_cdn_policy_cache_key_policy_response.dart';
import 'backend_bucket_cdn_policy_negative_caching_policy_response.dart';

/// Message containing Cloud CDN configuration for a backend bucket.
class BackendBucketCdnPolicyResponse {
  /// Bypass the cache when the specified request headers are matched - e.g. Pragma or Authorization headers. Up to 5 headers can be specified. The cache is bypassed for all cdnPolicy.cacheMode settings.
  final pulumi.Input<List<BackendBucketCdnPolicyBypassCacheOnRequestHeaderResponse>> bypassCacheOnRequestHeaders;
  /// The CacheKeyPolicy for this CdnPolicy.
  final pulumi.Input<BackendBucketCdnPolicyCacheKeyPolicyResponse> cacheKeyPolicy;
  ...
  final pulumi.Input<List<BackendBucketCdnPolicyNegativeCachingPolicyResponse>> negativeCachingPolicy;
  ...
  /// Creates a new [BackendBucketCdnPolicyResponse].
  ...
  const BackendBucketCdnPolicyResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'bypassCacheOnRequestHeaders': pulumi.Input.mapInputValue<List<BackendBucketCdnPolicyBypassCacheOnRequestHeaderResponse>, List<Map<String, dynamic>>>(bypassCacheOnRequestHeaders, (value) => pulumi.Input.encodeList<BackendBucketCdnPolicyBypassCacheOnRequestHeaderResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'cacheKeyPolicy': pulumi.Input.mapInputValue<BackendBucketCdnPolicyCacheKeyPolicyResponse, Map<String, dynamic>>(cacheKeyPolicy, (value) => value.toMap()),
      'cacheMode': cacheMode,
      'clientTtl': clientTtl,
      'defaultTtl': defaultTtl,
      'maxTtl': maxTtl,
      'negativeCaching': negativeCaching,
      'negativeCachingPolicy': pulumi.Input.mapInputValue<List<BackendBucketCdnPolicyNegativeCachingPolicyResponse>, List<Map<String, dynamic>>>(negativeCachingPolicy, (value) => pulumi.Input.encodeList<BackendBucketCdnPolicyNegativeCachingPolicyResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory BackendBucketCdnPolicyResponse.fromMap(Map<String, dynamic> map) {
    return BackendBucketCdnPolicyResponse(
      bypassCacheOnRequestHeaders: pulumi.Input.fromValue(pulumi.Input.decodeList<BackendBucketCdnPolicyBypassCacheOnRequestHeaderResponse>(map['bypassCacheOnRequestHeaders']!, (value) => BackendBucketCdnPolicyBypassCacheOnRequestHeaderResponse.fromMap((value as Map).cast<String, dynamic>()))),
      cacheKeyPolicy: pulumi.Input.fromValue(BackendBucketCdnPolicyCacheKeyPolicyResponse.fromMap((map['cacheKeyPolicy']! as Map).cast<String, dynamic>())),
      ...
      negativeCachingPolicy: pulumi.Input.fromValue(pulumi.Input.decodeList<BackendBucketCdnPolicyNegativeCachingPolicyResponse>(map['negativeCachingPolicy']!, (value) => BackendBucketCdnPolicyNegativeCachingPolicyResponse.fromMap((value as Map).cast<String, dynamic>()))),
