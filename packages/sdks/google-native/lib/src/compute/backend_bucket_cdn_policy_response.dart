...
class BackendBucketCdnPolicyResponse {
  ...
  final List<BackendBucketCdnPolicyBypassCacheOnRequestHeaderResponse> bypassCacheOnRequestHeaders;
  /// The CacheKeyPolicy for this CdnPolicy.
  final BackendBucketCdnPolicyCacheKeyPolicyResponse cacheKeyPolicy;
  ...
  final List<BackendBucketCdnPolicyNegativeCachingPolicyResponse> negativeCachingPolicy;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'bypassCacheOnRequestHeaders': pulumi.Input.encodeList<BackendBucketCdnPolicyBypassCacheOnRequestHeaderResponse, Map<String, dynamic>>(bypassCacheOnRequestHeaders, (value) => value.toMap()),
      ...
      'negativeCachingPolicy': pulumi.Input.encodeList<BackendBucketCdnPolicyNegativeCachingPolicyResponse, Map<String, dynamic>>(negativeCachingPolicy, (value) => value.toMap()),
  ...
  factory BackendBucketCdnPolicyResponse.fromMap(Map<String, dynamic> map) {
    return BackendBucketCdnPolicyResponse(
      bypassCacheOnRequestHeaders: pulumi.Input.decodeList<BackendBucketCdnPolicyBypassCacheOnRequestHeaderResponse>(map['bypassCacheOnRequestHeaders'], (value) => BackendBucketCdnPolicyBypassCacheOnRequestHeaderResponse.fromMap((value as Map).cast<String, dynamic>())),
      cacheKeyPolicy: BackendBucketCdnPolicyCacheKeyPolicyResponse.fromMap((map['cacheKeyPolicy'] as Map).cast<String, dynamic>()),
      ...
      negativeCachingPolicy: pulumi.Input.decodeList<BackendBucketCdnPolicyNegativeCachingPolicyResponse>(map['negativeCachingPolicy'], (value) => BackendBucketCdnPolicyNegativeCachingPolicyResponse.fromMap((value as Map).cast<String, dynamic>())),
