...
class TargetInstanceComputeV1Args {
  ...
  TargetInstanceComputeV1Args({
    ...
    pulumi.Output<TargetInstanceNatPolicyComputeV1>? natPolicy,
  ...
  factory TargetInstanceComputeV1Args.fromMap(Map<String, dynamic> map) {
    return TargetInstanceComputeV1Args(
      ...
      natPolicy: map['natPolicy'] == null ? null : pulumi.Output.create<TargetInstanceNatPolicyComputeV1>(TargetInstanceNatPolicyComputeV1.fromValue(map['natPolicy'] as String)),
