...
class TargetInstanceComputeV1Args {
  ...
  /// [zone] Optional.
  const TargetInstanceComputeV1Args({
    this.description,
    this.instance,
    this.name,
    this.natPolicy,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'instance': ?instance,
      'name': ?name,
      'natPolicy': ?pulumi.Input.mapOptionalInputValue<TargetInstanceNatPolicyComputeV1, String>(natPolicy, (value) => value.wireValue),
      'network': ?network,
      'project': ?project,
      'requestId': ?requestId,
      'zone': ?zone,
  ...
  factory TargetInstanceComputeV1Args.fromMap(Map<String, dynamic> map) {
    return TargetInstanceComputeV1Args(
      ...
      natPolicy: (() { final guardedValue = map['natPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TargetInstanceNatPolicyComputeV1.fromValue(guardedValue as String)); })(),
