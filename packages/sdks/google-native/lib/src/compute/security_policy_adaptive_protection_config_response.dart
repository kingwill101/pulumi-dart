...
class SecurityPolicyAdaptiveProtectionConfigResponse {
  ...
  const SecurityPolicyAdaptiveProtectionConfigResponse({
  ...
  factory SecurityPolicyAdaptiveProtectionConfigResponse.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyAdaptiveProtectionConfigResponse(
      autoDeployConfig: pulumi.Input.fromValue(SecurityPolicyAdaptiveProtectionConfigAutoDeployConfigResponse.fromMap((map['autoDeployConfig']! as Map).cast<String, dynamic>())),
      layer7DdosDefenseConfig: pulumi.Input.fromValue(SecurityPolicyAdaptiveProtectionConfigLayer7DdosDefenseConfigResponse.fromMap((map['layer7DdosDefenseConfig']! as Map).cast<String, dynamic>())),
    );
  }
}
