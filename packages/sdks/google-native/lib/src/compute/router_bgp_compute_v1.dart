...
class RouterBgpComputeV1 {
  ...
  final pulumi.Input<List<RouterBgpAdvertisedGroupsItemComputeV1>>?
  advertisedGroups;
    ...
    return <String, dynamic>{
      'advertiseMode':
          ?pulumi.Input.mapOptionalInputValue<
            RouterBgpAdvertiseModeComputeV1,
            String
          >(advertiseMode, (value) => value.wireValue),
      'advertisedGroups':
          ?pulumi.Input.mapOptionalInputValue<
            List<RouterBgpAdvertisedGroupsItemComputeV1>,
            List<String>
          >(
            advertisedGroups,
            (value) =>
    ...
    return RouterBgpComputeV1(
      advertiseMode: (() {
        ...
        return pulumi.Input.fromValue(
          RouterBgpAdvertiseModeComputeV1.fromValue(guardedValue as String),
        );
      })(),
      advertisedGroups: (() {
