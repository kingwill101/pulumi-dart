...
class GrpcServiceConfigResponse {
  ...
  factory GrpcServiceConfigResponse.fromMap(Map<String, dynamic> map) {
    return GrpcServiceConfigResponse(
      callCredentials: pulumi.Input.fromValue(CallCredentialsResponse.fromMap((map['callCredentials']! as Map).cast<String, dynamic>())),
      channelCredentials: pulumi.Input.fromValue(ChannelCredentialsResponse.fromMap((map['channelCredentials']! as Map).cast<String, dynamic>())),
