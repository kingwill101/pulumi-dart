...
class CommitmentResourceStatusCancellationInformationResponse {
  ...
  factory CommitmentResourceStatusCancellationInformationResponse.fromMap(Map<String, dynamic> map) {
    return CommitmentResourceStatusCancellationInformationResponse(
      canceledCommitment: pulumi.Input.fromValue(MoneyResponse.fromMap((map['canceledCommitment']! as Map).cast<String, dynamic>())),
      canceledCommitmentLastUpdatedTimestamp: pulumi.Input.fromValue(map['canceledCommitmentLastUpdatedTimestamp'] as String),
      cancellationCap: pulumi.Input.fromValue(MoneyResponse.fromMap((map['cancellationCap']! as Map).cast<String, dynamic>())),
      cancellationFee: pulumi.Input.fromValue(MoneyResponse.fromMap((map['cancellationFee']! as Map).cast<String, dynamic>())),
      cancellationFeeExpirationTimestamp: pulumi.Input.fromValue(map['cancellationFeeExpirationTimestamp'] as String),
    );
  }
}
