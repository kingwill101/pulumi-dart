...
class ImageRawDiskComputeV1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'containerType': ?pulumi.Input.mapOptionalInputValue<ImageRawDiskContainerTypeComputeV1, String>(containerType, (value) => value.wireValue),
  ...
  factory ImageRawDiskComputeV1.fromMap(Map<String, dynamic> map) {
    return ImageRawDiskComputeV1(
      containerType: (() { final guardedValue = map['containerType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ImageRawDiskContainerTypeComputeV1.fromValue(guardedValue as String)); })(),
