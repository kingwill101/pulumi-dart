    ...
    return <String, dynamic>{
      'containerType':
          ?pulumi.Input.mapOptionalInputValue<
            ImageRawDiskContainerTypeComputeV1,
            String
          >(containerType, (value) => value.wireValue),
    ...
    return ImageRawDiskComputeV1(
      containerType: (() {
        ...
        return pulumi.Input.fromValue(
          ImageRawDiskContainerTypeComputeV1.fromValue(guardedValue as String),
        );
      })(),
      sha1Checksum: (() {
        final guardedValue = map['sha1Checksum'];
        if (guardedValue == null) return null;
