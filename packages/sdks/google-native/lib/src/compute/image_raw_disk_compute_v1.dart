...
class ImageRawDiskComputeV1 {
  ...
  final ImageRawDiskContainerTypeComputeV1? containerType;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'containerType': ?containerType == null ? null : containerType!.value,
  ...
  factory ImageRawDiskComputeV1.fromMap(Map<String, dynamic> map) {
    return ImageRawDiskComputeV1(
      containerType: map['containerType'] == null ? null : ImageRawDiskContainerTypeComputeV1.fromValue(map['containerType'] as String),
      sha1Checksum: map['sha1Checksum'] == null ? null : map['sha1Checksum'] as String,
