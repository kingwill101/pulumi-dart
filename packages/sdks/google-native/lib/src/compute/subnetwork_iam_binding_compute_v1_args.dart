...
/// {@template pulumi_compute_v1_subnetwork_iam_binding_compute_v1_args_doc}
/// The set of arguments for SubnetworkIamBinding.
/// {@endtemplate}
/// {@macro pulumi_compute_v1_subnetwork_iam_binding_compute_v1_args_doc}
class SubnetworkIamBindingComputeV1Args {
  ...
  /// Creates a new [SubnetworkIamBindingComputeV1Args].
  ...
  const SubnetworkIamBindingComputeV1Args({
    this.condition,
