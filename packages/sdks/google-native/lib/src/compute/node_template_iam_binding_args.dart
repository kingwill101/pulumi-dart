...
/// {@template pulumi_compute_alpha_node_template_iam_binding_args_doc}
/// The set of arguments for NodeTemplateIamBinding.
/// {@endtemplate}
/// {@macro pulumi_compute_alpha_node_template_iam_binding_args_doc}
class NodeTemplateIamBindingArgs {
  ...
  /// Creates a new [NodeTemplateIamBindingArgs].
  ...
  const NodeTemplateIamBindingArgs({
    this.condition,
  ...
  factory NodeTemplateIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return NodeTemplateIamBindingArgs(
