...
class SubsettingComputeBeta {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'policy': ?pulumi.Input.mapOptionalInputValue<SubsettingPolicyComputeBeta, String>(policy, (value) => value.wireValue),
  ...
  factory SubsettingComputeBeta.fromMap(Map<String, dynamic> map) {
    return SubsettingComputeBeta(
      policy: (() { final guardedValue = map['policy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SubsettingPolicyComputeBeta.fromValue(guardedValue as String)); })(),
