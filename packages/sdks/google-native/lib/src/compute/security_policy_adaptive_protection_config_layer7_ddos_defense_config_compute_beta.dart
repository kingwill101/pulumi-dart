...
class SecurityPolicyAdaptiveProtectionConfigLayer7DdosDefenseConfigComputeBeta {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'enable': ?enable,
      'ruleVisibility': ?pulumi.Input.mapOptionalInputValue<SecurityPolicyAdaptiveProtectionConfigLayer7DdosDefenseConfigRuleVisibilityComputeBeta, String>(ruleVisibility, (value) => value.wireValue),
  ...
  factory SecurityPolicyAdaptiveProtectionConfigLayer7DdosDefenseConfigComputeBeta.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyAdaptiveProtectionConfigLayer7DdosDefenseConfigComputeBeta(
      ...
      ruleVisibility: (() { final guardedValue = map['ruleVisibility']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SecurityPolicyAdaptiveProtectionConfigLayer7DdosDefenseConfigRuleVisibilityComputeBeta.fromValue(guardedValue as String)); })(),
      thresholdConfigs: (() { final guardedValue = map['thresholdConfigs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SecurityPolicyAdaptiveProtectionConfigLayer7DdosDefenseConfigThresholdConfigComputeBeta>(guardedValue, (value) => SecurityPolicyAdaptiveProtectionConfigLayer7DdosDefenseConfigThresholdConfigComputeBeta.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
