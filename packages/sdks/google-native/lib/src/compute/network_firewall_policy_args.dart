...
class NetworkFirewallPolicyArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'shortName': ?shortName,
      'vpcNetworkScope': ?pulumi.Input.mapOptionalInputValue<NetworkFirewallPolicyVpcNetworkScope, String>(vpcNetworkScope, (value) => value.wireValue),
    };
  }
  ...
  factory NetworkFirewallPolicyArgs.fromMap(Map<String, dynamic> map) {
    return NetworkFirewallPolicyArgs(
      ...
      vpcNetworkScope: (() { final guardedValue = map['vpcNetworkScope']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkFirewallPolicyVpcNetworkScope.fromValue(guardedValue as String)); })(),
    );
  }
}
