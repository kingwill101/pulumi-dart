...
class RegionBackendServiceComputeBetaArgs {
  ...
  RegionBackendServiceComputeBetaArgs({
    ...
    pulumi.Output<RegionBackendServiceCompressionModeComputeBeta>? compressionMode,
    ...
    pulumi.Output<RegionBackendServiceIpAddressSelectionPolicyComputeBeta>? ipAddressSelectionPolicy,
    pulumi.Output<RegionBackendServiceLoadBalancingSchemeComputeBeta>? loadBalancingScheme,
    pulumi.Output<List<BackendServiceLocalityLoadBalancingPolicyConfigComputeBeta>>? localityLbPolicies,
    pulumi.Output<RegionBackendServiceLocalityLbPolicyComputeBeta>? localityLbPolicy,
    ...
    pulumi.Output<RegionBackendServiceProtocolComputeBeta>? protocol,
    ...
    pulumi.Output<RegionBackendServiceSessionAffinityComputeBeta>? sessionAffinity,
  ...
  factory RegionBackendServiceComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return RegionBackendServiceComputeBetaArgs(
      ...
      compressionMode: map['compressionMode'] == null ? null : pulumi.Output.create<RegionBackendServiceCompressionModeComputeBeta>(RegionBackendServiceCompressionModeComputeBeta.fromValue(map['compressionMode'] as String)),
      ...
      ipAddressSelectionPolicy: map['ipAddressSelectionPolicy'] == null ? null : pulumi.Output.create<RegionBackendServiceIpAddressSelectionPolicyComputeBeta>(RegionBackendServiceIpAddressSelectionPolicyComputeBeta.fromValue(map['ipAddressSelectionPolicy'] as String)),
      loadBalancingScheme: map['loadBalancingScheme'] == null ? null : pulumi.Output.create<RegionBackendServiceLoadBalancingSchemeComputeBeta>(RegionBackendServiceLoadBalancingSchemeComputeBeta.fromValue(map['loadBalancingScheme'] as String)),
      ...
      localityLbPolicy: map['localityLbPolicy'] == null ? null : pulumi.Output.create<RegionBackendServiceLocalityLbPolicyComputeBeta>(RegionBackendServiceLocalityLbPolicyComputeBeta.fromValue(map['localityLbPolicy'] as String)),
      ...
      protocol: map['protocol'] == null ? null : pulumi.Output.create<RegionBackendServiceProtocolComputeBeta>(RegionBackendServiceProtocolComputeBeta.fromValue(map['protocol'] as String)),
      ...
      sessionAffinity: map['sessionAffinity'] == null ? null : pulumi.Output.create<RegionBackendServiceSessionAffinityComputeBeta>(RegionBackendServiceSessionAffinityComputeBeta.fromValue(map['sessionAffinity'] as String)),
