...
class RegionBackendServiceComputeBetaArgs {
  ...
  factory RegionBackendServiceComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return RegionBackendServiceComputeBetaArgs(
      ...
      backends: map['backends'] == null ? null : (pulumi.Input.decodeList<BackendComputeBeta>(map['backends'], (value) => BackendComputeBeta.fromMap((value as Map).cast<String, dynamic>()))).input(),
      cdnPolicy: map['cdnPolicy'] == null ? null : (BackendServiceCdnPolicyComputeBeta.fromMap((map['cdnPolicy'] as Map).cast<String, dynamic>())).input(),
      circuitBreakers: map['circuitBreakers'] == null ? null : (CircuitBreakersComputeBeta.fromMap((map['circuitBreakers'] as Map).cast<String, dynamic>())).input(),
      compressionMode: map['compressionMode'] == null ? null : (RegionBackendServiceCompressionModeComputeBeta.fromValue(map['compressionMode'] as String)).input(),
      connectionDraining: map['connectionDraining'] == null ? null : (ConnectionDrainingComputeBeta.fromMap((map['connectionDraining'] as Map).cast<String, dynamic>())).input(),
      connectionTrackingPolicy: map['connectionTrackingPolicy'] == null ? null : (BackendServiceConnectionTrackingPolicyComputeBeta.fromMap((map['connectionTrackingPolicy'] as Map).cast<String, dynamic>())).input(),
      consistentHash: map['consistentHash'] == null ? null : (ConsistentHashLoadBalancerSettingsComputeBeta.fromMap((map['consistentHash'] as Map).cast<String, dynamic>())).input(),
      ...
      failoverPolicy: map['failoverPolicy'] == null ? null : (BackendServiceFailoverPolicyComputeBeta.fromMap((map['failoverPolicy'] as Map).cast<String, dynamic>())).input(),
      healthChecks: map['healthChecks'] == null ? null : ((map['healthChecks'] as List).cast<String>()).input(),
      iap: map['iap'] == null ? null : (BackendServiceIAPComputeBeta.fromMap((map['iap'] as Map).cast<String, dynamic>())).input(),
      ipAddressSelectionPolicy: map['ipAddressSelectionPolicy'] == null ? null : (RegionBackendServiceIpAddressSelectionPolicyComputeBeta.fromValue(map['ipAddressSelectionPolicy'] as String)).input(),
      loadBalancingScheme: map['loadBalancingScheme'] == null ? null : (RegionBackendServiceLoadBalancingSchemeComputeBeta.fromValue(map['loadBalancingScheme'] as String)).input(),
      localityLbPolicies: map['localityLbPolicies'] == null ? null : (pulumi.Input.decodeList<BackendServiceLocalityLoadBalancingPolicyConfigComputeBeta>(map['localityLbPolicies'], (value) => BackendServiceLocalityLoadBalancingPolicyConfigComputeBeta.fromMap((value as Map).cast<String, dynamic>()))).input(),
      localityLbPolicy: map['localityLbPolicy'] == null ? null : (RegionBackendServiceLocalityLbPolicyComputeBeta.fromValue(map['localityLbPolicy'] as String)).input(),
      logConfig: map['logConfig'] == null ? null : (BackendServiceLogConfigComputeBeta.fromMap((map['logConfig'] as Map).cast<String, dynamic>())).input(),
      ...
      outlierDetection: map['outlierDetection'] == null ? null : (OutlierDetectionComputeBeta.fromMap((map['outlierDetection'] as Map).cast<String, dynamic>())).input(),
      port: map['port'] == null ? null : (map['port'] as int).input(),
      portName: map['portName'] == null ? null : (map['portName'] as String).input(),
      project: map['project'] == null ? null : (map['project'] as String).input(),
      protocol: map['protocol'] == null ? null : (RegionBackendServiceProtocolComputeBeta.fromValue(map['protocol'] as String)).input(),
      region: (map['region'] as String).input(),
      requestId: map['requestId'] == null ? null : (map['requestId'] as String).input(),
      securitySettings: map['securitySettings'] == null ? null : (SecuritySettingsComputeBeta.fromMap((map['securitySettings'] as Map).cast<String, dynamic>())).input(),
      ...
      sessionAffinity: map['sessionAffinity'] == null ? null : (RegionBackendServiceSessionAffinityComputeBeta.fromValue(map['sessionAffinity'] as String)).input(),
      subsetting: map['subsetting'] == null ? null : (SubsettingComputeBeta.fromMap((map['subsetting'] as Map).cast<String, dynamic>())).input(),
      timeoutSec: map['timeoutSec'] == null ? null : (map['timeoutSec'] as int).input(),
      usedBy: map['usedBy'] == null ? null : (pulumi.Input.decodeList<BackendServiceUsedByComputeBeta>(map['usedBy'], (value) => BackendServiceUsedByComputeBeta.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
