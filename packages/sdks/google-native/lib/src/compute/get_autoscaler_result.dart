...
class GetAutoscalerResult {
  ...
  /// Creates a new [GetAutoscalerResult].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'status': status,
      'statusDetails': pulumi.Input.encodeList<AutoscalerStatusDetailsResponse, Map<String, dynamic>>(statusDetails, (value) => value.toMap()),
      'target': target,
      'zone': zone,
    };
  }

  factory GetAutoscalerResult.fromMap(Map<String, dynamic> map) {
    return GetAutoscalerResult(
      autoscalingPolicy: AutoscalingPolicyResponse.fromMap((map['autoscalingPolicy']! as Map).cast<String, dynamic>()),
      ...
      statusDetails: pulumi.Input.decodeList<AutoscalerStatusDetailsResponse>(map['statusDetails']!, (value) => AutoscalerStatusDetailsResponse.fromMap((value as Map).cast<String, dynamic>())),
