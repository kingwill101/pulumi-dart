...
class PublicAdvertisedPrefixComputeV1Args {
  ...
  const PublicAdvertisedPrefixComputeV1Args({
    this.description,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'pdpScope': ?pulumi.Input.mapOptionalInputValue<PublicAdvertisedPrefixPdpScopeComputeV1, String>(pdpScope, (value) => value.wireValue),
      'project': ?project,
      'requestId': ?requestId,
      'status': ?pulumi.Input.mapOptionalInputValue<PublicAdvertisedPrefixStatusComputeV1, String>(status, (value) => value.wireValue),
    };
  }
  ...
  factory PublicAdvertisedPrefixComputeV1Args.fromMap(Map<String, dynamic> map) {
    return PublicAdvertisedPrefixComputeV1Args(
      ...
      pdpScope: (() { final guardedValue = map['pdpScope']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PublicAdvertisedPrefixPdpScopeComputeV1.fromValue(guardedValue as String)); })(),
      project: (() { final guardedValue = map['project']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      requestId: (() { final guardedValue = map['requestId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PublicAdvertisedPrefixStatusComputeV1.fromValue(guardedValue as String)); })(),
    );
  }
}
