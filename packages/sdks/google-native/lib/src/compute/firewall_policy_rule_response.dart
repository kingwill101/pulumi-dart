...
class FirewallPolicyRuleResponse {
  ...
  factory FirewallPolicyRuleResponse.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyRuleResponse(
      ...
      match: (FirewallPolicyRuleMatcherResponse.fromMap((map['match'] as Map).cast<String, dynamic>())).input(),
      ...
      targetSecureTags: (pulumi.Input.decodeList<FirewallPolicyRuleSecureTagResponse>(map['targetSecureTags'], (value) => FirewallPolicyRuleSecureTagResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
