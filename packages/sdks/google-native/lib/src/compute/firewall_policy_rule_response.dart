...
class FirewallPolicyRuleResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'targetSecureTags': pulumi.Input.encodeList<FirewallPolicyRuleSecureTagResponse, Map<String, dynamic>>(targetSecureTags, (value) => value.toMap()),
  ...
  factory FirewallPolicyRuleResponse.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyRuleResponse(
      ...
      match: FirewallPolicyRuleMatcherResponse.fromMap((map['match'] as Map).cast<String, dynamic>()),
      ...
      targetSecureTags: pulumi.Input.decodeList<FirewallPolicyRuleSecureTagResponse>(map['targetSecureTags'], (value) => FirewallPolicyRuleSecureTagResponse.fromMap((value as Map).cast<String, dynamic>())),
