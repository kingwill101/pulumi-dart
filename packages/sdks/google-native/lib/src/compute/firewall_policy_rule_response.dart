...
class FirewallPolicyRuleResponse {
  ...
  final pulumi.Input<FirewallPolicyRuleMatcherResponse> match;
  ...
  final pulumi.Input<List<FirewallPolicyRuleSecureTagResponse>> targetSecureTags;
  ...
  const FirewallPolicyRuleResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'kind': kind,
      'match': pulumi.Input.mapInputValue<FirewallPolicyRuleMatcherResponse, Map<String, dynamic>>(match, (value) => value.toMap()),
      'priority': priority,
      'ruleName': ruleName,
      'ruleTupleCount': ruleTupleCount,
      'securityProfileGroup': securityProfileGroup,
      'targetResources': targetResources,
      'targetSecureTags': pulumi.Input.mapInputValue<List<FirewallPolicyRuleSecureTagResponse>, List<Map<String, dynamic>>>(targetSecureTags, (value) => pulumi.Input.encodeList<FirewallPolicyRuleSecureTagResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory FirewallPolicyRuleResponse.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyRuleResponse(
      ...
      match: pulumi.Input.fromValue(FirewallPolicyRuleMatcherResponse.fromMap((map['match']! as Map).cast<String, dynamic>())),
      ...
      targetSecureTags: pulumi.Input.fromValue(pulumi.Input.decodeList<FirewallPolicyRuleSecureTagResponse>(map['targetSecureTags']!, (value) => FirewallPolicyRuleSecureTagResponse.fromMap((value as Map).cast<String, dynamic>()))),
