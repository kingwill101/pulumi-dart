...
import 'int64_range_match_response_compute_beta.dart';

/// matchRule criteria for request header matches.
class HttpHeaderMatchResponseComputeBeta {
  ...
  final pulumi.Input<Int64RangeMatchResponseComputeBeta> rangeMatch;
  ...
  /// Creates a new [HttpHeaderMatchResponseComputeBeta].
  ...
  const HttpHeaderMatchResponseComputeBeta({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'rangeMatch': pulumi.Input.mapInputValue<Int64RangeMatchResponseComputeBeta, Map<String, dynamic>>(rangeMatch, (value) => value.toMap()),
      'regexMatch': regexMatch,
      'suffixMatch': suffixMatch,
    };
  }

  factory HttpHeaderMatchResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return HttpHeaderMatchResponseComputeBeta(
      ...
      rangeMatch: pulumi.Input.fromValue(Int64RangeMatchResponseComputeBeta.fromMap((map['rangeMatch']! as Map).cast<String, dynamic>())),
