...
class BackendServiceLocalityLoadBalancingPolicyConfigPolicy {
  ...
  final pulumi.Input<BackendServiceLocalityLoadBalancingPolicyConfigPolicyName>? name;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'name': ?pulumi.Input.mapOptionalInputValue<BackendServiceLocalityLoadBalancingPolicyConfigPolicyName, String>(name, (value) => value.wireValue),
    };
  }
  ...
  factory BackendServiceLocalityLoadBalancingPolicyConfigPolicy.fromMap(Map<String, dynamic> map) {
    return BackendServiceLocalityLoadBalancingPolicyConfigPolicy(
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BackendServiceLocalityLoadBalancingPolicyConfigPolicyName.fromValue(guardedValue as String)); })(),
    );
  }
}
