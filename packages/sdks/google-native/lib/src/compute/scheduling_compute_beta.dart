...
class SchedulingComputeBeta {
  ...
  final pulumi.Input<SchedulingInstanceTerminationActionComputeBeta>?
  ...
  final pulumi.Input<SchedulingMaintenanceIntervalComputeBeta>?
  maintenanceInterval;
    ...
    return <String, dynamic>{
      ...
      'instanceTerminationAction':
          ?pulumi.Input.mapOptionalInputValue<
            SchedulingInstanceTerminationActionComputeBeta,
            String
      ...
      'maintenanceInterval':
          ?pulumi.Input.mapOptionalInputValue<
            SchedulingMaintenanceIntervalComputeBeta,
            String
      ...
      'nodeAffinities':
          ?pulumi.Input.mapOptionalInputValue<
            List<SchedulingNodeAffinityComputeBeta>,
      ...
      'onHostMaintenance':
          ?pulumi.Input.mapOptionalInputValue<
            SchedulingOnHostMaintenanceComputeBeta,
            String
          >(onHostMaintenance, (value) => value.wireValue),
      'preemptible': ?preemptible,
      'provisioningModel':
          ?pulumi.Input.mapOptionalInputValue<
            SchedulingProvisioningModelComputeBeta,
            String
