...
class SchedulingComputeBeta {
  ...
  final SchedulingInstanceTerminationActionComputeBeta? instanceTerminationAction;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'instanceTerminationAction': ?instanceTerminationAction == null ? null : instanceTerminationAction!.value,
      ...
      'nodeAffinities': ?nodeAffinities == null ? null : pulumi.Input.encodeList<SchedulingNodeAffinityComputeBeta, Map<String, dynamic>>(nodeAffinities!, (value) => value.toMap()),
      'onHostMaintenance': ?onHostMaintenance == null ? null : onHostMaintenance!.value,
      'preemptible': ?preemptible,
      'provisioningModel': ?provisioningModel == null ? null : provisioningModel!.value,
  ...
  factory SchedulingComputeBeta.fromMap(Map<String, dynamic> map) {
    return SchedulingComputeBeta(
      ...
      instanceTerminationAction: map['instanceTerminationAction'] == null ? null : SchedulingInstanceTerminationActionComputeBeta.fromValue(map['instanceTerminationAction'] as String),
      localSsdRecoveryTimeout: map['localSsdRecoveryTimeout'] == null ? null : DurationComputeBeta.fromMap((map['localSsdRecoveryTimeout'] as Map).cast<String, dynamic>()),
      ...
      maintenanceInterval: map['maintenanceInterval'] == null ? null : SchedulingMaintenanceIntervalComputeBeta.fromValue(map['maintenanceInterval'] as String),
      maxRunDuration: map['maxRunDuration'] == null ? null : DurationComputeBeta.fromMap((map['maxRunDuration'] as Map).cast<String, dynamic>()),
      minNodeCpus: map['minNodeCpus'] == null ? null : map['minNodeCpus'] as int,
      nodeAffinities: map['nodeAffinities'] == null ? null : pulumi.Input.decodeList<SchedulingNodeAffinityComputeBeta>(map['nodeAffinities'], (value) => SchedulingNodeAffinityComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      onHostMaintenance: map['onHostMaintenance'] == null ? null : SchedulingOnHostMaintenanceComputeBeta.fromValue(map['onHostMaintenance'] as String),
      preemptible: map['preemptible'] == null ? null : map['preemptible'] as bool,
      provisioningModel: map['provisioningModel'] == null ? null : SchedulingProvisioningModelComputeBeta.fromValue(map['provisioningModel'] as String),
