...
class TCPHealthCheckResponseComputeV1 {
  ...
  /// Creates a new [TCPHealthCheckResponseComputeV1].
  ...
  const TCPHealthCheckResponseComputeV1({
    required this.port,
  ...
  factory TCPHealthCheckResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return TCPHealthCheckResponseComputeV1(
