...
class NetworkEndpointGroupArgs {
  ...
  factory NetworkEndpointGroupArgs.fromMap(Map<String, dynamic> map) {
    return NetworkEndpointGroupArgs(
      ...
      appEngine: map['appEngine'] == null ? null : (NetworkEndpointGroupAppEngine.fromMap((map['appEngine'] as Map).cast<String, dynamic>())).input(),
      clientPortMappingMode: map['clientPortMappingMode'] == null ? null : (NetworkEndpointGroupClientPortMappingMode.fromValue(map['clientPortMappingMode'] as String)).input(),
      cloudFunction: map['cloudFunction'] == null ? null : (NetworkEndpointGroupCloudFunction.fromMap((map['cloudFunction'] as Map).cast<String, dynamic>())).input(),
      cloudRun: map['cloudRun'] == null ? null : (NetworkEndpointGroupCloudRun.fromMap((map['cloudRun'] as Map).cast<String, dynamic>())).input(),
      defaultPort: map['defaultPort'] == null ? null : (map['defaultPort'] as int).input(),
      description: map['description'] == null ? null : (map['description'] as String).input(),
      loadBalancer: map['loadBalancer'] == null ? null : (NetworkEndpointGroupLbNetworkEndpointGroup.fromMap((map['loadBalancer'] as Map).cast<String, dynamic>())).input(),
      name: map['name'] == null ? null : (map['name'] as String).input(),
      network: map['network'] == null ? null : (map['network'] as String).input(),
      networkEndpointType: map['networkEndpointType'] == null ? null : (NetworkEndpointGroupNetworkEndpointType.fromValue(map['networkEndpointType'] as String)).input(),
      ...
      serverlessDeployment: map['serverlessDeployment'] == null ? null : (NetworkEndpointGroupServerlessDeployment.fromMap((map['serverlessDeployment'] as Map).cast<String, dynamic>())).input(),
      subnetwork: map['subnetwork'] == null ? null : (map['subnetwork'] as String).input(),
      type: map['type'] == null ? null : (NetworkEndpointGroupType.fromValue(map['type'] as String)).input(),
