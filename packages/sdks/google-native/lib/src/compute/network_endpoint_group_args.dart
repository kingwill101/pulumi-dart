...
class NetworkEndpointGroupArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'clientPortMappingMode': ?pulumi.Input.mapOptionalInputValue<NetworkEndpointGroupClientPortMappingMode, String>(clientPortMappingMode, (value) => value.wireValue),
      ...
      'name': ?name,
      'network': ?network,
      'networkEndpointType': ?pulumi.Input.mapOptionalInputValue<NetworkEndpointGroupNetworkEndpointType, String>(networkEndpointType, (value) => value.wireValue),
      'project': ?project,
      'pscData': ?pscData,
      ...
      'type': ?pulumi.Input.mapOptionalInputValue<NetworkEndpointGroupType, String>(type, (value) => value.wireValue),
      'zone': ?zone,
    };
  }
  ...
  factory NetworkEndpointGroupArgs.fromMap(Map<String, dynamic> map) {
    return NetworkEndpointGroupArgs(
      ...
      appEngine: (() { final guardedValue = map['appEngine']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkEndpointGroupAppEngine.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      clientPortMappingMode: (() { final guardedValue = map['clientPortMappingMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkEndpointGroupClientPortMappingMode.fromValue(guardedValue as String)); })(),
      cloudFunction: (() { final guardedValue = map['cloudFunction']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkEndpointGroupCloudFunction.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      cloudRun: (() { final guardedValue = map['cloudRun']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkEndpointGroupCloudRun.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      loadBalancer: (() { final guardedValue = map['loadBalancer']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkEndpointGroupLbNetworkEndpointGroup.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      network: (() { final guardedValue = map['network']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      networkEndpointType: (() { final guardedValue = map['networkEndpointType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkEndpointGroupNetworkEndpointType.fromValue(guardedValue as String)); })(),
      ...
      serverlessDeployment: (() { final guardedValue = map['serverlessDeployment']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkEndpointGroupServerlessDeployment.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      subnetwork: (() { final guardedValue = map['subnetwork']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkEndpointGroupType.fromValue(guardedValue as String)); })(),
