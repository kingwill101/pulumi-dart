...
class GlobalForwardingRuleComputeBetaArgs {
  ...
  GlobalForwardingRuleComputeBetaArgs({
    ...
    pulumi.Output<GlobalForwardingRuleIpProtocolComputeBeta>? ipProtocol,
    pulumi.Output<GlobalForwardingRuleIpVersionComputeBeta>? ipVersion,
    pulumi.Output<bool>? isMirroringCollector,
    pulumi.Output<Map<String, String>>? labels,
    pulumi.Output<GlobalForwardingRuleLoadBalancingSchemeComputeBeta>? loadBalancingScheme,
    pulumi.Output<List<MetadataFilterComputeBeta>>? metadataFilters,
    pulumi.Output<String>? name,
    pulumi.Output<String>? network,
    pulumi.Output<GlobalForwardingRuleNetworkTierComputeBeta>? networkTier,
    pulumi.Output<bool>? noAutomateDnsZone,
    pulumi.Output<String>? portRange,
    pulumi.Output<List<String>>? ports,
    pulumi.Output<String>? project,
    pulumi.Output<GlobalForwardingRulePscConnectionStatusComputeBeta>? pscConnectionStatus,
  ...
  factory GlobalForwardingRuleComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return GlobalForwardingRuleComputeBetaArgs(
      ...
      ipProtocol: map['ipProtocol'] == null ? null : pulumi.Output.create<GlobalForwardingRuleIpProtocolComputeBeta>(GlobalForwardingRuleIpProtocolComputeBeta.fromValue(map['ipProtocol'] as String)),
      ipVersion: map['ipVersion'] == null ? null : pulumi.Output.create<GlobalForwardingRuleIpVersionComputeBeta>(GlobalForwardingRuleIpVersionComputeBeta.fromValue(map['ipVersion'] as String)),
      ...
      loadBalancingScheme: map['loadBalancingScheme'] == null ? null : pulumi.Output.create<GlobalForwardingRuleLoadBalancingSchemeComputeBeta>(GlobalForwardingRuleLoadBalancingSchemeComputeBeta.fromValue(map['loadBalancingScheme'] as String)),
      ...
      networkTier: map['networkTier'] == null ? null : pulumi.Output.create<GlobalForwardingRuleNetworkTierComputeBeta>(GlobalForwardingRuleNetworkTierComputeBeta.fromValue(map['networkTier'] as String)),
      ...
      pscConnectionStatus: map['pscConnectionStatus'] == null ? null : pulumi.Output.create<GlobalForwardingRulePscConnectionStatusComputeBeta>(GlobalForwardingRulePscConnectionStatusComputeBeta.fromValue(map['pscConnectionStatus'] as String)),
