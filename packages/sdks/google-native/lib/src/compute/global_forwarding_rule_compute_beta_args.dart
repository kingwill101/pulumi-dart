...
class GlobalForwardingRuleComputeBetaArgs {
  ...
  factory GlobalForwardingRuleComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return GlobalForwardingRuleComputeBetaArgs(
      ...
      ipProtocol: map['ipProtocol'] == null ? null : (GlobalForwardingRuleIpProtocolComputeBeta.fromValue(map['ipProtocol']! as String)).input(),
      ipVersion: map['ipVersion'] == null ? null : (GlobalForwardingRuleIpVersionComputeBeta.fromValue(map['ipVersion']! as String)).input(),
      isMirroringCollector: map['isMirroringCollector'] == null ? null : (map['isMirroringCollector']! as bool).input(),
      labels: map['labels'] == null ? null : ((map['labels']! as Map).cast<String, String>()).input(),
      loadBalancingScheme: map['loadBalancingScheme'] == null ? null : (GlobalForwardingRuleLoadBalancingSchemeComputeBeta.fromValue(map['loadBalancingScheme']! as String)).input(),
      ...
      networkTier: map['networkTier'] == null ? null : (GlobalForwardingRuleNetworkTierComputeBeta.fromValue(map['networkTier']! as String)).input(),
      ...
      pscConnectionStatus: map['pscConnectionStatus'] == null ? null : (GlobalForwardingRulePscConnectionStatusComputeBeta.fromValue(map['pscConnectionStatus']! as String)).input(),
