...
class SslPolicyComputeBetaArgs {
  ...
  SslPolicyComputeBetaArgs({
    ...
    pulumi.Output<SslPolicyMinTlsVersionComputeBeta>? minTlsVersion,
    pulumi.Output<String>? name,
    pulumi.Output<SslPolicyProfileComputeBeta>? profile,
    pulumi.Output<String>? project,
    pulumi.Output<String>? requestId,
  }) :
      customFeatures = pulumi.Input.asOptionalInput<List<String>>(customFeatures),
      description = pulumi.Input.asOptionalInput<String>(description),
      minTlsVersion = pulumi.Input.asOptionalInput<SslPolicyMinTlsVersionComputeBeta>(minTlsVersion),
      name = pulumi.Input.asOptionalInput<String>(name),
      profile = pulumi.Input.asOptionalInput<SslPolicyProfileComputeBeta>(profile),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'minTlsVersion': ?pulumi.Input.mapOptionalInputValue<SslPolicyMinTlsVersionComputeBeta, String>(minTlsVersion, (value) => value.value),
      'name': ?name,
      'profile': ?pulumi.Input.mapOptionalInputValue<SslPolicyProfileComputeBeta, String>(profile, (value) => value.value),
      'project': ?project,
      'requestId': ?requestId,
    };
  }
  ...
  factory SslPolicyComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return SslPolicyComputeBetaArgs(
      ...
      minTlsVersion: map['minTlsVersion'] == null ? null : pulumi.Output.create<SslPolicyMinTlsVersionComputeBeta>(SslPolicyMinTlsVersionComputeBeta.fromValue(map['minTlsVersion'] as String)),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      profile: map['profile'] == null ? null : pulumi.Output.create<SslPolicyProfileComputeBeta>(SslPolicyProfileComputeBeta.fromValue(map['profile'] as String)),
