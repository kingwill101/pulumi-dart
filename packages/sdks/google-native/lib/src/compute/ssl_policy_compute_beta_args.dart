...
class SslPolicyComputeBetaArgs {
  ...
  const SslPolicyComputeBetaArgs({
    this.customFeatures,
    this.description,
    this.minTlsVersion,
    this.name,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'minTlsVersion': ?pulumi.Input.mapOptionalInputValue<SslPolicyMinTlsVersionComputeBeta, String>(minTlsVersion, (value) => value.wireValue),
      'name': ?name,
      'profile': ?pulumi.Input.mapOptionalInputValue<SslPolicyProfileComputeBeta, String>(profile, (value) => value.wireValue),
      'project': ?project,
      'requestId': ?requestId,
    };
  }
  ...
  factory SslPolicyComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return SslPolicyComputeBetaArgs(
      ...
      minTlsVersion: (() { final guardedValue = map['minTlsVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SslPolicyMinTlsVersionComputeBeta.fromValue(guardedValue as String)); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      profile: (() { final guardedValue = map['profile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SslPolicyProfileComputeBeta.fromValue(guardedValue as String)); })(),
