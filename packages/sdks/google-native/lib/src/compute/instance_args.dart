  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      ...
      keyRevocationActionType: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          InstanceKeyRevocationActionType.fromValue(guardedValue as String),
        );
      })(),
      labels: (() {
      ...
      postKeyRevocationActionType: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          InstancePostKeyRevocationActionType.fromValue(guardedValue as String),
        );
      })(),
      preservedStateSizeGb: (() {
        final guardedValue = map['preservedStateSizeGb'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      privateIpv6GoogleAccess: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          InstancePrivateIpv6GoogleAccess.fromValue(guardedValue as String),
        );
      })(),
      project: (() {
