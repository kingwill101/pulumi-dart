...
class InstanceArgs {
  ...
  /// [zone] Optional.
  InstanceArgs({
    pulumi.Output<AdvancedMachineFeatures>? advancedMachineFeatures,
    pulumi.Output<bool>? canIpForward,
    pulumi.Output<ConfidentialInstanceConfig>? confidentialInstanceConfig,
    pulumi.Output<bool>? deletionProtection,
    pulumi.Output<String>? description,
    pulumi.Output<List<AttachedDisk>>? disks,
    pulumi.Output<DisplayDevice>? displayDevice,
    pulumi.Output<bool>? eraseWindowsVssSignature,
    pulumi.Output<List<AcceleratorConfig>>? guestAccelerators,
    pulumi.Output<String>? hostname,
    pulumi.Output<CustomerEncryptionKey>? instanceEncryptionKey,
    pulumi.Output<InstanceKeyRevocationActionType>? keyRevocationActionType,
    pulumi.Output<Map<String, String>>? labels,
    pulumi.Output<String>? machineType,
    pulumi.Output<Metadata>? metadata,
    pulumi.Output<String>? minCpuPlatform,
    pulumi.Output<String>? name,
    pulumi.Output<List<NetworkInterface>>? networkInterfaces,
    pulumi.Output<NetworkPerformanceConfig>? networkPerformanceConfig,
    pulumi.Output<InstanceParams>? params,
    pulumi.Output<Map<String, String>>? partnerMetadata,
    pulumi.Output<InstancePostKeyRevocationActionType>? postKeyRevocationActionType,
    pulumi.Output<String>? preservedStateSizeGb,
    pulumi.Output<InstancePrivateIpv6GoogleAccess>? privateIpv6GoogleAccess,
    ...
    pulumi.Output<List<String>>? secureTags,
    pulumi.Output<List<ServiceAccount>>? serviceAccounts,
    pulumi.Output<Map<String, String>>? serviceIntegrationSpecs,
    pulumi.Output<ShieldedInstanceConfig>? shieldedInstanceConfig,
    pulumi.Output<ShieldedInstanceIntegrityPolicy>? shieldedInstanceIntegrityPolicy,
    pulumi.Output<ShieldedVmConfig>? shieldedVmConfig,
    pulumi.Output<ShieldedVmIntegrityPolicy>? shieldedVmIntegrityPolicy,
    pulumi.Output<String>? sourceInstanceTemplate,
    pulumi.Output<String>? sourceMachineImage,
    pulumi.Output<CustomerEncryptionKey>? sourceMachineImageEncryptionKey,
    pulumi.Output<Tags>? tags,
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      advancedMachineFeatures: map['advancedMachineFeatures'] == null ? null : pulumi.Output.create<AdvancedMachineFeatures>(AdvancedMachineFeatures.fromMap((map['advancedMachineFeatures'] as Map).cast<String, dynamic>())),
      canIpForward: map['canIpForward'] == null ? null : pulumi.Output.create<bool>(map['canIpForward'] as bool),
      confidentialInstanceConfig: map['confidentialInstanceConfig'] == null ? null : pulumi.Output.create<ConfidentialInstanceConfig>(ConfidentialInstanceConfig.fromMap((map['confidentialInstanceConfig'] as Map).cast<String, dynamic>())),
      deletionProtection: map['deletionProtection'] == null ? null : pulumi.Output.create<bool>(map['deletionProtection'] as bool),
      description: map['description'] == null ? null : pulumi.Output.create<String>(map['description'] as String),
      disks: map['disks'] == null ? null : pulumi.Output.create<List<AttachedDisk>>(pulumi.Input.decodeList<AttachedDisk>(map['disks'], (value) => AttachedDisk.fromMap((value as Map).cast<String, dynamic>()))),
      displayDevice: map['displayDevice'] == null ? null : pulumi.Output.create<DisplayDevice>(DisplayDevice.fromMap((map['displayDevice'] as Map).cast<String, dynamic>())),
      ...
      guestAccelerators: map['guestAccelerators'] == null ? null : pulumi.Output.create<List<AcceleratorConfig>>(pulumi.Input.decodeList<AcceleratorConfig>(map['guestAccelerators'], (value) => AcceleratorConfig.fromMap((value as Map).cast<String, dynamic>()))),
      hostname: map['hostname'] == null ? null : pulumi.Output.create<String>(map['hostname'] as String),
      instanceEncryptionKey: map['instanceEncryptionKey'] == null ? null : pulumi.Output.create<CustomerEncryptionKey>(CustomerEncryptionKey.fromMap((map['instanceEncryptionKey'] as Map).cast<String, dynamic>())),
      keyRevocationActionType: map['keyRevocationActionType'] == null ? null : pulumi.Output.create<InstanceKeyRevocationActionType>(InstanceKeyRevocationActionType.fromValue(map['keyRevocationActionType'] as String)),
      labels: map['labels'] == null ? null : pulumi.Output.create<Map<String, String>>((map['labels'] as Map).cast<String, String>()),
      machineType: map['machineType'] == null ? null : pulumi.Output.create<String>(map['machineType'] as String),
      metadata: map['metadata'] == null ? null : pulumi.Output.create<Metadata>(Metadata.fromMap((map['metadata'] as Map).cast<String, dynamic>())),
      minCpuPlatform: map['minCpuPlatform'] == null ? null : pulumi.Output.create<String>(map['minCpuPlatform'] as String),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      networkInterfaces: map['networkInterfaces'] == null ? null : pulumi.Output.create<List<NetworkInterface>>(pulumi.Input.decodeList<NetworkInterface>(map['networkInterfaces'], (value) => NetworkInterface.fromMap((value as Map).cast<String, dynamic>()))),
      networkPerformanceConfig: map['networkPerformanceConfig'] == null ? null : pulumi.Output.create<NetworkPerformanceConfig>(NetworkPerformanceConfig.fromMap((map['networkPerformanceConfig'] as Map).cast<String, dynamic>())),
      ...
      postKeyRevocationActionType: map['postKeyRevocationActionType'] == null ? null : pulumi.Output.create<InstancePostKeyRevocationActionType>(InstancePostKeyRevocationActionType.fromValue(map['postKeyRevocationActionType'] as String)),
      preservedStateSizeGb: map['preservedStateSizeGb'] == null ? null : pulumi.Output.create<String>(map['preservedStateSizeGb'] as String),
      privateIpv6GoogleAccess: map['privateIpv6GoogleAccess'] == null ? null : pulumi.Output.create<InstancePrivateIpv6GoogleAccess>(InstancePrivateIpv6GoogleAccess.fromValue(map['privateIpv6GoogleAccess'] as String)),
      ...
      secureTags: map['secureTags'] == null ? null : pulumi.Output.create<List<String>>((map['secureTags'] as List).cast<String>()),
      serviceAccounts: map['serviceAccounts'] == null ? null : pulumi.Output.create<List<ServiceAccount>>(pulumi.Input.decodeList<ServiceAccount>(map['serviceAccounts'], (value) => ServiceAccount.fromMap((value as Map).cast<String, dynamic>()))),
      serviceIntegrationSpecs: map['serviceIntegrationSpecs'] == null ? null : pulumi.Output.create<Map<String, String>>((map['serviceIntegrationSpecs'] as Map).cast<String, String>()),
      ...
      shieldedInstanceIntegrityPolicy: map['shieldedInstanceIntegrityPolicy'] == null ? null : pulumi.Output.create<ShieldedInstanceIntegrityPolicy>(ShieldedInstanceIntegrityPolicy.fromMap((map['shieldedInstanceIntegrityPolicy'] as Map).cast<String, dynamic>())),
      shieldedVmConfig: map['shieldedVmConfig'] == null ? null : pulumi.Output.create<ShieldedVmConfig>(ShieldedVmConfig.fromMap((map['shieldedVmConfig'] as Map).cast<String, dynamic>())),
      shieldedVmIntegrityPolicy: map['shieldedVmIntegrityPolicy'] == null ? null : pulumi.Output.create<ShieldedVmIntegrityPolicy>(ShieldedVmIntegrityPolicy.fromMap((map['shieldedVmIntegrityPolicy'] as Map).cast<String, dynamic>())),
      ...
      sourceMachineImageEncryptionKey: map['sourceMachineImageEncryptionKey'] == null ? null : pulumi.Output.create<CustomerEncryptionKey>(CustomerEncryptionKey.fromMap((map['sourceMachineImageEncryptionKey'] as Map).cast<String, dynamic>())),
      tags: map['tags'] == null ? null : pulumi.Output.create<Tags>(Tags.fromMap((map['tags'] as Map).cast<String, dynamic>())),
