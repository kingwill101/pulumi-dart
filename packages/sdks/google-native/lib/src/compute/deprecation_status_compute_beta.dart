...
class DeprecationStatusComputeBeta {
  ...
  const DeprecationStatusComputeBeta({
    this.deleted,
    this.deprecated,
    this.obsolete,
    this.replacement,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'state': ?pulumi.Input.mapOptionalInputValue<DeprecationStatusStateComputeBeta, String>(state, (value) => value.wireValue),
  ...
  factory DeprecationStatusComputeBeta.fromMap(Map<String, dynamic> map) {
    return DeprecationStatusComputeBeta(
      ...
      state: (() { final guardedValue = map['state']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DeprecationStatusStateComputeBeta.fromValue(guardedValue as String)); })(),
      stateOverride: (() { final guardedValue = map['stateOverride']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RolloutPolicyComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
