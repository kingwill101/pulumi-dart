...
class DeprecationStatusComputeBeta {
  ...
  factory DeprecationStatusComputeBeta.fromMap(Map<String, dynamic> map) {
    return DeprecationStatusComputeBeta(
      ...
      state: map['state'] == null ? null : DeprecationStatusStateComputeBeta.fromValue(map['state'] as String),
      stateOverride: map['stateOverride'] == null ? null : RolloutPolicyComputeBeta.fromMap((map['stateOverride'] as Map).cast<String, dynamic>()),
    );
  }
}
