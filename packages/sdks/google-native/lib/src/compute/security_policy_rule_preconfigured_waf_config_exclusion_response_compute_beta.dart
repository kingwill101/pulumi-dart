...
class SecurityPolicyRulePreconfiguredWafConfigExclusionResponseComputeBeta {
  ...
  factory SecurityPolicyRulePreconfiguredWafConfigExclusionResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRulePreconfiguredWafConfigExclusionResponseComputeBeta(
      requestCookiesToExclude: (pulumi.Input.decodeList<SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParamsResponseComputeBeta>(map['requestCookiesToExclude'], (value) => SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParamsResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))).input(),
      requestHeadersToExclude: (pulumi.Input.decodeList<SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParamsResponseComputeBeta>(map['requestHeadersToExclude'], (value) => SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParamsResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))).input(),
      requestQueryParamsToExclude: (pulumi.Input.decodeList<SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParamsResponseComputeBeta>(map['requestQueryParamsToExclude'], (value) => SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParamsResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))).input(),
      requestUrisToExclude: (pulumi.Input.decodeList<SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParamsResponseComputeBeta>(map['requestUrisToExclude'], (value) => SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParamsResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))).input(),
