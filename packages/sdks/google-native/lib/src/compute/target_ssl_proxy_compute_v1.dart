...
import 'target_ssl_proxy_compute_v1_args.dart';

/// Creates a TargetSslProxy resource in the specified project using the data included in the request.
class TargetSslProxyComputeV1 extends pulumi.CustomResource {
  ...
  /// Creates a new [TargetSslProxyComputeV1].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [TargetSslProxyComputeV1]. {@macro pulumi_compute_v1_target_ssl_proxy_compute_v1_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  TargetSslProxyComputeV1(
    String name, {
    TargetSslProxyComputeV1Args? args,
