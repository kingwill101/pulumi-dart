...
class RegionDiskArgs {
  ...
  factory RegionDiskArgs.fromMap(Map<String, dynamic> map) {
    return RegionDiskArgs(
      accessMode: map['accessMode'] == null ? null : (RegionDiskAccessMode.fromValue(map['accessMode']! as String)).input(),
      architecture: map['architecture'] == null ? null : (RegionDiskArchitecture.fromValue(map['architecture']! as String)).input(),
      asyncPrimaryDisk: map['asyncPrimaryDisk'] == null ? null : (DiskAsyncReplication.fromMap((map['asyncPrimaryDisk']! as Map).cast<String, dynamic>())).input(),
      ...
      interface: map['interface'] == null ? null : (RegionDiskInterface.fromValue(map['interface']! as String)).input(),
      ...
      physicalBlockSizeBytes: map['physicalBlockSizeBytes'] == null ? null : (map['physicalBlockSizeBytes']! as String).input(),
      ...
      storageType: map['storageType'] == null ? null : (RegionDiskStorageType.fromValue(map['storageType']! as String)).input(),
