...
class RegionDiskArgs {
  ...
  RegionDiskArgs({
    pulumi.Output<RegionDiskAccessMode>? accessMode,
    pulumi.Output<RegionDiskArchitecture>? architecture,
    ...
    pulumi.Output<RegionDiskInterface>? interface,
    ...
    pulumi.Output<RegionDiskStorageType>? storageType,
  ...
  factory RegionDiskArgs.fromMap(Map<String, dynamic> map) {
    return RegionDiskArgs(
      accessMode: map['accessMode'] == null ? null : pulumi.Output.create<RegionDiskAccessMode>(RegionDiskAccessMode.fromValue(map['accessMode'] as String)),
      architecture: map['architecture'] == null ? null : pulumi.Output.create<RegionDiskArchitecture>(RegionDiskArchitecture.fromValue(map['architecture'] as String)),
      ...
      interface: map['interface'] == null ? null : pulumi.Output.create<RegionDiskInterface>(RegionDiskInterface.fromValue(map['interface'] as String)),
      ...
      storageType: map['storageType'] == null ? null : pulumi.Output.create<RegionDiskStorageType>(RegionDiskStorageType.fromValue(map['storageType'] as String)),
