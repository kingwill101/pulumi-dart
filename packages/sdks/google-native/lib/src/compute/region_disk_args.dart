...
class RegionDiskArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'accessMode': ?pulumi.Input.mapOptionalInputValue<RegionDiskAccessMode, String>(accessMode, (value) => value.wireValue),
      'architecture': ?pulumi.Input.mapOptionalInputValue<RegionDiskArchitecture, String>(architecture, (value) => value.wireValue),
      ...
      'interface': ?pulumi.Input.mapOptionalInputValue<RegionDiskInterface, String>(interface, (value) => value.wireValue),
      'labels': ?labels,
      ...
      'storageType': ?pulumi.Input.mapOptionalInputValue<RegionDiskStorageType, String>(storageType, (value) => value.wireValue),
      'type': ?type,
  ...
  factory RegionDiskArgs.fromMap(Map<String, dynamic> map) {
    return RegionDiskArgs(
      accessMode: (() { final guardedValue = map['accessMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionDiskAccessMode.fromValue(guardedValue as String)); })(),
      architecture: (() { final guardedValue = map['architecture']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionDiskArchitecture.fromValue(guardedValue as String)); })(),
      ...
      interface: (() { final guardedValue = map['interface']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionDiskInterface.fromValue(guardedValue as String)); })(),
      ...
      storageType: (() { final guardedValue = map['storageType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionDiskStorageType.fromValue(guardedValue as String)); })(),
