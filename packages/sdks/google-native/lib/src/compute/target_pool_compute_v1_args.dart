...
class TargetPoolComputeV1Args {
  ...
  TargetPoolComputeV1Args({
    ...
    pulumi.Output<TargetPoolSessionAffinityComputeV1>? sessionAffinity,
  }) :
      ...
      sessionAffinity = pulumi.Input.asOptionalInput<TargetPoolSessionAffinityComputeV1>(sessionAffinity);
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'region': region,
      'requestId': ?requestId,
      'sessionAffinity': ?pulumi.Input.mapOptionalInputValue<TargetPoolSessionAffinityComputeV1, String>(sessionAffinity, (value) => value.value),
    };
  }
  ...
  factory TargetPoolComputeV1Args.fromMap(Map<String, dynamic> map) {
    return TargetPoolComputeV1Args(
      ...
      sessionAffinity: map['sessionAffinity'] == null ? null : pulumi.Output.create<TargetPoolSessionAffinityComputeV1>(TargetPoolSessionAffinityComputeV1.fromValue(map['sessionAffinity'] as String)),
    );
  }
}
