...
class CustomErrorResponsePolicy {
  ...
  final pulumi.Input<List<CustomErrorResponsePolicyCustomErrorResponseRule>>? errorResponseRules;
  ...
  const CustomErrorResponsePolicy({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'errorResponseRules': ?pulumi.Input.mapOptionalInputValue<List<CustomErrorResponsePolicyCustomErrorResponseRule>, List<Map<String, dynamic>>>(errorResponseRules, (value) => pulumi.Input.encodeList<CustomErrorResponsePolicyCustomErrorResponseRule, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory CustomErrorResponsePolicy.fromMap(Map<String, dynamic> map) {
    return CustomErrorResponsePolicy(
      errorResponseRules: (() { final guardedValue = map['errorResponseRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<CustomErrorResponsePolicyCustomErrorResponseRule>(guardedValue, (value) => CustomErrorResponsePolicyCustomErrorResponseRule.fromMap((value as Map).cast<String, dynamic>()))); })(),
