...
class UrlMapTestResponse {
  ...
  factory UrlMapTestResponse.fromMap(Map<String, dynamic> map) {
    return UrlMapTestResponse(
      backendServiceWeight: pulumi.Input.fromValue(
      ...
      expectedUrlRedirect: pulumi.Input.fromValue(
        map['expectedUrlRedirect'] as String,
      ),
      headers: pulumi.Input.fromValue(
        pulumi.Input.decodeList<UrlMapTestHeaderResponse>(
          map['headers']!,
