...
class BackendBucketCdnPolicyResponseComputeBeta {
  ...
  final pulumi.Input<List<BackendBucketCdnPolicyBypassCacheOnRequestHeaderResponseComputeBeta>> bypassCacheOnRequestHeaders;
  /// The CacheKeyPolicy for this CdnPolicy.
  final pulumi.Input<BackendBucketCdnPolicyCacheKeyPolicyResponseComputeBeta> cacheKeyPolicy;
  ...
  final pulumi.Input<List<BackendBucketCdnPolicyNegativeCachingPolicyResponseComputeBeta>> negativeCachingPolicy;
  ...
  const BackendBucketCdnPolicyResponseComputeBeta({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'bypassCacheOnRequestHeaders': pulumi.Input.mapInputValue<List<BackendBucketCdnPolicyBypassCacheOnRequestHeaderResponseComputeBeta>, List<Map<String, dynamic>>>(bypassCacheOnRequestHeaders, (value) => pulumi.Input.encodeList<BackendBucketCdnPolicyBypassCacheOnRequestHeaderResponseComputeBeta, Map<String, dynamic>>(value, (value) => value.toMap())),
      'cacheKeyPolicy': pulumi.Input.mapInputValue<BackendBucketCdnPolicyCacheKeyPolicyResponseComputeBeta, Map<String, dynamic>>(cacheKeyPolicy, (value) => value.toMap()),
      'cacheMode': cacheMode,
      'clientTtl': clientTtl,
      'defaultTtl': defaultTtl,
      'maxTtl': maxTtl,
      'negativeCaching': negativeCaching,
      'negativeCachingPolicy': pulumi.Input.mapInputValue<List<BackendBucketCdnPolicyNegativeCachingPolicyResponseComputeBeta>, List<Map<String, dynamic>>>(negativeCachingPolicy, (value) => pulumi.Input.encodeList<BackendBucketCdnPolicyNegativeCachingPolicyResponseComputeBeta, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory BackendBucketCdnPolicyResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return BackendBucketCdnPolicyResponseComputeBeta(
      bypassCacheOnRequestHeaders: pulumi.Input.fromValue(pulumi.Input.decodeList<BackendBucketCdnPolicyBypassCacheOnRequestHeaderResponseComputeBeta>(map['bypassCacheOnRequestHeaders']!, (value) => BackendBucketCdnPolicyBypassCacheOnRequestHeaderResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))),
      cacheKeyPolicy: pulumi.Input.fromValue(BackendBucketCdnPolicyCacheKeyPolicyResponseComputeBeta.fromMap((map['cacheKeyPolicy']! as Map).cast<String, dynamic>())),
      ...
      negativeCachingPolicy: pulumi.Input.fromValue(pulumi.Input.decodeList<BackendBucketCdnPolicyNegativeCachingPolicyResponseComputeBeta>(map['negativeCachingPolicy']!, (value) => BackendBucketCdnPolicyNegativeCachingPolicyResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))),
