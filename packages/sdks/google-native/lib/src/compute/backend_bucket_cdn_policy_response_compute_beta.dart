...
class BackendBucketCdnPolicyResponseComputeBeta {
  ...
  final pulumi.Input<
    List<BackendBucketCdnPolicyBypassCacheOnRequestHeaderResponseComputeBeta>
  >
  bypassCacheOnRequestHeaders;

  /// The CacheKeyPolicy for this CdnPolicy.
  final pulumi.Input<BackendBucketCdnPolicyCacheKeyPolicyResponseComputeBeta>
  cacheKeyPolicy;
  ...
  final pulumi.Input<
    List<BackendBucketCdnPolicyNegativeCachingPolicyResponseComputeBeta>
  >
