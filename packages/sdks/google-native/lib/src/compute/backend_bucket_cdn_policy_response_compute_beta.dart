...
class BackendBucketCdnPolicyResponseComputeBeta {
  ...
  factory BackendBucketCdnPolicyResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return BackendBucketCdnPolicyResponseComputeBeta(
      bypassCacheOnRequestHeaders: (pulumi.Input.decodeList<BackendBucketCdnPolicyBypassCacheOnRequestHeaderResponseComputeBeta>(map['bypassCacheOnRequestHeaders'], (value) => BackendBucketCdnPolicyBypassCacheOnRequestHeaderResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))).input(),
      cacheKeyPolicy: (BackendBucketCdnPolicyCacheKeyPolicyResponseComputeBeta.fromMap((map['cacheKeyPolicy'] as Map).cast<String, dynamic>())).input(),
      ...
      negativeCachingPolicy: (pulumi.Input.decodeList<BackendBucketCdnPolicyNegativeCachingPolicyResponseComputeBeta>(map['negativeCachingPolicy'], (value) => BackendBucketCdnPolicyNegativeCachingPolicyResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))).input(),
