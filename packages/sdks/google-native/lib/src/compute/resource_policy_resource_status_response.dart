...
class ResourcePolicyResourceStatusResponse {
  ...
  ResourcePolicyResourceStatusResponse({required this.instanceSchedulePolicy});
  ...
  factory ResourcePolicyResourceStatusResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return ResourcePolicyResourceStatusResponse(
      instanceSchedulePolicy: pulumi.Input.fromValue(
        ResourcePolicyResourceStatusInstanceSchedulePolicyStatusResponse.fromMap(
