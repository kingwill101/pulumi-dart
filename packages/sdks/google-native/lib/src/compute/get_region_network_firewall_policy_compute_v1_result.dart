...
import 'firewall_policy_association_response_compute_v1.dart';
import 'firewall_policy_rule_response_compute_v1.dart';

/// Result data returned by getRegionNetworkFirewallPolicy.
class GetRegionNetworkFirewallPolicyComputeV1Result {
  /// A list of associations that belong to this firewall policy.
  final List<FirewallPolicyAssociationResponseComputeV1> associations;
  ...
  final List<FirewallPolicyRuleResponseComputeV1> rules;
  ...
  /// Creates a new [GetRegionNetworkFirewallPolicyComputeV1Result].
  ...
  /// [parent] The parent of the firewall policy. This field is not applicable to network firewall policies.
  /// [region] URL of the region where the regional firewall policy resides. This field is not applicable to global firewall policies. You must specify this field as part of the HTTP request URL. It is not settable as a field in the request body.
  ...
  const GetRegionNetworkFirewallPolicyComputeV1Result({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'associations': pulumi.Input.encodeList<FirewallPolicyAssociationResponseComputeV1, Map<String, dynamic>>(associations, (value) => value.toMap()),
      ...
      'rules': pulumi.Input.encodeList<FirewallPolicyRuleResponseComputeV1, Map<String, dynamic>>(rules, (value) => value.toMap()),
      'selfLink': selfLink,
  ...
  factory GetRegionNetworkFirewallPolicyComputeV1Result.fromMap(Map<String, dynamic> map) {
    return GetRegionNetworkFirewallPolicyComputeV1Result(
      associations: pulumi.Input.decodeList<FirewallPolicyAssociationResponseComputeV1>(map['associations']!, (value) => FirewallPolicyAssociationResponseComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      ...
      rules: pulumi.Input.decodeList<FirewallPolicyRuleResponseComputeV1>(map['rules']!, (value) => FirewallPolicyRuleResponseComputeV1.fromMap((value as Map).cast<String, dynamic>())),
