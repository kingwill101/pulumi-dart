...
class GetGlobalForwardingRuleResult {
  ...
  final List<ForwardingRuleServiceDirectoryRegistrationResponse> serviceDirectoryRegistrations;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'serviceDirectoryRegistrations': pulumi.Input.encodeList<ForwardingRuleServiceDirectoryRegistrationResponse, Map<String, dynamic>>(serviceDirectoryRegistrations, (value) => value.toMap()),
  ...
  factory GetGlobalForwardingRuleResult.fromMap(Map<String, dynamic> map) {
    return GetGlobalForwardingRuleResult(
      ...
      serviceDirectoryRegistrations: pulumi.Input.decodeList<ForwardingRuleServiceDirectoryRegistrationResponse>(map['serviceDirectoryRegistrations']!, (value) => ForwardingRuleServiceDirectoryRegistrationResponse.fromMap((value as Map).cast<String, dynamic>())),
