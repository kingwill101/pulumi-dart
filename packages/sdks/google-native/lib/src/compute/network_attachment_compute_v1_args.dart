...
class NetworkAttachmentComputeV1Args {
  ...
  const NetworkAttachmentComputeV1Args({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'connectionPreference': ?pulumi.Input.mapOptionalInputValue<NetworkAttachmentConnectionPreferenceComputeV1, String>(connectionPreference, (value) => value.wireValue),
  ...
  factory NetworkAttachmentComputeV1Args.fromMap(Map<String, dynamic> map) {
    return NetworkAttachmentComputeV1Args(
      connectionPreference: (() { final guardedValue = map['connectionPreference']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkAttachmentConnectionPreferenceComputeV1.fromValue(guardedValue as String)); })(),
