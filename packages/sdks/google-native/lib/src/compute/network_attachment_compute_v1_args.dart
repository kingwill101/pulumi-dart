...
class NetworkAttachmentComputeV1Args {
  ...
  NetworkAttachmentComputeV1Args({
    pulumi.Output<NetworkAttachmentConnectionPreferenceComputeV1>? connectionPreference,
  ...
  factory NetworkAttachmentComputeV1Args.fromMap(Map<String, dynamic> map) {
    return NetworkAttachmentComputeV1Args(
      connectionPreference: map['connectionPreference'] == null ? null : pulumi.Output.create<NetworkAttachmentConnectionPreferenceComputeV1>(NetworkAttachmentConnectionPreferenceComputeV1.fromValue(map['connectionPreference'] as String)),
