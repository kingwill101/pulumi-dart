...
class NetworkAttachmentComputeV1Args {
  ...
  factory NetworkAttachmentComputeV1Args.fromMap(Map<String, dynamic> map) {
    return NetworkAttachmentComputeV1Args(
      connectionPreference: map['connectionPreference'] == null ? null : (NetworkAttachmentConnectionPreferenceComputeV1.fromValue(map['connectionPreference']! as String)).input(),
