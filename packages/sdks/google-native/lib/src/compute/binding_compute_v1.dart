...
class BindingComputeV1 {
  ...
  final pulumi.Input<ExprComputeV1>? condition;
  ...
  /// Creates a new [BindingComputeV1].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'bindingId': ?bindingId,
      'condition': ?pulumi.Input.mapOptionalInputValue<ExprComputeV1, Map<String, dynamic>>(condition, (value) => value.toMap()),
      'members': ?members,
      'role': ?role,
    };
  }

  factory BindingComputeV1.fromMap(Map<String, dynamic> map) {
    return BindingComputeV1(
      ...
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ExprComputeV1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
