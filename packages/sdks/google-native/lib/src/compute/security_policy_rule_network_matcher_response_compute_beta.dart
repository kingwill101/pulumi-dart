...
class SecurityPolicyRuleNetworkMatcherResponseComputeBeta {
  ...
  final pulumi.Input<List<SecurityPolicyRuleNetworkMatcherUserDefinedFieldMatchResponseComputeBeta>> userDefinedFields;
  ...
  const SecurityPolicyRuleNetworkMatcherResponseComputeBeta({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'userDefinedFields': pulumi.Input.mapInputValue<List<SecurityPolicyRuleNetworkMatcherUserDefinedFieldMatchResponseComputeBeta>, List<Map<String, dynamic>>>(userDefinedFields, (value) => pulumi.Input.encodeList<SecurityPolicyRuleNetworkMatcherUserDefinedFieldMatchResponseComputeBeta, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory SecurityPolicyRuleNetworkMatcherResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRuleNetworkMatcherResponseComputeBeta(
      ...
      userDefinedFields: pulumi.Input.fromValue(pulumi.Input.decodeList<SecurityPolicyRuleNetworkMatcherUserDefinedFieldMatchResponseComputeBeta>(map['userDefinedFields']!, (value) => SecurityPolicyRuleNetworkMatcherUserDefinedFieldMatchResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
