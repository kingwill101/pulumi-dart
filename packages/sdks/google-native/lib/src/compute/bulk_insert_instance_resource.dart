...
class BulkInsertInstanceResource {
  ...
  const BulkInsertInstanceResource({
    this.count,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'count': ?count,
      'instanceProperties': ?pulumi.Input.mapOptionalInputValue<InstanceProperties, Map<String, dynamic>>(instanceProperties, (value) => value.toMap()),
      'locationPolicy': ?pulumi.Input.mapOptionalInputValue<LocationPolicy, Map<String, dynamic>>(locationPolicy, (value) => value.toMap()),
      'minCount': ?minCount,
  ...
  factory BulkInsertInstanceResource.fromMap(Map<String, dynamic> map) {
    return BulkInsertInstanceResource(
      ...
      instanceProperties: (() { final guardedValue = map['instanceProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      locationPolicy: (() { final guardedValue = map['locationPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LocationPolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      minCount: (() { final guardedValue = map['minCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      perInstanceProperties: (() { final guardedValue = map['perInstanceProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
