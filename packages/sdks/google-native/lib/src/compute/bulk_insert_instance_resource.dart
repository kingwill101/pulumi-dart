...
class BulkInsertInstanceResource {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'locationPolicy': ?locationPolicy == null ? null : locationPolicy!.toMap(),
      'minCount': ?minCount,
  ...
  factory BulkInsertInstanceResource.fromMap(Map<String, dynamic> map) {
    return BulkInsertInstanceResource(
      ...
      instanceProperties: map['instanceProperties'] == null ? null : InstanceProperties.fromMap((map['instanceProperties'] as Map).cast<String, dynamic>()),
      locationPolicy: map['locationPolicy'] == null ? null : LocationPolicy.fromMap((map['locationPolicy'] as Map).cast<String, dynamic>()),
      minCount: map['minCount'] == null ? null : map['minCount'] as String,
      namePattern: map['namePattern'] == null ? null : map['namePattern'] as String,
      perInstanceProperties: map['perInstanceProperties'] == null ? null : (map['perInstanceProperties'] as Map).cast<String, String>(),
