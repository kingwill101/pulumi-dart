...
class OrganizationSecurityPolicyComputeBetaArgs {
  ...
  OrganizationSecurityPolicyComputeBetaArgs({
    ...
    pulumi.Output<OrganizationSecurityPolicyTypeComputeBeta>? type,
  ...
  factory OrganizationSecurityPolicyComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return OrganizationSecurityPolicyComputeBetaArgs(
      ...
      type: map['type'] == null ? null : pulumi.Output.create<OrganizationSecurityPolicyTypeComputeBeta>(OrganizationSecurityPolicyTypeComputeBeta.fromValue(map['type'] as String)),
