...
class OrganizationSecurityPolicyComputeBetaArgs {
  ...
  const OrganizationSecurityPolicyComputeBetaArgs({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'type': ?pulumi.Input.mapOptionalInputValue<OrganizationSecurityPolicyTypeComputeBeta, String>(type, (value) => value.wireValue),
  ...
  factory OrganizationSecurityPolicyComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return OrganizationSecurityPolicyComputeBetaArgs(
      ...
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OrganizationSecurityPolicyTypeComputeBeta.fromValue(guardedValue as String)); })(),
