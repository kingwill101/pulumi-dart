...
/// {@template pulumi_compute_beta_disk_iam_binding_compute_beta_args_doc}
/// The set of arguments for DiskIamBinding.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_disk_iam_binding_compute_beta_args_doc}
class DiskIamBindingComputeBetaArgs {
  ...
  /// Creates a new [DiskIamBindingComputeBetaArgs].
  ...
  const DiskIamBindingComputeBetaArgs({
    this.condition,
  ...
  factory DiskIamBindingComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return DiskIamBindingComputeBetaArgs(
