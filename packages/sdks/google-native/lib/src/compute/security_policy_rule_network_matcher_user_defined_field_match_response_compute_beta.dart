...
class SecurityPolicyRuleNetworkMatcherUserDefinedFieldMatchResponseComputeBeta {
  ...
  const SecurityPolicyRuleNetworkMatcherUserDefinedFieldMatchResponseComputeBeta({
    required this.name,
  ...
  factory SecurityPolicyRuleNetworkMatcherUserDefinedFieldMatchResponseComputeBeta.fromMap(Map<String, dynamic> map) {
