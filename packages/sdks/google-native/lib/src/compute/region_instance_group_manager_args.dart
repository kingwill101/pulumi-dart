...
class RegionInstanceGroupManagerArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'failoverAction': ?pulumi.Input.mapOptionalInputValue<RegionInstanceGroupManagerFailoverAction, String>(failoverAction, (value) => value.wireValue),
      ...
      'listManagedInstancesResults': ?pulumi.Input.mapOptionalInputValue<RegionInstanceGroupManagerListManagedInstancesResults, String>(listManagedInstancesResults, (value) => value.wireValue),
      'name': ?name,
      ...
      'targetSizeUnit': ?pulumi.Input.mapOptionalInputValue<RegionInstanceGroupManagerTargetSizeUnit, String>(targetSizeUnit, (value) => value.wireValue),
  ...
  factory RegionInstanceGroupManagerArgs.fromMap(Map<String, dynamic> map) {
    return RegionInstanceGroupManagerArgs(
      ...
      failoverAction: (() { final guardedValue = map['failoverAction']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionInstanceGroupManagerFailoverAction.fromValue(guardedValue as String)); })(),
      ...
      listManagedInstancesResults: (() { final guardedValue = map['listManagedInstancesResults']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionInstanceGroupManagerListManagedInstancesResults.fromValue(guardedValue as String)); })(),
      ...
      targetSizeUnit: (() { final guardedValue = map['targetSizeUnit']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionInstanceGroupManagerTargetSizeUnit.fromValue(guardedValue as String)); })(),
