...
/// {@template pulumi_compute_v1_instance_iam_member_compute_v1_args_doc}
/// The set of arguments for InstanceIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_v1_instance_iam_member_compute_v1_args_doc}
class InstanceIamMemberComputeV1Args {
  ...
  /// Creates a new [InstanceIamMemberComputeV1Args].
  ...
  const InstanceIamMemberComputeV1Args({
    this.condition,
  ...
  factory InstanceIamMemberComputeV1Args.fromMap(Map<String, dynamic> map) {
    return InstanceIamMemberComputeV1Args(
