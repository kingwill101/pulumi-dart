...
class ConsistentHashLoadBalancerSettingsResponse {
  ...
  factory ConsistentHashLoadBalancerSettingsResponse.fromMap(Map<String, dynamic> map) {
    return ConsistentHashLoadBalancerSettingsResponse(
      httpCookie: (ConsistentHashLoadBalancerSettingsHttpCookieResponse.fromMap((map['httpCookie'] as Map).cast<String, dynamic>())).input(),
      httpHeaderName: (map['httpHeaderName'] as String).input(),
      minimumRingSize: (map['minimumRingSize'] as String).input(),
    );
  }
}
