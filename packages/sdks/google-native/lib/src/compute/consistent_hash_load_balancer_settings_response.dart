...
class ConsistentHashLoadBalancerSettingsResponse {
  ...
  final pulumi.Input<ConsistentHashLoadBalancerSettingsHttpCookieResponse>
  httpCookie;
  ...
  factory ConsistentHashLoadBalancerSettingsResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return ConsistentHashLoadBalancerSettingsResponse(
      httpCookie: pulumi.Input.fromValue(
        ConsistentHashLoadBalancerSettingsHttpCookieResponse.fromMap(
