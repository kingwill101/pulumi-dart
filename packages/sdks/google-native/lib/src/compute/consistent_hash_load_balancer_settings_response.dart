...
import 'consistent_hash_load_balancer_settings_http_cookie_response.dart';

/// This message defines settings for a consistent hash style load balancer.
class ConsistentHashLoadBalancerSettingsResponse {
  /// Hash is based on HTTP Cookie. This field describes a HTTP cookie that will be used as the hash key for the consistent hash load balancer. If the cookie is not present, it will be generated. This field is applicable if the sessionAffinity is set to HTTP_COOKIE. Not supported when the backend service is referenced by a URL map that is bound to target gRPC proxy that has validateForProxyless field set to true.
  final pulumi.Input<ConsistentHashLoadBalancerSettingsHttpCookieResponse> httpCookie;
  ...
  /// Creates a new [ConsistentHashLoadBalancerSettingsResponse].
  /// [httpCookie] Hash is based on HTTP Cookie. This field describes a HTTP cookie that will be used as the hash key for the consistent hash load balancer. If the cookie is not present, it will be generated. This field is applicable if the sessionAffinity is set to HTTP_COOKIE. Not supported when the backend service is referenced by a URL map that is bound to target gRPC proxy that has validateForProxyless field set to true.
  ...
  const ConsistentHashLoadBalancerSettingsResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'httpCookie': pulumi.Input.mapInputValue<ConsistentHashLoadBalancerSettingsHttpCookieResponse, Map<String, dynamic>>(httpCookie, (value) => value.toMap()),
      'httpHeaderName': httpHeaderName,
      'minimumRingSize': minimumRingSize,
    };
  }

  factory ConsistentHashLoadBalancerSettingsResponse.fromMap(Map<String, dynamic> map) {
    return ConsistentHashLoadBalancerSettingsResponse(
      httpCookie: pulumi.Input.fromValue(ConsistentHashLoadBalancerSettingsHttpCookieResponse.fromMap((map['httpCookie']! as Map).cast<String, dynamic>())),
