...
class TCPHealthCheck {
  ...
  factory TCPHealthCheck.fromMap(Map<String, dynamic> map) {
    return TCPHealthCheck(
      ...
      portSpecification: map['portSpecification'] == null ? null : TCPHealthCheckPortSpecification.fromValue(map['portSpecification'] as String),
      proxyHeader: map['proxyHeader'] == null ? null : TCPHealthCheckProxyHeader.fromValue(map['proxyHeader'] as String),
