...
/// {@template pulumi_compute_beta_instant_snapshot_iam_binding_compute_beta_args_doc}
/// The set of arguments for InstantSnapshotIamBinding.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_instant_snapshot_iam_binding_compute_beta_args_doc}
class InstantSnapshotIamBindingComputeBetaArgs {
  ...
  /// Creates a new [InstantSnapshotIamBindingComputeBetaArgs].
  ...
  const InstantSnapshotIamBindingComputeBetaArgs({
    this.condition,
  ...
  factory InstantSnapshotIamBindingComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return InstantSnapshotIamBindingComputeBetaArgs(
