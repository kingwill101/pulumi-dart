...
class AllocationSpecificSKUAllocationReservedInstancePropertiesResponseComputeV1 {
  ...
  const AllocationSpecificSKUAllocationReservedInstancePropertiesResponseComputeV1({
  ...
  factory AllocationSpecificSKUAllocationReservedInstancePropertiesResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return AllocationSpecificSKUAllocationReservedInstancePropertiesResponseComputeV1(
      ...
      localSsds: pulumi.Input.fromValue(pulumi.Input.decodeList<AllocationSpecificSKUAllocationAllocatedInstancePropertiesReservedDiskResponseComputeV1>(map['localSsds']!, (value) => AllocationSpecificSKUAllocationAllocatedInstancePropertiesReservedDiskResponseComputeV1.fromMap((value as Map).cast<String, dynamic>()))),
