...
class NetworkInterfaceComputeV1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'nicType':
          ?pulumi.Input.mapOptionalInputValue<
            NetworkInterfaceNicTypeComputeV1,
            String
          >(nicType, (value) => value.wireValue),
      'queueCount': ?queueCount,
      'stackType':
          ?pulumi.Input.mapOptionalInputValue<
            NetworkInterfaceStackTypeComputeV1,
            String
  ...
  factory NetworkInterfaceComputeV1.fromMap(Map<String, dynamic> map) {
    return NetworkInterfaceComputeV1(
      ...
      nicType: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          NetworkInterfaceNicTypeComputeV1.fromValue(guardedValue as String),
        );
      })(),
      queueCount: (() {
      ...
      stackType: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          NetworkInterfaceStackTypeComputeV1.fromValue(guardedValue as String),
        );
      })(),
      subnetwork: (() {
