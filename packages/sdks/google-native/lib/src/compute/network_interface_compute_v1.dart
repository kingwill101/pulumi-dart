...
class NetworkInterfaceComputeV1 {
  ...
  final pulumi.Input<List<AccessConfigComputeV1>>? accessConfigs;
  /// An array of alias IP ranges for this network interface. You can only specify this field for network interfaces in VPC networks.
  final pulumi.Input<List<AliasIpRangeComputeV1>>? aliasIpRanges;
  /// The prefix length of the primary internal IPv6 range.
  final pulumi.Input<int>? internalIpv6PrefixLength;
  /// An array of IPv6 access configurations for this interface. Currently, only one IPv6 access config, DIRECT_IPV6, is supported. If there is no ipv6AccessConfig specified, then this instance will have no external IPv6 Internet access.
  final pulumi.Input<List<AccessConfigComputeV1>>? ipv6AccessConfigs;
  ...
  final pulumi.Input<NetworkInterfaceNicTypeComputeV1>? nicType;
  /// The networking queue count that's specified by users for the network interface. Both Rx and Tx queues will be set to this number. It'll be empty if not specified by the users.
  final pulumi.Input<int>? queueCount;
  /// The stack type for this network interface. To assign only IPv4 addresses, use IPV4_ONLY. To assign both IPv4 and IPv6 addresses, use IPV4_IPV6. If not specified, IPV4_ONLY is used. This field can be both set at instance creation and update network interface operations.
  final pulumi.Input<NetworkInterfaceStackTypeComputeV1>? stackType;
  ...
  const NetworkInterfaceComputeV1({
    this.accessConfigs,
    this.aliasIpRanges,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'accessConfigs': ?pulumi.Input.mapOptionalInputValue<List<AccessConfigComputeV1>, List<Map<String, dynamic>>>(accessConfigs, (value) => pulumi.Input.encodeList<AccessConfigComputeV1, Map<String, dynamic>>(value, (value) => value.toMap())),
      'aliasIpRanges': ?pulumi.Input.mapOptionalInputValue<List<AliasIpRangeComputeV1>, List<Map<String, dynamic>>>(aliasIpRanges, (value) => pulumi.Input.encodeList<AliasIpRangeComputeV1, Map<String, dynamic>>(value, (value) => value.toMap())),
      'internalIpv6PrefixLength': ?internalIpv6PrefixLength,
      'ipv6AccessConfigs': ?pulumi.Input.mapOptionalInputValue<List<AccessConfigComputeV1>, List<Map<String, dynamic>>>(ipv6AccessConfigs, (value) => pulumi.Input.encodeList<AccessConfigComputeV1, Map<String, dynamic>>(value, (value) => value.toMap())),
      'ipv6Address': ?ipv6Address,
      'network': ?network,
      'networkAttachment': ?networkAttachment,
      'networkIP': ?networkIP,
      'nicType': ?pulumi.Input.mapOptionalInputValue<NetworkInterfaceNicTypeComputeV1, String>(nicType, (value) => value.wireValue),
      'queueCount': ?queueCount,
      'stackType': ?pulumi.Input.mapOptionalInputValue<NetworkInterfaceStackTypeComputeV1, String>(stackType, (value) => value.wireValue),
  ...
  factory NetworkInterfaceComputeV1.fromMap(Map<String, dynamic> map) {
    return NetworkInterfaceComputeV1(
      accessConfigs: (() { final guardedValue = map['accessConfigs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AccessConfigComputeV1>(guardedValue, (value) => AccessConfigComputeV1.fromMap((value as Map).cast<String, dynamic>()))); })(),
      aliasIpRanges: (() { final guardedValue = map['aliasIpRanges']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AliasIpRangeComputeV1>(guardedValue, (value) => AliasIpRangeComputeV1.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      ipv6AccessConfigs: (() { final guardedValue = map['ipv6AccessConfigs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AccessConfigComputeV1>(guardedValue, (value) => AccessConfigComputeV1.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      nicType: (() { final guardedValue = map['nicType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkInterfaceNicTypeComputeV1.fromValue(guardedValue as String)); })(),
      ...
      stackType: (() { final guardedValue = map['stackType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkInterfaceStackTypeComputeV1.fromValue(guardedValue as String)); })(),
