...
class NetworkInterfaceComputeV1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'networkIP': ?networkIP,
      'nicType': ?pulumi.Input.mapOptionalInputValue<NetworkInterfaceNicTypeComputeV1, String>(nicType, (value) => value.value),
      'queueCount': ?queueCount,
      'stackType': ?pulumi.Input.mapOptionalInputValue<NetworkInterfaceStackTypeComputeV1, String>(stackType, (value) => value.value),
