...
class AccessConfigComputeV1 {
  ...
  final pulumi.Input<AccessConfigNetworkTierComputeV1>? networkTier;
  ...
  final pulumi.Input<AccessConfigTypeComputeV1>? type;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'natIP': ?natIP,
      'networkTier': ?pulumi.Input.mapOptionalInputValue<AccessConfigNetworkTierComputeV1, String>(networkTier, (value) => value.wireValue),
      'publicPtrDomainName': ?publicPtrDomainName,
      'setPublicPtr': ?setPublicPtr,
      'type': ?pulumi.Input.mapOptionalInputValue<AccessConfigTypeComputeV1, String>(type, (value) => value.wireValue),
    };
  }
  ...
  factory AccessConfigComputeV1.fromMap(Map<String, dynamic> map) {
    return AccessConfigComputeV1(
      ...
      networkTier: (() { final guardedValue = map['networkTier']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AccessConfigNetworkTierComputeV1.fromValue(guardedValue as String)); })(),
      ...
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AccessConfigTypeComputeV1.fromValue(guardedValue as String)); })(),
    );
  }
}
