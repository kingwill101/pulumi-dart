    ...
    return <String, dynamic>{
      ...
      'networkTier':
          ?pulumi.Input.mapOptionalInputValue<
            AccessConfigNetworkTierComputeV1,
            String
    ...
    return AccessConfigComputeV1(
      ...
      networkTier: (() {
        ...
        return pulumi.Input.fromValue(
          AccessConfigNetworkTierComputeV1.fromValue(guardedValue as String),
        );
      })(),
      publicPtrDomainName: (() {
      ...
      type: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AccessConfigTypeComputeV1.fromValue(guardedValue as String),
        );
      })(),
    );
  }
