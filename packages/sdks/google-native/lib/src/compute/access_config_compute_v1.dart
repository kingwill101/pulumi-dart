...
class AccessConfigComputeV1 {
  ...
  factory AccessConfigComputeV1.fromMap(Map<String, dynamic> map) {
    return AccessConfigComputeV1(
      ...
      networkTier: map['networkTier'] == null ? null : AccessConfigNetworkTierComputeV1.fromValue(map['networkTier'] as String),
      ...
      type: map['type'] == null ? null : AccessConfigTypeComputeV1.fromValue(map['type'] as String),
    );
  }
}
