...
class GetSslPolicyResult {
  ...
  final List<SslPolicyWarningsItemResponse> warnings;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'warnings': pulumi.Input.encodeList<SslPolicyWarningsItemResponse, Map<String, dynamic>>(warnings, (value) => value.toMap()),
    };
  }
  ...
  factory GetSslPolicyResult.fromMap(Map<String, dynamic> map) {
    return GetSslPolicyResult(
      ...
      tlsSettings: ServerTlsSettingsResponse.fromMap((map['tlsSettings'] as Map).cast<String, dynamic>()),
      warnings: pulumi.Input.decodeList<SslPolicyWarningsItemResponse>(map['warnings'], (value) => SslPolicyWarningsItemResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
