...
class AutoscalingPolicyResponseComputeV1 {
  ...
  final List<AutoscalingPolicyCustomMetricUtilizationResponseComputeV1> customMetricUtilizations;
  /// Configuration parameters of autoscaling based on load balancer.
  final AutoscalingPolicyLoadBalancingUtilizationResponseComputeV1 loadBalancingUtilization;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'customMetricUtilizations': pulumi.Input.encodeList<AutoscalingPolicyCustomMetricUtilizationResponseComputeV1, Map<String, dynamic>>(customMetricUtilizations, (value) => value.toMap()),
  ...
  factory AutoscalingPolicyResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return AutoscalingPolicyResponseComputeV1(
      ...
      cpuUtilization: AutoscalingPolicyCpuUtilizationResponseComputeV1.fromMap((map['cpuUtilization'] as Map).cast<String, dynamic>()),
      customMetricUtilizations: pulumi.Input.decodeList<AutoscalingPolicyCustomMetricUtilizationResponseComputeV1>(map['customMetricUtilizations'], (value) => AutoscalingPolicyCustomMetricUtilizationResponseComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      loadBalancingUtilization: AutoscalingPolicyLoadBalancingUtilizationResponseComputeV1.fromMap((map['loadBalancingUtilization'] as Map).cast<String, dynamic>()),
      maxNumReplicas: map['maxNumReplicas'] as int,
      minNumReplicas: map['minNumReplicas'] as int,
      mode: map['mode'] as String,
      scaleInControl: AutoscalingPolicyScaleInControlResponseComputeV1.fromMap((map['scaleInControl'] as Map).cast<String, dynamic>()),
