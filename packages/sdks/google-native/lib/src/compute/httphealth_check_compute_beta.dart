...
class HTTPHealthCheckComputeBeta {
  ...
  const HTTPHealthCheckComputeBeta({
    this.host,
    this.port,
    this.portName,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'port': ?port,
      'portName': ?portName,
      'portSpecification': ?pulumi.Input.mapOptionalInputValue<HTTPHealthCheckPortSpecificationComputeBeta, String>(portSpecification, (value) => value.wireValue),
      'proxyHeader': ?pulumi.Input.mapOptionalInputValue<HTTPHealthCheckProxyHeaderComputeBeta, String>(proxyHeader, (value) => value.wireValue),
  ...
  factory HTTPHealthCheckComputeBeta.fromMap(Map<String, dynamic> map) {
    return HTTPHealthCheckComputeBeta(
      ...
      portSpecification: (() { final guardedValue = map['portSpecification']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HTTPHealthCheckPortSpecificationComputeBeta.fromValue(guardedValue as String)); })(),
      proxyHeader: (() { final guardedValue = map['proxyHeader']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HTTPHealthCheckProxyHeaderComputeBeta.fromValue(guardedValue as String)); })(),
