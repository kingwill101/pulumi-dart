...
class HTTPHealthCheckComputeBeta {
  ...
  final pulumi.Input<HTTPHealthCheckPortSpecificationComputeBeta>?
  portSpecification;
    ...
    return <String, dynamic>{
      ...
      'portSpecification':
          ?pulumi.Input.mapOptionalInputValue<
            HTTPHealthCheckPortSpecificationComputeBeta,
            String
          >(portSpecification, (value) => value.wireValue),
      'proxyHeader':
          ?pulumi.Input.mapOptionalInputValue<
            HTTPHealthCheckProxyHeaderComputeBeta,
            String
    ...
    return HTTPHealthCheckComputeBeta(
      ...
      portSpecification: (() {
        ...
        return pulumi.Input.fromValue(
          HTTPHealthCheckPortSpecificationComputeBeta.fromValue(
      ...
      proxyHeader: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          HTTPHealthCheckProxyHeaderComputeBeta.fromValue(
            guardedValue as String,
          ),
        );
      })(),
