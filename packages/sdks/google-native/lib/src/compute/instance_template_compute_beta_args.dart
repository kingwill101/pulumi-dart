...
class InstanceTemplateComputeBetaArgs {
  ...
  const InstanceTemplateComputeBetaArgs({
    this.description,
    this.name,
    this.project,
    this.properties,
  ...
  factory InstanceTemplateComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return InstanceTemplateComputeBetaArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstancePropertiesComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      sourceInstanceParams: (() { final guardedValue = map['sourceInstanceParams']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SourceInstanceParamsComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
