...
class UrlMapTestResponseComputeV1 {
  ...
  const UrlMapTestResponseComputeV1({
  ...
  factory UrlMapTestResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return UrlMapTestResponseComputeV1(
      ...
      headers: pulumi.Input.fromValue(pulumi.Input.decodeList<UrlMapTestHeaderResponseComputeV1>(map['headers']!, (value) => UrlMapTestHeaderResponseComputeV1.fromMap((value as Map).cast<String, dynamic>()))),
