...
class AutoscalingPolicyCustomMetricUtilizationResponse {
  ...
  /// Creates a new [AutoscalingPolicyCustomMetricUtilizationResponse].
  ...
  const AutoscalingPolicyCustomMetricUtilizationResponse({
  ...
  factory AutoscalingPolicyCustomMetricUtilizationResponse.fromMap(Map<String, dynamic> map) {
    return AutoscalingPolicyCustomMetricUtilizationResponse(
