...
class AccessConfig {
  ...
  factory AccessConfig.fromMap(Map<String, dynamic> map) {
    return AccessConfig(
      ...
      networkTier: map['networkTier'] == null ? null : AccessConfigNetworkTier.fromValue(map['networkTier'] as String),
      publicPtrDomainName: map['publicPtrDomainName'] == null ? null : map['publicPtrDomainName'] as String,
      setPublicDns: map['setPublicDns'] == null ? null : map['setPublicDns'] as bool,
      setPublicPtr: map['setPublicPtr'] == null ? null : map['setPublicPtr'] as bool,
      type: map['type'] == null ? null : AccessConfigType.fromValue(map['type'] as String),
    );
  }
}
