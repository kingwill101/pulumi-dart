...
class AccessConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'natIP': ?natIP,
      'networkTier': ?pulumi.Input.mapOptionalInputValue<AccessConfigNetworkTier, String>(networkTier, (value) => value.wireValue),
      'publicPtrDomainName': ?publicPtrDomainName,
      'setPublicDns': ?setPublicDns,
      'setPublicPtr': ?setPublicPtr,
      'type': ?pulumi.Input.mapOptionalInputValue<AccessConfigType, String>(type, (value) => value.wireValue),
    };
  }
  ...
  factory AccessConfig.fromMap(Map<String, dynamic> map) {
    return AccessConfig(
      ...
      networkTier: (() { final guardedValue = map['networkTier']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AccessConfigNetworkTier.fromValue(guardedValue as String)); })(),
      ...
      setPublicDns: (() { final guardedValue = map['setPublicDns']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AccessConfigType.fromValue(guardedValue as String)); })(),
    );
  }
}
