...
class AccessConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'natIP': ?natIP,
      'networkTier': ?pulumi.Input.mapOptionalInputValue<AccessConfigNetworkTier, String>(networkTier, (value) => value.value),
      'publicPtrDomainName': ?publicPtrDomainName,
      'setPublicDns': ?setPublicDns,
      'setPublicPtr': ?setPublicPtr,
      'type': ?pulumi.Input.mapOptionalInputValue<AccessConfigType, String>(type, (value) => value.value),
    };
  }
