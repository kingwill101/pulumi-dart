...
class HealthCheckComputeV1Args {
  ...
  const HealthCheckComputeV1Args({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'type': ?pulumi.Input.mapOptionalInputValue<HealthCheckTypeComputeV1, String>(type, (value) => value.wireValue),
  ...
  factory HealthCheckComputeV1Args.fromMap(Map<String, dynamic> map) {
    return HealthCheckComputeV1Args(
      ...
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HealthCheckTypeComputeV1.fromValue(guardedValue as String)); })(),
