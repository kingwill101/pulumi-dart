...
class HTTP2HealthCheckComputeBeta {
  ...
  final pulumi.Input<HTTP2HealthCheckPortSpecificationComputeBeta>?
  portSpecification;
    ...
    return <String, dynamic>{
      ...
      'portSpecification':
          ?pulumi.Input.mapOptionalInputValue<
            HTTP2HealthCheckPortSpecificationComputeBeta,
            String
          >(portSpecification, (value) => value.wireValue),
      'proxyHeader':
          ?pulumi.Input.mapOptionalInputValue<
            HTTP2HealthCheckProxyHeaderComputeBeta,
            String
    ...
    return HTTP2HealthCheckComputeBeta(
      ...
      portSpecification: (() {
        ...
        return pulumi.Input.fromValue(
          HTTP2HealthCheckPortSpecificationComputeBeta.fromValue(
      ...
      proxyHeader: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          HTTP2HealthCheckProxyHeaderComputeBeta.fromValue(
            guardedValue as String,
          ),
        );
      })(),
