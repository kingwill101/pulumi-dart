...
class HTTP2HealthCheckComputeBeta {
  ...
  final HTTP2HealthCheckPortSpecificationComputeBeta? portSpecification;
  /// Specifies the type of proxy header to append before sending data to the backend, either NONE or PROXY_V1. The default is NONE.
  final HTTP2HealthCheckProxyHeaderComputeBeta? proxyHeader;
  ...
  factory HTTP2HealthCheckComputeBeta.fromMap(Map<String, dynamic> map) {
    return HTTP2HealthCheckComputeBeta(
      ...
      portSpecification: map['portSpecification'] == null ? null : HTTP2HealthCheckPortSpecificationComputeBeta.fromValue(map['portSpecification'] as String),
      proxyHeader: map['proxyHeader'] == null ? null : HTTP2HealthCheckProxyHeaderComputeBeta.fromValue(map['proxyHeader'] as String),
