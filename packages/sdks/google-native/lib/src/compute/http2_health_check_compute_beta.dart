...
class HTTP2HealthCheckComputeBeta {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'port': ?port,
      'portName': ?portName,
      'portSpecification': ?pulumi.Input.mapOptionalInputValue<HTTP2HealthCheckPortSpecificationComputeBeta, String>(portSpecification, (value) => value.value),
      'proxyHeader': ?pulumi.Input.mapOptionalInputValue<HTTP2HealthCheckProxyHeaderComputeBeta, String>(proxyHeader, (value) => value.value),
  ...
  factory HTTP2HealthCheckComputeBeta.fromMap(Map<String, dynamic> map) {
    return HTTP2HealthCheckComputeBeta(
      ...
      portSpecification: map['portSpecification'] == null ? null : (HTTP2HealthCheckPortSpecificationComputeBeta.fromValue(map['portSpecification'] as String)).input(),
      proxyHeader: map['proxyHeader'] == null ? null : (HTTP2HealthCheckProxyHeaderComputeBeta.fromValue(map['proxyHeader'] as String)).input(),
