...
class GetPacketMirroringComputeV1Result {
  ...
  const GetPacketMirroringComputeV1Result({
  ...
  factory GetPacketMirroringComputeV1Result.fromMap(Map<String, dynamic> map) {
    return GetPacketMirroringComputeV1Result(
      collectorIlb: PacketMirroringForwardingRuleInfoResponseComputeV1.fromMap((map['collectorIlb']! as Map).cast<String, dynamic>()),
      creationTimestamp: map['creationTimestamp'] as String,
      description: map['description'] as String,
      enable: map['enable'] as String,
      filter: PacketMirroringFilterResponseComputeV1.fromMap((map['filter']! as Map).cast<String, dynamic>()),
      kind: map['kind'] as String,
      mirroredResources: PacketMirroringMirroredResourceInfoResponseComputeV1.fromMap((map['mirroredResources']! as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      network: PacketMirroringNetworkInfoResponseComputeV1.fromMap((map['network']! as Map).cast<String, dynamic>()),
