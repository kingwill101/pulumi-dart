...
class NetworkComputeV1 extends pulumi.CustomResource {
  ...
  NetworkComputeV1(
    ...
    this.peerings = registerOutput<List<NetworkPeeringResponseComputeV1>>('peerings');
    this.project = registerOutput<String>('project');
    this.requestId = registerOutput<String?>('requestId');
    this.routingConfig = registerOutput<NetworkRoutingConfigResponseComputeV1>('routingConfig');
