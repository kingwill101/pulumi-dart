...
class PublicDelegatedPrefixPublicDelegatedSubPrefix {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'isAddress': ?isAddress,
      'mode': ?pulumi.Input.mapOptionalInputValue<PublicDelegatedPrefixPublicDelegatedSubPrefixMode, String>(mode, (value) => value.wireValue),
      'name': ?name,
    };
  }
  ...
  factory PublicDelegatedPrefixPublicDelegatedSubPrefix.fromMap(Map<String, dynamic> map) {
    return PublicDelegatedPrefixPublicDelegatedSubPrefix(
      ...
      mode: (() { final guardedValue = map['mode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PublicDelegatedPrefixPublicDelegatedSubPrefixMode.fromValue(guardedValue as String)); })(),
