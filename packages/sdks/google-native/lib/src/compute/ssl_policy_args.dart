...
class SslPolicyArgs {
  ...
  SslPolicyArgs({
    ...
    pulumi.Output<SslPolicyMinTlsVersion>? minTlsVersion,
    pulumi.Output<String>? name,
    pulumi.Output<SslPolicyProfile>? profile,
    ...
    pulumi.Output<ServerTlsSettings>? tlsSettings,
      ...
      minTlsVersion = pulumi.Input.asOptionalInput<SslPolicyMinTlsVersion>(minTlsVersion),
      name = pulumi.Input.asOptionalInput<String>(name),
      profile = pulumi.Input.asOptionalInput<SslPolicyProfile>(profile),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'minTlsVersion': ?pulumi.Input.mapOptionalInputValue<SslPolicyMinTlsVersion, String>(minTlsVersion, (value) => value.value),
      'name': ?name,
      'profile': ?pulumi.Input.mapOptionalInputValue<SslPolicyProfile, String>(profile, (value) => value.value),
      'project': ?project,
      'requestId': ?requestId,
  ...
  factory SslPolicyArgs.fromMap(Map<String, dynamic> map) {
    return SslPolicyArgs(
      ...
      minTlsVersion: map['minTlsVersion'] == null ? null : pulumi.Output.create<SslPolicyMinTlsVersion>(SslPolicyMinTlsVersion.fromValue(map['minTlsVersion'] as String)),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      profile: map['profile'] == null ? null : pulumi.Output.create<SslPolicyProfile>(SslPolicyProfile.fromValue(map['profile'] as String)),
