...
class InstanceGroupManagerUpdatePolicyComputeV1 {
  ...
  final pulumi.Input<InstanceGroupManagerUpdatePolicyMinimalActionComputeV1>?
  minimalAction;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'minimalAction':
          ?pulumi.Input.mapOptionalInputValue<
            InstanceGroupManagerUpdatePolicyMinimalActionComputeV1,
            String
      ...
      'type':
          ?pulumi.Input.mapOptionalInputValue<
            InstanceGroupManagerUpdatePolicyTypeComputeV1,
            String
