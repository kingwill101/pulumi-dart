...
class InstanceGroupManagerUpdatePolicyComputeV1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'instanceRedistributionType': ?pulumi.Input.mapOptionalInputValue<InstanceGroupManagerUpdatePolicyInstanceRedistributionTypeComputeV1, String>(instanceRedistributionType, (value) => value.wireValue),
      ...
      'minimalAction': ?pulumi.Input.mapOptionalInputValue<InstanceGroupManagerUpdatePolicyMinimalActionComputeV1, String>(minimalAction, (value) => value.wireValue),
      'mostDisruptiveAllowedAction': ?pulumi.Input.mapOptionalInputValue<InstanceGroupManagerUpdatePolicyMostDisruptiveAllowedActionComputeV1, String>(mostDisruptiveAllowedAction, (value) => value.wireValue),
      'replacementMethod': ?pulumi.Input.mapOptionalInputValue<InstanceGroupManagerUpdatePolicyReplacementMethodComputeV1, String>(replacementMethod, (value) => value.wireValue),
      'type': ?pulumi.Input.mapOptionalInputValue<InstanceGroupManagerUpdatePolicyTypeComputeV1, String>(type, (value) => value.wireValue),
    };
  }
  ...
  factory InstanceGroupManagerUpdatePolicyComputeV1.fromMap(Map<String, dynamic> map) {
    return InstanceGroupManagerUpdatePolicyComputeV1(
      instanceRedistributionType: (() { final guardedValue = map['instanceRedistributionType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceGroupManagerUpdatePolicyInstanceRedistributionTypeComputeV1.fromValue(guardedValue as String)); })(),
      maxSurge: (() { final guardedValue = map['maxSurge']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FixedOrPercentComputeV1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      maxUnavailable: (() { final guardedValue = map['maxUnavailable']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FixedOrPercentComputeV1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      minimalAction: (() { final guardedValue = map['minimalAction']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceGroupManagerUpdatePolicyMinimalActionComputeV1.fromValue(guardedValue as String)); })(),
      mostDisruptiveAllowedAction: (() { final guardedValue = map['mostDisruptiveAllowedAction']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceGroupManagerUpdatePolicyMostDisruptiveAllowedActionComputeV1.fromValue(guardedValue as String)); })(),
      replacementMethod: (() { final guardedValue = map['replacementMethod']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceGroupManagerUpdatePolicyReplacementMethodComputeV1.fromValue(guardedValue as String)); })(),
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceGroupManagerUpdatePolicyTypeComputeV1.fromValue(guardedValue as String)); })(),
    );
  }
}
