...
class InstanceGroupManagerUpdatePolicyComputeV1 {
  ...
  final InstanceGroupManagerUpdatePolicyInstanceRedistributionTypeComputeV1? instanceRedistributionType;
  /// The maximum number of instances that can be created above the specified targetSize during the update process. This value can be either a fixed number or, if the group has 10 or more instances, a percentage. If you set a percentage, the number of instances is rounded if necessary. The default value for maxSurge is a fixed value equal to the number of zones in which the managed instance group operates. At least one of either maxSurge or maxUnavailable must be greater than 0. Learn more about maxSurge.
  final FixedOrPercentComputeV1? maxSurge;
  ...
  final FixedOrPercentComputeV1? maxUnavailable;
  ...
  final InstanceGroupManagerUpdatePolicyMinimalActionComputeV1? minimalAction;
  /// Most disruptive action that is allowed to be taken on an instance. You can specify either NONE to forbid any actions, REFRESH to avoid restarting the VM and to limit disruption as much as possible. RESTART to allow actions that can be applied without instance replacing or REPLACE to allow all possible actions. If the Updater determines that the minimal update action needed is more disruptive than most disruptive allowed action you specify it will not perform the update at all.
  final InstanceGroupManagerUpdatePolicyMostDisruptiveAllowedActionComputeV1? mostDisruptiveAllowedAction;
  /// What action should be used to replace instances. See minimal_action.REPLACE
  final InstanceGroupManagerUpdatePolicyReplacementMethodComputeV1? replacementMethod;
  /// The type of update process. You can specify either PROACTIVE so that the MIG automatically updates VMs to the latest configurations or OPPORTUNISTIC so that you can select the VMs that you want to update.
  final InstanceGroupManagerUpdatePolicyTypeComputeV1? type;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'instanceRedistributionType': ?instanceRedistributionType == null ? null : instanceRedistributionType!.value,
      'maxSurge': ?maxSurge == null ? null : maxSurge!.toMap(),
      'maxUnavailable': ?maxUnavailable == null ? null : maxUnavailable!.toMap(),
      'minimalAction': ?minimalAction == null ? null : minimalAction!.value,
      'mostDisruptiveAllowedAction': ?mostDisruptiveAllowedAction == null ? null : mostDisruptiveAllowedAction!.value,
      'replacementMethod': ?replacementMethod == null ? null : replacementMethod!.value,
  ...
  factory InstanceGroupManagerUpdatePolicyComputeV1.fromMap(Map<String, dynamic> map) {
    return InstanceGroupManagerUpdatePolicyComputeV1(
      instanceRedistributionType: map['instanceRedistributionType'] == null ? null : InstanceGroupManagerUpdatePolicyInstanceRedistributionTypeComputeV1.fromValue(map['instanceRedistributionType'] as String),
      maxSurge: map['maxSurge'] == null ? null : FixedOrPercentComputeV1.fromMap((map['maxSurge'] as Map).cast<String, dynamic>()),
      maxUnavailable: map['maxUnavailable'] == null ? null : FixedOrPercentComputeV1.fromMap((map['maxUnavailable'] as Map).cast<String, dynamic>()),
      minimalAction: map['minimalAction'] == null ? null : InstanceGroupManagerUpdatePolicyMinimalActionComputeV1.fromValue(map['minimalAction'] as String),
      mostDisruptiveAllowedAction: map['mostDisruptiveAllowedAction'] == null ? null : InstanceGroupManagerUpdatePolicyMostDisruptiveAllowedActionComputeV1.fromValue(map['mostDisruptiveAllowedAction'] as String),
      replacementMethod: map['replacementMethod'] == null ? null : InstanceGroupManagerUpdatePolicyReplacementMethodComputeV1.fromValue(map['replacementMethod'] as String),
      type: map['type'] == null ? null : InstanceGroupManagerUpdatePolicyTypeComputeV1.fromValue(map['type'] as String),
    );
  }
}
