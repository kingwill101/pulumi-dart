...
class FirewallDeniedItemResponseComputeV1 {
  ...
  /// Creates a new [FirewallDeniedItemResponseComputeV1].
  ...
  const FirewallDeniedItemResponseComputeV1({
  ...
  factory FirewallDeniedItemResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return FirewallDeniedItemResponseComputeV1(
