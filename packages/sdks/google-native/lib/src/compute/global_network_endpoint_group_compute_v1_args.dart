...
class GlobalNetworkEndpointGroupComputeV1Args {
  ...
  const GlobalNetworkEndpointGroupComputeV1Args({
    this.annotations,
    this.appEngine,
    this.cloudFunction,
    this.cloudRun,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'network': ?network,
      'networkEndpointType': ?pulumi.Input.mapOptionalInputValue<GlobalNetworkEndpointGroupNetworkEndpointTypeComputeV1, String>(networkEndpointType, (value) => value.wireValue),
      'project': ?project,
      'pscData': ?pscData,
  ...
  factory GlobalNetworkEndpointGroupComputeV1Args.fromMap(Map<String, dynamic> map) {
    return GlobalNetworkEndpointGroupComputeV1Args(
      ...
      networkEndpointType: (() { final guardedValue = map['networkEndpointType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GlobalNetworkEndpointGroupNetworkEndpointTypeComputeV1.fromValue(guardedValue as String)); })(),
