...
/// {@template pulumi_compute_beta_backend_service_iam_binding_compute_beta_args_doc}
/// The set of arguments for BackendServiceIamBinding.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_backend_service_iam_binding_compute_beta_args_doc}
class BackendServiceIamBindingComputeBetaArgs {
  ...
  /// Creates a new [BackendServiceIamBindingComputeBetaArgs].
  ...
  const BackendServiceIamBindingComputeBetaArgs({
    this.condition,
  ...
  factory BackendServiceIamBindingComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return BackendServiceIamBindingComputeBetaArgs(
