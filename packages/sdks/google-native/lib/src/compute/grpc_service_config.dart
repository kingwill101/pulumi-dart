...
class GrpcServiceConfig {
  ...
  factory GrpcServiceConfig.fromMap(Map<String, dynamic> map) {
    return GrpcServiceConfig(
      callCredentials: (() { final guardedValue = map['callCredentials']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CallCredentials.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      channelCredentials: (() { final guardedValue = map['channelCredentials']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ChannelCredentials.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
