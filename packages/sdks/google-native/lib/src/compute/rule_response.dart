...
class RuleResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ins': ins,
      'logConfigs': pulumi.Input.encodeList<LogConfigResponse, Map<String, dynamic>>(logConfigs, (value) => value.toMap()),
      'notIns': notIns,
  ...
  factory RuleResponse.fromMap(Map<String, dynamic> map) {
    return RuleResponse(
      ...
      logConfigs: pulumi.Input.decodeList<LogConfigResponse>(map['logConfigs'], (value) => LogConfigResponse.fromMap((value as Map).cast<String, dynamic>())),
