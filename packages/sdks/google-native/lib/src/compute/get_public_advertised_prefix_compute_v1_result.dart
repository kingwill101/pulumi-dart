...
class GetPublicAdvertisedPrefixComputeV1Result {
  ...
  final List<PublicAdvertisedPrefixPublicDelegatedPrefixResponseComputeV1> publicDelegatedPrefixs;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': name,
      'pdpScope': pdpScope,
      'publicDelegatedPrefixs': pulumi.Input.encodeList<PublicAdvertisedPrefixPublicDelegatedPrefixResponseComputeV1, Map<String, dynamic>>(publicDelegatedPrefixs, (value) => value.toMap()),
      'selfLink': selfLink,
  ...
  factory GetPublicAdvertisedPrefixComputeV1Result.fromMap(Map<String, dynamic> map) {
    return GetPublicAdvertisedPrefixComputeV1Result(
      ...
      publicDelegatedPrefixs: pulumi.Input.decodeList<PublicAdvertisedPrefixPublicDelegatedPrefixResponseComputeV1>(map['publicDelegatedPrefixs'], (value) => PublicAdvertisedPrefixPublicDelegatedPrefixResponseComputeV1.fromMap((value as Map).cast<String, dynamic>())),
