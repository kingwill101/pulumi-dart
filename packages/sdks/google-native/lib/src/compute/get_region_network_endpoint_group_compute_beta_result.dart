...
class GetRegionNetworkEndpointGroupComputeBetaResult {
  ...
  /// Creates a new [GetRegionNetworkEndpointGroupComputeBetaResult].
  ...
  const GetRegionNetworkEndpointGroupComputeBetaResult({
  ...
  factory GetRegionNetworkEndpointGroupComputeBetaResult.fromMap(Map<String, dynamic> map) {
