...
/// {@template pulumi_compute_v1_network_attachment_iam_binding_compute_v1_args_doc}
/// The set of arguments for NetworkAttachmentIamBinding.
/// {@endtemplate}
/// {@macro pulumi_compute_v1_network_attachment_iam_binding_compute_v1_args_doc}
class NetworkAttachmentIamBindingComputeV1Args {
  ...
  /// Creates a new [NetworkAttachmentIamBindingComputeV1Args].
  ...
  const NetworkAttachmentIamBindingComputeV1Args({
    this.condition,
  ...
  factory NetworkAttachmentIamBindingComputeV1Args.fromMap(Map<String, dynamic> map) {
    return NetworkAttachmentIamBindingComputeV1Args(
