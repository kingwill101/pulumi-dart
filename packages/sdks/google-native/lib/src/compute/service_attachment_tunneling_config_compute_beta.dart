...
class ServiceAttachmentTunnelingConfigComputeBeta {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'encapsulationProfile': ?pulumi.Input.mapOptionalInputValue<ServiceAttachmentTunnelingConfigEncapsulationProfileComputeBeta, String>(encapsulationProfile, (value) => value.wireValue),
      'routingMode': ?pulumi.Input.mapOptionalInputValue<ServiceAttachmentTunnelingConfigRoutingModeComputeBeta, String>(routingMode, (value) => value.wireValue),
    };
  }
  ...
  factory ServiceAttachmentTunnelingConfigComputeBeta.fromMap(Map<String, dynamic> map) {
    return ServiceAttachmentTunnelingConfigComputeBeta(
      encapsulationProfile: (() { final guardedValue = map['encapsulationProfile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServiceAttachmentTunnelingConfigEncapsulationProfileComputeBeta.fromValue(guardedValue as String)); })(),
      routingMode: (() { final guardedValue = map['routingMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServiceAttachmentTunnelingConfigRoutingModeComputeBeta.fromValue(guardedValue as String)); })(),
    );
  }
}
