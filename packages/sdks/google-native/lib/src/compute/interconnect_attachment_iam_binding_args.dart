...
/// {@template pulumi_compute_alpha_interconnect_attachment_iam_binding_args_doc}
/// The set of arguments for InterconnectAttachmentIamBinding.
/// {@endtemplate}
/// {@macro pulumi_compute_alpha_interconnect_attachment_iam_binding_args_doc}
class InterconnectAttachmentIamBindingArgs {
  ...
  /// Creates a new [InterconnectAttachmentIamBindingArgs].
  ...
  const InterconnectAttachmentIamBindingArgs({
    this.condition,
  ...
  factory InterconnectAttachmentIamBindingArgs.fromMap(Map<String, dynamic> map) {
