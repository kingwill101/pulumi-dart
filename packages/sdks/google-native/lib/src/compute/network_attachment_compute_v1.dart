...
import 'network_attachment_compute_v1_args.dart';

/// Creates a NetworkAttachment in the specified project in the given scope using the parameters that are included in the request.
class NetworkAttachmentComputeV1 extends pulumi.CustomResource {
  ...
  /// Creates a new [NetworkAttachmentComputeV1].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [NetworkAttachmentComputeV1]. {@macro pulumi_compute_v1_network_attachment_compute_v1_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  NetworkAttachmentComputeV1(
    String name, {
    NetworkAttachmentComputeV1Args? args,
