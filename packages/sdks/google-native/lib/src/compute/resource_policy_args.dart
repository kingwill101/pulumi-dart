...
class ResourcePolicyArgs {
  ...
  factory ResourcePolicyArgs.fromMap(Map<String, dynamic> map) {
    return ResourcePolicyArgs(
      ...
      vmMaintenancePolicy: (() { final guardedValue = map['vmMaintenancePolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResourcePolicyVmMaintenancePolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
