...
class GlobalForwardingRuleComputeV1Args {
  ...
  factory GlobalForwardingRuleComputeV1Args.fromMap(Map<String, dynamic> map) {
    return GlobalForwardingRuleComputeV1Args(
      ...
      ipProtocol: map['ipProtocol'] == null ? null : (GlobalForwardingRuleIpProtocolComputeV1.fromValue(map['ipProtocol'] as String)).input(),
      ipVersion: map['ipVersion'] == null ? null : (GlobalForwardingRuleIpVersionComputeV1.fromValue(map['ipVersion'] as String)).input(),
      isMirroringCollector: map['isMirroringCollector'] == null ? null : (map['isMirroringCollector'] as bool).input(),
      labels: map['labels'] == null ? null : ((map['labels'] as Map).cast<String, String>()).input(),
      loadBalancingScheme: map['loadBalancingScheme'] == null ? null : (GlobalForwardingRuleLoadBalancingSchemeComputeV1.fromValue(map['loadBalancingScheme'] as String)).input(),
      metadataFilters: map['metadataFilters'] == null ? null : (pulumi.Input.decodeList<MetadataFilterComputeV1>(map['metadataFilters'], (value) => MetadataFilterComputeV1.fromMap((value as Map).cast<String, dynamic>()))).input(),
      name: map['name'] == null ? null : (map['name'] as String).input(),
      network: map['network'] == null ? null : (map['network'] as String).input(),
      networkTier: map['networkTier'] == null ? null : (GlobalForwardingRuleNetworkTierComputeV1.fromValue(map['networkTier'] as String)).input(),
      ...
      pscConnectionStatus: map['pscConnectionStatus'] == null ? null : (GlobalForwardingRulePscConnectionStatusComputeV1.fromValue(map['pscConnectionStatus'] as String)).input(),
      requestId: map['requestId'] == null ? null : (map['requestId'] as String).input(),
      serviceDirectoryRegistrations: map['serviceDirectoryRegistrations'] == null ? null : (pulumi.Input.decodeList<ForwardingRuleServiceDirectoryRegistrationComputeV1>(map['serviceDirectoryRegistrations'], (value) => ForwardingRuleServiceDirectoryRegistrationComputeV1.fromMap((value as Map).cast<String, dynamic>()))).input(),
