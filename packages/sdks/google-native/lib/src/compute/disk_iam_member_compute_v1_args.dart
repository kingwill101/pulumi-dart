...
/// {@template pulumi_compute_v1_disk_iam_member_compute_v1_args_doc}
/// The set of arguments for DiskIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_v1_disk_iam_member_compute_v1_args_doc}
class DiskIamMemberComputeV1Args {
  ...
  /// Creates a new [DiskIamMemberComputeV1Args].
  ...
  const DiskIamMemberComputeV1Args({
    this.condition,
  ...
  factory DiskIamMemberComputeV1Args.fromMap(Map<String, dynamic> map) {
    return DiskIamMemberComputeV1Args(
