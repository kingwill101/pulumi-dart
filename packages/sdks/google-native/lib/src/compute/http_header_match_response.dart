...
import 'int64_range_match_response.dart';

/// matchRule criteria for request header matches.
class HttpHeaderMatchResponse {
  ...
  final pulumi.Input<Int64RangeMatchResponse> rangeMatch;
  ...
  /// Creates a new [HttpHeaderMatchResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'rangeMatch': pulumi.Input.mapInputValue<Int64RangeMatchResponse, Map<String, dynamic>>(rangeMatch, (value) => value.toMap()),
      'regexMatch': regexMatch,
      'suffixMatch': suffixMatch,
    };
  }

  factory HttpHeaderMatchResponse.fromMap(Map<String, dynamic> map) {
    return HttpHeaderMatchResponse(
      ...
      rangeMatch: pulumi.Input.fromValue(Int64RangeMatchResponse.fromMap((map['rangeMatch']! as Map).cast<String, dynamic>())),
