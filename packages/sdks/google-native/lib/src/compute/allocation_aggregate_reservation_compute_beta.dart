...
class AllocationAggregateReservationComputeBeta {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'vmFamily': ?pulumi.Input.mapOptionalInputValue<AllocationAggregateReservationVmFamilyComputeBeta, String>(vmFamily, (value) => value.value),
      'workloadType': ?pulumi.Input.mapOptionalInputValue<AllocationAggregateReservationWorkloadTypeComputeBeta, String>(workloadType, (value) => value.value),
    };
  }
