...
class GetNetworkAttachmentComputeV1Result {
  ...
  final List<NetworkAttachmentConnectedEndpointResponseComputeV1>
  connectionEndpoints;
  ...
  factory GetNetworkAttachmentComputeV1Result.fromMap(
    ...
    return GetNetworkAttachmentComputeV1Result(
      connectionEndpoints:
          ...
          >(
            ...
            (value) =>
                NetworkAttachmentConnectedEndpointResponseComputeV1.fromMap(
