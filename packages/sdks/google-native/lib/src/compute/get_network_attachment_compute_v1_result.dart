...
import 'network_attachment_connected_endpoint_response_compute_v1.dart';

/// Result data returned by getNetworkAttachment.
class GetNetworkAttachmentComputeV1Result {
  /// An array of connections for all the producers connected to this network attachment.
  final List<NetworkAttachmentConnectedEndpointResponseComputeV1> connectionEndpoints;
  ...
  /// Creates a new [GetNetworkAttachmentComputeV1Result].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'connectionEndpoints': pulumi.Input.encodeList<NetworkAttachmentConnectedEndpointResponseComputeV1, Map<String, dynamic>>(connectionEndpoints, (value) => value.toMap()),
  ...
  factory GetNetworkAttachmentComputeV1Result.fromMap(Map<String, dynamic> map) {
    return GetNetworkAttachmentComputeV1Result(
      connectionEndpoints: pulumi.Input.decodeList<NetworkAttachmentConnectedEndpointResponseComputeV1>(map['connectionEndpoints']!, (value) => NetworkAttachmentConnectedEndpointResponseComputeV1.fromMap((value as Map).cast<String, dynamic>())),
