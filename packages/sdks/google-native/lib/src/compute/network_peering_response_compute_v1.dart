...
class NetworkPeeringResponseComputeV1 {
  ...
  factory NetworkPeeringResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return NetworkPeeringResponseComputeV1(
      ...
      exchangeSubnetRoutes: pulumi.Input.fromValue(
        map['exchangeSubnetRoutes'] as bool,
      ),
      exportCustomRoutes: pulumi.Input.fromValue(
        map['exportCustomRoutes'] as bool,
      ),
      exportSubnetRoutesWithPublicIp: pulumi.Input.fromValue(
        map['exportSubnetRoutesWithPublicIp'] as bool,
      ),
      importCustomRoutes: pulumi.Input.fromValue(
        map['importCustomRoutes'] as bool,
      ),
      importSubnetRoutesWithPublicIp: pulumi.Input.fromValue(
