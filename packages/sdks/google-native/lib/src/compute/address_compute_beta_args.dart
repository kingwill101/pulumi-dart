...
/// {@template pulumi_compute_beta_address_compute_beta_args_doc}
/// The set of arguments for Address.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_address_compute_beta_args_doc}
class AddressComputeBetaArgs {
  ...
  /// Creates a new [AddressComputeBetaArgs].
  ...
  AddressComputeBetaArgs({
    ...
    pulumi.Output<AddressAddressTypeComputeBeta>? addressType,
    pulumi.Output<String>? description,
    pulumi.Output<AddressIpVersionComputeBeta>? ipVersion,
    pulumi.Output<AddressIpv6EndpointTypeComputeBeta>? ipv6EndpointType,
    pulumi.Output<Map<String, String>>? labels,
    pulumi.Output<String>? name,
    pulumi.Output<String>? network,
    pulumi.Output<AddressNetworkTierComputeBeta>? networkTier,
    pulumi.Output<int>? prefixLength,
    pulumi.Output<String>? project,
    pulumi.Output<AddressPurposeComputeBeta>? purpose,
    required pulumi.Output<String> region,
    pulumi.Output<String>? requestId,
    pulumi.Output<String>? subnetwork,
  }) :
      address = pulumi.Input.asOptionalInput<String>(address),
      addressType = pulumi.Input.asOptionalInput<AddressAddressTypeComputeBeta>(addressType),
      description = pulumi.Input.asOptionalInput<String>(description),
      ipVersion = pulumi.Input.asOptionalInput<AddressIpVersionComputeBeta>(ipVersion),
      ipv6EndpointType = pulumi.Input.asOptionalInput<AddressIpv6EndpointTypeComputeBeta>(ipv6EndpointType),
      labels = pulumi.Input.asOptionalInput<Map<String, String>>(labels),
      name = pulumi.Input.asOptionalInput<String>(name),
      network = pulumi.Input.asOptionalInput<String>(network),
      networkTier = pulumi.Input.asOptionalInput<AddressNetworkTierComputeBeta>(networkTier),
      prefixLength = pulumi.Input.asOptionalInput<int>(prefixLength),
      project = pulumi.Input.asOptionalInput<String>(project),
      purpose = pulumi.Input.asOptionalInput<AddressPurposeComputeBeta>(purpose),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'address': ?address,
      'addressType': ?pulumi.Input.mapOptionalInputValue<AddressAddressTypeComputeBeta, String>(addressType, (value) => value.value),
      'description': ?description,
      'ipVersion': ?pulumi.Input.mapOptionalInputValue<AddressIpVersionComputeBeta, String>(ipVersion, (value) => value.value),
      'ipv6EndpointType': ?pulumi.Input.mapOptionalInputValue<AddressIpv6EndpointTypeComputeBeta, String>(ipv6EndpointType, (value) => value.value),
      'labels': ?labels,
      'name': ?name,
      'network': ?network,
      'networkTier': ?pulumi.Input.mapOptionalInputValue<AddressNetworkTierComputeBeta, String>(networkTier, (value) => value.value),
      'prefixLength': ?prefixLength,
      'project': ?project,
      'purpose': ?pulumi.Input.mapOptionalInputValue<AddressPurposeComputeBeta, String>(purpose, (value) => value.value),
      'region': region,
      'requestId': ?requestId,
  ...
  factory AddressComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return AddressComputeBetaArgs(
      ...
      addressType: map['addressType'] == null ? null : pulumi.Output.create<AddressAddressTypeComputeBeta>(AddressAddressTypeComputeBeta.fromValue(map['addressType'] as String)),
      description: map['description'] == null ? null : pulumi.Output.create<String>(map['description'] as String),
      ipVersion: map['ipVersion'] == null ? null : pulumi.Output.create<AddressIpVersionComputeBeta>(AddressIpVersionComputeBeta.fromValue(map['ipVersion'] as String)),
      ipv6EndpointType: map['ipv6EndpointType'] == null ? null : pulumi.Output.create<AddressIpv6EndpointTypeComputeBeta>(AddressIpv6EndpointTypeComputeBeta.fromValue(map['ipv6EndpointType'] as String)),
      labels: map['labels'] == null ? null : pulumi.Output.create<Map<String, String>>((map['labels'] as Map).cast<String, String>()),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      network: map['network'] == null ? null : pulumi.Output.create<String>(map['network'] as String),
      networkTier: map['networkTier'] == null ? null : pulumi.Output.create<AddressNetworkTierComputeBeta>(AddressNetworkTierComputeBeta.fromValue(map['networkTier'] as String)),
      prefixLength: map['prefixLength'] == null ? null : pulumi.Output.create<int>(map['prefixLength'] as int),
      project: map['project'] == null ? null : pulumi.Output.create<String>(map['project'] as String),
      purpose: map['purpose'] == null ? null : pulumi.Output.create<AddressPurposeComputeBeta>(AddressPurposeComputeBeta.fromValue(map['purpose'] as String)),
