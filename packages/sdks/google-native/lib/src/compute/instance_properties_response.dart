...
class InstancePropertiesResponse {
  ...
  factory InstancePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return InstancePropertiesResponse(
      ...
      displayDevice: pulumi.Input.fromValue(DisplayDeviceResponse.fromMap((map['displayDevice']! as Map).cast<String, dynamic>())),
      ...
      partnerMetadata: pulumi.Input.fromValue((map['partnerMetadata'] as Map).cast<String, String>()),
      ...
      secureTags: pulumi.Input.fromValue((map['secureTags'] as List).cast<String>()),
      ...
      serviceIntegrationSpecs: pulumi.Input.fromValue((map['serviceIntegrationSpecs'] as Map).cast<String, String>()),
      ...
      shieldedVmConfig: pulumi.Input.fromValue(ShieldedVmConfigResponse.fromMap((map['shieldedVmConfig']! as Map).cast<String, dynamic>())),
