...
class InstancePropertiesResponse {
  ...
  final pulumi.Input<ConfidentialInstanceConfigResponse>
  ...
  factory InstancePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return InstancePropertiesResponse(
      ...
      partnerMetadata: pulumi.Input.fromValue(
      ...
      secureTags: pulumi.Input.fromValue(
      ...
      serviceIntegrationSpecs: pulumi.Input.fromValue(
      ...
      shieldedVmConfig: pulumi.Input.fromValue(
        ShieldedVmConfigResponse.fromMap(
