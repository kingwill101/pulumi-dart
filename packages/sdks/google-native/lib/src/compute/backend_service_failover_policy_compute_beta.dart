...
class BackendServiceFailoverPolicyComputeBeta {
  ...
  /// Creates a new [BackendServiceFailoverPolicyComputeBeta].
  ...
  const BackendServiceFailoverPolicyComputeBeta({
  ...
  factory BackendServiceFailoverPolicyComputeBeta.fromMap(Map<String, dynamic> map) {
    return BackendServiceFailoverPolicyComputeBeta(
