...
import 'subnetwork_log_config_aggregation_interval_compute_v1.dart';
import 'subnetwork_log_config_metadata_compute_v1.dart';

/// The available logging options for this subnetwork.
class SubnetworkLogConfigComputeV1 {
  /// Can only be specified if VPC flow logging for this subnetwork is enabled. Toggles the aggregation interval for collecting flow logs. Increasing the interval time will reduce the amount of generated flow logs for long lasting connections. Default is an interval of 5 seconds per connection.
  final pulumi.Input<SubnetworkLogConfigAggregationIntervalComputeV1>? aggregationInterval;
  ...
  final pulumi.Input<SubnetworkLogConfigMetadataComputeV1>? metadata;
  /// Can only be specified if VPC flow logs for this subnetwork is enabled and "metadata" was set to CUSTOM_METADATA.
  final pulumi.Input<List<String>>? metadataFields;

  /// Creates a new [SubnetworkLogConfigComputeV1].
  ...
  const SubnetworkLogConfigComputeV1({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'aggregationInterval': ?pulumi.Input.mapOptionalInputValue<SubnetworkLogConfigAggregationIntervalComputeV1, String>(aggregationInterval, (value) => value.wireValue),
      'enable': ?enable,
      'filterExpr': ?filterExpr,
      'flowSampling': ?flowSampling,
      'metadata': ?pulumi.Input.mapOptionalInputValue<SubnetworkLogConfigMetadataComputeV1, String>(metadata, (value) => value.wireValue),
      'metadataFields': ?metadataFields,
    };
  }

  factory SubnetworkLogConfigComputeV1.fromMap(Map<String, dynamic> map) {
    return SubnetworkLogConfigComputeV1(
      aggregationInterval: (() { final guardedValue = map['aggregationInterval']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SubnetworkLogConfigAggregationIntervalComputeV1.fromValue(guardedValue as String)); })(),
      ...
      metadata: (() { final guardedValue = map['metadata']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SubnetworkLogConfigMetadataComputeV1.fromValue(guardedValue as String)); })(),
