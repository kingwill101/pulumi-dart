...
class InitialStateConfig {
  ...
  factory InitialStateConfig.fromMap(Map<String, dynamic> map) {
    return InitialStateConfig(
      dbs: (() { final guardedValue = map['dbs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FileContentBuffer>(guardedValue, (value) => FileContentBuffer.fromMap((value as Map).cast<String, dynamic>()))); })(),
      dbxs: (() { final guardedValue = map['dbxs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FileContentBuffer>(guardedValue, (value) => FileContentBuffer.fromMap((value as Map).cast<String, dynamic>()))); })(),
      keks: (() { final guardedValue = map['keks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FileContentBuffer>(guardedValue, (value) => FileContentBuffer.fromMap((value as Map).cast<String, dynamic>()))); })(),
      pk: (() { final guardedValue = map['pk']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FileContentBuffer.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
