...
class LogConfigCounterOptions {
  ...
  factory LogConfigCounterOptions.fromMap(Map<String, dynamic> map) {
    return LogConfigCounterOptions(
      customFields: (() { final guardedValue = map['customFields']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<LogConfigCounterOptionsCustomField>(guardedValue, (value) => LogConfigCounterOptionsCustomField.fromMap((value as Map).cast<String, dynamic>()))); })(),
