...
import 'http_health_check_compute_v1_args.dart';

/// Creates a HttpHealthCheck resource in the specified project using the data included in the request.
class HttpHealthCheckComputeV1 extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [HttpHealthCheckComputeV1]. {@macro pulumi_compute_v1_http_health_check_compute_v1_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  HttpHealthCheckComputeV1(
    String name, {
    HttpHealthCheckComputeV1Args? args,
