...
class InterconnectMacsecComputeV1 {
  ...
  final pulumi.Input<List<InterconnectMacsecPreSharedKeyComputeV1>>
  preSharedKeys;
  ...
  InterconnectMacsecComputeV1({this.failOpen, required this.preSharedKeys});
    ...
    return <String, dynamic>{
      ...
      'preSharedKeys':
          pulumi.Input.mapInputValue<
            List<InterconnectMacsecPreSharedKeyComputeV1>,
