...
class InterconnectMacsecComputeV1 {
  ...
  final pulumi.Input<List<InterconnectMacsecPreSharedKeyComputeV1>> preSharedKeys;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'failOpen': ?failOpen,
      'preSharedKeys': pulumi.Input.mapInputValue<List<InterconnectMacsecPreSharedKeyComputeV1>, List<Map<String, dynamic>>>(preSharedKeys, (value) => pulumi.Input.encodeList<InterconnectMacsecPreSharedKeyComputeV1, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory InterconnectMacsecComputeV1.fromMap(Map<String, dynamic> map) {
    return InterconnectMacsecComputeV1(
      ...
      preSharedKeys: pulumi.Input.fromValue(pulumi.Input.decodeList<InterconnectMacsecPreSharedKeyComputeV1>(map['preSharedKeys']!, (value) => InterconnectMacsecPreSharedKeyComputeV1.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
