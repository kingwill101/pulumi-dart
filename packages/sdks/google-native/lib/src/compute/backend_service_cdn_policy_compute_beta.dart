...
class BackendServiceCdnPolicyComputeBeta {
  ...
  final List<BackendServiceCdnPolicyBypassCacheOnRequestHeaderComputeBeta>? bypassCacheOnRequestHeaders;
  ...
  final List<BackendServiceCdnPolicyNegativeCachingPolicyComputeBeta>? negativeCachingPolicy;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'bypassCacheOnRequestHeaders': ?bypassCacheOnRequestHeaders == null ? null : pulumi.Input.encodeList<BackendServiceCdnPolicyBypassCacheOnRequestHeaderComputeBeta, Map<String, dynamic>>(bypassCacheOnRequestHeaders!, (value) => value.toMap()),
      ...
      'negativeCachingPolicy': ?negativeCachingPolicy == null ? null : pulumi.Input.encodeList<BackendServiceCdnPolicyNegativeCachingPolicyComputeBeta, Map<String, dynamic>>(negativeCachingPolicy!, (value) => value.toMap()),
  ...
  factory BackendServiceCdnPolicyComputeBeta.fromMap(Map<String, dynamic> map) {
    return BackendServiceCdnPolicyComputeBeta(
      bypassCacheOnRequestHeaders: map['bypassCacheOnRequestHeaders'] == null ? null : pulumi.Input.decodeList<BackendServiceCdnPolicyBypassCacheOnRequestHeaderComputeBeta>(map['bypassCacheOnRequestHeaders'], (value) => BackendServiceCdnPolicyBypassCacheOnRequestHeaderComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      cacheKeyPolicy: map['cacheKeyPolicy'] == null ? null : CacheKeyPolicyComputeBeta.fromMap((map['cacheKeyPolicy'] as Map).cast<String, dynamic>()),
      cacheMode: map['cacheMode'] == null ? null : BackendServiceCdnPolicyCacheModeComputeBeta.fromValue(map['cacheMode'] as String),
      ...
      negativeCachingPolicy: map['negativeCachingPolicy'] == null ? null : pulumi.Input.decodeList<BackendServiceCdnPolicyNegativeCachingPolicyComputeBeta>(map['negativeCachingPolicy'], (value) => BackendServiceCdnPolicyNegativeCachingPolicyComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
