...
/// {@template pulumi_compute_beta_region_network_firewall_policy_iam_binding_compute_beta_args_doc}
/// The set of arguments for RegionNetworkFirewallPolicyIamBinding.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_region_network_firewall_policy_iam_binding_compute_beta_args_doc}
class RegionNetworkFirewallPolicyIamBindingComputeBetaArgs {
  ...
  /// Creates a new [RegionNetworkFirewallPolicyIamBindingComputeBetaArgs].
  ...
  const RegionNetworkFirewallPolicyIamBindingComputeBetaArgs({
    this.condition,
  ...
  factory RegionNetworkFirewallPolicyIamBindingComputeBetaArgs.fromMap(Map<String, dynamic> map) {
