    ...
    return <String, dynamic>{
      ...
      'networkFirewallPolicyEnforcementOrder':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(networkFirewallPolicyEnforcementOrder, (value) => value.wireValue),
      'project': ?project,
      'requestId': ?requestId,
      'routingConfig':
          ?pulumi.Input.mapOptionalInputValue<
  ...
  factory NetworkComputeV1Args.fromMap(Map<String, dynamic> map) {
    return NetworkComputeV1Args(
      autoCreateSubnetworks: (() {
        final guardedValue = map['autoCreateSubnetworks'];
      ...
      enableUlaInternalIpv6: (() {
        final guardedValue = map['enableUlaInternalIpv6'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      internalIpv6Range: (() {
        final guardedValue = map['internalIpv6Range'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ipv4Range: (() {
      ...
      networkFirewallPolicyEnforcementOrder: (() {
        final guardedValue = map['networkFirewallPolicyEnforcementOrder'];
        if (guardedValue == null) return null;
