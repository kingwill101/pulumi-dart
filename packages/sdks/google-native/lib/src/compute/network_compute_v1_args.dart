...
class NetworkComputeV1Args {
  ...
  NetworkComputeV1Args({
    ...
    pulumi.Output<NetworkNetworkFirewallPolicyEnforcementOrderComputeV1>? networkFirewallPolicyEnforcementOrder,
    pulumi.Output<String>? project,
    pulumi.Output<String>? requestId,
    pulumi.Output<NetworkRoutingConfigComputeV1>? routingConfig,
  }) :
  ...
  factory NetworkComputeV1Args.fromMap(Map<String, dynamic> map) {
    return NetworkComputeV1Args(
      ...
      networkFirewallPolicyEnforcementOrder: map['networkFirewallPolicyEnforcementOrder'] == null ? null : pulumi.Output.create<NetworkNetworkFirewallPolicyEnforcementOrderComputeV1>(NetworkNetworkFirewallPolicyEnforcementOrderComputeV1.fromValue(map['networkFirewallPolicyEnforcementOrder'] as String)),
      project: map['project'] == null ? null : pulumi.Output.create<String>(map['project'] as String),
      requestId: map['requestId'] == null ? null : pulumi.Output.create<String>(map['requestId'] as String),
      routingConfig: map['routingConfig'] == null ? null : pulumi.Output.create<NetworkRoutingConfigComputeV1>(NetworkRoutingConfigComputeV1.fromMap((map['routingConfig'] as Map).cast<String, dynamic>())),
    );
  }
}
