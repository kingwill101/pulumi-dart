...
class NetworkComputeV1Args {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'mtu': ?mtu,
      'name': ?name,
      'networkFirewallPolicyEnforcementOrder': ?pulumi.Input.mapOptionalInputValue<NetworkNetworkFirewallPolicyEnforcementOrderComputeV1, String>(networkFirewallPolicyEnforcementOrder, (value) => value.wireValue),
      'project': ?project,
      'requestId': ?requestId,
  ...
  factory NetworkComputeV1Args.fromMap(Map<String, dynamic> map) {
    return NetworkComputeV1Args(
      ...
      networkFirewallPolicyEnforcementOrder: (() { final guardedValue = map['networkFirewallPolicyEnforcementOrder']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkNetworkFirewallPolicyEnforcementOrderComputeV1.fromValue(guardedValue as String)); })(),
      project: (() { final guardedValue = map['project']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      requestId: (() { final guardedValue = map['requestId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      routingConfig: (() { final guardedValue = map['routingConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkRoutingConfigComputeV1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
