...
class RouterBgpComputeBeta {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'advertisedGroups': ?advertisedGroups == null ? null : pulumi.Input.encodeList<RouterBgpAdvertisedGroupsItemComputeBeta, String>(advertisedGroups!, (value) => value.value),
      'advertisedIpRanges': ?advertisedIpRanges == null ? null : pulumi.Input.encodeList<RouterAdvertisedIpRangeComputeBeta, Map<String, dynamic>>(advertisedIpRanges!, (value) => value.toMap()),
      'asn': ?asn,
  ...
  factory RouterBgpComputeBeta.fromMap(Map<String, dynamic> map) {
    return RouterBgpComputeBeta(
      advertiseMode: map['advertiseMode'] == null ? null : RouterBgpAdvertiseModeComputeBeta.fromValue(map['advertiseMode'] as String),
      advertisedGroups: map['advertisedGroups'] == null ? null : pulumi.Input.decodeList<RouterBgpAdvertisedGroupsItemComputeBeta>(map['advertisedGroups'], (value) => RouterBgpAdvertisedGroupsItemComputeBeta.fromValue(value as String)),
      advertisedIpRanges: map['advertisedIpRanges'] == null ? null : pulumi.Input.decodeList<RouterAdvertisedIpRangeComputeBeta>(map['advertisedIpRanges'], (value) => RouterAdvertisedIpRangeComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
