...
class RouterBgpComputeBeta {
  ...
  final pulumi.Input<List<RouterBgpAdvertisedGroupsItemComputeBeta>>?
  advertisedGroups;

  /// User-specified list of individual IP ranges to advertise in custom mode. This field can only be populated if advertise_mode is CUSTOM and is advertised to all peers of the router. These IP ranges will be advertised in addition to any specified groups. Leave this field blank to advertise no custom IP ranges.
  final pulumi.Input<List<RouterAdvertisedIpRangeComputeBeta>>?
  advertisedIpRanges;
    ...
    return <String, dynamic>{
      'advertiseMode':
          ?pulumi.Input.mapOptionalInputValue<
            RouterBgpAdvertiseModeComputeBeta,
            String
          >(advertiseMode, (value) => value.wireValue),
      'advertisedGroups':
          ?pulumi.Input.mapOptionalInputValue<
            List<RouterBgpAdvertisedGroupsItemComputeBeta>,
            List<String>
          >(
            advertisedGroups,
            (value) =>
      ...
      'advertisedIpRanges':
          ?pulumi.Input.mapOptionalInputValue<
            List<RouterAdvertisedIpRangeComputeBeta>,
    ...
    return RouterBgpComputeBeta(
      advertiseMode: (() {
        ...
        return pulumi.Input.fromValue(
          RouterBgpAdvertiseModeComputeBeta.fromValue(guardedValue as String),
        );
      })(),
      advertisedGroups: (() {
      ...
      identifierRange: (() {
        final guardedValue = map['identifierRange'];
        if (guardedValue == null) return null;
