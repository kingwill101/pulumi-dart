...
class RouterBgpComputeBeta {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'advertiseMode': ?pulumi.Input.mapOptionalInputValue<RouterBgpAdvertiseModeComputeBeta, String>(advertiseMode, (value) => value.wireValue),
      'advertisedGroups': ?pulumi.Input.mapOptionalInputValue<List<RouterBgpAdvertisedGroupsItemComputeBeta>, List<String>>(advertisedGroups, (value) => pulumi.Input.encodeList<RouterBgpAdvertisedGroupsItemComputeBeta, String>(value, (value) => value.wireValue)),
  ...
  factory RouterBgpComputeBeta.fromMap(Map<String, dynamic> map) {
    return RouterBgpComputeBeta(
      advertiseMode: (() { final guardedValue = map['advertiseMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RouterBgpAdvertiseModeComputeBeta.fromValue(guardedValue as String)); })(),
      advertisedGroups: (() { final guardedValue = map['advertisedGroups']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RouterBgpAdvertisedGroupsItemComputeBeta>(guardedValue, (value) => RouterBgpAdvertisedGroupsItemComputeBeta.fromValue(value as String))); })(),
