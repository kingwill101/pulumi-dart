...
class InstanceGroupManagerArgs {
  ...
  InstanceGroupManagerArgs({
    ...
    pulumi.Output<List<InstanceGroupManagerAutoHealingPolicy>>? autoHealingPolicies,
    pulumi.Output<String>? baseInstanceName,
    pulumi.Output<String>? description,
    pulumi.Output<DistributionPolicy>? distributionPolicy,
    pulumi.Output<InstanceGroupManagerFailoverAction>? failoverAction,
    pulumi.Output<InstanceGroupManagerInstanceFlexibilityPolicy>? instanceFlexibilityPolicy,
    pulumi.Output<InstanceGroupManagerInstanceLifecyclePolicy>? instanceLifecyclePolicy,
    pulumi.Output<String>? instanceTemplate,
    pulumi.Output<InstanceGroupManagerListManagedInstancesResults>? listManagedInstancesResults,
    ...
    pulumi.Output<StatefulPolicy>? statefulPolicy,
    pulumi.Output<List<String>>? targetPools,
    pulumi.Output<int>? targetSize,
    pulumi.Output<InstanceGroupManagerTargetSizeUnit>? targetSizeUnit,
    ...
    pulumi.Output<List<InstanceGroupManagerVersion>>? versions,
    pulumi.Output<String>? zone,
  }) :
      allInstancesConfig = pulumi.Input.asOptionalInput<InstanceGroupManagerAllInstancesConfig>(allInstancesConfig),
      autoHealingPolicies = pulumi.Input.asOptionalInput<List<InstanceGroupManagerAutoHealingPolicy>>(autoHealingPolicies),
      baseInstanceName = pulumi.Input.asOptionalInput<String>(baseInstanceName),
      description = pulumi.Input.asOptionalInput<String>(description),
      distributionPolicy = pulumi.Input.asOptionalInput<DistributionPolicy>(distributionPolicy),
      failoverAction = pulumi.Input.asOptionalInput<InstanceGroupManagerFailoverAction>(failoverAction),
      instanceFlexibilityPolicy = pulumi.Input.asOptionalInput<InstanceGroupManagerInstanceFlexibilityPolicy>(instanceFlexibilityPolicy),
      ...
      listManagedInstancesResults = pulumi.Input.asOptionalInput<InstanceGroupManagerListManagedInstancesResults>(listManagedInstancesResults),
      ...
      statefulPolicy = pulumi.Input.asOptionalInput<StatefulPolicy>(statefulPolicy),
      targetPools = pulumi.Input.asOptionalInput<List<String>>(targetPools),
      targetSize = pulumi.Input.asOptionalInput<int>(targetSize),
      targetSizeUnit = pulumi.Input.asOptionalInput<InstanceGroupManagerTargetSizeUnit>(targetSizeUnit),
      ...
      versions = pulumi.Input.asOptionalInput<List<InstanceGroupManagerVersion>>(versions),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'failoverAction': ?pulumi.Input.mapOptionalInputValue<InstanceGroupManagerFailoverAction, String>(failoverAction, (value) => value.value),
      ...
      'listManagedInstancesResults': ?pulumi.Input.mapOptionalInputValue<InstanceGroupManagerListManagedInstancesResults, String>(listManagedInstancesResults, (value) => value.value),
      'name': ?name,
      ...
      'targetSizeUnit': ?pulumi.Input.mapOptionalInputValue<InstanceGroupManagerTargetSizeUnit, String>(targetSizeUnit, (value) => value.value),
  ...
  factory InstanceGroupManagerArgs.fromMap(Map<String, dynamic> map) {
    return InstanceGroupManagerArgs(
      ...
      autoHealingPolicies: map['autoHealingPolicies'] == null ? null : pulumi.Output.create<List<InstanceGroupManagerAutoHealingPolicy>>(pulumi.Input.decodeList<InstanceGroupManagerAutoHealingPolicy>(map['autoHealingPolicies'], (value) => InstanceGroupManagerAutoHealingPolicy.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      distributionPolicy: map['distributionPolicy'] == null ? null : pulumi.Output.create<DistributionPolicy>(DistributionPolicy.fromMap((map['distributionPolicy'] as Map).cast<String, dynamic>())),
      failoverAction: map['failoverAction'] == null ? null : pulumi.Output.create<InstanceGroupManagerFailoverAction>(InstanceGroupManagerFailoverAction.fromValue(map['failoverAction'] as String)),
      instanceFlexibilityPolicy: map['instanceFlexibilityPolicy'] == null ? null : pulumi.Output.create<InstanceGroupManagerInstanceFlexibilityPolicy>(InstanceGroupManagerInstanceFlexibilityPolicy.fromMap((map['instanceFlexibilityPolicy'] as Map).cast<String, dynamic>())),
      ...
      instanceTemplate: map['instanceTemplate'] == null ? null : pulumi.Output.create<String>(map['instanceTemplate'] as String),
      listManagedInstancesResults: map['listManagedInstancesResults'] == null ? null : pulumi.Output.create<InstanceGroupManagerListManagedInstancesResults>(InstanceGroupManagerListManagedInstancesResults.fromValue(map['listManagedInstancesResults'] as String)),
      ...
      statefulPolicy: map['statefulPolicy'] == null ? null : pulumi.Output.create<StatefulPolicy>(StatefulPolicy.fromMap((map['statefulPolicy'] as Map).cast<String, dynamic>())),
      ...
      targetSizeUnit: map['targetSizeUnit'] == null ? null : pulumi.Output.create<InstanceGroupManagerTargetSizeUnit>(InstanceGroupManagerTargetSizeUnit.fromValue(map['targetSizeUnit'] as String)),
      ...
      versions: map['versions'] == null ? null : pulumi.Output.create<List<InstanceGroupManagerVersion>>(pulumi.Input.decodeList<InstanceGroupManagerVersion>(map['versions'], (value) => InstanceGroupManagerVersion.fromMap((value as Map).cast<String, dynamic>()))),
