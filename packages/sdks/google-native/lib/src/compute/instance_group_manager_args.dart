...
class InstanceGroupManagerArgs {
  ...
  factory InstanceGroupManagerArgs.fromMap(Map<String, dynamic> map) {
    return InstanceGroupManagerArgs(
      ...
      failoverAction: map['failoverAction'] == null ? null : (InstanceGroupManagerFailoverAction.fromValue(map['failoverAction']! as String)).input(),
      ...
      listManagedInstancesResults: map['listManagedInstancesResults'] == null ? null : (InstanceGroupManagerListManagedInstancesResults.fromValue(map['listManagedInstancesResults']! as String)).input(),
      ...
      targetSizeUnit: map['targetSizeUnit'] == null ? null : (InstanceGroupManagerTargetSizeUnit.fromValue(map['targetSizeUnit']! as String)).input(),
