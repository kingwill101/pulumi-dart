  ...
  factory InstanceGroupManagerArgs.fromMap(Map<String, dynamic> map) {
    return InstanceGroupManagerArgs(
      ...
      failoverAction: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          InstanceGroupManagerFailoverAction.fromValue(guardedValue as String),
        );
      })(),
      instanceFlexibilityPolicy: (() {
      ...
      listManagedInstancesResults: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          InstanceGroupManagerListManagedInstancesResults.fromValue(
      ...
      targetSizeUnit: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          InstanceGroupManagerTargetSizeUnit.fromValue(guardedValue as String),
        );
      })(),
      targetStoppedSize: (() {
