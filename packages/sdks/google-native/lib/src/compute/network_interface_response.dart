...
class NetworkInterfaceResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'accessConfigs': pulumi.Input.encodeList<AccessConfigResponse, Map<String, dynamic>>(accessConfigs, (value) => value.toMap()),
      'aliasIpRanges': pulumi.Input.encodeList<AliasIpRangeResponse, Map<String, dynamic>>(aliasIpRanges, (value) => value.toMap()),
      'fingerprint': fingerprint,
      'internalIpv6PrefixLength': internalIpv6PrefixLength,
      'ipv6AccessConfigs': pulumi.Input.encodeList<AccessConfigResponse, Map<String, dynamic>>(ipv6AccessConfigs, (value) => value.toMap()),
      ...
      'stackType': stackType,
      'subinterfaces': pulumi.Input.encodeList<NetworkInterfaceSubInterfaceResponse, Map<String, dynamic>>(subinterfaces, (value) => value.toMap()),
  ...
  factory NetworkInterfaceResponse.fromMap(Map<String, dynamic> map) {
    return NetworkInterfaceResponse(
      accessConfigs: pulumi.Input.decodeList<AccessConfigResponse>(map['accessConfigs'], (value) => AccessConfigResponse.fromMap((value as Map).cast<String, dynamic>())),
      aliasIpRanges: pulumi.Input.decodeList<AliasIpRangeResponse>(map['aliasIpRanges'], (value) => AliasIpRangeResponse.fromMap((value as Map).cast<String, dynamic>())),
      fingerprint: map['fingerprint'] as String,
      internalIpv6PrefixLength: map['internalIpv6PrefixLength'] as int,
      ipv6AccessConfigs: pulumi.Input.decodeList<AccessConfigResponse>(map['ipv6AccessConfigs'], (value) => AccessConfigResponse.fromMap((value as Map).cast<String, dynamic>())),
      ...
      subinterfaces: pulumi.Input.decodeList<NetworkInterfaceSubInterfaceResponse>(map['subinterfaces'], (value) => NetworkInterfaceSubInterfaceResponse.fromMap((value as Map).cast<String, dynamic>())),
