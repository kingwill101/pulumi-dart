...
class NetworkInterfaceResponse {
  ...
  final pulumi.Input<List<AccessConfigResponse>> accessConfigs;
  /// An array of alias IP ranges for this network interface. You can only specify this field for network interfaces in VPC networks.
  final pulumi.Input<List<AliasIpRangeResponse>> aliasIpRanges;
  ...
  final pulumi.Input<List<AccessConfigResponse>> ipv6AccessConfigs;
  ...
  final pulumi.Input<List<NetworkInterfaceSubInterfaceResponse>> subinterfaces;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'accessConfigs': pulumi.Input.mapInputValue<List<AccessConfigResponse>, List<Map<String, dynamic>>>(accessConfigs, (value) => pulumi.Input.encodeList<AccessConfigResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'aliasIpRanges': pulumi.Input.mapInputValue<List<AliasIpRangeResponse>, List<Map<String, dynamic>>>(aliasIpRanges, (value) => pulumi.Input.encodeList<AliasIpRangeResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'fingerprint': fingerprint,
      'internalIpv6PrefixLength': internalIpv6PrefixLength,
      'ipv6AccessConfigs': pulumi.Input.mapInputValue<List<AccessConfigResponse>, List<Map<String, dynamic>>>(ipv6AccessConfigs, (value) => pulumi.Input.encodeList<AccessConfigResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      ...
      'stackType': stackType,
      'subinterfaces': pulumi.Input.mapInputValue<List<NetworkInterfaceSubInterfaceResponse>, List<Map<String, dynamic>>>(subinterfaces, (value) => pulumi.Input.encodeList<NetworkInterfaceSubInterfaceResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory NetworkInterfaceResponse.fromMap(Map<String, dynamic> map) {
    return NetworkInterfaceResponse(
      accessConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<AccessConfigResponse>(map['accessConfigs']!, (value) => AccessConfigResponse.fromMap((value as Map).cast<String, dynamic>()))),
      aliasIpRanges: pulumi.Input.fromValue(pulumi.Input.decodeList<AliasIpRangeResponse>(map['aliasIpRanges']!, (value) => AliasIpRangeResponse.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      ipv6AccessConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<AccessConfigResponse>(map['ipv6AccessConfigs']!, (value) => AccessConfigResponse.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      subinterfaces: pulumi.Input.fromValue(pulumi.Input.decodeList<NetworkInterfaceSubInterfaceResponse>(map['subinterfaces']!, (value) => NetworkInterfaceSubInterfaceResponse.fromMap((value as Map).cast<String, dynamic>()))),
