...
class NetworkInterfaceResponse {
  ...
  factory NetworkInterfaceResponse.fromMap(Map<String, dynamic> map) {
    return NetworkInterfaceResponse(
      accessConfigs: (pulumi.Input.decodeList<AccessConfigResponse>(map['accessConfigs'], (value) => AccessConfigResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      aliasIpRanges: (pulumi.Input.decodeList<AliasIpRangeResponse>(map['aliasIpRanges'], (value) => AliasIpRangeResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      fingerprint: (map['fingerprint'] as String).input(),
      internalIpv6PrefixLength: (map['internalIpv6PrefixLength'] as int).input(),
      ipv6AccessConfigs: (pulumi.Input.decodeList<AccessConfigResponse>(map['ipv6AccessConfigs'], (value) => AccessConfigResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      parentNicName: (map['parentNicName'] as String).input(),
      queueCount: (map['queueCount'] as int).input(),
      stackType: (map['stackType'] as String).input(),
      subinterfaces: (pulumi.Input.decodeList<NetworkInterfaceSubInterfaceResponse>(map['subinterfaces'], (value) => NetworkInterfaceSubInterfaceResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
