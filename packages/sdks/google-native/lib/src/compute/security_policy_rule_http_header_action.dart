...
class SecurityPolicyRuleHttpHeaderAction {
  ...
  const SecurityPolicyRuleHttpHeaderAction({
  ...
  factory SecurityPolicyRuleHttpHeaderAction.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRuleHttpHeaderAction(
      requestHeadersToAdds: (() { final guardedValue = map['requestHeadersToAdds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SecurityPolicyRuleHttpHeaderActionHttpHeaderOption>(guardedValue, (value) => SecurityPolicyRuleHttpHeaderActionHttpHeaderOption.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
