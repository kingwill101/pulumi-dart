...
/// {@template pulumi_compute_beta_image_iam_policy_compute_beta_args_doc}
/// The set of arguments for ImageIamPolicy.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_image_iam_policy_compute_beta_args_doc}
class ImageIamPolicyComputeBetaArgs {
  ...
  /// Creates a new [ImageIamPolicyComputeBetaArgs].
  ...
  factory ImageIamPolicyComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return ImageIamPolicyComputeBetaArgs(
