...
class GetRegionDiskComputeBetaResult {
  ...
  /// Creates a new [GetRegionDiskComputeBetaResult].
  ...
  const GetRegionDiskComputeBetaResult({
  ...
  factory GetRegionDiskComputeBetaResult.fromMap(Map<String, dynamic> map) {
    return GetRegionDiskComputeBetaResult(
