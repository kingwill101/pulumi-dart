...
class ResourceCommitmentComputeV1 {
  ...
  const ResourceCommitmentComputeV1({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'amount': ?amount,
      'type': ?pulumi.Input.mapOptionalInputValue<ResourceCommitmentTypeComputeV1, String>(type, (value) => value.wireValue),
    };
  }
  ...
  factory ResourceCommitmentComputeV1.fromMap(Map<String, dynamic> map) {
    return ResourceCommitmentComputeV1(
      ...
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResourceCommitmentTypeComputeV1.fromValue(guardedValue as String)); })(),
    );
  }
}
