...
class GetServiceAttachmentComputeV1Result {
  ...
  final List<ServiceAttachmentConnectedEndpointResponseComputeV1> connectedEndpoints;
  /// The connection preference of service attachment. The value can be set to ACCEPT_AUTOMATIC. An ACCEPT_AUTOMATIC service attachment is one that always accepts the connection from consumer forwarding rules.
  final String connectionPreference;
  /// Projects that are allowed to connect to this service attachment.
  final List<ServiceAttachmentConsumerProjectLimitResponseComputeV1> consumerAcceptLists;
  ...
  /// Creates a new [GetServiceAttachmentComputeV1Result].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'connectedEndpoints': pulumi.Input.encodeList<ServiceAttachmentConnectedEndpointResponseComputeV1, Map<String, dynamic>>(connectedEndpoints, (value) => value.toMap()),
      'connectionPreference': connectionPreference,
      'consumerAcceptLists': pulumi.Input.encodeList<ServiceAttachmentConsumerProjectLimitResponseComputeV1, Map<String, dynamic>>(consumerAcceptLists, (value) => value.toMap()),
  ...
  factory GetServiceAttachmentComputeV1Result.fromMap(Map<String, dynamic> map) {
    return GetServiceAttachmentComputeV1Result(
      connectedEndpoints: pulumi.Input.decodeList<ServiceAttachmentConnectedEndpointResponseComputeV1>(map['connectedEndpoints']!, (value) => ServiceAttachmentConnectedEndpointResponseComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      connectionPreference: map['connectionPreference'] as String,
      consumerAcceptLists: pulumi.Input.decodeList<ServiceAttachmentConsumerProjectLimitResponseComputeV1>(map['consumerAcceptLists']!, (value) => ServiceAttachmentConsumerProjectLimitResponseComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      ...
      pscServiceAttachmentId: Uint128ResponseComputeV1.fromMap((map['pscServiceAttachmentId']! as Map).cast<String, dynamic>()),
