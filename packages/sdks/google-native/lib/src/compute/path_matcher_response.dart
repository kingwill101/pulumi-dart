...
class PathMatcherResponse {
  ...
  final pulumi.Input<CustomErrorResponsePolicyResponse> defaultCustomErrorResponsePolicy;
  ...
  final pulumi.Input<HttpRouteActionResponse> defaultRouteAction;
  ...
  final pulumi.Input<HttpRedirectActionResponse> defaultUrlRedirect;
  ...
  final pulumi.Input<List<PathRuleResponse>> pathRules;
  /// The list of HTTP route rules. Use this list instead of pathRules when advanced route matching and routing actions are desired. routeRules are evaluated in order of priority, from the lowest to highest number. Within a given pathMatcher, you can set only one of pathRules or routeRules.
  final pulumi.Input<List<HttpRouteRuleResponse>> routeRules;

  /// Creates a new [PathMatcherResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'defaultCustomErrorResponsePolicy': pulumi.Input.mapInputValue<CustomErrorResponsePolicyResponse, Map<String, dynamic>>(defaultCustomErrorResponsePolicy, (value) => value.toMap()),
      'defaultRouteAction': pulumi.Input.mapInputValue<HttpRouteActionResponse, Map<String, dynamic>>(defaultRouteAction, (value) => value.toMap()),
      'defaultService': defaultService,
      'defaultUrlRedirect': pulumi.Input.mapInputValue<HttpRedirectActionResponse, Map<String, dynamic>>(defaultUrlRedirect, (value) => value.toMap()),
      'description': description,
      'headerAction': pulumi.Input.mapInputValue<HttpHeaderActionResponse, Map<String, dynamic>>(headerAction, (value) => value.toMap()),
      'name': name,
      'pathRules': pulumi.Input.mapInputValue<List<PathRuleResponse>, List<Map<String, dynamic>>>(pathRules, (value) => pulumi.Input.encodeList<PathRuleResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'routeRules': pulumi.Input.mapInputValue<List<HttpRouteRuleResponse>, List<Map<String, dynamic>>>(routeRules, (value) => pulumi.Input.encodeList<HttpRouteRuleResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory PathMatcherResponse.fromMap(Map<String, dynamic> map) {
    return PathMatcherResponse(
      defaultCustomErrorResponsePolicy: pulumi.Input.fromValue(CustomErrorResponsePolicyResponse.fromMap((map['defaultCustomErrorResponsePolicy']! as Map).cast<String, dynamic>())),
      defaultRouteAction: pulumi.Input.fromValue(HttpRouteActionResponse.fromMap((map['defaultRouteAction']! as Map).cast<String, dynamic>())),
      defaultService: pulumi.Input.fromValue(map['defaultService'] as String),
      defaultUrlRedirect: pulumi.Input.fromValue(HttpRedirectActionResponse.fromMap((map['defaultUrlRedirect']! as Map).cast<String, dynamic>())),
      ...
      pathRules: pulumi.Input.fromValue(pulumi.Input.decodeList<PathRuleResponse>(map['pathRules']!, (value) => PathRuleResponse.fromMap((value as Map).cast<String, dynamic>()))),
      routeRules: pulumi.Input.fromValue(pulumi.Input.decodeList<HttpRouteRuleResponse>(map['routeRules']!, (value) => HttpRouteRuleResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
