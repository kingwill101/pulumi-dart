...
class PathMatcherResponse {
  ...
  factory PathMatcherResponse.fromMap(Map<String, dynamic> map) {
    return PathMatcherResponse(
      defaultCustomErrorResponsePolicy: (CustomErrorResponsePolicyResponse.fromMap((map['defaultCustomErrorResponsePolicy'] as Map).cast<String, dynamic>())).input(),
      defaultRouteAction: (HttpRouteActionResponse.fromMap((map['defaultRouteAction'] as Map).cast<String, dynamic>())).input(),
      defaultService: (map['defaultService'] as String).input(),
      defaultUrlRedirect: (HttpRedirectActionResponse.fromMap((map['defaultUrlRedirect'] as Map).cast<String, dynamic>())).input(),
      description: (map['description'] as String).input(),
      headerAction: (HttpHeaderActionResponse.fromMap((map['headerAction'] as Map).cast<String, dynamic>())).input(),
      name: (map['name'] as String).input(),
      pathRules: (pulumi.Input.decodeList<PathRuleResponse>(map['pathRules'], (value) => PathRuleResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      routeRules: (pulumi.Input.decodeList<HttpRouteRuleResponse>(map['routeRules'], (value) => HttpRouteRuleResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
