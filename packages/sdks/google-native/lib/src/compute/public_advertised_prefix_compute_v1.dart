...
class PublicAdvertisedPrefixComputeV1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<PublicAdvertisedPrefixPublicDelegatedPrefixResponseComputeV1>> publicDelegatedPrefixs;
  ...
  PublicAdvertisedPrefixComputeV1(
    ...
    this.publicDelegatedPrefixs = registerOutput<List<PublicAdvertisedPrefixPublicDelegatedPrefixResponseComputeV1>>('publicDelegatedPrefixs');
