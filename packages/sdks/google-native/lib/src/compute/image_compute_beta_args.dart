...
class ImageComputeBetaArgs {
  ...
  ImageComputeBetaArgs({
    pulumi.Output<ImageArchitectureComputeBeta>? architecture,
    pulumi.Output<String>? archiveSizeBytes,
    pulumi.Output<DeprecationStatusComputeBeta>? deprecated,
    ...
    pulumi.Output<CustomerEncryptionKeyComputeBeta>? imageEncryptionKey,
    ...
    pulumi.Output<ImageRawDiskComputeBeta>? rawDisk,
    pulumi.Output<String>? requestId,
    pulumi.Output<RolloutPolicyComputeBeta>? rolloutOverride,
    pulumi.Output<InitialStateConfigComputeBeta>? shieldedInstanceInitialState,
    pulumi.Output<String>? sourceDisk,
    pulumi.Output<CustomerEncryptionKeyComputeBeta>? sourceDiskEncryptionKey,
    ...
    pulumi.Output<ImageSourceTypeComputeBeta>? sourceType,
  ...
  factory ImageComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return ImageComputeBetaArgs(
      architecture: map['architecture'] == null ? null : pulumi.Output.create<ImageArchitectureComputeBeta>(ImageArchitectureComputeBeta.fromValue(map['architecture'] as String)),
      archiveSizeBytes: map['archiveSizeBytes'] == null ? null : pulumi.Output.create<String>(map['archiveSizeBytes'] as String),
      deprecated: map['deprecated'] == null ? null : pulumi.Output.create<DeprecationStatusComputeBeta>(DeprecationStatusComputeBeta.fromMap((map['deprecated'] as Map).cast<String, dynamic>())),
      ...
      imageEncryptionKey: map['imageEncryptionKey'] == null ? null : pulumi.Output.create<CustomerEncryptionKeyComputeBeta>(CustomerEncryptionKeyComputeBeta.fromMap((map['imageEncryptionKey'] as Map).cast<String, dynamic>())),
      ...
      rawDisk: map['rawDisk'] == null ? null : pulumi.Output.create<ImageRawDiskComputeBeta>(ImageRawDiskComputeBeta.fromMap((map['rawDisk'] as Map).cast<String, dynamic>())),
      requestId: map['requestId'] == null ? null : pulumi.Output.create<String>(map['requestId'] as String),
      rolloutOverride: map['rolloutOverride'] == null ? null : pulumi.Output.create<RolloutPolicyComputeBeta>(RolloutPolicyComputeBeta.fromMap((map['rolloutOverride'] as Map).cast<String, dynamic>())),
      shieldedInstanceInitialState: map['shieldedInstanceInitialState'] == null ? null : pulumi.Output.create<InitialStateConfigComputeBeta>(InitialStateConfigComputeBeta.fromMap((map['shieldedInstanceInitialState'] as Map).cast<String, dynamic>())),
      sourceDisk: map['sourceDisk'] == null ? null : pulumi.Output.create<String>(map['sourceDisk'] as String),
      sourceDiskEncryptionKey: map['sourceDiskEncryptionKey'] == null ? null : pulumi.Output.create<CustomerEncryptionKeyComputeBeta>(CustomerEncryptionKeyComputeBeta.fromMap((map['sourceDiskEncryptionKey'] as Map).cast<String, dynamic>())),
      ...
      sourceType: map['sourceType'] == null ? null : pulumi.Output.create<ImageSourceTypeComputeBeta>(ImageSourceTypeComputeBeta.fromValue(map['sourceType'] as String)),
