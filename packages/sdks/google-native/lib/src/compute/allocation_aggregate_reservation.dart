...
class AllocationAggregateReservation {
  ...
  final List<AllocationAggregateReservationReservedResourceInfo>? reservedResources;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'reservedResources': ?reservedResources == null ? null : pulumi.Input.encodeList<AllocationAggregateReservationReservedResourceInfo, Map<String, dynamic>>(reservedResources!, (value) => value.toMap()),
  ...
  factory AllocationAggregateReservation.fromMap(Map<String, dynamic> map) {
    return AllocationAggregateReservation(
      reservedResources: map['reservedResources'] == null ? null : pulumi.Input.decodeList<AllocationAggregateReservationReservedResourceInfo>(map['reservedResources'], (value) => AllocationAggregateReservationReservedResourceInfo.fromMap((value as Map).cast<String, dynamic>())),
      vmFamily: map['vmFamily'] == null ? null : AllocationAggregateReservationVmFamily.fromValue(map['vmFamily'] as String),
      workloadType: map['workloadType'] == null ? null : AllocationAggregateReservationWorkloadType.fromValue(map['workloadType'] as String),
    );
  }
}
