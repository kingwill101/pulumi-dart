...
class FirewallPolicyRuleMatcherLayer4Config {
  ...
  /// Creates a new [FirewallPolicyRuleMatcherLayer4Config].
  ...
  const FirewallPolicyRuleMatcherLayer4Config({
    this.ipProtocol,
    this.ports,
  });
  ...
  factory FirewallPolicyRuleMatcherLayer4Config.fromMap(Map<String, dynamic> map) {
