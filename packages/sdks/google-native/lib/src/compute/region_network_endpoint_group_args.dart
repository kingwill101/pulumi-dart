...
class RegionNetworkEndpointGroupArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'clientPortMappingMode': ?pulumi.Input.mapOptionalInputValue<RegionNetworkEndpointGroupClientPortMappingMode, String>(clientPortMappingMode, (value) => value.wireValue),
      ...
      'name': ?name,
      'network': ?network,
      'networkEndpointType': ?pulumi.Input.mapOptionalInputValue<RegionNetworkEndpointGroupNetworkEndpointType, String>(networkEndpointType, (value) => value.wireValue),
      'project': ?project,
      'pscData': ?pscData,
      ...
      'type': ?pulumi.Input.mapOptionalInputValue<RegionNetworkEndpointGroupType, String>(type, (value) => value.wireValue),
    };
  }
  ...
  factory RegionNetworkEndpointGroupArgs.fromMap(Map<String, dynamic> map) {
    return RegionNetworkEndpointGroupArgs(
      ...
      clientPortMappingMode: (() { final guardedValue = map['clientPortMappingMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionNetworkEndpointGroupClientPortMappingMode.fromValue(guardedValue as String)); })(),
      ...
      networkEndpointType: (() { final guardedValue = map['networkEndpointType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionNetworkEndpointGroupNetworkEndpointType.fromValue(guardedValue as String)); })(),
      ...
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionNetworkEndpointGroupType.fromValue(guardedValue as String)); })(),
    );
  }
}
