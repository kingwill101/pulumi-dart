...
class RegionNetworkEndpointGroupArgs {
  ...
  factory RegionNetworkEndpointGroupArgs.fromMap(Map<String, dynamic> map) {
    return RegionNetworkEndpointGroupArgs(
      ...
      clientPortMappingMode: map['clientPortMappingMode'] == null ? null : (RegionNetworkEndpointGroupClientPortMappingMode.fromValue(map['clientPortMappingMode']! as String)).input(),
      ...
      networkEndpointType: map['networkEndpointType'] == null ? null : (RegionNetworkEndpointGroupNetworkEndpointType.fromValue(map['networkEndpointType']! as String)).input(),
      ...
      type: map['type'] == null ? null : (RegionNetworkEndpointGroupType.fromValue(map['type']! as String)).input(),
    );
  }
}
