...
class ReservationResponseComputeV1 {
  ...
  final pulumi.Input<AllocationSpecificSKUReservationResponseComputeV1>
  specificReservation;
  ...
  factory ReservationResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return ReservationResponseComputeV1(
      ...
      resourceStatus: pulumi.Input.fromValue(
        AllocationResourceStatusResponseComputeV1.fromMap(
      ...
      shareSettings: pulumi.Input.fromValue(
        ShareSettingsResponseComputeV1.fromMap(
