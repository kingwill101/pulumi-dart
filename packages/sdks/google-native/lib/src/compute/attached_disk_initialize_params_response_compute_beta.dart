...
class AttachedDiskInitializeParamsResponseComputeBeta {
  ...
  const AttachedDiskInitializeParamsResponseComputeBeta({
  ...
  factory AttachedDiskInitializeParamsResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return AttachedDiskInitializeParamsResponseComputeBeta(
      ...
      multiWriter: pulumi.Input.fromValue(map['multiWriter'] as bool),
      ...
      sourceImageEncryptionKey: pulumi.Input.fromValue(CustomerEncryptionKeyResponseComputeBeta.fromMap((map['sourceImageEncryptionKey']! as Map).cast<String, dynamic>())),
      sourceInstantSnapshot: pulumi.Input.fromValue(map['sourceInstantSnapshot'] as String),
      sourceSnapshot: pulumi.Input.fromValue(map['sourceSnapshot'] as String),
      sourceSnapshotEncryptionKey: pulumi.Input.fromValue(CustomerEncryptionKeyResponseComputeBeta.fromMap((map['sourceSnapshotEncryptionKey']! as Map).cast<String, dynamic>())),
    );
  }
}
