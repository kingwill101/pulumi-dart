...
class AttachedDiskInitializeParamsResponseComputeBeta {
  ...
  final pulumi.Input<CustomerEncryptionKeyResponseComputeBeta> sourceImageEncryptionKey;
  ...
  final pulumi.Input<CustomerEncryptionKeyResponseComputeBeta> sourceSnapshotEncryptionKey;

  /// Creates a new [AttachedDiskInitializeParamsResponseComputeBeta].
  ...
  AttachedDiskInitializeParamsResponseComputeBeta({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'sourceImageEncryptionKey': pulumi.Input.mapInputValue<CustomerEncryptionKeyResponseComputeBeta, Map<String, dynamic>>(sourceImageEncryptionKey, (value) => value.toMap()),
      'sourceInstantSnapshot': sourceInstantSnapshot,
      'sourceSnapshot': sourceSnapshot,
      'sourceSnapshotEncryptionKey': pulumi.Input.mapInputValue<CustomerEncryptionKeyResponseComputeBeta, Map<String, dynamic>>(sourceSnapshotEncryptionKey, (value) => value.toMap()),
    };
  }

  factory AttachedDiskInitializeParamsResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return AttachedDiskInitializeParamsResponseComputeBeta(
      ...
      multiWriter: (map['multiWriter'] as bool).input(),
      onUpdateAction: (map['onUpdateAction'] as String).input(),
      provisionedIops: (map['provisionedIops'] as String).input(),
      provisionedThroughput: (map['provisionedThroughput'] as String).input(),
      ...
      sourceImageEncryptionKey: (CustomerEncryptionKeyResponseComputeBeta.fromMap((map['sourceImageEncryptionKey'] as Map).cast<String, dynamic>())).input(),
      sourceInstantSnapshot: (map['sourceInstantSnapshot'] as String).input(),
      sourceSnapshot: (map['sourceSnapshot'] as String).input(),
      sourceSnapshotEncryptionKey: (CustomerEncryptionKeyResponseComputeBeta.fromMap((map['sourceSnapshotEncryptionKey'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
