...
class CustomErrorResponsePolicyResponse {
  ...
  factory CustomErrorResponsePolicyResponse.fromMap(Map<String, dynamic> map) {
    return CustomErrorResponsePolicyResponse(
      errorResponseRules: (pulumi.Input.decodeList<CustomErrorResponsePolicyCustomErrorResponseRuleResponse>(map['errorResponseRules'], (value) => CustomErrorResponsePolicyCustomErrorResponseRuleResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
