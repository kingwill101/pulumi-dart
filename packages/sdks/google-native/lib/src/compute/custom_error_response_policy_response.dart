...
class CustomErrorResponsePolicyResponse {
  ...
  final pulumi.Input<List<CustomErrorResponsePolicyCustomErrorResponseRuleResponse>> errorResponseRules;
  ...
  /// Creates a new [CustomErrorResponsePolicyResponse].
  ...
  const CustomErrorResponsePolicyResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'errorResponseRules': pulumi.Input.mapInputValue<List<CustomErrorResponsePolicyCustomErrorResponseRuleResponse>, List<Map<String, dynamic>>>(errorResponseRules, (value) => pulumi.Input.encodeList<CustomErrorResponsePolicyCustomErrorResponseRuleResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory CustomErrorResponsePolicyResponse.fromMap(Map<String, dynamic> map) {
    return CustomErrorResponsePolicyResponse(
      errorResponseRules: pulumi.Input.fromValue(pulumi.Input.decodeList<CustomErrorResponsePolicyCustomErrorResponseRuleResponse>(map['errorResponseRules']!, (value) => CustomErrorResponsePolicyCustomErrorResponseRuleResponse.fromMap((value as Map).cast<String, dynamic>()))),
