...
class NetworkEndpointGroupCloudFunctionResponse {
  ...
  /// Creates a new [NetworkEndpointGroupCloudFunctionResponse].
  ...
  const NetworkEndpointGroupCloudFunctionResponse({
  ...
  factory NetworkEndpointGroupCloudFunctionResponse.fromMap(Map<String, dynamic> map) {
    return NetworkEndpointGroupCloudFunctionResponse(
