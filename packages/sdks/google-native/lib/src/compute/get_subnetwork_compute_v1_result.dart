...
class GetSubnetworkComputeV1Result {
  ...
  factory GetSubnetworkComputeV1Result.fromMap(Map<String, dynamic> map) {
    return GetSubnetworkComputeV1Result(
      ...
      logConfig: SubnetworkLogConfigResponseComputeV1.fromMap(
      ...
      secondaryIpRanges:
          pulumi.Input.decodeList<SubnetworkSecondaryRangeResponseComputeV1>(
            map['secondaryIpRanges']!,
            (value) => SubnetworkSecondaryRangeResponseComputeV1.fromMap(
