...
class InstanceGroupManagerInstanceLifecyclePolicyComputeV1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'forceUpdateOnRepair': ?pulumi.Input.mapOptionalInputValue<InstanceGroupManagerInstanceLifecyclePolicyForceUpdateOnRepairComputeV1, String>(forceUpdateOnRepair, (value) => value.value),
    };
  }
