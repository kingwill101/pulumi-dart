...
class HTTPHealthCheck {
  ...
  factory HTTPHealthCheck.fromMap(Map<String, dynamic> map) {
    return HTTPHealthCheck(
      ...
      portSpecification: map['portSpecification'] == null ? null : HTTPHealthCheckPortSpecification.fromValue(map['portSpecification'] as String),
      proxyHeader: map['proxyHeader'] == null ? null : HTTPHealthCheckProxyHeader.fromValue(map['proxyHeader'] as String),
      requestPath: map['requestPath'] == null ? null : map['requestPath'] as String,
      response: map['response'] == null ? null : map['response'] as String,
      weightReportMode: map['weightReportMode'] == null ? null : HTTPHealthCheckWeightReportMode.fromValue(map['weightReportMode'] as String),
    );
  }
}
