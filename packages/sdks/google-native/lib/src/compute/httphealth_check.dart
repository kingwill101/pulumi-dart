...
class HTTPHealthCheck {
  ...
  final pulumi.Input<HTTPHealthCheckPortSpecification>? portSpecification;
  /// Specifies the type of proxy header to append before sending data to the backend, either NONE or PROXY_V1. The default is NONE.
  final pulumi.Input<HTTPHealthCheckProxyHeader>? proxyHeader;
  ...
  final pulumi.Input<HTTPHealthCheckWeightReportMode>? weightReportMode;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'port': ?port,
      'portName': ?portName,
      'portSpecification': ?pulumi.Input.mapOptionalInputValue<HTTPHealthCheckPortSpecification, String>(portSpecification, (value) => value.wireValue),
      'proxyHeader': ?pulumi.Input.mapOptionalInputValue<HTTPHealthCheckProxyHeader, String>(proxyHeader, (value) => value.wireValue),
      'requestPath': ?requestPath,
      'response': ?response,
      'weightReportMode': ?pulumi.Input.mapOptionalInputValue<HTTPHealthCheckWeightReportMode, String>(weightReportMode, (value) => value.wireValue),
    };
  }
  ...
  factory HTTPHealthCheck.fromMap(Map<String, dynamic> map) {
    return HTTPHealthCheck(
      ...
      portSpecification: (() { final guardedValue = map['portSpecification']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HTTPHealthCheckPortSpecification.fromValue(guardedValue as String)); })(),
      proxyHeader: (() { final guardedValue = map['proxyHeader']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HTTPHealthCheckProxyHeader.fromValue(guardedValue as String)); })(),
      ...
      weightReportMode: (() { final guardedValue = map['weightReportMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HTTPHealthCheckWeightReportMode.fromValue(guardedValue as String)); })(),
    );
  }
}
