...
class RegionBackendServiceArgs {
  ...
  const RegionBackendServiceArgs({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'compressionMode': ?pulumi.Input.mapOptionalInputValue<RegionBackendServiceCompressionMode, String>(compressionMode, (value) => value.wireValue),
      ...
      'ipAddressSelectionPolicy': ?pulumi.Input.mapOptionalInputValue<RegionBackendServiceIpAddressSelectionPolicy, String>(ipAddressSelectionPolicy, (value) => value.wireValue),
      'loadBalancingScheme': ?pulumi.Input.mapOptionalInputValue<RegionBackendServiceLoadBalancingScheme, String>(loadBalancingScheme, (value) => value.wireValue),
      ...
      'localityLbPolicy': ?pulumi.Input.mapOptionalInputValue<RegionBackendServiceLocalityLbPolicy, String>(localityLbPolicy, (value) => value.wireValue),
      ...
      'portName': ?portName,
      'project': ?project,
      'protocol': ?pulumi.Input.mapOptionalInputValue<RegionBackendServiceProtocol, String>(protocol, (value) => value.wireValue),
      'region': region,
      'requestId': ?requestId,
      ...
      'sessionAffinity': ?pulumi.Input.mapOptionalInputValue<RegionBackendServiceSessionAffinity, String>(sessionAffinity, (value) => value.wireValue),
      ...
      'vpcNetworkScope': ?pulumi.Input.mapOptionalInputValue<RegionBackendServiceVpcNetworkScope, String>(vpcNetworkScope, (value) => value.wireValue),
    };
  }
  ...
  factory RegionBackendServiceArgs.fromMap(Map<String, dynamic> map) {
    return RegionBackendServiceArgs(
      ...
      compressionMode: (() { final guardedValue = map['compressionMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionBackendServiceCompressionMode.fromValue(guardedValue as String)); })(),
      ...
      ipAddressSelectionPolicy: (() { final guardedValue = map['ipAddressSelectionPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionBackendServiceIpAddressSelectionPolicy.fromValue(guardedValue as String)); })(),
      loadBalancingScheme: (() { final guardedValue = map['loadBalancingScheme']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionBackendServiceLoadBalancingScheme.fromValue(guardedValue as String)); })(),
      ...
      localityLbPolicy: (() { final guardedValue = map['localityLbPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionBackendServiceLocalityLbPolicy.fromValue(guardedValue as String)); })(),
      ...
      protocol: (() { final guardedValue = map['protocol']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionBackendServiceProtocol.fromValue(guardedValue as String)); })(),
      ...
      sessionAffinity: (() { final guardedValue = map['sessionAffinity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionBackendServiceSessionAffinity.fromValue(guardedValue as String)); })(),
      ...
      vpcNetworkScope: (() { final guardedValue = map['vpcNetworkScope']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionBackendServiceVpcNetworkScope.fromValue(guardedValue as String)); })(),
    );
  }
}
