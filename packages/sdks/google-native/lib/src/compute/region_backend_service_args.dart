...
class RegionBackendServiceArgs {
  ...
  factory RegionBackendServiceArgs.fromMap(Map<String, dynamic> map) {
    return RegionBackendServiceArgs(
      ...
      compressionMode: map['compressionMode'] == null ? null : (RegionBackendServiceCompressionMode.fromValue(map['compressionMode'] as String)).input(),
      ...
      ipAddressSelectionPolicy: map['ipAddressSelectionPolicy'] == null ? null : (RegionBackendServiceIpAddressSelectionPolicy.fromValue(map['ipAddressSelectionPolicy'] as String)).input(),
      loadBalancingScheme: map['loadBalancingScheme'] == null ? null : (RegionBackendServiceLoadBalancingScheme.fromValue(map['loadBalancingScheme'] as String)).input(),
      ...
      localityLbPolicy: map['localityLbPolicy'] == null ? null : (RegionBackendServiceLocalityLbPolicy.fromValue(map['localityLbPolicy'] as String)).input(),
      ...
      protocol: map['protocol'] == null ? null : (RegionBackendServiceProtocol.fromValue(map['protocol'] as String)).input(),
      ...
      sessionAffinity: map['sessionAffinity'] == null ? null : (RegionBackendServiceSessionAffinity.fromValue(map['sessionAffinity'] as String)).input(),
      ...
      vpcNetworkScope: map['vpcNetworkScope'] == null ? null : (RegionBackendServiceVpcNetworkScope.fromValue(map['vpcNetworkScope'] as String)).input(),
    );
  }
}
