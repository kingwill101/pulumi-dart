...
class SubnetworkComputeBetaArgs {
  ...
  factory SubnetworkComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return SubnetworkComputeBetaArgs(
      ...
      ipv6AccessType: map['ipv6AccessType'] == null ? null : (SubnetworkIpv6AccessTypeComputeBeta.fromValue(map['ipv6AccessType']! as String)).input(),
      logConfig: map['logConfig'] == null ? null : (SubnetworkLogConfigComputeBeta.fromMap((map['logConfig']! as Map).cast<String, dynamic>())).input(),
      name: map['name'] == null ? null : (map['name']! as String).input(),
      network: map['network'] == null ? null : (map['network']! as String).input(),
      privateIpGoogleAccess: map['privateIpGoogleAccess'] == null ? null : (map['privateIpGoogleAccess']! as bool).input(),
      privateIpv6GoogleAccess: map['privateIpv6GoogleAccess'] == null ? null : (SubnetworkPrivateIpv6GoogleAccessComputeBeta.fromValue(map['privateIpv6GoogleAccess']! as String)).input(),
      project: map['project'] == null ? null : (map['project']! as String).input(),
      purpose: map['purpose'] == null ? null : (SubnetworkPurposeComputeBeta.fromValue(map['purpose']! as String)).input(),
      region: (map['region'] as String).input(),
      requestId: map['requestId'] == null ? null : (map['requestId']! as String).input(),
      reservedInternalRange: map['reservedInternalRange'] == null ? null : (map['reservedInternalRange']! as String).input(),
      role: map['role'] == null ? null : (SubnetworkRoleComputeBeta.fromValue(map['role']! as String)).input(),
      secondaryIpRanges: map['secondaryIpRanges'] == null ? null : (pulumi.Input.decodeList<SubnetworkSecondaryRangeComputeBeta>(map['secondaryIpRanges']!, (value) => SubnetworkSecondaryRangeComputeBeta.fromMap((value as Map).cast<String, dynamic>()))).input(),
      stackType: map['stackType'] == null ? null : (SubnetworkStackTypeComputeBeta.fromValue(map['stackType']! as String)).input(),
    );
  }
}
