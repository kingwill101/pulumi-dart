    ...
    return SubnetworkComputeBetaArgs(
      ...
      ipv6AccessType: (() {
        ...
        return pulumi.Input.fromValue(
          SubnetworkIpv6AccessTypeComputeBeta.fromValue(guardedValue as String),
        );
      })(),
      logConfig: (() {
      ...
      purpose: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SubnetworkPurposeComputeBeta.fromValue(guardedValue as String),
        );
      })(),
      ...
      role: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SubnetworkRoleComputeBeta.fromValue(guardedValue as String),
        );
      })(),
      secondaryIpRanges: (() {
      ...
      stackType: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SubnetworkStackTypeComputeBeta.fromValue(guardedValue as String),
        );
      })(),
    );
  }
