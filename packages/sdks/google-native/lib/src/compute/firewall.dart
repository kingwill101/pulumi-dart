...
class Firewall extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<FirewallAllowedItemResponse>> allowed;
  /// Creation timestamp in RFC3339 text format.
  late final pulumi.Output<String> creationTimestamp;
  /// The list of DENY rules specified by this firewall. Each rule specifies a protocol and port-range tuple that describes a denied connection.
  late final pulumi.Output<List<FirewallDeniedItemResponse>> denied;
  ...
  late final pulumi.Output<FirewallLogConfigResponse> logConfig;
  ...
  /// [args] Arguments used to configure this [Firewall]. {@macro pulumi_compute_alpha_firewall_args_doc}
  ...
  Firewall(
    ...
    this.allowed = registerOutput<List<FirewallAllowedItemResponse>>('allowed');
    this.creationTimestamp = registerOutput<String>('creationTimestamp');
    this.denied = registerOutput<List<FirewallDeniedItemResponse>>('denied');
    ...
    this.logConfig = registerOutput<FirewallLogConfigResponse>('logConfig');
