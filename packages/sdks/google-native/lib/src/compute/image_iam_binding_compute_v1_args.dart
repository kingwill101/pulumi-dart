...
/// {@template pulumi_compute_v1_image_iam_binding_compute_v1_args_doc}
/// The set of arguments for ImageIamBinding.
/// {@endtemplate}
/// {@macro pulumi_compute_v1_image_iam_binding_compute_v1_args_doc}
class ImageIamBindingComputeV1Args {
  ...
  /// Creates a new [ImageIamBindingComputeV1Args].
  ...
  const ImageIamBindingComputeV1Args({
    this.condition,
