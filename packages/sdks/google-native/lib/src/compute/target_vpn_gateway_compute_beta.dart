...
import 'target_vpn_gateway_compute_beta_args.dart';

/// Creates a target VPN gateway in the specified project and region using the data included in the request.
class TargetVpnGatewayComputeBeta extends pulumi.CustomResource {
  ...
  /// Creates a new [TargetVpnGatewayComputeBeta].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [TargetVpnGatewayComputeBeta]. {@macro pulumi_compute_beta_target_vpn_gateway_compute_beta_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  TargetVpnGatewayComputeBeta(
    String name, {
    TargetVpnGatewayComputeBetaArgs? args,
    ...
    tunnels = registerOutput<List<String>>('tunnels');
  }
}
