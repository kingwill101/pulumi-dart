...
import 'target_pool_compute_beta_args.dart';

/// Creates a target pool in the specified project and region using the data included in the request.
class TargetPoolComputeBeta extends pulumi.CustomResource {
  ...
  /// Creates a new [TargetPoolComputeBeta].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [TargetPoolComputeBeta]. {@macro pulumi_compute_beta_target_pool_compute_beta_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  TargetPoolComputeBeta(
    String name, {
    TargetPoolComputeBetaArgs? args,
