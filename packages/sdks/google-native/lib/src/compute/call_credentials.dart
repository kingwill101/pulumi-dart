...
class CallCredentials {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'callCredentialType': ?pulumi.Input.mapOptionalInputValue<CallCredentialsCallCredentialType, String>(callCredentialType, (value) => value.wireValue),
      'fromPlugin': ?pulumi.Input.mapOptionalInputValue<MetadataCredentialsFromPlugin, Map<String, dynamic>>(fromPlugin, (value) => value.toMap()),
    };
  }

  factory CallCredentials.fromMap(Map<String, dynamic> map) {
    return CallCredentials(
      callCredentialType: (() { final guardedValue = map['callCredentialType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CallCredentialsCallCredentialType.fromValue(guardedValue as String)); })(),
      fromPlugin: (() { final guardedValue = map['fromPlugin']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MetadataCredentialsFromPlugin.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
