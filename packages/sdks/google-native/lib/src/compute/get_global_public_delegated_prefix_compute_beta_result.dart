...
class GetGlobalPublicDelegatedPrefixComputeBetaResult {
  ...
  /// Creates a new [GetGlobalPublicDelegatedPrefixComputeBetaResult].
  ...
  const GetGlobalPublicDelegatedPrefixComputeBetaResult({
  ...
  factory GetGlobalPublicDelegatedPrefixComputeBetaResult.fromMap(Map<String, dynamic> map) {
