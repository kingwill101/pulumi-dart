...
/// {@template pulumi_compute_beta_snapshot_iam_binding_compute_beta_args_doc}
/// The set of arguments for SnapshotIamBinding.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_snapshot_iam_binding_compute_beta_args_doc}
class SnapshotIamBindingComputeBetaArgs {
  ...
  /// Creates a new [SnapshotIamBindingComputeBetaArgs].
  ...
  const SnapshotIamBindingComputeBetaArgs({
    this.condition,
