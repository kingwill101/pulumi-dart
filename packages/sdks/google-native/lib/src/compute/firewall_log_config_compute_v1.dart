...
class FirewallLogConfigComputeV1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'enable': ?enable,
      'metadata': ?pulumi.Input.mapOptionalInputValue<FirewallLogConfigMetadataComputeV1, String>(metadata, (value) => value.wireValue),
    };
  }
  ...
  factory FirewallLogConfigComputeV1.fromMap(Map<String, dynamic> map) {
    return FirewallLogConfigComputeV1(
      ...
      metadata: (() { final guardedValue = map['metadata']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FirewallLogConfigMetadataComputeV1.fromValue(guardedValue as String)); })(),
    );
  }
}
