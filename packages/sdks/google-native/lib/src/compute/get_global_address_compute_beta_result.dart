...
class GetGlobalAddressComputeBetaResult {
  ...
  /// Creates a new [GetGlobalAddressComputeBetaResult].
  ...
  const GetGlobalAddressComputeBetaResult({
  ...
  factory GetGlobalAddressComputeBetaResult.fromMap(Map<String, dynamic> map) {
    return GetGlobalAddressComputeBetaResult(
