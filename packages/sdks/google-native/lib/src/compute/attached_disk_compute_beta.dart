...
class AttachedDiskComputeBeta {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'interface': ?pulumi.Input.mapOptionalInputValue<AttachedDiskInterfaceComputeBeta, String>(interface, (value) => value.wireValue),
      'mode': ?pulumi.Input.mapOptionalInputValue<AttachedDiskModeComputeBeta, String>(mode, (value) => value.wireValue),
      'savedState': ?pulumi.Input.mapOptionalInputValue<AttachedDiskSavedStateComputeBeta, String>(savedState, (value) => value.wireValue),
      'source': ?source,
      'type': ?pulumi.Input.mapOptionalInputValue<AttachedDiskTypeComputeBeta, String>(type, (value) => value.wireValue),
    };
  }
  ...
  factory AttachedDiskComputeBeta.fromMap(Map<String, dynamic> map) {
    return AttachedDiskComputeBeta(
      ...
      diskEncryptionKey: (() { final guardedValue = map['diskEncryptionKey']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CustomerEncryptionKeyComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      initializeParams: (() { final guardedValue = map['initializeParams']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AttachedDiskInitializeParamsComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      interface: (() { final guardedValue = map['interface']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AttachedDiskInterfaceComputeBeta.fromValue(guardedValue as String)); })(),
      mode: (() { final guardedValue = map['mode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AttachedDiskModeComputeBeta.fromValue(guardedValue as String)); })(),
      savedState: (() { final guardedValue = map['savedState']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AttachedDiskSavedStateComputeBeta.fromValue(guardedValue as String)); })(),
      source: (() { final guardedValue = map['source']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AttachedDiskTypeComputeBeta.fromValue(guardedValue as String)); })(),
    );
  }
}
