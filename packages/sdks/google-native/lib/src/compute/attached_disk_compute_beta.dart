...
class AttachedDiskComputeBeta {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'interface':
          ?pulumi.Input.mapOptionalInputValue<
            AttachedDiskInterfaceComputeBeta,
            String
          >(interface, (value) => value.wireValue),
      'mode':
          ?pulumi.Input.mapOptionalInputValue<
            AttachedDiskModeComputeBeta,
            String
          >(mode, (value) => value.wireValue),
      'savedState':
          ?pulumi.Input.mapOptionalInputValue<
            AttachedDiskSavedStateComputeBeta,
            String
          >(savedState, (value) => value.wireValue),
      'source': ?source,
      'type':
          ?pulumi.Input.mapOptionalInputValue<
            AttachedDiskTypeComputeBeta,
            String
  ...
  factory AttachedDiskComputeBeta.fromMap(Map<String, dynamic> map) {
    return AttachedDiskComputeBeta(
      ...
      interface: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AttachedDiskInterfaceComputeBeta.fromValue(guardedValue as String),
        );
      })(),
      mode: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AttachedDiskModeComputeBeta.fromValue(guardedValue as String),
        );
      })(),
      savedState: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AttachedDiskSavedStateComputeBeta.fromValue(guardedValue as String),
        );
      })(),
      source: (() {
      ...
      type: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AttachedDiskTypeComputeBeta.fromValue(guardedValue as String),
        );
      })(),
    );
  }
