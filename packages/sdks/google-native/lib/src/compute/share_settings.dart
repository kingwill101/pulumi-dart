...
class ShareSettings {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'projects': ?projects,
      'shareType': ?pulumi.Input.mapOptionalInputValue<ShareSettingsShareType, String>(shareType, (value) => value.wireValue),
    };
  }

  factory ShareSettings.fromMap(Map<String, dynamic> map) {
    return ShareSettings(
      folderMap: (() { final guardedValue = map['folderMap']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      ...
      shareType: (() { final guardedValue = map['shareType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ShareSettingsShareType.fromValue(guardedValue as String)); })(),
    );
  }
}
