...
class InstanceGroupManagerUpdatePolicyResponseComputeBeta {
  ...
  final pulumi.Input<FixedOrPercentResponseComputeBeta> maxSurge;
  ...
  final pulumi.Input<FixedOrPercentResponseComputeBeta> maxUnavailable;
  ...
  const InstanceGroupManagerUpdatePolicyResponseComputeBeta({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'maxSurge': pulumi.Input.mapInputValue<FixedOrPercentResponseComputeBeta, Map<String, dynamic>>(maxSurge, (value) => value.toMap()),
      'maxUnavailable': pulumi.Input.mapInputValue<FixedOrPercentResponseComputeBeta, Map<String, dynamic>>(maxUnavailable, (value) => value.toMap()),
  ...
  factory InstanceGroupManagerUpdatePolicyResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return InstanceGroupManagerUpdatePolicyResponseComputeBeta(
      ...
      maxSurge: pulumi.Input.fromValue(FixedOrPercentResponseComputeBeta.fromMap((map['maxSurge']! as Map).cast<String, dynamic>())),
      maxUnavailable: pulumi.Input.fromValue(FixedOrPercentResponseComputeBeta.fromMap((map['maxUnavailable']! as Map).cast<String, dynamic>())),
