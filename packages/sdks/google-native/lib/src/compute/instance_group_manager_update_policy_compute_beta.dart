...
class InstanceGroupManagerUpdatePolicyComputeBeta {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'instanceRedistributionType': ?pulumi.Input.mapOptionalInputValue<InstanceGroupManagerUpdatePolicyInstanceRedistributionTypeComputeBeta, String>(instanceRedistributionType, (value) => value.value),
      ...
      'minimalAction': ?pulumi.Input.mapOptionalInputValue<InstanceGroupManagerUpdatePolicyMinimalActionComputeBeta, String>(minimalAction, (value) => value.value),
      'mostDisruptiveAllowedAction': ?pulumi.Input.mapOptionalInputValue<InstanceGroupManagerUpdatePolicyMostDisruptiveAllowedActionComputeBeta, String>(mostDisruptiveAllowedAction, (value) => value.value),
      'replacementMethod': ?pulumi.Input.mapOptionalInputValue<InstanceGroupManagerUpdatePolicyReplacementMethodComputeBeta, String>(replacementMethod, (value) => value.value),
      'type': ?pulumi.Input.mapOptionalInputValue<InstanceGroupManagerUpdatePolicyTypeComputeBeta, String>(type, (value) => value.value),
    };
  }
