...
class RouterBgpPeer {
  ...
  final pulumi.Input<List<RouterBgpPeerCustomLearnedIpRange>>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'advertisedGroups':
          ?pulumi.Input.mapOptionalInputValue<
            List<RouterBgpPeerAdvertisedGroupsItem>,
            List<String>
          >(
            advertisedGroups,
            (value) =>
      ...
      'enable':
          ?pulumi.Input.mapOptionalInputValue<RouterBgpPeerEnable, String>(
            enable,
    ...
    return RouterBgpPeer(
      advertiseMode: (() {
        ...
        return pulumi.Input.fromValue(
          RouterBgpPeerAdvertiseMode.fromValue(guardedValue as String),
        );
      })(),
      advertisedGroups: (() {
      ...
      enable: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RouterBgpPeerEnable.fromValue(guardedValue as String),
        );
      })(),
      enableIpv4: (() {
