...
class RouterBgpPeer {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'advertiseMode': ?pulumi.Input.mapOptionalInputValue<RouterBgpPeerAdvertiseMode, String>(advertiseMode, (value) => value.value),
      'advertisedGroups': ?pulumi.Input.mapOptionalInputValue<List<RouterBgpPeerAdvertisedGroupsItem>, List<String>>(advertisedGroups, (value) => pulumi.Input.encodeList<RouterBgpPeerAdvertisedGroupsItem, String>(value, (value) => value.value)),
      ...
      'enable': ?pulumi.Input.mapOptionalInputValue<RouterBgpPeerEnable, String>(enable, (value) => value.value),
  ...
  factory RouterBgpPeer.fromMap(Map<String, dynamic> map) {
    return RouterBgpPeer(
      advertiseMode: map['advertiseMode'] == null ? null : (RouterBgpPeerAdvertiseMode.fromValue(map['advertiseMode']! as String)).input(),
      advertisedGroups: map['advertisedGroups'] == null ? null : (pulumi.Input.decodeList<RouterBgpPeerAdvertisedGroupsItem>(map['advertisedGroups']!, (value) => RouterBgpPeerAdvertisedGroupsItem.fromValue(value as String))).input(),
      ...
      bfd: map['bfd'] == null ? null : (RouterBgpPeerBfd.fromMap((map['bfd']! as Map).cast<String, dynamic>())).input(),
      customLearnedIpRanges: map['customLearnedIpRanges'] == null ? null : (pulumi.Input.decodeList<RouterBgpPeerCustomLearnedIpRange>(map['customLearnedIpRanges']!, (value) => RouterBgpPeerCustomLearnedIpRange.fromMap((value as Map).cast<String, dynamic>()))).input(),
      customLearnedRoutePriority: map['customLearnedRoutePriority'] == null ? null : (map['customLearnedRoutePriority']! as int).input(),
      enable: map['enable'] == null ? null : (RouterBgpPeerEnable.fromValue(map['enable']! as String)).input(),
