...
class HttpRouteRuleMatchResponseComputeBeta {
  ...
  factory HttpRouteRuleMatchResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return HttpRouteRuleMatchResponseComputeBeta(
      ...
      headerMatches: (pulumi.Input.decodeList<HttpHeaderMatchResponseComputeBeta>(map['headerMatches'], (value) => HttpHeaderMatchResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ignoreCase: (map['ignoreCase'] as bool).input(),
      metadataFilters: (pulumi.Input.decodeList<MetadataFilterResponseComputeBeta>(map['metadataFilters'], (value) => MetadataFilterResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))).input(),
      pathTemplateMatch: (map['pathTemplateMatch'] as String).input(),
      prefixMatch: (map['prefixMatch'] as String).input(),
      queryParameterMatches: (pulumi.Input.decodeList<HttpQueryParameterMatchResponseComputeBeta>(map['queryParameterMatches'], (value) => HttpQueryParameterMatchResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))).input(),
