...
class HttpRouteRuleMatchResponseComputeBeta {
  ...
  final pulumi.Input<List<HttpQueryParameterMatchResponseComputeBeta>>
    ...
    return <String, dynamic>{
      ...
      'headerMatches':
          pulumi.Input.mapInputValue<
            List<HttpHeaderMatchResponseComputeBeta>,
      ...
      'metadataFilters':
          pulumi.Input.mapInputValue<
            List<MetadataFilterResponseComputeBeta>,
            List<Map<String, dynamic>>
          >(
            metadataFilters,
            (value) =>
      ...
      'queryParameterMatches':
          pulumi.Input.mapInputValue<
            List<HttpQueryParameterMatchResponseComputeBeta>,
            List<Map<String, dynamic>>
          >(
            queryParameterMatches,
            (value) =>
