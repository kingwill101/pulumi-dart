...
class HttpRouteRuleMatchResponseComputeBeta {
  ...
  final pulumi.Input<List<HttpHeaderMatchResponseComputeBeta>> headerMatches;
  ...
  final pulumi.Input<List<MetadataFilterResponseComputeBeta>> metadataFilters;
  ...
  final pulumi.Input<List<HttpQueryParameterMatchResponseComputeBeta>> queryParameterMatches;
  ...
  const HttpRouteRuleMatchResponseComputeBeta({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'headerMatches': pulumi.Input.mapInputValue<List<HttpHeaderMatchResponseComputeBeta>, List<Map<String, dynamic>>>(headerMatches, (value) => pulumi.Input.encodeList<HttpHeaderMatchResponseComputeBeta, Map<String, dynamic>>(value, (value) => value.toMap())),
      'ignoreCase': ignoreCase,
      'metadataFilters': pulumi.Input.mapInputValue<List<MetadataFilterResponseComputeBeta>, List<Map<String, dynamic>>>(metadataFilters, (value) => pulumi.Input.encodeList<MetadataFilterResponseComputeBeta, Map<String, dynamic>>(value, (value) => value.toMap())),
      'pathTemplateMatch': pathTemplateMatch,
      'prefixMatch': prefixMatch,
      'queryParameterMatches': pulumi.Input.mapInputValue<List<HttpQueryParameterMatchResponseComputeBeta>, List<Map<String, dynamic>>>(queryParameterMatches, (value) => pulumi.Input.encodeList<HttpQueryParameterMatchResponseComputeBeta, Map<String, dynamic>>(value, (value) => value.toMap())),
      'regexMatch': regexMatch,
    };
  }

  factory HttpRouteRuleMatchResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return HttpRouteRuleMatchResponseComputeBeta(
      fullPathMatch: pulumi.Input.fromValue(map['fullPathMatch'] as String),
      headerMatches: pulumi.Input.fromValue(pulumi.Input.decodeList<HttpHeaderMatchResponseComputeBeta>(map['headerMatches']!, (value) => HttpHeaderMatchResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))),
      ignoreCase: pulumi.Input.fromValue(map['ignoreCase'] as bool),
      metadataFilters: pulumi.Input.fromValue(pulumi.Input.decodeList<MetadataFilterResponseComputeBeta>(map['metadataFilters']!, (value) => MetadataFilterResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      queryParameterMatches: pulumi.Input.fromValue(pulumi.Input.decodeList<HttpQueryParameterMatchResponseComputeBeta>(map['queryParameterMatches']!, (value) => HttpQueryParameterMatchResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))),
