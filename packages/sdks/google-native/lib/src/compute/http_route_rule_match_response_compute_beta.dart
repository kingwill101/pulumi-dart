...
class HttpRouteRuleMatchResponseComputeBeta {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'headerMatches': pulumi.Input.encodeList<HttpHeaderMatchResponseComputeBeta, Map<String, dynamic>>(headerMatches, (value) => value.toMap()),
      ...
      'queryParameterMatches': pulumi.Input.encodeList<HttpQueryParameterMatchResponseComputeBeta, Map<String, dynamic>>(queryParameterMatches, (value) => value.toMap()),
  ...
  factory HttpRouteRuleMatchResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return HttpRouteRuleMatchResponseComputeBeta(
      ...
      headerMatches: pulumi.Input.decodeList<HttpHeaderMatchResponseComputeBeta>(map['headerMatches'], (value) => HttpHeaderMatchResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      ...
      queryParameterMatches: pulumi.Input.decodeList<HttpQueryParameterMatchResponseComputeBeta>(map['queryParameterMatches'], (value) => HttpQueryParameterMatchResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
