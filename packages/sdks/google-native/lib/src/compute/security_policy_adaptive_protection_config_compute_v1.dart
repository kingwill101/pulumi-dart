...
class SecurityPolicyAdaptiveProtectionConfigComputeV1 {
  ...
  factory SecurityPolicyAdaptiveProtectionConfigComputeV1.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyAdaptiveProtectionConfigComputeV1(
      layer7DdosDefenseConfig: (() { final guardedValue = map['layer7DdosDefenseConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SecurityPolicyAdaptiveProtectionConfigLayer7DdosDefenseConfigComputeV1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
