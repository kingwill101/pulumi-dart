...
class NetworkInterfaceResponseComputeBeta {
  ...
  factory NetworkInterfaceResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return NetworkInterfaceResponseComputeBeta(
      accessConfigs: (pulumi.Input.decodeList<AccessConfigResponseComputeBeta>(map['accessConfigs'], (value) => AccessConfigResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))).input(),
      aliasIpRanges: (pulumi.Input.decodeList<AliasIpRangeResponseComputeBeta>(map['aliasIpRanges'], (value) => AliasIpRangeResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))).input(),
      fingerprint: (map['fingerprint'] as String).input(),
      internalIpv6PrefixLength: (map['internalIpv6PrefixLength'] as int).input(),
      ipv6AccessConfigs: (pulumi.Input.decodeList<AccessConfigResponseComputeBeta>(map['ipv6AccessConfigs'], (value) => AccessConfigResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))).input(),
