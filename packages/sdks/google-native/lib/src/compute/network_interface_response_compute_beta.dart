...
class NetworkInterfaceResponseComputeBeta {
  ...
  final pulumi.Input<List<AccessConfigResponseComputeBeta>> accessConfigs;
  /// An array of alias IP ranges for this network interface. You can only specify this field for network interfaces in VPC networks.
  final pulumi.Input<List<AliasIpRangeResponseComputeBeta>> aliasIpRanges;
  ...
  final pulumi.Input<List<AccessConfigResponseComputeBeta>> ipv6AccessConfigs;
  ...
  /// Creates a new [NetworkInterfaceResponseComputeBeta].
  ...
  const NetworkInterfaceResponseComputeBeta({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'accessConfigs': pulumi.Input.mapInputValue<List<AccessConfigResponseComputeBeta>, List<Map<String, dynamic>>>(accessConfigs, (value) => pulumi.Input.encodeList<AccessConfigResponseComputeBeta, Map<String, dynamic>>(value, (value) => value.toMap())),
      'aliasIpRanges': pulumi.Input.mapInputValue<List<AliasIpRangeResponseComputeBeta>, List<Map<String, dynamic>>>(aliasIpRanges, (value) => pulumi.Input.encodeList<AliasIpRangeResponseComputeBeta, Map<String, dynamic>>(value, (value) => value.toMap())),
      'fingerprint': fingerprint,
      'internalIpv6PrefixLength': internalIpv6PrefixLength,
      'ipv6AccessConfigs': pulumi.Input.mapInputValue<List<AccessConfigResponseComputeBeta>, List<Map<String, dynamic>>>(ipv6AccessConfigs, (value) => pulumi.Input.encodeList<AccessConfigResponseComputeBeta, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory NetworkInterfaceResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return NetworkInterfaceResponseComputeBeta(
      accessConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<AccessConfigResponseComputeBeta>(map['accessConfigs']!, (value) => AccessConfigResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))),
      aliasIpRanges: pulumi.Input.fromValue(pulumi.Input.decodeList<AliasIpRangeResponseComputeBeta>(map['aliasIpRanges']!, (value) => AliasIpRangeResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      ipv6AccessConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<AccessConfigResponseComputeBeta>(map['ipv6AccessConfigs']!, (value) => AccessConfigResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))),
