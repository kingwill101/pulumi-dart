...
class AuditLogConfigResponseComputeBeta {
  ...
  factory AuditLogConfigResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return AuditLogConfigResponseComputeBeta(
