...
import 'http_route_rule_response_compute_beta.dart';
import 'path_rule_response_compute_beta.dart';

/// A matcher for the path portion of the URL. The BackendService from the longest-matched rule will serve the URL. If no rule was matched, the default service is used.
class PathMatcherResponseComputeBeta {
  ...
  final pulumi.Input<CustomErrorResponsePolicyResponseComputeBeta> defaultCustomErrorResponsePolicy;
  ...
  final pulumi.Input<HttpRouteActionResponseComputeBeta> defaultRouteAction;
  ...
  final pulumi.Input<HttpRedirectActionResponseComputeBeta> defaultUrlRedirect;
  ...
  final pulumi.Input<List<PathRuleResponseComputeBeta>> pathRules;
  /// The list of HTTP route rules. Use this list instead of pathRules when advanced route matching and routing actions are desired. routeRules are evaluated in order of priority, from the lowest to highest number. Within a given pathMatcher, you can set only one of pathRules or routeRules.
  final pulumi.Input<List<HttpRouteRuleResponseComputeBeta>> routeRules;

  /// Creates a new [PathMatcherResponseComputeBeta].
  ...
  const PathMatcherResponseComputeBeta({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'defaultCustomErrorResponsePolicy': pulumi.Input.mapInputValue<CustomErrorResponsePolicyResponseComputeBeta, Map<String, dynamic>>(defaultCustomErrorResponsePolicy, (value) => value.toMap()),
      'defaultRouteAction': pulumi.Input.mapInputValue<HttpRouteActionResponseComputeBeta, Map<String, dynamic>>(defaultRouteAction, (value) => value.toMap()),
      'defaultService': defaultService,
      'defaultUrlRedirect': pulumi.Input.mapInputValue<HttpRedirectActionResponseComputeBeta, Map<String, dynamic>>(defaultUrlRedirect, (value) => value.toMap()),
      ...
      'name': name,
      'pathRules': pulumi.Input.mapInputValue<List<PathRuleResponseComputeBeta>, List<Map<String, dynamic>>>(pathRules, (value) => pulumi.Input.encodeList<PathRuleResponseComputeBeta, Map<String, dynamic>>(value, (value) => value.toMap())),
      'routeRules': pulumi.Input.mapInputValue<List<HttpRouteRuleResponseComputeBeta>, List<Map<String, dynamic>>>(routeRules, (value) => pulumi.Input.encodeList<HttpRouteRuleResponseComputeBeta, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory PathMatcherResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return PathMatcherResponseComputeBeta(
      defaultCustomErrorResponsePolicy: pulumi.Input.fromValue(CustomErrorResponsePolicyResponseComputeBeta.fromMap((map['defaultCustomErrorResponsePolicy']! as Map).cast<String, dynamic>())),
      defaultRouteAction: pulumi.Input.fromValue(HttpRouteActionResponseComputeBeta.fromMap((map['defaultRouteAction']! as Map).cast<String, dynamic>())),
      defaultService: pulumi.Input.fromValue(map['defaultService'] as String),
      defaultUrlRedirect: pulumi.Input.fromValue(HttpRedirectActionResponseComputeBeta.fromMap((map['defaultUrlRedirect']! as Map).cast<String, dynamic>())),
      ...
      pathRules: pulumi.Input.fromValue(pulumi.Input.decodeList<PathRuleResponseComputeBeta>(map['pathRules']!, (value) => PathRuleResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))),
      routeRules: pulumi.Input.fromValue(pulumi.Input.decodeList<HttpRouteRuleResponseComputeBeta>(map['routeRules']!, (value) => HttpRouteRuleResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
