...
class PathMatcherResponseComputeBeta {
  ...
  final pulumi.Input<CustomErrorResponsePolicyResponseComputeBeta>
    ...
    return <String, dynamic>{
      'defaultCustomErrorResponsePolicy':
          pulumi.Input.mapInputValue<
            CustomErrorResponsePolicyResponseComputeBeta,
            Map<String, dynamic>
          >(defaultCustomErrorResponsePolicy, (value) => value.toMap()),
      'defaultRouteAction':
          pulumi.Input.mapInputValue<
            HttpRouteActionResponseComputeBeta,
            Map<String, dynamic>
      ...
      'pathRules':
          pulumi.Input.mapInputValue<
            List<PathRuleResponseComputeBeta>,
            List<Map<String, dynamic>>
          >(
            pathRules,
            (value) =>
                pulumi.Input.encodeList<
                  PathRuleResponseComputeBeta,
                  Map<String, dynamic>
                >(value, (value) => value.toMap()),
          ),
      'routeRules':
          pulumi.Input.mapInputValue<
            List<HttpRouteRuleResponseComputeBeta>,
            List<Map<String, dynamic>>
          >(
            routeRules,
            (value) =>
  ...
  factory PathMatcherResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return PathMatcherResponseComputeBeta(
      defaultCustomErrorResponsePolicy: pulumi.Input.fromValue(
        CustomErrorResponsePolicyResponseComputeBeta.fromMap(
          (map['defaultCustomErrorResponsePolicy']! as Map)
              .cast<String, dynamic>(),
        ),
      ),
      defaultRouteAction: pulumi.Input.fromValue(
        HttpRouteActionResponseComputeBeta.fromMap(
          (map['defaultRouteAction']! as Map).cast<String, dynamic>(),
        ),
      ),
      defaultService: pulumi.Input.fromValue(map['defaultService'] as String),
      defaultUrlRedirect: pulumi.Input.fromValue(
        HttpRedirectActionResponseComputeBeta.fromMap(
          (map['defaultUrlRedirect']! as Map).cast<String, dynamic>(),
        ),
      ),
      description: pulumi.Input.fromValue(map['description'] as String),
      headerAction: pulumi.Input.fromValue(
        HttpHeaderActionResponseComputeBeta.fromMap(
          (map['headerAction']! as Map).cast<String, dynamic>(),
        ),
      ),
      name: pulumi.Input.fromValue(map['name'] as String),
      pathRules: pulumi.Input.fromValue(
        pulumi.Input.decodeList<PathRuleResponseComputeBeta>(
          map['pathRules']!,
          (value) => PathRuleResponseComputeBeta.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      routeRules: pulumi.Input.fromValue(
        pulumi.Input.decodeList<HttpRouteRuleResponseComputeBeta>(
          map['routeRules']!,
          (value) => HttpRouteRuleResponseComputeBeta.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
