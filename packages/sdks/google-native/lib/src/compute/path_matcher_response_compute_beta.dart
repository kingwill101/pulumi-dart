...
class PathMatcherResponseComputeBeta {
  ...
  factory PathMatcherResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return PathMatcherResponseComputeBeta(
      defaultCustomErrorResponsePolicy: (CustomErrorResponsePolicyResponseComputeBeta.fromMap((map['defaultCustomErrorResponsePolicy'] as Map).cast<String, dynamic>())).input(),
      defaultRouteAction: (HttpRouteActionResponseComputeBeta.fromMap((map['defaultRouteAction'] as Map).cast<String, dynamic>())).input(),
      defaultService: (map['defaultService'] as String).input(),
      defaultUrlRedirect: (HttpRedirectActionResponseComputeBeta.fromMap((map['defaultUrlRedirect'] as Map).cast<String, dynamic>())).input(),
      description: (map['description'] as String).input(),
      headerAction: (HttpHeaderActionResponseComputeBeta.fromMap((map['headerAction'] as Map).cast<String, dynamic>())).input(),
      name: (map['name'] as String).input(),
      pathRules: (pulumi.Input.decodeList<PathRuleResponseComputeBeta>(map['pathRules'], (value) => PathRuleResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))).input(),
      routeRules: (pulumi.Input.decodeList<HttpRouteRuleResponseComputeBeta>(map['routeRules'], (value) => HttpRouteRuleResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
