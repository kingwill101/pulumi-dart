...
class PathMatcherResponseComputeBeta {
  ...
  final List<PathRuleResponseComputeBeta> pathRules;
  /// The list of HTTP route rules. Use this list instead of pathRules when advanced route matching and routing actions are desired. routeRules are evaluated in order of priority, from the lowest to highest number. Within a given pathMatcher, you can set only one of pathRules or routeRules.
  final List<HttpRouteRuleResponseComputeBeta> routeRules;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': name,
      'pathRules': pulumi.Input.encodeList<PathRuleResponseComputeBeta, Map<String, dynamic>>(pathRules, (value) => value.toMap()),
      'routeRules': pulumi.Input.encodeList<HttpRouteRuleResponseComputeBeta, Map<String, dynamic>>(routeRules, (value) => value.toMap()),
    };
  }
  ...
  factory PathMatcherResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return PathMatcherResponseComputeBeta(
      ...
      pathRules: pulumi.Input.decodeList<PathRuleResponseComputeBeta>(map['pathRules'], (value) => PathRuleResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      routeRules: pulumi.Input.decodeList<HttpRouteRuleResponseComputeBeta>(map['routeRules'], (value) => HttpRouteRuleResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
