...
class SecurityPolicyUserDefinedFieldComputeV1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'base': ?pulumi.Input.mapOptionalInputValue<SecurityPolicyUserDefinedFieldBaseComputeV1, String>(base, (value) => value.wireValue),
      'mask': ?mask,
      'name': ?name,
      'offset': ?offset,
      'size': ?size,
  ...
  factory SecurityPolicyUserDefinedFieldComputeV1.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyUserDefinedFieldComputeV1(
      base: (() { final guardedValue = map['base']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SecurityPolicyUserDefinedFieldBaseComputeV1.fromValue(guardedValue as String)); })(),
