...
/// {@template pulumi_compute_alpha_service_attachment_iam_binding_args_doc}
/// The set of arguments for ServiceAttachmentIamBinding.
/// {@endtemplate}
/// {@macro pulumi_compute_alpha_service_attachment_iam_binding_args_doc}
class ServiceAttachmentIamBindingArgs {
  ...
  /// Creates a new [ServiceAttachmentIamBindingArgs].
  ...
  const ServiceAttachmentIamBindingArgs({
    this.condition,
