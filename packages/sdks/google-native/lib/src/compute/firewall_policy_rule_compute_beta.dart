...
class FirewallPolicyRuleComputeBeta {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'direction': ?pulumi.Input.mapOptionalInputValue<FirewallPolicyRuleDirectionComputeBeta, String>(direction, (value) => value.value),
      'disabled': ?disabled,
  ...
  factory FirewallPolicyRuleComputeBeta.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyRuleComputeBeta(
      ...
      direction: map['direction'] == null ? null : (FirewallPolicyRuleDirectionComputeBeta.fromValue(map['direction']! as String)).input(),
      disabled: map['disabled'] == null ? null : (map['disabled']! as bool).input(),
      enableLogging: map['enableLogging'] == null ? null : (map['enableLogging']! as bool).input(),
      match: map['match'] == null ? null : (FirewallPolicyRuleMatcherComputeBeta.fromMap((map['match']! as Map).cast<String, dynamic>())).input(),
      ...
      targetSecureTags: map['targetSecureTags'] == null ? null : (pulumi.Input.decodeList<FirewallPolicyRuleSecureTagComputeBeta>(map['targetSecureTags']!, (value) => FirewallPolicyRuleSecureTagComputeBeta.fromMap((value as Map).cast<String, dynamic>()))).input(),
