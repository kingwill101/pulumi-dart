...
class FirewallPolicyRuleComputeBeta {
  ...
  final pulumi.Input<List<FirewallPolicyRuleSecureTagComputeBeta>>?
  targetSecureTags;
    ...
    return <String, dynamic>{
      ...
      'direction':
          ?pulumi.Input.mapOptionalInputValue<
            FirewallPolicyRuleDirectionComputeBeta,
            String
      ...
      'match':
          ?pulumi.Input.mapOptionalInputValue<
            FirewallPolicyRuleMatcherComputeBeta,
            Map<String, dynamic>
      ...
      'targetSecureTags':
          ?pulumi.Input.mapOptionalInputValue<
            List<FirewallPolicyRuleSecureTagComputeBeta>,
