...
class GetPacketMirroringComputeBetaResult {
  ...
  final PacketMirroringMirroredResourceInfoResponseComputeBeta
  mirroredResources;
  ...
  factory GetPacketMirroringComputeBetaResult.fromMap(
    Map<String, dynamic> map,
  ) {
    return GetPacketMirroringComputeBetaResult(
      collectorIlb:
          PacketMirroringForwardingRuleInfoResponseComputeBeta.fromMap(
            (map['collectorIlb']! as Map).cast<String, dynamic>(),
          ),
      creationTimestamp: map['creationTimestamp'] as String,
      description: map['description'] as String,
      enable: map['enable'] as String,
      filter: PacketMirroringFilterResponseComputeBeta.fromMap(
        (map['filter']! as Map).cast<String, dynamic>(),
      ),
      kind: map['kind'] as String,
      mirroredResources:
          PacketMirroringMirroredResourceInfoResponseComputeBeta.fromMap(
            (map['mirroredResources']! as Map).cast<String, dynamic>(),
          ),
      name: map['name'] as String,
      network: PacketMirroringNetworkInfoResponseComputeBeta.fromMap(
