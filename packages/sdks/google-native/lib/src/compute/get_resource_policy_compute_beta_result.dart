...
class GetResourcePolicyComputeBetaResult {
  ...
  /// Creates a new [GetResourcePolicyComputeBetaResult].
  ...
  factory GetResourcePolicyComputeBetaResult.fromMap(Map<String, dynamic> map) {
