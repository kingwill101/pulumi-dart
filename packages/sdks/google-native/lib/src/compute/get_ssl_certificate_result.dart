...
class GetSslCertificateResult {
  ...
  final SslCertificateManagedSslCertificateResponse managed;
  ...
  final SslCertificateSelfManagedSslCertificateResponse selfManaged;
  /// Domains associated with the certificate via Subject Alternative Name.
  final List<String> subjectAlternativeNames;
  /// (Optional) Specifies the type of SSL certificate, either "SELF_MANAGED" or "MANAGED". If not specified, the certificate is self-managed and the fields certificate and private_key are used.
  final String type;

  /// Creates a new [GetSslCertificateResult].
  ...
  factory GetSslCertificateResult.fromMap(Map<String, dynamic> map) {
    return GetSslCertificateResult(
      ...
      managed: SslCertificateManagedSslCertificateResponse.fromMap((map['managed']! as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      privateKey: map['privateKey'] as String,
      region: map['region'] as String,
      selfLink: map['selfLink'] as String,
      selfLinkWithId: map['selfLinkWithId'] as String,
      selfManaged: SslCertificateSelfManagedSslCertificateResponse.fromMap((map['selfManaged']! as Map).cast<String, dynamic>()),
