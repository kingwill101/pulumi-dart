...
class InstancePropertiesComputeV1 {
  ...
  const InstancePropertiesComputeV1({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'keyRevocationActionType': ?pulumi.Input.mapOptionalInputValue<InstancePropertiesKeyRevocationActionTypeComputeV1, String>(keyRevocationActionType, (value) => value.wireValue),
      'labels': ?labels,
      ...
      'privateIpv6GoogleAccess': ?pulumi.Input.mapOptionalInputValue<InstancePropertiesPrivateIpv6GoogleAccessComputeV1, String>(privateIpv6GoogleAccess, (value) => value.wireValue),
  ...
  factory InstancePropertiesComputeV1.fromMap(Map<String, dynamic> map) {
    return InstancePropertiesComputeV1(
      ...
      keyRevocationActionType: (() { final guardedValue = map['keyRevocationActionType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstancePropertiesKeyRevocationActionTypeComputeV1.fromValue(guardedValue as String)); })(),
      ...
      privateIpv6GoogleAccess: (() { final guardedValue = map['privateIpv6GoogleAccess']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstancePropertiesPrivateIpv6GoogleAccessComputeV1.fromValue(guardedValue as String)); })(),
