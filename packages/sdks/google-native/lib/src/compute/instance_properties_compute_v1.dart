...
class InstancePropertiesComputeV1 {
  ...
  final pulumi.Input<InstancePropertiesKeyRevocationActionTypeComputeV1>?
  ...
  final pulumi.Input<InstancePropertiesPrivateIpv6GoogleAccessComputeV1>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'keyRevocationActionType':
          ?pulumi.Input.mapOptionalInputValue<
            InstancePropertiesKeyRevocationActionTypeComputeV1,
            String
      ...
      'networkInterfaces':
          ?pulumi.Input.mapOptionalInputValue<
            List<NetworkInterfaceComputeV1>,
            List<Map<String, dynamic>>
          >(
            networkInterfaces,
            (value) =>
      ...
      'privateIpv6GoogleAccess':
          ?pulumi.Input.mapOptionalInputValue<
            InstancePropertiesPrivateIpv6GoogleAccessComputeV1,
            String
  ...
  factory InstancePropertiesComputeV1.fromMap(Map<String, dynamic> map) {
    return InstancePropertiesComputeV1(
      ...
      tags: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TagsComputeV1.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
