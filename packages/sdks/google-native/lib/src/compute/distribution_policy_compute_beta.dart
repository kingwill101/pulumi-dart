...
class DistributionPolicyComputeBeta {
  ...
  final pulumi.Input<List<DistributionPolicyZoneConfigurationComputeBeta>>?
  zones;
    ...
    return <String, dynamic>{
      'targetShape':
          ?pulumi.Input.mapOptionalInputValue<
            DistributionPolicyTargetShapeComputeBeta,
            String
          >(targetShape, (value) => value.wireValue),
      'zones':
          ?pulumi.Input.mapOptionalInputValue<
            List<DistributionPolicyZoneConfigurationComputeBeta>,
  ...
  factory DistributionPolicyComputeBeta.fromMap(Map<String, dynamic> map) {
    return DistributionPolicyComputeBeta(
      ...
      zones: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<DistributionPolicyZoneConfigurationComputeBeta>(
            guardedValue,
