...
class SecurityPolicyRuleRateLimitOptions {
  ...
  final pulumi.Input<SecurityPolicyRuleRateLimitOptionsEnforceOnKey>?
  enforceOnKey;
  ...
  final pulumi.Input<SecurityPolicyRuleRateLimitOptionsRpcStatus>?
  ...
  final pulumi.Input<SecurityPolicyRuleRateLimitOptionsThreshold>?
  rateLimitThreshold;
  ...
  factory SecurityPolicyRuleRateLimitOptions.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRuleRateLimitOptions(
      ...
      exceedActionRpcStatus: (() {
        final guardedValue = map['exceedActionRpcStatus'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
