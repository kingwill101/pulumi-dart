...
class SecurityPolicyRuleRateLimitOptions {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'enforceOnKey': ?pulumi.Input.mapOptionalInputValue<SecurityPolicyRuleRateLimitOptionsEnforceOnKey, String>(enforceOnKey, (value) => value.value),
  ...
  factory SecurityPolicyRuleRateLimitOptions.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRuleRateLimitOptions(
      ...
      banThreshold: map['banThreshold'] == null ? null : (SecurityPolicyRuleRateLimitOptionsThreshold.fromMap((map['banThreshold'] as Map).cast<String, dynamic>())).input(),
      conformAction: map['conformAction'] == null ? null : (map['conformAction'] as String).input(),
      enforceOnKey: map['enforceOnKey'] == null ? null : (SecurityPolicyRuleRateLimitOptionsEnforceOnKey.fromValue(map['enforceOnKey'] as String)).input(),
      ...
      exceedActionRpcStatus: map['exceedActionRpcStatus'] == null ? null : (SecurityPolicyRuleRateLimitOptionsRpcStatus.fromMap((map['exceedActionRpcStatus'] as Map).cast<String, dynamic>())).input(),
      exceedRedirectOptions: map['exceedRedirectOptions'] == null ? null : (SecurityPolicyRuleRedirectOptions.fromMap((map['exceedRedirectOptions'] as Map).cast<String, dynamic>())).input(),
      rateLimitThreshold: map['rateLimitThreshold'] == null ? null : (SecurityPolicyRuleRateLimitOptionsThreshold.fromMap((map['rateLimitThreshold'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
