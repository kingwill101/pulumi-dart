...
class SecurityPolicyRuleRateLimitOptions {
  ...
  final pulumi.Input<SecurityPolicyRuleRateLimitOptionsThreshold>? banThreshold;
  ...
  final pulumi.Input<SecurityPolicyRuleRateLimitOptionsEnforceOnKey>? enforceOnKey;
  ...
  final pulumi.Input<SecurityPolicyRuleRateLimitOptionsRpcStatus>? exceedActionRpcStatus;
  /// Parameters defining the redirect action that is used as the exceed action. Cannot be specified if the exceed action is not redirect. This field is only supported in Global Security Policies of type CLOUD_ARMOR.
  final pulumi.Input<SecurityPolicyRuleRedirectOptions>? exceedRedirectOptions;
  /// Threshold at which to begin ratelimiting.
  final pulumi.Input<SecurityPolicyRuleRateLimitOptionsThreshold>? rateLimitThreshold;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'banThreshold': ?pulumi.Input.mapOptionalInputValue<SecurityPolicyRuleRateLimitOptionsThreshold, Map<String, dynamic>>(banThreshold, (value) => value.toMap()),
      'conformAction': ?conformAction,
      'enforceOnKey': ?pulumi.Input.mapOptionalInputValue<SecurityPolicyRuleRateLimitOptionsEnforceOnKey, String>(enforceOnKey, (value) => value.wireValue),
      ...
      'exceedActionRpcStatus': ?pulumi.Input.mapOptionalInputValue<SecurityPolicyRuleRateLimitOptionsRpcStatus, Map<String, dynamic>>(exceedActionRpcStatus, (value) => value.toMap()),
      'exceedRedirectOptions': ?pulumi.Input.mapOptionalInputValue<SecurityPolicyRuleRedirectOptions, Map<String, dynamic>>(exceedRedirectOptions, (value) => value.toMap()),
      'rateLimitThreshold': ?pulumi.Input.mapOptionalInputValue<SecurityPolicyRuleRateLimitOptionsThreshold, Map<String, dynamic>>(rateLimitThreshold, (value) => value.toMap()),
    };
  }
  ...
  factory SecurityPolicyRuleRateLimitOptions.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRuleRateLimitOptions(
      ...
      banThreshold: (() { final guardedValue = map['banThreshold']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SecurityPolicyRuleRateLimitOptionsThreshold.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      enforceOnKey: (() { final guardedValue = map['enforceOnKey']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SecurityPolicyRuleRateLimitOptionsEnforceOnKey.fromValue(guardedValue as String)); })(),
      ...
      exceedActionRpcStatus: (() { final guardedValue = map['exceedActionRpcStatus']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SecurityPolicyRuleRateLimitOptionsRpcStatus.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      exceedRedirectOptions: (() { final guardedValue = map['exceedRedirectOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SecurityPolicyRuleRedirectOptions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      rateLimitThreshold: (() { final guardedValue = map['rateLimitThreshold']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SecurityPolicyRuleRateLimitOptionsThreshold.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
