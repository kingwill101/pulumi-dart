...
class RegionSnapshot extends pulumi.CustomResource {
  ...
  RegionSnapshot(
    ...
    snapshotEncryptionKey = registerOutput<CustomerEncryptionKeyResponse>('snapshotEncryptionKey', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return CustomerEncryptionKeyResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    sourceInstantSnapshotEncryptionKey = registerOutput<CustomerEncryptionKeyResponse>('sourceInstantSnapshotEncryptionKey', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return CustomerEncryptionKeyResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
