...
class SecurityPolicyRulePreconfiguredWafConfigExclusionComputeV1 {
  ...
  factory SecurityPolicyRulePreconfiguredWafConfigExclusionComputeV1.fromMap(
    ...
    return SecurityPolicyRulePreconfiguredWafConfigExclusionComputeV1(
      requestCookiesToExclude: (() {
        final guardedValue = map['requestCookiesToExclude'];
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParamsComputeV1.fromMap(
      ...
      requestHeadersToExclude: (() {
        final guardedValue = map['requestHeadersToExclude'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<
            SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParamsComputeV1
      ...
      requestQueryParamsToExclude: (() {
        final guardedValue = map['requestQueryParamsToExclude'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<
            SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParamsComputeV1
      ...
      requestUrisToExclude: (() {
        final guardedValue = map['requestUrisToExclude'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<
            SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParamsComputeV1
      ...
      targetRuleSet: (() {
        final guardedValue = map['targetRuleSet'];
        if (guardedValue == null) return null;
