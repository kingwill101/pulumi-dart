...
/// {@template pulumi_compute_alpha_node_group_iam_member_args_doc}
/// The set of arguments for NodeGroupIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_alpha_node_group_iam_member_args_doc}
class NodeGroupIamMemberArgs {
  ...
  /// Creates a new [NodeGroupIamMemberArgs].
  ...
  factory NodeGroupIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return NodeGroupIamMemberArgs(
