...
class SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigComputeV1 {
  ...
  final pulumi.Input<
    SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigEnforceOnKeyTypeComputeV1
  >?
  enforceOnKeyType;
    ...
    return <String, dynamic>{
      ...
      'enforceOnKeyType':
          ?pulumi.Input.mapOptionalInputValue<
            SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigEnforceOnKeyTypeComputeV1,
            String
          >(enforceOnKeyType, (value) => value.wireValue),
    };
  }

  factory SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigComputeV1.fromMap(
    ...
    return SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigComputeV1(
      ...
      enforceOnKeyType: (() {
        ...
        return pulumi.Input.fromValue(
          SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigEnforceOnKeyTypeComputeV1.fromValue(
