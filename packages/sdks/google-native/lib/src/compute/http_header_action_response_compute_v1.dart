...
class HttpHeaderActionResponseComputeV1 {
  ...
  factory HttpHeaderActionResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return HttpHeaderActionResponseComputeV1(
      requestHeadersToAdd: (pulumi.Input.decodeList<HttpHeaderOptionResponseComputeV1>(map['requestHeadersToAdd'], (value) => HttpHeaderOptionResponseComputeV1.fromMap((value as Map).cast<String, dynamic>()))).input(),
      requestHeadersToRemove: ((map['requestHeadersToRemove'] as List).cast<String>()).input(),
      responseHeadersToAdd: (pulumi.Input.decodeList<HttpHeaderOptionResponseComputeV1>(map['responseHeadersToAdd'], (value) => HttpHeaderOptionResponseComputeV1.fromMap((value as Map).cast<String, dynamic>()))).input(),
