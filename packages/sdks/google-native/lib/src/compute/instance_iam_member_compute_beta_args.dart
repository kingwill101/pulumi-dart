...
/// {@template pulumi_compute_beta_instance_iam_member_compute_beta_args_doc}
/// The set of arguments for InstanceIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_instance_iam_member_compute_beta_args_doc}
class InstanceIamMemberComputeBetaArgs {
  ...
  /// Creates a new [InstanceIamMemberComputeBetaArgs].
  ...
  const InstanceIamMemberComputeBetaArgs({
    this.condition,
  ...
  factory InstanceIamMemberComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return InstanceIamMemberComputeBetaArgs(
