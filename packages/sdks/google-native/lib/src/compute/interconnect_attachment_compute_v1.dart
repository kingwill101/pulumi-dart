...
class InterconnectAttachmentComputeV1 extends pulumi.CustomResource {
  ...
  InterconnectAttachmentComputeV1(
    ...
    this.candidateIpv6Subnets = registerOutput<List<String>>('candidateIpv6Subnets');
    ...
    this.cloudRouterIpv6InterfaceId = registerOutput<String>('cloudRouterIpv6InterfaceId');
    this.configurationConstraints = registerOutput<InterconnectAttachmentConfigurationConstraintsResponseComputeV1>('configurationConstraints');
    ...
    this.customerRouterIpv6InterfaceId = registerOutput<String>('customerRouterIpv6InterfaceId');
    ...
    this.partnerMetadata = registerOutput<InterconnectAttachmentPartnerMetadataResponseComputeV1>('partnerMetadata');
    this.privateInterconnectInfo = registerOutput<InterconnectAttachmentPrivateInfoResponseComputeV1>('privateInterconnectInfo');
