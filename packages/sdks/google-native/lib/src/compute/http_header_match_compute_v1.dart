...
class HttpHeaderMatchComputeV1 {
  ...
  final Int64RangeMatchComputeV1? rangeMatch;
  ...
  factory HttpHeaderMatchComputeV1.fromMap(Map<String, dynamic> map) {
    return HttpHeaderMatchComputeV1(
      ...
      rangeMatch: map['rangeMatch'] == null ? null : Int64RangeMatchComputeV1.fromMap((map['rangeMatch'] as Map).cast<String, dynamic>()),
