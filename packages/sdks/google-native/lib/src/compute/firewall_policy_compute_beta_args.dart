...
class FirewallPolicyComputeBetaArgs {
  ...
  const FirewallPolicyComputeBetaArgs({
    this.associations,
    this.description,
    this.displayName,
    this.name,
  ...
  factory FirewallPolicyComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyComputeBetaArgs(
      associations: (() { final guardedValue = map['associations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FirewallPolicyAssociationComputeBeta>(guardedValue, (value) => FirewallPolicyAssociationComputeBeta.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      rules: (() { final guardedValue = map['rules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FirewallPolicyRuleComputeBeta>(guardedValue, (value) => FirewallPolicyRuleComputeBeta.fromMap((value as Map).cast<String, dynamic>()))); })(),
