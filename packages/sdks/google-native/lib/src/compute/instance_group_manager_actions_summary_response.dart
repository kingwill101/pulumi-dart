...
class InstanceGroupManagerActionsSummaryResponse {
  ...
  const InstanceGroupManagerActionsSummaryResponse({
  ...
  factory InstanceGroupManagerActionsSummaryResponse.fromMap(Map<String, dynamic> map) {
    return InstanceGroupManagerActionsSummaryResponse(
      ...
      creatingAtomically: pulumi.Input.fromValue(map['creatingAtomically'] as int),
      creatingWithoutRetries: pulumi.Input.fromValue(map['creatingWithoutRetries'] as int),
