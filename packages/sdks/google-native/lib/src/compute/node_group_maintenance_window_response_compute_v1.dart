...
class NodeGroupMaintenanceWindowResponseComputeV1 {
  ...
  const NodeGroupMaintenanceWindowResponseComputeV1({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'maintenanceDuration': pulumi.Input.mapInputValue<DurationResponseComputeV1, Map<String, dynamic>>(maintenanceDuration, (value) => value.toMap()),
      'startTime': startTime,
    };
  }

  factory NodeGroupMaintenanceWindowResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return NodeGroupMaintenanceWindowResponseComputeV1(
      maintenanceDuration: pulumi.Input.fromValue(DurationResponseComputeV1.fromMap((map['maintenanceDuration']! as Map).cast<String, dynamic>())),
