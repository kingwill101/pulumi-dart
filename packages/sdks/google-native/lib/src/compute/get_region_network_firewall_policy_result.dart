...
class GetRegionNetworkFirewallPolicyResult {
  ...
  final List<FirewallPolicyAssociationResponse> associations;
  ...
  final List<FirewallPolicyRuleResponse> rules;
  ...
  /// Creates a new [GetRegionNetworkFirewallPolicyResult].
  ...
  const GetRegionNetworkFirewallPolicyResult({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'associations': pulumi.Input.encodeList<FirewallPolicyAssociationResponse, Map<String, dynamic>>(associations, (value) => value.toMap()),
      ...
      'rules': pulumi.Input.encodeList<FirewallPolicyRuleResponse, Map<String, dynamic>>(rules, (value) => value.toMap()),
      'selfLink': selfLink,
  ...
  factory GetRegionNetworkFirewallPolicyResult.fromMap(Map<String, dynamic> map) {
    return GetRegionNetworkFirewallPolicyResult(
      associations: pulumi.Input.decodeList<FirewallPolicyAssociationResponse>(map['associations']!, (value) => FirewallPolicyAssociationResponse.fromMap((value as Map).cast<String, dynamic>())),
      ...
      rules: pulumi.Input.decodeList<FirewallPolicyRuleResponse>(map['rules']!, (value) => FirewallPolicyRuleResponse.fromMap((value as Map).cast<String, dynamic>())),
