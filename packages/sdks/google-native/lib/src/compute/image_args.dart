...
class ImageArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'architecture': ?pulumi.Input.mapOptionalInputValue<ImageArchitecture, String>(architecture, (value) => value.wireValue),
      ...
      'sourceType': ?pulumi.Input.mapOptionalInputValue<ImageSourceType, String>(sourceType, (value) => value.wireValue),
  ...
  factory ImageArgs.fromMap(Map<String, dynamic> map) {
    return ImageArgs(
      architecture: (() { final guardedValue = map['architecture']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ImageArchitecture.fromValue(guardedValue as String)); })(),
      ...
      deprecated: (() { final guardedValue = map['deprecated']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DeprecationStatus.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      imageEncryptionKey: (() { final guardedValue = map['imageEncryptionKey']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CustomerEncryptionKey.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      rolloutOverride: (() { final guardedValue = map['rolloutOverride']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RolloutPolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      shieldedInstanceInitialState: (() { final guardedValue = map['shieldedInstanceInitialState']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InitialStateConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      sourceType: (() { final guardedValue = map['sourceType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ImageSourceType.fromValue(guardedValue as String)); })(),
