  ...
  factory BackendServiceArgs.fromMap(Map<String, dynamic> map) {
    return BackendServiceArgs(
      ...
      compressionMode: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          BackendServiceCompressionMode.fromValue(guardedValue as String),
        );
      })(),
      connectionDraining: (() {
      ...
      loadBalancingScheme: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          BackendServiceLoadBalancingScheme.fromValue(guardedValue as String),
        );
      })(),
      localityLbPolicies: (() {
      ...
      localityLbPolicy: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          BackendServiceLocalityLbPolicy.fromValue(guardedValue as String),
        );
      })(),
      logConfig: (() {
      ...
      protocol: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          BackendServiceProtocol.fromValue(guardedValue as String),
        );
      })(),
      requestId: (() {
      ...
      sessionAffinity: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          BackendServiceSessionAffinity.fromValue(guardedValue as String),
        );
      })(),
      subsetting: (() {
      ...
      vpcNetworkScope: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          BackendServiceVpcNetworkScope.fromValue(guardedValue as String),
        );
      })(),
    );
  }
