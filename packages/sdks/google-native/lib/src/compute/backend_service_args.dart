...
class BackendServiceArgs {
  ...
  BackendServiceArgs({
    ...
    pulumi.Output<BackendServiceCompressionMode>? compressionMode,
    ...
    pulumi.Output<BackendServiceIpAddressSelectionPolicy>? ipAddressSelectionPolicy,
    pulumi.Output<BackendServiceLoadBalancingScheme>? loadBalancingScheme,
    pulumi.Output<List<BackendServiceLocalityLoadBalancingPolicyConfig>>? localityLbPolicies,
    pulumi.Output<BackendServiceLocalityLbPolicy>? localityLbPolicy,
    ...
    pulumi.Output<BackendServiceProtocol>? protocol,
    ...
    pulumi.Output<BackendServiceSessionAffinity>? sessionAffinity,
    pulumi.Output<Subsetting>? subsetting,
    pulumi.Output<int>? timeoutSec,
    pulumi.Output<List<BackendServiceUsedBy>>? usedBy,
    pulumi.Output<BackendServiceVpcNetworkScope>? vpcNetworkScope,
  }) :
  ...
  factory BackendServiceArgs.fromMap(Map<String, dynamic> map) {
    return BackendServiceArgs(
      ...
      compressionMode: map['compressionMode'] == null ? null : pulumi.Output.create<BackendServiceCompressionMode>(BackendServiceCompressionMode.fromValue(map['compressionMode'] as String)),
      ...
      ipAddressSelectionPolicy: map['ipAddressSelectionPolicy'] == null ? null : pulumi.Output.create<BackendServiceIpAddressSelectionPolicy>(BackendServiceIpAddressSelectionPolicy.fromValue(map['ipAddressSelectionPolicy'] as String)),
      loadBalancingScheme: map['loadBalancingScheme'] == null ? null : pulumi.Output.create<BackendServiceLoadBalancingScheme>(BackendServiceLoadBalancingScheme.fromValue(map['loadBalancingScheme'] as String)),
      ...
      localityLbPolicy: map['localityLbPolicy'] == null ? null : pulumi.Output.create<BackendServiceLocalityLbPolicy>(BackendServiceLocalityLbPolicy.fromValue(map['localityLbPolicy'] as String)),
      ...
      protocol: map['protocol'] == null ? null : pulumi.Output.create<BackendServiceProtocol>(BackendServiceProtocol.fromValue(map['protocol'] as String)),
      ...
      sessionAffinity: map['sessionAffinity'] == null ? null : pulumi.Output.create<BackendServiceSessionAffinity>(BackendServiceSessionAffinity.fromValue(map['sessionAffinity'] as String)),
      ...
      vpcNetworkScope: map['vpcNetworkScope'] == null ? null : pulumi.Output.create<BackendServiceVpcNetworkScope>(BackendServiceVpcNetworkScope.fromValue(map['vpcNetworkScope'] as String)),
    );
  }
}
