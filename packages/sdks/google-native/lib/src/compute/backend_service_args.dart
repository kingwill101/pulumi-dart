...
class BackendServiceArgs {
  ...
  factory BackendServiceArgs.fromMap(Map<String, dynamic> map) {
    return BackendServiceArgs(
      ...
      circuitBreakers: map['circuitBreakers'] == null ? null : (CircuitBreakers.fromMap((map['circuitBreakers'] as Map).cast<String, dynamic>())).input(),
      compressionMode: map['compressionMode'] == null ? null : (BackendServiceCompressionMode.fromValue(map['compressionMode'] as String)).input(),
      connectionDraining: map['connectionDraining'] == null ? null : (ConnectionDraining.fromMap((map['connectionDraining'] as Map).cast<String, dynamic>())).input(),
      connectionTrackingPolicy: map['connectionTrackingPolicy'] == null ? null : (BackendServiceConnectionTrackingPolicy.fromMap((map['connectionTrackingPolicy'] as Map).cast<String, dynamic>())).input(),
      consistentHash: map['consistentHash'] == null ? null : (ConsistentHashLoadBalancerSettings.fromMap((map['consistentHash'] as Map).cast<String, dynamic>())).input(),
      ...
      failoverPolicy: map['failoverPolicy'] == null ? null : (BackendServiceFailoverPolicy.fromMap((map['failoverPolicy'] as Map).cast<String, dynamic>())).input(),
      ...
      ipAddressSelectionPolicy: map['ipAddressSelectionPolicy'] == null ? null : (BackendServiceIpAddressSelectionPolicy.fromValue(map['ipAddressSelectionPolicy'] as String)).input(),
      loadBalancingScheme: map['loadBalancingScheme'] == null ? null : (BackendServiceLoadBalancingScheme.fromValue(map['loadBalancingScheme'] as String)).input(),
      localityLbPolicies: map['localityLbPolicies'] == null ? null : (pulumi.Input.decodeList<BackendServiceLocalityLoadBalancingPolicyConfig>(map['localityLbPolicies'], (value) => BackendServiceLocalityLoadBalancingPolicyConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
      localityLbPolicy: map['localityLbPolicy'] == null ? null : (BackendServiceLocalityLbPolicy.fromValue(map['localityLbPolicy'] as String)).input(),
      logConfig: map['logConfig'] == null ? null : (BackendServiceLogConfig.fromMap((map['logConfig'] as Map).cast<String, dynamic>())).input(),
      maxStreamDuration: map['maxStreamDuration'] == null ? null : (Duration.fromMap((map['maxStreamDuration'] as Map).cast<String, dynamic>())).input(),
      metadatas: map['metadatas'] == null ? null : ((map['metadatas'] as Map).cast<String, String>()).input(),
      name: map['name'] == null ? null : (map['name'] as String).input(),
      network: map['network'] == null ? null : (map['network'] as String).input(),
      outlierDetection: map['outlierDetection'] == null ? null : (OutlierDetection.fromMap((map['outlierDetection'] as Map).cast<String, dynamic>())).input(),
      port: map['port'] == null ? null : (map['port'] as int).input(),
      portName: map['portName'] == null ? null : (map['portName'] as String).input(),
      project: map['project'] == null ? null : (map['project'] as String).input(),
      protocol: map['protocol'] == null ? null : (BackendServiceProtocol.fromValue(map['protocol'] as String)).input(),
      ...
      sessionAffinity: map['sessionAffinity'] == null ? null : (BackendServiceSessionAffinity.fromValue(map['sessionAffinity'] as String)).input(),
      subsetting: map['subsetting'] == null ? null : (Subsetting.fromMap((map['subsetting'] as Map).cast<String, dynamic>())).input(),
      timeoutSec: map['timeoutSec'] == null ? null : (map['timeoutSec'] as int).input(),
      usedBy: map['usedBy'] == null ? null : (pulumi.Input.decodeList<BackendServiceUsedBy>(map['usedBy'], (value) => BackendServiceUsedBy.fromMap((value as Map).cast<String, dynamic>()))).input(),
      vpcNetworkScope: map['vpcNetworkScope'] == null ? null : (BackendServiceVpcNetworkScope.fromValue(map['vpcNetworkScope'] as String)).input(),
    );
  }
}
