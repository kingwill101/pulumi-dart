...
class NetworkInterface {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'networkIP': ?networkIP,
      'nicType':
          ?pulumi.Input.mapOptionalInputValue<NetworkInterfaceNicType, String>(
            nicType,
      ...
      'subinterfaces':
          ?pulumi.Input.mapOptionalInputValue<
            List<NetworkInterfaceSubInterface>,
            List<Map<String, dynamic>>
          >(
            subinterfaces,
            (value) =>
  ...
  factory NetworkInterface.fromMap(Map<String, dynamic> map) {
    return NetworkInterface(
      ...
      nicType: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          NetworkInterfaceNicType.fromValue(guardedValue as String),
        );
      })(),
      parentNicName: (() {
        final guardedValue = map['parentNicName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      queueCount: (() {
      ...
      stackType: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          NetworkInterfaceStackType.fromValue(guardedValue as String),
        );
      })(),
      subinterfaces: (() {
        final guardedValue = map['subinterfaces'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
