...
class RegionNetworkEndpointGroup extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [RegionNetworkEndpointGroup]. {@macro pulumi_compute_alpha_region_network_endpoint_group_args_doc}
  ...
  RegionNetworkEndpointGroup(
    ...
    this.appEngine = registerOutput<NetworkEndpointGroupAppEngineResponse>('appEngine');
    this.clientPortMappingMode = registerOutput<String>('clientPortMappingMode');
    this.cloudFunction = registerOutput<NetworkEndpointGroupCloudFunctionResponse>('cloudFunction');
    this.cloudRun = registerOutput<NetworkEndpointGroupCloudRunResponse>('cloudRun');
    this.creationTimestamp = registerOutput<String>('creationTimestamp');
    this.defaultPort = registerOutput<int>('defaultPort');
    this.description = registerOutput<String>('description');
    this.kind = registerOutput<String>('kind');
    this.loadBalancer = registerOutput<NetworkEndpointGroupLbNetworkEndpointGroupResponse>('loadBalancer');
    this.name = registerOutput<String>('name');
    this.network = registerOutput<String>('network');
    this.networkEndpointType = registerOutput<String>('networkEndpointType');
    this.project = registerOutput<String>('project');
    this.pscData = registerOutput<NetworkEndpointGroupPscDataResponse>('pscData');
    this.pscTargetService = registerOutput<String>('pscTargetService');
    this.region = registerOutput<String>('region');
    this.requestId = registerOutput<String?>('requestId');
    this.selfLink = registerOutput<String>('selfLink');
    this.selfLinkWithId = registerOutput<String>('selfLinkWithId');
    this.serverlessDeployment = registerOutput<NetworkEndpointGroupServerlessDeploymentResponse>('serverlessDeployment');
