...
class AttachedDisk {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'interface':
          ?pulumi.Input.mapOptionalInputValue<AttachedDiskInterface, String>(
            interface,
            (value) => value.wireValue,
          ),
      'mode': ?pulumi.Input.mapOptionalInputValue<AttachedDiskMode, String>(
        mode,
        (value) => value.wireValue,
      ),
      'savedState':
          ?pulumi.Input.mapOptionalInputValue<AttachedDiskSavedState, String>(
            savedState,
            (value) => value.wireValue,
          ),
      'source': ?source,
      'type': ?pulumi.Input.mapOptionalInputValue<AttachedDiskType, String>(
        type,
        (value) => value.wireValue,
      ),
    };
  ...
  factory AttachedDisk.fromMap(Map<String, dynamic> map) {
    return AttachedDisk(
      ...
      interface: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AttachedDiskInterface.fromValue(guardedValue as String),
        );
      })(),
      mode: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AttachedDiskMode.fromValue(guardedValue as String),
        );
      })(),
      savedState: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AttachedDiskSavedState.fromValue(guardedValue as String),
        );
      })(),
      source: (() {
      ...
      type: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AttachedDiskType.fromValue(guardedValue as String),
        );
      })(),
    );
  }
