...
class AttachedDisk {
  ...
  factory AttachedDisk.fromMap(Map<String, dynamic> map) {
    return AttachedDisk(
      ...
      initializeParams: map['initializeParams'] == null ? null : AttachedDiskInitializeParams.fromMap((map['initializeParams'] as Map).cast<String, dynamic>()),
      interface: map['interface'] == null ? null : AttachedDiskInterface.fromValue(map['interface'] as String),
      mode: map['mode'] == null ? null : AttachedDiskMode.fromValue(map['mode'] as String),
      savedState: map['savedState'] == null ? null : AttachedDiskSavedState.fromValue(map['savedState'] as String),
      source: map['source'] == null ? null : map['source'] as String,
      type: map['type'] == null ? null : AttachedDiskType.fromValue(map['type'] as String),
    );
  }
}
