...
import 'backend_bucket_cdn_policy_response.dart';
...
class BackendBucket extends pulumi.CustomResource {
  ...
  late final pulumi.Output<BackendBucketCdnPolicyResponse> cdnPolicy;
  ...
  /// [args] Arguments used to configure this [BackendBucket]. {@macro pulumi_compute_alpha_backend_bucket_args_doc}
  ...
  BackendBucket(
    ...
    cdnPolicy = registerOutput<BackendBucketCdnPolicyResponse>('cdnPolicy', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return BackendBucketCdnPolicyResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
