...
class HttpRouteRuleResponseComputeV1 {
  ...
  final pulumi.Input<List<HttpRouteRuleMatchResponseComputeV1>> matchRules;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'matchRules': pulumi.Input.mapInputValue<List<HttpRouteRuleMatchResponseComputeV1>, List<Map<String, dynamic>>>(matchRules, (value) => pulumi.Input.encodeList<HttpRouteRuleMatchResponseComputeV1, Map<String, dynamic>>(value, (value) => value.toMap())),
      'priority': priority,
      'routeAction': pulumi.Input.mapInputValue<HttpRouteActionResponseComputeV1, Map<String, dynamic>>(routeAction, (value) => value.toMap()),
      'service': service,
      'urlRedirect': pulumi.Input.mapInputValue<HttpRedirectActionResponseComputeV1, Map<String, dynamic>>(urlRedirect, (value) => value.toMap()),
    };
  }
  ...
  factory HttpRouteRuleResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return HttpRouteRuleResponseComputeV1(
      ...
      headerAction: (HttpHeaderActionResponseComputeV1.fromMap((map['headerAction'] as Map).cast<String, dynamic>())).input(),
      matchRules: (pulumi.Input.decodeList<HttpRouteRuleMatchResponseComputeV1>(map['matchRules'], (value) => HttpRouteRuleMatchResponseComputeV1.fromMap((value as Map).cast<String, dynamic>()))).input(),
      priority: (map['priority'] as int).input(),
      routeAction: (HttpRouteActionResponseComputeV1.fromMap((map['routeAction'] as Map).cast<String, dynamic>())).input(),
      service: (map['service'] as String).input(),
      urlRedirect: (HttpRedirectActionResponseComputeV1.fromMap((map['urlRedirect'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
