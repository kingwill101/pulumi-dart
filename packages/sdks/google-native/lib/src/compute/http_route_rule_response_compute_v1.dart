...
class HttpRouteRuleResponseComputeV1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'matchRules':
          pulumi.Input.mapInputValue<
            List<HttpRouteRuleMatchResponseComputeV1>,
  ...
  factory HttpRouteRuleResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return HttpRouteRuleResponseComputeV1(
      ...
      headerAction: pulumi.Input.fromValue(
        HttpHeaderActionResponseComputeV1.fromMap(
          (map['headerAction']! as Map).cast<String, dynamic>(),
        ),
      ),
      matchRules: pulumi.Input.fromValue(
        pulumi.Input.decodeList<HttpRouteRuleMatchResponseComputeV1>(
          map['matchRules']!,
          (value) => HttpRouteRuleMatchResponseComputeV1.fromMap(
