...
class PacketMirroringFilterComputeV1 {
  ...
  const PacketMirroringFilterComputeV1({
    this.cidrRanges,
    this.direction,
    this.ipProtocols,
  });
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'direction': ?pulumi.Input.mapOptionalInputValue<PacketMirroringFilterDirectionComputeV1, String>(direction, (value) => value.wireValue),
  ...
  factory PacketMirroringFilterComputeV1.fromMap(Map<String, dynamic> map) {
    return PacketMirroringFilterComputeV1(
      ...
      direction: (() { final guardedValue = map['direction']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PacketMirroringFilterDirectionComputeV1.fromValue(guardedValue as String)); })(),
