...
class AutoscalingPolicy {
  ...
  final pulumi.Input<List<AutoscalingPolicyCustomMetricUtilization>>?
  customMetricUtilizations;

  /// Configuration parameters of autoscaling based on load balancer.
  final pulumi.Input<AutoscalingPolicyLoadBalancingUtilization>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'mode':
          ?pulumi.Input.mapOptionalInputValue<AutoscalingPolicyMode, String>(
            mode,
  ...
  factory AutoscalingPolicy.fromMap(Map<String, dynamic> map) {
    return AutoscalingPolicy(
      ...
      mode: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AutoscalingPolicyMode.fromValue(guardedValue as String),
        );
      })(),
      scaleDownControl: (() {
