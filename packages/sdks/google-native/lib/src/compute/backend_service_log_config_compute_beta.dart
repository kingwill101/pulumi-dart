...
class BackendServiceLogConfigComputeBeta {
  ...
  final pulumi.Input<BackendServiceLogConfigOptionalModeComputeBeta>? optionalMode;
  /// This field can only be specified if logging is enabled for this backend service. The value of the field must be in [0, 1]. This configures the sampling rate of requests to the load balancer where 1.0 means all logged requests are reported and 0.0 means no logged requests are reported. The default value is 1.0.
  final pulumi.Input<double>? sampleRate;

  /// Creates a new [BackendServiceLogConfigComputeBeta].
  ...
  const BackendServiceLogConfigComputeBeta({
    this.enable,
    this.optionalFields,
    this.optionalMode,
    this.sampleRate,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'optionalMode': ?pulumi.Input.mapOptionalInputValue<BackendServiceLogConfigOptionalModeComputeBeta, String>(optionalMode, (value) => value.wireValue),
  ...
  factory BackendServiceLogConfigComputeBeta.fromMap(Map<String, dynamic> map) {
    return BackendServiceLogConfigComputeBeta(
      ...
      optionalMode: (() { final guardedValue = map['optionalMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BackendServiceLogConfigOptionalModeComputeBeta.fromValue(guardedValue as String)); })(),
