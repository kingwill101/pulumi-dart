...
class HttpRouteRuleComputeBeta {
  ...
  final pulumi.Input<List<HttpFilterConfigComputeBeta>>? httpFilterConfigs;
  ...
  final pulumi.Input<List<HttpFilterConfigComputeBeta>>? httpFilterMetadata;
  /// The list of criteria for matching attributes of a request to this routeRule. This list has OR semantics: the request matches this routeRule when any of the matchRules are satisfied. However predicates within a given matchRule have AND semantics. All predicates within a matchRule must match for the request to match the rule.
  final pulumi.Input<List<HttpRouteRuleMatchComputeBeta>>? matchRules;
  ...
  const HttpRouteRuleComputeBeta({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'httpFilterConfigs': ?pulumi.Input.mapOptionalInputValue<List<HttpFilterConfigComputeBeta>, List<Map<String, dynamic>>>(httpFilterConfigs, (value) => pulumi.Input.encodeList<HttpFilterConfigComputeBeta, Map<String, dynamic>>(value, (value) => value.toMap())),
      'httpFilterMetadata': ?pulumi.Input.mapOptionalInputValue<List<HttpFilterConfigComputeBeta>, List<Map<String, dynamic>>>(httpFilterMetadata, (value) => pulumi.Input.encodeList<HttpFilterConfigComputeBeta, Map<String, dynamic>>(value, (value) => value.toMap())),
      'matchRules': ?pulumi.Input.mapOptionalInputValue<List<HttpRouteRuleMatchComputeBeta>, List<Map<String, dynamic>>>(matchRules, (value) => pulumi.Input.encodeList<HttpRouteRuleMatchComputeBeta, Map<String, dynamic>>(value, (value) => value.toMap())),
      'priority': ?priority,
  ...
  factory HttpRouteRuleComputeBeta.fromMap(Map<String, dynamic> map) {
    return HttpRouteRuleComputeBeta(
      customErrorResponsePolicy: (() { final guardedValue = map['customErrorResponsePolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CustomErrorResponsePolicyComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      httpFilterConfigs: (() { final guardedValue = map['httpFilterConfigs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<HttpFilterConfigComputeBeta>(guardedValue, (value) => HttpFilterConfigComputeBeta.fromMap((value as Map).cast<String, dynamic>()))); })(),
      httpFilterMetadata: (() { final guardedValue = map['httpFilterMetadata']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<HttpFilterConfigComputeBeta>(guardedValue, (value) => HttpFilterConfigComputeBeta.fromMap((value as Map).cast<String, dynamic>()))); })(),
      matchRules: (() { final guardedValue = map['matchRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<HttpRouteRuleMatchComputeBeta>(guardedValue, (value) => HttpRouteRuleMatchComputeBeta.fromMap((value as Map).cast<String, dynamic>()))); })(),
      priority: (() { final guardedValue = map['priority']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      routeAction: (() { final guardedValue = map['routeAction']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HttpRouteActionComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      service: (() { final guardedValue = map['service']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      urlRedirect: (() { final guardedValue = map['urlRedirect']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HttpRedirectActionComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
