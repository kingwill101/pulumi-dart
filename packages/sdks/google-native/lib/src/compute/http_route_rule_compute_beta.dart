...
class HttpRouteRuleComputeBeta {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'httpFilterConfigs': ?httpFilterConfigs == null ? null : pulumi.Input.encodeList<HttpFilterConfigComputeBeta, Map<String, dynamic>>(httpFilterConfigs!, (value) => value.toMap()),
      'httpFilterMetadata': ?httpFilterMetadata == null ? null : pulumi.Input.encodeList<HttpFilterConfigComputeBeta, Map<String, dynamic>>(httpFilterMetadata!, (value) => value.toMap()),
      'matchRules': ?matchRules == null ? null : pulumi.Input.encodeList<HttpRouteRuleMatchComputeBeta, Map<String, dynamic>>(matchRules!, (value) => value.toMap()),
      'priority': ?priority,
  ...
  factory HttpRouteRuleComputeBeta.fromMap(Map<String, dynamic> map) {
    return HttpRouteRuleComputeBeta(
      customErrorResponsePolicy: map['customErrorResponsePolicy'] == null ? null : CustomErrorResponsePolicyComputeBeta.fromMap((map['customErrorResponsePolicy'] as Map).cast<String, dynamic>()),
      ...
      httpFilterConfigs: map['httpFilterConfigs'] == null ? null : pulumi.Input.decodeList<HttpFilterConfigComputeBeta>(map['httpFilterConfigs'], (value) => HttpFilterConfigComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      httpFilterMetadata: map['httpFilterMetadata'] == null ? null : pulumi.Input.decodeList<HttpFilterConfigComputeBeta>(map['httpFilterMetadata'], (value) => HttpFilterConfigComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      matchRules: map['matchRules'] == null ? null : pulumi.Input.decodeList<HttpRouteRuleMatchComputeBeta>(map['matchRules'], (value) => HttpRouteRuleMatchComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      priority: map['priority'] == null ? null : map['priority'] as int,
      routeAction: map['routeAction'] == null ? null : HttpRouteActionComputeBeta.fromMap((map['routeAction'] as Map).cast<String, dynamic>()),
      service: map['service'] == null ? null : map['service'] as String,
      urlRedirect: map['urlRedirect'] == null ? null : HttpRedirectActionComputeBeta.fromMap((map['urlRedirect'] as Map).cast<String, dynamic>()),
    );
  }
}
