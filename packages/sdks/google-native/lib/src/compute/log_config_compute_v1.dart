...
class LogConfigComputeV1 {
  ...
  factory LogConfigComputeV1.fromMap(Map<String, dynamic> map) {
    return LogConfigComputeV1(
      cloudAudit: (() { final guardedValue = map['cloudAudit']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LogConfigCloudAuditOptionsComputeV1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      counter: (() { final guardedValue = map['counter']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LogConfigCounterOptionsComputeV1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      dataAccess: (() { final guardedValue = map['dataAccess']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LogConfigDataAccessOptionsComputeV1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
