...
class GetPublicAdvertisedPrefixResult {
  ...
  final List<PublicAdvertisedPrefixPublicDelegatedPrefixResponse> publicDelegatedPrefixs;
  ...
  /// Creates a new [GetPublicAdvertisedPrefixResult].
  ...
  const GetPublicAdvertisedPrefixResult({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': name,
      'pdpScope': pdpScope,
      'publicDelegatedPrefixs': pulumi.Input.encodeList<PublicAdvertisedPrefixPublicDelegatedPrefixResponse, Map<String, dynamic>>(publicDelegatedPrefixs, (value) => value.toMap()),
      'selfLink': selfLink,
  ...
  factory GetPublicAdvertisedPrefixResult.fromMap(Map<String, dynamic> map) {
    return GetPublicAdvertisedPrefixResult(
      ...
      publicDelegatedPrefixs: pulumi.Input.decodeList<PublicAdvertisedPrefixPublicDelegatedPrefixResponse>(map['publicDelegatedPrefixs']!, (value) => PublicAdvertisedPrefixPublicDelegatedPrefixResponse.fromMap((value as Map).cast<String, dynamic>())),
