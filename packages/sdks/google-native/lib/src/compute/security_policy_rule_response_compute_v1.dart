...
class SecurityPolicyRuleResponseComputeV1 {
  ...
  factory SecurityPolicyRuleResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRuleResponseComputeV1(
      ...
      headerAction: (SecurityPolicyRuleHttpHeaderActionResponseComputeV1.fromMap((map['headerAction'] as Map).cast<String, dynamic>())).input(),
      kind: (map['kind'] as String).input(),
      match: (SecurityPolicyRuleMatcherResponseComputeV1.fromMap((map['match'] as Map).cast<String, dynamic>())).input(),
      networkMatch: (SecurityPolicyRuleNetworkMatcherResponseComputeV1.fromMap((map['networkMatch'] as Map).cast<String, dynamic>())).input(),
      preconfiguredWafConfig: (SecurityPolicyRulePreconfiguredWafConfigResponseComputeV1.fromMap((map['preconfiguredWafConfig'] as Map).cast<String, dynamic>())).input(),
      preview: (map['preview'] as bool).input(),
      priority: (map['priority'] as int).input(),
      rateLimitOptions: (SecurityPolicyRuleRateLimitOptionsResponseComputeV1.fromMap((map['rateLimitOptions'] as Map).cast<String, dynamic>())).input(),
      redirectOptions: (SecurityPolicyRuleRedirectOptionsResponseComputeV1.fromMap((map['redirectOptions'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
