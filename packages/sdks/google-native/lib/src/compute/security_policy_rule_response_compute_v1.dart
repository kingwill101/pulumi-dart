...
class SecurityPolicyRuleResponseComputeV1 {
  ...
  final pulumi.Input<SecurityPolicyRuleHttpHeaderActionResponseComputeV1>
  headerAction;
  ...
  final pulumi.Input<SecurityPolicyRuleNetworkMatcherResponseComputeV1>
  networkMatch;

  /// Preconfigured WAF configuration to be applied for the rule. If the rule does not evaluate preconfigured WAF rules, i.e., if evaluatePreconfiguredWaf() is not used, this field will have no effect.
  final pulumi.Input<SecurityPolicyRulePreconfiguredWafConfigResponseComputeV1>
  ...
  final pulumi.Input<SecurityPolicyRuleRateLimitOptionsResponseComputeV1>
  rateLimitOptions;

  /// Parameters defining the redirect action. Cannot be specified for any other actions. This field is only supported in Global Security Policies of type CLOUD_ARMOR.
  final pulumi.Input<SecurityPolicyRuleRedirectOptionsResponseComputeV1>
  redirectOptions;
  ...
  factory SecurityPolicyRuleResponseComputeV1.fromMap(
    ...
    return SecurityPolicyRuleResponseComputeV1(
      ...
      headerAction: pulumi.Input.fromValue(
        SecurityPolicyRuleHttpHeaderActionResponseComputeV1.fromMap(
          (map['headerAction']! as Map).cast<String, dynamic>(),
        ),
      ),
      kind: pulumi.Input.fromValue(map['kind'] as String),
      match: pulumi.Input.fromValue(
        SecurityPolicyRuleMatcherResponseComputeV1.fromMap(
          (map['match']! as Map).cast<String, dynamic>(),
        ),
      ),
      networkMatch: pulumi.Input.fromValue(
        SecurityPolicyRuleNetworkMatcherResponseComputeV1.fromMap(
