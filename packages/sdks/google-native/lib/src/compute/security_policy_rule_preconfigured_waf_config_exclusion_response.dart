...
class SecurityPolicyRulePreconfiguredWafConfigExclusionResponse {
  ...
  final pulumi.Input<List<SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParamsResponse>> requestCookiesToExclude;
  /// A list of request header names whose value will be excluded from inspection during preconfigured WAF evaluation.
  final pulumi.Input<List<SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParamsResponse>> requestHeadersToExclude;
  /// A list of request query parameter names whose value will be excluded from inspection during preconfigured WAF evaluation. Note that the parameter can be in the query string or in the POST body.
  final pulumi.Input<List<SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParamsResponse>> requestQueryParamsToExclude;
  /// A list of request URIs from the request line to be excluded from inspection during preconfigured WAF evaluation. When specifying this field, the query or fragment part should be excluded.
  final pulumi.Input<List<SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParamsResponse>> requestUrisToExclude;
  ...
  const SecurityPolicyRulePreconfiguredWafConfigExclusionResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'requestUrisToExclude': pulumi.Input.mapInputValue<List<SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParamsResponse>, List<Map<String, dynamic>>>(requestUrisToExclude, (value) => pulumi.Input.encodeList<SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParamsResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory SecurityPolicyRulePreconfiguredWafConfigExclusionResponse.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRulePreconfiguredWafConfigExclusionResponse(
      requestCookiesToExclude: pulumi.Input.fromValue(pulumi.Input.decodeList<SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParamsResponse>(map['requestCookiesToExclude']!, (value) => SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParamsResponse.fromMap((value as Map).cast<String, dynamic>()))),
      requestHeadersToExclude: pulumi.Input.fromValue(pulumi.Input.decodeList<SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParamsResponse>(map['requestHeadersToExclude']!, (value) => SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParamsResponse.fromMap((value as Map).cast<String, dynamic>()))),
      requestQueryParamsToExclude: pulumi.Input.fromValue(pulumi.Input.decodeList<SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParamsResponse>(map['requestQueryParamsToExclude']!, (value) => SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParamsResponse.fromMap((value as Map).cast<String, dynamic>()))),
      requestUrisToExclude: pulumi.Input.fromValue(pulumi.Input.decodeList<SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParamsResponse>(map['requestUrisToExclude']!, (value) => SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParamsResponse.fromMap((value as Map).cast<String, dynamic>()))),
