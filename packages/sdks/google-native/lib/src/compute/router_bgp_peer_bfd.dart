...
class RouterBgpPeerBfd {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'mode': ?pulumi.Input.mapOptionalInputValue<RouterBgpPeerBfdMode, String>(mode, (value) => value.wireValue),
      'multiplier': ?multiplier,
      'packetMode': ?pulumi.Input.mapOptionalInputValue<RouterBgpPeerBfdPacketMode, String>(packetMode, (value) => value.wireValue),
      'sessionInitializationMode': ?pulumi.Input.mapOptionalInputValue<RouterBgpPeerBfdSessionInitializationMode, String>(sessionInitializationMode, (value) => value.wireValue),
  ...
  factory RouterBgpPeerBfd.fromMap(Map<String, dynamic> map) {
    return RouterBgpPeerBfd(
      ...
      mode: (() { final guardedValue = map['mode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RouterBgpPeerBfdMode.fromValue(guardedValue as String)); })(),
      ...
      packetMode: (() { final guardedValue = map['packetMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RouterBgpPeerBfdPacketMode.fromValue(guardedValue as String)); })(),
      sessionInitializationMode: (() { final guardedValue = map['sessionInitializationMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RouterBgpPeerBfdSessionInitializationMode.fromValue(guardedValue as String)); })(),
      slowTimerInterval: (() { final guardedValue = map['slowTimerInterval']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
    );
  }
}
