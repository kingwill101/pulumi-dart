...
class RouterBgpPeerBfd {
  ...
  final pulumi.Input<RouterBgpPeerBfdSessionInitializationMode>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'mode': ?pulumi.Input.mapOptionalInputValue<RouterBgpPeerBfdMode, String>(
        mode,
      ...
      'packetMode':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(packetMode, (value) => value.wireValue),
      'sessionInitializationMode':
          ?pulumi.Input.mapOptionalInputValue<
    ...
    return RouterBgpPeerBfd(
      ...
      mode: (() {
        ...
        return pulumi.Input.fromValue(
          RouterBgpPeerBfdMode.fromValue(guardedValue as String),
        );
      })(),
      multiplier: (() {
      ...
      packetMode: (() {
        final guardedValue = map['packetMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RouterBgpPeerBfdPacketMode.fromValue(guardedValue as String),
        );
      })(),
      sessionInitializationMode: (() {
      ...
      slowTimerInterval: (() {
        final guardedValue = map['slowTimerInterval'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
    );
