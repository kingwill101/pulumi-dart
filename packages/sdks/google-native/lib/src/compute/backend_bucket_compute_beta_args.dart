...
class BackendBucketComputeBetaArgs {
  ...
  BackendBucketComputeBetaArgs({
    ...
    pulumi.Output<BackendBucketCdnPolicyComputeBeta>? cdnPolicy,
    pulumi.Output<BackendBucketCompressionModeComputeBeta>? compressionMode,
    ...
    pulumi.Output<String>? requestId,
      ...
      cdnPolicy = pulumi.Input.asOptionalInput<BackendBucketCdnPolicyComputeBeta>(cdnPolicy),
      compressionMode = pulumi.Input.asOptionalInput<BackendBucketCompressionModeComputeBeta>(compressionMode),
  ...
  factory BackendBucketComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return BackendBucketComputeBetaArgs(
      ...
      cdnPolicy: map['cdnPolicy'] == null ? null : pulumi.Output.create<BackendBucketCdnPolicyComputeBeta>(BackendBucketCdnPolicyComputeBeta.fromMap((map['cdnPolicy'] as Map).cast<String, dynamic>())),
      compressionMode: map['compressionMode'] == null ? null : pulumi.Output.create<BackendBucketCompressionModeComputeBeta>(BackendBucketCompressionModeComputeBeta.fromValue(map['compressionMode'] as String)),
