...
class BackendBucketComputeBetaArgs {
  ...
  const BackendBucketComputeBetaArgs({
    this.bucketName,
    this.cdnPolicy,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'compressionMode': ?pulumi.Input.mapOptionalInputValue<BackendBucketCompressionModeComputeBeta, String>(compressionMode, (value) => value.wireValue),
  ...
  factory BackendBucketComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return BackendBucketComputeBetaArgs(
      ...
      cdnPolicy: (() { final guardedValue = map['cdnPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BackendBucketCdnPolicyComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      compressionMode: (() { final guardedValue = map['compressionMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BackendBucketCompressionModeComputeBeta.fromValue(guardedValue as String)); })(),
