...
class GetRegionNotificationEndpointComputeV1Result {
  /// Creation timestamp in RFC3339 text format.
  final String creationTimestamp;
  /// An optional description of this resource. Provide this property when you create the resource.
  final String description;
  /// Settings of the gRPC notification endpoint including the endpoint URL and the retry duration.
  final NotificationEndpointGrpcSettingsResponseComputeV1 grpcSettings;
  ...
  /// Creates a new [GetRegionNotificationEndpointComputeV1Result].
  ...
  const GetRegionNotificationEndpointComputeV1Result({
  ...
  factory GetRegionNotificationEndpointComputeV1Result.fromMap(Map<String, dynamic> map) {
    return GetRegionNotificationEndpointComputeV1Result(
      creationTimestamp: map['creationTimestamp'] as String,
      description: map['description'] as String,
      grpcSettings: NotificationEndpointGrpcSettingsResponseComputeV1.fromMap((map['grpcSettings']! as Map).cast<String, dynamic>()),
