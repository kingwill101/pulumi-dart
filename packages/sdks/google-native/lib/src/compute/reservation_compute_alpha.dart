...
class ReservationComputeAlpha extends pulumi.CustomResource {
  ...
  ReservationComputeAlpha(
    ...
    this.aggregateReservation = registerOutput<AllocationAggregateReservationResponse>('aggregateReservation');
    this.commitment = registerOutput<String>('commitment');
    this.creationTimestamp = registerOutput<String>('creationTimestamp');
    this.deleteAfterDuration = registerOutput<DurationResponse>('deleteAfterDuration');
    ...
    this.resourceStatus = registerOutput<AllocationResourceStatusResponse>('resourceStatus');
    ...
    this.specificReservation = registerOutput<AllocationSpecificSKUReservationResponse>('specificReservation');
