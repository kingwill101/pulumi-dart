...
class ReservationComputeAlpha extends pulumi.CustomResource {
  ...
  late final pulumi.Output<AllocationAggregateReservationResponse> aggregateReservation;
  ...
  late final pulumi.Output<AllocationSpecificSKUReservationResponse> specificReservation;
  ...
  ReservationComputeAlpha(
    ...
    aggregateReservation = registerOutput<AllocationAggregateReservationResponse>('aggregateReservation', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return AllocationAggregateReservationResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    commitment = registerOutput<String>('commitment');
    creationTimestamp = registerOutput<String>('creationTimestamp');
    deleteAfterDuration = registerOutput<DurationResponse>('deleteAfterDuration', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return DurationResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    resourceStatus = registerOutput<AllocationResourceStatusResponse>('resourceStatus', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return AllocationResourceStatusResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    satisfiesPzs = registerOutput<bool>('satisfiesPzs');
    selfLink = registerOutput<String>('selfLink');
    selfLinkWithId = registerOutput<String>('selfLinkWithId');
    shareSettings = registerOutput<ShareSettingsResponse>('shareSettings', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ShareSettingsResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    specificReservation = registerOutput<AllocationSpecificSKUReservationResponse>('specificReservation', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return AllocationSpecificSKUReservationResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
