...
class HealthCheckComputeBetaArgs {
  ...
  factory HealthCheckComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return HealthCheckComputeBetaArgs(
      ...
      grpcHealthCheck: map['grpcHealthCheck'] == null ? null : (GRPCHealthCheckComputeBeta.fromMap((map['grpcHealthCheck'] as Map).cast<String, dynamic>())).input(),
      healthyThreshold: map['healthyThreshold'] == null ? null : (map['healthyThreshold'] as int).input(),
      http2HealthCheck: map['http2HealthCheck'] == null ? null : (HTTP2HealthCheckComputeBeta.fromMap((map['http2HealthCheck'] as Map).cast<String, dynamic>())).input(),
      httpHealthCheck: map['httpHealthCheck'] == null ? null : (HTTPHealthCheckComputeBeta.fromMap((map['httpHealthCheck'] as Map).cast<String, dynamic>())).input(),
      httpsHealthCheck: map['httpsHealthCheck'] == null ? null : (HTTPSHealthCheckComputeBeta.fromMap((map['httpsHealthCheck'] as Map).cast<String, dynamic>())).input(),
      kind: map['kind'] == null ? null : (map['kind'] as String).input(),
      logConfig: map['logConfig'] == null ? null : (HealthCheckLogConfigComputeBeta.fromMap((map['logConfig'] as Map).cast<String, dynamic>())).input(),
      name: map['name'] == null ? null : (map['name'] as String).input(),
      project: map['project'] == null ? null : (map['project'] as String).input(),
      requestId: map['requestId'] == null ? null : (map['requestId'] as String).input(),
      sslHealthCheck: map['sslHealthCheck'] == null ? null : (SSLHealthCheckComputeBeta.fromMap((map['sslHealthCheck'] as Map).cast<String, dynamic>())).input(),
      tcpHealthCheck: map['tcpHealthCheck'] == null ? null : (TCPHealthCheckComputeBeta.fromMap((map['tcpHealthCheck'] as Map).cast<String, dynamic>())).input(),
      timeoutSec: map['timeoutSec'] == null ? null : (map['timeoutSec'] as int).input(),
      type: map['type'] == null ? null : (HealthCheckTypeComputeBeta.fromValue(map['type'] as String)).input(),
