...
class NetworkRoutingConfigResponse {
  ...
  factory NetworkRoutingConfigResponse.fromMap(Map<String, dynamic> map) {
    return NetworkRoutingConfigResponse(
      bgpAlwaysCompareMed: (map['bgpAlwaysCompareMed'] as bool).input(),
      bgpBestPathSelectionMode: (map['bgpBestPathSelectionMode'] as String).input(),
      bgpInterRegionCost: (map['bgpInterRegionCost'] as String).input(),
