...
class HTTP2HealthCheckComputeV1 {
  ...
  final pulumi.Input<HTTP2HealthCheckPortSpecificationComputeV1>? portSpecification;
  /// Specifies the type of proxy header to append before sending data to the backend, either NONE or PROXY_V1. The default is NONE.
  final pulumi.Input<HTTP2HealthCheckProxyHeaderComputeV1>? proxyHeader;
  ...
  const HTTP2HealthCheckComputeV1({
    this.host,
    this.port,
    this.portName,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'port': ?port,
      'portName': ?portName,
      'portSpecification': ?pulumi.Input.mapOptionalInputValue<HTTP2HealthCheckPortSpecificationComputeV1, String>(portSpecification, (value) => value.wireValue),
      'proxyHeader': ?pulumi.Input.mapOptionalInputValue<HTTP2HealthCheckProxyHeaderComputeV1, String>(proxyHeader, (value) => value.wireValue),
  ...
  factory HTTP2HealthCheckComputeV1.fromMap(Map<String, dynamic> map) {
    return HTTP2HealthCheckComputeV1(
      ...
      portSpecification: (() { final guardedValue = map['portSpecification']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HTTP2HealthCheckPortSpecificationComputeV1.fromValue(guardedValue as String)); })(),
      proxyHeader: (() { final guardedValue = map['proxyHeader']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HTTP2HealthCheckProxyHeaderComputeV1.fromValue(guardedValue as String)); })(),
