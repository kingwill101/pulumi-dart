...
class HTTP2HealthCheckComputeV1 {
  ...
  factory HTTP2HealthCheckComputeV1.fromMap(Map<String, dynamic> map) {
    return HTTP2HealthCheckComputeV1(
      ...
      portSpecification: map['portSpecification'] == null ? null : HTTP2HealthCheckPortSpecificationComputeV1.fromValue(map['portSpecification'] as String),
      proxyHeader: map['proxyHeader'] == null ? null : HTTP2HealthCheckProxyHeaderComputeV1.fromValue(map['proxyHeader'] as String),
