...
class ForwardingRuleComputeBetaArgs {
  ...
  factory ForwardingRuleComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return ForwardingRuleComputeBetaArgs(
      allPorts: map['allPorts'] == null ? null : (map['allPorts'] as bool).input(),
      allowGlobalAccess: map['allowGlobalAccess'] == null ? null : (map['allowGlobalAccess'] as bool).input(),
      allowPscGlobalAccess: map['allowPscGlobalAccess'] == null ? null : (map['allowPscGlobalAccess'] as bool).input(),
      allowPscPacketInjection: map['allowPscPacketInjection'] == null ? null : (map['allowPscPacketInjection'] as bool).input(),
      backendService: map['backendService'] == null ? null : (map['backendService'] as String).input(),
      description: map['description'] == null ? null : (map['description'] as String).input(),
      ipAddress: map['ipAddress'] == null ? null : (map['ipAddress'] as String).input(),
      ipProtocol: map['ipProtocol'] == null ? null : (ForwardingRuleIpProtocolComputeBeta.fromValue(map['ipProtocol'] as String)).input(),
      ipVersion: map['ipVersion'] == null ? null : (ForwardingRuleIpVersionComputeBeta.fromValue(map['ipVersion'] as String)).input(),
      isMirroringCollector: map['isMirroringCollector'] == null ? null : (map['isMirroringCollector'] as bool).input(),
      labels: map['labels'] == null ? null : ((map['labels'] as Map).cast<String, String>()).input(),
      loadBalancingScheme: map['loadBalancingScheme'] == null ? null : (ForwardingRuleLoadBalancingSchemeComputeBeta.fromValue(map['loadBalancingScheme'] as String)).input(),
      metadataFilters: map['metadataFilters'] == null ? null : (pulumi.Input.decodeList<MetadataFilterComputeBeta>(map['metadataFilters'], (value) => MetadataFilterComputeBeta.fromMap((value as Map).cast<String, dynamic>()))).input(),
      name: map['name'] == null ? null : (map['name'] as String).input(),
      network: map['network'] == null ? null : (map['network'] as String).input(),
      networkTier: map['networkTier'] == null ? null : (ForwardingRuleNetworkTierComputeBeta.fromValue(map['networkTier'] as String)).input(),
      noAutomateDnsZone: map['noAutomateDnsZone'] == null ? null : (map['noAutomateDnsZone'] as bool).input(),
      ...
      pscConnectionStatus: map['pscConnectionStatus'] == null ? null : (ForwardingRulePscConnectionStatusComputeBeta.fromValue(map['pscConnectionStatus'] as String)).input(),
      region: (map['region'] as String).input(),
      requestId: map['requestId'] == null ? null : (map['requestId'] as String).input(),
      serviceDirectoryRegistrations: map['serviceDirectoryRegistrations'] == null ? null : (pulumi.Input.decodeList<ForwardingRuleServiceDirectoryRegistrationComputeBeta>(map['serviceDirectoryRegistrations'], (value) => ForwardingRuleServiceDirectoryRegistrationComputeBeta.fromMap((value as Map).cast<String, dynamic>()))).input(),
      serviceLabel: map['serviceLabel'] == null ? null : (map['serviceLabel'] as String).input(),
      sourceIpRanges: map['sourceIpRanges'] == null ? null : ((map['sourceIpRanges'] as List).cast<String>()).input(),
