...
import 'forwarding_rule_ip_protocol_compute_beta.dart';
import 'forwarding_rule_ip_version_compute_beta.dart';
import 'forwarding_rule_load_balancing_scheme_compute_beta.dart';
import 'forwarding_rule_network_tier_compute_beta.dart';
import 'forwarding_rule_psc_connection_status_compute_beta.dart';
import 'forwarding_rule_service_directory_registration_compute_beta.dart';
import 'metadata_filter_compute_beta.dart';

/// {@template pulumi_compute_beta_forwarding_rule_compute_beta_args_doc}
/// The set of arguments for ForwardingRule.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_forwarding_rule_compute_beta_args_doc}
class ForwardingRuleComputeBetaArgs {
  ...
  final pulumi.Input<ForwardingRuleIpProtocolComputeBeta>? ipProtocol;
  /// The IP Version that will be used by this forwarding rule. Valid options are IPV4 or IPV6.
  final pulumi.Input<ForwardingRuleIpVersionComputeBeta>? ipVersion;
  ...
  final pulumi.Input<ForwardingRuleLoadBalancingSchemeComputeBeta>? loadBalancingScheme;
  ...
  final pulumi.Input<ForwardingRuleNetworkTierComputeBeta>? networkTier;
  ...
  final pulumi.Input<ForwardingRulePscConnectionStatusComputeBeta>? pscConnectionStatus;
  ...
  /// Creates a new [ForwardingRuleComputeBetaArgs].
  ...
  ForwardingRuleComputeBetaArgs({
    pulumi.Output<bool>? allPorts,
    pulumi.Output<bool>? allowGlobalAccess,
    pulumi.Output<bool>? allowPscGlobalAccess,
    pulumi.Output<bool>? allowPscPacketInjection,
    pulumi.Output<String>? backendService,
    pulumi.Output<String>? description,
    pulumi.Output<String>? ipAddress,
    pulumi.Output<ForwardingRuleIpProtocolComputeBeta>? ipProtocol,
    pulumi.Output<ForwardingRuleIpVersionComputeBeta>? ipVersion,
    pulumi.Output<bool>? isMirroringCollector,
    pulumi.Output<Map<String, String>>? labels,
    pulumi.Output<ForwardingRuleLoadBalancingSchemeComputeBeta>? loadBalancingScheme,
    pulumi.Output<List<MetadataFilterComputeBeta>>? metadataFilters,
    pulumi.Output<String>? name,
    pulumi.Output<String>? network,
    pulumi.Output<ForwardingRuleNetworkTierComputeBeta>? networkTier,
    pulumi.Output<bool>? noAutomateDnsZone,
    pulumi.Output<String>? portRange,
    pulumi.Output<List<String>>? ports,
    pulumi.Output<String>? project,
    pulumi.Output<ForwardingRulePscConnectionStatusComputeBeta>? pscConnectionStatus,
    required pulumi.Output<String> region,
    pulumi.Output<String>? requestId,
    pulumi.Output<List<ForwardingRuleServiceDirectoryRegistrationComputeBeta>>? serviceDirectoryRegistrations,
    ...
    pulumi.Output<String>? target,
      ...
      ipProtocol = pulumi.Input.asOptionalInput<ForwardingRuleIpProtocolComputeBeta>(ipProtocol),
      ipVersion = pulumi.Input.asOptionalInput<ForwardingRuleIpVersionComputeBeta>(ipVersion),
      isMirroringCollector = pulumi.Input.asOptionalInput<bool>(isMirroringCollector),
      labels = pulumi.Input.asOptionalInput<Map<String, String>>(labels),
      loadBalancingScheme = pulumi.Input.asOptionalInput<ForwardingRuleLoadBalancingSchemeComputeBeta>(loadBalancingScheme),
      metadataFilters = pulumi.Input.asOptionalInput<List<MetadataFilterComputeBeta>>(metadataFilters),
      name = pulumi.Input.asOptionalInput<String>(name),
      network = pulumi.Input.asOptionalInput<String>(network),
      networkTier = pulumi.Input.asOptionalInput<ForwardingRuleNetworkTierComputeBeta>(networkTier),
      ...
      pscConnectionStatus = pulumi.Input.asOptionalInput<ForwardingRulePscConnectionStatusComputeBeta>(pscConnectionStatus),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ipAddress': ?ipAddress,
      'ipProtocol': ?pulumi.Input.mapOptionalInputValue<ForwardingRuleIpProtocolComputeBeta, String>(ipProtocol, (value) => value.value),
      'ipVersion': ?pulumi.Input.mapOptionalInputValue<ForwardingRuleIpVersionComputeBeta, String>(ipVersion, (value) => value.value),
      'isMirroringCollector': ?isMirroringCollector,
      'labels': ?labels,
      'loadBalancingScheme': ?pulumi.Input.mapOptionalInputValue<ForwardingRuleLoadBalancingSchemeComputeBeta, String>(loadBalancingScheme, (value) => value.value),
      ...
      'name': ?name,
      'network': ?network,
      'networkTier': ?pulumi.Input.mapOptionalInputValue<ForwardingRuleNetworkTierComputeBeta, String>(networkTier, (value) => value.value),
      'noAutomateDnsZone': ?noAutomateDnsZone,
      'portRange': ?portRange,
      'ports': ?ports,
      'project': ?project,
      'pscConnectionStatus': ?pulumi.Input.mapOptionalInputValue<ForwardingRulePscConnectionStatusComputeBeta, String>(pscConnectionStatus, (value) => value.value),
      'region': region,
      'requestId': ?requestId,
  ...
  factory ForwardingRuleComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return ForwardingRuleComputeBetaArgs(
      ...
      allowPscPacketInjection: map['allowPscPacketInjection'] == null ? null : pulumi.Output.create<bool>(map['allowPscPacketInjection'] as bool),
      ...
      ipProtocol: map['ipProtocol'] == null ? null : pulumi.Output.create<ForwardingRuleIpProtocolComputeBeta>(ForwardingRuleIpProtocolComputeBeta.fromValue(map['ipProtocol'] as String)),
      ipVersion: map['ipVersion'] == null ? null : pulumi.Output.create<ForwardingRuleIpVersionComputeBeta>(ForwardingRuleIpVersionComputeBeta.fromValue(map['ipVersion'] as String)),
      ...
      loadBalancingScheme: map['loadBalancingScheme'] == null ? null : pulumi.Output.create<ForwardingRuleLoadBalancingSchemeComputeBeta>(ForwardingRuleLoadBalancingSchemeComputeBeta.fromValue(map['loadBalancingScheme'] as String)),
      metadataFilters: map['metadataFilters'] == null ? null : pulumi.Output.create<List<MetadataFilterComputeBeta>>(pulumi.Input.decodeList<MetadataFilterComputeBeta>(map['metadataFilters'], (value) => MetadataFilterComputeBeta.fromMap((value as Map).cast<String, dynamic>()))),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      network: map['network'] == null ? null : pulumi.Output.create<String>(map['network'] as String),
      networkTier: map['networkTier'] == null ? null : pulumi.Output.create<ForwardingRuleNetworkTierComputeBeta>(ForwardingRuleNetworkTierComputeBeta.fromValue(map['networkTier'] as String)),
      ...
      pscConnectionStatus: map['pscConnectionStatus'] == null ? null : pulumi.Output.create<ForwardingRulePscConnectionStatusComputeBeta>(ForwardingRulePscConnectionStatusComputeBeta.fromValue(map['pscConnectionStatus'] as String)),
      region: pulumi.Output.create<String>(map['region'] as String),
      requestId: map['requestId'] == null ? null : pulumi.Output.create<String>(map['requestId'] as String),
      serviceDirectoryRegistrations: map['serviceDirectoryRegistrations'] == null ? null : pulumi.Output.create<List<ForwardingRuleServiceDirectoryRegistrationComputeBeta>>(pulumi.Input.decodeList<ForwardingRuleServiceDirectoryRegistrationComputeBeta>(map['serviceDirectoryRegistrations'], (value) => ForwardingRuleServiceDirectoryRegistrationComputeBeta.fromMap((value as Map).cast<String, dynamic>()))),
