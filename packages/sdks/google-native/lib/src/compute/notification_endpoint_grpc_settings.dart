...
class NotificationEndpointGrpcSettings {
  ...
  final pulumi.Input<Duration>? resendInterval;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'resendInterval': ?pulumi.Input.mapOptionalInputValue<Duration, Map<String, dynamic>>(resendInterval, (value) => value.toMap()),
  ...
  factory NotificationEndpointGrpcSettings.fromMap(Map<String, dynamic> map) {
    return NotificationEndpointGrpcSettings(
      ...
      resendInterval: (() { final guardedValue = map['resendInterval']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Duration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
