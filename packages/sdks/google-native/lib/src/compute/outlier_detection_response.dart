...
class OutlierDetectionResponse {
  ...
  factory OutlierDetectionResponse.fromMap(Map<String, dynamic> map) {
    return OutlierDetectionResponse(
      baseEjectionTime: DurationResponse.fromMap((map['baseEjectionTime'] as Map).cast<String, dynamic>()),
      ...
      interval: DurationResponse.fromMap((map['interval'] as Map).cast<String, dynamic>()),
