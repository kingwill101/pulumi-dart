...
class OutlierDetectionResponse {
  ...
  final pulumi.Input<DurationResponse> baseEjectionTime;
  ...
  final pulumi.Input<DurationResponse> interval;
  ...
  /// Creates a new [OutlierDetectionResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'baseEjectionTime': pulumi.Input.mapInputValue<DurationResponse, Map<String, dynamic>>(baseEjectionTime, (value) => value.toMap()),
      ...
      'interval': pulumi.Input.mapInputValue<DurationResponse, Map<String, dynamic>>(interval, (value) => value.toMap()),
  ...
  factory OutlierDetectionResponse.fromMap(Map<String, dynamic> map) {
    return OutlierDetectionResponse(
      baseEjectionTime: (DurationResponse.fromMap((map['baseEjectionTime'] as Map).cast<String, dynamic>())).input(),
      consecutiveErrors: (map['consecutiveErrors'] as int).input(),
      consecutiveGatewayFailure: (map['consecutiveGatewayFailure'] as int).input(),
      enforcingConsecutiveErrors: (map['enforcingConsecutiveErrors'] as int).input(),
      enforcingConsecutiveGatewayFailure: (map['enforcingConsecutiveGatewayFailure'] as int).input(),
      enforcingSuccessRate: (map['enforcingSuccessRate'] as int).input(),
      interval: (DurationResponse.fromMap((map['interval'] as Map).cast<String, dynamic>())).input(),
      maxEjectionPercent: (map['maxEjectionPercent'] as int).input(),
      successRateMinimumHosts: (map['successRateMinimumHosts'] as int).input(),
      successRateRequestVolume: (map['successRateRequestVolume'] as int).input(),
      successRateStdevFactor: (map['successRateStdevFactor'] as int).input(),
    );
  }
}
