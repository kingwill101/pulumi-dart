...
/// {@template pulumi_compute_beta_region_backend_service_iam_policy_compute_beta_args_doc}
/// The set of arguments for RegionBackendServiceIamPolicy.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_region_backend_service_iam_policy_compute_beta_args_doc}
class RegionBackendServiceIamPolicyComputeBetaArgs {
  ...
  /// Creates a new [RegionBackendServiceIamPolicyComputeBetaArgs].
  ...
  /// [version] Specifies the format of the policy. Valid values are `0`, `1`, and `3`. Requests that specify an invalid value are rejected. Any operation that affects conditional role bindings must specify version `3`. This requirement applies to the following operations: * Getting a policy that includes a conditional role binding * Adding a conditional role binding to a policy * Changing a conditional role binding in a policy * Removing any role binding, with or without a condition, from a policy that includes conditions **Important:** If you use IAM Conditions, you must include the `etag` field whenever you call `setIamPolicy`. If you omit this field, then IAM allows you to overwrite a version `3` policy with a version `1` policy, and all of the conditions in the version `3` policy are lost. If a policy does not include any conditions, operations on that policy may specify any valid version or leave the field unset. To learn which resources support conditions in their IAM policies, see the [IAM documentation](https://cloud.google.com/iam/help/conditions/resource-policies).
  RegionBackendServiceIamPolicyComputeBetaArgs({
    pulumi.Output<List<AuditConfigComputeBeta>>? auditConfigs,
    pulumi.Output<List<BindingComputeBeta>>? bindings,
    pulumi.Output<String>? etag,
    pulumi.Output<String>? project,
    required pulumi.Output<String> region,
    required pulumi.Output<String> resource,
    pulumi.Output<List<RuleComputeBeta>>? rules,
    pulumi.Output<int>? version,
  }) :
      auditConfigs = pulumi.Input.asOptionalInput<List<AuditConfigComputeBeta>>(auditConfigs),
      bindings = pulumi.Input.asOptionalInput<List<BindingComputeBeta>>(bindings),
      etag = pulumi.Input.asOptionalInput<String>(etag),
      project = pulumi.Input.asOptionalInput<String>(project),
      region = pulumi.Input.asInput<String>(region),
      resource = pulumi.Input.asInput<String>(resource),
      rules = pulumi.Input.asOptionalInput<List<RuleComputeBeta>>(rules),
  ...
  factory RegionBackendServiceIamPolicyComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return RegionBackendServiceIamPolicyComputeBetaArgs(
      auditConfigs: map['auditConfigs'] == null ? null : pulumi.Output.create<List<AuditConfigComputeBeta>>(pulumi.Input.decodeList<AuditConfigComputeBeta>(map['auditConfigs'], (value) => AuditConfigComputeBeta.fromMap((value as Map).cast<String, dynamic>()))),
      bindings: map['bindings'] == null ? null : pulumi.Output.create<List<BindingComputeBeta>>(pulumi.Input.decodeList<BindingComputeBeta>(map['bindings'], (value) => BindingComputeBeta.fromMap((value as Map).cast<String, dynamic>()))),
      etag: map['etag'] == null ? null : pulumi.Output.create<String>(map['etag'] as String),
      project: map['project'] == null ? null : pulumi.Output.create<String>(map['project'] as String),
      region: pulumi.Output.create<String>(map['region'] as String),
      resource: pulumi.Output.create<String>(map['resource'] as String),
      rules: map['rules'] == null ? null : pulumi.Output.create<List<RuleComputeBeta>>(pulumi.Input.decodeList<RuleComputeBeta>(map['rules'], (value) => RuleComputeBeta.fromMap((value as Map).cast<String, dynamic>()))),
