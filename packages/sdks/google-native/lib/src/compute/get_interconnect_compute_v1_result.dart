...
class GetInterconnectComputeV1Result {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'circuitInfos': pulumi.Input.encodeList<InterconnectCircuitInfoResponseComputeV1, Map<String, dynamic>>(circuitInfos, (value) => value.toMap()),
      'creationTimestamp': creationTimestamp,
      'customerName': customerName,
      'description': description,
      'expectedOutages': pulumi.Input.encodeList<InterconnectOutageNotificationResponseComputeV1, Map<String, dynamic>>(expectedOutages, (value) => value.toMap()),
  ...
  factory GetInterconnectComputeV1Result.fromMap(Map<String, dynamic> map) {
    return GetInterconnectComputeV1Result(
      ...
      circuitInfos: pulumi.Input.decodeList<InterconnectCircuitInfoResponseComputeV1>(map['circuitInfos'], (value) => InterconnectCircuitInfoResponseComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      creationTimestamp: map['creationTimestamp'] as String,
      customerName: map['customerName'] as String,
      description: map['description'] as String,
      expectedOutages: pulumi.Input.decodeList<InterconnectOutageNotificationResponseComputeV1>(map['expectedOutages'], (value) => InterconnectOutageNotificationResponseComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      ...
      macsec: InterconnectMacsecResponseComputeV1.fromMap((map['macsec'] as Map).cast<String, dynamic>()),
