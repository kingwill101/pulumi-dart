...
class FirewallPolicyRuleMatcherResponseComputeV1 {
  ...
  factory FirewallPolicyRuleMatcherResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyRuleMatcherResponseComputeV1(
      ...
      layer4Configs: (pulumi.Input.decodeList<FirewallPolicyRuleMatcherLayer4ConfigResponseComputeV1>(map['layer4Configs'], (value) => FirewallPolicyRuleMatcherLayer4ConfigResponseComputeV1.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      srcSecureTags: (pulumi.Input.decodeList<FirewallPolicyRuleSecureTagResponseComputeV1>(map['srcSecureTags'], (value) => FirewallPolicyRuleSecureTagResponseComputeV1.fromMap((value as Map).cast<String, dynamic>()))).input(),
