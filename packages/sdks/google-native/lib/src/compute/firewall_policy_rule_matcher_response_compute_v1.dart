...
class FirewallPolicyRuleMatcherResponseComputeV1 {
  ...
  final pulumi.Input<List<FirewallPolicyRuleMatcherLayer4ConfigResponseComputeV1>> layer4Configs;
  ...
  final pulumi.Input<List<FirewallPolicyRuleSecureTagResponseComputeV1>> srcSecureTags;
  ...
  const FirewallPolicyRuleMatcherResponseComputeV1({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'layer4Configs': pulumi.Input.mapInputValue<List<FirewallPolicyRuleMatcherLayer4ConfigResponseComputeV1>, List<Map<String, dynamic>>>(layer4Configs, (value) => pulumi.Input.encodeList<FirewallPolicyRuleMatcherLayer4ConfigResponseComputeV1, Map<String, dynamic>>(value, (value) => value.toMap())),
      'srcAddressGroups': srcAddressGroups,
      'srcFqdns': srcFqdns,
      'srcIpRanges': srcIpRanges,
      'srcRegionCodes': srcRegionCodes,
      'srcSecureTags': pulumi.Input.mapInputValue<List<FirewallPolicyRuleSecureTagResponseComputeV1>, List<Map<String, dynamic>>>(srcSecureTags, (value) => pulumi.Input.encodeList<FirewallPolicyRuleSecureTagResponseComputeV1, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory FirewallPolicyRuleMatcherResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyRuleMatcherResponseComputeV1(
      ...
      layer4Configs: pulumi.Input.fromValue(pulumi.Input.decodeList<FirewallPolicyRuleMatcherLayer4ConfigResponseComputeV1>(map['layer4Configs']!, (value) => FirewallPolicyRuleMatcherLayer4ConfigResponseComputeV1.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      srcSecureTags: pulumi.Input.fromValue(pulumi.Input.decodeList<FirewallPolicyRuleSecureTagResponseComputeV1>(map['srcSecureTags']!, (value) => FirewallPolicyRuleSecureTagResponseComputeV1.fromMap((value as Map).cast<String, dynamic>()))),
