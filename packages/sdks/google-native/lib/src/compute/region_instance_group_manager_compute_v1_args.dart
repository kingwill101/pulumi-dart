...
class RegionInstanceGroupManagerComputeV1Args {
  ...
  RegionInstanceGroupManagerComputeV1Args({
    ...
    pulumi.Output<RegionInstanceGroupManagerListManagedInstancesResultsComputeV1>? listManagedInstancesResults,
  ...
  factory RegionInstanceGroupManagerComputeV1Args.fromMap(Map<String, dynamic> map) {
    return RegionInstanceGroupManagerComputeV1Args(
      ...
      listManagedInstancesResults: map['listManagedInstancesResults'] == null ? null : pulumi.Output.create<RegionInstanceGroupManagerListManagedInstancesResultsComputeV1>(RegionInstanceGroupManagerListManagedInstancesResultsComputeV1.fromValue(map['listManagedInstancesResults'] as String)),
