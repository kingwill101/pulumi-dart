...
class AutoscalingPolicyCustomMetricUtilization {
  ...
  final AutoscalingPolicyCustomMetricUtilizationUtilizationTargetType? utilizationTargetType;
  ...
  factory AutoscalingPolicyCustomMetricUtilization.fromMap(Map<String, dynamic> map) {
    return AutoscalingPolicyCustomMetricUtilization(
      ...
      utilizationTargetType: map['utilizationTargetType'] == null ? null : AutoscalingPolicyCustomMetricUtilizationUtilizationTargetType.fromValue(map['utilizationTargetType'] as String),
    );
  }
}
