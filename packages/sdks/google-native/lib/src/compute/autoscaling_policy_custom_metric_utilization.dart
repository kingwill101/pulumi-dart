...
import 'autoscaling_policy_custom_metric_utilization_utilization_target_type.dart';
...
class AutoscalingPolicyCustomMetricUtilization {
  ...
  final pulumi.Input<AutoscalingPolicyCustomMetricUtilizationUtilizationTargetType>? utilizationTargetType;

  /// Creates a new [AutoscalingPolicyCustomMetricUtilization].
  ...
  const AutoscalingPolicyCustomMetricUtilization({
    this.filter,
    this.metric,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'utilizationTargetType': ?pulumi.Input.mapOptionalInputValue<AutoscalingPolicyCustomMetricUtilizationUtilizationTargetType, String>(utilizationTargetType, (value) => value.wireValue),
    };
  }

  factory AutoscalingPolicyCustomMetricUtilization.fromMap(Map<String, dynamic> map) {
    return AutoscalingPolicyCustomMetricUtilization(
      ...
      utilizationTargetType: (() { final guardedValue = map['utilizationTargetType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AutoscalingPolicyCustomMetricUtilizationUtilizationTargetType.fromValue(guardedValue as String)); })(),
    );
  }
}
