...
/// {@template pulumi_compute_beta_region_network_firewall_policy_compute_beta_args_doc}
/// The set of arguments for RegionNetworkFirewallPolicy.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_region_network_firewall_policy_compute_beta_args_doc}
class RegionNetworkFirewallPolicyComputeBetaArgs {
  ...
  /// Creates a new [RegionNetworkFirewallPolicyComputeBetaArgs].
  ...
  const RegionNetworkFirewallPolicyComputeBetaArgs({
    this.associations,
    this.description,
    this.displayName,
    this.name,
  ...
  factory RegionNetworkFirewallPolicyComputeBetaArgs.fromMap(Map<String, dynamic> map) {
