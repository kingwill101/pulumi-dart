...
class TargetSslProxyComputeBetaArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'project': ?project,
      'proxyHeader': ?pulumi.Input.mapOptionalInputValue<TargetSslProxyProxyHeaderComputeBeta, String>(proxyHeader, (value) => value.wireValue),
      'requestId': ?requestId,
      'service': ?service,
  ...
  factory TargetSslProxyComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return TargetSslProxyComputeBetaArgs(
      ...
      proxyHeader: (() { final guardedValue = map['proxyHeader']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TargetSslProxyProxyHeaderComputeBeta.fromValue(guardedValue as String)); })(),
