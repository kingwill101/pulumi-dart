...
import 'region_target_tcp_proxy_proxy_header.dart';

/// {@template pulumi_compute_alpha_region_target_tcp_proxy_args_doc}
/// The set of arguments for RegionTargetTcpProxy.
/// {@endtemplate}
/// {@macro pulumi_compute_alpha_region_target_tcp_proxy_args_doc}
class RegionTargetTcpProxyArgs {
  ...
  final pulumi.Input<RegionTargetTcpProxyProxyHeader>? proxyHeader;
  ...
  RegionTargetTcpProxyArgs({
    ...
    pulumi.Output<RegionTargetTcpProxyProxyHeader>? proxyHeader,
    ...
    pulumi.Output<String>? service,
      ...
      proxyHeader = pulumi.Input.asOptionalInput<RegionTargetTcpProxyProxyHeader>(proxyHeader),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'project': ?project,
      'proxyBind': ?proxyBind,
      'proxyHeader': ?pulumi.Input.mapOptionalInputValue<RegionTargetTcpProxyProxyHeader, String>(proxyHeader, (value) => value.value),
      'region': region,
      'requestId': ?requestId,
      'service': ?service,
    };
  ...
  factory RegionTargetTcpProxyArgs.fromMap(Map<String, dynamic> map) {
    return RegionTargetTcpProxyArgs(
      ...
      proxyHeader: map['proxyHeader'] == null ? null : pulumi.Output.create<RegionTargetTcpProxyProxyHeader>(RegionTargetTcpProxyProxyHeader.fromValue(map['proxyHeader'] as String)),
