...
class RegionTargetTcpProxyArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'project': ?project,
      'proxyBind': ?proxyBind,
      'proxyHeader': ?pulumi.Input.mapOptionalInputValue<RegionTargetTcpProxyProxyHeader, String>(proxyHeader, (value) => value.wireValue),
      'region': region,
      'requestId': ?requestId,
      'service': ?service,
    };
  ...
  factory RegionTargetTcpProxyArgs.fromMap(Map<String, dynamic> map) {
    return RegionTargetTcpProxyArgs(
      ...
      proxyHeader: (() { final guardedValue = map['proxyHeader']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionTargetTcpProxyProxyHeader.fromValue(guardedValue as String)); })(),
