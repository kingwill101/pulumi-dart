...
/// {@template pulumi_compute_beta_http_health_check_compute_beta_args_doc}
/// The set of arguments for HttpHealthCheck.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_http_health_check_compute_beta_args_doc}
class HttpHealthCheckComputeBetaArgs {
  ...
  /// Creates a new [HttpHealthCheckComputeBetaArgs].
  ...
  factory HttpHealthCheckComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return HttpHealthCheckComputeBetaArgs(
