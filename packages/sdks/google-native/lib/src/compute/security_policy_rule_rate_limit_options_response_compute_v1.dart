...
class SecurityPolicyRuleRateLimitOptionsResponseComputeV1 {
  ...
  final pulumi.Input<SecurityPolicyRuleRateLimitOptionsThresholdResponseComputeV1> banThreshold;
  ...
  final pulumi.Input<List<SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponseComputeV1>> enforceOnKeyConfigs;
  ...
  final pulumi.Input<SecurityPolicyRuleRedirectOptionsResponseComputeV1> exceedRedirectOptions;
  /// Threshold at which to begin ratelimiting.
  final pulumi.Input<SecurityPolicyRuleRateLimitOptionsThresholdResponseComputeV1> rateLimitThreshold;
  ...
  const SecurityPolicyRuleRateLimitOptionsResponseComputeV1({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'banThreshold': pulumi.Input.mapInputValue<SecurityPolicyRuleRateLimitOptionsThresholdResponseComputeV1, Map<String, dynamic>>(banThreshold, (value) => value.toMap()),
      'conformAction': conformAction,
      'enforceOnKey': enforceOnKey,
      'enforceOnKeyConfigs': pulumi.Input.mapInputValue<List<SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponseComputeV1>, List<Map<String, dynamic>>>(enforceOnKeyConfigs, (value) => pulumi.Input.encodeList<SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponseComputeV1, Map<String, dynamic>>(value, (value) => value.toMap())),
      'enforceOnKeyName': enforceOnKeyName,
      'exceedAction': exceedAction,
      'exceedRedirectOptions': pulumi.Input.mapInputValue<SecurityPolicyRuleRedirectOptionsResponseComputeV1, Map<String, dynamic>>(exceedRedirectOptions, (value) => value.toMap()),
      'rateLimitThreshold': pulumi.Input.mapInputValue<SecurityPolicyRuleRateLimitOptionsThresholdResponseComputeV1, Map<String, dynamic>>(rateLimitThreshold, (value) => value.toMap()),
    };
  }
  ...
  factory SecurityPolicyRuleRateLimitOptionsResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRuleRateLimitOptionsResponseComputeV1(
      ...
      banThreshold: pulumi.Input.fromValue(SecurityPolicyRuleRateLimitOptionsThresholdResponseComputeV1.fromMap((map['banThreshold']! as Map).cast<String, dynamic>())),
      ...
      enforceOnKeyConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponseComputeV1>(map['enforceOnKeyConfigs']!, (value) => SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponseComputeV1.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      exceedRedirectOptions: pulumi.Input.fromValue(SecurityPolicyRuleRedirectOptionsResponseComputeV1.fromMap((map['exceedRedirectOptions']! as Map).cast<String, dynamic>())),
      rateLimitThreshold: pulumi.Input.fromValue(SecurityPolicyRuleRateLimitOptionsThresholdResponseComputeV1.fromMap((map['rateLimitThreshold']! as Map).cast<String, dynamic>())),
    );
  }
}
