...
class SecurityPolicyRuleRateLimitOptionsResponseComputeV1 {
  ...
  factory SecurityPolicyRuleRateLimitOptionsResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRuleRateLimitOptionsResponseComputeV1(
      ...
      banThreshold: (SecurityPolicyRuleRateLimitOptionsThresholdResponseComputeV1.fromMap((map['banThreshold'] as Map).cast<String, dynamic>())).input(),
      conformAction: (map['conformAction'] as String).input(),
      enforceOnKey: (map['enforceOnKey'] as String).input(),
      enforceOnKeyConfigs: (pulumi.Input.decodeList<SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponseComputeV1>(map['enforceOnKeyConfigs'], (value) => SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponseComputeV1.fromMap((value as Map).cast<String, dynamic>()))).input(),
      enforceOnKeyName: (map['enforceOnKeyName'] as String).input(),
      exceedAction: (map['exceedAction'] as String).input(),
      exceedRedirectOptions: (SecurityPolicyRuleRedirectOptionsResponseComputeV1.fromMap((map['exceedRedirectOptions'] as Map).cast<String, dynamic>())).input(),
      rateLimitThreshold: (SecurityPolicyRuleRateLimitOptionsThresholdResponseComputeV1.fromMap((map['rateLimitThreshold'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
