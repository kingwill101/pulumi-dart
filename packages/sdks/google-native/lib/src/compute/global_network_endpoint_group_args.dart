...
class GlobalNetworkEndpointGroupArgs {
  ...
  factory GlobalNetworkEndpointGroupArgs.fromMap(Map<String, dynamic> map) {
    return GlobalNetworkEndpointGroupArgs(
      ...
      clientPortMappingMode: map['clientPortMappingMode'] == null ? null : (GlobalNetworkEndpointGroupClientPortMappingMode.fromValue(map['clientPortMappingMode'] as String)).input(),
      ...
      networkEndpointType: map['networkEndpointType'] == null ? null : (GlobalNetworkEndpointGroupNetworkEndpointType.fromValue(map['networkEndpointType'] as String)).input(),
      ...
      type: map['type'] == null ? null : (GlobalNetworkEndpointGroupType.fromValue(map['type'] as String)).input(),
    );
  }
}
