...
class GlobalNetworkEndpointGroupArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'clientPortMappingMode': ?pulumi.Input.mapOptionalInputValue<GlobalNetworkEndpointGroupClientPortMappingMode, String>(clientPortMappingMode, (value) => value.wireValue),
      ...
      'name': ?name,
      'network': ?network,
      'networkEndpointType': ?pulumi.Input.mapOptionalInputValue<GlobalNetworkEndpointGroupNetworkEndpointType, String>(networkEndpointType, (value) => value.wireValue),
      'project': ?project,
      'pscData': ?pscData,
      ...
      'type': ?pulumi.Input.mapOptionalInputValue<GlobalNetworkEndpointGroupType, String>(type, (value) => value.wireValue),
    };
  }
  ...
  factory GlobalNetworkEndpointGroupArgs.fromMap(Map<String, dynamic> map) {
    return GlobalNetworkEndpointGroupArgs(
      ...
      clientPortMappingMode: (() { final guardedValue = map['clientPortMappingMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GlobalNetworkEndpointGroupClientPortMappingMode.fromValue(guardedValue as String)); })(),
      ...
      networkEndpointType: (() { final guardedValue = map['networkEndpointType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GlobalNetworkEndpointGroupNetworkEndpointType.fromValue(guardedValue as String)); })(),
      ...
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GlobalNetworkEndpointGroupType.fromValue(guardedValue as String)); })(),
    );
  }
}
