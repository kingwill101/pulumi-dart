...
class SubnetworkLogConfigResponse {
  ...
  /// Creates a new [SubnetworkLogConfigResponse].
  ...
  factory SubnetworkLogConfigResponse.fromMap(Map<String, dynamic> map) {
    return SubnetworkLogConfigResponse(
      aggregationInterval: (map['aggregationInterval'] as String).input(),
      enable: (map['enable'] as bool).input(),
      filterExpr: (map['filterExpr'] as String).input(),
      flowSampling: (map['flowSampling'] as double).input(),
