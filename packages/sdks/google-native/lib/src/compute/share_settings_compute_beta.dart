...
class ShareSettingsComputeBeta {
  ...
  const ShareSettingsComputeBeta({
    this.projectMap,
    this.projects,
    this.shareType,
  });
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'projects': ?projects,
      'shareType': ?pulumi.Input.mapOptionalInputValue<ShareSettingsShareTypeComputeBeta, String>(shareType, (value) => value.wireValue),
    };
  }
  ...
  factory ShareSettingsComputeBeta.fromMap(Map<String, dynamic> map) {
    return ShareSettingsComputeBeta(
      ...
      shareType: (() { final guardedValue = map['shareType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ShareSettingsShareTypeComputeBeta.fromValue(guardedValue as String)); })(),
    );
  }
}
