...
class AllocationSpecificSKUAllocationReservedInstancePropertiesResponse {
  ...
  const AllocationSpecificSKUAllocationReservedInstancePropertiesResponse({
  ...
  factory AllocationSpecificSKUAllocationReservedInstancePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AllocationSpecificSKUAllocationReservedInstancePropertiesResponse(
      ...
      localSsds: pulumi.Input.fromValue(pulumi.Input.decodeList<AllocationSpecificSKUAllocationAllocatedInstancePropertiesReservedDiskResponse>(map['localSsds']!, (value) => AllocationSpecificSKUAllocationAllocatedInstancePropertiesReservedDiskResponse.fromMap((value as Map).cast<String, dynamic>()))),
