...
/// {@template pulumi_compute_beta_node_template_iam_binding_compute_beta_args_doc}
/// The set of arguments for NodeTemplateIamBinding.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_node_template_iam_binding_compute_beta_args_doc}
class NodeTemplateIamBindingComputeBetaArgs {
  ...
  /// Creates a new [NodeTemplateIamBindingComputeBetaArgs].
  ...
  NodeTemplateIamBindingComputeBetaArgs({
    this.condition,
  ...
  factory NodeTemplateIamBindingComputeBetaArgs.fromMap(
