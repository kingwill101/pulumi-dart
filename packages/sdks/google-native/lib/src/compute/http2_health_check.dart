...
class HTTP2HealthCheck {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'port': ?port,
      'portName': ?portName,
      'portSpecification': ?pulumi.Input.mapOptionalInputValue<HTTP2HealthCheckPortSpecification, String>(portSpecification, (value) => value.wireValue),
      'proxyHeader': ?pulumi.Input.mapOptionalInputValue<HTTP2HealthCheckProxyHeader, String>(proxyHeader, (value) => value.wireValue),
      'requestPath': ?requestPath,
      'response': ?response,
      'weightReportMode': ?pulumi.Input.mapOptionalInputValue<HTTP2HealthCheckWeightReportMode, String>(weightReportMode, (value) => value.wireValue),
    };
  }
  ...
  factory HTTP2HealthCheck.fromMap(Map<String, dynamic> map) {
    return HTTP2HealthCheck(
      ...
      portSpecification: (() { final guardedValue = map['portSpecification']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HTTP2HealthCheckPortSpecification.fromValue(guardedValue as String)); })(),
      proxyHeader: (() { final guardedValue = map['proxyHeader']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HTTP2HealthCheckProxyHeader.fromValue(guardedValue as String)); })(),
      ...
      weightReportMode: (() { final guardedValue = map['weightReportMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HTTP2HealthCheckWeightReportMode.fromValue(guardedValue as String)); })(),
    );
  }
}
