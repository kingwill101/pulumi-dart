    ...
    return HTTP2HealthCheck(
      ...
      portSpecification: (() {
        ...
        return pulumi.Input.fromValue(
          HTTP2HealthCheckPortSpecification.fromValue(guardedValue as String),
        );
      })(),
      proxyHeader: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          HTTP2HealthCheckProxyHeader.fromValue(guardedValue as String),
        );
      })(),
      requestPath: (() {
      ...
      weightReportMode: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          HTTP2HealthCheckWeightReportMode.fromValue(guardedValue as String),
        );
      })(),
    );
  }
