...
/// {@template pulumi_compute_beta_region_backend_service_iam_member_compute_beta_args_doc}
/// The set of arguments for RegionBackendServiceIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_region_backend_service_iam_member_compute_beta_args_doc}
class RegionBackendServiceIamMemberComputeBetaArgs {
  ...
  /// Creates a new [RegionBackendServiceIamMemberComputeBetaArgs].
  ...
  const RegionBackendServiceIamMemberComputeBetaArgs({
    this.condition,
  ...
  factory RegionBackendServiceIamMemberComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return RegionBackendServiceIamMemberComputeBetaArgs(
