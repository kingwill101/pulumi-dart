...
class AllocationSpecificSKUAllocationReservedInstancePropertiesComputeBeta {
  ...
  final pulumi.Input<List<AllocationSpecificSKUAllocationAllocatedInstancePropertiesReservedDiskComputeBeta>>? localSsds;
  ...
  final pulumi.Input<AllocationSpecificSKUAllocationReservedInstancePropertiesMaintenanceIntervalComputeBeta>? maintenanceInterval;
  ...
  const AllocationSpecificSKUAllocationReservedInstancePropertiesComputeBeta({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'localSsds': ?pulumi.Input.mapOptionalInputValue<List<AllocationSpecificSKUAllocationAllocatedInstancePropertiesReservedDiskComputeBeta>, List<Map<String, dynamic>>>(localSsds, (value) => pulumi.Input.encodeList<AllocationSpecificSKUAllocationAllocatedInstancePropertiesReservedDiskComputeBeta, Map<String, dynamic>>(value, (value) => value.toMap())),
      'locationHint': ?locationHint,
      'machineType': ?machineType,
      'maintenanceFreezeDurationHours': ?maintenanceFreezeDurationHours,
      'maintenanceInterval': ?pulumi.Input.mapOptionalInputValue<AllocationSpecificSKUAllocationReservedInstancePropertiesMaintenanceIntervalComputeBeta, String>(maintenanceInterval, (value) => value.wireValue),
  ...
  factory AllocationSpecificSKUAllocationReservedInstancePropertiesComputeBeta.fromMap(Map<String, dynamic> map) {
    return AllocationSpecificSKUAllocationReservedInstancePropertiesComputeBeta(
      ...
      localSsds: (() { final guardedValue = map['localSsds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AllocationSpecificSKUAllocationAllocatedInstancePropertiesReservedDiskComputeBeta>(guardedValue, (value) => AllocationSpecificSKUAllocationAllocatedInstancePropertiesReservedDiskComputeBeta.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      maintenanceInterval: (() { final guardedValue = map['maintenanceInterval']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AllocationSpecificSKUAllocationReservedInstancePropertiesMaintenanceIntervalComputeBeta.fromValue(guardedValue as String)); })(),
