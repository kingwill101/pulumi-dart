...
class SecurityPolicyRuleNetworkMatcherResponseComputeV1 {
  ...
  final pulumi.Input<
    List<SecurityPolicyRuleNetworkMatcherUserDefinedFieldMatchResponseComputeV1>
  >
  userDefinedFields;
  ...
  factory SecurityPolicyRuleNetworkMatcherResponseComputeV1.fromMap(
    ...
    return SecurityPolicyRuleNetworkMatcherResponseComputeV1(
      ...
      userDefinedFields: pulumi.Input.fromValue(
        ...
        >(
          ...
          (value) =>
              SecurityPolicyRuleNetworkMatcherUserDefinedFieldMatchResponseComputeV1.fromMap(
