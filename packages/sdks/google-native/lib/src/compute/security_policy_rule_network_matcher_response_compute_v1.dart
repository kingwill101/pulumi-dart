...
class SecurityPolicyRuleNetworkMatcherResponseComputeV1 {
  ...
  factory SecurityPolicyRuleNetworkMatcherResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRuleNetworkMatcherResponseComputeV1(
      ...
      userDefinedFields: (pulumi.Input.decodeList<SecurityPolicyRuleNetworkMatcherUserDefinedFieldMatchResponseComputeV1>(map['userDefinedFields'], (value) => SecurityPolicyRuleNetworkMatcherUserDefinedFieldMatchResponseComputeV1.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
