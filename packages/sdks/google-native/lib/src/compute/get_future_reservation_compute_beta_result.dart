...
class GetFutureReservationComputeBetaResult {
  ...
  factory GetFutureReservationComputeBetaResult.fromMap(Map<String, dynamic> map) {
    return GetFutureReservationComputeBetaResult(
      ...
      autoCreatedReservationsDuration: DurationResponseComputeBeta.fromMap((map['autoCreatedReservationsDuration']! as Map).cast<String, dynamic>()),
      ...
      status: FutureReservationStatusResponseComputeBeta.fromMap((map['status']! as Map).cast<String, dynamic>()),
