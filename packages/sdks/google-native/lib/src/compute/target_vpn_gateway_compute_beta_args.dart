...
/// {@template pulumi_compute_beta_target_vpn_gateway_compute_beta_args_doc}
/// The set of arguments for TargetVpnGateway.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_target_vpn_gateway_compute_beta_args_doc}
class TargetVpnGatewayComputeBetaArgs {
  ...
  /// Creates a new [TargetVpnGatewayComputeBetaArgs].
  ...
  const TargetVpnGatewayComputeBetaArgs({
    this.description,
    this.labels,
    this.name,
    this.network,
