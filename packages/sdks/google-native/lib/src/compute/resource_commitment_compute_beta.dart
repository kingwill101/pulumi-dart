...
class ResourceCommitmentComputeBeta {
  ...
  ResourceCommitmentComputeBeta({this.acceleratorType, this.amount, this.type});
    ...
    return <String, dynamic>{
      ...
      'type':
          ?pulumi.Input.mapOptionalInputValue<
            ResourceCommitmentTypeComputeBeta,
            String
    ...
    return ResourceCommitmentComputeBeta(
      ...
      type: (() {
        ...
        return pulumi.Input.fromValue(
          ResourceCommitmentTypeComputeBeta.fromValue(guardedValue as String),
        );
      })(),
    );
  }
