...
class SslPolicyWarningsItemResponseComputeBeta {
  ...
  final pulumi.Input<List<SslPolicyWarningsItemDataItemResponseComputeBeta>>
  data;
    ...
    return <String, dynamic>{
      ...
      'data':
          pulumi.Input.mapInputValue<
            List<SslPolicyWarningsItemDataItemResponseComputeBeta>,
  ...
  factory SslPolicyWarningsItemResponseComputeBeta.fromMap(
    ...
    return SslPolicyWarningsItemResponseComputeBeta(
      ...
      data: pulumi.Input.fromValue(
        pulumi
            .Input.decodeList<SslPolicyWarningsItemDataItemResponseComputeBeta>(
          map['data']!,
