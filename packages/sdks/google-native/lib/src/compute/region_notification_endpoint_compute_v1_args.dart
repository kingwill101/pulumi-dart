...
class RegionNotificationEndpointComputeV1Args {
  ...
  const RegionNotificationEndpointComputeV1Args({
    this.description,
    this.grpcSettings,
    this.name,
    this.project,
  ...
  factory RegionNotificationEndpointComputeV1Args.fromMap(Map<String, dynamic> map) {
    return RegionNotificationEndpointComputeV1Args(
      ...
      grpcSettings: (() { final guardedValue = map['grpcSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NotificationEndpointGrpcSettingsComputeV1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
