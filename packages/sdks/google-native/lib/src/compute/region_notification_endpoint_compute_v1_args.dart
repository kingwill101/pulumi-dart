...
class RegionNotificationEndpointComputeV1Args {
  ...
  RegionNotificationEndpointComputeV1Args({
    ...
    pulumi.Output<NotificationEndpointGrpcSettingsComputeV1>? grpcSettings,
    ...
    pulumi.Output<String>? requestId,
      ...
      grpcSettings = pulumi.Input.asOptionalInput<NotificationEndpointGrpcSettingsComputeV1>(grpcSettings),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'grpcSettings': ?pulumi.Input.mapOptionalInputValue<NotificationEndpointGrpcSettingsComputeV1, Map<String, dynamic>>(grpcSettings, (value) => value.toMap()),
      'name': ?name,
      'project': ?project,
      'region': region,
      'requestId': ?requestId,
  ...
  factory RegionNotificationEndpointComputeV1Args.fromMap(Map<String, dynamic> map) {
    return RegionNotificationEndpointComputeV1Args(
      ...
      grpcSettings: map['grpcSettings'] == null ? null : pulumi.Output.create<NotificationEndpointGrpcSettingsComputeV1>(NotificationEndpointGrpcSettingsComputeV1.fromMap((map['grpcSettings'] as Map).cast<String, dynamic>())),
