...
class FirewallArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'direction': ?pulumi.Input.mapOptionalInputValue<FirewallDirection, String>(direction, (value) => value.wireValue),
      'disabled': ?disabled,
  ...
  factory FirewallArgs.fromMap(Map<String, dynamic> map) {
    return FirewallArgs(
      allowed: (() { final guardedValue = map['allowed']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FirewallAllowedItem>(guardedValue, (value) => FirewallAllowedItem.fromMap((value as Map).cast<String, dynamic>()))); })(),
      denied: (() { final guardedValue = map['denied']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FirewallDeniedItem>(guardedValue, (value) => FirewallDeniedItem.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      direction: (() { final guardedValue = map['direction']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FirewallDirection.fromValue(guardedValue as String)); })(),
