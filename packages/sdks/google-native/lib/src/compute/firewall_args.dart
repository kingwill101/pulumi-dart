...
class FirewallArgs {
  ...
  FirewallArgs({
    pulumi.Output<List<FirewallAllowedItem>>? allowed,
    pulumi.Output<List<FirewallDeniedItem>>? denied,
    pulumi.Output<String>? description,
    pulumi.Output<List<String>>? destinationRanges,
    pulumi.Output<FirewallDirection>? direction,
  ...
  factory FirewallArgs.fromMap(Map<String, dynamic> map) {
    return FirewallArgs(
      allowed: map['allowed'] == null ? null : pulumi.Output.create<List<FirewallAllowedItem>>(pulumi.Input.decodeList<FirewallAllowedItem>(map['allowed'], (value) => FirewallAllowedItem.fromMap((value as Map).cast<String, dynamic>()))),
      denied: map['denied'] == null ? null : pulumi.Output.create<List<FirewallDeniedItem>>(pulumi.Input.decodeList<FirewallDeniedItem>(map['denied'], (value) => FirewallDeniedItem.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      direction: map['direction'] == null ? null : pulumi.Output.create<FirewallDirection>(FirewallDirection.fromValue(map['direction'] as String)),
