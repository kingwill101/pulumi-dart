...
class FirewallArgs {
  ...
  factory FirewallArgs.fromMap(Map<String, dynamic> map) {
    return FirewallArgs(
      allowed: map['allowed'] == null ? null : (pulumi.Input.decodeList<FirewallAllowedItem>(map['allowed'], (value) => FirewallAllowedItem.fromMap((value as Map).cast<String, dynamic>()))).input(),
      denied: map['denied'] == null ? null : (pulumi.Input.decodeList<FirewallDeniedItem>(map['denied'], (value) => FirewallDeniedItem.fromMap((value as Map).cast<String, dynamic>()))).input(),
      description: map['description'] == null ? null : (map['description'] as String).input(),
      destinationRanges: map['destinationRanges'] == null ? null : ((map['destinationRanges'] as List).cast<String>()).input(),
      direction: map['direction'] == null ? null : (FirewallDirection.fromValue(map['direction'] as String)).input(),
