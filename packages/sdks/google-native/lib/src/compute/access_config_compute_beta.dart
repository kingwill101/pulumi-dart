...
class AccessConfigComputeBeta {
  ...
  final pulumi.Input<AccessConfigNetworkTierComputeBeta>? networkTier;
  ...
  final pulumi.Input<AccessConfigTypeComputeBeta>? type;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'natIP': ?natIP,
      'networkTier': ?pulumi.Input.mapOptionalInputValue<AccessConfigNetworkTierComputeBeta, String>(networkTier, (value) => value.wireValue),
      'publicPtrDomainName': ?publicPtrDomainName,
      'setPublicPtr': ?setPublicPtr,
      'type': ?pulumi.Input.mapOptionalInputValue<AccessConfigTypeComputeBeta, String>(type, (value) => value.wireValue),
    };
  }
  ...
  factory AccessConfigComputeBeta.fromMap(Map<String, dynamic> map) {
    return AccessConfigComputeBeta(
      ...
      networkTier: (() { final guardedValue = map['networkTier']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AccessConfigNetworkTierComputeBeta.fromValue(guardedValue as String)); })(),
      ...
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AccessConfigTypeComputeBeta.fromValue(guardedValue as String)); })(),
    );
  }
}
