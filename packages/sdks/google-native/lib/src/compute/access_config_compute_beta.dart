    ...
    return <String, dynamic>{
      ...
      'networkTier':
          ?pulumi.Input.mapOptionalInputValue<
            AccessConfigNetworkTierComputeBeta,
            String
    ...
    return AccessConfigComputeBeta(
      ...
      networkTier: (() {
        ...
        return pulumi.Input.fromValue(
          AccessConfigNetworkTierComputeBeta.fromValue(guardedValue as String),
        );
      })(),
      publicPtrDomainName: (() {
      ...
      type: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AccessConfigTypeComputeBeta.fromValue(guardedValue as String),
        );
      })(),
    );
  }
