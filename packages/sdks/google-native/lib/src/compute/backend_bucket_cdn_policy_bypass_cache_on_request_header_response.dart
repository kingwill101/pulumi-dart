...
class BackendBucketCdnPolicyBypassCacheOnRequestHeaderResponse {
  ...
  const BackendBucketCdnPolicyBypassCacheOnRequestHeaderResponse({
  ...
  factory BackendBucketCdnPolicyBypassCacheOnRequestHeaderResponse.fromMap(Map<String, dynamic> map) {
