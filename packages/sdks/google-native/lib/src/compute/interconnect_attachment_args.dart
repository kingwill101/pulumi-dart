    ...
    return InterconnectAttachmentArgs(
      ...
      bandwidth: (() {
        ...
        return pulumi.Input.fromValue(
          InterconnectAttachmentBandwidth.fromValue(guardedValue as String),
        );
      })(),
      ...
      encryption: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          InterconnectAttachmentEncryption.fromValue(guardedValue as String),
        );
      })(),
      interconnect: (() {
      ...
      stackType: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          InterconnectAttachmentStackType.fromValue(guardedValue as String),
        );
      })(),
      subnetLength: (() {
      ...
      type: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          InterconnectAttachmentType.fromValue(guardedValue as String),
        );
      })(),
      vlanTag8021q: (() {
