...
class InterconnectAttachmentArgs {
  ...
  factory InterconnectAttachmentArgs.fromMap(Map<String, dynamic> map) {
    return InterconnectAttachmentArgs(
      ...
      bandwidth: map['bandwidth'] == null ? null : (InterconnectAttachmentBandwidth.fromValue(map['bandwidth'] as String)).input(),
      ...
      edgeAvailabilityDomain: map['edgeAvailabilityDomain'] == null ? null : (InterconnectAttachmentEdgeAvailabilityDomain.fromValue(map['edgeAvailabilityDomain'] as String)).input(),
      encryption: map['encryption'] == null ? null : (InterconnectAttachmentEncryption.fromValue(map['encryption'] as String)).input(),
      ...
      partnerMetadata: map['partnerMetadata'] == null ? null : (InterconnectAttachmentPartnerMetadata.fromMap((map['partnerMetadata'] as Map).cast<String, dynamic>())).input(),
      project: map['project'] == null ? null : (map['project'] as String).input(),
      region: (map['region'] as String).input(),
      requestId: map['requestId'] == null ? null : (map['requestId'] as String).input(),
      router: map['router'] == null ? null : (map['router'] as String).input(),
      stackType: map['stackType'] == null ? null : (InterconnectAttachmentStackType.fromValue(map['stackType'] as String)).input(),
      subnetLength: map['subnetLength'] == null ? null : (map['subnetLength'] as int).input(),
      type: map['type'] == null ? null : (InterconnectAttachmentType.fromValue(map['type'] as String)).input(),
