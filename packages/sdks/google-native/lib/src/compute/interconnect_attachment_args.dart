...
class InterconnectAttachmentArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'bandwidth': ?pulumi.Input.mapOptionalInputValue<InterconnectAttachmentBandwidth, String>(bandwidth, (value) => value.wireValue),
      ...
      'edgeAvailabilityDomain': ?pulumi.Input.mapOptionalInputValue<InterconnectAttachmentEdgeAvailabilityDomain, String>(edgeAvailabilityDomain, (value) => value.wireValue),
      'encryption': ?pulumi.Input.mapOptionalInputValue<InterconnectAttachmentEncryption, String>(encryption, (value) => value.wireValue),
      ...
      'requestId': ?requestId,
      'router': ?router,
      'stackType': ?pulumi.Input.mapOptionalInputValue<InterconnectAttachmentStackType, String>(stackType, (value) => value.wireValue),
      'subnetLength': ?subnetLength,
      'type': ?pulumi.Input.mapOptionalInputValue<InterconnectAttachmentType, String>(type, (value) => value.wireValue),
  ...
  factory InterconnectAttachmentArgs.fromMap(Map<String, dynamic> map) {
    return InterconnectAttachmentArgs(
      ...
      bandwidth: (() { final guardedValue = map['bandwidth']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InterconnectAttachmentBandwidth.fromValue(guardedValue as String)); })(),
      ...
      edgeAvailabilityDomain: (() { final guardedValue = map['edgeAvailabilityDomain']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InterconnectAttachmentEdgeAvailabilityDomain.fromValue(guardedValue as String)); })(),
      encryption: (() { final guardedValue = map['encryption']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InterconnectAttachmentEncryption.fromValue(guardedValue as String)); })(),
      ...
      partnerMetadata: (() { final guardedValue = map['partnerMetadata']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InterconnectAttachmentPartnerMetadata.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      stackType: (() { final guardedValue = map['stackType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InterconnectAttachmentStackType.fromValue(guardedValue as String)); })(),
      ...
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InterconnectAttachmentType.fromValue(guardedValue as String)); })(),
