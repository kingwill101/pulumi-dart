...
class NetworkInterfaceSubInterfaceResponse {
  ...
  const NetworkInterfaceSubInterfaceResponse({
  ...
  factory NetworkInterfaceSubInterfaceResponse.fromMap(Map<String, dynamic> map) {
    return NetworkInterfaceSubInterfaceResponse(
      ipAddress: pulumi.Input.fromValue(map['ipAddress'] as String),
      ipAllocationMode: pulumi.Input.fromValue(map['ipAllocationMode'] as String),
