...
class DistributionPolicyResponseComputeBeta {
  ...
  factory DistributionPolicyResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return DistributionPolicyResponseComputeBeta(
      ...
      zones: (pulumi.Input.decodeList<DistributionPolicyZoneConfigurationResponseComputeBeta>(map['zones'], (value) => DistributionPolicyZoneConfigurationResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
