...
class FirewallPolicyArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'shortName': ?shortName,
      'vpcNetworkScope': ?pulumi.Input.mapOptionalInputValue<FirewallPolicyVpcNetworkScope, String>(vpcNetworkScope, (value) => value.wireValue),
    };
  }
  ...
  factory FirewallPolicyArgs.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyArgs(
      ...
      vpcNetworkScope: (() { final guardedValue = map['vpcNetworkScope']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FirewallPolicyVpcNetworkScope.fromValue(guardedValue as String)); })(),
    );
  }
}
