...
class PacketMirroringMirroredResourceInfoResponseComputeV1 {
  ...
  final pulumi.Input<
    List<PacketMirroringMirroredResourceInfoInstanceInfoResponseComputeV1>
  >
  instances;

  /// A set of subnetworks for which traffic from/to all VM instances will be mirrored. They must live in the same region as this packetMirroring. You may specify a maximum of 5 subnetworks.
  final pulumi.Input<
    List<PacketMirroringMirroredResourceInfoSubnetInfoResponseComputeV1>
  >
  subnetworks;
    ...
    return PacketMirroringMirroredResourceInfoResponseComputeV1(
      instances: pulumi.Input.fromValue(
        ...
        >(
          map['instances']!,
          (value) =>
              PacketMirroringMirroredResourceInfoInstanceInfoResponseComputeV1.fromMap(
      ...
      subnetworks: pulumi.Input.fromValue(
        ...
        >(
          map['subnetworks']!,
          (value) =>
              PacketMirroringMirroredResourceInfoSubnetInfoResponseComputeV1.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
