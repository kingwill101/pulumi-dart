...
class GetSslPolicyComputeBetaResult {
  ...
  /// Creates a new [GetSslPolicyComputeBetaResult].
  ...
  const GetSslPolicyComputeBetaResult({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'region': region,
      'selfLink': selfLink,
      'warnings': pulumi.Input.encodeList<SslPolicyWarningsItemResponseComputeBeta, Map<String, dynamic>>(warnings, (value) => value.toMap()),
    };
  }
  ...
  factory GetSslPolicyComputeBetaResult.fromMap(Map<String, dynamic> map) {
    return GetSslPolicyComputeBetaResult(
      ...
      warnings: pulumi.Input.decodeList<SslPolicyWarningsItemResponseComputeBeta>(map['warnings']!, (value) => SslPolicyWarningsItemResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
