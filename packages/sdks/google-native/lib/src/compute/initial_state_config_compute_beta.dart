...
class InitialStateConfigComputeBeta {
  ...
  const InitialStateConfigComputeBeta({
    this.dbs,
    this.dbxs,
    this.keks,
    this.pk,
  ...
  factory InitialStateConfigComputeBeta.fromMap(Map<String, dynamic> map) {
    return InitialStateConfigComputeBeta(
      dbs: (() { final guardedValue = map['dbs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FileContentBufferComputeBeta>(guardedValue, (value) => FileContentBufferComputeBeta.fromMap((value as Map).cast<String, dynamic>()))); })(),
      dbxs: (() { final guardedValue = map['dbxs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FileContentBufferComputeBeta>(guardedValue, (value) => FileContentBufferComputeBeta.fromMap((value as Map).cast<String, dynamic>()))); })(),
      keks: (() { final guardedValue = map['keks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FileContentBufferComputeBeta>(guardedValue, (value) => FileContentBufferComputeBeta.fromMap((value as Map).cast<String, dynamic>()))); })(),
      pk: (() { final guardedValue = map['pk']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FileContentBufferComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
