...
class HttpHeaderMatchComputeBeta {
  ...
  final pulumi.Input<Int64RangeMatchComputeBeta>? rangeMatch;
  ...
  const HttpHeaderMatchComputeBeta({
    this.exactMatch,
    this.headerName,
    this.invertMatch,
    this.prefixMatch,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'rangeMatch': ?pulumi.Input.mapOptionalInputValue<Int64RangeMatchComputeBeta, Map<String, dynamic>>(rangeMatch, (value) => value.toMap()),
  ...
  factory HttpHeaderMatchComputeBeta.fromMap(Map<String, dynamic> map) {
    return HttpHeaderMatchComputeBeta(
      ...
      rangeMatch: (() { final guardedValue = map['rangeMatch']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Int64RangeMatchComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
