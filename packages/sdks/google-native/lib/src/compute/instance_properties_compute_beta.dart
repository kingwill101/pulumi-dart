...
class InstancePropertiesComputeBeta {
  ...
  final pulumi.Input<InstancePropertiesKeyRevocationActionTypeComputeBeta>?
  ...
  final pulumi.Input<InstancePropertiesPostKeyRevocationActionTypeComputeBeta>?
  postKeyRevocationActionType;

  /// The private IPv6 google access type for VMs. If not specified, use INHERIT_FROM_SUBNETWORK as default. Note that for MachineImage, this is not supported yet.
  final pulumi.Input<InstancePropertiesPrivateIpv6GoogleAccessComputeBeta>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'keyRevocationActionType':
          ?pulumi.Input.mapOptionalInputValue<
            InstancePropertiesKeyRevocationActionTypeComputeBeta,
            String
      ...
      'postKeyRevocationActionType':
          ?pulumi.Input.mapOptionalInputValue<
            InstancePropertiesPostKeyRevocationActionTypeComputeBeta,
            String
          >(postKeyRevocationActionType, (value) => value.wireValue),
      'privateIpv6GoogleAccess':
          ?pulumi.Input.mapOptionalInputValue<
            InstancePropertiesPrivateIpv6GoogleAccessComputeBeta,
            String
