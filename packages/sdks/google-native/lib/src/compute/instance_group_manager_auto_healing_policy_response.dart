...
class InstanceGroupManagerAutoHealingPolicyResponse {
  ...
  final InstanceGroupManagerAutoHealingPolicyAutoHealingTriggersResponse autoHealingTriggers;
  ...
  final FixedOrPercentResponse maxUnavailable;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'autoHealingTriggers': autoHealingTriggers.toMap(),
  ...
  factory InstanceGroupManagerAutoHealingPolicyResponse.fromMap(Map<String, dynamic> map) {
    return InstanceGroupManagerAutoHealingPolicyResponse(
      autoHealingTriggers: InstanceGroupManagerAutoHealingPolicyAutoHealingTriggersResponse.fromMap((map['autoHealingTriggers'] as Map).cast<String, dynamic>()),
      healthCheck: map['healthCheck'] as String,
      initialDelaySec: map['initialDelaySec'] as int,
      maxUnavailable: FixedOrPercentResponse.fromMap((map['maxUnavailable'] as Map).cast<String, dynamic>()),
    );
  }
}
