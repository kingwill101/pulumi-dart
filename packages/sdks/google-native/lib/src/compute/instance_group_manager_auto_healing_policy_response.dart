...
class InstanceGroupManagerAutoHealingPolicyResponse {
  ...
  final pulumi.Input<InstanceGroupManagerAutoHealingPolicyAutoHealingTriggersResponse> autoHealingTriggers;
  ...
  const InstanceGroupManagerAutoHealingPolicyResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'autoHealingTriggers': pulumi.Input.mapInputValue<InstanceGroupManagerAutoHealingPolicyAutoHealingTriggersResponse, Map<String, dynamic>>(autoHealingTriggers, (value) => value.toMap()),
      'healthCheck': healthCheck,
      'initialDelaySec': initialDelaySec,
      'maxUnavailable': pulumi.Input.mapInputValue<FixedOrPercentResponse, Map<String, dynamic>>(maxUnavailable, (value) => value.toMap()),
    };
  }

  factory InstanceGroupManagerAutoHealingPolicyResponse.fromMap(Map<String, dynamic> map) {
    return InstanceGroupManagerAutoHealingPolicyResponse(
      autoHealingTriggers: pulumi.Input.fromValue(InstanceGroupManagerAutoHealingPolicyAutoHealingTriggersResponse.fromMap((map['autoHealingTriggers']! as Map).cast<String, dynamic>())),
      ...
      maxUnavailable: pulumi.Input.fromValue(FixedOrPercentResponse.fromMap((map['maxUnavailable']! as Map).cast<String, dynamic>())),
    );
  }
}
