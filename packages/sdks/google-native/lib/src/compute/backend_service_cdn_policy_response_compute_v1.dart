...
import 'backend_service_cdn_policy_bypass_cache_on_request_header_response_compute_v1.dart';
import 'backend_service_cdn_policy_negative_caching_policy_response_compute_v1.dart';
import 'cache_key_policy_response_compute_v1.dart';

/// Message containing Cloud CDN configuration for a backend service.
class BackendServiceCdnPolicyResponseComputeV1 {
  /// Bypass the cache when the specified request headers are matched - e.g. Pragma or Authorization headers. Up to 5 headers can be specified. The cache is bypassed for all cdnPolicy.cacheMode settings.
  final pulumi.Input<List<BackendServiceCdnPolicyBypassCacheOnRequestHeaderResponseComputeV1>> bypassCacheOnRequestHeaders;
  /// The CacheKeyPolicy for this CdnPolicy.
  final pulumi.Input<CacheKeyPolicyResponseComputeV1> cacheKeyPolicy;
  ...
  final pulumi.Input<List<BackendServiceCdnPolicyNegativeCachingPolicyResponseComputeV1>> negativeCachingPolicy;
  ...
  /// Creates a new [BackendServiceCdnPolicyResponseComputeV1].
  ...
  const BackendServiceCdnPolicyResponseComputeV1({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'bypassCacheOnRequestHeaders': pulumi.Input.mapInputValue<List<BackendServiceCdnPolicyBypassCacheOnRequestHeaderResponseComputeV1>, List<Map<String, dynamic>>>(bypassCacheOnRequestHeaders, (value) => pulumi.Input.encodeList<BackendServiceCdnPolicyBypassCacheOnRequestHeaderResponseComputeV1, Map<String, dynamic>>(value, (value) => value.toMap())),
      'cacheKeyPolicy': pulumi.Input.mapInputValue<CacheKeyPolicyResponseComputeV1, Map<String, dynamic>>(cacheKeyPolicy, (value) => value.toMap()),
      'cacheMode': cacheMode,
      'clientTtl': clientTtl,
      'defaultTtl': defaultTtl,
      'maxTtl': maxTtl,
      'negativeCaching': negativeCaching,
      'negativeCachingPolicy': pulumi.Input.mapInputValue<List<BackendServiceCdnPolicyNegativeCachingPolicyResponseComputeV1>, List<Map<String, dynamic>>>(negativeCachingPolicy, (value) => pulumi.Input.encodeList<BackendServiceCdnPolicyNegativeCachingPolicyResponseComputeV1, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory BackendServiceCdnPolicyResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return BackendServiceCdnPolicyResponseComputeV1(
      bypassCacheOnRequestHeaders: pulumi.Input.fromValue(pulumi.Input.decodeList<BackendServiceCdnPolicyBypassCacheOnRequestHeaderResponseComputeV1>(map['bypassCacheOnRequestHeaders']!, (value) => BackendServiceCdnPolicyBypassCacheOnRequestHeaderResponseComputeV1.fromMap((value as Map).cast<String, dynamic>()))),
      cacheKeyPolicy: pulumi.Input.fromValue(CacheKeyPolicyResponseComputeV1.fromMap((map['cacheKeyPolicy']! as Map).cast<String, dynamic>())),
      ...
      negativeCachingPolicy: pulumi.Input.fromValue(pulumi.Input.decodeList<BackendServiceCdnPolicyNegativeCachingPolicyResponseComputeV1>(map['negativeCachingPolicy']!, (value) => BackendServiceCdnPolicyNegativeCachingPolicyResponseComputeV1.fromMap((value as Map).cast<String, dynamic>()))),
