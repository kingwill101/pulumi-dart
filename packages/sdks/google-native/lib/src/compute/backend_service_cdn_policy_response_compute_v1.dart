...
class BackendServiceCdnPolicyResponseComputeV1 {
  ...
  final pulumi.Input<
    List<BackendServiceCdnPolicyBypassCacheOnRequestHeaderResponseComputeV1>
  >
  ...
  final pulumi.Input<
    List<BackendServiceCdnPolicyNegativeCachingPolicyResponseComputeV1>
  >
  ...
  factory BackendServiceCdnPolicyResponseComputeV1.fromMap(
    ...
    return BackendServiceCdnPolicyResponseComputeV1(
      bypassCacheOnRequestHeaders: pulumi.Input.fromValue(
        ...
        >(
          ...
          (value) =>
              BackendServiceCdnPolicyBypassCacheOnRequestHeaderResponseComputeV1.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
      cacheKeyPolicy: pulumi.Input.fromValue(
        CacheKeyPolicyResponseComputeV1.fromMap(
      ...
      negativeCachingPolicy: pulumi.Input.fromValue(
        ...
        >(
          ...
          (value) =>
              BackendServiceCdnPolicyNegativeCachingPolicyResponseComputeV1.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
