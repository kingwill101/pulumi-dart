...
class BackendServiceCdnPolicyResponseComputeV1 {
  ...
  factory BackendServiceCdnPolicyResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return BackendServiceCdnPolicyResponseComputeV1(
      bypassCacheOnRequestHeaders: (pulumi.Input.decodeList<BackendServiceCdnPolicyBypassCacheOnRequestHeaderResponseComputeV1>(map['bypassCacheOnRequestHeaders'], (value) => BackendServiceCdnPolicyBypassCacheOnRequestHeaderResponseComputeV1.fromMap((value as Map).cast<String, dynamic>()))).input(),
      cacheKeyPolicy: (CacheKeyPolicyResponseComputeV1.fromMap((map['cacheKeyPolicy'] as Map).cast<String, dynamic>())).input(),
      ...
      negativeCachingPolicy: (pulumi.Input.decodeList<BackendServiceCdnPolicyNegativeCachingPolicyResponseComputeV1>(map['negativeCachingPolicy'], (value) => BackendServiceCdnPolicyNegativeCachingPolicyResponseComputeV1.fromMap((value as Map).cast<String, dynamic>()))).input(),
