...
import 'target_https_proxy_compute_beta_args.dart';

/// Creates a TargetHttpsProxy resource in the specified project using the data included in the request.
class TargetHttpsProxyComputeBeta extends pulumi.CustomResource {
  ...
  /// Creates a new [TargetHttpsProxyComputeBeta].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [TargetHttpsProxyComputeBeta]. {@macro pulumi_compute_beta_target_https_proxy_compute_beta_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  TargetHttpsProxyComputeBeta(
    String name, {
    TargetHttpsProxyComputeBetaArgs? args,
