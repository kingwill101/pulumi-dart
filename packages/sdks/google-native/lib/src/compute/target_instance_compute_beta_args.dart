...
class TargetInstanceComputeBetaArgs {
  ...
  /// [zone] Optional.
  const TargetInstanceComputeBetaArgs({
    this.description,
    this.instance,
    this.name,
    this.natPolicy,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'instance': ?instance,
      'name': ?name,
      'natPolicy': ?pulumi.Input.mapOptionalInputValue<TargetInstanceNatPolicyComputeBeta, String>(natPolicy, (value) => value.wireValue),
      'network': ?network,
      'project': ?project,
      'requestId': ?requestId,
      'zone': ?zone,
  ...
  factory TargetInstanceComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return TargetInstanceComputeBetaArgs(
      ...
      natPolicy: (() { final guardedValue = map['natPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TargetInstanceNatPolicyComputeBeta.fromValue(guardedValue as String)); })(),
