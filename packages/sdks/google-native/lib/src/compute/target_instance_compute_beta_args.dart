...
class TargetInstanceComputeBetaArgs {
  ...
  TargetInstanceComputeBetaArgs({
    ...
    pulumi.Output<TargetInstanceNatPolicyComputeBeta>? natPolicy,
    ...
    pulumi.Output<String>? zone,
      ...
      natPolicy = pulumi.Input.asOptionalInput<TargetInstanceNatPolicyComputeBeta>(natPolicy),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'instance': ?instance,
      'name': ?name,
      'natPolicy': ?pulumi.Input.mapOptionalInputValue<TargetInstanceNatPolicyComputeBeta, String>(natPolicy, (value) => value.value),
      'network': ?network,
      'project': ?project,
      'requestId': ?requestId,
      'zone': ?zone,
  ...
  factory TargetInstanceComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return TargetInstanceComputeBetaArgs(
      ...
      natPolicy: map['natPolicy'] == null ? null : pulumi.Output.create<TargetInstanceNatPolicyComputeBeta>(TargetInstanceNatPolicyComputeBeta.fromValue(map['natPolicy'] as String)),
