...
class AttachedDiskResponseComputeBeta {
  ...
  final pulumi.Input<AttachedDiskInitializeParamsResponseComputeBeta>
  initializeParams;
  ...
  final pulumi.Input<InitialStateConfigResponseComputeBeta>
  ...
  factory AttachedDiskResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return AttachedDiskResponseComputeBeta(
      ...
      initializeParams: pulumi.Input.fromValue(
        AttachedDiskInitializeParamsResponseComputeBeta.fromMap(
      ...
      shieldedInstanceInitialState: pulumi.Input.fromValue(
      ...
      userLicenses: pulumi.Input.fromValue(
