...
class AttachedDiskResponseComputeBeta {
  ...
  final AttachedDiskInitializeParamsResponseComputeBeta initializeParams;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'index': index,
      'initializeParams': initializeParams.toMap(),
      'interface': interface,
      'kind': kind,
      'licenses': licenses,
      'locked': locked,
  ...
  factory AttachedDiskResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return AttachedDiskResponseComputeBeta(
      ...
      initializeParams: AttachedDiskInitializeParamsResponseComputeBeta.fromMap((map['initializeParams'] as Map).cast<String, dynamic>()),
      ...
      shieldedInstanceInitialState: InitialStateConfigResponseComputeBeta.fromMap((map['shieldedInstanceInitialState'] as Map).cast<String, dynamic>()),
