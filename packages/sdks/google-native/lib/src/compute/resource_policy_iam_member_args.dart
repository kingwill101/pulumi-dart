...
/// {@template pulumi_compute_alpha_resource_policy_iam_member_args_doc}
/// The set of arguments for ResourcePolicyIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_alpha_resource_policy_iam_member_args_doc}
class ResourcePolicyIamMemberArgs {
  ...
  /// Creates a new [ResourcePolicyIamMemberArgs].
  ...
  const ResourcePolicyIamMemberArgs({
    this.condition,
  ...
  factory ResourcePolicyIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return ResourcePolicyIamMemberArgs(
