...
class RouterNatRuleComputeV1 {
  ...
  factory RouterNatRuleComputeV1.fromMap(Map<String, dynamic> map) {
    return RouterNatRuleComputeV1(
      action: (() { final guardedValue = map['action']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RouterNatRuleActionComputeV1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
