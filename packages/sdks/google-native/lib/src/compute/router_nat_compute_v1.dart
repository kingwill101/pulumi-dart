...
class RouterNatComputeV1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'autoNetworkTier': ?pulumi.Input.mapOptionalInputValue<RouterNatAutoNetworkTierComputeV1, String>(autoNetworkTier, (value) => value.wireValue),
      ...
      'endpointTypes': ?pulumi.Input.mapOptionalInputValue<List<RouterNatEndpointTypesItemComputeV1>, List<String>>(endpointTypes, (value) => pulumi.Input.encodeList<RouterNatEndpointTypesItemComputeV1, String>(value, (value) => value.wireValue)),
      ...
      'name': ?name,
      'natIpAllocateOption': ?pulumi.Input.mapOptionalInputValue<RouterNatNatIpAllocateOptionComputeV1, String>(natIpAllocateOption, (value) => value.wireValue),
      'natIps': ?natIps,
      ...
      'sourceSubnetworkIpRangesToNat': ?pulumi.Input.mapOptionalInputValue<RouterNatSourceSubnetworkIpRangesToNatComputeV1, String>(sourceSubnetworkIpRangesToNat, (value) => value.wireValue),
      ...
      'type': ?pulumi.Input.mapOptionalInputValue<RouterNatTypeComputeV1, String>(type, (value) => value.wireValue),
  ...
  factory RouterNatComputeV1.fromMap(Map<String, dynamic> map) {
    return RouterNatComputeV1(
      autoNetworkTier: (() { final guardedValue = map['autoNetworkTier']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RouterNatAutoNetworkTierComputeV1.fromValue(guardedValue as String)); })(),
      ...
      endpointTypes: (() { final guardedValue = map['endpointTypes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RouterNatEndpointTypesItemComputeV1>(guardedValue, (value) => RouterNatEndpointTypesItemComputeV1.fromValue(value as String))); })(),
      ...
      logConfig: (() { final guardedValue = map['logConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RouterNatLogConfigComputeV1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      natIpAllocateOption: (() { final guardedValue = map['natIpAllocateOption']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RouterNatNatIpAllocateOptionComputeV1.fromValue(guardedValue as String)); })(),
      ...
      rules: (() { final guardedValue = map['rules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RouterNatRuleComputeV1>(guardedValue, (value) => RouterNatRuleComputeV1.fromMap((value as Map).cast<String, dynamic>()))); })(),
      sourceSubnetworkIpRangesToNat: (() { final guardedValue = map['sourceSubnetworkIpRangesToNat']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RouterNatSourceSubnetworkIpRangesToNatComputeV1.fromValue(guardedValue as String)); })(),
      subnetworks: (() { final guardedValue = map['subnetworks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RouterNatSubnetworkToNatComputeV1>(guardedValue, (value) => RouterNatSubnetworkToNatComputeV1.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RouterNatTypeComputeV1.fromValue(guardedValue as String)); })(),
