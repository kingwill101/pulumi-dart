...
class ResourcePolicyWeeklyCycleDayOfWeekComputeBeta {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'day': ?pulumi.Input.mapOptionalInputValue<ResourcePolicyWeeklyCycleDayOfWeekDayComputeBeta, String>(day, (value) => value.wireValue),
      'startTime': ?startTime,
    };
  }
  ...
  factory ResourcePolicyWeeklyCycleDayOfWeekComputeBeta.fromMap(Map<String, dynamic> map) {
    return ResourcePolicyWeeklyCycleDayOfWeekComputeBeta(
      day: (() { final guardedValue = map['day']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResourcePolicyWeeklyCycleDayOfWeekDayComputeBeta.fromValue(guardedValue as String)); })(),
