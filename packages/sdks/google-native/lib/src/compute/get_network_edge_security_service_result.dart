...
class GetNetworkEdgeSecurityServiceResult {
  ...
  /// Creates a new [GetNetworkEdgeSecurityServiceResult].
  ...
  const GetNetworkEdgeSecurityServiceResult({
  ...
  factory GetNetworkEdgeSecurityServiceResult.fromMap(Map<String, dynamic> map) {
