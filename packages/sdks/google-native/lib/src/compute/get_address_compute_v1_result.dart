...
class GetAddressComputeV1Result {
  ...
  /// Creates a new [GetAddressComputeV1Result].
  ...
  const GetAddressComputeV1Result({
  ...
  factory GetAddressComputeV1Result.fromMap(Map<String, dynamic> map) {
    return GetAddressComputeV1Result(
