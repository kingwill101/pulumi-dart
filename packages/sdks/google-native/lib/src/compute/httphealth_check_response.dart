...
class HTTPHealthCheckResponse {
  ...
  /// Creates a new [HTTPHealthCheckResponse].
  ...
  factory HTTPHealthCheckResponse.fromMap(Map<String, dynamic> map) {
    return HTTPHealthCheckResponse(
      ...
      weightReportMode: pulumi.Input.fromValue(
