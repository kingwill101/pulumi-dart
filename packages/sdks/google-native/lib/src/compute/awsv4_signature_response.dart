...
class AWSV4SignatureResponse {
  ...
  /// Creates a new [AWSV4SignatureResponse].
  ...
  factory AWSV4SignatureResponse.fromMap(Map<String, dynamic> map) {
    return AWSV4SignatureResponse(
