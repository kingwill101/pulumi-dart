...
class SecurityPolicyRulePreconfiguredWafConfigComputeV1 {
  ...
  factory SecurityPolicyRulePreconfiguredWafConfigComputeV1.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRulePreconfiguredWafConfigComputeV1(
      exclusions: (() { final guardedValue = map['exclusions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SecurityPolicyRulePreconfiguredWafConfigExclusionComputeV1>(guardedValue, (value) => SecurityPolicyRulePreconfiguredWafConfigExclusionComputeV1.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
