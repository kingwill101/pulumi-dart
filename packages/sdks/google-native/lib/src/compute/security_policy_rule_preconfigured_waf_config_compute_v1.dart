...
class SecurityPolicyRulePreconfiguredWafConfigComputeV1 {
  ...
  final pulumi.Input<
    List<SecurityPolicyRulePreconfiguredWafConfigExclusionComputeV1>
  >?
  exclusions;
  ...
  SecurityPolicyRulePreconfiguredWafConfigComputeV1({this.exclusions});
      ...
      exclusions: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                SecurityPolicyRulePreconfiguredWafConfigExclusionComputeV1.fromMap(
