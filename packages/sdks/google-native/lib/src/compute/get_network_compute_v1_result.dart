...
import 'network_peering_response_compute_v1.dart';
import 'network_routing_config_response_compute_v1.dart';

/// Result data returned by getNetwork.
class GetNetworkComputeV1Result {
  ...
  final List<NetworkPeeringResponseComputeV1> peerings;
  /// The network-level routing configuration for this network. Used by Cloud Router to determine what type of network-wide routing behavior to enforce.
  final NetworkRoutingConfigResponseComputeV1 routingConfig;
  ...
  /// Creates a new [GetNetworkComputeV1Result].
  ...
  const GetNetworkComputeV1Result({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'peerings': pulumi.Input.encodeList<NetworkPeeringResponseComputeV1, Map<String, dynamic>>(peerings, (value) => value.toMap()),
  ...
  factory GetNetworkComputeV1Result.fromMap(Map<String, dynamic> map) {
    return GetNetworkComputeV1Result(
      ...
      peerings: pulumi.Input.decodeList<NetworkPeeringResponseComputeV1>(map['peerings']!, (value) => NetworkPeeringResponseComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      routingConfig: NetworkRoutingConfigResponseComputeV1.fromMap((map['routingConfig']! as Map).cast<String, dynamic>()),
