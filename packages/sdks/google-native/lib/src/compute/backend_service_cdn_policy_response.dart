...
class BackendServiceCdnPolicyResponse {
  ...
  final pulumi.Input<List<BackendServiceCdnPolicyBypassCacheOnRequestHeaderResponse>> bypassCacheOnRequestHeaders;
  /// The CacheKeyPolicy for this CdnPolicy.
  final pulumi.Input<CacheKeyPolicyResponse> cacheKeyPolicy;
  ...
  final pulumi.Input<List<BackendServiceCdnPolicyNegativeCachingPolicyResponse>> negativeCachingPolicy;
  ...
  const BackendServiceCdnPolicyResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'bypassCacheOnRequestHeaders': pulumi.Input.mapInputValue<List<BackendServiceCdnPolicyBypassCacheOnRequestHeaderResponse>, List<Map<String, dynamic>>>(bypassCacheOnRequestHeaders, (value) => pulumi.Input.encodeList<BackendServiceCdnPolicyBypassCacheOnRequestHeaderResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'cacheKeyPolicy': pulumi.Input.mapInputValue<CacheKeyPolicyResponse, Map<String, dynamic>>(cacheKeyPolicy, (value) => value.toMap()),
      'cacheMode': cacheMode,
      'clientTtl': clientTtl,
      'defaultTtl': defaultTtl,
      'maxTtl': maxTtl,
      'negativeCaching': negativeCaching,
      'negativeCachingPolicy': pulumi.Input.mapInputValue<List<BackendServiceCdnPolicyNegativeCachingPolicyResponse>, List<Map<String, dynamic>>>(negativeCachingPolicy, (value) => pulumi.Input.encodeList<BackendServiceCdnPolicyNegativeCachingPolicyResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory BackendServiceCdnPolicyResponse.fromMap(Map<String, dynamic> map) {
    return BackendServiceCdnPolicyResponse(
      bypassCacheOnRequestHeaders: pulumi.Input.fromValue(pulumi.Input.decodeList<BackendServiceCdnPolicyBypassCacheOnRequestHeaderResponse>(map['bypassCacheOnRequestHeaders']!, (value) => BackendServiceCdnPolicyBypassCacheOnRequestHeaderResponse.fromMap((value as Map).cast<String, dynamic>()))),
      cacheKeyPolicy: pulumi.Input.fromValue(CacheKeyPolicyResponse.fromMap((map['cacheKeyPolicy']! as Map).cast<String, dynamic>())),
      ...
      negativeCachingPolicy: pulumi.Input.fromValue(pulumi.Input.decodeList<BackendServiceCdnPolicyNegativeCachingPolicyResponse>(map['negativeCachingPolicy']!, (value) => BackendServiceCdnPolicyNegativeCachingPolicyResponse.fromMap((value as Map).cast<String, dynamic>()))),
