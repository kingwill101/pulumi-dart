...
class BackendServiceCdnPolicyResponse {
  ...
  final pulumi.Input<
    List<BackendServiceCdnPolicyBypassCacheOnRequestHeaderResponse>
  >
  ...
  final pulumi.Input<List<BackendServiceCdnPolicyNegativeCachingPolicyResponse>>
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'negativeCachingPolicy':
          pulumi.Input.mapInputValue<
            List<BackendServiceCdnPolicyNegativeCachingPolicyResponse>,
            List<Map<String, dynamic>>
          >(
            negativeCachingPolicy,
            (value) =>
  ...
  factory BackendServiceCdnPolicyResponse.fromMap(Map<String, dynamic> map) {
    return BackendServiceCdnPolicyResponse(
      ...
      cacheKeyPolicy: pulumi.Input.fromValue(
        CacheKeyPolicyResponse.fromMap(
