...
class BackendServiceCdnPolicyResponse {
  ...
  final List<BackendServiceCdnPolicyBypassCacheOnRequestHeaderResponse> bypassCacheOnRequestHeaders;
  ...
  final List<BackendServiceCdnPolicyNegativeCachingPolicyResponse> negativeCachingPolicy;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'bypassCacheOnRequestHeaders': pulumi.Input.encodeList<BackendServiceCdnPolicyBypassCacheOnRequestHeaderResponse, Map<String, dynamic>>(bypassCacheOnRequestHeaders, (value) => value.toMap()),
      ...
      'negativeCachingPolicy': pulumi.Input.encodeList<BackendServiceCdnPolicyNegativeCachingPolicyResponse, Map<String, dynamic>>(negativeCachingPolicy, (value) => value.toMap()),
  ...
  factory BackendServiceCdnPolicyResponse.fromMap(Map<String, dynamic> map) {
    return BackendServiceCdnPolicyResponse(
      bypassCacheOnRequestHeaders: pulumi.Input.decodeList<BackendServiceCdnPolicyBypassCacheOnRequestHeaderResponse>(map['bypassCacheOnRequestHeaders'], (value) => BackendServiceCdnPolicyBypassCacheOnRequestHeaderResponse.fromMap((value as Map).cast<String, dynamic>())),
      cacheKeyPolicy: CacheKeyPolicyResponse.fromMap((map['cacheKeyPolicy'] as Map).cast<String, dynamic>()),
      ...
      negativeCachingPolicy: pulumi.Input.decodeList<BackendServiceCdnPolicyNegativeCachingPolicyResponse>(map['negativeCachingPolicy'], (value) => BackendServiceCdnPolicyNegativeCachingPolicyResponse.fromMap((value as Map).cast<String, dynamic>())),
