...
class BackendServiceCdnPolicyResponse {
  ...
  factory BackendServiceCdnPolicyResponse.fromMap(Map<String, dynamic> map) {
    return BackendServiceCdnPolicyResponse(
      bypassCacheOnRequestHeaders: (pulumi.Input.decodeList<BackendServiceCdnPolicyBypassCacheOnRequestHeaderResponse>(map['bypassCacheOnRequestHeaders'], (value) => BackendServiceCdnPolicyBypassCacheOnRequestHeaderResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      cacheKeyPolicy: (CacheKeyPolicyResponse.fromMap((map['cacheKeyPolicy'] as Map).cast<String, dynamic>())).input(),
      ...
      negativeCachingPolicy: (pulumi.Input.decodeList<BackendServiceCdnPolicyNegativeCachingPolicyResponse>(map['negativeCachingPolicy'], (value) => BackendServiceCdnPolicyNegativeCachingPolicyResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
