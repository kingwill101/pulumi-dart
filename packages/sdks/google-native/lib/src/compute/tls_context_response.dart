...
class TlsContextResponse {
  ...
  factory TlsContextResponse.fromMap(Map<String, dynamic> map) {
    return TlsContextResponse(
      certificateContext: pulumi.Input.fromValue(TlsCertificateContextResponse.fromMap((map['certificateContext']! as Map).cast<String, dynamic>())),
      validationContext: pulumi.Input.fromValue(TlsValidationContextResponse.fromMap((map['validationContext']! as Map).cast<String, dynamic>())),
    );
  }
}
