...
/// {@template pulumi_compute_beta_subnetwork_iam_member_compute_beta_args_doc}
/// The set of arguments for SubnetworkIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_subnetwork_iam_member_compute_beta_args_doc}
class SubnetworkIamMemberComputeBetaArgs {
  ...
  /// Creates a new [SubnetworkIamMemberComputeBetaArgs].
  ...
  const SubnetworkIamMemberComputeBetaArgs({
    this.condition,
  ...
  factory SubnetworkIamMemberComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return SubnetworkIamMemberComputeBetaArgs(
