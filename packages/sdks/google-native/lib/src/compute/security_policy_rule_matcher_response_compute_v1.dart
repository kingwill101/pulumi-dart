...
class SecurityPolicyRuleMatcherResponseComputeV1 {
  ...
  const SecurityPolicyRuleMatcherResponseComputeV1({
  ...
  factory SecurityPolicyRuleMatcherResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRuleMatcherResponseComputeV1(
      config: pulumi.Input.fromValue(SecurityPolicyRuleMatcherConfigResponseComputeV1.fromMap((map['config']! as Map).cast<String, dynamic>())),
      expr: pulumi.Input.fromValue(ExprResponseComputeV1.fromMap((map['expr']! as Map).cast<String, dynamic>())),
