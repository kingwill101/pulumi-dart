...
import 'custom_error_response_policy_custom_error_response_rule_response_compute_beta.dart';

/// Specifies the custom error response policy that must be applied when the backend service or backend bucket responds with an error.
class CustomErrorResponsePolicyResponseComputeBeta {
  ...
  final pulumi.Input<List<CustomErrorResponsePolicyCustomErrorResponseRuleResponseComputeBeta>> errorResponseRules;
  ...
  /// Creates a new [CustomErrorResponsePolicyResponseComputeBeta].
  ...
  const CustomErrorResponsePolicyResponseComputeBeta({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'errorResponseRules': pulumi.Input.mapInputValue<List<CustomErrorResponsePolicyCustomErrorResponseRuleResponseComputeBeta>, List<Map<String, dynamic>>>(errorResponseRules, (value) => pulumi.Input.encodeList<CustomErrorResponsePolicyCustomErrorResponseRuleResponseComputeBeta, Map<String, dynamic>>(value, (value) => value.toMap())),
      'errorService': errorService,
    };
  }

  factory CustomErrorResponsePolicyResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return CustomErrorResponsePolicyResponseComputeBeta(
      errorResponseRules: pulumi.Input.fromValue(pulumi.Input.decodeList<CustomErrorResponsePolicyCustomErrorResponseRuleResponseComputeBeta>(map['errorResponseRules']!, (value) => CustomErrorResponsePolicyCustomErrorResponseRuleResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))),
      errorService: pulumi.Input.fromValue(map['errorService'] as String),
    );
  }
}
