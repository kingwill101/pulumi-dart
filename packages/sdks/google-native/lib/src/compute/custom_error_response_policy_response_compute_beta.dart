...
class CustomErrorResponsePolicyResponseComputeBeta {
  ...
  factory CustomErrorResponsePolicyResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return CustomErrorResponsePolicyResponseComputeBeta(
      errorResponseRules: (pulumi.Input.decodeList<CustomErrorResponsePolicyCustomErrorResponseRuleResponseComputeBeta>(map['errorResponseRules'], (value) => CustomErrorResponsePolicyCustomErrorResponseRuleResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))).input(),
      errorService: (map['errorService'] as String).input(),
    );
  }
}
