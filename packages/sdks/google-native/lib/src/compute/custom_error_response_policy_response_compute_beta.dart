...
class CustomErrorResponsePolicyResponseComputeBeta {
  ...
  final pulumi.Input<
    List<CustomErrorResponsePolicyCustomErrorResponseRuleResponseComputeBeta>
  >
  errorResponseRules;
  ...
  factory CustomErrorResponsePolicyResponseComputeBeta.fromMap(
    Map<String, dynamic> map,
  ) {
    return CustomErrorResponsePolicyResponseComputeBeta(
      errorResponseRules: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          CustomErrorResponsePolicyCustomErrorResponseRuleResponseComputeBeta
        >(
          map['errorResponseRules']!,
          (value) =>
              CustomErrorResponsePolicyCustomErrorResponseRuleResponseComputeBeta.fromMap(
