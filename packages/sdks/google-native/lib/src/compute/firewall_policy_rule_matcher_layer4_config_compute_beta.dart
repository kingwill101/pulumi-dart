...
class FirewallPolicyRuleMatcherLayer4ConfigComputeBeta {
  ...
  /// Creates a new [FirewallPolicyRuleMatcherLayer4ConfigComputeBeta].
  ...
  const FirewallPolicyRuleMatcherLayer4ConfigComputeBeta({
    this.ipProtocol,
    this.ports,
  });
  ...
  factory FirewallPolicyRuleMatcherLayer4ConfigComputeBeta.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyRuleMatcherLayer4ConfigComputeBeta(
