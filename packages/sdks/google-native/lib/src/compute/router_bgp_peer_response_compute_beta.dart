...
class RouterBgpPeerResponseComputeBeta {
  ...
  factory RouterBgpPeerResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return RouterBgpPeerResponseComputeBeta(
      ...
      advertisedIpRanges: (pulumi.Input.decodeList<RouterAdvertisedIpRangeResponseComputeBeta>(map['advertisedIpRanges'], (value) => RouterAdvertisedIpRangeResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))).input(),
      advertisedRoutePriority: (map['advertisedRoutePriority'] as int).input(),
      bfd: (RouterBgpPeerBfdResponseComputeBeta.fromMap((map['bfd'] as Map).cast<String, dynamic>())).input(),
      customLearnedIpRanges: (pulumi.Input.decodeList<RouterBgpPeerCustomLearnedIpRangeResponseComputeBeta>(map['customLearnedIpRanges'], (value) => RouterBgpPeerCustomLearnedIpRangeResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))).input(),
