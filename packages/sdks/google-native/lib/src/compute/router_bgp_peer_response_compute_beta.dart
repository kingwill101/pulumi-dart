...
class RouterBgpPeerResponseComputeBeta {
  ...
  final pulumi.Input<List<RouterAdvertisedIpRangeResponseComputeBeta>>
  advertisedIpRanges;
  ...
  final pulumi.Input<List<RouterBgpPeerCustomLearnedIpRangeResponseComputeBeta>>
    ...
    return <String, dynamic>{
      ...
      'advertisedIpRanges':
          pulumi.Input.mapInputValue<
            List<RouterAdvertisedIpRangeResponseComputeBeta>,
      ...
      'customLearnedIpRanges':
          pulumi.Input.mapInputValue<
            List<RouterBgpPeerCustomLearnedIpRangeResponseComputeBeta>,
            List<Map<String, dynamic>>
          >(
            customLearnedIpRanges,
            (value) =>
  ...
  factory RouterBgpPeerResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return RouterBgpPeerResponseComputeBeta(
      ...
      bfd: pulumi.Input.fromValue(
        RouterBgpPeerBfdResponseComputeBeta.fromMap(
      ...
      ipv4NexthopAddress: pulumi.Input.fromValue(
      ...
      peerIpv4NexthopAddress: pulumi.Input.fromValue(
