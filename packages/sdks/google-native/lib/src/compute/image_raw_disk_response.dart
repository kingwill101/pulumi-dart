...
class ImageRawDiskResponse {
  ...
  /// Creates a new [ImageRawDiskResponse].
  ...
  factory ImageRawDiskResponse.fromMap(Map<String, dynamic> map) {
    return ImageRawDiskResponse(
      containerType: pulumi.Input.fromValue(map['containerType'] as String),
      sha1Checksum: pulumi.Input.fromValue(map['sha1Checksum'] as String),
