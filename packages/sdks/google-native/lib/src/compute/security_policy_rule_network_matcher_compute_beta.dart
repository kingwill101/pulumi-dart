...
class SecurityPolicyRuleNetworkMatcherComputeBeta {
  ...
  final pulumi.Input<List<SecurityPolicyRuleNetworkMatcherUserDefinedFieldMatchComputeBeta>>? userDefinedFields;
  ...
  factory SecurityPolicyRuleNetworkMatcherComputeBeta.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRuleNetworkMatcherComputeBeta(
      ...
      userDefinedFields: map['userDefinedFields'] == null ? null : (pulumi.Input.decodeList<SecurityPolicyRuleNetworkMatcherUserDefinedFieldMatchComputeBeta>(map['userDefinedFields']!, (value) => SecurityPolicyRuleNetworkMatcherUserDefinedFieldMatchComputeBeta.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
