...
class SecurityPolicyRuleNetworkMatcherComputeBeta {
  ...
  const SecurityPolicyRuleNetworkMatcherComputeBeta({
    this.destIpRanges,
    this.destPorts,
    this.ipProtocols,
    this.srcAsns,
  ...
  factory SecurityPolicyRuleNetworkMatcherComputeBeta.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRuleNetworkMatcherComputeBeta(
      ...
      userDefinedFields: (() { final guardedValue = map['userDefinedFields']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SecurityPolicyRuleNetworkMatcherUserDefinedFieldMatchComputeBeta>(guardedValue, (value) => SecurityPolicyRuleNetworkMatcherUserDefinedFieldMatchComputeBeta.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
