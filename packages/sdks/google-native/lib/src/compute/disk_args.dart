    ...
    return DiskArgs(
      accessMode: (() {
        ...
        return pulumi.Input.fromValue(
          DiskAccessMode.fromValue(guardedValue as String),
        );
      })(),
      architecture: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DiskArchitecture.fromValue(guardedValue as String),
        );
      })(),
      asyncPrimaryDisk: (() {
      ...
      interface: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DiskInterface.fromValue(guardedValue as String),
        );
      })(),
      labels: (() {
      ...
      storageType: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DiskStorageType.fromValue(guardedValue as String),
        );
      })(),
      type: (() {
