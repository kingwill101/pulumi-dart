...
class DiskArgs {
  ...
  factory DiskArgs.fromMap(Map<String, dynamic> map) {
    return DiskArgs(
      accessMode: map['accessMode'] == null ? null : (DiskAccessMode.fromValue(map['accessMode']! as String)).input(),
      architecture: map['architecture'] == null ? null : (DiskArchitecture.fromValue(map['architecture']! as String)).input(),
      ...
      interface: map['interface'] == null ? null : (DiskInterface.fromValue(map['interface']! as String)).input(),
      ...
      storageType: map['storageType'] == null ? null : (DiskStorageType.fromValue(map['storageType']! as String)).input(),
