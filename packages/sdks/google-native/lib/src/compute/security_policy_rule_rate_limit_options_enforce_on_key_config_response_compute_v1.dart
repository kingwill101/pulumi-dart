...
class SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponseComputeV1 {
  ...
  /// Creates a new [SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponseComputeV1].
  ...
  const SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponseComputeV1({
  ...
  factory SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponseComputeV1(
