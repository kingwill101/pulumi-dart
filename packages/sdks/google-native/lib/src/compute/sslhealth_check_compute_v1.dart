...
class SSLHealthCheckComputeV1 {
  ...
  final pulumi.Input<SSLHealthCheckPortSpecificationComputeV1>?
  portSpecification;
    ...
    return <String, dynamic>{
      ...
      'portSpecification':
          ?pulumi.Input.mapOptionalInputValue<
            SSLHealthCheckPortSpecificationComputeV1,
            String
          >(portSpecification, (value) => value.wireValue),
      'proxyHeader':
          ?pulumi.Input.mapOptionalInputValue<
            SSLHealthCheckProxyHeaderComputeV1,
            String
    ...
    return SSLHealthCheckComputeV1(
      ...
      portSpecification: (() {
        ...
        return pulumi.Input.fromValue(
          SSLHealthCheckPortSpecificationComputeV1.fromValue(
      ...
      proxyHeader: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SSLHealthCheckProxyHeaderComputeV1.fromValue(guardedValue as String),
        );
      })(),
      request: (() {
