...
class SSLHealthCheckComputeV1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'port': ?port,
      'portName': ?portName,
      'portSpecification': ?pulumi.Input.mapOptionalInputValue<SSLHealthCheckPortSpecificationComputeV1, String>(portSpecification, (value) => value.value),
      'proxyHeader': ?pulumi.Input.mapOptionalInputValue<SSLHealthCheckProxyHeaderComputeV1, String>(proxyHeader, (value) => value.value),
      'request': ?request,
      'response': ?response,
    };
  }
