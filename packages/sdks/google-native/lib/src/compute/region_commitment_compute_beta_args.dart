...
class RegionCommitmentComputeBetaArgs {
  ...
  const RegionCommitmentComputeBetaArgs({
    this.autoRenew,
    this.category,
    this.description,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'autoRenew': ?autoRenew,
      'category': ?pulumi.Input.mapOptionalInputValue<RegionCommitmentCategoryComputeBeta, String>(category, (value) => value.wireValue),
      ...
      'name': ?name,
      'plan': ?pulumi.Input.mapOptionalInputValue<RegionCommitmentPlanComputeBeta, String>(plan, (value) => value.wireValue),
      'project': ?project,
      'region': region,
      'requestId': ?requestId,
      ...
      'type': ?pulumi.Input.mapOptionalInputValue<RegionCommitmentTypeComputeBeta, String>(type, (value) => value.wireValue),
    };
  }
  ...
  factory RegionCommitmentComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return RegionCommitmentComputeBetaArgs(
      ...
      category: (() { final guardedValue = map['category']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionCommitmentCategoryComputeBeta.fromValue(guardedValue as String)); })(),
      description: (() { final guardedValue = map['description']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      licenseResource: (() { final guardedValue = map['licenseResource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LicenseResourceCommitmentComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      plan: (() { final guardedValue = map['plan']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionCommitmentPlanComputeBeta.fromValue(guardedValue as String)); })(),
      project: (() { final guardedValue = map['project']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      region: pulumi.Input.fromValue(map['region'] as String),
      requestId: (() { final guardedValue = map['requestId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      reservations: (() { final guardedValue = map['reservations']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<ReservationResource>()); })(),
      resources: (() { final guardedValue = map['resources']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ResourceCommitmentComputeBeta>(guardedValue, (value) => ResourceCommitmentComputeBeta.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionCommitmentTypeComputeBeta.fromValue(guardedValue as String)); })(),
    );
  }
}
