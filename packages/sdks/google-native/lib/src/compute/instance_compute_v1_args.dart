...
class InstanceComputeV1Args {
  ...
  InstanceComputeV1Args({
    pulumi.Output<AdvancedMachineFeaturesComputeV1>? advancedMachineFeatures,
    pulumi.Output<bool>? canIpForward,
    pulumi.Output<ConfidentialInstanceConfigComputeV1>? confidentialInstanceConfig,
    pulumi.Output<bool>? deletionProtection,
    pulumi.Output<String>? description,
    pulumi.Output<List<AttachedDiskComputeV1>>? disks,
    pulumi.Output<DisplayDeviceComputeV1>? displayDevice,
    pulumi.Output<List<AcceleratorConfigComputeV1>>? guestAccelerators,
    pulumi.Output<String>? hostname,
    pulumi.Output<CustomerEncryptionKeyComputeV1>? instanceEncryptionKey,
    pulumi.Output<InstanceKeyRevocationActionTypeComputeV1>? keyRevocationActionType,
    pulumi.Output<Map<String, String>>? labels,
    pulumi.Output<String>? machineType,
    pulumi.Output<MetadataComputeV1>? metadata,
    pulumi.Output<String>? minCpuPlatform,
    pulumi.Output<String>? name,
    pulumi.Output<List<NetworkInterfaceComputeV1>>? networkInterfaces,
    pulumi.Output<NetworkPerformanceConfigComputeV1>? networkPerformanceConfig,
    pulumi.Output<InstanceParamsComputeV1>? params,
    pulumi.Output<InstancePrivateIpv6GoogleAccessComputeV1>? privateIpv6GoogleAccess,
    pulumi.Output<String>? project,
    pulumi.Output<String>? requestId,
    pulumi.Output<ReservationAffinityComputeV1>? reservationAffinity,
    pulumi.Output<List<String>>? resourcePolicies,
    pulumi.Output<SchedulingComputeV1>? scheduling,
    pulumi.Output<List<ServiceAccountComputeV1>>? serviceAccounts,
    pulumi.Output<ShieldedInstanceConfigComputeV1>? shieldedInstanceConfig,
    pulumi.Output<ShieldedInstanceIntegrityPolicyComputeV1>? shieldedInstanceIntegrityPolicy,
    pulumi.Output<String>? sourceInstanceTemplate,
    pulumi.Output<String>? sourceMachineImage,
    pulumi.Output<CustomerEncryptionKeyComputeV1>? sourceMachineImageEncryptionKey,
    pulumi.Output<TagsComputeV1>? tags,
    pulumi.Output<String>? zone,
  }) :
      advancedMachineFeatures = pulumi.Input.asOptionalInput<AdvancedMachineFeaturesComputeV1>(advancedMachineFeatures),
      canIpForward = pulumi.Input.asOptionalInput<bool>(canIpForward),
      confidentialInstanceConfig = pulumi.Input.asOptionalInput<ConfidentialInstanceConfigComputeV1>(confidentialInstanceConfig),
      deletionProtection = pulumi.Input.asOptionalInput<bool>(deletionProtection),
      description = pulumi.Input.asOptionalInput<String>(description),
      disks = pulumi.Input.asOptionalInput<List<AttachedDiskComputeV1>>(disks),
      displayDevice = pulumi.Input.asOptionalInput<DisplayDeviceComputeV1>(displayDevice),
      guestAccelerators = pulumi.Input.asOptionalInput<List<AcceleratorConfigComputeV1>>(guestAccelerators),
      hostname = pulumi.Input.asOptionalInput<String>(hostname),
      instanceEncryptionKey = pulumi.Input.asOptionalInput<CustomerEncryptionKeyComputeV1>(instanceEncryptionKey),
      keyRevocationActionType = pulumi.Input.asOptionalInput<InstanceKeyRevocationActionTypeComputeV1>(keyRevocationActionType),
      ...
      networkInterfaces = pulumi.Input.asOptionalInput<List<NetworkInterfaceComputeV1>>(networkInterfaces),
      networkPerformanceConfig = pulumi.Input.asOptionalInput<NetworkPerformanceConfigComputeV1>(networkPerformanceConfig),
      params = pulumi.Input.asOptionalInput<InstanceParamsComputeV1>(params),
      privateIpv6GoogleAccess = pulumi.Input.asOptionalInput<InstancePrivateIpv6GoogleAccessComputeV1>(privateIpv6GoogleAccess),
      project = pulumi.Input.asOptionalInput<String>(project),
      requestId = pulumi.Input.asOptionalInput<String>(requestId),
      reservationAffinity = pulumi.Input.asOptionalInput<ReservationAffinityComputeV1>(reservationAffinity),
      resourcePolicies = pulumi.Input.asOptionalInput<List<String>>(resourcePolicies),
      scheduling = pulumi.Input.asOptionalInput<SchedulingComputeV1>(scheduling),
      serviceAccounts = pulumi.Input.asOptionalInput<List<ServiceAccountComputeV1>>(serviceAccounts),
      shieldedInstanceConfig = pulumi.Input.asOptionalInput<ShieldedInstanceConfigComputeV1>(shieldedInstanceConfig),
      shieldedInstanceIntegrityPolicy = pulumi.Input.asOptionalInput<ShieldedInstanceIntegrityPolicyComputeV1>(shieldedInstanceIntegrityPolicy),
      ...
      sourceMachineImageEncryptionKey = pulumi.Input.asOptionalInput<CustomerEncryptionKeyComputeV1>(sourceMachineImageEncryptionKey),
  ...
  factory InstanceComputeV1Args.fromMap(Map<String, dynamic> map) {
    return InstanceComputeV1Args(
      advancedMachineFeatures: map['advancedMachineFeatures'] == null ? null : pulumi.Output.create<AdvancedMachineFeaturesComputeV1>(AdvancedMachineFeaturesComputeV1.fromMap((map['advancedMachineFeatures'] as Map).cast<String, dynamic>())),
      canIpForward: map['canIpForward'] == null ? null : pulumi.Output.create<bool>(map['canIpForward'] as bool),
      confidentialInstanceConfig: map['confidentialInstanceConfig'] == null ? null : pulumi.Output.create<ConfidentialInstanceConfigComputeV1>(ConfidentialInstanceConfigComputeV1.fromMap((map['confidentialInstanceConfig'] as Map).cast<String, dynamic>())),
      deletionProtection: map['deletionProtection'] == null ? null : pulumi.Output.create<bool>(map['deletionProtection'] as bool),
      description: map['description'] == null ? null : pulumi.Output.create<String>(map['description'] as String),
      disks: map['disks'] == null ? null : pulumi.Output.create<List<AttachedDiskComputeV1>>(pulumi.Input.decodeList<AttachedDiskComputeV1>(map['disks'], (value) => AttachedDiskComputeV1.fromMap((value as Map).cast<String, dynamic>()))),
      displayDevice: map['displayDevice'] == null ? null : pulumi.Output.create<DisplayDeviceComputeV1>(DisplayDeviceComputeV1.fromMap((map['displayDevice'] as Map).cast<String, dynamic>())),
      guestAccelerators: map['guestAccelerators'] == null ? null : pulumi.Output.create<List<AcceleratorConfigComputeV1>>(pulumi.Input.decodeList<AcceleratorConfigComputeV1>(map['guestAccelerators'], (value) => AcceleratorConfigComputeV1.fromMap((value as Map).cast<String, dynamic>()))),
      hostname: map['hostname'] == null ? null : pulumi.Output.create<String>(map['hostname'] as String),
      instanceEncryptionKey: map['instanceEncryptionKey'] == null ? null : pulumi.Output.create<CustomerEncryptionKeyComputeV1>(CustomerEncryptionKeyComputeV1.fromMap((map['instanceEncryptionKey'] as Map).cast<String, dynamic>())),
      keyRevocationActionType: map['keyRevocationActionType'] == null ? null : pulumi.Output.create<InstanceKeyRevocationActionTypeComputeV1>(InstanceKeyRevocationActionTypeComputeV1.fromValue(map['keyRevocationActionType'] as String)),
      labels: map['labels'] == null ? null : pulumi.Output.create<Map<String, String>>((map['labels'] as Map).cast<String, String>()),
      machineType: map['machineType'] == null ? null : pulumi.Output.create<String>(map['machineType'] as String),
      metadata: map['metadata'] == null ? null : pulumi.Output.create<MetadataComputeV1>(MetadataComputeV1.fromMap((map['metadata'] as Map).cast<String, dynamic>())),
      minCpuPlatform: map['minCpuPlatform'] == null ? null : pulumi.Output.create<String>(map['minCpuPlatform'] as String),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      networkInterfaces: map['networkInterfaces'] == null ? null : pulumi.Output.create<List<NetworkInterfaceComputeV1>>(pulumi.Input.decodeList<NetworkInterfaceComputeV1>(map['networkInterfaces'], (value) => NetworkInterfaceComputeV1.fromMap((value as Map).cast<String, dynamic>()))),
      networkPerformanceConfig: map['networkPerformanceConfig'] == null ? null : pulumi.Output.create<NetworkPerformanceConfigComputeV1>(NetworkPerformanceConfigComputeV1.fromMap((map['networkPerformanceConfig'] as Map).cast<String, dynamic>())),
      params: map['params'] == null ? null : pulumi.Output.create<InstanceParamsComputeV1>(InstanceParamsComputeV1.fromMap((map['params'] as Map).cast<String, dynamic>())),
      privateIpv6GoogleAccess: map['privateIpv6GoogleAccess'] == null ? null : pulumi.Output.create<InstancePrivateIpv6GoogleAccessComputeV1>(InstancePrivateIpv6GoogleAccessComputeV1.fromValue(map['privateIpv6GoogleAccess'] as String)),
      project: map['project'] == null ? null : pulumi.Output.create<String>(map['project'] as String),
      requestId: map['requestId'] == null ? null : pulumi.Output.create<String>(map['requestId'] as String),
      reservationAffinity: map['reservationAffinity'] == null ? null : pulumi.Output.create<ReservationAffinityComputeV1>(ReservationAffinityComputeV1.fromMap((map['reservationAffinity'] as Map).cast<String, dynamic>())),
      ...
      scheduling: map['scheduling'] == null ? null : pulumi.Output.create<SchedulingComputeV1>(SchedulingComputeV1.fromMap((map['scheduling'] as Map).cast<String, dynamic>())),
      serviceAccounts: map['serviceAccounts'] == null ? null : pulumi.Output.create<List<ServiceAccountComputeV1>>(pulumi.Input.decodeList<ServiceAccountComputeV1>(map['serviceAccounts'], (value) => ServiceAccountComputeV1.fromMap((value as Map).cast<String, dynamic>()))),
      shieldedInstanceConfig: map['shieldedInstanceConfig'] == null ? null : pulumi.Output.create<ShieldedInstanceConfigComputeV1>(ShieldedInstanceConfigComputeV1.fromMap((map['shieldedInstanceConfig'] as Map).cast<String, dynamic>())),
      shieldedInstanceIntegrityPolicy: map['shieldedInstanceIntegrityPolicy'] == null ? null : pulumi.Output.create<ShieldedInstanceIntegrityPolicyComputeV1>(ShieldedInstanceIntegrityPolicyComputeV1.fromMap((map['shieldedInstanceIntegrityPolicy'] as Map).cast<String, dynamic>())),
      ...
      sourceMachineImageEncryptionKey: map['sourceMachineImageEncryptionKey'] == null ? null : pulumi.Output.create<CustomerEncryptionKeyComputeV1>(CustomerEncryptionKeyComputeV1.fromMap((map['sourceMachineImageEncryptionKey'] as Map).cast<String, dynamic>())),
      tags: map['tags'] == null ? null : pulumi.Output.create<TagsComputeV1>(TagsComputeV1.fromMap((map['tags'] as Map).cast<String, dynamic>())),
