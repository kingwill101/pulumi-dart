...
class NetworkEndpointGroupAppEngineResponseComputeBeta {
  ...
  /// Creates a new [NetworkEndpointGroupAppEngineResponseComputeBeta].
  ...
  const NetworkEndpointGroupAppEngineResponseComputeBeta({
  ...
  factory NetworkEndpointGroupAppEngineResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return NetworkEndpointGroupAppEngineResponseComputeBeta(
