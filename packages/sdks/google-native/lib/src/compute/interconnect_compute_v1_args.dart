...
class InterconnectComputeV1Args {
  ...
  const InterconnectComputeV1Args({
    this.adminEnabled,
    this.customerName,
    this.description,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'interconnectType': ?pulumi.Input.mapOptionalInputValue<InterconnectInterconnectTypeComputeV1, String>(interconnectType, (value) => value.wireValue),
      'labels': ?labels,
      'linkType': ?pulumi.Input.mapOptionalInputValue<InterconnectLinkTypeComputeV1, String>(linkType, (value) => value.wireValue),
      'location': ?location,
      ...
      'requestId': ?requestId,
      'requestedFeatures': ?pulumi.Input.mapOptionalInputValue<List<InterconnectRequestedFeaturesItemComputeV1>, List<String>>(requestedFeatures, (value) => pulumi.Input.encodeList<InterconnectRequestedFeaturesItemComputeV1, String>(value, (value) => value.wireValue)),
  ...
  factory InterconnectComputeV1Args.fromMap(Map<String, dynamic> map) {
    return InterconnectComputeV1Args(
      ...
      interconnectType: (() { final guardedValue = map['interconnectType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InterconnectInterconnectTypeComputeV1.fromValue(guardedValue as String)); })(),
      labels: (() { final guardedValue = map['labels']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      linkType: (() { final guardedValue = map['linkType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InterconnectLinkTypeComputeV1.fromValue(guardedValue as String)); })(),
      location: (() { final guardedValue = map['location']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      macsec: (() { final guardedValue = map['macsec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InterconnectMacsecComputeV1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      requestedFeatures: (() { final guardedValue = map['requestedFeatures']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InterconnectRequestedFeaturesItemComputeV1>(guardedValue, (value) => InterconnectRequestedFeaturesItemComputeV1.fromValue(value as String))); })(),
