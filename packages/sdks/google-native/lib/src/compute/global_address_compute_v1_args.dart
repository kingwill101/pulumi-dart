    ...
    return GlobalAddressComputeV1Args(
      ...
      addressType: (() {
        ...
        return pulumi.Input.fromValue(
          GlobalAddressAddressTypeComputeV1.fromValue(guardedValue as String),
        );
      })(),
      description: (() {
      ...
      ipVersion: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GlobalAddressIpVersionComputeV1.fromValue(guardedValue as String),
        );
      })(),
      ipv6EndpointType: (() {
      ...
      networkTier: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GlobalAddressNetworkTierComputeV1.fromValue(guardedValue as String),
        );
      })(),
      prefixLength: (() {
      ...
      purpose: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GlobalAddressPurposeComputeV1.fromValue(guardedValue as String),
        );
      })(),
      requestId: (() {
