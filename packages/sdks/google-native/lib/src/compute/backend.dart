...
class Backend {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'balancingMode': ?pulumi.Input.mapOptionalInputValue<BackendBalancingMode, String>(balancingMode, (value) => value.value),
      ...
      'preference': ?pulumi.Input.mapOptionalInputValue<BackendPreference, String>(preference, (value) => value.value),
    };
  }

  factory Backend.fromMap(Map<String, dynamic> map) {
    return Backend(
      balancingMode: map['balancingMode'] == null ? null : (BackendBalancingMode.fromValue(map['balancingMode'] as String)).input(),
      ...
      preference: map['preference'] == null ? null : (BackendPreference.fromValue(map['preference'] as String)).input(),
    );
  }
}
