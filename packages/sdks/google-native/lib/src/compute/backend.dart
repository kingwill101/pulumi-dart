...
class Backend {
  ...
  factory Backend.fromMap(Map<String, dynamic> map) {
    return Backend(
      balancingMode: map['balancingMode'] == null ? null : BackendBalancingMode.fromValue(map['balancingMode'] as String),
      ...
      preference: map['preference'] == null ? null : BackendPreference.fromValue(map['preference'] as String),
    );
  }
}
