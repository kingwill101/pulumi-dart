...
class Backend {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'balancingMode':
          ?pulumi.Input.mapOptionalInputValue<BackendBalancingMode, String>(
            balancingMode,
      ...
      'preference':
          ?pulumi.Input.mapOptionalInputValue<BackendPreference, String>(
            preference,
            (value) => value.wireValue,
          ),
    };
    ...
    return Backend(
      balancingMode: (() {
        ...
        return pulumi.Input.fromValue(
          BackendBalancingMode.fromValue(guardedValue as String),
        );
      })(),
      capacityScaler: (() {
      ...
      preference: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          BackendPreference.fromValue(guardedValue as String),
        );
      })(),
    );
  }
