...
class InterconnectOutageNotificationResponseComputeBeta {
  ...
  /// Creates a new [InterconnectOutageNotificationResponseComputeBeta].
  ...
  const InterconnectOutageNotificationResponseComputeBeta({
  ...
  factory InterconnectOutageNotificationResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return InterconnectOutageNotificationResponseComputeBeta(
