...
/// {@template pulumi_compute_beta_network_firewall_policy_iam_binding_compute_beta_args_doc}
/// The set of arguments for NetworkFirewallPolicyIamBinding.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_network_firewall_policy_iam_binding_compute_beta_args_doc}
class NetworkFirewallPolicyIamBindingComputeBetaArgs {
  ...
  /// Creates a new [NetworkFirewallPolicyIamBindingComputeBetaArgs].
  ...
  const NetworkFirewallPolicyIamBindingComputeBetaArgs({
    this.condition,
  ...
  factory NetworkFirewallPolicyIamBindingComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return NetworkFirewallPolicyIamBindingComputeBetaArgs(
