...
class RegionTargetTcpProxyComputeV1Args {
  ...
  const RegionTargetTcpProxyComputeV1Args({
    this.description,
    this.name,
    this.project,
    this.proxyBind,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'project': ?project,
      'proxyBind': ?proxyBind,
      'proxyHeader': ?pulumi.Input.mapOptionalInputValue<RegionTargetTcpProxyProxyHeaderComputeV1, String>(proxyHeader, (value) => value.wireValue),
      'region': region,
      'requestId': ?requestId,
      'service': ?service,
    };
  ...
  factory RegionTargetTcpProxyComputeV1Args.fromMap(Map<String, dynamic> map) {
    return RegionTargetTcpProxyComputeV1Args(
      ...
      proxyHeader: (() { final guardedValue = map['proxyHeader']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionTargetTcpProxyProxyHeaderComputeV1.fromValue(guardedValue as String)); })(),
