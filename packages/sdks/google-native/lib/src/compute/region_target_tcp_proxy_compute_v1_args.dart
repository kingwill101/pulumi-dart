...
class RegionTargetTcpProxyComputeV1Args {
  ...
  RegionTargetTcpProxyComputeV1Args({
    ...
    pulumi.Output<RegionTargetTcpProxyProxyHeaderComputeV1>? proxyHeader,
    ...
    pulumi.Output<String>? service,
      ...
      proxyHeader = pulumi.Input.asOptionalInput<RegionTargetTcpProxyProxyHeaderComputeV1>(proxyHeader),
  ...
  factory RegionTargetTcpProxyComputeV1Args.fromMap(Map<String, dynamic> map) {
    return RegionTargetTcpProxyComputeV1Args(
      ...
      proxyHeader: map['proxyHeader'] == null ? null : pulumi.Output.create<RegionTargetTcpProxyProxyHeaderComputeV1>(RegionTargetTcpProxyProxyHeaderComputeV1.fromValue(map['proxyHeader'] as String)),
