...
class SSLHealthCheck {
  ...
  final SSLHealthCheckPortSpecification? portSpecification;
  /// Specifies the type of proxy header to append before sending data to the backend, either NONE or PROXY_V1. The default is NONE.
  final SSLHealthCheckProxyHeader? proxyHeader;
  ...
  factory SSLHealthCheck.fromMap(Map<String, dynamic> map) {
    return SSLHealthCheck(
      ...
      portSpecification: map['portSpecification'] == null ? null : SSLHealthCheckPortSpecification.fromValue(map['portSpecification'] as String),
      proxyHeader: map['proxyHeader'] == null ? null : SSLHealthCheckProxyHeader.fromValue(map['proxyHeader'] as String),
