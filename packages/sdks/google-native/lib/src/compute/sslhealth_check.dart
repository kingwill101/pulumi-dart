...
class SSLHealthCheck {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'port': ?port,
      'portName': ?portName,
      'portSpecification': ?pulumi.Input.mapOptionalInputValue<SSLHealthCheckPortSpecification, String>(portSpecification, (value) => value.wireValue),
      'proxyHeader': ?pulumi.Input.mapOptionalInputValue<SSLHealthCheckProxyHeader, String>(proxyHeader, (value) => value.wireValue),
      'request': ?request,
      'response': ?response,
    };
  }
  ...
  factory SSLHealthCheck.fromMap(Map<String, dynamic> map) {
    return SSLHealthCheck(
      ...
      portSpecification: (() { final guardedValue = map['portSpecification']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SSLHealthCheckPortSpecification.fromValue(guardedValue as String)); })(),
      proxyHeader: (() { final guardedValue = map['proxyHeader']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SSLHealthCheckProxyHeader.fromValue(guardedValue as String)); })(),
