...
class NotificationEndpointGrpcSettingsResponseComputeBeta {
  ...
  const NotificationEndpointGrpcSettingsResponseComputeBeta({
  ...
  factory NotificationEndpointGrpcSettingsResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return NotificationEndpointGrpcSettingsResponseComputeBeta(
      ...
      resendInterval: pulumi.Input.fromValue(DurationResponseComputeBeta.fromMap((map['resendInterval']! as Map).cast<String, dynamic>())),
