...
class NotificationEndpointGrpcSettingsResponseComputeBeta {
  ...
  final pulumi.Input<DurationResponseComputeBeta> resendInterval;
  /// How much time (in seconds) is spent attempting notification retries until a successful response is received. Default is 30s. Limit is 20m (1200s). Must be a positive number.
  final pulumi.Input<int> retryDurationSec;

  /// Creates a new [NotificationEndpointGrpcSettingsResponseComputeBeta].
  ...
  NotificationEndpointGrpcSettingsResponseComputeBeta({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'resendInterval': pulumi.Input.mapInputValue<DurationResponseComputeBeta, Map<String, dynamic>>(resendInterval, (value) => value.toMap()),
      'retryDurationSec': retryDurationSec,
    };
  }

  factory NotificationEndpointGrpcSettingsResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return NotificationEndpointGrpcSettingsResponseComputeBeta(
      authority: (map['authority'] as String).input(),
      endpoint: (map['endpoint'] as String).input(),
      payloadName: (map['payloadName'] as String).input(),
      resendInterval: (DurationResponseComputeBeta.fromMap((map['resendInterval'] as Map).cast<String, dynamic>())).input(),
      retryDurationSec: (map['retryDurationSec'] as int).input(),
    );
  }
}
