...
class VpnGateway extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<VpnGatewayVpnGatewayInterfaceResponse>> vpnInterfaces;

  /// Creates a new [VpnGateway].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [VpnGateway]. {@macro pulumi_compute_alpha_vpn_gateway_args_doc}
  ...
  VpnGateway(
    ...
    this.vpnInterfaces = registerOutput<List<VpnGatewayVpnGatewayInterfaceResponse>>('vpnInterfaces');
  }
}
