...
class FirewallPolicyRuleMatcherLayer4ConfigComputeV1 {
  ...
  /// Creates a new [FirewallPolicyRuleMatcherLayer4ConfigComputeV1].
  ...
  const FirewallPolicyRuleMatcherLayer4ConfigComputeV1({
    this.ipProtocol,
    this.ports,
  });
  ...
  factory FirewallPolicyRuleMatcherLayer4ConfigComputeV1.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyRuleMatcherLayer4ConfigComputeV1(
