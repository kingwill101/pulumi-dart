...
class PacketMirroringMirroredResourceInfoComputeV1 {
  ...
  const PacketMirroringMirroredResourceInfoComputeV1({
    this.instances,
    this.subnetworks,
    this.tags,
  });
  ...
  factory PacketMirroringMirroredResourceInfoComputeV1.fromMap(Map<String, dynamic> map) {
    return PacketMirroringMirroredResourceInfoComputeV1(
      instances: (() { final guardedValue = map['instances']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PacketMirroringMirroredResourceInfoInstanceInfoComputeV1>(guardedValue, (value) => PacketMirroringMirroredResourceInfoInstanceInfoComputeV1.fromMap((value as Map).cast<String, dynamic>()))); })(),
      subnetworks: (() { final guardedValue = map['subnetworks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PacketMirroringMirroredResourceInfoSubnetInfoComputeV1>(guardedValue, (value) => PacketMirroringMirroredResourceInfoSubnetInfoComputeV1.fromMap((value as Map).cast<String, dynamic>()))); })(),
