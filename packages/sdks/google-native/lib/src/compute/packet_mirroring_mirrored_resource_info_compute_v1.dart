...
class PacketMirroringMirroredResourceInfoComputeV1 {
  ...
  final pulumi.Input<
    List<PacketMirroringMirroredResourceInfoInstanceInfoComputeV1>
  >?
  instances;

  /// A set of subnetworks for which traffic from/to all VM instances will be mirrored. They must live in the same region as this packetMirroring. You may specify a maximum of 5 subnetworks.
  final pulumi.Input<
    List<PacketMirroringMirroredResourceInfoSubnetInfoComputeV1>
  >?
  subnetworks;
      ...
      instances: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                PacketMirroringMirroredResourceInfoInstanceInfoComputeV1.fromMap(
      ...
      subnetworks: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                PacketMirroringMirroredResourceInfoSubnetInfoComputeV1.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
