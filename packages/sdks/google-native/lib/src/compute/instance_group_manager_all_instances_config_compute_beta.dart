...
class InstanceGroupManagerAllInstancesConfigComputeBeta {
  ...
  final pulumi.Input<InstancePropertiesPatchComputeBeta>? properties;
  ...
  const InstanceGroupManagerAllInstancesConfigComputeBeta({
    this.properties,
  });
  ...
  factory InstanceGroupManagerAllInstancesConfigComputeBeta.fromMap(Map<String, dynamic> map) {
    return InstanceGroupManagerAllInstancesConfigComputeBeta(
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstancePropertiesPatchComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
