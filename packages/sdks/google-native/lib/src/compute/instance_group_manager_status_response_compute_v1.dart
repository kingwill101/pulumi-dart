...
class InstanceGroupManagerStatusResponseComputeV1 {
  ...
  final pulumi.Input<InstanceGroupManagerStatusStatefulResponseComputeV1>
  stateful;

  /// A status of consistency of Instances' versions with their target version specified by version field on Instance Group Manager.
  final pulumi.Input<InstanceGroupManagerStatusVersionTargetResponseComputeV1>
  versionTarget;
  ...
  factory InstanceGroupManagerStatusResponseComputeV1.fromMap(
    ...
    return InstanceGroupManagerStatusResponseComputeV1(
      ...
      stateful: pulumi.Input.fromValue(
        InstanceGroupManagerStatusStatefulResponseComputeV1.fromMap(
