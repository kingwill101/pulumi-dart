...
class InstanceGroupManagerStatusResponseComputeV1 {
  ...
  const InstanceGroupManagerStatusResponseComputeV1({
  ...
  factory InstanceGroupManagerStatusResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return InstanceGroupManagerStatusResponseComputeV1(
      ...
      stateful: pulumi.Input.fromValue(InstanceGroupManagerStatusStatefulResponseComputeV1.fromMap((map['stateful']! as Map).cast<String, dynamic>())),
      versionTarget: pulumi.Input.fromValue(InstanceGroupManagerStatusVersionTargetResponseComputeV1.fromMap((map['versionTarget']! as Map).cast<String, dynamic>())),
    );
  }
}
