...
class GetNodeTemplateComputeBetaResult {
  ...
  const GetNodeTemplateComputeBetaResult({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'accelerators': pulumi.Input.encodeList<AcceleratorConfigResponseComputeBeta, Map<String, dynamic>>(accelerators, (value) => value.toMap()),
      'cpuOvercommitType': cpuOvercommitType,
      'creationTimestamp': creationTimestamp,
      'description': description,
      'disks': pulumi.Input.encodeList<LocalDiskResponseComputeBeta, Map<String, dynamic>>(disks, (value) => value.toMap()),
      'kind': kind,
      'name': name,
  ...
  factory GetNodeTemplateComputeBetaResult.fromMap(Map<String, dynamic> map) {
    return GetNodeTemplateComputeBetaResult(
      accelerators: pulumi.Input.decodeList<AcceleratorConfigResponseComputeBeta>(map['accelerators']!, (value) => AcceleratorConfigResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      cpuOvercommitType: map['cpuOvercommitType'] as String,
      creationTimestamp: map['creationTimestamp'] as String,
      description: map['description'] as String,
      disks: pulumi.Input.decodeList<LocalDiskResponseComputeBeta>(map['disks']!, (value) => LocalDiskResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      kind: map['kind'] as String,
      name: map['name'] as String,
      nodeAffinityLabels: (map['nodeAffinityLabels'] as Map).cast<String, String>(),
      nodeType: map['nodeType'] as String,
      nodeTypeFlexibility: NodeTemplateNodeTypeFlexibilityResponseComputeBeta.fromMap((map['nodeTypeFlexibility']! as Map).cast<String, dynamic>()),
      region: map['region'] as String,
      selfLink: map['selfLink'] as String,
      serverBinding: ServerBindingResponseComputeBeta.fromMap((map['serverBinding']! as Map).cast<String, dynamic>()),
