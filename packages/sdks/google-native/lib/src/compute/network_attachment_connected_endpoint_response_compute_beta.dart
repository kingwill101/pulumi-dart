...
class NetworkAttachmentConnectedEndpointResponseComputeBeta {
  ...
  /// Creates a new [NetworkAttachmentConnectedEndpointResponseComputeBeta].
  ...
  factory NetworkAttachmentConnectedEndpointResponseComputeBeta.fromMap(Map<String, dynamic> map) {
