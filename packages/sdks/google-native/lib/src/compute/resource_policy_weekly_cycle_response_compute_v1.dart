...
class ResourcePolicyWeeklyCycleResponseComputeV1 {
  ...
  final pulumi.Input<List<ResourcePolicyWeeklyCycleDayOfWeekResponseComputeV1>>
  dayOfWeeks;
  ...
  ResourcePolicyWeeklyCycleResponseComputeV1({required this.dayOfWeeks});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'dayOfWeeks':
          pulumi.Input.mapInputValue<
            List<ResourcePolicyWeeklyCycleDayOfWeekResponseComputeV1>,
