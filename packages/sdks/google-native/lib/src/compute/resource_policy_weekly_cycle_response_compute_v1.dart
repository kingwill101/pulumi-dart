...
class ResourcePolicyWeeklyCycleResponseComputeV1 {
  ...
  factory ResourcePolicyWeeklyCycleResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return ResourcePolicyWeeklyCycleResponseComputeV1(
      dayOfWeeks: pulumi.Input.fromValue(pulumi.Input.decodeList<ResourcePolicyWeeklyCycleDayOfWeekResponseComputeV1>(map['dayOfWeeks']!, (value) => ResourcePolicyWeeklyCycleDayOfWeekResponseComputeV1.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
