...
class TargetSslProxyComputeV1Args {
  ...
  const TargetSslProxyComputeV1Args({
    this.certificateMap,
    this.description,
    this.name,
    this.project,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'project': ?project,
      'proxyHeader': ?pulumi.Input.mapOptionalInputValue<TargetSslProxyProxyHeaderComputeV1, String>(proxyHeader, (value) => value.wireValue),
      'requestId': ?requestId,
      'service': ?service,
  ...
  factory TargetSslProxyComputeV1Args.fromMap(Map<String, dynamic> map) {
    return TargetSslProxyComputeV1Args(
      ...
      proxyHeader: (() { final guardedValue = map['proxyHeader']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TargetSslProxyProxyHeaderComputeV1.fromValue(guardedValue as String)); })(),
