...
class TargetSslProxyComputeV1Args {
  ...
  TargetSslProxyComputeV1Args({
    ...
    pulumi.Output<TargetSslProxyProxyHeaderComputeV1>? proxyHeader,
  ...
  factory TargetSslProxyComputeV1Args.fromMap(Map<String, dynamic> map) {
    return TargetSslProxyComputeV1Args(
      ...
      proxyHeader: map['proxyHeader'] == null ? null : pulumi.Output.create<TargetSslProxyProxyHeaderComputeV1>(TargetSslProxyProxyHeaderComputeV1.fromValue(map['proxyHeader'] as String)),
