...
class HTTPHealthCheckComputeV1 {
  ...
  final pulumi.Input<HTTPHealthCheckPortSpecificationComputeV1>?
  portSpecification;
    ...
    return <String, dynamic>{
      ...
      'portSpecification':
          ?pulumi.Input.mapOptionalInputValue<
            HTTPHealthCheckPortSpecificationComputeV1,
            String
          >(portSpecification, (value) => value.wireValue),
      'proxyHeader':
          ?pulumi.Input.mapOptionalInputValue<
            HTTPHealthCheckProxyHeaderComputeV1,
            String
    ...
    return HTTPHealthCheckComputeV1(
      ...
      portSpecification: (() {
        ...
        return pulumi.Input.fromValue(
          HTTPHealthCheckPortSpecificationComputeV1.fromValue(
      ...
      proxyHeader: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          HTTPHealthCheckProxyHeaderComputeV1.fromValue(guardedValue as String),
        );
      })(),
      requestPath: (() {
