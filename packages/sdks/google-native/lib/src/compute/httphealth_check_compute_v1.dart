...
class HTTPHealthCheckComputeV1 {
  ...
  final HTTPHealthCheckPortSpecificationComputeV1? portSpecification;
  /// Specifies the type of proxy header to append before sending data to the backend, either NONE or PROXY_V1. The default is NONE.
  final HTTPHealthCheckProxyHeaderComputeV1? proxyHeader;
  ...
  factory HTTPHealthCheckComputeV1.fromMap(Map<String, dynamic> map) {
    return HTTPHealthCheckComputeV1(
      ...
      portSpecification: map['portSpecification'] == null ? null : HTTPHealthCheckPortSpecificationComputeV1.fromValue(map['portSpecification'] as String),
      proxyHeader: map['proxyHeader'] == null ? null : HTTPHealthCheckProxyHeaderComputeV1.fromValue(map['proxyHeader'] as String),
