...
class HTTPHealthCheckComputeV1 {
  ...
  const HTTPHealthCheckComputeV1({
    this.host,
    this.port,
    this.portName,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'port': ?port,
      'portName': ?portName,
      'portSpecification': ?pulumi.Input.mapOptionalInputValue<HTTPHealthCheckPortSpecificationComputeV1, String>(portSpecification, (value) => value.wireValue),
      'proxyHeader': ?pulumi.Input.mapOptionalInputValue<HTTPHealthCheckProxyHeaderComputeV1, String>(proxyHeader, (value) => value.wireValue),
  ...
  factory HTTPHealthCheckComputeV1.fromMap(Map<String, dynamic> map) {
    return HTTPHealthCheckComputeV1(
      ...
      portSpecification: (() { final guardedValue = map['portSpecification']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HTTPHealthCheckPortSpecificationComputeV1.fromValue(guardedValue as String)); })(),
      proxyHeader: (() { final guardedValue = map['proxyHeader']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HTTPHealthCheckProxyHeaderComputeV1.fromValue(guardedValue as String)); })(),
