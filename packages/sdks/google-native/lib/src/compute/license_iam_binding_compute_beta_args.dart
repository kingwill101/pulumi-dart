...
/// {@template pulumi_compute_beta_license_iam_binding_compute_beta_args_doc}
/// The set of arguments for LicenseIamBinding.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_license_iam_binding_compute_beta_args_doc}
class LicenseIamBindingComputeBetaArgs {
  ...
  /// Creates a new [LicenseIamBindingComputeBetaArgs].
  ...
  const LicenseIamBindingComputeBetaArgs({
    this.condition,
  ...
  factory LicenseIamBindingComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return LicenseIamBindingComputeBetaArgs(
