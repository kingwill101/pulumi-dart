...
import 'deprecation_status_state.dart';
...
class DeprecationStatus {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'stateOverride': ?stateOverride == null ? null : stateOverride!.toMap(),
    };
  }
  ...
  factory DeprecationStatus.fromMap(Map<String, dynamic> map) {
    return DeprecationStatus(
      ...
      deprecated: map['deprecated'] == null ? null : map['deprecated'] as String,
      obsolete: map['obsolete'] == null ? null : map['obsolete'] as String,
      replacement: map['replacement'] == null ? null : map['replacement'] as String,
      state: map['state'] == null ? null : DeprecationStatusState.fromValue(map['state'] as String),
      stateOverride: map['stateOverride'] == null ? null : RolloutPolicy.fromMap((map['stateOverride'] as Map).cast<String, dynamic>()),
    );
  }
}
