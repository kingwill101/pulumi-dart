...
/// {@template pulumi_compute_alpha_reservation_iam_binding_args_doc}
/// The set of arguments for ReservationIamBinding.
/// {@endtemplate}
/// {@macro pulumi_compute_alpha_reservation_iam_binding_args_doc}
class ReservationIamBindingArgs {
  ...
  /// Creates a new [ReservationIamBindingArgs].
  ...
  const ReservationIamBindingArgs({
    this.condition,
  ...
  factory ReservationIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return ReservationIamBindingArgs(
