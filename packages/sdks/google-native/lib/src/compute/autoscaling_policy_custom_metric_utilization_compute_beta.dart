...
class AutoscalingPolicyCustomMetricUtilizationComputeBeta {
  ...
  final pulumi.Input<
    AutoscalingPolicyCustomMetricUtilizationUtilizationTargetTypeComputeBeta
  >?
    ...
    return <String, dynamic>{
      ...
      'utilizationTargetType':
          ?pulumi.Input.mapOptionalInputValue<
            AutoscalingPolicyCustomMetricUtilizationUtilizationTargetTypeComputeBeta,
            String
          >(utilizationTargetType, (value) => value.wireValue),
    };
  }

  factory AutoscalingPolicyCustomMetricUtilizationComputeBeta.fromMap(
    ...
    return AutoscalingPolicyCustomMetricUtilizationComputeBeta(
      ...
      utilizationTargetType: (() {
        final guardedValue = map['utilizationTargetType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AutoscalingPolicyCustomMetricUtilizationUtilizationTargetTypeComputeBeta.fromValue(
