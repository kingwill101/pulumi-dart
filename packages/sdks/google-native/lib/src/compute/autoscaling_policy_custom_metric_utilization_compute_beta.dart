...
class AutoscalingPolicyCustomMetricUtilizationComputeBeta {
  ...
  final AutoscalingPolicyCustomMetricUtilizationUtilizationTargetTypeComputeBeta? utilizationTargetType;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'utilizationTargetType': ?utilizationTargetType == null ? null : utilizationTargetType!.value,
    };
  }
  ...
  factory AutoscalingPolicyCustomMetricUtilizationComputeBeta.fromMap(Map<String, dynamic> map) {
    return AutoscalingPolicyCustomMetricUtilizationComputeBeta(
      ...
      utilizationTarget: map['utilizationTarget'] == null ? null : map['utilizationTarget'] as double,
      utilizationTargetType: map['utilizationTargetType'] == null ? null : AutoscalingPolicyCustomMetricUtilizationUtilizationTargetTypeComputeBeta.fromValue(map['utilizationTargetType'] as String),
    );
  }
}
