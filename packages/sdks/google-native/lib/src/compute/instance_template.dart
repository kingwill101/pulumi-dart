...
class InstanceTemplate extends pulumi.CustomResource {
  ...
  InstanceTemplate(
    ...
    this.properties = registerOutput<InstancePropertiesResponse>('properties');
    this.region = registerOutput<String>('region');
    this.requestId = registerOutput<String?>('requestId');
    this.selfLink = registerOutput<String>('selfLink');
    this.selfLinkWithId = registerOutput<String>('selfLinkWithId');
    this.sourceInstance = registerOutput<String>('sourceInstance');
    this.sourceInstanceParams = registerOutput<SourceInstanceParamsResponse>('sourceInstanceParams');
  }
}
