...
class SecurityPolicyRuleResponseComputeBeta {
  ...
  final pulumi.Input<SecurityPolicyRuleHttpHeaderActionResponseComputeBeta>
  headerAction;
  ...
  final pulumi.Input<SecurityPolicyRuleNetworkMatcherResponseComputeBeta>
  networkMatch;
  ...
  final pulumi.Input<SecurityPolicyRuleRateLimitOptionsResponseComputeBeta>
  rateLimitOptions;

  /// Parameters defining the redirect action. Cannot be specified for any other actions. This field is only supported in Global Security Policies of type CLOUD_ARMOR.
  final pulumi.Input<SecurityPolicyRuleRedirectOptionsResponseComputeBeta>
  redirectOptions;
  ...
  factory SecurityPolicyRuleResponseComputeBeta.fromMap(
    ...
    return SecurityPolicyRuleResponseComputeBeta(
      ...
      match: pulumi.Input.fromValue(
        SecurityPolicyRuleMatcherResponseComputeBeta.fromMap(
          (map['match']! as Map).cast<String, dynamic>(),
        ),
      ),
      networkMatch: pulumi.Input.fromValue(
        SecurityPolicyRuleNetworkMatcherResponseComputeBeta.fromMap(
