...
class SecurityPolicyRuleResponseComputeBeta {
  ...
  final SecurityPolicyRuleHttpHeaderActionResponseComputeBeta headerAction;
  /// [Output only] Type of the resource. Always compute#securityPolicyRule for security policy rules
  final String kind;
  /// A match condition that incoming traffic is evaluated against. If it evaluates to true, the corresponding 'action' is enforced.
  final SecurityPolicyRuleMatcherResponseComputeBeta match;
  ...
  final SecurityPolicyRuleNetworkMatcherResponseComputeBeta networkMatch;
  /// Preconfigured WAF configuration to be applied for the rule. If the rule does not evaluate preconfigured WAF rules, i.e., if evaluatePreconfiguredWaf() is not used, this field will have no effect.
  final SecurityPolicyRulePreconfiguredWafConfigResponseComputeBeta preconfiguredWafConfig;
  /// If set to true, the specified action is not enforced.
  final bool preview;
  /// An integer indicating the priority of a rule in the list. The priority must be a positive value between 0 and 2147483647. Rules are evaluated from highest to lowest priority where 0 is the highest priority and 2147483647 is the lowest priority.
  final int priority;
  /// Must be specified if the action is "rate_based_ban" or "throttle". Cannot be specified for any other actions.
  final SecurityPolicyRuleRateLimitOptionsResponseComputeBeta rateLimitOptions;
  /// Parameters defining the redirect action. Cannot be specified for any other actions. This field is only supported in Global Security Policies of type CLOUD_ARMOR.
  final SecurityPolicyRuleRedirectOptionsResponseComputeBeta redirectOptions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'kind': kind,
      'match': match.toMap(),
      'networkMatch': networkMatch.toMap(),
      'preconfiguredWafConfig': preconfiguredWafConfig.toMap(),
      'preview': preview,
      'priority': priority,
      'rateLimitOptions': rateLimitOptions.toMap(),
      'redirectOptions': redirectOptions.toMap(),
  ...
  factory SecurityPolicyRuleResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRuleResponseComputeBeta(
      ...
      headerAction: SecurityPolicyRuleHttpHeaderActionResponseComputeBeta.fromMap((map['headerAction'] as Map).cast<String, dynamic>()),
      kind: map['kind'] as String,
      match: SecurityPolicyRuleMatcherResponseComputeBeta.fromMap((map['match'] as Map).cast<String, dynamic>()),
      networkMatch: SecurityPolicyRuleNetworkMatcherResponseComputeBeta.fromMap((map['networkMatch'] as Map).cast<String, dynamic>()),
      preconfiguredWafConfig: SecurityPolicyRulePreconfiguredWafConfigResponseComputeBeta.fromMap((map['preconfiguredWafConfig'] as Map).cast<String, dynamic>()),
      preview: map['preview'] as bool,
      priority: map['priority'] as int,
      rateLimitOptions: SecurityPolicyRuleRateLimitOptionsResponseComputeBeta.fromMap((map['rateLimitOptions'] as Map).cast<String, dynamic>()),
      redirectOptions: SecurityPolicyRuleRedirectOptionsResponseComputeBeta.fromMap((map['redirectOptions'] as Map).cast<String, dynamic>()),
