...
class SecurityPolicyRuleResponseComputeBeta {
  ...
  factory SecurityPolicyRuleResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRuleResponseComputeBeta(
      ...
      headerAction: (SecurityPolicyRuleHttpHeaderActionResponseComputeBeta.fromMap((map['headerAction'] as Map).cast<String, dynamic>())).input(),
      kind: (map['kind'] as String).input(),
      match: (SecurityPolicyRuleMatcherResponseComputeBeta.fromMap((map['match'] as Map).cast<String, dynamic>())).input(),
      networkMatch: (SecurityPolicyRuleNetworkMatcherResponseComputeBeta.fromMap((map['networkMatch'] as Map).cast<String, dynamic>())).input(),
      preconfiguredWafConfig: (SecurityPolicyRulePreconfiguredWafConfigResponseComputeBeta.fromMap((map['preconfiguredWafConfig'] as Map).cast<String, dynamic>())).input(),
      preview: (map['preview'] as bool).input(),
      priority: (map['priority'] as int).input(),
      rateLimitOptions: (SecurityPolicyRuleRateLimitOptionsResponseComputeBeta.fromMap((map['rateLimitOptions'] as Map).cast<String, dynamic>())).input(),
      redirectOptions: (SecurityPolicyRuleRedirectOptionsResponseComputeBeta.fromMap((map['redirectOptions'] as Map).cast<String, dynamic>())).input(),
