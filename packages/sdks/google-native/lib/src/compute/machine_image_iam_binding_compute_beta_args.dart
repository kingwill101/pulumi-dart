...
/// {@template pulumi_compute_beta_machine_image_iam_binding_compute_beta_args_doc}
/// The set of arguments for MachineImageIamBinding.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_machine_image_iam_binding_compute_beta_args_doc}
class MachineImageIamBindingComputeBetaArgs {
  ...
  /// Creates a new [MachineImageIamBindingComputeBetaArgs].
  ...
  const MachineImageIamBindingComputeBetaArgs({
    this.condition,
  ...
  factory MachineImageIamBindingComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return MachineImageIamBindingComputeBetaArgs(
