...
class ServiceAttachmentComputeV1Args {
  ...
  const ServiceAttachmentComputeV1Args({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'connectionPreference': ?pulumi.Input.mapOptionalInputValue<ServiceAttachmentConnectionPreferenceComputeV1, String>(connectionPreference, (value) => value.wireValue),
  ...
  factory ServiceAttachmentComputeV1Args.fromMap(Map<String, dynamic> map) {
    return ServiceAttachmentComputeV1Args(
      connectionPreference: (() { final guardedValue = map['connectionPreference']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServiceAttachmentConnectionPreferenceComputeV1.fromValue(guardedValue as String)); })(),
      consumerAcceptLists: (() { final guardedValue = map['consumerAcceptLists']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ServiceAttachmentConsumerProjectLimitComputeV1>(guardedValue, (value) => ServiceAttachmentConsumerProjectLimitComputeV1.fromMap((value as Map).cast<String, dynamic>()))); })(),
