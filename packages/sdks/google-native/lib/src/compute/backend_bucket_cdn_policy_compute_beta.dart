...
class BackendBucketCdnPolicyComputeBeta {
  ...
  final pulumi.Input<BackendBucketCdnPolicyCacheKeyPolicyComputeBeta>?
  cacheKeyPolicy;
  ...
  final pulumi.Input<
    List<BackendBucketCdnPolicyNegativeCachingPolicyComputeBeta>
  >?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'cacheMode':
          ?pulumi.Input.mapOptionalInputValue<
            BackendBucketCdnPolicyCacheModeComputeBeta,
            String
          >(cacheMode, (value) => value.wireValue),
      'clientTtl': ?clientTtl,
