...
import 'backend_bucket_cdn_policy_bypass_cache_on_request_header_compute_beta.dart';
import 'backend_bucket_cdn_policy_cache_key_policy_compute_beta.dart';
import 'backend_bucket_cdn_policy_cache_mode_compute_beta.dart';
import 'backend_bucket_cdn_policy_negative_caching_policy_compute_beta.dart';

/// Message containing Cloud CDN configuration for a backend bucket.
class BackendBucketCdnPolicyComputeBeta {
  /// Bypass the cache when the specified request headers are matched - e.g. Pragma or Authorization headers. Up to 5 headers can be specified. The cache is bypassed for all cdnPolicy.cacheMode settings.
  final pulumi.Input<List<BackendBucketCdnPolicyBypassCacheOnRequestHeaderComputeBeta>>? bypassCacheOnRequestHeaders;
  /// The CacheKeyPolicy for this CdnPolicy.
  final pulumi.Input<BackendBucketCdnPolicyCacheKeyPolicyComputeBeta>? cacheKeyPolicy;
  ...
  final pulumi.Input<BackendBucketCdnPolicyCacheModeComputeBeta>? cacheMode;
  ...
  final pulumi.Input<List<BackendBucketCdnPolicyNegativeCachingPolicyComputeBeta>>? negativeCachingPolicy;
  ...
  /// Creates a new [BackendBucketCdnPolicyComputeBeta].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'bypassCacheOnRequestHeaders': ?pulumi.Input.mapOptionalInputValue<List<BackendBucketCdnPolicyBypassCacheOnRequestHeaderComputeBeta>, List<Map<String, dynamic>>>(bypassCacheOnRequestHeaders, (value) => pulumi.Input.encodeList<BackendBucketCdnPolicyBypassCacheOnRequestHeaderComputeBeta, Map<String, dynamic>>(value, (value) => value.toMap())),
      'cacheKeyPolicy': ?pulumi.Input.mapOptionalInputValue<BackendBucketCdnPolicyCacheKeyPolicyComputeBeta, Map<String, dynamic>>(cacheKeyPolicy, (value) => value.toMap()),
      'cacheMode': ?pulumi.Input.mapOptionalInputValue<BackendBucketCdnPolicyCacheModeComputeBeta, String>(cacheMode, (value) => value.value),
      'clientTtl': ?clientTtl,
      'defaultTtl': ?defaultTtl,
      'maxTtl': ?maxTtl,
      'negativeCaching': ?negativeCaching,
      'negativeCachingPolicy': ?pulumi.Input.mapOptionalInputValue<List<BackendBucketCdnPolicyNegativeCachingPolicyComputeBeta>, List<Map<String, dynamic>>>(negativeCachingPolicy, (value) => pulumi.Input.encodeList<BackendBucketCdnPolicyNegativeCachingPolicyComputeBeta, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory BackendBucketCdnPolicyComputeBeta.fromMap(Map<String, dynamic> map) {
    return BackendBucketCdnPolicyComputeBeta(
      bypassCacheOnRequestHeaders: map['bypassCacheOnRequestHeaders'] == null ? null : (pulumi.Input.decodeList<BackendBucketCdnPolicyBypassCacheOnRequestHeaderComputeBeta>(map['bypassCacheOnRequestHeaders'], (value) => BackendBucketCdnPolicyBypassCacheOnRequestHeaderComputeBeta.fromMap((value as Map).cast<String, dynamic>()))).input(),
      cacheKeyPolicy: map['cacheKeyPolicy'] == null ? null : (BackendBucketCdnPolicyCacheKeyPolicyComputeBeta.fromMap((map['cacheKeyPolicy'] as Map).cast<String, dynamic>())).input(),
      cacheMode: map['cacheMode'] == null ? null : (BackendBucketCdnPolicyCacheModeComputeBeta.fromValue(map['cacheMode'] as String)).input(),
      ...
      negativeCachingPolicy: map['negativeCachingPolicy'] == null ? null : (pulumi.Input.decodeList<BackendBucketCdnPolicyNegativeCachingPolicyComputeBeta>(map['negativeCachingPolicy'], (value) => BackendBucketCdnPolicyNegativeCachingPolicyComputeBeta.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      signedUrlCacheMaxAgeSec: map['signedUrlCacheMaxAgeSec'] == null ? null : (map['signedUrlCacheMaxAgeSec'] as String).input(),
    );
  }
}
