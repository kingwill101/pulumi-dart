...
class BackendBucketCdnPolicyComputeBeta {
  ...
  const BackendBucketCdnPolicyComputeBeta({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'cacheMode': ?pulumi.Input.mapOptionalInputValue<BackendBucketCdnPolicyCacheModeComputeBeta, String>(cacheMode, (value) => value.wireValue),
      'clientTtl': ?clientTtl,
  ...
  factory BackendBucketCdnPolicyComputeBeta.fromMap(Map<String, dynamic> map) {
    return BackendBucketCdnPolicyComputeBeta(
      bypassCacheOnRequestHeaders: (() { final guardedValue = map['bypassCacheOnRequestHeaders']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<BackendBucketCdnPolicyBypassCacheOnRequestHeaderComputeBeta>(guardedValue, (value) => BackendBucketCdnPolicyBypassCacheOnRequestHeaderComputeBeta.fromMap((value as Map).cast<String, dynamic>()))); })(),
      cacheKeyPolicy: (() { final guardedValue = map['cacheKeyPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BackendBucketCdnPolicyCacheKeyPolicyComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      cacheMode: (() { final guardedValue = map['cacheMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BackendBucketCdnPolicyCacheModeComputeBeta.fromValue(guardedValue as String)); })(),
      ...
      negativeCachingPolicy: (() { final guardedValue = map['negativeCachingPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<BackendBucketCdnPolicyNegativeCachingPolicyComputeBeta>(guardedValue, (value) => BackendBucketCdnPolicyNegativeCachingPolicyComputeBeta.fromMap((value as Map).cast<String, dynamic>()))); })(),
