...
class SecurityPolicyUserDefinedFieldResponseComputeBeta {
  ...
  /// Creates a new [SecurityPolicyUserDefinedFieldResponseComputeBeta].
  ...
  factory SecurityPolicyUserDefinedFieldResponseComputeBeta.fromMap(Map<String, dynamic> map) {
