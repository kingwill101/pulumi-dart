...
class NodeGroup extends pulumi.CustomResource {
  ...
  NodeGroup(
    ...
    autoscalingPolicy = registerOutput<NodeGroupAutoscalingPolicyResponse>('autoscalingPolicy', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return NodeGroupAutoscalingPolicyResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    maintenanceWindow = registerOutput<NodeGroupMaintenanceWindowResponse>('maintenanceWindow', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return NodeGroupMaintenanceWindowResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
