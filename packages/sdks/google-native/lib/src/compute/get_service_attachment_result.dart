...
class GetServiceAttachmentResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'connectedEndpoints': pulumi.Input.encodeList<ServiceAttachmentConnectedEndpointResponse, Map<String, dynamic>>(connectedEndpoints, (value) => value.toMap()),
      'connectionPreference': connectionPreference,
      'consumerAcceptLists': pulumi.Input.encodeList<ServiceAttachmentConsumerProjectLimitResponse, Map<String, dynamic>>(consumerAcceptLists, (value) => value.toMap()),
  ...
  factory GetServiceAttachmentResult.fromMap(Map<String, dynamic> map) {
    return GetServiceAttachmentResult(
      connectedEndpoints: pulumi.Input.decodeList<ServiceAttachmentConnectedEndpointResponse>(map['connectedEndpoints'], (value) => ServiceAttachmentConnectedEndpointResponse.fromMap((value as Map).cast<String, dynamic>())),
      connectionPreference: map['connectionPreference'] as String,
      consumerAcceptLists: pulumi.Input.decodeList<ServiceAttachmentConsumerProjectLimitResponse>(map['consumerAcceptLists'], (value) => ServiceAttachmentConsumerProjectLimitResponse.fromMap((value as Map).cast<String, dynamic>())),
      ...
      pscServiceAttachmentId: Uint128Response.fromMap((map['pscServiceAttachmentId'] as Map).cast<String, dynamic>()),
      reconcileConnections: map['reconcileConnections'] as bool,
      region: map['region'] as String,
      selfLink: map['selfLink'] as String,
      targetService: map['targetService'] as String,
      tunnelingConfig: ServiceAttachmentTunnelingConfigResponse.fromMap((map['tunnelingConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
