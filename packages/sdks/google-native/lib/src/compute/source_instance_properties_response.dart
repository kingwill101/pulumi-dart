    ...
    return <String, dynamic>{
      ...
      'disks':
          pulumi.Input.mapInputValue<
            List<SavedAttachedDiskResponse>,
      ...
      'scheduling':
          pulumi.Input.mapInputValue<SchedulingResponse, Map<String, dynamic>>(
            scheduling,
            (value) => value.toMap(),
          ),
      'serviceAccounts':
      ...
      'tags': pulumi.Input.mapInputValue<TagsResponse, Map<String, dynamic>>(
        tags,
        (value) => value.toMap(),
      ),
    };
  ...
  factory SourceInstancePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return SourceInstancePropertiesResponse(
      ...
      disks: pulumi.Input.fromValue(
        pulumi.Input.decodeList<SavedAttachedDiskResponse>(
          map['disks']!,
      ...
      tags: pulumi.Input.fromValue(
        TagsResponse.fromMap((map['tags']! as Map).cast<String, dynamic>()),
      ),
    );
  }
}
