...
class SourceInstancePropertiesResponse {
  ...
  const SourceInstancePropertiesResponse({
  ...
  factory SourceInstancePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return SourceInstancePropertiesResponse(
      ...
      disks: pulumi.Input.fromValue(pulumi.Input.decodeList<SavedAttachedDiskResponse>(map['disks']!, (value) => SavedAttachedDiskResponse.fromMap((value as Map).cast<String, dynamic>()))),
      guestAccelerators: pulumi.Input.fromValue(pulumi.Input.decodeList<AcceleratorConfigResponse>(map['guestAccelerators']!, (value) => AcceleratorConfigResponse.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      scheduling: pulumi.Input.fromValue(SchedulingResponse.fromMap((map['scheduling']! as Map).cast<String, dynamic>())),
      serviceAccounts: pulumi.Input.fromValue(pulumi.Input.decodeList<ServiceAccountResponse>(map['serviceAccounts']!, (value) => ServiceAccountResponse.fromMap((value as Map).cast<String, dynamic>()))),
      tags: pulumi.Input.fromValue(TagsResponse.fromMap((map['tags']! as Map).cast<String, dynamic>())),
    );
  }
}
