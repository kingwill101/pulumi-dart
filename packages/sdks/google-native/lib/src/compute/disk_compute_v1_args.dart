...
class DiskComputeV1Args {
  ...
  /// [zone] Optional.
  DiskComputeV1Args({
    pulumi.Output<DiskArchitectureComputeV1>? architecture,
  ...
  factory DiskComputeV1Args.fromMap(Map<String, dynamic> map) {
    return DiskComputeV1Args(
      architecture: map['architecture'] == null ? null : pulumi.Output.create<DiskArchitectureComputeV1>(DiskArchitectureComputeV1.fromValue(map['architecture'] as String)),
