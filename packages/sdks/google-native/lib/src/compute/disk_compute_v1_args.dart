...
class DiskComputeV1Args {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'architecture': ?pulumi.Input.mapOptionalInputValue<DiskArchitectureComputeV1, String>(architecture, (value) => value.wireValue),
  ...
  factory DiskComputeV1Args.fromMap(Map<String, dynamic> map) {
    return DiskComputeV1Args(
      architecture: (() { final guardedValue = map['architecture']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DiskArchitectureComputeV1.fromValue(guardedValue as String)); })(),
