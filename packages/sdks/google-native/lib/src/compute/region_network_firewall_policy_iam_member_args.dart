...
/// {@template pulumi_compute_alpha_region_network_firewall_policy_iam_member_args_doc}
/// The set of arguments for RegionNetworkFirewallPolicyIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_alpha_region_network_firewall_policy_iam_member_args_doc}
class RegionNetworkFirewallPolicyIamMemberArgs {
  ...
  /// Creates a new [RegionNetworkFirewallPolicyIamMemberArgs].
  ...
  const RegionNetworkFirewallPolicyIamMemberArgs({
    this.condition,
  ...
  factory RegionNetworkFirewallPolicyIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return RegionNetworkFirewallPolicyIamMemberArgs(
