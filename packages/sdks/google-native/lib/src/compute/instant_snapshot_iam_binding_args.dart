...
/// {@template pulumi_compute_alpha_instant_snapshot_iam_binding_args_doc}
/// The set of arguments for InstantSnapshotIamBinding.
/// {@endtemplate}
/// {@macro pulumi_compute_alpha_instant_snapshot_iam_binding_args_doc}
class InstantSnapshotIamBindingArgs {
  ...
  const InstantSnapshotIamBindingArgs({
    this.condition,
