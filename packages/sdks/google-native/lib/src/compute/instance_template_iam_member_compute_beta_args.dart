...
/// {@template pulumi_compute_beta_instance_template_iam_member_compute_beta_args_doc}
/// The set of arguments for InstanceTemplateIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_instance_template_iam_member_compute_beta_args_doc}
class InstanceTemplateIamMemberComputeBetaArgs {
  ...
  /// Creates a new [InstanceTemplateIamMemberComputeBetaArgs].
  ...
  const InstanceTemplateIamMemberComputeBetaArgs({
    this.condition,
  ...
  factory InstanceTemplateIamMemberComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return InstanceTemplateIamMemberComputeBetaArgs(
