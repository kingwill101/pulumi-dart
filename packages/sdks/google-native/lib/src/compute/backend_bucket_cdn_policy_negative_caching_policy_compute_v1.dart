...
class BackendBucketCdnPolicyNegativeCachingPolicyComputeV1 {
  ...
  /// Creates a new [BackendBucketCdnPolicyNegativeCachingPolicyComputeV1].
  ...
  const BackendBucketCdnPolicyNegativeCachingPolicyComputeV1({
    this.code,
    this.ttl,
  });
  ...
  factory BackendBucketCdnPolicyNegativeCachingPolicyComputeV1.fromMap(Map<String, dynamic> map) {
