...
class FirewallPolicyRuleMatcherLayer4ConfigResponseComputeV1 {
  ...
  const FirewallPolicyRuleMatcherLayer4ConfigResponseComputeV1({
  ...
  factory FirewallPolicyRuleMatcherLayer4ConfigResponseComputeV1.fromMap(Map<String, dynamic> map) {
