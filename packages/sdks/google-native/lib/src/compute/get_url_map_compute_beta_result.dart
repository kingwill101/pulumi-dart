...
class GetUrlMapComputeBetaResult {
  ...
  /// Creates a new [GetUrlMapComputeBetaResult].
  ...
  const GetUrlMapComputeBetaResult({
  ...
  factory GetUrlMapComputeBetaResult.fromMap(Map<String, dynamic> map) {
    return GetUrlMapComputeBetaResult(
