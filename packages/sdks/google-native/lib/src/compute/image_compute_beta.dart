...
class ImageComputeBeta extends pulumi.CustomResource {
  ...
  ImageComputeBeta(
    ...
    deprecated = registerOutput<DeprecationStatusResponseComputeBeta>('deprecated', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return DeprecationStatusResponseComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    imageEncryptionKey = registerOutput<CustomerEncryptionKeyResponseComputeBeta>('imageEncryptionKey', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return CustomerEncryptionKeyResponseComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    rawDisk = registerOutput<ImageRawDiskResponseComputeBeta>('rawDisk', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ImageRawDiskResponseComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    requestId = registerOutput<String?>('requestId');
    rolloutOverride = registerOutput<RolloutPolicyResponseComputeBeta>('rolloutOverride', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return RolloutPolicyResponseComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    satisfiesPzs = registerOutput<bool>('satisfiesPzs');
    selfLink = registerOutput<String>('selfLink');
    shieldedInstanceInitialState = registerOutput<InitialStateConfigResponseComputeBeta>('shieldedInstanceInitialState', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return InitialStateConfigResponseComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    sourceDisk = registerOutput<String>('sourceDisk');
    sourceDiskEncryptionKey = registerOutput<CustomerEncryptionKeyResponseComputeBeta>('sourceDiskEncryptionKey', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return CustomerEncryptionKeyResponseComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    sourceDiskId = registerOutput<String>('sourceDiskId');
    sourceImage = registerOutput<String>('sourceImage');
    sourceImageEncryptionKey = registerOutput<CustomerEncryptionKeyResponseComputeBeta>('sourceImageEncryptionKey', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return CustomerEncryptionKeyResponseComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    sourceImageId = registerOutput<String>('sourceImageId');
    sourceSnapshot = registerOutput<String>('sourceSnapshot');
    sourceSnapshotEncryptionKey = registerOutput<CustomerEncryptionKeyResponseComputeBeta>('sourceSnapshotEncryptionKey', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return CustomerEncryptionKeyResponseComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>()); });
