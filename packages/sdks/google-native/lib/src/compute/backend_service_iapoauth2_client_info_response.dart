...
class BackendServiceIAPOAuth2ClientInfoResponse {
  ...
  const BackendServiceIAPOAuth2ClientInfoResponse({
  ...
  factory BackendServiceIAPOAuth2ClientInfoResponse.fromMap(Map<String, dynamic> map) {
    return BackendServiceIAPOAuth2ClientInfoResponse(
      ...
      developerEmailAddress: pulumi.Input.fromValue(map['developerEmailAddress'] as String),
    );
  }
}
