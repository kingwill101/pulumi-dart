...
class GetPublicAdvertisedPrefixComputeBetaResult {
  ...
  final List<PublicAdvertisedPrefixPublicDelegatedPrefixResponseComputeBeta> publicDelegatedPrefixs;
  ...
  /// Creates a new [GetPublicAdvertisedPrefixComputeBetaResult].
  ...
  const GetPublicAdvertisedPrefixComputeBetaResult({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': name,
      'pdpScope': pdpScope,
      'publicDelegatedPrefixs': pulumi.Input.encodeList<PublicAdvertisedPrefixPublicDelegatedPrefixResponseComputeBeta, Map<String, dynamic>>(publicDelegatedPrefixs, (value) => value.toMap()),
      'selfLink': selfLink,
  ...
  factory GetPublicAdvertisedPrefixComputeBetaResult.fromMap(Map<String, dynamic> map) {
    return GetPublicAdvertisedPrefixComputeBetaResult(
      ...
      publicDelegatedPrefixs: pulumi.Input.decodeList<PublicAdvertisedPrefixPublicDelegatedPrefixResponseComputeBeta>(map['publicDelegatedPrefixs']!, (value) => PublicAdvertisedPrefixPublicDelegatedPrefixResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
