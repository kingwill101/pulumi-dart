...
class AccessConfigResponseComputeBeta {
  ...
  /// Creates a new [AccessConfigResponseComputeBeta].
  ...
  AccessConfigResponseComputeBeta({
  ...
  factory AccessConfigResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return AccessConfigResponseComputeBeta(
      externalIpv6: (map['externalIpv6'] as String).input(),
      externalIpv6PrefixLength: (map['externalIpv6PrefixLength'] as int).input(),
      ...
      setPublicPtr: (map['setPublicPtr'] as bool).input(),
