  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'savedDisks':
          ...
          >(
            savedDisks,
            (value) => pulumi.Input.encodeList<SavedDisk, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
  ...
  factory MachineImageArgs.fromMap(Map<String, dynamic> map) {
    return MachineImageArgs(
      ...
      savedDisks: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SavedDisk>(
            guardedValue,
            (value) =>
                SavedDisk.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      sourceDiskEncryptionKeys: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SourceDiskEncryptionKey>(
            guardedValue,
            (value) => SourceDiskEncryptionKey.fromMap(
