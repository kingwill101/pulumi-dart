...
class MachineImageArgs {
  ...
  factory MachineImageArgs.fromMap(Map<String, dynamic> map) {
    return MachineImageArgs(
      ...
      machineImageEncryptionKey: (() { final guardedValue = map['machineImageEncryptionKey']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CustomerEncryptionKey.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      project: (() { final guardedValue = map['project']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      requestId: (() { final guardedValue = map['requestId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      savedDisks: (() { final guardedValue = map['savedDisks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SavedDisk>(guardedValue, (value) => SavedDisk.fromMap((value as Map).cast<String, dynamic>()))); })(),
      sourceDiskEncryptionKeys: (() { final guardedValue = map['sourceDiskEncryptionKeys']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SourceDiskEncryptionKey>(guardedValue, (value) => SourceDiskEncryptionKey.fromMap((value as Map).cast<String, dynamic>()))); })(),
