...
class GetNetworkAttachmentResult {
  ...
  final List<NetworkAttachmentConnectedEndpointResponse> connectionEndpoints;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'connectionEndpoints': pulumi.Input.encodeList<NetworkAttachmentConnectedEndpointResponse, Map<String, dynamic>>(connectionEndpoints, (value) => value.toMap()),
  ...
  factory GetNetworkAttachmentResult.fromMap(Map<String, dynamic> map) {
    return GetNetworkAttachmentResult(
      connectionEndpoints: pulumi.Input.decodeList<NetworkAttachmentConnectedEndpointResponse>(map['connectionEndpoints'], (value) => NetworkAttachmentConnectedEndpointResponse.fromMap((value as Map).cast<String, dynamic>())),
