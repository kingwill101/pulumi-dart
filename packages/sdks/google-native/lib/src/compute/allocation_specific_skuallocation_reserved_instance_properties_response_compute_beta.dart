...
class AllocationSpecificSKUAllocationReservedInstancePropertiesResponseComputeBeta {
  ...
  const AllocationSpecificSKUAllocationReservedInstancePropertiesResponseComputeBeta({
  ...
  factory AllocationSpecificSKUAllocationReservedInstancePropertiesResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return AllocationSpecificSKUAllocationReservedInstancePropertiesResponseComputeBeta(
      ...
      localSsds: pulumi.Input.fromValue(pulumi.Input.decodeList<AllocationSpecificSKUAllocationAllocatedInstancePropertiesReservedDiskResponseComputeBeta>(map['localSsds']!, (value) => AllocationSpecificSKUAllocationAllocatedInstancePropertiesReservedDiskResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))),
