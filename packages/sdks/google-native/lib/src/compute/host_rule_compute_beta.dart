...
class HostRuleComputeBeta {
  ...
  /// Creates a new [HostRuleComputeBeta].
  ...
  factory HostRuleComputeBeta.fromMap(Map<String, dynamic> map) {
    return HostRuleComputeBeta(
      ...
      pathMatcher: (() { final guardedValue = map['pathMatcher']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
