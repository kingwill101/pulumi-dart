...
class ResourcePolicySnapshotSchedulePolicyScheduleResponseComputeV1 {
  ...
  factory ResourcePolicySnapshotSchedulePolicyScheduleResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return ResourcePolicySnapshotSchedulePolicyScheduleResponseComputeV1(
      dailySchedule: (ResourcePolicyDailyCycleResponseComputeV1.fromMap((map['dailySchedule'] as Map).cast<String, dynamic>())).input(),
      hourlySchedule: (ResourcePolicyHourlyCycleResponseComputeV1.fromMap((map['hourlySchedule'] as Map).cast<String, dynamic>())).input(),
      weeklySchedule: (ResourcePolicyWeeklyCycleResponseComputeV1.fromMap((map['weeklySchedule'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
