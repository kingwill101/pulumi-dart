...
class ResourcePolicySnapshotSchedulePolicyResponseComputeBeta {
  ...
  factory ResourcePolicySnapshotSchedulePolicyResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return ResourcePolicySnapshotSchedulePolicyResponseComputeBeta(
      retentionPolicy: (ResourcePolicySnapshotSchedulePolicyRetentionPolicyResponseComputeBeta.fromMap((map['retentionPolicy'] as Map).cast<String, dynamic>())).input(),
      schedule: (ResourcePolicySnapshotSchedulePolicyScheduleResponseComputeBeta.fromMap((map['schedule'] as Map).cast<String, dynamic>())).input(),
      snapshotProperties: (ResourcePolicySnapshotSchedulePolicySnapshotPropertiesResponseComputeBeta.fromMap((map['snapshotProperties'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
