...
/// {@template pulumi_compute_beta_image_iam_member_compute_beta_args_doc}
/// The set of arguments for ImageIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_image_iam_member_compute_beta_args_doc}
class ImageIamMemberComputeBetaArgs {
  ...
  /// Creates a new [ImageIamMemberComputeBetaArgs].
  ...
  const ImageIamMemberComputeBetaArgs({
    this.condition,
  ...
  factory ImageIamMemberComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return ImageIamMemberComputeBetaArgs(
