...
/// {@template pulumi_compute_v1_instance_iam_binding_compute_v1_args_doc}
/// The set of arguments for InstanceIamBinding.
/// {@endtemplate}
/// {@macro pulumi_compute_v1_instance_iam_binding_compute_v1_args_doc}
class InstanceIamBindingComputeV1Args {
  ...
  /// Creates a new [InstanceIamBindingComputeV1Args].
  ...
  const InstanceIamBindingComputeV1Args({
    this.condition,
  ...
  factory InstanceIamBindingComputeV1Args.fromMap(Map<String, dynamic> map) {
    return InstanceIamBindingComputeV1Args(
