...
class ServerTlsSettings {
  ...
  ServerTlsSettings({this.proxyTlsContext, this.subjectAltNames, this.tlsMode});
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'tlsMode':
          ?pulumi.Input.mapOptionalInputValue<ServerTlsSettingsTlsMode, String>(
            tlsMode,
  ...
  factory ServerTlsSettings.fromMap(Map<String, dynamic> map) {
    return ServerTlsSettings(
      proxyTlsContext: (() {
        final guardedValue = map['proxyTlsContext'];
      ...
      tlsMode: (() {
        final guardedValue = map['tlsMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ServerTlsSettingsTlsMode.fromValue(guardedValue as String),
        );
      })(),
    );
  }
