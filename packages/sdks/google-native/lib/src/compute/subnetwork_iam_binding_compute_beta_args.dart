...
/// {@template pulumi_compute_beta_subnetwork_iam_binding_compute_beta_args_doc}
/// The set of arguments for SubnetworkIamBinding.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_subnetwork_iam_binding_compute_beta_args_doc}
class SubnetworkIamBindingComputeBetaArgs {
  ...
  /// Creates a new [SubnetworkIamBindingComputeBetaArgs].
  ...
  const SubnetworkIamBindingComputeBetaArgs({
    this.condition,
  ...
  factory SubnetworkIamBindingComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return SubnetworkIamBindingComputeBetaArgs(
