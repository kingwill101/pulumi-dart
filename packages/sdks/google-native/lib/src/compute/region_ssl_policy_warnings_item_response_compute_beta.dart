...
class RegionSslPolicyWarningsItemResponseComputeBeta {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'code': code,
      'data': pulumi.Input.encodeList<RegionSslPolicyWarningsItemDataItemResponseComputeBeta, Map<String, dynamic>>(data, (value) => value.toMap()),
      'message': message,
    };
  }
  ...
  factory RegionSslPolicyWarningsItemResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return RegionSslPolicyWarningsItemResponseComputeBeta(
      ...
      data: pulumi.Input.decodeList<RegionSslPolicyWarningsItemDataItemResponseComputeBeta>(map['data'], (value) => RegionSslPolicyWarningsItemDataItemResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
