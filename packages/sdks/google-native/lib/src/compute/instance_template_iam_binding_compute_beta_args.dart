...
/// {@template pulumi_compute_beta_instance_template_iam_binding_compute_beta_args_doc}
/// The set of arguments for InstanceTemplateIamBinding.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_instance_template_iam_binding_compute_beta_args_doc}
class InstanceTemplateIamBindingComputeBetaArgs {
  ...
  /// Creates a new [InstanceTemplateIamBindingComputeBetaArgs].
  ...
  const InstanceTemplateIamBindingComputeBetaArgs({
    this.condition,
  ...
  factory InstanceTemplateIamBindingComputeBetaArgs.fromMap(Map<String, dynamic> map) {
