...
/// {@template pulumi_compute_beta_instant_snapshot_compute_beta_args_doc}
/// The set of arguments for InstantSnapshot.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_instant_snapshot_compute_beta_args_doc}
class InstantSnapshotComputeBetaArgs {
  ...
  /// Creates a new [InstantSnapshotComputeBetaArgs].
  ...
  /// [zone] Optional.
  const InstantSnapshotComputeBetaArgs({
    this.description,
    this.labels,
    this.name,
    this.project,
  ...
  factory InstantSnapshotComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return InstantSnapshotComputeBetaArgs(
