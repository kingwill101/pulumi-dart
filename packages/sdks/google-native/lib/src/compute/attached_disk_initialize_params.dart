...
class AttachedDiskInitializeParams {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'architecture': ?pulumi.Input.mapOptionalInputValue<AttachedDiskInitializeParamsArchitecture, String>(architecture, (value) => value.value),
      ...
      'interface': ?pulumi.Input.mapOptionalInputValue<AttachedDiskInitializeParamsInterface, String>(interface, (value) => value.value),
      'labels': ?labels,
      'licenseCodes': ?licenseCodes,
      'licenses': ?licenses,
      'multiWriter': ?multiWriter,
      'onUpdateAction': ?pulumi.Input.mapOptionalInputValue<AttachedDiskInitializeParamsOnUpdateAction, String>(onUpdateAction, (value) => value.value),
  ...
  factory AttachedDiskInitializeParams.fromMap(Map<String, dynamic> map) {
    return AttachedDiskInitializeParams(
      architecture: map['architecture'] == null ? null : (AttachedDiskInitializeParamsArchitecture.fromValue(map['architecture']! as String)).input(),
      ...
      interface: map['interface'] == null ? null : (AttachedDiskInitializeParamsInterface.fromValue(map['interface']! as String)).input(),
      ...
      onUpdateAction: map['onUpdateAction'] == null ? null : (AttachedDiskInitializeParamsOnUpdateAction.fromValue(map['onUpdateAction']! as String)).input(),
