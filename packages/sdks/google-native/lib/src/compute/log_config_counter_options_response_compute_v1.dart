...
class LogConfigCounterOptionsResponseComputeV1 {
  /// This is deprecated and has no effect. Do not use.
  final pulumi.Input<List<LogConfigCounterOptionsCustomFieldResponseComputeV1>>
  customFields;
    ...
    return <String, dynamic>{
      'customFields':
          pulumi.Input.mapInputValue<
            List<LogConfigCounterOptionsCustomFieldResponseComputeV1>,
  ...
  factory LogConfigCounterOptionsResponseComputeV1.fromMap(
    ...
    return LogConfigCounterOptionsResponseComputeV1(
      customFields: pulumi.Input.fromValue(
        ...
        >(
          map['customFields']!,
          (value) =>
              LogConfigCounterOptionsCustomFieldResponseComputeV1.fromMap(
