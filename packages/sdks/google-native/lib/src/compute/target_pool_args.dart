...
class TargetPoolArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'region': region,
      'requestId': ?requestId,
      'sessionAffinity': ?pulumi.Input.mapOptionalInputValue<TargetPoolSessionAffinity, String>(sessionAffinity, (value) => value.wireValue),
    };
  }
  ...
  factory TargetPoolArgs.fromMap(Map<String, dynamic> map) {
    return TargetPoolArgs(
      ...
      sessionAffinity: (() { final guardedValue = map['sessionAffinity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TargetPoolSessionAffinity.fromValue(guardedValue as String)); })(),
    );
  }
}
