...
class AttachedDiskComputeV1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'interface':
          ?pulumi.Input.mapOptionalInputValue<
            AttachedDiskInterfaceComputeV1,
            String
          >(interface, (value) => value.wireValue),
      'mode':
          ?pulumi.Input.mapOptionalInputValue<
            AttachedDiskModeComputeV1,
            String
          >(mode, (value) => value.wireValue),
      'savedState':
          ?pulumi.Input.mapOptionalInputValue<
            AttachedDiskSavedStateComputeV1,
            String
          >(savedState, (value) => value.wireValue),
      'source': ?source,
      'type':
          ?pulumi.Input.mapOptionalInputValue<
            AttachedDiskTypeComputeV1,
            String
  ...
  factory AttachedDiskComputeV1.fromMap(Map<String, dynamic> map) {
    return AttachedDiskComputeV1(
      ...
      interface: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AttachedDiskInterfaceComputeV1.fromValue(guardedValue as String),
        );
      })(),
      mode: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AttachedDiskModeComputeV1.fromValue(guardedValue as String),
        );
      })(),
      savedState: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AttachedDiskSavedStateComputeV1.fromValue(guardedValue as String),
        );
      })(),
      source: (() {
      ...
      type: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AttachedDiskTypeComputeV1.fromValue(guardedValue as String),
        );
      })(),
    );
  }
