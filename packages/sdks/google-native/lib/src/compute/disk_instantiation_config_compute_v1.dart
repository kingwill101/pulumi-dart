...
class DiskInstantiationConfigComputeV1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'instantiateFrom': ?pulumi.Input.mapOptionalInputValue<DiskInstantiationConfigInstantiateFromComputeV1, String>(instantiateFrom, (value) => value.value),
    };
  }
  ...
  factory DiskInstantiationConfigComputeV1.fromMap(Map<String, dynamic> map) {
    return DiskInstantiationConfigComputeV1(
      ...
      instantiateFrom: map['instantiateFrom'] == null ? null : (DiskInstantiationConfigInstantiateFromComputeV1.fromValue(map['instantiateFrom'] as String)).input(),
    );
  }
}
