...
class HttpRetryPolicyResponse {
  ...
  final pulumi.Input<DurationResponse> perTryTimeout;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'perTryTimeout': pulumi.Input.mapInputValue<DurationResponse, Map<String, dynamic>>(perTryTimeout, (value) => value.toMap()),
  ...
  factory HttpRetryPolicyResponse.fromMap(Map<String, dynamic> map) {
    return HttpRetryPolicyResponse(
      ...
      perTryTimeout: (DurationResponse.fromMap((map['perTryTimeout'] as Map).cast<String, dynamic>())).input(),
