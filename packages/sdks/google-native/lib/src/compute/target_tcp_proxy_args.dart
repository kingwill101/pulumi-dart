...
class TargetTcpProxyArgs {
  ...
  TargetTcpProxyArgs({
    ...
    pulumi.Output<TargetTcpProxyProxyHeader>? proxyHeader,
    ...
    pulumi.Output<String>? service,
      ...
      proxyHeader = pulumi.Input.asOptionalInput<TargetTcpProxyProxyHeader>(proxyHeader),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'project': ?project,
      'proxyBind': ?proxyBind,
      'proxyHeader': ?pulumi.Input.mapOptionalInputValue<TargetTcpProxyProxyHeader, String>(proxyHeader, (value) => value.value),
      'requestId': ?requestId,
      'service': ?service,
    };
  }
  ...
  factory TargetTcpProxyArgs.fromMap(Map<String, dynamic> map) {
    return TargetTcpProxyArgs(
      ...
      proxyHeader: map['proxyHeader'] == null ? null : pulumi.Output.create<TargetTcpProxyProxyHeader>(TargetTcpProxyProxyHeader.fromValue(map['proxyHeader'] as String)),
