...
/// {@template pulumi_compute_alpha_license_iam_member_args_doc}
/// The set of arguments for LicenseIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_alpha_license_iam_member_args_doc}
class LicenseIamMemberArgs {
  ...
  /// Creates a new [LicenseIamMemberArgs].
  ...
  factory LicenseIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return LicenseIamMemberArgs(
