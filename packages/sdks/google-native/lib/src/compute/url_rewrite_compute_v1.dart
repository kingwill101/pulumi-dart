...
class UrlRewriteComputeV1 {
  ...
  /// Creates a new [UrlRewriteComputeV1].
  ...
  factory UrlRewriteComputeV1.fromMap(Map<String, dynamic> map) {
    return UrlRewriteComputeV1(
