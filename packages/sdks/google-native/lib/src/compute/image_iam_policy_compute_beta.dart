...
import 'image_iam_policy_compute_beta_args.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy.
/// Note - this resource's API doesn't support deletion. When deleted, the resource will persist
/// on Google Cloud even though it will be deleted from Pulumi state.
class ImageIamPolicyComputeBeta extends pulumi.CustomResource {
  ...
  /// Creates a new [ImageIamPolicyComputeBeta].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ImageIamPolicyComputeBeta]. {@macro pulumi_compute_beta_image_iam_policy_compute_beta_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  ImageIamPolicyComputeBeta(
    String name, {
    ImageIamPolicyComputeBetaArgs? args,
