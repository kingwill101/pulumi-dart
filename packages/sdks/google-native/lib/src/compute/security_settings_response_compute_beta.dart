...
class SecuritySettingsResponseComputeBeta {
  ...
  const SecuritySettingsResponseComputeBeta({
  ...
  factory SecuritySettingsResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return SecuritySettingsResponseComputeBeta(
      ...
      awsV4Authentication: pulumi.Input.fromValue(AWSV4SignatureResponseComputeBeta.fromMap((map['awsV4Authentication']! as Map).cast<String, dynamic>())),
