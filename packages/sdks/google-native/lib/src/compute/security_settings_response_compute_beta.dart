...
import 'awsv4_signature_response_compute_beta.dart';

/// The authentication and authorization settings for a BackendService.
class SecuritySettingsResponseComputeBeta {
  ...
  final pulumi.Input<AWSV4SignatureResponseComputeBeta> awsV4Authentication;
  ...
  /// Creates a new [SecuritySettingsResponseComputeBeta].
  ...
  SecuritySettingsResponseComputeBeta({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsV4Authentication': pulumi.Input.mapInputValue<AWSV4SignatureResponseComputeBeta, Map<String, dynamic>>(awsV4Authentication, (value) => value.toMap()),
      'clientTlsPolicy': clientTlsPolicy,
      'subjectAltNames': subjectAltNames,
    };
  }

  factory SecuritySettingsResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return SecuritySettingsResponseComputeBeta(
      authentication: (map['authentication'] as String).input(),
      awsV4Authentication: (AWSV4SignatureResponseComputeBeta.fromMap((map['awsV4Authentication'] as Map).cast<String, dynamic>())).input(),
      clientTlsPolicy: (map['clientTlsPolicy'] as String).input(),
