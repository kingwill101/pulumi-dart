...
/// {@template pulumi_compute_alpha_node_group_iam_binding_args_doc}
/// The set of arguments for NodeGroupIamBinding.
/// {@endtemplate}
/// {@macro pulumi_compute_alpha_node_group_iam_binding_args_doc}
class NodeGroupIamBindingArgs {
  ...
  /// Creates a new [NodeGroupIamBindingArgs].
  ...
  factory NodeGroupIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return NodeGroupIamBindingArgs(
