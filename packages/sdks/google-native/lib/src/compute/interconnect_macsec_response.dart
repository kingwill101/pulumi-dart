...
class InterconnectMacsecResponse {
  ...
  factory InterconnectMacsecResponse.fromMap(Map<String, dynamic> map) {
    return InterconnectMacsecResponse(
      ...
      preSharedKeys: (pulumi.Input.decodeList<InterconnectMacsecPreSharedKeyResponse>(map['preSharedKeys'], (value) => InterconnectMacsecPreSharedKeyResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
