...
class InterconnectMacsecResponse {
  ...
  final pulumi.Input<List<InterconnectMacsecPreSharedKeyResponse>> preSharedKeys;
  ...
  const InterconnectMacsecResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'failOpen': failOpen,
      'preSharedKeys': pulumi.Input.mapInputValue<List<InterconnectMacsecPreSharedKeyResponse>, List<Map<String, dynamic>>>(preSharedKeys, (value) => pulumi.Input.encodeList<InterconnectMacsecPreSharedKeyResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory InterconnectMacsecResponse.fromMap(Map<String, dynamic> map) {
    return InterconnectMacsecResponse(
      ...
      preSharedKeys: pulumi.Input.fromValue(pulumi.Input.decodeList<InterconnectMacsecPreSharedKeyResponse>(map['preSharedKeys']!, (value) => InterconnectMacsecPreSharedKeyResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
