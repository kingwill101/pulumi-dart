...
class SecurityPolicyRuleMatcherExprOptionsComputeBeta {
  ...
  final pulumi.Input<SecurityPolicyRuleMatcherExprOptionsRecaptchaOptionsComputeBeta>? recaptchaOptions;
  ...
  const SecurityPolicyRuleMatcherExprOptionsComputeBeta({
    this.recaptchaOptions,
  });

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'recaptchaOptions': ?pulumi.Input.mapOptionalInputValue<SecurityPolicyRuleMatcherExprOptionsRecaptchaOptionsComputeBeta, Map<String, dynamic>>(recaptchaOptions, (value) => value.toMap()),
    };
  }
  ...
  factory SecurityPolicyRuleMatcherExprOptionsComputeBeta.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRuleMatcherExprOptionsComputeBeta(
      recaptchaOptions: (() { final guardedValue = map['recaptchaOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SecurityPolicyRuleMatcherExprOptionsRecaptchaOptionsComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
