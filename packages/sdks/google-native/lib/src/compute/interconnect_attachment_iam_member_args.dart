...
/// {@template pulumi_compute_alpha_interconnect_attachment_iam_member_args_doc}
/// The set of arguments for InterconnectAttachmentIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_alpha_interconnect_attachment_iam_member_args_doc}
class InterconnectAttachmentIamMemberArgs {
  ...
  /// Creates a new [InterconnectAttachmentIamMemberArgs].
  ...
  const InterconnectAttachmentIamMemberArgs({
    this.condition,
  ...
  factory InterconnectAttachmentIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return InterconnectAttachmentIamMemberArgs(
