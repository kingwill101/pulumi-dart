...
/// {@template pulumi_compute_alpha_network_firewall_policy_iam_member_args_doc}
/// The set of arguments for NetworkFirewallPolicyIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_alpha_network_firewall_policy_iam_member_args_doc}
class NetworkFirewallPolicyIamMemberArgs {
  ...
  /// Creates a new [NetworkFirewallPolicyIamMemberArgs].
  ...
  const NetworkFirewallPolicyIamMemberArgs({
    this.condition,
  ...
  factory NetworkFirewallPolicyIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return NetworkFirewallPolicyIamMemberArgs(
