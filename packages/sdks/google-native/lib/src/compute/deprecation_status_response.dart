...
class DeprecationStatusResponse {
  ...
  final pulumi.Input<RolloutPolicyResponse> stateOverride;
  ...
  const DeprecationStatusResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'state': state,
      'stateOverride': pulumi.Input.mapInputValue<RolloutPolicyResponse, Map<String, dynamic>>(stateOverride, (value) => value.toMap()),
    };
  }
  ...
  factory DeprecationStatusResponse.fromMap(Map<String, dynamic> map) {
    return DeprecationStatusResponse(
      ...
      stateOverride: pulumi.Input.fromValue(RolloutPolicyResponse.fromMap((map['stateOverride']! as Map).cast<String, dynamic>())),
    );
  }
}
