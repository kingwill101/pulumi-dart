...
class ServiceAttachmentArgs {
  ...
  ServiceAttachmentArgs({
    pulumi.Output<ServiceAttachmentConnectionPreference>? connectionPreference,
    pulumi.Output<List<ServiceAttachmentConsumerProjectLimit>>? consumerAcceptLists,
  ...
  factory ServiceAttachmentArgs.fromMap(Map<String, dynamic> map) {
    return ServiceAttachmentArgs(
      connectionPreference: map['connectionPreference'] == null ? null : pulumi.Output.create<ServiceAttachmentConnectionPreference>(ServiceAttachmentConnectionPreference.fromValue(map['connectionPreference'] as String)),
      consumerAcceptLists: map['consumerAcceptLists'] == null ? null : pulumi.Output.create<List<ServiceAttachmentConsumerProjectLimit>>(pulumi.Input.decodeList<ServiceAttachmentConsumerProjectLimit>(map['consumerAcceptLists'], (value) => ServiceAttachmentConsumerProjectLimit.fromMap((value as Map).cast<String, dynamic>()))),
