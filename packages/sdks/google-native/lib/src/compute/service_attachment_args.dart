...
class ServiceAttachmentArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'connectionPreference': ?pulumi.Input.mapOptionalInputValue<ServiceAttachmentConnectionPreference, String>(connectionPreference, (value) => value.wireValue),
  ...
  factory ServiceAttachmentArgs.fromMap(Map<String, dynamic> map) {
    return ServiceAttachmentArgs(
      connectionPreference: (() { final guardedValue = map['connectionPreference']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServiceAttachmentConnectionPreference.fromValue(guardedValue as String)); })(),
      consumerAcceptLists: (() { final guardedValue = map['consumerAcceptLists']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ServiceAttachmentConsumerProjectLimit>(guardedValue, (value) => ServiceAttachmentConsumerProjectLimit.fromMap((value as Map).cast<String, dynamic>()))); })(),
