...
class SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponse {
  ...
  /// Creates a new [SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponse].
  ...
  const SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponse({
  ...
  factory SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponse.fromMap(Map<String, dynamic> map) {
