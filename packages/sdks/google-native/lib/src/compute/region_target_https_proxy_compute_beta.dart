...
import 'region_target_https_proxy_compute_beta_args.dart';

/// Creates a TargetHttpsProxy resource in the specified project and region using the data included in the request.
class RegionTargetHttpsProxyComputeBeta extends pulumi.CustomResource {
  ...
  /// Creates a new [RegionTargetHttpsProxyComputeBeta].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [RegionTargetHttpsProxyComputeBeta]. {@macro pulumi_compute_beta_region_target_https_proxy_compute_beta_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  RegionTargetHttpsProxyComputeBeta(
    String name, {
    RegionTargetHttpsProxyComputeBetaArgs? args,
    ...
    httpFilters = registerOutput<List<String>>('httpFilters');
