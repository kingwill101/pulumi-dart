...
class RuleResponseComputeBeta {
  ...
  factory RuleResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return RuleResponseComputeBeta(
      ...
      conditions: pulumi.Input.fromValue(pulumi.Input.decodeList<ConditionResponseComputeBeta>(map['conditions']!, (value) => ConditionResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))),
      description: pulumi.Input.fromValue(map['description'] as String),
      ins: pulumi.Input.fromValue((map['ins'] as List).cast<String>()),
      logConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<LogConfigResponseComputeBeta>(map['logConfigs']!, (value) => LogConfigResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))),
