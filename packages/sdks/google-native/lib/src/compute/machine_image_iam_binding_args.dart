...
/// {@template pulumi_compute_alpha_machine_image_iam_binding_args_doc}
/// The set of arguments for MachineImageIamBinding.
/// {@endtemplate}
/// {@macro pulumi_compute_alpha_machine_image_iam_binding_args_doc}
class MachineImageIamBindingArgs {
  ...
  const MachineImageIamBindingArgs({
    this.condition,
