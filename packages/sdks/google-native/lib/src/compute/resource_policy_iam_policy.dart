...
class ResourcePolicyIamPolicy extends pulumi.CustomResource {
  ...
  /// Creates a new [ResourcePolicyIamPolicy].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ResourcePolicyIamPolicy]. {@macro pulumi_compute_alpha_resource_policy_iam_policy_args_doc}
