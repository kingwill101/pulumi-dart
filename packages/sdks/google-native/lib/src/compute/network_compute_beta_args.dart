...
class NetworkComputeBetaArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'mtu': ?mtu,
      'name': ?name,
      'networkFirewallPolicyEnforcementOrder': ?pulumi.Input.mapOptionalInputValue<NetworkNetworkFirewallPolicyEnforcementOrderComputeBeta, String>(networkFirewallPolicyEnforcementOrder, (value) => value.wireValue),
      'project': ?project,
      'requestId': ?requestId,
  ...
  factory NetworkComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return NetworkComputeBetaArgs(
      ...
      networkFirewallPolicyEnforcementOrder: (() { final guardedValue = map['networkFirewallPolicyEnforcementOrder']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkNetworkFirewallPolicyEnforcementOrderComputeBeta.fromValue(guardedValue as String)); })(),
      project: (() { final guardedValue = map['project']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      requestId: (() { final guardedValue = map['requestId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      routingConfig: (() { final guardedValue = map['routingConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkRoutingConfigComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
