...
/// {@template pulumi_compute_beta_network_compute_beta_args_doc}
/// The set of arguments for Network.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_network_compute_beta_args_doc}
class NetworkComputeBetaArgs {
  ...
  final pulumi.Input<NetworkNetworkFirewallPolicyEnforcementOrderComputeBeta>? networkFirewallPolicyEnforcementOrder;
  ...
  /// Creates a new [NetworkComputeBetaArgs].
  ...
  NetworkComputeBetaArgs({
    ...
    pulumi.Output<NetworkNetworkFirewallPolicyEnforcementOrderComputeBeta>? networkFirewallPolicyEnforcementOrder,
    pulumi.Output<String>? project,
    pulumi.Output<String>? requestId,
    pulumi.Output<NetworkRoutingConfigComputeBeta>? routingConfig,
  }) :
      ...
      networkFirewallPolicyEnforcementOrder = pulumi.Input.asOptionalInput<NetworkNetworkFirewallPolicyEnforcementOrderComputeBeta>(networkFirewallPolicyEnforcementOrder),
      project = pulumi.Input.asOptionalInput<String>(project),
      requestId = pulumi.Input.asOptionalInput<String>(requestId),
      routingConfig = pulumi.Input.asOptionalInput<NetworkRoutingConfigComputeBeta>(routingConfig);
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'mtu': ?mtu,
      'name': ?name,
      'networkFirewallPolicyEnforcementOrder': ?pulumi.Input.mapOptionalInputValue<NetworkNetworkFirewallPolicyEnforcementOrderComputeBeta, String>(networkFirewallPolicyEnforcementOrder, (value) => value.value),
      'project': ?project,
      'requestId': ?requestId,
      'routingConfig': ?pulumi.Input.mapOptionalInputValue<NetworkRoutingConfigComputeBeta, Map<String, dynamic>>(routingConfig, (value) => value.toMap()),
    };
  }
  ...
  factory NetworkComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return NetworkComputeBetaArgs(
      ...
      networkFirewallPolicyEnforcementOrder: map['networkFirewallPolicyEnforcementOrder'] == null ? null : pulumi.Output.create<NetworkNetworkFirewallPolicyEnforcementOrderComputeBeta>(NetworkNetworkFirewallPolicyEnforcementOrderComputeBeta.fromValue(map['networkFirewallPolicyEnforcementOrder'] as String)),
      project: map['project'] == null ? null : pulumi.Output.create<String>(map['project'] as String),
      requestId: map['requestId'] == null ? null : pulumi.Output.create<String>(map['requestId'] as String),
      routingConfig: map['routingConfig'] == null ? null : pulumi.Output.create<NetworkRoutingConfigComputeBeta>(NetworkRoutingConfigComputeBeta.fromMap((map['routingConfig'] as Map).cast<String, dynamic>())),
    );
  }
}
