...
class NetworkEndpointGroupAppEngineResponseComputeV1 {
  ...
  /// Creates a new [NetworkEndpointGroupAppEngineResponseComputeV1].
  ...
  const NetworkEndpointGroupAppEngineResponseComputeV1({
  ...
  factory NetworkEndpointGroupAppEngineResponseComputeV1.fromMap(Map<String, dynamic> map) {
