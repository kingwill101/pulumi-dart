...
class InstanceGroupManagerResizeRequestComputeBeta extends pulumi.CustomResource {
  ...
  InstanceGroupManagerResizeRequestComputeBeta(
    ...
    this.requestedRunDuration = registerOutput<DurationResponseComputeBeta>('requestedRunDuration');
    this.resizeBy = registerOutput<int>('resizeBy');
    this.selfLink = registerOutput<String>('selfLink');
    this.selfLinkWithId = registerOutput<String>('selfLinkWithId');
    this.state = registerOutput<String>('state');
    this.status = registerOutput<InstanceGroupManagerResizeRequestStatusResponseComputeBeta>('status');
