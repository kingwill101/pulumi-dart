...
class AutoscalerArgs {
  ...
  /// [zone] Optional.
  AutoscalerArgs({
    pulumi.Output<AutoscalingPolicy>? autoscalingPolicy,
    ...
    pulumi.Output<String>? zone,
      ...
      autoscalingPolicy = pulumi.Input.asOptionalInput<AutoscalingPolicy>(autoscalingPolicy),
  ...
  factory AutoscalerArgs.fromMap(Map<String, dynamic> map) {
    return AutoscalerArgs(
      autoscalingPolicy: map['autoscalingPolicy'] == null ? null : pulumi.Output.create<AutoscalingPolicy>(AutoscalingPolicy.fromMap((map['autoscalingPolicy'] as Map).cast<String, dynamic>())),
