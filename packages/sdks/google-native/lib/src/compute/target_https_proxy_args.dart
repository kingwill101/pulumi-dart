...
class TargetHttpsProxyArgs {
  ...
  TargetHttpsProxyArgs({
    ...
    pulumi.Output<TargetHttpsProxyQuicOverride>? quicOverride,
    ...
    pulumi.Output<String>? urlMap,
      ...
      quicOverride = pulumi.Input.asOptionalInput<TargetHttpsProxyQuicOverride>(quicOverride),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'project': ?project,
      'proxyBind': ?proxyBind,
      'quicOverride': ?pulumi.Input.mapOptionalInputValue<TargetHttpsProxyQuicOverride, String>(quicOverride, (value) => value.value),
      'requestId': ?requestId,
  ...
  factory TargetHttpsProxyArgs.fromMap(Map<String, dynamic> map) {
    return TargetHttpsProxyArgs(
      ...
      quicOverride: map['quicOverride'] == null ? null : pulumi.Output.create<TargetHttpsProxyQuicOverride>(TargetHttpsProxyQuicOverride.fromValue(map['quicOverride'] as String)),
