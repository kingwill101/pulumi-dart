...
class TargetHttpsProxyArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'project': ?project,
      'proxyBind': ?proxyBind,
      'quicOverride': ?pulumi.Input.mapOptionalInputValue<TargetHttpsProxyQuicOverride, String>(quicOverride, (value) => value.wireValue),
      'requestId': ?requestId,
  ...
  factory TargetHttpsProxyArgs.fromMap(Map<String, dynamic> map) {
    return TargetHttpsProxyArgs(
      ...
      httpFilters: (() { final guardedValue = map['httpFilters']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      ...
      quicOverride: (() { final guardedValue = map['quicOverride']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TargetHttpsProxyQuicOverride.fromValue(guardedValue as String)); })(),
