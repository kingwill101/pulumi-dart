...
class ResourcePolicyWeeklyCycleDayOfWeek {
  ...
  final pulumi.Input<ResourcePolicyWeeklyCycleDayOfWeekDay>? day;
  ...
  const ResourcePolicyWeeklyCycleDayOfWeek({
    this.day,
    this.startTime,
  });
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'day': ?pulumi.Input.mapOptionalInputValue<ResourcePolicyWeeklyCycleDayOfWeekDay, String>(day, (value) => value.wireValue),
      'startTime': ?startTime,
    };
  }
  ...
  factory ResourcePolicyWeeklyCycleDayOfWeek.fromMap(Map<String, dynamic> map) {
    return ResourcePolicyWeeklyCycleDayOfWeek(
      day: (() { final guardedValue = map['day']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResourcePolicyWeeklyCycleDayOfWeekDay.fromValue(guardedValue as String)); })(),
