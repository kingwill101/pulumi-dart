...
class RolloutPolicyComputeBeta {
  ...
  factory RolloutPolicyComputeBeta.fromMap(Map<String, dynamic> map) {
    return RolloutPolicyComputeBeta(
      defaultRolloutTime: map['defaultRolloutTime'] == null ? null : map['defaultRolloutTime'] as String,
      locationRolloutPolicies: map['locationRolloutPolicies'] == null ? null : (map['locationRolloutPolicies'] as Map).cast<String, String>(),
    );
  }
}
