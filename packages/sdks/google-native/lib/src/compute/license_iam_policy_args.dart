...
/// {@template pulumi_compute_alpha_license_iam_policy_args_doc}
/// The set of arguments for LicenseIamPolicy.
/// {@endtemplate}
/// {@macro pulumi_compute_alpha_license_iam_policy_args_doc}
class LicenseIamPolicyArgs {
  ...
  /// Creates a new [LicenseIamPolicyArgs].
  ...
  factory LicenseIamPolicyArgs.fromMap(Map<String, dynamic> map) {
    return LicenseIamPolicyArgs(
