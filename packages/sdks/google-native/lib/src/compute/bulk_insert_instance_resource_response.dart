...
class BulkInsertInstanceResourceResponse {
  ...
  const BulkInsertInstanceResourceResponse({
    required this.count,
  ...
  factory BulkInsertInstanceResourceResponse.fromMap(Map<String, dynamic> map) {
    return BulkInsertInstanceResourceResponse(
      ...
      instanceProperties: pulumi.Input.fromValue(InstancePropertiesResponse.fromMap((map['instanceProperties']! as Map).cast<String, dynamic>())),
      locationPolicy: pulumi.Input.fromValue(LocationPolicyResponse.fromMap((map['locationPolicy']! as Map).cast<String, dynamic>())),
      minCount: pulumi.Input.fromValue(map['minCount'] as String),
      namePattern: pulumi.Input.fromValue(map['namePattern'] as String),
      perInstanceProperties: pulumi.Input.fromValue((map['perInstanceProperties'] as Map).cast<String, String>()),
