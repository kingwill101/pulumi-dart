...
class BulkInsertInstanceResourceResponse {
  ...
  final LocationPolicyResponse locationPolicy;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'locationPolicy': locationPolicy.toMap(),
      'minCount': minCount,
  ...
  factory BulkInsertInstanceResourceResponse.fromMap(Map<String, dynamic> map) {
    return BulkInsertInstanceResourceResponse(
      ...
      instanceProperties: InstancePropertiesResponse.fromMap((map['instanceProperties'] as Map).cast<String, dynamic>()),
      locationPolicy: LocationPolicyResponse.fromMap((map['locationPolicy'] as Map).cast<String, dynamic>()),
      minCount: map['minCount'] as String,
      namePattern: map['namePattern'] as String,
      perInstanceProperties: (map['perInstanceProperties'] as Map).cast<String, String>(),
