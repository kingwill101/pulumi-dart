...
import 'interconnect_circuit_info_response_compute_beta.dart';
import 'interconnect_macsec_response_compute_beta.dart';
import 'interconnect_outage_notification_response_compute_beta.dart';

/// Result data returned by getInterconnect.
class GetInterconnectComputeBetaResult {
  ...
  final List<InterconnectCircuitInfoResponseComputeBeta> circuitInfos;
  ...
  final List<InterconnectOutageNotificationResponseComputeBeta> expectedOutages;
  ...
  final InterconnectMacsecResponseComputeBeta macsec;
  ...
  /// Creates a new [GetInterconnectComputeBetaResult].
  ...
  const GetInterconnectComputeBetaResult({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'circuitInfos': pulumi.Input.encodeList<InterconnectCircuitInfoResponseComputeBeta, Map<String, dynamic>>(circuitInfos, (value) => value.toMap()),
      'creationTimestamp': creationTimestamp,
      'customerName': customerName,
      'description': description,
      'expectedOutages': pulumi.Input.encodeList<InterconnectOutageNotificationResponseComputeBeta, Map<String, dynamic>>(expectedOutages, (value) => value.toMap()),
  ...
  factory GetInterconnectComputeBetaResult.fromMap(Map<String, dynamic> map) {
    return GetInterconnectComputeBetaResult(
      adminEnabled: map['adminEnabled'] as bool,
      availableFeatures: (map['availableFeatures'] as List).cast<String>(),
      circuitInfos: pulumi.Input.decodeList<InterconnectCircuitInfoResponseComputeBeta>(map['circuitInfos']!, (value) => InterconnectCircuitInfoResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      creationTimestamp: map['creationTimestamp'] as String,
      customerName: map['customerName'] as String,
      description: map['description'] as String,
      expectedOutages: pulumi.Input.decodeList<InterconnectOutageNotificationResponseComputeBeta>(map['expectedOutages']!, (value) => InterconnectOutageNotificationResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      googleIpAddress: map['googleIpAddress'] as String,
      googleReferenceId: map['googleReferenceId'] as String,
      interconnectAttachments: (map['interconnectAttachments'] as List).cast<String>(),
      ...
      macsec: InterconnectMacsecResponseComputeBeta.fromMap((map['macsec']! as Map).cast<String, dynamic>()),
