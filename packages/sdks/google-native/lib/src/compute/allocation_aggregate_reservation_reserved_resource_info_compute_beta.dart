...
class AllocationAggregateReservationReservedResourceInfoComputeBeta {
  ...
  const AllocationAggregateReservationReservedResourceInfoComputeBeta({
    this.accelerator,
  });
  ...
  factory AllocationAggregateReservationReservedResourceInfoComputeBeta.fromMap(Map<String, dynamic> map) {
    return AllocationAggregateReservationReservedResourceInfoComputeBeta(
      accelerator: (() { final guardedValue = map['accelerator']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AllocationAggregateReservationReservedResourceInfoAcceleratorComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
