    ...
    return <String, dynamic>{
      'balancingMode':
          ?pulumi.Input.mapOptionalInputValue<
            BackendBalancingModeComputeBeta,
            String
      ...
      'preference':
          ?pulumi.Input.mapOptionalInputValue<
            BackendPreferenceComputeBeta,
            String
          >(preference, (value) => value.wireValue),
    };
  }
    ...
    return BackendComputeBeta(
      balancingMode: (() {
        ...
        return pulumi.Input.fromValue(
          BackendBalancingModeComputeBeta.fromValue(guardedValue as String),
        );
      })(),
      capacityScaler: (() {
      ...
      preference: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          BackendPreferenceComputeBeta.fromValue(guardedValue as String),
        );
      })(),
    );
  }
