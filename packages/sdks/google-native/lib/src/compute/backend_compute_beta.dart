...
class BackendComputeBeta {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'balancingMode': ?pulumi.Input.mapOptionalInputValue<BackendBalancingModeComputeBeta, String>(balancingMode, (value) => value.wireValue),
      ...
      'preference': ?pulumi.Input.mapOptionalInputValue<BackendPreferenceComputeBeta, String>(preference, (value) => value.wireValue),
    };
  }

  factory BackendComputeBeta.fromMap(Map<String, dynamic> map) {
    return BackendComputeBeta(
      balancingMode: (() { final guardedValue = map['balancingMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BackendBalancingModeComputeBeta.fromValue(guardedValue as String)); })(),
      ...
      preference: (() { final guardedValue = map['preference']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BackendPreferenceComputeBeta.fromValue(guardedValue as String)); })(),
    );
  }
}
