...
class PathMatcherComputeBeta {
  ...
  final pulumi.Input<List<PathRuleComputeBeta>>? pathRules;
  /// The list of HTTP route rules. Use this list instead of pathRules when advanced route matching and routing actions are desired. routeRules are evaluated in order of priority, from the lowest to highest number. Within a given pathMatcher, you can set only one of pathRules or routeRules.
  final pulumi.Input<List<HttpRouteRuleComputeBeta>>? routeRules;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'pathRules': ?pulumi.Input.mapOptionalInputValue<List<PathRuleComputeBeta>, List<Map<String, dynamic>>>(pathRules, (value) => pulumi.Input.encodeList<PathRuleComputeBeta, Map<String, dynamic>>(value, (value) => value.toMap())),
      'routeRules': ?pulumi.Input.mapOptionalInputValue<List<HttpRouteRuleComputeBeta>, List<Map<String, dynamic>>>(routeRules, (value) => pulumi.Input.encodeList<HttpRouteRuleComputeBeta, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory PathMatcherComputeBeta.fromMap(Map<String, dynamic> map) {
    return PathMatcherComputeBeta(
      ...
      pathRules: (() { final guardedValue = map['pathRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PathRuleComputeBeta>(guardedValue, (value) => PathRuleComputeBeta.fromMap((value as Map).cast<String, dynamic>()))); })(),
      routeRules: (() { final guardedValue = map['routeRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<HttpRouteRuleComputeBeta>(guardedValue, (value) => HttpRouteRuleComputeBeta.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
