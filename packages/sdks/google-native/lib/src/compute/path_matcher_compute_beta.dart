...
import 'http_route_rule_compute_beta.dart';
import 'path_rule_compute_beta.dart';

/// A matcher for the path portion of the URL. The BackendService from the longest-matched rule will serve the URL. If no rule was matched, the default service is used.
class PathMatcherComputeBeta {
  ...
  final CustomErrorResponsePolicyComputeBeta? defaultCustomErrorResponsePolicy;
  ...
  final HttpRouteActionComputeBeta? defaultRouteAction;
  ...
  final HttpRedirectActionComputeBeta? defaultUrlRedirect;
  ...
  final List<PathRuleComputeBeta>? pathRules;
  /// The list of HTTP route rules. Use this list instead of pathRules when advanced route matching and routing actions are desired. routeRules are evaluated in order of priority, from the lowest to highest number. Within a given pathMatcher, you can set only one of pathRules or routeRules.
  final List<HttpRouteRuleComputeBeta>? routeRules;

  /// Creates a new [PathMatcherComputeBeta].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'pathRules': ?pathRules == null ? null : pulumi.Input.encodeList<PathRuleComputeBeta, Map<String, dynamic>>(pathRules!, (value) => value.toMap()),
      'routeRules': ?routeRules == null ? null : pulumi.Input.encodeList<HttpRouteRuleComputeBeta, Map<String, dynamic>>(routeRules!, (value) => value.toMap()),
    };
  }

  factory PathMatcherComputeBeta.fromMap(Map<String, dynamic> map) {
    return PathMatcherComputeBeta(
      defaultCustomErrorResponsePolicy: map['defaultCustomErrorResponsePolicy'] == null ? null : CustomErrorResponsePolicyComputeBeta.fromMap((map['defaultCustomErrorResponsePolicy'] as Map).cast<String, dynamic>()),
      defaultRouteAction: map['defaultRouteAction'] == null ? null : HttpRouteActionComputeBeta.fromMap((map['defaultRouteAction'] as Map).cast<String, dynamic>()),
      defaultService: map['defaultService'] == null ? null : map['defaultService'] as String,
      defaultUrlRedirect: map['defaultUrlRedirect'] == null ? null : HttpRedirectActionComputeBeta.fromMap((map['defaultUrlRedirect'] as Map).cast<String, dynamic>()),
      ...
      pathRules: map['pathRules'] == null ? null : pulumi.Input.decodeList<PathRuleComputeBeta>(map['pathRules'], (value) => PathRuleComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      routeRules: map['routeRules'] == null ? null : pulumi.Input.decodeList<HttpRouteRuleComputeBeta>(map['routeRules'], (value) => HttpRouteRuleComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
