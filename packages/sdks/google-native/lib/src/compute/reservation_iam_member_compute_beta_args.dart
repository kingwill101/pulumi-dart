...
/// {@template pulumi_compute_beta_reservation_iam_member_compute_beta_args_doc}
/// The set of arguments for ReservationIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_reservation_iam_member_compute_beta_args_doc}
class ReservationIamMemberComputeBetaArgs {
  ...
  /// Creates a new [ReservationIamMemberComputeBetaArgs].
  ...
  const ReservationIamMemberComputeBetaArgs({
    this.condition,
  ...
  factory ReservationIamMemberComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return ReservationIamMemberComputeBetaArgs(
