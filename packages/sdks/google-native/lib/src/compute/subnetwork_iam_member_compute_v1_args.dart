...
/// {@template pulumi_compute_v1_subnetwork_iam_member_compute_v1_args_doc}
/// The set of arguments for SubnetworkIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_v1_subnetwork_iam_member_compute_v1_args_doc}
class SubnetworkIamMemberComputeV1Args {
  ...
  /// Creates a new [SubnetworkIamMemberComputeV1Args].
  ...
  const SubnetworkIamMemberComputeV1Args({
    this.condition,
  ...
  factory SubnetworkIamMemberComputeV1Args.fromMap(Map<String, dynamic> map) {
    return SubnetworkIamMemberComputeV1Args(
