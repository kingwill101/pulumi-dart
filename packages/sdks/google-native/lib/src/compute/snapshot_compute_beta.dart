...
class SnapshotComputeBeta extends pulumi.CustomResource {
  ...
  SnapshotComputeBeta(
    ...
    snapshotEncryptionKey = registerOutput<CustomerEncryptionKeyResponseComputeBeta>('snapshotEncryptionKey', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return CustomerEncryptionKeyResponseComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    sourceInstantSnapshotEncryptionKey = registerOutput<CustomerEncryptionKeyResponseComputeBeta>('sourceInstantSnapshotEncryptionKey', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return CustomerEncryptionKeyResponseComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>()); });
