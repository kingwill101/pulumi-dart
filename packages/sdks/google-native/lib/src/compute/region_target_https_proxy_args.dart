...
class RegionTargetHttpsProxyArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'project': ?project,
      'proxyBind': ?proxyBind,
      'quicOverride': ?pulumi.Input.mapOptionalInputValue<RegionTargetHttpsProxyQuicOverride, String>(quicOverride, (value) => value.wireValue),
      'region': region,
      'requestId': ?requestId,
  ...
  factory RegionTargetHttpsProxyArgs.fromMap(Map<String, dynamic> map) {
    return RegionTargetHttpsProxyArgs(
      ...
      quicOverride: (() { final guardedValue = map['quicOverride']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionTargetHttpsProxyQuicOverride.fromValue(guardedValue as String)); })(),
