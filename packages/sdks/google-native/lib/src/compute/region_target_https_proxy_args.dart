...
import 'region_target_https_proxy_quic_override.dart';

/// {@template pulumi_compute_alpha_region_target_https_proxy_args_doc}
/// The set of arguments for RegionTargetHttpsProxy.
/// {@endtemplate}
/// {@macro pulumi_compute_alpha_region_target_https_proxy_args_doc}
class RegionTargetHttpsProxyArgs {
  ...
  final pulumi.Input<RegionTargetHttpsProxyQuicOverride>? quicOverride;
  ...
  RegionTargetHttpsProxyArgs({
    ...
    pulumi.Output<RegionTargetHttpsProxyQuicOverride>? quicOverride,
    ...
    pulumi.Output<String>? urlMap,
      ...
      quicOverride = pulumi.Input.asOptionalInput<RegionTargetHttpsProxyQuicOverride>(quicOverride),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'project': ?project,
      'proxyBind': ?proxyBind,
      'quicOverride': ?pulumi.Input.mapOptionalInputValue<RegionTargetHttpsProxyQuicOverride, String>(quicOverride, (value) => value.value),
      'region': region,
      'requestId': ?requestId,
  ...
  factory RegionTargetHttpsProxyArgs.fromMap(Map<String, dynamic> map) {
    return RegionTargetHttpsProxyArgs(
      ...
      quicOverride: map['quicOverride'] == null ? null : pulumi.Output.create<RegionTargetHttpsProxyQuicOverride>(RegionTargetHttpsProxyQuicOverride.fromValue(map['quicOverride'] as String)),
