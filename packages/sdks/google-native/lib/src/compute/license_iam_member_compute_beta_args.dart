...
/// {@template pulumi_compute_beta_license_iam_member_compute_beta_args_doc}
/// The set of arguments for LicenseIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_license_iam_member_compute_beta_args_doc}
class LicenseIamMemberComputeBetaArgs {
  ...
  /// Creates a new [LicenseIamMemberComputeBetaArgs].
  ...
  const LicenseIamMemberComputeBetaArgs({
    this.condition,
  ...
  factory LicenseIamMemberComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return LicenseIamMemberComputeBetaArgs(
