...
class SecurityPolicyRuleMatcherConfigResponseComputeBeta {
  ...
  factory SecurityPolicyRuleMatcherConfigResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRuleMatcherConfigResponseComputeBeta(
      ...
      layer4Configs: (pulumi.Input.decodeList<SecurityPolicyRuleMatcherConfigLayer4ConfigResponseComputeBeta>(map['layer4Configs'], (value) => SecurityPolicyRuleMatcherConfigLayer4ConfigResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))).input(),
