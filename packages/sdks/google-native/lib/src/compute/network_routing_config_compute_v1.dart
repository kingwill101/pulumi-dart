...
class NetworkRoutingConfigComputeV1 {
  ...
  const NetworkRoutingConfigComputeV1({
    this.routingMode,
  });

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'routingMode': ?pulumi.Input.mapOptionalInputValue<NetworkRoutingConfigRoutingModeComputeV1, String>(routingMode, (value) => value.wireValue),
    };
  }

  factory NetworkRoutingConfigComputeV1.fromMap(Map<String, dynamic> map) {
    return NetworkRoutingConfigComputeV1(
      routingMode: (() { final guardedValue = map['routingMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkRoutingConfigRoutingModeComputeV1.fromValue(guardedValue as String)); })(),
    );
  }
}
