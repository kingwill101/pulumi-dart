...
class PublicAdvertisedPrefixComputeBetaArgs {
  ...
  const PublicAdvertisedPrefixComputeBetaArgs({
    this.description,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'pdpScope': ?pulumi.Input.mapOptionalInputValue<PublicAdvertisedPrefixPdpScopeComputeBeta, String>(pdpScope, (value) => value.wireValue),
      'project': ?project,
      'requestId': ?requestId,
      'status': ?pulumi.Input.mapOptionalInputValue<PublicAdvertisedPrefixStatusComputeBeta, String>(status, (value) => value.wireValue),
    };
  }
  ...
  factory PublicAdvertisedPrefixComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return PublicAdvertisedPrefixComputeBetaArgs(
      ...
      pdpScope: (() { final guardedValue = map['pdpScope']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PublicAdvertisedPrefixPdpScopeComputeBeta.fromValue(guardedValue as String)); })(),
      project: (() { final guardedValue = map['project']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      requestId: (() { final guardedValue = map['requestId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PublicAdvertisedPrefixStatusComputeBeta.fromValue(guardedValue as String)); })(),
    );
  }
}
