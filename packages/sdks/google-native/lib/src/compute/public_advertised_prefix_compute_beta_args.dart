...
class PublicAdvertisedPrefixComputeBetaArgs {
  ...
  PublicAdvertisedPrefixComputeBetaArgs({
    ...
    pulumi.Output<PublicAdvertisedPrefixPdpScopeComputeBeta>? pdpScope,
    pulumi.Output<String>? project,
    pulumi.Output<String>? requestId,
    pulumi.Output<PublicAdvertisedPrefixStatusComputeBeta>? status,
  }) :
  ...
  factory PublicAdvertisedPrefixComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return PublicAdvertisedPrefixComputeBetaArgs(
      ...
      pdpScope: map['pdpScope'] == null ? null : pulumi.Output.create<PublicAdvertisedPrefixPdpScopeComputeBeta>(PublicAdvertisedPrefixPdpScopeComputeBeta.fromValue(map['pdpScope'] as String)),
      project: map['project'] == null ? null : pulumi.Output.create<String>(map['project'] as String),
      requestId: map['requestId'] == null ? null : pulumi.Output.create<String>(map['requestId'] as String),
      status: map['status'] == null ? null : pulumi.Output.create<PublicAdvertisedPrefixStatusComputeBeta>(PublicAdvertisedPrefixStatusComputeBeta.fromValue(map['status'] as String)),
    );
  }
}
