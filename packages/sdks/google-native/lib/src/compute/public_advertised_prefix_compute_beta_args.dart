...
class PublicAdvertisedPrefixComputeBetaArgs {
  ...
  factory PublicAdvertisedPrefixComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return PublicAdvertisedPrefixComputeBetaArgs(
      ...
      pdpScope: map['pdpScope'] == null ? null : (PublicAdvertisedPrefixPdpScopeComputeBeta.fromValue(map['pdpScope'] as String)).input(),
      project: map['project'] == null ? null : (map['project'] as String).input(),
      requestId: map['requestId'] == null ? null : (map['requestId'] as String).input(),
      status: map['status'] == null ? null : (PublicAdvertisedPrefixStatusComputeBeta.fromValue(map['status'] as String)).input(),
    );
  }
}
