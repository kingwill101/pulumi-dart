...
/// {@template pulumi_compute_alpha_region_snapshot_iam_binding_args_doc}
/// The set of arguments for RegionSnapshotIamBinding.
/// {@endtemplate}
/// {@macro pulumi_compute_alpha_region_snapshot_iam_binding_args_doc}
class RegionSnapshotIamBindingArgs {
  ...
  /// Creates a new [RegionSnapshotIamBindingArgs].
  ...
  const RegionSnapshotIamBindingArgs({
    this.condition,
  ...
  factory RegionSnapshotIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return RegionSnapshotIamBindingArgs(
