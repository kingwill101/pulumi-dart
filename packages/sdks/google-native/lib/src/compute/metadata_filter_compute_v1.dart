...
class MetadataFilterComputeV1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'filterMatchCriteria': ?pulumi.Input.mapOptionalInputValue<MetadataFilterFilterMatchCriteriaComputeV1, String>(filterMatchCriteria, (value) => value.wireValue),
    };
  }

  factory MetadataFilterComputeV1.fromMap(Map<String, dynamic> map) {
    return MetadataFilterComputeV1(
      filterLabels: (() { final guardedValue = map['filterLabels']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<MetadataFilterLabelMatchComputeV1>(guardedValue, (value) => MetadataFilterLabelMatchComputeV1.fromMap((value as Map).cast<String, dynamic>()))); })(),
      filterMatchCriteria: (() { final guardedValue = map['filterMatchCriteria']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MetadataFilterFilterMatchCriteriaComputeV1.fromValue(guardedValue as String)); })(),
    );
  }
}
