...
class MetadataFilterComputeV1 {
  ...
  final pulumi.Input<MetadataFilterFilterMatchCriteriaComputeV1>?
  filterMatchCriteria;
  ...
  MetadataFilterComputeV1({this.filterLabels, this.filterMatchCriteria});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'filterLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<MetadataFilterLabelMatchComputeV1>,
      ...
      'filterMatchCriteria':
          ?pulumi.Input.mapOptionalInputValue<
            MetadataFilterFilterMatchCriteriaComputeV1,
            String
    ...
    return MetadataFilterComputeV1(
      filterLabels: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MetadataFilterLabelMatchComputeV1>(
            guardedValue,
            (value) => MetadataFilterLabelMatchComputeV1.fromMap(
      ...
      filterMatchCriteria: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          MetadataFilterFilterMatchCriteriaComputeV1.fromValue(
