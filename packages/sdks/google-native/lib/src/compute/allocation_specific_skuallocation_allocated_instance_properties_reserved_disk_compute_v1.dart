...
class AllocationSpecificSKUAllocationAllocatedInstancePropertiesReservedDiskComputeV1 {
  ...
  final pulumi.Input<AllocationSpecificSKUAllocationAllocatedInstancePropertiesReservedDiskInterfaceComputeV1>? interface;
  ...
  const AllocationSpecificSKUAllocationAllocatedInstancePropertiesReservedDiskComputeV1({
    this.diskSizeGb,
    this.interface,
  });
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'interface': ?pulumi.Input.mapOptionalInputValue<AllocationSpecificSKUAllocationAllocatedInstancePropertiesReservedDiskInterfaceComputeV1, String>(interface, (value) => value.wireValue),
    };
  }
  ...
  factory AllocationSpecificSKUAllocationAllocatedInstancePropertiesReservedDiskComputeV1.fromMap(Map<String, dynamic> map) {
    return AllocationSpecificSKUAllocationAllocatedInstancePropertiesReservedDiskComputeV1(
      ...
      interface: (() { final guardedValue = map['interface']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AllocationSpecificSKUAllocationAllocatedInstancePropertiesReservedDiskInterfaceComputeV1.fromValue(guardedValue as String)); })(),
    );
  }
}
