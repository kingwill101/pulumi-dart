...
class BackendServiceCdnPolicyComputeV1 {
  ...
  final pulumi.Input<
    List<BackendServiceCdnPolicyBypassCacheOnRequestHeaderComputeV1>
  >?
  ...
  final pulumi.Input<
    List<BackendServiceCdnPolicyNegativeCachingPolicyComputeV1>
  >?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'cacheMode':
          ?pulumi.Input.mapOptionalInputValue<
            BackendServiceCdnPolicyCacheModeComputeV1,
            String
