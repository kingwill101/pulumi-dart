...
class BackendServiceCdnPolicyComputeV1 {
  ...
  final pulumi.Input<List<BackendServiceCdnPolicyBypassCacheOnRequestHeaderComputeV1>>? bypassCacheOnRequestHeaders;
  /// The CacheKeyPolicy for this CdnPolicy.
  final pulumi.Input<CacheKeyPolicyComputeV1>? cacheKeyPolicy;
  ...
  final pulumi.Input<BackendServiceCdnPolicyCacheModeComputeV1>? cacheMode;
  ...
  final pulumi.Input<List<BackendServiceCdnPolicyNegativeCachingPolicyComputeV1>>? negativeCachingPolicy;
  ...
  const BackendServiceCdnPolicyComputeV1({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'bypassCacheOnRequestHeaders': ?pulumi.Input.mapOptionalInputValue<List<BackendServiceCdnPolicyBypassCacheOnRequestHeaderComputeV1>, List<Map<String, dynamic>>>(bypassCacheOnRequestHeaders, (value) => pulumi.Input.encodeList<BackendServiceCdnPolicyBypassCacheOnRequestHeaderComputeV1, Map<String, dynamic>>(value, (value) => value.toMap())),
      'cacheKeyPolicy': ?pulumi.Input.mapOptionalInputValue<CacheKeyPolicyComputeV1, Map<String, dynamic>>(cacheKeyPolicy, (value) => value.toMap()),
      'cacheMode': ?pulumi.Input.mapOptionalInputValue<BackendServiceCdnPolicyCacheModeComputeV1, String>(cacheMode, (value) => value.wireValue),
      'clientTtl': ?clientTtl,
      'defaultTtl': ?defaultTtl,
      'maxTtl': ?maxTtl,
      'negativeCaching': ?negativeCaching,
      'negativeCachingPolicy': ?pulumi.Input.mapOptionalInputValue<List<BackendServiceCdnPolicyNegativeCachingPolicyComputeV1>, List<Map<String, dynamic>>>(negativeCachingPolicy, (value) => pulumi.Input.encodeList<BackendServiceCdnPolicyNegativeCachingPolicyComputeV1, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory BackendServiceCdnPolicyComputeV1.fromMap(Map<String, dynamic> map) {
    return BackendServiceCdnPolicyComputeV1(
      bypassCacheOnRequestHeaders: (() { final guardedValue = map['bypassCacheOnRequestHeaders']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<BackendServiceCdnPolicyBypassCacheOnRequestHeaderComputeV1>(guardedValue, (value) => BackendServiceCdnPolicyBypassCacheOnRequestHeaderComputeV1.fromMap((value as Map).cast<String, dynamic>()))); })(),
      cacheKeyPolicy: (() { final guardedValue = map['cacheKeyPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CacheKeyPolicyComputeV1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      cacheMode: (() { final guardedValue = map['cacheMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BackendServiceCdnPolicyCacheModeComputeV1.fromValue(guardedValue as String)); })(),
      ...
      negativeCachingPolicy: (() { final guardedValue = map['negativeCachingPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<BackendServiceCdnPolicyNegativeCachingPolicyComputeV1>(guardedValue, (value) => BackendServiceCdnPolicyNegativeCachingPolicyComputeV1.fromMap((value as Map).cast<String, dynamic>()))); })(),
