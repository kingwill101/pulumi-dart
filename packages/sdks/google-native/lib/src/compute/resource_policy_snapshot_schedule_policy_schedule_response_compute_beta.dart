...
class ResourcePolicySnapshotSchedulePolicyScheduleResponseComputeBeta {
  ...
  final pulumi.Input<ResourcePolicyHourlyCycleResponseComputeBeta>
  hourlySchedule;
  final pulumi.Input<ResourcePolicyWeeklyCycleResponseComputeBeta>
  weeklySchedule;
    ...
    return <String, dynamic>{
      'dailySchedule':
          pulumi.Input.mapInputValue<
            ResourcePolicyDailyCycleResponseComputeBeta,
            Map<String, dynamic>
