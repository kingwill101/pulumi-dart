...
class ResourcePolicySnapshotSchedulePolicyScheduleResponseComputeBeta {
  ...
  factory ResourcePolicySnapshotSchedulePolicyScheduleResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return ResourcePolicySnapshotSchedulePolicyScheduleResponseComputeBeta(
      dailySchedule: (ResourcePolicyDailyCycleResponseComputeBeta.fromMap((map['dailySchedule'] as Map).cast<String, dynamic>())).input(),
      hourlySchedule: (ResourcePolicyHourlyCycleResponseComputeBeta.fromMap((map['hourlySchedule'] as Map).cast<String, dynamic>())).input(),
      weeklySchedule: (ResourcePolicyWeeklyCycleResponseComputeBeta.fromMap((map['weeklySchedule'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
