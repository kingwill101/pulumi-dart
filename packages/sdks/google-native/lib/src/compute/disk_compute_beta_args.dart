...
class DiskComputeBetaArgs {
  ...
  factory DiskComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return DiskComputeBetaArgs(
      architecture: map['architecture'] == null ? null : (DiskArchitectureComputeBeta.fromValue(map['architecture'] as String)).input(),
      ...
      interface: map['interface'] == null ? null : (DiskInterfaceComputeBeta.fromValue(map['interface'] as String)).input(),
      ...
      storageType: map['storageType'] == null ? null : (DiskStorageTypeComputeBeta.fromValue(map['storageType'] as String)).input(),
