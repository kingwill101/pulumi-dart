...
class DiskComputeBetaArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'architecture': ?pulumi.Input.mapOptionalInputValue<DiskArchitectureComputeBeta, String>(architecture, (value) => value.wireValue),
      ...
      'interface': ?pulumi.Input.mapOptionalInputValue<DiskInterfaceComputeBeta, String>(interface, (value) => value.wireValue),
      'labels': ?labels,
      ...
      'storageType': ?pulumi.Input.mapOptionalInputValue<DiskStorageTypeComputeBeta, String>(storageType, (value) => value.wireValue),
      'type': ?type,
  ...
  factory DiskComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return DiskComputeBetaArgs(
      architecture: (() { final guardedValue = map['architecture']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DiskArchitectureComputeBeta.fromValue(guardedValue as String)); })(),
      ...
      interface: (() { final guardedValue = map['interface']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DiskInterfaceComputeBeta.fromValue(guardedValue as String)); })(),
      ...
      storageType: (() { final guardedValue = map['storageType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DiskStorageTypeComputeBeta.fromValue(guardedValue as String)); })(),
