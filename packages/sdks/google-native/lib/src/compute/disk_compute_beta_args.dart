...
class DiskComputeBetaArgs {
  ...
  /// [zone] Optional.
  DiskComputeBetaArgs({
    pulumi.Output<DiskArchitectureComputeBeta>? architecture,
    ...
    pulumi.Output<DiskInterfaceComputeBeta>? interface,
    ...
    pulumi.Output<DiskStorageTypeComputeBeta>? storageType,
  ...
  factory DiskComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return DiskComputeBetaArgs(
      architecture: map['architecture'] == null ? null : pulumi.Output.create<DiskArchitectureComputeBeta>(DiskArchitectureComputeBeta.fromValue(map['architecture'] as String)),
      ...
      interface: map['interface'] == null ? null : pulumi.Output.create<DiskInterfaceComputeBeta>(DiskInterfaceComputeBeta.fromValue(map['interface'] as String)),
      ...
      storageType: map['storageType'] == null ? null : pulumi.Output.create<DiskStorageTypeComputeBeta>(DiskStorageTypeComputeBeta.fromValue(map['storageType'] as String)),
