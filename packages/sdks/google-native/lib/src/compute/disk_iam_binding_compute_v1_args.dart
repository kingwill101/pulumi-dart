...
/// {@template pulumi_compute_v1_disk_iam_binding_compute_v1_args_doc}
/// The set of arguments for DiskIamBinding.
/// {@endtemplate}
/// {@macro pulumi_compute_v1_disk_iam_binding_compute_v1_args_doc}
class DiskIamBindingComputeV1Args {
  ...
  /// Creates a new [DiskIamBindingComputeV1Args].
  ...
  const DiskIamBindingComputeV1Args({
    this.condition,
