...
class GetInstantSnapshotComputeBetaResult {
  ...
  /// Creates a new [GetInstantSnapshotComputeBetaResult].
  ...
  const GetInstantSnapshotComputeBetaResult({
  ...
  factory GetInstantSnapshotComputeBetaResult.fromMap(Map<String, dynamic> map) {
    return GetInstantSnapshotComputeBetaResult(
      ...
      resourceStatus: InstantSnapshotResourceStatusResponseComputeBeta.fromMap((map['resourceStatus']! as Map).cast<String, dynamic>()),
