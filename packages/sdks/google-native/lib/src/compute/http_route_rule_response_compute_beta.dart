...
class HttpRouteRuleResponseComputeBeta {
  ...
  final pulumi.Input<CustomErrorResponsePolicyResponseComputeBeta> customErrorResponsePolicy;
  ...
  final pulumi.Input<List<HttpFilterConfigResponseComputeBeta>> httpFilterConfigs;
  ...
  final pulumi.Input<List<HttpFilterConfigResponseComputeBeta>> httpFilterMetadata;
  /// The list of criteria for matching attributes of a request to this routeRule. This list has OR semantics: the request matches this routeRule when any of the matchRules are satisfied. However predicates within a given matchRule have AND semantics. All predicates within a matchRule must match for the request to match the rule.
  final pulumi.Input<List<HttpRouteRuleMatchResponseComputeBeta>> matchRules;
  ...
  final pulumi.Input<HttpRouteActionResponseComputeBeta> routeAction;
  ...
  final pulumi.Input<HttpRedirectActionResponseComputeBeta> urlRedirect;
  ...
  const HttpRouteRuleResponseComputeBeta({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'customErrorResponsePolicy': pulumi.Input.mapInputValue<CustomErrorResponsePolicyResponseComputeBeta, Map<String, dynamic>>(customErrorResponsePolicy, (value) => value.toMap()),
      ...
      'httpFilterConfigs': pulumi.Input.mapInputValue<List<HttpFilterConfigResponseComputeBeta>, List<Map<String, dynamic>>>(httpFilterConfigs, (value) => pulumi.Input.encodeList<HttpFilterConfigResponseComputeBeta, Map<String, dynamic>>(value, (value) => value.toMap())),
      'httpFilterMetadata': pulumi.Input.mapInputValue<List<HttpFilterConfigResponseComputeBeta>, List<Map<String, dynamic>>>(httpFilterMetadata, (value) => pulumi.Input.encodeList<HttpFilterConfigResponseComputeBeta, Map<String, dynamic>>(value, (value) => value.toMap())),
      'matchRules': pulumi.Input.mapInputValue<List<HttpRouteRuleMatchResponseComputeBeta>, List<Map<String, dynamic>>>(matchRules, (value) => pulumi.Input.encodeList<HttpRouteRuleMatchResponseComputeBeta, Map<String, dynamic>>(value, (value) => value.toMap())),
      'priority': priority,
      'routeAction': pulumi.Input.mapInputValue<HttpRouteActionResponseComputeBeta, Map<String, dynamic>>(routeAction, (value) => value.toMap()),
      'service': service,
      'urlRedirect': pulumi.Input.mapInputValue<HttpRedirectActionResponseComputeBeta, Map<String, dynamic>>(urlRedirect, (value) => value.toMap()),
    };
  }

  factory HttpRouteRuleResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return HttpRouteRuleResponseComputeBeta(
      customErrorResponsePolicy: pulumi.Input.fromValue(CustomErrorResponsePolicyResponseComputeBeta.fromMap((map['customErrorResponsePolicy']! as Map).cast<String, dynamic>())),
      description: pulumi.Input.fromValue(map['description'] as String),
      headerAction: pulumi.Input.fromValue(HttpHeaderActionResponseComputeBeta.fromMap((map['headerAction']! as Map).cast<String, dynamic>())),
      httpFilterConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<HttpFilterConfigResponseComputeBeta>(map['httpFilterConfigs']!, (value) => HttpFilterConfigResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))),
      httpFilterMetadata: pulumi.Input.fromValue(pulumi.Input.decodeList<HttpFilterConfigResponseComputeBeta>(map['httpFilterMetadata']!, (value) => HttpFilterConfigResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))),
      matchRules: pulumi.Input.fromValue(pulumi.Input.decodeList<HttpRouteRuleMatchResponseComputeBeta>(map['matchRules']!, (value) => HttpRouteRuleMatchResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))),
      priority: pulumi.Input.fromValue(map['priority'] as int),
      routeAction: pulumi.Input.fromValue(HttpRouteActionResponseComputeBeta.fromMap((map['routeAction']! as Map).cast<String, dynamic>())),
      service: pulumi.Input.fromValue(map['service'] as String),
      urlRedirect: pulumi.Input.fromValue(HttpRedirectActionResponseComputeBeta.fromMap((map['urlRedirect']! as Map).cast<String, dynamic>())),
    );
  }
}
