...
class HttpRouteRuleResponseComputeBeta {
  ...
  final pulumi.Input<List<HttpFilterConfigResponseComputeBeta>>
  httpFilterConfigs;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'httpFilterConfigs':
          pulumi.Input.mapInputValue<
            List<HttpFilterConfigResponseComputeBeta>,
      ...
      'matchRules':
          pulumi.Input.mapInputValue<
            List<HttpRouteRuleMatchResponseComputeBeta>,
            List<Map<String, dynamic>>
          >(
            matchRules,
            (value) =>
  ...
  factory HttpRouteRuleResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return HttpRouteRuleResponseComputeBeta(
      ...
      httpFilterConfigs: pulumi.Input.fromValue(
      ...
      httpFilterMetadata: pulumi.Input.fromValue(
        pulumi.Input.decodeList<HttpFilterConfigResponseComputeBeta>(
      ...
      matchRules: pulumi.Input.fromValue(
