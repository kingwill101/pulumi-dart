...
class HttpRouteRuleResponseComputeBeta {
  ...
  factory HttpRouteRuleResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return HttpRouteRuleResponseComputeBeta(
      customErrorResponsePolicy: (CustomErrorResponsePolicyResponseComputeBeta.fromMap((map['customErrorResponsePolicy'] as Map).cast<String, dynamic>())).input(),
      description: (map['description'] as String).input(),
      headerAction: (HttpHeaderActionResponseComputeBeta.fromMap((map['headerAction'] as Map).cast<String, dynamic>())).input(),
      httpFilterConfigs: (pulumi.Input.decodeList<HttpFilterConfigResponseComputeBeta>(map['httpFilterConfigs'], (value) => HttpFilterConfigResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))).input(),
      httpFilterMetadata: (pulumi.Input.decodeList<HttpFilterConfigResponseComputeBeta>(map['httpFilterMetadata'], (value) => HttpFilterConfigResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))).input(),
      matchRules: (pulumi.Input.decodeList<HttpRouteRuleMatchResponseComputeBeta>(map['matchRules'], (value) => HttpRouteRuleMatchResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))).input(),
      priority: (map['priority'] as int).input(),
      routeAction: (HttpRouteActionResponseComputeBeta.fromMap((map['routeAction'] as Map).cast<String, dynamic>())).input(),
      service: (map['service'] as String).input(),
      urlRedirect: (HttpRedirectActionResponseComputeBeta.fromMap((map['urlRedirect'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
