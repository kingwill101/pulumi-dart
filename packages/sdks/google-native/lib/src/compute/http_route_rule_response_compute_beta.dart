...
class HttpRouteRuleResponseComputeBeta {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'httpFilterConfigs': pulumi.Input.encodeList<HttpFilterConfigResponseComputeBeta, Map<String, dynamic>>(httpFilterConfigs, (value) => value.toMap()),
      'httpFilterMetadata': pulumi.Input.encodeList<HttpFilterConfigResponseComputeBeta, Map<String, dynamic>>(httpFilterMetadata, (value) => value.toMap()),
      'matchRules': pulumi.Input.encodeList<HttpRouteRuleMatchResponseComputeBeta, Map<String, dynamic>>(matchRules, (value) => value.toMap()),
      'priority': priority,
  ...
  factory HttpRouteRuleResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return HttpRouteRuleResponseComputeBeta(
      customErrorResponsePolicy: CustomErrorResponsePolicyResponseComputeBeta.fromMap((map['customErrorResponsePolicy'] as Map).cast<String, dynamic>()),
      description: map['description'] as String,
      headerAction: HttpHeaderActionResponseComputeBeta.fromMap((map['headerAction'] as Map).cast<String, dynamic>()),
      httpFilterConfigs: pulumi.Input.decodeList<HttpFilterConfigResponseComputeBeta>(map['httpFilterConfigs'], (value) => HttpFilterConfigResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      httpFilterMetadata: pulumi.Input.decodeList<HttpFilterConfigResponseComputeBeta>(map['httpFilterMetadata'], (value) => HttpFilterConfigResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      matchRules: pulumi.Input.decodeList<HttpRouteRuleMatchResponseComputeBeta>(map['matchRules'], (value) => HttpRouteRuleMatchResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      priority: map['priority'] as int,
      routeAction: HttpRouteActionResponseComputeBeta.fromMap((map['routeAction'] as Map).cast<String, dynamic>()),
      service: map['service'] as String,
      urlRedirect: HttpRedirectActionResponseComputeBeta.fromMap((map['urlRedirect'] as Map).cast<String, dynamic>()),
    );
  }
}
