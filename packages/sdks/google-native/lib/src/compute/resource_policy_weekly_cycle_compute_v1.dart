...
class ResourcePolicyWeeklyCycleComputeV1 {
  ...
  final pulumi.Input<List<ResourcePolicyWeeklyCycleDayOfWeekComputeV1>>?
  dayOfWeeks;
    ...
    return <String, dynamic>{
      'dayOfWeeks':
          ?pulumi.Input.mapOptionalInputValue<
            List<ResourcePolicyWeeklyCycleDayOfWeekComputeV1>,
    ...
    return ResourcePolicyWeeklyCycleComputeV1(
      dayOfWeeks: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ResourcePolicyWeeklyCycleDayOfWeekComputeV1>(
            guardedValue,
