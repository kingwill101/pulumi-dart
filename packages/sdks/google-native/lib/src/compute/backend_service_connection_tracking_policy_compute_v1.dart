...
class BackendServiceConnectionTrackingPolicyComputeV1 {
  ...
  final pulumi.Input<BackendServiceConnectionTrackingPolicyConnectionPersistenceOnUnhealthyBackendsComputeV1>? connectionPersistenceOnUnhealthyBackends;
  ...
  final pulumi.Input<BackendServiceConnectionTrackingPolicyTrackingModeComputeV1>? trackingMode;
  ...
  const BackendServiceConnectionTrackingPolicyComputeV1({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'connectionPersistenceOnUnhealthyBackends': ?pulumi.Input.mapOptionalInputValue<BackendServiceConnectionTrackingPolicyConnectionPersistenceOnUnhealthyBackendsComputeV1, String>(connectionPersistenceOnUnhealthyBackends, (value) => value.wireValue),
      'enableStrongAffinity': ?enableStrongAffinity,
      'idleTimeoutSec': ?idleTimeoutSec,
      'trackingMode': ?pulumi.Input.mapOptionalInputValue<BackendServiceConnectionTrackingPolicyTrackingModeComputeV1, String>(trackingMode, (value) => value.wireValue),
    };
  }

  factory BackendServiceConnectionTrackingPolicyComputeV1.fromMap(Map<String, dynamic> map) {
    return BackendServiceConnectionTrackingPolicyComputeV1(
      connectionPersistenceOnUnhealthyBackends: (() { final guardedValue = map['connectionPersistenceOnUnhealthyBackends']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BackendServiceConnectionTrackingPolicyConnectionPersistenceOnUnhealthyBackendsComputeV1.fromValue(guardedValue as String)); })(),
      ...
      trackingMode: (() { final guardedValue = map['trackingMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BackendServiceConnectionTrackingPolicyTrackingModeComputeV1.fromValue(guardedValue as String)); })(),
    );
  }
}
