...
class BackendServiceConnectionTrackingPolicyComputeV1 {
    ...
    return <String, dynamic>{
      ...
      'trackingMode':
          ?pulumi.Input.mapOptionalInputValue<
            BackendServiceConnectionTrackingPolicyTrackingModeComputeV1,
            String
          >(trackingMode, (value) => value.wireValue),
    };
  }
  ...
  factory BackendServiceConnectionTrackingPolicyComputeV1.fromMap(
    ...
    return BackendServiceConnectionTrackingPolicyComputeV1(
      connectionPersistenceOnUnhealthyBackends: (() {
        final guardedValue = map['connectionPersistenceOnUnhealthyBackends'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          BackendServiceConnectionTrackingPolicyConnectionPersistenceOnUnhealthyBackendsComputeV1.fromValue(
            guardedValue as String,
          ),
        );
      })(),
      enableStrongAffinity: (() {
        final guardedValue = map['enableStrongAffinity'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      idleTimeoutSec: (() {
        final guardedValue = map['idleTimeoutSec'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      trackingMode: (() {
        final guardedValue = map['trackingMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          BackendServiceConnectionTrackingPolicyTrackingModeComputeV1.fromValue(
            guardedValue as String,
          ),
        );
      })(),
