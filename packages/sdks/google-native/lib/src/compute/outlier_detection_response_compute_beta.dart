...
class OutlierDetectionResponseComputeBeta {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'baseEjectionTime': pulumi.Input.mapInputValue<DurationResponseComputeBeta, Map<String, dynamic>>(baseEjectionTime, (value) => value.toMap()),
      ...
      'interval': pulumi.Input.mapInputValue<DurationResponseComputeBeta, Map<String, dynamic>>(interval, (value) => value.toMap()),
  ...
  factory OutlierDetectionResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return OutlierDetectionResponseComputeBeta(
      baseEjectionTime: (DurationResponseComputeBeta.fromMap((map['baseEjectionTime'] as Map).cast<String, dynamic>())).input(),
      ...
      interval: (DurationResponseComputeBeta.fromMap((map['interval'] as Map).cast<String, dynamic>())).input(),
