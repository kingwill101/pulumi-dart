...
class OutlierDetectionResponseComputeBeta {
  ...
  factory OutlierDetectionResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return OutlierDetectionResponseComputeBeta(
      baseEjectionTime: pulumi.Input.fromValue(DurationResponseComputeBeta.fromMap((map['baseEjectionTime']! as Map).cast<String, dynamic>())),
      ...
      interval: pulumi.Input.fromValue(DurationResponseComputeBeta.fromMap((map['interval']! as Map).cast<String, dynamic>())),
