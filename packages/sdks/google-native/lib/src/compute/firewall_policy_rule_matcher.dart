...
class FirewallPolicyRuleMatcher {
  ...
  final List<FirewallPolicyRuleMatcherLayer4Config>? layer4Configs;
  ...
  final List<FirewallPolicyRuleSecureTag>? srcSecureTags;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'layer4Configs': ?layer4Configs == null ? null : pulumi.Input.encodeList<FirewallPolicyRuleMatcherLayer4Config, Map<String, dynamic>>(layer4Configs!, (value) => value.toMap()),
      'srcAddressGroups': ?srcAddressGroups,
      'srcFqdns': ?srcFqdns,
      'srcIpRanges': ?srcIpRanges,
      'srcRegionCodes': ?srcRegionCodes,
      'srcSecureTags': ?srcSecureTags == null ? null : pulumi.Input.encodeList<FirewallPolicyRuleSecureTag, Map<String, dynamic>>(srcSecureTags!, (value) => value.toMap()),
  ...
  factory FirewallPolicyRuleMatcher.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyRuleMatcher(
      ...
      layer4Configs: map['layer4Configs'] == null ? null : pulumi.Input.decodeList<FirewallPolicyRuleMatcherLayer4Config>(map['layer4Configs'], (value) => FirewallPolicyRuleMatcherLayer4Config.fromMap((value as Map).cast<String, dynamic>())),
      ...
      srcSecureTags: map['srcSecureTags'] == null ? null : pulumi.Input.decodeList<FirewallPolicyRuleSecureTag>(map['srcSecureTags'], (value) => FirewallPolicyRuleSecureTag.fromMap((value as Map).cast<String, dynamic>())),
