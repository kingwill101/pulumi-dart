...
class FirewallPolicyRuleMatcher {
  ...
  final pulumi.Input<List<FirewallPolicyRuleMatcherLayer4Config>>? layer4Configs;
  ...
  const FirewallPolicyRuleMatcher({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'layer4Configs': ?pulumi.Input.mapOptionalInputValue<List<FirewallPolicyRuleMatcherLayer4Config>, List<Map<String, dynamic>>>(layer4Configs, (value) => pulumi.Input.encodeList<FirewallPolicyRuleMatcherLayer4Config, Map<String, dynamic>>(value, (value) => value.toMap())),
      'srcAddressGroups': ?srcAddressGroups,
      'srcFqdns': ?srcFqdns,
      'srcIpRanges': ?srcIpRanges,
      'srcRegionCodes': ?srcRegionCodes,
      'srcSecureTags': ?pulumi.Input.mapOptionalInputValue<List<FirewallPolicyRuleSecureTag>, List<Map<String, dynamic>>>(srcSecureTags, (value) => pulumi.Input.encodeList<FirewallPolicyRuleSecureTag, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory FirewallPolicyRuleMatcher.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyRuleMatcher(
      ...
      layer4Configs: (() { final guardedValue = map['layer4Configs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FirewallPolicyRuleMatcherLayer4Config>(guardedValue, (value) => FirewallPolicyRuleMatcherLayer4Config.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      srcSecureTags: (() { final guardedValue = map['srcSecureTags']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FirewallPolicyRuleSecureTag>(guardedValue, (value) => FirewallPolicyRuleSecureTag.fromMap((value as Map).cast<String, dynamic>()))); })(),
