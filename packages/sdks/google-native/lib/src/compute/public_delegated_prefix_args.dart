...
class PublicDelegatedPrefixArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'mode': ?pulumi.Input.mapOptionalInputValue<PublicDelegatedPrefixMode, String>(mode, (value) => value.wireValue),
      'name': ?name,
  ...
  factory PublicDelegatedPrefixArgs.fromMap(Map<String, dynamic> map) {
    return PublicDelegatedPrefixArgs(
      ...
      mode: (() { final guardedValue = map['mode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PublicDelegatedPrefixMode.fromValue(guardedValue as String)); })(),
