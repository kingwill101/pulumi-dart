...
class FirewallDeniedItemResponseComputeBeta {
  ...
  /// Creates a new [FirewallDeniedItemResponseComputeBeta].
  ...
  const FirewallDeniedItemResponseComputeBeta({
  ...
  factory FirewallDeniedItemResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return FirewallDeniedItemResponseComputeBeta(
