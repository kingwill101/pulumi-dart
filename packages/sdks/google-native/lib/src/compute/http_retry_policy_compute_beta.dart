...
class HttpRetryPolicyComputeBeta {
  ...
  final pulumi.Input<DurationComputeBeta>? perTryTimeout;
  ...
  const HttpRetryPolicyComputeBeta({
    this.numRetries,
    this.perTryTimeout,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'perTryTimeout': ?pulumi.Input.mapOptionalInputValue<DurationComputeBeta, Map<String, dynamic>>(perTryTimeout, (value) => value.toMap()),
  ...
  factory HttpRetryPolicyComputeBeta.fromMap(Map<String, dynamic> map) {
    return HttpRetryPolicyComputeBeta(
      ...
      perTryTimeout: (() { final guardedValue = map['perTryTimeout']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DurationComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
