...
class CacheKeyPolicyComputeBeta {
  ...
  /// Creates a new [CacheKeyPolicyComputeBeta].
  ...
  const CacheKeyPolicyComputeBeta({
    this.includeHost,
  ...
  factory CacheKeyPolicyComputeBeta.fromMap(Map<String, dynamic> map) {
    return CacheKeyPolicyComputeBeta(
