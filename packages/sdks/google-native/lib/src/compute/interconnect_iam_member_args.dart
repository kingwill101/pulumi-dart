...
/// {@template pulumi_compute_alpha_interconnect_iam_member_args_doc}
/// The set of arguments for InterconnectIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_alpha_interconnect_iam_member_args_doc}
class InterconnectIamMemberArgs {
  ...
  /// Creates a new [InterconnectIamMemberArgs].
  ...
  const InterconnectIamMemberArgs({
    this.condition,
  ...
  factory InterconnectIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return InterconnectIamMemberArgs(
