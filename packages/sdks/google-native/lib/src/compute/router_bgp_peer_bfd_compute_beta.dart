...
class RouterBgpPeerBfdComputeBeta {
  ...
  const RouterBgpPeerBfdComputeBeta({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'sessionInitializationMode': ?pulumi.Input.mapOptionalInputValue<RouterBgpPeerBfdSessionInitializationModeComputeBeta, String>(sessionInitializationMode, (value) => value.wireValue),
    };
  }
  ...
  factory RouterBgpPeerBfdComputeBeta.fromMap(Map<String, dynamic> map) {
    return RouterBgpPeerBfdComputeBeta(
      ...
      sessionInitializationMode: (() { final guardedValue = map['sessionInitializationMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RouterBgpPeerBfdSessionInitializationModeComputeBeta.fromValue(guardedValue as String)); })(),
    );
  }
}
