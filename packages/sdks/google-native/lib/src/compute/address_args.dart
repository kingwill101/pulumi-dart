...
class AddressArgs {
  ...
  factory AddressArgs.fromMap(Map<String, dynamic> map) {
    return AddressArgs(
      ...
      addressType: map['addressType'] == null ? null : (AddressAddressType.fromValue(map['addressType']! as String)).input(),
      description: map['description'] == null ? null : (map['description']! as String).input(),
      ipVersion: map['ipVersion'] == null ? null : (AddressIpVersion.fromValue(map['ipVersion']! as String)).input(),
      ipv6EndpointType: map['ipv6EndpointType'] == null ? null : (AddressIpv6EndpointType.fromValue(map['ipv6EndpointType']! as String)).input(),
      labels: map['labels'] == null ? null : ((map['labels']! as Map).cast<String, String>()).input(),
      name: map['name'] == null ? null : (map['name']! as String).input(),
      network: map['network'] == null ? null : (map['network']! as String).input(),
      networkTier: map['networkTier'] == null ? null : (AddressNetworkTier.fromValue(map['networkTier']! as String)).input(),
      prefixLength: map['prefixLength'] == null ? null : (map['prefixLength']! as int).input(),
      project: map['project'] == null ? null : (map['project']! as String).input(),
      purpose: map['purpose'] == null ? null : (AddressPurpose.fromValue(map['purpose']! as String)).input(),
