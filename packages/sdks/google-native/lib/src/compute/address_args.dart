...
class AddressArgs {
  ...
  AddressArgs({
    ...
    pulumi.Output<AddressAddressType>? addressType,
    pulumi.Output<String>? description,
    pulumi.Output<AddressIpVersion>? ipVersion,
    pulumi.Output<AddressIpv6EndpointType>? ipv6EndpointType,
    pulumi.Output<Map<String, String>>? labels,
    pulumi.Output<String>? name,
    pulumi.Output<String>? network,
    pulumi.Output<AddressNetworkTier>? networkTier,
    pulumi.Output<int>? prefixLength,
    pulumi.Output<String>? project,
    pulumi.Output<AddressPurpose>? purpose,
    required pulumi.Output<String> region,
    pulumi.Output<String>? requestId,
    pulumi.Output<String>? subnetwork,
  }) :
      address = pulumi.Input.asOptionalInput<String>(address),
      addressType = pulumi.Input.asOptionalInput<AddressAddressType>(addressType),
      description = pulumi.Input.asOptionalInput<String>(description),
      ipVersion = pulumi.Input.asOptionalInput<AddressIpVersion>(ipVersion),
      ipv6EndpointType = pulumi.Input.asOptionalInput<AddressIpv6EndpointType>(ipv6EndpointType),
      labels = pulumi.Input.asOptionalInput<Map<String, String>>(labels),
      name = pulumi.Input.asOptionalInput<String>(name),
      network = pulumi.Input.asOptionalInput<String>(network),
      networkTier = pulumi.Input.asOptionalInput<AddressNetworkTier>(networkTier),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'address': ?address,
      'addressType': ?pulumi.Input.mapOptionalInputValue<AddressAddressType, String>(addressType, (value) => value.value),
      'description': ?description,
      'ipVersion': ?pulumi.Input.mapOptionalInputValue<AddressIpVersion, String>(ipVersion, (value) => value.value),
      'ipv6EndpointType': ?pulumi.Input.mapOptionalInputValue<AddressIpv6EndpointType, String>(ipv6EndpointType, (value) => value.value),
      'labels': ?labels,
      'name': ?name,
      'network': ?network,
      'networkTier': ?pulumi.Input.mapOptionalInputValue<AddressNetworkTier, String>(networkTier, (value) => value.value),
      'prefixLength': ?prefixLength,
      'project': ?project,
      'purpose': ?pulumi.Input.mapOptionalInputValue<AddressPurpose, String>(purpose, (value) => value.value),
      'region': region,
      'requestId': ?requestId,
  ...
  factory AddressArgs.fromMap(Map<String, dynamic> map) {
    return AddressArgs(
      ...
      addressType: map['addressType'] == null ? null : pulumi.Output.create<AddressAddressType>(AddressAddressType.fromValue(map['addressType'] as String)),
      description: map['description'] == null ? null : pulumi.Output.create<String>(map['description'] as String),
      ipVersion: map['ipVersion'] == null ? null : pulumi.Output.create<AddressIpVersion>(AddressIpVersion.fromValue(map['ipVersion'] as String)),
      ipv6EndpointType: map['ipv6EndpointType'] == null ? null : pulumi.Output.create<AddressIpv6EndpointType>(AddressIpv6EndpointType.fromValue(map['ipv6EndpointType'] as String)),
      labels: map['labels'] == null ? null : pulumi.Output.create<Map<String, String>>((map['labels'] as Map).cast<String, String>()),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      network: map['network'] == null ? null : pulumi.Output.create<String>(map['network'] as String),
      networkTier: map['networkTier'] == null ? null : pulumi.Output.create<AddressNetworkTier>(AddressNetworkTier.fromValue(map['networkTier'] as String)),
      prefixLength: map['prefixLength'] == null ? null : pulumi.Output.create<int>(map['prefixLength'] as int),
      project: map['project'] == null ? null : pulumi.Output.create<String>(map['project'] as String),
      purpose: map['purpose'] == null ? null : pulumi.Output.create<AddressPurpose>(AddressPurpose.fromValue(map['purpose'] as String)),
