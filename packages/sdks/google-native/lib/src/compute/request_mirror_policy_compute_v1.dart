...
class RequestMirrorPolicyComputeV1 {
  /// The full or partial URL to the BackendService resource being mirrored to. The backend service configured for a mirroring policy must reference backends that are of the same type as the original backend service matched in the URL map. Serverless NEG backends are not currently supported as a mirrored backend service.
  final pulumi.Input<String>? backendService;

  /// Creates a new [RequestMirrorPolicyComputeV1].
  ...
  RequestMirrorPolicyComputeV1({this.backendService});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'backendService': ?backendService};
  }

  factory RequestMirrorPolicyComputeV1.fromMap(Map<String, dynamic> map) {
    return RequestMirrorPolicyComputeV1(
      backendService: (() {
