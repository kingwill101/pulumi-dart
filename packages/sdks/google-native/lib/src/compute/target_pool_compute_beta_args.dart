...
class TargetPoolComputeBetaArgs {
  ...
  const TargetPoolComputeBetaArgs({
    this.backupPool,
    this.description,
    this.failoverRatio,
    this.healthChecks,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'region': region,
      'requestId': ?requestId,
      'sessionAffinity': ?pulumi.Input.mapOptionalInputValue<TargetPoolSessionAffinityComputeBeta, String>(sessionAffinity, (value) => value.wireValue),
    };
  }
  ...
  factory TargetPoolComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return TargetPoolComputeBetaArgs(
      ...
      sessionAffinity: (() { final guardedValue = map['sessionAffinity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TargetPoolSessionAffinityComputeBeta.fromValue(guardedValue as String)); })(),
    );
  }
}
