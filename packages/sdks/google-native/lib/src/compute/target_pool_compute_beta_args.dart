...
import 'target_pool_session_affinity_compute_beta.dart';

/// {@template pulumi_compute_beta_target_pool_compute_beta_args_doc}
/// The set of arguments for TargetPool.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_target_pool_compute_beta_args_doc}
class TargetPoolComputeBetaArgs {
  ...
  final pulumi.Input<TargetPoolSessionAffinityComputeBeta>? sessionAffinity;

  /// Creates a new [TargetPoolComputeBetaArgs].
  ...
  TargetPoolComputeBetaArgs({
    ...
    pulumi.Output<TargetPoolSessionAffinityComputeBeta>? sessionAffinity,
  }) :
      ...
      sessionAffinity = pulumi.Input.asOptionalInput<TargetPoolSessionAffinityComputeBeta>(sessionAffinity);
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'region': region,
      'requestId': ?requestId,
      'sessionAffinity': ?pulumi.Input.mapOptionalInputValue<TargetPoolSessionAffinityComputeBeta, String>(sessionAffinity, (value) => value.value),
    };
  }
  ...
  factory TargetPoolComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return TargetPoolComputeBetaArgs(
      ...
      sessionAffinity: map['sessionAffinity'] == null ? null : pulumi.Output.create<TargetPoolSessionAffinityComputeBeta>(TargetPoolSessionAffinityComputeBeta.fromValue(map['sessionAffinity'] as String)),
    );
  }
}
