...
class GetRegionTargetHttpsProxyComputeBetaResult {
  ...
  /// Creates a new [GetRegionTargetHttpsProxyComputeBetaResult].
  ...
  const GetRegionTargetHttpsProxyComputeBetaResult({
  ...
  factory GetRegionTargetHttpsProxyComputeBetaResult.fromMap(Map<String, dynamic> map) {
    return GetRegionTargetHttpsProxyComputeBetaResult(
