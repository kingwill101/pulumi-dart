...
class HttpRedirectAction {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'redirectResponseCode': ?pulumi.Input.mapOptionalInputValue<HttpRedirectActionRedirectResponseCode, String>(redirectResponseCode, (value) => value.value),
  ...
  factory HttpRedirectAction.fromMap(Map<String, dynamic> map) {
    return HttpRedirectAction(
      ...
      redirectResponseCode: map['redirectResponseCode'] == null ? null : (HttpRedirectActionRedirectResponseCode.fromValue(map['redirectResponseCode'] as String)).input(),
