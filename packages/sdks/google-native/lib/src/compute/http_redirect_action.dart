...
class HttpRedirectAction {
  ...
  final HttpRedirectActionRedirectResponseCode? redirectResponseCode;
  ...
  factory HttpRedirectAction.fromMap(Map<String, dynamic> map) {
    return HttpRedirectAction(
      ...
      redirectResponseCode: map['redirectResponseCode'] == null ? null : HttpRedirectActionRedirectResponseCode.fromValue(map['redirectResponseCode'] as String),
