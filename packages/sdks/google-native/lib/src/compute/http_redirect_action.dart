...
import 'http_redirect_action_redirect_response_code.dart';
...
class HttpRedirectAction {
  ...
  final pulumi.Input<HttpRedirectActionRedirectResponseCode>? redirectResponseCode;
  /// If set to true, any accompanying query portion of the original URL is removed before redirecting the request. If set to false, the query portion of the original URL is retained. The default is set to false.
  final pulumi.Input<bool>? stripQuery;

  /// Creates a new [HttpRedirectAction].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'redirectResponseCode': ?pulumi.Input.mapOptionalInputValue<HttpRedirectActionRedirectResponseCode, String>(redirectResponseCode, (value) => value.wireValue),
      'stripQuery': ?stripQuery,
    };
  }

  factory HttpRedirectAction.fromMap(Map<String, dynamic> map) {
    return HttpRedirectAction(
      ...
      redirectResponseCode: (() { final guardedValue = map['redirectResponseCode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HttpRedirectActionRedirectResponseCode.fromValue(guardedValue as String)); })(),
