...
class VpnTunnelComputeBetaArgs {
  ...
  factory VpnTunnelComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return VpnTunnelComputeBetaArgs(
      ...
      localTrafficSelector: map['localTrafficSelector'] == null ? null : ((map['localTrafficSelector']! as List).cast<String>()).input(),
      ...
      remoteTrafficSelector: map['remoteTrafficSelector'] == null ? null : ((map['remoteTrafficSelector']! as List).cast<String>()).input(),
