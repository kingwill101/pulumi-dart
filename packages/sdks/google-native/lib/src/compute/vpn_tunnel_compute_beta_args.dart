  ...
  factory VpnTunnelComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return VpnTunnelComputeBetaArgs(
      ...
      localTrafficSelector: (() {
        final guardedValue = map['localTrafficSelector'];
        if (guardedValue == null) return null;
      ...
      peerExternalGateway: (() {
        final guardedValue = map['peerExternalGateway'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      peerExternalGatewayInterface: (() {
        final guardedValue = map['peerExternalGatewayInterface'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      peerGcpGateway: (() {
        final guardedValue = map['peerGcpGateway'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      peerIp: (() {
      ...
      remoteTrafficSelector: (() {
        final guardedValue = map['remoteTrafficSelector'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      requestId: (() {
      ...
      sharedSecretHash: (() {
        final guardedValue = map['sharedSecretHash'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      targetVpnGateway: (() {
        final guardedValue = map['targetVpnGateway'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      vpnGateway: (() {
      ...
      vpnGatewayInterface: (() {
        final guardedValue = map['vpnGatewayInterface'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
    );
