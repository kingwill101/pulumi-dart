...
class VpnTunnelComputeBetaArgs {
  ...
  VpnTunnelComputeBetaArgs({
    ...
    pulumi.Output<List<String>>? localTrafficSelector,
    ...
    pulumi.Output<List<String>>? remoteTrafficSelector,
  ...
  factory VpnTunnelComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return VpnTunnelComputeBetaArgs(
      ...
      localTrafficSelector: map['localTrafficSelector'] == null ? null : pulumi.Output.create<List<String>>((map['localTrafficSelector'] as List).cast<String>()),
      ...
      remoteTrafficSelector: map['remoteTrafficSelector'] == null ? null : pulumi.Output.create<List<String>>((map['remoteTrafficSelector'] as List).cast<String>()),
