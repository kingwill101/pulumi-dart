...
class RegionSslPolicyWarningsItemResponseComputeV1 {
  ...
  const RegionSslPolicyWarningsItemResponseComputeV1({
    required this.code,
    required this.data,
  ...
  factory RegionSslPolicyWarningsItemResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return RegionSslPolicyWarningsItemResponseComputeV1(
      ...
      data: pulumi.Input.fromValue(pulumi.Input.decodeList<RegionSslPolicyWarningsItemDataItemResponseComputeV1>(map['data']!, (value) => RegionSslPolicyWarningsItemDataItemResponseComputeV1.fromMap((value as Map).cast<String, dynamic>()))),
