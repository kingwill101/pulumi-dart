...
class ExprResponseComputeBeta {
  ...
  /// Creates a new [ExprResponseComputeBeta].
  ...
  factory ExprResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return ExprResponseComputeBeta(
