...
class InitialStateConfigResponse {
  ...
  factory InitialStateConfigResponse.fromMap(Map<String, dynamic> map) {
    return InitialStateConfigResponse(
      dbs: (pulumi.Input.decodeList<FileContentBufferResponse>(map['dbs'], (value) => FileContentBufferResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      dbxs: (pulumi.Input.decodeList<FileContentBufferResponse>(map['dbxs'], (value) => FileContentBufferResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      keks: (pulumi.Input.decodeList<FileContentBufferResponse>(map['keks'], (value) => FileContentBufferResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      pk: (FileContentBufferResponse.fromMap((map['pk'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
