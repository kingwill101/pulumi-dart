...
class NotificationEndpointGrpcSettingsComputeV1 {
  ...
  const NotificationEndpointGrpcSettingsComputeV1({
    this.authority,
    this.endpoint,
    this.payloadName,
    this.resendInterval,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'resendInterval': ?pulumi.Input.mapOptionalInputValue<DurationComputeV1, Map<String, dynamic>>(resendInterval, (value) => value.toMap()),
  ...
  factory NotificationEndpointGrpcSettingsComputeV1.fromMap(Map<String, dynamic> map) {
    return NotificationEndpointGrpcSettingsComputeV1(
      ...
      resendInterval: (() { final guardedValue = map['resendInterval']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DurationComputeV1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
