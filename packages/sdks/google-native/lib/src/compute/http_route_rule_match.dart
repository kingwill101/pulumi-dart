...
class HttpRouteRuleMatch {
  ...
  final pulumi.Input<List<HttpHeaderMatch>>? headerMatches;
  ...
  final pulumi.Input<List<HttpQueryParameterMatch>>? queryParameterMatches;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'headerMatches': ?pulumi.Input.mapOptionalInputValue<List<HttpHeaderMatch>, List<Map<String, dynamic>>>(headerMatches, (value) => pulumi.Input.encodeList<HttpHeaderMatch, Map<String, dynamic>>(value, (value) => value.toMap())),
      ...
      'queryParameterMatches': ?pulumi.Input.mapOptionalInputValue<List<HttpQueryParameterMatch>, List<Map<String, dynamic>>>(queryParameterMatches, (value) => pulumi.Input.encodeList<HttpQueryParameterMatch, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory HttpRouteRuleMatch.fromMap(Map<String, dynamic> map) {
    return HttpRouteRuleMatch(
      ...
      headerMatches: (() { final guardedValue = map['headerMatches']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<HttpHeaderMatch>(guardedValue, (value) => HttpHeaderMatch.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      queryParameterMatches: (() { final guardedValue = map['queryParameterMatches']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<HttpQueryParameterMatch>(guardedValue, (value) => HttpQueryParameterMatch.fromMap((value as Map).cast<String, dynamic>()))); })(),
