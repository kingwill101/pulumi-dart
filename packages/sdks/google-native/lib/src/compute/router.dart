...
class Router extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<RouterBgpPeerResponse>> bgpPeers;
  ...
  late final pulumi.Output<List<RouterInterfaceResponse>> interfaces;
  /// Type of resource. Always compute#router for routers.
  late final pulumi.Output<String> kind;
  /// Keys used for MD5 authentication.
  late final pulumi.Output<List<RouterMd5AuthenticationKeyResponse>> md5AuthenticationKeys;
  /// Name of the resource. Provided by the client when the resource is created. The name must be 1-63 characters long, and comply with RFC1035. Specifically, the name must be 1-63 characters long and match the regular expression `[a-z]([-a-z0-9]*[a-z0-9])?` which means the first character must be a lowercase letter, and all following characters must be a dash, lowercase letter, or digit, except the last character, which cannot be a dash.
  late final pulumi.Output<String> name;
  /// A list of NAT services created in this router.
  late final pulumi.Output<List<RouterNatResponse>> nats;
  ...
  Router(
    ...
    this.interfaces = registerOutput<List<RouterInterfaceResponse>>('interfaces');
    this.kind = registerOutput<String>('kind');
    this.md5AuthenticationKeys = registerOutput<List<RouterMd5AuthenticationKeyResponse>>('md5AuthenticationKeys');
