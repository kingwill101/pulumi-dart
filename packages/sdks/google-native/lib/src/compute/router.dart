...
class Router extends pulumi.CustomResource {
  ...
  Router(
    ...
    bgp = registerOutput<RouterBgpResponse>('bgp', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return RouterBgpResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
