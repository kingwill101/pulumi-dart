...
class FirewallDeniedItemResponse {
  ...
  /// Creates a new [FirewallDeniedItemResponse].
  ...
  FirewallDeniedItemResponse({required this.ipProtocol, required this.ports});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'ipProtocol': ipProtocol, 'ports': ports};
  }

  factory FirewallDeniedItemResponse.fromMap(Map<String, dynamic> map) {
    return FirewallDeniedItemResponse(
