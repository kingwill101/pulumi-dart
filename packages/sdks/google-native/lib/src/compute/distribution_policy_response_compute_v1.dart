...
class DistributionPolicyResponseComputeV1 {
  ...
  factory DistributionPolicyResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return DistributionPolicyResponseComputeV1(
      ...
      zones: (pulumi.Input.decodeList<DistributionPolicyZoneConfigurationResponseComputeV1>(map['zones'], (value) => DistributionPolicyZoneConfigurationResponseComputeV1.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
