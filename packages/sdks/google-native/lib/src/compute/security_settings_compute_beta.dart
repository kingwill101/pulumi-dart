...
class SecuritySettingsComputeBeta {
  ...
  const SecuritySettingsComputeBeta({
    this.authentication,
  ...
  factory SecuritySettingsComputeBeta.fromMap(Map<String, dynamic> map) {
    return SecuritySettingsComputeBeta(
      ...
      awsV4Authentication: (() { final guardedValue = map['awsV4Authentication']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AWSV4SignatureComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
