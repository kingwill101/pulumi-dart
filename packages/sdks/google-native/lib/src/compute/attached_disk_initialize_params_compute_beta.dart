...
class AttachedDiskInitializeParamsComputeBeta {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'guestOsFeatures': ?guestOsFeatures == null ? null : pulumi.Input.encodeList<GuestOsFeatureComputeBeta, Map<String, dynamic>>(guestOsFeatures!, (value) => value.toMap()),
      'labels': ?labels,
      'licenses': ?licenses,
  ...
  factory AttachedDiskInitializeParamsComputeBeta.fromMap(Map<String, dynamic> map) {
    return AttachedDiskInitializeParamsComputeBeta(
      architecture: map['architecture'] == null ? null : AttachedDiskInitializeParamsArchitectureComputeBeta.fromValue(map['architecture'] as String),
      ...
      onUpdateAction: map['onUpdateAction'] == null ? null : AttachedDiskInitializeParamsOnUpdateActionComputeBeta.fromValue(map['onUpdateAction'] as String),
