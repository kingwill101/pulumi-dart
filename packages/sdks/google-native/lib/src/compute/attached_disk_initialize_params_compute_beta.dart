...
class AttachedDiskInitializeParamsComputeBeta {
  ...
  final pulumi.Input<AttachedDiskInitializeParamsArchitectureComputeBeta>?
  architecture;
  ...
  final pulumi.Input<AttachedDiskInitializeParamsOnUpdateActionComputeBeta>?
  onUpdateAction;
    ...
    return <String, dynamic>{
      'architecture':
          ?pulumi.Input.mapOptionalInputValue<
            AttachedDiskInitializeParamsArchitectureComputeBeta,
            String
          >(architecture, (value) => value.wireValue),
      ...
      'onUpdateAction':
          ?pulumi.Input.mapOptionalInputValue<
            AttachedDiskInitializeParamsOnUpdateActionComputeBeta,
            String
          >(onUpdateAction, (value) => value.wireValue),
  ...
  factory AttachedDiskInitializeParamsComputeBeta.fromMap(
    ...
    return AttachedDiskInitializeParamsComputeBeta(
      ...
      onUpdateAction: (() {
        final guardedValue = map['onUpdateAction'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
