...
class AttachedDiskInitializeParamsComputeBeta {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'architecture': ?pulumi.Input.mapOptionalInputValue<AttachedDiskInitializeParamsArchitectureComputeBeta, String>(architecture, (value) => value.value),
      ...
      'onUpdateAction': ?pulumi.Input.mapOptionalInputValue<AttachedDiskInitializeParamsOnUpdateActionComputeBeta, String>(onUpdateAction, (value) => value.value),
  ...
  factory AttachedDiskInitializeParamsComputeBeta.fromMap(Map<String, dynamic> map) {
    return AttachedDiskInitializeParamsComputeBeta(
      architecture: map['architecture'] == null ? null : (AttachedDiskInitializeParamsArchitectureComputeBeta.fromValue(map['architecture'] as String)).input(),
      ...
      onUpdateAction: map['onUpdateAction'] == null ? null : (AttachedDiskInitializeParamsOnUpdateActionComputeBeta.fromValue(map['onUpdateAction'] as String)).input(),
