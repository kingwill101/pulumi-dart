...
class AttachedDiskInitializeParamsComputeBeta {
  ...
  final pulumi.Input<AttachedDiskInitializeParamsArchitectureComputeBeta>? architecture;
  ...
  final pulumi.Input<AttachedDiskInitializeParamsOnUpdateActionComputeBeta>? onUpdateAction;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'architecture': ?pulumi.Input.mapOptionalInputValue<AttachedDiskInitializeParamsArchitectureComputeBeta, String>(architecture, (value) => value.wireValue),
      ...
      'onUpdateAction': ?pulumi.Input.mapOptionalInputValue<AttachedDiskInitializeParamsOnUpdateActionComputeBeta, String>(onUpdateAction, (value) => value.wireValue),
  ...
  factory AttachedDiskInitializeParamsComputeBeta.fromMap(Map<String, dynamic> map) {
    return AttachedDiskInitializeParamsComputeBeta(
      architecture: (() { final guardedValue = map['architecture']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AttachedDiskInitializeParamsArchitectureComputeBeta.fromValue(guardedValue as String)); })(),
      ...
      guestOsFeatures: (() { final guardedValue = map['guestOsFeatures']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GuestOsFeatureComputeBeta>(guardedValue, (value) => GuestOsFeatureComputeBeta.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      onUpdateAction: (() { final guardedValue = map['onUpdateAction']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AttachedDiskInitializeParamsOnUpdateActionComputeBeta.fromValue(guardedValue as String)); })(),
      ...
      sourceImageEncryptionKey: (() { final guardedValue = map['sourceImageEncryptionKey']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CustomerEncryptionKeyComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      sourceSnapshotEncryptionKey: (() { final guardedValue = map['sourceSnapshotEncryptionKey']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CustomerEncryptionKeyComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
