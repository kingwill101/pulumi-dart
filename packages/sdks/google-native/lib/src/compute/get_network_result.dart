...
class GetNetworkResult {
  ...
  final List<NetworkPeeringResponse> peerings;
  ...
  final NetworkRoutingConfigResponse routingConfig;
  ...
  /// [region] URL of the region where the regional network resides. This field is not applicable to global network. You must specify this field as part of the HTTP request URL. It is not settable as a field in the request body.
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'peerings': pulumi.Input.encodeList<NetworkPeeringResponse, Map<String, dynamic>>(peerings, (value) => value.toMap()),
      'region': region,
  ...
  factory GetNetworkResult.fromMap(Map<String, dynamic> map) {
    return GetNetworkResult(
      ...
      peerings: pulumi.Input.decodeList<NetworkPeeringResponse>(map['peerings']!, (value) => NetworkPeeringResponse.fromMap((value as Map).cast<String, dynamic>())),
      region: map['region'] as String,
      routingConfig: NetworkRoutingConfigResponse.fromMap((map['routingConfig']! as Map).cast<String, dynamic>()),
