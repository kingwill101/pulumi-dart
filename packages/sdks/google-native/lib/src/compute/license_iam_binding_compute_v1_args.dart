...
/// {@template pulumi_compute_v1_license_iam_binding_compute_v1_args_doc}
/// The set of arguments for LicenseIamBinding.
/// {@endtemplate}
/// {@macro pulumi_compute_v1_license_iam_binding_compute_v1_args_doc}
class LicenseIamBindingComputeV1Args {
  ...
  /// Creates a new [LicenseIamBindingComputeV1Args].
  ...
  const LicenseIamBindingComputeV1Args({
    this.condition,
  ...
  factory LicenseIamBindingComputeV1Args.fromMap(Map<String, dynamic> map) {
    return LicenseIamBindingComputeV1Args(
