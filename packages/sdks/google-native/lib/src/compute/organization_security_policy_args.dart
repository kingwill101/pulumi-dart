...
class OrganizationSecurityPolicyArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'type': ?pulumi.Input.mapOptionalInputValue<OrganizationSecurityPolicyType, String>(type, (value) => value.wireValue),
  ...
  factory OrganizationSecurityPolicyArgs.fromMap(Map<String, dynamic> map) {
    return OrganizationSecurityPolicyArgs(
      ...
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OrganizationSecurityPolicyType.fromValue(guardedValue as String)); })(),
