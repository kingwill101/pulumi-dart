    ...
    return <String, dynamic>{
      ...
      'category':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(category, (value) => value.wireValue),
      ...
      'resources':
          ?pulumi.Input.mapOptionalInputValue<
            List<ResourceCommitmentComputeV1>,
    ...
    return RegionCommitmentComputeV1Args(
      ...
      category: (() {
        ...
        return pulumi.Input.fromValue(
          RegionCommitmentCategoryComputeV1.fromValue(guardedValue as String),
        );
      })(),
      description: (() {
      ...
      plan: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RegionCommitmentPlanComputeV1.fromValue(guardedValue as String),
        );
      })(),
      project: (() {
      ...
      reservations: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as List).cast<ReservationComputeV1Resource>(),
        );
      })(),
      resources: (() {
      ...
      type: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RegionCommitmentTypeComputeV1.fromValue(guardedValue as String),
        );
      })(),
    );
  }
