...
class SecurityPolicyAdaptiveProtectionConfigResponseComputeBeta {
  ...
  const SecurityPolicyAdaptiveProtectionConfigResponseComputeBeta({
  ...
  factory SecurityPolicyAdaptiveProtectionConfigResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyAdaptiveProtectionConfigResponseComputeBeta(
      autoDeployConfig: pulumi.Input.fromValue(SecurityPolicyAdaptiveProtectionConfigAutoDeployConfigResponseComputeBeta.fromMap((map['autoDeployConfig']! as Map).cast<String, dynamic>())),
      layer7DdosDefenseConfig: pulumi.Input.fromValue(SecurityPolicyAdaptiveProtectionConfigLayer7DdosDefenseConfigResponseComputeBeta.fromMap((map['layer7DdosDefenseConfig']! as Map).cast<String, dynamic>())),
    );
  }
}
