...
class ResourcePolicySnapshotSchedulePolicyResponse {
  ...
  factory ResourcePolicySnapshotSchedulePolicyResponse.fromMap(Map<String, dynamic> map) {
    return ResourcePolicySnapshotSchedulePolicyResponse(
      retentionPolicy: (ResourcePolicySnapshotSchedulePolicyRetentionPolicyResponse.fromMap((map['retentionPolicy'] as Map).cast<String, dynamic>())).input(),
      schedule: (ResourcePolicySnapshotSchedulePolicyScheduleResponse.fromMap((map['schedule'] as Map).cast<String, dynamic>())).input(),
      snapshotProperties: (ResourcePolicySnapshotSchedulePolicySnapshotPropertiesResponse.fromMap((map['snapshotProperties'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
