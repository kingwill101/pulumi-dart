...
import 'saved_disk_response_compute_v1.dart';
import 'source_disk_encryption_key_response_compute_v1.dart';
import 'source_instance_properties_response_compute_v1.dart';

/// Result data returned by getMachineImage.
class GetMachineImageComputeV1Result {
  ...
  final InstancePropertiesResponseComputeV1 instanceProperties;
  ...
  final CustomerEncryptionKeyResponseComputeV1 machineImageEncryptionKey;
  ...
  final List<SavedDiskResponseComputeV1> savedDisks;
  /// The URL for this machine image. The server defines this URL.
  final String selfLink;
  /// [Input Only] The customer-supplied encryption key of the disks attached to the source instance. Required if the source disk is protected by a customer-supplied encryption key.
  final List<SourceDiskEncryptionKeyResponseComputeV1> sourceDiskEncryptionKeys;
  ...
  final SourceInstancePropertiesResponseComputeV1 sourceInstanceProperties;
  ...
  /// Creates a new [GetMachineImageComputeV1Result].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'savedDisks': pulumi.Input.encodeList<SavedDiskResponseComputeV1, Map<String, dynamic>>(savedDisks, (value) => value.toMap()),
      'selfLink': selfLink,
      'sourceDiskEncryptionKeys': pulumi.Input.encodeList<SourceDiskEncryptionKeyResponseComputeV1, Map<String, dynamic>>(sourceDiskEncryptionKeys, (value) => value.toMap()),
  ...
  factory GetMachineImageComputeV1Result.fromMap(Map<String, dynamic> map) {
    return GetMachineImageComputeV1Result(
      creationTimestamp: map['creationTimestamp'] as String,
      description: map['description'] as String,
      guestFlush: map['guestFlush'] as bool,
      instanceProperties: InstancePropertiesResponseComputeV1.fromMap((map['instanceProperties']! as Map).cast<String, dynamic>()),
      kind: map['kind'] as String,
      machineImageEncryptionKey: CustomerEncryptionKeyResponseComputeV1.fromMap((map['machineImageEncryptionKey']! as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      satisfiesPzs: map['satisfiesPzs'] as bool,
      savedDisks: pulumi.Input.decodeList<SavedDiskResponseComputeV1>(map['savedDisks']!, (value) => SavedDiskResponseComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      selfLink: map['selfLink'] as String,
      sourceDiskEncryptionKeys: pulumi.Input.decodeList<SourceDiskEncryptionKeyResponseComputeV1>(map['sourceDiskEncryptionKeys']!, (value) => SourceDiskEncryptionKeyResponseComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      sourceInstance: map['sourceInstance'] as String,
      sourceInstanceProperties: SourceInstancePropertiesResponseComputeV1.fromMap((map['sourceInstanceProperties']! as Map).cast<String, dynamic>()),
