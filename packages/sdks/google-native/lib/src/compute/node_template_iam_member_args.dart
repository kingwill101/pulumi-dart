...
/// {@template pulumi_compute_alpha_node_template_iam_member_args_doc}
/// The set of arguments for NodeTemplateIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_alpha_node_template_iam_member_args_doc}
class NodeTemplateIamMemberArgs {
  ...
  /// Creates a new [NodeTemplateIamMemberArgs].
  ...
  const NodeTemplateIamMemberArgs({
    this.condition,
  ...
  factory NodeTemplateIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return NodeTemplateIamMemberArgs(
