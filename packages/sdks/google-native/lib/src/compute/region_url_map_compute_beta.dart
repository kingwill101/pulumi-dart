...
import 'region_url_map_compute_beta_args.dart';

/// Creates a UrlMap resource in the specified project using the data included in the request.
class RegionUrlMapComputeBeta extends pulumi.CustomResource {
  ...
  /// Creates a new [RegionUrlMapComputeBeta].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [RegionUrlMapComputeBeta]. {@macro pulumi_compute_beta_region_url_map_compute_beta_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  RegionUrlMapComputeBeta(
    String name, {
    RegionUrlMapComputeBetaArgs? args,
    ...
    defaultCustomErrorResponsePolicy = registerOutput<CustomErrorResponsePolicyResponseComputeBeta>('defaultCustomErrorResponsePolicy', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return CustomErrorResponsePolicyResponseComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    defaultRouteAction = registerOutput<HttpRouteActionResponseComputeBeta>('defaultRouteAction', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return HttpRouteActionResponseComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    defaultService = registerOutput<String>('defaultService');
    defaultUrlRedirect = registerOutput<HttpRedirectActionResponseComputeBeta>('defaultUrlRedirect', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return HttpRedirectActionResponseComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    description = registerOutput<String>('description');
    fingerprint = registerOutput<String>('fingerprint');
    headerAction = registerOutput<HttpHeaderActionResponseComputeBeta>('headerAction', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return HttpHeaderActionResponseComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>()); });
