...
class ResourcePolicyInstanceSchedulePolicyResponseComputeBeta {
  ...
  factory ResourcePolicyInstanceSchedulePolicyResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return ResourcePolicyInstanceSchedulePolicyResponseComputeBeta(
      ...
      vmStartSchedule: (ResourcePolicyInstanceSchedulePolicyScheduleResponseComputeBeta.fromMap((map['vmStartSchedule'] as Map).cast<String, dynamic>())).input(),
      vmStopSchedule: (ResourcePolicyInstanceSchedulePolicyScheduleResponseComputeBeta.fromMap((map['vmStopSchedule'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
