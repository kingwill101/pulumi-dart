...
class NodeGroupComputeBetaArgs {
  ...
  /// [zone] Optional.
  const NodeGroupComputeBetaArgs({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'maintenanceInterval': ?pulumi.Input.mapOptionalInputValue<NodeGroupMaintenanceIntervalComputeBeta, String>(maintenanceInterval, (value) => value.wireValue),
      'maintenancePolicy': ?pulumi.Input.mapOptionalInputValue<NodeGroupMaintenancePolicyComputeBeta, String>(maintenancePolicy, (value) => value.wireValue),
  ...
  factory NodeGroupComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return NodeGroupComputeBetaArgs(
      autoscalingPolicy: (() { final guardedValue = map['autoscalingPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NodeGroupAutoscalingPolicyComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      maintenanceInterval: (() { final guardedValue = map['maintenanceInterval']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NodeGroupMaintenanceIntervalComputeBeta.fromValue(guardedValue as String)); })(),
      maintenancePolicy: (() { final guardedValue = map['maintenancePolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NodeGroupMaintenancePolicyComputeBeta.fromValue(guardedValue as String)); })(),
      maintenanceWindow: (() { final guardedValue = map['maintenanceWindow']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NodeGroupMaintenanceWindowComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
