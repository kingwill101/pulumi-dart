...
class GuestOsFeatureComputeV1 {
  ...
  const GuestOsFeatureComputeV1({
    this.type,
  });

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'type': ?pulumi.Input.mapOptionalInputValue<GuestOsFeatureTypeComputeV1, String>(type, (value) => value.wireValue),
    };
  }

  factory GuestOsFeatureComputeV1.fromMap(Map<String, dynamic> map) {
    return GuestOsFeatureComputeV1(
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GuestOsFeatureTypeComputeV1.fromValue(guardedValue as String)); })(),
    );
  }
}
