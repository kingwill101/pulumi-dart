...
class FutureReservationStatusResponseComputeBeta {
  ...
  const FutureReservationStatusResponseComputeBeta({
  ...
  factory FutureReservationStatusResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return FutureReservationStatusResponseComputeBeta(
      amendmentStatus: pulumi.Input.fromValue(map['amendmentStatus'] as String),
      autoCreatedReservations: pulumi.Input.fromValue((map['autoCreatedReservations'] as List).cast<String>()),
      fulfilledCount: pulumi.Input.fromValue(map['fulfilledCount'] as String),
      lastKnownGoodState: pulumi.Input.fromValue(FutureReservationStatusLastKnownGoodStateResponseComputeBeta.fromMap((map['lastKnownGoodState']! as Map).cast<String, dynamic>())),
      ...
      specificSkuProperties: pulumi.Input.fromValue(FutureReservationStatusSpecificSKUPropertiesResponseComputeBeta.fromMap((map['specificSkuProperties']! as Map).cast<String, dynamic>())),
    );
  }
}
