...
class CustomerEncryptionKeyComputeV1 {
  ...
  /// Creates a new [CustomerEncryptionKeyComputeV1].
  ...
  const CustomerEncryptionKeyComputeV1({
    this.kmsKeyName,
  ...
  factory CustomerEncryptionKeyComputeV1.fromMap(Map<String, dynamic> map) {
    return CustomerEncryptionKeyComputeV1(
