...
class HTTPSHealthCheckComputeBeta {
  ...
  final pulumi.Input<HTTPSHealthCheckPortSpecificationComputeBeta>?
  portSpecification;
    ...
    return <String, dynamic>{
      ...
      'portSpecification':
          ?pulumi.Input.mapOptionalInputValue<
            HTTPSHealthCheckPortSpecificationComputeBeta,
            String
          >(portSpecification, (value) => value.wireValue),
      'proxyHeader':
          ?pulumi.Input.mapOptionalInputValue<
            HTTPSHealthCheckProxyHeaderComputeBeta,
            String
    ...
    return HTTPSHealthCheckComputeBeta(
      ...
      portSpecification: (() {
        ...
        return pulumi.Input.fromValue(
          HTTPSHealthCheckPortSpecificationComputeBeta.fromValue(
      ...
      proxyHeader: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          HTTPSHealthCheckProxyHeaderComputeBeta.fromValue(
            guardedValue as String,
          ),
        );
      })(),
