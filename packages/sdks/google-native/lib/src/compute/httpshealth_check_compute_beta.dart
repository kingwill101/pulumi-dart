...
import 'httpshealth_check_port_specification_compute_beta.dart';
import 'httpshealth_check_proxy_header_compute_beta.dart';

class HTTPSHealthCheckComputeBeta {
  ...
  final pulumi.Input<HTTPSHealthCheckPortSpecificationComputeBeta>? portSpecification;
  /// Specifies the type of proxy header to append before sending data to the backend, either NONE or PROXY_V1. The default is NONE.
  final pulumi.Input<HTTPSHealthCheckProxyHeaderComputeBeta>? proxyHeader;
  ...
  /// Creates a new [HTTPSHealthCheckComputeBeta].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'port': ?port,
      'portName': ?portName,
      'portSpecification': ?pulumi.Input.mapOptionalInputValue<HTTPSHealthCheckPortSpecificationComputeBeta, String>(portSpecification, (value) => value.wireValue),
      'proxyHeader': ?pulumi.Input.mapOptionalInputValue<HTTPSHealthCheckProxyHeaderComputeBeta, String>(proxyHeader, (value) => value.wireValue),
  ...
  factory HTTPSHealthCheckComputeBeta.fromMap(Map<String, dynamic> map) {
    return HTTPSHealthCheckComputeBeta(
      ...
      portSpecification: (() { final guardedValue = map['portSpecification']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HTTPSHealthCheckPortSpecificationComputeBeta.fromValue(guardedValue as String)); })(),
      proxyHeader: (() { final guardedValue = map['proxyHeader']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HTTPSHealthCheckProxyHeaderComputeBeta.fromValue(guardedValue as String)); })(),
