...
import 'autoscaler_status_details_response_compute_beta.dart';
import 'autoscaling_policy_response_compute_beta.dart';

/// Result data returned by getAutoscaler.
class GetAutoscalerComputeBetaResult {
  /// The configuration parameters for the autoscaling algorithm. You can define one or more signals for an autoscaler: cpuUtilization, customMetricUtilizations, and loadBalancingUtilization. If none of these are specified, the default will be to autoscale based on cpuUtilization to 0.6 or 60%.
  final AutoscalingPolicyResponseComputeBeta autoscalingPolicy;
  ...
  final List<AutoscalerStatusDetailsResponseComputeBeta> statusDetails;
  /// URL of the managed instance group that this autoscaler will scale. This field is required when creating an autoscaler.
  final String target;
  /// URL of the zone where the instance group resides (for autoscalers living in zonal scope).
  final String zone;

  /// Creates a new [GetAutoscalerComputeBetaResult].
  ...
  const GetAutoscalerComputeBetaResult({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'selfLink': selfLink,
      'status': status,
      'statusDetails': pulumi.Input.encodeList<AutoscalerStatusDetailsResponseComputeBeta, Map<String, dynamic>>(statusDetails, (value) => value.toMap()),
      'target': target,
      'zone': zone,
    };
  }

  factory GetAutoscalerComputeBetaResult.fromMap(Map<String, dynamic> map) {
    return GetAutoscalerComputeBetaResult(
      autoscalingPolicy: AutoscalingPolicyResponseComputeBeta.fromMap((map['autoscalingPolicy']! as Map).cast<String, dynamic>()),
      ...
      scalingScheduleStatus: (map['scalingScheduleStatus'] as Map).cast<String, String>(),
      selfLink: map['selfLink'] as String,
      status: map['status'] as String,
      statusDetails: pulumi.Input.decodeList<AutoscalerStatusDetailsResponseComputeBeta>(map['statusDetails']!, (value) => AutoscalerStatusDetailsResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
