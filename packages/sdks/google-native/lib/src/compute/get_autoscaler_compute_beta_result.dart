...
class GetAutoscalerComputeBetaResult {
    ...
    return <String, dynamic>{
      ...
      'statusDetails':
          pulumi.Input.encodeList<
            AutoscalerStatusDetailsResponseComputeBeta,
            Map<String, dynamic>
  ...
  factory GetAutoscalerComputeBetaResult.fromMap(Map<String, dynamic> map) {
    return GetAutoscalerComputeBetaResult(
      autoscalingPolicy: AutoscalingPolicyResponseComputeBeta.fromMap(
      ...
      scalingScheduleStatus: (map['scalingScheduleStatus'] as Map)
          .cast<String, String>(),
      selfLink: map['selfLink'] as String,
      status: map['status'] as String,
      statusDetails:
          pulumi.Input.decodeList<AutoscalerStatusDetailsResponseComputeBeta>(
            map['statusDetails']!,
            (value) => AutoscalerStatusDetailsResponseComputeBeta.fromMap(
