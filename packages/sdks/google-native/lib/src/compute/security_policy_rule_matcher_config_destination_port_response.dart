...
class SecurityPolicyRuleMatcherConfigDestinationPortResponse {
  ...
  /// Creates a new [SecurityPolicyRuleMatcherConfigDestinationPortResponse].
  ...
  const SecurityPolicyRuleMatcherConfigDestinationPortResponse({
  ...
  factory SecurityPolicyRuleMatcherConfigDestinationPortResponse.fromMap(Map<String, dynamic> map) {
