...
/// {@template pulumi_compute_v1_https_health_check_compute_v1_args_doc}
/// The set of arguments for HttpsHealthCheck.
/// {@endtemplate}
/// {@macro pulumi_compute_v1_https_health_check_compute_v1_args_doc}
class HttpsHealthCheckComputeV1Args {
  ...
  /// Creates a new [HttpsHealthCheckComputeV1Args].
  ...
  const HttpsHealthCheckComputeV1Args({
  ...
  factory HttpsHealthCheckComputeV1Args.fromMap(Map<String, dynamic> map) {
    return HttpsHealthCheckComputeV1Args(
