...
class GlobalForwardingRuleArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ipProtocol': ?pulumi.Input.mapOptionalInputValue<GlobalForwardingRuleIpProtocol, String>(ipProtocol, (value) => value.wireValue),
      'ipVersion': ?pulumi.Input.mapOptionalInputValue<GlobalForwardingRuleIpVersion, String>(ipVersion, (value) => value.wireValue),
      'isMirroringCollector': ?isMirroringCollector,
      'labels': ?labels,
      'loadBalancingScheme': ?pulumi.Input.mapOptionalInputValue<GlobalForwardingRuleLoadBalancingScheme, String>(loadBalancingScheme, (value) => value.wireValue),
      ...
      'name': ?name,
      'network': ?network,
      'networkTier': ?pulumi.Input.mapOptionalInputValue<GlobalForwardingRuleNetworkTier, String>(networkTier, (value) => value.wireValue),
      'noAutomateDnsZone': ?noAutomateDnsZone,
      'portRange': ?portRange,
      'ports': ?ports,
      'project': ?project,
      'pscConnectionStatus': ?pulumi.Input.mapOptionalInputValue<GlobalForwardingRulePscConnectionStatus, String>(pscConnectionStatus, (value) => value.wireValue),
      'requestId': ?requestId,
  ...
  factory GlobalForwardingRuleArgs.fromMap(Map<String, dynamic> map) {
    return GlobalForwardingRuleArgs(
      ...
      ipProtocol: (() { final guardedValue = map['ipProtocol']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GlobalForwardingRuleIpProtocol.fromValue(guardedValue as String)); })(),
      ipVersion: (() { final guardedValue = map['ipVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GlobalForwardingRuleIpVersion.fromValue(guardedValue as String)); })(),
      ...
      loadBalancingScheme: (() { final guardedValue = map['loadBalancingScheme']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GlobalForwardingRuleLoadBalancingScheme.fromValue(guardedValue as String)); })(),
      metadataFilters: (() { final guardedValue = map['metadataFilters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<MetadataFilter>(guardedValue, (value) => MetadataFilter.fromMap((value as Map).cast<String, dynamic>()))); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      network: (() { final guardedValue = map['network']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      networkTier: (() { final guardedValue = map['networkTier']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GlobalForwardingRuleNetworkTier.fromValue(guardedValue as String)); })(),
      ...
      pscConnectionStatus: (() { final guardedValue = map['pscConnectionStatus']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GlobalForwardingRulePscConnectionStatus.fromValue(guardedValue as String)); })(),
      requestId: (() { final guardedValue = map['requestId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      serviceDirectoryRegistrations: (() { final guardedValue = map['serviceDirectoryRegistrations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ForwardingRuleServiceDirectoryRegistration>(guardedValue, (value) => ForwardingRuleServiceDirectoryRegistration.fromMap((value as Map).cast<String, dynamic>()))); })(),
