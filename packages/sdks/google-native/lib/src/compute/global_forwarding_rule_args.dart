...
class GlobalForwardingRuleArgs {
  ...
  factory GlobalForwardingRuleArgs.fromMap(Map<String, dynamic> map) {
    return GlobalForwardingRuleArgs(
      ...
      ipProtocol: map['ipProtocol'] == null ? null : (GlobalForwardingRuleIpProtocol.fromValue(map['ipProtocol']! as String)).input(),
      ipVersion: map['ipVersion'] == null ? null : (GlobalForwardingRuleIpVersion.fromValue(map['ipVersion']! as String)).input(),
      isMirroringCollector: map['isMirroringCollector'] == null ? null : (map['isMirroringCollector']! as bool).input(),
      labels: map['labels'] == null ? null : ((map['labels']! as Map).cast<String, String>()).input(),
      loadBalancingScheme: map['loadBalancingScheme'] == null ? null : (GlobalForwardingRuleLoadBalancingScheme.fromValue(map['loadBalancingScheme']! as String)).input(),
      metadataFilters: map['metadataFilters'] == null ? null : (pulumi.Input.decodeList<MetadataFilter>(map['metadataFilters']!, (value) => MetadataFilter.fromMap((value as Map).cast<String, dynamic>()))).input(),
      name: map['name'] == null ? null : (map['name']! as String).input(),
      network: map['network'] == null ? null : (map['network']! as String).input(),
      networkTier: map['networkTier'] == null ? null : (GlobalForwardingRuleNetworkTier.fromValue(map['networkTier']! as String)).input(),
      ...
      pscConnectionStatus: map['pscConnectionStatus'] == null ? null : (GlobalForwardingRulePscConnectionStatus.fromValue(map['pscConnectionStatus']! as String)).input(),
      requestId: map['requestId'] == null ? null : (map['requestId']! as String).input(),
      serviceDirectoryRegistrations: map['serviceDirectoryRegistrations'] == null ? null : (pulumi.Input.decodeList<ForwardingRuleServiceDirectoryRegistration>(map['serviceDirectoryRegistrations']!, (value) => ForwardingRuleServiceDirectoryRegistration.fromMap((value as Map).cast<String, dynamic>()))).input(),
