    ...
    return GlobalForwardingRuleArgs(
      ...
      ipProtocol: (() {
        ...
        return pulumi.Input.fromValue(
          GlobalForwardingRuleIpProtocol.fromValue(guardedValue as String),
        );
      })(),
      ipVersion: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GlobalForwardingRuleIpVersion.fromValue(guardedValue as String),
        );
      })(),
      ...
      metadataFilters: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MetadataFilter>(
            guardedValue,
            (value) =>
                MetadataFilter.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      name: (() {
      ...
      networkTier: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GlobalForwardingRuleNetworkTier.fromValue(guardedValue as String),
        );
      })(),
      noAutomateDnsZone: (() {
