...
class AttachedDiskInitializeParamsComputeV1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'architecture': ?pulumi.Input.mapOptionalInputValue<AttachedDiskInitializeParamsArchitectureComputeV1, String>(architecture, (value) => value.value),
      ...
      'labels': ?labels,
      'licenses': ?licenses,
      'onUpdateAction': ?pulumi.Input.mapOptionalInputValue<AttachedDiskInitializeParamsOnUpdateActionComputeV1, String>(onUpdateAction, (value) => value.value),
  ...
  factory AttachedDiskInitializeParamsComputeV1.fromMap(Map<String, dynamic> map) {
    return AttachedDiskInitializeParamsComputeV1(
      architecture: map['architecture'] == null ? null : (AttachedDiskInitializeParamsArchitectureComputeV1.fromValue(map['architecture'] as String)).input(),
      ...
      onUpdateAction: map['onUpdateAction'] == null ? null : (AttachedDiskInitializeParamsOnUpdateActionComputeV1.fromValue(map['onUpdateAction'] as String)).input(),
