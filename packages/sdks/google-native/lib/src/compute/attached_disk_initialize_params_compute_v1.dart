...
class AttachedDiskInitializeParamsComputeV1 {
  ...
  final pulumi.Input<AttachedDiskInitializeParamsArchitectureComputeV1>? architecture;
  ...
  final pulumi.Input<AttachedDiskInitializeParamsOnUpdateActionComputeV1>? onUpdateAction;
  ...
  const AttachedDiskInitializeParamsComputeV1({
    this.architecture,
    this.description,
    this.diskName,
    this.diskSizeGb,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'architecture': ?pulumi.Input.mapOptionalInputValue<AttachedDiskInitializeParamsArchitectureComputeV1, String>(architecture, (value) => value.wireValue),
      ...
      'labels': ?labels,
      'licenses': ?licenses,
      'onUpdateAction': ?pulumi.Input.mapOptionalInputValue<AttachedDiskInitializeParamsOnUpdateActionComputeV1, String>(onUpdateAction, (value) => value.wireValue),
  ...
  factory AttachedDiskInitializeParamsComputeV1.fromMap(Map<String, dynamic> map) {
    return AttachedDiskInitializeParamsComputeV1(
      architecture: (() { final guardedValue = map['architecture']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AttachedDiskInitializeParamsArchitectureComputeV1.fromValue(guardedValue as String)); })(),
      ...
      onUpdateAction: (() { final guardedValue = map['onUpdateAction']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AttachedDiskInitializeParamsOnUpdateActionComputeV1.fromValue(guardedValue as String)); })(),
