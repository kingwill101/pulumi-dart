...
class AttachedDiskInitializeParamsComputeV1 {
  ...
  final pulumi.Input<AttachedDiskInitializeParamsArchitectureComputeV1>?
  architecture;
  ...
  final pulumi.Input<AttachedDiskInitializeParamsOnUpdateActionComputeV1>?
  onUpdateAction;
    ...
    return <String, dynamic>{
      'architecture':
          ?pulumi.Input.mapOptionalInputValue<
            AttachedDiskInitializeParamsArchitectureComputeV1,
            String
      ...
      'onUpdateAction':
          ?pulumi.Input.mapOptionalInputValue<
            AttachedDiskInitializeParamsOnUpdateActionComputeV1,
            String
