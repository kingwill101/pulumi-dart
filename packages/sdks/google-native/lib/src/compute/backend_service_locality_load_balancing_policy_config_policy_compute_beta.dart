...
class BackendServiceLocalityLoadBalancingPolicyConfigPolicyComputeBeta {
  ...
  const BackendServiceLocalityLoadBalancingPolicyConfigPolicyComputeBeta({
    this.name,
  });

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'name': ?pulumi.Input.mapOptionalInputValue<BackendServiceLocalityLoadBalancingPolicyConfigPolicyNameComputeBeta, String>(name, (value) => value.wireValue),
    };
  }
  ...
  factory BackendServiceLocalityLoadBalancingPolicyConfigPolicyComputeBeta.fromMap(Map<String, dynamic> map) {
    return BackendServiceLocalityLoadBalancingPolicyConfigPolicyComputeBeta(
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BackendServiceLocalityLoadBalancingPolicyConfigPolicyNameComputeBeta.fromValue(guardedValue as String)); })(),
    );
  }
}
