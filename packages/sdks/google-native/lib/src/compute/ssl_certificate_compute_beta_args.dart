...
class SslCertificateComputeBetaArgs {
  ...
  const SslCertificateComputeBetaArgs({
    this.certificate,
    this.description,
    this.managed,
    this.name,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'type': ?pulumi.Input.mapOptionalInputValue<SslCertificateTypeComputeBeta, String>(type, (value) => value.wireValue),
    };
  }
  ...
  factory SslCertificateComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return SslCertificateComputeBetaArgs(
      ...
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SslCertificateTypeComputeBeta.fromValue(guardedValue as String)); })(),
    );
  }
}
