...
class ReservationComputeV1Args {
  ...
  ReservationComputeV1Args({
    ...
    pulumi.Output<ShareSettingsComputeV1>? shareSettings,
    pulumi.Output<AllocationSpecificSKUReservationComputeV1>? specificReservation,
  ...
  factory ReservationComputeV1Args.fromMap(Map<String, dynamic> map) {
    return ReservationComputeV1Args(
      ...
      shareSettings: map['shareSettings'] == null ? null : pulumi.Output.create<ShareSettingsComputeV1>(ShareSettingsComputeV1.fromMap((map['shareSettings'] as Map).cast<String, dynamic>())),
      specificReservation: map['specificReservation'] == null ? null : pulumi.Output.create<AllocationSpecificSKUReservationComputeV1>(AllocationSpecificSKUReservationComputeV1.fromMap((map['specificReservation'] as Map).cast<String, dynamic>())),
