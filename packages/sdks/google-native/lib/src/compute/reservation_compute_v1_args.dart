...
class ReservationComputeV1Args {
  ...
  factory ReservationComputeV1Args.fromMap(Map<String, dynamic> map) {
    return ReservationComputeV1Args(
      ...
      specificReservation: (() { final guardedValue = map['specificReservation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AllocationSpecificSKUReservationComputeV1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
