...
class GetRegionSslPolicyComputeBetaResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'region': region,
      'selfLink': selfLink,
      'warnings': pulumi.Input.encodeList<RegionSslPolicyWarningsItemResponseComputeBeta, Map<String, dynamic>>(warnings, (value) => value.toMap()),
    };
  }

  factory GetRegionSslPolicyComputeBetaResult.fromMap(Map<String, dynamic> map) {
    return GetRegionSslPolicyComputeBetaResult(
      ...
      warnings: pulumi.Input.decodeList<RegionSslPolicyWarningsItemResponseComputeBeta>(map['warnings']!, (value) => RegionSslPolicyWarningsItemResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
