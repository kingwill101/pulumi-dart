...
class SecurityPolicyAdvancedOptionsConfigComputeBeta {
  ...
  >?
  jsonCustomConfig;
  final pulumi.Input<SecurityPolicyAdvancedOptionsConfigJsonParsingComputeBeta>?
  jsonParsing;
  final pulumi.Input<SecurityPolicyAdvancedOptionsConfigLogLevelComputeBeta>?
  logLevel;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'jsonParsing':
          ?pulumi.Input.mapOptionalInputValue<
            SecurityPolicyAdvancedOptionsConfigJsonParsingComputeBeta,
            String
          >(jsonParsing, (value) => value.wireValue),
      'logLevel':
          ?pulumi.Input.mapOptionalInputValue<
            SecurityPolicyAdvancedOptionsConfigLogLevelComputeBeta,
            String
