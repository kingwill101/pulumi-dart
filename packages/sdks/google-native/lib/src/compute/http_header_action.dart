...
class HttpHeaderAction {
  ...
  factory HttpHeaderAction.fromMap(Map<String, dynamic> map) {
    return HttpHeaderAction(
      requestHeadersToAdd: (() { final guardedValue = map['requestHeadersToAdd']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<HttpHeaderOption>(guardedValue, (value) => HttpHeaderOption.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      responseHeadersToAdd: (() { final guardedValue = map['responseHeadersToAdd']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<HttpHeaderOption>(guardedValue, (value) => HttpHeaderOption.fromMap((value as Map).cast<String, dynamic>()))); })(),
