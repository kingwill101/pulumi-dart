...
class BackendServiceIAPOAuth2ClientInfo {
  ...
  const BackendServiceIAPOAuth2ClientInfo({
  ...
  factory BackendServiceIAPOAuth2ClientInfo.fromMap(Map<String, dynamic> map) {
    return BackendServiceIAPOAuth2ClientInfo(
      ...
      developerEmailAddress: (() { final guardedValue = map['developerEmailAddress']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
