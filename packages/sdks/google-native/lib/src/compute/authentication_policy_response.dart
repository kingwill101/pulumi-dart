    ...
    return <String, dynamic>{
      'origins':
          pulumi.Input.mapInputValue<
            List<OriginAuthenticationMethodResponse>,
      ...
      'peers':
          pulumi.Input.mapInputValue<
            List<PeerAuthenticationMethodResponse>,
            List<Map<String, dynamic>>
          >(
            peers,
            (value) =>
  ...
  factory AuthenticationPolicyResponse.fromMap(Map<String, dynamic> map) {
    return AuthenticationPolicyResponse(
      origins: pulumi.Input.fromValue(
        pulumi.Input.decodeList<OriginAuthenticationMethodResponse>(
          map['origins']!,
      ...
      peers: pulumi.Input.fromValue(
        pulumi.Input.decodeList<PeerAuthenticationMethodResponse>(
          map['peers']!,
      ...
      principalBinding: pulumi.Input.fromValue(
        map['principalBinding'] as String,
      ),
      serverTlsContext: pulumi.Input.fromValue(
