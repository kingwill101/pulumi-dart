...
class AuthenticationPolicyResponse {
  ...
  factory AuthenticationPolicyResponse.fromMap(Map<String, dynamic> map) {
    return AuthenticationPolicyResponse(
      origins: (pulumi.Input.decodeList<OriginAuthenticationMethodResponse>(map['origins'], (value) => OriginAuthenticationMethodResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      peers: (pulumi.Input.decodeList<PeerAuthenticationMethodResponse>(map['peers'], (value) => PeerAuthenticationMethodResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      principalBinding: (map['principalBinding'] as String).input(),
      serverTlsContext: (TlsContextResponse.fromMap((map['serverTlsContext'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
