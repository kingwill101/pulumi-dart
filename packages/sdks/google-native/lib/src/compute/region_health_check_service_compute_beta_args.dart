...
class RegionHealthCheckServiceComputeBetaArgs {
  ...
  const RegionHealthCheckServiceComputeBetaArgs({
    this.description,
    this.healthChecks,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'healthStatusAggregationPolicy': ?pulumi.Input.mapOptionalInputValue<RegionHealthCheckServiceHealthStatusAggregationPolicyComputeBeta, String>(healthStatusAggregationPolicy, (value) => value.wireValue),
      'healthStatusAggregationStrategy': ?pulumi.Input.mapOptionalInputValue<RegionHealthCheckServiceHealthStatusAggregationStrategyComputeBeta, String>(healthStatusAggregationStrategy, (value) => value.wireValue),
      'name': ?name,
  ...
  factory RegionHealthCheckServiceComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return RegionHealthCheckServiceComputeBetaArgs(
      ...
      healthStatusAggregationPolicy: (() { final guardedValue = map['healthStatusAggregationPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionHealthCheckServiceHealthStatusAggregationPolicyComputeBeta.fromValue(guardedValue as String)); })(),
      healthStatusAggregationStrategy: (() { final guardedValue = map['healthStatusAggregationStrategy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionHealthCheckServiceHealthStatusAggregationStrategyComputeBeta.fromValue(guardedValue as String)); })(),
