...
/// {@template pulumi_compute_v1_node_template_iam_member_compute_v1_args_doc}
/// The set of arguments for NodeTemplateIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_v1_node_template_iam_member_compute_v1_args_doc}
class NodeTemplateIamMemberComputeV1Args {
  ...
  /// Creates a new [NodeTemplateIamMemberComputeV1Args].
  ...
  const NodeTemplateIamMemberComputeV1Args({
    this.condition,
  ...
  factory NodeTemplateIamMemberComputeV1Args.fromMap(Map<String, dynamic> map) {
    return NodeTemplateIamMemberComputeV1Args(
