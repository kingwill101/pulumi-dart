...
class AutoscalingPolicyScaleDownControl {
  ...
  const AutoscalingPolicyScaleDownControl({
  ...
  factory AutoscalingPolicyScaleDownControl.fromMap(Map<String, dynamic> map) {
    return AutoscalingPolicyScaleDownControl(
      maxScaledDownReplicas: (() { final guardedValue = map['maxScaledDownReplicas']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FixedOrPercent.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
