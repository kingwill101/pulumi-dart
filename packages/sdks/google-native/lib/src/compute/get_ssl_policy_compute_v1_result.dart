...
class GetSslPolicyComputeV1Result {
  ...
  final List<SslPolicyWarningsItemResponseComputeV1> warnings;

  /// Creates a new [GetSslPolicyComputeV1Result].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'region': region,
      'selfLink': selfLink,
      'warnings': pulumi.Input.encodeList<SslPolicyWarningsItemResponseComputeV1, Map<String, dynamic>>(warnings, (value) => value.toMap()),
    };
  }

  factory GetSslPolicyComputeV1Result.fromMap(Map<String, dynamic> map) {
    return GetSslPolicyComputeV1Result(
      ...
      warnings: pulumi.Input.decodeList<SslPolicyWarningsItemResponseComputeV1>(map['warnings'], (value) => SslPolicyWarningsItemResponseComputeV1.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
