...
class TargetTcpProxyComputeBetaArgs {
  ...
  TargetTcpProxyComputeBetaArgs({
    ...
    pulumi.Output<TargetTcpProxyProxyHeaderComputeBeta>? proxyHeader,
    ...
    pulumi.Output<String>? service,
      ...
      proxyHeader = pulumi.Input.asOptionalInput<TargetTcpProxyProxyHeaderComputeBeta>(proxyHeader),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'project': ?project,
      'proxyBind': ?proxyBind,
      'proxyHeader': ?pulumi.Input.mapOptionalInputValue<TargetTcpProxyProxyHeaderComputeBeta, String>(proxyHeader, (value) => value.value),
      'requestId': ?requestId,
      'service': ?service,
    };
  }
  ...
  factory TargetTcpProxyComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return TargetTcpProxyComputeBetaArgs(
      ...
      proxyHeader: map['proxyHeader'] == null ? null : pulumi.Output.create<TargetTcpProxyProxyHeaderComputeBeta>(TargetTcpProxyProxyHeaderComputeBeta.fromValue(map['proxyHeader'] as String)),
