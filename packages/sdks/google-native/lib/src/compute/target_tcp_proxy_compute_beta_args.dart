...
class TargetTcpProxyComputeBetaArgs {
  ...
  const TargetTcpProxyComputeBetaArgs({
    this.description,
    this.name,
    this.project,
    this.proxyBind,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'project': ?project,
      'proxyBind': ?proxyBind,
      'proxyHeader': ?pulumi.Input.mapOptionalInputValue<TargetTcpProxyProxyHeaderComputeBeta, String>(proxyHeader, (value) => value.wireValue),
      'requestId': ?requestId,
      'service': ?service,
    };
  }
  ...
  factory TargetTcpProxyComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return TargetTcpProxyComputeBetaArgs(
      ...
      proxyHeader: (() { final guardedValue = map['proxyHeader']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TargetTcpProxyProxyHeaderComputeBeta.fromValue(guardedValue as String)); })(),
