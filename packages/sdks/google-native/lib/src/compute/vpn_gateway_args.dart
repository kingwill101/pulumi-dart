...
class VpnGatewayArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'gatewayIpVersion': ?pulumi.Input.mapOptionalInputValue<VpnGatewayGatewayIpVersion, String>(gatewayIpVersion, (value) => value.wireValue),
      'labels': ?labels,
      'name': ?name,
      'network': ?network,
      'project': ?project,
      'region': region,
      'requestId': ?requestId,
      'stackType': ?pulumi.Input.mapOptionalInputValue<VpnGatewayStackType, String>(stackType, (value) => value.wireValue),
  ...
  factory VpnGatewayArgs.fromMap(Map<String, dynamic> map) {
    return VpnGatewayArgs(
      ...
      gatewayIpVersion: (() { final guardedValue = map['gatewayIpVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VpnGatewayGatewayIpVersion.fromValue(guardedValue as String)); })(),
      ...
      stackType: (() { final guardedValue = map['stackType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VpnGatewayStackType.fromValue(guardedValue as String)); })(),
      vpnInterfaces: (() { final guardedValue = map['vpnInterfaces']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<VpnGatewayVpnGatewayInterface>(guardedValue, (value) => VpnGatewayVpnGatewayInterface.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
