...
import 'external_vpn_gateway_compute_beta_args.dart';
import 'external_vpn_gateway_interface_response_compute_beta.dart';

/// Creates a ExternalVpnGateway in the specified project using the data included in the request.
class ExternalVpnGatewayComputeBeta extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<ExternalVpnGatewayInterfaceResponseComputeBeta>> interfaces;
  ...
  /// Creates a new [ExternalVpnGatewayComputeBeta].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ExternalVpnGatewayComputeBeta]. {@macro pulumi_compute_beta_external_vpn_gateway_compute_beta_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  ExternalVpnGatewayComputeBeta(
    String name, {
    ExternalVpnGatewayComputeBetaArgs? args,
    ...
    this.interfaces = registerOutput<List<ExternalVpnGatewayInterfaceResponseComputeBeta>>('interfaces');
