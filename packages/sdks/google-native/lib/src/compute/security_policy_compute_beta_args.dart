...
class SecurityPolicyComputeBetaArgs {
  ...
  const SecurityPolicyComputeBetaArgs({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'type': ?pulumi.Input.mapOptionalInputValue<SecurityPolicyTypeComputeBeta, String>(type, (value) => value.wireValue),
  ...
  factory SecurityPolicyComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyComputeBetaArgs(
      ...
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SecurityPolicyTypeComputeBeta.fromValue(guardedValue as String)); })(),
