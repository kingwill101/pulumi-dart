...
class SecurityPolicyComputeBetaArgs {
  ...
  SecurityPolicyComputeBetaArgs({
    ...
    pulumi.Output<SecurityPolicyTypeComputeBeta>? type,
  ...
  factory SecurityPolicyComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyComputeBetaArgs(
      ...
      type: map['type'] == null ? null : pulumi.Output.create<SecurityPolicyTypeComputeBeta>(SecurityPolicyTypeComputeBeta.fromValue(map['type'] as String)),
