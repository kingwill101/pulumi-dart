...
class RouterBgpPeerComputeBeta {
  ...
  final pulumi.Input<List<RouterBgpPeerAdvertisedGroupsItemComputeBeta>>?
  advertisedGroups;
  ...
  final pulumi.Input<List<RouterBgpPeerCustomLearnedIpRangeComputeBeta>>?
    ...
    return <String, dynamic>{
      'advertiseMode':
          ?pulumi.Input.mapOptionalInputValue<
            RouterBgpPeerAdvertiseModeComputeBeta,
            String
          >(advertiseMode, (value) => value.wireValue),
      'advertisedGroups':
          ?pulumi.Input.mapOptionalInputValue<
            List<RouterBgpPeerAdvertisedGroupsItemComputeBeta>,
            List<String>
          >(
            advertisedGroups,
            (value) =>
      ...
      'customLearnedIpRanges':
          ?pulumi.Input.mapOptionalInputValue<
            List<RouterBgpPeerCustomLearnedIpRangeComputeBeta>,
            List<Map<String, dynamic>>
          >(
            customLearnedIpRanges,
            (value) =>
      ...
      'enable':
          ?pulumi.Input.mapOptionalInputValue<
            RouterBgpPeerEnableComputeBeta,
            String
  ...
  factory RouterBgpPeerComputeBeta.fromMap(Map<String, dynamic> map) {
    return RouterBgpPeerComputeBeta(
      ...
      advertisedGroups: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RouterBgpPeerAdvertisedGroupsItemComputeBeta>(
            guardedValue,
      ...
      customLearnedIpRanges: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RouterBgpPeerCustomLearnedIpRangeComputeBeta>(
            guardedValue,
      ...
      enable: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RouterBgpPeerEnableComputeBeta.fromValue(guardedValue as String),
        );
      })(),
      enableIpv4: (() {
