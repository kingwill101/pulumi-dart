...
class RouterBgpPeerComputeBeta {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'advertiseMode': ?pulumi.Input.mapOptionalInputValue<RouterBgpPeerAdvertiseModeComputeBeta, String>(advertiseMode, (value) => value.value),
      'advertisedGroups': ?pulumi.Input.mapOptionalInputValue<List<RouterBgpPeerAdvertisedGroupsItemComputeBeta>, List<String>>(advertisedGroups, (value) => pulumi.Input.encodeList<RouterBgpPeerAdvertisedGroupsItemComputeBeta, String>(value, (value) => value.value)),
      ...
      'enable': ?pulumi.Input.mapOptionalInputValue<RouterBgpPeerEnableComputeBeta, String>(enable, (value) => value.value),
  ...
  factory RouterBgpPeerComputeBeta.fromMap(Map<String, dynamic> map) {
    return RouterBgpPeerComputeBeta(
      advertiseMode: map['advertiseMode'] == null ? null : (RouterBgpPeerAdvertiseModeComputeBeta.fromValue(map['advertiseMode']! as String)).input(),
      advertisedGroups: map['advertisedGroups'] == null ? null : (pulumi.Input.decodeList<RouterBgpPeerAdvertisedGroupsItemComputeBeta>(map['advertisedGroups']!, (value) => RouterBgpPeerAdvertisedGroupsItemComputeBeta.fromValue(value as String))).input(),
      ...
      bfd: map['bfd'] == null ? null : (RouterBgpPeerBfdComputeBeta.fromMap((map['bfd']! as Map).cast<String, dynamic>())).input(),
      customLearnedIpRanges: map['customLearnedIpRanges'] == null ? null : (pulumi.Input.decodeList<RouterBgpPeerCustomLearnedIpRangeComputeBeta>(map['customLearnedIpRanges']!, (value) => RouterBgpPeerCustomLearnedIpRangeComputeBeta.fromMap((value as Map).cast<String, dynamic>()))).input(),
      customLearnedRoutePriority: map['customLearnedRoutePriority'] == null ? null : (map['customLearnedRoutePriority']! as int).input(),
      enable: map['enable'] == null ? null : (RouterBgpPeerEnableComputeBeta.fromValue(map['enable']! as String)).input(),
