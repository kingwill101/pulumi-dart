...
class GetMachineImageResult {
  ...
  /// Creates a new [GetMachineImageResult].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'savedDisks': pulumi.Input.encodeList<SavedDiskResponse, Map<String, dynamic>>(savedDisks, (value) => value.toMap()),
      'selfLink': selfLink,
      'selfLinkWithId': selfLinkWithId,
      'sourceDiskEncryptionKeys': pulumi.Input.encodeList<SourceDiskEncryptionKeyResponse, Map<String, dynamic>>(sourceDiskEncryptionKeys, (value) => value.toMap()),
  ...
  factory GetMachineImageResult.fromMap(Map<String, dynamic> map) {
    return GetMachineImageResult(
      ...
      machineImageEncryptionKey: CustomerEncryptionKeyResponse.fromMap((map['machineImageEncryptionKey']! as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      satisfiesPzs: map['satisfiesPzs'] as bool,
      savedDisks: pulumi.Input.decodeList<SavedDiskResponse>(map['savedDisks']!, (value) => SavedDiskResponse.fromMap((value as Map).cast<String, dynamic>())),
      selfLink: map['selfLink'] as String,
      selfLinkWithId: map['selfLinkWithId'] as String,
      sourceDiskEncryptionKeys: pulumi.Input.decodeList<SourceDiskEncryptionKeyResponse>(map['sourceDiskEncryptionKeys']!, (value) => SourceDiskEncryptionKeyResponse.fromMap((value as Map).cast<String, dynamic>())),
      sourceInstance: map['sourceInstance'] as String,
      sourceInstanceProperties: SourceInstancePropertiesResponse.fromMap((map['sourceInstanceProperties']! as Map).cast<String, dynamic>()),
