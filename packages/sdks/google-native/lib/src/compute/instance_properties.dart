...
class InstanceProperties {
  ...
  final pulumi.Input<InstancePropertiesKeyRevocationActionType>?
  ...
  final pulumi.Input<InstancePropertiesPostKeyRevocationActionType>?
  postKeyRevocationActionType;

  /// The private IPv6 google access type for VMs. If not specified, use INHERIT_FROM_SUBNETWORK as default. Note that for MachineImage, this is not supported yet.
  final pulumi.Input<InstancePropertiesPrivateIpv6GoogleAccess>?
  ...
  factory InstanceProperties.fromMap(Map<String, dynamic> map) {
    return InstanceProperties(
      ...
      displayDevice: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DisplayDevice.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      guestAccelerators: (() {
      ...
      scheduling: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          Scheduling.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      secureTags: (() {
        final guardedValue = map['secureTags'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      serviceAccounts: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ServiceAccount>(
            guardedValue,
            (value) =>
                ServiceAccount.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      serviceIntegrationSpecs: (() {
        final guardedValue = map['serviceIntegrationSpecs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as Map).cast<String, String>(),
        );
      ...
      tags: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          Tags.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
