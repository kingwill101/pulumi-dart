...
class InstanceProperties {
  ...
  final InstancePropertiesPostKeyRevocationActionType? postKeyRevocationActionType;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'disks': ?disks == null ? null : pulumi.Input.encodeList<AttachedDisk, Map<String, dynamic>>(disks!, (value) => value.toMap()),
      ...
      'serviceAccounts': ?serviceAccounts == null ? null : pulumi.Input.encodeList<ServiceAccount, Map<String, dynamic>>(serviceAccounts!, (value) => value.toMap()),
  ...
  factory InstanceProperties.fromMap(Map<String, dynamic> map) {
    return InstanceProperties(
      ...
      keyRevocationActionType: map['keyRevocationActionType'] == null ? null : InstancePropertiesKeyRevocationActionType.fromValue(map['keyRevocationActionType'] as String),
      ...
      postKeyRevocationActionType: map['postKeyRevocationActionType'] == null ? null : InstancePropertiesPostKeyRevocationActionType.fromValue(map['postKeyRevocationActionType'] as String),
      privateIpv6GoogleAccess: map['privateIpv6GoogleAccess'] == null ? null : InstancePropertiesPrivateIpv6GoogleAccess.fromValue(map['privateIpv6GoogleAccess'] as String),
