...
class VpnGatewayComputeBetaArgs {
  ...
  const VpnGatewayComputeBetaArgs({
    this.description,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'gatewayIpVersion': ?pulumi.Input.mapOptionalInputValue<VpnGatewayGatewayIpVersionComputeBeta, String>(gatewayIpVersion, (value) => value.wireValue),
      'labels': ?labels,
      'name': ?name,
      'network': ?network,
      'project': ?project,
      'region': region,
      'requestId': ?requestId,
      'stackType': ?pulumi.Input.mapOptionalInputValue<VpnGatewayStackTypeComputeBeta, String>(stackType, (value) => value.wireValue),
  ...
  factory VpnGatewayComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return VpnGatewayComputeBetaArgs(
      ...
      gatewayIpVersion: (() { final guardedValue = map['gatewayIpVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VpnGatewayGatewayIpVersionComputeBeta.fromValue(guardedValue as String)); })(),
      ...
      stackType: (() { final guardedValue = map['stackType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VpnGatewayStackTypeComputeBeta.fromValue(guardedValue as String)); })(),
      vpnInterfaces: (() { final guardedValue = map['vpnInterfaces']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<VpnGatewayVpnGatewayInterfaceComputeBeta>(guardedValue, (value) => VpnGatewayVpnGatewayInterfaceComputeBeta.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
