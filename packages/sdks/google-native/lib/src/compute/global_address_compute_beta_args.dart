...
class GlobalAddressComputeBetaArgs {
  ...
  final pulumi.Input<GlobalAddressIpv6EndpointTypeComputeBeta>?
  ipv6EndpointType;
    ...
    return <String, dynamic>{
      ...
      'addressType':
          ?pulumi.Input.mapOptionalInputValue<
            GlobalAddressAddressTypeComputeBeta,
            String
          >(addressType, (value) => value.wireValue),
      'description': ?description,
      'ipVersion':
          ?pulumi.Input.mapOptionalInputValue<
            GlobalAddressIpVersionComputeBeta,
            String
          >(ipVersion, (value) => value.wireValue),
      'ipv6EndpointType':
          ?pulumi.Input.mapOptionalInputValue<
            GlobalAddressIpv6EndpointTypeComputeBeta,
            String
          >(ipv6EndpointType, (value) => value.wireValue),
      'labels': ?labels,
      'name': ?name,
      'network': ?network,
      'networkTier':
          ?pulumi.Input.mapOptionalInputValue<
            GlobalAddressNetworkTierComputeBeta,
            String
      ...
      'purpose':
          ?pulumi.Input.mapOptionalInputValue<
            GlobalAddressPurposeComputeBeta,
            String
          >(purpose, (value) => value.wireValue),
      'requestId': ?requestId,
    ...
    return GlobalAddressComputeBetaArgs(
      ...
      addressType: (() {
        ...
        return pulumi.Input.fromValue(
          GlobalAddressAddressTypeComputeBeta.fromValue(guardedValue as String),
        );
      })(),
      description: (() {
      ...
      ipVersion: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GlobalAddressIpVersionComputeBeta.fromValue(guardedValue as String),
        );
      })(),
      ipv6EndpointType: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GlobalAddressIpv6EndpointTypeComputeBeta.fromValue(
      ...
      networkTier: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GlobalAddressNetworkTierComputeBeta.fromValue(guardedValue as String),
        );
      })(),
      prefixLength: (() {
      ...
      purpose: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GlobalAddressPurposeComputeBeta.fromValue(guardedValue as String),
        );
      })(),
      requestId: (() {
