...
class GlobalAddressComputeBetaArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'address': ?address,
      'addressType': ?pulumi.Input.mapOptionalInputValue<GlobalAddressAddressTypeComputeBeta, String>(addressType, (value) => value.value),
      'description': ?description,
      'ipVersion': ?pulumi.Input.mapOptionalInputValue<GlobalAddressIpVersionComputeBeta, String>(ipVersion, (value) => value.value),
      'ipv6EndpointType': ?pulumi.Input.mapOptionalInputValue<GlobalAddressIpv6EndpointTypeComputeBeta, String>(ipv6EndpointType, (value) => value.value),
      'labels': ?labels,
      'name': ?name,
      'network': ?network,
      'networkTier': ?pulumi.Input.mapOptionalInputValue<GlobalAddressNetworkTierComputeBeta, String>(networkTier, (value) => value.value),
      'prefixLength': ?prefixLength,
      'project': ?project,
      'purpose': ?pulumi.Input.mapOptionalInputValue<GlobalAddressPurposeComputeBeta, String>(purpose, (value) => value.value),
      'requestId': ?requestId,
