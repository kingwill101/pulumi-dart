...
class SecurityPolicyRuleRateLimitOptionsResponseComputeBeta {
  ...
  final SecurityPolicyRuleRateLimitOptionsThresholdResponseComputeBeta banThreshold;
  ...
  final List<SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponseComputeBeta> enforceOnKeyConfigs;
  ...
  final SecurityPolicyRuleRedirectOptionsResponseComputeBeta exceedRedirectOptions;
  /// Threshold at which to begin ratelimiting.
  final SecurityPolicyRuleRateLimitOptionsThresholdResponseComputeBeta rateLimitThreshold;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'enforceOnKeyConfigs': pulumi.Input.encodeList<SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponseComputeBeta, Map<String, dynamic>>(enforceOnKeyConfigs, (value) => value.toMap()),
  ...
  factory SecurityPolicyRuleRateLimitOptionsResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRuleRateLimitOptionsResponseComputeBeta(
      ...
      banThreshold: SecurityPolicyRuleRateLimitOptionsThresholdResponseComputeBeta.fromMap((map['banThreshold'] as Map).cast<String, dynamic>()),
      conformAction: map['conformAction'] as String,
      enforceOnKey: map['enforceOnKey'] as String,
      enforceOnKeyConfigs: pulumi.Input.decodeList<SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponseComputeBeta>(map['enforceOnKeyConfigs'], (value) => SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      enforceOnKeyName: map['enforceOnKeyName'] as String,
      exceedAction: map['exceedAction'] as String,
      exceedRedirectOptions: SecurityPolicyRuleRedirectOptionsResponseComputeBeta.fromMap((map['exceedRedirectOptions'] as Map).cast<String, dynamic>()),
      rateLimitThreshold: SecurityPolicyRuleRateLimitOptionsThresholdResponseComputeBeta.fromMap((map['rateLimitThreshold'] as Map).cast<String, dynamic>()),
    );
  }
}
