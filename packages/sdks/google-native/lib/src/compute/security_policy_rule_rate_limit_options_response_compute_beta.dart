...
class SecurityPolicyRuleRateLimitOptionsResponseComputeBeta {
  ...
  factory SecurityPolicyRuleRateLimitOptionsResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRuleRateLimitOptionsResponseComputeBeta(
      ...
      banThreshold: (SecurityPolicyRuleRateLimitOptionsThresholdResponseComputeBeta.fromMap((map['banThreshold'] as Map).cast<String, dynamic>())).input(),
      conformAction: (map['conformAction'] as String).input(),
      enforceOnKey: (map['enforceOnKey'] as String).input(),
      enforceOnKeyConfigs: (pulumi.Input.decodeList<SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponseComputeBeta>(map['enforceOnKeyConfigs'], (value) => SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))).input(),
      enforceOnKeyName: (map['enforceOnKeyName'] as String).input(),
      exceedAction: (map['exceedAction'] as String).input(),
      exceedRedirectOptions: (SecurityPolicyRuleRedirectOptionsResponseComputeBeta.fromMap((map['exceedRedirectOptions'] as Map).cast<String, dynamic>())).input(),
      rateLimitThreshold: (SecurityPolicyRuleRateLimitOptionsThresholdResponseComputeBeta.fromMap((map['rateLimitThreshold'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
