...
class SecurityPolicyRuleRateLimitOptionsResponseComputeBeta {
  ...
  factory SecurityPolicyRuleRateLimitOptionsResponseComputeBeta.fromMap(
    ...
    return SecurityPolicyRuleRateLimitOptionsResponseComputeBeta(
      ...
      banThreshold: pulumi.Input.fromValue(
        SecurityPolicyRuleRateLimitOptionsThresholdResponseComputeBeta.fromMap(
      ...
      enforceOnKeyConfigs: pulumi.Input.fromValue(
        ...
        >(
          ...
          (value) =>
              SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponseComputeBeta.fromMap(
