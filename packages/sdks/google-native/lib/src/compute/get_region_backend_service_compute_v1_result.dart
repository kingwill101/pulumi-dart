...
class GetRegionBackendServiceComputeV1Result {
  ...
  /// Creates a new [GetRegionBackendServiceComputeV1Result].
  ...
  /// [usedBy] Required.
  const GetRegionBackendServiceComputeV1Result({
  ...
  factory GetRegionBackendServiceComputeV1Result.fromMap(Map<String, dynamic> map) {
