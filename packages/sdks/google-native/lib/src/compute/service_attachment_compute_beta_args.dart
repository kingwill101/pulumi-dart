...
class ServiceAttachmentComputeBetaArgs {
  ...
  ServiceAttachmentComputeBetaArgs({
    pulumi.Output<ServiceAttachmentConnectionPreferenceComputeBeta>? connectionPreference,
    pulumi.Output<List<ServiceAttachmentConsumerProjectLimitComputeBeta>>? consumerAcceptLists,
    ...
    pulumi.Output<ServiceAttachmentTunnelingConfigComputeBeta>? tunnelingConfig,
  }) :
      connectionPreference = pulumi.Input.asOptionalInput<ServiceAttachmentConnectionPreferenceComputeBeta>(connectionPreference),
      consumerAcceptLists = pulumi.Input.asOptionalInput<List<ServiceAttachmentConsumerProjectLimitComputeBeta>>(consumerAcceptLists),
      ...
      tunnelingConfig = pulumi.Input.asOptionalInput<ServiceAttachmentTunnelingConfigComputeBeta>(tunnelingConfig);

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'connectionPreference': ?pulumi.Input.mapOptionalInputValue<ServiceAttachmentConnectionPreferenceComputeBeta, String>(connectionPreference, (value) => value.value),
  ...
  factory ServiceAttachmentComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return ServiceAttachmentComputeBetaArgs(
      connectionPreference: map['connectionPreference'] == null ? null : pulumi.Output.create<ServiceAttachmentConnectionPreferenceComputeBeta>(ServiceAttachmentConnectionPreferenceComputeBeta.fromValue(map['connectionPreference'] as String)),
      consumerAcceptLists: map['consumerAcceptLists'] == null ? null : pulumi.Output.create<List<ServiceAttachmentConsumerProjectLimitComputeBeta>>(pulumi.Input.decodeList<ServiceAttachmentConsumerProjectLimitComputeBeta>(map['consumerAcceptLists'], (value) => ServiceAttachmentConsumerProjectLimitComputeBeta.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      tunnelingConfig: map['tunnelingConfig'] == null ? null : pulumi.Output.create<ServiceAttachmentTunnelingConfigComputeBeta>(ServiceAttachmentTunnelingConfigComputeBeta.fromMap((map['tunnelingConfig'] as Map).cast<String, dynamic>())),
    );
  }
}
