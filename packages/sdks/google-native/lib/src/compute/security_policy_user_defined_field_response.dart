...
class SecurityPolicyUserDefinedFieldResponse {
  ...
  /// Creates a new [SecurityPolicyUserDefinedFieldResponse].
  ...
  const SecurityPolicyUserDefinedFieldResponse({
    required this.base,
    required this.mask,
    required this.name,
  ...
  factory SecurityPolicyUserDefinedFieldResponse.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyUserDefinedFieldResponse(
