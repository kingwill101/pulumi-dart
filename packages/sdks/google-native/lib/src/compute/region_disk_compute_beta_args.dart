...
class RegionDiskComputeBetaArgs {
  ...
  RegionDiskComputeBetaArgs({
    pulumi.Output<RegionDiskArchitectureComputeBeta>? architecture,
    pulumi.Output<DiskAsyncReplicationComputeBeta>? asyncPrimaryDisk,
    pulumi.Output<String>? description,
    pulumi.Output<CustomerEncryptionKeyComputeBeta>? diskEncryptionKey,
    pulumi.Output<bool>? enableConfidentialCompute,
    pulumi.Output<bool>? eraseWindowsVssSignature,
    pulumi.Output<List<GuestOsFeatureComputeBeta>>? guestOsFeatures,
    pulumi.Output<RegionDiskInterfaceComputeBeta>? interface,
    ...
    pulumi.Output<DiskParamsComputeBeta>? params,
    ...
    pulumi.Output<CustomerEncryptionKeyComputeBeta>? sourceImageEncryptionKey,
    pulumi.Output<String>? sourceInstantSnapshot,
    pulumi.Output<String>? sourceSnapshot,
    pulumi.Output<CustomerEncryptionKeyComputeBeta>? sourceSnapshotEncryptionKey,
    pulumi.Output<String>? sourceStorageObject,
    pulumi.Output<RegionDiskStorageTypeComputeBeta>? storageType,
    pulumi.Output<String>? type,
    pulumi.Output<List<String>>? userLicenses,
  }) :
      architecture = pulumi.Input.asOptionalInput<RegionDiskArchitectureComputeBeta>(architecture),
      ...
      interface = pulumi.Input.asOptionalInput<RegionDiskInterfaceComputeBeta>(interface),
      ...
      storageType = pulumi.Input.asOptionalInput<RegionDiskStorageTypeComputeBeta>(storageType),
      type = pulumi.Input.asOptionalInput<String>(type),
      userLicenses = pulumi.Input.asOptionalInput<List<String>>(userLicenses);

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'architecture': ?pulumi.Input.mapOptionalInputValue<RegionDiskArchitectureComputeBeta, String>(architecture, (value) => value.value),
      ...
      'interface': ?pulumi.Input.mapOptionalInputValue<RegionDiskInterfaceComputeBeta, String>(interface, (value) => value.value),
      'labels': ?labels,
      ...
      'storageType': ?pulumi.Input.mapOptionalInputValue<RegionDiskStorageTypeComputeBeta, String>(storageType, (value) => value.value),
      'type': ?type,
  ...
  factory RegionDiskComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return RegionDiskComputeBetaArgs(
      architecture: map['architecture'] == null ? null : pulumi.Output.create<RegionDiskArchitectureComputeBeta>(RegionDiskArchitectureComputeBeta.fromValue(map['architecture'] as String)),
      asyncPrimaryDisk: map['asyncPrimaryDisk'] == null ? null : pulumi.Output.create<DiskAsyncReplicationComputeBeta>(DiskAsyncReplicationComputeBeta.fromMap((map['asyncPrimaryDisk'] as Map).cast<String, dynamic>())),
      description: map['description'] == null ? null : pulumi.Output.create<String>(map['description'] as String),
      diskEncryptionKey: map['diskEncryptionKey'] == null ? null : pulumi.Output.create<CustomerEncryptionKeyComputeBeta>(CustomerEncryptionKeyComputeBeta.fromMap((map['diskEncryptionKey'] as Map).cast<String, dynamic>())),
      ...
      guestOsFeatures: map['guestOsFeatures'] == null ? null : pulumi.Output.create<List<GuestOsFeatureComputeBeta>>(pulumi.Input.decodeList<GuestOsFeatureComputeBeta>(map['guestOsFeatures'], (value) => GuestOsFeatureComputeBeta.fromMap((value as Map).cast<String, dynamic>()))),
      interface: map['interface'] == null ? null : pulumi.Output.create<RegionDiskInterfaceComputeBeta>(RegionDiskInterfaceComputeBeta.fromValue(map['interface'] as String)),
      ...
      params: map['params'] == null ? null : pulumi.Output.create<DiskParamsComputeBeta>(DiskParamsComputeBeta.fromMap((map['params'] as Map).cast<String, dynamic>())),
      ...
      sourceImageEncryptionKey: map['sourceImageEncryptionKey'] == null ? null : pulumi.Output.create<CustomerEncryptionKeyComputeBeta>(CustomerEncryptionKeyComputeBeta.fromMap((map['sourceImageEncryptionKey'] as Map).cast<String, dynamic>())),
      ...
      sourceSnapshotEncryptionKey: map['sourceSnapshotEncryptionKey'] == null ? null : pulumi.Output.create<CustomerEncryptionKeyComputeBeta>(CustomerEncryptionKeyComputeBeta.fromMap((map['sourceSnapshotEncryptionKey'] as Map).cast<String, dynamic>())),
      sourceStorageObject: map['sourceStorageObject'] == null ? null : pulumi.Output.create<String>(map['sourceStorageObject'] as String),
      storageType: map['storageType'] == null ? null : pulumi.Output.create<RegionDiskStorageTypeComputeBeta>(RegionDiskStorageTypeComputeBeta.fromValue(map['storageType'] as String)),
