    ...
    return <String, dynamic>{
      ...
      'storageType':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(storageType, (value) => value.wireValue),
      'type': ?type,
    ...
    return RegionDiskComputeBetaArgs(
      architecture: (() {
        ...
        return pulumi.Input.fromValue(
          RegionDiskArchitectureComputeBeta.fromValue(guardedValue as String),
        );
      })(),
      asyncPrimaryDisk: (() {
      ...
      interface: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RegionDiskInterfaceComputeBeta.fromValue(guardedValue as String),
        );
      })(),
      labels: (() {
      ...
      storageType: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RegionDiskStorageTypeComputeBeta.fromValue(guardedValue as String),
        );
      })(),
      type: (() {
