...
class RegionDiskComputeBetaArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'architecture': ?pulumi.Input.mapOptionalInputValue<RegionDiskArchitectureComputeBeta, String>(architecture, (value) => value.wireValue),
      ...
      'interface': ?pulumi.Input.mapOptionalInputValue<RegionDiskInterfaceComputeBeta, String>(interface, (value) => value.wireValue),
      'labels': ?labels,
      ...
      'storageType': ?pulumi.Input.mapOptionalInputValue<RegionDiskStorageTypeComputeBeta, String>(storageType, (value) => value.wireValue),
      'type': ?type,
  ...
  factory RegionDiskComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return RegionDiskComputeBetaArgs(
      architecture: (() { final guardedValue = map['architecture']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionDiskArchitectureComputeBeta.fromValue(guardedValue as String)); })(),
      asyncPrimaryDisk: (() { final guardedValue = map['asyncPrimaryDisk']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DiskAsyncReplicationComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      interface: (() { final guardedValue = map['interface']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionDiskInterfaceComputeBeta.fromValue(guardedValue as String)); })(),
      ...
      params: (() { final guardedValue = map['params']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DiskParamsComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      storageType: (() { final guardedValue = map['storageType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionDiskStorageTypeComputeBeta.fromValue(guardedValue as String)); })(),
