...
class RegionDiskComputeBetaArgs {
  ...
  factory RegionDiskComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return RegionDiskComputeBetaArgs(
      architecture: map['architecture'] == null ? null : (RegionDiskArchitectureComputeBeta.fromValue(map['architecture']! as String)).input(),
      asyncPrimaryDisk: map['asyncPrimaryDisk'] == null ? null : (DiskAsyncReplicationComputeBeta.fromMap((map['asyncPrimaryDisk']! as Map).cast<String, dynamic>())).input(),
      ...
      interface: map['interface'] == null ? null : (RegionDiskInterfaceComputeBeta.fromValue(map['interface']! as String)).input(),
      ...
      params: map['params'] == null ? null : (DiskParamsComputeBeta.fromMap((map['params']! as Map).cast<String, dynamic>())).input(),
      ...
      storageType: map['storageType'] == null ? null : (RegionDiskStorageTypeComputeBeta.fromValue(map['storageType']! as String)).input(),
