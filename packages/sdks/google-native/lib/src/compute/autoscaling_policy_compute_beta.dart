...
class AutoscalingPolicyComputeBeta {
  ...
  final pulumi.Input<AutoscalingPolicyCpuUtilizationComputeBeta>?
  cpuUtilization;

  /// Configuration parameters of autoscaling based on a custom metric.
  final pulumi.Input<List<AutoscalingPolicyCustomMetricUtilizationComputeBeta>>?
  customMetricUtilizations;

  /// Configuration parameters of autoscaling based on load balancer.
  final pulumi.Input<AutoscalingPolicyLoadBalancingUtilizationComputeBeta>?
  ...
  final pulumi.Input<AutoscalingPolicyScaleDownControlComputeBeta>?
  scaleDownControl;
  final pulumi.Input<AutoscalingPolicyScaleInControlComputeBeta>?
  scaleInControl;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'customMetricUtilizations':
          ?pulumi.Input.mapOptionalInputValue<
            List<AutoscalingPolicyCustomMetricUtilizationComputeBeta>,
      ...
      'mode':
          ?pulumi.Input.mapOptionalInputValue<
            AutoscalingPolicyModeComputeBeta,
            String
  ...
  factory AutoscalingPolicyComputeBeta.fromMap(Map<String, dynamic> map) {
    return AutoscalingPolicyComputeBeta(
      ...
      mode: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AutoscalingPolicyModeComputeBeta.fromValue(guardedValue as String),
        );
      })(),
      scaleDownControl: (() {
