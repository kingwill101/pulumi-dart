...
class HttpRetryPolicyComputeV1 {
  ...
  final DurationComputeV1? perTryTimeout;
  ...
  factory HttpRetryPolicyComputeV1.fromMap(Map<String, dynamic> map) {
    return HttpRetryPolicyComputeV1(
      ...
      perTryTimeout: map['perTryTimeout'] == null ? null : DurationComputeV1.fromMap((map['perTryTimeout'] as Map).cast<String, dynamic>()),
