...
class NodeTemplateComputeV1Args {
  ...
  NodeTemplateComputeV1Args({
    pulumi.Output<List<AcceleratorConfigComputeV1>>? accelerators,
    pulumi.Output<NodeTemplateCpuOvercommitTypeComputeV1>? cpuOvercommitType,
    pulumi.Output<String>? description,
    pulumi.Output<List<LocalDiskComputeV1>>? disks,
    pulumi.Output<String>? name,
    pulumi.Output<Map<String, String>>? nodeAffinityLabels,
    pulumi.Output<String>? nodeType,
    pulumi.Output<NodeTemplateNodeTypeFlexibilityComputeV1>? nodeTypeFlexibility,
    pulumi.Output<String>? project,
    required pulumi.Output<String> region,
    pulumi.Output<String>? requestId,
    pulumi.Output<ServerBindingComputeV1>? serverBinding,
  }) :
  ...
  factory NodeTemplateComputeV1Args.fromMap(Map<String, dynamic> map) {
    return NodeTemplateComputeV1Args(
      accelerators: map['accelerators'] == null ? null : pulumi.Output.create<List<AcceleratorConfigComputeV1>>(pulumi.Input.decodeList<AcceleratorConfigComputeV1>(map['accelerators'], (value) => AcceleratorConfigComputeV1.fromMap((value as Map).cast<String, dynamic>()))),
      cpuOvercommitType: map['cpuOvercommitType'] == null ? null : pulumi.Output.create<NodeTemplateCpuOvercommitTypeComputeV1>(NodeTemplateCpuOvercommitTypeComputeV1.fromValue(map['cpuOvercommitType'] as String)),
      description: map['description'] == null ? null : pulumi.Output.create<String>(map['description'] as String),
      disks: map['disks'] == null ? null : pulumi.Output.create<List<LocalDiskComputeV1>>(pulumi.Input.decodeList<LocalDiskComputeV1>(map['disks'], (value) => LocalDiskComputeV1.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      nodeTypeFlexibility: map['nodeTypeFlexibility'] == null ? null : pulumi.Output.create<NodeTemplateNodeTypeFlexibilityComputeV1>(NodeTemplateNodeTypeFlexibilityComputeV1.fromMap((map['nodeTypeFlexibility'] as Map).cast<String, dynamic>())),
      project: map['project'] == null ? null : pulumi.Output.create<String>(map['project'] as String),
      region: pulumi.Output.create<String>(map['region'] as String),
      requestId: map['requestId'] == null ? null : pulumi.Output.create<String>(map['requestId'] as String),
      serverBinding: map['serverBinding'] == null ? null : pulumi.Output.create<ServerBindingComputeV1>(ServerBindingComputeV1.fromMap((map['serverBinding'] as Map).cast<String, dynamic>())),
    );
  }
}
