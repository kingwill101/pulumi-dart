...
class InstanceGroupManagerComputeV1Args {
  ...
  factory InstanceGroupManagerComputeV1Args.fromMap(Map<String, dynamic> map) {
    return InstanceGroupManagerComputeV1Args(
      ...
      listManagedInstancesResults: map['listManagedInstancesResults'] == null ? null : (InstanceGroupManagerListManagedInstancesResultsComputeV1.fromValue(map['listManagedInstancesResults']! as String)).input(),
