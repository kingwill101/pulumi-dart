...
class InstanceGroupManagerComputeV1Args {
  ...
  /// [zone] Optional.
  const InstanceGroupManagerComputeV1Args({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'listManagedInstancesResults': ?pulumi.Input.mapOptionalInputValue<InstanceGroupManagerListManagedInstancesResultsComputeV1, String>(listManagedInstancesResults, (value) => value.wireValue),
      'name': ?name,
  ...
  factory InstanceGroupManagerComputeV1Args.fromMap(Map<String, dynamic> map) {
    return InstanceGroupManagerComputeV1Args(
      ...
      listManagedInstancesResults: (() { final guardedValue = map['listManagedInstancesResults']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceGroupManagerListManagedInstancesResultsComputeV1.fromValue(guardedValue as String)); })(),
