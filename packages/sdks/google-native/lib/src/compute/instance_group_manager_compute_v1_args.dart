    ...
    return InstanceGroupManagerComputeV1Args(
      autoHealingPolicies: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<InstanceGroupManagerAutoHealingPolicyComputeV1>(
            guardedValue,
      ...
      listManagedInstancesResults: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          InstanceGroupManagerListManagedInstancesResultsComputeV1.fromValue(
