...
class InstanceGroupManagerComputeV1Args {
  ...
  InstanceGroupManagerComputeV1Args({
    pulumi.Output<List<InstanceGroupManagerAutoHealingPolicyComputeV1>>? autoHealingPolicies,
    pulumi.Output<String>? baseInstanceName,
    pulumi.Output<String>? description,
    pulumi.Output<DistributionPolicyComputeV1>? distributionPolicy,
    pulumi.Output<InstanceGroupManagerInstanceLifecyclePolicyComputeV1>? instanceLifecyclePolicy,
    pulumi.Output<String>? instanceTemplate,
    pulumi.Output<InstanceGroupManagerListManagedInstancesResultsComputeV1>? listManagedInstancesResults,
    pulumi.Output<String>? name,
    pulumi.Output<List<NamedPortComputeV1>>? namedPorts,
    pulumi.Output<String>? project,
    pulumi.Output<String>? requestId,
    pulumi.Output<StatefulPolicyComputeV1>? statefulPolicy,
    pulumi.Output<List<String>>? targetPools,
    pulumi.Output<int>? targetSize,
    pulumi.Output<InstanceGroupManagerUpdatePolicyComputeV1>? updatePolicy,
    pulumi.Output<List<InstanceGroupManagerVersionComputeV1>>? versions,
  ...
  factory InstanceGroupManagerComputeV1Args.fromMap(Map<String, dynamic> map) {
    return InstanceGroupManagerComputeV1Args(
      autoHealingPolicies: map['autoHealingPolicies'] == null ? null : pulumi.Output.create<List<InstanceGroupManagerAutoHealingPolicyComputeV1>>(pulumi.Input.decodeList<InstanceGroupManagerAutoHealingPolicyComputeV1>(map['autoHealingPolicies'], (value) => InstanceGroupManagerAutoHealingPolicyComputeV1.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      distributionPolicy: map['distributionPolicy'] == null ? null : pulumi.Output.create<DistributionPolicyComputeV1>(DistributionPolicyComputeV1.fromMap((map['distributionPolicy'] as Map).cast<String, dynamic>())),
      instanceLifecyclePolicy: map['instanceLifecyclePolicy'] == null ? null : pulumi.Output.create<InstanceGroupManagerInstanceLifecyclePolicyComputeV1>(InstanceGroupManagerInstanceLifecyclePolicyComputeV1.fromMap((map['instanceLifecyclePolicy'] as Map).cast<String, dynamic>())),
      instanceTemplate: map['instanceTemplate'] == null ? null : pulumi.Output.create<String>(map['instanceTemplate'] as String),
      listManagedInstancesResults: map['listManagedInstancesResults'] == null ? null : pulumi.Output.create<InstanceGroupManagerListManagedInstancesResultsComputeV1>(InstanceGroupManagerListManagedInstancesResultsComputeV1.fromValue(map['listManagedInstancesResults'] as String)),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      namedPorts: map['namedPorts'] == null ? null : pulumi.Output.create<List<NamedPortComputeV1>>(pulumi.Input.decodeList<NamedPortComputeV1>(map['namedPorts'], (value) => NamedPortComputeV1.fromMap((value as Map).cast<String, dynamic>()))),
      project: map['project'] == null ? null : pulumi.Output.create<String>(map['project'] as String),
      requestId: map['requestId'] == null ? null : pulumi.Output.create<String>(map['requestId'] as String),
      statefulPolicy: map['statefulPolicy'] == null ? null : pulumi.Output.create<StatefulPolicyComputeV1>(StatefulPolicyComputeV1.fromMap((map['statefulPolicy'] as Map).cast<String, dynamic>())),
      ...
      updatePolicy: map['updatePolicy'] == null ? null : pulumi.Output.create<InstanceGroupManagerUpdatePolicyComputeV1>(InstanceGroupManagerUpdatePolicyComputeV1.fromMap((map['updatePolicy'] as Map).cast<String, dynamic>())),
      versions: map['versions'] == null ? null : pulumi.Output.create<List<InstanceGroupManagerVersionComputeV1>>(pulumi.Input.decodeList<InstanceGroupManagerVersionComputeV1>(map['versions'], (value) => InstanceGroupManagerVersionComputeV1.fromMap((value as Map).cast<String, dynamic>()))),
