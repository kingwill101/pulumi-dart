...
class Jwt {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'jwtHeaders':
          ...
          >(
            jwtHeaders,
            (value) => pulumi.Input.encodeList<JwtHeader, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
  ...
  factory Jwt.fromMap(Map<String, dynamic> map) {
    return Jwt(
      ...
      jwksPublicKeys: (() {
        final guardedValue = map['jwksPublicKeys'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      jwtHeaders: (() {
        final guardedValue = map['jwtHeaders'];
        if (guardedValue == null) return null;
      ...
      jwtParams: (() {
        final guardedValue = map['jwtParams'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
    );
