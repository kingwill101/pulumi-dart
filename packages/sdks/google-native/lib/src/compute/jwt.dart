...
class Jwt {
  ...
  factory Jwt.fromMap(Map<String, dynamic> map) {
    return Jwt(
      ...
      jwksPublicKeys: (() { final guardedValue = map['jwksPublicKeys']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      jwtHeaders: (() { final guardedValue = map['jwtHeaders']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<JwtHeader>(guardedValue, (value) => JwtHeader.fromMap((value as Map).cast<String, dynamic>()))); })(),
      jwtParams: (() { final guardedValue = map['jwtParams']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
    );
  }
}
