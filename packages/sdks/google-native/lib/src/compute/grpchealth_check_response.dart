...
class GRPCHealthCheckResponse {
  ...
  /// Creates a new [GRPCHealthCheckResponse].
  ...
  factory GRPCHealthCheckResponse.fromMap(Map<String, dynamic> map) {
    return GRPCHealthCheckResponse(
