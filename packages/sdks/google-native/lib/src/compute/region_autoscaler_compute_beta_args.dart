...
class RegionAutoscalerComputeBetaArgs {
  ...
  const RegionAutoscalerComputeBetaArgs({
  ...
  factory RegionAutoscalerComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return RegionAutoscalerComputeBetaArgs(
      autoscalingPolicy: (() { final guardedValue = map['autoscalingPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AutoscalingPolicyComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
