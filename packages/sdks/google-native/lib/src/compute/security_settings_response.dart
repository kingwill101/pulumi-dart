...
class SecuritySettingsResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'authenticationPolicy': pulumi.Input.mapInputValue<AuthenticationPolicyResponse, Map<String, dynamic>>(authenticationPolicy, (value) => value.toMap()),
      'authorizationConfig': pulumi.Input.mapInputValue<AuthorizationConfigResponse, Map<String, dynamic>>(authorizationConfig, (value) => value.toMap()),
      'awsV4Authentication': pulumi.Input.mapInputValue<AWSV4SignatureResponse, Map<String, dynamic>>(awsV4Authentication, (value) => value.toMap()),
      'clientTlsPolicy': clientTlsPolicy,
      'clientTlsSettings': pulumi.Input.mapInputValue<ClientTlsSettingsResponse, Map<String, dynamic>>(clientTlsSettings, (value) => value.toMap()),
  ...
  factory SecuritySettingsResponse.fromMap(Map<String, dynamic> map) {
    return SecuritySettingsResponse(
      ...
      authenticationPolicy: pulumi.Input.fromValue(AuthenticationPolicyResponse.fromMap((map['authenticationPolicy']! as Map).cast<String, dynamic>())),
      authorizationConfig: pulumi.Input.fromValue(AuthorizationConfigResponse.fromMap((map['authorizationConfig']! as Map).cast<String, dynamic>())),
      awsV4Authentication: pulumi.Input.fromValue(AWSV4SignatureResponse.fromMap((map['awsV4Authentication']! as Map).cast<String, dynamic>())),
      clientTlsPolicy: pulumi.Input.fromValue(map['clientTlsPolicy'] as String),
      clientTlsSettings: pulumi.Input.fromValue(ClientTlsSettingsResponse.fromMap((map['clientTlsSettings']! as Map).cast<String, dynamic>())),
