...
class SecuritySettingsResponse {
  ...
  factory SecuritySettingsResponse.fromMap(Map<String, dynamic> map) {
    return SecuritySettingsResponse(
      ...
      authenticationPolicy: (AuthenticationPolicyResponse.fromMap((map['authenticationPolicy'] as Map).cast<String, dynamic>())).input(),
      authorizationConfig: (AuthorizationConfigResponse.fromMap((map['authorizationConfig'] as Map).cast<String, dynamic>())).input(),
      awsV4Authentication: (AWSV4SignatureResponse.fromMap((map['awsV4Authentication'] as Map).cast<String, dynamic>())).input(),
      clientTlsPolicy: (map['clientTlsPolicy'] as String).input(),
      clientTlsSettings: (ClientTlsSettingsResponse.fromMap((map['clientTlsSettings'] as Map).cast<String, dynamic>())).input(),
