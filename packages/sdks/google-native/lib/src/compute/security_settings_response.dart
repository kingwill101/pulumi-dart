...
class SecuritySettingsResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'authenticationPolicy': authenticationPolicy.toMap(),
      ...
      'clientTlsSettings': clientTlsSettings.toMap(),
  ...
  factory SecuritySettingsResponse.fromMap(Map<String, dynamic> map) {
    return SecuritySettingsResponse(
      ...
      authenticationPolicy: AuthenticationPolicyResponse.fromMap((map['authenticationPolicy'] as Map).cast<String, dynamic>()),
      authorizationConfig: AuthorizationConfigResponse.fromMap((map['authorizationConfig'] as Map).cast<String, dynamic>()),
      awsV4Authentication: AWSV4SignatureResponse.fromMap((map['awsV4Authentication'] as Map).cast<String, dynamic>()),
      clientTlsPolicy: map['clientTlsPolicy'] as String,
      clientTlsSettings: ClientTlsSettingsResponse.fromMap((map['clientTlsSettings'] as Map).cast<String, dynamic>()),
