...
class RegionNetworkEndpointGroupComputeBetaArgs {
  ...
  final pulumi.Input<RegionNetworkEndpointGroupNetworkEndpointTypeComputeBeta>?
  networkEndpointType;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'networkEndpointType':
          ?pulumi.Input.mapOptionalInputValue<
            RegionNetworkEndpointGroupNetworkEndpointTypeComputeBeta,
            String
  ...
  factory RegionNetworkEndpointGroupComputeBetaArgs.fromMap(
    ...
    return RegionNetworkEndpointGroupComputeBetaArgs(
      ...
      networkEndpointType: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RegionNetworkEndpointGroupNetworkEndpointTypeComputeBeta.fromValue(
