...
import 'region_network_endpoint_group_network_endpoint_type_compute_beta.dart';

/// {@template pulumi_compute_beta_region_network_endpoint_group_compute_beta_args_doc}
/// The set of arguments for RegionNetworkEndpointGroup.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_region_network_endpoint_group_compute_beta_args_doc}
class RegionNetworkEndpointGroupComputeBetaArgs {
  ...
  final pulumi.Input<RegionNetworkEndpointGroupNetworkEndpointTypeComputeBeta>? networkEndpointType;
  ...
  /// Creates a new [RegionNetworkEndpointGroupComputeBetaArgs].
  ...
  RegionNetworkEndpointGroupComputeBetaArgs({
    pulumi.Output<Map<String, String>>? annotations,
    pulumi.Output<NetworkEndpointGroupAppEngineComputeBeta>? appEngine,
    pulumi.Output<NetworkEndpointGroupCloudFunctionComputeBeta>? cloudFunction,
    pulumi.Output<NetworkEndpointGroupCloudRunComputeBeta>? cloudRun,
    pulumi.Output<int>? defaultPort,
    pulumi.Output<String>? description,
    pulumi.Output<NetworkEndpointGroupLbNetworkEndpointGroupComputeBeta>? loadBalancer,
    pulumi.Output<String>? name,
    pulumi.Output<String>? network,
    pulumi.Output<RegionNetworkEndpointGroupNetworkEndpointTypeComputeBeta>? networkEndpointType,
    pulumi.Output<String>? project,
    pulumi.Output<Map<String, dynamic>>? pscData,
    pulumi.Output<String>? pscTargetService,
    required pulumi.Output<String> region,
    pulumi.Output<String>? requestId,
    pulumi.Output<NetworkEndpointGroupServerlessDeploymentComputeBeta>? serverlessDeployment,
    pulumi.Output<String>? subnetwork,
      ...
      networkEndpointType = pulumi.Input.asOptionalInput<RegionNetworkEndpointGroupNetworkEndpointTypeComputeBeta>(networkEndpointType),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'network': ?network,
      'networkEndpointType': ?pulumi.Input.mapOptionalInputValue<RegionNetworkEndpointGroupNetworkEndpointTypeComputeBeta, String>(networkEndpointType, (value) => value.value),
      'project': ?project,
      'pscData': ?pscData,
  ...
  factory RegionNetworkEndpointGroupComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return RegionNetworkEndpointGroupComputeBetaArgs(
      annotations: map['annotations'] == null ? null : pulumi.Output.create<Map<String, String>>((map['annotations'] as Map).cast<String, String>()),
      appEngine: map['appEngine'] == null ? null : pulumi.Output.create<NetworkEndpointGroupAppEngineComputeBeta>(NetworkEndpointGroupAppEngineComputeBeta.fromMap((map['appEngine'] as Map).cast<String, dynamic>())),
      cloudFunction: map['cloudFunction'] == null ? null : pulumi.Output.create<NetworkEndpointGroupCloudFunctionComputeBeta>(NetworkEndpointGroupCloudFunctionComputeBeta.fromMap((map['cloudFunction'] as Map).cast<String, dynamic>())),
      cloudRun: map['cloudRun'] == null ? null : pulumi.Output.create<NetworkEndpointGroupCloudRunComputeBeta>(NetworkEndpointGroupCloudRunComputeBeta.fromMap((map['cloudRun'] as Map).cast<String, dynamic>())),
      defaultPort: map['defaultPort'] == null ? null : pulumi.Output.create<int>(map['defaultPort'] as int),
      description: map['description'] == null ? null : pulumi.Output.create<String>(map['description'] as String),
      loadBalancer: map['loadBalancer'] == null ? null : pulumi.Output.create<NetworkEndpointGroupLbNetworkEndpointGroupComputeBeta>(NetworkEndpointGroupLbNetworkEndpointGroupComputeBeta.fromMap((map['loadBalancer'] as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      network: map['network'] == null ? null : pulumi.Output.create<String>(map['network'] as String),
      networkEndpointType: map['networkEndpointType'] == null ? null : pulumi.Output.create<RegionNetworkEndpointGroupNetworkEndpointTypeComputeBeta>(RegionNetworkEndpointGroupNetworkEndpointTypeComputeBeta.fromValue(map['networkEndpointType'] as String)),
      ...
      serverlessDeployment: map['serverlessDeployment'] == null ? null : pulumi.Output.create<NetworkEndpointGroupServerlessDeploymentComputeBeta>(NetworkEndpointGroupServerlessDeploymentComputeBeta.fromMap((map['serverlessDeployment'] as Map).cast<String, dynamic>())),
