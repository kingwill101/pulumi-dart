...
class RegionNetworkEndpointGroupComputeBetaArgs {
  ...
  const RegionNetworkEndpointGroupComputeBetaArgs({
    this.annotations,
    this.appEngine,
    this.cloudFunction,
    this.cloudRun,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'network': ?network,
      'networkEndpointType': ?pulumi.Input.mapOptionalInputValue<RegionNetworkEndpointGroupNetworkEndpointTypeComputeBeta, String>(networkEndpointType, (value) => value.wireValue),
      'project': ?project,
      'pscData': ?pscData,
  ...
  factory RegionNetworkEndpointGroupComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return RegionNetworkEndpointGroupComputeBetaArgs(
      ...
      appEngine: (() { final guardedValue = map['appEngine']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkEndpointGroupAppEngineComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      cloudFunction: (() { final guardedValue = map['cloudFunction']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkEndpointGroupCloudFunctionComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      cloudRun: (() { final guardedValue = map['cloudRun']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkEndpointGroupCloudRunComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      loadBalancer: (() { final guardedValue = map['loadBalancer']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkEndpointGroupLbNetworkEndpointGroupComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      network: (() { final guardedValue = map['network']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      networkEndpointType: (() { final guardedValue = map['networkEndpointType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionNetworkEndpointGroupNetworkEndpointTypeComputeBeta.fromValue(guardedValue as String)); })(),
      ...
      serverlessDeployment: (() { final guardedValue = map['serverlessDeployment']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkEndpointGroupServerlessDeploymentComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
