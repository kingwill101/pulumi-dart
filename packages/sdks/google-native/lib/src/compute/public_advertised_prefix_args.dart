    ...
    return <String, dynamic>{
      ...
      'pdpScope':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(pdpScope, (value) => value.wireValue),
      'project': ?project,
      'requestId': ?requestId,
      'status':
          ?pulumi.Input.mapOptionalInputValue<
    ...
    return PublicAdvertisedPrefixArgs(
      ...
      pdpScope: (() {
        ...
        return pulumi.Input.fromValue(
          PublicAdvertisedPrefixPdpScope.fromValue(guardedValue as String),
        );
      })(),
      project: (() {
      ...
      status: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PublicAdvertisedPrefixStatus.fromValue(guardedValue as String),
        );
      })(),
    );
  }
