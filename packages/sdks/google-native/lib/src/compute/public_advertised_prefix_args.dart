...
class PublicAdvertisedPrefixArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'pdpScope': ?pulumi.Input.mapOptionalInputValue<PublicAdvertisedPrefixPdpScope, String>(pdpScope, (value) => value.wireValue),
      'project': ?project,
      'requestId': ?requestId,
      'status': ?pulumi.Input.mapOptionalInputValue<PublicAdvertisedPrefixStatus, String>(status, (value) => value.wireValue),
    };
  }
  ...
  factory PublicAdvertisedPrefixArgs.fromMap(Map<String, dynamic> map) {
    return PublicAdvertisedPrefixArgs(
      ...
      pdpScope: (() { final guardedValue = map['pdpScope']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PublicAdvertisedPrefixPdpScope.fromValue(guardedValue as String)); })(),
      project: (() { final guardedValue = map['project']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      requestId: (() { final guardedValue = map['requestId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PublicAdvertisedPrefixStatus.fromValue(guardedValue as String)); })(),
    );
  }
}
