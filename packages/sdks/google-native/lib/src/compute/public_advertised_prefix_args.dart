...
class PublicAdvertisedPrefixArgs {
  ...
  PublicAdvertisedPrefixArgs({
    ...
    pulumi.Output<PublicAdvertisedPrefixPdpScope>? pdpScope,
    pulumi.Output<String>? project,
    pulumi.Output<String>? requestId,
    pulumi.Output<PublicAdvertisedPrefixStatus>? status,
  }) :
      ...
      pdpScope = pulumi.Input.asOptionalInput<PublicAdvertisedPrefixPdpScope>(pdpScope),
      project = pulumi.Input.asOptionalInput<String>(project),
      requestId = pulumi.Input.asOptionalInput<String>(requestId),
      status = pulumi.Input.asOptionalInput<PublicAdvertisedPrefixStatus>(status);
  ...
  factory PublicAdvertisedPrefixArgs.fromMap(Map<String, dynamic> map) {
    return PublicAdvertisedPrefixArgs(
      ...
      pdpScope: map['pdpScope'] == null ? null : pulumi.Output.create<PublicAdvertisedPrefixPdpScope>(PublicAdvertisedPrefixPdpScope.fromValue(map['pdpScope'] as String)),
      project: map['project'] == null ? null : pulumi.Output.create<String>(map['project'] as String),
      requestId: map['requestId'] == null ? null : pulumi.Output.create<String>(map['requestId'] as String),
      status: map['status'] == null ? null : pulumi.Output.create<PublicAdvertisedPrefixStatus>(PublicAdvertisedPrefixStatus.fromValue(map['status'] as String)),
    );
  }
}
