...
class ResourcePolicySnapshotSchedulePolicy {
  ...
  final pulumi.Input<ResourcePolicySnapshotSchedulePolicyRetentionPolicy>?
  retentionPolicy;
  ...
  final pulumi.Input<ResourcePolicySnapshotSchedulePolicySnapshotProperties>?
  snapshotProperties;
  ...
  factory ResourcePolicySnapshotSchedulePolicy.fromMap(
    ...
    return ResourcePolicySnapshotSchedulePolicy(
      ...
      snapshotProperties: (() {
        final guardedValue = map['snapshotProperties'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
