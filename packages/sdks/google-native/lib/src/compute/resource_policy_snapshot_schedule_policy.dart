...
class ResourcePolicySnapshotSchedulePolicy {
  ...
  const ResourcePolicySnapshotSchedulePolicy({
  ...
  factory ResourcePolicySnapshotSchedulePolicy.fromMap(Map<String, dynamic> map) {
    return ResourcePolicySnapshotSchedulePolicy(
      retentionPolicy: (() { final guardedValue = map['retentionPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResourcePolicySnapshotSchedulePolicyRetentionPolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      schedule: (() { final guardedValue = map['schedule']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResourcePolicySnapshotSchedulePolicySchedule.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      snapshotProperties: (() { final guardedValue = map['snapshotProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResourcePolicySnapshotSchedulePolicySnapshotProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
