...
class SslPolicyComputeV1Args {
  ...
  factory SslPolicyComputeV1Args.fromMap(Map<String, dynamic> map) {
    return SslPolicyComputeV1Args(
      ...
      minTlsVersion: map['minTlsVersion'] == null ? null : (SslPolicyMinTlsVersionComputeV1.fromValue(map['minTlsVersion'] as String)).input(),
      name: map['name'] == null ? null : (map['name'] as String).input(),
      profile: map['profile'] == null ? null : (SslPolicyProfileComputeV1.fromValue(map['profile'] as String)).input(),
