...
class SslPolicyComputeV1Args {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'minTlsVersion': ?pulumi.Input.mapOptionalInputValue<SslPolicyMinTlsVersionComputeV1, String>(minTlsVersion, (value) => value.wireValue),
      'name': ?name,
      'profile': ?pulumi.Input.mapOptionalInputValue<SslPolicyProfileComputeV1, String>(profile, (value) => value.wireValue),
      'project': ?project,
      'requestId': ?requestId,
    };
  }
  ...
  factory SslPolicyComputeV1Args.fromMap(Map<String, dynamic> map) {
    return SslPolicyComputeV1Args(
      ...
      minTlsVersion: (() { final guardedValue = map['minTlsVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SslPolicyMinTlsVersionComputeV1.fromValue(guardedValue as String)); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      profile: (() { final guardedValue = map['profile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SslPolicyProfileComputeV1.fromValue(guardedValue as String)); })(),
