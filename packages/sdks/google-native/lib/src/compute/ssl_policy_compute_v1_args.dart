...
class SslPolicyComputeV1Args {
  ...
  SslPolicyComputeV1Args({
    ...
    pulumi.Output<SslPolicyMinTlsVersionComputeV1>? minTlsVersion,
    pulumi.Output<String>? name,
    pulumi.Output<SslPolicyProfileComputeV1>? profile,
  ...
  factory SslPolicyComputeV1Args.fromMap(Map<String, dynamic> map) {
    return SslPolicyComputeV1Args(
      ...
      minTlsVersion: map['minTlsVersion'] == null ? null : pulumi.Output.create<SslPolicyMinTlsVersionComputeV1>(SslPolicyMinTlsVersionComputeV1.fromValue(map['minTlsVersion'] as String)),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      profile: map['profile'] == null ? null : pulumi.Output.create<SslPolicyProfileComputeV1>(SslPolicyProfileComputeV1.fromValue(map['profile'] as String)),
