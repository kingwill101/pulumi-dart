...
class SecurityPolicyRuleRateLimitOptionsResponse {
  ...
  factory SecurityPolicyRuleRateLimitOptionsResponse.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRuleRateLimitOptionsResponse(
      ...
      banThreshold: (SecurityPolicyRuleRateLimitOptionsThresholdResponse.fromMap((map['banThreshold'] as Map).cast<String, dynamic>())).input(),
      conformAction: (map['conformAction'] as String).input(),
      enforceOnKey: (map['enforceOnKey'] as String).input(),
      enforceOnKeyConfigs: (pulumi.Input.decodeList<SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponse>(map['enforceOnKeyConfigs'], (value) => SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      enforceOnKeyName: (map['enforceOnKeyName'] as String).input(),
      exceedAction: (map['exceedAction'] as String).input(),
      exceedActionRpcStatus: (SecurityPolicyRuleRateLimitOptionsRpcStatusResponse.fromMap((map['exceedActionRpcStatus'] as Map).cast<String, dynamic>())).input(),
      exceedRedirectOptions: (SecurityPolicyRuleRedirectOptionsResponse.fromMap((map['exceedRedirectOptions'] as Map).cast<String, dynamic>())).input(),
      rateLimitThreshold: (SecurityPolicyRuleRateLimitOptionsThresholdResponse.fromMap((map['rateLimitThreshold'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
