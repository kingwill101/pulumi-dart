...
class SecurityPolicyRuleRateLimitOptionsResponse {
  ...
  final pulumi.Input<SecurityPolicyRuleRateLimitOptionsThresholdResponse> banThreshold;
  ...
  final pulumi.Input<List<SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponse>> enforceOnKeyConfigs;
  ...
  final pulumi.Input<SecurityPolicyRuleRateLimitOptionsRpcStatusResponse> exceedActionRpcStatus;
  /// Parameters defining the redirect action that is used as the exceed action. Cannot be specified if the exceed action is not redirect. This field is only supported in Global Security Policies of type CLOUD_ARMOR.
  final pulumi.Input<SecurityPolicyRuleRedirectOptionsResponse> exceedRedirectOptions;
  /// Threshold at which to begin ratelimiting.
  final pulumi.Input<SecurityPolicyRuleRateLimitOptionsThresholdResponse> rateLimitThreshold;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'banThreshold': pulumi.Input.mapInputValue<SecurityPolicyRuleRateLimitOptionsThresholdResponse, Map<String, dynamic>>(banThreshold, (value) => value.toMap()),
      'conformAction': conformAction,
      'enforceOnKey': enforceOnKey,
      'enforceOnKeyConfigs': pulumi.Input.mapInputValue<List<SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponse>, List<Map<String, dynamic>>>(enforceOnKeyConfigs, (value) => pulumi.Input.encodeList<SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'enforceOnKeyName': enforceOnKeyName,
      'exceedAction': exceedAction,
      'exceedActionRpcStatus': pulumi.Input.mapInputValue<SecurityPolicyRuleRateLimitOptionsRpcStatusResponse, Map<String, dynamic>>(exceedActionRpcStatus, (value) => value.toMap()),
      'exceedRedirectOptions': pulumi.Input.mapInputValue<SecurityPolicyRuleRedirectOptionsResponse, Map<String, dynamic>>(exceedRedirectOptions, (value) => value.toMap()),
      'rateLimitThreshold': pulumi.Input.mapInputValue<SecurityPolicyRuleRateLimitOptionsThresholdResponse, Map<String, dynamic>>(rateLimitThreshold, (value) => value.toMap()),
    };
  }

  factory SecurityPolicyRuleRateLimitOptionsResponse.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRuleRateLimitOptionsResponse(
      banDurationSec: pulumi.Input.fromValue(map['banDurationSec'] as int),
      banThreshold: pulumi.Input.fromValue(SecurityPolicyRuleRateLimitOptionsThresholdResponse.fromMap((map['banThreshold']! as Map).cast<String, dynamic>())),
      ...
      enforceOnKeyConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponse>(map['enforceOnKeyConfigs']!, (value) => SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponse.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      exceedActionRpcStatus: pulumi.Input.fromValue(SecurityPolicyRuleRateLimitOptionsRpcStatusResponse.fromMap((map['exceedActionRpcStatus']! as Map).cast<String, dynamic>())),
      exceedRedirectOptions: pulumi.Input.fromValue(SecurityPolicyRuleRedirectOptionsResponse.fromMap((map['exceedRedirectOptions']! as Map).cast<String, dynamic>())),
      rateLimitThreshold: pulumi.Input.fromValue(SecurityPolicyRuleRateLimitOptionsThresholdResponse.fromMap((map['rateLimitThreshold']! as Map).cast<String, dynamic>())),
    );
  }
}
