...
class SecurityPolicyRuleRateLimitOptionsResponse {
  ...
  final List<SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponse> enforceOnKeyConfigs;
  ...
  final SecurityPolicyRuleRateLimitOptionsRpcStatusResponse exceedActionRpcStatus;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'enforceOnKeyConfigs': pulumi.Input.encodeList<SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponse, Map<String, dynamic>>(enforceOnKeyConfigs, (value) => value.toMap()),
      'enforceOnKeyName': enforceOnKeyName,
      'exceedAction': exceedAction,
      'exceedActionRpcStatus': exceedActionRpcStatus.toMap(),
  ...
  factory SecurityPolicyRuleRateLimitOptionsResponse.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRuleRateLimitOptionsResponse(
      ...
      banThreshold: SecurityPolicyRuleRateLimitOptionsThresholdResponse.fromMap((map['banThreshold'] as Map).cast<String, dynamic>()),
      conformAction: map['conformAction'] as String,
      enforceOnKey: map['enforceOnKey'] as String,
      enforceOnKeyConfigs: pulumi.Input.decodeList<SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponse>(map['enforceOnKeyConfigs'], (value) => SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponse.fromMap((value as Map).cast<String, dynamic>())),
      enforceOnKeyName: map['enforceOnKeyName'] as String,
      exceedAction: map['exceedAction'] as String,
      exceedActionRpcStatus: SecurityPolicyRuleRateLimitOptionsRpcStatusResponse.fromMap((map['exceedActionRpcStatus'] as Map).cast<String, dynamic>()),
      exceedRedirectOptions: SecurityPolicyRuleRedirectOptionsResponse.fromMap((map['exceedRedirectOptions'] as Map).cast<String, dynamic>()),
      rateLimitThreshold: SecurityPolicyRuleRateLimitOptionsThresholdResponse.fromMap((map['rateLimitThreshold'] as Map).cast<String, dynamic>()),
    );
  }
}
