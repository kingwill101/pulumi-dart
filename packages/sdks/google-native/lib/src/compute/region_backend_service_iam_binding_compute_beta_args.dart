...
/// {@template pulumi_compute_beta_region_backend_service_iam_binding_compute_beta_args_doc}
/// The set of arguments for RegionBackendServiceIamBinding.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_region_backend_service_iam_binding_compute_beta_args_doc}
class RegionBackendServiceIamBindingComputeBetaArgs {
  ...
  /// Creates a new [RegionBackendServiceIamBindingComputeBetaArgs].
  ...
  const RegionBackendServiceIamBindingComputeBetaArgs({
    this.condition,
  ...
  factory RegionBackendServiceIamBindingComputeBetaArgs.fromMap(Map<String, dynamic> map) {
