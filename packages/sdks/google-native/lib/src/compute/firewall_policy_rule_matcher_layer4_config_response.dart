...
class FirewallPolicyRuleMatcherLayer4ConfigResponse {
  ...
  /// Creates a new [FirewallPolicyRuleMatcherLayer4ConfigResponse].
  ...
  const FirewallPolicyRuleMatcherLayer4ConfigResponse({
  ...
  factory FirewallPolicyRuleMatcherLayer4ConfigResponse.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyRuleMatcherLayer4ConfigResponse(
