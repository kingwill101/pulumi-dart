...
class NetworkRoutingConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'bgpBestPathSelectionMode': ?pulumi.Input.mapOptionalInputValue<NetworkRoutingConfigBgpBestPathSelectionMode, String>(bgpBestPathSelectionMode, (value) => value.value),
      'bgpInterRegionCost': ?pulumi.Input.mapOptionalInputValue<NetworkRoutingConfigBgpInterRegionCost, String>(bgpInterRegionCost, (value) => value.value),
      'routingMode': ?pulumi.Input.mapOptionalInputValue<NetworkRoutingConfigRoutingMode, String>(routingMode, (value) => value.value),
    };
  }
