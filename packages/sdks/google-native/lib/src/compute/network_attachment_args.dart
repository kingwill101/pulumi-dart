...
class NetworkAttachmentArgs {
  ...
  NetworkAttachmentArgs({
    pulumi.Output<NetworkAttachmentConnectionPreference>? connectionPreference,
    ...
    pulumi.Output<List<String>>? subnetworks,
      ...
      connectionPreference = pulumi.Input.asOptionalInput<NetworkAttachmentConnectionPreference>(connectionPreference),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'connectionPreference': ?pulumi.Input.mapOptionalInputValue<NetworkAttachmentConnectionPreference, String>(connectionPreference, (value) => value.value),
  ...
  factory NetworkAttachmentArgs.fromMap(Map<String, dynamic> map) {
    return NetworkAttachmentArgs(
      connectionPreference: map['connectionPreference'] == null ? null : pulumi.Output.create<NetworkAttachmentConnectionPreference>(NetworkAttachmentConnectionPreference.fromValue(map['connectionPreference'] as String)),
