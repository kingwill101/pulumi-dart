...
class GetRegionInstanceTemplateComputeV1Result {
  ...
  /// Creates a new [GetRegionInstanceTemplateComputeV1Result].
  ...
  const GetRegionInstanceTemplateComputeV1Result({
  ...
  factory GetRegionInstanceTemplateComputeV1Result.fromMap(Map<String, dynamic> map) {
    return GetRegionInstanceTemplateComputeV1Result(
