...
class RegionInstanceGroupManagerComputeBetaArgs {
  ...
  RegionInstanceGroupManagerComputeBetaArgs({
    pulumi.Output<InstanceGroupManagerAllInstancesConfigComputeBeta>? allInstancesConfig,
    pulumi.Output<List<InstanceGroupManagerAutoHealingPolicyComputeBeta>>? autoHealingPolicies,
    pulumi.Output<String>? baseInstanceName,
    pulumi.Output<String>? description,
    pulumi.Output<DistributionPolicyComputeBeta>? distributionPolicy,
    pulumi.Output<RegionInstanceGroupManagerFailoverActionComputeBeta>? failoverAction,
    pulumi.Output<InstanceGroupManagerInstanceFlexibilityPolicyComputeBeta>? instanceFlexibilityPolicy,
    pulumi.Output<InstanceGroupManagerInstanceLifecyclePolicyComputeBeta>? instanceLifecyclePolicy,
    pulumi.Output<String>? instanceTemplate,
    pulumi.Output<RegionInstanceGroupManagerListManagedInstancesResultsComputeBeta>? listManagedInstancesResults,
    pulumi.Output<String>? name,
    pulumi.Output<List<NamedPortComputeBeta>>? namedPorts,
    pulumi.Output<String>? project,
    required pulumi.Output<String> region,
    pulumi.Output<String>? requestId,
    pulumi.Output<String>? serviceAccount,
    pulumi.Output<InstanceGroupManagerStandbyPolicyComputeBeta>? standbyPolicy,
    pulumi.Output<StatefulPolicyComputeBeta>? statefulPolicy,
    ...
    pulumi.Output<InstanceGroupManagerUpdatePolicyComputeBeta>? updatePolicy,
    pulumi.Output<List<InstanceGroupManagerVersionComputeBeta>>? versions,
  }) :
      ...
      failoverAction = pulumi.Input.asOptionalInput<RegionInstanceGroupManagerFailoverActionComputeBeta>(failoverAction),
      ...
      listManagedInstancesResults = pulumi.Input.asOptionalInput<RegionInstanceGroupManagerListManagedInstancesResultsComputeBeta>(listManagedInstancesResults),
  ...
  factory RegionInstanceGroupManagerComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return RegionInstanceGroupManagerComputeBetaArgs(
      allInstancesConfig: map['allInstancesConfig'] == null ? null : pulumi.Output.create<InstanceGroupManagerAllInstancesConfigComputeBeta>(InstanceGroupManagerAllInstancesConfigComputeBeta.fromMap((map['allInstancesConfig'] as Map).cast<String, dynamic>())),
      autoHealingPolicies: map['autoHealingPolicies'] == null ? null : pulumi.Output.create<List<InstanceGroupManagerAutoHealingPolicyComputeBeta>>(pulumi.Input.decodeList<InstanceGroupManagerAutoHealingPolicyComputeBeta>(map['autoHealingPolicies'], (value) => InstanceGroupManagerAutoHealingPolicyComputeBeta.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      distributionPolicy: map['distributionPolicy'] == null ? null : pulumi.Output.create<DistributionPolicyComputeBeta>(DistributionPolicyComputeBeta.fromMap((map['distributionPolicy'] as Map).cast<String, dynamic>())),
      failoverAction: map['failoverAction'] == null ? null : pulumi.Output.create<RegionInstanceGroupManagerFailoverActionComputeBeta>(RegionInstanceGroupManagerFailoverActionComputeBeta.fromValue(map['failoverAction'] as String)),
      instanceFlexibilityPolicy: map['instanceFlexibilityPolicy'] == null ? null : pulumi.Output.create<InstanceGroupManagerInstanceFlexibilityPolicyComputeBeta>(InstanceGroupManagerInstanceFlexibilityPolicyComputeBeta.fromMap((map['instanceFlexibilityPolicy'] as Map).cast<String, dynamic>())),
      instanceLifecyclePolicy: map['instanceLifecyclePolicy'] == null ? null : pulumi.Output.create<InstanceGroupManagerInstanceLifecyclePolicyComputeBeta>(InstanceGroupManagerInstanceLifecyclePolicyComputeBeta.fromMap((map['instanceLifecyclePolicy'] as Map).cast<String, dynamic>())),
      instanceTemplate: map['instanceTemplate'] == null ? null : pulumi.Output.create<String>(map['instanceTemplate'] as String),
      listManagedInstancesResults: map['listManagedInstancesResults'] == null ? null : pulumi.Output.create<RegionInstanceGroupManagerListManagedInstancesResultsComputeBeta>(RegionInstanceGroupManagerListManagedInstancesResultsComputeBeta.fromValue(map['listManagedInstancesResults'] as String)),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      namedPorts: map['namedPorts'] == null ? null : pulumi.Output.create<List<NamedPortComputeBeta>>(pulumi.Input.decodeList<NamedPortComputeBeta>(map['namedPorts'], (value) => NamedPortComputeBeta.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      standbyPolicy: map['standbyPolicy'] == null ? null : pulumi.Output.create<InstanceGroupManagerStandbyPolicyComputeBeta>(InstanceGroupManagerStandbyPolicyComputeBeta.fromMap((map['standbyPolicy'] as Map).cast<String, dynamic>())),
      statefulPolicy: map['statefulPolicy'] == null ? null : pulumi.Output.create<StatefulPolicyComputeBeta>(StatefulPolicyComputeBeta.fromMap((map['statefulPolicy'] as Map).cast<String, dynamic>())),
      ...
      updatePolicy: map['updatePolicy'] == null ? null : pulumi.Output.create<InstanceGroupManagerUpdatePolicyComputeBeta>(InstanceGroupManagerUpdatePolicyComputeBeta.fromMap((map['updatePolicy'] as Map).cast<String, dynamic>())),
      versions: map['versions'] == null ? null : pulumi.Output.create<List<InstanceGroupManagerVersionComputeBeta>>(pulumi.Input.decodeList<InstanceGroupManagerVersionComputeBeta>(map['versions'], (value) => InstanceGroupManagerVersionComputeBeta.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
