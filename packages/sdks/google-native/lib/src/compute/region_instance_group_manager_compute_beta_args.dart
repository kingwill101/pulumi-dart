...
class RegionInstanceGroupManagerComputeBetaArgs {
  ...
  const RegionInstanceGroupManagerComputeBetaArgs({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'failoverAction': ?pulumi.Input.mapOptionalInputValue<RegionInstanceGroupManagerFailoverActionComputeBeta, String>(failoverAction, (value) => value.wireValue),
      ...
      'listManagedInstancesResults': ?pulumi.Input.mapOptionalInputValue<RegionInstanceGroupManagerListManagedInstancesResultsComputeBeta, String>(listManagedInstancesResults, (value) => value.wireValue),
      'name': ?name,
  ...
  factory RegionInstanceGroupManagerComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return RegionInstanceGroupManagerComputeBetaArgs(
      ...
      failoverAction: (() { final guardedValue = map['failoverAction']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionInstanceGroupManagerFailoverActionComputeBeta.fromValue(guardedValue as String)); })(),
      ...
      listManagedInstancesResults: (() { final guardedValue = map['listManagedInstancesResults']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionInstanceGroupManagerListManagedInstancesResultsComputeBeta.fromValue(guardedValue as String)); })(),
