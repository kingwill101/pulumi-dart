...
class HttpRedirectActionResponseComputeV1 {
  ...
  /// Creates a new [HttpRedirectActionResponseComputeV1].
  ...
  factory HttpRedirectActionResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return HttpRedirectActionResponseComputeV1(
      ...
      prefixRedirect: (map['prefixRedirect'] as String).input(),
      redirectResponseCode: (map['redirectResponseCode'] as String).input(),
