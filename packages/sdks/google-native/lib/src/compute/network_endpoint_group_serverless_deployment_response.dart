...
class NetworkEndpointGroupServerlessDeploymentResponse {
  ...
  /// Creates a new [NetworkEndpointGroupServerlessDeploymentResponse].
  ...
  const NetworkEndpointGroupServerlessDeploymentResponse({
  ...
  factory NetworkEndpointGroupServerlessDeploymentResponse.fromMap(Map<String, dynamic> map) {
    return NetworkEndpointGroupServerlessDeploymentResponse(
