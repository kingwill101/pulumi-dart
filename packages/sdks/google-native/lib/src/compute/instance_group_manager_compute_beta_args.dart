...
class InstanceGroupManagerComputeBetaArgs {
  ...
  factory InstanceGroupManagerComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return InstanceGroupManagerComputeBetaArgs(
      ...
      failoverAction: map['failoverAction'] == null ? null : (InstanceGroupManagerFailoverActionComputeBeta.fromValue(map['failoverAction']! as String)).input(),
      ...
      listManagedInstancesResults: map['listManagedInstancesResults'] == null ? null : (InstanceGroupManagerListManagedInstancesResultsComputeBeta.fromValue(map['listManagedInstancesResults']! as String)).input(),
