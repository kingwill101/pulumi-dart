...
class InstanceGroupManagerComputeBetaArgs {
  ...
  InstanceGroupManagerComputeBetaArgs({
    ...
    pulumi.Output<InstanceGroupManagerFailoverActionComputeBeta>? failoverAction,
    ...
    pulumi.Output<InstanceGroupManagerListManagedInstancesResultsComputeBeta>? listManagedInstancesResults,
  ...
  factory InstanceGroupManagerComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return InstanceGroupManagerComputeBetaArgs(
      ...
      failoverAction: map['failoverAction'] == null ? null : pulumi.Output.create<InstanceGroupManagerFailoverActionComputeBeta>(InstanceGroupManagerFailoverActionComputeBeta.fromValue(map['failoverAction'] as String)),
      ...
      listManagedInstancesResults: map['listManagedInstancesResults'] == null ? null : pulumi.Output.create<InstanceGroupManagerListManagedInstancesResultsComputeBeta>(InstanceGroupManagerListManagedInstancesResultsComputeBeta.fromValue(map['listManagedInstancesResults'] as String)),
