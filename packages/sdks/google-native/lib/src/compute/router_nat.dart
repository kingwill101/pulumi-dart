...
class RouterNat {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'endpointTypes': ?endpointTypes == null ? null : pulumi.Input.encodeList<RouterNatEndpointTypesItem, String>(endpointTypes!, (value) => value.value),
      ...
      'natIps': ?natIps,
      'rules': ?rules == null ? null : pulumi.Input.encodeList<RouterNatRule, Map<String, dynamic>>(rules!, (value) => value.toMap()),
      'sourceSubnetworkIpRangesToNat': ?sourceSubnetworkIpRangesToNat == null ? null : sourceSubnetworkIpRangesToNat!.value,
      'subnetworks': ?subnetworks == null ? null : pulumi.Input.encodeList<RouterNatSubnetworkToNat, Map<String, dynamic>>(subnetworks!, (value) => value.toMap()),
  ...
  factory RouterNat.fromMap(Map<String, dynamic> map) {
    return RouterNat(
      autoNetworkTier: map['autoNetworkTier'] == null ? null : RouterNatAutoNetworkTier.fromValue(map['autoNetworkTier'] as String),
      ...
      endpointTypes: map['endpointTypes'] == null ? null : pulumi.Input.decodeList<RouterNatEndpointTypesItem>(map['endpointTypes'], (value) => RouterNatEndpointTypesItem.fromValue(value as String)),
      icmpIdleTimeoutSec: map['icmpIdleTimeoutSec'] == null ? null : map['icmpIdleTimeoutSec'] as int,
      logConfig: map['logConfig'] == null ? null : RouterNatLogConfig.fromMap((map['logConfig'] as Map).cast<String, dynamic>()),
      ...
      natIpAllocateOption: map['natIpAllocateOption'] == null ? null : RouterNatNatIpAllocateOption.fromValue(map['natIpAllocateOption'] as String),
      natIps: map['natIps'] == null ? null : (map['natIps'] as List).cast<String>(),
      rules: map['rules'] == null ? null : pulumi.Input.decodeList<RouterNatRule>(map['rules'], (value) => RouterNatRule.fromMap((value as Map).cast<String, dynamic>())),
      sourceSubnetworkIpRangesToNat: map['sourceSubnetworkIpRangesToNat'] == null ? null : RouterNatSourceSubnetworkIpRangesToNat.fromValue(map['sourceSubnetworkIpRangesToNat'] as String),
      subnetworks: map['subnetworks'] == null ? null : pulumi.Input.decodeList<RouterNatSubnetworkToNat>(map['subnetworks'], (value) => RouterNatSubnetworkToNat.fromMap((value as Map).cast<String, dynamic>())),
      ...
      type: map['type'] == null ? null : RouterNatType.fromValue(map['type'] as String),
