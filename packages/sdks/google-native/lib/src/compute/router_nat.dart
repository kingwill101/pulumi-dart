...
class RouterNat {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'autoNetworkTier': ?pulumi.Input.mapOptionalInputValue<RouterNatAutoNetworkTier, String>(autoNetworkTier, (value) => value.wireValue),
      ...
      'endpointTypes': ?pulumi.Input.mapOptionalInputValue<List<RouterNatEndpointTypesItem>, List<String>>(endpointTypes, (value) => pulumi.Input.encodeList<RouterNatEndpointTypesItem, String>(value, (value) => value.wireValue)),
      ...
      'name': ?name,
      'natIpAllocateOption': ?pulumi.Input.mapOptionalInputValue<RouterNatNatIpAllocateOption, String>(natIpAllocateOption, (value) => value.wireValue),
      'natIps': ?natIps,
      ...
      'sourceSubnetworkIpRangesToNat': ?pulumi.Input.mapOptionalInputValue<RouterNatSourceSubnetworkIpRangesToNat, String>(sourceSubnetworkIpRangesToNat, (value) => value.wireValue),
      ...
      'type': ?pulumi.Input.mapOptionalInputValue<RouterNatType, String>(type, (value) => value.wireValue),
  ...
  factory RouterNat.fromMap(Map<String, dynamic> map) {
    return RouterNat(
      autoNetworkTier: (() { final guardedValue = map['autoNetworkTier']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RouterNatAutoNetworkTier.fromValue(guardedValue as String)); })(),
      ...
      endpointTypes: (() { final guardedValue = map['endpointTypes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RouterNatEndpointTypesItem>(guardedValue, (value) => RouterNatEndpointTypesItem.fromValue(value as String))); })(),
      ...
      natIpAllocateOption: (() { final guardedValue = map['natIpAllocateOption']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RouterNatNatIpAllocateOption.fromValue(guardedValue as String)); })(),
      ...
      sourceSubnetworkIpRangesToNat: (() { final guardedValue = map['sourceSubnetworkIpRangesToNat']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RouterNatSourceSubnetworkIpRangesToNat.fromValue(guardedValue as String)); })(),
      subnetworks: (() { final guardedValue = map['subnetworks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RouterNatSubnetworkToNat>(guardedValue, (value) => RouterNatSubnetworkToNat.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RouterNatType.fromValue(guardedValue as String)); })(),
