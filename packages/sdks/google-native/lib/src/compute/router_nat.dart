...
class RouterNat {
  ...
  final pulumi.Input<RouterNatSourceSubnetworkIpRangesToNat>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'autoNetworkTier':
          ?pulumi.Input.mapOptionalInputValue<RouterNatAutoNetworkTier, String>(
            autoNetworkTier,
      ...
      'endpointTypes':
          ?pulumi.Input.mapOptionalInputValue<
            List<RouterNatEndpointTypesItem>,
            List<String>
          >(
            endpointTypes,
            (value) =>
      ...
      'type': ?pulumi.Input.mapOptionalInputValue<RouterNatType, String>(
        type,
        (value) => value.wireValue,
      ),
    ...
    return RouterNat(
      autoNetworkTier: (() {
        ...
        return pulumi.Input.fromValue(
          RouterNatAutoNetworkTier.fromValue(guardedValue as String),
        );
      })(),
      drainNatIps: (() {
      ...
      natIpAllocateOption: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RouterNatNatIpAllocateOption.fromValue(guardedValue as String),
        );
      })(),
      natIps: (() {
      ...
      type: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RouterNatType.fromValue(guardedValue as String),
        );
      })(),
      udpIdleTimeoutSec: (() {
