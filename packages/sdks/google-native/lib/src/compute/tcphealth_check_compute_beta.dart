...
import 'tcphealth_check_port_specification_compute_beta.dart';
import 'tcphealth_check_proxy_header_compute_beta.dart';

class TCPHealthCheckComputeBeta {
  ...
  final pulumi.Input<TCPHealthCheckPortSpecificationComputeBeta>? portSpecification;
  /// Specifies the type of proxy header to append before sending data to the backend, either NONE or PROXY_V1. The default is NONE.
  final pulumi.Input<TCPHealthCheckProxyHeaderComputeBeta>? proxyHeader;
  ...
  /// Creates a new [TCPHealthCheckComputeBeta].
  ...
  const TCPHealthCheckComputeBeta({
    this.port,
    this.portName,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'port': ?port,
      'portName': ?portName,
      'portSpecification': ?pulumi.Input.mapOptionalInputValue<TCPHealthCheckPortSpecificationComputeBeta, String>(portSpecification, (value) => value.wireValue),
      'proxyHeader': ?pulumi.Input.mapOptionalInputValue<TCPHealthCheckProxyHeaderComputeBeta, String>(proxyHeader, (value) => value.wireValue),
      'request': ?request,
      'response': ?response,
    };
  }
  ...
  factory TCPHealthCheckComputeBeta.fromMap(Map<String, dynamic> map) {
    return TCPHealthCheckComputeBeta(
      ...
      portSpecification: (() { final guardedValue = map['portSpecification']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TCPHealthCheckPortSpecificationComputeBeta.fromValue(guardedValue as String)); })(),
      proxyHeader: (() { final guardedValue = map['proxyHeader']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TCPHealthCheckProxyHeaderComputeBeta.fromValue(guardedValue as String)); })(),
