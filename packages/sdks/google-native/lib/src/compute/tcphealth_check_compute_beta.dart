...
class TCPHealthCheckComputeBeta {
  ...
  final pulumi.Input<TCPHealthCheckPortSpecificationComputeBeta>?
  portSpecification;
    ...
    return <String, dynamic>{
      ...
      'portSpecification':
          ?pulumi.Input.mapOptionalInputValue<
            TCPHealthCheckPortSpecificationComputeBeta,
            String
          >(portSpecification, (value) => value.wireValue),
      'proxyHeader':
          ?pulumi.Input.mapOptionalInputValue<
            TCPHealthCheckProxyHeaderComputeBeta,
            String
    ...
    return TCPHealthCheckComputeBeta(
      ...
      portSpecification: (() {
        ...
        return pulumi.Input.fromValue(
          TCPHealthCheckPortSpecificationComputeBeta.fromValue(
      ...
      proxyHeader: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TCPHealthCheckProxyHeaderComputeBeta.fromValue(
            guardedValue as String,
          ),
        );
      })(),
