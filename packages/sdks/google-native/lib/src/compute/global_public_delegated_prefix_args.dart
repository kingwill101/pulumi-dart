...
class GlobalPublicDelegatedPrefixArgs {
  ...
  const GlobalPublicDelegatedPrefixArgs({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'mode': ?pulumi.Input.mapOptionalInputValue<GlobalPublicDelegatedPrefixMode, String>(mode, (value) => value.wireValue),
      'name': ?name,
  ...
  factory GlobalPublicDelegatedPrefixArgs.fromMap(Map<String, dynamic> map) {
    return GlobalPublicDelegatedPrefixArgs(
      ...
      mode: (() { final guardedValue = map['mode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GlobalPublicDelegatedPrefixMode.fromValue(guardedValue as String)); })(),
