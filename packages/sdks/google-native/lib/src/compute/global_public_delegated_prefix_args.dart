...
class GlobalPublicDelegatedPrefixArgs {
  ...
  GlobalPublicDelegatedPrefixArgs({
    ...
    pulumi.Output<GlobalPublicDelegatedPrefixMode>? mode,
  ...
  factory GlobalPublicDelegatedPrefixArgs.fromMap(Map<String, dynamic> map) {
    return GlobalPublicDelegatedPrefixArgs(
      ...
      mode: map['mode'] == null ? null : pulumi.Output.create<GlobalPublicDelegatedPrefixMode>(GlobalPublicDelegatedPrefixMode.fromValue(map['mode'] as String)),
