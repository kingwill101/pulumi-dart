...
class RouterNatRuleActionResponse {
  ...
  /// Creates a new [RouterNatRuleActionResponse].
  ...
  const RouterNatRuleActionResponse({
  ...
  factory RouterNatRuleActionResponse.fromMap(Map<String, dynamic> map) {
    return RouterNatRuleActionResponse(
      sourceNatActiveIps: pulumi.Input.fromValue((map['sourceNatActiveIps'] as List).cast<String>()),
      sourceNatActiveRanges: pulumi.Input.fromValue((map['sourceNatActiveRanges'] as List).cast<String>()),
      sourceNatDrainIps: pulumi.Input.fromValue((map['sourceNatDrainIps'] as List).cast<String>()),
      sourceNatDrainRanges: pulumi.Input.fromValue((map['sourceNatDrainRanges'] as List).cast<String>()),
    );
  }
}
