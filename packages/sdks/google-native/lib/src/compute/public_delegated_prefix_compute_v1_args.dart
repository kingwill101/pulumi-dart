...
class PublicDelegatedPrefixComputeV1Args {
  ...
  PublicDelegatedPrefixComputeV1Args({
    ...
    pulumi.Output<List<PublicDelegatedPrefixPublicDelegatedSubPrefixComputeV1>>? publicDelegatedSubPrefixs,
  ...
  factory PublicDelegatedPrefixComputeV1Args.fromMap(Map<String, dynamic> map) {
    return PublicDelegatedPrefixComputeV1Args(
      ...
      publicDelegatedSubPrefixs: map['publicDelegatedSubPrefixs'] == null ? null : pulumi.Output.create<List<PublicDelegatedPrefixPublicDelegatedSubPrefixComputeV1>>(pulumi.Input.decodeList<PublicDelegatedPrefixPublicDelegatedSubPrefixComputeV1>(map['publicDelegatedSubPrefixs'], (value) => PublicDelegatedPrefixPublicDelegatedSubPrefixComputeV1.fromMap((value as Map).cast<String, dynamic>()))),
