...
class InstanceGroupManagerAutoHealingPolicyResponseComputeV1 {
  ...
  /// Creates a new [InstanceGroupManagerAutoHealingPolicyResponseComputeV1].
  ...
  const InstanceGroupManagerAutoHealingPolicyResponseComputeV1({
  ...
  factory InstanceGroupManagerAutoHealingPolicyResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return InstanceGroupManagerAutoHealingPolicyResponseComputeV1(
