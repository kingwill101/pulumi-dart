...
class GetExternalVpnGatewayResult {
  ...
  final List<ExternalVpnGatewayInterfaceResponse> interfaces;
  ...
  /// Creates a new [GetExternalVpnGatewayResult].
  ...
  const GetExternalVpnGatewayResult({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'interfaces': pulumi.Input.encodeList<ExternalVpnGatewayInterfaceResponse, Map<String, dynamic>>(interfaces, (value) => value.toMap()),
      'kind': kind,
  ...
  factory GetExternalVpnGatewayResult.fromMap(Map<String, dynamic> map) {
    return GetExternalVpnGatewayResult(
      creationTimestamp: map['creationTimestamp'] as String,
      description: map['description'] as String,
      interfaces: pulumi.Input.decodeList<ExternalVpnGatewayInterfaceResponse>(map['interfaces']!, (value) => ExternalVpnGatewayInterfaceResponse.fromMap((value as Map).cast<String, dynamic>())),
