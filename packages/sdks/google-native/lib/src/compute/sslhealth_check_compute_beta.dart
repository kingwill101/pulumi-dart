...
class SSLHealthCheckComputeBeta {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'port': ?port,
      'portName': ?portName,
      'portSpecification': ?pulumi.Input.mapOptionalInputValue<SSLHealthCheckPortSpecificationComputeBeta, String>(portSpecification, (value) => value.value),
      'proxyHeader': ?pulumi.Input.mapOptionalInputValue<SSLHealthCheckProxyHeaderComputeBeta, String>(proxyHeader, (value) => value.value),
      'request': ?request,
      'response': ?response,
    };
  }
  ...
  factory SSLHealthCheckComputeBeta.fromMap(Map<String, dynamic> map) {
    return SSLHealthCheckComputeBeta(
      ...
      portSpecification: map['portSpecification'] == null ? null : (SSLHealthCheckPortSpecificationComputeBeta.fromValue(map['portSpecification'] as String)).input(),
      proxyHeader: map['proxyHeader'] == null ? null : (SSLHealthCheckProxyHeaderComputeBeta.fromValue(map['proxyHeader'] as String)).input(),
