...
class SnapshotComputeBetaArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'snapshotType': ?pulumi.Input.mapOptionalInputValue<SnapshotSnapshotTypeComputeBeta, String>(snapshotType, (value) => value.wireValue),
  ...
  factory SnapshotComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return SnapshotComputeBetaArgs(
      ...
      snapshotEncryptionKey: (() { final guardedValue = map['snapshotEncryptionKey']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CustomerEncryptionKeyComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      snapshotType: (() { final guardedValue = map['snapshotType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SnapshotSnapshotTypeComputeBeta.fromValue(guardedValue as String)); })(),
      ...
      sourceInstantSnapshotEncryptionKey: (() { final guardedValue = map['sourceInstantSnapshotEncryptionKey']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CustomerEncryptionKeyComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
