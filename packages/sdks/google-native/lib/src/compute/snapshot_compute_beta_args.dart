...
/// {@template pulumi_compute_beta_snapshot_compute_beta_args_doc}
/// The set of arguments for Snapshot.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_snapshot_compute_beta_args_doc}
class SnapshotComputeBetaArgs {
  ...
  final pulumi.Input<CustomerEncryptionKeyComputeBeta>? sourceInstantSnapshotEncryptionKey;
  /// Cloud Storage bucket storage location of the snapshot (regional or multi-regional).
  final pulumi.Input<List<String>>? storageLocations;

  /// Creates a new [SnapshotComputeBetaArgs].
  ...
  SnapshotComputeBetaArgs({
    ...
    pulumi.Output<CustomerEncryptionKeyComputeBeta>? snapshotEncryptionKey,
    pulumi.Output<SnapshotSnapshotTypeComputeBeta>? snapshotType,
    ...
    pulumi.Output<CustomerEncryptionKeyComputeBeta>? sourceInstantSnapshotEncryptionKey,
    pulumi.Output<List<String>>? storageLocations,
      ...
      snapshotEncryptionKey = pulumi.Input.asOptionalInput<CustomerEncryptionKeyComputeBeta>(snapshotEncryptionKey),
      snapshotType = pulumi.Input.asOptionalInput<SnapshotSnapshotTypeComputeBeta>(snapshotType),
      ...
      sourceInstantSnapshotEncryptionKey = pulumi.Input.asOptionalInput<CustomerEncryptionKeyComputeBeta>(sourceInstantSnapshotEncryptionKey),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'project': ?project,
      'requestId': ?requestId,
      'snapshotEncryptionKey': ?pulumi.Input.mapOptionalInputValue<CustomerEncryptionKeyComputeBeta, Map<String, dynamic>>(snapshotEncryptionKey, (value) => value.toMap()),
      'snapshotType': ?pulumi.Input.mapOptionalInputValue<SnapshotSnapshotTypeComputeBeta, String>(snapshotType, (value) => value.value),
      ...
      'sourceInstantSnapshotEncryptionKey': ?pulumi.Input.mapOptionalInputValue<CustomerEncryptionKeyComputeBeta, Map<String, dynamic>>(sourceInstantSnapshotEncryptionKey, (value) => value.toMap()),
  ...
  factory SnapshotComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return SnapshotComputeBetaArgs(
      ...
      snapshotEncryptionKey: map['snapshotEncryptionKey'] == null ? null : pulumi.Output.create<CustomerEncryptionKeyComputeBeta>(CustomerEncryptionKeyComputeBeta.fromMap((map['snapshotEncryptionKey'] as Map).cast<String, dynamic>())),
      snapshotType: map['snapshotType'] == null ? null : pulumi.Output.create<SnapshotSnapshotTypeComputeBeta>(SnapshotSnapshotTypeComputeBeta.fromValue(map['snapshotType'] as String)),
      ...
      sourceInstantSnapshotEncryptionKey: map['sourceInstantSnapshotEncryptionKey'] == null ? null : pulumi.Output.create<CustomerEncryptionKeyComputeBeta>(CustomerEncryptionKeyComputeBeta.fromMap((map['sourceInstantSnapshotEncryptionKey'] as Map).cast<String, dynamic>())),
