...
/// {@template pulumi_compute_alpha_region_network_firewall_policy_args_doc}
/// The set of arguments for RegionNetworkFirewallPolicy.
/// {@endtemplate}
/// {@macro pulumi_compute_alpha_region_network_firewall_policy_args_doc}
class RegionNetworkFirewallPolicyArgs {
  ...
  final pulumi.Input<RegionNetworkFirewallPolicyVpcNetworkScope>? vpcNetworkScope;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'shortName': ?shortName,
      'vpcNetworkScope': ?pulumi.Input.mapOptionalInputValue<RegionNetworkFirewallPolicyVpcNetworkScope, String>(vpcNetworkScope, (value) => value.wireValue),
    };
  }

  factory RegionNetworkFirewallPolicyArgs.fromMap(Map<String, dynamic> map) {
    return RegionNetworkFirewallPolicyArgs(
      associations: (() { final guardedValue = map['associations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FirewallPolicyAssociation>(guardedValue, (value) => FirewallPolicyAssociation.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      rules: (() { final guardedValue = map['rules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FirewallPolicyRule>(guardedValue, (value) => FirewallPolicyRule.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      vpcNetworkScope: (() { final guardedValue = map['vpcNetworkScope']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionNetworkFirewallPolicyVpcNetworkScope.fromValue(guardedValue as String)); })(),
    );
  }
}
