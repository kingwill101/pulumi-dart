...
class InstanceGroupManagerUpdatePolicyResponseComputeV1 {
  ...
  factory InstanceGroupManagerUpdatePolicyResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return InstanceGroupManagerUpdatePolicyResponseComputeV1(
      ...
      maxSurge: (FixedOrPercentResponseComputeV1.fromMap((map['maxSurge'] as Map).cast<String, dynamic>())).input(),
      maxUnavailable: (FixedOrPercentResponseComputeV1.fromMap((map['maxUnavailable'] as Map).cast<String, dynamic>())).input(),
