...
class GlobalNetworkEndpointGroupComputeBetaArgs {
  ...
  GlobalNetworkEndpointGroupComputeBetaArgs({
    ...
    pulumi.Output<GlobalNetworkEndpointGroupNetworkEndpointTypeComputeBeta>? networkEndpointType,
  ...
  factory GlobalNetworkEndpointGroupComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return GlobalNetworkEndpointGroupComputeBetaArgs(
      ...
      networkEndpointType: map['networkEndpointType'] == null ? null : pulumi.Output.create<GlobalNetworkEndpointGroupNetworkEndpointTypeComputeBeta>(GlobalNetworkEndpointGroupNetworkEndpointTypeComputeBeta.fromValue(map['networkEndpointType'] as String)),
