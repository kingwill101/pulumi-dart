...
class GlobalNetworkEndpointGroupComputeBetaArgs {
  ...
  const GlobalNetworkEndpointGroupComputeBetaArgs({
    this.annotations,
    this.appEngine,
    this.cloudFunction,
    this.cloudRun,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'network': ?network,
      'networkEndpointType': ?pulumi.Input.mapOptionalInputValue<GlobalNetworkEndpointGroupNetworkEndpointTypeComputeBeta, String>(networkEndpointType, (value) => value.wireValue),
      'project': ?project,
      'pscData': ?pscData,
  ...
  factory GlobalNetworkEndpointGroupComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return GlobalNetworkEndpointGroupComputeBetaArgs(
      ...
      networkEndpointType: (() { final guardedValue = map['networkEndpointType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GlobalNetworkEndpointGroupNetworkEndpointTypeComputeBeta.fromValue(guardedValue as String)); })(),
