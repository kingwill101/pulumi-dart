...
class RegionInstanceTemplateComputeV1Args {
  ...
  const RegionInstanceTemplateComputeV1Args({
    this.description,
    this.name,
    this.project,
    this.properties,
  ...
  factory RegionInstanceTemplateComputeV1Args.fromMap(Map<String, dynamic> map) {
    return RegionInstanceTemplateComputeV1Args(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstancePropertiesComputeV1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      sourceInstanceParams: (() { final guardedValue = map['sourceInstanceParams']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SourceInstanceParamsComputeV1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
