...
class RuleComputeV1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'action':
          ?pulumi.Input.mapOptionalInputValue<RuleActionComputeV1, String>(
            action,
            (value) => value.wireValue,
          ),
      'conditions':
          ?pulumi.Input.mapOptionalInputValue<
            List<ConditionComputeV1>,
    ...
    return RuleComputeV1(
      action: (() {
        ...
        return pulumi.Input.fromValue(
          RuleActionComputeV1.fromValue(guardedValue as String),
        );
      })(),
      conditions: (() {
