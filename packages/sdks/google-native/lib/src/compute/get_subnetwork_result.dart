...
class GetSubnetworkResult {
  ...
  final bool enablePrivateV6Access;
  ...
  final SubnetworkLogConfigResponse logConfig;
  ...
  final List<SubnetworkSecondaryRangeResponse> secondaryIpRanges;
  ...
  const GetSubnetworkResult({
    ...
    required this.enableL2,
    required this.enablePrivateV6Access,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'role': role,
      'secondaryIpRanges': pulumi.Input.encodeList<SubnetworkSecondaryRangeResponse, Map<String, dynamic>>(secondaryIpRanges, (value) => value.toMap()),
      'selfLink': selfLink,
  ...
  factory GetSubnetworkResult.fromMap(Map<String, dynamic> map) {
    return GetSubnetworkResult(
      ...
      enableL2: map['enableL2'] as bool,
      enablePrivateV6Access: map['enablePrivateV6Access'] as bool,
      ...
      logConfig: SubnetworkLogConfigResponse.fromMap((map['logConfig']! as Map).cast<String, dynamic>()),
      ...
      secondaryIpRanges: pulumi.Input.decodeList<SubnetworkSecondaryRangeResponse>(map['secondaryIpRanges']!, (value) => SubnetworkSecondaryRangeResponse.fromMap((value as Map).cast<String, dynamic>())),
      selfLink: map['selfLink'] as String,
      selfLinkWithId: map['selfLinkWithId'] as String,
      stackType: map['stackType'] as String,
      state: map['state'] as String,
      vlans: (map['vlans'] as List).cast<int>(),
    );
  }
}
