...
class BindingComputeBeta {
  ...
  final pulumi.Input<ExprComputeBeta>? condition;
  ...
  /// Creates a new [BindingComputeBeta].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'bindingId': ?bindingId,
      'condition': ?pulumi.Input.mapOptionalInputValue<ExprComputeBeta, Map<String, dynamic>>(condition, (value) => value.toMap()),
      'members': ?members,
      'role': ?role,
    };
  }
  ...
  factory BindingComputeBeta.fromMap(Map<String, dynamic> map) {
    return BindingComputeBeta(
      ...
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ExprComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
