...
class CorsPolicyComputeBeta {
  ...
  /// Creates a new [CorsPolicyComputeBeta].
  ...
  factory CorsPolicyComputeBeta.fromMap(Map<String, dynamic> map) {
    return CorsPolicyComputeBeta(
