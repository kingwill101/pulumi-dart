...
/// {@template pulumi_compute_alpha_service_attachment_iam_member_args_doc}
/// The set of arguments for ServiceAttachmentIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_alpha_service_attachment_iam_member_args_doc}
class ServiceAttachmentIamMemberArgs {
  ...
  /// Creates a new [ServiceAttachmentIamMemberArgs].
  ...
  const ServiceAttachmentIamMemberArgs({
    this.condition,
  ...
  factory ServiceAttachmentIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return ServiceAttachmentIamMemberArgs(
