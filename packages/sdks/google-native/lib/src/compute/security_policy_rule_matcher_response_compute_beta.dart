...
class SecurityPolicyRuleMatcherResponseComputeBeta {
  ...
  factory SecurityPolicyRuleMatcherResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRuleMatcherResponseComputeBeta(
      config: SecurityPolicyRuleMatcherConfigResponseComputeBeta.fromMap((map['config'] as Map).cast<String, dynamic>()),
      expr: ExprResponseComputeBeta.fromMap((map['expr'] as Map).cast<String, dynamic>()),
      exprOptions: SecurityPolicyRuleMatcherExprOptionsResponseComputeBeta.fromMap((map['exprOptions'] as Map).cast<String, dynamic>()),
