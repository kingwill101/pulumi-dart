...
class ServiceAttachment extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<ServiceAttachmentConnectedEndpointResponse>> connectedEndpoints;
  /// The connection preference of service attachment. The value can be set to ACCEPT_AUTOMATIC. An ACCEPT_AUTOMATIC service attachment is one that always accepts the connection from consumer forwarding rules.
  late final pulumi.Output<String> connectionPreference;
  /// Projects that are allowed to connect to this service attachment.
  late final pulumi.Output<List<ServiceAttachmentConsumerProjectLimitResponse>> consumerAcceptLists;
  ...
  late final pulumi.Output<ServiceAttachmentTunnelingConfigResponse> tunnelingConfig;

  /// Creates a new [ServiceAttachment].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ServiceAttachment]. {@macro pulumi_compute_alpha_service_attachment_args_doc}
  ...
  ServiceAttachment(
    ...
    this.connectedEndpoints = registerOutput<List<ServiceAttachmentConnectedEndpointResponse>>('connectedEndpoints');
    this.connectionPreference = registerOutput<String>('connectionPreference');
    this.consumerAcceptLists = registerOutput<List<ServiceAttachmentConsumerProjectLimitResponse>>('consumerAcceptLists');
    ...
    this.propagatedConnectionLimit = registerOutput<int>('propagatedConnectionLimit');
    this.pscServiceAttachmentId = registerOutput<Uint128Response>('pscServiceAttachmentId');
    ...
    this.tunnelingConfig = registerOutput<ServiceAttachmentTunnelingConfigResponse>('tunnelingConfig');
  }
}
