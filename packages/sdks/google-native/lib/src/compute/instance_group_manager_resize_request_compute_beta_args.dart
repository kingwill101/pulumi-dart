...
class InstanceGroupManagerResizeRequestComputeBetaArgs {
  ...
  /// [zone] Optional.
  const InstanceGroupManagerResizeRequestComputeBetaArgs({
    this.count,
    this.description,
  ...
  factory InstanceGroupManagerResizeRequestComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return InstanceGroupManagerResizeRequestComputeBetaArgs(
      ...
      requestedRunDuration: (() { final guardedValue = map['requestedRunDuration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DurationComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
