...
class HttpRouteRuleResponse {
  ...
  final pulumi.Input<List<HttpFilterConfigResponse>> httpFilterConfigs;
  ...
  final pulumi.Input<List<HttpFilterConfigResponse>> httpFilterMetadata;
  /// The list of criteria for matching attributes of a request to this routeRule. This list has OR semantics: the request matches this routeRule when any of the matchRules are satisfied. However predicates within a given matchRule have AND semantics. All predicates within a matchRule must match for the request to match the rule.
  final pulumi.Input<List<HttpRouteRuleMatchResponse>> matchRules;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'httpFilterConfigs': pulumi.Input.mapInputValue<List<HttpFilterConfigResponse>, List<Map<String, dynamic>>>(httpFilterConfigs, (value) => pulumi.Input.encodeList<HttpFilterConfigResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'httpFilterMetadata': pulumi.Input.mapInputValue<List<HttpFilterConfigResponse>, List<Map<String, dynamic>>>(httpFilterMetadata, (value) => pulumi.Input.encodeList<HttpFilterConfigResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'matchRules': pulumi.Input.mapInputValue<List<HttpRouteRuleMatchResponse>, List<Map<String, dynamic>>>(matchRules, (value) => pulumi.Input.encodeList<HttpRouteRuleMatchResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'priority': priority,
  ...
  factory HttpRouteRuleResponse.fromMap(Map<String, dynamic> map) {
    return HttpRouteRuleResponse(
      customErrorResponsePolicy: pulumi.Input.fromValue(CustomErrorResponsePolicyResponse.fromMap((map['customErrorResponsePolicy']! as Map).cast<String, dynamic>())),
      description: pulumi.Input.fromValue(map['description'] as String),
      headerAction: pulumi.Input.fromValue(HttpHeaderActionResponse.fromMap((map['headerAction']! as Map).cast<String, dynamic>())),
      httpFilterConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<HttpFilterConfigResponse>(map['httpFilterConfigs']!, (value) => HttpFilterConfigResponse.fromMap((value as Map).cast<String, dynamic>()))),
      httpFilterMetadata: pulumi.Input.fromValue(pulumi.Input.decodeList<HttpFilterConfigResponse>(map['httpFilterMetadata']!, (value) => HttpFilterConfigResponse.fromMap((value as Map).cast<String, dynamic>()))),
      matchRules: pulumi.Input.fromValue(pulumi.Input.decodeList<HttpRouteRuleMatchResponse>(map['matchRules']!, (value) => HttpRouteRuleMatchResponse.fromMap((value as Map).cast<String, dynamic>()))),
      priority: pulumi.Input.fromValue(map['priority'] as int),
      routeAction: pulumi.Input.fromValue(HttpRouteActionResponse.fromMap((map['routeAction']! as Map).cast<String, dynamic>())),
      service: pulumi.Input.fromValue(map['service'] as String),
      urlRedirect: pulumi.Input.fromValue(HttpRedirectActionResponse.fromMap((map['urlRedirect']! as Map).cast<String, dynamic>())),
    );
  }
}
