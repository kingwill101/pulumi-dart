...
class HttpRouteRuleResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'matchRules':
          pulumi.Input.mapInputValue<
            List<HttpRouteRuleMatchResponse>,
            List<Map<String, dynamic>>
          >(
            matchRules,
            (value) =>
  ...
  factory HttpRouteRuleResponse.fromMap(Map<String, dynamic> map) {
    return HttpRouteRuleResponse(
      ...
      matchRules: pulumi.Input.fromValue(
        pulumi.Input.decodeList<HttpRouteRuleMatchResponse>(
          map['matchRules']!,
