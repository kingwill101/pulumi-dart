...
class HttpRouteRuleResponse {
  ...
  final CustomErrorResponsePolicyResponse customErrorResponsePolicy;
  ...
  final List<HttpFilterConfigResponse> httpFilterConfigs;
  ...
  final List<HttpFilterConfigResponse> httpFilterMetadata;
  /// The list of criteria for matching attributes of a request to this routeRule. This list has OR semantics: the request matches this routeRule when any of the matchRules are satisfied. However predicates within a given matchRule have AND semantics. All predicates within a matchRule must match for the request to match the rule.
  final List<HttpRouteRuleMatchResponse> matchRules;
  ...
  final HttpRouteActionResponse routeAction;
  ...
  final HttpRedirectActionResponse urlRedirect;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'httpFilterConfigs': pulumi.Input.encodeList<HttpFilterConfigResponse, Map<String, dynamic>>(httpFilterConfigs, (value) => value.toMap()),
      'httpFilterMetadata': pulumi.Input.encodeList<HttpFilterConfigResponse, Map<String, dynamic>>(httpFilterMetadata, (value) => value.toMap()),
      'matchRules': pulumi.Input.encodeList<HttpRouteRuleMatchResponse, Map<String, dynamic>>(matchRules, (value) => value.toMap()),
      'priority': priority,
  ...
  factory HttpRouteRuleResponse.fromMap(Map<String, dynamic> map) {
    return HttpRouteRuleResponse(
      customErrorResponsePolicy: CustomErrorResponsePolicyResponse.fromMap((map['customErrorResponsePolicy'] as Map).cast<String, dynamic>()),
      description: map['description'] as String,
      headerAction: HttpHeaderActionResponse.fromMap((map['headerAction'] as Map).cast<String, dynamic>()),
      httpFilterConfigs: pulumi.Input.decodeList<HttpFilterConfigResponse>(map['httpFilterConfigs'], (value) => HttpFilterConfigResponse.fromMap((value as Map).cast<String, dynamic>())),
      httpFilterMetadata: pulumi.Input.decodeList<HttpFilterConfigResponse>(map['httpFilterMetadata'], (value) => HttpFilterConfigResponse.fromMap((value as Map).cast<String, dynamic>())),
      matchRules: pulumi.Input.decodeList<HttpRouteRuleMatchResponse>(map['matchRules'], (value) => HttpRouteRuleMatchResponse.fromMap((value as Map).cast<String, dynamic>())),
      priority: map['priority'] as int,
      routeAction: HttpRouteActionResponse.fromMap((map['routeAction'] as Map).cast<String, dynamic>()),
      service: map['service'] as String,
      urlRedirect: HttpRedirectActionResponse.fromMap((map['urlRedirect'] as Map).cast<String, dynamic>()),
    );
  }
}
