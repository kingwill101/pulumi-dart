...
class NetworkEndpointGroupCloudFunctionComputeV1 {
  ...
  /// Creates a new [NetworkEndpointGroupCloudFunctionComputeV1].
  ...
  const NetworkEndpointGroupCloudFunctionComputeV1({
    this.function,
    this.urlMask,
  });
  ...
  factory NetworkEndpointGroupCloudFunctionComputeV1.fromMap(Map<String, dynamic> map) {
    return NetworkEndpointGroupCloudFunctionComputeV1(
