...
class RegionTargetHttpsProxyComputeV1Args {
  ...
  RegionTargetHttpsProxyComputeV1Args({
    ...
    pulumi.Output<RegionTargetHttpsProxyQuicOverrideComputeV1>? quicOverride,
    ...
    pulumi.Output<String>? urlMap,
      ...
      quicOverride = pulumi.Input.asOptionalInput<RegionTargetHttpsProxyQuicOverrideComputeV1>(quicOverride),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'project': ?project,
      'proxyBind': ?proxyBind,
      'quicOverride': ?pulumi.Input.mapOptionalInputValue<RegionTargetHttpsProxyQuicOverrideComputeV1, String>(quicOverride, (value) => value.value),
      'region': region,
      'requestId': ?requestId,
  ...
  factory RegionTargetHttpsProxyComputeV1Args.fromMap(Map<String, dynamic> map) {
    return RegionTargetHttpsProxyComputeV1Args(
      ...
      quicOverride: map['quicOverride'] == null ? null : pulumi.Output.create<RegionTargetHttpsProxyQuicOverrideComputeV1>(RegionTargetHttpsProxyQuicOverrideComputeV1.fromValue(map['quicOverride'] as String)),
