...
class HttpHeaderActionResponse {
  ...
  const HttpHeaderActionResponse({
  ...
  factory HttpHeaderActionResponse.fromMap(Map<String, dynamic> map) {
    return HttpHeaderActionResponse(
      requestHeadersToAdd: pulumi.Input.fromValue(pulumi.Input.decodeList<HttpHeaderOptionResponse>(map['requestHeadersToAdd']!, (value) => HttpHeaderOptionResponse.fromMap((value as Map).cast<String, dynamic>()))),
      requestHeadersToRemove: pulumi.Input.fromValue((map['requestHeadersToRemove'] as List).cast<String>()),
      responseHeadersToAdd: pulumi.Input.fromValue(pulumi.Input.decodeList<HttpHeaderOptionResponse>(map['responseHeadersToAdd']!, (value) => HttpHeaderOptionResponse.fromMap((value as Map).cast<String, dynamic>()))),
