...
class RouterBgpPeerBfdResponseComputeV1 {
  ...
  /// Creates a new [RouterBgpPeerBfdResponseComputeV1].
  ...
  factory RouterBgpPeerBfdResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return RouterBgpPeerBfdResponseComputeV1(
      minReceiveInterval: (map['minReceiveInterval'] as int).input(),
      minTransmitInterval: (map['minTransmitInterval'] as int).input(),
      multiplier: (map['multiplier'] as int).input(),
