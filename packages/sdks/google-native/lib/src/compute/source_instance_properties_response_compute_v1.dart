...
class SourceInstancePropertiesResponseComputeV1 {
  ...
  final pulumi.Input<List<SavedAttachedDiskResponseComputeV1>> disks;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'disks': pulumi.Input.mapInputValue<List<SavedAttachedDiskResponseComputeV1>, List<Map<String, dynamic>>>(disks, (value) => pulumi.Input.encodeList<SavedAttachedDiskResponseComputeV1, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory SourceInstancePropertiesResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return SourceInstancePropertiesResponseComputeV1(
      ...
      disks: pulumi.Input.fromValue(pulumi.Input.decodeList<SavedAttachedDiskResponseComputeV1>(map['disks']!, (value) => SavedAttachedDiskResponseComputeV1.fromMap((value as Map).cast<String, dynamic>()))),
