...
/// {@template pulumi_compute_beta_region_disk_iam_binding_compute_beta_args_doc}
/// The set of arguments for RegionDiskIamBinding.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_region_disk_iam_binding_compute_beta_args_doc}
class RegionDiskIamBindingComputeBetaArgs {
  ...
  /// Creates a new [RegionDiskIamBindingComputeBetaArgs].
  ...
  const RegionDiskIamBindingComputeBetaArgs({
    this.condition,
  ...
  factory RegionDiskIamBindingComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return RegionDiskIamBindingComputeBetaArgs(
