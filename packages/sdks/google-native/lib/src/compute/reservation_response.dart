...
class ReservationResponse {
  ...
  factory ReservationResponse.fromMap(Map<String, dynamic> map) {
    return ReservationResponse(
      aggregateReservation: pulumi.Input.fromValue(AllocationAggregateReservationResponse.fromMap((map['aggregateReservation']! as Map).cast<String, dynamic>())),
      ...
      deleteAfterDuration: pulumi.Input.fromValue(DurationResponse.fromMap((map['deleteAfterDuration']! as Map).cast<String, dynamic>())),
      ...
      resourceStatus: pulumi.Input.fromValue(AllocationResourceStatusResponse.fromMap((map['resourceStatus']! as Map).cast<String, dynamic>())),
      ...
      specificReservation: pulumi.Input.fromValue(AllocationSpecificSKUReservationResponse.fromMap((map['specificReservation']! as Map).cast<String, dynamic>())),
