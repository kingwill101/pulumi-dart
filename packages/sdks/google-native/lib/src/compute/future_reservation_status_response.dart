...
class FutureReservationStatusResponse {
  ...
  factory FutureReservationStatusResponse.fromMap(Map<String, dynamic> map) {
    return FutureReservationStatusResponse(
      ...
      lastKnownGoodState: pulumi.Input.fromValue(FutureReservationStatusLastKnownGoodStateResponse.fromMap((map['lastKnownGoodState']! as Map).cast<String, dynamic>())),
      ...
      specificSkuProperties: pulumi.Input.fromValue(FutureReservationStatusSpecificSKUPropertiesResponse.fromMap((map['specificSkuProperties']! as Map).cast<String, dynamic>())),
    );
  }
}
