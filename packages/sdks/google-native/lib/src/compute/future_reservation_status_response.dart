...
class FutureReservationStatusResponse {
  ...
  final pulumi.Input<FutureReservationStatusLastKnownGoodStateResponse>
  lastKnownGoodState;
  ...
  final pulumi.Input<FutureReservationStatusSpecificSKUPropertiesResponse>
    ...
    return <String, dynamic>{
      ...
      'lastKnownGoodState':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(lastKnownGoodState, (value) => value.toMap()),
      'lockTime': lockTime,
