...
class HTTPSHealthCheckComputeV1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'port': ?port,
      'portName': ?portName,
      'portSpecification': ?pulumi.Input.mapOptionalInputValue<HTTPSHealthCheckPortSpecificationComputeV1, String>(portSpecification, (value) => value.value),
      'proxyHeader': ?pulumi.Input.mapOptionalInputValue<HTTPSHealthCheckProxyHeaderComputeV1, String>(proxyHeader, (value) => value.value),
  ...
  factory HTTPSHealthCheckComputeV1.fromMap(Map<String, dynamic> map) {
    return HTTPSHealthCheckComputeV1(
      ...
      portSpecification: map['portSpecification'] == null ? null : (HTTPSHealthCheckPortSpecificationComputeV1.fromValue(map['portSpecification']! as String)).input(),
      proxyHeader: map['proxyHeader'] == null ? null : (HTTPSHealthCheckProxyHeaderComputeV1.fromValue(map['proxyHeader']! as String)).input(),
