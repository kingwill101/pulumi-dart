...
class HTTPSHealthCheckComputeV1 {
  ...
  final pulumi.Input<HTTPSHealthCheckPortSpecificationComputeV1>? portSpecification;
  /// Specifies the type of proxy header to append before sending data to the backend, either NONE or PROXY_V1. The default is NONE.
  final pulumi.Input<HTTPSHealthCheckProxyHeaderComputeV1>? proxyHeader;
  ...
  const HTTPSHealthCheckComputeV1({
    this.host,
    this.port,
    this.portName,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'port': ?port,
      'portName': ?portName,
      'portSpecification': ?pulumi.Input.mapOptionalInputValue<HTTPSHealthCheckPortSpecificationComputeV1, String>(portSpecification, (value) => value.wireValue),
      'proxyHeader': ?pulumi.Input.mapOptionalInputValue<HTTPSHealthCheckProxyHeaderComputeV1, String>(proxyHeader, (value) => value.wireValue),
  ...
  factory HTTPSHealthCheckComputeV1.fromMap(Map<String, dynamic> map) {
    return HTTPSHealthCheckComputeV1(
      ...
      portSpecification: (() { final guardedValue = map['portSpecification']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HTTPSHealthCheckPortSpecificationComputeV1.fromValue(guardedValue as String)); })(),
      proxyHeader: (() { final guardedValue = map['proxyHeader']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HTTPSHealthCheckProxyHeaderComputeV1.fromValue(guardedValue as String)); })(),
