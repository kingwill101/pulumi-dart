...
class NetworkEndpointGroupCloudRunResponseComputeV1 {
  ...
  /// Creates a new [NetworkEndpointGroupCloudRunResponseComputeV1].
  ...
  const NetworkEndpointGroupCloudRunResponseComputeV1({
  ...
  factory NetworkEndpointGroupCloudRunResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return NetworkEndpointGroupCloudRunResponseComputeV1(
