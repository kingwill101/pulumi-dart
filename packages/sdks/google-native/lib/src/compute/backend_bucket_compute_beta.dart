...
import 'backend_bucket_compute_beta_args.dart';

/// Creates a BackendBucket resource in the specified project using the data included in the request.
class BackendBucketComputeBeta extends pulumi.CustomResource {
  /// Cloud Storage bucket name.
  late final pulumi.Output<String> bucketName;
  /// Cloud CDN configuration for this BackendBucket.
  late final pulumi.Output<BackendBucketCdnPolicyResponseComputeBeta> cdnPolicy;
  ...
  /// Creates a new [BackendBucketComputeBeta].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [BackendBucketComputeBeta]. {@macro pulumi_compute_beta_backend_bucket_compute_beta_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  BackendBucketComputeBeta(
    String name, {
    BackendBucketComputeBetaArgs? args,
    ...
    cdnPolicy = registerOutput<BackendBucketCdnPolicyResponseComputeBeta>('cdnPolicy', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return BackendBucketCdnPolicyResponseComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>()); });
