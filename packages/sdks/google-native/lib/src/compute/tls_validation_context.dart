...
class TlsValidationContext {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'validationSource': ?pulumi.Input.mapOptionalInputValue<TlsValidationContextValidationSource, String>(validationSource, (value) => value.wireValue),
    };
  }
  ...
  factory TlsValidationContext.fromMap(Map<String, dynamic> map) {
    return TlsValidationContext(
      ...
      validationSource: (() { final guardedValue = map['validationSource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TlsValidationContextValidationSource.fromValue(guardedValue as String)); })(),
    );
  }
}
