...
class SubnetworkLogConfigComputeBeta {
  ...
  final pulumi.Input<SubnetworkLogConfigAggregationIntervalComputeBeta>? aggregationInterval;
  ...
  final pulumi.Input<SubnetworkLogConfigMetadataComputeBeta>? metadata;
  ...
  const SubnetworkLogConfigComputeBeta({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'aggregationInterval': ?pulumi.Input.mapOptionalInputValue<SubnetworkLogConfigAggregationIntervalComputeBeta, String>(aggregationInterval, (value) => value.wireValue),
      'enable': ?enable,
      'filterExpr': ?filterExpr,
      'flowSampling': ?flowSampling,
      'metadata': ?pulumi.Input.mapOptionalInputValue<SubnetworkLogConfigMetadataComputeBeta, String>(metadata, (value) => value.wireValue),
  ...
  factory SubnetworkLogConfigComputeBeta.fromMap(Map<String, dynamic> map) {
    return SubnetworkLogConfigComputeBeta(
      aggregationInterval: (() { final guardedValue = map['aggregationInterval']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SubnetworkLogConfigAggregationIntervalComputeBeta.fromValue(guardedValue as String)); })(),
      ...
      metadata: (() { final guardedValue = map['metadata']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SubnetworkLogConfigMetadataComputeBeta.fromValue(guardedValue as String)); })(),
