...
class SubnetworkLogConfigComputeBeta {
  ...
  final pulumi.Input<SubnetworkLogConfigAggregationIntervalComputeBeta>?
  aggregationInterval;
    ...
    return <String, dynamic>{
      'aggregationInterval':
          ?pulumi.Input.mapOptionalInputValue<
            SubnetworkLogConfigAggregationIntervalComputeBeta,
            String
      ...
      'metadata':
          ?pulumi.Input.mapOptionalInputValue<
            SubnetworkLogConfigMetadataComputeBeta,
            String
