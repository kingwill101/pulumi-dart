...
class SubnetworkLogConfigComputeBeta {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'aggregationInterval': ?aggregationInterval == null ? null : aggregationInterval!.value,
      'enable': ?enable,
  ...
  factory SubnetworkLogConfigComputeBeta.fromMap(Map<String, dynamic> map) {
    return SubnetworkLogConfigComputeBeta(
      aggregationInterval: map['aggregationInterval'] == null ? null : SubnetworkLogConfigAggregationIntervalComputeBeta.fromValue(map['aggregationInterval'] as String),
      enable: map['enable'] == null ? null : map['enable'] as bool,
      filterExpr: map['filterExpr'] == null ? null : map['filterExpr'] as String,
      flowSampling: map['flowSampling'] == null ? null : map['flowSampling'] as double,
      metadata: map['metadata'] == null ? null : SubnetworkLogConfigMetadataComputeBeta.fromValue(map['metadata'] as String),
      metadataFields: map['metadataFields'] == null ? null : (map['metadataFields'] as List).cast<String>(),
    );
  }
}
