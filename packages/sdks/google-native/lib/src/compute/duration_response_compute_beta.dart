...
class DurationResponseComputeBeta {
  ...
  /// Creates a new [DurationResponseComputeBeta].
  ...
  DurationResponseComputeBeta({required this.nanos, required this.seconds});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'nanos': nanos, 'seconds': seconds};
  }

  factory DurationResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return DurationResponseComputeBeta(
