...
class UrlMapArgs {
  ...
  factory UrlMapArgs.fromMap(Map<String, dynamic> map) {
    return UrlMapArgs(
      ...
      hostRules: (() { final guardedValue = map['hostRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<HostRule>(guardedValue, (value) => HostRule.fromMap((value as Map).cast<String, dynamic>()))); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      pathMatchers: (() { final guardedValue = map['pathMatchers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PathMatcher>(guardedValue, (value) => PathMatcher.fromMap((value as Map).cast<String, dynamic>()))); })(),
