...
class PathMatcher {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'pathRules': ?pulumi.Input.mapOptionalInputValue<List<PathRule>, List<Map<String, dynamic>>>(pathRules, (value) => pulumi.Input.encodeList<PathRule, Map<String, dynamic>>(value, (value) => value.toMap())),
      'routeRules': ?pulumi.Input.mapOptionalInputValue<List<HttpRouteRule>, List<Map<String, dynamic>>>(routeRules, (value) => pulumi.Input.encodeList<HttpRouteRule, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory PathMatcher.fromMap(Map<String, dynamic> map) {
    return PathMatcher(
      defaultCustomErrorResponsePolicy: (() { final guardedValue = map['defaultCustomErrorResponsePolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CustomErrorResponsePolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      defaultRouteAction: (() { final guardedValue = map['defaultRouteAction']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HttpRouteAction.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      defaultUrlRedirect: (() { final guardedValue = map['defaultUrlRedirect']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HttpRedirectAction.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      pathRules: (() { final guardedValue = map['pathRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PathRule>(guardedValue, (value) => PathRule.fromMap((value as Map).cast<String, dynamic>()))); })(),
      routeRules: (() { final guardedValue = map['routeRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<HttpRouteRule>(guardedValue, (value) => HttpRouteRule.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
