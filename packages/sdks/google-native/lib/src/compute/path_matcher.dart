...
class PathMatcher {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'pathRules': ?pathRules == null ? null : pulumi.Input.encodeList<PathRule, Map<String, dynamic>>(pathRules!, (value) => value.toMap()),
      'routeRules': ?routeRules == null ? null : pulumi.Input.encodeList<HttpRouteRule, Map<String, dynamic>>(routeRules!, (value) => value.toMap()),
    };
  }

  factory PathMatcher.fromMap(Map<String, dynamic> map) {
    return PathMatcher(
      defaultCustomErrorResponsePolicy: map['defaultCustomErrorResponsePolicy'] == null ? null : CustomErrorResponsePolicy.fromMap((map['defaultCustomErrorResponsePolicy'] as Map).cast<String, dynamic>()),
      defaultRouteAction: map['defaultRouteAction'] == null ? null : HttpRouteAction.fromMap((map['defaultRouteAction'] as Map).cast<String, dynamic>()),
      defaultService: map['defaultService'] == null ? null : map['defaultService'] as String,
      defaultUrlRedirect: map['defaultUrlRedirect'] == null ? null : HttpRedirectAction.fromMap((map['defaultUrlRedirect'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      headerAction: map['headerAction'] == null ? null : HttpHeaderAction.fromMap((map['headerAction'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      pathRules: map['pathRules'] == null ? null : pulumi.Input.decodeList<PathRule>(map['pathRules'], (value) => PathRule.fromMap((value as Map).cast<String, dynamic>())),
      routeRules: map['routeRules'] == null ? null : pulumi.Input.decodeList<HttpRouteRule>(map['routeRules'], (value) => HttpRouteRule.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
