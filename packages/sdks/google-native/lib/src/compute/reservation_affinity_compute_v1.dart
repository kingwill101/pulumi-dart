...
class ReservationAffinityComputeV1 {
  ...
  final pulumi.Input<ReservationAffinityConsumeReservationTypeComputeV1>? consumeReservationType;
  ...
  const ReservationAffinityComputeV1({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'consumeReservationType': ?pulumi.Input.mapOptionalInputValue<ReservationAffinityConsumeReservationTypeComputeV1, String>(consumeReservationType, (value) => value.wireValue),
      'key': ?key,
      'values': ?values,
    };
  }
  ...
  factory ReservationAffinityComputeV1.fromMap(Map<String, dynamic> map) {
    return ReservationAffinityComputeV1(
      consumeReservationType: (() { final guardedValue = map['consumeReservationType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ReservationAffinityConsumeReservationTypeComputeV1.fromValue(guardedValue as String)); })(),
