    ...
    return <String, dynamic>{
      ...
      'ipVersion':
          ?pulumi.Input.mapOptionalInputValue<
            RouterInterfaceIpVersionComputeBeta,
            String
    ...
    return RouterInterfaceComputeBeta(
      ...
      ipVersion: (() {
        ...
        return pulumi.Input.fromValue(
          RouterInterfaceIpVersionComputeBeta.fromValue(guardedValue as String),
        );
      })(),
      linkedInterconnectAttachment: (() {
        final guardedValue = map['linkedInterconnectAttachment'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      linkedVpnTunnel: (() {
        final guardedValue = map['linkedVpnTunnel'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      name: (() {
