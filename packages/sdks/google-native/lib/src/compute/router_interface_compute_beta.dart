...
import 'router_interface_ip_version_compute_beta.dart';

class RouterInterfaceComputeBeta {
  /// IP address and range of the interface. The IP range must be in the RFC3927 link-local IP address space. The value must be a CIDR-formatted string, for example: 169.254.0.1/30. NOTE: Do not truncate the address as it represents the IP address of the interface.
  final pulumi.Input<String>? ipRange;
  /// IP version of this interface.
  final pulumi.Input<RouterInterfaceIpVersionComputeBeta>? ipVersion;
  ...
  /// Creates a new [RouterInterfaceComputeBeta].
  ...
  const RouterInterfaceComputeBeta({
    this.ipRange,
    this.ipVersion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'ipRange': ?ipRange,
      'ipVersion': ?pulumi.Input.mapOptionalInputValue<RouterInterfaceIpVersionComputeBeta, String>(ipVersion, (value) => value.wireValue),
  ...
  factory RouterInterfaceComputeBeta.fromMap(Map<String, dynamic> map) {
    return RouterInterfaceComputeBeta(
      ...
      ipVersion: (() { final guardedValue = map['ipVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RouterInterfaceIpVersionComputeBeta.fromValue(guardedValue as String)); })(),
