...
/// {@template pulumi_compute_alpha_license_code_iam_binding_args_doc}
/// The set of arguments for LicenseCodeIamBinding.
/// {@endtemplate}
/// {@macro pulumi_compute_alpha_license_code_iam_binding_args_doc}
class LicenseCodeIamBindingArgs {
  ...
  /// Creates a new [LicenseCodeIamBindingArgs].
  ...
  const LicenseCodeIamBindingArgs({
    this.condition,
  ...
  factory LicenseCodeIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return LicenseCodeIamBindingArgs(
