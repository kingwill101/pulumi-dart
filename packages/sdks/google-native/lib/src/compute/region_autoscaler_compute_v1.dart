...
class RegionAutoscalerComputeV1 extends pulumi.CustomResource {
  ...
  RegionAutoscalerComputeV1(
    ...
    autoscalingPolicy = registerOutput<AutoscalingPolicyResponseComputeV1>(
      'autoscalingPolicy',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return AutoscalingPolicyResponseComputeV1.fromMap(
    ...
    scalingScheduleStatus = registerOutput<Map<String, String>>(
