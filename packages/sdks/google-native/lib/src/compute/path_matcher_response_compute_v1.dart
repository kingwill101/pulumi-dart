...
class PathMatcherResponseComputeV1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'pathRules':
          pulumi.Input.mapInputValue<
            List<PathRuleResponseComputeV1>,
      ...
      'routeRules':
          pulumi.Input.mapInputValue<
            List<HttpRouteRuleResponseComputeV1>,
            List<Map<String, dynamic>>
          >(
            routeRules,
            (value) =>
  ...
  factory PathMatcherResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return PathMatcherResponseComputeV1(
      ...
      pathRules: pulumi.Input.fromValue(
        pulumi.Input.decodeList<PathRuleResponseComputeV1>(
          map['pathRules']!,
      ...
      routeRules: pulumi.Input.fromValue(
        pulumi.Input.decodeList<HttpRouteRuleResponseComputeV1>(
          map['routeRules']!,
