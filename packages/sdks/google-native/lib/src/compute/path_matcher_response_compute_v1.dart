...
class PathMatcherResponseComputeV1 {
  ...
  factory PathMatcherResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return PathMatcherResponseComputeV1(
      defaultRouteAction: (HttpRouteActionResponseComputeV1.fromMap((map['defaultRouteAction'] as Map).cast<String, dynamic>())).input(),
      defaultService: (map['defaultService'] as String).input(),
      defaultUrlRedirect: (HttpRedirectActionResponseComputeV1.fromMap((map['defaultUrlRedirect'] as Map).cast<String, dynamic>())).input(),
      description: (map['description'] as String).input(),
      headerAction: (HttpHeaderActionResponseComputeV1.fromMap((map['headerAction'] as Map).cast<String, dynamic>())).input(),
      name: (map['name'] as String).input(),
      pathRules: (pulumi.Input.decodeList<PathRuleResponseComputeV1>(map['pathRules'], (value) => PathRuleResponseComputeV1.fromMap((value as Map).cast<String, dynamic>()))).input(),
      routeRules: (pulumi.Input.decodeList<HttpRouteRuleResponseComputeV1>(map['routeRules'], (value) => HttpRouteRuleResponseComputeV1.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
