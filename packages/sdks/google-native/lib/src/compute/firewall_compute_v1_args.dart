...
class FirewallComputeV1Args {
  ...
  FirewallComputeV1Args({
    pulumi.Output<List<FirewallAllowedItemComputeV1>>? allowed,
    pulumi.Output<List<FirewallDeniedItemComputeV1>>? denied,
    pulumi.Output<String>? description,
    pulumi.Output<List<String>>? destinationRanges,
    pulumi.Output<FirewallDirectionComputeV1>? direction,
    pulumi.Output<bool>? disabled,
    pulumi.Output<FirewallLogConfigComputeV1>? logConfig,
  ...
  factory FirewallComputeV1Args.fromMap(Map<String, dynamic> map) {
    return FirewallComputeV1Args(
      allowed: map['allowed'] == null ? null : pulumi.Output.create<List<FirewallAllowedItemComputeV1>>(pulumi.Input.decodeList<FirewallAllowedItemComputeV1>(map['allowed'], (value) => FirewallAllowedItemComputeV1.fromMap((value as Map).cast<String, dynamic>()))),
      denied: map['denied'] == null ? null : pulumi.Output.create<List<FirewallDeniedItemComputeV1>>(pulumi.Input.decodeList<FirewallDeniedItemComputeV1>(map['denied'], (value) => FirewallDeniedItemComputeV1.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      direction: map['direction'] == null ? null : pulumi.Output.create<FirewallDirectionComputeV1>(FirewallDirectionComputeV1.fromValue(map['direction'] as String)),
      disabled: map['disabled'] == null ? null : pulumi.Output.create<bool>(map['disabled'] as bool),
      logConfig: map['logConfig'] == null ? null : pulumi.Output.create<FirewallLogConfigComputeV1>(FirewallLogConfigComputeV1.fromMap((map['logConfig'] as Map).cast<String, dynamic>())),
