...
class FirewallComputeV1Args {
  ...
  factory FirewallComputeV1Args.fromMap(Map<String, dynamic> map) {
    return FirewallComputeV1Args(
      allowed: map['allowed'] == null ? null : (pulumi.Input.decodeList<FirewallAllowedItemComputeV1>(map['allowed'], (value) => FirewallAllowedItemComputeV1.fromMap((value as Map).cast<String, dynamic>()))).input(),
      denied: map['denied'] == null ? null : (pulumi.Input.decodeList<FirewallDeniedItemComputeV1>(map['denied'], (value) => FirewallDeniedItemComputeV1.fromMap((value as Map).cast<String, dynamic>()))).input(),
      description: map['description'] == null ? null : (map['description'] as String).input(),
      destinationRanges: map['destinationRanges'] == null ? null : ((map['destinationRanges'] as List).cast<String>()).input(),
      direction: map['direction'] == null ? null : (FirewallDirectionComputeV1.fromValue(map['direction'] as String)).input(),
      disabled: map['disabled'] == null ? null : (map['disabled'] as bool).input(),
      logConfig: map['logConfig'] == null ? null : (FirewallLogConfigComputeV1.fromMap((map['logConfig'] as Map).cast<String, dynamic>())).input(),
