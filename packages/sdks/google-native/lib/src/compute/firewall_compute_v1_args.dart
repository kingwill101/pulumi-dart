...
class FirewallComputeV1Args {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'direction': ?pulumi.Input.mapOptionalInputValue<FirewallDirectionComputeV1, String>(direction, (value) => value.wireValue),
      'disabled': ?disabled,
  ...
  factory FirewallComputeV1Args.fromMap(Map<String, dynamic> map) {
    return FirewallComputeV1Args(
      allowed: (() { final guardedValue = map['allowed']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FirewallAllowedItemComputeV1>(guardedValue, (value) => FirewallAllowedItemComputeV1.fromMap((value as Map).cast<String, dynamic>()))); })(),
      denied: (() { final guardedValue = map['denied']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FirewallDeniedItemComputeV1>(guardedValue, (value) => FirewallDeniedItemComputeV1.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      direction: (() { final guardedValue = map['direction']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FirewallDirectionComputeV1.fromValue(guardedValue as String)); })(),
      disabled: (() { final guardedValue = map['disabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      logConfig: (() { final guardedValue = map['logConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FirewallLogConfigComputeV1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
