...
/// {@template pulumi_compute_v1_backend_service_iam_member_compute_v1_args_doc}
/// The set of arguments for BackendServiceIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_v1_backend_service_iam_member_compute_v1_args_doc}
class BackendServiceIamMemberComputeV1Args {
  ...
  /// Creates a new [BackendServiceIamMemberComputeV1Args].
  ...
  const BackendServiceIamMemberComputeV1Args({
    this.condition,
  ...
  factory BackendServiceIamMemberComputeV1Args.fromMap(Map<String, dynamic> map) {
    return BackendServiceIamMemberComputeV1Args(
