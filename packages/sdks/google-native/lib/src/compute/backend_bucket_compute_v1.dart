...
class BackendBucketComputeV1 extends pulumi.CustomResource {
  ...
  BackendBucketComputeV1(
    ...
    cdnPolicy = registerOutput<BackendBucketCdnPolicyResponseComputeV1>('cdnPolicy', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return BackendBucketCdnPolicyResponseComputeV1.fromMap((guardedValue as Map).cast<String, dynamic>()); });
