...
class GetRegionTargetTcpProxyComputeV1Result {
  ...
  /// Creates a new [GetRegionTargetTcpProxyComputeV1Result].
  ...
  const GetRegionTargetTcpProxyComputeV1Result({
  ...
  factory GetRegionTargetTcpProxyComputeV1Result.fromMap(Map<String, dynamic> map) {
    return GetRegionTargetTcpProxyComputeV1Result(
