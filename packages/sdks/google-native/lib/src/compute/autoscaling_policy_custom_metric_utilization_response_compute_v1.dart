...
class AutoscalingPolicyCustomMetricUtilizationResponseComputeV1 {
  ...
  /// Creates a new [AutoscalingPolicyCustomMetricUtilizationResponseComputeV1].
  ...
  const AutoscalingPolicyCustomMetricUtilizationResponseComputeV1({
  ...
  factory AutoscalingPolicyCustomMetricUtilizationResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return AutoscalingPolicyCustomMetricUtilizationResponseComputeV1(
