...
class RegionCommitmentComputeBeta extends pulumi.CustomResource {
  ...
  RegionCommitmentComputeBeta(
    ...
    licenseResource = registerOutput<LicenseResourceCommitmentResponseComputeBeta>('licenseResource', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return LicenseResourceCommitmentResponseComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>()); });
