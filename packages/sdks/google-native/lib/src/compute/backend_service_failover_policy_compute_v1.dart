...
class BackendServiceFailoverPolicyComputeV1 {
  ...
  /// Creates a new [BackendServiceFailoverPolicyComputeV1].
  ...
  const BackendServiceFailoverPolicyComputeV1({
  ...
  factory BackendServiceFailoverPolicyComputeV1.fromMap(Map<String, dynamic> map) {
