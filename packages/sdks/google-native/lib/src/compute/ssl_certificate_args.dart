...
class SslCertificateArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'type': ?pulumi.Input.mapOptionalInputValue<SslCertificateType, String>(type, (value) => value.wireValue),
    };
  }
  ...
  factory SslCertificateArgs.fromMap(Map<String, dynamic> map) {
    return SslCertificateArgs(
      ...
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SslCertificateType.fromValue(guardedValue as String)); })(),
    );
  }
}
