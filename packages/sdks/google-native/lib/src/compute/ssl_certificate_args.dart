...
class SslCertificateArgs {
  ...
  SslCertificateArgs({
    ...
    pulumi.Output<SslCertificateType>? type,
  }) :
      ...
      type = pulumi.Input.asOptionalInput<SslCertificateType>(type);
  ...
  factory SslCertificateArgs.fromMap(Map<String, dynamic> map) {
    return SslCertificateArgs(
      ...
      type: map['type'] == null ? null : pulumi.Output.create<SslCertificateType>(SslCertificateType.fromValue(map['type'] as String)),
    );
  }
}
