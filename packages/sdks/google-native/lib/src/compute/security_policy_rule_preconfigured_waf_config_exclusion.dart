...
class SecurityPolicyRulePreconfiguredWafConfigExclusion {
  ...
  factory SecurityPolicyRulePreconfiguredWafConfigExclusion.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRulePreconfiguredWafConfigExclusion(
      requestCookiesToExclude: (() { final guardedValue = map['requestCookiesToExclude']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParams>(guardedValue, (value) => SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParams.fromMap((value as Map).cast<String, dynamic>()))); })(),
      requestHeadersToExclude: (() { final guardedValue = map['requestHeadersToExclude']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParams>(guardedValue, (value) => SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParams.fromMap((value as Map).cast<String, dynamic>()))); })(),
      requestQueryParamsToExclude: (() { final guardedValue = map['requestQueryParamsToExclude']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParams>(guardedValue, (value) => SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParams.fromMap((value as Map).cast<String, dynamic>()))); })(),
      requestUrisToExclude: (() { final guardedValue = map['requestUrisToExclude']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParams>(guardedValue, (value) => SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParams.fromMap((value as Map).cast<String, dynamic>()))); })(),
