...
/// {@template pulumi_compute_beta_region_instant_snapshot_iam_binding_compute_beta_args_doc}
/// The set of arguments for RegionInstantSnapshotIamBinding.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_region_instant_snapshot_iam_binding_compute_beta_args_doc}
class RegionInstantSnapshotIamBindingComputeBetaArgs {
  ...
  /// Creates a new [RegionInstantSnapshotIamBindingComputeBetaArgs].
  ...
  const RegionInstantSnapshotIamBindingComputeBetaArgs({
    this.condition,
  ...
  factory RegionInstantSnapshotIamBindingComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return RegionInstantSnapshotIamBindingComputeBetaArgs(
