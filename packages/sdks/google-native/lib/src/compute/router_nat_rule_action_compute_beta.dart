...
class RouterNatRuleActionComputeBeta {
  ...
  /// Creates a new [RouterNatRuleActionComputeBeta].
  ...
  const RouterNatRuleActionComputeBeta({
  ...
  factory RouterNatRuleActionComputeBeta.fromMap(Map<String, dynamic> map) {
    return RouterNatRuleActionComputeBeta(
      sourceNatActiveIps: (() { final guardedValue = map['sourceNatActiveIps']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      sourceNatActiveRanges: (() { final guardedValue = map['sourceNatActiveRanges']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      sourceNatDrainIps: (() { final guardedValue = map['sourceNatDrainIps']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      sourceNatDrainRanges: (() { final guardedValue = map['sourceNatDrainRanges']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
    );
  }
}
