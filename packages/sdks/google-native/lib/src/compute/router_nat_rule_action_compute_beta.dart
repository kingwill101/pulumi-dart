...
class RouterNatRuleActionComputeBeta {
  ...
  factory RouterNatRuleActionComputeBeta.fromMap(Map<String, dynamic> map) {
    return RouterNatRuleActionComputeBeta(
      sourceNatActiveIps: map['sourceNatActiveIps'] == null ? null : (map['sourceNatActiveIps'] as List).cast<String>(),
      sourceNatActiveRanges: map['sourceNatActiveRanges'] == null ? null : (map['sourceNatActiveRanges'] as List).cast<String>(),
      sourceNatDrainIps: map['sourceNatDrainIps'] == null ? null : (map['sourceNatDrainIps'] as List).cast<String>(),
      sourceNatDrainRanges: map['sourceNatDrainRanges'] == null ? null : (map['sourceNatDrainRanges'] as List).cast<String>(),
    );
  }
}
