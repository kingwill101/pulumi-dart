...
class SecurityPolicyRuleMatcherConfigLayer4ConfigResponseComputeBeta {
  ...
  /// Creates a new [SecurityPolicyRuleMatcherConfigLayer4ConfigResponseComputeBeta].
  ...
  const SecurityPolicyRuleMatcherConfigLayer4ConfigResponseComputeBeta({
  ...
  factory SecurityPolicyRuleMatcherConfigLayer4ConfigResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRuleMatcherConfigLayer4ConfigResponseComputeBeta(
