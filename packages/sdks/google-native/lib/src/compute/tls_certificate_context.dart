...
class TlsCertificateContext {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'certificateSource': ?pulumi.Input.mapOptionalInputValue<TlsCertificateContextCertificateSource, String>(certificateSource, (value) => value.wireValue),
  ...
  factory TlsCertificateContext.fromMap(Map<String, dynamic> map) {
    return TlsCertificateContext(
      certificatePaths: (() { final guardedValue = map['certificatePaths']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TlsCertificatePaths.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      certificateSource: (() { final guardedValue = map['certificateSource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TlsCertificateContextCertificateSource.fromValue(guardedValue as String)); })(),
      sdsConfig: (() { final guardedValue = map['sdsConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SdsConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
