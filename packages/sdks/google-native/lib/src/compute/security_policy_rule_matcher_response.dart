...
class SecurityPolicyRuleMatcherResponse {
  ...
  factory SecurityPolicyRuleMatcherResponse.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRuleMatcherResponse(
      config: (SecurityPolicyRuleMatcherConfigResponse.fromMap((map['config'] as Map).cast<String, dynamic>())).input(),
      expr: (ExprResponse.fromMap((map['expr'] as Map).cast<String, dynamic>())).input(),
      exprOptions: (SecurityPolicyRuleMatcherExprOptionsResponse.fromMap((map['exprOptions'] as Map).cast<String, dynamic>())).input(),
