...
class UrlMap extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<HostRuleResponse>> hostRules;
  ...
  late final pulumi.Output<List<PathMatcherResponse>> pathMatchers;
  ...
  late final pulumi.Output<List<UrlMapTestResponse>> tests;
  ...
  UrlMap(
    ...
    this.defaultCustomErrorResponsePolicy = registerOutput<CustomErrorResponsePolicyResponse>('defaultCustomErrorResponsePolicy');
    this.defaultRouteAction = registerOutput<HttpRouteActionResponse>('defaultRouteAction');
    this.defaultService = registerOutput<String>('defaultService');
    this.defaultUrlRedirect = registerOutput<HttpRedirectActionResponse>('defaultUrlRedirect');
    this.description = registerOutput<String>('description');
    this.fingerprint = registerOutput<String>('fingerprint');
    this.headerAction = registerOutput<HttpHeaderActionResponse>('headerAction');
    this.hostRules = registerOutput<List<HostRuleResponse>>('hostRules');
    this.kind = registerOutput<String>('kind');
    this.name = registerOutput<String>('name');
    this.pathMatchers = registerOutput<List<PathMatcherResponse>>('pathMatchers');
    this.project = registerOutput<String>('project');
    this.region = registerOutput<String>('region');
    this.requestId = registerOutput<String?>('requestId');
    this.selfLink = registerOutput<String>('selfLink');
    this.tests = registerOutput<List<UrlMapTestResponse>>('tests');
  }
}
