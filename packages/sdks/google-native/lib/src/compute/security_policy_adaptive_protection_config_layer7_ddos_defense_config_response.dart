...
class SecurityPolicyAdaptiveProtectionConfigLayer7DdosDefenseConfigResponse {
  ...
  const SecurityPolicyAdaptiveProtectionConfigLayer7DdosDefenseConfigResponse({
  ...
  factory SecurityPolicyAdaptiveProtectionConfigLayer7DdosDefenseConfigResponse.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyAdaptiveProtectionConfigLayer7DdosDefenseConfigResponse(
      ...
      thresholdConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<SecurityPolicyAdaptiveProtectionConfigLayer7DdosDefenseConfigThresholdConfigResponse>(map['thresholdConfigs']!, (value) => SecurityPolicyAdaptiveProtectionConfigLayer7DdosDefenseConfigThresholdConfigResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
