...
/// {@template pulumi_compute_beta_node_template_iam_member_compute_beta_args_doc}
/// The set of arguments for NodeTemplateIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_node_template_iam_member_compute_beta_args_doc}
class NodeTemplateIamMemberComputeBetaArgs {
  ...
  /// Creates a new [NodeTemplateIamMemberComputeBetaArgs].
  ...
  const NodeTemplateIamMemberComputeBetaArgs({
    this.condition,
  ...
  factory NodeTemplateIamMemberComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return NodeTemplateIamMemberComputeBetaArgs(
