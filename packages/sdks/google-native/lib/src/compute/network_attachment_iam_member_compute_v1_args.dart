...
/// {@template pulumi_compute_v1_network_attachment_iam_member_compute_v1_args_doc}
/// The set of arguments for NetworkAttachmentIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_v1_network_attachment_iam_member_compute_v1_args_doc}
class NetworkAttachmentIamMemberComputeV1Args {
  ...
  /// Creates a new [NetworkAttachmentIamMemberComputeV1Args].
  ...
  const NetworkAttachmentIamMemberComputeV1Args({
    this.condition,
  ...
  factory NetworkAttachmentIamMemberComputeV1Args.fromMap(Map<String, dynamic> map) {
    return NetworkAttachmentIamMemberComputeV1Args(
