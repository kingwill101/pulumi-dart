...
class BackendServiceComputeBetaArgs {
  ...
  /// [usedBy] Optional.
  const BackendServiceComputeBetaArgs({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'compressionMode': ?pulumi.Input.mapOptionalInputValue<BackendServiceCompressionModeComputeBeta, String>(compressionMode, (value) => value.wireValue),
      ...
      'ipAddressSelectionPolicy': ?pulumi.Input.mapOptionalInputValue<BackendServiceIpAddressSelectionPolicyComputeBeta, String>(ipAddressSelectionPolicy, (value) => value.wireValue),
      'loadBalancingScheme': ?pulumi.Input.mapOptionalInputValue<BackendServiceLoadBalancingSchemeComputeBeta, String>(loadBalancingScheme, (value) => value.wireValue),
      ...
      'localityLbPolicy': ?pulumi.Input.mapOptionalInputValue<BackendServiceLocalityLbPolicyComputeBeta, String>(localityLbPolicy, (value) => value.wireValue),
      ...
      'portName': ?portName,
      'project': ?project,
      'protocol': ?pulumi.Input.mapOptionalInputValue<BackendServiceProtocolComputeBeta, String>(protocol, (value) => value.wireValue),
      'requestId': ?requestId,
      ...
      'sessionAffinity': ?pulumi.Input.mapOptionalInputValue<BackendServiceSessionAffinityComputeBeta, String>(sessionAffinity, (value) => value.wireValue),
  ...
  factory BackendServiceComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return BackendServiceComputeBetaArgs(
      ...
      compressionMode: (() { final guardedValue = map['compressionMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BackendServiceCompressionModeComputeBeta.fromValue(guardedValue as String)); })(),
      ...
      ipAddressSelectionPolicy: (() { final guardedValue = map['ipAddressSelectionPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BackendServiceIpAddressSelectionPolicyComputeBeta.fromValue(guardedValue as String)); })(),
      loadBalancingScheme: (() { final guardedValue = map['loadBalancingScheme']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BackendServiceLoadBalancingSchemeComputeBeta.fromValue(guardedValue as String)); })(),
      ...
      localityLbPolicy: (() { final guardedValue = map['localityLbPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BackendServiceLocalityLbPolicyComputeBeta.fromValue(guardedValue as String)); })(),
      ...
      protocol: (() { final guardedValue = map['protocol']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BackendServiceProtocolComputeBeta.fromValue(guardedValue as String)); })(),
      ...
      sessionAffinity: (() { final guardedValue = map['sessionAffinity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BackendServiceSessionAffinityComputeBeta.fromValue(guardedValue as String)); })(),
