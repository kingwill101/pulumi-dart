...
class BackendServiceComputeBetaArgs {
  ...
  factory BackendServiceComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return BackendServiceComputeBetaArgs(
      ...
      compressionMode: map['compressionMode'] == null ? null : (BackendServiceCompressionModeComputeBeta.fromValue(map['compressionMode'] as String)).input(),
      ...
      ipAddressSelectionPolicy: map['ipAddressSelectionPolicy'] == null ? null : (BackendServiceIpAddressSelectionPolicyComputeBeta.fromValue(map['ipAddressSelectionPolicy'] as String)).input(),
      loadBalancingScheme: map['loadBalancingScheme'] == null ? null : (BackendServiceLoadBalancingSchemeComputeBeta.fromValue(map['loadBalancingScheme'] as String)).input(),
      ...
      localityLbPolicy: map['localityLbPolicy'] == null ? null : (BackendServiceLocalityLbPolicyComputeBeta.fromValue(map['localityLbPolicy'] as String)).input(),
      ...
      protocol: map['protocol'] == null ? null : (BackendServiceProtocolComputeBeta.fromValue(map['protocol'] as String)).input(),
      ...
      sessionAffinity: map['sessionAffinity'] == null ? null : (BackendServiceSessionAffinityComputeBeta.fromValue(map['sessionAffinity'] as String)).input(),
