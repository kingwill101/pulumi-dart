...
/// {@template pulumi_compute_beta_resource_policy_iam_member_compute_beta_args_doc}
/// The set of arguments for ResourcePolicyIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_resource_policy_iam_member_compute_beta_args_doc}
class ResourcePolicyIamMemberComputeBetaArgs {
  ...
  /// Creates a new [ResourcePolicyIamMemberComputeBetaArgs].
  ...
  const ResourcePolicyIamMemberComputeBetaArgs({
    this.condition,
  ...
  factory ResourcePolicyIamMemberComputeBetaArgs.fromMap(Map<String, dynamic> map) {
