...
class ReservationComputeBeta {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'aggregateReservation': ?aggregateReservation == null ? null : aggregateReservation!.toMap(),
      'deleteAfterDuration': ?deleteAfterDuration == null ? null : deleteAfterDuration!.toMap(),
