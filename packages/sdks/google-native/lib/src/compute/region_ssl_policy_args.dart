...
class RegionSslPolicyArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'minTlsVersion': ?pulumi.Input.mapOptionalInputValue<RegionSslPolicyMinTlsVersion, String>(minTlsVersion, (value) => value.wireValue),
      'name': ?name,
      'profile': ?pulumi.Input.mapOptionalInputValue<RegionSslPolicyProfile, String>(profile, (value) => value.wireValue),
      'project': ?project,
      'region': region,
      'requestId': ?requestId,
  ...
  factory RegionSslPolicyArgs.fromMap(Map<String, dynamic> map) {
    return RegionSslPolicyArgs(
      ...
      minTlsVersion: (() { final guardedValue = map['minTlsVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionSslPolicyMinTlsVersion.fromValue(guardedValue as String)); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      profile: (() { final guardedValue = map['profile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionSslPolicyProfile.fromValue(guardedValue as String)); })(),
