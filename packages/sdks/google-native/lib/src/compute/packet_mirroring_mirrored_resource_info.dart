...
class PacketMirroringMirroredResourceInfo {
  ...
  final pulumi.Input<List<PacketMirroringMirroredResourceInfoInstanceInfo>>?
  instances;

  /// A set of subnetworks for which traffic from/to all VM instances will be mirrored. They must live in the same region as this packetMirroring. You may specify a maximum of 5 subnetworks.
  final pulumi.Input<List<PacketMirroringMirroredResourceInfoSubnetInfo>>?
  subnetworks;
    ...
    return PacketMirroringMirroredResourceInfo(
      instances: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => PacketMirroringMirroredResourceInfoInstanceInfo.fromMap(
      ...
      subnetworks: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<PacketMirroringMirroredResourceInfoSubnetInfo>(
            guardedValue,
