...
class PacketMirroringMirroredResourceInfo {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'instances': ?instances == null ? null : pulumi.Input.encodeList<PacketMirroringMirroredResourceInfoInstanceInfo, Map<String, dynamic>>(instances!, (value) => value.toMap()),
      'subnetworks': ?subnetworks == null ? null : pulumi.Input.encodeList<PacketMirroringMirroredResourceInfoSubnetInfo, Map<String, dynamic>>(subnetworks!, (value) => value.toMap()),
      'tags': ?tags,
    };
  }
  ...
  factory PacketMirroringMirroredResourceInfo.fromMap(Map<String, dynamic> map) {
    return PacketMirroringMirroredResourceInfo(
      instances: map['instances'] == null ? null : pulumi.Input.decodeList<PacketMirroringMirroredResourceInfoInstanceInfo>(map['instances'], (value) => PacketMirroringMirroredResourceInfoInstanceInfo.fromMap((value as Map).cast<String, dynamic>())),
      subnetworks: map['subnetworks'] == null ? null : pulumi.Input.decodeList<PacketMirroringMirroredResourceInfoSubnetInfo>(map['subnetworks'], (value) => PacketMirroringMirroredResourceInfoSubnetInfo.fromMap((value as Map).cast<String, dynamic>())),
