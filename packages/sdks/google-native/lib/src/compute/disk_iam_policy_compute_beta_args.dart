...
/// {@template pulumi_compute_beta_disk_iam_policy_compute_beta_args_doc}
/// The set of arguments for DiskIamPolicy.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_disk_iam_policy_compute_beta_args_doc}
class DiskIamPolicyComputeBetaArgs {
  ...
  /// Creates a new [DiskIamPolicyComputeBetaArgs].
  ...
  factory DiskIamPolicyComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return DiskIamPolicyComputeBetaArgs(
