...
class GetTargetGrpcProxyComputeBetaResult {
  ...
  /// Creates a new [GetTargetGrpcProxyComputeBetaResult].
  ...
  const GetTargetGrpcProxyComputeBetaResult({
  ...
  factory GetTargetGrpcProxyComputeBetaResult.fromMap(Map<String, dynamic> map) {
