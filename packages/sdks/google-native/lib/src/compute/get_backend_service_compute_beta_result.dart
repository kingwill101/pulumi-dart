...
class GetBackendServiceComputeBetaResult {
  ...
  /// Creates a new [GetBackendServiceComputeBetaResult].
  ...
  /// [usedBy] Required.
  const GetBackendServiceComputeBetaResult({
  ...
  factory GetBackendServiceComputeBetaResult.fromMap(Map<String, dynamic> map) {
    return GetBackendServiceComputeBetaResult(
