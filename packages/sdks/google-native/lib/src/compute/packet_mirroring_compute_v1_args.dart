...
class PacketMirroringComputeV1Args {
  ...
  const PacketMirroringComputeV1Args({
    this.collectorIlb,
    this.description,
    this.enable,
    this.filter,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'enable': ?pulumi.Input.mapOptionalInputValue<PacketMirroringEnableComputeV1, String>(enable, (value) => value.wireValue),
  ...
  factory PacketMirroringComputeV1Args.fromMap(Map<String, dynamic> map) {
    return PacketMirroringComputeV1Args(
      collectorIlb: (() { final guardedValue = map['collectorIlb']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PacketMirroringForwardingRuleInfoComputeV1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      description: (() { final guardedValue = map['description']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      enable: (() { final guardedValue = map['enable']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PacketMirroringEnableComputeV1.fromValue(guardedValue as String)); })(),
      filter: (() { final guardedValue = map['filter']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PacketMirroringFilterComputeV1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      mirroredResources: (() { final guardedValue = map['mirroredResources']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PacketMirroringMirroredResourceInfoComputeV1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      network: (() { final guardedValue = map['network']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PacketMirroringNetworkInfoComputeV1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
