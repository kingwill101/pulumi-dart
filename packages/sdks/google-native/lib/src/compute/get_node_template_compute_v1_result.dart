...
class GetNodeTemplateComputeV1Result {
  final List<AcceleratorConfigResponseComputeV1> accelerators;
  /// CPU overcommit.
  ...
  final List<LocalDiskResponseComputeV1> disks;
  ...
  final NodeTemplateNodeTypeFlexibilityResponseComputeV1 nodeTypeFlexibility;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'accelerators': pulumi.Input.encodeList<AcceleratorConfigResponseComputeV1, Map<String, dynamic>>(accelerators, (value) => value.toMap()),
      'cpuOvercommitType': cpuOvercommitType,
      'creationTimestamp': creationTimestamp,
      'description': description,
      'disks': pulumi.Input.encodeList<LocalDiskResponseComputeV1, Map<String, dynamic>>(disks, (value) => value.toMap()),
      'kind': kind,
      'name': name,
  ...
  factory GetNodeTemplateComputeV1Result.fromMap(Map<String, dynamic> map) {
    return GetNodeTemplateComputeV1Result(
      accelerators: pulumi.Input.decodeList<AcceleratorConfigResponseComputeV1>(map['accelerators']!, (value) => AcceleratorConfigResponseComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      cpuOvercommitType: map['cpuOvercommitType'] as String,
      creationTimestamp: map['creationTimestamp'] as String,
      description: map['description'] as String,
      disks: pulumi.Input.decodeList<LocalDiskResponseComputeV1>(map['disks']!, (value) => LocalDiskResponseComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      kind: map['kind'] as String,
      name: map['name'] as String,
      nodeAffinityLabels: (map['nodeAffinityLabels'] as Map).cast<String, String>(),
      nodeType: map['nodeType'] as String,
      nodeTypeFlexibility: NodeTemplateNodeTypeFlexibilityResponseComputeV1.fromMap((map['nodeTypeFlexibility']! as Map).cast<String, dynamic>()),
      region: map['region'] as String,
      selfLink: map['selfLink'] as String,
      serverBinding: ServerBindingResponseComputeV1.fromMap((map['serverBinding']! as Map).cast<String, dynamic>()),
