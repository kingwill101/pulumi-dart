...
class ConditionComputeV1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'iam': ?pulumi.Input.mapOptionalInputValue<ConditionIamComputeV1, String>(
        iam,
        (value) => value.wireValue,
      ),
      'op': ?pulumi.Input.mapOptionalInputValue<ConditionOpComputeV1, String>(
        op,
        (value) => value.wireValue,
      ),
      'svc': ?svc,
      'sys': ?pulumi.Input.mapOptionalInputValue<ConditionSysComputeV1, String>(
        sys,
        (value) => value.wireValue,
      ),
      'values': ?values,
    ...
    return ConditionComputeV1(
      iam: (() {
        ...
        return pulumi.Input.fromValue(
          ConditionIamComputeV1.fromValue(guardedValue as String),
        );
      })(),
      op: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ConditionOpComputeV1.fromValue(guardedValue as String),
        );
      })(),
      svc: (() {
      ...
      sys: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ConditionSysComputeV1.fromValue(guardedValue as String),
        );
      })(),
      values: (() {
