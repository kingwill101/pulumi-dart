...
class GetInstanceTemplateComputeV1Result {
  ...
  final InstancePropertiesResponseComputeV1 properties;
  ...
  final SourceInstanceParamsResponseComputeV1 sourceInstanceParams;

  /// Creates a new [GetInstanceTemplateComputeV1Result].
  ...
  factory GetInstanceTemplateComputeV1Result.fromMap(Map<String, dynamic> map) {
    return GetInstanceTemplateComputeV1Result(
      creationTimestamp: map['creationTimestamp'] as String,
      description: map['description'] as String,
      kind: map['kind'] as String,
      name: map['name'] as String,
      properties: InstancePropertiesResponseComputeV1.fromMap((map['properties'] as Map).cast<String, dynamic>()),
      region: map['region'] as String,
      selfLink: map['selfLink'] as String,
      sourceInstance: map['sourceInstance'] as String,
      sourceInstanceParams: SourceInstanceParamsResponseComputeV1.fromMap((map['sourceInstanceParams'] as Map).cast<String, dynamic>()),
    );
  }
}
