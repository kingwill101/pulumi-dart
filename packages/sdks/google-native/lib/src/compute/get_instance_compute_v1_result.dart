...
class GetInstanceComputeV1Result {
  ...
  final DisplayDeviceResponseComputeV1 displayDevice;
  ...
  final CustomerEncryptionKeyResponseComputeV1 instanceEncryptionKey;
  ...
  final InstanceParamsResponseComputeV1 params;
  ...
  final ResourceStatusResponseComputeV1 resourceStatus;
  ...
  final ShieldedInstanceIntegrityPolicyResponseComputeV1 shieldedInstanceIntegrityPolicy;
  /// Source machine image
  final String sourceMachineImage;
  /// Source machine image encryption key when creating an instance from a machine image.
  final CustomerEncryptionKeyResponseComputeV1 sourceMachineImageEncryptionKey;
  ...
  /// Creates a new [GetInstanceComputeV1Result].
  ...
  const GetInstanceComputeV1Result({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'disks': pulumi.Input.encodeList<AttachedDiskResponseComputeV1, Map<String, dynamic>>(disks, (value) => value.toMap()),
      ...
      'name': name,
      'networkInterfaces': pulumi.Input.encodeList<NetworkInterfaceResponseComputeV1, Map<String, dynamic>>(networkInterfaces, (value) => value.toMap()),
      ...
      'selfLink': selfLink,
      'serviceAccounts': pulumi.Input.encodeList<ServiceAccountResponseComputeV1, Map<String, dynamic>>(serviceAccounts, (value) => value.toMap()),
  ...
  factory GetInstanceComputeV1Result.fromMap(Map<String, dynamic> map) {
    return GetInstanceComputeV1Result(
      advancedMachineFeatures: AdvancedMachineFeaturesResponseComputeV1.fromMap((map['advancedMachineFeatures']! as Map).cast<String, dynamic>()),
      canIpForward: map['canIpForward'] as bool,
      confidentialInstanceConfig: ConfidentialInstanceConfigResponseComputeV1.fromMap((map['confidentialInstanceConfig']! as Map).cast<String, dynamic>()),
      cpuPlatform: map['cpuPlatform'] as String,
      creationTimestamp: map['creationTimestamp'] as String,
      deletionProtection: map['deletionProtection'] as bool,
      description: map['description'] as String,
      disks: pulumi.Input.decodeList<AttachedDiskResponseComputeV1>(map['disks']!, (value) => AttachedDiskResponseComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      displayDevice: DisplayDeviceResponseComputeV1.fromMap((map['displayDevice']! as Map).cast<String, dynamic>()),
      ...
      instanceEncryptionKey: CustomerEncryptionKeyResponseComputeV1.fromMap((map['instanceEncryptionKey']! as Map).cast<String, dynamic>()),
      ...
      metadata: MetadataResponseComputeV1.fromMap((map['metadata']! as Map).cast<String, dynamic>()),
      minCpuPlatform: map['minCpuPlatform'] as String,
      name: map['name'] as String,
      networkInterfaces: pulumi.Input.decodeList<NetworkInterfaceResponseComputeV1>(map['networkInterfaces']!, (value) => NetworkInterfaceResponseComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      networkPerformanceConfig: NetworkPerformanceConfigResponseComputeV1.fromMap((map['networkPerformanceConfig']! as Map).cast<String, dynamic>()),
      params: InstanceParamsResponseComputeV1.fromMap((map['params']! as Map).cast<String, dynamic>()),
      privateIpv6GoogleAccess: map['privateIpv6GoogleAccess'] as String,
      reservationAffinity: ReservationAffinityResponseComputeV1.fromMap((map['reservationAffinity']! as Map).cast<String, dynamic>()),
      resourcePolicies: (map['resourcePolicies'] as List).cast<String>(),
      resourceStatus: ResourceStatusResponseComputeV1.fromMap((map['resourceStatus']! as Map).cast<String, dynamic>()),
      satisfiesPzs: map['satisfiesPzs'] as bool,
      scheduling: SchedulingResponseComputeV1.fromMap((map['scheduling']! as Map).cast<String, dynamic>()),
      selfLink: map['selfLink'] as String,
      serviceAccounts: pulumi.Input.decodeList<ServiceAccountResponseComputeV1>(map['serviceAccounts']!, (value) => ServiceAccountResponseComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      shieldedInstanceConfig: ShieldedInstanceConfigResponseComputeV1.fromMap((map['shieldedInstanceConfig']! as Map).cast<String, dynamic>()),
      shieldedInstanceIntegrityPolicy: ShieldedInstanceIntegrityPolicyResponseComputeV1.fromMap((map['shieldedInstanceIntegrityPolicy']! as Map).cast<String, dynamic>()),
      sourceMachineImage: map['sourceMachineImage'] as String,
      sourceMachineImageEncryptionKey: CustomerEncryptionKeyResponseComputeV1.fromMap((map['sourceMachineImageEncryptionKey']! as Map).cast<String, dynamic>()),
      startRestricted: map['startRestricted'] as bool,
      status: map['status'] as String,
      statusMessage: map['statusMessage'] as String,
      tags: TagsResponseComputeV1.fromMap((map['tags']! as Map).cast<String, dynamic>()),
