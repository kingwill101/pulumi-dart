...
class RouterBgpPeerResponse {
  ...
  final pulumi.Input<List<RouterBgpPeerCustomLearnedIpRangeResponse>>
    ...
    return <String, dynamic>{
      ...
      'advertisedIpRanges':
          pulumi.Input.mapInputValue<
            List<RouterAdvertisedIpRangeResponse>,
      ...
      'customLearnedIpRanges':
          pulumi.Input.mapInputValue<
            List<RouterBgpPeerCustomLearnedIpRangeResponse>,
            List<Map<String, dynamic>>
          >(
            customLearnedIpRanges,
            (value) =>
  ...
  factory RouterBgpPeerResponse.fromMap(Map<String, dynamic> map) {
    return RouterBgpPeerResponse(
      ...
      bfd: pulumi.Input.fromValue(
        RouterBgpPeerBfdResponse.fromMap(
      ...
      exportPolicies: pulumi.Input.fromValue(
        (map['exportPolicies'] as List).cast<String>(),
      ),
      importPolicies: pulumi.Input.fromValue(
