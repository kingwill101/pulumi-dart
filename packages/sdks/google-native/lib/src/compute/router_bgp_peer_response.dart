...
class RouterBgpPeerResponse {
  ...
  factory RouterBgpPeerResponse.fromMap(Map<String, dynamic> map) {
    return RouterBgpPeerResponse(
      ...
      advertisedIpRanges: pulumi.Input.fromValue(pulumi.Input.decodeList<RouterAdvertisedIpRangeResponse>(map['advertisedIpRanges']!, (value) => RouterAdvertisedIpRangeResponse.fromMap((value as Map).cast<String, dynamic>()))),
      advertisedRoutePriority: pulumi.Input.fromValue(map['advertisedRoutePriority'] as int),
      bfd: pulumi.Input.fromValue(RouterBgpPeerBfdResponse.fromMap((map['bfd']! as Map).cast<String, dynamic>())),
      customLearnedIpRanges: pulumi.Input.fromValue(pulumi.Input.decodeList<RouterBgpPeerCustomLearnedIpRangeResponse>(map['customLearnedIpRanges']!, (value) => RouterBgpPeerCustomLearnedIpRangeResponse.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      exportPolicies: pulumi.Input.fromValue((map['exportPolicies'] as List).cast<String>()),
      importPolicies: pulumi.Input.fromValue((map['importPolicies'] as List).cast<String>()),
