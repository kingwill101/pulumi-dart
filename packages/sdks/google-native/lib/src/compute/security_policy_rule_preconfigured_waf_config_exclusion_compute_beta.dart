...
class SecurityPolicyRulePreconfiguredWafConfigExclusionComputeBeta {
  ...
  final pulumi.Input<List<SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParamsComputeBeta>>? requestCookiesToExclude;
  /// A list of request header names whose value will be excluded from inspection during preconfigured WAF evaluation.
  final pulumi.Input<List<SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParamsComputeBeta>>? requestHeadersToExclude;
  /// A list of request query parameter names whose value will be excluded from inspection during preconfigured WAF evaluation. Note that the parameter can be in the query string or in the POST body.
  final pulumi.Input<List<SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParamsComputeBeta>>? requestQueryParamsToExclude;
  /// A list of request URIs from the request line to be excluded from inspection during preconfigured WAF evaluation. When specifying this field, the query or fragment part should be excluded.
  final pulumi.Input<List<SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParamsComputeBeta>>? requestUrisToExclude;
  ...
  const SecurityPolicyRulePreconfiguredWafConfigExclusionComputeBeta({
  ...
  factory SecurityPolicyRulePreconfiguredWafConfigExclusionComputeBeta.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRulePreconfiguredWafConfigExclusionComputeBeta(
      requestCookiesToExclude: (() { final guardedValue = map['requestCookiesToExclude']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParamsComputeBeta>(guardedValue, (value) => SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParamsComputeBeta.fromMap((value as Map).cast<String, dynamic>()))); })(),
      requestHeadersToExclude: (() { final guardedValue = map['requestHeadersToExclude']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParamsComputeBeta>(guardedValue, (value) => SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParamsComputeBeta.fromMap((value as Map).cast<String, dynamic>()))); })(),
      requestQueryParamsToExclude: (() { final guardedValue = map['requestQueryParamsToExclude']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParamsComputeBeta>(guardedValue, (value) => SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParamsComputeBeta.fromMap((value as Map).cast<String, dynamic>()))); })(),
      requestUrisToExclude: (() { final guardedValue = map['requestUrisToExclude']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParamsComputeBeta>(guardedValue, (value) => SecurityPolicyRulePreconfiguredWafConfigExclusionFieldParamsComputeBeta.fromMap((value as Map).cast<String, dynamic>()))); })(),
