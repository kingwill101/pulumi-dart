...
class RouterBgpPeerResponseComputeV1 {
  ...
  factory RouterBgpPeerResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return RouterBgpPeerResponseComputeV1(
      ...
      advertisedIpRanges: (pulumi.Input.decodeList<RouterAdvertisedIpRangeResponseComputeV1>(map['advertisedIpRanges'], (value) => RouterAdvertisedIpRangeResponseComputeV1.fromMap((value as Map).cast<String, dynamic>()))).input(),
      advertisedRoutePriority: (map['advertisedRoutePriority'] as int).input(),
      bfd: (RouterBgpPeerBfdResponseComputeV1.fromMap((map['bfd'] as Map).cast<String, dynamic>())).input(),
      customLearnedIpRanges: (pulumi.Input.decodeList<RouterBgpPeerCustomLearnedIpRangeResponseComputeV1>(map['customLearnedIpRanges'], (value) => RouterBgpPeerCustomLearnedIpRangeResponseComputeV1.fromMap((value as Map).cast<String, dynamic>()))).input(),
