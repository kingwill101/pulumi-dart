...
class RouterBgpPeerResponseComputeV1 {
  ...
  final pulumi.Input<List<RouterAdvertisedIpRangeResponseComputeV1>>
  advertisedIpRanges;
  ...
  final pulumi.Input<List<RouterBgpPeerCustomLearnedIpRangeResponseComputeV1>>
    ...
    return <String, dynamic>{
      ...
      'advertisedIpRanges':
          pulumi.Input.mapInputValue<
            List<RouterAdvertisedIpRangeResponseComputeV1>,
      ...
      'bfd':
          pulumi.Input.mapInputValue<
            RouterBgpPeerBfdResponseComputeV1,
            Map<String, dynamic>
          >(bfd, (value) => value.toMap()),
      'customLearnedIpRanges':
          pulumi.Input.mapInputValue<
            List<RouterBgpPeerCustomLearnedIpRangeResponseComputeV1>,
            List<Map<String, dynamic>>
          >(
            customLearnedIpRanges,
            (value) =>
  ...
  factory RouterBgpPeerResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return RouterBgpPeerResponseComputeV1(
      ...
      advertisedIpRanges: pulumi.Input.fromValue(
        pulumi.Input.decodeList<RouterAdvertisedIpRangeResponseComputeV1>(
          map['advertisedIpRanges']!,
          (value) => RouterAdvertisedIpRangeResponseComputeV1.fromMap(
      ...
      bfd: pulumi.Input.fromValue(
        RouterBgpPeerBfdResponseComputeV1.fromMap(
          (map['bfd']! as Map).cast<String, dynamic>(),
        ),
      ),
      customLearnedIpRanges: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          RouterBgpPeerCustomLearnedIpRangeResponseComputeV1
        >(
          map['customLearnedIpRanges']!,
          (value) => RouterBgpPeerCustomLearnedIpRangeResponseComputeV1.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      customLearnedRoutePriority: pulumi.Input.fromValue(
      ...
      peerIpv6NexthopAddress: pulumi.Input.fromValue(
        map['peerIpv6NexthopAddress'] as String,
      ),
      routerApplianceInstance: pulumi.Input.fromValue(
