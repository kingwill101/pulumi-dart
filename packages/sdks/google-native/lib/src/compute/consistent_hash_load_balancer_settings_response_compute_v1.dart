...
class ConsistentHashLoadBalancerSettingsResponseComputeV1 {
  ...
  final pulumi.Input<ConsistentHashLoadBalancerSettingsHttpCookieResponseComputeV1> httpCookie;
  ...
  const ConsistentHashLoadBalancerSettingsResponseComputeV1({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'httpCookie': pulumi.Input.mapInputValue<ConsistentHashLoadBalancerSettingsHttpCookieResponseComputeV1, Map<String, dynamic>>(httpCookie, (value) => value.toMap()),
      'httpHeaderName': httpHeaderName,
      'minimumRingSize': minimumRingSize,
    };
  }

  factory ConsistentHashLoadBalancerSettingsResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return ConsistentHashLoadBalancerSettingsResponseComputeV1(
      httpCookie: pulumi.Input.fromValue(ConsistentHashLoadBalancerSettingsHttpCookieResponseComputeV1.fromMap((map['httpCookie']! as Map).cast<String, dynamic>())),
