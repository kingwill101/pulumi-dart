...
class ConsistentHashLoadBalancerSettingsResponseComputeV1 {
  ...
  final ConsistentHashLoadBalancerSettingsHttpCookieResponseComputeV1 httpCookie;
  ...
  factory ConsistentHashLoadBalancerSettingsResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return ConsistentHashLoadBalancerSettingsResponseComputeV1(
      httpCookie: ConsistentHashLoadBalancerSettingsHttpCookieResponseComputeV1.fromMap((map['httpCookie'] as Map).cast<String, dynamic>()),
