...
class RouterNatRuleResponseComputeBeta {
  ...
  const RouterNatRuleResponseComputeBeta({
  ...
  factory RouterNatRuleResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return RouterNatRuleResponseComputeBeta(
      action: pulumi.Input.fromValue(RouterNatRuleActionResponseComputeBeta.fromMap((map['action']! as Map).cast<String, dynamic>())),
