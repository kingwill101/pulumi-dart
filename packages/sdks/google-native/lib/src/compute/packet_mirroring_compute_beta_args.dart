...
class PacketMirroringComputeBetaArgs {
  ...
  factory PacketMirroringComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return PacketMirroringComputeBetaArgs(
      collectorIlb: map['collectorIlb'] == null ? null : (PacketMirroringForwardingRuleInfoComputeBeta.fromMap((map['collectorIlb']! as Map).cast<String, dynamic>())).input(),
      description: map['description'] == null ? null : (map['description']! as String).input(),
      enable: map['enable'] == null ? null : (PacketMirroringEnableComputeBeta.fromValue(map['enable']! as String)).input(),
      filter: map['filter'] == null ? null : (PacketMirroringFilterComputeBeta.fromMap((map['filter']! as Map).cast<String, dynamic>())).input(),
      mirroredResources: map['mirroredResources'] == null ? null : (PacketMirroringMirroredResourceInfoComputeBeta.fromMap((map['mirroredResources']! as Map).cast<String, dynamic>())).input(),
      name: map['name'] == null ? null : (map['name']! as String).input(),
      network: map['network'] == null ? null : (PacketMirroringNetworkInfoComputeBeta.fromMap((map['network']! as Map).cast<String, dynamic>())).input(),
