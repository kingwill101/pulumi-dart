...
class PacketMirroringComputeBetaArgs {
  ...
  PacketMirroringComputeBetaArgs({
    pulumi.Output<PacketMirroringForwardingRuleInfoComputeBeta>? collectorIlb,
    pulumi.Output<String>? description,
    pulumi.Output<PacketMirroringEnableComputeBeta>? enable,
    pulumi.Output<PacketMirroringFilterComputeBeta>? filter,
    pulumi.Output<PacketMirroringMirroredResourceInfoComputeBeta>? mirroredResources,
    pulumi.Output<String>? name,
    pulumi.Output<PacketMirroringNetworkInfoComputeBeta>? network,
    pulumi.Output<int>? priority,
    pulumi.Output<String>? project,
    required pulumi.Output<String> region,
    pulumi.Output<String>? requestId,
  }) :
      collectorIlb = pulumi.Input.asOptionalInput<PacketMirroringForwardingRuleInfoComputeBeta>(collectorIlb),
      description = pulumi.Input.asOptionalInput<String>(description),
      enable = pulumi.Input.asOptionalInput<PacketMirroringEnableComputeBeta>(enable),
      filter = pulumi.Input.asOptionalInput<PacketMirroringFilterComputeBeta>(filter),
      mirroredResources = pulumi.Input.asOptionalInput<PacketMirroringMirroredResourceInfoComputeBeta>(mirroredResources),
      name = pulumi.Input.asOptionalInput<String>(name),
      network = pulumi.Input.asOptionalInput<PacketMirroringNetworkInfoComputeBeta>(network),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'enable': ?pulumi.Input.mapOptionalInputValue<PacketMirroringEnableComputeBeta, String>(enable, (value) => value.value),
  ...
  factory PacketMirroringComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return PacketMirroringComputeBetaArgs(
      collectorIlb: map['collectorIlb'] == null ? null : pulumi.Output.create<PacketMirroringForwardingRuleInfoComputeBeta>(PacketMirroringForwardingRuleInfoComputeBeta.fromMap((map['collectorIlb'] as Map).cast<String, dynamic>())),
      description: map['description'] == null ? null : pulumi.Output.create<String>(map['description'] as String),
      enable: map['enable'] == null ? null : pulumi.Output.create<PacketMirroringEnableComputeBeta>(PacketMirroringEnableComputeBeta.fromValue(map['enable'] as String)),
      filter: map['filter'] == null ? null : pulumi.Output.create<PacketMirroringFilterComputeBeta>(PacketMirroringFilterComputeBeta.fromMap((map['filter'] as Map).cast<String, dynamic>())),
      mirroredResources: map['mirroredResources'] == null ? null : pulumi.Output.create<PacketMirroringMirroredResourceInfoComputeBeta>(PacketMirroringMirroredResourceInfoComputeBeta.fromMap((map['mirroredResources'] as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      network: map['network'] == null ? null : pulumi.Output.create<PacketMirroringNetworkInfoComputeBeta>(PacketMirroringNetworkInfoComputeBeta.fromMap((map['network'] as Map).cast<String, dynamic>())),
