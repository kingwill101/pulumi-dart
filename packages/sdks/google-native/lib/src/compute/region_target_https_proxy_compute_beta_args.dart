...
class RegionTargetHttpsProxyComputeBetaArgs {
  ...
  RegionTargetHttpsProxyComputeBetaArgs({
    ...
    pulumi.Output<RegionTargetHttpsProxyQuicOverrideComputeBeta>? quicOverride,
  ...
  factory RegionTargetHttpsProxyComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return RegionTargetHttpsProxyComputeBetaArgs(
      ...
      quicOverride: map['quicOverride'] == null ? null : pulumi.Output.create<RegionTargetHttpsProxyQuicOverrideComputeBeta>(RegionTargetHttpsProxyQuicOverrideComputeBeta.fromValue(map['quicOverride'] as String)),
