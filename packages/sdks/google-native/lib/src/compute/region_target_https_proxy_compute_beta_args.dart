...
class RegionTargetHttpsProxyComputeBetaArgs {
  ...
  const RegionTargetHttpsProxyComputeBetaArgs({
    this.authentication,
    this.authorization,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'project': ?project,
      'proxyBind': ?proxyBind,
      'quicOverride': ?pulumi.Input.mapOptionalInputValue<RegionTargetHttpsProxyQuicOverrideComputeBeta, String>(quicOverride, (value) => value.wireValue),
      'region': region,
      'requestId': ?requestId,
  ...
  factory RegionTargetHttpsProxyComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return RegionTargetHttpsProxyComputeBetaArgs(
      ...
      quicOverride: (() { final guardedValue = map['quicOverride']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionTargetHttpsProxyQuicOverrideComputeBeta.fromValue(guardedValue as String)); })(),
