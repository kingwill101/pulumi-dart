    ...
    return ImageComputeV1Args(
      architecture: (() {
        ...
        return pulumi.Input.fromValue(
          ImageArchitectureComputeV1.fromValue(guardedValue as String),
        );
      })(),
      archiveSizeBytes: (() {
      ...
      deprecated: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DeprecationStatusComputeV1.fromMap(
      ...
      shieldedInstanceInitialState: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          InitialStateConfigComputeV1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      sourceType: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ImageSourceTypeComputeV1.fromValue(guardedValue as String),
        );
      })(),
      storageLocations: (() {
