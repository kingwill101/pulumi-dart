...
class ImageComputeV1Args {
  ...
  factory ImageComputeV1Args.fromMap(Map<String, dynamic> map) {
    return ImageComputeV1Args(
      architecture: map['architecture'] == null ? null : (ImageArchitectureComputeV1.fromValue(map['architecture'] as String)).input(),
      archiveSizeBytes: map['archiveSizeBytes'] == null ? null : (map['archiveSizeBytes'] as String).input(),
      deprecated: map['deprecated'] == null ? null : (DeprecationStatusComputeV1.fromMap((map['deprecated'] as Map).cast<String, dynamic>())).input(),
      ...
      imageEncryptionKey: map['imageEncryptionKey'] == null ? null : (CustomerEncryptionKeyComputeV1.fromMap((map['imageEncryptionKey'] as Map).cast<String, dynamic>())).input(),
      ...
      rawDisk: map['rawDisk'] == null ? null : (ImageRawDiskComputeV1.fromMap((map['rawDisk'] as Map).cast<String, dynamic>())).input(),
      requestId: map['requestId'] == null ? null : (map['requestId'] as String).input(),
      shieldedInstanceInitialState: map['shieldedInstanceInitialState'] == null ? null : (InitialStateConfigComputeV1.fromMap((map['shieldedInstanceInitialState'] as Map).cast<String, dynamic>())).input(),
      ...
      sourceImageEncryptionKey: map['sourceImageEncryptionKey'] == null ? null : (CustomerEncryptionKeyComputeV1.fromMap((map['sourceImageEncryptionKey'] as Map).cast<String, dynamic>())).input(),
      sourceSnapshot: map['sourceSnapshot'] == null ? null : (map['sourceSnapshot'] as String).input(),
      sourceSnapshotEncryptionKey: map['sourceSnapshotEncryptionKey'] == null ? null : (CustomerEncryptionKeyComputeV1.fromMap((map['sourceSnapshotEncryptionKey'] as Map).cast<String, dynamic>())).input(),
      sourceType: map['sourceType'] == null ? null : (ImageSourceTypeComputeV1.fromValue(map['sourceType'] as String)).input(),
