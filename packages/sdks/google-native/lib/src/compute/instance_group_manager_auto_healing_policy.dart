...
class InstanceGroupManagerAutoHealingPolicy {
  ...
  const InstanceGroupManagerAutoHealingPolicy({
  ...
  factory InstanceGroupManagerAutoHealingPolicy.fromMap(Map<String, dynamic> map) {
    return InstanceGroupManagerAutoHealingPolicy(
      autoHealingTriggers: (() { final guardedValue = map['autoHealingTriggers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceGroupManagerAutoHealingPolicyAutoHealingTriggers.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      maxUnavailable: (() { final guardedValue = map['maxUnavailable']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FixedOrPercent.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
