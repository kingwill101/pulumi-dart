...
/// {@template pulumi_compute_beta_service_attachment_iam_binding_compute_beta_args_doc}
/// The set of arguments for ServiceAttachmentIamBinding.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_service_attachment_iam_binding_compute_beta_args_doc}
class ServiceAttachmentIamBindingComputeBetaArgs {
  ...
  /// Creates a new [ServiceAttachmentIamBindingComputeBetaArgs].
  ...
  const ServiceAttachmentIamBindingComputeBetaArgs({
    this.condition,
  ...
  factory ServiceAttachmentIamBindingComputeBetaArgs.fromMap(Map<String, dynamic> map) {
