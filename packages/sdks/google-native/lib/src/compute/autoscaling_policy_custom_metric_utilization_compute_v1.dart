...
class AutoscalingPolicyCustomMetricUtilizationComputeV1 {
  ...
  final AutoscalingPolicyCustomMetricUtilizationUtilizationTargetTypeComputeV1? utilizationTargetType;
  ...
  factory AutoscalingPolicyCustomMetricUtilizationComputeV1.fromMap(Map<String, dynamic> map) {
    return AutoscalingPolicyCustomMetricUtilizationComputeV1(
      ...
      utilizationTargetType: map['utilizationTargetType'] == null ? null : AutoscalingPolicyCustomMetricUtilizationUtilizationTargetTypeComputeV1.fromValue(map['utilizationTargetType'] as String),
    );
  }
}
