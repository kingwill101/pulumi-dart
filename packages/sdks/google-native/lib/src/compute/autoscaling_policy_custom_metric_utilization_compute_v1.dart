...
import 'autoscaling_policy_custom_metric_utilization_utilization_target_type_compute_v1.dart';

/// Custom utilization metric policy.
class AutoscalingPolicyCustomMetricUtilizationComputeV1 {
  ...
  final pulumi.Input<AutoscalingPolicyCustomMetricUtilizationUtilizationTargetTypeComputeV1>? utilizationTargetType;

  /// Creates a new [AutoscalingPolicyCustomMetricUtilizationComputeV1].
  ...
  const AutoscalingPolicyCustomMetricUtilizationComputeV1({
    this.filter,
    this.metric,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'utilizationTargetType': ?pulumi.Input.mapOptionalInputValue<AutoscalingPolicyCustomMetricUtilizationUtilizationTargetTypeComputeV1, String>(utilizationTargetType, (value) => value.wireValue),
    };
  }
  ...
  factory AutoscalingPolicyCustomMetricUtilizationComputeV1.fromMap(Map<String, dynamic> map) {
    return AutoscalingPolicyCustomMetricUtilizationComputeV1(
      ...
      utilizationTargetType: (() { final guardedValue = map['utilizationTargetType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AutoscalingPolicyCustomMetricUtilizationUtilizationTargetTypeComputeV1.fromValue(guardedValue as String)); })(),
    );
  }
}
