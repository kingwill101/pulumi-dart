...
class AutoscalingPolicyCustomMetricUtilizationComputeV1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'utilizationTargetType': ?pulumi.Input.mapOptionalInputValue<AutoscalingPolicyCustomMetricUtilizationUtilizationTargetTypeComputeV1, String>(utilizationTargetType, (value) => value.value),
    };
  }
