...
class SecurityPolicyAdaptiveProtectionConfigLayer7DdosDefenseConfigResponseComputeV1 {
  ...
  final pulumi.Input<List<SecurityPolicyAdaptiveProtectionConfigLayer7DdosDefenseConfigThresholdConfigResponseComputeV1>> thresholdConfigs;
  ...
  const SecurityPolicyAdaptiveProtectionConfigLayer7DdosDefenseConfigResponseComputeV1({
  ...
  factory SecurityPolicyAdaptiveProtectionConfigLayer7DdosDefenseConfigResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyAdaptiveProtectionConfigLayer7DdosDefenseConfigResponseComputeV1(
      ...
      thresholdConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<SecurityPolicyAdaptiveProtectionConfigLayer7DdosDefenseConfigThresholdConfigResponseComputeV1>(map['thresholdConfigs']!, (value) => SecurityPolicyAdaptiveProtectionConfigLayer7DdosDefenseConfigThresholdConfigResponseComputeV1.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
