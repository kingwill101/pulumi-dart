...
class LicenseArgs {
  ...
  factory LicenseArgs.fromMap(Map<String, dynamic> map) {
    return LicenseArgs(
      ...
      resourceRequirements: (() { final guardedValue = map['resourceRequirements']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LicenseResourceRequirements.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
