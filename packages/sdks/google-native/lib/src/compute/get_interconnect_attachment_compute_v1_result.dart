...
class GetInterconnectAttachmentComputeV1Result {
  ...
  final InterconnectAttachmentConfigurationConstraintsResponseComputeV1 configurationConstraints;
  ...
  final InterconnectAttachmentPrivateInfoResponseComputeV1 privateInterconnectInfo;
  ...
  const GetInterconnectAttachmentComputeV1Result({
  ...
  factory GetInterconnectAttachmentComputeV1Result.fromMap(Map<String, dynamic> map) {
    return GetInterconnectAttachmentComputeV1Result(
      ...
      configurationConstraints: InterconnectAttachmentConfigurationConstraintsResponseComputeV1.fromMap((map['configurationConstraints']! as Map).cast<String, dynamic>()),
      ...
      partnerMetadata: InterconnectAttachmentPartnerMetadataResponseComputeV1.fromMap((map['partnerMetadata']! as Map).cast<String, dynamic>()),
      privateInterconnectInfo: InterconnectAttachmentPrivateInfoResponseComputeV1.fromMap((map['privateInterconnectInfo']! as Map).cast<String, dynamic>()),
