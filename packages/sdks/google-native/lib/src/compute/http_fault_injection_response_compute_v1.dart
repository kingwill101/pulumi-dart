...
class HttpFaultInjectionResponseComputeV1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'abort': pulumi.Input.mapInputValue<HttpFaultAbortResponseComputeV1, Map<String, dynamic>>(abort, (value) => value.toMap()),
      'delay': pulumi.Input.mapInputValue<HttpFaultDelayResponseComputeV1, Map<String, dynamic>>(delay, (value) => value.toMap()),
    };
  }

  factory HttpFaultInjectionResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return HttpFaultInjectionResponseComputeV1(
      abort: pulumi.Input.fromValue(HttpFaultAbortResponseComputeV1.fromMap((map['abort']! as Map).cast<String, dynamic>())),
      delay: pulumi.Input.fromValue(HttpFaultDelayResponseComputeV1.fromMap((map['delay']! as Map).cast<String, dynamic>())),
    );
  }
}
