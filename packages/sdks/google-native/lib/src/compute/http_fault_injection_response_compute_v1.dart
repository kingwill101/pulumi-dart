...
class HttpFaultInjectionResponseComputeV1 {
  ...
  factory HttpFaultInjectionResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return HttpFaultInjectionResponseComputeV1(
      abort: (HttpFaultAbortResponseComputeV1.fromMap((map['abort'] as Map).cast<String, dynamic>())).input(),
      delay: (HttpFaultDelayResponseComputeV1.fromMap((map['delay'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
