...
class RegionHealthCheckServiceComputeBeta extends pulumi.CustomResource {
  ...
  RegionHealthCheckServiceComputeBeta(
    ...
    healthStatusAggregationPolicy = registerOutput<String>(
      'healthStatusAggregationPolicy',
    );
    healthStatusAggregationStrategy = registerOutput<String>(
      'healthStatusAggregationStrategy',
    );
    kind = registerOutput<String>('kind');
    this.name = registerOutput<String>('name');
    networkEndpointGroups = registerOutput<List<String>>(
      'networkEndpointGroups',
    );
    notificationEndpoints = registerOutput<List<String>>(
