...
class RegionDiskComputeV1Args {
  ...
  factory RegionDiskComputeV1Args.fromMap(Map<String, dynamic> map) {
    return RegionDiskComputeV1Args(
      architecture: map['architecture'] == null ? null : (RegionDiskArchitectureComputeV1.fromValue(map['architecture']! as String)).input(),
      asyncPrimaryDisk: map['asyncPrimaryDisk'] == null ? null : (DiskAsyncReplicationComputeV1.fromMap((map['asyncPrimaryDisk']! as Map).cast<String, dynamic>())).input(),
      ...
      params: map['params'] == null ? null : (DiskParamsComputeV1.fromMap((map['params']! as Map).cast<String, dynamic>())).input(),
