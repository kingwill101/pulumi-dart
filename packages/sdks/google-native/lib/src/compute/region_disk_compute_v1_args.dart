...
class RegionDiskComputeV1Args {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'architecture': ?pulumi.Input.mapOptionalInputValue<RegionDiskArchitectureComputeV1, String>(architecture, (value) => value.wireValue),
  ...
  factory RegionDiskComputeV1Args.fromMap(Map<String, dynamic> map) {
    return RegionDiskComputeV1Args(
      architecture: (() { final guardedValue = map['architecture']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionDiskArchitectureComputeV1.fromValue(guardedValue as String)); })(),
      asyncPrimaryDisk: (() { final guardedValue = map['asyncPrimaryDisk']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DiskAsyncReplicationComputeV1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      params: (() { final guardedValue = map['params']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DiskParamsComputeV1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
