...
class RegionDiskComputeV1Args {
  ...
  RegionDiskComputeV1Args({
    pulumi.Output<RegionDiskArchitectureComputeV1>? architecture,
    pulumi.Output<DiskAsyncReplicationComputeV1>? asyncPrimaryDisk,
    pulumi.Output<String>? description,
    pulumi.Output<CustomerEncryptionKeyComputeV1>? diskEncryptionKey,
    ...
    pulumi.Output<DiskParamsComputeV1>? params,
    ...
    pulumi.Output<String>? type,
      ...
      architecture = pulumi.Input.asOptionalInput<RegionDiskArchitectureComputeV1>(architecture),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'architecture': ?pulumi.Input.mapOptionalInputValue<RegionDiskArchitectureComputeV1, String>(architecture, (value) => value.value),
  ...
  factory RegionDiskComputeV1Args.fromMap(Map<String, dynamic> map) {
    return RegionDiskComputeV1Args(
      architecture: map['architecture'] == null ? null : pulumi.Output.create<RegionDiskArchitectureComputeV1>(RegionDiskArchitectureComputeV1.fromValue(map['architecture'] as String)),
      asyncPrimaryDisk: map['asyncPrimaryDisk'] == null ? null : pulumi.Output.create<DiskAsyncReplicationComputeV1>(DiskAsyncReplicationComputeV1.fromMap((map['asyncPrimaryDisk'] as Map).cast<String, dynamic>())),
      description: map['description'] == null ? null : pulumi.Output.create<String>(map['description'] as String),
      diskEncryptionKey: map['diskEncryptionKey'] == null ? null : pulumi.Output.create<CustomerEncryptionKeyComputeV1>(CustomerEncryptionKeyComputeV1.fromMap((map['diskEncryptionKey'] as Map).cast<String, dynamic>())),
      ...
      params: map['params'] == null ? null : pulumi.Output.create<DiskParamsComputeV1>(DiskParamsComputeV1.fromMap((map['params'] as Map).cast<String, dynamic>())),
