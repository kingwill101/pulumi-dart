...
class NetworkEndpointGroupComputeBetaArgs {
  ...
  NetworkEndpointGroupComputeBetaArgs({
    ...
    pulumi.Output<NetworkEndpointGroupNetworkEndpointTypeComputeBeta>? networkEndpointType,
    ...
    pulumi.Output<String>? zone,
      ...
      networkEndpointType = pulumi.Input.asOptionalInput<NetworkEndpointGroupNetworkEndpointTypeComputeBeta>(networkEndpointType),
  ...
  factory NetworkEndpointGroupComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return NetworkEndpointGroupComputeBetaArgs(
      ...
      networkEndpointType: map['networkEndpointType'] == null ? null : pulumi.Output.create<NetworkEndpointGroupNetworkEndpointTypeComputeBeta>(NetworkEndpointGroupNetworkEndpointTypeComputeBeta.fromValue(map['networkEndpointType'] as String)),
