...
class NetworkEndpointGroupComputeBetaArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'network': ?network,
      'networkEndpointType': ?pulumi.Input.mapOptionalInputValue<NetworkEndpointGroupNetworkEndpointTypeComputeBeta, String>(networkEndpointType, (value) => value.wireValue),
      'project': ?project,
      'pscData': ?pscData,
  ...
  factory NetworkEndpointGroupComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return NetworkEndpointGroupComputeBetaArgs(
      ...
      networkEndpointType: (() { final guardedValue = map['networkEndpointType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkEndpointGroupNetworkEndpointTypeComputeBeta.fromValue(guardedValue as String)); })(),
