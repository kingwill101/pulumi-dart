...
class BackendServiceLocalityLoadBalancingPolicyConfigCustomPolicyResponseComputeBeta {
  ...
  /// Creates a new [BackendServiceLocalityLoadBalancingPolicyConfigCustomPolicyResponseComputeBeta].
  ...
  const BackendServiceLocalityLoadBalancingPolicyConfigCustomPolicyResponseComputeBeta({
    required this.data,
    required this.name,
  });
