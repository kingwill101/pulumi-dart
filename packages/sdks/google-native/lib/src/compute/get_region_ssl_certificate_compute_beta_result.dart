...
class GetRegionSslCertificateComputeBetaResult {
  ...
  /// Creates a new [GetRegionSslCertificateComputeBetaResult].
  ...
  factory GetRegionSslCertificateComputeBetaResult.fromMap(Map<String, dynamic> map) {
    return GetRegionSslCertificateComputeBetaResult(
      certificate: map['certificate'] as String,
      creationTimestamp: map['creationTimestamp'] as String,
      description: map['description'] as String,
      expireTime: map['expireTime'] as String,
      kind: map['kind'] as String,
      managed: SslCertificateManagedSslCertificateResponseComputeBeta.fromMap((map['managed']! as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      privateKey: map['privateKey'] as String,
      region: map['region'] as String,
      selfLink: map['selfLink'] as String,
      selfManaged: SslCertificateSelfManagedSslCertificateResponseComputeBeta.fromMap((map['selfManaged']! as Map).cast<String, dynamic>()),
