...
class BackendServiceComputeV1Args {
  ...
  /// [usedBy] Optional.
  const BackendServiceComputeV1Args({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'compressionMode': ?pulumi.Input.mapOptionalInputValue<BackendServiceCompressionModeComputeV1, String>(compressionMode, (value) => value.wireValue),
      ...
      'loadBalancingScheme': ?pulumi.Input.mapOptionalInputValue<BackendServiceLoadBalancingSchemeComputeV1, String>(loadBalancingScheme, (value) => value.wireValue),
      ...
      'localityLbPolicy': ?pulumi.Input.mapOptionalInputValue<BackendServiceLocalityLbPolicyComputeV1, String>(localityLbPolicy, (value) => value.wireValue),
      ...
      'portName': ?portName,
      'project': ?project,
      'protocol': ?pulumi.Input.mapOptionalInputValue<BackendServiceProtocolComputeV1, String>(protocol, (value) => value.wireValue),
      'requestId': ?requestId,
      ...
      'sessionAffinity': ?pulumi.Input.mapOptionalInputValue<BackendServiceSessionAffinityComputeV1, String>(sessionAffinity, (value) => value.wireValue),
  ...
  factory BackendServiceComputeV1Args.fromMap(Map<String, dynamic> map) {
    return BackendServiceComputeV1Args(
      ...
      compressionMode: (() { final guardedValue = map['compressionMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BackendServiceCompressionModeComputeV1.fromValue(guardedValue as String)); })(),
      ...
      loadBalancingScheme: (() { final guardedValue = map['loadBalancingScheme']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BackendServiceLoadBalancingSchemeComputeV1.fromValue(guardedValue as String)); })(),
      ...
      localityLbPolicy: (() { final guardedValue = map['localityLbPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BackendServiceLocalityLbPolicyComputeV1.fromValue(guardedValue as String)); })(),
      ...
      protocol: (() { final guardedValue = map['protocol']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BackendServiceProtocolComputeV1.fromValue(guardedValue as String)); })(),
      ...
      sessionAffinity: (() { final guardedValue = map['sessionAffinity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BackendServiceSessionAffinityComputeV1.fromValue(guardedValue as String)); })(),
