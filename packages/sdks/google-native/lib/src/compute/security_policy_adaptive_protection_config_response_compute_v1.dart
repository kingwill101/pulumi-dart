...
class SecurityPolicyAdaptiveProtectionConfigResponseComputeV1 {
  ...
  factory SecurityPolicyAdaptiveProtectionConfigResponseComputeV1.fromMap(
    Map<String, dynamic> map,
  ) {
    return SecurityPolicyAdaptiveProtectionConfigResponseComputeV1(
      layer7DdosDefenseConfig: pulumi.Input.fromValue(
        SecurityPolicyAdaptiveProtectionConfigLayer7DdosDefenseConfigResponseComputeV1.fromMap(
