...
/// {@template pulumi_compute_beta_region_network_firewall_policy_iam_member_compute_beta_args_doc}
/// The set of arguments for RegionNetworkFirewallPolicyIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_region_network_firewall_policy_iam_member_compute_beta_args_doc}
class RegionNetworkFirewallPolicyIamMemberComputeBetaArgs {
  ...
  /// Creates a new [RegionNetworkFirewallPolicyIamMemberComputeBetaArgs].
  ...
  const RegionNetworkFirewallPolicyIamMemberComputeBetaArgs({
    this.condition,
  ...
  factory RegionNetworkFirewallPolicyIamMemberComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return RegionNetworkFirewallPolicyIamMemberComputeBetaArgs(
