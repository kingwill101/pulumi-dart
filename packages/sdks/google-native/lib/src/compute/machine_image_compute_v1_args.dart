...
class MachineImageComputeV1Args {
  ...
  const MachineImageComputeV1Args({
    this.description,
    this.guestFlush,
  ...
  factory MachineImageComputeV1Args.fromMap(Map<String, dynamic> map) {
    return MachineImageComputeV1Args(
      ...
      machineImageEncryptionKey: (() { final guardedValue = map['machineImageEncryptionKey']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CustomerEncryptionKeyComputeV1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      project: (() { final guardedValue = map['project']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      requestId: (() { final guardedValue = map['requestId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      savedDisks: (() { final guardedValue = map['savedDisks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SavedDiskComputeV1>(guardedValue, (value) => SavedDiskComputeV1.fromMap((value as Map).cast<String, dynamic>()))); })(),
      sourceDiskEncryptionKeys: (() { final guardedValue = map['sourceDiskEncryptionKeys']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SourceDiskEncryptionKeyComputeV1>(guardedValue, (value) => SourceDiskEncryptionKeyComputeV1.fromMap((value as Map).cast<String, dynamic>()))); })(),
