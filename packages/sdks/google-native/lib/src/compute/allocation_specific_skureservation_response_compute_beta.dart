...
class AllocationSpecificSKUReservationResponseComputeBeta {
  ...
  const AllocationSpecificSKUReservationResponseComputeBeta({
  ...
  factory AllocationSpecificSKUReservationResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return AllocationSpecificSKUReservationResponseComputeBeta(
      ...
      instanceProperties: pulumi.Input.fromValue(AllocationSpecificSKUAllocationReservedInstancePropertiesResponseComputeBeta.fromMap((map['instanceProperties']! as Map).cast<String, dynamic>())),
