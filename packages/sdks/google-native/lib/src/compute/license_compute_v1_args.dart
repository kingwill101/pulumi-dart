...
class LicenseComputeV1Args {
  ...
  final pulumi.Input<LicenseResourceRequirementsComputeV1>? resourceRequirements;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'project': ?project,
      'requestId': ?requestId,
      'resourceRequirements': ?pulumi.Input.mapOptionalInputValue<LicenseResourceRequirementsComputeV1, Map<String, dynamic>>(resourceRequirements, (value) => value.toMap()),
  ...
  factory LicenseComputeV1Args.fromMap(Map<String, dynamic> map) {
    return LicenseComputeV1Args(
      ...
      resourceRequirements: (() { final guardedValue = map['resourceRequirements']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LicenseResourceRequirementsComputeV1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
