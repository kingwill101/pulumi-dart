...
class InterconnectAttachmentComputeBeta extends pulumi.CustomResource {
  ...
  late final pulumi.Output<InterconnectAttachmentConfigurationConstraintsResponseComputeBeta> configurationConstraints;
  ...
  late final pulumi.Output<InterconnectAttachmentPartnerMetadataResponseComputeBeta> partnerMetadata;
  ...
  late final pulumi.Output<InterconnectAttachmentPrivateInfoResponseComputeBeta> privateInterconnectInfo;
  ...
  InterconnectAttachmentComputeBeta(
    ...
    configurationConstraints = registerOutput<InterconnectAttachmentConfigurationConstraintsResponseComputeBeta>('configurationConstraints', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return InterconnectAttachmentConfigurationConstraintsResponseComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    partnerMetadata = registerOutput<InterconnectAttachmentPartnerMetadataResponseComputeBeta>('partnerMetadata', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return InterconnectAttachmentPartnerMetadataResponseComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    privateInterconnectInfo = registerOutput<InterconnectAttachmentPrivateInfoResponseComputeBeta>('privateInterconnectInfo', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return InterconnectAttachmentPrivateInfoResponseComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>()); });
