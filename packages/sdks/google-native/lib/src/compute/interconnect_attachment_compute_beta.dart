...
class InterconnectAttachmentComputeBeta extends pulumi.CustomResource {
  ...
  InterconnectAttachmentComputeBeta(
    ...
    cloudRouterIpv6InterfaceId = registerOutput<String>(
    ...
    configurationConstraints =
        ...
        >(
          ...
          decoder: (raw) {
            ...
            return InterconnectAttachmentConfigurationConstraintsResponseComputeBeta.fromMap(
    ...
    customerRouterIpv6InterfaceId = registerOutput<String>(
    ...
    ipsecInternalAddresses = registerOutput<List<String>>(
    ...
    partnerMetadata =
        ...
        >(
          ...
          decoder: (raw) {
            final guardedValue = raw;
            if (guardedValue == null) return null;
            return InterconnectAttachmentPartnerMetadataResponseComputeBeta.fromMap(
              (guardedValue as Map).cast<String, dynamic>(),
            );
          },
        );
    privateInterconnectInfo =
        registerOutput<InterconnectAttachmentPrivateInfoResponseComputeBeta>(
          ...
          decoder: (raw) {
            final guardedValue = raw;
            if (guardedValue == null) return null;
            return InterconnectAttachmentPrivateInfoResponseComputeBeta.fromMap(
              (guardedValue as Map).cast<String, dynamic>(),
            );
          },
        );
