...
class InterconnectAttachmentComputeBeta extends pulumi.CustomResource {
  ...
  InterconnectAttachmentComputeBeta(
    ...
    this.configurationConstraints = registerOutput<InterconnectAttachmentConfigurationConstraintsResponseComputeBeta>('configurationConstraints');
    ...
    this.partnerMetadata = registerOutput<InterconnectAttachmentPartnerMetadataResponseComputeBeta>('partnerMetadata');
    this.privateInterconnectInfo = registerOutput<InterconnectAttachmentPrivateInfoResponseComputeBeta>('privateInterconnectInfo');
