...
class Scheduling {
  ...
  final pulumi.Input<SchedulingInstanceTerminationAction>?
  ...
  factory Scheduling.fromMap(Map<String, dynamic> map) {
    return Scheduling(
      ...
      currentCpus: (() {
        final guardedValue = map['currentCpus'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      currentMemoryMb: (() {
        final guardedValue = map['currentMemoryMb'];
        if (guardedValue == null) return null;
      ...
      instanceTerminationAction: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SchedulingInstanceTerminationAction.fromValue(guardedValue as String),
        );
      })(),
      latencyTolerant: (() {
        final guardedValue = map['latencyTolerant'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      localSsdRecoveryTimeout: (() {
      ...
      maintenanceInterval: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SchedulingMaintenanceInterval.fromValue(guardedValue as String),
        );
      })(),
      maxRunDuration: (() {
      ...
      onHostMaintenance: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SchedulingOnHostMaintenance.fromValue(guardedValue as String),
        );
      })(),
      preemptible: (() {
      ...
      provisioningModel: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SchedulingProvisioningModel.fromValue(guardedValue as String),
        );
      })(),
      terminationTime: (() {
