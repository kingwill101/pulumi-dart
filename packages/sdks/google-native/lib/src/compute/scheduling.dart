...
class Scheduling {
  ...
  factory Scheduling.fromMap(Map<String, dynamic> map) {
    return Scheduling(
      ...
      currentCpus: map['currentCpus'] == null ? null : map['currentCpus'] as int,
      currentMemoryMb: map['currentMemoryMb'] == null ? null : map['currentMemoryMb'] as String,
      gracefulShutdown: map['gracefulShutdown'] == null ? null : SchedulingGracefulShutdown.fromMap((map['gracefulShutdown'] as Map).cast<String, dynamic>()),
      hostErrorTimeoutSeconds: map['hostErrorTimeoutSeconds'] == null ? null : map['hostErrorTimeoutSeconds'] as int,
      instanceTerminationAction: map['instanceTerminationAction'] == null ? null : SchedulingInstanceTerminationAction.fromValue(map['instanceTerminationAction'] as String),
      latencyTolerant: map['latencyTolerant'] == null ? null : map['latencyTolerant'] as bool,
      localSsdRecoveryTimeout: map['localSsdRecoveryTimeout'] == null ? null : Duration.fromMap((map['localSsdRecoveryTimeout'] as Map).cast<String, dynamic>()),
      ...
      maintenanceInterval: map['maintenanceInterval'] == null ? null : SchedulingMaintenanceInterval.fromValue(map['maintenanceInterval'] as String),
      maxRunDuration: map['maxRunDuration'] == null ? null : Duration.fromMap((map['maxRunDuration'] as Map).cast<String, dynamic>()),
      ...
      onHostMaintenance: map['onHostMaintenance'] == null ? null : SchedulingOnHostMaintenance.fromValue(map['onHostMaintenance'] as String),
      preemptible: map['preemptible'] == null ? null : map['preemptible'] as bool,
      provisioningModel: map['provisioningModel'] == null ? null : SchedulingProvisioningModel.fromValue(map['provisioningModel'] as String),
