...
class InterconnectMacsecResponseComputeBeta {
  ...
  factory InterconnectMacsecResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return InterconnectMacsecResponseComputeBeta(
      failOpen: (map['failOpen'] as bool).input(),
      preSharedKeys: (pulumi.Input.decodeList<InterconnectMacsecPreSharedKeyResponseComputeBeta>(map['preSharedKeys'], (value) => InterconnectMacsecPreSharedKeyResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
