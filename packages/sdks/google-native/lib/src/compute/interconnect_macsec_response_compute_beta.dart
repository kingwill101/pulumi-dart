...
class InterconnectMacsecResponseComputeBeta {
  ...
  final pulumi.Input<List<InterconnectMacsecPreSharedKeyResponseComputeBeta>>
  preSharedKeys;
  ...
  InterconnectMacsecResponseComputeBeta({
    ...
    return <String, dynamic>{
      ...
      'preSharedKeys':
          pulumi.Input.mapInputValue<
            List<InterconnectMacsecPreSharedKeyResponseComputeBeta>,
  ...
  factory InterconnectMacsecResponseComputeBeta.fromMap(
    ...
    return InterconnectMacsecResponseComputeBeta(
      ...
      preSharedKeys: pulumi.Input.fromValue(
        ...
        >(
          map['preSharedKeys']!,
          (value) => InterconnectMacsecPreSharedKeyResponseComputeBeta.fromMap(
