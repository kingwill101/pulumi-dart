...
class InstanceComputeBetaArgs {
  ...
  InstanceComputeBetaArgs({
    pulumi.Output<AdvancedMachineFeaturesComputeBeta>? advancedMachineFeatures,
    pulumi.Output<bool>? canIpForward,
    pulumi.Output<ConfidentialInstanceConfigComputeBeta>? confidentialInstanceConfig,
    pulumi.Output<bool>? deletionProtection,
    pulumi.Output<String>? description,
    pulumi.Output<List<AttachedDiskComputeBeta>>? disks,
    pulumi.Output<DisplayDeviceComputeBeta>? displayDevice,
    pulumi.Output<bool>? eraseWindowsVssSignature,
    pulumi.Output<List<AcceleratorConfigComputeBeta>>? guestAccelerators,
    pulumi.Output<String>? hostname,
    pulumi.Output<CustomerEncryptionKeyComputeBeta>? instanceEncryptionKey,
    pulumi.Output<InstanceKeyRevocationActionTypeComputeBeta>? keyRevocationActionType,
    pulumi.Output<Map<String, String>>? labels,
    pulumi.Output<String>? machineType,
    pulumi.Output<MetadataComputeBeta>? metadata,
    pulumi.Output<String>? minCpuPlatform,
    pulumi.Output<String>? name,
    pulumi.Output<List<NetworkInterfaceComputeBeta>>? networkInterfaces,
    pulumi.Output<NetworkPerformanceConfigComputeBeta>? networkPerformanceConfig,
    pulumi.Output<InstanceParamsComputeBeta>? params,
    pulumi.Output<InstancePostKeyRevocationActionTypeComputeBeta>? postKeyRevocationActionType,
    pulumi.Output<InstancePrivateIpv6GoogleAccessComputeBeta>? privateIpv6GoogleAccess,
    pulumi.Output<String>? project,
    pulumi.Output<String>? requestId,
    pulumi.Output<ReservationAffinityComputeBeta>? reservationAffinity,
    pulumi.Output<List<String>>? resourcePolicies,
    pulumi.Output<SchedulingComputeBeta>? scheduling,
    pulumi.Output<List<ServiceAccountComputeBeta>>? serviceAccounts,
    pulumi.Output<ShieldedInstanceConfigComputeBeta>? shieldedInstanceConfig,
    pulumi.Output<ShieldedInstanceIntegrityPolicyComputeBeta>? shieldedInstanceIntegrityPolicy,
    pulumi.Output<ShieldedVmConfigComputeBeta>? shieldedVmConfig,
    pulumi.Output<ShieldedVmIntegrityPolicyComputeBeta>? shieldedVmIntegrityPolicy,
    pulumi.Output<String>? sourceInstanceTemplate,
    pulumi.Output<String>? sourceMachineImage,
    pulumi.Output<CustomerEncryptionKeyComputeBeta>? sourceMachineImageEncryptionKey,
    pulumi.Output<TagsComputeBeta>? tags,
  ...
  factory InstanceComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return InstanceComputeBetaArgs(
      advancedMachineFeatures: map['advancedMachineFeatures'] == null ? null : pulumi.Output.create<AdvancedMachineFeaturesComputeBeta>(AdvancedMachineFeaturesComputeBeta.fromMap((map['advancedMachineFeatures'] as Map).cast<String, dynamic>())),
      canIpForward: map['canIpForward'] == null ? null : pulumi.Output.create<bool>(map['canIpForward'] as bool),
      confidentialInstanceConfig: map['confidentialInstanceConfig'] == null ? null : pulumi.Output.create<ConfidentialInstanceConfigComputeBeta>(ConfidentialInstanceConfigComputeBeta.fromMap((map['confidentialInstanceConfig'] as Map).cast<String, dynamic>())),
      deletionProtection: map['deletionProtection'] == null ? null : pulumi.Output.create<bool>(map['deletionProtection'] as bool),
      description: map['description'] == null ? null : pulumi.Output.create<String>(map['description'] as String),
      disks: map['disks'] == null ? null : pulumi.Output.create<List<AttachedDiskComputeBeta>>(pulumi.Input.decodeList<AttachedDiskComputeBeta>(map['disks'], (value) => AttachedDiskComputeBeta.fromMap((value as Map).cast<String, dynamic>()))),
      displayDevice: map['displayDevice'] == null ? null : pulumi.Output.create<DisplayDeviceComputeBeta>(DisplayDeviceComputeBeta.fromMap((map['displayDevice'] as Map).cast<String, dynamic>())),
      ...
      guestAccelerators: map['guestAccelerators'] == null ? null : pulumi.Output.create<List<AcceleratorConfigComputeBeta>>(pulumi.Input.decodeList<AcceleratorConfigComputeBeta>(map['guestAccelerators'], (value) => AcceleratorConfigComputeBeta.fromMap((value as Map).cast<String, dynamic>()))),
      hostname: map['hostname'] == null ? null : pulumi.Output.create<String>(map['hostname'] as String),
      instanceEncryptionKey: map['instanceEncryptionKey'] == null ? null : pulumi.Output.create<CustomerEncryptionKeyComputeBeta>(CustomerEncryptionKeyComputeBeta.fromMap((map['instanceEncryptionKey'] as Map).cast<String, dynamic>())),
      keyRevocationActionType: map['keyRevocationActionType'] == null ? null : pulumi.Output.create<InstanceKeyRevocationActionTypeComputeBeta>(InstanceKeyRevocationActionTypeComputeBeta.fromValue(map['keyRevocationActionType'] as String)),
      labels: map['labels'] == null ? null : pulumi.Output.create<Map<String, String>>((map['labels'] as Map).cast<String, String>()),
      machineType: map['machineType'] == null ? null : pulumi.Output.create<String>(map['machineType'] as String),
      metadata: map['metadata'] == null ? null : pulumi.Output.create<MetadataComputeBeta>(MetadataComputeBeta.fromMap((map['metadata'] as Map).cast<String, dynamic>())),
      minCpuPlatform: map['minCpuPlatform'] == null ? null : pulumi.Output.create<String>(map['minCpuPlatform'] as String),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      networkInterfaces: map['networkInterfaces'] == null ? null : pulumi.Output.create<List<NetworkInterfaceComputeBeta>>(pulumi.Input.decodeList<NetworkInterfaceComputeBeta>(map['networkInterfaces'], (value) => NetworkInterfaceComputeBeta.fromMap((value as Map).cast<String, dynamic>()))),
      networkPerformanceConfig: map['networkPerformanceConfig'] == null ? null : pulumi.Output.create<NetworkPerformanceConfigComputeBeta>(NetworkPerformanceConfigComputeBeta.fromMap((map['networkPerformanceConfig'] as Map).cast<String, dynamic>())),
      params: map['params'] == null ? null : pulumi.Output.create<InstanceParamsComputeBeta>(InstanceParamsComputeBeta.fromMap((map['params'] as Map).cast<String, dynamic>())),
      postKeyRevocationActionType: map['postKeyRevocationActionType'] == null ? null : pulumi.Output.create<InstancePostKeyRevocationActionTypeComputeBeta>(InstancePostKeyRevocationActionTypeComputeBeta.fromValue(map['postKeyRevocationActionType'] as String)),
      privateIpv6GoogleAccess: map['privateIpv6GoogleAccess'] == null ? null : pulumi.Output.create<InstancePrivateIpv6GoogleAccessComputeBeta>(InstancePrivateIpv6GoogleAccessComputeBeta.fromValue(map['privateIpv6GoogleAccess'] as String)),
      project: map['project'] == null ? null : pulumi.Output.create<String>(map['project'] as String),
      requestId: map['requestId'] == null ? null : pulumi.Output.create<String>(map['requestId'] as String),
      reservationAffinity: map['reservationAffinity'] == null ? null : pulumi.Output.create<ReservationAffinityComputeBeta>(ReservationAffinityComputeBeta.fromMap((map['reservationAffinity'] as Map).cast<String, dynamic>())),
      ...
      scheduling: map['scheduling'] == null ? null : pulumi.Output.create<SchedulingComputeBeta>(SchedulingComputeBeta.fromMap((map['scheduling'] as Map).cast<String, dynamic>())),
      serviceAccounts: map['serviceAccounts'] == null ? null : pulumi.Output.create<List<ServiceAccountComputeBeta>>(pulumi.Input.decodeList<ServiceAccountComputeBeta>(map['serviceAccounts'], (value) => ServiceAccountComputeBeta.fromMap((value as Map).cast<String, dynamic>()))),
      shieldedInstanceConfig: map['shieldedInstanceConfig'] == null ? null : pulumi.Output.create<ShieldedInstanceConfigComputeBeta>(ShieldedInstanceConfigComputeBeta.fromMap((map['shieldedInstanceConfig'] as Map).cast<String, dynamic>())),
      shieldedInstanceIntegrityPolicy: map['shieldedInstanceIntegrityPolicy'] == null ? null : pulumi.Output.create<ShieldedInstanceIntegrityPolicyComputeBeta>(ShieldedInstanceIntegrityPolicyComputeBeta.fromMap((map['shieldedInstanceIntegrityPolicy'] as Map).cast<String, dynamic>())),
      shieldedVmConfig: map['shieldedVmConfig'] == null ? null : pulumi.Output.create<ShieldedVmConfigComputeBeta>(ShieldedVmConfigComputeBeta.fromMap((map['shieldedVmConfig'] as Map).cast<String, dynamic>())),
      shieldedVmIntegrityPolicy: map['shieldedVmIntegrityPolicy'] == null ? null : pulumi.Output.create<ShieldedVmIntegrityPolicyComputeBeta>(ShieldedVmIntegrityPolicyComputeBeta.fromMap((map['shieldedVmIntegrityPolicy'] as Map).cast<String, dynamic>())),
      ...
      sourceMachineImageEncryptionKey: map['sourceMachineImageEncryptionKey'] == null ? null : pulumi.Output.create<CustomerEncryptionKeyComputeBeta>(CustomerEncryptionKeyComputeBeta.fromMap((map['sourceMachineImageEncryptionKey'] as Map).cast<String, dynamic>())),
      tags: map['tags'] == null ? null : pulumi.Output.create<TagsComputeBeta>(TagsComputeBeta.fromMap((map['tags'] as Map).cast<String, dynamic>())),
