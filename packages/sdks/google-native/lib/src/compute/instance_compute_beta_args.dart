...
class InstanceComputeBetaArgs {
  ...
  factory InstanceComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return InstanceComputeBetaArgs(
      ...
      instanceEncryptionKey: map['instanceEncryptionKey'] == null ? null : (CustomerEncryptionKeyComputeBeta.fromMap((map['instanceEncryptionKey']! as Map).cast<String, dynamic>())).input(),
      keyRevocationActionType: map['keyRevocationActionType'] == null ? null : (InstanceKeyRevocationActionTypeComputeBeta.fromValue(map['keyRevocationActionType']! as String)).input(),
      ...
      params: map['params'] == null ? null : (InstanceParamsComputeBeta.fromMap((map['params']! as Map).cast<String, dynamic>())).input(),
      postKeyRevocationActionType: map['postKeyRevocationActionType'] == null ? null : (InstancePostKeyRevocationActionTypeComputeBeta.fromValue(map['postKeyRevocationActionType']! as String)).input(),
      privateIpv6GoogleAccess: map['privateIpv6GoogleAccess'] == null ? null : (InstancePrivateIpv6GoogleAccessComputeBeta.fromValue(map['privateIpv6GoogleAccess']! as String)).input(),
      ...
      shieldedInstanceIntegrityPolicy: map['shieldedInstanceIntegrityPolicy'] == null ? null : (ShieldedInstanceIntegrityPolicyComputeBeta.fromMap((map['shieldedInstanceIntegrityPolicy']! as Map).cast<String, dynamic>())).input(),
      ...
      shieldedVmIntegrityPolicy: map['shieldedVmIntegrityPolicy'] == null ? null : (ShieldedVmIntegrityPolicyComputeBeta.fromMap((map['shieldedVmIntegrityPolicy']! as Map).cast<String, dynamic>())).input(),
      ...
      sourceMachineImageEncryptionKey: map['sourceMachineImageEncryptionKey'] == null ? null : (CustomerEncryptionKeyComputeBeta.fromMap((map['sourceMachineImageEncryptionKey']! as Map).cast<String, dynamic>())).input(),
