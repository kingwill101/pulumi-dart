    ...
    return GlobalAddressArgs(
      ...
      addressType: (() {
        ...
        return pulumi.Input.fromValue(
          GlobalAddressAddressType.fromValue(guardedValue as String),
        );
      })(),
      description: (() {
      ...
      ipVersion: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GlobalAddressIpVersion.fromValue(guardedValue as String),
        );
      })(),
      ipv6EndpointType: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GlobalAddressIpv6EndpointType.fromValue(guardedValue as String),
        );
      })(),
      labels: (() {
      ...
      networkTier: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GlobalAddressNetworkTier.fromValue(guardedValue as String),
        );
      })(),
      prefixLength: (() {
      ...
      purpose: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GlobalAddressPurpose.fromValue(guardedValue as String),
        );
      })(),
      requestId: (() {
