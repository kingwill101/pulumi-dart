...
class GetRegionCommitmentComputeBetaResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'resources':
          pulumi.Input.encodeList<
            ResourceCommitmentResponseComputeBeta,
            Map<String, dynamic>
  ...
  factory GetRegionCommitmentComputeBetaResult.fromMap(
    ...
    return GetRegionCommitmentComputeBetaResult(
      ...
      licenseResource: LicenseResourceCommitmentResponseComputeBeta.fromMap(
        (map['licenseResource']! as Map).cast<String, dynamic>(),
      ),
      mergeSourceCommitments: (map['mergeSourceCommitments'] as List)
          .cast<String>(),
      name: map['name'] as String,
      plan: map['plan'] as String,
      region: map['region'] as String,
      reservations: pulumi.Input.decodeList<ReservationResponseComputeBeta>(
        map['reservations']!,
        (value) => ReservationResponseComputeBeta.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      resources: pulumi.Input.decodeList<ResourceCommitmentResponseComputeBeta>(
        map['resources']!,
        (value) => ResourceCommitmentResponseComputeBeta.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
