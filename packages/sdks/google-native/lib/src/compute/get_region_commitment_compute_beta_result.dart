...
class GetRegionCommitmentComputeBetaResult {
  ...
  final LicenseResourceCommitmentResponseComputeBeta licenseResource;
  ...
  final List<ReservationResponseComputeBeta> reservations;
  /// A list of commitment amounts for particular resources. Note that VCPU and MEMORY resource commitments must occur together.
  final List<ResourceCommitmentResponseComputeBeta> resources;
  ...
  /// Creates a new [GetRegionCommitmentComputeBetaResult].
  ...
  const GetRegionCommitmentComputeBetaResult({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'plan': plan,
      'region': region,
      'reservations': pulumi.Input.encodeList<ReservationResponseComputeBeta, Map<String, dynamic>>(reservations, (value) => value.toMap()),
      'resources': pulumi.Input.encodeList<ResourceCommitmentResponseComputeBeta, Map<String, dynamic>>(resources, (value) => value.toMap()),
      'selfLink': selfLink,
  ...
  factory GetRegionCommitmentComputeBetaResult.fromMap(Map<String, dynamic> map) {
    return GetRegionCommitmentComputeBetaResult(
      ...
      licenseResource: LicenseResourceCommitmentResponseComputeBeta.fromMap((map['licenseResource']! as Map).cast<String, dynamic>()),
      mergeSourceCommitments: (map['mergeSourceCommitments'] as List).cast<String>(),
      name: map['name'] as String,
      plan: map['plan'] as String,
      region: map['region'] as String,
      reservations: pulumi.Input.decodeList<ReservationResponseComputeBeta>(map['reservations']!, (value) => ReservationResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      resources: pulumi.Input.decodeList<ResourceCommitmentResponseComputeBeta>(map['resources']!, (value) => ResourceCommitmentResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
