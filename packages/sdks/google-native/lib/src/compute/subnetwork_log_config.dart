...
class SubnetworkLogConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'aggregationInterval': ?pulumi.Input.mapOptionalInputValue<SubnetworkLogConfigAggregationInterval, String>(aggregationInterval, (value) => value.wireValue),
      'enable': ?enable,
      'filterExpr': ?filterExpr,
      'flowSampling': ?flowSampling,
      'metadata': ?pulumi.Input.mapOptionalInputValue<SubnetworkLogConfigMetadata, String>(metadata, (value) => value.wireValue),
  ...
  factory SubnetworkLogConfig.fromMap(Map<String, dynamic> map) {
    return SubnetworkLogConfig(
      aggregationInterval: (() { final guardedValue = map['aggregationInterval']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SubnetworkLogConfigAggregationInterval.fromValue(guardedValue as String)); })(),
      ...
      metadata: (() { final guardedValue = map['metadata']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SubnetworkLogConfigMetadata.fromValue(guardedValue as String)); })(),
