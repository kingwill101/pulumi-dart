...
class SubnetworkLogConfig {
  ...
  factory SubnetworkLogConfig.fromMap(Map<String, dynamic> map) {
    return SubnetworkLogConfig(
      aggregationInterval: map['aggregationInterval'] == null ? null : SubnetworkLogConfigAggregationInterval.fromValue(map['aggregationInterval'] as String),
      ...
      metadata: map['metadata'] == null ? null : SubnetworkLogConfigMetadata.fromValue(map['metadata'] as String),
