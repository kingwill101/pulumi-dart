...
class TargetHttpsProxyComputeV1Args {
  ...
  const TargetHttpsProxyComputeV1Args({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'project': ?project,
      'proxyBind': ?proxyBind,
      'quicOverride': ?pulumi.Input.mapOptionalInputValue<TargetHttpsProxyQuicOverrideComputeV1, String>(quicOverride, (value) => value.wireValue),
      'requestId': ?requestId,
  ...
  factory TargetHttpsProxyComputeV1Args.fromMap(Map<String, dynamic> map) {
    return TargetHttpsProxyComputeV1Args(
      ...
      quicOverride: (() { final guardedValue = map['quicOverride']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TargetHttpsProxyQuicOverrideComputeV1.fromValue(guardedValue as String)); })(),
