...
class FirewallComputeBetaArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'direction': ?pulumi.Input.mapOptionalInputValue<FirewallDirectionComputeBeta, String>(direction, (value) => value.wireValue),
      'disabled': ?disabled,
  ...
  factory FirewallComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return FirewallComputeBetaArgs(
      allowed: (() { final guardedValue = map['allowed']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FirewallAllowedItemComputeBeta>(guardedValue, (value) => FirewallAllowedItemComputeBeta.fromMap((value as Map).cast<String, dynamic>()))); })(),
      denied: (() { final guardedValue = map['denied']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FirewallDeniedItemComputeBeta>(guardedValue, (value) => FirewallDeniedItemComputeBeta.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      direction: (() { final guardedValue = map['direction']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FirewallDirectionComputeBeta.fromValue(guardedValue as String)); })(),
      ...
      logConfig: (() { final guardedValue = map['logConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FirewallLogConfigComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
