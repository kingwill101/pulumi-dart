...
class FirewallComputeBetaArgs {
  ...
  factory FirewallComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return FirewallComputeBetaArgs(
      allowed: map['allowed'] == null ? null : (pulumi.Input.decodeList<FirewallAllowedItemComputeBeta>(map['allowed'], (value) => FirewallAllowedItemComputeBeta.fromMap((value as Map).cast<String, dynamic>()))).input(),
      denied: map['denied'] == null ? null : (pulumi.Input.decodeList<FirewallDeniedItemComputeBeta>(map['denied'], (value) => FirewallDeniedItemComputeBeta.fromMap((value as Map).cast<String, dynamic>()))).input(),
      description: map['description'] == null ? null : (map['description'] as String).input(),
      destinationRanges: map['destinationRanges'] == null ? null : ((map['destinationRanges'] as List).cast<String>()).input(),
      direction: map['direction'] == null ? null : (FirewallDirectionComputeBeta.fromValue(map['direction'] as String)).input(),
      disabled: map['disabled'] == null ? null : (map['disabled'] as bool).input(),
      enableLogging: map['enableLogging'] == null ? null : (map['enableLogging'] as bool).input(),
      logConfig: map['logConfig'] == null ? null : (FirewallLogConfigComputeBeta.fromMap((map['logConfig'] as Map).cast<String, dynamic>())).input(),
