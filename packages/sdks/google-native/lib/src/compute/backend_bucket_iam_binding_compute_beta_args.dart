...
/// {@template pulumi_compute_beta_backend_bucket_iam_binding_compute_beta_args_doc}
/// The set of arguments for BackendBucketIamBinding.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_backend_bucket_iam_binding_compute_beta_args_doc}
class BackendBucketIamBindingComputeBetaArgs {
  ...
  /// Creates a new [BackendBucketIamBindingComputeBetaArgs].
  ...
  const BackendBucketIamBindingComputeBetaArgs({
    this.condition,
  ...
  factory BackendBucketIamBindingComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return BackendBucketIamBindingComputeBetaArgs(
