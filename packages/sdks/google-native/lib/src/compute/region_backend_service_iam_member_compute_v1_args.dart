...
/// {@template pulumi_compute_v1_region_backend_service_iam_member_compute_v1_args_doc}
/// The set of arguments for RegionBackendServiceIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_v1_region_backend_service_iam_member_compute_v1_args_doc}
class RegionBackendServiceIamMemberComputeV1Args {
  ...
  /// Creates a new [RegionBackendServiceIamMemberComputeV1Args].
  ...
  const RegionBackendServiceIamMemberComputeV1Args({
    this.condition,
  ...
  factory RegionBackendServiceIamMemberComputeV1Args.fromMap(Map<String, dynamic> map) {
    return RegionBackendServiceIamMemberComputeV1Args(
