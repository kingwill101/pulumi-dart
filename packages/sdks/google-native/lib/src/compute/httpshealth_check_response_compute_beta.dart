...
class HTTPSHealthCheckResponseComputeBeta {
  ...
  /// Creates a new [HTTPSHealthCheckResponseComputeBeta].
  ...
  const HTTPSHealthCheckResponseComputeBeta({
    required this.host,
    required this.port,
  ...
  factory HTTPSHealthCheckResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return HTTPSHealthCheckResponseComputeBeta(
