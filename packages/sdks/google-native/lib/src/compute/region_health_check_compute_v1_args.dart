...
class RegionHealthCheckComputeV1Args {
  ...
  RegionHealthCheckComputeV1Args({
    ...
    pulumi.Output<RegionHealthCheckTypeComputeV1>? type,
  ...
  factory RegionHealthCheckComputeV1Args.fromMap(Map<String, dynamic> map) {
    return RegionHealthCheckComputeV1Args(
      ...
      type: map['type'] == null ? null : pulumi.Output.create<RegionHealthCheckTypeComputeV1>(RegionHealthCheckTypeComputeV1.fromValue(map['type'] as String)),
