...
class InstancePropertiesResponseComputeBeta {
  ...
  factory InstancePropertiesResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return InstancePropertiesResponseComputeBeta(
      advancedMachineFeatures: pulumi.Input.fromValue(AdvancedMachineFeaturesResponseComputeBeta.fromMap((map['advancedMachineFeatures']! as Map).cast<String, dynamic>())),
      canIpForward: pulumi.Input.fromValue(map['canIpForward'] as bool),
      confidentialInstanceConfig: pulumi.Input.fromValue(ConfidentialInstanceConfigResponseComputeBeta.fromMap((map['confidentialInstanceConfig']! as Map).cast<String, dynamic>())),
      description: pulumi.Input.fromValue(map['description'] as String),
      disks: pulumi.Input.fromValue(pulumi.Input.decodeList<AttachedDiskResponseComputeBeta>(map['disks']!, (value) => AttachedDiskResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))),
      displayDevice: pulumi.Input.fromValue(DisplayDeviceResponseComputeBeta.fromMap((map['displayDevice']! as Map).cast<String, dynamic>())),
      ...
      networkPerformanceConfig: pulumi.Input.fromValue(NetworkPerformanceConfigResponseComputeBeta.fromMap((map['networkPerformanceConfig']! as Map).cast<String, dynamic>())),
      ...
      reservationAffinity: pulumi.Input.fromValue(ReservationAffinityResponseComputeBeta.fromMap((map['reservationAffinity']! as Map).cast<String, dynamic>())),
      ...
      shieldedInstanceConfig: pulumi.Input.fromValue(ShieldedInstanceConfigResponseComputeBeta.fromMap((map['shieldedInstanceConfig']! as Map).cast<String, dynamic>())),
      shieldedVmConfig: pulumi.Input.fromValue(ShieldedVmConfigResponseComputeBeta.fromMap((map['shieldedVmConfig']! as Map).cast<String, dynamic>())),
