...
class NetworkInterfaceComputeBeta {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'nicType':
          ?pulumi.Input.mapOptionalInputValue<
            NetworkInterfaceNicTypeComputeBeta,
            String
          >(nicType, (value) => value.wireValue),
      'queueCount': ?queueCount,
      'stackType':
          ?pulumi.Input.mapOptionalInputValue<
            NetworkInterfaceStackTypeComputeBeta,
            String
  ...
  factory NetworkInterfaceComputeBeta.fromMap(Map<String, dynamic> map) {
    return NetworkInterfaceComputeBeta(
      ...
      nicType: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          NetworkInterfaceNicTypeComputeBeta.fromValue(guardedValue as String),
        );
      })(),
      queueCount: (() {
