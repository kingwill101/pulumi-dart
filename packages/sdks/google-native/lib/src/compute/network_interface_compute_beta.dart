...
class NetworkInterfaceComputeBeta {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'accessConfigs': ?accessConfigs == null ? null : pulumi.Input.encodeList<AccessConfigComputeBeta, Map<String, dynamic>>(accessConfigs!, (value) => value.toMap()),
      'aliasIpRanges': ?aliasIpRanges == null ? null : pulumi.Input.encodeList<AliasIpRangeComputeBeta, Map<String, dynamic>>(aliasIpRanges!, (value) => value.toMap()),
      'internalIpv6PrefixLength': ?internalIpv6PrefixLength,
      'ipv6AccessConfigs': ?ipv6AccessConfigs == null ? null : pulumi.Input.encodeList<AccessConfigComputeBeta, Map<String, dynamic>>(ipv6AccessConfigs!, (value) => value.toMap()),
  ...
  factory NetworkInterfaceComputeBeta.fromMap(Map<String, dynamic> map) {
    return NetworkInterfaceComputeBeta(
      accessConfigs: map['accessConfigs'] == null ? null : pulumi.Input.decodeList<AccessConfigComputeBeta>(map['accessConfigs'], (value) => AccessConfigComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      aliasIpRanges: map['aliasIpRanges'] == null ? null : pulumi.Input.decodeList<AliasIpRangeComputeBeta>(map['aliasIpRanges'], (value) => AliasIpRangeComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      internalIpv6PrefixLength: map['internalIpv6PrefixLength'] == null ? null : map['internalIpv6PrefixLength'] as int,
      ipv6AccessConfigs: map['ipv6AccessConfigs'] == null ? null : pulumi.Input.decodeList<AccessConfigComputeBeta>(map['ipv6AccessConfigs'], (value) => AccessConfigComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      ...
      nicType: map['nicType'] == null ? null : NetworkInterfaceNicTypeComputeBeta.fromValue(map['nicType'] as String),
      queueCount: map['queueCount'] == null ? null : map['queueCount'] as int,
      stackType: map['stackType'] == null ? null : NetworkInterfaceStackTypeComputeBeta.fromValue(map['stackType'] as String),
