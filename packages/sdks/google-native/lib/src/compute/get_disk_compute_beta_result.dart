...
import 'disk_async_replication_response_compute_beta.dart';
import 'disk_params_response_compute_beta.dart';
import 'disk_resource_status_response_compute_beta.dart';
import 'guest_os_feature_response_compute_beta.dart';

/// Result data returned by getDisk.
class GetDiskComputeBetaResult {
  /// The architecture of the disk. Valid values are ARM64 or X86_64.
  final String architecture;
  /// Disk asynchronously replicated into this disk.
  final DiskAsyncReplicationResponseComputeBeta asyncPrimaryDisk;
  ...
  final DiskParamsResponseComputeBeta params;
  ...
  final DiskResourceStatusResponseComputeBeta resourceStatus;
  ...
  /// Creates a new [GetDiskComputeBetaResult].
  ...
  const GetDiskComputeBetaResult({
  ...
  factory GetDiskComputeBetaResult.fromMap(Map<String, dynamic> map) {
    return GetDiskComputeBetaResult(
      architecture: map['architecture'] as String,
      asyncPrimaryDisk: DiskAsyncReplicationResponseComputeBeta.fromMap((map['asyncPrimaryDisk']! as Map).cast<String, dynamic>()),
      ...
      params: DiskParamsResponseComputeBeta.fromMap((map['params']! as Map).cast<String, dynamic>()),
      ...
      resourceStatus: DiskResourceStatusResponseComputeBeta.fromMap((map['resourceStatus']! as Map).cast<String, dynamic>()),
