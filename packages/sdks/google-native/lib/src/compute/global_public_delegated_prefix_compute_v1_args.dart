...
class GlobalPublicDelegatedPrefixComputeV1Args {
  ...
  const GlobalPublicDelegatedPrefixComputeV1Args({
    this.description,
    this.ipCidrRange,
  ...
  factory GlobalPublicDelegatedPrefixComputeV1Args.fromMap(Map<String, dynamic> map) {
    return GlobalPublicDelegatedPrefixComputeV1Args(
      ...
      publicDelegatedSubPrefixs: (() { final guardedValue = map['publicDelegatedSubPrefixs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PublicDelegatedPrefixPublicDelegatedSubPrefixComputeV1>(guardedValue, (value) => PublicDelegatedPrefixPublicDelegatedSubPrefixComputeV1.fromMap((value as Map).cast<String, dynamic>()))); })(),
