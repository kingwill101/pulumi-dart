...
class AttachedDiskResponseComputeV1 {
  ...
  factory AttachedDiskResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return AttachedDiskResponseComputeV1(
      ...
      initializeParams: (AttachedDiskInitializeParamsResponseComputeV1.fromMap((map['initializeParams'] as Map).cast<String, dynamic>())).input(),
      ...
      shieldedInstanceInitialState: (InitialStateConfigResponseComputeV1.fromMap((map['shieldedInstanceInitialState'] as Map).cast<String, dynamic>())).input(),
