...
class AttachedDiskResponseComputeV1 {
  ...
  final pulumi.Input<AttachedDiskInitializeParamsResponseComputeV1>
  initializeParams;
  ...
  final pulumi.Input<InitialStateConfigResponseComputeV1>
  ...
  factory AttachedDiskResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return AttachedDiskResponseComputeV1(
      ...
      initializeParams: pulumi.Input.fromValue(
        AttachedDiskInitializeParamsResponseComputeV1.fromMap(
      ...
      shieldedInstanceInitialState: pulumi.Input.fromValue(
        InitialStateConfigResponseComputeV1.fromMap(
