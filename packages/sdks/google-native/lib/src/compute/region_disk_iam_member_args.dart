...
/// {@template pulumi_compute_alpha_region_disk_iam_member_args_doc}
/// The set of arguments for RegionDiskIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_alpha_region_disk_iam_member_args_doc}
class RegionDiskIamMemberArgs {
  ...
  /// Creates a new [RegionDiskIamMemberArgs].
  ...
  factory RegionDiskIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return RegionDiskIamMemberArgs(
