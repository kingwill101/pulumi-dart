...
class PathMatcherComputeV1 {
  ...
  factory PathMatcherComputeV1.fromMap(Map<String, dynamic> map) {
    return PathMatcherComputeV1(
      ...
      pathRules: (() { final guardedValue = map['pathRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PathRuleComputeV1>(guardedValue, (value) => PathRuleComputeV1.fromMap((value as Map).cast<String, dynamic>()))); })(),
      routeRules: (() { final guardedValue = map['routeRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<HttpRouteRuleComputeV1>(guardedValue, (value) => HttpRouteRuleComputeV1.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
