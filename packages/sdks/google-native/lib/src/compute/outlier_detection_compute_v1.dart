...
class OutlierDetectionComputeV1 {
  ...
  final pulumi.Input<DurationComputeV1>? baseEjectionTime;
  ...
  final pulumi.Input<DurationComputeV1>? interval;
  ...
  const OutlierDetectionComputeV1({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'baseEjectionTime': ?pulumi.Input.mapOptionalInputValue<DurationComputeV1, Map<String, dynamic>>(baseEjectionTime, (value) => value.toMap()),
      ...
      'interval': ?pulumi.Input.mapOptionalInputValue<DurationComputeV1, Map<String, dynamic>>(interval, (value) => value.toMap()),
  ...
  factory OutlierDetectionComputeV1.fromMap(Map<String, dynamic> map) {
    return OutlierDetectionComputeV1(
      baseEjectionTime: (() { final guardedValue = map['baseEjectionTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DurationComputeV1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      interval: (() { final guardedValue = map['interval']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DurationComputeV1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
