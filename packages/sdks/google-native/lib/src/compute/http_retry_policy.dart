...
class HttpRetryPolicy {
  ...
  final pulumi.Input<Duration>? perTryTimeout;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'perTryTimeout': ?pulumi.Input.mapOptionalInputValue<Duration, Map<String, dynamic>>(perTryTimeout, (value) => value.toMap()),
  ...
  factory HttpRetryPolicy.fromMap(Map<String, dynamic> map) {
    return HttpRetryPolicy(
      ...
      perTryTimeout: (() { final guardedValue = map['perTryTimeout']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Duration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
