...
/// {@template pulumi_compute_beta_instance_iam_binding_compute_beta_args_doc}
/// The set of arguments for InstanceIamBinding.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_instance_iam_binding_compute_beta_args_doc}
class InstanceIamBindingComputeBetaArgs {
  ...
  /// Creates a new [InstanceIamBindingComputeBetaArgs].
  ...
  const InstanceIamBindingComputeBetaArgs({
    this.condition,
