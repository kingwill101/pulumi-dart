...
class HostRuleResponseComputeBeta {
  ...
  /// Creates a new [HostRuleResponseComputeBeta].
  ...
  const HostRuleResponseComputeBeta({
  ...
  factory HostRuleResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return HostRuleResponseComputeBeta(
