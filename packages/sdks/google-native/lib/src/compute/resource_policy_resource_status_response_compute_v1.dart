...
class ResourcePolicyResourceStatusResponseComputeV1 {
  ...
  final pulumi.Input<ResourcePolicyResourceStatusInstanceSchedulePolicyStatusResponseComputeV1> instanceSchedulePolicy;
  ...
  const ResourcePolicyResourceStatusResponseComputeV1({
    required this.instanceSchedulePolicy,
  });

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'instanceSchedulePolicy': pulumi.Input.mapInputValue<ResourcePolicyResourceStatusInstanceSchedulePolicyStatusResponseComputeV1, Map<String, dynamic>>(instanceSchedulePolicy, (value) => value.toMap()),
    };
  }

  factory ResourcePolicyResourceStatusResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return ResourcePolicyResourceStatusResponseComputeV1(
      instanceSchedulePolicy: pulumi.Input.fromValue(ResourcePolicyResourceStatusInstanceSchedulePolicyStatusResponseComputeV1.fromMap((map['instanceSchedulePolicy']! as Map).cast<String, dynamic>())),
    );
  }
}
