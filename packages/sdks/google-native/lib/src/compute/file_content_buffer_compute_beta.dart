...
class FileContentBufferComputeBeta {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'content': ?content,
      'fileType': ?pulumi.Input.mapOptionalInputValue<FileContentBufferFileTypeComputeBeta, String>(fileType, (value) => value.wireValue),
    };
  }
  ...
  factory FileContentBufferComputeBeta.fromMap(Map<String, dynamic> map) {
    return FileContentBufferComputeBeta(
      ...
      fileType: (() { final guardedValue = map['fileType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FileContentBufferFileTypeComputeBeta.fromValue(guardedValue as String)); })(),
    );
  }
}
