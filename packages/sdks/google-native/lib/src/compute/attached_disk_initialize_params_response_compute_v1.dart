...
class AttachedDiskInitializeParamsResponseComputeV1 {
  ...
  factory AttachedDiskInitializeParamsResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return AttachedDiskInitializeParamsResponseComputeV1(
      ...
      sourceImageEncryptionKey: (CustomerEncryptionKeyResponseComputeV1.fromMap((map['sourceImageEncryptionKey'] as Map).cast<String, dynamic>())).input(),
      sourceSnapshot: (map['sourceSnapshot'] as String).input(),
      sourceSnapshotEncryptionKey: (CustomerEncryptionKeyResponseComputeV1.fromMap((map['sourceSnapshotEncryptionKey'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
