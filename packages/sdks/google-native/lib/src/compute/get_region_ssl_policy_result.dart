...
class GetRegionSslPolicyResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'warnings': pulumi.Input.encodeList<RegionSslPolicyWarningsItemResponse, Map<String, dynamic>>(warnings, (value) => value.toMap()),
    };
  }
  ...
  factory GetRegionSslPolicyResult.fromMap(Map<String, dynamic> map) {
    return GetRegionSslPolicyResult(
      ...
      warnings: pulumi.Input.decodeList<RegionSslPolicyWarningsItemResponse>(map['warnings']!, (value) => RegionSslPolicyWarningsItemResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
