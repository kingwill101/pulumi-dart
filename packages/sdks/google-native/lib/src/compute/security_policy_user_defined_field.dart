...
class SecurityPolicyUserDefinedField {
  ...
  /// Creates a new [SecurityPolicyUserDefinedField].
  ...
  const SecurityPolicyUserDefinedField({
    this.base,
    this.mask,
    this.name,
    this.offset,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'base': ?pulumi.Input.mapOptionalInputValue<SecurityPolicyUserDefinedFieldBase, String>(base, (value) => value.wireValue),
      'mask': ?mask,
      'name': ?name,
      'offset': ?offset,
      'size': ?size,
  ...
  factory SecurityPolicyUserDefinedField.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyUserDefinedField(
      base: (() { final guardedValue = map['base']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SecurityPolicyUserDefinedFieldBase.fromValue(guardedValue as String)); })(),
