...
class SubnetworkArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'aggregationInterval': ?pulumi.Input.mapOptionalInputValue<SubnetworkAggregationInterval, String>(aggregationInterval, (value) => value.wireValue),
      ...
      'ipv6AccessType': ?pulumi.Input.mapOptionalInputValue<SubnetworkIpv6AccessType, String>(ipv6AccessType, (value) => value.wireValue),
      'logConfig': ?pulumi.Input.mapOptionalInputValue<SubnetworkLogConfig, Map<String, dynamic>>(logConfig, (value) => value.toMap()),
      'metadata': ?pulumi.Input.mapOptionalInputValue<SubnetworkMetadata, String>(metadata, (value) => value.wireValue),
      'name': ?name,
      'network': ?network,
      'privateIpGoogleAccess': ?privateIpGoogleAccess,
      'privateIpv6GoogleAccess': ?pulumi.Input.mapOptionalInputValue<SubnetworkPrivateIpv6GoogleAccess, String>(privateIpv6GoogleAccess, (value) => value.wireValue),
      'project': ?project,
      'purpose': ?pulumi.Input.mapOptionalInputValue<SubnetworkPurpose, String>(purpose, (value) => value.wireValue),
      'region': region,
      'requestId': ?requestId,
      'reservedInternalRange': ?reservedInternalRange,
      'role': ?pulumi.Input.mapOptionalInputValue<SubnetworkRole, String>(role, (value) => value.wireValue),
      ...
      'stackType': ?pulumi.Input.mapOptionalInputValue<SubnetworkStackType, String>(stackType, (value) => value.wireValue),
      'vlans': ?vlans,
    };
  }
  ...
  factory SubnetworkArgs.fromMap(Map<String, dynamic> map) {
    return SubnetworkArgs(
      aggregationInterval: (() { final guardedValue = map['aggregationInterval']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SubnetworkAggregationInterval.fromValue(guardedValue as String)); })(),
      ...
      enableL2: (() { final guardedValue = map['enableL2']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      enablePrivateV6Access: (() { final guardedValue = map['enablePrivateV6Access']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      ipv6AccessType: (() { final guardedValue = map['ipv6AccessType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SubnetworkIpv6AccessType.fromValue(guardedValue as String)); })(),
      ...
      metadata: (() { final guardedValue = map['metadata']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SubnetworkMetadata.fromValue(guardedValue as String)); })(),
      ...
      privateIpv6GoogleAccess: (() { final guardedValue = map['privateIpv6GoogleAccess']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SubnetworkPrivateIpv6GoogleAccess.fromValue(guardedValue as String)); })(),
      project: (() { final guardedValue = map['project']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      purpose: (() { final guardedValue = map['purpose']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SubnetworkPurpose.fromValue(guardedValue as String)); })(),
      ...
      role: (() { final guardedValue = map['role']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SubnetworkRole.fromValue(guardedValue as String)); })(),
      secondaryIpRanges: (() { final guardedValue = map['secondaryIpRanges']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SubnetworkSecondaryRange>(guardedValue, (value) => SubnetworkSecondaryRange.fromMap((value as Map).cast<String, dynamic>()))); })(),
      stackType: (() { final guardedValue = map['stackType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SubnetworkStackType.fromValue(guardedValue as String)); })(),
      vlans: (() { final guardedValue = map['vlans']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<int>()); })(),
    );
  }
}
