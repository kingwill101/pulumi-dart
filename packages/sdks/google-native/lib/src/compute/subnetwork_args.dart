...
class SubnetworkArgs {
  ...
  final pulumi.Input<SubnetworkPrivateIpv6GoogleAccess>? privateIpv6GoogleAccess;
  ...
  SubnetworkArgs({
    pulumi.Output<SubnetworkAggregationInterval>? aggregationInterval,
    pulumi.Output<bool>? allowSubnetCidrRoutesOverlap,
    pulumi.Output<String>? description,
    pulumi.Output<bool>? enableFlowLogs,
    pulumi.Output<bool>? enableL2,
    pulumi.Output<bool>? enablePrivateV6Access,
    pulumi.Output<String>? externalIpv6Prefix,
    pulumi.Output<double>? flowSampling,
    pulumi.Output<String>? ipCidrRange,
    pulumi.Output<SubnetworkIpv6AccessType>? ipv6AccessType,
    pulumi.Output<SubnetworkLogConfig>? logConfig,
    pulumi.Output<SubnetworkMetadata>? metadata,
    pulumi.Output<String>? name,
    pulumi.Output<String>? network,
    pulumi.Output<bool>? privateIpGoogleAccess,
    pulumi.Output<SubnetworkPrivateIpv6GoogleAccess>? privateIpv6GoogleAccess,
    pulumi.Output<String>? project,
    pulumi.Output<SubnetworkPurpose>? purpose,
    required pulumi.Output<String> region,
    pulumi.Output<String>? requestId,
    pulumi.Output<String>? reservedInternalRange,
    pulumi.Output<SubnetworkRole>? role,
    pulumi.Output<List<SubnetworkSecondaryRange>>? secondaryIpRanges,
    pulumi.Output<SubnetworkStackType>? stackType,
    pulumi.Output<List<int>>? vlans,
  }) :
      aggregationInterval = pulumi.Input.asOptionalInput<SubnetworkAggregationInterval>(aggregationInterval),
      ...
      enablePrivateV6Access = pulumi.Input.asOptionalInput<bool>(enablePrivateV6Access),
      ...
      ipv6AccessType = pulumi.Input.asOptionalInput<SubnetworkIpv6AccessType>(ipv6AccessType),
      ...
      privateIpv6GoogleAccess = pulumi.Input.asOptionalInput<SubnetworkPrivateIpv6GoogleAccess>(privateIpv6GoogleAccess),
      ...
      secondaryIpRanges = pulumi.Input.asOptionalInput<List<SubnetworkSecondaryRange>>(secondaryIpRanges),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'aggregationInterval': ?pulumi.Input.mapOptionalInputValue<SubnetworkAggregationInterval, String>(aggregationInterval, (value) => value.value),
      ...
      'ipv6AccessType': ?pulumi.Input.mapOptionalInputValue<SubnetworkIpv6AccessType, String>(ipv6AccessType, (value) => value.value),
      'logConfig': ?pulumi.Input.mapOptionalInputValue<SubnetworkLogConfig, Map<String, dynamic>>(logConfig, (value) => value.toMap()),
      'metadata': ?pulumi.Input.mapOptionalInputValue<SubnetworkMetadata, String>(metadata, (value) => value.value),
      'name': ?name,
      'network': ?network,
      'privateIpGoogleAccess': ?privateIpGoogleAccess,
      'privateIpv6GoogleAccess': ?pulumi.Input.mapOptionalInputValue<SubnetworkPrivateIpv6GoogleAccess, String>(privateIpv6GoogleAccess, (value) => value.value),
      'project': ?project,
      'purpose': ?pulumi.Input.mapOptionalInputValue<SubnetworkPurpose, String>(purpose, (value) => value.value),
      'region': region,
      'requestId': ?requestId,
      'reservedInternalRange': ?reservedInternalRange,
      'role': ?pulumi.Input.mapOptionalInputValue<SubnetworkRole, String>(role, (value) => value.value),
      'secondaryIpRanges': ?pulumi.Input.mapOptionalInputValue<List<SubnetworkSecondaryRange>, List<Map<String, dynamic>>>(secondaryIpRanges, (value) => pulumi.Input.encodeList<SubnetworkSecondaryRange, Map<String, dynamic>>(value, (value) => value.toMap())),
      'stackType': ?pulumi.Input.mapOptionalInputValue<SubnetworkStackType, String>(stackType, (value) => value.value),
      'vlans': ?vlans,
    };
  }
  ...
  factory SubnetworkArgs.fromMap(Map<String, dynamic> map) {
    return SubnetworkArgs(
      aggregationInterval: map['aggregationInterval'] == null ? null : pulumi.Output.create<SubnetworkAggregationInterval>(SubnetworkAggregationInterval.fromValue(map['aggregationInterval'] as String)),
      ...
      enableL2: map['enableL2'] == null ? null : pulumi.Output.create<bool>(map['enableL2'] as bool),
      enablePrivateV6Access: map['enablePrivateV6Access'] == null ? null : pulumi.Output.create<bool>(map['enablePrivateV6Access'] as bool),
      ...
      ipv6AccessType: map['ipv6AccessType'] == null ? null : pulumi.Output.create<SubnetworkIpv6AccessType>(SubnetworkIpv6AccessType.fromValue(map['ipv6AccessType'] as String)),
      ...
      metadata: map['metadata'] == null ? null : pulumi.Output.create<SubnetworkMetadata>(SubnetworkMetadata.fromValue(map['metadata'] as String)),
      ...
      privateIpv6GoogleAccess: map['privateIpv6GoogleAccess'] == null ? null : pulumi.Output.create<SubnetworkPrivateIpv6GoogleAccess>(SubnetworkPrivateIpv6GoogleAccess.fromValue(map['privateIpv6GoogleAccess'] as String)),
      project: map['project'] == null ? null : pulumi.Output.create<String>(map['project'] as String),
      purpose: map['purpose'] == null ? null : pulumi.Output.create<SubnetworkPurpose>(SubnetworkPurpose.fromValue(map['purpose'] as String)),
      ...
      role: map['role'] == null ? null : pulumi.Output.create<SubnetworkRole>(SubnetworkRole.fromValue(map['role'] as String)),
      secondaryIpRanges: map['secondaryIpRanges'] == null ? null : pulumi.Output.create<List<SubnetworkSecondaryRange>>(pulumi.Input.decodeList<SubnetworkSecondaryRange>(map['secondaryIpRanges'], (value) => SubnetworkSecondaryRange.fromMap((value as Map).cast<String, dynamic>()))),
      stackType: map['stackType'] == null ? null : pulumi.Output.create<SubnetworkStackType>(SubnetworkStackType.fromValue(map['stackType'] as String)),
      vlans: map['vlans'] == null ? null : pulumi.Output.create<List<int>>((map['vlans'] as List).cast<int>()),
    );
  }
}
