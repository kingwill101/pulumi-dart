...
class SubnetworkArgs {
  ...
  factory SubnetworkArgs.fromMap(Map<String, dynamic> map) {
    return SubnetworkArgs(
      aggregationInterval: map['aggregationInterval'] == null ? null : (SubnetworkAggregationInterval.fromValue(map['aggregationInterval'] as String)).input(),
      ...
      enableFlowLogs: map['enableFlowLogs'] == null ? null : (map['enableFlowLogs'] as bool).input(),
      enableL2: map['enableL2'] == null ? null : (map['enableL2'] as bool).input(),
      enablePrivateV6Access: map['enablePrivateV6Access'] == null ? null : (map['enablePrivateV6Access'] as bool).input(),
      ...
      ipv6AccessType: map['ipv6AccessType'] == null ? null : (SubnetworkIpv6AccessType.fromValue(map['ipv6AccessType'] as String)).input(),
      logConfig: map['logConfig'] == null ? null : (SubnetworkLogConfig.fromMap((map['logConfig'] as Map).cast<String, dynamic>())).input(),
      metadata: map['metadata'] == null ? null : (SubnetworkMetadata.fromValue(map['metadata'] as String)).input(),
      name: map['name'] == null ? null : (map['name'] as String).input(),
      network: map['network'] == null ? null : (map['network'] as String).input(),
      privateIpGoogleAccess: map['privateIpGoogleAccess'] == null ? null : (map['privateIpGoogleAccess'] as bool).input(),
      privateIpv6GoogleAccess: map['privateIpv6GoogleAccess'] == null ? null : (SubnetworkPrivateIpv6GoogleAccess.fromValue(map['privateIpv6GoogleAccess'] as String)).input(),
      project: map['project'] == null ? null : (map['project'] as String).input(),
      purpose: map['purpose'] == null ? null : (SubnetworkPurpose.fromValue(map['purpose'] as String)).input(),
      region: (map['region'] as String).input(),
      requestId: map['requestId'] == null ? null : (map['requestId'] as String).input(),
      reservedInternalRange: map['reservedInternalRange'] == null ? null : (map['reservedInternalRange'] as String).input(),
      role: map['role'] == null ? null : (SubnetworkRole.fromValue(map['role'] as String)).input(),
      secondaryIpRanges: map['secondaryIpRanges'] == null ? null : (pulumi.Input.decodeList<SubnetworkSecondaryRange>(map['secondaryIpRanges'], (value) => SubnetworkSecondaryRange.fromMap((value as Map).cast<String, dynamic>()))).input(),
      stackType: map['stackType'] == null ? null : (SubnetworkStackType.fromValue(map['stackType'] as String)).input(),
      vlans: map['vlans'] == null ? null : ((map['vlans'] as List).cast<int>()).input(),
    );
  }
}
