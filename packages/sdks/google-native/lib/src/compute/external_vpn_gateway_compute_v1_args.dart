...
class ExternalVpnGatewayComputeV1Args {
  ...
  const ExternalVpnGatewayComputeV1Args({
    this.description,
    this.interfaces,
    this.labels,
    this.name,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'project': ?project,
      'redundancyType': ?pulumi.Input.mapOptionalInputValue<ExternalVpnGatewayRedundancyTypeComputeV1, String>(redundancyType, (value) => value.wireValue),
      'requestId': ?requestId,
    };
  }
  ...
  factory ExternalVpnGatewayComputeV1Args.fromMap(Map<String, dynamic> map) {
    return ExternalVpnGatewayComputeV1Args(
      ...
      interfaces: (() { final guardedValue = map['interfaces']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ExternalVpnGatewayInterfaceComputeV1>(guardedValue, (value) => ExternalVpnGatewayInterfaceComputeV1.fromMap((value as Map).cast<String, dynamic>()))); })(),
      labels: (() { final guardedValue = map['labels']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      project: (() { final guardedValue = map['project']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      redundancyType: (() { final guardedValue = map['redundancyType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ExternalVpnGatewayRedundancyTypeComputeV1.fromValue(guardedValue as String)); })(),
