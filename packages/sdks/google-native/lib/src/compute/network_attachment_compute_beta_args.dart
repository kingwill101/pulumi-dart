...
class NetworkAttachmentComputeBetaArgs {
  ...
  const NetworkAttachmentComputeBetaArgs({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'connectionPreference': ?pulumi.Input.mapOptionalInputValue<NetworkAttachmentConnectionPreferenceComputeBeta, String>(connectionPreference, (value) => value.wireValue),
  ...
  factory NetworkAttachmentComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return NetworkAttachmentComputeBetaArgs(
      connectionPreference: (() { final guardedValue = map['connectionPreference']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkAttachmentConnectionPreferenceComputeBeta.fromValue(guardedValue as String)); })(),
