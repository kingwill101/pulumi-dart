...
class RouterNatRuleResponse {
  ...
  final pulumi.Input<RouterNatRuleActionResponse> action;
  ...
  /// Creates a new [RouterNatRuleResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'action': pulumi.Input.mapInputValue<RouterNatRuleActionResponse, Map<String, dynamic>>(action, (value) => value.toMap()),
  ...
  factory RouterNatRuleResponse.fromMap(Map<String, dynamic> map) {
    return RouterNatRuleResponse(
      action: pulumi.Input.fromValue(RouterNatRuleActionResponse.fromMap((map['action']! as Map).cast<String, dynamic>())),
