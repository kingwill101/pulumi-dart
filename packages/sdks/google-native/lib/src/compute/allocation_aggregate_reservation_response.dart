...
class AllocationAggregateReservationResponse {
  ...
  factory AllocationAggregateReservationResponse.fromMap(Map<String, dynamic> map) {
    return AllocationAggregateReservationResponse(
      inUseResources: (pulumi.Input.decodeList<AllocationAggregateReservationReservedResourceInfoResponse>(map['inUseResources'], (value) => AllocationAggregateReservationReservedResourceInfoResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      reservedResources: (pulumi.Input.decodeList<AllocationAggregateReservationReservedResourceInfoResponse>(map['reservedResources'], (value) => AllocationAggregateReservationReservedResourceInfoResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
