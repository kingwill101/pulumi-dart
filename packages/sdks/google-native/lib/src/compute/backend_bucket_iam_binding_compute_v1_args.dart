...
/// {@template pulumi_compute_v1_backend_bucket_iam_binding_compute_v1_args_doc}
/// The set of arguments for BackendBucketIamBinding.
/// {@endtemplate}
/// {@macro pulumi_compute_v1_backend_bucket_iam_binding_compute_v1_args_doc}
class BackendBucketIamBindingComputeV1Args {
  ...
  /// Creates a new [BackendBucketIamBindingComputeV1Args].
  ...
  const BackendBucketIamBindingComputeV1Args({
    this.condition,
  ...
  factory BackendBucketIamBindingComputeV1Args.fromMap(Map<String, dynamic> map) {
    return BackendBucketIamBindingComputeV1Args(
