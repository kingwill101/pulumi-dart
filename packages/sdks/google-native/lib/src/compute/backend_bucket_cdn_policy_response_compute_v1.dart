...
class BackendBucketCdnPolicyResponseComputeV1 {
  ...
  factory BackendBucketCdnPolicyResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return BackendBucketCdnPolicyResponseComputeV1(
      bypassCacheOnRequestHeaders: (pulumi.Input.decodeList<BackendBucketCdnPolicyBypassCacheOnRequestHeaderResponseComputeV1>(map['bypassCacheOnRequestHeaders'], (value) => BackendBucketCdnPolicyBypassCacheOnRequestHeaderResponseComputeV1.fromMap((value as Map).cast<String, dynamic>()))).input(),
      cacheKeyPolicy: (BackendBucketCdnPolicyCacheKeyPolicyResponseComputeV1.fromMap((map['cacheKeyPolicy'] as Map).cast<String, dynamic>())).input(),
      ...
      negativeCachingPolicy: (pulumi.Input.decodeList<BackendBucketCdnPolicyNegativeCachingPolicyResponseComputeV1>(map['negativeCachingPolicy'], (value) => BackendBucketCdnPolicyNegativeCachingPolicyResponseComputeV1.fromMap((value as Map).cast<String, dynamic>()))).input(),
