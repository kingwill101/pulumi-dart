...
import 'backend_bucket_cdn_policy_bypass_cache_on_request_header_response_compute_v1.dart';
import 'backend_bucket_cdn_policy_cache_key_policy_response_compute_v1.dart';
import 'backend_bucket_cdn_policy_negative_caching_policy_response_compute_v1.dart';

/// Message containing Cloud CDN configuration for a backend bucket.
class BackendBucketCdnPolicyResponseComputeV1 {
  /// Bypass the cache when the specified request headers are matched - e.g. Pragma or Authorization headers. Up to 5 headers can be specified. The cache is bypassed for all cdnPolicy.cacheMode settings.
  final pulumi.Input<List<BackendBucketCdnPolicyBypassCacheOnRequestHeaderResponseComputeV1>> bypassCacheOnRequestHeaders;
  /// The CacheKeyPolicy for this CdnPolicy.
  final pulumi.Input<BackendBucketCdnPolicyCacheKeyPolicyResponseComputeV1> cacheKeyPolicy;
  ...
  final pulumi.Input<List<BackendBucketCdnPolicyNegativeCachingPolicyResponseComputeV1>> negativeCachingPolicy;
  ...
  /// Creates a new [BackendBucketCdnPolicyResponseComputeV1].
  ...
  const BackendBucketCdnPolicyResponseComputeV1({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'cacheKeyPolicy': pulumi.Input.mapInputValue<BackendBucketCdnPolicyCacheKeyPolicyResponseComputeV1, Map<String, dynamic>>(cacheKeyPolicy, (value) => value.toMap()),
      'cacheMode': cacheMode,
      'clientTtl': clientTtl,
      'defaultTtl': defaultTtl,
      'maxTtl': maxTtl,
      'negativeCaching': negativeCaching,
      'negativeCachingPolicy': pulumi.Input.mapInputValue<List<BackendBucketCdnPolicyNegativeCachingPolicyResponseComputeV1>, List<Map<String, dynamic>>>(negativeCachingPolicy, (value) => pulumi.Input.encodeList<BackendBucketCdnPolicyNegativeCachingPolicyResponseComputeV1, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory BackendBucketCdnPolicyResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return BackendBucketCdnPolicyResponseComputeV1(
      bypassCacheOnRequestHeaders: pulumi.Input.fromValue(pulumi.Input.decodeList<BackendBucketCdnPolicyBypassCacheOnRequestHeaderResponseComputeV1>(map['bypassCacheOnRequestHeaders']!, (value) => BackendBucketCdnPolicyBypassCacheOnRequestHeaderResponseComputeV1.fromMap((value as Map).cast<String, dynamic>()))),
      cacheKeyPolicy: pulumi.Input.fromValue(BackendBucketCdnPolicyCacheKeyPolicyResponseComputeV1.fromMap((map['cacheKeyPolicy']! as Map).cast<String, dynamic>())),
      ...
      negativeCachingPolicy: pulumi.Input.fromValue(pulumi.Input.decodeList<BackendBucketCdnPolicyNegativeCachingPolicyResponseComputeV1>(map['negativeCachingPolicy']!, (value) => BackendBucketCdnPolicyNegativeCachingPolicyResponseComputeV1.fromMap((value as Map).cast<String, dynamic>()))),
