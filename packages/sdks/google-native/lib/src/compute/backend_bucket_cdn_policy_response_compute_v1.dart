...
class BackendBucketCdnPolicyResponseComputeV1 {
  ...
  final pulumi.Input<
    List<BackendBucketCdnPolicyBypassCacheOnRequestHeaderResponseComputeV1>
  >
  bypassCacheOnRequestHeaders;

  /// The CacheKeyPolicy for this CdnPolicy.
  final pulumi.Input<BackendBucketCdnPolicyCacheKeyPolicyResponseComputeV1>
  cacheKeyPolicy;
  ...
  final pulumi.Input<
    List<BackendBucketCdnPolicyNegativeCachingPolicyResponseComputeV1>
  >
