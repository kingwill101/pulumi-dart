    ...
    return <String, dynamic>{
      ...
      'conditions':
          pulumi.Input.mapInputValue<
            List<ConditionResponseComputeV1>,
      ...
      'logConfigs':
          pulumi.Input.mapInputValue<
            List<LogConfigResponseComputeV1>,
            List<Map<String, dynamic>>
          >(
            logConfigs,
            (value) =>
  ...
  factory RuleResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return RuleResponseComputeV1(
      ...
      conditions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ConditionResponseComputeV1>(
          map['conditions']!,
          (value) => ConditionResponseComputeV1.fromMap(
      ...
      logConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<LogConfigResponseComputeV1>(
          map['logConfigs']!,
          (value) => LogConfigResponseComputeV1.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
