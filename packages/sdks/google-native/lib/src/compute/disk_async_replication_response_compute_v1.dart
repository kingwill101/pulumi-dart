...
class DiskAsyncReplicationResponseComputeV1 {
  ...
  /// Creates a new [DiskAsyncReplicationResponseComputeV1].
  ...
  DiskAsyncReplicationResponseComputeV1({
  ...
  factory DiskAsyncReplicationResponseComputeV1.fromMap(
    Map<String, dynamic> map,
  ) {
    return DiskAsyncReplicationResponseComputeV1(
      consistencyGroupPolicy: pulumi.Input.fromValue(
        map['consistencyGroupPolicy'] as String,
      ),
      consistencyGroupPolicyId: pulumi.Input.fromValue(
        map['consistencyGroupPolicyId'] as String,
      ),
