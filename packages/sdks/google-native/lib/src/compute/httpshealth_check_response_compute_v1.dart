...
class HTTPSHealthCheckResponseComputeV1 {
  ...
  /// Creates a new [HTTPSHealthCheckResponseComputeV1].
  ...
  const HTTPSHealthCheckResponseComputeV1({
    required this.host,
    required this.port,
  ...
  factory HTTPSHealthCheckResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return HTTPSHealthCheckResponseComputeV1(
