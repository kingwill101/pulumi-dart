...
class ConsistentHashLoadBalancerSettingsResponseComputeBeta {
  ...
  final pulumi.Input<ConsistentHashLoadBalancerSettingsHttpCookieResponseComputeBeta> httpCookie;
  ...
  const ConsistentHashLoadBalancerSettingsResponseComputeBeta({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'httpCookie': pulumi.Input.mapInputValue<ConsistentHashLoadBalancerSettingsHttpCookieResponseComputeBeta, Map<String, dynamic>>(httpCookie, (value) => value.toMap()),
      'httpHeaderName': httpHeaderName,
      'minimumRingSize': minimumRingSize,
    };
  }

  factory ConsistentHashLoadBalancerSettingsResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return ConsistentHashLoadBalancerSettingsResponseComputeBeta(
      httpCookie: pulumi.Input.fromValue(ConsistentHashLoadBalancerSettingsHttpCookieResponseComputeBeta.fromMap((map['httpCookie']! as Map).cast<String, dynamic>())),
