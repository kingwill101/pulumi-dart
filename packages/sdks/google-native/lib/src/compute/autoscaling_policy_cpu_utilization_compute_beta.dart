...
class AutoscalingPolicyCpuUtilizationComputeBeta {
  ...
  const AutoscalingPolicyCpuUtilizationComputeBeta({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'predictiveMethod': ?pulumi.Input.mapOptionalInputValue<AutoscalingPolicyCpuUtilizationPredictiveMethodComputeBeta, String>(predictiveMethod, (value) => value.wireValue),
  ...
  factory AutoscalingPolicyCpuUtilizationComputeBeta.fromMap(Map<String, dynamic> map) {
    return AutoscalingPolicyCpuUtilizationComputeBeta(
      predictiveMethod: (() { final guardedValue = map['predictiveMethod']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AutoscalingPolicyCpuUtilizationPredictiveMethodComputeBeta.fromValue(guardedValue as String)); })(),
