...
/// {@template pulumi_compute_v1_node_template_iam_binding_compute_v1_args_doc}
/// The set of arguments for NodeTemplateIamBinding.
/// {@endtemplate}
/// {@macro pulumi_compute_v1_node_template_iam_binding_compute_v1_args_doc}
class NodeTemplateIamBindingComputeV1Args {
  ...
  /// Creates a new [NodeTemplateIamBindingComputeV1Args].
  ...
  const NodeTemplateIamBindingComputeV1Args({
    this.condition,
  ...
  factory NodeTemplateIamBindingComputeV1Args.fromMap(Map<String, dynamic> map) {
