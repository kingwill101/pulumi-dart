...
class HelpResponse {
  ...
  final pulumi.Input<List<HelpLinkResponse>> links;
  ...
  factory HelpResponse.fromMap(Map<String, dynamic> map) {
    return HelpResponse(
      links: pulumi.Input.fromValue(pulumi.Input.decodeList<HelpLinkResponse>(map['links']!, (value) => HelpLinkResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
