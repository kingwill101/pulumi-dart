...
/// {@template pulumi_compute_beta_node_group_iam_binding_compute_beta_args_doc}
/// The set of arguments for NodeGroupIamBinding.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_node_group_iam_binding_compute_beta_args_doc}
class NodeGroupIamBindingComputeBetaArgs {
  ...
  /// Creates a new [NodeGroupIamBindingComputeBetaArgs].
  ...
  const NodeGroupIamBindingComputeBetaArgs({
    this.condition,
  ...
  factory NodeGroupIamBindingComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return NodeGroupIamBindingComputeBetaArgs(
