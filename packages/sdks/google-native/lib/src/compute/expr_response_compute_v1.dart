...
class ExprResponseComputeV1 {
  ...
  /// Creates a new [ExprResponseComputeV1].
  ...
  factory ExprResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return ExprResponseComputeV1(
