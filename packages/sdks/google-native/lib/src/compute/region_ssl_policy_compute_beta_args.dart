...
class RegionSslPolicyComputeBetaArgs {
  ...
  RegionSslPolicyComputeBetaArgs({
    ...
    pulumi.Output<RegionSslPolicyMinTlsVersionComputeBeta>? minTlsVersion,
    pulumi.Output<String>? name,
    pulumi.Output<RegionSslPolicyProfileComputeBeta>? profile,
    ...
    pulumi.Output<String>? requestId,
      ...
      minTlsVersion = pulumi.Input.asOptionalInput<RegionSslPolicyMinTlsVersionComputeBeta>(minTlsVersion),
      name = pulumi.Input.asOptionalInput<String>(name),
      profile = pulumi.Input.asOptionalInput<RegionSslPolicyProfileComputeBeta>(profile),
  ...
  factory RegionSslPolicyComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return RegionSslPolicyComputeBetaArgs(
      ...
      minTlsVersion: map['minTlsVersion'] == null ? null : pulumi.Output.create<RegionSslPolicyMinTlsVersionComputeBeta>(RegionSslPolicyMinTlsVersionComputeBeta.fromValue(map['minTlsVersion'] as String)),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      profile: map['profile'] == null ? null : pulumi.Output.create<RegionSslPolicyProfileComputeBeta>(RegionSslPolicyProfileComputeBeta.fromValue(map['profile'] as String)),
