...
class RegionSslPolicyComputeBetaArgs {
  ...
  const RegionSslPolicyComputeBetaArgs({
    this.customFeatures,
    this.description,
    this.minTlsVersion,
    this.name,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'minTlsVersion': ?pulumi.Input.mapOptionalInputValue<RegionSslPolicyMinTlsVersionComputeBeta, String>(minTlsVersion, (value) => value.wireValue),
      'name': ?name,
      'profile': ?pulumi.Input.mapOptionalInputValue<RegionSslPolicyProfileComputeBeta, String>(profile, (value) => value.wireValue),
      'project': ?project,
      'region': region,
      'requestId': ?requestId,
    };
  ...
  factory RegionSslPolicyComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return RegionSslPolicyComputeBetaArgs(
      ...
      minTlsVersion: (() { final guardedValue = map['minTlsVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionSslPolicyMinTlsVersionComputeBeta.fromValue(guardedValue as String)); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      profile: (() { final guardedValue = map['profile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionSslPolicyProfileComputeBeta.fromValue(guardedValue as String)); })(),
