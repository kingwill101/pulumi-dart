...
import 'target_ssl_proxy_compute_beta_args.dart';

/// Creates a TargetSslProxy resource in the specified project using the data included in the request.
class TargetSslProxyComputeBeta extends pulumi.CustomResource {
  ...
  /// Creates a new [TargetSslProxyComputeBeta].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [TargetSslProxyComputeBeta]. {@macro pulumi_compute_beta_target_ssl_proxy_compute_beta_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  TargetSslProxyComputeBeta(
    String name, {
    TargetSslProxyComputeBetaArgs? args,
