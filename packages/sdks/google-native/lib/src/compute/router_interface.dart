...
import 'router_interface_ip_version.dart';

class RouterInterface {
  /// IP address and range of the interface. The IP range must be in the RFC3927 link-local IP address space. The value must be a CIDR-formatted string, for example: 169.254.0.1/30. NOTE: Do not truncate the address as it represents the IP address of the interface.
  final String? ipRange;
  /// IP version of this interface.
  final RouterInterfaceIpVersion? ipVersion;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'ipRange': ?ipRange,
      'ipVersion': ?ipVersion == null ? null : ipVersion!.value,
  ...
  factory RouterInterface.fromMap(Map<String, dynamic> map) {
    return RouterInterface(
      ...
      ipVersion: map['ipVersion'] == null ? null : RouterInterfaceIpVersion.fromValue(map['ipVersion'] as String),
      linkedInterconnectAttachment: map['linkedInterconnectAttachment'] == null ? null : map['linkedInterconnectAttachment'] as String,
      linkedVpnTunnel: map['linkedVpnTunnel'] == null ? null : map['linkedVpnTunnel'] as String,
