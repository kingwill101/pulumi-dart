...
class RouterInterface {
  ...
  final pulumi.Input<RouterInterfaceIpVersion>? ipVersion;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'ipRange': ?ipRange,
      'ipVersion': ?pulumi.Input.mapOptionalInputValue<RouterInterfaceIpVersion, String>(ipVersion, (value) => value.wireValue),
  ...
  factory RouterInterface.fromMap(Map<String, dynamic> map) {
    return RouterInterface(
      ...
      ipVersion: (() { final guardedValue = map['ipVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RouterInterfaceIpVersion.fromValue(guardedValue as String)); })(),
