...
class RouterInterface {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'ipRange': ?ipRange,
      'ipVersion': ?pulumi.Input.mapOptionalInputValue<RouterInterfaceIpVersion, String>(ipVersion, (value) => value.value),
  ...
  factory RouterInterface.fromMap(Map<String, dynamic> map) {
    return RouterInterface(
      ...
      ipVersion: map['ipVersion'] == null ? null : (RouterInterfaceIpVersion.fromValue(map['ipVersion']! as String)).input(),
