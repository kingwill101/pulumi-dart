...
class FirewallAllowedItem {
  ...
  /// Creates a new [FirewallAllowedItem].
  ...
  FirewallAllowedItem({this.ipProtocol, this.ports});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'ipProtocol': ?ipProtocol, 'ports': ?ports};
  }

  factory FirewallAllowedItem.fromMap(Map<String, dynamic> map) {
    return FirewallAllowedItem(
      ipProtocol: (() {
