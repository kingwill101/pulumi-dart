...
class SourceInstanceParamsResponseComputeBeta {
  ...
  factory SourceInstanceParamsResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return SourceInstanceParamsResponseComputeBeta(
      diskConfigs: (pulumi.Input.decodeList<DiskInstantiationConfigResponseComputeBeta>(map['diskConfigs'], (value) => DiskInstantiationConfigResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
