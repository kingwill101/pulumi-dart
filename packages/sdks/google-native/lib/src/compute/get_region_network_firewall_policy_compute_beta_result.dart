...
class GetRegionNetworkFirewallPolicyComputeBetaResult {
  /// A list of associations that belong to this firewall policy.
  final List<FirewallPolicyAssociationResponseComputeBeta> associations;
  ...
  final List<FirewallPolicyRuleResponseComputeBeta> rules;
  ...
  /// Creates a new [GetRegionNetworkFirewallPolicyComputeBetaResult].
  ...
  const GetRegionNetworkFirewallPolicyComputeBetaResult({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'associations': pulumi.Input.encodeList<FirewallPolicyAssociationResponseComputeBeta, Map<String, dynamic>>(associations, (value) => value.toMap()),
      ...
      'rules': pulumi.Input.encodeList<FirewallPolicyRuleResponseComputeBeta, Map<String, dynamic>>(rules, (value) => value.toMap()),
      'selfLink': selfLink,
  ...
  factory GetRegionNetworkFirewallPolicyComputeBetaResult.fromMap(Map<String, dynamic> map) {
    return GetRegionNetworkFirewallPolicyComputeBetaResult(
      associations: pulumi.Input.decodeList<FirewallPolicyAssociationResponseComputeBeta>(map['associations']!, (value) => FirewallPolicyAssociationResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
      ...
      rules: pulumi.Input.decodeList<FirewallPolicyRuleResponseComputeBeta>(map['rules']!, (value) => FirewallPolicyRuleResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>())),
