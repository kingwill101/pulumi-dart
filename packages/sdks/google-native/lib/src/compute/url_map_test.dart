...
class UrlMapTest {
  ...
  factory UrlMapTest.fromMap(Map<String, dynamic> map) {
    return UrlMapTest(
      backendServiceWeight: (() { final guardedValue = map['backendServiceWeight']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      expectedUrlRedirect: (() { final guardedValue = map['expectedUrlRedirect']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
