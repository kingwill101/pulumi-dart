...
class AWSV4SignatureResponseComputeBeta {
  ...
  /// Creates a new [AWSV4SignatureResponseComputeBeta].
  ...
  const AWSV4SignatureResponseComputeBeta({
  ...
  factory AWSV4SignatureResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return AWSV4SignatureResponseComputeBeta(
