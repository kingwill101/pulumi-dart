...
class GetNetworkEndpointGroupComputeV1Result {
  ...
  /// Creates a new [GetNetworkEndpointGroupComputeV1Result].
  ...
  const GetNetworkEndpointGroupComputeV1Result({
  ...
  factory GetNetworkEndpointGroupComputeV1Result.fromMap(Map<String, dynamic> map) {
    return GetNetworkEndpointGroupComputeV1Result(
      annotations: (map['annotations'] as Map).cast<String, String>(),
      appEngine: NetworkEndpointGroupAppEngineResponseComputeV1.fromMap((map['appEngine']! as Map).cast<String, dynamic>()),
      cloudFunction: NetworkEndpointGroupCloudFunctionResponseComputeV1.fromMap((map['cloudFunction']! as Map).cast<String, dynamic>()),
      cloudRun: NetworkEndpointGroupCloudRunResponseComputeV1.fromMap((map['cloudRun']! as Map).cast<String, dynamic>()),
      ...
      pscData: NetworkEndpointGroupPscDataResponseComputeV1.fromMap((map['pscData']! as Map).cast<String, dynamic>()),
