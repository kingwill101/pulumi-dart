...
class RouterComputeBetaArgs {
  ...
  factory RouterComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return RouterComputeBetaArgs(
      bgp: (() { final guardedValue = map['bgp']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RouterBgpComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      bgpPeers: (() { final guardedValue = map['bgpPeers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RouterBgpPeerComputeBeta>(guardedValue, (value) => RouterBgpPeerComputeBeta.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      interfaces: (() { final guardedValue = map['interfaces']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RouterInterfaceComputeBeta>(guardedValue, (value) => RouterInterfaceComputeBeta.fromMap((value as Map).cast<String, dynamic>()))); })(),
      md5AuthenticationKeys: (() { final guardedValue = map['md5AuthenticationKeys']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RouterMd5AuthenticationKeyComputeBeta>(guardedValue, (value) => RouterMd5AuthenticationKeyComputeBeta.fromMap((value as Map).cast<String, dynamic>()))); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      nats: (() { final guardedValue = map['nats']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RouterNatComputeBeta>(guardedValue, (value) => RouterNatComputeBeta.fromMap((value as Map).cast<String, dynamic>()))); })(),
