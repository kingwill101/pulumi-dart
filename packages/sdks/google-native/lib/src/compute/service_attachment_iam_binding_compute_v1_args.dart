...
/// {@template pulumi_compute_v1_service_attachment_iam_binding_compute_v1_args_doc}
/// The set of arguments for ServiceAttachmentIamBinding.
/// {@endtemplate}
/// {@macro pulumi_compute_v1_service_attachment_iam_binding_compute_v1_args_doc}
class ServiceAttachmentIamBindingComputeV1Args {
  ...
  /// Creates a new [ServiceAttachmentIamBindingComputeV1Args].
  ...
  const ServiceAttachmentIamBindingComputeV1Args({
    this.condition,
  ...
  factory ServiceAttachmentIamBindingComputeV1Args.fromMap(Map<String, dynamic> map) {
