...
/// {@template pulumi_compute_v1_snapshot_iam_member_compute_v1_args_doc}
/// The set of arguments for SnapshotIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_v1_snapshot_iam_member_compute_v1_args_doc}
class SnapshotIamMemberComputeV1Args {
  ...
  /// Creates a new [SnapshotIamMemberComputeV1Args].
  ...
  const SnapshotIamMemberComputeV1Args({
    this.condition,
  ...
  factory SnapshotIamMemberComputeV1Args.fromMap(Map<String, dynamic> map) {
    return SnapshotIamMemberComputeV1Args(
