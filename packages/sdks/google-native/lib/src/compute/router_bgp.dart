...
class RouterBgp {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'advertiseMode':
          ?pulumi.Input.mapOptionalInputValue<RouterBgpAdvertiseMode, String>(
            advertiseMode,
            (value) => value.wireValue,
          ),
      'advertisedGroups':
          ?pulumi.Input.mapOptionalInputValue<
            List<RouterBgpAdvertisedGroupsItem>,
            List<String>
          >(
            advertisedGroups,
            (value) =>
    ...
    return RouterBgp(
      advertiseMode: (() {
        ...
        return pulumi.Input.fromValue(
          RouterBgpAdvertiseMode.fromValue(guardedValue as String),
        );
      })(),
      advertisedGroups: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RouterBgpAdvertisedGroupsItem>(
            guardedValue,
            (value) => RouterBgpAdvertisedGroupsItem.fromValue(value as String),
          ),
        );
      })(),
      advertisedIpRanges: (() {
