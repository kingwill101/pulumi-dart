...
class GRPCHealthCheck {
  ...
  final pulumi.Input<GRPCHealthCheckPortSpecification>? portSpecification;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'port': ?port,
      'portName': ?portName,
      'portSpecification': ?pulumi.Input.mapOptionalInputValue<GRPCHealthCheckPortSpecification, String>(portSpecification, (value) => value.wireValue),
    };
  }
  ...
  factory GRPCHealthCheck.fromMap(Map<String, dynamic> map) {
    return GRPCHealthCheck(
      ...
      portSpecification: (() { final guardedValue = map['portSpecification']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GRPCHealthCheckPortSpecification.fromValue(guardedValue as String)); })(),
    );
  }
}
