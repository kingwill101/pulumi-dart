...
class SecurityPolicyRuleComputeBeta {
  ...
  final SecurityPolicyRulePreconfiguredWafConfigComputeBeta? preconfiguredWafConfig;
  ...
  factory SecurityPolicyRuleComputeBeta.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRuleComputeBeta(
      ...
      direction: map['direction'] == null ? null : SecurityPolicyRuleDirectionComputeBeta.fromValue(map['direction'] as String),
      enableLogging: map['enableLogging'] == null ? null : map['enableLogging'] as bool,
      headerAction: map['headerAction'] == null ? null : SecurityPolicyRuleHttpHeaderActionComputeBeta.fromMap((map['headerAction'] as Map).cast<String, dynamic>()),
      match: map['match'] == null ? null : SecurityPolicyRuleMatcherComputeBeta.fromMap((map['match'] as Map).cast<String, dynamic>()),
      networkMatch: map['networkMatch'] == null ? null : SecurityPolicyRuleNetworkMatcherComputeBeta.fromMap((map['networkMatch'] as Map).cast<String, dynamic>()),
      preconfiguredWafConfig: map['preconfiguredWafConfig'] == null ? null : SecurityPolicyRulePreconfiguredWafConfigComputeBeta.fromMap((map['preconfiguredWafConfig'] as Map).cast<String, dynamic>()),
      preview: map['preview'] == null ? null : map['preview'] as bool,
      priority: map['priority'] == null ? null : map['priority'] as int,
      rateLimitOptions: map['rateLimitOptions'] == null ? null : SecurityPolicyRuleRateLimitOptionsComputeBeta.fromMap((map['rateLimitOptions'] as Map).cast<String, dynamic>()),
      redirectOptions: map['redirectOptions'] == null ? null : SecurityPolicyRuleRedirectOptionsComputeBeta.fromMap((map['redirectOptions'] as Map).cast<String, dynamic>()),
