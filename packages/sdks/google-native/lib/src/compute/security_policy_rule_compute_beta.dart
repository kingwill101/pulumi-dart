...
class SecurityPolicyRuleComputeBeta {
  ...
  final pulumi.Input<SecurityPolicyRuleHttpHeaderActionComputeBeta>?
  headerAction;
  ...
  final pulumi.Input<SecurityPolicyRulePreconfiguredWafConfigComputeBeta>?
  ...
  final pulumi.Input<SecurityPolicyRuleRateLimitOptionsComputeBeta>?
  rateLimitOptions;
    ...
    return <String, dynamic>{
      ...
      'direction':
          ?pulumi.Input.mapOptionalInputValue<
            SecurityPolicyRuleDirectionComputeBeta,
            String
