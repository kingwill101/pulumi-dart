...
class SecurityPolicyRuleComputeBeta {
  ...
  const SecurityPolicyRuleComputeBeta({
    this.action,
    this.description,
    this.direction,
    this.enableLogging,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'direction': ?pulumi.Input.mapOptionalInputValue<SecurityPolicyRuleDirectionComputeBeta, String>(direction, (value) => value.wireValue),
  ...
  factory SecurityPolicyRuleComputeBeta.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRuleComputeBeta(
      ...
      direction: (() { final guardedValue = map['direction']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SecurityPolicyRuleDirectionComputeBeta.fromValue(guardedValue as String)); })(),
      ...
      headerAction: (() { final guardedValue = map['headerAction']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SecurityPolicyRuleHttpHeaderActionComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      match: (() { final guardedValue = map['match']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SecurityPolicyRuleMatcherComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      networkMatch: (() { final guardedValue = map['networkMatch']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SecurityPolicyRuleNetworkMatcherComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      preconfiguredWafConfig: (() { final guardedValue = map['preconfiguredWafConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SecurityPolicyRulePreconfiguredWafConfigComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      rateLimitOptions: (() { final guardedValue = map['rateLimitOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SecurityPolicyRuleRateLimitOptionsComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      redirectOptions: (() { final guardedValue = map['redirectOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SecurityPolicyRuleRedirectOptionsComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
