...
class QueuedResourceStatusFailedDataErrorResponse {
  ...
  factory QueuedResourceStatusFailedDataErrorResponse.fromMap(Map<String, dynamic> map) {
    return QueuedResourceStatusFailedDataErrorResponse(
      errors: (pulumi.Input.decodeList<QueuedResourceStatusFailedDataErrorErrorsItemResponse>(map['errors'], (value) => QueuedResourceStatusFailedDataErrorErrorsItemResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
