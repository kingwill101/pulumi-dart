...
/// {@template pulumi_compute_v1_resource_policy_iam_member_compute_v1_args_doc}
/// The set of arguments for ResourcePolicyIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_v1_resource_policy_iam_member_compute_v1_args_doc}
class ResourcePolicyIamMemberComputeV1Args {
  ...
  /// Creates a new [ResourcePolicyIamMemberComputeV1Args].
  ...
  const ResourcePolicyIamMemberComputeV1Args({
    this.condition,
  ...
  factory ResourcePolicyIamMemberComputeV1Args.fromMap(Map<String, dynamic> map) {
    return ResourcePolicyIamMemberComputeV1Args(
