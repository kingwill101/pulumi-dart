...
class MetadataFilterResponseComputeBeta {
  ...
  final pulumi.Input<List<MetadataFilterLabelMatchResponseComputeBeta>> filterLabels;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'filterLabels': pulumi.Input.mapInputValue<List<MetadataFilterLabelMatchResponseComputeBeta>, List<Map<String, dynamic>>>(filterLabels, (value) => pulumi.Input.encodeList<MetadataFilterLabelMatchResponseComputeBeta, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory MetadataFilterResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return MetadataFilterResponseComputeBeta(
      filterLabels: pulumi.Input.fromValue(pulumi.Input.decodeList<MetadataFilterLabelMatchResponseComputeBeta>(map['filterLabels']!, (value) => MetadataFilterLabelMatchResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))),
