...
class MetadataFilterResponseComputeBeta {
  ...
  factory MetadataFilterResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return MetadataFilterResponseComputeBeta(
      filterLabels: (pulumi.Input.decodeList<MetadataFilterLabelMatchResponseComputeBeta>(map['filterLabels'], (value) => MetadataFilterLabelMatchResponseComputeBeta.fromMap((value as Map).cast<String, dynamic>()))).input(),
