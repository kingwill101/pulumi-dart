...
class RegionSecurityPolicyComputeBetaArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'type':
          ?pulumi.Input.mapOptionalInputValue<
            RegionSecurityPolicyTypeComputeBeta,
            String
  ...
  factory RegionSecurityPolicyComputeBetaArgs.fromMap(
    ...
    return RegionSecurityPolicyComputeBetaArgs(
      ...
      type: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RegionSecurityPolicyTypeComputeBeta.fromValue(guardedValue as String),
        );
      })(),
      userDefinedFields: (() {
