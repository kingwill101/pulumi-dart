...
class GetRegionHealthCheckComputeV1Result {
  ...
  const GetRegionHealthCheckComputeV1Result({
  ...
  factory GetRegionHealthCheckComputeV1Result.fromMap(Map<String, dynamic> map) {
    return GetRegionHealthCheckComputeV1Result(
      checkIntervalSec: map['checkIntervalSec'] as int,
      creationTimestamp: map['creationTimestamp'] as String,
      description: map['description'] as String,
      grpcHealthCheck: GRPCHealthCheckResponseComputeV1.fromMap((map['grpcHealthCheck']! as Map).cast<String, dynamic>()),
      healthyThreshold: map['healthyThreshold'] as int,
      http2HealthCheck: HTTP2HealthCheckResponseComputeV1.fromMap((map['http2HealthCheck']! as Map).cast<String, dynamic>()),
      httpHealthCheck: HTTPHealthCheckResponseComputeV1.fromMap((map['httpHealthCheck']! as Map).cast<String, dynamic>()),
      httpsHealthCheck: HTTPSHealthCheckResponseComputeV1.fromMap((map['httpsHealthCheck']! as Map).cast<String, dynamic>()),
      kind: map['kind'] as String,
      logConfig: HealthCheckLogConfigResponseComputeV1.fromMap((map['logConfig']! as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      region: map['region'] as String,
      selfLink: map['selfLink'] as String,
      sslHealthCheck: SSLHealthCheckResponseComputeV1.fromMap((map['sslHealthCheck']! as Map).cast<String, dynamic>()),
      tcpHealthCheck: TCPHealthCheckResponseComputeV1.fromMap((map['tcpHealthCheck']! as Map).cast<String, dynamic>()),
