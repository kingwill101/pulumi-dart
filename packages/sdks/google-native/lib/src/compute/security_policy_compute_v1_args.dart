...
class SecurityPolicyComputeV1Args {
  ...
  const SecurityPolicyComputeV1Args({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'type': ?pulumi.Input.mapOptionalInputValue<SecurityPolicyTypeComputeV1, String>(type, (value) => value.wireValue),
  ...
  factory SecurityPolicyComputeV1Args.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyComputeV1Args(
      ...
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SecurityPolicyTypeComputeV1.fromValue(guardedValue as String)); })(),
