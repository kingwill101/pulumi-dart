...
class SecurityPolicyComputeV1Args {
  ...
  factory SecurityPolicyComputeV1Args.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyComputeV1Args(
      adaptiveProtectionConfig: (() {
        final guardedValue = map['adaptiveProtectionConfig'];
      ...
      advancedOptionsConfig: (() {
        final guardedValue = map['advancedOptionsConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      ddosProtectionConfig: (() {
        final guardedValue = map['ddosProtectionConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      recaptchaOptionsConfig: (() {
        final guardedValue = map['recaptchaOptionsConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      type: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SecurityPolicyTypeComputeV1.fromValue(guardedValue as String),
        );
      })(),
      userDefinedFields: (() {
