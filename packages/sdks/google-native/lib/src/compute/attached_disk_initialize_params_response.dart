...
class AttachedDiskInitializeParamsResponse {
  ...
  const AttachedDiskInitializeParamsResponse({
  ...
  factory AttachedDiskInitializeParamsResponse.fromMap(Map<String, dynamic> map) {
    return AttachedDiskInitializeParamsResponse(
      ...
      licenseCodes: pulumi.Input.fromValue((map['licenseCodes'] as List).cast<String>()),
      ...
      sourceImageEncryptionKey: pulumi.Input.fromValue(CustomerEncryptionKeyResponse.fromMap((map['sourceImageEncryptionKey']! as Map).cast<String, dynamic>())),
      ...
      sourceSnapshotEncryptionKey: pulumi.Input.fromValue(CustomerEncryptionKeyResponse.fromMap((map['sourceSnapshotEncryptionKey']! as Map).cast<String, dynamic>())),
