...
class AttachedDiskInitializeParamsResponse {
  ...
  factory AttachedDiskInitializeParamsResponse.fromMap(
    ...
    return AttachedDiskInitializeParamsResponse(
      ...
      licenseCodes: pulumi.Input.fromValue(
