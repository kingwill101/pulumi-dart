...
class AttachedDiskInitializeParamsResponse {
  ...
  final pulumi.Input<CustomerEncryptionKeyResponse> sourceImageEncryptionKey;
  ...
  final pulumi.Input<CustomerEncryptionKeyResponse> sourceSnapshotEncryptionKey;
  /// The storage pool in which the new disk is created. You can provide this as a partial or full URL to the resource. For example, the following are valid values: - https://www.googleapis.com/compute/v1/projects/project/zones/zone /storagePools/storagePool - projects/project/zones/zone/storagePools/storagePool - zones/zone/storagePools/storagePool
  final pulumi.Input<String> storagePool;

  /// Creates a new [AttachedDiskInitializeParamsResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'sourceImageEncryptionKey': pulumi.Input.mapInputValue<CustomerEncryptionKeyResponse, Map<String, dynamic>>(sourceImageEncryptionKey, (value) => value.toMap()),
      'sourceInstantSnapshot': sourceInstantSnapshot,
      'sourceSnapshot': sourceSnapshot,
      'sourceSnapshotEncryptionKey': pulumi.Input.mapInputValue<CustomerEncryptionKeyResponse, Map<String, dynamic>>(sourceSnapshotEncryptionKey, (value) => value.toMap()),
      'storagePool': storagePool,
    };
  }

  factory AttachedDiskInitializeParamsResponse.fromMap(Map<String, dynamic> map) {
    return AttachedDiskInitializeParamsResponse(
      ...
      licenseCodes: ((map['licenseCodes'] as List).cast<String>()).input(),
      ...
      sourceImageEncryptionKey: (CustomerEncryptionKeyResponse.fromMap((map['sourceImageEncryptionKey'] as Map).cast<String, dynamic>())).input(),
      sourceInstantSnapshot: (map['sourceInstantSnapshot'] as String).input(),
      sourceSnapshot: (map['sourceSnapshot'] as String).input(),
      sourceSnapshotEncryptionKey: (CustomerEncryptionKeyResponse.fromMap((map['sourceSnapshotEncryptionKey'] as Map).cast<String, dynamic>())).input(),
