...
class Principal {
  ...
  factory Principal.fromMap(Map<String, dynamic> map) {
    return Principal(
      ...
      notGroups: map['notGroups'] == null ? null : (map['notGroups'] as List).cast<String>(),
      notIps: map['notIps'] == null ? null : (map['notIps'] as List).cast<String>(),
      notNamespaces: map['notNamespaces'] == null ? null : (map['notNamespaces'] as List).cast<String>(),
      notUsers: map['notUsers'] == null ? null : (map['notUsers'] as List).cast<String>(),
