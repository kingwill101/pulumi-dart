...
class ReservationAffinityComputeBeta {
  ...
  const ReservationAffinityComputeBeta({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'consumeReservationType': ?pulumi.Input.mapOptionalInputValue<ReservationAffinityConsumeReservationTypeComputeBeta, String>(consumeReservationType, (value) => value.wireValue),
      'key': ?key,
      'values': ?values,
    };
  }
  ...
  factory ReservationAffinityComputeBeta.fromMap(Map<String, dynamic> map) {
    return ReservationAffinityComputeBeta(
      consumeReservationType: (() { final guardedValue = map['consumeReservationType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ReservationAffinityConsumeReservationTypeComputeBeta.fromValue(guardedValue as String)); })(),
