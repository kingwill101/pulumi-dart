...
class ClientTlsSettings {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'clientTlsContext': ?pulumi.Input.mapOptionalInputValue<TlsContext, Map<String, dynamic>>(clientTlsContext, (value) => value.toMap()),
      'mode': ?pulumi.Input.mapOptionalInputValue<ClientTlsSettingsMode, String>(mode, (value) => value.wireValue),
      'sni': ?sni,
  ...
  factory ClientTlsSettings.fromMap(Map<String, dynamic> map) {
    return ClientTlsSettings(
      clientTlsContext: (() { final guardedValue = map['clientTlsContext']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TlsContext.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      mode: (() { final guardedValue = map['mode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClientTlsSettingsMode.fromValue(guardedValue as String)); })(),
