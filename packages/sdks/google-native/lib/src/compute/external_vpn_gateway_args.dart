...
class ExternalVpnGatewayArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'project': ?project,
      'redundancyType': ?pulumi.Input.mapOptionalInputValue<ExternalVpnGatewayRedundancyType, String>(redundancyType, (value) => value.wireValue),
      'requestId': ?requestId,
    };
  }
  ...
  factory ExternalVpnGatewayArgs.fromMap(Map<String, dynamic> map) {
    return ExternalVpnGatewayArgs(
      ...
      redundancyType: (() { final guardedValue = map['redundancyType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ExternalVpnGatewayRedundancyType.fromValue(guardedValue as String)); })(),
