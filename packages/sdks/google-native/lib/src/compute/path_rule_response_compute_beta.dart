...
class PathRuleResponseComputeBeta {
  ...
  /// Creates a new [PathRuleResponseComputeBeta].
  ...
  const PathRuleResponseComputeBeta({
  ...
  factory PathRuleResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return PathRuleResponseComputeBeta(
