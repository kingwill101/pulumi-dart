...
import 'instant_snapshot_compute_beta_args.dart';
import 'instant_snapshot_resource_status_response_compute_beta.dart';

/// Creates an instant snapshot in the specified zone.
class InstantSnapshotComputeBeta extends pulumi.CustomResource {
  ...
  late final pulumi.Output<InstantSnapshotResourceStatusResponseComputeBeta> resourceStatus;
  ...
  /// Creates a new [InstantSnapshotComputeBeta].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [InstantSnapshotComputeBeta]. {@macro pulumi_compute_beta_instant_snapshot_compute_beta_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  InstantSnapshotComputeBeta(
    String name, {
    InstantSnapshotComputeBetaArgs? args,
    ...
    resourceStatus = registerOutput<InstantSnapshotResourceStatusResponseComputeBeta>('resourceStatus', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return InstantSnapshotResourceStatusResponseComputeBeta.fromMap((guardedValue as Map).cast<String, dynamic>()); });
