...
class RegionHealthCheckArgs {
  ...
  RegionHealthCheckArgs({
    ...
    pulumi.Output<RegionHealthCheckType>? type,
  ...
  factory RegionHealthCheckArgs.fromMap(Map<String, dynamic> map) {
    return RegionHealthCheckArgs(
      ...
      type: map['type'] == null ? null : pulumi.Output.create<RegionHealthCheckType>(RegionHealthCheckType.fromValue(map['type'] as String)),
