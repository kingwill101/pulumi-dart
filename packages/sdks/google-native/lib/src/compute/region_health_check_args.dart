...
class RegionHealthCheckArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'type': ?pulumi.Input.mapOptionalInputValue<RegionHealthCheckType, String>(type, (value) => value.wireValue),
  ...
  factory RegionHealthCheckArgs.fromMap(Map<String, dynamic> map) {
    return RegionHealthCheckArgs(
      ...
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegionHealthCheckType.fromValue(guardedValue as String)); })(),
