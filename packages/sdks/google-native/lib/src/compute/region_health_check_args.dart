  ...
  factory RegionHealthCheckArgs.fromMap(Map<String, dynamic> map) {
    return RegionHealthCheckArgs(
      ...
      sslHealthCheck: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SSLHealthCheck.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      tcpHealthCheck: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TCPHealthCheck.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      timeoutSec: (() {
      ...
      type: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RegionHealthCheckType.fromValue(guardedValue as String),
        );
      })(),
      udpHealthCheck: (() {
        final guardedValue = map['udpHealthCheck'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          UDPHealthCheck.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      unhealthyThreshold: (() {
