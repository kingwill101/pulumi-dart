...
class SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponseComputeBeta {
  ...
  /// Creates a new [SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponseComputeBeta].
  ...
  const SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponseComputeBeta({
  ...
  factory SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigResponseComputeBeta.fromMap(Map<String, dynamic> map) {
