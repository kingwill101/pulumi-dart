...
class UrlRewriteResponse {
  ...
  /// Creates a new [UrlRewriteResponse].
  ...
  factory UrlRewriteResponse.fromMap(Map<String, dynamic> map) {
    return UrlRewriteResponse(
      ...
      pathTemplateRewrite: pulumi.Input.fromValue(map['pathTemplateRewrite'] as String),
    );
  }
}
