...
import 'snapshot_compute_v1_args.dart';

/// Creates a snapshot in the specified project using the data included in the request. For regular snapshot creation, consider using this method instead of disks.createSnapshot, as this method supports more features, such as creating snapshots in a project different from the source disk project.
class SnapshotComputeV1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<CustomerEncryptionKeyResponseComputeV1> snapshotEncryptionKey;
  ...
  /// Creates a new [SnapshotComputeV1].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [SnapshotComputeV1]. {@macro pulumi_compute_v1_snapshot_compute_v1_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  SnapshotComputeV1(
    String name, {
    SnapshotComputeV1Args? args,
    ...
    autoCreated = registerOutput<bool>('autoCreated');
    chainName = registerOutput<String>('chainName');
    creationSizeBytes = registerOutput<String>('creationSizeBytes');
    ...
    snapshotEncryptionKey = registerOutput<CustomerEncryptionKeyResponseComputeV1>('snapshotEncryptionKey', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return CustomerEncryptionKeyResponseComputeV1.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    sourceDiskForRecoveryCheckpoint = registerOutput<String>('sourceDiskForRecoveryCheckpoint');
    sourceDiskId = registerOutput<String>('sourceDiskId');
    sourceSnapshotSchedulePolicy = registerOutput<String>('sourceSnapshotSchedulePolicy');
    sourceSnapshotSchedulePolicyId = registerOutput<String>('sourceSnapshotSchedulePolicyId');
    status = registerOutput<String>('status');
    storageBytes = registerOutput<String>('storageBytes');
    storageBytesStatus = registerOutput<String>('storageBytesStatus');
