...
class SecurityPolicyRuleRateLimitOptionsComputeV1 {
  ...
  final SecurityPolicyRuleRateLimitOptionsThresholdComputeV1? banThreshold;
  ...
  final SecurityPolicyRuleRateLimitOptionsEnforceOnKeyComputeV1? enforceOnKey;
  /// If specified, any combination of values of enforce_on_key_type/enforce_on_key_name is treated as the key on which ratelimit threshold/action is enforced. You can specify up to 3 enforce_on_key_configs. If enforce_on_key_configs is specified, enforce_on_key must not be specified.
  final List<SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigComputeV1>? enforceOnKeyConfigs;
  ...
  final SecurityPolicyRuleRedirectOptionsComputeV1? exceedRedirectOptions;
  /// Threshold at which to begin ratelimiting.
  final SecurityPolicyRuleRateLimitOptionsThresholdComputeV1? rateLimitThreshold;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'enforceOnKey': ?enforceOnKey == null ? null : enforceOnKey!.value,
      'enforceOnKeyConfigs': ?enforceOnKeyConfigs == null ? null : pulumi.Input.encodeList<SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigComputeV1, Map<String, dynamic>>(enforceOnKeyConfigs!, (value) => value.toMap()),
  ...
  factory SecurityPolicyRuleRateLimitOptionsComputeV1.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRuleRateLimitOptionsComputeV1(
      ...
      banThreshold: map['banThreshold'] == null ? null : SecurityPolicyRuleRateLimitOptionsThresholdComputeV1.fromMap((map['banThreshold'] as Map).cast<String, dynamic>()),
      conformAction: map['conformAction'] == null ? null : map['conformAction'] as String,
      enforceOnKey: map['enforceOnKey'] == null ? null : SecurityPolicyRuleRateLimitOptionsEnforceOnKeyComputeV1.fromValue(map['enforceOnKey'] as String),
      enforceOnKeyConfigs: map['enforceOnKeyConfigs'] == null ? null : pulumi.Input.decodeList<SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigComputeV1>(map['enforceOnKeyConfigs'], (value) => SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      ...
      exceedRedirectOptions: map['exceedRedirectOptions'] == null ? null : SecurityPolicyRuleRedirectOptionsComputeV1.fromMap((map['exceedRedirectOptions'] as Map).cast<String, dynamic>()),
      rateLimitThreshold: map['rateLimitThreshold'] == null ? null : SecurityPolicyRuleRateLimitOptionsThresholdComputeV1.fromMap((map['rateLimitThreshold'] as Map).cast<String, dynamic>()),
    );
  }
}
