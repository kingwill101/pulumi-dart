...
class SecurityPolicyRuleRateLimitOptionsComputeV1 {
  ...
  const SecurityPolicyRuleRateLimitOptionsComputeV1({
    this.banDurationSec,
    this.banThreshold,
    this.conformAction,
    this.enforceOnKey,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'enforceOnKey': ?pulumi.Input.mapOptionalInputValue<SecurityPolicyRuleRateLimitOptionsEnforceOnKeyComputeV1, String>(enforceOnKey, (value) => value.wireValue),
  ...
  factory SecurityPolicyRuleRateLimitOptionsComputeV1.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRuleRateLimitOptionsComputeV1(
      ...
      banThreshold: (() { final guardedValue = map['banThreshold']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SecurityPolicyRuleRateLimitOptionsThresholdComputeV1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      enforceOnKey: (() { final guardedValue = map['enforceOnKey']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SecurityPolicyRuleRateLimitOptionsEnforceOnKeyComputeV1.fromValue(guardedValue as String)); })(),
      enforceOnKeyConfigs: (() { final guardedValue = map['enforceOnKeyConfigs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigComputeV1>(guardedValue, (value) => SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigComputeV1.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      exceedRedirectOptions: (() { final guardedValue = map['exceedRedirectOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SecurityPolicyRuleRedirectOptionsComputeV1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      rateLimitThreshold: (() { final guardedValue = map['rateLimitThreshold']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SecurityPolicyRuleRateLimitOptionsThresholdComputeV1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
