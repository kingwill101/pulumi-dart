...
class SecurityPolicyRuleRateLimitOptionsComputeV1 {
  ...
  final pulumi.Input<SecurityPolicyRuleRateLimitOptionsThresholdComputeV1>?
  banThreshold;
  ...
  final pulumi.Input<SecurityPolicyRuleRateLimitOptionsEnforceOnKeyComputeV1>?
  enforceOnKey;

  /// If specified, any combination of values of enforce_on_key_type/enforce_on_key_name is treated as the key on which ratelimit threshold/action is enforced. You can specify up to 3 enforce_on_key_configs. If enforce_on_key_configs is specified, enforce_on_key must not be specified.
  final pulumi.Input<
    List<SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigComputeV1>
  >?
  enforceOnKeyConfigs;
  ...
  final pulumi.Input<SecurityPolicyRuleRedirectOptionsComputeV1>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'enforceOnKey':
          ?pulumi.Input.mapOptionalInputValue<
            SecurityPolicyRuleRateLimitOptionsEnforceOnKeyComputeV1,
            String
          >(enforceOnKey, (value) => value.wireValue),
      'enforceOnKeyConfigs':
          ?pulumi.Input.mapOptionalInputValue<
            List<SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigComputeV1>,
  ...
  factory SecurityPolicyRuleRateLimitOptionsComputeV1.fromMap(
    ...
    return SecurityPolicyRuleRateLimitOptionsComputeV1(
      ...
      banThreshold: (() {
        ...
        return pulumi.Input.fromValue(
          SecurityPolicyRuleRateLimitOptionsThresholdComputeV1.fromMap(
      ...
      enforceOnKey: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SecurityPolicyRuleRateLimitOptionsEnforceOnKeyComputeV1.fromValue(
      ...
      enforceOnKeyConfigs: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigComputeV1.fromMap(
      ...
      exceedRedirectOptions: (() {
        final guardedValue = map['exceedRedirectOptions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
