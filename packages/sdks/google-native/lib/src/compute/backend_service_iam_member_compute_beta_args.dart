...
/// {@template pulumi_compute_beta_backend_service_iam_member_compute_beta_args_doc}
/// The set of arguments for BackendServiceIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_backend_service_iam_member_compute_beta_args_doc}
class BackendServiceIamMemberComputeBetaArgs {
  ...
  /// Creates a new [BackendServiceIamMemberComputeBetaArgs].
  ...
  const BackendServiceIamMemberComputeBetaArgs({
    this.condition,
  ...
  factory BackendServiceIamMemberComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return BackendServiceIamMemberComputeBetaArgs(
