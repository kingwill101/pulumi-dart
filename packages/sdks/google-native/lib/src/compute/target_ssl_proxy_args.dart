...
class TargetSslProxyArgs {
  ...
  TargetSslProxyArgs({
    ...
    pulumi.Output<TargetSslProxyProxyHeader>? proxyHeader,
  ...
  factory TargetSslProxyArgs.fromMap(Map<String, dynamic> map) {
    return TargetSslProxyArgs(
      ...
      proxyHeader: map['proxyHeader'] == null ? null : pulumi.Output.create<TargetSslProxyProxyHeader>(TargetSslProxyProxyHeader.fromValue(map['proxyHeader'] as String)),
