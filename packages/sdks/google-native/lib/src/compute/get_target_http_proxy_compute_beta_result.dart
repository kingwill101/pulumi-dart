...
class GetTargetHttpProxyComputeBetaResult {
  ...
  /// Creates a new [GetTargetHttpProxyComputeBetaResult].
  ...
  const GetTargetHttpProxyComputeBetaResult({
  ...
  factory GetTargetHttpProxyComputeBetaResult.fromMap(Map<String, dynamic> map) {
    return GetTargetHttpProxyComputeBetaResult(
