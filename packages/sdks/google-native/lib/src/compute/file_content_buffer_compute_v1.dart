...
class FileContentBufferComputeV1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'content': ?content,
      'fileType': ?pulumi.Input.mapOptionalInputValue<FileContentBufferFileTypeComputeV1, String>(fileType, (value) => value.wireValue),
    };
  }
  ...
  factory FileContentBufferComputeV1.fromMap(Map<String, dynamic> map) {
    return FileContentBufferComputeV1(
      ...
      fileType: (() { final guardedValue = map['fileType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FileContentBufferFileTypeComputeV1.fromValue(guardedValue as String)); })(),
    );
  }
}
