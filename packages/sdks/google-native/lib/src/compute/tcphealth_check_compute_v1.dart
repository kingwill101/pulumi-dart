...
class TCPHealthCheckComputeV1 {
  ...
  final pulumi.Input<TCPHealthCheckPortSpecificationComputeV1>?
  portSpecification;
    ...
    return <String, dynamic>{
      ...
      'portSpecification':
          ?pulumi.Input.mapOptionalInputValue<
            TCPHealthCheckPortSpecificationComputeV1,
            String
          >(portSpecification, (value) => value.wireValue),
      'proxyHeader':
          ?pulumi.Input.mapOptionalInputValue<
            TCPHealthCheckProxyHeaderComputeV1,
            String
  ...
  factory TCPHealthCheckComputeV1.fromMap(Map<String, dynamic> map) {
    return TCPHealthCheckComputeV1(
      ...
      proxyHeader: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TCPHealthCheckProxyHeaderComputeV1.fromValue(guardedValue as String),
        );
      })(),
      request: (() {
