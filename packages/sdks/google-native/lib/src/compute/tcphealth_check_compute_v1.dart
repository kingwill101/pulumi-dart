...
class TCPHealthCheckComputeV1 {
  ...
  final pulumi.Input<TCPHealthCheckPortSpecificationComputeV1>? portSpecification;
  /// Specifies the type of proxy header to append before sending data to the backend, either NONE or PROXY_V1. The default is NONE.
  final pulumi.Input<TCPHealthCheckProxyHeaderComputeV1>? proxyHeader;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'port': ?port,
      'portName': ?portName,
      'portSpecification': ?pulumi.Input.mapOptionalInputValue<TCPHealthCheckPortSpecificationComputeV1, String>(portSpecification, (value) => value.wireValue),
      'proxyHeader': ?pulumi.Input.mapOptionalInputValue<TCPHealthCheckProxyHeaderComputeV1, String>(proxyHeader, (value) => value.wireValue),
      'request': ?request,
      'response': ?response,
    };
  }
  ...
  factory TCPHealthCheckComputeV1.fromMap(Map<String, dynamic> map) {
    return TCPHealthCheckComputeV1(
      ...
      portSpecification: (() { final guardedValue = map['portSpecification']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TCPHealthCheckPortSpecificationComputeV1.fromValue(guardedValue as String)); })(),
      proxyHeader: (() { final guardedValue = map['proxyHeader']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TCPHealthCheckProxyHeaderComputeV1.fromValue(guardedValue as String)); })(),
