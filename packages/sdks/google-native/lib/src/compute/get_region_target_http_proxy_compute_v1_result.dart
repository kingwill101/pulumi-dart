...
class GetRegionTargetHttpProxyComputeV1Result {
  ...
  /// Creates a new [GetRegionTargetHttpProxyComputeV1Result].
  ...
  const GetRegionTargetHttpProxyComputeV1Result({
  ...
  factory GetRegionTargetHttpProxyComputeV1Result.fromMap(Map<String, dynamic> map) {
    return GetRegionTargetHttpProxyComputeV1Result(
