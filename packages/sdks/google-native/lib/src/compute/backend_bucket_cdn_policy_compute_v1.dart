...
class BackendBucketCdnPolicyComputeV1 {
  ...
  final pulumi.Input<BackendBucketCdnPolicyCacheKeyPolicyComputeV1>?
  cacheKeyPolicy;
  ...
  final pulumi.Input<
    List<BackendBucketCdnPolicyNegativeCachingPolicyComputeV1>
  >?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'cacheMode':
          ?pulumi.Input.mapOptionalInputValue<
            BackendBucketCdnPolicyCacheModeComputeV1,
            String
      ...
      'negativeCachingPolicy':
          ...
          >(
            ...
            (value) =>
                pulumi.Input.encodeList<
                  BackendBucketCdnPolicyNegativeCachingPolicyComputeV1,
                  Map<String, dynamic>
                >(value, (value) => value.toMap()),
          ),
  ...
  factory BackendBucketCdnPolicyComputeV1.fromMap(Map<String, dynamic> map) {
    return BackendBucketCdnPolicyComputeV1(
      bypassCacheOnRequestHeaders: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                BackendBucketCdnPolicyBypassCacheOnRequestHeaderComputeV1.fromMap(
      ...
      cacheKeyPolicy: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          BackendBucketCdnPolicyCacheKeyPolicyComputeV1.fromMap(
      ...
      cacheMode: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          BackendBucketCdnPolicyCacheModeComputeV1.fromValue(
      ...
      negativeCachingPolicy: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                BackendBucketCdnPolicyNegativeCachingPolicyComputeV1.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
