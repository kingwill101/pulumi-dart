...
/// {@template pulumi_compute_v1_interconnect_attachment_compute_v1_args_doc}
/// The set of arguments for InterconnectAttachment.
/// {@endtemplate}
/// {@macro pulumi_compute_v1_interconnect_attachment_compute_v1_args_doc}
class InterconnectAttachmentComputeV1Args {
  ...
  final pulumi.Input<InterconnectAttachmentEdgeAvailabilityDomainComputeV1>? edgeAvailabilityDomain;
  ...
  final pulumi.Input<InterconnectAttachmentPartnerMetadataComputeV1>? partnerMetadata;
  ...
  /// Creates a new [InterconnectAttachmentComputeV1Args].
  ...
  InterconnectAttachmentComputeV1Args({
    ...
    pulumi.Output<InterconnectAttachmentBandwidthComputeV1>? bandwidth,
    ...
    pulumi.Output<InterconnectAttachmentEdgeAvailabilityDomainComputeV1>? edgeAvailabilityDomain,
    pulumi.Output<InterconnectAttachmentEncryptionComputeV1>? encryption,
    ...
    pulumi.Output<InterconnectAttachmentPartnerMetadataComputeV1>? partnerMetadata,
    pulumi.Output<String>? project,
    required pulumi.Output<String> region,
    pulumi.Output<String>? requestId,
    pulumi.Output<String>? router,
    pulumi.Output<InterconnectAttachmentStackTypeComputeV1>? stackType,
    pulumi.Output<int>? subnetLength,
    pulumi.Output<InterconnectAttachmentTypeComputeV1>? type,
    pulumi.Output<int>? vlanTag8021q,
  }) :
      adminEnabled = pulumi.Input.asOptionalInput<bool>(adminEnabled),
      bandwidth = pulumi.Input.asOptionalInput<InterconnectAttachmentBandwidthComputeV1>(bandwidth),
      ...
      edgeAvailabilityDomain = pulumi.Input.asOptionalInput<InterconnectAttachmentEdgeAvailabilityDomainComputeV1>(edgeAvailabilityDomain),
      encryption = pulumi.Input.asOptionalInput<InterconnectAttachmentEncryptionComputeV1>(encryption),
      ...
      partnerMetadata = pulumi.Input.asOptionalInput<InterconnectAttachmentPartnerMetadataComputeV1>(partnerMetadata),
      project = pulumi.Input.asOptionalInput<String>(project),
      region = pulumi.Input.asInput<String>(region),
      requestId = pulumi.Input.asOptionalInput<String>(requestId),
      router = pulumi.Input.asOptionalInput<String>(router),
      stackType = pulumi.Input.asOptionalInput<InterconnectAttachmentStackTypeComputeV1>(stackType),
      subnetLength = pulumi.Input.asOptionalInput<int>(subnetLength),
      type = pulumi.Input.asOptionalInput<InterconnectAttachmentTypeComputeV1>(type),
      vlanTag8021q = pulumi.Input.asOptionalInput<int>(vlanTag8021q);

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'adminEnabled': ?adminEnabled,
      'bandwidth': ?pulumi.Input.mapOptionalInputValue<InterconnectAttachmentBandwidthComputeV1, String>(bandwidth, (value) => value.value),
      ...
      'edgeAvailabilityDomain': ?pulumi.Input.mapOptionalInputValue<InterconnectAttachmentEdgeAvailabilityDomainComputeV1, String>(edgeAvailabilityDomain, (value) => value.value),
      'encryption': ?pulumi.Input.mapOptionalInputValue<InterconnectAttachmentEncryptionComputeV1, String>(encryption, (value) => value.value),
      ...
      'partnerMetadata': ?pulumi.Input.mapOptionalInputValue<InterconnectAttachmentPartnerMetadataComputeV1, Map<String, dynamic>>(partnerMetadata, (value) => value.toMap()),
      'project': ?project,
      'region': region,
      'requestId': ?requestId,
      'router': ?router,
      'stackType': ?pulumi.Input.mapOptionalInputValue<InterconnectAttachmentStackTypeComputeV1, String>(stackType, (value) => value.value),
      'subnetLength': ?subnetLength,
      'type': ?pulumi.Input.mapOptionalInputValue<InterconnectAttachmentTypeComputeV1, String>(type, (value) => value.value),
      'vlanTag8021q': ?vlanTag8021q,
    };
  }

  factory InterconnectAttachmentComputeV1Args.fromMap(Map<String, dynamic> map) {
    return InterconnectAttachmentComputeV1Args(
      ...
      bandwidth: map['bandwidth'] == null ? null : pulumi.Output.create<InterconnectAttachmentBandwidthComputeV1>(InterconnectAttachmentBandwidthComputeV1.fromValue(map['bandwidth'] as String)),
      ...
      edgeAvailabilityDomain: map['edgeAvailabilityDomain'] == null ? null : pulumi.Output.create<InterconnectAttachmentEdgeAvailabilityDomainComputeV1>(InterconnectAttachmentEdgeAvailabilityDomainComputeV1.fromValue(map['edgeAvailabilityDomain'] as String)),
      encryption: map['encryption'] == null ? null : pulumi.Output.create<InterconnectAttachmentEncryptionComputeV1>(InterconnectAttachmentEncryptionComputeV1.fromValue(map['encryption'] as String)),
      ...
      partnerMetadata: map['partnerMetadata'] == null ? null : pulumi.Output.create<InterconnectAttachmentPartnerMetadataComputeV1>(InterconnectAttachmentPartnerMetadataComputeV1.fromMap((map['partnerMetadata'] as Map).cast<String, dynamic>())),
      project: map['project'] == null ? null : pulumi.Output.create<String>(map['project'] as String),
      region: pulumi.Output.create<String>(map['region'] as String),
      requestId: map['requestId'] == null ? null : pulumi.Output.create<String>(map['requestId'] as String),
      router: map['router'] == null ? null : pulumi.Output.create<String>(map['router'] as String),
      stackType: map['stackType'] == null ? null : pulumi.Output.create<InterconnectAttachmentStackTypeComputeV1>(InterconnectAttachmentStackTypeComputeV1.fromValue(map['stackType'] as String)),
      subnetLength: map['subnetLength'] == null ? null : pulumi.Output.create<int>(map['subnetLength'] as int),
      type: map['type'] == null ? null : pulumi.Output.create<InterconnectAttachmentTypeComputeV1>(InterconnectAttachmentTypeComputeV1.fromValue(map['type'] as String)),
