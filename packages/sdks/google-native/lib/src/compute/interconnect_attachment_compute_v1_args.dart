...
class InterconnectAttachmentComputeV1Args {
  ...
  factory InterconnectAttachmentComputeV1Args.fromMap(Map<String, dynamic> map) {
    return InterconnectAttachmentComputeV1Args(
      ...
      bandwidth: map['bandwidth'] == null ? null : (InterconnectAttachmentBandwidthComputeV1.fromValue(map['bandwidth']! as String)).input(),
      candidateIpv6Subnets: map['candidateIpv6Subnets'] == null ? null : ((map['candidateIpv6Subnets']! as List).cast<String>()).input(),
      candidateSubnets: map['candidateSubnets'] == null ? null : ((map['candidateSubnets']! as List).cast<String>()).input(),
      cloudRouterIpv6InterfaceId: map['cloudRouterIpv6InterfaceId'] == null ? null : (map['cloudRouterIpv6InterfaceId']! as String).input(),
      customerRouterIpv6InterfaceId: map['customerRouterIpv6InterfaceId'] == null ? null : (map['customerRouterIpv6InterfaceId']! as String).input(),
      description: map['description'] == null ? null : (map['description']! as String).input(),
      edgeAvailabilityDomain: map['edgeAvailabilityDomain'] == null ? null : (InterconnectAttachmentEdgeAvailabilityDomainComputeV1.fromValue(map['edgeAvailabilityDomain']! as String)).input(),
      encryption: map['encryption'] == null ? null : (InterconnectAttachmentEncryptionComputeV1.fromValue(map['encryption']! as String)).input(),
      ...
      partnerMetadata: map['partnerMetadata'] == null ? null : (InterconnectAttachmentPartnerMetadataComputeV1.fromMap((map['partnerMetadata']! as Map).cast<String, dynamic>())).input(),
      project: map['project'] == null ? null : (map['project']! as String).input(),
      region: (map['region'] as String).input(),
      requestId: map['requestId'] == null ? null : (map['requestId']! as String).input(),
      router: map['router'] == null ? null : (map['router']! as String).input(),
      stackType: map['stackType'] == null ? null : (InterconnectAttachmentStackTypeComputeV1.fromValue(map['stackType']! as String)).input(),
      subnetLength: map['subnetLength'] == null ? null : (map['subnetLength']! as int).input(),
      type: map['type'] == null ? null : (InterconnectAttachmentTypeComputeV1.fromValue(map['type']! as String)).input(),
