    ...
    return <String, dynamic>{
      ...
      'bandwidth':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(bandwidth, (value) => value.wireValue),
      ...
      'edgeAvailabilityDomain':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(edgeAvailabilityDomain, (value) => value.wireValue),
      'encryption':
          ?pulumi.Input.mapOptionalInputValue<
            InterconnectAttachmentEncryptionComputeV1,
            String
          >(encryption, (value) => value.wireValue),
  ...
  factory InterconnectAttachmentComputeV1Args.fromMap(
    ...
    return InterconnectAttachmentComputeV1Args(
      ...
      candidateIpv6Subnets: (() {
        final guardedValue = map['candidateIpv6Subnets'];
        if (guardedValue == null) return null;
      ...
      cloudRouterIpv6InterfaceId: (() {
        final guardedValue = map['cloudRouterIpv6InterfaceId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      customerRouterIpv6InterfaceId: (() {
        final guardedValue = map['customerRouterIpv6InterfaceId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      description: (() {
      ...
      type: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          InterconnectAttachmentTypeComputeV1.fromValue(guardedValue as String),
        );
      })(),
      vlanTag8021q: (() {
