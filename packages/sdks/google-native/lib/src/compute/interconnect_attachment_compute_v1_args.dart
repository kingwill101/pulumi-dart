...
class InterconnectAttachmentComputeV1Args {
  ...
  const InterconnectAttachmentComputeV1Args({
    this.adminEnabled,
    this.bandwidth,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'bandwidth': ?pulumi.Input.mapOptionalInputValue<InterconnectAttachmentBandwidthComputeV1, String>(bandwidth, (value) => value.wireValue),
      ...
      'edgeAvailabilityDomain': ?pulumi.Input.mapOptionalInputValue<InterconnectAttachmentEdgeAvailabilityDomainComputeV1, String>(edgeAvailabilityDomain, (value) => value.wireValue),
      'encryption': ?pulumi.Input.mapOptionalInputValue<InterconnectAttachmentEncryptionComputeV1, String>(encryption, (value) => value.wireValue),
      ...
      'requestId': ?requestId,
      'router': ?router,
      'stackType': ?pulumi.Input.mapOptionalInputValue<InterconnectAttachmentStackTypeComputeV1, String>(stackType, (value) => value.wireValue),
      'subnetLength': ?subnetLength,
      'type': ?pulumi.Input.mapOptionalInputValue<InterconnectAttachmentTypeComputeV1, String>(type, (value) => value.wireValue),
  ...
  factory InterconnectAttachmentComputeV1Args.fromMap(Map<String, dynamic> map) {
    return InterconnectAttachmentComputeV1Args(
      ...
      bandwidth: (() { final guardedValue = map['bandwidth']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InterconnectAttachmentBandwidthComputeV1.fromValue(guardedValue as String)); })(),
      ...
      edgeAvailabilityDomain: (() { final guardedValue = map['edgeAvailabilityDomain']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InterconnectAttachmentEdgeAvailabilityDomainComputeV1.fromValue(guardedValue as String)); })(),
      encryption: (() { final guardedValue = map['encryption']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InterconnectAttachmentEncryptionComputeV1.fromValue(guardedValue as String)); })(),
      ...
      partnerMetadata: (() { final guardedValue = map['partnerMetadata']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InterconnectAttachmentPartnerMetadataComputeV1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      stackType: (() { final guardedValue = map['stackType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InterconnectAttachmentStackTypeComputeV1.fromValue(guardedValue as String)); })(),
      ...
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InterconnectAttachmentTypeComputeV1.fromValue(guardedValue as String)); })(),
