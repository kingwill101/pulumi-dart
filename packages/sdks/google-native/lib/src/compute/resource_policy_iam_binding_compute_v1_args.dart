...
/// {@template pulumi_compute_v1_resource_policy_iam_binding_compute_v1_args_doc}
/// The set of arguments for ResourcePolicyIamBinding.
/// {@endtemplate}
/// {@macro pulumi_compute_v1_resource_policy_iam_binding_compute_v1_args_doc}
class ResourcePolicyIamBindingComputeV1Args {
  ...
  /// Creates a new [ResourcePolicyIamBindingComputeV1Args].
  ...
  const ResourcePolicyIamBindingComputeV1Args({
    this.condition,
  ...
  factory ResourcePolicyIamBindingComputeV1Args.fromMap(Map<String, dynamic> map) {
    return ResourcePolicyIamBindingComputeV1Args(
