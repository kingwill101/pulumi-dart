...
class ResourcePolicyInstanceSchedulePolicyComputeBeta {
  ...
  final pulumi.Input<ResourcePolicyInstanceSchedulePolicyScheduleComputeBeta>?
  vmStartSchedule;
    ...
    return <String, dynamic>{
      ...
      'vmStartSchedule':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(vmStartSchedule, (value) => value.toMap()),
      'vmStopSchedule':
          ?pulumi.Input.mapOptionalInputValue<
            ResourcePolicyInstanceSchedulePolicyScheduleComputeBeta,
            Map<String, dynamic>
          >(vmStopSchedule, (value) => value.toMap()),
    };
  }
  ...
  factory ResourcePolicyInstanceSchedulePolicyComputeBeta.fromMap(
    ...
    return ResourcePolicyInstanceSchedulePolicyComputeBeta(
      ...
      vmStartSchedule: (() {
        final guardedValue = map['vmStartSchedule'];
        if (guardedValue == null) return null;
      ...
      vmStopSchedule: (() {
        final guardedValue = map['vmStopSchedule'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ResourcePolicyInstanceSchedulePolicyScheduleComputeBeta.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
