...
class ResourcePolicyInstanceSchedulePolicyComputeBeta {
  ...
  final ResourcePolicyInstanceSchedulePolicyScheduleComputeBeta? vmStartSchedule;
  ...
  factory ResourcePolicyInstanceSchedulePolicyComputeBeta.fromMap(Map<String, dynamic> map) {
    return ResourcePolicyInstanceSchedulePolicyComputeBeta(
      ...
      vmStartSchedule: map['vmStartSchedule'] == null ? null : ResourcePolicyInstanceSchedulePolicyScheduleComputeBeta.fromMap((map['vmStartSchedule'] as Map).cast<String, dynamic>()),
      vmStopSchedule: map['vmStopSchedule'] == null ? null : ResourcePolicyInstanceSchedulePolicyScheduleComputeBeta.fromMap((map['vmStopSchedule'] as Map).cast<String, dynamic>()),
    );
  }
}
