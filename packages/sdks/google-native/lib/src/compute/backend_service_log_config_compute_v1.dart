...
class BackendServiceLogConfigComputeV1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'optionalMode': ?pulumi.Input.mapOptionalInputValue<BackendServiceLogConfigOptionalModeComputeV1, String>(optionalMode, (value) => value.value),
  ...
  factory BackendServiceLogConfigComputeV1.fromMap(Map<String, dynamic> map) {
    return BackendServiceLogConfigComputeV1(
      ...
      optionalMode: map['optionalMode'] == null ? null : (BackendServiceLogConfigOptionalModeComputeV1.fromValue(map['optionalMode'] as String)).input(),
