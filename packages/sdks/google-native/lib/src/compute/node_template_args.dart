...
class NodeTemplateArgs {
    ...
    return <String, dynamic>{
      ...
      'cpuOvercommitType':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(cpuOvercommitType, (value) => value.wireValue),
  ...
  factory NodeTemplateArgs.fromMap(Map<String, dynamic> map) {
    return NodeTemplateArgs(
      ...
      cpuOvercommitType: (() {
        final guardedValue = map['cpuOvercommitType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          NodeTemplateCpuOvercommitType.fromValue(guardedValue as String),
        );
      })(),
      description: (() {
      ...
      disks: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<LocalDisk>(
            guardedValue,
            (value) =>
                LocalDisk.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      name: (() {
      ...
      nodeAffinityLabels: (() {
        final guardedValue = map['nodeAffinityLabels'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      nodeTypeFlexibility: (() {
        final guardedValue = map['nodeTypeFlexibility'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      serverBinding: (() {
        final guardedValue = map['serverBinding'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ServerBinding.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
