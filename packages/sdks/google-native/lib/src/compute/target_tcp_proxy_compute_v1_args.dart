...
import 'target_tcp_proxy_proxy_header_compute_v1.dart';

/// {@template pulumi_compute_v1_target_tcp_proxy_compute_v1_args_doc}
/// The set of arguments for TargetTcpProxy.
/// {@endtemplate}
/// {@macro pulumi_compute_v1_target_tcp_proxy_compute_v1_args_doc}
class TargetTcpProxyComputeV1Args {
  ...
  final pulumi.Input<TargetTcpProxyProxyHeaderComputeV1>? proxyHeader;
  ...
  /// Creates a new [TargetTcpProxyComputeV1Args].
  ...
  const TargetTcpProxyComputeV1Args({
    this.description,
    this.name,
    this.project,
    this.proxyBind,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'project': ?project,
      'proxyBind': ?proxyBind,
      'proxyHeader': ?pulumi.Input.mapOptionalInputValue<TargetTcpProxyProxyHeaderComputeV1, String>(proxyHeader, (value) => value.wireValue),
      'requestId': ?requestId,
      'service': ?service,
    };
  }
  ...
  factory TargetTcpProxyComputeV1Args.fromMap(Map<String, dynamic> map) {
    return TargetTcpProxyComputeV1Args(
      ...
      proxyHeader: (() { final guardedValue = map['proxyHeader']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TargetTcpProxyProxyHeaderComputeV1.fromValue(guardedValue as String)); })(),
