    ...
    return <String, dynamic>{
      ...
      'snapshotType':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(snapshotType, (value) => value.wireValue),
  ...
  factory RegionSnapshotArgs.fromMap(Map<String, dynamic> map) {
    return RegionSnapshotArgs(
      ...
      snapshotType: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RegionSnapshotSnapshotType.fromValue(guardedValue as String),
        );
      })(),
      sourceDisk: (() {
      ...
      sourceDiskForRecoveryCheckpoint: (() {
        final guardedValue = map['sourceDiskForRecoveryCheckpoint'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ...
      sourceInstantSnapshotEncryptionKey: (() {
        final guardedValue = map['sourceInstantSnapshotEncryptionKey'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CustomerEncryptionKey.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
