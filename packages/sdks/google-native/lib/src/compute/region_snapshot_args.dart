...
class RegionSnapshotArgs {
  ...
  RegionSnapshotArgs({
    ...
    pulumi.Output<RegionSnapshotSnapshotType>? snapshotType,
  ...
  factory RegionSnapshotArgs.fromMap(Map<String, dynamic> map) {
    return RegionSnapshotArgs(
      ...
      snapshotType: map['snapshotType'] == null ? null : pulumi.Output.create<RegionSnapshotSnapshotType>(RegionSnapshotSnapshotType.fromValue(map['snapshotType'] as String)),
