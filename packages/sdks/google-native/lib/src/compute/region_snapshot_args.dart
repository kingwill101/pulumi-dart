...
class RegionSnapshotArgs {
  ...
  factory RegionSnapshotArgs.fromMap(Map<String, dynamic> map) {
    return RegionSnapshotArgs(
      ...
      snapshotEncryptionKey: map['snapshotEncryptionKey'] == null ? null : (CustomerEncryptionKey.fromMap((map['snapshotEncryptionKey'] as Map).cast<String, dynamic>())).input(),
      snapshotType: map['snapshotType'] == null ? null : (RegionSnapshotSnapshotType.fromValue(map['snapshotType'] as String)).input(),
      ...
      sourceInstantSnapshotEncryptionKey: map['sourceInstantSnapshotEncryptionKey'] == null ? null : (CustomerEncryptionKey.fromMap((map['sourceInstantSnapshotEncryptionKey'] as Map).cast<String, dynamic>())).input(),
