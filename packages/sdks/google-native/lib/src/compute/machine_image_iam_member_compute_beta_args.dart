...
/// {@template pulumi_compute_beta_machine_image_iam_member_compute_beta_args_doc}
/// The set of arguments for MachineImageIamMember.
/// {@endtemplate}
/// {@macro pulumi_compute_beta_machine_image_iam_member_compute_beta_args_doc}
class MachineImageIamMemberComputeBetaArgs {
  ...
  /// Creates a new [MachineImageIamMemberComputeBetaArgs].
  ...
  const MachineImageIamMemberComputeBetaArgs({
    this.condition,
  ...
  factory MachineImageIamMemberComputeBetaArgs.fromMap(Map<String, dynamic> map) {
    return MachineImageIamMemberComputeBetaArgs(
