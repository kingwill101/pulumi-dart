...
class RegionBackendService extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<BackendServiceLocalityLoadBalancingPolicyConfigResponse>> localityLbPolicies;
  ...
  RegionBackendService(
    ...
    this.cdnPolicy = registerOutput<BackendServiceCdnPolicyResponse>('cdnPolicy');
    this.circuitBreakers = registerOutput<CircuitBreakersResponse>('circuitBreakers');
    this.compressionMode = registerOutput<String>('compressionMode');
    this.connectionDraining = registerOutput<ConnectionDrainingResponse>('connectionDraining');
    this.connectionTrackingPolicy = registerOutput<BackendServiceConnectionTrackingPolicyResponse>('connectionTrackingPolicy');
    this.consistentHash = registerOutput<ConsistentHashLoadBalancerSettingsResponse>('consistentHash');
    ...
    this.failoverPolicy = registerOutput<BackendServiceFailoverPolicyResponse>('failoverPolicy');
    ...
    this.localityLbPolicies = registerOutput<List<BackendServiceLocalityLoadBalancingPolicyConfigResponse>>('localityLbPolicies');
    this.localityLbPolicy = registerOutput<String>('localityLbPolicy');
    this.logConfig = registerOutput<BackendServiceLogConfigResponse>('logConfig');
    this.maxStreamDuration = registerOutput<DurationResponse>('maxStreamDuration');
    this.metadatas = registerOutput<Map<String, String>>('metadatas');
    this.name = registerOutput<String>('name');
    this.network = registerOutput<String>('network');
    this.outlierDetection = registerOutput<OutlierDetectionResponse>('outlierDetection');
    ...
    this.securitySettings = registerOutput<SecuritySettingsResponse>('securitySettings');
