...
class RegionBackendService extends pulumi.CustomResource {
  ...
  late final pulumi.Output<BackendServiceConnectionTrackingPolicyResponse> connectionTrackingPolicy;
  ...
  late final pulumi.Output<ConsistentHashLoadBalancerSettingsResponse> consistentHash;
  ...
  /// [args] Arguments used to configure this [RegionBackendService]. {@macro pulumi_compute_alpha_region_backend_service_args_doc}
  ...
  RegionBackendService(
    ...
    cdnPolicy = registerOutput<BackendServiceCdnPolicyResponse>('cdnPolicy', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return BackendServiceCdnPolicyResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    circuitBreakers = registerOutput<CircuitBreakersResponse>('circuitBreakers', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return CircuitBreakersResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    compressionMode = registerOutput<String>('compressionMode');
    connectionDraining = registerOutput<ConnectionDrainingResponse>('connectionDraining', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ConnectionDrainingResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    connectionTrackingPolicy = registerOutput<BackendServiceConnectionTrackingPolicyResponse>('connectionTrackingPolicy', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return BackendServiceConnectionTrackingPolicyResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    consistentHash = registerOutput<ConsistentHashLoadBalancerSettingsResponse>('consistentHash', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ConsistentHashLoadBalancerSettingsResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    failoverPolicy = registerOutput<BackendServiceFailoverPolicyResponse>('failoverPolicy', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return BackendServiceFailoverPolicyResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    fingerprint = registerOutput<String>('fingerprint');
    healthChecks = registerOutput<List<String>>('healthChecks');
    iap = registerOutput<BackendServiceIAPResponse>('iap', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return BackendServiceIAPResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    logConfig = registerOutput<BackendServiceLogConfigResponse>('logConfig', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return BackendServiceLogConfigResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    maxStreamDuration = registerOutput<DurationResponse>('maxStreamDuration', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return DurationResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    metadatas = registerOutput<Map<String, String>>('metadatas');
    this.name = registerOutput<String>('name');
    network = registerOutput<String>('network');
    outlierDetection = registerOutput<OutlierDetectionResponse>('outlierDetection', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return OutlierDetectionResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    securitySettings = registerOutput<SecuritySettingsResponse>('securitySettings', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SecuritySettingsResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    subsetting = registerOutput<SubsettingResponse>('subsetting', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SubsettingResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    timeoutSec = registerOutput<int>('timeoutSec');
    usedBy = registerOutput<List<Map<String, dynamic>>>('usedBy');
    vpcNetworkScope = registerOutput<String>('vpcNetworkScope');
  }
}
