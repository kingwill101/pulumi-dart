...
class SecurityPolicyUserDefinedFieldComputeBeta {
    ...
    return <String, dynamic>{
      'base':
          ?pulumi.Input.mapOptionalInputValue<
            SecurityPolicyUserDefinedFieldBaseComputeBeta,
            String
  ...
  factory SecurityPolicyUserDefinedFieldComputeBeta.fromMap(
    ...
    return SecurityPolicyUserDefinedFieldComputeBeta(
      base: (() {
        ...
        return pulumi.Input.fromValue(
          SecurityPolicyUserDefinedFieldBaseComputeBeta.fromValue(
