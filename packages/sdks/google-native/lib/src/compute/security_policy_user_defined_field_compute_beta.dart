...
class SecurityPolicyUserDefinedFieldComputeBeta {
  ...
  final pulumi.Input<SecurityPolicyUserDefinedFieldBaseComputeBeta>? base;
  ...
  const SecurityPolicyUserDefinedFieldComputeBeta({
    this.base,
    this.mask,
    this.name,
    this.offset,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'base': ?pulumi.Input.mapOptionalInputValue<SecurityPolicyUserDefinedFieldBaseComputeBeta, String>(base, (value) => value.wireValue),
      'mask': ?mask,
      'name': ?name,
      'offset': ?offset,
      'size': ?size,
  ...
  factory SecurityPolicyUserDefinedFieldComputeBeta.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyUserDefinedFieldComputeBeta(
      base: (() { final guardedValue = map['base']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SecurityPolicyUserDefinedFieldBaseComputeBeta.fromValue(guardedValue as String)); })(),
