...
class SecurityPolicyUserDefinedFieldComputeBeta {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'base': ?pulumi.Input.mapOptionalInputValue<SecurityPolicyUserDefinedFieldBaseComputeBeta, String>(base, (value) => value.value),
      'mask': ?mask,
      'name': ?name,
      'offset': ?offset,
      'size': ?size,
  ...
  factory SecurityPolicyUserDefinedFieldComputeBeta.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyUserDefinedFieldComputeBeta(
      base: map['base'] == null ? null : (SecurityPolicyUserDefinedFieldBaseComputeBeta.fromValue(map['base']! as String)).input(),
