...
class GetRegionAutoscalerComputeBetaResult {
  ...
  /// Creates a new [GetRegionAutoscalerComputeBetaResult].
  ...
  const GetRegionAutoscalerComputeBetaResult({
  ...
  factory GetRegionAutoscalerComputeBetaResult.fromMap(Map<String, dynamic> map) {
    return GetRegionAutoscalerComputeBetaResult(
