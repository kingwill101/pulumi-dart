...
class InterconnectMacsecResponseComputeV1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'failOpen': failOpen,
      'preSharedKeys': pulumi.Input.encodeList<InterconnectMacsecPreSharedKeyResponseComputeV1, Map<String, dynamic>>(preSharedKeys, (value) => value.toMap()),
    };
  }
  ...
  factory InterconnectMacsecResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return InterconnectMacsecResponseComputeV1(
      ...
      preSharedKeys: pulumi.Input.decodeList<InterconnectMacsecPreSharedKeyResponseComputeV1>(map['preSharedKeys'], (value) => InterconnectMacsecPreSharedKeyResponseComputeV1.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
