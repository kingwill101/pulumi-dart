...
class InterconnectMacsecResponseComputeV1 {
  ...
  factory InterconnectMacsecResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return InterconnectMacsecResponseComputeV1(
      ...
      preSharedKeys: (pulumi.Input.decodeList<InterconnectMacsecPreSharedKeyResponseComputeV1>(map['preSharedKeys'], (value) => InterconnectMacsecPreSharedKeyResponseComputeV1.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
