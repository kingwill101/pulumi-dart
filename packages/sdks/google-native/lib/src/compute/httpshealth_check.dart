...
class HTTPSHealthCheck {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'port': ?port,
      'portName': ?portName,
      'portSpecification': ?pulumi.Input.mapOptionalInputValue<HTTPSHealthCheckPortSpecification, String>(portSpecification, (value) => value.value),
      'proxyHeader': ?pulumi.Input.mapOptionalInputValue<HTTPSHealthCheckProxyHeader, String>(proxyHeader, (value) => value.value),
      'requestPath': ?requestPath,
      'response': ?response,
      'weightReportMode': ?pulumi.Input.mapOptionalInputValue<HTTPSHealthCheckWeightReportMode, String>(weightReportMode, (value) => value.value),
    };
  }
  ...
  factory HTTPSHealthCheck.fromMap(Map<String, dynamic> map) {
    return HTTPSHealthCheck(
      ...
      portSpecification: map['portSpecification'] == null ? null : (HTTPSHealthCheckPortSpecification.fromValue(map['portSpecification']! as String)).input(),
      proxyHeader: map['proxyHeader'] == null ? null : (HTTPSHealthCheckProxyHeader.fromValue(map['proxyHeader']! as String)).input(),
      ...
      weightReportMode: map['weightReportMode'] == null ? null : (HTTPSHealthCheckWeightReportMode.fromValue(map['weightReportMode']! as String)).input(),
    );
  }
}
