    ...
    return <String, dynamic>{
      ...
      'weightReportMode':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(weightReportMode, (value) => value.wireValue),
    };
  }
    ...
    return HTTPSHealthCheck(
      ...
      portSpecification: (() {
        ...
        return pulumi.Input.fromValue(
          HTTPSHealthCheckPortSpecification.fromValue(guardedValue as String),
        );
      })(),
      proxyHeader: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          HTTPSHealthCheckProxyHeader.fromValue(guardedValue as String),
        );
      })(),
      requestPath: (() {
      ...
      weightReportMode: (() {
        final guardedValue = map['weightReportMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          HTTPSHealthCheckWeightReportMode.fromValue(guardedValue as String),
        );
      })(),
    );
  }
