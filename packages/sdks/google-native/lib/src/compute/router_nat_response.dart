...
class RouterNatResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'natIps': natIps,
      'rules': pulumi.Input.encodeList<RouterNatRuleResponse, Map<String, dynamic>>(rules, (value) => value.toMap()),
      'sourceSubnetworkIpRangesToNat': sourceSubnetworkIpRangesToNat,
      'subnetworks': pulumi.Input.encodeList<RouterNatSubnetworkToNatResponse, Map<String, dynamic>>(subnetworks, (value) => value.toMap()),
  ...
  factory RouterNatResponse.fromMap(Map<String, dynamic> map) {
    return RouterNatResponse(
      ...
      logConfig: RouterNatLogConfigResponse.fromMap((map['logConfig'] as Map).cast<String, dynamic>()),
      ...
      rules: pulumi.Input.decodeList<RouterNatRuleResponse>(map['rules'], (value) => RouterNatRuleResponse.fromMap((value as Map).cast<String, dynamic>())),
      sourceSubnetworkIpRangesToNat: map['sourceSubnetworkIpRangesToNat'] as String,
      subnetworks: pulumi.Input.decodeList<RouterNatSubnetworkToNatResponse>(map['subnetworks'], (value) => RouterNatSubnetworkToNatResponse.fromMap((value as Map).cast<String, dynamic>())),
