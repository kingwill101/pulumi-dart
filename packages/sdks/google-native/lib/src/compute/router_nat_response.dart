...
class RouterNatResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'subnetworks':
          pulumi.Input.mapInputValue<
            List<RouterNatSubnetworkToNatResponse>,
            List<Map<String, dynamic>>
          >(
            subnetworks,
            (value) =>
  ...
  factory RouterNatResponse.fromMap(Map<String, dynamic> map) {
    return RouterNatResponse(
      ...
      logConfig: pulumi.Input.fromValue(
        RouterNatLogConfigResponse.fromMap(
      ...
      rules: pulumi.Input.fromValue(
        pulumi.Input.decodeList<RouterNatRuleResponse>(
          map['rules']!,
      ...
      subnetworks: pulumi.Input.fromValue(
        pulumi.Input.decodeList<RouterNatSubnetworkToNatResponse>(
          map['subnetworks']!,
