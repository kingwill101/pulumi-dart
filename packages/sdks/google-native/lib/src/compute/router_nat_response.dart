...
class RouterNatResponse {
  ...
  factory RouterNatResponse.fromMap(Map<String, dynamic> map) {
    return RouterNatResponse(
      ...
      logConfig: (RouterNatLogConfigResponse.fromMap((map['logConfig'] as Map).cast<String, dynamic>())).input(),
      ...
      rules: (pulumi.Input.decodeList<RouterNatRuleResponse>(map['rules'], (value) => RouterNatRuleResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      sourceSubnetworkIpRangesToNat: (map['sourceSubnetworkIpRangesToNat'] as String).input(),
      subnetworks: (pulumi.Input.decodeList<RouterNatSubnetworkToNatResponse>(map['subnetworks'], (value) => RouterNatSubnetworkToNatResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
