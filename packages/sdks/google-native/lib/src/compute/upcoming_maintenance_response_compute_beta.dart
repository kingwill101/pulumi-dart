...
class UpcomingMaintenanceResponseComputeBeta {
  ...
  /// Creates a new [UpcomingMaintenanceResponseComputeBeta].
  ...
  const UpcomingMaintenanceResponseComputeBeta({
  ...
  factory UpcomingMaintenanceResponseComputeBeta.fromMap(Map<String, dynamic> map) {
    return UpcomingMaintenanceResponseComputeBeta(
