...
class NetworkEndpointGroupComputeV1Args {
  ...
  NetworkEndpointGroupComputeV1Args({
    ...
    pulumi.Output<NetworkEndpointGroupNetworkEndpointTypeComputeV1>? networkEndpointType,
  ...
  factory NetworkEndpointGroupComputeV1Args.fromMap(Map<String, dynamic> map) {
    return NetworkEndpointGroupComputeV1Args(
      ...
      networkEndpointType: map['networkEndpointType'] == null ? null : pulumi.Output.create<NetworkEndpointGroupNetworkEndpointTypeComputeV1>(NetworkEndpointGroupNetworkEndpointTypeComputeV1.fromValue(map['networkEndpointType'] as String)),
