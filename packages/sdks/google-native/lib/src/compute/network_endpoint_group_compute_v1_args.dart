...
class NetworkEndpointGroupComputeV1Args {
  ...
  /// [zone] Optional.
  const NetworkEndpointGroupComputeV1Args({
    this.annotations,
    this.appEngine,
    this.cloudFunction,
    this.cloudRun,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'network': ?network,
      'networkEndpointType': ?pulumi.Input.mapOptionalInputValue<NetworkEndpointGroupNetworkEndpointTypeComputeV1, String>(networkEndpointType, (value) => value.wireValue),
      'project': ?project,
      'pscData': ?pscData,
  ...
  factory NetworkEndpointGroupComputeV1Args.fromMap(Map<String, dynamic> map) {
    return NetworkEndpointGroupComputeV1Args(
      ...
      networkEndpointType: (() { final guardedValue = map['networkEndpointType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkEndpointGroupNetworkEndpointTypeComputeV1.fromValue(guardedValue as String)); })(),
