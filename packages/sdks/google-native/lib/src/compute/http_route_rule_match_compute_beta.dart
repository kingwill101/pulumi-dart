...
class HttpRouteRuleMatchComputeBeta {
  ...
  final pulumi.Input<List<HttpQueryParameterMatchComputeBeta>>? queryParameterMatches;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'headerMatches': ?pulumi.Input.mapOptionalInputValue<List<HttpHeaderMatchComputeBeta>, List<Map<String, dynamic>>>(headerMatches, (value) => pulumi.Input.encodeList<HttpHeaderMatchComputeBeta, Map<String, dynamic>>(value, (value) => value.toMap())),
      ...
      'queryParameterMatches': ?pulumi.Input.mapOptionalInputValue<List<HttpQueryParameterMatchComputeBeta>, List<Map<String, dynamic>>>(queryParameterMatches, (value) => pulumi.Input.encodeList<HttpQueryParameterMatchComputeBeta, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory HttpRouteRuleMatchComputeBeta.fromMap(Map<String, dynamic> map) {
    return HttpRouteRuleMatchComputeBeta(
      ...
      headerMatches: (() { final guardedValue = map['headerMatches']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<HttpHeaderMatchComputeBeta>(guardedValue, (value) => HttpHeaderMatchComputeBeta.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      queryParameterMatches: (() { final guardedValue = map['queryParameterMatches']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<HttpQueryParameterMatchComputeBeta>(guardedValue, (value) => HttpQueryParameterMatchComputeBeta.fromMap((value as Map).cast<String, dynamic>()))); })(),
