...
class InstanceGroupManagerUpdatePolicy {
  ...
  final pulumi.Input<InstanceGroupManagerUpdatePolicyInstanceRedistributionType>? instanceRedistributionType;
  ...
  final pulumi.Input<InstanceGroupManagerUpdatePolicyMinimalAction>? minimalAction;
  /// Most disruptive action that is allowed to be taken on an instance. You can specify either NONE to forbid any actions, REFRESH to avoid restarting the VM and to limit disruption as much as possible. RESTART to allow actions that can be applied without instance replacing or REPLACE to allow all possible actions. If the Updater determines that the minimal update action needed is more disruptive than most disruptive allowed action you specify it will not perform the update at all.
  final pulumi.Input<InstanceGroupManagerUpdatePolicyMostDisruptiveAllowedAction>? mostDisruptiveAllowedAction;
  /// What action should be used to replace instances. See minimal_action.REPLACE
  final pulumi.Input<InstanceGroupManagerUpdatePolicyReplacementMethod>? replacementMethod;
  ...
  const InstanceGroupManagerUpdatePolicy({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'instanceRedistributionType': ?pulumi.Input.mapOptionalInputValue<InstanceGroupManagerUpdatePolicyInstanceRedistributionType, String>(instanceRedistributionType, (value) => value.wireValue),
      'maxSurge': ?pulumi.Input.mapOptionalInputValue<FixedOrPercent, Map<String, dynamic>>(maxSurge, (value) => value.toMap()),
      ...
      'minimalAction': ?pulumi.Input.mapOptionalInputValue<InstanceGroupManagerUpdatePolicyMinimalAction, String>(minimalAction, (value) => value.wireValue),
      'mostDisruptiveAllowedAction': ?pulumi.Input.mapOptionalInputValue<InstanceGroupManagerUpdatePolicyMostDisruptiveAllowedAction, String>(mostDisruptiveAllowedAction, (value) => value.wireValue),
      'replacementMethod': ?pulumi.Input.mapOptionalInputValue<InstanceGroupManagerUpdatePolicyReplacementMethod, String>(replacementMethod, (value) => value.wireValue),
      'type': ?pulumi.Input.mapOptionalInputValue<InstanceGroupManagerUpdatePolicyType, String>(type, (value) => value.wireValue),
    };
  }

  factory InstanceGroupManagerUpdatePolicy.fromMap(Map<String, dynamic> map) {
    return InstanceGroupManagerUpdatePolicy(
      instanceRedistributionType: (() { final guardedValue = map['instanceRedistributionType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceGroupManagerUpdatePolicyInstanceRedistributionType.fromValue(guardedValue as String)); })(),
      maxSurge: (() { final guardedValue = map['maxSurge']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FixedOrPercent.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      minimalAction: (() { final guardedValue = map['minimalAction']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceGroupManagerUpdatePolicyMinimalAction.fromValue(guardedValue as String)); })(),
      mostDisruptiveAllowedAction: (() { final guardedValue = map['mostDisruptiveAllowedAction']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceGroupManagerUpdatePolicyMostDisruptiveAllowedAction.fromValue(guardedValue as String)); })(),
      replacementMethod: (() { final guardedValue = map['replacementMethod']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceGroupManagerUpdatePolicyReplacementMethod.fromValue(guardedValue as String)); })(),
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceGroupManagerUpdatePolicyType.fromValue(guardedValue as String)); })(),
    );
  }
}
