...
class RouterBgpResponseComputeV1 {
  ...
  final List<RouterAdvertisedIpRangeResponseComputeV1> advertisedIpRanges;
  ...
  /// Creates a new [RouterBgpResponseComputeV1].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'advertisedIpRanges': pulumi.Input.encodeList<RouterAdvertisedIpRangeResponseComputeV1, Map<String, dynamic>>(advertisedIpRanges, (value) => value.toMap()),
      'asn': asn,
      'keepaliveInterval': keepaliveInterval,
    };
  }

  factory RouterBgpResponseComputeV1.fromMap(Map<String, dynamic> map) {
    return RouterBgpResponseComputeV1(
      advertiseMode: map['advertiseMode'] as String,
      advertisedGroups: (map['advertisedGroups'] as List).cast<String>(),
      advertisedIpRanges: pulumi.Input.decodeList<RouterAdvertisedIpRangeResponseComputeV1>(map['advertisedIpRanges'], (value) => RouterAdvertisedIpRangeResponseComputeV1.fromMap((value as Map).cast<String, dynamic>())),
      asn: map['asn'] as int,
