...
class SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigComputeBeta {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'enforceOnKeyType': ?pulumi.Input.mapOptionalInputValue<SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigEnforceOnKeyTypeComputeBeta, String>(enforceOnKeyType, (value) => value.value),
    };
  }
