...
class SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigComputeBeta {
  ...
  final SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigEnforceOnKeyTypeComputeBeta? enforceOnKeyType;
  ...
  factory SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigComputeBeta.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigComputeBeta(
      ...
      enforceOnKeyType: map['enforceOnKeyType'] == null ? null : SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigEnforceOnKeyTypeComputeBeta.fromValue(map['enforceOnKeyType'] as String),
    );
  }
}
