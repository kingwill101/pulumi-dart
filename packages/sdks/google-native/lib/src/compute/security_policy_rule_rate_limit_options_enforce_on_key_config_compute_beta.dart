...
class SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigComputeBeta {
  ...
  final pulumi.Input<SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigEnforceOnKeyTypeComputeBeta>? enforceOnKeyType;
  ...
  const SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigComputeBeta({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'enforceOnKeyType': ?pulumi.Input.mapOptionalInputValue<SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigEnforceOnKeyTypeComputeBeta, String>(enforceOnKeyType, (value) => value.wireValue),
    };
  }
  ...
  factory SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigComputeBeta.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigComputeBeta(
      ...
      enforceOnKeyType: (() { final guardedValue = map['enforceOnKeyType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfigEnforceOnKeyTypeComputeBeta.fromValue(guardedValue as String)); })(),
    );
  }
}
