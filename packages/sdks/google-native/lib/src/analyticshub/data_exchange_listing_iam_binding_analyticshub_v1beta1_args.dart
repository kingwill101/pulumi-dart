...
/// {@template pulumi_analyticshub_v1beta1_data_exchange_listing_iam_binding_analyticshub_v1beta1_args_doc}
/// The set of arguments for DataExchangeListingIamBinding.
/// {@endtemplate}
/// {@macro pulumi_analyticshub_v1beta1_data_exchange_listing_iam_binding_analyticshub_v1beta1_args_doc}
class DataExchangeListingIamBindingAnalyticshubV1beta1Args {
  ...
  /// Creates a new [DataExchangeListingIamBindingAnalyticshubV1beta1Args].
  ...
  const DataExchangeListingIamBindingAnalyticshubV1beta1Args({
    this.condition,
  ...
  factory DataExchangeListingIamBindingAnalyticshubV1beta1Args.fromMap(Map<String, dynamic> map) {
