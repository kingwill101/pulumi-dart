...
/// {@template pulumi_analyticshub_v1_data_exchange_listing_iam_binding_args_doc}
/// The set of arguments for DataExchangeListingIamBinding.
/// {@endtemplate}
/// {@macro pulumi_analyticshub_v1_data_exchange_listing_iam_binding_args_doc}
class DataExchangeListingIamBindingArgs {
  ...
  /// Creates a new [DataExchangeListingIamBindingArgs].
  ...
  const DataExchangeListingIamBindingArgs({
    this.condition,
  ...
  factory DataExchangeListingIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return DataExchangeListingIamBindingArgs(
