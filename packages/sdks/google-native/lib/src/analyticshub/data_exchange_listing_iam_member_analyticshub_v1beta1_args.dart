...
/// {@template pulumi_analyticshub_v1beta1_data_exchange_listing_iam_member_analyticshub_v1beta1_args_doc}
/// The set of arguments for DataExchangeListingIamMember.
/// {@endtemplate}
/// {@macro pulumi_analyticshub_v1beta1_data_exchange_listing_iam_member_analyticshub_v1beta1_args_doc}
class DataExchangeListingIamMemberAnalyticshubV1beta1Args {
  ...
  /// Creates a new [DataExchangeListingIamMemberAnalyticshubV1beta1Args].
  ...
  const DataExchangeListingIamMemberAnalyticshubV1beta1Args({
    this.condition,
  ...
  factory DataExchangeListingIamMemberAnalyticshubV1beta1Args.fromMap(Map<String, dynamic> map) {
    return DataExchangeListingIamMemberAnalyticshubV1beta1Args(
