...
class ListingAnalyticshubV1beta1Args {
  ...
  ListingAnalyticshubV1beta1Args({
    required pulumi.Output<BigQueryDatasetSourceAnalyticshubV1beta1> bigqueryDataset,
    pulumi.Output<List<ListingCategoriesItemAnalyticshubV1beta1>>? categories,
    required pulumi.Output<String> dataExchangeId,
    pulumi.Output<DataProviderAnalyticshubV1beta1>? dataProvider,
    ...
    pulumi.Output<PublisherAnalyticshubV1beta1>? publisher,
    pulumi.Output<String>? requestAccess,
    pulumi.Output<RestrictedExportConfigAnalyticshubV1beta1>? restrictedExportConfig,
  }) :
  ...
  factory ListingAnalyticshubV1beta1Args.fromMap(Map<String, dynamic> map) {
    return ListingAnalyticshubV1beta1Args(
      bigqueryDataset: pulumi.Output.create<BigQueryDatasetSourceAnalyticshubV1beta1>(BigQueryDatasetSourceAnalyticshubV1beta1.fromMap((map['bigqueryDataset'] as Map).cast<String, dynamic>())),
      categories: map['categories'] == null ? null : pulumi.Output.create<List<ListingCategoriesItemAnalyticshubV1beta1>>(pulumi.Input.decodeList<ListingCategoriesItemAnalyticshubV1beta1>(map['categories'], (value) => ListingCategoriesItemAnalyticshubV1beta1.fromValue(value as String))),
      dataExchangeId: pulumi.Output.create<String>(map['dataExchangeId'] as String),
      dataProvider: map['dataProvider'] == null ? null : pulumi.Output.create<DataProviderAnalyticshubV1beta1>(DataProviderAnalyticshubV1beta1.fromMap((map['dataProvider'] as Map).cast<String, dynamic>())),
      ...
      publisher: map['publisher'] == null ? null : pulumi.Output.create<PublisherAnalyticshubV1beta1>(PublisherAnalyticshubV1beta1.fromMap((map['publisher'] as Map).cast<String, dynamic>())),
      requestAccess: map['requestAccess'] == null ? null : pulumi.Output.create<String>(map['requestAccess'] as String),
      restrictedExportConfig: map['restrictedExportConfig'] == null ? null : pulumi.Output.create<RestrictedExportConfigAnalyticshubV1beta1>(RestrictedExportConfigAnalyticshubV1beta1.fromMap((map['restrictedExportConfig'] as Map).cast<String, dynamic>())),
    );
  }
}
