...
class ListingAnalyticshubV1beta1Args {
    ...
    return <String, dynamic>{
      ...
      'categories':
          ?pulumi.Input.mapOptionalInputValue<
            List<ListingCategoriesItemAnalyticshubV1beta1>,
            List<String>
          >(
            categories,
            (value) =>
  ...
  factory ListingAnalyticshubV1beta1Args.fromMap(Map<String, dynamic> map) {
    return ListingAnalyticshubV1beta1Args(
      bigqueryDataset: pulumi.Input.fromValue(
        BigQueryDatasetSourceAnalyticshubV1beta1.fromMap(
      ...
      categories: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ListingCategoriesItemAnalyticshubV1beta1>(
            guardedValue,
            (value) => ListingCategoriesItemAnalyticshubV1beta1.fromValue(
              value as String,
            ),
          ),
        );
      ...
      dataProvider: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DataProviderAnalyticshubV1beta1.fromMap(
      ...
      publisher: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PublisherAnalyticshubV1beta1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      restrictedExportConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RestrictedExportConfigAnalyticshubV1beta1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
