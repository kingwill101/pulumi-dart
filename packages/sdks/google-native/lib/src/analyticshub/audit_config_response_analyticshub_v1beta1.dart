...
class AuditConfigResponseAnalyticshubV1beta1 {
  ...
  factory AuditConfigResponseAnalyticshubV1beta1.fromMap(Map<String, dynamic> map) {
    return AuditConfigResponseAnalyticshubV1beta1(
      auditLogConfigs: (pulumi.Input.decodeList<AuditLogConfigResponseAnalyticshubV1beta1>(map['auditLogConfigs'], (value) => AuditLogConfigResponseAnalyticshubV1beta1.fromMap((value as Map).cast<String, dynamic>()))).input(),
