...
class GetListingResult {
  ...
  factory GetListingResult.fromMap(Map<String, dynamic> map) {
    return GetListingResult(
      bigqueryDataset: BigQueryDatasetSourceResponse.fromMap((map['bigqueryDataset']! as Map).cast<String, dynamic>()),
      categories: (map['categories'] as List).cast<String>(),
      dataProvider: DataProviderResponse.fromMap((map['dataProvider']! as Map).cast<String, dynamic>()),
      ...
      publisher: PublisherResponse.fromMap((map['publisher']! as Map).cast<String, dynamic>()),
      requestAccess: map['requestAccess'] as String,
      restrictedExportConfig: RestrictedExportConfigResponse.fromMap((map['restrictedExportConfig']! as Map).cast<String, dynamic>()),
