...
class ListingAnalyticshubV1beta1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<BigQueryDatasetSourceResponseAnalyticshubV1beta1> bigqueryDataset;
  /// Optional. Categories of the listing. Up to two categories are allowed.
  late final pulumi.Output<List<String>> categories;
  late final pulumi.Output<String> dataExchangeId;
  /// Optional. Details of the data provider who owns the source data.
  late final pulumi.Output<DataProviderResponseAnalyticshubV1beta1> dataProvider;
  ...
  late final pulumi.Output<RestrictedExportConfigResponseAnalyticshubV1beta1> restrictedExportConfig;
  ...
  ListingAnalyticshubV1beta1(
    ...
    bigqueryDataset = registerOutput<BigQueryDatasetSourceResponseAnalyticshubV1beta1>('bigqueryDataset', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return BigQueryDatasetSourceResponseAnalyticshubV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    categories = registerOutput<List<String>>('categories');
    dataExchangeId = registerOutput<String>('dataExchangeId');
    dataProvider = registerOutput<DataProviderResponseAnalyticshubV1beta1>('dataProvider', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return DataProviderResponseAnalyticshubV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    publisher = registerOutput<PublisherResponseAnalyticshubV1beta1>('publisher', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return PublisherResponseAnalyticshubV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    requestAccess = registerOutput<String>('requestAccess');
    restrictedExportConfig = registerOutput<RestrictedExportConfigResponseAnalyticshubV1beta1>('restrictedExportConfig', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return RestrictedExportConfigResponseAnalyticshubV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>()); });
