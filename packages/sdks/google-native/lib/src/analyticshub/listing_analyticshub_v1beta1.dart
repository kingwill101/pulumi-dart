...
class ListingAnalyticshubV1beta1 extends pulumi.CustomResource {
  ...
  ListingAnalyticshubV1beta1(
    ...
    this.bigqueryDataset = registerOutput<BigQueryDatasetSourceResponseAnalyticshubV1beta1>('bigqueryDataset');
    this.categories = registerOutput<List<String>>('categories');
    this.dataExchangeId = registerOutput<String>('dataExchangeId');
    this.dataProvider = registerOutput<DataProviderResponseAnalyticshubV1beta1>('dataProvider');
    ...
    this.publisher = registerOutput<PublisherResponseAnalyticshubV1beta1>('publisher');
    this.requestAccess = registerOutput<String>('requestAccess');
    this.restrictedExportConfig = registerOutput<RestrictedExportConfigResponseAnalyticshubV1beta1>('restrictedExportConfig');
