...
/// {@template pulumi_analyticshub_v1beta1_data_exchange_iam_member_analyticshub_v1beta1_args_doc}
/// The set of arguments for DataExchangeIamMember.
/// {@endtemplate}
/// {@macro pulumi_analyticshub_v1beta1_data_exchange_iam_member_analyticshub_v1beta1_args_doc}
class DataExchangeIamMemberAnalyticshubV1beta1Args {
  ...
  /// Creates a new [DataExchangeIamMemberAnalyticshubV1beta1Args].
  ...
  const DataExchangeIamMemberAnalyticshubV1beta1Args({
    this.condition,
  ...
  factory DataExchangeIamMemberAnalyticshubV1beta1Args.fromMap(Map<String, dynamic> map) {
    return DataExchangeIamMemberAnalyticshubV1beta1Args(
