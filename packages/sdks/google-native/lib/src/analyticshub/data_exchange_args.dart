...
class DataExchangeArgs {
  ...
  factory DataExchangeArgs.fromMap(Map<String, dynamic> map) {
    return DataExchangeArgs(
      ...
      sharingEnvironmentConfig: (() { final guardedValue = map['sharingEnvironmentConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SharingEnvironmentConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
