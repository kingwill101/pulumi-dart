...
/// {@template pulumi_analyticshub_v1beta1_data_exchange_iam_binding_analyticshub_v1beta1_args_doc}
/// The set of arguments for DataExchangeIamBinding.
/// {@endtemplate}
/// {@macro pulumi_analyticshub_v1beta1_data_exchange_iam_binding_analyticshub_v1beta1_args_doc}
class DataExchangeIamBindingAnalyticshubV1beta1Args {
  ...
  /// Creates a new [DataExchangeIamBindingAnalyticshubV1beta1Args].
  ...
  const DataExchangeIamBindingAnalyticshubV1beta1Args({
    this.condition,
  ...
  factory DataExchangeIamBindingAnalyticshubV1beta1Args.fromMap(Map<String, dynamic> map) {
    return DataExchangeIamBindingAnalyticshubV1beta1Args(
