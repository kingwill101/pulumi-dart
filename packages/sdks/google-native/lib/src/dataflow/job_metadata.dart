...
class JobMetadata {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'sdkVersion':
          ?pulumi.Input.mapOptionalInputValue<SdkVersion, Map<String, dynamic>>(
            sdkVersion,
            (value) => value.toMap(),
          ),
      'spannerDetails':
  ...
  factory JobMetadata.fromMap(Map<String, dynamic> map) {
    return JobMetadata(
      bigTableDetails: (() {
        final guardedValue = map['bigTableDetails'];
      ...
      bigqueryDetails: (() {
        final guardedValue = map['bigqueryDetails'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      datastoreDetails: (() {
        final guardedValue = map['datastoreDetails'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      fileDetails: (() {
        final guardedValue = map['fileDetails'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FileIODetails>(
            guardedValue,
            (value) =>
                FileIODetails.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      pubsubDetails: (() {
        final guardedValue = map['pubsubDetails'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PubSubIODetails>(
            guardedValue,
            (value) =>
                PubSubIODetails.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      sdkVersion: (() {
        final guardedValue = map['sdkVersion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SdkVersion.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      spannerDetails: (() {
        final guardedValue = map['spannerDetails'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      userDisplayProperties: (() {
        final guardedValue = map['userDisplayProperties'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
