...
class WorkerPool {
    ...
    return <String, dynamic>{
      ...
      'defaultPackageSet':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(defaultPackageSet, (value) => value.wireValue),
      ...
      'ipConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(ipConfiguration, (value) => value.wireValue),
      'kind': ?kind,
      ...
      'taskrunnerSettings':
          ?pulumi.Input.mapOptionalInputValue<
            TaskRunnerSettings,
            Map<String, dynamic>
          >(taskrunnerSettings, (value) => value.toMap()),
      'teardownPolicy':
          ?pulumi.Input.mapOptionalInputValue<WorkerPoolTeardownPolicy, String>(
            teardownPolicy,
  ...
  factory WorkerPool.fromMap(Map<String, dynamic> map) {
    return WorkerPool(
      autoscalingSettings: (() {
        final guardedValue = map['autoscalingSettings'];
      ...
      defaultPackageSet: (() {
        final guardedValue = map['defaultPackageSet'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          WorkerPoolDefaultPackageSet.fromValue(guardedValue as String),
        );
      })(),
      diskSizeGb: (() {
      ...
      diskSourceImage: (() {
        final guardedValue = map['diskSourceImage'];
        if (guardedValue == null) return null;
      ...
      ipConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          WorkerPoolIpConfiguration.fromValue(guardedValue as String),
        );
      })(),
      kind: (() {
      ...
      numThreadsPerWorker: (() {
        final guardedValue = map['numThreadsPerWorker'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      numWorkers: (() {
        final guardedValue = map['numWorkers'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      onHostMaintenance: (() {
      ...
      packages: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<Package>(
            guardedValue,
            (value) => Package.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      poolArgs: (() {
        final guardedValue = map['poolArgs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as Map).cast<String, String>(),
        );
      ...
      sdkHarnessContainerImages: (() {
        final guardedValue = map['sdkHarnessContainerImages'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      taskrunnerSettings: (() {
        final guardedValue = map['taskrunnerSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      teardownPolicy: (() {
        final guardedValue = map['teardownPolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          WorkerPoolTeardownPolicy.fromValue(guardedValue as String),
        );
      })(),
      workerHarnessContainerImage: pulumi.Input.fromValue(
        map['workerHarnessContainerImage'] as String,
      ),
      zone: (() {
