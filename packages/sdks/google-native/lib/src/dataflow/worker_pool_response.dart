...
class WorkerPoolResponse {
  ...
  final pulumi.Input<List<SdkHarnessContainerImageResponse>>
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'sdkHarnessContainerImages':
          pulumi.Input.mapInputValue<
            List<SdkHarnessContainerImageResponse>,
            List<Map<String, dynamic>>
          >(
            sdkHarnessContainerImages,
            (value) =>
  ...
  factory WorkerPoolResponse.fromMap(Map<String, dynamic> map) {
    return WorkerPoolResponse(
      autoscalingSettings: pulumi.Input.fromValue(
        AutoscalingSettingsResponse.fromMap(
      ...
      defaultPackageSet: pulumi.Input.fromValue(
      ...
      numThreadsPerWorker: pulumi.Input.fromValue(
      ...
      packages: pulumi.Input.fromValue(
        pulumi.Input.decodeList<PackageResponse>(
          map['packages']!,
          (value) =>
              PackageResponse.fromMap((value as Map).cast<String, dynamic>()),
        ),
      ),
      poolArgs: pulumi.Input.fromValue(
        (map['poolArgs'] as Map).cast<String, String>(),
      ),
      sdkHarnessContainerImages: pulumi.Input.fromValue(
      ...
      taskrunnerSettings: pulumi.Input.fromValue(
        TaskRunnerSettingsResponse.fromMap(
