...
class WorkerPoolResponse {
  ...
  factory WorkerPoolResponse.fromMap(Map<String, dynamic> map) {
    return WorkerPoolResponse(
      autoscalingSettings: (AutoscalingSettingsResponse.fromMap((map['autoscalingSettings'] as Map).cast<String, dynamic>())).input(),
      dataDisks: (pulumi.Input.decodeList<DiskResponse>(map['dataDisks'], (value) => DiskResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      defaultPackageSet: (map['defaultPackageSet'] as String).input(),
      diskSizeGb: (map['diskSizeGb'] as int).input(),
      diskSourceImage: (map['diskSourceImage'] as String).input(),
      diskType: (map['diskType'] as String).input(),
      ipConfiguration: (map['ipConfiguration'] as String).input(),
      kind: (map['kind'] as String).input(),
      machineType: (map['machineType'] as String).input(),
      metadata: ((map['metadata'] as Map).cast<String, String>()).input(),
      network: (map['network'] as String).input(),
      numThreadsPerWorker: (map['numThreadsPerWorker'] as int).input(),
      numWorkers: (map['numWorkers'] as int).input(),
      onHostMaintenance: (map['onHostMaintenance'] as String).input(),
      packages: (pulumi.Input.decodeList<PackageResponse>(map['packages'], (value) => PackageResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      poolArgs: ((map['poolArgs'] as Map).cast<String, String>()).input(),
      sdkHarnessContainerImages: (pulumi.Input.decodeList<SdkHarnessContainerImageResponse>(map['sdkHarnessContainerImages'], (value) => SdkHarnessContainerImageResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      subnetwork: (map['subnetwork'] as String).input(),
      taskrunnerSettings: (TaskRunnerSettingsResponse.fromMap((map['taskrunnerSettings'] as Map).cast<String, dynamic>())).input(),
      teardownPolicy: (map['teardownPolicy'] as String).input(),
