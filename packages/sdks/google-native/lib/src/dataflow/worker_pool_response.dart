...
class WorkerPoolResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'dataDisks': pulumi.Input.encodeList<DiskResponse, Map<String, dynamic>>(dataDisks, (value) => value.toMap()),
      ...
      'packages': pulumi.Input.encodeList<PackageResponse, Map<String, dynamic>>(packages, (value) => value.toMap()),
      'poolArgs': poolArgs,
      'sdkHarnessContainerImages': pulumi.Input.encodeList<SdkHarnessContainerImageResponse, Map<String, dynamic>>(sdkHarnessContainerImages, (value) => value.toMap()),
  ...
  factory WorkerPoolResponse.fromMap(Map<String, dynamic> map) {
    return WorkerPoolResponse(
      autoscalingSettings: AutoscalingSettingsResponse.fromMap((map['autoscalingSettings'] as Map).cast<String, dynamic>()),
      dataDisks: pulumi.Input.decodeList<DiskResponse>(map['dataDisks'], (value) => DiskResponse.fromMap((value as Map).cast<String, dynamic>())),
      ...
      packages: pulumi.Input.decodeList<PackageResponse>(map['packages'], (value) => PackageResponse.fromMap((value as Map).cast<String, dynamic>())),
      poolArgs: (map['poolArgs'] as Map).cast<String, String>(),
      sdkHarnessContainerImages: pulumi.Input.decodeList<SdkHarnessContainerImageResponse>(map['sdkHarnessContainerImages'], (value) => SdkHarnessContainerImageResponse.fromMap((value as Map).cast<String, dynamic>())),
      subnetwork: map['subnetwork'] as String,
      taskrunnerSettings: TaskRunnerSettingsResponse.fromMap((map['taskrunnerSettings'] as Map).cast<String, dynamic>()),
