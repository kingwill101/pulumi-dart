...
class ExecutionStageStateResponse {
  ...
  factory ExecutionStageStateResponse.fromMap(Map<String, dynamic> map) {
    return ExecutionStageStateResponse(
      currentStateTime: pulumi.Input.fromValue(map['currentStateTime'] as String),
      executionStageName: pulumi.Input.fromValue(map['executionStageName'] as String),
      executionStageState: pulumi.Input.fromValue(map['executionStageState'] as String),
    );
  }
}
