...
class RuntimeEnvironment {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ipConfiguration': ?pulumi.Input.mapOptionalInputValue<RuntimeEnvironmentIpConfiguration, String>(ipConfiguration, (value) => value.value),
  ...
  factory RuntimeEnvironment.fromMap(Map<String, dynamic> map) {
    return RuntimeEnvironment(
      ...
      bypassTempDirValidation: map['bypassTempDirValidation'] == null ? null : (map['bypassTempDirValidation']! as bool).input(),
      diskSizeGb: map['diskSizeGb'] == null ? null : (map['diskSizeGb']! as int).input(),
      enableStreamingEngine: map['enableStreamingEngine'] == null ? null : (map['enableStreamingEngine']! as bool).input(),
      ipConfiguration: map['ipConfiguration'] == null ? null : (RuntimeEnvironmentIpConfiguration.fromValue(map['ipConfiguration']! as String)).input(),
      ...
      tempLocation: (map['tempLocation'] as String).input(),
