...
class RuntimeEnvironment {
  ...
  factory RuntimeEnvironment.fromMap(Map<String, dynamic> map) {
    return RuntimeEnvironment(
      ...
      additionalUserLabels: (() {
        final guardedValue = map['additionalUserLabels'];
        if (guardedValue == null) return null;
      ...
      bypassTempDirValidation: (() {
        final guardedValue = map['bypassTempDirValidation'];
        if (guardedValue == null) return null;
      ...
      ipConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RuntimeEnvironmentIpConfiguration.fromValue(guardedValue as String),
        );
      })(),
      kmsKeyName: (() {
