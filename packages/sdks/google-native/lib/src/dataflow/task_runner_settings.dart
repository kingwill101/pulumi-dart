...
class TaskRunnerSettings {
    ...
    return <String, dynamic>{
      ...
      'parallelWorkerSettings':
          ?pulumi.Input.mapOptionalInputValue<
            WorkerSettings,
            Map<String, dynamic>
          >(parallelWorkerSettings, (value) => value.toMap()),
  ...
  factory TaskRunnerSettings.fromMap(Map<String, dynamic> map) {
    return TaskRunnerSettings(
      alsologtostderr: (() {
        final guardedValue = map['alsologtostderr'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      baseTaskDir: (() {
        final guardedValue = map['baseTaskDir'];
        if (guardedValue == null) return null;
      ...
      commandlinesFileName: (() {
        final guardedValue = map['commandlinesFileName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      continueOnException: (() {
        final guardedValue = map['continueOnException'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      dataflowApiVersion: (() {
        final guardedValue = map['dataflowApiVersion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      harnessCommand: (() {
        final guardedValue = map['harnessCommand'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      languageHint: (() {
        final guardedValue = map['languageHint'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      logDir: (() {
      ...
      logToSerialconsole: (() {
        final guardedValue = map['logToSerialconsole'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      logUploadLocation: (() {
        final guardedValue = map['logUploadLocation'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      oauthScopes: (() {
      ...
      parallelWorkerSettings: (() {
        final guardedValue = map['parallelWorkerSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          WorkerSettings.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      streamingWorkerMainClass: (() {
        final guardedValue = map['streamingWorkerMainClass'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      taskGroup: (() {
        final guardedValue = map['taskGroup'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      taskUser: (() {
        final guardedValue = map['taskUser'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      tempStoragePrefix: (() {
      ...
      workflowFileName: (() {
        final guardedValue = map['workflowFileName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
