...
class EnvironmentResponse {
  ...
  factory EnvironmentResponse.fromMap(Map<String, dynamic> map) {
    return EnvironmentResponse(
      clusterManagerApiService: pulumi.Input.fromValue(map['clusterManagerApiService'] as String),
      dataset: pulumi.Input.fromValue(map['dataset'] as String),
      debugOptions: pulumi.Input.fromValue(DebugOptionsResponse.fromMap((map['debugOptions']! as Map).cast<String, dynamic>())),
      experiments: pulumi.Input.fromValue((map['experiments'] as List).cast<String>()),
      flexResourceSchedulingGoal: pulumi.Input.fromValue(map['flexResourceSchedulingGoal'] as String),
      internalExperiments: pulumi.Input.fromValue((map['internalExperiments'] as Map).cast<String, String>()),
      sdkPipelineOptions: pulumi.Input.fromValue((map['sdkPipelineOptions'] as Map).cast<String, String>()),
      serviceAccountEmail: pulumi.Input.fromValue(map['serviceAccountEmail'] as String),
      serviceKmsKeyName: pulumi.Input.fromValue(map['serviceKmsKeyName'] as String),
      serviceOptions: pulumi.Input.fromValue((map['serviceOptions'] as List).cast<String>()),
      shuffleMode: pulumi.Input.fromValue(map['shuffleMode'] as String),
      tempStoragePrefix: pulumi.Input.fromValue(map['tempStoragePrefix'] as String),
      useStreamingEngineResourceBasedBilling: pulumi.Input.fromValue(map['useStreamingEngineResourceBasedBilling'] as bool),
      userAgent: pulumi.Input.fromValue((map['userAgent'] as Map).cast<String, String>()),
      version: pulumi.Input.fromValue((map['version'] as Map).cast<String, String>()),
      workerPools: pulumi.Input.fromValue(pulumi.Input.decodeList<WorkerPoolResponse>(map['workerPools']!, (value) => WorkerPoolResponse.fromMap((value as Map).cast<String, dynamic>()))),
