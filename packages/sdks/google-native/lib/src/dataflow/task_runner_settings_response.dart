...
class TaskRunnerSettingsResponse {
  ...
  factory TaskRunnerSettingsResponse.fromMap(Map<String, dynamic> map) {
    return TaskRunnerSettingsResponse(
      ...
      commandlinesFileName: pulumi.Input.fromValue(
        map['commandlinesFileName'] as String,
      ),
      continueOnException: pulumi.Input.fromValue(
        map['continueOnException'] as bool,
      ),
      dataflowApiVersion: pulumi.Input.fromValue(
      ...
      logToSerialconsole: pulumi.Input.fromValue(
        map['logToSerialconsole'] as bool,
      ),
      logUploadLocation: pulumi.Input.fromValue(
        map['logUploadLocation'] as String,
      ),
      oauthScopes: pulumi.Input.fromValue(
        (map['oauthScopes'] as List).cast<String>(),
      ),
      parallelWorkerSettings: pulumi.Input.fromValue(
        WorkerSettingsResponse.fromMap(
          (map['parallelWorkerSettings']! as Map).cast<String, dynamic>(),
        ),
      ),
      streamingWorkerMainClass: pulumi.Input.fromValue(
      ...
      workflowFileName: pulumi.Input.fromValue(
