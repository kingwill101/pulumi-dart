...
class Environment {
  ...
  final pulumi.Input<EnvironmentFlexResourceSchedulingGoal>? flexResourceSchedulingGoal;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'dataset': ?dataset,
      'debugOptions': ?pulumi.Input.mapOptionalInputValue<DebugOptions, Map<String, dynamic>>(debugOptions, (value) => value.toMap()),
      'experiments': ?experiments,
      'flexResourceSchedulingGoal': ?pulumi.Input.mapOptionalInputValue<EnvironmentFlexResourceSchedulingGoal, String>(flexResourceSchedulingGoal, (value) => value.wireValue),
      ...
      'userAgent': ?userAgent,
      'version': ?version,
      'workerPools': ?pulumi.Input.mapOptionalInputValue<List<WorkerPool>, List<Map<String, dynamic>>>(workerPools, (value) => pulumi.Input.encodeList<WorkerPool, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory Environment.fromMap(Map<String, dynamic> map) {
    return Environment(
      clusterManagerApiService: (() { final guardedValue = map['clusterManagerApiService']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      debugOptions: (() { final guardedValue = map['debugOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DebugOptions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      experiments: (() { final guardedValue = map['experiments']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      flexResourceSchedulingGoal: (() { final guardedValue = map['flexResourceSchedulingGoal']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EnvironmentFlexResourceSchedulingGoal.fromValue(guardedValue as String)); })(),
      internalExperiments: (() { final guardedValue = map['internalExperiments']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      sdkPipelineOptions: (() { final guardedValue = map['sdkPipelineOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      ...
      serviceKmsKeyName: (() { final guardedValue = map['serviceKmsKeyName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      serviceOptions: (() { final guardedValue = map['serviceOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      ...
      userAgent: (() { final guardedValue = map['userAgent']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      ...
      workerPools: (() { final guardedValue = map['workerPools']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<WorkerPool>(guardedValue, (value) => WorkerPool.fromMap((value as Map).cast<String, dynamic>()))); })(),
