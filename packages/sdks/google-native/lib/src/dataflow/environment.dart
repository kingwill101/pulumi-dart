...
class Environment {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'flexResourceSchedulingGoal': ?pulumi.Input.mapOptionalInputValue<EnvironmentFlexResourceSchedulingGoal, String>(flexResourceSchedulingGoal, (value) => value.value),
