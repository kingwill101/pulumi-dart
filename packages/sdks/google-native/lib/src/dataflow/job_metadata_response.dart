...
class JobMetadataResponse {
    ...
    return <String, dynamic>{
      'bigTableDetails':
          pulumi.Input.mapInputValue<
            List<BigTableIODetailsResponse>,
      ...
      'bigqueryDetails':
          pulumi.Input.mapInputValue<
            List<BigQueryIODetailsResponse>,
            List<Map<String, dynamic>>
          >(
            bigqueryDetails,
            (value) =>
      ...
      'datastoreDetails':
          pulumi.Input.mapInputValue<
            List<DatastoreIODetailsResponse>,
            List<Map<String, dynamic>>
          >(
            datastoreDetails,
            (value) =>
      ...
      'sdkVersion':
          pulumi.Input.mapInputValue<SdkVersionResponse, Map<String, dynamic>>(
            sdkVersion,
            (value) => value.toMap(),
          ),
      'spannerDetails':
          pulumi.Input.mapInputValue<
            List<SpannerIODetailsResponse>,
            List<Map<String, dynamic>>
          >(
            spannerDetails,
            (value) =>
  ...
  factory JobMetadataResponse.fromMap(Map<String, dynamic> map) {
    return JobMetadataResponse(
      bigTableDetails: pulumi.Input.fromValue(
        pulumi.Input.decodeList<BigTableIODetailsResponse>(
          map['bigTableDetails']!,
      ...
      bigqueryDetails: pulumi.Input.fromValue(
        pulumi.Input.decodeList<BigQueryIODetailsResponse>(
          map['bigqueryDetails']!,
      ...
      datastoreDetails: pulumi.Input.fromValue(
        pulumi.Input.decodeList<DatastoreIODetailsResponse>(
      ...
      fileDetails: pulumi.Input.fromValue(
        pulumi.Input.decodeList<FileIODetailsResponse>(
          map['fileDetails']!,
      ...
      pubsubDetails: pulumi.Input.fromValue(
        pulumi.Input.decodeList<PubSubIODetailsResponse>(
          map['pubsubDetails']!,
      ...
      sdkVersion: pulumi.Input.fromValue(
        SdkVersionResponse.fromMap(
          (map['sdkVersion']! as Map).cast<String, dynamic>(),
        ),
      ),
      spannerDetails: pulumi.Input.fromValue(
        pulumi.Input.decodeList<SpannerIODetailsResponse>(
          map['spannerDetails']!,
      ...
      userDisplayProperties: pulumi.Input.fromValue(
