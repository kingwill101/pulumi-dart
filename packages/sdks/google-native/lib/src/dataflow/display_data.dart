...
class DisplayData {
  ...
  factory DisplayData.fromMap(Map<String, dynamic> map) {
    return DisplayData(
      ...
      durationValue: (() {
        final guardedValue = map['durationValue'];
        if (guardedValue == null) return null;
      ...
      int64Value: (() {
        final guardedValue = map['int64Value'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      javaClassValue: (() {
        final guardedValue = map['javaClassValue'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      key: (() {
      ...
      shortStrValue: (() {
        final guardedValue = map['shortStrValue'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      strValue: (() {
        final guardedValue = map['strValue'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      timestampValue: (() {
