...
class DisplayData {
  ...
  factory DisplayData.fromMap(Map<String, dynamic> map) {
    return DisplayData(
      ...
      durationValue: map['durationValue'] == null ? null : map['durationValue'] as String,
      floatValue: map['floatValue'] == null ? null : map['floatValue'] as double,
      int64Value: map['int64Value'] == null ? null : map['int64Value'] as String,
      javaClassValue: map['javaClassValue'] == null ? null : map['javaClassValue'] as String,
      key: map['key'] == null ? null : map['key'] as String,
      label: map['label'] == null ? null : map['label'] as String,
      namespace: map['namespace'] == null ? null : map['namespace'] as String,
      shortStrValue: map['shortStrValue'] == null ? null : map['shortStrValue'] as String,
