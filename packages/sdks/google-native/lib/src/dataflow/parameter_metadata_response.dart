...
class ParameterMetadataResponse {
  ...
  factory ParameterMetadataResponse.fromMap(Map<String, dynamic> map) {
    return ParameterMetadataResponse(
      ...
      enumOptions: pulumi.Input.fromValue(pulumi.Input.decodeList<ParameterMetadataEnumOptionResponse>(map['enumOptions']!, (value) => ParameterMetadataEnumOptionResponse.fromMap((value as Map).cast<String, dynamic>()))),
      groupName: pulumi.Input.fromValue(map['groupName'] as String),
      helpText: pulumi.Input.fromValue(map['helpText'] as String),
      isOptional: pulumi.Input.fromValue(map['isOptional'] as bool),
      label: pulumi.Input.fromValue(map['label'] as String),
      name: pulumi.Input.fromValue(map['name'] as String),
      paramType: pulumi.Input.fromValue(map['paramType'] as String),
      parentName: pulumi.Input.fromValue(map['parentName'] as String),
      parentTriggerValues: pulumi.Input.fromValue((map['parentTriggerValues'] as List).cast<String>()),
