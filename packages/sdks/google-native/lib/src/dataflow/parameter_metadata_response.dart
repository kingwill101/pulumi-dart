...
class ParameterMetadataResponse {
    ...
    return <String, dynamic>{
      ...
      'enumOptions':
          pulumi.Input.mapInputValue<
            List<ParameterMetadataEnumOptionResponse>,
  ...
  factory ParameterMetadataResponse.fromMap(Map<String, dynamic> map) {
    return ParameterMetadataResponse(
      customMetadata: pulumi.Input.fromValue(
        (map['customMetadata'] as Map).cast<String, String>(),
      ),
      defaultValue: pulumi.Input.fromValue(map['defaultValue'] as String),
      enumOptions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ParameterMetadataEnumOptionResponse>(
          map['enumOptions']!,
      ...
      parentTriggerValues: pulumi.Input.fromValue(
        (map['parentTriggerValues'] as List).cast<String>(),
      ),
