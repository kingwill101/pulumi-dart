...
class DisplayDataResponse {
  ...
  factory DisplayDataResponse.fromMap(Map<String, dynamic> map) {
    return DisplayDataResponse(
      ...
      durationValue: (map['durationValue'] as String).input(),
      floatValue: (map['floatValue'] as double).input(),
      int64Value: (map['int64Value'] as String).input(),
      javaClassValue: (map['javaClassValue'] as String).input(),
      key: (map['key'] as String).input(),
      label: (map['label'] as String).input(),
      namespace: (map['namespace'] as String).input(),
      shortStrValue: (map['shortStrValue'] as String).input(),
      strValue: (map['strValue'] as String).input(),
