...
class JobArgs {
  ...
  factory JobArgs.fromMap(Map<String, dynamic> map) {
    return JobArgs(
      clientRequestId: map['clientRequestId'] == null ? null : (map['clientRequestId']! as String).input(),
      createTime: map['createTime'] == null ? null : (map['createTime']! as String).input(),
      createdFromSnapshotId: map['createdFromSnapshotId'] == null ? null : (map['createdFromSnapshotId']! as String).input(),
      currentState: map['currentState'] == null ? null : (JobCurrentState.fromValue(map['currentState']! as String)).input(),
      ...
      executionInfo: map['executionInfo'] == null ? null : (JobExecutionInfo.fromMap((map['executionInfo']! as Map).cast<String, dynamic>())).input(),
      id: map['id'] == null ? null : (map['id']! as String).input(),
      jobMetadata: map['jobMetadata'] == null ? null : (JobMetadata.fromMap((map['jobMetadata']! as Map).cast<String, dynamic>())).input(),
      labels: map['labels'] == null ? null : ((map['labels']! as Map).cast<String, String>()).input(),
      location: map['location'] == null ? null : (map['location']! as String).input(),
      name: map['name'] == null ? null : (map['name']! as String).input(),
      pipelineDescription: map['pipelineDescription'] == null ? null : (PipelineDescription.fromMap((map['pipelineDescription']! as Map).cast<String, dynamic>())).input(),
      project: map['project'] == null ? null : (map['project']! as String).input(),
      replaceJobId: map['replaceJobId'] == null ? null : (map['replaceJobId']! as String).input(),
      replacedByJobId: map['replacedByJobId'] == null ? null : (map['replacedByJobId']! as String).input(),
      requestedState: map['requestedState'] == null ? null : (JobRequestedState.fromValue(map['requestedState']! as String)).input(),
      runtimeUpdatableParams: map['runtimeUpdatableParams'] == null ? null : (RuntimeUpdatableParams.fromMap((map['runtimeUpdatableParams']! as Map).cast<String, dynamic>())).input(),
      satisfiesPzs: map['satisfiesPzs'] == null ? null : (map['satisfiesPzs']! as bool).input(),
      stageStates: map['stageStates'] == null ? null : (pulumi.Input.decodeList<ExecutionStageState>(map['stageStates']!, (value) => ExecutionStageState.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      stepsLocation: map['stepsLocation'] == null ? null : (map['stepsLocation']! as String).input(),
      tempFiles: map['tempFiles'] == null ? null : ((map['tempFiles']! as List).cast<String>()).input(),
      transformNameMapping: map['transformNameMapping'] == null ? null : ((map['transformNameMapping']! as Map).cast<String, String>()).input(),
      type: map['type'] == null ? null : (JobType.fromValue(map['type']! as String)).input(),
