...
class JobArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'currentState': ?pulumi.Input.mapOptionalInputValue<JobCurrentState, String>(currentState, (value) => value.wireValue),
      ...
      'requestedState': ?pulumi.Input.mapOptionalInputValue<JobRequestedState, String>(requestedState, (value) => value.wireValue),
      ...
      'type': ?pulumi.Input.mapOptionalInputValue<JobType, String>(type, (value) => value.wireValue),
      'view': ?view,
    };
  }
  ...
  factory JobArgs.fromMap(Map<String, dynamic> map) {
    return JobArgs(
      clientRequestId: (() { final guardedValue = map['clientRequestId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      createTime: (() { final guardedValue = map['createTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      createdFromSnapshotId: (() { final guardedValue = map['createdFromSnapshotId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      currentState: (() { final guardedValue = map['currentState']; if (guardedValue == null) return null; return pulumi.Input.fromValue(JobCurrentState.fromValue(guardedValue as String)); })(),
      ...
      executionInfo: (() { final guardedValue = map['executionInfo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(JobExecutionInfo.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      id: (() { final guardedValue = map['id']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      jobMetadata: (() { final guardedValue = map['jobMetadata']; if (guardedValue == null) return null; return pulumi.Input.fromValue(JobMetadata.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      labels: (() { final guardedValue = map['labels']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      location: (() { final guardedValue = map['location']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      pipelineDescription: (() { final guardedValue = map['pipelineDescription']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PipelineDescription.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      project: (() { final guardedValue = map['project']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      replaceJobId: (() { final guardedValue = map['replaceJobId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      replacedByJobId: (() { final guardedValue = map['replacedByJobId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      requestedState: (() { final guardedValue = map['requestedState']; if (guardedValue == null) return null; return pulumi.Input.fromValue(JobRequestedState.fromValue(guardedValue as String)); })(),
      runtimeUpdatableParams: (() { final guardedValue = map['runtimeUpdatableParams']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RuntimeUpdatableParams.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      stageStates: (() { final guardedValue = map['stageStates']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ExecutionStageState>(guardedValue, (value) => ExecutionStageState.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      stepsLocation: (() { final guardedValue = map['stepsLocation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      tempFiles: (() { final guardedValue = map['tempFiles']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      ...
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(JobType.fromValue(guardedValue as String)); })(),
