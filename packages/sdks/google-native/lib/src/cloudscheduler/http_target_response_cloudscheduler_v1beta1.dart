...
class HttpTargetResponseCloudschedulerV1beta1 {
  ...
  factory HttpTargetResponseCloudschedulerV1beta1.fromMap(Map<String, dynamic> map) {
    return HttpTargetResponseCloudschedulerV1beta1(
      ...
      oauthToken: OAuthTokenResponseCloudschedulerV1beta1.fromMap((map['oauthToken'] as Map).cast<String, dynamic>()),
      oidcToken: OidcTokenResponseCloudschedulerV1beta1.fromMap((map['oidcToken'] as Map).cast<String, dynamic>()),
