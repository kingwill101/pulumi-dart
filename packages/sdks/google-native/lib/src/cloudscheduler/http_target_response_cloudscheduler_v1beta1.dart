...
class HttpTargetResponseCloudschedulerV1beta1 {
  ...
  final pulumi.Input<OAuthTokenResponseCloudschedulerV1beta1> oauthToken;
  /// If specified, an [OIDC](https://developers.google.com/identity/protocols/OpenIDConnect) token will be generated and attached as an `Authorization` header in the HTTP request. This type of authorization can be used for many scenarios, including calling Cloud Run, or endpoints where you intend to validate the token yourself.
  final pulumi.Input<OidcTokenResponseCloudschedulerV1beta1> oidcToken;
  ...
  const HttpTargetResponseCloudschedulerV1beta1({
    required this.body,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'oauthToken': pulumi.Input.mapInputValue<OAuthTokenResponseCloudschedulerV1beta1, Map<String, dynamic>>(oauthToken, (value) => value.toMap()),
      'oidcToken': pulumi.Input.mapInputValue<OidcTokenResponseCloudschedulerV1beta1, Map<String, dynamic>>(oidcToken, (value) => value.toMap()),
      'uri': uri,
    };
  }

  factory HttpTargetResponseCloudschedulerV1beta1.fromMap(Map<String, dynamic> map) {
    return HttpTargetResponseCloudschedulerV1beta1(
      ...
      oauthToken: pulumi.Input.fromValue(OAuthTokenResponseCloudschedulerV1beta1.fromMap((map['oauthToken']! as Map).cast<String, dynamic>())),
      oidcToken: pulumi.Input.fromValue(OidcTokenResponseCloudschedulerV1beta1.fromMap((map['oidcToken']! as Map).cast<String, dynamic>())),
