...
import 'app_engine_http_target_http_method.dart';
...
class AppEngineHttpTarget {
  ...
  final pulumi.Input<AppEngineRouting>? appEngineRouting;
  ...
  final pulumi.Input<AppEngineHttpTargetHttpMethod>? httpMethod;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'appEngineRouting': ?pulumi.Input.mapOptionalInputValue<AppEngineRouting, Map<String, dynamic>>(appEngineRouting, (value) => value.toMap()),
      'body': ?body,
      'headers': ?headers,
      'httpMethod': ?pulumi.Input.mapOptionalInputValue<AppEngineHttpTargetHttpMethod, String>(httpMethod, (value) => value.wireValue),
  ...
  factory AppEngineHttpTarget.fromMap(Map<String, dynamic> map) {
    return AppEngineHttpTarget(
      appEngineRouting: (() { final guardedValue = map['appEngineRouting']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AppEngineRouting.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      httpMethod: (() { final guardedValue = map['httpMethod']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AppEngineHttpTargetHttpMethod.fromValue(guardedValue as String)); })(),
