  ...
  factory JobArgs.fromMap(Map<String, dynamic> map) {
    return JobArgs(
      ...
      httpTarget: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          HttpTarget.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      location: (() {
      ...
      pubsubTarget: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PubsubTarget.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      retryConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RetryConfig.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      schedule: (() {
