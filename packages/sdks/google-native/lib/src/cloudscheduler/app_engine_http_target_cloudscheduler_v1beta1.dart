...
class AppEngineHttpTargetCloudschedulerV1beta1 {
  ...
  const AppEngineHttpTargetCloudschedulerV1beta1({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'body': ?body,
      'headers': ?headers,
      'httpMethod': ?pulumi.Input.mapOptionalInputValue<AppEngineHttpTargetHttpMethodCloudschedulerV1beta1, String>(httpMethod, (value) => value.wireValue),
  ...
  factory AppEngineHttpTargetCloudschedulerV1beta1.fromMap(Map<String, dynamic> map) {
    return AppEngineHttpTargetCloudschedulerV1beta1(
      appEngineRouting: (() { final guardedValue = map['appEngineRouting']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AppEngineRoutingCloudschedulerV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      httpMethod: (() { final guardedValue = map['httpMethod']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AppEngineHttpTargetHttpMethodCloudschedulerV1beta1.fromValue(guardedValue as String)); })(),
