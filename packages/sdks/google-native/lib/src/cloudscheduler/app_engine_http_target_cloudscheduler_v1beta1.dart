...
class AppEngineHttpTargetCloudschedulerV1beta1 {
  ...
  factory AppEngineHttpTargetCloudschedulerV1beta1.fromMap(Map<String, dynamic> map) {
    return AppEngineHttpTargetCloudschedulerV1beta1(
      appEngineRouting: map['appEngineRouting'] == null ? null : AppEngineRoutingCloudschedulerV1beta1.fromMap((map['appEngineRouting'] as Map).cast<String, dynamic>()),
      body: map['body'] == null ? null : map['body'] as String,
      headers: map['headers'] == null ? null : (map['headers'] as Map).cast<String, String>(),
      httpMethod: map['httpMethod'] == null ? null : AppEngineHttpTargetHttpMethodCloudschedulerV1beta1.fromValue(map['httpMethod'] as String),
