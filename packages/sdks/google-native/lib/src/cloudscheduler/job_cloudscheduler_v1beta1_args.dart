...
class JobCloudschedulerV1beta1Args {
  ...
  const JobCloudschedulerV1beta1Args({
  ...
  factory JobCloudschedulerV1beta1Args.fromMap(Map<String, dynamic> map) {
    return JobCloudschedulerV1beta1Args(
      appEngineHttpTarget: (() { final guardedValue = map['appEngineHttpTarget']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AppEngineHttpTargetCloudschedulerV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      httpTarget: (() { final guardedValue = map['httpTarget']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HttpTargetCloudschedulerV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      legacyAppEngineCron: (() { final guardedValue = map['legacyAppEngineCron']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      location: (() { final guardedValue = map['location']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      project: (() { final guardedValue = map['project']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      pubsubTarget: (() { final guardedValue = map['pubsubTarget']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PubsubTargetCloudschedulerV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      retryConfig: (() { final guardedValue = map['retryConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RetryConfigCloudschedulerV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
