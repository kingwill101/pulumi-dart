...
class RetryConfigResponseCloudschedulerV1beta1 {
  ...
  /// Creates a new [RetryConfigResponseCloudschedulerV1beta1].
  ...
  RetryConfigResponseCloudschedulerV1beta1({
  ...
  factory RetryConfigResponseCloudschedulerV1beta1.fromMap(Map<String, dynamic> map) {
    return RetryConfigResponseCloudschedulerV1beta1(
      maxBackoffDuration: (map['maxBackoffDuration'] as String).input(),
      maxDoublings: (map['maxDoublings'] as int).input(),
      maxRetryDuration: (map['maxRetryDuration'] as String).input(),
      minBackoffDuration: (map['minBackoffDuration'] as String).input(),
