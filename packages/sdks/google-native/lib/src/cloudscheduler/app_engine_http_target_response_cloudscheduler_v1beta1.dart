...
import 'app_engine_routing_response_cloudscheduler_v1beta1.dart';

/// App Engine target. The job will be pushed to a job handler by means of an HTTP request via an http_method such as HTTP POST, HTTP GET, etc. The job is acknowledged by means of an HTTP response code in the range [200 - 299]. Error 503 is considered an App Engine system error instead of an application error. Requests returning error 503 will be retried regardless of retry configuration and not counted against retry counts. Any other response code, or a failure to receive a response before the deadline, constitutes a failed attempt.
class AppEngineHttpTargetResponseCloudschedulerV1beta1 {
  /// App Engine Routing setting for the job.
  final pulumi.Input<AppEngineRoutingResponseCloudschedulerV1beta1> appEngineRouting;
  ...
  /// Creates a new [AppEngineHttpTargetResponseCloudschedulerV1beta1].
  ...
  const AppEngineHttpTargetResponseCloudschedulerV1beta1({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'appEngineRouting': pulumi.Input.mapInputValue<AppEngineRoutingResponseCloudschedulerV1beta1, Map<String, dynamic>>(appEngineRouting, (value) => value.toMap()),
      'body': body,
      'headers': headers,
  ...
  factory AppEngineHttpTargetResponseCloudschedulerV1beta1.fromMap(Map<String, dynamic> map) {
    return AppEngineHttpTargetResponseCloudschedulerV1beta1(
      appEngineRouting: pulumi.Input.fromValue(AppEngineRoutingResponseCloudschedulerV1beta1.fromMap((map['appEngineRouting']! as Map).cast<String, dynamic>())),
