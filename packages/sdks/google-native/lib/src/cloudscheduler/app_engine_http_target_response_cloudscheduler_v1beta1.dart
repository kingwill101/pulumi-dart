...
class AppEngineHttpTargetResponseCloudschedulerV1beta1 {
  ...
  final pulumi.Input<AppEngineRoutingResponseCloudschedulerV1beta1>
  appEngineRouting;
  ...
  factory AppEngineHttpTargetResponseCloudschedulerV1beta1.fromMap(
    Map<String, dynamic> map,
  ) {
    return AppEngineHttpTargetResponseCloudschedulerV1beta1(
      appEngineRouting: pulumi.Input.fromValue(
        AppEngineRoutingResponseCloudschedulerV1beta1.fromMap(
