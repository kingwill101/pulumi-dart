...
class AppEngineHttpTargetResponseCloudschedulerV1beta1 {
  ...
  final AppEngineRoutingResponseCloudschedulerV1beta1 appEngineRouting;
  ...
  factory AppEngineHttpTargetResponseCloudschedulerV1beta1.fromMap(Map<String, dynamic> map) {
    return AppEngineHttpTargetResponseCloudschedulerV1beta1(
      appEngineRouting: AppEngineRoutingResponseCloudschedulerV1beta1.fromMap((map['appEngineRouting'] as Map).cast<String, dynamic>()),
