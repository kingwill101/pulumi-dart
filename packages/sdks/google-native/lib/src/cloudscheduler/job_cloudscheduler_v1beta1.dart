...
class JobCloudschedulerV1beta1 extends pulumi.CustomResource {
  ...
  JobCloudschedulerV1beta1(
    ...
    this.appEngineHttpTarget = registerOutput<AppEngineHttpTargetResponseCloudschedulerV1beta1>('appEngineHttpTarget');
    this.attemptDeadline = registerOutput<String>('attemptDeadline');
    this.description = registerOutput<String>('description');
    this.httpTarget = registerOutput<HttpTargetResponseCloudschedulerV1beta1>('httpTarget');
    ...
    this.pubsubTarget = registerOutput<PubsubTargetResponseCloudschedulerV1beta1>('pubsubTarget');
    this.retryConfig = registerOutput<RetryConfigResponseCloudschedulerV1beta1>('retryConfig');
