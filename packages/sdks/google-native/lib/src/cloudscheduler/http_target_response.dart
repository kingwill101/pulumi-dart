...
class HttpTargetResponse {
  ...
  final pulumi.Input<OAuthTokenResponse> oauthToken;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'oauthToken': pulumi.Input.mapInputValue<OAuthTokenResponse, Map<String, dynamic>>(oauthToken, (value) => value.toMap()),
  ...
  factory HttpTargetResponse.fromMap(Map<String, dynamic> map) {
    return HttpTargetResponse(
      ...
      oauthToken: pulumi.Input.fromValue(OAuthTokenResponse.fromMap((map['oauthToken']! as Map).cast<String, dynamic>())),
