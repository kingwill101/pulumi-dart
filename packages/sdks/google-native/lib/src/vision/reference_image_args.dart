...
class ReferenceImageArgs {
  ...
  factory ReferenceImageArgs.fromMap(Map<String, dynamic> map) {
    return ReferenceImageArgs(
      ...
      referenceImageId: (() { final guardedValue = map['referenceImageId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
