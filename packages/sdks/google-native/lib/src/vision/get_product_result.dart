...
class GetProductResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'productLabels': pulumi.Input.encodeList<KeyValueResponse, Map<String, dynamic>>(productLabels, (value) => value.toMap()),
    };
  }
  ...
  factory GetProductResult.fromMap(Map<String, dynamic> map) {
    return GetProductResult(
      ...
      productLabels: pulumi.Input.decodeList<KeyValueResponse>(map['productLabels']!, (value) => KeyValueResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
