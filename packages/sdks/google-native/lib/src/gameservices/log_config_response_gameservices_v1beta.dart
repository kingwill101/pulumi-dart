  ...
  factory LogConfigResponseGameservicesV1beta.fromMap(
    ...
    return LogConfigResponseGameservicesV1beta(
      cloudAudit: pulumi.Input.fromValue(
        CloudAuditOptionsResponseGameservicesV1beta.fromMap(
          (map['cloudAudit']! as Map).cast<String, dynamic>(),
        ),
      ),
      counter: pulumi.Input.fromValue(
        CounterOptionsResponseGameservicesV1beta.fromMap(
          (map['counter']! as Map).cast<String, dynamic>(),
        ),
      ),
      dataAccess: pulumi.Input.fromValue(
        DataAccessOptionsResponseGameservicesV1beta.fromMap(
