...
/// {@template pulumi_gameservices_v1beta_game_server_deployment_iam_member_gameservices_v1beta_args_doc}
/// The set of arguments for GameServerDeploymentIamMember.
/// {@endtemplate}
/// {@macro pulumi_gameservices_v1beta_game_server_deployment_iam_member_gameservices_v1beta_args_doc}
class GameServerDeploymentIamMemberGameservicesV1betaArgs {
  ...
  /// Creates a new [GameServerDeploymentIamMemberGameservicesV1betaArgs].
  ...
  const GameServerDeploymentIamMemberGameservicesV1betaArgs({
    this.condition,
  ...
  factory GameServerDeploymentIamMemberGameservicesV1betaArgs.fromMap(Map<String, dynamic> map) {
    return GameServerDeploymentIamMemberGameservicesV1betaArgs(
