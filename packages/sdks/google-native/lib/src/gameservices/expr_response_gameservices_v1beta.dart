...
class ExprResponseGameservicesV1beta {
  ...
  /// Creates a new [ExprResponseGameservicesV1beta].
  ...
  const ExprResponseGameservicesV1beta({
  ...
  factory ExprResponseGameservicesV1beta.fromMap(Map<String, dynamic> map) {
    return ExprResponseGameservicesV1beta(
