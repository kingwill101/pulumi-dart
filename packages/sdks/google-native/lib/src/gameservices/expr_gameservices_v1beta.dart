...
class ExprGameservicesV1beta {
  ...
  /// Creates a new [ExprGameservicesV1beta].
  ...
  factory ExprGameservicesV1beta.fromMap(Map<String, dynamic> map) {
    return ExprGameservicesV1beta(
