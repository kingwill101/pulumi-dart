    ...
    return <String, dynamic>{
      'action':
          ?pulumi.Input.mapOptionalInputValue<
            RuleActionGameservicesV1beta,
            String
          >(action, (value) => value.wireValue),
      'conditions':
          ?pulumi.Input.mapOptionalInputValue<
            List<ConditionGameservicesV1beta>,
      ...
      'logConfig':
          ?pulumi.Input.mapOptionalInputValue<
            List<LogConfigGameservicesV1beta>,
            List<Map<String, dynamic>>
          >(
            logConfig,
            (value) =>
    ...
    return RuleGameservicesV1beta(
      action: (() {
        ...
        return pulumi.Input.fromValue(
          RuleActionGameservicesV1beta.fromValue(guardedValue as String),
        );
      })(),
      conditions: (() {
