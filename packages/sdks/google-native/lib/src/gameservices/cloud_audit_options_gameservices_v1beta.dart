...
class CloudAuditOptionsGameservicesV1beta {
  ...
  final pulumi.Input<AuthorizationLoggingOptionsGameservicesV1beta>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'logName':
          ?pulumi.Input.mapOptionalInputValue<
            CloudAuditOptionsLogNameGameservicesV1beta,
            String
          >(logName, (value) => value.wireValue),
    };
  }
  ...
  factory CloudAuditOptionsGameservicesV1beta.fromMap(
    ...
    return CloudAuditOptionsGameservicesV1beta(
      authorizationLoggingOptions: (() {
        final guardedValue = map['authorizationLoggingOptions'];
      ...
      logName: (() {
        final guardedValue = map['logName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
