...
class RuleResponseGameservicesV1beta {
  ...
  factory RuleResponseGameservicesV1beta.fromMap(Map<String, dynamic> map) {
    return RuleResponseGameservicesV1beta(
      ...
      conditions: (pulumi.Input.decodeList<ConditionResponseGameservicesV1beta>(map['conditions'], (value) => ConditionResponseGameservicesV1beta.fromMap((value as Map).cast<String, dynamic>()))).input(),
      description: (map['description'] as String).input(),
      in_: ((map['in'] as List).cast<String>()).input(),
      logConfig: (pulumi.Input.decodeList<LogConfigResponseGameservicesV1beta>(map['logConfig'], (value) => LogConfigResponseGameservicesV1beta.fromMap((value as Map).cast<String, dynamic>()))).input(),
      notIn: ((map['notIn'] as List).cast<String>()).input(),
