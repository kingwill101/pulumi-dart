...
class RuleResponseGameservicesV1beta {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'action': action,
      'conditions': pulumi.Input.encodeList<ConditionResponseGameservicesV1beta, Map<String, dynamic>>(conditions, (value) => value.toMap()),
      'description': description,
      'in': in_,
      'logConfig': pulumi.Input.encodeList<LogConfigResponseGameservicesV1beta, Map<String, dynamic>>(logConfig, (value) => value.toMap()),
      'notIn': notIn,
  ...
  factory RuleResponseGameservicesV1beta.fromMap(Map<String, dynamic> map) {
    return RuleResponseGameservicesV1beta(
      ...
      conditions: pulumi.Input.decodeList<ConditionResponseGameservicesV1beta>(map['conditions'], (value) => ConditionResponseGameservicesV1beta.fromMap((value as Map).cast<String, dynamic>())),
      description: map['description'] as String,
      in_: (map['in'] as List).cast<String>(),
      logConfig: pulumi.Input.decodeList<LogConfigResponseGameservicesV1beta>(map['logConfig'], (value) => LogConfigResponseGameservicesV1beta.fromMap((value as Map).cast<String, dynamic>())),
