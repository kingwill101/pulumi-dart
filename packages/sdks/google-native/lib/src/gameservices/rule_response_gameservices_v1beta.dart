    ...
    return <String, dynamic>{
      ...
      'conditions':
          pulumi.Input.mapInputValue<
            List<ConditionResponseGameservicesV1beta>,
      ...
      'logConfig':
          pulumi.Input.mapInputValue<
            List<LogConfigResponseGameservicesV1beta>,
            List<Map<String, dynamic>>
          >(
            logConfig,
            (value) =>
  ...
  factory RuleResponseGameservicesV1beta.fromMap(Map<String, dynamic> map) {
    return RuleResponseGameservicesV1beta(
      ...
      conditions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ConditionResponseGameservicesV1beta>(
          map['conditions']!,
      ...
      logConfig: pulumi.Input.fromValue(
        pulumi.Input.decodeList<LogConfigResponseGameservicesV1beta>(
          map['logConfig']!,
