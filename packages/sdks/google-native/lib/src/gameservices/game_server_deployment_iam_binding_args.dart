...
/// {@template pulumi_gameservices_v1_game_server_deployment_iam_binding_args_doc}
/// The set of arguments for GameServerDeploymentIamBinding.
/// {@endtemplate}
/// {@macro pulumi_gameservices_v1_game_server_deployment_iam_binding_args_doc}
class GameServerDeploymentIamBindingArgs {
  ...
  /// Creates a new [GameServerDeploymentIamBindingArgs].
  ...
  const GameServerDeploymentIamBindingArgs({
    this.condition,
  ...
  factory GameServerDeploymentIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return GameServerDeploymentIamBindingArgs(
