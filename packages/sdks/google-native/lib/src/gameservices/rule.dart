...
class Rule {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'in': ?in_,
      'logConfig': ?logConfig == null ? null : pulumi.Input.encodeList<LogConfig, Map<String, dynamic>>(logConfig!, (value) => value.toMap()),
      'notIn': ?notIn,
  ...
  factory Rule.fromMap(Map<String, dynamic> map) {
    return Rule(
      ...
      logConfig: map['logConfig'] == null ? null : pulumi.Input.decodeList<LogConfig>(map['logConfig'], (value) => LogConfig.fromMap((value as Map).cast<String, dynamic>())),
