...
class MethodSettingsResponse {
  ...
  MethodSettingsResponse({required this.longRunning, required this.selector});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'longRunning':
          pulumi.Input.mapInputValue<LongRunningResponse, Map<String, dynamic>>(
            longRunning,
            (value) => value.toMap(),
          ),
      'selector': selector,
  ...
  factory MethodSettingsResponse.fromMap(Map<String, dynamic> map) {
    return MethodSettingsResponse(
      longRunning: pulumi.Input.fromValue(
        LongRunningResponse.fromMap(
