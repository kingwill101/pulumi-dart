...
class AuthenticationRule {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'requirements': ?requirements == null ? null : pulumi.Input.encodeList<AuthRequirement, Map<String, dynamic>>(requirements!, (value) => value.toMap()),
      'selector': ?selector,
    };
  }
  ...
  factory AuthenticationRule.fromMap(Map<String, dynamic> map) {
    return AuthenticationRule(
      allowWithoutCredential: map['allowWithoutCredential'] == null ? null : map['allowWithoutCredential'] as bool,
      oauth: map['oauth'] == null ? null : OAuthRequirements.fromMap((map['oauth'] as Map).cast<String, dynamic>()),
      requirements: map['requirements'] == null ? null : pulumi.Input.decodeList<AuthRequirement>(map['requirements'], (value) => AuthRequirement.fromMap((value as Map).cast<String, dynamic>())),
