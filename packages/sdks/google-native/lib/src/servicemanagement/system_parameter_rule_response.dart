...
class SystemParameterRuleResponse {
  ...
  factory SystemParameterRuleResponse.fromMap(Map<String, dynamic> map) {
    return SystemParameterRuleResponse(
      parameters: (pulumi.Input.decodeList<SystemParameterResponse>(map['parameters'], (value) => SystemParameterResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
