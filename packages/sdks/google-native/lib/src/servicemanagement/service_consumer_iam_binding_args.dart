...
/// {@template pulumi_servicemanagement_v1_service_consumer_iam_binding_args_doc}
/// The set of arguments for ServiceConsumerIamBinding.
/// {@endtemplate}
/// {@macro pulumi_servicemanagement_v1_service_consumer_iam_binding_args_doc}
class ServiceConsumerIamBindingArgs {
  ...
  /// Creates a new [ServiceConsumerIamBindingArgs].
  ...
  const ServiceConsumerIamBindingArgs({
    this.condition,
  ...
  factory ServiceConsumerIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return ServiceConsumerIamBindingArgs(
