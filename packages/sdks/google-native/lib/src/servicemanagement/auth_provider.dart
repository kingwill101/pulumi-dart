...
class AuthProvider {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'issuer': ?issuer,
      'jwksUri': ?jwksUri,
      'jwtLocations': ?jwtLocations == null ? null : pulumi.Input.encodeList<JwtLocation, Map<String, dynamic>>(jwtLocations!, (value) => value.toMap()),
    };
  }
  ...
  factory AuthProvider.fromMap(Map<String, dynamic> map) {
    return AuthProvider(
      ...
      authorizationUrl: map['authorizationUrl'] == null ? null : map['authorizationUrl'] as String,
      id: map['id'] == null ? null : map['id'] as String,
      issuer: map['issuer'] == null ? null : map['issuer'] as String,
      jwksUri: map['jwksUri'] == null ? null : map['jwksUri'] as String,
      jwtLocations: map['jwtLocations'] == null ? null : pulumi.Input.decodeList<JwtLocation>(map['jwtLocations'], (value) => JwtLocation.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
