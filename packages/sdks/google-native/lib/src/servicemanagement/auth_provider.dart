...
class AuthProvider {
    ...
    return <String, dynamic>{
      ...
      'jwtLocations':
          ...
          >(
            jwtLocations,
            (value) =>
                pulumi.Input.encodeList<JwtLocation, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory AuthProvider.fromMap(Map<String, dynamic> map) {
    return AuthProvider(
      ...
      authorizationUrl: (() {
        final guardedValue = map['authorizationUrl'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      id: (() {
      ...
      jwksUri: (() {
        final guardedValue = map['jwksUri'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      jwtLocations: (() {
        final guardedValue = map['jwtLocations'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<JwtLocation>(
            guardedValue,
            (value) =>
                JwtLocation.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
    );
