...
class AuthenticationResponse {
  ...
  factory AuthenticationResponse.fromMap(Map<String, dynamic> map) {
    return AuthenticationResponse(
      providers: (pulumi.Input.decodeList<AuthProviderResponse>(map['providers'], (value) => AuthProviderResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      rules: (pulumi.Input.decodeList<AuthenticationRuleResponse>(map['rules'], (value) => AuthenticationRuleResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
