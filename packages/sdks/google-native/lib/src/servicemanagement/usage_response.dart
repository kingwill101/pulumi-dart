...
class UsageResponse {
  ...
  factory UsageResponse.fromMap(Map<String, dynamic> map) {
    return UsageResponse(
      producerNotificationChannel: (map['producerNotificationChannel'] as String).input(),
      requirements: ((map['requirements'] as List).cast<String>()).input(),
      rules: (pulumi.Input.decodeList<UsageRuleResponse>(map['rules'], (value) => UsageRuleResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
