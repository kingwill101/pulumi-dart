...
class UsageResponse {
  ...
  final pulumi.Input<List<UsageRuleResponse>> rules;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'rules': pulumi.Input.mapInputValue<List<UsageRuleResponse>, List<Map<String, dynamic>>>(rules, (value) => pulumi.Input.encodeList<UsageRuleResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory UsageResponse.fromMap(Map<String, dynamic> map) {
    return UsageResponse(
      producerNotificationChannel: pulumi.Input.fromValue(map['producerNotificationChannel'] as String),
      requirements: pulumi.Input.fromValue((map['requirements'] as List).cast<String>()),
      rules: pulumi.Input.fromValue(pulumi.Input.decodeList<UsageRuleResponse>(map['rules']!, (value) => UsageRuleResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
