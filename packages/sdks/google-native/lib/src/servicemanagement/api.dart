  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'methods':
          ...
          >(
            methods,
            (value) => pulumi.Input.encodeList<Method, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
      'mixins':
          ...
          >(
            mixins,
            (value) => pulumi.Input.encodeList<Mixin, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
      ...
      'syntax': ?pulumi.Input.mapOptionalInputValue<ApiSyntax, String>(
        syntax,
  ...
  factory Api.fromMap(Map<String, dynamic> map) {
    return Api(
      methods: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<Method>(
            guardedValue,
            (value) => Method.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      mixins: (() {
        final guardedValue = map['mixins'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<Mixin>(
            guardedValue,
      ...
      syntax: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ApiSyntax.fromValue(guardedValue as String),
        );
      })(),
      version: (() {
