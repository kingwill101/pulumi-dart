...
class ClientLibrarySettingsResponse {
  ...
  const ClientLibrarySettingsResponse({
  ...
  factory ClientLibrarySettingsResponse.fromMap(Map<String, dynamic> map) {
    return ClientLibrarySettingsResponse(
      cppSettings: pulumi.Input.fromValue(CppSettingsResponse.fromMap((map['cppSettings']! as Map).cast<String, dynamic>())),
      dotnetSettings: pulumi.Input.fromValue(DotnetSettingsResponse.fromMap((map['dotnetSettings']! as Map).cast<String, dynamic>())),
      goSettings: pulumi.Input.fromValue(GoSettingsResponse.fromMap((map['goSettings']! as Map).cast<String, dynamic>())),
      javaSettings: pulumi.Input.fromValue(JavaSettingsResponse.fromMap((map['javaSettings']! as Map).cast<String, dynamic>())),
      launchStage: pulumi.Input.fromValue(map['launchStage'] as String),
      nodeSettings: pulumi.Input.fromValue(NodeSettingsResponse.fromMap((map['nodeSettings']! as Map).cast<String, dynamic>())),
      phpSettings: pulumi.Input.fromValue(PhpSettingsResponse.fromMap((map['phpSettings']! as Map).cast<String, dynamic>())),
      pythonSettings: pulumi.Input.fromValue(PythonSettingsResponse.fromMap((map['pythonSettings']! as Map).cast<String, dynamic>())),
      restNumericEnums: pulumi.Input.fromValue(map['restNumericEnums'] as bool),
      rubySettings: pulumi.Input.fromValue(RubySettingsResponse.fromMap((map['rubySettings']! as Map).cast<String, dynamic>())),
