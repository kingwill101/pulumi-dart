...
class ClientLibrarySettingsResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'cppSettings':
          pulumi.Input.mapInputValue<CppSettingsResponse, Map<String, dynamic>>(
            cppSettings,
            (value) => value.toMap(),
          ),
      'dotnetSettings':
      ...
      'goSettings':
          pulumi.Input.mapInputValue<GoSettingsResponse, Map<String, dynamic>>(
            goSettings,
            (value) => value.toMap(),
          ),
      'javaSettings':
      ...
      'phpSettings':
          pulumi.Input.mapInputValue<PhpSettingsResponse, Map<String, dynamic>>(
            phpSettings,
            (value) => value.toMap(),
          ),
      'pythonSettings':
  ...
  factory ClientLibrarySettingsResponse.fromMap(Map<String, dynamic> map) {
    return ClientLibrarySettingsResponse(
      cppSettings: pulumi.Input.fromValue(
        CppSettingsResponse.fromMap(
          (map['cppSettings']! as Map).cast<String, dynamic>(),
        ),
      ),
      dotnetSettings: pulumi.Input.fromValue(
        DotnetSettingsResponse.fromMap(
          (map['dotnetSettings']! as Map).cast<String, dynamic>(),
        ),
      ),
      goSettings: pulumi.Input.fromValue(
        GoSettingsResponse.fromMap(
          (map['goSettings']! as Map).cast<String, dynamic>(),
        ),
      ),
      javaSettings: pulumi.Input.fromValue(
        JavaSettingsResponse.fromMap(
      ...
      nodeSettings: pulumi.Input.fromValue(
        NodeSettingsResponse.fromMap(
          (map['nodeSettings']! as Map).cast<String, dynamic>(),
        ),
      ),
      phpSettings: pulumi.Input.fromValue(
        PhpSettingsResponse.fromMap(
          (map['phpSettings']! as Map).cast<String, dynamic>(),
        ),
      ),
      pythonSettings: pulumi.Input.fromValue(
        PythonSettingsResponse.fromMap(
          (map['pythonSettings']! as Map).cast<String, dynamic>(),
        ),
      ),
      restNumericEnums: pulumi.Input.fromValue(map['restNumericEnums'] as bool),
      rubySettings: pulumi.Input.fromValue(
        RubySettingsResponse.fromMap(
