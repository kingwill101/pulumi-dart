...
class UsageRule {
  ...
  factory UsageRule.fromMap(Map<String, dynamic> map) {
    return UsageRule(
      allowUnregisteredCalls: (() { final guardedValue = map['allowUnregisteredCalls']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      skipServiceControl: (() { final guardedValue = map['skipServiceControl']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
    );
  }
}
