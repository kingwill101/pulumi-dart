...
class MonitoredResourceDescriptor {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'labels': pulumi.Input.encodeList<LabelDescriptor, Map<String, dynamic>>(labels, (value) => value.toMap()),
  ...
  factory MonitoredResourceDescriptor.fromMap(Map<String, dynamic> map) {
    return MonitoredResourceDescriptor(
      ...
      labels: pulumi.Input.decodeList<LabelDescriptor>(map['labels'], (value) => LabelDescriptor.fromMap((value as Map).cast<String, dynamic>())),
      launchStage: map['launchStage'] == null ? null : MonitoredResourceDescriptorLaunchStage.fromValue(map['launchStage'] as String),
