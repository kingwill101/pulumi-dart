...
class Http {
  ...
  factory Http.fromMap(Map<String, dynamic> map) {
    return Http(
      fullyDecodeReservedExpansion: (() { final guardedValue = map['fullyDecodeReservedExpansion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      rules: (() { final guardedValue = map['rules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<HttpRule>(guardedValue, (value) => HttpRule.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
