...
class HttpResponse {
  ...
  final pulumi.Input<List<HttpRuleResponse>> rules;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'rules': pulumi.Input.mapInputValue<List<HttpRuleResponse>, List<Map<String, dynamic>>>(rules, (value) => pulumi.Input.encodeList<HttpRuleResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory HttpResponse.fromMap(Map<String, dynamic> map) {
    return HttpResponse(
      fullyDecodeReservedExpansion: pulumi.Input.fromValue(map['fullyDecodeReservedExpansion'] as bool),
      rules: pulumi.Input.fromValue(pulumi.Input.decodeList<HttpRuleResponse>(map['rules']!, (value) => HttpRuleResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
