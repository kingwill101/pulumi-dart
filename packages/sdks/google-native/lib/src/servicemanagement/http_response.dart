...
class HttpResponse {
  ...
  factory HttpResponse.fromMap(Map<String, dynamic> map) {
    return HttpResponse(
      fullyDecodeReservedExpansion: (map['fullyDecodeReservedExpansion'] as bool).input(),
      rules: (pulumi.Input.decodeList<HttpRuleResponse>(map['rules'], (value) => HttpRuleResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
