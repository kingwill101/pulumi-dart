...
class MetricDescriptorResponse {
  ...
  factory MetricDescriptorResponse.fromMap(Map<String, dynamic> map) {
    return MetricDescriptorResponse(
      ...
      labels: (pulumi.Input.decodeList<LabelDescriptorResponse>(map['labels'], (value) => LabelDescriptorResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      launchStage: (map['launchStage'] as String).input(),
      metadata: (MetricDescriptorMetadataResponse.fromMap((map['metadata'] as Map).cast<String, dynamic>())).input(),
      metricKind: (map['metricKind'] as String).input(),
      monitoredResourceTypes: ((map['monitoredResourceTypes'] as List).cast<String>()).input(),
