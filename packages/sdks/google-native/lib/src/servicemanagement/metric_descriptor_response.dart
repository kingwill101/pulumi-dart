...
class MetricDescriptorResponse {
  ...
  final pulumi.Input<MetricDescriptorMetadataResponse> metadata;
  ...
  /// Creates a new [MetricDescriptorResponse].
  ...
  const MetricDescriptorResponse({
    ...
    required this.monitoredResourceTypes,
    required this.name,
    required this.type,
    required this.unit,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'labels': pulumi.Input.mapInputValue<List<LabelDescriptorResponse>, List<Map<String, dynamic>>>(labels, (value) => pulumi.Input.encodeList<LabelDescriptorResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'launchStage': launchStage,
      'metadata': pulumi.Input.mapInputValue<MetricDescriptorMetadataResponse, Map<String, dynamic>>(metadata, (value) => value.toMap()),
  ...
  factory MetricDescriptorResponse.fromMap(Map<String, dynamic> map) {
    return MetricDescriptorResponse(
      description: pulumi.Input.fromValue(map['description'] as String),
      displayName: pulumi.Input.fromValue(map['displayName'] as String),
      labels: pulumi.Input.fromValue(pulumi.Input.decodeList<LabelDescriptorResponse>(map['labels']!, (value) => LabelDescriptorResponse.fromMap((value as Map).cast<String, dynamic>()))),
      launchStage: pulumi.Input.fromValue(map['launchStage'] as String),
      metadata: pulumi.Input.fromValue(MetricDescriptorMetadataResponse.fromMap((map['metadata']! as Map).cast<String, dynamic>())),
      metricKind: pulumi.Input.fromValue(map['metricKind'] as String),
      monitoredResourceTypes: pulumi.Input.fromValue((map['monitoredResourceTypes'] as List).cast<String>()),
