...
class DocumentationRule {
  ...
  factory DocumentationRule.fromMap(Map<String, dynamic> map) {
    return DocumentationRule(
      deprecationDescription: (() { final guardedValue = map['deprecationDescription']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      description: (() { final guardedValue = map['description']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      disableReplacementWords: (() { final guardedValue = map['disableReplacementWords']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
