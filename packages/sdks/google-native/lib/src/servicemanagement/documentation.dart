...
class Documentation {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'overview': ?overview,
      'pages': ?pulumi.Input.mapOptionalInputValue<List<Page>, List<Map<String, dynamic>>>(pages, (value) => pulumi.Input.encodeList<Page, Map<String, dynamic>>(value, (value) => value.toMap())),
      'rules': ?pulumi.Input.mapOptionalInputValue<List<DocumentationRule>, List<Map<String, dynamic>>>(rules, (value) => pulumi.Input.encodeList<DocumentationRule, Map<String, dynamic>>(value, (value) => value.toMap())),
      'sectionOverrides': ?pulumi.Input.mapOptionalInputValue<List<Page>, List<Map<String, dynamic>>>(sectionOverrides, (value) => pulumi.Input.encodeList<Page, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory Documentation.fromMap(Map<String, dynamic> map) {
    return Documentation(
      documentationRootUrl: (() { final guardedValue = map['documentationRootUrl']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      pages: (() { final guardedValue = map['pages']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<Page>(guardedValue, (value) => Page.fromMap((value as Map).cast<String, dynamic>()))); })(),
      rules: (() { final guardedValue = map['rules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DocumentationRule>(guardedValue, (value) => DocumentationRule.fromMap((value as Map).cast<String, dynamic>()))); })(),
      sectionOverrides: (() { final guardedValue = map['sectionOverrides']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<Page>(guardedValue, (value) => Page.fromMap((value as Map).cast<String, dynamic>()))); })(),
      serviceRootUrl: (() { final guardedValue = map['serviceRootUrl']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
