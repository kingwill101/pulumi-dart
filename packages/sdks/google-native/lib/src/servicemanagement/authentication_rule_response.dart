...
class AuthenticationRuleResponse {
  ...
  const AuthenticationRuleResponse({
  ...
  factory AuthenticationRuleResponse.fromMap(Map<String, dynamic> map) {
    return AuthenticationRuleResponse(
      allowWithoutCredential: pulumi.Input.fromValue(map['allowWithoutCredential'] as bool),
      oauth: pulumi.Input.fromValue(OAuthRequirementsResponse.fromMap((map['oauth']! as Map).cast<String, dynamic>())),
      requirements: pulumi.Input.fromValue(pulumi.Input.decodeList<AuthRequirementResponse>(map['requirements']!, (value) => AuthRequirementResponse.fromMap((value as Map).cast<String, dynamic>()))),
