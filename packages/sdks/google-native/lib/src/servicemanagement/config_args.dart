...
class ConfigArgs {
  ...
  ConfigArgs({
    pulumi.Output<List<Api>>? apis,
    pulumi.Output<Authentication>? authentication,
    pulumi.Output<Backend>? backend,
    pulumi.Output<Billing>? billing,
    pulumi.Output<int>? configVersion,
    pulumi.Output<Context>? context,
    pulumi.Output<Control>? control,
    pulumi.Output<CustomError>? customError,
    pulumi.Output<Documentation>? documentation,
    pulumi.Output<List<Endpoint>>? endpoints,
    pulumi.Output<List<Enum>>? enums,
    pulumi.Output<Http>? http,
    pulumi.Output<String>? id,
    pulumi.Output<Logging>? logging,
    pulumi.Output<List<LogDescriptor>>? logs,
    pulumi.Output<List<MetricDescriptor>>? metrics,
    pulumi.Output<List<MonitoredResourceDescriptor>>? monitoredResources,
    pulumi.Output<Monitoring>? monitoring,
    pulumi.Output<String>? name,
    pulumi.Output<String>? producerProjectId,
    pulumi.Output<Publishing>? publishing,
    pulumi.Output<Quota>? quota,
    required pulumi.Output<String> serviceName,
    pulumi.Output<SystemParameters>? systemParameters,
    pulumi.Output<List<Type>>? systemTypes,
    pulumi.Output<String>? title,
    pulumi.Output<List<Type>>? types,
    pulumi.Output<Usage>? usage,
  }) :
  ...
  factory ConfigArgs.fromMap(Map<String, dynamic> map) {
    return ConfigArgs(
      apis: map['apis'] == null ? null : pulumi.Output.create<List<Api>>(pulumi.Input.decodeList<Api>(map['apis'], (value) => Api.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      backend: map['backend'] == null ? null : pulumi.Output.create<Backend>(Backend.fromMap((map['backend'] as Map).cast<String, dynamic>())),
      billing: map['billing'] == null ? null : pulumi.Output.create<Billing>(Billing.fromMap((map['billing'] as Map).cast<String, dynamic>())),
      configVersion: map['configVersion'] == null ? null : pulumi.Output.create<int>(map['configVersion'] as int),
      context: map['context'] == null ? null : pulumi.Output.create<Context>(Context.fromMap((map['context'] as Map).cast<String, dynamic>())),
      control: map['control'] == null ? null : pulumi.Output.create<Control>(Control.fromMap((map['control'] as Map).cast<String, dynamic>())),
      customError: map['customError'] == null ? null : pulumi.Output.create<CustomError>(CustomError.fromMap((map['customError'] as Map).cast<String, dynamic>())),
      ...
      endpoints: map['endpoints'] == null ? null : pulumi.Output.create<List<Endpoint>>(pulumi.Input.decodeList<Endpoint>(map['endpoints'], (value) => Endpoint.fromMap((value as Map).cast<String, dynamic>()))),
      enums: map['enums'] == null ? null : pulumi.Output.create<List<Enum>>(pulumi.Input.decodeList<Enum>(map['enums'], (value) => Enum.fromMap((value as Map).cast<String, dynamic>()))),
      http: map['http'] == null ? null : pulumi.Output.create<Http>(Http.fromMap((map['http'] as Map).cast<String, dynamic>())),
      id: map['id'] == null ? null : pulumi.Output.create<String>(map['id'] as String),
      logging: map['logging'] == null ? null : pulumi.Output.create<Logging>(Logging.fromMap((map['logging'] as Map).cast<String, dynamic>())),
      logs: map['logs'] == null ? null : pulumi.Output.create<List<LogDescriptor>>(pulumi.Input.decodeList<LogDescriptor>(map['logs'], (value) => LogDescriptor.fromMap((value as Map).cast<String, dynamic>()))),
      metrics: map['metrics'] == null ? null : pulumi.Output.create<List<MetricDescriptor>>(pulumi.Input.decodeList<MetricDescriptor>(map['metrics'], (value) => MetricDescriptor.fromMap((value as Map).cast<String, dynamic>()))),
      monitoredResources: map['monitoredResources'] == null ? null : pulumi.Output.create<List<MonitoredResourceDescriptor>>(pulumi.Input.decodeList<MonitoredResourceDescriptor>(map['monitoredResources'], (value) => MonitoredResourceDescriptor.fromMap((value as Map).cast<String, dynamic>()))),
      monitoring: map['monitoring'] == null ? null : pulumi.Output.create<Monitoring>(Monitoring.fromMap((map['monitoring'] as Map).cast<String, dynamic>())),
      ...
      publishing: map['publishing'] == null ? null : pulumi.Output.create<Publishing>(Publishing.fromMap((map['publishing'] as Map).cast<String, dynamic>())),
      quota: map['quota'] == null ? null : pulumi.Output.create<Quota>(Quota.fromMap((map['quota'] as Map).cast<String, dynamic>())),
      serviceName: pulumi.Output.create<String>(map['serviceName'] as String),
      systemParameters: map['systemParameters'] == null ? null : pulumi.Output.create<SystemParameters>(SystemParameters.fromMap((map['systemParameters'] as Map).cast<String, dynamic>())),
      systemTypes: map['systemTypes'] == null ? null : pulumi.Output.create<List<Type>>(pulumi.Input.decodeList<Type>(map['systemTypes'], (value) => Type.fromMap((value as Map).cast<String, dynamic>()))),
      title: map['title'] == null ? null : pulumi.Output.create<String>(map['title'] as String),
      types: map['types'] == null ? null : pulumi.Output.create<List<Type>>(pulumi.Input.decodeList<Type>(map['types'], (value) => Type.fromMap((value as Map).cast<String, dynamic>()))),
      usage: map['usage'] == null ? null : pulumi.Output.create<Usage>(Usage.fromMap((map['usage'] as Map).cast<String, dynamic>())),
    );
  }
}
