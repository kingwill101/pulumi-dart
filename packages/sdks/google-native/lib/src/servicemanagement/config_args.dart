...
class ConfigArgs {
  ...
  factory ConfigArgs.fromMap(Map<String, dynamic> map) {
    return ConfigArgs(
      apis: map['apis'] == null ? null : (pulumi.Input.decodeList<Api>(map['apis']!, (value) => Api.fromMap((value as Map).cast<String, dynamic>()))).input(),
      authentication: map['authentication'] == null ? null : (Authentication.fromMap((map['authentication']! as Map).cast<String, dynamic>())).input(),
      backend: map['backend'] == null ? null : (Backend.fromMap((map['backend']! as Map).cast<String, dynamic>())).input(),
      billing: map['billing'] == null ? null : (Billing.fromMap((map['billing']! as Map).cast<String, dynamic>())).input(),
      configVersion: map['configVersion'] == null ? null : (map['configVersion']! as int).input(),
      context: map['context'] == null ? null : (Context.fromMap((map['context']! as Map).cast<String, dynamic>())).input(),
      control: map['control'] == null ? null : (Control.fromMap((map['control']! as Map).cast<String, dynamic>())).input(),
      customError: map['customError'] == null ? null : (CustomError.fromMap((map['customError']! as Map).cast<String, dynamic>())).input(),
      ...
      enums: map['enums'] == null ? null : (pulumi.Input.decodeList<Enum>(map['enums']!, (value) => Enum.fromMap((value as Map).cast<String, dynamic>()))).input(),
      http: map['http'] == null ? null : (Http.fromMap((map['http']! as Map).cast<String, dynamic>())).input(),
      id: map['id'] == null ? null : (map['id']! as String).input(),
      logging: map['logging'] == null ? null : (Logging.fromMap((map['logging']! as Map).cast<String, dynamic>())).input(),
      logs: map['logs'] == null ? null : (pulumi.Input.decodeList<LogDescriptor>(map['logs']!, (value) => LogDescriptor.fromMap((value as Map).cast<String, dynamic>()))).input(),
      metrics: map['metrics'] == null ? null : (pulumi.Input.decodeList<MetricDescriptor>(map['metrics']!, (value) => MetricDescriptor.fromMap((value as Map).cast<String, dynamic>()))).input(),
      monitoredResources: map['monitoredResources'] == null ? null : (pulumi.Input.decodeList<MonitoredResourceDescriptor>(map['monitoredResources']!, (value) => MonitoredResourceDescriptor.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      publishing: map['publishing'] == null ? null : (Publishing.fromMap((map['publishing']! as Map).cast<String, dynamic>())).input(),
      quota: map['quota'] == null ? null : (Quota.fromMap((map['quota']! as Map).cast<String, dynamic>())).input(),
      serviceName: (map['serviceName'] as String).input(),
      systemParameters: map['systemParameters'] == null ? null : (SystemParameters.fromMap((map['systemParameters']! as Map).cast<String, dynamic>())).input(),
      systemTypes: map['systemTypes'] == null ? null : (pulumi.Input.decodeList<Type>(map['systemTypes']!, (value) => Type.fromMap((value as Map).cast<String, dynamic>()))).input(),
      title: map['title'] == null ? null : (map['title']! as String).input(),
      types: map['types'] == null ? null : (pulumi.Input.decodeList<Type>(map['types']!, (value) => Type.fromMap((value as Map).cast<String, dynamic>()))).input(),
      usage: map['usage'] == null ? null : (Usage.fromMap((map['usage']! as Map).cast<String, dynamic>())).input(),
    );
  }
}
