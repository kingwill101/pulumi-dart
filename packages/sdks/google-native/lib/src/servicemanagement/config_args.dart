...
class ConfigArgs {
  ...
  factory ConfigArgs.fromMap(Map<String, dynamic> map) {
    return ConfigArgs(
      apis: (() { final guardedValue = map['apis']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<Api>(guardedValue, (value) => Api.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      backend: (() { final guardedValue = map['backend']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Backend.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      billing: (() { final guardedValue = map['billing']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Billing.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      configVersion: (() { final guardedValue = map['configVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      context: (() { final guardedValue = map['context']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Context.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      control: (() { final guardedValue = map['control']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Control.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      customError: (() { final guardedValue = map['customError']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CustomError.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      documentation: (() { final guardedValue = map['documentation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Documentation.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      enums: (() { final guardedValue = map['enums']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<Enum>(guardedValue, (value) => Enum.fromMap((value as Map).cast<String, dynamic>()))); })(),
      http: (() { final guardedValue = map['http']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Http.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      logs: (() { final guardedValue = map['logs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<LogDescriptor>(guardedValue, (value) => LogDescriptor.fromMap((value as Map).cast<String, dynamic>()))); })(),
      metrics: (() { final guardedValue = map['metrics']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<MetricDescriptor>(guardedValue, (value) => MetricDescriptor.fromMap((value as Map).cast<String, dynamic>()))); })(),
      monitoredResources: (() { final guardedValue = map['monitoredResources']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<MonitoredResourceDescriptor>(guardedValue, (value) => MonitoredResourceDescriptor.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      producerProjectId: (() { final guardedValue = map['producerProjectId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      publishing: (() { final guardedValue = map['publishing']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Publishing.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      quota: (() { final guardedValue = map['quota']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Quota.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      serviceName: pulumi.Input.fromValue(map['serviceName'] as String),
      systemParameters: (() { final guardedValue = map['systemParameters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SystemParameters.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      systemTypes: (() { final guardedValue = map['systemTypes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<Type>(guardedValue, (value) => Type.fromMap((value as Map).cast<String, dynamic>()))); })(),
      title: (() { final guardedValue = map['title']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      types: (() { final guardedValue = map['types']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<Type>(guardedValue, (value) => Type.fromMap((value as Map).cast<String, dynamic>()))); })(),
      usage: (() { final guardedValue = map['usage']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Usage.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
