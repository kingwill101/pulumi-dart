  ...
  factory DotnetSettings.fromMap(Map<String, dynamic> map) {
    return DotnetSettings(
      ...
      forcedNamespaceAliases: (() {
        final guardedValue = map['forcedNamespaceAliases'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      handwrittenSignatures: (() {
        final guardedValue = map['handwrittenSignatures'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      ignoredResources: (() {
        final guardedValue = map['ignoredResources'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      renamedResources: (() {
        final guardedValue = map['renamedResources'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      renamedServices: (() {
        final guardedValue = map['renamedServices'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as Map).cast<String, String>(),
        );
