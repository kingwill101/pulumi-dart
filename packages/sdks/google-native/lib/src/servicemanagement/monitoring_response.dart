...
class MonitoringResponse {
  ...
  factory MonitoringResponse.fromMap(Map<String, dynamic> map) {
    return MonitoringResponse(
      consumerDestinations: (pulumi.Input.decodeList<MonitoringDestinationResponse>(map['consumerDestinations'], (value) => MonitoringDestinationResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      producerDestinations: (pulumi.Input.decodeList<MonitoringDestinationResponse>(map['producerDestinations'], (value) => MonitoringDestinationResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
