...
class MetricRuleResponse {
  ...
  MetricRuleResponse({required this.metricCosts, required this.selector});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'metricCosts': metricCosts, 'selector': selector};
  }

  factory MetricRuleResponse.fromMap(Map<String, dynamic> map) {
    return MetricRuleResponse(
      metricCosts: pulumi.Input.fromValue(
