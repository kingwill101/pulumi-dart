  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'enumvalue':
          ...
          >(
            enumvalue,
            (value) => pulumi.Input.encodeList<EnumValue, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
      ...
      'syntax': ?pulumi.Input.mapOptionalInputValue<EnumSyntax, String>(
        syntax,
  ...
  factory Enum.fromMap(Map<String, dynamic> map) {
    return Enum(
      ...
      syntax: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          EnumSyntax.fromValue(guardedValue as String),
        );
      })(),
    );
  }
