...
class AuthProviderResponse {
  ...
  factory AuthProviderResponse.fromMap(Map<String, dynamic> map) {
    return AuthProviderResponse(
      ...
      jwtLocations: pulumi.Input.fromValue(pulumi.Input.decodeList<JwtLocationResponse>(map['jwtLocations']!, (value) => JwtLocationResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
