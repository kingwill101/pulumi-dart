...
class AuthProviderResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'issuer': issuer,
      'jwksUri': jwksUri,
      'jwtLocations': pulumi.Input.mapInputValue<List<JwtLocationResponse>, List<Map<String, dynamic>>>(jwtLocations, (value) => pulumi.Input.encodeList<JwtLocationResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory AuthProviderResponse.fromMap(Map<String, dynamic> map) {
    return AuthProviderResponse(
      ...
      authorizationUrl: (map['authorizationUrl'] as String).input(),
      issuer: (map['issuer'] as String).input(),
      jwksUri: (map['jwksUri'] as String).input(),
      jwtLocations: (pulumi.Input.decodeList<JwtLocationResponse>(map['jwtLocations'], (value) => JwtLocationResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
