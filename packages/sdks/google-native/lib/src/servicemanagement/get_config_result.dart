...
class GetConfigResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'apis': pulumi.Input.encodeList<ApiResponse, Map<String, dynamic>>(
        apis,
        (value) => value.toMap(),
      ),
      ...
      'endpoints':
          pulumi.Input.encodeList<EndpointResponse, Map<String, dynamic>>(
            endpoints,
            (value) => value.toMap(),
          ),
      'enums': pulumi.Input.encodeList<EnumResponse, Map<String, dynamic>>(
        enums,
        (value) => value.toMap(),
      ),
      'http': http.toMap(),
      ...
      'systemTypes':
          pulumi.Input.encodeList<TypeResponse, Map<String, dynamic>>(
            systemTypes,
            (value) => value.toMap(),
          ),
      'title': title,
      'types': pulumi.Input.encodeList<TypeResponse, Map<String, dynamic>>(
        types,
        (value) => value.toMap(),
      ),
      'usage': usage.toMap(),
  ...
  factory GetConfigResult.fromMap(Map<String, dynamic> map) {
    return GetConfigResult(
      ...
      documentation: DocumentationResponse.fromMap(
        (map['documentation']! as Map).cast<String, dynamic>(),
      ),
      endpoints: pulumi.Input.decodeList<EndpointResponse>(
        map['endpoints']!,
        (value) =>
      ...
      enums: pulumi.Input.decodeList<EnumResponse>(
        map['enums']!,
        (value) => EnumResponse.fromMap((value as Map).cast<String, dynamic>()),
      ),
      ...
      metrics: pulumi.Input.decodeList<MetricDescriptorResponse>(
        map['metrics']!,
        (value) => MetricDescriptorResponse.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      monitoredResources:
      ...
      systemTypes: pulumi.Input.decodeList<TypeResponse>(
        map['systemTypes']!,
        (value) => TypeResponse.fromMap((value as Map).cast<String, dynamic>()),
      ),
      title: map['title'] as String,
      types: pulumi.Input.decodeList<TypeResponse>(
        map['types']!,
        (value) => TypeResponse.fromMap((value as Map).cast<String, dynamic>()),
      ),
      usage: UsageResponse.fromMap(
        (map['usage']! as Map).cast<String, dynamic>(),
      ),
    );
  }
}
