...
class Type {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'syntax': ?pulumi.Input.mapOptionalInputValue<TypeSyntax, String>(
        syntax,
  ...
  factory Type.fromMap(Map<String, dynamic> map) {
    return Type(
      ...
      sourceContext: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SourceContext.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      syntax: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TypeSyntax.fromValue(guardedValue as String),
        );
      })(),
    );
  }
