...
class DotnetSettingsResponse {
  ...
  factory DotnetSettingsResponse.fromMap(Map<String, dynamic> map) {
    return DotnetSettingsResponse(
      ...
      forcedNamespaceAliases: pulumi.Input.fromValue((map['forcedNamespaceAliases'] as List).cast<String>()),
      handwrittenSignatures: pulumi.Input.fromValue((map['handwrittenSignatures'] as List).cast<String>()),
      ignoredResources: pulumi.Input.fromValue((map['ignoredResources'] as List).cast<String>()),
      renamedResources: pulumi.Input.fromValue((map['renamedResources'] as Map).cast<String, String>()),
      renamedServices: pulumi.Input.fromValue((map['renamedServices'] as Map).cast<String, String>()),
    );
  }
}
