...
class CustomError {
  ...
  factory CustomError.fromMap(Map<String, dynamic> map) {
    return CustomError(
      rules: (() { final guardedValue = map['rules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<CustomErrorRule>(guardedValue, (value) => CustomErrorRule.fromMap((value as Map).cast<String, dynamic>()))); })(),
