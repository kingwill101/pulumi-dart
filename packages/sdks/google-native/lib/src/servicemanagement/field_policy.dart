...
class FieldPolicy {
  ...
  factory FieldPolicy.fromMap(Map<String, dynamic> map) {
    return FieldPolicy(
      resourcePermission: (() { final guardedValue = map['resourcePermission']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
