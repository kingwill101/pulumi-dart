...
class SystemParameters {
  ...
  factory SystemParameters.fromMap(Map<String, dynamic> map) {
    return SystemParameters(
      rules: (() { final guardedValue = map['rules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SystemParameterRule>(guardedValue, (value) => SystemParameterRule.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
