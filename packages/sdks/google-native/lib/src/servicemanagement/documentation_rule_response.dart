...
class DocumentationRuleResponse {
  ...
  const DocumentationRuleResponse({
  ...
  factory DocumentationRuleResponse.fromMap(Map<String, dynamic> map) {
    return DocumentationRuleResponse(
      deprecationDescription: pulumi.Input.fromValue(map['deprecationDescription'] as String),
      description: pulumi.Input.fromValue(map['description'] as String),
      disableReplacementWords: pulumi.Input.fromValue(map['disableReplacementWords'] as String),
