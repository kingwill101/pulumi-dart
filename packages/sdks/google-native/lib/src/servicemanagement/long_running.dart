...
class LongRunning {
  ...
  factory LongRunning.fromMap(Map<String, dynamic> map) {
    return LongRunning(
      initialPollDelay: (() {
        final guardedValue = map['initialPollDelay'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      maxPollDelay: (() {
        final guardedValue = map['maxPollDelay'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      pollDelayMultiplier: (() {
        final guardedValue = map['pollDelayMultiplier'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as double);
      })(),
      totalPollTimeout: (() {
        final guardedValue = map['totalPollTimeout'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
