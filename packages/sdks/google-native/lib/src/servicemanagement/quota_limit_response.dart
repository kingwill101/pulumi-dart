...
class QuotaLimitResponse {
  ...
  final pulumi.Input<String> defaultLimit;
  ...
  factory QuotaLimitResponse.fromMap(Map<String, dynamic> map) {
    return QuotaLimitResponse(
      defaultLimit: pulumi.Input.fromValue(map['defaultLimit'] as String),
      description: pulumi.Input.fromValue(map['description'] as String),
      displayName: pulumi.Input.fromValue(map['displayName'] as String),
      duration: pulumi.Input.fromValue(map['duration'] as String),
      freeTier: pulumi.Input.fromValue(map['freeTier'] as String),
      maxLimit: pulumi.Input.fromValue(map['maxLimit'] as String),
