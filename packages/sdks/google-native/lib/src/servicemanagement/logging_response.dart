...
class LoggingResponse {
  ...
  factory LoggingResponse.fromMap(Map<String, dynamic> map) {
    return LoggingResponse(
      consumerDestinations: pulumi.Input.fromValue(pulumi.Input.decodeList<LoggingDestinationResponse>(map['consumerDestinations']!, (value) => LoggingDestinationResponse.fromMap((value as Map).cast<String, dynamic>()))),
      producerDestinations: pulumi.Input.fromValue(pulumi.Input.decodeList<LoggingDestinationResponse>(map['producerDestinations']!, (value) => LoggingDestinationResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
