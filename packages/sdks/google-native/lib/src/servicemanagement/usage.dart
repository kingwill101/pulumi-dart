...
class Usage {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'rules': ?rules == null ? null : pulumi.Input.encodeList<UsageRule, Map<String, dynamic>>(rules!, (value) => value.toMap()),
    };
  }

  factory Usage.fromMap(Map<String, dynamic> map) {
    return Usage(
      producerNotificationChannel: map['producerNotificationChannel'] == null ? null : map['producerNotificationChannel'] as String,
      requirements: map['requirements'] == null ? null : (map['requirements'] as List).cast<String>(),
      rules: map['rules'] == null ? null : pulumi.Input.decodeList<UsageRule>(map['rules'], (value) => UsageRule.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
