...
/// {@template pulumi_servicemanagement_v1_service_consumer_iam_member_args_doc}
/// The set of arguments for ServiceConsumerIamMember.
/// {@endtemplate}
/// {@macro pulumi_servicemanagement_v1_service_consumer_iam_member_args_doc}
class ServiceConsumerIamMemberArgs {
  ...
  /// Creates a new [ServiceConsumerIamMemberArgs].
  ...
  const ServiceConsumerIamMemberArgs({
    this.condition,
