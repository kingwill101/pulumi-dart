...
class QuotaLimit {
  ...
  factory QuotaLimit.fromMap(Map<String, dynamic> map) {
    return QuotaLimit(
      defaultLimit: (() { final guardedValue = map['defaultLimit']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      freeTier: (() { final guardedValue = map['freeTier']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      maxLimit: (() { final guardedValue = map['maxLimit']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
