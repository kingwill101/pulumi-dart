...
class BackendRule {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'pathTranslation': ?pulumi.Input.mapOptionalInputValue<BackendRulePathTranslation, String>(pathTranslation, (value) => value.wireValue),
      'protocol': ?protocol,
      'selector': ?selector,
    };
  }
  ...
  factory BackendRule.fromMap(Map<String, dynamic> map) {
    return BackendRule(
      ...
      deadline: (() { final guardedValue = map['deadline']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as double); })(),
      ...
      jwtAudience: (() { final guardedValue = map['jwtAudience']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      minDeadline: (() { final guardedValue = map['minDeadline']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as double); })(),
      operationDeadline: (() { final guardedValue = map['operationDeadline']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as double); })(),
      overridesByRequestProtocol: (() { final guardedValue = map['overridesByRequestProtocol']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      pathTranslation: (() { final guardedValue = map['pathTranslation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BackendRulePathTranslation.fromValue(guardedValue as String)); })(),
