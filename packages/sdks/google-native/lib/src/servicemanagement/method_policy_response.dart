...
class MethodPolicyResponse {
  ...
  MethodPolicyResponse({required this.requestPolicies, required this.selector});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'requestPolicies':
          pulumi.Input.mapInputValue<
            List<FieldPolicyResponse>,
  ...
  factory MethodPolicyResponse.fromMap(Map<String, dynamic> map) {
    return MethodPolicyResponse(
      requestPolicies: pulumi.Input.fromValue(
        pulumi.Input.decodeList<FieldPolicyResponse>(
          map['requestPolicies']!,
