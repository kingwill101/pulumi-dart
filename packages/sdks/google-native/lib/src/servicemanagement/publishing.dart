...
class Publishing {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'organization': ?pulumi.Input.mapOptionalInputValue<PublishingOrganization, String>(organization, (value) => value.wireValue),
  ...
  factory Publishing.fromMap(Map<String, dynamic> map) {
    return Publishing(
      apiShortName: (() { final guardedValue = map['apiShortName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      codeownerGithubTeams: (() { final guardedValue = map['codeownerGithubTeams']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      docTagPrefix: (() { final guardedValue = map['docTagPrefix']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      githubLabel: (() { final guardedValue = map['githubLabel']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      librarySettings: (() { final guardedValue = map['librarySettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ClientLibrarySettings>(guardedValue, (value) => ClientLibrarySettings.fromMap((value as Map).cast<String, dynamic>()))); })(),
      methodSettings: (() { final guardedValue = map['methodSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<MethodSettings>(guardedValue, (value) => MethodSettings.fromMap((value as Map).cast<String, dynamic>()))); })(),
      newIssueUri: (() { final guardedValue = map['newIssueUri']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      organization: (() { final guardedValue = map['organization']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PublishingOrganization.fromValue(guardedValue as String)); })(),
      protoReferenceDocumentationUri: (() { final guardedValue = map['protoReferenceDocumentationUri']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
