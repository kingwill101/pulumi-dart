...
class NetworkConfigFileV1beta1 {
  ...
  final NetworkConfigConnectModeFileV1beta1? connectMode;
  /// Internet protocol versions for which the instance has IP addresses assigned. For this version, only MODE_IPV4 is supported.
  final List<NetworkConfigModesItemFileV1beta1>? modes;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'modes': ?modes == null ? null : pulumi.Input.encodeList<NetworkConfigModesItemFileV1beta1, String>(modes!, (value) => value.value),
      'network': ?network,
  ...
  factory NetworkConfigFileV1beta1.fromMap(Map<String, dynamic> map) {
    return NetworkConfigFileV1beta1(
      connectMode: map['connectMode'] == null ? null : NetworkConfigConnectModeFileV1beta1.fromValue(map['connectMode'] as String),
      modes: map['modes'] == null ? null : pulumi.Input.decodeList<NetworkConfigModesItemFileV1beta1>(map['modes'], (value) => NetworkConfigModesItemFileV1beta1.fromValue(value as String)),
