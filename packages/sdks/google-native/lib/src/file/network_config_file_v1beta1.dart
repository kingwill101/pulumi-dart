    ...
    return <String, dynamic>{
      'connectMode':
          ?pulumi.Input.mapOptionalInputValue<
            NetworkConfigConnectModeFileV1beta1,
            String
          >(connectMode, (value) => value.wireValue),
      'modes':
          ?pulumi.Input.mapOptionalInputValue<
            List<NetworkConfigModesItemFileV1beta1>,
            List<String>
          >(
            modes,
            (value) =>
                pulumi.Input.encodeList<
                  NetworkConfigModesItemFileV1beta1,
                  String
    ...
    return NetworkConfigFileV1beta1(
      connectMode: (() {
        ...
        return pulumi.Input.fromValue(
          NetworkConfigConnectModeFileV1beta1.fromValue(guardedValue as String),
        );
      })(),
      modes: (() {
