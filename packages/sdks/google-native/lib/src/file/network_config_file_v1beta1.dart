...
class NetworkConfigFileV1beta1 {
  ...
  const NetworkConfigFileV1beta1({
    this.connectMode,
    this.modes,
    this.network,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'connectMode': ?pulumi.Input.mapOptionalInputValue<NetworkConfigConnectModeFileV1beta1, String>(connectMode, (value) => value.wireValue),
      'modes': ?pulumi.Input.mapOptionalInputValue<List<NetworkConfigModesItemFileV1beta1>, List<String>>(modes, (value) => pulumi.Input.encodeList<NetworkConfigModesItemFileV1beta1, String>(value, (value) => value.wireValue)),
      'network': ?network,
  ...
  factory NetworkConfigFileV1beta1.fromMap(Map<String, dynamic> map) {
    return NetworkConfigFileV1beta1(
      connectMode: (() { final guardedValue = map['connectMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkConfigConnectModeFileV1beta1.fromValue(guardedValue as String)); })(),
      modes: (() { final guardedValue = map['modes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NetworkConfigModesItemFileV1beta1>(guardedValue, (value) => NetworkConfigModesItemFileV1beta1.fromValue(value as String))); })(),
