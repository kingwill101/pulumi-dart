...
class NfsExportOptions {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'accessMode': ?pulumi.Input.mapOptionalInputValue<NfsExportOptionsAccessMode, String>(accessMode, (value) => value.value),
      'anonGid': ?anonGid,
      'anonUid': ?anonUid,
      'ipRanges': ?ipRanges,
      'squashMode': ?pulumi.Input.mapOptionalInputValue<NfsExportOptionsSquashMode, String>(squashMode, (value) => value.value),
    };
  }
