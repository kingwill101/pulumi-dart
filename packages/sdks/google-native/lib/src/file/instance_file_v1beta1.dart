...
class InstanceFileV1beta1 extends pulumi.CustomResource {
  ...
  InstanceFileV1beta1(
    ...
    this.directoryServices = registerOutput<DirectoryServicesConfigResponse>('directoryServices');
    this.etag = registerOutput<String>('etag');
    this.fileShares = registerOutput<List<FileShareConfigResponseFileV1beta1>>('fileShares');
    ...
    this.networks = registerOutput<List<NetworkConfigResponseFileV1beta1>>('networks');
