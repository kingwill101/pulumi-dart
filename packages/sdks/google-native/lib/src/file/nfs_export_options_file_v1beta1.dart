...
class NfsExportOptionsFileV1beta1 {
  ...
  final pulumi.Input<List<NfsExportOptionsSecurityFlavorsItem>>?
  securityFlavors;
    ...
    return <String, dynamic>{
      'accessMode':
          ?pulumi.Input.mapOptionalInputValue<
            NfsExportOptionsAccessModeFileV1beta1,
            String
          >(accessMode, (value) => value.wireValue),
      'anonGid': ?anonGid,
      'anonUid': ?anonUid,
      'ipRanges': ?ipRanges,
      'securityFlavors':
          ?pulumi.Input.mapOptionalInputValue<
            List<NfsExportOptionsSecurityFlavorsItem>,
            List<String>
          >(
            securityFlavors,
            (value) =>
      ...
      'squashMode':
          ?pulumi.Input.mapOptionalInputValue<
            NfsExportOptionsSquashModeFileV1beta1,
            String
          >(squashMode, (value) => value.wireValue),
    };
  }
  ...
  factory NfsExportOptionsFileV1beta1.fromMap(Map<String, dynamic> map) {
    return NfsExportOptionsFileV1beta1(
      ...
      anonGid: (() {
        final guardedValue = map['anonGid'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      anonUid: (() {
        final guardedValue = map['anonUid'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ipRanges: (() {
      ...
      securityFlavors: (() {
        final guardedValue = map['securityFlavors'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NfsExportOptionsSecurityFlavorsItem>(
            guardedValue,
            (value) =>
                NfsExportOptionsSecurityFlavorsItem.fromValue(value as String),
          ),
        );
      })(),
      squashMode: (() {
        final guardedValue = map['squashMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
