...
class NfsExportOptionsFileV1beta1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'accessMode': ?pulumi.Input.mapOptionalInputValue<NfsExportOptionsAccessModeFileV1beta1, String>(accessMode, (value) => value.wireValue),
      'anonGid': ?anonGid,
      'anonUid': ?anonUid,
      'ipRanges': ?ipRanges,
      'securityFlavors': ?pulumi.Input.mapOptionalInputValue<List<NfsExportOptionsSecurityFlavorsItem>, List<String>>(securityFlavors, (value) => pulumi.Input.encodeList<NfsExportOptionsSecurityFlavorsItem, String>(value, (value) => value.wireValue)),
      'squashMode': ?pulumi.Input.mapOptionalInputValue<NfsExportOptionsSquashModeFileV1beta1, String>(squashMode, (value) => value.wireValue),
    };
  }

  factory NfsExportOptionsFileV1beta1.fromMap(Map<String, dynamic> map) {
    return NfsExportOptionsFileV1beta1(
      accessMode: (() { final guardedValue = map['accessMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NfsExportOptionsAccessModeFileV1beta1.fromValue(guardedValue as String)); })(),
      ...
      securityFlavors: (() { final guardedValue = map['securityFlavors']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NfsExportOptionsSecurityFlavorsItem>(guardedValue, (value) => NfsExportOptionsSecurityFlavorsItem.fromValue(value as String))); })(),
      squashMode: (() { final guardedValue = map['squashMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NfsExportOptionsSquashModeFileV1beta1.fromValue(guardedValue as String)); })(),
    );
  }
}
