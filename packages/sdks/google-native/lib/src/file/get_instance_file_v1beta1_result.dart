...
class GetInstanceFileV1beta1Result {
  ...
  factory GetInstanceFileV1beta1Result.fromMap(Map<String, dynamic> map) {
    return GetInstanceFileV1beta1Result(
      ...
      fileShares: pulumi.Input.decodeList<FileShareConfigResponseFileV1beta1>(
        map['fileShares']!,
        (value) => FileShareConfigResponseFileV1beta1.fromMap(
      ...
      networks: pulumi.Input.decodeList<NetworkConfigResponseFileV1beta1>(
        map['networks']!,
        (value) => NetworkConfigResponseFileV1beta1.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
