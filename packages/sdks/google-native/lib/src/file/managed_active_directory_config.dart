...
class ManagedActiveDirectoryConfig {
  ...
  const ManagedActiveDirectoryConfig({
    this.computer,
    this.domain,
  });
  ...
  factory ManagedActiveDirectoryConfig.fromMap(Map<String, dynamic> map) {
    return ManagedActiveDirectoryConfig(
      computer: (() { final guardedValue = map['computer']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
