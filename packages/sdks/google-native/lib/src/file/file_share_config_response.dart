...
class FileShareConfigResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': name,
      'nfsExportOptions': pulumi.Input.mapInputValue<List<NfsExportOptionsResponse>, List<Map<String, dynamic>>>(nfsExportOptions, (value) => pulumi.Input.encodeList<NfsExportOptionsResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory FileShareConfigResponse.fromMap(Map<String, dynamic> map) {
    return FileShareConfigResponse(
      ...
      nfsExportOptions: pulumi.Input.fromValue(pulumi.Input.decodeList<NfsExportOptionsResponse>(map['nfsExportOptions']!, (value) => NfsExportOptionsResponse.fromMap((value as Map).cast<String, dynamic>()))),
