...
class FileShareConfigResponse {
  ...
  factory FileShareConfigResponse.fromMap(Map<String, dynamic> map) {
    return FileShareConfigResponse(
      ...
      nfsExportOptions: (pulumi.Input.decodeList<NfsExportOptionsResponse>(map['nfsExportOptions'], (value) => NfsExportOptionsResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
