...
class InstanceFileV1beta1Args {
  ...
  InstanceFileV1beta1Args({
    ...
    pulumi.Output<DirectoryServicesConfig>? directoryServices,
    pulumi.Output<String>? etag,
    pulumi.Output<List<FileShareConfigFileV1beta1>>? fileShares,
    required pulumi.Output<String> instanceId,
    pulumi.Output<String>? kmsKeyName,
    pulumi.Output<Map<String, String>>? labels,
    pulumi.Output<String>? location,
    pulumi.Output<String>? maxShareCount,
    pulumi.Output<bool>? multiShareEnabled,
    pulumi.Output<List<NetworkConfigFileV1beta1>>? networks,
    pulumi.Output<String>? project,
    pulumi.Output<InstanceProtocol>? protocol,
    pulumi.Output<InstanceTierFileV1beta1>? tier,
  }) :
  ...
  factory InstanceFileV1beta1Args.fromMap(Map<String, dynamic> map) {
    return InstanceFileV1beta1Args(
      ...
      directoryServices: map['directoryServices'] == null ? null : pulumi.Output.create<DirectoryServicesConfig>(DirectoryServicesConfig.fromMap((map['directoryServices'] as Map).cast<String, dynamic>())),
      etag: map['etag'] == null ? null : pulumi.Output.create<String>(map['etag'] as String),
      fileShares: map['fileShares'] == null ? null : pulumi.Output.create<List<FileShareConfigFileV1beta1>>(pulumi.Input.decodeList<FileShareConfigFileV1beta1>(map['fileShares'], (value) => FileShareConfigFileV1beta1.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      maxShareCount: map['maxShareCount'] == null ? null : pulumi.Output.create<String>(map['maxShareCount'] as String),
      multiShareEnabled: map['multiShareEnabled'] == null ? null : pulumi.Output.create<bool>(map['multiShareEnabled'] as bool),
      networks: map['networks'] == null ? null : pulumi.Output.create<List<NetworkConfigFileV1beta1>>(pulumi.Input.decodeList<NetworkConfigFileV1beta1>(map['networks'], (value) => NetworkConfigFileV1beta1.fromMap((value as Map).cast<String, dynamic>()))),
      project: map['project'] == null ? null : pulumi.Output.create<String>(map['project'] as String),
      protocol: map['protocol'] == null ? null : pulumi.Output.create<InstanceProtocol>(InstanceProtocol.fromValue(map['protocol'] as String)),
      tier: map['tier'] == null ? null : pulumi.Output.create<InstanceTierFileV1beta1>(InstanceTierFileV1beta1.fromValue(map['tier'] as String)),
    );
  }
}
