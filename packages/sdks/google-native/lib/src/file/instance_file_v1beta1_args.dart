...
class InstanceFileV1beta1Args {
  ...
  factory InstanceFileV1beta1Args.fromMap(Map<String, dynamic> map) {
    return InstanceFileV1beta1Args(
      ...
      maxShareCount: (() {
        final guardedValue = map['maxShareCount'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      multiShareEnabled: (() {
        final guardedValue = map['multiShareEnabled'];
        if (guardedValue == null) return null;
      ...
      protocol: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          InstanceProtocol.fromValue(guardedValue as String),
        );
      })(),
      tier: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          InstanceTierFileV1beta1.fromValue(guardedValue as String),
        );
      })(),
    );
  }
