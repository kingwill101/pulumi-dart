...
class NetworkConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'connectMode': ?pulumi.Input.mapOptionalInputValue<NetworkConfigConnectMode, String>(connectMode, (value) => value.wireValue),
      'modes': ?pulumi.Input.mapOptionalInputValue<List<NetworkConfigModesItem>, List<String>>(modes, (value) => pulumi.Input.encodeList<NetworkConfigModesItem, String>(value, (value) => value.wireValue)),
      'network': ?network,
  ...
  factory NetworkConfig.fromMap(Map<String, dynamic> map) {
    return NetworkConfig(
      connectMode: (() { final guardedValue = map['connectMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkConfigConnectMode.fromValue(guardedValue as String)); })(),
      modes: (() { final guardedValue = map['modes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NetworkConfigModesItem>(guardedValue, (value) => NetworkConfigModesItem.fromValue(value as String))); })(),
