...
class NetworkConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'connectMode': ?pulumi.Input.mapOptionalInputValue<NetworkConfigConnectMode, String>(connectMode, (value) => value.value),
      'modes': ?pulumi.Input.mapOptionalInputValue<List<NetworkConfigModesItem>, List<String>>(modes, (value) => pulumi.Input.encodeList<NetworkConfigModesItem, String>(value, (value) => value.value)),
      'network': ?network,
  ...
  factory NetworkConfig.fromMap(Map<String, dynamic> map) {
    return NetworkConfig(
      connectMode: map['connectMode'] == null ? null : (NetworkConfigConnectMode.fromValue(map['connectMode']! as String)).input(),
      modes: map['modes'] == null ? null : (pulumi.Input.decodeList<NetworkConfigModesItem>(map['modes']!, (value) => NetworkConfigModesItem.fromValue(value as String))).input(),
