...
class NetworkConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'modes': ?modes == null ? null : pulumi.Input.encodeList<NetworkConfigModesItem, String>(modes!, (value) => value.value),
      'network': ?network,
  ...
  factory NetworkConfig.fromMap(Map<String, dynamic> map) {
    return NetworkConfig(
      connectMode: map['connectMode'] == null ? null : NetworkConfigConnectMode.fromValue(map['connectMode'] as String),
      modes: map['modes'] == null ? null : pulumi.Input.decodeList<NetworkConfigModesItem>(map['modes'], (value) => NetworkConfigModesItem.fromValue(value as String)),
