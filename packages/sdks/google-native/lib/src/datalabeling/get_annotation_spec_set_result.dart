...
class GetAnnotationSpecSetResult {
  ...
  final List<GoogleCloudDatalabelingV1beta1AnnotationSpecResponse>
  annotationSpecs;
    ...
    return <String, dynamic>{
      'annotationSpecs':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(annotationSpecs, (value) => value.toMap()),
    ...
    return GetAnnotationSpecSetResult(
      annotationSpecs:
          ...
          >(
            map['annotationSpecs']!,
            (value) =>
                GoogleCloudDatalabelingV1beta1AnnotationSpecResponse.fromMap(
