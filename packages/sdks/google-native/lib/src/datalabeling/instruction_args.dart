...
class InstructionArgs {
  ...
  final pulumi.Input<GoogleCloudDatalabelingV1beta1CsvInstruction>? csvInstruction;
  ...
  final pulumi.Input<GoogleCloudDatalabelingV1beta1PdfInstruction>? pdfInstruction;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'csvInstruction': ?pulumi.Input.mapOptionalInputValue<GoogleCloudDatalabelingV1beta1CsvInstruction, Map<String, dynamic>>(csvInstruction, (value) => value.toMap()),
      'dataType': pulumi.Input.mapInputValue<InstructionDataType, String>(dataType, (value) => value.wireValue),
      'description': ?description,
      'displayName': displayName,
      'pdfInstruction': ?pulumi.Input.mapOptionalInputValue<GoogleCloudDatalabelingV1beta1PdfInstruction, Map<String, dynamic>>(pdfInstruction, (value) => value.toMap()),
      'project': ?project,
    };
  }
  ...
  factory InstructionArgs.fromMap(Map<String, dynamic> map) {
    return InstructionArgs(
      csvInstruction: (() { final guardedValue = map['csvInstruction']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDatalabelingV1beta1CsvInstruction.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      dataType: pulumi.Input.fromValue(InstructionDataType.fromValue(map['dataType']! as String)),
      description: (() { final guardedValue = map['description']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      displayName: pulumi.Input.fromValue(map['displayName'] as String),
      pdfInstruction: (() { final guardedValue = map['pdfInstruction']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDatalabelingV1beta1PdfInstruction.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
