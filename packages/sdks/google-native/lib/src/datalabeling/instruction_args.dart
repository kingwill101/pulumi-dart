...
class InstructionArgs {
  ...
  factory InstructionArgs.fromMap(Map<String, dynamic> map) {
    return InstructionArgs(
      csvInstruction: (() {
        final guardedValue = map['csvInstruction'];
      ...
      dataType: pulumi.Input.fromValue(
        InstructionDataType.fromValue(map['dataType']! as String),
      ),
      description: (() {
      ...
      pdfInstruction: (() {
        final guardedValue = map['pdfInstruction'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
