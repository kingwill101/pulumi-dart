...
class GoogleCloudDatalabelingV1beta1EvaluationJobConfigResponse {
  ...
  final pulumi.Input<GoogleCloudDatalabelingV1beta1BoundingPolyConfigResponse>
  boundingPolyConfig;
  ...
  final pulumi.Input<GoogleCloudDatalabelingV1beta1EvaluationConfigResponse>
  evaluationConfig;
  ...
  final pulumi.Input<GoogleCloudDatalabelingV1beta1InputConfigResponse>
  inputConfig;
  ...
  factory GoogleCloudDatalabelingV1beta1EvaluationJobConfigResponse.fromMap(
    ...
    return GoogleCloudDatalabelingV1beta1EvaluationJobConfigResponse(
      ...
      boundingPolyConfig: pulumi.Input.fromValue(
      ...
      evaluationJobAlertConfig: pulumi.Input.fromValue(
        GoogleCloudDatalabelingV1beta1EvaluationJobAlertConfigResponse.fromMap(
      ...
      humanAnnotationConfig: pulumi.Input.fromValue(
        GoogleCloudDatalabelingV1beta1HumanAnnotationConfigResponse.fromMap(
          (map['humanAnnotationConfig']! as Map).cast<String, dynamic>(),
        ),
      ),
      imageClassificationConfig: pulumi.Input.fromValue(
        GoogleCloudDatalabelingV1beta1ImageClassificationConfigResponse.fromMap(
      ...
      textClassificationConfig: pulumi.Input.fromValue(
        GoogleCloudDatalabelingV1beta1TextClassificationConfigResponse.fromMap(
