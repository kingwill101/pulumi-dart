...
class GoogleCloudDatalabelingV1beta1EvaluationJobConfigResponse {
  ...
  factory GoogleCloudDatalabelingV1beta1EvaluationJobConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDatalabelingV1beta1EvaluationJobConfigResponse(
      ...
      boundingPolyConfig: (GoogleCloudDatalabelingV1beta1BoundingPolyConfigResponse.fromMap((map['boundingPolyConfig'] as Map).cast<String, dynamic>())).input(),
      evaluationConfig: (GoogleCloudDatalabelingV1beta1EvaluationConfigResponse.fromMap((map['evaluationConfig'] as Map).cast<String, dynamic>())).input(),
      evaluationJobAlertConfig: (GoogleCloudDatalabelingV1beta1EvaluationJobAlertConfigResponse.fromMap((map['evaluationJobAlertConfig'] as Map).cast<String, dynamic>())).input(),
      exampleCount: (map['exampleCount'] as int).input(),
      exampleSamplePercentage: (map['exampleSamplePercentage'] as double).input(),
      humanAnnotationConfig: (GoogleCloudDatalabelingV1beta1HumanAnnotationConfigResponse.fromMap((map['humanAnnotationConfig'] as Map).cast<String, dynamic>())).input(),
      imageClassificationConfig: (GoogleCloudDatalabelingV1beta1ImageClassificationConfigResponse.fromMap((map['imageClassificationConfig'] as Map).cast<String, dynamic>())).input(),
      inputConfig: (GoogleCloudDatalabelingV1beta1InputConfigResponse.fromMap((map['inputConfig'] as Map).cast<String, dynamic>())).input(),
      textClassificationConfig: (GoogleCloudDatalabelingV1beta1TextClassificationConfigResponse.fromMap((map['textClassificationConfig'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
