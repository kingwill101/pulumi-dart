...
class GoogleCloudDatalabelingV1beta1EvaluationConfig {
  ...
  final pulumi.Input<GoogleCloudDatalabelingV1beta1BoundingBoxEvaluationOptions>? boundingBoxEvaluationOptions;
  ...
  const GoogleCloudDatalabelingV1beta1EvaluationConfig({
    this.boundingBoxEvaluationOptions,
  });

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'boundingBoxEvaluationOptions': ?pulumi.Input.mapOptionalInputValue<GoogleCloudDatalabelingV1beta1BoundingBoxEvaluationOptions, Map<String, dynamic>>(boundingBoxEvaluationOptions, (value) => value.toMap()),
    };
  }
  ...
  factory GoogleCloudDatalabelingV1beta1EvaluationConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDatalabelingV1beta1EvaluationConfig(
      boundingBoxEvaluationOptions: (() { final guardedValue = map['boundingBoxEvaluationOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDatalabelingV1beta1BoundingBoxEvaluationOptions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
