...
class EvaluationJob extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<GoogleCloudDatalabelingV1beta1AttemptResponse>> attempts;
  ...
  late final pulumi.Output<GoogleCloudDatalabelingV1beta1EvaluationJobConfigResponse> evaluationJobConfig;
  ...
  EvaluationJob(
    ...
    this.attempts = registerOutput<List<GoogleCloudDatalabelingV1beta1AttemptResponse>>('attempts');
    this.createTime = registerOutput<String>('createTime');
    this.description = registerOutput<String>('description');
    this.evaluationJobConfig = registerOutput<GoogleCloudDatalabelingV1beta1EvaluationJobConfigResponse>('evaluationJobConfig');
    this.labelMissingGroundTruth = registerOutput<bool>('labelMissingGroundTruth');
