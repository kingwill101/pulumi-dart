...
class GoogleCloudDatalabelingV1beta1EvaluationJobConfig {
  ...
  final pulumi.Input<GoogleCloudDatalabelingV1beta1BoundingPolyConfig>? boundingPolyConfig;
  ...
  final pulumi.Input<GoogleCloudDatalabelingV1beta1EvaluationConfig> evaluationConfig;
  /// Optional. Configuration details for evaluation job alerts. Specify this field if you want to receive email alerts if the evaluation job finds that your predictions have low mean average precision during a run.
  final pulumi.Input<GoogleCloudDatalabelingV1beta1EvaluationJobAlertConfig>? evaluationJobAlertConfig;
  ...
  final pulumi.Input<GoogleCloudDatalabelingV1beta1HumanAnnotationConfig>? humanAnnotationConfig;
  ...
  final pulumi.Input<GoogleCloudDatalabelingV1beta1ImageClassificationConfig>? imageClassificationConfig;
  ...
  final pulumi.Input<GoogleCloudDatalabelingV1beta1TextClassificationConfig>? textClassificationConfig;
  ...
  const GoogleCloudDatalabelingV1beta1EvaluationJobConfig({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'boundingPolyConfig': ?pulumi.Input.mapOptionalInputValue<GoogleCloudDatalabelingV1beta1BoundingPolyConfig, Map<String, dynamic>>(boundingPolyConfig, (value) => value.toMap()),
      'evaluationConfig': pulumi.Input.mapInputValue<GoogleCloudDatalabelingV1beta1EvaluationConfig, Map<String, dynamic>>(evaluationConfig, (value) => value.toMap()),
      'evaluationJobAlertConfig': ?pulumi.Input.mapOptionalInputValue<GoogleCloudDatalabelingV1beta1EvaluationJobAlertConfig, Map<String, dynamic>>(evaluationJobAlertConfig, (value) => value.toMap()),
      'exampleCount': exampleCount,
      'exampleSamplePercentage': exampleSamplePercentage,
      'humanAnnotationConfig': ?pulumi.Input.mapOptionalInputValue<GoogleCloudDatalabelingV1beta1HumanAnnotationConfig, Map<String, dynamic>>(humanAnnotationConfig, (value) => value.toMap()),
      'imageClassificationConfig': ?pulumi.Input.mapOptionalInputValue<GoogleCloudDatalabelingV1beta1ImageClassificationConfig, Map<String, dynamic>>(imageClassificationConfig, (value) => value.toMap()),
      'inputConfig': ?pulumi.Input.mapOptionalInputValue<GoogleCloudDatalabelingV1beta1InputConfig, Map<String, dynamic>>(inputConfig, (value) => value.toMap()),
      'textClassificationConfig': ?pulumi.Input.mapOptionalInputValue<GoogleCloudDatalabelingV1beta1TextClassificationConfig, Map<String, dynamic>>(textClassificationConfig, (value) => value.toMap()),
    };
  }
  ...
  factory GoogleCloudDatalabelingV1beta1EvaluationJobConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDatalabelingV1beta1EvaluationJobConfig(
      ...
      boundingPolyConfig: (() { final guardedValue = map['boundingPolyConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDatalabelingV1beta1BoundingPolyConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      evaluationConfig: pulumi.Input.fromValue(GoogleCloudDatalabelingV1beta1EvaluationConfig.fromMap((map['evaluationConfig']! as Map).cast<String, dynamic>())),
      evaluationJobAlertConfig: (() { final guardedValue = map['evaluationJobAlertConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDatalabelingV1beta1EvaluationJobAlertConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      humanAnnotationConfig: (() { final guardedValue = map['humanAnnotationConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDatalabelingV1beta1HumanAnnotationConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      imageClassificationConfig: (() { final guardedValue = map['imageClassificationConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDatalabelingV1beta1ImageClassificationConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      inputConfig: (() { final guardedValue = map['inputConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDatalabelingV1beta1InputConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      textClassificationConfig: (() { final guardedValue = map['textClassificationConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDatalabelingV1beta1TextClassificationConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
