...
class GoogleCloudDatalabelingV1beta1EvaluationJobConfig {
  ...
  final GoogleCloudDatalabelingV1beta1BoundingPolyConfig? boundingPolyConfig;
  ...
  final GoogleCloudDatalabelingV1beta1EvaluationConfig evaluationConfig;
  /// Optional. Configuration details for evaluation job alerts. Specify this field if you want to receive email alerts if the evaluation job finds that your predictions have low mean average precision during a run.
  final GoogleCloudDatalabelingV1beta1EvaluationJobAlertConfig? evaluationJobAlertConfig;
  ...
  final GoogleCloudDatalabelingV1beta1HumanAnnotationConfig? humanAnnotationConfig;
  ...
  final GoogleCloudDatalabelingV1beta1ImageClassificationConfig? imageClassificationConfig;
  ...
  final GoogleCloudDatalabelingV1beta1InputConfig? inputConfig;
  ...
  final GoogleCloudDatalabelingV1beta1TextClassificationConfig? textClassificationConfig;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'boundingPolyConfig': ?boundingPolyConfig == null ? null : boundingPolyConfig!.toMap(),
      'evaluationConfig': evaluationConfig.toMap(),
      'evaluationJobAlertConfig': ?evaluationJobAlertConfig == null ? null : evaluationJobAlertConfig!.toMap(),
      'exampleCount': exampleCount,
      'exampleSamplePercentage': exampleSamplePercentage,
      'humanAnnotationConfig': ?humanAnnotationConfig == null ? null : humanAnnotationConfig!.toMap(),
      'imageClassificationConfig': ?imageClassificationConfig == null ? null : imageClassificationConfig!.toMap(),
      'inputConfig': ?inputConfig == null ? null : inputConfig!.toMap(),
      'textClassificationConfig': ?textClassificationConfig == null ? null : textClassificationConfig!.toMap(),
    };
  }
  ...
  factory GoogleCloudDatalabelingV1beta1EvaluationJobConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDatalabelingV1beta1EvaluationJobConfig(
      bigqueryImportKeys: (map['bigqueryImportKeys'] as Map).cast<String, String>(),
      boundingPolyConfig: map['boundingPolyConfig'] == null ? null : GoogleCloudDatalabelingV1beta1BoundingPolyConfig.fromMap((map['boundingPolyConfig'] as Map).cast<String, dynamic>()),
      evaluationConfig: GoogleCloudDatalabelingV1beta1EvaluationConfig.fromMap((map['evaluationConfig'] as Map).cast<String, dynamic>()),
      evaluationJobAlertConfig: map['evaluationJobAlertConfig'] == null ? null : GoogleCloudDatalabelingV1beta1EvaluationJobAlertConfig.fromMap((map['evaluationJobAlertConfig'] as Map).cast<String, dynamic>()),
      exampleCount: map['exampleCount'] as int,
      exampleSamplePercentage: map['exampleSamplePercentage'] as double,
      humanAnnotationConfig: map['humanAnnotationConfig'] == null ? null : GoogleCloudDatalabelingV1beta1HumanAnnotationConfig.fromMap((map['humanAnnotationConfig'] as Map).cast<String, dynamic>()),
      imageClassificationConfig: map['imageClassificationConfig'] == null ? null : GoogleCloudDatalabelingV1beta1ImageClassificationConfig.fromMap((map['imageClassificationConfig'] as Map).cast<String, dynamic>()),
      inputConfig: map['inputConfig'] == null ? null : GoogleCloudDatalabelingV1beta1InputConfig.fromMap((map['inputConfig'] as Map).cast<String, dynamic>()),
      textClassificationConfig: map['textClassificationConfig'] == null ? null : GoogleCloudDatalabelingV1beta1TextClassificationConfig.fromMap((map['textClassificationConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
