...
class GoogleCloudDatalabelingV1beta1HumanAnnotationConfigResponse {
  ...
  factory GoogleCloudDatalabelingV1beta1HumanAnnotationConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDatalabelingV1beta1HumanAnnotationConfigResponse(
      annotatedDatasetDescription: (map['annotatedDatasetDescription'] as String).input(),
      annotatedDatasetDisplayName: (map['annotatedDatasetDisplayName'] as String).input(),
      contributorEmails: ((map['contributorEmails'] as List).cast<String>()).input(),
      instruction: (map['instruction'] as String).input(),
      labelGroup: (map['labelGroup'] as String).input(),
      languageCode: (map['languageCode'] as String).input(),
      questionDuration: (map['questionDuration'] as String).input(),
