...
class GoogleCloudDatalabelingV1beta1AttemptResponse {
  ...
  factory GoogleCloudDatalabelingV1beta1AttemptResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDatalabelingV1beta1AttemptResponse(
      attemptTime: (map['attemptTime'] as String).input(),
      partialFailures: (pulumi.Input.decodeList<GoogleRpcStatusResponse>(map['partialFailures'], (value) => GoogleRpcStatusResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
