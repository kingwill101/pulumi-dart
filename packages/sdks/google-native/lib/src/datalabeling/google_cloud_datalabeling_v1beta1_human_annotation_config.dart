...
class GoogleCloudDatalabelingV1beta1HumanAnnotationConfig {
  ...
  factory GoogleCloudDatalabelingV1beta1HumanAnnotationConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDatalabelingV1beta1HumanAnnotationConfig(
      annotatedDatasetDescription: map['annotatedDatasetDescription'] == null ? null : map['annotatedDatasetDescription'] as String,
      annotatedDatasetDisplayName: map['annotatedDatasetDisplayName'] as String,
      contributorEmails: map['contributorEmails'] == null ? null : (map['contributorEmails'] as List).cast<String>(),
      instruction: map['instruction'] as String,
      labelGroup: map['labelGroup'] == null ? null : map['labelGroup'] as String,
      languageCode: map['languageCode'] == null ? null : map['languageCode'] as String,
      questionDuration: map['questionDuration'] == null ? null : map['questionDuration'] as String,
