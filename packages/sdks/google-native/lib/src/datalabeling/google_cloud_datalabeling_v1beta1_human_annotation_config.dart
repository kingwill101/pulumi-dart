  ...
  factory GoogleCloudDatalabelingV1beta1HumanAnnotationConfig.fromMap(
    ...
    return GoogleCloudDatalabelingV1beta1HumanAnnotationConfig(
      annotatedDatasetDescription: (() {
        final guardedValue = map['annotatedDatasetDescription'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      annotatedDatasetDisplayName: pulumi.Input.fromValue(
        map['annotatedDatasetDisplayName'] as String,
      ),
      contributorEmails: (() {
        final guardedValue = map['contributorEmails'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      instruction: pulumi.Input.fromValue(map['instruction'] as String),
      labelGroup: (() {
        final guardedValue = map['labelGroup'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      languageCode: (() {
      ...
      questionDuration: (() {
        final guardedValue = map['questionDuration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      replicaCount: (() {
