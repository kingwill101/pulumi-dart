...
class GoogleCloudDatalabelingV1beta1InputConfig {
  ...
  final pulumi.Input<GoogleCloudDatalabelingV1beta1InputConfigAnnotationType>?
  annotationType;

  /// Source located in BigQuery. You must specify this field if you are using this InputConfig in an EvaluationJob.
  final pulumi.Input<GoogleCloudDatalabelingV1beta1BigQuerySource>?
  bigquerySource;

  /// Optional. Metadata about annotations for the input. You must specify this field if you are using this InputConfig in an EvaluationJob for a model version that performs classification.
  final pulumi.Input<GoogleCloudDatalabelingV1beta1ClassificationMetadata>?
  classificationMetadata;

  /// Data type must be specifed when user tries to import data.
  final pulumi.Input<GoogleCloudDatalabelingV1beta1InputConfigDataType>
  dataType;
    ...
    return <String, dynamic>{
      'annotationType':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(annotationType, (value) => value.wireValue),
      'bigquerySource':
          ?pulumi.Input.mapOptionalInputValue<
  ...
  factory GoogleCloudDatalabelingV1beta1InputConfig.fromMap(
    ...
    return GoogleCloudDatalabelingV1beta1InputConfig(
      ...
      classificationMetadata: (() {
        final guardedValue = map['classificationMetadata'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      dataType: pulumi.Input.fromValue(
        GoogleCloudDatalabelingV1beta1InputConfigDataType.fromValue(
      ...
      textMetadata: (() {
        final guardedValue = map['textMetadata'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
