...
class GetDatasetResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'inputConfigs': pulumi.Input.encodeList<GoogleCloudDatalabelingV1beta1InputConfigResponse, Map<String, dynamic>>(inputConfigs, (value) => value.toMap()),
  ...
  factory GetDatasetResult.fromMap(Map<String, dynamic> map) {
    return GetDatasetResult(
      ...
      inputConfigs: pulumi.Input.decodeList<GoogleCloudDatalabelingV1beta1InputConfigResponse>(map['inputConfigs']!, (value) => GoogleCloudDatalabelingV1beta1InputConfigResponse.fromMap((value as Map).cast<String, dynamic>())),
