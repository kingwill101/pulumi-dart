...
class X509ParametersResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'caOptions':
          pulumi.Input.mapInputValue<CaOptionsResponse, Map<String, dynamic>>(
            caOptions,
            (value) => value.toMap(),
          ),
      'keyUsage':
          pulumi.Input.mapInputValue<KeyUsageResponse, Map<String, dynamic>>(
            keyUsage,
            (value) => value.toMap(),
          ),
      'nameConstraints':
