...
/// {@template pulumi_privateca_v1beta1_certificate_authority_iam_member_args_doc}
/// The set of arguments for CertificateAuthorityIamMember.
/// {@endtemplate}
/// {@macro pulumi_privateca_v1beta1_certificate_authority_iam_member_args_doc}
class CertificateAuthorityIamMemberArgs {
  ...
  /// Creates a new [CertificateAuthorityIamMemberArgs].
  ...
  const CertificateAuthorityIamMemberArgs({
    this.condition,
