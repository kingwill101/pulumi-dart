...
class IssuancePolicyResponse {
  ...
  factory IssuancePolicyResponse.fromMap(Map<String, dynamic> map) {
    return IssuancePolicyResponse(
      allowedIssuanceModes: (IssuanceModesResponse.fromMap((map['allowedIssuanceModes'] as Map).cast<String, dynamic>())).input(),
      allowedKeyTypes: (pulumi.Input.decodeList<AllowedKeyTypeResponse>(map['allowedKeyTypes'], (value) => AllowedKeyTypeResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      baselineValues: (X509ParametersResponse.fromMap((map['baselineValues'] as Map).cast<String, dynamic>())).input(),
      identityConstraints: (CertificateIdentityConstraintsResponse.fromMap((map['identityConstraints'] as Map).cast<String, dynamic>())).input(),
      maximumLifetime: (map['maximumLifetime'] as String).input(),
      passthroughExtensions: (CertificateExtensionConstraintsResponse.fromMap((map['passthroughExtensions'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
