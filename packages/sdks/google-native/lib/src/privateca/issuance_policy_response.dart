...
class IssuancePolicyResponse {
  ...
  final pulumi.Input<CertificateIdentityConstraintsResponse> identityConstraints;
  ...
  final pulumi.Input<CertificateExtensionConstraintsResponse> passthroughExtensions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'allowedIssuanceModes': pulumi.Input.mapInputValue<IssuanceModesResponse, Map<String, dynamic>>(allowedIssuanceModes, (value) => value.toMap()),
      'allowedKeyTypes': pulumi.Input.mapInputValue<List<AllowedKeyTypeResponse>, List<Map<String, dynamic>>>(allowedKeyTypes, (value) => pulumi.Input.encodeList<AllowedKeyTypeResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'baselineValues': pulumi.Input.mapInputValue<X509ParametersResponse, Map<String, dynamic>>(baselineValues, (value) => value.toMap()),
      'identityConstraints': pulumi.Input.mapInputValue<CertificateIdentityConstraintsResponse, Map<String, dynamic>>(identityConstraints, (value) => value.toMap()),
      'maximumLifetime': maximumLifetime,
      'passthroughExtensions': pulumi.Input.mapInputValue<CertificateExtensionConstraintsResponse, Map<String, dynamic>>(passthroughExtensions, (value) => value.toMap()),
    };
  }

  factory IssuancePolicyResponse.fromMap(Map<String, dynamic> map) {
    return IssuancePolicyResponse(
      allowedIssuanceModes: pulumi.Input.fromValue(IssuanceModesResponse.fromMap((map['allowedIssuanceModes']! as Map).cast<String, dynamic>())),
      allowedKeyTypes: pulumi.Input.fromValue(pulumi.Input.decodeList<AllowedKeyTypeResponse>(map['allowedKeyTypes']!, (value) => AllowedKeyTypeResponse.fromMap((value as Map).cast<String, dynamic>()))),
      baselineValues: pulumi.Input.fromValue(X509ParametersResponse.fromMap((map['baselineValues']! as Map).cast<String, dynamic>())),
      identityConstraints: pulumi.Input.fromValue(CertificateIdentityConstraintsResponse.fromMap((map['identityConstraints']! as Map).cast<String, dynamic>())),
      maximumLifetime: pulumi.Input.fromValue(map['maximumLifetime'] as String),
      passthroughExtensions: pulumi.Input.fromValue(CertificateExtensionConstraintsResponse.fromMap((map['passthroughExtensions']! as Map).cast<String, dynamic>())),
    );
  }
}
