...
/// {@template pulumi_privateca_v1beta1_certificate_authority_certificate_revocation_list_iam_binding_args_doc}
/// The set of arguments for CertificateAuthorityCertificateRevocationListIamBinding.
/// {@endtemplate}
/// {@macro pulumi_privateca_v1beta1_certificate_authority_certificate_revocation_list_iam_binding_args_doc}
class CertificateAuthorityCertificateRevocationListIamBindingArgs {
  ...
  /// Creates a new [CertificateAuthorityCertificateRevocationListIamBindingArgs].
  ...
  const CertificateAuthorityCertificateRevocationListIamBindingArgs({
    this.condition,
  ...
  factory CertificateAuthorityCertificateRevocationListIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return CertificateAuthorityCertificateRevocationListIamBindingArgs(
