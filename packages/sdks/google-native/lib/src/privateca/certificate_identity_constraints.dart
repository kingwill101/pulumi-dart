...
class CertificateIdentityConstraints {
  ...
  const CertificateIdentityConstraints({
  ...
  factory CertificateIdentityConstraints.fromMap(Map<String, dynamic> map) {
    return CertificateIdentityConstraints(
      ...
      celExpression: (() { final guardedValue = map['celExpression']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Expr.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
