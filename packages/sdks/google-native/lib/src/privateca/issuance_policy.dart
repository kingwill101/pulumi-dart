    ...
    return IssuancePolicy(
      allowedIssuanceModes: (() {
        ...
        return pulumi.Input.fromValue(
          IssuanceModes.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      allowedKeyTypes: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AllowedKeyType>(
            guardedValue,
            (value) =>
                AllowedKeyType.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      baselineValues: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          X509Parameters.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      identityConstraints: (() {
