...
class IssuancePolicy {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'allowedIssuanceModes': ?allowedIssuanceModes == null ? null : allowedIssuanceModes!.toMap(),
      'allowedKeyTypes': ?allowedKeyTypes == null ? null : pulumi.Input.encodeList<AllowedKeyType, Map<String, dynamic>>(allowedKeyTypes!, (value) => value.toMap()),
      'baselineValues': ?baselineValues == null ? null : baselineValues!.toMap(),
      'identityConstraints': ?identityConstraints == null ? null : identityConstraints!.toMap(),
      'maximumLifetime': ?maximumLifetime,
      'passthroughExtensions': ?passthroughExtensions == null ? null : passthroughExtensions!.toMap(),
    };
  }

  factory IssuancePolicy.fromMap(Map<String, dynamic> map) {
    return IssuancePolicy(
      allowedIssuanceModes: map['allowedIssuanceModes'] == null ? null : IssuanceModes.fromMap((map['allowedIssuanceModes'] as Map).cast<String, dynamic>()),
      allowedKeyTypes: map['allowedKeyTypes'] == null ? null : pulumi.Input.decodeList<AllowedKeyType>(map['allowedKeyTypes'], (value) => AllowedKeyType.fromMap((value as Map).cast<String, dynamic>())),
      baselineValues: map['baselineValues'] == null ? null : X509Parameters.fromMap((map['baselineValues'] as Map).cast<String, dynamic>()),
      identityConstraints: map['identityConstraints'] == null ? null : CertificateIdentityConstraints.fromMap((map['identityConstraints'] as Map).cast<String, dynamic>()),
      maximumLifetime: map['maximumLifetime'] == null ? null : map['maximumLifetime'] as String,
      passthroughExtensions: map['passthroughExtensions'] == null ? null : CertificateExtensionConstraints.fromMap((map['passthroughExtensions'] as Map).cast<String, dynamic>()),
    );
  }
}
