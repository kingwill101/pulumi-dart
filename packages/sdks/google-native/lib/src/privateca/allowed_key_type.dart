...
class AllowedKeyType {
  ...
  factory AllowedKeyType.fromMap(Map<String, dynamic> map) {
    return AllowedKeyType(
      ellipticCurve: (() { final guardedValue = map['ellipticCurve']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EcKeyType.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      rsa: (() { final guardedValue = map['rsa']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RsaKeyType.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
