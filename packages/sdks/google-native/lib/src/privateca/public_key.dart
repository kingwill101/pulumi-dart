...
class PublicKey {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'format': pulumi.Input.mapInputValue<PublicKeyFormat, String>(format, (value) => value.wireValue),
      'key': key,
    };
  }
  ...
  factory PublicKey.fromMap(Map<String, dynamic> map) {
    return PublicKey(
      format: pulumi.Input.fromValue(PublicKeyFormat.fromValue(map['format']! as String)),
