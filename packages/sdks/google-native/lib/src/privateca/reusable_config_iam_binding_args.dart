...
/// {@template pulumi_privateca_v1beta1_reusable_config_iam_binding_args_doc}
/// The set of arguments for ReusableConfigIamBinding.
/// {@endtemplate}
/// {@macro pulumi_privateca_v1beta1_reusable_config_iam_binding_args_doc}
class ReusableConfigIamBindingArgs {
  ...
  /// Creates a new [ReusableConfigIamBindingArgs].
  ...
  const ReusableConfigIamBindingArgs({
    this.condition,
  ...
  factory ReusableConfigIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return ReusableConfigIamBindingArgs(
