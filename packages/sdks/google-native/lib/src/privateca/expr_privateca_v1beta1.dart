...
class ExprPrivatecaV1beta1 {
  ...
  /// Creates a new [ExprPrivatecaV1beta1].
  ...
  factory ExprPrivatecaV1beta1.fromMap(Map<String, dynamic> map) {
    return ExprPrivatecaV1beta1(
