...
class CertificateConfigResponse {
  ...
  factory CertificateConfigResponse.fromMap(Map<String, dynamic> map) {
    return CertificateConfigResponse(
      publicKey: (PublicKeyResponse.fromMap((map['publicKey'] as Map).cast<String, dynamic>())).input(),
      subjectConfig: (SubjectConfigResponse.fromMap((map['subjectConfig'] as Map).cast<String, dynamic>())).input(),
      x509Config: (X509ParametersResponse.fromMap((map['x509Config'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
