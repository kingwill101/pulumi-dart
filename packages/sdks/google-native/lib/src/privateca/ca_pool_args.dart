...
class CaPoolArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'requestId': ?requestId,
      'tier': pulumi.Input.mapInputValue<CaPoolTier, String>(
        tier,
    ...
    return CaPoolArgs(
      ...
      issuancePolicy: (() {
        ...
        return pulumi.Input.fromValue(
          IssuancePolicy.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      labels: (() {
      ...
      tier: pulumi.Input.fromValue(
        CaPoolTier.fromValue(map['tier']! as String),
      ),
    );
  }
}
