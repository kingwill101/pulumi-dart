...
class CaPoolArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'requestId': ?requestId,
      'tier': pulumi.Input.mapInputValue<CaPoolTier, String>(tier, (value) => value.wireValue),
    };
  }
  ...
  factory CaPoolArgs.fromMap(Map<String, dynamic> map) {
    return CaPoolArgs(
      ...
      issuancePolicy: (() { final guardedValue = map['issuancePolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(IssuancePolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      labels: (() { final guardedValue = map['labels']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      location: (() { final guardedValue = map['location']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      project: (() { final guardedValue = map['project']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      publishingOptions: (() { final guardedValue = map['publishingOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PublishingOptions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      requestId: (() { final guardedValue = map['requestId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      tier: pulumi.Input.fromValue(CaPoolTier.fromValue(map['tier']! as String)),
    );
  }
}
