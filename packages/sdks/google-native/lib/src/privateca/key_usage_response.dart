...
class KeyUsageResponse {
  ...
  factory KeyUsageResponse.fromMap(Map<String, dynamic> map) {
    return KeyUsageResponse(
      baseKeyUsage: (KeyUsageOptionsResponse.fromMap((map['baseKeyUsage'] as Map).cast<String, dynamic>())).input(),
      extendedKeyUsage: (ExtendedKeyUsageOptionsResponse.fromMap((map['extendedKeyUsage'] as Map).cast<String, dynamic>())).input(),
      unknownExtendedKeyUsages: (pulumi.Input.decodeList<ObjectIdResponse>(map['unknownExtendedKeyUsages'], (value) => ObjectIdResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
