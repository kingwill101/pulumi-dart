...
class CertificateExtensionConstraintsResponse {
  ...
  factory CertificateExtensionConstraintsResponse.fromMap(Map<String, dynamic> map) {
    return CertificateExtensionConstraintsResponse(
      additionalExtensions: (pulumi.Input.decodeList<ObjectIdResponse>(map['additionalExtensions'], (value) => ObjectIdResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      knownExtensions: ((map['knownExtensions'] as List).cast<String>()).input(),
    );
  }
}
