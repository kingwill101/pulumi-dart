...
class KeyVersionSpec {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'algorithm': ?pulumi.Input.mapOptionalInputValue<KeyVersionSpecAlgorithm, String>(algorithm, (value) => value.wireValue),
  ...
  factory KeyVersionSpec.fromMap(Map<String, dynamic> map) {
    return KeyVersionSpec(
      algorithm: (() { final guardedValue = map['algorithm']; if (guardedValue == null) return null; return pulumi.Input.fromValue(KeyVersionSpecAlgorithm.fromValue(guardedValue as String)); })(),
