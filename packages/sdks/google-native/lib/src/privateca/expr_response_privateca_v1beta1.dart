...
class ExprResponsePrivatecaV1beta1 {
  ...
  /// Creates a new [ExprResponsePrivatecaV1beta1].
  ...
  const ExprResponsePrivatecaV1beta1({
  ...
  factory ExprResponsePrivatecaV1beta1.fromMap(Map<String, dynamic> map) {
    return ExprResponsePrivatecaV1beta1(
