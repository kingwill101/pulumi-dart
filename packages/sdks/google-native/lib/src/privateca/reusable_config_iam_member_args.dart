...
/// {@template pulumi_privateca_v1beta1_reusable_config_iam_member_args_doc}
/// The set of arguments for ReusableConfigIamMember.
/// {@endtemplate}
/// {@macro pulumi_privateca_v1beta1_reusable_config_iam_member_args_doc}
class ReusableConfigIamMemberArgs {
  ...
  /// Creates a new [ReusableConfigIamMemberArgs].
  ...
  const ReusableConfigIamMemberArgs({
    this.condition,
  ...
  factory ReusableConfigIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return ReusableConfigIamMemberArgs(
