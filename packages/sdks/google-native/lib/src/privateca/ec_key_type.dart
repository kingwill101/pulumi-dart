...
class EcKeyType {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'signatureAlgorithm': ?pulumi.Input.mapOptionalInputValue<EcKeyTypeSignatureAlgorithm, String>(signatureAlgorithm, (value) => value.wireValue),
    };
  }

  factory EcKeyType.fromMap(Map<String, dynamic> map) {
    return EcKeyType(
      signatureAlgorithm: (() { final guardedValue = map['signatureAlgorithm']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EcKeyTypeSignatureAlgorithm.fromValue(guardedValue as String)); })(),
    );
  }
}
