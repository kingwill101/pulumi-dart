...
/// {@template pulumi_privateca_v1beta1_certificate_authority_iam_binding_args_doc}
/// The set of arguments for CertificateAuthorityIamBinding.
/// {@endtemplate}
/// {@macro pulumi_privateca_v1beta1_certificate_authority_iam_binding_args_doc}
class CertificateAuthorityIamBindingArgs {
  ...
  /// Creates a new [CertificateAuthorityIamBindingArgs].
  ...
  const CertificateAuthorityIamBindingArgs({
    this.condition,
  ...
  factory CertificateAuthorityIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return CertificateAuthorityIamBindingArgs(
