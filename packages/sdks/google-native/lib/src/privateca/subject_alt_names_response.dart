...
class SubjectAltNamesResponse {
  ...
  factory SubjectAltNamesResponse.fromMap(Map<String, dynamic> map) {
    return SubjectAltNamesResponse(
      customSans: pulumi.Input.fromValue(pulumi.Input.decodeList<X509ExtensionResponse>(map['customSans']!, (value) => X509ExtensionResponse.fromMap((value as Map).cast<String, dynamic>()))),
