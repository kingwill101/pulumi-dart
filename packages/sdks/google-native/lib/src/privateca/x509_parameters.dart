...
class X509Parameters {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'caOptions':
          ?pulumi.Input.mapOptionalInputValue<CaOptions, Map<String, dynamic>>(
            caOptions,
            (value) => value.toMap(),
          ),
      'keyUsage':
          ?pulumi.Input.mapOptionalInputValue<KeyUsage, Map<String, dynamic>>(
            keyUsage,
            (value) => value.toMap(),
          ),
      'nameConstraints':
  ...
  factory X509Parameters.fromMap(Map<String, dynamic> map) {
    return X509Parameters(
      ...
      caOptions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CaOptions.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      keyUsage: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          KeyUsage.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      nameConstraints: (() {
