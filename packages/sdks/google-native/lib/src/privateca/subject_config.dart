...
class SubjectConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'subject':
          ?pulumi.Input.mapOptionalInputValue<Subject, Map<String, dynamic>>(
            subject,
            (value) => value.toMap(),
          ),
      'subjectAltName':
    ...
    return SubjectConfig(
      subject: (() {
        ...
        return pulumi.Input.fromValue(
          Subject.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      subjectAltName: (() {
        final guardedValue = map['subjectAltName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
