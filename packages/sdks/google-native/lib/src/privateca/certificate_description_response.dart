...
class CertificateDescriptionResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'authorityKeyId': pulumi.Input.mapInputValue<KeyIdResponse, Map<String, dynamic>>(authorityKeyId, (value) => value.toMap()),
      'certFingerprint': pulumi.Input.mapInputValue<CertificateFingerprintResponse, Map<String, dynamic>>(certFingerprint, (value) => value.toMap()),
      'crlDistributionPoints': crlDistributionPoints,
      'publicKey': pulumi.Input.mapInputValue<PublicKeyResponse, Map<String, dynamic>>(publicKey, (value) => value.toMap()),
      'subjectDescription': pulumi.Input.mapInputValue<SubjectDescriptionResponse, Map<String, dynamic>>(subjectDescription, (value) => value.toMap()),
      'subjectKeyId': pulumi.Input.mapInputValue<KeyIdResponse, Map<String, dynamic>>(subjectKeyId, (value) => value.toMap()),
      'x509Description': pulumi.Input.mapInputValue<X509ParametersResponse, Map<String, dynamic>>(x509Description, (value) => value.toMap()),
    };
  }
  ...
  factory CertificateDescriptionResponse.fromMap(Map<String, dynamic> map) {
    return CertificateDescriptionResponse(
      ...
      authorityKeyId: pulumi.Input.fromValue(KeyIdResponse.fromMap((map['authorityKeyId']! as Map).cast<String, dynamic>())),
      certFingerprint: pulumi.Input.fromValue(CertificateFingerprintResponse.fromMap((map['certFingerprint']! as Map).cast<String, dynamic>())),
      crlDistributionPoints: pulumi.Input.fromValue((map['crlDistributionPoints'] as List).cast<String>()),
      publicKey: pulumi.Input.fromValue(PublicKeyResponse.fromMap((map['publicKey']! as Map).cast<String, dynamic>())),
      subjectDescription: pulumi.Input.fromValue(SubjectDescriptionResponse.fromMap((map['subjectDescription']! as Map).cast<String, dynamic>())),
      subjectKeyId: pulumi.Input.fromValue(KeyIdResponse.fromMap((map['subjectKeyId']! as Map).cast<String, dynamic>())),
      x509Description: pulumi.Input.fromValue(X509ParametersResponse.fromMap((map['x509Description']! as Map).cast<String, dynamic>())),
    );
  }
}
