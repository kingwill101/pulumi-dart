...
class CertificateDescriptionResponse {
  ...
  factory CertificateDescriptionResponse.fromMap(Map<String, dynamic> map) {
    return CertificateDescriptionResponse(
      ...
      authorityKeyId: KeyIdResponse.fromMap((map['authorityKeyId'] as Map).cast<String, dynamic>()),
      certFingerprint: CertificateFingerprintResponse.fromMap((map['certFingerprint'] as Map).cast<String, dynamic>()),
      crlDistributionPoints: (map['crlDistributionPoints'] as List).cast<String>(),
      publicKey: PublicKeyResponse.fromMap((map['publicKey'] as Map).cast<String, dynamic>()),
      subjectDescription: SubjectDescriptionResponse.fromMap((map['subjectDescription'] as Map).cast<String, dynamic>()),
      subjectKeyId: KeyIdResponse.fromMap((map['subjectKeyId'] as Map).cast<String, dynamic>()),
      x509Description: X509ParametersResponse.fromMap((map['x509Description'] as Map).cast<String, dynamic>()),
    );
  }
}
