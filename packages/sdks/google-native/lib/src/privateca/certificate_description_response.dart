...
class CertificateDescriptionResponse {
  ...
  factory CertificateDescriptionResponse.fromMap(Map<String, dynamic> map) {
    return CertificateDescriptionResponse(
      ...
      authorityKeyId: (KeyIdResponse.fromMap((map['authorityKeyId'] as Map).cast<String, dynamic>())).input(),
      certFingerprint: (CertificateFingerprintResponse.fromMap((map['certFingerprint'] as Map).cast<String, dynamic>())).input(),
      crlDistributionPoints: ((map['crlDistributionPoints'] as List).cast<String>()).input(),
      publicKey: (PublicKeyResponse.fromMap((map['publicKey'] as Map).cast<String, dynamic>())).input(),
      subjectDescription: (SubjectDescriptionResponse.fromMap((map['subjectDescription'] as Map).cast<String, dynamic>())).input(),
      subjectKeyId: (KeyIdResponse.fromMap((map['subjectKeyId'] as Map).cast<String, dynamic>())).input(),
      x509Description: (X509ParametersResponse.fromMap((map['x509Description'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
