...
class AllowedKeyTypeResponse {
  ...
  factory AllowedKeyTypeResponse.fromMap(Map<String, dynamic> map) {
    return AllowedKeyTypeResponse(
      ellipticCurve: (EcKeyTypeResponse.fromMap((map['ellipticCurve'] as Map).cast<String, dynamic>())).input(),
      rsa: (RsaKeyTypeResponse.fromMap((map['rsa'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
