...
/// Result data returned by getFolderExclusion.
class GetFolderExclusionResult {
  ...
  /// Creates a new [GetFolderExclusionResult].
  ...
  const GetFolderExclusionResult({
  ...
  factory GetFolderExclusionResult.fromMap(Map<String, dynamic> map) {
