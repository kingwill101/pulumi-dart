...
/// Result data returned by getOrganizationBucketLink.
class GetOrganizationBucketLinkResult {
  ...
  /// Creates a new [GetOrganizationBucketLinkResult].
  ...
  const GetOrganizationBucketLinkResult({
  ...
  factory GetOrganizationBucketLinkResult.fromMap(Map<String, dynamic> map) {
    return GetOrganizationBucketLinkResult(
