...
/// Result data returned by getOrganizationBucket.
class GetOrganizationBucketResult {
  ...
  /// Creates a new [GetOrganizationBucketResult].
  ...
  const GetOrganizationBucketResult({
  ...
  factory GetOrganizationBucketResult.fromMap(Map<String, dynamic> map) {
