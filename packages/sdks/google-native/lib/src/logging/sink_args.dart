...
class SinkArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'outputVersionFormat': ?pulumi.Input.mapOptionalInputValue<SinkOutputVersionFormat, String>(outputVersionFormat, (value) => value.wireValue),
      'project': ?project,
  ...
  factory SinkArgs.fromMap(Map<String, dynamic> map) {
    return SinkArgs(
      bigqueryOptions: (() { final guardedValue = map['bigqueryOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BigQueryOptions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      exclusions: (() { final guardedValue = map['exclusions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<LogExclusion>(guardedValue, (value) => LogExclusion.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      outputVersionFormat: (() { final guardedValue = map['outputVersionFormat']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SinkOutputVersionFormat.fromValue(guardedValue as String)); })(),
