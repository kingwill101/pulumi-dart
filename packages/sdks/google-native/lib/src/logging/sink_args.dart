...
class SinkArgs {
  ...
  SinkArgs({
    ...
    pulumi.Output<SinkOutputVersionFormat>? outputVersionFormat,
  ...
  factory SinkArgs.fromMap(Map<String, dynamic> map) {
    return SinkArgs(
      ...
      outputVersionFormat: map['outputVersionFormat'] == null ? null : pulumi.Output.create<SinkOutputVersionFormat>(SinkOutputVersionFormat.fromValue(map['outputVersionFormat'] as String)),
