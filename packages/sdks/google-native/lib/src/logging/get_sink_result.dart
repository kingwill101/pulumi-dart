...
class GetSinkResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'disabled': disabled,
      'exclusions': pulumi.Input.encodeList<LogExclusionResponse, Map<String, dynamic>>(exclusions, (value) => value.toMap()),
      'filter': filter,
  ...
  factory GetSinkResult.fromMap(Map<String, dynamic> map) {
    return GetSinkResult(
      bigqueryOptions: BigQueryOptionsResponse.fromMap((map['bigqueryOptions']! as Map).cast<String, dynamic>()),
      createTime: map['createTime'] as String,
      description: map['description'] as String,
      destination: map['destination'] as String,
      disabled: map['disabled'] as bool,
      exclusions: pulumi.Input.decodeList<LogExclusionResponse>(map['exclusions']!, (value) => LogExclusionResponse.fromMap((value as Map).cast<String, dynamic>())),
