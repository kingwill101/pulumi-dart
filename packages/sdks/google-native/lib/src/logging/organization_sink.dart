...
class OrganizationSink extends pulumi.CustomResource {
  ...
  late final pulumi.Output<BigQueryOptionsResponse> bigqueryOptions;
  ...
  late final pulumi.Output<String> outputVersionFormat;
  ...
  /// Creates a new [OrganizationSink].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [OrganizationSink]. {@macro pulumi_logging_v2_organization_sink_args_doc}
  ...
  OrganizationSink(
    ...
    bigqueryOptions = registerOutput<BigQueryOptionsResponse>('bigqueryOptions', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return BigQueryOptionsResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    outputVersionFormat = registerOutput<String>('outputVersionFormat');
