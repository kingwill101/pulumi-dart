...
class FolderSinkArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'outputVersionFormat': ?pulumi.Input.mapOptionalInputValue<FolderSinkOutputVersionFormat, String>(outputVersionFormat, (value) => value.wireValue),
  ...
  factory FolderSinkArgs.fromMap(Map<String, dynamic> map) {
    return FolderSinkArgs(
      ...
      outputVersionFormat: (() { final guardedValue = map['outputVersionFormat']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FolderSinkOutputVersionFormat.fromValue(guardedValue as String)); })(),
