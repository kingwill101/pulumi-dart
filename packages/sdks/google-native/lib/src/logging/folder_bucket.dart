...
import 'folder_bucket_args.dart';
import 'index_config_response.dart';

/// Creates a log bucket that can be used to store log entries. After a bucket has been created, the bucket's location cannot be changed.
/// Auto-naming is currently not supported for this resource.
class FolderBucket extends pulumi.CustomResource {
  ...
  /// Creates a new [FolderBucket].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [FolderBucket]. {@macro pulumi_logging_v2_folder_bucket_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  FolderBucket(
    String name, {
    FolderBucketArgs? args,
