...
class OrganizationSinkArgs {
  ...
  OrganizationSinkArgs({
    ...
    pulumi.Output<OrganizationSinkOutputVersionFormat>? outputVersionFormat,
    pulumi.Output<bool>? uniqueWriterIdentity,
      ...
      outputVersionFormat = pulumi.Input.asOptionalInput<OrganizationSinkOutputVersionFormat>(outputVersionFormat),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'outputVersionFormat': ?pulumi.Input.mapOptionalInputValue<OrganizationSinkOutputVersionFormat, String>(outputVersionFormat, (value) => value.value),
  ...
  factory OrganizationSinkArgs.fromMap(Map<String, dynamic> map) {
    return OrganizationSinkArgs(
      ...
      outputVersionFormat: map['outputVersionFormat'] == null ? null : pulumi.Output.create<OrganizationSinkOutputVersionFormat>(OrganizationSinkOutputVersionFormat.fromValue(map['outputVersionFormat'] as String)),
