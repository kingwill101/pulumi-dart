...
class OrganizationSinkArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'outputVersionFormat': ?pulumi.Input.mapOptionalInputValue<OrganizationSinkOutputVersionFormat, String>(outputVersionFormat, (value) => value.wireValue),
  ...
  factory OrganizationSinkArgs.fromMap(Map<String, dynamic> map) {
    return OrganizationSinkArgs(
      ...
      outputVersionFormat: (() { final guardedValue = map['outputVersionFormat']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OrganizationSinkOutputVersionFormat.fromValue(guardedValue as String)); })(),
