...
class MetricArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'version': ?pulumi.Input.mapOptionalInputValue<MetricVersion, String>(version, (value) => value.wireValue),
    };
  }
  ...
  factory MetricArgs.fromMap(Map<String, dynamic> map) {
    return MetricArgs(
      ...
      bucketOptions: (() { final guardedValue = map['bucketOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BucketOptions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      metricDescriptor: (() { final guardedValue = map['metricDescriptor']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MetricDescriptor.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      version: (() { final guardedValue = map['version']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MetricVersion.fromValue(guardedValue as String)); })(),
    );
  }
}
