...
/// Result data returned by getOrganizationExclusion.
class GetOrganizationExclusionResult {
  ...
  /// Creates a new [GetOrganizationExclusionResult].
  ...
  const GetOrganizationExclusionResult({
  ...
  factory GetOrganizationExclusionResult.fromMap(Map<String, dynamic> map) {
