...
class BillingAccountBucketLink extends pulumi.CustomResource {
  ...
  /// Creates a new [BillingAccountBucketLink].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [BillingAccountBucketLink]. {@macro pulumi_logging_v2_billing_account_bucket_link_args_doc}
  ...
  BillingAccountBucketLink(
    ...
    bigqueryDataset = registerOutput<BigQueryDatasetResponse>('bigqueryDataset', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return BigQueryDatasetResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
