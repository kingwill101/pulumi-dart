...
/// Result data returned by getFolderBucket.
class GetFolderBucketResult {
  ...
  /// Creates a new [GetFolderBucketResult].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'indexConfigs': pulumi.Input.encodeList<IndexConfigResponse, Map<String, dynamic>>(indexConfigs, (value) => value.toMap()),
  ...
  factory GetFolderBucketResult.fromMap(Map<String, dynamic> map) {
    return GetFolderBucketResult(
      analyticsEnabled: map['analyticsEnabled'] as bool,
      cmekSettings: CmekSettingsResponse.fromMap((map['cmekSettings']! as Map).cast<String, dynamic>()),
      createTime: map['createTime'] as String,
      description: map['description'] as String,
      indexConfigs: pulumi.Input.decodeList<IndexConfigResponse>(map['indexConfigs']!, (value) => IndexConfigResponse.fromMap((value as Map).cast<String, dynamic>())),
