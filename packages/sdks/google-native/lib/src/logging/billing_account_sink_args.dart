...
class BillingAccountSinkArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'outputVersionFormat': ?pulumi.Input.mapOptionalInputValue<BillingAccountSinkOutputVersionFormat, String>(outputVersionFormat, (value) => value.wireValue),
  ...
  factory BillingAccountSinkArgs.fromMap(Map<String, dynamic> map) {
    return BillingAccountSinkArgs(
      ...
      outputVersionFormat: (() { final guardedValue = map['outputVersionFormat']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BillingAccountSinkOutputVersionFormat.fromValue(guardedValue as String)); })(),
