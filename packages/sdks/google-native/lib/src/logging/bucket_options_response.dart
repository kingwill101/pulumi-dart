...
class BucketOptionsResponse {
  ...
  factory BucketOptionsResponse.fromMap(Map<String, dynamic> map) {
    return BucketOptionsResponse(
      explicitBuckets: (ExplicitResponse.fromMap((map['explicitBuckets'] as Map).cast<String, dynamic>())).input(),
      exponentialBuckets: (ExponentialResponse.fromMap((map['exponentialBuckets'] as Map).cast<String, dynamic>())).input(),
      linearBuckets: (LinearResponse.fromMap((map['linearBuckets'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
