...
class GetMetricResult {
  ...
  /// [createTime] The creation timestamp of the metric.This field may not be present for older metrics.
  ...
  /// [updateTime] The last update timestamp of the metric.This field may not be present for older metrics.
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'bucketOptions': bucketOptions.toMap(),
      'createTime': createTime,
      'description': description,
      'disabled': disabled,
      'filter': filter,
      'labelExtractors': labelExtractors,
      'metricDescriptor': metricDescriptor.toMap(),
      'name': name,
  ...
  factory GetMetricResult.fromMap(Map<String, dynamic> map) {
    return GetMetricResult(
      ...
      bucketOptions: BucketOptionsResponse.fromMap((map['bucketOptions']! as Map).cast<String, dynamic>()),
      createTime: map['createTime'] as String,
      description: map['description'] as String,
      disabled: map['disabled'] as bool,
      filter: map['filter'] as String,
      labelExtractors: (map['labelExtractors'] as Map).cast<String, String>(),
      metricDescriptor: MetricDescriptorResponse.fromMap((map['metricDescriptor']! as Map).cast<String, dynamic>()),
