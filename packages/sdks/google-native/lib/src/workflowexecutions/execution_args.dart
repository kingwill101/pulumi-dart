...
class ExecutionArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'argument': ?argument,
      'callLogLevel': ?pulumi.Input.mapOptionalInputValue<ExecutionCallLogLevel, String>(callLogLevel, (value) => value.wireValue),
      'labels': ?labels,
      'location': ?location,
      'project': ?project,
  ...
  factory ExecutionArgs.fromMap(Map<String, dynamic> map) {
    return ExecutionArgs(
      ...
      callLogLevel: (() { final guardedValue = map['callLogLevel']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ExecutionCallLogLevel.fromValue(guardedValue as String)); })(),
