...
class StackTraceResponseWorkflowexecutionsV1beta {
  ...
  factory StackTraceResponseWorkflowexecutionsV1beta.fromMap(Map<String, dynamic> map) {
    return StackTraceResponseWorkflowexecutionsV1beta(
      elements: (pulumi.Input.decodeList<StackTraceElementResponseWorkflowexecutionsV1beta>(map['elements'], (value) => StackTraceElementResponseWorkflowexecutionsV1beta.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
