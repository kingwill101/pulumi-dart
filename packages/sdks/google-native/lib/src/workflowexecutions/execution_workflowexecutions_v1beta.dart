...
class ExecutionWorkflowexecutionsV1beta extends pulumi.CustomResource {
  ...
  ExecutionWorkflowexecutionsV1beta(
    ...
    error = registerOutput<ErrorResponseWorkflowexecutionsV1beta>('error', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ErrorResponseWorkflowexecutionsV1beta.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    status = registerOutput<StatusResponseWorkflowexecutionsV1beta>('status', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return StatusResponseWorkflowexecutionsV1beta.fromMap((guardedValue as Map).cast<String, dynamic>()); });
