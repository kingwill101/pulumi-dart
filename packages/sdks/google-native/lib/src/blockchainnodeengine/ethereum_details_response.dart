...
class EthereumDetailsResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'gethDetails':
          pulumi.Input.mapInputValue<GethDetailsResponse, Map<String, dynamic>>(
            gethDetails,
            (value) => value.toMap(),
          ),
      'network': network,
  ...
  factory EthereumDetailsResponse.fromMap(Map<String, dynamic> map) {
    return EthereumDetailsResponse(
      additionalEndpoints: pulumi.Input.fromValue(
        EthereumEndpointsResponse.fromMap(
      ...
      beaconFeeRecipient: pulumi.Input.fromValue(
      ...
      gethDetails: pulumi.Input.fromValue(
        GethDetailsResponse.fromMap(
