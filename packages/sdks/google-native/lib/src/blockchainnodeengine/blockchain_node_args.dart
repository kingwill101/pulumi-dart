...
class BlockchainNodeArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'blockchainType': ?pulumi.Input.mapOptionalInputValue<BlockchainNodeBlockchainType, String>(blockchainType, (value) => value.wireValue),
  ...
  factory BlockchainNodeArgs.fromMap(Map<String, dynamic> map) {
    return BlockchainNodeArgs(
      ...
      blockchainType: (() { final guardedValue = map['blockchainType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BlockchainNodeBlockchainType.fromValue(guardedValue as String)); })(),
      ethereumDetails: (() { final guardedValue = map['ethereumDetails']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EthereumDetails.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      labels: (() { final guardedValue = map['labels']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      location: (() { final guardedValue = map['location']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      privateServiceConnectEnabled: (() { final guardedValue = map['privateServiceConnectEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
