...
class BlockchainNode extends pulumi.CustomResource {
  ...
  BlockchainNode(
    ...
    this.connectionInfo = registerOutput<ConnectionInfoResponse>('connectionInfo');
    this.createTime = registerOutput<String>('createTime');
    this.ethereumDetails = registerOutput<EthereumDetailsResponse>('ethereumDetails');
    this.labels = registerOutput<Map<String, String>>('labels');
    this.location = registerOutput<String>('location');
    this.name = registerOutput<String>('name');
    this.privateServiceConnectEnabled = registerOutput<bool>('privateServiceConnectEnabled');
