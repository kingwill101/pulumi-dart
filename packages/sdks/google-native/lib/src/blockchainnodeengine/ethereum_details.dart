...
class EthereumDetails {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'consensusClient': ?consensusClient == null ? null : consensusClient!.value,
      'executionClient': ?executionClient == null ? null : executionClient!.value,
  ...
  factory EthereumDetails.fromMap(Map<String, dynamic> map) {
    return EthereumDetails(
      ...
      beaconFeeRecipient: map['beaconFeeRecipient'] == null ? null : map['beaconFeeRecipient'] as String,
      consensusClient: map['consensusClient'] == null ? null : EthereumDetailsConsensusClient.fromValue(map['consensusClient'] as String),
      executionClient: map['executionClient'] == null ? null : EthereumDetailsExecutionClient.fromValue(map['executionClient'] as String),
      gethDetails: map['gethDetails'] == null ? null : GethDetails.fromMap((map['gethDetails'] as Map).cast<String, dynamic>()),
      network: map['network'] == null ? null : EthereumDetailsNetwork.fromValue(map['network'] as String),
      nodeType: map['nodeType'] == null ? null : EthereumDetailsNodeType.fromValue(map['nodeType'] as String),
    );
  }
}
