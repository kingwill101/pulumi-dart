...
class EthereumDetails {
    ...
    return <String, dynamic>{
      ...
      'consensusClient':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(consensusClient, (value) => value.wireValue),
      'executionClient':
          ?pulumi.Input.mapOptionalInputValue<
            EthereumDetailsExecutionClient,
            String
          >(executionClient, (value) => value.wireValue),
      'gethDetails':
          ?pulumi.Input.mapOptionalInputValue<
            GethDetails,
            Map<String, dynamic>
      ...
      'network':
          ?pulumi.Input.mapOptionalInputValue<EthereumDetailsNetwork, String>(
            network,
            (value) => value.wireValue,
          ),
      'nodeType':
          ?pulumi.Input.mapOptionalInputValue<EthereumDetailsNodeType, String>(
            nodeType,
            (value) => value.wireValue,
          ),
    };
  ...
  factory EthereumDetails.fromMap(Map<String, dynamic> map) {
    return EthereumDetails(
      ...
      beaconFeeRecipient: (() {
        final guardedValue = map['beaconFeeRecipient'];
        if (guardedValue == null) return null;
      ...
      consensusClient: (() {
        ...
        return pulumi.Input.fromValue(
          EthereumDetailsConsensusClient.fromValue(guardedValue as String),
        );
      })(),
      executionClient: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          EthereumDetailsExecutionClient.fromValue(guardedValue as String),
        );
      })(),
      gethDetails: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GethDetails.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      network: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          EthereumDetailsNetwork.fromValue(guardedValue as String),
        );
      })(),
      nodeType: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          EthereumDetailsNodeType.fromValue(guardedValue as String),
        );
      })(),
    );
  }
