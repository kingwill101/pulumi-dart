...
class Engine extends pulumi.CustomResource {
  ...
  Engine(
    ...
    this.chatEngineConfig = registerOutput<GoogleCloudDiscoveryengineV1alphaEngineChatEngineConfigResponse>('chatEngineConfig');
    this.chatEngineMetadata = registerOutput<GoogleCloudDiscoveryengineV1alphaEngineChatEngineMetadataResponse>('chatEngineMetadata');
    this.collectionId = registerOutput<String>('collectionId');
    this.commonConfig = registerOutput<GoogleCloudDiscoveryengineV1alphaEngineCommonConfigResponse>('commonConfig');
    ...
    this.mediaRecommendationEngineConfig = registerOutput<GoogleCloudDiscoveryengineV1alphaEngineMediaRecommendationEngineConfigResponse>('mediaRecommendationEngineConfig');
    this.name = registerOutput<String>('name');
    this.project = registerOutput<String>('project');
    this.recommendationMetadata = registerOutput<GoogleCloudDiscoveryengineV1alphaEngineRecommendationMetadataResponse>('recommendationMetadata');
    this.searchEngineConfig = registerOutput<GoogleCloudDiscoveryengineV1alphaEngineSearchEngineConfigResponse>('searchEngineConfig');
    this.similarDocumentsConfig = registerOutput<Map<String, dynamic>>('similarDocumentsConfig');
