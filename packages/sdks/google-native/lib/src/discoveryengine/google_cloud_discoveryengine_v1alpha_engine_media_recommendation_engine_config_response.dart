...
class GoogleCloudDiscoveryengineV1alphaEngineMediaRecommendationEngineConfigResponse {
  ...
  final GoogleCloudDiscoveryengineV1alphaEngineMediaRecommendationEngineConfigOptimizationObjectiveConfigResponse optimizationObjectiveConfig;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'optimizationObjectiveConfig': optimizationObjectiveConfig.toMap(),
  ...
  factory GoogleCloudDiscoveryengineV1alphaEngineMediaRecommendationEngineConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDiscoveryengineV1alphaEngineMediaRecommendationEngineConfigResponse(
      ...
      optimizationObjectiveConfig: GoogleCloudDiscoveryengineV1alphaEngineMediaRecommendationEngineConfigOptimizationObjectiveConfigResponse.fromMap((map['optimizationObjectiveConfig'] as Map).cast<String, dynamic>()),
