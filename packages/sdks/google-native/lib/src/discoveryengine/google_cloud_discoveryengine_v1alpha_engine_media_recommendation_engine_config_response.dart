...
class GoogleCloudDiscoveryengineV1alphaEngineMediaRecommendationEngineConfigResponse {
  ...
  factory GoogleCloudDiscoveryengineV1alphaEngineMediaRecommendationEngineConfigResponse.fromMap(
    ...
    return GoogleCloudDiscoveryengineV1alphaEngineMediaRecommendationEngineConfigResponse(
      optimizationObjective: pulumi.Input.fromValue(
        map['optimizationObjective'] as String,
      ),
      optimizationObjectiveConfig: pulumi.Input.fromValue(
        GoogleCloudDiscoveryengineV1alphaEngineMediaRecommendationEngineConfigOptimizationObjectiveConfigResponse.fromMap(
          (map['optimizationObjectiveConfig']! as Map).cast<String, dynamic>(),
        ),
      ),
