...
class GoogleCloudDiscoveryengineV1alphaEngineMediaRecommendationEngineConfigResponse {
  ...
  final pulumi.Input<GoogleCloudDiscoveryengineV1alphaEngineMediaRecommendationEngineConfigOptimizationObjectiveConfigResponse> optimizationObjectiveConfig;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'optimizationObjectiveConfig': pulumi.Input.mapInputValue<GoogleCloudDiscoveryengineV1alphaEngineMediaRecommendationEngineConfigOptimizationObjectiveConfigResponse, Map<String, dynamic>>(optimizationObjectiveConfig, (value) => value.toMap()),
      'trainingState': trainingState,
      'type': type,
    };
  }

  factory GoogleCloudDiscoveryengineV1alphaEngineMediaRecommendationEngineConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDiscoveryengineV1alphaEngineMediaRecommendationEngineConfigResponse(
      optimizationObjective: pulumi.Input.fromValue(map['optimizationObjective'] as String),
      optimizationObjectiveConfig: pulumi.Input.fromValue(GoogleCloudDiscoveryengineV1alphaEngineMediaRecommendationEngineConfigOptimizationObjectiveConfigResponse.fromMap((map['optimizationObjectiveConfig']! as Map).cast<String, dynamic>())),
      trainingState: pulumi.Input.fromValue(map['trainingState'] as String),
