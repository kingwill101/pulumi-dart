...
class GoogleCloudDiscoveryengineV1alphaSearchResponseSummary {
  ...
  factory GoogleCloudDiscoveryengineV1alphaSearchResponseSummary.fromMap(
    ...
    return GoogleCloudDiscoveryengineV1alphaSearchResponseSummary(
      safetyAttributes: (() {
        final guardedValue = map['safetyAttributes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GoogleCloudDiscoveryengineV1alphaSearchResponseSummarySafetyAttributes.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      summarySkippedReasons: (() {
        final guardedValue = map['summarySkippedReasons'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                GoogleCloudDiscoveryengineV1alphaSearchResponseSummarySummarySkippedReasonsItem.fromValue(
                  value as String,
                ),
          ),
        );
      ...
      summaryText: (() {
        final guardedValue = map['summaryText'];
        if (guardedValue == null) return null;
