...
class DataStoreArgs {
    ...
    return <String, dynamic>{
      ...
      'industryVertical':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(industryVertical, (value) => value.wireValue),
      'location': ?location,
      'name': ?name,
      'project': ?project,
      'solutionTypes':
  ...
  factory DataStoreArgs.fromMap(Map<String, dynamic> map) {
    return DataStoreArgs(
      ...
      contentConfig: (() {
        final guardedValue = map['contentConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DataStoreContentConfig.fromValue(guardedValue as String),
        );
      })(),
      ...
      industryVertical: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DataStoreIndustryVertical.fromValue(guardedValue as String),
        );
      })(),
      location: (() {
