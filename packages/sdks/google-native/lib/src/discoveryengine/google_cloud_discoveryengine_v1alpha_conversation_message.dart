...
class GoogleCloudDiscoveryengineV1alphaConversationMessage {
  ...
  factory GoogleCloudDiscoveryengineV1alphaConversationMessage.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDiscoveryengineV1alphaConversationMessage(
      reply: (() { final guardedValue = map['reply']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDiscoveryengineV1alphaReply.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      userInput: (() { final guardedValue = map['userInput']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDiscoveryengineV1alphaTextInput.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
