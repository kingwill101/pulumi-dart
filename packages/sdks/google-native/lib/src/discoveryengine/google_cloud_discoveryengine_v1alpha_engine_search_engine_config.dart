...
class GoogleCloudDiscoveryengineV1alphaEngineSearchEngineConfig {
    ...
    return <String, dynamic>{
      ...
      'searchTier':
          ?pulumi.Input.mapOptionalInputValue<
            GoogleCloudDiscoveryengineV1alphaEngineSearchEngineConfigSearchTier,
            String
          >(searchTier, (value) => value.wireValue),
    };
  }
  ...
  factory GoogleCloudDiscoveryengineV1alphaEngineSearchEngineConfig.fromMap(
    ...
    return GoogleCloudDiscoveryengineV1alphaEngineSearchEngineConfig(
      searchAddOns: (() {
        final guardedValue = map['searchAddOns'];
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                GoogleCloudDiscoveryengineV1alphaEngineSearchEngineConfigSearchAddOnsItem.fromValue(
                  value as String,
                ),
          ),
        );
      ...
      searchTier: (() {
        final guardedValue = map['searchTier'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GoogleCloudDiscoveryengineV1alphaEngineSearchEngineConfigSearchTier.fromValue(
