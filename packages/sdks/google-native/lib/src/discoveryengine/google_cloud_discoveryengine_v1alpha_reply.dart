...
class GoogleCloudDiscoveryengineV1alphaReply {
  ...
  final pulumi.Input<List<GoogleCloudDiscoveryengineV1alphaReplyReference>>?
  references;
  ...
  final pulumi.Input<GoogleCloudDiscoveryengineV1alphaSearchResponseSummary>?
  summary;
    ...
    return <String, dynamic>{
      'references':
          ?pulumi.Input.mapOptionalInputValue<
            List<GoogleCloudDiscoveryengineV1alphaReplyReference>,
    ...
    return GoogleCloudDiscoveryengineV1alphaReply(
      references: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => GoogleCloudDiscoveryengineV1alphaReplyReference.fromMap(
