...
class GoogleCloudDiscoveryengineV1alphaEngineMediaRecommendationEngineConfig {
  ...
  final GoogleCloudDiscoveryengineV1alphaEngineMediaRecommendationEngineConfigOptimizationObjectiveConfig? optimizationObjectiveConfig;
  ...
  final GoogleCloudDiscoveryengineV1alphaEngineMediaRecommendationEngineConfigTrainingState? trainingState;
  ...
  factory GoogleCloudDiscoveryengineV1alphaEngineMediaRecommendationEngineConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDiscoveryengineV1alphaEngineMediaRecommendationEngineConfig(
      ...
      optimizationObjectiveConfig: map['optimizationObjectiveConfig'] == null ? null : GoogleCloudDiscoveryengineV1alphaEngineMediaRecommendationEngineConfigOptimizationObjectiveConfig.fromMap((map['optimizationObjectiveConfig'] as Map).cast<String, dynamic>()),
      trainingState: map['trainingState'] == null ? null : GoogleCloudDiscoveryengineV1alphaEngineMediaRecommendationEngineConfigTrainingState.fromValue(map['trainingState'] as String),
