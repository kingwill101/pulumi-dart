...
class GoogleCloudDiscoveryengineV1betaTextInput {
  ...
  factory GoogleCloudDiscoveryengineV1betaTextInput.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDiscoveryengineV1betaTextInput(
      context: (() { final guardedValue = map['context']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDiscoveryengineV1betaConversationContext.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
