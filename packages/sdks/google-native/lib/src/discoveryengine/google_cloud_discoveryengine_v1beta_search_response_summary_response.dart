...
class GoogleCloudDiscoveryengineV1betaSearchResponseSummaryResponse {
  ...
  final GoogleCloudDiscoveryengineV1betaSearchResponseSummarySafetyAttributesResponse safetyAttributes;
  ...
  factory GoogleCloudDiscoveryengineV1betaSearchResponseSummaryResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDiscoveryengineV1betaSearchResponseSummaryResponse(
      safetyAttributes: GoogleCloudDiscoveryengineV1betaSearchResponseSummarySafetyAttributesResponse.fromMap((map['safetyAttributes'] as Map).cast<String, dynamic>()),
