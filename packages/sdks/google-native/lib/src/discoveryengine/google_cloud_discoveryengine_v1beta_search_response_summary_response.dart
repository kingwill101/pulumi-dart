...
class GoogleCloudDiscoveryengineV1betaSearchResponseSummaryResponse {
  ...
  factory GoogleCloudDiscoveryengineV1betaSearchResponseSummaryResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDiscoveryengineV1betaSearchResponseSummaryResponse(
      safetyAttributes: (GoogleCloudDiscoveryengineV1betaSearchResponseSummarySafetyAttributesResponse.fromMap((map['safetyAttributes'] as Map).cast<String, dynamic>())).input(),
      summarySkippedReasons: ((map['summarySkippedReasons'] as List).cast<String>()).input(),
      summaryText: (map['summaryText'] as String).input(),
    );
  }
}
