...
class DocumentArgs {
  ...
  factory DocumentArgs.fromMap(Map<String, dynamic> map) {
    return DocumentArgs(
      ...
      content: (() { final guardedValue = map['content']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDiscoveryengineV1alphaDocumentContent.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
