...
/// {@template pulumi_discoveryengine_v1alpha_document_args_doc}
/// The set of arguments for Document.
/// {@endtemplate}
/// {@macro pulumi_discoveryengine_v1alpha_document_args_doc}
class DocumentArgs {
  ...
  DocumentArgs({
    ...
    pulumi.Output<GoogleCloudDiscoveryengineV1alphaDocumentContent>? content,
    ...
    pulumi.Output<Map<String, String>>? structData,
      ...
      content = pulumi.Input.asOptionalInput<GoogleCloudDiscoveryengineV1alphaDocumentContent>(content),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'content': ?pulumi.Input.mapOptionalInputValue<GoogleCloudDiscoveryengineV1alphaDocumentContent, Map<String, dynamic>>(content, (value) => value.toMap()),
  ...
  factory DocumentArgs.fromMap(Map<String, dynamic> map) {
    return DocumentArgs(
      ...
      content: map['content'] == null ? null : pulumi.Output.create<GoogleCloudDiscoveryengineV1alphaDocumentContent>(GoogleCloudDiscoveryengineV1alphaDocumentContent.fromMap((map['content'] as Map).cast<String, dynamic>())),
