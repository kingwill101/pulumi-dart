...
class GoogleCloudDiscoveryengineV1alphaFieldConfigResponse {
  ...
  factory GoogleCloudDiscoveryengineV1alphaFieldConfigResponse.fromMap(
    ...
    return GoogleCloudDiscoveryengineV1alphaFieldConfigResponse(
      completableOption: pulumi.Input.fromValue(
        map['completableOption'] as String,
      ),
      dynamicFacetableOption: pulumi.Input.fromValue(
        map['dynamicFacetableOption'] as String,
      ),
      fieldPath: pulumi.Input.fromValue(map['fieldPath'] as String),
      fieldType: pulumi.Input.fromValue(map['fieldType'] as String),
      indexableOption: pulumi.Input.fromValue(map['indexableOption'] as String),
      keyPropertyType: pulumi.Input.fromValue(map['keyPropertyType'] as String),
      recsFilterableOption: pulumi.Input.fromValue(
        map['recsFilterableOption'] as String,
      ),
      retrievableOption: pulumi.Input.fromValue(
        map['retrievableOption'] as String,
      ),
      searchableOption: pulumi.Input.fromValue(
        map['searchableOption'] as String,
      ),
    );
  }
}
