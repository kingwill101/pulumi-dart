...
class GoogleCloudDiscoveryengineV1alphaFieldConfigResponse {
  ...
  const GoogleCloudDiscoveryengineV1alphaFieldConfigResponse({
  ...
  factory GoogleCloudDiscoveryengineV1alphaFieldConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDiscoveryengineV1alphaFieldConfigResponse(
      completableOption: pulumi.Input.fromValue(map['completableOption'] as String),
      dynamicFacetableOption: pulumi.Input.fromValue(map['dynamicFacetableOption'] as String),
      ...
      recsFilterableOption: pulumi.Input.fromValue(map['recsFilterableOption'] as String),
      retrievableOption: pulumi.Input.fromValue(map['retrievableOption'] as String),
      searchableOption: pulumi.Input.fromValue(map['searchableOption'] as String),
    );
  }
}
