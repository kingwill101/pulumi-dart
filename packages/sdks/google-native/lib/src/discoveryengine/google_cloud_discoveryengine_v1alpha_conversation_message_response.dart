...
class GoogleCloudDiscoveryengineV1alphaConversationMessageResponse {
  ...
  /// User text input.
  final pulumi.Input<GoogleCloudDiscoveryengineV1alphaTextInputResponse>
  userInput;
  ...
  factory GoogleCloudDiscoveryengineV1alphaConversationMessageResponse.fromMap(
    ...
    return GoogleCloudDiscoveryengineV1alphaConversationMessageResponse(
      ...
      reply: pulumi.Input.fromValue(
        GoogleCloudDiscoveryengineV1alphaReplyResponse.fromMap(
          (map['reply']! as Map).cast<String, dynamic>(),
        ),
      ),
      userInput: pulumi.Input.fromValue(
        GoogleCloudDiscoveryengineV1alphaTextInputResponse.fromMap(
