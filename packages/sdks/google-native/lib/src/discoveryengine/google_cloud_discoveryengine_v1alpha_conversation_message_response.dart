...
class GoogleCloudDiscoveryengineV1alphaConversationMessageResponse {
  ...
  factory GoogleCloudDiscoveryengineV1alphaConversationMessageResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDiscoveryengineV1alphaConversationMessageResponse(
      ...
      reply: pulumi.Input.fromValue(GoogleCloudDiscoveryengineV1alphaReplyResponse.fromMap((map['reply']! as Map).cast<String, dynamic>())),
      userInput: pulumi.Input.fromValue(GoogleCloudDiscoveryengineV1alphaTextInputResponse.fromMap((map['userInput']! as Map).cast<String, dynamic>())),
    );
  }
}
