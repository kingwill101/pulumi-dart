...
class GoogleCloudDiscoveryengineV1alphaEngineChatEngineConfig {
  ...
  final pulumi.Input<GoogleCloudDiscoveryengineV1alphaEngineChatEngineConfigAgentCreationConfig>? agentCreationConfig;
  ...
  const GoogleCloudDiscoveryengineV1alphaEngineChatEngineConfig({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'agentCreationConfig': ?pulumi.Input.mapOptionalInputValue<GoogleCloudDiscoveryengineV1alphaEngineChatEngineConfigAgentCreationConfig, Map<String, dynamic>>(agentCreationConfig, (value) => value.toMap()),
  ...
  factory GoogleCloudDiscoveryengineV1alphaEngineChatEngineConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDiscoveryengineV1alphaEngineChatEngineConfig(
      agentCreationConfig: (() { final guardedValue = map['agentCreationConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDiscoveryengineV1alphaEngineChatEngineConfigAgentCreationConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
