...
class CertificateIssuanceConfig extends pulumi.CustomResource {
  ...
  CertificateIssuanceConfig(
    ...
    this.certificateAuthorityConfig = registerOutput<CertificateAuthorityConfigResponse>('certificateAuthorityConfig');
    this.certificateIssuanceConfigId = registerOutput<String>('certificateIssuanceConfigId');
    ...
    this.rotationWindowPercentage = registerOutput<int>('rotationWindowPercentage');
