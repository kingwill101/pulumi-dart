...
class ManagedCertificateResponse {
  ...
  final pulumi.Input<List<AuthorizationAttemptInfoResponse>>
    ...
    return <String, dynamic>{
      'authorizationAttemptInfo':
          pulumi.Input.mapInputValue<
            List<AuthorizationAttemptInfoResponse>,
      ...
      'provisioningIssue':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(provisioningIssue, (value) => value.toMap()),
      'state': state,
    };
  }
  ...
  factory ManagedCertificateResponse.fromMap(Map<String, dynamic> map) {
    return ManagedCertificateResponse(
      authorizationAttemptInfo: pulumi.Input.fromValue(
        pulumi.Input.decodeList<AuthorizationAttemptInfoResponse>(
      ...
      dnsAuthorizations: pulumi.Input.fromValue(
      ...
      provisioningIssue: pulumi.Input.fromValue(
        ProvisioningIssueResponse.fromMap(
