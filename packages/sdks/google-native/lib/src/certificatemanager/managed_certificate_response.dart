...
class ManagedCertificateResponse {
  ...
  factory ManagedCertificateResponse.fromMap(Map<String, dynamic> map) {
    return ManagedCertificateResponse(
      authorizationAttemptInfo: pulumi.Input.fromValue(pulumi.Input.decodeList<AuthorizationAttemptInfoResponse>(map['authorizationAttemptInfo']!, (value) => AuthorizationAttemptInfoResponse.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      provisioningIssue: pulumi.Input.fromValue(ProvisioningIssueResponse.fromMap((map['provisioningIssue']! as Map).cast<String, dynamic>())),
