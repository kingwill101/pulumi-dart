...
class GetTrustConfigResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'labels': labels,
      'name': name,
      'trustStores': pulumi.Input.encodeList<TrustStoreResponse, Map<String, dynamic>>(trustStores, (value) => value.toMap()),
  ...
  factory GetTrustConfigResult.fromMap(Map<String, dynamic> map) {
    return GetTrustConfigResult(
      ...
      trustStores: pulumi.Input.decodeList<TrustStoreResponse>(map['trustStores']!, (value) => TrustStoreResponse.fromMap((value as Map).cast<String, dynamic>())),
