...
class EnterpriseCrmEventbusProtoTaskUiConfig {
  ...
  const EnterpriseCrmEventbusProtoTaskUiConfig({
  ...
  factory EnterpriseCrmEventbusProtoTaskUiConfig.fromMap(Map<String, dynamic> map) {
    return EnterpriseCrmEventbusProtoTaskUiConfig(
      taskUiModuleConfigs: (() { final guardedValue = map['taskUiModuleConfigs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<EnterpriseCrmEventbusProtoTaskUiModuleConfig>(guardedValue, (value) => EnterpriseCrmEventbusProtoTaskUiModuleConfig.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
