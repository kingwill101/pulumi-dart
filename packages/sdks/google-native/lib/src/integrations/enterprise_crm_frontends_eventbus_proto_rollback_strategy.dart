...
class EnterpriseCrmFrontendsEventbusProtoRollbackStrategy {
  ...
  factory EnterpriseCrmFrontendsEventbusProtoRollbackStrategy.fromMap(Map<String, dynamic> map) {
    return EnterpriseCrmFrontendsEventbusProtoRollbackStrategy(
      parameters: (() { final guardedValue = map['parameters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EnterpriseCrmFrontendsEventbusProtoEventParameters.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
