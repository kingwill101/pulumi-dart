...
class EnterpriseCrmEventbusProtoParameterEntry {
  ...
  const EnterpriseCrmEventbusProtoParameterEntry({
    this.key,
    this.value,
  });
  ...
  factory EnterpriseCrmEventbusProtoParameterEntry.fromMap(Map<String, dynamic> map) {
    return EnterpriseCrmEventbusProtoParameterEntry(
      ...
      value: (() { final guardedValue = map['value']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EnterpriseCrmEventbusProtoParameterValueType.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
