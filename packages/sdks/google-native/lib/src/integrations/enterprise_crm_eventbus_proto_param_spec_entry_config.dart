...
class EnterpriseCrmEventbusProtoParamSpecEntryConfig {
  ...
  const EnterpriseCrmEventbusProtoParamSpecEntryConfig({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'inputDisplayOption': ?pulumi.Input.mapOptionalInputValue<EnterpriseCrmEventbusProtoParamSpecEntryConfigInputDisplayOption, String>(inputDisplayOption, (value) => value.wireValue),
      'isHidden': ?isHidden,
      'label': ?label,
      'parameterNameOption': ?pulumi.Input.mapOptionalInputValue<EnterpriseCrmEventbusProtoParamSpecEntryConfigParameterNameOption, String>(parameterNameOption, (value) => value.wireValue),
  ...
  factory EnterpriseCrmEventbusProtoParamSpecEntryConfig.fromMap(Map<String, dynamic> map) {
    return EnterpriseCrmEventbusProtoParamSpecEntryConfig(
      descriptivePhrase: (() { final guardedValue = map['descriptivePhrase']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      helpText: (() { final guardedValue = map['helpText']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      hideDefaultValue: (() { final guardedValue = map['hideDefaultValue']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      inputDisplayOption: (() { final guardedValue = map['inputDisplayOption']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EnterpriseCrmEventbusProtoParamSpecEntryConfigInputDisplayOption.fromValue(guardedValue as String)); })(),
      ...
      parameterNameOption: (() { final guardedValue = map['parameterNameOption']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EnterpriseCrmEventbusProtoParamSpecEntryConfigParameterNameOption.fromValue(guardedValue as String)); })(),
      subSectionLabel: (() { final guardedValue = map['subSectionLabel']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      uiPlaceholderText: (() { final guardedValue = map['uiPlaceholderText']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
