...
class GoogleCloudIntegrationsV1alphaAssertion {
  ...
  final pulumi.Input<GoogleCloudIntegrationsV1alphaAssertionAssertionStrategy>?
  assertionStrategy;
    ...
    return <String, dynamic>{
      'assertionStrategy':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(assertionStrategy, (value) => value.wireValue),
      'condition': ?condition,
      'parameter':
          ?pulumi.Input.mapOptionalInputValue<
  ...
  factory GoogleCloudIntegrationsV1alphaAssertion.fromMap(
    ...
    return GoogleCloudIntegrationsV1alphaAssertion(
      assertionStrategy: (() {
        final guardedValue = map['assertionStrategy'];
