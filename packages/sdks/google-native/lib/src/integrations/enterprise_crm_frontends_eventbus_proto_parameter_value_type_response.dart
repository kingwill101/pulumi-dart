...
class EnterpriseCrmFrontendsEventbusProtoParameterValueTypeResponse {
  ...
  const EnterpriseCrmFrontendsEventbusProtoParameterValueTypeResponse({
  ...
  factory EnterpriseCrmFrontendsEventbusProtoParameterValueTypeResponse.fromMap(Map<String, dynamic> map) {
    return EnterpriseCrmFrontendsEventbusProtoParameterValueTypeResponse(
      booleanArray: pulumi.Input.fromValue(EnterpriseCrmFrontendsEventbusProtoBooleanParameterArrayResponse.fromMap((map['booleanArray']! as Map).cast<String, dynamic>())),
      booleanValue: pulumi.Input.fromValue(map['booleanValue'] as bool),
      doubleArray: pulumi.Input.fromValue(EnterpriseCrmFrontendsEventbusProtoDoubleParameterArrayResponse.fromMap((map['doubleArray']! as Map).cast<String, dynamic>())),
      doubleValue: pulumi.Input.fromValue(map['doubleValue'] as double),
      intArray: pulumi.Input.fromValue(EnterpriseCrmFrontendsEventbusProtoIntParameterArrayResponse.fromMap((map['intArray']! as Map).cast<String, dynamic>())),
      intValue: pulumi.Input.fromValue(map['intValue'] as String),
      jsonValue: pulumi.Input.fromValue(map['jsonValue'] as String),
      protoArray: pulumi.Input.fromValue(EnterpriseCrmFrontendsEventbusProtoProtoParameterArrayResponse.fromMap((map['protoArray']! as Map).cast<String, dynamic>())),
      protoValue: pulumi.Input.fromValue((map['protoValue'] as Map).cast<String, String>()),
      serializedObjectValue: pulumi.Input.fromValue(EnterpriseCrmFrontendsEventbusProtoSerializedObjectParameterResponse.fromMap((map['serializedObjectValue']! as Map).cast<String, dynamic>())),
      stringArray: pulumi.Input.fromValue(EnterpriseCrmFrontendsEventbusProtoStringParameterArrayResponse.fromMap((map['stringArray']! as Map).cast<String, dynamic>())),
