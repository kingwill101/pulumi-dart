...
class GoogleCloudIntegrationsV1alphaCredentialResponse {
  ...
  final GoogleCloudIntegrationsV1alphaOAuth2AuthorizationCodeResponse oauth2AuthorizationCode;
  /// OAuth2Implicit oauth2_implicit = 5; OAuth2 client credentials
  final GoogleCloudIntegrationsV1alphaOAuth2ClientCredentialsResponse oauth2ClientCredentials;
  /// OAuth2 resource owner credentials
  final GoogleCloudIntegrationsV1alphaOAuth2ResourceOwnerCredentialsResponse oauth2ResourceOwnerCredentials;
  /// Google OIDC ID Token
  final GoogleCloudIntegrationsV1alphaOidcTokenResponse oidcToken;
  /// Service account credential
  final GoogleCloudIntegrationsV1alphaServiceAccountCredentialsResponse serviceAccountCredentials;
  /// Username and password credential
  final GoogleCloudIntegrationsV1alphaUsernameAndPasswordResponse usernameAndPassword;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'jwt': jwt.toMap(),
      'oauth2AuthorizationCode': oauth2AuthorizationCode.toMap(),
      'oauth2ClientCredentials': oauth2ClientCredentials.toMap(),
      'oauth2ResourceOwnerCredentials': oauth2ResourceOwnerCredentials.toMap(),
      'oidcToken': oidcToken.toMap(),
      'serviceAccountCredentials': serviceAccountCredentials.toMap(),
      'usernameAndPassword': usernameAndPassword.toMap(),
    };
  }
  ...
  factory GoogleCloudIntegrationsV1alphaCredentialResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudIntegrationsV1alphaCredentialResponse(
      authToken: GoogleCloudIntegrationsV1alphaAuthTokenResponse.fromMap((map['authToken'] as Map).cast<String, dynamic>()),
      credentialType: map['credentialType'] as String,
      jwt: GoogleCloudIntegrationsV1alphaJwtResponse.fromMap((map['jwt'] as Map).cast<String, dynamic>()),
      oauth2AuthorizationCode: GoogleCloudIntegrationsV1alphaOAuth2AuthorizationCodeResponse.fromMap((map['oauth2AuthorizationCode'] as Map).cast<String, dynamic>()),
      oauth2ClientCredentials: GoogleCloudIntegrationsV1alphaOAuth2ClientCredentialsResponse.fromMap((map['oauth2ClientCredentials'] as Map).cast<String, dynamic>()),
      oauth2ResourceOwnerCredentials: GoogleCloudIntegrationsV1alphaOAuth2ResourceOwnerCredentialsResponse.fromMap((map['oauth2ResourceOwnerCredentials'] as Map).cast<String, dynamic>()),
      oidcToken: GoogleCloudIntegrationsV1alphaOidcTokenResponse.fromMap((map['oidcToken'] as Map).cast<String, dynamic>()),
      serviceAccountCredentials: GoogleCloudIntegrationsV1alphaServiceAccountCredentialsResponse.fromMap((map['serviceAccountCredentials'] as Map).cast<String, dynamic>()),
      usernameAndPassword: GoogleCloudIntegrationsV1alphaUsernameAndPasswordResponse.fromMap((map['usernameAndPassword'] as Map).cast<String, dynamic>()),
    );
  }
}
