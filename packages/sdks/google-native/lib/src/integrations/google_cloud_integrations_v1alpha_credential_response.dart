...
class GoogleCloudIntegrationsV1alphaCredentialResponse {
  ...
  final pulumi.Input<GoogleCloudIntegrationsV1alphaUsernameAndPasswordResponse>
  usernameAndPassword;
  ...
  factory GoogleCloudIntegrationsV1alphaCredentialResponse.fromMap(
    ...
    return GoogleCloudIntegrationsV1alphaCredentialResponse(
      authToken: pulumi.Input.fromValue(
        GoogleCloudIntegrationsV1alphaAuthTokenResponse.fromMap(
      ...
      jwt: pulumi.Input.fromValue(
        GoogleCloudIntegrationsV1alphaJwtResponse.fromMap(
          (map['jwt']! as Map).cast<String, dynamic>(),
        ),
      ),
      oauth2AuthorizationCode: pulumi.Input.fromValue(
      ...
      oauth2ClientCredentials: pulumi.Input.fromValue(
      ...
      oauth2ResourceOwnerCredentials: pulumi.Input.fromValue(
        GoogleCloudIntegrationsV1alphaOAuth2ResourceOwnerCredentialsResponse.fromMap(
          (map['oauth2ResourceOwnerCredentials']! as Map)
              .cast<String, dynamic>(),
        ),
      ),
      oidcToken: pulumi.Input.fromValue(
        GoogleCloudIntegrationsV1alphaOidcTokenResponse.fromMap(
          (map['oidcToken']! as Map).cast<String, dynamic>(),
        ),
      ),
      serviceAccountCredentials: pulumi.Input.fromValue(
        GoogleCloudIntegrationsV1alphaServiceAccountCredentialsResponse.fromMap(
          (map['serviceAccountCredentials']! as Map).cast<String, dynamic>(),
        ),
      ),
      usernameAndPassword: pulumi.Input.fromValue(
