...
class GoogleCloudIntegrationsV1alphaCredentialResponse {
  ...
  factory GoogleCloudIntegrationsV1alphaCredentialResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudIntegrationsV1alphaCredentialResponse(
      authToken: (GoogleCloudIntegrationsV1alphaAuthTokenResponse.fromMap((map['authToken'] as Map).cast<String, dynamic>())).input(),
      credentialType: (map['credentialType'] as String).input(),
      jwt: (GoogleCloudIntegrationsV1alphaJwtResponse.fromMap((map['jwt'] as Map).cast<String, dynamic>())).input(),
      oauth2AuthorizationCode: (GoogleCloudIntegrationsV1alphaOAuth2AuthorizationCodeResponse.fromMap((map['oauth2AuthorizationCode'] as Map).cast<String, dynamic>())).input(),
      oauth2ClientCredentials: (GoogleCloudIntegrationsV1alphaOAuth2ClientCredentialsResponse.fromMap((map['oauth2ClientCredentials'] as Map).cast<String, dynamic>())).input(),
      oauth2ResourceOwnerCredentials: (GoogleCloudIntegrationsV1alphaOAuth2ResourceOwnerCredentialsResponse.fromMap((map['oauth2ResourceOwnerCredentials'] as Map).cast<String, dynamic>())).input(),
      oidcToken: (GoogleCloudIntegrationsV1alphaOidcTokenResponse.fromMap((map['oidcToken'] as Map).cast<String, dynamic>())).input(),
      serviceAccountCredentials: (GoogleCloudIntegrationsV1alphaServiceAccountCredentialsResponse.fromMap((map['serviceAccountCredentials'] as Map).cast<String, dynamic>())).input(),
      usernameAndPassword: (GoogleCloudIntegrationsV1alphaUsernameAndPasswordResponse.fromMap((map['usernameAndPassword'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
