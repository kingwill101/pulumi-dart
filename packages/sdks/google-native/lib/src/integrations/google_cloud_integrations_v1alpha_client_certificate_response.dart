...
class GoogleCloudIntegrationsV1alphaClientCertificateResponse {
  ...
  /// Creates a new [GoogleCloudIntegrationsV1alphaClientCertificateResponse].
  ...
  const GoogleCloudIntegrationsV1alphaClientCertificateResponse({
  ...
  factory GoogleCloudIntegrationsV1alphaClientCertificateResponse.fromMap(Map<String, dynamic> map) {
