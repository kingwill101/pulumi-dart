...
class AuthConfigArgs {
  ...
  AuthConfigArgs({
    ...
    pulumi.Output<String>? clientCertificateEncryptedPrivateKey,
    pulumi.Output<String>? clientCertificatePassphrase,
    pulumi.Output<String>? clientCertificateSslCertificate,
    pulumi.Output<String>? creatorEmail,
    pulumi.Output<AuthConfigCredentialType>? credentialType,
    pulumi.Output<GoogleCloudIntegrationsV1alphaCredential>? decryptedCredential,
    pulumi.Output<String>? description,
    required pulumi.Output<String> displayName,
    pulumi.Output<String>? encryptedCredential,
    pulumi.Output<List<String>>? expiryNotificationDuration,
    ...
    pulumi.Output<AuthConfigState>? state,
    pulumi.Output<String>? validTime,
    pulumi.Output<AuthConfigVisibility>? visibility,
  }) :
      certificateId = pulumi.Input.asOptionalInput<String>(certificateId),
      clientCertificateEncryptedPrivateKey = pulumi.Input.asOptionalInput<String>(clientCertificateEncryptedPrivateKey),
      clientCertificatePassphrase = pulumi.Input.asOptionalInput<String>(clientCertificatePassphrase),
      clientCertificateSslCertificate = pulumi.Input.asOptionalInput<String>(clientCertificateSslCertificate),
      creatorEmail = pulumi.Input.asOptionalInput<String>(creatorEmail),
      credentialType = pulumi.Input.asOptionalInput<AuthConfigCredentialType>(credentialType),
      decryptedCredential = pulumi.Input.asOptionalInput<GoogleCloudIntegrationsV1alphaCredential>(decryptedCredential),
      description = pulumi.Input.asOptionalInput<String>(description),
      displayName = pulumi.Input.asInput<String>(displayName),
      encryptedCredential = pulumi.Input.asOptionalInput<String>(encryptedCredential),
      expiryNotificationDuration = pulumi.Input.asOptionalInput<List<String>>(expiryNotificationDuration),
      ...
      visibility = pulumi.Input.asOptionalInput<AuthConfigVisibility>(visibility);
  ...
  factory AuthConfigArgs.fromMap(Map<String, dynamic> map) {
    return AuthConfigArgs(
      ...
      clientCertificateEncryptedPrivateKey: map['clientCertificateEncryptedPrivateKey'] == null ? null : pulumi.Output.create<String>(map['clientCertificateEncryptedPrivateKey'] as String),
      clientCertificatePassphrase: map['clientCertificatePassphrase'] == null ? null : pulumi.Output.create<String>(map['clientCertificatePassphrase'] as String),
      clientCertificateSslCertificate: map['clientCertificateSslCertificate'] == null ? null : pulumi.Output.create<String>(map['clientCertificateSslCertificate'] as String),
      creatorEmail: map['creatorEmail'] == null ? null : pulumi.Output.create<String>(map['creatorEmail'] as String),
      credentialType: map['credentialType'] == null ? null : pulumi.Output.create<AuthConfigCredentialType>(AuthConfigCredentialType.fromValue(map['credentialType'] as String)),
      decryptedCredential: map['decryptedCredential'] == null ? null : pulumi.Output.create<GoogleCloudIntegrationsV1alphaCredential>(GoogleCloudIntegrationsV1alphaCredential.fromMap((map['decryptedCredential'] as Map).cast<String, dynamic>())),
      ...
      expiryNotificationDuration: map['expiryNotificationDuration'] == null ? null : pulumi.Output.create<List<String>>((map['expiryNotificationDuration'] as List).cast<String>()),
      ...
      state: map['state'] == null ? null : pulumi.Output.create<AuthConfigState>(AuthConfigState.fromValue(map['state'] as String)),
      validTime: map['validTime'] == null ? null : pulumi.Output.create<String>(map['validTime'] as String),
      visibility: map['visibility'] == null ? null : pulumi.Output.create<AuthConfigVisibility>(AuthConfigVisibility.fromValue(map['visibility'] as String)),
    );
  }
}
