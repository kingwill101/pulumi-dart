...
class AuthConfigArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'project': ?project,
      'reason': ?reason,
      'state': ?pulumi.Input.mapOptionalInputValue<AuthConfigState, String>(
        state,
        (value) => value.wireValue,
      ),
      'validTime': ?validTime,
  ...
  factory AuthConfigArgs.fromMap(Map<String, dynamic> map) {
    return AuthConfigArgs(
      ...
      clientCertificateEncryptedPrivateKey: (() {
        final guardedValue = map['clientCertificateEncryptedPrivateKey'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      clientCertificatePassphrase: (() {
        final guardedValue = map['clientCertificatePassphrase'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      clientCertificateSslCertificate: (() {
        final guardedValue = map['clientCertificateSslCertificate'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      creatorEmail: (() {
      ...
      credentialType: (() {
        ...
        return pulumi.Input.fromValue(
          AuthConfigCredentialType.fromValue(guardedValue as String),
        );
      })(),
      decryptedCredential: (() {
        final guardedValue = map['decryptedCredential'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      expiryNotificationDuration: (() {
        final guardedValue = map['expiryNotificationDuration'];
        if (guardedValue == null) return null;
      ...
      overrideValidTime: (() {
        final guardedValue = map['overrideValidTime'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ...
      state: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AuthConfigState.fromValue(guardedValue as String),
        );
      })(),
      validTime: (() {
        final guardedValue = map['validTime'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      visibility: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AuthConfigVisibility.fromValue(guardedValue as String),
        );
      })(),
    );
  }
