...
class GoogleCloudIntegrationsV1alphaIntegrationAlertConfigResponse {
  ...
  factory GoogleCloudIntegrationsV1alphaIntegrationAlertConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudIntegrationsV1alphaIntegrationAlertConfigResponse(
      ...
      alertThreshold: (map['alertThreshold'] as int).input(),
      disableAlert: (map['disableAlert'] as bool).input(),
      displayName: (map['displayName'] as String).input(),
      durationThreshold: (map['durationThreshold'] as String).input(),
      ...
      thresholdValue: (GoogleCloudIntegrationsV1alphaIntegrationAlertConfigThresholdValueResponse.fromMap((map['thresholdValue'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
