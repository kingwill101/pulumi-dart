...
class EnterpriseCrmEventbusProtoTaskAlertConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'metricType': ?pulumi.Input.mapOptionalInputValue<EnterpriseCrmEventbusProtoTaskAlertConfigMetricType, String>(metricType, (value) => value.value),
      'numAggregationPeriods': ?numAggregationPeriods,
      'onlyFinalAttempt': ?onlyFinalAttempt,
      'playbookUrl': ?playbookUrl,
      'thresholdType': ?pulumi.Input.mapOptionalInputValue<EnterpriseCrmEventbusProtoTaskAlertConfigThresholdType, String>(thresholdType, (value) => value.value),
