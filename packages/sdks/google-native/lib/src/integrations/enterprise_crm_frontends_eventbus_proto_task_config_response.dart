...
class EnterpriseCrmFrontendsEventbusProtoTaskConfigResponse {
  ...
  factory EnterpriseCrmFrontendsEventbusProtoTaskConfigResponse.fromMap(Map<String, dynamic> map) {
    return EnterpriseCrmFrontendsEventbusProtoTaskConfigResponse(
      alertConfigs: (pulumi.Input.decodeList<EnterpriseCrmEventbusProtoTaskAlertConfigResponse>(map['alertConfigs'], (value) => EnterpriseCrmEventbusProtoTaskAlertConfigResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      createTime: (map['createTime'] as String).input(),
      creatorEmail: (map['creatorEmail'] as String).input(),
      description: (map['description'] as String).input(),
      disableStrictTypeValidation: (map['disableStrictTypeValidation'] as bool).input(),
      errorCatcherId: (map['errorCatcherId'] as String).input(),
      externalTaskType: (map['externalTaskType'] as String).input(),
      failurePolicy: (EnterpriseCrmEventbusProtoFailurePolicyResponse.fromMap((map['failurePolicy'] as Map).cast<String, dynamic>())).input(),
      incomingEdgeCount: (map['incomingEdgeCount'] as int).input(),
      jsonValidationOption: (map['jsonValidationOption'] as String).input(),
      label: (map['label'] as String).input(),
      lastModifiedTime: (map['lastModifiedTime'] as String).input(),
      nextTasks: (pulumi.Input.decodeList<EnterpriseCrmEventbusProtoNextTaskResponse>(map['nextTasks'], (value) => EnterpriseCrmEventbusProtoNextTaskResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      preconditionLabel: (map['preconditionLabel'] as String).input(),
      rollbackStrategy: (EnterpriseCrmFrontendsEventbusProtoRollbackStrategyResponse.fromMap((map['rollbackStrategy'] as Map).cast<String, dynamic>())).input(),
      successPolicy: (EnterpriseCrmEventbusProtoSuccessPolicyResponse.fromMap((map['successPolicy'] as Map).cast<String, dynamic>())).input(),
      synchronousCallFailurePolicy: (EnterpriseCrmEventbusProtoFailurePolicyResponse.fromMap((map['synchronousCallFailurePolicy'] as Map).cast<String, dynamic>())).input(),
      taskEntity: (EnterpriseCrmFrontendsEventbusProtoTaskEntityResponse.fromMap((map['taskEntity'] as Map).cast<String, dynamic>())).input(),
      ...
      taskSpec: (map['taskSpec'] as String).input(),
      taskTemplateName: (map['taskTemplateName'] as String).input(),
