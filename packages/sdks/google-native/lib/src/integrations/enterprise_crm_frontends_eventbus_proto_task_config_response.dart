...
class EnterpriseCrmFrontendsEventbusProtoTaskConfigResponse {
  ...
  final pulumi.Input<List<EnterpriseCrmEventbusProtoTaskAlertConfigResponse>>
  alertConfigs;
  ...
  final pulumi.Input<EnterpriseCrmEventbusProtoFailurePolicyResponse>
  failurePolicy;
  ...
  final pulumi.Input<List<EnterpriseCrmEventbusProtoNextTaskResponse>>
  nextTasks;
  ...
  final pulumi.Input<EnterpriseCrmEventbusProtoSuccessPolicyResponse>
  successPolicy;
  ...
  final pulumi.Input<EnterpriseCrmFrontendsEventbusProtoTaskEntityResponse>
  taskEntity;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'nextTasks':
          pulumi.Input.mapInputValue<
            List<EnterpriseCrmEventbusProtoNextTaskResponse>,
            List<Map<String, dynamic>>
          >(
            nextTasks,
            (value) =>
  ...
  factory EnterpriseCrmFrontendsEventbusProtoTaskConfigResponse.fromMap(
    ...
    return EnterpriseCrmFrontendsEventbusProtoTaskConfigResponse(
      ...
      nextTasks: pulumi.Input.fromValue(
      ...
      position: pulumi.Input.fromValue(
        EnterpriseCrmEventbusProtoCoordinateResponse.fromMap(
          (map['position']! as Map).cast<String, dynamic>(),
        ),
      ),
      precondition: pulumi.Input.fromValue(map['precondition'] as String),
      preconditionLabel: pulumi.Input.fromValue(
        map['preconditionLabel'] as String,
      ),
      rollbackStrategy: pulumi.Input.fromValue(
        EnterpriseCrmFrontendsEventbusProtoRollbackStrategyResponse.fromMap(
          (map['rollbackStrategy']! as Map).cast<String, dynamic>(),
        ),
      ),
      successPolicy: pulumi.Input.fromValue(
        EnterpriseCrmEventbusProtoSuccessPolicyResponse.fromMap(
          (map['successPolicy']! as Map).cast<String, dynamic>(),
        ),
      ),
      synchronousCallFailurePolicy: pulumi.Input.fromValue(
        EnterpriseCrmEventbusProtoFailurePolicyResponse.fromMap(
          (map['synchronousCallFailurePolicy']! as Map).cast<String, dynamic>(),
        ),
      ),
      taskEntity: pulumi.Input.fromValue(
        EnterpriseCrmFrontendsEventbusProtoTaskEntityResponse.fromMap(
          (map['taskEntity']! as Map).cast<String, dynamic>(),
        ),
      ),
      taskExecutionStrategy: pulumi.Input.fromValue(
      ...
      taskTemplateName: pulumi.Input.fromValue(
