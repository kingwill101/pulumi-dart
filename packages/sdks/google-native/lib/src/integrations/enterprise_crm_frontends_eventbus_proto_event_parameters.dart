...
class EnterpriseCrmFrontendsEventbusProtoEventParameters {
  ...
  const EnterpriseCrmFrontendsEventbusProtoEventParameters({
    this.parameters,
  });
  ...
  factory EnterpriseCrmFrontendsEventbusProtoEventParameters.fromMap(Map<String, dynamic> map) {
    return EnterpriseCrmFrontendsEventbusProtoEventParameters(
      parameters: (() { final guardedValue = map['parameters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<EnterpriseCrmFrontendsEventbusProtoParameterEntry>(guardedValue, (value) => EnterpriseCrmFrontendsEventbusProtoParameterEntry.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
