...
class GoogleCloudIntegrationsV1alphaIntegrationAlertConfig {
  ...
  factory GoogleCloudIntegrationsV1alphaIntegrationAlertConfig.fromMap(
    ...
    return GoogleCloudIntegrationsV1alphaIntegrationAlertConfig(
      ...
      alertThreshold: (() {
        final guardedValue = map['alertThreshold'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      disableAlert: (() {
        final guardedValue = map['disableAlert'];
        if (guardedValue == null) return null;
      ...
      durationThreshold: (() {
        final guardedValue = map['durationThreshold'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      metricType: (() {
        ...
        return pulumi.Input.fromValue(
          GoogleCloudIntegrationsV1alphaIntegrationAlertConfigMetricType.fromValue(
      ...
      thresholdType: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GoogleCloudIntegrationsV1alphaIntegrationAlertConfigThresholdType.fromValue(
            guardedValue as String,
          ),
        );
      })(),
      thresholdValue: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GoogleCloudIntegrationsV1alphaIntegrationAlertConfigThresholdValue.fromMap(
