...
class GoogleCloudIntegrationsV1alphaIntegrationAlertConfig {
  ...
  const GoogleCloudIntegrationsV1alphaIntegrationAlertConfig({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'metricType': ?pulumi.Input.mapOptionalInputValue<GoogleCloudIntegrationsV1alphaIntegrationAlertConfigMetricType, String>(metricType, (value) => value.wireValue),
      'onlyFinalAttempt': ?onlyFinalAttempt,
      'thresholdType': ?pulumi.Input.mapOptionalInputValue<GoogleCloudIntegrationsV1alphaIntegrationAlertConfigThresholdType, String>(thresholdType, (value) => value.wireValue),
  ...
  factory GoogleCloudIntegrationsV1alphaIntegrationAlertConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudIntegrationsV1alphaIntegrationAlertConfig(
      ...
      alertThreshold: (() { final guardedValue = map['alertThreshold']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      disableAlert: (() { final guardedValue = map['disableAlert']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      displayName: (() { final guardedValue = map['displayName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      durationThreshold: (() { final guardedValue = map['durationThreshold']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      metricType: (() { final guardedValue = map['metricType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudIntegrationsV1alphaIntegrationAlertConfigMetricType.fromValue(guardedValue as String)); })(),
      ...
      thresholdType: (() { final guardedValue = map['thresholdType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudIntegrationsV1alphaIntegrationAlertConfigThresholdType.fromValue(guardedValue as String)); })(),
      thresholdValue: (() { final guardedValue = map['thresholdValue']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudIntegrationsV1alphaIntegrationAlertConfigThresholdValue.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
