...
class EnterpriseCrmEventbusProtoTaskUiConfigResponse {
  ...
  factory EnterpriseCrmEventbusProtoTaskUiConfigResponse.fromMap(Map<String, dynamic> map) {
    return EnterpriseCrmEventbusProtoTaskUiConfigResponse(
      taskUiModuleConfigs: (pulumi.Input.decodeList<EnterpriseCrmEventbusProtoTaskUiModuleConfigResponse>(map['taskUiModuleConfigs'], (value) => EnterpriseCrmEventbusProtoTaskUiModuleConfigResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
