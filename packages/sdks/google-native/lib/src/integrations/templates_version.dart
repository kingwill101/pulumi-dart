...
class TemplatesVersion extends pulumi.CustomResource {
  ...
  late final pulumi.Output<EnterpriseCrmFrontendsEventbusProtoWorkflowParametersResponse> templateParameters;
  ...
  TemplatesVersion(
    ...
    parentIntegrationVersionId = registerOutput<String>('parentIntegrationVersionId');
    ...
    templateParameters = registerOutput<EnterpriseCrmFrontendsEventbusProtoWorkflowParametersResponse>('templateParameters', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return EnterpriseCrmFrontendsEventbusProtoWorkflowParametersResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
