...
class GoogleCloudIntegrationsV1alphaCloudLoggingDetails {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'cloudLoggingSeverity': ?pulumi.Input.mapOptionalInputValue<GoogleCloudIntegrationsV1alphaCloudLoggingDetailsCloudLoggingSeverity, String>(cloudLoggingSeverity, (value) => value.value),
