...
class EnterpriseCrmEventbusProtoTaskAlertConfigResponse {
  ...
  factory EnterpriseCrmEventbusProtoTaskAlertConfigResponse.fromMap(Map<String, dynamic> map) {
    return EnterpriseCrmEventbusProtoTaskAlertConfigResponse(
      aggregationPeriod: (map['aggregationPeriod'] as String).input(),
      alertDisabled: (map['alertDisabled'] as bool).input(),
      alertName: (map['alertName'] as String).input(),
      clientId: (map['clientId'] as String).input(),
      durationThresholdMs: (map['durationThresholdMs'] as String).input(),
      errorEnumList: (EnterpriseCrmEventbusProtoBaseAlertConfigErrorEnumListResponse.fromMap((map['errorEnumList'] as Map).cast<String, dynamic>())).input(),
      metricType: (map['metricType'] as String).input(),
      numAggregationPeriods: (map['numAggregationPeriods'] as int).input(),
      onlyFinalAttempt: (map['onlyFinalAttempt'] as bool).input(),
      playbookUrl: (map['playbookUrl'] as String).input(),
      thresholdType: (map['thresholdType'] as String).input(),
      thresholdValue: (EnterpriseCrmEventbusProtoBaseAlertConfigThresholdValueResponse.fromMap((map['thresholdValue'] as Map).cast<String, dynamic>())).input(),
      warningEnumList: (EnterpriseCrmEventbusProtoBaseAlertConfigErrorEnumListResponse.fromMap((map['warningEnumList'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
