...
class GoogleCloudIntegrationsV1alphaTestTaskConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'assertions': ?assertions == null ? null : pulumi.Input.encodeList<GoogleCloudIntegrationsV1alphaAssertion, Map<String, dynamic>>(assertions!, (value) => value.toMap()),
  ...
  factory GoogleCloudIntegrationsV1alphaTestTaskConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudIntegrationsV1alphaTestTaskConfig(
      assertions: map['assertions'] == null ? null : pulumi.Input.decodeList<GoogleCloudIntegrationsV1alphaAssertion>(map['assertions'], (value) => GoogleCloudIntegrationsV1alphaAssertion.fromMap((value as Map).cast<String, dynamic>())),
      mockConfig: map['mockConfig'] == null ? null : GoogleCloudIntegrationsV1alphaMockConfig.fromMap((map['mockConfig'] as Map).cast<String, dynamic>()),
