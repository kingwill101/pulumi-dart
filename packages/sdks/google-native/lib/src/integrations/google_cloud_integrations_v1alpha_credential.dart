...
class GoogleCloudIntegrationsV1alphaCredential {
  ...
  final GoogleCloudIntegrationsV1alphaOAuth2AuthorizationCode? oauth2AuthorizationCode;
  /// OAuth2Implicit oauth2_implicit = 5; OAuth2 client credentials
  final GoogleCloudIntegrationsV1alphaOAuth2ClientCredentials? oauth2ClientCredentials;
  /// OAuth2 resource owner credentials
  final GoogleCloudIntegrationsV1alphaOAuth2ResourceOwnerCredentials? oauth2ResourceOwnerCredentials;
  /// Google OIDC ID Token
  final GoogleCloudIntegrationsV1alphaOidcToken? oidcToken;
  /// Service account credential
  final GoogleCloudIntegrationsV1alphaServiceAccountCredentials? serviceAccountCredentials;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'credentialType': ?credentialType == null ? null : credentialType!.value,
      ...
      'oauth2ResourceOwnerCredentials': ?oauth2ResourceOwnerCredentials == null ? null : oauth2ResourceOwnerCredentials!.toMap(),
  ...
  factory GoogleCloudIntegrationsV1alphaCredential.fromMap(Map<String, dynamic> map) {
    return GoogleCloudIntegrationsV1alphaCredential(
      authToken: map['authToken'] == null ? null : GoogleCloudIntegrationsV1alphaAuthToken.fromMap((map['authToken'] as Map).cast<String, dynamic>()),
      credentialType: map['credentialType'] == null ? null : GoogleCloudIntegrationsV1alphaCredentialCredentialType.fromValue(map['credentialType'] as String),
      jwt: map['jwt'] == null ? null : GoogleCloudIntegrationsV1alphaJwt.fromMap((map['jwt'] as Map).cast<String, dynamic>()),
      oauth2AuthorizationCode: map['oauth2AuthorizationCode'] == null ? null : GoogleCloudIntegrationsV1alphaOAuth2AuthorizationCode.fromMap((map['oauth2AuthorizationCode'] as Map).cast<String, dynamic>()),
      oauth2ClientCredentials: map['oauth2ClientCredentials'] == null ? null : GoogleCloudIntegrationsV1alphaOAuth2ClientCredentials.fromMap((map['oauth2ClientCredentials'] as Map).cast<String, dynamic>()),
      oauth2ResourceOwnerCredentials: map['oauth2ResourceOwnerCredentials'] == null ? null : GoogleCloudIntegrationsV1alphaOAuth2ResourceOwnerCredentials.fromMap((map['oauth2ResourceOwnerCredentials'] as Map).cast<String, dynamic>()),
      oidcToken: map['oidcToken'] == null ? null : GoogleCloudIntegrationsV1alphaOidcToken.fromMap((map['oidcToken'] as Map).cast<String, dynamic>()),
      serviceAccountCredentials: map['serviceAccountCredentials'] == null ? null : GoogleCloudIntegrationsV1alphaServiceAccountCredentials.fromMap((map['serviceAccountCredentials'] as Map).cast<String, dynamic>()),
      usernameAndPassword: map['usernameAndPassword'] == null ? null : GoogleCloudIntegrationsV1alphaUsernameAndPassword.fromMap((map['usernameAndPassword'] as Map).cast<String, dynamic>()),
    );
  }
}
