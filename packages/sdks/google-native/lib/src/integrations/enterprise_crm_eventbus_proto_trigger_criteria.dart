...
class EnterpriseCrmEventbusProtoTriggerCriteria {
  ...
  const EnterpriseCrmEventbusProtoTriggerCriteria({
  ...
  factory EnterpriseCrmEventbusProtoTriggerCriteria.fromMap(Map<String, dynamic> map) {
    return EnterpriseCrmEventbusProtoTriggerCriteria(
      ...
      triggerCriteriaTaskImplementationClassName: (() { final guardedValue = map['triggerCriteriaTaskImplementationClassName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
