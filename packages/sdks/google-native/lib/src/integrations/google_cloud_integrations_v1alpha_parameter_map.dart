...
class GoogleCloudIntegrationsV1alphaParameterMap {
  ...
  final pulumi.Input<List<GoogleCloudIntegrationsV1alphaParameterMapEntry>>?
  entries;

  /// Option to specify key type for all entries of the map. If provided then field types for all entries must conform to this.
  final pulumi.Input<GoogleCloudIntegrationsV1alphaParameterMapKeyType>?
  keyType;
  ...
  final pulumi.Input<GoogleCloudIntegrationsV1alphaParameterMapValueType>?
  valueType;
    ...
    return <String, dynamic>{
      'entries':
          ?pulumi.Input.mapOptionalInputValue<
            List<GoogleCloudIntegrationsV1alphaParameterMapEntry>,
    ...
    return GoogleCloudIntegrationsV1alphaParameterMap(
      entries: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => GoogleCloudIntegrationsV1alphaParameterMapEntry.fromMap(
