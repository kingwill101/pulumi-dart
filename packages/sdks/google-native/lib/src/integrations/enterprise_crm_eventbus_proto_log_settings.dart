...
class EnterpriseCrmEventbusProtoLogSettings {
  ...
  final pulumi.Input<EnterpriseCrmEventbusProtoLogSettingsSeedPeriod>?
  seedPeriod;
    ...
    return <String, dynamic>{
      ...
      'seedPeriod':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(seedPeriod, (value) => value.wireValue),
      'seedScope':
          ?pulumi.Input.mapOptionalInputValue<
            EnterpriseCrmEventbusProtoLogSettingsSeedScope,
            String
          >(seedScope, (value) => value.wireValue),
      'shorteningLimits':
          ?pulumi.Input.mapOptionalInputValue<
  ...
  factory EnterpriseCrmEventbusProtoLogSettings.fromMap(
    ...
    return EnterpriseCrmEventbusProtoLogSettings(
      logFieldName: (() {
        final guardedValue = map['logFieldName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      sanitizeOptions: (() {
        final guardedValue = map['sanitizeOptions'];
        if (guardedValue == null) return null;
      ...
      seedPeriod: (() {
        final guardedValue = map['seedPeriod'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      seedScope: (() {
        final guardedValue = map['seedScope'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      shorteningLimits: (() {
        final guardedValue = map['shorteningLimits'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
