...
class VersionArgs {
  ...
  VersionArgs({
    pulumi.Output<GoogleCloudIntegrationsV1alphaCloudLoggingDetails>? cloudLoggingDetails,
    pulumi.Output<bool>? createSampleIntegrations,
    pulumi.Output<VersionDatabasePersistencePolicy>? databasePersistencePolicy,
    ...
    pulumi.Output<List<GoogleCloudIntegrationsV1alphaIntegrationParameter>>? integrationParameters,
    pulumi.Output<EnterpriseCrmFrontendsEventbusProtoWorkflowParameters>? integrationParametersInternal,
    pulumi.Output<String>? lastModifierEmail,
    pulumi.Output<String>? location,
    pulumi.Output<String>? lockHolder,
    pulumi.Output<bool>? newIntegration,
    pulumi.Output<VersionOrigin>? origin,
    pulumi.Output<String>? parentTemplateId,
    required pulumi.Output<String> productId,
    pulumi.Output<String>? project,
    pulumi.Output<String>? runAsServiceAccount,
    pulumi.Output<String>? snapshotNumber,
    pulumi.Output<List<GoogleCloudIntegrationsV1alphaTaskConfig>>? taskConfigs,
    pulumi.Output<List<EnterpriseCrmFrontendsEventbusProtoTaskConfig>>? taskConfigsInternal,
    pulumi.Output<EnterpriseCrmEventbusProtoTeardown>? teardown,
    pulumi.Output<List<GoogleCloudIntegrationsV1alphaTriggerConfig>>? triggerConfigs,
    pulumi.Output<List<EnterpriseCrmFrontendsEventbusProtoTriggerConfig>>? triggerConfigsInternal,
    pulumi.Output<String>? userLabel,
  }) :
      cloudLoggingDetails = pulumi.Input.asOptionalInput<GoogleCloudIntegrationsV1alphaCloudLoggingDetails>(cloudLoggingDetails),
      createSampleIntegrations = pulumi.Input.asOptionalInput<bool>(createSampleIntegrations),
      databasePersistencePolicy = pulumi.Input.asOptionalInput<VersionDatabasePersistencePolicy>(databasePersistencePolicy),
      ...
      integrationParameters = pulumi.Input.asOptionalInput<List<GoogleCloudIntegrationsV1alphaIntegrationParameter>>(integrationParameters),
      integrationParametersInternal = pulumi.Input.asOptionalInput<EnterpriseCrmFrontendsEventbusProtoWorkflowParameters>(integrationParametersInternal),
      ...
      parentTemplateId = pulumi.Input.asOptionalInput<String>(parentTemplateId),
      ...
      taskConfigs = pulumi.Input.asOptionalInput<List<GoogleCloudIntegrationsV1alphaTaskConfig>>(taskConfigs),
      taskConfigsInternal = pulumi.Input.asOptionalInput<List<EnterpriseCrmFrontendsEventbusProtoTaskConfig>>(taskConfigsInternal),
      teardown = pulumi.Input.asOptionalInput<EnterpriseCrmEventbusProtoTeardown>(teardown),
      triggerConfigs = pulumi.Input.asOptionalInput<List<GoogleCloudIntegrationsV1alphaTriggerConfig>>(triggerConfigs),
      triggerConfigsInternal = pulumi.Input.asOptionalInput<List<EnterpriseCrmFrontendsEventbusProtoTriggerConfig>>(triggerConfigsInternal),
  ...
  factory VersionArgs.fromMap(Map<String, dynamic> map) {
    return VersionArgs(
      cloudLoggingDetails: map['cloudLoggingDetails'] == null ? null : pulumi.Output.create<GoogleCloudIntegrationsV1alphaCloudLoggingDetails>(GoogleCloudIntegrationsV1alphaCloudLoggingDetails.fromMap((map['cloudLoggingDetails'] as Map).cast<String, dynamic>())),
      ...
      databasePersistencePolicy: map['databasePersistencePolicy'] == null ? null : pulumi.Output.create<VersionDatabasePersistencePolicy>(VersionDatabasePersistencePolicy.fromValue(map['databasePersistencePolicy'] as String)),
      ...
      integrationParameters: map['integrationParameters'] == null ? null : pulumi.Output.create<List<GoogleCloudIntegrationsV1alphaIntegrationParameter>>(pulumi.Input.decodeList<GoogleCloudIntegrationsV1alphaIntegrationParameter>(map['integrationParameters'], (value) => GoogleCloudIntegrationsV1alphaIntegrationParameter.fromMap((value as Map).cast<String, dynamic>()))),
      integrationParametersInternal: map['integrationParametersInternal'] == null ? null : pulumi.Output.create<EnterpriseCrmFrontendsEventbusProtoWorkflowParameters>(EnterpriseCrmFrontendsEventbusProtoWorkflowParameters.fromMap((map['integrationParametersInternal'] as Map).cast<String, dynamic>())),
      ...
      lockHolder: map['lockHolder'] == null ? null : pulumi.Output.create<String>(map['lockHolder'] as String),
      newIntegration: map['newIntegration'] == null ? null : pulumi.Output.create<bool>(map['newIntegration'] as bool),
      origin: map['origin'] == null ? null : pulumi.Output.create<VersionOrigin>(VersionOrigin.fromValue(map['origin'] as String)),
      parentTemplateId: map['parentTemplateId'] == null ? null : pulumi.Output.create<String>(map['parentTemplateId'] as String),
      ...
      snapshotNumber: map['snapshotNumber'] == null ? null : pulumi.Output.create<String>(map['snapshotNumber'] as String),
      taskConfigs: map['taskConfigs'] == null ? null : pulumi.Output.create<List<GoogleCloudIntegrationsV1alphaTaskConfig>>(pulumi.Input.decodeList<GoogleCloudIntegrationsV1alphaTaskConfig>(map['taskConfigs'], (value) => GoogleCloudIntegrationsV1alphaTaskConfig.fromMap((value as Map).cast<String, dynamic>()))),
      taskConfigsInternal: map['taskConfigsInternal'] == null ? null : pulumi.Output.create<List<EnterpriseCrmFrontendsEventbusProtoTaskConfig>>(pulumi.Input.decodeList<EnterpriseCrmFrontendsEventbusProtoTaskConfig>(map['taskConfigsInternal'], (value) => EnterpriseCrmFrontendsEventbusProtoTaskConfig.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      triggerConfigs: map['triggerConfigs'] == null ? null : pulumi.Output.create<List<GoogleCloudIntegrationsV1alphaTriggerConfig>>(pulumi.Input.decodeList<GoogleCloudIntegrationsV1alphaTriggerConfig>(map['triggerConfigs'], (value) => GoogleCloudIntegrationsV1alphaTriggerConfig.fromMap((value as Map).cast<String, dynamic>()))),
      triggerConfigsInternal: map['triggerConfigsInternal'] == null ? null : pulumi.Output.create<List<EnterpriseCrmFrontendsEventbusProtoTriggerConfig>>(pulumi.Input.decodeList<EnterpriseCrmFrontendsEventbusProtoTriggerConfig>(map['triggerConfigsInternal'], (value) => EnterpriseCrmFrontendsEventbusProtoTriggerConfig.fromMap((value as Map).cast<String, dynamic>()))),
