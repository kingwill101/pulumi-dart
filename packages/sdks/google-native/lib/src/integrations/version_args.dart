...
class VersionArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'databasePersistencePolicy': ?pulumi.Input.mapOptionalInputValue<VersionDatabasePersistencePolicy, String>(databasePersistencePolicy, (value) => value.wireValue),
      ...
      'origin': ?pulumi.Input.mapOptionalInputValue<VersionOrigin, String>(origin, (value) => value.wireValue),
  ...
  factory VersionArgs.fromMap(Map<String, dynamic> map) {
    return VersionArgs(
      cloudLoggingDetails: (() { final guardedValue = map['cloudLoggingDetails']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudIntegrationsV1alphaCloudLoggingDetails.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      databasePersistencePolicy: (() { final guardedValue = map['databasePersistencePolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VersionDatabasePersistencePolicy.fromValue(guardedValue as String)); })(),
      ...
      integrationParameters: (() { final guardedValue = map['integrationParameters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudIntegrationsV1alphaIntegrationParameter>(guardedValue, (value) => GoogleCloudIntegrationsV1alphaIntegrationParameter.fromMap((value as Map).cast<String, dynamic>()))); })(),
      integrationParametersInternal: (() { final guardedValue = map['integrationParametersInternal']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EnterpriseCrmFrontendsEventbusProtoWorkflowParameters.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      lockHolder: (() { final guardedValue = map['lockHolder']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      newIntegration: (() { final guardedValue = map['newIntegration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      origin: (() { final guardedValue = map['origin']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VersionOrigin.fromValue(guardedValue as String)); })(),
      parentTemplateId: (() { final guardedValue = map['parentTemplateId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      snapshotNumber: (() { final guardedValue = map['snapshotNumber']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      taskConfigs: (() { final guardedValue = map['taskConfigs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudIntegrationsV1alphaTaskConfig>(guardedValue, (value) => GoogleCloudIntegrationsV1alphaTaskConfig.fromMap((value as Map).cast<String, dynamic>()))); })(),
      taskConfigsInternal: (() { final guardedValue = map['taskConfigsInternal']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<EnterpriseCrmFrontendsEventbusProtoTaskConfig>(guardedValue, (value) => EnterpriseCrmFrontendsEventbusProtoTaskConfig.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      triggerConfigs: (() { final guardedValue = map['triggerConfigs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudIntegrationsV1alphaTriggerConfig>(guardedValue, (value) => GoogleCloudIntegrationsV1alphaTriggerConfig.fromMap((value as Map).cast<String, dynamic>()))); })(),
      triggerConfigsInternal: (() { final guardedValue = map['triggerConfigsInternal']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<EnterpriseCrmFrontendsEventbusProtoTriggerConfig>(guardedValue, (value) => EnterpriseCrmFrontendsEventbusProtoTriggerConfig.fromMap((value as Map).cast<String, dynamic>()))); })(),
