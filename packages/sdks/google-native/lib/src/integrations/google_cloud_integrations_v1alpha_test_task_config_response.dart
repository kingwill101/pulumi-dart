...
class GoogleCloudIntegrationsV1alphaTestTaskConfigResponse {
  ...
  factory GoogleCloudIntegrationsV1alphaTestTaskConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudIntegrationsV1alphaTestTaskConfigResponse(
      assertions: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudIntegrationsV1alphaAssertionResponse>(map['assertions']!, (value) => GoogleCloudIntegrationsV1alphaAssertionResponse.fromMap((value as Map).cast<String, dynamic>()))),
      mockConfig: pulumi.Input.fromValue(GoogleCloudIntegrationsV1alphaMockConfigResponse.fromMap((map['mockConfig']! as Map).cast<String, dynamic>())),
