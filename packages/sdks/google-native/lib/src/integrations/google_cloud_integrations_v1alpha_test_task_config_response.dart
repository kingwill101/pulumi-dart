...
class GoogleCloudIntegrationsV1alphaTestTaskConfigResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'assertions': pulumi.Input.encodeList<GoogleCloudIntegrationsV1alphaAssertionResponse, Map<String, dynamic>>(assertions, (value) => value.toMap()),
  ...
  factory GoogleCloudIntegrationsV1alphaTestTaskConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudIntegrationsV1alphaTestTaskConfigResponse(
      assertions: pulumi.Input.decodeList<GoogleCloudIntegrationsV1alphaAssertionResponse>(map['assertions'], (value) => GoogleCloudIntegrationsV1alphaAssertionResponse.fromMap((value as Map).cast<String, dynamic>())),
      mockConfig: GoogleCloudIntegrationsV1alphaMockConfigResponse.fromMap((map['mockConfig'] as Map).cast<String, dynamic>()),
