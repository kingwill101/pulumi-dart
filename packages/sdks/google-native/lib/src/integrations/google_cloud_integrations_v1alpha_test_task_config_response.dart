...
class GoogleCloudIntegrationsV1alphaTestTaskConfigResponse {
  ...
  final pulumi.Input<List<GoogleCloudIntegrationsV1alphaAssertionResponse>>
  assertions;

  /// Optional. Defines how to mock the given task during test execution
  final pulumi.Input<GoogleCloudIntegrationsV1alphaMockConfigResponse>
  mockConfig;
    ...
    return <String, dynamic>{
      'assertions':
          pulumi.Input.mapInputValue<
            List<GoogleCloudIntegrationsV1alphaAssertionResponse>,
  ...
  factory GoogleCloudIntegrationsV1alphaTestTaskConfigResponse.fromMap(
    ...
    return GoogleCloudIntegrationsV1alphaTestTaskConfigResponse(
      assertions: pulumi.Input.fromValue(
        pulumi
      ...
      mockConfig: pulumi.Input.fromValue(
        GoogleCloudIntegrationsV1alphaMockConfigResponse.fromMap(
