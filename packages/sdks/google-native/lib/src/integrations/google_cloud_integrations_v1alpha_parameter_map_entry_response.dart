...
class GoogleCloudIntegrationsV1alphaParameterMapEntryResponse {
  ...
  factory GoogleCloudIntegrationsV1alphaParameterMapEntryResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudIntegrationsV1alphaParameterMapEntryResponse(
      key: pulumi.Input.fromValue(GoogleCloudIntegrationsV1alphaParameterMapFieldResponse.fromMap((map['key']! as Map).cast<String, dynamic>())),
      value: pulumi.Input.fromValue(GoogleCloudIntegrationsV1alphaParameterMapFieldResponse.fromMap((map['value']! as Map).cast<String, dynamic>())),
    );
  }
}
