...
class GoogleCloudIntegrationsV1alphaTaskConfig {
  ...
  final GoogleCloudIntegrationsV1alphaTaskConfigExternalTaskType? externalTaskType;
  ...
  final GoogleCloudIntegrationsV1alphaTaskConfigJsonValidationOption? jsonValidationOption;
  ...
  final GoogleCloudIntegrationsV1alphaTaskConfigNextTasksExecutionPolicy? nextTasksExecutionPolicy;
  ...
  final GoogleCloudIntegrationsV1alphaFailurePolicy? synchronousCallFailurePolicy;
  /// Optional. The name for the task.
  final String? task;
  /// Optional. The policy dictating the execution strategy of this task.
  final GoogleCloudIntegrationsV1alphaTaskConfigTaskExecutionStrategy? taskExecutionStrategy;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'nextTasks': ?nextTasks == null ? null : pulumi.Input.encodeList<GoogleCloudIntegrationsV1alphaNextTask, Map<String, dynamic>>(nextTasks!, (value) => value.toMap()),
  ...
  factory GoogleCloudIntegrationsV1alphaTaskConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudIntegrationsV1alphaTaskConfig(
      ...
      externalTaskType: map['externalTaskType'] == null ? null : GoogleCloudIntegrationsV1alphaTaskConfigExternalTaskType.fromValue(map['externalTaskType'] as String),
      failurePolicy: map['failurePolicy'] == null ? null : GoogleCloudIntegrationsV1alphaFailurePolicy.fromMap((map['failurePolicy'] as Map).cast<String, dynamic>()),
      jsonValidationOption: map['jsonValidationOption'] == null ? null : GoogleCloudIntegrationsV1alphaTaskConfigJsonValidationOption.fromValue(map['jsonValidationOption'] as String),
      nextTasks: map['nextTasks'] == null ? null : pulumi.Input.decodeList<GoogleCloudIntegrationsV1alphaNextTask>(map['nextTasks'], (value) => GoogleCloudIntegrationsV1alphaNextTask.fromMap((value as Map).cast<String, dynamic>())),
      nextTasksExecutionPolicy: map['nextTasksExecutionPolicy'] == null ? null : GoogleCloudIntegrationsV1alphaTaskConfigNextTasksExecutionPolicy.fromValue(map['nextTasksExecutionPolicy'] as String),
      ...
      successPolicy: map['successPolicy'] == null ? null : GoogleCloudIntegrationsV1alphaSuccessPolicy.fromMap((map['successPolicy'] as Map).cast<String, dynamic>()),
      synchronousCallFailurePolicy: map['synchronousCallFailurePolicy'] == null ? null : GoogleCloudIntegrationsV1alphaFailurePolicy.fromMap((map['synchronousCallFailurePolicy'] as Map).cast<String, dynamic>()),
      task: map['task'] == null ? null : map['task'] as String,
      taskExecutionStrategy: map['taskExecutionStrategy'] == null ? null : GoogleCloudIntegrationsV1alphaTaskConfigTaskExecutionStrategy.fromValue(map['taskExecutionStrategy'] as String),
      taskId: map['taskId'] as String,
      taskTemplate: map['taskTemplate'] == null ? null : map['taskTemplate'] as String,
    );
  }
}
