...
class GoogleCloudIntegrationsV1alphaTaskConfig {
  ...
  final pulumi.Input<GoogleCloudIntegrationsV1alphaTaskConfigExternalTaskType>?
  externalTaskType;
  ...
  final pulumi.Input<GoogleCloudIntegrationsV1alphaFailurePolicy>?
  failurePolicy;
  ...
  final pulumi.Input<GoogleCloudIntegrationsV1alphaSuccessPolicy>?
  successPolicy;
  ...
  factory GoogleCloudIntegrationsV1alphaTaskConfig.fromMap(
    ...
    return GoogleCloudIntegrationsV1alphaTaskConfig(
      ...
      taskTemplate: (() {
        final guardedValue = map['taskTemplate'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
