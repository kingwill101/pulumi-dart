...
class GoogleCloudIntegrationsV1alphaTaskConfigResponse {
  ...
  const GoogleCloudIntegrationsV1alphaTaskConfigResponse({
  ...
  factory GoogleCloudIntegrationsV1alphaTaskConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudIntegrationsV1alphaTaskConfigResponse(
      ...
      failurePolicy: pulumi.Input.fromValue(GoogleCloudIntegrationsV1alphaFailurePolicyResponse.fromMap((map['failurePolicy']! as Map).cast<String, dynamic>())),
      jsonValidationOption: pulumi.Input.fromValue(map['jsonValidationOption'] as String),
      nextTasks: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudIntegrationsV1alphaNextTaskResponse>(map['nextTasks']!, (value) => GoogleCloudIntegrationsV1alphaNextTaskResponse.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      successPolicy: pulumi.Input.fromValue(GoogleCloudIntegrationsV1alphaSuccessPolicyResponse.fromMap((map['successPolicy']! as Map).cast<String, dynamic>())),
      synchronousCallFailurePolicy: pulumi.Input.fromValue(GoogleCloudIntegrationsV1alphaFailurePolicyResponse.fromMap((map['synchronousCallFailurePolicy']! as Map).cast<String, dynamic>())),
      ...
      taskTemplate: pulumi.Input.fromValue(map['taskTemplate'] as String),
    );
  }
}
