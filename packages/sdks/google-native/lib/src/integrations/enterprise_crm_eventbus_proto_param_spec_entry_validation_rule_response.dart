...
class EnterpriseCrmEventbusProtoParamSpecEntryValidationRuleResponse {
  ...
  factory EnterpriseCrmEventbusProtoParamSpecEntryValidationRuleResponse.fromMap(Map<String, dynamic> map) {
    return EnterpriseCrmEventbusProtoParamSpecEntryValidationRuleResponse(
      doubleRange: pulumi.Input.fromValue(EnterpriseCrmEventbusProtoParamSpecEntryValidationRuleDoubleRangeResponse.fromMap((map['doubleRange']! as Map).cast<String, dynamic>())),
      intRange: pulumi.Input.fromValue(EnterpriseCrmEventbusProtoParamSpecEntryValidationRuleIntRangeResponse.fromMap((map['intRange']! as Map).cast<String, dynamic>())),
      stringRegex: pulumi.Input.fromValue(EnterpriseCrmEventbusProtoParamSpecEntryValidationRuleStringRegexResponse.fromMap((map['stringRegex']! as Map).cast<String, dynamic>())),
    );
  }
}
