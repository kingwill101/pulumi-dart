...
class GoogleCloudIntegrationsV1alphaOAuth2AuthorizationCodeResponse {
  ...
  final pulumi.Input<GoogleCloudIntegrationsV1alphaAccessTokenResponse>
  accessToken;
  ...
  final pulumi.Input<GoogleCloudIntegrationsV1alphaParameterMapResponse>
  authParams;
  ...
  factory GoogleCloudIntegrationsV1alphaOAuth2AuthorizationCodeResponse.fromMap(
    ...
    return GoogleCloudIntegrationsV1alphaOAuth2AuthorizationCodeResponse(
      accessToken: pulumi.Input.fromValue(
        GoogleCloudIntegrationsV1alphaAccessTokenResponse.fromMap(
          (map['accessToken']! as Map).cast<String, dynamic>(),
        ),
      ),
      applyReauthPolicy: pulumi.Input.fromValue(
      ...
      authParams: pulumi.Input.fromValue(
        GoogleCloudIntegrationsV1alphaParameterMapResponse.fromMap(
      ...
      tokenParams: pulumi.Input.fromValue(
        GoogleCloudIntegrationsV1alphaParameterMapResponse.fromMap(
