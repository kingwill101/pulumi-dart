...
class EnterpriseCrmEventbusProtoTaskMetadataResponse {
  ...
  final pulumi.Input<List<EnterpriseCrmEventbusProtoTaskMetadataAdminResponse>>
  admins;
    ...
    return <String, dynamic>{
      ...
      'admins':
          pulumi.Input.mapInputValue<
            List<EnterpriseCrmEventbusProtoTaskMetadataAdminResponse>,
  ...
  factory EnterpriseCrmEventbusProtoTaskMetadataResponse.fromMap(
    ...
    return EnterpriseCrmEventbusProtoTaskMetadataResponse(
      ...
      defaultJsonValidationOption: pulumi.Input.fromValue(
      ...
      externalCategory: pulumi.Input.fromValue(
        map['externalCategory'] as String,
      ),
      externalCategorySequence: pulumi.Input.fromValue(
      ...
      externalDocMarkdown: pulumi.Input.fromValue(
      ...
      standaloneExternalDocHtml: pulumi.Input.fromValue(
