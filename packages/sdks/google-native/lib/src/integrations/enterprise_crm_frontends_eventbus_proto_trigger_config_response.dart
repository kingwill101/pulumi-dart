...
class EnterpriseCrmFrontendsEventbusProtoTriggerConfigResponse {
  ...
  >
  alertConfig;
  final pulumi.Input<EnterpriseCrmEventbusProtoCloudSchedulerConfigResponse>
  ...
  final pulumi.Input<EnterpriseCrmEventbusProtoTriggerCriteriaResponse>
  triggerCriteria;
  ...
  factory EnterpriseCrmFrontendsEventbusProtoTriggerConfigResponse.fromMap(
    ...
    return EnterpriseCrmFrontendsEventbusProtoTriggerConfigResponse(
      ...
      pauseWorkflowExecutions: pulumi.Input.fromValue(
      ...
      triggerCriteria: pulumi.Input.fromValue(
