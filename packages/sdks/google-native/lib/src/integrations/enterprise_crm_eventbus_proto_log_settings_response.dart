...
class EnterpriseCrmEventbusProtoLogSettingsResponse {
  ...
  factory EnterpriseCrmEventbusProtoLogSettingsResponse.fromMap(Map<String, dynamic> map) {
    return EnterpriseCrmEventbusProtoLogSettingsResponse(
      logFieldName: (map['logFieldName'] as String).input(),
      sanitizeOptions: (EnterpriseCrmLoggingGwsSanitizeOptionsResponse.fromMap((map['sanitizeOptions'] as Map).cast<String, dynamic>())).input(),
      seedPeriod: (map['seedPeriod'] as String).input(),
      seedScope: (map['seedScope'] as String).input(),
      shorteningLimits: (EnterpriseCrmLoggingGwsFieldLimitsResponse.fromMap((map['shorteningLimits'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
