...
class EnterpriseCrmEventbusProtoLogSettingsResponse {
  ...
  final pulumi.Input<EnterpriseCrmLoggingGwsSanitizeOptionsResponse>
  sanitizeOptions;
  ...
  final pulumi.Input<EnterpriseCrmLoggingGwsFieldLimitsResponse>
  shorteningLimits;
    ...
    return <String, dynamic>{
      ...
      'sanitizeOptions':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(sanitizeOptions, (value) => value.toMap()),
      ...
      'shorteningLimits':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(shorteningLimits, (value) => value.toMap()),
    };
  }
  ...
  factory EnterpriseCrmEventbusProtoLogSettingsResponse.fromMap(
    ...
    return EnterpriseCrmEventbusProtoLogSettingsResponse(
      ...
      sanitizeOptions: pulumi.Input.fromValue(
        EnterpriseCrmLoggingGwsSanitizeOptionsResponse.fromMap(
      ...
      shorteningLimits: pulumi.Input.fromValue(
        EnterpriseCrmLoggingGwsFieldLimitsResponse.fromMap(
