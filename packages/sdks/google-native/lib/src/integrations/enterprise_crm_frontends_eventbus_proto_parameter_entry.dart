...
class EnterpriseCrmFrontendsEventbusProtoParameterEntry {
  ...
  final pulumi.Input<EnterpriseCrmFrontendsEventbusProtoParameterEntryDataType>? dataType;
  ...
  final pulumi.Input<EnterpriseCrmFrontendsEventbusProtoParameterValueType>? value;
  ...
  const EnterpriseCrmFrontendsEventbusProtoParameterEntry({
    this.dataType,
    this.key,
    this.value,
  });
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'dataType': ?pulumi.Input.mapOptionalInputValue<EnterpriseCrmFrontendsEventbusProtoParameterEntryDataType, String>(dataType, (value) => value.wireValue),
      'key': ?key,
      'value': ?pulumi.Input.mapOptionalInputValue<EnterpriseCrmFrontendsEventbusProtoParameterValueType, Map<String, dynamic>>(value, (value) => value.toMap()),
    };
  }
  ...
  factory EnterpriseCrmFrontendsEventbusProtoParameterEntry.fromMap(Map<String, dynamic> map) {
    return EnterpriseCrmFrontendsEventbusProtoParameterEntry(
      dataType: (() { final guardedValue = map['dataType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EnterpriseCrmFrontendsEventbusProtoParameterEntryDataType.fromValue(guardedValue as String)); })(),
      key: (() { final guardedValue = map['key']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      value: (() { final guardedValue = map['value']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EnterpriseCrmFrontendsEventbusProtoParameterValueType.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
