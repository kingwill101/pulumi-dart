...
class GoogleCloudIntegrationsV1alphaTriggerConfig {
  ...
  final pulumi.Input<List<GoogleCloudIntegrationsV1alphaIntegrationAlertConfig>>? alertConfig;
  /// Optional. Cloud Scheduler Trigger related metadata
  final pulumi.Input<GoogleCloudIntegrationsV1alphaCloudSchedulerConfig>? cloudSchedulerConfig;
  ...
  final pulumi.Input<GoogleCloudIntegrationsV1alphaTriggerConfigNextTasksExecutionPolicy>? nextTasksExecutionPolicy;
  ...
  final pulumi.Input<GoogleCloudIntegrationsV1alphaTriggerConfigTriggerType>? triggerType;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'alertConfig': ?pulumi.Input.mapOptionalInputValue<List<GoogleCloudIntegrationsV1alphaIntegrationAlertConfig>, List<Map<String, dynamic>>>(alertConfig, (value) => pulumi.Input.encodeList<GoogleCloudIntegrationsV1alphaIntegrationAlertConfig, Map<String, dynamic>>(value, (value) => value.toMap())),
      'cloudSchedulerConfig': ?pulumi.Input.mapOptionalInputValue<GoogleCloudIntegrationsV1alphaCloudSchedulerConfig, Map<String, dynamic>>(cloudSchedulerConfig, (value) => value.toMap()),
      'description': ?description,
      'errorCatcherId': ?errorCatcherId,
      'label': ?label,
      'nextTasksExecutionPolicy': ?pulumi.Input.mapOptionalInputValue<GoogleCloudIntegrationsV1alphaTriggerConfigNextTasksExecutionPolicy, String>(nextTasksExecutionPolicy, (value) => value.wireValue),
      ...
      'startTasks': ?pulumi.Input.mapOptionalInputValue<List<GoogleCloudIntegrationsV1alphaNextTask>, List<Map<String, dynamic>>>(startTasks, (value) => pulumi.Input.encodeList<GoogleCloudIntegrationsV1alphaNextTask, Map<String, dynamic>>(value, (value) => value.toMap())),
      'trigger': ?trigger,
      'triggerId': ?triggerId,
      'triggerNumber': triggerNumber,
      'triggerType': ?pulumi.Input.mapOptionalInputValue<GoogleCloudIntegrationsV1alphaTriggerConfigTriggerType, String>(triggerType, (value) => value.wireValue),
    };
  }
  ...
  factory GoogleCloudIntegrationsV1alphaTriggerConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudIntegrationsV1alphaTriggerConfig(
      alertConfig: (() { final guardedValue = map['alertConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudIntegrationsV1alphaIntegrationAlertConfig>(guardedValue, (value) => GoogleCloudIntegrationsV1alphaIntegrationAlertConfig.fromMap((value as Map).cast<String, dynamic>()))); })(),
      cloudSchedulerConfig: (() { final guardedValue = map['cloudSchedulerConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudIntegrationsV1alphaCloudSchedulerConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      nextTasksExecutionPolicy: (() { final guardedValue = map['nextTasksExecutionPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudIntegrationsV1alphaTriggerConfigNextTasksExecutionPolicy.fromValue(guardedValue as String)); })(),
      ...
      startTasks: (() { final guardedValue = map['startTasks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudIntegrationsV1alphaNextTask>(guardedValue, (value) => GoogleCloudIntegrationsV1alphaNextTask.fromMap((value as Map).cast<String, dynamic>()))); })(),
      trigger: (() { final guardedValue = map['trigger']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      triggerType: (() { final guardedValue = map['triggerType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudIntegrationsV1alphaTriggerConfigTriggerType.fromValue(guardedValue as String)); })(),
    );
  }
}
