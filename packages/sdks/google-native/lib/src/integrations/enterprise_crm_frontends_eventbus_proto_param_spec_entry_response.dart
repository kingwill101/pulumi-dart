...
class EnterpriseCrmFrontendsEventbusProtoParamSpecEntryResponse {
  ...
  factory EnterpriseCrmFrontendsEventbusProtoParamSpecEntryResponse.fromMap(Map<String, dynamic> map) {
    return EnterpriseCrmFrontendsEventbusProtoParamSpecEntryResponse(
      ...
      collectionElementClassName: (map['collectionElementClassName'] as String).input(),
      config: (EnterpriseCrmEventbusProtoParamSpecEntryConfigResponse.fromMap((map['config'] as Map).cast<String, dynamic>())).input(),
      ...
      isOutput: (map['isOutput'] as bool).input(),
      jsonSchema: (map['jsonSchema'] as String).input(),
      key: (map['key'] as String).input(),
      protoDef: (EnterpriseCrmEventbusProtoParamSpecEntryProtoDefinitionResponse.fromMap((map['protoDef'] as Map).cast<String, dynamic>())).input(),
      required: (map['required'] as bool).input(),
      validationRule: (EnterpriseCrmEventbusProtoParamSpecEntryValidationRuleResponse.fromMap((map['validationRule'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
