...
class EnterpriseCrmFrontendsEventbusProtoParamSpecEntryResponse {
  ...
  final pulumi.Input<EnterpriseCrmEventbusProtoParamSpecEntryConfigResponse>
  config;
  ...
  factory EnterpriseCrmFrontendsEventbusProtoParamSpecEntryResponse.fromMap(
    ...
    return EnterpriseCrmFrontendsEventbusProtoParamSpecEntryResponse(
      ...
      collectionElementClassName: pulumi.Input.fromValue(
        map['collectionElementClassName'] as String,
      ),
      config: pulumi.Input.fromValue(
        EnterpriseCrmEventbusProtoParamSpecEntryConfigResponse.fromMap(
      ...
      protoDef: pulumi.Input.fromValue(
      ...
      validationRule: pulumi.Input.fromValue(
