...
class GoogleCloudIntegrationsV1alphaMockConfigResponse {
  ...
  factory GoogleCloudIntegrationsV1alphaMockConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudIntegrationsV1alphaMockConfigResponse(
      failedExecutions: (map['failedExecutions'] as String).input(),
      mockStrategy: (map['mockStrategy'] as String).input(),
      parameters: (pulumi.Input.decodeList<GoogleCloudIntegrationsV1alphaEventParameterResponse>(map['parameters'], (value) => GoogleCloudIntegrationsV1alphaEventParameterResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
