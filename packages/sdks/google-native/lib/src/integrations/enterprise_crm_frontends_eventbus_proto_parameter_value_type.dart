...
class EnterpriseCrmFrontendsEventbusProtoParameterValueType {
  final pulumi.Input<EnterpriseCrmFrontendsEventbusProtoBooleanParameterArray>?
  booleanArray;
  final pulumi.Input<bool>? booleanValue;
  final pulumi.Input<EnterpriseCrmFrontendsEventbusProtoDoubleParameterArray>?
  doubleArray;
  final pulumi.Input<double>? doubleValue;
  final pulumi.Input<EnterpriseCrmFrontendsEventbusProtoIntParameterArray>?
  intArray;
  final pulumi.Input<String>? intValue;
  final pulumi.Input<String>? jsonValue;
  final pulumi.Input<EnterpriseCrmFrontendsEventbusProtoProtoParameterArray>?
  protoArray;
  ...
  final pulumi.Input<EnterpriseCrmFrontendsEventbusProtoStringParameterArray>?
  stringArray;
  ...
  factory EnterpriseCrmFrontendsEventbusProtoParameterValueType.fromMap(
    ...
    return EnterpriseCrmFrontendsEventbusProtoParameterValueType(
      ...
      serializedObjectValue: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          EnterpriseCrmFrontendsEventbusProtoSerializedObjectParameter.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
