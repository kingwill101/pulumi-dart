...
class EnterpriseCrmFrontendsEventbusProtoParamSpecEntry {
  ...
  const EnterpriseCrmFrontendsEventbusProtoParamSpecEntry({
    this.className,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'dataType': ?pulumi.Input.mapOptionalInputValue<EnterpriseCrmFrontendsEventbusProtoParamSpecEntryDataType, String>(dataType, (value) => value.wireValue),
  ...
  factory EnterpriseCrmFrontendsEventbusProtoParamSpecEntry.fromMap(Map<String, dynamic> map) {
    return EnterpriseCrmFrontendsEventbusProtoParamSpecEntry(
      ...
      collectionElementClassName: (() { final guardedValue = map['collectionElementClassName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      config: (() { final guardedValue = map['config']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EnterpriseCrmEventbusProtoParamSpecEntryConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      dataType: (() { final guardedValue = map['dataType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EnterpriseCrmFrontendsEventbusProtoParamSpecEntryDataType.fromValue(guardedValue as String)); })(),
      ...
      isOutput: (() { final guardedValue = map['isOutput']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      protoDef: (() { final guardedValue = map['protoDef']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EnterpriseCrmEventbusProtoParamSpecEntryProtoDefinition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      validationRule: (() { final guardedValue = map['validationRule']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EnterpriseCrmEventbusProtoParamSpecEntryValidationRule.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
