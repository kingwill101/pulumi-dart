...
class EnterpriseCrmFrontendsEventbusProtoParamSpecEntry {
  ...
  final pulumi.Input<EnterpriseCrmFrontendsEventbusProtoParamSpecEntryDataType>?
  dataType;
  ...
  final pulumi.Input<EnterpriseCrmEventbusProtoParamSpecEntryProtoDefinition>?
  protoDef;
  ...
  final pulumi.Input<EnterpriseCrmEventbusProtoParamSpecEntryValidationRule>?
  validationRule;
    ...
    return <String, dynamic>{
      ...
      'protoDef':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(protoDef, (value) => value.toMap()),
      'required': ?required,
      'validationRule':
          ?pulumi.Input.mapOptionalInputValue<
            EnterpriseCrmEventbusProtoParamSpecEntryValidationRule,
            Map<String, dynamic>
          >(validationRule, (value) => value.toMap()),
    };
  }
  ...
  factory EnterpriseCrmFrontendsEventbusProtoParamSpecEntry.fromMap(
    ...
    return EnterpriseCrmFrontendsEventbusProtoParamSpecEntry(
      ...
      collectionElementClassName: (() {
        final guardedValue = map['collectionElementClassName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      config: (() {
      ...
      isOutput: (() {
        final guardedValue = map['isOutput'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      jsonSchema: (() {
      ...
      protoDef: (() {
        final guardedValue = map['protoDef'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      validationRule: (() {
        final guardedValue = map['validationRule'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
