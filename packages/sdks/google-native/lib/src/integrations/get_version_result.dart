...
class GetVersionResult {
  ...
  final GoogleCloudIntegrationsV1alphaCloudLoggingDetailsResponse cloudLoggingDetails;
  /// Auto-generated.
  ...
  final List<GoogleCloudIntegrationsV1alphaIntegrationParameterResponse> integrationParameters;
  /// Optional. Parameters that are expected to be passed to the integration when an event is triggered. This consists of all the parameters that are expected in the integration execution. This gives the user the ability to provide default values, add information like PII and also provide data types of each parameter.
  final EnterpriseCrmFrontendsEventbusProtoWorkflowParametersResponse integrationParametersInternal;
  ...
  /// Optional. Task configuration for the integration. It's optional, but the integration doesn't do anything without task_configs.
  final List<EnterpriseCrmFrontendsEventbusProtoTaskConfigResponse> taskConfigsInternal;
  /// Optional. Contains a graph of tasks that will be executed before putting the event in a terminal state (SUCCEEDED/FAILED/FATAL), regardless of success or failure, similar to "finally" in code.
  final EnterpriseCrmEventbusProtoTeardownResponse teardown;
  /// Optional. Trigger configurations.
  final List<GoogleCloudIntegrationsV1alphaTriggerConfigResponse> triggerConfigs;
  /// Optional. Trigger configurations.
  final List<EnterpriseCrmFrontendsEventbusProtoTriggerConfigResponse> triggerConfigsInternal;
  /// Auto-generated.
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'cloudLoggingDetails': cloudLoggingDetails.toMap(),
      ...
      'integrationParameters': pulumi.Input.encodeList<GoogleCloudIntegrationsV1alphaIntegrationParameterResponse, Map<String, dynamic>>(integrationParameters, (value) => value.toMap()),
      'integrationParametersInternal': integrationParametersInternal.toMap(),
      ...
      'state': state,
      'status': status,
      'taskConfigs': pulumi.Input.encodeList<GoogleCloudIntegrationsV1alphaTaskConfigResponse, Map<String, dynamic>>(taskConfigs, (value) => value.toMap()),
      'taskConfigsInternal': pulumi.Input.encodeList<EnterpriseCrmFrontendsEventbusProtoTaskConfigResponse, Map<String, dynamic>>(taskConfigsInternal, (value) => value.toMap()),
      'teardown': teardown.toMap(),
      'triggerConfigs': pulumi.Input.encodeList<GoogleCloudIntegrationsV1alphaTriggerConfigResponse, Map<String, dynamic>>(triggerConfigs, (value) => value.toMap()),
      'triggerConfigsInternal': pulumi.Input.encodeList<EnterpriseCrmFrontendsEventbusProtoTriggerConfigResponse, Map<String, dynamic>>(triggerConfigsInternal, (value) => value.toMap()),
  ...
  factory GetVersionResult.fromMap(Map<String, dynamic> map) {
    return GetVersionResult(
      cloudLoggingDetails: GoogleCloudIntegrationsV1alphaCloudLoggingDetailsResponse.fromMap((map['cloudLoggingDetails']! as Map).cast<String, dynamic>()),
      ...
      integrationParameters: pulumi.Input.decodeList<GoogleCloudIntegrationsV1alphaIntegrationParameterResponse>(map['integrationParameters']!, (value) => GoogleCloudIntegrationsV1alphaIntegrationParameterResponse.fromMap((value as Map).cast<String, dynamic>())),
      integrationParametersInternal: EnterpriseCrmFrontendsEventbusProtoWorkflowParametersResponse.fromMap((map['integrationParametersInternal']! as Map).cast<String, dynamic>()),
      ...
      taskConfigs: pulumi.Input.decodeList<GoogleCloudIntegrationsV1alphaTaskConfigResponse>(map['taskConfigs']!, (value) => GoogleCloudIntegrationsV1alphaTaskConfigResponse.fromMap((value as Map).cast<String, dynamic>())),
      taskConfigsInternal: pulumi.Input.decodeList<EnterpriseCrmFrontendsEventbusProtoTaskConfigResponse>(map['taskConfigsInternal']!, (value) => EnterpriseCrmFrontendsEventbusProtoTaskConfigResponse.fromMap((value as Map).cast<String, dynamic>())),
      teardown: EnterpriseCrmEventbusProtoTeardownResponse.fromMap((map['teardown']! as Map).cast<String, dynamic>()),
      triggerConfigs: pulumi.Input.decodeList<GoogleCloudIntegrationsV1alphaTriggerConfigResponse>(map['triggerConfigs']!, (value) => GoogleCloudIntegrationsV1alphaTriggerConfigResponse.fromMap((value as Map).cast<String, dynamic>())),
      triggerConfigsInternal: pulumi.Input.decodeList<EnterpriseCrmFrontendsEventbusProtoTriggerConfigResponse>(map['triggerConfigsInternal']!, (value) => EnterpriseCrmFrontendsEventbusProtoTriggerConfigResponse.fromMap((value as Map).cast<String, dynamic>())),
