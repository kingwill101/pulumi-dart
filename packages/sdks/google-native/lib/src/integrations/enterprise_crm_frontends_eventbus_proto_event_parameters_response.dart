...
class EnterpriseCrmFrontendsEventbusProtoEventParametersResponse {
  ...
  final List<EnterpriseCrmFrontendsEventbusProtoParameterEntryResponse> parameters;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'parameters': pulumi.Input.encodeList<EnterpriseCrmFrontendsEventbusProtoParameterEntryResponse, Map<String, dynamic>>(parameters, (value) => value.toMap()),
    };
  }
  ...
  factory EnterpriseCrmFrontendsEventbusProtoEventParametersResponse.fromMap(Map<String, dynamic> map) {
    return EnterpriseCrmFrontendsEventbusProtoEventParametersResponse(
      parameters: pulumi.Input.decodeList<EnterpriseCrmFrontendsEventbusProtoParameterEntryResponse>(map['parameters'], (value) => EnterpriseCrmFrontendsEventbusProtoParameterEntryResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
