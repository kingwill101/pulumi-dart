...
class EnterpriseCrmEventbusProtoParamSpecEntryValidationRule {
  ...
  factory EnterpriseCrmEventbusProtoParamSpecEntryValidationRule.fromMap(Map<String, dynamic> map) {
    return EnterpriseCrmEventbusProtoParamSpecEntryValidationRule(
      doubleRange: (() { final guardedValue = map['doubleRange']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EnterpriseCrmEventbusProtoParamSpecEntryValidationRuleDoubleRange.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      intRange: (() { final guardedValue = map['intRange']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EnterpriseCrmEventbusProtoParamSpecEntryValidationRuleIntRange.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      stringRegex: (() { final guardedValue = map['stringRegex']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EnterpriseCrmEventbusProtoParamSpecEntryValidationRuleStringRegex.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
