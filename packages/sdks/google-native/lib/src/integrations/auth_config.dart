...
class AuthConfig extends pulumi.CustomResource {
  ...
  AuthConfig(
    ...
    this.clientCertificateEncryptedPrivateKey = registerOutput<String?>('clientCertificateEncryptedPrivateKey');
    this.clientCertificatePassphrase = registerOutput<String?>('clientCertificatePassphrase');
    this.clientCertificateSslCertificate = registerOutput<String?>('clientCertificateSslCertificate');
    this.createTime = registerOutput<String>('createTime');
    this.creatorEmail = registerOutput<String>('creatorEmail');
    this.credentialType = registerOutput<String>('credentialType');
    this.decryptedCredential = registerOutput<GoogleCloudIntegrationsV1alphaCredentialResponse>('decryptedCredential');
    this.description = registerOutput<String>('description');
    this.displayName = registerOutput<String>('displayName');
    this.encryptedCredential = registerOutput<String>('encryptedCredential');
    this.expiryNotificationDuration = registerOutput<List<String>>('expiryNotificationDuration');
