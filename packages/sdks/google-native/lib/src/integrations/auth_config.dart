...
class AuthConfig extends pulumi.CustomResource {
  ...
  AuthConfig(
    ...
    clientCertificateEncryptedPrivateKey = registerOutput<String?>(
      'clientCertificateEncryptedPrivateKey',
    );
    clientCertificatePassphrase = registerOutput<String?>(
      'clientCertificatePassphrase',
    );
    clientCertificateSslCertificate = registerOutput<String?>(
    ...
    expiryNotificationDuration = registerOutput<List<String>>(
