...
class EnterpriseCrmEventbusProtoNextTaskResponse {
  ...
  final List<EnterpriseCrmEventbusProtoCombinedConditionResponse> combinedConditions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'combinedConditions': pulumi.Input.encodeList<EnterpriseCrmEventbusProtoCombinedConditionResponse, Map<String, dynamic>>(combinedConditions, (value) => value.toMap()),
      'condition': condition,
  ...
  factory EnterpriseCrmEventbusProtoNextTaskResponse.fromMap(Map<String, dynamic> map) {
    return EnterpriseCrmEventbusProtoNextTaskResponse(
      combinedConditions: pulumi.Input.decodeList<EnterpriseCrmEventbusProtoCombinedConditionResponse>(map['combinedConditions'], (value) => EnterpriseCrmEventbusProtoCombinedConditionResponse.fromMap((value as Map).cast<String, dynamic>())),
