...
class EnterpriseCrmFrontendsEventbusProtoWorkflowParameterEntryResponse {
  ...
  final pulumi.Input<
    List<EnterpriseCrmFrontendsEventbusProtoWorkflowParameterEntryResponse>
  >
  children;
  ...
  final pulumi.Input<EnterpriseCrmEventbusProtoNodeIdentifierResponse>
  producedBy;
  ...
  factory EnterpriseCrmFrontendsEventbusProtoWorkflowParameterEntryResponse.fromMap(
    ...
    return EnterpriseCrmFrontendsEventbusProtoWorkflowParameterEntryResponse(
      attributes: pulumi.Input.fromValue(
        EnterpriseCrmEventbusProtoAttributesResponse.fromMap(
          (map['attributes']! as Map).cast<String, dynamic>(),
        ),
      ),
      children: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          EnterpriseCrmFrontendsEventbusProtoWorkflowParameterEntryResponse
        >(
          map['children']!,
          (value) =>
              EnterpriseCrmFrontendsEventbusProtoWorkflowParameterEntryResponse.fromMap(
      ...
      producedBy: pulumi.Input.fromValue(
        EnterpriseCrmEventbusProtoNodeIdentifierResponse.fromMap(
