...
class EnterpriseCrmEventbusProtoTaskMetadata {
  ...
  final EnterpriseCrmEventbusProtoTaskMetadataDefaultJsonValidationOption? defaultJsonValidationOption;
  ...
  final EnterpriseCrmEventbusProtoTaskMetadataExternalCategory? externalCategory;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'admins': ?admins == null ? null : pulumi.Input.encodeList<EnterpriseCrmEventbusProtoTaskMetadataAdmin, Map<String, dynamic>>(admins!, (value) => value.toMap()),
      'category': ?category == null ? null : category!.value,
      'codeSearchLink': ?codeSearchLink,
      'defaultJsonValidationOption': ?defaultJsonValidationOption == null ? null : defaultJsonValidationOption!.value,
      'defaultSpec': ?defaultSpec,
      'description': ?description,
      'descriptiveName': ?descriptiveName,
      'docMarkdown': ?docMarkdown,
      'externalCategory': ?externalCategory == null ? null : externalCategory!.value,
  ...
  factory EnterpriseCrmEventbusProtoTaskMetadata.fromMap(Map<String, dynamic> map) {
    return EnterpriseCrmEventbusProtoTaskMetadata(
      activeTaskName: map['activeTaskName'] == null ? null : map['activeTaskName'] as String,
      admins: map['admins'] == null ? null : pulumi.Input.decodeList<EnterpriseCrmEventbusProtoTaskMetadataAdmin>(map['admins'], (value) => EnterpriseCrmEventbusProtoTaskMetadataAdmin.fromMap((value as Map).cast<String, dynamic>())),
      category: map['category'] == null ? null : EnterpriseCrmEventbusProtoTaskMetadataCategory.fromValue(map['category'] as String),
      codeSearchLink: map['codeSearchLink'] == null ? null : map['codeSearchLink'] as String,
      defaultJsonValidationOption: map['defaultJsonValidationOption'] == null ? null : EnterpriseCrmEventbusProtoTaskMetadataDefaultJsonValidationOption.fromValue(map['defaultJsonValidationOption'] as String),
      defaultSpec: map['defaultSpec'] == null ? null : map['defaultSpec'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      descriptiveName: map['descriptiveName'] == null ? null : map['descriptiveName'] as String,
      docMarkdown: map['docMarkdown'] == null ? null : map['docMarkdown'] as String,
      externalCategory: map['externalCategory'] == null ? null : EnterpriseCrmEventbusProtoTaskMetadataExternalCategory.fromValue(map['externalCategory'] as String),
      externalCategorySequence: map['externalCategorySequence'] == null ? null : map['externalCategorySequence'] as int,
      externalDocHtml: map['externalDocHtml'] == null ? null : map['externalDocHtml'] as String,
      externalDocLink: map['externalDocLink'] == null ? null : map['externalDocLink'] as String,
      externalDocMarkdown: map['externalDocMarkdown'] == null ? null : map['externalDocMarkdown'] as String,
      g3DocLink: map['g3DocLink'] == null ? null : map['g3DocLink'] as String,
      iconLink: map['iconLink'] == null ? null : map['iconLink'] as String,
      isDeprecated: map['isDeprecated'] == null ? null : map['isDeprecated'] as bool,
      name: map['name'] == null ? null : map['name'] as String,
      standaloneExternalDocHtml: map['standaloneExternalDocHtml'] == null ? null : map['standaloneExternalDocHtml'] as String,
      status: map['status'] == null ? null : EnterpriseCrmEventbusProtoTaskMetadataStatus.fromValue(map['status'] as String),
      system: map['system'] == null ? null : EnterpriseCrmEventbusProtoTaskMetadataSystem.fromValue(map['system'] as String),
