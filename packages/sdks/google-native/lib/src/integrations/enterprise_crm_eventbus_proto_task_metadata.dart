...
class EnterpriseCrmEventbusProtoTaskMetadata {
  ...
  final pulumi.Input<EnterpriseCrmEventbusProtoTaskMetadataExternalCategory>?
  externalCategory;
    ...
    return <String, dynamic>{
      ...
      'admins':
          ?pulumi.Input.mapOptionalInputValue<
            List<EnterpriseCrmEventbusProtoTaskMetadataAdmin>,
      ...
      'defaultJsonValidationOption':
          ?pulumi.Input.mapOptionalInputValue<
            EnterpriseCrmEventbusProtoTaskMetadataDefaultJsonValidationOption,
            String
          >(defaultJsonValidationOption, (value) => value.wireValue),
      ...
      'externalCategory':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(externalCategory, (value) => value.wireValue),
  ...
  factory EnterpriseCrmEventbusProtoTaskMetadata.fromMap(
    ...
    return EnterpriseCrmEventbusProtoTaskMetadata(
      activeTaskName: (() {
        final guardedValue = map['activeTaskName'];
      ...
      admins: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EnterpriseCrmEventbusProtoTaskMetadataAdmin>(
            guardedValue,
      ...
      codeSearchLink: (() {
        final guardedValue = map['codeSearchLink'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      defaultJsonValidationOption: (() {
        final guardedValue = map['defaultJsonValidationOption'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      defaultSpec: (() {
        final guardedValue = map['defaultSpec'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      description: (() {
      ...
      descriptiveName: (() {
        final guardedValue = map['descriptiveName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      docMarkdown: (() {
        final guardedValue = map['docMarkdown'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      externalCategory: (() {
        final guardedValue = map['externalCategory'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      externalCategorySequence: (() {
        final guardedValue = map['externalCategorySequence'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      externalDocHtml: (() {
        final guardedValue = map['externalDocHtml'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      externalDocLink: (() {
        final guardedValue = map['externalDocLink'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      externalDocMarkdown: (() {
        final guardedValue = map['externalDocMarkdown'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      g3DocLink: (() {
        final guardedValue = map['g3DocLink'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      iconLink: (() {
        final guardedValue = map['iconLink'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      isDeprecated: (() {
      ...
      standaloneExternalDocHtml: (() {
        final guardedValue = map['standaloneExternalDocHtml'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      status: (() {
