...
class GoogleCloudIntegrationsV1alphaErrorCatcherConfig {
  ...
  final pulumi.Input<List<GoogleCloudIntegrationsV1alphaNextTask>> startErrorTasks;
  ...
  const GoogleCloudIntegrationsV1alphaErrorCatcherConfig({
    this.description,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'startErrorTasks': pulumi.Input.mapInputValue<List<GoogleCloudIntegrationsV1alphaNextTask>, List<Map<String, dynamic>>>(startErrorTasks, (value) => pulumi.Input.encodeList<GoogleCloudIntegrationsV1alphaNextTask, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory GoogleCloudIntegrationsV1alphaErrorCatcherConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudIntegrationsV1alphaErrorCatcherConfig(
      ...
      startErrorTasks: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudIntegrationsV1alphaNextTask>(map['startErrorTasks']!, (value) => GoogleCloudIntegrationsV1alphaNextTask.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
