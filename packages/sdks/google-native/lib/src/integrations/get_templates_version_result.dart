...
class GetTemplatesVersionResult {
  ...
  final List<GoogleCloudIntegrationsV1alphaErrorCatcherConfigResponse> errorCatcherConfigs;
  ...
  final EnterpriseCrmFrontendsEventbusProtoWorkflowParametersResponse templateParameters;
  /// Optional. Trigger configurations.
  final List<EnterpriseCrmFrontendsEventbusProtoTriggerConfigResponse> triggerConfigs;
  /// Auto-generated.
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'errorCatcherConfigs': pulumi.Input.encodeList<GoogleCloudIntegrationsV1alphaErrorCatcherConfigResponse, Map<String, dynamic>>(errorCatcherConfigs, (value) => value.toMap()),
      'lastModifierEmail': lastModifierEmail,
      'name': name,
      'parentIntegrationVersionId': parentIntegrationVersionId,
      'snapshotNumber': snapshotNumber,
      'status': status,
      'taskConfigs': pulumi.Input.encodeList<EnterpriseCrmFrontendsEventbusProtoTaskConfigResponse, Map<String, dynamic>>(taskConfigs, (value) => value.toMap()),
      'teardown': teardown.toMap(),
      'templateParameters': templateParameters.toMap(),
      'triggerConfigs': pulumi.Input.encodeList<EnterpriseCrmFrontendsEventbusProtoTriggerConfigResponse, Map<String, dynamic>>(triggerConfigs, (value) => value.toMap()),
  ...
  factory GetTemplatesVersionResult.fromMap(Map<String, dynamic> map) {
    return GetTemplatesVersionResult(
      ...
      errorCatcherConfigs: pulumi.Input.decodeList<GoogleCloudIntegrationsV1alphaErrorCatcherConfigResponse>(map['errorCatcherConfigs']!, (value) => GoogleCloudIntegrationsV1alphaErrorCatcherConfigResponse.fromMap((value as Map).cast<String, dynamic>())),
      ...
      taskConfigs: pulumi.Input.decodeList<EnterpriseCrmFrontendsEventbusProtoTaskConfigResponse>(map['taskConfigs']!, (value) => EnterpriseCrmFrontendsEventbusProtoTaskConfigResponse.fromMap((value as Map).cast<String, dynamic>())),
      teardown: EnterpriseCrmEventbusProtoTeardownResponse.fromMap((map['teardown']! as Map).cast<String, dynamic>()),
      templateParameters: EnterpriseCrmFrontendsEventbusProtoWorkflowParametersResponse.fromMap((map['templateParameters']! as Map).cast<String, dynamic>()),
      triggerConfigs: pulumi.Input.decodeList<EnterpriseCrmFrontendsEventbusProtoTriggerConfigResponse>(map['triggerConfigs']!, (value) => EnterpriseCrmFrontendsEventbusProtoTriggerConfigResponse.fromMap((value as Map).cast<String, dynamic>())),
