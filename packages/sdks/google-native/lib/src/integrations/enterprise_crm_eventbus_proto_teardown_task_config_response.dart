...
class EnterpriseCrmEventbusProtoTeardownTaskConfigResponse {
  ...
  factory EnterpriseCrmEventbusProtoTeardownTaskConfigResponse.fromMap(Map<String, dynamic> map) {
    return EnterpriseCrmEventbusProtoTeardownTaskConfigResponse(
      ...
      nextTeardownTask: pulumi.Input.fromValue(EnterpriseCrmEventbusProtoNextTeardownTaskResponse.fromMap((map['nextTeardownTask']! as Map).cast<String, dynamic>())),
      parameters: pulumi.Input.fromValue(EnterpriseCrmEventbusProtoEventParametersResponse.fromMap((map['parameters']! as Map).cast<String, dynamic>())),
      properties: pulumi.Input.fromValue(EnterpriseCrmEventbusProtoEventBusPropertiesResponse.fromMap((map['properties']! as Map).cast<String, dynamic>())),
