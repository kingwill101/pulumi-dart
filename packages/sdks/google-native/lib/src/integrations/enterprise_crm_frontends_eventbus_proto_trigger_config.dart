...
class EnterpriseCrmFrontendsEventbusProtoTriggerConfig {
  ...
  final EnterpriseCrmFrontendsEventbusProtoTriggerConfigNextTasksExecutionPolicy? nextTasksExecutionPolicy;
  ...
  final EnterpriseCrmFrontendsEventbusProtoTriggerConfigTriggerType? triggerType;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'alertConfig': ?alertConfig == null ? null : pulumi.Input.encodeList<EnterpriseCrmEventbusProtoWorkflowAlertConfig, Map<String, dynamic>>(alertConfig!, (value) => value.toMap()),
      ...
      'startTasks': ?startTasks == null ? null : pulumi.Input.encodeList<EnterpriseCrmEventbusProtoNextTask, Map<String, dynamic>>(startTasks!, (value) => value.toMap()),
      'triggerCriteria': ?triggerCriteria == null ? null : triggerCriteria!.toMap(),
      'triggerId': ?triggerId,
  ...
  factory EnterpriseCrmFrontendsEventbusProtoTriggerConfig.fromMap(Map<String, dynamic> map) {
    return EnterpriseCrmFrontendsEventbusProtoTriggerConfig(
      alertConfig: map['alertConfig'] == null ? null : pulumi.Input.decodeList<EnterpriseCrmEventbusProtoWorkflowAlertConfig>(map['alertConfig'], (value) => EnterpriseCrmEventbusProtoWorkflowAlertConfig.fromMap((value as Map).cast<String, dynamic>())),
      cloudSchedulerConfig: map['cloudSchedulerConfig'] == null ? null : EnterpriseCrmEventbusProtoCloudSchedulerConfig.fromMap((map['cloudSchedulerConfig'] as Map).cast<String, dynamic>()),
      ...
      nextTasksExecutionPolicy: map['nextTasksExecutionPolicy'] == null ? null : EnterpriseCrmFrontendsEventbusProtoTriggerConfigNextTasksExecutionPolicy.fromValue(map['nextTasksExecutionPolicy'] as String),
      pauseWorkflowExecutions: map['pauseWorkflowExecutions'] == null ? null : map['pauseWorkflowExecutions'] as bool,
      position: map['position'] == null ? null : EnterpriseCrmEventbusProtoCoordinate.fromMap((map['position'] as Map).cast<String, dynamic>()),
      properties: map['properties'] == null ? null : (map['properties'] as Map).cast<String, String>(),
      startTasks: map['startTasks'] == null ? null : pulumi.Input.decodeList<EnterpriseCrmEventbusProtoNextTask>(map['startTasks'], (value) => EnterpriseCrmEventbusProtoNextTask.fromMap((value as Map).cast<String, dynamic>())),
      triggerCriteria: map['triggerCriteria'] == null ? null : EnterpriseCrmEventbusProtoTriggerCriteria.fromMap((map['triggerCriteria'] as Map).cast<String, dynamic>()),
      ...
      triggerType: map['triggerType'] == null ? null : EnterpriseCrmFrontendsEventbusProtoTriggerConfigTriggerType.fromValue(map['triggerType'] as String),
    );
  }
}
