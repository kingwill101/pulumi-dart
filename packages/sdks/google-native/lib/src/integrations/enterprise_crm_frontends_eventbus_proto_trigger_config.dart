...
class EnterpriseCrmFrontendsEventbusProtoTriggerConfig {
  ...
  final pulumi.Input<List<EnterpriseCrmEventbusProtoWorkflowAlertConfig>>? alertConfig;
  final pulumi.Input<EnterpriseCrmEventbusProtoCloudSchedulerConfig>? cloudSchedulerConfig;
  ...
  final pulumi.Input<EnterpriseCrmFrontendsEventbusProtoTriggerConfigNextTasksExecutionPolicy>? nextTasksExecutionPolicy;
  ...
  final pulumi.Input<EnterpriseCrmEventbusProtoTriggerCriteria>? triggerCriteria;
  ...
  final pulumi.Input<EnterpriseCrmFrontendsEventbusProtoTriggerConfigTriggerType>? triggerType;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'alertConfig': ?pulumi.Input.mapOptionalInputValue<List<EnterpriseCrmEventbusProtoWorkflowAlertConfig>, List<Map<String, dynamic>>>(alertConfig, (value) => pulumi.Input.encodeList<EnterpriseCrmEventbusProtoWorkflowAlertConfig, Map<String, dynamic>>(value, (value) => value.toMap())),
      'cloudSchedulerConfig': ?pulumi.Input.mapOptionalInputValue<EnterpriseCrmEventbusProtoCloudSchedulerConfig, Map<String, dynamic>>(cloudSchedulerConfig, (value) => value.toMap()),
      'description': ?description,
      'enabledClients': enabledClients,
      'errorCatcherId': ?errorCatcherId,
      'label': ?label,
      'nextTasksExecutionPolicy': ?pulumi.Input.mapOptionalInputValue<EnterpriseCrmFrontendsEventbusProtoTriggerConfigNextTasksExecutionPolicy, String>(nextTasksExecutionPolicy, (value) => value.wireValue),
      ...
      'startTasks': ?pulumi.Input.mapOptionalInputValue<List<EnterpriseCrmEventbusProtoNextTask>, List<Map<String, dynamic>>>(startTasks, (value) => pulumi.Input.encodeList<EnterpriseCrmEventbusProtoNextTask, Map<String, dynamic>>(value, (value) => value.toMap())),
      'triggerCriteria': ?pulumi.Input.mapOptionalInputValue<EnterpriseCrmEventbusProtoTriggerCriteria, Map<String, dynamic>>(triggerCriteria, (value) => value.toMap()),
      'triggerId': ?triggerId,
      'triggerName': ?triggerName,
      'triggerNumber': triggerNumber,
      'triggerType': ?pulumi.Input.mapOptionalInputValue<EnterpriseCrmFrontendsEventbusProtoTriggerConfigTriggerType, String>(triggerType, (value) => value.wireValue),
    };
  }
  ...
  factory EnterpriseCrmFrontendsEventbusProtoTriggerConfig.fromMap(Map<String, dynamic> map) {
    return EnterpriseCrmFrontendsEventbusProtoTriggerConfig(
      alertConfig: (() { final guardedValue = map['alertConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<EnterpriseCrmEventbusProtoWorkflowAlertConfig>(guardedValue, (value) => EnterpriseCrmEventbusProtoWorkflowAlertConfig.fromMap((value as Map).cast<String, dynamic>()))); })(),
      cloudSchedulerConfig: (() { final guardedValue = map['cloudSchedulerConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EnterpriseCrmEventbusProtoCloudSchedulerConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      nextTasksExecutionPolicy: (() { final guardedValue = map['nextTasksExecutionPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EnterpriseCrmFrontendsEventbusProtoTriggerConfigNextTasksExecutionPolicy.fromValue(guardedValue as String)); })(),
      pauseWorkflowExecutions: (() { final guardedValue = map['pauseWorkflowExecutions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      startTasks: (() { final guardedValue = map['startTasks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<EnterpriseCrmEventbusProtoNextTask>(guardedValue, (value) => EnterpriseCrmEventbusProtoNextTask.fromMap((value as Map).cast<String, dynamic>()))); })(),
      triggerCriteria: (() { final guardedValue = map['triggerCriteria']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EnterpriseCrmEventbusProtoTriggerCriteria.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      triggerType: (() { final guardedValue = map['triggerType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EnterpriseCrmFrontendsEventbusProtoTriggerConfigTriggerType.fromValue(guardedValue as String)); })(),
    );
  }
}
