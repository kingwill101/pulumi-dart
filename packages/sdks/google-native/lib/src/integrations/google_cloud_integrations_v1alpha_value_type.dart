...
class GoogleCloudIntegrationsV1alphaValueType {
  ...
  factory GoogleCloudIntegrationsV1alphaValueType.fromMap(Map<String, dynamic> map) {
    return GoogleCloudIntegrationsV1alphaValueType(
      booleanArray: map['booleanArray'] == null ? null : GoogleCloudIntegrationsV1alphaBooleanParameterArray.fromMap((map['booleanArray'] as Map).cast<String, dynamic>()),
      booleanValue: map['booleanValue'] == null ? null : map['booleanValue'] as bool,
      doubleArray: map['doubleArray'] == null ? null : GoogleCloudIntegrationsV1alphaDoubleParameterArray.fromMap((map['doubleArray'] as Map).cast<String, dynamic>()),
      doubleValue: map['doubleValue'] == null ? null : map['doubleValue'] as double,
      intArray: map['intArray'] == null ? null : GoogleCloudIntegrationsV1alphaIntParameterArray.fromMap((map['intArray'] as Map).cast<String, dynamic>()),
      intValue: map['intValue'] == null ? null : map['intValue'] as String,
      jsonValue: map['jsonValue'] == null ? null : map['jsonValue'] as String,
      stringArray: map['stringArray'] == null ? null : GoogleCloudIntegrationsV1alphaStringParameterArray.fromMap((map['stringArray'] as Map).cast<String, dynamic>()),
