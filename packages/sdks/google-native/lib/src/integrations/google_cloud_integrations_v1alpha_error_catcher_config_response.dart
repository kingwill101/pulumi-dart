...
class GoogleCloudIntegrationsV1alphaErrorCatcherConfigResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'startErrorTasks': pulumi.Input.encodeList<GoogleCloudIntegrationsV1alphaNextTaskResponse, Map<String, dynamic>>(startErrorTasks, (value) => value.toMap()),
    };
  }
  ...
  factory GoogleCloudIntegrationsV1alphaErrorCatcherConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudIntegrationsV1alphaErrorCatcherConfigResponse(
      ...
      startErrorTasks: pulumi.Input.decodeList<GoogleCloudIntegrationsV1alphaNextTaskResponse>(map['startErrorTasks'], (value) => GoogleCloudIntegrationsV1alphaNextTaskResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
