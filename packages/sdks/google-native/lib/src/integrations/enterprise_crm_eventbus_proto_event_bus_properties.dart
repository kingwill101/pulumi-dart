...
class EnterpriseCrmEventbusProtoEventBusProperties {
  ...
  const EnterpriseCrmEventbusProtoEventBusProperties({
    this.properties,
  });
  ...
  factory EnterpriseCrmEventbusProtoEventBusProperties.fromMap(Map<String, dynamic> map) {
    return EnterpriseCrmEventbusProtoEventBusProperties(
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<EnterpriseCrmEventbusProtoPropertyEntry>(guardedValue, (value) => EnterpriseCrmEventbusProtoPropertyEntry.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
