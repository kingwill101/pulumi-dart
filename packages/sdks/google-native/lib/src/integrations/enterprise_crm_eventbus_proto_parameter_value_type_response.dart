...
class EnterpriseCrmEventbusProtoParameterValueTypeResponse {
  final pulumi.Input<EnterpriseCrmEventbusProtoBooleanParameterArrayResponse>
  booleanArray;
  final pulumi.Input<bool> booleanValue;
  final pulumi.Input<EnterpriseCrmEventbusProtoDoubleParameterArrayResponse>
  doubleArray;
  final pulumi.Input<double> doubleValue;
  final pulumi.Input<EnterpriseCrmEventbusProtoIntParameterArrayResponse>
  intArray;
  final pulumi.Input<String> intValue;
  final pulumi.Input<EnterpriseCrmEventbusProtoProtoParameterArrayResponse>
  protoArray;
  ...
  final pulumi.Input<EnterpriseCrmEventbusProtoStringParameterArrayResponse>
  stringArray;
  ...
  factory EnterpriseCrmEventbusProtoParameterValueTypeResponse.fromMap(
    ...
    return EnterpriseCrmEventbusProtoParameterValueTypeResponse(
      ...
      intArray: pulumi.Input.fromValue(
        EnterpriseCrmEventbusProtoIntParameterArrayResponse.fromMap(
      ...
      protoArray: pulumi.Input.fromValue(
        EnterpriseCrmEventbusProtoProtoParameterArrayResponse.fromMap(
