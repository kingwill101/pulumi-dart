...
class Instance extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<NodeResponse>> memcacheNodes;
  ...
  Instance(
    ...
    this.instanceMessages = registerOutput<List<InstanceMessageResponse>>('instanceMessages');
    this.labels = registerOutput<Map<String, String>>('labels');
    this.location = registerOutput<String>('location');
    this.maintenancePolicy = registerOutput<GoogleCloudMemcacheV1MaintenancePolicyResponse>('maintenancePolicy');
    ...
    this.memcacheNodes = registerOutput<List<NodeResponse>>('memcacheNodes');
