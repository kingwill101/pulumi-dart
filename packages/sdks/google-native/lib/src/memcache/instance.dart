...
class Instance extends pulumi.CustomResource {
  ...
  late final pulumi.Output<GoogleCloudMemcacheV1MaintenancePolicyResponse> maintenancePolicy;
  ...
  Instance(
    ...
    maintenancePolicy = registerOutput<GoogleCloudMemcacheV1MaintenancePolicyResponse>('maintenancePolicy', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return GoogleCloudMemcacheV1MaintenancePolicyResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    parameters = registerOutput<MemcacheParametersResponse>('parameters', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return MemcacheParametersResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
