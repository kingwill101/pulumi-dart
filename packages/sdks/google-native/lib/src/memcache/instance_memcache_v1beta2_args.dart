...
class InstanceMemcacheV1beta2Args {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'memcacheVersion': ?pulumi.Input.mapOptionalInputValue<InstanceMemcacheVersionMemcacheV1beta2, String>(memcacheVersion, (value) => value.wireValue),
      'name': ?name,
  ...
  factory InstanceMemcacheV1beta2Args.fromMap(Map<String, dynamic> map) {
    return InstanceMemcacheV1beta2Args(
      ...
      instanceMessages: (() { final guardedValue = map['instanceMessages']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InstanceMessageMemcacheV1beta2>(guardedValue, (value) => InstanceMessageMemcacheV1beta2.fromMap((value as Map).cast<String, dynamic>()))); })(),
      labels: (() { final guardedValue = map['labels']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      location: (() { final guardedValue = map['location']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      maintenancePolicy: (() { final guardedValue = map['maintenancePolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudMemcacheV1beta2MaintenancePolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      memcacheVersion: (() { final guardedValue = map['memcacheVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceMemcacheVersionMemcacheV1beta2.fromValue(guardedValue as String)); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      nodeConfig: pulumi.Input.fromValue(NodeConfigMemcacheV1beta2.fromMap((map['nodeConfig']! as Map).cast<String, dynamic>())),
      nodeCount: pulumi.Input.fromValue(map['nodeCount'] as int),
      parameters: (() { final guardedValue = map['parameters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MemcacheParametersMemcacheV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
