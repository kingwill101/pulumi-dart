...
class InstanceArgs {
  ...
  InstanceArgs({
    ...
    pulumi.Output<List<InstanceMessage>>? instanceMessages,
    pulumi.Output<Map<String, String>>? labels,
    pulumi.Output<String>? location,
    pulumi.Output<GoogleCloudMemcacheV1MaintenancePolicy>? maintenancePolicy,
    pulumi.Output<InstanceMemcacheVersion>? memcacheVersion,
    pulumi.Output<String>? name,
    required pulumi.Output<NodeConfig> nodeConfig,
    required pulumi.Output<int> nodeCount,
    pulumi.Output<MemcacheParameters>? parameters,
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      ...
      instanceMessages: map['instanceMessages'] == null ? null : pulumi.Output.create<List<InstanceMessage>>(pulumi.Input.decodeList<InstanceMessage>(map['instanceMessages'], (value) => InstanceMessage.fromMap((value as Map).cast<String, dynamic>()))),
      labels: map['labels'] == null ? null : pulumi.Output.create<Map<String, String>>((map['labels'] as Map).cast<String, String>()),
      location: map['location'] == null ? null : pulumi.Output.create<String>(map['location'] as String),
      maintenancePolicy: map['maintenancePolicy'] == null ? null : pulumi.Output.create<GoogleCloudMemcacheV1MaintenancePolicy>(GoogleCloudMemcacheV1MaintenancePolicy.fromMap((map['maintenancePolicy'] as Map).cast<String, dynamic>())),
      memcacheVersion: map['memcacheVersion'] == null ? null : pulumi.Output.create<InstanceMemcacheVersion>(InstanceMemcacheVersion.fromValue(map['memcacheVersion'] as String)),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      nodeConfig: pulumi.Output.create<NodeConfig>(NodeConfig.fromMap((map['nodeConfig'] as Map).cast<String, dynamic>())),
      nodeCount: pulumi.Output.create<int>(map['nodeCount'] as int),
      parameters: map['parameters'] == null ? null : pulumi.Output.create<MemcacheParameters>(MemcacheParameters.fromMap((map['parameters'] as Map).cast<String, dynamic>())),
