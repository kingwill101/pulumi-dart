  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      ...
      instanceMessages: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InstanceMessage>(
            guardedValue,
            (value) =>
                InstanceMessage.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      labels: (() {
      ...
      memcacheVersion: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          InstanceMemcacheVersion.fromValue(guardedValue as String),
        );
      })(),
      name: (() {
      ...
      nodeConfig: pulumi.Input.fromValue(
        NodeConfig.fromMap((map['nodeConfig']! as Map).cast<String, dynamic>()),
      ),
