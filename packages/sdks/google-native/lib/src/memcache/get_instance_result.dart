...
class GetInstanceResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'instanceMessages': pulumi.Input.encodeList<InstanceMessageResponse, Map<String, dynamic>>(instanceMessages, (value) => value.toMap()),
      'labels': labels,
      ...
      'memcacheNodes': pulumi.Input.encodeList<NodeResponse, Map<String, dynamic>>(memcacheNodes, (value) => value.toMap()),
  ...
  factory GetInstanceResult.fromMap(Map<String, dynamic> map) {
    return GetInstanceResult(
      ...
      instanceMessages: pulumi.Input.decodeList<InstanceMessageResponse>(map['instanceMessages']!, (value) => InstanceMessageResponse.fromMap((value as Map).cast<String, dynamic>())),
      labels: (map['labels'] as Map).cast<String, String>(),
      maintenancePolicy: GoogleCloudMemcacheV1MaintenancePolicyResponse.fromMap((map['maintenancePolicy']! as Map).cast<String, dynamic>()),
      ...
      memcacheNodes: pulumi.Input.decodeList<NodeResponse>(map['memcacheNodes']!, (value) => NodeResponse.fromMap((value as Map).cast<String, dynamic>())),
      ...
      parameters: MemcacheParametersResponse.fromMap((map['parameters']! as Map).cast<String, dynamic>()),
