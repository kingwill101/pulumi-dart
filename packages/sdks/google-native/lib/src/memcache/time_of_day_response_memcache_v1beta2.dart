...
class TimeOfDayResponseMemcacheV1beta2 {
  ...
  /// Creates a new [TimeOfDayResponseMemcacheV1beta2].
  ...
  const TimeOfDayResponseMemcacheV1beta2({
    required this.hours,
  ...
  factory TimeOfDayResponseMemcacheV1beta2.fromMap(Map<String, dynamic> map) {
    return TimeOfDayResponseMemcacheV1beta2(
