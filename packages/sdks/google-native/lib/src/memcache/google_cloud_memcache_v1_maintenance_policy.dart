...
class GoogleCloudMemcacheV1MaintenancePolicy {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'weeklyMaintenanceWindow': pulumi.Input.encodeList<WeeklyMaintenanceWindow, Map<String, dynamic>>(weeklyMaintenanceWindow, (value) => value.toMap()),
    };
  }
  ...
  factory GoogleCloudMemcacheV1MaintenancePolicy.fromMap(Map<String, dynamic> map) {
    return GoogleCloudMemcacheV1MaintenancePolicy(
      ...
      weeklyMaintenanceWindow: pulumi.Input.decodeList<WeeklyMaintenanceWindow>(map['weeklyMaintenanceWindow'], (value) => WeeklyMaintenanceWindow.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
