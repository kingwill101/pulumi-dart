...
class GoogleCloudMemcacheV1MaintenancePolicyResponse {
  ...
  factory GoogleCloudMemcacheV1MaintenancePolicyResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudMemcacheV1MaintenancePolicyResponse(
      ...
      weeklyMaintenanceWindow: (pulumi.Input.decodeList<WeeklyMaintenanceWindowResponse>(map['weeklyMaintenanceWindow'], (value) => WeeklyMaintenanceWindowResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
