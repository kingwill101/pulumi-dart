...
class GoogleCloudDialogflowV2IntentTrainingPhrase {
  ...
  final pulumi.Input<List<GoogleCloudDialogflowV2IntentTrainingPhrasePart>>
  parts;
    ...
    return <String, dynamic>{
      'parts':
          pulumi.Input.mapInputValue<
            List<GoogleCloudDialogflowV2IntentTrainingPhrasePart>,
  ...
  factory GoogleCloudDialogflowV2IntentTrainingPhrase.fromMap(
    ...
    return GoogleCloudDialogflowV2IntentTrainingPhrase(
      parts: pulumi.Input.fromValue(
        pulumi
            .Input.decodeList<GoogleCloudDialogflowV2IntentTrainingPhrasePart>(
          map['parts']!,
      ...
      type: pulumi.Input.fromValue(
        GoogleCloudDialogflowV2IntentTrainingPhraseType.fromValue(
          map['type']! as String,
        ),
      ),
    );
