...
class GoogleCloudDialogflowCxV3VersionVariants {
  /// A list of flow version variants.
  final pulumi.Input<List<GoogleCloudDialogflowCxV3VersionVariantsVariant>>?
  variants;
    ...
    return <String, dynamic>{
      'variants':
          ?pulumi.Input.mapOptionalInputValue<
            List<GoogleCloudDialogflowCxV3VersionVariantsVariant>,
    ...
    return GoogleCloudDialogflowCxV3VersionVariants(
      variants: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => GoogleCloudDialogflowCxV3VersionVariantsVariant.fromMap(
