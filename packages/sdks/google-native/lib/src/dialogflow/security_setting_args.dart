...
class SecuritySettingArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'purgeDataTypes':
          ?pulumi.Input.mapOptionalInputValue<
            List<SecuritySettingPurgeDataTypesItem>,
            List<String>
          >(
            purgeDataTypes,
            (value) =>
    ...
    return SecuritySettingArgs(
      audioExportSettings: (() {
        ...
        return pulumi.Input.fromValue(
          GoogleCloudDialogflowCxV3SecuritySettingsAudioExportSettings.fromMap(
      ...
      insightsExportSettings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GoogleCloudDialogflowCxV3SecuritySettingsInsightsExportSettings.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      redactionScope: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SecuritySettingRedactionScope.fromValue(guardedValue as String),
        );
      })(),
      redactionStrategy: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SecuritySettingRedactionStrategy.fromValue(guardedValue as String),
        );
      })(),
      retentionStrategy: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SecuritySettingRetentionStrategy.fromValue(guardedValue as String),
        );
      })(),
      retentionWindowDays: (() {
