...
class PageDialogflowV3beta1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<GoogleCloudDialogflowCxV3beta1EventHandlerResponse>> eventHandlers;
  ...
  PageDialogflowV3beta1(
    ...
    this.entryFulfillment = registerOutput<GoogleCloudDialogflowCxV3beta1FulfillmentResponse>('entryFulfillment');
    this.eventHandlers = registerOutput<List<GoogleCloudDialogflowCxV3beta1EventHandlerResponse>>('eventHandlers');
    this.flowId = registerOutput<String>('flowId');
    this.form = registerOutput<GoogleCloudDialogflowCxV3beta1FormResponse>('form');
    this.knowledgeConnectorSettings = registerOutput<GoogleCloudDialogflowCxV3beta1KnowledgeConnectorSettingsResponse>('knowledgeConnectorSettings');
