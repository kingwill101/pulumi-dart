...
class GoogleCloudDialogflowV2IntentMessageCard {
  ...
  final pulumi.Input<List<GoogleCloudDialogflowV2IntentMessageCardButton>>? buttons;
  ...
  const GoogleCloudDialogflowV2IntentMessageCard({
    this.buttons,
    this.imageUri,
    this.subtitle,
    this.title,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'buttons': ?pulumi.Input.mapOptionalInputValue<List<GoogleCloudDialogflowV2IntentMessageCardButton>, List<Map<String, dynamic>>>(buttons, (value) => pulumi.Input.encodeList<GoogleCloudDialogflowV2IntentMessageCardButton, Map<String, dynamic>>(value, (value) => value.toMap())),
      'imageUri': ?imageUri,
      'subtitle': ?subtitle,
      'title': ?title,
    };
  ...
  factory GoogleCloudDialogflowV2IntentMessageCard.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2IntentMessageCard(
      buttons: (() { final guardedValue = map['buttons']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudDialogflowV2IntentMessageCardButton>(guardedValue, (value) => GoogleCloudDialogflowV2IntentMessageCardButton.fromMap((value as Map).cast<String, dynamic>()))); })(),
