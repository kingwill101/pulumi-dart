...
class GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionFeatureConfig {
  ...
  final pulumi.Input<GoogleCloudDialogflowV2beta1SuggestionFeature>?
  suggestionFeature;
    ...
    return GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionFeatureConfig(
      conversationModelConfig: (() {
        ...
        return pulumi.Input.fromValue(
          GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigConversationModelConfig.fromMap(
      ...
      conversationProcessConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigConversationProcessConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      queryConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionQueryConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      suggestionTriggerSettings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionTriggerSettings.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
