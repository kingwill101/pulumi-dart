...
class GoogleCloudDialogflowCxV3WebhookGenericWebService {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'httpMethod': ?pulumi.Input.mapOptionalInputValue<GoogleCloudDialogflowCxV3WebhookGenericWebServiceHttpMethod, String>(httpMethod, (value) => value.value),
      ...
      'uri': uri,
      'username': ?username,
      'webhookType': ?pulumi.Input.mapOptionalInputValue<GoogleCloudDialogflowCxV3WebhookGenericWebServiceWebhookType, String>(webhookType, (value) => value.value),
    };
  }
  ...
  factory GoogleCloudDialogflowCxV3WebhookGenericWebService.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3WebhookGenericWebService(
      ...
      httpMethod: map['httpMethod'] == null ? null : (GoogleCloudDialogflowCxV3WebhookGenericWebServiceHttpMethod.fromValue(map['httpMethod']! as String)).input(),
      ...
      webhookType: map['webhookType'] == null ? null : (GoogleCloudDialogflowCxV3WebhookGenericWebServiceWebhookType.fromValue(map['webhookType']! as String)).input(),
    );
  }
}
