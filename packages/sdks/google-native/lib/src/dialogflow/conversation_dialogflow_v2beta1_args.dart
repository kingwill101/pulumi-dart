...
class ConversationDialogflowV2beta1Args {
  ...
  /// [location] Optional.
  /// [project] Optional.
  const ConversationDialogflowV2beta1Args({
    this.conversationId,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'conversationStage': ?pulumi.Input.mapOptionalInputValue<ConversationConversationStageDialogflowV2beta1, String>(conversationStage, (value) => value.wireValue),
      'location': ?location,
      'project': ?project,
    };
  }
  ...
  factory ConversationDialogflowV2beta1Args.fromMap(Map<String, dynamic> map) {
    return ConversationDialogflowV2beta1Args(
      ...
      conversationStage: (() { final guardedValue = map['conversationStage']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConversationConversationStageDialogflowV2beta1.fromValue(guardedValue as String)); })(),
