...
class GoogleCloudDialogflowV2beta1IntentMessageTableCardResponse {
  ...
  final pulumi.Input<
    List<GoogleCloudDialogflowV2beta1IntentMessageColumnPropertiesResponse>
  >
  columnProperties;
  ...
  final pulumi.Input<
    List<GoogleCloudDialogflowV2beta1IntentMessageTableCardRowResponse>
  >
  rows;
  ...
  factory GoogleCloudDialogflowV2beta1IntentMessageTableCardResponse.fromMap(
    ...
    return GoogleCloudDialogflowV2beta1IntentMessageTableCardResponse(
      ...
      columnProperties: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GoogleCloudDialogflowV2beta1IntentMessageColumnPropertiesResponse
        >(
          map['columnProperties']!,
          (value) =>
              GoogleCloudDialogflowV2beta1IntentMessageColumnPropertiesResponse.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
      ...
      rows: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GoogleCloudDialogflowV2beta1IntentMessageTableCardRowResponse
        >(
          map['rows']!,
          (value) =>
              GoogleCloudDialogflowV2beta1IntentMessageTableCardRowResponse.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
