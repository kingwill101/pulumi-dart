...
class GoogleCloudDialogflowCxV3ConversationTurnVirtualAgentOutput {
  ...
  final pulumi.Input<List<GoogleCloudDialogflowCxV3ResponseMessageText>>?
  textResponses;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'textResponses':
          ?pulumi.Input.mapOptionalInputValue<
            List<GoogleCloudDialogflowCxV3ResponseMessageText>,
  ...
  factory GoogleCloudDialogflowCxV3ConversationTurnVirtualAgentOutput.fromMap(
    ...
    return GoogleCloudDialogflowCxV3ConversationTurnVirtualAgentOutput(
      ...
      textResponses: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GoogleCloudDialogflowCxV3ResponseMessageText>(
            guardedValue,
