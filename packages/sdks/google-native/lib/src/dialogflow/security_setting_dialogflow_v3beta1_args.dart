...
class SecuritySettingDialogflowV3beta1Args {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'project': ?project,
      'purgeDataTypes': ?pulumi.Input.mapOptionalInputValue<List<SecuritySettingPurgeDataTypesItemDialogflowV3beta1>, List<String>>(purgeDataTypes, (value) => pulumi.Input.encodeList<SecuritySettingPurgeDataTypesItemDialogflowV3beta1, String>(value, (value) => value.wireValue)),
      'redactionScope': ?pulumi.Input.mapOptionalInputValue<SecuritySettingRedactionScopeDialogflowV3beta1, String>(redactionScope, (value) => value.wireValue),
      'redactionStrategy': ?pulumi.Input.mapOptionalInputValue<SecuritySettingRedactionStrategyDialogflowV3beta1, String>(redactionStrategy, (value) => value.wireValue),
      'retentionStrategy': ?pulumi.Input.mapOptionalInputValue<SecuritySettingRetentionStrategyDialogflowV3beta1, String>(retentionStrategy, (value) => value.wireValue),
  ...
  factory SecuritySettingDialogflowV3beta1Args.fromMap(Map<String, dynamic> map) {
    return SecuritySettingDialogflowV3beta1Args(
      audioExportSettings: (() { final guardedValue = map['audioExportSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowCxV3beta1SecuritySettingsAudioExportSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      insightsExportSettings: (() { final guardedValue = map['insightsExportSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowCxV3beta1SecuritySettingsInsightsExportSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      purgeDataTypes: (() { final guardedValue = map['purgeDataTypes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SecuritySettingPurgeDataTypesItemDialogflowV3beta1>(guardedValue, (value) => SecuritySettingPurgeDataTypesItemDialogflowV3beta1.fromValue(value as String))); })(),
      redactionScope: (() { final guardedValue = map['redactionScope']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SecuritySettingRedactionScopeDialogflowV3beta1.fromValue(guardedValue as String)); })(),
      redactionStrategy: (() { final guardedValue = map['redactionStrategy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SecuritySettingRedactionStrategyDialogflowV3beta1.fromValue(guardedValue as String)); })(),
      retentionStrategy: (() { final guardedValue = map['retentionStrategy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SecuritySettingRetentionStrategyDialogflowV3beta1.fromValue(guardedValue as String)); })(),
