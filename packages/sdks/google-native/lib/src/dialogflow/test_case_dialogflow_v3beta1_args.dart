...
class TestCaseDialogflowV3beta1Args {
  ...
  factory TestCaseDialogflowV3beta1Args.fromMap(Map<String, dynamic> map) {
    return TestCaseDialogflowV3beta1Args(
      ...
      lastTestResult: (() { final guardedValue = map['lastTestResult']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowCxV3beta1TestCaseResult.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      testCaseConversationTurns: (() { final guardedValue = map['testCaseConversationTurns']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudDialogflowCxV3beta1ConversationTurn>(guardedValue, (value) => GoogleCloudDialogflowCxV3beta1ConversationTurn.fromMap((value as Map).cast<String, dynamic>()))); })(),
      testConfig: (() { final guardedValue = map['testConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowCxV3beta1TestConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
