...
class GoogleCloudDialogflowCxV3beta1Intent {
  ...
  final List<GoogleCloudDialogflowCxV3beta1IntentTrainingPhrase>? trainingPhrases;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'labels': ?labels,
      'name': ?name,
      'parameters': ?parameters == null ? null : pulumi.Input.encodeList<GoogleCloudDialogflowCxV3beta1IntentParameter, Map<String, dynamic>>(parameters!, (value) => value.toMap()),
      'priority': ?priority,
      'trainingPhrases': ?trainingPhrases == null ? null : pulumi.Input.encodeList<GoogleCloudDialogflowCxV3beta1IntentTrainingPhrase, Map<String, dynamic>>(trainingPhrases!, (value) => value.toMap()),
    };
  }
