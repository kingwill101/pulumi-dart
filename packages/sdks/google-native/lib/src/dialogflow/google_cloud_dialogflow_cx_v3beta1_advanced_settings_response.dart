...
class GoogleCloudDialogflowCxV3beta1AdvancedSettingsResponse {
  ...
  final GoogleCloudDialogflowCxV3beta1GcsDestinationResponse audioExportGcsDestination;
  /// Settings for DTMF. Exposed at the following levels: - Agent level - Flow level - Page level - Parameter level.
  final GoogleCloudDialogflowCxV3beta1AdvancedSettingsDtmfSettingsResponse dtmfSettings;
  /// Settings for logging. Settings for Dialogflow History, Contact Center messages, StackDriver logs, and speech logging. Exposed at the following levels: - Agent level.
  final GoogleCloudDialogflowCxV3beta1AdvancedSettingsLoggingSettingsResponse loggingSettings;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'audioExportGcsDestination': audioExportGcsDestination.toMap(),
      'dtmfSettings': dtmfSettings.toMap(),
      'loggingSettings': loggingSettings.toMap(),
    };
  }
  ...
  factory GoogleCloudDialogflowCxV3beta1AdvancedSettingsResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3beta1AdvancedSettingsResponse(
      audioExportGcsDestination: GoogleCloudDialogflowCxV3beta1GcsDestinationResponse.fromMap((map['audioExportGcsDestination'] as Map).cast<String, dynamic>()),
      dtmfSettings: GoogleCloudDialogflowCxV3beta1AdvancedSettingsDtmfSettingsResponse.fromMap((map['dtmfSettings'] as Map).cast<String, dynamic>()),
      loggingSettings: GoogleCloudDialogflowCxV3beta1AdvancedSettingsLoggingSettingsResponse.fromMap((map['loggingSettings'] as Map).cast<String, dynamic>()),
    );
  }
}
