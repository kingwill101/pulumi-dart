...
class GoogleCloudDialogflowCxV3beta1AdvancedSettingsResponse {
  ...
  final pulumi.Input<GoogleCloudDialogflowCxV3beta1GcsDestinationResponse>
  ...
  factory GoogleCloudDialogflowCxV3beta1AdvancedSettingsResponse.fromMap(
    ...
    return GoogleCloudDialogflowCxV3beta1AdvancedSettingsResponse(
      ...
      dtmfSettings: pulumi.Input.fromValue(
        GoogleCloudDialogflowCxV3beta1AdvancedSettingsDtmfSettingsResponse.fromMap(
          (map['dtmfSettings']! as Map).cast<String, dynamic>(),
        ),
      ),
      loggingSettings: pulumi.Input.fromValue(
        GoogleCloudDialogflowCxV3beta1AdvancedSettingsLoggingSettingsResponse.fromMap(
