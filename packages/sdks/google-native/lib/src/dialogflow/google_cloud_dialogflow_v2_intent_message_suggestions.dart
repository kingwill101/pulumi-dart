...
class GoogleCloudDialogflowV2IntentMessageSuggestions {
  ...
  factory GoogleCloudDialogflowV2IntentMessageSuggestions.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2IntentMessageSuggestions(
      suggestions: (pulumi.Input.decodeList<GoogleCloudDialogflowV2IntentMessageSuggestion>(map['suggestions'], (value) => GoogleCloudDialogflowV2IntentMessageSuggestion.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
