...
class GoogleCloudDialogflowV2IntentMessageSuggestions {
  ...
  final pulumi.Input<List<GoogleCloudDialogflowV2IntentMessageSuggestion>>
  suggestions;
    ...
    return <String, dynamic>{
      'suggestions':
          pulumi.Input.mapInputValue<
            List<GoogleCloudDialogflowV2IntentMessageSuggestion>,
  ...
  factory GoogleCloudDialogflowV2IntentMessageSuggestions.fromMap(
    ...
    return GoogleCloudDialogflowV2IntentMessageSuggestions(
      suggestions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GoogleCloudDialogflowV2IntentMessageSuggestion>(
          map['suggestions']!,
