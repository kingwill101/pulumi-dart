...
class GetConversationModelResult {
  ...
  final GoogleCloudDialogflowV2ArticleSuggestionModelMetadataResponse
  ...
  final GoogleCloudDialogflowV2SmartReplyModelMetadataResponse
  ...
  factory GetConversationModelResult.fromMap(Map<String, dynamic> map) {
    return GetConversationModelResult(
      articleSuggestionModelMetadata:
          GoogleCloudDialogflowV2ArticleSuggestionModelMetadataResponse.fromMap(
      ...
      smartReplyModelMetadata:
          GoogleCloudDialogflowV2SmartReplyModelMetadataResponse.fromMap(
            (map['smartReplyModelMetadata']! as Map).cast<String, dynamic>(),
          ),
