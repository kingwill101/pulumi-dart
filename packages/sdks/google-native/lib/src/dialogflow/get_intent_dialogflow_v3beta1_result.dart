...
class GetIntentDialogflowV3beta1Result {
  ...
  final List<GoogleCloudDialogflowCxV3beta1IntentTrainingPhraseResponse> trainingPhrases;

  /// Creates a new [GetIntentDialogflowV3beta1Result].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'labels': labels,
      'name': name,
      'parameters': pulumi.Input.encodeList<GoogleCloudDialogflowCxV3beta1IntentParameterResponse, Map<String, dynamic>>(parameters, (value) => value.toMap()),
      'priority': priority,
      'trainingPhrases': pulumi.Input.encodeList<GoogleCloudDialogflowCxV3beta1IntentTrainingPhraseResponse, Map<String, dynamic>>(trainingPhrases, (value) => value.toMap()),
    };
  }
  ...
  factory GetIntentDialogflowV3beta1Result.fromMap(Map<String, dynamic> map) {
    return GetIntentDialogflowV3beta1Result(
      ...
      parameters: pulumi.Input.decodeList<GoogleCloudDialogflowCxV3beta1IntentParameterResponse>(map['parameters']!, (value) => GoogleCloudDialogflowCxV3beta1IntentParameterResponse.fromMap((value as Map).cast<String, dynamic>())),
      priority: map['priority'] as int,
      trainingPhrases: pulumi.Input.decodeList<GoogleCloudDialogflowCxV3beta1IntentTrainingPhraseResponse>(map['trainingPhrases']!, (value) => GoogleCloudDialogflowCxV3beta1IntentTrainingPhraseResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
