...
class GoogleCloudDialogflowCxV3beta1IntentResponse {
  ...
  factory GoogleCloudDialogflowCxV3beta1IntentResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3beta1IntentResponse(
      ...
      isFallback: (map['isFallback'] as bool).input(),
      labels: ((map['labels'] as Map).cast<String, String>()).input(),
      name: (map['name'] as String).input(),
      parameters: (pulumi.Input.decodeList<GoogleCloudDialogflowCxV3beta1IntentParameterResponse>(map['parameters'], (value) => GoogleCloudDialogflowCxV3beta1IntentParameterResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      priority: (map['priority'] as int).input(),
      trainingPhrases: (pulumi.Input.decodeList<GoogleCloudDialogflowCxV3beta1IntentTrainingPhraseResponse>(map['trainingPhrases'], (value) => GoogleCloudDialogflowCxV3beta1IntentTrainingPhraseResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
