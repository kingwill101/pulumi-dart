...
class GoogleCloudDialogflowCxV3beta1IntentResponse {
  ...
  final pulumi.Input<
    List<GoogleCloudDialogflowCxV3beta1IntentParameterResponse>
  >
  parameters;
  ...
  final pulumi.Input<
    List<GoogleCloudDialogflowCxV3beta1IntentTrainingPhraseResponse>
  >
  trainingPhrases;
  ...
  factory GoogleCloudDialogflowCxV3beta1IntentResponse.fromMap(
    ...
    return GoogleCloudDialogflowCxV3beta1IntentResponse(
      ...
      trainingPhrases: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GoogleCloudDialogflowCxV3beta1IntentTrainingPhraseResponse
        >(
          map['trainingPhrases']!,
          (value) =>
              GoogleCloudDialogflowCxV3beta1IntentTrainingPhraseResponse.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
