...
class GoogleCloudDialogflowV2beta1IntentMessageBrowseCarouselCardResponse {
  ...
  factory GoogleCloudDialogflowV2beta1IntentMessageBrowseCarouselCardResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2beta1IntentMessageBrowseCarouselCardResponse(
      imageDisplayOptions: pulumi.Input.fromValue(map['imageDisplayOptions'] as String),
      items: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudDialogflowV2beta1IntentMessageBrowseCarouselCardBrowseCarouselCardItemResponse>(map['items']!, (value) => GoogleCloudDialogflowV2beta1IntentMessageBrowseCarouselCardBrowseCarouselCardItemResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
