...
class GoogleCloudDialogflowV2HumanAgentAssistantConfigMessageAnalysisConfig {
  ...
  const GoogleCloudDialogflowV2HumanAgentAssistantConfigMessageAnalysisConfig({
  ...
  factory GoogleCloudDialogflowV2HumanAgentAssistantConfigMessageAnalysisConfig.fromMap(Map<String, dynamic> map) {
