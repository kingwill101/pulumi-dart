...
class SessionEntityTypeDialogflowV2beta1Args {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'entityOverrideMode': pulumi.Input.mapInputValue<SessionEntityTypeEntityOverrideModeDialogflowV2beta1, String>(entityOverrideMode, (value) => value.wireValue),
  ...
  factory SessionEntityTypeDialogflowV2beta1Args.fromMap(Map<String, dynamic> map) {
    return SessionEntityTypeDialogflowV2beta1Args(
      entities: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudDialogflowV2beta1EntityTypeEntity>(map['entities']!, (value) => GoogleCloudDialogflowV2beta1EntityTypeEntity.fromMap((value as Map).cast<String, dynamic>()))),
      entityOverrideMode: pulumi.Input.fromValue(SessionEntityTypeEntityOverrideModeDialogflowV2beta1.fromValue(map['entityOverrideMode']! as String)),
