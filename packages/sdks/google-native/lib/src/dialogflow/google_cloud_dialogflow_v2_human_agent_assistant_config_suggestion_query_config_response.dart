  ...
  factory GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigResponse.fromMap(
    ...
    return GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigResponse(
      ...
      contextFilterSettings: pulumi.Input.fromValue(
        GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigContextFilterSettingsResponse.fromMap(
          (map['contextFilterSettings']! as Map).cast<String, dynamic>(),
        ),
      ),
      dialogflowQuerySource: pulumi.Input.fromValue(
        GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigDialogflowQuerySourceResponse.fromMap(
          (map['dialogflowQuerySource']! as Map).cast<String, dynamic>(),
        ),
      ),
      documentQuerySource: pulumi.Input.fromValue(
        GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigDocumentQuerySourceResponse.fromMap(
          (map['documentQuerySource']! as Map).cast<String, dynamic>(),
        ),
      ),
      knowledgeBaseQuerySource: pulumi.Input.fromValue(
        GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigKnowledgeBaseQuerySourceResponse.fromMap(
