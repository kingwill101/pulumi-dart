...
class GoogleCloudDialogflowCxV3BargeInConfig {
  ...
  /// Creates a new [GoogleCloudDialogflowCxV3BargeInConfig].
  ...
  factory GoogleCloudDialogflowCxV3BargeInConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3BargeInConfig(
      noBargeInDuration: map['noBargeInDuration'] == null ? null : map['noBargeInDuration'] as String,
      totalDuration: map['totalDuration'] == null ? null : map['totalDuration'] as String,
    );
  }
}
