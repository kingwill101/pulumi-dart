...
class GoogleCloudDialogflowV2beta1IntentMessageRbmSuggestedAction {
  ...
  factory GoogleCloudDialogflowV2beta1IntentMessageRbmSuggestedAction.fromMap(
    ...
    return GoogleCloudDialogflowV2beta1IntentMessageRbmSuggestedAction(
      dial: (() {
        final guardedValue = map['dial'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GoogleCloudDialogflowV2beta1IntentMessageRbmSuggestedActionRbmSuggestedActionDial.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      openUrl: (() {
        final guardedValue = map['openUrl'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GoogleCloudDialogflowV2beta1IntentMessageRbmSuggestedActionRbmSuggestedActionOpenUri.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      shareLocation: (() {
        final guardedValue = map['shareLocation'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as Map).cast<String, dynamic>(),
        );
