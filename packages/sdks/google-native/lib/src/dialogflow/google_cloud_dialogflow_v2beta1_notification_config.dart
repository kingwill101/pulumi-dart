...
class GoogleCloudDialogflowV2beta1NotificationConfig {
  ...
  const GoogleCloudDialogflowV2beta1NotificationConfig({
    this.messageFormat,
    this.topic,
  });
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'messageFormat': ?pulumi.Input.mapOptionalInputValue<GoogleCloudDialogflowV2beta1NotificationConfigMessageFormat, String>(messageFormat, (value) => value.wireValue),
      'topic': ?topic,
    };
  }
  ...
  factory GoogleCloudDialogflowV2beta1NotificationConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2beta1NotificationConfig(
      messageFormat: (() { final guardedValue = map['messageFormat']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowV2beta1NotificationConfigMessageFormat.fromValue(guardedValue as String)); })(),
