...
class GetEntityTypeDialogflowV3beta1Result {
  ...
  final List<GoogleCloudDialogflowCxV3beta1EntityTypeExcludedPhraseResponse> excludedPhrases;
  ...
  const GetEntityTypeDialogflowV3beta1Result({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'excludedPhrases': pulumi.Input.encodeList<GoogleCloudDialogflowCxV3beta1EntityTypeExcludedPhraseResponse, Map<String, dynamic>>(excludedPhrases, (value) => value.toMap()),
      'kind': kind,
      'name': name,
      'redact': redact,
    };
  ...
  factory GetEntityTypeDialogflowV3beta1Result.fromMap(Map<String, dynamic> map) {
    return GetEntityTypeDialogflowV3beta1Result(
      ...
      excludedPhrases: pulumi.Input.decodeList<GoogleCloudDialogflowCxV3beta1EntityTypeExcludedPhraseResponse>(map['excludedPhrases']!, (value) => GoogleCloudDialogflowCxV3beta1EntityTypeExcludedPhraseResponse.fromMap((value as Map).cast<String, dynamic>())),
