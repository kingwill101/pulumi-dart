...
class GoogleCloudDialogflowCxV3beta1EnvironmentWebhookConfigResponse {
  ...
  final pulumi.Input<List<GoogleCloudDialogflowCxV3beta1WebhookResponse>> webhookOverrides;
  ...
  const GoogleCloudDialogflowCxV3beta1EnvironmentWebhookConfigResponse({
    required this.webhookOverrides,
  });

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'webhookOverrides': pulumi.Input.mapInputValue<List<GoogleCloudDialogflowCxV3beta1WebhookResponse>, List<Map<String, dynamic>>>(webhookOverrides, (value) => pulumi.Input.encodeList<GoogleCloudDialogflowCxV3beta1WebhookResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory GoogleCloudDialogflowCxV3beta1EnvironmentWebhookConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3beta1EnvironmentWebhookConfigResponse(
      webhookOverrides: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudDialogflowCxV3beta1WebhookResponse>(map['webhookOverrides']!, (value) => GoogleCloudDialogflowCxV3beta1WebhookResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
