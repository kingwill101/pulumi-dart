...
class GoogleCloudDialogflowCxV3beta1EnvironmentWebhookConfigResponse {
  ...
  final pulumi.Input<List<GoogleCloudDialogflowCxV3beta1WebhookResponse>>
  webhookOverrides;
    ...
    return <String, dynamic>{
      'webhookOverrides':
          pulumi.Input.mapInputValue<
            List<GoogleCloudDialogflowCxV3beta1WebhookResponse>,
  ...
  factory GoogleCloudDialogflowCxV3beta1EnvironmentWebhookConfigResponse.fromMap(
    ...
    return GoogleCloudDialogflowCxV3beta1EnvironmentWebhookConfigResponse(
      webhookOverrides: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GoogleCloudDialogflowCxV3beta1WebhookResponse>(
