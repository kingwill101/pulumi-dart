...
import 'google_cloud_dialogflow_cx_v3beta1_barge_in_config.dart';
import 'google_cloud_dialogflow_cx_v3beta1_input_audio_config_audio_encoding.dart';
import 'google_cloud_dialogflow_cx_v3beta1_input_audio_config_model_variant.dart';

/// Instructs the speech recognizer on how to process the audio content.
class GoogleCloudDialogflowCxV3beta1InputAudioConfig {
  /// Audio encoding of the audio content to process.
  final pulumi.Input<GoogleCloudDialogflowCxV3beta1InputAudioConfigAudioEncoding> audioEncoding;
  /// Configuration of barge-in behavior during the streaming of input audio.
  final pulumi.Input<GoogleCloudDialogflowCxV3beta1BargeInConfig>? bargeInConfig;
  ...
  final pulumi.Input<GoogleCloudDialogflowCxV3beta1InputAudioConfigModelVariant>? modelVariant;
  ...
  /// Creates a new [GoogleCloudDialogflowCxV3beta1InputAudioConfig].
  ...
  const GoogleCloudDialogflowCxV3beta1InputAudioConfig({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'audioEncoding': pulumi.Input.mapInputValue<GoogleCloudDialogflowCxV3beta1InputAudioConfigAudioEncoding, String>(audioEncoding, (value) => value.wireValue),
      'bargeInConfig': ?pulumi.Input.mapOptionalInputValue<GoogleCloudDialogflowCxV3beta1BargeInConfig, Map<String, dynamic>>(bargeInConfig, (value) => value.toMap()),
      'enableWordInfo': ?enableWordInfo,
      'model': ?model,
      'modelVariant': ?pulumi.Input.mapOptionalInputValue<GoogleCloudDialogflowCxV3beta1InputAudioConfigModelVariant, String>(modelVariant, (value) => value.wireValue),
  ...
  factory GoogleCloudDialogflowCxV3beta1InputAudioConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3beta1InputAudioConfig(
      audioEncoding: pulumi.Input.fromValue(GoogleCloudDialogflowCxV3beta1InputAudioConfigAudioEncoding.fromValue(map['audioEncoding']! as String)),
      bargeInConfig: (() { final guardedValue = map['bargeInConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowCxV3beta1BargeInConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      modelVariant: (() { final guardedValue = map['modelVariant']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowCxV3beta1InputAudioConfigModelVariant.fromValue(guardedValue as String)); })(),
      phraseHints: (() { final guardedValue = map['phraseHints']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      ...
      singleUtterance: (() { final guardedValue = map['singleUtterance']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
    );
  }
}
