...
class GoogleCloudDialogflowCxV3beta1InputAudioConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'audioEncoding': pulumi.Input.mapInputValue<GoogleCloudDialogflowCxV3beta1InputAudioConfigAudioEncoding, String>(audioEncoding, (value) => value.value),
      ...
      'model': ?model,
      'modelVariant': ?pulumi.Input.mapOptionalInputValue<GoogleCloudDialogflowCxV3beta1InputAudioConfigModelVariant, String>(modelVariant, (value) => value.value),
