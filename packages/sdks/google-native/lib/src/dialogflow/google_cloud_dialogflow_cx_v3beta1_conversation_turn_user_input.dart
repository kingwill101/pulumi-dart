...
class GoogleCloudDialogflowCxV3beta1ConversationTurnUserInput {
  ...
  const GoogleCloudDialogflowCxV3beta1ConversationTurnUserInput({
  ...
  factory GoogleCloudDialogflowCxV3beta1ConversationTurnUserInput.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3beta1ConversationTurnUserInput(
      ...
      input: (() { final guardedValue = map['input']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowCxV3beta1QueryInput.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
