...
class GoogleCloudDialogflowV2IntentMessageResponse {
  ...
  final pulumi.Input<GoogleCloudDialogflowV2IntentMessageBasicCardResponse>
  basicCard;
  ...
  final pulumi.Input<GoogleCloudDialogflowV2IntentMessageCarouselSelectResponse>
  carouselSelect;
  ...
  final pulumi.Input<GoogleCloudDialogflowV2IntentMessageListSelectResponse>
  listSelect;

  /// The media content card for Actions on Google.
  final pulumi.Input<GoogleCloudDialogflowV2IntentMessageMediaContentResponse>
  mediaContent;
  ...
  final pulumi.Input<GoogleCloudDialogflowV2IntentMessageQuickRepliesResponse>
  quickReplies;
  ...
  final pulumi.Input<GoogleCloudDialogflowV2IntentMessageSuggestionsResponse>
  suggestions;

  /// Table card for Actions on Google.
  final pulumi.Input<GoogleCloudDialogflowV2IntentMessageTableCardResponse>
  tableCard;
  ...
  factory GoogleCloudDialogflowV2IntentMessageResponse.fromMap(
    ...
    return GoogleCloudDialogflowV2IntentMessageResponse(
      basicCard: pulumi.Input.fromValue(
        GoogleCloudDialogflowV2IntentMessageBasicCardResponse.fromMap(
      ...
      card: pulumi.Input.fromValue(
        GoogleCloudDialogflowV2IntentMessageCardResponse.fromMap(
      ...
      tableCard: pulumi.Input.fromValue(
        GoogleCloudDialogflowV2IntentMessageTableCardResponse.fromMap(
          (map['tableCard']! as Map).cast<String, dynamic>(),
        ),
      ),
      text: pulumi.Input.fromValue(
        GoogleCloudDialogflowV2IntentMessageTextResponse.fromMap(
