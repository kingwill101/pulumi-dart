...
class Participant extends pulumi.CustomResource {
  ...
  Participant(
    ...
    this.documentsMetadataFilters = registerOutput<Map<String, String>>('documentsMetadataFilters');
    this.location = registerOutput<String>('location');
    this.name = registerOutput<String>('name');
    this.obfuscatedExternalUserId = registerOutput<String>('obfuscatedExternalUserId');
    this.project = registerOutput<String>('project');
    this.role = registerOutput<String>('role');
    this.sipRecordingMediaLabel = registerOutput<String>('sipRecordingMediaLabel');
  }
}
