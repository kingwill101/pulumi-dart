...
class GoogleCloudDialogflowV2beta1IntentMessageSimpleResponse {
  ...
  const GoogleCloudDialogflowV2beta1IntentMessageSimpleResponse({
    this.displayText,
    this.ssml,
    this.textToSpeech,
  });
  ...
  factory GoogleCloudDialogflowV2beta1IntentMessageSimpleResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2beta1IntentMessageSimpleResponse(
      displayText: (() { final guardedValue = map['displayText']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ssml: (() { final guardedValue = map['ssml']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      textToSpeech: (() { final guardedValue = map['textToSpeech']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
