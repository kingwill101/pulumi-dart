...
class GoogleCloudDialogflowV2beta1IntentMessageRbmCardContentRbmMediaResponse {
  ...
  factory GoogleCloudDialogflowV2beta1IntentMessageRbmCardContentRbmMediaResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2beta1IntentMessageRbmCardContentRbmMediaResponse(
      fileUri: (map['fileUri'] as String).input(),
      height: (map['height'] as String).input(),
      thumbnailUri: (map['thumbnailUri'] as String).input(),
    );
  }
}
