...
class GoogleCloudDialogflowCxV3beta1FulfillmentConditionalCasesCaseResponse {
  ...
  final List<GoogleCloudDialogflowCxV3beta1FulfillmentConditionalCasesCaseCaseContentResponse> caseContent;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'caseContent': pulumi.Input.encodeList<GoogleCloudDialogflowCxV3beta1FulfillmentConditionalCasesCaseCaseContentResponse, Map<String, dynamic>>(caseContent, (value) => value.toMap()),
      'condition': condition,
    };
  }
  ...
  factory GoogleCloudDialogflowCxV3beta1FulfillmentConditionalCasesCaseResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3beta1FulfillmentConditionalCasesCaseResponse(
      caseContent: pulumi.Input.decodeList<GoogleCloudDialogflowCxV3beta1FulfillmentConditionalCasesCaseCaseContentResponse>(map['caseContent'], (value) => GoogleCloudDialogflowCxV3beta1FulfillmentConditionalCasesCaseCaseContentResponse.fromMap((value as Map).cast<String, dynamic>())),
