...
class GoogleCloudDialogflowV2beta1IntentMessage {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'payload': ?payload,
      'platform': ?pulumi.Input.mapOptionalInputValue<GoogleCloudDialogflowV2beta1IntentMessagePlatform, String>(platform, (value) => value.wireValue),
  ...
  factory GoogleCloudDialogflowV2beta1IntentMessage.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2beta1IntentMessage(
      basicCard: (() { final guardedValue = map['basicCard']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowV2beta1IntentMessageBasicCard.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      browseCarouselCard: (() { final guardedValue = map['browseCarouselCard']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowV2beta1IntentMessageBrowseCarouselCard.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      card: (() { final guardedValue = map['card']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowV2beta1IntentMessageCard.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      carouselSelect: (() { final guardedValue = map['carouselSelect']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowV2beta1IntentMessageCarouselSelect.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      linkOutSuggestion: (() { final guardedValue = map['linkOutSuggestion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowV2beta1IntentMessageLinkOutSuggestion.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      listSelect: (() { final guardedValue = map['listSelect']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowV2beta1IntentMessageListSelect.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      mediaContent: (() { final guardedValue = map['mediaContent']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowV2beta1IntentMessageMediaContent.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      platform: (() { final guardedValue = map['platform']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowV2beta1IntentMessagePlatform.fromValue(guardedValue as String)); })(),
      quickReplies: (() { final guardedValue = map['quickReplies']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowV2beta1IntentMessageQuickReplies.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      rbmCarouselRichCard: (() { final guardedValue = map['rbmCarouselRichCard']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowV2beta1IntentMessageRbmCarouselCard.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      rbmStandaloneRichCard: (() { final guardedValue = map['rbmStandaloneRichCard']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowV2beta1IntentMessageRbmStandaloneCard.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      rbmText: (() { final guardedValue = map['rbmText']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowV2beta1IntentMessageRbmText.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      simpleResponses: (() { final guardedValue = map['simpleResponses']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowV2beta1IntentMessageSimpleResponses.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      suggestions: (() { final guardedValue = map['suggestions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowV2beta1IntentMessageSuggestions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      tableCard: (() { final guardedValue = map['tableCard']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowV2beta1IntentMessageTableCard.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      telephonyPlayAudio: (() { final guardedValue = map['telephonyPlayAudio']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowV2beta1IntentMessageTelephonyPlayAudio.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      telephonySynthesizeSpeech: (() { final guardedValue = map['telephonySynthesizeSpeech']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowV2beta1IntentMessageTelephonySynthesizeSpeech.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      telephonyTransferCall: (() { final guardedValue = map['telephonyTransferCall']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowV2beta1IntentMessageTelephonyTransferCall.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      text: (() { final guardedValue = map['text']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowV2beta1IntentMessageText.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
