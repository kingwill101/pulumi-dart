...
class EnvironmentDialogflowV3 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<GoogleCloudDialogflowCxV3EnvironmentVersionConfigResponse>> versionConfigs;
  ...
  EnvironmentDialogflowV3(
    ...
    this.testCasesConfig = registerOutput<GoogleCloudDialogflowCxV3EnvironmentTestCasesConfigResponse>('testCasesConfig');
    this.updateTime = registerOutput<String>('updateTime');
    this.versionConfigs = registerOutput<List<GoogleCloudDialogflowCxV3EnvironmentVersionConfigResponse>>('versionConfigs');
    this.webhookConfig = registerOutput<GoogleCloudDialogflowCxV3EnvironmentWebhookConfigResponse>('webhookConfig');
  }
}
