...
class GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionQueryConfigResponse {
  ...
  factory GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionQueryConfigResponse.fromMap(
    ...
    return GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionQueryConfigResponse(
      ...
      contextFilterSettings: pulumi.Input.fromValue(
        GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionQueryConfigContextFilterSettingsResponse.fromMap(
          (map['contextFilterSettings']! as Map).cast<String, dynamic>(),
        ),
      ),
      dialogflowQuerySource: pulumi.Input.fromValue(
        GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionQueryConfigDialogflowQuerySourceResponse.fromMap(
          (map['dialogflowQuerySource']! as Map).cast<String, dynamic>(),
        ),
      ),
      documentQuerySource: pulumi.Input.fromValue(
        GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionQueryConfigDocumentQuerySourceResponse.fromMap(
          (map['documentQuerySource']! as Map).cast<String, dynamic>(),
        ),
      ),
      knowledgeBaseQuerySource: pulumi.Input.fromValue(
        GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionQueryConfigKnowledgeBaseQuerySourceResponse.fromMap(
