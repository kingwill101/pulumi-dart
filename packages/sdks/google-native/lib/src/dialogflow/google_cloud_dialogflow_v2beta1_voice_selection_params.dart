    ...
    return <String, dynamic>{
      ...
      'ssmlGender':
          ?pulumi.Input.mapOptionalInputValue<
            GoogleCloudDialogflowV2beta1VoiceSelectionParamsSsmlGender,
            String
          >(ssmlGender, (value) => value.wireValue),
    };
  }

  factory GoogleCloudDialogflowV2beta1VoiceSelectionParams.fromMap(
    ...
    return GoogleCloudDialogflowV2beta1VoiceSelectionParams(
      ...
      ssmlGender: (() {
        final guardedValue = map['ssmlGender'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GoogleCloudDialogflowV2beta1VoiceSelectionParamsSsmlGender.fromValue(
