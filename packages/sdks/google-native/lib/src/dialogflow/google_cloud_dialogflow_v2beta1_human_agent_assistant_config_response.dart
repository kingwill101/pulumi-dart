...
class GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigResponse {
  ...
  factory GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigResponse(
      endUserSuggestionConfig: (GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionConfigResponse.fromMap((map['endUserSuggestionConfig'] as Map).cast<String, dynamic>())).input(),
      humanAgentSuggestionConfig: (GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionConfigResponse.fromMap((map['humanAgentSuggestionConfig'] as Map).cast<String, dynamic>())).input(),
      messageAnalysisConfig: (GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigMessageAnalysisConfigResponse.fromMap((map['messageAnalysisConfig'] as Map).cast<String, dynamic>())).input(),
      notificationConfig: (GoogleCloudDialogflowV2beta1NotificationConfigResponse.fromMap((map['notificationConfig'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
