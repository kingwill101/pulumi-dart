...
class GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionConfigResponse {
  ...
  final pulumi.Input<List<GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionFeatureConfigResponse>> featureConfigs;
  ...
  const GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionConfigResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'featureConfigs': pulumi.Input.mapInputValue<List<GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionFeatureConfigResponse>, List<Map<String, dynamic>>>(featureConfigs, (value) => pulumi.Input.encodeList<GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionFeatureConfigResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'groupSuggestionResponses': groupSuggestionResponses,
    };
  }

  factory GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionConfigResponse(
      featureConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionFeatureConfigResponse>(map['featureConfigs']!, (value) => GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionFeatureConfigResponse.fromMap((value as Map).cast<String, dynamic>()))),
      groupSuggestionResponses: pulumi.Input.fromValue(map['groupSuggestionResponses'] as bool),
    );
  }
}
