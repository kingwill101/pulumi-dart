...
class GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionConfigResponse {
  ...
  factory GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionConfigResponse(
      featureConfigs: (pulumi.Input.decodeList<GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionFeatureConfigResponse>(map['featureConfigs'], (value) => GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionFeatureConfigResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      groupSuggestionResponses: (map['groupSuggestionResponses'] as bool).input(),
    );
  }
}
