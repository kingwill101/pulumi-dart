...
class ConversationProfileDialogflowV2beta1Args {
  ...
  ConversationProfileDialogflowV2beta1Args({
    pulumi.Output<GoogleCloudDialogflowV2beta1AutomatedAgentConfig>? automatedAgentConfig,
    required pulumi.Output<String> displayName,
    pulumi.Output<GoogleCloudDialogflowV2beta1HumanAgentAssistantConfig>? humanAgentAssistantConfig,
    pulumi.Output<GoogleCloudDialogflowV2beta1HumanAgentHandoffConfig>? humanAgentHandoffConfig,
    pulumi.Output<String>? languageCode,
    pulumi.Output<String>? location,
    pulumi.Output<GoogleCloudDialogflowV2beta1LoggingConfig>? loggingConfig,
    pulumi.Output<String>? name,
    pulumi.Output<GoogleCloudDialogflowV2beta1NotificationConfig>? newMessageEventNotificationConfig,
    pulumi.Output<GoogleCloudDialogflowV2beta1NotificationConfig>? notificationConfig,
    pulumi.Output<String>? project,
    pulumi.Output<String>? securitySettings,
    pulumi.Output<GoogleCloudDialogflowV2beta1SpeechToTextConfig>? sttConfig,
    pulumi.Output<String>? timeZone,
    pulumi.Output<GoogleCloudDialogflowV2beta1SynthesizeSpeechConfig>? ttsConfig,
  }) :
  ...
  factory ConversationProfileDialogflowV2beta1Args.fromMap(Map<String, dynamic> map) {
    return ConversationProfileDialogflowV2beta1Args(
      automatedAgentConfig: map['automatedAgentConfig'] == null ? null : pulumi.Output.create<GoogleCloudDialogflowV2beta1AutomatedAgentConfig>(GoogleCloudDialogflowV2beta1AutomatedAgentConfig.fromMap((map['automatedAgentConfig'] as Map).cast<String, dynamic>())),
      displayName: pulumi.Output.create<String>(map['displayName'] as String),
      humanAgentAssistantConfig: map['humanAgentAssistantConfig'] == null ? null : pulumi.Output.create<GoogleCloudDialogflowV2beta1HumanAgentAssistantConfig>(GoogleCloudDialogflowV2beta1HumanAgentAssistantConfig.fromMap((map['humanAgentAssistantConfig'] as Map).cast<String, dynamic>())),
      humanAgentHandoffConfig: map['humanAgentHandoffConfig'] == null ? null : pulumi.Output.create<GoogleCloudDialogflowV2beta1HumanAgentHandoffConfig>(GoogleCloudDialogflowV2beta1HumanAgentHandoffConfig.fromMap((map['humanAgentHandoffConfig'] as Map).cast<String, dynamic>())),
      languageCode: map['languageCode'] == null ? null : pulumi.Output.create<String>(map['languageCode'] as String),
      location: map['location'] == null ? null : pulumi.Output.create<String>(map['location'] as String),
      loggingConfig: map['loggingConfig'] == null ? null : pulumi.Output.create<GoogleCloudDialogflowV2beta1LoggingConfig>(GoogleCloudDialogflowV2beta1LoggingConfig.fromMap((map['loggingConfig'] as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      newMessageEventNotificationConfig: map['newMessageEventNotificationConfig'] == null ? null : pulumi.Output.create<GoogleCloudDialogflowV2beta1NotificationConfig>(GoogleCloudDialogflowV2beta1NotificationConfig.fromMap((map['newMessageEventNotificationConfig'] as Map).cast<String, dynamic>())),
      notificationConfig: map['notificationConfig'] == null ? null : pulumi.Output.create<GoogleCloudDialogflowV2beta1NotificationConfig>(GoogleCloudDialogflowV2beta1NotificationConfig.fromMap((map['notificationConfig'] as Map).cast<String, dynamic>())),
      ...
      sttConfig: map['sttConfig'] == null ? null : pulumi.Output.create<GoogleCloudDialogflowV2beta1SpeechToTextConfig>(GoogleCloudDialogflowV2beta1SpeechToTextConfig.fromMap((map['sttConfig'] as Map).cast<String, dynamic>())),
      timeZone: map['timeZone'] == null ? null : pulumi.Output.create<String>(map['timeZone'] as String),
      ttsConfig: map['ttsConfig'] == null ? null : pulumi.Output.create<GoogleCloudDialogflowV2beta1SynthesizeSpeechConfig>(GoogleCloudDialogflowV2beta1SynthesizeSpeechConfig.fromMap((map['ttsConfig'] as Map).cast<String, dynamic>())),
    );
  }
}
