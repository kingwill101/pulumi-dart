...
class ConversationProfileDialogflowV2beta1Args {
  ...
  const ConversationProfileDialogflowV2beta1Args({
  ...
  factory ConversationProfileDialogflowV2beta1Args.fromMap(Map<String, dynamic> map) {
    return ConversationProfileDialogflowV2beta1Args(
      automatedAgentConfig: (() { final guardedValue = map['automatedAgentConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowV2beta1AutomatedAgentConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      displayName: pulumi.Input.fromValue(map['displayName'] as String),
      humanAgentAssistantConfig: (() { final guardedValue = map['humanAgentAssistantConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowV2beta1HumanAgentAssistantConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      humanAgentHandoffConfig: (() { final guardedValue = map['humanAgentHandoffConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowV2beta1HumanAgentHandoffConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      loggingConfig: (() { final guardedValue = map['loggingConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowV2beta1LoggingConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      newMessageEventNotificationConfig: (() { final guardedValue = map['newMessageEventNotificationConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowV2beta1NotificationConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      sttConfig: (() { final guardedValue = map['sttConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowV2beta1SpeechToTextConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      timeZone: (() { final guardedValue = map['timeZone']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ttsConfig: (() { final guardedValue = map['ttsConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowV2beta1SynthesizeSpeechConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
