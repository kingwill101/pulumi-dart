...
class GoogleCloudDialogflowV2IntentMessageBrowseCarouselCard {
  ...
  const GoogleCloudDialogflowV2IntentMessageBrowseCarouselCard({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'imageDisplayOptions': ?pulumi.Input.mapOptionalInputValue<GoogleCloudDialogflowV2IntentMessageBrowseCarouselCardImageDisplayOptions, String>(imageDisplayOptions, (value) => value.wireValue),
  ...
  factory GoogleCloudDialogflowV2IntentMessageBrowseCarouselCard.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2IntentMessageBrowseCarouselCard(
      imageDisplayOptions: (() { final guardedValue = map['imageDisplayOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowV2IntentMessageBrowseCarouselCardImageDisplayOptions.fromValue(guardedValue as String)); })(),
      items: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudDialogflowV2IntentMessageBrowseCarouselCardBrowseCarouselCardItem>(map['items']!, (value) => GoogleCloudDialogflowV2IntentMessageBrowseCarouselCardBrowseCarouselCardItem.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
