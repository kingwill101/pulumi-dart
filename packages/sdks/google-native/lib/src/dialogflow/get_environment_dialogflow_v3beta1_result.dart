...
class GetEnvironmentDialogflowV3beta1Result {
  ...
  final GoogleCloudDialogflowCxV3beta1EnvironmentTestCasesConfigResponse testCasesConfig;
  /// Update time of this environment.
  final String updateTime;
  /// A list of configurations for flow versions. You should include version configs for all flows that are reachable from `Start Flow` in the agent. Otherwise, an error will be returned.
  final List<GoogleCloudDialogflowCxV3beta1EnvironmentVersionConfigResponse> versionConfigs;
  /// The webhook configuration for this environment.
  final GoogleCloudDialogflowCxV3beta1EnvironmentWebhookConfigResponse webhookConfig;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'versionConfigs': pulumi.Input.encodeList<GoogleCloudDialogflowCxV3beta1EnvironmentVersionConfigResponse, Map<String, dynamic>>(versionConfigs, (value) => value.toMap()),
      'webhookConfig': webhookConfig.toMap(),
    };
  }

  factory GetEnvironmentDialogflowV3beta1Result.fromMap(Map<String, dynamic> map) {
    return GetEnvironmentDialogflowV3beta1Result(
      description: map['description'] as String,
      displayName: map['displayName'] as String,
      name: map['name'] as String,
      testCasesConfig: GoogleCloudDialogflowCxV3beta1EnvironmentTestCasesConfigResponse.fromMap((map['testCasesConfig']! as Map).cast<String, dynamic>()),
      updateTime: map['updateTime'] as String,
      versionConfigs: pulumi.Input.decodeList<GoogleCloudDialogflowCxV3beta1EnvironmentVersionConfigResponse>(map['versionConfigs']!, (value) => GoogleCloudDialogflowCxV3beta1EnvironmentVersionConfigResponse.fromMap((value as Map).cast<String, dynamic>())),
      webhookConfig: GoogleCloudDialogflowCxV3beta1EnvironmentWebhookConfigResponse.fromMap((map['webhookConfig']! as Map).cast<String, dynamic>()),
    );
  }
}
