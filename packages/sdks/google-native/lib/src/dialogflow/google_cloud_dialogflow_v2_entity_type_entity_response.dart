...
class GoogleCloudDialogflowV2EntityTypeEntityResponse {
  ...
  /// Creates a new [GoogleCloudDialogflowV2EntityTypeEntityResponse].
  ...
  const GoogleCloudDialogflowV2EntityTypeEntityResponse({
  ...
  factory GoogleCloudDialogflowV2EntityTypeEntityResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2EntityTypeEntityResponse(
