...
class GoogleCloudDialogflowV2IntentMessageBrowseCarouselCardResponse {
  ...
  factory GoogleCloudDialogflowV2IntentMessageBrowseCarouselCardResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2IntentMessageBrowseCarouselCardResponse(
      ...
      items: (pulumi.Input.decodeList<GoogleCloudDialogflowV2IntentMessageBrowseCarouselCardBrowseCarouselCardItemResponse>(map['items'], (value) => GoogleCloudDialogflowV2IntentMessageBrowseCarouselCardBrowseCarouselCardItemResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
