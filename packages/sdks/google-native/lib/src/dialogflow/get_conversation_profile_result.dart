...
class GetConversationProfileResult {
  ...
  final GoogleCloudDialogflowV2AutomatedAgentConfigResponse automatedAgentConfig;
  /// Create time of the conversation profile.
  final String createTime;
  /// Human readable name for this profile. Max length 1024 bytes.
  final String displayName;
  /// Configuration for agent assistance to use with this profile.
  final GoogleCloudDialogflowV2HumanAgentAssistantConfigResponse humanAgentAssistantConfig;
  /// Configuration for connecting to a live agent. Currently, this feature is not general available, please contact Google to get access.
  final GoogleCloudDialogflowV2HumanAgentHandoffConfigResponse humanAgentHandoffConfig;
  ...
  final GoogleCloudDialogflowV2NotificationConfigResponse newMessageEventNotificationConfig;
  ...
  /// Creates a new [GetConversationProfileResult].
  ...
  const GetConversationProfileResult({
  ...
  factory GetConversationProfileResult.fromMap(Map<String, dynamic> map) {
    return GetConversationProfileResult(
      automatedAgentConfig: GoogleCloudDialogflowV2AutomatedAgentConfigResponse.fromMap((map['automatedAgentConfig']! as Map).cast<String, dynamic>()),
      createTime: map['createTime'] as String,
      displayName: map['displayName'] as String,
      humanAgentAssistantConfig: GoogleCloudDialogflowV2HumanAgentAssistantConfigResponse.fromMap((map['humanAgentAssistantConfig']! as Map).cast<String, dynamic>()),
      humanAgentHandoffConfig: GoogleCloudDialogflowV2HumanAgentHandoffConfigResponse.fromMap((map['humanAgentHandoffConfig']! as Map).cast<String, dynamic>()),
      languageCode: map['languageCode'] as String,
      loggingConfig: GoogleCloudDialogflowV2LoggingConfigResponse.fromMap((map['loggingConfig']! as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      newMessageEventNotificationConfig: GoogleCloudDialogflowV2NotificationConfigResponse.fromMap((map['newMessageEventNotificationConfig']! as Map).cast<String, dynamic>()),
      ...
      sttConfig: GoogleCloudDialogflowV2SpeechToTextConfigResponse.fromMap((map['sttConfig']! as Map).cast<String, dynamic>()),
      timeZone: map['timeZone'] as String,
      ttsConfig: GoogleCloudDialogflowV2SynthesizeSpeechConfigResponse.fromMap((map['ttsConfig']! as Map).cast<String, dynamic>()),
