...
class GoogleCloudDialogflowCxV3beta1FulfillmentConditionalCasesCase {
  ...
  const GoogleCloudDialogflowCxV3beta1FulfillmentConditionalCasesCase({
    this.caseContent,
    this.condition,
  });
  ...
  factory GoogleCloudDialogflowCxV3beta1FulfillmentConditionalCasesCase.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3beta1FulfillmentConditionalCasesCase(
      caseContent: (() { final guardedValue = map['caseContent']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudDialogflowCxV3beta1FulfillmentConditionalCasesCaseCaseContent>(guardedValue, (value) => GoogleCloudDialogflowCxV3beta1FulfillmentConditionalCasesCaseCaseContent.fromMap((value as Map).cast<String, dynamic>()))); })(),
