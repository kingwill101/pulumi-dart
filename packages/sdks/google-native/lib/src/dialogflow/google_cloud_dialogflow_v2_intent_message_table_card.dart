...
class GoogleCloudDialogflowV2IntentMessageTableCard {
  ...
  final pulumi.Input<List<GoogleCloudDialogflowV2IntentMessageBasicCardButton>>?
  buttons;
  ...
  final pulumi.Input<List<GoogleCloudDialogflowV2IntentMessageTableCardRow>>?
  rows;
    ...
    return <String, dynamic>{
      'buttons':
          ?pulumi.Input.mapOptionalInputValue<
            List<GoogleCloudDialogflowV2IntentMessageBasicCardButton>,
      ...
      'rows':
          ?pulumi.Input.mapOptionalInputValue<
            List<GoogleCloudDialogflowV2IntentMessageTableCardRow>,
            List<Map<String, dynamic>>
          >(
            rows,
            (value) =>
  ...
  factory GoogleCloudDialogflowV2IntentMessageTableCard.fromMap(
    ...
    return GoogleCloudDialogflowV2IntentMessageTableCard(
      ...
      columnProperties: (() {
        final guardedValue = map['columnProperties'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<
            GoogleCloudDialogflowV2IntentMessageColumnProperties
      ...
      rows: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => GoogleCloudDialogflowV2IntentMessageTableCardRow.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
