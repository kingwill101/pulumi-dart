...
class GoogleCloudDialogflowV2SynthesizeSpeechConfigResponse {
  ...
  const GoogleCloudDialogflowV2SynthesizeSpeechConfigResponse({
  ...
  factory GoogleCloudDialogflowV2SynthesizeSpeechConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2SynthesizeSpeechConfigResponse(
      effectsProfileId: pulumi.Input.fromValue((map['effectsProfileId'] as List).cast<String>()),
      pitch: pulumi.Input.fromValue(map['pitch'] as double),
      speakingRate: pulumi.Input.fromValue(map['speakingRate'] as double),
      voice: pulumi.Input.fromValue(GoogleCloudDialogflowV2VoiceSelectionParamsResponse.fromMap((map['voice']! as Map).cast<String, dynamic>())),
