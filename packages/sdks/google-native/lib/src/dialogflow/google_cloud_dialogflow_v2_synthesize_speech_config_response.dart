...
import 'google_cloud_dialogflow_v2_voice_selection_params_response.dart';

/// Configuration of how speech should be synthesized.
class GoogleCloudDialogflowV2SynthesizeSpeechConfigResponse {
  ...
  final pulumi.Input<GoogleCloudDialogflowV2VoiceSelectionParamsResponse> voice;
  ...
  /// Creates a new [GoogleCloudDialogflowV2SynthesizeSpeechConfigResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'voice': pulumi.Input.mapInputValue<GoogleCloudDialogflowV2VoiceSelectionParamsResponse, Map<String, dynamic>>(voice, (value) => value.toMap()),
      'volumeGainDb': volumeGainDb,
    };
  }

  factory GoogleCloudDialogflowV2SynthesizeSpeechConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2SynthesizeSpeechConfigResponse(
      effectsProfileId: ((map['effectsProfileId'] as List).cast<String>()).input(),
      pitch: (map['pitch'] as double).input(),
      speakingRate: (map['speakingRate'] as double).input(),
      voice: (GoogleCloudDialogflowV2VoiceSelectionParamsResponse.fromMap((map['voice'] as Map).cast<String, dynamic>())).input(),
      volumeGainDb: (map['volumeGainDb'] as double).input(),
    );
  }
}
