...
class GoogleCloudDialogflowV2SynthesizeSpeechConfigResponse {
  ...
  final GoogleCloudDialogflowV2VoiceSelectionParamsResponse voice;
  ...
  factory GoogleCloudDialogflowV2SynthesizeSpeechConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2SynthesizeSpeechConfigResponse(
      effectsProfileId: (map['effectsProfileId'] as List).cast<String>(),
      pitch: map['pitch'] as double,
      speakingRate: map['speakingRate'] as double,
      voice: GoogleCloudDialogflowV2VoiceSelectionParamsResponse.fromMap((map['voice'] as Map).cast<String, dynamic>()),
      volumeGainDb: map['volumeGainDb'] as double,
    );
  }
}
