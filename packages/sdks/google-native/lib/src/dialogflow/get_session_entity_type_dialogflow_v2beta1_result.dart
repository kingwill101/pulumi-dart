...
class GetSessionEntityTypeDialogflowV2beta1Result {
  ...
  const GetSessionEntityTypeDialogflowV2beta1Result({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'entities': pulumi.Input.encodeList<GoogleCloudDialogflowV2beta1EntityTypeEntityResponse, Map<String, dynamic>>(entities, (value) => value.toMap()),
      'entityOverrideMode': entityOverrideMode,
      'name': name,
    };
  }

  factory GetSessionEntityTypeDialogflowV2beta1Result.fromMap(Map<String, dynamic> map) {
    return GetSessionEntityTypeDialogflowV2beta1Result(
      entities: pulumi.Input.decodeList<GoogleCloudDialogflowV2beta1EntityTypeEntityResponse>(map['entities']!, (value) => GoogleCloudDialogflowV2beta1EntityTypeEntityResponse.fromMap((value as Map).cast<String, dynamic>())),
