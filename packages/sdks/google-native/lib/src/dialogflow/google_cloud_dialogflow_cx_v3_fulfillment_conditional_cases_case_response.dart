...
class GoogleCloudDialogflowCxV3FulfillmentConditionalCasesCaseResponse {
  ...
  final List<GoogleCloudDialogflowCxV3FulfillmentConditionalCasesCaseCaseContentResponse> caseContent;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'caseContent': pulumi.Input.encodeList<GoogleCloudDialogflowCxV3FulfillmentConditionalCasesCaseCaseContentResponse, Map<String, dynamic>>(caseContent, (value) => value.toMap()),
      'condition': condition,
    };
  }
  ...
  factory GoogleCloudDialogflowCxV3FulfillmentConditionalCasesCaseResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3FulfillmentConditionalCasesCaseResponse(
      caseContent: pulumi.Input.decodeList<GoogleCloudDialogflowCxV3FulfillmentConditionalCasesCaseCaseContentResponse>(map['caseContent'], (value) => GoogleCloudDialogflowCxV3FulfillmentConditionalCasesCaseCaseContentResponse.fromMap((value as Map).cast<String, dynamic>())),
