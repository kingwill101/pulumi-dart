...
class AgentDialogflowV3beta1Args {
  ...
  AgentDialogflowV3beta1Args({
    pulumi.Output<GoogleCloudDialogflowCxV3beta1AdvancedSettings>? advancedSettings,
    pulumi.Output<GoogleCloudDialogflowCxV3beta1AgentAnswerFeedbackSettings>? answerFeedbackSettings,
    ...
    pulumi.Output<GoogleCloudDialogflowCxV3beta1AgentGenAppBuilderSettings>? genAppBuilderSettings,
    pulumi.Output<GoogleCloudDialogflowCxV3beta1AgentGitIntegrationSettings>? gitIntegrationSettings,
    pulumi.Output<String>? location,
    pulumi.Output<bool>? locked,
    pulumi.Output<String>? name,
    pulumi.Output<String>? project,
    pulumi.Output<String>? securitySettings,
    pulumi.Output<GoogleCloudDialogflowCxV3beta1SpeechToTextSettings>? speechToTextSettings,
    pulumi.Output<String>? startFlow,
    pulumi.Output<List<String>>? supportedLanguageCodes,
    pulumi.Output<GoogleCloudDialogflowCxV3beta1TextToSpeechSettings>? textToSpeechSettings,
  ...
  factory AgentDialogflowV3beta1Args.fromMap(Map<String, dynamic> map) {
    return AgentDialogflowV3beta1Args(
      advancedSettings: map['advancedSettings'] == null ? null : pulumi.Output.create<GoogleCloudDialogflowCxV3beta1AdvancedSettings>(GoogleCloudDialogflowCxV3beta1AdvancedSettings.fromMap((map['advancedSettings'] as Map).cast<String, dynamic>())),
      answerFeedbackSettings: map['answerFeedbackSettings'] == null ? null : pulumi.Output.create<GoogleCloudDialogflowCxV3beta1AgentAnswerFeedbackSettings>(GoogleCloudDialogflowCxV3beta1AgentAnswerFeedbackSettings.fromMap((map['answerFeedbackSettings'] as Map).cast<String, dynamic>())),
      ...
      genAppBuilderSettings: map['genAppBuilderSettings'] == null ? null : pulumi.Output.create<GoogleCloudDialogflowCxV3beta1AgentGenAppBuilderSettings>(GoogleCloudDialogflowCxV3beta1AgentGenAppBuilderSettings.fromMap((map['genAppBuilderSettings'] as Map).cast<String, dynamic>())),
      gitIntegrationSettings: map['gitIntegrationSettings'] == null ? null : pulumi.Output.create<GoogleCloudDialogflowCxV3beta1AgentGitIntegrationSettings>(GoogleCloudDialogflowCxV3beta1AgentGitIntegrationSettings.fromMap((map['gitIntegrationSettings'] as Map).cast<String, dynamic>())),
      ...
      speechToTextSettings: map['speechToTextSettings'] == null ? null : pulumi.Output.create<GoogleCloudDialogflowCxV3beta1SpeechToTextSettings>(GoogleCloudDialogflowCxV3beta1SpeechToTextSettings.fromMap((map['speechToTextSettings'] as Map).cast<String, dynamic>())),
      ...
      textToSpeechSettings: map['textToSpeechSettings'] == null ? null : pulumi.Output.create<GoogleCloudDialogflowCxV3beta1TextToSpeechSettings>(GoogleCloudDialogflowCxV3beta1TextToSpeechSettings.fromMap((map['textToSpeechSettings'] as Map).cast<String, dynamic>())),
