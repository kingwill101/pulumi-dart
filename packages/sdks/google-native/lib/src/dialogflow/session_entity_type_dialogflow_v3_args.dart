...
class SessionEntityTypeDialogflowV3Args {
  ...
  SessionEntityTypeDialogflowV3Args({
    ...
    required pulumi.Output<List<GoogleCloudDialogflowCxV3EntityTypeEntity>> entities,
    required pulumi.Output<SessionEntityTypeEntityOverrideModeDialogflowV3> entityOverrideMode,
  ...
  factory SessionEntityTypeDialogflowV3Args.fromMap(Map<String, dynamic> map) {
    return SessionEntityTypeDialogflowV3Args(
      ...
      entities: pulumi.Output.create<List<GoogleCloudDialogflowCxV3EntityTypeEntity>>(pulumi.Input.decodeList<GoogleCloudDialogflowCxV3EntityTypeEntity>(map['entities'], (value) => GoogleCloudDialogflowCxV3EntityTypeEntity.fromMap((value as Map).cast<String, dynamic>()))),
      entityOverrideMode: pulumi.Output.create<SessionEntityTypeEntityOverrideModeDialogflowV3>(SessionEntityTypeEntityOverrideModeDialogflowV3.fromValue(map['entityOverrideMode'] as String)),
