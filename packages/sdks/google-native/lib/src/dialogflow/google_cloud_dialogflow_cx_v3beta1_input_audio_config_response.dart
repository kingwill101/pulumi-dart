...
class GoogleCloudDialogflowCxV3beta1InputAudioConfigResponse {
  ...
  const GoogleCloudDialogflowCxV3beta1InputAudioConfigResponse({
  ...
  factory GoogleCloudDialogflowCxV3beta1InputAudioConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3beta1InputAudioConfigResponse(
      audioEncoding: pulumi.Input.fromValue(map['audioEncoding'] as String),
      bargeInConfig: pulumi.Input.fromValue(GoogleCloudDialogflowCxV3beta1BargeInConfigResponse.fromMap((map['bargeInConfig']! as Map).cast<String, dynamic>())),
      enableWordInfo: pulumi.Input.fromValue(map['enableWordInfo'] as bool),
      model: pulumi.Input.fromValue(map['model'] as String),
      modelVariant: pulumi.Input.fromValue(map['modelVariant'] as String),
      phraseHints: pulumi.Input.fromValue((map['phraseHints'] as List).cast<String>()),
      sampleRateHertz: pulumi.Input.fromValue(map['sampleRateHertz'] as int),
      singleUtterance: pulumi.Input.fromValue(map['singleUtterance'] as bool),
    );
  }
}
