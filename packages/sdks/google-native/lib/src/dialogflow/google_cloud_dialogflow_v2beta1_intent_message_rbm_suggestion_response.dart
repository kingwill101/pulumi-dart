...
class GoogleCloudDialogflowV2beta1IntentMessageRbmSuggestionResponse {
  ...
  factory GoogleCloudDialogflowV2beta1IntentMessageRbmSuggestionResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2beta1IntentMessageRbmSuggestionResponse(
      action: (GoogleCloudDialogflowV2beta1IntentMessageRbmSuggestedActionResponse.fromMap((map['action'] as Map).cast<String, dynamic>())).input(),
      reply: (GoogleCloudDialogflowV2beta1IntentMessageRbmSuggestedReplyResponse.fromMap((map['reply'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
