...
class GoogleCloudDialogflowV2SmartReplyMetricsResponse {
  ...
  final pulumi.Input<
    List<GoogleCloudDialogflowV2SmartReplyMetricsTopNMetricsResponse>
  >
  topNMetrics;
  ...
  factory GoogleCloudDialogflowV2SmartReplyMetricsResponse.fromMap(
    ...
    return GoogleCloudDialogflowV2SmartReplyMetricsResponse(
      allowlistCoverage: pulumi.Input.fromValue(
        map['allowlistCoverage'] as double,
      ),
      conversationCount: pulumi.Input.fromValue(
        map['conversationCount'] as String,
      ),
      topNMetrics: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GoogleCloudDialogflowV2SmartReplyMetricsTopNMetricsResponse
        >(
          map['topNMetrics']!,
          (value) =>
              GoogleCloudDialogflowV2SmartReplyMetricsTopNMetricsResponse.fromMap(
