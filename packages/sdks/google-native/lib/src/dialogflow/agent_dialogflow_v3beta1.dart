...
class AgentDialogflowV3beta1 extends pulumi.CustomResource {
  ...
  AgentDialogflowV3beta1(
    ...
    this.advancedSettings = registerOutput<GoogleCloudDialogflowCxV3beta1AdvancedSettingsResponse>('advancedSettings');
    this.answerFeedbackSettings = registerOutput<GoogleCloudDialogflowCxV3beta1AgentAnswerFeedbackSettingsResponse>('answerFeedbackSettings');
    ...
    this.genAppBuilderSettings = registerOutput<GoogleCloudDialogflowCxV3beta1AgentGenAppBuilderSettingsResponse>('genAppBuilderSettings');
    this.gitIntegrationSettings = registerOutput<GoogleCloudDialogflowCxV3beta1AgentGitIntegrationSettingsResponse>('gitIntegrationSettings');
    ...
    this.speechToTextSettings = registerOutput<GoogleCloudDialogflowCxV3beta1SpeechToTextSettingsResponse>('speechToTextSettings');
    this.startFlow = registerOutput<String>('startFlow');
    this.supportedLanguageCodes = registerOutput<List<String>>('supportedLanguageCodes');
    this.textToSpeechSettings = registerOutput<GoogleCloudDialogflowCxV3beta1TextToSpeechSettingsResponse>('textToSpeechSettings');
