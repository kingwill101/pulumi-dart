...
import 'entity_type_dialogflow_v3beta1_args.dart';
...
class EntityTypeDialogflowV3beta1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<GoogleCloudDialogflowCxV3beta1EntityTypeEntityResponse>> entities;
  /// Collection of exceptional words and phrases that shouldn't be matched. For example, if you have a size entity type with entry `giant`(an adjective), you might consider adding `giants`(a noun) as an exclusion. If the kind of entity type is `KIND_MAP`, then the phrases specified by entities and excluded phrases should be mutually exclusive.
  late final pulumi.Output<List<GoogleCloudDialogflowCxV3beta1EntityTypeExcludedPhraseResponse>> excludedPhrases;
  ...
  /// Creates a new [EntityTypeDialogflowV3beta1].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [EntityTypeDialogflowV3beta1]. {@macro pulumi_dialogflow_v3beta1_entity_type_dialogflow_v3beta1_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  EntityTypeDialogflowV3beta1(
    String name, {
    EntityTypeDialogflowV3beta1Args? args,
    ...
    this.entities = registerOutput<List<GoogleCloudDialogflowCxV3beta1EntityTypeEntityResponse>>('entities');
    this.excludedPhrases = registerOutput<List<GoogleCloudDialogflowCxV3beta1EntityTypeExcludedPhraseResponse>>('excludedPhrases');
