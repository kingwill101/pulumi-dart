...
class GoogleCloudDialogflowCxV3beta1FulfillmentResponse {
  ...
  factory GoogleCloudDialogflowCxV3beta1FulfillmentResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3beta1FulfillmentResponse(
      ...
      conditionalCases: (pulumi.Input.decodeList<GoogleCloudDialogflowCxV3beta1FulfillmentConditionalCasesResponse>(map['conditionalCases'], (value) => GoogleCloudDialogflowCxV3beta1FulfillmentConditionalCasesResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      enableGenerativeFallback: (map['enableGenerativeFallback'] as bool).input(),
      messages: (pulumi.Input.decodeList<GoogleCloudDialogflowCxV3beta1ResponseMessageResponse>(map['messages'], (value) => GoogleCloudDialogflowCxV3beta1ResponseMessageResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      returnPartialResponses: (map['returnPartialResponses'] as bool).input(),
      setParameterActions: (pulumi.Input.decodeList<GoogleCloudDialogflowCxV3beta1FulfillmentSetParameterActionResponse>(map['setParameterActions'], (value) => GoogleCloudDialogflowCxV3beta1FulfillmentSetParameterActionResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
