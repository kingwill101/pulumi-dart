...
class GoogleCloudDialogflowCxV3beta1FulfillmentResponse {
  ...
  final pulumi.Input<
    List<GoogleCloudDialogflowCxV3beta1FulfillmentConditionalCasesResponse>
  >
  conditionalCases;
  ...
  final pulumi.Input<
    List<GoogleCloudDialogflowCxV3beta1ResponseMessageResponse>
  >
  messages;
  ...
  final pulumi.Input<
    List<GoogleCloudDialogflowCxV3beta1FulfillmentSetParameterActionResponse>
  >
  setParameterActions;
    ...
    return GoogleCloudDialogflowCxV3beta1FulfillmentResponse(
      ...
      conditionalCases: pulumi.Input.fromValue(
        ...
        >(
          ...
          (value) =>
              GoogleCloudDialogflowCxV3beta1FulfillmentConditionalCasesResponse.fromMap(
      ...
      setParameterActions: pulumi.Input.fromValue(
        ...
        >(
          ...
          (value) =>
              GoogleCloudDialogflowCxV3beta1FulfillmentSetParameterActionResponse.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
