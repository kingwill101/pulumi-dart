...
class GoogleCloudDialogflowCxV3ConversationTurnVirtualAgentOutputResponse {
  ...
  final pulumi.Input<List<GoogleCloudDialogflowCxV3TestRunDifferenceResponse>>
  differences;
  ...
  final pulumi.Input<List<GoogleCloudDialogflowCxV3ResponseMessageTextResponse>>
  textResponses;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'differences':
          pulumi.Input.mapInputValue<
            List<GoogleCloudDialogflowCxV3TestRunDifferenceResponse>,
      ...
      'textResponses':
          pulumi.Input.mapInputValue<
            List<GoogleCloudDialogflowCxV3ResponseMessageTextResponse>,
            List<Map<String, dynamic>>
          >(
            textResponses,
            (value) =>
  ...
  factory GoogleCloudDialogflowCxV3ConversationTurnVirtualAgentOutputResponse.fromMap(
    ...
    return GoogleCloudDialogflowCxV3ConversationTurnVirtualAgentOutputResponse(
      currentPage: pulumi.Input.fromValue(
        GoogleCloudDialogflowCxV3PageResponse.fromMap(
      ...
      status: pulumi.Input.fromValue(
        GoogleRpcStatusResponseDialogflowV3.fromMap(
      ...
      triggeredIntent: pulumi.Input.fromValue(
        GoogleCloudDialogflowCxV3IntentResponse.fromMap(
