...
class GoogleCloudDialogflowCxV3ConversationTurnVirtualAgentOutputResponse {
  ...
  factory GoogleCloudDialogflowCxV3ConversationTurnVirtualAgentOutputResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3ConversationTurnVirtualAgentOutputResponse(
      currentPage: pulumi.Input.fromValue(GoogleCloudDialogflowCxV3PageResponse.fromMap((map['currentPage']! as Map).cast<String, dynamic>())),
      diagnosticInfo: pulumi.Input.fromValue((map['diagnosticInfo'] as Map).cast<String, String>()),
      differences: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudDialogflowCxV3TestRunDifferenceResponse>(map['differences']!, (value) => GoogleCloudDialogflowCxV3TestRunDifferenceResponse.fromMap((value as Map).cast<String, dynamic>()))),
      sessionParameters: pulumi.Input.fromValue((map['sessionParameters'] as Map).cast<String, String>()),
      status: pulumi.Input.fromValue(GoogleRpcStatusResponseDialogflowV3.fromMap((map['status']! as Map).cast<String, dynamic>())),
      textResponses: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudDialogflowCxV3ResponseMessageTextResponse>(map['textResponses']!, (value) => GoogleCloudDialogflowCxV3ResponseMessageTextResponse.fromMap((value as Map).cast<String, dynamic>()))),
      triggeredIntent: pulumi.Input.fromValue(GoogleCloudDialogflowCxV3IntentResponse.fromMap((map['triggeredIntent']! as Map).cast<String, dynamic>())),
    );
  }
}
