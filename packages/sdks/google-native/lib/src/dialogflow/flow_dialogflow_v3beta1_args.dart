...
class FlowDialogflowV3beta1Args {
  ...
  const FlowDialogflowV3beta1Args({
  ...
  factory FlowDialogflowV3beta1Args.fromMap(Map<String, dynamic> map) {
    return FlowDialogflowV3beta1Args(
      ...
      nluSettings: (() { final guardedValue = map['nluSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowCxV3beta1NluSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
