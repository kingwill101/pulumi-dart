...
class GoogleCloudDialogflowCxV3beta1FormResponse {
  ...
  final pulumi.Input<List<GoogleCloudDialogflowCxV3beta1FormParameterResponse>>
  parameters;

  /// Creates a new [GoogleCloudDialogflowCxV3beta1FormResponse].
  /// [parameters] Parameters to collect from the user.
  GoogleCloudDialogflowCxV3beta1FormResponse({required this.parameters});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'parameters':
          pulumi.Input.mapInputValue<
            List<GoogleCloudDialogflowCxV3beta1FormParameterResponse>,
