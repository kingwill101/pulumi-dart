...
class GoogleCloudDialogflowCxV3beta1FormResponse {
  ...
  const GoogleCloudDialogflowCxV3beta1FormResponse({
  ...
  factory GoogleCloudDialogflowCxV3beta1FormResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3beta1FormResponse(
      parameters: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudDialogflowCxV3beta1FormParameterResponse>(map['parameters']!, (value) => GoogleCloudDialogflowCxV3beta1FormParameterResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
