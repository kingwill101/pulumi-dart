...
class GoogleCloudDialogflowCxV3beta1Fulfillment {
  ...
  final pulumi.Input<List<GoogleCloudDialogflowCxV3beta1ResponseMessage>>?
  messages;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'messages':
          ?pulumi.Input.mapOptionalInputValue<
            List<GoogleCloudDialogflowCxV3beta1ResponseMessage>,
            List<Map<String, dynamic>>
          >(
            messages,
            (value) =>
  ...
  factory GoogleCloudDialogflowCxV3beta1Fulfillment.fromMap(
    ...
    return GoogleCloudDialogflowCxV3beta1Fulfillment(
      ...
      messages: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<GoogleCloudDialogflowCxV3beta1ResponseMessage>(
            guardedValue,
