...
import 'google_cloud_dialogflow_cx_v3beta1_fulfillment_set_parameter_action.dart';
...
class GoogleCloudDialogflowCxV3beta1Fulfillment {
  ...
  final pulumi.Input<List<GoogleCloudDialogflowCxV3beta1FulfillmentConditionalCases>>? conditionalCases;
  /// If the flag is true, the agent will utilize LLM to generate a text response. If LLM generation fails, the defined responses in the fulfillment will be respected. This flag is only useful for fulfillments associated with no-match event handlers.
  final pulumi.Input<bool>? enableGenerativeFallback;
  /// The list of rich message responses to present to the user.
  final pulumi.Input<List<GoogleCloudDialogflowCxV3beta1ResponseMessage>>? messages;
  ...
  final pulumi.Input<List<GoogleCloudDialogflowCxV3beta1FulfillmentSetParameterAction>>? setParameterActions;
  /// The value of this field will be populated in the WebhookRequest `fulfillmentInfo.tag` field by Dialogflow when the associated webhook is called. The tag is typically used by the webhook service to identify which fulfillment is being called, but it could be used for other purposes. This field is required if `webhook` is specified.
  final pulumi.Input<String>? tag;
  /// The webhook to call. Format: `projects//locations//agents//webhooks/`.
  final pulumi.Input<String>? webhook;

  /// Creates a new [GoogleCloudDialogflowCxV3beta1Fulfillment].
  ...
  const GoogleCloudDialogflowCxV3beta1Fulfillment({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'conditionalCases': ?pulumi.Input.mapOptionalInputValue<List<GoogleCloudDialogflowCxV3beta1FulfillmentConditionalCases>, List<Map<String, dynamic>>>(conditionalCases, (value) => pulumi.Input.encodeList<GoogleCloudDialogflowCxV3beta1FulfillmentConditionalCases, Map<String, dynamic>>(value, (value) => value.toMap())),
      'enableGenerativeFallback': ?enableGenerativeFallback,
      'messages': ?pulumi.Input.mapOptionalInputValue<List<GoogleCloudDialogflowCxV3beta1ResponseMessage>, List<Map<String, dynamic>>>(messages, (value) => pulumi.Input.encodeList<GoogleCloudDialogflowCxV3beta1ResponseMessage, Map<String, dynamic>>(value, (value) => value.toMap())),
      'returnPartialResponses': ?returnPartialResponses,
      'setParameterActions': ?pulumi.Input.mapOptionalInputValue<List<GoogleCloudDialogflowCxV3beta1FulfillmentSetParameterAction>, List<Map<String, dynamic>>>(setParameterActions, (value) => pulumi.Input.encodeList<GoogleCloudDialogflowCxV3beta1FulfillmentSetParameterAction, Map<String, dynamic>>(value, (value) => value.toMap())),
      'tag': ?tag,
      'webhook': ?webhook,
    };
  }

  factory GoogleCloudDialogflowCxV3beta1Fulfillment.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3beta1Fulfillment(
      ...
      conditionalCases: (() { final guardedValue = map['conditionalCases']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudDialogflowCxV3beta1FulfillmentConditionalCases>(guardedValue, (value) => GoogleCloudDialogflowCxV3beta1FulfillmentConditionalCases.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      messages: (() { final guardedValue = map['messages']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudDialogflowCxV3beta1ResponseMessage>(guardedValue, (value) => GoogleCloudDialogflowCxV3beta1ResponseMessage.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      setParameterActions: (() { final guardedValue = map['setParameterActions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudDialogflowCxV3beta1FulfillmentSetParameterAction>(guardedValue, (value) => GoogleCloudDialogflowCxV3beta1FulfillmentSetParameterAction.fromMap((value as Map).cast<String, dynamic>()))); })(),
