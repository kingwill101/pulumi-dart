...
class GetIntentResult {
  ...
  final List<GoogleCloudDialogflowV2IntentFollowupIntentInfoResponse> followupIntentInfo;
  ...
  final List<GoogleCloudDialogflowV2IntentTrainingPhraseResponse> trainingPhrases;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'events': events,
      'followupIntentInfo': pulumi.Input.encodeList<GoogleCloudDialogflowV2IntentFollowupIntentInfoResponse, Map<String, dynamic>>(followupIntentInfo, (value) => value.toMap()),
      'inputContextNames': inputContextNames,
      'isFallback': isFallback,
      'liveAgentHandoff': liveAgentHandoff,
      'messages': pulumi.Input.encodeList<GoogleCloudDialogflowV2IntentMessageResponse, Map<String, dynamic>>(messages, (value) => value.toMap()),
      'mlDisabled': mlDisabled,
      'name': name,
      'outputContexts': pulumi.Input.encodeList<GoogleCloudDialogflowV2ContextResponse, Map<String, dynamic>>(outputContexts, (value) => value.toMap()),
      'parameters': pulumi.Input.encodeList<GoogleCloudDialogflowV2IntentParameterResponse, Map<String, dynamic>>(parameters, (value) => value.toMap()),
      'parentFollowupIntentName': parentFollowupIntentName,
      'priority': priority,
      'resetContexts': resetContexts,
      'rootFollowupIntentName': rootFollowupIntentName,
      'trainingPhrases': pulumi.Input.encodeList<GoogleCloudDialogflowV2IntentTrainingPhraseResponse, Map<String, dynamic>>(trainingPhrases, (value) => value.toMap()),
  ...
  factory GetIntentResult.fromMap(Map<String, dynamic> map) {
    return GetIntentResult(
      ...
      followupIntentInfo: pulumi.Input.decodeList<GoogleCloudDialogflowV2IntentFollowupIntentInfoResponse>(map['followupIntentInfo']!, (value) => GoogleCloudDialogflowV2IntentFollowupIntentInfoResponse.fromMap((value as Map).cast<String, dynamic>())),
      ...
      messages: pulumi.Input.decodeList<GoogleCloudDialogflowV2IntentMessageResponse>(map['messages']!, (value) => GoogleCloudDialogflowV2IntentMessageResponse.fromMap((value as Map).cast<String, dynamic>())),
      mlDisabled: map['mlDisabled'] as bool,
      name: map['name'] as String,
      outputContexts: pulumi.Input.decodeList<GoogleCloudDialogflowV2ContextResponse>(map['outputContexts']!, (value) => GoogleCloudDialogflowV2ContextResponse.fromMap((value as Map).cast<String, dynamic>())),
      parameters: pulumi.Input.decodeList<GoogleCloudDialogflowV2IntentParameterResponse>(map['parameters']!, (value) => GoogleCloudDialogflowV2IntentParameterResponse.fromMap((value as Map).cast<String, dynamic>())),
      ...
      trainingPhrases: pulumi.Input.decodeList<GoogleCloudDialogflowV2IntentTrainingPhraseResponse>(map['trainingPhrases']!, (value) => GoogleCloudDialogflowV2IntentTrainingPhraseResponse.fromMap((value as Map).cast<String, dynamic>())),
