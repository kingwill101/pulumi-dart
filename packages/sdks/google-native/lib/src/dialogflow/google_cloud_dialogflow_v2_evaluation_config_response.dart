...
class GoogleCloudDialogflowV2EvaluationConfigResponse {
  ...
  final GoogleCloudDialogflowV2EvaluationConfigSmartComposeConfigResponse smartComposeConfig;
  /// Configuration for smart reply model evalution.
  final GoogleCloudDialogflowV2EvaluationConfigSmartReplyConfigResponse smartReplyConfig;
  ...
  factory GoogleCloudDialogflowV2EvaluationConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2EvaluationConfigResponse(
      ...
      smartComposeConfig: GoogleCloudDialogflowV2EvaluationConfigSmartComposeConfigResponse.fromMap((map['smartComposeConfig'] as Map).cast<String, dynamic>()),
      smartReplyConfig: GoogleCloudDialogflowV2EvaluationConfigSmartReplyConfigResponse.fromMap((map['smartReplyConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
