...
class GoogleCloudDialogflowV2EvaluationConfigResponse {
  ...
  factory GoogleCloudDialogflowV2EvaluationConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2EvaluationConfigResponse(
      datasets: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudDialogflowV2InputDatasetResponse>(map['datasets']!, (value) => GoogleCloudDialogflowV2InputDatasetResponse.fromMap((value as Map).cast<String, dynamic>()))),
      smartComposeConfig: pulumi.Input.fromValue(GoogleCloudDialogflowV2EvaluationConfigSmartComposeConfigResponse.fromMap((map['smartComposeConfig']! as Map).cast<String, dynamic>())),
      smartReplyConfig: pulumi.Input.fromValue(GoogleCloudDialogflowV2EvaluationConfigSmartReplyConfigResponse.fromMap((map['smartReplyConfig']! as Map).cast<String, dynamic>())),
    );
  }
}
