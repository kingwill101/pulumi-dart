...
class GoogleCloudDialogflowV2beta1EntityTypeEntity {
  ...
  /// Creates a new [GoogleCloudDialogflowV2beta1EntityTypeEntity].
  ...
  const GoogleCloudDialogflowV2beta1EntityTypeEntity({
  ...
  factory GoogleCloudDialogflowV2beta1EntityTypeEntity.fromMap(Map<String, dynamic> map) {
