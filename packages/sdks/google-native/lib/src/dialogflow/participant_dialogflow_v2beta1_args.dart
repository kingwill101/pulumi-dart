...
class ParticipantDialogflowV2beta1Args {
  ...
  const ParticipantDialogflowV2beta1Args({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'project': ?project,
      'role': ?pulumi.Input.mapOptionalInputValue<ParticipantRoleDialogflowV2beta1, String>(role, (value) => value.wireValue),
    };
  }
  ...
  factory ParticipantDialogflowV2beta1Args.fromMap(Map<String, dynamic> map) {
    return ParticipantDialogflowV2beta1Args(
      ...
      role: (() { final guardedValue = map['role']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ParticipantRoleDialogflowV2beta1.fromValue(guardedValue as String)); })(),
    );
  }
}
