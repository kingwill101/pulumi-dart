...
class ConversationProfileArgs {
  ...
  ConversationProfileArgs({
    pulumi.Output<GoogleCloudDialogflowV2AutomatedAgentConfig>? automatedAgentConfig,
    required pulumi.Output<String> displayName,
    pulumi.Output<GoogleCloudDialogflowV2HumanAgentAssistantConfig>? humanAgentAssistantConfig,
    pulumi.Output<GoogleCloudDialogflowV2HumanAgentHandoffConfig>? humanAgentHandoffConfig,
    pulumi.Output<String>? languageCode,
    pulumi.Output<String>? location,
    pulumi.Output<GoogleCloudDialogflowV2LoggingConfig>? loggingConfig,
    pulumi.Output<String>? name,
    pulumi.Output<GoogleCloudDialogflowV2NotificationConfig>? newMessageEventNotificationConfig,
    pulumi.Output<GoogleCloudDialogflowV2NotificationConfig>? notificationConfig,
    pulumi.Output<String>? project,
    pulumi.Output<String>? securitySettings,
    pulumi.Output<GoogleCloudDialogflowV2SpeechToTextConfig>? sttConfig,
    pulumi.Output<String>? timeZone,
    pulumi.Output<GoogleCloudDialogflowV2SynthesizeSpeechConfig>? ttsConfig,
  }) :
      automatedAgentConfig = pulumi.Input.asOptionalInput<GoogleCloudDialogflowV2AutomatedAgentConfig>(automatedAgentConfig),
      displayName = pulumi.Input.asInput<String>(displayName),
      humanAgentAssistantConfig = pulumi.Input.asOptionalInput<GoogleCloudDialogflowV2HumanAgentAssistantConfig>(humanAgentAssistantConfig),
      humanAgentHandoffConfig = pulumi.Input.asOptionalInput<GoogleCloudDialogflowV2HumanAgentHandoffConfig>(humanAgentHandoffConfig),
      languageCode = pulumi.Input.asOptionalInput<String>(languageCode),
      location = pulumi.Input.asOptionalInput<String>(location),
      loggingConfig = pulumi.Input.asOptionalInput<GoogleCloudDialogflowV2LoggingConfig>(loggingConfig),
      name = pulumi.Input.asOptionalInput<String>(name),
      newMessageEventNotificationConfig = pulumi.Input.asOptionalInput<GoogleCloudDialogflowV2NotificationConfig>(newMessageEventNotificationConfig),
      notificationConfig = pulumi.Input.asOptionalInput<GoogleCloudDialogflowV2NotificationConfig>(notificationConfig),
      project = pulumi.Input.asOptionalInput<String>(project),
      securitySettings = pulumi.Input.asOptionalInput<String>(securitySettings),
      sttConfig = pulumi.Input.asOptionalInput<GoogleCloudDialogflowV2SpeechToTextConfig>(sttConfig),
      timeZone = pulumi.Input.asOptionalInput<String>(timeZone),
      ttsConfig = pulumi.Input.asOptionalInput<GoogleCloudDialogflowV2SynthesizeSpeechConfig>(ttsConfig);
  ...
  factory ConversationProfileArgs.fromMap(Map<String, dynamic> map) {
    return ConversationProfileArgs(
      automatedAgentConfig: map['automatedAgentConfig'] == null ? null : pulumi.Output.create<GoogleCloudDialogflowV2AutomatedAgentConfig>(GoogleCloudDialogflowV2AutomatedAgentConfig.fromMap((map['automatedAgentConfig'] as Map).cast<String, dynamic>())),
      displayName: pulumi.Output.create<String>(map['displayName'] as String),
      humanAgentAssistantConfig: map['humanAgentAssistantConfig'] == null ? null : pulumi.Output.create<GoogleCloudDialogflowV2HumanAgentAssistantConfig>(GoogleCloudDialogflowV2HumanAgentAssistantConfig.fromMap((map['humanAgentAssistantConfig'] as Map).cast<String, dynamic>())),
      humanAgentHandoffConfig: map['humanAgentHandoffConfig'] == null ? null : pulumi.Output.create<GoogleCloudDialogflowV2HumanAgentHandoffConfig>(GoogleCloudDialogflowV2HumanAgentHandoffConfig.fromMap((map['humanAgentHandoffConfig'] as Map).cast<String, dynamic>())),
      languageCode: map['languageCode'] == null ? null : pulumi.Output.create<String>(map['languageCode'] as String),
      location: map['location'] == null ? null : pulumi.Output.create<String>(map['location'] as String),
      loggingConfig: map['loggingConfig'] == null ? null : pulumi.Output.create<GoogleCloudDialogflowV2LoggingConfig>(GoogleCloudDialogflowV2LoggingConfig.fromMap((map['loggingConfig'] as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      newMessageEventNotificationConfig: map['newMessageEventNotificationConfig'] == null ? null : pulumi.Output.create<GoogleCloudDialogflowV2NotificationConfig>(GoogleCloudDialogflowV2NotificationConfig.fromMap((map['newMessageEventNotificationConfig'] as Map).cast<String, dynamic>())),
      notificationConfig: map['notificationConfig'] == null ? null : pulumi.Output.create<GoogleCloudDialogflowV2NotificationConfig>(GoogleCloudDialogflowV2NotificationConfig.fromMap((map['notificationConfig'] as Map).cast<String, dynamic>())),
      ...
      sttConfig: map['sttConfig'] == null ? null : pulumi.Output.create<GoogleCloudDialogflowV2SpeechToTextConfig>(GoogleCloudDialogflowV2SpeechToTextConfig.fromMap((map['sttConfig'] as Map).cast<String, dynamic>())),
      timeZone: map['timeZone'] == null ? null : pulumi.Output.create<String>(map['timeZone'] as String),
      ttsConfig: map['ttsConfig'] == null ? null : pulumi.Output.create<GoogleCloudDialogflowV2SynthesizeSpeechConfig>(GoogleCloudDialogflowV2SynthesizeSpeechConfig.fromMap((map['ttsConfig'] as Map).cast<String, dynamic>())),
    );
  }
}
