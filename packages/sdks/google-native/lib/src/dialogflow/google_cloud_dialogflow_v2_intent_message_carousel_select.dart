...
class GoogleCloudDialogflowV2IntentMessageCarouselSelect {
  ...
  factory GoogleCloudDialogflowV2IntentMessageCarouselSelect.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2IntentMessageCarouselSelect(
      items: (pulumi.Input.decodeList<GoogleCloudDialogflowV2IntentMessageCarouselSelectItem>(map['items'], (value) => GoogleCloudDialogflowV2IntentMessageCarouselSelectItem.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
