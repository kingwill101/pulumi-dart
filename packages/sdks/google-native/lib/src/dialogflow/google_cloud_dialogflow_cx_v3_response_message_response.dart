...
class GoogleCloudDialogflowCxV3ResponseMessageResponse {
  ...
  final pulumi.Input<GoogleCloudDialogflowCxV3ResponseMessageMixedAudioResponse>
  mixedAudio;
  ...
  final pulumi.Input<GoogleCloudDialogflowCxV3ResponseMessagePlayAudioResponse>
  playAudio;
  ...
  factory GoogleCloudDialogflowCxV3ResponseMessageResponse.fromMap(
    ...
    return GoogleCloudDialogflowCxV3ResponseMessageResponse(
      ...
      conversationSuccess: pulumi.Input.fromValue(
        GoogleCloudDialogflowCxV3ResponseMessageConversationSuccessResponse.fromMap(
          (map['conversationSuccess']! as Map).cast<String, dynamic>(),
        ),
      ),
      endInteraction: pulumi.Input.fromValue(
        (map['endInteraction']! as Map).cast<String, dynamic>(),
      ),
      knowledgeInfoCard: pulumi.Input.fromValue(
        (map['knowledgeInfoCard']! as Map).cast<String, dynamic>(),
      ),
      liveAgentHandoff: pulumi.Input.fromValue(
        GoogleCloudDialogflowCxV3ResponseMessageLiveAgentHandoffResponse.fromMap(
          (map['liveAgentHandoff']! as Map).cast<String, dynamic>(),
        ),
      ),
      mixedAudio: pulumi.Input.fromValue(
        GoogleCloudDialogflowCxV3ResponseMessageMixedAudioResponse.fromMap(
          (map['mixedAudio']! as Map).cast<String, dynamic>(),
        ),
      ),
      outputAudioText: pulumi.Input.fromValue(
        GoogleCloudDialogflowCxV3ResponseMessageOutputAudioTextResponse.fromMap(
      ...
      playAudio: pulumi.Input.fromValue(
      ...
      telephonyTransferCall: pulumi.Input.fromValue(
        GoogleCloudDialogflowCxV3ResponseMessageTelephonyTransferCallResponse.fromMap(
