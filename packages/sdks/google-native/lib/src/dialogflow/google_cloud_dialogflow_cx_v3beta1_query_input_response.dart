...
class GoogleCloudDialogflowCxV3beta1QueryInputResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'audio': pulumi.Input.mapInputValue<GoogleCloudDialogflowCxV3beta1AudioInputResponse, Map<String, dynamic>>(audio, (value) => value.toMap()),
      'dtmf': pulumi.Input.mapInputValue<GoogleCloudDialogflowCxV3beta1DtmfInputResponse, Map<String, dynamic>>(dtmf, (value) => value.toMap()),
      'event': pulumi.Input.mapInputValue<GoogleCloudDialogflowCxV3beta1EventInputResponse, Map<String, dynamic>>(event, (value) => value.toMap()),
      'intent': pulumi.Input.mapInputValue<GoogleCloudDialogflowCxV3beta1IntentInputResponse, Map<String, dynamic>>(intent, (value) => value.toMap()),
      'languageCode': languageCode,
      'text': pulumi.Input.mapInputValue<GoogleCloudDialogflowCxV3beta1TextInputResponse, Map<String, dynamic>>(text, (value) => value.toMap()),
    };
  }
  ...
  factory GoogleCloudDialogflowCxV3beta1QueryInputResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3beta1QueryInputResponse(
      audio: pulumi.Input.fromValue(GoogleCloudDialogflowCxV3beta1AudioInputResponse.fromMap((map['audio']! as Map).cast<String, dynamic>())),
      dtmf: pulumi.Input.fromValue(GoogleCloudDialogflowCxV3beta1DtmfInputResponse.fromMap((map['dtmf']! as Map).cast<String, dynamic>())),
      event: pulumi.Input.fromValue(GoogleCloudDialogflowCxV3beta1EventInputResponse.fromMap((map['event']! as Map).cast<String, dynamic>())),
      intent: pulumi.Input.fromValue(GoogleCloudDialogflowCxV3beta1IntentInputResponse.fromMap((map['intent']! as Map).cast<String, dynamic>())),
      languageCode: pulumi.Input.fromValue(map['languageCode'] as String),
      text: pulumi.Input.fromValue(GoogleCloudDialogflowCxV3beta1TextInputResponse.fromMap((map['text']! as Map).cast<String, dynamic>())),
    );
  }
}
