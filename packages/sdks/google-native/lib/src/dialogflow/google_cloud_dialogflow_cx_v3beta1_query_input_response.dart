...
class GoogleCloudDialogflowCxV3beta1QueryInputResponse {
  ...
  factory GoogleCloudDialogflowCxV3beta1QueryInputResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3beta1QueryInputResponse(
      audio: (GoogleCloudDialogflowCxV3beta1AudioInputResponse.fromMap((map['audio'] as Map).cast<String, dynamic>())).input(),
      dtmf: (GoogleCloudDialogflowCxV3beta1DtmfInputResponse.fromMap((map['dtmf'] as Map).cast<String, dynamic>())).input(),
      event: (GoogleCloudDialogflowCxV3beta1EventInputResponse.fromMap((map['event'] as Map).cast<String, dynamic>())).input(),
      intent: (GoogleCloudDialogflowCxV3beta1IntentInputResponse.fromMap((map['intent'] as Map).cast<String, dynamic>())).input(),
      languageCode: (map['languageCode'] as String).input(),
      text: (GoogleCloudDialogflowCxV3beta1TextInputResponse.fromMap((map['text'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
