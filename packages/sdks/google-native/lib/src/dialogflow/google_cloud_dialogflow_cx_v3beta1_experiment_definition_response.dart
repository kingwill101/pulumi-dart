...
class GoogleCloudDialogflowCxV3beta1ExperimentDefinitionResponse {
  ...
  final pulumi.Input<GoogleCloudDialogflowCxV3beta1VersionVariantsResponse>
  versionVariants;
  ...
  factory GoogleCloudDialogflowCxV3beta1ExperimentDefinitionResponse.fromMap(
    ...
    return GoogleCloudDialogflowCxV3beta1ExperimentDefinitionResponse(
      ...
      versionVariants: pulumi.Input.fromValue(
        GoogleCloudDialogflowCxV3beta1VersionVariantsResponse.fromMap(
