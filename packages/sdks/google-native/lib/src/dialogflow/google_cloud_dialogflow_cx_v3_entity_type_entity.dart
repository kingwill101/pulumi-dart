...
class GoogleCloudDialogflowCxV3EntityTypeEntity {
  ...
  /// Creates a new [GoogleCloudDialogflowCxV3EntityTypeEntity].
  ...
  const GoogleCloudDialogflowCxV3EntityTypeEntity({
  ...
  factory GoogleCloudDialogflowCxV3EntityTypeEntity.fromMap(Map<String, dynamic> map) {
