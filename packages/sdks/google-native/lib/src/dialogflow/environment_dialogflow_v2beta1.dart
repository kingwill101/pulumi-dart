...
class EnvironmentDialogflowV2beta1 extends pulumi.CustomResource {
  ...
  EnvironmentDialogflowV2beta1(
    ...
    this.fulfillment = registerOutput<GoogleCloudDialogflowV2beta1FulfillmentResponse>('fulfillment');
    this.location = registerOutput<String>('location');
    this.name = registerOutput<String>('name');
    this.project = registerOutput<String>('project');
    this.state = registerOutput<String>('state');
    this.textToSpeechSettings = registerOutput<GoogleCloudDialogflowV2beta1TextToSpeechSettingsResponse>('textToSpeechSettings');
