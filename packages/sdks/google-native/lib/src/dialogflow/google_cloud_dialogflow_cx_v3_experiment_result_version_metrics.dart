...
class GoogleCloudDialogflowCxV3ExperimentResultVersionMetrics {
  ...
  final pulumi.Input<List<GoogleCloudDialogflowCxV3ExperimentResultMetric>>?
  metrics;
    ...
    return <String, dynamic>{
      'metrics':
          ?pulumi.Input.mapOptionalInputValue<
            List<GoogleCloudDialogflowCxV3ExperimentResultMetric>,
    ...
    return GoogleCloudDialogflowCxV3ExperimentResultVersionMetrics(
      metrics: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => GoogleCloudDialogflowCxV3ExperimentResultMetric.fromMap(
      ...
      sessionCount: (() {
        final guardedValue = map['sessionCount'];
        if (guardedValue == null) return null;
