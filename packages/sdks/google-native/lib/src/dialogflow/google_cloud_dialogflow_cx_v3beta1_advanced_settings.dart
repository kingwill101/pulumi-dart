...
class GoogleCloudDialogflowCxV3beta1AdvancedSettings {
  ...
  const GoogleCloudDialogflowCxV3beta1AdvancedSettings({
  ...
  factory GoogleCloudDialogflowCxV3beta1AdvancedSettings.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3beta1AdvancedSettings(
      audioExportGcsDestination: (() { final guardedValue = map['audioExportGcsDestination']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowCxV3beta1GcsDestination.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      dtmfSettings: (() { final guardedValue = map['dtmfSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowCxV3beta1AdvancedSettingsDtmfSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      loggingSettings: (() { final guardedValue = map['loggingSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowCxV3beta1AdvancedSettingsLoggingSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
