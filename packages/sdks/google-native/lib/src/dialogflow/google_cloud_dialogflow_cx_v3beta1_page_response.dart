...
class GoogleCloudDialogflowCxV3beta1PageResponse {
  ...
  const GoogleCloudDialogflowCxV3beta1PageResponse({
  ...
  factory GoogleCloudDialogflowCxV3beta1PageResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3beta1PageResponse(
      ...
      entryFulfillment: pulumi.Input.fromValue(GoogleCloudDialogflowCxV3beta1FulfillmentResponse.fromMap((map['entryFulfillment']! as Map).cast<String, dynamic>())),
      eventHandlers: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudDialogflowCxV3beta1EventHandlerResponse>(map['eventHandlers']!, (value) => GoogleCloudDialogflowCxV3beta1EventHandlerResponse.fromMap((value as Map).cast<String, dynamic>()))),
      form: pulumi.Input.fromValue(GoogleCloudDialogflowCxV3beta1FormResponse.fromMap((map['form']! as Map).cast<String, dynamic>())),
      knowledgeConnectorSettings: pulumi.Input.fromValue(GoogleCloudDialogflowCxV3beta1KnowledgeConnectorSettingsResponse.fromMap((map['knowledgeConnectorSettings']! as Map).cast<String, dynamic>())),
      name: pulumi.Input.fromValue(map['name'] as String),
      transitionRouteGroups: pulumi.Input.fromValue((map['transitionRouteGroups'] as List).cast<String>()),
      transitionRoutes: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudDialogflowCxV3beta1TransitionRouteResponse>(map['transitionRoutes']!, (value) => GoogleCloudDialogflowCxV3beta1TransitionRouteResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
