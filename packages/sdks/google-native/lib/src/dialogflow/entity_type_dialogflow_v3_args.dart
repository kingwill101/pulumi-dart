...
class EntityTypeDialogflowV3Args {
  ...
  const EntityTypeDialogflowV3Args({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'agentId': agentId,
      'autoExpansionMode': ?pulumi.Input.mapOptionalInputValue<EntityTypeAutoExpansionModeDialogflowV3, String>(autoExpansionMode, (value) => value.wireValue),
      ...
      'kind': pulumi.Input.mapInputValue<EntityTypeKindDialogflowV3, String>(kind, (value) => value.wireValue),
  ...
  factory EntityTypeDialogflowV3Args.fromMap(Map<String, dynamic> map) {
    return EntityTypeDialogflowV3Args(
      ...
      autoExpansionMode: (() { final guardedValue = map['autoExpansionMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EntityTypeAutoExpansionModeDialogflowV3.fromValue(guardedValue as String)); })(),
      ...
      entities: (() { final guardedValue = map['entities']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudDialogflowCxV3EntityTypeEntity>(guardedValue, (value) => GoogleCloudDialogflowCxV3EntityTypeEntity.fromMap((value as Map).cast<String, dynamic>()))); })(),
      excludedPhrases: (() { final guardedValue = map['excludedPhrases']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudDialogflowCxV3EntityTypeExcludedPhrase>(guardedValue, (value) => GoogleCloudDialogflowCxV3EntityTypeExcludedPhrase.fromMap((value as Map).cast<String, dynamic>()))); })(),
      kind: pulumi.Input.fromValue(EntityTypeKindDialogflowV3.fromValue(map['kind']! as String)),
