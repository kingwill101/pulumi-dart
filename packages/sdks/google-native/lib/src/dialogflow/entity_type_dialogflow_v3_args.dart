...
class EntityTypeDialogflowV3Args {
    ...
    return <String, dynamic>{
      ...
      'autoExpansionMode':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(autoExpansionMode, (value) => value.wireValue),
      ...
      'kind': pulumi.Input.mapInputValue<EntityTypeKindDialogflowV3, String>(
        kind,
  ...
  factory EntityTypeDialogflowV3Args.fromMap(Map<String, dynamic> map) {
    return EntityTypeDialogflowV3Args(
      ...
      autoExpansionMode: (() {
        final guardedValue = map['autoExpansionMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          EntityTypeAutoExpansionModeDialogflowV3.fromValue(
      ...
      entities: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GoogleCloudDialogflowCxV3EntityTypeEntity>(
            guardedValue,
            (value) => GoogleCloudDialogflowCxV3EntityTypeEntity.fromMap(
      ...
      excludedPhrases: (() {
        final guardedValue = map['excludedPhrases'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                GoogleCloudDialogflowCxV3EntityTypeExcludedPhrase.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      kind: pulumi.Input.fromValue(
        EntityTypeKindDialogflowV3.fromValue(map['kind']! as String),
      ),
      languageCode: (() {
