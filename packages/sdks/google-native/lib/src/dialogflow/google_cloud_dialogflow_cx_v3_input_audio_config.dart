...
class GoogleCloudDialogflowCxV3InputAudioConfig {
  ...
  final pulumi.Input<GoogleCloudDialogflowCxV3InputAudioConfigAudioEncoding> audioEncoding;
  ...
  final pulumi.Input<GoogleCloudDialogflowCxV3InputAudioConfigModelVariant>? modelVariant;
  ...
  const GoogleCloudDialogflowCxV3InputAudioConfig({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'audioEncoding': pulumi.Input.mapInputValue<GoogleCloudDialogflowCxV3InputAudioConfigAudioEncoding, String>(audioEncoding, (value) => value.wireValue),
      'bargeInConfig': ?pulumi.Input.mapOptionalInputValue<GoogleCloudDialogflowCxV3BargeInConfig, Map<String, dynamic>>(bargeInConfig, (value) => value.toMap()),
      'enableWordInfo': ?enableWordInfo,
      'model': ?model,
      'modelVariant': ?pulumi.Input.mapOptionalInputValue<GoogleCloudDialogflowCxV3InputAudioConfigModelVariant, String>(modelVariant, (value) => value.wireValue),
  ...
  factory GoogleCloudDialogflowCxV3InputAudioConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3InputAudioConfig(
      audioEncoding: pulumi.Input.fromValue(GoogleCloudDialogflowCxV3InputAudioConfigAudioEncoding.fromValue(map['audioEncoding']! as String)),
      bargeInConfig: (() { final guardedValue = map['bargeInConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowCxV3BargeInConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      modelVariant: (() { final guardedValue = map['modelVariant']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowCxV3InputAudioConfigModelVariant.fromValue(guardedValue as String)); })(),
