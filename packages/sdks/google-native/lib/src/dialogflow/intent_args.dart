...
class IntentArgs {
  ...
  IntentArgs({
    ...
    pulumi.Output<List<IntentDefaultResponsePlatformsItem>>? defaultResponsePlatforms,
    ...
    pulumi.Output<List<GoogleCloudDialogflowV2IntentMessage>>? messages,
    pulumi.Output<bool>? mlDisabled,
    pulumi.Output<String>? name,
    pulumi.Output<List<GoogleCloudDialogflowV2Context>>? outputContexts,
    pulumi.Output<List<GoogleCloudDialogflowV2IntentParameter>>? parameters,
    pulumi.Output<String>? parentFollowupIntentName,
    pulumi.Output<int>? priority,
    pulumi.Output<String>? project,
    pulumi.Output<bool>? resetContexts,
    pulumi.Output<List<GoogleCloudDialogflowV2IntentTrainingPhrase>>? trainingPhrases,
    pulumi.Output<IntentWebhookState>? webhookState,
  }) :
      action = pulumi.Input.asOptionalInput<String>(action),
      defaultResponsePlatforms = pulumi.Input.asOptionalInput<List<IntentDefaultResponsePlatformsItem>>(defaultResponsePlatforms),
      ...
      messages = pulumi.Input.asOptionalInput<List<GoogleCloudDialogflowV2IntentMessage>>(messages),
      mlDisabled = pulumi.Input.asOptionalInput<bool>(mlDisabled),
      name = pulumi.Input.asOptionalInput<String>(name),
      outputContexts = pulumi.Input.asOptionalInput<List<GoogleCloudDialogflowV2Context>>(outputContexts),
      parameters = pulumi.Input.asOptionalInput<List<GoogleCloudDialogflowV2IntentParameter>>(parameters),
      ...
      trainingPhrases = pulumi.Input.asOptionalInput<List<GoogleCloudDialogflowV2IntentTrainingPhrase>>(trainingPhrases),
      webhookState = pulumi.Input.asOptionalInput<IntentWebhookState>(webhookState);
  ...
  factory IntentArgs.fromMap(Map<String, dynamic> map) {
    return IntentArgs(
      ...
      defaultResponsePlatforms: map['defaultResponsePlatforms'] == null ? null : pulumi.Output.create<List<IntentDefaultResponsePlatformsItem>>(pulumi.Input.decodeList<IntentDefaultResponsePlatformsItem>(map['defaultResponsePlatforms'], (value) => IntentDefaultResponsePlatformsItem.fromValue(value as String))),
      ...
      messages: map['messages'] == null ? null : pulumi.Output.create<List<GoogleCloudDialogflowV2IntentMessage>>(pulumi.Input.decodeList<GoogleCloudDialogflowV2IntentMessage>(map['messages'], (value) => GoogleCloudDialogflowV2IntentMessage.fromMap((value as Map).cast<String, dynamic>()))),
      mlDisabled: map['mlDisabled'] == null ? null : pulumi.Output.create<bool>(map['mlDisabled'] as bool),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      outputContexts: map['outputContexts'] == null ? null : pulumi.Output.create<List<GoogleCloudDialogflowV2Context>>(pulumi.Input.decodeList<GoogleCloudDialogflowV2Context>(map['outputContexts'], (value) => GoogleCloudDialogflowV2Context.fromMap((value as Map).cast<String, dynamic>()))),
      parameters: map['parameters'] == null ? null : pulumi.Output.create<List<GoogleCloudDialogflowV2IntentParameter>>(pulumi.Input.decodeList<GoogleCloudDialogflowV2IntentParameter>(map['parameters'], (value) => GoogleCloudDialogflowV2IntentParameter.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      trainingPhrases: map['trainingPhrases'] == null ? null : pulumi.Output.create<List<GoogleCloudDialogflowV2IntentTrainingPhrase>>(pulumi.Input.decodeList<GoogleCloudDialogflowV2IntentTrainingPhrase>(map['trainingPhrases'], (value) => GoogleCloudDialogflowV2IntentTrainingPhrase.fromMap((value as Map).cast<String, dynamic>()))),
      webhookState: map['webhookState'] == null ? null : pulumi.Output.create<IntentWebhookState>(IntentWebhookState.fromValue(map['webhookState'] as String)),
    );
  }
}
