...
class GoogleCloudDialogflowV2FulfillmentResponse {
  ...
  const GoogleCloudDialogflowV2FulfillmentResponse({
  ...
  factory GoogleCloudDialogflowV2FulfillmentResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2FulfillmentResponse(
      ...
      features: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudDialogflowV2FulfillmentFeatureResponse>(map['features']!, (value) => GoogleCloudDialogflowV2FulfillmentFeatureResponse.fromMap((value as Map).cast<String, dynamic>()))),
      genericWebService: pulumi.Input.fromValue(GoogleCloudDialogflowV2FulfillmentGenericWebServiceResponse.fromMap((map['genericWebService']! as Map).cast<String, dynamic>())),
