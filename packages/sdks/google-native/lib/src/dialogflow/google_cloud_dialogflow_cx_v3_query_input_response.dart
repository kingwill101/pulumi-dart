  ...
  factory GoogleCloudDialogflowCxV3QueryInputResponse.fromMap(
    ...
    return GoogleCloudDialogflowCxV3QueryInputResponse(
      audio: pulumi.Input.fromValue(
        GoogleCloudDialogflowCxV3AudioInputResponse.fromMap(
          (map['audio']! as Map).cast<String, dynamic>(),
        ),
      ),
      dtmf: pulumi.Input.fromValue(
        GoogleCloudDialogflowCxV3DtmfInputResponse.fromMap(
          (map['dtmf']! as Map).cast<String, dynamic>(),
        ),
      ),
      event: pulumi.Input.fromValue(
        GoogleCloudDialogflowCxV3EventInputResponse.fromMap(
          (map['event']! as Map).cast<String, dynamic>(),
        ),
      ),
      intent: pulumi.Input.fromValue(
        GoogleCloudDialogflowCxV3IntentInputResponse.fromMap(
      ...
      text: pulumi.Input.fromValue(
        GoogleCloudDialogflowCxV3TextInputResponse.fromMap(
