...
class GoogleCloudDialogflowCxV3QueryInputResponse {
  ...
  factory GoogleCloudDialogflowCxV3QueryInputResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3QueryInputResponse(
      audio: (GoogleCloudDialogflowCxV3AudioInputResponse.fromMap((map['audio'] as Map).cast<String, dynamic>())).input(),
      dtmf: (GoogleCloudDialogflowCxV3DtmfInputResponse.fromMap((map['dtmf'] as Map).cast<String, dynamic>())).input(),
      event: (GoogleCloudDialogflowCxV3EventInputResponse.fromMap((map['event'] as Map).cast<String, dynamic>())).input(),
      intent: (GoogleCloudDialogflowCxV3IntentInputResponse.fromMap((map['intent'] as Map).cast<String, dynamic>())).input(),
      languageCode: (map['languageCode'] as String).input(),
      text: (GoogleCloudDialogflowCxV3TextInputResponse.fromMap((map['text'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
