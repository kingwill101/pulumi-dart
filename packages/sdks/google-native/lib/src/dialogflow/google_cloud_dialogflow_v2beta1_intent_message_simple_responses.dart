...
class GoogleCloudDialogflowV2beta1IntentMessageSimpleResponses {
  ...
  factory GoogleCloudDialogflowV2beta1IntentMessageSimpleResponses.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2beta1IntentMessageSimpleResponses(
      simpleResponses: (pulumi.Input.decodeList<GoogleCloudDialogflowV2beta1IntentMessageSimpleResponse>(map['simpleResponses'], (value) => GoogleCloudDialogflowV2beta1IntentMessageSimpleResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
