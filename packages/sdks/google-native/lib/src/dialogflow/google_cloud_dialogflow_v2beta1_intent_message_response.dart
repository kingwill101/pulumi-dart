...
class GoogleCloudDialogflowV2beta1IntentMessageResponse {
  ...
  final pulumi.Input<GoogleCloudDialogflowV2beta1IntentMessageBasicCardResponse>
  basicCard;
  ...
  /// Displays a card.
  final pulumi.Input<GoogleCloudDialogflowV2beta1IntentMessageCardResponse>
  card;
  ...
  final pulumi.Input<GoogleCloudDialogflowV2beta1IntentMessageRbmTextResponse>
  rbmText;
  ...
  final pulumi.Input<GoogleCloudDialogflowV2beta1IntentMessageTableCardResponse>
  tableCard;
  ...
  final pulumi.Input<GoogleCloudDialogflowV2beta1IntentMessageTextResponse>
  text;
  ...
  factory GoogleCloudDialogflowV2beta1IntentMessageResponse.fromMap(
    ...
    return GoogleCloudDialogflowV2beta1IntentMessageResponse(
      ...
      card: pulumi.Input.fromValue(
        GoogleCloudDialogflowV2beta1IntentMessageCardResponse.fromMap(
          (map['card']! as Map).cast<String, dynamic>(),
        ),
      ),
      carouselSelect: pulumi.Input.fromValue(
      ...
      linkOutSuggestion: pulumi.Input.fromValue(
      ...
      rbmCarouselRichCard: pulumi.Input.fromValue(
      ...
      rbmStandaloneRichCard: pulumi.Input.fromValue(
      ...
      rbmText: pulumi.Input.fromValue(
        GoogleCloudDialogflowV2beta1IntentMessageRbmTextResponse.fromMap(
          (map['rbmText']! as Map).cast<String, dynamic>(),
        ),
      ),
      simpleResponses: pulumi.Input.fromValue(
      ...
      telephonySynthesizeSpeech: pulumi.Input.fromValue(
      ...
      telephonyTransferCall: pulumi.Input.fromValue(
      ...
      text: pulumi.Input.fromValue(
        GoogleCloudDialogflowV2beta1IntentMessageTextResponse.fromMap(
