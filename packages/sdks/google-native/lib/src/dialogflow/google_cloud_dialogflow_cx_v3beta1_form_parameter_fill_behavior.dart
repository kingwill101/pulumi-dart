...
class GoogleCloudDialogflowCxV3beta1FormParameterFillBehavior {
  ...
  final GoogleCloudDialogflowCxV3beta1Fulfillment initialPromptFulfillment;
  ...
  final List<GoogleCloudDialogflowCxV3beta1EventHandler>? repromptEventHandlers;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'repromptEventHandlers': ?repromptEventHandlers == null ? null : pulumi.Input.encodeList<GoogleCloudDialogflowCxV3beta1EventHandler, Map<String, dynamic>>(repromptEventHandlers!, (value) => value.toMap()),
    };
  }
  ...
  factory GoogleCloudDialogflowCxV3beta1FormParameterFillBehavior.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3beta1FormParameterFillBehavior(
      initialPromptFulfillment: GoogleCloudDialogflowCxV3beta1Fulfillment.fromMap((map['initialPromptFulfillment'] as Map).cast<String, dynamic>()),
      repromptEventHandlers: map['repromptEventHandlers'] == null ? null : pulumi.Input.decodeList<GoogleCloudDialogflowCxV3beta1EventHandler>(map['repromptEventHandlers'], (value) => GoogleCloudDialogflowCxV3beta1EventHandler.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
