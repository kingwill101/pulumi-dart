...
class GoogleCloudDialogflowCxV3beta1FormParameterFillBehavior {
  ...
  const GoogleCloudDialogflowCxV3beta1FormParameterFillBehavior({
  ...
  factory GoogleCloudDialogflowCxV3beta1FormParameterFillBehavior.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3beta1FormParameterFillBehavior(
      initialPromptFulfillment: pulumi.Input.fromValue(GoogleCloudDialogflowCxV3beta1Fulfillment.fromMap((map['initialPromptFulfillment']! as Map).cast<String, dynamic>())),
      repromptEventHandlers: (() { final guardedValue = map['repromptEventHandlers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudDialogflowCxV3beta1EventHandler>(guardedValue, (value) => GoogleCloudDialogflowCxV3beta1EventHandler.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
