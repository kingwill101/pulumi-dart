...
class GoogleCloudDialogflowV2beta1IntentMessageRbmCardContentRbmMedia {
  ...
  final pulumi.Input<GoogleCloudDialogflowV2beta1IntentMessageRbmCardContentRbmMediaHeight>? height;
  ...
  const GoogleCloudDialogflowV2beta1IntentMessageRbmCardContentRbmMedia({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'fileUri': fileUri,
      'height': ?pulumi.Input.mapOptionalInputValue<GoogleCloudDialogflowV2beta1IntentMessageRbmCardContentRbmMediaHeight, String>(height, (value) => value.wireValue),
  ...
  factory GoogleCloudDialogflowV2beta1IntentMessageRbmCardContentRbmMedia.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2beta1IntentMessageRbmCardContentRbmMedia(
      ...
      height: (() { final guardedValue = map['height']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowV2beta1IntentMessageRbmCardContentRbmMediaHeight.fromValue(guardedValue as String)); })(),
      thumbnailUri: (() { final guardedValue = map['thumbnailUri']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
