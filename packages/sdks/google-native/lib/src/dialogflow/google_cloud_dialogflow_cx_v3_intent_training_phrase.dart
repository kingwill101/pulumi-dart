...
class GoogleCloudDialogflowCxV3IntentTrainingPhrase {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'parts': pulumi.Input.encodeList<GoogleCloudDialogflowCxV3IntentTrainingPhrasePart, Map<String, dynamic>>(parts, (value) => value.toMap()),
  ...
  factory GoogleCloudDialogflowCxV3IntentTrainingPhrase.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3IntentTrainingPhrase(
      parts: pulumi.Input.decodeList<GoogleCloudDialogflowCxV3IntentTrainingPhrasePart>(map['parts'], (value) => GoogleCloudDialogflowCxV3IntentTrainingPhrasePart.fromMap((value as Map).cast<String, dynamic>())),
