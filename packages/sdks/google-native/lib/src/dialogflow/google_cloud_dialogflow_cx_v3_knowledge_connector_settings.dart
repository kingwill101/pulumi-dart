...
class GoogleCloudDialogflowCxV3KnowledgeConnectorSettings {
  ...
  const GoogleCloudDialogflowCxV3KnowledgeConnectorSettings({
  ...
  factory GoogleCloudDialogflowCxV3KnowledgeConnectorSettings.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3KnowledgeConnectorSettings(
      dataStoreConnections: (() { final guardedValue = map['dataStoreConnections']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudDialogflowCxV3DataStoreConnection>(guardedValue, (value) => GoogleCloudDialogflowCxV3DataStoreConnection.fromMap((value as Map).cast<String, dynamic>()))); })(),
