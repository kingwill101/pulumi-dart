...
class GoogleCloudDialogflowCxV3KnowledgeConnectorSettings {
  ...
  final pulumi.Input<List<GoogleCloudDialogflowCxV3DataStoreConnection>>?
    ...
    return <String, dynamic>{
      'dataStoreConnections':
          ?pulumi.Input.mapOptionalInputValue<
            List<GoogleCloudDialogflowCxV3DataStoreConnection>,
    ...
    return GoogleCloudDialogflowCxV3KnowledgeConnectorSettings(
      dataStoreConnections: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GoogleCloudDialogflowCxV3DataStoreConnection>(
            guardedValue,
