...
class ConversationModelArgs {
  ...
  factory ConversationModelArgs.fromMap(Map<String, dynamic> map) {
    return ConversationModelArgs(
      articleSuggestionModelMetadata: (() { final guardedValue = map['articleSuggestionModelMetadata']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowV2ArticleSuggestionModelMetadata.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      smartReplyModelMetadata: (() { final guardedValue = map['smartReplyModelMetadata']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowV2SmartReplyModelMetadata.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
