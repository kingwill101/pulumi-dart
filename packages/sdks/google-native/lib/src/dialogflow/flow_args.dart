...
class FlowArgs {
  ...
  FlowArgs({
    ...
    pulumi.Output<GoogleCloudDialogflowCxV3NluSettings>? nluSettings,
  ...
  factory FlowArgs.fromMap(Map<String, dynamic> map) {
    return FlowArgs(
      ...
      nluSettings: map['nluSettings'] == null ? null : pulumi.Output.create<GoogleCloudDialogflowCxV3NluSettings>(GoogleCloudDialogflowCxV3NluSettings.fromMap((map['nluSettings'] as Map).cast<String, dynamic>())),
