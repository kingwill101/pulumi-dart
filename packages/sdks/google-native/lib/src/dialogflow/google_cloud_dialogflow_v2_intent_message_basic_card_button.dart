...
class GoogleCloudDialogflowV2IntentMessageBasicCardButton {
  ...
  const GoogleCloudDialogflowV2IntentMessageBasicCardButton({
  ...
  factory GoogleCloudDialogflowV2IntentMessageBasicCardButton.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2IntentMessageBasicCardButton(
      openUriAction: pulumi.Input.fromValue(GoogleCloudDialogflowV2IntentMessageBasicCardButtonOpenUriAction.fromMap((map['openUriAction']! as Map).cast<String, dynamic>())),
