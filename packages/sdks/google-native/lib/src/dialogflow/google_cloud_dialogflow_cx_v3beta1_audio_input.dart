...
class GoogleCloudDialogflowCxV3beta1AudioInput {
  ...
  const GoogleCloudDialogflowCxV3beta1AudioInput({
    this.audio,
  ...
  factory GoogleCloudDialogflowCxV3beta1AudioInput.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3beta1AudioInput(
      ...
      config: pulumi.Input.fromValue(GoogleCloudDialogflowCxV3beta1InputAudioConfig.fromMap((map['config']! as Map).cast<String, dynamic>())),
    );
  }
}
