...
class GoogleCloudDialogflowV2HumanAgentAssistantConfig {
  ...
  factory GoogleCloudDialogflowV2HumanAgentAssistantConfig.fromMap(
    ...
    return GoogleCloudDialogflowV2HumanAgentAssistantConfig(
      endUserSuggestionConfig: (() {
        ...
        return pulumi.Input.fromValue(
          GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionConfig.fromMap(
      ...
      messageAnalysisConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GoogleCloudDialogflowV2HumanAgentAssistantConfigMessageAnalysisConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
