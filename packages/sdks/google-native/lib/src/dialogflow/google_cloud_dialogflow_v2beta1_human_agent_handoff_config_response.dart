...
class GoogleCloudDialogflowV2beta1HumanAgentHandoffConfigResponse {
  ...
  factory GoogleCloudDialogflowV2beta1HumanAgentHandoffConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2beta1HumanAgentHandoffConfigResponse(
      livePersonConfig: (GoogleCloudDialogflowV2beta1HumanAgentHandoffConfigLivePersonConfigResponse.fromMap((map['livePersonConfig'] as Map).cast<String, dynamic>())).input(),
      salesforceLiveAgentConfig: (GoogleCloudDialogflowV2beta1HumanAgentHandoffConfigSalesforceLiveAgentConfigResponse.fromMap((map['salesforceLiveAgentConfig'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
