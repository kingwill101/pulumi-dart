...
class GoogleCloudDialogflowCxV3beta1RolloutConfig {
  ...
  final List<GoogleCloudDialogflowCxV3beta1RolloutConfigRolloutStep>? rolloutSteps;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'rolloutSteps': ?rolloutSteps == null ? null : pulumi.Input.encodeList<GoogleCloudDialogflowCxV3beta1RolloutConfigRolloutStep, Map<String, dynamic>>(rolloutSteps!, (value) => value.toMap()),
    };
  }
  ...
  factory GoogleCloudDialogflowCxV3beta1RolloutConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3beta1RolloutConfig(
      ...
      rolloutSteps: map['rolloutSteps'] == null ? null : pulumi.Input.decodeList<GoogleCloudDialogflowCxV3beta1RolloutConfigRolloutStep>(map['rolloutSteps'], (value) => GoogleCloudDialogflowCxV3beta1RolloutConfigRolloutStep.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
