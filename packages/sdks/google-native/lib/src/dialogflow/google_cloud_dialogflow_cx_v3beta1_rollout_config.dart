...
class GoogleCloudDialogflowCxV3beta1RolloutConfig {
  ...
  const GoogleCloudDialogflowCxV3beta1RolloutConfig({
  ...
  factory GoogleCloudDialogflowCxV3beta1RolloutConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3beta1RolloutConfig(
      ...
      rolloutSteps: (() { final guardedValue = map['rolloutSteps']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudDialogflowCxV3beta1RolloutConfigRolloutStep>(guardedValue, (value) => GoogleCloudDialogflowCxV3beta1RolloutConfigRolloutStep.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
