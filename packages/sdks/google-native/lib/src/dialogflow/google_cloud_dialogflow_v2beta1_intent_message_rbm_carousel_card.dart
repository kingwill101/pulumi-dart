...
class GoogleCloudDialogflowV2beta1IntentMessageRbmCarouselCard {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'cardWidth': pulumi.Input.mapInputValue<GoogleCloudDialogflowV2beta1IntentMessageRbmCarouselCardCardWidth, String>(cardWidth, (value) => value.wireValue),
    };
  }
  ...
  factory GoogleCloudDialogflowV2beta1IntentMessageRbmCarouselCard.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2beta1IntentMessageRbmCarouselCard(
      cardContents: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudDialogflowV2beta1IntentMessageRbmCardContent>(map['cardContents']!, (value) => GoogleCloudDialogflowV2beta1IntentMessageRbmCardContent.fromMap((value as Map).cast<String, dynamic>()))),
      cardWidth: pulumi.Input.fromValue(GoogleCloudDialogflowV2beta1IntentMessageRbmCarouselCardCardWidth.fromValue(map['cardWidth']! as String)),
    );
  }
}
