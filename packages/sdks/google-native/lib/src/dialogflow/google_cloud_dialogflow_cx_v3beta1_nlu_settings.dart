...
class GoogleCloudDialogflowCxV3beta1NluSettings {
  ...
  final pulumi.Input<GoogleCloudDialogflowCxV3beta1NluSettingsModelType>?
  modelType;
    ...
    return <String, dynamic>{
      ...
      'modelTrainingMode':
          ?pulumi.Input.mapOptionalInputValue<
            GoogleCloudDialogflowCxV3beta1NluSettingsModelTrainingMode,
            String
          >(modelTrainingMode, (value) => value.wireValue),
      'modelType':
          ?pulumi.Input.mapOptionalInputValue<
            GoogleCloudDialogflowCxV3beta1NluSettingsModelType,
            String
          >(modelType, (value) => value.wireValue),
    };
  }

  factory GoogleCloudDialogflowCxV3beta1NluSettings.fromMap(
    Map<String, dynamic> map,
  ) {
    return GoogleCloudDialogflowCxV3beta1NluSettings(
      classificationThreshold: (() {
        final guardedValue = map['classificationThreshold'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as double);
      })(),
      modelTrainingMode: (() {
        final guardedValue = map['modelTrainingMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GoogleCloudDialogflowCxV3beta1NluSettingsModelTrainingMode.fromValue(
      ...
      modelType: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GoogleCloudDialogflowCxV3beta1NluSettingsModelType.fromValue(
            guardedValue as String,
          ),
        );
      })(),
