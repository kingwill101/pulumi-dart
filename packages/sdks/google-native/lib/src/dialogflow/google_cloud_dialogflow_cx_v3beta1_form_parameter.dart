...
class GoogleCloudDialogflowCxV3beta1FormParameter {
  ...
  final pulumi.Input<GoogleCloudDialogflowCxV3beta1FormParameterFillBehavior>
  fillBehavior;
    ...
    return <String, dynamic>{
      ...
      'fillBehavior':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(fillBehavior, (value) => value.toMap()),
      'isList': ?isList,
      'redact': ?redact,
      'required': ?required,
    };
  ...
  factory GoogleCloudDialogflowCxV3beta1FormParameter.fromMap(
    ...
    return GoogleCloudDialogflowCxV3beta1FormParameter(
      ...
      fillBehavior: pulumi.Input.fromValue(
        GoogleCloudDialogflowCxV3beta1FormParameterFillBehavior.fromMap(
          (map['fillBehavior']! as Map).cast<String, dynamic>(),
        ),
      ),
      isList: (() {
        final guardedValue = map['isList'];
        if (guardedValue == null) return null;
