...
class Page extends pulumi.CustomResource {
  ...
  late final pulumi.Output<GoogleCloudDialogflowCxV3FulfillmentResponse> entryFulfillment;
  /// Handlers associated with the page to handle events such as webhook errors, no match or no input.
  late final pulumi.Output<List<GoogleCloudDialogflowCxV3EventHandlerResponse>> eventHandlers;
  ...
  late final pulumi.Output<List<GoogleCloudDialogflowCxV3TransitionRouteResponse>> transitionRoutes;
  ...
  Page(
    ...
    this.entryFulfillment = registerOutput<GoogleCloudDialogflowCxV3FulfillmentResponse>('entryFulfillment');
    this.eventHandlers = registerOutput<List<GoogleCloudDialogflowCxV3EventHandlerResponse>>('eventHandlers');
    this.flowId = registerOutput<String>('flowId');
    this.form = registerOutput<GoogleCloudDialogflowCxV3FormResponse>('form');
    this.knowledgeConnectorSettings = registerOutput<GoogleCloudDialogflowCxV3KnowledgeConnectorSettingsResponse>('knowledgeConnectorSettings');
    this.languageCode = registerOutput<String?>('languageCode');
    this.location = registerOutput<String>('location');
    this.name = registerOutput<String>('name');
    this.project = registerOutput<String>('project');
    this.transitionRouteGroups = registerOutput<List<String>>('transitionRouteGroups');
    this.transitionRoutes = registerOutput<List<GoogleCloudDialogflowCxV3TransitionRouteResponse>>('transitionRoutes');
  }
}
