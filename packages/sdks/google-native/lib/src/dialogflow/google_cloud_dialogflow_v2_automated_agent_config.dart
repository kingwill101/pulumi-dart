...
class GoogleCloudDialogflowV2AutomatedAgentConfig {
  ...
  /// Creates a new [GoogleCloudDialogflowV2AutomatedAgentConfig].
  ...
  const GoogleCloudDialogflowV2AutomatedAgentConfig({
    required this.agent,
    this.sessionTtl,
  });
  ...
  factory GoogleCloudDialogflowV2AutomatedAgentConfig.fromMap(Map<String, dynamic> map) {
