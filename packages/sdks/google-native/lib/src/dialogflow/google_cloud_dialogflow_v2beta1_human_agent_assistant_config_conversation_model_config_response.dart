...
class GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigConversationModelConfigResponse {
  ...
  const GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigConversationModelConfigResponse({
  ...
  factory GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigConversationModelConfigResponse.fromMap(Map<String, dynamic> map) {
