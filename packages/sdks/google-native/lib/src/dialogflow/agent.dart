...
class Agent extends pulumi.CustomResource {
  ...
  Agent(
    ...
    this.advancedSettings = registerOutput<GoogleCloudDialogflowCxV3AdvancedSettingsResponse>('advancedSettings');
    this.answerFeedbackSettings = registerOutput<GoogleCloudDialogflowCxV3AgentAnswerFeedbackSettingsResponse>('answerFeedbackSettings');
    ...
    this.genAppBuilderSettings = registerOutput<GoogleCloudDialogflowCxV3AgentGenAppBuilderSettingsResponse>('genAppBuilderSettings');
    this.gitIntegrationSettings = registerOutput<GoogleCloudDialogflowCxV3AgentGitIntegrationSettingsResponse>('gitIntegrationSettings');
    ...
    this.speechToTextSettings = registerOutput<GoogleCloudDialogflowCxV3SpeechToTextSettingsResponse>('speechToTextSettings');
    ...
    this.textToSpeechSettings = registerOutput<GoogleCloudDialogflowCxV3TextToSpeechSettingsResponse>('textToSpeechSettings');
