...
class AgentArgs {
  ...
  factory AgentArgs.fromMap(Map<String, dynamic> map) {
    return AgentArgs(
      ...
      answerFeedbackSettings: map['answerFeedbackSettings'] == null ? null : (GoogleCloudDialogflowCxV3AgentAnswerFeedbackSettings.fromMap((map['answerFeedbackSettings']! as Map).cast<String, dynamic>())).input(),
      ...
      genAppBuilderSettings: map['genAppBuilderSettings'] == null ? null : (GoogleCloudDialogflowCxV3AgentGenAppBuilderSettings.fromMap((map['genAppBuilderSettings']! as Map).cast<String, dynamic>())).input(),
      gitIntegrationSettings: map['gitIntegrationSettings'] == null ? null : (GoogleCloudDialogflowCxV3AgentGitIntegrationSettings.fromMap((map['gitIntegrationSettings']! as Map).cast<String, dynamic>())).input(),
      ...
      speechToTextSettings: map['speechToTextSettings'] == null ? null : (GoogleCloudDialogflowCxV3SpeechToTextSettings.fromMap((map['speechToTextSettings']! as Map).cast<String, dynamic>())).input(),
      ...
      textToSpeechSettings: map['textToSpeechSettings'] == null ? null : (GoogleCloudDialogflowCxV3TextToSpeechSettings.fromMap((map['textToSpeechSettings']! as Map).cast<String, dynamic>())).input(),
