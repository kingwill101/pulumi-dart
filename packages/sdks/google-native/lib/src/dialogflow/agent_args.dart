...
class AgentArgs {
  ...
  factory AgentArgs.fromMap(Map<String, dynamic> map) {
    return AgentArgs(
      ...
      answerFeedbackSettings: (() { final guardedValue = map['answerFeedbackSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowCxV3AgentAnswerFeedbackSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      genAppBuilderSettings: (() { final guardedValue = map['genAppBuilderSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowCxV3AgentGenAppBuilderSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      gitIntegrationSettings: (() { final guardedValue = map['gitIntegrationSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowCxV3AgentGitIntegrationSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      speechToTextSettings: (() { final guardedValue = map['speechToTextSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowCxV3SpeechToTextSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      textToSpeechSettings: (() { final guardedValue = map['textToSpeechSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowCxV3TextToSpeechSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
