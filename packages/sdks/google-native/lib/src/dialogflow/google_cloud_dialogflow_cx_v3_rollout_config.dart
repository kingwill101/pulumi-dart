...
class GoogleCloudDialogflowCxV3RolloutConfig {
  ...
  final pulumi.Input<List<GoogleCloudDialogflowCxV3RolloutConfigRolloutStep>>?
  rolloutSteps;
    ...
    return <String, dynamic>{
      ...
      'rolloutSteps':
          ?pulumi.Input.mapOptionalInputValue<
            List<GoogleCloudDialogflowCxV3RolloutConfigRolloutStep>,
  ...
  factory GoogleCloudDialogflowCxV3RolloutConfig.fromMap(
      ...
      rolloutSteps: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                GoogleCloudDialogflowCxV3RolloutConfigRolloutStep.fromMap(
