...
class GoogleCloudDialogflowCxV3RolloutConfig {
  ...
  final pulumi.Input<List<GoogleCloudDialogflowCxV3RolloutConfigRolloutStep>>? rolloutSteps;
  ...
  const GoogleCloudDialogflowCxV3RolloutConfig({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'rolloutSteps': ?pulumi.Input.mapOptionalInputValue<List<GoogleCloudDialogflowCxV3RolloutConfigRolloutStep>, List<Map<String, dynamic>>>(rolloutSteps, (value) => pulumi.Input.encodeList<GoogleCloudDialogflowCxV3RolloutConfigRolloutStep, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory GoogleCloudDialogflowCxV3RolloutConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3RolloutConfig(
      failureCondition: (() { final guardedValue = map['failureCondition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      rolloutCondition: (() { final guardedValue = map['rolloutCondition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      rolloutSteps: (() { final guardedValue = map['rolloutSteps']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudDialogflowCxV3RolloutConfigRolloutStep>(guardedValue, (value) => GoogleCloudDialogflowCxV3RolloutConfigRolloutStep.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
