...
class GoogleCloudDialogflowV2beta1SynthesizeSpeechConfigResponse {
  ...
  final pulumi.Input<GoogleCloudDialogflowV2beta1VoiceSelectionParamsResponse> voice;
  ...
  const GoogleCloudDialogflowV2beta1SynthesizeSpeechConfigResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'voice': pulumi.Input.mapInputValue<GoogleCloudDialogflowV2beta1VoiceSelectionParamsResponse, Map<String, dynamic>>(voice, (value) => value.toMap()),
  ...
  factory GoogleCloudDialogflowV2beta1SynthesizeSpeechConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2beta1SynthesizeSpeechConfigResponse(
      ...
      voice: pulumi.Input.fromValue(GoogleCloudDialogflowV2beta1VoiceSelectionParamsResponse.fromMap((map['voice']! as Map).cast<String, dynamic>())),
