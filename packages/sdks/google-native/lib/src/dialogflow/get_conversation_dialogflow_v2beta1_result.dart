...
class GetConversationDialogflowV2beta1Result {
  ...
  factory GetConversationDialogflowV2beta1Result.fromMap(Map<String, dynamic> map) {
    return GetConversationDialogflowV2beta1Result(
      ...
      phoneNumber: GoogleCloudDialogflowV2beta1ConversationPhoneNumberResponse.fromMap((map['phoneNumber']! as Map).cast<String, dynamic>()),
