...
class GoogleCloudDialogflowCxV3FormParameterFillBehavior {
  ...
  final GoogleCloudDialogflowCxV3Fulfillment initialPromptFulfillment;
  ...
  final List<GoogleCloudDialogflowCxV3EventHandler>? repromptEventHandlers;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'repromptEventHandlers': ?repromptEventHandlers == null ? null : pulumi.Input.encodeList<GoogleCloudDialogflowCxV3EventHandler, Map<String, dynamic>>(repromptEventHandlers!, (value) => value.toMap()),
    };
  }
  ...
  factory GoogleCloudDialogflowCxV3FormParameterFillBehavior.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3FormParameterFillBehavior(
      initialPromptFulfillment: GoogleCloudDialogflowCxV3Fulfillment.fromMap((map['initialPromptFulfillment'] as Map).cast<String, dynamic>()),
      repromptEventHandlers: map['repromptEventHandlers'] == null ? null : pulumi.Input.decodeList<GoogleCloudDialogflowCxV3EventHandler>(map['repromptEventHandlers'], (value) => GoogleCloudDialogflowCxV3EventHandler.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
