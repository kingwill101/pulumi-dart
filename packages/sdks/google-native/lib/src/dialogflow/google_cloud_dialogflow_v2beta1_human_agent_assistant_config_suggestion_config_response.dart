...
class GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionConfigResponse {
  ...
  final List<GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionFeatureConfigResponse> featureConfigs;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'featureConfigs': pulumi.Input.encodeList<GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionFeatureConfigResponse, Map<String, dynamic>>(featureConfigs, (value) => value.toMap()),
      'groupSuggestionResponses': groupSuggestionResponses,
    };
  }

  factory GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionConfigResponse(
      featureConfigs: pulumi.Input.decodeList<GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionFeatureConfigResponse>(map['featureConfigs'], (value) => GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionFeatureConfigResponse.fromMap((value as Map).cast<String, dynamic>())),
