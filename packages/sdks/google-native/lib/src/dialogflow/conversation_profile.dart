...
class ConversationProfile extends pulumi.CustomResource {
  ...
  ConversationProfile(
    ...
    this.automatedAgentConfig = registerOutput<GoogleCloudDialogflowV2AutomatedAgentConfigResponse>('automatedAgentConfig');
    this.createTime = registerOutput<String>('createTime');
    this.displayName = registerOutput<String>('displayName');
    this.humanAgentAssistantConfig = registerOutput<GoogleCloudDialogflowV2HumanAgentAssistantConfigResponse>('humanAgentAssistantConfig');
    this.humanAgentHandoffConfig = registerOutput<GoogleCloudDialogflowV2HumanAgentHandoffConfigResponse>('humanAgentHandoffConfig');
    this.languageCode = registerOutput<String>('languageCode');
    this.location = registerOutput<String>('location');
    this.loggingConfig = registerOutput<GoogleCloudDialogflowV2LoggingConfigResponse>('loggingConfig');
    this.name = registerOutput<String>('name');
    this.newMessageEventNotificationConfig = registerOutput<GoogleCloudDialogflowV2NotificationConfigResponse>('newMessageEventNotificationConfig');
    this.notificationConfig = registerOutput<GoogleCloudDialogflowV2NotificationConfigResponse>('notificationConfig');
    this.project = registerOutput<String>('project');
    this.securitySettings = registerOutput<String>('securitySettings');
    this.sttConfig = registerOutput<GoogleCloudDialogflowV2SpeechToTextConfigResponse>('sttConfig');
    this.timeZone = registerOutput<String>('timeZone');
    this.ttsConfig = registerOutput<GoogleCloudDialogflowV2SynthesizeSpeechConfigResponse>('ttsConfig');
