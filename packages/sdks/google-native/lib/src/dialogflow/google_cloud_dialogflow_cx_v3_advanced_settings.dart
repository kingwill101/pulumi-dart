...
class GoogleCloudDialogflowCxV3AdvancedSettings {
  ...
  final pulumi.Input<GoogleCloudDialogflowCxV3GcsDestination>?
  audioExportGcsDestination;

  /// Settings for DTMF. Exposed at the following levels: - Agent level - Flow level - Page level - Parameter level.
  final pulumi.Input<GoogleCloudDialogflowCxV3AdvancedSettingsDtmfSettings>?
  dtmfSettings;

  /// Settings for logging. Settings for Dialogflow History, Contact Center messages, StackDriver logs, and speech logging. Exposed at the following levels: - Agent level.
  final pulumi.Input<GoogleCloudDialogflowCxV3AdvancedSettingsLoggingSettings>?
  loggingSettings;
