...
class DocumentDialogflowV2beta1 extends pulumi.CustomResource {
  ...
  DocumentDialogflowV2beta1(
    ...
    this.importGcsCustomMetadata = registerOutput<bool?>('importGcsCustomMetadata');
    this.knowledgeBaseId = registerOutput<String>('knowledgeBaseId');
    this.knowledgeTypes = registerOutput<List<String>>('knowledgeTypes');
    this.latestReloadStatus = registerOutput<GoogleCloudDialogflowV2beta1DocumentReloadStatusResponse>('latestReloadStatus');
