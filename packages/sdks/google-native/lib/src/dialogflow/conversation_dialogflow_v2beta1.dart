...
class ConversationDialogflowV2beta1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<GoogleCloudDialogflowV2beta1ConversationPhoneNumberResponse> phoneNumber;
  ...
  ConversationDialogflowV2beta1(
    ...
    phoneNumber = registerOutput<GoogleCloudDialogflowV2beta1ConversationPhoneNumberResponse>('phoneNumber', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return GoogleCloudDialogflowV2beta1ConversationPhoneNumberResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
