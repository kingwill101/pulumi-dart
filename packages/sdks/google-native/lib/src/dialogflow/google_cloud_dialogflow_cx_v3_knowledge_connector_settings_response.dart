...
class GoogleCloudDialogflowCxV3KnowledgeConnectorSettingsResponse {
  ...
  final List<GoogleCloudDialogflowCxV3DataStoreConnectionResponse> dataStoreConnections;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'dataStoreConnections': pulumi.Input.encodeList<GoogleCloudDialogflowCxV3DataStoreConnectionResponse, Map<String, dynamic>>(dataStoreConnections, (value) => value.toMap()),
      'enabled': enabled,
  ...
  factory GoogleCloudDialogflowCxV3KnowledgeConnectorSettingsResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3KnowledgeConnectorSettingsResponse(
      dataStoreConnections: pulumi.Input.decodeList<GoogleCloudDialogflowCxV3DataStoreConnectionResponse>(map['dataStoreConnections'], (value) => GoogleCloudDialogflowCxV3DataStoreConnectionResponse.fromMap((value as Map).cast<String, dynamic>())),
