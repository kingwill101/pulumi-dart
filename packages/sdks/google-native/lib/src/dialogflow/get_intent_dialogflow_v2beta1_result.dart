...
class GetIntentDialogflowV2beta1Result {
    ...
    return <String, dynamic>{
      ...
      'followupIntentInfo':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(followupIntentInfo, (value) => value.toMap()),
      ...
      'outputContexts':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(outputContexts, (value) => value.toMap()),
      'parameters':
          pulumi.Input.encodeList<
      ...
      'trainingPhrases':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(trainingPhrases, (value) => value.toMap()),
  ...
  factory GetIntentDialogflowV2beta1Result.fromMap(Map<String, dynamic> map) {
    return GetIntentDialogflowV2beta1Result(
      ...
      defaultResponsePlatforms: (map['defaultResponsePlatforms'] as List)
          .cast<String>(),
      ...
      followupIntentInfo:
          ...
          >(
            ...
            (value) =>
                GoogleCloudDialogflowV2beta1IntentFollowupIntentInfoResponse.fromMap(
      ...
      messages:
          ...
          >(
            map['messages']!,
            (value) =>
                GoogleCloudDialogflowV2beta1IntentMessageResponse.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
