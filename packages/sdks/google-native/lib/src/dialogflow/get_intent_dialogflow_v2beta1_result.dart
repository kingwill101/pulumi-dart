...
class GetIntentDialogflowV2beta1Result {
  ...
  final List<GoogleCloudDialogflowV2beta1IntentFollowupIntentInfoResponse> followupIntentInfo;
  ...
  final List<GoogleCloudDialogflowV2beta1IntentTrainingPhraseResponse> trainingPhrases;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'events': events,
      'followupIntentInfo': pulumi.Input.encodeList<GoogleCloudDialogflowV2beta1IntentFollowupIntentInfoResponse, Map<String, dynamic>>(followupIntentInfo, (value) => value.toMap()),
      'inputContextNames': inputContextNames,
      'isFallback': isFallback,
      'liveAgentHandoff': liveAgentHandoff,
      'messages': pulumi.Input.encodeList<GoogleCloudDialogflowV2beta1IntentMessageResponse, Map<String, dynamic>>(messages, (value) => value.toMap()),
      'mlDisabled': mlDisabled,
      'mlEnabled': mlEnabled,
      'name': name,
      'outputContexts': pulumi.Input.encodeList<GoogleCloudDialogflowV2beta1ContextResponse, Map<String, dynamic>>(outputContexts, (value) => value.toMap()),
      'parameters': pulumi.Input.encodeList<GoogleCloudDialogflowV2beta1IntentParameterResponse, Map<String, dynamic>>(parameters, (value) => value.toMap()),
      'parentFollowupIntentName': parentFollowupIntentName,
      'priority': priority,
      'resetContexts': resetContexts,
      'rootFollowupIntentName': rootFollowupIntentName,
      'trainingPhrases': pulumi.Input.encodeList<GoogleCloudDialogflowV2beta1IntentTrainingPhraseResponse, Map<String, dynamic>>(trainingPhrases, (value) => value.toMap()),
  ...
  factory GetIntentDialogflowV2beta1Result.fromMap(Map<String, dynamic> map) {
    return GetIntentDialogflowV2beta1Result(
      ...
      defaultResponsePlatforms: (map['defaultResponsePlatforms'] as List).cast<String>(),
      displayName: map['displayName'] as String,
      endInteraction: map['endInteraction'] as bool,
      events: (map['events'] as List).cast<String>(),
      followupIntentInfo: pulumi.Input.decodeList<GoogleCloudDialogflowV2beta1IntentFollowupIntentInfoResponse>(map['followupIntentInfo']!, (value) => GoogleCloudDialogflowV2beta1IntentFollowupIntentInfoResponse.fromMap((value as Map).cast<String, dynamic>())),
      ...
      messages: pulumi.Input.decodeList<GoogleCloudDialogflowV2beta1IntentMessageResponse>(map['messages']!, (value) => GoogleCloudDialogflowV2beta1IntentMessageResponse.fromMap((value as Map).cast<String, dynamic>())),
      mlDisabled: map['mlDisabled'] as bool,
      mlEnabled: map['mlEnabled'] as bool,
      name: map['name'] as String,
      outputContexts: pulumi.Input.decodeList<GoogleCloudDialogflowV2beta1ContextResponse>(map['outputContexts']!, (value) => GoogleCloudDialogflowV2beta1ContextResponse.fromMap((value as Map).cast<String, dynamic>())),
      parameters: pulumi.Input.decodeList<GoogleCloudDialogflowV2beta1IntentParameterResponse>(map['parameters']!, (value) => GoogleCloudDialogflowV2beta1IntentParameterResponse.fromMap((value as Map).cast<String, dynamic>())),
      ...
      trainingPhrases: pulumi.Input.decodeList<GoogleCloudDialogflowV2beta1IntentTrainingPhraseResponse>(map['trainingPhrases']!, (value) => GoogleCloudDialogflowV2beta1IntentTrainingPhraseResponse.fromMap((value as Map).cast<String, dynamic>())),
