...
class GetAgentDialogflowV3beta1Result {
  ...
  final GoogleCloudDialogflowCxV3beta1AgentAnswerFeedbackSettingsResponse answerFeedbackSettings;
  ...
  final GoogleCloudDialogflowCxV3beta1AgentGenAppBuilderSettingsResponse genAppBuilderSettings;
  /// Git integration settings for this agent.
  final GoogleCloudDialogflowCxV3beta1AgentGitIntegrationSettingsResponse gitIntegrationSettings;
  ...
  final GoogleCloudDialogflowCxV3beta1SpeechToTextSettingsResponse speechToTextSettings;
  ...
  final GoogleCloudDialogflowCxV3beta1TextToSpeechSettingsResponse textToSpeechSettings;
  ...
  factory GetAgentDialogflowV3beta1Result.fromMap(Map<String, dynamic> map) {
    return GetAgentDialogflowV3beta1Result(
      ...
      answerFeedbackSettings: GoogleCloudDialogflowCxV3beta1AgentAnswerFeedbackSettingsResponse.fromMap((map['answerFeedbackSettings']! as Map).cast<String, dynamic>()),
      ...
      genAppBuilderSettings: GoogleCloudDialogflowCxV3beta1AgentGenAppBuilderSettingsResponse.fromMap((map['genAppBuilderSettings']! as Map).cast<String, dynamic>()),
      gitIntegrationSettings: GoogleCloudDialogflowCxV3beta1AgentGitIntegrationSettingsResponse.fromMap((map['gitIntegrationSettings']! as Map).cast<String, dynamic>()),
      locked: map['locked'] as bool,
      name: map['name'] as String,
      securitySettings: map['securitySettings'] as String,
      speechToTextSettings: GoogleCloudDialogflowCxV3beta1SpeechToTextSettingsResponse.fromMap((map['speechToTextSettings']! as Map).cast<String, dynamic>()),
      startFlow: map['startFlow'] as String,
      supportedLanguageCodes: (map['supportedLanguageCodes'] as List).cast<String>(),
      textToSpeechSettings: GoogleCloudDialogflowCxV3beta1TextToSpeechSettingsResponse.fromMap((map['textToSpeechSettings']! as Map).cast<String, dynamic>()),
