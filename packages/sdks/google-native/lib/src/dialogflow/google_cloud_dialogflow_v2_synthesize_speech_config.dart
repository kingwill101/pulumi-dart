...
class GoogleCloudDialogflowV2SynthesizeSpeechConfig {
  ...
  final pulumi.Input<GoogleCloudDialogflowV2VoiceSelectionParams>? voice;
  ...
  /// Creates a new [GoogleCloudDialogflowV2SynthesizeSpeechConfig].
  ...
  const GoogleCloudDialogflowV2SynthesizeSpeechConfig({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'voice': ?pulumi.Input.mapOptionalInputValue<GoogleCloudDialogflowV2VoiceSelectionParams, Map<String, dynamic>>(voice, (value) => value.toMap()),
  ...
  factory GoogleCloudDialogflowV2SynthesizeSpeechConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2SynthesizeSpeechConfig(
      ...
      voice: (() { final guardedValue = map['voice']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowV2VoiceSelectionParams.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
