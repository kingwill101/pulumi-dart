...
class GoogleCloudDialogflowCxV3beta1ExperimentResultMetric {
  ...
  const GoogleCloudDialogflowCxV3beta1ExperimentResultMetric({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'count': ?count,
      'countType': ?pulumi.Input.mapOptionalInputValue<GoogleCloudDialogflowCxV3beta1ExperimentResultMetricCountType, String>(countType, (value) => value.wireValue),
      'ratio': ?ratio,
      'type': ?pulumi.Input.mapOptionalInputValue<GoogleCloudDialogflowCxV3beta1ExperimentResultMetricType, String>(type, (value) => value.wireValue),
    };
  }
  ...
  factory GoogleCloudDialogflowCxV3beta1ExperimentResultMetric.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3beta1ExperimentResultMetric(
      confidenceInterval: (() { final guardedValue = map['confidenceInterval']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowCxV3beta1ExperimentResultConfidenceInterval.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      count: (() { final guardedValue = map['count']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as double); })(),
      countType: (() { final guardedValue = map['countType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowCxV3beta1ExperimentResultMetricCountType.fromValue(guardedValue as String)); })(),
      ratio: (() { final guardedValue = map['ratio']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as double); })(),
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowCxV3beta1ExperimentResultMetricType.fromValue(guardedValue as String)); })(),
    );
  }
}
