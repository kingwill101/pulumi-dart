...
class GoogleCloudDialogflowCxV3beta1KnowledgeConnectorSettingsResponse {
  ...
  factory GoogleCloudDialogflowCxV3beta1KnowledgeConnectorSettingsResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3beta1KnowledgeConnectorSettingsResponse(
      dataStoreConnections: (pulumi.Input.decodeList<GoogleCloudDialogflowCxV3beta1DataStoreConnectionResponse>(map['dataStoreConnections'], (value) => GoogleCloudDialogflowCxV3beta1DataStoreConnectionResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      enabled: (map['enabled'] as bool).input(),
      targetFlow: (map['targetFlow'] as String).input(),
      targetPage: (map['targetPage'] as String).input(),
      triggerFulfillment: (GoogleCloudDialogflowCxV3beta1FulfillmentResponse.fromMap((map['triggerFulfillment'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
