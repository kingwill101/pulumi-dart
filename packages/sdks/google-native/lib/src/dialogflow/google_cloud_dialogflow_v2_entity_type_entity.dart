...
class GoogleCloudDialogflowV2EntityTypeEntity {
  ...
  /// Creates a new [GoogleCloudDialogflowV2EntityTypeEntity].
  ...
  const GoogleCloudDialogflowV2EntityTypeEntity({
  ...
  factory GoogleCloudDialogflowV2EntityTypeEntity.fromMap(Map<String, dynamic> map) {
