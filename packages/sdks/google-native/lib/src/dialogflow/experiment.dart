...
class Experiment extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<GoogleCloudDialogflowCxV3VariantsHistoryResponse>> variantsHistory;
  ...
  Experiment(
    ...
    this.definition = registerOutput<GoogleCloudDialogflowCxV3ExperimentDefinitionResponse>('definition');
    ...
    this.result = registerOutput<GoogleCloudDialogflowCxV3ExperimentResultResponse>('result');
    this.rolloutConfig = registerOutput<GoogleCloudDialogflowCxV3RolloutConfigResponse>('rolloutConfig');
    this.rolloutFailureReason = registerOutput<String>('rolloutFailureReason');
    this.rolloutState = registerOutput<GoogleCloudDialogflowCxV3RolloutStateResponse>('rolloutState');
    this.startTime = registerOutput<String>('startTime');
    this.state = registerOutput<String>('state');
    this.variantsHistory = registerOutput<List<GoogleCloudDialogflowCxV3VariantsHistoryResponse>>('variantsHistory');
  }
}
