...
import 'version_dialogflow_v2beta1_args.dart';
...
class VersionDialogflowV2beta1 extends pulumi.CustomResource {
  ...
  /// Creates a new [VersionDialogflowV2beta1].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [VersionDialogflowV2beta1]. {@macro pulumi_dialogflow_v2beta1_version_dialogflow_v2beta1_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  VersionDialogflowV2beta1(
    String name, {
