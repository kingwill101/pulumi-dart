    ...
    return GoogleCloudDialogflowV2beta1IntentMessageMediaContent(
      mediaObjects: pulumi.Input.fromValue(
        ...
        >(
          map['mediaObjects']!,
          (value) =>
              GoogleCloudDialogflowV2beta1IntentMessageMediaContentResponseMediaObject.fromMap(
      ...
      mediaType: (() {
        ...
        return pulumi.Input.fromValue(
          GoogleCloudDialogflowV2beta1IntentMessageMediaContentMediaType.fromValue(
