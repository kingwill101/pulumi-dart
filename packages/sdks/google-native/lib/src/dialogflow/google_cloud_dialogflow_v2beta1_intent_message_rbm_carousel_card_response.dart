...
class GoogleCloudDialogflowV2beta1IntentMessageRbmCarouselCardResponse {
  ...
  final pulumi.Input<List<GoogleCloudDialogflowV2beta1IntentMessageRbmCardContentResponse>> cardContents;
  ...
  const GoogleCloudDialogflowV2beta1IntentMessageRbmCarouselCardResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'cardContents': pulumi.Input.mapInputValue<List<GoogleCloudDialogflowV2beta1IntentMessageRbmCardContentResponse>, List<Map<String, dynamic>>>(cardContents, (value) => pulumi.Input.encodeList<GoogleCloudDialogflowV2beta1IntentMessageRbmCardContentResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'cardWidth': cardWidth,
    };
  }

  factory GoogleCloudDialogflowV2beta1IntentMessageRbmCarouselCardResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2beta1IntentMessageRbmCarouselCardResponse(
      cardContents: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudDialogflowV2beta1IntentMessageRbmCardContentResponse>(map['cardContents']!, (value) => GoogleCloudDialogflowV2beta1IntentMessageRbmCardContentResponse.fromMap((value as Map).cast<String, dynamic>()))),
