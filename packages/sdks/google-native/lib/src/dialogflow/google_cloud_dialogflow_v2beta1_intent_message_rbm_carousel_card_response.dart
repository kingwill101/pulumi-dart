...
class GoogleCloudDialogflowV2beta1IntentMessageRbmCarouselCardResponse {
  ...
  factory GoogleCloudDialogflowV2beta1IntentMessageRbmCarouselCardResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2beta1IntentMessageRbmCarouselCardResponse(
      cardContents: (pulumi.Input.decodeList<GoogleCloudDialogflowV2beta1IntentMessageRbmCardContentResponse>(map['cardContents'], (value) => GoogleCloudDialogflowV2beta1IntentMessageRbmCardContentResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      cardWidth: (map['cardWidth'] as String).input(),
    );
  }
}
