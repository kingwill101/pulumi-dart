...
class GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfig {
  ...
  factory GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfig(
      ...
      contextFilterSettings: (() { final guardedValue = map['contextFilterSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigContextFilterSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      dialogflowQuerySource: (() { final guardedValue = map['dialogflowQuerySource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigDialogflowQuerySource.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      documentQuerySource: (() { final guardedValue = map['documentQuerySource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigDocumentQuerySource.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      knowledgeBaseQuerySource: (() { final guardedValue = map['knowledgeBaseQuerySource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigKnowledgeBaseQuerySource.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
