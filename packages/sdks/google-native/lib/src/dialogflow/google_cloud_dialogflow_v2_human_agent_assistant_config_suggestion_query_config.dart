...
class GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfig {
  ...
  final GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigContextFilterSettings? contextFilterSettings;
  /// Query from Dialogflow agent. It is used by DIALOGFLOW_ASSIST.
  final GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigDialogflowQuerySource? dialogflowQuerySource;
  /// Query from knowledge base document. It is used by: SMART_REPLY, SMART_COMPOSE.
  final GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigDocumentQuerySource? documentQuerySource;
  /// Query from knowledgebase. It is used by: ARTICLE_SUGGESTION, FAQ.
  final GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigKnowledgeBaseQuerySource? knowledgeBaseQuerySource;
  ...
  factory GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfig(
      ...
      contextFilterSettings: map['contextFilterSettings'] == null ? null : GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigContextFilterSettings.fromMap((map['contextFilterSettings'] as Map).cast<String, dynamic>()),
      dialogflowQuerySource: map['dialogflowQuerySource'] == null ? null : GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigDialogflowQuerySource.fromMap((map['dialogflowQuerySource'] as Map).cast<String, dynamic>()),
      documentQuerySource: map['documentQuerySource'] == null ? null : GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigDocumentQuerySource.fromMap((map['documentQuerySource'] as Map).cast<String, dynamic>()),
      knowledgeBaseQuerySource: map['knowledgeBaseQuerySource'] == null ? null : GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigKnowledgeBaseQuerySource.fromMap((map['knowledgeBaseQuerySource'] as Map).cast<String, dynamic>()),
