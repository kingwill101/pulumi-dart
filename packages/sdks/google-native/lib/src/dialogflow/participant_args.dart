...
class ParticipantArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'project': ?project,
      'role': ?pulumi.Input.mapOptionalInputValue<ParticipantRole, String>(
        role,
  ...
  factory ParticipantArgs.fromMap(Map<String, dynamic> map) {
    return ParticipantArgs(
      ...
      documentsMetadataFilters: (() {
        final guardedValue = map['documentsMetadataFilters'];
      ...
      obfuscatedExternalUserId: (() {
        final guardedValue = map['obfuscatedExternalUserId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      project: (() {
      ...
      role: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ParticipantRole.fromValue(guardedValue as String),
        );
      })(),
      sipRecordingMediaLabel: (() {
        final guardedValue = map['sipRecordingMediaLabel'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
