...
class GoogleCloudDialogflowCxV3beta1AdvancedSettingsDtmfSettingsResponse {
  ...
  const GoogleCloudDialogflowCxV3beta1AdvancedSettingsDtmfSettingsResponse({
  ...
  factory GoogleCloudDialogflowCxV3beta1AdvancedSettingsDtmfSettingsResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3beta1AdvancedSettingsDtmfSettingsResponse(
      ...
      maxDigits: pulumi.Input.fromValue(map['maxDigits'] as int),
    );
  }
}
