...
class GoogleCloudDialogflowV2IntentMessageSimpleResponses {
  ...
  factory GoogleCloudDialogflowV2IntentMessageSimpleResponses.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2IntentMessageSimpleResponses(
      simpleResponses: (pulumi.Input.decodeList<GoogleCloudDialogflowV2IntentMessageSimpleResponse>(map['simpleResponses'], (value) => GoogleCloudDialogflowV2IntentMessageSimpleResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
