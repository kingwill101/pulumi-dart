...
class GoogleCloudDialogflowCxV3PageResponse {
  ...
  final pulumi.Input<List<GoogleCloudDialogflowCxV3EventHandlerResponse>>
  eventHandlers;
  ...
  final pulumi.Input<List<GoogleCloudDialogflowCxV3TransitionRouteResponse>>
  transitionRoutes;
  ...
  factory GoogleCloudDialogflowCxV3PageResponse.fromMap(
    ...
    return GoogleCloudDialogflowCxV3PageResponse(
      ...
      eventHandlers: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GoogleCloudDialogflowCxV3EventHandlerResponse>(
          map['eventHandlers']!,
      ...
      form: pulumi.Input.fromValue(
        GoogleCloudDialogflowCxV3FormResponse.fromMap(
