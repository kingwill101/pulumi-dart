...
class GoogleCloudDialogflowCxV3PageResponse {
  ...
  final pulumi.Input<GoogleCloudDialogflowCxV3FulfillmentResponse> entryFulfillment;
  /// Handlers associated with the page to handle events such as webhook errors, no match or no input.
  final pulumi.Input<List<GoogleCloudDialogflowCxV3EventHandlerResponse>> eventHandlers;
  /// The form associated with the page, used for collecting parameters relevant to the page.
  final pulumi.Input<GoogleCloudDialogflowCxV3FormResponse> form;
  /// Optional. Knowledge connector configuration.
  final pulumi.Input<GoogleCloudDialogflowCxV3KnowledgeConnectorSettingsResponse> knowledgeConnectorSettings;
  ...
  final pulumi.Input<List<GoogleCloudDialogflowCxV3TransitionRouteResponse>> transitionRoutes;
  ...
  const GoogleCloudDialogflowCxV3PageResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'entryFulfillment': pulumi.Input.mapInputValue<GoogleCloudDialogflowCxV3FulfillmentResponse, Map<String, dynamic>>(entryFulfillment, (value) => value.toMap()),
      'eventHandlers': pulumi.Input.mapInputValue<List<GoogleCloudDialogflowCxV3EventHandlerResponse>, List<Map<String, dynamic>>>(eventHandlers, (value) => pulumi.Input.encodeList<GoogleCloudDialogflowCxV3EventHandlerResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'form': pulumi.Input.mapInputValue<GoogleCloudDialogflowCxV3FormResponse, Map<String, dynamic>>(form, (value) => value.toMap()),
      'knowledgeConnectorSettings': pulumi.Input.mapInputValue<GoogleCloudDialogflowCxV3KnowledgeConnectorSettingsResponse, Map<String, dynamic>>(knowledgeConnectorSettings, (value) => value.toMap()),
      'name': name,
      'transitionRouteGroups': transitionRouteGroups,
      'transitionRoutes': pulumi.Input.mapInputValue<List<GoogleCloudDialogflowCxV3TransitionRouteResponse>, List<Map<String, dynamic>>>(transitionRoutes, (value) => pulumi.Input.encodeList<GoogleCloudDialogflowCxV3TransitionRouteResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory GoogleCloudDialogflowCxV3PageResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3PageResponse(
      ...
      entryFulfillment: pulumi.Input.fromValue(GoogleCloudDialogflowCxV3FulfillmentResponse.fromMap((map['entryFulfillment']! as Map).cast<String, dynamic>())),
      eventHandlers: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudDialogflowCxV3EventHandlerResponse>(map['eventHandlers']!, (value) => GoogleCloudDialogflowCxV3EventHandlerResponse.fromMap((value as Map).cast<String, dynamic>()))),
      form: pulumi.Input.fromValue(GoogleCloudDialogflowCxV3FormResponse.fromMap((map['form']! as Map).cast<String, dynamic>())),
      knowledgeConnectorSettings: pulumi.Input.fromValue(GoogleCloudDialogflowCxV3KnowledgeConnectorSettingsResponse.fromMap((map['knowledgeConnectorSettings']! as Map).cast<String, dynamic>())),
      name: pulumi.Input.fromValue(map['name'] as String),
      transitionRouteGroups: pulumi.Input.fromValue((map['transitionRouteGroups'] as List).cast<String>()),
      transitionRoutes: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudDialogflowCxV3TransitionRouteResponse>(map['transitionRoutes']!, (value) => GoogleCloudDialogflowCxV3TransitionRouteResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
