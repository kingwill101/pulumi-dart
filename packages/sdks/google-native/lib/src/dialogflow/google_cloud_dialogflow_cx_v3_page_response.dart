...
class GoogleCloudDialogflowCxV3PageResponse {
  ...
  factory GoogleCloudDialogflowCxV3PageResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3PageResponse(
      advancedSettings: (GoogleCloudDialogflowCxV3AdvancedSettingsResponse.fromMap((map['advancedSettings'] as Map).cast<String, dynamic>())).input(),
      displayName: (map['displayName'] as String).input(),
      entryFulfillment: (GoogleCloudDialogflowCxV3FulfillmentResponse.fromMap((map['entryFulfillment'] as Map).cast<String, dynamic>())).input(),
      eventHandlers: (pulumi.Input.decodeList<GoogleCloudDialogflowCxV3EventHandlerResponse>(map['eventHandlers'], (value) => GoogleCloudDialogflowCxV3EventHandlerResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      form: (GoogleCloudDialogflowCxV3FormResponse.fromMap((map['form'] as Map).cast<String, dynamic>())).input(),
      knowledgeConnectorSettings: (GoogleCloudDialogflowCxV3KnowledgeConnectorSettingsResponse.fromMap((map['knowledgeConnectorSettings'] as Map).cast<String, dynamic>())).input(),
      name: (map['name'] as String).input(),
      transitionRouteGroups: ((map['transitionRouteGroups'] as List).cast<String>()).input(),
      transitionRoutes: (pulumi.Input.decodeList<GoogleCloudDialogflowCxV3TransitionRouteResponse>(map['transitionRoutes'], (value) => GoogleCloudDialogflowCxV3TransitionRouteResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
