...
class GetSecuritySettingDialogflowV3beta1Result {
  ...
  final GoogleCloudDialogflowCxV3beta1SecuritySettingsAudioExportSettingsResponse audioExportSettings;
  ...
  final GoogleCloudDialogflowCxV3beta1SecuritySettingsInsightsExportSettingsResponse insightsExportSettings;
  ...
  const GetSecuritySettingDialogflowV3beta1Result({
  ...
  factory GetSecuritySettingDialogflowV3beta1Result.fromMap(Map<String, dynamic> map) {
    return GetSecuritySettingDialogflowV3beta1Result(
      audioExportSettings: GoogleCloudDialogflowCxV3beta1SecuritySettingsAudioExportSettingsResponse.fromMap((map['audioExportSettings']! as Map).cast<String, dynamic>()),
      deidentifyTemplate: map['deidentifyTemplate'] as String,
      displayName: map['displayName'] as String,
      insightsExportSettings: GoogleCloudDialogflowCxV3beta1SecuritySettingsInsightsExportSettingsResponse.fromMap((map['insightsExportSettings']! as Map).cast<String, dynamic>()),
