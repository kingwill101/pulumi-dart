...
class GoogleCloudDialogflowV2beta1IntentMessageSuggestions {
  ...
  factory GoogleCloudDialogflowV2beta1IntentMessageSuggestions.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2beta1IntentMessageSuggestions(
      suggestions: (pulumi.Input.decodeList<GoogleCloudDialogflowV2beta1IntentMessageSuggestion>(map['suggestions'], (value) => GoogleCloudDialogflowV2beta1IntentMessageSuggestion.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
