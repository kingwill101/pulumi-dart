...
class GoogleCloudDialogflowV2beta1IntentMessageRbmCardContentResponse {
  ...
  factory GoogleCloudDialogflowV2beta1IntentMessageRbmCardContentResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2beta1IntentMessageRbmCardContentResponse(
      ...
      media: (GoogleCloudDialogflowV2beta1IntentMessageRbmCardContentRbmMediaResponse.fromMap((map['media'] as Map).cast<String, dynamic>())).input(),
      suggestions: (pulumi.Input.decodeList<GoogleCloudDialogflowV2beta1IntentMessageRbmSuggestionResponse>(map['suggestions'], (value) => GoogleCloudDialogflowV2beta1IntentMessageRbmSuggestionResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
