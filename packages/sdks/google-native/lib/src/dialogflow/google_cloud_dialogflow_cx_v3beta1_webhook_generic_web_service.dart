...
class GoogleCloudDialogflowCxV3beta1WebhookGenericWebService {
  ...
  const GoogleCloudDialogflowCxV3beta1WebhookGenericWebService({
    this.allowedCaCerts,
    this.httpMethod,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'httpMethod': ?pulumi.Input.mapOptionalInputValue<GoogleCloudDialogflowCxV3beta1WebhookGenericWebServiceHttpMethod, String>(httpMethod, (value) => value.wireValue),
      ...
      'uri': uri,
      'username': ?username,
      'webhookType': ?pulumi.Input.mapOptionalInputValue<GoogleCloudDialogflowCxV3beta1WebhookGenericWebServiceWebhookType, String>(webhookType, (value) => value.wireValue),
    };
  }
  ...
  factory GoogleCloudDialogflowCxV3beta1WebhookGenericWebService.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3beta1WebhookGenericWebService(
      ...
      httpMethod: (() { final guardedValue = map['httpMethod']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowCxV3beta1WebhookGenericWebServiceHttpMethod.fromValue(guardedValue as String)); })(),
      ...
      webhookType: (() { final guardedValue = map['webhookType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowCxV3beta1WebhookGenericWebServiceWebhookType.fromValue(guardedValue as String)); })(),
    );
  }
}
