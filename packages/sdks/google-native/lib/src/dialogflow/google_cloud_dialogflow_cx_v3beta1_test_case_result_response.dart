...
class GoogleCloudDialogflowCxV3beta1TestCaseResultResponse {
  ...
  const GoogleCloudDialogflowCxV3beta1TestCaseResultResponse({
  ...
  factory GoogleCloudDialogflowCxV3beta1TestCaseResultResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3beta1TestCaseResultResponse(
      conversationTurns: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudDialogflowCxV3beta1ConversationTurnResponse>(map['conversationTurns']!, (value) => GoogleCloudDialogflowCxV3beta1ConversationTurnResponse.fromMap((value as Map).cast<String, dynamic>()))),
