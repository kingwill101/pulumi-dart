...
class GoogleCloudDialogflowCxV3beta1ConversationTurnVirtualAgentOutputResponse {
  ...
  final pulumi.Input<
    List<GoogleCloudDialogflowCxV3beta1TestRunDifferenceResponse>
  >
  differences;
  ...
  final pulumi.Input<
    List<GoogleCloudDialogflowCxV3beta1ResponseMessageTextResponse>
  >
  textResponses;

  /// The Intent that triggered the response. Only name and displayName will be set.
  final pulumi.Input<GoogleCloudDialogflowCxV3beta1IntentResponse>
  triggeredIntent;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'status':
          pulumi.Input.mapInputValue<
            GoogleRpcStatusResponseDialogflowV3beta1,
            Map<String, dynamic>
  ...
  factory GoogleCloudDialogflowCxV3beta1ConversationTurnVirtualAgentOutputResponse.fromMap(
    ...
    return GoogleCloudDialogflowCxV3beta1ConversationTurnVirtualAgentOutputResponse(
      currentPage: pulumi.Input.fromValue(
        GoogleCloudDialogflowCxV3beta1PageResponse.fromMap(
          (map['currentPage']! as Map).cast<String, dynamic>(),
        ),
      ),
      diagnosticInfo: pulumi.Input.fromValue(
        (map['diagnosticInfo'] as Map).cast<String, String>(),
      ),
      differences: pulumi.Input.fromValue(
      ...
      sessionParameters: pulumi.Input.fromValue(
        (map['sessionParameters'] as Map).cast<String, String>(),
      ),
      status: pulumi.Input.fromValue(
        GoogleRpcStatusResponseDialogflowV3beta1.fromMap(
          (map['status']! as Map).cast<String, dynamic>(),
        ),
      ),
      textResponses: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GoogleCloudDialogflowCxV3beta1ResponseMessageTextResponse
        >(
          map['textResponses']!,
      ...
      triggeredIntent: pulumi.Input.fromValue(
        GoogleCloudDialogflowCxV3beta1IntentResponse.fromMap(
