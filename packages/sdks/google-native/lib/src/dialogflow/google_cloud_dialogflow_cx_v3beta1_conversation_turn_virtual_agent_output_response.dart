...
class GoogleCloudDialogflowCxV3beta1ConversationTurnVirtualAgentOutputResponse {
  ...
  final List<GoogleCloudDialogflowCxV3beta1TestRunDifferenceResponse> differences;
  ...
  final List<GoogleCloudDialogflowCxV3beta1ResponseMessageTextResponse> textResponses;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'differences': pulumi.Input.encodeList<GoogleCloudDialogflowCxV3beta1TestRunDifferenceResponse, Map<String, dynamic>>(differences, (value) => value.toMap()),
      'sessionParameters': sessionParameters,
      'status': status.toMap(),
      'textResponses': pulumi.Input.encodeList<GoogleCloudDialogflowCxV3beta1ResponseMessageTextResponse, Map<String, dynamic>>(textResponses, (value) => value.toMap()),
  ...
  factory GoogleCloudDialogflowCxV3beta1ConversationTurnVirtualAgentOutputResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3beta1ConversationTurnVirtualAgentOutputResponse(
      currentPage: GoogleCloudDialogflowCxV3beta1PageResponse.fromMap((map['currentPage'] as Map).cast<String, dynamic>()),
      diagnosticInfo: (map['diagnosticInfo'] as Map).cast<String, String>(),
      differences: pulumi.Input.decodeList<GoogleCloudDialogflowCxV3beta1TestRunDifferenceResponse>(map['differences'], (value) => GoogleCloudDialogflowCxV3beta1TestRunDifferenceResponse.fromMap((value as Map).cast<String, dynamic>())),
      sessionParameters: (map['sessionParameters'] as Map).cast<String, String>(),
      status: GoogleRpcStatusResponseDialogflowV3beta1.fromMap((map['status'] as Map).cast<String, dynamic>()),
      textResponses: pulumi.Input.decodeList<GoogleCloudDialogflowCxV3beta1ResponseMessageTextResponse>(map['textResponses'], (value) => GoogleCloudDialogflowCxV3beta1ResponseMessageTextResponse.fromMap((value as Map).cast<String, dynamic>())),
      triggeredIntent: GoogleCloudDialogflowCxV3beta1IntentResponse.fromMap((map['triggeredIntent'] as Map).cast<String, dynamic>()),
    );
  }
}
