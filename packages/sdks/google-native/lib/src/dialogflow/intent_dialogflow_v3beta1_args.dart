...
class IntentDialogflowV3beta1Args {
  ...
  IntentDialogflowV3beta1Args({
    ...
    pulumi.Output<List<GoogleCloudDialogflowCxV3beta1IntentParameter>>? parameters,
    pulumi.Output<int>? priority,
    pulumi.Output<String>? project,
    pulumi.Output<List<GoogleCloudDialogflowCxV3beta1IntentTrainingPhrase>>? trainingPhrases,
  }) :
      ...
      parameters = pulumi.Input.asOptionalInput<List<GoogleCloudDialogflowCxV3beta1IntentParameter>>(parameters),
      priority = pulumi.Input.asOptionalInput<int>(priority),
      project = pulumi.Input.asOptionalInput<String>(project),
      trainingPhrases = pulumi.Input.asOptionalInput<List<GoogleCloudDialogflowCxV3beta1IntentTrainingPhrase>>(trainingPhrases);
  ...
  factory IntentDialogflowV3beta1Args.fromMap(Map<String, dynamic> map) {
    return IntentDialogflowV3beta1Args(
      ...
      parameters: map['parameters'] == null ? null : pulumi.Output.create<List<GoogleCloudDialogflowCxV3beta1IntentParameter>>(pulumi.Input.decodeList<GoogleCloudDialogflowCxV3beta1IntentParameter>(map['parameters'], (value) => GoogleCloudDialogflowCxV3beta1IntentParameter.fromMap((value as Map).cast<String, dynamic>()))),
      priority: map['priority'] == null ? null : pulumi.Output.create<int>(map['priority'] as int),
      project: map['project'] == null ? null : pulumi.Output.create<String>(map['project'] as String),
      trainingPhrases: map['trainingPhrases'] == null ? null : pulumi.Output.create<List<GoogleCloudDialogflowCxV3beta1IntentTrainingPhrase>>(pulumi.Input.decodeList<GoogleCloudDialogflowCxV3beta1IntentTrainingPhrase>(map['trainingPhrases'], (value) => GoogleCloudDialogflowCxV3beta1IntentTrainingPhrase.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
