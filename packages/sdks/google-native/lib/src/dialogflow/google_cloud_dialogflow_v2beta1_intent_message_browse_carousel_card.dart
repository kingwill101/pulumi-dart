...
class GoogleCloudDialogflowV2beta1IntentMessageBrowseCarouselCard {
  ...
  const GoogleCloudDialogflowV2beta1IntentMessageBrowseCarouselCard({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'imageDisplayOptions': ?pulumi.Input.mapOptionalInputValue<GoogleCloudDialogflowV2beta1IntentMessageBrowseCarouselCardImageDisplayOptions, String>(imageDisplayOptions, (value) => value.wireValue),
  ...
  factory GoogleCloudDialogflowV2beta1IntentMessageBrowseCarouselCard.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2beta1IntentMessageBrowseCarouselCard(
      imageDisplayOptions: (() { final guardedValue = map['imageDisplayOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowV2beta1IntentMessageBrowseCarouselCardImageDisplayOptions.fromValue(guardedValue as String)); })(),
      items: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudDialogflowV2beta1IntentMessageBrowseCarouselCardBrowseCarouselCardItem>(map['items']!, (value) => GoogleCloudDialogflowV2beta1IntentMessageBrowseCarouselCardBrowseCarouselCardItem.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
