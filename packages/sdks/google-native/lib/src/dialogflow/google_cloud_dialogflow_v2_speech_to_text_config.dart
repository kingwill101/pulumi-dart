...
class GoogleCloudDialogflowV2SpeechToTextConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'model': ?model,
      'speechModelVariant': ?pulumi.Input.mapOptionalInputValue<GoogleCloudDialogflowV2SpeechToTextConfigSpeechModelVariant, String>(speechModelVariant, (value) => value.value),
  ...
  factory GoogleCloudDialogflowV2SpeechToTextConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2SpeechToTextConfig(
      ...
      speechModelVariant: map['speechModelVariant'] == null ? null : (GoogleCloudDialogflowV2SpeechToTextConfigSpeechModelVariant.fromValue(map['speechModelVariant']! as String)).input(),
