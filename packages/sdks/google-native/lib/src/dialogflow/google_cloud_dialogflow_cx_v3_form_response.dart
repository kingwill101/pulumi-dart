...
class GoogleCloudDialogflowCxV3FormResponse {
  ...
  final pulumi.Input<List<GoogleCloudDialogflowCxV3FormParameterResponse>>
  parameters;

  /// Creates a new [GoogleCloudDialogflowCxV3FormResponse].
  /// [parameters] Parameters to collect from the user.
  GoogleCloudDialogflowCxV3FormResponse({required this.parameters});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'parameters':
          pulumi.Input.mapInputValue<
            List<GoogleCloudDialogflowCxV3FormParameterResponse>,
  ...
  factory GoogleCloudDialogflowCxV3FormResponse.fromMap(
    ...
    return GoogleCloudDialogflowCxV3FormResponse(
      parameters: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GoogleCloudDialogflowCxV3FormParameterResponse>(
          map['parameters']!,
