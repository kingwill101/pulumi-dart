...
class GoogleCloudDialogflowCxV3beta1WebhookGenericWebServiceResponse {
  ...
  /// Creates a new [GoogleCloudDialogflowCxV3beta1WebhookGenericWebServiceResponse].
  ...
  factory GoogleCloudDialogflowCxV3beta1WebhookGenericWebServiceResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3beta1WebhookGenericWebServiceResponse(
      allowedCaCerts: pulumi.Input.fromValue((map['allowedCaCerts'] as List).cast<String>()),
      httpMethod: pulumi.Input.fromValue(map['httpMethod'] as String),
      parameterMapping: pulumi.Input.fromValue((map['parameterMapping'] as Map).cast<String, String>()),
      password: pulumi.Input.fromValue(map['password'] as String),
      requestBody: pulumi.Input.fromValue(map['requestBody'] as String),
