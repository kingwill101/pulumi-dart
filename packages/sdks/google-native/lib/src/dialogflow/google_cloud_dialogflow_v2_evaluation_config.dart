...
class GoogleCloudDialogflowV2EvaluationConfig {
  ...
  final pulumi.Input<GoogleCloudDialogflowV2EvaluationConfigSmartComposeConfig>?
  smartComposeConfig;

  /// Configuration for smart reply model evalution.
  final pulumi.Input<GoogleCloudDialogflowV2EvaluationConfigSmartReplyConfig>?
  smartReplyConfig;
  ...
  factory GoogleCloudDialogflowV2EvaluationConfig.fromMap(
    ...
    return GoogleCloudDialogflowV2EvaluationConfig(
      ...
      smartComposeConfig: (() {
        final guardedValue = map['smartComposeConfig'];
      ...
      smartReplyConfig: (() {
        final guardedValue = map['smartReplyConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
