...
class GoogleCloudDialogflowV2beta1IntentMessageCarouselSelect {
  ...
  factory GoogleCloudDialogflowV2beta1IntentMessageCarouselSelect.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2beta1IntentMessageCarouselSelect(
      items: (pulumi.Input.decodeList<GoogleCloudDialogflowV2beta1IntentMessageCarouselSelectItem>(map['items'], (value) => GoogleCloudDialogflowV2beta1IntentMessageCarouselSelectItem.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
