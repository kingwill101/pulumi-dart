...
class GoogleCloudDialogflowV2IntentTrainingPhraseResponse {
  ...
  const GoogleCloudDialogflowV2IntentTrainingPhraseResponse({
    required this.name,
    required this.parts,
  ...
  factory GoogleCloudDialogflowV2IntentTrainingPhraseResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2IntentTrainingPhraseResponse(
      ...
      parts: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudDialogflowV2IntentTrainingPhrasePartResponse>(map['parts']!, (value) => GoogleCloudDialogflowV2IntentTrainingPhrasePartResponse.fromMap((value as Map).cast<String, dynamic>()))),
