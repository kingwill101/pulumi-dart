...
class GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionFeatureConfigResponse {
  ...
  factory GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionFeatureConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionFeatureConfigResponse(
      conversationModelConfig: (GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigConversationModelConfigResponse.fromMap((map['conversationModelConfig'] as Map).cast<String, dynamic>())).input(),
      conversationProcessConfig: (GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigConversationProcessConfigResponse.fromMap((map['conversationProcessConfig'] as Map).cast<String, dynamic>())).input(),
      ...
      queryConfig: (GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionQueryConfigResponse.fromMap((map['queryConfig'] as Map).cast<String, dynamic>())).input(),
      suggestionFeature: (GoogleCloudDialogflowV2beta1SuggestionFeatureResponse.fromMap((map['suggestionFeature'] as Map).cast<String, dynamic>())).input(),
      suggestionTriggerSettings: (GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionTriggerSettingsResponse.fromMap((map['suggestionTriggerSettings'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
