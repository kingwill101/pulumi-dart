...
class GoogleCloudDialogflowV2IntentParameterResponse {
  ...
  /// Creates a new [GoogleCloudDialogflowV2IntentParameterResponse].
  ...
  factory GoogleCloudDialogflowV2IntentParameterResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2IntentParameterResponse(
      defaultValue: (map['defaultValue'] as String).input(),
      displayName: (map['displayName'] as String).input(),
      entityTypeDisplayName: (map['entityTypeDisplayName'] as String).input(),
      isList: (map['isList'] as bool).input(),
      mandatory: (map['mandatory'] as bool).input(),
      name: (map['name'] as String).input(),
      prompts: ((map['prompts'] as List).cast<String>()).input(),
