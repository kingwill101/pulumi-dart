...
class GoogleCloudDialogflowCxV3FulfillmentConditionalCasesCaseCaseContentResponse {
  ...
  const GoogleCloudDialogflowCxV3FulfillmentConditionalCasesCaseCaseContentResponse({
  ...
  factory GoogleCloudDialogflowCxV3FulfillmentConditionalCasesCaseCaseContentResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3FulfillmentConditionalCasesCaseCaseContentResponse(
      additionalCases: pulumi.Input.fromValue(GoogleCloudDialogflowCxV3FulfillmentConditionalCasesResponse.fromMap((map['additionalCases']! as Map).cast<String, dynamic>())),
      message: pulumi.Input.fromValue(GoogleCloudDialogflowCxV3ResponseMessageResponse.fromMap((map['message']! as Map).cast<String, dynamic>())),
    );
  }
}
