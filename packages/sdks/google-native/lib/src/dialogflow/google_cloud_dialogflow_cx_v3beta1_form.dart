...
class GoogleCloudDialogflowCxV3beta1Form {
  ...
  final pulumi.Input<List<GoogleCloudDialogflowCxV3beta1FormParameter>>?
  parameters;
    ...
    return <String, dynamic>{
      'parameters':
          ?pulumi.Input.mapOptionalInputValue<
            List<GoogleCloudDialogflowCxV3beta1FormParameter>,
    ...
    return GoogleCloudDialogflowCxV3beta1Form(
      parameters: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GoogleCloudDialogflowCxV3beta1FormParameter>(
            guardedValue,
