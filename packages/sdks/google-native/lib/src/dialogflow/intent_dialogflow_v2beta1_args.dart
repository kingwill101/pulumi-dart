...
class IntentDialogflowV2beta1Args {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'action': ?action,
      'defaultResponsePlatforms': ?pulumi.Input.mapOptionalInputValue<List<IntentDefaultResponsePlatformsItemDialogflowV2beta1>, List<String>>(defaultResponsePlatforms, (value) => pulumi.Input.encodeList<IntentDefaultResponsePlatformsItemDialogflowV2beta1, String>(value, (value) => value.wireValue)),
      ...
      'webhookState': ?pulumi.Input.mapOptionalInputValue<IntentWebhookStateDialogflowV2beta1, String>(webhookState, (value) => value.wireValue),
    };
  }
  ...
  factory IntentDialogflowV2beta1Args.fromMap(Map<String, dynamic> map) {
    return IntentDialogflowV2beta1Args(
      ...
      defaultResponsePlatforms: (() { final guardedValue = map['defaultResponsePlatforms']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<IntentDefaultResponsePlatformsItemDialogflowV2beta1>(guardedValue, (value) => IntentDefaultResponsePlatformsItemDialogflowV2beta1.fromValue(value as String))); })(),
      ...
      messages: (() { final guardedValue = map['messages']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudDialogflowV2beta1IntentMessage>(guardedValue, (value) => GoogleCloudDialogflowV2beta1IntentMessage.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      mlEnabled: (() { final guardedValue = map['mlEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      outputContexts: (() { final guardedValue = map['outputContexts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudDialogflowV2beta1Context>(guardedValue, (value) => GoogleCloudDialogflowV2beta1Context.fromMap((value as Map).cast<String, dynamic>()))); })(),
      parameters: (() { final guardedValue = map['parameters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudDialogflowV2beta1IntentParameter>(guardedValue, (value) => GoogleCloudDialogflowV2beta1IntentParameter.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      trainingPhrases: (() { final guardedValue = map['trainingPhrases']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudDialogflowV2beta1IntentTrainingPhrase>(guardedValue, (value) => GoogleCloudDialogflowV2beta1IntentTrainingPhrase.fromMap((value as Map).cast<String, dynamic>()))); })(),
      webhookState: (() { final guardedValue = map['webhookState']; if (guardedValue == null) return null; return pulumi.Input.fromValue(IntentWebhookStateDialogflowV2beta1.fromValue(guardedValue as String)); })(),
    );
  }
}
