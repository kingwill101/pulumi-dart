...
class SessionEntityTypeArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'entityOverrideMode': pulumi.Input.mapInputValue<SessionEntityTypeEntityOverrideMode, String>(entityOverrideMode, (value) => value.wireValue),
  ...
  factory SessionEntityTypeArgs.fromMap(Map<String, dynamic> map) {
    return SessionEntityTypeArgs(
      entities: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudDialogflowV2EntityTypeEntity>(map['entities']!, (value) => GoogleCloudDialogflowV2EntityTypeEntity.fromMap((value as Map).cast<String, dynamic>()))),
      entityOverrideMode: pulumi.Input.fromValue(SessionEntityTypeEntityOverrideMode.fromValue(map['entityOverrideMode']! as String)),
