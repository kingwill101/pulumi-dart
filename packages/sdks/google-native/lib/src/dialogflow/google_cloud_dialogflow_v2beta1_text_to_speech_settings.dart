...
class GoogleCloudDialogflowV2beta1TextToSpeechSettings {
  ...
  final pulumi.Input<GoogleCloudDialogflowV2beta1TextToSpeechSettingsOutputAudioEncoding> outputAudioEncoding;
  ...
  const GoogleCloudDialogflowV2beta1TextToSpeechSettings({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'outputAudioEncoding': pulumi.Input.mapInputValue<GoogleCloudDialogflowV2beta1TextToSpeechSettingsOutputAudioEncoding, String>(outputAudioEncoding, (value) => value.wireValue),
  ...
  factory GoogleCloudDialogflowV2beta1TextToSpeechSettings.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2beta1TextToSpeechSettings(
      ...
      outputAudioEncoding: pulumi.Input.fromValue(GoogleCloudDialogflowV2beta1TextToSpeechSettingsOutputAudioEncoding.fromValue(map['outputAudioEncoding']! as String)),
