...
class GoogleCloudDialogflowV2beta1TextToSpeechSettings {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'outputAudioEncoding': pulumi.Input.mapInputValue<GoogleCloudDialogflowV2beta1TextToSpeechSettingsOutputAudioEncoding, String>(outputAudioEncoding, (value) => value.value),
