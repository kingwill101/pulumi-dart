...
class GoogleCloudDialogflowCxV3beta1RolloutConfigResponse {
  ...
  final pulumi.Input<List<GoogleCloudDialogflowCxV3beta1RolloutConfigRolloutStepResponse>> rolloutSteps;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'rolloutSteps': pulumi.Input.mapInputValue<List<GoogleCloudDialogflowCxV3beta1RolloutConfigRolloutStepResponse>, List<Map<String, dynamic>>>(rolloutSteps, (value) => pulumi.Input.encodeList<GoogleCloudDialogflowCxV3beta1RolloutConfigRolloutStepResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory GoogleCloudDialogflowCxV3beta1RolloutConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3beta1RolloutConfigResponse(
      failureCondition: (map['failureCondition'] as String).input(),
      rolloutCondition: (map['rolloutCondition'] as String).input(),
      rolloutSteps: (pulumi.Input.decodeList<GoogleCloudDialogflowCxV3beta1RolloutConfigRolloutStepResponse>(map['rolloutSteps'], (value) => GoogleCloudDialogflowCxV3beta1RolloutConfigRolloutStepResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
