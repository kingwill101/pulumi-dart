...
class GoogleCloudDialogflowCxV3beta1RolloutConfigResponse {
  ...
  const GoogleCloudDialogflowCxV3beta1RolloutConfigResponse({
  ...
  factory GoogleCloudDialogflowCxV3beta1RolloutConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3beta1RolloutConfigResponse(
      ...
      rolloutSteps: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudDialogflowCxV3beta1RolloutConfigRolloutStepResponse>(map['rolloutSteps']!, (value) => GoogleCloudDialogflowCxV3beta1RolloutConfigRolloutStepResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
