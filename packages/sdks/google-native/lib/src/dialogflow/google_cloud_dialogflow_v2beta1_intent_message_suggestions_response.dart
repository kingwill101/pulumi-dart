...
class GoogleCloudDialogflowV2beta1IntentMessageSuggestionsResponse {
  ...
  final List<GoogleCloudDialogflowV2beta1IntentMessageSuggestionResponse> suggestions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'suggestions': pulumi.Input.encodeList<GoogleCloudDialogflowV2beta1IntentMessageSuggestionResponse, Map<String, dynamic>>(suggestions, (value) => value.toMap()),
    };
  }
  ...
  factory GoogleCloudDialogflowV2beta1IntentMessageSuggestionsResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2beta1IntentMessageSuggestionsResponse(
      suggestions: pulumi.Input.decodeList<GoogleCloudDialogflowV2beta1IntentMessageSuggestionResponse>(map['suggestions'], (value) => GoogleCloudDialogflowV2beta1IntentMessageSuggestionResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
