...
class GoogleCloudDialogflowV2beta1SpeechToTextConfigResponse {
  ...
  /// Creates a new [GoogleCloudDialogflowV2beta1SpeechToTextConfigResponse].
  ...
  const GoogleCloudDialogflowV2beta1SpeechToTextConfigResponse({
    required this.model,
  ...
  factory GoogleCloudDialogflowV2beta1SpeechToTextConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2beta1SpeechToTextConfigResponse(
      model: pulumi.Input.fromValue(map['model'] as String),
      speechModelVariant: pulumi.Input.fromValue(map['speechModelVariant'] as String),
      useTimeoutBasedEndpointing: pulumi.Input.fromValue(map['useTimeoutBasedEndpointing'] as bool),
    );
  }
}
