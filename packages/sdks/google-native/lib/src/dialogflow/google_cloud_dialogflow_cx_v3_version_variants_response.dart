...
class GoogleCloudDialogflowCxV3VersionVariantsResponse {
  ...
  factory GoogleCloudDialogflowCxV3VersionVariantsResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3VersionVariantsResponse(
      variants: (pulumi.Input.decodeList<GoogleCloudDialogflowCxV3VersionVariantsVariantResponse>(map['variants'], (value) => GoogleCloudDialogflowCxV3VersionVariantsVariantResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
