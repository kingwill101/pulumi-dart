...
class GoogleCloudDialogflowCxV3AudioInput {
  ...
  const GoogleCloudDialogflowCxV3AudioInput({
    this.audio,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'audio': ?audio,
      'config': pulumi.Input.mapInputValue<GoogleCloudDialogflowCxV3InputAudioConfig, Map<String, dynamic>>(config, (value) => value.toMap()),
    };
  }
  ...
  factory GoogleCloudDialogflowCxV3AudioInput.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3AudioInput(
      ...
      config: pulumi.Input.fromValue(GoogleCloudDialogflowCxV3InputAudioConfig.fromMap((map['config']! as Map).cast<String, dynamic>())),
    );
  }
}
