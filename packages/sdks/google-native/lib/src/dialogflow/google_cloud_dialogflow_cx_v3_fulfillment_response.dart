...
class GoogleCloudDialogflowCxV3FulfillmentResponse {
  ...
  factory GoogleCloudDialogflowCxV3FulfillmentResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3FulfillmentResponse(
      ...
      conditionalCases: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudDialogflowCxV3FulfillmentConditionalCasesResponse>(map['conditionalCases']!, (value) => GoogleCloudDialogflowCxV3FulfillmentConditionalCasesResponse.fromMap((value as Map).cast<String, dynamic>()))),
      enableGenerativeFallback: pulumi.Input.fromValue(map['enableGenerativeFallback'] as bool),
      messages: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudDialogflowCxV3ResponseMessageResponse>(map['messages']!, (value) => GoogleCloudDialogflowCxV3ResponseMessageResponse.fromMap((value as Map).cast<String, dynamic>()))),
      returnPartialResponses: pulumi.Input.fromValue(map['returnPartialResponses'] as bool),
      setParameterActions: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudDialogflowCxV3FulfillmentSetParameterActionResponse>(map['setParameterActions']!, (value) => GoogleCloudDialogflowCxV3FulfillmentSetParameterActionResponse.fromMap((value as Map).cast<String, dynamic>()))),
