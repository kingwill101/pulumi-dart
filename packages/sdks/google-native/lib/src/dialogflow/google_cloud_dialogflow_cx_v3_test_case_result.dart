...
class GoogleCloudDialogflowCxV3TestCaseResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'conversationTurns': ?conversationTurns == null ? null : pulumi.Input.encodeList<GoogleCloudDialogflowCxV3ConversationTurn, Map<String, dynamic>>(conversationTurns!, (value) => value.toMap()),
  ...
  factory GoogleCloudDialogflowCxV3TestCaseResult.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowCxV3TestCaseResult(
      conversationTurns: map['conversationTurns'] == null ? null : pulumi.Input.decodeList<GoogleCloudDialogflowCxV3ConversationTurn>(map['conversationTurns'], (value) => GoogleCloudDialogflowCxV3ConversationTurn.fromMap((value as Map).cast<String, dynamic>())),
      environment: map['environment'] == null ? null : map['environment'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      testResult: map['testResult'] == null ? null : GoogleCloudDialogflowCxV3TestCaseResultTestResult.fromValue(map['testResult'] as String),
