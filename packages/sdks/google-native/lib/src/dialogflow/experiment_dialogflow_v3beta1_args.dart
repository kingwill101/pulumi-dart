...
class ExperimentDialogflowV3beta1Args {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'startTime': ?startTime,
      'state': ?pulumi.Input.mapOptionalInputValue<ExperimentStateDialogflowV3beta1, String>(state, (value) => value.wireValue),
  ...
  factory ExperimentDialogflowV3beta1Args.fromMap(Map<String, dynamic> map) {
    return ExperimentDialogflowV3beta1Args(
      ...
      definition: (() { final guardedValue = map['definition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowCxV3beta1ExperimentDefinition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      result: (() { final guardedValue = map['result']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowCxV3beta1ExperimentResult.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      rolloutConfig: (() { final guardedValue = map['rolloutConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowCxV3beta1RolloutConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      rolloutState: (() { final guardedValue = map['rolloutState']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDialogflowCxV3beta1RolloutState.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      startTime: (() { final guardedValue = map['startTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      state: (() { final guardedValue = map['state']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ExperimentStateDialogflowV3beta1.fromValue(guardedValue as String)); })(),
      variantsHistory: (() { final guardedValue = map['variantsHistory']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudDialogflowCxV3beta1VariantsHistory>(guardedValue, (value) => GoogleCloudDialogflowCxV3beta1VariantsHistory.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
