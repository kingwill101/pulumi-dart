...
class GoogleCloudDialogflowV2IntentParameter {
  ...
  /// Creates a new [GoogleCloudDialogflowV2IntentParameter].
  ...
  const GoogleCloudDialogflowV2IntentParameter({
    this.defaultValue,
  ...
  factory GoogleCloudDialogflowV2IntentParameter.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2IntentParameter(
      ...
      entityTypeDisplayName: (() { final guardedValue = map['entityTypeDisplayName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      prompts: (() { final guardedValue = map['prompts']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
