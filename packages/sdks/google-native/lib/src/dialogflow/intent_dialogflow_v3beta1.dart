...
import 'intent_dialogflow_v3beta1_args.dart';

/// Creates an intent in the specified agent. Note: You should always train a flow prior to sending it queries. See the [training documentation](https://cloud.google.com/dialogflow/cx/docs/concept/training).
class IntentDialogflowV3beta1 extends pulumi.CustomResource {
  ...
  /// Creates a new [IntentDialogflowV3beta1].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [IntentDialogflowV3beta1]. {@macro pulumi_dialogflow_v3beta1_intent_dialogflow_v3beta1_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  IntentDialogflowV3beta1(
    String name, {
    IntentDialogflowV3beta1Args? args,
