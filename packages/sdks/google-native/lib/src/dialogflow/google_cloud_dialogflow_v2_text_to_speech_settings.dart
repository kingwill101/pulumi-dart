...
class GoogleCloudDialogflowV2TextToSpeechSettings {
  ...
  final pulumi.Input<GoogleCloudDialogflowV2TextToSpeechSettingsOutputAudioEncoding> outputAudioEncoding;
  ...
  const GoogleCloudDialogflowV2TextToSpeechSettings({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'outputAudioEncoding': pulumi.Input.mapInputValue<GoogleCloudDialogflowV2TextToSpeechSettingsOutputAudioEncoding, String>(outputAudioEncoding, (value) => value.wireValue),
      'sampleRateHertz': ?sampleRateHertz,
      'synthesizeSpeechConfigs': ?synthesizeSpeechConfigs,
    };
  }

  factory GoogleCloudDialogflowV2TextToSpeechSettings.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2TextToSpeechSettings(
      ...
      outputAudioEncoding: pulumi.Input.fromValue(GoogleCloudDialogflowV2TextToSpeechSettingsOutputAudioEncoding.fromValue(map['outputAudioEncoding']! as String)),
