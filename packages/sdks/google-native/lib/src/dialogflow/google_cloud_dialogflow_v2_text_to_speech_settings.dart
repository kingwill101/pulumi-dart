...
class GoogleCloudDialogflowV2TextToSpeechSettings {
  ...
  final GoogleCloudDialogflowV2TextToSpeechSettingsOutputAudioEncoding outputAudioEncoding;
  ...
  factory GoogleCloudDialogflowV2TextToSpeechSettings.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDialogflowV2TextToSpeechSettings(
      ...
      outputAudioEncoding: GoogleCloudDialogflowV2TextToSpeechSettingsOutputAudioEncoding.fromValue(map['outputAudioEncoding'] as String),
