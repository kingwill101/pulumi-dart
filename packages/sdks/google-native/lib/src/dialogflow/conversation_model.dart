...
class ConversationModel extends pulumi.CustomResource {
  ...
  ConversationModel(
    ...
    articleSuggestionModelMetadata = registerOutput<GoogleCloudDialogflowV2ArticleSuggestionModelMetadataResponse>('articleSuggestionModelMetadata', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return GoogleCloudDialogflowV2ArticleSuggestionModelMetadataResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    smartReplyModelMetadata = registerOutput<GoogleCloudDialogflowV2SmartReplyModelMetadataResponse>('smartReplyModelMetadata', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return GoogleCloudDialogflowV2SmartReplyModelMetadataResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
