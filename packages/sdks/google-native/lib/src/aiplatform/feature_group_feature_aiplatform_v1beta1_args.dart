...
class FeatureGroupFeatureAiplatformV1beta1Args {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'valueType':
          ?pulumi.Input.mapOptionalInputValue<
            FeatureGroupFeatureValueTypeAiplatformV1beta1,
            String
  ...
  factory FeatureGroupFeatureAiplatformV1beta1Args.fromMap(
    ...
    return FeatureGroupFeatureAiplatformV1beta1Args(
      ...
      valueType: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FeatureGroupFeatureValueTypeAiplatformV1beta1.fromValue(
