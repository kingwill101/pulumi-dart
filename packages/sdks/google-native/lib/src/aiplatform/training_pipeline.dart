...
class TrainingPipeline extends pulumi.CustomResource {
  ...
  TrainingPipeline(
    ...
    inputDataConfig = registerOutput<GoogleCloudAiplatformV1InputDataConfigResponse>('inputDataConfig', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return GoogleCloudAiplatformV1InputDataConfigResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    labels = registerOutput<Map<String, String>>('labels');
    location = registerOutput<String>('location');
    modelId = registerOutput<String>('modelId');
    modelToUpload = registerOutput<GoogleCloudAiplatformV1ModelResponse>('modelToUpload', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return GoogleCloudAiplatformV1ModelResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
