...
class NotebookRuntimeTemplateAiplatformV1beta1Args {
  ...
  NotebookRuntimeTemplateAiplatformV1beta1Args({
    pulumi.Output<GoogleCloudAiplatformV1beta1PersistentDiskSpec>? dataPersistentDiskSpec,
    pulumi.Output<String>? description,
    required pulumi.Output<String> displayName,
    pulumi.Output<String>? etag,
    pulumi.Output<GoogleCloudAiplatformV1beta1NotebookEucConfig>? eucConfig,
    pulumi.Output<GoogleCloudAiplatformV1beta1NotebookIdleShutdownConfig>? idleShutdownConfig,
    pulumi.Output<Map<String, String>>? labels,
    pulumi.Output<String>? location,
    pulumi.Output<GoogleCloudAiplatformV1beta1MachineSpec>? machineSpec,
    pulumi.Output<GoogleCloudAiplatformV1beta1NetworkSpec>? networkSpec,
    pulumi.Output<String>? notebookRuntimeTemplateId,
    pulumi.Output<NotebookRuntimeTemplateNotebookRuntimeTypeAiplatformV1beta1>? notebookRuntimeType,
  ...
  factory NotebookRuntimeTemplateAiplatformV1beta1Args.fromMap(Map<String, dynamic> map) {
    return NotebookRuntimeTemplateAiplatformV1beta1Args(
      dataPersistentDiskSpec: map['dataPersistentDiskSpec'] == null ? null : pulumi.Output.create<GoogleCloudAiplatformV1beta1PersistentDiskSpec>(GoogleCloudAiplatformV1beta1PersistentDiskSpec.fromMap((map['dataPersistentDiskSpec'] as Map).cast<String, dynamic>())),
      description: map['description'] == null ? null : pulumi.Output.create<String>(map['description'] as String),
      displayName: pulumi.Output.create<String>(map['displayName'] as String),
      etag: map['etag'] == null ? null : pulumi.Output.create<String>(map['etag'] as String),
      eucConfig: map['eucConfig'] == null ? null : pulumi.Output.create<GoogleCloudAiplatformV1beta1NotebookEucConfig>(GoogleCloudAiplatformV1beta1NotebookEucConfig.fromMap((map['eucConfig'] as Map).cast<String, dynamic>())),
      idleShutdownConfig: map['idleShutdownConfig'] == null ? null : pulumi.Output.create<GoogleCloudAiplatformV1beta1NotebookIdleShutdownConfig>(GoogleCloudAiplatformV1beta1NotebookIdleShutdownConfig.fromMap((map['idleShutdownConfig'] as Map).cast<String, dynamic>())),
      labels: map['labels'] == null ? null : pulumi.Output.create<Map<String, String>>((map['labels'] as Map).cast<String, String>()),
      location: map['location'] == null ? null : pulumi.Output.create<String>(map['location'] as String),
      machineSpec: map['machineSpec'] == null ? null : pulumi.Output.create<GoogleCloudAiplatformV1beta1MachineSpec>(GoogleCloudAiplatformV1beta1MachineSpec.fromMap((map['machineSpec'] as Map).cast<String, dynamic>())),
      networkSpec: map['networkSpec'] == null ? null : pulumi.Output.create<GoogleCloudAiplatformV1beta1NetworkSpec>(GoogleCloudAiplatformV1beta1NetworkSpec.fromMap((map['networkSpec'] as Map).cast<String, dynamic>())),
      ...
      notebookRuntimeType: map['notebookRuntimeType'] == null ? null : pulumi.Output.create<NotebookRuntimeTemplateNotebookRuntimeTypeAiplatformV1beta1>(NotebookRuntimeTemplateNotebookRuntimeTypeAiplatformV1beta1.fromValue(map['notebookRuntimeType'] as String)),
