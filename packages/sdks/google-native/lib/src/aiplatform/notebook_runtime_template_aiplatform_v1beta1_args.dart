    ...
    return <String, dynamic>{
      ...
      'notebookRuntimeType':
          ?pulumi.Input.mapOptionalInputValue<
            NotebookRuntimeTemplateNotebookRuntimeTypeAiplatformV1beta1,
            String
          >(notebookRuntimeType, (value) => value.wireValue),
      'project': ?project,
  ...
  factory NotebookRuntimeTemplateAiplatformV1beta1Args.fromMap(
    ...
    return NotebookRuntimeTemplateAiplatformV1beta1Args(
      ...
      notebookRuntimeTemplateId: (() {
        final guardedValue = map['notebookRuntimeTemplateId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      notebookRuntimeType: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          NotebookRuntimeTemplateNotebookRuntimeTypeAiplatformV1beta1.fromValue(
