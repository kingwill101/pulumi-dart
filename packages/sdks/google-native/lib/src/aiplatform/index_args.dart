...
class IndexArgs {
  ...
  IndexArgs({
    ...
    pulumi.Output<IndexIndexUpdateMethod>? indexUpdateMethod,
  ...
  factory IndexArgs.fromMap(Map<String, dynamic> map) {
    return IndexArgs(
      ...
      indexUpdateMethod: map['indexUpdateMethod'] == null ? null : pulumi.Output.create<IndexIndexUpdateMethod>(IndexIndexUpdateMethod.fromValue(map['indexUpdateMethod'] as String)),
