...
class GoogleCloudAiplatformV1beta1PredictSchemata {
  ...
  factory GoogleCloudAiplatformV1beta1PredictSchemata.fromMap(
    Map<String, dynamic> map,
  ) {
    return GoogleCloudAiplatformV1beta1PredictSchemata(
      instanceSchemaUri: (() {
        final guardedValue = map['instanceSchemaUri'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      parametersSchemaUri: (() {
        final guardedValue = map['parametersSchemaUri'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      predictionSchemaUri: (() {
        final guardedValue = map['predictionSchemaUri'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
