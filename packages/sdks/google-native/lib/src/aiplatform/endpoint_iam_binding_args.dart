...
/// {@template pulumi_aiplatform_v1beta1_endpoint_iam_binding_args_doc}
/// The set of arguments for EndpointIamBinding.
/// {@endtemplate}
/// {@macro pulumi_aiplatform_v1beta1_endpoint_iam_binding_args_doc}
class EndpointIamBindingArgs {
  ...
  /// Creates a new [EndpointIamBindingArgs].
  ...
  factory EndpointIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return EndpointIamBindingArgs(
