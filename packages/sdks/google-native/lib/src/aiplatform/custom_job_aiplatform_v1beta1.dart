...
import 'custom_job_aiplatform_v1beta1_args.dart';
...
class CustomJobAiplatformV1beta1 extends pulumi.CustomResource {
  ...
  /// Job spec.
  late final pulumi.Output<GoogleCloudAiplatformV1beta1CustomJobSpecResponse> jobSpec;
  ...
  /// Creates a new [CustomJobAiplatformV1beta1].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [CustomJobAiplatformV1beta1]. {@macro pulumi_aiplatform_v1beta1_custom_job_aiplatform_v1beta1_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  CustomJobAiplatformV1beta1(
    String name, {
    CustomJobAiplatformV1beta1Args? args,
    ...
    jobSpec = registerOutput<GoogleCloudAiplatformV1beta1CustomJobSpecResponse>('jobSpec', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return GoogleCloudAiplatformV1beta1CustomJobSpecResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
