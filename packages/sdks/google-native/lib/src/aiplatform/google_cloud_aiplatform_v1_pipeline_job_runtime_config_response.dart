...
class GoogleCloudAiplatformV1PipelineJobRuntimeConfigResponse {
  ...
  /// Creates a new [GoogleCloudAiplatformV1PipelineJobRuntimeConfigResponse].
  ...
  factory GoogleCloudAiplatformV1PipelineJobRuntimeConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1PipelineJobRuntimeConfigResponse(
      failurePolicy: pulumi.Input.fromValue(map['failurePolicy'] as String),
      gcsOutputDirectory: pulumi.Input.fromValue(map['gcsOutputDirectory'] as String),
      inputArtifacts: pulumi.Input.fromValue((map['inputArtifacts'] as Map).cast<String, String>()),
      parameterValues: pulumi.Input.fromValue((map['parameterValues'] as Map).cast<String, String>()),
