...
class GoogleCloudAiplatformV1beta1InputDataConfig {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1beta1PredefinedSplit>?
  predefinedSplit;
  ...
  final pulumi.Input<GoogleCloudAiplatformV1beta1StratifiedSplit>?
  stratifiedSplit;

  /// Supported only for tabular Datasets. Split based on the timestamp of the input data pieces.
  final pulumi.Input<GoogleCloudAiplatformV1beta1TimestampSplit>?
  timestampSplit;
    ...
    return <String, dynamic>{
      ...
      'filterSplit':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(filterSplit, (value) => value.toMap()),
      'fractionSplit':
          ?pulumi.Input.mapOptionalInputValue<
            GoogleCloudAiplatformV1beta1FractionSplit,
            Map<String, dynamic>
          >(fractionSplit, (value) => value.toMap()),
      'gcsDestination':
          ?pulumi.Input.mapOptionalInputValue<
            GoogleCloudAiplatformV1beta1GcsDestination,
            Map<String, dynamic>
          >(gcsDestination, (value) => value.toMap()),
      'persistMlUseAssignment': ?persistMlUseAssignment,
      'predefinedSplit':
          ?pulumi.Input.mapOptionalInputValue<
            GoogleCloudAiplatformV1beta1PredefinedSplit,
            Map<String, dynamic>
          >(predefinedSplit, (value) => value.toMap()),
      'savedQueryId': ?savedQueryId,
      'stratifiedSplit':
          ?pulumi.Input.mapOptionalInputValue<
            GoogleCloudAiplatformV1beta1StratifiedSplit,
            Map<String, dynamic>
          >(stratifiedSplit, (value) => value.toMap()),
      'timestampSplit':
          ?pulumi.Input.mapOptionalInputValue<
            GoogleCloudAiplatformV1beta1TimestampSplit,
            Map<String, dynamic>
          >(timestampSplit, (value) => value.toMap()),
    };
  }

  factory GoogleCloudAiplatformV1beta1InputDataConfig.fromMap(
    Map<String, dynamic> map,
  ) {
    return GoogleCloudAiplatformV1beta1InputDataConfig(
      annotationSchemaUri: (() {
        final guardedValue = map['annotationSchemaUri'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      annotationsFilter: (() {
        final guardedValue = map['annotationsFilter'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      bigqueryDestination: (() {
      ...
      filterSplit: (() {
        final guardedValue = map['filterSplit'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GoogleCloudAiplatformV1beta1FilterSplit.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      fractionSplit: (() {
        final guardedValue = map['fractionSplit'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GoogleCloudAiplatformV1beta1FractionSplit.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      gcsDestination: (() {
        final guardedValue = map['gcsDestination'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      persistMlUseAssignment: (() {
        final guardedValue = map['persistMlUseAssignment'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      predefinedSplit: (() {
        final guardedValue = map['predefinedSplit'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GoogleCloudAiplatformV1beta1PredefinedSplit.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      savedQueryId: (() {
        final guardedValue = map['savedQueryId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      stratifiedSplit: (() {
        final guardedValue = map['stratifiedSplit'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GoogleCloudAiplatformV1beta1StratifiedSplit.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      timestampSplit: (() {
        final guardedValue = map['timestampSplit'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GoogleCloudAiplatformV1beta1TimestampSplit.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
