...
class GoogleCloudAiplatformV1FeatureOnlineStoreBigtableAutoScalingResponse {
  ...
  const GoogleCloudAiplatformV1FeatureOnlineStoreBigtableAutoScalingResponse({
  ...
  factory GoogleCloudAiplatformV1FeatureOnlineStoreBigtableAutoScalingResponse.fromMap(Map<String, dynamic> map) {
