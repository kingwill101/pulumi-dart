...
class GoogleCloudAiplatformV1beta1ModelMonitoringAlertConfigResponse {
  /// Email alert config.
  final pulumi.Input<GoogleCloudAiplatformV1beta1ModelMonitoringAlertConfigEmailAlertConfigResponse> emailAlertConfig;
  ...
  const GoogleCloudAiplatformV1beta1ModelMonitoringAlertConfigResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'emailAlertConfig': pulumi.Input.mapInputValue<GoogleCloudAiplatformV1beta1ModelMonitoringAlertConfigEmailAlertConfigResponse, Map<String, dynamic>>(emailAlertConfig, (value) => value.toMap()),
  ...
  factory GoogleCloudAiplatformV1beta1ModelMonitoringAlertConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1ModelMonitoringAlertConfigResponse(
      emailAlertConfig: pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1ModelMonitoringAlertConfigEmailAlertConfigResponse.fromMap((map['emailAlertConfig']! as Map).cast<String, dynamic>())),
      enableLogging: pulumi.Input.fromValue(map['enableLogging'] as bool),
      notificationChannels: pulumi.Input.fromValue((map['notificationChannels'] as List).cast<String>()),
    );
  }
}
