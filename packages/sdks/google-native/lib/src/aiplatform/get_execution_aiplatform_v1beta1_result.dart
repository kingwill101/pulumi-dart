...
class GetExecutionAiplatformV1beta1Result {
  ...
  /// Creates a new [GetExecutionAiplatformV1beta1Result].
  ...
  const GetExecutionAiplatformV1beta1Result({
  ...
  factory GetExecutionAiplatformV1beta1Result.fromMap(Map<String, dynamic> map) {
