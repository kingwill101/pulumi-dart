...
class FeatureStoreFeatureAiplatformV1beta1Args {
  ...
  const FeatureStoreFeatureAiplatformV1beta1Args({
    this.description,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'project': ?project,
      'valueType': ?pulumi.Input.mapOptionalInputValue<FeatureStoreFeatureValueTypeAiplatformV1beta1, String>(valueType, (value) => value.wireValue),
  ...
  factory FeatureStoreFeatureAiplatformV1beta1Args.fromMap(Map<String, dynamic> map) {
    return FeatureStoreFeatureAiplatformV1beta1Args(
      ...
      valueType: (() { final guardedValue = map['valueType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FeatureStoreFeatureValueTypeAiplatformV1beta1.fromValue(guardedValue as String)); })(),
