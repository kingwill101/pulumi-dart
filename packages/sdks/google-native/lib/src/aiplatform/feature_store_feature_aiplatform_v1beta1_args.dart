...
class FeatureStoreFeatureAiplatformV1beta1Args {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1beta1FeaturestoreMonitoringConfig>?
  monitoringConfig;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'valueType':
          ?pulumi.Input.mapOptionalInputValue<
            FeatureStoreFeatureValueTypeAiplatformV1beta1,
            String
  ...
  factory FeatureStoreFeatureAiplatformV1beta1Args.fromMap(
    ...
    return FeatureStoreFeatureAiplatformV1beta1Args(
      ...
      disableMonitoring: (() {
        final guardedValue = map['disableMonitoring'];
        if (guardedValue == null) return null;
      ...
      monitoringConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GoogleCloudAiplatformV1beta1FeaturestoreMonitoringConfig.fromMap(
      ...
      valueType: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FeatureStoreFeatureValueTypeAiplatformV1beta1.fromValue(
