...
class GoogleCloudAiplatformV1CustomJobSpecResponse {
  ...
  factory GoogleCloudAiplatformV1CustomJobSpecResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1CustomJobSpecResponse(
      baseOutputDirectory: pulumi.Input.fromValue(GoogleCloudAiplatformV1GcsDestinationResponse.fromMap((map['baseOutputDirectory']! as Map).cast<String, dynamic>())),
      enableDashboardAccess: pulumi.Input.fromValue(map['enableDashboardAccess'] as bool),
      ...
      protectedArtifactLocationId: pulumi.Input.fromValue(map['protectedArtifactLocationId'] as String),
      reservedIpRanges: pulumi.Input.fromValue((map['reservedIpRanges'] as List).cast<String>()),
      scheduling: pulumi.Input.fromValue(GoogleCloudAiplatformV1SchedulingResponse.fromMap((map['scheduling']! as Map).cast<String, dynamic>())),
      serviceAccount: pulumi.Input.fromValue(map['serviceAccount'] as String),
      tensorboard: pulumi.Input.fromValue(map['tensorboard'] as String),
      workerPoolSpecs: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudAiplatformV1WorkerPoolSpecResponse>(map['workerPoolSpecs']!, (value) => GoogleCloudAiplatformV1WorkerPoolSpecResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
