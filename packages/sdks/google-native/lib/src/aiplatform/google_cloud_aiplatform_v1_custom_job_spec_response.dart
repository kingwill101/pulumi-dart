...
import 'google_cloud_aiplatform_v1_scheduling_response.dart';
import 'google_cloud_aiplatform_v1_worker_pool_spec_response.dart';

/// Represents the spec of a CustomJob.
class GoogleCloudAiplatformV1CustomJobSpecResponse {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1GcsDestinationResponse> baseOutputDirectory;
  ...
  final pulumi.Input<GoogleCloudAiplatformV1SchedulingResponse> scheduling;
  ...
  final pulumi.Input<List<GoogleCloudAiplatformV1WorkerPoolSpecResponse>> workerPoolSpecs;

  /// Creates a new [GoogleCloudAiplatformV1CustomJobSpecResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'baseOutputDirectory': pulumi.Input.mapInputValue<GoogleCloudAiplatformV1GcsDestinationResponse, Map<String, dynamic>>(baseOutputDirectory, (value) => value.toMap()),
      ...
      'scheduling': pulumi.Input.mapInputValue<GoogleCloudAiplatformV1SchedulingResponse, Map<String, dynamic>>(scheduling, (value) => value.toMap()),
      'serviceAccount': serviceAccount,
      'tensorboard': tensorboard,
      'workerPoolSpecs': pulumi.Input.mapInputValue<List<GoogleCloudAiplatformV1WorkerPoolSpecResponse>, List<Map<String, dynamic>>>(workerPoolSpecs, (value) => pulumi.Input.encodeList<GoogleCloudAiplatformV1WorkerPoolSpecResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory GoogleCloudAiplatformV1CustomJobSpecResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1CustomJobSpecResponse(
      baseOutputDirectory: (GoogleCloudAiplatformV1GcsDestinationResponse.fromMap((map['baseOutputDirectory'] as Map).cast<String, dynamic>())).input(),
      enableDashboardAccess: (map['enableDashboardAccess'] as bool).input(),
      enableWebAccess: (map['enableWebAccess'] as bool).input(),
      experiment: (map['experiment'] as String).input(),
      experimentRun: (map['experimentRun'] as String).input(),
      network: (map['network'] as String).input(),
      protectedArtifactLocationId: (map['protectedArtifactLocationId'] as String).input(),
      reservedIpRanges: ((map['reservedIpRanges'] as List).cast<String>()).input(),
      scheduling: (GoogleCloudAiplatformV1SchedulingResponse.fromMap((map['scheduling'] as Map).cast<String, dynamic>())).input(),
      serviceAccount: (map['serviceAccount'] as String).input(),
      tensorboard: (map['tensorboard'] as String).input(),
      workerPoolSpecs: (pulumi.Input.decodeList<GoogleCloudAiplatformV1WorkerPoolSpecResponse>(map['workerPoolSpecs'], (value) => GoogleCloudAiplatformV1WorkerPoolSpecResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
