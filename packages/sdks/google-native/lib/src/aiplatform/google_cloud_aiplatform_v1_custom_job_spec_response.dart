...
class GoogleCloudAiplatformV1CustomJobSpecResponse {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1GcsDestinationResponse>
  baseOutputDirectory;
  ...
  final pulumi.Input<List<GoogleCloudAiplatformV1WorkerPoolSpecResponse>>
  workerPoolSpecs;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'workerPoolSpecs':
          pulumi.Input.mapInputValue<
            List<GoogleCloudAiplatformV1WorkerPoolSpecResponse>,
  ...
  factory GoogleCloudAiplatformV1CustomJobSpecResponse.fromMap(
    ...
    return GoogleCloudAiplatformV1CustomJobSpecResponse(
      ...
      scheduling: pulumi.Input.fromValue(
        GoogleCloudAiplatformV1SchedulingResponse.fromMap(
      ...
      workerPoolSpecs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GoogleCloudAiplatformV1WorkerPoolSpecResponse>(
          map['workerPoolSpecs']!,
