...
class GoogleCloudAiplatformV1CustomJobSpecResponse {
  ...
  final GoogleCloudAiplatformV1GcsDestinationResponse baseOutputDirectory;
  ...
  final GoogleCloudAiplatformV1SchedulingResponse scheduling;
  ...
  final List<GoogleCloudAiplatformV1WorkerPoolSpecResponse> workerPoolSpecs;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'baseOutputDirectory': baseOutputDirectory.toMap(),
      ...
      'workerPoolSpecs': pulumi.Input.encodeList<GoogleCloudAiplatformV1WorkerPoolSpecResponse, Map<String, dynamic>>(workerPoolSpecs, (value) => value.toMap()),
    };
  }
  ...
  factory GoogleCloudAiplatformV1CustomJobSpecResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1CustomJobSpecResponse(
      baseOutputDirectory: GoogleCloudAiplatformV1GcsDestinationResponse.fromMap((map['baseOutputDirectory'] as Map).cast<String, dynamic>()),
      ...
      scheduling: GoogleCloudAiplatformV1SchedulingResponse.fromMap((map['scheduling'] as Map).cast<String, dynamic>()),
      serviceAccount: map['serviceAccount'] as String,
      tensorboard: map['tensorboard'] as String,
      workerPoolSpecs: pulumi.Input.decodeList<GoogleCloudAiplatformV1WorkerPoolSpecResponse>(map['workerPoolSpecs'], (value) => GoogleCloudAiplatformV1WorkerPoolSpecResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
