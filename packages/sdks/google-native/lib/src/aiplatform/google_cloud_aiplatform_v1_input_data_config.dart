...
class GoogleCloudAiplatformV1InputDataConfig {
  ...
  const GoogleCloudAiplatformV1InputDataConfig({
  ...
  factory GoogleCloudAiplatformV1InputDataConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1InputDataConfig(
      ...
      bigqueryDestination: (() { final guardedValue = map['bigqueryDestination']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1BigQueryDestination.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      datasetId: pulumi.Input.fromValue(map['datasetId'] as String),
      filterSplit: (() { final guardedValue = map['filterSplit']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1FilterSplit.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      fractionSplit: (() { final guardedValue = map['fractionSplit']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1FractionSplit.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      gcsDestination: (() { final guardedValue = map['gcsDestination']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1GcsDestination.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      predefinedSplit: (() { final guardedValue = map['predefinedSplit']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1PredefinedSplit.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      stratifiedSplit: (() { final guardedValue = map['stratifiedSplit']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1StratifiedSplit.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      timestampSplit: (() { final guardedValue = map['timestampSplit']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1TimestampSplit.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
