...
class GoogleCloudAiplatformV1FeatureGroupBigQuery {
  ...
  const GoogleCloudAiplatformV1FeatureGroupBigQuery({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'bigQuerySource': pulumi.Input.mapInputValue<GoogleCloudAiplatformV1BigQuerySource, Map<String, dynamic>>(bigQuerySource, (value) => value.toMap()),
      'entityIdColumns': ?entityIdColumns,
    };
  }

  factory GoogleCloudAiplatformV1FeatureGroupBigQuery.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1FeatureGroupBigQuery(
      bigQuerySource: pulumi.Input.fromValue(GoogleCloudAiplatformV1BigQuerySource.fromMap((map['bigQuerySource']! as Map).cast<String, dynamic>())),
