...
class GoogleCloudAiplatformV1beta1SampleConfig {
  ...
  const GoogleCloudAiplatformV1beta1SampleConfig({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'sampleStrategy': ?pulumi.Input.mapOptionalInputValue<GoogleCloudAiplatformV1beta1SampleConfigSampleStrategy, String>(sampleStrategy, (value) => value.wireValue),
    };
  }
  ...
  factory GoogleCloudAiplatformV1beta1SampleConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1SampleConfig(
      ...
      sampleStrategy: (() { final guardedValue = map['sampleStrategy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1SampleConfigSampleStrategy.fromValue(guardedValue as String)); })(),
    );
  }
}
