...
class Schedule extends pulumi.CustomResource {
  ...
  late final pulumi.Output<GoogleCloudAiplatformV1CreatePipelineJobRequestResponse> createPipelineJobRequest;
  ...
  late final pulumi.Output<GoogleCloudAiplatformV1ScheduleRunResponseResponse> lastScheduledRunResponse;
  ...
  Schedule(
    ...
    createPipelineJobRequest = registerOutput<GoogleCloudAiplatformV1CreatePipelineJobRequestResponse>('createPipelineJobRequest', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return GoogleCloudAiplatformV1CreatePipelineJobRequestResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    lastScheduledRunResponse = registerOutput<GoogleCloudAiplatformV1ScheduleRunResponseResponse>('lastScheduledRunResponse', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return GoogleCloudAiplatformV1ScheduleRunResponseResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
