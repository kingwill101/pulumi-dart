...
class GoogleCloudAiplatformV1ModelResponse {
  ...
  factory GoogleCloudAiplatformV1ModelResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1ModelResponse(
      ...
      deployedModels: (pulumi.Input.decodeList<GoogleCloudAiplatformV1DeployedModelRefResponse>(map['deployedModels'], (value) => GoogleCloudAiplatformV1DeployedModelRefResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      explanationSpec: (GoogleCloudAiplatformV1ExplanationSpecResponse.fromMap((map['explanationSpec'] as Map).cast<String, dynamic>())).input(),
      ...
      modelSourceInfo: (GoogleCloudAiplatformV1ModelSourceInfoResponse.fromMap((map['modelSourceInfo'] as Map).cast<String, dynamic>())).input(),
      name: (map['name'] as String).input(),
      originalModelInfo: (GoogleCloudAiplatformV1ModelOriginalModelInfoResponse.fromMap((map['originalModelInfo'] as Map).cast<String, dynamic>())).input(),
      pipelineJob: (map['pipelineJob'] as String).input(),
      ...
      supportedExportFormats: (pulumi.Input.decodeList<GoogleCloudAiplatformV1ModelExportFormatResponse>(map['supportedExportFormats'], (value) => GoogleCloudAiplatformV1ModelExportFormatResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
