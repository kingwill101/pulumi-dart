...
class GoogleCloudAiplatformV1ModelResponse {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1ModelContainerSpecResponse>
  containerSpec;
  ...
  final pulumi.Input<List<GoogleCloudAiplatformV1DeployedModelRefResponse>>
  deployedModels;
  ...
  final pulumi.Input<GoogleCloudAiplatformV1EncryptionSpecResponse>
  encryptionSpec;
  ...
  final pulumi.Input<GoogleCloudAiplatformV1ExplanationSpecResponse>
  explanationSpec;
  ...
  final pulumi.Input<GoogleCloudAiplatformV1ModelSourceInfoResponse>
  modelSourceInfo;
  ...
  final pulumi.Input<GoogleCloudAiplatformV1ModelOriginalModelInfoResponse>
  originalModelInfo;
  ...
  final pulumi.Input<GoogleCloudAiplatformV1PredictSchemataResponse>
  predictSchemata;
  ...
  final pulumi.Input<List<GoogleCloudAiplatformV1ModelExportFormatResponse>>
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'deployedModels':
          pulumi.Input.mapInputValue<
            List<GoogleCloudAiplatformV1DeployedModelRefResponse>,
      ...
      'supportedExportFormats':
          pulumi.Input.mapInputValue<
            List<GoogleCloudAiplatformV1ModelExportFormatResponse>,
            List<Map<String, dynamic>>
          >(
            supportedExportFormats,
            (value) =>
  ...
  factory GoogleCloudAiplatformV1ModelResponse.fromMap(
    ...
    return GoogleCloudAiplatformV1ModelResponse(
      ...
      containerSpec: pulumi.Input.fromValue(
        GoogleCloudAiplatformV1ModelContainerSpecResponse.fromMap(
      ...
      deployedModels: pulumi.Input.fromValue(
        pulumi
            .Input.decodeList<GoogleCloudAiplatformV1DeployedModelRefResponse>(
          map['deployedModels']!,
          (value) => GoogleCloudAiplatformV1DeployedModelRefResponse.fromMap(
      ...
      encryptionSpec: pulumi.Input.fromValue(
        GoogleCloudAiplatformV1EncryptionSpecResponse.fromMap(
          (map['encryptionSpec']! as Map).cast<String, dynamic>(),
        ),
      ),
      etag: pulumi.Input.fromValue(map['etag'] as String),
      explanationSpec: pulumi.Input.fromValue(
        GoogleCloudAiplatformV1ExplanationSpecResponse.fromMap(
      ...
      modelSourceInfo: pulumi.Input.fromValue(
        GoogleCloudAiplatformV1ModelSourceInfoResponse.fromMap(
          (map['modelSourceInfo']! as Map).cast<String, dynamic>(),
        ),
      ),
      name: pulumi.Input.fromValue(map['name'] as String),
      originalModelInfo: pulumi.Input.fromValue(
        GoogleCloudAiplatformV1ModelOriginalModelInfoResponse.fromMap(
      ...
      predictSchemata: pulumi.Input.fromValue(
        GoogleCloudAiplatformV1PredictSchemataResponse.fromMap(
      ...
      supportedExportFormats: pulumi.Input.fromValue(
        pulumi
            .Input.decodeList<GoogleCloudAiplatformV1ModelExportFormatResponse>(
          map['supportedExportFormats']!,
          (value) => GoogleCloudAiplatformV1ModelExportFormatResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
