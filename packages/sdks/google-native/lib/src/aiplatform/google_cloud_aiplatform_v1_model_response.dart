...
class GoogleCloudAiplatformV1ModelResponse {
  ...
  final List<GoogleCloudAiplatformV1DeployedModelRefResponse> deployedModels;
  ...
  final GoogleCloudAiplatformV1ModelSourceInfoResponse modelSourceInfo;
  /// The resource name of the Model.
  final String name;
  /// If this Model is a copy of another Model, this contains info about the original.
  final GoogleCloudAiplatformV1ModelOriginalModelInfoResponse originalModelInfo;
  ...
  final List<GoogleCloudAiplatformV1ModelExportFormatResponse> supportedExportFormats;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'deployedModels': pulumi.Input.encodeList<GoogleCloudAiplatformV1DeployedModelRefResponse, Map<String, dynamic>>(deployedModels, (value) => value.toMap()),
      ...
      'supportedExportFormats': pulumi.Input.encodeList<GoogleCloudAiplatformV1ModelExportFormatResponse, Map<String, dynamic>>(supportedExportFormats, (value) => value.toMap()),
  ...
  factory GoogleCloudAiplatformV1ModelResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1ModelResponse(
      ...
      deployedModels: pulumi.Input.decodeList<GoogleCloudAiplatformV1DeployedModelRefResponse>(map['deployedModels'], (value) => GoogleCloudAiplatformV1DeployedModelRefResponse.fromMap((value as Map).cast<String, dynamic>())),
      ...
      modelSourceInfo: GoogleCloudAiplatformV1ModelSourceInfoResponse.fromMap((map['modelSourceInfo'] as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      originalModelInfo: GoogleCloudAiplatformV1ModelOriginalModelInfoResponse.fromMap((map['originalModelInfo'] as Map).cast<String, dynamic>()),
      pipelineJob: map['pipelineJob'] as String,
      ...
      supportedExportFormats: pulumi.Input.decodeList<GoogleCloudAiplatformV1ModelExportFormatResponse>(map['supportedExportFormats'], (value) => GoogleCloudAiplatformV1ModelExportFormatResponse.fromMap((value as Map).cast<String, dynamic>())),
