...
class NasJobAiplatformV1beta1 extends pulumi.CustomResource {
  ...
  NasJobAiplatformV1beta1(
    ...
    this.nasJobOutput = registerOutput<GoogleCloudAiplatformV1beta1NasJobOutputResponse>('nasJobOutput');
    this.nasJobSpec = registerOutput<GoogleCloudAiplatformV1beta1NasJobSpecResponse>('nasJobSpec');
