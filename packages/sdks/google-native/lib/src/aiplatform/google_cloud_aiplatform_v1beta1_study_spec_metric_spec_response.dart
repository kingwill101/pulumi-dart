...
class GoogleCloudAiplatformV1beta1StudySpecMetricSpecResponse {
  ...
  final GoogleCloudAiplatformV1beta1StudySpecMetricSpecSafetyMetricConfigResponse safetyConfig;
  ...
  factory GoogleCloudAiplatformV1beta1StudySpecMetricSpecResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1StudySpecMetricSpecResponse(
      ...
      safetyConfig: GoogleCloudAiplatformV1beta1StudySpecMetricSpecSafetyMetricConfigResponse.fromMap((map['safetyConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
