...
class GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpecResponse {
  ...
  factory GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpecResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpecResponse(
      metric: pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpecMetricSpecResponse.fromMap((map['metric']! as Map).cast<String, dynamic>())),
      multiTrialAlgorithm: pulumi.Input.fromValue(map['multiTrialAlgorithm'] as String),
      searchTrialSpec: pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpecSearchTrialSpecResponse.fromMap((map['searchTrialSpec']! as Map).cast<String, dynamic>())),
      trainTrialSpec: pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpecTrainTrialSpecResponse.fromMap((map['trainTrialSpec']! as Map).cast<String, dynamic>())),
    );
  }
}
