...
class TrainingPipelineAiplatformV1beta1Args {
  ...
  TrainingPipelineAiplatformV1beta1Args({
    ...
    pulumi.Output<GoogleCloudAiplatformV1beta1InputDataConfig>? inputDataConfig,
    pulumi.Output<Map<String, String>>? labels,
    pulumi.Output<String>? location,
    pulumi.Output<String>? modelId,
    pulumi.Output<GoogleCloudAiplatformV1beta1Model>? modelToUpload,
    ...
    required pulumi.Output<dynamic> trainingTaskInputs,
      ...
      inputDataConfig = pulumi.Input.asOptionalInput<GoogleCloudAiplatformV1beta1InputDataConfig>(inputDataConfig),
      labels = pulumi.Input.asOptionalInput<Map<String, String>>(labels),
      location = pulumi.Input.asOptionalInput<String>(location),
      modelId = pulumi.Input.asOptionalInput<String>(modelId),
      modelToUpload = pulumi.Input.asOptionalInput<GoogleCloudAiplatformV1beta1Model>(modelToUpload),
  ...
  factory TrainingPipelineAiplatformV1beta1Args.fromMap(Map<String, dynamic> map) {
    return TrainingPipelineAiplatformV1beta1Args(
      ...
      inputDataConfig: map['inputDataConfig'] == null ? null : pulumi.Output.create<GoogleCloudAiplatformV1beta1InputDataConfig>(GoogleCloudAiplatformV1beta1InputDataConfig.fromMap((map['inputDataConfig'] as Map).cast<String, dynamic>())),
      labels: map['labels'] == null ? null : pulumi.Output.create<Map<String, String>>((map['labels'] as Map).cast<String, String>()),
      location: map['location'] == null ? null : pulumi.Output.create<String>(map['location'] as String),
      modelId: map['modelId'] == null ? null : pulumi.Output.create<String>(map['modelId'] as String),
      modelToUpload: map['modelToUpload'] == null ? null : pulumi.Output.create<GoogleCloudAiplatformV1beta1Model>(GoogleCloudAiplatformV1beta1Model.fromMap((map['modelToUpload'] as Map).cast<String, dynamic>())),
