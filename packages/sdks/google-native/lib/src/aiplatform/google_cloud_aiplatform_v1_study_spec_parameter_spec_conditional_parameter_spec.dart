...
class GoogleCloudAiplatformV1StudySpecParameterSpecConditionalParameterSpec {
  ...
  const GoogleCloudAiplatformV1StudySpecParameterSpecConditionalParameterSpec({
  ...
  factory GoogleCloudAiplatformV1StudySpecParameterSpecConditionalParameterSpec.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1StudySpecParameterSpecConditionalParameterSpec(
      parameterSpec: pulumi.Input.fromValue(GoogleCloudAiplatformV1StudySpecParameterSpec.fromMap((map['parameterSpec']! as Map).cast<String, dynamic>())),
      parentCategoricalValues: (() { final guardedValue = map['parentCategoricalValues']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1StudySpecParameterSpecConditionalParameterSpecCategoricalValueCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      parentDiscreteValues: (() { final guardedValue = map['parentDiscreteValues']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1StudySpecParameterSpecConditionalParameterSpecDiscreteValueCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      parentIntValues: (() { final guardedValue = map['parentIntValues']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1StudySpecParameterSpecConditionalParameterSpecIntValueCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
