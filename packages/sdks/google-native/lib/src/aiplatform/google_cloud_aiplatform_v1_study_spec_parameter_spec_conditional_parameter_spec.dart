...
class GoogleCloudAiplatformV1StudySpecParameterSpecConditionalParameterSpec {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1StudySpecParameterSpec>
  parameterSpec;
  ...
  factory GoogleCloudAiplatformV1StudySpecParameterSpecConditionalParameterSpec.fromMap(
    ...
    return GoogleCloudAiplatformV1StudySpecParameterSpecConditionalParameterSpec(
      parameterSpec: pulumi.Input.fromValue(
        GoogleCloudAiplatformV1StudySpecParameterSpec.fromMap(
      ...
      parentCategoricalValues: (() {
        ...
        return pulumi.Input.fromValue(
          GoogleCloudAiplatformV1StudySpecParameterSpecConditionalParameterSpecCategoricalValueCondition.fromMap(
      ...
      parentDiscreteValues: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GoogleCloudAiplatformV1StudySpecParameterSpecConditionalParameterSpecDiscreteValueCondition.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      parentIntValues: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GoogleCloudAiplatformV1StudySpecParameterSpecConditionalParameterSpecIntValueCondition.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
