...
class GoogleCloudAiplatformV1InputDataConfigResponse {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1FractionSplitResponse>
  fractionSplit;
  ...
  final pulumi.Input<GoogleCloudAiplatformV1PredefinedSplitResponse>
  predefinedSplit;
  ...
  final pulumi.Input<GoogleCloudAiplatformV1StratifiedSplitResponse>
  stratifiedSplit;

  /// Supported only for tabular Datasets. Split based on the timestamp of the input data pieces.
  final pulumi.Input<GoogleCloudAiplatformV1TimestampSplitResponse>
  timestampSplit;
  ...
  factory GoogleCloudAiplatformV1InputDataConfigResponse.fromMap(
    ...
    return GoogleCloudAiplatformV1InputDataConfigResponse(
      annotationSchemaUri: pulumi.Input.fromValue(
        map['annotationSchemaUri'] as String,
      ),
      annotationsFilter: pulumi.Input.fromValue(
      ...
      filterSplit: pulumi.Input.fromValue(
        GoogleCloudAiplatformV1FilterSplitResponse.fromMap(
          (map['filterSplit']! as Map).cast<String, dynamic>(),
        ),
      ),
      fractionSplit: pulumi.Input.fromValue(
        GoogleCloudAiplatformV1FractionSplitResponse.fromMap(
      ...
      persistMlUseAssignment: pulumi.Input.fromValue(
        map['persistMlUseAssignment'] as bool,
      ),
      predefinedSplit: pulumi.Input.fromValue(
        GoogleCloudAiplatformV1PredefinedSplitResponse.fromMap(
          (map['predefinedSplit']! as Map).cast<String, dynamic>(),
        ),
      ),
      savedQueryId: pulumi.Input.fromValue(map['savedQueryId'] as String),
      stratifiedSplit: pulumi.Input.fromValue(
        GoogleCloudAiplatformV1StratifiedSplitResponse.fromMap(
          (map['stratifiedSplit']! as Map).cast<String, dynamic>(),
        ),
      ),
      timestampSplit: pulumi.Input.fromValue(
        GoogleCloudAiplatformV1TimestampSplitResponse.fromMap(
