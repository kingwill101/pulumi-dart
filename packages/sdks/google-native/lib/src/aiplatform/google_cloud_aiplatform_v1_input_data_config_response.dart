...
class GoogleCloudAiplatformV1InputDataConfigResponse {
  ...
  factory GoogleCloudAiplatformV1InputDataConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1InputDataConfigResponse(
      ...
      filterSplit: GoogleCloudAiplatformV1FilterSplitResponse.fromMap((map['filterSplit'] as Map).cast<String, dynamic>()),
      fractionSplit: GoogleCloudAiplatformV1FractionSplitResponse.fromMap((map['fractionSplit'] as Map).cast<String, dynamic>()),
      gcsDestination: GoogleCloudAiplatformV1GcsDestinationResponse.fromMap((map['gcsDestination'] as Map).cast<String, dynamic>()),
      persistMlUseAssignment: map['persistMlUseAssignment'] as bool,
      predefinedSplit: GoogleCloudAiplatformV1PredefinedSplitResponse.fromMap((map['predefinedSplit'] as Map).cast<String, dynamic>()),
      savedQueryId: map['savedQueryId'] as String,
      stratifiedSplit: GoogleCloudAiplatformV1StratifiedSplitResponse.fromMap((map['stratifiedSplit'] as Map).cast<String, dynamic>()),
      timestampSplit: GoogleCloudAiplatformV1TimestampSplitResponse.fromMap((map['timestampSplit'] as Map).cast<String, dynamic>()),
    );
  }
}
