...
class GoogleCloudAiplatformV1InputDataConfigResponse {
  ...
  factory GoogleCloudAiplatformV1InputDataConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1InputDataConfigResponse(
      ...
      bigqueryDestination: (GoogleCloudAiplatformV1BigQueryDestinationResponse.fromMap((map['bigqueryDestination'] as Map).cast<String, dynamic>())).input(),
      datasetId: (map['datasetId'] as String).input(),
      filterSplit: (GoogleCloudAiplatformV1FilterSplitResponse.fromMap((map['filterSplit'] as Map).cast<String, dynamic>())).input(),
      fractionSplit: (GoogleCloudAiplatformV1FractionSplitResponse.fromMap((map['fractionSplit'] as Map).cast<String, dynamic>())).input(),
      gcsDestination: (GoogleCloudAiplatformV1GcsDestinationResponse.fromMap((map['gcsDestination'] as Map).cast<String, dynamic>())).input(),
      persistMlUseAssignment: (map['persistMlUseAssignment'] as bool).input(),
      predefinedSplit: (GoogleCloudAiplatformV1PredefinedSplitResponse.fromMap((map['predefinedSplit'] as Map).cast<String, dynamic>())).input(),
      savedQueryId: (map['savedQueryId'] as String).input(),
      stratifiedSplit: (GoogleCloudAiplatformV1StratifiedSplitResponse.fromMap((map['stratifiedSplit'] as Map).cast<String, dynamic>())).input(),
      timestampSplit: (GoogleCloudAiplatformV1TimestampSplitResponse.fromMap((map['timestampSplit'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
