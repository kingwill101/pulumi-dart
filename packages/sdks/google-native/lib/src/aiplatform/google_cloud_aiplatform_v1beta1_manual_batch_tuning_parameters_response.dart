...
class GoogleCloudAiplatformV1beta1ManualBatchTuningParametersResponse {
  ...
  const GoogleCloudAiplatformV1beta1ManualBatchTuningParametersResponse({
  ...
  factory GoogleCloudAiplatformV1beta1ManualBatchTuningParametersResponse.fromMap(Map<String, dynamic> map) {
