...
class Endpoint extends pulumi.CustomResource {
  ...
  Endpoint(
    ...
    predictRequestResponseLoggingConfig = registerOutput<GoogleCloudAiplatformV1PredictRequestResponseLoggingConfigResponse>('predictRequestResponseLoggingConfig', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return GoogleCloudAiplatformV1PredictRequestResponseLoggingConfigResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
