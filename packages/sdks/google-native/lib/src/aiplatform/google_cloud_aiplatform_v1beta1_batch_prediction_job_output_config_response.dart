...
class GoogleCloudAiplatformV1beta1BatchPredictionJobOutputConfigResponse {
  ...
  factory GoogleCloudAiplatformV1beta1BatchPredictionJobOutputConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1BatchPredictionJobOutputConfigResponse(
      bigqueryDestination: (GoogleCloudAiplatformV1beta1BigQueryDestinationResponse.fromMap((map['bigqueryDestination'] as Map).cast<String, dynamic>())).input(),
      gcsDestination: (GoogleCloudAiplatformV1beta1GcsDestinationResponse.fromMap((map['gcsDestination'] as Map).cast<String, dynamic>())).input(),
      predictionsFormat: (map['predictionsFormat'] as String).input(),
    );
  }
}
