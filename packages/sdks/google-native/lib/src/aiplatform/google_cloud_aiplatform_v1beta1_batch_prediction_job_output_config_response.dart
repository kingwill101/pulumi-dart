...
class GoogleCloudAiplatformV1beta1BatchPredictionJobOutputConfigResponse {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1beta1BigQueryDestinationResponse> bigqueryDestination;
  ...
  final pulumi.Input<GoogleCloudAiplatformV1beta1GcsDestinationResponse> gcsDestination;
  /// The format in which Vertex AI gives the predictions, must be one of the Model's supported_output_storage_formats.
  final pulumi.Input<String> predictionsFormat;

  /// Creates a new [GoogleCloudAiplatformV1beta1BatchPredictionJobOutputConfigResponse].
  ...
  const GoogleCloudAiplatformV1beta1BatchPredictionJobOutputConfigResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'bigqueryDestination': pulumi.Input.mapInputValue<GoogleCloudAiplatformV1beta1BigQueryDestinationResponse, Map<String, dynamic>>(bigqueryDestination, (value) => value.toMap()),
      'gcsDestination': pulumi.Input.mapInputValue<GoogleCloudAiplatformV1beta1GcsDestinationResponse, Map<String, dynamic>>(gcsDestination, (value) => value.toMap()),
      'predictionsFormat': predictionsFormat,
    };
  }

  factory GoogleCloudAiplatformV1beta1BatchPredictionJobOutputConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1BatchPredictionJobOutputConfigResponse(
      bigqueryDestination: pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1BigQueryDestinationResponse.fromMap((map['bigqueryDestination']! as Map).cast<String, dynamic>())),
      gcsDestination: pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1GcsDestinationResponse.fromMap((map['gcsDestination']! as Map).cast<String, dynamic>())),
      predictionsFormat: pulumi.Input.fromValue(map['predictionsFormat'] as String),
    );
  }
}
