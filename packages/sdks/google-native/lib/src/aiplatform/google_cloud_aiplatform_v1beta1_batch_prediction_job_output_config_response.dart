...
class GoogleCloudAiplatformV1beta1BatchPredictionJobOutputConfigResponse {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1beta1BigQueryDestinationResponse>
  bigqueryDestination;
  ...
  factory GoogleCloudAiplatformV1beta1BatchPredictionJobOutputConfigResponse.fromMap(
    ...
    return GoogleCloudAiplatformV1beta1BatchPredictionJobOutputConfigResponse(
      ...
      gcsDestination: pulumi.Input.fromValue(
        GoogleCloudAiplatformV1beta1GcsDestinationResponse.fromMap(
          (map['gcsDestination']! as Map).cast<String, dynamic>(),
        ),
      ),
      predictionsFormat: pulumi.Input.fromValue(
        map['predictionsFormat'] as String,
      ),
    );
  }
}
