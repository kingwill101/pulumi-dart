...
class GoogleCloudAiplatformV1FeatureStatsAnomalyResponse {
  ...
  /// Creates a new [GoogleCloudAiplatformV1FeatureStatsAnomalyResponse].
  ...
  const GoogleCloudAiplatformV1FeatureStatsAnomalyResponse({
  ...
  factory GoogleCloudAiplatformV1FeatureStatsAnomalyResponse.fromMap(Map<String, dynamic> map) {
