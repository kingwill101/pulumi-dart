...
class GoogleCloudAiplatformV1beta1ExplanationParameters {
  ...
  final GoogleCloudAiplatformV1beta1IntegratedGradientsAttribution? integratedGradientsAttribution;
  ...
  final GoogleCloudAiplatformV1beta1SampledShapleyAttribution? sampledShapleyAttribution;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'examples': ?examples == null ? null : examples!.toMap(),
      'integratedGradientsAttribution': ?integratedGradientsAttribution == null ? null : integratedGradientsAttribution!.toMap(),
      'outputIndices': ?outputIndices,
      'sampledShapleyAttribution': ?sampledShapleyAttribution == null ? null : sampledShapleyAttribution!.toMap(),
      'topK': ?topK,
      'xraiAttribution': ?xraiAttribution == null ? null : xraiAttribution!.toMap(),
    };
  }
  ...
  factory GoogleCloudAiplatformV1beta1ExplanationParameters.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1ExplanationParameters(
      examples: map['examples'] == null ? null : GoogleCloudAiplatformV1beta1Examples.fromMap((map['examples'] as Map).cast<String, dynamic>()),
      integratedGradientsAttribution: map['integratedGradientsAttribution'] == null ? null : GoogleCloudAiplatformV1beta1IntegratedGradientsAttribution.fromMap((map['integratedGradientsAttribution'] as Map).cast<String, dynamic>()),
      outputIndices: map['outputIndices'] == null ? null : (map['outputIndices'] as List).cast<dynamic>(),
      sampledShapleyAttribution: map['sampledShapleyAttribution'] == null ? null : GoogleCloudAiplatformV1beta1SampledShapleyAttribution.fromMap((map['sampledShapleyAttribution'] as Map).cast<String, dynamic>()),
      topK: map['topK'] == null ? null : map['topK'] as int,
      xraiAttribution: map['xraiAttribution'] == null ? null : GoogleCloudAiplatformV1beta1XraiAttribution.fromMap((map['xraiAttribution'] as Map).cast<String, dynamic>()),
    );
  }
}
