...
class GoogleCloudAiplatformV1beta1ExplanationParameters {
  ...
  const GoogleCloudAiplatformV1beta1ExplanationParameters({
    this.examples,
  ...
  factory GoogleCloudAiplatformV1beta1ExplanationParameters.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1ExplanationParameters(
      examples: (() { final guardedValue = map['examples']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1Examples.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      integratedGradientsAttribution: (() { final guardedValue = map['integratedGradientsAttribution']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1IntegratedGradientsAttribution.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      sampledShapleyAttribution: (() { final guardedValue = map['sampledShapleyAttribution']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1SampledShapleyAttribution.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      topK: (() { final guardedValue = map['topK']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      xraiAttribution: (() { final guardedValue = map['xraiAttribution']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1XraiAttribution.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
