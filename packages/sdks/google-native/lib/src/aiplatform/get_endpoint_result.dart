...
class GetEndpointResult {
  ...
  final GoogleCloudAiplatformV1PredictRequestResponseLoggingConfigResponse predictRequestResponseLoggingConfig;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'deployedModels': pulumi.Input.encodeList<GoogleCloudAiplatformV1DeployedModelResponse, Map<String, dynamic>>(deployedModels, (value) => value.toMap()),
  ...
  factory GetEndpointResult.fromMap(Map<String, dynamic> map) {
    return GetEndpointResult(
      ...
      deployedModels: pulumi.Input.decodeList<GoogleCloudAiplatformV1DeployedModelResponse>(map['deployedModels']!, (value) => GoogleCloudAiplatformV1DeployedModelResponse.fromMap((value as Map).cast<String, dynamic>())),
      ...
      predictRequestResponseLoggingConfig: GoogleCloudAiplatformV1PredictRequestResponseLoggingConfigResponse.fromMap((map['predictRequestResponseLoggingConfig']! as Map).cast<String, dynamic>()),
