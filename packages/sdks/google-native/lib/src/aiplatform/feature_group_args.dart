...
class FeatureGroupArgs {
  ...
  factory FeatureGroupArgs.fromMap(Map<String, dynamic> map) {
    return FeatureGroupArgs(
      bigQuery: (() { final guardedValue = map['bigQuery']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1FeatureGroupBigQuery.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
