...
class GetFeatureViewAiplatformV1beta1Result {
  ...
  factory GetFeatureViewAiplatformV1beta1Result.fromMap(
    ...
    return GetFeatureViewAiplatformV1beta1Result(
      ...
      featureRegistrySource:
          GoogleCloudAiplatformV1beta1FeatureViewFeatureRegistrySourceResponse.fromMap(
      ...
      vectorSearchConfig:
          GoogleCloudAiplatformV1beta1FeatureViewVectorSearchConfigResponse.fromMap(
