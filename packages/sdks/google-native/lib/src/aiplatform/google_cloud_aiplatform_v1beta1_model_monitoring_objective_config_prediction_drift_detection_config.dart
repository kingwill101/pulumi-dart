...
class GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigPredictionDriftDetectionConfig {
  ...
  factory GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigPredictionDriftDetectionConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigPredictionDriftDetectionConfig(
      ...
      defaultDriftThreshold: map['defaultDriftThreshold'] == null ? null : GoogleCloudAiplatformV1beta1ThresholdConfig.fromMap((map['defaultDriftThreshold'] as Map).cast<String, dynamic>()),
