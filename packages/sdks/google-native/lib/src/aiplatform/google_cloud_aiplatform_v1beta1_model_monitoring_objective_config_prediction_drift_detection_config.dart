...
class GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigPredictionDriftDetectionConfig {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1beta1ThresholdConfig>? defaultDriftThreshold;
  ...
  const GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigPredictionDriftDetectionConfig({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'defaultDriftThreshold': ?pulumi.Input.mapOptionalInputValue<GoogleCloudAiplatformV1beta1ThresholdConfig, Map<String, dynamic>>(defaultDriftThreshold, (value) => value.toMap()),
  ...
  factory GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigPredictionDriftDetectionConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigPredictionDriftDetectionConfig(
      ...
      defaultDriftThreshold: (() { final guardedValue = map['defaultDriftThreshold']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1ThresholdConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
