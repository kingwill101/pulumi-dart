...
class GetTrialAiplatformV1beta1Result {
  ...
  /// Creates a new [GetTrialAiplatformV1beta1Result].
  ...
  factory GetTrialAiplatformV1beta1Result.fromMap(Map<String, dynamic> map) {
    return GetTrialAiplatformV1beta1Result(
