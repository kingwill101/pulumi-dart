...
class GoogleCloudAiplatformV1beta1StudySpecResponse {
  ...
  final pulumi.Input<
    List<GoogleCloudAiplatformV1beta1StudySpecMetricSpecResponse>
  >
  metrics;
  ...
  final pulumi.Input<
    List<GoogleCloudAiplatformV1beta1StudySpecParameterSpecResponse>
  >
  parameters;
    ...
    return <String, dynamic>{
      ...
      'convexAutomatedStoppingSpec':
          pulumi.Input.mapInputValue<
            GoogleCloudAiplatformV1beta1StudySpecConvexAutomatedStoppingSpecResponse,
            Map<String, dynamic>
          >(convexAutomatedStoppingSpec, (value) => value.toMap()),
      'convexStopConfig':
          pulumi.Input.mapInputValue<
            GoogleCloudAiplatformV1beta1StudySpecConvexStopConfigResponse,
            Map<String, dynamic>
          >(convexStopConfig, (value) => value.toMap()),
      'decayCurveStoppingSpec':
          pulumi.Input.mapInputValue<
            GoogleCloudAiplatformV1beta1StudySpecDecayCurveAutomatedStoppingSpecResponse,
            Map<String, dynamic>
          >(decayCurveStoppingSpec, (value) => value.toMap()),
      'measurementSelectionType': measurementSelectionType,
      'medianAutomatedStoppingSpec':
          pulumi.Input.mapInputValue<
            GoogleCloudAiplatformV1beta1StudySpecMedianAutomatedStoppingSpecResponse,
            Map<String, dynamic>
          >(medianAutomatedStoppingSpec, (value) => value.toMap()),
      'metrics':
          pulumi.Input.mapInputValue<
            List<GoogleCloudAiplatformV1beta1StudySpecMetricSpecResponse>,
      ...
      'studyStoppingConfig':
          pulumi.Input.mapInputValue<
            GoogleCloudAiplatformV1beta1StudySpecStudyStoppingConfigResponse,
            Map<String, dynamic>
          >(studyStoppingConfig, (value) => value.toMap()),
      'transferLearningConfig':
          pulumi.Input.mapInputValue<
            GoogleCloudAiplatformV1beta1StudySpecTransferLearningConfigResponse,
            Map<String, dynamic>
          >(transferLearningConfig, (value) => value.toMap()),
    };
  }
  ...
  factory GoogleCloudAiplatformV1beta1StudySpecResponse.fromMap(
    ...
    return GoogleCloudAiplatformV1beta1StudySpecResponse(
      ...
      convexAutomatedStoppingSpec: pulumi.Input.fromValue(
        GoogleCloudAiplatformV1beta1StudySpecConvexAutomatedStoppingSpecResponse.fromMap(
          (map['convexAutomatedStoppingSpec']! as Map).cast<String, dynamic>(),
        ),
      ),
      convexStopConfig: pulumi.Input.fromValue(
        GoogleCloudAiplatformV1beta1StudySpecConvexStopConfigResponse.fromMap(
          (map['convexStopConfig']! as Map).cast<String, dynamic>(),
        ),
      ),
      decayCurveStoppingSpec: pulumi.Input.fromValue(
        GoogleCloudAiplatformV1beta1StudySpecDecayCurveAutomatedStoppingSpecResponse.fromMap(
          (map['decayCurveStoppingSpec']! as Map).cast<String, dynamic>(),
        ),
      ),
      measurementSelectionType: pulumi.Input.fromValue(
        map['measurementSelectionType'] as String,
      ),
      medianAutomatedStoppingSpec: pulumi.Input.fromValue(
        GoogleCloudAiplatformV1beta1StudySpecMedianAutomatedStoppingSpecResponse.fromMap(
          (map['medianAutomatedStoppingSpec']! as Map).cast<String, dynamic>(),
        ),
      ),
      ...
      observationNoise: pulumi.Input.fromValue(
      ...
      parameters: pulumi.Input.fromValue(
        ...
        >(
          map['parameters']!,
          (value) =>
              GoogleCloudAiplatformV1beta1StudySpecParameterSpecResponse.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
      studyStoppingConfig: pulumi.Input.fromValue(
        GoogleCloudAiplatformV1beta1StudySpecStudyStoppingConfigResponse.fromMap(
          (map['studyStoppingConfig']! as Map).cast<String, dynamic>(),
        ),
      ),
      transferLearningConfig: pulumi.Input.fromValue(
        GoogleCloudAiplatformV1beta1StudySpecTransferLearningConfigResponse.fromMap(
