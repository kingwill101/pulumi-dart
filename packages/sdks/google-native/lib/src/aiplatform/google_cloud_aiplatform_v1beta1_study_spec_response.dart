...
class GoogleCloudAiplatformV1beta1StudySpecResponse {
  ...
  factory GoogleCloudAiplatformV1beta1StudySpecResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1StudySpecResponse(
      ...
      convexAutomatedStoppingSpec: (GoogleCloudAiplatformV1beta1StudySpecConvexAutomatedStoppingSpecResponse.fromMap((map['convexAutomatedStoppingSpec'] as Map).cast<String, dynamic>())).input(),
      convexStopConfig: (GoogleCloudAiplatformV1beta1StudySpecConvexStopConfigResponse.fromMap((map['convexStopConfig'] as Map).cast<String, dynamic>())).input(),
      decayCurveStoppingSpec: (GoogleCloudAiplatformV1beta1StudySpecDecayCurveAutomatedStoppingSpecResponse.fromMap((map['decayCurveStoppingSpec'] as Map).cast<String, dynamic>())).input(),
      measurementSelectionType: (map['measurementSelectionType'] as String).input(),
      medianAutomatedStoppingSpec: (GoogleCloudAiplatformV1beta1StudySpecMedianAutomatedStoppingSpecResponse.fromMap((map['medianAutomatedStoppingSpec'] as Map).cast<String, dynamic>())).input(),
      metrics: (pulumi.Input.decodeList<GoogleCloudAiplatformV1beta1StudySpecMetricSpecResponse>(map['metrics'], (value) => GoogleCloudAiplatformV1beta1StudySpecMetricSpecResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      observationNoise: (map['observationNoise'] as String).input(),
      parameters: (pulumi.Input.decodeList<GoogleCloudAiplatformV1beta1StudySpecParameterSpecResponse>(map['parameters'], (value) => GoogleCloudAiplatformV1beta1StudySpecParameterSpecResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      studyStoppingConfig: (GoogleCloudAiplatformV1beta1StudySpecStudyStoppingConfigResponse.fromMap((map['studyStoppingConfig'] as Map).cast<String, dynamic>())).input(),
      transferLearningConfig: (GoogleCloudAiplatformV1beta1StudySpecTransferLearningConfigResponse.fromMap((map['transferLearningConfig'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
