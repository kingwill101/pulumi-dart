...
class GoogleCloudAiplatformV1ModelMonitoringAlertConfig {
  /// Email alert config.
  final GoogleCloudAiplatformV1ModelMonitoringAlertConfigEmailAlertConfig? emailAlertConfig;
  ...
  factory GoogleCloudAiplatformV1ModelMonitoringAlertConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1ModelMonitoringAlertConfig(
      emailAlertConfig: map['emailAlertConfig'] == null ? null : GoogleCloudAiplatformV1ModelMonitoringAlertConfigEmailAlertConfig.fromMap((map['emailAlertConfig'] as Map).cast<String, dynamic>()),
