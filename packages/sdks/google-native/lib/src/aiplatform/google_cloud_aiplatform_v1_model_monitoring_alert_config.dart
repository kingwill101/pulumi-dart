...
class GoogleCloudAiplatformV1ModelMonitoringAlertConfig {
  ...
  const GoogleCloudAiplatformV1ModelMonitoringAlertConfig({
  ...
  factory GoogleCloudAiplatformV1ModelMonitoringAlertConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1ModelMonitoringAlertConfig(
      emailAlertConfig: (() { final guardedValue = map['emailAlertConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1ModelMonitoringAlertConfigEmailAlertConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
