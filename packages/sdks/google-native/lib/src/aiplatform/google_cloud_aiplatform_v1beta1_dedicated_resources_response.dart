...
class GoogleCloudAiplatformV1beta1DedicatedResourcesResponse {
  ...
  final pulumi.Input<List<GoogleCloudAiplatformV1beta1AutoscalingMetricSpecResponse>> autoscalingMetricSpecs;
  ...
  const GoogleCloudAiplatformV1beta1DedicatedResourcesResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'autoscalingMetricSpecs': pulumi.Input.mapInputValue<List<GoogleCloudAiplatformV1beta1AutoscalingMetricSpecResponse>, List<Map<String, dynamic>>>(autoscalingMetricSpecs, (value) => pulumi.Input.encodeList<GoogleCloudAiplatformV1beta1AutoscalingMetricSpecResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory GoogleCloudAiplatformV1beta1DedicatedResourcesResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1DedicatedResourcesResponse(
      autoscalingMetricSpecs: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudAiplatformV1beta1AutoscalingMetricSpecResponse>(map['autoscalingMetricSpecs']!, (value) => GoogleCloudAiplatformV1beta1AutoscalingMetricSpecResponse.fromMap((value as Map).cast<String, dynamic>()))),
