...
class GoogleCloudAiplatformV1beta1DedicatedResourcesResponse {
  ...
  factory GoogleCloudAiplatformV1beta1DedicatedResourcesResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1DedicatedResourcesResponse(
      autoscalingMetricSpecs: (pulumi.Input.decodeList<GoogleCloudAiplatformV1beta1AutoscalingMetricSpecResponse>(map['autoscalingMetricSpecs'], (value) => GoogleCloudAiplatformV1beta1AutoscalingMetricSpecResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
