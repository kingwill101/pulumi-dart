...
class GoogleCloudAiplatformV1NasJobSpecMultiTrialAlgorithmSpec {
  ...
  final GoogleCloudAiplatformV1NasJobSpecMultiTrialAlgorithmSpecMetricSpec? metric;
  /// The multi-trial Neural Architecture Search (NAS) algorithm type. Defaults to `REINFORCEMENT_LEARNING`.
  final GoogleCloudAiplatformV1NasJobSpecMultiTrialAlgorithmSpecMultiTrialAlgorithm? multiTrialAlgorithm;
  /// Spec for search trials.
  final GoogleCloudAiplatformV1NasJobSpecMultiTrialAlgorithmSpecSearchTrialSpec searchTrialSpec;
  ...
  final GoogleCloudAiplatformV1NasJobSpecMultiTrialAlgorithmSpecTrainTrialSpec? trainTrialSpec;
  ...
  factory GoogleCloudAiplatformV1NasJobSpecMultiTrialAlgorithmSpec.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1NasJobSpecMultiTrialAlgorithmSpec(
      metric: map['metric'] == null ? null : GoogleCloudAiplatformV1NasJobSpecMultiTrialAlgorithmSpecMetricSpec.fromMap((map['metric'] as Map).cast<String, dynamic>()),
      multiTrialAlgorithm: map['multiTrialAlgorithm'] == null ? null : GoogleCloudAiplatformV1NasJobSpecMultiTrialAlgorithmSpecMultiTrialAlgorithm.fromValue(map['multiTrialAlgorithm'] as String),
      searchTrialSpec: GoogleCloudAiplatformV1NasJobSpecMultiTrialAlgorithmSpecSearchTrialSpec.fromMap((map['searchTrialSpec'] as Map).cast<String, dynamic>()),
      trainTrialSpec: map['trainTrialSpec'] == null ? null : GoogleCloudAiplatformV1NasJobSpecMultiTrialAlgorithmSpecTrainTrialSpec.fromMap((map['trainTrialSpec'] as Map).cast<String, dynamic>()),
    );
  }
}
