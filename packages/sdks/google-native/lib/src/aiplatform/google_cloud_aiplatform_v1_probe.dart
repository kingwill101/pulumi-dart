...
class GoogleCloudAiplatformV1Probe {
  ...
  const GoogleCloudAiplatformV1Probe({
    this.exec,
    this.periodSeconds,
    this.timeoutSeconds,
  });
  ...
  factory GoogleCloudAiplatformV1Probe.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1Probe(
      exec: (() { final guardedValue = map['exec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1ProbeExecAction.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
