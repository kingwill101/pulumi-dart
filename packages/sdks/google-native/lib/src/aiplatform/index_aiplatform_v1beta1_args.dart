...
class IndexAiplatformV1beta1Args {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'etag': ?etag,
      'indexUpdateMethod': ?pulumi.Input.mapOptionalInputValue<IndexIndexUpdateMethodAiplatformV1beta1, String>(indexUpdateMethod, (value) => value.wireValue),
      'labels': ?labels,
      'location': ?location,
      'metadata': ?metadata,
  ...
  factory IndexAiplatformV1beta1Args.fromMap(Map<String, dynamic> map) {
    return IndexAiplatformV1beta1Args(
      ...
      indexUpdateMethod: (() { final guardedValue = map['indexUpdateMethod']; if (guardedValue == null) return null; return pulumi.Input.fromValue(IndexIndexUpdateMethodAiplatformV1beta1.fromValue(guardedValue as String)); })(),
