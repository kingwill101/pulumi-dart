...
class GoogleCloudAiplatformV1FeatureNoiseSigmaResponse {
  ...
  factory GoogleCloudAiplatformV1FeatureNoiseSigmaResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1FeatureNoiseSigmaResponse(
      noiseSigma: (pulumi.Input.decodeList<GoogleCloudAiplatformV1FeatureNoiseSigmaNoiseSigmaForFeatureResponse>(map['noiseSigma'], (value) => GoogleCloudAiplatformV1FeatureNoiseSigmaNoiseSigmaForFeatureResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
