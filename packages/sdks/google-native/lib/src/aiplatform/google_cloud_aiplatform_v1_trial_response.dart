...
class GoogleCloudAiplatformV1TrialResponse {
  ...
  final pulumi.Input<List<GoogleCloudAiplatformV1MeasurementResponse>>
  measurements;
  ...
  final pulumi.Input<List<GoogleCloudAiplatformV1TrialParameterResponse>>
  parameters;
  ...
  factory GoogleCloudAiplatformV1TrialResponse.fromMap(
    ...
    return GoogleCloudAiplatformV1TrialResponse(
      ...
      parameters: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GoogleCloudAiplatformV1TrialParameterResponse>(
          map['parameters']!,
