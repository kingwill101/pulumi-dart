...
class GoogleCloudAiplatformV1TrialResponse {
  ...
  factory GoogleCloudAiplatformV1TrialResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1TrialResponse(
      ...
      measurements: (pulumi.Input.decodeList<GoogleCloudAiplatformV1MeasurementResponse>(map['measurements'], (value) => GoogleCloudAiplatformV1MeasurementResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      name: (map['name'] as String).input(),
      parameters: (pulumi.Input.decodeList<GoogleCloudAiplatformV1TrialParameterResponse>(map['parameters'], (value) => GoogleCloudAiplatformV1TrialParameterResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
