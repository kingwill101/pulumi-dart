...
class HyperparameterTuningJobArgs {
  ...
  HyperparameterTuningJobArgs({
    ...
    required pulumi.Output<GoogleCloudAiplatformV1CustomJobSpec> trialJobSpec,
  }) :
      ...
      trialJobSpec = pulumi.Input.asInput<GoogleCloudAiplatformV1CustomJobSpec>(trialJobSpec);
  ...
  factory HyperparameterTuningJobArgs.fromMap(Map<String, dynamic> map) {
    return HyperparameterTuningJobArgs(
      ...
      trialJobSpec: pulumi.Output.create<GoogleCloudAiplatformV1CustomJobSpec>(GoogleCloudAiplatformV1CustomJobSpec.fromMap((map['trialJobSpec'] as Map).cast<String, dynamic>())),
    );
  }
}
