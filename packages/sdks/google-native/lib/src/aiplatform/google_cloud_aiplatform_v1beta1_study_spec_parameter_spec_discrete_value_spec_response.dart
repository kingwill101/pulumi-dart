...
class GoogleCloudAiplatformV1beta1StudySpecParameterSpecDiscreteValueSpecResponse {
  ...
  const GoogleCloudAiplatformV1beta1StudySpecParameterSpecDiscreteValueSpecResponse({
  ...
  factory GoogleCloudAiplatformV1beta1StudySpecParameterSpecDiscreteValueSpecResponse.fromMap(Map<String, dynamic> map) {
