...
class GoogleCloudAiplatformV1beta1FilterSplit {
  ...
  /// Creates a new [GoogleCloudAiplatformV1beta1FilterSplit].
  ...
  const GoogleCloudAiplatformV1beta1FilterSplit({
  ...
  factory GoogleCloudAiplatformV1beta1FilterSplit.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1FilterSplit(
