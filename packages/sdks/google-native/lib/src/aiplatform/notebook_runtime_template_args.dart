...
class NotebookRuntimeTemplateArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'notebookRuntimeType': ?pulumi.Input.mapOptionalInputValue<NotebookRuntimeTemplateNotebookRuntimeType, String>(notebookRuntimeType, (value) => value.wireValue),
      'project': ?project,
  ...
  factory NotebookRuntimeTemplateArgs.fromMap(Map<String, dynamic> map) {
    return NotebookRuntimeTemplateArgs(
      dataPersistentDiskSpec: (() { final guardedValue = map['dataPersistentDiskSpec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1PersistentDiskSpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      description: (() { final guardedValue = map['description']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      displayName: pulumi.Input.fromValue(map['displayName'] as String),
      etag: (() { final guardedValue = map['etag']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      eucConfig: (() { final guardedValue = map['eucConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1NotebookEucConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      idleShutdownConfig: (() { final guardedValue = map['idleShutdownConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1NotebookIdleShutdownConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      networkSpec: (() { final guardedValue = map['networkSpec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1NetworkSpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      notebookRuntimeType: (() { final guardedValue = map['notebookRuntimeType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NotebookRuntimeTemplateNotebookRuntimeType.fromValue(guardedValue as String)); })(),
