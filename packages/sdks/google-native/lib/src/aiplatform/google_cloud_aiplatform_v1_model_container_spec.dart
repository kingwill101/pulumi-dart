...
import 'google_cloud_aiplatform_v1_port.dart';
import 'google_cloud_aiplatform_v1_probe.dart';
...
class GoogleCloudAiplatformV1ModelContainerSpec {
  ...
  final pulumi.Input<List<GoogleCloudAiplatformV1EnvVar>>? env;

  /// Immutable. Specification for Kubernetes readiness probe. TODO (b/306244185): Revise documentation before exposing.
  final pulumi.Input<GoogleCloudAiplatformV1Probe>? healthProbe;
  ...
  final pulumi.Input<List<GoogleCloudAiplatformV1Port>>? ports;
  ...
  final pulumi.Input<GoogleCloudAiplatformV1Probe>? startupProbe;

  /// Creates a new [GoogleCloudAiplatformV1ModelContainerSpec].
    ...
    return <String, dynamic>{
      ...
      'env':
          ?pulumi.Input.mapOptionalInputValue<
            List<GoogleCloudAiplatformV1EnvVar>,
      ...
      'ports':
          ?pulumi.Input.mapOptionalInputValue<
            List<GoogleCloudAiplatformV1Port>,
            List<Map<String, dynamic>>
          >(
            ports,
            (value) =>
  ...
  factory GoogleCloudAiplatformV1ModelContainerSpec.fromMap(
    ...
    return GoogleCloudAiplatformV1ModelContainerSpec(
      ...
      deploymentTimeout: (() {
        final guardedValue = map['deploymentTimeout'];
        if (guardedValue == null) return null;
      ...
      healthProbe: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GoogleCloudAiplatformV1Probe.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      healthRoute: (() {
        final guardedValue = map['healthRoute'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ...
      ports: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GoogleCloudAiplatformV1Port>(
            guardedValue,
            (value) => GoogleCloudAiplatformV1Port.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      predictRoute: (() {
        final guardedValue = map['predictRoute'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      sharedMemorySizeMb: (() {
        final guardedValue = map['sharedMemorySizeMb'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      startupProbe: (() {
