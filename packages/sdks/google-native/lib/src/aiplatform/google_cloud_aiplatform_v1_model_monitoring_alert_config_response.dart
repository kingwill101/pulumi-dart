...
class GoogleCloudAiplatformV1ModelMonitoringAlertConfigResponse {
  /// Email alert config.
  final GoogleCloudAiplatformV1ModelMonitoringAlertConfigEmailAlertConfigResponse emailAlertConfig;
  ...
  factory GoogleCloudAiplatformV1ModelMonitoringAlertConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1ModelMonitoringAlertConfigResponse(
      emailAlertConfig: GoogleCloudAiplatformV1ModelMonitoringAlertConfigEmailAlertConfigResponse.fromMap((map['emailAlertConfig'] as Map).cast<String, dynamic>()),
