...
class GetTrialResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'measurements': pulumi.Input.encodeList<GoogleCloudAiplatformV1MeasurementResponse, Map<String, dynamic>>(measurements, (value) => value.toMap()),
      'name': name,
      'parameters': pulumi.Input.encodeList<GoogleCloudAiplatformV1TrialParameterResponse, Map<String, dynamic>>(parameters, (value) => value.toMap()),
      'startTime': startTime,
      'state': state,
  ...
  factory GetTrialResult.fromMap(Map<String, dynamic> map) {
    return GetTrialResult(
      ...
      finalMeasurement: GoogleCloudAiplatformV1MeasurementResponse.fromMap((map['finalMeasurement']! as Map).cast<String, dynamic>()),
      infeasibleReason: map['infeasibleReason'] as String,
      measurements: pulumi.Input.decodeList<GoogleCloudAiplatformV1MeasurementResponse>(map['measurements']!, (value) => GoogleCloudAiplatformV1MeasurementResponse.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] as String,
      parameters: pulumi.Input.decodeList<GoogleCloudAiplatformV1TrialParameterResponse>(map['parameters']!, (value) => GoogleCloudAiplatformV1TrialParameterResponse.fromMap((value as Map).cast<String, dynamic>())),
