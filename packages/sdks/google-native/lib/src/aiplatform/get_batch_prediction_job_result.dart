...
class GetBatchPredictionJobResult {
  ...
  final GoogleCloudAiplatformV1CompletionStatsResponse completionStats;
  /// Time when the BatchPredictionJob was created.
  final String createTime;
  /// The config of resources used by the Model during the batch prediction. If the Model supports DEDICATED_RESOURCES this config may be provided (and the job will use these resources), if the Model doesn't support AUTOMATIC_RESOURCES, this config must be provided.
  final GoogleCloudAiplatformV1BatchDedicatedResourcesResponse dedicatedResources;
  ...
  final GoogleCloudAiplatformV1BatchPredictionJobInputConfigResponse inputConfig;
  /// Configuration for how to convert batch prediction input instances to the prediction instances that are sent to the Model.
  final GoogleCloudAiplatformV1BatchPredictionJobInstanceConfigResponse instanceConfig;
  ...
  final GoogleCloudAiplatformV1ManualBatchTuningParametersResponse manualBatchTuningParameters;
  ...
  final GoogleCloudAiplatformV1BatchPredictionJobOutputConfigResponse outputConfig;
  /// Information further describing the output of this job.
  final GoogleCloudAiplatformV1BatchPredictionJobOutputInfoResponse outputInfo;
  ...
  final GoogleCloudAiplatformV1ResourcesConsumedResponse resourcesConsumed;
  ...
  final GoogleCloudAiplatformV1UnmanagedContainerModelResponse unmanagedContainerModel;
  /// Time when the BatchPredictionJob was most recently updated.
  final String updateTime;

  /// Creates a new [GetBatchPredictionJobResult].
  ...
  factory GetBatchPredictionJobResult.fromMap(Map<String, dynamic> map) {
    return GetBatchPredictionJobResult(
      completionStats: GoogleCloudAiplatformV1CompletionStatsResponse.fromMap((map['completionStats']! as Map).cast<String, dynamic>()),
      createTime: map['createTime'] as String,
      dedicatedResources: GoogleCloudAiplatformV1BatchDedicatedResourcesResponse.fromMap((map['dedicatedResources']! as Map).cast<String, dynamic>()),
      ...
      inputConfig: GoogleCloudAiplatformV1BatchPredictionJobInputConfigResponse.fromMap((map['inputConfig']! as Map).cast<String, dynamic>()),
      instanceConfig: GoogleCloudAiplatformV1BatchPredictionJobInstanceConfigResponse.fromMap((map['instanceConfig']! as Map).cast<String, dynamic>()),
      labels: (map['labels'] as Map).cast<String, String>(),
      manualBatchTuningParameters: GoogleCloudAiplatformV1ManualBatchTuningParametersResponse.fromMap((map['manualBatchTuningParameters']! as Map).cast<String, dynamic>()),
      model: map['model'] as String,
      modelParameters: map['modelParameters'],
      modelVersionId: map['modelVersionId'] as String,
      name: map['name'] as String,
      outputConfig: GoogleCloudAiplatformV1BatchPredictionJobOutputConfigResponse.fromMap((map['outputConfig']! as Map).cast<String, dynamic>()),
      outputInfo: GoogleCloudAiplatformV1BatchPredictionJobOutputInfoResponse.fromMap((map['outputInfo']! as Map).cast<String, dynamic>()),
      ...
      resourcesConsumed: GoogleCloudAiplatformV1ResourcesConsumedResponse.fromMap((map['resourcesConsumed']! as Map).cast<String, dynamic>()),
      serviceAccount: map['serviceAccount'] as String,
      startTime: map['startTime'] as String,
      state: map['state'] as String,
      unmanagedContainerModel: GoogleCloudAiplatformV1UnmanagedContainerModelResponse.fromMap((map['unmanagedContainerModel']! as Map).cast<String, dynamic>()),
