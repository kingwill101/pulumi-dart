...
class GetBatchPredictionJobResult {
  ...
  final GoogleCloudAiplatformV1BatchDedicatedResourcesResponse
  dedicatedResources;
  ...
  final GoogleCloudAiplatformV1BatchPredictionJobInputConfigResponse
  inputConfig;

  /// Configuration for how to convert batch prediction input instances to the prediction instances that are sent to the Model.
  final GoogleCloudAiplatformV1BatchPredictionJobInstanceConfigResponse
  instanceConfig;
  ...
  final GoogleCloudAiplatformV1ManualBatchTuningParametersResponse
  ...
  final GoogleCloudAiplatformV1BatchPredictionJobOutputConfigResponse
  outputConfig;
  ...
  final GoogleCloudAiplatformV1UnmanagedContainerModelResponse
  ...
  factory GetBatchPredictionJobResult.fromMap(Map<String, dynamic> map) {
    return GetBatchPredictionJobResult(
      completionStats: GoogleCloudAiplatformV1CompletionStatsResponse.fromMap(
        (map['completionStats']! as Map).cast<String, dynamic>(),
      ),
      createTime: map['createTime'] as String,
      dedicatedResources:
          GoogleCloudAiplatformV1BatchDedicatedResourcesResponse.fromMap(
      ...
      inputConfig:
          GoogleCloudAiplatformV1BatchPredictionJobInputConfigResponse.fromMap(
            (map['inputConfig']! as Map).cast<String, dynamic>(),
          ),
      instanceConfig:
          GoogleCloudAiplatformV1BatchPredictionJobInstanceConfigResponse.fromMap(
            (map['instanceConfig']! as Map).cast<String, dynamic>(),
          ),
      labels: (map['labels'] as Map).cast<String, String>(),
      manualBatchTuningParameters:
          GoogleCloudAiplatformV1ManualBatchTuningParametersResponse.fromMap(
      ...
      outputConfig:
          GoogleCloudAiplatformV1BatchPredictionJobOutputConfigResponse.fromMap(
      ...
      resourcesConsumed:
          GoogleCloudAiplatformV1ResourcesConsumedResponse.fromMap(
      ...
      unmanagedContainerModel:
          GoogleCloudAiplatformV1UnmanagedContainerModelResponse.fromMap(
