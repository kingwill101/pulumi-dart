...
class GoogleCloudAiplatformV1BatchPredictionJobInputConfigResponse {
  ...
  /// Creates a new [GoogleCloudAiplatformV1BatchPredictionJobInputConfigResponse].
  ...
  const GoogleCloudAiplatformV1BatchPredictionJobInputConfigResponse({
  ...
  factory GoogleCloudAiplatformV1BatchPredictionJobInputConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1BatchPredictionJobInputConfigResponse(
      bigquerySource: pulumi.Input.fromValue(GoogleCloudAiplatformV1BigQuerySourceResponse.fromMap((map['bigquerySource']! as Map).cast<String, dynamic>())),
      gcsSource: pulumi.Input.fromValue(GoogleCloudAiplatformV1GcsSourceResponse.fromMap((map['gcsSource']! as Map).cast<String, dynamic>())),
