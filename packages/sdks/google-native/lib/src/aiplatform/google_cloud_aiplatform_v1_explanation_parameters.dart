...
class GoogleCloudAiplatformV1ExplanationParameters {
  ...
  final GoogleCloudAiplatformV1Examples? examples;
  /// An attribution method that computes Aumann-Shapley values taking advantage of the model's fully differentiable structure. Refer to this paper for more details: https://arxiv.org/abs/1703.01365
  final GoogleCloudAiplatformV1IntegratedGradientsAttribution? integratedGradientsAttribution;
  ...
  final GoogleCloudAiplatformV1SampledShapleyAttribution? sampledShapleyAttribution;
  ...
  final GoogleCloudAiplatformV1XraiAttribution? xraiAttribution;
  ...
  factory GoogleCloudAiplatformV1ExplanationParameters.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1ExplanationParameters(
      examples: map['examples'] == null ? null : GoogleCloudAiplatformV1Examples.fromMap((map['examples'] as Map).cast<String, dynamic>()),
      integratedGradientsAttribution: map['integratedGradientsAttribution'] == null ? null : GoogleCloudAiplatformV1IntegratedGradientsAttribution.fromMap((map['integratedGradientsAttribution'] as Map).cast<String, dynamic>()),
      outputIndices: map['outputIndices'] == null ? null : (map['outputIndices'] as List).cast<dynamic>(),
      sampledShapleyAttribution: map['sampledShapleyAttribution'] == null ? null : GoogleCloudAiplatformV1SampledShapleyAttribution.fromMap((map['sampledShapleyAttribution'] as Map).cast<String, dynamic>()),
      topK: map['topK'] == null ? null : map['topK'] as int,
      xraiAttribution: map['xraiAttribution'] == null ? null : GoogleCloudAiplatformV1XraiAttribution.fromMap((map['xraiAttribution'] as Map).cast<String, dynamic>()),
    );
  }
}
