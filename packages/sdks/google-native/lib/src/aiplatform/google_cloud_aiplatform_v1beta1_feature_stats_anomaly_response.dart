...
class GoogleCloudAiplatformV1beta1FeatureStatsAnomalyResponse {
  ...
  factory GoogleCloudAiplatformV1beta1FeatureStatsAnomalyResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1FeatureStatsAnomalyResponse(
      anomalyDetectionThreshold: (map['anomalyDetectionThreshold'] as double).input(),
      anomalyUri: (map['anomalyUri'] as String).input(),
      distributionDeviation: (map['distributionDeviation'] as double).input(),
      endTime: (map['endTime'] as String).input(),
      score: (map['score'] as double).input(),
      startTime: (map['startTime'] as String).input(),
      statsUri: (map['statsUri'] as String).input(),
    );
  }
}
