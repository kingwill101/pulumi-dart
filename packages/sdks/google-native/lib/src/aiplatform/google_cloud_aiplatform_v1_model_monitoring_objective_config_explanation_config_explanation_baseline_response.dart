...
class GoogleCloudAiplatformV1ModelMonitoringObjectiveConfigExplanationConfigExplanationBaselineResponse {
  ...
  /// Creates a new [GoogleCloudAiplatformV1ModelMonitoringObjectiveConfigExplanationConfigExplanationBaselineResponse].
  ...
  factory GoogleCloudAiplatformV1ModelMonitoringObjectiveConfigExplanationConfigExplanationBaselineResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1ModelMonitoringObjectiveConfigExplanationConfigExplanationBaselineResponse(
      bigquery: (GoogleCloudAiplatformV1BigQueryDestinationResponse.fromMap((map['bigquery'] as Map).cast<String, dynamic>())).input(),
      gcs: (GoogleCloudAiplatformV1GcsDestinationResponse.fromMap((map['gcs'] as Map).cast<String, dynamic>())).input(),
      predictionFormat: (map['predictionFormat'] as String).input(),
    );
  }
}
