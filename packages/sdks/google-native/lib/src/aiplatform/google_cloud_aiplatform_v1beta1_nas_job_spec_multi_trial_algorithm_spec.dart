...
class GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpec {
  ...
  const GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpec({
    this.metric,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'multiTrialAlgorithm': ?pulumi.Input.mapOptionalInputValue<GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpecMultiTrialAlgorithm, String>(multiTrialAlgorithm, (value) => value.wireValue),
  ...
  factory GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpec.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpec(
      metric: (() { final guardedValue = map['metric']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpecMetricSpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      multiTrialAlgorithm: (() { final guardedValue = map['multiTrialAlgorithm']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpecMultiTrialAlgorithm.fromValue(guardedValue as String)); })(),
      searchTrialSpec: pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpecSearchTrialSpec.fromMap((map['searchTrialSpec']! as Map).cast<String, dynamic>())),
      trainTrialSpec: (() { final guardedValue = map['trainTrialSpec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpecTrainTrialSpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
