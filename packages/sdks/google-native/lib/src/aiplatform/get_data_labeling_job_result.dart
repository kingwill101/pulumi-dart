...
class GetDataLabelingJobResult {
  ...
  final GoogleCloudAiplatformV1ActiveLearningConfigResponse activeLearningConfig;
  ...
  factory GetDataLabelingJobResult.fromMap(Map<String, dynamic> map) {
    return GetDataLabelingJobResult(
      activeLearningConfig: GoogleCloudAiplatformV1ActiveLearningConfigResponse.fromMap((map['activeLearningConfig'] as Map).cast<String, dynamic>()),
      annotationLabels: (map['annotationLabels'] as Map).cast<String, String>(),
      createTime: map['createTime'] as String,
      currentSpend: GoogleTypeMoneyResponse.fromMap((map['currentSpend'] as Map).cast<String, dynamic>()),
