...
/// {@template pulumi_aiplatform_v1beta1_model_iam_member_args_doc}
/// The set of arguments for ModelIamMember.
/// {@endtemplate}
/// {@macro pulumi_aiplatform_v1beta1_model_iam_member_args_doc}
class ModelIamMemberArgs {
  ...
  /// Creates a new [ModelIamMemberArgs].
  ...
  factory ModelIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return ModelIamMemberArgs(
