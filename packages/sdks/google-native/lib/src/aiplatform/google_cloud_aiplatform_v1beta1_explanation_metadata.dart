...
class GoogleCloudAiplatformV1beta1ExplanationMetadata {
  ...
  const GoogleCloudAiplatformV1beta1ExplanationMetadata({
  ...
  factory GoogleCloudAiplatformV1beta1ExplanationMetadata.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1ExplanationMetadata(
      featureAttributionsSchemaUri: (() { final guardedValue = map['featureAttributionsSchemaUri']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      inputs: pulumi.Input.fromValue((map['inputs'] as Map).cast<String, String>()),
      latentSpaceSource: (() { final guardedValue = map['latentSpaceSource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
