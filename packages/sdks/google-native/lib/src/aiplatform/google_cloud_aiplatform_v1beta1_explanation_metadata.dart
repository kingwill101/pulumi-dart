...
class GoogleCloudAiplatformV1beta1ExplanationMetadata {
  ...
  factory GoogleCloudAiplatformV1beta1ExplanationMetadata.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1ExplanationMetadata(
      featureAttributionsSchemaUri: map['featureAttributionsSchemaUri'] == null ? null : map['featureAttributionsSchemaUri'] as String,
      inputs: (map['inputs'] as Map).cast<String, String>(),
      latentSpaceSource: map['latentSpaceSource'] == null ? null : map['latentSpaceSource'] as String,
