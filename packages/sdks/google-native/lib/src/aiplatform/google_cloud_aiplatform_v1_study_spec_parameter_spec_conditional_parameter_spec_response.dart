...
class GoogleCloudAiplatformV1StudySpecParameterSpecConditionalParameterSpecResponse {
  ...
  const GoogleCloudAiplatformV1StudySpecParameterSpecConditionalParameterSpecResponse({
  ...
  factory GoogleCloudAiplatformV1StudySpecParameterSpecConditionalParameterSpecResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1StudySpecParameterSpecConditionalParameterSpecResponse(
      parameterSpec: pulumi.Input.fromValue(GoogleCloudAiplatformV1StudySpecParameterSpecResponse.fromMap((map['parameterSpec']! as Map).cast<String, dynamic>())),
      parentCategoricalValues: pulumi.Input.fromValue(GoogleCloudAiplatformV1StudySpecParameterSpecConditionalParameterSpecCategoricalValueConditionResponse.fromMap((map['parentCategoricalValues']! as Map).cast<String, dynamic>())),
      parentDiscreteValues: pulumi.Input.fromValue(GoogleCloudAiplatformV1StudySpecParameterSpecConditionalParameterSpecDiscreteValueConditionResponse.fromMap((map['parentDiscreteValues']! as Map).cast<String, dynamic>())),
      parentIntValues: pulumi.Input.fromValue(GoogleCloudAiplatformV1StudySpecParameterSpecConditionalParameterSpecIntValueConditionResponse.fromMap((map['parentIntValues']! as Map).cast<String, dynamic>())),
    );
  }
}
