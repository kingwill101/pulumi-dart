...
class GoogleCloudAiplatformV1NasJobSpecMultiTrialAlgorithmSpecTrainTrialSpecResponse {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1CustomJobSpecResponse>
  trainTrialJobSpec;
  ...
  factory GoogleCloudAiplatformV1NasJobSpecMultiTrialAlgorithmSpecTrainTrialSpecResponse.fromMap(
    ...
    return GoogleCloudAiplatformV1NasJobSpecMultiTrialAlgorithmSpecTrainTrialSpecResponse(
      ...
      trainTrialJobSpec: pulumi.Input.fromValue(
        GoogleCloudAiplatformV1CustomJobSpecResponse.fromMap(
