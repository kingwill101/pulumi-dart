...
class GoogleCloudAiplatformV1beta1PredictRequestResponseLoggingConfigResponse {
  ...
  final GoogleCloudAiplatformV1beta1BigQueryDestinationResponse bigqueryDestination;
  ...
  factory GoogleCloudAiplatformV1beta1PredictRequestResponseLoggingConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1PredictRequestResponseLoggingConfigResponse(
      bigqueryDestination: GoogleCloudAiplatformV1beta1BigQueryDestinationResponse.fromMap((map['bigqueryDestination'] as Map).cast<String, dynamic>()),
