...
class GoogleCloudAiplatformV1beta1ModelMonitoringConfig {
  ...
  final List<GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfig>? objectiveConfigs;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'objectiveConfigs': ?objectiveConfigs == null ? null : pulumi.Input.encodeList<GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfig, Map<String, dynamic>>(objectiveConfigs!, (value) => value.toMap()),
      'statsAnomaliesBaseDirectory': ?statsAnomaliesBaseDirectory == null ? null : statsAnomaliesBaseDirectory!.toMap(),
    };
  }
  ...
  factory GoogleCloudAiplatformV1beta1ModelMonitoringConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1ModelMonitoringConfig(
      alertConfig: map['alertConfig'] == null ? null : GoogleCloudAiplatformV1beta1ModelMonitoringAlertConfig.fromMap((map['alertConfig'] as Map).cast<String, dynamic>()),
      analysisInstanceSchemaUri: map['analysisInstanceSchemaUri'] == null ? null : map['analysisInstanceSchemaUri'] as String,
      objectiveConfigs: map['objectiveConfigs'] == null ? null : pulumi.Input.decodeList<GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfig>(map['objectiveConfigs'], (value) => GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfig.fromMap((value as Map).cast<String, dynamic>())),
