...
import 'google_cloud_aiplatform_v1_feature_noise_sigma_response.dart';

/// Config for SmoothGrad approximation of gradients. When enabled, the gradients are approximated by averaging the gradients from noisy samples in the vicinity of the inputs. Adding noise can help improve the computed gradients. Refer to this paper for more details: https://arxiv.org/pdf/1706.03825.pdf
class GoogleCloudAiplatformV1SmoothGradConfigResponse {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1FeatureNoiseSigmaResponse> featureNoiseSigma;
  ...
  /// Creates a new [GoogleCloudAiplatformV1SmoothGradConfigResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'featureNoiseSigma': pulumi.Input.mapInputValue<GoogleCloudAiplatformV1FeatureNoiseSigmaResponse, Map<String, dynamic>>(featureNoiseSigma, (value) => value.toMap()),
      'noiseSigma': noiseSigma,
      'noisySampleCount': noisySampleCount,
    };
  }

  factory GoogleCloudAiplatformV1SmoothGradConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1SmoothGradConfigResponse(
      featureNoiseSigma: (GoogleCloudAiplatformV1FeatureNoiseSigmaResponse.fromMap((map['featureNoiseSigma'] as Map).cast<String, dynamic>())).input(),
      noiseSigma: (map['noiseSigma'] as double).input(),
      noisySampleCount: (map['noisySampleCount'] as int).input(),
    );
  }
}
