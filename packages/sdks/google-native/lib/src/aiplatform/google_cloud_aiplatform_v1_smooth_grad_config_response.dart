...
class GoogleCloudAiplatformV1SmoothGradConfigResponse {
  ...
  final GoogleCloudAiplatformV1FeatureNoiseSigmaResponse featureNoiseSigma;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'featureNoiseSigma': featureNoiseSigma.toMap(),
  ...
  factory GoogleCloudAiplatformV1SmoothGradConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1SmoothGradConfigResponse(
      featureNoiseSigma: GoogleCloudAiplatformV1FeatureNoiseSigmaResponse.fromMap((map['featureNoiseSigma'] as Map).cast<String, dynamic>()),
      noiseSigma: map['noiseSigma'] as double,
      noisySampleCount: map['noisySampleCount'] as int,
    );
  }
}
