...
class GoogleCloudAiplatformV1FeaturestoreMonitoringConfigResponse {
  ...
  factory GoogleCloudAiplatformV1FeaturestoreMonitoringConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1FeaturestoreMonitoringConfigResponse(
      categoricalThresholdConfig: pulumi.Input.fromValue(GoogleCloudAiplatformV1FeaturestoreMonitoringConfigThresholdConfigResponse.fromMap((map['categoricalThresholdConfig']! as Map).cast<String, dynamic>())),
      importFeaturesAnalysis: pulumi.Input.fromValue(GoogleCloudAiplatformV1FeaturestoreMonitoringConfigImportFeaturesAnalysisResponse.fromMap((map['importFeaturesAnalysis']! as Map).cast<String, dynamic>())),
      numericalThresholdConfig: pulumi.Input.fromValue(GoogleCloudAiplatformV1FeaturestoreMonitoringConfigThresholdConfigResponse.fromMap((map['numericalThresholdConfig']! as Map).cast<String, dynamic>())),
      snapshotAnalysis: pulumi.Input.fromValue(GoogleCloudAiplatformV1FeaturestoreMonitoringConfigSnapshotAnalysisResponse.fromMap((map['snapshotAnalysis']! as Map).cast<String, dynamic>())),
    );
  }
}
