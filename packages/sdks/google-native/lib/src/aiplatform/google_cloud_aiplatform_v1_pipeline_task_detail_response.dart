...
class GoogleCloudAiplatformV1PipelineTaskDetailResponse {
  ...
  factory GoogleCloudAiplatformV1PipelineTaskDetailResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1PipelineTaskDetailResponse(
      ...
      execution: (GoogleCloudAiplatformV1ExecutionResponse.fromMap((map['execution'] as Map).cast<String, dynamic>())).input(),
      executorDetail: (GoogleCloudAiplatformV1PipelineTaskExecutorDetailResponse.fromMap((map['executorDetail'] as Map).cast<String, dynamic>())).input(),
      ...
      pipelineTaskStatus: (pulumi.Input.decodeList<GoogleCloudAiplatformV1PipelineTaskDetailPipelineTaskStatusResponse>(map['pipelineTaskStatus'], (value) => GoogleCloudAiplatformV1PipelineTaskDetailPipelineTaskStatusResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
