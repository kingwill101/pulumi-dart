...
class GoogleCloudAiplatformV1PipelineTaskDetailResponse {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1PipelineTaskExecutorDetailResponse> executorDetail;
  ...
  final pulumi.Input<List<GoogleCloudAiplatformV1PipelineTaskDetailPipelineTaskStatusResponse>> pipelineTaskStatus;
  /// Task start time.
  ...
  const GoogleCloudAiplatformV1PipelineTaskDetailResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'execution': pulumi.Input.mapInputValue<GoogleCloudAiplatformV1ExecutionResponse, Map<String, dynamic>>(execution, (value) => value.toMap()),
      'executorDetail': pulumi.Input.mapInputValue<GoogleCloudAiplatformV1PipelineTaskExecutorDetailResponse, Map<String, dynamic>>(executorDetail, (value) => value.toMap()),
      'inputs': inputs,
      'outputs': outputs,
      'parentTaskId': parentTaskId,
      'pipelineTaskStatus': pulumi.Input.mapInputValue<List<GoogleCloudAiplatformV1PipelineTaskDetailPipelineTaskStatusResponse>, List<Map<String, dynamic>>>(pipelineTaskStatus, (value) => pulumi.Input.encodeList<GoogleCloudAiplatformV1PipelineTaskDetailPipelineTaskStatusResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'startTime': startTime,
      'state': state,
      'taskId': taskId,
      'taskName': taskName,
  ...
  factory GoogleCloudAiplatformV1PipelineTaskDetailResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1PipelineTaskDetailResponse(
      ...
      execution: pulumi.Input.fromValue(GoogleCloudAiplatformV1ExecutionResponse.fromMap((map['execution']! as Map).cast<String, dynamic>())),
      executorDetail: pulumi.Input.fromValue(GoogleCloudAiplatformV1PipelineTaskExecutorDetailResponse.fromMap((map['executorDetail']! as Map).cast<String, dynamic>())),
      ...
      pipelineTaskStatus: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudAiplatformV1PipelineTaskDetailPipelineTaskStatusResponse>(map['pipelineTaskStatus']!, (value) => GoogleCloudAiplatformV1PipelineTaskDetailPipelineTaskStatusResponse.fromMap((value as Map).cast<String, dynamic>()))),
