...
class EndpointArgs {
  ...
  EndpointArgs({
    ...
    pulumi.Output<GoogleCloudAiplatformV1PredictRequestResponseLoggingConfig>? predictRequestResponseLoggingConfig,
  ...
  factory EndpointArgs.fromMap(Map<String, dynamic> map) {
    return EndpointArgs(
      ...
      predictRequestResponseLoggingConfig: map['predictRequestResponseLoggingConfig'] == null ? null : pulumi.Output.create<GoogleCloudAiplatformV1PredictRequestResponseLoggingConfig>(GoogleCloudAiplatformV1PredictRequestResponseLoggingConfig.fromMap((map['predictRequestResponseLoggingConfig'] as Map).cast<String, dynamic>())),
