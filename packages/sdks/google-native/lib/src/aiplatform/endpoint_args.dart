...
class EndpointArgs {
  ...
  factory EndpointArgs.fromMap(Map<String, dynamic> map) {
    return EndpointArgs(
      ...
      predictRequestResponseLoggingConfig: (() { final guardedValue = map['predictRequestResponseLoggingConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1PredictRequestResponseLoggingConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
