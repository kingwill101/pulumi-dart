...
class GoogleCloudAiplatformV1ModelMonitoringObjectiveConfigTrainingPredictionSkewDetectionConfig {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1ThresholdConfig>? defaultSkewThreshold;
  /// Key is the feature name and value is the threshold. If a feature needs to be monitored for skew, a value threshold must be configured for that feature. The threshold here is against feature distribution distance between the training and prediction feature.
  final pulumi.Input<Map<String, String>>? skewThresholds;

  /// Creates a new [GoogleCloudAiplatformV1ModelMonitoringObjectiveConfigTrainingPredictionSkewDetectionConfig].
  ...
  const GoogleCloudAiplatformV1ModelMonitoringObjectiveConfigTrainingPredictionSkewDetectionConfig({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'defaultSkewThreshold': ?pulumi.Input.mapOptionalInputValue<GoogleCloudAiplatformV1ThresholdConfig, Map<String, dynamic>>(defaultSkewThreshold, (value) => value.toMap()),
      'skewThresholds': ?skewThresholds,
    };
  }

  factory GoogleCloudAiplatformV1ModelMonitoringObjectiveConfigTrainingPredictionSkewDetectionConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1ModelMonitoringObjectiveConfigTrainingPredictionSkewDetectionConfig(
      attributionScoreSkewThresholds: (() { final guardedValue = map['attributionScoreSkewThresholds']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      defaultSkewThreshold: (() { final guardedValue = map['defaultSkewThreshold']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1ThresholdConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      skewThresholds: (() { final guardedValue = map['skewThresholds']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
    );
  }
}
