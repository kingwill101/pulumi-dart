...
class GoogleCloudAiplatformV1beta1DeployedIndexResponse {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1beta1AutomaticResourcesResponse>
  automaticResources;
  ...
  final pulumi.Input<GoogleCloudAiplatformV1beta1DedicatedResourcesResponse>
  dedicatedResources;
  ...
  final pulumi.Input<GoogleCloudAiplatformV1beta1IndexPrivateEndpointsResponse>
  privateEndpoints;
  ...
  factory GoogleCloudAiplatformV1beta1DeployedIndexResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return GoogleCloudAiplatformV1beta1DeployedIndexResponse(
      automaticResources: pulumi.Input.fromValue(
        GoogleCloudAiplatformV1beta1AutomaticResourcesResponse.fromMap(
          (map['automaticResources']! as Map).cast<String, dynamic>(),
        ),
      ),
      createTime: pulumi.Input.fromValue(map['createTime'] as String),
      dedicatedResources: pulumi.Input.fromValue(
        GoogleCloudAiplatformV1beta1DedicatedResourcesResponse.fromMap(
          (map['dedicatedResources']! as Map).cast<String, dynamic>(),
        ),
      ),
      deployedIndexAuthConfig: pulumi.Input.fromValue(
        GoogleCloudAiplatformV1beta1DeployedIndexAuthConfigResponse.fromMap(
          (map['deployedIndexAuthConfig']! as Map).cast<String, dynamic>(),
        ),
      ),
      deploymentGroup: pulumi.Input.fromValue(map['deploymentGroup'] as String),
      displayName: pulumi.Input.fromValue(map['displayName'] as String),
      enableAccessLogging: pulumi.Input.fromValue(
        map['enableAccessLogging'] as bool,
      ),
      index: pulumi.Input.fromValue(map['index'] as String),
      indexSyncTime: pulumi.Input.fromValue(map['indexSyncTime'] as String),
      privateEndpoints: pulumi.Input.fromValue(
        GoogleCloudAiplatformV1beta1IndexPrivateEndpointsResponse.fromMap(
