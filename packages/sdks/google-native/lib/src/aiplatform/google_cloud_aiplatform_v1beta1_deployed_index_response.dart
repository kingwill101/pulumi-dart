...
class GoogleCloudAiplatformV1beta1DeployedIndexResponse {
  ...
  const GoogleCloudAiplatformV1beta1DeployedIndexResponse({
  ...
  factory GoogleCloudAiplatformV1beta1DeployedIndexResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1DeployedIndexResponse(
      ...
      deployedIndexAuthConfig: pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1DeployedIndexAuthConfigResponse.fromMap((map['deployedIndexAuthConfig']! as Map).cast<String, dynamic>())),
      ...
      privateEndpoints: pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1IndexPrivateEndpointsResponse.fromMap((map['privateEndpoints']! as Map).cast<String, dynamic>())),
