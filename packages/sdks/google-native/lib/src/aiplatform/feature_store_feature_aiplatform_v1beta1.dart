...
class FeatureStoreFeatureAiplatformV1beta1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<GoogleCloudAiplatformV1beta1FeatureStatsAnomalyResponse>> monitoringStats;
  /// Only applicable for Vertex AI Feature Store (Legacy). The list of historical stats and anomalies with specified objectives.
  late final pulumi.Output<List<GoogleCloudAiplatformV1beta1FeatureMonitoringStatsAnomalyResponse>> monitoringStatsAnomalies;
  ...
  FeatureStoreFeatureAiplatformV1beta1(
    ...
    this.monitoringConfig = registerOutput<GoogleCloudAiplatformV1beta1FeaturestoreMonitoringConfigResponse>('monitoringConfig');
    this.monitoringStats = registerOutput<List<GoogleCloudAiplatformV1beta1FeatureStatsAnomalyResponse>>('monitoringStats');
    this.monitoringStatsAnomalies = registerOutput<List<GoogleCloudAiplatformV1beta1FeatureMonitoringStatsAnomalyResponse>>('monitoringStatsAnomalies');
