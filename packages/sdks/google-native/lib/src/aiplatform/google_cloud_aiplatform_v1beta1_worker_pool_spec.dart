...
class GoogleCloudAiplatformV1beta1WorkerPoolSpec {
  ...
  const GoogleCloudAiplatformV1beta1WorkerPoolSpec({
    this.containerSpec,
    this.diskSpec,
    this.machineSpec,
    this.nfsMounts,
  ...
  factory GoogleCloudAiplatformV1beta1WorkerPoolSpec.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1WorkerPoolSpec(
      containerSpec: (() { final guardedValue = map['containerSpec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1ContainerSpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      nfsMounts: (() { final guardedValue = map['nfsMounts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudAiplatformV1beta1NfsMount>(guardedValue, (value) => GoogleCloudAiplatformV1beta1NfsMount.fromMap((value as Map).cast<String, dynamic>()))); })(),
      pythonPackageSpec: (() { final guardedValue = map['pythonPackageSpec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1PythonPackageSpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
