...
class GoogleCloudAiplatformV1beta1NasJobSpec {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpec>? multiTrialAlgorithmSpec;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'multiTrialAlgorithmSpec': ?pulumi.Input.mapOptionalInputValue<GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpec, Map<String, dynamic>>(multiTrialAlgorithmSpec, (value) => value.toMap()),
  ...
  factory GoogleCloudAiplatformV1beta1NasJobSpec.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1NasJobSpec(
      multiTrialAlgorithmSpec: (() { final guardedValue = map['multiTrialAlgorithmSpec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      resumeNasJobId: (() { final guardedValue = map['resumeNasJobId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      searchSpaceSpec: (() { final guardedValue = map['searchSpaceSpec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
