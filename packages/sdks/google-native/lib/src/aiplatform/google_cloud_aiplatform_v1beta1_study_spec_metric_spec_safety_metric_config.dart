...
class GoogleCloudAiplatformV1beta1StudySpecMetricSpecSafetyMetricConfig {
  ...
  const GoogleCloudAiplatformV1beta1StudySpecMetricSpecSafetyMetricConfig({
  ...
  factory GoogleCloudAiplatformV1beta1StudySpecMetricSpecSafetyMetricConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1StudySpecMetricSpecSafetyMetricConfig(
      desiredMinSafeTrialsFraction: (() { final guardedValue = map['desiredMinSafeTrialsFraction']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as double); })(),
      safetyThreshold: (() { final guardedValue = map['safetyThreshold']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as double); })(),
    );
  }
}
