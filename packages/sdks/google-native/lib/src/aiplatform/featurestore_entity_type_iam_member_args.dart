...
/// {@template pulumi_aiplatform_v1_featurestore_entity_type_iam_member_args_doc}
/// The set of arguments for FeaturestoreEntityTypeIamMember.
/// {@endtemplate}
/// {@macro pulumi_aiplatform_v1_featurestore_entity_type_iam_member_args_doc}
class FeaturestoreEntityTypeIamMemberArgs {
  ...
  /// Creates a new [FeaturestoreEntityTypeIamMemberArgs].
  ...
  const FeaturestoreEntityTypeIamMemberArgs({
    this.condition,
  ...
  factory FeaturestoreEntityTypeIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return FeaturestoreEntityTypeIamMemberArgs(
