...
class GoogleCloudAiplatformV1beta1ExplanationParametersResponse {
  ...
  final GoogleCloudAiplatformV1beta1IntegratedGradientsAttributionResponse integratedGradientsAttribution;
  ...
  final GoogleCloudAiplatformV1beta1SampledShapleyAttributionResponse sampledShapleyAttribution;
  ...
  factory GoogleCloudAiplatformV1beta1ExplanationParametersResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1ExplanationParametersResponse(
      examples: GoogleCloudAiplatformV1beta1ExamplesResponse.fromMap((map['examples'] as Map).cast<String, dynamic>()),
      integratedGradientsAttribution: GoogleCloudAiplatformV1beta1IntegratedGradientsAttributionResponse.fromMap((map['integratedGradientsAttribution'] as Map).cast<String, dynamic>()),
      outputIndices: (map['outputIndices'] as List).cast<dynamic>(),
      sampledShapleyAttribution: GoogleCloudAiplatformV1beta1SampledShapleyAttributionResponse.fromMap((map['sampledShapleyAttribution'] as Map).cast<String, dynamic>()),
      topK: map['topK'] as int,
      xraiAttribution: GoogleCloudAiplatformV1beta1XraiAttributionResponse.fromMap((map['xraiAttribution'] as Map).cast<String, dynamic>()),
    );
  }
}
