...
class GoogleCloudAiplatformV1beta1ExplanationParametersResponse {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1beta1XraiAttributionResponse>
  xraiAttribution;
  ...
  factory GoogleCloudAiplatformV1beta1ExplanationParametersResponse.fromMap(
    ...
    return GoogleCloudAiplatformV1beta1ExplanationParametersResponse(
      examples: pulumi.Input.fromValue(
        GoogleCloudAiplatformV1beta1ExamplesResponse.fromMap(
          (map['examples']! as Map).cast<String, dynamic>(),
        ),
      ),
      integratedGradientsAttribution: pulumi.Input.fromValue(
        GoogleCloudAiplatformV1beta1IntegratedGradientsAttributionResponse.fromMap(
          (map['integratedGradientsAttribution']! as Map)
              .cast<String, dynamic>(),
        ),
      ),
      outputIndices: pulumi.Input.fromValue(
