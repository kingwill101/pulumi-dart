...
/// {@template pulumi_aiplatform_v1_notebook_runtime_template_iam_binding_args_doc}
/// The set of arguments for NotebookRuntimeTemplateIamBinding.
/// {@endtemplate}
/// {@macro pulumi_aiplatform_v1_notebook_runtime_template_iam_binding_args_doc}
class NotebookRuntimeTemplateIamBindingArgs {
  ...
  /// Creates a new [NotebookRuntimeTemplateIamBindingArgs].
  ...
  const NotebookRuntimeTemplateIamBindingArgs({
    this.condition,
  ...
  factory NotebookRuntimeTemplateIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return NotebookRuntimeTemplateIamBindingArgs(
