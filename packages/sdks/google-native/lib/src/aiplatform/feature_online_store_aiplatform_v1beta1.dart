...
class FeatureOnlineStoreAiplatformV1beta1 extends pulumi.CustomResource {
  ...
  FeatureOnlineStoreAiplatformV1beta1(
    ...
    this.bigtable = registerOutput<GoogleCloudAiplatformV1beta1FeatureOnlineStoreBigtableResponse>('bigtable');
    this.createTime = registerOutput<String>('createTime');
    this.dedicatedServingEndpoint = registerOutput<GoogleCloudAiplatformV1beta1FeatureOnlineStoreDedicatedServingEndpointResponse>('dedicatedServingEndpoint');
    this.embeddingManagement = registerOutput<GoogleCloudAiplatformV1beta1FeatureOnlineStoreEmbeddingManagementResponse>('embeddingManagement');
