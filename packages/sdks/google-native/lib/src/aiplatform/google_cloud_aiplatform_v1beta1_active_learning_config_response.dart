...
class GoogleCloudAiplatformV1beta1ActiveLearningConfigResponse {
  ...
  factory GoogleCloudAiplatformV1beta1ActiveLearningConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1ActiveLearningConfigResponse(
      ...
      sampleConfig: GoogleCloudAiplatformV1beta1SampleConfigResponse.fromMap((map['sampleConfig'] as Map).cast<String, dynamic>()),
      trainingConfig: GoogleCloudAiplatformV1beta1TrainingConfigResponse.fromMap((map['trainingConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
