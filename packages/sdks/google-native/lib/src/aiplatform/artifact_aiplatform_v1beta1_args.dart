...
class ArtifactAiplatformV1beta1Args {
  ...
  const ArtifactAiplatformV1beta1Args({
    this.artifactId,
    this.description,
    this.displayName,
    this.etag,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'state': ?pulumi.Input.mapOptionalInputValue<ArtifactStateAiplatformV1beta1, String>(state, (value) => value.wireValue),
      'uri': ?uri,
    };
  }
  ...
  factory ArtifactAiplatformV1beta1Args.fromMap(Map<String, dynamic> map) {
    return ArtifactAiplatformV1beta1Args(
      ...
      state: (() { final guardedValue = map['state']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ArtifactStateAiplatformV1beta1.fromValue(guardedValue as String)); })(),
