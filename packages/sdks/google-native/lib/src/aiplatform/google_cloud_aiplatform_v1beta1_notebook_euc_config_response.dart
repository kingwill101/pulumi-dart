...
class GoogleCloudAiplatformV1beta1NotebookEucConfigResponse {
  ...
  const GoogleCloudAiplatformV1beta1NotebookEucConfigResponse({
  ...
  factory GoogleCloudAiplatformV1beta1NotebookEucConfigResponse.fromMap(Map<String, dynamic> map) {
