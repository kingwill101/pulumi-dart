...
class MetadataSchemaAiplatformV1beta1Args {
  ...
  const MetadataSchemaAiplatformV1beta1Args({
    this.description,
    this.location,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'project': ?project,
      'schema': schema,
      'schemaType': ?pulumi.Input.mapOptionalInputValue<MetadataSchemaSchemaTypeAiplatformV1beta1, String>(schemaType, (value) => value.wireValue),
  ...
  factory MetadataSchemaAiplatformV1beta1Args.fromMap(Map<String, dynamic> map) {
    return MetadataSchemaAiplatformV1beta1Args(
      ...
      schemaType: (() { final guardedValue = map['schemaType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MetadataSchemaSchemaTypeAiplatformV1beta1.fromValue(guardedValue as String)); })(),
