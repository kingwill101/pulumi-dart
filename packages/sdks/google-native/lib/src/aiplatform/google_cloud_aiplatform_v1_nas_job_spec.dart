...
class GoogleCloudAiplatformV1NasJobSpec {
  ...
  const GoogleCloudAiplatformV1NasJobSpec({
  ...
  factory GoogleCloudAiplatformV1NasJobSpec.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1NasJobSpec(
      multiTrialAlgorithmSpec: (() { final guardedValue = map['multiTrialAlgorithmSpec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1NasJobSpecMultiTrialAlgorithmSpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
