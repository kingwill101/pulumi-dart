...
class GoogleCloudAiplatformV1beta1ModelContainerSpec {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1beta1Probe>? healthProbe;
  ...
  final pulumi.Input<List<GoogleCloudAiplatformV1beta1Port>>? ports;
  ...
  final pulumi.Input<GoogleCloudAiplatformV1beta1Probe>? startupProbe;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ports':
          ?pulumi.Input.mapOptionalInputValue<
            List<GoogleCloudAiplatformV1beta1Port>,
            List<Map<String, dynamic>>
          >(
            ports,
            (value) =>
