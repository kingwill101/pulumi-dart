...
class GoogleCloudAiplatformV1beta1CustomJobSpecResponse {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1beta1GcsDestinationResponse> baseOutputDirectory;
  ...
  final pulumi.Input<List<GoogleCloudAiplatformV1beta1WorkerPoolSpecResponse>> workerPoolSpecs;
  ...
  const GoogleCloudAiplatformV1beta1CustomJobSpecResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'baseOutputDirectory': pulumi.Input.mapInputValue<GoogleCloudAiplatformV1beta1GcsDestinationResponse, Map<String, dynamic>>(baseOutputDirectory, (value) => value.toMap()),
      ...
      'scheduling': pulumi.Input.mapInputValue<GoogleCloudAiplatformV1beta1SchedulingResponse, Map<String, dynamic>>(scheduling, (value) => value.toMap()),
      'serviceAccount': serviceAccount,
      'tensorboard': tensorboard,
      'workerPoolSpecs': pulumi.Input.mapInputValue<List<GoogleCloudAiplatformV1beta1WorkerPoolSpecResponse>, List<Map<String, dynamic>>>(workerPoolSpecs, (value) => pulumi.Input.encodeList<GoogleCloudAiplatformV1beta1WorkerPoolSpecResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory GoogleCloudAiplatformV1beta1CustomJobSpecResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1CustomJobSpecResponse(
      baseOutputDirectory: pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1GcsDestinationResponse.fromMap((map['baseOutputDirectory']! as Map).cast<String, dynamic>())),
      ...
      scheduling: pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1SchedulingResponse.fromMap((map['scheduling']! as Map).cast<String, dynamic>())),
      serviceAccount: pulumi.Input.fromValue(map['serviceAccount'] as String),
      tensorboard: pulumi.Input.fromValue(map['tensorboard'] as String),
      workerPoolSpecs: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudAiplatformV1beta1WorkerPoolSpecResponse>(map['workerPoolSpecs']!, (value) => GoogleCloudAiplatformV1beta1WorkerPoolSpecResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
