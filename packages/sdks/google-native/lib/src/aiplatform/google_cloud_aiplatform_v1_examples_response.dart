...
class GoogleCloudAiplatformV1ExamplesResponse {
  ...
  factory GoogleCloudAiplatformV1ExamplesResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1ExamplesResponse(
      exampleGcsSource: (GoogleCloudAiplatformV1ExamplesExampleGcsSourceResponse.fromMap((map['exampleGcsSource'] as Map).cast<String, dynamic>())).input(),
      nearestNeighborSearchConfig: (map['nearestNeighborSearchConfig']).input(),
      neighborCount: (map['neighborCount'] as int).input(),
      presets: (GoogleCloudAiplatformV1PresetsResponse.fromMap((map['presets'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
