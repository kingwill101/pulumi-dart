...
class GoogleCloudAiplatformV1beta1ModelMonitoringConfigResponse {
  ...
  final pulumi.Input<
    List<GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigResponse>
  >
  objectiveConfigs;
  ...
  factory GoogleCloudAiplatformV1beta1ModelMonitoringConfigResponse.fromMap(
    ...
    return GoogleCloudAiplatformV1beta1ModelMonitoringConfigResponse(
      ...
      analysisInstanceSchemaUri: pulumi.Input.fromValue(
        map['analysisInstanceSchemaUri'] as String,
      ),
      objectiveConfigs: pulumi.Input.fromValue(
      ...
      statsAnomaliesBaseDirectory: pulumi.Input.fromValue(
        GoogleCloudAiplatformV1beta1GcsDestinationResponse.fromMap(
          (map['statsAnomaliesBaseDirectory']! as Map).cast<String, dynamic>(),
        ),
      ),
    );
  }
