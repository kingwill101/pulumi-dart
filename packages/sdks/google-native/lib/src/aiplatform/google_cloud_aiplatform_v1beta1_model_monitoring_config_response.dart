...
class GoogleCloudAiplatformV1beta1ModelMonitoringConfigResponse {
  ...
  factory GoogleCloudAiplatformV1beta1ModelMonitoringConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1ModelMonitoringConfigResponse(
      alertConfig: (GoogleCloudAiplatformV1beta1ModelMonitoringAlertConfigResponse.fromMap((map['alertConfig'] as Map).cast<String, dynamic>())).input(),
      analysisInstanceSchemaUri: (map['analysisInstanceSchemaUri'] as String).input(),
      objectiveConfigs: (pulumi.Input.decodeList<GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigResponse>(map['objectiveConfigs'], (value) => GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      statsAnomaliesBaseDirectory: (GoogleCloudAiplatformV1beta1GcsDestinationResponse.fromMap((map['statsAnomaliesBaseDirectory'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
