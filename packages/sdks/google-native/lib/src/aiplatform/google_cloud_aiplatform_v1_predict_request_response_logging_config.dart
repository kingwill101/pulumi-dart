...
class GoogleCloudAiplatformV1PredictRequestResponseLoggingConfig {
  ...
  const GoogleCloudAiplatformV1PredictRequestResponseLoggingConfig({
  ...
  factory GoogleCloudAiplatformV1PredictRequestResponseLoggingConfig.fromMap(Map<String, dynamic> map) {
