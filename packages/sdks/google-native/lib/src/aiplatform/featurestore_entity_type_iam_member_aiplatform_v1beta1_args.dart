...
/// {@template pulumi_aiplatform_v1beta1_featurestore_entity_type_iam_member_aiplatform_v1beta1_args_doc}
/// The set of arguments for FeaturestoreEntityTypeIamMember.
/// {@endtemplate}
/// {@macro pulumi_aiplatform_v1beta1_featurestore_entity_type_iam_member_aiplatform_v1beta1_args_doc}
class FeaturestoreEntityTypeIamMemberAiplatformV1beta1Args {
  ...
  /// Creates a new [FeaturestoreEntityTypeIamMemberAiplatformV1beta1Args].
  ...
  const FeaturestoreEntityTypeIamMemberAiplatformV1beta1Args({
    this.condition,
  ...
  factory FeaturestoreEntityTypeIamMemberAiplatformV1beta1Args.fromMap(Map<String, dynamic> map) {
    return FeaturestoreEntityTypeIamMemberAiplatformV1beta1Args(
