...
class GoogleCloudAiplatformV1beta1ModelMonitoringStatsAnomaliesFeatureHistoricStatsAnomalies {
  ...
  final pulumi.Input<List<GoogleCloudAiplatformV1beta1FeatureStatsAnomaly>>?
  predictionStats;
  ...
  final pulumi.Input<GoogleCloudAiplatformV1beta1FeatureStatsAnomaly>?
  trainingStats;
  ...
  factory GoogleCloudAiplatformV1beta1ModelMonitoringStatsAnomaliesFeatureHistoricStatsAnomalies.fromMap(
    ...
    return GoogleCloudAiplatformV1beta1ModelMonitoringStatsAnomaliesFeatureHistoricStatsAnomalies(
      featureDisplayName: (() {
        final guardedValue = map['featureDisplayName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      predictionStats: (() {
        final guardedValue = map['predictionStats'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => GoogleCloudAiplatformV1beta1FeatureStatsAnomaly.fromMap(
      ...
      trainingStats: (() {
        final guardedValue = map['trainingStats'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
