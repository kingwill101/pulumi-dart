...
class GoogleCloudAiplatformV1IntegratedGradientsAttributionResponse {
  ...
  factory GoogleCloudAiplatformV1IntegratedGradientsAttributionResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1IntegratedGradientsAttributionResponse(
      blurBaselineConfig: GoogleCloudAiplatformV1BlurBaselineConfigResponse.fromMap((map['blurBaselineConfig'] as Map).cast<String, dynamic>()),
      smoothGradConfig: GoogleCloudAiplatformV1SmoothGradConfigResponse.fromMap((map['smoothGradConfig'] as Map).cast<String, dynamic>()),
