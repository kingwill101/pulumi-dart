...
/// {@template pulumi_aiplatform_v1_featurestore_iam_member_args_doc}
/// The set of arguments for FeaturestoreIamMember.
/// {@endtemplate}
/// {@macro pulumi_aiplatform_v1_featurestore_iam_member_args_doc}
class FeaturestoreIamMemberArgs {
  ...
  /// Creates a new [FeaturestoreIamMemberArgs].
  ...
  const FeaturestoreIamMemberArgs({
    this.condition,
  ...
  factory FeaturestoreIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return FeaturestoreIamMemberArgs(
