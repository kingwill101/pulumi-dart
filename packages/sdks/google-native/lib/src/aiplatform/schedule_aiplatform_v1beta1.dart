...
class ScheduleAiplatformV1beta1 extends pulumi.CustomResource {
  ...
  ScheduleAiplatformV1beta1(
    ...
    this.createPipelineJobRequest = registerOutput<GoogleCloudAiplatformV1beta1CreatePipelineJobRequestResponse>('createPipelineJobRequest');
    ...
    this.lastScheduledRunResponse = registerOutput<GoogleCloudAiplatformV1beta1ScheduleRunResponseResponse>('lastScheduledRunResponse');
