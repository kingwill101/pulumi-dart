...
import 'feature_store_feature_value_type.dart';

/// {@template pulumi_aiplatform_v1_feature_store_feature_args_doc}
/// The set of arguments for FeatureStoreFeature.
/// {@endtemplate}
/// {@macro pulumi_aiplatform_v1_feature_store_feature_args_doc}
class FeatureStoreFeatureArgs {
  ...
  /// Creates a new [FeatureStoreFeatureArgs].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'project': ?project,
      'valueType': ?pulumi.Input.mapOptionalInputValue<FeatureStoreFeatureValueType, String>(valueType, (value) => value.wireValue),
  ...
  factory FeatureStoreFeatureArgs.fromMap(Map<String, dynamic> map) {
    return FeatureStoreFeatureArgs(
      ...
      valueType: (() { final guardedValue = map['valueType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FeatureStoreFeatureValueType.fromValue(guardedValue as String)); })(),
