...
class GoogleCloudAiplatformV1beta1PipelineJobRuntimeConfig {
  ...
  final GoogleCloudAiplatformV1beta1PipelineJobRuntimeConfigFailurePolicy? failurePolicy;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'failurePolicy': ?failurePolicy == null ? null : failurePolicy!.value,
  ...
  factory GoogleCloudAiplatformV1beta1PipelineJobRuntimeConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1PipelineJobRuntimeConfig(
      failurePolicy: map['failurePolicy'] == null ? null : GoogleCloudAiplatformV1beta1PipelineJobRuntimeConfigFailurePolicy.fromValue(map['failurePolicy'] as String),
      gcsOutputDirectory: map['gcsOutputDirectory'] as String,
      inputArtifacts: map['inputArtifacts'] == null ? null : (map['inputArtifacts'] as Map).cast<String, String>(),
