...
class GoogleCloudAiplatformV1beta1PipelineJobRuntimeConfig {
  ...
  /// Creates a new [GoogleCloudAiplatformV1beta1PipelineJobRuntimeConfig].
  ...
  const GoogleCloudAiplatformV1beta1PipelineJobRuntimeConfig({
    this.failurePolicy,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'failurePolicy': ?pulumi.Input.mapOptionalInputValue<GoogleCloudAiplatformV1beta1PipelineJobRuntimeConfigFailurePolicy, String>(failurePolicy, (value) => value.wireValue),
  ...
  factory GoogleCloudAiplatformV1beta1PipelineJobRuntimeConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1PipelineJobRuntimeConfig(
      failurePolicy: (() { final guardedValue = map['failurePolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1PipelineJobRuntimeConfigFailurePolicy.fromValue(guardedValue as String)); })(),
