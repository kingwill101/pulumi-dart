...
class GoogleCloudAiplatformV1StudySpecStudyStoppingConfig {
  ...
  const GoogleCloudAiplatformV1StudySpecStudyStoppingConfig({
  ...
  factory GoogleCloudAiplatformV1StudySpecStudyStoppingConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1StudySpecStudyStoppingConfig(
      ...
      maximumRuntimeConstraint: (() { final guardedValue = map['maximumRuntimeConstraint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1StudyTimeConstraint.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      minimumRuntimeConstraint: (() { final guardedValue = map['minimumRuntimeConstraint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1StudyTimeConstraint.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
