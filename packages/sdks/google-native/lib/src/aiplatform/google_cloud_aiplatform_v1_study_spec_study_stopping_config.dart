...
class GoogleCloudAiplatformV1StudySpecStudyStoppingConfig {
  ...
  factory GoogleCloudAiplatformV1StudySpecStudyStoppingConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1StudySpecStudyStoppingConfig(
      ...
      maximumRuntimeConstraint: map['maximumRuntimeConstraint'] == null ? null : GoogleCloudAiplatformV1StudyTimeConstraint.fromMap((map['maximumRuntimeConstraint'] as Map).cast<String, dynamic>()),
      minNumTrials: map['minNumTrials'] == null ? null : map['minNumTrials'] as int,
      minimumRuntimeConstraint: map['minimumRuntimeConstraint'] == null ? null : GoogleCloudAiplatformV1StudyTimeConstraint.fromMap((map['minimumRuntimeConstraint'] as Map).cast<String, dynamic>()),
