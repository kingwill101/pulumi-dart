...
class GoogleCloudAiplatformV1beta1ActiveLearningConfig {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1beta1TrainingConfig>?
  trainingConfig;
  ...
  factory GoogleCloudAiplatformV1beta1ActiveLearningConfig.fromMap(
    ...
    return GoogleCloudAiplatformV1beta1ActiveLearningConfig(
      maxDataItemCount: (() {
        final guardedValue = map['maxDataItemCount'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      maxDataItemPercentage: (() {
        final guardedValue = map['maxDataItemPercentage'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      sampleConfig: (() {
        final guardedValue = map['sampleConfig'];
        if (guardedValue == null) return null;
      ...
      trainingConfig: (() {
        final guardedValue = map['trainingConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
