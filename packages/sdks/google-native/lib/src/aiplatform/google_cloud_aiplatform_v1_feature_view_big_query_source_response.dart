...
class GoogleCloudAiplatformV1FeatureViewBigQuerySourceResponse {
  ...
  const GoogleCloudAiplatformV1FeatureViewBigQuerySourceResponse({
  ...
  factory GoogleCloudAiplatformV1FeatureViewBigQuerySourceResponse.fromMap(Map<String, dynamic> map) {
