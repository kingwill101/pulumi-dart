...
class NotebookRuntimeTemplate extends pulumi.CustomResource {
  ...
  NotebookRuntimeTemplate(
    ...
    this.dataPersistentDiskSpec = registerOutput<GoogleCloudAiplatformV1PersistentDiskSpecResponse>('dataPersistentDiskSpec');
    this.description = registerOutput<String>('description');
    this.displayName = registerOutput<String>('displayName');
    this.etag = registerOutput<String>('etag');
    this.eucConfig = registerOutput<GoogleCloudAiplatformV1NotebookEucConfigResponse>('eucConfig');
    this.idleShutdownConfig = registerOutput<GoogleCloudAiplatformV1NotebookIdleShutdownConfigResponse>('idleShutdownConfig');
    this.isDefault = registerOutput<bool>('isDefault');
    this.labels = registerOutput<Map<String, String>>('labels');
    this.location = registerOutput<String>('location');
    this.machineSpec = registerOutput<GoogleCloudAiplatformV1MachineSpecResponse>('machineSpec');
    this.name = registerOutput<String>('name');
    this.networkSpec = registerOutput<GoogleCloudAiplatformV1NetworkSpecResponse>('networkSpec');
