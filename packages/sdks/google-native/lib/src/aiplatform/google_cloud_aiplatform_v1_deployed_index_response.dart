...
class GoogleCloudAiplatformV1DeployedIndexResponse {
  ...
  factory GoogleCloudAiplatformV1DeployedIndexResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1DeployedIndexResponse(
      automaticResources: (GoogleCloudAiplatformV1AutomaticResourcesResponse.fromMap((map['automaticResources'] as Map).cast<String, dynamic>())).input(),
      createTime: (map['createTime'] as String).input(),
      dedicatedResources: (GoogleCloudAiplatformV1DedicatedResourcesResponse.fromMap((map['dedicatedResources'] as Map).cast<String, dynamic>())).input(),
      deployedIndexAuthConfig: (GoogleCloudAiplatformV1DeployedIndexAuthConfigResponse.fromMap((map['deployedIndexAuthConfig'] as Map).cast<String, dynamic>())).input(),
      ...
      privateEndpoints: (GoogleCloudAiplatformV1IndexPrivateEndpointsResponse.fromMap((map['privateEndpoints'] as Map).cast<String, dynamic>())).input(),
