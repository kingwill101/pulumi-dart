...
class GoogleCloudAiplatformV1DeployedIndexResponse {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1AutomaticResourcesResponse> automaticResources;
  ...
  final pulumi.Input<GoogleCloudAiplatformV1DedicatedResourcesResponse> dedicatedResources;
  /// Optional. If set, the authentication is enabled for the private endpoint.
  final pulumi.Input<GoogleCloudAiplatformV1DeployedIndexAuthConfigResponse> deployedIndexAuthConfig;
  ...
  final pulumi.Input<GoogleCloudAiplatformV1IndexPrivateEndpointsResponse> privateEndpoints;
  ...
  const GoogleCloudAiplatformV1DeployedIndexResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'automaticResources': pulumi.Input.mapInputValue<GoogleCloudAiplatformV1AutomaticResourcesResponse, Map<String, dynamic>>(automaticResources, (value) => value.toMap()),
      'createTime': createTime,
      'dedicatedResources': pulumi.Input.mapInputValue<GoogleCloudAiplatformV1DedicatedResourcesResponse, Map<String, dynamic>>(dedicatedResources, (value) => value.toMap()),
      'deployedIndexAuthConfig': pulumi.Input.mapInputValue<GoogleCloudAiplatformV1DeployedIndexAuthConfigResponse, Map<String, dynamic>>(deployedIndexAuthConfig, (value) => value.toMap()),
      'deploymentGroup': deploymentGroup,
      'displayName': displayName,
      'enableAccessLogging': enableAccessLogging,
      'index': index,
      'indexSyncTime': indexSyncTime,
      'privateEndpoints': pulumi.Input.mapInputValue<GoogleCloudAiplatformV1IndexPrivateEndpointsResponse, Map<String, dynamic>>(privateEndpoints, (value) => value.toMap()),
      'reservedIpRanges': reservedIpRanges,
    };
  }

  factory GoogleCloudAiplatformV1DeployedIndexResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1DeployedIndexResponse(
      automaticResources: pulumi.Input.fromValue(GoogleCloudAiplatformV1AutomaticResourcesResponse.fromMap((map['automaticResources']! as Map).cast<String, dynamic>())),
      createTime: pulumi.Input.fromValue(map['createTime'] as String),
      dedicatedResources: pulumi.Input.fromValue(GoogleCloudAiplatformV1DedicatedResourcesResponse.fromMap((map['dedicatedResources']! as Map).cast<String, dynamic>())),
      deployedIndexAuthConfig: pulumi.Input.fromValue(GoogleCloudAiplatformV1DeployedIndexAuthConfigResponse.fromMap((map['deployedIndexAuthConfig']! as Map).cast<String, dynamic>())),
      ...
      privateEndpoints: pulumi.Input.fromValue(GoogleCloudAiplatformV1IndexPrivateEndpointsResponse.fromMap((map['privateEndpoints']! as Map).cast<String, dynamic>())),
