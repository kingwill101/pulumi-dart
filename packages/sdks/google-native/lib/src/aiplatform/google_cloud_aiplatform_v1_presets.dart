...
class GoogleCloudAiplatformV1Presets {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'modality': ?pulumi.Input.mapOptionalInputValue<GoogleCloudAiplatformV1PresetsModality, String>(modality, (value) => value.wireValue),
      'query': ?pulumi.Input.mapOptionalInputValue<GoogleCloudAiplatformV1PresetsQuery, String>(query, (value) => value.wireValue),
    };
  }

  factory GoogleCloudAiplatformV1Presets.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1Presets(
      modality: (() { final guardedValue = map['modality']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1PresetsModality.fromValue(guardedValue as String)); })(),
      query: (() { final guardedValue = map['query']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1PresetsQuery.fromValue(guardedValue as String)); })(),
    );
  }
}
