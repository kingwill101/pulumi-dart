...
class GoogleCloudAiplatformV1beta1StratifiedSplitResponse {
  ...
  /// Creates a new [GoogleCloudAiplatformV1beta1StratifiedSplitResponse].
  ...
  const GoogleCloudAiplatformV1beta1StratifiedSplitResponse({
    required this.key,
  ...
  factory GoogleCloudAiplatformV1beta1StratifiedSplitResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1StratifiedSplitResponse(
