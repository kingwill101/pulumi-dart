...
class GoogleCloudAiplatformV1beta1FeatureViewVectorSearchConfig {
    ...
    return <String, dynamic>{
      ...
      'distanceMeasureType':
          ?pulumi.Input.mapOptionalInputValue<
            GoogleCloudAiplatformV1beta1FeatureViewVectorSearchConfigDistanceMeasureType,
            String
          >(distanceMeasureType, (value) => value.wireValue),
  ...
  factory GoogleCloudAiplatformV1beta1FeatureViewVectorSearchConfig.fromMap(
    ...
    return GoogleCloudAiplatformV1beta1FeatureViewVectorSearchConfig(
      ...
      crowdingColumn: (() {
        final guardedValue = map['crowdingColumn'];
        if (guardedValue == null) return null;
      ...
      embeddingColumn: (() {
        final guardedValue = map['embeddingColumn'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      embeddingDimension: (() {
        final guardedValue = map['embeddingDimension'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      filterColumns: (() {
        final guardedValue = map['filterColumns'];
        if (guardedValue == null) return null;
