...
class GoogleCloudAiplatformV1beta1FeatureViewVectorSearchConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'distanceMeasureType': ?pulumi.Input.mapOptionalInputValue<GoogleCloudAiplatformV1beta1FeatureViewVectorSearchConfigDistanceMeasureType, String>(distanceMeasureType, (value) => value.value),
