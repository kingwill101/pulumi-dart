...
class GoogleCloudAiplatformV1beta1StudySpecMedianAutomatedStoppingSpecResponse {
  ...
  /// Creates a new [GoogleCloudAiplatformV1beta1StudySpecMedianAutomatedStoppingSpecResponse].
  ...
  const GoogleCloudAiplatformV1beta1StudySpecMedianAutomatedStoppingSpecResponse({
  ...
  factory GoogleCloudAiplatformV1beta1StudySpecMedianAutomatedStoppingSpecResponse.fromMap(Map<String, dynamic> map) {
