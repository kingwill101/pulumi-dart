...
class NotebookRuntimeTemplateAiplatformV1beta1 extends pulumi.CustomResource {
  ...
  NotebookRuntimeTemplateAiplatformV1beta1(
    ...
    this.dataPersistentDiskSpec = registerOutput<GoogleCloudAiplatformV1beta1PersistentDiskSpecResponse>('dataPersistentDiskSpec');
    this.description = registerOutput<String>('description');
    this.displayName = registerOutput<String>('displayName');
    this.etag = registerOutput<String>('etag');
    this.eucConfig = registerOutput<GoogleCloudAiplatformV1beta1NotebookEucConfigResponse>('eucConfig');
    this.idleShutdownConfig = registerOutput<GoogleCloudAiplatformV1beta1NotebookIdleShutdownConfigResponse>('idleShutdownConfig');
    this.isDefault = registerOutput<bool>('isDefault');
    this.labels = registerOutput<Map<String, String>>('labels');
    this.location = registerOutput<String>('location');
    this.machineSpec = registerOutput<GoogleCloudAiplatformV1beta1MachineSpecResponse>('machineSpec');
    this.name = registerOutput<String>('name');
    this.networkSpec = registerOutput<GoogleCloudAiplatformV1beta1NetworkSpecResponse>('networkSpec');
