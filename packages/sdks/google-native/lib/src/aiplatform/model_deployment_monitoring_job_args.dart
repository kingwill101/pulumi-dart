    ...
    return ModelDeploymentMonitoringJobArgs(
      ...
      modelDeploymentMonitoringObjectiveConfigs: pulumi.Input.fromValue(
        ...
        >(
          ...
          (value) =>
              GoogleCloudAiplatformV1ModelDeploymentMonitoringObjectiveConfig.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
      modelDeploymentMonitoringScheduleConfig: pulumi.Input.fromValue(
        GoogleCloudAiplatformV1ModelDeploymentMonitoringScheduleConfig.fromMap(
      ...
      modelMonitoringAlertConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GoogleCloudAiplatformV1ModelMonitoringAlertConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
