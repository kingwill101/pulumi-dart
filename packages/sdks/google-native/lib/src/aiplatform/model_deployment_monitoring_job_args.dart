...
class ModelDeploymentMonitoringJobArgs {
  ...
  ModelDeploymentMonitoringJobArgs({
    ...
    required pulumi.Output<GoogleCloudAiplatformV1SamplingStrategy> loggingSamplingStrategy,
    required pulumi.Output<List<GoogleCloudAiplatformV1ModelDeploymentMonitoringObjectiveConfig>> modelDeploymentMonitoringObjectiveConfigs,
    required pulumi.Output<GoogleCloudAiplatformV1ModelDeploymentMonitoringScheduleConfig> modelDeploymentMonitoringScheduleConfig,
    pulumi.Output<GoogleCloudAiplatformV1ModelMonitoringAlertConfig>? modelMonitoringAlertConfig,
    pulumi.Output<String>? predictInstanceSchemaUri,
    pulumi.Output<String>? project,
    pulumi.Output<dynamic>? samplePredictInstance,
    pulumi.Output<GoogleCloudAiplatformV1GcsDestination>? statsAnomaliesBaseDirectory,
  }) :
      ...
      loggingSamplingStrategy = pulumi.Input.asInput<GoogleCloudAiplatformV1SamplingStrategy>(loggingSamplingStrategy),
      modelDeploymentMonitoringObjectiveConfigs = pulumi.Input.asInput<List<GoogleCloudAiplatformV1ModelDeploymentMonitoringObjectiveConfig>>(modelDeploymentMonitoringObjectiveConfigs),
      modelDeploymentMonitoringScheduleConfig = pulumi.Input.asInput<GoogleCloudAiplatformV1ModelDeploymentMonitoringScheduleConfig>(modelDeploymentMonitoringScheduleConfig),
      modelMonitoringAlertConfig = pulumi.Input.asOptionalInput<GoogleCloudAiplatformV1ModelMonitoringAlertConfig>(modelMonitoringAlertConfig),
      ...
      statsAnomaliesBaseDirectory = pulumi.Input.asOptionalInput<GoogleCloudAiplatformV1GcsDestination>(statsAnomaliesBaseDirectory);
  ...
  factory ModelDeploymentMonitoringJobArgs.fromMap(Map<String, dynamic> map) {
    return ModelDeploymentMonitoringJobArgs(
      ...
      loggingSamplingStrategy: pulumi.Output.create<GoogleCloudAiplatformV1SamplingStrategy>(GoogleCloudAiplatformV1SamplingStrategy.fromMap((map['loggingSamplingStrategy'] as Map).cast<String, dynamic>())),
      modelDeploymentMonitoringObjectiveConfigs: pulumi.Output.create<List<GoogleCloudAiplatformV1ModelDeploymentMonitoringObjectiveConfig>>(pulumi.Input.decodeList<GoogleCloudAiplatformV1ModelDeploymentMonitoringObjectiveConfig>(map['modelDeploymentMonitoringObjectiveConfigs'], (value) => GoogleCloudAiplatformV1ModelDeploymentMonitoringObjectiveConfig.fromMap((value as Map).cast<String, dynamic>()))),
      modelDeploymentMonitoringScheduleConfig: pulumi.Output.create<GoogleCloudAiplatformV1ModelDeploymentMonitoringScheduleConfig>(GoogleCloudAiplatformV1ModelDeploymentMonitoringScheduleConfig.fromMap((map['modelDeploymentMonitoringScheduleConfig'] as Map).cast<String, dynamic>())),
      modelMonitoringAlertConfig: map['modelMonitoringAlertConfig'] == null ? null : pulumi.Output.create<GoogleCloudAiplatformV1ModelMonitoringAlertConfig>(GoogleCloudAiplatformV1ModelMonitoringAlertConfig.fromMap((map['modelMonitoringAlertConfig'] as Map).cast<String, dynamic>())),
      ...
      statsAnomaliesBaseDirectory: map['statsAnomaliesBaseDirectory'] == null ? null : pulumi.Output.create<GoogleCloudAiplatformV1GcsDestination>(GoogleCloudAiplatformV1GcsDestination.fromMap((map['statsAnomaliesBaseDirectory'] as Map).cast<String, dynamic>())),
    );
  }
}
