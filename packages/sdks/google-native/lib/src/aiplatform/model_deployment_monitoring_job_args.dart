...
class ModelDeploymentMonitoringJobArgs {
  ...
  const ModelDeploymentMonitoringJobArgs({
  ...
  factory ModelDeploymentMonitoringJobArgs.fromMap(Map<String, dynamic> map) {
    return ModelDeploymentMonitoringJobArgs(
      ...
      loggingSamplingStrategy: pulumi.Input.fromValue(GoogleCloudAiplatformV1SamplingStrategy.fromMap((map['loggingSamplingStrategy']! as Map).cast<String, dynamic>())),
      modelDeploymentMonitoringObjectiveConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudAiplatformV1ModelDeploymentMonitoringObjectiveConfig>(map['modelDeploymentMonitoringObjectiveConfigs']!, (value) => GoogleCloudAiplatformV1ModelDeploymentMonitoringObjectiveConfig.fromMap((value as Map).cast<String, dynamic>()))),
      modelDeploymentMonitoringScheduleConfig: pulumi.Input.fromValue(GoogleCloudAiplatformV1ModelDeploymentMonitoringScheduleConfig.fromMap((map['modelDeploymentMonitoringScheduleConfig']! as Map).cast<String, dynamic>())),
      modelMonitoringAlertConfig: (() { final guardedValue = map['modelMonitoringAlertConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1ModelMonitoringAlertConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      statsAnomaliesBaseDirectory: (() { final guardedValue = map['statsAnomaliesBaseDirectory']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1GcsDestination.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
