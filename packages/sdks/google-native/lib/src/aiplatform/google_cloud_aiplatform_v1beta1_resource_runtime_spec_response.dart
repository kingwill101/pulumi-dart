...
class GoogleCloudAiplatformV1beta1ResourceRuntimeSpecResponse {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1beta1ServiceAccountSpecResponse>
  serviceAccountSpec;
    ...
    return <String, dynamic>{
      'raySpec':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(raySpec, (value) => value.toMap()),
      'serviceAccountSpec':
          pulumi.Input.mapInputValue<
            GoogleCloudAiplatformV1beta1ServiceAccountSpecResponse,
            Map<String, dynamic>
          >(serviceAccountSpec, (value) => value.toMap()),
    };
  }
  ...
  factory GoogleCloudAiplatformV1beta1ResourceRuntimeSpecResponse.fromMap(
    ...
    return GoogleCloudAiplatformV1beta1ResourceRuntimeSpecResponse(
      raySpec: pulumi.Input.fromValue(
        GoogleCloudAiplatformV1beta1RaySpecResponse.fromMap(
          (map['raySpec']! as Map).cast<String, dynamic>(),
        ),
      ),
      serviceAccountSpec: pulumi.Input.fromValue(
