...
class GoogleCloudAiplatformV1beta1ResourceRuntimeSpecResponse {
  ...
  const GoogleCloudAiplatformV1beta1ResourceRuntimeSpecResponse({
  ...
  factory GoogleCloudAiplatformV1beta1ResourceRuntimeSpecResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1ResourceRuntimeSpecResponse(
      raySpec: pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1RaySpecResponse.fromMap((map['raySpec']! as Map).cast<String, dynamic>())),
      serviceAccountSpec: pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1ServiceAccountSpecResponse.fromMap((map['serviceAccountSpec']! as Map).cast<String, dynamic>())),
    );
  }
}
