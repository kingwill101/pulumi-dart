...
class GoogleCloudAiplatformV1XraiAttribution {
  ...
  factory GoogleCloudAiplatformV1XraiAttribution.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1XraiAttribution(
      blurBaselineConfig: map['blurBaselineConfig'] == null ? null : GoogleCloudAiplatformV1BlurBaselineConfig.fromMap((map['blurBaselineConfig'] as Map).cast<String, dynamic>()),
      smoothGradConfig: map['smoothGradConfig'] == null ? null : GoogleCloudAiplatformV1SmoothGradConfig.fromMap((map['smoothGradConfig'] as Map).cast<String, dynamic>()),
