...
import 'model_iam_member_args.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class ModelIamMember extends pulumi.CustomResource {
  ...
  /// Creates a new [ModelIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ModelIamMember]. {@macro pulumi_aiplatform_v1beta1_model_iam_member_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  ModelIamMember(
    String name, {
    ModelIamMemberArgs? args,
