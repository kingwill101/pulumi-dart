...
class GoogleCloudAiplatformV1beta1Probe {
  ...
  const GoogleCloudAiplatformV1beta1Probe({
    this.exec,
    this.periodSeconds,
    this.timeoutSeconds,
  });
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'exec': ?pulumi.Input.mapOptionalInputValue<GoogleCloudAiplatformV1beta1ProbeExecAction, Map<String, dynamic>>(exec, (value) => value.toMap()),
  ...
  factory GoogleCloudAiplatformV1beta1Probe.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1Probe(
      exec: (() { final guardedValue = map['exec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1ProbeExecAction.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
