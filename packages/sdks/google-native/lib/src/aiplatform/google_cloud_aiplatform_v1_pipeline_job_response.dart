...
class GoogleCloudAiplatformV1PipelineJobResponse {
  ...
  const GoogleCloudAiplatformV1PipelineJobResponse({
  ...
  factory GoogleCloudAiplatformV1PipelineJobResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1PipelineJobResponse(
      ...
      jobDetail: pulumi.Input.fromValue(GoogleCloudAiplatformV1PipelineJobDetailResponse.fromMap((map['jobDetail']! as Map).cast<String, dynamic>())),
      ...
      runtimeConfig: pulumi.Input.fromValue(GoogleCloudAiplatformV1PipelineJobRuntimeConfigResponse.fromMap((map['runtimeConfig']! as Map).cast<String, dynamic>())),
      scheduleName: pulumi.Input.fromValue(map['scheduleName'] as String),
      serviceAccount: pulumi.Input.fromValue(map['serviceAccount'] as String),
      startTime: pulumi.Input.fromValue(map['startTime'] as String),
      state: pulumi.Input.fromValue(map['state'] as String),
      templateMetadata: pulumi.Input.fromValue(GoogleCloudAiplatformV1PipelineTemplateMetadataResponse.fromMap((map['templateMetadata']! as Map).cast<String, dynamic>())),
