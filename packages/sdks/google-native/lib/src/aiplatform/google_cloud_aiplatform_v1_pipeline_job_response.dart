...
class GoogleCloudAiplatformV1PipelineJobResponse {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1PipelineJobDetailResponse>
  jobDetail;
  ...
  final pulumi.Input<GoogleCloudAiplatformV1PipelineJobRuntimeConfigResponse>
  runtimeConfig;
  ...
  final pulumi.Input<GoogleCloudAiplatformV1PipelineTemplateMetadataResponse>
  templateMetadata;
  ...
  factory GoogleCloudAiplatformV1PipelineJobResponse.fromMap(
    ...
    return GoogleCloudAiplatformV1PipelineJobResponse(
      ...
      jobDetail: pulumi.Input.fromValue(
        GoogleCloudAiplatformV1PipelineJobDetailResponse.fromMap(
      ...
      pipelineSpec: pulumi.Input.fromValue(
      ...
      runtimeConfig: pulumi.Input.fromValue(
        GoogleCloudAiplatformV1PipelineJobRuntimeConfigResponse.fromMap(
      ...
      templateMetadata: pulumi.Input.fromValue(
        GoogleCloudAiplatformV1PipelineTemplateMetadataResponse.fromMap(
