...
class GoogleCloudAiplatformV1PipelineJobResponse {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1PipelineJobDetailResponse> jobDetail;
  ...
  final pulumi.Input<GoogleCloudAiplatformV1PipelineJobRuntimeConfigResponse> runtimeConfig;
  ...
  final pulumi.Input<GoogleCloudAiplatformV1PipelineTemplateMetadataResponse> templateMetadata;
  ...
  /// Creates a new [GoogleCloudAiplatformV1PipelineJobResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'jobDetail': pulumi.Input.mapInputValue<GoogleCloudAiplatformV1PipelineJobDetailResponse, Map<String, dynamic>>(jobDetail, (value) => value.toMap()),
      'labels': labels,
      'name': name,
      'network': network,
      'pipelineSpec': pipelineSpec,
      'reservedIpRanges': reservedIpRanges,
      'runtimeConfig': pulumi.Input.mapInputValue<GoogleCloudAiplatformV1PipelineJobRuntimeConfigResponse, Map<String, dynamic>>(runtimeConfig, (value) => value.toMap()),
      'scheduleName': scheduleName,
      'serviceAccount': serviceAccount,
      'startTime': startTime,
      'state': state,
      'templateMetadata': pulumi.Input.mapInputValue<GoogleCloudAiplatformV1PipelineTemplateMetadataResponse, Map<String, dynamic>>(templateMetadata, (value) => value.toMap()),
      'templateUri': templateUri,
      'updateTime': updateTime,
    };
  }

  factory GoogleCloudAiplatformV1PipelineJobResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1PipelineJobResponse(
      createTime: (map['createTime'] as String).input(),
      displayName: (map['displayName'] as String).input(),
      encryptionSpec: (GoogleCloudAiplatformV1EncryptionSpecResponse.fromMap((map['encryptionSpec'] as Map).cast<String, dynamic>())).input(),
      endTime: (map['endTime'] as String).input(),
      error: (GoogleRpcStatusResponse.fromMap((map['error'] as Map).cast<String, dynamic>())).input(),
      jobDetail: (GoogleCloudAiplatformV1PipelineJobDetailResponse.fromMap((map['jobDetail'] as Map).cast<String, dynamic>())).input(),
      labels: ((map['labels'] as Map).cast<String, String>()).input(),
      name: (map['name'] as String).input(),
      network: (map['network'] as String).input(),
      pipelineSpec: ((map['pipelineSpec'] as Map).cast<String, String>()).input(),
      reservedIpRanges: ((map['reservedIpRanges'] as List).cast<String>()).input(),
      runtimeConfig: (GoogleCloudAiplatformV1PipelineJobRuntimeConfigResponse.fromMap((map['runtimeConfig'] as Map).cast<String, dynamic>())).input(),
      scheduleName: (map['scheduleName'] as String).input(),
      serviceAccount: (map['serviceAccount'] as String).input(),
      startTime: (map['startTime'] as String).input(),
      state: (map['state'] as String).input(),
      templateMetadata: (GoogleCloudAiplatformV1PipelineTemplateMetadataResponse.fromMap((map['templateMetadata'] as Map).cast<String, dynamic>())).input(),
      templateUri: (map['templateUri'] as String).input(),
