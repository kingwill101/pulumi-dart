...
class TrainingPipelineAiplatformV1beta1 extends pulumi.CustomResource {
  ...
  TrainingPipelineAiplatformV1beta1(
    ...
    this.inputDataConfig = registerOutput<GoogleCloudAiplatformV1beta1InputDataConfigResponse>('inputDataConfig');
    this.labels = registerOutput<Map<String, String>>('labels');
    this.location = registerOutput<String>('location');
    this.modelId = registerOutput<String>('modelId');
    this.modelToUpload = registerOutput<GoogleCloudAiplatformV1beta1ModelResponse>('modelToUpload');
