...
class GoogleCloudAiplatformV1ModelMonitoringObjectiveConfigResponse {
  ...
  factory GoogleCloudAiplatformV1ModelMonitoringObjectiveConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1ModelMonitoringObjectiveConfigResponse(
      explanationConfig: (GoogleCloudAiplatformV1ModelMonitoringObjectiveConfigExplanationConfigResponse.fromMap((map['explanationConfig'] as Map).cast<String, dynamic>())).input(),
      predictionDriftDetectionConfig: (GoogleCloudAiplatformV1ModelMonitoringObjectiveConfigPredictionDriftDetectionConfigResponse.fromMap((map['predictionDriftDetectionConfig'] as Map).cast<String, dynamic>())).input(),
      trainingDataset: (GoogleCloudAiplatformV1ModelMonitoringObjectiveConfigTrainingDatasetResponse.fromMap((map['trainingDataset'] as Map).cast<String, dynamic>())).input(),
      trainingPredictionSkewDetectionConfig: (GoogleCloudAiplatformV1ModelMonitoringObjectiveConfigTrainingPredictionSkewDetectionConfigResponse.fromMap((map['trainingPredictionSkewDetectionConfig'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
