...
class IndexEndpointAiplatformV1beta1Args {
  ...
  IndexEndpointAiplatformV1beta1Args({
    ...
    pulumi.Output<GoogleCloudAiplatformV1beta1PrivateServiceConnectConfig>? privateServiceConnectConfig,
    ...
    pulumi.Output<bool>? publicEndpointEnabled,
      ...
      privateServiceConnectConfig = pulumi.Input.asOptionalInput<GoogleCloudAiplatformV1beta1PrivateServiceConnectConfig>(privateServiceConnectConfig),
  ...
  factory IndexEndpointAiplatformV1beta1Args.fromMap(Map<String, dynamic> map) {
    return IndexEndpointAiplatformV1beta1Args(
      ...
      privateServiceConnectConfig: map['privateServiceConnectConfig'] == null ? null : pulumi.Output.create<GoogleCloudAiplatformV1beta1PrivateServiceConnectConfig>(GoogleCloudAiplatformV1beta1PrivateServiceConnectConfig.fromMap((map['privateServiceConnectConfig'] as Map).cast<String, dynamic>())),
