...
class GoogleCloudAiplatformV1beta1TrialResponse {
  ...
  final pulumi.Input<List<GoogleCloudAiplatformV1beta1MeasurementResponse>>
  measurements;
  ...
  final pulumi.Input<List<GoogleCloudAiplatformV1beta1TrialParameterResponse>>
  parameters;
  ...
  factory GoogleCloudAiplatformV1beta1TrialResponse.fromMap(
    ...
    return GoogleCloudAiplatformV1beta1TrialResponse(
      ...
      infeasibleReason: pulumi.Input.fromValue(
        map['infeasibleReason'] as String,
      ),
      measurements: pulumi.Input.fromValue(
        pulumi
            .Input.decodeList<GoogleCloudAiplatformV1beta1MeasurementResponse>(
          map['measurements']!,
          (value) => GoogleCloudAiplatformV1beta1MeasurementResponse.fromMap(
      ...
      parameters: pulumi.Input.fromValue(
        ...
        >(
          map['parameters']!,
          (value) => GoogleCloudAiplatformV1beta1TrialParameterResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      ...
      webAccessUris: pulumi.Input.fromValue(
