...
class GoogleCloudAiplatformV1beta1TrialResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'measurements': pulumi.Input.encodeList<GoogleCloudAiplatformV1beta1MeasurementResponse, Map<String, dynamic>>(measurements, (value) => value.toMap()),
      'name': name,
      'parameters': pulumi.Input.encodeList<GoogleCloudAiplatformV1beta1TrialParameterResponse, Map<String, dynamic>>(parameters, (value) => value.toMap()),
      'startTime': startTime,
      'state': state,
  ...
  factory GoogleCloudAiplatformV1beta1TrialResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1TrialResponse(
      ...
      measurements: pulumi.Input.decodeList<GoogleCloudAiplatformV1beta1MeasurementResponse>(map['measurements'], (value) => GoogleCloudAiplatformV1beta1MeasurementResponse.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] as String,
      parameters: pulumi.Input.decodeList<GoogleCloudAiplatformV1beta1TrialParameterResponse>(map['parameters'], (value) => GoogleCloudAiplatformV1beta1TrialParameterResponse.fromMap((value as Map).cast<String, dynamic>())),
