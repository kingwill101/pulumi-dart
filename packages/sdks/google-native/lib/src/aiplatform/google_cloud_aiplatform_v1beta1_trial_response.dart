...
class GoogleCloudAiplatformV1beta1TrialResponse {
  ...
  final pulumi.Input<List<GoogleCloudAiplatformV1beta1MeasurementResponse>> measurements;
  /// Resource name of the Trial assigned by the service.
  final pulumi.Input<String> name;
  /// The parameters of the Trial.
  final pulumi.Input<List<GoogleCloudAiplatformV1beta1TrialParameterResponse>> parameters;
  ...
  /// Creates a new [GoogleCloudAiplatformV1beta1TrialResponse].
  ...
  const GoogleCloudAiplatformV1beta1TrialResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'measurements': pulumi.Input.mapInputValue<List<GoogleCloudAiplatformV1beta1MeasurementResponse>, List<Map<String, dynamic>>>(measurements, (value) => pulumi.Input.encodeList<GoogleCloudAiplatformV1beta1MeasurementResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'name': name,
      'parameters': pulumi.Input.mapInputValue<List<GoogleCloudAiplatformV1beta1TrialParameterResponse>, List<Map<String, dynamic>>>(parameters, (value) => pulumi.Input.encodeList<GoogleCloudAiplatformV1beta1TrialParameterResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'startTime': startTime,
      'state': state,
  ...
  factory GoogleCloudAiplatformV1beta1TrialResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1TrialResponse(
      clientId: pulumi.Input.fromValue(map['clientId'] as String),
      customJob: pulumi.Input.fromValue(map['customJob'] as String),
      endTime: pulumi.Input.fromValue(map['endTime'] as String),
      finalMeasurement: pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1MeasurementResponse.fromMap((map['finalMeasurement']! as Map).cast<String, dynamic>())),
      infeasibleReason: pulumi.Input.fromValue(map['infeasibleReason'] as String),
      measurements: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudAiplatformV1beta1MeasurementResponse>(map['measurements']!, (value) => GoogleCloudAiplatformV1beta1MeasurementResponse.fromMap((value as Map).cast<String, dynamic>()))),
      name: pulumi.Input.fromValue(map['name'] as String),
      parameters: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudAiplatformV1beta1TrialParameterResponse>(map['parameters']!, (value) => GoogleCloudAiplatformV1beta1TrialParameterResponse.fromMap((value as Map).cast<String, dynamic>()))),
