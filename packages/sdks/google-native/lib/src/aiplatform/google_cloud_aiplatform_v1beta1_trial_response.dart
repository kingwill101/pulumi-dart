...
class GoogleCloudAiplatformV1beta1TrialResponse {
  ...
  factory GoogleCloudAiplatformV1beta1TrialResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1TrialResponse(
      ...
      customJob: (map['customJob'] as String).input(),
      ...
      infeasibleReason: (map['infeasibleReason'] as String).input(),
      measurements: (pulumi.Input.decodeList<GoogleCloudAiplatformV1beta1MeasurementResponse>(map['measurements'], (value) => GoogleCloudAiplatformV1beta1MeasurementResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      name: (map['name'] as String).input(),
      parameters: (pulumi.Input.decodeList<GoogleCloudAiplatformV1beta1TrialParameterResponse>(map['parameters'], (value) => GoogleCloudAiplatformV1beta1TrialParameterResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      startTime: (map['startTime'] as String).input(),
      state: (map['state'] as String).input(),
      webAccessUris: ((map['webAccessUris'] as Map).cast<String, String>()).input(),
    );
  }
}
