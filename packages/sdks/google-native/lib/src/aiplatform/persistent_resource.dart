...
class PersistentResource extends pulumi.CustomResource {
  ...
  late final pulumi.Output<GoogleCloudAiplatformV1beta1ResourceRuntimeResponse> resourceRuntime;
  /// Optional. Persistent Resource runtime spec. For example, used for Ray cluster configuration.
  late final pulumi.Output<GoogleCloudAiplatformV1beta1ResourceRuntimeSpecResponse> resourceRuntimeSpec;
  ...
  /// Creates a new [PersistentResource].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [PersistentResource]. {@macro pulumi_aiplatform_v1beta1_persistent_resource_args_doc}
  ...
  PersistentResource(
    ...
    persistentResourceId = registerOutput<String>('persistentResourceId');
    ...
    resourceRuntime = registerOutput<GoogleCloudAiplatformV1beta1ResourceRuntimeResponse>('resourceRuntime', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return GoogleCloudAiplatformV1beta1ResourceRuntimeResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    resourceRuntimeSpec = registerOutput<GoogleCloudAiplatformV1beta1ResourceRuntimeSpecResponse>('resourceRuntimeSpec', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return GoogleCloudAiplatformV1beta1ResourceRuntimeSpecResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
