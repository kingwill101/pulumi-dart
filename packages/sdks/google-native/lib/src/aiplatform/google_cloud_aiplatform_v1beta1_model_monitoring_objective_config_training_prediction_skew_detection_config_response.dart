...
class GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigTrainingPredictionSkewDetectionConfigResponse {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1beta1ThresholdConfigResponse> defaultSkewThreshold;
  ...
  const GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigTrainingPredictionSkewDetectionConfigResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'defaultSkewThreshold': pulumi.Input.mapInputValue<GoogleCloudAiplatformV1beta1ThresholdConfigResponse, Map<String, dynamic>>(defaultSkewThreshold, (value) => value.toMap()),
      'skewThresholds': skewThresholds,
    };
  }

  factory GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigTrainingPredictionSkewDetectionConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigTrainingPredictionSkewDetectionConfigResponse(
      ...
      defaultSkewThreshold: pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1ThresholdConfigResponse.fromMap((map['defaultSkewThreshold']! as Map).cast<String, dynamic>())),
