...
class GoogleCloudAiplatformV1beta1DedicatedResources {
  ...
  final pulumi.Input<List<GoogleCloudAiplatformV1beta1AutoscalingMetricSpec>>? autoscalingMetricSpecs;
  ...
  const GoogleCloudAiplatformV1beta1DedicatedResources({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'autoscalingMetricSpecs': ?pulumi.Input.mapOptionalInputValue<List<GoogleCloudAiplatformV1beta1AutoscalingMetricSpec>, List<Map<String, dynamic>>>(autoscalingMetricSpecs, (value) => pulumi.Input.encodeList<GoogleCloudAiplatformV1beta1AutoscalingMetricSpec, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory GoogleCloudAiplatformV1beta1DedicatedResources.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1DedicatedResources(
      autoscalingMetricSpecs: (() { final guardedValue = map['autoscalingMetricSpecs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudAiplatformV1beta1AutoscalingMetricSpec>(guardedValue, (value) => GoogleCloudAiplatformV1beta1AutoscalingMetricSpec.fromMap((value as Map).cast<String, dynamic>()))); })(),
