...
class GoogleTypeExprResponseAiplatformV1beta1 {
  ...
  /// Creates a new [GoogleTypeExprResponseAiplatformV1beta1].
  ...
  const GoogleTypeExprResponseAiplatformV1beta1({
  ...
  factory GoogleTypeExprResponseAiplatformV1beta1.fromMap(Map<String, dynamic> map) {
    return GoogleTypeExprResponseAiplatformV1beta1(
