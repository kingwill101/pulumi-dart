...
class DatasetAiplatformV1beta1Args {
  ...
  DatasetAiplatformV1beta1Args({
    ...
    pulumi.Output<List<GoogleCloudAiplatformV1beta1SavedQuery>>? savedQueries,
  }) :
      ...
      savedQueries = pulumi.Input.asOptionalInput<List<GoogleCloudAiplatformV1beta1SavedQuery>>(savedQueries);
  ...
  factory DatasetAiplatformV1beta1Args.fromMap(Map<String, dynamic> map) {
    return DatasetAiplatformV1beta1Args(
      ...
      savedQueries: map['savedQueries'] == null ? null : pulumi.Output.create<List<GoogleCloudAiplatformV1beta1SavedQuery>>(pulumi.Input.decodeList<GoogleCloudAiplatformV1beta1SavedQuery>(map['savedQueries'], (value) => GoogleCloudAiplatformV1beta1SavedQuery.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
