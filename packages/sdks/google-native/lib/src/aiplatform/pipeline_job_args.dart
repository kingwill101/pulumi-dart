...
class PipelineJobArgs {
  ...
  PipelineJobArgs({
    ...
    pulumi.Output<GoogleCloudAiplatformV1PipelineJobRuntimeConfig>? runtimeConfig,
  ...
  factory PipelineJobArgs.fromMap(Map<String, dynamic> map) {
    return PipelineJobArgs(
      ...
      runtimeConfig: map['runtimeConfig'] == null ? null : pulumi.Output.create<GoogleCloudAiplatformV1PipelineJobRuntimeConfig>(GoogleCloudAiplatformV1PipelineJobRuntimeConfig.fromMap((map['runtimeConfig'] as Map).cast<String, dynamic>())),
