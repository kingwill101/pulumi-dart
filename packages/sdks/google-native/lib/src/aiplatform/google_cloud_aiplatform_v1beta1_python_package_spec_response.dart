...
class GoogleCloudAiplatformV1beta1PythonPackageSpecResponse {
  ...
  factory GoogleCloudAiplatformV1beta1PythonPackageSpecResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1PythonPackageSpecResponse(
      ...
      env: (pulumi.Input.decodeList<GoogleCloudAiplatformV1beta1EnvVarResponse>(map['env'], (value) => GoogleCloudAiplatformV1beta1EnvVarResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
