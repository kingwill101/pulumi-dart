...
class GoogleCloudAiplatformV1beta1PipelineJob {
  ...
  /// Creates a new [GoogleCloudAiplatformV1beta1PipelineJob].
  ...
  factory GoogleCloudAiplatformV1beta1PipelineJob.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1PipelineJob(
      ...
      runtimeConfig: map['runtimeConfig'] == null ? null : GoogleCloudAiplatformV1beta1PipelineJobRuntimeConfig.fromMap((map['runtimeConfig'] as Map).cast<String, dynamic>()),
