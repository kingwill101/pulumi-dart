...
class GoogleCloudAiplatformV1beta1DeployedModelResponse {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1beta1PrivateEndpointsResponse>
  privateEndpoints;
  ...
  factory GoogleCloudAiplatformV1beta1DeployedModelResponse.fromMap(
    ...
    return GoogleCloudAiplatformV1beta1DeployedModelResponse(
      ...
      disableExplanations: pulumi.Input.fromValue(
        map['disableExplanations'] as bool,
      ),
      displayName: pulumi.Input.fromValue(map['displayName'] as String),
      enableAccessLogging: pulumi.Input.fromValue(
        map['enableAccessLogging'] as bool,
      ),
      enableContainerLogging: pulumi.Input.fromValue(
