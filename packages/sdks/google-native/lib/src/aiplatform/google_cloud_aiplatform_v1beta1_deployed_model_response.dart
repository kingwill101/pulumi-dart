...
class GoogleCloudAiplatformV1beta1DeployedModelResponse {
  ...
  factory GoogleCloudAiplatformV1beta1DeployedModelResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1DeployedModelResponse(
      ...
      disableExplanations: (map['disableExplanations'] as bool).input(),
      displayName: (map['displayName'] as String).input(),
      enableAccessLogging: (map['enableAccessLogging'] as bool).input(),
      enableContainerLogging: (map['enableContainerLogging'] as bool).input(),
      ...
      privateEndpoints: (GoogleCloudAiplatformV1beta1PrivateEndpointsResponse.fromMap((map['privateEndpoints'] as Map).cast<String, dynamic>())).input(),
      serviceAccount: (map['serviceAccount'] as String).input(),
      sharedResources: (map['sharedResources'] as String).input(),
    );
  }
}
