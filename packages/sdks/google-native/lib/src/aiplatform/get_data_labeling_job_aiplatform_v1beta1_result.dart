...
class GetDataLabelingJobAiplatformV1beta1Result {
  ...
  final GoogleCloudAiplatformV1beta1ActiveLearningConfigResponse activeLearningConfig;
  ...
  factory GetDataLabelingJobAiplatformV1beta1Result.fromMap(Map<String, dynamic> map) {
    return GetDataLabelingJobAiplatformV1beta1Result(
      activeLearningConfig: GoogleCloudAiplatformV1beta1ActiveLearningConfigResponse.fromMap((map['activeLearningConfig']! as Map).cast<String, dynamic>()),
      annotationLabels: (map['annotationLabels'] as Map).cast<String, String>(),
      createTime: map['createTime'] as String,
      currentSpend: GoogleTypeMoneyResponseAiplatformV1beta1.fromMap((map['currentSpend']! as Map).cast<String, dynamic>()),
