...
class TimeSeriesAiplatformV1beta1Args {
  ...
  TimeSeriesAiplatformV1beta1Args({
    ...
    required pulumi.Output<TimeSeriesValueTypeAiplatformV1beta1> valueType,
  }) :
  ...
  factory TimeSeriesAiplatformV1beta1Args.fromMap(Map<String, dynamic> map) {
    return TimeSeriesAiplatformV1beta1Args(
      ...
      valueType: pulumi.Output.create<TimeSeriesValueTypeAiplatformV1beta1>(TimeSeriesValueTypeAiplatformV1beta1.fromValue(map['valueType'] as String)),
    );
  }
}
