...
class TimeSeriesAiplatformV1beta1Args {
  ...
  const TimeSeriesAiplatformV1beta1Args({
    this.description,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'valueType': pulumi.Input.mapInputValue<TimeSeriesValueTypeAiplatformV1beta1, String>(valueType, (value) => value.wireValue),
    };
  }
  ...
  factory TimeSeriesAiplatformV1beta1Args.fromMap(Map<String, dynamic> map) {
    return TimeSeriesAiplatformV1beta1Args(
      ...
      valueType: pulumi.Input.fromValue(TimeSeriesValueTypeAiplatformV1beta1.fromValue(map['valueType']! as String)),
    );
  }
}
