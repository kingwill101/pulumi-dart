...
import 'trial_aiplatform_v1beta1_args.dart';

/// Adds a user provided Trial to a Study.
/// Auto-naming is currently not supported for this resource.
class TrialAiplatformV1beta1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<GoogleCloudAiplatformV1beta1MeasurementResponse> finalMeasurement;
  ...
  /// Creates a new [TrialAiplatformV1beta1].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [TrialAiplatformV1beta1]. {@macro pulumi_aiplatform_v1beta1_trial_aiplatform_v1beta1_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  TrialAiplatformV1beta1(
    String name, {
    TrialAiplatformV1beta1Args? args,
    ...
    finalMeasurement = registerOutput<GoogleCloudAiplatformV1beta1MeasurementResponse>('finalMeasurement', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return GoogleCloudAiplatformV1beta1MeasurementResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
