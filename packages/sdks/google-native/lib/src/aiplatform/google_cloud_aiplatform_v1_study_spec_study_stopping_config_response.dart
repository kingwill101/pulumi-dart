...
class GoogleCloudAiplatformV1StudySpecStudyStoppingConfigResponse {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1StudyTimeConstraintResponse> maximumRuntimeConstraint;
  ...
  final pulumi.Input<GoogleCloudAiplatformV1StudyTimeConstraintResponse> minimumRuntimeConstraint;
  ...
  const GoogleCloudAiplatformV1StudySpecStudyStoppingConfigResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'maximumRuntimeConstraint': pulumi.Input.mapInputValue<GoogleCloudAiplatformV1StudyTimeConstraintResponse, Map<String, dynamic>>(maximumRuntimeConstraint, (value) => value.toMap()),
      'minNumTrials': minNumTrials,
      'minimumRuntimeConstraint': pulumi.Input.mapInputValue<GoogleCloudAiplatformV1StudyTimeConstraintResponse, Map<String, dynamic>>(minimumRuntimeConstraint, (value) => value.toMap()),
      'shouldStopAsap': shouldStopAsap,
    };
  }

  factory GoogleCloudAiplatformV1StudySpecStudyStoppingConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1StudySpecStudyStoppingConfigResponse(
      ...
      maximumRuntimeConstraint: pulumi.Input.fromValue(GoogleCloudAiplatformV1StudyTimeConstraintResponse.fromMap((map['maximumRuntimeConstraint']! as Map).cast<String, dynamic>())),
      minNumTrials: pulumi.Input.fromValue(map['minNumTrials'] as int),
      minimumRuntimeConstraint: pulumi.Input.fromValue(GoogleCloudAiplatformV1StudyTimeConstraintResponse.fromMap((map['minimumRuntimeConstraint']! as Map).cast<String, dynamic>())),
