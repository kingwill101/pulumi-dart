...
class GoogleCloudAiplatformV1StudySpecStudyStoppingConfigResponse {
  ...
  factory GoogleCloudAiplatformV1StudySpecStudyStoppingConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1StudySpecStudyStoppingConfigResponse(
      ...
      maximumRuntimeConstraint: (GoogleCloudAiplatformV1StudyTimeConstraintResponse.fromMap((map['maximumRuntimeConstraint'] as Map).cast<String, dynamic>())).input(),
      minNumTrials: (map['minNumTrials'] as int).input(),
      minimumRuntimeConstraint: (GoogleCloudAiplatformV1StudyTimeConstraintResponse.fromMap((map['minimumRuntimeConstraint'] as Map).cast<String, dynamic>())).input(),
