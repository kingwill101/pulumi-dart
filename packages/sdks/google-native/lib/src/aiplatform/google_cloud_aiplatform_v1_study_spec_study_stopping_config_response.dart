...
class GoogleCloudAiplatformV1StudySpecStudyStoppingConfigResponse {
  ...
  final GoogleCloudAiplatformV1StudyTimeConstraintResponse maximumRuntimeConstraint;
  ...
  final GoogleCloudAiplatformV1StudyTimeConstraintResponse minimumRuntimeConstraint;
  ...
  factory GoogleCloudAiplatformV1StudySpecStudyStoppingConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1StudySpecStudyStoppingConfigResponse(
      ...
      maximumRuntimeConstraint: GoogleCloudAiplatformV1StudyTimeConstraintResponse.fromMap((map['maximumRuntimeConstraint'] as Map).cast<String, dynamic>()),
      minNumTrials: map['minNumTrials'] as int,
      minimumRuntimeConstraint: GoogleCloudAiplatformV1StudyTimeConstraintResponse.fromMap((map['minimumRuntimeConstraint'] as Map).cast<String, dynamic>()),
