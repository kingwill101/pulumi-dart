...
class GetScheduleResult {
  ...
  final GoogleCloudAiplatformV1CreatePipelineJobRequestResponse createPipelineJobRequest;
  ...
  final GoogleCloudAiplatformV1ScheduleRunResponseResponse lastScheduledRunResponse;
  ...
  factory GetScheduleResult.fromMap(Map<String, dynamic> map) {
    return GetScheduleResult(
      ...
      createPipelineJobRequest: GoogleCloudAiplatformV1CreatePipelineJobRequestResponse.fromMap((map['createPipelineJobRequest']! as Map).cast<String, dynamic>()),
      ...
      lastScheduledRunResponse: GoogleCloudAiplatformV1ScheduleRunResponseResponse.fromMap((map['lastScheduledRunResponse']! as Map).cast<String, dynamic>()),
