...
class GoogleCloudAiplatformV1StudySpecConvexAutomatedStoppingSpecResponse {
  ...
  factory GoogleCloudAiplatformV1StudySpecConvexAutomatedStoppingSpecResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1StudySpecConvexAutomatedStoppingSpecResponse(
      learningRateParameterName: (map['learningRateParameterName'] as String).input(),
      maxStepCount: (map['maxStepCount'] as String).input(),
      minMeasurementCount: (map['minMeasurementCount'] as String).input(),
      minStepCount: (map['minStepCount'] as String).input(),
      updateAllStoppedTrials: (map['updateAllStoppedTrials'] as bool).input(),
      useElapsedDuration: (map['useElapsedDuration'] as bool).input(),
    );
  }
}
