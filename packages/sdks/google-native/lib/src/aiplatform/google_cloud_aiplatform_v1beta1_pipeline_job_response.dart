...
class GoogleCloudAiplatformV1beta1PipelineJobResponse {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1beta1PipelineJobDetailResponse>
  jobDetail;
  ...
  factory GoogleCloudAiplatformV1beta1PipelineJobResponse.fromMap(
    ...
    return GoogleCloudAiplatformV1beta1PipelineJobResponse(
      ...
      error: pulumi.Input.fromValue(
        GoogleRpcStatusResponseAiplatformV1beta1.fromMap(
          (map['error']! as Map).cast<String, dynamic>(),
        ),
      ),
      jobDetail: pulumi.Input.fromValue(
        GoogleCloudAiplatformV1beta1PipelineJobDetailResponse.fromMap(
