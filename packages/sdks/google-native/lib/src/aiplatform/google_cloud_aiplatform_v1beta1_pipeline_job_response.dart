...
class GoogleCloudAiplatformV1beta1PipelineJobResponse {
  ...
  factory GoogleCloudAiplatformV1beta1PipelineJobResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1PipelineJobResponse(
      ...
      jobDetail: (GoogleCloudAiplatformV1beta1PipelineJobDetailResponse.fromMap((map['jobDetail'] as Map).cast<String, dynamic>())).input(),
      ...
      runtimeConfig: (GoogleCloudAiplatformV1beta1PipelineJobRuntimeConfigResponse.fromMap((map['runtimeConfig'] as Map).cast<String, dynamic>())).input(),
      scheduleName: (map['scheduleName'] as String).input(),
      serviceAccount: (map['serviceAccount'] as String).input(),
      startTime: (map['startTime'] as String).input(),
      state: (map['state'] as String).input(),
      templateMetadata: (GoogleCloudAiplatformV1beta1PipelineTemplateMetadataResponse.fromMap((map['templateMetadata'] as Map).cast<String, dynamic>())).input(),
