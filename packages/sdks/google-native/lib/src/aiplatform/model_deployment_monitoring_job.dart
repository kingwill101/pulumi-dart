...
import 'model_deployment_monitoring_job_args.dart';

/// Creates a ModelDeploymentMonitoringJob. It will run periodically on a configured interval.
/// Auto-naming is currently not supported for this resource.
class ModelDeploymentMonitoringJob extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<GoogleCloudAiplatformV1ModelDeploymentMonitoringBigQueryTableResponse>> bigqueryTables;
  ...
  late final pulumi.Output<GoogleCloudAiplatformV1ModelDeploymentMonitoringJobLatestMonitoringPipelineMetadataResponse> latestMonitoringPipelineMetadata;
  late final pulumi.Output<String> location;
  /// The TTL of BigQuery tables in user projects which stores logs. A day is the basic unit of the TTL and we take the ceil of TTL/86400(a day). e.g. { second: 3600} indicates ttl = 1 day.
  late final pulumi.Output<String> logTtl;
  /// Sample Strategy for logging.
  late final pulumi.Output<GoogleCloudAiplatformV1SamplingStrategyResponse> loggingSamplingStrategy;
  ...
  late final pulumi.Output<List<GoogleCloudAiplatformV1ModelDeploymentMonitoringObjectiveConfigResponse>> modelDeploymentMonitoringObjectiveConfigs;
  /// Schedule config for running the monitoring job.
  late final pulumi.Output<GoogleCloudAiplatformV1ModelDeploymentMonitoringScheduleConfigResponse> modelDeploymentMonitoringScheduleConfig;
  /// Alert config for model monitoring.
  late final pulumi.Output<GoogleCloudAiplatformV1ModelMonitoringAlertConfigResponse> modelMonitoringAlertConfig;
  ...
  late final pulumi.Output<GoogleCloudAiplatformV1GcsDestinationResponse> statsAnomaliesBaseDirectory;
  /// Timestamp when this ModelDeploymentMonitoringJob was updated most recently.
  late final pulumi.Output<String> updateTime;

  /// Creates a new [ModelDeploymentMonitoringJob].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ModelDeploymentMonitoringJob]. {@macro pulumi_aiplatform_v1_model_deployment_monitoring_job_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  ModelDeploymentMonitoringJob(
    String name, {
    ModelDeploymentMonitoringJobArgs? args,
    ...
    this.analysisInstanceSchemaUri = registerOutput<String>('analysisInstanceSchemaUri');
    this.bigqueryTables = registerOutput<List<GoogleCloudAiplatformV1ModelDeploymentMonitoringBigQueryTableResponse>>('bigqueryTables');
    this.createTime = registerOutput<String>('createTime');
    this.displayName = registerOutput<String>('displayName');
    this.enableMonitoringPipelineLogs = registerOutput<bool>('enableMonitoringPipelineLogs');
    ...
    this.latestMonitoringPipelineMetadata = registerOutput<GoogleCloudAiplatformV1ModelDeploymentMonitoringJobLatestMonitoringPipelineMetadataResponse>('latestMonitoringPipelineMetadata');
    this.location = registerOutput<String>('location');
    this.logTtl = registerOutput<String>('logTtl');
    this.loggingSamplingStrategy = registerOutput<GoogleCloudAiplatformV1SamplingStrategyResponse>('loggingSamplingStrategy');
    this.modelDeploymentMonitoringObjectiveConfigs = registerOutput<List<GoogleCloudAiplatformV1ModelDeploymentMonitoringObjectiveConfigResponse>>('modelDeploymentMonitoringObjectiveConfigs');
    this.modelDeploymentMonitoringScheduleConfig = registerOutput<GoogleCloudAiplatformV1ModelDeploymentMonitoringScheduleConfigResponse>('modelDeploymentMonitoringScheduleConfig');
    this.modelMonitoringAlertConfig = registerOutput<GoogleCloudAiplatformV1ModelMonitoringAlertConfigResponse>('modelMonitoringAlertConfig');
    this.name = registerOutput<String>('name');
    this.nextScheduleTime = registerOutput<String>('nextScheduleTime');
    this.predictInstanceSchemaUri = registerOutput<String>('predictInstanceSchemaUri');
    this.project = registerOutput<String>('project');
    this.samplePredictInstance = registerOutput<dynamic>('samplePredictInstance');
    this.scheduleState = registerOutput<String>('scheduleState');
    this.state = registerOutput<String>('state');
    this.statsAnomaliesBaseDirectory = registerOutput<GoogleCloudAiplatformV1GcsDestinationResponse>('statsAnomaliesBaseDirectory');
