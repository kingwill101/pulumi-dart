...
class GoogleCloudAiplatformV1DedicatedResourcesResponse {
  ...
  final pulumi.Input<List<GoogleCloudAiplatformV1AutoscalingMetricSpecResponse>>
    ...
    return <String, dynamic>{
      'autoscalingMetricSpecs':
          pulumi.Input.mapInputValue<
            List<GoogleCloudAiplatformV1AutoscalingMetricSpecResponse>,
  ...
  factory GoogleCloudAiplatformV1DedicatedResourcesResponse.fromMap(
    ...
    return GoogleCloudAiplatformV1DedicatedResourcesResponse(
      autoscalingMetricSpecs: pulumi.Input.fromValue(
