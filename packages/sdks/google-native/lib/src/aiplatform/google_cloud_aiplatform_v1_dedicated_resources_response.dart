...
class GoogleCloudAiplatformV1DedicatedResourcesResponse {
  ...
  factory GoogleCloudAiplatformV1DedicatedResourcesResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1DedicatedResourcesResponse(
      autoscalingMetricSpecs: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudAiplatformV1AutoscalingMetricSpecResponse>(map['autoscalingMetricSpecs']!, (value) => GoogleCloudAiplatformV1AutoscalingMetricSpecResponse.fromMap((value as Map).cast<String, dynamic>()))),
