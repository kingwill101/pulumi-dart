...
class NasJob extends pulumi.CustomResource {
  ...
  NasJob(
    ...
    this.enableRestrictedImageTraining = registerOutput<bool>('enableRestrictedImageTraining');
    ...
    this.nasJobOutput = registerOutput<GoogleCloudAiplatformV1NasJobOutputResponse>('nasJobOutput');
    this.nasJobSpec = registerOutput<GoogleCloudAiplatformV1NasJobSpecResponse>('nasJobSpec');
