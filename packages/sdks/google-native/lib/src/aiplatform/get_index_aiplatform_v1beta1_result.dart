...
class GetIndexAiplatformV1beta1Result {
  /// Timestamp when this Index was created.
  final String createTime;
  /// The pointers to DeployedIndexes created from this Index. An Index can be only deleted if all its DeployedIndexes had been undeployed first.
  final List<GoogleCloudAiplatformV1beta1DeployedIndexRefResponse> deployedIndexes;
  ...
  final GoogleCloudAiplatformV1beta1IndexStatsResponse indexStats;
  ...
  /// Creates a new [GetIndexAiplatformV1beta1Result].
  /// [createTime] Timestamp when this Index was created.
  ...
  /// [updateTime] Timestamp when this Index was most recently updated. This also includes any update to the contents of the Index. Note that Operations working on this Index may have their Operations.metadata.generic_metadata.update_time a little after the value of this timestamp, yet that does not mean their results are not already reflected in the Index. Result of any successfully completed Operation on the Index is reflected in it.
  const GetIndexAiplatformV1beta1Result({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'deployedIndexes': pulumi.Input.encodeList<GoogleCloudAiplatformV1beta1DeployedIndexRefResponse, Map<String, dynamic>>(deployedIndexes, (value) => value.toMap()),
      'description': description,
      'displayName': displayName,
      'encryptionSpec': encryptionSpec.toMap(),
      'etag': etag,
      'indexStats': indexStats.toMap(),
  ...
  factory GetIndexAiplatformV1beta1Result.fromMap(Map<String, dynamic> map) {
    return GetIndexAiplatformV1beta1Result(
      createTime: map['createTime'] as String,
      deployedIndexes: pulumi.Input.decodeList<GoogleCloudAiplatformV1beta1DeployedIndexRefResponse>(map['deployedIndexes']!, (value) => GoogleCloudAiplatformV1beta1DeployedIndexRefResponse.fromMap((value as Map).cast<String, dynamic>())),
      ...
      indexStats: GoogleCloudAiplatformV1beta1IndexStatsResponse.fromMap((map['indexStats']! as Map).cast<String, dynamic>()),
