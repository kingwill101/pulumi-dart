...
class GetIndexAiplatformV1beta1Result {
  ...
  final List<GoogleCloudAiplatformV1beta1DeployedIndexRefResponse>
  deployedIndexes;
    ...
    return GetIndexAiplatformV1beta1Result(
      ...
      deployedIndexes:
          ...
          >(
            map['deployedIndexes']!,
            (value) =>
                GoogleCloudAiplatformV1beta1DeployedIndexRefResponse.fromMap(
      ...
      indexStats: GoogleCloudAiplatformV1beta1IndexStatsResponse.fromMap(
