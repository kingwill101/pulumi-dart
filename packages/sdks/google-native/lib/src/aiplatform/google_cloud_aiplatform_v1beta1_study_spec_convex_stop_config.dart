...
class GoogleCloudAiplatformV1beta1StudySpecConvexStopConfig {
  ...
  final pulumi.Input<String>? autoregressiveOrder;
  ...
  final pulumi.Input<String>? maxNumSteps;
  ...
  const GoogleCloudAiplatformV1beta1StudySpecConvexStopConfig({
  ...
  factory GoogleCloudAiplatformV1beta1StudySpecConvexStopConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1StudySpecConvexStopConfig(
      autoregressiveOrder: (() { final guardedValue = map['autoregressiveOrder']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      learningRateParameterName: (() { final guardedValue = map['learningRateParameterName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      maxNumSteps: (() { final guardedValue = map['maxNumSteps']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      minNumSteps: (() { final guardedValue = map['minNumSteps']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      useSeconds: (() { final guardedValue = map['useSeconds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
    );
  }
}
