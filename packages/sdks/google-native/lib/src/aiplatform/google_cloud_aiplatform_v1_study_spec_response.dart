...
class GoogleCloudAiplatformV1StudySpecResponse {
  ...
  final GoogleCloudAiplatformV1StudySpecConvexAutomatedStoppingSpecResponse convexAutomatedStoppingSpec;
  /// The automated early stopping spec using decay curve rule.
  final GoogleCloudAiplatformV1StudySpecDecayCurveAutomatedStoppingSpecResponse decayCurveStoppingSpec;
  /// Describe which measurement selection type will be used
  final String measurementSelectionType;
  /// The automated early stopping spec using median rule.
  final GoogleCloudAiplatformV1StudySpecMedianAutomatedStoppingSpecResponse medianAutomatedStoppingSpec;
  ...
  final GoogleCloudAiplatformV1StudySpecStudyStoppingConfigResponse studyStoppingConfig;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'metrics': pulumi.Input.encodeList<GoogleCloudAiplatformV1StudySpecMetricSpecResponse, Map<String, dynamic>>(metrics, (value) => value.toMap()),
      'observationNoise': observationNoise,
      'parameters': pulumi.Input.encodeList<GoogleCloudAiplatformV1StudySpecParameterSpecResponse, Map<String, dynamic>>(parameters, (value) => value.toMap()),
  ...
  factory GoogleCloudAiplatformV1StudySpecResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1StudySpecResponse(
      ...
      convexAutomatedStoppingSpec: GoogleCloudAiplatformV1StudySpecConvexAutomatedStoppingSpecResponse.fromMap((map['convexAutomatedStoppingSpec'] as Map).cast<String, dynamic>()),
      decayCurveStoppingSpec: GoogleCloudAiplatformV1StudySpecDecayCurveAutomatedStoppingSpecResponse.fromMap((map['decayCurveStoppingSpec'] as Map).cast<String, dynamic>()),
      measurementSelectionType: map['measurementSelectionType'] as String,
      medianAutomatedStoppingSpec: GoogleCloudAiplatformV1StudySpecMedianAutomatedStoppingSpecResponse.fromMap((map['medianAutomatedStoppingSpec'] as Map).cast<String, dynamic>()),
      metrics: pulumi.Input.decodeList<GoogleCloudAiplatformV1StudySpecMetricSpecResponse>(map['metrics'], (value) => GoogleCloudAiplatformV1StudySpecMetricSpecResponse.fromMap((value as Map).cast<String, dynamic>())),
      observationNoise: map['observationNoise'] as String,
      parameters: pulumi.Input.decodeList<GoogleCloudAiplatformV1StudySpecParameterSpecResponse>(map['parameters'], (value) => GoogleCloudAiplatformV1StudySpecParameterSpecResponse.fromMap((value as Map).cast<String, dynamic>())),
      studyStoppingConfig: GoogleCloudAiplatformV1StudySpecStudyStoppingConfigResponse.fromMap((map['studyStoppingConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
