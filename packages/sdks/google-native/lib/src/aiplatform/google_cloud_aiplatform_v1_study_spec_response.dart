...
class GoogleCloudAiplatformV1StudySpecResponse {
  ...
  factory GoogleCloudAiplatformV1StudySpecResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1StudySpecResponse(
      ...
      convexAutomatedStoppingSpec: (GoogleCloudAiplatformV1StudySpecConvexAutomatedStoppingSpecResponse.fromMap((map['convexAutomatedStoppingSpec'] as Map).cast<String, dynamic>())).input(),
      decayCurveStoppingSpec: (GoogleCloudAiplatformV1StudySpecDecayCurveAutomatedStoppingSpecResponse.fromMap((map['decayCurveStoppingSpec'] as Map).cast<String, dynamic>())).input(),
      measurementSelectionType: (map['measurementSelectionType'] as String).input(),
      medianAutomatedStoppingSpec: (GoogleCloudAiplatformV1StudySpecMedianAutomatedStoppingSpecResponse.fromMap((map['medianAutomatedStoppingSpec'] as Map).cast<String, dynamic>())).input(),
      metrics: (pulumi.Input.decodeList<GoogleCloudAiplatformV1StudySpecMetricSpecResponse>(map['metrics'], (value) => GoogleCloudAiplatformV1StudySpecMetricSpecResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      observationNoise: (map['observationNoise'] as String).input(),
      parameters: (pulumi.Input.decodeList<GoogleCloudAiplatformV1StudySpecParameterSpecResponse>(map['parameters'], (value) => GoogleCloudAiplatformV1StudySpecParameterSpecResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      studyStoppingConfig: (GoogleCloudAiplatformV1StudySpecStudyStoppingConfigResponse.fromMap((map['studyStoppingConfig'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
