...
class GoogleCloudAiplatformV1StudySpecResponse {
  ...
  final pulumi.Input<List<GoogleCloudAiplatformV1StudySpecMetricSpecResponse>>
  metrics;
  ...
  final pulumi.Input<
    List<GoogleCloudAiplatformV1StudySpecParameterSpecResponse>
  >
  parameters;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'metrics':
          pulumi.Input.mapInputValue<
            List<GoogleCloudAiplatformV1StudySpecMetricSpecResponse>,
  ...
  factory GoogleCloudAiplatformV1StudySpecResponse.fromMap(
    ...
    return GoogleCloudAiplatformV1StudySpecResponse(
      ...
      convexAutomatedStoppingSpec: pulumi.Input.fromValue(
        GoogleCloudAiplatformV1StudySpecConvexAutomatedStoppingSpecResponse.fromMap(
          (map['convexAutomatedStoppingSpec']! as Map).cast<String, dynamic>(),
        ),
      ),
      decayCurveStoppingSpec: pulumi.Input.fromValue(
        GoogleCloudAiplatformV1StudySpecDecayCurveAutomatedStoppingSpecResponse.fromMap(
      ...
      medianAutomatedStoppingSpec: pulumi.Input.fromValue(
        GoogleCloudAiplatformV1StudySpecMedianAutomatedStoppingSpecResponse.fromMap(
