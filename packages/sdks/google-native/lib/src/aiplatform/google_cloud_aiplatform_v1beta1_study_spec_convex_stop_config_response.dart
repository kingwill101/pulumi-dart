...
class GoogleCloudAiplatformV1beta1StudySpecConvexStopConfigResponse {
  ...
  factory GoogleCloudAiplatformV1beta1StudySpecConvexStopConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1StudySpecConvexStopConfigResponse(
      autoregressiveOrder: (map['autoregressiveOrder'] as String).input(),
      learningRateParameterName: (map['learningRateParameterName'] as String).input(),
      maxNumSteps: (map['maxNumSteps'] as String).input(),
      minNumSteps: (map['minNumSteps'] as String).input(),
      useSeconds: (map['useSeconds'] as bool).input(),
    );
  }
}
