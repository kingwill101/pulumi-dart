...
class GoogleCloudAiplatformV1beta1StudySpecConvexStopConfigResponse {
  ...
  const GoogleCloudAiplatformV1beta1StudySpecConvexStopConfigResponse({
  ...
  factory GoogleCloudAiplatformV1beta1StudySpecConvexStopConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1StudySpecConvexStopConfigResponse(
      autoregressiveOrder: pulumi.Input.fromValue(map['autoregressiveOrder'] as String),
      learningRateParameterName: pulumi.Input.fromValue(map['learningRateParameterName'] as String),
      maxNumSteps: pulumi.Input.fromValue(map['maxNumSteps'] as String),
      minNumSteps: pulumi.Input.fromValue(map['minNumSteps'] as String),
      useSeconds: pulumi.Input.fromValue(map['useSeconds'] as bool),
    );
  }
}
