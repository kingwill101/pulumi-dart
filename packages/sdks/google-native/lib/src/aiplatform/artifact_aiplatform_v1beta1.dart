...
import 'artifact_aiplatform_v1beta1_args.dart';

/// Creates an Artifact associated with a MetadataStore.
/// Auto-naming is currently not supported for this resource.
class ArtifactAiplatformV1beta1 extends pulumi.CustomResource {
  ...
  /// Creates a new [ArtifactAiplatformV1beta1].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ArtifactAiplatformV1beta1]. {@macro pulumi_aiplatform_v1beta1_artifact_aiplatform_v1beta1_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  ArtifactAiplatformV1beta1(
    String name, {
    ArtifactAiplatformV1beta1Args? args,
