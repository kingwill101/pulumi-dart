...
/// {@template pulumi_aiplatform_v1beta1_featurestore_entity_type_iam_binding_aiplatform_v1beta1_args_doc}
/// The set of arguments for FeaturestoreEntityTypeIamBinding.
/// {@endtemplate}
/// {@macro pulumi_aiplatform_v1beta1_featurestore_entity_type_iam_binding_aiplatform_v1beta1_args_doc}
class FeaturestoreEntityTypeIamBindingAiplatformV1beta1Args {
  ...
  /// Creates a new [FeaturestoreEntityTypeIamBindingAiplatformV1beta1Args].
  ...
  const FeaturestoreEntityTypeIamBindingAiplatformV1beta1Args({
    this.condition,
  ...
  factory FeaturestoreEntityTypeIamBindingAiplatformV1beta1Args.fromMap(Map<String, dynamic> map) {
    return FeaturestoreEntityTypeIamBindingAiplatformV1beta1Args(
