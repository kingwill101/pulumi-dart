...
class GoogleCloudAiplatformV1beta1FeaturestoreOnlineServingConfig {
  ...
  const GoogleCloudAiplatformV1beta1FeaturestoreOnlineServingConfig({
    this.fixedNodeCount,
    this.scaling,
  });
  ...
  factory GoogleCloudAiplatformV1beta1FeaturestoreOnlineServingConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1FeaturestoreOnlineServingConfig(
      ...
      scaling: (() { final guardedValue = map['scaling']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1FeaturestoreOnlineServingConfigScaling.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
