...
class DatasetArgs {
  ...
  factory DatasetArgs.fromMap(Map<String, dynamic> map) {
    return DatasetArgs(
      ...
      savedQueries: (() { final guardedValue = map['savedQueries']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudAiplatformV1SavedQuery>(guardedValue, (value) => GoogleCloudAiplatformV1SavedQuery.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
