...
class GoogleCloudAiplatformV1beta1ModelContainerSpecResponse {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1beta1ProbeResponse> healthProbe;
  ...
  final pulumi.Input<List<GoogleCloudAiplatformV1beta1PortResponse>> ports;
  ...
  final pulumi.Input<GoogleCloudAiplatformV1beta1ProbeResponse> startupProbe;

  /// Creates a new [GoogleCloudAiplatformV1beta1ModelContainerSpecResponse].
    ...
    return <String, dynamic>{
      ...
      'env':
          pulumi.Input.mapInputValue<
            List<GoogleCloudAiplatformV1beta1EnvVarResponse>,
      ...
      'ports':
          pulumi.Input.mapInputValue<
            List<GoogleCloudAiplatformV1beta1PortResponse>,
            List<Map<String, dynamic>>
          >(
            ports,
            (value) =>
  ...
  factory GoogleCloudAiplatformV1beta1ModelContainerSpecResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return GoogleCloudAiplatformV1beta1ModelContainerSpecResponse(
      ...
      env: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GoogleCloudAiplatformV1beta1EnvVarResponse>(
          map['env']!,
      ...
      healthProbe: pulumi.Input.fromValue(
        GoogleCloudAiplatformV1beta1ProbeResponse.fromMap(
      ...
      ports: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GoogleCloudAiplatformV1beta1PortResponse>(
          map['ports']!,
