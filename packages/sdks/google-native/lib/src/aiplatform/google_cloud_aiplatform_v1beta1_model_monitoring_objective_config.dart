...
class GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfig {
  ...
  final GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigExplanationConfig? explanationConfig;
  /// The config for drift of prediction data.
  final GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigPredictionDriftDetectionConfig? predictionDriftDetectionConfig;
  /// Training dataset for models. This field has to be set only if TrainingPredictionSkewDetectionConfig is specified.
  final GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigTrainingDataset? trainingDataset;
  /// The config for skew between training data and prediction data.
  final GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigTrainingPredictionSkewDetectionConfig? trainingPredictionSkewDetectionConfig;
  ...
  factory GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfig(
      explanationConfig: map['explanationConfig'] == null ? null : GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigExplanationConfig.fromMap((map['explanationConfig'] as Map).cast<String, dynamic>()),
      predictionDriftDetectionConfig: map['predictionDriftDetectionConfig'] == null ? null : GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigPredictionDriftDetectionConfig.fromMap((map['predictionDriftDetectionConfig'] as Map).cast<String, dynamic>()),
      trainingDataset: map['trainingDataset'] == null ? null : GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigTrainingDataset.fromMap((map['trainingDataset'] as Map).cast<String, dynamic>()),
      trainingPredictionSkewDetectionConfig: map['trainingPredictionSkewDetectionConfig'] == null ? null : GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigTrainingPredictionSkewDetectionConfig.fromMap((map['trainingPredictionSkewDetectionConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
