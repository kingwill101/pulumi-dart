...
class GoogleCloudAiplatformV1beta1PersistentDiskSpecResponse {
  ...
  /// Creates a new [GoogleCloudAiplatformV1beta1PersistentDiskSpecResponse].
  ...
  const GoogleCloudAiplatformV1beta1PersistentDiskSpecResponse({
  ...
  factory GoogleCloudAiplatformV1beta1PersistentDiskSpecResponse.fromMap(Map<String, dynamic> map) {
