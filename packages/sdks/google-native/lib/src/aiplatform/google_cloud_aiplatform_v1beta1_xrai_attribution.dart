...
class GoogleCloudAiplatformV1beta1XraiAttribution {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1beta1BlurBaselineConfig>?
  blurBaselineConfig;

  /// Config for SmoothGrad approximation of gradients. When enabled, the gradients are approximated by averaging the gradients from noisy samples in the vicinity of the inputs. Adding noise can help improve the computed gradients. Refer to this paper for more details: https://arxiv.org/pdf/1706.03825.pdf
  final pulumi.Input<GoogleCloudAiplatformV1beta1SmoothGradConfig>?
  smoothGradConfig;
  ...
  factory GoogleCloudAiplatformV1beta1XraiAttribution.fromMap(
    Map<String, dynamic> map,
  ) {
    return GoogleCloudAiplatformV1beta1XraiAttribution(
      blurBaselineConfig: (() {
        final guardedValue = map['blurBaselineConfig'];
      ...
      smoothGradConfig: (() {
        final guardedValue = map['smoothGradConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
