...
class GoogleCloudAiplatformV1beta1XraiAttribution {
  ...
  final GoogleCloudAiplatformV1beta1BlurBaselineConfig? blurBaselineConfig;
  /// Config for SmoothGrad approximation of gradients. When enabled, the gradients are approximated by averaging the gradients from noisy samples in the vicinity of the inputs. Adding noise can help improve the computed gradients. Refer to this paper for more details: https://arxiv.org/pdf/1706.03825.pdf
  final GoogleCloudAiplatformV1beta1SmoothGradConfig? smoothGradConfig;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'blurBaselineConfig': ?blurBaselineConfig == null ? null : blurBaselineConfig!.toMap(),
      'smoothGradConfig': ?smoothGradConfig == null ? null : smoothGradConfig!.toMap(),
      'stepCount': stepCount,
    };
  }
  ...
  factory GoogleCloudAiplatformV1beta1XraiAttribution.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1XraiAttribution(
      blurBaselineConfig: map['blurBaselineConfig'] == null ? null : GoogleCloudAiplatformV1beta1BlurBaselineConfig.fromMap((map['blurBaselineConfig'] as Map).cast<String, dynamic>()),
      smoothGradConfig: map['smoothGradConfig'] == null ? null : GoogleCloudAiplatformV1beta1SmoothGradConfig.fromMap((map['smoothGradConfig'] as Map).cast<String, dynamic>()),
