...
import 'google_cloud_aiplatform_v1beta1_blur_baseline_config.dart';
import 'google_cloud_aiplatform_v1beta1_smooth_grad_config.dart';
...
class GoogleCloudAiplatformV1beta1XraiAttribution {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1beta1BlurBaselineConfig>? blurBaselineConfig;
  /// Config for SmoothGrad approximation of gradients. When enabled, the gradients are approximated by averaging the gradients from noisy samples in the vicinity of the inputs. Adding noise can help improve the computed gradients. Refer to this paper for more details: https://arxiv.org/pdf/1706.03825.pdf
  final pulumi.Input<GoogleCloudAiplatformV1beta1SmoothGradConfig>? smoothGradConfig;
  ...
  /// Creates a new [GoogleCloudAiplatformV1beta1XraiAttribution].
  ...
  const GoogleCloudAiplatformV1beta1XraiAttribution({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'blurBaselineConfig': ?pulumi.Input.mapOptionalInputValue<GoogleCloudAiplatformV1beta1BlurBaselineConfig, Map<String, dynamic>>(blurBaselineConfig, (value) => value.toMap()),
      'smoothGradConfig': ?pulumi.Input.mapOptionalInputValue<GoogleCloudAiplatformV1beta1SmoothGradConfig, Map<String, dynamic>>(smoothGradConfig, (value) => value.toMap()),
      'stepCount': stepCount,
    };
  }

  factory GoogleCloudAiplatformV1beta1XraiAttribution.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1XraiAttribution(
      blurBaselineConfig: (() { final guardedValue = map['blurBaselineConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1BlurBaselineConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      smoothGradConfig: (() { final guardedValue = map['smoothGradConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1SmoothGradConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
