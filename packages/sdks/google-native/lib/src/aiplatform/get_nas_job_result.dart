...
class GetNasJobResult {
  ...
  factory GetNasJobResult.fromMap(Map<String, dynamic> map) {
    return GetNasJobResult(
      ...
      nasJobOutput: GoogleCloudAiplatformV1NasJobOutputResponse.fromMap((map['nasJobOutput']! as Map).cast<String, dynamic>()),
      nasJobSpec: GoogleCloudAiplatformV1NasJobSpecResponse.fromMap((map['nasJobSpec']! as Map).cast<String, dynamic>()),
