...
class GetDatasetResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': name,
      'savedQueries': pulumi.Input.encodeList<GoogleCloudAiplatformV1SavedQueryResponse, Map<String, dynamic>>(savedQueries, (value) => value.toMap()),
  ...
  factory GetDatasetResult.fromMap(Map<String, dynamic> map) {
    return GetDatasetResult(
      ...
      savedQueries: pulumi.Input.decodeList<GoogleCloudAiplatformV1SavedQueryResponse>(map['savedQueries']!, (value) => GoogleCloudAiplatformV1SavedQueryResponse.fromMap((value as Map).cast<String, dynamic>())),
