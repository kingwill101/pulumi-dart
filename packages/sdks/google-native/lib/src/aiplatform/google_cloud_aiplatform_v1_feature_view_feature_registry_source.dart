...
class GoogleCloudAiplatformV1FeatureViewFeatureRegistrySource {
  ...
  const GoogleCloudAiplatformV1FeatureViewFeatureRegistrySource({
  ...
  factory GoogleCloudAiplatformV1FeatureViewFeatureRegistrySource.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1FeatureViewFeatureRegistrySource(
      featureGroups: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudAiplatformV1FeatureViewFeatureRegistrySourceFeatureGroup>(map['featureGroups']!, (value) => GoogleCloudAiplatformV1FeatureViewFeatureRegistrySourceFeatureGroup.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
