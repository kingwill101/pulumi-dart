...
class GoogleCloudAiplatformV1ExplanationParametersResponse {
  ...
  factory GoogleCloudAiplatformV1ExplanationParametersResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1ExplanationParametersResponse(
      examples: (GoogleCloudAiplatformV1ExamplesResponse.fromMap((map['examples'] as Map).cast<String, dynamic>())).input(),
      integratedGradientsAttribution: (GoogleCloudAiplatformV1IntegratedGradientsAttributionResponse.fromMap((map['integratedGradientsAttribution'] as Map).cast<String, dynamic>())).input(),
      outputIndices: ((map['outputIndices'] as List).cast<dynamic>()).input(),
      sampledShapleyAttribution: (GoogleCloudAiplatformV1SampledShapleyAttributionResponse.fromMap((map['sampledShapleyAttribution'] as Map).cast<String, dynamic>())).input(),
      topK: (map['topK'] as int).input(),
      xraiAttribution: (GoogleCloudAiplatformV1XraiAttributionResponse.fromMap((map['xraiAttribution'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
