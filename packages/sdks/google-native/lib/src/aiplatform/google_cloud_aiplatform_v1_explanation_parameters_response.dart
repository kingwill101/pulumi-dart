...
class GoogleCloudAiplatformV1ExplanationParametersResponse {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1SampledShapleyAttributionResponse>
  ...
  final pulumi.Input<GoogleCloudAiplatformV1XraiAttributionResponse>
  xraiAttribution;
  ...
  factory GoogleCloudAiplatformV1ExplanationParametersResponse.fromMap(
    ...
    return GoogleCloudAiplatformV1ExplanationParametersResponse(
      examples: pulumi.Input.fromValue(
        GoogleCloudAiplatformV1ExamplesResponse.fromMap(
      ...
      xraiAttribution: pulumi.Input.fromValue(
        GoogleCloudAiplatformV1XraiAttributionResponse.fromMap(
