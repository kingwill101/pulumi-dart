...
class GoogleCloudAiplatformV1beta1BatchPredictionJobInstanceConfig {
  ...
  const GoogleCloudAiplatformV1beta1BatchPredictionJobInstanceConfig({
    this.excludedFields,
    this.includedFields,
    this.instanceType,
    this.keyField,
  ...
  factory GoogleCloudAiplatformV1beta1BatchPredictionJobInstanceConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1BatchPredictionJobInstanceConfig(
      excludedFields: (() { final guardedValue = map['excludedFields']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      includedFields: (() { final guardedValue = map['includedFields']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      instanceType: (() { final guardedValue = map['instanceType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      keyField: (() { final guardedValue = map['keyField']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
