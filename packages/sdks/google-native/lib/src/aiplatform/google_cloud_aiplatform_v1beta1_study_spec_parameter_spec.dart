...
class GoogleCloudAiplatformV1beta1StudySpecParameterSpec {
  ...
  const GoogleCloudAiplatformV1beta1StudySpecParameterSpec({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'scaleType': ?pulumi.Input.mapOptionalInputValue<GoogleCloudAiplatformV1beta1StudySpecParameterSpecScaleType, String>(scaleType, (value) => value.wireValue),
    };
  }
  ...
  factory GoogleCloudAiplatformV1beta1StudySpecParameterSpec.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1StudySpecParameterSpec(
      categoricalValueSpec: (() { final guardedValue = map['categoricalValueSpec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1StudySpecParameterSpecCategoricalValueSpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      conditionalParameterSpecs: (() { final guardedValue = map['conditionalParameterSpecs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudAiplatformV1beta1StudySpecParameterSpecConditionalParameterSpec>(guardedValue, (value) => GoogleCloudAiplatformV1beta1StudySpecParameterSpecConditionalParameterSpec.fromMap((value as Map).cast<String, dynamic>()))); })(),
      discreteValueSpec: (() { final guardedValue = map['discreteValueSpec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1StudySpecParameterSpecDiscreteValueSpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      doubleValueSpec: (() { final guardedValue = map['doubleValueSpec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1StudySpecParameterSpecDoubleValueSpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      integerValueSpec: (() { final guardedValue = map['integerValueSpec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1StudySpecParameterSpecIntegerValueSpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      parameterId: pulumi.Input.fromValue(map['parameterId'] as String),
      scaleType: (() { final guardedValue = map['scaleType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1StudySpecParameterSpecScaleType.fromValue(guardedValue as String)); })(),
    );
  }
}
