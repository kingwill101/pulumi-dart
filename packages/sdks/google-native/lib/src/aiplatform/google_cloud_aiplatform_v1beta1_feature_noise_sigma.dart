...
class GoogleCloudAiplatformV1beta1FeatureNoiseSigma {
  ...
  final pulumi.Input<
    List<GoogleCloudAiplatformV1beta1FeatureNoiseSigmaNoiseSigmaForFeature>
  >?
  noiseSigma;
  ...
  factory GoogleCloudAiplatformV1beta1FeatureNoiseSigma.fromMap(
      ...
      noiseSigma: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                GoogleCloudAiplatformV1beta1FeatureNoiseSigmaNoiseSigmaForFeature.fromMap(
