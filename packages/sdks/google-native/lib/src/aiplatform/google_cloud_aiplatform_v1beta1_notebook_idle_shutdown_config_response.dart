...
class GoogleCloudAiplatformV1beta1NotebookIdleShutdownConfigResponse {
  ...
  factory GoogleCloudAiplatformV1beta1NotebookIdleShutdownConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1NotebookIdleShutdownConfigResponse(
      idleShutdownDisabled: (map['idleShutdownDisabled'] as bool).input(),
