...
class GoogleCloudAiplatformV1ModelDeploymentMonitoringScheduleConfigResponse {
  ...
  /// Creates a new [GoogleCloudAiplatformV1ModelDeploymentMonitoringScheduleConfigResponse].
  ...
  const GoogleCloudAiplatformV1ModelDeploymentMonitoringScheduleConfigResponse({
  ...
  factory GoogleCloudAiplatformV1ModelDeploymentMonitoringScheduleConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1ModelDeploymentMonitoringScheduleConfigResponse(
