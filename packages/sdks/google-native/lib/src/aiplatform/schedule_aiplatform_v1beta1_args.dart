...
class ScheduleAiplatformV1beta1Args {
  ...
  factory ScheduleAiplatformV1beta1Args.fromMap(Map<String, dynamic> map) {
    return ScheduleAiplatformV1beta1Args(
      ...
      createPipelineJobRequest: (() { final guardedValue = map['createPipelineJobRequest']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1CreatePipelineJobRequest.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
