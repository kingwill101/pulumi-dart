...
class IndexEndpointAiplatformV1beta1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<GoogleCloudAiplatformV1beta1DeployedIndexResponse>> deployedIndexes;
  ...
  IndexEndpointAiplatformV1beta1(
    ...
    this.deployedIndexes = registerOutput<List<GoogleCloudAiplatformV1beta1DeployedIndexResponse>>('deployedIndexes');
    ...
    this.privateServiceConnectConfig = registerOutput<GoogleCloudAiplatformV1beta1PrivateServiceConnectConfigResponse>('privateServiceConnectConfig');
