...
import 'run_aiplatform_v1beta1_args.dart';

/// Creates a TensorboardRun.
/// Auto-naming is currently not supported for this resource.
class RunAiplatformV1beta1 extends pulumi.CustomResource {
  ...
  /// Creates a new [RunAiplatformV1beta1].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [RunAiplatformV1beta1]. {@macro pulumi_aiplatform_v1beta1_run_aiplatform_v1beta1_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  RunAiplatformV1beta1(
    String name, {
    RunAiplatformV1beta1Args? args,
