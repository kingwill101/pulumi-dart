...
class GoogleCloudAiplatformV1beta1ModelResponse {
  ...
  const GoogleCloudAiplatformV1beta1ModelResponse({
  ...
  factory GoogleCloudAiplatformV1beta1ModelResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1ModelResponse(
      ...
      deployedModels: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudAiplatformV1beta1DeployedModelRefResponse>(map['deployedModels']!, (value) => GoogleCloudAiplatformV1beta1DeployedModelRefResponse.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      modelSourceInfo: pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1ModelSourceInfoResponse.fromMap((map['modelSourceInfo']! as Map).cast<String, dynamic>())),
      name: pulumi.Input.fromValue(map['name'] as String),
      originalModelInfo: pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1ModelOriginalModelInfoResponse.fromMap((map['originalModelInfo']! as Map).cast<String, dynamic>())),
      ...
      supportedExportFormats: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudAiplatformV1beta1ModelExportFormatResponse>(map['supportedExportFormats']!, (value) => GoogleCloudAiplatformV1beta1ModelExportFormatResponse.fromMap((value as Map).cast<String, dynamic>()))),
