...
class GoogleCloudAiplatformV1beta1ModelResponse {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1beta1ModelContainerSpecResponse>
  containerSpec;
  ...
  final pulumi.Input<List<GoogleCloudAiplatformV1beta1DeployedModelRefResponse>>
  deployedModels;
  ...
  final pulumi.Input<GoogleCloudAiplatformV1beta1EncryptionSpecResponse>
  encryptionSpec;
  ...
  final pulumi.Input<GoogleCloudAiplatformV1beta1ExplanationSpecResponse>
  explanationSpec;
  ...
  final pulumi.Input<GoogleCloudAiplatformV1beta1ModelSourceInfoResponse>
  modelSourceInfo;
  ...
  final pulumi.Input<GoogleCloudAiplatformV1beta1ModelOriginalModelInfoResponse>
  originalModelInfo;

  /// The schemata that describe formats of the Model's predictions and explanations as given and returned via PredictionService.Predict and PredictionService.Explain.
  final pulumi.Input<GoogleCloudAiplatformV1beta1PredictSchemataResponse>
  predictSchemata;
  ...
  final pulumi.Input<
    List<GoogleCloudAiplatformV1beta1ModelExportFormatResponse>
  >
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'deployedModels':
          pulumi.Input.mapInputValue<
            List<GoogleCloudAiplatformV1beta1DeployedModelRefResponse>,
  ...
  factory GoogleCloudAiplatformV1beta1ModelResponse.fromMap(
    ...
    return GoogleCloudAiplatformV1beta1ModelResponse(
      ...
      deployedModels: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GoogleCloudAiplatformV1beta1DeployedModelRefResponse
        >(
          map['deployedModels']!,
          (value) =>
              GoogleCloudAiplatformV1beta1DeployedModelRefResponse.fromMap(
      ...
      explanationSpec: pulumi.Input.fromValue(
      ...
      metadataArtifact: pulumi.Input.fromValue(
        map['metadataArtifact'] as String,
      ),
      metadataSchemaUri: pulumi.Input.fromValue(
        map['metadataSchemaUri'] as String,
      ),
      modelSourceInfo: pulumi.Input.fromValue(
        GoogleCloudAiplatformV1beta1ModelSourceInfoResponse.fromMap(
          (map['modelSourceInfo']! as Map).cast<String, dynamic>(),
        ),
      ),
      name: pulumi.Input.fromValue(map['name'] as String),
      originalModelInfo: pulumi.Input.fromValue(
        GoogleCloudAiplatformV1beta1ModelOriginalModelInfoResponse.fromMap(
          (map['originalModelInfo']! as Map).cast<String, dynamic>(),
        ),
      ),
      predictSchemata: pulumi.Input.fromValue(
        GoogleCloudAiplatformV1beta1PredictSchemataResponse.fromMap(
          (map['predictSchemata']! as Map).cast<String, dynamic>(),
        ),
      ),
      supportedDeploymentResourcesTypes: pulumi.Input.fromValue(
        (map['supportedDeploymentResourcesTypes'] as List).cast<String>(),
      ),
      supportedExportFormats: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GoogleCloudAiplatformV1beta1ModelExportFormatResponse
        >(
          map['supportedExportFormats']!,
          (value) =>
              GoogleCloudAiplatformV1beta1ModelExportFormatResponse.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
      supportedInputStorageFormats: pulumi.Input.fromValue(
        (map['supportedInputStorageFormats'] as List).cast<String>(),
      ),
      supportedOutputStorageFormats: pulumi.Input.fromValue(
        (map['supportedOutputStorageFormats'] as List).cast<String>(),
      ),
      trainingPipeline: pulumi.Input.fromValue(
        map['trainingPipeline'] as String,
      ),
      updateTime: pulumi.Input.fromValue(map['updateTime'] as String),
      versionAliases: pulumi.Input.fromValue(
        (map['versionAliases'] as List).cast<String>(),
      ),
      versionCreateTime: pulumi.Input.fromValue(
        map['versionCreateTime'] as String,
      ),
      versionDescription: pulumi.Input.fromValue(
        map['versionDescription'] as String,
      ),
      versionId: pulumi.Input.fromValue(map['versionId'] as String),
      versionUpdateTime: pulumi.Input.fromValue(
        map['versionUpdateTime'] as String,
      ),
    );
  }
}
