...
class GoogleCloudAiplatformV1beta1ModelResponse {
  ...
  final List<GoogleCloudAiplatformV1beta1DeployedModelRefResponse> deployedModels;
  ...
  final GoogleCloudAiplatformV1beta1ModelSourceInfoResponse modelSourceInfo;
  /// The resource name of the Model.
  final String name;
  /// If this Model is a copy of another Model, this contains info about the original.
  final GoogleCloudAiplatformV1beta1ModelOriginalModelInfoResponse originalModelInfo;
  ...
  final List<String> supportedDeploymentResourcesTypes;
  /// The formats in which this Model may be exported. If empty, this Model is not available for export.
  final List<GoogleCloudAiplatformV1beta1ModelExportFormatResponse> supportedExportFormats;
  ...
  final String versionCreateTime;
  ...
  final String versionUpdateTime;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'deployedModels': pulumi.Input.encodeList<GoogleCloudAiplatformV1beta1DeployedModelRefResponse, Map<String, dynamic>>(deployedModels, (value) => value.toMap()),
      ...
      'modelSourceInfo': modelSourceInfo.toMap(),
      'name': name,
      'originalModelInfo': originalModelInfo.toMap(),
      'predictSchemata': predictSchemata.toMap(),
      'supportedDeploymentResourcesTypes': supportedDeploymentResourcesTypes,
      'supportedExportFormats': pulumi.Input.encodeList<GoogleCloudAiplatformV1beta1ModelExportFormatResponse, Map<String, dynamic>>(supportedExportFormats, (value) => value.toMap()),
  ...
  factory GoogleCloudAiplatformV1beta1ModelResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1ModelResponse(
      ...
      containerSpec: GoogleCloudAiplatformV1beta1ModelContainerSpecResponse.fromMap((map['containerSpec'] as Map).cast<String, dynamic>()),
      createTime: map['createTime'] as String,
      deployedModels: pulumi.Input.decodeList<GoogleCloudAiplatformV1beta1DeployedModelRefResponse>(map['deployedModels'], (value) => GoogleCloudAiplatformV1beta1DeployedModelRefResponse.fromMap((value as Map).cast<String, dynamic>())),
      ...
      modelSourceInfo: GoogleCloudAiplatformV1beta1ModelSourceInfoResponse.fromMap((map['modelSourceInfo'] as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      originalModelInfo: GoogleCloudAiplatformV1beta1ModelOriginalModelInfoResponse.fromMap((map['originalModelInfo'] as Map).cast<String, dynamic>()),
      predictSchemata: GoogleCloudAiplatformV1beta1PredictSchemataResponse.fromMap((map['predictSchemata'] as Map).cast<String, dynamic>()),
      supportedDeploymentResourcesTypes: (map['supportedDeploymentResourcesTypes'] as List).cast<String>(),
      supportedExportFormats: pulumi.Input.decodeList<GoogleCloudAiplatformV1beta1ModelExportFormatResponse>(map['supportedExportFormats'], (value) => GoogleCloudAiplatformV1beta1ModelExportFormatResponse.fromMap((value as Map).cast<String, dynamic>())),
      supportedInputStorageFormats: (map['supportedInputStorageFormats'] as List).cast<String>(),
      supportedOutputStorageFormats: (map['supportedOutputStorageFormats'] as List).cast<String>(),
      trainingPipeline: map['trainingPipeline'] as String,
      updateTime: map['updateTime'] as String,
      versionAliases: (map['versionAliases'] as List).cast<String>(),
      versionCreateTime: map['versionCreateTime'] as String,
      versionDescription: map['versionDescription'] as String,
      versionId: map['versionId'] as String,
      versionUpdateTime: map['versionUpdateTime'] as String,
    );
  }
}
