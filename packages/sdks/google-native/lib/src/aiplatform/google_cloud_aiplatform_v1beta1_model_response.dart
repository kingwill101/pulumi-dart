...
import 'google_cloud_aiplatform_v1beta1_model_export_format_response.dart';
import 'google_cloud_aiplatform_v1beta1_model_original_model_info_response.dart';
import 'google_cloud_aiplatform_v1beta1_model_source_info_response.dart';
import 'google_cloud_aiplatform_v1beta1_predict_schemata_response.dart';

/// A trained machine learning Model.
class GoogleCloudAiplatformV1beta1ModelResponse {
  ...
  final pulumi.Input<List<GoogleCloudAiplatformV1beta1DeployedModelRefResponse>> deployedModels;
  ...
  final pulumi.Input<GoogleCloudAiplatformV1beta1ModelSourceInfoResponse> modelSourceInfo;
  /// The resource name of the Model.
  final pulumi.Input<String> name;
  /// If this Model is a copy of another Model, this contains info about the original.
  final pulumi.Input<GoogleCloudAiplatformV1beta1ModelOriginalModelInfoResponse> originalModelInfo;
  ...
  final pulumi.Input<List<GoogleCloudAiplatformV1beta1ModelExportFormatResponse>> supportedExportFormats;
  ...
  /// Creates a new [GoogleCloudAiplatformV1beta1ModelResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'deployedModels': pulumi.Input.mapInputValue<List<GoogleCloudAiplatformV1beta1DeployedModelRefResponse>, List<Map<String, dynamic>>>(deployedModels, (value) => pulumi.Input.encodeList<GoogleCloudAiplatformV1beta1DeployedModelRefResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      ...
      'modelSourceInfo': pulumi.Input.mapInputValue<GoogleCloudAiplatformV1beta1ModelSourceInfoResponse, Map<String, dynamic>>(modelSourceInfo, (value) => value.toMap()),
      'name': name,
      'originalModelInfo': pulumi.Input.mapInputValue<GoogleCloudAiplatformV1beta1ModelOriginalModelInfoResponse, Map<String, dynamic>>(originalModelInfo, (value) => value.toMap()),
      ...
      'supportedExportFormats': pulumi.Input.mapInputValue<List<GoogleCloudAiplatformV1beta1ModelExportFormatResponse>, List<Map<String, dynamic>>>(supportedExportFormats, (value) => pulumi.Input.encodeList<GoogleCloudAiplatformV1beta1ModelExportFormatResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory GoogleCloudAiplatformV1beta1ModelResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1ModelResponse(
      artifactUri: (map['artifactUri'] as String).input(),
      containerSpec: (GoogleCloudAiplatformV1beta1ModelContainerSpecResponse.fromMap((map['containerSpec'] as Map).cast<String, dynamic>())).input(),
      createTime: (map['createTime'] as String).input(),
      deployedModels: (pulumi.Input.decodeList<GoogleCloudAiplatformV1beta1DeployedModelRefResponse>(map['deployedModels'], (value) => GoogleCloudAiplatformV1beta1DeployedModelRefResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      description: (map['description'] as String).input(),
      displayName: (map['displayName'] as String).input(),
      encryptionSpec: (GoogleCloudAiplatformV1beta1EncryptionSpecResponse.fromMap((map['encryptionSpec'] as Map).cast<String, dynamic>())).input(),
      etag: (map['etag'] as String).input(),
      explanationSpec: (GoogleCloudAiplatformV1beta1ExplanationSpecResponse.fromMap((map['explanationSpec'] as Map).cast<String, dynamic>())).input(),
      labels: ((map['labels'] as Map).cast<String, String>()).input(),
      metadata: (map['metadata']).input(),
      metadataArtifact: (map['metadataArtifact'] as String).input(),
      metadataSchemaUri: (map['metadataSchemaUri'] as String).input(),
      modelSourceInfo: (GoogleCloudAiplatformV1beta1ModelSourceInfoResponse.fromMap((map['modelSourceInfo'] as Map).cast<String, dynamic>())).input(),
      name: (map['name'] as String).input(),
      originalModelInfo: (GoogleCloudAiplatformV1beta1ModelOriginalModelInfoResponse.fromMap((map['originalModelInfo'] as Map).cast<String, dynamic>())).input(),
      predictSchemata: (GoogleCloudAiplatformV1beta1PredictSchemataResponse.fromMap((map['predictSchemata'] as Map).cast<String, dynamic>())).input(),
      supportedDeploymentResourcesTypes: ((map['supportedDeploymentResourcesTypes'] as List).cast<String>()).input(),
      supportedExportFormats: (pulumi.Input.decodeList<GoogleCloudAiplatformV1beta1ModelExportFormatResponse>(map['supportedExportFormats'], (value) => GoogleCloudAiplatformV1beta1ModelExportFormatResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      supportedInputStorageFormats: ((map['supportedInputStorageFormats'] as List).cast<String>()).input(),
      supportedOutputStorageFormats: ((map['supportedOutputStorageFormats'] as List).cast<String>()).input(),
      trainingPipeline: (map['trainingPipeline'] as String).input(),
      updateTime: (map['updateTime'] as String).input(),
      versionAliases: ((map['versionAliases'] as List).cast<String>()).input(),
      versionCreateTime: (map['versionCreateTime'] as String).input(),
      versionDescription: (map['versionDescription'] as String).input(),
      versionId: (map['versionId'] as String).input(),
      versionUpdateTime: (map['versionUpdateTime'] as String).input(),
    );
  }
}
