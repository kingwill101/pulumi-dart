...
class GoogleCloudAiplatformV1MachineSpec {
  ...
  const GoogleCloudAiplatformV1MachineSpec({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'acceleratorType': ?pulumi.Input.mapOptionalInputValue<GoogleCloudAiplatformV1MachineSpecAcceleratorType, String>(acceleratorType, (value) => value.wireValue),
  ...
  factory GoogleCloudAiplatformV1MachineSpec.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1MachineSpec(
      ...
      acceleratorType: (() { final guardedValue = map['acceleratorType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1MachineSpecAcceleratorType.fromValue(guardedValue as String)); })(),
