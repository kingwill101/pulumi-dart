...
class GetModelDeploymentMonitoringJobResult {
  ...
  final List<GoogleCloudAiplatformV1ModelDeploymentMonitoringBigQueryTableResponse> bigqueryTables;
  ...
  final GoogleCloudAiplatformV1ModelDeploymentMonitoringJobLatestMonitoringPipelineMetadataResponse latestMonitoringPipelineMetadata;
  ...
  final List<GoogleCloudAiplatformV1ModelDeploymentMonitoringObjectiveConfigResponse> modelDeploymentMonitoringObjectiveConfigs;
  /// Schedule config for running the monitoring job.
  final GoogleCloudAiplatformV1ModelDeploymentMonitoringScheduleConfigResponse modelDeploymentMonitoringScheduleConfig;
  /// Alert config for model monitoring.
  final GoogleCloudAiplatformV1ModelMonitoringAlertConfigResponse modelMonitoringAlertConfig;
  ...
  final GoogleCloudAiplatformV1GcsDestinationResponse statsAnomaliesBaseDirectory;
  ...
  const GetModelDeploymentMonitoringJobResult({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'bigqueryTables': pulumi.Input.encodeList<GoogleCloudAiplatformV1ModelDeploymentMonitoringBigQueryTableResponse, Map<String, dynamic>>(bigqueryTables, (value) => value.toMap()),
      ...
      'error': error.toMap(),
      'labels': labels,
      'latestMonitoringPipelineMetadata': latestMonitoringPipelineMetadata.toMap(),
      'logTtl': logTtl,
      'loggingSamplingStrategy': loggingSamplingStrategy.toMap(),
      'modelDeploymentMonitoringObjectiveConfigs': pulumi.Input.encodeList<GoogleCloudAiplatformV1ModelDeploymentMonitoringObjectiveConfigResponse, Map<String, dynamic>>(modelDeploymentMonitoringObjectiveConfigs, (value) => value.toMap()),
      'modelDeploymentMonitoringScheduleConfig': modelDeploymentMonitoringScheduleConfig.toMap(),
  ...
  factory GetModelDeploymentMonitoringJobResult.fromMap(Map<String, dynamic> map) {
    return GetModelDeploymentMonitoringJobResult(
      analysisInstanceSchemaUri: map['analysisInstanceSchemaUri'] as String,
      bigqueryTables: pulumi.Input.decodeList<GoogleCloudAiplatformV1ModelDeploymentMonitoringBigQueryTableResponse>(map['bigqueryTables']!, (value) => GoogleCloudAiplatformV1ModelDeploymentMonitoringBigQueryTableResponse.fromMap((value as Map).cast<String, dynamic>())),
      ...
      latestMonitoringPipelineMetadata: GoogleCloudAiplatformV1ModelDeploymentMonitoringJobLatestMonitoringPipelineMetadataResponse.fromMap((map['latestMonitoringPipelineMetadata']! as Map).cast<String, dynamic>()),
      logTtl: map['logTtl'] as String,
      loggingSamplingStrategy: GoogleCloudAiplatformV1SamplingStrategyResponse.fromMap((map['loggingSamplingStrategy']! as Map).cast<String, dynamic>()),
      modelDeploymentMonitoringObjectiveConfigs: pulumi.Input.decodeList<GoogleCloudAiplatformV1ModelDeploymentMonitoringObjectiveConfigResponse>(map['modelDeploymentMonitoringObjectiveConfigs']!, (value) => GoogleCloudAiplatformV1ModelDeploymentMonitoringObjectiveConfigResponse.fromMap((value as Map).cast<String, dynamic>())),
      modelDeploymentMonitoringScheduleConfig: GoogleCloudAiplatformV1ModelDeploymentMonitoringScheduleConfigResponse.fromMap((map['modelDeploymentMonitoringScheduleConfig']! as Map).cast<String, dynamic>()),
      modelMonitoringAlertConfig: GoogleCloudAiplatformV1ModelMonitoringAlertConfigResponse.fromMap((map['modelMonitoringAlertConfig']! as Map).cast<String, dynamic>()),
      ...
      statsAnomaliesBaseDirectory: GoogleCloudAiplatformV1GcsDestinationResponse.fromMap((map['statsAnomaliesBaseDirectory']! as Map).cast<String, dynamic>()),
