...
class GetContextAiplatformV1beta1Result {
  ...
  /// Creates a new [GetContextAiplatformV1beta1Result].
  ...
  const GetContextAiplatformV1beta1Result({
  ...
  factory GetContextAiplatformV1beta1Result.fromMap(Map<String, dynamic> map) {
    return GetContextAiplatformV1beta1Result(
