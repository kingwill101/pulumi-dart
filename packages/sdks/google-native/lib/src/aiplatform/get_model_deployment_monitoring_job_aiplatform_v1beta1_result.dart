...
class GetModelDeploymentMonitoringJobAiplatformV1beta1Result {
  ...
  final List<GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringBigQueryTableResponse> bigqueryTables;
  ...
  final GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringJobLatestMonitoringPipelineMetadataResponse latestMonitoringPipelineMetadata;
  ...
  final List<GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringObjectiveConfigResponse> modelDeploymentMonitoringObjectiveConfigs;
  /// Schedule config for running the monitoring job.
  final GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringScheduleConfigResponse modelDeploymentMonitoringScheduleConfig;
  /// Alert config for model monitoring.
  final GoogleCloudAiplatformV1beta1ModelMonitoringAlertConfigResponse modelMonitoringAlertConfig;
  ...
  /// Creates a new [GetModelDeploymentMonitoringJobAiplatformV1beta1Result].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'bigqueryTables': pulumi.Input.encodeList<GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringBigQueryTableResponse, Map<String, dynamic>>(bigqueryTables, (value) => value.toMap()),
      ...
      'modelDeploymentMonitoringObjectiveConfigs': pulumi.Input.encodeList<GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringObjectiveConfigResponse, Map<String, dynamic>>(modelDeploymentMonitoringObjectiveConfigs, (value) => value.toMap()),
  ...
  factory GetModelDeploymentMonitoringJobAiplatformV1beta1Result.fromMap(Map<String, dynamic> map) {
    return GetModelDeploymentMonitoringJobAiplatformV1beta1Result(
      analysisInstanceSchemaUri: map['analysisInstanceSchemaUri'] as String,
      bigqueryTables: pulumi.Input.decodeList<GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringBigQueryTableResponse>(map['bigqueryTables']!, (value) => GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringBigQueryTableResponse.fromMap((value as Map).cast<String, dynamic>())),
      ...
      latestMonitoringPipelineMetadata: GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringJobLatestMonitoringPipelineMetadataResponse.fromMap((map['latestMonitoringPipelineMetadata']! as Map).cast<String, dynamic>()),
      ...
      modelDeploymentMonitoringObjectiveConfigs: pulumi.Input.decodeList<GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringObjectiveConfigResponse>(map['modelDeploymentMonitoringObjectiveConfigs']!, (value) => GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringObjectiveConfigResponse.fromMap((value as Map).cast<String, dynamic>())),
      modelDeploymentMonitoringScheduleConfig: GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringScheduleConfigResponse.fromMap((map['modelDeploymentMonitoringScheduleConfig']! as Map).cast<String, dynamic>()),
      modelMonitoringAlertConfig: GoogleCloudAiplatformV1beta1ModelMonitoringAlertConfigResponse.fromMap((map['modelMonitoringAlertConfig']! as Map).cast<String, dynamic>()),
