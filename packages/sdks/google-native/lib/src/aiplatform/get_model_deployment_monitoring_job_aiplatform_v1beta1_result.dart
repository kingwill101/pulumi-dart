...
class GetModelDeploymentMonitoringJobAiplatformV1beta1Result {
  ...
  final GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringJobLatestMonitoringPipelineMetadataResponse
  ...
  final GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringScheduleConfigResponse
  ...
  factory GetModelDeploymentMonitoringJobAiplatformV1beta1Result.fromMap(
    ...
    return GetModelDeploymentMonitoringJobAiplatformV1beta1Result(
      ...
      bigqueryTables:
          ...
          >(
            map['bigqueryTables']!,
            (value) =>
                GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringBigQueryTableResponse.fromMap(
      ...
      latestMonitoringPipelineMetadata:
          GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringJobLatestMonitoringPipelineMetadataResponse.fromMap(
      ...
      modelDeploymentMonitoringObjectiveConfigs:
          ...
          >(
            ...
            (value) =>
                GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringObjectiveConfigResponse.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
      modelDeploymentMonitoringScheduleConfig:
          GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringScheduleConfigResponse.fromMap(
            (map['modelDeploymentMonitoringScheduleConfig']! as Map)
                .cast<String, dynamic>(),
          ),
      modelMonitoringAlertConfig:
          GoogleCloudAiplatformV1beta1ModelMonitoringAlertConfigResponse.fromMap(
