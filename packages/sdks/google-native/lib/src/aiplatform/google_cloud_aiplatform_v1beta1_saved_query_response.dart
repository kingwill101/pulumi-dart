...
class GoogleCloudAiplatformV1beta1SavedQueryResponse {
  ...
  factory GoogleCloudAiplatformV1beta1SavedQueryResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1SavedQueryResponse(
      annotationFilter: pulumi.Input.fromValue(map['annotationFilter'] as String),
      annotationSpecCount: pulumi.Input.fromValue(map['annotationSpecCount'] as int),
      ...
      supportAutomlTraining: pulumi.Input.fromValue(map['supportAutomlTraining'] as bool),
