...
class GoogleCloudAiplatformV1beta1XraiAttributionResponse {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1beta1BlurBaselineConfigResponse>
  blurBaselineConfig;

  /// Config for SmoothGrad approximation of gradients. When enabled, the gradients are approximated by averaging the gradients from noisy samples in the vicinity of the inputs. Adding noise can help improve the computed gradients. Refer to this paper for more details: https://arxiv.org/pdf/1706.03825.pdf
  final pulumi.Input<GoogleCloudAiplatformV1beta1SmoothGradConfigResponse>
  smoothGradConfig;
  ...
  factory GoogleCloudAiplatformV1beta1XraiAttributionResponse.fromMap(
