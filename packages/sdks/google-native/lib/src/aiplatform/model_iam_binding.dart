...
import 'model_iam_binding_args.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class ModelIamBinding extends pulumi.CustomResource {
  ...
  /// Creates a new [ModelIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ModelIamBinding]. {@macro pulumi_aiplatform_v1beta1_model_iam_binding_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  ModelIamBinding(
    String name, {
    ModelIamBindingArgs? args,
