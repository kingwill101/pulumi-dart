...
class GoogleCloudAiplatformV1beta1Model {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1beta1ModelContainerSpec>?
  containerSpec;
  ...
  final pulumi.Input<GoogleCloudAiplatformV1beta1PredictSchemata>?
  predictSchemata;
  ...
  factory GoogleCloudAiplatformV1beta1Model.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1Model(
      ...
      predictSchemata: (() {
        final guardedValue = map['predictSchemata'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
