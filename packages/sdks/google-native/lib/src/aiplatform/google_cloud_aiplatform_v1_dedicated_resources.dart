...
class GoogleCloudAiplatformV1DedicatedResources {
  ...
  final pulumi.Input<List<GoogleCloudAiplatformV1AutoscalingMetricSpec>>?
    ...
    return <String, dynamic>{
      'autoscalingMetricSpecs':
          ?pulumi.Input.mapOptionalInputValue<
            List<GoogleCloudAiplatformV1AutoscalingMetricSpec>,
    ...
    return GoogleCloudAiplatformV1DedicatedResources(
      autoscalingMetricSpecs: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GoogleCloudAiplatformV1AutoscalingMetricSpec>(
            guardedValue,
