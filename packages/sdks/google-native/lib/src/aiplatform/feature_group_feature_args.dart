...
class FeatureGroupFeatureArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'project': ?project,
      'valueType': ?pulumi.Input.mapOptionalInputValue<FeatureGroupFeatureValueType, String>(valueType, (value) => value.wireValue),
  ...
  factory FeatureGroupFeatureArgs.fromMap(Map<String, dynamic> map) {
    return FeatureGroupFeatureArgs(
      ...
      valueType: (() { final guardedValue = map['valueType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FeatureGroupFeatureValueType.fromValue(guardedValue as String)); })(),
