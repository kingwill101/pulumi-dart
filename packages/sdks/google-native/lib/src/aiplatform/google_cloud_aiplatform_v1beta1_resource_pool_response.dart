...
class GoogleCloudAiplatformV1beta1ResourcePoolResponse {
  ...
  factory GoogleCloudAiplatformV1beta1ResourcePoolResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1ResourcePoolResponse(
      autoscalingSpec: pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1ResourcePoolAutoscalingSpecResponse.fromMap((map['autoscalingSpec']! as Map).cast<String, dynamic>())),
      ...
      usedReplicaCount: pulumi.Input.fromValue(map['usedReplicaCount'] as String),
    );
  }
}
