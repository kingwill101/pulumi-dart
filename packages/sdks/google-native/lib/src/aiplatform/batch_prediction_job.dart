...
class BatchPredictionJob extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<GoogleRpcStatusResponse>> partialFailures;
  ...
  BatchPredictionJob(
    ...
    this.completionStats = registerOutput<GoogleCloudAiplatformV1CompletionStatsResponse>('completionStats');
    this.createTime = registerOutput<String>('createTime');
    this.dedicatedResources = registerOutput<GoogleCloudAiplatformV1BatchDedicatedResourcesResponse>('dedicatedResources');
    ...
    this.explanationSpec = registerOutput<GoogleCloudAiplatformV1ExplanationSpecResponse>('explanationSpec');
    this.generateExplanation = registerOutput<bool>('generateExplanation');
    this.inputConfig = registerOutput<GoogleCloudAiplatformV1BatchPredictionJobInputConfigResponse>('inputConfig');
    this.instanceConfig = registerOutput<GoogleCloudAiplatformV1BatchPredictionJobInstanceConfigResponse>('instanceConfig');
    this.labels = registerOutput<Map<String, String>>('labels');
    this.location = registerOutput<String>('location');
    this.manualBatchTuningParameters = registerOutput<GoogleCloudAiplatformV1ManualBatchTuningParametersResponse>('manualBatchTuningParameters');
    ...
    this.outputConfig = registerOutput<GoogleCloudAiplatformV1BatchPredictionJobOutputConfigResponse>('outputConfig');
    this.outputInfo = registerOutput<GoogleCloudAiplatformV1BatchPredictionJobOutputInfoResponse>('outputInfo');
    this.partialFailures = registerOutput<List<GoogleRpcStatusResponse>>('partialFailures');
    this.project = registerOutput<String>('project');
    this.resourcesConsumed = registerOutput<GoogleCloudAiplatformV1ResourcesConsumedResponse>('resourcesConsumed');
    this.serviceAccount = registerOutput<String>('serviceAccount');
    this.startTime = registerOutput<String>('startTime');
    this.state = registerOutput<String>('state');
    this.unmanagedContainerModel = registerOutput<GoogleCloudAiplatformV1UnmanagedContainerModelResponse>('unmanagedContainerModel');
