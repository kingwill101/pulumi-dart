...
class GoogleCloudAiplatformV1FeatureViewFeatureRegistrySourceResponse {
  ...
  final List<GoogleCloudAiplatformV1FeatureViewFeatureRegistrySourceFeatureGroupResponse> featureGroups;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'featureGroups': pulumi.Input.encodeList<GoogleCloudAiplatformV1FeatureViewFeatureRegistrySourceFeatureGroupResponse, Map<String, dynamic>>(featureGroups, (value) => value.toMap()),
    };
  }
  ...
  factory GoogleCloudAiplatformV1FeatureViewFeatureRegistrySourceResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1FeatureViewFeatureRegistrySourceResponse(
      featureGroups: pulumi.Input.decodeList<GoogleCloudAiplatformV1FeatureViewFeatureRegistrySourceFeatureGroupResponse>(map['featureGroups'], (value) => GoogleCloudAiplatformV1FeatureViewFeatureRegistrySourceFeatureGroupResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
