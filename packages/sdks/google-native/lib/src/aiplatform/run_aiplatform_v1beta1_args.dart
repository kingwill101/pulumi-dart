...
/// {@template pulumi_aiplatform_v1beta1_run_aiplatform_v1beta1_args_doc}
/// The set of arguments for Run.
/// {@endtemplate}
/// {@macro pulumi_aiplatform_v1beta1_run_aiplatform_v1beta1_args_doc}
class RunAiplatformV1beta1Args {
  ...
  /// Creates a new [RunAiplatformV1beta1Args].
  ...
  factory RunAiplatformV1beta1Args.fromMap(Map<String, dynamic> map) {
    return RunAiplatformV1beta1Args(
      ...
      tensorboardRunId: pulumi.Input.fromValue(
        map['tensorboardRunId'] as String,
      ),
    );
  }
}
