...
class GoogleCloudAiplatformV1beta1StudySpecParameterSpecConditionalParameterSpecResponse {
  ...
  factory GoogleCloudAiplatformV1beta1StudySpecParameterSpecConditionalParameterSpecResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1StudySpecParameterSpecConditionalParameterSpecResponse(
      parameterSpec: (GoogleCloudAiplatformV1beta1StudySpecParameterSpecResponse.fromMap((map['parameterSpec'] as Map).cast<String, dynamic>())).input(),
      parentCategoricalValues: (GoogleCloudAiplatformV1beta1StudySpecParameterSpecConditionalParameterSpecCategoricalValueConditionResponse.fromMap((map['parentCategoricalValues'] as Map).cast<String, dynamic>())).input(),
      parentDiscreteValues: (GoogleCloudAiplatformV1beta1StudySpecParameterSpecConditionalParameterSpecDiscreteValueConditionResponse.fromMap((map['parentDiscreteValues'] as Map).cast<String, dynamic>())).input(),
      parentIntValues: (GoogleCloudAiplatformV1beta1StudySpecParameterSpecConditionalParameterSpecIntValueConditionResponse.fromMap((map['parentIntValues'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
