...
class GoogleCloudAiplatformV1NasJobSpecMultiTrialAlgorithmSpecTrainTrialSpec {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1CustomJobSpec> trainTrialJobSpec;

  /// Creates a new [GoogleCloudAiplatformV1NasJobSpecMultiTrialAlgorithmSpecTrainTrialSpec].
  ...
  const GoogleCloudAiplatformV1NasJobSpecMultiTrialAlgorithmSpecTrainTrialSpec({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'trainTrialJobSpec': pulumi.Input.mapInputValue<GoogleCloudAiplatformV1CustomJobSpec, Map<String, dynamic>>(trainTrialJobSpec, (value) => value.toMap()),
    };
  }

  factory GoogleCloudAiplatformV1NasJobSpecMultiTrialAlgorithmSpecTrainTrialSpec.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1NasJobSpecMultiTrialAlgorithmSpecTrainTrialSpec(
      ...
      trainTrialJobSpec: pulumi.Input.fromValue(GoogleCloudAiplatformV1CustomJobSpec.fromMap((map['trainTrialJobSpec']! as Map).cast<String, dynamic>())),
    );
  }
}
