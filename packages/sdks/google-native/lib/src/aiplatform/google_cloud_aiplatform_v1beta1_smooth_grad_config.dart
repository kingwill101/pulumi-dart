...
class GoogleCloudAiplatformV1beta1SmoothGradConfig {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1beta1FeatureNoiseSigma>?
  featureNoiseSigma;
  ...
  factory GoogleCloudAiplatformV1beta1SmoothGradConfig.fromMap(
    ...
    return GoogleCloudAiplatformV1beta1SmoothGradConfig(
      featureNoiseSigma: (() {
        final guardedValue = map['featureNoiseSigma'];
      ...
      noiseSigma: (() {
        final guardedValue = map['noiseSigma'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as double);
      })(),
      noisySampleCount: (() {
        final guardedValue = map['noisySampleCount'];
        if (guardedValue == null) return null;
