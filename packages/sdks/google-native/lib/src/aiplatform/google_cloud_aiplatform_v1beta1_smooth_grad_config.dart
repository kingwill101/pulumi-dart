...
class GoogleCloudAiplatformV1beta1SmoothGradConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'featureNoiseSigma': ?featureNoiseSigma == null ? null : featureNoiseSigma!.toMap(),
  ...
  factory GoogleCloudAiplatformV1beta1SmoothGradConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1SmoothGradConfig(
      featureNoiseSigma: map['featureNoiseSigma'] == null ? null : GoogleCloudAiplatformV1beta1FeatureNoiseSigma.fromMap((map['featureNoiseSigma'] as Map).cast<String, dynamic>()),
      noiseSigma: map['noiseSigma'] == null ? null : map['noiseSigma'] as double,
      noisySampleCount: map['noisySampleCount'] == null ? null : map['noisySampleCount'] as int,
    );
  }
}
