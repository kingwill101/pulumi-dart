...
class GoogleCloudAiplatformV1beta1SmoothGradConfig {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1beta1FeatureNoiseSigma>? featureNoiseSigma;
  ...
  /// Creates a new [GoogleCloudAiplatformV1beta1SmoothGradConfig].
  ...
  const GoogleCloudAiplatformV1beta1SmoothGradConfig({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'featureNoiseSigma': ?pulumi.Input.mapOptionalInputValue<GoogleCloudAiplatformV1beta1FeatureNoiseSigma, Map<String, dynamic>>(featureNoiseSigma, (value) => value.toMap()),
      'noiseSigma': ?noiseSigma,
      'noisySampleCount': ?noisySampleCount,
    };
  }

  factory GoogleCloudAiplatformV1beta1SmoothGradConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1SmoothGradConfig(
      featureNoiseSigma: (() { final guardedValue = map['featureNoiseSigma']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1FeatureNoiseSigma.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
