...
class ScheduleArgs {
  ...
  factory ScheduleArgs.fromMap(Map<String, dynamic> map) {
    return ScheduleArgs(
      ...
      createPipelineJobRequest: (() { final guardedValue = map['createPipelineJobRequest']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1CreatePipelineJobRequest.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
