...
/// {@template pulumi_aiplatform_v1_schedule_args_doc}
/// The set of arguments for Schedule.
/// {@endtemplate}
/// {@macro pulumi_aiplatform_v1_schedule_args_doc}
class ScheduleArgs {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1CreatePipelineJobRequest>? createPipelineJobRequest;
  ...
  ScheduleArgs({
    ...
    pulumi.Output<GoogleCloudAiplatformV1CreatePipelineJobRequest>? createPipelineJobRequest,
    ...
    pulumi.Output<String>? startTime,
      ...
      createPipelineJobRequest = pulumi.Input.asOptionalInput<GoogleCloudAiplatformV1CreatePipelineJobRequest>(createPipelineJobRequest),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'createPipelineJobRequest': ?pulumi.Input.mapOptionalInputValue<GoogleCloudAiplatformV1CreatePipelineJobRequest, Map<String, dynamic>>(createPipelineJobRequest, (value) => value.toMap()),
      'cron': ?cron,
  ...
  factory ScheduleArgs.fromMap(Map<String, dynamic> map) {
    return ScheduleArgs(
      ...
      createPipelineJobRequest: map['createPipelineJobRequest'] == null ? null : pulumi.Output.create<GoogleCloudAiplatformV1CreatePipelineJobRequest>(GoogleCloudAiplatformV1CreatePipelineJobRequest.fromMap((map['createPipelineJobRequest'] as Map).cast<String, dynamic>())),
