...
class GoogleCloudAiplatformV1beta1SampledShapleyAttribution {
  ...
  const GoogleCloudAiplatformV1beta1SampledShapleyAttribution({
  ...
  factory GoogleCloudAiplatformV1beta1SampledShapleyAttribution.fromMap(Map<String, dynamic> map) {
