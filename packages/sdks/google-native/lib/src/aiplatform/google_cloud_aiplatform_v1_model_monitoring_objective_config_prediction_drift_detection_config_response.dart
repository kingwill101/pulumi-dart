...
class GoogleCloudAiplatformV1ModelMonitoringObjectiveConfigPredictionDriftDetectionConfigResponse {
  ...
  /// Creates a new [GoogleCloudAiplatformV1ModelMonitoringObjectiveConfigPredictionDriftDetectionConfigResponse].
  ...
  factory GoogleCloudAiplatformV1ModelMonitoringObjectiveConfigPredictionDriftDetectionConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1ModelMonitoringObjectiveConfigPredictionDriftDetectionConfigResponse(
      attributionScoreDriftThresholds: ((map['attributionScoreDriftThresholds'] as Map).cast<String, String>()).input(),
      defaultDriftThreshold: (GoogleCloudAiplatformV1ThresholdConfigResponse.fromMap((map['defaultDriftThreshold'] as Map).cast<String, dynamic>())).input(),
      driftThresholds: ((map['driftThresholds'] as Map).cast<String, String>()).input(),
    );
  }
}
