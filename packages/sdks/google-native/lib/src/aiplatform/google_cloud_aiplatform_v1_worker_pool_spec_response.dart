...
class GoogleCloudAiplatformV1WorkerPoolSpecResponse {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1ContainerSpecResponse>
  containerSpec;
  ...
  final pulumi.Input<GoogleCloudAiplatformV1PythonPackageSpecResponse>
  pythonPackageSpec;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'nfsMounts':
          pulumi.Input.mapInputValue<
            List<GoogleCloudAiplatformV1NfsMountResponse>,
  ...
  factory GoogleCloudAiplatformV1WorkerPoolSpecResponse.fromMap(
    ...
    return GoogleCloudAiplatformV1WorkerPoolSpecResponse(
      containerSpec: pulumi.Input.fromValue(
        GoogleCloudAiplatformV1ContainerSpecResponse.fromMap(
          (map['containerSpec']! as Map).cast<String, dynamic>(),
        ),
      ),
      diskSpec: pulumi.Input.fromValue(
        GoogleCloudAiplatformV1DiskSpecResponse.fromMap(
