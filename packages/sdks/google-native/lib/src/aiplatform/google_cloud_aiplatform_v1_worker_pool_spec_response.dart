...
class GoogleCloudAiplatformV1WorkerPoolSpecResponse {
  ...
  const GoogleCloudAiplatformV1WorkerPoolSpecResponse({
  ...
  factory GoogleCloudAiplatformV1WorkerPoolSpecResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1WorkerPoolSpecResponse(
      containerSpec: pulumi.Input.fromValue(GoogleCloudAiplatformV1ContainerSpecResponse.fromMap((map['containerSpec']! as Map).cast<String, dynamic>())),
      diskSpec: pulumi.Input.fromValue(GoogleCloudAiplatformV1DiskSpecResponse.fromMap((map['diskSpec']! as Map).cast<String, dynamic>())),
      ...
      nfsMounts: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudAiplatformV1NfsMountResponse>(map['nfsMounts']!, (value) => GoogleCloudAiplatformV1NfsMountResponse.fromMap((value as Map).cast<String, dynamic>()))),
      pythonPackageSpec: pulumi.Input.fromValue(GoogleCloudAiplatformV1PythonPackageSpecResponse.fromMap((map['pythonPackageSpec']! as Map).cast<String, dynamic>())),
