...
class GoogleCloudAiplatformV1Model {
  ...
  factory GoogleCloudAiplatformV1Model.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1Model(
      ...
      containerSpec: map['containerSpec'] == null ? null : GoogleCloudAiplatformV1ModelContainerSpec.fromMap((map['containerSpec'] as Map).cast<String, dynamic>()),
      ...
      pipelineJob: map['pipelineJob'] == null ? null : map['pipelineJob'] as String,
      predictSchemata: map['predictSchemata'] == null ? null : GoogleCloudAiplatformV1PredictSchemata.fromMap((map['predictSchemata'] as Map).cast<String, dynamic>()),
