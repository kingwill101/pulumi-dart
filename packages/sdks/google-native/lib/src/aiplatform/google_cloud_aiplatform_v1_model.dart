...
class GoogleCloudAiplatformV1Model {
  ...
  const GoogleCloudAiplatformV1Model({
    this.artifactUri,
    this.containerSpec,
    this.description,
  ...
  factory GoogleCloudAiplatformV1Model.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1Model(
      ...
      pipelineJob: (() { final guardedValue = map['pipelineJob']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
