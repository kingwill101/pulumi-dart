...
class FeaturestoreAiplatformV1beta1Args {
  ...
  factory FeaturestoreAiplatformV1beta1Args.fromMap(Map<String, dynamic> map) {
    return FeaturestoreAiplatformV1beta1Args(
      ...
      onlineServingConfig: (() { final guardedValue = map['onlineServingConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1FeaturestoreOnlineServingConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
