...
class TimeSeriesArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'valueType': pulumi.Input.mapInputValue<TimeSeriesValueType, String>(valueType, (value) => value.wireValue),
    };
  }
  ...
  factory TimeSeriesArgs.fromMap(Map<String, dynamic> map) {
    return TimeSeriesArgs(
      ...
      tensorboardTimeSeriesId: (() { final guardedValue = map['tensorboardTimeSeriesId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      valueType: pulumi.Input.fromValue(TimeSeriesValueType.fromValue(map['valueType']! as String)),
    );
  }
}
