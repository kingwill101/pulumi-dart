...
class GetNotebookRuntimeTemplateResult {
  ...
  final GoogleCloudAiplatformV1PersistentDiskSpecResponse dataPersistentDiskSpec;
  ...
  final GoogleCloudAiplatformV1NotebookIdleShutdownConfigResponse idleShutdownConfig;
  ...
  /// Creates a new [GetNotebookRuntimeTemplateResult].
  ...
  factory GetNotebookRuntimeTemplateResult.fromMap(Map<String, dynamic> map) {
    return GetNotebookRuntimeTemplateResult(
      ...
      dataPersistentDiskSpec: GoogleCloudAiplatformV1PersistentDiskSpecResponse.fromMap((map['dataPersistentDiskSpec']! as Map).cast<String, dynamic>()),
      description: map['description'] as String,
      displayName: map['displayName'] as String,
      etag: map['etag'] as String,
      eucConfig: GoogleCloudAiplatformV1NotebookEucConfigResponse.fromMap((map['eucConfig']! as Map).cast<String, dynamic>()),
      idleShutdownConfig: GoogleCloudAiplatformV1NotebookIdleShutdownConfigResponse.fromMap((map['idleShutdownConfig']! as Map).cast<String, dynamic>()),
      ...
      networkSpec: GoogleCloudAiplatformV1NetworkSpecResponse.fromMap((map['networkSpec']! as Map).cast<String, dynamic>()),
