...
class GoogleCloudAiplatformV1SamplingStrategy {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1SamplingStrategyRandomSampleConfig>?
  randomSampleConfig;
  ...
  GoogleCloudAiplatformV1SamplingStrategy({this.randomSampleConfig});
  ...
  factory GoogleCloudAiplatformV1SamplingStrategy.fromMap(
    ...
    return GoogleCloudAiplatformV1SamplingStrategy(
      randomSampleConfig: (() {
        final guardedValue = map['randomSampleConfig'];
