...
class GoogleCloudAiplatformV1SamplingStrategy {
  ...
  factory GoogleCloudAiplatformV1SamplingStrategy.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1SamplingStrategy(
      randomSampleConfig: (() { final guardedValue = map['randomSampleConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1SamplingStrategyRandomSampleConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
