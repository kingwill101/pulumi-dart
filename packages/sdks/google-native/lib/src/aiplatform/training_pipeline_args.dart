...
class TrainingPipelineArgs {
  ...
  factory TrainingPipelineArgs.fromMap(Map<String, dynamic> map) {
    return TrainingPipelineArgs(
      ...
      inputDataConfig: (() { final guardedValue = map['inputDataConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1InputDataConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      modelToUpload: (() { final guardedValue = map['modelToUpload']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1Model.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
