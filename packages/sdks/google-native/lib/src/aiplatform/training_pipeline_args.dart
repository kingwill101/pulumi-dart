    ...
    return <String, dynamic>{
      ...
      'modelToUpload':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(modelToUpload, (value) => value.toMap()),
  ...
  factory TrainingPipelineArgs.fromMap(Map<String, dynamic> map) {
    return TrainingPipelineArgs(
      ...
      inputDataConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GoogleCloudAiplatformV1InputDataConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      modelToUpload: (() {
        final guardedValue = map['modelToUpload'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GoogleCloudAiplatformV1Model.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      parentModel: (() {
        final guardedValue = map['parentModel'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      project: (() {
      ...
      trainingTaskDefinition: pulumi.Input.fromValue(
        map['trainingTaskDefinition'] as String,
      ),
