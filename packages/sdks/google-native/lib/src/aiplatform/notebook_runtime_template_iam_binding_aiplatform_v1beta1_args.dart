...
/// {@template pulumi_aiplatform_v1beta1_notebook_runtime_template_iam_binding_aiplatform_v1beta1_args_doc}
/// The set of arguments for NotebookRuntimeTemplateIamBinding.
/// {@endtemplate}
/// {@macro pulumi_aiplatform_v1beta1_notebook_runtime_template_iam_binding_aiplatform_v1beta1_args_doc}
class NotebookRuntimeTemplateIamBindingAiplatformV1beta1Args {
  ...
  /// Creates a new [NotebookRuntimeTemplateIamBindingAiplatformV1beta1Args].
  ...
  const NotebookRuntimeTemplateIamBindingAiplatformV1beta1Args({
    this.condition,
  ...
  factory NotebookRuntimeTemplateIamBindingAiplatformV1beta1Args.fromMap(Map<String, dynamic> map) {
    return NotebookRuntimeTemplateIamBindingAiplatformV1beta1Args(
