...
class GoogleCloudAiplatformV1beta1ExplanationSpec {
  ...
  const GoogleCloudAiplatformV1beta1ExplanationSpec({
    this.metadata,
  ...
  factory GoogleCloudAiplatformV1beta1ExplanationSpec.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1ExplanationSpec(
      metadata: (() { final guardedValue = map['metadata']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1ExplanationMetadata.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      parameters: pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1ExplanationParameters.fromMap((map['parameters']! as Map).cast<String, dynamic>())),
    );
  }
}
