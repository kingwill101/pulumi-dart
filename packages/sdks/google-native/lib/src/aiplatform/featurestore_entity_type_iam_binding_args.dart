...
/// {@template pulumi_aiplatform_v1_featurestore_entity_type_iam_binding_args_doc}
/// The set of arguments for FeaturestoreEntityTypeIamBinding.
/// {@endtemplate}
/// {@macro pulumi_aiplatform_v1_featurestore_entity_type_iam_binding_args_doc}
class FeaturestoreEntityTypeIamBindingArgs {
  ...
  /// Creates a new [FeaturestoreEntityTypeIamBindingArgs].
  ...
  const FeaturestoreEntityTypeIamBindingArgs({
    this.condition,
  ...
  factory FeaturestoreEntityTypeIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return FeaturestoreEntityTypeIamBindingArgs(
