...
class GoogleCloudAiplatformV1Examples {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1ExamplesExampleGcsSource>?
  exampleGcsSource;
  ...
  factory GoogleCloudAiplatformV1Examples.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1Examples(
      exampleGcsSource: (() {
        final guardedValue = map['exampleGcsSource'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GoogleCloudAiplatformV1ExamplesExampleGcsSource.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      nearestNeighborSearchConfig: (() {
        final guardedValue = map['nearestNeighborSearchConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue);
      })(),
      neighborCount: (() {
        final guardedValue = map['neighborCount'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      presets: (() {
        final guardedValue = map['presets'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GoogleCloudAiplatformV1Presets.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
