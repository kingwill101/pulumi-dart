...
class GoogleCloudAiplatformV1PredefinedSplit {
  ...
  /// Creates a new [GoogleCloudAiplatformV1PredefinedSplit].
  ...
  const GoogleCloudAiplatformV1PredefinedSplit({
    required this.key,
  });
  ...
  factory GoogleCloudAiplatformV1PredefinedSplit.fromMap(Map<String, dynamic> map) {
