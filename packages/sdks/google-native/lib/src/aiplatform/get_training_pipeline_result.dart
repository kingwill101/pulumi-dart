...
class GetTrainingPipelineResult {
  ...
  const GetTrainingPipelineResult({
  ...
  factory GetTrainingPipelineResult.fromMap(Map<String, dynamic> map) {
    return GetTrainingPipelineResult(
      ...
      inputDataConfig: GoogleCloudAiplatformV1InputDataConfigResponse.fromMap((map['inputDataConfig']! as Map).cast<String, dynamic>()),
      labels: (map['labels'] as Map).cast<String, String>(),
      modelId: map['modelId'] as String,
      modelToUpload: GoogleCloudAiplatformV1ModelResponse.fromMap((map['modelToUpload']! as Map).cast<String, dynamic>()),
