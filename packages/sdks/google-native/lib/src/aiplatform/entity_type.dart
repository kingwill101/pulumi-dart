...
class EntityType extends pulumi.CustomResource {
  ...
  EntityType(
    ...
    monitoringConfig = registerOutput<GoogleCloudAiplatformV1FeaturestoreMonitoringConfigResponse>('monitoringConfig', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return GoogleCloudAiplatformV1FeaturestoreMonitoringConfigResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
