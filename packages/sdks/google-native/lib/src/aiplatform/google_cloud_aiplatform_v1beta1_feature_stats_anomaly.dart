...
class GoogleCloudAiplatformV1beta1FeatureStatsAnomaly {
  ...
  /// Creates a new [GoogleCloudAiplatformV1beta1FeatureStatsAnomaly].
  ...
  factory GoogleCloudAiplatformV1beta1FeatureStatsAnomaly.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1FeatureStatsAnomaly(
      anomalyDetectionThreshold: map['anomalyDetectionThreshold'] == null ? null : map['anomalyDetectionThreshold'] as double,
      anomalyUri: map['anomalyUri'] == null ? null : map['anomalyUri'] as String,
      distributionDeviation: map['distributionDeviation'] == null ? null : map['distributionDeviation'] as double,
