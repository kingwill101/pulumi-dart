...
class FeatureGroupFeature extends pulumi.CustomResource {
  ...
  /// Creates a new [FeatureGroupFeature].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [FeatureGroupFeature]. {@macro pulumi_aiplatform_v1_feature_group_feature_args_doc}
  ...
  FeatureGroupFeature(
    ...
    monitoringStatsAnomalies = registerOutput<List<Map<String, dynamic>>>(
