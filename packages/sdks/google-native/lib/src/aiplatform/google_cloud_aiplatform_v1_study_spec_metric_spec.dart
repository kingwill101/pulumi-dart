...
class GoogleCloudAiplatformV1StudySpecMetricSpec {
  ...
  const GoogleCloudAiplatformV1StudySpecMetricSpec({
    required this.goal,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'goal': pulumi.Input.mapInputValue<GoogleCloudAiplatformV1StudySpecMetricSpecGoal, String>(goal, (value) => value.wireValue),
      'metricId': metricId,
  ...
  factory GoogleCloudAiplatformV1StudySpecMetricSpec.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1StudySpecMetricSpec(
      goal: pulumi.Input.fromValue(GoogleCloudAiplatformV1StudySpecMetricSpecGoal.fromValue(map['goal']! as String)),
      metricId: pulumi.Input.fromValue(map['metricId'] as String),
      safetyConfig: (() { final guardedValue = map['safetyConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1StudySpecMetricSpecSafetyMetricConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
