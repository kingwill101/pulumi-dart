...
class GoogleCloudAiplatformV1DeployedModelResponse {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1PrivateEndpointsResponse> privateEndpoints;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'privateEndpoints': pulumi.Input.mapInputValue<GoogleCloudAiplatformV1PrivateEndpointsResponse, Map<String, dynamic>>(privateEndpoints, (value) => value.toMap()),
  ...
  factory GoogleCloudAiplatformV1DeployedModelResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1DeployedModelResponse(
      ...
      disableContainerLogging: pulumi.Input.fromValue(map['disableContainerLogging'] as bool),
      ...
      privateEndpoints: pulumi.Input.fromValue(GoogleCloudAiplatformV1PrivateEndpointsResponse.fromMap((map['privateEndpoints']! as Map).cast<String, dynamic>())),
