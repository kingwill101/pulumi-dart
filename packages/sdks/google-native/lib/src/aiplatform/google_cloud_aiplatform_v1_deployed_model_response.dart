...
class GoogleCloudAiplatformV1DeployedModelResponse {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1AutomaticResourcesResponse>
  automaticResources;
  ...
  final pulumi.Input<GoogleCloudAiplatformV1DedicatedResourcesResponse>
  dedicatedResources;
  ...
  final pulumi.Input<GoogleCloudAiplatformV1PrivateEndpointsResponse>
  privateEndpoints;
  ...
  factory GoogleCloudAiplatformV1DeployedModelResponse.fromMap(
    ...
    return GoogleCloudAiplatformV1DeployedModelResponse(
      ...
      disableContainerLogging: pulumi.Input.fromValue(
      ...
      privateEndpoints: pulumi.Input.fromValue(
        GoogleCloudAiplatformV1PrivateEndpointsResponse.fromMap(
