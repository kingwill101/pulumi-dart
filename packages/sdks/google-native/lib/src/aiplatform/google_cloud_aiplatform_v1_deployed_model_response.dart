...
class GoogleCloudAiplatformV1DeployedModelResponse {
  ...
  factory GoogleCloudAiplatformV1DeployedModelResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1DeployedModelResponse(
      ...
      disableContainerLogging: (map['disableContainerLogging'] as bool).input(),
      ...
      modelVersionId: (map['modelVersionId'] as String).input(),
      privateEndpoints: (GoogleCloudAiplatformV1PrivateEndpointsResponse.fromMap((map['privateEndpoints'] as Map).cast<String, dynamic>())).input(),
