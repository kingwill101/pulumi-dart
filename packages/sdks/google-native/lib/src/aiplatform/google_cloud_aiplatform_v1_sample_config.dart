...
import 'google_cloud_aiplatform_v1_sample_config_sample_strategy.dart';
...
class GoogleCloudAiplatformV1SampleConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'sampleStrategy': ?pulumi.Input.mapOptionalInputValue<GoogleCloudAiplatformV1SampleConfigSampleStrategy, String>(sampleStrategy, (value) => value.value),
    };
  }
