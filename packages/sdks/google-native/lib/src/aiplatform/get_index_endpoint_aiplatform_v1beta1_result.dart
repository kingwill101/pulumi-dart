...
class GetIndexEndpointAiplatformV1beta1Result {
  ...
  /// Creates a new [GetIndexEndpointAiplatformV1beta1Result].
  ...
  const GetIndexEndpointAiplatformV1beta1Result({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'deployedIndexes': pulumi.Input.encodeList<GoogleCloudAiplatformV1beta1DeployedIndexResponse, Map<String, dynamic>>(deployedIndexes, (value) => value.toMap()),
  ...
  factory GetIndexEndpointAiplatformV1beta1Result.fromMap(Map<String, dynamic> map) {
    return GetIndexEndpointAiplatformV1beta1Result(
      createTime: map['createTime'] as String,
      deployedIndexes: pulumi.Input.decodeList<GoogleCloudAiplatformV1beta1DeployedIndexResponse>(map['deployedIndexes']!, (value) => GoogleCloudAiplatformV1beta1DeployedIndexResponse.fromMap((value as Map).cast<String, dynamic>())),
