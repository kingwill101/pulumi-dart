...
class ModelDeploymentMonitoringJobAiplatformV1beta1Args {
  ...
  final pulumi.Input<
    List<GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringObjectiveConfig>
  >
    ...
    return <String, dynamic>{
      ...
      'modelMonitoringAlertConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(modelMonitoringAlertConfig, (value) => value.toMap()),
      ...
      'statsAnomaliesBaseDirectory':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(statsAnomaliesBaseDirectory, (value) => value.toMap()),
    };
  }
  ...
  factory ModelDeploymentMonitoringJobAiplatformV1beta1Args.fromMap(
    ...
    return ModelDeploymentMonitoringJobAiplatformV1beta1Args(
      analysisInstanceSchemaUri: (() {
        final guardedValue = map['analysisInstanceSchemaUri'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      displayName: pulumi.Input.fromValue(map['displayName'] as String),
      enableMonitoringPipelineLogs: (() {
        final guardedValue = map['enableMonitoringPipelineLogs'];
        if (guardedValue == null) return null;
      ...
      modelDeploymentMonitoringObjectiveConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringObjectiveConfig
        >(
          map['modelDeploymentMonitoringObjectiveConfigs']!,
          (value) =>
              GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringObjectiveConfig.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
      modelDeploymentMonitoringScheduleConfig: pulumi.Input.fromValue(
        GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringScheduleConfig.fromMap(
          (map['modelDeploymentMonitoringScheduleConfig']! as Map)
              .cast<String, dynamic>(),
        ),
      ),
      modelMonitoringAlertConfig: (() {
        final guardedValue = map['modelMonitoringAlertConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      predictInstanceSchemaUri: (() {
        final guardedValue = map['predictInstanceSchemaUri'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      project: (() {
      ...
      samplePredictInstance: (() {
        final guardedValue = map['samplePredictInstance'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue);
      })(),
      statsAnomaliesBaseDirectory: (() {
        final guardedValue = map['statsAnomaliesBaseDirectory'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
