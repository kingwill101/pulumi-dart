...
class ModelDeploymentMonitoringJobAiplatformV1beta1Args {
  ...
  factory ModelDeploymentMonitoringJobAiplatformV1beta1Args.fromMap(Map<String, dynamic> map) {
    return ModelDeploymentMonitoringJobAiplatformV1beta1Args(
      ...
      loggingSamplingStrategy: (GoogleCloudAiplatformV1beta1SamplingStrategy.fromMap((map['loggingSamplingStrategy'] as Map).cast<String, dynamic>())).input(),
      modelDeploymentMonitoringObjectiveConfigs: (pulumi.Input.decodeList<GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringObjectiveConfig>(map['modelDeploymentMonitoringObjectiveConfigs'], (value) => GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringObjectiveConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
      modelDeploymentMonitoringScheduleConfig: (GoogleCloudAiplatformV1beta1ModelDeploymentMonitoringScheduleConfig.fromMap((map['modelDeploymentMonitoringScheduleConfig'] as Map).cast<String, dynamic>())).input(),
      modelMonitoringAlertConfig: map['modelMonitoringAlertConfig'] == null ? null : (GoogleCloudAiplatformV1beta1ModelMonitoringAlertConfig.fromMap((map['modelMonitoringAlertConfig'] as Map).cast<String, dynamic>())).input(),
