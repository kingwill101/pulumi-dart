...
class PipelineJobAiplatformV1beta1Args {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1beta1PipelineJobRuntimeConfig>? runtimeConfig;
  ...
  const PipelineJobAiplatformV1beta1Args({
    this.displayName,
    this.encryptionSpec,
    this.labels,
    this.location,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'runtimeConfig': ?pulumi.Input.mapOptionalInputValue<GoogleCloudAiplatformV1beta1PipelineJobRuntimeConfig, Map<String, dynamic>>(runtimeConfig, (value) => value.toMap()),
  ...
  factory PipelineJobAiplatformV1beta1Args.fromMap(Map<String, dynamic> map) {
    return PipelineJobAiplatformV1beta1Args(
      ...
      pipelineSpec: (() { final guardedValue = map['pipelineSpec']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      ...
      runtimeConfig: (() { final guardedValue = map['runtimeConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1PipelineJobRuntimeConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
