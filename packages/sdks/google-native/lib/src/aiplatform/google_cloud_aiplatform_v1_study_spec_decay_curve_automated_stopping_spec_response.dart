...
class GoogleCloudAiplatformV1StudySpecDecayCurveAutomatedStoppingSpecResponse {
  ...
  const GoogleCloudAiplatformV1StudySpecDecayCurveAutomatedStoppingSpecResponse({
  ...
  factory GoogleCloudAiplatformV1StudySpecDecayCurveAutomatedStoppingSpecResponse.fromMap(Map<String, dynamic> map) {
