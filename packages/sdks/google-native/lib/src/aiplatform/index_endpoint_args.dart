...
class IndexEndpointArgs {
  ...
  factory IndexEndpointArgs.fromMap(Map<String, dynamic> map) {
    return IndexEndpointArgs(
      ...
      privateServiceConnectConfig: (() { final guardedValue = map['privateServiceConnectConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1PrivateServiceConnectConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
