...
class GetTrainingPipelineAiplatformV1beta1Result {
  ...
  factory GetTrainingPipelineAiplatformV1beta1Result.fromMap(Map<String, dynamic> map) {
    return GetTrainingPipelineAiplatformV1beta1Result(
      ...
      inputDataConfig: GoogleCloudAiplatformV1beta1InputDataConfigResponse.fromMap((map['inputDataConfig']! as Map).cast<String, dynamic>()),
      labels: (map['labels'] as Map).cast<String, String>(),
      modelId: map['modelId'] as String,
      modelToUpload: GoogleCloudAiplatformV1beta1ModelResponse.fromMap((map['modelToUpload']! as Map).cast<String, dynamic>()),
