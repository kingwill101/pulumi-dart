...
class GoogleCloudAiplatformV1beta1FeatureNoiseSigmaResponse {
  ...
  factory GoogleCloudAiplatformV1beta1FeatureNoiseSigmaResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1FeatureNoiseSigmaResponse(
      noiseSigma: (pulumi.Input.decodeList<GoogleCloudAiplatformV1beta1FeatureNoiseSigmaNoiseSigmaForFeatureResponse>(map['noiseSigma'], (value) => GoogleCloudAiplatformV1beta1FeatureNoiseSigmaNoiseSigmaForFeatureResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
