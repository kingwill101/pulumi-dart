...
/// {@template pulumi_aiplatform_v1_featurestore_iam_binding_args_doc}
/// The set of arguments for FeaturestoreIamBinding.
/// {@endtemplate}
/// {@macro pulumi_aiplatform_v1_featurestore_iam_binding_args_doc}
class FeaturestoreIamBindingArgs {
  ...
  /// Creates a new [FeaturestoreIamBindingArgs].
  ...
  const FeaturestoreIamBindingArgs({
    this.condition,
  ...
  factory FeaturestoreIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return FeaturestoreIamBindingArgs(
