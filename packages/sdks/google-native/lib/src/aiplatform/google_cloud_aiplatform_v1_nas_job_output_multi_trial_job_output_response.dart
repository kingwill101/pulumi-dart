...
class GoogleCloudAiplatformV1NasJobOutputMultiTrialJobOutputResponse {
  ...
  factory GoogleCloudAiplatformV1NasJobOutputMultiTrialJobOutputResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1NasJobOutputMultiTrialJobOutputResponse(
      searchTrials: (pulumi.Input.decodeList<GoogleCloudAiplatformV1NasTrialResponse>(map['searchTrials'], (value) => GoogleCloudAiplatformV1NasTrialResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      trainTrials: (pulumi.Input.decodeList<GoogleCloudAiplatformV1NasTrialResponse>(map['trainTrials'], (value) => GoogleCloudAiplatformV1NasTrialResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
