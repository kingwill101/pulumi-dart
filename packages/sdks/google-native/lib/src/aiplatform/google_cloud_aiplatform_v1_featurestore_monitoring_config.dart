...
class GoogleCloudAiplatformV1FeaturestoreMonitoringConfig {
  ...
  const GoogleCloudAiplatformV1FeaturestoreMonitoringConfig({
  ...
  factory GoogleCloudAiplatformV1FeaturestoreMonitoringConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1FeaturestoreMonitoringConfig(
      categoricalThresholdConfig: (() { final guardedValue = map['categoricalThresholdConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1FeaturestoreMonitoringConfigThresholdConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      importFeaturesAnalysis: (() { final guardedValue = map['importFeaturesAnalysis']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1FeaturestoreMonitoringConfigImportFeaturesAnalysis.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      numericalThresholdConfig: (() { final guardedValue = map['numericalThresholdConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1FeaturestoreMonitoringConfigThresholdConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      snapshotAnalysis: (() { final guardedValue = map['snapshotAnalysis']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1FeaturestoreMonitoringConfigSnapshotAnalysis.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
