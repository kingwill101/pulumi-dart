...
class GoogleCloudAiplatformV1beta1InputDataConfigResponse {
  ...
  const GoogleCloudAiplatformV1beta1InputDataConfigResponse({
  ...
  factory GoogleCloudAiplatformV1beta1InputDataConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1InputDataConfigResponse(
      ...
      filterSplit: pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1FilterSplitResponse.fromMap((map['filterSplit']! as Map).cast<String, dynamic>())),
      fractionSplit: pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1FractionSplitResponse.fromMap((map['fractionSplit']! as Map).cast<String, dynamic>())),
      ...
      predefinedSplit: pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1PredefinedSplitResponse.fromMap((map['predefinedSplit']! as Map).cast<String, dynamic>())),
      savedQueryId: pulumi.Input.fromValue(map['savedQueryId'] as String),
      stratifiedSplit: pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1StratifiedSplitResponse.fromMap((map['stratifiedSplit']! as Map).cast<String, dynamic>())),
      timestampSplit: pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1TimestampSplitResponse.fromMap((map['timestampSplit']! as Map).cast<String, dynamic>())),
    );
  }
}
