...
class GoogleCloudAiplatformV1beta1InputDataConfigResponse {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1beta1FilterSplitResponse> filterSplit;
  /// Split based on fractions defining the size of each set.
  final pulumi.Input<GoogleCloudAiplatformV1beta1FractionSplitResponse> fractionSplit;
  ...
  final pulumi.Input<GoogleCloudAiplatformV1beta1PredefinedSplitResponse> predefinedSplit;
  ...
  final pulumi.Input<GoogleCloudAiplatformV1beta1StratifiedSplitResponse> stratifiedSplit;
  /// Supported only for tabular Datasets. Split based on the timestamp of the input data pieces.
  final pulumi.Input<GoogleCloudAiplatformV1beta1TimestampSplitResponse> timestampSplit;

  /// Creates a new [GoogleCloudAiplatformV1beta1InputDataConfigResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'datasetId': datasetId,
      'filterSplit': pulumi.Input.mapInputValue<GoogleCloudAiplatformV1beta1FilterSplitResponse, Map<String, dynamic>>(filterSplit, (value) => value.toMap()),
      'fractionSplit': pulumi.Input.mapInputValue<GoogleCloudAiplatformV1beta1FractionSplitResponse, Map<String, dynamic>>(fractionSplit, (value) => value.toMap()),
      ...
      'predefinedSplit': pulumi.Input.mapInputValue<GoogleCloudAiplatformV1beta1PredefinedSplitResponse, Map<String, dynamic>>(predefinedSplit, (value) => value.toMap()),
      'savedQueryId': savedQueryId,
      'stratifiedSplit': pulumi.Input.mapInputValue<GoogleCloudAiplatformV1beta1StratifiedSplitResponse, Map<String, dynamic>>(stratifiedSplit, (value) => value.toMap()),
      'timestampSplit': pulumi.Input.mapInputValue<GoogleCloudAiplatformV1beta1TimestampSplitResponse, Map<String, dynamic>>(timestampSplit, (value) => value.toMap()),
    };
  }

  factory GoogleCloudAiplatformV1beta1InputDataConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1InputDataConfigResponse(
      annotationSchemaUri: (map['annotationSchemaUri'] as String).input(),
      annotationsFilter: (map['annotationsFilter'] as String).input(),
      ...
      filterSplit: (GoogleCloudAiplatformV1beta1FilterSplitResponse.fromMap((map['filterSplit'] as Map).cast<String, dynamic>())).input(),
      fractionSplit: (GoogleCloudAiplatformV1beta1FractionSplitResponse.fromMap((map['fractionSplit'] as Map).cast<String, dynamic>())).input(),
      ...
      persistMlUseAssignment: (map['persistMlUseAssignment'] as bool).input(),
      predefinedSplit: (GoogleCloudAiplatformV1beta1PredefinedSplitResponse.fromMap((map['predefinedSplit'] as Map).cast<String, dynamic>())).input(),
      savedQueryId: (map['savedQueryId'] as String).input(),
      stratifiedSplit: (GoogleCloudAiplatformV1beta1StratifiedSplitResponse.fromMap((map['stratifiedSplit'] as Map).cast<String, dynamic>())).input(),
      timestampSplit: (GoogleCloudAiplatformV1beta1TimestampSplitResponse.fromMap((map['timestampSplit'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
