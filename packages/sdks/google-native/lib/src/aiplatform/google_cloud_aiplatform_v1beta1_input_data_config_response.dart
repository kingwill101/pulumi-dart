...
class GoogleCloudAiplatformV1beta1InputDataConfigResponse {
  ...
  factory GoogleCloudAiplatformV1beta1InputDataConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1InputDataConfigResponse(
      ...
      filterSplit: GoogleCloudAiplatformV1beta1FilterSplitResponse.fromMap((map['filterSplit'] as Map).cast<String, dynamic>()),
      fractionSplit: GoogleCloudAiplatformV1beta1FractionSplitResponse.fromMap((map['fractionSplit'] as Map).cast<String, dynamic>()),
      gcsDestination: GoogleCloudAiplatformV1beta1GcsDestinationResponse.fromMap((map['gcsDestination'] as Map).cast<String, dynamic>()),
      persistMlUseAssignment: map['persistMlUseAssignment'] as bool,
      predefinedSplit: GoogleCloudAiplatformV1beta1PredefinedSplitResponse.fromMap((map['predefinedSplit'] as Map).cast<String, dynamic>()),
      savedQueryId: map['savedQueryId'] as String,
      stratifiedSplit: GoogleCloudAiplatformV1beta1StratifiedSplitResponse.fromMap((map['stratifiedSplit'] as Map).cast<String, dynamic>()),
      timestampSplit: GoogleCloudAiplatformV1beta1TimestampSplitResponse.fromMap((map['timestampSplit'] as Map).cast<String, dynamic>()),
    );
  }
}
