...
class GoogleCloudAiplatformV1beta1InputDataConfigResponse {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1beta1FilterSplitResponse>
  filterSplit;

  /// Split based on fractions defining the size of each set.
  final pulumi.Input<GoogleCloudAiplatformV1beta1FractionSplitResponse>
  fractionSplit;
  ...
  final pulumi.Input<GoogleCloudAiplatformV1beta1PredefinedSplitResponse>
  predefinedSplit;
  ...
  final pulumi.Input<GoogleCloudAiplatformV1beta1StratifiedSplitResponse>
  stratifiedSplit;

  /// Supported only for tabular Datasets. Split based on the timestamp of the input data pieces.
  final pulumi.Input<GoogleCloudAiplatformV1beta1TimestampSplitResponse>
  timestampSplit;
  ...
  factory GoogleCloudAiplatformV1beta1InputDataConfigResponse.fromMap(
    ...
    return GoogleCloudAiplatformV1beta1InputDataConfigResponse(
      ...
      filterSplit: pulumi.Input.fromValue(
        GoogleCloudAiplatformV1beta1FilterSplitResponse.fromMap(
          (map['filterSplit']! as Map).cast<String, dynamic>(),
        ),
      ),
      fractionSplit: pulumi.Input.fromValue(
        GoogleCloudAiplatformV1beta1FractionSplitResponse.fromMap(
