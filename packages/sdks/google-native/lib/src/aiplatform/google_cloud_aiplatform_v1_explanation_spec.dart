...
class GoogleCloudAiplatformV1ExplanationSpec {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'metadata': ?pulumi.Input.mapOptionalInputValue<GoogleCloudAiplatformV1ExplanationMetadata, Map<String, dynamic>>(metadata, (value) => value.toMap()),
      'parameters': pulumi.Input.mapInputValue<GoogleCloudAiplatformV1ExplanationParameters, Map<String, dynamic>>(parameters, (value) => value.toMap()),
    };
  }
  ...
  factory GoogleCloudAiplatformV1ExplanationSpec.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1ExplanationSpec(
      metadata: (() { final guardedValue = map['metadata']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1ExplanationMetadata.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      parameters: pulumi.Input.fromValue(GoogleCloudAiplatformV1ExplanationParameters.fromMap((map['parameters']! as Map).cast<String, dynamic>())),
    );
  }
}
