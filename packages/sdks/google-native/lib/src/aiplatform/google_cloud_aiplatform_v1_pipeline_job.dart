...
class GoogleCloudAiplatformV1PipelineJob {
  ...
  factory GoogleCloudAiplatformV1PipelineJob.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1PipelineJob(
      ...
      runtimeConfig: (() { final guardedValue = map['runtimeConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1PipelineJobRuntimeConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
