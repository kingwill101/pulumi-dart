...
class ArtifactArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'state': ?pulumi.Input.mapOptionalInputValue<ArtifactState, String>(state, (value) => value.wireValue),
      'uri': ?uri,
    };
  }
  ...
  factory ArtifactArgs.fromMap(Map<String, dynamic> map) {
    return ArtifactArgs(
      ...
      state: (() { final guardedValue = map['state']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ArtifactState.fromValue(guardedValue as String)); })(),
