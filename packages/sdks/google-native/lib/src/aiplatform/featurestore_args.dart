...
class FeaturestoreArgs {
  ...
  FeaturestoreArgs({
    ...
    pulumi.Output<GoogleCloudAiplatformV1FeaturestoreOnlineServingConfig>? onlineServingConfig,
    ...
    pulumi.Output<String>? project,
      ...
      onlineServingConfig = pulumi.Input.asOptionalInput<GoogleCloudAiplatformV1FeaturestoreOnlineServingConfig>(onlineServingConfig),
  ...
  factory FeaturestoreArgs.fromMap(Map<String, dynamic> map) {
    return FeaturestoreArgs(
      ...
      onlineServingConfig: map['onlineServingConfig'] == null ? null : pulumi.Output.create<GoogleCloudAiplatformV1FeaturestoreOnlineServingConfig>(GoogleCloudAiplatformV1FeaturestoreOnlineServingConfig.fromMap((map['onlineServingConfig'] as Map).cast<String, dynamic>())),
