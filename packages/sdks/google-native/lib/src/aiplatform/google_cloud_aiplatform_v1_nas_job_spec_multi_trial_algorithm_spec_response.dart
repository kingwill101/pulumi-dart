...
class GoogleCloudAiplatformV1NasJobSpecMultiTrialAlgorithmSpecResponse {
  ...
  factory GoogleCloudAiplatformV1NasJobSpecMultiTrialAlgorithmSpecResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1NasJobSpecMultiTrialAlgorithmSpecResponse(
      metric: (GoogleCloudAiplatformV1NasJobSpecMultiTrialAlgorithmSpecMetricSpecResponse.fromMap((map['metric'] as Map).cast<String, dynamic>())).input(),
      multiTrialAlgorithm: (map['multiTrialAlgorithm'] as String).input(),
      searchTrialSpec: (GoogleCloudAiplatformV1NasJobSpecMultiTrialAlgorithmSpecSearchTrialSpecResponse.fromMap((map['searchTrialSpec'] as Map).cast<String, dynamic>())).input(),
      trainTrialSpec: (GoogleCloudAiplatformV1NasJobSpecMultiTrialAlgorithmSpecTrainTrialSpecResponse.fromMap((map['trainTrialSpec'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
