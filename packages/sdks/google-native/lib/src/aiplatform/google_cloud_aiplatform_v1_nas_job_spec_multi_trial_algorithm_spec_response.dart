...
class GoogleCloudAiplatformV1NasJobSpecMultiTrialAlgorithmSpecResponse {
  ...
  final GoogleCloudAiplatformV1NasJobSpecMultiTrialAlgorithmSpecMetricSpecResponse metric;
  /// The multi-trial Neural Architecture Search (NAS) algorithm type. Defaults to `REINFORCEMENT_LEARNING`.
  final String multiTrialAlgorithm;
  /// Spec for search trials.
  final GoogleCloudAiplatformV1NasJobSpecMultiTrialAlgorithmSpecSearchTrialSpecResponse searchTrialSpec;
  ...
  final GoogleCloudAiplatformV1NasJobSpecMultiTrialAlgorithmSpecTrainTrialSpecResponse trainTrialSpec;
  ...
  factory GoogleCloudAiplatformV1NasJobSpecMultiTrialAlgorithmSpecResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1NasJobSpecMultiTrialAlgorithmSpecResponse(
      metric: GoogleCloudAiplatformV1NasJobSpecMultiTrialAlgorithmSpecMetricSpecResponse.fromMap((map['metric'] as Map).cast<String, dynamic>()),
      multiTrialAlgorithm: map['multiTrialAlgorithm'] as String,
      searchTrialSpec: GoogleCloudAiplatformV1NasJobSpecMultiTrialAlgorithmSpecSearchTrialSpecResponse.fromMap((map['searchTrialSpec'] as Map).cast<String, dynamic>()),
      trainTrialSpec: GoogleCloudAiplatformV1NasJobSpecMultiTrialAlgorithmSpecTrainTrialSpecResponse.fromMap((map['trainTrialSpec'] as Map).cast<String, dynamic>()),
    );
  }
}
