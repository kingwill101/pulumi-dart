...
class IndexAiplatformV1beta1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<GoogleCloudAiplatformV1beta1IndexStatsResponse>
  indexStats;
  ...
  IndexAiplatformV1beta1(
    ...
    indexStats = registerOutput<GoogleCloudAiplatformV1beta1IndexStatsResponse>(
      'indexStats',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return GoogleCloudAiplatformV1beta1IndexStatsResponse.fromMap(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      },
    );
