...
import 'index_aiplatform_v1beta1_args.dart';

/// Creates an Index.
/// Auto-naming is currently not supported for this resource.
class IndexAiplatformV1beta1 extends pulumi.CustomResource {
  /// Timestamp when this Index was created.
  late final pulumi.Output<String> createTime;
  /// The pointers to DeployedIndexes created from this Index. An Index can be only deleted if all its DeployedIndexes had been undeployed first.
  late final pulumi.Output<List<GoogleCloudAiplatformV1beta1DeployedIndexRefResponse>> deployedIndexes;
  ...
  late final pulumi.Output<GoogleCloudAiplatformV1beta1IndexStatsResponse> indexStats;
  ...
  /// Creates a new [IndexAiplatformV1beta1].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [IndexAiplatformV1beta1]. {@macro pulumi_aiplatform_v1beta1_index_aiplatform_v1beta1_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  IndexAiplatformV1beta1(
    String name, {
    IndexAiplatformV1beta1Args? args,
    ...
    this.deployedIndexes = registerOutput<List<GoogleCloudAiplatformV1beta1DeployedIndexRefResponse>>('deployedIndexes');
    ...
    this.indexStats = registerOutput<GoogleCloudAiplatformV1beta1IndexStatsResponse>('indexStats');
