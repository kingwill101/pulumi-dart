...
/// {@template pulumi_aiplatform_v1beta1_notebook_runtime_template_iam_member_aiplatform_v1beta1_args_doc}
/// The set of arguments for NotebookRuntimeTemplateIamMember.
/// {@endtemplate}
/// {@macro pulumi_aiplatform_v1beta1_notebook_runtime_template_iam_member_aiplatform_v1beta1_args_doc}
class NotebookRuntimeTemplateIamMemberAiplatformV1beta1Args {
  ...
  /// Creates a new [NotebookRuntimeTemplateIamMemberAiplatformV1beta1Args].
  ...
  const NotebookRuntimeTemplateIamMemberAiplatformV1beta1Args({
    this.condition,
  ...
  factory NotebookRuntimeTemplateIamMemberAiplatformV1beta1Args.fromMap(Map<String, dynamic> map) {
    return NotebookRuntimeTemplateIamMemberAiplatformV1beta1Args(
