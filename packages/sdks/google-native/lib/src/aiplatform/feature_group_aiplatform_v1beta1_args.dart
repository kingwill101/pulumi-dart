...
class FeatureGroupAiplatformV1beta1Args {
  ...
  /// [location] Optional.
  /// [project] Optional.
  const FeatureGroupAiplatformV1beta1Args({
    this.bigQuery,
    this.description,
    this.etag,
  ...
  factory FeatureGroupAiplatformV1beta1Args.fromMap(Map<String, dynamic> map) {
    return FeatureGroupAiplatformV1beta1Args(
      bigQuery: (() { final guardedValue = map['bigQuery']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1FeatureGroupBigQuery.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
