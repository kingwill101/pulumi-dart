...
class Dataset extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<GoogleCloudAiplatformV1SavedQueryResponse>> savedQueries;
  ...
  Dataset(
    ...
    this.savedQueries = registerOutput<List<GoogleCloudAiplatformV1SavedQueryResponse>>('savedQueries');
