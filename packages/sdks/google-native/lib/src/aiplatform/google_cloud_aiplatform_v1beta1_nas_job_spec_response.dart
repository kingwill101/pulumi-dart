...
class GoogleCloudAiplatformV1beta1NasJobSpecResponse {
  ...
  final GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpecResponse multiTrialAlgorithmSpec;
  ...
  factory GoogleCloudAiplatformV1beta1NasJobSpecResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1NasJobSpecResponse(
      multiTrialAlgorithmSpec: GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpecResponse.fromMap((map['multiTrialAlgorithmSpec'] as Map).cast<String, dynamic>()),
