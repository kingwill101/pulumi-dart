...
class GoogleCloudAiplatformV1beta1NasJobSpecResponse {
  ...
  const GoogleCloudAiplatformV1beta1NasJobSpecResponse({
  ...
  factory GoogleCloudAiplatformV1beta1NasJobSpecResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1NasJobSpecResponse(
      multiTrialAlgorithmSpec: pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1NasJobSpecMultiTrialAlgorithmSpecResponse.fromMap((map['multiTrialAlgorithmSpec']! as Map).cast<String, dynamic>())),
