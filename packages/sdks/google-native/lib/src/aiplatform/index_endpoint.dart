...
class IndexEndpoint extends pulumi.CustomResource {
  ...
  IndexEndpoint(
    ...
    privateServiceConnectConfig = registerOutput<GoogleCloudAiplatformV1PrivateServiceConnectConfigResponse>('privateServiceConnectConfig', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return GoogleCloudAiplatformV1PrivateServiceConnectConfigResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
