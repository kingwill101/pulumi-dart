...
class GoogleCloudAiplatformV1beta1FeaturestoreOnlineServingConfigScaling {
  ...
  /// Creates a new [GoogleCloudAiplatformV1beta1FeaturestoreOnlineServingConfigScaling].
  ...
  const GoogleCloudAiplatformV1beta1FeaturestoreOnlineServingConfigScaling({
  ...
  factory GoogleCloudAiplatformV1beta1FeaturestoreOnlineServingConfigScaling.fromMap(Map<String, dynamic> map) {
