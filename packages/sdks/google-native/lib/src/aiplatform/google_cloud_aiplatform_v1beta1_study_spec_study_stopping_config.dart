...
class GoogleCloudAiplatformV1beta1StudySpecStudyStoppingConfig {
  ...
  final GoogleCloudAiplatformV1beta1StudyTimeConstraint? maximumRuntimeConstraint;
  ...
  final GoogleCloudAiplatformV1beta1StudyTimeConstraint? minimumRuntimeConstraint;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'maximumRuntimeConstraint': ?maximumRuntimeConstraint == null ? null : maximumRuntimeConstraint!.toMap(),
      'minNumTrials': ?minNumTrials,
      'minimumRuntimeConstraint': ?minimumRuntimeConstraint == null ? null : minimumRuntimeConstraint!.toMap(),
  ...
  factory GoogleCloudAiplatformV1beta1StudySpecStudyStoppingConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1StudySpecStudyStoppingConfig(
      maxDurationNoProgress: map['maxDurationNoProgress'] == null ? null : map['maxDurationNoProgress'] as String,
      maxNumTrials: map['maxNumTrials'] == null ? null : map['maxNumTrials'] as int,
      maxNumTrialsNoProgress: map['maxNumTrialsNoProgress'] == null ? null : map['maxNumTrialsNoProgress'] as int,
      maximumRuntimeConstraint: map['maximumRuntimeConstraint'] == null ? null : GoogleCloudAiplatformV1beta1StudyTimeConstraint.fromMap((map['maximumRuntimeConstraint'] as Map).cast<String, dynamic>()),
      minNumTrials: map['minNumTrials'] == null ? null : map['minNumTrials'] as int,
      minimumRuntimeConstraint: map['minimumRuntimeConstraint'] == null ? null : GoogleCloudAiplatformV1beta1StudyTimeConstraint.fromMap((map['minimumRuntimeConstraint'] as Map).cast<String, dynamic>()),
      shouldStopAsap: map['shouldStopAsap'] == null ? null : map['shouldStopAsap'] as bool,
    );
  }
}
