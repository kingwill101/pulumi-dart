...
class GoogleCloudAiplatformV1beta1StudySpecStudyStoppingConfig {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1beta1StudyTimeConstraint>?
  ...
  factory GoogleCloudAiplatformV1beta1StudySpecStudyStoppingConfig.fromMap(
    ...
    return GoogleCloudAiplatformV1beta1StudySpecStudyStoppingConfig(
      maxDurationNoProgress: (() {
        final guardedValue = map['maxDurationNoProgress'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      maxNumTrials: (() {
        final guardedValue = map['maxNumTrials'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      maxNumTrialsNoProgress: (() {
        final guardedValue = map['maxNumTrialsNoProgress'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      maximumRuntimeConstraint: (() {
        final guardedValue = map['maximumRuntimeConstraint'];
        if (guardedValue == null) return null;
      ...
      minNumTrials: (() {
        final guardedValue = map['minNumTrials'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      minimumRuntimeConstraint: (() {
        final guardedValue = map['minimumRuntimeConstraint'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GoogleCloudAiplatformV1beta1StudyTimeConstraint.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
      ...
      shouldStopAsap: (() {
        final guardedValue = map['shouldStopAsap'];
        if (guardedValue == null) return null;
