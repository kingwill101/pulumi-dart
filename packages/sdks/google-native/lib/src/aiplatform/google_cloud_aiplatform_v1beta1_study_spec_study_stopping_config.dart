...
class GoogleCloudAiplatformV1beta1StudySpecStudyStoppingConfig {
  ...
  factory GoogleCloudAiplatformV1beta1StudySpecStudyStoppingConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1StudySpecStudyStoppingConfig(
      ...
      maximumRuntimeConstraint: map['maximumRuntimeConstraint'] == null ? null : (GoogleCloudAiplatformV1beta1StudyTimeConstraint.fromMap((map['maximumRuntimeConstraint'] as Map).cast<String, dynamic>())).input(),
      minNumTrials: map['minNumTrials'] == null ? null : (map['minNumTrials'] as int).input(),
      minimumRuntimeConstraint: map['minimumRuntimeConstraint'] == null ? null : (GoogleCloudAiplatformV1beta1StudyTimeConstraint.fromMap((map['minimumRuntimeConstraint'] as Map).cast<String, dynamic>())).input(),
