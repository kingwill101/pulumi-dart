...
class GoogleCloudAiplatformV1beta1ExamplesResponse {
  ...
  const GoogleCloudAiplatformV1beta1ExamplesResponse({
  ...
  factory GoogleCloudAiplatformV1beta1ExamplesResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1ExamplesResponse(
      exampleGcsSource: pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1ExamplesExampleGcsSourceResponse.fromMap((map['exampleGcsSource']! as Map).cast<String, dynamic>())),
      ...
      presets: pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1PresetsResponse.fromMap((map['presets']! as Map).cast<String, dynamic>())),
    );
  }
}
