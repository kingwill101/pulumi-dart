...
class FeatureViewAiplatformV1beta1Args {
  ...
  factory FeatureViewAiplatformV1beta1Args.fromMap(Map<String, dynamic> map) {
    return FeatureViewAiplatformV1beta1Args(
      bigQuerySource: (() { final guardedValue = map['bigQuerySource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1FeatureViewBigQuerySource.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      etag: (() { final guardedValue = map['etag']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      featureOnlineStoreId: pulumi.Input.fromValue(map['featureOnlineStoreId'] as String),
      featureRegistrySource: (() { final guardedValue = map['featureRegistrySource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1FeatureViewFeatureRegistrySource.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      syncConfig: (() { final guardedValue = map['syncConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1FeatureViewSyncConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      vectorSearchConfig: (() { final guardedValue = map['vectorSearchConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1FeatureViewVectorSearchConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
