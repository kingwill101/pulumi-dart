...
class GoogleCloudAiplatformV1beta1StudySpecStudyStoppingConfigResponse {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1beta1StudyTimeConstraintResponse> maximumRuntimeConstraint;
  ...
  final pulumi.Input<GoogleCloudAiplatformV1beta1StudyTimeConstraintResponse> minimumRuntimeConstraint;
  ...
  /// Creates a new [GoogleCloudAiplatformV1beta1StudySpecStudyStoppingConfigResponse].
  ...
  const GoogleCloudAiplatformV1beta1StudySpecStudyStoppingConfigResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'maximumRuntimeConstraint': pulumi.Input.mapInputValue<GoogleCloudAiplatformV1beta1StudyTimeConstraintResponse, Map<String, dynamic>>(maximumRuntimeConstraint, (value) => value.toMap()),
      'minNumTrials': minNumTrials,
      'minimumRuntimeConstraint': pulumi.Input.mapInputValue<GoogleCloudAiplatformV1beta1StudyTimeConstraintResponse, Map<String, dynamic>>(minimumRuntimeConstraint, (value) => value.toMap()),
  ...
  factory GoogleCloudAiplatformV1beta1StudySpecStudyStoppingConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1StudySpecStudyStoppingConfigResponse(
      maxDurationNoProgress: pulumi.Input.fromValue(map['maxDurationNoProgress'] as String),
      maxNumTrials: pulumi.Input.fromValue(map['maxNumTrials'] as int),
      maxNumTrialsNoProgress: pulumi.Input.fromValue(map['maxNumTrialsNoProgress'] as int),
      maximumRuntimeConstraint: pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1StudyTimeConstraintResponse.fromMap((map['maximumRuntimeConstraint']! as Map).cast<String, dynamic>())),
      minNumTrials: pulumi.Input.fromValue(map['minNumTrials'] as int),
      minimumRuntimeConstraint: pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1StudyTimeConstraintResponse.fromMap((map['minimumRuntimeConstraint']! as Map).cast<String, dynamic>())),
