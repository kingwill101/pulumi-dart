...
class GoogleCloudAiplatformV1beta1StudySpecStudyStoppingConfigResponse {
  ...
  factory GoogleCloudAiplatformV1beta1StudySpecStudyStoppingConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1StudySpecStudyStoppingConfigResponse(
      maxDurationNoProgress: (map['maxDurationNoProgress'] as String).input(),
      maxNumTrials: (map['maxNumTrials'] as int).input(),
      maxNumTrialsNoProgress: (map['maxNumTrialsNoProgress'] as int).input(),
      maximumRuntimeConstraint: (GoogleCloudAiplatformV1beta1StudyTimeConstraintResponse.fromMap((map['maximumRuntimeConstraint'] as Map).cast<String, dynamic>())).input(),
      minNumTrials: (map['minNumTrials'] as int).input(),
      minimumRuntimeConstraint: (GoogleCloudAiplatformV1beta1StudyTimeConstraintResponse.fromMap((map['minimumRuntimeConstraint'] as Map).cast<String, dynamic>())).input(),
      shouldStopAsap: (map['shouldStopAsap'] as bool).input(),
    );
  }
}
