...
class GoogleCloudAiplatformV1Scheduling {
  ...
  factory GoogleCloudAiplatformV1Scheduling.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1Scheduling(
      disableRetries: map['disableRetries'] == null ? null : map['disableRetries'] as bool,
      restartJobOnWorkerRestart: map['restartJobOnWorkerRestart'] == null ? null : map['restartJobOnWorkerRestart'] as bool,
