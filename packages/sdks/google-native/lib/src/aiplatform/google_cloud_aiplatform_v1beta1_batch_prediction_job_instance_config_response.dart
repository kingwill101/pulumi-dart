...
class GoogleCloudAiplatformV1beta1BatchPredictionJobInstanceConfigResponse {
  ...
  /// Creates a new [GoogleCloudAiplatformV1beta1BatchPredictionJobInstanceConfigResponse].
  ...
  const GoogleCloudAiplatformV1beta1BatchPredictionJobInstanceConfigResponse({
  ...
  factory GoogleCloudAiplatformV1beta1BatchPredictionJobInstanceConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1BatchPredictionJobInstanceConfigResponse(
      excludedFields: pulumi.Input.fromValue((map['excludedFields'] as List).cast<String>()),
      includedFields: pulumi.Input.fromValue((map['includedFields'] as List).cast<String>()),
      instanceType: pulumi.Input.fromValue(map['instanceType'] as String),
      keyField: pulumi.Input.fromValue(map['keyField'] as String),
    );
  }
}
