...
class GoogleCloudAiplatformV1ModelMonitoringObjectiveConfigPredictionDriftDetectionConfig {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1ThresholdConfig>? defaultDriftThreshold;
  ...
  const GoogleCloudAiplatformV1ModelMonitoringObjectiveConfigPredictionDriftDetectionConfig({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'defaultDriftThreshold': ?pulumi.Input.mapOptionalInputValue<GoogleCloudAiplatformV1ThresholdConfig, Map<String, dynamic>>(defaultDriftThreshold, (value) => value.toMap()),
      'driftThresholds': ?driftThresholds,
    };
  }

  factory GoogleCloudAiplatformV1ModelMonitoringObjectiveConfigPredictionDriftDetectionConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1ModelMonitoringObjectiveConfigPredictionDriftDetectionConfig(
      attributionScoreDriftThresholds: (() { final guardedValue = map['attributionScoreDriftThresholds']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      defaultDriftThreshold: (() { final guardedValue = map['defaultDriftThreshold']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1ThresholdConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      driftThresholds: (() { final guardedValue = map['driftThresholds']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
    );
  }
}
