...
class GetEndpointAiplatformV1beta1Result {
  ...
  final List<GoogleCloudAiplatformV1beta1DeployedModelResponse> deployedModels;
  ...
  final GoogleCloudAiplatformV1beta1PredictRequestResponseLoggingConfigResponse predictRequestResponseLoggingConfig;
  ...
  /// Creates a new [GetEndpointAiplatformV1beta1Result].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'deployedModels': pulumi.Input.encodeList<GoogleCloudAiplatformV1beta1DeployedModelResponse, Map<String, dynamic>>(deployedModels, (value) => value.toMap()),
      ...
      'name': name,
      'network': network,
      'predictRequestResponseLoggingConfig': predictRequestResponseLoggingConfig.toMap(),
      'trafficSplit': trafficSplit,
      'updateTime': updateTime,
    };
  }

  factory GetEndpointAiplatformV1beta1Result.fromMap(Map<String, dynamic> map) {
    return GetEndpointAiplatformV1beta1Result(
      createTime: map['createTime'] as String,
      deployedModels: pulumi.Input.decodeList<GoogleCloudAiplatformV1beta1DeployedModelResponse>(map['deployedModels']!, (value) => GoogleCloudAiplatformV1beta1DeployedModelResponse.fromMap((value as Map).cast<String, dynamic>())),
      ...
      modelDeploymentMonitoringJob: map['modelDeploymentMonitoringJob'] as String,
      name: map['name'] as String,
      network: map['network'] as String,
      predictRequestResponseLoggingConfig: GoogleCloudAiplatformV1beta1PredictRequestResponseLoggingConfigResponse.fromMap((map['predictRequestResponseLoggingConfig']! as Map).cast<String, dynamic>()),
