...
class EndpointAiplatformV1beta1Args {
  ...
  factory EndpointAiplatformV1beta1Args.fromMap(Map<String, dynamic> map) {
    return EndpointAiplatformV1beta1Args(
      ...
      predictRequestResponseLoggingConfig: map['predictRequestResponseLoggingConfig'] == null ? null : (GoogleCloudAiplatformV1beta1PredictRequestResponseLoggingConfig.fromMap((map['predictRequestResponseLoggingConfig'] as Map).cast<String, dynamic>())).input(),
