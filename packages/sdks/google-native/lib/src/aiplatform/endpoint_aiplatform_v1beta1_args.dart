...
class EndpointAiplatformV1beta1Args {
  ...
  /// [project] Optional.
  /// [trafficSplit] A map from a DeployedModel's ID to the percentage of this Endpoint's traffic that should be forwarded to that DeployedModel. If a DeployedModel's ID is not listed in this map, then it receives no traffic. The traffic percentage values must add up to 100, or map must be empty if the Endpoint is to not accept any traffic at a moment.
  const EndpointAiplatformV1beta1Args({
    this.description,
  ...
  factory EndpointAiplatformV1beta1Args.fromMap(Map<String, dynamic> map) {
    return EndpointAiplatformV1beta1Args(
      ...
      predictRequestResponseLoggingConfig: (() { final guardedValue = map['predictRequestResponseLoggingConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1PredictRequestResponseLoggingConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      project: (() { final guardedValue = map['project']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      trafficSplit: (() { final guardedValue = map['trafficSplit']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
    );
  }
}
