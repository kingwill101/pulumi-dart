...
import 'google_cloud_aiplatform_v1beta1_predict_request_response_logging_config.dart';

/// {@template pulumi_aiplatform_v1beta1_endpoint_aiplatform_v1beta1_args_doc}
/// The set of arguments for Endpoint.
/// {@endtemplate}
/// {@macro pulumi_aiplatform_v1beta1_endpoint_aiplatform_v1beta1_args_doc}
class EndpointAiplatformV1beta1Args {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1beta1PredictRequestResponseLoggingConfig>? predictRequestResponseLoggingConfig;
  final pulumi.Input<String>? project;
  /// A map from a DeployedModel's ID to the percentage of this Endpoint's traffic that should be forwarded to that DeployedModel. If a DeployedModel's ID is not listed in this map, then it receives no traffic. The traffic percentage values must add up to 100, or map must be empty if the Endpoint is to not accept any traffic at a moment.
  final pulumi.Input<Map<String, String>>? trafficSplit;

  /// Creates a new [EndpointAiplatformV1beta1Args].
  ...
  EndpointAiplatformV1beta1Args({
    ...
    pulumi.Output<GoogleCloudAiplatformV1beta1PredictRequestResponseLoggingConfig>? predictRequestResponseLoggingConfig,
    pulumi.Output<String>? project,
    pulumi.Output<Map<String, String>>? trafficSplit,
  }) :
      ...
      predictRequestResponseLoggingConfig = pulumi.Input.asOptionalInput<GoogleCloudAiplatformV1beta1PredictRequestResponseLoggingConfig>(predictRequestResponseLoggingConfig),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'location': ?location,
      'network': ?network,
      'predictRequestResponseLoggingConfig': ?pulumi.Input.mapOptionalInputValue<GoogleCloudAiplatformV1beta1PredictRequestResponseLoggingConfig, Map<String, dynamic>>(predictRequestResponseLoggingConfig, (value) => value.toMap()),
      'project': ?project,
      'trafficSplit': ?trafficSplit,
    };
  }

  factory EndpointAiplatformV1beta1Args.fromMap(Map<String, dynamic> map) {
    return EndpointAiplatformV1beta1Args(
      ...
      predictRequestResponseLoggingConfig: map['predictRequestResponseLoggingConfig'] == null ? null : pulumi.Output.create<GoogleCloudAiplatformV1beta1PredictRequestResponseLoggingConfig>(GoogleCloudAiplatformV1beta1PredictRequestResponseLoggingConfig.fromMap((map['predictRequestResponseLoggingConfig'] as Map).cast<String, dynamic>())),
      project: map['project'] == null ? null : pulumi.Output.create<String>(map['project'] as String),
      trafficSplit: map['trafficSplit'] == null ? null : pulumi.Output.create<Map<String, String>>((map['trafficSplit'] as Map).cast<String, String>()),
    );
  }
}
