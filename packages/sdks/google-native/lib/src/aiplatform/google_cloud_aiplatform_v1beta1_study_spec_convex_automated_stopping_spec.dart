...
class GoogleCloudAiplatformV1beta1StudySpecConvexAutomatedStoppingSpec {
  ...
  factory GoogleCloudAiplatformV1beta1StudySpecConvexAutomatedStoppingSpec.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1StudySpecConvexAutomatedStoppingSpec(
      ...
      maxStepCount: (() { final guardedValue = map['maxStepCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      minMeasurementCount: (() { final guardedValue = map['minMeasurementCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      minStepCount: (() { final guardedValue = map['minStepCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      updateAllStoppedTrials: (() { final guardedValue = map['updateAllStoppedTrials']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
