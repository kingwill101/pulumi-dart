...
class TimeSeriesAiplatformV1beta1 extends pulumi.CustomResource {
  ...
  TimeSeriesAiplatformV1beta1(
    ...
    this.metadata = registerOutput<GoogleCloudAiplatformV1beta1TensorboardTimeSeriesMetadataResponse>('metadata');
    ...
    this.tensorboardTimeSeriesId = registerOutput<String?>('tensorboardTimeSeriesId');
