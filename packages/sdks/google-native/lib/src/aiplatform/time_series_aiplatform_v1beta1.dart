...
class TimeSeriesAiplatformV1beta1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<GoogleCloudAiplatformV1beta1TensorboardTimeSeriesMetadataResponse> metadata;
  ...
  /// Creates a new [TimeSeriesAiplatformV1beta1].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [TimeSeriesAiplatformV1beta1]. {@macro pulumi_aiplatform_v1beta1_time_series_aiplatform_v1beta1_args_doc}
  ...
  TimeSeriesAiplatformV1beta1(
    ...
    metadata = registerOutput<GoogleCloudAiplatformV1beta1TensorboardTimeSeriesMetadataResponse>('metadata', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return GoogleCloudAiplatformV1beta1TensorboardTimeSeriesMetadataResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    tensorboardTimeSeriesId = registerOutput<String?>('tensorboardTimeSeriesId');
