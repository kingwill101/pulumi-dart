...
class GoogleCloudAiplatformV1beta1WorkerPoolSpecResponse {
  ...
  factory GoogleCloudAiplatformV1beta1WorkerPoolSpecResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1WorkerPoolSpecResponse(
      containerSpec: pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1ContainerSpecResponse.fromMap((map['containerSpec']! as Map).cast<String, dynamic>())),
      diskSpec: pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1DiskSpecResponse.fromMap((map['diskSpec']! as Map).cast<String, dynamic>())),
      machineSpec: pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1MachineSpecResponse.fromMap((map['machineSpec']! as Map).cast<String, dynamic>())),
      nfsMounts: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudAiplatformV1beta1NfsMountResponse>(map['nfsMounts']!, (value) => GoogleCloudAiplatformV1beta1NfsMountResponse.fromMap((value as Map).cast<String, dynamic>()))),
      pythonPackageSpec: pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1PythonPackageSpecResponse.fromMap((map['pythonPackageSpec']! as Map).cast<String, dynamic>())),
