...
class BatchPredictionJobAiplatformV1beta1Args {
  ...
  BatchPredictionJobAiplatformV1beta1Args({
    pulumi.Output<GoogleCloudAiplatformV1beta1BatchDedicatedResources>? dedicatedResources,
    ...
    pulumi.Output<GoogleCloudAiplatformV1beta1ExplanationSpec>? explanationSpec,
    pulumi.Output<bool>? generateExplanation,
    required pulumi.Output<GoogleCloudAiplatformV1beta1BatchPredictionJobInputConfig> inputConfig,
    pulumi.Output<GoogleCloudAiplatformV1beta1BatchPredictionJobInstanceConfig>? instanceConfig,
    pulumi.Output<Map<String, String>>? labels,
    pulumi.Output<String>? location,
    pulumi.Output<GoogleCloudAiplatformV1beta1ManualBatchTuningParameters>? manualBatchTuningParameters,
    pulumi.Output<String>? model,
    pulumi.Output<GoogleCloudAiplatformV1beta1ModelMonitoringConfig>? modelMonitoringConfig,
    pulumi.Output<List<GoogleCloudAiplatformV1beta1ModelMonitoringStatsAnomalies>>? modelMonitoringStatsAnomalies,
    pulumi.Output<dynamic>? modelParameters,
    required pulumi.Output<GoogleCloudAiplatformV1beta1BatchPredictionJobOutputConfig> outputConfig,
    pulumi.Output<String>? project,
    pulumi.Output<String>? serviceAccount,
    pulumi.Output<GoogleCloudAiplatformV1beta1UnmanagedContainerModel>? unmanagedContainerModel,
  }) :
      dedicatedResources = pulumi.Input.asOptionalInput<GoogleCloudAiplatformV1beta1BatchDedicatedResources>(dedicatedResources),
      ...
      explanationSpec = pulumi.Input.asOptionalInput<GoogleCloudAiplatformV1beta1ExplanationSpec>(explanationSpec),
      generateExplanation = pulumi.Input.asOptionalInput<bool>(generateExplanation),
      inputConfig = pulumi.Input.asInput<GoogleCloudAiplatformV1beta1BatchPredictionJobInputConfig>(inputConfig),
      instanceConfig = pulumi.Input.asOptionalInput<GoogleCloudAiplatformV1beta1BatchPredictionJobInstanceConfig>(instanceConfig),
      labels = pulumi.Input.asOptionalInput<Map<String, String>>(labels),
      location = pulumi.Input.asOptionalInput<String>(location),
      manualBatchTuningParameters = pulumi.Input.asOptionalInput<GoogleCloudAiplatformV1beta1ManualBatchTuningParameters>(manualBatchTuningParameters),
      model = pulumi.Input.asOptionalInput<String>(model),
      modelMonitoringConfig = pulumi.Input.asOptionalInput<GoogleCloudAiplatformV1beta1ModelMonitoringConfig>(modelMonitoringConfig),
      modelMonitoringStatsAnomalies = pulumi.Input.asOptionalInput<List<GoogleCloudAiplatformV1beta1ModelMonitoringStatsAnomalies>>(modelMonitoringStatsAnomalies),
      modelParameters = pulumi.Input.asOptionalInput<dynamic>(modelParameters),
      outputConfig = pulumi.Input.asInput<GoogleCloudAiplatformV1beta1BatchPredictionJobOutputConfig>(outputConfig),
      project = pulumi.Input.asOptionalInput<String>(project),
      serviceAccount = pulumi.Input.asOptionalInput<String>(serviceAccount),
      unmanagedContainerModel = pulumi.Input.asOptionalInput<GoogleCloudAiplatformV1beta1UnmanagedContainerModel>(unmanagedContainerModel);
  ...
  factory BatchPredictionJobAiplatformV1beta1Args.fromMap(Map<String, dynamic> map) {
    return BatchPredictionJobAiplatformV1beta1Args(
      dedicatedResources: map['dedicatedResources'] == null ? null : pulumi.Output.create<GoogleCloudAiplatformV1beta1BatchDedicatedResources>(GoogleCloudAiplatformV1beta1BatchDedicatedResources.fromMap((map['dedicatedResources'] as Map).cast<String, dynamic>())),
      ...
      explanationSpec: map['explanationSpec'] == null ? null : pulumi.Output.create<GoogleCloudAiplatformV1beta1ExplanationSpec>(GoogleCloudAiplatformV1beta1ExplanationSpec.fromMap((map['explanationSpec'] as Map).cast<String, dynamic>())),
      generateExplanation: map['generateExplanation'] == null ? null : pulumi.Output.create<bool>(map['generateExplanation'] as bool),
      inputConfig: pulumi.Output.create<GoogleCloudAiplatformV1beta1BatchPredictionJobInputConfig>(GoogleCloudAiplatformV1beta1BatchPredictionJobInputConfig.fromMap((map['inputConfig'] as Map).cast<String, dynamic>())),
      instanceConfig: map['instanceConfig'] == null ? null : pulumi.Output.create<GoogleCloudAiplatformV1beta1BatchPredictionJobInstanceConfig>(GoogleCloudAiplatformV1beta1BatchPredictionJobInstanceConfig.fromMap((map['instanceConfig'] as Map).cast<String, dynamic>())),
      labels: map['labels'] == null ? null : pulumi.Output.create<Map<String, String>>((map['labels'] as Map).cast<String, String>()),
      location: map['location'] == null ? null : pulumi.Output.create<String>(map['location'] as String),
      manualBatchTuningParameters: map['manualBatchTuningParameters'] == null ? null : pulumi.Output.create<GoogleCloudAiplatformV1beta1ManualBatchTuningParameters>(GoogleCloudAiplatformV1beta1ManualBatchTuningParameters.fromMap((map['manualBatchTuningParameters'] as Map).cast<String, dynamic>())),
      model: map['model'] == null ? null : pulumi.Output.create<String>(map['model'] as String),
      modelMonitoringConfig: map['modelMonitoringConfig'] == null ? null : pulumi.Output.create<GoogleCloudAiplatformV1beta1ModelMonitoringConfig>(GoogleCloudAiplatformV1beta1ModelMonitoringConfig.fromMap((map['modelMonitoringConfig'] as Map).cast<String, dynamic>())),
      modelMonitoringStatsAnomalies: map['modelMonitoringStatsAnomalies'] == null ? null : pulumi.Output.create<List<GoogleCloudAiplatformV1beta1ModelMonitoringStatsAnomalies>>(pulumi.Input.decodeList<GoogleCloudAiplatformV1beta1ModelMonitoringStatsAnomalies>(map['modelMonitoringStatsAnomalies'], (value) => GoogleCloudAiplatformV1beta1ModelMonitoringStatsAnomalies.fromMap((value as Map).cast<String, dynamic>()))),
      modelParameters: map['modelParameters'] == null ? null : pulumi.Output.create<dynamic>(map['modelParameters']),
      outputConfig: pulumi.Output.create<GoogleCloudAiplatformV1beta1BatchPredictionJobOutputConfig>(GoogleCloudAiplatformV1beta1BatchPredictionJobOutputConfig.fromMap((map['outputConfig'] as Map).cast<String, dynamic>())),
      project: map['project'] == null ? null : pulumi.Output.create<String>(map['project'] as String),
      serviceAccount: map['serviceAccount'] == null ? null : pulumi.Output.create<String>(map['serviceAccount'] as String),
      unmanagedContainerModel: map['unmanagedContainerModel'] == null ? null : pulumi.Output.create<GoogleCloudAiplatformV1beta1UnmanagedContainerModel>(GoogleCloudAiplatformV1beta1UnmanagedContainerModel.fromMap((map['unmanagedContainerModel'] as Map).cast<String, dynamic>())),
    );
  }
}
