...
class GoogleCloudAiplatformV1beta1MachineSpec {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1beta1MachineSpecAcceleratorType>?
  acceleratorType;
  ...
  factory GoogleCloudAiplatformV1beta1MachineSpec.fromMap(
    ...
    return GoogleCloudAiplatformV1beta1MachineSpec(
      ...
      acceleratorType: (() {
        ...
        return pulumi.Input.fromValue(
          GoogleCloudAiplatformV1beta1MachineSpecAcceleratorType.fromValue(
