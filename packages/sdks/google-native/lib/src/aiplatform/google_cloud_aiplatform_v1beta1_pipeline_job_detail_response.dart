...
class GoogleCloudAiplatformV1beta1PipelineJobDetailResponse {
  ...
  factory GoogleCloudAiplatformV1beta1PipelineJobDetailResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1PipelineJobDetailResponse(
      pipelineContext: pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1ContextResponse.fromMap((map['pipelineContext']! as Map).cast<String, dynamic>())),
      pipelineRunContext: pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1ContextResponse.fromMap((map['pipelineRunContext']! as Map).cast<String, dynamic>())),
      taskDetails: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudAiplatformV1beta1PipelineTaskDetailResponse>(map['taskDetails']!, (value) => GoogleCloudAiplatformV1beta1PipelineTaskDetailResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
