...
class GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigTrainingPredictionSkewDetectionConfig {
  ...
  final pulumi.Input<GoogleCloudAiplatformV1beta1ThresholdConfig>? defaultSkewThreshold;
  ...
  const GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigTrainingPredictionSkewDetectionConfig({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'defaultSkewThreshold': ?pulumi.Input.mapOptionalInputValue<GoogleCloudAiplatformV1beta1ThresholdConfig, Map<String, dynamic>>(defaultSkewThreshold, (value) => value.toMap()),
  ...
  factory GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigTrainingPredictionSkewDetectionConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1ModelMonitoringObjectiveConfigTrainingPredictionSkewDetectionConfig(
      ...
      defaultSkewThreshold: (() { final guardedValue = map['defaultSkewThreshold']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1ThresholdConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
