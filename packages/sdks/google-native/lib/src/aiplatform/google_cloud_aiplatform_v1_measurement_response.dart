...
class GoogleCloudAiplatformV1MeasurementResponse {
  ...
  const GoogleCloudAiplatformV1MeasurementResponse({
  ...
  factory GoogleCloudAiplatformV1MeasurementResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1MeasurementResponse(
      ...
      metrics: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudAiplatformV1MeasurementMetricResponse>(map['metrics']!, (value) => GoogleCloudAiplatformV1MeasurementMetricResponse.fromMap((value as Map).cast<String, dynamic>()))),
