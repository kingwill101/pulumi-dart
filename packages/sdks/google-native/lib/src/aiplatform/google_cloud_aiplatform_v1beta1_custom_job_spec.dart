...
class GoogleCloudAiplatformV1beta1CustomJobSpec {
  ...
  final pulumi.Input<List<GoogleCloudAiplatformV1beta1WorkerPoolSpec>>
  workerPoolSpecs;
    ...
    return <String, dynamic>{
      ...
      'workerPoolSpecs':
          pulumi.Input.mapInputValue<
            List<GoogleCloudAiplatformV1beta1WorkerPoolSpec>,
  ...
  factory GoogleCloudAiplatformV1beta1CustomJobSpec.fromMap(
    ...
    return GoogleCloudAiplatformV1beta1CustomJobSpec(
      baseOutputDirectory: (() {
        final guardedValue = map['baseOutputDirectory'];
      ...
      enableDashboardAccess: (() {
        final guardedValue = map['enableDashboardAccess'];
        if (guardedValue == null) return null;
      ...
      experiment: (() {
        final guardedValue = map['experiment'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      experimentRun: (() {
        final guardedValue = map['experimentRun'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      network: (() {
      ...
      persistentResourceId: (() {
        final guardedValue = map['persistentResourceId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      protectedArtifactLocationId: (() {
        final guardedValue = map['protectedArtifactLocationId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      reservedIpRanges: (() {
