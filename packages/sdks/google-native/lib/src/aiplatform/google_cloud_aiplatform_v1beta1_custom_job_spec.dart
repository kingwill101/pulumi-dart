...
class GoogleCloudAiplatformV1beta1CustomJobSpec {
  ...
  const GoogleCloudAiplatformV1beta1CustomJobSpec({
  ...
  factory GoogleCloudAiplatformV1beta1CustomJobSpec.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1CustomJobSpec(
      baseOutputDirectory: (() { final guardedValue = map['baseOutputDirectory']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1GcsDestination.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      persistentResourceId: (() { final guardedValue = map['persistentResourceId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      scheduling: (() { final guardedValue = map['scheduling']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAiplatformV1beta1Scheduling.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      workerPoolSpecs: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudAiplatformV1beta1WorkerPoolSpec>(map['workerPoolSpecs']!, (value) => GoogleCloudAiplatformV1beta1WorkerPoolSpec.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
