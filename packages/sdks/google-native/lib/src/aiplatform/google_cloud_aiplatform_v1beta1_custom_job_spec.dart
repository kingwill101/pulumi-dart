...
class GoogleCloudAiplatformV1beta1CustomJobSpec {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'workerPoolSpecs': pulumi.Input.encodeList<GoogleCloudAiplatformV1beta1WorkerPoolSpec, Map<String, dynamic>>(workerPoolSpecs, (value) => value.toMap()),
    };
  }
  ...
  factory GoogleCloudAiplatformV1beta1CustomJobSpec.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAiplatformV1beta1CustomJobSpec(
      baseOutputDirectory: map['baseOutputDirectory'] == null ? null : GoogleCloudAiplatformV1beta1GcsDestination.fromMap((map['baseOutputDirectory'] as Map).cast<String, dynamic>()),
      ...
      persistentResourceId: map['persistentResourceId'] == null ? null : map['persistentResourceId'] as String,
      ...
      scheduling: map['scheduling'] == null ? null : GoogleCloudAiplatformV1beta1Scheduling.fromMap((map['scheduling'] as Map).cast<String, dynamic>()),
      ...
      workerPoolSpecs: pulumi.Input.decodeList<GoogleCloudAiplatformV1beta1WorkerPoolSpec>(map['workerPoolSpecs'], (value) => GoogleCloudAiplatformV1beta1WorkerPoolSpec.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
