...
class Connection extends pulumi.CustomResource {
  ...
  Connection(
    ...
    this.githubEnterpriseConfig = registerOutput<GoogleDevtoolsCloudbuildV2GitHubEnterpriseConfigResponse>('githubEnterpriseConfig');
    this.gitlabConfig = registerOutput<GoogleDevtoolsCloudbuildV2GitLabConfigResponse>('gitlabConfig');
    this.installationState = registerOutput<InstallationStateResponse>('installationState');
