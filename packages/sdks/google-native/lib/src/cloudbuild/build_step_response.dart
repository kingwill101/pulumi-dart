...
class BuildStepResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'exitCode': exitCode,
      'name': name,
      'pullTiming': pulumi.Input.mapInputValue<TimeSpanResponse, Map<String, dynamic>>(pullTiming, (value) => value.toMap()),
      'script': script,
      'secretEnv': secretEnv,
      'status': status,
      'timeout': timeout,
  ...
  factory BuildStepResponse.fromMap(Map<String, dynamic> map) {
    return BuildStepResponse(
      ...
      pullTiming: pulumi.Input.fromValue(TimeSpanResponse.fromMap((map['pullTiming']! as Map).cast<String, dynamic>())),
