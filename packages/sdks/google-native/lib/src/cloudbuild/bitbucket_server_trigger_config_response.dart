...
class BitbucketServerTriggerConfigResponse {
  ...
  const BitbucketServerTriggerConfigResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'bitbucketServerConfig': pulumi.Input.mapInputValue<BitbucketServerConfigResponse, Map<String, dynamic>>(bitbucketServerConfig, (value) => value.toMap()),
  ...
  factory BitbucketServerTriggerConfigResponse.fromMap(Map<String, dynamic> map) {
    return BitbucketServerTriggerConfigResponse(
      bitbucketServerConfig: pulumi.Input.fromValue(BitbucketServerConfigResponse.fromMap((map['bitbucketServerConfig']! as Map).cast<String, dynamic>())),
