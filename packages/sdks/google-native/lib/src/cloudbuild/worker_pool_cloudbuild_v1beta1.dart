...
class WorkerPoolCloudbuildV1beta1 extends pulumi.CustomResource {
  ...
  WorkerPoolCloudbuildV1beta1(
    ...
    this.networkConfig = registerOutput<NetworkConfigResponseCloudbuildV1beta1>('networkConfig');
    this.project = registerOutput<String>('project');
    this.state = registerOutput<String>('state');
    this.uid = registerOutput<String>('uid');
    this.updateTime = registerOutput<String>('updateTime');
    this.workerConfig = registerOutput<WorkerConfigResponseCloudbuildV1beta1>('workerConfig');
