...
class BuildArgs {
  ...
  BuildArgs({
    pulumi.Output<Artifacts>? artifacts,
    pulumi.Output<Secrets>? availableSecrets,
    pulumi.Output<List<String>>? images,
    pulumi.Output<String>? location,
    pulumi.Output<String>? logsBucket,
    pulumi.Output<BuildOptions>? options,
    pulumi.Output<String>? project,
    required pulumi.Output<String> projectId,
    pulumi.Output<String>? queueTtl,
    pulumi.Output<List<Secret>>? secrets,
    pulumi.Output<String>? serviceAccount,
    pulumi.Output<Source>? source,
    required pulumi.Output<List<BuildStep>> steps,
    pulumi.Output<Map<String, String>>? substitutions,
  ...
  factory BuildArgs.fromMap(Map<String, dynamic> map) {
    return BuildArgs(
      artifacts: map['artifacts'] == null ? null : pulumi.Output.create<Artifacts>(Artifacts.fromMap((map['artifacts'] as Map).cast<String, dynamic>())),
      availableSecrets: map['availableSecrets'] == null ? null : pulumi.Output.create<Secrets>(Secrets.fromMap((map['availableSecrets'] as Map).cast<String, dynamic>())),
      images: map['images'] == null ? null : pulumi.Output.create<List<String>>((map['images'] as List).cast<String>()),
      location: map['location'] == null ? null : pulumi.Output.create<String>(map['location'] as String),
      logsBucket: map['logsBucket'] == null ? null : pulumi.Output.create<String>(map['logsBucket'] as String),
      options: map['options'] == null ? null : pulumi.Output.create<BuildOptions>(BuildOptions.fromMap((map['options'] as Map).cast<String, dynamic>())),
      project: map['project'] == null ? null : pulumi.Output.create<String>(map['project'] as String),
      projectId: pulumi.Output.create<String>(map['projectId'] as String),
      queueTtl: map['queueTtl'] == null ? null : pulumi.Output.create<String>(map['queueTtl'] as String),
      ...
      source: map['source'] == null ? null : pulumi.Output.create<Source>(Source.fromMap((map['source'] as Map).cast<String, dynamic>())),
      steps: pulumi.Output.create<List<BuildStep>>(pulumi.Input.decodeList<BuildStep>(map['steps'], (value) => BuildStep.fromMap((value as Map).cast<String, dynamic>()))),
      substitutions: map['substitutions'] == null ? null : pulumi.Output.create<Map<String, String>>((map['substitutions'] as Map).cast<String, String>()),
