...
class GetConnectionResult {
  ...
  final GoogleDevtoolsCloudbuildV2GitHubEnterpriseConfigResponse githubEnterpriseConfig;
  ...
  /// [installationState] Installation state of the Connection.
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'disabled': disabled,
      'etag': etag,
      'githubConfig': githubConfig.toMap(),
      'githubEnterpriseConfig': githubEnterpriseConfig.toMap(),
      'gitlabConfig': gitlabConfig.toMap(),
      'installationState': installationState.toMap(),
      'name': name,
  ...
  factory GetConnectionResult.fromMap(Map<String, dynamic> map) {
    return GetConnectionResult(
      ...
      githubConfig: GitHubConfigResponse.fromMap((map['githubConfig']! as Map).cast<String, dynamic>()),
      githubEnterpriseConfig: GoogleDevtoolsCloudbuildV2GitHubEnterpriseConfigResponse.fromMap((map['githubEnterpriseConfig']! as Map).cast<String, dynamic>()),
      gitlabConfig: GoogleDevtoolsCloudbuildV2GitLabConfigResponse.fromMap((map['gitlabConfig']! as Map).cast<String, dynamic>()),
      installationState: InstallationStateResponse.fromMap((map['installationState']! as Map).cast<String, dynamic>()),
