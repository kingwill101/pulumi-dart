...
class ArtifactsResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'images': images,
      'mavenArtifacts': pulumi.Input.encodeList<MavenArtifactResponse, Map<String, dynamic>>(mavenArtifacts, (value) => value.toMap()),
      'npmPackages': pulumi.Input.encodeList<NpmPackageResponse, Map<String, dynamic>>(npmPackages, (value) => value.toMap()),
      'objects': objects.toMap(),
      'pythonPackages': pulumi.Input.encodeList<PythonPackageResponse, Map<String, dynamic>>(pythonPackages, (value) => value.toMap()),
    };
  }
  ...
  factory ArtifactsResponse.fromMap(Map<String, dynamic> map) {
    return ArtifactsResponse(
      ...
      mavenArtifacts: pulumi.Input.decodeList<MavenArtifactResponse>(map['mavenArtifacts'], (value) => MavenArtifactResponse.fromMap((value as Map).cast<String, dynamic>())),
      npmPackages: pulumi.Input.decodeList<NpmPackageResponse>(map['npmPackages'], (value) => NpmPackageResponse.fromMap((value as Map).cast<String, dynamic>())),
      objects: ArtifactObjectsResponse.fromMap((map['objects'] as Map).cast<String, dynamic>()),
      pythonPackages: pulumi.Input.decodeList<PythonPackageResponse>(map['pythonPackages'], (value) => PythonPackageResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
