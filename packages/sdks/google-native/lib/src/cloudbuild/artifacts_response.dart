  ...
  factory ArtifactsResponse.fromMap(Map<String, dynamic> map) {
    return ArtifactsResponse(
      ...
      mavenArtifacts: pulumi.Input.fromValue(
        pulumi.Input.decodeList<MavenArtifactResponse>(
          map['mavenArtifacts']!,
      ...
      npmPackages: pulumi.Input.fromValue(
        pulumi.Input.decodeList<NpmPackageResponse>(
          map['npmPackages']!,
      ...
      objects: pulumi.Input.fromValue(
        ArtifactObjectsResponse.fromMap(
          (map['objects']! as Map).cast<String, dynamic>(),
        ),
      ),
      pythonPackages: pulumi.Input.fromValue(
        pulumi.Input.decodeList<PythonPackageResponse>(
          map['pythonPackages']!,
