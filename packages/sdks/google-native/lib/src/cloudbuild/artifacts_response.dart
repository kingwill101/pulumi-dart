...
class ArtifactsResponse {
  ...
  factory ArtifactsResponse.fromMap(Map<String, dynamic> map) {
    return ArtifactsResponse(
      ...
      mavenArtifacts: (pulumi.Input.decodeList<MavenArtifactResponse>(map['mavenArtifacts'], (value) => MavenArtifactResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      npmPackages: (pulumi.Input.decodeList<NpmPackageResponse>(map['npmPackages'], (value) => NpmPackageResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      objects: (ArtifactObjectsResponse.fromMap((map['objects'] as Map).cast<String, dynamic>())).input(),
      pythonPackages: (pulumi.Input.decodeList<PythonPackageResponse>(map['pythonPackages'], (value) => PythonPackageResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
