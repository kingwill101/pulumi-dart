...
class NetworkConfig {
  ...
  final pulumi.Input<NetworkConfigEgressOption>? egressOption;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'egressOption': ?pulumi.Input.mapOptionalInputValue<NetworkConfigEgressOption, String>(egressOption, (value) => value.wireValue),
  ...
  factory NetworkConfig.fromMap(Map<String, dynamic> map) {
    return NetworkConfig(
      egressOption: (() { final guardedValue = map['egressOption']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkConfigEgressOption.fromValue(guardedValue as String)); })(),
