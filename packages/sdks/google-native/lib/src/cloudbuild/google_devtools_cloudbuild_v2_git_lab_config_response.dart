...
class GoogleDevtoolsCloudbuildV2GitLabConfigResponse {
  ...
  factory GoogleDevtoolsCloudbuildV2GitLabConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleDevtoolsCloudbuildV2GitLabConfigResponse(
      authorizerCredential: (UserCredentialResponse.fromMap((map['authorizerCredential'] as Map).cast<String, dynamic>())).input(),
      hostUri: (map['hostUri'] as String).input(),
      readAuthorizerCredential: (UserCredentialResponse.fromMap((map['readAuthorizerCredential'] as Map).cast<String, dynamic>())).input(),
