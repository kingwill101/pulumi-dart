...
class SourceProvenanceResponse {
  ...
  factory SourceProvenanceResponse.fromMap(Map<String, dynamic> map) {
    return SourceProvenanceResponse(
      ...
      resolvedConnectedRepository: (ConnectedRepositoryResponse.fromMap((map['resolvedConnectedRepository'] as Map).cast<String, dynamic>())).input(),
      resolvedGitSource: (GitSourceResponse.fromMap((map['resolvedGitSource'] as Map).cast<String, dynamic>())).input(),
      ...
      resolvedStorageSourceManifest: (StorageSourceManifestResponse.fromMap((map['resolvedStorageSourceManifest'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
