...
class SourceProvenanceResponse {
  ...
  final pulumi.Input<StorageSourceManifestResponse>
    ...
    return <String, dynamic>{
      ...
      'resolvedConnectedRepository':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(resolvedConnectedRepository, (value) => value.toMap()),
      'resolvedGitSource':
      ...
      'resolvedStorageSourceManifest':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(resolvedStorageSourceManifest, (value) => value.toMap()),
    };
  }
  ...
  factory SourceProvenanceResponse.fromMap(Map<String, dynamic> map) {
    return SourceProvenanceResponse(
      ...
      resolvedStorageSourceManifest: pulumi.Input.fromValue(
