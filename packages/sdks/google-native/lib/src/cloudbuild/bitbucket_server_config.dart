...
class BitbucketServerConfig extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<BitbucketServerRepositoryIdResponse>> connectedRepositories;
  ...
  BitbucketServerConfig(
    ...
    this.bitbucketServerConfigId = registerOutput<String?>('bitbucketServerConfigId');
    this.connectedRepositories = registerOutput<List<BitbucketServerRepositoryIdResponse>>('connectedRepositories');
