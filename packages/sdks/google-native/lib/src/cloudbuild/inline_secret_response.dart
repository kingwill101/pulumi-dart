...
class InlineSecretResponse {
  ...
  InlineSecretResponse({required this.envMap, required this.kmsKeyName});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'envMap': envMap, 'kmsKeyName': kmsKeyName};
  }

  factory InlineSecretResponse.fromMap(Map<String, dynamic> map) {
    return InlineSecretResponse(
      envMap: pulumi.Input.fromValue(
