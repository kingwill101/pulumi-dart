...
class SecretsResponse {
  ...
  factory SecretsResponse.fromMap(Map<String, dynamic> map) {
    return SecretsResponse(
      inline: (pulumi.Input.decodeList<InlineSecretResponse>(map['inline'], (value) => InlineSecretResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      secretManager: (pulumi.Input.decodeList<SecretManagerSecretResponse>(map['secretManager'], (value) => SecretManagerSecretResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
