...
class SecretsResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'secretManager':
          pulumi.Input.mapInputValue<
            List<SecretManagerSecretResponse>,
            List<Map<String, dynamic>>
          >(
            secretManager,
            (value) =>
  ...
  factory SecretsResponse.fromMap(Map<String, dynamic> map) {
    return SecretsResponse(
      inline: pulumi.Input.fromValue(
        pulumi.Input.decodeList<InlineSecretResponse>(
          map['inline']!,
      ...
      secretManager: pulumi.Input.fromValue(
        pulumi.Input.decodeList<SecretManagerSecretResponse>(
          map['secretManager']!,
