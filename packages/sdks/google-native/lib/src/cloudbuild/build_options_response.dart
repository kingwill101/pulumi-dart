...
class BuildOptionsResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'pool':
          pulumi.Input.mapInputValue<PoolOptionResponse, Map<String, dynamic>>(
            pool,
            (value) => value.toMap(),
          ),
