...
class BuildOptionsResponse {
  ...
  factory BuildOptionsResponse.fromMap(Map<String, dynamic> map) {
    return BuildOptionsResponse(
      automapSubstitutions: (map['automapSubstitutions'] as bool).input(),
      defaultLogsBucketBehavior: (map['defaultLogsBucketBehavior'] as String).input(),
      diskSizeGb: (map['diskSizeGb'] as String).input(),
      dynamicSubstitutions: (map['dynamicSubstitutions'] as bool).input(),
      env: ((map['env'] as List).cast<String>()).input(),
      logStreamingOption: (map['logStreamingOption'] as String).input(),
      logging: (map['logging'] as String).input(),
      machineType: (map['machineType'] as String).input(),
      pool: (PoolOptionResponse.fromMap((map['pool'] as Map).cast<String, dynamic>())).input(),
      requestedVerifyOption: (map['requestedVerifyOption'] as String).input(),
      secretEnv: ((map['secretEnv'] as List).cast<String>()).input(),
      sourceProvenanceHash: ((map['sourceProvenanceHash'] as List).cast<String>()).input(),
      substitutionOption: (map['substitutionOption'] as String).input(),
