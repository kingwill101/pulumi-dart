...
class SourceResponse {
  ...
  factory SourceResponse.fromMap(Map<String, dynamic> map) {
    return SourceResponse(
      connectedRepository: pulumi.Input.fromValue(ConnectedRepositoryResponse.fromMap((map['connectedRepository']! as Map).cast<String, dynamic>())),
      gitSource: pulumi.Input.fromValue(GitSourceResponse.fromMap((map['gitSource']! as Map).cast<String, dynamic>())),
      ...
      storageSourceManifest: pulumi.Input.fromValue(StorageSourceManifestResponse.fromMap((map['storageSourceManifest']! as Map).cast<String, dynamic>())),
    );
  }
}
