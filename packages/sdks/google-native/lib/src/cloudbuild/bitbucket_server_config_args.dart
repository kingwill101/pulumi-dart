...
class BitbucketServerConfigArgs {
  ...
  factory BitbucketServerConfigArgs.fromMap(Map<String, dynamic> map) {
    return BitbucketServerConfigArgs(
      ...
      bitbucketServerConfigId: (() { final guardedValue = map['bitbucketServerConfigId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      peeredNetworkIpRange: (() { final guardedValue = map['peeredNetworkIpRange']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      project: (() { final guardedValue = map['project']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      secrets: pulumi.Input.fromValue(BitbucketServerSecrets.fromMap((map['secrets']! as Map).cast<String, dynamic>())),
