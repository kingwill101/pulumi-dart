...
class BitbucketServerConfigResponse {
  ...
  factory BitbucketServerConfigResponse.fromMap(Map<String, dynamic> map) {
    return BitbucketServerConfigResponse(
      ...
      connectedRepositories: (pulumi.Input.decodeList<BitbucketServerRepositoryIdResponse>(map['connectedRepositories'], (value) => BitbucketServerRepositoryIdResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      secrets: (BitbucketServerSecretsResponse.fromMap((map['secrets'] as Map).cast<String, dynamic>())).input(),
