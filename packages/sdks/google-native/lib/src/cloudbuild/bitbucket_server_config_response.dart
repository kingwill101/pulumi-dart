...
class BitbucketServerConfigResponse {
  ...
  final pulumi.Input<List<BitbucketServerRepositoryIdResponse>> connectedRepositories;
  ...
  final pulumi.Input<BitbucketServerSecretsResponse> secrets;
  ...
  const BitbucketServerConfigResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'apiKey': apiKey,
      'connectedRepositories': pulumi.Input.mapInputValue<List<BitbucketServerRepositoryIdResponse>, List<Map<String, dynamic>>>(connectedRepositories, (value) => pulumi.Input.encodeList<BitbucketServerRepositoryIdResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'createTime': createTime,
      'hostUri': hostUri,
      'name': name,
      'peeredNetwork': peeredNetwork,
      'peeredNetworkIpRange': peeredNetworkIpRange,
      'secrets': pulumi.Input.mapInputValue<BitbucketServerSecretsResponse, Map<String, dynamic>>(secrets, (value) => value.toMap()),
      'sslCa': sslCa,
      'username': username,
  ...
  factory BitbucketServerConfigResponse.fromMap(Map<String, dynamic> map) {
    return BitbucketServerConfigResponse(
      ...
      connectedRepositories: pulumi.Input.fromValue(pulumi.Input.decodeList<BitbucketServerRepositoryIdResponse>(map['connectedRepositories']!, (value) => BitbucketServerRepositoryIdResponse.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      secrets: pulumi.Input.fromValue(BitbucketServerSecretsResponse.fromMap((map['secrets']! as Map).cast<String, dynamic>())),
