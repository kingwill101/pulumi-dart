...
class WorkerPoolCloudbuildV1beta1Args {
  ...
  factory WorkerPoolCloudbuildV1beta1Args.fromMap(Map<String, dynamic> map) {
    return WorkerPoolCloudbuildV1beta1Args(
      ...
      networkConfig: (() { final guardedValue = map['networkConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkConfigCloudbuildV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      project: (() { final guardedValue = map['project']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      workerConfig: (() { final guardedValue = map['workerConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WorkerConfigCloudbuildV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
