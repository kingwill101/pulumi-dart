...
class GetTriggerResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'approvalConfig': approvalConfig.toMap(),
      'autodetect': autodetect,
      'bitbucketServerTriggerConfig': bitbucketServerTriggerConfig.toMap(),
      'build': build.toMap(),
      ...
      'filename': filename,
      'filter': filter,
      'gitFileSource': gitFileSource.toMap(),
      'github': github.toMap(),
      'gitlabEnterpriseEventsConfig': gitlabEnterpriseEventsConfig.toMap(),
      'ignoredFiles': ignoredFiles,
      'includeBuildLogs': includeBuildLogs,
      'includedFiles': includedFiles,
      'name': name,
      'pubsubConfig': pubsubConfig.toMap(),
      'repositoryEventConfig': repositoryEventConfig.toMap(),
      'resourceName': resourceName,
      'serviceAccount': serviceAccount,
      'sourceToBuild': sourceToBuild.toMap(),
      'substitutions': substitutions,
      'tags': tags,
      'triggerTemplate': triggerTemplate.toMap(),
  ...
  factory GetTriggerResult.fromMap(Map<String, dynamic> map) {
    return GetTriggerResult(
      approvalConfig: ApprovalConfigResponse.fromMap((map['approvalConfig']! as Map).cast<String, dynamic>()),
      autodetect: map['autodetect'] as bool,
      bitbucketServerTriggerConfig: BitbucketServerTriggerConfigResponse.fromMap((map['bitbucketServerTriggerConfig']! as Map).cast<String, dynamic>()),
      ...
      gitFileSource: GitFileSourceResponse.fromMap((map['gitFileSource']! as Map).cast<String, dynamic>()),
      github: GitHubEventsConfigResponse.fromMap((map['github']! as Map).cast<String, dynamic>()),
      gitlabEnterpriseEventsConfig: GitLabEventsConfigResponse.fromMap((map['gitlabEnterpriseEventsConfig']! as Map).cast<String, dynamic>()),
      ...
      repositoryEventConfig: RepositoryEventConfigResponse.fromMap((map['repositoryEventConfig']! as Map).cast<String, dynamic>()),
      resourceName: map['resourceName'] as String,
      serviceAccount: map['serviceAccount'] as String,
      sourceToBuild: GitRepoSourceResponse.fromMap((map['sourceToBuild']! as Map).cast<String, dynamic>()),
      substitutions: (map['substitutions'] as Map).cast<String, String>(),
      tags: (map['tags'] as List).cast<String>(),
      triggerTemplate: RepoSourceResponse.fromMap((map['triggerTemplate']! as Map).cast<String, dynamic>()),
      webhookConfig: WebhookConfigResponse.fromMap((map['webhookConfig']! as Map).cast<String, dynamic>()),
    );
  }
}
