...
class Source {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'gitSource':
          ?pulumi.Input.mapOptionalInputValue<GitSource, Map<String, dynamic>>(
            gitSource,
            (value) => value.toMap(),
          ),
      'repoSource':
  ...
  factory Source.fromMap(Map<String, dynamic> map) {
    return Source(
      connectedRepository: (() {
        final guardedValue = map['connectedRepository'];
      ...
      gitSource: (() {
        final guardedValue = map['gitSource'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GitSource.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      repoSource: (() {
      ...
      storageSourceManifest: (() {
        final guardedValue = map['storageSourceManifest'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
