...
class BuildOptions {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'defaultLogsBucketBehavior': ?pulumi.Input.mapOptionalInputValue<BuildOptionsDefaultLogsBucketBehavior, String>(defaultLogsBucketBehavior, (value) => value.wireValue),
      'diskSizeGb': ?diskSizeGb,
      'dynamicSubstitutions': ?dynamicSubstitutions,
      'env': ?env,
      'logStreamingOption': ?pulumi.Input.mapOptionalInputValue<BuildOptionsLogStreamingOption, String>(logStreamingOption, (value) => value.wireValue),
      'logging': ?pulumi.Input.mapOptionalInputValue<BuildOptionsLogging, String>(logging, (value) => value.wireValue),
      'machineType': ?pulumi.Input.mapOptionalInputValue<BuildOptionsMachineType, String>(machineType, (value) => value.wireValue),
      'pool': ?pulumi.Input.mapOptionalInputValue<PoolOption, Map<String, dynamic>>(pool, (value) => value.toMap()),
      'requestedVerifyOption': ?pulumi.Input.mapOptionalInputValue<BuildOptionsRequestedVerifyOption, String>(requestedVerifyOption, (value) => value.wireValue),
      'secretEnv': ?secretEnv,
      'sourceProvenanceHash': ?pulumi.Input.mapOptionalInputValue<List<BuildOptionsSourceProvenanceHashItem>, List<String>>(sourceProvenanceHash, (value) => pulumi.Input.encodeList<BuildOptionsSourceProvenanceHashItem, String>(value, (value) => value.wireValue)),
      'substitutionOption': ?pulumi.Input.mapOptionalInputValue<BuildOptionsSubstitutionOption, String>(substitutionOption, (value) => value.wireValue),
  ...
  factory BuildOptions.fromMap(Map<String, dynamic> map) {
    return BuildOptions(
      automapSubstitutions: (() { final guardedValue = map['automapSubstitutions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      defaultLogsBucketBehavior: (() { final guardedValue = map['defaultLogsBucketBehavior']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BuildOptionsDefaultLogsBucketBehavior.fromValue(guardedValue as String)); })(),
      ...
      dynamicSubstitutions: (() { final guardedValue = map['dynamicSubstitutions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      logStreamingOption: (() { final guardedValue = map['logStreamingOption']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BuildOptionsLogStreamingOption.fromValue(guardedValue as String)); })(),
      logging: (() { final guardedValue = map['logging']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BuildOptionsLogging.fromValue(guardedValue as String)); })(),
      machineType: (() { final guardedValue = map['machineType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BuildOptionsMachineType.fromValue(guardedValue as String)); })(),
      pool: (() { final guardedValue = map['pool']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PoolOption.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      requestedVerifyOption: (() { final guardedValue = map['requestedVerifyOption']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BuildOptionsRequestedVerifyOption.fromValue(guardedValue as String)); })(),
      secretEnv: (() { final guardedValue = map['secretEnv']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      sourceProvenanceHash: (() { final guardedValue = map['sourceProvenanceHash']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<BuildOptionsSourceProvenanceHashItem>(guardedValue, (value) => BuildOptionsSourceProvenanceHashItem.fromValue(value as String))); })(),
      substitutionOption: (() { final guardedValue = map['substitutionOption']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BuildOptionsSubstitutionOption.fromValue(guardedValue as String)); })(),
