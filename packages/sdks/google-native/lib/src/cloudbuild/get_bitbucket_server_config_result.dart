...
/// Result data returned by getBitbucketServerConfig.
class GetBitbucketServerConfigResult {
  ...
  /// Creates a new [GetBitbucketServerConfigResult].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'apiKey': apiKey,
      'connectedRepositories': pulumi.Input.encodeList<BitbucketServerRepositoryIdResponse, Map<String, dynamic>>(connectedRepositories, (value) => value.toMap()),
  ...
  factory GetBitbucketServerConfigResult.fromMap(Map<String, dynamic> map) {
    return GetBitbucketServerConfigResult(
      apiKey: map['apiKey'] as String,
      connectedRepositories: pulumi.Input.decodeList<BitbucketServerRepositoryIdResponse>(map['connectedRepositories']!, (value) => BitbucketServerRepositoryIdResponse.fromMap((value as Map).cast<String, dynamic>())),
      ...
      secrets: BitbucketServerSecretsResponse.fromMap((map['secrets']! as Map).cast<String, dynamic>()),
