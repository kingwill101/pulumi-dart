...
class ResultsResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'mavenArtifacts':
          pulumi.Input.mapInputValue<
            List<UploadedMavenArtifactResponse>,
            List<Map<String, dynamic>>
          >(
            mavenArtifacts,
            (value) =>
      ...
      'npmPackages':
          pulumi.Input.mapInputValue<
            List<UploadedNpmPackageResponse>,
            List<Map<String, dynamic>>
          >(
            npmPackages,
            (value) =>
      ...
      'pythonPackages':
          pulumi.Input.mapInputValue<
            List<UploadedPythonPackageResponse>,
            List<Map<String, dynamic>>
          >(
            pythonPackages,
            (value) =>
  ...
  factory ResultsResponse.fromMap(Map<String, dynamic> map) {
    return ResultsResponse(
      artifactManifest: pulumi.Input.fromValue(
        map['artifactManifest'] as String,
      ),
      artifactTiming: pulumi.Input.fromValue(
        TimeSpanResponse.fromMap(
          (map['artifactTiming']! as Map).cast<String, dynamic>(),
        ),
      ),
      buildStepImages: pulumi.Input.fromValue(
        (map['buildStepImages'] as List).cast<String>(),
      ),
      buildStepOutputs: pulumi.Input.fromValue(
        (map['buildStepOutputs'] as List).cast<String>(),
      ),
      images: pulumi.Input.fromValue(
        pulumi.Input.decodeList<BuiltImageResponse>(
          map['images']!,
      ...
      mavenArtifacts: pulumi.Input.fromValue(
        pulumi.Input.decodeList<UploadedMavenArtifactResponse>(
          map['mavenArtifacts']!,
      ...
      npmPackages: pulumi.Input.fromValue(
        pulumi.Input.decodeList<UploadedNpmPackageResponse>(
          map['npmPackages']!,
      ...
      pythonPackages: pulumi.Input.fromValue(
        pulumi.Input.decodeList<UploadedPythonPackageResponse>(
          map['pythonPackages']!,
