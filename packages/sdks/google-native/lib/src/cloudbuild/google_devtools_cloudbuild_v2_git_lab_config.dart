...
class GoogleDevtoolsCloudbuildV2GitLabConfig {
  ...
  final pulumi.Input<GoogleDevtoolsCloudbuildV2ServiceDirectoryConfig>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'authorizerCredential':
          pulumi.Input.mapInputValue<UserCredential, Map<String, dynamic>>(
            authorizerCredential,
            (value) => value.toMap(),
          ),
      'hostUri': ?hostUri,
