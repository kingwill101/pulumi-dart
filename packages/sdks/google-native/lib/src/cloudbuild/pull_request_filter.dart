...
class PullRequestFilter {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'branch': ?branch,
      'commentControl': ?pulumi.Input.mapOptionalInputValue<PullRequestFilterCommentControl, String>(commentControl, (value) => value.wireValue),
  ...
  factory PullRequestFilter.fromMap(Map<String, dynamic> map) {
    return PullRequestFilter(
      ...
      commentControl: (() { final guardedValue = map['commentControl']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PullRequestFilterCommentControl.fromValue(guardedValue as String)); })(),
