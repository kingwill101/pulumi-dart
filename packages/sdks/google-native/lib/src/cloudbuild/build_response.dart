...
class BuildResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'approval': pulumi.Input.mapInputValue<BuildApprovalResponse, Map<String, dynamic>>(approval, (value) => value.toMap()),
      'artifacts': pulumi.Input.mapInputValue<ArtifactsResponse, Map<String, dynamic>>(artifacts, (value) => value.toMap()),
      'availableSecrets': pulumi.Input.mapInputValue<SecretsResponse, Map<String, dynamic>>(availableSecrets, (value) => value.toMap()),
      'buildTriggerId': buildTriggerId,
      'createTime': createTime,
      'failureInfo': pulumi.Input.mapInputValue<FailureInfoResponse, Map<String, dynamic>>(failureInfo, (value) => value.toMap()),
      'finishTime': finishTime,
      'images': images,
      'logUrl': logUrl,
      'logsBucket': logsBucket,
      'name': name,
      'options': pulumi.Input.mapInputValue<BuildOptionsResponse, Map<String, dynamic>>(options, (value) => value.toMap()),
      'project': project,
      'queueTtl': queueTtl,
      'results': pulumi.Input.mapInputValue<ResultsResponse, Map<String, dynamic>>(results, (value) => value.toMap()),
      'secrets': pulumi.Input.mapInputValue<List<SecretResponse>, List<Map<String, dynamic>>>(secrets, (value) => pulumi.Input.encodeList<SecretResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      ...
      'steps': pulumi.Input.mapInputValue<List<BuildStepResponse>, List<Map<String, dynamic>>>(steps, (value) => pulumi.Input.encodeList<BuildStepResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'substitutions': substitutions,
      'tags': tags,
      'timeout': timeout,
      'timing': timing,
      'warnings': pulumi.Input.mapInputValue<List<WarningResponse>, List<Map<String, dynamic>>>(warnings, (value) => pulumi.Input.encodeList<WarningResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory BuildResponse.fromMap(Map<String, dynamic> map) {
    return BuildResponse(
      approval: pulumi.Input.fromValue(BuildApprovalResponse.fromMap((map['approval']! as Map).cast<String, dynamic>())),
      artifacts: pulumi.Input.fromValue(ArtifactsResponse.fromMap((map['artifacts']! as Map).cast<String, dynamic>())),
      availableSecrets: pulumi.Input.fromValue(SecretsResponse.fromMap((map['availableSecrets']! as Map).cast<String, dynamic>())),
      buildTriggerId: pulumi.Input.fromValue(map['buildTriggerId'] as String),
      createTime: pulumi.Input.fromValue(map['createTime'] as String),
      failureInfo: pulumi.Input.fromValue(FailureInfoResponse.fromMap((map['failureInfo']! as Map).cast<String, dynamic>())),
      ...
      options: pulumi.Input.fromValue(BuildOptionsResponse.fromMap((map['options']! as Map).cast<String, dynamic>())),
      project: pulumi.Input.fromValue(map['project'] as String),
      queueTtl: pulumi.Input.fromValue(map['queueTtl'] as String),
      results: pulumi.Input.fromValue(ResultsResponse.fromMap((map['results']! as Map).cast<String, dynamic>())),
      secrets: pulumi.Input.fromValue(pulumi.Input.decodeList<SecretResponse>(map['secrets']!, (value) => SecretResponse.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      steps: pulumi.Input.fromValue(pulumi.Input.decodeList<BuildStepResponse>(map['steps']!, (value) => BuildStepResponse.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      timing: pulumi.Input.fromValue((map['timing'] as Map).cast<String, String>()),
      warnings: pulumi.Input.fromValue(pulumi.Input.decodeList<WarningResponse>(map['warnings']!, (value) => WarningResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
