...
class BuildResponse {
  ...
  factory BuildResponse.fromMap(Map<String, dynamic> map) {
    return BuildResponse(
      approval: (BuildApprovalResponse.fromMap((map['approval'] as Map).cast<String, dynamic>())).input(),
      artifacts: (ArtifactsResponse.fromMap((map['artifacts'] as Map).cast<String, dynamic>())).input(),
      availableSecrets: (SecretsResponse.fromMap((map['availableSecrets'] as Map).cast<String, dynamic>())).input(),
      buildTriggerId: (map['buildTriggerId'] as String).input(),
      createTime: (map['createTime'] as String).input(),
      failureInfo: (FailureInfoResponse.fromMap((map['failureInfo'] as Map).cast<String, dynamic>())).input(),
      finishTime: (map['finishTime'] as String).input(),
      images: ((map['images'] as List).cast<String>()).input(),
      logUrl: (map['logUrl'] as String).input(),
      logsBucket: (map['logsBucket'] as String).input(),
      name: (map['name'] as String).input(),
      options: (BuildOptionsResponse.fromMap((map['options'] as Map).cast<String, dynamic>())).input(),
      project: (map['project'] as String).input(),
      queueTtl: (map['queueTtl'] as String).input(),
      results: (ResultsResponse.fromMap((map['results'] as Map).cast<String, dynamic>())).input(),
      secrets: (pulumi.Input.decodeList<SecretResponse>(map['secrets'], (value) => SecretResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      steps: (pulumi.Input.decodeList<BuildStepResponse>(map['steps'], (value) => BuildStepResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      timing: ((map['timing'] as Map).cast<String, String>()).input(),
      warnings: (pulumi.Input.decodeList<WarningResponse>(map['warnings'], (value) => WarningResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
