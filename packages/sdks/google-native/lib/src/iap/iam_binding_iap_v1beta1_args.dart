...
/// {@template pulumi_iap_v1beta1_iam_binding_iap_v1beta1_args_doc}
/// The set of arguments for V1beta1IamBinding.
/// {@endtemplate}
/// {@macro pulumi_iap_v1beta1_iam_binding_iap_v1beta1_args_doc}
class IamBindingIapV1beta1Args {
  ...
  /// Creates a new [IamBindingIapV1beta1Args].
  ...
  const IamBindingIapV1beta1Args({
    this.condition,
  ...
  factory IamBindingIapV1beta1Args.fromMap(Map<String, dynamic> map) {
    return IamBindingIapV1beta1Args(
