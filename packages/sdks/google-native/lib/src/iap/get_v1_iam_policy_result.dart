...
/// Result data returned by getV1IamPolicy.
class GetV1IamPolicyResult {
  ...
  /// Creates a new [GetV1IamPolicyResult].
  ...
  factory GetV1IamPolicyResult.fromMap(Map<String, dynamic> map) {
    return GetV1IamPolicyResult(
