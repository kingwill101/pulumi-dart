...
class ExprResponseIapV1beta1 {
  ...
  /// Creates a new [ExprResponseIapV1beta1].
  ...
  factory ExprResponseIapV1beta1.fromMap(Map<String, dynamic> map) {
    return ExprResponseIapV1beta1(
