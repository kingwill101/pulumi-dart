...
/// {@template pulumi_iap_v1beta1_iam_member_iap_v1beta1_args_doc}
/// The set of arguments for V1beta1IamMember.
/// {@endtemplate}
/// {@macro pulumi_iap_v1beta1_iam_member_iap_v1beta1_args_doc}
class IamMemberIapV1beta1Args {
  ...
  /// Creates a new [IamMemberIapV1beta1Args].
  ...
  factory IamMemberIapV1beta1Args.fromMap(Map<String, dynamic> map) {
    return IamMemberIapV1beta1Args(
