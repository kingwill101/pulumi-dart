...
class VexAssessmentResponseContaineranalysisV1beta1 {
  ...
  final pulumi.Input<JustificationResponseContaineranalysisV1beta1>
  justification;
  ...
  final pulumi.Input<List<RelatedUrlResponseContaineranalysisV1beta1>>
  relatedUris;

  /// Specifies details on how to handle (and presumably, fix) a vulnerability.
  final pulumi.Input<List<RemediationResponseContaineranalysisV1beta1>>
  remediations;
    ...
    return <String, dynamic>{
      ...
      'justification':
          pulumi.Input.mapInputValue<
            JustificationResponseContaineranalysisV1beta1,
            Map<String, dynamic>
          >(justification, (value) => value.toMap()),
      'noteName': noteName,
      'relatedUris':
          pulumi.Input.mapInputValue<
            List<RelatedUrlResponseContaineranalysisV1beta1>,
      ...
      'remediations':
          pulumi.Input.mapInputValue<
            List<RemediationResponseContaineranalysisV1beta1>,
            List<Map<String, dynamic>>
          >(
            remediations,
            (value) =>
  ...
  factory VexAssessmentResponseContaineranalysisV1beta1.fromMap(
    ...
    return VexAssessmentResponseContaineranalysisV1beta1(
      ...
      justification: pulumi.Input.fromValue(
        JustificationResponseContaineranalysisV1beta1.fromMap(
