...
class DetailResponse {
  ...
  factory DetailResponse.fromMap(Map<String, dynamic> map) {
    return DetailResponse(
      ...
      affectedVersionEnd: (VersionResponse.fromMap((map['affectedVersionEnd'] as Map).cast<String, dynamic>())).input(),
      affectedVersionStart: (VersionResponse.fromMap((map['affectedVersionStart'] as Map).cast<String, dynamic>())).input(),
