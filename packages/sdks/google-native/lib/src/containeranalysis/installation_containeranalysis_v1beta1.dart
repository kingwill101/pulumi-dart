...
class InstallationContaineranalysisV1beta1 {
  ...
  factory InstallationContaineranalysisV1beta1.fromMap(Map<String, dynamic> map) {
    return InstallationContaineranalysisV1beta1(
      ...
      location: (() { final guardedValue = map['location']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<LocationContaineranalysisV1beta1>(guardedValue, (value) => LocationContaineranalysisV1beta1.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
