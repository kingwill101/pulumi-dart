...
class Package {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'architecture':
          ?pulumi.Input.mapOptionalInputValue<PackageArchitecture, String>(
            architecture,
      ...
      'digest':
          ?pulumi.Input.mapOptionalInputValue<
            List<DigestContaineranalysisV1alpha1>,
      ...
      'distribution':
          ?pulumi.Input.mapOptionalInputValue<
            List<DistributionContaineranalysisV1alpha1>,
            List<Map<String, dynamic>>
          >(
            distribution,
            (value) =>
    ...
    return Package(
      architecture: (() {
        ...
        return pulumi.Input.fromValue(
          PackageArchitecture.fromValue(guardedValue as String),
        );
      })(),
      cpeUri: (() {
