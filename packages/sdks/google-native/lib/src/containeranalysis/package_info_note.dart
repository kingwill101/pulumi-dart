...
class PackageInfoNote {
  ...
  /// ExternalRef
  final pulumi.Input<List<ExternalRef>>? externalRefs;
  ...
  final pulumi.Input<LicenseContaineranalysisV1alpha1>? licenseDeclared;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'externalRefs': ?pulumi.Input.mapOptionalInputValue<List<ExternalRef>, List<Map<String, dynamic>>>(externalRefs, (value) => pulumi.Input.encodeList<ExternalRef, Map<String, dynamic>>(value, (value) => value.toMap())),
      'filesLicenseInfo': ?filesLicenseInfo,
      'homePage': ?homePage,
      'licenseDeclared': ?pulumi.Input.mapOptionalInputValue<LicenseContaineranalysisV1alpha1, Map<String, dynamic>>(licenseDeclared, (value) => value.toMap()),
  ...
  factory PackageInfoNote.fromMap(Map<String, dynamic> map) {
    return PackageInfoNote(
      ...
      externalRefs: (() { final guardedValue = map['externalRefs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ExternalRef>(guardedValue, (value) => ExternalRef.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      licenseDeclared: (() { final guardedValue = map['licenseDeclared']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LicenseContaineranalysisV1alpha1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
