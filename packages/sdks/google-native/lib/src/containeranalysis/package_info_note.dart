...
class PackageInfoNote {
  ...
  factory PackageInfoNote.fromMap(Map<String, dynamic> map) {
    return PackageInfoNote(
      ...
      externalRefs: map['externalRefs'] == null ? null : (pulumi.Input.decodeList<ExternalRef>(map['externalRefs']!, (value) => ExternalRef.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      licenseDeclared: map['licenseDeclared'] == null ? null : (LicenseContaineranalysisV1alpha1.fromMap((map['licenseDeclared']! as Map).cast<String, dynamic>())).input(),
