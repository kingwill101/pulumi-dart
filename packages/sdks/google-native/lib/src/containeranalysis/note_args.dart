...
class NoteArgs {
  ...
  NoteArgs({
    pulumi.Output<AttestationNote>? attestation,
    pulumi.Output<BuildNote>? build,
    pulumi.Output<ComplianceNote>? compliance,
    pulumi.Output<DeploymentNote>? deployment,
    pulumi.Output<DiscoveryNote>? discovery,
    pulumi.Output<DSSEAttestationNote>? dsseAttestation,
    pulumi.Output<String>? expirationTime,
    pulumi.Output<ImageNote>? image,
    pulumi.Output<String>? longDescription,
    required pulumi.Output<String> noteId,
    pulumi.Output<PackageNote>? package,
    pulumi.Output<String>? project,
    pulumi.Output<List<String>>? relatedNoteNames,
    pulumi.Output<List<RelatedUrl>>? relatedUrl,
    pulumi.Output<SBOMReferenceNote>? sbomReference,
    pulumi.Output<String>? shortDescription,
    pulumi.Output<UpgradeNote>? upgrade,
    pulumi.Output<VulnerabilityNote>? vulnerability,
    pulumi.Output<VulnerabilityAssessmentNote>? vulnerabilityAssessment,
  }) :
  ...
  factory NoteArgs.fromMap(Map<String, dynamic> map) {
    return NoteArgs(
      attestation: map['attestation'] == null ? null : pulumi.Output.create<AttestationNote>(AttestationNote.fromMap((map['attestation'] as Map).cast<String, dynamic>())),
      build: map['build'] == null ? null : pulumi.Output.create<BuildNote>(BuildNote.fromMap((map['build'] as Map).cast<String, dynamic>())),
      compliance: map['compliance'] == null ? null : pulumi.Output.create<ComplianceNote>(ComplianceNote.fromMap((map['compliance'] as Map).cast<String, dynamic>())),
      deployment: map['deployment'] == null ? null : pulumi.Output.create<DeploymentNote>(DeploymentNote.fromMap((map['deployment'] as Map).cast<String, dynamic>())),
      discovery: map['discovery'] == null ? null : pulumi.Output.create<DiscoveryNote>(DiscoveryNote.fromMap((map['discovery'] as Map).cast<String, dynamic>())),
      dsseAttestation: map['dsseAttestation'] == null ? null : pulumi.Output.create<DSSEAttestationNote>(DSSEAttestationNote.fromMap((map['dsseAttestation'] as Map).cast<String, dynamic>())),
      expirationTime: map['expirationTime'] == null ? null : pulumi.Output.create<String>(map['expirationTime'] as String),
      image: map['image'] == null ? null : pulumi.Output.create<ImageNote>(ImageNote.fromMap((map['image'] as Map).cast<String, dynamic>())),
      ...
      package: map['package'] == null ? null : pulumi.Output.create<PackageNote>(PackageNote.fromMap((map['package'] as Map).cast<String, dynamic>())),
      ...
      relatedUrl: map['relatedUrl'] == null ? null : pulumi.Output.create<List<RelatedUrl>>(pulumi.Input.decodeList<RelatedUrl>(map['relatedUrl'], (value) => RelatedUrl.fromMap((value as Map).cast<String, dynamic>()))),
      sbomReference: map['sbomReference'] == null ? null : pulumi.Output.create<SBOMReferenceNote>(SBOMReferenceNote.fromMap((map['sbomReference'] as Map).cast<String, dynamic>())),
      shortDescription: map['shortDescription'] == null ? null : pulumi.Output.create<String>(map['shortDescription'] as String),
      upgrade: map['upgrade'] == null ? null : pulumi.Output.create<UpgradeNote>(UpgradeNote.fromMap((map['upgrade'] as Map).cast<String, dynamic>())),
      vulnerability: map['vulnerability'] == null ? null : pulumi.Output.create<VulnerabilityNote>(VulnerabilityNote.fromMap((map['vulnerability'] as Map).cast<String, dynamic>())),
      vulnerabilityAssessment: map['vulnerabilityAssessment'] == null ? null : pulumi.Output.create<VulnerabilityAssessmentNote>(VulnerabilityAssessmentNote.fromMap((map['vulnerabilityAssessment'] as Map).cast<String, dynamic>())),
    );
  }
}
