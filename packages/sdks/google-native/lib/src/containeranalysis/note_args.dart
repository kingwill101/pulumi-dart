...
class NoteArgs {
  ...
  factory NoteArgs.fromMap(Map<String, dynamic> map) {
    return NoteArgs(
      attestation: map['attestation'] == null ? null : (AttestationNote.fromMap((map['attestation']! as Map).cast<String, dynamic>())).input(),
      build: map['build'] == null ? null : (BuildNote.fromMap((map['build']! as Map).cast<String, dynamic>())).input(),
      compliance: map['compliance'] == null ? null : (ComplianceNote.fromMap((map['compliance']! as Map).cast<String, dynamic>())).input(),
      deployment: map['deployment'] == null ? null : (DeploymentNote.fromMap((map['deployment']! as Map).cast<String, dynamic>())).input(),
      discovery: map['discovery'] == null ? null : (DiscoveryNote.fromMap((map['discovery']! as Map).cast<String, dynamic>())).input(),
      dsseAttestation: map['dsseAttestation'] == null ? null : (DSSEAttestationNote.fromMap((map['dsseAttestation']! as Map).cast<String, dynamic>())).input(),
      expirationTime: map['expirationTime'] == null ? null : (map['expirationTime']! as String).input(),
      image: map['image'] == null ? null : (ImageNote.fromMap((map['image']! as Map).cast<String, dynamic>())).input(),
      longDescription: map['longDescription'] == null ? null : (map['longDescription']! as String).input(),
      noteId: (map['noteId'] as String).input(),
      package: map['package'] == null ? null : (PackageNote.fromMap((map['package']! as Map).cast<String, dynamic>())).input(),
      project: map['project'] == null ? null : (map['project']! as String).input(),
      relatedNoteNames: map['relatedNoteNames'] == null ? null : ((map['relatedNoteNames']! as List).cast<String>()).input(),
      relatedUrl: map['relatedUrl'] == null ? null : (pulumi.Input.decodeList<RelatedUrl>(map['relatedUrl']!, (value) => RelatedUrl.fromMap((value as Map).cast<String, dynamic>()))).input(),
      sbomReference: map['sbomReference'] == null ? null : (SBOMReferenceNote.fromMap((map['sbomReference']! as Map).cast<String, dynamic>())).input(),
      shortDescription: map['shortDescription'] == null ? null : (map['shortDescription']! as String).input(),
      upgrade: map['upgrade'] == null ? null : (UpgradeNote.fromMap((map['upgrade']! as Map).cast<String, dynamic>())).input(),
      vulnerability: map['vulnerability'] == null ? null : (VulnerabilityNote.fromMap((map['vulnerability']! as Map).cast<String, dynamic>())).input(),
      vulnerabilityAssessment: map['vulnerabilityAssessment'] == null ? null : (VulnerabilityAssessmentNote.fromMap((map['vulnerabilityAssessment']! as Map).cast<String, dynamic>())).input(),
    );
  }
}
