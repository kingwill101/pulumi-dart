...
class SlsaProvenanceZeroTwoResponseContaineranalysisV1alpha1 {
  ...
  factory SlsaProvenanceZeroTwoResponseContaineranalysisV1alpha1.fromMap(Map<String, dynamic> map) {
    return SlsaProvenanceZeroTwoResponseContaineranalysisV1alpha1(
      ...
      invocation: (GoogleDevtoolsContaineranalysisV1alpha1SlsaProvenanceZeroTwoSlsaInvocationResponse.fromMap((map['invocation'] as Map).cast<String, dynamic>())).input(),
      materials: (pulumi.Input.decodeList<GoogleDevtoolsContaineranalysisV1alpha1SlsaProvenanceZeroTwoSlsaMaterialResponse>(map['materials'], (value) => GoogleDevtoolsContaineranalysisV1alpha1SlsaProvenanceZeroTwoSlsaMaterialResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      metadata: (GoogleDevtoolsContaineranalysisV1alpha1SlsaProvenanceZeroTwoSlsaMetadataResponse.fromMap((map['metadata'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
