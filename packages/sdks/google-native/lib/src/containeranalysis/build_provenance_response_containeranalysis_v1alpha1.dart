...
class BuildProvenanceResponseContaineranalysisV1alpha1 {
  ...
  /// Output of the build.
  final pulumi.Input<List<ArtifactResponseContaineranalysisV1alpha1>>
  builtArtifacts;
    ...
    return <String, dynamic>{
      ...
      'builtArtifacts':
          pulumi.Input.mapInputValue<
            List<ArtifactResponseContaineranalysisV1alpha1>,
      ...
      'commands':
          pulumi.Input.mapInputValue<
            List<CommandResponseContaineranalysisV1alpha1>,
            List<Map<String, dynamic>>
          >(
            commands,
            (value) =>
  ...
  factory BuildProvenanceResponseContaineranalysisV1alpha1.fromMap(
    ...
    return BuildProvenanceResponseContaineranalysisV1alpha1(
      ...
      sourceProvenance: pulumi.Input.fromValue(
        SourceResponseContaineranalysisV1alpha1.fromMap(
