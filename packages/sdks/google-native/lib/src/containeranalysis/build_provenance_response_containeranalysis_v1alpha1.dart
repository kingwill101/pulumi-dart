...
class BuildProvenanceResponseContaineranalysisV1alpha1 {
  ...
  const BuildProvenanceResponseContaineranalysisV1alpha1({
  ...
  factory BuildProvenanceResponseContaineranalysisV1alpha1.fromMap(Map<String, dynamic> map) {
    return BuildProvenanceResponseContaineranalysisV1alpha1(
      ...
      builtArtifacts: pulumi.Input.fromValue(pulumi.Input.decodeList<ArtifactResponseContaineranalysisV1alpha1>(map['builtArtifacts']!, (value) => ArtifactResponseContaineranalysisV1alpha1.fromMap((value as Map).cast<String, dynamic>()))),
      commands: pulumi.Input.fromValue(pulumi.Input.decodeList<CommandResponseContaineranalysisV1alpha1>(map['commands']!, (value) => CommandResponseContaineranalysisV1alpha1.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      sourceProvenance: pulumi.Input.fromValue(SourceResponseContaineranalysisV1alpha1.fromMap((map['sourceProvenance']! as Map).cast<String, dynamic>())),
