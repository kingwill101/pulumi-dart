...
class BuildDetailsResponse {
  ...
  factory BuildDetailsResponse.fromMap(Map<String, dynamic> map) {
    return BuildDetailsResponse(
      inTotoSlsaProvenanceV1: pulumi.Input.fromValue(InTotoSlsaProvenanceV1ResponseContaineranalysisV1alpha1.fromMap((map['inTotoSlsaProvenanceV1']! as Map).cast<String, dynamic>())),
      intotoProvenance: pulumi.Input.fromValue(InTotoProvenanceResponseContaineranalysisV1alpha1.fromMap((map['intotoProvenance']! as Map).cast<String, dynamic>())),
      intotoStatement: pulumi.Input.fromValue(InTotoStatementResponseContaineranalysisV1alpha1.fromMap((map['intotoStatement']! as Map).cast<String, dynamic>())),
      provenance: pulumi.Input.fromValue(BuildProvenanceResponseContaineranalysisV1alpha1.fromMap((map['provenance']! as Map).cast<String, dynamic>())),
