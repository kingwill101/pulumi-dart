...
class BuildDetailsResponse {
  ...
  final pulumi.Input<InTotoSlsaProvenanceV1ResponseContaineranalysisV1alpha1>
  inTotoSlsaProvenanceV1;

  /// Deprecated. See InTotoStatement for the replacement. In-toto Provenance representation as defined in spec.
  final pulumi.Input<InTotoProvenanceResponseContaineranalysisV1alpha1>
  intotoProvenance;
  ...
  final pulumi.Input<BuildProvenanceResponseContaineranalysisV1alpha1>
  provenance;
    ...
    return <String, dynamic>{
      ...
      'intotoProvenance':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(intotoProvenance, (value) => value.toMap()),
      'intotoStatement':
          pulumi.Input.mapInputValue<
            InTotoStatementResponseContaineranalysisV1alpha1,
            Map<String, dynamic>
          >(intotoStatement, (value) => value.toMap()),
      'provenance':
          pulumi.Input.mapInputValue<
  ...
  factory BuildDetailsResponse.fromMap(Map<String, dynamic> map) {
    return BuildDetailsResponse(
      ...
      provenance: pulumi.Input.fromValue(
        BuildProvenanceResponseContaineranalysisV1alpha1.fromMap(
