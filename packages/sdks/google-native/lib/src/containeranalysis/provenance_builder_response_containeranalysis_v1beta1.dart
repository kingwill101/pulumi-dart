...
class ProvenanceBuilderResponseContaineranalysisV1beta1 {
  ...
  /// [version] Required.
  const ProvenanceBuilderResponseContaineranalysisV1beta1({
  ...
  factory ProvenanceBuilderResponseContaineranalysisV1beta1.fromMap(Map<String, dynamic> map) {
    return ProvenanceBuilderResponseContaineranalysisV1beta1(
      builderDependencies: pulumi.Input.fromValue(pulumi.Input.decodeList<ResourceDescriptorResponseContaineranalysisV1beta1>(map['builderDependencies']!, (value) => ResourceDescriptorResponseContaineranalysisV1beta1.fromMap((value as Map).cast<String, dynamic>()))),
