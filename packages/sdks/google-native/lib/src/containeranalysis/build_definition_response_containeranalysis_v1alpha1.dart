...
class BuildDefinitionResponseContaineranalysisV1alpha1 {
  ...
  final List<ResourceDescriptorResponseContaineranalysisV1alpha1> resolvedDependencies;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'resolvedDependencies': pulumi.Input.encodeList<ResourceDescriptorResponseContaineranalysisV1alpha1, Map<String, dynamic>>(resolvedDependencies, (value) => value.toMap()),
    };
  }
  ...
  factory BuildDefinitionResponseContaineranalysisV1alpha1.fromMap(Map<String, dynamic> map) {
    return BuildDefinitionResponseContaineranalysisV1alpha1(
      ...
      resolvedDependencies: pulumi.Input.decodeList<ResourceDescriptorResponseContaineranalysisV1alpha1>(map['resolvedDependencies'], (value) => ResourceDescriptorResponseContaineranalysisV1alpha1.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
