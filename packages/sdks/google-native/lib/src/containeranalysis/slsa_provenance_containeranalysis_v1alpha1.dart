...
class SlsaProvenanceContaineranalysisV1alpha1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'materials': ?materials == null ? null : pulumi.Input.encodeList<MaterialContaineranalysisV1alpha1, Map<String, dynamic>>(materials!, (value) => value.toMap()),
  ...
  factory SlsaProvenanceContaineranalysisV1alpha1.fromMap(Map<String, dynamic> map) {
    return SlsaProvenanceContaineranalysisV1alpha1(
      builder: map['builder'] == null ? null : SlsaBuilderContaineranalysisV1alpha1.fromMap((map['builder'] as Map).cast<String, dynamic>()),
      materials: map['materials'] == null ? null : pulumi.Input.decodeList<MaterialContaineranalysisV1alpha1>(map['materials'], (value) => MaterialContaineranalysisV1alpha1.fromMap((value as Map).cast<String, dynamic>())),
      metadata: map['metadata'] == null ? null : SlsaMetadataContaineranalysisV1alpha1.fromMap((map['metadata'] as Map).cast<String, dynamic>()),
      recipe: map['recipe'] == null ? null : SlsaRecipeContaineranalysisV1alpha1.fromMap((map['recipe'] as Map).cast<String, dynamic>()),
    );
  }
}
