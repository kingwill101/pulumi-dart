...
class UpgradeNoteResponseContaineranalysisV1alpha1 {
  ...
  factory UpgradeNoteResponseContaineranalysisV1alpha1.fromMap(Map<String, dynamic> map) {
    return UpgradeNoteResponseContaineranalysisV1alpha1(
      distributions: (pulumi.Input.decodeList<UpgradeDistributionResponseContaineranalysisV1alpha1>(map['distributions'], (value) => UpgradeDistributionResponseContaineranalysisV1alpha1.fromMap((value as Map).cast<String, dynamic>()))).input(),
