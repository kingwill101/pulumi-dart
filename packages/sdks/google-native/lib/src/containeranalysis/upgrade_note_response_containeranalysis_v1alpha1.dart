...
class UpgradeNoteResponseContaineranalysisV1alpha1 {
  ...
  final pulumi.Input<List<UpgradeDistributionResponseContaineranalysisV1alpha1>>
  distributions;
    ...
    return <String, dynamic>{
      'distributions':
          pulumi.Input.mapInputValue<
            List<UpgradeDistributionResponseContaineranalysisV1alpha1>,
  ...
  factory UpgradeNoteResponseContaineranalysisV1alpha1.fromMap(
