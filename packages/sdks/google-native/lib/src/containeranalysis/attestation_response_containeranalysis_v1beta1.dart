...
class AttestationResponseContaineranalysisV1beta1 {
  ...
  final PgpSignedAttestationResponseContaineranalysisV1beta1 pgpSignedAttestation;
  ...
  factory AttestationResponseContaineranalysisV1beta1.fromMap(Map<String, dynamic> map) {
    return AttestationResponseContaineranalysisV1beta1(
      genericSignedAttestation: GenericSignedAttestationResponse.fromMap((map['genericSignedAttestation'] as Map).cast<String, dynamic>()),
      pgpSignedAttestation: PgpSignedAttestationResponseContaineranalysisV1beta1.fromMap((map['pgpSignedAttestation'] as Map).cast<String, dynamic>()),
    );
  }
}
