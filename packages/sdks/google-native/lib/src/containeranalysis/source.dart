...
class Source {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'additionalContexts': ?additionalContexts == null ? null : pulumi.Input.encodeList<SourceContext, Map<String, dynamic>>(additionalContexts!, (value) => value.toMap()),
  ...
  factory Source.fromMap(Map<String, dynamic> map) {
    return Source(
      additionalContexts: map['additionalContexts'] == null ? null : pulumi.Input.decodeList<SourceContext>(map['additionalContexts'], (value) => SourceContext.fromMap((value as Map).cast<String, dynamic>())),
      artifactStorageSourceUri: map['artifactStorageSourceUri'] == null ? null : map['artifactStorageSourceUri'] as String,
      context: map['context'] == null ? null : SourceContext.fromMap((map['context'] as Map).cast<String, dynamic>()),
