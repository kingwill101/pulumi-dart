...
class Source {
  ...
  factory Source.fromMap(Map<String, dynamic> map) {
    return Source(
      additionalContexts: (() { final guardedValue = map['additionalContexts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SourceContext>(guardedValue, (value) => SourceContext.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      context: (() { final guardedValue = map['context']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SourceContext.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
