...
class AssessmentContaineranalysisV1alpha1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'state': ?pulumi.Input.mapOptionalInputValue<AssessmentStateContaineranalysisV1alpha1, String>(state, (value) => value.wireValue),
  ...
  factory AssessmentContaineranalysisV1alpha1.fromMap(Map<String, dynamic> map) {
    return AssessmentContaineranalysisV1alpha1(
      ...
      state: (() { final guardedValue = map['state']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AssessmentStateContaineranalysisV1alpha1.fromValue(guardedValue as String)); })(),
