...
class PgpSignedAttestationResponse {
  ...
  /// Creates a new [PgpSignedAttestationResponse].
  ...
  const PgpSignedAttestationResponse({
  ...
  factory PgpSignedAttestationResponse.fromMap(Map<String, dynamic> map) {
    return PgpSignedAttestationResponse(
