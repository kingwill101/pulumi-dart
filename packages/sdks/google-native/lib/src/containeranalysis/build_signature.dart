...
class BuildSignature {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'keyId': ?keyId,
      'keyType': ?pulumi.Input.mapOptionalInputValue<BuildSignatureKeyType, String>(keyType, (value) => value.wireValue),
      'publicKey': ?publicKey,
      'signature': ?signature,
    };
  }
  ...
  factory BuildSignature.fromMap(Map<String, dynamic> map) {
    return BuildSignature(
      ...
      keyType: (() { final guardedValue = map['keyType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BuildSignatureKeyType.fromValue(guardedValue as String)); })(),
