...
class ProvenanceBuilderContaineranalysisV1alpha1 {
  ...
  /// [id] Optional.
  /// [version] Optional.
  const ProvenanceBuilderContaineranalysisV1alpha1({
  ...
  factory ProvenanceBuilderContaineranalysisV1alpha1.fromMap(Map<String, dynamic> map) {
    return ProvenanceBuilderContaineranalysisV1alpha1(
      builderDependencies: (() { final guardedValue = map['builderDependencies']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ResourceDescriptorContaineranalysisV1alpha1>(guardedValue, (value) => ResourceDescriptorContaineranalysisV1alpha1.fromMap((value as Map).cast<String, dynamic>()))); })(),
