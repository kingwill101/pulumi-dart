...
class ProviderNoteIamPolicy extends pulumi.CustomResource {
  ...
  /// Creates a new [ProviderNoteIamPolicy].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ProviderNoteIamPolicy]. {@macro pulumi_containeranalysis_v1alpha1_provider_note_iam_policy_args_doc}
