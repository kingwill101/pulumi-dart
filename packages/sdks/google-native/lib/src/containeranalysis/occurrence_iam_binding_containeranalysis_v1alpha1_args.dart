...
/// {@template pulumi_containeranalysis_v1alpha1_occurrence_iam_binding_containeranalysis_v1alpha1_args_doc}
/// The set of arguments for OccurrenceIamBinding.
/// {@endtemplate}
/// {@macro pulumi_containeranalysis_v1alpha1_occurrence_iam_binding_containeranalysis_v1alpha1_args_doc}
class OccurrenceIamBindingContaineranalysisV1alpha1Args {
  ...
  /// Creates a new [OccurrenceIamBindingContaineranalysisV1alpha1Args].
  ...
  const OccurrenceIamBindingContaineranalysisV1alpha1Args({
    this.condition,
  ...
  factory OccurrenceIamBindingContaineranalysisV1alpha1Args.fromMap(Map<String, dynamic> map) {
    return OccurrenceIamBindingContaineranalysisV1alpha1Args(
