...
class PackageContaineranalysisV1beta1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'architecture': ?pulumi.Input.mapOptionalInputValue<PackageArchitectureContaineranalysisV1beta1, String>(architecture, (value) => value.wireValue),
      'cpeUri': ?cpeUri,
  ...
  factory PackageContaineranalysisV1beta1.fromMap(Map<String, dynamic> map) {
    return PackageContaineranalysisV1beta1(
      architecture: (() { final guardedValue = map['architecture']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PackageArchitectureContaineranalysisV1beta1.fromValue(guardedValue as String)); })(),
      ...
      digest: (() { final guardedValue = map['digest']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DigestContaineranalysisV1beta1>(guardedValue, (value) => DigestContaineranalysisV1beta1.fromMap((value as Map).cast<String, dynamic>()))); })(),
      distribution: (() { final guardedValue = map['distribution']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DistributionContaineranalysisV1beta1>(guardedValue, (value) => DistributionContaineranalysisV1beta1.fromMap((value as Map).cast<String, dynamic>()))); })(),
      license: (() { final guardedValue = map['license']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LicenseContaineranalysisV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
