...
class CVSSContaineranalysisV1beta1 {
  ...
  final pulumi.Input<CVSSAttackComplexityContaineranalysisV1beta1>?
  attackComplexity;
  ...
  /// Defined in CVSS v2
  final pulumi.Input<CVSSAuthenticationContaineranalysisV1beta1>?
  authentication;

  /// Defined in CVSS v3, CVSS v2
  final pulumi.Input<CVSSAvailabilityImpactContaineranalysisV1beta1>?
  availabilityImpact;
  ...
  /// Defined in CVSS v3, CVSS v2
  final pulumi.Input<CVSSConfidentialityImpactContaineranalysisV1beta1>?
  confidentialityImpact;
  final pulumi.Input<double>? exploitabilityScore;
  final pulumi.Input<double>? impactScore;

  /// Defined in CVSS v3, CVSS v2
  final pulumi.Input<CVSSIntegrityImpactContaineranalysisV1beta1>?
  integrityImpact;

  /// Defined in CVSS v3
  final pulumi.Input<CVSSPrivilegesRequiredContaineranalysisV1beta1>?
  privilegesRequired;
  ...
  /// Defined in CVSS v3
  final pulumi.Input<CVSSUserInteractionContaineranalysisV1beta1>?
  userInteraction;
    ...
    return <String, dynamic>{
      'attackComplexity':
          ?pulumi.Input.mapOptionalInputValue<
            CVSSAttackComplexityContaineranalysisV1beta1,
            String
          >(attackComplexity, (value) => value.wireValue),
      'attackVector':
          ?pulumi.Input.mapOptionalInputValue<
            CVSSAttackVectorContaineranalysisV1beta1,
            String
          >(attackVector, (value) => value.wireValue),
      'authentication':
          ?pulumi.Input.mapOptionalInputValue<
            CVSSAuthenticationContaineranalysisV1beta1,
            String
          >(authentication, (value) => value.wireValue),
      'availabilityImpact':
          ?pulumi.Input.mapOptionalInputValue<
            CVSSAvailabilityImpactContaineranalysisV1beta1,
            String
          >(availabilityImpact, (value) => value.wireValue),
      'baseScore': ?baseScore,
      'confidentialityImpact':
          ?pulumi.Input.mapOptionalInputValue<
            CVSSConfidentialityImpactContaineranalysisV1beta1,
            String
      ...
      'integrityImpact':
          ?pulumi.Input.mapOptionalInputValue<
            CVSSIntegrityImpactContaineranalysisV1beta1,
            String
          >(integrityImpact, (value) => value.wireValue),
      'privilegesRequired':
          ?pulumi.Input.mapOptionalInputValue<
            CVSSPrivilegesRequiredContaineranalysisV1beta1,
            String
          >(privilegesRequired, (value) => value.wireValue),
      'scope':
          ?pulumi.Input.mapOptionalInputValue<
            CVSSScopeContaineranalysisV1beta1,
            String
          >(scope, (value) => value.wireValue),
      'userInteraction':
          ?pulumi.Input.mapOptionalInputValue<
            CVSSUserInteractionContaineranalysisV1beta1,
            String
  ...
  factory CVSSContaineranalysisV1beta1.fromMap(Map<String, dynamic> map) {
    return CVSSContaineranalysisV1beta1(
      ...
      scope: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CVSSScopeContaineranalysisV1beta1.fromValue(guardedValue as String),
        );
      })(),
      userInteraction: (() {
