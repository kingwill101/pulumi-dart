...
/// {@template pulumi_containeranalysis_v1_occurrence_iam_binding_args_doc}
/// The set of arguments for OccurrenceIamBinding.
/// {@endtemplate}
/// {@macro pulumi_containeranalysis_v1_occurrence_iam_binding_args_doc}
class OccurrenceIamBindingArgs {
  ...
  /// Creates a new [OccurrenceIamBindingArgs].
  ...
  const OccurrenceIamBindingArgs({
    this.condition,
  ...
  factory OccurrenceIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return OccurrenceIamBindingArgs(
