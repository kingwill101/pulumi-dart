...
class RecipeContaineranalysisV1alpha1 {
  ...
  /// Creates a new [RecipeContaineranalysisV1alpha1].
  ...
  RecipeContaineranalysisV1alpha1({
    this.arguments,
  ...
  factory RecipeContaineranalysisV1alpha1.fromMap(Map<String, dynamic> map) {
    return RecipeContaineranalysisV1alpha1(
      arguments: map['arguments'] == null ? null : (map['arguments'] as List).cast<Map<String, String>>(),
      definedInMaterial: map['definedInMaterial'] == null ? null : map['definedInMaterial'] as String,
      entryPoint: map['entryPoint'] == null ? null : map['entryPoint'] as String,
      environment: map['environment'] == null ? null : (map['environment'] as List).cast<Map<String, String>>(),
