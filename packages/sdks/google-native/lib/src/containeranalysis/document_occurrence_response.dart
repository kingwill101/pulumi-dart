...
class DocumentOccurrenceResponse {
  ...
  /// Creates a new [DocumentOccurrenceResponse].
  ...
  factory DocumentOccurrenceResponse.fromMap(Map<String, dynamic> map) {
    return DocumentOccurrenceResponse(
      createTime: pulumi.Input.fromValue(map['createTime'] as String),
      creatorComment: pulumi.Input.fromValue(map['creatorComment'] as String),
      creators: pulumi.Input.fromValue((map['creators'] as List).cast<String>()),
      documentComment: pulumi.Input.fromValue(map['documentComment'] as String),
      externalDocumentRefs: pulumi.Input.fromValue((map['externalDocumentRefs'] as List).cast<String>()),
      licenseListVersion: pulumi.Input.fromValue(map['licenseListVersion'] as String),
