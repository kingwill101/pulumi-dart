...
class SlsaProvenanceResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'recipe':
          pulumi.Input.mapInputValue<SlsaRecipeResponse, Map<String, dynamic>>(
            recipe,
            (value) => value.toMap(),
          ),
    };
  ...
  factory SlsaProvenanceResponse.fromMap(Map<String, dynamic> map) {
    return SlsaProvenanceResponse(
      ...
      materials: pulumi.Input.fromValue(
        pulumi.Input.decodeList<MaterialResponse>(
          map['materials']!,
          (value) =>
      ...
      metadata: pulumi.Input.fromValue(
        SlsaMetadataResponse.fromMap(
          (map['metadata']! as Map).cast<String, dynamic>(),
        ),
      ),
      recipe: pulumi.Input.fromValue(
        SlsaRecipeResponse.fromMap(
