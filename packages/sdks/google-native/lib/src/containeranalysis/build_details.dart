...
class BuildDetails {
  ...
  final pulumi.Input<InTotoSlsaProvenanceV1ContaineranalysisV1alpha1>?
  inTotoSlsaProvenanceV1;

  /// Deprecated. See InTotoStatement for the replacement. In-toto Provenance representation as defined in spec.
  final pulumi.Input<InTotoProvenanceContaineranalysisV1alpha1>?
  intotoProvenance;
  ...
  factory BuildDetails.fromMap(Map<String, dynamic> map) {
    return BuildDetails(
      inTotoSlsaProvenanceV1: (() {
        final guardedValue = map['inTotoSlsaProvenanceV1'];
      ...
      intotoProvenance: (() {
        final guardedValue = map['intotoProvenance'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      intotoStatement: (() {
        final guardedValue = map['intotoStatement'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      provenanceBytes: (() {
        final guardedValue = map['provenanceBytes'];
        if (guardedValue == null) return null;
