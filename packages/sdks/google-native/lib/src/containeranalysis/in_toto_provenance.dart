...
class InTotoProvenance {
  ...
  factory InTotoProvenance.fromMap(Map<String, dynamic> map) {
    return InTotoProvenance(
      builderConfig: map['builderConfig'] == null ? null : BuilderConfig.fromMap((map['builderConfig'] as Map).cast<String, dynamic>()),
      ...
      recipe: map['recipe'] == null ? null : Recipe.fromMap((map['recipe'] as Map).cast<String, dynamic>()),
    );
  }
}
