...
class InTotoProvenance {
  ...
  factory InTotoProvenance.fromMap(Map<String, dynamic> map) {
    return InTotoProvenance(
      builderConfig: (() { final guardedValue = map['builderConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BuilderConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      recipe: (() { final guardedValue = map['recipe']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Recipe.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
