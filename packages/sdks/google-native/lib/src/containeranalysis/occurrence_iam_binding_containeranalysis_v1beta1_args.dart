...
/// {@template pulumi_containeranalysis_v1beta1_occurrence_iam_binding_containeranalysis_v1beta1_args_doc}
/// The set of arguments for OccurrenceIamBinding.
/// {@endtemplate}
/// {@macro pulumi_containeranalysis_v1beta1_occurrence_iam_binding_containeranalysis_v1beta1_args_doc}
class OccurrenceIamBindingContaineranalysisV1beta1Args {
  ...
  /// Creates a new [OccurrenceIamBindingContaineranalysisV1beta1Args].
  ...
  const OccurrenceIamBindingContaineranalysisV1beta1Args({
    this.condition,
  ...
  factory OccurrenceIamBindingContaineranalysisV1beta1Args.fromMap(Map<String, dynamic> map) {
    return OccurrenceIamBindingContaineranalysisV1beta1Args(
