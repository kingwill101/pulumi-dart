...
class PackageIssueResponse {
    ...
    return <String, dynamic>{
      ...
      'fileLocation':
          pulumi.Input.mapInputValue<
            List<GrafeasV1FileLocationResponse>,
  ...
  factory PackageIssueResponse.fromMap(Map<String, dynamic> map) {
    return PackageIssueResponse(
      ...
      affectedVersion: pulumi.Input.fromValue(
      ...
      fileLocation: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GrafeasV1FileLocationResponse>(
          map['fileLocation']!,
      ...
      fixedVersion: pulumi.Input.fromValue(
        VersionResponse.fromMap(
