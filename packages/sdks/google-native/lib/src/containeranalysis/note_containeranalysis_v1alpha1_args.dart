  ...
  factory NoteContaineranalysisV1alpha1Args.fromMap(Map<String, dynamic> map) {
    return NoteContaineranalysisV1alpha1Args(
      ...
      baseImage: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          Basis.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      buildType: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          BuildType.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      compliance: (() {
      ...
      deployable: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          Deployable.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      discovery: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          Discovery.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      dsseAttestation: (() {
      ...
      package: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          Package.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      project: (() {
      ...
      sbom: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DocumentNote.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      sbomReference: (() {
      ...
      spdxFile: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FileNote.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      spdxPackage: (() {
      ...
      vulnerabilityType: (() {
        final guardedValue = map['vulnerabilityType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
