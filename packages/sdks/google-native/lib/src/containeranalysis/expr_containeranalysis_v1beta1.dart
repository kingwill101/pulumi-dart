...
class ExprContaineranalysisV1beta1 {
  ...
  /// Creates a new [ExprContaineranalysisV1beta1].
  ...
  const ExprContaineranalysisV1beta1({
    this.description,
    this.expression,
    this.location,
    this.title,
  ...
  factory ExprContaineranalysisV1beta1.fromMap(Map<String, dynamic> map) {
    return ExprContaineranalysisV1beta1(
