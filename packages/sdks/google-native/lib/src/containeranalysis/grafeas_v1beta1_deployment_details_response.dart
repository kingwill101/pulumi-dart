...
class GrafeasV1beta1DeploymentDetailsResponse {
  ...
  const GrafeasV1beta1DeploymentDetailsResponse({
  ...
  factory GrafeasV1beta1DeploymentDetailsResponse.fromMap(Map<String, dynamic> map) {
    return GrafeasV1beta1DeploymentDetailsResponse(
      deployment: pulumi.Input.fromValue(DeploymentResponseContaineranalysisV1beta1.fromMap((map['deployment']! as Map).cast<String, dynamic>())),
    );
  }
}
