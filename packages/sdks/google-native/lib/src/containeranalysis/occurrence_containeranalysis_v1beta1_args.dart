...
class OccurrenceContaineranalysisV1beta1Args {
  ...
  factory OccurrenceContaineranalysisV1beta1Args.fromMap(Map<String, dynamic> map) {
    return OccurrenceContaineranalysisV1beta1Args(
      attestation: (() { final guardedValue = map['attestation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Details.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      build: (() { final guardedValue = map['build']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GrafeasV1beta1BuildDetails.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      deployment: (() { final guardedValue = map['deployment']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GrafeasV1beta1DeploymentDetails.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      derivedImage: (() { final guardedValue = map['derivedImage']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GrafeasV1beta1ImageDetails.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      discovered: (() { final guardedValue = map['discovered']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GrafeasV1beta1DiscoveryDetails.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      envelope: (() { final guardedValue = map['envelope']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EnvelopeContaineranalysisV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      installation: (() { final guardedValue = map['installation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GrafeasV1beta1PackageDetails.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      intoto: (() { final guardedValue = map['intoto']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GrafeasV1beta1IntotoDetails.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      resource: pulumi.Input.fromValue(ResourceContaineranalysisV1beta1.fromMap((map['resource']! as Map).cast<String, dynamic>())),
      sbom: (() { final guardedValue = map['sbom']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DocumentOccurrenceContaineranalysisV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      sbomReference: (() { final guardedValue = map['sbomReference']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SBOMReferenceOccurrenceContaineranalysisV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      spdxFile: (() { final guardedValue = map['spdxFile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FileOccurrenceContaineranalysisV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      spdxPackage: (() { final guardedValue = map['spdxPackage']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PackageInfoOccurrenceContaineranalysisV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      spdxRelationship: (() { final guardedValue = map['spdxRelationship']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RelationshipOccurrenceContaineranalysisV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      vulnerability: (() { final guardedValue = map['vulnerability']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GrafeasV1beta1VulnerabilityDetails.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
