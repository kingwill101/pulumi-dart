...
class OccurrenceContaineranalysisV1beta1Args {
  ...
  factory OccurrenceContaineranalysisV1beta1Args.fromMap(Map<String, dynamic> map) {
    return OccurrenceContaineranalysisV1beta1Args(
      attestation: map['attestation'] == null ? null : (Details.fromMap((map['attestation']! as Map).cast<String, dynamic>())).input(),
      build: map['build'] == null ? null : (GrafeasV1beta1BuildDetails.fromMap((map['build']! as Map).cast<String, dynamic>())).input(),
      deployment: map['deployment'] == null ? null : (GrafeasV1beta1DeploymentDetails.fromMap((map['deployment']! as Map).cast<String, dynamic>())).input(),
      derivedImage: map['derivedImage'] == null ? null : (GrafeasV1beta1ImageDetails.fromMap((map['derivedImage']! as Map).cast<String, dynamic>())).input(),
      discovered: map['discovered'] == null ? null : (GrafeasV1beta1DiscoveryDetails.fromMap((map['discovered']! as Map).cast<String, dynamic>())).input(),
      envelope: map['envelope'] == null ? null : (EnvelopeContaineranalysisV1beta1.fromMap((map['envelope']! as Map).cast<String, dynamic>())).input(),
      installation: map['installation'] == null ? null : (GrafeasV1beta1PackageDetails.fromMap((map['installation']! as Map).cast<String, dynamic>())).input(),
      intoto: map['intoto'] == null ? null : (GrafeasV1beta1IntotoDetails.fromMap((map['intoto']! as Map).cast<String, dynamic>())).input(),
      noteName: (map['noteName'] as String).input(),
      project: map['project'] == null ? null : (map['project']! as String).input(),
      remediation: map['remediation'] == null ? null : (map['remediation']! as String).input(),
      resource: (ResourceContaineranalysisV1beta1.fromMap((map['resource'] as Map).cast<String, dynamic>())).input(),
      sbom: map['sbom'] == null ? null : (DocumentOccurrenceContaineranalysisV1beta1.fromMap((map['sbom']! as Map).cast<String, dynamic>())).input(),
      sbomReference: map['sbomReference'] == null ? null : (SBOMReferenceOccurrenceContaineranalysisV1beta1.fromMap((map['sbomReference']! as Map).cast<String, dynamic>())).input(),
      spdxFile: map['spdxFile'] == null ? null : (FileOccurrenceContaineranalysisV1beta1.fromMap((map['spdxFile']! as Map).cast<String, dynamic>())).input(),
      spdxPackage: map['spdxPackage'] == null ? null : (PackageInfoOccurrenceContaineranalysisV1beta1.fromMap((map['spdxPackage']! as Map).cast<String, dynamic>())).input(),
      spdxRelationship: map['spdxRelationship'] == null ? null : (RelationshipOccurrenceContaineranalysisV1beta1.fromMap((map['spdxRelationship']! as Map).cast<String, dynamic>())).input(),
      vulnerability: map['vulnerability'] == null ? null : (GrafeasV1beta1VulnerabilityDetails.fromMap((map['vulnerability']! as Map).cast<String, dynamic>())).input(),
    );
  }
}
