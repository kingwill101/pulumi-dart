...
class DetailContaineranalysisV1beta1 {
  ...
  factory DetailContaineranalysisV1beta1.fromMap(Map<String, dynamic> map) {
    return DetailContaineranalysisV1beta1(
      ...
      fixedLocation: (() { final guardedValue = map['fixedLocation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VulnerabilityLocationContaineranalysisV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      maxAffectedVersion: (() { final guardedValue = map['maxAffectedVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VersionContaineranalysisV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      minAffectedVersion: (() { final guardedValue = map['minAffectedVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VersionContaineranalysisV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
