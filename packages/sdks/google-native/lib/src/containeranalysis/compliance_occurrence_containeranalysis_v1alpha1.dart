...
class ComplianceOccurrenceContaineranalysisV1alpha1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'nonCompliantFiles': ?nonCompliantFiles == null ? null : pulumi.Input.encodeList<NonCompliantFileContaineranalysisV1alpha1, Map<String, dynamic>>(nonCompliantFiles!, (value) => value.toMap()),
    };
  }
  ...
  factory ComplianceOccurrenceContaineranalysisV1alpha1.fromMap(Map<String, dynamic> map) {
    return ComplianceOccurrenceContaineranalysisV1alpha1(
      ...
      nonCompliantFiles: map['nonCompliantFiles'] == null ? null : pulumi.Input.decodeList<NonCompliantFileContaineranalysisV1alpha1>(map['nonCompliantFiles'], (value) => NonCompliantFileContaineranalysisV1alpha1.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
