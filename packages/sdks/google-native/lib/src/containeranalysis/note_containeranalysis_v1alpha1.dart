...
class NoteContaineranalysisV1alpha1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<RelatedUrlResponseContaineranalysisV1alpha1>> relatedUrl;
  ...
  NoteContaineranalysisV1alpha1(
    ...
    this.attestationAuthority = registerOutput<AttestationAuthorityResponse>('attestationAuthority');
    this.baseImage = registerOutput<BasisResponse>('baseImage');
    this.buildType = registerOutput<BuildTypeResponse>('buildType');
    this.compliance = registerOutput<ComplianceNoteResponseContaineranalysisV1alpha1>('compliance');
    ...
    this.dsseAttestation = registerOutput<DSSEAttestationNoteResponseContaineranalysisV1alpha1>('dsseAttestation');
    ...
    this.relatedUrl = registerOutput<List<RelatedUrlResponseContaineranalysisV1alpha1>>('relatedUrl');
    this.sbom = registerOutput<DocumentNoteResponse>('sbom');
    this.sbomReference = registerOutput<SBOMReferenceNoteResponseContaineranalysisV1alpha1>('sbomReference');
    ...
    this.spdxRelationship = registerOutput<RelationshipNoteResponse>('spdxRelationship');
    this.updateTime = registerOutput<String>('updateTime');
    this.upgrade = registerOutput<UpgradeNoteResponseContaineranalysisV1alpha1>('upgrade');
    this.vulnerabilityAssessment = registerOutput<VulnerabilityAssessmentNoteResponseContaineranalysisV1alpha1>('vulnerabilityAssessment');
    this.vulnerabilityType = registerOutput<VulnerabilityTypeResponse>('vulnerabilityType');
  }
}
