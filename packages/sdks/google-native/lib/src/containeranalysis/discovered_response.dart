...
class DiscoveredResponse {
  ...
  final pulumi.Input<AnalysisCompletedResponseContaineranalysisV1alpha1>
  analysisCompleted;

  /// Indicates any errors encountered during analysis of a resource. There could be 0 or more of these errors.
  final pulumi.Input<List<StatusResponseContaineranalysisV1alpha1>>
  analysisError;
  ...
  final pulumi.Input<StatusResponseContaineranalysisV1alpha1>
  analysisStatusError;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'analysisError':
          pulumi.Input.mapInputValue<
            List<StatusResponseContaineranalysisV1alpha1>,
      ...
      'operation':
          pulumi.Input.mapInputValue<OperationResponse, Map<String, dynamic>>(
            operation,
            (value) => value.toMap(),
          ),
      'sbomStatus':
  ...
  factory DiscoveredResponse.fromMap(Map<String, dynamic> map) {
    return DiscoveredResponse(
      ...
      analysisStatusError: pulumi.Input.fromValue(
        StatusResponseContaineranalysisV1alpha1.fromMap(
      ...
      operation: pulumi.Input.fromValue(
        OperationResponse.fromMap(
          (map['operation']! as Map).cast<String, dynamic>(),
        ),
      ),
      sbomStatus: pulumi.Input.fromValue(
        SBOMStatusResponseContaineranalysisV1alpha1.fromMap(
