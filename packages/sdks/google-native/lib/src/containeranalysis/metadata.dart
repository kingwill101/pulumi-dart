...
class Metadata {
  ...
  factory Metadata.fromMap(Map<String, dynamic> map) {
    return Metadata(
      ...
      completeness: (() { final guardedValue = map['completeness']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Completeness.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
