...
class PgpSignedAttestation {
  ...
  final pulumi.Input<String>? pgpKeyId;
  ...
  /// Creates a new [PgpSignedAttestation].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'contentType': ?pulumi.Input.mapOptionalInputValue<PgpSignedAttestationContentType, String>(contentType, (value) => value.wireValue),
      'pgpKeyId': ?pgpKeyId,
      'signature': ?signature,
    };
  }
  ...
  factory PgpSignedAttestation.fromMap(Map<String, dynamic> map) {
    return PgpSignedAttestation(
      contentType: (() { final guardedValue = map['contentType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PgpSignedAttestationContentType.fromValue(guardedValue as String)); })(),
      pgpKeyId: (() { final guardedValue = map['pgpKeyId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
