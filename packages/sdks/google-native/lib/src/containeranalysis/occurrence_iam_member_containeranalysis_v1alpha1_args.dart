...
/// {@template pulumi_containeranalysis_v1alpha1_occurrence_iam_member_containeranalysis_v1alpha1_args_doc}
/// The set of arguments for OccurrenceIamMember.
/// {@endtemplate}
/// {@macro pulumi_containeranalysis_v1alpha1_occurrence_iam_member_containeranalysis_v1alpha1_args_doc}
class OccurrenceIamMemberContaineranalysisV1alpha1Args {
  ...
  /// Creates a new [OccurrenceIamMemberContaineranalysisV1alpha1Args].
  ...
  const OccurrenceIamMemberContaineranalysisV1alpha1Args({
    this.condition,
  ...
  factory OccurrenceIamMemberContaineranalysisV1alpha1Args.fromMap(Map<String, dynamic> map) {
    return OccurrenceIamMemberContaineranalysisV1alpha1Args(
