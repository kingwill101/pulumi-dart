...
class InTotoSlsaProvenanceV1ContaineranalysisV1beta1 {
  ...
  const InTotoSlsaProvenanceV1ContaineranalysisV1beta1({
    this.predicate,
    this.predicateType,
    this.subject,
    this.type,
  ...
  factory InTotoSlsaProvenanceV1ContaineranalysisV1beta1.fromMap(Map<String, dynamic> map) {
    return InTotoSlsaProvenanceV1ContaineranalysisV1beta1(
      predicate: (() { final guardedValue = map['predicate']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SlsaProvenanceV1ContaineranalysisV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
