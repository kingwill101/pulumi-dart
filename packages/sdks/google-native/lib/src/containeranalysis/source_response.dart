...
class SourceResponse {
  ...
  factory SourceResponse.fromMap(Map<String, dynamic> map) {
    return SourceResponse(
      additionalContexts: (pulumi.Input.decodeList<SourceContextResponse>(map['additionalContexts'], (value) => SourceContextResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      artifactStorageSourceUri: (map['artifactStorageSourceUri'] as String).input(),
      context: (SourceContextResponse.fromMap((map['context'] as Map).cast<String, dynamic>())).input(),
