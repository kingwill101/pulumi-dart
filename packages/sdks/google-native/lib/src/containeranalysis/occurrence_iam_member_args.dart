...
/// {@template pulumi_containeranalysis_v1_occurrence_iam_member_args_doc}
/// The set of arguments for OccurrenceIamMember.
/// {@endtemplate}
/// {@macro pulumi_containeranalysis_v1_occurrence_iam_member_args_doc}
class OccurrenceIamMemberArgs {
  ...
  /// Creates a new [OccurrenceIamMemberArgs].
  ...
  factory OccurrenceIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return OccurrenceIamMemberArgs(
