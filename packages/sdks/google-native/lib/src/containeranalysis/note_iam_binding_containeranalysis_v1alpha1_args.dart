...
/// {@template pulumi_containeranalysis_v1alpha1_note_iam_binding_containeranalysis_v1alpha1_args_doc}
/// The set of arguments for NoteIamBinding.
/// {@endtemplate}
/// {@macro pulumi_containeranalysis_v1alpha1_note_iam_binding_containeranalysis_v1alpha1_args_doc}
class NoteIamBindingContaineranalysisV1alpha1Args {
  ...
  /// Creates a new [NoteIamBindingContaineranalysisV1alpha1Args].
  ...
  const NoteIamBindingContaineranalysisV1alpha1Args({
    this.condition,
  ...
  factory NoteIamBindingContaineranalysisV1alpha1Args.fromMap(Map<String, dynamic> map) {
    return NoteIamBindingContaineranalysisV1alpha1Args(
