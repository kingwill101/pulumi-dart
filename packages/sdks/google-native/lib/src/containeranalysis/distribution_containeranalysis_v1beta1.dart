...
class DistributionContaineranalysisV1beta1 {
  ...
  const DistributionContaineranalysisV1beta1({
    this.architecture,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'architecture': ?pulumi.Input.mapOptionalInputValue<DistributionArchitectureContaineranalysisV1beta1, String>(architecture, (value) => value.wireValue),
      'cpeUri': cpeUri,
  ...
  factory DistributionContaineranalysisV1beta1.fromMap(Map<String, dynamic> map) {
    return DistributionContaineranalysisV1beta1(
      architecture: (() { final guardedValue = map['architecture']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DistributionArchitectureContaineranalysisV1beta1.fromValue(guardedValue as String)); })(),
      cpeUri: pulumi.Input.fromValue(map['cpeUri'] as String),
      description: (() { final guardedValue = map['description']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      latestVersion: (() { final guardedValue = map['latestVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VersionContaineranalysisV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
