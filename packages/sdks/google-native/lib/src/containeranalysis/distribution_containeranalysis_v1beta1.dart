...
class DistributionContaineranalysisV1beta1 {
  ...
  final pulumi.Input<DistributionArchitectureContaineranalysisV1beta1>?
  architecture;
    ...
    return <String, dynamic>{
      'architecture':
          ?pulumi.Input.mapOptionalInputValue<
            DistributionArchitectureContaineranalysisV1beta1,
            String
  ...
  factory DistributionContaineranalysisV1beta1.fromMap(
    ...
    return DistributionContaineranalysisV1beta1(
      architecture: (() {
        ...
        return pulumi.Input.fromValue(
          DistributionArchitectureContaineranalysisV1beta1.fromValue(
      ...
      maintainer: (() {
        final guardedValue = map['maintainer'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      url: (() {
