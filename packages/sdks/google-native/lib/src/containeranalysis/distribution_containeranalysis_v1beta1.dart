...
class DistributionContaineranalysisV1beta1 {
  ...
  final DistributionArchitectureContaineranalysisV1beta1? architecture;
  /// The cpe_uri in [CPE format](https://cpe.mitre.org/specification/) denoting the package manager version distributing a package.
  final String cpeUri;
  /// The distribution channel-specific description of this package.
  final String? description;
  /// The latest available version of this package in this distribution channel.
  final VersionContaineranalysisV1beta1? latestVersion;
  ...
  factory DistributionContaineranalysisV1beta1.fromMap(Map<String, dynamic> map) {
    return DistributionContaineranalysisV1beta1(
      architecture: map['architecture'] == null ? null : DistributionArchitectureContaineranalysisV1beta1.fromValue(map['architecture'] as String),
      cpeUri: map['cpeUri'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      latestVersion: map['latestVersion'] == null ? null : VersionContaineranalysisV1beta1.fromMap((map['latestVersion'] as Map).cast<String, dynamic>()),
