...
class BuildProvenanceResponseContaineranalysisV1beta1 {
  ...
  /// Output of the build.
  final pulumi.Input<List<ArtifactResponseContaineranalysisV1beta1>>
  builtArtifacts;
    ...
    return <String, dynamic>{
      ...
      'builtArtifacts':
          pulumi.Input.mapInputValue<
            List<ArtifactResponseContaineranalysisV1beta1>,
      ...
      'commands':
          pulumi.Input.mapInputValue<
            List<CommandResponseContaineranalysisV1beta1>,
            List<Map<String, dynamic>>
          >(
            commands,
            (value) =>
  ...
  factory BuildProvenanceResponseContaineranalysisV1beta1.fromMap(
    ...
    return BuildProvenanceResponseContaineranalysisV1beta1(
      ...
      sourceProvenance: pulumi.Input.fromValue(
        SourceResponseContaineranalysisV1beta1.fromMap(
