...
class AssessmentResponseContaineranalysisV1alpha1 {
  ...
  factory AssessmentResponseContaineranalysisV1alpha1.fromMap(Map<String, dynamic> map) {
    return AssessmentResponseContaineranalysisV1alpha1(
      ...
      justification: (JustificationResponseContaineranalysisV1alpha1.fromMap((map['justification'] as Map).cast<String, dynamic>())).input(),
      longDescription: (map['longDescription'] as String).input(),
      relatedUris: (pulumi.Input.decodeList<URIResponse>(map['relatedUris'], (value) => URIResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      remediations: (pulumi.Input.decodeList<RemediationResponseContaineranalysisV1alpha1>(map['remediations'], (value) => RemediationResponseContaineranalysisV1alpha1.fromMap((value as Map).cast<String, dynamic>()))).input(),
