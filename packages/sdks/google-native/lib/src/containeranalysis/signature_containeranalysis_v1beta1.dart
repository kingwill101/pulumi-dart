...
class SignatureContaineranalysisV1beta1 {
  ...
  /// Creates a new [SignatureContaineranalysisV1beta1].
  ...
  const SignatureContaineranalysisV1beta1({
    this.publicKeyId,
    this.signature,
  });
  ...
  factory SignatureContaineranalysisV1beta1.fromMap(Map<String, dynamic> map) {
    return SignatureContaineranalysisV1beta1(
      publicKeyId: (() { final guardedValue = map['publicKeyId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
