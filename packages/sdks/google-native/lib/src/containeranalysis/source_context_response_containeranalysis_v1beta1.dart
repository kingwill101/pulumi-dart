...
class SourceContextResponseContaineranalysisV1beta1 {
  ...
  factory SourceContextResponseContaineranalysisV1beta1.fromMap(Map<String, dynamic> map) {
    return SourceContextResponseContaineranalysisV1beta1(
      cloudRepo: (CloudRepoSourceContextResponseContaineranalysisV1beta1.fromMap((map['cloudRepo'] as Map).cast<String, dynamic>())).input(),
      gerrit: (GerritSourceContextResponseContaineranalysisV1beta1.fromMap((map['gerrit'] as Map).cast<String, dynamic>())).input(),
      git: (GitSourceContextResponseContaineranalysisV1beta1.fromMap((map['git'] as Map).cast<String, dynamic>())).input(),
