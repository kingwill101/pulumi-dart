...
class SourceContextResponseContaineranalysisV1beta1 {
  ...
  final pulumi.Input<CloudRepoSourceContextResponseContaineranalysisV1beta1>
  cloudRepo;

  /// A SourceContext referring to a Gerrit project.
  final pulumi.Input<GerritSourceContextResponseContaineranalysisV1beta1>
  gerrit;
  ...
  factory SourceContextResponseContaineranalysisV1beta1.fromMap(
    Map<String, dynamic> map,
  ) {
    return SourceContextResponseContaineranalysisV1beta1(
      cloudRepo: pulumi.Input.fromValue(
        CloudRepoSourceContextResponseContaineranalysisV1beta1.fromMap(
          (map['cloudRepo']! as Map).cast<String, dynamic>(),
        ),
      ),
      gerrit: pulumi.Input.fromValue(
        GerritSourceContextResponseContaineranalysisV1beta1.fromMap(
          (map['gerrit']! as Map).cast<String, dynamic>(),
        ),
      ),
      git: pulumi.Input.fromValue(
        GitSourceContextResponseContaineranalysisV1beta1.fromMap(
