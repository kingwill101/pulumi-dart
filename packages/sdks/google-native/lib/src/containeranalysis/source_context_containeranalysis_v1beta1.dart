...
class SourceContextContaineranalysisV1beta1 {
  ...
  const SourceContextContaineranalysisV1beta1({
    this.cloudRepo,
    this.gerrit,
    this.git,
    this.labels,
  ...
  factory SourceContextContaineranalysisV1beta1.fromMap(Map<String, dynamic> map) {
    return SourceContextContaineranalysisV1beta1(
      cloudRepo: (() { final guardedValue = map['cloudRepo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CloudRepoSourceContextContaineranalysisV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      gerrit: (() { final guardedValue = map['gerrit']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GerritSourceContextContaineranalysisV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      git: (() { final guardedValue = map['git']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GitSourceContextContaineranalysisV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
