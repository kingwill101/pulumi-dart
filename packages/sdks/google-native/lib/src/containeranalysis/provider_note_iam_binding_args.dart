...
/// {@template pulumi_containeranalysis_v1alpha1_provider_note_iam_binding_args_doc}
/// The set of arguments for ProviderNoteIamBinding.
/// {@endtemplate}
/// {@macro pulumi_containeranalysis_v1alpha1_provider_note_iam_binding_args_doc}
class ProviderNoteIamBindingArgs {
  ...
  /// Creates a new [ProviderNoteIamBindingArgs].
  ...
  const ProviderNoteIamBindingArgs({
    this.condition,
  ...
  factory ProviderNoteIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return ProviderNoteIamBindingArgs(
