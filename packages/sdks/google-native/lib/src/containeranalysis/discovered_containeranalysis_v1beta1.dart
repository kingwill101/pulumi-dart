...
class DiscoveredContaineranalysisV1beta1 {
  final pulumi.Input<AnalysisCompletedContaineranalysisV1beta1>?
  analysisCompleted;
  ...
  final pulumi.Input<DiscoveredAnalysisStatusContaineranalysisV1beta1>?
  analysisStatus;
  ...
  final pulumi.Input<DiscoveredContinuousAnalysisContaineranalysisV1beta1>?
  continuousAnalysis;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'analysisError':
          ?pulumi.Input.mapOptionalInputValue<
            List<StatusContaineranalysisV1beta1>,
      ...
      'analysisStatus':
          ?pulumi.Input.mapOptionalInputValue<
            DiscoveredAnalysisStatusContaineranalysisV1beta1,
            String
      ...
      'continuousAnalysis':
          ?pulumi.Input.mapOptionalInputValue<
            DiscoveredContinuousAnalysisContaineranalysisV1beta1,
            String
  ...
  factory DiscoveredContaineranalysisV1beta1.fromMap(Map<String, dynamic> map) {
    return DiscoveredContaineranalysisV1beta1(
      ...
      lastAnalysisTime: (() {
        final guardedValue = map['lastAnalysisTime'];
        if (guardedValue == null) return null;
