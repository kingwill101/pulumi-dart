...
class PackageInfoNoteContaineranalysisV1beta1 {
  ...
  /// ExternalRef
  final List<ExternalRefContaineranalysisV1beta1>? externalRefs;
  ...
  final LicenseContaineranalysisV1beta1? licenseDeclared;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'externalRefs': ?externalRefs == null ? null : pulumi.Input.encodeList<ExternalRefContaineranalysisV1beta1, Map<String, dynamic>>(externalRefs!, (value) => value.toMap()),
  ...
  factory PackageInfoNoteContaineranalysisV1beta1.fromMap(Map<String, dynamic> map) {
    return PackageInfoNoteContaineranalysisV1beta1(
      ...
      externalRefs: map['externalRefs'] == null ? null : pulumi.Input.decodeList<ExternalRefContaineranalysisV1beta1>(map['externalRefs'], (value) => ExternalRefContaineranalysisV1beta1.fromMap((value as Map).cast<String, dynamic>())),
      ...
      licenseDeclared: map['licenseDeclared'] == null ? null : LicenseContaineranalysisV1beta1.fromMap((map['licenseDeclared'] as Map).cast<String, dynamic>()),
