...
class AssessmentContaineranalysisV1beta1 {
  ...
  const AssessmentContaineranalysisV1beta1({
    this.cve,
    this.impacts,
    this.justification,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'state': ?pulumi.Input.mapOptionalInputValue<AssessmentStateContaineranalysisV1beta1, String>(state, (value) => value.wireValue),
  ...
  factory AssessmentContaineranalysisV1beta1.fromMap(Map<String, dynamic> map) {
    return AssessmentContaineranalysisV1beta1(
      ...
      state: (() { final guardedValue = map['state']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AssessmentStateContaineranalysisV1beta1.fromValue(guardedValue as String)); })(),
