...
class DerivedContaineranalysisV1beta1 {
  ...
  factory DerivedContaineranalysisV1beta1.fromMap(Map<String, dynamic> map) {
    return DerivedContaineranalysisV1beta1(
      ...
      layerInfo: (() { final guardedValue = map['layerInfo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<LayerContaineranalysisV1beta1>(guardedValue, (value) => LayerContaineranalysisV1beta1.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
