...
class ExprResponseContaineranalysisV1alpha1 {
  ...
  /// Creates a new [ExprResponseContaineranalysisV1alpha1].
  ...
  const ExprResponseContaineranalysisV1alpha1({
  ...
  factory ExprResponseContaineranalysisV1alpha1.fromMap(Map<String, dynamic> map) {
