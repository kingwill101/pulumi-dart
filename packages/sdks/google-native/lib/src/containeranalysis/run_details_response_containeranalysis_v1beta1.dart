...
class RunDetailsResponseContaineranalysisV1beta1 {
  ...
  factory RunDetailsResponseContaineranalysisV1beta1.fromMap(Map<String, dynamic> map) {
    return RunDetailsResponseContaineranalysisV1beta1(
      builder: (ProvenanceBuilderResponseContaineranalysisV1beta1.fromMap((map['builder'] as Map).cast<String, dynamic>())).input(),
      byproducts: (pulumi.Input.decodeList<ResourceDescriptorResponseContaineranalysisV1beta1>(map['byproducts'], (value) => ResourceDescriptorResponseContaineranalysisV1beta1.fromMap((value as Map).cast<String, dynamic>()))).input(),
      metadata: (BuildMetadataResponseContaineranalysisV1beta1.fromMap((map['metadata'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
