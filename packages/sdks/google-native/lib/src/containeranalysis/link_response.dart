...
class LinkResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'byproducts':
          pulumi.Input.mapInputValue<ByProductsResponse, Map<String, dynamic>>(
            byproducts,
            (value) => value.toMap(),
          ),
      'command': command,
      ...
      'materials':
          pulumi.Input.mapInputValue<
            List<GrafeasV1beta1IntotoArtifactResponse>,
  ...
  factory LinkResponse.fromMap(Map<String, dynamic> map) {
    return LinkResponse(
      byproducts: pulumi.Input.fromValue(
        ByProductsResponse.fromMap(
      ...
      materials: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GrafeasV1beta1IntotoArtifactResponse>(
          map['materials']!,
