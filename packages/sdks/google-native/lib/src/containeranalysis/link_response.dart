...
class LinkResponse {
  ...
  factory LinkResponse.fromMap(Map<String, dynamic> map) {
    return LinkResponse(
      byproducts: (ByProductsResponse.fromMap((map['byproducts'] as Map).cast<String, dynamic>())).input(),
      ...
      materials: (pulumi.Input.decodeList<GrafeasV1beta1IntotoArtifactResponse>(map['materials'], (value) => GrafeasV1beta1IntotoArtifactResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      products: (pulumi.Input.decodeList<GrafeasV1beta1IntotoArtifactResponse>(map['products'], (value) => GrafeasV1beta1IntotoArtifactResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
