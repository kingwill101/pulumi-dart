...
class ImageNoteResponse {
  ...
  ImageNoteResponse({required this.fingerprint, required this.resourceUrl});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'fingerprint':
          pulumi.Input.mapInputValue<FingerprintResponse, Map<String, dynamic>>(
            fingerprint,
            (value) => value.toMap(),
          ),
