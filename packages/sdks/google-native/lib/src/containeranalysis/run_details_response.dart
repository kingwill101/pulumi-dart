...
class RunDetailsResponse {
  ...
  factory RunDetailsResponse.fromMap(Map<String, dynamic> map) {
    return RunDetailsResponse(
      builder: pulumi.Input.fromValue(ProvenanceBuilderResponse.fromMap((map['builder']! as Map).cast<String, dynamic>())),
      byproducts: pulumi.Input.fromValue(pulumi.Input.decodeList<ResourceDescriptorResponse>(map['byproducts']!, (value) => ResourceDescriptorResponse.fromMap((value as Map).cast<String, dynamic>()))),
      metadata: pulumi.Input.fromValue(BuildMetadataResponse.fromMap((map['metadata']! as Map).cast<String, dynamic>())),
    );
  }
}
