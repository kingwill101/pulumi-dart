...
class ExprResponseContaineranalysisV1beta1 {
  ...
  /// Creates a new [ExprResponseContaineranalysisV1beta1].
  ...
  const ExprResponseContaineranalysisV1beta1({
  ...
  factory ExprResponseContaineranalysisV1beta1.fromMap(Map<String, dynamic> map) {
    return ExprResponseContaineranalysisV1beta1(
