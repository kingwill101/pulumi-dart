...
class DetailResponseContaineranalysisV1alpha1 {
  ...
  factory DetailResponseContaineranalysisV1alpha1.fromMap(Map<String, dynamic> map) {
    return DetailResponseContaineranalysisV1alpha1(
      ...
      maxAffectedVersion: (VersionResponseContaineranalysisV1alpha1.fromMap((map['maxAffectedVersion'] as Map).cast<String, dynamic>())).input(),
      minAffectedVersion: (VersionResponseContaineranalysisV1alpha1.fromMap((map['minAffectedVersion'] as Map).cast<String, dynamic>())).input(),
