...
class SourceContaineranalysisV1beta1 {
  ...
  final pulumi.Input<List<SourceContextContaineranalysisV1beta1>>?
  additionalContexts;
    ...
    return <String, dynamic>{
      'additionalContexts':
          ?pulumi.Input.mapOptionalInputValue<
            List<SourceContextContaineranalysisV1beta1>,
  ...
  factory SourceContaineranalysisV1beta1.fromMap(Map<String, dynamic> map) {
    return SourceContaineranalysisV1beta1(
      ...
      artifactStorageSourceUri: (() {
        final guardedValue = map['artifactStorageSourceUri'];
        if (guardedValue == null) return null;
