...
class SourceContaineranalysisV1beta1 {
  ...
  const SourceContaineranalysisV1beta1({
  ...
  factory SourceContaineranalysisV1beta1.fromMap(Map<String, dynamic> map) {
    return SourceContaineranalysisV1beta1(
      additionalContexts: (() { final guardedValue = map['additionalContexts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SourceContextContaineranalysisV1beta1>(guardedValue, (value) => SourceContextContaineranalysisV1beta1.fromMap((value as Map).cast<String, dynamic>()))); })(),
      artifactStorageSourceUri: (() { final guardedValue = map['artifactStorageSourceUri']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      context: (() { final guardedValue = map['context']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SourceContextContaineranalysisV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
