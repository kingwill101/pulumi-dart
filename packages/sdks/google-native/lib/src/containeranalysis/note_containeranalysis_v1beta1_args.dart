...
class NoteContaineranalysisV1beta1Args {
  ...
  factory NoteContaineranalysisV1beta1Args.fromMap(Map<String, dynamic> map) {
    return NoteContaineranalysisV1beta1Args(
      attestationAuthority: (() { final guardedValue = map['attestationAuthority']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Authority.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      baseImage: (() { final guardedValue = map['baseImage']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BasisContaineranalysisV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      build: (() { final guardedValue = map['build']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Build.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      deployable: (() { final guardedValue = map['deployable']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DeployableContaineranalysisV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      discovery: (() { final guardedValue = map['discovery']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DiscoveryContaineranalysisV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      intoto: (() { final guardedValue = map['intoto']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InToto.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      package: (() { final guardedValue = map['package']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PackageContaineranalysisV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      relatedUrl: (() { final guardedValue = map['relatedUrl']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RelatedUrlContaineranalysisV1beta1>(guardedValue, (value) => RelatedUrlContaineranalysisV1beta1.fromMap((value as Map).cast<String, dynamic>()))); })(),
      sbom: (() { final guardedValue = map['sbom']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DocumentNoteContaineranalysisV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      sbomReference: (() { final guardedValue = map['sbomReference']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SBOMReferenceNoteContaineranalysisV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      spdxFile: (() { final guardedValue = map['spdxFile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FileNoteContaineranalysisV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      spdxPackage: (() { final guardedValue = map['spdxPackage']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PackageInfoNoteContaineranalysisV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      spdxRelationship: (() { final guardedValue = map['spdxRelationship']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RelationshipNoteContaineranalysisV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      vulnerability: (() { final guardedValue = map['vulnerability']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Vulnerability.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      vulnerabilityAssessment: (() { final guardedValue = map['vulnerabilityAssessment']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VulnerabilityAssessmentNoteContaineranalysisV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
