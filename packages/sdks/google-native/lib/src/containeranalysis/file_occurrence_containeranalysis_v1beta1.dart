...
class FileOccurrenceContaineranalysisV1beta1 {
  ...
  factory FileOccurrenceContaineranalysisV1beta1.fromMap(Map<String, dynamic> map) {
    return FileOccurrenceContaineranalysisV1beta1(
      attributions: (() { final guardedValue = map['attributions']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      comment: (() { final guardedValue = map['comment']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      contributors: (() { final guardedValue = map['contributors']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      ...
      licenseConcluded: (() { final guardedValue = map['licenseConcluded']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LicenseContaineranalysisV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      notice: (() { final guardedValue = map['notice']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
