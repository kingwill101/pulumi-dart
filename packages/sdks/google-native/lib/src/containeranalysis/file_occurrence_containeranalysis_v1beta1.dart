...
class FileOccurrenceContaineranalysisV1beta1 {
  ...
  factory FileOccurrenceContaineranalysisV1beta1.fromMap(
    Map<String, dynamic> map,
  ) {
    return FileOccurrenceContaineranalysisV1beta1(
      attributions: (() {
        final guardedValue = map['attributions'];
      ...
      contributors: (() {
        final guardedValue = map['contributors'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      copyright: (() {
