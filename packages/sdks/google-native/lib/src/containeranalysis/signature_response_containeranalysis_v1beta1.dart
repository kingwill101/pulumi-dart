...
class SignatureResponseContaineranalysisV1beta1 {
  ...
  /// Creates a new [SignatureResponseContaineranalysisV1beta1].
  ...
  const SignatureResponseContaineranalysisV1beta1({
  ...
  factory SignatureResponseContaineranalysisV1beta1.fromMap(Map<String, dynamic> map) {
    return SignatureResponseContaineranalysisV1beta1(
