...
class BuildProvenanceContaineranalysisV1beta1 {
  ...
  factory BuildProvenanceContaineranalysisV1beta1.fromMap(Map<String, dynamic> map) {
    return BuildProvenanceContaineranalysisV1beta1(
      ...
      builtArtifacts: (() { final guardedValue = map['builtArtifacts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ArtifactContaineranalysisV1beta1>(guardedValue, (value) => ArtifactContaineranalysisV1beta1.fromMap((value as Map).cast<String, dynamic>()))); })(),
      commands: (() { final guardedValue = map['commands']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<CommandContaineranalysisV1beta1>(guardedValue, (value) => CommandContaineranalysisV1beta1.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      sourceProvenance: (() { final guardedValue = map['sourceProvenance']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SourceContaineranalysisV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
