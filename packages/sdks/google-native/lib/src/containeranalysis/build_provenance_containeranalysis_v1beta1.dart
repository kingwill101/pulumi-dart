...
class BuildProvenanceContaineranalysisV1beta1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'builtArtifacts': ?builtArtifacts == null ? null : pulumi.Input.encodeList<ArtifactContaineranalysisV1beta1, Map<String, dynamic>>(builtArtifacts!, (value) => value.toMap()),
      'commands': ?commands == null ? null : pulumi.Input.encodeList<CommandContaineranalysisV1beta1, Map<String, dynamic>>(commands!, (value) => value.toMap()),
  ...
  factory BuildProvenanceContaineranalysisV1beta1.fromMap(Map<String, dynamic> map) {
    return BuildProvenanceContaineranalysisV1beta1(
      ...
      builtArtifacts: map['builtArtifacts'] == null ? null : pulumi.Input.decodeList<ArtifactContaineranalysisV1beta1>(map['builtArtifacts'], (value) => ArtifactContaineranalysisV1beta1.fromMap((value as Map).cast<String, dynamic>())),
      commands: map['commands'] == null ? null : pulumi.Input.decodeList<CommandContaineranalysisV1beta1>(map['commands'], (value) => CommandContaineranalysisV1beta1.fromMap((value as Map).cast<String, dynamic>())),
      ...
      sourceProvenance: map['sourceProvenance'] == null ? null : SourceContaineranalysisV1beta1.fromMap((map['sourceProvenance'] as Map).cast<String, dynamic>()),
