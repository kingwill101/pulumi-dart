...
class GrafeasV1beta1ImageDetails {
  ...
  const GrafeasV1beta1ImageDetails({
  ...
  factory GrafeasV1beta1ImageDetails.fromMap(Map<String, dynamic> map) {
    return GrafeasV1beta1ImageDetails(
      derivedImage: pulumi.Input.fromValue(DerivedContaineranalysisV1beta1.fromMap((map['derivedImage']! as Map).cast<String, dynamic>())),
    );
  }
}
