...
class InToto {
  ...
  factory InToto.fromMap(Map<String, dynamic> map) {
    return InToto(
      expectedCommand: (() {
        final guardedValue = map['expectedCommand'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      expectedMaterials: (() {
        final guardedValue = map['expectedMaterials'];
        if (guardedValue == null) return null;
      ...
      expectedProducts: (() {
        final guardedValue = map['expectedProducts'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ArtifactRule>(
            guardedValue,
      ...
      signingKeys: (() {
        final guardedValue = map['signingKeys'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
