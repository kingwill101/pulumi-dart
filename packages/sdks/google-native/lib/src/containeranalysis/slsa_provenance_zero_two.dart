...
class SlsaProvenanceZeroTwo {
  ...
  factory SlsaProvenanceZeroTwo.fromMap(Map<String, dynamic> map) {
    return SlsaProvenanceZeroTwo(
      ...
      builder: (() { final guardedValue = map['builder']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GrafeasV1SlsaProvenanceZeroTwoSlsaBuilder.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      invocation: (() { final guardedValue = map['invocation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GrafeasV1SlsaProvenanceZeroTwoSlsaInvocation.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      materials: (() { final guardedValue = map['materials']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GrafeasV1SlsaProvenanceZeroTwoSlsaMaterial>(guardedValue, (value) => GrafeasV1SlsaProvenanceZeroTwoSlsaMaterial.fromMap((value as Map).cast<String, dynamic>()))); })(),
      metadata: (() { final guardedValue = map['metadata']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GrafeasV1SlsaProvenanceZeroTwoSlsaMetadata.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
