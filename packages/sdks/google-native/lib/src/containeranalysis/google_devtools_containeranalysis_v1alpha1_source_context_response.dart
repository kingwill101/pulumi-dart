...
class GoogleDevtoolsContaineranalysisV1alpha1SourceContextResponse {
  ...
  factory GoogleDevtoolsContaineranalysisV1alpha1SourceContextResponse.fromMap(Map<String, dynamic> map) {
    return GoogleDevtoolsContaineranalysisV1alpha1SourceContextResponse(
      cloudRepo: (GoogleDevtoolsContaineranalysisV1alpha1CloudRepoSourceContextResponse.fromMap((map['cloudRepo'] as Map).cast<String, dynamic>())).input(),
      gerrit: (GoogleDevtoolsContaineranalysisV1alpha1GerritSourceContextResponse.fromMap((map['gerrit'] as Map).cast<String, dynamic>())).input(),
      git: (GoogleDevtoolsContaineranalysisV1alpha1GitSourceContextResponse.fromMap((map['git'] as Map).cast<String, dynamic>())).input(),
