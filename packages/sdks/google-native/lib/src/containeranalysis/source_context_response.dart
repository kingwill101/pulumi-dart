...
class SourceContextResponse {
  ...
  factory SourceContextResponse.fromMap(Map<String, dynamic> map) {
    return SourceContextResponse(
      cloudRepo: (CloudRepoSourceContextResponse.fromMap((map['cloudRepo'] as Map).cast<String, dynamic>())).input(),
      gerrit: (GerritSourceContextResponse.fromMap((map['gerrit'] as Map).cast<String, dynamic>())).input(),
      git: (GitSourceContextResponse.fromMap((map['git'] as Map).cast<String, dynamic>())).input(),
