...
class BuildResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'signature': pulumi.Input.mapInputValue<BuildSignatureResponseContaineranalysisV1beta1, Map<String, dynamic>>(signature, (value) => value.toMap()),
    };
  }
  ...
  factory BuildResponse.fromMap(Map<String, dynamic> map) {
    return BuildResponse(
      ...
      signature: pulumi.Input.fromValue(BuildSignatureResponseContaineranalysisV1beta1.fromMap((map['signature']! as Map).cast<String, dynamic>())),
    );
  }
}
