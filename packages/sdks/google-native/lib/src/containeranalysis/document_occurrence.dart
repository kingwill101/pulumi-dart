...
class DocumentOccurrence {
  ...
  factory DocumentOccurrence.fromMap(Map<String, dynamic> map) {
    return DocumentOccurrence(
      ...
      creatorComment: (() {
        final guardedValue = map['creatorComment'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      creators: (() {
        final guardedValue = map['creators'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      documentComment: (() {
        final guardedValue = map['documentComment'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      externalDocumentRefs: (() {
        final guardedValue = map['externalDocumentRefs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      id: (() {
      ...
      licenseListVersion: (() {
        final guardedValue = map['licenseListVersion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      namespace: (() {
