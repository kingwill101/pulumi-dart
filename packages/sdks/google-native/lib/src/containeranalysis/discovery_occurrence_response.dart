...
class DiscoveryOccurrenceResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'sbomStatus':
          pulumi.Input.mapInputValue<SBOMStatusResponse, Map<String, dynamic>>(
            sbomStatus,
            (value) => value.toMap(),
          ),
    };
