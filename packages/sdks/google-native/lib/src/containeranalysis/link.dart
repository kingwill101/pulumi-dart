...
class Link {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'byproducts':
          ?pulumi.Input.mapOptionalInputValue<ByProducts, Map<String, dynamic>>(
            byproducts,
            (value) => value.toMap(),
          ),
      'command': ?command,
      ...
      'materials':
          ?pulumi.Input.mapOptionalInputValue<
            List<GrafeasV1beta1IntotoArtifact>,
    ...
    return Link(
      byproducts: (() {
        ...
        return pulumi.Input.fromValue(
          ByProducts.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      command: (() {
      ...
      products: (() {
        final guardedValue = map['products'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GrafeasV1beta1IntotoArtifact>(
            guardedValue,
