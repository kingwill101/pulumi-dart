...
class WindowsDetailContaineranalysisV1beta1 {
  ...
  const WindowsDetailContaineranalysisV1beta1({
  ...
  factory WindowsDetailContaineranalysisV1beta1.fromMap(Map<String, dynamic> map) {
    return WindowsDetailContaineranalysisV1beta1(
      ...
      fixingKbs: pulumi.Input.fromValue(pulumi.Input.decodeList<KnowledgeBaseContaineranalysisV1beta1>(map['fixingKbs']!, (value) => KnowledgeBaseContaineranalysisV1beta1.fromMap((value as Map).cast<String, dynamic>()))),
