...
class ExprContaineranalysisV1alpha1 {
  ...
  /// Creates a new [ExprContaineranalysisV1alpha1].
  ...
  const ExprContaineranalysisV1alpha1({
    this.description,
    this.expression,
    this.location,
    this.title,
  ...
  factory ExprContaineranalysisV1alpha1.fromMap(Map<String, dynamic> map) {
    return ExprContaineranalysisV1alpha1(
