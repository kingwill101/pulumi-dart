...
class LayerContaineranalysisV1alpha1 {
  ...
  LayerContaineranalysisV1alpha1({this.arguments, this.directive});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'arguments': ?arguments,
      'directive': ?pulumi.Input.mapOptionalInputValue<LayerDirective, String>(
        directive,
  ...
  factory LayerContaineranalysisV1alpha1.fromMap(Map<String, dynamic> map) {
    return LayerContaineranalysisV1alpha1(
      ...
      directive: (() {
        final guardedValue = map['directive'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          LayerDirective.fromValue(guardedValue as String),
        );
      })(),
    );
  }
