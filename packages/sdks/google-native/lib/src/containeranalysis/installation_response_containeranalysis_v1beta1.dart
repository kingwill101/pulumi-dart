...
class InstallationResponseContaineranalysisV1beta1 {
  ...
  factory InstallationResponseContaineranalysisV1beta1.fromMap(Map<String, dynamic> map) {
    return InstallationResponseContaineranalysisV1beta1(
      ...
      location: pulumi.Input.fromValue(pulumi.Input.decodeList<LocationResponseContaineranalysisV1beta1>(map['location']!, (value) => LocationResponseContaineranalysisV1beta1.fromMap((value as Map).cast<String, dynamic>()))),
