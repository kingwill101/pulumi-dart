...
class DetailContaineranalysisV1alpha1 {
  ...
  const DetailContaineranalysisV1alpha1({
    this.cpeUri,
    this.description,
    this.fixedLocation,
    this.isObsolete,
  ...
  factory DetailContaineranalysisV1alpha1.fromMap(Map<String, dynamic> map) {
    return DetailContaineranalysisV1alpha1(
      ...
      maxAffectedVersion: (() { final guardedValue = map['maxAffectedVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VersionContaineranalysisV1alpha1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      minAffectedVersion: (() { final guardedValue = map['minAffectedVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VersionContaineranalysisV1alpha1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
