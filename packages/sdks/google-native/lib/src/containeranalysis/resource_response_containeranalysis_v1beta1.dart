...
class ResourceResponseContaineranalysisV1beta1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'contentHash': pulumi.Input.mapInputValue<HashResponseContaineranalysisV1beta1, Map<String, dynamic>>(contentHash, (value) => value.toMap()),
      'name': name,
      'uri': uri,
    };
  }
  ...
  factory ResourceResponseContaineranalysisV1beta1.fromMap(Map<String, dynamic> map) {
    return ResourceResponseContaineranalysisV1beta1(
      contentHash: pulumi.Input.fromValue(HashResponseContaineranalysisV1beta1.fromMap((map['contentHash']! as Map).cast<String, dynamic>())),
