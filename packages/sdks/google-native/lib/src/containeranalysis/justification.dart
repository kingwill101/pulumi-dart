...
class Justification {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'details': ?details,
      'justificationType': ?pulumi.Input.mapOptionalInputValue<JustificationJustificationType, String>(justificationType, (value) => value.wireValue),
    };
  }
  ...
  factory Justification.fromMap(Map<String, dynamic> map) {
    return Justification(
      ...
      justificationType: (() { final guardedValue = map['justificationType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(JustificationJustificationType.fromValue(guardedValue as String)); })(),
    );
  }
}
