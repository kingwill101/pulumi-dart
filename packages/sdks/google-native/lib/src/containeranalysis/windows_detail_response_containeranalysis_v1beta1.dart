...
class WindowsDetailResponseContaineranalysisV1beta1 {
  ...
  factory WindowsDetailResponseContaineranalysisV1beta1.fromMap(Map<String, dynamic> map) {
    return WindowsDetailResponseContaineranalysisV1beta1(
      ...
      fixingKbs: (pulumi.Input.decodeList<KnowledgeBaseResponseContaineranalysisV1beta1>(map['fixingKbs'], (value) => KnowledgeBaseResponseContaineranalysisV1beta1.fromMap((value as Map).cast<String, dynamic>()))).input(),
