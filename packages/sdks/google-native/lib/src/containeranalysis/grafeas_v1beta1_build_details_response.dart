...
class GrafeasV1beta1BuildDetailsResponse {
  final pulumi.Input<InTotoSlsaProvenanceV1ResponseContaineranalysisV1beta1>
  inTotoSlsaProvenanceV1;

  /// The actual provenance for the build.
  final pulumi.Input<BuildProvenanceResponseContaineranalysisV1beta1>
  provenance;
    ...
    return <String, dynamic>{
      'inTotoSlsaProvenanceV1':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(inTotoSlsaProvenanceV1, (value) => value.toMap()),
      'provenance':
          pulumi.Input.mapInputValue<
  ...
  factory GrafeasV1beta1BuildDetailsResponse.fromMap(Map<String, dynamic> map) {
    return GrafeasV1beta1BuildDetailsResponse(
      inTotoSlsaProvenanceV1: pulumi.Input.fromValue(
      ...
      provenance: pulumi.Input.fromValue(
        BuildProvenanceResponseContaineranalysisV1beta1.fromMap(
