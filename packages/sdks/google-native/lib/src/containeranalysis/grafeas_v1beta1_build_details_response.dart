...
class GrafeasV1beta1BuildDetailsResponse {
  ...
  factory GrafeasV1beta1BuildDetailsResponse.fromMap(Map<String, dynamic> map) {
    return GrafeasV1beta1BuildDetailsResponse(
      inTotoSlsaProvenanceV1: (InTotoSlsaProvenanceV1ResponseContaineranalysisV1beta1.fromMap((map['inTotoSlsaProvenanceV1'] as Map).cast<String, dynamic>())).input(),
      provenance: (BuildProvenanceResponseContaineranalysisV1beta1.fromMap((map['provenance'] as Map).cast<String, dynamic>())).input(),
