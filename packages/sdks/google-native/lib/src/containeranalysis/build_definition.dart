...
class BuildDefinition {
  ...
  factory BuildDefinition.fromMap(Map<String, dynamic> map) {
    return BuildDefinition(
      ...
      resolvedDependencies: (() { final guardedValue = map['resolvedDependencies']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ResourceDescriptor>(guardedValue, (value) => ResourceDescriptor.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
