...
class PackageResponseContaineranalysisV1beta1 {
  ...
  final pulumi.Input<List<DistributionResponseContaineranalysisV1beta1>>
  distribution;
    ...
    return <String, dynamic>{
      ...
      'digest':
          pulumi.Input.mapInputValue<
            List<DigestResponseContaineranalysisV1beta1>,
      ...
      'distribution':
          pulumi.Input.mapInputValue<
            List<DistributionResponseContaineranalysisV1beta1>,
            List<Map<String, dynamic>>
          >(
            distribution,
            (value) =>
  ...
  factory PackageResponseContaineranalysisV1beta1.fromMap(
    ...
    return PackageResponseContaineranalysisV1beta1(
      ...
      digest: pulumi.Input.fromValue(
        pulumi.Input.decodeList<DigestResponseContaineranalysisV1beta1>(
          map['digest']!,
