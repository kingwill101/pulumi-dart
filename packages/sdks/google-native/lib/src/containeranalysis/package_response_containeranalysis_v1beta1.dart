...
class PackageResponseContaineranalysisV1beta1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'digest': pulumi.Input.encodeList<DigestResponseContaineranalysisV1beta1, Map<String, dynamic>>(digest, (value) => value.toMap()),
      'distribution': pulumi.Input.encodeList<DistributionResponseContaineranalysisV1beta1, Map<String, dynamic>>(distribution, (value) => value.toMap()),
  ...
  factory PackageResponseContaineranalysisV1beta1.fromMap(Map<String, dynamic> map) {
    return PackageResponseContaineranalysisV1beta1(
      ...
      digest: pulumi.Input.decodeList<DigestResponseContaineranalysisV1beta1>(map['digest'], (value) => DigestResponseContaineranalysisV1beta1.fromMap((value as Map).cast<String, dynamic>())),
      distribution: pulumi.Input.decodeList<DistributionResponseContaineranalysisV1beta1>(map['distribution'], (value) => DistributionResponseContaineranalysisV1beta1.fromMap((value as Map).cast<String, dynamic>())),
