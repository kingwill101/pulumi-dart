...
class PgpSignedAttestationContaineranalysisV1beta1 {
  ...
  final pulumi.Input<PgpSignedAttestationContentTypeContaineranalysisV1beta1>?
  contentType;
    ...
    return <String, dynamic>{
      'contentType':
          ?pulumi.Input.mapOptionalInputValue<
            PgpSignedAttestationContentTypeContaineranalysisV1beta1,
            String
  ...
  factory PgpSignedAttestationContaineranalysisV1beta1.fromMap(
    ...
    return PgpSignedAttestationContaineranalysisV1beta1(
      contentType: (() {
        ...
        return pulumi.Input.fromValue(
          PgpSignedAttestationContentTypeContaineranalysisV1beta1.fromValue(
