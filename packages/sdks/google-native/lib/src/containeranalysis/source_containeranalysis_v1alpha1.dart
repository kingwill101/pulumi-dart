...
class SourceContaineranalysisV1alpha1 {
  ...
  final pulumi.Input<GoogleDevtoolsContaineranalysisV1alpha1SourceContext>?
  context;
    ...
    return <String, dynamic>{
      ...
      'artifactStorageSource':
          ?pulumi.Input.mapOptionalInputValue<
            StorageSource,
            Map<String, dynamic>
          >(artifactStorageSource, (value) => value.toMap()),
      'context':
          ?pulumi.Input.mapOptionalInputValue<
            GoogleDevtoolsContaineranalysisV1alpha1SourceContext,
            Map<String, dynamic>
  ...
  factory SourceContaineranalysisV1alpha1.fromMap(Map<String, dynamic> map) {
    return SourceContaineranalysisV1alpha1(
      ...
      artifactStorageSource: (() {
        final guardedValue = map['artifactStorageSource'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      fileHashes: (() {
        final guardedValue = map['fileHashes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
