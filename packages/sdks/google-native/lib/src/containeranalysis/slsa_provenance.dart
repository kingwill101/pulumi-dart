...
class SlsaProvenance {
  ...
  factory SlsaProvenance.fromMap(Map<String, dynamic> map) {
    return SlsaProvenance(
      builder: (() { final guardedValue = map['builder']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SlsaBuilder.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      materials: (() { final guardedValue = map['materials']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<Material>(guardedValue, (value) => Material.fromMap((value as Map).cast<String, dynamic>()))); })(),
      metadata: (() { final guardedValue = map['metadata']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SlsaMetadata.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      recipe: (() { final guardedValue = map['recipe']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SlsaRecipe.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
