...
class InTotoProvenanceResponseContaineranalysisV1alpha1 {
  ...
  factory InTotoProvenanceResponseContaineranalysisV1alpha1.fromMap(Map<String, dynamic> map) {
    return InTotoProvenanceResponseContaineranalysisV1alpha1(
      builderConfig: ((map['builderConfig'] as Map).cast<String, dynamic>()).input(),
      materials: ((map['materials'] as List).cast<String>()).input(),
      metadata: (MetadataResponseContaineranalysisV1alpha1.fromMap((map['metadata'] as Map).cast<String, dynamic>())).input(),
      recipe: (RecipeResponseContaineranalysisV1alpha1.fromMap((map['recipe'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
