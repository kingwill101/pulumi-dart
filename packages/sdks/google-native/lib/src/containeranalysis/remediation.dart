...
class Remediation {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'remediationUri':
          ?pulumi.Input.mapOptionalInputValue<RelatedUrl, Map<String, dynamic>>(
            remediationUri,
            (value) => value.toMap(),
          ),
    };
    ...
    return Remediation(
      ...
      remediationType: (() {
        ...
        return pulumi.Input.fromValue(
          RemediationRemediationType.fromValue(guardedValue as String),
        );
      })(),
      remediationUri: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RelatedUrl.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
