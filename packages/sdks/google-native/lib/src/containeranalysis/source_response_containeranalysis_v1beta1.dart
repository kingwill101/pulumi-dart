...
class SourceResponseContaineranalysisV1beta1 {
  ...
  final pulumi.Input<List<SourceContextResponseContaineranalysisV1beta1>>
  additionalContexts;
    ...
    return <String, dynamic>{
      'additionalContexts':
          pulumi.Input.mapInputValue<
            List<SourceContextResponseContaineranalysisV1beta1>,
  ...
  factory SourceResponseContaineranalysisV1beta1.fromMap(
    ...
    return SourceResponseContaineranalysisV1beta1(
      additionalContexts: pulumi.Input.fromValue(
        pulumi.Input.decodeList<SourceContextResponseContaineranalysisV1beta1>(
      ...
      artifactStorageSourceUri: pulumi.Input.fromValue(
        map['artifactStorageSourceUri'] as String,
      ),
      context: pulumi.Input.fromValue(
        SourceContextResponseContaineranalysisV1beta1.fromMap(
