...
class SbomReferenceIntotoPayloadContaineranalysisV1beta1 {
  ...
  const SbomReferenceIntotoPayloadContaineranalysisV1beta1({
    this.predicate,
    this.predicateType,
    this.subject,
    this.type,
  ...
  factory SbomReferenceIntotoPayloadContaineranalysisV1beta1.fromMap(Map<String, dynamic> map) {
    return SbomReferenceIntotoPayloadContaineranalysisV1beta1(
      predicate: (() { final guardedValue = map['predicate']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SbomReferenceIntotoPredicateContaineranalysisV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      subject: (() { final guardedValue = map['subject']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SubjectContaineranalysisV1beta1>(guardedValue, (value) => SubjectContaineranalysisV1beta1.fromMap((value as Map).cast<String, dynamic>()))); })(),
