...
class UpgradeOccurrence {
  ...
  factory UpgradeOccurrence.fromMap(Map<String, dynamic> map) {
    return UpgradeOccurrence(
      distribution: (() { final guardedValue = map['distribution']; if (guardedValue == null) return null; return pulumi.Input.fromValue(UpgradeDistribution.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      parsedVersion: (() { final guardedValue = map['parsedVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Version.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
