...
class CVSSv3ContaineranalysisV1beta1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'attackComplexity': ?pulumi.Input.mapOptionalInputValue<CVSSv3AttackComplexityContaineranalysisV1beta1, String>(attackComplexity, (value) => value.value),
      'attackVector': ?pulumi.Input.mapOptionalInputValue<CVSSv3AttackVectorContaineranalysisV1beta1, String>(attackVector, (value) => value.value),
      'availabilityImpact': ?pulumi.Input.mapOptionalInputValue<CVSSv3AvailabilityImpactContaineranalysisV1beta1, String>(availabilityImpact, (value) => value.value),
      'baseScore': ?baseScore,
      'confidentialityImpact': ?pulumi.Input.mapOptionalInputValue<CVSSv3ConfidentialityImpactContaineranalysisV1beta1, String>(confidentialityImpact, (value) => value.value),
      'exploitabilityScore': ?exploitabilityScore,
      'impactScore': ?impactScore,
      'integrityImpact': ?pulumi.Input.mapOptionalInputValue<CVSSv3IntegrityImpactContaineranalysisV1beta1, String>(integrityImpact, (value) => value.value),
      'privilegesRequired': ?pulumi.Input.mapOptionalInputValue<CVSSv3PrivilegesRequiredContaineranalysisV1beta1, String>(privilegesRequired, (value) => value.value),
      'scope': ?pulumi.Input.mapOptionalInputValue<CVSSv3ScopeContaineranalysisV1beta1, String>(scope, (value) => value.value),
      'userInteraction': ?pulumi.Input.mapOptionalInputValue<CVSSv3UserInteractionContaineranalysisV1beta1, String>(userInteraction, (value) => value.value),
    };
  }
