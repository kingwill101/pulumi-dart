...
class BuildProvenanceContaineranalysisV1alpha1 {
    ...
    return <String, dynamic>{
      ...
      'builtArtifacts':
          ?pulumi.Input.mapOptionalInputValue<
            List<ArtifactContaineranalysisV1alpha1>,
      ...
      'commands':
          ?pulumi.Input.mapOptionalInputValue<
            List<CommandContaineranalysisV1alpha1>,
            List<Map<String, dynamic>>
          >(
            commands,
            (value) =>
  ...
  factory BuildProvenanceContaineranalysisV1alpha1.fromMap(
    ...
    return BuildProvenanceContaineranalysisV1alpha1(
      buildOptions: (() {
        final guardedValue = map['buildOptions'];
      ...
      builtArtifacts: (() {
        final guardedValue = map['builtArtifacts'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      sourceProvenance: (() {
        final guardedValue = map['sourceProvenance'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
