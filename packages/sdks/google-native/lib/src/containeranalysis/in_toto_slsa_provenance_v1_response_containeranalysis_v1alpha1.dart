...
class InTotoSlsaProvenanceV1ResponseContaineranalysisV1alpha1 {
  final pulumi.Input<SlsaProvenanceV1ResponseContaineranalysisV1alpha1> predicate;
  ...
  const InTotoSlsaProvenanceV1ResponseContaineranalysisV1alpha1({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'predicate': pulumi.Input.mapInputValue<SlsaProvenanceV1ResponseContaineranalysisV1alpha1, Map<String, dynamic>>(predicate, (value) => value.toMap()),
  ...
  factory InTotoSlsaProvenanceV1ResponseContaineranalysisV1alpha1.fromMap(Map<String, dynamic> map) {
    return InTotoSlsaProvenanceV1ResponseContaineranalysisV1alpha1(
      predicate: pulumi.Input.fromValue(SlsaProvenanceV1ResponseContaineranalysisV1alpha1.fromMap((map['predicate']! as Map).cast<String, dynamic>())),
      predicateType: pulumi.Input.fromValue(map['predicateType'] as String),
      subject: pulumi.Input.fromValue(pulumi.Input.decodeList<SubjectResponseContaineranalysisV1alpha1>(map['subject']!, (value) => SubjectResponseContaineranalysisV1alpha1.fromMap((value as Map).cast<String, dynamic>()))),
