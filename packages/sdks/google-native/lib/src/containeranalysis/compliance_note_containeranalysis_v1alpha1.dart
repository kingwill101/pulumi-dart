...
class ComplianceNoteContaineranalysisV1alpha1 {
  ...
  const ComplianceNoteContaineranalysisV1alpha1({
    this.cisBenchmark,
    this.description,
    this.rationale,
    this.remediation,
  ...
  factory ComplianceNoteContaineranalysisV1alpha1.fromMap(Map<String, dynamic> map) {
    return ComplianceNoteContaineranalysisV1alpha1(
      cisBenchmark: (() { final guardedValue = map['cisBenchmark']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CisBenchmarkContaineranalysisV1alpha1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      version: (() { final guardedValue = map['version']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ComplianceVersionContaineranalysisV1alpha1>(guardedValue, (value) => ComplianceVersionContaineranalysisV1alpha1.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
