...
class SourceResponseContaineranalysisV1alpha1 {
  ...
  final List<GoogleDevtoolsContaineranalysisV1alpha1SourceContextResponse> additionalContexts;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'additionalContexts': pulumi.Input.encodeList<GoogleDevtoolsContaineranalysisV1alpha1SourceContextResponse, Map<String, dynamic>>(additionalContexts, (value) => value.toMap()),
  ...
  factory SourceResponseContaineranalysisV1alpha1.fromMap(Map<String, dynamic> map) {
    return SourceResponseContaineranalysisV1alpha1(
      additionalContexts: pulumi.Input.decodeList<GoogleDevtoolsContaineranalysisV1alpha1SourceContextResponse>(map['additionalContexts'], (value) => GoogleDevtoolsContaineranalysisV1alpha1SourceContextResponse.fromMap((value as Map).cast<String, dynamic>())),
      artifactStorageSource: StorageSourceResponse.fromMap((map['artifactStorageSource'] as Map).cast<String, dynamic>()),
      context: GoogleDevtoolsContaineranalysisV1alpha1SourceContextResponse.fromMap((map['context'] as Map).cast<String, dynamic>()),
