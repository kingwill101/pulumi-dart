...
class SourceResponseContaineranalysisV1alpha1 {
  ...
  factory SourceResponseContaineranalysisV1alpha1.fromMap(Map<String, dynamic> map) {
    return SourceResponseContaineranalysisV1alpha1(
      additionalContexts: (pulumi.Input.decodeList<GoogleDevtoolsContaineranalysisV1alpha1SourceContextResponse>(map['additionalContexts'], (value) => GoogleDevtoolsContaineranalysisV1alpha1SourceContextResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      artifactStorageSource: (StorageSourceResponse.fromMap((map['artifactStorageSource'] as Map).cast<String, dynamic>())).input(),
      context: (GoogleDevtoolsContaineranalysisV1alpha1SourceContextResponse.fromMap((map['context'] as Map).cast<String, dynamic>())).input(),
