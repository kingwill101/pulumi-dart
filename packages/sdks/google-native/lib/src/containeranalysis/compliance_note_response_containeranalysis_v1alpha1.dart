...
class ComplianceNoteResponseContaineranalysisV1alpha1 {
  ...
  factory ComplianceNoteResponseContaineranalysisV1alpha1.fromMap(Map<String, dynamic> map) {
    return ComplianceNoteResponseContaineranalysisV1alpha1(
      cisBenchmark: pulumi.Input.fromValue(CisBenchmarkResponseContaineranalysisV1alpha1.fromMap((map['cisBenchmark']! as Map).cast<String, dynamic>())),
      ...
      version: pulumi.Input.fromValue(pulumi.Input.decodeList<ComplianceVersionResponseContaineranalysisV1alpha1>(map['version']!, (value) => ComplianceVersionResponseContaineranalysisV1alpha1.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
