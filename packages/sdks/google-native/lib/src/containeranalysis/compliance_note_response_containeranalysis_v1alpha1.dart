...
class ComplianceNoteResponseContaineranalysisV1alpha1 {
  ...
  final pulumi.Input<CisBenchmarkResponseContaineranalysisV1alpha1>
  cisBenchmark;
  ...
  final pulumi.Input<List<ComplianceVersionResponseContaineranalysisV1alpha1>>
  version;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'version':
          pulumi.Input.mapInputValue<
            List<ComplianceVersionResponseContaineranalysisV1alpha1>,
  ...
  factory ComplianceNoteResponseContaineranalysisV1alpha1.fromMap(
    ...
    return ComplianceNoteResponseContaineranalysisV1alpha1(
      cisBenchmark: pulumi.Input.fromValue(
        CisBenchmarkResponseContaineranalysisV1alpha1.fromMap(
      ...
      scanInstructions: pulumi.Input.fromValue(
