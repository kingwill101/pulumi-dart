...
class RepoIdContaineranalysisV1beta1 {
  ...
  const RepoIdContaineranalysisV1beta1({
    this.projectRepoId,
    this.uid,
  });
  ...
  factory RepoIdContaineranalysisV1beta1.fromMap(Map<String, dynamic> map) {
    return RepoIdContaineranalysisV1beta1(
      projectRepoId: (() { final guardedValue = map['projectRepoId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ProjectRepoIdContaineranalysisV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
