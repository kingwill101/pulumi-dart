...
class DSSEAttestationOccurrence {
  ...
  factory DSSEAttestationOccurrence.fromMap(Map<String, dynamic> map) {
    return DSSEAttestationOccurrence(
      ...
      statement: (() { final guardedValue = map['statement']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InTotoStatement.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
