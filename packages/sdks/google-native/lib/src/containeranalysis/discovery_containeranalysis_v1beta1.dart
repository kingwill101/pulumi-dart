...
class DiscoveryContaineranalysisV1beta1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'analysisKind': pulumi.Input.mapInputValue<DiscoveryAnalysisKindContaineranalysisV1beta1, String>(analysisKind, (value) => value.value),
    };
  }

  factory DiscoveryContaineranalysisV1beta1.fromMap(Map<String, dynamic> map) {
    return DiscoveryContaineranalysisV1beta1(
      analysisKind: (DiscoveryAnalysisKindContaineranalysisV1beta1.fromValue(map['analysisKind'] as String)).input(),
    );
  }
}
