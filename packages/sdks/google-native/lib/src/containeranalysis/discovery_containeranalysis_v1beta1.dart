...
class DiscoveryContaineranalysisV1beta1 {
  ...
  final pulumi.Input<DiscoveryAnalysisKindContaineranalysisV1beta1> analysisKind;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'analysisKind': pulumi.Input.mapInputValue<DiscoveryAnalysisKindContaineranalysisV1beta1, String>(analysisKind, (value) => value.wireValue),
    };
  }

  factory DiscoveryContaineranalysisV1beta1.fromMap(Map<String, dynamic> map) {
    return DiscoveryContaineranalysisV1beta1(
      analysisKind: pulumi.Input.fromValue(DiscoveryAnalysisKindContaineranalysisV1beta1.fromValue(map['analysisKind']! as String)),
    );
  }
}
