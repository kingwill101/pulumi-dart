...
class GrafeasV1beta1IntotoDetailsResponse {
  ...
  factory GrafeasV1beta1IntotoDetailsResponse.fromMap(Map<String, dynamic> map) {
    return GrafeasV1beta1IntotoDetailsResponse(
      signatures: (pulumi.Input.decodeList<GrafeasV1beta1IntotoSignatureResponse>(map['signatures'], (value) => GrafeasV1beta1IntotoSignatureResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      signed: (LinkResponse.fromMap((map['signed'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
