...
class SlsaMetadataResponseContaineranalysisV1alpha1 {
  ...
  const SlsaMetadataResponseContaineranalysisV1alpha1({
  ...
  factory SlsaMetadataResponseContaineranalysisV1alpha1.fromMap(Map<String, dynamic> map) {
    return SlsaMetadataResponseContaineranalysisV1alpha1(
      ...
      completeness: pulumi.Input.fromValue(SlsaCompletenessResponseContaineranalysisV1alpha1.fromMap((map['completeness']! as Map).cast<String, dynamic>())),
