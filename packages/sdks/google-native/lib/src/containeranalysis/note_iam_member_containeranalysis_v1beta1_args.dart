...
/// {@template pulumi_containeranalysis_v1beta1_note_iam_member_containeranalysis_v1beta1_args_doc}
/// The set of arguments for NoteIamMember.
/// {@endtemplate}
/// {@macro pulumi_containeranalysis_v1beta1_note_iam_member_containeranalysis_v1beta1_args_doc}
class NoteIamMemberContaineranalysisV1beta1Args {
  ...
  /// Creates a new [NoteIamMemberContaineranalysisV1beta1Args].
  ...
  const NoteIamMemberContaineranalysisV1beta1Args({
    this.condition,
  ...
  factory NoteIamMemberContaineranalysisV1beta1Args.fromMap(Map<String, dynamic> map) {
    return NoteIamMemberContaineranalysisV1beta1Args(
