...
class MetadataResponseContaineranalysisV1alpha1 {
  ...
  final pulumi.Input<CompletenessResponseContaineranalysisV1alpha1>
  completeness;
  ...
  factory MetadataResponseContaineranalysisV1alpha1.fromMap(
    ...
    return MetadataResponseContaineranalysisV1alpha1(
      ...
      completeness: pulumi.Input.fromValue(
        CompletenessResponseContaineranalysisV1alpha1.fromMap(
