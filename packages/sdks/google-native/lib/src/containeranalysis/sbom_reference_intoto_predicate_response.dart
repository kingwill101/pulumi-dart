...
class SbomReferenceIntotoPredicateResponse {
  ...
  /// Creates a new [SbomReferenceIntotoPredicateResponse].
  ...
  const SbomReferenceIntotoPredicateResponse({
  ...
  factory SbomReferenceIntotoPredicateResponse.fromMap(Map<String, dynamic> map) {
    return SbomReferenceIntotoPredicateResponse(
