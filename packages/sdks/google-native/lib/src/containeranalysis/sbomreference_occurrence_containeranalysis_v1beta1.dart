...
class SBOMReferenceOccurrenceContaineranalysisV1beta1 {
  ...
  final pulumi.Input<SbomReferenceIntotoPayloadContaineranalysisV1beta1>?
  payload;
  ...
  final pulumi.Input<List<EnvelopeSignatureContaineranalysisV1beta1>>?
  signatures;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'signatures':
          ?pulumi.Input.mapOptionalInputValue<
            List<EnvelopeSignatureContaineranalysisV1beta1>,
