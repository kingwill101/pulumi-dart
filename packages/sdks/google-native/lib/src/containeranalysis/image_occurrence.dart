...
class ImageOccurrence {
  ...
  factory ImageOccurrence.fromMap(Map<String, dynamic> map) {
    return ImageOccurrence(
      fingerprint: pulumi.Input.fromValue(Fingerprint.fromMap((map['fingerprint']! as Map).cast<String, dynamic>())),
      layerInfo: (() { final guardedValue = map['layerInfo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<Layer>(guardedValue, (value) => Layer.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
