...
class SlsaProvenanceResponseContaineranalysisV1alpha1 {
  ...
  factory SlsaProvenanceResponseContaineranalysisV1alpha1.fromMap(Map<String, dynamic> map) {
    return SlsaProvenanceResponseContaineranalysisV1alpha1(
      ...
      materials: (pulumi.Input.decodeList<MaterialResponseContaineranalysisV1alpha1>(map['materials'], (value) => MaterialResponseContaineranalysisV1alpha1.fromMap((value as Map).cast<String, dynamic>()))).input(),
      metadata: (SlsaMetadataResponseContaineranalysisV1alpha1.fromMap((map['metadata'] as Map).cast<String, dynamic>())).input(),
      recipe: (SlsaRecipeResponseContaineranalysisV1alpha1.fromMap((map['recipe'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
