...
class SlsaProvenanceResponseContaineranalysisV1alpha1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'builder': builder,
      'materials': pulumi.Input.mapInputValue<List<MaterialResponseContaineranalysisV1alpha1>, List<Map<String, dynamic>>>(materials, (value) => pulumi.Input.encodeList<MaterialResponseContaineranalysisV1alpha1, Map<String, dynamic>>(value, (value) => value.toMap())),
      'metadata': pulumi.Input.mapInputValue<SlsaMetadataResponseContaineranalysisV1alpha1, Map<String, dynamic>>(metadata, (value) => value.toMap()),
      'recipe': pulumi.Input.mapInputValue<SlsaRecipeResponseContaineranalysisV1alpha1, Map<String, dynamic>>(recipe, (value) => value.toMap()),
    };
  }
  ...
  factory SlsaProvenanceResponseContaineranalysisV1alpha1.fromMap(Map<String, dynamic> map) {
    return SlsaProvenanceResponseContaineranalysisV1alpha1(
      ...
      materials: pulumi.Input.fromValue(pulumi.Input.decodeList<MaterialResponseContaineranalysisV1alpha1>(map['materials']!, (value) => MaterialResponseContaineranalysisV1alpha1.fromMap((value as Map).cast<String, dynamic>()))),
      metadata: pulumi.Input.fromValue(SlsaMetadataResponseContaineranalysisV1alpha1.fromMap((map['metadata']! as Map).cast<String, dynamic>())),
      recipe: pulumi.Input.fromValue(SlsaRecipeResponseContaineranalysisV1alpha1.fromMap((map['recipe']! as Map).cast<String, dynamic>())),
    );
  }
}
