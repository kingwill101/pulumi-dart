...
class RecipeResponseContaineranalysisV1alpha1 {
  ...
  factory RecipeResponseContaineranalysisV1alpha1.fromMap(Map<String, dynamic> map) {
    return RecipeResponseContaineranalysisV1alpha1(
      arguments: ((map['arguments'] as List).cast<Map<String, String>>()).input(),
      definedInMaterial: (map['definedInMaterial'] as String).input(),
      entryPoint: (map['entryPoint'] as String).input(),
      environment: ((map['environment'] as List).cast<Map<String, String>>()).input(),
