...
class AttestationContaineranalysisV1beta1 {
  ...
  final pulumi.Input<PgpSignedAttestationContaineranalysisV1beta1>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'pgpSignedAttestation':
          ?pulumi.Input.mapOptionalInputValue<
            PgpSignedAttestationContaineranalysisV1beta1,
            Map<String, dynamic>
  ...
  factory AttestationContaineranalysisV1beta1.fromMap(
    ...
    return AttestationContaineranalysisV1beta1(
      genericSignedAttestation: (() {
        final guardedValue = map['genericSignedAttestation'];
