...
class PgpSignedAttestationResponseContaineranalysisV1beta1 {
  ...
  /// Creates a new [PgpSignedAttestationResponseContaineranalysisV1beta1].
  ...
  const PgpSignedAttestationResponseContaineranalysisV1beta1({
    required this.contentType,
    required this.pgpKeyId,
  ...
  factory PgpSignedAttestationResponseContaineranalysisV1beta1.fromMap(Map<String, dynamic> map) {
    return PgpSignedAttestationResponseContaineranalysisV1beta1(
      contentType: pulumi.Input.fromValue(map['contentType'] as String),
      pgpKeyId: pulumi.Input.fromValue(map['pgpKeyId'] as String),
