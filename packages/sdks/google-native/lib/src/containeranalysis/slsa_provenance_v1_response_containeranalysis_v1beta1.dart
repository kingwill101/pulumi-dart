...
class SlsaProvenanceV1ResponseContaineranalysisV1beta1 {
  ...
  factory SlsaProvenanceV1ResponseContaineranalysisV1beta1.fromMap(Map<String, dynamic> map) {
    return SlsaProvenanceV1ResponseContaineranalysisV1beta1(
      buildDefinition: (BuildDefinitionResponseContaineranalysisV1beta1.fromMap((map['buildDefinition'] as Map).cast<String, dynamic>())).input(),
      runDetails: (RunDetailsResponseContaineranalysisV1beta1.fromMap((map['runDetails'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
