...
class Discovered {
  ...
  final pulumi.Input<AnalysisCompletedContaineranalysisV1alpha1>?
  analysisCompleted;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'analysisError':
          ?pulumi.Input.mapOptionalInputValue<
            List<StatusContaineranalysisV1alpha1>,
      ...
      'analysisStatus':
          ?pulumi.Input.mapOptionalInputValue<DiscoveredAnalysisStatus, String>(
            analysisStatus,
  ...
  factory Discovered.fromMap(Map<String, dynamic> map) {
    return Discovered(
      ...
      analysisStatus: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DiscoveredAnalysisStatus.fromValue(guardedValue as String),
        );
      })(),
      analysisStatusError: (() {
      ...
      continuousAnalysis: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DiscoveredContinuousAnalysis.fromValue(guardedValue as String),
        );
      })(),
      cpe: (() {
