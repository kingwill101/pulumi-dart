...
class UpgradeNoteContaineranalysisV1alpha1 {
  ...
  final pulumi.Input<List<UpgradeDistributionContaineranalysisV1alpha1>>?
  distributions;
    ...
    return <String, dynamic>{
      'distributions':
          ?pulumi.Input.mapOptionalInputValue<
            List<UpgradeDistributionContaineranalysisV1alpha1>,
    ...
    return UpgradeNoteContaineranalysisV1alpha1(
      distributions: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<UpgradeDistributionContaineranalysisV1alpha1>(
            guardedValue,
