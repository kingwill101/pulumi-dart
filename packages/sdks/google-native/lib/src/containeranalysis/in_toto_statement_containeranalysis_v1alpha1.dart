...
class InTotoStatementContaineranalysisV1alpha1 {
  ...
  const InTotoStatementContaineranalysisV1alpha1({
    this.predicateType,
    this.provenance,
    this.slsaProvenance,
  ...
  factory InTotoStatementContaineranalysisV1alpha1.fromMap(Map<String, dynamic> map) {
    return InTotoStatementContaineranalysisV1alpha1(
      ...
      provenance: (() { final guardedValue = map['provenance']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InTotoProvenanceContaineranalysisV1alpha1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      slsaProvenance: (() { final guardedValue = map['slsaProvenance']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SlsaProvenanceContaineranalysisV1alpha1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      slsaProvenanceZeroTwo: (() { final guardedValue = map['slsaProvenanceZeroTwo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SlsaProvenanceZeroTwoContaineranalysisV1alpha1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
