...
class PackageNote {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'architecture':
          ?pulumi.Input.mapOptionalInputValue<PackageNoteArchitecture, String>(
            architecture,
      ...
      'digest':
          ...
          >(
            digest,
            (value) => pulumi.Input.encodeList<Digest, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
    ...
    return PackageNote(
      architecture: (() {
        ...
        return pulumi.Input.fromValue(
          PackageNoteArchitecture.fromValue(guardedValue as String),
        );
      })(),
      cpeUri: (() {
