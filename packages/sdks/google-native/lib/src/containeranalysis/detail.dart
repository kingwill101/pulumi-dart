...
class Detail {
  ...
  factory Detail.fromMap(Map<String, dynamic> map) {
    return Detail(
      ...
      affectedVersionEnd: (() {
        final guardedValue = map['affectedVersionEnd'];
      ...
      affectedVersionStart: (() {
        final guardedValue = map['affectedVersionStart'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          Version.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      ...
      fixedCpeUri: (() {
        final guardedValue = map['fixedCpeUri'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      fixedPackage: (() {
        final guardedValue = map['fixedPackage'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      fixedVersion: (() {
        final guardedValue = map['fixedVersion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          Version.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
