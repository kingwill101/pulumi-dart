...
class SBOMReferenceOccurrenceContaineranalysisV1alpha1 {
  ...
  final pulumi.Input<SbomReferenceIntotoPayloadContaineranalysisV1alpha1>?
  payload;
  ...
  final pulumi.Input<List<EnvelopeSignatureContaineranalysisV1alpha1>>?
  signatures;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'signatures':
          ?pulumi.Input.mapOptionalInputValue<
            List<EnvelopeSignatureContaineranalysisV1alpha1>,
