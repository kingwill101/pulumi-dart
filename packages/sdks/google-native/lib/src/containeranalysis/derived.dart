...
class Derived {
  ...
  factory Derived.fromMap(Map<String, dynamic> map) {
    return Derived(
      ...
      layerInfo: (() { final guardedValue = map['layerInfo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<LayerContaineranalysisV1alpha1>(guardedValue, (value) => LayerContaineranalysisV1alpha1.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
