...
class ReplicationSecretmanagerV1beta1 {
  ...
  factory ReplicationSecretmanagerV1beta1.fromMap(Map<String, dynamic> map) {
    return ReplicationSecretmanagerV1beta1(
      automatic: (() { final guardedValue = map['automatic']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, dynamic>()); })(),
      userManaged: (() { final guardedValue = map['userManaged']; if (guardedValue == null) return null; return pulumi.Input.fromValue(UserManagedSecretmanagerV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
