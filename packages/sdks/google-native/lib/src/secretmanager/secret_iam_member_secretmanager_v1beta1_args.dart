...
/// {@template pulumi_secretmanager_v1beta1_secret_iam_member_secretmanager_v1beta1_args_doc}
/// The set of arguments for SecretIamMember.
/// {@endtemplate}
/// {@macro pulumi_secretmanager_v1beta1_secret_iam_member_secretmanager_v1beta1_args_doc}
class SecretIamMemberSecretmanagerV1beta1Args {
  ...
  /// Creates a new [SecretIamMemberSecretmanagerV1beta1Args].
  ...
  const SecretIamMemberSecretmanagerV1beta1Args({
    this.condition,
  ...
  factory SecretIamMemberSecretmanagerV1beta1Args.fromMap(Map<String, dynamic> map) {
    return SecretIamMemberSecretmanagerV1beta1Args(
