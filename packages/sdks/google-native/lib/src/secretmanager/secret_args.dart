...
class SecretArgs {
  ...
  factory SecretArgs.fromMap(Map<String, dynamic> map) {
    return SecretArgs(
      ...
      replication: pulumi.Input.fromValue(Replication.fromMap((map['replication']! as Map).cast<String, dynamic>())),
      rotation: (() { final guardedValue = map['rotation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Rotation.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      secretId: pulumi.Input.fromValue(map['secretId'] as String),
      topics: (() { final guardedValue = map['topics']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<Topic>(guardedValue, (value) => Topic.fromMap((value as Map).cast<String, dynamic>()))); })(),
