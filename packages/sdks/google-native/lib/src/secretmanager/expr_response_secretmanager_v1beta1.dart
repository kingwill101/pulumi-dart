...
class ExprResponseSecretmanagerV1beta1 {
  ...
  /// Creates a new [ExprResponseSecretmanagerV1beta1].
  ...
  const ExprResponseSecretmanagerV1beta1({
  ...
  factory ExprResponseSecretmanagerV1beta1.fromMap(Map<String, dynamic> map) {
    return ExprResponseSecretmanagerV1beta1(
