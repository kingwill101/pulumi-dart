...
/// {@template pulumi_secretmanager_v1beta1_secret_iam_binding_secretmanager_v1beta1_args_doc}
/// The set of arguments for SecretIamBinding.
/// {@endtemplate}
/// {@macro pulumi_secretmanager_v1beta1_secret_iam_binding_secretmanager_v1beta1_args_doc}
class SecretIamBindingSecretmanagerV1beta1Args {
  ...
  /// Creates a new [SecretIamBindingSecretmanagerV1beta1Args].
  ...
  SecretIamBindingSecretmanagerV1beta1Args({
    this.condition,
  ...
  factory SecretIamBindingSecretmanagerV1beta1Args.fromMap(
