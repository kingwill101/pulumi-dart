...
class UserManagedResponseSecretmanagerV1beta1 {
  ...
  final pulumi.Input<List<ReplicaResponseSecretmanagerV1beta1>> replicas;
  ...
  factory UserManagedResponseSecretmanagerV1beta1.fromMap(Map<String, dynamic> map) {
    return UserManagedResponseSecretmanagerV1beta1(
      replicas: (pulumi.Input.decodeList<ReplicaResponseSecretmanagerV1beta1>(map['replicas'], (value) => ReplicaResponseSecretmanagerV1beta1.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
