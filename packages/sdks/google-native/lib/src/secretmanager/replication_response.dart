...
class ReplicationResponse {
  ...
  factory ReplicationResponse.fromMap(Map<String, dynamic> map) {
    return ReplicationResponse(
      automatic: pulumi.Input.fromValue(AutomaticResponse.fromMap((map['automatic']! as Map).cast<String, dynamic>())),
      userManaged: pulumi.Input.fromValue(UserManagedResponse.fromMap((map['userManaged']! as Map).cast<String, dynamic>())),
    );
  }
}
