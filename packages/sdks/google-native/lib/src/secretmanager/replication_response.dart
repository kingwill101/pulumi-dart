...
class ReplicationResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'automatic':
          pulumi.Input.mapInputValue<AutomaticResponse, Map<String, dynamic>>(
            automatic,
            (value) => value.toMap(),
          ),
      'userManaged':
          pulumi.Input.mapInputValue<UserManagedResponse, Map<String, dynamic>>(
            userManaged,
            (value) => value.toMap(),
          ),
    };
