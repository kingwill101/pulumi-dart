...
class UserManagedSecretmanagerV1beta1 {
  ...
  factory UserManagedSecretmanagerV1beta1.fromMap(Map<String, dynamic> map) {
    return UserManagedSecretmanagerV1beta1(
      replicas: (pulumi.Input.decodeList<ReplicaSecretmanagerV1beta1>(map['replicas'], (value) => ReplicaSecretmanagerV1beta1.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
