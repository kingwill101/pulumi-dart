...
class CapacityCommitment extends pulumi.CustomResource {
  ...
  CapacityCommitment(
    ...
    failureStatus = registerOutput<StatusResponse>('failureStatus', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return StatusResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
