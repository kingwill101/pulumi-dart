...
class CapacityCommitmentBigqueryreservationV1beta1 extends pulumi.CustomResource {
  ...
  CapacityCommitmentBigqueryreservationV1beta1(
    ...
    this.enforceSingleAdminProjectPerOrg = registerOutput<bool?>('enforceSingleAdminProjectPerOrg');
    this.failureStatus = registerOutput<StatusResponseBigqueryreservationV1beta1>('failureStatus');
