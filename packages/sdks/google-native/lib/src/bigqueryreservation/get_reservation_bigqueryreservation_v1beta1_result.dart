...
class GetReservationBigqueryreservationV1beta1Result {
  ...
  /// Creates a new [GetReservationBigqueryreservationV1beta1Result].
  ...
  const GetReservationBigqueryreservationV1beta1Result({
  ...
  factory GetReservationBigqueryreservationV1beta1Result.fromMap(Map<String, dynamic> map) {
