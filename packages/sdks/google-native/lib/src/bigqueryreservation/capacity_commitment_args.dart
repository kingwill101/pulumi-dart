    ...
    return CapacityCommitmentArgs(
      ...
      edition: (() {
        ...
        return pulumi.Input.fromValue(
          CapacityCommitmentEdition.fromValue(guardedValue as String),
        );
      })(),
      ...
      plan: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CapacityCommitmentPlan.fromValue(guardedValue as String),
        );
      })(),
      project: (() {
      ...
      renewalPlan: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CapacityCommitmentRenewalPlan.fromValue(guardedValue as String),
        );
      })(),
      slotCount: (() {
