  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'apiTargets':
          ...
          >(
            apiTargets,
            (value) => pulumi.Input.encodeList<ApiTarget, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
    ...
    return Restrictions(
      androidKeyRestrictions: (() {
        ...
        return pulumi.Input.fromValue(
          AndroidKeyRestrictions.fromMap(
      ...
      apiTargets: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ApiTarget>(
            guardedValue,
            (value) =>
                ApiTarget.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      browserKeyRestrictions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          BrowserKeyRestrictions.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
