...
class RestrictionsResponse {
  ...
  factory RestrictionsResponse.fromMap(Map<String, dynamic> map) {
    return RestrictionsResponse(
      androidKeyRestrictions: pulumi.Input.fromValue(AndroidKeyRestrictionsResponse.fromMap((map['androidKeyRestrictions']! as Map).cast<String, dynamic>())),
      apiTargets: pulumi.Input.fromValue(pulumi.Input.decodeList<ApiTargetResponse>(map['apiTargets']!, (value) => ApiTargetResponse.fromMap((value as Map).cast<String, dynamic>()))),
      browserKeyRestrictions: pulumi.Input.fromValue(BrowserKeyRestrictionsResponse.fromMap((map['browserKeyRestrictions']! as Map).cast<String, dynamic>())),
      iosKeyRestrictions: pulumi.Input.fromValue(IosKeyRestrictionsResponse.fromMap((map['iosKeyRestrictions']! as Map).cast<String, dynamic>())),
      serverKeyRestrictions: pulumi.Input.fromValue(ServerKeyRestrictionsResponse.fromMap((map['serverKeyRestrictions']! as Map).cast<String, dynamic>())),
    );
  }
}
