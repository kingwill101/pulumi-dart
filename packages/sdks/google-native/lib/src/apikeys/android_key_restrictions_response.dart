...
class AndroidKeyRestrictionsResponse {
  ...
  factory AndroidKeyRestrictionsResponse.fromMap(Map<String, dynamic> map) {
    return AndroidKeyRestrictionsResponse(
      allowedApplications: pulumi.Input.fromValue(pulumi.Input.decodeList<AndroidApplicationResponse>(map['allowedApplications']!, (value) => AndroidApplicationResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
