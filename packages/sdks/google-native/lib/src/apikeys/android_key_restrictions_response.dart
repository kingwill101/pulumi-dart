...
class AndroidKeyRestrictionsResponse {
  ...
  final List<AndroidApplicationResponse> allowedApplications;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'allowedApplications': pulumi.Input.encodeList<AndroidApplicationResponse, Map<String, dynamic>>(allowedApplications, (value) => value.toMap()),
    };
  }

  factory AndroidKeyRestrictionsResponse.fromMap(Map<String, dynamic> map) {
    return AndroidKeyRestrictionsResponse(
      allowedApplications: pulumi.Input.decodeList<AndroidApplicationResponse>(map['allowedApplications'], (value) => AndroidApplicationResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
