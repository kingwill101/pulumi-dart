...
class KeyArgs {
  ...
  factory KeyArgs.fromMap(Map<String, dynamic> map) {
    return KeyArgs(
      ...
      restrictions: (() { final guardedValue = map['restrictions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Restrictions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
