...
class ClusterUpdate {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'desiredDatapathProvider': ?pulumi.Input.mapOptionalInputValue<ClusterUpdateDesiredDatapathProvider, String>(desiredDatapathProvider, (value) => value.wireValue),
      ...
      'desiredPrivateIpv6GoogleAccess': ?pulumi.Input.mapOptionalInputValue<ClusterUpdateDesiredPrivateIpv6GoogleAccess, String>(desiredPrivateIpv6GoogleAccess, (value) => value.wireValue),
      ...
      'desiredStackType': ?pulumi.Input.mapOptionalInputValue<ClusterUpdateDesiredStackType, String>(desiredStackType, (value) => value.wireValue),
  ...
  factory ClusterUpdate.fromMap(Map<String, dynamic> map) {
    return ClusterUpdate(
      additionalPodRangesConfig: (() { final guardedValue = map['additionalPodRangesConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AdditionalPodRangesConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      desiredAddonsConfig: (() { final guardedValue = map['desiredAddonsConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AddonsConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      desiredAuthenticatorGroupsConfig: (() { final guardedValue = map['desiredAuthenticatorGroupsConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AuthenticatorGroupsConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      desiredAutopilotWorkloadPolicyConfig: (() { final guardedValue = map['desiredAutopilotWorkloadPolicyConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WorkloadPolicyConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      desiredBinaryAuthorization: (() { final guardedValue = map['desiredBinaryAuthorization']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BinaryAuthorization.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      desiredClusterAutoscaling: (() { final guardedValue = map['desiredClusterAutoscaling']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterAutoscaling.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      desiredCostManagementConfig: (() { final guardedValue = map['desiredCostManagementConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CostManagementConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      desiredDatabaseEncryption: (() { final guardedValue = map['desiredDatabaseEncryption']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DatabaseEncryption.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      desiredDatapathProvider: (() { final guardedValue = map['desiredDatapathProvider']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterUpdateDesiredDatapathProvider.fromValue(guardedValue as String)); })(),
      desiredDefaultSnatStatus: (() { final guardedValue = map['desiredDefaultSnatStatus']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DefaultSnatStatus.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      desiredDnsConfig: (() { final guardedValue = map['desiredDnsConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DNSConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      desiredFleet: (() { final guardedValue = map['desiredFleet']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Fleet.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      desiredGatewayApiConfig: (() { final guardedValue = map['desiredGatewayApiConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GatewayAPIConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      desiredGcfsConfig: (() { final guardedValue = map['desiredGcfsConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GcfsConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      desiredIdentityServiceConfig: (() { final guardedValue = map['desiredIdentityServiceConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(IdentityServiceConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      desiredIntraNodeVisibilityConfig: (() { final guardedValue = map['desiredIntraNodeVisibilityConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(IntraNodeVisibilityConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      desiredK8sBetaApis: (() { final guardedValue = map['desiredK8sBetaApis']; if (guardedValue == null) return null; return pulumi.Input.fromValue(K8sBetaAPIConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      desiredL4ilbSubsettingConfig: (() { final guardedValue = map['desiredL4ilbSubsettingConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ILBSubsettingConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      desiredLoggingConfig: (() { final guardedValue = map['desiredLoggingConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LoggingConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      desiredMasterAuthorizedNetworksConfig: (() { final guardedValue = map['desiredMasterAuthorizedNetworksConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MasterAuthorizedNetworksConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      desiredMeshCertificates: (() { final guardedValue = map['desiredMeshCertificates']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MeshCertificates.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      desiredMonitoringConfig: (() { final guardedValue = map['desiredMonitoringConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MonitoringConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      desiredNetworkPerformanceConfig: (() { final guardedValue = map['desiredNetworkPerformanceConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterNetworkPerformanceConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      desiredNodePoolAutoConfigNetworkTags: (() { final guardedValue = map['desiredNodePoolAutoConfigNetworkTags']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkTags.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      desiredNodePoolAutoConfigResourceManagerTags: (() { final guardedValue = map['desiredNodePoolAutoConfigResourceManagerTags']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResourceManagerTags.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      desiredNodePoolAutoscaling: (() { final guardedValue = map['desiredNodePoolAutoscaling']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NodePoolAutoscaling.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      desiredNodePoolLoggingConfig: (() { final guardedValue = map['desiredNodePoolLoggingConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NodePoolLoggingConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      desiredNotificationConfig: (() { final guardedValue = map['desiredNotificationConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NotificationConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      desiredParentProductConfig: (() { final guardedValue = map['desiredParentProductConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ParentProductConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      desiredPrivateClusterConfig: (() { final guardedValue = map['desiredPrivateClusterConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PrivateClusterConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      desiredPrivateIpv6GoogleAccess: (() { final guardedValue = map['desiredPrivateIpv6GoogleAccess']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterUpdateDesiredPrivateIpv6GoogleAccess.fromValue(guardedValue as String)); })(),
      desiredReleaseChannel: (() { final guardedValue = map['desiredReleaseChannel']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ReleaseChannel.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      desiredResourceUsageExportConfig: (() { final guardedValue = map['desiredResourceUsageExportConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResourceUsageExportConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      desiredSecurityPostureConfig: (() { final guardedValue = map['desiredSecurityPostureConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SecurityPostureConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      desiredServiceExternalIpsConfig: (() { final guardedValue = map['desiredServiceExternalIpsConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServiceExternalIPsConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      desiredShieldedNodes: (() { final guardedValue = map['desiredShieldedNodes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ShieldedNodes.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      desiredStackType: (() { final guardedValue = map['desiredStackType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterUpdateDesiredStackType.fromValue(guardedValue as String)); })(),
      desiredVerticalPodAutoscaling: (() { final guardedValue = map['desiredVerticalPodAutoscaling']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VerticalPodAutoscaling.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      desiredWorkloadIdentityConfig: (() { final guardedValue = map['desiredWorkloadIdentityConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WorkloadIdentityConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      removedAdditionalPodRangesConfig: (() { final guardedValue = map['removedAdditionalPodRangesConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AdditionalPodRangesConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
