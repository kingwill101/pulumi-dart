...
class ClusterNetworkPerformanceConfig {
  ...
  final ClusterNetworkPerformanceConfigTotalEgressBandwidthTier? totalEgressBandwidthTier;
  ...
  factory ClusterNetworkPerformanceConfig.fromMap(Map<String, dynamic> map) {
    return ClusterNetworkPerformanceConfig(
      totalEgressBandwidthTier: map['totalEgressBandwidthTier'] == null ? null : ClusterNetworkPerformanceConfigTotalEgressBandwidthTier.fromValue(map['totalEgressBandwidthTier'] as String),
    );
  }
}
