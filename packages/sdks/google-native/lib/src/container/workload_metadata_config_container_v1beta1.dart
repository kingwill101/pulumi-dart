...
class WorkloadMetadataConfigContainerV1beta1 {
    ...
    return <String, dynamic>{
      'mode':
          ?pulumi.Input.mapOptionalInputValue<
            WorkloadMetadataConfigModeContainerV1beta1,
            String
      ...
      'nodeMetadata':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(nodeMetadata, (value) => value.wireValue),
    };
  }
  ...
  factory WorkloadMetadataConfigContainerV1beta1.fromMap(
    ...
    return WorkloadMetadataConfigContainerV1beta1(
      ...
      nodeMetadata: (() {
        final guardedValue = map['nodeMetadata'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          WorkloadMetadataConfigNodeMetadata.fromValue(guardedValue as String),
        );
      })(),
    );
  }
