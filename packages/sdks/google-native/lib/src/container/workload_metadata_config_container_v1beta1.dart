...
class WorkloadMetadataConfigContainerV1beta1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'mode': ?pulumi.Input.mapOptionalInputValue<WorkloadMetadataConfigModeContainerV1beta1, String>(mode, (value) => value.value),
      'nodeMetadata': ?pulumi.Input.mapOptionalInputValue<WorkloadMetadataConfigNodeMetadata, String>(nodeMetadata, (value) => value.value),
    };
  }
