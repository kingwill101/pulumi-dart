...
class UpgradeSettings {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'strategy': ?pulumi.Input.mapOptionalInputValue<UpgradeSettingsStrategy, String>(strategy, (value) => value.value),
    };
  }

  factory UpgradeSettings.fromMap(Map<String, dynamic> map) {
    return UpgradeSettings(
      blueGreenSettings: map['blueGreenSettings'] == null ? null : (BlueGreenSettings.fromMap((map['blueGreenSettings'] as Map).cast<String, dynamic>())).input(),
      ...
      strategy: map['strategy'] == null ? null : (UpgradeSettingsStrategy.fromValue(map['strategy'] as String)).input(),
    );
  }
}
