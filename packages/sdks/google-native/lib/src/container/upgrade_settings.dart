...
class UpgradeSettings {
  ...
  final pulumi.Input<BlueGreenSettings>? blueGreenSettings;
  ...
  final pulumi.Input<UpgradeSettingsStrategy>? strategy;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'blueGreenSettings': ?pulumi.Input.mapOptionalInputValue<BlueGreenSettings, Map<String, dynamic>>(blueGreenSettings, (value) => value.toMap()),
      'maxSurge': ?maxSurge,
      'maxUnavailable': ?maxUnavailable,
      'strategy': ?pulumi.Input.mapOptionalInputValue<UpgradeSettingsStrategy, String>(strategy, (value) => value.wireValue),
    };
  }

  factory UpgradeSettings.fromMap(Map<String, dynamic> map) {
    return UpgradeSettings(
      blueGreenSettings: (() { final guardedValue = map['blueGreenSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BlueGreenSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      strategy: (() { final guardedValue = map['strategy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(UpgradeSettingsStrategy.fromValue(guardedValue as String)); })(),
    );
  }
}
