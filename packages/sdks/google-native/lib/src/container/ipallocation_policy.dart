...
class IPAllocationPolicy {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ipv6AccessType': ?pulumi.Input.mapOptionalInputValue<IPAllocationPolicyIpv6AccessType, String>(ipv6AccessType, (value) => value.wireValue),
      ...
      'stackType': ?pulumi.Input.mapOptionalInputValue<IPAllocationPolicyStackType, String>(stackType, (value) => value.wireValue),
  ...
  factory IPAllocationPolicy.fromMap(Map<String, dynamic> map) {
    return IPAllocationPolicy(
      ...
      ipv6AccessType: (() { final guardedValue = map['ipv6AccessType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(IPAllocationPolicyIpv6AccessType.fromValue(guardedValue as String)); })(),
      ...
      stackType: (() { final guardedValue = map['stackType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(IPAllocationPolicyStackType.fromValue(guardedValue as String)); })(),
