...
class MaintenanceWindowContainerV1beta1 {
  ...
  const MaintenanceWindowContainerV1beta1({
  ...
  factory MaintenanceWindowContainerV1beta1.fromMap(Map<String, dynamic> map) {
    return MaintenanceWindowContainerV1beta1(
      dailyMaintenanceWindow: (() { final guardedValue = map['dailyMaintenanceWindow']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DailyMaintenanceWindowContainerV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      recurringWindow: (() { final guardedValue = map['recurringWindow']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RecurringTimeWindowContainerV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
