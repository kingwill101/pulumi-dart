...
class DNSConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'clusterDns': ?pulumi.Input.mapOptionalInputValue<DNSConfigClusterDns, String>(clusterDns, (value) => value.wireValue),
      'clusterDnsDomain': ?clusterDnsDomain,
      'clusterDnsScope': ?pulumi.Input.mapOptionalInputValue<DNSConfigClusterDnsScope, String>(clusterDnsScope, (value) => value.wireValue),
    };
  }

  factory DNSConfig.fromMap(Map<String, dynamic> map) {
    return DNSConfig(
      clusterDns: (() { final guardedValue = map['clusterDns']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DNSConfigClusterDns.fromValue(guardedValue as String)); })(),
      ...
      clusterDnsScope: (() { final guardedValue = map['clusterDnsScope']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DNSConfigClusterDnsScope.fromValue(guardedValue as String)); })(),
    );
  }
}
