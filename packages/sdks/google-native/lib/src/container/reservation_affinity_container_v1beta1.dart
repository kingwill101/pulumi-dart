...
class ReservationAffinityContainerV1beta1 {
  ...
  final ReservationAffinityConsumeReservationTypeContainerV1beta1? consumeReservationType;
  ...
  factory ReservationAffinityContainerV1beta1.fromMap(Map<String, dynamic> map) {
    return ReservationAffinityContainerV1beta1(
      consumeReservationType: map['consumeReservationType'] == null ? null : ReservationAffinityConsumeReservationTypeContainerV1beta1.fromValue(map['consumeReservationType'] as String),
