...
class DatabaseEncryptionContainerV1beta1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'keyName': ?keyName,
      'state': ?pulumi.Input.mapOptionalInputValue<DatabaseEncryptionStateContainerV1beta1, String>(state, (value) => value.wireValue),
    };
  }
  ...
  factory DatabaseEncryptionContainerV1beta1.fromMap(Map<String, dynamic> map) {
    return DatabaseEncryptionContainerV1beta1(
      ...
      state: (() { final guardedValue = map['state']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DatabaseEncryptionStateContainerV1beta1.fromValue(guardedValue as String)); })(),
    );
  }
}
