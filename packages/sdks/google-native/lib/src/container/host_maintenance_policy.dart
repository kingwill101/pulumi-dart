...
class HostMaintenancePolicy {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'maintenanceInterval': ?pulumi.Input.mapOptionalInputValue<HostMaintenancePolicyMaintenanceInterval, String>(maintenanceInterval, (value) => value.wireValue),
  ...
  factory HostMaintenancePolicy.fromMap(Map<String, dynamic> map) {
    return HostMaintenancePolicy(
      maintenanceInterval: (() { final guardedValue = map['maintenanceInterval']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HostMaintenancePolicyMaintenanceInterval.fromValue(guardedValue as String)); })(),
      opportunisticMaintenanceStrategy: (() { final guardedValue = map['opportunisticMaintenanceStrategy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OpportunisticMaintenanceStrategy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
