...
class NodeConfig {
  ...
  factory NodeConfig.fromMap(Map<String, dynamic> map) {
    return NodeConfig(
      ...
      ephemeralStorageLocalSsdConfig: map['ephemeralStorageLocalSsdConfig'] == null ? null : (EphemeralStorageLocalSsdConfig.fromMap((map['ephemeralStorageLocalSsdConfig']! as Map).cast<String, dynamic>())).input(),
      fastSocket: map['fastSocket'] == null ? null : (FastSocket.fromMap((map['fastSocket']! as Map).cast<String, dynamic>())).input(),
      gcfsConfig: map['gcfsConfig'] == null ? null : (GcfsConfig.fromMap((map['gcfsConfig']! as Map).cast<String, dynamic>())).input(),
      gvnic: map['gvnic'] == null ? null : (VirtualNIC.fromMap((map['gvnic']! as Map).cast<String, dynamic>())).input(),
      imageType: map['imageType'] == null ? null : (map['imageType']! as String).input(),
      kubeletConfig: map['kubeletConfig'] == null ? null : (NodeKubeletConfig.fromMap((map['kubeletConfig']! as Map).cast<String, dynamic>())).input(),
      labels: map['labels'] == null ? null : ((map['labels']! as Map).cast<String, String>()).input(),
      linuxNodeConfig: map['linuxNodeConfig'] == null ? null : (LinuxNodeConfig.fromMap((map['linuxNodeConfig']! as Map).cast<String, dynamic>())).input(),
      localNvmeSsdBlockConfig: map['localNvmeSsdBlockConfig'] == null ? null : (LocalNvmeSsdBlockConfig.fromMap((map['localNvmeSsdBlockConfig']! as Map).cast<String, dynamic>())).input(),
      ...
      sandboxConfig: map['sandboxConfig'] == null ? null : (SandboxConfig.fromMap((map['sandboxConfig']! as Map).cast<String, dynamic>())).input(),
      ...
      soleTenantConfig: map['soleTenantConfig'] == null ? null : (SoleTenantConfig.fromMap((map['soleTenantConfig']! as Map).cast<String, dynamic>())).input(),
      ...
      windowsNodeConfig: map['windowsNodeConfig'] == null ? null : (WindowsNodeConfig.fromMap((map['windowsNodeConfig']! as Map).cast<String, dynamic>())).input(),
      workloadMetadataConfig: map['workloadMetadataConfig'] == null ? null : (WorkloadMetadataConfig.fromMap((map['workloadMetadataConfig']! as Map).cast<String, dynamic>())).input(),
    );
  }
}
