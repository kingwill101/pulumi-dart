...
class NodeConfig {
  ...
  final pulumi.Input<EphemeralStorageLocalSsdConfig>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'fastSocket':
          ?pulumi.Input.mapOptionalInputValue<FastSocket, Map<String, dynamic>>(
            fastSocket,
            (value) => value.toMap(),
          ),
      'gcfsConfig':
      ...
      'gvnic':
          ?pulumi.Input.mapOptionalInputValue<VirtualNIC, Map<String, dynamic>>(
            gvnic,
            (value) => value.toMap(),
          ),
      'imageType': ?imageType,
  ...
  factory NodeConfig.fromMap(Map<String, dynamic> map) {
    return NodeConfig(
      ...
      fastSocket: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FastSocket.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      gcfsConfig: (() {
      ...
      gvnic: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VirtualNIC.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      imageType: (() {
      ...
      sandboxConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SandboxConfig.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      serviceAccount: (() {
