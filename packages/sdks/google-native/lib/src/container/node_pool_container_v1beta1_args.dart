...
class NodePoolContainerV1beta1Args {
  ...
  NodePoolContainerV1beta1Args({
    pulumi.Output<NodePoolAutoscalingContainerV1beta1>? autoscaling,
    pulumi.Output<BestEffortProvisioningContainerV1beta1>? bestEffortProvisioning,
    required pulumi.Output<String> clusterId,
    pulumi.Output<List<StatusConditionContainerV1beta1>>? conditions,
    pulumi.Output<NodeConfigContainerV1beta1>? config,
    pulumi.Output<String>? etag,
    pulumi.Output<int>? initialNodeCount,
    pulumi.Output<String>? location,
    pulumi.Output<List<String>>? locations,
    pulumi.Output<NodeManagementContainerV1beta1>? management,
    pulumi.Output<MaxPodsConstraintContainerV1beta1>? maxPodsConstraint,
    pulumi.Output<String>? name,
    pulumi.Output<NodeNetworkConfigContainerV1beta1>? networkConfig,
    pulumi.Output<String>? parent,
    pulumi.Output<PlacementPolicyContainerV1beta1>? placementPolicy,
    pulumi.Output<String>? project,
    pulumi.Output<QueuedProvisioningContainerV1beta1>? queuedProvisioning,
    pulumi.Output<UpgradeSettingsContainerV1beta1>? upgradeSettings,
  ...
  factory NodePoolContainerV1beta1Args.fromMap(Map<String, dynamic> map) {
    return NodePoolContainerV1beta1Args(
      autoscaling: map['autoscaling'] == null ? null : pulumi.Output.create<NodePoolAutoscalingContainerV1beta1>(NodePoolAutoscalingContainerV1beta1.fromMap((map['autoscaling'] as Map).cast<String, dynamic>())),
      bestEffortProvisioning: map['bestEffortProvisioning'] == null ? null : pulumi.Output.create<BestEffortProvisioningContainerV1beta1>(BestEffortProvisioningContainerV1beta1.fromMap((map['bestEffortProvisioning'] as Map).cast<String, dynamic>())),
      ...
      config: map['config'] == null ? null : pulumi.Output.create<NodeConfigContainerV1beta1>(NodeConfigContainerV1beta1.fromMap((map['config'] as Map).cast<String, dynamic>())),
      ...
      management: map['management'] == null ? null : pulumi.Output.create<NodeManagementContainerV1beta1>(NodeManagementContainerV1beta1.fromMap((map['management'] as Map).cast<String, dynamic>())),
      maxPodsConstraint: map['maxPodsConstraint'] == null ? null : pulumi.Output.create<MaxPodsConstraintContainerV1beta1>(MaxPodsConstraintContainerV1beta1.fromMap((map['maxPodsConstraint'] as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      networkConfig: map['networkConfig'] == null ? null : pulumi.Output.create<NodeNetworkConfigContainerV1beta1>(NodeNetworkConfigContainerV1beta1.fromMap((map['networkConfig'] as Map).cast<String, dynamic>())),
      parent: map['parent'] == null ? null : pulumi.Output.create<String>(map['parent'] as String),
      placementPolicy: map['placementPolicy'] == null ? null : pulumi.Output.create<PlacementPolicyContainerV1beta1>(PlacementPolicyContainerV1beta1.fromMap((map['placementPolicy'] as Map).cast<String, dynamic>())),
      project: map['project'] == null ? null : pulumi.Output.create<String>(map['project'] as String),
      queuedProvisioning: map['queuedProvisioning'] == null ? null : pulumi.Output.create<QueuedProvisioningContainerV1beta1>(QueuedProvisioningContainerV1beta1.fromMap((map['queuedProvisioning'] as Map).cast<String, dynamic>())),
      upgradeSettings: map['upgradeSettings'] == null ? null : pulumi.Output.create<UpgradeSettingsContainerV1beta1>(UpgradeSettingsContainerV1beta1.fromMap((map['upgradeSettings'] as Map).cast<String, dynamic>())),
