...
class ProtectConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'workloadVulnerabilityMode': ?pulumi.Input.mapOptionalInputValue<ProtectConfigWorkloadVulnerabilityMode, String>(workloadVulnerabilityMode, (value) => value.wireValue),
    };
  }

  factory ProtectConfig.fromMap(Map<String, dynamic> map) {
    return ProtectConfig(
      workloadConfig: (() { final guardedValue = map['workloadConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WorkloadConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      workloadVulnerabilityMode: (() { final guardedValue = map['workloadVulnerabilityMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ProtectConfigWorkloadVulnerabilityMode.fromValue(guardedValue as String)); })(),
    );
  }
}
