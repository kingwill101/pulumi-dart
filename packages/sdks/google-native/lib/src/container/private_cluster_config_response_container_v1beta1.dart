...
class PrivateClusterConfigResponseContainerV1beta1 {
  ...
  final PrivateClusterMasterGlobalAccessConfigResponseContainerV1beta1 masterGlobalAccessConfig;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'masterGlobalAccessConfig': masterGlobalAccessConfig.toMap(),
  ...
  factory PrivateClusterConfigResponseContainerV1beta1.fromMap(Map<String, dynamic> map) {
    return PrivateClusterConfigResponseContainerV1beta1(
      ...
      masterGlobalAccessConfig: PrivateClusterMasterGlobalAccessConfigResponseContainerV1beta1.fromMap((map['masterGlobalAccessConfig'] as Map).cast<String, dynamic>()),
