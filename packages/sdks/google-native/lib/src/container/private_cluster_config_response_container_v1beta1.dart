...
class PrivateClusterConfigResponseContainerV1beta1 {
  ...
  factory PrivateClusterConfigResponseContainerV1beta1.fromMap(
    ...
    return PrivateClusterConfigResponseContainerV1beta1(
      ...
      enablePrivateNodes: pulumi.Input.fromValue(
        map['enablePrivateNodes'] as bool,
      ),
      masterGlobalAccessConfig: pulumi.Input.fromValue(
        PrivateClusterMasterGlobalAccessConfigResponseContainerV1beta1.fromMap(
      ...
      privateEndpointSubnetwork: pulumi.Input.fromValue(
