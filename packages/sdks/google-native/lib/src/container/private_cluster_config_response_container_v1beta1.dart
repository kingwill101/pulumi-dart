...
class PrivateClusterConfigResponseContainerV1beta1 {
  ...
  final pulumi.Input<PrivateClusterMasterGlobalAccessConfigResponseContainerV1beta1> masterGlobalAccessConfig;
  ...
  /// Creates a new [PrivateClusterConfigResponseContainerV1beta1].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'masterGlobalAccessConfig': pulumi.Input.mapInputValue<PrivateClusterMasterGlobalAccessConfigResponseContainerV1beta1, Map<String, dynamic>>(masterGlobalAccessConfig, (value) => value.toMap()),
  ...
  factory PrivateClusterConfigResponseContainerV1beta1.fromMap(Map<String, dynamic> map) {
    return PrivateClusterConfigResponseContainerV1beta1(
      ...
      masterGlobalAccessConfig: (PrivateClusterMasterGlobalAccessConfigResponseContainerV1beta1.fromMap((map['masterGlobalAccessConfig'] as Map).cast<String, dynamic>())).input(),
      ...
      privateEndpointSubnetwork: (map['privateEndpointSubnetwork'] as String).input(),
