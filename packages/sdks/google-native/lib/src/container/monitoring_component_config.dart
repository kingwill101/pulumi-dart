...
class MonitoringComponentConfig {
  ...
  final pulumi.Input<List<MonitoringComponentConfigEnableComponentsItem>>?
  enableComponents;
    ...
    return <String, dynamic>{
      'enableComponents':
          ?pulumi.Input.mapOptionalInputValue<
            List<MonitoringComponentConfigEnableComponentsItem>,
            List<String>
          >(
            enableComponents,
            (value) =>
      ...
      enableComponents: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
            ...
            guardedValue,
            (value) => MonitoringComponentConfigEnableComponentsItem.fromValue(
              value as String,
            ),
          ),
        );
