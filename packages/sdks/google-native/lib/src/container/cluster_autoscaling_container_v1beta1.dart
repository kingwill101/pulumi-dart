...
class ClusterAutoscalingContainerV1beta1 {
  ...
  final pulumi.Input<AutoprovisioningNodePoolDefaultsContainerV1beta1>?
  autoprovisioningNodePoolDefaults;

  /// Defines autoscaling behaviour.
  final pulumi.Input<ClusterAutoscalingAutoscalingProfileContainerV1beta1>?
  autoscalingProfile;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'autoscalingProfile':
          ?pulumi.Input.mapOptionalInputValue<
            ClusterAutoscalingAutoscalingProfileContainerV1beta1,
            String
          >(autoscalingProfile, (value) => value.wireValue),
      'enableNodeAutoprovisioning': ?enableNodeAutoprovisioning,
      'resourceLimits':
          ?pulumi.Input.mapOptionalInputValue<
            List<ResourceLimitContainerV1beta1>,
  ...
  factory ClusterAutoscalingContainerV1beta1.fromMap(Map<String, dynamic> map) {
    return ClusterAutoscalingContainerV1beta1(
      ...
      autoprovisioningNodePoolDefaults: (() {
        final guardedValue = map['autoprovisioningNodePoolDefaults'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AutoprovisioningNodePoolDefaultsContainerV1beta1.fromMap(
      ...
      autoscalingProfile: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ClusterAutoscalingAutoscalingProfileContainerV1beta1.fromValue(
            guardedValue as String,
          ),
        );
      })(),
      enableNodeAutoprovisioning: (() {
        final guardedValue = map['enableNodeAutoprovisioning'];
        if (guardedValue == null) return null;
      ...
      resourceLimits: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ResourceLimitContainerV1beta1>(
            guardedValue,
            (value) => ResourceLimitContainerV1beta1.fromMap(
