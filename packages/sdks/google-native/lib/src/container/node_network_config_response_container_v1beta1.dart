...
class NodeNetworkConfigResponseContainerV1beta1 {
  ...
  final pulumi.Input<List<AdditionalNodeNetworkConfigResponseContainerV1beta1>>
  additionalNodeNetworkConfigs;

  /// We specify the additional pod networks for this node pool using this list. Each pod network corresponds to an additional alias IP range for the node
  final pulumi.Input<List<AdditionalPodNetworkConfigResponseContainerV1beta1>>
  ...
  final pulumi.Input<NetworkPerformanceConfigResponseContainerV1beta1>
    ...
    return <String, dynamic>{
      'additionalNodeNetworkConfigs':
          pulumi.Input.mapInputValue<
            List<AdditionalNodeNetworkConfigResponseContainerV1beta1>,
      ...
      'additionalPodNetworkConfigs':
          pulumi.Input.mapInputValue<
            List<AdditionalPodNetworkConfigResponseContainerV1beta1>,
            List<Map<String, dynamic>>
          >(
            additionalPodNetworkConfigs,
            (value) =>
  ...
  factory NodeNetworkConfigResponseContainerV1beta1.fromMap(
    ...
    return NodeNetworkConfigResponseContainerV1beta1(
      additionalNodeNetworkConfigs: pulumi.Input.fromValue(
      ...
      additionalPodNetworkConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          AdditionalPodNetworkConfigResponseContainerV1beta1
        >(
      ...
      podIpv4CidrBlock: pulumi.Input.fromValue(
        map['podIpv4CidrBlock'] as String,
      ),
      podIpv4RangeUtilization: pulumi.Input.fromValue(
        map['podIpv4RangeUtilization'] as double,
      ),
