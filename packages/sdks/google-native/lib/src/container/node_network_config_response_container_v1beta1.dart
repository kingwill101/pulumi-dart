...
class NodeNetworkConfigResponseContainerV1beta1 {
  ...
  final List<AdditionalNodeNetworkConfigResponseContainerV1beta1> additionalNodeNetworkConfigs;
  /// We specify the additional pod networks for this node pool using this list. Each pod network corresponds to an additional alias IP range for the node
  final List<AdditionalPodNetworkConfigResponseContainerV1beta1> additionalPodNetworkConfigs;
  ...
  final NetworkPerformanceConfigResponseContainerV1beta1 networkPerformanceConfig;
  /// [PRIVATE FIELD] Pod CIDR size overprovisioning config for the nodepool. Pod CIDR size per node depends on max_pods_per_node. By default, the value of max_pods_per_node is rounded off to next power of 2 and we then double that to get the size of pod CIDR block per node. Example: max_pods_per_node of 30 would result in 64 IPs (/26). This config can disable the doubling of IPs (we still round off to next power of 2) Example: max_pods_per_node of 30 will result in 32 IPs (/27) when overprovisioning is disabled.
  final PodCIDROverprovisionConfigResponseContainerV1beta1 podCidrOverprovisionConfig;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'additionalNodeNetworkConfigs': pulumi.Input.encodeList<AdditionalNodeNetworkConfigResponseContainerV1beta1, Map<String, dynamic>>(additionalNodeNetworkConfigs, (value) => value.toMap()),
      'additionalPodNetworkConfigs': pulumi.Input.encodeList<AdditionalPodNetworkConfigResponseContainerV1beta1, Map<String, dynamic>>(additionalPodNetworkConfigs, (value) => value.toMap()),
  ...
  factory NodeNetworkConfigResponseContainerV1beta1.fromMap(Map<String, dynamic> map) {
    return NodeNetworkConfigResponseContainerV1beta1(
      additionalNodeNetworkConfigs: pulumi.Input.decodeList<AdditionalNodeNetworkConfigResponseContainerV1beta1>(map['additionalNodeNetworkConfigs'], (value) => AdditionalNodeNetworkConfigResponseContainerV1beta1.fromMap((value as Map).cast<String, dynamic>())),
      additionalPodNetworkConfigs: pulumi.Input.decodeList<AdditionalPodNetworkConfigResponseContainerV1beta1>(map['additionalPodNetworkConfigs'], (value) => AdditionalPodNetworkConfigResponseContainerV1beta1.fromMap((value as Map).cast<String, dynamic>())),
      createPodRange: map['createPodRange'] as bool,
      enablePrivateNodes: map['enablePrivateNodes'] as bool,
      networkPerformanceConfig: NetworkPerformanceConfigResponseContainerV1beta1.fromMap((map['networkPerformanceConfig'] as Map).cast<String, dynamic>()),
      podCidrOverprovisionConfig: PodCIDROverprovisionConfigResponseContainerV1beta1.fromMap((map['podCidrOverprovisionConfig'] as Map).cast<String, dynamic>()),
