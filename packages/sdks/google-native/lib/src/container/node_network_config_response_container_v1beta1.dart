...
class NodeNetworkConfigResponseContainerV1beta1 {
  ...
  const NodeNetworkConfigResponseContainerV1beta1({
  ...
  factory NodeNetworkConfigResponseContainerV1beta1.fromMap(Map<String, dynamic> map) {
    return NodeNetworkConfigResponseContainerV1beta1(
      additionalNodeNetworkConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<AdditionalNodeNetworkConfigResponseContainerV1beta1>(map['additionalNodeNetworkConfigs']!, (value) => AdditionalNodeNetworkConfigResponseContainerV1beta1.fromMap((value as Map).cast<String, dynamic>()))),
      additionalPodNetworkConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<AdditionalPodNetworkConfigResponseContainerV1beta1>(map['additionalPodNetworkConfigs']!, (value) => AdditionalPodNetworkConfigResponseContainerV1beta1.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      networkPerformanceConfig: pulumi.Input.fromValue(NetworkPerformanceConfigResponseContainerV1beta1.fromMap((map['networkPerformanceConfig']! as Map).cast<String, dynamic>())),
