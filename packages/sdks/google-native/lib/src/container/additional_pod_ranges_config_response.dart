...
class AdditionalPodRangesConfigResponse {
  ...
  const AdditionalPodRangesConfigResponse({
  ...
  factory AdditionalPodRangesConfigResponse.fromMap(Map<String, dynamic> map) {
    return AdditionalPodRangesConfigResponse(
      podRangeInfo: pulumi.Input.fromValue(pulumi.Input.decodeList<RangeInfoResponse>(map['podRangeInfo']!, (value) => RangeInfoResponse.fromMap((value as Map).cast<String, dynamic>()))),
