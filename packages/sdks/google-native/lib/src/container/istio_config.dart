...
class IstioConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'auth': ?pulumi.Input.mapOptionalInputValue<IstioConfigAuth, String>(auth, (value) => value.wireValue),
      'disabled': ?disabled,
    };
  }
  ...
  factory IstioConfig.fromMap(Map<String, dynamic> map) {
    return IstioConfig(
      auth: (() { final guardedValue = map['auth']; if (guardedValue == null) return null; return pulumi.Input.fromValue(IstioConfigAuth.fromValue(guardedValue as String)); })(),
