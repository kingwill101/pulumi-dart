...
class BlueGreenInfoResponseContainerV1beta1 {
  ...
  const BlueGreenInfoResponseContainerV1beta1({
  ...
  factory BlueGreenInfoResponseContainerV1beta1.fromMap(Map<String, dynamic> map) {
    return BlueGreenInfoResponseContainerV1beta1(
      blueInstanceGroupUrls: pulumi.Input.fromValue((map['blueInstanceGroupUrls'] as List).cast<String>()),
      bluePoolDeletionStartTime: pulumi.Input.fromValue(map['bluePoolDeletionStartTime'] as String),
      greenInstanceGroupUrls: pulumi.Input.fromValue((map['greenInstanceGroupUrls'] as List).cast<String>()),
      greenPoolVersion: pulumi.Input.fromValue(map['greenPoolVersion'] as String),
