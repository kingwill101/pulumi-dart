...
class NodePoolArgs {
  ...
  NodePoolArgs({
    ...
    pulumi.Output<BestEffortProvisioning>? bestEffortProvisioning,
    required pulumi.Output<String> clusterId,
    pulumi.Output<List<StatusCondition>>? conditions,
    pulumi.Output<NodeConfig>? config,
    pulumi.Output<String>? etag,
    pulumi.Output<int>? initialNodeCount,
    pulumi.Output<String>? location,
    pulumi.Output<List<String>>? locations,
    pulumi.Output<NodeManagement>? management,
    pulumi.Output<MaxPodsConstraint>? maxPodsConstraint,
    pulumi.Output<String>? name,
    pulumi.Output<NodeNetworkConfig>? networkConfig,
    pulumi.Output<String>? parent,
    pulumi.Output<PlacementPolicy>? placementPolicy,
    pulumi.Output<String>? project,
    pulumi.Output<QueuedProvisioning>? queuedProvisioning,
    pulumi.Output<UpgradeSettings>? upgradeSettings,
  ...
  factory NodePoolArgs.fromMap(Map<String, dynamic> map) {
    return NodePoolArgs(
      ...
      bestEffortProvisioning: map['bestEffortProvisioning'] == null ? null : pulumi.Output.create<BestEffortProvisioning>(BestEffortProvisioning.fromMap((map['bestEffortProvisioning'] as Map).cast<String, dynamic>())),
      ...
      config: map['config'] == null ? null : pulumi.Output.create<NodeConfig>(NodeConfig.fromMap((map['config'] as Map).cast<String, dynamic>())),
      ...
      management: map['management'] == null ? null : pulumi.Output.create<NodeManagement>(NodeManagement.fromMap((map['management'] as Map).cast<String, dynamic>())),
      maxPodsConstraint: map['maxPodsConstraint'] == null ? null : pulumi.Output.create<MaxPodsConstraint>(MaxPodsConstraint.fromMap((map['maxPodsConstraint'] as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      networkConfig: map['networkConfig'] == null ? null : pulumi.Output.create<NodeNetworkConfig>(NodeNetworkConfig.fromMap((map['networkConfig'] as Map).cast<String, dynamic>())),
      parent: map['parent'] == null ? null : pulumi.Output.create<String>(map['parent'] as String),
      placementPolicy: map['placementPolicy'] == null ? null : pulumi.Output.create<PlacementPolicy>(PlacementPolicy.fromMap((map['placementPolicy'] as Map).cast<String, dynamic>())),
      project: map['project'] == null ? null : pulumi.Output.create<String>(map['project'] as String),
      queuedProvisioning: map['queuedProvisioning'] == null ? null : pulumi.Output.create<QueuedProvisioning>(QueuedProvisioning.fromMap((map['queuedProvisioning'] as Map).cast<String, dynamic>())),
      upgradeSettings: map['upgradeSettings'] == null ? null : pulumi.Output.create<UpgradeSettings>(UpgradeSettings.fromMap((map['upgradeSettings'] as Map).cast<String, dynamic>())),
