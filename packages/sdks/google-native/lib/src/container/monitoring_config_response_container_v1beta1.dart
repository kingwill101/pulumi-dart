...
class MonitoringConfigResponseContainerV1beta1 {
  ...
  factory MonitoringConfigResponseContainerV1beta1.fromMap(Map<String, dynamic> map) {
    return MonitoringConfigResponseContainerV1beta1(
      advancedDatapathObservabilityConfig: (AdvancedDatapathObservabilityConfigResponseContainerV1beta1.fromMap((map['advancedDatapathObservabilityConfig'] as Map).cast<String, dynamic>())).input(),
      componentConfig: (MonitoringComponentConfigResponseContainerV1beta1.fromMap((map['componentConfig'] as Map).cast<String, dynamic>())).input(),
      managedPrometheusConfig: (ManagedPrometheusConfigResponseContainerV1beta1.fromMap((map['managedPrometheusConfig'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
