...
class MasterAuthContainerV1beta1 {
  ...
  final pulumi.Input<ClientCertificateConfigContainerV1beta1>? clientCertificateConfig;
  ...
  const MasterAuthContainerV1beta1({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'clientCertificateConfig': ?pulumi.Input.mapOptionalInputValue<ClientCertificateConfigContainerV1beta1, Map<String, dynamic>>(clientCertificateConfig, (value) => value.toMap()),
  ...
  factory MasterAuthContainerV1beta1.fromMap(Map<String, dynamic> map) {
    return MasterAuthContainerV1beta1(
      clientCertificateConfig: (() { final guardedValue = map['clientCertificateConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClientCertificateConfigContainerV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
