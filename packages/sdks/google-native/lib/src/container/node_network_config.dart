...
class NodeNetworkConfig {
  ...
  final List<AdditionalNodeNetworkConfig>? additionalNodeNetworkConfigs;
  /// We specify the additional pod networks for this node pool using this list. Each pod network corresponds to an additional alias IP range for the node
  final List<AdditionalPodNetworkConfig>? additionalPodNetworkConfigs;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'additionalNodeNetworkConfigs': ?additionalNodeNetworkConfigs == null ? null : pulumi.Input.encodeList<AdditionalNodeNetworkConfig, Map<String, dynamic>>(additionalNodeNetworkConfigs!, (value) => value.toMap()),
      'additionalPodNetworkConfigs': ?additionalPodNetworkConfigs == null ? null : pulumi.Input.encodeList<AdditionalPodNetworkConfig, Map<String, dynamic>>(additionalPodNetworkConfigs!, (value) => value.toMap()),
  ...
  factory NodeNetworkConfig.fromMap(Map<String, dynamic> map) {
    return NodeNetworkConfig(
      additionalNodeNetworkConfigs: map['additionalNodeNetworkConfigs'] == null ? null : pulumi.Input.decodeList<AdditionalNodeNetworkConfig>(map['additionalNodeNetworkConfigs'], (value) => AdditionalNodeNetworkConfig.fromMap((value as Map).cast<String, dynamic>())),
      additionalPodNetworkConfigs: map['additionalPodNetworkConfigs'] == null ? null : pulumi.Input.decodeList<AdditionalPodNetworkConfig>(map['additionalPodNetworkConfigs'], (value) => AdditionalPodNetworkConfig.fromMap((value as Map).cast<String, dynamic>())),
      ...
      podCidrOverprovisionConfig: map['podCidrOverprovisionConfig'] == null ? null : PodCIDROverprovisionConfig.fromMap((map['podCidrOverprovisionConfig'] as Map).cast<String, dynamic>()),
