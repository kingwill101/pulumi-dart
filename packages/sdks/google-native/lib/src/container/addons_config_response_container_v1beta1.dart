...
class AddonsConfigResponseContainerV1beta1 {
  ...
  factory AddonsConfigResponseContainerV1beta1.fromMap(Map<String, dynamic> map) {
    return AddonsConfigResponseContainerV1beta1(
      cloudRunConfig: pulumi.Input.fromValue(CloudRunConfigResponseContainerV1beta1.fromMap((map['cloudRunConfig']! as Map).cast<String, dynamic>())),
      configConnectorConfig: pulumi.Input.fromValue(ConfigConnectorConfigResponseContainerV1beta1.fromMap((map['configConnectorConfig']! as Map).cast<String, dynamic>())),
      dnsCacheConfig: pulumi.Input.fromValue(DnsCacheConfigResponseContainerV1beta1.fromMap((map['dnsCacheConfig']! as Map).cast<String, dynamic>())),
      gcePersistentDiskCsiDriverConfig: pulumi.Input.fromValue(GcePersistentDiskCsiDriverConfigResponseContainerV1beta1.fromMap((map['gcePersistentDiskCsiDriverConfig']! as Map).cast<String, dynamic>())),
      gcpFilestoreCsiDriverConfig: pulumi.Input.fromValue(GcpFilestoreCsiDriverConfigResponseContainerV1beta1.fromMap((map['gcpFilestoreCsiDriverConfig']! as Map).cast<String, dynamic>())),
      gcsFuseCsiDriverConfig: pulumi.Input.fromValue(GcsFuseCsiDriverConfigResponseContainerV1beta1.fromMap((map['gcsFuseCsiDriverConfig']! as Map).cast<String, dynamic>())),
      gkeBackupAgentConfig: pulumi.Input.fromValue(GkeBackupAgentConfigResponseContainerV1beta1.fromMap((map['gkeBackupAgentConfig']! as Map).cast<String, dynamic>())),
      horizontalPodAutoscaling: pulumi.Input.fromValue(HorizontalPodAutoscalingResponseContainerV1beta1.fromMap((map['horizontalPodAutoscaling']! as Map).cast<String, dynamic>())),
      httpLoadBalancing: pulumi.Input.fromValue(HttpLoadBalancingResponseContainerV1beta1.fromMap((map['httpLoadBalancing']! as Map).cast<String, dynamic>())),
      istioConfig: pulumi.Input.fromValue(IstioConfigResponse.fromMap((map['istioConfig']! as Map).cast<String, dynamic>())),
      kalmConfig: pulumi.Input.fromValue(KalmConfigResponse.fromMap((map['kalmConfig']! as Map).cast<String, dynamic>())),
      kubernetesDashboard: pulumi.Input.fromValue(KubernetesDashboardResponseContainerV1beta1.fromMap((map['kubernetesDashboard']! as Map).cast<String, dynamic>())),
      networkPolicyConfig: pulumi.Input.fromValue(NetworkPolicyConfigResponseContainerV1beta1.fromMap((map['networkPolicyConfig']! as Map).cast<String, dynamic>())),
    );
  }
}
