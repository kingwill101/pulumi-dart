...
class MaintenanceWindowResponse {
  ...
  factory MaintenanceWindowResponse.fromMap(Map<String, dynamic> map) {
    return MaintenanceWindowResponse(
      dailyMaintenanceWindow: DailyMaintenanceWindowResponse.fromMap((map['dailyMaintenanceWindow'] as Map).cast<String, dynamic>()),
      maintenanceExclusions: (map['maintenanceExclusions'] as Map).cast<String, String>(),
      recurringWindow: RecurringTimeWindowResponse.fromMap((map['recurringWindow'] as Map).cast<String, dynamic>()),
    );
  }
}
