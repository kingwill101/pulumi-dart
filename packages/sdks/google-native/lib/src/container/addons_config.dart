...
class AddonsConfig {
  ...
  final pulumi.Input<GcePersistentDiskCsiDriverConfig>?
    ...
    return AddonsConfig(
      cloudRunConfig: (() {
        ...
        return pulumi.Input.fromValue(
          CloudRunConfig.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      configConnectorConfig: (() {
      ...
      dnsCacheConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DnsCacheConfig.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      gcePersistentDiskCsiDriverConfig: (() {
