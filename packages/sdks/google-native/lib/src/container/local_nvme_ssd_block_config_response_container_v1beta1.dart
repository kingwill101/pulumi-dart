...
class LocalNvmeSsdBlockConfigResponseContainerV1beta1 {
  ...
  /// Creates a new [LocalNvmeSsdBlockConfigResponseContainerV1beta1].
  ...
  const LocalNvmeSsdBlockConfigResponseContainerV1beta1({
  ...
  factory LocalNvmeSsdBlockConfigResponseContainerV1beta1.fromMap(Map<String, dynamic> map) {
    return LocalNvmeSsdBlockConfigResponseContainerV1beta1(
