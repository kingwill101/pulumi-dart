...
class NodePoolAutoConfigResponseContainerV1beta1 {
  ...
  factory NodePoolAutoConfigResponseContainerV1beta1.fromMap(Map<String, dynamic> map) {
    return NodePoolAutoConfigResponseContainerV1beta1(
      networkTags: (NetworkTagsResponseContainerV1beta1.fromMap((map['networkTags'] as Map).cast<String, dynamic>())).input(),
      resourceManagerTags: (ResourceManagerTagsResponseContainerV1beta1.fromMap((map['resourceManagerTags'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
