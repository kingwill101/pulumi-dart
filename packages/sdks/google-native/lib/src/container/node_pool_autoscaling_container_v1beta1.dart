...
class NodePoolAutoscalingContainerV1beta1 {
  ...
  final NodePoolAutoscalingLocationPolicyContainerV1beta1? locationPolicy;
  ...
  factory NodePoolAutoscalingContainerV1beta1.fromMap(Map<String, dynamic> map) {
    return NodePoolAutoscalingContainerV1beta1(
      autoprovisioned: map['autoprovisioned'] == null ? null : map['autoprovisioned'] as bool,
      enabled: map['enabled'] == null ? null : map['enabled'] as bool,
      locationPolicy: map['locationPolicy'] == null ? null : NodePoolAutoscalingLocationPolicyContainerV1beta1.fromValue(map['locationPolicy'] as String),
