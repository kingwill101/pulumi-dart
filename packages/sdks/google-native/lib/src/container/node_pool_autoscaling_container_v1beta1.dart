...
class NodePoolAutoscalingContainerV1beta1 {
  ...
  final pulumi.Input<NodePoolAutoscalingLocationPolicyContainerV1beta1>?
  locationPolicy;
    ...
    return <String, dynamic>{
      ...
      'locationPolicy':
          ?pulumi.Input.mapOptionalInputValue<
            NodePoolAutoscalingLocationPolicyContainerV1beta1,
            String
  ...
  factory NodePoolAutoscalingContainerV1beta1.fromMap(
    ...
    return NodePoolAutoscalingContainerV1beta1(
      ...
      locationPolicy: (() {
        ...
        return pulumi.Input.fromValue(
          NodePoolAutoscalingLocationPolicyContainerV1beta1.fromValue(
