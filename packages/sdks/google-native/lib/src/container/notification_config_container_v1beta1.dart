...
class NotificationConfigContainerV1beta1 {
  ...
  const NotificationConfigContainerV1beta1({
    this.pubsub,
  });
  ...
  factory NotificationConfigContainerV1beta1.fromMap(Map<String, dynamic> map) {
    return NotificationConfigContainerV1beta1(
      pubsub: (() { final guardedValue = map['pubsub']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PubSubContainerV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
