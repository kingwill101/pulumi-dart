...
class AddonsConfigContainerV1beta1 {
  ...
  final pulumi.Input<ConfigConnectorConfigContainerV1beta1>?
  ...
  final pulumi.Input<GcePersistentDiskCsiDriverConfigContainerV1beta1>?
  gcePersistentDiskCsiDriverConfig;

  /// Configuration for the GCP Filestore CSI driver.
  final pulumi.Input<GcpFilestoreCsiDriverConfigContainerV1beta1>?
  gcpFilestoreCsiDriverConfig;

  /// Configuration for the Cloud Storage Fuse CSI driver.
  final pulumi.Input<GcsFuseCsiDriverConfigContainerV1beta1>?
  gcsFuseCsiDriverConfig;

  /// Configuration for the Backup for GKE agent addon.
  final pulumi.Input<GkeBackupAgentConfigContainerV1beta1>?
  gkeBackupAgentConfig;

  /// Configuration for the horizontal pod autoscaling feature, which increases or decreases the number of replica pods a replication controller has based on the resource usage of the existing pods.
  final pulumi.Input<HorizontalPodAutoscalingContainerV1beta1>?
    ...
    return <String, dynamic>{
      ...
      'istioConfig':
          ?pulumi.Input.mapOptionalInputValue<
            IstioConfig,
            Map<String, dynamic>
          >(istioConfig, (value) => value.toMap()),
      'kalmConfig':
          ?pulumi.Input.mapOptionalInputValue<KalmConfig, Map<String, dynamic>>(
            kalmConfig,
            (value) => value.toMap(),
          ),
      'kubernetesDashboard':
  ...
  factory AddonsConfigContainerV1beta1.fromMap(Map<String, dynamic> map) {
    return AddonsConfigContainerV1beta1(
      cloudRunConfig: (() {
        final guardedValue = map['cloudRunConfig'];
      ...
      configConnectorConfig: (() {
        final guardedValue = map['configConnectorConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      dnsCacheConfig: (() {
        final guardedValue = map['dnsCacheConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      gcePersistentDiskCsiDriverConfig: (() {
        final guardedValue = map['gcePersistentDiskCsiDriverConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      gcpFilestoreCsiDriverConfig: (() {
        final guardedValue = map['gcpFilestoreCsiDriverConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      gcsFuseCsiDriverConfig: (() {
        final guardedValue = map['gcsFuseCsiDriverConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      gkeBackupAgentConfig: (() {
        final guardedValue = map['gkeBackupAgentConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      horizontalPodAutoscaling: (() {
        final guardedValue = map['horizontalPodAutoscaling'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      httpLoadBalancing: (() {
        final guardedValue = map['httpLoadBalancing'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      istioConfig: (() {
        final guardedValue = map['istioConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          IstioConfig.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      kalmConfig: (() {
        final guardedValue = map['kalmConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          KalmConfig.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      kubernetesDashboard: (() {
        final guardedValue = map['kubernetesDashboard'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      networkPolicyConfig: (() {
        final guardedValue = map['networkPolicyConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
