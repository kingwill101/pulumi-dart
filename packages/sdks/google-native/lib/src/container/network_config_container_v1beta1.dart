...
class NetworkConfigContainerV1beta1 {
  ...
  const NetworkConfigContainerV1beta1({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'datapathProvider': ?pulumi.Input.mapOptionalInputValue<NetworkConfigDatapathProviderContainerV1beta1, String>(datapathProvider, (value) => value.wireValue),
      ...
      'inTransitEncryptionConfig': ?pulumi.Input.mapOptionalInputValue<NetworkConfigInTransitEncryptionConfig, String>(inTransitEncryptionConfig, (value) => value.wireValue),
      ...
      'privateIpv6GoogleAccess': ?pulumi.Input.mapOptionalInputValue<NetworkConfigPrivateIpv6GoogleAccessContainerV1beta1, String>(privateIpv6GoogleAccess, (value) => value.wireValue),
  ...
  factory NetworkConfigContainerV1beta1.fromMap(Map<String, dynamic> map) {
    return NetworkConfigContainerV1beta1(
      datapathProvider: (() { final guardedValue = map['datapathProvider']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkConfigDatapathProviderContainerV1beta1.fromValue(guardedValue as String)); })(),
      defaultSnatStatus: (() { final guardedValue = map['defaultSnatStatus']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DefaultSnatStatusContainerV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      dnsConfig: (() { final guardedValue = map['dnsConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DNSConfigContainerV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      gatewayApiConfig: (() { final guardedValue = map['gatewayApiConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GatewayAPIConfigContainerV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      inTransitEncryptionConfig: (() { final guardedValue = map['inTransitEncryptionConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkConfigInTransitEncryptionConfig.fromValue(guardedValue as String)); })(),
      networkPerformanceConfig: (() { final guardedValue = map['networkPerformanceConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterNetworkPerformanceConfigContainerV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      privateIpv6GoogleAccess: (() { final guardedValue = map['privateIpv6GoogleAccess']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkConfigPrivateIpv6GoogleAccessContainerV1beta1.fromValue(guardedValue as String)); })(),
      serviceExternalIpsConfig: (() { final guardedValue = map['serviceExternalIpsConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServiceExternalIPsConfigContainerV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
