...
class NodePoolAutoConfigResponse {
  ...
  factory NodePoolAutoConfigResponse.fromMap(Map<String, dynamic> map) {
    return NodePoolAutoConfigResponse(
      networkTags: (NetworkTagsResponse.fromMap((map['networkTags'] as Map).cast<String, dynamic>())).input(),
      resourceManagerTags: (ResourceManagerTagsResponse.fromMap((map['resourceManagerTags'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
