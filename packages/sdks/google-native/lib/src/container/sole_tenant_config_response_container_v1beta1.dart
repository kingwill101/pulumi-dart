...
class SoleTenantConfigResponseContainerV1beta1 {
  ...
  factory SoleTenantConfigResponseContainerV1beta1.fromMap(Map<String, dynamic> map) {
    return SoleTenantConfigResponseContainerV1beta1(
      nodeAffinities: (pulumi.Input.decodeList<NodeAffinityResponseContainerV1beta1>(map['nodeAffinities'], (value) => NodeAffinityResponseContainerV1beta1.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
