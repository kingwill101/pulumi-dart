...
class ClusterArgs {
  ...
  factory ClusterArgs.fromMap(Map<String, dynamic> map) {
    return ClusterArgs(
      addonsConfig: map['addonsConfig'] == null ? null : (AddonsConfig.fromMap((map['addonsConfig']! as Map).cast<String, dynamic>())).input(),
      authenticatorGroupsConfig: map['authenticatorGroupsConfig'] == null ? null : (AuthenticatorGroupsConfig.fromMap((map['authenticatorGroupsConfig']! as Map).cast<String, dynamic>())).input(),
      autopilot: map['autopilot'] == null ? null : (Autopilot.fromMap((map['autopilot']! as Map).cast<String, dynamic>())).input(),
      autoscaling: map['autoscaling'] == null ? null : (ClusterAutoscaling.fromMap((map['autoscaling']! as Map).cast<String, dynamic>())).input(),
      ...
      confidentialNodes: map['confidentialNodes'] == null ? null : (ConfidentialNodes.fromMap((map['confidentialNodes']! as Map).cast<String, dynamic>())).input(),
      costManagementConfig: map['costManagementConfig'] == null ? null : (CostManagementConfig.fromMap((map['costManagementConfig']! as Map).cast<String, dynamic>())).input(),
      databaseEncryption: map['databaseEncryption'] == null ? null : (DatabaseEncryption.fromMap((map['databaseEncryption']! as Map).cast<String, dynamic>())).input(),
      defaultMaxPodsConstraint: map['defaultMaxPodsConstraint'] == null ? null : (MaxPodsConstraint.fromMap((map['defaultMaxPodsConstraint']! as Map).cast<String, dynamic>())).input(),
      ...
      fleet: map['fleet'] == null ? null : (Fleet.fromMap((map['fleet']! as Map).cast<String, dynamic>())).input(),
      identityServiceConfig: map['identityServiceConfig'] == null ? null : (IdentityServiceConfig.fromMap((map['identityServiceConfig']! as Map).cast<String, dynamic>())).input(),
      ...
      legacyAbac: map['legacyAbac'] == null ? null : (LegacyAbac.fromMap((map['legacyAbac']! as Map).cast<String, dynamic>())).input(),
      ...
      masterAuth: map['masterAuth'] == null ? null : (MasterAuth.fromMap((map['masterAuth']! as Map).cast<String, dynamic>())).input(),
      ...
      meshCertificates: map['meshCertificates'] == null ? null : (MeshCertificates.fromMap((map['meshCertificates']! as Map).cast<String, dynamic>())).input(),
      ...
      networkPolicy: map['networkPolicy'] == null ? null : (NetworkPolicy.fromMap((map['networkPolicy']! as Map).cast<String, dynamic>())).input(),
      nodeConfig: map['nodeConfig'] == null ? null : (NodeConfig.fromMap((map['nodeConfig']! as Map).cast<String, dynamic>())).input(),
      nodePoolAutoConfig: map['nodePoolAutoConfig'] == null ? null : (NodePoolAutoConfig.fromMap((map['nodePoolAutoConfig']! as Map).cast<String, dynamic>())).input(),
      nodePoolDefaults: map['nodePoolDefaults'] == null ? null : (NodePoolDefaults.fromMap((map['nodePoolDefaults']! as Map).cast<String, dynamic>())).input(),
      nodePools: map['nodePools'] == null ? null : ((map['nodePools']! as List).cast<NodePoolContainerV1>()).input(),
      ...
      parentProductConfig: map['parentProductConfig'] == null ? null : (ParentProductConfig.fromMap((map['parentProductConfig']! as Map).cast<String, dynamic>())).input(),
      ...
      releaseChannel: map['releaseChannel'] == null ? null : (ReleaseChannel.fromMap((map['releaseChannel']! as Map).cast<String, dynamic>())).input(),
      resourceLabels: map['resourceLabels'] == null ? null : ((map['resourceLabels']! as Map).cast<String, String>()).input(),
      resourceUsageExportConfig: map['resourceUsageExportConfig'] == null ? null : (ResourceUsageExportConfig.fromMap((map['resourceUsageExportConfig']! as Map).cast<String, dynamic>())).input(),
      ...
      shieldedNodes: map['shieldedNodes'] == null ? null : (ShieldedNodes.fromMap((map['shieldedNodes']! as Map).cast<String, dynamic>())).input(),
      subnetwork: map['subnetwork'] == null ? null : (map['subnetwork']! as String).input(),
      verticalPodAutoscaling: map['verticalPodAutoscaling'] == null ? null : (VerticalPodAutoscaling.fromMap((map['verticalPodAutoscaling']! as Map).cast<String, dynamic>())).input(),
      workloadIdentityConfig: map['workloadIdentityConfig'] == null ? null : (WorkloadIdentityConfig.fromMap((map['workloadIdentityConfig']! as Map).cast<String, dynamic>())).input(),
