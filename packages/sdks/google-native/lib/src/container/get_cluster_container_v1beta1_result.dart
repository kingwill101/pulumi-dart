...
class GetClusterContainerV1beta1Result {
  ...
  final AuthenticatorGroupsConfigResponseContainerV1beta1 authenticatorGroupsConfig;
  ...
  final MasterAuthorizedNetworksConfigResponseContainerV1beta1 masterAuthorizedNetworksConfig;
  ...
  final ResourceUsageExportConfigResponseContainerV1beta1 resourceUsageExportConfig;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'clusterTelemetry': clusterTelemetry.toMap(),
      ...
      'nodePools': pulumi.Input.encodeList<NodePoolResponseContainerV1beta1, Map<String, dynamic>>(nodePools, (value) => value.toMap()),
      'notificationConfig': notificationConfig.toMap(),
      'parentProductConfig': parentProductConfig.toMap(),
      'podSecurityPolicyConfig': podSecurityPolicyConfig.toMap(),
      'privateCluster': privateCluster,
      'privateClusterConfig': privateClusterConfig.toMap(),
      'protectConfig': protectConfig.toMap(),
      ...
      'tpuConfig': tpuConfig.toMap(),
      'tpuIpv4CidrBlock': tpuIpv4CidrBlock,
      'verticalPodAutoscaling': verticalPodAutoscaling.toMap(),
      'workloadAltsConfig': workloadAltsConfig.toMap(),
      'workloadCertificates': workloadCertificates.toMap(),
  ...
  factory GetClusterContainerV1beta1Result.fromMap(Map<String, dynamic> map) {
    return GetClusterContainerV1beta1Result(
      addonsConfig: AddonsConfigResponseContainerV1beta1.fromMap((map['addonsConfig']! as Map).cast<String, dynamic>()),
      authenticatorGroupsConfig: AuthenticatorGroupsConfigResponseContainerV1beta1.fromMap((map['authenticatorGroupsConfig']! as Map).cast<String, dynamic>()),
      autopilot: AutopilotResponseContainerV1beta1.fromMap((map['autopilot']! as Map).cast<String, dynamic>()),
      autoscaling: ClusterAutoscalingResponseContainerV1beta1.fromMap((map['autoscaling']! as Map).cast<String, dynamic>()),
      binaryAuthorization: BinaryAuthorizationResponseContainerV1beta1.fromMap((map['binaryAuthorization']! as Map).cast<String, dynamic>()),
      clusterIpv4Cidr: map['clusterIpv4Cidr'] as String,
      clusterTelemetry: ClusterTelemetryResponse.fromMap((map['clusterTelemetry']! as Map).cast<String, dynamic>()),
      ...
      costManagementConfig: CostManagementConfigResponseContainerV1beta1.fromMap((map['costManagementConfig']! as Map).cast<String, dynamic>()),
      ...
      databaseEncryption: DatabaseEncryptionResponseContainerV1beta1.fromMap((map['databaseEncryption']! as Map).cast<String, dynamic>()),
      defaultMaxPodsConstraint: MaxPodsConstraintResponseContainerV1beta1.fromMap((map['defaultMaxPodsConstraint']! as Map).cast<String, dynamic>()),
      description: map['description'] as String,
      enableK8sBetaApis: K8sBetaAPIConfigResponseContainerV1beta1.fromMap((map['enableK8sBetaApis']! as Map).cast<String, dynamic>()),
      enableKubernetesAlpha: map['enableKubernetesAlpha'] as bool,
      enableTpu: map['enableTpu'] as bool,
      endpoint: map['endpoint'] as String,
      enterpriseConfig: EnterpriseConfigResponseContainerV1beta1.fromMap((map['enterpriseConfig']! as Map).cast<String, dynamic>()),
      etag: map['etag'] as String,
      expireTime: map['expireTime'] as String,
      fleet: FleetResponseContainerV1beta1.fromMap((map['fleet']! as Map).cast<String, dynamic>()),
      identityServiceConfig: IdentityServiceConfigResponseContainerV1beta1.fromMap((map['identityServiceConfig']! as Map).cast<String, dynamic>()),
      ...
      ipAllocationPolicy: IPAllocationPolicyResponseContainerV1beta1.fromMap((map['ipAllocationPolicy']! as Map).cast<String, dynamic>()),
      labelFingerprint: map['labelFingerprint'] as String,
      legacyAbac: LegacyAbacResponseContainerV1beta1.fromMap((map['legacyAbac']! as Map).cast<String, dynamic>()),
      location: map['location'] as String,
      locations: (map['locations'] as List).cast<String>(),
      loggingConfig: LoggingConfigResponseContainerV1beta1.fromMap((map['loggingConfig']! as Map).cast<String, dynamic>()),
      loggingService: map['loggingService'] as String,
      maintenancePolicy: MaintenancePolicyResponseContainerV1beta1.fromMap((map['maintenancePolicy']! as Map).cast<String, dynamic>()),
      master: (map['master']! as Map).cast<String, dynamic>(),
      masterAuth: MasterAuthResponseContainerV1beta1.fromMap((map['masterAuth']! as Map).cast<String, dynamic>()),
      masterAuthorizedNetworksConfig: MasterAuthorizedNetworksConfigResponseContainerV1beta1.fromMap((map['masterAuthorizedNetworksConfig']! as Map).cast<String, dynamic>()),
      masterIpv4CidrBlock: map['masterIpv4CidrBlock'] as String,
      meshCertificates: MeshCertificatesResponseContainerV1beta1.fromMap((map['meshCertificates']! as Map).cast<String, dynamic>()),
      monitoringConfig: MonitoringConfigResponseContainerV1beta1.fromMap((map['monitoringConfig']! as Map).cast<String, dynamic>()),
      monitoringService: map['monitoringService'] as String,
      name: map['name'] as String,
      network: map['network'] as String,
      networkConfig: NetworkConfigResponseContainerV1beta1.fromMap((map['networkConfig']! as Map).cast<String, dynamic>()),
      networkPolicy: NetworkPolicyResponseContainerV1beta1.fromMap((map['networkPolicy']! as Map).cast<String, dynamic>()),
      nodeConfig: NodeConfigResponseContainerV1beta1.fromMap((map['nodeConfig']! as Map).cast<String, dynamic>()),
      nodeIpv4CidrSize: map['nodeIpv4CidrSize'] as int,
      nodePoolAutoConfig: NodePoolAutoConfigResponseContainerV1beta1.fromMap((map['nodePoolAutoConfig']! as Map).cast<String, dynamic>()),
      nodePoolDefaults: NodePoolDefaultsResponseContainerV1beta1.fromMap((map['nodePoolDefaults']! as Map).cast<String, dynamic>()),
      nodePools: pulumi.Input.decodeList<NodePoolResponseContainerV1beta1>(map['nodePools']!, (value) => NodePoolResponseContainerV1beta1.fromMap((value as Map).cast<String, dynamic>())),
      notificationConfig: NotificationConfigResponseContainerV1beta1.fromMap((map['notificationConfig']! as Map).cast<String, dynamic>()),
      parentProductConfig: ParentProductConfigResponseContainerV1beta1.fromMap((map['parentProductConfig']! as Map).cast<String, dynamic>()),
      podSecurityPolicyConfig: PodSecurityPolicyConfigResponse.fromMap((map['podSecurityPolicyConfig']! as Map).cast<String, dynamic>()),
      privateCluster: map['privateCluster'] as bool,
      privateClusterConfig: PrivateClusterConfigResponseContainerV1beta1.fromMap((map['privateClusterConfig']! as Map).cast<String, dynamic>()),
      protectConfig: ProtectConfigResponse.fromMap((map['protectConfig']! as Map).cast<String, dynamic>()),
      releaseChannel: ReleaseChannelResponseContainerV1beta1.fromMap((map['releaseChannel']! as Map).cast<String, dynamic>()),
      resourceLabels: (map['resourceLabels'] as Map).cast<String, String>(),
      resourceUsageExportConfig: ResourceUsageExportConfigResponseContainerV1beta1.fromMap((map['resourceUsageExportConfig']! as Map).cast<String, dynamic>()),
      securityPostureConfig: SecurityPostureConfigResponseContainerV1beta1.fromMap((map['securityPostureConfig']! as Map).cast<String, dynamic>()),
      selfLink: map['selfLink'] as String,
      servicesIpv4Cidr: map['servicesIpv4Cidr'] as String,
      shieldedNodes: ShieldedNodesResponseContainerV1beta1.fromMap((map['shieldedNodes']! as Map).cast<String, dynamic>()),
      status: map['status'] as String,
      statusMessage: map['statusMessage'] as String,
      subnetwork: map['subnetwork'] as String,
      tpuConfig: TpuConfigResponse.fromMap((map['tpuConfig']! as Map).cast<String, dynamic>()),
      tpuIpv4CidrBlock: map['tpuIpv4CidrBlock'] as String,
      verticalPodAutoscaling: VerticalPodAutoscalingResponseContainerV1beta1.fromMap((map['verticalPodAutoscaling']! as Map).cast<String, dynamic>()),
      workloadAltsConfig: WorkloadALTSConfigResponse.fromMap((map['workloadAltsConfig']! as Map).cast<String, dynamic>()),
      workloadCertificates: WorkloadCertificatesResponse.fromMap((map['workloadCertificates']! as Map).cast<String, dynamic>()),
      workloadIdentityConfig: WorkloadIdentityConfigResponseContainerV1beta1.fromMap((map['workloadIdentityConfig']! as Map).cast<String, dynamic>()),
