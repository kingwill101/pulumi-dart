...
class IPAllocationPolicyResponseContainerV1beta1 {
  ...
  final AdditionalPodRangesConfigResponseContainerV1beta1 additionalPodRangesConfig;
  ...
  factory IPAllocationPolicyResponseContainerV1beta1.fromMap(Map<String, dynamic> map) {
    return IPAllocationPolicyResponseContainerV1beta1(
      additionalPodRangesConfig: AdditionalPodRangesConfigResponseContainerV1beta1.fromMap((map['additionalPodRangesConfig'] as Map).cast<String, dynamic>()),
      ...
      defaultPodIpv4RangeUtilization: map['defaultPodIpv4RangeUtilization'] as double,
