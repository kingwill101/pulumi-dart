...
class IPAllocationPolicyResponseContainerV1beta1 {
  ...
  final pulumi.Input<AdditionalPodRangesConfigResponseContainerV1beta1> additionalPodRangesConfig;
  ...
  const IPAllocationPolicyResponseContainerV1beta1({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'additionalPodRangesConfig': pulumi.Input.mapInputValue<AdditionalPodRangesConfigResponseContainerV1beta1, Map<String, dynamic>>(additionalPodRangesConfig, (value) => value.toMap()),
  ...
  factory IPAllocationPolicyResponseContainerV1beta1.fromMap(Map<String, dynamic> map) {
    return IPAllocationPolicyResponseContainerV1beta1(
      additionalPodRangesConfig: pulumi.Input.fromValue(AdditionalPodRangesConfigResponseContainerV1beta1.fromMap((map['additionalPodRangesConfig']! as Map).cast<String, dynamic>())),
      allowRouteOverlap: pulumi.Input.fromValue(map['allowRouteOverlap'] as bool),
      ...
      defaultPodIpv4RangeUtilization: pulumi.Input.fromValue(map['defaultPodIpv4RangeUtilization'] as double),
      ...
      nodeIpv4CidrBlock: pulumi.Input.fromValue(map['nodeIpv4CidrBlock'] as String),
      podCidrOverprovisionConfig: pulumi.Input.fromValue(PodCIDROverprovisionConfigResponseContainerV1beta1.fromMap((map['podCidrOverprovisionConfig']! as Map).cast<String, dynamic>())),
      servicesIpv4Cidr: pulumi.Input.fromValue(map['servicesIpv4Cidr'] as String),
      servicesIpv4CidrBlock: pulumi.Input.fromValue(map['servicesIpv4CidrBlock'] as String),
      servicesIpv6CidrBlock: pulumi.Input.fromValue(map['servicesIpv6CidrBlock'] as String),
      ...
      subnetIpv6CidrBlock: pulumi.Input.fromValue(map['subnetIpv6CidrBlock'] as String),
      subnetworkName: pulumi.Input.fromValue(map['subnetworkName'] as String),
      tpuIpv4CidrBlock: pulumi.Input.fromValue(map['tpuIpv4CidrBlock'] as String),
