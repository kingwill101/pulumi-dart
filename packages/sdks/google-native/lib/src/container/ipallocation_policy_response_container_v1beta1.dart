...
class IPAllocationPolicyResponseContainerV1beta1 {
  ...
  factory IPAllocationPolicyResponseContainerV1beta1.fromMap(Map<String, dynamic> map) {
    return IPAllocationPolicyResponseContainerV1beta1(
      additionalPodRangesConfig: (AdditionalPodRangesConfigResponseContainerV1beta1.fromMap((map['additionalPodRangesConfig'] as Map).cast<String, dynamic>())).input(),
      allowRouteOverlap: (map['allowRouteOverlap'] as bool).input(),
