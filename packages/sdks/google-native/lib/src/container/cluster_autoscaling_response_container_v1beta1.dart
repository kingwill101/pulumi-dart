...
class ClusterAutoscalingResponseContainerV1beta1 {
  ...
  final pulumi.Input<AutoprovisioningNodePoolDefaultsResponseContainerV1beta1>
  ...
  final pulumi.Input<List<ResourceLimitResponseContainerV1beta1>>
  resourceLimits;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'resourceLimits':
          pulumi.Input.mapInputValue<
            List<ResourceLimitResponseContainerV1beta1>,
