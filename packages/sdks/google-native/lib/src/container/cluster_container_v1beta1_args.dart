...
class ClusterContainerV1beta1Args {
  ...
  factory ClusterContainerV1beta1Args.fromMap(Map<String, dynamic> map) {
    return ClusterContainerV1beta1Args(
      addonsConfig: map['addonsConfig'] == null ? null : (AddonsConfigContainerV1beta1.fromMap((map['addonsConfig'] as Map).cast<String, dynamic>())).input(),
      authenticatorGroupsConfig: map['authenticatorGroupsConfig'] == null ? null : (AuthenticatorGroupsConfigContainerV1beta1.fromMap((map['authenticatorGroupsConfig'] as Map).cast<String, dynamic>())).input(),
      autopilot: map['autopilot'] == null ? null : (AutopilotContainerV1beta1.fromMap((map['autopilot'] as Map).cast<String, dynamic>())).input(),
      autoscaling: map['autoscaling'] == null ? null : (ClusterAutoscalingContainerV1beta1.fromMap((map['autoscaling'] as Map).cast<String, dynamic>())).input(),
      binaryAuthorization: map['binaryAuthorization'] == null ? null : (BinaryAuthorizationContainerV1beta1.fromMap((map['binaryAuthorization'] as Map).cast<String, dynamic>())).input(),
      clusterIpv4Cidr: map['clusterIpv4Cidr'] == null ? null : (map['clusterIpv4Cidr'] as String).input(),
      clusterTelemetry: map['clusterTelemetry'] == null ? null : (ClusterTelemetry.fromMap((map['clusterTelemetry'] as Map).cast<String, dynamic>())).input(),
      ...
      costManagementConfig: map['costManagementConfig'] == null ? null : (CostManagementConfigContainerV1beta1.fromMap((map['costManagementConfig'] as Map).cast<String, dynamic>())).input(),
      databaseEncryption: map['databaseEncryption'] == null ? null : (DatabaseEncryptionContainerV1beta1.fromMap((map['databaseEncryption'] as Map).cast<String, dynamic>())).input(),
      defaultMaxPodsConstraint: map['defaultMaxPodsConstraint'] == null ? null : (MaxPodsConstraintContainerV1beta1.fromMap((map['defaultMaxPodsConstraint'] as Map).cast<String, dynamic>())).input(),
      ...
      enterpriseConfig: map['enterpriseConfig'] == null ? null : ((map['enterpriseConfig'] as Map).cast<String, dynamic>()).input(),
      etag: map['etag'] == null ? null : (map['etag'] as String).input(),
      fleet: map['fleet'] == null ? null : (FleetContainerV1beta1.fromMap((map['fleet'] as Map).cast<String, dynamic>())).input(),
      identityServiceConfig: map['identityServiceConfig'] == null ? null : (IdentityServiceConfigContainerV1beta1.fromMap((map['identityServiceConfig'] as Map).cast<String, dynamic>())).input(),
      initialClusterVersion: map['initialClusterVersion'] == null ? null : (map['initialClusterVersion'] as String).input(),
      ...
      ipAllocationPolicy: map['ipAllocationPolicy'] == null ? null : (IPAllocationPolicyContainerV1beta1.fromMap((map['ipAllocationPolicy'] as Map).cast<String, dynamic>())).input(),
      legacyAbac: map['legacyAbac'] == null ? null : (LegacyAbacContainerV1beta1.fromMap((map['legacyAbac'] as Map).cast<String, dynamic>())).input(),
      location: map['location'] == null ? null : (map['location'] as String).input(),
      locations: map['locations'] == null ? null : ((map['locations'] as List).cast<String>()).input(),
      loggingConfig: map['loggingConfig'] == null ? null : (LoggingConfigContainerV1beta1.fromMap((map['loggingConfig'] as Map).cast<String, dynamic>())).input(),
      loggingService: map['loggingService'] == null ? null : (map['loggingService'] as String).input(),
      maintenancePolicy: map['maintenancePolicy'] == null ? null : (MaintenancePolicyContainerV1beta1.fromMap((map['maintenancePolicy'] as Map).cast<String, dynamic>())).input(),
      master: map['master'] == null ? null : ((map['master'] as Map).cast<String, dynamic>()).input(),
      masterAuth: map['masterAuth'] == null ? null : (MasterAuthContainerV1beta1.fromMap((map['masterAuth'] as Map).cast<String, dynamic>())).input(),
      masterAuthorizedNetworksConfig: map['masterAuthorizedNetworksConfig'] == null ? null : (MasterAuthorizedNetworksConfigContainerV1beta1.fromMap((map['masterAuthorizedNetworksConfig'] as Map).cast<String, dynamic>())).input(),
      masterIpv4CidrBlock: map['masterIpv4CidrBlock'] == null ? null : (map['masterIpv4CidrBlock'] as String).input(),
      meshCertificates: map['meshCertificates'] == null ? null : (MeshCertificatesContainerV1beta1.fromMap((map['meshCertificates'] as Map).cast<String, dynamic>())).input(),
      monitoringConfig: map['monitoringConfig'] == null ? null : (MonitoringConfigContainerV1beta1.fromMap((map['monitoringConfig'] as Map).cast<String, dynamic>())).input(),
      monitoringService: map['monitoringService'] == null ? null : (map['monitoringService'] as String).input(),
      name: map['name'] == null ? null : (map['name'] as String).input(),
      network: map['network'] == null ? null : (map['network'] as String).input(),
      networkConfig: map['networkConfig'] == null ? null : (NetworkConfigContainerV1beta1.fromMap((map['networkConfig'] as Map).cast<String, dynamic>())).input(),
      networkPolicy: map['networkPolicy'] == null ? null : (NetworkPolicyContainerV1beta1.fromMap((map['networkPolicy'] as Map).cast<String, dynamic>())).input(),
      nodeConfig: map['nodeConfig'] == null ? null : (NodeConfigContainerV1beta1.fromMap((map['nodeConfig'] as Map).cast<String, dynamic>())).input(),
      nodePoolAutoConfig: map['nodePoolAutoConfig'] == null ? null : (NodePoolAutoConfigContainerV1beta1.fromMap((map['nodePoolAutoConfig'] as Map).cast<String, dynamic>())).input(),
      nodePoolDefaults: map['nodePoolDefaults'] == null ? null : (NodePoolDefaultsContainerV1beta1.fromMap((map['nodePoolDefaults'] as Map).cast<String, dynamic>())).input(),
      nodePools: map['nodePools'] == null ? null : ((map['nodePools'] as List).cast<NodePoolResource>()).input(),
      notificationConfig: map['notificationConfig'] == null ? null : (NotificationConfigContainerV1beta1.fromMap((map['notificationConfig'] as Map).cast<String, dynamic>())).input(),
      parent: map['parent'] == null ? null : (map['parent'] as String).input(),
      parentProductConfig: map['parentProductConfig'] == null ? null : (ParentProductConfigContainerV1beta1.fromMap((map['parentProductConfig'] as Map).cast<String, dynamic>())).input(),
      podSecurityPolicyConfig: map['podSecurityPolicyConfig'] == null ? null : (PodSecurityPolicyConfig.fromMap((map['podSecurityPolicyConfig'] as Map).cast<String, dynamic>())).input(),
      privateCluster: map['privateCluster'] == null ? null : (map['privateCluster'] as bool).input(),
      privateClusterConfig: map['privateClusterConfig'] == null ? null : (PrivateClusterConfigContainerV1beta1.fromMap((map['privateClusterConfig'] as Map).cast<String, dynamic>())).input(),
      project: map['project'] == null ? null : (map['project'] as String).input(),
      protectConfig: map['protectConfig'] == null ? null : (ProtectConfig.fromMap((map['protectConfig'] as Map).cast<String, dynamic>())).input(),
      releaseChannel: map['releaseChannel'] == null ? null : (ReleaseChannelContainerV1beta1.fromMap((map['releaseChannel'] as Map).cast<String, dynamic>())).input(),
      resourceLabels: map['resourceLabels'] == null ? null : ((map['resourceLabels'] as Map).cast<String, String>()).input(),
      resourceUsageExportConfig: map['resourceUsageExportConfig'] == null ? null : (ResourceUsageExportConfigContainerV1beta1.fromMap((map['resourceUsageExportConfig'] as Map).cast<String, dynamic>())).input(),
      securityPostureConfig: map['securityPostureConfig'] == null ? null : (SecurityPostureConfigContainerV1beta1.fromMap((map['securityPostureConfig'] as Map).cast<String, dynamic>())).input(),
      shieldedNodes: map['shieldedNodes'] == null ? null : (ShieldedNodesContainerV1beta1.fromMap((map['shieldedNodes'] as Map).cast<String, dynamic>())).input(),
      subnetwork: map['subnetwork'] == null ? null : (map['subnetwork'] as String).input(),
      tpuConfig: map['tpuConfig'] == null ? null : (TpuConfig.fromMap((map['tpuConfig'] as Map).cast<String, dynamic>())).input(),
      verticalPodAutoscaling: map['verticalPodAutoscaling'] == null ? null : (VerticalPodAutoscalingContainerV1beta1.fromMap((map['verticalPodAutoscaling'] as Map).cast<String, dynamic>())).input(),
      workloadAltsConfig: map['workloadAltsConfig'] == null ? null : (WorkloadALTSConfig.fromMap((map['workloadAltsConfig'] as Map).cast<String, dynamic>())).input(),
      workloadCertificates: map['workloadCertificates'] == null ? null : (WorkloadCertificates.fromMap((map['workloadCertificates'] as Map).cast<String, dynamic>())).input(),
      workloadIdentityConfig: map['workloadIdentityConfig'] == null ? null : (WorkloadIdentityConfigContainerV1beta1.fromMap((map['workloadIdentityConfig'] as Map).cast<String, dynamic>())).input(),
