    ...
    return <String, dynamic>{
      ...
      'workloadCertificates':
          ?pulumi.Input.mapOptionalInputValue<
            WorkloadCertificates,
            Map<String, dynamic>
          >(workloadCertificates, (value) => value.toMap()),
      'workloadIdentityConfig':
          ?pulumi.Input.mapOptionalInputValue<
  ...
  factory ClusterContainerV1beta1Args.fromMap(Map<String, dynamic> map) {
    return ClusterContainerV1beta1Args(
      ...
      nodePools: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as List).cast<NodePoolResource>(),
        );
      })(),
      notificationConfig: (() {
      ...
      privateCluster: (() {
        final guardedValue = map['privateCluster'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      privateClusterConfig: (() {
      ...
      workloadCertificates: (() {
        final guardedValue = map['workloadCertificates'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
