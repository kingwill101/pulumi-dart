...
class NodePool {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'bestEffortProvisioning': ?bestEffortProvisioning == null ? null : bestEffortProvisioning!.toMap(),
      'conditions': ?conditions == null ? null : pulumi.Input.encodeList<StatusCondition, Map<String, dynamic>>(conditions!, (value) => value.toMap()),
      'config': ?config == null ? null : config!.toMap(),
      'etag': ?etag,
      'initialNodeCount': ?initialNodeCount,
      'locations': ?locations,
      'management': ?management == null ? null : management!.toMap(),
      'maxPodsConstraint': ?maxPodsConstraint == null ? null : maxPodsConstraint!.toMap(),
      'name': ?name,
