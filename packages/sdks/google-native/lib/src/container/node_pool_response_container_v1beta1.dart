...
class NodePoolResponseContainerV1beta1 {
  ...
  const NodePoolResponseContainerV1beta1({
  ...
  factory NodePoolResponseContainerV1beta1.fromMap(Map<String, dynamic> map) {
    return NodePoolResponseContainerV1beta1(
      autoscaling: pulumi.Input.fromValue(NodePoolAutoscalingResponseContainerV1beta1.fromMap((map['autoscaling']! as Map).cast<String, dynamic>())),
      bestEffortProvisioning: pulumi.Input.fromValue(BestEffortProvisioningResponseContainerV1beta1.fromMap((map['bestEffortProvisioning']! as Map).cast<String, dynamic>())),
      conditions: pulumi.Input.fromValue(pulumi.Input.decodeList<StatusConditionResponseContainerV1beta1>(map['conditions']!, (value) => StatusConditionResponseContainerV1beta1.fromMap((value as Map).cast<String, dynamic>()))),
      config: pulumi.Input.fromValue(NodeConfigResponseContainerV1beta1.fromMap((map['config']! as Map).cast<String, dynamic>())),
      ...
      maxPodsConstraint: pulumi.Input.fromValue(MaxPodsConstraintResponseContainerV1beta1.fromMap((map['maxPodsConstraint']! as Map).cast<String, dynamic>())),
      name: pulumi.Input.fromValue(map['name'] as String),
      networkConfig: pulumi.Input.fromValue(NodeNetworkConfigResponseContainerV1beta1.fromMap((map['networkConfig']! as Map).cast<String, dynamic>())),
      placementPolicy: pulumi.Input.fromValue(PlacementPolicyResponseContainerV1beta1.fromMap((map['placementPolicy']! as Map).cast<String, dynamic>())),
      podIpv4CidrSize: pulumi.Input.fromValue(map['podIpv4CidrSize'] as int),
      queuedProvisioning: pulumi.Input.fromValue(QueuedProvisioningResponseContainerV1beta1.fromMap((map['queuedProvisioning']! as Map).cast<String, dynamic>())),
      ...
      updateInfo: pulumi.Input.fromValue(UpdateInfoResponseContainerV1beta1.fromMap((map['updateInfo']! as Map).cast<String, dynamic>())),
