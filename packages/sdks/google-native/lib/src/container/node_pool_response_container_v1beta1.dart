...
class NodePoolResponseContainerV1beta1 {
  ...
  final pulumi.Input<BestEffortProvisioningResponseContainerV1beta1>
  ...
  final pulumi.Input<MaxPodsConstraintResponseContainerV1beta1>
  maxPodsConstraint;
  ...
  final pulumi.Input<QueuedProvisioningResponseContainerV1beta1>
  queuedProvisioning;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'conditions':
          pulumi.Input.mapInputValue<
            List<StatusConditionResponseContainerV1beta1>,
  ...
  factory NodePoolResponseContainerV1beta1.fromMap(Map<String, dynamic> map) {
    return NodePoolResponseContainerV1beta1(
      autoscaling: pulumi.Input.fromValue(
        NodePoolAutoscalingResponseContainerV1beta1.fromMap(
          (map['autoscaling']! as Map).cast<String, dynamic>(),
        ),
      ),
      bestEffortProvisioning: pulumi.Input.fromValue(
      ...
      config: pulumi.Input.fromValue(
        NodeConfigResponseContainerV1beta1.fromMap(
      ...
      networkConfig: pulumi.Input.fromValue(
        NodeNetworkConfigResponseContainerV1beta1.fromMap(
          (map['networkConfig']! as Map).cast<String, dynamic>(),
        ),
      ),
      placementPolicy: pulumi.Input.fromValue(
        PlacementPolicyResponseContainerV1beta1.fromMap(
          (map['placementPolicy']! as Map).cast<String, dynamic>(),
        ),
      ),
      podIpv4CidrSize: pulumi.Input.fromValue(map['podIpv4CidrSize'] as int),
      queuedProvisioning: pulumi.Input.fromValue(
        QueuedProvisioningResponseContainerV1beta1.fromMap(
      ...
      updateInfo: pulumi.Input.fromValue(
        UpdateInfoResponseContainerV1beta1.fromMap(
