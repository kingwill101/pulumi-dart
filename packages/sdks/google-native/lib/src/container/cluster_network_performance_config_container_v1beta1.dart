...
class ClusterNetworkPerformanceConfigContainerV1beta1 {
  ...
  const ClusterNetworkPerformanceConfigContainerV1beta1({
    this.totalEgressBandwidthTier,
  });

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'totalEgressBandwidthTier': ?pulumi.Input.mapOptionalInputValue<ClusterNetworkPerformanceConfigTotalEgressBandwidthTierContainerV1beta1, String>(totalEgressBandwidthTier, (value) => value.wireValue),
    };
  }
  ...
  factory ClusterNetworkPerformanceConfigContainerV1beta1.fromMap(Map<String, dynamic> map) {
    return ClusterNetworkPerformanceConfigContainerV1beta1(
      totalEgressBandwidthTier: (() { final guardedValue = map['totalEgressBandwidthTier']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterNetworkPerformanceConfigTotalEgressBandwidthTierContainerV1beta1.fromValue(guardedValue as String)); })(),
    );
  }
}
