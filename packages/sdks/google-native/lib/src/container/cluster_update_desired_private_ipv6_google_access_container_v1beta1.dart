...
enum ClusterUpdateDesiredPrivateIpv6GoogleAccessContainerV1beta1 {
  ...
  const ClusterUpdateDesiredPrivateIpv6GoogleAccessContainerV1beta1(
    this.wireValue,
  );
  final String wireValue;

  static ClusterUpdateDesiredPrivateIpv6GoogleAccessContainerV1beta1 fromValue(
    String value,
  ) {
    for (final item
        in ClusterUpdateDesiredPrivateIpv6GoogleAccessContainerV1beta1.values) {
      if (item.wireValue == value) {
        return item;
      }
    }
    throw ArgumentError(
      'Unknown ClusterUpdateDesiredPrivateIpv6GoogleAccessContainerV1beta1 value: $value',
    );
  }
}
