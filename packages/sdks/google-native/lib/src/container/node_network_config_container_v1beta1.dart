...
class NodeNetworkConfigContainerV1beta1 {
  ...
  final pulumi.Input<List<AdditionalNodeNetworkConfigContainerV1beta1>>?
  additionalNodeNetworkConfigs;

  /// We specify the additional pod networks for this node pool using this list. Each pod network corresponds to an additional alias IP range for the node
  final pulumi.Input<List<AdditionalPodNetworkConfigContainerV1beta1>>?
  ...
  final pulumi.Input<NetworkPerformanceConfigContainerV1beta1>?
    ...
    return <String, dynamic>{
      'additionalNodeNetworkConfigs':
          ?pulumi.Input.mapOptionalInputValue<
            List<AdditionalNodeNetworkConfigContainerV1beta1>,
      ...
      'additionalPodNetworkConfigs':
          ?pulumi.Input.mapOptionalInputValue<
            List<AdditionalPodNetworkConfigContainerV1beta1>,
            List<Map<String, dynamic>>
          >(
            additionalPodNetworkConfigs,
            (value) =>
  ...
  factory NodeNetworkConfigContainerV1beta1.fromMap(Map<String, dynamic> map) {
    return NodeNetworkConfigContainerV1beta1(
      additionalNodeNetworkConfigs: (() {
        final guardedValue = map['additionalNodeNetworkConfigs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AdditionalNodeNetworkConfigContainerV1beta1>(
            guardedValue,
            (value) => AdditionalNodeNetworkConfigContainerV1beta1.fromMap(
      ...
      additionalPodNetworkConfigs: (() {
        final guardedValue = map['additionalPodNetworkConfigs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AdditionalPodNetworkConfigContainerV1beta1>(
            guardedValue,
            (value) => AdditionalPodNetworkConfigContainerV1beta1.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      createPodRange: (() {
        final guardedValue = map['createPodRange'];
        if (guardedValue == null) return null;
      ...
      networkPerformanceConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          NetworkPerformanceConfigContainerV1beta1.fromMap(
      ...
      podIpv4CidrBlock: (() {
        final guardedValue = map['podIpv4CidrBlock'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      podRange: (() {
        final guardedValue = map['podRange'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
