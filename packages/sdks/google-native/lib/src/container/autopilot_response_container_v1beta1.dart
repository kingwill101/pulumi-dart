...
class AutopilotResponseContainerV1beta1 {
  ...
  final pulumi.Input<WorkloadPolicyConfigResponseContainerV1beta1>
    ...
    return <String, dynamic>{
      'conversionStatus':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(conversionStatus, (value) => value.toMap()),
      'enabled': enabled,
      'workloadPolicyConfig':
          pulumi.Input.mapInputValue<
  ...
  factory AutopilotResponseContainerV1beta1.fromMap(Map<String, dynamic> map) {
    return AutopilotResponseContainerV1beta1(
      conversionStatus: pulumi.Input.fromValue(
        AutopilotConversionStatusResponse.fromMap(
