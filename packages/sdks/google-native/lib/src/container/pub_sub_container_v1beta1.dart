...
class PubSubContainerV1beta1 {
  ...
  factory PubSubContainerV1beta1.fromMap(Map<String, dynamic> map) {
    return PubSubContainerV1beta1(
      ...
      filter: (() { final guardedValue = map['filter']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FilterContainerV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
