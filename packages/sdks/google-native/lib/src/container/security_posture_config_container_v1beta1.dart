...
class SecurityPostureConfigContainerV1beta1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'mode': ?pulumi.Input.mapOptionalInputValue<SecurityPostureConfigModeContainerV1beta1, String>(mode, (value) => value.value),
      'vulnerabilityMode': ?pulumi.Input.mapOptionalInputValue<SecurityPostureConfigVulnerabilityModeContainerV1beta1, String>(vulnerabilityMode, (value) => value.value),
    };
  }
