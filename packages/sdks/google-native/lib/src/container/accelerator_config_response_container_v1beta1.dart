...
class AcceleratorConfigResponseContainerV1beta1 {
  ...
  factory AcceleratorConfigResponseContainerV1beta1.fromMap(Map<String, dynamic> map) {
    return AcceleratorConfigResponseContainerV1beta1(
      ...
      gpuDriverInstallationConfig: (GPUDriverInstallationConfigResponseContainerV1beta1.fromMap((map['gpuDriverInstallationConfig'] as Map).cast<String, dynamic>())).input(),
      gpuPartitionSize: (map['gpuPartitionSize'] as String).input(),
      gpuSharingConfig: (GPUSharingConfigResponseContainerV1beta1.fromMap((map['gpuSharingConfig'] as Map).cast<String, dynamic>())).input(),
      maxTimeSharedClientsPerGpu: (map['maxTimeSharedClientsPerGpu'] as String).input(),
    );
  }
}
