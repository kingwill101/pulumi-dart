...
class SandboxConfigContainerV1beta1 {
  ...
  SandboxConfigContainerV1beta1({this.sandboxType, this.type});
    ...
    return <String, dynamic>{
      ...
      'type':
          ?pulumi.Input.mapOptionalInputValue<
            SandboxConfigTypeContainerV1beta1,
            String
  ...
  factory SandboxConfigContainerV1beta1.fromMap(Map<String, dynamic> map) {
    return SandboxConfigContainerV1beta1(
      sandboxType: (() {
        final guardedValue = map['sandboxType'];
      ...
      type: (() {
        ...
        return pulumi.Input.fromValue(
          SandboxConfigTypeContainerV1beta1.fromValue(guardedValue as String),
        );
      })(),
    );
  }
