...
class MonitoringConfig {
  ...
  factory MonitoringConfig.fromMap(Map<String, dynamic> map) {
    return MonitoringConfig(
      advancedDatapathObservabilityConfig: (() { final guardedValue = map['advancedDatapathObservabilityConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AdvancedDatapathObservabilityConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      componentConfig: (() { final guardedValue = map['componentConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MonitoringComponentConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      managedPrometheusConfig: (() { final guardedValue = map['managedPrometheusConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagedPrometheusConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
