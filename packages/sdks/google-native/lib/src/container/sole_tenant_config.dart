...
class SoleTenantConfig {
  ...
  factory SoleTenantConfig.fromMap(Map<String, dynamic> map) {
    return SoleTenantConfig(
      nodeAffinities: (() { final guardedValue = map['nodeAffinities']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NodeAffinity>(guardedValue, (value) => NodeAffinity.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
