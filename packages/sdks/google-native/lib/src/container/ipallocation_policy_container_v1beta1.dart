...
class IPAllocationPolicyContainerV1beta1 {
  ...
  const IPAllocationPolicyContainerV1beta1({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ipv6AccessType': ?pulumi.Input.mapOptionalInputValue<IPAllocationPolicyIpv6AccessTypeContainerV1beta1, String>(ipv6AccessType, (value) => value.wireValue),
      ...
      'stackType': ?pulumi.Input.mapOptionalInputValue<IPAllocationPolicyStackTypeContainerV1beta1, String>(stackType, (value) => value.wireValue),
  ...
  factory IPAllocationPolicyContainerV1beta1.fromMap(Map<String, dynamic> map) {
    return IPAllocationPolicyContainerV1beta1(
      allowRouteOverlap: (() { final guardedValue = map['allowRouteOverlap']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      createSubnetwork: (() { final guardedValue = map['createSubnetwork']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ipv6AccessType: (() { final guardedValue = map['ipv6AccessType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(IPAllocationPolicyIpv6AccessTypeContainerV1beta1.fromValue(guardedValue as String)); })(),
      nodeIpv4Cidr: (() { final guardedValue = map['nodeIpv4Cidr']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      nodeIpv4CidrBlock: (() { final guardedValue = map['nodeIpv4CidrBlock']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      stackType: (() { final guardedValue = map['stackType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(IPAllocationPolicyStackTypeContainerV1beta1.fromValue(guardedValue as String)); })(),
      ...
      useRoutes: (() { final guardedValue = map['useRoutes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
    );
  }
}
