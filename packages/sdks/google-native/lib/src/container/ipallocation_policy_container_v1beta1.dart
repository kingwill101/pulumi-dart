...
class IPAllocationPolicyContainerV1beta1 {
  ...
  factory IPAllocationPolicyContainerV1beta1.fromMap(Map<String, dynamic> map) {
    return IPAllocationPolicyContainerV1beta1(
      allowRouteOverlap: map['allowRouteOverlap'] == null ? null : map['allowRouteOverlap'] as bool,
      ...
      ipv6AccessType: map['ipv6AccessType'] == null ? null : IPAllocationPolicyIpv6AccessTypeContainerV1beta1.fromValue(map['ipv6AccessType'] as String),
      ...
      stackType: map['stackType'] == null ? null : IPAllocationPolicyStackTypeContainerV1beta1.fromValue(map['stackType'] as String),
