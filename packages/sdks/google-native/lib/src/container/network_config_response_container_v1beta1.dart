...
class NetworkConfigResponseContainerV1beta1 {
  ...
  final ClusterNetworkPerformanceConfigResponseContainerV1beta1 networkPerformanceConfig;
  /// The desired state of IPv6 connectivity to Google Services. By default, no private IPv6 access to or from Google Services (all access will be via IPv4)
  final String privateIpv6GoogleAccess;
  /// ServiceExternalIPsConfig specifies if services with externalIPs field are blocked or not.
  final ServiceExternalIPsConfigResponseContainerV1beta1 serviceExternalIpsConfig;
  ...
  factory NetworkConfigResponseContainerV1beta1.fromMap(Map<String, dynamic> map) {
    return NetworkConfigResponseContainerV1beta1(
      ...
      defaultSnatStatus: DefaultSnatStatusResponseContainerV1beta1.fromMap((map['defaultSnatStatus'] as Map).cast<String, dynamic>()),
      dnsConfig: DNSConfigResponseContainerV1beta1.fromMap((map['dnsConfig'] as Map).cast<String, dynamic>()),
      ...
      gatewayApiConfig: GatewayAPIConfigResponseContainerV1beta1.fromMap((map['gatewayApiConfig'] as Map).cast<String, dynamic>()),
      inTransitEncryptionConfig: map['inTransitEncryptionConfig'] as String,
      network: map['network'] as String,
      networkPerformanceConfig: ClusterNetworkPerformanceConfigResponseContainerV1beta1.fromMap((map['networkPerformanceConfig'] as Map).cast<String, dynamic>()),
      privateIpv6GoogleAccess: map['privateIpv6GoogleAccess'] as String,
      serviceExternalIpsConfig: ServiceExternalIPsConfigResponseContainerV1beta1.fromMap((map['serviceExternalIpsConfig'] as Map).cast<String, dynamic>()),
