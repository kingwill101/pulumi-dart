...
class NetworkConfigResponseContainerV1beta1 {
  ...
  factory NetworkConfigResponseContainerV1beta1.fromMap(Map<String, dynamic> map) {
    return NetworkConfigResponseContainerV1beta1(
      ...
      defaultSnatStatus: (DefaultSnatStatusResponseContainerV1beta1.fromMap((map['defaultSnatStatus'] as Map).cast<String, dynamic>())).input(),
      dnsConfig: (DNSConfigResponseContainerV1beta1.fromMap((map['dnsConfig'] as Map).cast<String, dynamic>())).input(),
      ...
      gatewayApiConfig: (GatewayAPIConfigResponseContainerV1beta1.fromMap((map['gatewayApiConfig'] as Map).cast<String, dynamic>())).input(),
      inTransitEncryptionConfig: (map['inTransitEncryptionConfig'] as String).input(),
      network: (map['network'] as String).input(),
      networkPerformanceConfig: (ClusterNetworkPerformanceConfigResponseContainerV1beta1.fromMap((map['networkPerformanceConfig'] as Map).cast<String, dynamic>())).input(),
      privateIpv6GoogleAccess: (map['privateIpv6GoogleAccess'] as String).input(),
      serviceExternalIpsConfig: (ServiceExternalIPsConfigResponseContainerV1beta1.fromMap((map['serviceExternalIpsConfig'] as Map).cast<String, dynamic>())).input(),
