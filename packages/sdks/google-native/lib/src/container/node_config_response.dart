...
class NodeConfigResponse {
  ...
  factory NodeConfigResponse.fromMap(Map<String, dynamic> map) {
    return NodeConfigResponse(
      ...
      confidentialNodes: (ConfidentialNodesResponse.fromMap((map['confidentialNodes'] as Map).cast<String, dynamic>())).input(),
      diskSizeGb: (map['diskSizeGb'] as int).input(),
      diskType: (map['diskType'] as String).input(),
      ephemeralStorageLocalSsdConfig: (EphemeralStorageLocalSsdConfigResponse.fromMap((map['ephemeralStorageLocalSsdConfig'] as Map).cast<String, dynamic>())).input(),
      fastSocket: (FastSocketResponse.fromMap((map['fastSocket'] as Map).cast<String, dynamic>())).input(),
      gcfsConfig: (GcfsConfigResponse.fromMap((map['gcfsConfig'] as Map).cast<String, dynamic>())).input(),
      gvnic: (VirtualNICResponse.fromMap((map['gvnic'] as Map).cast<String, dynamic>())).input(),
      imageType: (map['imageType'] as String).input(),
      kubeletConfig: (NodeKubeletConfigResponse.fromMap((map['kubeletConfig'] as Map).cast<String, dynamic>())).input(),
      labels: ((map['labels'] as Map).cast<String, String>()).input(),
      linuxNodeConfig: (LinuxNodeConfigResponse.fromMap((map['linuxNodeConfig'] as Map).cast<String, dynamic>())).input(),
      localNvmeSsdBlockConfig: (LocalNvmeSsdBlockConfigResponse.fromMap((map['localNvmeSsdBlockConfig'] as Map).cast<String, dynamic>())).input(),
      localSsdCount: (map['localSsdCount'] as int).input(),
      loggingConfig: (NodePoolLoggingConfigResponse.fromMap((map['loggingConfig'] as Map).cast<String, dynamic>())).input(),
      ...
      sandboxConfig: (SandboxConfigResponse.fromMap((map['sandboxConfig'] as Map).cast<String, dynamic>())).input(),
      ...
      soleTenantConfig: (SoleTenantConfigResponse.fromMap((map['soleTenantConfig'] as Map).cast<String, dynamic>())).input(),
      ...
      windowsNodeConfig: (WindowsNodeConfigResponse.fromMap((map['windowsNodeConfig'] as Map).cast<String, dynamic>())).input(),
      workloadMetadataConfig: (WorkloadMetadataConfigResponse.fromMap((map['workloadMetadataConfig'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
