...
class NodeConfigResponse {
  ...
  final pulumi.Input<EphemeralStorageLocalSsdConfigResponse>
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'fastSocket':
          pulumi.Input.mapInputValue<FastSocketResponse, Map<String, dynamic>>(
            fastSocket,
            (value) => value.toMap(),
          ),
      'gcfsConfig':
          pulumi.Input.mapInputValue<GcfsConfigResponse, Map<String, dynamic>>(
            gcfsConfig,
            (value) => value.toMap(),
          ),
      'gvnic':
          pulumi.Input.mapInputValue<VirtualNICResponse, Map<String, dynamic>>(
            gvnic,
            (value) => value.toMap(),
          ),
      'imageType': imageType,
  ...
  factory NodeConfigResponse.fromMap(Map<String, dynamic> map) {
    return NodeConfigResponse(
      ...
      confidentialNodes: pulumi.Input.fromValue(
        ConfidentialNodesResponse.fromMap(
      ...
      kubeletConfig: pulumi.Input.fromValue(
        NodeKubeletConfigResponse.fromMap(
      ...
      loggingConfig: pulumi.Input.fromValue(
        NodePoolLoggingConfigResponse.fromMap(
      ...
      reservationAffinity: pulumi.Input.fromValue(
        ReservationAffinityResponse.fromMap(
      ...
      soleTenantConfig: pulumi.Input.fromValue(
        SoleTenantConfigResponse.fromMap(
      ...
      taints: pulumi.Input.fromValue(
        pulumi.Input.decodeList<NodeTaintResponse>(
          map['taints']!,
          (value) =>
