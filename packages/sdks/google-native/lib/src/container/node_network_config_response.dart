...
class NodeNetworkConfigResponse {
  ...
  factory NodeNetworkConfigResponse.fromMap(Map<String, dynamic> map) {
    return NodeNetworkConfigResponse(
      additionalNodeNetworkConfigs: (pulumi.Input.decodeList<AdditionalNodeNetworkConfigResponse>(map['additionalNodeNetworkConfigs'], (value) => AdditionalNodeNetworkConfigResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      additionalPodNetworkConfigs: (pulumi.Input.decodeList<AdditionalPodNetworkConfigResponse>(map['additionalPodNetworkConfigs'], (value) => AdditionalPodNetworkConfigResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
