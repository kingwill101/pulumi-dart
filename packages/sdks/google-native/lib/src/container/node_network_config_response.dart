...
class NodeNetworkConfigResponse {
  ...
  final pulumi.Input<List<AdditionalNodeNetworkConfigResponse>>
  additionalNodeNetworkConfigs;

  /// We specify the additional pod networks for this node pool using this list. Each pod network corresponds to an additional alias IP range for the node
  final pulumi.Input<List<AdditionalPodNetworkConfigResponse>>
    ...
    return <String, dynamic>{
      'additionalNodeNetworkConfigs':
          pulumi.Input.mapInputValue<
            List<AdditionalNodeNetworkConfigResponse>,
      ...
      'additionalPodNetworkConfigs':
          pulumi.Input.mapInputValue<
            List<AdditionalPodNetworkConfigResponse>,
            List<Map<String, dynamic>>
          >(
            additionalPodNetworkConfigs,
            (value) =>
  ...
  factory NodeNetworkConfigResponse.fromMap(Map<String, dynamic> map) {
    return NodeNetworkConfigResponse(
      ...
      networkPerformanceConfig: pulumi.Input.fromValue(
        NetworkPerformanceConfigResponse.fromMap(
