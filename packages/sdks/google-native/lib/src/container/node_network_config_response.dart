...
class NodeNetworkConfigResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'additionalNodeNetworkConfigs': pulumi.Input.encodeList<AdditionalNodeNetworkConfigResponse, Map<String, dynamic>>(additionalNodeNetworkConfigs, (value) => value.toMap()),
      'additionalPodNetworkConfigs': pulumi.Input.encodeList<AdditionalPodNetworkConfigResponse, Map<String, dynamic>>(additionalPodNetworkConfigs, (value) => value.toMap()),
  ...
  factory NodeNetworkConfigResponse.fromMap(Map<String, dynamic> map) {
    return NodeNetworkConfigResponse(
      additionalNodeNetworkConfigs: pulumi.Input.decodeList<AdditionalNodeNetworkConfigResponse>(map['additionalNodeNetworkConfigs'], (value) => AdditionalNodeNetworkConfigResponse.fromMap((value as Map).cast<String, dynamic>())),
      additionalPodNetworkConfigs: pulumi.Input.decodeList<AdditionalPodNetworkConfigResponse>(map['additionalPodNetworkConfigs'], (value) => AdditionalPodNetworkConfigResponse.fromMap((value as Map).cast<String, dynamic>())),
      ...
      podCidrOverprovisionConfig: PodCIDROverprovisionConfigResponse.fromMap((map['podCidrOverprovisionConfig'] as Map).cast<String, dynamic>()),
