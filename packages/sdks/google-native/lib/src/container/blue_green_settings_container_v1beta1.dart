...
class BlueGreenSettingsContainerV1beta1 {
  ...
  const BlueGreenSettingsContainerV1beta1({
  ...
  factory BlueGreenSettingsContainerV1beta1.fromMap(Map<String, dynamic> map) {
    return BlueGreenSettingsContainerV1beta1(
      ...
      standardRolloutPolicy: (() { final guardedValue = map['standardRolloutPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(StandardRolloutPolicyContainerV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
