...
class NodeManagementResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'upgradeOptions': pulumi.Input.mapInputValue<AutoUpgradeOptionsResponse, Map<String, dynamic>>(upgradeOptions, (value) => value.toMap()),
    };
  }
  ...
  factory NodeManagementResponse.fromMap(Map<String, dynamic> map) {
    return NodeManagementResponse(
      ...
      upgradeOptions: pulumi.Input.fromValue(AutoUpgradeOptionsResponse.fromMap((map['upgradeOptions']! as Map).cast<String, dynamic>())),
    );
  }
}
