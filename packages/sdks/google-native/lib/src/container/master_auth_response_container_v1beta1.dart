...
class MasterAuthResponseContainerV1beta1 {
  ...
  const MasterAuthResponseContainerV1beta1({
  ...
  factory MasterAuthResponseContainerV1beta1.fromMap(Map<String, dynamic> map) {
    return MasterAuthResponseContainerV1beta1(
      ...
      clientCertificateConfig: pulumi.Input.fromValue(ClientCertificateConfigResponseContainerV1beta1.fromMap((map['clientCertificateConfig']! as Map).cast<String, dynamic>())),
