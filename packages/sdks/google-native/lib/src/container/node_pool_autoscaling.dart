...
class NodePoolAutoscaling {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'enabled': ?enabled,
      'locationPolicy': ?pulumi.Input.mapOptionalInputValue<NodePoolAutoscalingLocationPolicy, String>(locationPolicy, (value) => value.wireValue),
  ...
  factory NodePoolAutoscaling.fromMap(Map<String, dynamic> map) {
    return NodePoolAutoscaling(
      ...
      locationPolicy: (() { final guardedValue = map['locationPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NodePoolAutoscalingLocationPolicy.fromValue(guardedValue as String)); })(),
