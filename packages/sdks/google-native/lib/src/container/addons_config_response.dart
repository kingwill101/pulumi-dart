...
class AddonsConfigResponse {
  ...
  factory AddonsConfigResponse.fromMap(Map<String, dynamic> map) {
    return AddonsConfigResponse(
      cloudRunConfig: pulumi.Input.fromValue(CloudRunConfigResponse.fromMap((map['cloudRunConfig']! as Map).cast<String, dynamic>())),
      configConnectorConfig: pulumi.Input.fromValue(ConfigConnectorConfigResponse.fromMap((map['configConnectorConfig']! as Map).cast<String, dynamic>())),
      dnsCacheConfig: pulumi.Input.fromValue(DnsCacheConfigResponse.fromMap((map['dnsCacheConfig']! as Map).cast<String, dynamic>())),
      gcePersistentDiskCsiDriverConfig: pulumi.Input.fromValue(GcePersistentDiskCsiDriverConfigResponse.fromMap((map['gcePersistentDiskCsiDriverConfig']! as Map).cast<String, dynamic>())),
      gcpFilestoreCsiDriverConfig: pulumi.Input.fromValue(GcpFilestoreCsiDriverConfigResponse.fromMap((map['gcpFilestoreCsiDriverConfig']! as Map).cast<String, dynamic>())),
      gcsFuseCsiDriverConfig: pulumi.Input.fromValue(GcsFuseCsiDriverConfigResponse.fromMap((map['gcsFuseCsiDriverConfig']! as Map).cast<String, dynamic>())),
      gkeBackupAgentConfig: pulumi.Input.fromValue(GkeBackupAgentConfigResponse.fromMap((map['gkeBackupAgentConfig']! as Map).cast<String, dynamic>())),
      horizontalPodAutoscaling: pulumi.Input.fromValue(HorizontalPodAutoscalingResponse.fromMap((map['horizontalPodAutoscaling']! as Map).cast<String, dynamic>())),
      httpLoadBalancing: pulumi.Input.fromValue(HttpLoadBalancingResponse.fromMap((map['httpLoadBalancing']! as Map).cast<String, dynamic>())),
      kubernetesDashboard: pulumi.Input.fromValue(KubernetesDashboardResponse.fromMap((map['kubernetesDashboard']! as Map).cast<String, dynamic>())),
      networkPolicyConfig: pulumi.Input.fromValue(NetworkPolicyConfigResponse.fromMap((map['networkPolicyConfig']! as Map).cast<String, dynamic>())),
    );
  }
}
