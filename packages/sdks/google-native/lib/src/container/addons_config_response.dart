...
class AddonsConfigResponse {
  ...
  final pulumi.Input<GcePersistentDiskCsiDriverConfigResponse>
  gcePersistentDiskCsiDriverConfig;

  /// Configuration for the GCP Filestore CSI driver.
  final pulumi.Input<GcpFilestoreCsiDriverConfigResponse>
