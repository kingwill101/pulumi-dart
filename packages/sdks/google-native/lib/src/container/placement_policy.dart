...
class PlacementPolicy {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'type': ?pulumi.Input.mapOptionalInputValue<PlacementPolicyType, String>(type, (value) => value.wireValue),
    };
  }
  ...
  factory PlacementPolicy.fromMap(Map<String, dynamic> map) {
    return PlacementPolicy(
      ...
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PlacementPolicyType.fromValue(guardedValue as String)); })(),
    );
  }
}
