...
class OpportunisticMaintenanceStrategyResponse {
  ...
  factory OpportunisticMaintenanceStrategyResponse.fromMap(Map<String, dynamic> map) {
    return OpportunisticMaintenanceStrategyResponse(
      maintenanceAvailabilityWindow: (map['maintenanceAvailabilityWindow'] as String).input(),
      minNodesPerPool: (map['minNodesPerPool'] as String).input(),
      nodeIdleTimeWindow: (map['nodeIdleTimeWindow'] as String).input(),
    );
  }
}
