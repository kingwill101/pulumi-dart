...
class DNSConfigContainerV1beta1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'clusterDns': ?pulumi.Input.mapOptionalInputValue<DNSConfigClusterDnsContainerV1beta1, String>(clusterDns, (value) => value.value),
      'clusterDnsDomain': ?clusterDnsDomain,
      'clusterDnsScope': ?pulumi.Input.mapOptionalInputValue<DNSConfigClusterDnsScopeContainerV1beta1, String>(clusterDnsScope, (value) => value.value),
    };
  }
