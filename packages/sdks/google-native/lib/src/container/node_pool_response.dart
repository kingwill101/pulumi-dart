...
class NodePoolResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'updateInfo':
          pulumi.Input.mapInputValue<UpdateInfoResponse, Map<String, dynamic>>(
            updateInfo,
            (value) => value.toMap(),
          ),
      'upgradeSettings':
  ...
  factory NodePoolResponse.fromMap(Map<String, dynamic> map) {
    return NodePoolResponse(
      ...
      networkConfig: pulumi.Input.fromValue(
        NodeNetworkConfigResponse.fromMap(
          (map['networkConfig']! as Map).cast<String, dynamic>(),
        ),
      ),
      placementPolicy: pulumi.Input.fromValue(
        PlacementPolicyResponse.fromMap(
      ...
      queuedProvisioning: pulumi.Input.fromValue(
        QueuedProvisioningResponse.fromMap(
