...
class IosTestSetup {
  ...
  factory IosTestSetup.fromMap(Map<String, dynamic> map) {
    return IosTestSetup(
      additionalIpas: (() { final guardedValue = map['additionalIpas']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FileReference>(guardedValue, (value) => FileReference.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      pullDirectories: (() { final guardedValue = map['pullDirectories']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<IosDeviceFile>(guardedValue, (value) => IosDeviceFile.fromMap((value as Map).cast<String, dynamic>()))); })(),
      pushFiles: (() { final guardedValue = map['pushFiles']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<IosDeviceFile>(guardedValue, (value) => IosDeviceFile.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
