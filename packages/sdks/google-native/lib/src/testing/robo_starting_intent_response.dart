...
class RoboStartingIntentResponse {
  ...
  factory RoboStartingIntentResponse.fromMap(Map<String, dynamic> map) {
    return RoboStartingIntentResponse(
      launcherActivity: ((map['launcherActivity'] as Map).cast<String, dynamic>()).input(),
      noActivity: ((map['noActivity'] as Map).cast<String, dynamic>()).input(),
      startActivity: (StartActivityIntentResponse.fromMap((map['startActivity'] as Map).cast<String, dynamic>())).input(),
