...
class AndroidInstrumentationTestResponse {
  ...
  const AndroidInstrumentationTestResponse({
  ...
  factory AndroidInstrumentationTestResponse.fromMap(Map<String, dynamic> map) {
    return AndroidInstrumentationTestResponse(
      ...
      orchestratorOption: pulumi.Input.fromValue(map['orchestratorOption'] as String),
      shardingOption: pulumi.Input.fromValue(ShardingOptionResponse.fromMap((map['shardingOption']! as Map).cast<String, dynamic>())),
      testApk: pulumi.Input.fromValue(FileReferenceResponse.fromMap((map['testApk']! as Map).cast<String, dynamic>())),
