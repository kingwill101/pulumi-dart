...
class AndroidInstrumentationTestResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'appBundle':
          pulumi.Input.mapInputValue<AppBundleResponse, Map<String, dynamic>>(
            appBundle,
            (value) => value.toMap(),
          ),
