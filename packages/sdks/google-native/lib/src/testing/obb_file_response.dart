...
class ObbFileResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'obb': pulumi.Input.mapInputValue<FileReferenceResponse, Map<String, dynamic>>(obb, (value) => value.toMap()),
  ...
  factory ObbFileResponse.fromMap(Map<String, dynamic> map) {
    return ObbFileResponse(
      obb: (FileReferenceResponse.fromMap((map['obb'] as Map).cast<String, dynamic>())).input(),
      obbFileName: (map['obbFileName'] as String).input(),
    );
  }
}
