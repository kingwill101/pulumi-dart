...
class TestSetup {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'account':
          ?pulumi.Input.mapOptionalInputValue<Account, Map<String, dynamic>>(
            account,
            (value) => value.toMap(),
          ),
      'additionalApks':
          ...
          >(
            additionalApks,
            (value) => pulumi.Input.encodeList<Apk, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
    ...
    return TestSetup(
      account: (() {
        ...
        return pulumi.Input.fromValue(
          Account.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      additionalApks: (() {
        final guardedValue = map['additionalApks'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      directoriesToPull: (() {
        final guardedValue = map['directoriesToPull'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      dontAutograntPermissions: (() {
        final guardedValue = map['dontAutograntPermissions'];
        if (guardedValue == null) return null;
      ...
      filesToPush: (() {
        final guardedValue = map['filesToPush'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      initialSetupApks: (() {
        final guardedValue = map['initialSetupApks'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<Apk>(
            guardedValue,
      ...
      systrace: (() {
        final guardedValue = map['systrace'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SystraceSetup.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
