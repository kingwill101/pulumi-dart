...
class TestSetup {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'additionalApks': ?additionalApks == null ? null : pulumi.Input.encodeList<Apk, Map<String, dynamic>>(additionalApks!, (value) => value.toMap()),
      ...
      'filesToPush': ?filesToPush == null ? null : pulumi.Input.encodeList<DeviceFile, Map<String, dynamic>>(filesToPush!, (value) => value.toMap()),
      'initialSetupApks': ?initialSetupApks == null ? null : pulumi.Input.encodeList<Apk, Map<String, dynamic>>(initialSetupApks!, (value) => value.toMap()),
  ...
  factory TestSetup.fromMap(Map<String, dynamic> map) {
    return TestSetup(
      account: map['account'] == null ? null : Account.fromMap((map['account'] as Map).cast<String, dynamic>()),
      additionalApks: map['additionalApks'] == null ? null : pulumi.Input.decodeList<Apk>(map['additionalApks'], (value) => Apk.fromMap((value as Map).cast<String, dynamic>())),
      directoriesToPull: map['directoriesToPull'] == null ? null : (map['directoriesToPull'] as List).cast<String>(),
      dontAutograntPermissions: map['dontAutograntPermissions'] == null ? null : map['dontAutograntPermissions'] as bool,
      ...
      filesToPush: map['filesToPush'] == null ? null : pulumi.Input.decodeList<DeviceFile>(map['filesToPush'], (value) => DeviceFile.fromMap((value as Map).cast<String, dynamic>())),
      initialSetupApks: map['initialSetupApks'] == null ? null : pulumi.Input.decodeList<Apk>(map['initialSetupApks'], (value) => Apk.fromMap((value as Map).cast<String, dynamic>())),
      networkProfile: map['networkProfile'] == null ? null : map['networkProfile'] as String,
      systrace: map['systrace'] == null ? null : SystraceSetup.fromMap((map['systrace'] as Map).cast<String, dynamic>()),
    );
  }
}
