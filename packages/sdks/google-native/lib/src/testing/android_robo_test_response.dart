...
class AndroidRoboTestResponse {
  ...
  factory AndroidRoboTestResponse.fromMap(Map<String, dynamic> map) {
    return AndroidRoboTestResponse(
      ...
      appInitialActivity: pulumi.Input.fromValue(
      ...
      roboDirectives: pulumi.Input.fromValue(
        pulumi.Input.decodeList<RoboDirectiveResponse>(
          map['roboDirectives']!,
      ...
      startingIntents: pulumi.Input.fromValue(
        pulumi.Input.decodeList<RoboStartingIntentResponse>(
          map['startingIntents']!,
