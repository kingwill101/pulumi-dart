...
class AndroidRoboTest {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'maxDepth': ?maxDepth,
      'maxSteps': ?maxSteps,
      'roboDirectives': ?roboDirectives == null ? null : pulumi.Input.encodeList<RoboDirective, Map<String, dynamic>>(roboDirectives!, (value) => value.toMap()),
      'roboMode': ?roboMode == null ? null : roboMode!.value,
      'roboScript': ?roboScript == null ? null : roboScript!.toMap(),
      'startingIntents': ?startingIntents == null ? null : pulumi.Input.encodeList<RoboStartingIntent, Map<String, dynamic>>(startingIntents!, (value) => value.toMap()),
    };
  }

  factory AndroidRoboTest.fromMap(Map<String, dynamic> map) {
    return AndroidRoboTest(
      appApk: map['appApk'] == null ? null : FileReference.fromMap((map['appApk'] as Map).cast<String, dynamic>()),
      appBundle: map['appBundle'] == null ? null : AppBundle.fromMap((map['appBundle'] as Map).cast<String, dynamic>()),
      appInitialActivity: map['appInitialActivity'] == null ? null : map['appInitialActivity'] as String,
      appPackageId: map['appPackageId'] == null ? null : map['appPackageId'] as String,
      maxDepth: map['maxDepth'] == null ? null : map['maxDepth'] as int,
      maxSteps: map['maxSteps'] == null ? null : map['maxSteps'] as int,
      roboDirectives: map['roboDirectives'] == null ? null : pulumi.Input.decodeList<RoboDirective>(map['roboDirectives'], (value) => RoboDirective.fromMap((value as Map).cast<String, dynamic>())),
      roboMode: map['roboMode'] == null ? null : AndroidRoboTestRoboMode.fromValue(map['roboMode'] as String),
      roboScript: map['roboScript'] == null ? null : FileReference.fromMap((map['roboScript'] as Map).cast<String, dynamic>()),
      startingIntents: map['startingIntents'] == null ? null : pulumi.Input.decodeList<RoboStartingIntent>(map['startingIntents'], (value) => RoboStartingIntent.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
