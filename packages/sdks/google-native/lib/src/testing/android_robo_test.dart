...
class AndroidRoboTest {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'roboMode':
          ?pulumi.Input.mapOptionalInputValue<AndroidRoboTestRoboMode, String>(
            roboMode,
  ...
  factory AndroidRoboTest.fromMap(Map<String, dynamic> map) {
    return AndroidRoboTest(
      ...
      roboDirectives: (() {
        final guardedValue = map['roboDirectives'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      roboMode: (() {
        final guardedValue = map['roboMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AndroidRoboTestRoboMode.fromValue(guardedValue as String),
        );
      })(),
      roboScript: (() {
      ...
      startingIntents: (() {
        final guardedValue = map['startingIntents'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
