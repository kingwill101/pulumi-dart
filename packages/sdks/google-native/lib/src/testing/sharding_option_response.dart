...
class ShardingOptionResponse {
  ...
  factory ShardingOptionResponse.fromMap(Map<String, dynamic> map) {
    return ShardingOptionResponse(
      manualSharding: pulumi.Input.fromValue(ManualShardingResponse.fromMap((map['manualSharding']! as Map).cast<String, dynamic>())),
      smartSharding: pulumi.Input.fromValue(SmartShardingResponse.fromMap((map['smartSharding']! as Map).cast<String, dynamic>())),
      uniformSharding: pulumi.Input.fromValue(UniformShardingResponse.fromMap((map['uniformSharding']! as Map).cast<String, dynamic>())),
    );
  }
}
