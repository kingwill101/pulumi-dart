...
class EnvironmentMatrix {
  ...
  factory EnvironmentMatrix.fromMap(Map<String, dynamic> map) {
    return EnvironmentMatrix(
      androidDeviceList: (() {
        final guardedValue = map['androidDeviceList'];
      ...
      androidMatrix: (() {
        final guardedValue = map['androidMatrix'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AndroidMatrix.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      iosDeviceList: (() {
        final guardedValue = map['iosDeviceList'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          IosDeviceList.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
