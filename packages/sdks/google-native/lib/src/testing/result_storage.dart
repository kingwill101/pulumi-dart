...
class ResultStorage {
  ...
  factory ResultStorage.fromMap(Map<String, dynamic> map) {
    return ResultStorage(
      googleCloudStorage: pulumi.Input.fromValue(GoogleCloudStorage.fromMap((map['googleCloudStorage']! as Map).cast<String, dynamic>())),
      toolResultsHistory: (() { final guardedValue = map['toolResultsHistory']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ToolResultsHistory.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
