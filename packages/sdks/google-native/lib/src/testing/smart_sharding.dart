...
class SmartSharding {
  ...
  final pulumi.Input<String>? targetedShardDuration;
  ...
  factory SmartSharding.fromMap(Map<String, dynamic> map) {
    return SmartSharding(
      targetedShardDuration: (() { final guardedValue = map['targetedShardDuration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
