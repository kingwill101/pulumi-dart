...
class RoboStartingIntent {
  ...
  factory RoboStartingIntent.fromMap(Map<String, dynamic> map) {
    return RoboStartingIntent(
      launcherActivity: (() { final guardedValue = map['launcherActivity']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, dynamic>()); })(),
      noActivity: (() { final guardedValue = map['noActivity']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, dynamic>()); })(),
      startActivity: (() { final guardedValue = map['startActivity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(StartActivityIntent.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
