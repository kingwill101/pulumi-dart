...
class TestMatrixArgs {
  ...
  factory TestMatrixArgs.fromMap(Map<String, dynamic> map) {
    return TestMatrixArgs(
      ...
      environmentMatrix: pulumi.Input.fromValue(
        EnvironmentMatrix.fromMap(
          (map['environmentMatrix']! as Map).cast<String, dynamic>(),
        ),
      ),
      failFast: (() {
        final guardedValue = map['failFast'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      flakyTestAttempts: (() {
        final guardedValue = map['flakyTestAttempts'];
        if (guardedValue == null) return null;
