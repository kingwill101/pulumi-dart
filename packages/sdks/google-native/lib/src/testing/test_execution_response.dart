...
class TestExecutionResponse {
  ...
  factory TestExecutionResponse.fromMap(Map<String, dynamic> map) {
    return TestExecutionResponse(
      ...
      shard: pulumi.Input.fromValue(ShardResponse.fromMap((map['shard']! as Map).cast<String, dynamic>())),
      state: pulumi.Input.fromValue(map['state'] as String),
      testDetails: pulumi.Input.fromValue(TestDetailsResponse.fromMap((map['testDetails']! as Map).cast<String, dynamic>())),
      testSpecification: pulumi.Input.fromValue(TestSpecificationResponse.fromMap((map['testSpecification']! as Map).cast<String, dynamic>())),
      timestamp: pulumi.Input.fromValue(map['timestamp'] as String),
      toolResultsStep: pulumi.Input.fromValue(ToolResultsStepResponse.fromMap((map['toolResultsStep']! as Map).cast<String, dynamic>())),
    );
  }
}
