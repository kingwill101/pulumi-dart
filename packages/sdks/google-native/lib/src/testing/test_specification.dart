...
class TestSpecification {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'testSetup':
          ?pulumi.Input.mapOptionalInputValue<TestSetup, Map<String, dynamic>>(
            testSetup,
            (value) => value.toMap(),
          ),
  ...
  factory TestSpecification.fromMap(Map<String, dynamic> map) {
    return TestSpecification(
      ...
      disablePerformanceMetrics: (() {
        final guardedValue = map['disablePerformanceMetrics'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      disableVideoRecording: (() {
        final guardedValue = map['disableVideoRecording'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      iosRoboTest: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          IosRoboTest.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      iosTestLoop: (() {
      ...
      iosTestSetup: (() {
        final guardedValue = map['iosTestSetup'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          IosTestSetup.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      iosXcTest: (() {
      ...
      testSetup: (() {
        final guardedValue = map['testSetup'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TestSetup.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      testTimeout: (() {
