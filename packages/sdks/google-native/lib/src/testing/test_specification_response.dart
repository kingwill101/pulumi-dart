...
class TestSpecificationResponse {
  ...
  factory TestSpecificationResponse.fromMap(Map<String, dynamic> map) {
    return TestSpecificationResponse(
      ...
      androidTestLoop: pulumi.Input.fromValue(AndroidTestLoopResponse.fromMap((map['androidTestLoop']! as Map).cast<String, dynamic>())),
      disablePerformanceMetrics: pulumi.Input.fromValue(map['disablePerformanceMetrics'] as bool),
      disableVideoRecording: pulumi.Input.fromValue(map['disableVideoRecording'] as bool),
      iosRoboTest: pulumi.Input.fromValue(IosRoboTestResponse.fromMap((map['iosRoboTest']! as Map).cast<String, dynamic>())),
      iosTestLoop: pulumi.Input.fromValue(IosTestLoopResponse.fromMap((map['iosTestLoop']! as Map).cast<String, dynamic>())),
      iosTestSetup: pulumi.Input.fromValue(IosTestSetupResponse.fromMap((map['iosTestSetup']! as Map).cast<String, dynamic>())),
      iosXcTest: pulumi.Input.fromValue(IosXcTestResponse.fromMap((map['iosXcTest']! as Map).cast<String, dynamic>())),
      testSetup: pulumi.Input.fromValue(TestSetupResponse.fromMap((map['testSetup']! as Map).cast<String, dynamic>())),
