...
class GetTestMatrixResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'state': state,
      'testExecutions': pulumi.Input.encodeList<TestExecutionResponse, Map<String, dynamic>>(testExecutions, (value) => value.toMap()),
  ...
  factory GetTestMatrixResult.fromMap(Map<String, dynamic> map) {
    return GetTestMatrixResult(
      clientInfo: ClientInfoResponse.fromMap((map['clientInfo']! as Map).cast<String, dynamic>()),
      environmentMatrix: EnvironmentMatrixResponse.fromMap((map['environmentMatrix']! as Map).cast<String, dynamic>()),
      ...
      resultStorage: ResultStorageResponse.fromMap((map['resultStorage']! as Map).cast<String, dynamic>()),
      state: map['state'] as String,
      testExecutions: pulumi.Input.decodeList<TestExecutionResponse>(map['testExecutions']!, (value) => TestExecutionResponse.fromMap((value as Map).cast<String, dynamic>())),
