...
class IosDeviceList {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'iosDevices':
          pulumi
              .Input.mapInputValue<List<IosDevice>, List<Map<String, dynamic>>>(
            iosDevices,
            (value) => pulumi.Input.encodeList<IosDevice, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
  ...
  factory IosDeviceList.fromMap(Map<String, dynamic> map) {
    return IosDeviceList(
      iosDevices: pulumi.Input.fromValue(
        pulumi.Input.decodeList<IosDevice>(
          map['iosDevices']!,
