...
class ObbFile {
  ...
  ObbFile({required this.obb, required this.obbFileName});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'obb': pulumi.Input.mapInputValue<FileReference, Map<String, dynamic>>(
        obb,
        (value) => value.toMap(),
      ),
  ...
  factory ObbFile.fromMap(Map<String, dynamic> map) {
    return ObbFile(
      obb: pulumi.Input.fromValue(
        FileReference.fromMap((map['obb']! as Map).cast<String, dynamic>()),
      ),
