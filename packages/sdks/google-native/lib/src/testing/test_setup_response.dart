...
class TestSetupResponse {
  ...
  factory TestSetupResponse.fromMap(Map<String, dynamic> map) {
    return TestSetupResponse(
      account: (AccountResponse.fromMap((map['account'] as Map).cast<String, dynamic>())).input(),
      additionalApks: (pulumi.Input.decodeList<ApkResponse>(map['additionalApks'], (value) => ApkResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      directoriesToPull: ((map['directoriesToPull'] as List).cast<String>()).input(),
      dontAutograntPermissions: (map['dontAutograntPermissions'] as bool).input(),
      environmentVariables: (pulumi.Input.decodeList<EnvironmentVariableResponse>(map['environmentVariables'], (value) => EnvironmentVariableResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      filesToPush: (pulumi.Input.decodeList<DeviceFileResponse>(map['filesToPush'], (value) => DeviceFileResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      initialSetupApks: (pulumi.Input.decodeList<ApkResponse>(map['initialSetupApks'], (value) => ApkResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      networkProfile: (map['networkProfile'] as String).input(),
      systrace: (SystraceSetupResponse.fromMap((map['systrace'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
