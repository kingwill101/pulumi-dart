...
class TestSetupResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'account': pulumi.Input.mapInputValue<AccountResponse, Map<String, dynamic>>(account, (value) => value.toMap()),
      'additionalApks': pulumi.Input.mapInputValue<List<ApkResponse>, List<Map<String, dynamic>>>(additionalApks, (value) => pulumi.Input.encodeList<ApkResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'directoriesToPull': directoriesToPull,
      'dontAutograntPermissions': dontAutograntPermissions,
      'environmentVariables': pulumi.Input.mapInputValue<List<EnvironmentVariableResponse>, List<Map<String, dynamic>>>(environmentVariables, (value) => pulumi.Input.encodeList<EnvironmentVariableResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'filesToPush': pulumi.Input.mapInputValue<List<DeviceFileResponse>, List<Map<String, dynamic>>>(filesToPush, (value) => pulumi.Input.encodeList<DeviceFileResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'initialSetupApks': pulumi.Input.mapInputValue<List<ApkResponse>, List<Map<String, dynamic>>>(initialSetupApks, (value) => pulumi.Input.encodeList<ApkResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'networkProfile': networkProfile,
      'systrace': pulumi.Input.mapInputValue<SystraceSetupResponse, Map<String, dynamic>>(systrace, (value) => value.toMap()),
    };
  }

  factory TestSetupResponse.fromMap(Map<String, dynamic> map) {
    return TestSetupResponse(
      account: pulumi.Input.fromValue(AccountResponse.fromMap((map['account']! as Map).cast<String, dynamic>())),
      additionalApks: pulumi.Input.fromValue(pulumi.Input.decodeList<ApkResponse>(map['additionalApks']!, (value) => ApkResponse.fromMap((value as Map).cast<String, dynamic>()))),
      directoriesToPull: pulumi.Input.fromValue((map['directoriesToPull'] as List).cast<String>()),
      dontAutograntPermissions: pulumi.Input.fromValue(map['dontAutograntPermissions'] as bool),
      environmentVariables: pulumi.Input.fromValue(pulumi.Input.decodeList<EnvironmentVariableResponse>(map['environmentVariables']!, (value) => EnvironmentVariableResponse.fromMap((value as Map).cast<String, dynamic>()))),
      filesToPush: pulumi.Input.fromValue(pulumi.Input.decodeList<DeviceFileResponse>(map['filesToPush']!, (value) => DeviceFileResponse.fromMap((value as Map).cast<String, dynamic>()))),
      initialSetupApks: pulumi.Input.fromValue(pulumi.Input.decodeList<ApkResponse>(map['initialSetupApks']!, (value) => ApkResponse.fromMap((value as Map).cast<String, dynamic>()))),
      networkProfile: pulumi.Input.fromValue(map['networkProfile'] as String),
      systrace: pulumi.Input.fromValue(SystraceSetupResponse.fromMap((map['systrace']! as Map).cast<String, dynamic>())),
    );
  }
}
