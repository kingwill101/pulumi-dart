...
class TestSetupResponse {
  ...
  final List<ApkResponse> additionalApks;
  ...
  final SystraceSetupResponse systrace;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'additionalApks': pulumi.Input.encodeList<ApkResponse, Map<String, dynamic>>(additionalApks, (value) => value.toMap()),
      'directoriesToPull': directoriesToPull,
      'dontAutograntPermissions': dontAutograntPermissions,
      'environmentVariables': pulumi.Input.encodeList<EnvironmentVariableResponse, Map<String, dynamic>>(environmentVariables, (value) => value.toMap()),
      'filesToPush': pulumi.Input.encodeList<DeviceFileResponse, Map<String, dynamic>>(filesToPush, (value) => value.toMap()),
      'initialSetupApks': pulumi.Input.encodeList<ApkResponse, Map<String, dynamic>>(initialSetupApks, (value) => value.toMap()),
      'networkProfile': networkProfile,
      'systrace': systrace.toMap(),
    };
  }

  factory TestSetupResponse.fromMap(Map<String, dynamic> map) {
    return TestSetupResponse(
      account: AccountResponse.fromMap((map['account'] as Map).cast<String, dynamic>()),
      additionalApks: pulumi.Input.decodeList<ApkResponse>(map['additionalApks'], (value) => ApkResponse.fromMap((value as Map).cast<String, dynamic>())),
      directoriesToPull: (map['directoriesToPull'] as List).cast<String>(),
      dontAutograntPermissions: map['dontAutograntPermissions'] as bool,
      environmentVariables: pulumi.Input.decodeList<EnvironmentVariableResponse>(map['environmentVariables'], (value) => EnvironmentVariableResponse.fromMap((value as Map).cast<String, dynamic>())),
      filesToPush: pulumi.Input.decodeList<DeviceFileResponse>(map['filesToPush'], (value) => DeviceFileResponse.fromMap((value as Map).cast<String, dynamic>())),
      initialSetupApks: pulumi.Input.decodeList<ApkResponse>(map['initialSetupApks'], (value) => ApkResponse.fromMap((value as Map).cast<String, dynamic>())),
      networkProfile: map['networkProfile'] as String,
      systrace: SystraceSetupResponse.fromMap((map['systrace'] as Map).cast<String, dynamic>()),
    );
  }
}
