...
class IosXcTestResponse {
  ...
  factory IosXcTestResponse.fromMap(Map<String, dynamic> map) {
    return IosXcTestResponse(
      ...
      testSpecialEntitlements: pulumi.Input.fromValue(map['testSpecialEntitlements'] as bool),
      testsZip: pulumi.Input.fromValue(FileReferenceResponse.fromMap((map['testsZip']! as Map).cast<String, dynamic>())),
      xcodeVersion: pulumi.Input.fromValue(map['xcodeVersion'] as String),
      xctestrun: pulumi.Input.fromValue(FileReferenceResponse.fromMap((map['xctestrun']! as Map).cast<String, dynamic>())),
    );
  }
}
