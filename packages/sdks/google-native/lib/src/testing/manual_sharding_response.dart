...
class ManualShardingResponse {
  ...
  factory ManualShardingResponse.fromMap(Map<String, dynamic> map) {
    return ManualShardingResponse(
      testTargetsForShard: (pulumi.Input.decodeList<TestTargetsForShardResponse>(map['testTargetsForShard'], (value) => TestTargetsForShardResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
