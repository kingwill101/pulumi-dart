...
class ApigatewayExprResponse {
  ...
  /// Creates a new [ApigatewayExprResponse].
  ...
  factory ApigatewayExprResponse.fromMap(Map<String, dynamic> map) {
    return ApigatewayExprResponse(
