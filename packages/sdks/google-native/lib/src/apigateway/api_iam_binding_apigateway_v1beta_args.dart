...
/// {@template pulumi_apigateway_v1beta_api_iam_binding_apigateway_v1beta_args_doc}
/// The set of arguments for ApiIamBinding.
/// {@endtemplate}
/// {@macro pulumi_apigateway_v1beta_api_iam_binding_apigateway_v1beta_args_doc}
class ApiIamBindingApigatewayV1betaArgs {
  ...
  /// Creates a new [ApiIamBindingApigatewayV1betaArgs].
  ...
  const ApiIamBindingApigatewayV1betaArgs({
    this.condition,
  ...
  factory ApiIamBindingApigatewayV1betaArgs.fromMap(Map<String, dynamic> map) {
    return ApiIamBindingApigatewayV1betaArgs(
