...
class Config extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<ApigatewayApiConfigGrpcServiceDefinitionResponse>> grpcServices;
  ...
  late final pulumi.Output<List<ApigatewayApiConfigFileResponse>> managedServiceConfigs;
  ...
  late final pulumi.Output<List<ApigatewayApiConfigOpenApiDocumentResponse>> openapiDocuments;
  ...
  Config(
    ...
    this.gatewayServiceAccount = registerOutput<String>('gatewayServiceAccount');
    this.grpcServices = registerOutput<List<ApigatewayApiConfigGrpcServiceDefinitionResponse>>('grpcServices');
    this.labels = registerOutput<Map<String, String>>('labels');
    this.location = registerOutput<String>('location');
    this.managedServiceConfigs = registerOutput<List<ApigatewayApiConfigFileResponse>>('managedServiceConfigs');
    this.name = registerOutput<String>('name');
    this.openapiDocuments = registerOutput<List<ApigatewayApiConfigOpenApiDocumentResponse>>('openapiDocuments');
