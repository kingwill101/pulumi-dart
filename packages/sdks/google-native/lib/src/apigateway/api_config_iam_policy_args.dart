    ...
    return ApiConfigIamPolicyArgs(
      ...
      auditConfigs: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ApigatewayAuditConfig>(
            guardedValue,
            (value) => ApigatewayAuditConfig.fromMap(
      ...
      bindings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ApigatewayBinding>(
            guardedValue,
            (value) => ApigatewayBinding.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
