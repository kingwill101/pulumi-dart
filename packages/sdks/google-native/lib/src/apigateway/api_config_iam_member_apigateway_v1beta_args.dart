...
/// {@template pulumi_apigateway_v1beta_api_config_iam_member_apigateway_v1beta_args_doc}
/// The set of arguments for ApiConfigIamMember.
/// {@endtemplate}
/// {@macro pulumi_apigateway_v1beta_api_config_iam_member_apigateway_v1beta_args_doc}
class ApiConfigIamMemberApigatewayV1betaArgs {
  ...
  /// Creates a new [ApiConfigIamMemberApigatewayV1betaArgs].
  ...
  const ApiConfigIamMemberApigatewayV1betaArgs({
    this.condition,
  ...
  factory ApiConfigIamMemberApigatewayV1betaArgs.fromMap(Map<String, dynamic> map) {
    return ApiConfigIamMemberApigatewayV1betaArgs(
