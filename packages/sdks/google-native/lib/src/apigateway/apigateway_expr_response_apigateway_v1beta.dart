...
class ApigatewayExprResponseApigatewayV1beta {
  ...
  /// Creates a new [ApigatewayExprResponseApigatewayV1beta].
  ...
  const ApigatewayExprResponseApigatewayV1beta({
  ...
  factory ApigatewayExprResponseApigatewayV1beta.fromMap(Map<String, dynamic> map) {
    return ApigatewayExprResponseApigatewayV1beta(
