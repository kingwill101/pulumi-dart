...
class ApigatewayExprApigatewayV1beta {
  ...
  /// Creates a new [ApigatewayExprApigatewayV1beta].
  ...
  const ApigatewayExprApigatewayV1beta({
    this.description,
    this.expression,
    this.location,
    this.title,
  ...
  factory ApigatewayExprApigatewayV1beta.fromMap(Map<String, dynamic> map) {
    return ApigatewayExprApigatewayV1beta(
