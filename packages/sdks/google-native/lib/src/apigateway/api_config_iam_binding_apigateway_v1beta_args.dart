...
/// {@template pulumi_apigateway_v1beta_api_config_iam_binding_apigateway_v1beta_args_doc}
/// The set of arguments for ApiConfigIamBinding.
/// {@endtemplate}
/// {@macro pulumi_apigateway_v1beta_api_config_iam_binding_apigateway_v1beta_args_doc}
class ApiConfigIamBindingApigatewayV1betaArgs {
  ...
  /// Creates a new [ApiConfigIamBindingApigatewayV1betaArgs].
  ...
  const ApiConfigIamBindingApigatewayV1betaArgs({
    this.condition,
  ...
  factory ApiConfigIamBindingApigatewayV1betaArgs.fromMap(Map<String, dynamic> map) {
    return ApiConfigIamBindingApigatewayV1betaArgs(
