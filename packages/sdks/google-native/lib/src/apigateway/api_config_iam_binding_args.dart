...
/// {@template pulumi_apigateway_v1_api_config_iam_binding_args_doc}
/// The set of arguments for ApiConfigIamBinding.
/// {@endtemplate}
/// {@macro pulumi_apigateway_v1_api_config_iam_binding_args_doc}
class ApiConfigIamBindingArgs {
  ...
  /// Creates a new [ApiConfigIamBindingArgs].
  ...
  factory ApiConfigIamBindingArgs.fromMap(Map<String, dynamic> map) {
