...
class ApigatewayAuditConfigApigatewayV1beta {
  ...
  final pulumi.Input<List<ApigatewayAuditLogConfigApigatewayV1beta>>?
  auditLogConfigs;
  ...
  ApigatewayAuditConfigApigatewayV1beta({this.auditLogConfigs, this.service});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'auditLogConfigs':
          ?pulumi.Input.mapOptionalInputValue<
            List<ApigatewayAuditLogConfigApigatewayV1beta>,
