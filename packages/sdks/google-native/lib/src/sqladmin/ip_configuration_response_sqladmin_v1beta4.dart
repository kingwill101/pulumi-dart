...
class IpConfigurationResponseSqladminV1beta4 {
  ...
  factory IpConfigurationResponseSqladminV1beta4.fromMap(Map<String, dynamic> map) {
    return IpConfigurationResponseSqladminV1beta4(
      ...
      authorizedNetworks: (pulumi.Input.decodeList<AclEntryResponseSqladminV1beta4>(map['authorizedNetworks'], (value) => AclEntryResponseSqladminV1beta4.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      pscConfig: (PscConfigResponseSqladminV1beta4.fromMap((map['pscConfig'] as Map).cast<String, dynamic>())).input(),
