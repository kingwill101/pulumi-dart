...
class SettingsSqladminV1beta4 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'availabilityType': ?availabilityType == null ? null : availabilityType!.value,
      'backupConfiguration': ?backupConfiguration == null ? null : backupConfiguration!.toMap(),
      'collation': ?collation,
      'connectorEnforcement': ?connectorEnforcement == null ? null : connectorEnforcement!.value,
      ...
      'databaseFlags': ?databaseFlags == null ? null : pulumi.Input.encodeList<DatabaseFlagsSqladminV1beta4, Map<String, dynamic>>(databaseFlags!, (value) => value.toMap()),
      'databaseReplicationEnabled': ?databaseReplicationEnabled,
      'deletionProtectionEnabled': ?deletionProtectionEnabled,
      'denyMaintenancePeriods': ?denyMaintenancePeriods == null ? null : pulumi.Input.encodeList<DenyMaintenancePeriodSqladminV1beta4, Map<String, dynamic>>(denyMaintenancePeriods!, (value) => value.toMap()),
      ...
      'replicationType': ?replicationType == null ? null : replicationType!.value,
  ...
  factory SettingsSqladminV1beta4.fromMap(Map<String, dynamic> map) {
    return SettingsSqladminV1beta4(
      activationPolicy: map['activationPolicy'] == null ? null : SettingsActivationPolicySqladminV1beta4.fromValue(map['activationPolicy'] as String),
      activeDirectoryConfig: map['activeDirectoryConfig'] == null ? null : SqlActiveDirectoryConfigSqladminV1beta4.fromMap((map['activeDirectoryConfig'] as Map).cast<String, dynamic>()),
      advancedMachineFeatures: map['advancedMachineFeatures'] == null ? null : AdvancedMachineFeaturesSqladminV1beta4.fromMap((map['advancedMachineFeatures'] as Map).cast<String, dynamic>()),
      authorizedGaeApplications: map['authorizedGaeApplications'] == null ? null : (map['authorizedGaeApplications'] as List).cast<String>(),
      availabilityType: map['availabilityType'] == null ? null : SettingsAvailabilityTypeSqladminV1beta4.fromValue(map['availabilityType'] as String),
      backupConfiguration: map['backupConfiguration'] == null ? null : BackupConfigurationSqladminV1beta4.fromMap((map['backupConfiguration'] as Map).cast<String, dynamic>()),
      collation: map['collation'] == null ? null : map['collation'] as String,
      connectorEnforcement: map['connectorEnforcement'] == null ? null : SettingsConnectorEnforcementSqladminV1beta4.fromValue(map['connectorEnforcement'] as String),
      crashSafeReplicationEnabled: map['crashSafeReplicationEnabled'] == null ? null : map['crashSafeReplicationEnabled'] as bool,
      dataCacheConfig: map['dataCacheConfig'] == null ? null : DataCacheConfigSqladminV1beta4.fromMap((map['dataCacheConfig'] as Map).cast<String, dynamic>()),
      dataDiskSizeGb: map['dataDiskSizeGb'] == null ? null : map['dataDiskSizeGb'] as String,
      dataDiskType: map['dataDiskType'] == null ? null : SettingsDataDiskTypeSqladminV1beta4.fromValue(map['dataDiskType'] as String),
      databaseFlags: map['databaseFlags'] == null ? null : pulumi.Input.decodeList<DatabaseFlagsSqladminV1beta4>(map['databaseFlags'], (value) => DatabaseFlagsSqladminV1beta4.fromMap((value as Map).cast<String, dynamic>())),
      databaseReplicationEnabled: map['databaseReplicationEnabled'] == null ? null : map['databaseReplicationEnabled'] as bool,
      deletionProtectionEnabled: map['deletionProtectionEnabled'] == null ? null : map['deletionProtectionEnabled'] as bool,
      denyMaintenancePeriods: map['denyMaintenancePeriods'] == null ? null : pulumi.Input.decodeList<DenyMaintenancePeriodSqladminV1beta4>(map['denyMaintenancePeriods'], (value) => DenyMaintenancePeriodSqladminV1beta4.fromMap((value as Map).cast<String, dynamic>())),
      edition: map['edition'] == null ? null : SettingsEditionSqladminV1beta4.fromValue(map['edition'] as String),
      insightsConfig: map['insightsConfig'] == null ? null : InsightsConfigSqladminV1beta4.fromMap((map['insightsConfig'] as Map).cast<String, dynamic>()),
      ipConfiguration: map['ipConfiguration'] == null ? null : IpConfigurationSqladminV1beta4.fromMap((map['ipConfiguration'] as Map).cast<String, dynamic>()),
      kind: map['kind'] == null ? null : map['kind'] as String,
      locationPreference: map['locationPreference'] == null ? null : LocationPreferenceSqladminV1beta4.fromMap((map['locationPreference'] as Map).cast<String, dynamic>()),
      maintenanceWindow: map['maintenanceWindow'] == null ? null : MaintenanceWindowSqladminV1beta4.fromMap((map['maintenanceWindow'] as Map).cast<String, dynamic>()),
      passwordValidationPolicy: map['passwordValidationPolicy'] == null ? null : PasswordValidationPolicySqladminV1beta4.fromMap((map['passwordValidationPolicy'] as Map).cast<String, dynamic>()),
      pricingPlan: map['pricingPlan'] == null ? null : SettingsPricingPlanSqladminV1beta4.fromValue(map['pricingPlan'] as String),
      replicationType: map['replicationType'] == null ? null : SettingsReplicationTypeSqladminV1beta4.fromValue(map['replicationType'] as String),
      settingsVersion: map['settingsVersion'] == null ? null : map['settingsVersion'] as String,
      sqlServerAuditConfig: map['sqlServerAuditConfig'] == null ? null : SqlServerAuditConfigSqladminV1beta4.fromMap((map['sqlServerAuditConfig'] as Map).cast<String, dynamic>()),
      storageAutoResize: map['storageAutoResize'] == null ? null : map['storageAutoResize'] as bool,
