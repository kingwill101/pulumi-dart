...
class SettingsSqladminV1beta4 {
  ...
  final pulumi.Input<SqlActiveDirectoryConfigSqladminV1beta4>?
  activeDirectoryConfig;

  /// Specifies advance machine configuration for the instance relevant only for SQL Server.
  final pulumi.Input<AdvancedMachineFeaturesSqladminV1beta4>?
  ...
  final pulumi.Input<SettingsConnectorEnforcementSqladminV1beta4>?
  ...
  final pulumi.Input<List<DenyMaintenancePeriodSqladminV1beta4>>?
  ...
  final pulumi.Input<PasswordValidationPolicySqladminV1beta4>?
    ...
    return <String, dynamic>{
      'activationPolicy':
          ?pulumi.Input.mapOptionalInputValue<
            SettingsActivationPolicySqladminV1beta4,
            String
          >(activationPolicy, (value) => value.wireValue),
      'activeDirectoryConfig':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'availabilityType':
          ?pulumi.Input.mapOptionalInputValue<
            SettingsAvailabilityTypeSqladminV1beta4,
            String
          >(availabilityType, (value) => value.wireValue),
      'backupConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'connectorEnforcement':
          ?pulumi.Input.mapOptionalInputValue<
            SettingsConnectorEnforcementSqladminV1beta4,
            String
      ...
      'dataDiskType':
          ?pulumi.Input.mapOptionalInputValue<
            SettingsDataDiskTypeSqladminV1beta4,
            String
          >(dataDiskType, (value) => value.wireValue),
      'databaseFlags':
          ?pulumi.Input.mapOptionalInputValue<
            List<DatabaseFlagsSqladminV1beta4>,
      ...
      'denyMaintenancePeriods':
          ?pulumi.Input.mapOptionalInputValue<
            List<DenyMaintenancePeriodSqladminV1beta4>,
            List<Map<String, dynamic>>
          >(
            denyMaintenancePeriods,
            (value) =>
      ...
      'edition':
          ?pulumi.Input.mapOptionalInputValue<
            SettingsEditionSqladminV1beta4,
            String
          >(edition, (value) => value.wireValue),
      'insightsConfig':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'locationPreference':
          ?pulumi.Input.mapOptionalInputValue<
            LocationPreferenceSqladminV1beta4,
            Map<String, dynamic>
      ...
      'pricingPlan':
          ?pulumi.Input.mapOptionalInputValue<
            SettingsPricingPlanSqladminV1beta4,
            String
          >(pricingPlan, (value) => value.wireValue),
      'replicationType':
          ?pulumi.Input.mapOptionalInputValue<
            SettingsReplicationTypeSqladminV1beta4,
            String
          >(replicationType, (value) => value.wireValue),
  ...
  factory SettingsSqladminV1beta4.fromMap(Map<String, dynamic> map) {
    return SettingsSqladminV1beta4(
      ...
      dataDiskType: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SettingsDataDiskTypeSqladminV1beta4.fromValue(guardedValue as String),
        );
      })(),
      databaseFlags: (() {
      ...
      edition: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SettingsEditionSqladminV1beta4.fromValue(guardedValue as String),
        );
      })(),
      insightsConfig: (() {
      ...
      pricingPlan: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SettingsPricingPlanSqladminV1beta4.fromValue(guardedValue as String),
        );
      })(),
      replicationType: (() {
