...
class ReplicaConfiguration {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'kind': ?kind,
      'mysqlReplicaConfiguration': ?pulumi.Input.mapOptionalInputValue<MySqlReplicaConfiguration, Map<String, dynamic>>(mysqlReplicaConfiguration, (value) => value.toMap()),
    };
  }
  ...
  factory ReplicaConfiguration.fromMap(Map<String, dynamic> map) {
    return ReplicaConfiguration(
      ...
      mysqlReplicaConfiguration: (() { final guardedValue = map['mysqlReplicaConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MySqlReplicaConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
