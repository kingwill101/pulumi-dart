...
class ReplicaConfiguration {
  ...
  factory ReplicaConfiguration.fromMap(Map<String, dynamic> map) {
    return ReplicaConfiguration(
      ...
      mysqlReplicaConfiguration: map['mysqlReplicaConfiguration'] == null ? null : MySqlReplicaConfiguration.fromMap((map['mysqlReplicaConfiguration'] as Map).cast<String, dynamic>()),
    );
  }
}
