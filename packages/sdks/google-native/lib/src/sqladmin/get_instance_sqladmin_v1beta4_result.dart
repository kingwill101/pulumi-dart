...
class GetInstanceSqladminV1beta4Result {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ipAddresses': pulumi.Input.encodeList<IpMappingResponseSqladminV1beta4, Map<String, dynamic>>(ipAddresses, (value) => value.toMap()),
  ...
  factory GetInstanceSqladminV1beta4Result.fromMap(Map<String, dynamic> map) {
    return GetInstanceSqladminV1beta4Result(
      ...
      failoverReplica: InstanceFailoverReplicaResponseSqladminV1beta4.fromMap((map['failoverReplica']! as Map).cast<String, dynamic>()),
      gceZone: map['gceZone'] as String,
      instanceType: map['instanceType'] as String,
      ipAddresses: pulumi.Input.decodeList<IpMappingResponseSqladminV1beta4>(map['ipAddresses']!, (value) => IpMappingResponseSqladminV1beta4.fromMap((value as Map).cast<String, dynamic>())),
      ...
      onPremisesConfiguration: OnPremisesConfigurationResponseSqladminV1beta4.fromMap((map['onPremisesConfiguration']! as Map).cast<String, dynamic>()),
      outOfDiskReport: SqlOutOfDiskReportResponseSqladminV1beta4.fromMap((map['outOfDiskReport']! as Map).cast<String, dynamic>()),
      primaryDnsName: map['primaryDnsName'] as String,
      project: map['project'] as String,
      pscServiceAttachmentLink: map['pscServiceAttachmentLink'] as String,
      region: map['region'] as String,
      replicaConfiguration: ReplicaConfigurationResponseSqladminV1beta4.fromMap((map['replicaConfiguration']! as Map).cast<String, dynamic>()),
      ...
      scheduledMaintenance: SqlScheduledMaintenanceResponseSqladminV1beta4.fromMap((map['scheduledMaintenance']! as Map).cast<String, dynamic>()),
      secondaryGceZone: map['secondaryGceZone'] as String,
      selfLink: map['selfLink'] as String,
      serverCaCert: SslCertResponseSqladminV1beta4.fromMap((map['serverCaCert']! as Map).cast<String, dynamic>()),
      serviceAccountEmailAddress: map['serviceAccountEmailAddress'] as String,
      settings: SettingsResponseSqladminV1beta4.fromMap((map['settings']! as Map).cast<String, dynamic>()),
