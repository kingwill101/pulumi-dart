...
class SettingsResponse {
  ...
  factory SettingsResponse.fromMap(Map<String, dynamic> map) {
    return SettingsResponse(
      ...
      activeDirectoryConfig: (SqlActiveDirectoryConfigResponse.fromMap((map['activeDirectoryConfig'] as Map).cast<String, dynamic>())).input(),
      ...
      backupConfiguration: (BackupConfigurationResponse.fromMap((map['backupConfiguration'] as Map).cast<String, dynamic>())).input(),
      ...
      databaseFlags: (pulumi.Input.decodeList<DatabaseFlagsResponse>(map['databaseFlags'], (value) => DatabaseFlagsResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      denyMaintenancePeriods: (pulumi.Input.decodeList<DenyMaintenancePeriodResponse>(map['denyMaintenancePeriods'], (value) => DenyMaintenancePeriodResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      edition: (map['edition'] as String).input(),
      insightsConfig: (InsightsConfigResponse.fromMap((map['insightsConfig'] as Map).cast<String, dynamic>())).input(),
      ipConfiguration: (IpConfigurationResponse.fromMap((map['ipConfiguration'] as Map).cast<String, dynamic>())).input(),
      kind: (map['kind'] as String).input(),
      locationPreference: (LocationPreferenceResponse.fromMap((map['locationPreference'] as Map).cast<String, dynamic>())).input(),
      maintenanceWindow: (MaintenanceWindowResponse.fromMap((map['maintenanceWindow'] as Map).cast<String, dynamic>())).input(),
      passwordValidationPolicy: (PasswordValidationPolicyResponse.fromMap((map['passwordValidationPolicy'] as Map).cast<String, dynamic>())).input(),
      ...
      sqlServerAuditConfig: (SqlServerAuditConfigResponse.fromMap((map['sqlServerAuditConfig'] as Map).cast<String, dynamic>())).input(),
