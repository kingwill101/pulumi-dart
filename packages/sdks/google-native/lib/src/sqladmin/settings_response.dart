...
class SettingsResponse {
  ...
  final pulumi.Input<List<DenyMaintenancePeriodResponse>>
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'denyMaintenancePeriods':
          pulumi.Input.mapInputValue<
            List<DenyMaintenancePeriodResponse>,
            List<Map<String, dynamic>>
          >(
            denyMaintenancePeriods,
            (value) =>
  ...
  factory SettingsResponse.fromMap(Map<String, dynamic> map) {
    return SettingsResponse(
      ...
      databaseFlags: pulumi.Input.fromValue(
        pulumi.Input.decodeList<DatabaseFlagsResponse>(
          map['databaseFlags']!,
      ...
      denyMaintenancePeriods: pulumi.Input.fromValue(
        pulumi.Input.decodeList<DenyMaintenancePeriodResponse>(
          map['denyMaintenancePeriods']!,
          (value) => DenyMaintenancePeriodResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      ...
      insightsConfig: pulumi.Input.fromValue(
        InsightsConfigResponse.fromMap(
      ...
      locationPreference: pulumi.Input.fromValue(
        LocationPreferenceResponse.fromMap(
      ...
      passwordValidationPolicy: pulumi.Input.fromValue(
        PasswordValidationPolicyResponse.fromMap(
      ...
      sqlServerAuditConfig: pulumi.Input.fromValue(
        SqlServerAuditConfigResponse.fromMap(
