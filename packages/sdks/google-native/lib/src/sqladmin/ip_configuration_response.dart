...
class IpConfigurationResponse {
  ...
  factory IpConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return IpConfigurationResponse(
      ...
      authorizedNetworks: pulumi.Input.fromValue(pulumi.Input.decodeList<AclEntryResponse>(map['authorizedNetworks']!, (value) => AclEntryResponse.fromMap((value as Map).cast<String, dynamic>()))),
