...
class IpConfiguration {
  ...
  final pulumi.Input<List<AclEntry>>? authorizedNetworks;
  ...
  final pulumi.Input<IpConfigurationSslMode>? sslMode;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'authorizedNetworks': ?pulumi.Input.mapOptionalInputValue<List<AclEntry>, List<Map<String, dynamic>>>(authorizedNetworks, (value) => pulumi.Input.encodeList<AclEntry, Map<String, dynamic>>(value, (value) => value.toMap())),
      ...
      'sslMode': ?pulumi.Input.mapOptionalInputValue<IpConfigurationSslMode, String>(sslMode, (value) => value.wireValue),
    };
  }
  ...
  factory IpConfiguration.fromMap(Map<String, dynamic> map) {
    return IpConfiguration(
      ...
      authorizedNetworks: (() { final guardedValue = map['authorizedNetworks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AclEntry>(guardedValue, (value) => AclEntry.fromMap((value as Map).cast<String, dynamic>()))); })(),
      enablePrivatePathForGoogleCloudServices: (() { final guardedValue = map['enablePrivatePathForGoogleCloudServices']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      sslMode: (() { final guardedValue = map['sslMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(IpConfigurationSslMode.fromValue(guardedValue as String)); })(),
    );
  }
}
