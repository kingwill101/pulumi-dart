...
class UserArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'dualPasswordType': ?pulumi.Input.mapOptionalInputValue<UserDualPasswordType, String>(dualPasswordType, (value) => value.wireValue),
      'etag': ?etag,
      'host': ?host,
      'instance': instance,
      'kind': ?kind,
      ...
      'type': ?pulumi.Input.mapOptionalInputValue<UserType, String>(type, (value) => value.wireValue),
    };
  }

  factory UserArgs.fromMap(Map<String, dynamic> map) {
    return UserArgs(
      dualPasswordType: (() { final guardedValue = map['dualPasswordType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(UserDualPasswordType.fromValue(guardedValue as String)); })(),
      ...
      passwordPolicy: (() { final guardedValue = map['passwordPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(UserPasswordValidationPolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      project: (() { final guardedValue = map['project']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      sqlserverUserDetails: (() { final guardedValue = map['sqlserverUserDetails']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SqlServerUserDetails.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(UserType.fromValue(guardedValue as String)); })(),
    );
  }
}
