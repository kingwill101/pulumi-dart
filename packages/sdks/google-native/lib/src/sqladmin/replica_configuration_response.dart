...
class ReplicaConfigurationResponse {
  ...
  const ReplicaConfigurationResponse({
  ...
  factory ReplicaConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return ReplicaConfigurationResponse(
      ...
      mysqlReplicaConfiguration: pulumi.Input.fromValue(MySqlReplicaConfigurationResponse.fromMap((map['mysqlReplicaConfiguration']! as Map).cast<String, dynamic>())),
    );
  }
}
