...
class IpMappingSqladminV1beta4 {
  ...
  const IpMappingSqladminV1beta4({
    this.ipAddress,
    this.timeToRetire,
    this.type,
  });
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'type': ?pulumi.Input.mapOptionalInputValue<IpMappingTypeSqladminV1beta4, String>(type, (value) => value.wireValue),
    };
  }
  ...
  factory IpMappingSqladminV1beta4.fromMap(Map<String, dynamic> map) {
    return IpMappingSqladminV1beta4(
      ...
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(IpMappingTypeSqladminV1beta4.fromValue(guardedValue as String)); })(),
    );
  }
}
