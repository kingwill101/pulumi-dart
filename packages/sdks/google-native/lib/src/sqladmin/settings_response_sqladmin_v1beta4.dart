...
class SettingsResponseSqladminV1beta4 {
  ...
  factory SettingsResponseSqladminV1beta4.fromMap(Map<String, dynamic> map) {
    return SettingsResponseSqladminV1beta4(
      ...
      activeDirectoryConfig: (SqlActiveDirectoryConfigResponseSqladminV1beta4.fromMap((map['activeDirectoryConfig'] as Map).cast<String, dynamic>())).input(),
      advancedMachineFeatures: (AdvancedMachineFeaturesResponseSqladminV1beta4.fromMap((map['advancedMachineFeatures'] as Map).cast<String, dynamic>())).input(),
      authorizedGaeApplications: ((map['authorizedGaeApplications'] as List).cast<String>()).input(),
      availabilityType: (map['availabilityType'] as String).input(),
      backupConfiguration: (BackupConfigurationResponseSqladminV1beta4.fromMap((map['backupConfiguration'] as Map).cast<String, dynamic>())).input(),
      collation: (map['collation'] as String).input(),
      connectorEnforcement: (map['connectorEnforcement'] as String).input(),
      crashSafeReplicationEnabled: (map['crashSafeReplicationEnabled'] as bool).input(),
      dataCacheConfig: (DataCacheConfigResponseSqladminV1beta4.fromMap((map['dataCacheConfig'] as Map).cast<String, dynamic>())).input(),
      dataDiskSizeGb: (map['dataDiskSizeGb'] as String).input(),
      dataDiskType: (map['dataDiskType'] as String).input(),
      databaseFlags: (pulumi.Input.decodeList<DatabaseFlagsResponseSqladminV1beta4>(map['databaseFlags'], (value) => DatabaseFlagsResponseSqladminV1beta4.fromMap((value as Map).cast<String, dynamic>()))).input(),
      databaseReplicationEnabled: (map['databaseReplicationEnabled'] as bool).input(),
      deletionProtectionEnabled: (map['deletionProtectionEnabled'] as bool).input(),
      denyMaintenancePeriods: (pulumi.Input.decodeList<DenyMaintenancePeriodResponseSqladminV1beta4>(map['denyMaintenancePeriods'], (value) => DenyMaintenancePeriodResponseSqladminV1beta4.fromMap((value as Map).cast<String, dynamic>()))).input(),
      edition: (map['edition'] as String).input(),
      insightsConfig: (InsightsConfigResponseSqladminV1beta4.fromMap((map['insightsConfig'] as Map).cast<String, dynamic>())).input(),
      ipConfiguration: (IpConfigurationResponseSqladminV1beta4.fromMap((map['ipConfiguration'] as Map).cast<String, dynamic>())).input(),
      kind: (map['kind'] as String).input(),
      locationPreference: (LocationPreferenceResponseSqladminV1beta4.fromMap((map['locationPreference'] as Map).cast<String, dynamic>())).input(),
      maintenanceWindow: (MaintenanceWindowResponseSqladminV1beta4.fromMap((map['maintenanceWindow'] as Map).cast<String, dynamic>())).input(),
      passwordValidationPolicy: (PasswordValidationPolicyResponseSqladminV1beta4.fromMap((map['passwordValidationPolicy'] as Map).cast<String, dynamic>())).input(),
      pricingPlan: (map['pricingPlan'] as String).input(),
      replicationType: (map['replicationType'] as String).input(),
      settingsVersion: (map['settingsVersion'] as String).input(),
      sqlServerAuditConfig: (SqlServerAuditConfigResponseSqladminV1beta4.fromMap((map['sqlServerAuditConfig'] as Map).cast<String, dynamic>())).input(),
      storageAutoResize: (map['storageAutoResize'] as bool).input(),
