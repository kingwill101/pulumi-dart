...
class SettingsResponseSqladminV1beta4 {
  ...
  final pulumi.Input<SqlActiveDirectoryConfigResponseSqladminV1beta4>
  activeDirectoryConfig;

  /// Specifies advance machine configuration for the instance relevant only for SQL Server.
  final pulumi.Input<AdvancedMachineFeaturesResponseSqladminV1beta4>
  ...
  final pulumi.Input<BackupConfigurationResponseSqladminV1beta4>
  backupConfiguration;
  ...
  final pulumi.Input<List<DenyMaintenancePeriodResponseSqladminV1beta4>>
  ...
  final pulumi.Input<LocationPreferenceResponseSqladminV1beta4>
  locationPreference;

  /// The maintenance window for this instance. This specifies when the instance can be restarted for maintenance purposes.
  final pulumi.Input<MaintenanceWindowResponseSqladminV1beta4>
  maintenanceWindow;

  /// The local user password validation policy of the instance.
  final pulumi.Input<PasswordValidationPolicyResponseSqladminV1beta4>
  ...
  final pulumi.Input<SqlServerAuditConfigResponseSqladminV1beta4>
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'databaseFlags':
          pulumi.Input.mapInputValue<
            List<DatabaseFlagsResponseSqladminV1beta4>,
      ...
      'denyMaintenancePeriods':
          pulumi.Input.mapInputValue<
            List<DenyMaintenancePeriodResponseSqladminV1beta4>,
            List<Map<String, dynamic>>
          >(
            denyMaintenancePeriods,
            (value) =>
  ...
  factory SettingsResponseSqladminV1beta4.fromMap(Map<String, dynamic> map) {
    return SettingsResponseSqladminV1beta4(
      ...
      activeDirectoryConfig: pulumi.Input.fromValue(
      ...
      authorizedGaeApplications: pulumi.Input.fromValue(
        (map['authorizedGaeApplications'] as List).cast<String>(),
      ),
      availabilityType: pulumi.Input.fromValue(
        map['availabilityType'] as String,
      ),
      backupConfiguration: pulumi.Input.fromValue(
        BackupConfigurationResponseSqladminV1beta4.fromMap(
      ...
      crashSafeReplicationEnabled: pulumi.Input.fromValue(
        map['crashSafeReplicationEnabled'] as bool,
      ),
      dataCacheConfig: pulumi.Input.fromValue(
        DataCacheConfigResponseSqladminV1beta4.fromMap(
      ...
      databaseReplicationEnabled: pulumi.Input.fromValue(
      ...
      insightsConfig: pulumi.Input.fromValue(
        InsightsConfigResponseSqladminV1beta4.fromMap(
          (map['insightsConfig']! as Map).cast<String, dynamic>(),
        ),
      ),
      ipConfiguration: pulumi.Input.fromValue(
        IpConfigurationResponseSqladminV1beta4.fromMap(
          (map['ipConfiguration']! as Map).cast<String, dynamic>(),
        ),
      ),
      kind: pulumi.Input.fromValue(map['kind'] as String),
      locationPreference: pulumi.Input.fromValue(
        LocationPreferenceResponseSqladminV1beta4.fromMap(
          (map['locationPreference']! as Map).cast<String, dynamic>(),
        ),
      ),
      maintenanceWindow: pulumi.Input.fromValue(
        MaintenanceWindowResponseSqladminV1beta4.fromMap(
          (map['maintenanceWindow']! as Map).cast<String, dynamic>(),
        ),
      ),
      passwordValidationPolicy: pulumi.Input.fromValue(
      ...
      sqlServerAuditConfig: pulumi.Input.fromValue(
        SqlServerAuditConfigResponseSqladminV1beta4.fromMap(
          (map['sqlServerAuditConfig']! as Map).cast<String, dynamic>(),
        ),
      ),
      storageAutoResize: pulumi.Input.fromValue(
