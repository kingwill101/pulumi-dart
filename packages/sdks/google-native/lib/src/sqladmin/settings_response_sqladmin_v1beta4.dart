...
class SettingsResponseSqladminV1beta4 {
  ...
  final List<DenyMaintenancePeriodResponseSqladminV1beta4> denyMaintenancePeriods;
  ...
  final PasswordValidationPolicyResponseSqladminV1beta4 passwordValidationPolicy;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'databaseFlags': pulumi.Input.encodeList<DatabaseFlagsResponseSqladminV1beta4, Map<String, dynamic>>(databaseFlags, (value) => value.toMap()),
      'databaseReplicationEnabled': databaseReplicationEnabled,
      'deletionProtectionEnabled': deletionProtectionEnabled,
      'denyMaintenancePeriods': pulumi.Input.encodeList<DenyMaintenancePeriodResponseSqladminV1beta4, Map<String, dynamic>>(denyMaintenancePeriods, (value) => value.toMap()),
      'edition': edition,
  ...
  factory SettingsResponseSqladminV1beta4.fromMap(Map<String, dynamic> map) {
    return SettingsResponseSqladminV1beta4(
      ...
      activeDirectoryConfig: SqlActiveDirectoryConfigResponseSqladminV1beta4.fromMap((map['activeDirectoryConfig'] as Map).cast<String, dynamic>()),
      advancedMachineFeatures: AdvancedMachineFeaturesResponseSqladminV1beta4.fromMap((map['advancedMachineFeatures'] as Map).cast<String, dynamic>()),
      ...
      backupConfiguration: BackupConfigurationResponseSqladminV1beta4.fromMap((map['backupConfiguration'] as Map).cast<String, dynamic>()),
      ...
      dataCacheConfig: DataCacheConfigResponseSqladminV1beta4.fromMap((map['dataCacheConfig'] as Map).cast<String, dynamic>()),
      dataDiskSizeGb: map['dataDiskSizeGb'] as String,
      dataDiskType: map['dataDiskType'] as String,
      databaseFlags: pulumi.Input.decodeList<DatabaseFlagsResponseSqladminV1beta4>(map['databaseFlags'], (value) => DatabaseFlagsResponseSqladminV1beta4.fromMap((value as Map).cast<String, dynamic>())),
      ...
      denyMaintenancePeriods: pulumi.Input.decodeList<DenyMaintenancePeriodResponseSqladminV1beta4>(map['denyMaintenancePeriods'], (value) => DenyMaintenancePeriodResponseSqladminV1beta4.fromMap((value as Map).cast<String, dynamic>())),
      edition: map['edition'] as String,
      insightsConfig: InsightsConfigResponseSqladminV1beta4.fromMap((map['insightsConfig'] as Map).cast<String, dynamic>()),
      ipConfiguration: IpConfigurationResponseSqladminV1beta4.fromMap((map['ipConfiguration'] as Map).cast<String, dynamic>()),
      kind: map['kind'] as String,
      locationPreference: LocationPreferenceResponseSqladminV1beta4.fromMap((map['locationPreference'] as Map).cast<String, dynamic>()),
      maintenanceWindow: MaintenanceWindowResponseSqladminV1beta4.fromMap((map['maintenanceWindow'] as Map).cast<String, dynamic>()),
      passwordValidationPolicy: PasswordValidationPolicyResponseSqladminV1beta4.fromMap((map['passwordValidationPolicy'] as Map).cast<String, dynamic>()),
      ...
      sqlServerAuditConfig: SqlServerAuditConfigResponseSqladminV1beta4.fromMap((map['sqlServerAuditConfig'] as Map).cast<String, dynamic>()),
