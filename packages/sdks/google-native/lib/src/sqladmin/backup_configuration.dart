...
class BackupConfiguration {
  ...
  factory BackupConfiguration.fromMap(Map<String, dynamic> map) {
    return BackupConfiguration(
      backupRetentionSettings: (() { final guardedValue = map['backupRetentionSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BackupRetentionSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
