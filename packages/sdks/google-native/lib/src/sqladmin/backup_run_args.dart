...
class BackupRunArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'startTime': ?startTime,
      'timeZone': ?timeZone,
      'type': ?pulumi.Input.mapOptionalInputValue<BackupRunType, String>(
        type,
        (value) => value.wireValue,
      ),
    ...
    return BackupRunArgs(
      backupKind: (() {
        ...
        return pulumi.Input.fromValue(
          BackupRunBackupKind.fromValue(guardedValue as String),
        );
      })(),
      description: (() {
      ...
      error: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          OperationError.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      id: (() {
      ...
      type: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          BackupRunType.fromValue(guardedValue as String),
        );
      })(),
      windowStartTime: (() {
