...
class IpMapping {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'type': ?pulumi.Input.mapOptionalInputValue<IpMappingType, String>(type, (value) => value.wireValue),
    };
  }
  ...
  factory IpMapping.fromMap(Map<String, dynamic> map) {
    return IpMapping(
      ...
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(IpMappingType.fromValue(guardedValue as String)); })(),
    );
  }
}
