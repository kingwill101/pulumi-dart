...
class GetBackupRunSqladminV1beta4Result {
  ...
  final DiskEncryptionConfigurationResponseSqladminV1beta4 diskEncryptionConfiguration;
  ...
  const GetBackupRunSqladminV1beta4Result({
  ...
  factory GetBackupRunSqladminV1beta4Result.fromMap(Map<String, dynamic> map) {
    return GetBackupRunSqladminV1beta4Result(
      ...
      diskEncryptionConfiguration: DiskEncryptionConfigurationResponseSqladminV1beta4.fromMap((map['diskEncryptionConfiguration']! as Map).cast<String, dynamic>()),
      diskEncryptionStatus: DiskEncryptionStatusResponseSqladminV1beta4.fromMap((map['diskEncryptionStatus']! as Map).cast<String, dynamic>()),
      endTime: map['endTime'] as String,
      enqueuedTime: map['enqueuedTime'] as String,
      error: OperationErrorResponseSqladminV1beta4.fromMap((map['error']! as Map).cast<String, dynamic>()),
