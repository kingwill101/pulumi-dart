...
class DatabaseSqladminV1beta4Args {
  ...
  DatabaseSqladminV1beta4Args({
    ...
    pulumi.Output<SqlServerDatabaseDetailsSqladminV1beta4>? sqlserverDatabaseDetails,
  }) :
  ...
  factory DatabaseSqladminV1beta4Args.fromMap(Map<String, dynamic> map) {
    return DatabaseSqladminV1beta4Args(
      ...
      sqlserverDatabaseDetails: map['sqlserverDatabaseDetails'] == null ? null : pulumi.Output.create<SqlServerDatabaseDetailsSqladminV1beta4>(SqlServerDatabaseDetailsSqladminV1beta4.fromMap((map['sqlserverDatabaseDetails'] as Map).cast<String, dynamic>())),
    );
  }
}
