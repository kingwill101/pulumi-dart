...
class OnPremisesConfiguration {
  ...
  factory OnPremisesConfiguration.fromMap(Map<String, dynamic> map) {
    return OnPremisesConfiguration(
      ...
      sourceInstance: (() { final guardedValue = map['sourceInstance']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceReference.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
