...
class ReplicaConfigurationSqladminV1beta4 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'kind': ?kind,
      'mysqlReplicaConfiguration': ?mysqlReplicaConfiguration == null ? null : mysqlReplicaConfiguration!.toMap(),
    };
  }
  ...
  factory ReplicaConfigurationSqladminV1beta4.fromMap(Map<String, dynamic> map) {
    return ReplicaConfigurationSqladminV1beta4(
      ...
      mysqlReplicaConfiguration: map['mysqlReplicaConfiguration'] == null ? null : MySqlReplicaConfigurationSqladminV1beta4.fromMap((map['mysqlReplicaConfiguration'] as Map).cast<String, dynamic>()),
    );
  }
}
