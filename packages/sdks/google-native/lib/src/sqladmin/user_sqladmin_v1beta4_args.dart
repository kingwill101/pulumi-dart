    ...
    return <String, dynamic>{
      'dualPasswordType':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(dualPasswordType, (value) => value.wireValue),
      'etag': ?etag,
      'host': ?host,
      'instance': instance,
      'kind': ?kind,
    ...
    return UserSqladminV1beta4Args(
      dualPasswordType: (() {
        ...
        return pulumi.Input.fromValue(
          UserDualPasswordTypeSqladminV1beta4.fromValue(guardedValue as String),
        );
      })(),
      etag: (() {
      ...
      type: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          UserTypeSqladminV1beta4.fromValue(guardedValue as String),
        );
      })(),
    );
  }
