...
class BackupRunSqladminV1beta4Args {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'backupKind': ?pulumi.Input.mapOptionalInputValue<BackupRunBackupKindSqladminV1beta4, String>(backupKind, (value) => value.wireValue),
      ...
      'startTime': ?startTime,
      'timeZone': ?timeZone,
      'type': ?pulumi.Input.mapOptionalInputValue<BackupRunTypeSqladminV1beta4, String>(type, (value) => value.wireValue),
  ...
  factory BackupRunSqladminV1beta4Args.fromMap(Map<String, dynamic> map) {
    return BackupRunSqladminV1beta4Args(
      backupKind: (() { final guardedValue = map['backupKind']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BackupRunBackupKindSqladminV1beta4.fromValue(guardedValue as String)); })(),
      ...
      error: (() { final guardedValue = map['error']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OperationErrorSqladminV1beta4.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BackupRunTypeSqladminV1beta4.fromValue(guardedValue as String)); })(),
