...
class BackupRunSqladminV1beta4Args {
  ...
  BackupRunSqladminV1beta4Args({
    pulumi.Output<BackupRunBackupKindSqladminV1beta4>? backupKind,
    pulumi.Output<String>? description,
    pulumi.Output<DiskEncryptionConfigurationSqladminV1beta4>? diskEncryptionConfiguration,
    pulumi.Output<DiskEncryptionStatusSqladminV1beta4>? diskEncryptionStatus,
    pulumi.Output<String>? endTime,
    pulumi.Output<String>? enqueuedTime,
    pulumi.Output<OperationErrorSqladminV1beta4>? error,
    ...
    pulumi.Output<BackupRunTypeSqladminV1beta4>? type,
    pulumi.Output<String>? windowStartTime,
  }) :
  ...
  factory BackupRunSqladminV1beta4Args.fromMap(Map<String, dynamic> map) {
    return BackupRunSqladminV1beta4Args(
      backupKind: map['backupKind'] == null ? null : pulumi.Output.create<BackupRunBackupKindSqladminV1beta4>(BackupRunBackupKindSqladminV1beta4.fromValue(map['backupKind'] as String)),
      description: map['description'] == null ? null : pulumi.Output.create<String>(map['description'] as String),
      diskEncryptionConfiguration: map['diskEncryptionConfiguration'] == null ? null : pulumi.Output.create<DiskEncryptionConfigurationSqladminV1beta4>(DiskEncryptionConfigurationSqladminV1beta4.fromMap((map['diskEncryptionConfiguration'] as Map).cast<String, dynamic>())),
      diskEncryptionStatus: map['diskEncryptionStatus'] == null ? null : pulumi.Output.create<DiskEncryptionStatusSqladminV1beta4>(DiskEncryptionStatusSqladminV1beta4.fromMap((map['diskEncryptionStatus'] as Map).cast<String, dynamic>())),
      endTime: map['endTime'] == null ? null : pulumi.Output.create<String>(map['endTime'] as String),
      enqueuedTime: map['enqueuedTime'] == null ? null : pulumi.Output.create<String>(map['enqueuedTime'] as String),
      error: map['error'] == null ? null : pulumi.Output.create<OperationErrorSqladminV1beta4>(OperationErrorSqladminV1beta4.fromMap((map['error'] as Map).cast<String, dynamic>())),
      ...
      type: map['type'] == null ? null : pulumi.Output.create<BackupRunTypeSqladminV1beta4>(BackupRunTypeSqladminV1beta4.fromValue(map['type'] as String)),
      windowStartTime: map['windowStartTime'] == null ? null : pulumi.Output.create<String>(map['windowStartTime'] as String),
    );
  }
}
