    ...
    return InstanceArgs(
      backendType: (() {
        ...
        return pulumi.Input.fromValue(
          InstanceBackendType.fromValue(guardedValue as String),
        );
      })(),
      connectionName: (() {
      ...
      databaseVersion: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          InstanceDatabaseVersion.fromValue(guardedValue as String),
        );
      })(),
      diskEncryptionConfiguration: (() {
      ...
      serverCaCert: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as SslCertSqladminV1);
      })(),
      ...
      sqlNetworkArchitecture: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          InstanceSqlNetworkArchitecture.fromValue(guardedValue as String),
        );
      })(),
      state: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          InstanceState.fromValue(guardedValue as String),
        );
      })(),
      suspensionReason: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InstanceSuspensionReasonItem>(
            guardedValue,
            (value) => InstanceSuspensionReasonItem.fromValue(value as String),
          ),
        );
      })(),
    );
