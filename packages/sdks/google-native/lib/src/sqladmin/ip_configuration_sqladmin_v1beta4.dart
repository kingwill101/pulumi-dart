...
class IpConfigurationSqladminV1beta4 {
  ...
  final List<AclEntrySqladminV1beta4>? authorizedNetworks;
  ...
  final PscConfigSqladminV1beta4? pscConfig;
  ...
  final IpConfigurationSslModeSqladminV1beta4? sslMode;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'authorizedNetworks': ?authorizedNetworks == null ? null : pulumi.Input.encodeList<AclEntrySqladminV1beta4, Map<String, dynamic>>(authorizedNetworks!, (value) => value.toMap()),
  ...
  factory IpConfigurationSqladminV1beta4.fromMap(Map<String, dynamic> map) {
    return IpConfigurationSqladminV1beta4(
      ...
      authorizedNetworks: map['authorizedNetworks'] == null ? null : pulumi.Input.decodeList<AclEntrySqladminV1beta4>(map['authorizedNetworks'], (value) => AclEntrySqladminV1beta4.fromMap((value as Map).cast<String, dynamic>())),
      ...
      pscConfig: map['pscConfig'] == null ? null : PscConfigSqladminV1beta4.fromMap((map['pscConfig'] as Map).cast<String, dynamic>()),
      requireSsl: map['requireSsl'] == null ? null : map['requireSsl'] as bool,
      sslMode: map['sslMode'] == null ? null : IpConfigurationSslModeSqladminV1beta4.fromValue(map['sslMode'] as String),
    );
  }
}
