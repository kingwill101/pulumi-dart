...
class IpConfigurationSqladminV1beta4 {
  ...
  const IpConfigurationSqladminV1beta4({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'authorizedNetworks': ?pulumi.Input.mapOptionalInputValue<List<AclEntrySqladminV1beta4>, List<Map<String, dynamic>>>(authorizedNetworks, (value) => pulumi.Input.encodeList<AclEntrySqladminV1beta4, Map<String, dynamic>>(value, (value) => value.toMap())),
      'enablePrivatePathForGoogleCloudServices': ?enablePrivatePathForGoogleCloudServices,
      'ipv4Enabled': ?ipv4Enabled,
      'privateNetwork': ?privateNetwork,
      'pscConfig': ?pulumi.Input.mapOptionalInputValue<PscConfigSqladminV1beta4, Map<String, dynamic>>(pscConfig, (value) => value.toMap()),
      'requireSsl': ?requireSsl,
      'sslMode': ?pulumi.Input.mapOptionalInputValue<IpConfigurationSslModeSqladminV1beta4, String>(sslMode, (value) => value.wireValue),
    };
  }
  ...
  factory IpConfigurationSqladminV1beta4.fromMap(Map<String, dynamic> map) {
    return IpConfigurationSqladminV1beta4(
      ...
      authorizedNetworks: (() { final guardedValue = map['authorizedNetworks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AclEntrySqladminV1beta4>(guardedValue, (value) => AclEntrySqladminV1beta4.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      pscConfig: (() { final guardedValue = map['pscConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PscConfigSqladminV1beta4.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      sslMode: (() { final guardedValue = map['sslMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(IpConfigurationSslModeSqladminV1beta4.fromValue(guardedValue as String)); })(),
    );
  }
}
