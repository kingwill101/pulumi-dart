...
class GoogleCloudRecommendationengineV1beta1FeatureMapResponse {
  ...
  /// Creates a new [GoogleCloudRecommendationengineV1beta1FeatureMapResponse].
  ...
  const GoogleCloudRecommendationengineV1beta1FeatureMapResponse({
  ...
  factory GoogleCloudRecommendationengineV1beta1FeatureMapResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRecommendationengineV1beta1FeatureMapResponse(
      categoricalFeatures: pulumi.Input.fromValue((map['categoricalFeatures'] as Map).cast<String, String>()),
      numericalFeatures: pulumi.Input.fromValue((map['numericalFeatures'] as Map).cast<String, String>()),
    );
  }
}
