...
class CatalogItem extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<GoogleCloudRecommendationengineV1beta1CatalogItemCategoryHierarchyResponse>> categoryHierarchies;
  ...
  CatalogItem(
    ...
    this.categoryHierarchies = registerOutput<List<GoogleCloudRecommendationengineV1beta1CatalogItemCategoryHierarchyResponse>>('categoryHierarchies');
    this.description = registerOutput<String>('description');
    this.itemAttributes = registerOutput<GoogleCloudRecommendationengineV1beta1FeatureMapResponse>('itemAttributes');
    this.itemGroupId = registerOutput<String>('itemGroupId');
    this.languageCode = registerOutput<String>('languageCode');
    this.location = registerOutput<String>('location');
    this.productMetadata = registerOutput<GoogleCloudRecommendationengineV1beta1ProductCatalogItemResponse>('productMetadata');
