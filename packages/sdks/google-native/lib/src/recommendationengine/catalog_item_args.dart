...
class CatalogItemArgs {
    ...
    return <String, dynamic>{
      ...
      'itemAttributes':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(itemAttributes, (value) => value.toMap()),
      ...
      'productMetadata':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(productMetadata, (value) => value.toMap()),
      'project': ?project,
      'tags': ?tags,
      'title': title,
    };
  ...
  factory CatalogItemArgs.fromMap(Map<String, dynamic> map) {
    return CatalogItemArgs(
      ...
      categoryHierarchies: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GoogleCloudRecommendationengineV1beta1CatalogItemCategoryHierarchy
        >(
          map['categoryHierarchies']!,
          (value) =>
              GoogleCloudRecommendationengineV1beta1CatalogItemCategoryHierarchy.fromMap(
      ...
      itemAttributes: (() {
        final guardedValue = map['itemAttributes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GoogleCloudRecommendationengineV1beta1FeatureMap.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      itemGroupId: (() {
        final guardedValue = map['itemGroupId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      languageCode: (() {
      ...
      productMetadata: (() {
        final guardedValue = map['productMetadata'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GoogleCloudRecommendationengineV1beta1ProductCatalogItem.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
