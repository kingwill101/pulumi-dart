...
class GoogleCloudRecommendationengineV1beta1ProductCatalogItem {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'images':
          ?pulumi.Input.mapOptionalInputValue<
            List<GoogleCloudRecommendationengineV1beta1Image>,
      ...
      'stockState':
          ?pulumi.Input.mapOptionalInputValue<
            GoogleCloudRecommendationengineV1beta1ProductCatalogItemStockState,
            String
          >(stockState, (value) => value.wireValue),
    };
  }
  ...
  factory GoogleCloudRecommendationengineV1beta1ProductCatalogItem.fromMap(
    ...
    return GoogleCloudRecommendationengineV1beta1ProductCatalogItem(
      ...
      canonicalProductUri: (() {
        final guardedValue = map['canonicalProductUri'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      costs: (() {
      ...
      exactPrice: (() {
        final guardedValue = map['exactPrice'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      images: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GoogleCloudRecommendationengineV1beta1Image>(
            guardedValue,
      ...
      priceRange: (() {
        final guardedValue = map['priceRange'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      stockState: (() {
        final guardedValue = map['stockState'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
