...
/// {@template pulumi_managedidentities_v1_domain_iam_policy_args_doc}
/// The set of arguments for DomainIamPolicy.
/// {@endtemplate}
/// {@macro pulumi_managedidentities_v1_domain_iam_policy_args_doc}
class DomainIamPolicyArgs {
  ...
  /// Creates a new [DomainIamPolicyArgs].
  ...
  factory DomainIamPolicyArgs.fromMap(Map<String, dynamic> map) {
    return DomainIamPolicyArgs(
