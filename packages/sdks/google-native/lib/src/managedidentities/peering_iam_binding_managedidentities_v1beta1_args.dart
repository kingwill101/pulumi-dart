...
/// {@template pulumi_managedidentities_v1beta1_peering_iam_binding_managedidentities_v1beta1_args_doc}
/// The set of arguments for PeeringIamBinding.
/// {@endtemplate}
/// {@macro pulumi_managedidentities_v1beta1_peering_iam_binding_managedidentities_v1beta1_args_doc}
class PeeringIamBindingManagedidentitiesV1beta1Args {
  ...
  /// Creates a new [PeeringIamBindingManagedidentitiesV1beta1Args].
  ...
  const PeeringIamBindingManagedidentitiesV1beta1Args({
    this.condition,
  ...
  factory PeeringIamBindingManagedidentitiesV1beta1Args.fromMap(Map<String, dynamic> map) {
    return PeeringIamBindingManagedidentitiesV1beta1Args(
