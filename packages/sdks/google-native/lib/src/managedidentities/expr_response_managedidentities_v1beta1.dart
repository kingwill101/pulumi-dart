...
class ExprResponseManagedidentitiesV1beta1 {
  ...
  /// Creates a new [ExprResponseManagedidentitiesV1beta1].
  ...
  const ExprResponseManagedidentitiesV1beta1({
  ...
  factory ExprResponseManagedidentitiesV1beta1.fromMap(Map<String, dynamic> map) {
    return ExprResponseManagedidentitiesV1beta1(
