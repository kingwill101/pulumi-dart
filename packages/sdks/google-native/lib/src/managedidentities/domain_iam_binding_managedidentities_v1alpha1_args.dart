...
/// {@template pulumi_managedidentities_v1alpha1_domain_iam_binding_managedidentities_v1alpha1_args_doc}
/// The set of arguments for DomainIamBinding.
/// {@endtemplate}
/// {@macro pulumi_managedidentities_v1alpha1_domain_iam_binding_managedidentities_v1alpha1_args_doc}
class DomainIamBindingManagedidentitiesV1alpha1Args {
  ...
  /// Creates a new [DomainIamBindingManagedidentitiesV1alpha1Args].
  ...
  const DomainIamBindingManagedidentitiesV1alpha1Args({
    this.condition,
  ...
  factory DomainIamBindingManagedidentitiesV1alpha1Args.fromMap(Map<String, dynamic> map) {
    return DomainIamBindingManagedidentitiesV1alpha1Args(
