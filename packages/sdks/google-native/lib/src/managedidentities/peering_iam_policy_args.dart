...
/// {@template pulumi_managedidentities_v1_peering_iam_policy_args_doc}
/// The set of arguments for PeeringIamPolicy.
/// {@endtemplate}
/// {@macro pulumi_managedidentities_v1_peering_iam_policy_args_doc}
class PeeringIamPolicyArgs {
  ...
  /// Creates a new [PeeringIamPolicyArgs].
  ...
  factory PeeringIamPolicyArgs.fromMap(Map<String, dynamic> map) {
    return PeeringIamPolicyArgs(
