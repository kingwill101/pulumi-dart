...
class DomainManagedidentitiesV1alpha1 extends pulumi.CustomResource {
  ...
  DomainManagedidentitiesV1alpha1(
    ...
    this.managedIdentitiesAdminName = registerOutput<String>('managedIdentitiesAdminName');
    this.name = registerOutput<String>('name');
    this.project = registerOutput<String>('project');
    this.reservedIpRange = registerOutput<String>('reservedIpRange');
    this.state = registerOutput<String>('state');
    this.statusMessage = registerOutput<String>('statusMessage');
    this.trusts = registerOutput<List<TrustResponseManagedidentitiesV1alpha1>>('trusts');
