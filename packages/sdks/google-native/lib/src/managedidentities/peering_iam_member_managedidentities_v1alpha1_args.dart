...
/// {@template pulumi_managedidentities_v1alpha1_peering_iam_member_managedidentities_v1alpha1_args_doc}
/// The set of arguments for PeeringIamMember.
/// {@endtemplate}
/// {@macro pulumi_managedidentities_v1alpha1_peering_iam_member_managedidentities_v1alpha1_args_doc}
class PeeringIamMemberManagedidentitiesV1alpha1Args {
  ...
  /// Creates a new [PeeringIamMemberManagedidentitiesV1alpha1Args].
  ...
  const PeeringIamMemberManagedidentitiesV1alpha1Args({
    this.condition,
  ...
  factory PeeringIamMemberManagedidentitiesV1alpha1Args.fromMap(Map<String, dynamic> map) {
    return PeeringIamMemberManagedidentitiesV1alpha1Args(
