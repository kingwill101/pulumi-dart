...
/// {@template pulumi_managedidentities_v1_domain_backup_iam_member_args_doc}
/// The set of arguments for DomainBackupIamMember.
/// {@endtemplate}
/// {@macro pulumi_managedidentities_v1_domain_backup_iam_member_args_doc}
class DomainBackupIamMemberArgs {
  ...
  /// Creates a new [DomainBackupIamMemberArgs].
  ...
  const DomainBackupIamMemberArgs({
    this.condition,
