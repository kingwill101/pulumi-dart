...
/// {@template pulumi_managedidentities_v1alpha1_peering_iam_binding_managedidentities_v1alpha1_args_doc}
/// The set of arguments for PeeringIamBinding.
/// {@endtemplate}
/// {@macro pulumi_managedidentities_v1alpha1_peering_iam_binding_managedidentities_v1alpha1_args_doc}
class PeeringIamBindingManagedidentitiesV1alpha1Args {
  ...
  /// Creates a new [PeeringIamBindingManagedidentitiesV1alpha1Args].
  ...
  const PeeringIamBindingManagedidentitiesV1alpha1Args({
    this.condition,
  ...
  factory PeeringIamBindingManagedidentitiesV1alpha1Args.fromMap(Map<String, dynamic> map) {
    return PeeringIamBindingManagedidentitiesV1alpha1Args(
