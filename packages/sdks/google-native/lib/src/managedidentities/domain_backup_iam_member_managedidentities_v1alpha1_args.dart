...
/// {@template pulumi_managedidentities_v1alpha1_domain_backup_iam_member_managedidentities_v1alpha1_args_doc}
/// The set of arguments for DomainBackupIamMember.
/// {@endtemplate}
/// {@macro pulumi_managedidentities_v1alpha1_domain_backup_iam_member_managedidentities_v1alpha1_args_doc}
class DomainBackupIamMemberManagedidentitiesV1alpha1Args {
  ...
  /// Creates a new [DomainBackupIamMemberManagedidentitiesV1alpha1Args].
  ...
  const DomainBackupIamMemberManagedidentitiesV1alpha1Args({
    this.condition,
