...
/// {@template pulumi_managedidentities_v1_peering_iam_binding_args_doc}
/// The set of arguments for PeeringIamBinding.
/// {@endtemplate}
/// {@macro pulumi_managedidentities_v1_peering_iam_binding_args_doc}
class PeeringIamBindingArgs {
  ...
  /// Creates a new [PeeringIamBindingArgs].
  ...
  factory PeeringIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return PeeringIamBindingArgs(
