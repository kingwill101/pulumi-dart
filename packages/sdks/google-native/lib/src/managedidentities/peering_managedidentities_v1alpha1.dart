...
class PeeringManagedidentitiesV1alpha1 extends pulumi.CustomResource {
  ...
  /// Creates a new [PeeringManagedidentitiesV1alpha1].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [PeeringManagedidentitiesV1alpha1]. {@macro pulumi_managedidentities_v1alpha1_peering_managedidentities_v1alpha1_args_doc}
