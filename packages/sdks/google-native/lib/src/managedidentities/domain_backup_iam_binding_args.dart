...
/// {@template pulumi_managedidentities_v1_domain_backup_iam_binding_args_doc}
/// The set of arguments for DomainBackupIamBinding.
/// {@endtemplate}
/// {@macro pulumi_managedidentities_v1_domain_backup_iam_binding_args_doc}
class DomainBackupIamBindingArgs {
  ...
  /// Creates a new [DomainBackupIamBindingArgs].
  ...
  const DomainBackupIamBindingArgs({
    this.condition,
  ...
  factory DomainBackupIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return DomainBackupIamBindingArgs(
