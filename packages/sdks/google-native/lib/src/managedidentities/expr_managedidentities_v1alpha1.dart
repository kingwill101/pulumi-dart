...
class ExprManagedidentitiesV1alpha1 {
  ...
  /// Creates a new [ExprManagedidentitiesV1alpha1].
  ...
  const ExprManagedidentitiesV1alpha1({
    this.description,
    this.expression,
    this.location,
    this.title,
  ...
  factory ExprManagedidentitiesV1alpha1.fromMap(Map<String, dynamic> map) {
    return ExprManagedidentitiesV1alpha1(
