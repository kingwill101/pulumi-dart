...
/// {@template pulumi_managedidentities_v1_domain_iam_member_args_doc}
/// The set of arguments for DomainIamMember.
/// {@endtemplate}
/// {@macro pulumi_managedidentities_v1_domain_iam_member_args_doc}
class DomainIamMemberArgs {
  ...
  /// Creates a new [DomainIamMemberArgs].
  ...
  factory DomainIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return DomainIamMemberArgs(
