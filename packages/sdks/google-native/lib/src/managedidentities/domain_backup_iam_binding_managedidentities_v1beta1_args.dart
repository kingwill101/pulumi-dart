...
/// {@template pulumi_managedidentities_v1beta1_domain_backup_iam_binding_managedidentities_v1beta1_args_doc}
/// The set of arguments for DomainBackupIamBinding.
/// {@endtemplate}
/// {@macro pulumi_managedidentities_v1beta1_domain_backup_iam_binding_managedidentities_v1beta1_args_doc}
class DomainBackupIamBindingManagedidentitiesV1beta1Args {
  ...
  /// Creates a new [DomainBackupIamBindingManagedidentitiesV1beta1Args].
  ...
  const DomainBackupIamBindingManagedidentitiesV1beta1Args({
    this.condition,
  ...
  factory DomainBackupIamBindingManagedidentitiesV1beta1Args.fromMap(Map<String, dynamic> map) {
    return DomainBackupIamBindingManagedidentitiesV1beta1Args(
