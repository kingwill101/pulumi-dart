...
/// {@template pulumi_managedidentities_v1beta1_domain_iam_binding_managedidentities_v1beta1_args_doc}
/// The set of arguments for DomainIamBinding.
/// {@endtemplate}
/// {@macro pulumi_managedidentities_v1beta1_domain_iam_binding_managedidentities_v1beta1_args_doc}
class DomainIamBindingManagedidentitiesV1beta1Args {
  ...
  /// Creates a new [DomainIamBindingManagedidentitiesV1beta1Args].
  ...
  const DomainIamBindingManagedidentitiesV1beta1Args({
    this.condition,
  ...
  factory DomainIamBindingManagedidentitiesV1beta1Args.fromMap(Map<String, dynamic> map) {
    return DomainIamBindingManagedidentitiesV1beta1Args(
