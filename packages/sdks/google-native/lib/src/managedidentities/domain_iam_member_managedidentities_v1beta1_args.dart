...
/// {@template pulumi_managedidentities_v1beta1_domain_iam_member_managedidentities_v1beta1_args_doc}
/// The set of arguments for DomainIamMember.
/// {@endtemplate}
/// {@macro pulumi_managedidentities_v1beta1_domain_iam_member_managedidentities_v1beta1_args_doc}
class DomainIamMemberManagedidentitiesV1beta1Args {
  ...
  /// Creates a new [DomainIamMemberManagedidentitiesV1beta1Args].
  ...
  const DomainIamMemberManagedidentitiesV1beta1Args({
    this.condition,
  ...
  factory DomainIamMemberManagedidentitiesV1beta1Args.fromMap(Map<String, dynamic> map) {
    return DomainIamMemberManagedidentitiesV1beta1Args(
