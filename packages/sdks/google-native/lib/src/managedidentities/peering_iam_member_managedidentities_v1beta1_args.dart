...
/// {@template pulumi_managedidentities_v1beta1_peering_iam_member_managedidentities_v1beta1_args_doc}
/// The set of arguments for PeeringIamMember.
/// {@endtemplate}
/// {@macro pulumi_managedidentities_v1beta1_peering_iam_member_managedidentities_v1beta1_args_doc}
class PeeringIamMemberManagedidentitiesV1beta1Args {
  ...
  /// Creates a new [PeeringIamMemberManagedidentitiesV1beta1Args].
  ...
  const PeeringIamMemberManagedidentitiesV1beta1Args({
    this.condition,
  ...
  factory PeeringIamMemberManagedidentitiesV1beta1Args.fromMap(Map<String, dynamic> map) {
    return PeeringIamMemberManagedidentitiesV1beta1Args(
