...
class DomainManagedidentitiesV1alpha1Args {
  ...
  factory DomainManagedidentitiesV1alpha1Args.fromMap(Map<String, dynamic> map) {
    return DomainManagedidentitiesV1alpha1Args(
      auditLogsEnabled: (() { final guardedValue = map['auditLogsEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      managedIdentitiesAdminName: (() { final guardedValue = map['managedIdentitiesAdminName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
