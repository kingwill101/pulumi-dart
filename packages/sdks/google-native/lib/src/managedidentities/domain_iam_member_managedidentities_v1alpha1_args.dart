...
/// {@template pulumi_managedidentities_v1alpha1_domain_iam_member_managedidentities_v1alpha1_args_doc}
/// The set of arguments for DomainIamMember.
/// {@endtemplate}
/// {@macro pulumi_managedidentities_v1alpha1_domain_iam_member_managedidentities_v1alpha1_args_doc}
class DomainIamMemberManagedidentitiesV1alpha1Args {
  ...
  /// Creates a new [DomainIamMemberManagedidentitiesV1alpha1Args].
  ...
  const DomainIamMemberManagedidentitiesV1alpha1Args({
    this.condition,
  ...
  factory DomainIamMemberManagedidentitiesV1alpha1Args.fromMap(Map<String, dynamic> map) {
