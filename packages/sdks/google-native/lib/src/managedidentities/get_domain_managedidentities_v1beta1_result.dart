...
class GetDomainManagedidentitiesV1beta1Result {
  ...
  const GetDomainManagedidentitiesV1beta1Result({
    required this.admin,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'trusts': pulumi.Input.encodeList<TrustResponseManagedidentitiesV1beta1, Map<String, dynamic>>(trusts, (value) => value.toMap()),
      'updateTime': updateTime,
    };
  }

  factory GetDomainManagedidentitiesV1beta1Result.fromMap(Map<String, dynamic> map) {
    return GetDomainManagedidentitiesV1beta1Result(
      ...
      trusts: pulumi.Input.decodeList<TrustResponseManagedidentitiesV1beta1>(map['trusts']!, (value) => TrustResponseManagedidentitiesV1beta1.fromMap((value as Map).cast<String, dynamic>())),
