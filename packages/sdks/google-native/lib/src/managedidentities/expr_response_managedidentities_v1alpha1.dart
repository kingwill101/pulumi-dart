...
class ExprResponseManagedidentitiesV1alpha1 {
  ...
  /// Creates a new [ExprResponseManagedidentitiesV1alpha1].
  ...
  const ExprResponseManagedidentitiesV1alpha1({
  ...
  factory ExprResponseManagedidentitiesV1alpha1.fromMap(Map<String, dynamic> map) {
    return ExprResponseManagedidentitiesV1alpha1(
