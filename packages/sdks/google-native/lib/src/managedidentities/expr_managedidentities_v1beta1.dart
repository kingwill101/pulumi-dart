...
class ExprManagedidentitiesV1beta1 {
  ...
  /// Creates a new [ExprManagedidentitiesV1beta1].
  ...
  const ExprManagedidentitiesV1beta1({
    this.description,
    this.expression,
    this.location,
    this.title,
  ...
  factory ExprManagedidentitiesV1beta1.fromMap(Map<String, dynamic> map) {
    return ExprManagedidentitiesV1beta1(
