...
/// {@template pulumi_managedidentities_v1_peering_iam_member_args_doc}
/// The set of arguments for PeeringIamMember.
/// {@endtemplate}
/// {@macro pulumi_managedidentities_v1_peering_iam_member_args_doc}
class PeeringIamMemberArgs {
  ...
  /// Creates a new [PeeringIamMemberArgs].
  ...
  factory PeeringIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return PeeringIamMemberArgs(
