...
class GetPeeringManagedidentitiesV1alpha1Result {
  ...
  /// Creates a new [GetPeeringManagedidentitiesV1alpha1Result].
  ...
  factory GetPeeringManagedidentitiesV1alpha1Result.fromMap(Map<String, dynamic> map) {
    return GetPeeringManagedidentitiesV1alpha1Result(
