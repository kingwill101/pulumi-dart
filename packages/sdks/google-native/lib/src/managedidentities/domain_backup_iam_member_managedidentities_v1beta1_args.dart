...
/// {@template pulumi_managedidentities_v1beta1_domain_backup_iam_member_managedidentities_v1beta1_args_doc}
/// The set of arguments for DomainBackupIamMember.
/// {@endtemplate}
/// {@macro pulumi_managedidentities_v1beta1_domain_backup_iam_member_managedidentities_v1beta1_args_doc}
class DomainBackupIamMemberManagedidentitiesV1beta1Args {
  ...
  /// Creates a new [DomainBackupIamMemberManagedidentitiesV1beta1Args].
  ...
  const DomainBackupIamMemberManagedidentitiesV1beta1Args({
    this.condition,
  ...
  factory DomainBackupIamMemberManagedidentitiesV1beta1Args.fromMap(Map<String, dynamic> map) {
    return DomainBackupIamMemberManagedidentitiesV1beta1Args(
