...
class GoogleCloudDataplexV1StorageFormat {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'compressionFormat': ?compressionFormat == null ? null : compressionFormat!.value,
  ...
  factory GoogleCloudDataplexV1StorageFormat.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDataplexV1StorageFormat(
      compressionFormat: map['compressionFormat'] == null ? null : GoogleCloudDataplexV1StorageFormatCompressionFormat.fromValue(map['compressionFormat'] as String),
      csv: map['csv'] == null ? null : GoogleCloudDataplexV1StorageFormatCsvOptions.fromMap((map['csv'] as Map).cast<String, dynamic>()),
      iceberg: map['iceberg'] == null ? null : GoogleCloudDataplexV1StorageFormatIcebergOptions.fromMap((map['iceberg'] as Map).cast<String, dynamic>()),
      json: map['json'] == null ? null : GoogleCloudDataplexV1StorageFormatJsonOptions.fromMap((map['json'] as Map).cast<String, dynamic>()),
