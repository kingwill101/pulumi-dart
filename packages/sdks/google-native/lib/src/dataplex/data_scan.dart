...
class DataScan extends pulumi.CustomResource {
  ...
  DataScan(
    ...
    this.dataProfileResult = registerOutput<GoogleCloudDataplexV1DataProfileResultResponse>('dataProfileResult');
    this.dataProfileSpec = registerOutput<GoogleCloudDataplexV1DataProfileSpecResponse>('dataProfileSpec');
    this.dataQualityResult = registerOutput<GoogleCloudDataplexV1DataQualityResultResponse>('dataQualityResult');
    this.dataQualitySpec = registerOutput<GoogleCloudDataplexV1DataQualitySpecResponse>('dataQualitySpec');
    this.dataScanId = registerOutput<String>('dataScanId');
    this.description = registerOutput<String>('description');
    this.displayName = registerOutput<String>('displayName');
    this.executionSpec = registerOutput<GoogleCloudDataplexV1DataScanExecutionSpecResponse>('executionSpec');
    this.executionStatus = registerOutput<GoogleCloudDataplexV1DataScanExecutionStatusResponse>('executionStatus');
