...
class LakeArgs {
  ...
  factory LakeArgs.fromMap(Map<String, dynamic> map) {
    return LakeArgs(
      ...
      metastore: (() { final guardedValue = map['metastore']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDataplexV1LakeMetastore.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
