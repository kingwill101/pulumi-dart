...
class GoogleCloudDataplexV1DataQualityRuleStatisticRangeExpectation {
  ...
  const GoogleCloudDataplexV1DataQualityRuleStatisticRangeExpectation({
    this.maxValue,
    this.minValue,
    this.statistic,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'maxValue': ?maxValue,
      'minValue': ?minValue,
      'statistic': ?pulumi.Input.mapOptionalInputValue<GoogleCloudDataplexV1DataQualityRuleStatisticRangeExpectationStatistic, String>(statistic, (value) => value.wireValue),
  ...
  factory GoogleCloudDataplexV1DataQualityRuleStatisticRangeExpectation.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDataplexV1DataQualityRuleStatisticRangeExpectation(
      ...
      statistic: (() { final guardedValue = map['statistic']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDataplexV1DataQualityRuleStatisticRangeExpectationStatistic.fromValue(guardedValue as String)); })(),
