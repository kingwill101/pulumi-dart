...
class AssetArgs {
  ...
  factory AssetArgs.fromMap(Map<String, dynamic> map) {
    return AssetArgs(
      ...
      discoverySpec: (() { final guardedValue = map['discoverySpec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDataplexV1AssetDiscoverySpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      resourceSpec: pulumi.Input.fromValue(GoogleCloudDataplexV1AssetResourceSpec.fromMap((map['resourceSpec']! as Map).cast<String, dynamic>())),
