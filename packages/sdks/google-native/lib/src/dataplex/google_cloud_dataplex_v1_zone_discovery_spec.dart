...
class GoogleCloudDataplexV1ZoneDiscoverySpec {
  ...
  final pulumi.Input<GoogleCloudDataplexV1ZoneDiscoverySpecCsvOptions>?
  csvOptions;
  ...
  final pulumi.Input<GoogleCloudDataplexV1ZoneDiscoverySpecJsonOptions>?
  jsonOptions;
  ...
  factory GoogleCloudDataplexV1ZoneDiscoverySpec.fromMap(
    ...
    return GoogleCloudDataplexV1ZoneDiscoverySpec(
      csvOptions: (() {
        ...
        return pulumi.Input.fromValue(
          GoogleCloudDataplexV1ZoneDiscoverySpecCsvOptions.fromMap(
      ...
      jsonOptions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GoogleCloudDataplexV1ZoneDiscoverySpecJsonOptions.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
