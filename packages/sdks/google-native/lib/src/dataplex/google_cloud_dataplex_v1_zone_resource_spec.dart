...
class GoogleCloudDataplexV1ZoneResourceSpec {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'locationType': pulumi.Input.mapInputValue<GoogleCloudDataplexV1ZoneResourceSpecLocationType, String>(locationType, (value) => value.value),
    };
  }

  factory GoogleCloudDataplexV1ZoneResourceSpec.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDataplexV1ZoneResourceSpec(
      locationType: (GoogleCloudDataplexV1ZoneResourceSpecLocationType.fromValue(map['locationType'] as String)).input(),
    );
  }
}
