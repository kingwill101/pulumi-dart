...
class GoogleCloudDataplexV1ZoneResourceSpec {
  ...
  final pulumi.Input<GoogleCloudDataplexV1ZoneResourceSpecLocationType>
  locationType;
    ...
    return <String, dynamic>{
      'locationType':
          pulumi.Input.mapInputValue<
            ...
            String
          >(locationType, (value) => value.wireValue),
    };
  }
  ...
  factory GoogleCloudDataplexV1ZoneResourceSpec.fromMap(
    ...
    return GoogleCloudDataplexV1ZoneResourceSpec(
      locationType: pulumi.Input.fromValue(
        GoogleCloudDataplexV1ZoneResourceSpecLocationType.fromValue(
