...
/// {@template pulumi_dataplex_v1_lake_asset_iam_policy_args_doc}
/// The set of arguments for LakeAssetIamPolicy.
/// {@endtemplate}
/// {@macro pulumi_dataplex_v1_lake_asset_iam_policy_args_doc}
class LakeAssetIamPolicyArgs {
  ...
  /// Creates a new [LakeAssetIamPolicyArgs].
  /// [assetId] Required.
  ...
  factory LakeAssetIamPolicyArgs.fromMap(Map<String, dynamic> map) {
    return LakeAssetIamPolicyArgs(
