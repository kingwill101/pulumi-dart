...
import 'lake_zone_iam_member_args.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy.Can return NOT_FOUND, INVALID_ARGUMENT, and PERMISSION_DENIED errors.
class LakeZoneIamMember extends pulumi.CustomResource {
  ...
  /// Creates a new [LakeZoneIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [LakeZoneIamMember]. {@macro pulumi_dataplex_v1_lake_zone_iam_member_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  LakeZoneIamMember(
    String name, {
    LakeZoneIamMemberArgs? args,
