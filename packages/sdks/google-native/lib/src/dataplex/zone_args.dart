...
class ZoneArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'type': pulumi.Input.mapInputValue<ZoneType, String>(type, (value) => value.wireValue),
      'zoneId': zoneId,
    };
  }
  ...
  factory ZoneArgs.fromMap(Map<String, dynamic> map) {
    return ZoneArgs(
      ...
      discoverySpec: (() { final guardedValue = map['discoverySpec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDataplexV1ZoneDiscoverySpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      resourceSpec: pulumi.Input.fromValue(GoogleCloudDataplexV1ZoneResourceSpec.fromMap((map['resourceSpec']! as Map).cast<String, dynamic>())),
