...
class GoogleCloudDataplexV1DataQualityRuleResultResponse {
  ...
  factory GoogleCloudDataplexV1DataQualityRuleResultResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDataplexV1DataQualityRuleResultResponse(
      evaluatedCount: (map['evaluatedCount'] as String).input(),
      failingRowsQuery: (map['failingRowsQuery'] as String).input(),
      nullCount: (map['nullCount'] as String).input(),
      passRatio: (map['passRatio'] as double).input(),
      passed: (map['passed'] as bool).input(),
      passedCount: (map['passedCount'] as String).input(),
      rule: (GoogleCloudDataplexV1DataQualityRuleResponse.fromMap((map['rule'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
