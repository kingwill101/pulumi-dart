...
class EntityArgs {
  ...
  EntityArgs({
    ...
    required pulumi.Output<String> dataPath,
    pulumi.Output<String>? dataPathPattern,
    pulumi.Output<String>? description,
    pulumi.Output<String>? displayName,
    pulumi.Output<String>? etag,
    required pulumi.Output<GoogleCloudDataplexV1StorageFormat> format,
    required pulumi.Output<String> id,
    required pulumi.Output<String> lakeId,
    pulumi.Output<String>? location,
    pulumi.Output<String>? project,
    required pulumi.Output<GoogleCloudDataplexV1Schema> schema,
    required pulumi.Output<EntitySystem> system,
    required pulumi.Output<EntityType> type,
    pulumi.Output<String>? zone,
      ...
      format = pulumi.Input.asInput<GoogleCloudDataplexV1StorageFormat>(format),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'system': pulumi.Input.mapInputValue<EntitySystem, String>(system, (value) => value.value),
      'type': pulumi.Input.mapInputValue<EntityType, String>(type, (value) => value.value),
      'zone': ?zone,
    };
  }
  ...
  factory EntityArgs.fromMap(Map<String, dynamic> map) {
    return EntityArgs(
      ...
      dataPath: pulumi.Output.create<String>(map['dataPath'] as String),
      dataPathPattern: map['dataPathPattern'] == null ? null : pulumi.Output.create<String>(map['dataPathPattern'] as String),
      description: map['description'] == null ? null : pulumi.Output.create<String>(map['description'] as String),
      displayName: map['displayName'] == null ? null : pulumi.Output.create<String>(map['displayName'] as String),
      etag: map['etag'] == null ? null : pulumi.Output.create<String>(map['etag'] as String),
      format: pulumi.Output.create<GoogleCloudDataplexV1StorageFormat>(GoogleCloudDataplexV1StorageFormat.fromMap((map['format'] as Map).cast<String, dynamic>())),
      ...
      schema: pulumi.Output.create<GoogleCloudDataplexV1Schema>(GoogleCloudDataplexV1Schema.fromMap((map['schema'] as Map).cast<String, dynamic>())),
      system: pulumi.Output.create<EntitySystem>(EntitySystem.fromValue(map['system'] as String)),
      type: pulumi.Output.create<EntityType>(EntityType.fromValue(map['type'] as String)),
