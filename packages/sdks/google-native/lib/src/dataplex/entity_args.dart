...
class EntityArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'system': pulumi.Input.mapInputValue<EntitySystem, String>(
        system,
        (value) => value.wireValue,
      ),
      'type': pulumi.Input.mapInputValue<EntityType, String>(
        type,
        (value) => value.wireValue,
      ),
      'zone': ?zone,
  ...
  factory EntityArgs.fromMap(Map<String, dynamic> map) {
    return EntityArgs(
      ...
      dataPathPattern: (() {
        final guardedValue = map['dataPathPattern'];
      ...
      format: pulumi.Input.fromValue(
        GoogleCloudDataplexV1StorageFormat.fromMap(
      ...
      schema: pulumi.Input.fromValue(
        GoogleCloudDataplexV1Schema.fromMap(
          (map['schema']! as Map).cast<String, dynamic>(),
        ),
      ),
      system: pulumi.Input.fromValue(
        EntitySystem.fromValue(map['system']! as String),
      ),
      type: pulumi.Input.fromValue(
        EntityType.fromValue(map['type']! as String),
      ),
      zone: (() {
