...
class GoogleCloudDataplexV1DataScanExecutionSpec {
  ...
  const GoogleCloudDataplexV1DataScanExecutionSpec({
    this.field,
    this.trigger,
  });
  ...
  factory GoogleCloudDataplexV1DataScanExecutionSpec.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDataplexV1DataScanExecutionSpec(
      ...
      trigger: (() { final guardedValue = map['trigger']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDataplexV1Trigger.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
