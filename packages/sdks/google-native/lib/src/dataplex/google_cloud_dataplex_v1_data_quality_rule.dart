...
class GoogleCloudDataplexV1DataQualityRule {
  ...
  final GoogleCloudDataplexV1DataQualityRuleRowConditionExpectation? rowConditionExpectation;
  /// Row-level rule which evaluates whether each column value is contained by a specified set.
  final GoogleCloudDataplexV1DataQualityRuleSetExpectation? setExpectation;
  /// Aggregate rule which evaluates whether the column aggregate statistic lies between a specified range.
  final GoogleCloudDataplexV1DataQualityRuleStatisticRangeExpectation? statisticRangeExpectation;
  /// Aggregate rule which evaluates whether the provided expression is true for a table.
  final GoogleCloudDataplexV1DataQualityRuleTableConditionExpectation? tableConditionExpectation;
  ...
  factory GoogleCloudDataplexV1DataQualityRule.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDataplexV1DataQualityRule(
      ...
      rangeExpectation: map['rangeExpectation'] == null ? null : GoogleCloudDataplexV1DataQualityRuleRangeExpectation.fromMap((map['rangeExpectation'] as Map).cast<String, dynamic>()),
      regexExpectation: map['regexExpectation'] == null ? null : GoogleCloudDataplexV1DataQualityRuleRegexExpectation.fromMap((map['regexExpectation'] as Map).cast<String, dynamic>()),
      rowConditionExpectation: map['rowConditionExpectation'] == null ? null : GoogleCloudDataplexV1DataQualityRuleRowConditionExpectation.fromMap((map['rowConditionExpectation'] as Map).cast<String, dynamic>()),
      setExpectation: map['setExpectation'] == null ? null : GoogleCloudDataplexV1DataQualityRuleSetExpectation.fromMap((map['setExpectation'] as Map).cast<String, dynamic>()),
      statisticRangeExpectation: map['statisticRangeExpectation'] == null ? null : GoogleCloudDataplexV1DataQualityRuleStatisticRangeExpectation.fromMap((map['statisticRangeExpectation'] as Map).cast<String, dynamic>()),
      tableConditionExpectation: map['tableConditionExpectation'] == null ? null : GoogleCloudDataplexV1DataQualityRuleTableConditionExpectation.fromMap((map['tableConditionExpectation'] as Map).cast<String, dynamic>()),
