...
class GoogleCloudDataplexV1DataQualityRule {
  ...
  final pulumi.Input<GoogleCloudDataplexV1DataQualityRuleRangeExpectation>?
  rangeExpectation;

  /// Row-level rule which evaluates whether each column value matches a specified regex.
  final pulumi.Input<GoogleCloudDataplexV1DataQualityRuleRegexExpectation>?
  regexExpectation;
  ...
  final pulumi.Input<GoogleCloudDataplexV1DataQualityRuleSetExpectation>?
  setExpectation;
