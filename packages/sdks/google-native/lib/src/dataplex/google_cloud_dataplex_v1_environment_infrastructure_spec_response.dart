...
class GoogleCloudDataplexV1EnvironmentInfrastructureSpecResponse {
  ...
  factory GoogleCloudDataplexV1EnvironmentInfrastructureSpecResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDataplexV1EnvironmentInfrastructureSpecResponse(
      compute: pulumi.Input.fromValue(GoogleCloudDataplexV1EnvironmentInfrastructureSpecComputeResourcesResponse.fromMap((map['compute']! as Map).cast<String, dynamic>())),
      osImage: pulumi.Input.fromValue(GoogleCloudDataplexV1EnvironmentInfrastructureSpecOsImageRuntimeResponse.fromMap((map['osImage']! as Map).cast<String, dynamic>())),
    );
  }
}
