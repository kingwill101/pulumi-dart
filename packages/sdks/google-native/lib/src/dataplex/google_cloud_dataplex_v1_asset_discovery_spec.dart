...
class GoogleCloudDataplexV1AssetDiscoverySpec {
  ...
  const GoogleCloudDataplexV1AssetDiscoverySpec({
    this.csvOptions,
    this.enabled,
  ...
  factory GoogleCloudDataplexV1AssetDiscoverySpec.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDataplexV1AssetDiscoverySpec(
      csvOptions: (() { final guardedValue = map['csvOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDataplexV1AssetDiscoverySpecCsvOptions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      jsonOptions: (() { final guardedValue = map['jsonOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDataplexV1AssetDiscoverySpecJsonOptions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
