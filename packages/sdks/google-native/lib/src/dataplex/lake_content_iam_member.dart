...
import 'lake_content_iam_member_args.dart';
...
class LakeContentIamMember extends pulumi.CustomResource {
  ...
  /// Creates a new [LakeContentIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [LakeContentIamMember]. {@macro pulumi_dataplex_v1_lake_content_iam_member_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  LakeContentIamMember(
    String name, {
    LakeContentIamMemberArgs? args,
