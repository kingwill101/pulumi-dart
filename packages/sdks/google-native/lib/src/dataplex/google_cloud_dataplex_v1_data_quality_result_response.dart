...
class GoogleCloudDataplexV1DataQualityResultResponse {
  ...
  final List<GoogleCloudDataplexV1DataQualityDimensionResultResponse> dimensions;
  /// Overall data quality result -- true if all rules passed.
  final bool passed;
  /// The result of post scan actions.
  final GoogleCloudDataplexV1DataQualityResultPostScanActionsResultResponse postScanActionsResult;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'columns': pulumi.Input.encodeList<GoogleCloudDataplexV1DataQualityColumnResultResponse, Map<String, dynamic>>(columns, (value) => value.toMap()),
      'dimensions': pulumi.Input.encodeList<GoogleCloudDataplexV1DataQualityDimensionResultResponse, Map<String, dynamic>>(dimensions, (value) => value.toMap()),
      'passed': passed,
      'postScanActionsResult': postScanActionsResult.toMap(),
      'rowCount': rowCount,
      'rules': pulumi.Input.encodeList<GoogleCloudDataplexV1DataQualityRuleResultResponse, Map<String, dynamic>>(rules, (value) => value.toMap()),
  ...
  factory GoogleCloudDataplexV1DataQualityResultResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDataplexV1DataQualityResultResponse(
      columns: pulumi.Input.decodeList<GoogleCloudDataplexV1DataQualityColumnResultResponse>(map['columns'], (value) => GoogleCloudDataplexV1DataQualityColumnResultResponse.fromMap((value as Map).cast<String, dynamic>())),
      dimensions: pulumi.Input.decodeList<GoogleCloudDataplexV1DataQualityDimensionResultResponse>(map['dimensions'], (value) => GoogleCloudDataplexV1DataQualityDimensionResultResponse.fromMap((value as Map).cast<String, dynamic>())),
      passed: map['passed'] as bool,
      postScanActionsResult: GoogleCloudDataplexV1DataQualityResultPostScanActionsResultResponse.fromMap((map['postScanActionsResult'] as Map).cast<String, dynamic>()),
      rowCount: map['rowCount'] as String,
      rules: pulumi.Input.decodeList<GoogleCloudDataplexV1DataQualityRuleResultResponse>(map['rules'], (value) => GoogleCloudDataplexV1DataQualityRuleResultResponse.fromMap((value as Map).cast<String, dynamic>())),
