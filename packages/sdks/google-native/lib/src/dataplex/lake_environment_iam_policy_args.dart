...
/// {@template pulumi_dataplex_v1_lake_environment_iam_policy_args_doc}
/// The set of arguments for LakeEnvironmentIamPolicy.
/// {@endtemplate}
/// {@macro pulumi_dataplex_v1_lake_environment_iam_policy_args_doc}
class LakeEnvironmentIamPolicyArgs {
  ...
  /// Creates a new [LakeEnvironmentIamPolicyArgs].
  ...
  factory LakeEnvironmentIamPolicyArgs.fromMap(Map<String, dynamic> map) {
    return LakeEnvironmentIamPolicyArgs(
      auditConfigs: (() {
