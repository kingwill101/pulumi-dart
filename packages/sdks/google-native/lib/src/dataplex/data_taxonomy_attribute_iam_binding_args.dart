...
/// {@template pulumi_dataplex_v1_data_taxonomy_attribute_iam_binding_args_doc}
/// The set of arguments for DataTaxonomyAttributeIamBinding.
/// {@endtemplate}
/// {@macro pulumi_dataplex_v1_data_taxonomy_attribute_iam_binding_args_doc}
class DataTaxonomyAttributeIamBindingArgs {
  ...
  /// Creates a new [DataTaxonomyAttributeIamBindingArgs].
  ...
  const DataTaxonomyAttributeIamBindingArgs({
    this.condition,
  ...
  factory DataTaxonomyAttributeIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return DataTaxonomyAttributeIamBindingArgs(
