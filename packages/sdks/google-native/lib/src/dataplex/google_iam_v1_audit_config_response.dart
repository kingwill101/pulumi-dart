...
class GoogleIamV1AuditConfigResponse {
  ...
  factory GoogleIamV1AuditConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleIamV1AuditConfigResponse(
      auditLogConfigs: (pulumi.Input.decodeList<GoogleIamV1AuditLogConfigResponse>(map['auditLogConfigs'], (value) => GoogleIamV1AuditLogConfigResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
