...
/// {@template pulumi_dataplex_v1_entry_type_iam_binding_args_doc}
/// The set of arguments for EntryTypeIamBinding.
/// {@endtemplate}
/// {@macro pulumi_dataplex_v1_entry_type_iam_binding_args_doc}
class EntryTypeIamBindingArgs {
  ...
  /// Creates a new [EntryTypeIamBindingArgs].
  ...
  factory EntryTypeIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return EntryTypeIamBindingArgs(
