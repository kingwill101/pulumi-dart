...
import 'lake_zone_iam_binding_args.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy.Can return NOT_FOUND, INVALID_ARGUMENT, and PERMISSION_DENIED errors.
class LakeZoneIamBinding extends pulumi.CustomResource {
  ...
  /// Creates a new [LakeZoneIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [LakeZoneIamBinding]. {@macro pulumi_dataplex_v1_lake_zone_iam_binding_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  LakeZoneIamBinding(
    String name, {
    LakeZoneIamBindingArgs? args,
