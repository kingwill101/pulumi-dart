...
class GoogleCloudDataplexV1DataQualitySpecResponse {
  ...
  factory GoogleCloudDataplexV1DataQualitySpecResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDataplexV1DataQualitySpecResponse(
      postScanActions: (GoogleCloudDataplexV1DataQualitySpecPostScanActionsResponse.fromMap((map['postScanActions'] as Map).cast<String, dynamic>())).input(),
      rowFilter: (map['rowFilter'] as String).input(),
      rules: (pulumi.Input.decodeList<GoogleCloudDataplexV1DataQualityRuleResponse>(map['rules'], (value) => GoogleCloudDataplexV1DataQualityRuleResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
