...
/// {@template pulumi_dataplex_v1_data_taxonomy_iam_member_args_doc}
/// The set of arguments for DataTaxonomyIamMember.
/// {@endtemplate}
/// {@macro pulumi_dataplex_v1_data_taxonomy_iam_member_args_doc}
class DataTaxonomyIamMemberArgs {
  ...
  /// Creates a new [DataTaxonomyIamMemberArgs].
  ...
  const DataTaxonomyIamMemberArgs({
    this.condition,
  ...
  factory DataTaxonomyIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return DataTaxonomyIamMemberArgs(
