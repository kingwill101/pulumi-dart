...
/// {@template pulumi_dataplex_v1_lake_zone_iam_binding_args_doc}
/// The set of arguments for LakeZoneIamBinding.
/// {@endtemplate}
/// {@macro pulumi_dataplex_v1_lake_zone_iam_binding_args_doc}
class LakeZoneIamBindingArgs {
  ...
  /// Creates a new [LakeZoneIamBindingArgs].
  ...
  factory LakeZoneIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return LakeZoneIamBindingArgs(
