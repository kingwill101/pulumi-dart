...
class GoogleCloudDataplexV1DataQualitySpec {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'rowFilter': ?rowFilter,
      'rules': pulumi.Input.encodeList<GoogleCloudDataplexV1DataQualityRule, Map<String, dynamic>>(rules, (value) => value.toMap()),
  ...
  factory GoogleCloudDataplexV1DataQualitySpec.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDataplexV1DataQualitySpec(
      postScanActions: map['postScanActions'] == null ? null : GoogleCloudDataplexV1DataQualitySpecPostScanActions.fromMap((map['postScanActions'] as Map).cast<String, dynamic>()),
      rowFilter: map['rowFilter'] == null ? null : map['rowFilter'] as String,
      rules: pulumi.Input.decodeList<GoogleCloudDataplexV1DataQualityRule>(map['rules'], (value) => GoogleCloudDataplexV1DataQualityRule.fromMap((value as Map).cast<String, dynamic>())),
