...
class GoogleCloudDataplexV1DataQualitySpec {
  ...
  final pulumi.Input<GoogleCloudDataplexV1DataQualitySpecPostScanActions>?
  postScanActions;
    ...
    return <String, dynamic>{
      ...
      'rules':
          pulumi.Input.mapInputValue<
            List<GoogleCloudDataplexV1DataQualityRule>,
  ...
  factory GoogleCloudDataplexV1DataQualitySpec.fromMap(
    ...
    return GoogleCloudDataplexV1DataQualitySpec(
      ...
      rules: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GoogleCloudDataplexV1DataQualityRule>(
          map['rules']!,
