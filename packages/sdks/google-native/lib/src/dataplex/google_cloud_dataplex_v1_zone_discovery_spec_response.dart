...
class GoogleCloudDataplexV1ZoneDiscoverySpecResponse {
  ...
  final pulumi.Input<GoogleCloudDataplexV1ZoneDiscoverySpecCsvOptionsResponse>
  csvOptions;
  ...
  final pulumi.Input<GoogleCloudDataplexV1ZoneDiscoverySpecJsonOptionsResponse>
  jsonOptions;
  ...
  factory GoogleCloudDataplexV1ZoneDiscoverySpecResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return GoogleCloudDataplexV1ZoneDiscoverySpecResponse(
      csvOptions: pulumi.Input.fromValue(
        GoogleCloudDataplexV1ZoneDiscoverySpecCsvOptionsResponse.fromMap(
      ...
      jsonOptions: pulumi.Input.fromValue(
        GoogleCloudDataplexV1ZoneDiscoverySpecJsonOptionsResponse.fromMap(
