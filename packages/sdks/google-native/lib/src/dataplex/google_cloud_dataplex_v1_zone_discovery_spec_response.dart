...
class GoogleCloudDataplexV1ZoneDiscoverySpecResponse {
  ...
  factory GoogleCloudDataplexV1ZoneDiscoverySpecResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDataplexV1ZoneDiscoverySpecResponse(
      csvOptions: (GoogleCloudDataplexV1ZoneDiscoverySpecCsvOptionsResponse.fromMap((map['csvOptions'] as Map).cast<String, dynamic>())).input(),
      ...
      jsonOptions: (GoogleCloudDataplexV1ZoneDiscoverySpecJsonOptionsResponse.fromMap((map['jsonOptions'] as Map).cast<String, dynamic>())).input(),
