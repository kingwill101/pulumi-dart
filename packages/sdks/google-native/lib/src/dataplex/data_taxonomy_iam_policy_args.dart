...
/// {@template pulumi_dataplex_v1_data_taxonomy_iam_policy_args_doc}
/// The set of arguments for DataTaxonomyIamPolicy.
/// {@endtemplate}
/// {@macro pulumi_dataplex_v1_data_taxonomy_iam_policy_args_doc}
class DataTaxonomyIamPolicyArgs {
  ...
  /// Creates a new [DataTaxonomyIamPolicyArgs].
  ...
  factory DataTaxonomyIamPolicyArgs.fromMap(Map<String, dynamic> map) {
    return DataTaxonomyIamPolicyArgs(
      auditConfigs: (() {
