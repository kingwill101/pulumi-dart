...
class GoogleCloudDataplexV1ScannedDataResponse {
  ...
  final pulumi.Input<GoogleCloudDataplexV1ScannedDataIncrementalFieldResponse>
  incrementalField;
  ...
  GoogleCloudDataplexV1ScannedDataResponse({required this.incrementalField});
    ...
    return <String, dynamic>{
      'incrementalField':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(incrementalField, (value) => value.toMap()),
    };
  }
  ...
  factory GoogleCloudDataplexV1ScannedDataResponse.fromMap(
    ...
    return GoogleCloudDataplexV1ScannedDataResponse(
      incrementalField: pulumi.Input.fromValue(
