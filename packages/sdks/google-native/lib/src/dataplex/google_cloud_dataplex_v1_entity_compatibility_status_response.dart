...
class GoogleCloudDataplexV1EntityCompatibilityStatusResponse {
  ...
  factory GoogleCloudDataplexV1EntityCompatibilityStatusResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDataplexV1EntityCompatibilityStatusResponse(
      bigquery: (GoogleCloudDataplexV1EntityCompatibilityStatusCompatibilityResponse.fromMap((map['bigquery'] as Map).cast<String, dynamic>())).input(),
      hiveMetastore: (GoogleCloudDataplexV1EntityCompatibilityStatusCompatibilityResponse.fromMap((map['hiveMetastore'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
