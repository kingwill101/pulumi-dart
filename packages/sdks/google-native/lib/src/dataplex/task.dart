...
class Task extends pulumi.CustomResource {
  ...
  Task(
    ...
    this.executionSpec = registerOutput<GoogleCloudDataplexV1TaskExecutionSpecResponse>('executionSpec');
    this.executionStatus = registerOutput<GoogleCloudDataplexV1TaskExecutionStatusResponse>('executionStatus');
    this.labels = registerOutput<Map<String, String>>('labels');
    this.lakeId = registerOutput<String>('lakeId');
    this.location = registerOutput<String>('location');
    this.name = registerOutput<String>('name');
    this.notebook = registerOutput<GoogleCloudDataplexV1TaskNotebookTaskConfigResponse>('notebook');
    this.project = registerOutput<String>('project');
    this.spark = registerOutput<GoogleCloudDataplexV1TaskSparkTaskConfigResponse>('spark');
    this.state = registerOutput<String>('state');
    this.taskId = registerOutput<String>('taskId');
    this.triggerSpec = registerOutput<GoogleCloudDataplexV1TaskTriggerSpecResponse>('triggerSpec');
