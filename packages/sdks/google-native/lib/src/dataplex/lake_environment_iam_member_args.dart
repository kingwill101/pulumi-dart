...
/// {@template pulumi_dataplex_v1_lake_environment_iam_member_args_doc}
/// The set of arguments for LakeEnvironmentIamMember.
/// {@endtemplate}
/// {@macro pulumi_dataplex_v1_lake_environment_iam_member_args_doc}
class LakeEnvironmentIamMemberArgs {
  ...
  /// Creates a new [LakeEnvironmentIamMemberArgs].
  ...
  const LakeEnvironmentIamMemberArgs({
    this.condition,
  ...
  factory LakeEnvironmentIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return LakeEnvironmentIamMemberArgs(
