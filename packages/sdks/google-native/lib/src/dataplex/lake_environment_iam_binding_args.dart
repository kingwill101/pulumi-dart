...
/// {@template pulumi_dataplex_v1_lake_environment_iam_binding_args_doc}
/// The set of arguments for LakeEnvironmentIamBinding.
/// {@endtemplate}
/// {@macro pulumi_dataplex_v1_lake_environment_iam_binding_args_doc}
class LakeEnvironmentIamBindingArgs {
  ...
  /// Creates a new [LakeEnvironmentIamBindingArgs].
  ...
  const LakeEnvironmentIamBindingArgs({
    this.condition,
  ...
  factory LakeEnvironmentIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return LakeEnvironmentIamBindingArgs(
