...
/// {@template pulumi_dataplex_v1_data_taxonomy_iam_binding_args_doc}
/// The set of arguments for DataTaxonomyIamBinding.
/// {@endtemplate}
/// {@macro pulumi_dataplex_v1_data_taxonomy_iam_binding_args_doc}
class DataTaxonomyIamBindingArgs {
  ...
  /// Creates a new [DataTaxonomyIamBindingArgs].
  ...
  const DataTaxonomyIamBindingArgs({
    this.condition,
  ...
  factory DataTaxonomyIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return DataTaxonomyIamBindingArgs(
