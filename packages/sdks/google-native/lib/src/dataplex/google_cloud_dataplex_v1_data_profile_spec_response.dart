...
class GoogleCloudDataplexV1DataProfileSpecResponse {
  ...
  final pulumi.Input<GoogleCloudDataplexV1DataProfileSpecSelectedFieldsResponse>
  excludeFields;
    ...
    return <String, dynamic>{
      'excludeFields':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(excludeFields, (value) => value.toMap()),
      'includeFields':
          pulumi.Input.mapInputValue<
            GoogleCloudDataplexV1DataProfileSpecSelectedFieldsResponse,
            Map<String, dynamic>
          >(includeFields, (value) => value.toMap()),
      'postScanActions':
          pulumi.Input.mapInputValue<
            GoogleCloudDataplexV1DataProfileSpecPostScanActionsResponse,
            Map<String, dynamic>
  ...
  factory GoogleCloudDataplexV1DataProfileSpecResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return GoogleCloudDataplexV1DataProfileSpecResponse(
      excludeFields: pulumi.Input.fromValue(
        GoogleCloudDataplexV1DataProfileSpecSelectedFieldsResponse.fromMap(
          (map['excludeFields']! as Map).cast<String, dynamic>(),
        ),
      ),
      includeFields: pulumi.Input.fromValue(
        GoogleCloudDataplexV1DataProfileSpecSelectedFieldsResponse.fromMap(
          (map['includeFields']! as Map).cast<String, dynamic>(),
        ),
      ),
      postScanActions: pulumi.Input.fromValue(
        GoogleCloudDataplexV1DataProfileSpecPostScanActionsResponse.fromMap(
