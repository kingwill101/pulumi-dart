...
class GoogleCloudDataplexV1DataProfileSpecResponse {
  ...
  factory GoogleCloudDataplexV1DataProfileSpecResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDataplexV1DataProfileSpecResponse(
      excludeFields: (GoogleCloudDataplexV1DataProfileSpecSelectedFieldsResponse.fromMap((map['excludeFields'] as Map).cast<String, dynamic>())).input(),
      includeFields: (GoogleCloudDataplexV1DataProfileSpecSelectedFieldsResponse.fromMap((map['includeFields'] as Map).cast<String, dynamic>())).input(),
      postScanActions: (GoogleCloudDataplexV1DataProfileSpecPostScanActionsResponse.fromMap((map['postScanActions'] as Map).cast<String, dynamic>())).input(),
      rowFilter: (map['rowFilter'] as String).input(),
      samplingPercent: (map['samplingPercent'] as double).input(),
    );
  }
}
