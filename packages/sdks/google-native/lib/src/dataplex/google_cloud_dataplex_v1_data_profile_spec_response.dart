...
class GoogleCloudDataplexV1DataProfileSpecResponse {
  ...
  final GoogleCloudDataplexV1DataProfileSpecSelectedFieldsResponse excludeFields;
  ...
  final GoogleCloudDataplexV1DataProfileSpecSelectedFieldsResponse includeFields;
  /// Optional. Actions to take upon job completion..
  final GoogleCloudDataplexV1DataProfileSpecPostScanActionsResponse postScanActions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'excludeFields': excludeFields.toMap(),
      'includeFields': includeFields.toMap(),
  ...
  factory GoogleCloudDataplexV1DataProfileSpecResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDataplexV1DataProfileSpecResponse(
      excludeFields: GoogleCloudDataplexV1DataProfileSpecSelectedFieldsResponse.fromMap((map['excludeFields'] as Map).cast<String, dynamic>()),
      includeFields: GoogleCloudDataplexV1DataProfileSpecSelectedFieldsResponse.fromMap((map['includeFields'] as Map).cast<String, dynamic>()),
      postScanActions: GoogleCloudDataplexV1DataProfileSpecPostScanActionsResponse.fromMap((map['postScanActions'] as Map).cast<String, dynamic>()),
