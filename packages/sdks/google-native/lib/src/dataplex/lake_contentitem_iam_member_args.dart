...
/// {@template pulumi_dataplex_v1_lake_contentitem_iam_member_args_doc}
/// The set of arguments for LakeContentitemIamMember.
/// {@endtemplate}
/// {@macro pulumi_dataplex_v1_lake_contentitem_iam_member_args_doc}
class LakeContentitemIamMemberArgs {
  ...
  /// Creates a new [LakeContentitemIamMemberArgs].
  ...
  const LakeContentitemIamMemberArgs({
    this.condition,
