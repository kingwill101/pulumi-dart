...
class GoogleCloudDataplexV1AssetDiscoverySpecResponse {
  ...
  const GoogleCloudDataplexV1AssetDiscoverySpecResponse({
  ...
  factory GoogleCloudDataplexV1AssetDiscoverySpecResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDataplexV1AssetDiscoverySpecResponse(
      csvOptions: pulumi.Input.fromValue(GoogleCloudDataplexV1AssetDiscoverySpecCsvOptionsResponse.fromMap((map['csvOptions']! as Map).cast<String, dynamic>())),
      ...
      jsonOptions: pulumi.Input.fromValue(GoogleCloudDataplexV1AssetDiscoverySpecJsonOptionsResponse.fromMap((map['jsonOptions']! as Map).cast<String, dynamic>())),
