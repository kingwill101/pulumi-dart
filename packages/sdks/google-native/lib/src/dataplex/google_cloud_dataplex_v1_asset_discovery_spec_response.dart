...
class GoogleCloudDataplexV1AssetDiscoverySpecResponse {
  ...
  final pulumi.Input<GoogleCloudDataplexV1AssetDiscoverySpecCsvOptionsResponse>
  csvOptions;
  ...
  final pulumi.Input<GoogleCloudDataplexV1AssetDiscoverySpecJsonOptionsResponse>
  jsonOptions;
  ...
  factory GoogleCloudDataplexV1AssetDiscoverySpecResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return GoogleCloudDataplexV1AssetDiscoverySpecResponse(
      csvOptions: pulumi.Input.fromValue(
        GoogleCloudDataplexV1AssetDiscoverySpecCsvOptionsResponse.fromMap(
          (map['csvOptions']! as Map).cast<String, dynamic>(),
        ),
      ),
      enabled: pulumi.Input.fromValue(map['enabled'] as bool),
      excludePatterns: pulumi.Input.fromValue(
        (map['excludePatterns'] as List).cast<String>(),
      ),
      includePatterns: pulumi.Input.fromValue(
        (map['includePatterns'] as List).cast<String>(),
      ),
      jsonOptions: pulumi.Input.fromValue(
        GoogleCloudDataplexV1AssetDiscoverySpecJsonOptionsResponse.fromMap(
