...
class GoogleCloudDataplexV1DataQualityRuleResponse {
  ...
  factory GoogleCloudDataplexV1DataQualityRuleResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDataplexV1DataQualityRuleResponse(
      ...
      nonNullExpectation: ((map['nonNullExpectation'] as Map).cast<String, dynamic>()).input(),
      rangeExpectation: (GoogleCloudDataplexV1DataQualityRuleRangeExpectationResponse.fromMap((map['rangeExpectation'] as Map).cast<String, dynamic>())).input(),
      regexExpectation: (GoogleCloudDataplexV1DataQualityRuleRegexExpectationResponse.fromMap((map['regexExpectation'] as Map).cast<String, dynamic>())).input(),
      rowConditionExpectation: (GoogleCloudDataplexV1DataQualityRuleRowConditionExpectationResponse.fromMap((map['rowConditionExpectation'] as Map).cast<String, dynamic>())).input(),
      setExpectation: (GoogleCloudDataplexV1DataQualityRuleSetExpectationResponse.fromMap((map['setExpectation'] as Map).cast<String, dynamic>())).input(),
      statisticRangeExpectation: (GoogleCloudDataplexV1DataQualityRuleStatisticRangeExpectationResponse.fromMap((map['statisticRangeExpectation'] as Map).cast<String, dynamic>())).input(),
      tableConditionExpectation: (GoogleCloudDataplexV1DataQualityRuleTableConditionExpectationResponse.fromMap((map['tableConditionExpectation'] as Map).cast<String, dynamic>())).input(),
      threshold: (map['threshold'] as double).input(),
      uniquenessExpectation: ((map['uniquenessExpectation'] as Map).cast<String, dynamic>()).input(),
    );
  }
}
