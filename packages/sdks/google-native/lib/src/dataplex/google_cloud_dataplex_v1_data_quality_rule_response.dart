...
class GoogleCloudDataplexV1DataQualityRuleResponse {
  ...
  final GoogleCloudDataplexV1DataQualityRuleRangeExpectationResponse rangeExpectation;
  /// Row-level rule which evaluates whether each column value matches a specified regex.
  final GoogleCloudDataplexV1DataQualityRuleRegexExpectationResponse regexExpectation;
  /// Row-level rule which evaluates whether each row in a table passes the specified condition.
  final GoogleCloudDataplexV1DataQualityRuleRowConditionExpectationResponse rowConditionExpectation;
  /// Row-level rule which evaluates whether each column value is contained by a specified set.
  final GoogleCloudDataplexV1DataQualityRuleSetExpectationResponse setExpectation;
  /// Aggregate rule which evaluates whether the column aggregate statistic lies between a specified range.
  final GoogleCloudDataplexV1DataQualityRuleStatisticRangeExpectationResponse statisticRangeExpectation;
  /// Aggregate rule which evaluates whether the provided expression is true for a table.
  final GoogleCloudDataplexV1DataQualityRuleTableConditionExpectationResponse tableConditionExpectation;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'rangeExpectation': rangeExpectation.toMap(),
      'regexExpectation': regexExpectation.toMap(),
      'rowConditionExpectation': rowConditionExpectation.toMap(),
      'setExpectation': setExpectation.toMap(),
      'statisticRangeExpectation': statisticRangeExpectation.toMap(),
      'tableConditionExpectation': tableConditionExpectation.toMap(),
      'threshold': threshold,
  ...
  factory GoogleCloudDataplexV1DataQualityRuleResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDataplexV1DataQualityRuleResponse(
      ...
      nonNullExpectation: (map['nonNullExpectation'] as Map).cast<String, dynamic>(),
      rangeExpectation: GoogleCloudDataplexV1DataQualityRuleRangeExpectationResponse.fromMap((map['rangeExpectation'] as Map).cast<String, dynamic>()),
      regexExpectation: GoogleCloudDataplexV1DataQualityRuleRegexExpectationResponse.fromMap((map['regexExpectation'] as Map).cast<String, dynamic>()),
      rowConditionExpectation: GoogleCloudDataplexV1DataQualityRuleRowConditionExpectationResponse.fromMap((map['rowConditionExpectation'] as Map).cast<String, dynamic>()),
      setExpectation: GoogleCloudDataplexV1DataQualityRuleSetExpectationResponse.fromMap((map['setExpectation'] as Map).cast<String, dynamic>()),
      statisticRangeExpectation: GoogleCloudDataplexV1DataQualityRuleStatisticRangeExpectationResponse.fromMap((map['statisticRangeExpectation'] as Map).cast<String, dynamic>()),
      tableConditionExpectation: GoogleCloudDataplexV1DataQualityRuleTableConditionExpectationResponse.fromMap((map['tableConditionExpectation'] as Map).cast<String, dynamic>()),
      threshold: map['threshold'] as double,
      uniquenessExpectation: (map['uniquenessExpectation'] as Map).cast<String, dynamic>(),
    );
  }
}
