...
/// {@template pulumi_dataplex_v1_lake_asset_iam_binding_args_doc}
/// The set of arguments for LakeAssetIamBinding.
/// {@endtemplate}
/// {@macro pulumi_dataplex_v1_lake_asset_iam_binding_args_doc}
class LakeAssetIamBindingArgs {
  ...
  /// Creates a new [LakeAssetIamBindingArgs].
  ...
  factory LakeAssetIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return LakeAssetIamBindingArgs(
