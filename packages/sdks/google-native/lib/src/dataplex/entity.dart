...
class Entity extends pulumi.CustomResource {
  ...
  Entity(
    ...
    this.access = registerOutput<GoogleCloudDataplexV1StorageAccessResponse>('access');
    this.asset = registerOutput<String>('asset');
    this.catalogEntry = registerOutput<String>('catalogEntry');
    this.compatibility = registerOutput<GoogleCloudDataplexV1EntityCompatibilityStatusResponse>('compatibility');
    ...
    this.format = registerOutput<GoogleCloudDataplexV1StorageFormatResponse>('format');
