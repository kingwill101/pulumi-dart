...
class DataAttributeBindingArgs {
  ...
  factory DataAttributeBindingArgs.fromMap(Map<String, dynamic> map) {
    return DataAttributeBindingArgs(
      ...
      paths: (() { final guardedValue = map['paths']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudDataplexV1DataAttributeBindingPath>(guardedValue, (value) => GoogleCloudDataplexV1DataAttributeBindingPath.fromMap((value as Map).cast<String, dynamic>()))); })(),
