...
/// {@template pulumi_dataplex_v1_data_attribute_binding_iam_member_args_doc}
/// The set of arguments for DataAttributeBindingIamMember.
/// {@endtemplate}
/// {@macro pulumi_dataplex_v1_data_attribute_binding_iam_member_args_doc}
class DataAttributeBindingIamMemberArgs {
  ...
  /// Creates a new [DataAttributeBindingIamMemberArgs].
  ...
  const DataAttributeBindingIamMemberArgs({
    this.condition,
  ...
  factory DataAttributeBindingIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return DataAttributeBindingIamMemberArgs(
