...
class GoogleCloudDataplexV1DataProfileSpec {
  ...
  final pulumi.Input<GoogleCloudDataplexV1DataProfileSpecSelectedFields>?
  excludeFields;
  ...
  final pulumi.Input<GoogleCloudDataplexV1DataProfileSpecPostScanActions>?
  postScanActions;
  ...
  factory GoogleCloudDataplexV1DataProfileSpec.fromMap(
    ...
    return GoogleCloudDataplexV1DataProfileSpec(
      excludeFields: (() {
        final guardedValue = map['excludeFields'];
