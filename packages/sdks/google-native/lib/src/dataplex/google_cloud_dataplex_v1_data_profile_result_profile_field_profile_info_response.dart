...
class GoogleCloudDataplexV1DataProfileResultProfileFieldProfileInfoResponse {
  ...
  factory GoogleCloudDataplexV1DataProfileResultProfileFieldProfileInfoResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDataplexV1DataProfileResultProfileFieldProfileInfoResponse(
      distinctRatio: (map['distinctRatio'] as double).input(),
      doubleProfile: (GoogleCloudDataplexV1DataProfileResultProfileFieldProfileInfoDoubleFieldInfoResponse.fromMap((map['doubleProfile'] as Map).cast<String, dynamic>())).input(),
      integerProfile: (GoogleCloudDataplexV1DataProfileResultProfileFieldProfileInfoIntegerFieldInfoResponse.fromMap((map['integerProfile'] as Map).cast<String, dynamic>())).input(),
      nullRatio: (map['nullRatio'] as double).input(),
      stringProfile: (GoogleCloudDataplexV1DataProfileResultProfileFieldProfileInfoStringFieldInfoResponse.fromMap((map['stringProfile'] as Map).cast<String, dynamic>())).input(),
      topNValues: (pulumi.Input.decodeList<GoogleCloudDataplexV1DataProfileResultProfileFieldProfileInfoTopNValueResponse>(map['topNValues'], (value) => GoogleCloudDataplexV1DataProfileResultProfileFieldProfileInfoTopNValueResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
