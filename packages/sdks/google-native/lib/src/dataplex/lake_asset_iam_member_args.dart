...
/// {@template pulumi_dataplex_v1_lake_asset_iam_member_args_doc}
/// The set of arguments for LakeAssetIamMember.
/// {@endtemplate}
/// {@macro pulumi_dataplex_v1_lake_asset_iam_member_args_doc}
class LakeAssetIamMemberArgs {
  ...
  /// Creates a new [LakeAssetIamMemberArgs].
  ...
  factory LakeAssetIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return LakeAssetIamMemberArgs(
