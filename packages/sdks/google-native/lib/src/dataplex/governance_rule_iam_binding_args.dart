...
/// {@template pulumi_dataplex_v1_governance_rule_iam_binding_args_doc}
/// The set of arguments for GovernanceRuleIamBinding.
/// {@endtemplate}
/// {@macro pulumi_dataplex_v1_governance_rule_iam_binding_args_doc}
class GovernanceRuleIamBindingArgs {
  ...
  /// Creates a new [GovernanceRuleIamBindingArgs].
  ...
  const GovernanceRuleIamBindingArgs({
    this.condition,
  ...
  factory GovernanceRuleIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return GovernanceRuleIamBindingArgs(
