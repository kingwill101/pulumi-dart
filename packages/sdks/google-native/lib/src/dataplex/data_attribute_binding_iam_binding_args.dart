...
/// {@template pulumi_dataplex_v1_data_attribute_binding_iam_binding_args_doc}
/// The set of arguments for DataAttributeBindingIamBinding.
/// {@endtemplate}
/// {@macro pulumi_dataplex_v1_data_attribute_binding_iam_binding_args_doc}
class DataAttributeBindingIamBindingArgs {
  ...
  /// Creates a new [DataAttributeBindingIamBindingArgs].
  ...
  const DataAttributeBindingIamBindingArgs({
    this.condition,
  ...
  factory DataAttributeBindingIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return DataAttributeBindingIamBindingArgs(
