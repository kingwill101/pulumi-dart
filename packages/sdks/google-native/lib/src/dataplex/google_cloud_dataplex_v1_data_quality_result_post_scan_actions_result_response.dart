...
class GoogleCloudDataplexV1DataQualityResultPostScanActionsResultResponse {
  ...
  const GoogleCloudDataplexV1DataQualityResultPostScanActionsResultResponse({
  ...
  factory GoogleCloudDataplexV1DataQualityResultPostScanActionsResultResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDataplexV1DataQualityResultPostScanActionsResultResponse(
      bigqueryExportResult: pulumi.Input.fromValue(GoogleCloudDataplexV1DataQualityResultPostScanActionsResultBigQueryExportResultResponse.fromMap((map['bigqueryExportResult']! as Map).cast<String, dynamic>())),
    );
  }
}
