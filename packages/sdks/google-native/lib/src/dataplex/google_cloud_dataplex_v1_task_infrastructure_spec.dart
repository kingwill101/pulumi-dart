...
class GoogleCloudDataplexV1TaskInfrastructureSpec {
  ...
  final GoogleCloudDataplexV1TaskInfrastructureSpecContainerImageRuntime? containerImage;
  /// Vpc network.
  ...
  factory GoogleCloudDataplexV1TaskInfrastructureSpec.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDataplexV1TaskInfrastructureSpec(
      batch: map['batch'] == null ? null : GoogleCloudDataplexV1TaskInfrastructureSpecBatchComputeResources.fromMap((map['batch'] as Map).cast<String, dynamic>()),
      containerImage: map['containerImage'] == null ? null : GoogleCloudDataplexV1TaskInfrastructureSpecContainerImageRuntime.fromMap((map['containerImage'] as Map).cast<String, dynamic>()),
      vpcNetwork: map['vpcNetwork'] == null ? null : GoogleCloudDataplexV1TaskInfrastructureSpecVpcNetwork.fromMap((map['vpcNetwork'] as Map).cast<String, dynamic>()),
    );
  }
}
