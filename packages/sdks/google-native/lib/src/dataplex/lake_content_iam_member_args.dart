...
/// {@template pulumi_dataplex_v1_lake_content_iam_member_args_doc}
/// The set of arguments for LakeContentIamMember.
/// {@endtemplate}
/// {@macro pulumi_dataplex_v1_lake_content_iam_member_args_doc}
class LakeContentIamMemberArgs {
  ...
  /// Creates a new [LakeContentIamMemberArgs].
  ...
  const LakeContentIamMemberArgs({
    this.condition,
  ...
  factory LakeContentIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return LakeContentIamMemberArgs(
