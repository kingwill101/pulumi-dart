...
/// {@template pulumi_dataplex_v1_data_taxonomy_attribute_iam_member_args_doc}
/// The set of arguments for DataTaxonomyAttributeIamMember.
/// {@endtemplate}
/// {@macro pulumi_dataplex_v1_data_taxonomy_attribute_iam_member_args_doc}
class DataTaxonomyAttributeIamMemberArgs {
  ...
  /// Creates a new [DataTaxonomyAttributeIamMemberArgs].
  ...
  const DataTaxonomyAttributeIamMemberArgs({
    this.condition,
  ...
  factory DataTaxonomyAttributeIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return DataTaxonomyAttributeIamMemberArgs(
