...
/// {@template pulumi_dataplex_v1_governance_rule_iam_member_args_doc}
/// The set of arguments for GovernanceRuleIamMember.
/// {@endtemplate}
/// {@macro pulumi_dataplex_v1_governance_rule_iam_member_args_doc}
class GovernanceRuleIamMemberArgs {
  ...
  /// Creates a new [GovernanceRuleIamMemberArgs].
  ...
  const GovernanceRuleIamMemberArgs({
    this.condition,
  ...
  factory GovernanceRuleIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return GovernanceRuleIamMemberArgs(
