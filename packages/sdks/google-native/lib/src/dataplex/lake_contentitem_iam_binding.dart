...
import 'lake_contentitem_iam_binding_args.dart';
...
class LakeContentitemIamBinding extends pulumi.CustomResource {
  ...
  /// Creates a new [LakeContentitemIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [LakeContentitemIamBinding]. {@macro pulumi_dataplex_v1_lake_contentitem_iam_binding_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  LakeContentitemIamBinding(
    String name, {
    LakeContentitemIamBindingArgs? args,
