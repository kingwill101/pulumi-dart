...
class GoogleCloudDataplexV1Schema {
  ...
  final pulumi.Input<List<GoogleCloudDataplexV1SchemaPartitionField>>?
  partitionFields;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'partitionFields':
          ?pulumi.Input.mapOptionalInputValue<
            List<GoogleCloudDataplexV1SchemaPartitionField>,
            List<Map<String, dynamic>>
          >(
            partitionFields,
            (value) =>
      ...
      'partitionStyle':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(partitionStyle, (value) => value.wireValue),
  ...
  factory GoogleCloudDataplexV1Schema.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDataplexV1Schema(
      ...
      partitionFields: (() {
        final guardedValue = map['partitionFields'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      partitionStyle: (() {
        final guardedValue = map['partitionStyle'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
