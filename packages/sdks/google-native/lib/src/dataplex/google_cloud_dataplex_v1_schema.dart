...
class GoogleCloudDataplexV1Schema {
  ...
  const GoogleCloudDataplexV1Schema({
    this.fields,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'partitionStyle': ?pulumi.Input.mapOptionalInputValue<GoogleCloudDataplexV1SchemaPartitionStyle, String>(partitionStyle, (value) => value.wireValue),
  ...
  factory GoogleCloudDataplexV1Schema.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDataplexV1Schema(
      ...
      partitionFields: (() { final guardedValue = map['partitionFields']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudDataplexV1SchemaPartitionField>(guardedValue, (value) => GoogleCloudDataplexV1SchemaPartitionField.fromMap((value as Map).cast<String, dynamic>()))); })(),
      partitionStyle: (() { final guardedValue = map['partitionStyle']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDataplexV1SchemaPartitionStyle.fromValue(guardedValue as String)); })(),
