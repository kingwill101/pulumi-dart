...
class GoogleCloudDataplexV1SchemaResponse {
  ...
  final pulumi.Input<List<GoogleCloudDataplexV1SchemaPartitionFieldResponse>>
  partitionFields;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'partitionFields':
          pulumi.Input.mapInputValue<
            List<GoogleCloudDataplexV1SchemaPartitionFieldResponse>,
            List<Map<String, dynamic>>
          >(
            partitionFields,
            (value) =>
  ...
  factory GoogleCloudDataplexV1SchemaResponse.fromMap(
    ...
    return GoogleCloudDataplexV1SchemaResponse(
      ...
      partitionFields: pulumi.Input.fromValue(
