...
class ScanRun {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'endTime': ?endTime,
      'executionState':
          ?pulumi.Input.mapOptionalInputValue<ScanRunExecutionState, String>(
            executionState,
      ...
      'resultState':
          ?pulumi.Input.mapOptionalInputValue<ScanRunResultState, String>(
            resultState,
            (value) => value.wireValue,
          ),
      'startTime': ?startTime,
    ...
    return ScanRun(
      ...
      executionState: (() {
        ...
        return pulumi.Input.fromValue(
          ScanRunExecutionState.fromValue(guardedValue as String),
        );
      })(),
      hasVulnerabilities: (() {
      ...
      resultState: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ScanRunResultState.fromValue(guardedValue as String),
        );
      })(),
      startTime: (() {
