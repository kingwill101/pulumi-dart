...
class ScanRunWebsecurityscannerV1beta {
  ...
  final pulumi.Input<ScanRunExecutionStateWebsecurityscannerV1beta>?
  executionState;
    ...
    return <String, dynamic>{
      ...
      'errorTrace':
          ?pulumi.Input.mapOptionalInputValue<
            ScanRunErrorTrace,
            Map<String, dynamic>
          >(errorTrace, (value) => value.toMap()),
      'executionState':
          ?pulumi.Input.mapOptionalInputValue<
            ScanRunExecutionStateWebsecurityscannerV1beta,
            String
          >(executionState, (value) => value.wireValue),
      'hasVulnerabilities': ?hasVulnerabilities,
      'name': ?name,
      'progressPercent': ?progressPercent,
      'resultState':
          ?pulumi.Input.mapOptionalInputValue<
            ScanRunResultStateWebsecurityscannerV1beta,
            String
          >(resultState, (value) => value.wireValue),
      'startTime': ?startTime,
  ...
  factory ScanRunWebsecurityscannerV1beta.fromMap(Map<String, dynamic> map) {
    return ScanRunWebsecurityscannerV1beta(
      ...
      errorTrace: (() {
        final guardedValue = map['errorTrace'];
        if (guardedValue == null) return null;
      ...
      hasVulnerabilities: (() {
        final guardedValue = map['hasVulnerabilities'];
        if (guardedValue == null) return null;
      ...
      progressPercent: (() {
        final guardedValue = map['progressPercent'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      resultState: (() {
        final guardedValue = map['resultState'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      urlsCrawledCount: (() {
        final guardedValue = map['urlsCrawledCount'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      urlsTestedCount: (() {
        final guardedValue = map['urlsTestedCount'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      warningTraces: (() {
        final guardedValue = map['warningTraces'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
