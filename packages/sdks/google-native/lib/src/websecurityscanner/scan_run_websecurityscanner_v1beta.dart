...
class ScanRunWebsecurityscannerV1beta {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'executionState': ?pulumi.Input.mapOptionalInputValue<ScanRunExecutionStateWebsecurityscannerV1beta, String>(executionState, (value) => value.value),
      'hasVulnerabilities': ?hasVulnerabilities,
      'name': ?name,
      'progressPercent': ?progressPercent,
      'resultState': ?pulumi.Input.mapOptionalInputValue<ScanRunResultStateWebsecurityscannerV1beta, String>(resultState, (value) => value.value),
      'startTime': ?startTime,
