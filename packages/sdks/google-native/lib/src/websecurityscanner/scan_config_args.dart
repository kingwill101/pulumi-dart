...
class ScanConfigArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'exportToSecurityCommandCenter': ?pulumi.Input.mapOptionalInputValue<ScanConfigExportToSecurityCommandCenter, String>(exportToSecurityCommandCenter, (value) => value.wireValue),
      'ignoreHttpStatusErrors': ?ignoreHttpStatusErrors,
      'managedScan': ?managedScan,
      'maxQps': ?maxQps,
      'name': ?name,
      'project': ?project,
      'riskLevel': ?pulumi.Input.mapOptionalInputValue<ScanConfigRiskLevel, String>(riskLevel, (value) => value.wireValue),
      ...
      'userAgent': ?pulumi.Input.mapOptionalInputValue<ScanConfigUserAgent, String>(userAgent, (value) => value.wireValue),
    };
  }
  ...
  factory ScanConfigArgs.fromMap(Map<String, dynamic> map) {
    return ScanConfigArgs(
      ...
      exportToSecurityCommandCenter: (() { final guardedValue = map['exportToSecurityCommandCenter']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ScanConfigExportToSecurityCommandCenter.fromValue(guardedValue as String)); })(),
      ...
      riskLevel: (() { final guardedValue = map['riskLevel']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ScanConfigRiskLevel.fromValue(guardedValue as String)); })(),
      ...
      userAgent: (() { final guardedValue = map['userAgent']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ScanConfigUserAgent.fromValue(guardedValue as String)); })(),
    );
  }
}
