...
class AuthenticationResponseWebsecurityscannerV1alpha {
  ...
  factory AuthenticationResponseWebsecurityscannerV1alpha.fromMap(Map<String, dynamic> map) {
    return AuthenticationResponseWebsecurityscannerV1alpha(
      customAccount: pulumi.Input.fromValue(CustomAccountResponseWebsecurityscannerV1alpha.fromMap((map['customAccount']! as Map).cast<String, dynamic>())),
      googleAccount: pulumi.Input.fromValue(GoogleAccountResponseWebsecurityscannerV1alpha.fromMap((map['googleAccount']! as Map).cast<String, dynamic>())),
    );
  }
}
