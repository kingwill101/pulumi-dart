...
class AuthenticationResponseWebsecurityscannerV1alpha {
  ...
  final pulumi.Input<CustomAccountResponseWebsecurityscannerV1alpha>
  customAccount;

  /// Authentication using a Google account.
  final pulumi.Input<GoogleAccountResponseWebsecurityscannerV1alpha>
  googleAccount;
  ...
  factory AuthenticationResponseWebsecurityscannerV1alpha.fromMap(
    ...
    return AuthenticationResponseWebsecurityscannerV1alpha(
      customAccount: pulumi.Input.fromValue(
        CustomAccountResponseWebsecurityscannerV1alpha.fromMap(
          (map['customAccount']! as Map).cast<String, dynamic>(),
        ),
      ),
      googleAccount: pulumi.Input.fromValue(
        GoogleAccountResponseWebsecurityscannerV1alpha.fromMap(
