...
class AuthenticationResponseWebsecurityscannerV1beta {
  ...
  final pulumi.Input<CustomAccountResponseWebsecurityscannerV1beta>
  customAccount;

  /// Authentication using a Google account.
  final pulumi.Input<GoogleAccountResponseWebsecurityscannerV1beta>
  googleAccount;

  /// Authentication using Identity-Aware-Proxy (IAP).
  final pulumi.Input<IapCredentialResponseWebsecurityscannerV1beta>
  iapCredential;
