...
class ScanConfigError {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'code': ?pulumi.Input.mapOptionalInputValue<ScanConfigErrorCode, String>(code, (value) => value.wireValue),
      'fieldName': ?fieldName,
    };
  }
  ...
  factory ScanConfigError.fromMap(Map<String, dynamic> map) {
    return ScanConfigError(
      code: (() { final guardedValue = map['code']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ScanConfigErrorCode.fromValue(guardedValue as String)); })(),
