...
class ScanRunResponseWebsecurityscannerV1beta {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'warningTraces':
          pulumi.Input.mapInputValue<
            List<ScanRunWarningTraceResponse>,
  ...
  factory ScanRunResponseWebsecurityscannerV1beta.fromMap(
    ...
    return ScanRunResponseWebsecurityscannerV1beta(
      ...
      errorTrace: pulumi.Input.fromValue(
        ScanRunErrorTraceResponse.fromMap(
      ...
      warningTraces: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ScanRunWarningTraceResponse>(
          map['warningTraces']!,
