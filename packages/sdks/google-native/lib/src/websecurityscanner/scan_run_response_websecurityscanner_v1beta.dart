...
class ScanRunResponseWebsecurityscannerV1beta {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'warningTraces': pulumi.Input.encodeList<ScanRunWarningTraceResponse, Map<String, dynamic>>(warningTraces, (value) => value.toMap()),
    };
  }
  ...
  factory ScanRunResponseWebsecurityscannerV1beta.fromMap(Map<String, dynamic> map) {
    return ScanRunResponseWebsecurityscannerV1beta(
      ...
      errorTrace: ScanRunErrorTraceResponse.fromMap((map['errorTrace'] as Map).cast<String, dynamic>()),
      ...
      warningTraces: pulumi.Input.decodeList<ScanRunWarningTraceResponse>(map['warningTraces'], (value) => ScanRunWarningTraceResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
