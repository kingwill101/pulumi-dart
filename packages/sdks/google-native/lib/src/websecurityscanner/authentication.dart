    ...
    return Authentication(
      customAccount: (() {
        ...
        return pulumi.Input.fromValue(
          CustomAccount.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      googleAccount: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GoogleAccount.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      iapCredential: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          IapCredential.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
