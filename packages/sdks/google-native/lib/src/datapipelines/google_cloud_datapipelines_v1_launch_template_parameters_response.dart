...
class GoogleCloudDatapipelinesV1LaunchTemplateParametersResponse {
  ...
  const GoogleCloudDatapipelinesV1LaunchTemplateParametersResponse({
  ...
  factory GoogleCloudDatapipelinesV1LaunchTemplateParametersResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDatapipelinesV1LaunchTemplateParametersResponse(
      environment: pulumi.Input.fromValue(GoogleCloudDatapipelinesV1RuntimeEnvironmentResponse.fromMap((map['environment']! as Map).cast<String, dynamic>())),
      ...
      transformNameMapping: pulumi.Input.fromValue((map['transformNameMapping'] as Map).cast<String, String>()),
