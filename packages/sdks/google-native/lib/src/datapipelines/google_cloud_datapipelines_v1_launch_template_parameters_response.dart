...
class GoogleCloudDatapipelinesV1LaunchTemplateParametersResponse {
  ...
  final pulumi.Input<GoogleCloudDatapipelinesV1RuntimeEnvironmentResponse>
  environment;
  ...
  factory GoogleCloudDatapipelinesV1LaunchTemplateParametersResponse.fromMap(
    ...
    return GoogleCloudDatapipelinesV1LaunchTemplateParametersResponse(
      environment: pulumi.Input.fromValue(
        GoogleCloudDatapipelinesV1RuntimeEnvironmentResponse.fromMap(
      ...
      transformNameMapping: pulumi.Input.fromValue(
