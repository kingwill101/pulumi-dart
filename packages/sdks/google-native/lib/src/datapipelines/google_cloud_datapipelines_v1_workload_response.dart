...
class GoogleCloudDatapipelinesV1WorkloadResponse {
  ...
  final pulumi.Input<GoogleCloudDatapipelinesV1LaunchTemplateRequestResponse>
  ...
  factory GoogleCloudDatapipelinesV1WorkloadResponse.fromMap(
    ...
    return GoogleCloudDatapipelinesV1WorkloadResponse(
      dataflowFlexTemplateRequest: pulumi.Input.fromValue(
      ...
      dataflowLaunchTemplateRequest: pulumi.Input.fromValue(
