...
class GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'flexrsGoal': ?pulumi.Input.mapOptionalInputValue<GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironmentFlexrsGoal, String>(flexrsGoal, (value) => value.value),
      'ipConfiguration': ?pulumi.Input.mapOptionalInputValue<GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironmentIpConfiguration, String>(ipConfiguration, (value) => value.value),
  ...
  factory GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment(
      ...
      flexrsGoal: map['flexrsGoal'] == null ? null : (GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironmentFlexrsGoal.fromValue(map['flexrsGoal'] as String)).input(),
      ipConfiguration: map['ipConfiguration'] == null ? null : (GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironmentIpConfiguration.fromValue(map['ipConfiguration'] as String)).input(),
