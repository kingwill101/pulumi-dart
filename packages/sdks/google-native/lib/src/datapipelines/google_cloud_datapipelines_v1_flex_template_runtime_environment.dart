...
class GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment {
  ...
  final GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironmentFlexrsGoal? flexrsGoal;
  /// Configuration for VM IPs.
  final GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironmentIpConfiguration? ipConfiguration;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'flexrsGoal': ?flexrsGoal == null ? null : flexrsGoal!.value,
  ...
  factory GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment(
      ...
      flexrsGoal: map['flexrsGoal'] == null ? null : GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironmentFlexrsGoal.fromValue(map['flexrsGoal'] as String),
      ipConfiguration: map['ipConfiguration'] == null ? null : GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironmentIpConfiguration.fromValue(map['ipConfiguration'] as String),
