...
class GoogleCloudDatapipelinesV1LaunchFlexTemplateParameterResponse {
  ...
  factory GoogleCloudDatapipelinesV1LaunchFlexTemplateParameterResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDatapipelinesV1LaunchFlexTemplateParameterResponse(
      ...
      environment: (GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironmentResponse.fromMap((map['environment'] as Map).cast<String, dynamic>())).input(),
      jobName: (map['jobName'] as String).input(),
      launchOptions: ((map['launchOptions'] as Map).cast<String, String>()).input(),
      parameters: ((map['parameters'] as Map).cast<String, String>()).input(),
      transformNameMappings: ((map['transformNameMappings'] as Map).cast<String, String>()).input(),
