...
class GoogleCloudDatapipelinesV1LaunchFlexTemplateParameterResponse {
  ...
  final pulumi.Input<GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironmentResponse> environment;
  ...
  const GoogleCloudDatapipelinesV1LaunchFlexTemplateParameterResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'environment': pulumi.Input.mapInputValue<GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironmentResponse, Map<String, dynamic>>(environment, (value) => value.toMap()),
      'jobName': jobName,
  ...
  factory GoogleCloudDatapipelinesV1LaunchFlexTemplateParameterResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDatapipelinesV1LaunchFlexTemplateParameterResponse(
      ...
      environment: pulumi.Input.fromValue(GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironmentResponse.fromMap((map['environment']! as Map).cast<String, dynamic>())),
      jobName: pulumi.Input.fromValue(map['jobName'] as String),
      launchOptions: pulumi.Input.fromValue((map['launchOptions'] as Map).cast<String, String>()),
      parameters: pulumi.Input.fromValue((map['parameters'] as Map).cast<String, String>()),
      transformNameMappings: pulumi.Input.fromValue((map['transformNameMappings'] as Map).cast<String, String>()),
