...
class PipelineArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'state': pulumi.Input.mapInputValue<PipelineState, String>(state, (value) => value.wireValue),
      'type': pulumi.Input.mapInputValue<PipelineType, String>(type, (value) => value.wireValue),
  ...
  factory PipelineArgs.fromMap(Map<String, dynamic> map) {
    return PipelineArgs(
      ...
      scheduleInfo: (() { final guardedValue = map['scheduleInfo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDatapipelinesV1ScheduleSpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      state: pulumi.Input.fromValue(PipelineState.fromValue(map['state']! as String)),
      type: pulumi.Input.fromValue(PipelineType.fromValue(map['type']! as String)),
      workload: (() { final guardedValue = map['workload']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDatapipelinesV1Workload.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
