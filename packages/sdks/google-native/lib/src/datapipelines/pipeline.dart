...
class Pipeline extends pulumi.CustomResource {
  ...
  Pipeline(
    ...
    this.pipelineSources = registerOutput<Map<String, String>>('pipelineSources');
    this.project = registerOutput<String>('project');
    this.scheduleInfo = registerOutput<GoogleCloudDatapipelinesV1ScheduleSpecResponse>('scheduleInfo');
    this.schedulerServiceAccountEmail = registerOutput<String>('schedulerServiceAccountEmail');
    this.state = registerOutput<String>('state');
    this.type = registerOutput<String>('type');
    this.workload = registerOutput<GoogleCloudDatapipelinesV1WorkloadResponse>('workload');
  }
}
