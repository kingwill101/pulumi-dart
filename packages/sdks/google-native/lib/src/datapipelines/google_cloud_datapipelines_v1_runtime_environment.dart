...
class GoogleCloudDatapipelinesV1RuntimeEnvironment {
  ...
  final pulumi.Input<GoogleCloudDatapipelinesV1RuntimeEnvironmentIpConfiguration>? ipConfiguration;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ipConfiguration': ?pulumi.Input.mapOptionalInputValue<GoogleCloudDatapipelinesV1RuntimeEnvironmentIpConfiguration, String>(ipConfiguration, (value) => value.wireValue),
  ...
  factory GoogleCloudDatapipelinesV1RuntimeEnvironment.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDatapipelinesV1RuntimeEnvironment(
      ...
      ipConfiguration: (() { final guardedValue = map['ipConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDatapipelinesV1RuntimeEnvironmentIpConfiguration.fromValue(guardedValue as String)); })(),
