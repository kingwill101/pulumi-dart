...
class GoogleCloudDatapipelinesV1RuntimeEnvironment {
  ...
  final GoogleCloudDatapipelinesV1RuntimeEnvironmentIpConfiguration? ipConfiguration;
  ...
  factory GoogleCloudDatapipelinesV1RuntimeEnvironment.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDatapipelinesV1RuntimeEnvironment(
      ...
      ipConfiguration: map['ipConfiguration'] == null ? null : GoogleCloudDatapipelinesV1RuntimeEnvironmentIpConfiguration.fromValue(map['ipConfiguration'] as String),
