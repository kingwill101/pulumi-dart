...
class GoogleCloudDatapipelinesV1RuntimeEnvironmentResponse {
  ...
  factory GoogleCloudDatapipelinesV1RuntimeEnvironmentResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDatapipelinesV1RuntimeEnvironmentResponse(
      additionalExperiments: ((map['additionalExperiments'] as List).cast<String>()).input(),
      additionalUserLabels: ((map['additionalUserLabels'] as Map).cast<String, String>()).input(),
      bypassTempDirValidation: (map['bypassTempDirValidation'] as bool).input(),
      enableStreamingEngine: (map['enableStreamingEngine'] as bool).input(),
      ...
      maxWorkers: (map['maxWorkers'] as int).input(),
