...
class GoogleCloudDatapipelinesV1RuntimeEnvironmentResponse {
  ...
  const GoogleCloudDatapipelinesV1RuntimeEnvironmentResponse({
  ...
  factory GoogleCloudDatapipelinesV1RuntimeEnvironmentResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDatapipelinesV1RuntimeEnvironmentResponse(
      additionalExperiments: pulumi.Input.fromValue((map['additionalExperiments'] as List).cast<String>()),
      additionalUserLabels: pulumi.Input.fromValue((map['additionalUserLabels'] as Map).cast<String, String>()),
      bypassTempDirValidation: pulumi.Input.fromValue(map['bypassTempDirValidation'] as bool),
      enableStreamingEngine: pulumi.Input.fromValue(map['enableStreamingEngine'] as bool),
