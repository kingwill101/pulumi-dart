...
class IosApp extends pulumi.CustomResource {
  ...
  /// Creates a new [IosApp].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [IosApp]. {@macro pulumi_firebase_v1beta1_ios_app_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  IosApp(String name, {IosAppArgs? args, pulumi.CustomResourceOptions? options})
    : super(
