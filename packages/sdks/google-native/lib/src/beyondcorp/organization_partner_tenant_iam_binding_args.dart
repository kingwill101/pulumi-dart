...
/// {@template pulumi_beyondcorp_v1_organization_partner_tenant_iam_binding_args_doc}
/// The set of arguments for OrganizationPartnerTenantIamBinding.
/// {@endtemplate}
/// {@macro pulumi_beyondcorp_v1_organization_partner_tenant_iam_binding_args_doc}
class OrganizationPartnerTenantIamBindingArgs {
  ...
  /// Creates a new [OrganizationPartnerTenantIamBindingArgs].
  ...
  const OrganizationPartnerTenantIamBindingArgs({
    this.condition,
  ...
  factory OrganizationPartnerTenantIamBindingArgs.fromMap(Map<String, dynamic> map) {
