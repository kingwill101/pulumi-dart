...
/// {@template pulumi_beyondcorp_v1_app_gateway_iam_member_args_doc}
/// The set of arguments for AppGatewayIamMember.
/// {@endtemplate}
/// {@macro pulumi_beyondcorp_v1_app_gateway_iam_member_args_doc}
class AppGatewayIamMemberArgs {
  ...
  /// Creates a new [AppGatewayIamMemberArgs].
  ...
  factory AppGatewayIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return AppGatewayIamMemberArgs(
