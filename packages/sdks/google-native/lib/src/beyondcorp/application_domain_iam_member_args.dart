...
/// {@template pulumi_beyondcorp_v1alpha_application_domain_iam_member_args_doc}
/// The set of arguments for ApplicationDomainIamMember.
/// {@endtemplate}
/// {@macro pulumi_beyondcorp_v1alpha_application_domain_iam_member_args_doc}
class ApplicationDomainIamMemberArgs {
  ...
  /// Creates a new [ApplicationDomainIamMemberArgs].
  ...
  const ApplicationDomainIamMemberArgs({
    this.condition,
  ...
  factory ApplicationDomainIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return ApplicationDomainIamMemberArgs(
