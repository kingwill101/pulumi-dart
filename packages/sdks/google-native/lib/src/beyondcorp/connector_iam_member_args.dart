...
/// {@template pulumi_beyondcorp_v1alpha_connector_iam_member_args_doc}
/// The set of arguments for ConnectorIamMember.
/// {@endtemplate}
/// {@macro pulumi_beyondcorp_v1alpha_connector_iam_member_args_doc}
class ConnectorIamMemberArgs {
  ...
  /// Creates a new [ConnectorIamMemberArgs].
  ...
  factory ConnectorIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return ConnectorIamMemberArgs(
