...
/// {@template pulumi_beyondcorp_v1alpha_application_iam_binding_args_doc}
/// The set of arguments for ApplicationIamBinding.
/// {@endtemplate}
/// {@macro pulumi_beyondcorp_v1alpha_application_iam_binding_args_doc}
class ApplicationIamBindingArgs {
  ...
  /// Creates a new [ApplicationIamBindingArgs].
  ...
  const ApplicationIamBindingArgs({
    this.condition,
  ...
  factory ApplicationIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return ApplicationIamBindingArgs(
