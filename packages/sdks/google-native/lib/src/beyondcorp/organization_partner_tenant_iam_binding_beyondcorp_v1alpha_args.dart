...
/// {@template pulumi_beyondcorp_v1alpha_organization_partner_tenant_iam_binding_beyondcorp_v1alpha_args_doc}
/// The set of arguments for OrganizationPartnerTenantIamBinding.
/// {@endtemplate}
/// {@macro pulumi_beyondcorp_v1alpha_organization_partner_tenant_iam_binding_beyondcorp_v1alpha_args_doc}
class OrganizationPartnerTenantIamBindingBeyondcorpV1alphaArgs {
  ...
  /// Creates a new [OrganizationPartnerTenantIamBindingBeyondcorpV1alphaArgs].
  ...
  const OrganizationPartnerTenantIamBindingBeyondcorpV1alphaArgs({
    this.condition,
  ...
  factory OrganizationPartnerTenantIamBindingBeyondcorpV1alphaArgs.fromMap(Map<String, dynamic> map) {
    return OrganizationPartnerTenantIamBindingBeyondcorpV1alphaArgs(
