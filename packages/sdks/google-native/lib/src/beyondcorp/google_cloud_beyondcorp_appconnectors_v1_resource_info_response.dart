...
class GoogleCloudBeyondcorpAppconnectorsV1ResourceInfoResponse {
  ...
  final pulumi.Input<
    List<GoogleCloudBeyondcorpAppconnectorsV1ResourceInfoResponse>
  >
  sub;
  ...
  factory GoogleCloudBeyondcorpAppconnectorsV1ResourceInfoResponse.fromMap(
    ...
    return GoogleCloudBeyondcorpAppconnectorsV1ResourceInfoResponse(
      ...
      sub: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GoogleCloudBeyondcorpAppconnectorsV1ResourceInfoResponse
        >(
          map['sub']!,
          (value) =>
              GoogleCloudBeyondcorpAppconnectorsV1ResourceInfoResponse.fromMap(
