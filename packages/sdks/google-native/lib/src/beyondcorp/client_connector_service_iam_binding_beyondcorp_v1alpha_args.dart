...
/// {@template pulumi_beyondcorp_v1alpha_client_connector_service_iam_binding_beyondcorp_v1alpha_args_doc}
/// The set of arguments for ClientConnectorServiceIamBinding.
/// {@endtemplate}
/// {@macro pulumi_beyondcorp_v1alpha_client_connector_service_iam_binding_beyondcorp_v1alpha_args_doc}
class ClientConnectorServiceIamBindingBeyondcorpV1alphaArgs {
  ...
  /// Creates a new [ClientConnectorServiceIamBindingBeyondcorpV1alphaArgs].
  ...
  const ClientConnectorServiceIamBindingBeyondcorpV1alphaArgs({
    this.condition,
  ...
  factory ClientConnectorServiceIamBindingBeyondcorpV1alphaArgs.fromMap(Map<String, dynamic> map) {
    return ClientConnectorServiceIamBindingBeyondcorpV1alphaArgs(
