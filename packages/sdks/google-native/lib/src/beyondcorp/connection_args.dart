...
class ConnectionArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'project': ?project,
      'requestId': ?requestId,
      'type': pulumi.Input.mapInputValue<ConnectionType, String>(type, (value) => value.wireValue),
    };
  }

  factory ConnectionArgs.fromMap(Map<String, dynamic> map) {
    return ConnectionArgs(
      applicationEndpoint: pulumi.Input.fromValue(ApplicationEndpoint.fromMap((map['applicationEndpoint']! as Map).cast<String, dynamic>())),
      ...
      gateway: (() { final guardedValue = map['gateway']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Gateway.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      type: pulumi.Input.fromValue(ConnectionType.fromValue(map['type']! as String)),
    );
  }
}
