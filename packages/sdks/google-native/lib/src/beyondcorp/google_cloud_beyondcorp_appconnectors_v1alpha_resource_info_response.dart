...
class GoogleCloudBeyondcorpAppconnectorsV1alphaResourceInfoResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'resource': resource,
      'status': status,
      'sub': pulumi.Input.encodeList<GoogleCloudBeyondcorpAppconnectorsV1alphaResourceInfoResponse, Map<String, dynamic>>(sub, (value) => value.toMap()),
      'time': time,
    };
  }
  ...
  factory GoogleCloudBeyondcorpAppconnectorsV1alphaResourceInfoResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudBeyondcorpAppconnectorsV1alphaResourceInfoResponse(
      ...
      sub: pulumi.Input.decodeList<GoogleCloudBeyondcorpAppconnectorsV1alphaResourceInfoResponse>(map['sub'], (value) => GoogleCloudBeyondcorpAppconnectorsV1alphaResourceInfoResponse.fromMap((value as Map).cast<String, dynamic>())),
