...
/// {@template pulumi_beyondcorp_v1_app_connection_iam_member_args_doc}
/// The set of arguments for AppConnectionIamMember.
/// {@endtemplate}
/// {@macro pulumi_beyondcorp_v1_app_connection_iam_member_args_doc}
class AppConnectionIamMemberArgs {
  ...
  /// Creates a new [AppConnectionIamMemberArgs].
  ...
  const AppConnectionIamMemberArgs({
    this.condition,
