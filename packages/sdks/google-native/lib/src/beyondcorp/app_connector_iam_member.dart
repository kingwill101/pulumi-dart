...
import 'app_connector_iam_member_args.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class AppConnectorIamMember extends pulumi.CustomResource {
  ...
  /// Creates a new [AppConnectorIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [AppConnectorIamMember]. {@macro pulumi_beyondcorp_v1_app_connector_iam_member_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  AppConnectorIamMember(
    String name, {
    AppConnectorIamMemberArgs? args,
