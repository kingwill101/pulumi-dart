...
/// {@template pulumi_beyondcorp_v1_app_connection_iam_binding_args_doc}
/// The set of arguments for AppConnectionIamBinding.
/// {@endtemplate}
/// {@macro pulumi_beyondcorp_v1_app_connection_iam_binding_args_doc}
class AppConnectionIamBindingArgs {
  ...
  /// Creates a new [AppConnectionIamBindingArgs].
  ...
  const AppConnectionIamBindingArgs({
    this.condition,
  ...
  factory AppConnectionIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return AppConnectionIamBindingArgs(
