...
class AppConnectionBeyondcorpV1alphaArgs {
  ...
  const AppConnectionBeyondcorpV1alphaArgs({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'project': ?project,
      'requestId': ?requestId,
      'type': pulumi.Input.mapInputValue<AppConnectionTypeBeyondcorpV1alpha, String>(type, (value) => value.wireValue),
    };
  }
  ...
  factory AppConnectionBeyondcorpV1alphaArgs.fromMap(Map<String, dynamic> map) {
    return AppConnectionBeyondcorpV1alphaArgs(
      ...
      applicationEndpoint: pulumi.Input.fromValue(GoogleCloudBeyondcorpAppconnectionsV1alphaAppConnectionApplicationEndpoint.fromMap((map['applicationEndpoint']! as Map).cast<String, dynamic>())),
      ...
      gateway: (() { final guardedValue = map['gateway']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudBeyondcorpAppconnectionsV1alphaAppConnectionGateway.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      type: pulumi.Input.fromValue(AppConnectionTypeBeyondcorpV1alpha.fromValue(map['type']! as String)),
    );
  }
}
