...
class ProxyConfig extends pulumi.CustomResource {
  ...
  ProxyConfig(
    ...
    this.encryptionInfo = registerOutput<GoogleCloudBeyondcorpPartnerservicesV1alphaEncryptionInfoResponse>('encryptionInfo');
    ...
    this.routingInfo = registerOutput<GoogleCloudBeyondcorpPartnerservicesV1alphaRoutingInfoResponse>('routingInfo');
    this.transportInfo = registerOutput<GoogleCloudBeyondcorpPartnerservicesV1alphaTransportInfoResponse>('transportInfo');
