...
class GetAppConnectionBeyondcorpV1alphaResult {
  /// Address of the remote application endpoint for the BeyondCorp AppConnection.
  final GoogleCloudBeyondcorpAppconnectionsV1alphaAppConnectionApplicationEndpointResponse applicationEndpoint;
  ...
  final GoogleCloudBeyondcorpAppconnectionsV1alphaAppConnectionGatewayResponse gateway;
  ...
  /// Creates a new [GetAppConnectionBeyondcorpV1alphaResult].
  ...
  const GetAppConnectionBeyondcorpV1alphaResult({
  ...
  factory GetAppConnectionBeyondcorpV1alphaResult.fromMap(Map<String, dynamic> map) {
    return GetAppConnectionBeyondcorpV1alphaResult(
      applicationEndpoint: GoogleCloudBeyondcorpAppconnectionsV1alphaAppConnectionApplicationEndpointResponse.fromMap((map['applicationEndpoint']! as Map).cast<String, dynamic>()),
      connectors: (map['connectors'] as List).cast<String>(),
      createTime: map['createTime'] as String,
      displayName: map['displayName'] as String,
      gateway: GoogleCloudBeyondcorpAppconnectionsV1alphaAppConnectionGatewayResponse.fromMap((map['gateway']! as Map).cast<String, dynamic>()),
