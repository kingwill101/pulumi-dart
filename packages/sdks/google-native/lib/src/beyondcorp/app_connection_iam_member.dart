...
class AppConnectionIamMember extends pulumi.CustomResource {
  ...
  /// Creates a new [AppConnectionIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [AppConnectionIamMember]. {@macro pulumi_beyondcorp_v1_app_connection_iam_member_args_doc}
