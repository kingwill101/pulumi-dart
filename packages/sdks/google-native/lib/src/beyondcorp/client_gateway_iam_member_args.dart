...
/// {@template pulumi_beyondcorp_v1_client_gateway_iam_member_args_doc}
/// The set of arguments for ClientGatewayIamMember.
/// {@endtemplate}
/// {@macro pulumi_beyondcorp_v1_client_gateway_iam_member_args_doc}
class ClientGatewayIamMemberArgs {
  ...
  /// Creates a new [ClientGatewayIamMemberArgs].
  ...
  const ClientGatewayIamMemberArgs({
    this.condition,
  ...
  factory ClientGatewayIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return ClientGatewayIamMemberArgs(
