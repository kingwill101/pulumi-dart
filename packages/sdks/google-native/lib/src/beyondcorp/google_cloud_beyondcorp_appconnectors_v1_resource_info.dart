...
class GoogleCloudBeyondcorpAppconnectorsV1ResourceInfo {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'sub': ?sub == null ? null : pulumi.Input.encodeList<GoogleCloudBeyondcorpAppconnectorsV1ResourceInfo, Map<String, dynamic>>(sub!, (value) => value.toMap()),
      'time': ?time,
    };
  }
  ...
  factory GoogleCloudBeyondcorpAppconnectorsV1ResourceInfo.fromMap(Map<String, dynamic> map) {
    return GoogleCloudBeyondcorpAppconnectorsV1ResourceInfo(
      ...
      status: map['status'] == null ? null : GoogleCloudBeyondcorpAppconnectorsV1ResourceInfoStatus.fromValue(map['status'] as String),
      sub: map['sub'] == null ? null : pulumi.Input.decodeList<GoogleCloudBeyondcorpAppconnectorsV1ResourceInfo>(map['sub'], (value) => GoogleCloudBeyondcorpAppconnectorsV1ResourceInfo.fromMap((value as Map).cast<String, dynamic>())),
