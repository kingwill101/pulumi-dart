...
/// {@template pulumi_beyondcorp_v1alpha_client_connector_service_iam_member_beyondcorp_v1alpha_args_doc}
/// The set of arguments for ClientConnectorServiceIamMember.
/// {@endtemplate}
/// {@macro pulumi_beyondcorp_v1alpha_client_connector_service_iam_member_beyondcorp_v1alpha_args_doc}
class ClientConnectorServiceIamMemberBeyondcorpV1alphaArgs {
  ...
  /// Creates a new [ClientConnectorServiceIamMemberBeyondcorpV1alphaArgs].
  ...
  const ClientConnectorServiceIamMemberBeyondcorpV1alphaArgs({
    this.condition,
  ...
  factory ClientConnectorServiceIamMemberBeyondcorpV1alphaArgs.fromMap(Map<String, dynamic> map) {
    return ClientConnectorServiceIamMemberBeyondcorpV1alphaArgs(
