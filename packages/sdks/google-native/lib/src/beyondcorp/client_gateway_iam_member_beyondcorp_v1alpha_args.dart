...
/// {@template pulumi_beyondcorp_v1alpha_client_gateway_iam_member_beyondcorp_v1alpha_args_doc}
/// The set of arguments for ClientGatewayIamMember.
/// {@endtemplate}
/// {@macro pulumi_beyondcorp_v1alpha_client_gateway_iam_member_beyondcorp_v1alpha_args_doc}
class ClientGatewayIamMemberBeyondcorpV1alphaArgs {
  ...
  /// Creates a new [ClientGatewayIamMemberBeyondcorpV1alphaArgs].
  ...
  const ClientGatewayIamMemberBeyondcorpV1alphaArgs({
    this.condition,
  ...
  factory ClientGatewayIamMemberBeyondcorpV1alphaArgs.fromMap(Map<String, dynamic> map) {
    return ClientGatewayIamMemberBeyondcorpV1alphaArgs(
