...
/// {@template pulumi_beyondcorp_v1_organization_partner_tenant_browser_dlp_rule_iam_binding_args_doc}
/// The set of arguments for OrganizationPartnerTenantBrowserDlpRuleIamBinding.
/// {@endtemplate}
/// {@macro pulumi_beyondcorp_v1_organization_partner_tenant_browser_dlp_rule_iam_binding_args_doc}
class OrganizationPartnerTenantBrowserDlpRuleIamBindingArgs {
  ...
  /// Creates a new [OrganizationPartnerTenantBrowserDlpRuleIamBindingArgs].
  ...
  const OrganizationPartnerTenantBrowserDlpRuleIamBindingArgs({
    this.condition,
  ...
  factory OrganizationPartnerTenantBrowserDlpRuleIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return OrganizationPartnerTenantBrowserDlpRuleIamBindingArgs(
