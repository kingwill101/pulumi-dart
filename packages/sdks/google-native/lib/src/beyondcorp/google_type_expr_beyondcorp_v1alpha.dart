...
class GoogleTypeExprBeyondcorpV1alpha {
  ...
  /// Creates a new [GoogleTypeExprBeyondcorpV1alpha].
  ...
  const GoogleTypeExprBeyondcorpV1alpha({
    this.description,
    this.expression,
    this.location,
    this.title,
  ...
  factory GoogleTypeExprBeyondcorpV1alpha.fromMap(Map<String, dynamic> map) {
    return GoogleTypeExprBeyondcorpV1alpha(
