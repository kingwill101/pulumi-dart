...
/// {@template pulumi_beyondcorp_v1alpha_app_connection_iam_binding_beyondcorp_v1alpha_args_doc}
/// The set of arguments for AppConnectionIamBinding.
/// {@endtemplate}
/// {@macro pulumi_beyondcorp_v1alpha_app_connection_iam_binding_beyondcorp_v1alpha_args_doc}
class AppConnectionIamBindingBeyondcorpV1alphaArgs {
  ...
  /// Creates a new [AppConnectionIamBindingBeyondcorpV1alphaArgs].
  ...
  const AppConnectionIamBindingBeyondcorpV1alphaArgs({
    this.condition,
  ...
  factory AppConnectionIamBindingBeyondcorpV1alphaArgs.fromMap(Map<String, dynamic> map) {
    return AppConnectionIamBindingBeyondcorpV1alphaArgs(
