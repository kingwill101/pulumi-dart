...
/// {@template pulumi_beyondcorp_v1alpha_client_gateway_iam_binding_beyondcorp_v1alpha_args_doc}
/// The set of arguments for ClientGatewayIamBinding.
/// {@endtemplate}
/// {@macro pulumi_beyondcorp_v1alpha_client_gateway_iam_binding_beyondcorp_v1alpha_args_doc}
class ClientGatewayIamBindingBeyondcorpV1alphaArgs {
  ...
  /// Creates a new [ClientGatewayIamBindingBeyondcorpV1alphaArgs].
  ...
  const ClientGatewayIamBindingBeyondcorpV1alphaArgs({
    this.condition,
  ...
  factory ClientGatewayIamBindingBeyondcorpV1alphaArgs.fromMap(Map<String, dynamic> map) {
    return ClientGatewayIamBindingBeyondcorpV1alphaArgs(
