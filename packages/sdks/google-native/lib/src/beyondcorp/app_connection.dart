...
class AppConnection extends pulumi.CustomResource {
  ...
  AppConnection(
    ...
    this.applicationEndpoint = registerOutput<GoogleCloudBeyondcorpAppconnectionsV1AppConnectionApplicationEndpointResponse>('applicationEndpoint');
    this.connectors = registerOutput<List<String>>('connectors');
    this.createTime = registerOutput<String>('createTime');
    this.displayName = registerOutput<String>('displayName');
    this.gateway = registerOutput<GoogleCloudBeyondcorpAppconnectionsV1AppConnectionGatewayResponse>('gateway');
