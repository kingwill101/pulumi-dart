...
/// {@template pulumi_beyondcorp_v1_organization_partner_tenant_browser_dlp_rule_iam_member_args_doc}
/// The set of arguments for OrganizationPartnerTenantBrowserDlpRuleIamMember.
/// {@endtemplate}
/// {@macro pulumi_beyondcorp_v1_organization_partner_tenant_browser_dlp_rule_iam_member_args_doc}
class OrganizationPartnerTenantBrowserDlpRuleIamMemberArgs {
  ...
  /// Creates a new [OrganizationPartnerTenantBrowserDlpRuleIamMemberArgs].
  ...
  const OrganizationPartnerTenantBrowserDlpRuleIamMemberArgs({
    this.condition,
  ...
  factory OrganizationPartnerTenantBrowserDlpRuleIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return OrganizationPartnerTenantBrowserDlpRuleIamMemberArgs(
