...
class GoogleIamV1AuditConfigBeyondcorpV1alpha {
  ...
  final pulumi.Input<List<GoogleIamV1AuditLogConfigBeyondcorpV1alpha>>?
  auditLogConfigs;
  ...
  GoogleIamV1AuditConfigBeyondcorpV1alpha({this.auditLogConfigs, this.service});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'auditLogConfigs':
          ?pulumi.Input.mapOptionalInputValue<
            List<GoogleIamV1AuditLogConfigBeyondcorpV1alpha>,
