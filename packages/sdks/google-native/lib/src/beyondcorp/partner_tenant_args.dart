...
class PartnerTenantArgs {
  ...
  factory PartnerTenantArgs.fromMap(Map<String, dynamic> map) {
    return PartnerTenantArgs(
      ...
      group: (() { final guardedValue = map['group']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudBeyondcorpPartnerservicesV1alphaGroup.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      organizationId: pulumi.Input.fromValue(map['organizationId'] as String),
      partnerMetadata: (() { final guardedValue = map['partnerMetadata']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudBeyondcorpPartnerservicesV1alphaPartnerMetadata.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
