...
class BrowserDlpRuleArgs {
  ...
  factory BrowserDlpRuleArgs.fromMap(Map<String, dynamic> map) {
    return BrowserDlpRuleArgs(
      group: pulumi.Input.fromValue(GoogleCloudBeyondcorpPartnerservicesV1alphaGroup.fromMap((map['group']! as Map).cast<String, dynamic>())),
      organizationId: pulumi.Input.fromValue(map['organizationId'] as String),
      partnerTenantId: pulumi.Input.fromValue(map['partnerTenantId'] as String),
      requestId: (() { final guardedValue = map['requestId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ruleSetting: pulumi.Input.fromValue(GoogleCloudBeyondcorpPartnerservicesV1alphaRuleSetting.fromMap((map['ruleSetting']! as Map).cast<String, dynamic>())),
    );
  }
}
