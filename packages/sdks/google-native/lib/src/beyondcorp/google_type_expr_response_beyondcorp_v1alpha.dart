...
class GoogleTypeExprResponseBeyondcorpV1alpha {
  ...
  /// Creates a new [GoogleTypeExprResponseBeyondcorpV1alpha].
  ...
  const GoogleTypeExprResponseBeyondcorpV1alpha({
  ...
  factory GoogleTypeExprResponseBeyondcorpV1alpha.fromMap(Map<String, dynamic> map) {
    return GoogleTypeExprResponseBeyondcorpV1alpha(
