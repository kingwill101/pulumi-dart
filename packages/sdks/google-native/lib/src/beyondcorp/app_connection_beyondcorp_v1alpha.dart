...
class AppConnectionBeyondcorpV1alpha extends pulumi.CustomResource {
  ...
  AppConnectionBeyondcorpV1alpha(
    ...
    this.applicationEndpoint = registerOutput<GoogleCloudBeyondcorpAppconnectionsV1alphaAppConnectionApplicationEndpointResponse>('applicationEndpoint');
    this.connectors = registerOutput<List<String>>('connectors');
    this.createTime = registerOutput<String>('createTime');
    this.displayName = registerOutput<String>('displayName');
    this.gateway = registerOutput<GoogleCloudBeyondcorpAppconnectionsV1alphaAppConnectionGatewayResponse>('gateway');
