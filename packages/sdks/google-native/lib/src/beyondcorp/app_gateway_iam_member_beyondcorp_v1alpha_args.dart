...
/// {@template pulumi_beyondcorp_v1alpha_app_gateway_iam_member_beyondcorp_v1alpha_args_doc}
/// The set of arguments for AppGatewayIamMember.
/// {@endtemplate}
/// {@macro pulumi_beyondcorp_v1alpha_app_gateway_iam_member_beyondcorp_v1alpha_args_doc}
class AppGatewayIamMemberBeyondcorpV1alphaArgs {
  ...
  /// Creates a new [AppGatewayIamMemberBeyondcorpV1alphaArgs].
  ...
  const AppGatewayIamMemberBeyondcorpV1alphaArgs({
    this.condition,
  ...
  factory AppGatewayIamMemberBeyondcorpV1alphaArgs.fromMap(Map<String, dynamic> map) {
    return AppGatewayIamMemberBeyondcorpV1alphaArgs(
