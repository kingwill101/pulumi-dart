...
/// {@template pulumi_beyondcorp_v1_app_gateway_iam_binding_args_doc}
/// The set of arguments for AppGatewayIamBinding.
/// {@endtemplate}
/// {@macro pulumi_beyondcorp_v1_app_gateway_iam_binding_args_doc}
class AppGatewayIamBindingArgs {
  ...
  /// Creates a new [AppGatewayIamBindingArgs].
  ...
  const AppGatewayIamBindingArgs({
    this.condition,
  ...
  factory AppGatewayIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return AppGatewayIamBindingArgs(
