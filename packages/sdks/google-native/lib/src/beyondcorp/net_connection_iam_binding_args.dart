...
/// {@template pulumi_beyondcorp_v1alpha_net_connection_iam_binding_args_doc}
/// The set of arguments for NetConnectionIamBinding.
/// {@endtemplate}
/// {@macro pulumi_beyondcorp_v1alpha_net_connection_iam_binding_args_doc}
class NetConnectionIamBindingArgs {
  ...
  /// Creates a new [NetConnectionIamBindingArgs].
  ...
  const NetConnectionIamBindingArgs({
    this.condition,
