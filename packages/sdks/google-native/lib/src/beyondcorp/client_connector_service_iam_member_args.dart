...
/// {@template pulumi_beyondcorp_v1_client_connector_service_iam_member_args_doc}
/// The set of arguments for ClientConnectorServiceIamMember.
/// {@endtemplate}
/// {@macro pulumi_beyondcorp_v1_client_connector_service_iam_member_args_doc}
class ClientConnectorServiceIamMemberArgs {
  ...
  /// Creates a new [ClientConnectorServiceIamMemberArgs].
  ...
  const ClientConnectorServiceIamMemberArgs({
    this.condition,
  ...
  factory ClientConnectorServiceIamMemberArgs.fromMap(Map<String, dynamic> map) {
