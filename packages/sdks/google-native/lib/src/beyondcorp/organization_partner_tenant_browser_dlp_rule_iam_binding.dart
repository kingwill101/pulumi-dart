...
class OrganizationPartnerTenantBrowserDlpRuleIamBinding
  ...
  /// Creates a new [OrganizationPartnerTenantBrowserDlpRuleIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [OrganizationPartnerTenantBrowserDlpRuleIamBinding]. {@macro pulumi_beyondcorp_v1_organization_partner_tenant_browser_dlp_rule_iam_binding_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  OrganizationPartnerTenantBrowserDlpRuleIamBinding(
    String name, {
