...
class GetConnectionResult {
  ...
  factory GetConnectionResult.fromMap(Map<String, dynamic> map) {
    return GetConnectionResult(
      applicationEndpoint: ApplicationEndpointResponse.fromMap((map['applicationEndpoint'] as Map).cast<String, dynamic>()),
      connectors: (map['connectors'] as List).cast<String>(),
      createTime: map['createTime'] as String,
      displayName: map['displayName'] as String,
      gateway: GatewayResponse.fromMap((map['gateway'] as Map).cast<String, dynamic>()),
