...
/// {@template pulumi_beyondcorp_v1_organization_partner_tenant_proxy_config_iam_member_args_doc}
/// The set of arguments for OrganizationPartnerTenantProxyConfigIamMember.
/// {@endtemplate}
/// {@macro pulumi_beyondcorp_v1_organization_partner_tenant_proxy_config_iam_member_args_doc}
class OrganizationPartnerTenantProxyConfigIamMemberArgs {
  ...
  /// Creates a new [OrganizationPartnerTenantProxyConfigIamMemberArgs].
  ...
  const OrganizationPartnerTenantProxyConfigIamMemberArgs({
    this.condition,
  ...
  factory OrganizationPartnerTenantProxyConfigIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return OrganizationPartnerTenantProxyConfigIamMemberArgs(
