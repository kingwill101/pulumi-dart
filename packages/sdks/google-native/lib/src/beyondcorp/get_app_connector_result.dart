...
class GetAppConnectorResult {
  ...
  final GoogleCloudBeyondcorpAppconnectorsV1AppConnectorPrincipalInfoResponse principalInfo;
  ...
  factory GetAppConnectorResult.fromMap(Map<String, dynamic> map) {
    return GetAppConnectorResult(
      ...
      principalInfo: GoogleCloudBeyondcorpAppconnectorsV1AppConnectorPrincipalInfoResponse.fromMap((map['principalInfo'] as Map).cast<String, dynamic>()),
      resourceInfo: GoogleCloudBeyondcorpAppconnectorsV1ResourceInfoResponse.fromMap((map['resourceInfo'] as Map).cast<String, dynamic>()),
