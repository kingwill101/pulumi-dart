...
/// {@template pulumi_beyondcorp_v1_client_connector_service_iam_binding_args_doc}
/// The set of arguments for ClientConnectorServiceIamBinding.
/// {@endtemplate}
/// {@macro pulumi_beyondcorp_v1_client_connector_service_iam_binding_args_doc}
class ClientConnectorServiceIamBindingArgs {
  ...
  /// Creates a new [ClientConnectorServiceIamBindingArgs].
  ...
  const ClientConnectorServiceIamBindingArgs({
    this.condition,
  ...
  factory ClientConnectorServiceIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return ClientConnectorServiceIamBindingArgs(
