...
/// {@template pulumi_beyondcorp_v1_organization_partner_tenant_proxy_config_iam_binding_args_doc}
/// The set of arguments for OrganizationPartnerTenantProxyConfigIamBinding.
/// {@endtemplate}
/// {@macro pulumi_beyondcorp_v1_organization_partner_tenant_proxy_config_iam_binding_args_doc}
class OrganizationPartnerTenantProxyConfigIamBindingArgs {
  ...
  /// Creates a new [OrganizationPartnerTenantProxyConfigIamBindingArgs].
  ...
  const OrganizationPartnerTenantProxyConfigIamBindingArgs({
    this.condition,
  ...
  factory OrganizationPartnerTenantProxyConfigIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return OrganizationPartnerTenantProxyConfigIamBindingArgs(
