...
/// {@template pulumi_beyondcorp_v1alpha_app_gateway_iam_binding_beyondcorp_v1alpha_args_doc}
/// The set of arguments for AppGatewayIamBinding.
/// {@endtemplate}
/// {@macro pulumi_beyondcorp_v1alpha_app_gateway_iam_binding_beyondcorp_v1alpha_args_doc}
class AppGatewayIamBindingBeyondcorpV1alphaArgs {
  ...
  /// Creates a new [AppGatewayIamBindingBeyondcorpV1alphaArgs].
  ...
  const AppGatewayIamBindingBeyondcorpV1alphaArgs({
    this.condition,
  ...
  factory AppGatewayIamBindingBeyondcorpV1alphaArgs.fromMap(Map<String, dynamic> map) {
    return AppGatewayIamBindingBeyondcorpV1alphaArgs(
