...
class Connector extends pulumi.CustomResource {
  ...
  Connector(
    ...
    principalInfo = registerOutput<PrincipalInfoResponse>('principalInfo', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return PrincipalInfoResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    project = registerOutput<String>('project');
    requestId = registerOutput<String?>('requestId');
    resourceInfo = registerOutput<ResourceInfoResponse>('resourceInfo', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ResourceInfoResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
