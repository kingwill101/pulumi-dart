...
class AppConnectorArgs {
  ...
  factory AppConnectorArgs.fromMap(Map<String, dynamic> map) {
    return AppConnectorArgs(
      ...
      principalInfo: pulumi.Input.fromValue(GoogleCloudBeyondcorpAppconnectorsV1AppConnectorPrincipalInfo.fromMap((map['principalInfo']! as Map).cast<String, dynamic>())),
      project: (() { final guardedValue = map['project']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      requestId: (() { final guardedValue = map['requestId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      resourceInfo: (() { final guardedValue = map['resourceInfo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudBeyondcorpAppconnectorsV1ResourceInfo.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
