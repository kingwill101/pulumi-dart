...
class AppGatewayArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'hostType': pulumi.Input.mapInputValue<AppGatewayHostType, String>(
        hostType,
      ...
      'project': ?project,
      'requestId': ?requestId,
      'type': pulumi.Input.mapInputValue<AppGatewayType, String>(
        type,
        (value) => value.wireValue,
      ),
    };
  ...
  factory AppGatewayArgs.fromMap(Map<String, dynamic> map) {
    return AppGatewayArgs(
      appGatewayId: (() {
        final guardedValue = map['appGatewayId'];
      ...
      hostType: pulumi.Input.fromValue(
        AppGatewayHostType.fromValue(map['hostType']! as String),
      ),
      labels: (() {
      ...
      type: pulumi.Input.fromValue(
        AppGatewayType.fromValue(map['type']! as String),
      ),
    );
  }
}
