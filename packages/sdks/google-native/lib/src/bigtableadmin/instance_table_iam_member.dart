...
import 'instance_table_iam_member_args.dart';

/// Sets the access control policy on a Table or Backup resource. Replaces any existing policy.
class InstanceTableIamMember extends pulumi.CustomResource {
  ...
  /// Creates a new [InstanceTableIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [InstanceTableIamMember]. {@macro pulumi_bigtableadmin_v2_instance_table_iam_member_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  InstanceTableIamMember(
    String name, {
    InstanceTableIamMemberArgs? args,
