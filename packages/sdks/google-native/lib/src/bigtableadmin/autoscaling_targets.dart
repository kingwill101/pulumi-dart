...
class AutoscalingTargets {
  ...
  factory AutoscalingTargets.fromMap(Map<String, dynamic> map) {
    return AutoscalingTargets(
      cpuUtilizationPercent: (() { final guardedValue = map['cpuUtilizationPercent']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      storageUtilizationGibPerNode: (() { final guardedValue = map['storageUtilizationGibPerNode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
    );
  }
}
