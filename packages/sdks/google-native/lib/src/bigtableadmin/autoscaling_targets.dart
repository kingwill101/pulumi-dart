...
class AutoscalingTargets {
  ...
  factory AutoscalingTargets.fromMap(Map<String, dynamic> map) {
    return AutoscalingTargets(
      cpuUtilizationPercent: map['cpuUtilizationPercent'] == null ? null : map['cpuUtilizationPercent'] as int,
      storageUtilizationGibPerNode: map['storageUtilizationGibPerNode'] == null ? null : map['storageUtilizationGibPerNode'] as int,
    );
  }
}
