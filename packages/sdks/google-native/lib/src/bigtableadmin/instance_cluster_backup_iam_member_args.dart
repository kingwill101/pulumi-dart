...
/// {@template pulumi_bigtableadmin_v2_instance_cluster_backup_iam_member_args_doc}
/// The set of arguments for InstanceClusterBackupIamMember.
/// {@endtemplate}
/// {@macro pulumi_bigtableadmin_v2_instance_cluster_backup_iam_member_args_doc}
class InstanceClusterBackupIamMemberArgs {
  ...
  /// Creates a new [InstanceClusterBackupIamMemberArgs].
  ...
  const InstanceClusterBackupIamMemberArgs({
    this.condition,
  ...
  factory InstanceClusterBackupIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return InstanceClusterBackupIamMemberArgs(
