...
class AppProfileArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'priority': ?pulumi.Input.mapOptionalInputValue<AppProfilePriority, String>(priority, (value) => value.wireValue),
      'project': ?project,
  ...
  factory AppProfileArgs.fromMap(Map<String, dynamic> map) {
    return AppProfileArgs(
      ...
      multiClusterRoutingUseAny: (() { final guardedValue = map['multiClusterRoutingUseAny']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MultiClusterRoutingUseAny.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      priority: (() { final guardedValue = map['priority']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AppProfilePriority.fromValue(guardedValue as String)); })(),
      project: (() { final guardedValue = map['project']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      singleClusterRouting: (() { final guardedValue = map['singleClusterRouting']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SingleClusterRouting.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      standardIsolation: (() { final guardedValue = map['standardIsolation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(StandardIsolation.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
