...
/// {@template pulumi_bigtableadmin_v2_instance_table_iam_member_args_doc}
/// The set of arguments for InstanceTableIamMember.
/// {@endtemplate}
/// {@macro pulumi_bigtableadmin_v2_instance_table_iam_member_args_doc}
class InstanceTableIamMemberArgs {
  ...
  /// Creates a new [InstanceTableIamMemberArgs].
  ...
  const InstanceTableIamMemberArgs({
    this.condition,
  ...
  factory InstanceTableIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return InstanceTableIamMemberArgs(
