...
/// {@template pulumi_bigtableadmin_v2_instance_cluster_backup_iam_binding_args_doc}
/// The set of arguments for InstanceClusterBackupIamBinding.
/// {@endtemplate}
/// {@macro pulumi_bigtableadmin_v2_instance_cluster_backup_iam_binding_args_doc}
class InstanceClusterBackupIamBindingArgs {
  ...
  /// Creates a new [InstanceClusterBackupIamBindingArgs].
  ...
  const InstanceClusterBackupIamBindingArgs({
    this.condition,
  ...
  factory InstanceClusterBackupIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return InstanceClusterBackupIamBindingArgs(
