...
/// {@template pulumi_bigtableadmin_v2_instance_table_iam_binding_args_doc}
/// The set of arguments for InstanceTableIamBinding.
/// {@endtemplate}
/// {@macro pulumi_bigtableadmin_v2_instance_table_iam_binding_args_doc}
class InstanceTableIamBindingArgs {
  ...
  /// Creates a new [InstanceTableIamBindingArgs].
  ...
  const InstanceTableIamBindingArgs({
    this.condition,
  ...
  factory InstanceTableIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return InstanceTableIamBindingArgs(
