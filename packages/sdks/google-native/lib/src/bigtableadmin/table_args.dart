...
class TableArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'changeStreamConfig': ?pulumi.Input.mapOptionalInputValue<ChangeStreamConfig, Map<String, dynamic>>(changeStreamConfig, (value) => value.toMap()),
      'columnFamilies': ?columnFamilies,
      'deletionProtection': ?deletionProtection,
      'granularity': ?pulumi.Input.mapOptionalInputValue<TableGranularity, String>(granularity, (value) => value.wireValue),
      'initialSplits': ?pulumi.Input.mapOptionalInputValue<List<Split>, List<Map<String, dynamic>>>(initialSplits, (value) => pulumi.Input.encodeList<Split, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory TableArgs.fromMap(Map<String, dynamic> map) {
    return TableArgs(
      changeStreamConfig: (() { final guardedValue = map['changeStreamConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ChangeStreamConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      columnFamilies: (() { final guardedValue = map['columnFamilies']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      deletionProtection: (() { final guardedValue = map['deletionProtection']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      granularity: (() { final guardedValue = map['granularity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TableGranularity.fromValue(guardedValue as String)); })(),
      initialSplits: (() { final guardedValue = map['initialSplits']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<Split>(guardedValue, (value) => Split.fromMap((value as Map).cast<String, dynamic>()))); })(),
