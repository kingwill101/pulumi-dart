...
class ClusterArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'clusterId': clusterId,
      'defaultStorageType': ?pulumi.Input.mapOptionalInputValue<ClusterDefaultStorageType, String>(defaultStorageType, (value) => value.wireValue),
  ...
  factory ClusterArgs.fromMap(Map<String, dynamic> map) {
    return ClusterArgs(
      ...
      defaultStorageType: (() { final guardedValue = map['defaultStorageType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterDefaultStorageType.fromValue(guardedValue as String)); })(),
      ...
      serveNodes: (() { final guardedValue = map['serveNodes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
    );
  }
}
