...
class Backup extends pulumi.CustomResource {
  ...
  Backup(
    ...
    this.clusterMetadata = registerOutput<ClusterMetadataResponse>('clusterMetadata');
    this.completeTime = registerOutput<String>('completeTime');
    this.configBackupSizeBytes = registerOutput<String>('configBackupSizeBytes');
    ...
    this.selectedApplications = registerOutput<NamespacedNamesResponse>('selectedApplications');
    this.selectedNamespaces = registerOutput<NamespacesResponse>('selectedNamespaces');
