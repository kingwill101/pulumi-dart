...
class ResourceFilterResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'groupKinds': pulumi.Input.encodeList<GroupKindResponse, Map<String, dynamic>>(groupKinds, (value) => value.toMap()),
      'jsonPath': jsonPath,
  ...
  factory ResourceFilterResponse.fromMap(Map<String, dynamic> map) {
    return ResourceFilterResponse(
      groupKinds: pulumi.Input.decodeList<GroupKindResponse>(map['groupKinds'], (value) => GroupKindResponse.fromMap((value as Map).cast<String, dynamic>())),
