...
/// {@template pulumi_gkebackup_v1_backup_plan_backup_volume_backup_iam_binding_args_doc}
/// The set of arguments for BackupPlanBackupVolumeBackupIamBinding.
/// {@endtemplate}
/// {@macro pulumi_gkebackup_v1_backup_plan_backup_volume_backup_iam_binding_args_doc}
class BackupPlanBackupVolumeBackupIamBindingArgs {
  ...
  /// Creates a new [BackupPlanBackupVolumeBackupIamBindingArgs].
  ...
  const BackupPlanBackupVolumeBackupIamBindingArgs({
    this.condition,
  ...
  factory BackupPlanBackupVolumeBackupIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return BackupPlanBackupVolumeBackupIamBindingArgs(
