...
class ClusterResourceRestoreScopeResponse {
  ...
  factory ClusterResourceRestoreScopeResponse.fromMap(Map<String, dynamic> map) {
    return ClusterResourceRestoreScopeResponse(
      allGroupKinds: (map['allGroupKinds'] as bool).input(),
      excludedGroupKinds: (pulumi.Input.decodeList<GroupKindResponse>(map['excludedGroupKinds'], (value) => GroupKindResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      noGroupKinds: (map['noGroupKinds'] as bool).input(),
      selectedGroupKinds: (pulumi.Input.decodeList<GroupKindResponse>(map['selectedGroupKinds'], (value) => GroupKindResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
