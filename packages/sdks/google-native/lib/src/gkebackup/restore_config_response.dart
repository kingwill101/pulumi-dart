...
class RestoreConfigResponse {
  ...
  final pulumi.Input<ClusterResourceRestoreScopeResponse>
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'excludedNamespaces':
          pulumi.Input.mapInputValue<NamespacesResponse, Map<String, dynamic>>(
            excludedNamespaces,
            (value) => value.toMap(),
          ),
  ...
  factory RestoreConfigResponse.fromMap(Map<String, dynamic> map) {
    return RestoreConfigResponse(
      ...
      clusterResourceConflictPolicy: pulumi.Input.fromValue(
        map['clusterResourceConflictPolicy'] as String,
      ),
      clusterResourceRestoreScope: pulumi.Input.fromValue(
        ClusterResourceRestoreScopeResponse.fromMap(
          (map['clusterResourceRestoreScope']! as Map).cast<String, dynamic>(),
        ),
      ),
      excludedNamespaces: pulumi.Input.fromValue(
        NamespacesResponse.fromMap(
          (map['excludedNamespaces']! as Map).cast<String, dynamic>(),
        ),
      ),
      namespacedResourceRestoreMode: pulumi.Input.fromValue(
        map['namespacedResourceRestoreMode'] as String,
      ),
      noNamespaces: pulumi.Input.fromValue(map['noNamespaces'] as bool),
      selectedApplications: pulumi.Input.fromValue(
        NamespacedNamesResponse.fromMap(
          (map['selectedApplications']! as Map).cast<String, dynamic>(),
        ),
      ),
      selectedNamespaces: pulumi.Input.fromValue(
        NamespacesResponse.fromMap(
          (map['selectedNamespaces']! as Map).cast<String, dynamic>(),
        ),
      ),
      substitutionRules: pulumi.Input.fromValue(
        pulumi.Input.decodeList<SubstitutionRuleResponse>(
      ...
      transformationRules: pulumi.Input.fromValue(
        pulumi.Input.decodeList<TransformationRuleResponse>(
      ...
      volumeDataRestorePolicy: pulumi.Input.fromValue(
