...
class RestoreConfigResponse {
  ...
  factory RestoreConfigResponse.fromMap(Map<String, dynamic> map) {
    return RestoreConfigResponse(
      ...
      clusterResourceConflictPolicy: (map['clusterResourceConflictPolicy'] as String).input(),
      clusterResourceRestoreScope: (ClusterResourceRestoreScopeResponse.fromMap((map['clusterResourceRestoreScope'] as Map).cast<String, dynamic>())).input(),
      excludedNamespaces: (NamespacesResponse.fromMap((map['excludedNamespaces'] as Map).cast<String, dynamic>())).input(),
      namespacedResourceRestoreMode: (map['namespacedResourceRestoreMode'] as String).input(),
      noNamespaces: (map['noNamespaces'] as bool).input(),
      ...
      substitutionRules: (pulumi.Input.decodeList<SubstitutionRuleResponse>(map['substitutionRules'], (value) => SubstitutionRuleResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      transformationRules: (pulumi.Input.decodeList<TransformationRuleResponse>(map['transformationRules'], (value) => TransformationRuleResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      volumeDataRestorePolicy: (map['volumeDataRestorePolicy'] as String).input(),
    );
  }
}
