...
class BackupConfigResponse {
  ...
  factory BackupConfigResponse.fromMap(Map<String, dynamic> map) {
    return BackupConfigResponse(
      ...
      encryptionKey: pulumi.Input.fromValue(EncryptionKeyResponse.fromMap((map['encryptionKey']! as Map).cast<String, dynamic>())),
      includeSecrets: pulumi.Input.fromValue(map['includeSecrets'] as bool),
      includeVolumeData: pulumi.Input.fromValue(map['includeVolumeData'] as bool),
