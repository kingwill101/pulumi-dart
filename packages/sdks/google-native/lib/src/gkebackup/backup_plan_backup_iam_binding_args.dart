...
/// {@template pulumi_gkebackup_v1_backup_plan_backup_iam_binding_args_doc}
/// The set of arguments for BackupPlanBackupIamBinding.
/// {@endtemplate}
/// {@macro pulumi_gkebackup_v1_backup_plan_backup_iam_binding_args_doc}
class BackupPlanBackupIamBindingArgs {
  ...
  /// Creates a new [BackupPlanBackupIamBindingArgs].
  ...
  const BackupPlanBackupIamBindingArgs({
    this.condition,
  ...
  factory BackupPlanBackupIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return BackupPlanBackupIamBindingArgs(
