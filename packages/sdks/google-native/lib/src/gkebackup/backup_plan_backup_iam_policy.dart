...
class BackupPlanBackupIamPolicy extends pulumi.CustomResource {
  ...
  /// Creates a new [BackupPlanBackupIamPolicy].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [BackupPlanBackupIamPolicy]. {@macro pulumi_gkebackup_v1_backup_plan_backup_iam_policy_args_doc}
