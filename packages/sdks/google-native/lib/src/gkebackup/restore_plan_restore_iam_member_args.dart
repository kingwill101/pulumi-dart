...
/// {@template pulumi_gkebackup_v1_restore_plan_restore_iam_member_args_doc}
/// The set of arguments for RestorePlanRestoreIamMember.
/// {@endtemplate}
/// {@macro pulumi_gkebackup_v1_restore_plan_restore_iam_member_args_doc}
class RestorePlanRestoreIamMemberArgs {
  ...
  /// Creates a new [RestorePlanRestoreIamMemberArgs].
  ...
  const RestorePlanRestoreIamMemberArgs({
    this.condition,
  ...
  factory RestorePlanRestoreIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return RestorePlanRestoreIamMemberArgs(
