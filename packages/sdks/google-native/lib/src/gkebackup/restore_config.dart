...
class RestoreConfig {
  ...
  final pulumi.Input<RestoreConfigClusterResourceConflictPolicy>? clusterResourceConflictPolicy;
  ...
  final pulumi.Input<RestoreConfigNamespacedResourceRestoreMode>? namespacedResourceRestoreMode;
  ...
  final pulumi.Input<RestoreConfigVolumeDataRestorePolicy>? volumeDataRestorePolicy;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'clusterResourceConflictPolicy': ?pulumi.Input.mapOptionalInputValue<RestoreConfigClusterResourceConflictPolicy, String>(clusterResourceConflictPolicy, (value) => value.wireValue),
      'clusterResourceRestoreScope': ?pulumi.Input.mapOptionalInputValue<ClusterResourceRestoreScope, Map<String, dynamic>>(clusterResourceRestoreScope, (value) => value.toMap()),
      'excludedNamespaces': ?pulumi.Input.mapOptionalInputValue<Namespaces, Map<String, dynamic>>(excludedNamespaces, (value) => value.toMap()),
      'namespacedResourceRestoreMode': ?pulumi.Input.mapOptionalInputValue<RestoreConfigNamespacedResourceRestoreMode, String>(namespacedResourceRestoreMode, (value) => value.wireValue),
      ...
      'substitutionRules': ?pulumi.Input.mapOptionalInputValue<List<SubstitutionRule>, List<Map<String, dynamic>>>(substitutionRules, (value) => pulumi.Input.encodeList<SubstitutionRule, Map<String, dynamic>>(value, (value) => value.toMap())),
      'transformationRules': ?pulumi.Input.mapOptionalInputValue<List<TransformationRule>, List<Map<String, dynamic>>>(transformationRules, (value) => pulumi.Input.encodeList<TransformationRule, Map<String, dynamic>>(value, (value) => value.toMap())),
      'volumeDataRestorePolicy': ?pulumi.Input.mapOptionalInputValue<RestoreConfigVolumeDataRestorePolicy, String>(volumeDataRestorePolicy, (value) => value.wireValue),
    };
  }
  ...
  factory RestoreConfig.fromMap(Map<String, dynamic> map) {
    return RestoreConfig(
      ...
      clusterResourceConflictPolicy: (() { final guardedValue = map['clusterResourceConflictPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RestoreConfigClusterResourceConflictPolicy.fromValue(guardedValue as String)); })(),
      clusterResourceRestoreScope: (() { final guardedValue = map['clusterResourceRestoreScope']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterResourceRestoreScope.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      excludedNamespaces: (() { final guardedValue = map['excludedNamespaces']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Namespaces.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      namespacedResourceRestoreMode: (() { final guardedValue = map['namespacedResourceRestoreMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RestoreConfigNamespacedResourceRestoreMode.fromValue(guardedValue as String)); })(),
      ...
      substitutionRules: (() { final guardedValue = map['substitutionRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SubstitutionRule>(guardedValue, (value) => SubstitutionRule.fromMap((value as Map).cast<String, dynamic>()))); })(),
      transformationRules: (() { final guardedValue = map['transformationRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<TransformationRule>(guardedValue, (value) => TransformationRule.fromMap((value as Map).cast<String, dynamic>()))); })(),
      volumeDataRestorePolicy: (() { final guardedValue = map['volumeDataRestorePolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RestoreConfigVolumeDataRestorePolicy.fromValue(guardedValue as String)); })(),
    );
  }
}
