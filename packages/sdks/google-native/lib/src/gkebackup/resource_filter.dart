...
class ResourceFilter {
  ...
  factory ResourceFilter.fromMap(Map<String, dynamic> map) {
    return ResourceFilter(
      groupKinds: (() { final guardedValue = map['groupKinds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GroupKind>(guardedValue, (value) => GroupKind.fromMap((value as Map).cast<String, dynamic>()))); })(),
