...
/// {@template pulumi_gkebackup_v1_restore_plan_restore_volume_restore_iam_policy_args_doc}
/// The set of arguments for RestorePlanRestoreVolumeRestoreIamPolicy.
/// {@endtemplate}
/// {@macro pulumi_gkebackup_v1_restore_plan_restore_volume_restore_iam_policy_args_doc}
class RestorePlanRestoreVolumeRestoreIamPolicyArgs {
  ...
  /// Creates a new [RestorePlanRestoreVolumeRestoreIamPolicyArgs].
  ...
  RestorePlanRestoreVolumeRestoreIamPolicyArgs({
    this.auditConfigs,
    this.bindings,
    this.etag,
    this.location,
  ...
  factory RestorePlanRestoreVolumeRestoreIamPolicyArgs.fromMap(
    Map<String, dynamic> map,
  ) {
    return RestorePlanRestoreVolumeRestoreIamPolicyArgs(
      auditConfigs: (() {
