...
class ClusterResourceRestoreScope {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'excludedGroupKinds': ?excludedGroupKinds == null ? null : pulumi.Input.encodeList<GroupKind, Map<String, dynamic>>(excludedGroupKinds!, (value) => value.toMap()),
      'noGroupKinds': ?noGroupKinds,
      'selectedGroupKinds': ?selectedGroupKinds == null ? null : pulumi.Input.encodeList<GroupKind, Map<String, dynamic>>(selectedGroupKinds!, (value) => value.toMap()),
    };
  }

  factory ClusterResourceRestoreScope.fromMap(Map<String, dynamic> map) {
    return ClusterResourceRestoreScope(
      allGroupKinds: map['allGroupKinds'] == null ? null : map['allGroupKinds'] as bool,
      excludedGroupKinds: map['excludedGroupKinds'] == null ? null : pulumi.Input.decodeList<GroupKind>(map['excludedGroupKinds'], (value) => GroupKind.fromMap((value as Map).cast<String, dynamic>())),
      noGroupKinds: map['noGroupKinds'] == null ? null : map['noGroupKinds'] as bool,
      selectedGroupKinds: map['selectedGroupKinds'] == null ? null : pulumi.Input.decodeList<GroupKind>(map['selectedGroupKinds'], (value) => GroupKind.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
