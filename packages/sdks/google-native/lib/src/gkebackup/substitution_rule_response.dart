...
class SubstitutionRuleResponse {
  ...
  factory SubstitutionRuleResponse.fromMap(Map<String, dynamic> map) {
    return SubstitutionRuleResponse(
      ...
      originalValuePattern: pulumi.Input.fromValue(
        map['originalValuePattern'] as String,
      ),
      targetGroupKinds: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GroupKindResponse>(
      ...
      targetNamespaces: pulumi.Input.fromValue(
