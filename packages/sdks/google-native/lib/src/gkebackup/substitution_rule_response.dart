...
class SubstitutionRuleResponse {
  ...
  const SubstitutionRuleResponse({
  ...
  factory SubstitutionRuleResponse.fromMap(Map<String, dynamic> map) {
    return SubstitutionRuleResponse(
      newValue: pulumi.Input.fromValue(map['newValue'] as String),
      originalValuePattern: pulumi.Input.fromValue(map['originalValuePattern'] as String),
      targetGroupKinds: pulumi.Input.fromValue(pulumi.Input.decodeList<GroupKindResponse>(map['targetGroupKinds']!, (value) => GroupKindResponse.fromMap((value as Map).cast<String, dynamic>()))),
      targetJsonPath: pulumi.Input.fromValue(map['targetJsonPath'] as String),
      targetNamespaces: pulumi.Input.fromValue((map['targetNamespaces'] as List).cast<String>()),
    );
  }
}
