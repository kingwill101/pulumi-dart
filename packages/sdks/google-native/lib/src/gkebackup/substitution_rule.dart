...
class SubstitutionRule {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'targetGroupKinds': ?targetGroupKinds == null ? null : pulumi.Input.encodeList<GroupKind, Map<String, dynamic>>(targetGroupKinds!, (value) => value.toMap()),
  ...
  factory SubstitutionRule.fromMap(Map<String, dynamic> map) {
    return SubstitutionRule(
      ...
      originalValuePattern: map['originalValuePattern'] == null ? null : map['originalValuePattern'] as String,
      targetGroupKinds: map['targetGroupKinds'] == null ? null : pulumi.Input.decodeList<GroupKind>(map['targetGroupKinds'], (value) => GroupKind.fromMap((value as Map).cast<String, dynamic>())),
      targetJsonPath: map['targetJsonPath'] as String,
      targetNamespaces: map['targetNamespaces'] == null ? null : (map['targetNamespaces'] as List).cast<String>(),
    );
  }
}
