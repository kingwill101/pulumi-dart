...
class SubstitutionRule {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'targetGroupKinds': ?pulumi.Input.mapOptionalInputValue<List<GroupKind>, List<Map<String, dynamic>>>(targetGroupKinds, (value) => pulumi.Input.encodeList<GroupKind, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory SubstitutionRule.fromMap(Map<String, dynamic> map) {
    return SubstitutionRule(
      newValue: (() { final guardedValue = map['newValue']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      originalValuePattern: (() { final guardedValue = map['originalValuePattern']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      targetGroupKinds: (() { final guardedValue = map['targetGroupKinds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GroupKind>(guardedValue, (value) => GroupKind.fromMap((value as Map).cast<String, dynamic>()))); })(),
      targetJsonPath: pulumi.Input.fromValue(map['targetJsonPath'] as String),
      targetNamespaces: (() { final guardedValue = map['targetNamespaces']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
    );
  }
}
