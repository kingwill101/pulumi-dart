...
class TransformationRuleResponse {
  ...
  const TransformationRuleResponse({
  ...
  factory TransformationRuleResponse.fromMap(Map<String, dynamic> map) {
    return TransformationRuleResponse(
      ...
      fieldActions: pulumi.Input.fromValue(pulumi.Input.decodeList<TransformationRuleActionResponse>(map['fieldActions']!, (value) => TransformationRuleActionResponse.fromMap((value as Map).cast<String, dynamic>()))),
      resourceFilter: pulumi.Input.fromValue(ResourceFilterResponse.fromMap((map['resourceFilter']! as Map).cast<String, dynamic>())),
    );
  }
}
