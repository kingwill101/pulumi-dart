...
class Topic extends pulumi.CustomResource {
  ...
  Topic(
    ...
    this.partitionConfig = registerOutput<PartitionConfigResponse>('partitionConfig');
    this.project = registerOutput<String>('project');
    this.reservationConfig = registerOutput<ReservationConfigResponse>('reservationConfig');
    this.retentionConfig = registerOutput<RetentionConfigResponse>('retentionConfig');
