...
class ExportConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'desiredState': ?pulumi.Input.mapOptionalInputValue<ExportConfigDesiredState, String>(desiredState, (value) => value.wireValue),
  ...
  factory ExportConfig.fromMap(Map<String, dynamic> map) {
    return ExportConfig(
      ...
      desiredState: (() { final guardedValue = map['desiredState']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ExportConfigDesiredState.fromValue(guardedValue as String)); })(),
