...
class ExportConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'pubsubConfig': ?pubsubConfig == null ? null : pubsubConfig!.toMap(),
    };
  }
  ...
  factory ExportConfig.fromMap(Map<String, dynamic> map) {
    return ExportConfig(
      ...
      desiredState: map['desiredState'] == null ? null : ExportConfigDesiredState.fromValue(map['desiredState'] as String),
