...
class Capacity {
  ...
  factory Capacity.fromMap(Map<String, dynamic> map) {
    return Capacity(
      publishMibPerSec: map['publishMibPerSec'] == null ? null : map['publishMibPerSec'] as int,
      subscribeMibPerSec: map['subscribeMibPerSec'] == null ? null : map['subscribeMibPerSec'] as int,
    );
  }
}
