...
class RetentionConfig {
  ...
  factory RetentionConfig.fromMap(Map<String, dynamic> map) {
    return RetentionConfig(
      perPartitionBytes: (() { final guardedValue = map['perPartitionBytes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
