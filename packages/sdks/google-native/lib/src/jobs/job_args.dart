...
class JobArgs {
  ...
  factory JobArgs.fromMap(Map<String, dynamic> map) {
    return JobArgs(
      ...
      applicationInfo: pulumi.Input.fromValue(
        ApplicationInfo.fromMap(
      ...
      jobLevel: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          JobJobLevel.fromValue(guardedValue as String),
        );
      })(),
      jobStartTime: (() {
      ...
      postingRegion: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          JobPostingRegion.fromValue(guardedValue as String),
        );
      })(),
      processingOptions: (() {
      ...
      visibility: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          JobVisibility.fromValue(guardedValue as String),
        );
      })(),
    );
  }
