...
class JobArgs {
  ...
  factory JobArgs.fromMap(Map<String, dynamic> map) {
    return JobArgs(
      ...
      applicationInfo: (ApplicationInfo.fromMap((map['applicationInfo'] as Map).cast<String, dynamic>())).input(),
      companyName: (map['companyName'] as String).input(),
      compensationInfo: map['compensationInfo'] == null ? null : (CompensationInfo.fromMap((map['compensationInfo']! as Map).cast<String, dynamic>())).input(),
      customAttributes: map['customAttributes'] == null ? null : ((map['customAttributes']! as Map).cast<String, String>()).input(),
      degreeTypes: map['degreeTypes'] == null ? null : (pulumi.Input.decodeList<JobDegreeTypesItem>(map['degreeTypes']!, (value) => JobDegreeTypesItem.fromValue(value as String))).input(),
      department: map['department'] == null ? null : (map['department']! as String).input(),
      description: (map['description'] as String).input(),
      employmentTypes: map['employmentTypes'] == null ? null : (pulumi.Input.decodeList<JobEmploymentTypesItem>(map['employmentTypes']!, (value) => JobEmploymentTypesItem.fromValue(value as String))).input(),
      incentives: map['incentives'] == null ? null : (map['incentives']! as String).input(),
      jobBenefits: map['jobBenefits'] == null ? null : (pulumi.Input.decodeList<JobJobBenefitsItem>(map['jobBenefits']!, (value) => JobJobBenefitsItem.fromValue(value as String))).input(),
      jobEndTime: map['jobEndTime'] == null ? null : (map['jobEndTime']! as String).input(),
      jobLevel: map['jobLevel'] == null ? null : (JobJobLevel.fromValue(map['jobLevel']! as String)).input(),
      jobStartTime: map['jobStartTime'] == null ? null : (map['jobStartTime']! as String).input(),
      languageCode: map['languageCode'] == null ? null : (map['languageCode']! as String).input(),
      name: map['name'] == null ? null : (map['name']! as String).input(),
      postingExpireTime: map['postingExpireTime'] == null ? null : (map['postingExpireTime']! as String).input(),
      postingPublishTime: map['postingPublishTime'] == null ? null : (map['postingPublishTime']! as String).input(),
      postingRegion: map['postingRegion'] == null ? null : (JobPostingRegion.fromValue(map['postingRegion']! as String)).input(),
      processingOptions: map['processingOptions'] == null ? null : (ProcessingOptions.fromMap((map['processingOptions']! as Map).cast<String, dynamic>())).input(),
      project: map['project'] == null ? null : (map['project']! as String).input(),
      promotionValue: map['promotionValue'] == null ? null : (map['promotionValue']! as int).input(),
      qualifications: map['qualifications'] == null ? null : (map['qualifications']! as String).input(),
      requisitionId: (map['requisitionId'] as String).input(),
      responsibilities: map['responsibilities'] == null ? null : (map['responsibilities']! as String).input(),
      title: (map['title'] as String).input(),
      visibility: map['visibility'] == null ? null : (JobVisibility.fromValue(map['visibility']! as String)).input(),
    );
  }
}
