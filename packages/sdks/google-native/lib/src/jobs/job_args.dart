...
class JobArgs {
  ...
  JobArgs({
    ...
    required pulumi.Output<ApplicationInfo> applicationInfo,
    required pulumi.Output<String> companyName,
    pulumi.Output<CompensationInfo>? compensationInfo,
    pulumi.Output<Map<String, String>>? customAttributes,
    pulumi.Output<List<JobDegreeTypesItem>>? degreeTypes,
    pulumi.Output<String>? department,
    required pulumi.Output<String> description,
    pulumi.Output<List<JobEmploymentTypesItem>>? employmentTypes,
    pulumi.Output<String>? incentives,
    pulumi.Output<List<JobJobBenefitsItem>>? jobBenefits,
    pulumi.Output<String>? jobEndTime,
    pulumi.Output<JobJobLevel>? jobLevel,
    ...
    pulumi.Output<JobPostingRegion>? postingRegion,
    pulumi.Output<ProcessingOptions>? processingOptions,
    ...
    pulumi.Output<JobVisibility>? visibility,
  }) :
      ...
      compensationInfo = pulumi.Input.asOptionalInput<CompensationInfo>(compensationInfo),
      customAttributes = pulumi.Input.asOptionalInput<Map<String, String>>(customAttributes),
      degreeTypes = pulumi.Input.asOptionalInput<List<JobDegreeTypesItem>>(degreeTypes),
      department = pulumi.Input.asOptionalInput<String>(department),
      description = pulumi.Input.asInput<String>(description),
      employmentTypes = pulumi.Input.asOptionalInput<List<JobEmploymentTypesItem>>(employmentTypes),
      incentives = pulumi.Input.asOptionalInput<String>(incentives),
      jobBenefits = pulumi.Input.asOptionalInput<List<JobJobBenefitsItem>>(jobBenefits),
      ...
      postingRegion = pulumi.Input.asOptionalInput<JobPostingRegion>(postingRegion),
      processingOptions = pulumi.Input.asOptionalInput<ProcessingOptions>(processingOptions),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'degreeTypes': ?pulumi.Input.mapOptionalInputValue<List<JobDegreeTypesItem>, List<String>>(degreeTypes, (value) => pulumi.Input.encodeList<JobDegreeTypesItem, String>(value, (value) => value.value)),
      'department': ?department,
      'description': description,
      'employmentTypes': ?pulumi.Input.mapOptionalInputValue<List<JobEmploymentTypesItem>, List<String>>(employmentTypes, (value) => pulumi.Input.encodeList<JobEmploymentTypesItem, String>(value, (value) => value.value)),
      'incentives': ?incentives,
      'jobBenefits': ?pulumi.Input.mapOptionalInputValue<List<JobJobBenefitsItem>, List<String>>(jobBenefits, (value) => pulumi.Input.encodeList<JobJobBenefitsItem, String>(value, (value) => value.value)),
      'jobEndTime': ?jobEndTime,
      'jobLevel': ?pulumi.Input.mapOptionalInputValue<JobJobLevel, String>(jobLevel, (value) => value.value),
      'jobStartTime': ?jobStartTime,
      'languageCode': ?languageCode,
      'name': ?name,
      'postingExpireTime': ?postingExpireTime,
      'postingPublishTime': ?postingPublishTime,
      'postingRegion': ?pulumi.Input.mapOptionalInputValue<JobPostingRegion, String>(postingRegion, (value) => value.value),
      ...
      'title': title,
      'visibility': ?pulumi.Input.mapOptionalInputValue<JobVisibility, String>(visibility, (value) => value.value),
    };
  }
  ...
  factory JobArgs.fromMap(Map<String, dynamic> map) {
    return JobArgs(
      ...
      applicationInfo: pulumi.Output.create<ApplicationInfo>(ApplicationInfo.fromMap((map['applicationInfo'] as Map).cast<String, dynamic>())),
      companyName: pulumi.Output.create<String>(map['companyName'] as String),
      compensationInfo: map['compensationInfo'] == null ? null : pulumi.Output.create<CompensationInfo>(CompensationInfo.fromMap((map['compensationInfo'] as Map).cast<String, dynamic>())),
      ...
      degreeTypes: map['degreeTypes'] == null ? null : pulumi.Output.create<List<JobDegreeTypesItem>>(pulumi.Input.decodeList<JobDegreeTypesItem>(map['degreeTypes'], (value) => JobDegreeTypesItem.fromValue(value as String))),
      ...
      employmentTypes: map['employmentTypes'] == null ? null : pulumi.Output.create<List<JobEmploymentTypesItem>>(pulumi.Input.decodeList<JobEmploymentTypesItem>(map['employmentTypes'], (value) => JobEmploymentTypesItem.fromValue(value as String))),
      incentives: map['incentives'] == null ? null : pulumi.Output.create<String>(map['incentives'] as String),
      jobBenefits: map['jobBenefits'] == null ? null : pulumi.Output.create<List<JobJobBenefitsItem>>(pulumi.Input.decodeList<JobJobBenefitsItem>(map['jobBenefits'], (value) => JobJobBenefitsItem.fromValue(value as String))),
      jobEndTime: map['jobEndTime'] == null ? null : pulumi.Output.create<String>(map['jobEndTime'] as String),
      jobLevel: map['jobLevel'] == null ? null : pulumi.Output.create<JobJobLevel>(JobJobLevel.fromValue(map['jobLevel'] as String)),
      ...
      postingRegion: map['postingRegion'] == null ? null : pulumi.Output.create<JobPostingRegion>(JobPostingRegion.fromValue(map['postingRegion'] as String)),
      processingOptions: map['processingOptions'] == null ? null : pulumi.Output.create<ProcessingOptions>(ProcessingOptions.fromMap((map['processingOptions'] as Map).cast<String, dynamic>())),
      ...
      visibility: map['visibility'] == null ? null : pulumi.Output.create<JobVisibility>(JobVisibility.fromValue(map['visibility'] as String)),
    );
  }
}
