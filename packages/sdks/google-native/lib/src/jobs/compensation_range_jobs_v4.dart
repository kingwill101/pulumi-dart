...
class CompensationRangeJobsV4 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'maxCompensation': ?pulumi.Input.mapOptionalInputValue<MoneyJobsV4, Map<String, dynamic>>(maxCompensation, (value) => value.toMap()),
      'minCompensation': ?pulumi.Input.mapOptionalInputValue<MoneyJobsV4, Map<String, dynamic>>(minCompensation, (value) => value.toMap()),
    };
  }

  factory CompensationRangeJobsV4.fromMap(Map<String, dynamic> map) {
    return CompensationRangeJobsV4(
      maxCompensation: (() { final guardedValue = map['maxCompensation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MoneyJobsV4.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      minCompensation: (() { final guardedValue = map['minCompensation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MoneyJobsV4.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
