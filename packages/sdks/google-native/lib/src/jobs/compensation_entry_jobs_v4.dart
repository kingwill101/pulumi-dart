...
class CompensationEntryJobsV4 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'type': ?pulumi.Input.mapOptionalInputValue<CompensationEntryTypeJobsV4, String>(type, (value) => value.wireValue),
      'unit': ?pulumi.Input.mapOptionalInputValue<CompensationEntryUnitJobsV4, String>(unit, (value) => value.wireValue),
    };
  }

  factory CompensationEntryJobsV4.fromMap(Map<String, dynamic> map) {
    return CompensationEntryJobsV4(
      amount: (() { final guardedValue = map['amount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MoneyJobsV4.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      description: (() { final guardedValue = map['description']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      expectedUnitsPerYear: (() { final guardedValue = map['expectedUnitsPerYear']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as double); })(),
      range: (() { final guardedValue = map['range']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CompensationRangeJobsV4.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CompensationEntryTypeJobsV4.fromValue(guardedValue as String)); })(),
      unit: (() { final guardedValue = map['unit']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CompensationEntryUnitJobsV4.fromValue(guardedValue as String)); })(),
    );
  }
}
