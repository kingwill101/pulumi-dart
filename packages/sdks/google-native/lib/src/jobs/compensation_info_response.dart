...
class CompensationInfoResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'entries': pulumi.Input.encodeList<CompensationEntryResponse, Map<String, dynamic>>(entries, (value) => value.toMap()),
    };
  }

  factory CompensationInfoResponse.fromMap(Map<String, dynamic> map) {
    return CompensationInfoResponse(
      annualizedBaseCompensationRange: CompensationRangeResponse.fromMap((map['annualizedBaseCompensationRange'] as Map).cast<String, dynamic>()),
      annualizedTotalCompensationRange: CompensationRangeResponse.fromMap((map['annualizedTotalCompensationRange'] as Map).cast<String, dynamic>()),
      entries: pulumi.Input.decodeList<CompensationEntryResponse>(map['entries'], (value) => CompensationEntryResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
