...
class CompensationInfoJobsV4 {
  ...
  factory CompensationInfoJobsV4.fromMap(Map<String, dynamic> map) {
    return CompensationInfoJobsV4(
      entries: (() { final guardedValue = map['entries']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<CompensationEntryJobsV4>(guardedValue, (value) => CompensationEntryJobsV4.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
