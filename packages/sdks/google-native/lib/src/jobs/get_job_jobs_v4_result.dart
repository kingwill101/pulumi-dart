...
class GetJobJobsV4Result {
  ...
  factory GetJobJobsV4Result.fromMap(Map<String, dynamic> map) {
    return GetJobJobsV4Result(
      ...
      applicationInfo: ApplicationInfoResponseJobsV4.fromMap((map['applicationInfo']! as Map).cast<String, dynamic>()),
      company: map['company'] as String,
      companyDisplayName: map['companyDisplayName'] as String,
      compensationInfo: CompensationInfoResponseJobsV4.fromMap((map['compensationInfo']! as Map).cast<String, dynamic>()),
      customAttributes: (map['customAttributes'] as Map).cast<String, String>(),
      degreeTypes: (map['degreeTypes'] as List).cast<String>(),
      department: map['department'] as String,
      derivedInfo: JobDerivedInfoResponseJobsV4.fromMap((map['derivedInfo']! as Map).cast<String, dynamic>()),
      ...
      processingOptions: ProcessingOptionsResponseJobsV4.fromMap((map['processingOptions']! as Map).cast<String, dynamic>()),
