...
class LocationResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'latLng':
          pulumi.Input.mapInputValue<LatLngResponse, Map<String, dynamic>>(
            latLng,
            (value) => value.toMap(),
          ),
  ...
  factory LocationResponse.fromMap(Map<String, dynamic> map) {
    return LocationResponse(
      latLng: pulumi.Input.fromValue(
        LatLngResponse.fromMap((map['latLng']! as Map).cast<String, dynamic>()),
      ),
      locationType: pulumi.Input.fromValue(map['locationType'] as String),
      postalAddress: pulumi.Input.fromValue(
        PostalAddressResponse.fromMap(
