...
class LocationResponse {
  ...
  factory LocationResponse.fromMap(Map<String, dynamic> map) {
    return LocationResponse(
      latLng: (LatLngResponse.fromMap((map['latLng'] as Map).cast<String, dynamic>())).input(),
      locationType: (map['locationType'] as String).input(),
      postalAddress: (PostalAddressResponse.fromMap((map['postalAddress'] as Map).cast<String, dynamic>())).input(),
      radiusInMiles: (map['radiusInMiles'] as double).input(),
    );
  }
}
