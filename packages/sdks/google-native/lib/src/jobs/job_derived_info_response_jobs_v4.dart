...
class JobDerivedInfoResponseJobsV4 {
  ...
  factory JobDerivedInfoResponseJobsV4.fromMap(Map<String, dynamic> map) {
    return JobDerivedInfoResponseJobsV4(
      jobCategories: ((map['jobCategories'] as List).cast<String>()).input(),
      locations: (pulumi.Input.decodeList<LocationResponseJobsV4>(map['locations'], (value) => LocationResponseJobsV4.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
