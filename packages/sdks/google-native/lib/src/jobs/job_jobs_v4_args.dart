...
class JobJobsV4Args {
  ...
  factory JobJobsV4Args.fromMap(Map<String, dynamic> map) {
    return JobJobsV4Args(
      ...
      applicationInfo: map['applicationInfo'] == null ? null : (ApplicationInfoJobsV4.fromMap((map['applicationInfo'] as Map).cast<String, dynamic>())).input(),
      company: (map['company'] as String).input(),
      compensationInfo: map['compensationInfo'] == null ? null : (CompensationInfoJobsV4.fromMap((map['compensationInfo'] as Map).cast<String, dynamic>())).input(),
      customAttributes: map['customAttributes'] == null ? null : ((map['customAttributes'] as Map).cast<String, String>()).input(),
      degreeTypes: map['degreeTypes'] == null ? null : (pulumi.Input.decodeList<JobDegreeTypesItemJobsV4>(map['degreeTypes'], (value) => JobDegreeTypesItemJobsV4.fromValue(value as String))).input(),
      department: map['department'] == null ? null : (map['department'] as String).input(),
      description: (map['description'] as String).input(),
      employmentTypes: map['employmentTypes'] == null ? null : (pulumi.Input.decodeList<JobEmploymentTypesItemJobsV4>(map['employmentTypes'], (value) => JobEmploymentTypesItemJobsV4.fromValue(value as String))).input(),
      incentives: map['incentives'] == null ? null : (map['incentives'] as String).input(),
      jobBenefits: map['jobBenefits'] == null ? null : (pulumi.Input.decodeList<JobJobBenefitsItemJobsV4>(map['jobBenefits'], (value) => JobJobBenefitsItemJobsV4.fromValue(value as String))).input(),
      jobEndTime: map['jobEndTime'] == null ? null : (map['jobEndTime'] as String).input(),
      jobLevel: map['jobLevel'] == null ? null : (JobJobLevelJobsV4.fromValue(map['jobLevel'] as String)).input(),
      ...
      postingRegion: map['postingRegion'] == null ? null : (JobPostingRegionJobsV4.fromValue(map['postingRegion'] as String)).input(),
      processingOptions: map['processingOptions'] == null ? null : (ProcessingOptionsJobsV4.fromMap((map['processingOptions'] as Map).cast<String, dynamic>())).input(),
      ...
      visibility: map['visibility'] == null ? null : (JobVisibilityJobsV4.fromValue(map['visibility'] as String)).input(),
    );
  }
}
