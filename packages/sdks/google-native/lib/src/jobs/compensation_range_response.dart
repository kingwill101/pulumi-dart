...
class CompensationRangeResponse {
  ...
  factory CompensationRangeResponse.fromMap(Map<String, dynamic> map) {
    return CompensationRangeResponse(
      maxCompensation: (MoneyResponse.fromMap((map['maxCompensation'] as Map).cast<String, dynamic>())).input(),
      minCompensation: (MoneyResponse.fromMap((map['minCompensation'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
