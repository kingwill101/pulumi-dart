...
class CompensationRangeResponse {
  ...
  const CompensationRangeResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'maxCompensation': pulumi.Input.mapInputValue<MoneyResponse, Map<String, dynamic>>(maxCompensation, (value) => value.toMap()),
      'minCompensation': pulumi.Input.mapInputValue<MoneyResponse, Map<String, dynamic>>(minCompensation, (value) => value.toMap()),
    };
  }

  factory CompensationRangeResponse.fromMap(Map<String, dynamic> map) {
    return CompensationRangeResponse(
      maxCompensation: pulumi.Input.fromValue(MoneyResponse.fromMap((map['maxCompensation']! as Map).cast<String, dynamic>())),
      minCompensation: pulumi.Input.fromValue(MoneyResponse.fromMap((map['minCompensation']! as Map).cast<String, dynamic>())),
    );
  }
}
