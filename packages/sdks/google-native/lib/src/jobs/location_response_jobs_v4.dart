...
class LocationResponseJobsV4 {
  ...
  factory LocationResponseJobsV4.fromMap(Map<String, dynamic> map) {
    return LocationResponseJobsV4(
      latLng: LatLngResponseJobsV4.fromMap((map['latLng'] as Map).cast<String, dynamic>()),
      locationType: map['locationType'] as String,
      postalAddress: PostalAddressResponseJobsV4.fromMap((map['postalAddress'] as Map).cast<String, dynamic>()),
