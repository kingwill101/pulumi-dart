...
class GetJobResult {
  ...
  factory GetJobResult.fromMap(Map<String, dynamic> map) {
    return GetJobResult(
      ...
      applicationInfo: ApplicationInfoResponse.fromMap((map['applicationInfo']! as Map).cast<String, dynamic>()),
      companyDisplayName: map['companyDisplayName'] as String,
      companyName: map['companyName'] as String,
      compensationInfo: CompensationInfoResponse.fromMap((map['compensationInfo']! as Map).cast<String, dynamic>()),
      customAttributes: (map['customAttributes'] as Map).cast<String, String>(),
      degreeTypes: (map['degreeTypes'] as List).cast<String>(),
      department: map['department'] as String,
      derivedInfo: JobDerivedInfoResponse.fromMap((map['derivedInfo']! as Map).cast<String, dynamic>()),
      ...
      processingOptions: ProcessingOptionsResponse.fromMap((map['processingOptions']! as Map).cast<String, dynamic>()),
