...
class ProcessingOptionsJobsV4 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'htmlSanitization': ?pulumi.Input.mapOptionalInputValue<ProcessingOptionsHtmlSanitizationJobsV4, String>(htmlSanitization, (value) => value.wireValue),
    };
  }
  ...
  factory ProcessingOptionsJobsV4.fromMap(Map<String, dynamic> map) {
    return ProcessingOptionsJobsV4(
      ...
      htmlSanitization: (() { final guardedValue = map['htmlSanitization']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ProcessingOptionsHtmlSanitizationJobsV4.fromValue(guardedValue as String)); })(),
    );
  }
}
