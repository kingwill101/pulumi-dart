...
class Job extends pulumi.CustomResource {
  ...
  late final pulumi.Output<ApplicationInfoResponse> applicationInfo;
  ...
  late final pulumi.Output<CompensationInfoResponse> compensationInfo;
  ...
  late final pulumi.Output<JobDerivedInfoResponse> derivedInfo;
  ...
  late final pulumi.Output<ProcessingOptionsResponse> processingOptions;
  ...
  /// [args] Arguments used to configure this [Job]. {@macro pulumi_jobs_v3_job_args_doc}
  ...
  Job(
    ...
    applicationInfo = registerOutput<ApplicationInfoResponse>('applicationInfo', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ApplicationInfoResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    companyDisplayName = registerOutput<String>('companyDisplayName');
    companyName = registerOutput<String>('companyName');
    compensationInfo = registerOutput<CompensationInfoResponse>('compensationInfo', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return CompensationInfoResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    derivedInfo = registerOutput<JobDerivedInfoResponse>('derivedInfo', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return JobDerivedInfoResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    processingOptions = registerOutput<ProcessingOptionsResponse>('processingOptions', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ProcessingOptionsResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
