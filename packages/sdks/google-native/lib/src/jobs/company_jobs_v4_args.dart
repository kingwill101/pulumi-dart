...
class CompanyJobsV4Args {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'project': ?project,
      'size': ?pulumi.Input.mapOptionalInputValue<CompanySizeJobsV4, String>(size, (value) => value.wireValue),
      'tenantId': tenantId,
  ...
  factory CompanyJobsV4Args.fromMap(Map<String, dynamic> map) {
    return CompanyJobsV4Args(
      ...
      size: (() { final guardedValue = map['size']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CompanySizeJobsV4.fromValue(guardedValue as String)); })(),
