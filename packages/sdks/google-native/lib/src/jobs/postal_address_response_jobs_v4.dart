...
class PostalAddressResponseJobsV4 {
  ...
  /// Creates a new [PostalAddressResponseJobsV4].
  ...
  const PostalAddressResponseJobsV4({
  ...
  factory PostalAddressResponseJobsV4.fromMap(Map<String, dynamic> map) {
    return PostalAddressResponseJobsV4(
