...
class GetGlossaryTranslateV3beta1Result {
  ...
  /// Creates a new [GetGlossaryTranslateV3beta1Result].
  ...
  factory GetGlossaryTranslateV3beta1Result.fromMap(Map<String, dynamic> map) {
    return GetGlossaryTranslateV3beta1Result(
      ...
      inputConfig: GlossaryInputConfigResponseTranslateV3beta1.fromMap((map['inputConfig']! as Map).cast<String, dynamic>()),
      languageCodesSet: LanguageCodesSetResponseTranslateV3beta1.fromMap((map['languageCodesSet']! as Map).cast<String, dynamic>()),
      languagePair: LanguageCodePairResponseTranslateV3beta1.fromMap((map['languagePair']! as Map).cast<String, dynamic>()),
