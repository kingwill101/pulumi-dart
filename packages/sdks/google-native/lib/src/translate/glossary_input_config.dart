...
class GlossaryInputConfig {
  ...
  final pulumi.Input<GcsSource> gcsSource;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'gcsSource': pulumi.Input.mapInputValue<GcsSource, Map<String, dynamic>>(gcsSource, (value) => value.toMap()),
    };
  }

  factory GlossaryInputConfig.fromMap(Map<String, dynamic> map) {
    return GlossaryInputConfig(
      gcsSource: pulumi.Input.fromValue(GcsSource.fromMap((map['gcsSource']! as Map).cast<String, dynamic>())),
    );
  }
}
