...
class GetPhraseSetResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': name,
      'phrases': pulumi.Input.encodeList<PhraseResponse, Map<String, dynamic>>(phrases, (value) => value.toMap()),
  ...
  factory GetPhraseSetResult.fromMap(Map<String, dynamic> map) {
    return GetPhraseSetResult(
      ...
      phrases: pulumi.Input.decodeList<PhraseResponse>(map['phrases']!, (value) => PhraseResponse.fromMap((value as Map).cast<String, dynamic>())),
