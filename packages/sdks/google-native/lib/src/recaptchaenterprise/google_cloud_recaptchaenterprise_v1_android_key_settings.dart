...
class GoogleCloudRecaptchaenterpriseV1AndroidKeySettings {
  ...
  const GoogleCloudRecaptchaenterpriseV1AndroidKeySettings({
  ...
  factory GoogleCloudRecaptchaenterpriseV1AndroidKeySettings.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRecaptchaenterpriseV1AndroidKeySettings(
      ...
      supportNonGoogleAppStoreDistribution: (() { final guardedValue = map['supportNonGoogleAppStoreDistribution']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
    );
  }
}
