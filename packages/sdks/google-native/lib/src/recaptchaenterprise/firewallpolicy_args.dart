...
class FirewallpolicyArgs {
  ...
  factory FirewallpolicyArgs.fromMap(Map<String, dynamic> map) {
    return FirewallpolicyArgs(
      actions: (() { final guardedValue = map['actions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudRecaptchaenterpriseV1FirewallAction>(guardedValue, (value) => GoogleCloudRecaptchaenterpriseV1FirewallAction.fromMap((value as Map).cast<String, dynamic>()))); })(),
