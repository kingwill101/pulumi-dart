...
class GoogleCloudRecaptchaenterpriseV1WafSettings {
  ...
  final pulumi.Input<GoogleCloudRecaptchaenterpriseV1WafSettingsWafFeature>
  wafFeature;

  /// The WAF service that uses this key.
  final pulumi.Input<GoogleCloudRecaptchaenterpriseV1WafSettingsWafService>
  wafService;
    ...
    return <String, dynamic>{
      'wafFeature':
          pulumi.Input.mapInputValue<
            ...
            String
          >(wafFeature, (value) => value.wireValue),
      'wafService':
          pulumi.Input.mapInputValue<
            GoogleCloudRecaptchaenterpriseV1WafSettingsWafService,
            String
          >(wafService, (value) => value.wireValue),
    };
  }
