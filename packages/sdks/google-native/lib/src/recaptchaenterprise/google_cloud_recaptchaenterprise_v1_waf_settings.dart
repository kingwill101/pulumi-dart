...
class GoogleCloudRecaptchaenterpriseV1WafSettings {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'wafFeature': pulumi.Input.mapInputValue<GoogleCloudRecaptchaenterpriseV1WafSettingsWafFeature, String>(wafFeature, (value) => value.wireValue),
      'wafService': pulumi.Input.mapInputValue<GoogleCloudRecaptchaenterpriseV1WafSettingsWafService, String>(wafService, (value) => value.wireValue),
    };
  }
  ...
  factory GoogleCloudRecaptchaenterpriseV1WafSettings.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRecaptchaenterpriseV1WafSettings(
      wafFeature: pulumi.Input.fromValue(GoogleCloudRecaptchaenterpriseV1WafSettingsWafFeature.fromValue(map['wafFeature']! as String)),
      wafService: pulumi.Input.fromValue(GoogleCloudRecaptchaenterpriseV1WafSettingsWafService.fromValue(map['wafService']! as String)),
    );
  }
}
