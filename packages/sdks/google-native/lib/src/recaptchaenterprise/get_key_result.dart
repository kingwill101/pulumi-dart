...
class GetKeyResult {
  ...
  final GoogleCloudRecaptchaenterpriseV1AndroidKeySettingsResponse androidSettings;
  ...
  factory GetKeyResult.fromMap(Map<String, dynamic> map) {
    return GetKeyResult(
      androidSettings: GoogleCloudRecaptchaenterpriseV1AndroidKeySettingsResponse.fromMap((map['androidSettings']! as Map).cast<String, dynamic>()),
      createTime: map['createTime'] as String,
      displayName: map['displayName'] as String,
      iosSettings: GoogleCloudRecaptchaenterpriseV1IOSKeySettingsResponse.fromMap((map['iosSettings']! as Map).cast<String, dynamic>()),
      labels: (map['labels'] as Map).cast<String, String>(),
      name: map['name'] as String,
      testingOptions: GoogleCloudRecaptchaenterpriseV1TestingOptionsResponse.fromMap((map['testingOptions']! as Map).cast<String, dynamic>()),
      wafSettings: GoogleCloudRecaptchaenterpriseV1WafSettingsResponse.fromMap((map['wafSettings']! as Map).cast<String, dynamic>()),
      webSettings: GoogleCloudRecaptchaenterpriseV1WebKeySettingsResponse.fromMap((map['webSettings']! as Map).cast<String, dynamic>()),
    );
  }
}
