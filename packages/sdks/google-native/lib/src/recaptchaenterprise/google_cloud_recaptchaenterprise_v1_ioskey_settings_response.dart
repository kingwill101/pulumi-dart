...
class GoogleCloudRecaptchaenterpriseV1IOSKeySettingsResponse {
  ...
  final pulumi.Input<GoogleCloudRecaptchaenterpriseV1AppleDeveloperIdResponse>
  appleDeveloperId;
