...
class GoogleCloudRecaptchaenterpriseV1IOSKeySettingsResponse {
  ...
  factory GoogleCloudRecaptchaenterpriseV1IOSKeySettingsResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRecaptchaenterpriseV1IOSKeySettingsResponse(
      allowAllBundleIds: (map['allowAllBundleIds'] as bool).input(),
      allowedBundleIds: ((map['allowedBundleIds'] as List).cast<String>()).input(),
      appleDeveloperId: (GoogleCloudRecaptchaenterpriseV1AppleDeveloperIdResponse.fromMap((map['appleDeveloperId'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
