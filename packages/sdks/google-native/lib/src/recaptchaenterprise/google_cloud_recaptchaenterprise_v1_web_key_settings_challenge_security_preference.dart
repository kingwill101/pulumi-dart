...
enum GoogleCloudRecaptchaenterpriseV1WebKeySettingsChallengeSecurityPreference {
  ...
  const GoogleCloudRecaptchaenterpriseV1WebKeySettingsChallengeSecurityPreference(this.wireValue);
  final String wireValue;

  static GoogleCloudRecaptchaenterpriseV1WebKeySettingsChallengeSecurityPreference fromValue(String value) {
    for (final item in GoogleCloudRecaptchaenterpriseV1WebKeySettingsChallengeSecurityPreference.values) {
