...
class GoogleCloudRecaptchaenterpriseV1WebKeySettings {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'challengeSecurityPreference': ?pulumi.Input.mapOptionalInputValue<GoogleCloudRecaptchaenterpriseV1WebKeySettingsChallengeSecurityPreference, String>(challengeSecurityPreference, (value) => value.value),
      'integrationType': pulumi.Input.mapInputValue<GoogleCloudRecaptchaenterpriseV1WebKeySettingsIntegrationType, String>(integrationType, (value) => value.value),
    };
  }
