...
class GoogleCloudRecaptchaenterpriseV1WebKeySettings {
  ...
  final pulumi.Input<GoogleCloudRecaptchaenterpriseV1WebKeySettingsChallengeSecurityPreference>? challengeSecurityPreference;
  /// Describes how this key is integrated with the website.
  final pulumi.Input<GoogleCloudRecaptchaenterpriseV1WebKeySettingsIntegrationType> integrationType;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'challengeSecurityPreference': ?pulumi.Input.mapOptionalInputValue<GoogleCloudRecaptchaenterpriseV1WebKeySettingsChallengeSecurityPreference, String>(challengeSecurityPreference, (value) => value.wireValue),
      'integrationType': pulumi.Input.mapInputValue<GoogleCloudRecaptchaenterpriseV1WebKeySettingsIntegrationType, String>(integrationType, (value) => value.wireValue),
    };
  }
  ...
  factory GoogleCloudRecaptchaenterpriseV1WebKeySettings.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRecaptchaenterpriseV1WebKeySettings(
      ...
      challengeSecurityPreference: (() { final guardedValue = map['challengeSecurityPreference']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudRecaptchaenterpriseV1WebKeySettingsChallengeSecurityPreference.fromValue(guardedValue as String)); })(),
      integrationType: pulumi.Input.fromValue(GoogleCloudRecaptchaenterpriseV1WebKeySettingsIntegrationType.fromValue(map['integrationType']! as String)),
    );
  }
}
