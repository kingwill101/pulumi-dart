...
class GoogleCloudRecaptchaenterpriseV1FirewallActionResponse {
    ...
    return <String, dynamic>{
      ...
      'setHeader':
          pulumi.Input.mapInputValue<
            GoogleCloudRecaptchaenterpriseV1FirewallActionSetHeaderActionResponse,
            Map<String, dynamic>
          >(setHeader, (value) => value.toMap()),
      'substitute':
          pulumi.Input.mapInputValue<
            GoogleCloudRecaptchaenterpriseV1FirewallActionSubstituteActionResponse,
            Map<String, dynamic>
          >(substitute, (value) => value.toMap()),
    };
  }
  ...
  factory GoogleCloudRecaptchaenterpriseV1FirewallActionResponse.fromMap(
    ...
    return GoogleCloudRecaptchaenterpriseV1FirewallActionResponse(
      allow: pulumi.Input.fromValue(
        (map['allow']! as Map).cast<String, dynamic>(),
      ),
      block: pulumi.Input.fromValue(
        (map['block']! as Map).cast<String, dynamic>(),
      ),
      redirect: pulumi.Input.fromValue(
        (map['redirect']! as Map).cast<String, dynamic>(),
      ),
      setHeader: pulumi.Input.fromValue(
        GoogleCloudRecaptchaenterpriseV1FirewallActionSetHeaderActionResponse.fromMap(
          (map['setHeader']! as Map).cast<String, dynamic>(),
        ),
      ),
      substitute: pulumi.Input.fromValue(
        GoogleCloudRecaptchaenterpriseV1FirewallActionSubstituteActionResponse.fromMap(
          (map['substitute']! as Map).cast<String, dynamic>(),
        ),
      ),
    );
  }
