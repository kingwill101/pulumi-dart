...
class GoogleCloudRecaptchaenterpriseV1FirewallActionResponse {
  ...
  factory GoogleCloudRecaptchaenterpriseV1FirewallActionResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRecaptchaenterpriseV1FirewallActionResponse(
      allow: ((map['allow'] as Map).cast<String, dynamic>()).input(),
      block: ((map['block'] as Map).cast<String, dynamic>()).input(),
      redirect: ((map['redirect'] as Map).cast<String, dynamic>()).input(),
      setHeader: (GoogleCloudRecaptchaenterpriseV1FirewallActionSetHeaderActionResponse.fromMap((map['setHeader'] as Map).cast<String, dynamic>())).input(),
      substitute: (GoogleCloudRecaptchaenterpriseV1FirewallActionSubstituteActionResponse.fromMap((map['substitute'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
