...
class GoogleCloudOrgpolicyV2AlternatePolicySpec {
  ...
  const GoogleCloudOrgpolicyV2AlternatePolicySpec({
    this.launch,
    this.spec,
  });
  ...
  factory GoogleCloudOrgpolicyV2AlternatePolicySpec.fromMap(Map<String, dynamic> map) {
    return GoogleCloudOrgpolicyV2AlternatePolicySpec(
      launch: (() { final guardedValue = map['launch']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
