...
class GoogleCloudOrgpolicyV2PolicySpecResponse {
  ...
  factory GoogleCloudOrgpolicyV2PolicySpecResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudOrgpolicyV2PolicySpecResponse(
      ...
      rules: (pulumi.Input.decodeList<GoogleCloudOrgpolicyV2PolicySpecPolicyRuleResponse>(map['rules'], (value) => GoogleCloudOrgpolicyV2PolicySpecPolicyRuleResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
