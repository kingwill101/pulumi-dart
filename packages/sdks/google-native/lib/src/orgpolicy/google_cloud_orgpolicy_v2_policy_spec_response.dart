...
class GoogleCloudOrgpolicyV2PolicySpecResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'reset': reset,
      'rules': pulumi.Input.encodeList<GoogleCloudOrgpolicyV2PolicySpecPolicyRuleResponse, Map<String, dynamic>>(rules, (value) => value.toMap()),
  ...
  factory GoogleCloudOrgpolicyV2PolicySpecResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudOrgpolicyV2PolicySpecResponse(
      ...
      rules: pulumi.Input.decodeList<GoogleCloudOrgpolicyV2PolicySpecPolicyRuleResponse>(map['rules'], (value) => GoogleCloudOrgpolicyV2PolicySpecPolicyRuleResponse.fromMap((value as Map).cast<String, dynamic>())),
