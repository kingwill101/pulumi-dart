...
class GoogleCloudOrgpolicyV2PolicySpecResponse {
  ...
  final pulumi.Input<List<GoogleCloudOrgpolicyV2PolicySpecPolicyRuleResponse>> rules;
  ...
  const GoogleCloudOrgpolicyV2PolicySpecResponse({
    required this.etag,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'reset': reset,
      'rules': pulumi.Input.mapInputValue<List<GoogleCloudOrgpolicyV2PolicySpecPolicyRuleResponse>, List<Map<String, dynamic>>>(rules, (value) => pulumi.Input.encodeList<GoogleCloudOrgpolicyV2PolicySpecPolicyRuleResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'updateTime': updateTime,
    };
  }

  factory GoogleCloudOrgpolicyV2PolicySpecResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudOrgpolicyV2PolicySpecResponse(
      ...
      rules: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudOrgpolicyV2PolicySpecPolicyRuleResponse>(map['rules']!, (value) => GoogleCloudOrgpolicyV2PolicySpecPolicyRuleResponse.fromMap((value as Map).cast<String, dynamic>()))),
