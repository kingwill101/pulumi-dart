...
class GoogleCloudOrgpolicyV2PolicySpecPolicyRuleResponse {
  ...
  factory GoogleCloudOrgpolicyV2PolicySpecPolicyRuleResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudOrgpolicyV2PolicySpecPolicyRuleResponse(
      allowAll: (map['allowAll'] as bool).input(),
      condition: (GoogleTypeExprResponse.fromMap((map['condition'] as Map).cast<String, dynamic>())).input(),
      denyAll: (map['denyAll'] as bool).input(),
      enforce: (map['enforce'] as bool).input(),
      values: (GoogleCloudOrgpolicyV2PolicySpecPolicyRuleStringValuesResponse.fromMap((map['values'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
