    ...
    return <String, dynamic>{
      'actionType':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(actionType, (value) => value.wireValue),
      'condition': ?condition,
      'description': ?description,
      'displayName': ?displayName,
      'methodTypes':
          ?pulumi.Input.mapOptionalInputValue<
            List<CustomConstraintMethodTypesItem>,
            List<String>
          >(
            methodTypes,
            (value) =>
    ...
    return CustomConstraintArgs(
      actionType: (() {
        ...
        return pulumi.Input.fromValue(
          CustomConstraintActionType.fromValue(guardedValue as String),
        );
      })(),
      condition: (() {
      ...
      methodTypes: (() {
        final guardedValue = map['methodTypes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
