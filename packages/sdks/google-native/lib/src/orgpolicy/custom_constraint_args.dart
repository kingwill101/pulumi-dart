...
class CustomConstraintArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'actionType': ?pulumi.Input.mapOptionalInputValue<CustomConstraintActionType, String>(actionType, (value) => value.wireValue),
      'condition': ?condition,
      'description': ?description,
      'displayName': ?displayName,
      'methodTypes': ?pulumi.Input.mapOptionalInputValue<List<CustomConstraintMethodTypesItem>, List<String>>(methodTypes, (value) => pulumi.Input.encodeList<CustomConstraintMethodTypesItem, String>(value, (value) => value.wireValue)),
      'name': ?name,
  ...
  factory CustomConstraintArgs.fromMap(Map<String, dynamic> map) {
    return CustomConstraintArgs(
      actionType: (() { final guardedValue = map['actionType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CustomConstraintActionType.fromValue(guardedValue as String)); })(),
      ...
      methodTypes: (() { final guardedValue = map['methodTypes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<CustomConstraintMethodTypesItem>(guardedValue, (value) => CustomConstraintMethodTypesItem.fromValue(value as String))); })(),
