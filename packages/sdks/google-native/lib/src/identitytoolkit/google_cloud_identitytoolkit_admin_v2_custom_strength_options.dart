...
class GoogleCloudIdentitytoolkitAdminV2CustomStrengthOptions {
  ...
  factory GoogleCloudIdentitytoolkitAdminV2CustomStrengthOptions.fromMap(Map<String, dynamic> map) {
    return GoogleCloudIdentitytoolkitAdminV2CustomStrengthOptions(
      containsLowercaseCharacter: map['containsLowercaseCharacter'] == null ? null : map['containsLowercaseCharacter'] as bool,
      containsNonAlphanumericCharacter: map['containsNonAlphanumericCharacter'] == null ? null : map['containsNonAlphanumericCharacter'] as bool,
      containsNumericCharacter: map['containsNumericCharacter'] == null ? null : map['containsNumericCharacter'] as bool,
      containsUppercaseCharacter: map['containsUppercaseCharacter'] == null ? null : map['containsUppercaseCharacter'] as bool,
