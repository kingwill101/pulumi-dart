...
/// {@template pulumi_identitytoolkit_v2_tenant_iam_binding_args_doc}
/// The set of arguments for TenantIamBinding.
/// {@endtemplate}
/// {@macro pulumi_identitytoolkit_v2_tenant_iam_binding_args_doc}
class TenantIamBindingArgs {
  ...
  /// Creates a new [TenantIamBindingArgs].
  ...
  factory TenantIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return TenantIamBindingArgs(
