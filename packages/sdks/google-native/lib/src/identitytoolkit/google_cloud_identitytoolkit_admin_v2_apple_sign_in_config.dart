...
class GoogleCloudIdentitytoolkitAdminV2AppleSignInConfig {
  ...
  const GoogleCloudIdentitytoolkitAdminV2AppleSignInConfig({
    this.bundleIds,
    this.codeFlowConfig,
  });
  ...
  factory GoogleCloudIdentitytoolkitAdminV2AppleSignInConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudIdentitytoolkitAdminV2AppleSignInConfig(
      ...
      codeFlowConfig: (() { final guardedValue = map['codeFlowConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudIdentitytoolkitAdminV2CodeFlowConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
