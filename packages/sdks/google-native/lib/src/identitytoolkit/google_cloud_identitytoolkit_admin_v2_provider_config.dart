...
class GoogleCloudIdentitytoolkitAdminV2ProviderConfig {
  ...
  final pulumi.Input<GoogleCloudIdentitytoolkitAdminV2ProviderConfigState>?
  state;

  /// TOTP MFA provider config for this project.
  final pulumi.Input<GoogleCloudIdentitytoolkitAdminV2TotpMfaProviderConfig>?
  totpProviderConfig;
    ...
    return <String, dynamic>{
      ...
      'totpProviderConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(totpProviderConfig, (value) => value.toMap()),
    };
  }
  ...
  factory GoogleCloudIdentitytoolkitAdminV2ProviderConfig.fromMap(
    ...
    return GoogleCloudIdentitytoolkitAdminV2ProviderConfig(
      ...
      totpProviderConfig: (() {
        final guardedValue = map['totpProviderConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
