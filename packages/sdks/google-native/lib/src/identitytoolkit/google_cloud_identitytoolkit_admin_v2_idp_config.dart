...
class GoogleCloudIdentitytoolkitAdminV2IdpConfig {
  ...
  const GoogleCloudIdentitytoolkitAdminV2IdpConfig({
  ...
  factory GoogleCloudIdentitytoolkitAdminV2IdpConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudIdentitytoolkitAdminV2IdpConfig(
      idpCertificates: (() { final guardedValue = map['idpCertificates']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudIdentitytoolkitAdminV2IdpCertificate>(guardedValue, (value) => GoogleCloudIdentitytoolkitAdminV2IdpCertificate.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      ssoUrl: (() { final guardedValue = map['ssoUrl']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
