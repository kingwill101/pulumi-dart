...
class GoogleCloudIdentitytoolkitAdminV2IdpConfigResponse {
  ...
  factory GoogleCloudIdentitytoolkitAdminV2IdpConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudIdentitytoolkitAdminV2IdpConfigResponse(
      idpCertificates: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudIdentitytoolkitAdminV2IdpCertificateResponse>(map['idpCertificates']!, (value) => GoogleCloudIdentitytoolkitAdminV2IdpCertificateResponse.fromMap((value as Map).cast<String, dynamic>()))),
