...
class GoogleCloudIdentitytoolkitAdminV2PasswordPolicyConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'passwordPolicyEnforcementState': ?pulumi.Input.mapOptionalInputValue<GoogleCloudIdentitytoolkitAdminV2PasswordPolicyConfigPasswordPolicyEnforcementState, String>(passwordPolicyEnforcementState, (value) => value.wireValue),
  ...
  factory GoogleCloudIdentitytoolkitAdminV2PasswordPolicyConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudIdentitytoolkitAdminV2PasswordPolicyConfig(
      forceUpgradeOnSignin: (() { final guardedValue = map['forceUpgradeOnSignin']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      passwordPolicyEnforcementState: (() { final guardedValue = map['passwordPolicyEnforcementState']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudIdentitytoolkitAdminV2PasswordPolicyConfigPasswordPolicyEnforcementState.fromValue(guardedValue as String)); })(),
      passwordPolicyVersions: (() { final guardedValue = map['passwordPolicyVersions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudIdentitytoolkitAdminV2PasswordPolicyVersion>(guardedValue, (value) => GoogleCloudIdentitytoolkitAdminV2PasswordPolicyVersion.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
