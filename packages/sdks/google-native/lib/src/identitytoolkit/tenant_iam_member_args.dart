...
/// {@template pulumi_identitytoolkit_v2_tenant_iam_member_args_doc}
/// The set of arguments for TenantIamMember.
/// {@endtemplate}
/// {@macro pulumi_identitytoolkit_v2_tenant_iam_member_args_doc}
class TenantIamMemberArgs {
  ...
  /// Creates a new [TenantIamMemberArgs].
  ...
  factory TenantIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return TenantIamMemberArgs(
