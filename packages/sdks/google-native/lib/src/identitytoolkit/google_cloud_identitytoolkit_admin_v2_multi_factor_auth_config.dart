...
class GoogleCloudIdentitytoolkitAdminV2MultiFactorAuthConfig {
  ...
  final pulumi.Input<List<GoogleCloudIdentitytoolkitAdminV2ProviderConfig>>?
  providerConfigs;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'providerConfigs':
          ?pulumi.Input.mapOptionalInputValue<
            List<GoogleCloudIdentitytoolkitAdminV2ProviderConfig>,
    ...
    return GoogleCloudIdentitytoolkitAdminV2MultiFactorAuthConfig(
      enabledProviders: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                GoogleCloudIdentitytoolkitAdminV2MultiFactorAuthConfigEnabledProvidersItem.fromValue(
                  value as String,
                ),
          ),
        );
      ...
      providerConfigs: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => GoogleCloudIdentitytoolkitAdminV2ProviderConfig.fromMap(
      ...
      state: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GoogleCloudIdentitytoolkitAdminV2MultiFactorAuthConfigState.fromValue(
