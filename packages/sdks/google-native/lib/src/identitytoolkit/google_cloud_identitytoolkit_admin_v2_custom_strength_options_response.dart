...
class GoogleCloudIdentitytoolkitAdminV2CustomStrengthOptionsResponse {
  ...
  factory GoogleCloudIdentitytoolkitAdminV2CustomStrengthOptionsResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudIdentitytoolkitAdminV2CustomStrengthOptionsResponse(
      containsLowercaseCharacter: (map['containsLowercaseCharacter'] as bool).input(),
      containsNonAlphanumericCharacter: (map['containsNonAlphanumericCharacter'] as bool).input(),
      containsNumericCharacter: (map['containsNumericCharacter'] as bool).input(),
      containsUppercaseCharacter: (map['containsUppercaseCharacter'] as bool).input(),
      maxPasswordLength: (map['maxPasswordLength'] as int).input(),
      minPasswordLength: (map['minPasswordLength'] as int).input(),
    );
  }
}
