...
import 'tenant_iam_binding_args.dart';
...
class TenantIamBinding extends pulumi.CustomResource {
  ...
  /// Creates a new [TenantIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [TenantIamBinding]. {@macro pulumi_identitytoolkit_v2_tenant_iam_binding_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  TenantIamBinding(
    String name, {
    TenantIamBindingArgs? args,
