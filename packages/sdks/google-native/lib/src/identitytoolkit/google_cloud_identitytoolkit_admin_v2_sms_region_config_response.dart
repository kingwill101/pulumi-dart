...
class GoogleCloudIdentitytoolkitAdminV2SmsRegionConfigResponse {
  ...
  factory GoogleCloudIdentitytoolkitAdminV2SmsRegionConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudIdentitytoolkitAdminV2SmsRegionConfigResponse(
      allowByDefault: pulumi.Input.fromValue(GoogleCloudIdentitytoolkitAdminV2AllowByDefaultResponse.fromMap((map['allowByDefault']! as Map).cast<String, dynamic>())),
      allowlistOnly: pulumi.Input.fromValue(GoogleCloudIdentitytoolkitAdminV2AllowlistOnlyResponse.fromMap((map['allowlistOnly']! as Map).cast<String, dynamic>())),
    );
  }
}
