...
class GoogleCloudIdentitytoolkitAdminV2SmsRegionConfigResponse {
  ...
  final pulumi.Input<GoogleCloudIdentitytoolkitAdminV2AllowByDefaultResponse>
  allowByDefault;

  /// A policy of only allowing regions by explicitly adding them to an allowlist.
  final pulumi.Input<GoogleCloudIdentitytoolkitAdminV2AllowlistOnlyResponse>
  allowlistOnly;
