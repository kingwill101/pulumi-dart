...
class TenantArgs {
  ...
  factory TenantArgs.fromMap(Map<String, dynamic> map) {
    return TenantArgs(
      ...
      client: (() { final guardedValue = map['client']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudIdentitytoolkitAdminV2ClientPermissionConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      emailPrivacyConfig: (() { final guardedValue = map['emailPrivacyConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudIdentitytoolkitAdminV2EmailPrivacyConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      enableAnonymousUser: (() { final guardedValue = map['enableAnonymousUser']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      inheritance: (() { final guardedValue = map['inheritance']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudIdentitytoolkitAdminV2Inheritance.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      mfaConfig: (() { final guardedValue = map['mfaConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudIdentitytoolkitAdminV2MultiFactorAuthConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      monitoring: (() { final guardedValue = map['monitoring']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudIdentitytoolkitAdminV2MonitoringConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      passwordPolicyConfig: (() { final guardedValue = map['passwordPolicyConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudIdentitytoolkitAdminV2PasswordPolicyConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      project: (() { final guardedValue = map['project']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      recaptchaConfig: (() { final guardedValue = map['recaptchaConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudIdentitytoolkitAdminV2RecaptchaConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      smsRegionConfig: (() { final guardedValue = map['smsRegionConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudIdentitytoolkitAdminV2SmsRegionConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      testPhoneNumbers: (() { final guardedValue = map['testPhoneNumbers']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
    );
  }
}
