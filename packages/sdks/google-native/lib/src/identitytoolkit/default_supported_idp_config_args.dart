...
class DefaultSupportedIdpConfigArgs {
  ...
  factory DefaultSupportedIdpConfigArgs.fromMap(Map<String, dynamic> map) {
    return DefaultSupportedIdpConfigArgs(
      appleSignInConfig: (() { final guardedValue = map['appleSignInConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudIdentitytoolkitAdminV2AppleSignInConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
