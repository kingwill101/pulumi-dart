...
/// {@template pulumi_cloudbilling_v1_billing_account_iam_member_args_doc}
/// The set of arguments for BillingAccountIamMember.
/// {@endtemplate}
/// {@macro pulumi_cloudbilling_v1_billing_account_iam_member_args_doc}
class BillingAccountIamMemberArgs {
  ...
  /// Creates a new [BillingAccountIamMemberArgs].
  ...
  const BillingAccountIamMemberArgs({
    this.condition,
