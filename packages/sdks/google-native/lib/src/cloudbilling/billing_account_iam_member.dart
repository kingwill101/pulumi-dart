...
import 'billing_account_iam_member_args.dart';
...
class BillingAccountIamMember extends pulumi.CustomResource {
  ...
  /// Creates a new [BillingAccountIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [BillingAccountIamMember]. {@macro pulumi_cloudbilling_v1_billing_account_iam_member_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  BillingAccountIamMember(
    String name, {
    BillingAccountIamMemberArgs? args,
