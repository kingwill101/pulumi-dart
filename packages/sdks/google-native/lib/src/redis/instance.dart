...
class Instance extends pulumi.CustomResource {
  ...
  Instance(
    ...
    persistenceConfig = registerOutput<PersistenceConfigResponse>('persistenceConfig', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return PersistenceConfigResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
