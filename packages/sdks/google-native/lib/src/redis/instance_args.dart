    ...
    return InstanceArgs(
      ...
      connectMode: (() {
        ...
        return pulumi.Input.fromValue(
          InstanceConnectMode.fromValue(guardedValue as String),
        );
      })(),
      customerManagedKey: (() {
      ...
      readReplicasMode: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          InstanceReadReplicasMode.fromValue(guardedValue as String),
        );
      })(),
      redisConfigs: (() {
      ...
      suspensionReasons: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InstanceSuspensionReasonsItem>(
            guardedValue,
            (value) => InstanceSuspensionReasonsItem.fromValue(value as String),
          ),
        );
      })(),
      ...
      transitEncryptionMode: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          InstanceTransitEncryptionMode.fromValue(guardedValue as String),
        );
      })(),
    );
  }
