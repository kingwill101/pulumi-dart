...
class InstanceArgs {
  ...
  InstanceArgs({
    ...
    pulumi.Output<InstanceConnectMode>? connectMode,
    ...
    pulumi.Output<PersistenceConfig>? persistenceConfig,
    pulumi.Output<String>? project,
    pulumi.Output<InstanceReadReplicasMode>? readReplicasMode,
    ...
    pulumi.Output<List<InstanceSuspensionReasonsItem>>? suspensionReasons,
    required pulumi.Output<InstanceTier> tier,
    pulumi.Output<InstanceTransitEncryptionMode>? transitEncryptionMode,
  }) :
      ...
      connectMode = pulumi.Input.asOptionalInput<InstanceConnectMode>(connectMode),
      ...
      persistenceConfig = pulumi.Input.asOptionalInput<PersistenceConfig>(persistenceConfig),
      project = pulumi.Input.asOptionalInput<String>(project),
      readReplicasMode = pulumi.Input.asOptionalInput<InstanceReadReplicasMode>(readReplicasMode),
      ...
      suspensionReasons = pulumi.Input.asOptionalInput<List<InstanceSuspensionReasonsItem>>(suspensionReasons),
      tier = pulumi.Input.asInput<InstanceTier>(tier),
      transitEncryptionMode = pulumi.Input.asOptionalInput<InstanceTransitEncryptionMode>(transitEncryptionMode);
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      ...
      connectMode: map['connectMode'] == null ? null : pulumi.Output.create<InstanceConnectMode>(InstanceConnectMode.fromValue(map['connectMode'] as String)),
      ...
      persistenceConfig: map['persistenceConfig'] == null ? null : pulumi.Output.create<PersistenceConfig>(PersistenceConfig.fromMap((map['persistenceConfig'] as Map).cast<String, dynamic>())),
      project: map['project'] == null ? null : pulumi.Output.create<String>(map['project'] as String),
      readReplicasMode: map['readReplicasMode'] == null ? null : pulumi.Output.create<InstanceReadReplicasMode>(InstanceReadReplicasMode.fromValue(map['readReplicasMode'] as String)),
      ...
      suspensionReasons: map['suspensionReasons'] == null ? null : pulumi.Output.create<List<InstanceSuspensionReasonsItem>>(pulumi.Input.decodeList<InstanceSuspensionReasonsItem>(map['suspensionReasons'], (value) => InstanceSuspensionReasonsItem.fromValue(value as String))),
      tier: pulumi.Output.create<InstanceTier>(InstanceTier.fromValue(map['tier'] as String)),
      transitEncryptionMode: map['transitEncryptionMode'] == null ? null : pulumi.Output.create<InstanceTransitEncryptionMode>(InstanceTransitEncryptionMode.fromValue(map['transitEncryptionMode'] as String)),
    );
  }
}
