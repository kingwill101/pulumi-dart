...
class WeeklyMaintenanceWindowRedisV1beta1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'day': pulumi.Input.mapInputValue<WeeklyMaintenanceWindowDayRedisV1beta1, String>(day, (value) => value.value),
  ...
  factory WeeklyMaintenanceWindowRedisV1beta1.fromMap(Map<String, dynamic> map) {
    return WeeklyMaintenanceWindowRedisV1beta1(
      day: (WeeklyMaintenanceWindowDayRedisV1beta1.fromValue(map['day'] as String)).input(),
      startTime: (TimeOfDayRedisV1beta1.fromMap((map['startTime'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
