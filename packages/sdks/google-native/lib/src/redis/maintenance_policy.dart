...
class MaintenancePolicy {
  ...
  factory MaintenancePolicy.fromMap(Map<String, dynamic> map) {
    return MaintenancePolicy(
      ...
      weeklyMaintenanceWindow: (() { final guardedValue = map['weeklyMaintenanceWindow']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<WeeklyMaintenanceWindow>(guardedValue, (value) => WeeklyMaintenanceWindow.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
