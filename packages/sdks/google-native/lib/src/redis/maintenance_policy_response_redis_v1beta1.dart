...
class MaintenancePolicyResponseRedisV1beta1 {
  ...
  factory MaintenancePolicyResponseRedisV1beta1.fromMap(Map<String, dynamic> map) {
    return MaintenancePolicyResponseRedisV1beta1(
      ...
      weeklyMaintenanceWindow: pulumi.Input.fromValue(pulumi.Input.decodeList<WeeklyMaintenanceWindowResponseRedisV1beta1>(map['weeklyMaintenanceWindow']!, (value) => WeeklyMaintenanceWindowResponseRedisV1beta1.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
