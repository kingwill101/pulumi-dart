...
class PersistenceConfigRedisV1beta1 {
  ...
  final pulumi.Input<PersistenceConfigPersistenceModeRedisV1beta1>?
  persistenceMode;

  /// Optional. Period between RDB snapshots. Snapshots will be attempted every period starting from the provided snapshot start time. For example, a start time of 01/01/2033 06:45 and SIX_HOURS snapshot period will do nothing until 01/01/2033, and then trigger snapshots every day at 06:45, 12:45, 18:45, and 00:45 the next day, and so on. If not provided, TWENTY_FOUR_HOURS will be used as default.
  final pulumi.Input<PersistenceConfigRdbSnapshotPeriodRedisV1beta1>?
  rdbSnapshotPeriod;
    ...
    return <String, dynamic>{
      'persistenceMode':
          ?pulumi.Input.mapOptionalInputValue<
            PersistenceConfigPersistenceModeRedisV1beta1,
            String
          >(persistenceMode, (value) => value.wireValue),
      'rdbSnapshotPeriod':
          ?pulumi.Input.mapOptionalInputValue<
            PersistenceConfigRdbSnapshotPeriodRedisV1beta1,
            String
