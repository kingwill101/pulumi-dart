    ...
    return ClusterArgs(
      authorizationMode: (() {
        ...
        return pulumi.Input.fromValue(
          ClusterAuthorizationMode.fromValue(guardedValue as String),
        );
      })(),
      ...
      pscConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<PscConfig>(
          map['pscConfigs']!,
      ...
      transitEncryptionMode: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ClusterTransitEncryptionMode.fromValue(guardedValue as String),
        );
      })(),
    );
  }
