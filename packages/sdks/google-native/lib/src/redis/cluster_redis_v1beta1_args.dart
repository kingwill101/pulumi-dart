...
class ClusterRedisV1beta1Args {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'authorizationMode': ?pulumi.Input.mapOptionalInputValue<ClusterAuthorizationModeRedisV1beta1, String>(authorizationMode, (value) => value.wireValue),
      'clusterId': clusterId,
      'location': ?location,
      'name': ?name,
      'project': ?project,
      ...
      'transitEncryptionMode': ?pulumi.Input.mapOptionalInputValue<ClusterTransitEncryptionModeRedisV1beta1, String>(transitEncryptionMode, (value) => value.wireValue),
    };
  }

  factory ClusterRedisV1beta1Args.fromMap(Map<String, dynamic> map) {
    return ClusterRedisV1beta1Args(
      authorizationMode: (() { final guardedValue = map['authorizationMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterAuthorizationModeRedisV1beta1.fromValue(guardedValue as String)); })(),
      clusterId: pulumi.Input.fromValue(map['clusterId'] as String),
      location: (() { final guardedValue = map['location']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      project: (() { final guardedValue = map['project']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      pscConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<PscConfigRedisV1beta1>(map['pscConfigs']!, (value) => PscConfigRedisV1beta1.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      transitEncryptionMode: (() { final guardedValue = map['transitEncryptionMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterTransitEncryptionModeRedisV1beta1.fromValue(guardedValue as String)); })(),
    );
  }
}
