...
class PersistenceConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'persistenceMode': ?pulumi.Input.mapOptionalInputValue<PersistenceConfigPersistenceMode, String>(persistenceMode, (value) => value.value),
      'rdbSnapshotPeriod': ?pulumi.Input.mapOptionalInputValue<PersistenceConfigRdbSnapshotPeriod, String>(rdbSnapshotPeriod, (value) => value.value),
