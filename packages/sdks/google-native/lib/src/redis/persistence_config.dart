    ...
    return <String, dynamic>{
      'persistenceMode':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(persistenceMode, (value) => value.wireValue),
      'rdbSnapshotPeriod':
          ?pulumi.Input.mapOptionalInputValue<
            PersistenceConfigRdbSnapshotPeriod,
            String
          >(rdbSnapshotPeriod, (value) => value.wireValue),
    ...
    return PersistenceConfig(
      persistenceMode: (() {
        ...
        return pulumi.Input.fromValue(
          PersistenceConfigPersistenceMode.fromValue(guardedValue as String),
        );
      })(),
      rdbSnapshotPeriod: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PersistenceConfigRdbSnapshotPeriod.fromValue(guardedValue as String),
        );
      })(),
