    ...
    return <String, dynamic>{
      ...
      'connectMode':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(connectMode, (value) => value.wireValue),
      ...
      'readReplicasMode':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(readReplicasMode, (value) => value.wireValue),
    ...
    return InstanceRedisV1beta1Args(
      ...
      connectMode: (() {
        ...
        return pulumi.Input.fromValue(
          InstanceConnectModeRedisV1beta1.fromValue(guardedValue as String),
        );
      })(),
      customerManagedKey: (() {
      ...
      suspensionReasons: (() {
        final guardedValue = map['suspensionReasons'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      tier: pulumi.Input.fromValue(
        InstanceTierRedisV1beta1.fromValue(map['tier']! as String),
      ),
      transitEncryptionMode: (() {
