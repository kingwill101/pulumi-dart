...
class InstanceRedisV1beta1Args {
  ...
  factory InstanceRedisV1beta1Args.fromMap(Map<String, dynamic> map) {
    return InstanceRedisV1beta1Args(
      ...
      connectMode: map['connectMode'] == null ? null : (InstanceConnectModeRedisV1beta1.fromValue(map['connectMode']! as String)).input(),
      ...
      maintenancePolicy: map['maintenancePolicy'] == null ? null : (MaintenancePolicyRedisV1beta1.fromMap((map['maintenancePolicy']! as Map).cast<String, dynamic>())).input(),
      ...
      persistenceConfig: map['persistenceConfig'] == null ? null : (PersistenceConfigRedisV1beta1.fromMap((map['persistenceConfig']! as Map).cast<String, dynamic>())).input(),
      project: map['project'] == null ? null : (map['project']! as String).input(),
      readReplicasMode: map['readReplicasMode'] == null ? null : (InstanceReadReplicasModeRedisV1beta1.fromValue(map['readReplicasMode']! as String)).input(),
      ...
      suspensionReasons: map['suspensionReasons'] == null ? null : (pulumi.Input.decodeList<InstanceSuspensionReasonsItemRedisV1beta1>(map['suspensionReasons']!, (value) => InstanceSuspensionReasonsItemRedisV1beta1.fromValue(value as String))).input(),
      tier: (InstanceTierRedisV1beta1.fromValue(map['tier'] as String)).input(),
      transitEncryptionMode: map['transitEncryptionMode'] == null ? null : (InstanceTransitEncryptionModeRedisV1beta1.fromValue(map['transitEncryptionMode']! as String)).input(),
    );
  }
}
