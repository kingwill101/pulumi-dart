...
class InstanceRedisV1beta1Args {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'connectMode': ?pulumi.Input.mapOptionalInputValue<InstanceConnectModeRedisV1beta1, String>(connectMode, (value) => value.wireValue),
      ...
      'project': ?project,
      'readReplicasMode': ?pulumi.Input.mapOptionalInputValue<InstanceReadReplicasModeRedisV1beta1, String>(readReplicasMode, (value) => value.wireValue),
      'redisConfigs': ?redisConfigs,
      'redisVersion': ?redisVersion,
      'replicaCount': ?replicaCount,
      'reservedIpRange': ?reservedIpRange,
      'secondaryIpRange': ?secondaryIpRange,
      'suspensionReasons': ?pulumi.Input.mapOptionalInputValue<List<InstanceSuspensionReasonsItemRedisV1beta1>, List<String>>(suspensionReasons, (value) => pulumi.Input.encodeList<InstanceSuspensionReasonsItemRedisV1beta1, String>(value, (value) => value.wireValue)),
      'tier': pulumi.Input.mapInputValue<InstanceTierRedisV1beta1, String>(tier, (value) => value.wireValue),
      'transitEncryptionMode': ?pulumi.Input.mapOptionalInputValue<InstanceTransitEncryptionModeRedisV1beta1, String>(transitEncryptionMode, (value) => value.wireValue),
    };
  }
  ...
  factory InstanceRedisV1beta1Args.fromMap(Map<String, dynamic> map) {
    return InstanceRedisV1beta1Args(
      ...
      connectMode: (() { final guardedValue = map['connectMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceConnectModeRedisV1beta1.fromValue(guardedValue as String)); })(),
      ...
      maintenancePolicy: (() { final guardedValue = map['maintenancePolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MaintenancePolicyRedisV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      persistenceConfig: (() { final guardedValue = map['persistenceConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PersistenceConfigRedisV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      project: (() { final guardedValue = map['project']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      readReplicasMode: (() { final guardedValue = map['readReplicasMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceReadReplicasModeRedisV1beta1.fromValue(guardedValue as String)); })(),
      ...
      suspensionReasons: (() { final guardedValue = map['suspensionReasons']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InstanceSuspensionReasonsItemRedisV1beta1>(guardedValue, (value) => InstanceSuspensionReasonsItemRedisV1beta1.fromValue(value as String))); })(),
      tier: pulumi.Input.fromValue(InstanceTierRedisV1beta1.fromValue(map['tier']! as String)),
      transitEncryptionMode: (() { final guardedValue = map['transitEncryptionMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceTransitEncryptionModeRedisV1beta1.fromValue(guardedValue as String)); })(),
    );
  }
}
