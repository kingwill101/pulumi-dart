...
class InstanceRedisV1beta1Args {
  ...
  InstanceRedisV1beta1Args({
    ...
    pulumi.Output<InstanceConnectModeRedisV1beta1>? connectMode,
    pulumi.Output<String>? customerManagedKey,
    pulumi.Output<String>? displayName,
    required pulumi.Output<String> instanceId,
    pulumi.Output<Map<String, String>>? labels,
    pulumi.Output<String>? location,
    pulumi.Output<MaintenancePolicyRedisV1beta1>? maintenancePolicy,
    pulumi.Output<String>? maintenanceVersion,
    required pulumi.Output<int> memorySizeGb,
    pulumi.Output<String>? name,
    pulumi.Output<PersistenceConfigRedisV1beta1>? persistenceConfig,
    pulumi.Output<String>? project,
    pulumi.Output<InstanceReadReplicasModeRedisV1beta1>? readReplicasMode,
    ...
    pulumi.Output<List<InstanceSuspensionReasonsItemRedisV1beta1>>? suspensionReasons,
    required pulumi.Output<InstanceTierRedisV1beta1> tier,
    pulumi.Output<InstanceTransitEncryptionModeRedisV1beta1>? transitEncryptionMode,
  }) :
  ...
  factory InstanceRedisV1beta1Args.fromMap(Map<String, dynamic> map) {
    return InstanceRedisV1beta1Args(
      ...
      connectMode: map['connectMode'] == null ? null : pulumi.Output.create<InstanceConnectModeRedisV1beta1>(InstanceConnectModeRedisV1beta1.fromValue(map['connectMode'] as String)),
      ...
      maintenancePolicy: map['maintenancePolicy'] == null ? null : pulumi.Output.create<MaintenancePolicyRedisV1beta1>(MaintenancePolicyRedisV1beta1.fromMap((map['maintenancePolicy'] as Map).cast<String, dynamic>())),
      maintenanceVersion: map['maintenanceVersion'] == null ? null : pulumi.Output.create<String>(map['maintenanceVersion'] as String),
      memorySizeGb: pulumi.Output.create<int>(map['memorySizeGb'] as int),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      persistenceConfig: map['persistenceConfig'] == null ? null : pulumi.Output.create<PersistenceConfigRedisV1beta1>(PersistenceConfigRedisV1beta1.fromMap((map['persistenceConfig'] as Map).cast<String, dynamic>())),
      project: map['project'] == null ? null : pulumi.Output.create<String>(map['project'] as String),
      readReplicasMode: map['readReplicasMode'] == null ? null : pulumi.Output.create<InstanceReadReplicasModeRedisV1beta1>(InstanceReadReplicasModeRedisV1beta1.fromValue(map['readReplicasMode'] as String)),
      ...
      suspensionReasons: map['suspensionReasons'] == null ? null : pulumi.Output.create<List<InstanceSuspensionReasonsItemRedisV1beta1>>(pulumi.Input.decodeList<InstanceSuspensionReasonsItemRedisV1beta1>(map['suspensionReasons'], (value) => InstanceSuspensionReasonsItemRedisV1beta1.fromValue(value as String))),
      tier: pulumi.Output.create<InstanceTierRedisV1beta1>(InstanceTierRedisV1beta1.fromValue(map['tier'] as String)),
      transitEncryptionMode: map['transitEncryptionMode'] == null ? null : pulumi.Output.create<InstanceTransitEncryptionModeRedisV1beta1>(InstanceTransitEncryptionModeRedisV1beta1.fromValue(map['transitEncryptionMode'] as String)),
    );
  }
}
