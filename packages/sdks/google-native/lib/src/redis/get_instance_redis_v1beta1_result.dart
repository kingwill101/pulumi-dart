...
class GetInstanceRedisV1beta1Result {
  ...
  factory GetInstanceRedisV1beta1Result.fromMap(Map<String, dynamic> map) {
    return GetInstanceRedisV1beta1Result(
      ...
      maintenancePolicy: MaintenancePolicyResponseRedisV1beta1.fromMap(
        (map['maintenancePolicy']! as Map).cast<String, dynamic>(),
      ),
      maintenanceSchedule: MaintenanceScheduleResponseRedisV1beta1.fromMap(
      ...
      nodes: pulumi.Input.decodeList<NodeInfoResponseRedisV1beta1>(
        map['nodes']!,
        (value) => NodeInfoResponseRedisV1beta1.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      persistenceConfig: PersistenceConfigResponseRedisV1beta1.fromMap(
      ...
      serverCaCerts:
          pulumi.Input.decodeList<TlsCertificateResponseRedisV1beta1>(
            map['serverCaCerts']!,
            (value) => TlsCertificateResponseRedisV1beta1.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
