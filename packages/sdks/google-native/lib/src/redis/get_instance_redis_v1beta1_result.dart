...
class GetInstanceRedisV1beta1Result {
  ...
  final MaintenancePolicyResponseRedisV1beta1 maintenancePolicy;
  /// Date and time of upcoming maintenance events which have been scheduled.
  final MaintenanceScheduleResponseRedisV1beta1 maintenanceSchedule;
  ...
  final String name;
  /// Info per node.
  final List<NodeInfoResponseRedisV1beta1> nodes;
  /// Optional. Persistence configuration parameters
  final PersistenceConfigResponseRedisV1beta1 persistenceConfig;
  ...
  final List<TlsCertificateResponseRedisV1beta1> serverCaCerts;
  ...
  /// Creates a new [GetInstanceRedisV1beta1Result].
  ...
  const GetInstanceRedisV1beta1Result({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': name,
      'nodes': pulumi.Input.encodeList<NodeInfoResponseRedisV1beta1, Map<String, dynamic>>(nodes, (value) => value.toMap()),
      ...
      'serverCaCerts': pulumi.Input.encodeList<TlsCertificateResponseRedisV1beta1, Map<String, dynamic>>(serverCaCerts, (value) => value.toMap()),
      'state': state,
  ...
  factory GetInstanceRedisV1beta1Result.fromMap(Map<String, dynamic> map) {
    return GetInstanceRedisV1beta1Result(
      ...
      maintenancePolicy: MaintenancePolicyResponseRedisV1beta1.fromMap((map['maintenancePolicy']! as Map).cast<String, dynamic>()),
      maintenanceSchedule: MaintenanceScheduleResponseRedisV1beta1.fromMap((map['maintenanceSchedule']! as Map).cast<String, dynamic>()),
      maintenanceVersion: map['maintenanceVersion'] as String,
      memorySizeGb: map['memorySizeGb'] as int,
      name: map['name'] as String,
      nodes: pulumi.Input.decodeList<NodeInfoResponseRedisV1beta1>(map['nodes']!, (value) => NodeInfoResponseRedisV1beta1.fromMap((value as Map).cast<String, dynamic>())),
      persistenceConfig: PersistenceConfigResponseRedisV1beta1.fromMap((map['persistenceConfig']! as Map).cast<String, dynamic>()),
      ...
      serverCaCerts: pulumi.Input.decodeList<TlsCertificateResponseRedisV1beta1>(map['serverCaCerts']!, (value) => TlsCertificateResponseRedisV1beta1.fromMap((value as Map).cast<String, dynamic>())),
