...
class DisksMigrationVmTargetDefaults {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'bootDiskDefaults': ?bootDiskDefaults == null ? null : bootDiskDefaults!.toMap(),
  ...
  factory DisksMigrationVmTargetDefaults.fromMap(Map<String, dynamic> map) {
    return DisksMigrationVmTargetDefaults(
      ...
      bootDiskDefaults: map['bootDiskDefaults'] == null ? null : BootDiskDefaults.fromMap((map['bootDiskDefaults'] as Map).cast<String, dynamic>()),
