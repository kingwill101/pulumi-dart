...
class CutoverJobResponseVmmigrationV1alpha1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'stateTime': stateTime,
      'steps': pulumi.Input.mapInputValue<List<CutoverStepResponseVmmigrationV1alpha1>, List<Map<String, dynamic>>>(steps, (value) => pulumi.Input.encodeList<CutoverStepResponseVmmigrationV1alpha1, Map<String, dynamic>>(value, (value) => value.toMap())),
      'targetDetails': pulumi.Input.mapInputValue<TargetVMDetailsResponse, Map<String, dynamic>>(targetDetails, (value) => value.toMap()),
    };
  }

  factory CutoverJobResponseVmmigrationV1alpha1.fromMap(Map<String, dynamic> map) {
    return CutoverJobResponseVmmigrationV1alpha1(
      computeEngineDisksTargetDetails: pulumi.Input.fromValue(ComputeEngineDisksTargetDetailsResponseVmmigrationV1alpha1.fromMap((map['computeEngineDisksTargetDetails']! as Map).cast<String, dynamic>())),
      computeEngineTargetDetails: pulumi.Input.fromValue(ComputeEngineTargetDetailsResponseVmmigrationV1alpha1.fromMap((map['computeEngineTargetDetails']! as Map).cast<String, dynamic>())),
      computeEngineVmDetails: pulumi.Input.fromValue(TargetVMDetailsResponse.fromMap((map['computeEngineVmDetails']! as Map).cast<String, dynamic>())),
      ...
      steps: pulumi.Input.fromValue(pulumi.Input.decodeList<CutoverStepResponseVmmigrationV1alpha1>(map['steps']!, (value) => CutoverStepResponseVmmigrationV1alpha1.fromMap((value as Map).cast<String, dynamic>()))),
      targetDetails: pulumi.Input.fromValue(TargetVMDetailsResponse.fromMap((map['targetDetails']! as Map).cast<String, dynamic>())),
    );
  }
}
