...
class PersistentDiskDefaultsVmmigrationV1alpha1 {
  ...
  final pulumi.Input<PersistentDiskDefaultsDiskTypeVmmigrationV1alpha1>?
  diskType;
  ...
  final pulumi.Input<VmAttachmentDetailsVmmigrationV1alpha1>?
  vmAttachmentDetails;
    ...
    return <String, dynamic>{
      ...
      'diskType':
          ?pulumi.Input.mapOptionalInputValue<
            PersistentDiskDefaultsDiskTypeVmmigrationV1alpha1,
            String
  ...
  factory PersistentDiskDefaultsVmmigrationV1alpha1.fromMap(
    ...
    return PersistentDiskDefaultsVmmigrationV1alpha1(
      additionalLabels: (() {
        final guardedValue = map['additionalLabels'];
      ...
      vmAttachmentDetails: (() {
        final guardedValue = map['vmAttachmentDetails'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
