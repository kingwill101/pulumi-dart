...
class VmwareVmDetailsVmmigrationV1alpha1 {
  ...
  const VmwareVmDetailsVmmigrationV1alpha1({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'memoryMb': ?memoryMb,
      'powerState': ?pulumi.Input.mapOptionalInputValue<VmwareVmDetailsPowerStateVmmigrationV1alpha1, String>(powerState, (value) => value.wireValue),
      'uuid': ?uuid,
      'vmId': ?vmId,
    };
  }
  ...
  factory VmwareVmDetailsVmmigrationV1alpha1.fromMap(Map<String, dynamic> map) {
    return VmwareVmDetailsVmmigrationV1alpha1(
      committedStorage: (() { final guardedValue = map['committedStorage']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      powerState: (() { final guardedValue = map['powerState']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VmwareVmDetailsPowerStateVmmigrationV1alpha1.fromValue(guardedValue as String)); })(),
