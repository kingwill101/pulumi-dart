...
class SchedulePolicyVmmigrationV1alpha1 {
  ...
  const SchedulePolicyVmmigrationV1alpha1({
    this.idleDuration,
  ...
  factory SchedulePolicyVmmigrationV1alpha1.fromMap(Map<String, dynamic> map) {
    return SchedulePolicyVmmigrationV1alpha1(
      ...
      skipOsAdaptation: (() { final guardedValue = map['skipOsAdaptation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
    );
  }
}
