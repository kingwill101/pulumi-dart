...
class AwsSourceDetailsResponseVmmigrationV1alpha1 {
  ...
  final pulumi.Input<AccessKeyCredentialsResponseVmmigrationV1alpha1>
  accessKeyCreds;
    ...
    return <String, dynamic>{
      'accessKeyCreds':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(accessKeyCreds, (value) => value.toMap()),
      'awsRegion': awsRegion,
      'error':
          pulumi.Input.mapInputValue<
      ...
      'inventoryTagList':
          pulumi.Input.mapInputValue<
            List<TagResponseVmmigrationV1alpha1>,
  ...
  factory AwsSourceDetailsResponseVmmigrationV1alpha1.fromMap(
    ...
    return AwsSourceDetailsResponseVmmigrationV1alpha1(
      accessKeyCreds: pulumi.Input.fromValue(
        AccessKeyCredentialsResponseVmmigrationV1alpha1.fromMap(
      ...
      inventorySecurityGroupNames: pulumi.Input.fromValue(
        (map['inventorySecurityGroupNames'] as List).cast<String>(),
      ),
      inventoryTagList: pulumi.Input.fromValue(
        pulumi.Input.decodeList<TagResponseVmmigrationV1alpha1>(
      ...
      migrationResourcesUserTags: pulumi.Input.fromValue(
