...
class TargetVMDetails {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'diskType': ?pulumi.Input.mapOptionalInputValue<TargetVMDetailsDiskType, String>(diskType, (value) => value.wireValue),
      'externalIp': ?externalIp,
      'internalIp': ?internalIp,
      'labels': ?labels,
      'licenseType': ?pulumi.Input.mapOptionalInputValue<TargetVMDetailsLicenseType, String>(licenseType, (value) => value.wireValue),
  ...
  factory TargetVMDetails.fromMap(Map<String, dynamic> map) {
    return TargetVMDetails(
      ...
      diskType: (() { final guardedValue = map['diskType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TargetVMDetailsDiskType.fromValue(guardedValue as String)); })(),
      ...
      licenseType: (() { final guardedValue = map['licenseType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TargetVMDetailsLicenseType.fromValue(guardedValue as String)); })(),
