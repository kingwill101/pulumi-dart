...
class ComputeSchedulingVmmigrationV1alpha1 {
  ...
  final pulumi.Input<List<SchedulingNodeAffinityVmmigrationV1alpha1>>?
  nodeAffinities;

  /// How the instance should behave when the host machine undergoes maintenance that may temporarily impact instance performance.
  final pulumi.Input<ComputeSchedulingOnHostMaintenanceVmmigrationV1alpha1>?
  onHostMaintenance;

  /// Whether the Instance should be automatically restarted whenever it is terminated by Compute Engine (not terminated by user). This configuration is identical to `automaticRestart` field in Compute Engine create instance under scheduling. It was changed to an enum (instead of a boolean) to match the default value in Compute Engine which is automatic restart.
  final pulumi.Input<ComputeSchedulingRestartTypeVmmigrationV1alpha1>?
  restartType;
    ...
    return <String, dynamic>{
      ...
      'nodeAffinities':
          ?pulumi.Input.mapOptionalInputValue<
            List<SchedulingNodeAffinityVmmigrationV1alpha1>,
      ...
      'onHostMaintenance':
          ?pulumi.Input.mapOptionalInputValue<
            ComputeSchedulingOnHostMaintenanceVmmigrationV1alpha1,
            String
          >(onHostMaintenance, (value) => value.wireValue),
      'restartType':
          ?pulumi.Input.mapOptionalInputValue<
            ComputeSchedulingRestartTypeVmmigrationV1alpha1,
            String
          >(restartType, (value) => value.wireValue),
    };
  }

  factory ComputeSchedulingVmmigrationV1alpha1.fromMap(
    ...
    return ComputeSchedulingVmmigrationV1alpha1(
      ...
      nodeAffinities: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SchedulingNodeAffinityVmmigrationV1alpha1>(
            guardedValue,
            (value) => SchedulingNodeAffinityVmmigrationV1alpha1.fromMap(
      ...
      onHostMaintenance: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ComputeSchedulingOnHostMaintenanceVmmigrationV1alpha1.fromValue(
      ...
      restartType: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ComputeSchedulingRestartTypeVmmigrationV1alpha1.fromValue(
            guardedValue as String,
          ),
        );
      })(),
