...
class ComputeSchedulingVmmigrationV1alpha1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'onHostMaintenance': ?pulumi.Input.mapOptionalInputValue<ComputeSchedulingOnHostMaintenanceVmmigrationV1alpha1, String>(onHostMaintenance, (value) => value.value),
      'restartType': ?pulumi.Input.mapOptionalInputValue<ComputeSchedulingRestartTypeVmmigrationV1alpha1, String>(restartType, (value) => value.value),
    };
  }
