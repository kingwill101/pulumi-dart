...
class GetDatacenterConnectorVmmigrationV1alpha1Result {
  ...
  const GetDatacenterConnectorVmmigrationV1alpha1Result({
  ...
  factory GetDatacenterConnectorVmmigrationV1alpha1Result.fromMap(Map<String, dynamic> map) {
    return GetDatacenterConnectorVmmigrationV1alpha1Result(
      applianceInfrastructureVersion: map['applianceInfrastructureVersion'] as String,
      applianceSoftwareVersion: map['applianceSoftwareVersion'] as String,
      availableVersions: AvailableUpdatesResponseVmmigrationV1alpha1.fromMap((map['availableVersions']! as Map).cast<String, dynamic>()),
      ...
      upgradeStatus: UpgradeStatusResponseVmmigrationV1alpha1.fromMap((map['upgradeStatus']! as Map).cast<String, dynamic>()),
