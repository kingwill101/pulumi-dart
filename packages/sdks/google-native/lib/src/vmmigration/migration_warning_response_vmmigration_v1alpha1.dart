...
class MigrationWarningResponseVmmigrationV1alpha1 {
  ...
  final pulumi.Input<LocalizedMessageResponseVmmigrationV1alpha1>
  warningMessage;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'helpLinks':
          pulumi.Input.mapInputValue<
            List<LinkResponseVmmigrationV1alpha1>,
  ...
  factory MigrationWarningResponseVmmigrationV1alpha1.fromMap(
    ...
    return MigrationWarningResponseVmmigrationV1alpha1(
      actionItem: pulumi.Input.fromValue(
        LocalizedMessageResponseVmmigrationV1alpha1.fromMap(
          (map['actionItem']! as Map).cast<String, dynamic>(),
        ),
      ),
      code: pulumi.Input.fromValue(map['code'] as String),
      helpLinks: pulumi.Input.fromValue(
        pulumi.Input.decodeList<LinkResponseVmmigrationV1alpha1>(
          map['helpLinks']!,
