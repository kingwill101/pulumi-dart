...
class CloneJobVmmigrationV1alpha1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<CloneStepResponseVmmigrationV1alpha1>> steps;
  ...
  CloneJobVmmigrationV1alpha1(
    ...
    this.computeEngineDisksTargetDetails = registerOutput<ComputeEngineDisksTargetDetailsResponseVmmigrationV1alpha1>('computeEngineDisksTargetDetails');
    this.computeEngineTargetDetails = registerOutput<ComputeEngineTargetDetailsResponseVmmigrationV1alpha1>('computeEngineTargetDetails');
    this.computeEngineVmDetails = registerOutput<TargetVMDetailsResponse>('computeEngineVmDetails');
    ...
    this.steps = registerOutput<List<CloneStepResponseVmmigrationV1alpha1>>('steps');
    this.targetDetails = registerOutput<TargetVMDetailsResponse>('targetDetails');
  }
}
