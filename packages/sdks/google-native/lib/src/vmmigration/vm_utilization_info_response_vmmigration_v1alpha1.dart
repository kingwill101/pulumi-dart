...
class VmUtilizationInfoResponseVmmigrationV1alpha1 {
  ...
  final pulumi.Input<VmUtilizationMetricsResponseVmmigrationV1alpha1>
  utilization;
  ...
  final pulumi.Input<VmwareVmDetailsResponseVmmigrationV1alpha1>
  vmwareVmDetails;
  ...
  factory VmUtilizationInfoResponseVmmigrationV1alpha1.fromMap(
    ...
    return VmUtilizationInfoResponseVmmigrationV1alpha1(
      utilization: pulumi.Input.fromValue(
        VmUtilizationMetricsResponseVmmigrationV1alpha1.fromMap(
      ...
      vmwareVmDetails: pulumi.Input.fromValue(
        VmwareVmDetailsResponseVmmigrationV1alpha1.fromMap(
