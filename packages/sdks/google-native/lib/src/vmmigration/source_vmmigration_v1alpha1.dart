...
class SourceVmmigrationV1alpha1 extends pulumi.CustomResource {
  ...
  SourceVmmigrationV1alpha1(
    ...
    aws = registerOutput<AwsSourceDetailsResponseVmmigrationV1alpha1>('aws', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return AwsSourceDetailsResponseVmmigrationV1alpha1.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    azure = registerOutput<AzureSourceDetailsResponseVmmigrationV1alpha1>('azure', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return AzureSourceDetailsResponseVmmigrationV1alpha1.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    createTime = registerOutput<String>('createTime');
    description = registerOutput<String>('description');
    encryption = registerOutput<EncryptionResponseVmmigrationV1alpha1>('encryption', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return EncryptionResponseVmmigrationV1alpha1.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    vmware = registerOutput<VmwareSourceDetailsResponseVmmigrationV1alpha1>('vmware', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return VmwareSourceDetailsResponseVmmigrationV1alpha1.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  }
}
