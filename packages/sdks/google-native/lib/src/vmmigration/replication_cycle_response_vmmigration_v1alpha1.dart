...
class ReplicationCycleResponseVmmigrationV1alpha1 {
  ...
  final pulumi.Input<List<MigrationWarningResponseVmmigrationV1alpha1>>
  warnings;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'steps':
          pulumi.Input.mapInputValue<
            List<CycleStepResponseVmmigrationV1alpha1>,
      ...
      'warnings':
          pulumi.Input.mapInputValue<
            List<MigrationWarningResponseVmmigrationV1alpha1>,
            List<Map<String, dynamic>>
          >(
            warnings,
            (value) =>
  ...
  factory ReplicationCycleResponseVmmigrationV1alpha1.fromMap(
    ...
    return ReplicationCycleResponseVmmigrationV1alpha1(
      ...
      steps: pulumi.Input.fromValue(
        pulumi.Input.decodeList<CycleStepResponseVmmigrationV1alpha1>(
          map['steps']!,
