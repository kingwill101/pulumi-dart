...
class MigratingVmArgs {
  ...
  factory MigratingVmArgs.fromMap(Map<String, dynamic> map) {
    return MigratingVmArgs(
      computeEngineDisksTargetDefaults: (() { final guardedValue = map['computeEngineDisksTargetDefaults']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ComputeEngineDisksTargetDefaults.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      computeEngineTargetDefaults: (() { final guardedValue = map['computeEngineTargetDefaults']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ComputeEngineTargetDefaults.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      policy: (() { final guardedValue = map['policy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SchedulePolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
