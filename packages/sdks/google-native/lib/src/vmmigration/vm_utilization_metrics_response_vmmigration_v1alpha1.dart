...
class VmUtilizationMetricsResponseVmmigrationV1alpha1 {
  ...
  factory VmUtilizationMetricsResponseVmmigrationV1alpha1.fromMap(Map<String, dynamic> map) {
    return VmUtilizationMetricsResponseVmmigrationV1alpha1(
      ...
      cpuAveragePercent: pulumi.Input.fromValue(map['cpuAveragePercent'] as int),
      cpuMax: pulumi.Input.fromValue(map['cpuMax'] as int),
      cpuMaxPercent: pulumi.Input.fromValue(map['cpuMaxPercent'] as int),
      diskIoRateAverage: pulumi.Input.fromValue(map['diskIoRateAverage'] as String),
      diskIoRateAverageKbps: pulumi.Input.fromValue(map['diskIoRateAverageKbps'] as String),
      diskIoRateMax: pulumi.Input.fromValue(map['diskIoRateMax'] as String),
      diskIoRateMaxKbps: pulumi.Input.fromValue(map['diskIoRateMaxKbps'] as String),
      memoryAverage: pulumi.Input.fromValue(map['memoryAverage'] as int),
      memoryAveragePercent: pulumi.Input.fromValue(map['memoryAveragePercent'] as int),
      memoryMax: pulumi.Input.fromValue(map['memoryMax'] as int),
      memoryMaxPercent: pulumi.Input.fromValue(map['memoryMaxPercent'] as int),
      networkThroughputAverage: pulumi.Input.fromValue(map['networkThroughputAverage'] as String),
      networkThroughputAverageKbps: pulumi.Input.fromValue(map['networkThroughputAverageKbps'] as String),
      networkThroughputMax: pulumi.Input.fromValue(map['networkThroughputMax'] as String),
      networkThroughputMaxKbps: pulumi.Input.fromValue(map['networkThroughputMaxKbps'] as String),
    );
  }
}
