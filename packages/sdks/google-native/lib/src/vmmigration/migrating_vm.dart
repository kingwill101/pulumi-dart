...
class MigratingVm extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<CloneJobResponse>> recentCloneJobs;
  ...
  late final pulumi.Output<List<CutoverJobResponse>> recentCutoverJobs;
  ...
  MigratingVm(
    ...
    this.awsSourceVmDetails = registerOutput<AwsSourceVmDetailsResponse>('awsSourceVmDetails');
    this.azureSourceVmDetails = registerOutput<AzureSourceVmDetailsResponse>('azureSourceVmDetails');
    this.computeEngineDisksTargetDefaults = registerOutput<ComputeEngineDisksTargetDefaultsResponse>('computeEngineDisksTargetDefaults');
    this.computeEngineTargetDefaults = registerOutput<ComputeEngineTargetDefaultsResponse>('computeEngineTargetDefaults');
    this.createTime = registerOutput<String>('createTime');
    this.currentSyncInfo = registerOutput<ReplicationCycleResponse>('currentSyncInfo');
    this.cutoverForecast = registerOutput<CutoverForecastResponse>('cutoverForecast');
    this.description = registerOutput<String>('description');
    this.displayName = registerOutput<String>('displayName');
    this.error = registerOutput<StatusResponse>('error');
    this.group = registerOutput<String>('group');
    this.labels = registerOutput<Map<String, String>>('labels');
    this.lastReplicationCycle = registerOutput<ReplicationCycleResponse>('lastReplicationCycle');
    ...
    this.recentCloneJobs = registerOutput<List<CloneJobResponse>>('recentCloneJobs');
    this.recentCutoverJobs = registerOutput<List<CutoverJobResponse>>('recentCutoverJobs');
    ...
    this.vmwareSourceVmDetails = registerOutput<VmwareSourceVmDetailsResponse>('vmwareSourceVmDetails');
  }
}
