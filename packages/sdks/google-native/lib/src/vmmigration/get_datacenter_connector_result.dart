...
class GetDatacenterConnectorResult {
  ...
  /// Creates a new [GetDatacenterConnectorResult].
  ...
  factory GetDatacenterConnectorResult.fromMap(Map<String, dynamic> map) {
    return GetDatacenterConnectorResult(
      ...
      availableVersions: AvailableUpdatesResponse.fromMap((map['availableVersions']! as Map).cast<String, dynamic>()),
      ...
      upgradeStatus: UpgradeStatusResponse.fromMap((map['upgradeStatus']! as Map).cast<String, dynamic>()),
