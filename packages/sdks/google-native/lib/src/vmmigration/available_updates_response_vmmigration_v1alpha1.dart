...
class AvailableUpdatesResponseVmmigrationV1alpha1 {
  ...
  factory AvailableUpdatesResponseVmmigrationV1alpha1.fromMap(Map<String, dynamic> map) {
    return AvailableUpdatesResponseVmmigrationV1alpha1(
      inPlaceUpdate: (ApplianceVersionResponseVmmigrationV1alpha1.fromMap((map['inPlaceUpdate'] as Map).cast<String, dynamic>())).input(),
      newDeployableAppliance: (ApplianceVersionResponseVmmigrationV1alpha1.fromMap((map['newDeployableAppliance'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
