...
class ComputeSchedulingResponseVmmigrationV1alpha1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'nodeAffinities': pulumi.Input.encodeList<SchedulingNodeAffinityResponseVmmigrationV1alpha1, Map<String, dynamic>>(nodeAffinities, (value) => value.toMap()),
  ...
  factory ComputeSchedulingResponseVmmigrationV1alpha1.fromMap(Map<String, dynamic> map) {
    return ComputeSchedulingResponseVmmigrationV1alpha1(
      ...
      nodeAffinities: pulumi.Input.decodeList<SchedulingNodeAffinityResponseVmmigrationV1alpha1>(map['nodeAffinities'], (value) => SchedulingNodeAffinityResponseVmmigrationV1alpha1.fromMap((value as Map).cast<String, dynamic>())),
