...
class ComputeSchedulingResponseVmmigrationV1alpha1 {
  ...
  const ComputeSchedulingResponseVmmigrationV1alpha1({
  ...
  factory ComputeSchedulingResponseVmmigrationV1alpha1.fromMap(Map<String, dynamic> map) {
    return ComputeSchedulingResponseVmmigrationV1alpha1(
      ...
      nodeAffinities: pulumi.Input.fromValue(pulumi.Input.decodeList<SchedulingNodeAffinityResponseVmmigrationV1alpha1>(map['nodeAffinities']!, (value) => SchedulingNodeAffinityResponseVmmigrationV1alpha1.fromMap((value as Map).cast<String, dynamic>()))),
