...
class GroupVmmigrationV1alpha1Args {
  ...
  final pulumi.Input<GroupMigrationTargetTypeVmmigrationV1alpha1>?
  migrationTargetType;
    ...
    return <String, dynamic>{
      ...
      'migrationTargetType':
          ?pulumi.Input.mapOptionalInputValue<
            GroupMigrationTargetTypeVmmigrationV1alpha1,
            String
          >(migrationTargetType, (value) => value.wireValue),
      'project': ?project,
      'requestId': ?requestId,
    };
  }
  ...
  factory GroupVmmigrationV1alpha1Args.fromMap(Map<String, dynamic> map) {
    return GroupVmmigrationV1alpha1Args(
      ...
      migrationTargetType: (() {
        final guardedValue = map['migrationTargetType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GroupMigrationTargetTypeVmmigrationV1alpha1.fromValue(
