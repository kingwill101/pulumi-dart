...
class AwsSourceVmDetailsResponseVmmigrationV1alpha1 {
  ...
  const AwsSourceVmDetailsResponseVmmigrationV1alpha1({
  ...
  factory AwsSourceVmDetailsResponseVmmigrationV1alpha1.fromMap(Map<String, dynamic> map) {
    return AwsSourceVmDetailsResponseVmmigrationV1alpha1(
      ...
      disks: pulumi.Input.fromValue(pulumi.Input.decodeList<AwsDiskDetailsResponseVmmigrationV1alpha1>(map['disks']!, (value) => AwsDiskDetailsResponseVmmigrationV1alpha1.fromMap((value as Map).cast<String, dynamic>()))),
