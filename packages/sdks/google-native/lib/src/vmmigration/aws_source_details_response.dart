...
class AwsSourceDetailsResponse {
  ...
  const AwsSourceDetailsResponse({
  ...
  factory AwsSourceDetailsResponse.fromMap(Map<String, dynamic> map) {
    return AwsSourceDetailsResponse(
      accessKeyCreds: pulumi.Input.fromValue(AccessKeyCredentialsResponse.fromMap((map['accessKeyCreds']! as Map).cast<String, dynamic>())),
      ...
      inventoryTagList: pulumi.Input.fromValue(pulumi.Input.decodeList<TagResponse>(map['inventoryTagList']!, (value) => TagResponse.fromMap((value as Map).cast<String, dynamic>()))),
