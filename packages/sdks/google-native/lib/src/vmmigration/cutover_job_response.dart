...
class CutoverJobResponse {
  ...
  final pulumi.Input<ComputeEngineDisksTargetDetailsResponse>
  computeEngineDisksTargetDetails;

  /// Details of the target VM in Compute Engine.
  final pulumi.Input<ComputeEngineTargetDetailsResponse>
  ...
  factory CutoverJobResponse.fromMap(Map<String, dynamic> map) {
    return CutoverJobResponse(
      ...
      computeEngineTargetDetails: pulumi.Input.fromValue(
        ComputeEngineTargetDetailsResponse.fromMap(
      ...
      steps: pulumi.Input.fromValue(
        pulumi.Input.decodeList<CutoverStepResponse>(
          map['steps']!,
