...
class ComputeEngineTargetDefaults {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'diskType': ?pulumi.Input.mapOptionalInputValue<ComputeEngineTargetDefaultsDiskType, String>(diskType, (value) => value.wireValue),
      'encryption': ?pulumi.Input.mapOptionalInputValue<Encryption, Map<String, dynamic>>(encryption, (value) => value.toMap()),
      'hostname': ?hostname,
      'labels': ?labels,
      'licenseType': ?pulumi.Input.mapOptionalInputValue<ComputeEngineTargetDefaultsLicenseType, String>(licenseType, (value) => value.wireValue),
  ...
  factory ComputeEngineTargetDefaults.fromMap(Map<String, dynamic> map) {
    return ComputeEngineTargetDefaults(
      ...
      diskType: (() { final guardedValue = map['diskType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ComputeEngineTargetDefaultsDiskType.fromValue(guardedValue as String)); })(),
      ...
      licenseType: (() { final guardedValue = map['licenseType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ComputeEngineTargetDefaultsLicenseType.fromValue(guardedValue as String)); })(),
