...
/// {@template pulumi_vmmigration_v1_clone_job_args_doc}
/// The set of arguments for CloneJob.
/// {@endtemplate}
/// {@macro pulumi_vmmigration_v1_clone_job_args_doc}
class CloneJobArgs {
  ...
  factory CloneJobArgs.fromMap(Map<String, dynamic> map) {
    return CloneJobArgs(
      cloneJobId: pulumi.Input.fromValue(map['cloneJobId'] as String),
