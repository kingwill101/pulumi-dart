...
class CloneJobResponseVmmigrationV1alpha1 {
  ...
  const CloneJobResponseVmmigrationV1alpha1({
  ...
  factory CloneJobResponseVmmigrationV1alpha1.fromMap(Map<String, dynamic> map) {
    return CloneJobResponseVmmigrationV1alpha1(
      ...
      steps: pulumi.Input.fromValue(pulumi.Input.decodeList<CloneStepResponseVmmigrationV1alpha1>(map['steps']!, (value) => CloneStepResponseVmmigrationV1alpha1.fromMap((value as Map).cast<String, dynamic>()))),
