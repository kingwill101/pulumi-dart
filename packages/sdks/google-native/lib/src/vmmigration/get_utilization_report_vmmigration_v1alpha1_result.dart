...
class GetUtilizationReportVmmigrationV1alpha1Result {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'timeFrame': timeFrame,
      'vmCount': vmCount,
      'vms': pulumi.Input.encodeList<VmUtilizationInfoResponseVmmigrationV1alpha1, Map<String, dynamic>>(vms, (value) => value.toMap()),
      'vmsCount': vmsCount,
    };
  }

  factory GetUtilizationReportVmmigrationV1alpha1Result.fromMap(Map<String, dynamic> map) {
    return GetUtilizationReportVmmigrationV1alpha1Result(
      ...
      vms: pulumi.Input.decodeList<VmUtilizationInfoResponseVmmigrationV1alpha1>(map['vms']!, (value) => VmUtilizationInfoResponseVmmigrationV1alpha1.fromMap((value as Map).cast<String, dynamic>())),
