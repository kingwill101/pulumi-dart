...
class MigratingVmVmmigrationV1alpha1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<AwsSourceVmDetailsResponseVmmigrationV1alpha1>
  awsSourceVmDetails;

  /// Details of the VM from an Azure source.
  late final pulumi.Output<AzureSourceVmDetailsResponseVmmigrationV1alpha1>
  ...
  late final pulumi.Output<ReplicationCycleResponseVmmigrationV1alpha1>
  currentSyncInfo;

  /// Provides details of future CutoverJobs of a MigratingVm. Set to empty when cutover forecast is unavailable.
  late final pulumi.Output<CutoverForecastResponseVmmigrationV1alpha1>
  cutoverForecast;
  ...
  late final pulumi.Output<VmwareSourceVmDetailsResponseVmmigrationV1alpha1>
