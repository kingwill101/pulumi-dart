    ...
    return <String, dynamic>{
      ...
      'computeEngineVmDefaults':
          ?pulumi.Input.mapOptionalInputValue<
            TargetVMDetails,
            Map<String, dynamic>
          >(computeEngineVmDefaults, (value) => value.toMap()),
      ...
      'targetDefaults':
          ?pulumi.Input.mapOptionalInputValue<
            TargetVMDetails,
            Map<String, dynamic>
          >(targetDefaults, (value) => value.toMap()),
    };
  }
    ...
    return MigratingVmVmmigrationV1alpha1Args(
      computeEngineDisksTargetDefaults: (() {
        ...
        return pulumi.Input.fromValue(
          ComputeEngineDisksTargetDefaultsVmmigrationV1alpha1.fromMap(
      ...
      computeEngineTargetDefaults: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ComputeEngineTargetDefaultsVmmigrationV1alpha1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      computeEngineVmDefaults: (() {
        final guardedValue = map['computeEngineVmDefaults'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TargetVMDetails.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      policy: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SchedulePolicyVmmigrationV1alpha1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      targetDefaults: (() {
        final guardedValue = map['targetDefaults'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TargetVMDetails.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
