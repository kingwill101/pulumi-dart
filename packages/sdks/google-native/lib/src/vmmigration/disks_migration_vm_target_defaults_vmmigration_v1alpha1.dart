...
class DisksMigrationVmTargetDefaultsVmmigrationV1alpha1 {
  ...
  final pulumi.Input<List<NetworkInterfaceVmmigrationV1alpha1>>?
  networkInterfaces;
    ...
    return <String, dynamic>{
      ...
      'bootDiskDefaults':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(bootDiskDefaults, (value) => value.toMap()),
      'computeScheduling':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'networkInterfaces':
          ?pulumi.Input.mapOptionalInputValue<
            List<NetworkInterfaceVmmigrationV1alpha1>,
  ...
  factory DisksMigrationVmTargetDefaultsVmmigrationV1alpha1.fromMap(
    ...
    return DisksMigrationVmTargetDefaultsVmmigrationV1alpha1(
      ...
      bootDiskDefaults: (() {
        final guardedValue = map['bootDiskDefaults'];
        if (guardedValue == null) return null;
