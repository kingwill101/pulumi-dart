...
class BootDiskDefaultsVmmigrationV1alpha1 {
  ...
  factory BootDiskDefaultsVmmigrationV1alpha1.fromMap(Map<String, dynamic> map) {
    return BootDiskDefaultsVmmigrationV1alpha1(
      ...
      diskType: map['diskType'] == null ? null : BootDiskDefaultsDiskTypeVmmigrationV1alpha1.fromValue(map['diskType'] as String),
      encryption: map['encryption'] == null ? null : EncryptionVmmigrationV1alpha1.fromMap((map['encryption'] as Map).cast<String, dynamic>()),
      image: map['image'] == null ? null : DiskImageDefaultsVmmigrationV1alpha1.fromMap((map['image'] as Map).cast<String, dynamic>()),
    );
  }
}
