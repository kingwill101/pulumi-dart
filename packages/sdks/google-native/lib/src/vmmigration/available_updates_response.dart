...
class AvailableUpdatesResponse {
  ...
  factory AvailableUpdatesResponse.fromMap(Map<String, dynamic> map) {
    return AvailableUpdatesResponse(
      inPlaceUpdate: (ApplianceVersionResponse.fromMap((map['inPlaceUpdate'] as Map).cast<String, dynamic>())).input(),
      newDeployableAppliance: (ApplianceVersionResponse.fromMap((map['newDeployableAppliance'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
