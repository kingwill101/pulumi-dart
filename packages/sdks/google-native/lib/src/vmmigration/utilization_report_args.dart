...
class UtilizationReportArgs {
  ...
  UtilizationReportArgs({
    ...
    pulumi.Output<UtilizationReportTimeFrame>? timeFrame,
    required pulumi.Output<String> utilizationReportId,
    pulumi.Output<List<VmUtilizationInfo>>? vms,
  }) :
      ...
      timeFrame = pulumi.Input.asOptionalInput<UtilizationReportTimeFrame>(timeFrame),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'requestId': ?requestId,
      'sourceId': sourceId,
      'timeFrame': ?pulumi.Input.mapOptionalInputValue<UtilizationReportTimeFrame, String>(timeFrame, (value) => value.value),
      'utilizationReportId': utilizationReportId,
      'vms': ?pulumi.Input.mapOptionalInputValue<List<VmUtilizationInfo>, List<Map<String, dynamic>>>(vms, (value) => pulumi.Input.encodeList<VmUtilizationInfo, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory UtilizationReportArgs.fromMap(Map<String, dynamic> map) {
    return UtilizationReportArgs(
      ...
      timeFrame: map['timeFrame'] == null ? null : pulumi.Output.create<UtilizationReportTimeFrame>(UtilizationReportTimeFrame.fromValue(map['timeFrame'] as String)),
      utilizationReportId: pulumi.Output.create<String>(map['utilizationReportId'] as String),
      vms: map['vms'] == null ? null : pulumi.Output.create<List<VmUtilizationInfo>>(pulumi.Input.decodeList<VmUtilizationInfo>(map['vms'], (value) => VmUtilizationInfo.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
