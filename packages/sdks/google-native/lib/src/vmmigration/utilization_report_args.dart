...
class UtilizationReportArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'requestId': ?requestId,
      'sourceId': sourceId,
      'timeFrame': ?pulumi.Input.mapOptionalInputValue<UtilizationReportTimeFrame, String>(timeFrame, (value) => value.wireValue),
  ...
  factory UtilizationReportArgs.fromMap(Map<String, dynamic> map) {
    return UtilizationReportArgs(
      ...
      timeFrame: (() { final guardedValue = map['timeFrame']; if (guardedValue == null) return null; return pulumi.Input.fromValue(UtilizationReportTimeFrame.fromValue(guardedValue as String)); })(),
      utilizationReportId: pulumi.Input.fromValue(map['utilizationReportId'] as String),
      vms: (() { final guardedValue = map['vms']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<VmUtilizationInfo>(guardedValue, (value) => VmUtilizationInfo.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
