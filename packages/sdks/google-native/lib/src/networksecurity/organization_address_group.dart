...
class OrganizationAddressGroup extends pulumi.CustomResource {
  ...
  /// Creates a new [OrganizationAddressGroup].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [OrganizationAddressGroup]. {@macro pulumi_networksecurity_v1_organization_address_group_args_doc}
