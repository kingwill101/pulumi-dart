...
class TlsInspectionPolicyNetworksecurityV1beta1Args {
  ...
  const TlsInspectionPolicyNetworksecurityV1beta1Args({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'location': ?location,
      'minTlsVersion': ?pulumi.Input.mapOptionalInputValue<TlsInspectionPolicyMinTlsVersionNetworksecurityV1beta1, String>(minTlsVersion, (value) => value.wireValue),
      'name': ?name,
      'project': ?project,
      'tlsFeatureProfile': ?pulumi.Input.mapOptionalInputValue<TlsInspectionPolicyTlsFeatureProfileNetworksecurityV1beta1, String>(tlsFeatureProfile, (value) => value.wireValue),
  ...
  factory TlsInspectionPolicyNetworksecurityV1beta1Args.fromMap(Map<String, dynamic> map) {
    return TlsInspectionPolicyNetworksecurityV1beta1Args(
      ...
      minTlsVersion: (() { final guardedValue = map['minTlsVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TlsInspectionPolicyMinTlsVersionNetworksecurityV1beta1.fromValue(guardedValue as String)); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      project: (() { final guardedValue = map['project']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      tlsFeatureProfile: (() { final guardedValue = map['tlsFeatureProfile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TlsInspectionPolicyTlsFeatureProfileNetworksecurityV1beta1.fromValue(guardedValue as String)); })(),
