...
class AddressGroupNetworksecurityV1beta1Args {
  ...
  const AddressGroupNetworksecurityV1beta1Args({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'project': ?project,
      'requestId': ?requestId,
      'type': pulumi.Input.mapInputValue<AddressGroupTypeNetworksecurityV1beta1, String>(type, (value) => value.wireValue),
    };
  }
  ...
  factory AddressGroupNetworksecurityV1beta1Args.fromMap(Map<String, dynamic> map) {
    return AddressGroupNetworksecurityV1beta1Args(
      ...
      type: pulumi.Input.fromValue(AddressGroupTypeNetworksecurityV1beta1.fromValue(map['type']! as String)),
    );
  }
}
