...
class AddressGroupNetworksecurityV1beta1Args {
  ...
  AddressGroupNetworksecurityV1beta1Args({
    ...
    required pulumi.Output<AddressGroupTypeNetworksecurityV1beta1> type,
  }) :
      ...
      type = pulumi.Input.asInput<AddressGroupTypeNetworksecurityV1beta1>(type);
  ...
  factory AddressGroupNetworksecurityV1beta1Args.fromMap(Map<String, dynamic> map) {
    return AddressGroupNetworksecurityV1beta1Args(
      ...
      type: pulumi.Output.create<AddressGroupTypeNetworksecurityV1beta1>(AddressGroupTypeNetworksecurityV1beta1.fromValue(map['type'] as String)),
    );
  }
}
