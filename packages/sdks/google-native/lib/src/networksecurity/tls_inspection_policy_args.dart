...
class TlsInspectionPolicyArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'location': ?location,
      'minTlsVersion': ?pulumi.Input.mapOptionalInputValue<TlsInspectionPolicyMinTlsVersion, String>(minTlsVersion, (value) => value.wireValue),
      'name': ?name,
      'project': ?project,
      'tlsFeatureProfile': ?pulumi.Input.mapOptionalInputValue<TlsInspectionPolicyTlsFeatureProfile, String>(tlsFeatureProfile, (value) => value.wireValue),
  ...
  factory TlsInspectionPolicyArgs.fromMap(Map<String, dynamic> map) {
    return TlsInspectionPolicyArgs(
      ...
      minTlsVersion: (() { final guardedValue = map['minTlsVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TlsInspectionPolicyMinTlsVersion.fromValue(guardedValue as String)); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      project: (() { final guardedValue = map['project']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      tlsFeatureProfile: (() { final guardedValue = map['tlsFeatureProfile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TlsInspectionPolicyTlsFeatureProfile.fromValue(guardedValue as String)); })(),
