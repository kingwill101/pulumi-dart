...
class DestinationNetworksecurityV1beta1 {
  ...
  const DestinationNetworksecurityV1beta1({
    required this.hosts,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'hosts': hosts,
      'httpHeaderMatch': ?pulumi.Input.mapOptionalInputValue<HttpHeaderMatchNetworksecurityV1beta1, Map<String, dynamic>>(httpHeaderMatch, (value) => value.toMap()),
      'methods': ?methods,
      'ports': ports,
    };
  }
  ...
  factory DestinationNetworksecurityV1beta1.fromMap(Map<String, dynamic> map) {
    return DestinationNetworksecurityV1beta1(
      ...
      httpHeaderMatch: (() { final guardedValue = map['httpHeaderMatch']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HttpHeaderMatchNetworksecurityV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
