...
class GatewaySecurityPolicy extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [GatewaySecurityPolicy]. {@macro pulumi_networksecurity_v1_gateway_security_policy_args_doc}
  ...
  GatewaySecurityPolicy(
    ...
    gatewaySecurityPolicyId = registerOutput<String>('gatewaySecurityPolicyId');
