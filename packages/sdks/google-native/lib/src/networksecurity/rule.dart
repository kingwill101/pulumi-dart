...
class Rule {
  ...
  factory Rule.fromMap(Map<String, dynamic> map) {
    return Rule(
      destinations: (() { final guardedValue = map['destinations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<Destination>(guardedValue, (value) => Destination.fromMap((value as Map).cast<String, dynamic>()))); })(),
      sources: (() { final guardedValue = map['sources']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<Source>(guardedValue, (value) => Source.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
