...
/// {@template pulumi_networksecurity_v1_authorization_policy_iam_member_args_doc}
/// The set of arguments for AuthorizationPolicyIamMember.
/// {@endtemplate}
/// {@macro pulumi_networksecurity_v1_authorization_policy_iam_member_args_doc}
class AuthorizationPolicyIamMemberArgs {
  ...
  /// Creates a new [AuthorizationPolicyIamMemberArgs].
  ...
  const AuthorizationPolicyIamMemberArgs({
    this.condition,
  ...
  factory AuthorizationPolicyIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return AuthorizationPolicyIamMemberArgs(
