...
class AuthorizationPolicyArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'action': pulumi.Input.mapInputValue<AuthorizationPolicyAction, String>(
        action,
  ...
  factory AuthorizationPolicyArgs.fromMap(Map<String, dynamic> map) {
    return AuthorizationPolicyArgs(
      action: pulumi.Input.fromValue(
        AuthorizationPolicyAction.fromValue(map['action']! as String),
      ),
      ...
      rules: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as List).cast<RuleNetworksecurityV1>(),
        );
      })(),
    );
  }
