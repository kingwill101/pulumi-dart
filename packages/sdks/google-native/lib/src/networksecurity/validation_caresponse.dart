...
class ValidationCAResponse {
  ...
  final pulumi.Input<CertificateProviderInstanceResponse>
  certificateProviderInstance;

  /// gRPC specific configuration to access the gRPC server to obtain the CA certificate.
  final pulumi.Input<GoogleCloudNetworksecurityV1GrpcEndpointResponse>
  grpcEndpoint;
  ...
  factory ValidationCAResponse.fromMap(Map<String, dynamic> map) {
    return ValidationCAResponse(
      certificateProviderInstance: pulumi.Input.fromValue(
        CertificateProviderInstanceResponse.fromMap(
          (map['certificateProviderInstance']! as Map).cast<String, dynamic>(),
        ),
      ),
      grpcEndpoint: pulumi.Input.fromValue(
        GoogleCloudNetworksecurityV1GrpcEndpointResponse.fromMap(
