...
class SeverityOverride {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'action': pulumi.Input.mapInputValue<SeverityOverrideAction, String>(
        action,
        (value) => value.wireValue,
      ),
      'severity': pulumi.Input.mapInputValue<SeverityOverrideSeverity, String>(
        severity,
        (value) => value.wireValue,
      ),
    };
  ...
  factory SeverityOverride.fromMap(Map<String, dynamic> map) {
    return SeverityOverride(
      action: pulumi.Input.fromValue(
        SeverityOverrideAction.fromValue(map['action']! as String),
      ),
      severity: pulumi.Input.fromValue(
        SeverityOverrideSeverity.fromValue(map['severity']! as String),
      ),
    );
  }
}
