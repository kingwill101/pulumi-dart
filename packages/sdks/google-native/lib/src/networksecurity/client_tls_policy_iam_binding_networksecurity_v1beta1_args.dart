...
/// {@template pulumi_networksecurity_v1beta1_client_tls_policy_iam_binding_networksecurity_v1beta1_args_doc}
/// The set of arguments for ClientTlsPolicyIamBinding.
/// {@endtemplate}
/// {@macro pulumi_networksecurity_v1beta1_client_tls_policy_iam_binding_networksecurity_v1beta1_args_doc}
class ClientTlsPolicyIamBindingNetworksecurityV1beta1Args {
  ...
  /// Creates a new [ClientTlsPolicyIamBindingNetworksecurityV1beta1Args].
  ...
  const ClientTlsPolicyIamBindingNetworksecurityV1beta1Args({
    this.condition,
  ...
  factory ClientTlsPolicyIamBindingNetworksecurityV1beta1Args.fromMap(Map<String, dynamic> map) {
    return ClientTlsPolicyIamBindingNetworksecurityV1beta1Args(
