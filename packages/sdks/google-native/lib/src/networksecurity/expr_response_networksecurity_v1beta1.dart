...
class ExprResponseNetworksecurityV1beta1 {
  ...
  /// Creates a new [ExprResponseNetworksecurityV1beta1].
  ...
  const ExprResponseNetworksecurityV1beta1({
  ...
  factory ExprResponseNetworksecurityV1beta1.fromMap(Map<String, dynamic> map) {
    return ExprResponseNetworksecurityV1beta1(
