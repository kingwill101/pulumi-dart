...
class GetClientTlsPolicyNetworksecurityV1beta1Result {
  ...
  final GoogleCloudNetworksecurityV1beta1CertificateProviderResponse clientCertificate;
  ...
  const GetClientTlsPolicyNetworksecurityV1beta1Result({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'labels': labels,
      'name': name,
      'serverValidationCa': pulumi.Input.encodeList<ValidationCAResponseNetworksecurityV1beta1, Map<String, dynamic>>(serverValidationCa, (value) => value.toMap()),
      'sni': sni,
      'updateTime': updateTime,
    };
  }

  factory GetClientTlsPolicyNetworksecurityV1beta1Result.fromMap(Map<String, dynamic> map) {
    return GetClientTlsPolicyNetworksecurityV1beta1Result(
      clientCertificate: GoogleCloudNetworksecurityV1beta1CertificateProviderResponse.fromMap((map['clientCertificate']! as Map).cast<String, dynamic>()),
      createTime: map['createTime'] as String,
      description: map['description'] as String,
      labels: (map['labels'] as Map).cast<String, String>(),
      name: map['name'] as String,
      serverValidationCa: pulumi.Input.decodeList<ValidationCAResponseNetworksecurityV1beta1>(map['serverValidationCa']!, (value) => ValidationCAResponseNetworksecurityV1beta1.fromMap((value as Map).cast<String, dynamic>())),
