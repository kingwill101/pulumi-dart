...
class ServerTlsPolicyNetworksecurityV1beta1 extends pulumi.CustomResource {
  ...
  ServerTlsPolicyNetworksecurityV1beta1(
    ...
    this.mtlsPolicy = registerOutput<MTLSPolicyResponseNetworksecurityV1beta1>('mtlsPolicy');
    this.name = registerOutput<String>('name');
    this.project = registerOutput<String>('project');
    this.serverCertificate = registerOutput<GoogleCloudNetworksecurityV1beta1CertificateProviderResponse>('serverCertificate');
