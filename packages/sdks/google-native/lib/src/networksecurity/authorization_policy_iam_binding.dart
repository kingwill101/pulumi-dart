...
import 'authorization_policy_iam_binding_args.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class AuthorizationPolicyIamBinding extends pulumi.CustomResource {
  ...
  /// Creates a new [AuthorizationPolicyIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [AuthorizationPolicyIamBinding]. {@macro pulumi_networksecurity_v1_authorization_policy_iam_binding_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  AuthorizationPolicyIamBinding(
    String name, {
    AuthorizationPolicyIamBindingArgs? args,
