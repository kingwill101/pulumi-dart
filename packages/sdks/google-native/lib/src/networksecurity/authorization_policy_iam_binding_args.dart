...
/// {@template pulumi_networksecurity_v1_authorization_policy_iam_binding_args_doc}
/// The set of arguments for AuthorizationPolicyIamBinding.
/// {@endtemplate}
/// {@macro pulumi_networksecurity_v1_authorization_policy_iam_binding_args_doc}
class AuthorizationPolicyIamBindingArgs {
  ...
  /// Creates a new [AuthorizationPolicyIamBindingArgs].
  ...
  const AuthorizationPolicyIamBindingArgs({
    this.condition,
  ...
  factory AuthorizationPolicyIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return AuthorizationPolicyIamBindingArgs(
