...
class RuleNetworksecurityV1beta1 {
  ...
  const RuleNetworksecurityV1beta1({
    this.destinations,
    this.sources,
  });
  ...
  factory RuleNetworksecurityV1beta1.fromMap(Map<String, dynamic> map) {
    return RuleNetworksecurityV1beta1(
      destinations: (() { final guardedValue = map['destinations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DestinationNetworksecurityV1beta1>(guardedValue, (value) => DestinationNetworksecurityV1beta1.fromMap((value as Map).cast<String, dynamic>()))); })(),
      sources: (() { final guardedValue = map['sources']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SourceNetworksecurityV1beta1>(guardedValue, (value) => SourceNetworksecurityV1beta1.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
