...
/// {@template pulumi_networksecurity_v1beta1_client_tls_policy_iam_member_networksecurity_v1beta1_args_doc}
/// The set of arguments for ClientTlsPolicyIamMember.
/// {@endtemplate}
/// {@macro pulumi_networksecurity_v1beta1_client_tls_policy_iam_member_networksecurity_v1beta1_args_doc}
class ClientTlsPolicyIamMemberNetworksecurityV1beta1Args {
  ...
  /// Creates a new [ClientTlsPolicyIamMemberNetworksecurityV1beta1Args].
  ...
  const ClientTlsPolicyIamMemberNetworksecurityV1beta1Args({
    this.condition,
  ...
  factory ClientTlsPolicyIamMemberNetworksecurityV1beta1Args.fromMap(Map<String, dynamic> map) {
    return ClientTlsPolicyIamMemberNetworksecurityV1beta1Args(
