...
/// {@template pulumi_networksecurity_v1beta1_address_group_iam_member_networksecurity_v1beta1_args_doc}
/// The set of arguments for AddressGroupIamMember.
/// {@endtemplate}
/// {@macro pulumi_networksecurity_v1beta1_address_group_iam_member_networksecurity_v1beta1_args_doc}
class AddressGroupIamMemberNetworksecurityV1beta1Args {
  ...
  /// Creates a new [AddressGroupIamMemberNetworksecurityV1beta1Args].
  ...
  const AddressGroupIamMemberNetworksecurityV1beta1Args({
    this.condition,
  ...
  factory AddressGroupIamMemberNetworksecurityV1beta1Args.fromMap(Map<String, dynamic> map) {
    return AddressGroupIamMemberNetworksecurityV1beta1Args(
