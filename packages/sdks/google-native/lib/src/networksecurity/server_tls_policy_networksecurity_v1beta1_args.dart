...
class ServerTlsPolicyNetworksecurityV1beta1Args {
  ...
  ServerTlsPolicyNetworksecurityV1beta1Args({
    ...
    pulumi.Output<MTLSPolicyNetworksecurityV1beta1>? mtlsPolicy,
    pulumi.Output<String>? name,
    pulumi.Output<String>? project,
    pulumi.Output<GoogleCloudNetworksecurityV1beta1CertificateProvider>? serverCertificate,
    required pulumi.Output<String> serverTlsPolicyId,
      ...
      mtlsPolicy = pulumi.Input.asOptionalInput<MTLSPolicyNetworksecurityV1beta1>(mtlsPolicy),
      name = pulumi.Input.asOptionalInput<String>(name),
      project = pulumi.Input.asOptionalInput<String>(project),
      serverCertificate = pulumi.Input.asOptionalInput<GoogleCloudNetworksecurityV1beta1CertificateProvider>(serverCertificate),
  ...
  factory ServerTlsPolicyNetworksecurityV1beta1Args.fromMap(Map<String, dynamic> map) {
    return ServerTlsPolicyNetworksecurityV1beta1Args(
      ...
      mtlsPolicy: map['mtlsPolicy'] == null ? null : pulumi.Output.create<MTLSPolicyNetworksecurityV1beta1>(MTLSPolicyNetworksecurityV1beta1.fromMap((map['mtlsPolicy'] as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      project: map['project'] == null ? null : pulumi.Output.create<String>(map['project'] as String),
      serverCertificate: map['serverCertificate'] == null ? null : pulumi.Output.create<GoogleCloudNetworksecurityV1beta1CertificateProvider>(GoogleCloudNetworksecurityV1beta1CertificateProvider.fromMap((map['serverCertificate'] as Map).cast<String, dynamic>())),
