...
/// {@template pulumi_networksecurity_v1_organization_address_group_args_doc}
/// The set of arguments for OrganizationAddressGroup.
/// {@endtemplate}
/// {@macro pulumi_networksecurity_v1_organization_address_group_args_doc}
class OrganizationAddressGroupArgs {
  ...
  /// Creates a new [OrganizationAddressGroupArgs].
  ...
  OrganizationAddressGroupArgs({
    ...
    required pulumi.Output<OrganizationAddressGroupType> type,
  }) :
      ...
      type = pulumi.Input.asInput<OrganizationAddressGroupType>(type);
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'requestId': ?requestId,
      'type': pulumi.Input.mapInputValue<OrganizationAddressGroupType, String>(type, (value) => value.value),
    };
  }
  ...
  factory OrganizationAddressGroupArgs.fromMap(Map<String, dynamic> map) {
    return OrganizationAddressGroupArgs(
      ...
      type: pulumi.Output.create<OrganizationAddressGroupType>(OrganizationAddressGroupType.fromValue(map['type'] as String)),
    );
  }
}
