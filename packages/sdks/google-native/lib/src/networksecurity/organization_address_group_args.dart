...
class OrganizationAddressGroupArgs {
  ...
  const OrganizationAddressGroupArgs({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'requestId': ?requestId,
      'type': pulumi.Input.mapInputValue<OrganizationAddressGroupType, String>(type, (value) => value.wireValue),
    };
  }
  ...
  factory OrganizationAddressGroupArgs.fromMap(Map<String, dynamic> map) {
    return OrganizationAddressGroupArgs(
      ...
      type: pulumi.Input.fromValue(OrganizationAddressGroupType.fromValue(map['type']! as String)),
    );
  }
}
