...
class MTLSPolicyResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'clientValidationCa': pulumi.Input.encodeList<ValidationCAResponse, Map<String, dynamic>>(clientValidationCa, (value) => value.toMap()),
  ...
  factory MTLSPolicyResponse.fromMap(Map<String, dynamic> map) {
    return MTLSPolicyResponse(
      clientValidationCa: pulumi.Input.decodeList<ValidationCAResponse>(map['clientValidationCa'], (value) => ValidationCAResponse.fromMap((value as Map).cast<String, dynamic>())),
