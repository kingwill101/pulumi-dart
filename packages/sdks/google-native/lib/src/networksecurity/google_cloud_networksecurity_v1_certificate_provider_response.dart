...
class GoogleCloudNetworksecurityV1CertificateProviderResponse {
  ...
  factory GoogleCloudNetworksecurityV1CertificateProviderResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudNetworksecurityV1CertificateProviderResponse(
      certificateProviderInstance: (CertificateProviderInstanceResponse.fromMap((map['certificateProviderInstance'] as Map).cast<String, dynamic>())).input(),
      grpcEndpoint: (GoogleCloudNetworksecurityV1GrpcEndpointResponse.fromMap((map['grpcEndpoint'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
