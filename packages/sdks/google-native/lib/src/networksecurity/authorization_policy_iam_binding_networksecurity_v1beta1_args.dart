...
/// {@template pulumi_networksecurity_v1beta1_authorization_policy_iam_binding_networksecurity_v1beta1_args_doc}
/// The set of arguments for AuthorizationPolicyIamBinding.
/// {@endtemplate}
/// {@macro pulumi_networksecurity_v1beta1_authorization_policy_iam_binding_networksecurity_v1beta1_args_doc}
class AuthorizationPolicyIamBindingNetworksecurityV1beta1Args {
  ...
  /// Creates a new [AuthorizationPolicyIamBindingNetworksecurityV1beta1Args].
  ...
  const AuthorizationPolicyIamBindingNetworksecurityV1beta1Args({
    this.condition,
  ...
  factory AuthorizationPolicyIamBindingNetworksecurityV1beta1Args.fromMap(Map<String, dynamic> map) {
    return AuthorizationPolicyIamBindingNetworksecurityV1beta1Args(
