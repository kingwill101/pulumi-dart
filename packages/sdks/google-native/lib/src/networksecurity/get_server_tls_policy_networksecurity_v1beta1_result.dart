...
class GetServerTlsPolicyNetworksecurityV1beta1Result {
  ...
  final MTLSPolicyResponseNetworksecurityV1beta1 mtlsPolicy;
  ...
  final GoogleCloudNetworksecurityV1beta1CertificateProviderResponse serverCertificate;
  /// The timestamp when the resource was updated.
  final String updateTime;

  /// Creates a new [GetServerTlsPolicyNetworksecurityV1beta1Result].
  ...
  const GetServerTlsPolicyNetworksecurityV1beta1Result({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'labels': labels,
      'mtlsPolicy': mtlsPolicy.toMap(),
      'name': name,
      'serverCertificate': serverCertificate.toMap(),
      'updateTime': updateTime,
    };
  }

  factory GetServerTlsPolicyNetworksecurityV1beta1Result.fromMap(Map<String, dynamic> map) {
    return GetServerTlsPolicyNetworksecurityV1beta1Result(
      allowOpen: map['allowOpen'] as bool,
      createTime: map['createTime'] as String,
      description: map['description'] as String,
      labels: (map['labels'] as Map).cast<String, String>(),
      mtlsPolicy: MTLSPolicyResponseNetworksecurityV1beta1.fromMap((map['mtlsPolicy']! as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      serverCertificate: GoogleCloudNetworksecurityV1beta1CertificateProviderResponse.fromMap((map['serverCertificate']! as Map).cast<String, dynamic>()),
