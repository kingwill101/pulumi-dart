...
class GoogleCloudNetworksecurityV1beta1CertificateProvider {
  ...
  const GoogleCloudNetworksecurityV1beta1CertificateProvider({
  ...
  factory GoogleCloudNetworksecurityV1beta1CertificateProvider.fromMap(Map<String, dynamic> map) {
    return GoogleCloudNetworksecurityV1beta1CertificateProvider(
      certificateProviderInstance: (() { final guardedValue = map['certificateProviderInstance']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CertificateProviderInstanceNetworksecurityV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      grpcEndpoint: (() { final guardedValue = map['grpcEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudNetworksecurityV1beta1GrpcEndpoint.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
