...
class GetTlsInspectionPolicyNetworksecurityV1beta1Result {
  ...
  /// Creates a new [GetTlsInspectionPolicyNetworksecurityV1beta1Result].
  ...
  const GetTlsInspectionPolicyNetworksecurityV1beta1Result({
  ...
  factory GetTlsInspectionPolicyNetworksecurityV1beta1Result.fromMap(Map<String, dynamic> map) {
