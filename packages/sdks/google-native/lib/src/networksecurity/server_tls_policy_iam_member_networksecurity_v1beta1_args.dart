...
/// {@template pulumi_networksecurity_v1beta1_server_tls_policy_iam_member_networksecurity_v1beta1_args_doc}
/// The set of arguments for ServerTlsPolicyIamMember.
/// {@endtemplate}
/// {@macro pulumi_networksecurity_v1beta1_server_tls_policy_iam_member_networksecurity_v1beta1_args_doc}
class ServerTlsPolicyIamMemberNetworksecurityV1beta1Args {
  ...
  /// Creates a new [ServerTlsPolicyIamMemberNetworksecurityV1beta1Args].
  ...
  const ServerTlsPolicyIamMemberNetworksecurityV1beta1Args({
    this.condition,
  ...
  factory ServerTlsPolicyIamMemberNetworksecurityV1beta1Args.fromMap(Map<String, dynamic> map) {
    return ServerTlsPolicyIamMemberNetworksecurityV1beta1Args(
