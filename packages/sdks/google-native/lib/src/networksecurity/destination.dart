...
class Destination {
  ...
  factory Destination.fromMap(Map<String, dynamic> map) {
    return Destination(
      ...
      httpHeaderMatch: (() { final guardedValue = map['httpHeaderMatch']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HttpHeaderMatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
