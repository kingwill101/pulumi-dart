...
class ThreatPreventionProfileResponse {
  ...
  factory ThreatPreventionProfileResponse.fromMap(Map<String, dynamic> map) {
    return ThreatPreventionProfileResponse(
      severityOverrides: pulumi.Input.fromValue(
        pulumi.Input.decodeList<SeverityOverrideResponse>(
      ...
      threatOverrides: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ThreatOverrideResponse>(
          map['threatOverrides']!,
