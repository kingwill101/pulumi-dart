...
class RuleResource extends pulumi.CustomResource {
  ...
  /// Creates a new [RuleResource].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [RuleResource]. {@macro pulumi_networksecurity_v1beta1_rule_networksecurity_v1beta1_args_doc}
  ...
  RuleResource(
    ...
    this.gatewaySecurityPolicyRuleId = registerOutput<String?>('gatewaySecurityPolicyRuleId');
