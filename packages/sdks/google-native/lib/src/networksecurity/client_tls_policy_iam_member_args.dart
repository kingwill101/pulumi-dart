...
/// {@template pulumi_networksecurity_v1_client_tls_policy_iam_member_args_doc}
/// The set of arguments for ClientTlsPolicyIamMember.
/// {@endtemplate}
/// {@macro pulumi_networksecurity_v1_client_tls_policy_iam_member_args_doc}
class ClientTlsPolicyIamMemberArgs {
  ...
  /// Creates a new [ClientTlsPolicyIamMemberArgs].
  ...
  const ClientTlsPolicyIamMemberArgs({
    this.condition,
