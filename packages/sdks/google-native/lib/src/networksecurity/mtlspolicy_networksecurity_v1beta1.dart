...
class MTLSPolicyNetworksecurityV1beta1 {
  ...
  final pulumi.Input<MTLSPolicyClientValidationModeNetworksecurityV1beta1>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'clientValidationMode':
          ?pulumi.Input.mapOptionalInputValue<
            MTLSPolicyClientValidationModeNetworksecurityV1beta1,
            String
          >(clientValidationMode, (value) => value.wireValue),
  ...
  factory MTLSPolicyNetworksecurityV1beta1.fromMap(Map<String, dynamic> map) {
    return MTLSPolicyNetworksecurityV1beta1(
      clientValidationCa: (() {
        final guardedValue = map['clientValidationCa'];
