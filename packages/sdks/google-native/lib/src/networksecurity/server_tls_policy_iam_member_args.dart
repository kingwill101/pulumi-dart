...
/// {@template pulumi_networksecurity_v1_server_tls_policy_iam_member_args_doc}
/// The set of arguments for ServerTlsPolicyIamMember.
/// {@endtemplate}
/// {@macro pulumi_networksecurity_v1_server_tls_policy_iam_member_args_doc}
class ServerTlsPolicyIamMemberArgs {
  ...
  /// Creates a new [ServerTlsPolicyIamMemberArgs].
  ...
  const ServerTlsPolicyIamMemberArgs({
    this.condition,
  ...
  factory ServerTlsPolicyIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return ServerTlsPolicyIamMemberArgs(
