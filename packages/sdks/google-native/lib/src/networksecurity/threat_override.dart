...
class ThreatOverride {
  ...
  ThreatOverride({required this.action, required this.threatId});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'action': pulumi.Input.mapInputValue<ThreatOverrideAction, String>(
        action,
  ...
  factory ThreatOverride.fromMap(Map<String, dynamic> map) {
    return ThreatOverride(
      action: pulumi.Input.fromValue(
        ThreatOverrideAction.fromValue(map['action']! as String),
      ),
