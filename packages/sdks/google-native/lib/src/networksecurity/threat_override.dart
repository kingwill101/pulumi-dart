...
class ThreatOverride {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'action': pulumi.Input.mapInputValue<ThreatOverrideAction, String>(action, (value) => value.wireValue),
      'threatId': threatId,
    };
  }
  ...
  factory ThreatOverride.fromMap(Map<String, dynamic> map) {
    return ThreatOverride(
      action: pulumi.Input.fromValue(ThreatOverrideAction.fromValue(map['action']! as String)),
