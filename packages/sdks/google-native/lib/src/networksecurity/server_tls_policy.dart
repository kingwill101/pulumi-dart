...
class ServerTlsPolicy extends pulumi.CustomResource {
  ...
  ServerTlsPolicy(
    ...
    mtlsPolicy = registerOutput<MTLSPolicyResponse>('mtlsPolicy', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return MTLSPolicyResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    this.name = registerOutput<String>('name');
    project = registerOutput<String>('project');
    serverCertificate = registerOutput<GoogleCloudNetworksecurityV1CertificateProviderResponse>('serverCertificate', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return GoogleCloudNetworksecurityV1CertificateProviderResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
