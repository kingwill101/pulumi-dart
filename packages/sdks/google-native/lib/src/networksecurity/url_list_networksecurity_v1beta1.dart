...
import 'url_list_networksecurity_v1beta1_args.dart';

/// Creates a new UrlList in a given project and location.
class UrlListNetworksecurityV1beta1 extends pulumi.CustomResource {
  ...
  /// Creates a new [UrlListNetworksecurityV1beta1].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [UrlListNetworksecurityV1beta1]. {@macro pulumi_networksecurity_v1beta1_url_list_networksecurity_v1beta1_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  UrlListNetworksecurityV1beta1(
    String name, {
    UrlListNetworksecurityV1beta1Args? args,
