...
class MTLSPolicyResponseNetworksecurityV1beta1 {
  ...
  factory MTLSPolicyResponseNetworksecurityV1beta1.fromMap(Map<String, dynamic> map) {
    return MTLSPolicyResponseNetworksecurityV1beta1(
      clientValidationCa: (pulumi.Input.decodeList<ValidationCAResponseNetworksecurityV1beta1>(map['clientValidationCa'], (value) => ValidationCAResponseNetworksecurityV1beta1.fromMap((value as Map).cast<String, dynamic>()))).input(),
      clientValidationMode: (map['clientValidationMode'] as String).input(),
      clientValidationTrustConfig: (map['clientValidationTrustConfig'] as String).input(),
    );
  }
}
