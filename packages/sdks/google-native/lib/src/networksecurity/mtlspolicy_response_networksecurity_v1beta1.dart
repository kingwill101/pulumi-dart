...
class MTLSPolicyResponseNetworksecurityV1beta1 {
  ...
  final pulumi.Input<List<ValidationCAResponseNetworksecurityV1beta1>>
  clientValidationCa;
    ...
    return <String, dynamic>{
      'clientValidationCa':
          pulumi.Input.mapInputValue<
            List<ValidationCAResponseNetworksecurityV1beta1>,
  ...
  factory MTLSPolicyResponseNetworksecurityV1beta1.fromMap(
    ...
    return MTLSPolicyResponseNetworksecurityV1beta1(
      clientValidationCa: pulumi.Input.fromValue(
      ...
      clientValidationMode: pulumi.Input.fromValue(
        map['clientValidationMode'] as String,
      ),
      clientValidationTrustConfig: pulumi.Input.fromValue(
