...
class MTLSPolicyResponseNetworksecurityV1beta1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'clientValidationCa': pulumi.Input.encodeList<ValidationCAResponseNetworksecurityV1beta1, Map<String, dynamic>>(clientValidationCa, (value) => value.toMap()),
  ...
  factory MTLSPolicyResponseNetworksecurityV1beta1.fromMap(Map<String, dynamic> map) {
    return MTLSPolicyResponseNetworksecurityV1beta1(
      clientValidationCa: pulumi.Input.decodeList<ValidationCAResponseNetworksecurityV1beta1>(map['clientValidationCa'], (value) => ValidationCAResponseNetworksecurityV1beta1.fromMap((value as Map).cast<String, dynamic>())),
