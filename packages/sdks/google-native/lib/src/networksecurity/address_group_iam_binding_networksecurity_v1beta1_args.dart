...
/// {@template pulumi_networksecurity_v1beta1_address_group_iam_binding_networksecurity_v1beta1_args_doc}
/// The set of arguments for AddressGroupIamBinding.
/// {@endtemplate}
/// {@macro pulumi_networksecurity_v1beta1_address_group_iam_binding_networksecurity_v1beta1_args_doc}
class AddressGroupIamBindingNetworksecurityV1beta1Args {
  ...
  /// Creates a new [AddressGroupIamBindingNetworksecurityV1beta1Args].
  ...
  const AddressGroupIamBindingNetworksecurityV1beta1Args({
    this.condition,
  ...
  factory AddressGroupIamBindingNetworksecurityV1beta1Args.fromMap(Map<String, dynamic> map) {
    return AddressGroupIamBindingNetworksecurityV1beta1Args(
