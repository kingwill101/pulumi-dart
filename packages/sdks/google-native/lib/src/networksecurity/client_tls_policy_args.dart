...
class ClientTlsPolicyArgs {
  ...
  factory ClientTlsPolicyArgs.fromMap(Map<String, dynamic> map) {
    return ClientTlsPolicyArgs(
      clientCertificate: (() { final guardedValue = map['clientCertificate']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudNetworksecurityV1CertificateProvider.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      serverValidationCa: (() { final guardedValue = map['serverValidationCa']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ValidationCA>(guardedValue, (value) => ValidationCA.fromMap((value as Map).cast<String, dynamic>()))); })(),
