...
class RuleNetworksecurityV1beta1Args {
  ...
  RuleNetworksecurityV1beta1Args({
    ...
    required pulumi.Output<RuleBasicProfileNetworksecurityV1beta1> basicProfile,
  ...
  factory RuleNetworksecurityV1beta1Args.fromMap(Map<String, dynamic> map) {
    return RuleNetworksecurityV1beta1Args(
      ...
      basicProfile: pulumi.Output.create<RuleBasicProfileNetworksecurityV1beta1>(RuleBasicProfileNetworksecurityV1beta1.fromValue(map['basicProfile'] as String)),
