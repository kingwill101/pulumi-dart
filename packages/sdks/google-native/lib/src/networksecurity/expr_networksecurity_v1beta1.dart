...
class ExprNetworksecurityV1beta1 {
  ...
  /// Creates a new [ExprNetworksecurityV1beta1].
  ...
  const ExprNetworksecurityV1beta1({
    this.description,
    this.expression,
    this.location,
    this.title,
  ...
  factory ExprNetworksecurityV1beta1.fromMap(Map<String, dynamic> map) {
    return ExprNetworksecurityV1beta1(
