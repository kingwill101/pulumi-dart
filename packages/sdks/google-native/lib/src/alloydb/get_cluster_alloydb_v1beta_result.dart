...
class GetClusterAlloydbV1betaResult {
  ...
  /// Creates a new [GetClusterAlloydbV1betaResult].
  ...
  const GetClusterAlloydbV1betaResult({
  ...
  factory GetClusterAlloydbV1betaResult.fromMap(Map<String, dynamic> map) {
    return GetClusterAlloydbV1betaResult(
      ...
      automatedBackupPolicy: AutomatedBackupPolicyResponseAlloydbV1beta.fromMap((map['automatedBackupPolicy']! as Map).cast<String, dynamic>()),
      backupSource: BackupSourceResponseAlloydbV1beta.fromMap((map['backupSource']! as Map).cast<String, dynamic>()),
      clusterType: map['clusterType'] as String,
      continuousBackupConfig: ContinuousBackupConfigResponseAlloydbV1beta.fromMap((map['continuousBackupConfig']! as Map).cast<String, dynamic>()),
      continuousBackupInfo: ContinuousBackupInfoResponseAlloydbV1beta.fromMap((map['continuousBackupInfo']! as Map).cast<String, dynamic>()),
      ...
      initialUser: UserPasswordResponseAlloydbV1beta.fromMap((map['initialUser']! as Map).cast<String, dynamic>()),
      labels: (map['labels'] as Map).cast<String, String>(),
      migrationSource: MigrationSourceResponseAlloydbV1beta.fromMap((map['migrationSource']! as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      network: map['network'] as String,
      networkConfig: NetworkConfigResponseAlloydbV1beta.fromMap((map['networkConfig']! as Map).cast<String, dynamic>()),
      primaryConfig: PrimaryConfigResponseAlloydbV1beta.fromMap((map['primaryConfig']! as Map).cast<String, dynamic>()),
      reconciling: map['reconciling'] as bool,
      secondaryConfig: SecondaryConfigResponseAlloydbV1beta.fromMap((map['secondaryConfig']! as Map).cast<String, dynamic>()),
      sslConfig: SslConfigResponseAlloydbV1beta.fromMap((map['sslConfig']! as Map).cast<String, dynamic>()),
