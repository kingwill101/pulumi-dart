...
class InstanceArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'availabilityType': ?pulumi.Input.mapOptionalInputValue<InstanceAvailabilityType, String>(availabilityType, (value) => value.wireValue),
      ...
      'instanceType': pulumi.Input.mapInputValue<InstanceInstanceType, String>(instanceType, (value) => value.wireValue),
      'labels': ?labels,
      'location': ?location,
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      ...
      availabilityType: (() { final guardedValue = map['availabilityType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceAvailabilityType.fromValue(guardedValue as String)); })(),
      clientConnectionConfig: (() { final guardedValue = map['clientConnectionConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClientConnectionConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      instanceType: pulumi.Input.fromValue(InstanceInstanceType.fromValue(map['instanceType']! as String)),
      ...
      queryInsightsConfig: (() { final guardedValue = map['queryInsightsConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(QueryInsightsInstanceConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      readPoolConfig: (() { final guardedValue = map['readPoolConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ReadPoolConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
