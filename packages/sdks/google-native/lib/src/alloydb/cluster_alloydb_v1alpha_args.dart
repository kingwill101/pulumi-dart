...
class ClusterAlloydbV1alphaArgs {
  ...
  factory ClusterAlloydbV1alphaArgs.fromMap(Map<String, dynamic> map) {
    return ClusterAlloydbV1alphaArgs(
      ...
      automatedBackupPolicy: map['automatedBackupPolicy'] == null ? null : (AutomatedBackupPolicyAlloydbV1alpha.fromMap((map['automatedBackupPolicy'] as Map).cast<String, dynamic>())).input(),
      clusterId: (map['clusterId'] as String).input(),
      continuousBackupConfig: map['continuousBackupConfig'] == null ? null : (ContinuousBackupConfigAlloydbV1alpha.fromMap((map['continuousBackupConfig'] as Map).cast<String, dynamic>())).input(),
      databaseVersion: map['databaseVersion'] == null ? null : (ClusterDatabaseVersionAlloydbV1alpha.fromValue(map['databaseVersion'] as String)).input(),
      ...
      initialUser: map['initialUser'] == null ? null : (UserPasswordAlloydbV1alpha.fromMap((map['initialUser'] as Map).cast<String, dynamic>())).input(),
      labels: map['labels'] == null ? null : ((map['labels'] as Map).cast<String, String>()).input(),
      location: map['location'] == null ? null : (map['location'] as String).input(),
      network: (map['network'] as String).input(),
      networkConfig: map['networkConfig'] == null ? null : (NetworkConfigAlloydbV1alpha.fromMap((map['networkConfig'] as Map).cast<String, dynamic>())).input(),
      ...
      secondaryConfig: map['secondaryConfig'] == null ? null : (SecondaryConfigAlloydbV1alpha.fromMap((map['secondaryConfig'] as Map).cast<String, dynamic>())).input(),
