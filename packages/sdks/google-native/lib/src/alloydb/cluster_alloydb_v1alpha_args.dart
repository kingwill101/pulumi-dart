  ...
  factory ClusterAlloydbV1alphaArgs.fromMap(Map<String, dynamic> map) {
    return ClusterAlloydbV1alphaArgs(
      ...
      automatedBackupPolicy: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AutomatedBackupPolicyAlloydbV1alpha.fromMap(
      ...
      continuousBackupConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ContinuousBackupConfigAlloydbV1alpha.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      databaseVersion: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ClusterDatabaseVersionAlloydbV1alpha.fromValue(
      ...
      initialUser: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          UserPasswordAlloydbV1alpha.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      networkConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          NetworkConfigAlloydbV1alpha.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      secondaryConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SecondaryConfigAlloydbV1alpha.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
