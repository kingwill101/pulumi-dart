  ...
  factory InstanceAlloydbV1betaArgs.fromMap(Map<String, dynamic> map) {
    return InstanceAlloydbV1betaArgs(
      ...
      availabilityType: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          InstanceAvailabilityTypeAlloydbV1beta.fromValue(
      ...
      clientConnectionConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ClientConnectionConfigAlloydbV1beta.fromMap(
      ...
      instanceType: pulumi.Input.fromValue(
        InstanceInstanceTypeAlloydbV1beta.fromValue(
      ...
      machineConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          MachineConfigAlloydbV1beta.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      queryInsightsConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          QueryInsightsInstanceConfigAlloydbV1beta.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      readPoolConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ReadPoolConfigAlloydbV1beta.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      updatePolicy: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          UpdatePolicyAlloydbV1beta.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
