...
class InstanceAlloydbV1betaArgs {
  ...
  factory InstanceAlloydbV1betaArgs.fromMap(Map<String, dynamic> map) {
    return InstanceAlloydbV1betaArgs(
      ...
      availabilityType: map['availabilityType'] == null ? null : (InstanceAvailabilityTypeAlloydbV1beta.fromValue(map['availabilityType'] as String)).input(),
      clientConnectionConfig: map['clientConnectionConfig'] == null ? null : (ClientConnectionConfigAlloydbV1beta.fromMap((map['clientConnectionConfig'] as Map).cast<String, dynamic>())).input(),
      ...
      instanceType: (InstanceInstanceTypeAlloydbV1beta.fromValue(map['instanceType'] as String)).input(),
      labels: map['labels'] == null ? null : ((map['labels'] as Map).cast<String, String>()).input(),
      location: map['location'] == null ? null : (map['location'] as String).input(),
      machineConfig: map['machineConfig'] == null ? null : (MachineConfigAlloydbV1beta.fromMap((map['machineConfig'] as Map).cast<String, dynamic>())).input(),
      project: map['project'] == null ? null : (map['project'] as String).input(),
      queryInsightsConfig: map['queryInsightsConfig'] == null ? null : (QueryInsightsInstanceConfigAlloydbV1beta.fromMap((map['queryInsightsConfig'] as Map).cast<String, dynamic>())).input(),
      readPoolConfig: map['readPoolConfig'] == null ? null : (ReadPoolConfigAlloydbV1beta.fromMap((map['readPoolConfig'] as Map).cast<String, dynamic>())).input(),
      requestId: map['requestId'] == null ? null : (map['requestId'] as String).input(),
      updatePolicy: map['updatePolicy'] == null ? null : (UpdatePolicyAlloydbV1beta.fromMap((map['updatePolicy'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
