...
class InstanceAlloydbV1betaArgs {
  ...
  const InstanceAlloydbV1betaArgs({
    this.annotations,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'availabilityType': ?pulumi.Input.mapOptionalInputValue<InstanceAvailabilityTypeAlloydbV1beta, String>(availabilityType, (value) => value.wireValue),
      ...
      'instanceType': pulumi.Input.mapInputValue<InstanceInstanceTypeAlloydbV1beta, String>(instanceType, (value) => value.wireValue),
      'labels': ?labels,
      'location': ?location,
  ...
  factory InstanceAlloydbV1betaArgs.fromMap(Map<String, dynamic> map) {
    return InstanceAlloydbV1betaArgs(
      ...
      availabilityType: (() { final guardedValue = map['availabilityType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceAvailabilityTypeAlloydbV1beta.fromValue(guardedValue as String)); })(),
      clientConnectionConfig: (() { final guardedValue = map['clientConnectionConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClientConnectionConfigAlloydbV1beta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      instanceType: pulumi.Input.fromValue(InstanceInstanceTypeAlloydbV1beta.fromValue(map['instanceType']! as String)),
      labels: (() { final guardedValue = map['labels']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      location: (() { final guardedValue = map['location']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      machineConfig: (() { final guardedValue = map['machineConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MachineConfigAlloydbV1beta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      project: (() { final guardedValue = map['project']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      queryInsightsConfig: (() { final guardedValue = map['queryInsightsConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(QueryInsightsInstanceConfigAlloydbV1beta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      readPoolConfig: (() { final guardedValue = map['readPoolConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ReadPoolConfigAlloydbV1beta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      requestId: (() { final guardedValue = map['requestId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      updatePolicy: (() { final guardedValue = map['updatePolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(UpdatePolicyAlloydbV1beta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
