    ...
    return <String, dynamic>{
      'caSource':
          ?pulumi.Input.mapOptionalInputValue<
            SslConfigCaSourceAlloydbV1beta,
            String
          >(caSource, (value) => value.wireValue),
      'sslMode':
          ?pulumi.Input.mapOptionalInputValue<
            SslConfigSslModeAlloydbV1beta,
            String
    ...
    return SslConfigAlloydbV1beta(
      caSource: (() {
        ...
        return pulumi.Input.fromValue(
          SslConfigCaSourceAlloydbV1beta.fromValue(guardedValue as String),
        );
      })(),
      sslMode: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SslConfigSslModeAlloydbV1beta.fromValue(guardedValue as String),
        );
      })(),
    );
  }
