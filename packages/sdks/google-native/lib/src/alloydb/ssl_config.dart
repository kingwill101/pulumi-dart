...
class SslConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'caSource':
          ?pulumi.Input.mapOptionalInputValue<SslConfigCaSource, String>(
            caSource,
            (value) => value.wireValue,
          ),
      'sslMode': ?pulumi.Input.mapOptionalInputValue<SslConfigSslMode, String>(
        sslMode,
        (value) => value.wireValue,
      ),
    };
    ...
    return SslConfig(
      caSource: (() {
        ...
        return pulumi.Input.fromValue(
          SslConfigCaSource.fromValue(guardedValue as String),
        );
      })(),
      sslMode: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SslConfigSslMode.fromValue(guardedValue as String),
        );
      })(),
    );
  }
