...
class BackupAlloydbV1betaArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'project': ?project,
      'requestId': ?requestId,
      'type': ?pulumi.Input.mapOptionalInputValue<BackupTypeAlloydbV1beta, String>(type, (value) => value.wireValue),
    };
  }
  ...
  factory BackupAlloydbV1betaArgs.fromMap(Map<String, dynamic> map) {
    return BackupAlloydbV1betaArgs(
      ...
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BackupTypeAlloydbV1beta.fromValue(guardedValue as String)); })(),
    );
  }
}
