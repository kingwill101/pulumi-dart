...
class ClusterArgs {
  ...
  ClusterArgs({
    ...
    pulumi.Output<AutomatedBackupPolicy>? automatedBackupPolicy,
    required pulumi.Output<String> clusterId,
    pulumi.Output<ContinuousBackupConfig>? continuousBackupConfig,
    pulumi.Output<ClusterDatabaseVersion>? databaseVersion,
    pulumi.Output<String>? displayName,
    pulumi.Output<EncryptionConfig>? encryptionConfig,
    pulumi.Output<String>? etag,
    pulumi.Output<UserPassword>? initialUser,
    ...
    pulumi.Output<SecondaryConfig>? secondaryConfig,
    pulumi.Output<SslConfig>? sslConfig,
  }) :
      annotations = pulumi.Input.asOptionalInput<Map<String, String>>(annotations),
      automatedBackupPolicy = pulumi.Input.asOptionalInput<AutomatedBackupPolicy>(automatedBackupPolicy),
      clusterId = pulumi.Input.asInput<String>(clusterId),
      continuousBackupConfig = pulumi.Input.asOptionalInput<ContinuousBackupConfig>(continuousBackupConfig),
      databaseVersion = pulumi.Input.asOptionalInput<ClusterDatabaseVersion>(databaseVersion),
      displayName = pulumi.Input.asOptionalInput<String>(displayName),
      encryptionConfig = pulumi.Input.asOptionalInput<EncryptionConfig>(encryptionConfig),
      etag = pulumi.Input.asOptionalInput<String>(etag),
      initialUser = pulumi.Input.asOptionalInput<UserPassword>(initialUser),
      ...
      secondaryConfig = pulumi.Input.asOptionalInput<SecondaryConfig>(secondaryConfig),
  ...
  factory ClusterArgs.fromMap(Map<String, dynamic> map) {
    return ClusterArgs(
      ...
      automatedBackupPolicy: map['automatedBackupPolicy'] == null ? null : pulumi.Output.create<AutomatedBackupPolicy>(AutomatedBackupPolicy.fromMap((map['automatedBackupPolicy'] as Map).cast<String, dynamic>())),
      clusterId: pulumi.Output.create<String>(map['clusterId'] as String),
      continuousBackupConfig: map['continuousBackupConfig'] == null ? null : pulumi.Output.create<ContinuousBackupConfig>(ContinuousBackupConfig.fromMap((map['continuousBackupConfig'] as Map).cast<String, dynamic>())),
      databaseVersion: map['databaseVersion'] == null ? null : pulumi.Output.create<ClusterDatabaseVersion>(ClusterDatabaseVersion.fromValue(map['databaseVersion'] as String)),
      ...
      initialUser: map['initialUser'] == null ? null : pulumi.Output.create<UserPassword>(UserPassword.fromMap((map['initialUser'] as Map).cast<String, dynamic>())),
      ...
      secondaryConfig: map['secondaryConfig'] == null ? null : pulumi.Output.create<SecondaryConfig>(SecondaryConfig.fromMap((map['secondaryConfig'] as Map).cast<String, dynamic>())),
