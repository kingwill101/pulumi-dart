...
class QueryInsightsInstanceConfigAlloydbV1alpha {
  ...
  /// Creates a new [QueryInsightsInstanceConfigAlloydbV1alpha].
  ...
  const QueryInsightsInstanceConfigAlloydbV1alpha({
  ...
  factory QueryInsightsInstanceConfigAlloydbV1alpha.fromMap(Map<String, dynamic> map) {
    return QueryInsightsInstanceConfigAlloydbV1alpha(
