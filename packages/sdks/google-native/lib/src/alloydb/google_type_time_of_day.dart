...
class GoogleTypeTimeOfDay {
  ...
  /// Creates a new [GoogleTypeTimeOfDay].
  ...
  GoogleTypeTimeOfDay({this.hours, this.minutes, this.nanos, this.seconds});
  ...
  factory GoogleTypeTimeOfDay.fromMap(Map<String, dynamic> map) {
