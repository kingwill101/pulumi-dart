...
class SslConfigAlloydbV1alpha {
    ...
    return <String, dynamic>{
      'caSource':
          ?pulumi.Input.mapOptionalInputValue<
            SslConfigCaSourceAlloydbV1alpha,
            String
          >(caSource, (value) => value.wireValue),
      'sslMode':
          ?pulumi.Input.mapOptionalInputValue<
            SslConfigSslModeAlloydbV1alpha,
            String
  ...
  factory SslConfigAlloydbV1alpha.fromMap(Map<String, dynamic> map) {
    return SslConfigAlloydbV1alpha(
      caSource: (() {
        final guardedValue = map['caSource'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SslConfigCaSourceAlloydbV1alpha.fromValue(guardedValue as String),
        );
      })(),
      sslMode: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SslConfigSslModeAlloydbV1alpha.fromValue(guardedValue as String),
        );
      })(),
    );
  }
