...
class AutomatedBackupPolicyResponseAlloydbV1alpha {
  ...
  final pulumi.Input<QuantityBasedRetentionResponseAlloydbV1alpha>
  quantityBasedRetention;

  /// Time-based Backup retention policy.
  final pulumi.Input<TimeBasedRetentionResponseAlloydbV1alpha>
  timeBasedRetention;
  ...
  factory AutomatedBackupPolicyResponseAlloydbV1alpha.fromMap(
    ...
    return AutomatedBackupPolicyResponseAlloydbV1alpha(
      ...
      timeBasedRetention: pulumi.Input.fromValue(
        TimeBasedRetentionResponseAlloydbV1alpha.fromMap(
          (map['timeBasedRetention']! as Map).cast<String, dynamic>(),
        ),
      ),
      weeklySchedule: pulumi.Input.fromValue(
        WeeklyScheduleResponseAlloydbV1alpha.fromMap(
