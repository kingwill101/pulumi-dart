...
class UserAlloydbV1betaArgs {
  ...
  UserAlloydbV1betaArgs({
    ...
    pulumi.Output<UserUserTypeAlloydbV1beta>? userType,
  }) :
      ...
      userType = pulumi.Input.asOptionalInput<UserUserTypeAlloydbV1beta>(userType);
  ...
  factory UserAlloydbV1betaArgs.fromMap(Map<String, dynamic> map) {
    return UserAlloydbV1betaArgs(
      ...
      userType: map['userType'] == null ? null : pulumi.Output.create<UserUserTypeAlloydbV1beta>(UserUserTypeAlloydbV1beta.fromValue(map['userType'] as String)),
    );
  }
}
