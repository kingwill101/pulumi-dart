...
class UserAlloydbV1betaArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'requestId': ?requestId,
      'userId': userId,
      'userType': ?pulumi.Input.mapOptionalInputValue<UserUserTypeAlloydbV1beta, String>(userType, (value) => value.wireValue),
    };
  }
  ...
  factory UserAlloydbV1betaArgs.fromMap(Map<String, dynamic> map) {
    return UserAlloydbV1betaArgs(
      ...
      userType: (() { final guardedValue = map['userType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(UserUserTypeAlloydbV1beta.fromValue(guardedValue as String)); })(),
    );
  }
}
