...
class WeeklyScheduleResponse {
  ...
  factory WeeklyScheduleResponse.fromMap(Map<String, dynamic> map) {
    return WeeklyScheduleResponse(
      ...
      startTimes: (pulumi.Input.decodeList<GoogleTypeTimeOfDayResponse>(map['startTimes'], (value) => GoogleTypeTimeOfDayResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
