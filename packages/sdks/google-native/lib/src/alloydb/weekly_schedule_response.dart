...
class WeeklyScheduleResponse {
  ...
  final pulumi.Input<List<GoogleTypeTimeOfDayResponse>> startTimes;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'startTimes': pulumi.Input.mapInputValue<List<GoogleTypeTimeOfDayResponse>, List<Map<String, dynamic>>>(startTimes, (value) => pulumi.Input.encodeList<GoogleTypeTimeOfDayResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory WeeklyScheduleResponse.fromMap(Map<String, dynamic> map) {
    return WeeklyScheduleResponse(
      ...
      startTimes: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleTypeTimeOfDayResponse>(map['startTimes']!, (value) => GoogleTypeTimeOfDayResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
