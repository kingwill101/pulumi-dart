...
class BackupArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'project': ?project,
      'requestId': ?requestId,
      'type': ?pulumi.Input.mapOptionalInputValue<BackupType, String>(type, (value) => value.wireValue),
    };
  }
  ...
  factory BackupArgs.fromMap(Map<String, dynamic> map) {
    return BackupArgs(
      ...
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BackupType.fromValue(guardedValue as String)); })(),
    );
  }
}
