...
import 'backup_alloydb_v1beta_args.dart';
import 'encryption_config_response_alloydb_v1beta.dart';
import 'encryption_info_response_alloydb_v1beta.dart';
import 'quantity_based_expiry_response_alloydb_v1beta.dart';

/// Creates a new Backup in a given project and location.
/// Auto-naming is currently not supported for this resource.
class BackupAlloydbV1beta extends pulumi.CustomResource {
  ...
  late final pulumi.Output<QuantityBasedExpiryResponseAlloydbV1beta> expiryQuantity;
  ...
  /// Creates a new [BackupAlloydbV1beta].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [BackupAlloydbV1beta]. {@macro pulumi_alloydb_v1beta_backup_alloydb_v1beta_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  BackupAlloydbV1beta(
    String name, {
    BackupAlloydbV1betaArgs? args,
    ...
    encryptionConfig = registerOutput<EncryptionConfigResponseAlloydbV1beta>('encryptionConfig', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return EncryptionConfigResponseAlloydbV1beta.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    encryptionInfo = registerOutput<EncryptionInfoResponseAlloydbV1beta>('encryptionInfo', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return EncryptionInfoResponseAlloydbV1beta.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    etag = registerOutput<String>('etag');
    expiryQuantity = registerOutput<QuantityBasedExpiryResponseAlloydbV1beta>('expiryQuantity', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return QuantityBasedExpiryResponseAlloydbV1beta.fromMap((guardedValue as Map).cast<String, dynamic>()); });
