...
class GetInstanceAlloydbV1alphaResult {
  ...
  const GetInstanceAlloydbV1alphaResult({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': name,
      'nodes': pulumi.Input.encodeList<NodeResponseAlloydbV1alpha, Map<String, dynamic>>(nodes, (value) => value.toMap()),
  ...
  factory GetInstanceAlloydbV1alphaResult.fromMap(Map<String, dynamic> map) {
    return GetInstanceAlloydbV1alphaResult(
      ...
      clientConnectionConfig: ClientConnectionConfigResponseAlloydbV1alpha.fromMap((map['clientConnectionConfig']! as Map).cast<String, dynamic>()),
      ...
      machineConfig: MachineConfigResponseAlloydbV1alpha.fromMap((map['machineConfig']! as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      nodes: pulumi.Input.decodeList<NodeResponseAlloydbV1alpha>(map['nodes']!, (value) => NodeResponseAlloydbV1alpha.fromMap((value as Map).cast<String, dynamic>())),
      queryInsightsConfig: QueryInsightsInstanceConfigResponseAlloydbV1alpha.fromMap((map['queryInsightsConfig']! as Map).cast<String, dynamic>()),
      readPoolConfig: ReadPoolConfigResponseAlloydbV1alpha.fromMap((map['readPoolConfig']! as Map).cast<String, dynamic>()),
      reconciling: map['reconciling'] as bool,
      satisfiesPzs: map['satisfiesPzs'] as bool,
      state: map['state'] as String,
      uid: map['uid'] as String,
      updatePolicy: UpdatePolicyResponse.fromMap((map['updatePolicy']! as Map).cast<String, dynamic>()),
      updateTime: map['updateTime'] as String,
      writableNode: NodeResponseAlloydbV1alpha.fromMap((map['writableNode']! as Map).cast<String, dynamic>()),
    );
  }
}
