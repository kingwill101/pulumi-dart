...
class GoogleTypeTimeOfDayResponse {
  ...
  /// Creates a new [GoogleTypeTimeOfDayResponse].
  ...
  const GoogleTypeTimeOfDayResponse({
    required this.hours,
  ...
  factory GoogleTypeTimeOfDayResponse.fromMap(Map<String, dynamic> map) {
    return GoogleTypeTimeOfDayResponse(
