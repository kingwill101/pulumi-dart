...
class ClusterAlloydbV1betaArgs {
  ...
  ClusterAlloydbV1betaArgs({
    ...
    pulumi.Output<AutomatedBackupPolicyAlloydbV1beta>? automatedBackupPolicy,
    required pulumi.Output<String> clusterId,
    pulumi.Output<ContinuousBackupConfigAlloydbV1beta>? continuousBackupConfig,
    pulumi.Output<ClusterDatabaseVersionAlloydbV1beta>? databaseVersion,
    pulumi.Output<String>? displayName,
    pulumi.Output<EncryptionConfigAlloydbV1beta>? encryptionConfig,
    pulumi.Output<String>? etag,
    pulumi.Output<UserPasswordAlloydbV1beta>? initialUser,
    pulumi.Output<Map<String, String>>? labels,
    pulumi.Output<String>? location,
    required pulumi.Output<String> network,
    pulumi.Output<NetworkConfigAlloydbV1beta>? networkConfig,
    pulumi.Output<String>? project,
    pulumi.Output<String>? requestId,
    pulumi.Output<SecondaryConfigAlloydbV1beta>? secondaryConfig,
    pulumi.Output<SslConfigAlloydbV1beta>? sslConfig,
  }) :
      annotations = pulumi.Input.asOptionalInput<Map<String, String>>(annotations),
      automatedBackupPolicy = pulumi.Input.asOptionalInput<AutomatedBackupPolicyAlloydbV1beta>(automatedBackupPolicy),
      clusterId = pulumi.Input.asInput<String>(clusterId),
      continuousBackupConfig = pulumi.Input.asOptionalInput<ContinuousBackupConfigAlloydbV1beta>(continuousBackupConfig),
      databaseVersion = pulumi.Input.asOptionalInput<ClusterDatabaseVersionAlloydbV1beta>(databaseVersion),
      displayName = pulumi.Input.asOptionalInput<String>(displayName),
      encryptionConfig = pulumi.Input.asOptionalInput<EncryptionConfigAlloydbV1beta>(encryptionConfig),
      etag = pulumi.Input.asOptionalInput<String>(etag),
      initialUser = pulumi.Input.asOptionalInput<UserPasswordAlloydbV1beta>(initialUser),
      labels = pulumi.Input.asOptionalInput<Map<String, String>>(labels),
      location = pulumi.Input.asOptionalInput<String>(location),
      network = pulumi.Input.asInput<String>(network),
      networkConfig = pulumi.Input.asOptionalInput<NetworkConfigAlloydbV1beta>(networkConfig),
      project = pulumi.Input.asOptionalInput<String>(project),
      requestId = pulumi.Input.asOptionalInput<String>(requestId),
      secondaryConfig = pulumi.Input.asOptionalInput<SecondaryConfigAlloydbV1beta>(secondaryConfig),
      sslConfig = pulumi.Input.asOptionalInput<SslConfigAlloydbV1beta>(sslConfig);
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'databaseVersion': ?pulumi.Input.mapOptionalInputValue<ClusterDatabaseVersionAlloydbV1beta, String>(databaseVersion, (value) => value.value),
  ...
  factory ClusterAlloydbV1betaArgs.fromMap(Map<String, dynamic> map) {
    return ClusterAlloydbV1betaArgs(
      ...
      automatedBackupPolicy: map['automatedBackupPolicy'] == null ? null : pulumi.Output.create<AutomatedBackupPolicyAlloydbV1beta>(AutomatedBackupPolicyAlloydbV1beta.fromMap((map['automatedBackupPolicy'] as Map).cast<String, dynamic>())),
      clusterId: pulumi.Output.create<String>(map['clusterId'] as String),
      continuousBackupConfig: map['continuousBackupConfig'] == null ? null : pulumi.Output.create<ContinuousBackupConfigAlloydbV1beta>(ContinuousBackupConfigAlloydbV1beta.fromMap((map['continuousBackupConfig'] as Map).cast<String, dynamic>())),
      databaseVersion: map['databaseVersion'] == null ? null : pulumi.Output.create<ClusterDatabaseVersionAlloydbV1beta>(ClusterDatabaseVersionAlloydbV1beta.fromValue(map['databaseVersion'] as String)),
      ...
      initialUser: map['initialUser'] == null ? null : pulumi.Output.create<UserPasswordAlloydbV1beta>(UserPasswordAlloydbV1beta.fromMap((map['initialUser'] as Map).cast<String, dynamic>())),
      labels: map['labels'] == null ? null : pulumi.Output.create<Map<String, String>>((map['labels'] as Map).cast<String, String>()),
      location: map['location'] == null ? null : pulumi.Output.create<String>(map['location'] as String),
      network: pulumi.Output.create<String>(map['network'] as String),
      networkConfig: map['networkConfig'] == null ? null : pulumi.Output.create<NetworkConfigAlloydbV1beta>(NetworkConfigAlloydbV1beta.fromMap((map['networkConfig'] as Map).cast<String, dynamic>())),
      project: map['project'] == null ? null : pulumi.Output.create<String>(map['project'] as String),
      requestId: map['requestId'] == null ? null : pulumi.Output.create<String>(map['requestId'] as String),
      secondaryConfig: map['secondaryConfig'] == null ? null : pulumi.Output.create<SecondaryConfigAlloydbV1beta>(SecondaryConfigAlloydbV1beta.fromMap((map['secondaryConfig'] as Map).cast<String, dynamic>())),
      sslConfig: map['sslConfig'] == null ? null : pulumi.Output.create<SslConfigAlloydbV1beta>(SslConfigAlloydbV1beta.fromMap((map['sslConfig'] as Map).cast<String, dynamic>())),
    );
  }
}
