...
class AutomatedBackupPolicyAlloydbV1beta {
  ...
  const AutomatedBackupPolicyAlloydbV1beta({
    this.backupWindow,
    this.enabled,
  ...
  factory AutomatedBackupPolicyAlloydbV1beta.fromMap(Map<String, dynamic> map) {
    return AutomatedBackupPolicyAlloydbV1beta(
      ...
      quantityBasedRetention: (() { final guardedValue = map['quantityBasedRetention']; if (guardedValue == null) return null; return pulumi.Input.fromValue(QuantityBasedRetentionAlloydbV1beta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      timeBasedRetention: (() { final guardedValue = map['timeBasedRetention']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TimeBasedRetentionAlloydbV1beta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      weeklySchedule: (() { final guardedValue = map['weeklySchedule']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WeeklyScheduleAlloydbV1beta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
