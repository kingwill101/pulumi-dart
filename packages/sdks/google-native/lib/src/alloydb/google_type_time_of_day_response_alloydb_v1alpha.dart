...
class GoogleTypeTimeOfDayResponseAlloydbV1alpha {
  ...
  /// Creates a new [GoogleTypeTimeOfDayResponseAlloydbV1alpha].
  ...
  const GoogleTypeTimeOfDayResponseAlloydbV1alpha({
    required this.hours,
  ...
  factory GoogleTypeTimeOfDayResponseAlloydbV1alpha.fromMap(Map<String, dynamic> map) {
    return GoogleTypeTimeOfDayResponseAlloydbV1alpha(
