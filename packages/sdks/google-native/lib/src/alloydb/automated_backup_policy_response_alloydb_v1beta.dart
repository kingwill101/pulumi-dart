...
class AutomatedBackupPolicyResponseAlloydbV1beta {
  ...
  final pulumi.Input<QuantityBasedRetentionResponseAlloydbV1beta>
  quantityBasedRetention;

  /// Time-based Backup retention policy.
  final pulumi.Input<TimeBasedRetentionResponseAlloydbV1beta>
  timeBasedRetention;
  ...
  factory AutomatedBackupPolicyResponseAlloydbV1beta.fromMap(
    ...
    return AutomatedBackupPolicyResponseAlloydbV1beta(
      ...
      encryptionConfig: pulumi.Input.fromValue(
        EncryptionConfigResponseAlloydbV1beta.fromMap(
      ...
      timeBasedRetention: pulumi.Input.fromValue(
        TimeBasedRetentionResponseAlloydbV1beta.fromMap(
          (map['timeBasedRetention']! as Map).cast<String, dynamic>(),
        ),
      ),
      weeklySchedule: pulumi.Input.fromValue(
        WeeklyScheduleResponseAlloydbV1beta.fromMap(
