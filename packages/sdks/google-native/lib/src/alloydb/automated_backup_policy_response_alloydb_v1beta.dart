...
class AutomatedBackupPolicyResponseAlloydbV1beta {
  ...
  const AutomatedBackupPolicyResponseAlloydbV1beta({
  ...
  factory AutomatedBackupPolicyResponseAlloydbV1beta.fromMap(Map<String, dynamic> map) {
    return AutomatedBackupPolicyResponseAlloydbV1beta(
      ...
      quantityBasedRetention: pulumi.Input.fromValue(QuantityBasedRetentionResponseAlloydbV1beta.fromMap((map['quantityBasedRetention']! as Map).cast<String, dynamic>())),
      timeBasedRetention: pulumi.Input.fromValue(TimeBasedRetentionResponseAlloydbV1beta.fromMap((map['timeBasedRetention']! as Map).cast<String, dynamic>())),
      weeklySchedule: pulumi.Input.fromValue(WeeklyScheduleResponseAlloydbV1beta.fromMap((map['weeklySchedule']! as Map).cast<String, dynamic>())),
    );
  }
}
