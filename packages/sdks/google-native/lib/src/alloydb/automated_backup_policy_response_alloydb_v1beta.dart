...
class AutomatedBackupPolicyResponseAlloydbV1beta {
  ...
  final pulumi.Input<QuantityBasedRetentionResponseAlloydbV1beta> quantityBasedRetention;
  /// Time-based Backup retention policy.
  final pulumi.Input<TimeBasedRetentionResponseAlloydbV1beta> timeBasedRetention;
  /// Weekly schedule for the Backup.
  final pulumi.Input<WeeklyScheduleResponseAlloydbV1beta> weeklySchedule;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'labels': labels,
      'location': location,
      'quantityBasedRetention': pulumi.Input.mapInputValue<QuantityBasedRetentionResponseAlloydbV1beta, Map<String, dynamic>>(quantityBasedRetention, (value) => value.toMap()),
      'timeBasedRetention': pulumi.Input.mapInputValue<TimeBasedRetentionResponseAlloydbV1beta, Map<String, dynamic>>(timeBasedRetention, (value) => value.toMap()),
      'weeklySchedule': pulumi.Input.mapInputValue<WeeklyScheduleResponseAlloydbV1beta, Map<String, dynamic>>(weeklySchedule, (value) => value.toMap()),
    };
  }
  ...
  factory AutomatedBackupPolicyResponseAlloydbV1beta.fromMap(Map<String, dynamic> map) {
    return AutomatedBackupPolicyResponseAlloydbV1beta(
      ...
      encryptionConfig: (EncryptionConfigResponseAlloydbV1beta.fromMap((map['encryptionConfig'] as Map).cast<String, dynamic>())).input(),
      labels: ((map['labels'] as Map).cast<String, String>()).input(),
      location: (map['location'] as String).input(),
      quantityBasedRetention: (QuantityBasedRetentionResponseAlloydbV1beta.fromMap((map['quantityBasedRetention'] as Map).cast<String, dynamic>())).input(),
      timeBasedRetention: (TimeBasedRetentionResponseAlloydbV1beta.fromMap((map['timeBasedRetention'] as Map).cast<String, dynamic>())).input(),
      weeklySchedule: (WeeklyScheduleResponseAlloydbV1beta.fromMap((map['weeklySchedule'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
