...
class Instance extends pulumi.CustomResource {
  ...
  Instance(
    ...
    this.clientConnectionConfig = registerOutput<ClientConnectionConfigResponse>('clientConnectionConfig');
    ...
    this.queryInsightsConfig = registerOutput<QueryInsightsInstanceConfigResponse>('queryInsightsConfig');
    this.readPoolConfig = registerOutput<ReadPoolConfigResponse>('readPoolConfig');
