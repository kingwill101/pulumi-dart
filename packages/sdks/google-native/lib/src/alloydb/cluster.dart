...
class Cluster extends pulumi.CustomResource {
  ...
  Cluster(
    ...
    this.automatedBackupPolicy = registerOutput<AutomatedBackupPolicyResponse>('automatedBackupPolicy');
    ...
    this.continuousBackupConfig = registerOutput<ContinuousBackupConfigResponse>('continuousBackupConfig');
    this.continuousBackupInfo = registerOutput<ContinuousBackupInfoResponse>('continuousBackupInfo');
    ...
    this.encryptionInfo = registerOutput<EncryptionInfoResponse>('encryptionInfo');
    this.etag = registerOutput<String>('etag');
    this.initialUser = registerOutput<UserPasswordResponse>('initialUser');
    this.labels = registerOutput<Map<String, String>>('labels');
    this.location = registerOutput<String>('location');
    this.migrationSource = registerOutput<MigrationSourceResponse>('migrationSource');
    ...
    this.secondaryConfig = registerOutput<SecondaryConfigResponse>('secondaryConfig');
