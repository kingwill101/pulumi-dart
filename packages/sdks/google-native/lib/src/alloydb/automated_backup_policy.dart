...
class AutomatedBackupPolicy {
  ...
  factory AutomatedBackupPolicy.fromMap(Map<String, dynamic> map) {
    return AutomatedBackupPolicy(
      ...
      quantityBasedRetention: map['quantityBasedRetention'] == null ? null : QuantityBasedRetention.fromMap((map['quantityBasedRetention'] as Map).cast<String, dynamic>()),
      timeBasedRetention: map['timeBasedRetention'] == null ? null : TimeBasedRetention.fromMap((map['timeBasedRetention'] as Map).cast<String, dynamic>()),
