...
class Backup extends pulumi.CustomResource {
  ...
  Backup(
    ...
    expiryQuantity = registerOutput<QuantityBasedExpiryResponse>('expiryQuantity', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return QuantityBasedExpiryResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
