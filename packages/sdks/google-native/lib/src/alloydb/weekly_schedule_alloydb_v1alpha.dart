...
class WeeklyScheduleAlloydbV1alpha {
  ...
  final pulumi.Input<List<WeeklyScheduleDaysOfWeekItemAlloydbV1alpha>>?
  daysOfWeek;
    ...
    return <String, dynamic>{
      'daysOfWeek':
          ?pulumi.Input.mapOptionalInputValue<
            List<WeeklyScheduleDaysOfWeekItemAlloydbV1alpha>,
            List<String>
          >(
            daysOfWeek,
            (value) =>
      ...
      'startTimes':
          ?pulumi.Input.mapOptionalInputValue<
            List<GoogleTypeTimeOfDayAlloydbV1alpha>,
