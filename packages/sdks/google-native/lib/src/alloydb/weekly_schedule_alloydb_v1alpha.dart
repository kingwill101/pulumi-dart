...
class WeeklyScheduleAlloydbV1alpha {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'daysOfWeek': ?pulumi.Input.mapOptionalInputValue<List<WeeklyScheduleDaysOfWeekItemAlloydbV1alpha>, List<String>>(daysOfWeek, (value) => pulumi.Input.encodeList<WeeklyScheduleDaysOfWeekItemAlloydbV1alpha, String>(value, (value) => value.value)),
