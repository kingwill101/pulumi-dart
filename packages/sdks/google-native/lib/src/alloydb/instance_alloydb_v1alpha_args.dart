...
class InstanceAlloydbV1alphaArgs {
  ...
  factory InstanceAlloydbV1alphaArgs.fromMap(Map<String, dynamic> map) {
    return InstanceAlloydbV1alphaArgs(
      ...
      availabilityType: map['availabilityType'] == null ? null : (InstanceAvailabilityTypeAlloydbV1alpha.fromValue(map['availabilityType']! as String)).input(),
      clientConnectionConfig: map['clientConnectionConfig'] == null ? null : (ClientConnectionConfigAlloydbV1alpha.fromMap((map['clientConnectionConfig']! as Map).cast<String, dynamic>())).input(),
      ...
      instanceType: (InstanceInstanceTypeAlloydbV1alpha.fromValue(map['instanceType'] as String)).input(),
      labels: map['labels'] == null ? null : ((map['labels']! as Map).cast<String, String>()).input(),
      location: map['location'] == null ? null : (map['location']! as String).input(),
      machineConfig: map['machineConfig'] == null ? null : (MachineConfigAlloydbV1alpha.fromMap((map['machineConfig']! as Map).cast<String, dynamic>())).input(),
      project: map['project'] == null ? null : (map['project']! as String).input(),
      queryInsightsConfig: map['queryInsightsConfig'] == null ? null : (QueryInsightsInstanceConfigAlloydbV1alpha.fromMap((map['queryInsightsConfig']! as Map).cast<String, dynamic>())).input(),
      readPoolConfig: map['readPoolConfig'] == null ? null : (ReadPoolConfigAlloydbV1alpha.fromMap((map['readPoolConfig']! as Map).cast<String, dynamic>())).input(),
      requestId: map['requestId'] == null ? null : (map['requestId']! as String).input(),
      updatePolicy: map['updatePolicy'] == null ? null : (UpdatePolicy.fromMap((map['updatePolicy']! as Map).cast<String, dynamic>())).input(),
    );
  }
}
