...
class InstanceAlloydbV1alphaArgs {
  ...
  InstanceAlloydbV1alphaArgs({
    ...
    pulumi.Output<InstanceAvailabilityTypeAlloydbV1alpha>? availabilityType,
    pulumi.Output<ClientConnectionConfigAlloydbV1alpha>? clientConnectionConfig,
    ...
    required pulumi.Output<InstanceInstanceTypeAlloydbV1alpha> instanceType,
    pulumi.Output<Map<String, String>>? labels,
    pulumi.Output<String>? location,
    pulumi.Output<MachineConfigAlloydbV1alpha>? machineConfig,
    pulumi.Output<String>? project,
    pulumi.Output<QueryInsightsInstanceConfigAlloydbV1alpha>? queryInsightsConfig,
    pulumi.Output<ReadPoolConfigAlloydbV1alpha>? readPoolConfig,
    pulumi.Output<String>? requestId,
    pulumi.Output<UpdatePolicy>? updatePolicy,
  }) :
  ...
  factory InstanceAlloydbV1alphaArgs.fromMap(Map<String, dynamic> map) {
    return InstanceAlloydbV1alphaArgs(
      ...
      availabilityType: map['availabilityType'] == null ? null : pulumi.Output.create<InstanceAvailabilityTypeAlloydbV1alpha>(InstanceAvailabilityTypeAlloydbV1alpha.fromValue(map['availabilityType'] as String)),
      clientConnectionConfig: map['clientConnectionConfig'] == null ? null : pulumi.Output.create<ClientConnectionConfigAlloydbV1alpha>(ClientConnectionConfigAlloydbV1alpha.fromMap((map['clientConnectionConfig'] as Map).cast<String, dynamic>())),
      ...
      instanceType: pulumi.Output.create<InstanceInstanceTypeAlloydbV1alpha>(InstanceInstanceTypeAlloydbV1alpha.fromValue(map['instanceType'] as String)),
      labels: map['labels'] == null ? null : pulumi.Output.create<Map<String, String>>((map['labels'] as Map).cast<String, String>()),
      location: map['location'] == null ? null : pulumi.Output.create<String>(map['location'] as String),
      machineConfig: map['machineConfig'] == null ? null : pulumi.Output.create<MachineConfigAlloydbV1alpha>(MachineConfigAlloydbV1alpha.fromMap((map['machineConfig'] as Map).cast<String, dynamic>())),
      project: map['project'] == null ? null : pulumi.Output.create<String>(map['project'] as String),
      queryInsightsConfig: map['queryInsightsConfig'] == null ? null : pulumi.Output.create<QueryInsightsInstanceConfigAlloydbV1alpha>(QueryInsightsInstanceConfigAlloydbV1alpha.fromMap((map['queryInsightsConfig'] as Map).cast<String, dynamic>())),
      readPoolConfig: map['readPoolConfig'] == null ? null : pulumi.Output.create<ReadPoolConfigAlloydbV1alpha>(ReadPoolConfigAlloydbV1alpha.fromMap((map['readPoolConfig'] as Map).cast<String, dynamic>())),
      requestId: map['requestId'] == null ? null : pulumi.Output.create<String>(map['requestId'] as String),
      updatePolicy: map['updatePolicy'] == null ? null : pulumi.Output.create<UpdatePolicy>(UpdatePolicy.fromMap((map['updatePolicy'] as Map).cast<String, dynamic>())),
    );
  }
}
