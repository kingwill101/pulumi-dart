...
class BackupAlloydbV1alphaArgs {
  ...
  BackupAlloydbV1alphaArgs({
    ...
    pulumi.Output<BackupTypeAlloydbV1alpha>? type,
  }) :
  ...
  factory BackupAlloydbV1alphaArgs.fromMap(Map<String, dynamic> map) {
    return BackupAlloydbV1alphaArgs(
      ...
      type: map['type'] == null ? null : pulumi.Output.create<BackupTypeAlloydbV1alpha>(BackupTypeAlloydbV1alpha.fromValue(map['type'] as String)),
    );
  }
}
