...
class GetUserAlloydbV1betaResult {
  ...
  /// Creates a new [GetUserAlloydbV1betaResult].
  ...
  const GetUserAlloydbV1betaResult({
  ...
  factory GetUserAlloydbV1betaResult.fromMap(Map<String, dynamic> map) {
    return GetUserAlloydbV1betaResult(
