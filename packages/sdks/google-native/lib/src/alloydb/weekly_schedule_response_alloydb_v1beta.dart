...
class WeeklyScheduleResponseAlloydbV1beta {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'startTimes': pulumi.Input.encodeList<GoogleTypeTimeOfDayResponseAlloydbV1beta, Map<String, dynamic>>(startTimes, (value) => value.toMap()),
    };
  }
  ...
  factory WeeklyScheduleResponseAlloydbV1beta.fromMap(Map<String, dynamic> map) {
    return WeeklyScheduleResponseAlloydbV1beta(
      ...
      startTimes: pulumi.Input.decodeList<GoogleTypeTimeOfDayResponseAlloydbV1beta>(map['startTimes'], (value) => GoogleTypeTimeOfDayResponseAlloydbV1beta.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
