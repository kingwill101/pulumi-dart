...
class WeeklyScheduleAlloydbV1beta {
  ...
  const WeeklyScheduleAlloydbV1beta({
    this.daysOfWeek,
    this.startTimes,
  });
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'daysOfWeek': ?pulumi.Input.mapOptionalInputValue<List<WeeklyScheduleDaysOfWeekItemAlloydbV1beta>, List<String>>(daysOfWeek, (value) => pulumi.Input.encodeList<WeeklyScheduleDaysOfWeekItemAlloydbV1beta, String>(value, (value) => value.wireValue)),
  ...
  factory WeeklyScheduleAlloydbV1beta.fromMap(Map<String, dynamic> map) {
    return WeeklyScheduleAlloydbV1beta(
      daysOfWeek: (() { final guardedValue = map['daysOfWeek']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<WeeklyScheduleDaysOfWeekItemAlloydbV1beta>(guardedValue, (value) => WeeklyScheduleDaysOfWeekItemAlloydbV1beta.fromValue(value as String))); })(),
      startTimes: (() { final guardedValue = map['startTimes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleTypeTimeOfDayAlloydbV1beta>(guardedValue, (value) => GoogleTypeTimeOfDayAlloydbV1beta.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
