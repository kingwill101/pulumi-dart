...
class WeeklyScheduleAlloydbV1beta {
  ...
  final pulumi.Input<List<WeeklyScheduleDaysOfWeekItemAlloydbV1beta>>?
  daysOfWeek;
  ...
  WeeklyScheduleAlloydbV1beta({this.daysOfWeek, this.startTimes});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'daysOfWeek':
          ?pulumi.Input.mapOptionalInputValue<
            List<WeeklyScheduleDaysOfWeekItemAlloydbV1beta>,
            List<String>
          >(
            daysOfWeek,
            (value) =>
      ...
      'startTimes':
          ?pulumi.Input.mapOptionalInputValue<
            List<GoogleTypeTimeOfDayAlloydbV1beta>,
