...
class AutomatedBackupPolicyResponse {
  ...
  factory AutomatedBackupPolicyResponse.fromMap(Map<String, dynamic> map) {
    return AutomatedBackupPolicyResponse(
      ...
      quantityBasedRetention: pulumi.Input.fromValue(QuantityBasedRetentionResponse.fromMap((map['quantityBasedRetention']! as Map).cast<String, dynamic>())),
      timeBasedRetention: pulumi.Input.fromValue(TimeBasedRetentionResponse.fromMap((map['timeBasedRetention']! as Map).cast<String, dynamic>())),
      weeklySchedule: pulumi.Input.fromValue(WeeklyScheduleResponse.fromMap((map['weeklySchedule']! as Map).cast<String, dynamic>())),
    );
  }
}
