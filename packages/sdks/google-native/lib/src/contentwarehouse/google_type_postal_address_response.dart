...
class GoogleTypePostalAddressResponse {
  ...
  /// Creates a new [GoogleTypePostalAddressResponse].
  ...
  const GoogleTypePostalAddressResponse({
  ...
  factory GoogleTypePostalAddressResponse.fromMap(Map<String, dynamic> map) {
    return GoogleTypePostalAddressResponse(
