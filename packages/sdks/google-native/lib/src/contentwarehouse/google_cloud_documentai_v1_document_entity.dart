...
class GoogleCloudDocumentaiV1DocumentEntity {
  ...
  factory GoogleCloudDocumentaiV1DocumentEntity.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDocumentaiV1DocumentEntity(
      ...
      mentionId: (() { final guardedValue = map['mentionId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      mentionText: (() { final guardedValue = map['mentionText']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      normalizedValue: (() { final guardedValue = map['normalizedValue']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDocumentaiV1DocumentEntityNormalizedValue.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      pageAnchor: (() { final guardedValue = map['pageAnchor']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDocumentaiV1DocumentPageAnchor.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudDocumentaiV1DocumentEntity>(guardedValue, (value) => GoogleCloudDocumentaiV1DocumentEntity.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      redacted: (() { final guardedValue = map['redacted']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
