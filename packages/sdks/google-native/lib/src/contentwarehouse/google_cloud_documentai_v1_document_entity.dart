...
class GoogleCloudDocumentaiV1DocumentEntity {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'normalizedValue': ?normalizedValue == null ? null : normalizedValue!.toMap(),
      'pageAnchor': ?pageAnchor == null ? null : pageAnchor!.toMap(),
      'properties': ?properties == null ? null : pulumi.Input.encodeList<GoogleCloudDocumentaiV1DocumentEntity, Map<String, dynamic>>(properties!, (value) => value.toMap()),
  ...
  factory GoogleCloudDocumentaiV1DocumentEntity.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDocumentaiV1DocumentEntity(
      ...
      mentionText: map['mentionText'] == null ? null : map['mentionText'] as String,
      normalizedValue: map['normalizedValue'] == null ? null : GoogleCloudDocumentaiV1DocumentEntityNormalizedValue.fromMap((map['normalizedValue'] as Map).cast<String, dynamic>()),
      pageAnchor: map['pageAnchor'] == null ? null : GoogleCloudDocumentaiV1DocumentPageAnchor.fromMap((map['pageAnchor'] as Map).cast<String, dynamic>()),
      properties: map['properties'] == null ? null : pulumi.Input.decodeList<GoogleCloudDocumentaiV1DocumentEntity>(map['properties'], (value) => GoogleCloudDocumentaiV1DocumentEntity.fromMap((value as Map).cast<String, dynamic>())),
