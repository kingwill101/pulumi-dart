...
class GoogleCloudContentwarehouseV1PropertyDefinitionResponse {
  ...
  final pulumi.Input<GoogleCloudContentwarehouseV1EnumTypeOptionsResponse>
  enumTypeOptions;
  ...
  final pulumi.Input<GoogleCloudContentwarehouseV1PropertyTypeOptionsResponse>
  propertyTypeOptions;
  ...
  final pulumi.Input<
    List<GoogleCloudContentwarehouseV1PropertyDefinitionSchemaSourceResponse>
  >
  schemaSources;
  ...
  factory GoogleCloudContentwarehouseV1PropertyDefinitionResponse.fromMap(
    ...
    return GoogleCloudContentwarehouseV1PropertyDefinitionResponse(
      ...
      mapTypeOptions: pulumi.Input.fromValue(
        (map['mapTypeOptions']! as Map).cast<String, dynamic>(),
      ),
      name: pulumi.Input.fromValue(map['name'] as String),
      propertyTypeOptions: pulumi.Input.fromValue(
        GoogleCloudContentwarehouseV1PropertyTypeOptionsResponse.fromMap(
          (map['propertyTypeOptions']! as Map).cast<String, dynamic>(),
        ),
      ),
      retrievalImportance: pulumi.Input.fromValue(
        map['retrievalImportance'] as String,
      ),
      schemaSources: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GoogleCloudContentwarehouseV1PropertyDefinitionSchemaSourceResponse
        >(
          map['schemaSources']!,
          (value) =>
              GoogleCloudContentwarehouseV1PropertyDefinitionSchemaSourceResponse.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
      textTypeOptions: pulumi.Input.fromValue(
        (map['textTypeOptions']! as Map).cast<String, dynamic>(),
      ),
      timestampTypeOptions: pulumi.Input.fromValue(
