...
class GoogleCloudDocumentaiV1DocumentEntityResponse {
  ...
  const GoogleCloudDocumentaiV1DocumentEntityResponse({
  ...
  factory GoogleCloudDocumentaiV1DocumentEntityResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDocumentaiV1DocumentEntityResponse(
      ...
      mentionId: pulumi.Input.fromValue(map['mentionId'] as String),
      mentionText: pulumi.Input.fromValue(map['mentionText'] as String),
      normalizedValue: pulumi.Input.fromValue(GoogleCloudDocumentaiV1DocumentEntityNormalizedValueResponse.fromMap((map['normalizedValue']! as Map).cast<String, dynamic>())),
      pageAnchor: pulumi.Input.fromValue(GoogleCloudDocumentaiV1DocumentPageAnchorResponse.fromMap((map['pageAnchor']! as Map).cast<String, dynamic>())),
      properties: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudDocumentaiV1DocumentEntityResponse>(map['properties']!, (value) => GoogleCloudDocumentaiV1DocumentEntityResponse.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      redacted: pulumi.Input.fromValue(map['redacted'] as bool),
