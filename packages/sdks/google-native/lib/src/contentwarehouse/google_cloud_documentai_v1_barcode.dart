...
class GoogleCloudDocumentaiV1Barcode {
  ...
  const GoogleCloudDocumentaiV1Barcode({
    this.format,
    this.rawValue,
    this.valueFormat,
  });
  ...
  factory GoogleCloudDocumentaiV1Barcode.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDocumentaiV1Barcode(
      ...
      rawValue: (() { final guardedValue = map['rawValue']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
