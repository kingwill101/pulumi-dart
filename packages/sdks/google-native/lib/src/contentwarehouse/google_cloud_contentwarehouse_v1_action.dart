...
class GoogleCloudContentwarehouseV1Action {
  ...
  final GoogleCloudContentwarehouseV1RemoveFromFolderAction? removeFromFolderAction;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'dataValidation': ?dataValidation == null ? null : dataValidation!.toMap(),
      'deleteDocumentAction': ?deleteDocumentAction == null ? null : deleteDocumentAction!.toMap(),
      'publishToPubSub': ?publishToPubSub == null ? null : publishToPubSub!.toMap(),
      'removeFromFolderAction': ?removeFromFolderAction == null ? null : removeFromFolderAction!.toMap(),
    };
  }

  factory GoogleCloudContentwarehouseV1Action.fromMap(Map<String, dynamic> map) {
    return GoogleCloudContentwarehouseV1Action(
      accessControl: map['accessControl'] == null ? null : GoogleCloudContentwarehouseV1AccessControlAction.fromMap((map['accessControl'] as Map).cast<String, dynamic>()),
      actionId: map['actionId'] == null ? null : map['actionId'] as String,
      addToFolder: map['addToFolder'] == null ? null : GoogleCloudContentwarehouseV1AddToFolderAction.fromMap((map['addToFolder'] as Map).cast<String, dynamic>()),
      dataUpdate: map['dataUpdate'] == null ? null : GoogleCloudContentwarehouseV1DataUpdateAction.fromMap((map['dataUpdate'] as Map).cast<String, dynamic>()),
      dataValidation: map['dataValidation'] == null ? null : GoogleCloudContentwarehouseV1DataValidationAction.fromMap((map['dataValidation'] as Map).cast<String, dynamic>()),
      deleteDocumentAction: map['deleteDocumentAction'] == null ? null : GoogleCloudContentwarehouseV1DeleteDocumentAction.fromMap((map['deleteDocumentAction'] as Map).cast<String, dynamic>()),
      publishToPubSub: map['publishToPubSub'] == null ? null : GoogleCloudContentwarehouseV1PublishAction.fromMap((map['publishToPubSub'] as Map).cast<String, dynamic>()),
      removeFromFolderAction: map['removeFromFolderAction'] == null ? null : GoogleCloudContentwarehouseV1RemoveFromFolderAction.fromMap((map['removeFromFolderAction'] as Map).cast<String, dynamic>()),
    );
  }
}
