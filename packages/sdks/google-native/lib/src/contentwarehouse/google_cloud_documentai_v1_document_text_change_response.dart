...
class GoogleCloudDocumentaiV1DocumentTextChangeResponse {
  ...
  final pulumi.Input<List<GoogleCloudDocumentaiV1DocumentProvenanceResponse>>
  provenance;
    ...
    return <String, dynamic>{
      ...
      'provenance':
          pulumi.Input.mapInputValue<
            List<GoogleCloudDocumentaiV1DocumentProvenanceResponse>,
  ...
  factory GoogleCloudDocumentaiV1DocumentTextChangeResponse.fromMap(
