...
class GoogleCloudDocumentaiV1DocumentTextChangeResponse {
  ...
  factory GoogleCloudDocumentaiV1DocumentTextChangeResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDocumentaiV1DocumentTextChangeResponse(
      changedText: (map['changedText'] as String).input(),
      provenance: (pulumi.Input.decodeList<GoogleCloudDocumentaiV1DocumentProvenanceResponse>(map['provenance'], (value) => GoogleCloudDocumentaiV1DocumentProvenanceResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
