...
class GoogleCloudDocumentaiV1BoundingPoly {
  ...
  final pulumi.Input<List<GoogleCloudDocumentaiV1NormalizedVertex>>?
  normalizedVertices;
    ...
    return <String, dynamic>{
      'normalizedVertices':
          ?pulumi.Input.mapOptionalInputValue<
            List<GoogleCloudDocumentaiV1NormalizedVertex>,
      ...
      'vertices':
          ?pulumi.Input.mapOptionalInputValue<
            List<GoogleCloudDocumentaiV1Vertex>,
            List<Map<String, dynamic>>
          >(
            vertices,
            (value) =>
  ...
  factory GoogleCloudDocumentaiV1BoundingPoly.fromMap(
    ...
    return GoogleCloudDocumentaiV1BoundingPoly(
      normalizedVertices: (() {
        final guardedValue = map['normalizedVertices'];
