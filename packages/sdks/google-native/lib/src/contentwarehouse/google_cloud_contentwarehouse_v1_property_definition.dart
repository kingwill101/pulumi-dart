...
class GoogleCloudContentwarehouseV1PropertyDefinition {
  ...
  final pulumi.Input<GoogleCloudContentwarehouseV1EnumTypeOptions>?
  enumTypeOptions;
  ...
  final pulumi.Input<GoogleCloudContentwarehouseV1PropertyTypeOptions>?
  propertyTypeOptions;
    ...
    return <String, dynamic>{
      ...
      'retrievalImportance':
          ?pulumi.Input.mapOptionalInputValue<
            GoogleCloudContentwarehouseV1PropertyDefinitionRetrievalImportance,
            String
          >(retrievalImportance, (value) => value.wireValue),
      'schemaSources':
          ?pulumi.Input.mapOptionalInputValue<
            List<GoogleCloudContentwarehouseV1PropertyDefinitionSchemaSource>,
  ...
  factory GoogleCloudContentwarehouseV1PropertyDefinition.fromMap(
    ...
    return GoogleCloudContentwarehouseV1PropertyDefinition(
      ...
      retrievalImportance: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GoogleCloudContentwarehouseV1PropertyDefinitionRetrievalImportance.fromValue(
      ...
      schemaSources: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                GoogleCloudContentwarehouseV1PropertyDefinitionSchemaSource.fromMap(
