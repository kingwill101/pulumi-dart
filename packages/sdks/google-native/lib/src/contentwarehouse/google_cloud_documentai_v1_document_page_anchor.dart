...
class GoogleCloudDocumentaiV1DocumentPageAnchor {
  ...
  final pulumi.Input<List<GoogleCloudDocumentaiV1DocumentPageAnchorPageRef>>?
  pageRefs;
    ...
    return <String, dynamic>{
      'pageRefs':
          ?pulumi.Input.mapOptionalInputValue<
            List<GoogleCloudDocumentaiV1DocumentPageAnchorPageRef>,
  ...
  factory GoogleCloudDocumentaiV1DocumentPageAnchor.fromMap(
    ...
    return GoogleCloudDocumentaiV1DocumentPageAnchor(
      pageRefs: (() {
        final guardedValue = map['pageRefs'];
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => GoogleCloudDocumentaiV1DocumentPageAnchorPageRef.fromMap(
