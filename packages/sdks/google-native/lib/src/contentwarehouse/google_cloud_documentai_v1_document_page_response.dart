...
class GoogleCloudDocumentaiV1DocumentPageResponse {
  ...
  final List<GoogleCloudDocumentaiV1DocumentPageDetectedBarcodeResponse> detectedBarcodes;
  ...
  final GoogleCloudDocumentaiV1DocumentPageImageQualityScoresResponse imageQualityScores;
  /// Layout for the page.
  ...
  final List<GoogleCloudDocumentaiV1DocumentPageVisualElementResponse> visualElements;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'blocks': pulumi.Input.encodeList<GoogleCloudDocumentaiV1DocumentPageBlockResponse, Map<String, dynamic>>(blocks, (value) => value.toMap()),
      'detectedBarcodes': pulumi.Input.encodeList<GoogleCloudDocumentaiV1DocumentPageDetectedBarcodeResponse, Map<String, dynamic>>(detectedBarcodes, (value) => value.toMap()),
      ...
      'formFields': pulumi.Input.encodeList<GoogleCloudDocumentaiV1DocumentPageFormFieldResponse, Map<String, dynamic>>(formFields, (value) => value.toMap()),
      'image': image.toMap(),
      'imageQualityScores': imageQualityScores.toMap(),
      'layout': layout.toMap(),
      'lines': pulumi.Input.encodeList<GoogleCloudDocumentaiV1DocumentPageLineResponse, Map<String, dynamic>>(lines, (value) => value.toMap()),
      'pageNumber': pageNumber,
      'paragraphs': pulumi.Input.encodeList<GoogleCloudDocumentaiV1DocumentPageParagraphResponse, Map<String, dynamic>>(paragraphs, (value) => value.toMap()),
      'provenance': provenance.toMap(),
      'symbols': pulumi.Input.encodeList<GoogleCloudDocumentaiV1DocumentPageSymbolResponse, Map<String, dynamic>>(symbols, (value) => value.toMap()),
      'tables': pulumi.Input.encodeList<GoogleCloudDocumentaiV1DocumentPageTableResponse, Map<String, dynamic>>(tables, (value) => value.toMap()),
      'tokens': pulumi.Input.encodeList<GoogleCloudDocumentaiV1DocumentPageTokenResponse, Map<String, dynamic>>(tokens, (value) => value.toMap()),
      'transforms': pulumi.Input.encodeList<GoogleCloudDocumentaiV1DocumentPageMatrixResponse, Map<String, dynamic>>(transforms, (value) => value.toMap()),
      'visualElements': pulumi.Input.encodeList<GoogleCloudDocumentaiV1DocumentPageVisualElementResponse, Map<String, dynamic>>(visualElements, (value) => value.toMap()),
    };
  }
  ...
  factory GoogleCloudDocumentaiV1DocumentPageResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDocumentaiV1DocumentPageResponse(
      blocks: pulumi.Input.decodeList<GoogleCloudDocumentaiV1DocumentPageBlockResponse>(map['blocks'], (value) => GoogleCloudDocumentaiV1DocumentPageBlockResponse.fromMap((value as Map).cast<String, dynamic>())),
      detectedBarcodes: pulumi.Input.decodeList<GoogleCloudDocumentaiV1DocumentPageDetectedBarcodeResponse>(map['detectedBarcodes'], (value) => GoogleCloudDocumentaiV1DocumentPageDetectedBarcodeResponse.fromMap((value as Map).cast<String, dynamic>())),
      ...
      dimension: GoogleCloudDocumentaiV1DocumentPageDimensionResponse.fromMap((map['dimension'] as Map).cast<String, dynamic>()),
      formFields: pulumi.Input.decodeList<GoogleCloudDocumentaiV1DocumentPageFormFieldResponse>(map['formFields'], (value) => GoogleCloudDocumentaiV1DocumentPageFormFieldResponse.fromMap((value as Map).cast<String, dynamic>())),
      image: GoogleCloudDocumentaiV1DocumentPageImageResponse.fromMap((map['image'] as Map).cast<String, dynamic>()),
      imageQualityScores: GoogleCloudDocumentaiV1DocumentPageImageQualityScoresResponse.fromMap((map['imageQualityScores'] as Map).cast<String, dynamic>()),
      layout: GoogleCloudDocumentaiV1DocumentPageLayoutResponse.fromMap((map['layout'] as Map).cast<String, dynamic>()),
      lines: pulumi.Input.decodeList<GoogleCloudDocumentaiV1DocumentPageLineResponse>(map['lines'], (value) => GoogleCloudDocumentaiV1DocumentPageLineResponse.fromMap((value as Map).cast<String, dynamic>())),
      pageNumber: map['pageNumber'] as int,
      paragraphs: pulumi.Input.decodeList<GoogleCloudDocumentaiV1DocumentPageParagraphResponse>(map['paragraphs'], (value) => GoogleCloudDocumentaiV1DocumentPageParagraphResponse.fromMap((value as Map).cast<String, dynamic>())),
      provenance: GoogleCloudDocumentaiV1DocumentProvenanceResponse.fromMap((map['provenance'] as Map).cast<String, dynamic>()),
      symbols: pulumi.Input.decodeList<GoogleCloudDocumentaiV1DocumentPageSymbolResponse>(map['symbols'], (value) => GoogleCloudDocumentaiV1DocumentPageSymbolResponse.fromMap((value as Map).cast<String, dynamic>())),
      tables: pulumi.Input.decodeList<GoogleCloudDocumentaiV1DocumentPageTableResponse>(map['tables'], (value) => GoogleCloudDocumentaiV1DocumentPageTableResponse.fromMap((value as Map).cast<String, dynamic>())),
      tokens: pulumi.Input.decodeList<GoogleCloudDocumentaiV1DocumentPageTokenResponse>(map['tokens'], (value) => GoogleCloudDocumentaiV1DocumentPageTokenResponse.fromMap((value as Map).cast<String, dynamic>())),
      transforms: pulumi.Input.decodeList<GoogleCloudDocumentaiV1DocumentPageMatrixResponse>(map['transforms'], (value) => GoogleCloudDocumentaiV1DocumentPageMatrixResponse.fromMap((value as Map).cast<String, dynamic>())),
      visualElements: pulumi.Input.decodeList<GoogleCloudDocumentaiV1DocumentPageVisualElementResponse>(map['visualElements'], (value) => GoogleCloudDocumentaiV1DocumentPageVisualElementResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
