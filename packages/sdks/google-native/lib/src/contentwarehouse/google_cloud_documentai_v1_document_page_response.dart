...
class GoogleCloudDocumentaiV1DocumentPageResponse {
  ...
  factory GoogleCloudDocumentaiV1DocumentPageResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDocumentaiV1DocumentPageResponse(
      blocks: (pulumi.Input.decodeList<GoogleCloudDocumentaiV1DocumentPageBlockResponse>(map['blocks'], (value) => GoogleCloudDocumentaiV1DocumentPageBlockResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      detectedBarcodes: (pulumi.Input.decodeList<GoogleCloudDocumentaiV1DocumentPageDetectedBarcodeResponse>(map['detectedBarcodes'], (value) => GoogleCloudDocumentaiV1DocumentPageDetectedBarcodeResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      dimension: (GoogleCloudDocumentaiV1DocumentPageDimensionResponse.fromMap((map['dimension'] as Map).cast<String, dynamic>())).input(),
      formFields: (pulumi.Input.decodeList<GoogleCloudDocumentaiV1DocumentPageFormFieldResponse>(map['formFields'], (value) => GoogleCloudDocumentaiV1DocumentPageFormFieldResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      image: (GoogleCloudDocumentaiV1DocumentPageImageResponse.fromMap((map['image'] as Map).cast<String, dynamic>())).input(),
      imageQualityScores: (GoogleCloudDocumentaiV1DocumentPageImageQualityScoresResponse.fromMap((map['imageQualityScores'] as Map).cast<String, dynamic>())).input(),
      layout: (GoogleCloudDocumentaiV1DocumentPageLayoutResponse.fromMap((map['layout'] as Map).cast<String, dynamic>())).input(),
      lines: (pulumi.Input.decodeList<GoogleCloudDocumentaiV1DocumentPageLineResponse>(map['lines'], (value) => GoogleCloudDocumentaiV1DocumentPageLineResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      pageNumber: (map['pageNumber'] as int).input(),
      paragraphs: (pulumi.Input.decodeList<GoogleCloudDocumentaiV1DocumentPageParagraphResponse>(map['paragraphs'], (value) => GoogleCloudDocumentaiV1DocumentPageParagraphResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      provenance: (GoogleCloudDocumentaiV1DocumentProvenanceResponse.fromMap((map['provenance'] as Map).cast<String, dynamic>())).input(),
      symbols: (pulumi.Input.decodeList<GoogleCloudDocumentaiV1DocumentPageSymbolResponse>(map['symbols'], (value) => GoogleCloudDocumentaiV1DocumentPageSymbolResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      tables: (pulumi.Input.decodeList<GoogleCloudDocumentaiV1DocumentPageTableResponse>(map['tables'], (value) => GoogleCloudDocumentaiV1DocumentPageTableResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      tokens: (pulumi.Input.decodeList<GoogleCloudDocumentaiV1DocumentPageTokenResponse>(map['tokens'], (value) => GoogleCloudDocumentaiV1DocumentPageTokenResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      transforms: (pulumi.Input.decodeList<GoogleCloudDocumentaiV1DocumentPageMatrixResponse>(map['transforms'], (value) => GoogleCloudDocumentaiV1DocumentPageMatrixResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      visualElements: (pulumi.Input.decodeList<GoogleCloudDocumentaiV1DocumentPageVisualElementResponse>(map['visualElements'], (value) => GoogleCloudDocumentaiV1DocumentPageVisualElementResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
