...
class GoogleCloudDocumentaiV1DocumentPageResponse {
  ...
  final pulumi.Input<List<GoogleCloudDocumentaiV1DocumentPageBlockResponse>>
  blocks;

  /// A list of detected barcodes.
  final pulumi.Input<
    List<GoogleCloudDocumentaiV1DocumentPageDetectedBarcodeResponse>
  >
  detectedBarcodes;
  ...
  final pulumi.Input<GoogleCloudDocumentaiV1DocumentPageDimensionResponse>
  dimension;

  /// A list of visually detected form fields on the page.
  final pulumi.Input<List<GoogleCloudDocumentaiV1DocumentPageFormFieldResponse>>
  formFields;
  ...
  final pulumi.Input<List<GoogleCloudDocumentaiV1DocumentPageLineResponse>>
  lines;
  ...
  final pulumi.Input<List<GoogleCloudDocumentaiV1DocumentPageParagraphResponse>>
  paragraphs;
  ...
  final pulumi.Input<List<GoogleCloudDocumentaiV1DocumentPageSymbolResponse>>
  symbols;

  /// A list of visually detected tables on the page.
  final pulumi.Input<List<GoogleCloudDocumentaiV1DocumentPageTableResponse>>
  tables;

  /// A list of visually detected tokens on the page.
  final pulumi.Input<List<GoogleCloudDocumentaiV1DocumentPageTokenResponse>>
  tokens;

  /// Transformation matrices that were applied to the original document image to produce Page.image.
  final pulumi.Input<List<GoogleCloudDocumentaiV1DocumentPageMatrixResponse>>
  transforms;

  /// A list of detected non-text visual elements e.g. checkbox, signature etc. on the page.
  final pulumi.Input<
    List<GoogleCloudDocumentaiV1DocumentPageVisualElementResponse>
  >
  visualElements;
    ...
    return <String, dynamic>{
      'blocks':
          pulumi.Input.mapInputValue<
            List<GoogleCloudDocumentaiV1DocumentPageBlockResponse>,
      ...
      'formFields':
          pulumi.Input.mapInputValue<
            List<GoogleCloudDocumentaiV1DocumentPageFormFieldResponse>,
            List<Map<String, dynamic>>
          >(
            formFields,
            (value) =>
      ...
      'lines':
          pulumi.Input.mapInputValue<
            List<GoogleCloudDocumentaiV1DocumentPageLineResponse>,
            List<Map<String, dynamic>>
          >(
            lines,
            (value) =>
      ...
      'paragraphs':
          pulumi.Input.mapInputValue<
            List<GoogleCloudDocumentaiV1DocumentPageParagraphResponse>,
            List<Map<String, dynamic>>
          >(
            paragraphs,
            (value) =>
      ...
      'symbols':
          pulumi.Input.mapInputValue<
            List<GoogleCloudDocumentaiV1DocumentPageSymbolResponse>,
            List<Map<String, dynamic>>
          >(
            symbols,
            (value) =>
      ...
      'tables':
          pulumi.Input.mapInputValue<
            List<GoogleCloudDocumentaiV1DocumentPageTableResponse>,
            List<Map<String, dynamic>>
          >(
            tables,
            (value) =>
      ...
      'tokens':
          pulumi.Input.mapInputValue<
            List<GoogleCloudDocumentaiV1DocumentPageTokenResponse>,
            List<Map<String, dynamic>>
          >(
            tokens,
            (value) =>
      ...
      'transforms':
          pulumi.Input.mapInputValue<
            List<GoogleCloudDocumentaiV1DocumentPageMatrixResponse>,
            List<Map<String, dynamic>>
          >(
            transforms,
            (value) =>
  ...
  factory GoogleCloudDocumentaiV1DocumentPageResponse.fromMap(
    ...
    return GoogleCloudDocumentaiV1DocumentPageResponse(
      blocks: pulumi.Input.fromValue(
        pulumi
            .Input.decodeList<GoogleCloudDocumentaiV1DocumentPageBlockResponse>(
          map['blocks']!,
      ...
      detectedBarcodes: pulumi.Input.fromValue(
      ...
      dimension: pulumi.Input.fromValue(
        GoogleCloudDocumentaiV1DocumentPageDimensionResponse.fromMap(
          (map['dimension']! as Map).cast<String, dynamic>(),
        ),
      ),
      formFields: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GoogleCloudDocumentaiV1DocumentPageFormFieldResponse
        >(
          map['formFields']!,
      ...
      image: pulumi.Input.fromValue(
        GoogleCloudDocumentaiV1DocumentPageImageResponse.fromMap(
          (map['image']! as Map).cast<String, dynamic>(),
        ),
      ),
      imageQualityScores: pulumi.Input.fromValue(
      ...
      lines: pulumi.Input.fromValue(
        pulumi
            .Input.decodeList<GoogleCloudDocumentaiV1DocumentPageLineResponse>(
          map['lines']!,
      ...
      paragraphs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GoogleCloudDocumentaiV1DocumentPageParagraphResponse
        >(
          map['paragraphs']!,
      ...
      symbols: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GoogleCloudDocumentaiV1DocumentPageSymbolResponse
        >(
          map['symbols']!,
          (value) => GoogleCloudDocumentaiV1DocumentPageSymbolResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      tables: pulumi.Input.fromValue(
        pulumi
            .Input.decodeList<GoogleCloudDocumentaiV1DocumentPageTableResponse>(
          map['tables']!,
      ...
      tokens: pulumi.Input.fromValue(
        pulumi
            .Input.decodeList<GoogleCloudDocumentaiV1DocumentPageTokenResponse>(
          map['tokens']!,
      ...
      transforms: pulumi.Input.fromValue(
        ...
        >(
          map['transforms']!,
          (value) => GoogleCloudDocumentaiV1DocumentPageMatrixResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      visualElements: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GoogleCloudDocumentaiV1DocumentPageVisualElementResponse
        >(
          map['visualElements']!,
