...
class GoogleCloudDocumentaiV1DocumentPageFormFieldResponse {
  ...
  factory GoogleCloudDocumentaiV1DocumentPageFormFieldResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDocumentaiV1DocumentPageFormFieldResponse(
      correctedKeyText: (map['correctedKeyText'] as String).input(),
      correctedValueText: (map['correctedValueText'] as String).input(),
      fieldName: (GoogleCloudDocumentaiV1DocumentPageLayoutResponse.fromMap((map['fieldName'] as Map).cast<String, dynamic>())).input(),
      fieldValue: (GoogleCloudDocumentaiV1DocumentPageLayoutResponse.fromMap((map['fieldValue'] as Map).cast<String, dynamic>())).input(),
      nameDetectedLanguages: (pulumi.Input.decodeList<GoogleCloudDocumentaiV1DocumentPageDetectedLanguageResponse>(map['nameDetectedLanguages'], (value) => GoogleCloudDocumentaiV1DocumentPageDetectedLanguageResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      provenance: (GoogleCloudDocumentaiV1DocumentProvenanceResponse.fromMap((map['provenance'] as Map).cast<String, dynamic>())).input(),
      valueDetectedLanguages: (pulumi.Input.decodeList<GoogleCloudDocumentaiV1DocumentPageDetectedLanguageResponse>(map['valueDetectedLanguages'], (value) => GoogleCloudDocumentaiV1DocumentPageDetectedLanguageResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
