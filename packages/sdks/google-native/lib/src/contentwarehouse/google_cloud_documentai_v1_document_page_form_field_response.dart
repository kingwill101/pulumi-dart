...
class GoogleCloudDocumentaiV1DocumentPageFormFieldResponse {
  ...
  final pulumi.Input<GoogleCloudDocumentaiV1DocumentPageLayoutResponse>
  fieldName;
    ...
    return <String, dynamic>{
      ...
      'fieldName':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(fieldName, (value) => value.toMap()),
      'fieldValue':
          pulumi.Input.mapInputValue<
            GoogleCloudDocumentaiV1DocumentPageLayoutResponse,
            Map<String, dynamic>
          >(fieldValue, (value) => value.toMap()),
      'nameDetectedLanguages':
          pulumi.Input.mapInputValue<
            List<GoogleCloudDocumentaiV1DocumentPageDetectedLanguageResponse>,
  ...
  factory GoogleCloudDocumentaiV1DocumentPageFormFieldResponse.fromMap(
    ...
    return GoogleCloudDocumentaiV1DocumentPageFormFieldResponse(
      ...
      valueDetectedLanguages: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GoogleCloudDocumentaiV1DocumentPageDetectedLanguageResponse
        >(
