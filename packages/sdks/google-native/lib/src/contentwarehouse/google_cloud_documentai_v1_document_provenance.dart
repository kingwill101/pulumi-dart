...
class GoogleCloudDocumentaiV1DocumentProvenance {
  ...
  final pulumi.Input<List<GoogleCloudDocumentaiV1DocumentProvenanceParent>>?
  parents;
    ...
    return <String, dynamic>{
      ...
      'parents':
          ?pulumi.Input.mapOptionalInputValue<
            List<GoogleCloudDocumentaiV1DocumentProvenanceParent>,
  ...
  factory GoogleCloudDocumentaiV1DocumentProvenance.fromMap(
    ...
    return GoogleCloudDocumentaiV1DocumentProvenance(
      ...
      parents: (() {
        final guardedValue = map['parents'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => GoogleCloudDocumentaiV1DocumentProvenanceParent.fromMap(
