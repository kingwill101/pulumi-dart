...
class GoogleCloudDocumentaiV1DocumentTextAnchorResponse {
  ...
  factory GoogleCloudDocumentaiV1DocumentTextAnchorResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDocumentaiV1DocumentTextAnchorResponse(
      ...
      textSegments: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudDocumentaiV1DocumentTextAnchorTextSegmentResponse>(map['textSegments']!, (value) => GoogleCloudDocumentaiV1DocumentTextAnchorTextSegmentResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
