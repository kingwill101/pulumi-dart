...
class GoogleCloudDocumentaiV1DocumentPageTableResponse {
  ...
  const GoogleCloudDocumentaiV1DocumentPageTableResponse({
  ...
  factory GoogleCloudDocumentaiV1DocumentPageTableResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDocumentaiV1DocumentPageTableResponse(
      bodyRows: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudDocumentaiV1DocumentPageTableTableRowResponse>(map['bodyRows']!, (value) => GoogleCloudDocumentaiV1DocumentPageTableTableRowResponse.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      headerRows: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudDocumentaiV1DocumentPageTableTableRowResponse>(map['headerRows']!, (value) => GoogleCloudDocumentaiV1DocumentPageTableTableRowResponse.fromMap((value as Map).cast<String, dynamic>()))),
