...
class GoogleCloudDocumentaiV1DocumentPageDetectedBarcode {
  ...
  const GoogleCloudDocumentaiV1DocumentPageDetectedBarcode({
    this.barcode,
    this.layout,
  });
  ...
  factory GoogleCloudDocumentaiV1DocumentPageDetectedBarcode.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDocumentaiV1DocumentPageDetectedBarcode(
      barcode: (() { final guardedValue = map['barcode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDocumentaiV1Barcode.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
