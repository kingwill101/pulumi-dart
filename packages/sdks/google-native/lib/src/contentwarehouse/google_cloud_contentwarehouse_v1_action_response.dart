...
class GoogleCloudContentwarehouseV1ActionResponse {
  ...
  factory GoogleCloudContentwarehouseV1ActionResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudContentwarehouseV1ActionResponse(
      accessControl: pulumi.Input.fromValue(GoogleCloudContentwarehouseV1AccessControlActionResponse.fromMap((map['accessControl']! as Map).cast<String, dynamic>())),
      actionId: pulumi.Input.fromValue(map['actionId'] as String),
      addToFolder: pulumi.Input.fromValue(GoogleCloudContentwarehouseV1AddToFolderActionResponse.fromMap((map['addToFolder']! as Map).cast<String, dynamic>())),
      dataUpdate: pulumi.Input.fromValue(GoogleCloudContentwarehouseV1DataUpdateActionResponse.fromMap((map['dataUpdate']! as Map).cast<String, dynamic>())),
      dataValidation: pulumi.Input.fromValue(GoogleCloudContentwarehouseV1DataValidationActionResponse.fromMap((map['dataValidation']! as Map).cast<String, dynamic>())),
      deleteDocumentAction: pulumi.Input.fromValue(GoogleCloudContentwarehouseV1DeleteDocumentActionResponse.fromMap((map['deleteDocumentAction']! as Map).cast<String, dynamic>())),
      publishToPubSub: pulumi.Input.fromValue(GoogleCloudContentwarehouseV1PublishActionResponse.fromMap((map['publishToPubSub']! as Map).cast<String, dynamic>())),
      removeFromFolderAction: pulumi.Input.fromValue(GoogleCloudContentwarehouseV1RemoveFromFolderActionResponse.fromMap((map['removeFromFolderAction']! as Map).cast<String, dynamic>())),
    );
  }
}
