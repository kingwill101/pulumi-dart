...
class GoogleCloudDocumentaiV1BarcodeResponse {
  ...
  final pulumi.Input<String> rawValue;
  ...
  const GoogleCloudDocumentaiV1BarcodeResponse({
  ...
  factory GoogleCloudDocumentaiV1BarcodeResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDocumentaiV1BarcodeResponse(
      format: pulumi.Input.fromValue(map['format'] as String),
      rawValue: pulumi.Input.fromValue(map['rawValue'] as String),
      valueFormat: pulumi.Input.fromValue(map['valueFormat'] as String),
    );
  }
}
