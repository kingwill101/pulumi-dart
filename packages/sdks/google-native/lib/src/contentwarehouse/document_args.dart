...
class DocumentArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'contentCategory': ?pulumi.Input.mapOptionalInputValue<DocumentContentCategory, String>(contentCategory, (value) => value.wireValue),
      ...
      'rawDocumentFileType': ?pulumi.Input.mapOptionalInputValue<DocumentRawDocumentFileType, String>(rawDocumentFileType, (value) => value.wireValue),
  ...
  factory DocumentArgs.fromMap(Map<String, dynamic> map) {
    return DocumentArgs(
      cloudAiDocument: (() { final guardedValue = map['cloudAiDocument']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDocumentaiV1Document.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      cloudAiDocumentOption: (() { final guardedValue = map['cloudAiDocumentOption']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudContentwarehouseV1CloudAIDocumentOption.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      contentCategory: (() { final guardedValue = map['contentCategory']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DocumentContentCategory.fromValue(guardedValue as String)); })(),
      createMask: (() { final guardedValue = map['createMask']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      displayUri: (() { final guardedValue = map['displayUri']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      documentSchemaName: (() { final guardedValue = map['documentSchemaName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      inlineRawDocument: (() { final guardedValue = map['inlineRawDocument']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      rawDocumentFileType: (() { final guardedValue = map['rawDocumentFileType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DocumentRawDocumentFileType.fromValue(guardedValue as String)); })(),
      rawDocumentPath: (() { final guardedValue = map['rawDocumentPath']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      requestMetadata: (() { final guardedValue = map['requestMetadata']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudContentwarehouseV1RequestMetadata.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      textExtractionDisabled: (() { final guardedValue = map['textExtractionDisabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      textExtractionEnabled: (() { final guardedValue = map['textExtractionEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      title: (() { final guardedValue = map['title']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      updater: (() { final guardedValue = map['updater']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
