...
class GoogleCloudContentwarehouseV1TimestampArrayResponse {
  ...
  factory GoogleCloudContentwarehouseV1TimestampArrayResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudContentwarehouseV1TimestampArrayResponse(
      values: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudContentwarehouseV1TimestampValueResponse>(map['values']!, (value) => GoogleCloudContentwarehouseV1TimestampValueResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
