...
class GoogleCloudContentwarehouseV1TimestampArrayResponse {
  ...
  final pulumi.Input<List<GoogleCloudContentwarehouseV1TimestampValueResponse>>
  values;

  /// Creates a new [GoogleCloudContentwarehouseV1TimestampArrayResponse].
  /// [values] List of timestamp values.
  GoogleCloudContentwarehouseV1TimestampArrayResponse({required this.values});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'values':
          pulumi.Input.mapInputValue<
            List<GoogleCloudContentwarehouseV1TimestampValueResponse>,
