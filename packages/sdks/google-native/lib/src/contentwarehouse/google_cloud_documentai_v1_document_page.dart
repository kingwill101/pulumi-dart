...
class GoogleCloudDocumentaiV1DocumentPage {
  ...
  final pulumi.Input<List<GoogleCloudDocumentaiV1DocumentPageDetectedBarcode>>?
  detectedBarcodes;
  ...
  final pulumi.Input<List<GoogleCloudDocumentaiV1DocumentPageFormField>>?
  formFields;
  ...
  final pulumi.Input<GoogleCloudDocumentaiV1DocumentPageImageQualityScores>?
  imageQualityScores;
  ...
  final pulumi.Input<List<GoogleCloudDocumentaiV1DocumentPageParagraph>>?
  paragraphs;
  ...
  final pulumi.Input<List<GoogleCloudDocumentaiV1DocumentPageMatrix>>?
  transforms;

  /// A list of detected non-text visual elements e.g. checkbox, signature etc. on the page.
  final pulumi.Input<List<GoogleCloudDocumentaiV1DocumentPageVisualElement>>?
  visualElements;
    ...
    return <String, dynamic>{
      'blocks':
          ?pulumi.Input.mapOptionalInputValue<
            List<GoogleCloudDocumentaiV1DocumentPageBlock>,
      ...
      'formFields':
          ?pulumi.Input.mapOptionalInputValue<
            List<GoogleCloudDocumentaiV1DocumentPageFormField>,
            List<Map<String, dynamic>>
          >(
            formFields,
            (value) =>
      ...
      'imageQualityScores':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(imageQualityScores, (value) => value.toMap()),
      'layout':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'lines':
          ?pulumi.Input.mapOptionalInputValue<
            List<GoogleCloudDocumentaiV1DocumentPageLine>,
            List<Map<String, dynamic>>
          >(
            lines,
            (value) =>
      ...
      'paragraphs':
          ?pulumi.Input.mapOptionalInputValue<
            List<GoogleCloudDocumentaiV1DocumentPageParagraph>,
            List<Map<String, dynamic>>
          >(
            paragraphs,
            (value) =>
      ...
      'symbols':
          ?pulumi.Input.mapOptionalInputValue<
            List<GoogleCloudDocumentaiV1DocumentPageSymbol>,
            List<Map<String, dynamic>>
          >(
            symbols,
            (value) =>
      ...
      'tables':
          ?pulumi.Input.mapOptionalInputValue<
            List<GoogleCloudDocumentaiV1DocumentPageTable>,
            List<Map<String, dynamic>>
          >(
            tables,
            (value) =>
      ...
      'tokens':
          ?pulumi.Input.mapOptionalInputValue<
            List<GoogleCloudDocumentaiV1DocumentPageToken>,
            List<Map<String, dynamic>>
          >(
            tokens,
            (value) =>
      ...
      'transforms':
          ?pulumi.Input.mapOptionalInputValue<
            List<GoogleCloudDocumentaiV1DocumentPageMatrix>,
            List<Map<String, dynamic>>
          >(
            transforms,
            (value) =>
      ...
      'visualElements':
          ?pulumi.Input.mapOptionalInputValue<
            List<GoogleCloudDocumentaiV1DocumentPageVisualElement>,
            List<Map<String, dynamic>>
          >(
            visualElements,
            (value) =>
  ...
  factory GoogleCloudDocumentaiV1DocumentPage.fromMap(
    ...
    return GoogleCloudDocumentaiV1DocumentPage(
      ...
      detectedBarcodes: (() {
        final guardedValue = map['detectedBarcodes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      formFields: (() {
        final guardedValue = map['formFields'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GoogleCloudDocumentaiV1DocumentPageFormField>(
            guardedValue,
      ...
      imageQualityScores: (() {
        final guardedValue = map['imageQualityScores'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      paragraphs: (() {
        final guardedValue = map['paragraphs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GoogleCloudDocumentaiV1DocumentPageParagraph>(
            guardedValue,
      ...
      symbols: (() {
        final guardedValue = map['symbols'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      visualElements: (() {
        final guardedValue = map['visualElements'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<
            GoogleCloudDocumentaiV1DocumentPageVisualElement
          >(
            guardedValue,
            (value) => GoogleCloudDocumentaiV1DocumentPageVisualElement.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
