...
class GoogleCloudDocumentaiV1DocumentResponse {
  ...
  final pulumi.Input<List<GoogleCloudDocumentaiV1DocumentEntityResponse>>
  entities;

  /// Placeholder. Relationship among Document.entities.
  final pulumi.Input<
    List<GoogleCloudDocumentaiV1DocumentEntityRelationResponse>
  >
  entityRelations;
  ...
  final pulumi.Input<List<GoogleCloudDocumentaiV1DocumentRevisionResponse>>
  revisions;

  /// Information about the sharding if this document is sharded part of a larger document. If the document is not sharded, this message is not specified.
  final pulumi.Input<GoogleCloudDocumentaiV1DocumentShardInfoResponse>
  shardInfo;
  ...
  final pulumi.Input<List<GoogleCloudDocumentaiV1DocumentTextChangeResponse>>
  textChanges;

  /// Styles for the Document.text.
  final pulumi.Input<List<GoogleCloudDocumentaiV1DocumentStyleResponse>>
  textStyles;
    ...
    return <String, dynamic>{
      ...
      'entities':
          pulumi.Input.mapInputValue<
            List<GoogleCloudDocumentaiV1DocumentEntityResponse>,
      ...
      'pages':
          pulumi.Input.mapInputValue<
            List<GoogleCloudDocumentaiV1DocumentPageResponse>,
            List<Map<String, dynamic>>
          >(
            pages,
            (value) =>
      ...
      'revisions':
          pulumi.Input.mapInputValue<
            List<GoogleCloudDocumentaiV1DocumentRevisionResponse>,
            List<Map<String, dynamic>>
          >(
            revisions,
            (value) =>
      ...
      'shardInfo':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(shardInfo, (value) => value.toMap()),
      'text': text,
      'textChanges':
          pulumi.Input.mapInputValue<
            List<GoogleCloudDocumentaiV1DocumentTextChangeResponse>,
            List<Map<String, dynamic>>
          >(
            textChanges,
            (value) =>
  ...
  factory GoogleCloudDocumentaiV1DocumentResponse.fromMap(
    ...
    return GoogleCloudDocumentaiV1DocumentResponse(
      ...
      entities: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GoogleCloudDocumentaiV1DocumentEntityResponse>(
          map['entities']!,
      ...
      entityRelations: pulumi.Input.fromValue(
      ...
      shardInfo: pulumi.Input.fromValue(
        GoogleCloudDocumentaiV1DocumentShardInfoResponse.fromMap(
          (map['shardInfo']! as Map).cast<String, dynamic>(),
        ),
      ),
      text: pulumi.Input.fromValue(map['text'] as String),
      textChanges: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GoogleCloudDocumentaiV1DocumentTextChangeResponse
        >(
          map['textChanges']!,
      ...
      textStyles: pulumi.Input.fromValue(
