...
class GoogleCloudDocumentaiV1DocumentResponse {
  ...
  factory GoogleCloudDocumentaiV1DocumentResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDocumentaiV1DocumentResponse(
      ...
      entities: (pulumi.Input.decodeList<GoogleCloudDocumentaiV1DocumentEntityResponse>(map['entities'], (value) => GoogleCloudDocumentaiV1DocumentEntityResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      entityRelations: (pulumi.Input.decodeList<GoogleCloudDocumentaiV1DocumentEntityRelationResponse>(map['entityRelations'], (value) => GoogleCloudDocumentaiV1DocumentEntityRelationResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      error: (GoogleRpcStatusResponse.fromMap((map['error'] as Map).cast<String, dynamic>())).input(),
      mimeType: (map['mimeType'] as String).input(),
      pages: (pulumi.Input.decodeList<GoogleCloudDocumentaiV1DocumentPageResponse>(map['pages'], (value) => GoogleCloudDocumentaiV1DocumentPageResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      revisions: (pulumi.Input.decodeList<GoogleCloudDocumentaiV1DocumentRevisionResponse>(map['revisions'], (value) => GoogleCloudDocumentaiV1DocumentRevisionResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      shardInfo: (GoogleCloudDocumentaiV1DocumentShardInfoResponse.fromMap((map['shardInfo'] as Map).cast<String, dynamic>())).input(),
      text: (map['text'] as String).input(),
      textChanges: (pulumi.Input.decodeList<GoogleCloudDocumentaiV1DocumentTextChangeResponse>(map['textChanges'], (value) => GoogleCloudDocumentaiV1DocumentTextChangeResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      textStyles: (pulumi.Input.decodeList<GoogleCloudDocumentaiV1DocumentStyleResponse>(map['textStyles'], (value) => GoogleCloudDocumentaiV1DocumentStyleResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
