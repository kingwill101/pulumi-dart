...
class GoogleCloudDocumentaiV1DocumentPageFormField {
  ...
  factory GoogleCloudDocumentaiV1DocumentPageFormField.fromMap(
    ...
    return GoogleCloudDocumentaiV1DocumentPageFormField(
      correctedKeyText: (() {
        final guardedValue = map['correctedKeyText'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      correctedValueText: (() {
        final guardedValue = map['correctedValueText'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      fieldName: (() {
      ...
      nameDetectedLanguages: (() {
        final guardedValue = map['nameDetectedLanguages'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      valueDetectedLanguages: (() {
        final guardedValue = map['valueDetectedLanguages'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<
            GoogleCloudDocumentaiV1DocumentPageDetectedLanguage
