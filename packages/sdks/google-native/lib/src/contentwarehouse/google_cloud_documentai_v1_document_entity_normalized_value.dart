...
class GoogleCloudDocumentaiV1DocumentEntityNormalizedValue {
  ...
  factory GoogleCloudDocumentaiV1DocumentEntityNormalizedValue.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDocumentaiV1DocumentEntityNormalizedValue(
      addressValue: map['addressValue'] == null ? null : GoogleTypePostalAddress.fromMap((map['addressValue'] as Map).cast<String, dynamic>()),
      ...
      datetimeValue: map['datetimeValue'] == null ? null : GoogleTypeDateTime.fromMap((map['datetimeValue'] as Map).cast<String, dynamic>()),
      ...
      moneyValue: map['moneyValue'] == null ? null : GoogleTypeMoney.fromMap((map['moneyValue'] as Map).cast<String, dynamic>()),
