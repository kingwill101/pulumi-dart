...
class GoogleCloudDocumentaiV1DocumentEntityNormalizedValue {
  ...
  const GoogleCloudDocumentaiV1DocumentEntityNormalizedValue({
    this.addressValue,
    this.booleanValue,
    this.dateValue,
    this.datetimeValue,
  ...
  factory GoogleCloudDocumentaiV1DocumentEntityNormalizedValue.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDocumentaiV1DocumentEntityNormalizedValue(
      addressValue: (() { final guardedValue = map['addressValue']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleTypePostalAddress.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      datetimeValue: (() { final guardedValue = map['datetimeValue']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleTypeDateTime.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      moneyValue: (() { final guardedValue = map['moneyValue']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleTypeMoney.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
