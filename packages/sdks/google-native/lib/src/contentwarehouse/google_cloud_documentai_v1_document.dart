...
class GoogleCloudDocumentaiV1Document {
  ...
  final pulumi.Input<List<GoogleCloudDocumentaiV1DocumentEntityRelation>>?
  entityRelations;
  ...
  final pulumi.Input<List<GoogleCloudDocumentaiV1DocumentTextChange>>?
  textChanges;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'entityRelations':
          ?pulumi.Input.mapOptionalInputValue<
            List<GoogleCloudDocumentaiV1DocumentEntityRelation>,
            List<Map<String, dynamic>>
          >(
            entityRelations,
            (value) =>
      ...
      'pages':
          ?pulumi.Input.mapOptionalInputValue<
            List<GoogleCloudDocumentaiV1DocumentPage>,
            List<Map<String, dynamic>>
          >(
            pages,
            (value) =>
      ...
      'revisions':
          ?pulumi.Input.mapOptionalInputValue<
            List<GoogleCloudDocumentaiV1DocumentRevision>,
            List<Map<String, dynamic>>
          >(
            revisions,
            (value) =>
      ...
      'textChanges':
          ?pulumi.Input.mapOptionalInputValue<
            List<GoogleCloudDocumentaiV1DocumentTextChange>,
            List<Map<String, dynamic>>
          >(
            textChanges,
            (value) =>
  ...
  factory GoogleCloudDocumentaiV1Document.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDocumentaiV1Document(
      ...
      entityRelations: (() {
        final guardedValue = map['entityRelations'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi
      ...
      shardInfo: (() {
        final guardedValue = map['shardInfo'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      textChanges: (() {
        final guardedValue = map['textChanges'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      textStyles: (() {
        final guardedValue = map['textStyles'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
