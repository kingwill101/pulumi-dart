...
class GoogleCloudDocumentaiV1DocumentEntityNormalizedValueResponse {
  ...
  factory GoogleCloudDocumentaiV1DocumentEntityNormalizedValueResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDocumentaiV1DocumentEntityNormalizedValueResponse(
      addressValue: (GoogleTypePostalAddressResponse.fromMap((map['addressValue'] as Map).cast<String, dynamic>())).input(),
      ...
      datetimeValue: (GoogleTypeDateTimeResponse.fromMap((map['datetimeValue'] as Map).cast<String, dynamic>())).input(),
      floatValue: (map['floatValue'] as double).input(),
      integerValue: (map['integerValue'] as int).input(),
      moneyValue: (GoogleTypeMoneyResponse.fromMap((map['moneyValue'] as Map).cast<String, dynamic>())).input(),
