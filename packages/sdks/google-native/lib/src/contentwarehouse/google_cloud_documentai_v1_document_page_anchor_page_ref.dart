...
class GoogleCloudDocumentaiV1DocumentPageAnchorPageRef {
  ...
  factory GoogleCloudDocumentaiV1DocumentPageAnchorPageRef.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDocumentaiV1DocumentPageAnchorPageRef(
      boundingPoly: map['boundingPoly'] == null ? null : GoogleCloudDocumentaiV1BoundingPoly.fromMap((map['boundingPoly'] as Map).cast<String, dynamic>()),
      confidence: map['confidence'] == null ? null : map['confidence'] as double,
      layoutId: map['layoutId'] == null ? null : map['layoutId'] as String,
      layoutType: map['layoutType'] == null ? null : GoogleCloudDocumentaiV1DocumentPageAnchorPageRefLayoutType.fromValue(map['layoutType'] as String),
