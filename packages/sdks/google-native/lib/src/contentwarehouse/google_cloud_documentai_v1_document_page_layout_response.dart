...
class GoogleCloudDocumentaiV1DocumentPageLayoutResponse {
  ...
  final pulumi.Input<GoogleCloudDocumentaiV1DocumentTextAnchorResponse>
  textAnchor;
  ...
  factory GoogleCloudDocumentaiV1DocumentPageLayoutResponse.fromMap(
    ...
    return GoogleCloudDocumentaiV1DocumentPageLayoutResponse(
      boundingPoly: pulumi.Input.fromValue(
        GoogleCloudDocumentaiV1BoundingPolyResponse.fromMap(
      ...
      textAnchor: pulumi.Input.fromValue(
        GoogleCloudDocumentaiV1DocumentTextAnchorResponse.fromMap(
