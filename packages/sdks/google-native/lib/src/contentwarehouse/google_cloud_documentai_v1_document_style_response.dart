...
class GoogleCloudDocumentaiV1DocumentStyleResponse {
  ...
  /// Font size.
  final pulumi.Input<GoogleCloudDocumentaiV1DocumentStyleFontSizeResponse>
  fontSize;
  ...
  factory GoogleCloudDocumentaiV1DocumentStyleResponse.fromMap(
    ...
    return GoogleCloudDocumentaiV1DocumentStyleResponse(
      ...
      fontSize: pulumi.Input.fromValue(
        GoogleCloudDocumentaiV1DocumentStyleFontSizeResponse.fromMap(
