...
class GoogleCloudDocumentaiV1DocumentPageTokenResponse {
  ...
  const GoogleCloudDocumentaiV1DocumentPageTokenResponse({
  ...
  factory GoogleCloudDocumentaiV1DocumentPageTokenResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDocumentaiV1DocumentPageTokenResponse(
      detectedBreak: pulumi.Input.fromValue(GoogleCloudDocumentaiV1DocumentPageTokenDetectedBreakResponse.fromMap((map['detectedBreak']! as Map).cast<String, dynamic>())),
      ...
      styleInfo: pulumi.Input.fromValue(GoogleCloudDocumentaiV1DocumentPageTokenStyleInfoResponse.fromMap((map['styleInfo']! as Map).cast<String, dynamic>())),
    );
  }
}
