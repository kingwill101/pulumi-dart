...
class GoogleCloudContentwarehouseV1UpdateOptions {
  /// Options for merging.
  final pulumi.Input<GoogleCloudContentwarehouseV1MergeFieldsOptions>?
  mergeFieldsOptions;
  ...
  /// Type for update.
  final pulumi.Input<GoogleCloudContentwarehouseV1UpdateOptionsUpdateType>?
  updateType;
    ...
    return <String, dynamic>{
      'mergeFieldsOptions':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(mergeFieldsOptions, (value) => value.toMap()),
      'updateMask': ?updateMask,
      'updateType':
          ?pulumi.Input.mapOptionalInputValue<
            GoogleCloudContentwarehouseV1UpdateOptionsUpdateType,
            String
          >(updateType, (value) => value.wireValue),
    };
  }
  ...
  factory GoogleCloudContentwarehouseV1UpdateOptions.fromMap(
    ...
    return GoogleCloudContentwarehouseV1UpdateOptions(
      mergeFieldsOptions: (() {
        final guardedValue = map['mergeFieldsOptions'];
