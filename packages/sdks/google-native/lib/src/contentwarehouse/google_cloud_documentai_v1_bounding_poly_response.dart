...
class GoogleCloudDocumentaiV1BoundingPolyResponse {
  ...
  const GoogleCloudDocumentaiV1BoundingPolyResponse({
  ...
  factory GoogleCloudDocumentaiV1BoundingPolyResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDocumentaiV1BoundingPolyResponse(
      normalizedVertices: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudDocumentaiV1NormalizedVertexResponse>(map['normalizedVertices']!, (value) => GoogleCloudDocumentaiV1NormalizedVertexResponse.fromMap((value as Map).cast<String, dynamic>()))),
      vertices: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudDocumentaiV1VertexResponse>(map['vertices']!, (value) => GoogleCloudDocumentaiV1VertexResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
