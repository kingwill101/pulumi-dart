...
class GoogleCloudContentwarehouseV1PropertyResponse {
  ...
  final pulumi.Input<GoogleCloudContentwarehouseV1DateTimeArrayResponse>
  dateTimeValues;
  ...
  final pulumi.Input<GoogleCloudContentwarehouseV1FloatArrayResponse>
  floatValues;

  /// Integer property values.
  final pulumi.Input<GoogleCloudContentwarehouseV1IntegerArrayResponse>
  integerValues;

  /// Map property values.
  final pulumi.Input<GoogleCloudContentwarehouseV1MapPropertyResponse>
  mapProperty;
  ...
  final pulumi.Input<GoogleCloudContentwarehouseV1PropertyArrayResponse>
  propertyValues;
  ...
  final pulumi.Input<GoogleCloudContentwarehouseV1TimestampArrayResponse>
  timestampValues;
  ...
  factory GoogleCloudContentwarehouseV1PropertyResponse.fromMap(
    ...
    return GoogleCloudContentwarehouseV1PropertyResponse(
      dateTimeValues: pulumi.Input.fromValue(
        GoogleCloudContentwarehouseV1DateTimeArrayResponse.fromMap(
          (map['dateTimeValues']! as Map).cast<String, dynamic>(),
        ),
      ),
      enumValues: pulumi.Input.fromValue(
        GoogleCloudContentwarehouseV1EnumArrayResponse.fromMap(
          (map['enumValues']! as Map).cast<String, dynamic>(),
        ),
      ),
      floatValues: pulumi.Input.fromValue(
        GoogleCloudContentwarehouseV1FloatArrayResponse.fromMap(
          (map['floatValues']! as Map).cast<String, dynamic>(),
        ),
      ),
      integerValues: pulumi.Input.fromValue(
        GoogleCloudContentwarehouseV1IntegerArrayResponse.fromMap(
          (map['integerValues']! as Map).cast<String, dynamic>(),
        ),
      ),
      mapProperty: pulumi.Input.fromValue(
        GoogleCloudContentwarehouseV1MapPropertyResponse.fromMap(
      ...
      textValues: pulumi.Input.fromValue(
        GoogleCloudContentwarehouseV1TextArrayResponse.fromMap(
          (map['textValues']! as Map).cast<String, dynamic>(),
        ),
      ),
      timestampValues: pulumi.Input.fromValue(
