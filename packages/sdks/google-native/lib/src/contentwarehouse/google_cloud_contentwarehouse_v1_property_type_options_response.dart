...
class GoogleCloudContentwarehouseV1PropertyTypeOptionsResponse {
  ...
  factory GoogleCloudContentwarehouseV1PropertyTypeOptionsResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudContentwarehouseV1PropertyTypeOptionsResponse(
      propertyDefinitions: (pulumi.Input.decodeList<GoogleCloudContentwarehouseV1PropertyDefinitionResponse>(map['propertyDefinitions'], (value) => GoogleCloudContentwarehouseV1PropertyDefinitionResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
