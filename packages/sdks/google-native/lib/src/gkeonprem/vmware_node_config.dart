...
class VmwareNodeConfig {
  ...
  factory VmwareNodeConfig.fromMap(Map<String, dynamic> map) {
    return VmwareNodeConfig(
      ...
      memoryMb: (() { final guardedValue = map['memoryMb']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      vsphereConfig: (() { final guardedValue = map['vsphereConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VmwareVsphereConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
