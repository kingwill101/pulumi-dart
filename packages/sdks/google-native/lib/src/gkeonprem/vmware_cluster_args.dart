...
class VmwareClusterArgs {
  ...
  factory VmwareClusterArgs.fromMap(Map<String, dynamic> map) {
    return VmwareClusterArgs(
      ...
      antiAffinityGroups: map['antiAffinityGroups'] == null ? null : (VmwareAAGConfig.fromMap((map['antiAffinityGroups']! as Map).cast<String, dynamic>())).input(),
      authorization: map['authorization'] == null ? null : (Authorization.fromMap((map['authorization']! as Map).cast<String, dynamic>())).input(),
      autoRepairConfig: map['autoRepairConfig'] == null ? null : (VmwareAutoRepairConfig.fromMap((map['autoRepairConfig']! as Map).cast<String, dynamic>())).input(),
      controlPlaneNode: map['controlPlaneNode'] == null ? null : (VmwareControlPlaneNodeConfig.fromMap((map['controlPlaneNode']! as Map).cast<String, dynamic>())).input(),
      dataplaneV2: map['dataplaneV2'] == null ? null : (VmwareDataplaneV2Config.fromMap((map['dataplaneV2']! as Map).cast<String, dynamic>())).input(),
      ...
      loadBalancer: map['loadBalancer'] == null ? null : (VmwareLoadBalancerConfig.fromMap((map['loadBalancer']! as Map).cast<String, dynamic>())).input(),
      location: map['location'] == null ? null : (map['location']! as String).input(),
      name: map['name'] == null ? null : (map['name']! as String).input(),
      networkConfig: map['networkConfig'] == null ? null : (VmwareNetworkConfig.fromMap((map['networkConfig']! as Map).cast<String, dynamic>())).input(),
      onPremVersion: (map['onPremVersion'] as String).input(),
      project: map['project'] == null ? null : (map['project']! as String).input(),
      storage: map['storage'] == null ? null : (VmwareStorageConfig.fromMap((map['storage']! as Map).cast<String, dynamic>())).input(),
      ...
      vcenter: map['vcenter'] == null ? null : (VmwareVCenterConfig.fromMap((map['vcenter']! as Map).cast<String, dynamic>())).input(),
