...
class VmwareClusterArgs {
  ...
  VmwareClusterArgs({
    ...
    pulumi.Output<VmwareAAGConfig>? antiAffinityGroups,
    pulumi.Output<Authorization>? authorization,
    pulumi.Output<VmwareAutoRepairConfig>? autoRepairConfig,
    pulumi.Output<VmwareControlPlaneNodeConfig>? controlPlaneNode,
    pulumi.Output<VmwareDataplaneV2Config>? dataplaneV2,
    pulumi.Output<String>? description,
    pulumi.Output<bool>? disableBundledIngress,
    pulumi.Output<bool>? enableControlPlaneV2,
    pulumi.Output<String>? etag,
    pulumi.Output<VmwareLoadBalancerConfig>? loadBalancer,
    pulumi.Output<String>? location,
    pulumi.Output<String>? name,
    pulumi.Output<VmwareNetworkConfig>? networkConfig,
    required pulumi.Output<String> onPremVersion,
    pulumi.Output<String>? project,
    pulumi.Output<VmwareStorageConfig>? storage,
    pulumi.Output<VmwareClusterUpgradePolicy>? upgradePolicy,
    pulumi.Output<VmwareVCenterConfig>? vcenter,
    ...
    pulumi.Output<String>? vmwareClusterId,
      ...
      antiAffinityGroups = pulumi.Input.asOptionalInput<VmwareAAGConfig>(antiAffinityGroups),
      authorization = pulumi.Input.asOptionalInput<Authorization>(authorization),
      autoRepairConfig = pulumi.Input.asOptionalInput<VmwareAutoRepairConfig>(autoRepairConfig),
      controlPlaneNode = pulumi.Input.asOptionalInput<VmwareControlPlaneNodeConfig>(controlPlaneNode),
      dataplaneV2 = pulumi.Input.asOptionalInput<VmwareDataplaneV2Config>(dataplaneV2),
      ...
      loadBalancer = pulumi.Input.asOptionalInput<VmwareLoadBalancerConfig>(loadBalancer),
      location = pulumi.Input.asOptionalInput<String>(location),
      name = pulumi.Input.asOptionalInput<String>(name),
      networkConfig = pulumi.Input.asOptionalInput<VmwareNetworkConfig>(networkConfig),
  ...
  factory VmwareClusterArgs.fromMap(Map<String, dynamic> map) {
    return VmwareClusterArgs(
      ...
      antiAffinityGroups: map['antiAffinityGroups'] == null ? null : pulumi.Output.create<VmwareAAGConfig>(VmwareAAGConfig.fromMap((map['antiAffinityGroups'] as Map).cast<String, dynamic>())),
      authorization: map['authorization'] == null ? null : pulumi.Output.create<Authorization>(Authorization.fromMap((map['authorization'] as Map).cast<String, dynamic>())),
      autoRepairConfig: map['autoRepairConfig'] == null ? null : pulumi.Output.create<VmwareAutoRepairConfig>(VmwareAutoRepairConfig.fromMap((map['autoRepairConfig'] as Map).cast<String, dynamic>())),
      controlPlaneNode: map['controlPlaneNode'] == null ? null : pulumi.Output.create<VmwareControlPlaneNodeConfig>(VmwareControlPlaneNodeConfig.fromMap((map['controlPlaneNode'] as Map).cast<String, dynamic>())),
      dataplaneV2: map['dataplaneV2'] == null ? null : pulumi.Output.create<VmwareDataplaneV2Config>(VmwareDataplaneV2Config.fromMap((map['dataplaneV2'] as Map).cast<String, dynamic>())),
      ...
      loadBalancer: map['loadBalancer'] == null ? null : pulumi.Output.create<VmwareLoadBalancerConfig>(VmwareLoadBalancerConfig.fromMap((map['loadBalancer'] as Map).cast<String, dynamic>())),
      location: map['location'] == null ? null : pulumi.Output.create<String>(map['location'] as String),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      networkConfig: map['networkConfig'] == null ? null : pulumi.Output.create<VmwareNetworkConfig>(VmwareNetworkConfig.fromMap((map['networkConfig'] as Map).cast<String, dynamic>())),
      onPremVersion: pulumi.Output.create<String>(map['onPremVersion'] as String),
      project: map['project'] == null ? null : pulumi.Output.create<String>(map['project'] as String),
      storage: map['storage'] == null ? null : pulumi.Output.create<VmwareStorageConfig>(VmwareStorageConfig.fromMap((map['storage'] as Map).cast<String, dynamic>())),
      ...
      vcenter: map['vcenter'] == null ? null : pulumi.Output.create<VmwareVCenterConfig>(VmwareVCenterConfig.fromMap((map['vcenter'] as Map).cast<String, dynamic>())),
