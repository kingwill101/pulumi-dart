...
class BareMetalClusterArgs {
  ...
  factory BareMetalClusterArgs.fromMap(Map<String, dynamic> map) {
    return BareMetalClusterArgs(
      ...
      clusterOperations: map['clusterOperations'] == null ? null : (BareMetalClusterOperationsConfig.fromMap((map['clusterOperations']! as Map).cast<String, dynamic>())).input(),
      controlPlane: (BareMetalControlPlaneConfig.fromMap((map['controlPlane'] as Map).cast<String, dynamic>())).input(),
      description: map['description'] == null ? null : (map['description']! as String).input(),
      loadBalancer: (BareMetalLoadBalancerConfig.fromMap((map['loadBalancer'] as Map).cast<String, dynamic>())).input(),
      location: map['location'] == null ? null : (map['location']! as String).input(),
      maintenanceConfig: map['maintenanceConfig'] == null ? null : (BareMetalMaintenanceConfig.fromMap((map['maintenanceConfig']! as Map).cast<String, dynamic>())).input(),
      name: map['name'] == null ? null : (map['name']! as String).input(),
      networkConfig: (BareMetalNetworkConfig.fromMap((map['networkConfig'] as Map).cast<String, dynamic>())).input(),
      nodeAccessConfig: map['nodeAccessConfig'] == null ? null : (BareMetalNodeAccessConfig.fromMap((map['nodeAccessConfig']! as Map).cast<String, dynamic>())).input(),
      nodeConfig: map['nodeConfig'] == null ? null : (BareMetalWorkloadNodeConfig.fromMap((map['nodeConfig']! as Map).cast<String, dynamic>())).input(),
      osEnvironmentConfig: map['osEnvironmentConfig'] == null ? null : (BareMetalOsEnvironmentConfig.fromMap((map['osEnvironmentConfig']! as Map).cast<String, dynamic>())).input(),
      project: map['project'] == null ? null : (map['project']! as String).input(),
      proxy: map['proxy'] == null ? null : (BareMetalProxyConfig.fromMap((map['proxy']! as Map).cast<String, dynamic>())).input(),
      securityConfig: map['securityConfig'] == null ? null : (BareMetalSecurityConfig.fromMap((map['securityConfig']! as Map).cast<String, dynamic>())).input(),
      storage: (BareMetalStorageConfig.fromMap((map['storage'] as Map).cast<String, dynamic>())).input(),
