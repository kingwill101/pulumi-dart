...
class BareMetalClusterArgs {
  ...
  factory BareMetalClusterArgs.fromMap(Map<String, dynamic> map) {
    return BareMetalClusterArgs(
      ...
      bareMetalVersion: pulumi.Input.fromValue(
      ...
      controlPlane: pulumi.Input.fromValue(
        BareMetalControlPlaneConfig.fromMap(
      ...
      loadBalancer: pulumi.Input.fromValue(
        BareMetalLoadBalancerConfig.fromMap(
      ...
      networkConfig: pulumi.Input.fromValue(
        BareMetalNetworkConfig.fromMap(
      ...
      storage: pulumi.Input.fromValue(
        BareMetalStorageConfig.fromMap(
