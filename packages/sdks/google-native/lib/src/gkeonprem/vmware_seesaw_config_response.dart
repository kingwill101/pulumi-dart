...
class VmwareSeesawConfigResponse {
  ...
  factory VmwareSeesawConfigResponse.fromMap(Map<String, dynamic> map) {
    return VmwareSeesawConfigResponse(
      enableHa: (map['enableHa'] as bool).input(),
      ...
      masterIp: (map['masterIp'] as String).input(),
      stackdriverName: (map['stackdriverName'] as String).input(),
      vms: ((map['vms'] as List).cast<String>()).input(),
    );
  }
}
