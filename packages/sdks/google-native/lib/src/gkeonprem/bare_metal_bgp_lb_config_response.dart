...
class BareMetalBgpLbConfigResponse {
  ...
  factory BareMetalBgpLbConfigResponse.fromMap(Map<String, dynamic> map) {
    return BareMetalBgpLbConfigResponse(
      addressPools: (pulumi.Input.decodeList<BareMetalLoadBalancerAddressPoolResponse>(map['addressPools'], (value) => BareMetalLoadBalancerAddressPoolResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      asn: (map['asn'] as String).input(),
      bgpPeerConfigs: (pulumi.Input.decodeList<BareMetalBgpPeerConfigResponse>(map['bgpPeerConfigs'], (value) => BareMetalBgpPeerConfigResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      loadBalancerNodePoolConfig: (BareMetalLoadBalancerNodePoolConfigResponse.fromMap((map['loadBalancerNodePoolConfig'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
