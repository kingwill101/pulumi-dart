...
class BareMetalControlPlaneConfigResponse {
  ...
  factory BareMetalControlPlaneConfigResponse.fromMap(Map<String, dynamic> map) {
    return BareMetalControlPlaneConfigResponse(
      apiServerArgs: (pulumi.Input.decodeList<BareMetalApiServerArgumentResponse>(map['apiServerArgs'], (value) => BareMetalApiServerArgumentResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      controlPlaneNodePoolConfig: (BareMetalControlPlaneNodePoolConfigResponse.fromMap((map['controlPlaneNodePoolConfig'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
