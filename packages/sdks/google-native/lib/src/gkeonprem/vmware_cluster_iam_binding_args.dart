...
/// {@template pulumi_gkeonprem_v1_vmware_cluster_iam_binding_args_doc}
/// The set of arguments for VmwareClusterIamBinding.
/// {@endtemplate}
/// {@macro pulumi_gkeonprem_v1_vmware_cluster_iam_binding_args_doc}
class VmwareClusterIamBindingArgs {
  ...
  /// Creates a new [VmwareClusterIamBindingArgs].
  ...
  const VmwareClusterIamBindingArgs({
    this.condition,
  ...
  factory VmwareClusterIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return VmwareClusterIamBindingArgs(
