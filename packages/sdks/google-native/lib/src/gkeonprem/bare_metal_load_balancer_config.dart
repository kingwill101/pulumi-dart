...
class BareMetalLoadBalancerConfig {
  ...
  factory BareMetalLoadBalancerConfig.fromMap(Map<String, dynamic> map) {
    return BareMetalLoadBalancerConfig(
      bgpLbConfig: (() {
        final guardedValue = map['bgpLbConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          BareMetalBgpLbConfig.fromMap(
      ...
      manualLbConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          BareMetalManualLbConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      metalLbConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          BareMetalMetalLbConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      portConfig: (() {
        final guardedValue = map['portConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          BareMetalPortConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
