...
class GetBareMetalAdminClusterResult {
  ...
  factory GetBareMetalAdminClusterResult.fromMap(Map<String, dynamic> map) {
    return GetBareMetalAdminClusterResult(
      ...
      binaryAuthorization: BinaryAuthorizationResponse.fromMap((map['binaryAuthorization']! as Map).cast<String, dynamic>()),
      clusterOperations: BareMetalAdminClusterOperationsConfigResponse.fromMap((map['clusterOperations']! as Map).cast<String, dynamic>()),
      controlPlane: BareMetalAdminControlPlaneConfigResponse.fromMap((map['controlPlane']! as Map).cast<String, dynamic>()),
      createTime: map['createTime'] as String,
      deleteTime: map['deleteTime'] as String,
      description: map['description'] as String,
      endpoint: map['endpoint'] as String,
      etag: map['etag'] as String,
      fleet: FleetResponse.fromMap((map['fleet']! as Map).cast<String, dynamic>()),
      loadBalancer: BareMetalAdminLoadBalancerConfigResponse.fromMap((map['loadBalancer']! as Map).cast<String, dynamic>()),
      localName: map['localName'] as String,
      maintenanceConfig: BareMetalAdminMaintenanceConfigResponse.fromMap((map['maintenanceConfig']! as Map).cast<String, dynamic>()),
      maintenanceStatus: BareMetalAdminMaintenanceStatusResponse.fromMap((map['maintenanceStatus']! as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      networkConfig: BareMetalAdminNetworkConfigResponse.fromMap((map['networkConfig']! as Map).cast<String, dynamic>()),
      nodeAccessConfig: BareMetalAdminNodeAccessConfigResponse.fromMap((map['nodeAccessConfig']! as Map).cast<String, dynamic>()),
      nodeConfig: BareMetalAdminWorkloadNodeConfigResponse.fromMap((map['nodeConfig']! as Map).cast<String, dynamic>()),
      osEnvironmentConfig: BareMetalAdminOsEnvironmentConfigResponse.fromMap((map['osEnvironmentConfig']! as Map).cast<String, dynamic>()),
      proxy: BareMetalAdminProxyConfigResponse.fromMap((map['proxy']! as Map).cast<String, dynamic>()),
      reconciling: map['reconciling'] as bool,
      securityConfig: BareMetalAdminSecurityConfigResponse.fromMap((map['securityConfig']! as Map).cast<String, dynamic>()),
      state: map['state'] as String,
      status: ResourceStatusResponse.fromMap((map['status']! as Map).cast<String, dynamic>()),
      storage: BareMetalAdminStorageConfigResponse.fromMap((map['storage']! as Map).cast<String, dynamic>()),
      uid: map['uid'] as String,
      updateTime: map['updateTime'] as String,
      validationCheck: ValidationCheckResponse.fromMap((map['validationCheck']! as Map).cast<String, dynamic>()),
    );
  }
}
