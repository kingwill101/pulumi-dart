...
class VmwareCluster extends pulumi.CustomResource {
  ...
  VmwareCluster(
    ...
    this.antiAffinityGroups = registerOutput<VmwareAAGConfigResponse>('antiAffinityGroups');
    this.authorization = registerOutput<AuthorizationResponse>('authorization');
    this.autoRepairConfig = registerOutput<VmwareAutoRepairConfigResponse>('autoRepairConfig');
    this.controlPlaneNode = registerOutput<VmwareControlPlaneNodeConfigResponse>('controlPlaneNode');
    this.createTime = registerOutput<String>('createTime');
    this.dataplaneV2 = registerOutput<VmwareDataplaneV2ConfigResponse>('dataplaneV2');
    ...
    this.loadBalancer = registerOutput<VmwareLoadBalancerConfigResponse>('loadBalancer');
    this.localName = registerOutput<String>('localName');
    this.location = registerOutput<String>('location');
    this.name = registerOutput<String>('name');
    this.networkConfig = registerOutput<VmwareNetworkConfigResponse>('networkConfig');
    ...
    this.upgradePolicy = registerOutput<VmwareClusterUpgradePolicyResponse>('upgradePolicy');
