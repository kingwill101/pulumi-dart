  ...
  VmwareCluster(
    ...
    antiAffinityGroups = registerOutput<VmwareAAGConfigResponse>(
      ...
      decoder: (raw) {
        ...
        return VmwareAAGConfigResponse.fromMap(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      },
    );
    authorization = registerOutput<AuthorizationResponse>(
      'authorization',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
    ...
    autoRepairConfig = registerOutput<VmwareAutoRepairConfigResponse>(
      ...
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return VmwareAutoRepairConfigResponse.fromMap(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      },
    );
    controlPlaneNode = registerOutput<VmwareControlPlaneNodeConfigResponse>(
      ...
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return VmwareControlPlaneNodeConfigResponse.fromMap(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      },
    );
    ...
    dataplaneV2 = registerOutput<VmwareDataplaneV2ConfigResponse>(
      ...
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return VmwareDataplaneV2ConfigResponse.fromMap(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      },
    );
    ...
    loadBalancer = registerOutput<VmwareLoadBalancerConfigResponse>(
      ...
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return VmwareLoadBalancerConfigResponse.fromMap(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      },
    );
    ...
    networkConfig = registerOutput<VmwareNetworkConfigResponse>(
      ...
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return VmwareNetworkConfigResponse.fromMap(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      },
    );
    ...
    storage = registerOutput<VmwareStorageConfigResponse>(
      'storage',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return VmwareStorageConfigResponse.fromMap(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      },
    );
    ...
    upgradePolicy = registerOutput<VmwareClusterUpgradePolicyResponse>(
      ...
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return VmwareClusterUpgradePolicyResponse.fromMap(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      },
    );
    ...
    vcenter = registerOutput<VmwareVCenterConfigResponse>(
      'vcenter',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return VmwareVCenterConfigResponse.fromMap(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      },
    );
