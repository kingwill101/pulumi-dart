...
/// {@template pulumi_gkeonprem_v1_vmware_cluster_iam_policy_args_doc}
/// The set of arguments for VmwareClusterIamPolicy.
/// {@endtemplate}
/// {@macro pulumi_gkeonprem_v1_vmware_cluster_iam_policy_args_doc}
class VmwareClusterIamPolicyArgs {
  ...
  /// Creates a new [VmwareClusterIamPolicyArgs].
  ...
  const VmwareClusterIamPolicyArgs({
    this.bindings,
    this.etag,
    this.location,
    this.project,
  ...
  factory VmwareClusterIamPolicyArgs.fromMap(Map<String, dynamic> map) {
    return VmwareClusterIamPolicyArgs(
