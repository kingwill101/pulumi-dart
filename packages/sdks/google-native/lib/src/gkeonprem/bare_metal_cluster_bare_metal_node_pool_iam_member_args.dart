...
/// {@template pulumi_gkeonprem_v1_bare_metal_cluster_bare_metal_node_pool_iam_member_args_doc}
/// The set of arguments for BareMetalClusterBareMetalNodePoolIamMember.
/// {@endtemplate}
/// {@macro pulumi_gkeonprem_v1_bare_metal_cluster_bare_metal_node_pool_iam_member_args_doc}
class BareMetalClusterBareMetalNodePoolIamMemberArgs {
  ...
  /// Creates a new [BareMetalClusterBareMetalNodePoolIamMemberArgs].
  ...
  const BareMetalClusterBareMetalNodePoolIamMemberArgs({
    this.condition,
  ...
  factory BareMetalClusterBareMetalNodePoolIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return BareMetalClusterBareMetalNodePoolIamMemberArgs(
