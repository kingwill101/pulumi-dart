...
class GetVmwareClusterResult {
  ...
  factory GetVmwareClusterResult.fromMap(Map<String, dynamic> map) {
    return GetVmwareClusterResult(
      ...
      antiAffinityGroups: VmwareAAGConfigResponse.fromMap((map['antiAffinityGroups']! as Map).cast<String, dynamic>()),
      authorization: AuthorizationResponse.fromMap((map['authorization']! as Map).cast<String, dynamic>()),
      autoRepairConfig: VmwareAutoRepairConfigResponse.fromMap((map['autoRepairConfig']! as Map).cast<String, dynamic>()),
      controlPlaneNode: VmwareControlPlaneNodeConfigResponse.fromMap((map['controlPlaneNode']! as Map).cast<String, dynamic>()),
      createTime: map['createTime'] as String,
      dataplaneV2: VmwareDataplaneV2ConfigResponse.fromMap((map['dataplaneV2']! as Map).cast<String, dynamic>()),
      ...
      loadBalancer: VmwareLoadBalancerConfigResponse.fromMap((map['loadBalancer']! as Map).cast<String, dynamic>()),
      localName: map['localName'] as String,
      name: map['name'] as String,
      networkConfig: VmwareNetworkConfigResponse.fromMap((map['networkConfig']! as Map).cast<String, dynamic>()),
      ...
      storage: VmwareStorageConfigResponse.fromMap((map['storage']! as Map).cast<String, dynamic>()),
      uid: map['uid'] as String,
      updateTime: map['updateTime'] as String,
      upgradePolicy: VmwareClusterUpgradePolicyResponse.fromMap((map['upgradePolicy']! as Map).cast<String, dynamic>()),
      validationCheck: ValidationCheckResponse.fromMap((map['validationCheck']! as Map).cast<String, dynamic>()),
      vcenter: VmwareVCenterConfigResponse.fromMap((map['vcenter']! as Map).cast<String, dynamic>()),
