...
class BareMetalNodePool extends pulumi.CustomResource {
  ...
  BareMetalNodePool(
    ...
    this.nodePoolConfig = registerOutput<BareMetalNodePoolConfigResponse>('nodePoolConfig');
    ...
    this.upgradePolicy = registerOutput<BareMetalNodePoolUpgradePolicyResponse>('upgradePolicy');
  }
}
