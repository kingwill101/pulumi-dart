...
class BareMetalAdminMachineDrainStatusResponse {
  ...
  final pulumi.Input<List<BareMetalAdminDrainedMachineResponse>>
  drainedMachines;

  /// The list of draning machines.
  final pulumi.Input<List<BareMetalAdminDrainingMachineResponse>>
  drainingMachines;
    ...
    return <String, dynamic>{
      'drainedMachines':
          pulumi.Input.mapInputValue<
            List<BareMetalAdminDrainedMachineResponse>,
      ...
      'drainingMachines':
          pulumi.Input.mapInputValue<
            List<BareMetalAdminDrainingMachineResponse>,
            List<Map<String, dynamic>>
          >(
            drainingMachines,
            (value) =>
