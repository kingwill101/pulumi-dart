...
class BareMetalAdminMachineDrainStatusResponse {
  ...
  factory BareMetalAdminMachineDrainStatusResponse.fromMap(Map<String, dynamic> map) {
    return BareMetalAdminMachineDrainStatusResponse(
      drainedMachines: (pulumi.Input.decodeList<BareMetalAdminDrainedMachineResponse>(map['drainedMachines'], (value) => BareMetalAdminDrainedMachineResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      drainingMachines: (pulumi.Input.decodeList<BareMetalAdminDrainingMachineResponse>(map['drainingMachines'], (value) => BareMetalAdminDrainingMachineResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
