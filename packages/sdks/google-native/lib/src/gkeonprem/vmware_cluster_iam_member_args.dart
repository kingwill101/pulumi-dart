...
/// {@template pulumi_gkeonprem_v1_vmware_cluster_iam_member_args_doc}
/// The set of arguments for VmwareClusterIamMember.
/// {@endtemplate}
/// {@macro pulumi_gkeonprem_v1_vmware_cluster_iam_member_args_doc}
class VmwareClusterIamMemberArgs {
  ...
  /// Creates a new [VmwareClusterIamMemberArgs].
  ...
  const VmwareClusterIamMemberArgs({
    this.condition,
  ...
  factory VmwareClusterIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return VmwareClusterIamMemberArgs(
