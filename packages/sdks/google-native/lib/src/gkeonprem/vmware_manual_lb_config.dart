  ...
  factory VmwareManualLbConfig.fromMap(Map<String, dynamic> map) {
    return VmwareManualLbConfig(
      controlPlaneNodePort: (() {
        final guardedValue = map['controlPlaneNodePort'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      ingressHttpNodePort: (() {
        final guardedValue = map['ingressHttpNodePort'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      ingressHttpsNodePort: (() {
        final guardedValue = map['ingressHttpsNodePort'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      konnectivityServerNodePort: (() {
        final guardedValue = map['konnectivityServerNodePort'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
    );
