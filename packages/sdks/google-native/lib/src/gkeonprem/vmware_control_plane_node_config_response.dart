...
class VmwareControlPlaneNodeConfigResponse {
  ...
  const VmwareControlPlaneNodeConfigResponse({
  ...
  factory VmwareControlPlaneNodeConfigResponse.fromMap(Map<String, dynamic> map) {
    return VmwareControlPlaneNodeConfigResponse(
      autoResizeConfig: pulumi.Input.fromValue(VmwareAutoResizeConfigResponse.fromMap((map['autoResizeConfig']! as Map).cast<String, dynamic>())),
      ...
      vsphereConfig: pulumi.Input.fromValue(VmwareControlPlaneVsphereConfigResponse.fromMap((map['vsphereConfig']! as Map).cast<String, dynamic>())),
    );
  }
}
