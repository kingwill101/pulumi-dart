...
class BareMetalBgpLbConfig {
  ...
  factory BareMetalBgpLbConfig.fromMap(Map<String, dynamic> map) {
    return BareMetalBgpLbConfig(
      ...
      bgpPeerConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<BareMetalBgpPeerConfig>(map['bgpPeerConfigs']!, (value) => BareMetalBgpPeerConfig.fromMap((value as Map).cast<String, dynamic>()))),
