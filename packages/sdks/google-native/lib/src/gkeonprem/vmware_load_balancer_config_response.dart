...
class VmwareLoadBalancerConfigResponse {
    ...
    return <String, dynamic>{
      ...
      'seesawConfig':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(seesawConfig, (value) => value.toMap()),
      'vipConfig':
          pulumi.Input.mapInputValue<
  ...
  factory VmwareLoadBalancerConfigResponse.fromMap(Map<String, dynamic> map) {
    return VmwareLoadBalancerConfigResponse(
      f5Config: pulumi.Input.fromValue(
        VmwareF5BigIpConfigResponse.fromMap(
          (map['f5Config']! as Map).cast<String, dynamic>(),
        ),
      ),
      manualLbConfig: pulumi.Input.fromValue(
        VmwareManualLbConfigResponse.fromMap(
          (map['manualLbConfig']! as Map).cast<String, dynamic>(),
        ),
      ),
      metalLbConfig: pulumi.Input.fromValue(
        VmwareMetalLbConfigResponse.fromMap(
          (map['metalLbConfig']! as Map).cast<String, dynamic>(),
        ),
      ),
      seesawConfig: pulumi.Input.fromValue(
        VmwareSeesawConfigResponse.fromMap(
          (map['seesawConfig']! as Map).cast<String, dynamic>(),
        ),
      ),
      vipConfig: pulumi.Input.fromValue(
        VmwareVipConfigResponse.fromMap(
