...
/// {@template pulumi_gkeonprem_v1_vmware_cluster_vmware_node_pool_iam_binding_args_doc}
/// The set of arguments for VmwareClusterVmwareNodePoolIamBinding.
/// {@endtemplate}
/// {@macro pulumi_gkeonprem_v1_vmware_cluster_vmware_node_pool_iam_binding_args_doc}
class VmwareClusterVmwareNodePoolIamBindingArgs {
  ...
  /// Creates a new [VmwareClusterVmwareNodePoolIamBindingArgs].
  ...
  const VmwareClusterVmwareNodePoolIamBindingArgs({
    this.condition,
  ...
  factory VmwareClusterVmwareNodePoolIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return VmwareClusterVmwareNodePoolIamBindingArgs(
