...
class BareMetalLoadBalancerNodePoolConfig {
  ...
  factory BareMetalLoadBalancerNodePoolConfig.fromMap(Map<String, dynamic> map) {
    return BareMetalLoadBalancerNodePoolConfig(
      nodePoolConfig: (() { final guardedValue = map['nodePoolConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BareMetalNodePoolConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
