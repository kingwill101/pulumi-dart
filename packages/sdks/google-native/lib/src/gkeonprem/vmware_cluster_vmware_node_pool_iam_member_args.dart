...
/// {@template pulumi_gkeonprem_v1_vmware_cluster_vmware_node_pool_iam_member_args_doc}
/// The set of arguments for VmwareClusterVmwareNodePoolIamMember.
/// {@endtemplate}
/// {@macro pulumi_gkeonprem_v1_vmware_cluster_vmware_node_pool_iam_member_args_doc}
class VmwareClusterVmwareNodePoolIamMemberArgs {
  ...
  /// Creates a new [VmwareClusterVmwareNodePoolIamMemberArgs].
  ...
  const VmwareClusterVmwareNodePoolIamMemberArgs({
    this.condition,
  ...
  factory VmwareClusterVmwareNodePoolIamMemberArgs.fromMap(Map<String, dynamic> map) {
