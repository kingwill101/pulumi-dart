...
class VmwareNetworkConfigResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'controlPlaneV2Config': controlPlaneV2Config.toMap(),
      'dhcpIpConfig': dhcpIpConfig.toMap(),
      'hostConfig': hostConfig.toMap(),
      'podAddressCidrBlocks': podAddressCidrBlocks,
      'serviceAddressCidrBlocks': serviceAddressCidrBlocks,
      'staticIpConfig': staticIpConfig.toMap(),
  ...
  factory VmwareNetworkConfigResponse.fromMap(Map<String, dynamic> map) {
    return VmwareNetworkConfigResponse(
      controlPlaneV2Config: VmwareControlPlaneV2ConfigResponse.fromMap((map['controlPlaneV2Config'] as Map).cast<String, dynamic>()),
      dhcpIpConfig: VmwareDhcpIpConfigResponse.fromMap((map['dhcpIpConfig'] as Map).cast<String, dynamic>()),
      hostConfig: VmwareHostConfigResponse.fromMap((map['hostConfig'] as Map).cast<String, dynamic>()),
      ...
      staticIpConfig: VmwareStaticIpConfigResponse.fromMap((map['staticIpConfig'] as Map).cast<String, dynamic>()),
