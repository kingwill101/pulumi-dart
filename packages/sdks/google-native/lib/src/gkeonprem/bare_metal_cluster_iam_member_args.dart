...
/// {@template pulumi_gkeonprem_v1_bare_metal_cluster_iam_member_args_doc}
/// The set of arguments for BareMetalClusterIamMember.
/// {@endtemplate}
/// {@macro pulumi_gkeonprem_v1_bare_metal_cluster_iam_member_args_doc}
class BareMetalClusterIamMemberArgs {
  ...
  /// Creates a new [BareMetalClusterIamMemberArgs].
  ...
  const BareMetalClusterIamMemberArgs({
    this.condition,
