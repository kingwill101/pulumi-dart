...
/// {@template pulumi_gkeonprem_v1_bare_metal_admin_cluster_iam_member_args_doc}
/// The set of arguments for BareMetalAdminClusterIamMember.
/// {@endtemplate}
/// {@macro pulumi_gkeonprem_v1_bare_metal_admin_cluster_iam_member_args_doc}
class BareMetalAdminClusterIamMemberArgs {
  ...
  /// Creates a new [BareMetalAdminClusterIamMemberArgs].
  ...
  const BareMetalAdminClusterIamMemberArgs({
    this.condition,
  ...
  factory BareMetalAdminClusterIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return BareMetalAdminClusterIamMemberArgs(
