...
class BareMetalAdminControlPlaneConfigResponse {
  ...
  final pulumi.Input<List<BareMetalAdminApiServerArgumentResponse>>
  apiServerArgs;

  /// Configures the node pool running the control plane. If specified the corresponding NodePool will be created for the cluster's control plane. The NodePool will have the same name and namespace as the cluster.
  final pulumi.Input<BareMetalAdminControlPlaneNodePoolConfigResponse>
    ...
    return <String, dynamic>{
      'apiServerArgs':
          pulumi.Input.mapInputValue<
            List<BareMetalAdminApiServerArgumentResponse>,
