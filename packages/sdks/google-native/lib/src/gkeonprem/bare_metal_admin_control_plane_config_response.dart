...
class BareMetalAdminControlPlaneConfigResponse {
  ...
  const BareMetalAdminControlPlaneConfigResponse({
  ...
  factory BareMetalAdminControlPlaneConfigResponse.fromMap(Map<String, dynamic> map) {
    return BareMetalAdminControlPlaneConfigResponse(
      apiServerArgs: pulumi.Input.fromValue(pulumi.Input.decodeList<BareMetalAdminApiServerArgumentResponse>(map['apiServerArgs']!, (value) => BareMetalAdminApiServerArgumentResponse.fromMap((value as Map).cast<String, dynamic>()))),
      controlPlaneNodePoolConfig: pulumi.Input.fromValue(BareMetalAdminControlPlaneNodePoolConfigResponse.fromMap((map['controlPlaneNodePoolConfig']! as Map).cast<String, dynamic>())),
    );
  }
}
