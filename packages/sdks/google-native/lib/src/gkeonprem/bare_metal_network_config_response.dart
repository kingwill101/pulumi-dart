...
class BareMetalNetworkConfigResponse {
  ...
  factory BareMetalNetworkConfigResponse.fromMap(Map<String, dynamic> map) {
    return BareMetalNetworkConfigResponse(
      ...
      islandModeCidr: (BareMetalIslandModeCidrConfigResponse.fromMap((map['islandModeCidr'] as Map).cast<String, dynamic>())).input(),
      multipleNetworkInterfacesConfig: (BareMetalMultipleNetworkInterfacesConfigResponse.fromMap((map['multipleNetworkInterfacesConfig'] as Map).cast<String, dynamic>())).input(),
      srIovConfig: (BareMetalSrIovConfigResponse.fromMap((map['srIovConfig'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
