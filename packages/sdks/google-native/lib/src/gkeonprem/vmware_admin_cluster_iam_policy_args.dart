...
/// {@template pulumi_gkeonprem_v1_vmware_admin_cluster_iam_policy_args_doc}
/// The set of arguments for VmwareAdminClusterIamPolicy.
/// {@endtemplate}
/// {@macro pulumi_gkeonprem_v1_vmware_admin_cluster_iam_policy_args_doc}
class VmwareAdminClusterIamPolicyArgs {
  ...
  /// Creates a new [VmwareAdminClusterIamPolicyArgs].
  ...
  const VmwareAdminClusterIamPolicyArgs({
    this.bindings,
    this.etag,
    this.location,
    this.project,
  ...
  factory VmwareAdminClusterIamPolicyArgs.fromMap(Map<String, dynamic> map) {
    return VmwareAdminClusterIamPolicyArgs(
      ...
      vmwareAdminClusterId: pulumi.Input.fromValue(map['vmwareAdminClusterId'] as String),
    );
  }
}
