...
class BareMetalMetalLbConfig {
  ...
  factory BareMetalMetalLbConfig.fromMap(Map<String, dynamic> map) {
    return BareMetalMetalLbConfig(
      addressPools: pulumi.Input.fromValue(pulumi.Input.decodeList<BareMetalLoadBalancerAddressPool>(map['addressPools']!, (value) => BareMetalLoadBalancerAddressPool.fromMap((value as Map).cast<String, dynamic>()))),
      loadBalancerNodePoolConfig: (() { final guardedValue = map['loadBalancerNodePoolConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BareMetalLoadBalancerNodePoolConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
