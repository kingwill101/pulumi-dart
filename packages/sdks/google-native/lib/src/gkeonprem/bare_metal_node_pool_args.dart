...
class BareMetalNodePoolArgs {
  ...
  factory BareMetalNodePoolArgs.fromMap(Map<String, dynamic> map) {
    return BareMetalNodePoolArgs(
      ...
      bareMetalNodePoolId: (() { final guardedValue = map['bareMetalNodePoolId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      upgradePolicy: (() { final guardedValue = map['upgradePolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BareMetalNodePoolUpgradePolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
