...
class BareMetalAdminControlPlaneConfig {
  ...
  const BareMetalAdminControlPlaneConfig({
    this.apiServerArgs,
  ...
  factory BareMetalAdminControlPlaneConfig.fromMap(Map<String, dynamic> map) {
    return BareMetalAdminControlPlaneConfig(
      apiServerArgs: (() { final guardedValue = map['apiServerArgs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<BareMetalAdminApiServerArgument>(guardedValue, (value) => BareMetalAdminApiServerArgument.fromMap((value as Map).cast<String, dynamic>()))); })(),
      controlPlaneNodePoolConfig: pulumi.Input.fromValue(BareMetalAdminControlPlaneNodePoolConfig.fromMap((map['controlPlaneNodePoolConfig']! as Map).cast<String, dynamic>())),
    );
  }
}
