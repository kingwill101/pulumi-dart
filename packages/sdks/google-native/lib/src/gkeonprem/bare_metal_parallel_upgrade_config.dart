...
class BareMetalParallelUpgradeConfig {
  ...
  factory BareMetalParallelUpgradeConfig.fromMap(Map<String, dynamic> map) {
    return BareMetalParallelUpgradeConfig(
      concurrentNodes: map['concurrentNodes'] == null ? null : map['concurrentNodes'] as int,
      minimumAvailableNodes: map['minimumAvailableNodes'] == null ? null : map['minimumAvailableNodes'] as int,
    );
  }
}
