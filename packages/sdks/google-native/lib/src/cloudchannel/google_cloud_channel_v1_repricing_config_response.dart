...
class GoogleCloudChannelV1RepricingConfigResponse {
  ...
  final pulumi.Input<List<GoogleCloudChannelV1ConditionalOverrideResponse>>
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'conditionalOverrides':
          pulumi.Input.mapInputValue<
            List<GoogleCloudChannelV1ConditionalOverrideResponse>,
      ...
      'effectiveInvoiceMonth':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(effectiveInvoiceMonth, (value) => value.toMap()),
      'entitlementGranularity':
          pulumi.Input.mapInputValue<
            GoogleCloudChannelV1RepricingConfigEntitlementGranularityResponse,
            Map<String, dynamic>
          >(entitlementGranularity, (value) => value.toMap()),
  ...
  factory GoogleCloudChannelV1RepricingConfigResponse.fromMap(
    ...
    return GoogleCloudChannelV1RepricingConfigResponse(
      ...
      channelPartnerGranularity: pulumi.Input.fromValue(
        (map['channelPartnerGranularity']! as Map).cast<String, dynamic>(),
      ),
      conditionalOverrides: pulumi.Input.fromValue(
        pulumi
      ...
      effectiveInvoiceMonth: pulumi.Input.fromValue(
        GoogleTypeDateResponse.fromMap(
          (map['effectiveInvoiceMonth']! as Map).cast<String, dynamic>(),
        ),
      ),
      entitlementGranularity: pulumi.Input.fromValue(
        GoogleCloudChannelV1RepricingConfigEntitlementGranularityResponse.fromMap(
