...
class GoogleCloudChannelV1RepricingConfig {
  ...
  final pulumi.Input<List<GoogleCloudChannelV1ConditionalOverride>>?
  ...
  final pulumi.Input<GoogleCloudChannelV1RepricingConfigEntitlementGranularity>?
  entitlementGranularity;

  /// The RebillingBasis to use for this bill. Specifies the relative cost based on repricing costs you will apply.
  final pulumi.Input<GoogleCloudChannelV1RepricingConfigRebillingBasis>
  rebillingBasis;
    ...
    return <String, dynamic>{
      ...
      'conditionalOverrides':
          ?pulumi.Input.mapOptionalInputValue<
            List<GoogleCloudChannelV1ConditionalOverride>,
  ...
  factory GoogleCloudChannelV1RepricingConfig.fromMap(
    ...
    return GoogleCloudChannelV1RepricingConfig(
      ...
      channelPartnerGranularity: (() {
        final guardedValue = map['channelPartnerGranularity'];
      ...
      conditionalOverrides: (() {
        final guardedValue = map['conditionalOverrides'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      entitlementGranularity: (() {
        final guardedValue = map['entitlementGranularity'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
