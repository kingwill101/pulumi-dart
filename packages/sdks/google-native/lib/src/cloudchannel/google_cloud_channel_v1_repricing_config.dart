...
class GoogleCloudChannelV1RepricingConfig {
  ...
  const GoogleCloudChannelV1RepricingConfig({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'rebillingBasis': pulumi.Input.mapInputValue<GoogleCloudChannelV1RepricingConfigRebillingBasis, String>(rebillingBasis, (value) => value.wireValue),
    };
  }
  ...
  factory GoogleCloudChannelV1RepricingConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudChannelV1RepricingConfig(
      ...
      channelPartnerGranularity: (() { final guardedValue = map['channelPartnerGranularity']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, dynamic>()); })(),
      conditionalOverrides: (() { final guardedValue = map['conditionalOverrides']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudChannelV1ConditionalOverride>(guardedValue, (value) => GoogleCloudChannelV1ConditionalOverride.fromMap((value as Map).cast<String, dynamic>()))); })(),
      effectiveInvoiceMonth: pulumi.Input.fromValue(GoogleTypeDate.fromMap((map['effectiveInvoiceMonth']! as Map).cast<String, dynamic>())),
      entitlementGranularity: (() { final guardedValue = map['entitlementGranularity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudChannelV1RepricingConfigEntitlementGranularity.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      rebillingBasis: pulumi.Input.fromValue(GoogleCloudChannelV1RepricingConfigRebillingBasis.fromValue(map['rebillingBasis']! as String)),
    );
  }
}
