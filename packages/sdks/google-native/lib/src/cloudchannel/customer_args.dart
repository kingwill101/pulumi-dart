...
class CustomerArgs {
  ...
  factory CustomerArgs.fromMap(Map<String, dynamic> map) {
    return CustomerArgs(
      ...
      alternateEmail: (() {
        final guardedValue = map['alternateEmail'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      channelPartnerId: (() {
        final guardedValue = map['channelPartnerId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ...
      orgPostalAddress: pulumi.Input.fromValue(
        GoogleTypePostalAddress.fromMap(
          (map['orgPostalAddress']! as Map).cast<String, dynamic>(),
        ),
      ),
      primaryContactInfo: (() {
        final guardedValue = map['primaryContactInfo'];
        if (guardedValue == null) return null;
