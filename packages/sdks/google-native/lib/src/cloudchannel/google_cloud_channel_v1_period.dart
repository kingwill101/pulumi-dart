...
class GoogleCloudChannelV1Period {
  ...
  const GoogleCloudChannelV1Period({
    this.duration,
    this.periodType,
  });
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'duration': ?duration,
      'periodType': ?pulumi.Input.mapOptionalInputValue<GoogleCloudChannelV1PeriodPeriodType, String>(periodType, (value) => value.wireValue),
    };
  }
  ...
  factory GoogleCloudChannelV1Period.fromMap(Map<String, dynamic> map) {
    return GoogleCloudChannelV1Period(
      ...
      periodType: (() { final guardedValue = map['periodType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudChannelV1PeriodPeriodType.fromValue(guardedValue as String)); })(),
    );
  }
}
