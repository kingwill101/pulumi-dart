...
class Customer extends pulumi.CustomResource {
  ...
  late final pulumi.Output<GoogleCloudChannelV1CloudIdentityInfoResponse> cloudIdentityInfo;
  ...
  late final pulumi.Output<GoogleCloudChannelV1ContactInfoResponse> primaryContactInfo;
  ...
  Customer(
    ...
    cloudIdentityInfo = registerOutput<GoogleCloudChannelV1CloudIdentityInfoResponse>('cloudIdentityInfo', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return GoogleCloudChannelV1CloudIdentityInfoResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    orgPostalAddress = registerOutput<GoogleTypePostalAddressResponse>('orgPostalAddress', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return GoogleTypePostalAddressResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    primaryContactInfo = registerOutput<GoogleCloudChannelV1ContactInfoResponse>('primaryContactInfo', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return GoogleCloudChannelV1ContactInfoResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
