...
class GoogleCloudChannelV1RenewalSettingsResponse {
  ...
  factory GoogleCloudChannelV1RenewalSettingsResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudChannelV1RenewalSettingsResponse(
      enableRenewal: (map['enableRenewal'] as bool).input(),
      paymentCycle: (GoogleCloudChannelV1PeriodResponse.fromMap((map['paymentCycle'] as Map).cast<String, dynamic>())).input(),
      paymentPlan: (map['paymentPlan'] as String).input(),
      resizeUnitCount: (map['resizeUnitCount'] as bool).input(),
    );
  }
}
