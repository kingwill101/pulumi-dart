...
class GoogleCloudChannelV1ConditionalOverrideResponse {
  ...
  final pulumi.Input<GoogleCloudChannelV1RepricingConditionResponse> repricingCondition;
  ...
  const GoogleCloudChannelV1ConditionalOverrideResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'repricingCondition': pulumi.Input.mapInputValue<GoogleCloudChannelV1RepricingConditionResponse, Map<String, dynamic>>(repricingCondition, (value) => value.toMap()),
    };
  }

  factory GoogleCloudChannelV1ConditionalOverrideResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudChannelV1ConditionalOverrideResponse(
      ...
      repricingCondition: pulumi.Input.fromValue(GoogleCloudChannelV1RepricingConditionResponse.fromMap((map['repricingCondition']! as Map).cast<String, dynamic>())),
    );
  }
}
