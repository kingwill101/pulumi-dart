...
class GoogleCloudChannelV1RepricingConditionResponse {
  ...
  final pulumi.Input<GoogleCloudChannelV1SkuGroupConditionResponse>
  skuGroupCondition;
  ...
  factory GoogleCloudChannelV1RepricingConditionResponse.fromMap(
    ...
    return GoogleCloudChannelV1RepricingConditionResponse(
      skuGroupCondition: pulumi.Input.fromValue(
        GoogleCloudChannelV1SkuGroupConditionResponse.fromMap(
