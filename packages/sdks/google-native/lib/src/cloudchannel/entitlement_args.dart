...
class EntitlementArgs {
    ...
    return <String, dynamic>{
      ...
      'associationInfo':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(associationInfo, (value) => value.toMap()),
      'billingAccount': ?billingAccount,
      'commitmentSettings':
          ?pulumi.Input.mapOptionalInputValue<
            GoogleCloudChannelV1CommitmentSettings,
            Map<String, dynamic>
          >(commitmentSettings, (value) => value.toMap()),
      'customerId': customerId,
      'offer': offer,
      'parameters':
          ?pulumi.Input.mapOptionalInputValue<
            List<GoogleCloudChannelV1Parameter>,
  ...
  factory EntitlementArgs.fromMap(Map<String, dynamic> map) {
    return EntitlementArgs(
      ...
      associationInfo: (() {
        final guardedValue = map['associationInfo'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GoogleCloudChannelV1AssociationInfo.fromMap(
      ...
      commitmentSettings: (() {
        final guardedValue = map['commitmentSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GoogleCloudChannelV1CommitmentSettings.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      parameters: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GoogleCloudChannelV1Parameter>(
            guardedValue,
            (value) => GoogleCloudChannelV1Parameter.fromMap(
      ...
      purchaseOrderId: (() {
        final guardedValue = map['purchaseOrderId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      requestId: (() {
