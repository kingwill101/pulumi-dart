...
class GoogleCloudChannelV1RenewalSettings {
  ...
  const GoogleCloudChannelV1RenewalSettings({
    this.enableRenewal,
    this.paymentCycle,
    this.paymentPlan,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'paymentPlan': ?pulumi.Input.mapOptionalInputValue<GoogleCloudChannelV1RenewalSettingsPaymentPlan, String>(paymentPlan, (value) => value.wireValue),
  ...
  factory GoogleCloudChannelV1RenewalSettings.fromMap(Map<String, dynamic> map) {
    return GoogleCloudChannelV1RenewalSettings(
      enableRenewal: (() { final guardedValue = map['enableRenewal']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      paymentCycle: (() { final guardedValue = map['paymentCycle']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudChannelV1Period.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      paymentPlan: (() { final guardedValue = map['paymentPlan']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudChannelV1RenewalSettingsPaymentPlan.fromValue(guardedValue as String)); })(),
      resizeUnitCount: (() { final guardedValue = map['resizeUnitCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
    );
  }
}
