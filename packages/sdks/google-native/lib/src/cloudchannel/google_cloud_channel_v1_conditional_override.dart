...
class GoogleCloudChannelV1ConditionalOverride {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'rebillingBasis': pulumi.Input.mapInputValue<GoogleCloudChannelV1ConditionalOverrideRebillingBasis, String>(rebillingBasis, (value) => value.value),
  ...
  factory GoogleCloudChannelV1ConditionalOverride.fromMap(Map<String, dynamic> map) {
    return GoogleCloudChannelV1ConditionalOverride(
      ...
      rebillingBasis: (GoogleCloudChannelV1ConditionalOverrideRebillingBasis.fromValue(map['rebillingBasis'] as String)).input(),
      repricingCondition: (GoogleCloudChannelV1RepricingCondition.fromMap((map['repricingCondition'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
