...
class ConnectionArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'eventingEnablementType': ?pulumi.Input.mapOptionalInputValue<ConnectionEventingEnablementType, String>(eventingEnablementType, (value) => value.wireValue),
      'labels': ?labels,
      'location': ?location,
  ...
  factory ConnectionArgs.fromMap(Map<String, dynamic> map) {
    return ConnectionArgs(
      ...
      configVariables: (() { final guardedValue = map['configVariables']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ConfigVariable>(guardedValue, (value) => ConfigVariable.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      destinationConfigs: (() { final guardedValue = map['destinationConfigs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DestinationConfig>(guardedValue, (value) => DestinationConfig.fromMap((value as Map).cast<String, dynamic>()))); })(),
      eventingConfig: (() { final guardedValue = map['eventingConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EventingConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      eventingEnablementType: (() { final guardedValue = map['eventingEnablementType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConnectionEventingEnablementType.fromValue(guardedValue as String)); })(),
      labels: (() { final guardedValue = map['labels']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      location: (() { final guardedValue = map['location']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      lockConfig: (() { final guardedValue = map['lockConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LockConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      logConfig: (() { final guardedValue = map['logConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConnectorsLogConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
