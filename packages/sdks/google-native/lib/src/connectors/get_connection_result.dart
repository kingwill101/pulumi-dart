...
class GetConnectionResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'configVariables': pulumi.Input.encodeList<ConfigVariableResponse, Map<String, dynamic>>(configVariables, (value) => value.toMap()),
      'connectionRevision': connectionRevision,
      'connectorVersion': connectorVersion,
      'connectorVersionInfraConfig': connectorVersionInfraConfig.toMap(),
      'connectorVersionLaunchStage': connectorVersionLaunchStage,
      'createTime': createTime,
      'description': description,
      'destinationConfigs': pulumi.Input.encodeList<DestinationConfigResponse, Map<String, dynamic>>(destinationConfigs, (value) => value.toMap()),
      'envoyImageLocation': envoyImageLocation,
      'eventingConfig': eventingConfig.toMap(),
      'eventingEnablementType': eventingEnablementType,
      'eventingRuntimeData': eventingRuntimeData.toMap(),
      'imageLocation': imageLocation,
      'isTrustedTester': isTrustedTester,
      'labels': labels,
      'lockConfig': lockConfig.toMap(),
  ...
  factory GetConnectionResult.fromMap(Map<String, dynamic> map) {
    return GetConnectionResult(
      ...
      configVariables: pulumi.Input.decodeList<ConfigVariableResponse>(map['configVariables']!, (value) => ConfigVariableResponse.fromMap((value as Map).cast<String, dynamic>())),
      connectionRevision: map['connectionRevision'] as String,
      connectorVersion: map['connectorVersion'] as String,
      connectorVersionInfraConfig: ConnectorVersionInfraConfigResponse.fromMap((map['connectorVersionInfraConfig']! as Map).cast<String, dynamic>()),
      connectorVersionLaunchStage: map['connectorVersionLaunchStage'] as String,
      createTime: map['createTime'] as String,
      description: map['description'] as String,
      destinationConfigs: pulumi.Input.decodeList<DestinationConfigResponse>(map['destinationConfigs']!, (value) => DestinationConfigResponse.fromMap((value as Map).cast<String, dynamic>())),
      envoyImageLocation: map['envoyImageLocation'] as String,
      eventingConfig: EventingConfigResponse.fromMap((map['eventingConfig']! as Map).cast<String, dynamic>()),
      eventingEnablementType: map['eventingEnablementType'] as String,
      eventingRuntimeData: EventingRuntimeDataResponse.fromMap((map['eventingRuntimeData']! as Map).cast<String, dynamic>()),
      imageLocation: map['imageLocation'] as String,
      isTrustedTester: map['isTrustedTester'] as bool,
      labels: (map['labels'] as Map).cast<String, String>(),
      lockConfig: LockConfigResponse.fromMap((map['lockConfig']! as Map).cast<String, dynamic>()),
      logConfig: ConnectorsLogConfigResponse.fromMap((map['logConfig']! as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      nodeConfig: NodeConfigResponse.fromMap((map['nodeConfig']! as Map).cast<String, dynamic>()),
      ...
      status: ConnectionStatusResponse.fromMap((map['status']! as Map).cast<String, dynamic>()),
