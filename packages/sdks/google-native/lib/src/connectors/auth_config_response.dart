...
class AuthConfigResponse {
  ...
  factory AuthConfigResponse.fromMap(Map<String, dynamic> map) {
    return AuthConfigResponse(
      ...
      oauth2AuthCodeFlow: pulumi.Input.fromValue(
        Oauth2AuthCodeFlowResponse.fromMap(
          (map['oauth2AuthCodeFlow']! as Map).cast<String, dynamic>(),
        ),
      ),
      oauth2ClientCredentials: pulumi.Input.fromValue(
        Oauth2ClientCredentialsResponse.fromMap(
          (map['oauth2ClientCredentials']! as Map).cast<String, dynamic>(),
        ),
      ),
      oauth2JwtBearer: pulumi.Input.fromValue(
        Oauth2JwtBearerResponse.fromMap(
      ...
      userPassword: pulumi.Input.fromValue(
