...
class AuthConfigResponse {
  ...
  factory AuthConfigResponse.fromMap(Map<String, dynamic> map) {
    return AuthConfigResponse(
      ...
      oauth2AuthCodeFlow: (Oauth2AuthCodeFlowResponse.fromMap((map['oauth2AuthCodeFlow'] as Map).cast<String, dynamic>())).input(),
      oauth2ClientCredentials: (Oauth2ClientCredentialsResponse.fromMap((map['oauth2ClientCredentials'] as Map).cast<String, dynamic>())).input(),
      oauth2JwtBearer: (Oauth2JwtBearerResponse.fromMap((map['oauth2JwtBearer'] as Map).cast<String, dynamic>())).input(),
      sshPublicKey: (SshPublicKeyResponse.fromMap((map['sshPublicKey'] as Map).cast<String, dynamic>())).input(),
      userPassword: (UserPasswordResponse.fromMap((map['userPassword'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
