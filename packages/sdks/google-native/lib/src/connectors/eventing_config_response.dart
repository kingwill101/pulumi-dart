...
class EventingConfigResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'authConfig':
          pulumi.Input.mapInputValue<AuthConfigResponse, Map<String, dynamic>>(
            authConfig,
            (value) => value.toMap(),
          ),
      'encryptionKey':
  ...
  factory EventingConfigResponse.fromMap(Map<String, dynamic> map) {
    return EventingConfigResponse(
      additionalVariables: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ConfigVariableResponse>(
      ...
      authConfig: pulumi.Input.fromValue(
        AuthConfigResponse.fromMap(
          (map['authConfig']! as Map).cast<String, dynamic>(),
        ),
      ),
      encryptionKey: pulumi.Input.fromValue(
        ConfigVariableResponse.fromMap(
          (map['encryptionKey']! as Map).cast<String, dynamic>(),
        ),
      ),
      enrichmentEnabled: pulumi.Input.fromValue(
        map['enrichmentEnabled'] as bool,
      ),
      eventsListenerIngressEndpoint: pulumi.Input.fromValue(
        map['eventsListenerIngressEndpoint'] as String,
      ),
      privateConnectivityEnabled: pulumi.Input.fromValue(
        map['privateConnectivityEnabled'] as bool,
      ),
      registrationDestinationConfig: pulumi.Input.fromValue(
        DestinationConfigResponse.fromMap(
