...
class SslConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'clientCertType':
          ?pulumi.Input.mapOptionalInputValue<SslConfigClientCertType, String>(
            clientCertType,
      ...
      'serverCertType':
          ?pulumi.Input.mapOptionalInputValue<SslConfigServerCertType, String>(
            serverCertType,
            (value) => value.wireValue,
          ),
      'trustModel':
          ?pulumi.Input.mapOptionalInputValue<SslConfigTrustModel, String>(
            trustModel,
            (value) => value.wireValue,
          ),
      'type': ?pulumi.Input.mapOptionalInputValue<SslConfigType, String>(
        type,
        (value) => value.wireValue,
      ),
      'useSsl': ?useSsl,
  ...
  factory SslConfig.fromMap(Map<String, dynamic> map) {
    return SslConfig(
      ...
      clientCertType: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SslConfigClientCertType.fromValue(guardedValue as String),
        );
      })(),
      clientCertificate: (() {
      ...
      serverCertType: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SslConfigServerCertType.fromValue(guardedValue as String),
        );
      })(),
      trustModel: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SslConfigTrustModel.fromValue(guardedValue as String),
        );
      })(),
      type: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SslConfigType.fromValue(guardedValue as String),
        );
      })(),
      useSsl: (() {
