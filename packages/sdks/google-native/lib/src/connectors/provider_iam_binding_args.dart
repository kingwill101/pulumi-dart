...
/// {@template pulumi_connectors_v1_provider_iam_binding_args_doc}
/// The set of arguments for ProviderIamBinding.
/// {@endtemplate}
/// {@macro pulumi_connectors_v1_provider_iam_binding_args_doc}
class ProviderIamBindingArgs {
  ...
  /// Creates a new [ProviderIamBindingArgs].
  ...
  factory ProviderIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return ProviderIamBindingArgs(
