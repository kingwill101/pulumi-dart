  ...
  factory EventingConfig.fromMap(Map<String, dynamic> map) {
    return EventingConfig(
      ...
      encryptionKey: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ConfigVariable.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      enrichmentEnabled: (() {
      ...
      eventsListenerIngressEndpoint: (() {
        final guardedValue = map['eventsListenerIngressEndpoint'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      privateConnectivityEnabled: (() {
        final guardedValue = map['privateConnectivityEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      registrationDestinationConfig: (() {
        final guardedValue = map['registrationDestinationConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
