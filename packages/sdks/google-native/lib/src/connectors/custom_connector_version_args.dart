  ...
  factory CustomConnectorVersionArgs.fromMap(Map<String, dynamic> map) {
    return CustomConnectorVersionArgs(
      authConfig: pulumi.Input.fromValue(
        AuthConfig.fromMap((map['authConfig']! as Map).cast<String, dynamic>()),
      ),
      ...
      enableBackendDestinationConfig: (() {
        final guardedValue = map['enableBackendDestinationConfig'];
      ...
      specLocation: (() {
        final guardedValue = map['specLocation'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      type: pulumi.Input.fromValue(
        CustomConnectorVersionType.fromValue(map['type']! as String),
      ),
    );
  }
}
