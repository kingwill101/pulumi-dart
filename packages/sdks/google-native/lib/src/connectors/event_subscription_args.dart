...
class EventSubscriptionArgs {
  ...
  factory EventSubscriptionArgs.fromMap(Map<String, dynamic> map) {
    return EventSubscriptionArgs(
      ...
      eventTypeId: (() {
        final guardedValue = map['eventTypeId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      jms: (() {
        final guardedValue = map['jms'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          JMS.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      location: (() {
      ...
      subscriber: (() {
        final guardedValue = map['subscriber'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      subscriberLink: (() {
        final guardedValue = map['subscriberLink'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
