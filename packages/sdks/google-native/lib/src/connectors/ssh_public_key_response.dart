...
class SshPublicKeyResponse {
  ...
  factory SshPublicKeyResponse.fromMap(Map<String, dynamic> map) {
    return SshPublicKeyResponse(
      ...
      sshClientCert: pulumi.Input.fromValue(SecretResponse.fromMap((map['sshClientCert']! as Map).cast<String, dynamic>())),
      sshClientCertPass: pulumi.Input.fromValue(SecretResponse.fromMap((map['sshClientCertPass']! as Map).cast<String, dynamic>())),
