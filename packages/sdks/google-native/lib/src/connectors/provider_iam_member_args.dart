...
/// {@template pulumi_connectors_v1_provider_iam_member_args_doc}
/// The set of arguments for ProviderIamMember.
/// {@endtemplate}
/// {@macro pulumi_connectors_v1_provider_iam_member_args_doc}
class ProviderIamMemberArgs {
  ...
  /// Creates a new [ProviderIamMemberArgs].
  ...
  factory ProviderIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return ProviderIamMemberArgs(
