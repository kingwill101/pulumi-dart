...
class CustomConnectorVersion extends pulumi.CustomResource {
  ...
  CustomConnectorVersion(
    ...
    this.customConnectorVersionId = registerOutput<String>('customConnectorVersionId');
    this.destinationConfig = registerOutput<DestinationConfigResponse>('destinationConfig');
    this.enableBackendDestinationConfig = registerOutput<bool>('enableBackendDestinationConfig');
