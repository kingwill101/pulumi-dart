...
class Oauth2JwtBearerResponse {
  ...
  factory Oauth2JwtBearerResponse.fromMap(Map<String, dynamic> map) {
    return Oauth2JwtBearerResponse(
      clientKey: (SecretResponse.fromMap((map['clientKey'] as Map).cast<String, dynamic>())).input(),
      jwtClaims: (JwtClaimsResponse.fromMap((map['jwtClaims'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
