...
class Oauth2JwtBearerResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'clientKey': pulumi.Input.mapInputValue<SecretResponse, Map<String, dynamic>>(clientKey, (value) => value.toMap()),
      'jwtClaims': pulumi.Input.mapInputValue<JwtClaimsResponse, Map<String, dynamic>>(jwtClaims, (value) => value.toMap()),
    };
  }

  factory Oauth2JwtBearerResponse.fromMap(Map<String, dynamic> map) {
    return Oauth2JwtBearerResponse(
      clientKey: pulumi.Input.fromValue(SecretResponse.fromMap((map['clientKey']! as Map).cast<String, dynamic>())),
      jwtClaims: pulumi.Input.fromValue(JwtClaimsResponse.fromMap((map['jwtClaims']! as Map).cast<String, dynamic>())),
    );
  }
}
