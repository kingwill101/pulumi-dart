...
class GoogleCloudMlV1TrainingOutputResponse {
  ...
  final pulumi.Input<GoogleCloudMlV1BuiltInAlgorithmOutputResponse>
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'trials':
          pulumi.Input.mapInputValue<
            List<GoogleCloudMlV1HyperparameterOutputResponse>,
  ...
  factory GoogleCloudMlV1TrainingOutputResponse.fromMap(
    ...
    return GoogleCloudMlV1TrainingOutputResponse(
      ...
      isBuiltInAlgorithmJob: pulumi.Input.fromValue(
        map['isBuiltInAlgorithmJob'] as bool,
      ),
      isHyperparameterTuningJob: pulumi.Input.fromValue(
        map['isHyperparameterTuningJob'] as bool,
      ),
      trials: pulumi.Input.fromValue(
