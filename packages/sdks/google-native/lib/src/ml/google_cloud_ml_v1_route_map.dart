...
class GoogleCloudMlV1RouteMap {
  ...
  factory GoogleCloudMlV1RouteMap.fromMap(Map<String, dynamic> map) {
    return GoogleCloudMlV1RouteMap(
      ...
      predict: (() { final guardedValue = map['predict']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
