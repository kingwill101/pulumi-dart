...
class GoogleCloudMlV1ExplanationConfig {
  ...
  final pulumi.Input<GoogleCloudMlV1IntegratedGradientsAttribution>? integratedGradientsAttribution;
  /// An attribution method that approximates Shapley values for features that contribute to the label being predicted. A sampling strategy is used to approximate the value rather than considering all subsets of features.
  final pulumi.Input<GoogleCloudMlV1SampledShapleyAttribution>? sampledShapleyAttribution;
  ...
  const GoogleCloudMlV1ExplanationConfig({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'integratedGradientsAttribution': ?pulumi.Input.mapOptionalInputValue<GoogleCloudMlV1IntegratedGradientsAttribution, Map<String, dynamic>>(integratedGradientsAttribution, (value) => value.toMap()),
      'sampledShapleyAttribution': ?pulumi.Input.mapOptionalInputValue<GoogleCloudMlV1SampledShapleyAttribution, Map<String, dynamic>>(sampledShapleyAttribution, (value) => value.toMap()),
      'xraiAttribution': ?pulumi.Input.mapOptionalInputValue<GoogleCloudMlV1XraiAttribution, Map<String, dynamic>>(xraiAttribution, (value) => value.toMap()),
    };
  }

  factory GoogleCloudMlV1ExplanationConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudMlV1ExplanationConfig(
      integratedGradientsAttribution: (() { final guardedValue = map['integratedGradientsAttribution']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudMlV1IntegratedGradientsAttribution.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      sampledShapleyAttribution: (() { final guardedValue = map['sampledShapleyAttribution']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudMlV1SampledShapleyAttribution.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      xraiAttribution: (() { final guardedValue = map['xraiAttribution']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudMlV1XraiAttribution.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
