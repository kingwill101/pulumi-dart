...
class GoogleCloudMlV1ExplanationConfig {
  ...
  final GoogleCloudMlV1IntegratedGradientsAttribution? integratedGradientsAttribution;
  ...
  factory GoogleCloudMlV1ExplanationConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudMlV1ExplanationConfig(
      integratedGradientsAttribution: map['integratedGradientsAttribution'] == null ? null : GoogleCloudMlV1IntegratedGradientsAttribution.fromMap((map['integratedGradientsAttribution'] as Map).cast<String, dynamic>()),
      sampledShapleyAttribution: map['sampledShapleyAttribution'] == null ? null : GoogleCloudMlV1SampledShapleyAttribution.fromMap((map['sampledShapleyAttribution'] as Map).cast<String, dynamic>()),
      xraiAttribution: map['xraiAttribution'] == null ? null : GoogleCloudMlV1XraiAttribution.fromMap((map['xraiAttribution'] as Map).cast<String, dynamic>()),
    );
  }
}
