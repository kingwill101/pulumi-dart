  ...
  factory GoogleCloudMlV1HyperparameterSpec.fromMap(Map<String, dynamic> map) {
    return GoogleCloudMlV1HyperparameterSpec(
      ...
      enableTrialEarlyStopping: (() {
        final guardedValue = map['enableTrialEarlyStopping'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      goal: pulumi.Input.fromValue(
        GoogleCloudMlV1HyperparameterSpecGoal.fromValue(map['goal']! as String),
      ),
      hyperparameterMetricTag: (() {
        final guardedValue = map['hyperparameterMetricTag'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      maxFailedTrials: (() {
        final guardedValue = map['maxFailedTrials'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      maxParallelTrials: (() {
        final guardedValue = map['maxParallelTrials'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      maxTrials: (() {
      ...
      params: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GoogleCloudMlV1ParameterSpec>(
          map['params']!,
      ...
      resumePreviousJobId: (() {
        final guardedValue = map['resumePreviousJobId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
