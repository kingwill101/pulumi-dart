...
class GoogleCloudMlV1ReplicaConfig {
  ...
  factory GoogleCloudMlV1ReplicaConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudMlV1ReplicaConfig(
      ...
      containerArgs: map['containerArgs'] == null ? null : (map['containerArgs'] as List).cast<String>(),
      containerCommand: map['containerCommand'] == null ? null : (map['containerCommand'] as List).cast<String>(),
      diskConfig: map['diskConfig'] == null ? null : GoogleCloudMlV1DiskConfig.fromMap((map['diskConfig'] as Map).cast<String, dynamic>()),
      imageUri: map['imageUri'] == null ? null : map['imageUri'] as String,
      tpuTfVersion: map['tpuTfVersion'] == null ? null : map['tpuTfVersion'] as String,
    );
  }
}
