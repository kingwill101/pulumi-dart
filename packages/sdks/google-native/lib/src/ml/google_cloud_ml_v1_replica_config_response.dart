...
class GoogleCloudMlV1ReplicaConfigResponse {
  ...
  factory GoogleCloudMlV1ReplicaConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudMlV1ReplicaConfigResponse(
      ...
      containerArgs: ((map['containerArgs'] as List).cast<String>()).input(),
      containerCommand: ((map['containerCommand'] as List).cast<String>()).input(),
      diskConfig: (GoogleCloudMlV1DiskConfigResponse.fromMap((map['diskConfig'] as Map).cast<String, dynamic>())).input(),
      imageUri: (map['imageUri'] as String).input(),
      tpuTfVersion: (map['tpuTfVersion'] as String).input(),
    );
  }
}
