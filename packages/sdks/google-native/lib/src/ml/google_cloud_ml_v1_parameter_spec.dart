...
class GoogleCloudMlV1ParameterSpec {
    ...
    return <String, dynamic>{
      ...
      'scaleType':
          ?pulumi.Input.mapOptionalInputValue<
            GoogleCloudMlV1ParameterSpecScaleType,
            String
          >(scaleType, (value) => value.wireValue),
      'type':
          pulumi.Input.mapInputValue<GoogleCloudMlV1ParameterSpecType, String>(
            type,
  ...
  factory GoogleCloudMlV1ParameterSpec.fromMap(Map<String, dynamic> map) {
    return GoogleCloudMlV1ParameterSpec(
      categoricalValues: (() {
        final guardedValue = map['categoricalValues'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      discreteValues: (() {
        final guardedValue = map['discreteValues'];
        if (guardedValue == null) return null;
      ...
      scaleType: (() {
        ...
        return pulumi.Input.fromValue(
          GoogleCloudMlV1ParameterSpecScaleType.fromValue(
            guardedValue as String,
          ),
        );
      })(),
      type: pulumi.Input.fromValue(
        GoogleCloudMlV1ParameterSpecType.fromValue(map['type']! as String),
      ),
    );
  }
}
