...
class VersionArgs {
  ...
  factory VersionArgs.fromMap(Map<String, dynamic> map) {
    return VersionArgs(
      ...
      autoScaling: map['autoScaling'] == null ? null : (GoogleCloudMlV1AutoScaling.fromMap((map['autoScaling']! as Map).cast<String, dynamic>())).input(),
      container: map['container'] == null ? null : (GoogleCloudMlV1ContainerSpec.fromMap((map['container']! as Map).cast<String, dynamic>())).input(),
      deploymentUri: map['deploymentUri'] == null ? null : (map['deploymentUri']! as String).input(),
      description: map['description'] == null ? null : (map['description']! as String).input(),
      etag: map['etag'] == null ? null : (map['etag']! as String).input(),
      explanationConfig: map['explanationConfig'] == null ? null : (GoogleCloudMlV1ExplanationConfig.fromMap((map['explanationConfig']! as Map).cast<String, dynamic>())).input(),
      framework: map['framework'] == null ? null : (VersionFramework.fromValue(map['framework']! as String)).input(),
      labels: map['labels'] == null ? null : ((map['labels']! as Map).cast<String, String>()).input(),
      machineType: map['machineType'] == null ? null : (map['machineType']! as String).input(),
      manualScaling: map['manualScaling'] == null ? null : (GoogleCloudMlV1ManualScaling.fromMap((map['manualScaling']! as Map).cast<String, dynamic>())).input(),
      modelId: (map['modelId'] as String).input(),
      name: map['name'] == null ? null : (map['name']! as String).input(),
      packageUris: map['packageUris'] == null ? null : ((map['packageUris']! as List).cast<String>()).input(),
      predictionClass: map['predictionClass'] == null ? null : (map['predictionClass']! as String).input(),
      project: map['project'] == null ? null : (map['project']! as String).input(),
      pythonVersion: (map['pythonVersion'] as String).input(),
      requestLoggingConfig: map['requestLoggingConfig'] == null ? null : (GoogleCloudMlV1RequestLoggingConfig.fromMap((map['requestLoggingConfig']! as Map).cast<String, dynamic>())).input(),
      routes: map['routes'] == null ? null : (GoogleCloudMlV1RouteMap.fromMap((map['routes']! as Map).cast<String, dynamic>())).input(),
