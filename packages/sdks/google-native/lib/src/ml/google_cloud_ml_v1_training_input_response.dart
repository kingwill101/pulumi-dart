...
class GoogleCloudMlV1TrainingInputResponse {
  ...
  factory GoogleCloudMlV1TrainingInputResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudMlV1TrainingInputResponse(
      ...
      encryptionConfig: (GoogleCloudMlV1EncryptionConfigResponse.fromMap((map['encryptionConfig'] as Map).cast<String, dynamic>())).input(),
      evaluatorConfig: (GoogleCloudMlV1ReplicaConfigResponse.fromMap((map['evaluatorConfig'] as Map).cast<String, dynamic>())).input(),
      evaluatorCount: (map['evaluatorCount'] as String).input(),
      evaluatorType: (map['evaluatorType'] as String).input(),
      hyperparameters: (GoogleCloudMlV1HyperparameterSpecResponse.fromMap((map['hyperparameters'] as Map).cast<String, dynamic>())).input(),
      jobDir: (map['jobDir'] as String).input(),
      masterConfig: (GoogleCloudMlV1ReplicaConfigResponse.fromMap((map['masterConfig'] as Map).cast<String, dynamic>())).input(),
      masterType: (map['masterType'] as String).input(),
      network: (map['network'] as String).input(),
      packageUris: ((map['packageUris'] as List).cast<String>()).input(),
      parameterServerConfig: (GoogleCloudMlV1ReplicaConfigResponse.fromMap((map['parameterServerConfig'] as Map).cast<String, dynamic>())).input(),
      parameterServerCount: (map['parameterServerCount'] as String).input(),
      parameterServerType: (map['parameterServerType'] as String).input(),
      ...
      scheduling: (GoogleCloudMlV1SchedulingResponse.fromMap((map['scheduling'] as Map).cast<String, dynamic>())).input(),
      serviceAccount: (map['serviceAccount'] as String).input(),
      useChiefInTfConfig: (map['useChiefInTfConfig'] as bool).input(),
      workerConfig: (GoogleCloudMlV1ReplicaConfigResponse.fromMap((map['workerConfig'] as Map).cast<String, dynamic>())).input(),
      workerCount: (map['workerCount'] as String).input(),
      workerType: (map['workerType'] as String).input(),
    );
  }
}
