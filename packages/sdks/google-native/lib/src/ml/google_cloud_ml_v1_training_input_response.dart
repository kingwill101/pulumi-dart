...
class GoogleCloudMlV1TrainingInputResponse {
  ...
  final pulumi.Input<GoogleCloudMlV1ReplicaConfigResponse>
    ...
    return <String, dynamic>{
      ...
      'evaluatorConfig':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(evaluatorConfig, (value) => value.toMap()),
      ...
      'hyperparameters':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(hyperparameters, (value) => value.toMap()),
      'jobDir': jobDir,
      'masterConfig':
          pulumi.Input.mapInputValue<
            GoogleCloudMlV1ReplicaConfigResponse,
      ...
      'parameterServerConfig':
          pulumi.Input.mapInputValue<
            GoogleCloudMlV1ReplicaConfigResponse,
            Map<String, dynamic>
          >(parameterServerConfig, (value) => value.toMap()),
      ...
      'scheduling':
          pulumi.Input.mapInputValue<
            GoogleCloudMlV1SchedulingResponse,
            Map<String, dynamic>
  ...
  factory GoogleCloudMlV1TrainingInputResponse.fromMap(
    ...
    return GoogleCloudMlV1TrainingInputResponse(
      ...
      encryptionConfig: pulumi.Input.fromValue(
        GoogleCloudMlV1EncryptionConfigResponse.fromMap(
          (map['encryptionConfig']! as Map).cast<String, dynamic>(),
        ),
      ),
      evaluatorConfig: pulumi.Input.fromValue(
        GoogleCloudMlV1ReplicaConfigResponse.fromMap(
      ...
      hyperparameters: pulumi.Input.fromValue(
        GoogleCloudMlV1HyperparameterSpecResponse.fromMap(
      ...
      parameterServerConfig: pulumi.Input.fromValue(
        GoogleCloudMlV1ReplicaConfigResponse.fromMap(
          (map['parameterServerConfig']! as Map).cast<String, dynamic>(),
        ),
      ),
      parameterServerCount: pulumi.Input.fromValue(
        map['parameterServerCount'] as String,
      ),
      parameterServerType: pulumi.Input.fromValue(
      ...
      scheduling: pulumi.Input.fromValue(
        GoogleCloudMlV1SchedulingResponse.fromMap(
          (map['scheduling']! as Map).cast<String, dynamic>(),
        ),
      ),
      serviceAccount: pulumi.Input.fromValue(map['serviceAccount'] as String),
      useChiefInTfConfig: pulumi.Input.fromValue(
