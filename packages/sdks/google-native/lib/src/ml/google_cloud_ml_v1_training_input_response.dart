...
class GoogleCloudMlV1TrainingInputResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'evaluatorConfig': evaluatorConfig.toMap(),
      'evaluatorCount': evaluatorCount,
      'evaluatorType': evaluatorType,
      'hyperparameters': hyperparameters.toMap(),
      'jobDir': jobDir,
      'masterConfig': masterConfig.toMap(),
      'masterType': masterType,
      'network': network,
      'packageUris': packageUris,
      'parameterServerConfig': parameterServerConfig.toMap(),
  ...
  factory GoogleCloudMlV1TrainingInputResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudMlV1TrainingInputResponse(
      ...
      encryptionConfig: GoogleCloudMlV1EncryptionConfigResponse.fromMap((map['encryptionConfig'] as Map).cast<String, dynamic>()),
      evaluatorConfig: GoogleCloudMlV1ReplicaConfigResponse.fromMap((map['evaluatorConfig'] as Map).cast<String, dynamic>()),
      evaluatorCount: map['evaluatorCount'] as String,
      evaluatorType: map['evaluatorType'] as String,
      hyperparameters: GoogleCloudMlV1HyperparameterSpecResponse.fromMap((map['hyperparameters'] as Map).cast<String, dynamic>()),
      jobDir: map['jobDir'] as String,
      masterConfig: GoogleCloudMlV1ReplicaConfigResponse.fromMap((map['masterConfig'] as Map).cast<String, dynamic>()),
      masterType: map['masterType'] as String,
      network: map['network'] as String,
      packageUris: (map['packageUris'] as List).cast<String>(),
      parameterServerConfig: GoogleCloudMlV1ReplicaConfigResponse.fromMap((map['parameterServerConfig'] as Map).cast<String, dynamic>()),
      ...
      scheduling: GoogleCloudMlV1SchedulingResponse.fromMap((map['scheduling'] as Map).cast<String, dynamic>()),
      serviceAccount: map['serviceAccount'] as String,
      useChiefInTfConfig: map['useChiefInTfConfig'] as bool,
      workerConfig: GoogleCloudMlV1ReplicaConfigResponse.fromMap((map['workerConfig'] as Map).cast<String, dynamic>()),
