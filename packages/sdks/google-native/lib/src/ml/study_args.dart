...
class StudyArgs {
  ...
  StudyArgs({
    ...
    required pulumi.Output<GoogleCloudMlV1StudyConfig> studyConfig,
  ...
  factory StudyArgs.fromMap(Map<String, dynamic> map) {
    return StudyArgs(
      ...
      studyConfig: pulumi.Output.create<GoogleCloudMlV1StudyConfig>(GoogleCloudMlV1StudyConfig.fromMap((map['studyConfig'] as Map).cast<String, dynamic>())),
