...
class GoogleCloudMlV1AutoScalingResponse {
  ...
  factory GoogleCloudMlV1AutoScalingResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudMlV1AutoScalingResponse(
      ...
      metrics: (pulumi.Input.decodeList<GoogleCloudMlV1MetricSpecResponse>(map['metrics'], (value) => GoogleCloudMlV1MetricSpecResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
