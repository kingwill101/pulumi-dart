...
class GoogleCloudMlV1AutoScalingResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'maxNodes': maxNodes,
      'metrics': pulumi.Input.encodeList<GoogleCloudMlV1MetricSpecResponse, Map<String, dynamic>>(metrics, (value) => value.toMap()),
      'minNodes': minNodes,
    };
  }
  ...
  factory GoogleCloudMlV1AutoScalingResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudMlV1AutoScalingResponse(
      ...
      metrics: pulumi.Input.decodeList<GoogleCloudMlV1MetricSpecResponse>(map['metrics'], (value) => GoogleCloudMlV1MetricSpecResponse.fromMap((value as Map).cast<String, dynamic>())),
