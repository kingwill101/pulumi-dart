...
class GoogleCloudMlV1AutoScalingResponse {
  ...
  final pulumi.Input<List<GoogleCloudMlV1MetricSpecResponse>> metrics;
  ...
  /// Creates a new [GoogleCloudMlV1AutoScalingResponse].
  ...
  const GoogleCloudMlV1AutoScalingResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'maxNodes': maxNodes,
      'metrics': pulumi.Input.mapInputValue<List<GoogleCloudMlV1MetricSpecResponse>, List<Map<String, dynamic>>>(metrics, (value) => pulumi.Input.encodeList<GoogleCloudMlV1MetricSpecResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'minNodes': minNodes,
    };
  }
  ...
  factory GoogleCloudMlV1AutoScalingResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudMlV1AutoScalingResponse(
      ...
      metrics: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudMlV1MetricSpecResponse>(map['metrics']!, (value) => GoogleCloudMlV1MetricSpecResponse.fromMap((value as Map).cast<String, dynamic>()))),
