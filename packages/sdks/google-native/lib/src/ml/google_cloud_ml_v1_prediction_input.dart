...
class GoogleCloudMlV1PredictionInput {
  ...
  final pulumi.Input<GoogleCloudMlV1PredictionInputOutputDataFormat>?
  outputDataFormat;
    ...
    return <String, dynamic>{
      ...
      'dataFormat':
          pulumi.Input.mapInputValue<
            GoogleCloudMlV1PredictionInputDataFormat,
            String
      ...
      'outputDataFormat':
          ?pulumi.Input.mapOptionalInputValue<
            GoogleCloudMlV1PredictionInputOutputDataFormat,
            String
          >(outputDataFormat, (value) => value.wireValue),
  ...
  factory GoogleCloudMlV1PredictionInput.fromMap(Map<String, dynamic> map) {
    return GoogleCloudMlV1PredictionInput(
      ...
      dataFormat: pulumi.Input.fromValue(
        GoogleCloudMlV1PredictionInputDataFormat.fromValue(
      ...
      maxWorkerCount: (() {
        final guardedValue = map['maxWorkerCount'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      modelName: (() {
      ...
      outputDataFormat: (() {
        final guardedValue = map['outputDataFormat'];
        if (guardedValue == null) return null;
      ...
      signatureName: (() {
        final guardedValue = map['signatureName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      uri: (() {
