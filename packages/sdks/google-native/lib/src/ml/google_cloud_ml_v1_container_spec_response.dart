...
class GoogleCloudMlV1ContainerSpecResponse {
  ...
  final pulumi.Input<List<GoogleCloudMlV1EnvVarResponse>> env;
  ...
  final pulumi.Input<List<GoogleCloudMlV1ContainerPortResponse>> ports;

  /// Creates a new [GoogleCloudMlV1ContainerSpecResponse].
    ...
    return <String, dynamic>{
      ...
      'env':
          pulumi.Input.mapInputValue<
            List<GoogleCloudMlV1EnvVarResponse>,
      ...
      'ports':
          pulumi.Input.mapInputValue<
            List<GoogleCloudMlV1ContainerPortResponse>,
            List<Map<String, dynamic>>
          >(
            ports,
            (value) =>
  ...
  factory GoogleCloudMlV1ContainerSpecResponse.fromMap(
    ...
    return GoogleCloudMlV1ContainerSpecResponse(
      ...
      env: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GoogleCloudMlV1EnvVarResponse>(
          map['env']!,
      ...
      ports: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GoogleCloudMlV1ContainerPortResponse>(
          map['ports']!,
