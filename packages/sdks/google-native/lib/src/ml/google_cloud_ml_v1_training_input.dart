...
class GoogleCloudMlV1TrainingInput {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'evaluatorConfig': ?evaluatorConfig == null ? null : evaluatorConfig!.toMap(),
      'evaluatorCount': ?evaluatorCount,
      'evaluatorType': ?evaluatorType,
      'hyperparameters': ?hyperparameters == null ? null : hyperparameters!.toMap(),
      'jobDir': ?jobDir,
      'masterConfig': ?masterConfig == null ? null : masterConfig!.toMap(),
      'masterType': ?masterType,
      'network': ?network,
      'packageUris': packageUris,
      'parameterServerConfig': ?parameterServerConfig == null ? null : parameterServerConfig!.toMap(),
  ...
  factory GoogleCloudMlV1TrainingInput.fromMap(Map<String, dynamic> map) {
    return GoogleCloudMlV1TrainingInput(
      ...
      encryptionConfig: map['encryptionConfig'] == null ? null : GoogleCloudMlV1EncryptionConfig.fromMap((map['encryptionConfig'] as Map).cast<String, dynamic>()),
      evaluatorConfig: map['evaluatorConfig'] == null ? null : GoogleCloudMlV1ReplicaConfig.fromMap((map['evaluatorConfig'] as Map).cast<String, dynamic>()),
      evaluatorCount: map['evaluatorCount'] == null ? null : map['evaluatorCount'] as String,
      evaluatorType: map['evaluatorType'] == null ? null : map['evaluatorType'] as String,
      hyperparameters: map['hyperparameters'] == null ? null : GoogleCloudMlV1HyperparameterSpec.fromMap((map['hyperparameters'] as Map).cast<String, dynamic>()),
      jobDir: map['jobDir'] == null ? null : map['jobDir'] as String,
      masterConfig: map['masterConfig'] == null ? null : GoogleCloudMlV1ReplicaConfig.fromMap((map['masterConfig'] as Map).cast<String, dynamic>()),
      masterType: map['masterType'] == null ? null : map['masterType'] as String,
      network: map['network'] == null ? null : map['network'] as String,
      packageUris: (map['packageUris'] as List).cast<String>(),
      parameterServerConfig: map['parameterServerConfig'] == null ? null : GoogleCloudMlV1ReplicaConfig.fromMap((map['parameterServerConfig'] as Map).cast<String, dynamic>()),
      parameterServerCount: map['parameterServerCount'] == null ? null : map['parameterServerCount'] as String,
      parameterServerType: map['parameterServerType'] == null ? null : map['parameterServerType'] as String,
      ...
      scaleTier: GoogleCloudMlV1TrainingInputScaleTier.fromValue(map['scaleTier'] as String),
      scheduling: map['scheduling'] == null ? null : GoogleCloudMlV1Scheduling.fromMap((map['scheduling'] as Map).cast<String, dynamic>()),
      serviceAccount: map['serviceAccount'] == null ? null : map['serviceAccount'] as String,
      useChiefInTfConfig: map['useChiefInTfConfig'] == null ? null : map['useChiefInTfConfig'] as bool,
      workerConfig: map['workerConfig'] == null ? null : GoogleCloudMlV1ReplicaConfig.fromMap((map['workerConfig'] as Map).cast<String, dynamic>()),
