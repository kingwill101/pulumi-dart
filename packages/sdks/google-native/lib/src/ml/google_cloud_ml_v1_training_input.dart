...
class GoogleCloudMlV1TrainingInput {
    ...
    return <String, dynamic>{
      ...
      'scaleTier':
          pulumi.Input.mapInputValue<
            GoogleCloudMlV1TrainingInputScaleTier,
            String
          >(scaleTier, (value) => value.wireValue),
      'scheduling':
          ?pulumi.Input.mapOptionalInputValue<
  ...
  factory GoogleCloudMlV1TrainingInput.fromMap(Map<String, dynamic> map) {
    return GoogleCloudMlV1TrainingInput(
      ...
      enableWebAccess: (() {
        final guardedValue = map['enableWebAccess'];
        if (guardedValue == null) return null;
      ...
      evaluatorConfig: (() {
        final guardedValue = map['evaluatorConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      evaluatorCount: (() {
        final guardedValue = map['evaluatorCount'];
        if (guardedValue == null) return null;
      ...
      parameterServerConfig: (() {
        final guardedValue = map['parameterServerConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GoogleCloudMlV1ReplicaConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
      ...
      parameterServerType: (() {
        final guardedValue = map['parameterServerType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ...
      scaleTier: pulumi.Input.fromValue(
        GoogleCloudMlV1TrainingInputScaleTier.fromValue(
      ...
      useChiefInTfConfig: (() {
        final guardedValue = map['useChiefInTfConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      workerConfig: (() {
