...
class GoogleCloudMlV1TrainingInput {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'scaleTier': pulumi.Input.mapInputValue<GoogleCloudMlV1TrainingInputScaleTier, String>(scaleTier, (value) => value.value),
  ...
  factory GoogleCloudMlV1TrainingInput.fromMap(Map<String, dynamic> map) {
    return GoogleCloudMlV1TrainingInput(
      ...
      encryptionConfig: map['encryptionConfig'] == null ? null : (GoogleCloudMlV1EncryptionConfig.fromMap((map['encryptionConfig'] as Map).cast<String, dynamic>())).input(),
      evaluatorConfig: map['evaluatorConfig'] == null ? null : (GoogleCloudMlV1ReplicaConfig.fromMap((map['evaluatorConfig'] as Map).cast<String, dynamic>())).input(),
      evaluatorCount: map['evaluatorCount'] == null ? null : (map['evaluatorCount'] as String).input(),
      evaluatorType: map['evaluatorType'] == null ? null : (map['evaluatorType'] as String).input(),
      hyperparameters: map['hyperparameters'] == null ? null : (GoogleCloudMlV1HyperparameterSpec.fromMap((map['hyperparameters'] as Map).cast<String, dynamic>())).input(),
      jobDir: map['jobDir'] == null ? null : (map['jobDir'] as String).input(),
      masterConfig: map['masterConfig'] == null ? null : (GoogleCloudMlV1ReplicaConfig.fromMap((map['masterConfig'] as Map).cast<String, dynamic>())).input(),
      ...
      parameterServerConfig: map['parameterServerConfig'] == null ? null : (GoogleCloudMlV1ReplicaConfig.fromMap((map['parameterServerConfig'] as Map).cast<String, dynamic>())).input(),
      parameterServerCount: map['parameterServerCount'] == null ? null : (map['parameterServerCount'] as String).input(),
      parameterServerType: map['parameterServerType'] == null ? null : (map['parameterServerType'] as String).input(),
      ...
      scaleTier: (GoogleCloudMlV1TrainingInputScaleTier.fromValue(map['scaleTier'] as String)).input(),
      scheduling: map['scheduling'] == null ? null : (GoogleCloudMlV1Scheduling.fromMap((map['scheduling'] as Map).cast<String, dynamic>())).input(),
      serviceAccount: map['serviceAccount'] == null ? null : (map['serviceAccount'] as String).input(),
      useChiefInTfConfig: map['useChiefInTfConfig'] == null ? null : (map['useChiefInTfConfig'] as bool).input(),
      workerConfig: map['workerConfig'] == null ? null : (GoogleCloudMlV1ReplicaConfig.fromMap((map['workerConfig'] as Map).cast<String, dynamic>())).input(),
