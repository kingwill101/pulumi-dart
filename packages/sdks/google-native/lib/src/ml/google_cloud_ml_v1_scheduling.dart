...
class GoogleCloudMlV1Scheduling {
  ...
  final pulumi.Input<String>? maxRunningTime;
  ...
  final pulumi.Input<String>? maxWaitTime;
  ...
  /// Creates a new [GoogleCloudMlV1Scheduling].
  ...
  const GoogleCloudMlV1Scheduling({
    this.maxRunningTime,
    this.maxWaitTime,
    this.priority,
  });
  ...
  factory GoogleCloudMlV1Scheduling.fromMap(Map<String, dynamic> map) {
    return GoogleCloudMlV1Scheduling(
      maxRunningTime: (() { final guardedValue = map['maxRunningTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      maxWaitTime: (() { final guardedValue = map['maxWaitTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
