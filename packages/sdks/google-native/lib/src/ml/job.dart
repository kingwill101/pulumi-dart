...
class Job extends pulumi.CustomResource {
  ...
  Job(
    ...
    this.predictionInput = registerOutput<GoogleCloudMlV1PredictionInputResponse>('predictionInput');
    this.predictionOutput = registerOutput<GoogleCloudMlV1PredictionOutputResponse>('predictionOutput');
    this.project = registerOutput<String>('project');
    this.startTime = registerOutput<String>('startTime');
    this.state = registerOutput<String>('state');
    this.trainingInput = registerOutput<GoogleCloudMlV1TrainingInputResponse>('trainingInput');
    this.trainingOutput = registerOutput<GoogleCloudMlV1TrainingOutputResponse>('trainingOutput');
  }
}
