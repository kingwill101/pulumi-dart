...
class GoogleCloudMlV1HyperparameterOutput {
  ...
  factory GoogleCloudMlV1HyperparameterOutput.fromMap(Map<String, dynamic> map) {
    return GoogleCloudMlV1HyperparameterOutput(
      allMetrics: (() { final guardedValue = map['allMetrics']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudMlV1HyperparameterOutputHyperparameterMetric>(guardedValue, (value) => GoogleCloudMlV1HyperparameterOutputHyperparameterMetric.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      finalMetric: (() { final guardedValue = map['finalMetric']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudMlV1HyperparameterOutputHyperparameterMetric.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      isTrialStoppedEarly: (() { final guardedValue = map['isTrialStoppedEarly']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      trialId: (() { final guardedValue = map['trialId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      webAccessUris: (() { final guardedValue = map['webAccessUris']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
    );
  }
}
