...
class GoogleCloudMlV1TrainingOutput {
  ...
  factory GoogleCloudMlV1TrainingOutput.fromMap(Map<String, dynamic> map) {
    return GoogleCloudMlV1TrainingOutput(
      ...
      completedTrialCount: (() {
        final guardedValue = map['completedTrialCount'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      consumedMLUnits: (() {
        final guardedValue = map['consumedMLUnits'];
        if (guardedValue == null) return null;
      ...
      isBuiltInAlgorithmJob: (() {
        final guardedValue = map['isBuiltInAlgorithmJob'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      isHyperparameterTuningJob: (() {
        final guardedValue = map['isHyperparameterTuningJob'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      trials: (() {
        final guardedValue = map['trials'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
