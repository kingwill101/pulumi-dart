...
class GoogleCloudMlV1HyperparameterOutputResponse {
  ...
  final List<GoogleCloudMlV1HyperparameterOutputHyperparameterMetricResponse> allMetrics;
  ...
  final GoogleCloudMlV1HyperparameterOutputHyperparameterMetricResponse finalMetric;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'allMetrics': pulumi.Input.encodeList<GoogleCloudMlV1HyperparameterOutputHyperparameterMetricResponse, Map<String, dynamic>>(allMetrics, (value) => value.toMap()),
      'builtInAlgorithmOutput': builtInAlgorithmOutput.toMap(),
      'endTime': endTime,
      'finalMetric': finalMetric.toMap(),
  ...
  factory GoogleCloudMlV1HyperparameterOutputResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudMlV1HyperparameterOutputResponse(
      allMetrics: pulumi.Input.decodeList<GoogleCloudMlV1HyperparameterOutputHyperparameterMetricResponse>(map['allMetrics'], (value) => GoogleCloudMlV1HyperparameterOutputHyperparameterMetricResponse.fromMap((value as Map).cast<String, dynamic>())),
      ...
      finalMetric: GoogleCloudMlV1HyperparameterOutputHyperparameterMetricResponse.fromMap((map['finalMetric'] as Map).cast<String, dynamic>()),
