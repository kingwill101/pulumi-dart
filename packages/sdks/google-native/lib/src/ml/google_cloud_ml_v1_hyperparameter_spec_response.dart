...
class GoogleCloudMlV1HyperparameterSpecResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'maxTrials': maxTrials,
      'params': pulumi.Input.encodeList<GoogleCloudMlV1ParameterSpecResponse, Map<String, dynamic>>(params, (value) => value.toMap()),
  ...
  factory GoogleCloudMlV1HyperparameterSpecResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudMlV1HyperparameterSpecResponse(
      ...
      params: pulumi.Input.decodeList<GoogleCloudMlV1ParameterSpecResponse>(map['params'], (value) => GoogleCloudMlV1ParameterSpecResponse.fromMap((value as Map).cast<String, dynamic>())),
