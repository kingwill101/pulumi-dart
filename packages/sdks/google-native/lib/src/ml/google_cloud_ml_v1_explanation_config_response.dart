...
class GoogleCloudMlV1ExplanationConfigResponse {
  ...
  factory GoogleCloudMlV1ExplanationConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudMlV1ExplanationConfigResponse(
      integratedGradientsAttribution: (GoogleCloudMlV1IntegratedGradientsAttributionResponse.fromMap((map['integratedGradientsAttribution'] as Map).cast<String, dynamic>())).input(),
      sampledShapleyAttribution: (GoogleCloudMlV1SampledShapleyAttributionResponse.fromMap((map['sampledShapleyAttribution'] as Map).cast<String, dynamic>())).input(),
      xraiAttribution: (GoogleCloudMlV1XraiAttributionResponse.fromMap((map['xraiAttribution'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
