...
class GoogleCloudMlV1ExplanationConfigResponse {
  ...
  final pulumi.Input<GoogleCloudMlV1IntegratedGradientsAttributionResponse> integratedGradientsAttribution;
  /// An attribution method that approximates Shapley values for features that contribute to the label being predicted. A sampling strategy is used to approximate the value rather than considering all subsets of features.
  final pulumi.Input<GoogleCloudMlV1SampledShapleyAttributionResponse> sampledShapleyAttribution;
  ...
  const GoogleCloudMlV1ExplanationConfigResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'integratedGradientsAttribution': pulumi.Input.mapInputValue<GoogleCloudMlV1IntegratedGradientsAttributionResponse, Map<String, dynamic>>(integratedGradientsAttribution, (value) => value.toMap()),
      'sampledShapleyAttribution': pulumi.Input.mapInputValue<GoogleCloudMlV1SampledShapleyAttributionResponse, Map<String, dynamic>>(sampledShapleyAttribution, (value) => value.toMap()),
      'xraiAttribution': pulumi.Input.mapInputValue<GoogleCloudMlV1XraiAttributionResponse, Map<String, dynamic>>(xraiAttribution, (value) => value.toMap()),
    };
  }
  ...
  factory GoogleCloudMlV1ExplanationConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudMlV1ExplanationConfigResponse(
      integratedGradientsAttribution: pulumi.Input.fromValue(GoogleCloudMlV1IntegratedGradientsAttributionResponse.fromMap((map['integratedGradientsAttribution']! as Map).cast<String, dynamic>())),
      sampledShapleyAttribution: pulumi.Input.fromValue(GoogleCloudMlV1SampledShapleyAttributionResponse.fromMap((map['sampledShapleyAttribution']! as Map).cast<String, dynamic>())),
      xraiAttribution: pulumi.Input.fromValue(GoogleCloudMlV1XraiAttributionResponse.fromMap((map['xraiAttribution']! as Map).cast<String, dynamic>())),
    );
  }
}
