...
class GoogleCloudMlV1MeasurementResponse {
  ...
  factory GoogleCloudMlV1MeasurementResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudMlV1MeasurementResponse(
      ...
      metrics: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudMlV1MeasurementMetricResponse>(map['metrics']!, (value) => GoogleCloudMlV1MeasurementMetricResponse.fromMap((value as Map).cast<String, dynamic>()))),
