...
class GoogleCloudMlV1StudyConfigParameterSpecResponse {
  ...
  factory GoogleCloudMlV1StudyConfigParameterSpecResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudMlV1StudyConfigParameterSpecResponse(
      categoricalValueSpec: pulumi.Input.fromValue(GoogleCloudMlV1StudyConfigParameterSpecCategoricalValueSpecResponse.fromMap((map['categoricalValueSpec']! as Map).cast<String, dynamic>())),
      childParameterSpecs: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudMlV1StudyConfigParameterSpecResponse>(map['childParameterSpecs']!, (value) => GoogleCloudMlV1StudyConfigParameterSpecResponse.fromMap((value as Map).cast<String, dynamic>()))),
      discreteValueSpec: pulumi.Input.fromValue(GoogleCloudMlV1StudyConfigParameterSpecDiscreteValueSpecResponse.fromMap((map['discreteValueSpec']! as Map).cast<String, dynamic>())),
      doubleValueSpec: pulumi.Input.fromValue(GoogleCloudMlV1StudyConfigParameterSpecDoubleValueSpecResponse.fromMap((map['doubleValueSpec']! as Map).cast<String, dynamic>())),
      integerValueSpec: pulumi.Input.fromValue(GoogleCloudMlV1StudyConfigParameterSpecIntegerValueSpecResponse.fromMap((map['integerValueSpec']! as Map).cast<String, dynamic>())),
      parameter: pulumi.Input.fromValue(map['parameter'] as String),
      parentCategoricalValues: pulumi.Input.fromValue(GoogleCloudMlV1StudyConfigParameterSpecMatchingParentCategoricalValueSpecResponse.fromMap((map['parentCategoricalValues']! as Map).cast<String, dynamic>())),
      parentDiscreteValues: pulumi.Input.fromValue(GoogleCloudMlV1StudyConfigParameterSpecMatchingParentDiscreteValueSpecResponse.fromMap((map['parentDiscreteValues']! as Map).cast<String, dynamic>())),
      parentIntValues: pulumi.Input.fromValue(GoogleCloudMlV1StudyConfigParameterSpecMatchingParentIntValueSpecResponse.fromMap((map['parentIntValues']! as Map).cast<String, dynamic>())),
