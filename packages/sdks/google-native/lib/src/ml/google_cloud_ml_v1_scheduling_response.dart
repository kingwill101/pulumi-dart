...
class GoogleCloudMlV1SchedulingResponse {
  ...
  /// Creates a new [GoogleCloudMlV1SchedulingResponse].
  ...
  const GoogleCloudMlV1SchedulingResponse({
  ...
  factory GoogleCloudMlV1SchedulingResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudMlV1SchedulingResponse(
      maxRunningTime: pulumi.Input.fromValue(map['maxRunningTime'] as String),
      maxWaitTime: pulumi.Input.fromValue(map['maxWaitTime'] as String),
