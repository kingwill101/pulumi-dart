...
class GoogleCloudMlV1StudyConfig {
  ...
  final pulumi.Input<GoogleCloudMlV1AutomatedStoppingConfig>?
    ...
    return <String, dynamic>{
      'algorithm':
          ?pulumi.Input.mapOptionalInputValue<
            GoogleCloudMlV1StudyConfigAlgorithm,
            String
    ...
    return GoogleCloudMlV1StudyConfig(
      algorithm: (() {
        ...
        return pulumi.Input.fromValue(
          GoogleCloudMlV1StudyConfigAlgorithm.fromValue(guardedValue as String),
        );
      })(),
      automatedStoppingConfig: (() {
        final guardedValue = map['automatedStoppingConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
