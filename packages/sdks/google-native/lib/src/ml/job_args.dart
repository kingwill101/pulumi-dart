...
class JobArgs {
  ...
  factory JobArgs.fromMap(Map<String, dynamic> map) {
    return JobArgs(
      ...
      predictionInput: (() {
        final guardedValue = map['predictionInput'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      predictionOutput: (() {
        final guardedValue = map['predictionOutput'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      trainingInput: (() {
        final guardedValue = map['trainingInput'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      trainingOutput: (() {
        final guardedValue = map['trainingOutput'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
