...
class TrialArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'project': ?project,
      'state': ?pulumi.Input.mapOptionalInputValue<TrialState, String>(
        state,
  ...
  factory TrialArgs.fromMap(Map<String, dynamic> map) {
    return TrialArgs(
      finalMeasurement: (() {
        final guardedValue = map['finalMeasurement'];
      ...
      measurements: (() {
        final guardedValue = map['measurements'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      state: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TrialState.fromValue(guardedValue as String),
        );
      })(),
