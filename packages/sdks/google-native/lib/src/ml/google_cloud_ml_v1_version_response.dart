...
class GoogleCloudMlV1VersionResponse {
  ...
  factory GoogleCloudMlV1VersionResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudMlV1VersionResponse(
      ...
      autoScaling: pulumi.Input.fromValue(GoogleCloudMlV1AutoScalingResponse.fromMap((map['autoScaling']! as Map).cast<String, dynamic>())),
      container: pulumi.Input.fromValue(GoogleCloudMlV1ContainerSpecResponse.fromMap((map['container']! as Map).cast<String, dynamic>())),
      ...
      explanationConfig: pulumi.Input.fromValue(GoogleCloudMlV1ExplanationConfigResponse.fromMap((map['explanationConfig']! as Map).cast<String, dynamic>())),
      ...
      lastMigrationModelId: pulumi.Input.fromValue(map['lastMigrationModelId'] as String),
      ...
      manualScaling: pulumi.Input.fromValue(GoogleCloudMlV1ManualScalingResponse.fromMap((map['manualScaling']! as Map).cast<String, dynamic>())),
      ...
      requestLoggingConfig: pulumi.Input.fromValue(GoogleCloudMlV1RequestLoggingConfigResponse.fromMap((map['requestLoggingConfig']! as Map).cast<String, dynamic>())),
      routes: pulumi.Input.fromValue(GoogleCloudMlV1RouteMapResponse.fromMap((map['routes']! as Map).cast<String, dynamic>())),
