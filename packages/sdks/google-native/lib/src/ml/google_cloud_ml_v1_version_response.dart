...
class GoogleCloudMlV1VersionResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'requestLoggingConfig': requestLoggingConfig.toMap(),
      'routes': routes.toMap(),
  ...
  factory GoogleCloudMlV1VersionResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudMlV1VersionResponse(
      ...
      autoScaling: GoogleCloudMlV1AutoScalingResponse.fromMap((map['autoScaling'] as Map).cast<String, dynamic>()),
      container: GoogleCloudMlV1ContainerSpecResponse.fromMap((map['container'] as Map).cast<String, dynamic>()),
      createTime: map['createTime'] as String,
      deploymentUri: map['deploymentUri'] as String,
      description: map['description'] as String,
      errorMessage: map['errorMessage'] as String,
      etag: map['etag'] as String,
      explanationConfig: GoogleCloudMlV1ExplanationConfigResponse.fromMap((map['explanationConfig'] as Map).cast<String, dynamic>()),
      ...
      manualScaling: GoogleCloudMlV1ManualScalingResponse.fromMap((map['manualScaling'] as Map).cast<String, dynamic>()),
      ...
      requestLoggingConfig: GoogleCloudMlV1RequestLoggingConfigResponse.fromMap((map['requestLoggingConfig'] as Map).cast<String, dynamic>()),
      routes: GoogleCloudMlV1RouteMapResponse.fromMap((map['routes'] as Map).cast<String, dynamic>()),
