...
class GoogleCloudMlV1VersionResponse {
  ...
  final pulumi.Input<GoogleCloudMlV1ExplanationConfigResponse> explanationConfig;
  ...
  final pulumi.Input<GoogleCloudMlV1RequestLoggingConfigResponse> requestLoggingConfig;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'autoScaling': pulumi.Input.mapInputValue<GoogleCloudMlV1AutoScalingResponse, Map<String, dynamic>>(autoScaling, (value) => value.toMap()),
      'container': pulumi.Input.mapInputValue<GoogleCloudMlV1ContainerSpecResponse, Map<String, dynamic>>(container, (value) => value.toMap()),
      'createTime': createTime,
      'deploymentUri': deploymentUri,
      'description': description,
      'errorMessage': errorMessage,
      'etag': etag,
      'explanationConfig': pulumi.Input.mapInputValue<GoogleCloudMlV1ExplanationConfigResponse, Map<String, dynamic>>(explanationConfig, (value) => value.toMap()),
      'framework': framework,
      'isDefault': isDefault,
      'labels': labels,
      ...
      'manualScaling': pulumi.Input.mapInputValue<GoogleCloudMlV1ManualScalingResponse, Map<String, dynamic>>(manualScaling, (value) => value.toMap()),
      'name': name,
      'packageUris': packageUris,
      'predictionClass': predictionClass,
      'pythonVersion': pythonVersion,
      'requestLoggingConfig': pulumi.Input.mapInputValue<GoogleCloudMlV1RequestLoggingConfigResponse, Map<String, dynamic>>(requestLoggingConfig, (value) => value.toMap()),
      'routes': pulumi.Input.mapInputValue<GoogleCloudMlV1RouteMapResponse, Map<String, dynamic>>(routes, (value) => value.toMap()),
  ...
  factory GoogleCloudMlV1VersionResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudMlV1VersionResponse(
      acceleratorConfig: (GoogleCloudMlV1AcceleratorConfigResponse.fromMap((map['acceleratorConfig'] as Map).cast<String, dynamic>())).input(),
      autoScaling: (GoogleCloudMlV1AutoScalingResponse.fromMap((map['autoScaling'] as Map).cast<String, dynamic>())).input(),
      container: (GoogleCloudMlV1ContainerSpecResponse.fromMap((map['container'] as Map).cast<String, dynamic>())).input(),
      createTime: (map['createTime'] as String).input(),
      deploymentUri: (map['deploymentUri'] as String).input(),
      description: (map['description'] as String).input(),
      errorMessage: (map['errorMessage'] as String).input(),
      etag: (map['etag'] as String).input(),
      explanationConfig: (GoogleCloudMlV1ExplanationConfigResponse.fromMap((map['explanationConfig'] as Map).cast<String, dynamic>())).input(),
      framework: (map['framework'] as String).input(),
      isDefault: (map['isDefault'] as bool).input(),
      labels: ((map['labels'] as Map).cast<String, String>()).input(),
      lastMigrationModelId: (map['lastMigrationModelId'] as String).input(),
      lastMigrationTime: (map['lastMigrationTime'] as String).input(),
      lastUseTime: (map['lastUseTime'] as String).input(),
      machineType: (map['machineType'] as String).input(),
      manualScaling: (GoogleCloudMlV1ManualScalingResponse.fromMap((map['manualScaling'] as Map).cast<String, dynamic>())).input(),
      name: (map['name'] as String).input(),
      packageUris: ((map['packageUris'] as List).cast<String>()).input(),
      predictionClass: (map['predictionClass'] as String).input(),
      pythonVersion: (map['pythonVersion'] as String).input(),
      requestLoggingConfig: (GoogleCloudMlV1RequestLoggingConfigResponse.fromMap((map['requestLoggingConfig'] as Map).cast<String, dynamic>())).input(),
      routes: (GoogleCloudMlV1RouteMapResponse.fromMap((map['routes'] as Map).cast<String, dynamic>())).input(),
