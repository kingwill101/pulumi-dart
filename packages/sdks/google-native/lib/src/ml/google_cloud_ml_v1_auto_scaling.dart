...
class GoogleCloudMlV1AutoScaling {
  ...
  final List<GoogleCloudMlV1MetricSpec>? metrics;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'maxNodes': ?maxNodes,
      'metrics': ?metrics == null ? null : pulumi.Input.encodeList<GoogleCloudMlV1MetricSpec, Map<String, dynamic>>(metrics!, (value) => value.toMap()),
      'minNodes': ?minNodes,
    };
  }
  ...
  factory GoogleCloudMlV1AutoScaling.fromMap(Map<String, dynamic> map) {
    return GoogleCloudMlV1AutoScaling(
      ...
      metrics: map['metrics'] == null ? null : pulumi.Input.decodeList<GoogleCloudMlV1MetricSpec>(map['metrics'], (value) => GoogleCloudMlV1MetricSpec.fromMap((value as Map).cast<String, dynamic>())),
