...
class GoogleCloudMlV1AutoScaling {
  ...
  const GoogleCloudMlV1AutoScaling({
    this.maxNodes,
    this.metrics,
    this.minNodes,
  });
  ...
  factory GoogleCloudMlV1AutoScaling.fromMap(Map<String, dynamic> map) {
    return GoogleCloudMlV1AutoScaling(
      ...
      metrics: (() { final guardedValue = map['metrics']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudMlV1MetricSpec>(guardedValue, (value) => GoogleCloudMlV1MetricSpec.fromMap((value as Map).cast<String, dynamic>()))); })(),
