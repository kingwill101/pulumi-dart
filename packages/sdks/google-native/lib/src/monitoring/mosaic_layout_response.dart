...
class MosaicLayoutResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'columns': columns,
      'tiles': pulumi.Input.mapInputValue<List<TileResponse>, List<Map<String, dynamic>>>(tiles, (value) => pulumi.Input.encodeList<TileResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory MosaicLayoutResponse.fromMap(Map<String, dynamic> map) {
    return MosaicLayoutResponse(
      columns: (map['columns'] as int).input(),
      tiles: (pulumi.Input.decodeList<TileResponse>(map['tiles'], (value) => TileResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
