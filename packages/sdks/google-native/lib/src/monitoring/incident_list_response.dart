...
class IncidentListResponse {
  ...
  factory IncidentListResponse.fromMap(Map<String, dynamic> map) {
    return IncidentListResponse(
      monitoredResources: pulumi.Input.fromValue(pulumi.Input.decodeList<MonitoredResourceResponse>(map['monitoredResources']!, (value) => MonitoredResourceResponse.fromMap((value as Map).cast<String, dynamic>()))),
