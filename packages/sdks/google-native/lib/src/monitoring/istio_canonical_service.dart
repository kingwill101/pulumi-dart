...
class IstioCanonicalService {
  ...
  factory IstioCanonicalService.fromMap(Map<String, dynamic> map) {
    return IstioCanonicalService(
      canonicalService: map['canonicalService'] == null ? null : map['canonicalService'] as String,
      canonicalServiceNamespace: map['canonicalServiceNamespace'] == null ? null : map['canonicalServiceNamespace'] as String,
