...
class IstioCanonicalService {
  ...
  factory IstioCanonicalService.fromMap(Map<String, dynamic> map) {
    return IstioCanonicalService(
      canonicalService: (() { final guardedValue = map['canonicalService']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      canonicalServiceNamespace: (() { final guardedValue = map['canonicalServiceNamespace']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
