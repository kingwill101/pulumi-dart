...
import 'aggregation_cross_series_reducer.dart';
import 'aggregation_per_series_aligner.dart';
...
class Aggregation {
  ...
  final pulumi.Input<AggregationCrossSeriesReducer>? crossSeriesReducer;
  ...
  final pulumi.Input<AggregationPerSeriesAligner>? perSeriesAligner;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'crossSeriesReducer': ?pulumi.Input.mapOptionalInputValue<AggregationCrossSeriesReducer, String>(crossSeriesReducer, (value) => value.wireValue),
      'groupByFields': ?groupByFields,
      'perSeriesAligner': ?pulumi.Input.mapOptionalInputValue<AggregationPerSeriesAligner, String>(perSeriesAligner, (value) => value.wireValue),
    };
  }
  ...
  factory Aggregation.fromMap(Map<String, dynamic> map) {
    return Aggregation(
      ...
      crossSeriesReducer: (() { final guardedValue = map['crossSeriesReducer']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AggregationCrossSeriesReducer.fromValue(guardedValue as String)); })(),
      ...
      perSeriesAligner: (() { final guardedValue = map['perSeriesAligner']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AggregationPerSeriesAligner.fromValue(guardedValue as String)); })(),
    );
  }
}
