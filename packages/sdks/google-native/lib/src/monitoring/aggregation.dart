...
class Aggregation {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'crossSeriesReducer': ?pulumi.Input.mapOptionalInputValue<AggregationCrossSeriesReducer, String>(crossSeriesReducer, (value) => value.value),
      'groupByFields': ?groupByFields,
      'perSeriesAligner': ?pulumi.Input.mapOptionalInputValue<AggregationPerSeriesAligner, String>(perSeriesAligner, (value) => value.value),
    };
  }
