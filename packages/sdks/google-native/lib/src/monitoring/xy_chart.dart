...
class XyChart {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'dataSets':
          pulumi.Input.mapInputValue<List<DataSet>, List<Map<String, dynamic>>>(
            dataSets,
            (value) => pulumi.Input.encodeList<DataSet, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
      'thresholds':
          ...
          >(
            thresholds,
            (value) => pulumi.Input.encodeList<Threshold, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
      'timeshiftDuration': ?timeshiftDuration,
      'xAxis': ?pulumi.Input.mapOptionalInputValue<Axis, Map<String, dynamic>>(
        xAxis,
        (value) => value.toMap(),
      ),
      'y2Axis': ?pulumi.Input.mapOptionalInputValue<Axis, Map<String, dynamic>>(
        y2Axis,
        (value) => value.toMap(),
      ),
      'yAxis': ?pulumi.Input.mapOptionalInputValue<Axis, Map<String, dynamic>>(
        yAxis,
        (value) => value.toMap(),
      ),
    };
  ...
  factory XyChart.fromMap(Map<String, dynamic> map) {
    return XyChart(
      chartOptions: (() {
        final guardedValue = map['chartOptions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ChartOptions.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      dataSets: pulumi.Input.fromValue(
        pulumi.Input.decodeList<DataSet>(
          map['dataSets']!,
      ...
      timeshiftDuration: (() {
        final guardedValue = map['timeshiftDuration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      xAxis: (() {
        final guardedValue = map['xAxis'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          Axis.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      y2Axis: (() {
        final guardedValue = map['y2Axis'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          Axis.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
