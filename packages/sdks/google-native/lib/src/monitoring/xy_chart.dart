...
class XyChart {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'dataSets': pulumi.Input.encodeList<DataSet, Map<String, dynamic>>(dataSets, (value) => value.toMap()),
  ...
  factory XyChart.fromMap(Map<String, dynamic> map) {
    return XyChart(
      chartOptions: map['chartOptions'] == null ? null : ChartOptions.fromMap((map['chartOptions'] as Map).cast<String, dynamic>()),
      dataSets: pulumi.Input.decodeList<DataSet>(map['dataSets'], (value) => DataSet.fromMap((value as Map).cast<String, dynamic>())),
      ...
      timeshiftDuration: map['timeshiftDuration'] == null ? null : map['timeshiftDuration'] as String,
      xAxis: map['xAxis'] == null ? null : Axis.fromMap((map['xAxis'] as Map).cast<String, dynamic>()),
      y2Axis: map['y2Axis'] == null ? null : Axis.fromMap((map['y2Axis'] as Map).cast<String, dynamic>()),
      yAxis: map['yAxis'] == null ? null : Axis.fromMap((map['yAxis'] as Map).cast<String, dynamic>()),
    );
  }
}
