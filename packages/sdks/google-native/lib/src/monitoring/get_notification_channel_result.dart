...
class GetNotificationChannelResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'enabled': enabled,
      'labels': labels,
      'mutationRecords': pulumi.Input.encodeList<MutationRecordResponse, Map<String, dynamic>>(mutationRecords, (value) => value.toMap()),
      'name': name,
      'type': type,
  ...
  factory GetNotificationChannelResult.fromMap(Map<String, dynamic> map) {
    return GetNotificationChannelResult(
      creationRecord: MutationRecordResponse.fromMap((map['creationRecord']! as Map).cast<String, dynamic>()),
      description: map['description'] as String,
      displayName: map['displayName'] as String,
      enabled: map['enabled'] as bool,
      labels: (map['labels'] as Map).cast<String, String>(),
      mutationRecords: pulumi.Input.decodeList<MutationRecordResponse>(map['mutationRecords']!, (value) => MutationRecordResponse.fromMap((value as Map).cast<String, dynamic>())),
