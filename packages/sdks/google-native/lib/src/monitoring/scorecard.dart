...
class Scorecard {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'blankView': ?blankView,
      'gaugeView':
          ?pulumi.Input.mapOptionalInputValue<GaugeView, Map<String, dynamic>>(
            gaugeView,
            (value) => value.toMap(),
          ),
      'sparkChartView':
  ...
  factory Scorecard.fromMap(Map<String, dynamic> map) {
    return Scorecard(
      blankView: (() {
        final guardedValue = map['blankView'];
      ...
      gaugeView: (() {
        final guardedValue = map['gaugeView'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GaugeView.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      sparkChartView: (() {
        final guardedValue = map['sparkChartView'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SparkChartView.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      thresholds: (() {
