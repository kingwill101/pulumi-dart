...
class Dimension {
  ...
  factory Dimension.fromMap(Map<String, dynamic> map) {
    return Dimension(
      ...
      columnType: map['columnType'] == null ? null : map['columnType'] as String,
      floatBinSize: map['floatBinSize'] == null ? null : map['floatBinSize'] as double,
      maxBinCount: map['maxBinCount'] == null ? null : map['maxBinCount'] as int,
      numericBinSize: map['numericBinSize'] == null ? null : map['numericBinSize'] as int,
      sortColumn: map['sortColumn'] == null ? null : map['sortColumn'] as String,
      sortOrder: map['sortOrder'] == null ? null : DimensionSortOrder.fromValue(map['sortOrder'] as String),
      timeBinSize: map['timeBinSize'] == null ? null : map['timeBinSize'] as String,
    );
  }
}
