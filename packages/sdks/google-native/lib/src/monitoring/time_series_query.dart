...
class TimeSeriesQuery {
  ...
  factory TimeSeriesQuery.fromMap(Map<String, dynamic> map) {
    return TimeSeriesQuery(
      opsAnalyticsQuery: (() {
        final guardedValue = map['opsAnalyticsQuery'];
      ...
      outputFullDuration: (() {
        final guardedValue = map['outputFullDuration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      prometheusQuery: (() {
        final guardedValue = map['prometheusQuery'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      timeSeriesFilter: (() {
        final guardedValue = map['timeSeriesFilter'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      timeSeriesFilterRatio: (() {
        final guardedValue = map['timeSeriesFilterRatio'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      timeSeriesQueryLanguage: (() {
        final guardedValue = map['timeSeriesQueryLanguage'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      unitOverride: (() {
        final guardedValue = map['unitOverride'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
