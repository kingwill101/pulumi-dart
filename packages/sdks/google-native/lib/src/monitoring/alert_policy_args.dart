...
class AlertPolicyArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'combiner': ?pulumi.Input.mapOptionalInputValue<AlertPolicyCombiner, String>(combiner, (value) => value.wireValue),
      ...
      'project': ?project,
      'severity': ?pulumi.Input.mapOptionalInputValue<AlertPolicySeverity, String>(severity, (value) => value.wireValue),
  ...
  factory AlertPolicyArgs.fromMap(Map<String, dynamic> map) {
    return AlertPolicyArgs(
      alertStrategy: (() { final guardedValue = map['alertStrategy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AlertStrategy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      combiner: (() { final guardedValue = map['combiner']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AlertPolicyCombiner.fromValue(guardedValue as String)); })(),
      ...
      mutationRecord: (() { final guardedValue = map['mutationRecord']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MutationRecord.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      severity: (() { final guardedValue = map['severity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AlertPolicySeverity.fromValue(guardedValue as String)); })(),
      ...
      validity: (() { final guardedValue = map['validity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Status.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
