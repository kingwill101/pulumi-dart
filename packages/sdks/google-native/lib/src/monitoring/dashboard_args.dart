...
class DashboardArgs {
    ...
    return <String, dynamic>{
      'columnLayout':
          ?pulumi.Input.mapOptionalInputValue<
            ColumnLayout,
            Map<String, dynamic>
          >(columnLayout, (value) => value.toMap()),
      'dashboardFilters':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'mosaicLayout':
          ?pulumi.Input.mapOptionalInputValue<
            MosaicLayout,
            Map<String, dynamic>
          >(mosaicLayout, (value) => value.toMap()),
      'name': ?name,
      'project': ?project,
      'rowLayout':
  ...
  factory DashboardArgs.fromMap(Map<String, dynamic> map) {
    return DashboardArgs(
      columnLayout: (() {
        final guardedValue = map['columnLayout'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ColumnLayout.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      dashboardFilters: (() {
        final guardedValue = map['dashboardFilters'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DashboardFilter>(
            guardedValue,
            (value) =>
                DashboardFilter.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      ...
      gridLayout: (() {
        final guardedValue = map['gridLayout'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GridLayout.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      labels: (() {
      ...
      mosaicLayout: (() {
        final guardedValue = map['mosaicLayout'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          MosaicLayout.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      name: (() {
      ...
      rowLayout: (() {
        final guardedValue = map['rowLayout'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RowLayout.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
