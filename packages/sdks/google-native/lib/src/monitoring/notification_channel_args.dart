...
class NotificationChannelArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'verificationStatus': ?pulumi.Input.mapOptionalInputValue<NotificationChannelVerificationStatus, String>(verificationStatus, (value) => value.wireValue),
    };
  }

  factory NotificationChannelArgs.fromMap(Map<String, dynamic> map) {
    return NotificationChannelArgs(
      creationRecord: (() { final guardedValue = map['creationRecord']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MutationRecord.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      description: (() { final guardedValue = map['description']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      displayName: (() { final guardedValue = map['displayName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      enabled: (() { final guardedValue = map['enabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      labels: (() { final guardedValue = map['labels']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      mutationRecords: (() { final guardedValue = map['mutationRecords']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<MutationRecord>(guardedValue, (value) => MutationRecord.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      verificationStatus: (() { final guardedValue = map['verificationStatus']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NotificationChannelVerificationStatus.fromValue(guardedValue as String)); })(),
    );
  }
}
