...
class NotificationChannelArgs {
    ...
    return <String, dynamic>{
      ...
      'verificationStatus':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(verificationStatus, (value) => value.wireValue),
    };
  }
  ...
  factory NotificationChannelArgs.fromMap(Map<String, dynamic> map) {
    return NotificationChannelArgs(
      creationRecord: (() {
        final guardedValue = map['creationRecord'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          MutationRecord.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      description: (() {
      ...
      mutationRecords: (() {
        final guardedValue = map['mutationRecords'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MutationRecord>(
            guardedValue,
            (value) =>
                MutationRecord.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      name: (() {
