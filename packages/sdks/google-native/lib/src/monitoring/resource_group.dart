...
class ResourceGroup {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'groupId': ?groupId,
      'resourceType': ?pulumi.Input.mapOptionalInputValue<ResourceGroupResourceType, String>(resourceType, (value) => value.wireValue),
    };
  }
  ...
  factory ResourceGroup.fromMap(Map<String, dynamic> map) {
    return ResourceGroup(
      ...
      resourceType: (() { final guardedValue = map['resourceType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResourceGroupResourceType.fromValue(guardedValue as String)); })(),
    );
  }
}
