...
class RequestBasedSliResponse {
  ...
  factory RequestBasedSliResponse.fromMap(Map<String, dynamic> map) {
    return RequestBasedSliResponse(
      distributionCut: pulumi.Input.fromValue(DistributionCutResponse.fromMap((map['distributionCut']! as Map).cast<String, dynamic>())),
      goodTotalRatio: pulumi.Input.fromValue(TimeSeriesRatioResponse.fromMap((map['goodTotalRatio']! as Map).cast<String, dynamic>())),
    );
  }
}
