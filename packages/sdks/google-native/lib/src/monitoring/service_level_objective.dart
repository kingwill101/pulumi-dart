...
class ServiceLevelObjective extends pulumi.CustomResource {
  ...
  ServiceLevelObjective(
    ...
    this.serviceLevelIndicator = registerOutput<ServiceLevelIndicatorResponse>('serviceLevelIndicator');
    this.serviceLevelObjectiveId = registerOutput<String?>('serviceLevelObjectiveId');
