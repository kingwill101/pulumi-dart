...
class AggregationResponseMonitoringV3 {
  ...
  factory AggregationResponseMonitoringV3.fromMap(Map<String, dynamic> map) {
    return AggregationResponseMonitoringV3(
      alignmentPeriod: (map['alignmentPeriod'] as String).input(),
      crossSeriesReducer: (map['crossSeriesReducer'] as String).input(),
      groupByFields: ((map['groupByFields'] as List).cast<String>()).input(),
      perSeriesAligner: (map['perSeriesAligner'] as String).input(),
    );
  }
}
