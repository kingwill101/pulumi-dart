...
class AggregationResponseMonitoringV3 {
  ...
  /// Creates a new [AggregationResponseMonitoringV3].
  ...
  const AggregationResponseMonitoringV3({
    required this.alignmentPeriod,
    required this.crossSeriesReducer,
    required this.groupByFields,
    required this.perSeriesAligner,
  });
  ...
  factory AggregationResponseMonitoringV3.fromMap(Map<String, dynamic> map) {
    return AggregationResponseMonitoringV3(
      alignmentPeriod: pulumi.Input.fromValue(map['alignmentPeriod'] as String),
      crossSeriesReducer: pulumi.Input.fromValue(map['crossSeriesReducer'] as String),
      groupByFields: pulumi.Input.fromValue((map['groupByFields'] as List).cast<String>()),
      perSeriesAligner: pulumi.Input.fromValue(map['perSeriesAligner'] as String),
    );
  }
}
