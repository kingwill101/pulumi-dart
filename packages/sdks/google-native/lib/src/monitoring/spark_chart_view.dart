...
class SparkChartView {
  ...
  SparkChartView({this.minAlignmentPeriod, required this.sparkChartType});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'minAlignmentPeriod': ?minAlignmentPeriod,
      'sparkChartType':
          pulumi.Input.mapInputValue<SparkChartViewSparkChartType, String>(
            sparkChartType,
  ...
  factory SparkChartView.fromMap(Map<String, dynamic> map) {
    return SparkChartView(
      ...
      sparkChartType: pulumi.Input.fromValue(
        SparkChartViewSparkChartType.fromValue(
