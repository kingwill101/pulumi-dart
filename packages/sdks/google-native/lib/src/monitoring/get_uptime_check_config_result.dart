...
class GetUptimeCheckConfigResult {
  ...
  /// Creates a new [GetUptimeCheckConfigResult].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'contentMatchers': pulumi.Input.encodeList<ContentMatcherResponse, Map<String, dynamic>>(contentMatchers, (value) => value.toMap()),
      'displayName': displayName,
      'httpCheck': httpCheck.toMap(),
      'internalCheckers': pulumi.Input.encodeList<InternalCheckerResponse, Map<String, dynamic>>(internalCheckers, (value) => value.toMap()),
      'isInternal': isInternal,
      'monitoredResource': monitoredResource.toMap(),
      'name': name,
      'period': period,
      'resourceGroup': resourceGroup.toMap(),
      'selectedRegions': selectedRegions,
      'syntheticMonitor': syntheticMonitor.toMap(),
      'tcpCheck': tcpCheck.toMap(),
      'timeout': timeout,
  ...
  factory GetUptimeCheckConfigResult.fromMap(Map<String, dynamic> map) {
    return GetUptimeCheckConfigResult(
      ...
      contentMatchers: pulumi.Input.decodeList<ContentMatcherResponse>(map['contentMatchers']!, (value) => ContentMatcherResponse.fromMap((value as Map).cast<String, dynamic>())),
      displayName: map['displayName'] as String,
      httpCheck: HttpCheckResponse.fromMap((map['httpCheck']! as Map).cast<String, dynamic>()),
      internalCheckers: pulumi.Input.decodeList<InternalCheckerResponse>(map['internalCheckers']!, (value) => InternalCheckerResponse.fromMap((value as Map).cast<String, dynamic>())),
      isInternal: map['isInternal'] as bool,
      monitoredResource: MonitoredResourceResponseMonitoringV3.fromMap((map['monitoredResource']! as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      period: map['period'] as String,
      resourceGroup: ResourceGroupResponse.fromMap((map['resourceGroup']! as Map).cast<String, dynamic>()),
      selectedRegions: (map['selectedRegions'] as List).cast<String>(),
      syntheticMonitor: SyntheticMonitorTargetResponse.fromMap((map['syntheticMonitor']! as Map).cast<String, dynamic>()),
      tcpCheck: TcpCheckResponse.fromMap((map['tcpCheck']! as Map).cast<String, dynamic>()),
