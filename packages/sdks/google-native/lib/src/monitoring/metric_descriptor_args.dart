...
class MetricDescriptorArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'launchStage': ?pulumi.Input.mapOptionalInputValue<MetricDescriptorLaunchStage, String>(launchStage, (value) => value.value),
      'metadata': ?pulumi.Input.mapOptionalInputValue<MetricDescriptorMetadata, Map<String, dynamic>>(metadata, (value) => value.toMap()),
      'metricKind': ?pulumi.Input.mapOptionalInputValue<MetricDescriptorMetricKind, String>(metricKind, (value) => value.value),
      'monitoredResourceTypes': ?monitoredResourceTypes,
      'name': ?name,
      'project': ?project,
      'type': ?type,
      'unit': ?unit,
      'valueType': ?pulumi.Input.mapOptionalInputValue<MetricDescriptorValueType, String>(valueType, (value) => value.value),
    };
  }
