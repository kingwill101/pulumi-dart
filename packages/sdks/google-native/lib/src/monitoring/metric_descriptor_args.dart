...
/// {@template pulumi_monitoring_v3_metric_descriptor_args_doc}
/// The set of arguments for MetricDescriptor.
/// {@endtemplate}
/// {@macro pulumi_monitoring_v3_metric_descriptor_args_doc}
class MetricDescriptorArgs {
  ...
  final pulumi.Input<MetricDescriptorLaunchStage>? launchStage;
  /// Optional. Metadata which can be used to guide usage of the metric.
  final pulumi.Input<MetricDescriptorMetadata>? metadata;
  /// Whether the metric records instantaneous values, changes to a value, etc. Some combinations of metric_kind and value_type might not be supported.
  final pulumi.Input<MetricDescriptorMetricKind>? metricKind;
  ...
  final pulumi.Input<MetricDescriptorValueType>? valueType;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'launchStage': ?pulumi.Input.mapOptionalInputValue<MetricDescriptorLaunchStage, String>(launchStage, (value) => value.wireValue),
      'metadata': ?pulumi.Input.mapOptionalInputValue<MetricDescriptorMetadata, Map<String, dynamic>>(metadata, (value) => value.toMap()),
      'metricKind': ?pulumi.Input.mapOptionalInputValue<MetricDescriptorMetricKind, String>(metricKind, (value) => value.wireValue),
      'monitoredResourceTypes': ?monitoredResourceTypes,
      'name': ?name,
      'project': ?project,
      'type': ?type,
      'unit': ?unit,
      'valueType': ?pulumi.Input.mapOptionalInputValue<MetricDescriptorValueType, String>(valueType, (value) => value.wireValue),
    };
  }
  ...
  factory MetricDescriptorArgs.fromMap(Map<String, dynamic> map) {
    return MetricDescriptorArgs(
      ...
      launchStage: (() { final guardedValue = map['launchStage']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MetricDescriptorLaunchStage.fromValue(guardedValue as String)); })(),
      ...
      metricKind: (() { final guardedValue = map['metricKind']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MetricDescriptorMetricKind.fromValue(guardedValue as String)); })(),
      ...
      valueType: (() { final guardedValue = map['valueType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MetricDescriptorValueType.fromValue(guardedValue as String)); })(),
    );
  }
}
