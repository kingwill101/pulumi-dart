    ...
    return <String, dynamic>{
      ...
      'metricKind':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(metricKind, (value) => value.wireValue),
  ...
  factory MetricDescriptorArgs.fromMap(Map<String, dynamic> map) {
    return MetricDescriptorArgs(
      ...
      launchStage: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          MetricDescriptorLaunchStage.fromValue(guardedValue as String),
        );
      })(),
      metadata: (() {
      ...
      metricKind: (() {
        final guardedValue = map['metricKind'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          MetricDescriptorMetricKind.fromValue(guardedValue as String),
        );
      })(),
      monitoredResourceTypes: (() {
        final guardedValue = map['monitoredResourceTypes'];
        if (guardedValue == null) return null;
      ...
      valueType: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          MetricDescriptorValueType.fromValue(guardedValue as String),
        );
      })(),
    );
  }
