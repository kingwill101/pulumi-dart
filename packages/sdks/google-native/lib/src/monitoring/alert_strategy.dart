...
class AlertStrategy {
  ...
  final pulumi.Input<List<NotificationChannelStrategy>>?
  ...
  factory AlertStrategy.fromMap(Map<String, dynamic> map) {
    return AlertStrategy(
      autoClose: (() {
        final guardedValue = map['autoClose'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      notificationChannelStrategy: (() {
        final guardedValue = map['notificationChannelStrategy'];
        if (guardedValue == null) return null;
      ...
      notificationRateLimit: (() {
        final guardedValue = map['notificationRateLimit'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
