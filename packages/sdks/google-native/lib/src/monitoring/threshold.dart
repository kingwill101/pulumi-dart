...
class Threshold {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'color': ?pulumi.Input.mapOptionalInputValue<ThresholdColor, String>(
        color,
        (value) => value.wireValue,
      ),
      'direction':
          ?pulumi.Input.mapOptionalInputValue<ThresholdDirection, String>(
            direction,
            (value) => value.wireValue,
          ),
      'label': ?label,
      'targetAxis':
          ?pulumi.Input.mapOptionalInputValue<ThresholdTargetAxis, String>(
            targetAxis,
            (value) => value.wireValue,
          ),
      'value': ?value,
    ...
    return Threshold(
      color: (() {
        ...
        return pulumi.Input.fromValue(
          ThresholdColor.fromValue(guardedValue as String),
        );
      })(),
      direction: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ThresholdDirection.fromValue(guardedValue as String),
        );
      })(),
      label: (() {
      ...
      targetAxis: (() {
        final guardedValue = map['targetAxis'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ThresholdTargetAxis.fromValue(guardedValue as String),
        );
      })(),
      value: (() {
