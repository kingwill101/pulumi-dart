...
class Widget {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'alertChart':
          ?pulumi.Input.mapOptionalInputValue<AlertChart, Map<String, dynamic>>(
            alertChart,
            (value) => value.toMap(),
          ),
      'blank': ?blank,
      ...
      'logsPanel':
          ?pulumi.Input.mapOptionalInputValue<LogsPanel, Map<String, dynamic>>(
            logsPanel,
            (value) => value.toMap(),
          ),
      'pieChart':
          ?pulumi.Input.mapOptionalInputValue<PieChart, Map<String, dynamic>>(
            pieChart,
            (value) => value.toMap(),
          ),
      'scorecard':
          ?pulumi.Input.mapOptionalInputValue<Scorecard, Map<String, dynamic>>(
            scorecard,
            (value) => value.toMap(),
          ),
      'text': ?pulumi.Input.mapOptionalInputValue<Text, Map<String, dynamic>>(
        text,
        (value) => value.toMap(),
      ),
      'timeSeriesTable':
      ...
      'title': ?title,
      'xyChart':
          ?pulumi.Input.mapOptionalInputValue<XyChart, Map<String, dynamic>>(
            xyChart,
            (value) => value.toMap(),
          ),
    };
  ...
  factory Widget.fromMap(Map<String, dynamic> map) {
    return Widget(
      alertChart: (() {
        final guardedValue = map['alertChart'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AlertChart.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      blank: (() {
        final guardedValue = map['blank'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      collapsibleGroup: (() {
        final guardedValue = map['collapsibleGroup'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      errorReportingPanel: (() {
        final guardedValue = map['errorReportingPanel'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      incidentList: (() {
        final guardedValue = map['incidentList'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          IncidentList.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      logsPanel: (() {
        final guardedValue = map['logsPanel'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          LogsPanel.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      pieChart: (() {
        final guardedValue = map['pieChart'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PieChart.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      scorecard: (() {
        final guardedValue = map['scorecard'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          Scorecard.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      text: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          Text.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      timeSeriesTable: (() {
        final guardedValue = map['timeSeriesTable'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      xyChart: (() {
        final guardedValue = map['xyChart'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          XyChart.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
