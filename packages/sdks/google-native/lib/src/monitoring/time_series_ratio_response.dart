...
class TimeSeriesRatioResponse {
  ...
  factory TimeSeriesRatioResponse.fromMap(Map<String, dynamic> map) {
    return TimeSeriesRatioResponse(
      badServiceFilter: (map['badServiceFilter'] as String).input(),
      goodServiceFilter: (map['goodServiceFilter'] as String).input(),
      totalServiceFilter: (map['totalServiceFilter'] as String).input(),
    );
  }
}
