...
class HttpCheck {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'body': ?body,
      'contentType': ?pulumi.Input.mapOptionalInputValue<HttpCheckContentType, String>(contentType, (value) => value.wireValue),
      ...
      'port': ?port,
      'requestMethod': ?pulumi.Input.mapOptionalInputValue<HttpCheckRequestMethod, String>(requestMethod, (value) => value.wireValue),
      'useSsl': ?useSsl,
  ...
  factory HttpCheck.fromMap(Map<String, dynamic> map) {
    return HttpCheck(
      acceptedResponseStatusCodes: (() { final guardedValue = map['acceptedResponseStatusCodes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ResponseStatusCode>(guardedValue, (value) => ResponseStatusCode.fromMap((value as Map).cast<String, dynamic>()))); })(),
      authInfo: (() { final guardedValue = map['authInfo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BasicAuthentication.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      body: (() { final guardedValue = map['body']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      contentType: (() { final guardedValue = map['contentType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HttpCheckContentType.fromValue(guardedValue as String)); })(),
      ...
      requestMethod: (() { final guardedValue = map['requestMethod']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HttpCheckRequestMethod.fromValue(guardedValue as String)); })(),
