...
class HttpCheck {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'acceptedResponseStatusCodes': ?acceptedResponseStatusCodes == null ? null : pulumi.Input.encodeList<ResponseStatusCode, Map<String, dynamic>>(acceptedResponseStatusCodes!, (value) => value.toMap()),
      ...
      'port': ?port,
      'requestMethod': ?requestMethod == null ? null : requestMethod!.value,
      'useSsl': ?useSsl,
  ...
  factory HttpCheck.fromMap(Map<String, dynamic> map) {
    return HttpCheck(
      acceptedResponseStatusCodes: map['acceptedResponseStatusCodes'] == null ? null : pulumi.Input.decodeList<ResponseStatusCode>(map['acceptedResponseStatusCodes'], (value) => ResponseStatusCode.fromMap((value as Map).cast<String, dynamic>())),
      authInfo: map['authInfo'] == null ? null : BasicAuthentication.fromMap((map['authInfo'] as Map).cast<String, dynamic>()),
      body: map['body'] == null ? null : map['body'] as String,
      contentType: map['contentType'] == null ? null : HttpCheckContentType.fromValue(map['contentType'] as String),
      ...
      requestMethod: map['requestMethod'] == null ? null : HttpCheckRequestMethod.fromValue(map['requestMethod'] as String),
