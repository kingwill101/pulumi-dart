...
class HttpCheck {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'body': ?body,
      'contentType':
          ?pulumi.Input.mapOptionalInputValue<HttpCheckContentType, String>(
            contentType,
      ...
      'port': ?port,
      'requestMethod':
          ?pulumi.Input.mapOptionalInputValue<HttpCheckRequestMethod, String>(
            requestMethod,
            (value) => value.wireValue,
          ),
      'useSsl': ?useSsl,
  ...
  factory HttpCheck.fromMap(Map<String, dynamic> map) {
    return HttpCheck(
      ...
      contentType: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          HttpCheckContentType.fromValue(guardedValue as String),
        );
      })(),
      customContentType: (() {
      ...
      requestMethod: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          HttpCheckRequestMethod.fromValue(guardedValue as String),
        );
      })(),
      useSsl: (() {
