...
class UptimeCheckConfig extends pulumi.CustomResource {
  ...
  UptimeCheckConfig(
    ...
    this.contentMatchers = registerOutput<List<ContentMatcherResponse>>('contentMatchers');
    this.displayName = registerOutput<String>('displayName');
    this.httpCheck = registerOutput<HttpCheckResponse>('httpCheck');
    this.internalCheckers = registerOutput<List<InternalCheckerResponse>>('internalCheckers');
    this.isInternal = registerOutput<bool>('isInternal');
    this.monitoredResource = registerOutput<MonitoredResourceResponseMonitoringV3>('monitoredResource');
    ...
    this.syntheticMonitor = registerOutput<SyntheticMonitorTargetResponse>('syntheticMonitor');
