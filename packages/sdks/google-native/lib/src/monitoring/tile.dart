...
class Tile {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'height': ?height,
      'widget':
          ?pulumi.Input.mapOptionalInputValue<Widget, Map<String, dynamic>>(
            widget,
            (value) => value.toMap(),
          ),
      'width': ?width,
  ...
  factory Tile.fromMap(Map<String, dynamic> map) {
    return Tile(
      ...
      widget: (() {
        final guardedValue = map['widget'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          Widget.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      width: (() {
      ...
      xPos: (() {
        final guardedValue = map['xPos'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      yPos: (() {
        final guardedValue = map['yPos'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
    );
