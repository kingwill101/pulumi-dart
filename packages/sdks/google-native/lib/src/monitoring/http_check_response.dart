...
class HttpCheckResponse {
  ...
  factory HttpCheckResponse.fromMap(Map<String, dynamic> map) {
    return HttpCheckResponse(
      acceptedResponseStatusCodes: pulumi.Input.fromValue(pulumi.Input.decodeList<ResponseStatusCodeResponse>(map['acceptedResponseStatusCodes']!, (value) => ResponseStatusCodeResponse.fromMap((value as Map).cast<String, dynamic>()))),
      authInfo: pulumi.Input.fromValue(BasicAuthenticationResponse.fromMap((map['authInfo']! as Map).cast<String, dynamic>())),
      body: pulumi.Input.fromValue(map['body'] as String),
      contentType: pulumi.Input.fromValue(map['contentType'] as String),
      customContentType: pulumi.Input.fromValue(map['customContentType'] as String),
