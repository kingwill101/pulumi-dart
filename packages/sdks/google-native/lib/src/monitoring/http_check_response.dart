...
class HttpCheckResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'acceptedResponseStatusCodes': pulumi.Input.encodeList<ResponseStatusCodeResponse, Map<String, dynamic>>(acceptedResponseStatusCodes, (value) => value.toMap()),
  ...
  factory HttpCheckResponse.fromMap(Map<String, dynamic> map) {
    return HttpCheckResponse(
      acceptedResponseStatusCodes: pulumi.Input.decodeList<ResponseStatusCodeResponse>(map['acceptedResponseStatusCodes'], (value) => ResponseStatusCodeResponse.fromMap((value as Map).cast<String, dynamic>())),
      authInfo: BasicAuthenticationResponse.fromMap((map['authInfo'] as Map).cast<String, dynamic>()),
