...
class HttpCheckResponse {
  ...
  final pulumi.Input<List<ResponseStatusCodeResponse>> acceptedResponseStatusCodes;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'acceptedResponseStatusCodes': pulumi.Input.mapInputValue<List<ResponseStatusCodeResponse>, List<Map<String, dynamic>>>(acceptedResponseStatusCodes, (value) => pulumi.Input.encodeList<ResponseStatusCodeResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'authInfo': pulumi.Input.mapInputValue<BasicAuthenticationResponse, Map<String, dynamic>>(authInfo, (value) => value.toMap()),
      'body': body,
  ...
  factory HttpCheckResponse.fromMap(Map<String, dynamic> map) {
    return HttpCheckResponse(
      acceptedResponseStatusCodes: (pulumi.Input.decodeList<ResponseStatusCodeResponse>(map['acceptedResponseStatusCodes'], (value) => ResponseStatusCodeResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      authInfo: (BasicAuthenticationResponse.fromMap((map['authInfo'] as Map).cast<String, dynamic>())).input(),
      body: (map['body'] as String).input(),
      contentType: (map['contentType'] as String).input(),
      customContentType: (map['customContentType'] as String).input(),
      headers: ((map['headers'] as Map).cast<String, String>()).input(),
      maskHeaders: (map['maskHeaders'] as bool).input(),
      path: (map['path'] as String).input(),
      pingConfig: (PingConfigResponse.fromMap((map['pingConfig'] as Map).cast<String, dynamic>())).input(),
      port: (map['port'] as int).input(),
      requestMethod: (map['requestMethod'] as String).input(),
      useSsl: (map['useSsl'] as bool).input(),
      validateSsl: (map['validateSsl'] as bool).input(),
    );
  }
}
