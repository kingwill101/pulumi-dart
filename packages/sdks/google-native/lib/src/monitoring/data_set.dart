...
class DataSet {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'breakdowns':
          ...
          >(
            breakdowns,
            (value) => pulumi.Input.encodeList<Breakdown, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
      ...
      'measures':
          ...
          >(
            measures,
            (value) => pulumi.Input.encodeList<Measure, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
      'minAlignmentPeriod': ?minAlignmentPeriod,
      'plotType': ?pulumi.Input.mapOptionalInputValue<DataSetPlotType, String>(
        plotType,
        (value) => value.wireValue,
      ),
      'targetAxis':
          ?pulumi.Input.mapOptionalInputValue<DataSetTargetAxis, String>(
            targetAxis,
            (value) => value.wireValue,
          ),
      'timeSeriesQuery':
  ...
  factory DataSet.fromMap(Map<String, dynamic> map) {
    return DataSet(
      breakdowns: (() {
        final guardedValue = map['breakdowns'];
      ...
      legendTemplate: (() {
        final guardedValue = map['legendTemplate'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      measures: (() {
        final guardedValue = map['measures'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<Measure>(
            guardedValue,
            (value) => Measure.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      minAlignmentPeriod: (() {
      ...
      plotType: (() {
        final guardedValue = map['plotType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DataSetPlotType.fromValue(guardedValue as String),
        );
      })(),
      targetAxis: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DataSetTargetAxis.fromValue(guardedValue as String),
        );
      })(),
