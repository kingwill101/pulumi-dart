...
class ConditionResponse {
  ...
  factory ConditionResponse.fromMap(Map<String, dynamic> map) {
    return ConditionResponse(
      conditionAbsent: (MetricAbsenceResponse.fromMap((map['conditionAbsent'] as Map).cast<String, dynamic>())).input(),
      conditionMatchedLog: (LogMatchResponse.fromMap((map['conditionMatchedLog'] as Map).cast<String, dynamic>())).input(),
      conditionMonitoringQueryLanguage: (MonitoringQueryLanguageConditionResponse.fromMap((map['conditionMonitoringQueryLanguage'] as Map).cast<String, dynamic>())).input(),
      conditionPrometheusQueryLanguage: (PrometheusQueryLanguageConditionResponse.fromMap((map['conditionPrometheusQueryLanguage'] as Map).cast<String, dynamic>())).input(),
      conditionThreshold: (MetricThresholdResponse.fromMap((map['conditionThreshold'] as Map).cast<String, dynamic>())).input(),
