...
class ConditionResponse {
  ...
  final pulumi.Input<MonitoringQueryLanguageConditionResponse> conditionMonitoringQueryLanguage;
  /// A condition that uses the Prometheus query language to define alerts.
  final pulumi.Input<PrometheusQueryLanguageConditionResponse> conditionPrometheusQueryLanguage;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'conditionAbsent': pulumi.Input.mapInputValue<MetricAbsenceResponse, Map<String, dynamic>>(conditionAbsent, (value) => value.toMap()),
      'conditionMatchedLog': pulumi.Input.mapInputValue<LogMatchResponse, Map<String, dynamic>>(conditionMatchedLog, (value) => value.toMap()),
      'conditionMonitoringQueryLanguage': pulumi.Input.mapInputValue<MonitoringQueryLanguageConditionResponse, Map<String, dynamic>>(conditionMonitoringQueryLanguage, (value) => value.toMap()),
      'conditionPrometheusQueryLanguage': pulumi.Input.mapInputValue<PrometheusQueryLanguageConditionResponse, Map<String, dynamic>>(conditionPrometheusQueryLanguage, (value) => value.toMap()),
      'conditionThreshold': pulumi.Input.mapInputValue<MetricThresholdResponse, Map<String, dynamic>>(conditionThreshold, (value) => value.toMap()),
  ...
  factory ConditionResponse.fromMap(Map<String, dynamic> map) {
    return ConditionResponse(
      conditionAbsent: pulumi.Input.fromValue(MetricAbsenceResponse.fromMap((map['conditionAbsent']! as Map).cast<String, dynamic>())),
      conditionMatchedLog: pulumi.Input.fromValue(LogMatchResponse.fromMap((map['conditionMatchedLog']! as Map).cast<String, dynamic>())),
      conditionMonitoringQueryLanguage: pulumi.Input.fromValue(MonitoringQueryLanguageConditionResponse.fromMap((map['conditionMonitoringQueryLanguage']! as Map).cast<String, dynamic>())),
      conditionPrometheusQueryLanguage: pulumi.Input.fromValue(PrometheusQueryLanguageConditionResponse.fromMap((map['conditionPrometheusQueryLanguage']! as Map).cast<String, dynamic>())),
      conditionThreshold: pulumi.Input.fromValue(MetricThresholdResponse.fromMap((map['conditionThreshold']! as Map).cast<String, dynamic>())),
