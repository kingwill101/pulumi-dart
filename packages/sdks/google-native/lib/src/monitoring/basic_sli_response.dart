...
class BasicSliResponse {
  ...
  factory BasicSliResponse.fromMap(Map<String, dynamic> map) {
    return BasicSliResponse(
      availability: pulumi.Input.fromValue((map['availability']! as Map).cast<String, dynamic>()),
      latency: pulumi.Input.fromValue(LatencyCriteriaResponse.fromMap((map['latency']! as Map).cast<String, dynamic>())),
      location: pulumi.Input.fromValue((map['location'] as List).cast<String>()),
