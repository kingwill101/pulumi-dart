...
class WindowsBasedSli {
  ...
  factory WindowsBasedSli.fromMap(Map<String, dynamic> map) {
    return WindowsBasedSli(
      ...
      goodTotalRatioThreshold: (() { final guardedValue = map['goodTotalRatioThreshold']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PerformanceThreshold.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      metricMeanInRange: (() { final guardedValue = map['metricMeanInRange']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MetricRange.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      metricSumInRange: (() { final guardedValue = map['metricSumInRange']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MetricRange.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
