...
class ServiceLevelObjectiveArgs {
  ...
  /// [v3Id] Required.
  /// [v3Id1] Required.
  const ServiceLevelObjectiveArgs({
    this.calendarPeriod,
    this.displayName,
    this.goal,
    this.name,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'calendarPeriod': ?pulumi.Input.mapOptionalInputValue<ServiceLevelObjectiveCalendarPeriod, String>(calendarPeriod, (value) => value.wireValue),
      'displayName': ?displayName,
      'goal': ?goal,
      'name': ?name,
      'rollingPeriod': ?rollingPeriod,
      'serviceId': serviceId,
      'serviceLevelIndicator': ?pulumi.Input.mapOptionalInputValue<ServiceLevelIndicator, Map<String, dynamic>>(serviceLevelIndicator, (value) => value.toMap()),
  ...
  factory ServiceLevelObjectiveArgs.fromMap(Map<String, dynamic> map) {
    return ServiceLevelObjectiveArgs(
      calendarPeriod: (() { final guardedValue = map['calendarPeriod']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServiceLevelObjectiveCalendarPeriod.fromValue(guardedValue as String)); })(),
      displayName: (() { final guardedValue = map['displayName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      goal: (() { final guardedValue = map['goal']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as double); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      rollingPeriod: (() { final guardedValue = map['rollingPeriod']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      serviceId: pulumi.Input.fromValue(map['serviceId'] as String),
      serviceLevelIndicator: (() { final guardedValue = map['serviceLevelIndicator']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServiceLevelIndicator.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      serviceLevelObjectiveId: (() { final guardedValue = map['serviceLevelObjectiveId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
