...
class DashboardFilter {
  ...
  factory DashboardFilter.fromMap(Map<String, dynamic> map) {
    return DashboardFilter(
      filterType: map['filterType'] == null ? null : DashboardFilterFilterType.fromValue(map['filterType'] as String),
      labelKey: map['labelKey'] as String,
      stringValue: map['stringValue'] == null ? null : map['stringValue'] as String,
      templateVariable: map['templateVariable'] == null ? null : map['templateVariable'] as String,
    );
  }
}
