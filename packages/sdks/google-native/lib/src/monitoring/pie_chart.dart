...
class PieChart {
  ...
  PieChart({required this.chartType, required this.dataSets, this.showLabels});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'chartType': pulumi.Input.mapInputValue<PieChartChartType, String>(
        chartType,
  ...
  factory PieChart.fromMap(Map<String, dynamic> map) {
    return PieChart(
      chartType: pulumi.Input.fromValue(
        PieChartChartType.fromValue(map['chartType']! as String),
      ),
      dataSets: pulumi.Input.fromValue(
        pulumi.Input.decodeList<PieChartDataSet>(
          map['dataSets']!,
          (value) =>
      ...
      showLabels: (() {
        final guardedValue = map['showLabels'];
