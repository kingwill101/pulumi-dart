    ...
    return <String, dynamic>{
      'checkerType':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(checkerType, (value) => value.wireValue),
      'contentMatchers':
          ?pulumi.Input.mapOptionalInputValue<
            List<ContentMatcher>,
    ...
    return UptimeCheckConfigArgs(
      checkerType: (() {
        ...
        return pulumi.Input.fromValue(
          UptimeCheckConfigCheckerType.fromValue(guardedValue as String),
        );
      })(),
      contentMatchers: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ContentMatcher>(
            guardedValue,
            (value) =>
                ContentMatcher.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      displayName: (() {
      ...
      httpCheck: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          HttpCheck.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      internalCheckers: (() {
        final guardedValue = map['internalCheckers'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InternalChecker>(
            guardedValue,
            (value) =>
                InternalChecker.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      isInternal: (() {
      ...
      resourceGroup: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ResourceGroup.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      selectedRegions: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<UptimeCheckConfigSelectedRegionsItem>(
            guardedValue,
            (value) =>
                UptimeCheckConfigSelectedRegionsItem.fromValue(value as String),
          ),
        );
      })(),
      syntheticMonitor: (() {
      ...
      tcpCheck: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TcpCheck.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      timeout: (() {
