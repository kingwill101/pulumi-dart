...
class ErrorReportingPanel {
  ...
  /// Creates a new [ErrorReportingPanel].
  ...
  factory ErrorReportingPanel.fromMap(Map<String, dynamic> map) {
    return ErrorReportingPanel(
      projectNames: (() { final guardedValue = map['projectNames']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
