...
import 'aggregation_cross_series_reducer_monitoring_v3.dart';
import 'aggregation_per_series_aligner_monitoring_v3.dart';
...
class AggregationMonitoringV3 {
  ...
  final AggregationCrossSeriesReducerMonitoringV3? crossSeriesReducer;
  ...
  final AggregationPerSeriesAlignerMonitoringV3? perSeriesAligner;

  /// Creates a new [AggregationMonitoringV3].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'crossSeriesReducer': ?crossSeriesReducer == null ? null : crossSeriesReducer!.value,
      'groupByFields': ?groupByFields,
      'perSeriesAligner': ?perSeriesAligner == null ? null : perSeriesAligner!.value,
    };
  }
  ...
  factory AggregationMonitoringV3.fromMap(Map<String, dynamic> map) {
    return AggregationMonitoringV3(
      ...
      crossSeriesReducer: map['crossSeriesReducer'] == null ? null : AggregationCrossSeriesReducerMonitoringV3.fromValue(map['crossSeriesReducer'] as String),
      groupByFields: map['groupByFields'] == null ? null : (map['groupByFields'] as List).cast<String>(),
      perSeriesAligner: map['perSeriesAligner'] == null ? null : AggregationPerSeriesAlignerMonitoringV3.fromValue(map['perSeriesAligner'] as String),
    );
  }
}
