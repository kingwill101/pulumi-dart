...
class AggregationMonitoringV3 {
  ...
  final pulumi.Input<AggregationCrossSeriesReducerMonitoringV3>?
  crossSeriesReducer;
    ...
    return <String, dynamic>{
      ...
      'crossSeriesReducer':
          ?pulumi.Input.mapOptionalInputValue<
            AggregationCrossSeriesReducerMonitoringV3,
            String
          >(crossSeriesReducer, (value) => value.wireValue),
      'groupByFields': ?groupByFields,
      'perSeriesAligner':
          ?pulumi.Input.mapOptionalInputValue<
            AggregationPerSeriesAlignerMonitoringV3,
            String
          >(perSeriesAligner, (value) => value.wireValue),
    };
  }
    ...
    return AggregationMonitoringV3(
      ...
      crossSeriesReducer: (() {
        ...
        return pulumi.Input.fromValue(
          AggregationCrossSeriesReducerMonitoringV3.fromValue(
      ...
      perSeriesAligner: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AggregationPerSeriesAlignerMonitoringV3.fromValue(
            guardedValue as String,
          ),
        );
      })(),
