...
class AggregationMonitoringV3 {
  ...
  final pulumi.Input<AggregationCrossSeriesReducerMonitoringV3>? crossSeriesReducer;
  ...
  final pulumi.Input<AggregationPerSeriesAlignerMonitoringV3>? perSeriesAligner;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'crossSeriesReducer': ?pulumi.Input.mapOptionalInputValue<AggregationCrossSeriesReducerMonitoringV3, String>(crossSeriesReducer, (value) => value.value),
      'groupByFields': ?groupByFields,
      'perSeriesAligner': ?pulumi.Input.mapOptionalInputValue<AggregationPerSeriesAlignerMonitoringV3, String>(perSeriesAligner, (value) => value.value),
    };
  }
