...
class JsonPathMatcher {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'jsonMatcher': ?pulumi.Input.mapOptionalInputValue<JsonPathMatcherJsonMatcher, String>(jsonMatcher, (value) => value.wireValue),
      'jsonPath': ?jsonPath,
    };
  }
  ...
  factory JsonPathMatcher.fromMap(Map<String, dynamic> map) {
    return JsonPathMatcher(
      jsonMatcher: (() { final guardedValue = map['jsonMatcher']; if (guardedValue == null) return null; return pulumi.Input.fromValue(JsonPathMatcherJsonMatcher.fromValue(guardedValue as String)); })(),
