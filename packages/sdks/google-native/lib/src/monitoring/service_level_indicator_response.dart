...
class ServiceLevelIndicatorResponse {
  ...
  factory ServiceLevelIndicatorResponse.fromMap(Map<String, dynamic> map) {
    return ServiceLevelIndicatorResponse(
      basicSli: (BasicSliResponse.fromMap((map['basicSli'] as Map).cast<String, dynamic>())).input(),
      requestBased: (RequestBasedSliResponse.fromMap((map['requestBased'] as Map).cast<String, dynamic>())).input(),
      windowsBased: (WindowsBasedSliResponse.fromMap((map['windowsBased'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
