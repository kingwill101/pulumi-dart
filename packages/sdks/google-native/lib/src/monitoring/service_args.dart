...
class ServiceArgs {
  ...
  factory ServiceArgs.fromMap(Map<String, dynamic> map) {
    return ServiceArgs(
      appEngine: map['appEngine'] == null ? null : (AppEngine.fromMap((map['appEngine']! as Map).cast<String, dynamic>())).input(),
      basicService: map['basicService'] == null ? null : (BasicService.fromMap((map['basicService']! as Map).cast<String, dynamic>())).input(),
      cloudEndpoints: map['cloudEndpoints'] == null ? null : (CloudEndpoints.fromMap((map['cloudEndpoints']! as Map).cast<String, dynamic>())).input(),
      cloudRun: map['cloudRun'] == null ? null : (CloudRun.fromMap((map['cloudRun']! as Map).cast<String, dynamic>())).input(),
      clusterIstio: map['clusterIstio'] == null ? null : (ClusterIstio.fromMap((map['clusterIstio']! as Map).cast<String, dynamic>())).input(),
      custom: map['custom'] == null ? null : ((map['custom']! as Map).cast<String, dynamic>()).input(),
      displayName: map['displayName'] == null ? null : (map['displayName']! as String).input(),
      gkeNamespace: map['gkeNamespace'] == null ? null : (GkeNamespace.fromMap((map['gkeNamespace']! as Map).cast<String, dynamic>())).input(),
      gkeService: map['gkeService'] == null ? null : (GkeService.fromMap((map['gkeService']! as Map).cast<String, dynamic>())).input(),
      gkeWorkload: map['gkeWorkload'] == null ? null : (GkeWorkload.fromMap((map['gkeWorkload']! as Map).cast<String, dynamic>())).input(),
      istioCanonicalService: map['istioCanonicalService'] == null ? null : (IstioCanonicalService.fromMap((map['istioCanonicalService']! as Map).cast<String, dynamic>())).input(),
      meshIstio: map['meshIstio'] == null ? null : (MeshIstio.fromMap((map['meshIstio']! as Map).cast<String, dynamic>())).input(),
      name: map['name'] == null ? null : (map['name']! as String).input(),
      serviceId: map['serviceId'] == null ? null : (map['serviceId']! as String).input(),
      telemetry: map['telemetry'] == null ? null : (Telemetry.fromMap((map['telemetry']! as Map).cast<String, dynamic>())).input(),
