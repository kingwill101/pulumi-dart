    ...
    return <String, dynamic>{
      ...
      'cloudEndpoints':
          ?pulumi.Input.mapOptionalInputValue<
            CloudEndpoints,
            Map<String, dynamic>
          >(cloudEndpoints, (value) => value.toMap()),
      'cloudRun':
      ...
      'clusterIstio':
          ?pulumi.Input.mapOptionalInputValue<
            ClusterIstio,
            Map<String, dynamic>
          >(clusterIstio, (value) => value.toMap()),
      'custom': ?custom,
      ...
      'gkeNamespace':
          ?pulumi.Input.mapOptionalInputValue<
            GkeNamespace,
            Map<String, dynamic>
          >(gkeNamespace, (value) => value.toMap()),
      'gkeService':
      ...
      'istioCanonicalService':
          ?pulumi.Input.mapOptionalInputValue<
            IstioCanonicalService,
            Map<String, dynamic>
          >(istioCanonicalService, (value) => value.toMap()),
      'meshIstio':
    ...
    return ServiceArgs(
      appEngine: (() {
        ...
        return pulumi.Input.fromValue(
          AppEngine.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      basicService: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          BasicService.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      cloudEndpoints: (() {
        final guardedValue = map['cloudEndpoints'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CloudEndpoints.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      cloudRun: (() {
      ...
      clusterIstio: (() {
        final guardedValue = map['clusterIstio'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ClusterIstio.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      custom: (() {
      ...
      gkeNamespace: (() {
        final guardedValue = map['gkeNamespace'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GkeNamespace.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      gkeService: (() {
        final guardedValue = map['gkeService'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GkeService.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      gkeWorkload: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GkeWorkload.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      istioCanonicalService: (() {
        final guardedValue = map['istioCanonicalService'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          IstioCanonicalService.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      meshIstio: (() {
        final guardedValue = map['meshIstio'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          MeshIstio.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      name: (() {
      ...
      telemetry: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          Telemetry.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      userLabels: (() {
