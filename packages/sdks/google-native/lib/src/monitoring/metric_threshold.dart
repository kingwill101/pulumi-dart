...
class MetricThreshold {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'denominatorAggregations': ?denominatorAggregations == null ? null : pulumi.Input.encodeList<AggregationMonitoringV3, Map<String, dynamic>>(denominatorAggregations!, (value) => value.toMap()),
  ...
  factory MetricThreshold.fromMap(Map<String, dynamic> map) {
    return MetricThreshold(
      ...
      comparison: map['comparison'] == null ? null : MetricThresholdComparison.fromValue(map['comparison'] as String),
      denominatorAggregations: map['denominatorAggregations'] == null ? null : pulumi.Input.decodeList<AggregationMonitoringV3>(map['denominatorAggregations'], (value) => AggregationMonitoringV3.fromMap((value as Map).cast<String, dynamic>())),
      denominatorFilter: map['denominatorFilter'] == null ? null : map['denominatorFilter'] as String,
      duration: map['duration'] == null ? null : map['duration'] as String,
      evaluationMissingData: map['evaluationMissingData'] == null ? null : MetricThresholdEvaluationMissingData.fromValue(map['evaluationMissingData'] as String),
      filter: map['filter'] as String,
      forecastOptions: map['forecastOptions'] == null ? null : ForecastOptions.fromMap((map['forecastOptions'] as Map).cast<String, dynamic>()),
