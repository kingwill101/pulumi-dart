...
class MetricThreshold {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'comparison': ?pulumi.Input.mapOptionalInputValue<MetricThresholdComparison, String>(comparison, (value) => value.wireValue),
      ...
      'duration': ?duration,
      'evaluationMissingData': ?pulumi.Input.mapOptionalInputValue<MetricThresholdEvaluationMissingData, String>(evaluationMissingData, (value) => value.wireValue),
      'filter': filter,
  ...
  factory MetricThreshold.fromMap(Map<String, dynamic> map) {
    return MetricThreshold(
      ...
      comparison: (() { final guardedValue = map['comparison']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MetricThresholdComparison.fromValue(guardedValue as String)); })(),
      denominatorAggregations: (() { final guardedValue = map['denominatorAggregations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AggregationMonitoringV3>(guardedValue, (value) => AggregationMonitoringV3.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      evaluationMissingData: (() { final guardedValue = map['evaluationMissingData']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MetricThresholdEvaluationMissingData.fromValue(guardedValue as String)); })(),
      filter: pulumi.Input.fromValue(map['filter'] as String),
      forecastOptions: (() { final guardedValue = map['forecastOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ForecastOptions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
