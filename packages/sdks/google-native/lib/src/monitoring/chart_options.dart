...
class ChartOptions {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'mode': ?pulumi.Input.mapOptionalInputValue<ChartOptionsMode, String>(
        mode,
  ...
  factory ChartOptions.fromMap(Map<String, dynamic> map) {
    return ChartOptions(
      displayHorizontal: (() {
        final guardedValue = map['displayHorizontal'];
      ...
      mode: (() {
        ...
        return pulumi.Input.fromValue(
          ChartOptionsMode.fromValue(guardedValue as String),
        );
      })(),
    );
  }
