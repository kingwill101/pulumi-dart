...
class MetricThresholdResponse {
  ...
  final pulumi.Input<List<AggregationResponseMonitoringV3>> denominatorAggregations;
  ...
  final pulumi.Input<ForecastOptionsResponse> forecastOptions;
  ...
  /// Creates a new [MetricThresholdResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'aggregations': pulumi.Input.mapInputValue<List<AggregationResponseMonitoringV3>, List<Map<String, dynamic>>>(aggregations, (value) => pulumi.Input.encodeList<AggregationResponseMonitoringV3, Map<String, dynamic>>(value, (value) => value.toMap())),
      'comparison': comparison,
      'denominatorAggregations': pulumi.Input.mapInputValue<List<AggregationResponseMonitoringV3>, List<Map<String, dynamic>>>(denominatorAggregations, (value) => pulumi.Input.encodeList<AggregationResponseMonitoringV3, Map<String, dynamic>>(value, (value) => value.toMap())),
      'denominatorFilter': denominatorFilter,
      'duration': duration,
      'evaluationMissingData': evaluationMissingData,
      'filter': filter,
      'forecastOptions': pulumi.Input.mapInputValue<ForecastOptionsResponse, Map<String, dynamic>>(forecastOptions, (value) => value.toMap()),
  ...
  factory MetricThresholdResponse.fromMap(Map<String, dynamic> map) {
    return MetricThresholdResponse(
      aggregations: (pulumi.Input.decodeList<AggregationResponseMonitoringV3>(map['aggregations'], (value) => AggregationResponseMonitoringV3.fromMap((value as Map).cast<String, dynamic>()))).input(),
      comparison: (map['comparison'] as String).input(),
      denominatorAggregations: (pulumi.Input.decodeList<AggregationResponseMonitoringV3>(map['denominatorAggregations'], (value) => AggregationResponseMonitoringV3.fromMap((value as Map).cast<String, dynamic>()))).input(),
      denominatorFilter: (map['denominatorFilter'] as String).input(),
      duration: (map['duration'] as String).input(),
      evaluationMissingData: (map['evaluationMissingData'] as String).input(),
      filter: (map['filter'] as String).input(),
      forecastOptions: (ForecastOptionsResponse.fromMap((map['forecastOptions'] as Map).cast<String, dynamic>())).input(),
      thresholdValue: (map['thresholdValue'] as double).input(),
      trigger: (TriggerResponse.fromMap((map['trigger'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
