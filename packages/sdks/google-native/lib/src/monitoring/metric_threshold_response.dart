...
class MetricThresholdResponse {
  ...
  factory MetricThresholdResponse.fromMap(Map<String, dynamic> map) {
    return MetricThresholdResponse(
      aggregations: pulumi.Input.fromValue(pulumi.Input.decodeList<AggregationResponseMonitoringV3>(map['aggregations']!, (value) => AggregationResponseMonitoringV3.fromMap((value as Map).cast<String, dynamic>()))),
      comparison: pulumi.Input.fromValue(map['comparison'] as String),
      denominatorAggregations: pulumi.Input.fromValue(pulumi.Input.decodeList<AggregationResponseMonitoringV3>(map['denominatorAggregations']!, (value) => AggregationResponseMonitoringV3.fromMap((value as Map).cast<String, dynamic>()))),
      denominatorFilter: pulumi.Input.fromValue(map['denominatorFilter'] as String),
      duration: pulumi.Input.fromValue(map['duration'] as String),
      evaluationMissingData: pulumi.Input.fromValue(map['evaluationMissingData'] as String),
      filter: pulumi.Input.fromValue(map['filter'] as String),
      forecastOptions: pulumi.Input.fromValue(ForecastOptionsResponse.fromMap((map['forecastOptions']! as Map).cast<String, dynamic>())),
