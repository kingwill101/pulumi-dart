...
class MetricThresholdResponse {
  ...
  final pulumi.Input<List<AggregationResponseMonitoringV3>>
  ...
  factory MetricThresholdResponse.fromMap(Map<String, dynamic> map) {
    return MetricThresholdResponse(
      ...
      denominatorAggregations: pulumi.Input.fromValue(
        pulumi.Input.decodeList<AggregationResponseMonitoringV3>(
      ...
      denominatorFilter: pulumi.Input.fromValue(
        map['denominatorFilter'] as String,
      ),
      duration: pulumi.Input.fromValue(map['duration'] as String),
      evaluationMissingData: pulumi.Input.fromValue(
        map['evaluationMissingData'] as String,
      ),
      filter: pulumi.Input.fromValue(map['filter'] as String),
      forecastOptions: pulumi.Input.fromValue(
        ForecastOptionsResponse.fromMap(
