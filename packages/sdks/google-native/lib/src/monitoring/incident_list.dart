...
class IncidentList {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'monitoredResources': ?pulumi.Input.mapOptionalInputValue<List<MonitoredResource>, List<Map<String, dynamic>>>(monitoredResources, (value) => pulumi.Input.encodeList<MonitoredResource, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory IncidentList.fromMap(Map<String, dynamic> map) {
    return IncidentList(
      monitoredResources: (() { final guardedValue = map['monitoredResources']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<MonitoredResource>(guardedValue, (value) => MonitoredResource.fromMap((value as Map).cast<String, dynamic>()))); })(),
