...
class TimeSeriesFilterRatio {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'denominator':
          ?pulumi.Input.mapOptionalInputValue<RatioPart, Map<String, dynamic>>(
            denominator,
            (value) => value.toMap(),
          ),
      'numerator':
      ...
      'secondaryAggregation':
          ?pulumi.Input.mapOptionalInputValue<
            Aggregation,
            Map<String, dynamic>
          >(secondaryAggregation, (value) => value.toMap()),
  ...
  factory TimeSeriesFilterRatio.fromMap(Map<String, dynamic> map) {
    return TimeSeriesFilterRatio(
      denominator: (() {
        final guardedValue = map['denominator'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RatioPart.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      numerator: (() {
        final guardedValue = map['numerator'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RatioPart.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      ...
      pickTimeSeriesFilter: (() {
        final guardedValue = map['pickTimeSeriesFilter'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      secondaryAggregation: (() {
        final guardedValue = map['secondaryAggregation'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      statisticalTimeSeriesFilter: (() {
        final guardedValue = map['statisticalTimeSeriesFilter'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
