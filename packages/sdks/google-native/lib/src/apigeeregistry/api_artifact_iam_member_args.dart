...
/// {@template pulumi_apigeeregistry_v1_api_artifact_iam_member_args_doc}
/// The set of arguments for ApiArtifactIamMember.
/// {@endtemplate}
/// {@macro pulumi_apigeeregistry_v1_api_artifact_iam_member_args_doc}
class ApiArtifactIamMemberArgs {
  ...
  /// Creates a new [ApiArtifactIamMemberArgs].
  ...
  const ApiArtifactIamMemberArgs({
    this.condition,
