...
class DeploymentArgs {
  ...
  factory DeploymentArgs.fromMap(Map<String, dynamic> map) {
    return DeploymentArgs(
      accessGuidance: (() { final guardedValue = map['accessGuidance']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      annotations: (() { final guardedValue = map['annotations']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      apiDeploymentId: pulumi.Input.fromValue(map['apiDeploymentId'] as String),
      apiId: pulumi.Input.fromValue(map['apiId'] as String),
      apiSpecRevision: (() { final guardedValue = map['apiSpecRevision']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      externalChannelUri: (() { final guardedValue = map['externalChannelUri']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      intendedAudience: (() { final guardedValue = map['intendedAudience']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
