...
/// {@template pulumi_apigeeregistry_v1_api_version_artifact_iam_binding_args_doc}
/// The set of arguments for ApiVersionArtifactIamBinding.
/// {@endtemplate}
/// {@macro pulumi_apigeeregistry_v1_api_version_artifact_iam_binding_args_doc}
class ApiVersionArtifactIamBindingArgs {
  ...
  /// Creates a new [ApiVersionArtifactIamBindingArgs].
  ...
  const ApiVersionArtifactIamBindingArgs({
    this.condition,
  ...
  factory ApiVersionArtifactIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return ApiVersionArtifactIamBindingArgs(
