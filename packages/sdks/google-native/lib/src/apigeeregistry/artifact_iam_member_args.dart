...
/// {@template pulumi_apigeeregistry_v1_artifact_iam_member_args_doc}
/// The set of arguments for ArtifactIamMember.
/// {@endtemplate}
/// {@macro pulumi_apigeeregistry_v1_artifact_iam_member_args_doc}
class ArtifactIamMemberArgs {
  ...
  /// Creates a new [ArtifactIamMemberArgs].
  ...
  factory ArtifactIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return ArtifactIamMemberArgs(
