...
/// {@template pulumi_apigeeregistry_v1_api_version_iam_member_args_doc}
/// The set of arguments for ApiVersionIamMember.
/// {@endtemplate}
/// {@macro pulumi_apigeeregistry_v1_api_version_iam_member_args_doc}
class ApiVersionIamMemberArgs {
  ...
  /// Creates a new [ApiVersionIamMemberArgs].
  ...
  factory ApiVersionIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return ApiVersionIamMemberArgs(
