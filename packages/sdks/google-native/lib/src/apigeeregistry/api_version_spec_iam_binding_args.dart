...
/// {@template pulumi_apigeeregistry_v1_api_version_spec_iam_binding_args_doc}
/// The set of arguments for ApiVersionSpecIamBinding.
/// {@endtemplate}
/// {@macro pulumi_apigeeregistry_v1_api_version_spec_iam_binding_args_doc}
class ApiVersionSpecIamBindingArgs {
  ...
  /// Creates a new [ApiVersionSpecIamBindingArgs].
  ...
  const ApiVersionSpecIamBindingArgs({
    this.condition,
  ...
  factory ApiVersionSpecIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return ApiVersionSpecIamBindingArgs(
