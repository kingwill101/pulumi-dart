...
/// {@template pulumi_apigeeregistry_v1_api_version_spec_artifact_iam_binding_args_doc}
/// The set of arguments for ApiVersionSpecArtifactIamBinding.
/// {@endtemplate}
/// {@macro pulumi_apigeeregistry_v1_api_version_spec_artifact_iam_binding_args_doc}
class ApiVersionSpecArtifactIamBindingArgs {
  ...
  /// Creates a new [ApiVersionSpecArtifactIamBindingArgs].
  ...
  const ApiVersionSpecArtifactIamBindingArgs({
    this.condition,
  ...
  factory ApiVersionSpecArtifactIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return ApiVersionSpecArtifactIamBindingArgs(
