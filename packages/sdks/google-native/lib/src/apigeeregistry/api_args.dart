...
class ApiArgs {
  ...
  factory ApiArgs.fromMap(Map<String, dynamic> map) {
    return ApiArgs(
      ...
      recommendedDeployment: (() { final guardedValue = map['recommendedDeployment']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      recommendedVersion: (() { final guardedValue = map['recommendedVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
