...
/// {@template pulumi_apigeeregistry_v1_api_deployment_iam_binding_args_doc}
/// The set of arguments for ApiDeploymentIamBinding.
/// {@endtemplate}
/// {@macro pulumi_apigeeregistry_v1_api_deployment_iam_binding_args_doc}
class ApiDeploymentIamBindingArgs {
  ...
  /// Creates a new [ApiDeploymentIamBindingArgs].
  ...
  const ApiDeploymentIamBindingArgs({
    this.condition,
  ...
  factory ApiDeploymentIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return ApiDeploymentIamBindingArgs(
