...
import 'deployment_artifact_args.dart';

/// Creates a specified artifact.
class DeploymentArtifact extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [DeploymentArtifact]. {@macro pulumi_apigeeregistry_v1_deployment_artifact_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  DeploymentArtifact(
    String name, {
    DeploymentArtifactArgs? args,
