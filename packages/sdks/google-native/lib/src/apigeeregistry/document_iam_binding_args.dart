...
/// {@template pulumi_apigeeregistry_v1_document_iam_binding_args_doc}
/// The set of arguments for DocumentIamBinding.
/// {@endtemplate}
/// {@macro pulumi_apigeeregistry_v1_document_iam_binding_args_doc}
class DocumentIamBindingArgs {
  ...
  /// Creates a new [DocumentIamBindingArgs].
  ...
  factory DocumentIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return DocumentIamBindingArgs(
