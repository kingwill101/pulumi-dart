...
/// {@template pulumi_apigeeregistry_v1_artifact_iam_binding_args_doc}
/// The set of arguments for ArtifactIamBinding.
/// {@endtemplate}
/// {@macro pulumi_apigeeregistry_v1_artifact_iam_binding_args_doc}
class ArtifactIamBindingArgs {
  ...
  /// Creates a new [ArtifactIamBindingArgs].
  ...
  factory ArtifactIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return ArtifactIamBindingArgs(
