...
/// {@template pulumi_apigeeregistry_v1_api_version_artifact_iam_member_args_doc}
/// The set of arguments for ApiVersionArtifactIamMember.
/// {@endtemplate}
/// {@macro pulumi_apigeeregistry_v1_api_version_artifact_iam_member_args_doc}
class ApiVersionArtifactIamMemberArgs {
  ...
  /// Creates a new [ApiVersionArtifactIamMemberArgs].
  ...
  const ApiVersionArtifactIamMemberArgs({
    this.condition,
  ...
  factory ApiVersionArtifactIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return ApiVersionArtifactIamMemberArgs(
