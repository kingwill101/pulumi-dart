...
/// {@template pulumi_apigeeregistry_v1_api_version_iam_binding_args_doc}
/// The set of arguments for ApiVersionIamBinding.
/// {@endtemplate}
/// {@macro pulumi_apigeeregistry_v1_api_version_iam_binding_args_doc}
class ApiVersionIamBindingArgs {
  ...
  /// Creates a new [ApiVersionIamBindingArgs].
  ...
  const ApiVersionIamBindingArgs({
    this.condition,
  ...
  factory ApiVersionIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return ApiVersionIamBindingArgs(
