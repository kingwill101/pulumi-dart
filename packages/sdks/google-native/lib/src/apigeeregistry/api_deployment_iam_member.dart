...
import 'api_deployment_iam_member_args.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class ApiDeploymentIamMember extends pulumi.CustomResource {
  ...
  /// Creates a new [ApiDeploymentIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ApiDeploymentIamMember]. {@macro pulumi_apigeeregistry_v1_api_deployment_iam_member_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  ApiDeploymentIamMember(
    String name, {
    ApiDeploymentIamMemberArgs? args,
