...
class PrivateEnvironmentConfig {
  ...
  factory PrivateEnvironmentConfig.fromMap(Map<String, dynamic> map) {
    return PrivateEnvironmentConfig(
      ...
      enablePrivateEnvironment: (() { final guardedValue = map['enablePrivateEnvironment']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      networkingConfig: (() { final guardedValue = map['networkingConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkingConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
