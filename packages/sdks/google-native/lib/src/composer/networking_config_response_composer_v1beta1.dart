...
class NetworkingConfigResponseComposerV1beta1 {
  ...
  NetworkingConfigResponseComposerV1beta1({required this.connectionType});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'connectionType': connectionType};
  }

  factory NetworkingConfigResponseComposerV1beta1.fromMap(
