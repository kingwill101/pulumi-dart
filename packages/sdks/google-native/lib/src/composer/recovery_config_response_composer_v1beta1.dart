...
class RecoveryConfigResponseComposerV1beta1 {
  ...
  final ScheduledSnapshotsConfigResponseComposerV1beta1 scheduledSnapshotsConfig;
  ...
  factory RecoveryConfigResponseComposerV1beta1.fromMap(Map<String, dynamic> map) {
    return RecoveryConfigResponseComposerV1beta1(
      scheduledSnapshotsConfig: ScheduledSnapshotsConfigResponseComposerV1beta1.fromMap((map['scheduledSnapshotsConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
