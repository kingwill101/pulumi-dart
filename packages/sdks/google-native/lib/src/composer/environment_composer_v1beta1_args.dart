...
class EnvironmentComposerV1beta1Args {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'project': ?project,
      'state': ?pulumi.Input.mapOptionalInputValue<EnvironmentStateComposerV1beta1, String>(state, (value) => value.wireValue),
  ...
  factory EnvironmentComposerV1beta1Args.fromMap(Map<String, dynamic> map) {
    return EnvironmentComposerV1beta1Args(
      config: (() { final guardedValue = map['config']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EnvironmentConfigComposerV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      labels: (() { final guardedValue = map['labels']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      location: (() { final guardedValue = map['location']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      project: (() { final guardedValue = map['project']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      state: (() { final guardedValue = map['state']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EnvironmentStateComposerV1beta1.fromValue(guardedValue as String)); })(),
      storageConfig: (() { final guardedValue = map['storageConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(StorageConfigComposerV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
