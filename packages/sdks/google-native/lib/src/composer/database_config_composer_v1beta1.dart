...
class DatabaseConfigComposerV1beta1 {
  ...
  /// Creates a new [DatabaseConfigComposerV1beta1].
  ...
  DatabaseConfigComposerV1beta1({this.machineType, this.zone});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'machineType': ?machineType, 'zone': ?zone};
  }

  factory DatabaseConfigComposerV1beta1.fromMap(Map<String, dynamic> map) {
    return DatabaseConfigComposerV1beta1(
      machineType: (() {
