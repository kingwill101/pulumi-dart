...
class EnvironmentConfigResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'nodeCount': nodeCount,
      'privateEnvironmentConfig': privateEnvironmentConfig.toMap(),
      'recoveryConfig': recoveryConfig.toMap(),
      'resilienceMode': resilienceMode,
      'softwareConfig': softwareConfig.toMap(),
      'webServerConfig': webServerConfig.toMap(),
      'webServerNetworkAccessControl': webServerNetworkAccessControl.toMap(),
      'workloadsConfig': workloadsConfig.toMap(),
    };
  }
  ...
  factory EnvironmentConfigResponse.fromMap(Map<String, dynamic> map) {
    return EnvironmentConfigResponse(
      ...
      databaseConfig: DatabaseConfigResponse.fromMap((map['databaseConfig'] as Map).cast<String, dynamic>()),
      ...
      masterAuthorizedNetworksConfig: MasterAuthorizedNetworksConfigResponse.fromMap((map['masterAuthorizedNetworksConfig'] as Map).cast<String, dynamic>()),
      nodeConfig: NodeConfigResponse.fromMap((map['nodeConfig'] as Map).cast<String, dynamic>()),
      nodeCount: map['nodeCount'] as int,
      privateEnvironmentConfig: PrivateEnvironmentConfigResponse.fromMap((map['privateEnvironmentConfig'] as Map).cast<String, dynamic>()),
      recoveryConfig: RecoveryConfigResponse.fromMap((map['recoveryConfig'] as Map).cast<String, dynamic>()),
      resilienceMode: map['resilienceMode'] as String,
      softwareConfig: SoftwareConfigResponse.fromMap((map['softwareConfig'] as Map).cast<String, dynamic>()),
      webServerConfig: WebServerConfigResponse.fromMap((map['webServerConfig'] as Map).cast<String, dynamic>()),
      webServerNetworkAccessControl: WebServerNetworkAccessControlResponse.fromMap((map['webServerNetworkAccessControl'] as Map).cast<String, dynamic>()),
      workloadsConfig: WorkloadsConfigResponse.fromMap((map['workloadsConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
