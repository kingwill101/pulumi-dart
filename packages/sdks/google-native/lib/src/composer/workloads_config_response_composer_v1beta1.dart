...
class WorkloadsConfigResponseComposerV1beta1 {
  ...
  const WorkloadsConfigResponseComposerV1beta1({
  ...
  factory WorkloadsConfigResponseComposerV1beta1.fromMap(Map<String, dynamic> map) {
    return WorkloadsConfigResponseComposerV1beta1(
      scheduler: pulumi.Input.fromValue(SchedulerResourceResponseComposerV1beta1.fromMap((map['scheduler']! as Map).cast<String, dynamic>())),
      triggerer: pulumi.Input.fromValue(TriggererResourceResponseComposerV1beta1.fromMap((map['triggerer']! as Map).cast<String, dynamic>())),
      webServer: pulumi.Input.fromValue(WebServerResourceResponseComposerV1beta1.fromMap((map['webServer']! as Map).cast<String, dynamic>())),
      worker: pulumi.Input.fromValue(WorkerResourceResponseComposerV1beta1.fromMap((map['worker']! as Map).cast<String, dynamic>())),
    );
  }
}
