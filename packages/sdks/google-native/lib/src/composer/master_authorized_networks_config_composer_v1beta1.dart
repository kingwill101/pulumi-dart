...
class MasterAuthorizedNetworksConfigComposerV1beta1 {
  ...
  const MasterAuthorizedNetworksConfigComposerV1beta1({
    this.cidrBlocks,
    this.enabled,
  });
  ...
  factory MasterAuthorizedNetworksConfigComposerV1beta1.fromMap(Map<String, dynamic> map) {
    return MasterAuthorizedNetworksConfigComposerV1beta1(
      cidrBlocks: (() { final guardedValue = map['cidrBlocks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<CidrBlockComposerV1beta1>(guardedValue, (value) => CidrBlockComposerV1beta1.fromMap((value as Map).cast<String, dynamic>()))); })(),
