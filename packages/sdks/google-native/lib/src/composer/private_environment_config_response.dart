...
class PrivateEnvironmentConfigResponse {
  ...
  final pulumi.Input<NetworkingConfigResponse> networkingConfig;
  /// Optional. Configuration for the private GKE cluster for a Private IP Cloud Composer environment.
  final pulumi.Input<PrivateClusterConfigResponse> privateClusterConfig;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'networkingConfig': pulumi.Input.mapInputValue<NetworkingConfigResponse, Map<String, dynamic>>(networkingConfig, (value) => value.toMap()),
      'privateClusterConfig': pulumi.Input.mapInputValue<PrivateClusterConfigResponse, Map<String, dynamic>>(privateClusterConfig, (value) => value.toMap()),
  ...
  factory PrivateEnvironmentConfigResponse.fromMap(Map<String, dynamic> map) {
    return PrivateEnvironmentConfigResponse(
      ...
      cloudComposerNetworkIpv4ReservedRange: (map['cloudComposerNetworkIpv4ReservedRange'] as String).input(),
      ...
      networkingConfig: (NetworkingConfigResponse.fromMap((map['networkingConfig'] as Map).cast<String, dynamic>())).input(),
      privateClusterConfig: (PrivateClusterConfigResponse.fromMap((map['privateClusterConfig'] as Map).cast<String, dynamic>())).input(),
      webServerIpv4CidrBlock: (map['webServerIpv4CidrBlock'] as String).input(),
      webServerIpv4ReservedRange: (map['webServerIpv4ReservedRange'] as String).input(),
    );
  }
}
