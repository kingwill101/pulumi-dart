...
class PrivateEnvironmentConfigResponse {
  ...
  factory PrivateEnvironmentConfigResponse.fromMap(Map<String, dynamic> map) {
    return PrivateEnvironmentConfigResponse(
      ...
      cloudComposerNetworkIpv4ReservedRange: pulumi.Input.fromValue(
      ...
      networkingConfig: pulumi.Input.fromValue(
        NetworkingConfigResponse.fromMap(
          (map['networkingConfig']! as Map).cast<String, dynamic>(),
        ),
      ),
      privateClusterConfig: pulumi.Input.fromValue(
        PrivateClusterConfigResponse.fromMap(
      ...
      webServerIpv4ReservedRange: pulumi.Input.fromValue(
        map['webServerIpv4ReservedRange'] as String,
      ),
    );
  }
}
