...
class PrivateEnvironmentConfigResponse {
  ...
  factory PrivateEnvironmentConfigResponse.fromMap(Map<String, dynamic> map) {
    return PrivateEnvironmentConfigResponse(
      ...
      networkingConfig: pulumi.Input.fromValue(NetworkingConfigResponse.fromMap((map['networkingConfig']! as Map).cast<String, dynamic>())),
      privateClusterConfig: pulumi.Input.fromValue(PrivateClusterConfigResponse.fromMap((map['privateClusterConfig']! as Map).cast<String, dynamic>())),
