...
class EnvironmentConfigComposerV1beta1 {
  ...
  final MasterAuthorizedNetworksConfigComposerV1beta1? masterAuthorizedNetworksConfig;
  ...
  final WebServerNetworkAccessControlComposerV1beta1? webServerNetworkAccessControl;
  ...
  factory EnvironmentConfigComposerV1beta1.fromMap(Map<String, dynamic> map) {
    return EnvironmentConfigComposerV1beta1(
      databaseConfig: map['databaseConfig'] == null ? null : DatabaseConfigComposerV1beta1.fromMap((map['databaseConfig'] as Map).cast<String, dynamic>()),
      encryptionConfig: map['encryptionConfig'] == null ? null : EncryptionConfigComposerV1beta1.fromMap((map['encryptionConfig'] as Map).cast<String, dynamic>()),
      environmentSize: map['environmentSize'] == null ? null : EnvironmentConfigEnvironmentSizeComposerV1beta1.fromValue(map['environmentSize'] as String),
      maintenanceWindow: map['maintenanceWindow'] == null ? null : MaintenanceWindowComposerV1beta1.fromMap((map['maintenanceWindow'] as Map).cast<String, dynamic>()),
      masterAuthorizedNetworksConfig: map['masterAuthorizedNetworksConfig'] == null ? null : MasterAuthorizedNetworksConfigComposerV1beta1.fromMap((map['masterAuthorizedNetworksConfig'] as Map).cast<String, dynamic>()),
      nodeConfig: map['nodeConfig'] == null ? null : NodeConfigComposerV1beta1.fromMap((map['nodeConfig'] as Map).cast<String, dynamic>()),
      nodeCount: map['nodeCount'] == null ? null : map['nodeCount'] as int,
      privateEnvironmentConfig: map['privateEnvironmentConfig'] == null ? null : PrivateEnvironmentConfigComposerV1beta1.fromMap((map['privateEnvironmentConfig'] as Map).cast<String, dynamic>()),
      recoveryConfig: map['recoveryConfig'] == null ? null : RecoveryConfigComposerV1beta1.fromMap((map['recoveryConfig'] as Map).cast<String, dynamic>()),
      resilienceMode: map['resilienceMode'] == null ? null : EnvironmentConfigResilienceModeComposerV1beta1.fromValue(map['resilienceMode'] as String),
      softwareConfig: map['softwareConfig'] == null ? null : SoftwareConfigComposerV1beta1.fromMap((map['softwareConfig'] as Map).cast<String, dynamic>()),
      webServerConfig: map['webServerConfig'] == null ? null : WebServerConfigComposerV1beta1.fromMap((map['webServerConfig'] as Map).cast<String, dynamic>()),
      webServerNetworkAccessControl: map['webServerNetworkAccessControl'] == null ? null : WebServerNetworkAccessControlComposerV1beta1.fromMap((map['webServerNetworkAccessControl'] as Map).cast<String, dynamic>()),
      workloadsConfig: map['workloadsConfig'] == null ? null : WorkloadsConfigComposerV1beta1.fromMap((map['workloadsConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
