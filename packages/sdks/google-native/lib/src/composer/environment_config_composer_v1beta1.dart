...
class EnvironmentConfigComposerV1beta1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'environmentSize': ?pulumi.Input.mapOptionalInputValue<EnvironmentConfigEnvironmentSizeComposerV1beta1, String>(environmentSize, (value) => value.value),
      ...
      'resilienceMode': ?pulumi.Input.mapOptionalInputValue<EnvironmentConfigResilienceModeComposerV1beta1, String>(resilienceMode, (value) => value.value),
