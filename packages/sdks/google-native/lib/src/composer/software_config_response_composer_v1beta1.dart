...
import 'cloud_data_lineage_integration_response.dart';

/// Specifies the selection and configuration of software inside the environment.
class SoftwareConfigResponseComposerV1beta1 {
  ...
  final pulumi.Input<CloudDataLineageIntegrationResponse> cloudDataLineageIntegration;
  ...
  /// Creates a new [SoftwareConfigResponseComposerV1beta1].
  ...
  const SoftwareConfigResponseComposerV1beta1({
    required this.airflowConfigOverrides,
    required this.cloudDataLineageIntegration,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'cloudDataLineageIntegration': pulumi.Input.mapInputValue<CloudDataLineageIntegrationResponse, Map<String, dynamic>>(cloudDataLineageIntegration, (value) => value.toMap()),
  ...
  factory SoftwareConfigResponseComposerV1beta1.fromMap(Map<String, dynamic> map) {
    return SoftwareConfigResponseComposerV1beta1(
      airflowConfigOverrides: pulumi.Input.fromValue((map['airflowConfigOverrides'] as Map).cast<String, String>()),
      cloudDataLineageIntegration: pulumi.Input.fromValue(CloudDataLineageIntegrationResponse.fromMap((map['cloudDataLineageIntegration']! as Map).cast<String, dynamic>())),
