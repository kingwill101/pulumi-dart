...
class PrivateEnvironmentConfigComposerV1beta1 {
  ...
  const PrivateEnvironmentConfigComposerV1beta1({
  ...
  factory PrivateEnvironmentConfigComposerV1beta1.fromMap(Map<String, dynamic> map) {
    return PrivateEnvironmentConfigComposerV1beta1(
      ...
      networkingConfig: (() { final guardedValue = map['networkingConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkingConfigComposerV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      privateClusterConfig: (() { final guardedValue = map['privateClusterConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PrivateClusterConfigComposerV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
