...
class PrivateEnvironmentConfigResponseComposerV1beta1 {
  ...
  final pulumi.Input<PrivateClusterConfigResponseComposerV1beta1>
  ...
  factory PrivateEnvironmentConfigResponseComposerV1beta1.fromMap(
    ...
    return PrivateEnvironmentConfigResponseComposerV1beta1(
      ...
      networkingConfig: pulumi.Input.fromValue(
        NetworkingConfigResponseComposerV1beta1.fromMap(
          (map['networkingConfig']! as Map).cast<String, dynamic>(),
        ),
      ),
      privateClusterConfig: pulumi.Input.fromValue(
        PrivateClusterConfigResponseComposerV1beta1.fromMap(
