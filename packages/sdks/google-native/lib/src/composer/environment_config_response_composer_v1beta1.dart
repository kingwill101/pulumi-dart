...
class EnvironmentConfigResponseComposerV1beta1 {
  ...
  final pulumi.Input<MaintenanceWindowResponseComposerV1beta1>
  maintenanceWindow;

  /// Optional. The configuration options for GKE cluster master authorized networks. By default master authorized networks feature is: - in case of private environment: enabled with no external networks allowlisted. - in case of public environment: disabled.
  final pulumi.Input<MasterAuthorizedNetworksConfigResponseComposerV1beta1>
  ...
  final pulumi.Input<PrivateEnvironmentConfigResponseComposerV1beta1>
  ...
  final pulumi.Input<WebServerNetworkAccessControlResponseComposerV1beta1>
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'webServerConfig':
          pulumi.Input.mapInputValue<
            WebServerConfigResponseComposerV1beta1,
            Map<String, dynamic>
  ...
  factory EnvironmentConfigResponseComposerV1beta1.fromMap(
    ...
    return EnvironmentConfigResponseComposerV1beta1(
      ...
      databaseConfig: pulumi.Input.fromValue(
        DatabaseConfigResponseComposerV1beta1.fromMap(
          (map['databaseConfig']! as Map).cast<String, dynamic>(),
        ),
      ),
      encryptionConfig: pulumi.Input.fromValue(
        EncryptionConfigResponseComposerV1beta1.fromMap(
      ...
      maintenanceWindow: pulumi.Input.fromValue(
        MaintenanceWindowResponseComposerV1beta1.fromMap(
      ...
      nodeConfig: pulumi.Input.fromValue(
        NodeConfigResponseComposerV1beta1.fromMap(
      ...
      recoveryConfig: pulumi.Input.fromValue(
        RecoveryConfigResponseComposerV1beta1.fromMap(
      ...
      softwareConfig: pulumi.Input.fromValue(
        SoftwareConfigResponseComposerV1beta1.fromMap(
          (map['softwareConfig']! as Map).cast<String, dynamic>(),
        ),
      ),
      webServerConfig: pulumi.Input.fromValue(
        WebServerConfigResponseComposerV1beta1.fromMap(
      ...
      workloadsConfig: pulumi.Input.fromValue(
        WorkloadsConfigResponseComposerV1beta1.fromMap(
