...
class EnvironmentConfigResponseComposerV1beta1 {
  ...
  const EnvironmentConfigResponseComposerV1beta1({
  ...
  factory EnvironmentConfigResponseComposerV1beta1.fromMap(Map<String, dynamic> map) {
    return EnvironmentConfigResponseComposerV1beta1(
      ...
      databaseConfig: pulumi.Input.fromValue(DatabaseConfigResponseComposerV1beta1.fromMap((map['databaseConfig']! as Map).cast<String, dynamic>())),
      encryptionConfig: pulumi.Input.fromValue(EncryptionConfigResponseComposerV1beta1.fromMap((map['encryptionConfig']! as Map).cast<String, dynamic>())),
      ...
      maintenanceWindow: pulumi.Input.fromValue(MaintenanceWindowResponseComposerV1beta1.fromMap((map['maintenanceWindow']! as Map).cast<String, dynamic>())),
      masterAuthorizedNetworksConfig: pulumi.Input.fromValue(MasterAuthorizedNetworksConfigResponseComposerV1beta1.fromMap((map['masterAuthorizedNetworksConfig']! as Map).cast<String, dynamic>())),
      nodeConfig: pulumi.Input.fromValue(NodeConfigResponseComposerV1beta1.fromMap((map['nodeConfig']! as Map).cast<String, dynamic>())),
      nodeCount: pulumi.Input.fromValue(map['nodeCount'] as int),
      privateEnvironmentConfig: pulumi.Input.fromValue(PrivateEnvironmentConfigResponseComposerV1beta1.fromMap((map['privateEnvironmentConfig']! as Map).cast<String, dynamic>())),
      recoveryConfig: pulumi.Input.fromValue(RecoveryConfigResponseComposerV1beta1.fromMap((map['recoveryConfig']! as Map).cast<String, dynamic>())),
      resilienceMode: pulumi.Input.fromValue(map['resilienceMode'] as String),
      softwareConfig: pulumi.Input.fromValue(SoftwareConfigResponseComposerV1beta1.fromMap((map['softwareConfig']! as Map).cast<String, dynamic>())),
      webServerConfig: pulumi.Input.fromValue(WebServerConfigResponseComposerV1beta1.fromMap((map['webServerConfig']! as Map).cast<String, dynamic>())),
      webServerNetworkAccessControl: pulumi.Input.fromValue(WebServerNetworkAccessControlResponseComposerV1beta1.fromMap((map['webServerNetworkAccessControl']! as Map).cast<String, dynamic>())),
      workloadsConfig: pulumi.Input.fromValue(WorkloadsConfigResponseComposerV1beta1.fromMap((map['workloadsConfig']! as Map).cast<String, dynamic>())),
    );
  }
}
