...
class EnvironmentConfigResponseComposerV1beta1 {
  ...
  final MasterAuthorizedNetworksConfigResponseComposerV1beta1 masterAuthorizedNetworksConfig;
  /// The configuration used for the Kubernetes Engine cluster.
  final NodeConfigResponseComposerV1beta1 nodeConfig;
  /// The number of nodes in the Kubernetes Engine cluster that will be used to run this environment. This field is supported for Cloud Composer environments in versions composer-1.*.*-airflow-*.*.*.
  final int nodeCount;
  /// The configuration used for the Private IP Cloud Composer environment.
  final PrivateEnvironmentConfigResponseComposerV1beta1 privateEnvironmentConfig;
  ...
  final WebServerNetworkAccessControlResponseComposerV1beta1 webServerNetworkAccessControl;
  ...
  factory EnvironmentConfigResponseComposerV1beta1.fromMap(Map<String, dynamic> map) {
    return EnvironmentConfigResponseComposerV1beta1(
      ...
      databaseConfig: DatabaseConfigResponseComposerV1beta1.fromMap((map['databaseConfig'] as Map).cast<String, dynamic>()),
      encryptionConfig: EncryptionConfigResponseComposerV1beta1.fromMap((map['encryptionConfig'] as Map).cast<String, dynamic>()),
      environmentSize: map['environmentSize'] as String,
      gkeCluster: map['gkeCluster'] as String,
      maintenanceWindow: MaintenanceWindowResponseComposerV1beta1.fromMap((map['maintenanceWindow'] as Map).cast<String, dynamic>()),
      masterAuthorizedNetworksConfig: MasterAuthorizedNetworksConfigResponseComposerV1beta1.fromMap((map['masterAuthorizedNetworksConfig'] as Map).cast<String, dynamic>()),
      nodeConfig: NodeConfigResponseComposerV1beta1.fromMap((map['nodeConfig'] as Map).cast<String, dynamic>()),
      nodeCount: map['nodeCount'] as int,
      privateEnvironmentConfig: PrivateEnvironmentConfigResponseComposerV1beta1.fromMap((map['privateEnvironmentConfig'] as Map).cast<String, dynamic>()),
      recoveryConfig: RecoveryConfigResponseComposerV1beta1.fromMap((map['recoveryConfig'] as Map).cast<String, dynamic>()),
      resilienceMode: map['resilienceMode'] as String,
      softwareConfig: SoftwareConfigResponseComposerV1beta1.fromMap((map['softwareConfig'] as Map).cast<String, dynamic>()),
      webServerConfig: WebServerConfigResponseComposerV1beta1.fromMap((map['webServerConfig'] as Map).cast<String, dynamic>()),
      webServerNetworkAccessControl: WebServerNetworkAccessControlResponseComposerV1beta1.fromMap((map['webServerNetworkAccessControl'] as Map).cast<String, dynamic>()),
      workloadsConfig: WorkloadsConfigResponseComposerV1beta1.fromMap((map['workloadsConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
