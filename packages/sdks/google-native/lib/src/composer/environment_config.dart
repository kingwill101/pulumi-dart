...
class EnvironmentConfig {
  ...
  final pulumi.Input<WebServerNetworkAccessControl>?
    ...
    return EnvironmentConfig(
      databaseConfig: (() {
        ...
        return pulumi.Input.fromValue(
          DatabaseConfig.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      encryptionConfig: (() {
      ...
      environmentSize: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          EnvironmentConfigEnvironmentSize.fromValue(guardedValue as String),
        );
      })(),
      maintenanceWindow: (() {
      ...
      recoveryConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RecoveryConfig.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      resilienceMode: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          EnvironmentConfigResilienceMode.fromValue(guardedValue as String),
        );
      })(),
      softwareConfig: (() {
