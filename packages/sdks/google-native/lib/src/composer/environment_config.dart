...
class EnvironmentConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'environmentSize': ?pulumi.Input.mapOptionalInputValue<EnvironmentConfigEnvironmentSize, String>(environmentSize, (value) => value.wireValue),
      ...
      'resilienceMode': ?pulumi.Input.mapOptionalInputValue<EnvironmentConfigResilienceMode, String>(resilienceMode, (value) => value.wireValue),
  ...
  factory EnvironmentConfig.fromMap(Map<String, dynamic> map) {
    return EnvironmentConfig(
      databaseConfig: (() { final guardedValue = map['databaseConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DatabaseConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      environmentSize: (() { final guardedValue = map['environmentSize']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EnvironmentConfigEnvironmentSize.fromValue(guardedValue as String)); })(),
      ...
      privateEnvironmentConfig: (() { final guardedValue = map['privateEnvironmentConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PrivateEnvironmentConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      recoveryConfig: (() { final guardedValue = map['recoveryConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RecoveryConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      resilienceMode: (() { final guardedValue = map['resilienceMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EnvironmentConfigResilienceMode.fromValue(guardedValue as String)); })(),
      ...
      webServerConfig: (() { final guardedValue = map['webServerConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WebServerConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      webServerNetworkAccessControl: (() { final guardedValue = map['webServerNetworkAccessControl']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WebServerNetworkAccessControl.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      workloadsConfig: (() { final guardedValue = map['workloadsConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WorkloadsConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
