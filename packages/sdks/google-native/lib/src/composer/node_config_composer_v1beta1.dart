...
import 'ipallocation_policy_composer_v1beta1.dart';

/// The configuration information for the Kubernetes Engine nodes running the Apache Airflow software.
class NodeConfigComposerV1beta1 {
  ...
  final pulumi.Input<IPAllocationPolicyComposerV1beta1>? ipAllocationPolicy;
  ...
  /// Creates a new [NodeConfigComposerV1beta1].
  ...
  const NodeConfigComposerV1beta1({
    this.diskSizeGb,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ipAllocationPolicy': ?pulumi.Input.mapOptionalInputValue<IPAllocationPolicyComposerV1beta1, Map<String, dynamic>>(ipAllocationPolicy, (value) => value.toMap()),
      'location': ?location,
  ...
  factory NodeConfigComposerV1beta1.fromMap(Map<String, dynamic> map) {
    return NodeConfigComposerV1beta1(
      ...
      ipAllocationPolicy: (() { final guardedValue = map['ipAllocationPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(IPAllocationPolicyComposerV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
