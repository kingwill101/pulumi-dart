...
class NodeConfigComposerV1beta1 {
  ...
  final IPAllocationPolicyComposerV1beta1? ipAllocationPolicy;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ipAllocationPolicy': ?ipAllocationPolicy == null ? null : ipAllocationPolicy!.toMap(),
      'location': ?location,
  ...
  factory NodeConfigComposerV1beta1.fromMap(Map<String, dynamic> map) {
    return NodeConfigComposerV1beta1(
      ...
      enableIpMasqAgent: map['enableIpMasqAgent'] == null ? null : map['enableIpMasqAgent'] as bool,
      ipAllocationPolicy: map['ipAllocationPolicy'] == null ? null : IPAllocationPolicyComposerV1beta1.fromMap((map['ipAllocationPolicy'] as Map).cast<String, dynamic>()),
