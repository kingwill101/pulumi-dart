...
class NodeConfigResponse {
  ...
  final pulumi.Input<IPAllocationPolicyResponse> ipAllocationPolicy;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ipAllocationPolicy': pulumi.Input.mapInputValue<IPAllocationPolicyResponse, Map<String, dynamic>>(ipAllocationPolicy, (value) => value.toMap()),
      'location': location,
  ...
  factory NodeConfigResponse.fromMap(Map<String, dynamic> map) {
    return NodeConfigResponse(
      ...
      ipAllocationPolicy: pulumi.Input.fromValue(IPAllocationPolicyResponse.fromMap((map['ipAllocationPolicy']! as Map).cast<String, dynamic>())),
