...
class NodeConfigResponseComposerV1beta1 {
  ...
  final IPAllocationPolicyResponseComposerV1beta1 ipAllocationPolicy;
  ...
  factory NodeConfigResponseComposerV1beta1.fromMap(Map<String, dynamic> map) {
    return NodeConfigResponseComposerV1beta1(
      ...
      ipAllocationPolicy: IPAllocationPolicyResponseComposerV1beta1.fromMap((map['ipAllocationPolicy'] as Map).cast<String, dynamic>()),
