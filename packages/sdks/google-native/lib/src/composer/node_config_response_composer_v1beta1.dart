...
class NodeConfigResponseComposerV1beta1 {
  ...
  final pulumi.Input<IPAllocationPolicyResponseComposerV1beta1>
  ipAllocationPolicy;
  ...
  NodeConfigResponseComposerV1beta1({
  ...
  factory NodeConfigResponseComposerV1beta1.fromMap(Map<String, dynamic> map) {
    return NodeConfigResponseComposerV1beta1(
      ...
      ipAllocationPolicy: pulumi.Input.fromValue(
        IPAllocationPolicyResponseComposerV1beta1.fromMap(
