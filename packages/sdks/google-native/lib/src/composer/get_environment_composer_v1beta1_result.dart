...
class GetEnvironmentComposerV1beta1Result {
  ...
  factory GetEnvironmentComposerV1beta1Result.fromMap(
    Map<String, dynamic> map,
  ) {
    return GetEnvironmentComposerV1beta1Result(
      config: EnvironmentConfigResponseComposerV1beta1.fromMap(
      ...
      storageConfig: StorageConfigResponseComposerV1beta1.fromMap(
