...
class SoftwareConfigComposerV1beta1 {
  ...
  factory SoftwareConfigComposerV1beta1.fromMap(Map<String, dynamic> map) {
    return SoftwareConfigComposerV1beta1(
      ...
      cloudDataLineageIntegration: map['cloudDataLineageIntegration'] == null ? null : CloudDataLineageIntegration.fromMap((map['cloudDataLineageIntegration'] as Map).cast<String, dynamic>()),
