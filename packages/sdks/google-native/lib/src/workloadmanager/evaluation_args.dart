...
class EvaluationArgs {
  ...
  factory EvaluationArgs.fromMap(Map<String, dynamic> map) {
    return EvaluationArgs(
      customRulesBucket: (() {
        final guardedValue = map['customRulesBucket'];
      ...
      resourceFilter: (() {
        final guardedValue = map['resourceFilter'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ResourceFilter.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      ruleNames: (() {
        final guardedValue = map['ruleNames'];
        if (guardedValue == null) return null;
