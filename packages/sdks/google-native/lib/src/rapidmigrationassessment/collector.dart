...
class Collector extends pulumi.CustomResource {
  ...
  Collector(
    ...
    guestOsScan = registerOutput<GuestOsScanResponse>('guestOsScan', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return GuestOsScanResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    vsphereScan = registerOutput<VSphereScanResponse>('vsphereScan', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return VSphereScanResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  }
}
