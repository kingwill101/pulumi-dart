...
import 'service_account_iam_member_args.dart';
...
class ServiceAccountIamMember extends pulumi.CustomResource {
  ...
  /// Creates a new [ServiceAccountIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ServiceAccountIamMember]. {@macro pulumi_iam_v1_service_account_iam_member_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  ServiceAccountIamMember(
    String name, {
    ServiceAccountIamMemberArgs? args,
