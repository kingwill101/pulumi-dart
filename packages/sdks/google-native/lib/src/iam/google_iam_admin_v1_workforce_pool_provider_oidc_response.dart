...
class GoogleIamAdminV1WorkforcePoolProviderOidcResponse {
  ...
  final GoogleIamAdminV1WorkforcePoolProviderOidcClientSecretResponse clientSecret;
  ...
  final GoogleIamAdminV1WorkforcePoolProviderOidcWebSsoConfigResponse webSsoConfig;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'issuerUri': issuerUri,
      'jwksJson': jwksJson,
      'webSsoConfig': webSsoConfig.toMap(),
    };
  }
  ...
  factory GoogleIamAdminV1WorkforcePoolProviderOidcResponse.fromMap(Map<String, dynamic> map) {
    return GoogleIamAdminV1WorkforcePoolProviderOidcResponse(
      ...
      clientSecret: GoogleIamAdminV1WorkforcePoolProviderOidcClientSecretResponse.fromMap((map['clientSecret'] as Map).cast<String, dynamic>()),
      issuerUri: map['issuerUri'] as String,
      jwksJson: map['jwksJson'] as String,
      webSsoConfig: GoogleIamAdminV1WorkforcePoolProviderOidcWebSsoConfigResponse.fromMap((map['webSsoConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
