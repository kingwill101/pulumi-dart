...
class GoogleIamAdminV1WorkforcePoolProviderOidcResponse {
  ...
  factory GoogleIamAdminV1WorkforcePoolProviderOidcResponse.fromMap(Map<String, dynamic> map) {
    return GoogleIamAdminV1WorkforcePoolProviderOidcResponse(
      ...
      clientSecret: pulumi.Input.fromValue(GoogleIamAdminV1WorkforcePoolProviderOidcClientSecretResponse.fromMap((map['clientSecret']! as Map).cast<String, dynamic>())),
      issuerUri: pulumi.Input.fromValue(map['issuerUri'] as String),
      jwksJson: pulumi.Input.fromValue(map['jwksJson'] as String),
      webSsoConfig: pulumi.Input.fromValue(GoogleIamAdminV1WorkforcePoolProviderOidcWebSsoConfigResponse.fromMap((map['webSsoConfig']! as Map).cast<String, dynamic>())),
    );
  }
}
