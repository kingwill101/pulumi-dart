...
class GoogleIamAdminV1WorkforcePoolProviderOidc {
  ...
  factory GoogleIamAdminV1WorkforcePoolProviderOidc.fromMap(Map<String, dynamic> map) {
    return GoogleIamAdminV1WorkforcePoolProviderOidc(
      ...
      clientSecret: map['clientSecret'] == null ? null : GoogleIamAdminV1WorkforcePoolProviderOidcClientSecret.fromMap((map['clientSecret'] as Map).cast<String, dynamic>()),
      issuerUri: map['issuerUri'] as String,
      jwksJson: map['jwksJson'] == null ? null : map['jwksJson'] as String,
      webSsoConfig: GoogleIamAdminV1WorkforcePoolProviderOidcWebSsoConfig.fromMap((map['webSsoConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
