...
class GoogleIamAdminV1WorkforcePoolProviderOidc {
  ...
  const GoogleIamAdminV1WorkforcePoolProviderOidc({
  ...
  factory GoogleIamAdminV1WorkforcePoolProviderOidc.fromMap(Map<String, dynamic> map) {
    return GoogleIamAdminV1WorkforcePoolProviderOidc(
      ...
      clientSecret: (() { final guardedValue = map['clientSecret']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleIamAdminV1WorkforcePoolProviderOidcClientSecret.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      webSsoConfig: pulumi.Input.fromValue(GoogleIamAdminV1WorkforcePoolProviderOidcWebSsoConfig.fromMap((map['webSsoConfig']! as Map).cast<String, dynamic>())),
    );
  }
}
