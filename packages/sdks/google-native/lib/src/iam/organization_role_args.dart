...
class OrganizationRoleArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'roleId': ?roleId,
      'stage': ?pulumi.Input.mapOptionalInputValue<OrganizationRoleStage, String>(stage, (value) => value.wireValue),
      'title': ?title,
    };
  }
  ...
  factory OrganizationRoleArgs.fromMap(Map<String, dynamic> map) {
    return OrganizationRoleArgs(
      ...
      includedPermissions: (() { final guardedValue = map['includedPermissions']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      ...
      stage: (() { final guardedValue = map['stage']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OrganizationRoleStage.fromValue(guardedValue as String)); })(),
