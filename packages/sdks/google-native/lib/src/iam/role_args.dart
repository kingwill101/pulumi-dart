...
class RoleArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'project': ?project,
      'roleId': ?roleId,
      'stage': ?pulumi.Input.mapOptionalInputValue<RoleStage, String>(stage, (value) => value.wireValue),
      'title': ?title,
    };
  }
  ...
  factory RoleArgs.fromMap(Map<String, dynamic> map) {
    return RoleArgs(
      ...
      stage: (() { final guardedValue = map['stage']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RoleStage.fromValue(guardedValue as String)); })(),
