...
class WorkforcePoolProvider extends pulumi.CustomResource {
  ...
  WorkforcePoolProvider(
    ...
    this.oidc = registerOutput<GoogleIamAdminV1WorkforcePoolProviderOidcResponse>('oidc');
    this.saml = registerOutput<GoogleIamAdminV1WorkforcePoolProviderSamlResponse>('saml');
    this.state = registerOutput<String>('state');
    this.workforcePoolId = registerOutput<String>('workforcePoolId');
    this.workforcePoolProviderId = registerOutput<String>('workforcePoolProviderId');
  }
}
