...
class AccessRestrictions {
  ...
  factory AccessRestrictions.fromMap(Map<String, dynamic> map) {
    return AccessRestrictions(
      allowedServices: (() { final guardedValue = map['allowedServices']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ServiceConfig>(guardedValue, (value) => ServiceConfig.fromMap((value as Map).cast<String, dynamic>()))); })(),
