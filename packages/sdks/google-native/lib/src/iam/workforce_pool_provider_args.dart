...
class WorkforcePoolProviderArgs {
  ...
  factory WorkforcePoolProviderArgs.fromMap(Map<String, dynamic> map) {
    return WorkforcePoolProviderArgs(
      ...
      attributeMapping: pulumi.Input.fromValue(
      ...
      oidc: (() {
        ...
        return pulumi.Input.fromValue(
          GoogleIamAdminV1WorkforcePoolProviderOidc.fromMap(
      ...
      saml: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GoogleIamAdminV1WorkforcePoolProviderSaml.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      workforcePoolId: pulumi.Input.fromValue(map['workforcePoolId'] as String),
      workforcePoolProviderId: pulumi.Input.fromValue(
        map['workforcePoolProviderId'] as String,
      ),
    );
  }
}
