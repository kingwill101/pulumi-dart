...
class WorkforcePoolProviderArgs {
  ...
  factory WorkforcePoolProviderArgs.fromMap(Map<String, dynamic> map) {
    return WorkforcePoolProviderArgs(
      ...
      attributeMapping: pulumi.Input.fromValue((map['attributeMapping'] as Map).cast<String, String>()),
      description: (() { final guardedValue = map['description']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      disabled: (() { final guardedValue = map['disabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      displayName: (() { final guardedValue = map['displayName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      location: (() { final guardedValue = map['location']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      oidc: (() { final guardedValue = map['oidc']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleIamAdminV1WorkforcePoolProviderOidc.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      saml: (() { final guardedValue = map['saml']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleIamAdminV1WorkforcePoolProviderSaml.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      workforcePoolId: pulumi.Input.fromValue(map['workforcePoolId'] as String),
      workforcePoolProviderId: pulumi.Input.fromValue(map['workforcePoolProviderId'] as String),
    );
  }
}
