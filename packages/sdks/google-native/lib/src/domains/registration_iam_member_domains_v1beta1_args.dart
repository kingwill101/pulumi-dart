...
/// {@template pulumi_domains_v1beta1_registration_iam_member_domains_v1beta1_args_doc}
/// The set of arguments for RegistrationIamMember.
/// {@endtemplate}
/// {@macro pulumi_domains_v1beta1_registration_iam_member_domains_v1beta1_args_doc}
class RegistrationIamMemberDomainsV1beta1Args {
  ...
  /// Creates a new [RegistrationIamMemberDomainsV1beta1Args].
  ...
  const RegistrationIamMemberDomainsV1beta1Args({
    this.condition,
  ...
  factory RegistrationIamMemberDomainsV1beta1Args.fromMap(Map<String, dynamic> map) {
