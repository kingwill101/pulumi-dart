...
class PostalAddressDomainsV1beta1 {
  ...
  factory PostalAddressDomainsV1beta1.fromMap(Map<String, dynamic> map) {
    return PostalAddressDomainsV1beta1(
      ...
      sortingCode: (() { final guardedValue = map['sortingCode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      sublocality: (() { final guardedValue = map['sublocality']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
