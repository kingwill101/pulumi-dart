...
class PostalAddressDomainsV1beta1 {
  ...
  /// Creates a new [PostalAddressDomainsV1beta1].
  ...
  factory PostalAddressDomainsV1beta1.fromMap(Map<String, dynamic> map) {
    return PostalAddressDomainsV1beta1(
      addressLines: map['addressLines'] == null ? null : (map['addressLines'] as List).cast<String>(),
      administrativeArea: map['administrativeArea'] == null ? null : map['administrativeArea'] as String,
      ...
      recipients: map['recipients'] == null ? null : (map['recipients'] as List).cast<String>(),
      regionCode: map['regionCode'] as String,
      revision: map['revision'] == null ? null : map['revision'] as int,
      sortingCode: map['sortingCode'] == null ? null : map['sortingCode'] as String,
      sublocality: map['sublocality'] == null ? null : map['sublocality'] as String,
    );
  }
}
