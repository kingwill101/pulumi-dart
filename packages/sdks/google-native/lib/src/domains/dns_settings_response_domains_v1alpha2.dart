...
class DnsSettingsResponseDomainsV1alpha2 {
  ...
  const DnsSettingsResponseDomainsV1alpha2({
  ...
  factory DnsSettingsResponseDomainsV1alpha2.fromMap(Map<String, dynamic> map) {
    return DnsSettingsResponseDomainsV1alpha2(
      customDns: pulumi.Input.fromValue(CustomDnsResponseDomainsV1alpha2.fromMap((map['customDns']! as Map).cast<String, dynamic>())),
      glueRecords: pulumi.Input.fromValue(pulumi.Input.decodeList<GlueRecordResponseDomainsV1alpha2>(map['glueRecords']!, (value) => GlueRecordResponseDomainsV1alpha2.fromMap((value as Map).cast<String, dynamic>()))),
      googleDomainsDns: pulumi.Input.fromValue(GoogleDomainsDnsResponseDomainsV1alpha2.fromMap((map['googleDomainsDns']! as Map).cast<String, dynamic>())),
    );
  }
}
