...
class DnsSettingsResponseDomainsV1alpha2 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'glueRecords': pulumi.Input.encodeList<GlueRecordResponseDomainsV1alpha2, Map<String, dynamic>>(glueRecords, (value) => value.toMap()),
  ...
  factory DnsSettingsResponseDomainsV1alpha2.fromMap(Map<String, dynamic> map) {
    return DnsSettingsResponseDomainsV1alpha2(
      customDns: CustomDnsResponseDomainsV1alpha2.fromMap((map['customDns'] as Map).cast<String, dynamic>()),
      glueRecords: pulumi.Input.decodeList<GlueRecordResponseDomainsV1alpha2>(map['glueRecords'], (value) => GlueRecordResponseDomainsV1alpha2.fromMap((value as Map).cast<String, dynamic>())),
      googleDomainsDns: GoogleDomainsDnsResponseDomainsV1alpha2.fromMap((map['googleDomainsDns'] as Map).cast<String, dynamic>()),
    );
  }
}
