...
class ContactSettings {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'privacy': pulumi.Input.mapInputValue<ContactSettingsPrivacy, String>(privacy, (value) => value.value),
  ...
  factory ContactSettings.fromMap(Map<String, dynamic> map) {
    return ContactSettings(
      adminContact: (Contact.fromMap((map['adminContact'] as Map).cast<String, dynamic>())).input(),
      privacy: (ContactSettingsPrivacy.fromValue(map['privacy'] as String)).input(),
      registrantContact: (Contact.fromMap((map['registrantContact'] as Map).cast<String, dynamic>())).input(),
      technicalContact: (Contact.fromMap((map['technicalContact'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
