...
class ContactSettings {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'adminContact': pulumi.Input.mapInputValue<Contact, Map<String, dynamic>>(
        adminContact,
        (value) => value.toMap(),
      ),
      'privacy': pulumi.Input.mapInputValue<ContactSettingsPrivacy, String>(
        privacy,
  ...
  factory ContactSettings.fromMap(Map<String, dynamic> map) {
    return ContactSettings(
      adminContact: pulumi.Input.fromValue(
        Contact.fromMap((map['adminContact']! as Map).cast<String, dynamic>()),
      ),
      privacy: pulumi.Input.fromValue(
        ContactSettingsPrivacy.fromValue(map['privacy']! as String),
      ),
