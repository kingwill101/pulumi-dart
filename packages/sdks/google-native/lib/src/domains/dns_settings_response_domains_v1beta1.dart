...
class DnsSettingsResponseDomainsV1beta1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'glueRecords':
          pulumi.Input.mapInputValue<
            List<GlueRecordResponseDomainsV1beta1>,
  ...
  factory DnsSettingsResponseDomainsV1beta1.fromMap(Map<String, dynamic> map) {
    return DnsSettingsResponseDomainsV1beta1(
      customDns: pulumi.Input.fromValue(
        CustomDnsResponseDomainsV1beta1.fromMap(
          (map['customDns']! as Map).cast<String, dynamic>(),
        ),
      ),
      glueRecords: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GlueRecordResponseDomainsV1beta1>(
          map['glueRecords']!,
      ...
      googleDomainsDns: pulumi.Input.fromValue(
        GoogleDomainsDnsResponseDomainsV1beta1.fromMap(
