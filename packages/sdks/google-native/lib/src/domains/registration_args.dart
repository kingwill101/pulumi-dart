...
class RegistrationArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'contactNotices': ?pulumi.Input.mapOptionalInputValue<List<RegistrationContactNoticesItem>, List<String>>(contactNotices, (value) => pulumi.Input.encodeList<RegistrationContactNoticesItem, String>(value, (value) => value.wireValue)),
      ...
      'domainNotices': ?pulumi.Input.mapOptionalInputValue<List<RegistrationDomainNoticesItem>, List<String>>(domainNotices, (value) => pulumi.Input.encodeList<RegistrationDomainNoticesItem, String>(value, (value) => value.wireValue)),
      'labels': ?labels,
      'location': ?location,
  ...
  factory RegistrationArgs.fromMap(Map<String, dynamic> map) {
    return RegistrationArgs(
      contactNotices: (() { final guardedValue = map['contactNotices']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RegistrationContactNoticesItem>(guardedValue, (value) => RegistrationContactNoticesItem.fromValue(value as String))); })(),
      contactSettings: pulumi.Input.fromValue(ContactSettings.fromMap((map['contactSettings']! as Map).cast<String, dynamic>())),
      dnsSettings: (() { final guardedValue = map['dnsSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DnsSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      domainName: pulumi.Input.fromValue(map['domainName'] as String),
      domainNotices: (() { final guardedValue = map['domainNotices']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RegistrationDomainNoticesItem>(guardedValue, (value) => RegistrationDomainNoticesItem.fromValue(value as String))); })(),
      ...
      yearlyPrice: pulumi.Input.fromValue(Money.fromMap((map['yearlyPrice']! as Map).cast<String, dynamic>())),
    );
  }
}
