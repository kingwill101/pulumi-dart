...
class ManagementSettingsDomainsV1alpha2 {
  ...
  final pulumi.Input<ManagementSettingsPreferredRenewalMethodDomainsV1alpha2>?
  preferredRenewalMethod;

  /// Controls whether the domain can be transferred to another registrar.
  final pulumi.Input<ManagementSettingsTransferLockStateDomainsV1alpha2>?
  transferLockState;
    ...
    return <String, dynamic>{
      'preferredRenewalMethod':
          ?pulumi.Input.mapOptionalInputValue<
            ManagementSettingsPreferredRenewalMethodDomainsV1alpha2,
            String
          >(preferredRenewalMethod, (value) => value.wireValue),
      'transferLockState':
          ?pulumi.Input.mapOptionalInputValue<
            ManagementSettingsTransferLockStateDomainsV1alpha2,
            String
          >(transferLockState, (value) => value.wireValue),
    };
  }
