...
class ManagementSettingsDomainsV1alpha2 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'preferredRenewalMethod': ?pulumi.Input.mapOptionalInputValue<ManagementSettingsPreferredRenewalMethodDomainsV1alpha2, String>(preferredRenewalMethod, (value) => value.value),
      'transferLockState': ?pulumi.Input.mapOptionalInputValue<ManagementSettingsTransferLockStateDomainsV1alpha2, String>(transferLockState, (value) => value.value),
    };
  }
