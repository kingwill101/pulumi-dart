...
class ManagementSettingsDomainsV1alpha2 {
  ...
  final pulumi.Input<ManagementSettingsPreferredRenewalMethodDomainsV1alpha2>? preferredRenewalMethod;
  /// Controls whether the domain can be transferred to another registrar.
  final pulumi.Input<ManagementSettingsTransferLockStateDomainsV1alpha2>? transferLockState;
  ...
  const ManagementSettingsDomainsV1alpha2({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'preferredRenewalMethod': ?pulumi.Input.mapOptionalInputValue<ManagementSettingsPreferredRenewalMethodDomainsV1alpha2, String>(preferredRenewalMethod, (value) => value.wireValue),
      'transferLockState': ?pulumi.Input.mapOptionalInputValue<ManagementSettingsTransferLockStateDomainsV1alpha2, String>(transferLockState, (value) => value.wireValue),
    };
  }

  factory ManagementSettingsDomainsV1alpha2.fromMap(Map<String, dynamic> map) {
    return ManagementSettingsDomainsV1alpha2(
      preferredRenewalMethod: (() { final guardedValue = map['preferredRenewalMethod']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagementSettingsPreferredRenewalMethodDomainsV1alpha2.fromValue(guardedValue as String)); })(),
      transferLockState: (() { final guardedValue = map['transferLockState']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagementSettingsTransferLockStateDomainsV1alpha2.fromValue(guardedValue as String)); })(),
    );
  }
}
