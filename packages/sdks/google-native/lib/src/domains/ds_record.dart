...
class DsRecord {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'algorithm':
          ?pulumi.Input.mapOptionalInputValue<DsRecordAlgorithm, String>(
            algorithm,
            (value) => value.wireValue,
          ),
      'digest': ?digest,
      'digestType':
          ?pulumi.Input.mapOptionalInputValue<DsRecordDigestType, String>(
            digestType,
            (value) => value.wireValue,
          ),
      'keyTag': ?keyTag,
    ...
    return DsRecord(
      algorithm: (() {
        ...
        return pulumi.Input.fromValue(
          DsRecordAlgorithm.fromValue(guardedValue as String),
        );
      })(),
      digest: (() {
      ...
      digestType: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DsRecordDigestType.fromValue(guardedValue as String),
        );
      })(),
      keyTag: (() {
