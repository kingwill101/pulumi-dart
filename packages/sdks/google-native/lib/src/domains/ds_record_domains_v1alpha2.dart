    ...
    return <String, dynamic>{
      'algorithm':
          ?pulumi.Input.mapOptionalInputValue<
            DsRecordAlgorithmDomainsV1alpha2,
            String
          >(algorithm, (value) => value.wireValue),
      'digest': ?digest,
      'digestType':
          ?pulumi.Input.mapOptionalInputValue<
            DsRecordDigestTypeDomainsV1alpha2,
            String
    ...
    return DsRecordDomainsV1alpha2(
      algorithm: (() {
        ...
        return pulumi.Input.fromValue(
          DsRecordAlgorithmDomainsV1alpha2.fromValue(guardedValue as String),
        );
      })(),
      digest: (() {
      ...
      digestType: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DsRecordDigestTypeDomainsV1alpha2.fromValue(guardedValue as String),
        );
      })(),
      keyTag: (() {
