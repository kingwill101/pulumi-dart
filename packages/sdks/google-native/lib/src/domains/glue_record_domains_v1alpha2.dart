...
class GlueRecordDomainsV1alpha2 {
  ...
  /// Creates a new [GlueRecordDomainsV1alpha2].
  ...
  const GlueRecordDomainsV1alpha2({
  ...
  factory GlueRecordDomainsV1alpha2.fromMap(Map<String, dynamic> map) {
    return GlueRecordDomainsV1alpha2(
