...
class ExprResponseDomainsV1alpha2 {
  ...
  /// Creates a new [ExprResponseDomainsV1alpha2].
  ...
  const ExprResponseDomainsV1alpha2({
  ...
  factory ExprResponseDomainsV1alpha2.fromMap(Map<String, dynamic> map) {
    return ExprResponseDomainsV1alpha2(
