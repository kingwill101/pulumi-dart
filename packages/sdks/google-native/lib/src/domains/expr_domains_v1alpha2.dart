...
class ExprDomainsV1alpha2 {
  ...
  /// Creates a new [ExprDomainsV1alpha2].
  ...
  factory ExprDomainsV1alpha2.fromMap(Map<String, dynamic> map) {
    return ExprDomainsV1alpha2(
