...
class GoogleDomainsDnsDomainsV1alpha2 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'dsState': pulumi.Input.mapInputValue<GoogleDomainsDnsDsStateDomainsV1alpha2, String>(dsState, (value) => value.value),
    };
  }

  factory GoogleDomainsDnsDomainsV1alpha2.fromMap(Map<String, dynamic> map) {
    return GoogleDomainsDnsDomainsV1alpha2(
      dsState: (GoogleDomainsDnsDsStateDomainsV1alpha2.fromValue(map['dsState'] as String)).input(),
    );
  }
}
