...
class ManagementSettingsResponseDomainsV1alpha2 {
  ...
  /// Creates a new [ManagementSettingsResponseDomainsV1alpha2].
  ...
  const ManagementSettingsResponseDomainsV1alpha2({
  ...
  factory ManagementSettingsResponseDomainsV1alpha2.fromMap(Map<String, dynamic> map) {
    return ManagementSettingsResponseDomainsV1alpha2(
