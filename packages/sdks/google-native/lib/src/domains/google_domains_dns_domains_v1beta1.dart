...
class GoogleDomainsDnsDomainsV1beta1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'dsState': pulumi.Input.mapInputValue<GoogleDomainsDnsDsStateDomainsV1beta1, String>(dsState, (value) => value.value),
    };
  }

  factory GoogleDomainsDnsDomainsV1beta1.fromMap(Map<String, dynamic> map) {
    return GoogleDomainsDnsDomainsV1beta1(
      dsState: (GoogleDomainsDnsDsStateDomainsV1beta1.fromValue(map['dsState'] as String)).input(),
    );
  }
}
