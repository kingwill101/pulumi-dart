...
class GoogleDomainsDnsDomainsV1beta1 {
  ...
  GoogleDomainsDnsDomainsV1beta1({required this.dsState});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'dsState':
          pulumi.Input.mapInputValue<
            GoogleDomainsDnsDsStateDomainsV1beta1,
            String
          >(dsState, (value) => value.wireValue),
    };
  }
  ...
  factory GoogleDomainsDnsDomainsV1beta1.fromMap(Map<String, dynamic> map) {
    return GoogleDomainsDnsDomainsV1beta1(
      dsState: pulumi.Input.fromValue(
        GoogleDomainsDnsDsStateDomainsV1beta1.fromValue(
