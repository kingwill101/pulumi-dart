...
class ManagementSettings {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'preferredRenewalMethod': ?pulumi.Input.mapOptionalInputValue<ManagementSettingsPreferredRenewalMethod, String>(preferredRenewalMethod, (value) => value.value),
      'transferLockState': ?pulumi.Input.mapOptionalInputValue<ManagementSettingsTransferLockState, String>(transferLockState, (value) => value.value),
    };
  }
