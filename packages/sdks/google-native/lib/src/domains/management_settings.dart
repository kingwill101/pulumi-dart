...
class ManagementSettings {
  ...
  final pulumi.Input<ManagementSettingsPreferredRenewalMethod>?
  ...
  ManagementSettings({this.preferredRenewalMethod, this.transferLockState});
  ...
  factory ManagementSettings.fromMap(Map<String, dynamic> map) {
    return ManagementSettings(
      ...
      transferLockState: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ManagementSettingsTransferLockState.fromValue(guardedValue as String),
        );
      })(),
    );
  }
