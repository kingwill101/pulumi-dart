...
class GetRegistrationDomainsV1beta1Result {
  ...
  factory GetRegistrationDomainsV1beta1Result.fromMap(Map<String, dynamic> map) {
    return GetRegistrationDomainsV1beta1Result(
      contactSettings: ContactSettingsResponseDomainsV1beta1.fromMap((map['contactSettings']! as Map).cast<String, dynamic>()),
      createTime: map['createTime'] as String,
      dnsSettings: DnsSettingsResponseDomainsV1beta1.fromMap((map['dnsSettings']! as Map).cast<String, dynamic>()),
      domainName: map['domainName'] as String,
      expireTime: map['expireTime'] as String,
      issues: (map['issues'] as List).cast<String>(),
      labels: (map['labels'] as Map).cast<String, String>(),
      managementSettings: ManagementSettingsResponseDomainsV1beta1.fromMap((map['managementSettings']! as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      pendingContactSettings: ContactSettingsResponseDomainsV1beta1.fromMap((map['pendingContactSettings']! as Map).cast<String, dynamic>()),
