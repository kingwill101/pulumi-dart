...
class GoogleDomainsDnsResponse {
  ...
  factory GoogleDomainsDnsResponse.fromMap(Map<String, dynamic> map) {
    return GoogleDomainsDnsResponse(
      dsRecords: (pulumi.Input.decodeList<DsRecordResponse>(map['dsRecords'], (value) => DsRecordResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      dsState: (map['dsState'] as String).input(),
