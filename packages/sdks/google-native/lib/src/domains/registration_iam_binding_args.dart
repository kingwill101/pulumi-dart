...
/// {@template pulumi_domains_v1_registration_iam_binding_args_doc}
/// The set of arguments for RegistrationIamBinding.
/// {@endtemplate}
/// {@macro pulumi_domains_v1_registration_iam_binding_args_doc}
class RegistrationIamBindingArgs {
  ...
  /// Creates a new [RegistrationIamBindingArgs].
  ...
  const RegistrationIamBindingArgs({
    this.condition,
  ...
  factory RegistrationIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return RegistrationIamBindingArgs(
