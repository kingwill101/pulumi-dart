...
class GoogleDomainsDnsResponseDomainsV1beta1 {
  ...
  factory GoogleDomainsDnsResponseDomainsV1beta1.fromMap(Map<String, dynamic> map) {
    return GoogleDomainsDnsResponseDomainsV1beta1(
      dsRecords: pulumi.Input.fromValue(pulumi.Input.decodeList<DsRecordResponseDomainsV1beta1>(map['dsRecords']!, (value) => DsRecordResponseDomainsV1beta1.fromMap((value as Map).cast<String, dynamic>()))),
