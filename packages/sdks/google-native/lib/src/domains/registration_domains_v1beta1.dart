...
class RegistrationDomainsV1beta1 extends pulumi.CustomResource {
  ...
  RegistrationDomainsV1beta1(
    ...
    this.contactSettings = registerOutput<ContactSettingsResponseDomainsV1beta1>('contactSettings');
    this.createTime = registerOutput<String>('createTime');
    this.dnsSettings = registerOutput<DnsSettingsResponseDomainsV1beta1>('dnsSettings');
    this.domainName = registerOutput<String>('domainName');
    this.expireTime = registerOutput<String>('expireTime');
    this.issues = registerOutput<List<String>>('issues');
    this.labels = registerOutput<Map<String, String>>('labels');
    this.location = registerOutput<String>('location');
    this.managementSettings = registerOutput<ManagementSettingsResponseDomainsV1beta1>('managementSettings');
    this.name = registerOutput<String>('name');
    this.pendingContactSettings = registerOutput<ContactSettingsResponseDomainsV1beta1>('pendingContactSettings');
