...
class ExprResponseDomainsV1beta1 {
  ...
  /// Creates a new [ExprResponseDomainsV1beta1].
  ...
  const ExprResponseDomainsV1beta1({
  ...
  factory ExprResponseDomainsV1beta1.fromMap(Map<String, dynamic> map) {
    return ExprResponseDomainsV1beta1(
