...
class AuditConfigDomainsV1alpha2 {
  ...
  factory AuditConfigDomainsV1alpha2.fromMap(Map<String, dynamic> map) {
    return AuditConfigDomainsV1alpha2(
      auditLogConfigs: (() { final guardedValue = map['auditLogConfigs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AuditLogConfigDomainsV1alpha2>(guardedValue, (value) => AuditLogConfigDomainsV1alpha2.fromMap((value as Map).cast<String, dynamic>()))); })(),
