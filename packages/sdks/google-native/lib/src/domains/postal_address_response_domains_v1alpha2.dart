...
class PostalAddressResponseDomainsV1alpha2 {
  ...
  factory PostalAddressResponseDomainsV1alpha2.fromMap(
    Map<String, dynamic> map,
  ) {
    return PostalAddressResponseDomainsV1alpha2(
      addressLines: pulumi.Input.fromValue(
        (map['addressLines'] as List).cast<String>(),
      ),
      administrativeArea: pulumi.Input.fromValue(
      ...
      recipients: pulumi.Input.fromValue(
