...
class PostalAddressResponseDomainsV1alpha2 {
  ...
  /// Creates a new [PostalAddressResponseDomainsV1alpha2].
  ...
  const PostalAddressResponseDomainsV1alpha2({
  ...
  factory PostalAddressResponseDomainsV1alpha2.fromMap(Map<String, dynamic> map) {
    return PostalAddressResponseDomainsV1alpha2(
      addressLines: pulumi.Input.fromValue((map['addressLines'] as List).cast<String>()),
      administrativeArea: pulumi.Input.fromValue(map['administrativeArea'] as String),
      ...
      recipients: pulumi.Input.fromValue((map['recipients'] as List).cast<String>()),
      regionCode: pulumi.Input.fromValue(map['regionCode'] as String),
      revision: pulumi.Input.fromValue(map['revision'] as int),
      sortingCode: pulumi.Input.fromValue(map['sortingCode'] as String),
      sublocality: pulumi.Input.fromValue(map['sublocality'] as String),
    );
  }
}
