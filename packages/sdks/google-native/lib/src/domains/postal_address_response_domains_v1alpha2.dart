...
class PostalAddressResponseDomainsV1alpha2 {
  ...
  factory PostalAddressResponseDomainsV1alpha2.fromMap(Map<String, dynamic> map) {
    return PostalAddressResponseDomainsV1alpha2(
      addressLines: ((map['addressLines'] as List).cast<String>()).input(),
      administrativeArea: (map['administrativeArea'] as String).input(),
      ...
      recipients: ((map['recipients'] as List).cast<String>()).input(),
      regionCode: (map['regionCode'] as String).input(),
      revision: (map['revision'] as int).input(),
      sortingCode: (map['sortingCode'] as String).input(),
      sublocality: (map['sublocality'] as String).input(),
    );
  }
}
