...
class ExprDomainsV1beta1 {
  ...
  /// Creates a new [ExprDomainsV1beta1].
  ...
  factory ExprDomainsV1beta1.fromMap(Map<String, dynamic> map) {
    return ExprDomainsV1beta1(
