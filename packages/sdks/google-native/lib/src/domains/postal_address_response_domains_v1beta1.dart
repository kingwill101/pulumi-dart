...
class PostalAddressResponseDomainsV1beta1 {
  ...
  /// Creates a new [PostalAddressResponseDomainsV1beta1].
  ...
  const PostalAddressResponseDomainsV1beta1({
  ...
  factory PostalAddressResponseDomainsV1beta1.fromMap(Map<String, dynamic> map) {
    return PostalAddressResponseDomainsV1beta1(
