...
class DnsSettingsDomainsV1alpha2 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'glueRecords': ?glueRecords == null ? null : pulumi.Input.encodeList<GlueRecordDomainsV1alpha2, Map<String, dynamic>>(glueRecords!, (value) => value.toMap()),
  ...
  factory DnsSettingsDomainsV1alpha2.fromMap(Map<String, dynamic> map) {
    return DnsSettingsDomainsV1alpha2(
      customDns: map['customDns'] == null ? null : CustomDnsDomainsV1alpha2.fromMap((map['customDns'] as Map).cast<String, dynamic>()),
      glueRecords: map['glueRecords'] == null ? null : pulumi.Input.decodeList<GlueRecordDomainsV1alpha2>(map['glueRecords'], (value) => GlueRecordDomainsV1alpha2.fromMap((value as Map).cast<String, dynamic>())),
      googleDomainsDns: map['googleDomainsDns'] == null ? null : GoogleDomainsDnsDomainsV1alpha2.fromMap((map['googleDomainsDns'] as Map).cast<String, dynamic>()),
    );
  }
}
