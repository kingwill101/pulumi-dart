...
class GetRegistrationDomainsV1alpha2Result {
  ...
  factory GetRegistrationDomainsV1alpha2Result.fromMap(
    Map<String, dynamic> map,
  ) {
    return GetRegistrationDomainsV1alpha2Result(
      contactSettings: ContactSettingsResponseDomainsV1alpha2.fromMap(
        (map['contactSettings']! as Map).cast<String, dynamic>(),
      ),
      createTime: map['createTime'] as String,
      dnsSettings: DnsSettingsResponseDomainsV1alpha2.fromMap(
      ...
      managementSettings: ManagementSettingsResponseDomainsV1alpha2.fromMap(
        (map['managementSettings']! as Map).cast<String, dynamic>(),
      ),
      name: map['name'] as String,
      pendingContactSettings: ContactSettingsResponseDomainsV1alpha2.fromMap(
