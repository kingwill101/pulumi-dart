...
class GetRegistrationDomainsV1alpha2Result {
  /// Settings for contact information linked to the `Registration`. You cannot update these with the `UpdateRegistration` method. To update these settings, use the `ConfigureContactSettings` method.
  final ContactSettingsResponseDomainsV1alpha2 contactSettings;
  /// The creation timestamp of the `Registration` resource.
  final String createTime;
  /// Settings controlling the DNS configuration of the `Registration`. You cannot update these with the `UpdateRegistration` method. To update these settings, use the `ConfigureDnsSettings` method.
  final DnsSettingsResponseDomainsV1alpha2 dnsSettings;
  ...
  final ManagementSettingsResponseDomainsV1alpha2 managementSettings;
  ...
  final ContactSettingsResponseDomainsV1alpha2 pendingContactSettings;
  ...
  /// Creates a new [GetRegistrationDomainsV1alpha2Result].
  ...
  const GetRegistrationDomainsV1alpha2Result({
  ...
  factory GetRegistrationDomainsV1alpha2Result.fromMap(Map<String, dynamic> map) {
    return GetRegistrationDomainsV1alpha2Result(
      contactSettings: ContactSettingsResponseDomainsV1alpha2.fromMap((map['contactSettings']! as Map).cast<String, dynamic>()),
      createTime: map['createTime'] as String,
      dnsSettings: DnsSettingsResponseDomainsV1alpha2.fromMap((map['dnsSettings']! as Map).cast<String, dynamic>()),
      domainName: map['domainName'] as String,
      expireTime: map['expireTime'] as String,
      issues: (map['issues'] as List).cast<String>(),
      labels: (map['labels'] as Map).cast<String, String>(),
      managementSettings: ManagementSettingsResponseDomainsV1alpha2.fromMap((map['managementSettings']! as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      pendingContactSettings: ContactSettingsResponseDomainsV1alpha2.fromMap((map['pendingContactSettings']! as Map).cast<String, dynamic>()),
