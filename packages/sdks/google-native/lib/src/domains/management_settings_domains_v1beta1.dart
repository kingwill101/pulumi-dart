...
class ManagementSettingsDomainsV1beta1 {
  ...
  final pulumi.Input<ManagementSettingsPreferredRenewalMethodDomainsV1beta1>?
  preferredRenewalMethod;

  /// Controls whether the domain can be transferred to another registrar.
  final pulumi.Input<ManagementSettingsTransferLockStateDomainsV1beta1>?
  transferLockState;
    ...
    return <String, dynamic>{
      'preferredRenewalMethod':
          ?pulumi.Input.mapOptionalInputValue<
            ManagementSettingsPreferredRenewalMethodDomainsV1beta1,
            String
          >(preferredRenewalMethod, (value) => value.wireValue),
      'transferLockState':
          ?pulumi.Input.mapOptionalInputValue<
            ManagementSettingsTransferLockStateDomainsV1beta1,
            String
