...
class GoogleDomainsDnsResponseDomainsV1alpha2 {
  ...
  const GoogleDomainsDnsResponseDomainsV1alpha2({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'dsRecords': pulumi.Input.mapInputValue<List<DsRecordResponseDomainsV1alpha2>, List<Map<String, dynamic>>>(dsRecords, (value) => pulumi.Input.encodeList<DsRecordResponseDomainsV1alpha2, Map<String, dynamic>>(value, (value) => value.toMap())),
      'dsState': dsState,
      'nameServers': nameServers,
    };
  }

  factory GoogleDomainsDnsResponseDomainsV1alpha2.fromMap(Map<String, dynamic> map) {
    return GoogleDomainsDnsResponseDomainsV1alpha2(
      dsRecords: pulumi.Input.fromValue(pulumi.Input.decodeList<DsRecordResponseDomainsV1alpha2>(map['dsRecords']!, (value) => DsRecordResponseDomainsV1alpha2.fromMap((value as Map).cast<String, dynamic>()))),
