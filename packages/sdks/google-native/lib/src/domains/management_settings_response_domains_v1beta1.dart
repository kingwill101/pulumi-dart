...
class ManagementSettingsResponseDomainsV1beta1 {
  ...
  const ManagementSettingsResponseDomainsV1beta1({
  ...
  factory ManagementSettingsResponseDomainsV1beta1.fromMap(Map<String, dynamic> map) {
    return ManagementSettingsResponseDomainsV1beta1(
      preferredRenewalMethod: pulumi.Input.fromValue(map['preferredRenewalMethod'] as String),
      renewalMethod: pulumi.Input.fromValue(map['renewalMethod'] as String),
      transferLockState: pulumi.Input.fromValue(map['transferLockState'] as String),
    );
  }
}
