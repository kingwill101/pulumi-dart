    ...
    return RegistrationDomainsV1alpha2Args(
      contactNotices: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<RegistrationContactNoticesItemDomainsV1alpha2>(
            guardedValue,
            (value) => RegistrationContactNoticesItemDomainsV1alpha2.fromValue(
              value as String,
            ),
          ),
        );
      ...
      contactSettings: pulumi.Input.fromValue(
        ContactSettingsDomainsV1alpha2.fromMap(
      ...
      domainNotices: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RegistrationDomainNoticesItemDomainsV1alpha2>(
            guardedValue,
