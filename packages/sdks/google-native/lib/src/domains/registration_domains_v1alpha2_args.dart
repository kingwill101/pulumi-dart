...
class RegistrationDomainsV1alpha2Args {
  ...
  const RegistrationDomainsV1alpha2Args({
    this.contactNotices,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'contactNotices': ?pulumi.Input.mapOptionalInputValue<List<RegistrationContactNoticesItemDomainsV1alpha2>, List<String>>(contactNotices, (value) => pulumi.Input.encodeList<RegistrationContactNoticesItemDomainsV1alpha2, String>(value, (value) => value.wireValue)),
      ...
      'domainNotices': ?pulumi.Input.mapOptionalInputValue<List<RegistrationDomainNoticesItemDomainsV1alpha2>, List<String>>(domainNotices, (value) => pulumi.Input.encodeList<RegistrationDomainNoticesItemDomainsV1alpha2, String>(value, (value) => value.wireValue)),
      'labels': ?labels,
      'location': ?location,
  ...
  factory RegistrationDomainsV1alpha2Args.fromMap(Map<String, dynamic> map) {
    return RegistrationDomainsV1alpha2Args(
      contactNotices: (() { final guardedValue = map['contactNotices']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RegistrationContactNoticesItemDomainsV1alpha2>(guardedValue, (value) => RegistrationContactNoticesItemDomainsV1alpha2.fromValue(value as String))); })(),
      contactSettings: pulumi.Input.fromValue(ContactSettingsDomainsV1alpha2.fromMap((map['contactSettings']! as Map).cast<String, dynamic>())),
      dnsSettings: (() { final guardedValue = map['dnsSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DnsSettingsDomainsV1alpha2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      domainName: pulumi.Input.fromValue(map['domainName'] as String),
      domainNotices: (() { final guardedValue = map['domainNotices']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RegistrationDomainNoticesItemDomainsV1alpha2>(guardedValue, (value) => RegistrationDomainNoticesItemDomainsV1alpha2.fromValue(value as String))); })(),
      labels: (() { final guardedValue = map['labels']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      location: (() { final guardedValue = map['location']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      managementSettings: (() { final guardedValue = map['managementSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagementSettingsDomainsV1alpha2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      yearlyPrice: pulumi.Input.fromValue(MoneyDomainsV1alpha2.fromMap((map['yearlyPrice']! as Map).cast<String, dynamic>())),
    );
  }
}
