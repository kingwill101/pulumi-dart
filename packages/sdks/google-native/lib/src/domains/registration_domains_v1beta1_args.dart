    ...
    return RegistrationDomainsV1beta1Args(
      contactNotices: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RegistrationContactNoticesItemDomainsV1beta1>(
            guardedValue,
      ...
      contactSettings: pulumi.Input.fromValue(
        ContactSettingsDomainsV1beta1.fromMap(
      ...
      domainNotices: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RegistrationDomainNoticesItemDomainsV1beta1>(
            guardedValue,
