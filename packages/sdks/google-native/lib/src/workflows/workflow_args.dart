...
class WorkflowArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'callLogLevel': ?pulumi.Input.mapOptionalInputValue<WorkflowCallLogLevel, String>(callLogLevel, (value) => value.wireValue),
  ...
  factory WorkflowArgs.fromMap(Map<String, dynamic> map) {
    return WorkflowArgs(
      callLogLevel: (() { final guardedValue = map['callLogLevel']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WorkflowCallLogLevel.fromValue(guardedValue as String)); })(),
