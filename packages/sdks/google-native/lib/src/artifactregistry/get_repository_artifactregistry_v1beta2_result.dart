...
class GetRepositoryArtifactregistryV1beta2Result {
  ...
  const GetRepositoryArtifactregistryV1beta2Result({
  ...
  factory GetRepositoryArtifactregistryV1beta2Result.fromMap(Map<String, dynamic> map) {
    return GetRepositoryArtifactregistryV1beta2Result(
      ...
      mavenConfig: MavenRepositoryConfigResponseArtifactregistryV1beta2.fromMap((map['mavenConfig']! as Map).cast<String, dynamic>()),
