...
class ExprArtifactregistryV1beta2 {
  ...
  /// Creates a new [ExprArtifactregistryV1beta2].
  ...
  const ExprArtifactregistryV1beta2({
    this.description,
    this.expression,
    this.location,
    this.title,
  ...
  factory ExprArtifactregistryV1beta2.fromMap(Map<String, dynamic> map) {
    return ExprArtifactregistryV1beta2(
