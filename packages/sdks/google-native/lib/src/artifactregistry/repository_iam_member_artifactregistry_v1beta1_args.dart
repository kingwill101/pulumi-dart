...
/// {@template pulumi_artifactregistry_v1beta1_repository_iam_member_artifactregistry_v1beta1_args_doc}
/// The set of arguments for RepositoryIamMember.
/// {@endtemplate}
/// {@macro pulumi_artifactregistry_v1beta1_repository_iam_member_artifactregistry_v1beta1_args_doc}
class RepositoryIamMemberArtifactregistryV1beta1Args {
  ...
  /// Creates a new [RepositoryIamMemberArtifactregistryV1beta1Args].
  ...
  const RepositoryIamMemberArtifactregistryV1beta1Args({
    this.condition,
  ...
  factory RepositoryIamMemberArtifactregistryV1beta1Args.fromMap(Map<String, dynamic> map) {
