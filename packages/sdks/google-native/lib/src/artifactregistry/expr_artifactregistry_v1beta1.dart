...
class ExprArtifactregistryV1beta1 {
  ...
  /// Creates a new [ExprArtifactregistryV1beta1].
  ...
  const ExprArtifactregistryV1beta1({
    this.description,
    this.expression,
    this.location,
    this.title,
  ...
  factory ExprArtifactregistryV1beta1.fromMap(Map<String, dynamic> map) {
    return ExprArtifactregistryV1beta1(
