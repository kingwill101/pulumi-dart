...
class PythonRepository {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'publicRepository': ?pulumi.Input.mapOptionalInputValue<PythonRepositoryPublicRepository, String>(publicRepository, (value) => value.wireValue),
    };
  }

  factory PythonRepository.fromMap(Map<String, dynamic> map) {
    return PythonRepository(
      publicRepository: (() { final guardedValue = map['publicRepository']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PythonRepositoryPublicRepository.fromValue(guardedValue as String)); })(),
    );
  }
}
