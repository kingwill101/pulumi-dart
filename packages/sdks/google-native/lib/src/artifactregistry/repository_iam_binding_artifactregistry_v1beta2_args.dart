...
/// {@template pulumi_artifactregistry_v1beta2_repository_iam_binding_artifactregistry_v1beta2_args_doc}
/// The set of arguments for RepositoryIamBinding.
/// {@endtemplate}
/// {@macro pulumi_artifactregistry_v1beta2_repository_iam_binding_artifactregistry_v1beta2_args_doc}
class RepositoryIamBindingArtifactregistryV1beta2Args {
  ...
  /// Creates a new [RepositoryIamBindingArtifactregistryV1beta2Args].
  ...
  const RepositoryIamBindingArtifactregistryV1beta2Args({
    this.condition,
  ...
  factory RepositoryIamBindingArtifactregistryV1beta2Args.fromMap(Map<String, dynamic> map) {
