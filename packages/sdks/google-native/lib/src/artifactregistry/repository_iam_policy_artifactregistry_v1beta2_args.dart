...
class RepositoryIamPolicyArtifactregistryV1beta2Args {
  ...
  RepositoryIamPolicyArtifactregistryV1beta2Args({
    pulumi.Output<List<BindingArtifactregistryV1beta2>>? bindings,
    ...
    pulumi.Output<int>? version,
      ...
      bindings = pulumi.Input.asOptionalInput<List<BindingArtifactregistryV1beta2>>(bindings),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'bindings': ?pulumi.Input.mapOptionalInputValue<List<BindingArtifactregistryV1beta2>, List<Map<String, dynamic>>>(bindings, (value) => pulumi.Input.encodeList<BindingArtifactregistryV1beta2, Map<String, dynamic>>(value, (value) => value.toMap())),
      'etag': ?etag,
      'location': ?location,
      'project': ?project,
  ...
  factory RepositoryIamPolicyArtifactregistryV1beta2Args.fromMap(Map<String, dynamic> map) {
    return RepositoryIamPolicyArtifactregistryV1beta2Args(
      bindings: map['bindings'] == null ? null : pulumi.Output.create<List<BindingArtifactregistryV1beta2>>(pulumi.Input.decodeList<BindingArtifactregistryV1beta2>(map['bindings'], (value) => BindingArtifactregistryV1beta2.fromMap((value as Map).cast<String, dynamic>()))),
