...
class RepositoryArtifactregistryV1beta2Args {
  ...
  const RepositoryArtifactregistryV1beta2Args({
    this.description,
    this.format,
    this.kmsKeyName,
    this.labels,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'format': ?pulumi.Input.mapOptionalInputValue<RepositoryFormatArtifactregistryV1beta2, String>(format, (value) => value.wireValue),
  ...
  factory RepositoryArtifactregistryV1beta2Args.fromMap(Map<String, dynamic> map) {
    return RepositoryArtifactregistryV1beta2Args(
      ...
      format: (() { final guardedValue = map['format']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RepositoryFormatArtifactregistryV1beta2.fromValue(guardedValue as String)); })(),
      kmsKeyName: (() { final guardedValue = map['kmsKeyName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      labels: (() { final guardedValue = map['labels']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      location: (() { final guardedValue = map['location']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      mavenConfig: (() { final guardedValue = map['mavenConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MavenRepositoryConfigArtifactregistryV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
