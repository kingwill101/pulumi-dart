...
/// {@template pulumi_artifactregistry_v1beta1_repository_iam_binding_artifactregistry_v1beta1_args_doc}
/// The set of arguments for RepositoryIamBinding.
/// {@endtemplate}
/// {@macro pulumi_artifactregistry_v1beta1_repository_iam_binding_artifactregistry_v1beta1_args_doc}
class RepositoryIamBindingArtifactregistryV1beta1Args {
  ...
  /// Creates a new [RepositoryIamBindingArtifactregistryV1beta1Args].
  ...
  const RepositoryIamBindingArtifactregistryV1beta1Args({
    this.condition,
  ...
  factory RepositoryIamBindingArtifactregistryV1beta1Args.fromMap(Map<String, dynamic> map) {
    return RepositoryIamBindingArtifactregistryV1beta1Args(
