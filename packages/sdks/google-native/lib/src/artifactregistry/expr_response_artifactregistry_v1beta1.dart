...
class ExprResponseArtifactregistryV1beta1 {
  ...
  /// Creates a new [ExprResponseArtifactregistryV1beta1].
  ...
  const ExprResponseArtifactregistryV1beta1({
  ...
  factory ExprResponseArtifactregistryV1beta1.fromMap(Map<String, dynamic> map) {
    return ExprResponseArtifactregistryV1beta1(
