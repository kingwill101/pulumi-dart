...
class YumRepository {
  ...
  final GoogleDevtoolsArtifactregistryV1RemoteRepositoryConfigYumRepositoryPublicRepository? publicRepository;
  ...
  factory YumRepository.fromMap(Map<String, dynamic> map) {
    return YumRepository(
      publicRepository: map['publicRepository'] == null ? null : GoogleDevtoolsArtifactregistryV1RemoteRepositoryConfigYumRepositoryPublicRepository.fromMap((map['publicRepository'] as Map).cast<String, dynamic>()),
    );
  }
}
