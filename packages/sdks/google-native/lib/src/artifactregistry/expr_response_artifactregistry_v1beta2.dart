...
class ExprResponseArtifactregistryV1beta2 {
  ...
  /// Creates a new [ExprResponseArtifactregistryV1beta2].
  ...
  const ExprResponseArtifactregistryV1beta2({
  ...
  factory ExprResponseArtifactregistryV1beta2.fromMap(Map<String, dynamic> map) {
    return ExprResponseArtifactregistryV1beta2(
