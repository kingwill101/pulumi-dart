...
class GetTagArtifactregistryV1beta2Result {
  ...
  const GetTagArtifactregistryV1beta2Result({
    required this.name,
  ...
  factory GetTagArtifactregistryV1beta2Result.fromMap(Map<String, dynamic> map) {
    return GetTagArtifactregistryV1beta2Result(
