...
class RepositoryArtifactregistryV1beta1Args {
  ...
  RepositoryArtifactregistryV1beta1Args({
    ...
    pulumi.Output<RepositoryFormatArtifactregistryV1beta1>? format,
  ...
  factory RepositoryArtifactregistryV1beta1Args.fromMap(Map<String, dynamic> map) {
    return RepositoryArtifactregistryV1beta1Args(
      ...
      format: map['format'] == null ? null : pulumi.Output.create<RepositoryFormatArtifactregistryV1beta1>(RepositoryFormatArtifactregistryV1beta1.fromValue(map['format'] as String)),
