...
class YumRepositoryResponse {
  ...
  factory YumRepositoryResponse.fromMap(Map<String, dynamic> map) {
    return YumRepositoryResponse(
      publicRepository: (GoogleDevtoolsArtifactregistryV1RemoteRepositoryConfigYumRepositoryPublicRepositoryResponse.fromMap((map['publicRepository'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
