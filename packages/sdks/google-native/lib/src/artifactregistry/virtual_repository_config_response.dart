...
class VirtualRepositoryConfigResponse {
  ...
  factory VirtualRepositoryConfigResponse.fromMap(Map<String, dynamic> map) {
    return VirtualRepositoryConfigResponse(
      upstreamPolicies: pulumi.Input.fromValue(pulumi.Input.decodeList<UpstreamPolicyResponse>(map['upstreamPolicies']!, (value) => UpstreamPolicyResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
