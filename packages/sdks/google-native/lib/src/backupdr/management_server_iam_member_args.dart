...
/// {@template pulumi_backupdr_v1_management_server_iam_member_args_doc}
/// The set of arguments for ManagementServerIamMember.
/// {@endtemplate}
/// {@macro pulumi_backupdr_v1_management_server_iam_member_args_doc}
class ManagementServerIamMemberArgs {
  ...
  /// Creates a new [ManagementServerIamMemberArgs].
  ...
  const ManagementServerIamMemberArgs({
    this.condition,
