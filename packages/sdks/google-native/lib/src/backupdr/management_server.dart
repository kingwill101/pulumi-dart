...
class ManagementServer extends pulumi.CustomResource {
  ...
  ManagementServer(
    ...
    this.workforceIdentityBasedManagementUri = registerOutput<WorkforceIdentityBasedManagementURIResponse>('workforceIdentityBasedManagementUri');
    this.workforceIdentityBasedOauth2ClientId = registerOutput<WorkforceIdentityBasedOAuth2ClientIDResponse>('workforceIdentityBasedOauth2ClientId');
  }
}
