...
class NetworkConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'network': ?network,
      'peeringMode':
          ?pulumi.Input.mapOptionalInputValue<NetworkConfigPeeringMode, String>(
            peeringMode,
  ...
  factory NetworkConfig.fromMap(Map<String, dynamic> map) {
    return NetworkConfig(
      ...
      peeringMode: (() {
        final guardedValue = map['peeringMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          NetworkConfigPeeringMode.fromValue(guardedValue as String),
        );
      })(),
    );
  }
