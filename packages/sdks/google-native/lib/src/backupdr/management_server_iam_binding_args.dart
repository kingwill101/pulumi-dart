...
/// {@template pulumi_backupdr_v1_management_server_iam_binding_args_doc}
/// The set of arguments for ManagementServerIamBinding.
/// {@endtemplate}
/// {@macro pulumi_backupdr_v1_management_server_iam_binding_args_doc}
class ManagementServerIamBindingArgs {
  ...
  /// Creates a new [ManagementServerIamBindingArgs].
  ...
  const ManagementServerIamBindingArgs({
    this.condition,
  ...
  factory ManagementServerIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return ManagementServerIamBindingArgs(
