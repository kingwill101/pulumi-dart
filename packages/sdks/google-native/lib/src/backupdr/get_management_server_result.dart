...
class GetManagementServerResult {
  ...
  final WorkforceIdentityBasedManagementURIResponse
  workforceIdentityBasedManagementUri;

  /// The OAuth client IDs for both types of user i.e. 1p and 3p.
  final WorkforceIdentityBasedOAuth2ClientIDResponse
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'workforceIdentityBasedManagementUri': workforceIdentityBasedManagementUri
          .toMap(),
      'workforceIdentityBasedOauth2ClientId':
          workforceIdentityBasedOauth2ClientId.toMap(),
    };
  }
  ...
  factory GetManagementServerResult.fromMap(Map<String, dynamic> map) {
    return GetManagementServerResult(
      ...
      workforceIdentityBasedManagementUri:
          WorkforceIdentityBasedManagementURIResponse.fromMap(
            (map['workforceIdentityBasedManagementUri']! as Map)
                .cast<String, dynamic>(),
          ),
      workforceIdentityBasedOauth2ClientId:
          WorkforceIdentityBasedOAuth2ClientIDResponse.fromMap(
            (map['workforceIdentityBasedOauth2ClientId']! as Map)
                .cast<String, dynamic>(),
          ),
    );
  }
