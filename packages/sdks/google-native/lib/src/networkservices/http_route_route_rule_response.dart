...
class HttpRouteRouteRuleResponse {
  ...
  const HttpRouteRouteRuleResponse({
  ...
  factory HttpRouteRouteRuleResponse.fromMap(Map<String, dynamic> map) {
    return HttpRouteRouteRuleResponse(
      action: pulumi.Input.fromValue(HttpRouteRouteActionResponse.fromMap((map['action']! as Map).cast<String, dynamic>())),
      matches: pulumi.Input.fromValue(pulumi.Input.decodeList<HttpRouteRouteMatchResponse>(map['matches']!, (value) => HttpRouteRouteMatchResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
