...
class TlsRouteRouteRuleResponseNetworkservicesV1beta1 {
  ...
  const TlsRouteRouteRuleResponseNetworkservicesV1beta1({
  ...
  factory TlsRouteRouteRuleResponseNetworkservicesV1beta1.fromMap(Map<String, dynamic> map) {
    return TlsRouteRouteRuleResponseNetworkservicesV1beta1(
      action: pulumi.Input.fromValue(TlsRouteRouteActionResponseNetworkservicesV1beta1.fromMap((map['action']! as Map).cast<String, dynamic>())),
      matches: pulumi.Input.fromValue(pulumi.Input.decodeList<TlsRouteRouteMatchResponseNetworkservicesV1beta1>(map['matches']!, (value) => TlsRouteRouteMatchResponseNetworkservicesV1beta1.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
