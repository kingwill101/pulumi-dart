...
class ExtensionChainExtension {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': name,
      'service': service,
      'supportedEvents': ?pulumi.Input.mapOptionalInputValue<List<ExtensionChainExtensionSupportedEventsItem>, List<String>>(supportedEvents, (value) => pulumi.Input.encodeList<ExtensionChainExtensionSupportedEventsItem, String>(value, (value) => value.value)),
      'timeout': timeout,
    };
  }
