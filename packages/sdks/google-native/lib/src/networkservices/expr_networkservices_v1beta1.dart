...
class ExprNetworkservicesV1beta1 {
  ...
  /// Creates a new [ExprNetworkservicesV1beta1].
  ...
  const ExprNetworkservicesV1beta1({
    this.description,
    this.expression,
    this.location,
    this.title,
  ...
  factory ExprNetworkservicesV1beta1.fromMap(Map<String, dynamic> map) {
    return ExprNetworkservicesV1beta1(
