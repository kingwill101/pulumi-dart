...
class EndpointMatcherMetadataLabelMatcherResponse {
  ...
  const EndpointMatcherMetadataLabelMatcherResponse({
  ...
  factory EndpointMatcherMetadataLabelMatcherResponse.fromMap(Map<String, dynamic> map) {
    return EndpointMatcherMetadataLabelMatcherResponse(
      ...
      metadataLabels: pulumi.Input.fromValue(pulumi.Input.decodeList<EndpointMatcherMetadataLabelMatcherMetadataLabelsResponse>(map['metadataLabels']!, (value) => EndpointMatcherMetadataLabelMatcherMetadataLabelsResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
