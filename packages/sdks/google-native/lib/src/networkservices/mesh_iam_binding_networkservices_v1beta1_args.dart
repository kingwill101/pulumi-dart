...
/// {@template pulumi_networkservices_v1beta1_mesh_iam_binding_networkservices_v1beta1_args_doc}
/// The set of arguments for MeshIamBinding.
/// {@endtemplate}
/// {@macro pulumi_networkservices_v1beta1_mesh_iam_binding_networkservices_v1beta1_args_doc}
class MeshIamBindingNetworkservicesV1beta1Args {
  ...
  /// Creates a new [MeshIamBindingNetworkservicesV1beta1Args].
  ...
  const MeshIamBindingNetworkservicesV1beta1Args({
    this.condition,
  ...
  factory MeshIamBindingNetworkservicesV1beta1Args.fromMap(Map<String, dynamic> map) {
    return MeshIamBindingNetworkservicesV1beta1Args(
