...
class GetHttpRouteResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'meshes': meshes,
      'name': name,
      'rules': pulumi.Input.encodeList<HttpRouteRouteRuleResponse, Map<String, dynamic>>(rules, (value) => value.toMap()),
      'selfLink': selfLink,
  ...
  factory GetHttpRouteResult.fromMap(Map<String, dynamic> map) {
    return GetHttpRouteResult(
      ...
      rules: pulumi.Input.decodeList<HttpRouteRouteRuleResponse>(map['rules']!, (value) => HttpRouteRouteRuleResponse.fromMap((value as Map).cast<String, dynamic>())),
