...
class ExtensionChainResponse {
  ...
  factory ExtensionChainResponse.fromMap(Map<String, dynamic> map) {
    return ExtensionChainResponse(
      extensions: (pulumi.Input.decodeList<ExtensionChainExtensionResponse>(map['extensions'], (value) => ExtensionChainExtensionResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      matchCondition: (ExtensionChainMatchConditionResponse.fromMap((map['matchCondition'] as Map).cast<String, dynamic>())).input(),
