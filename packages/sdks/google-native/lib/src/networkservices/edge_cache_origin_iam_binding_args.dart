...
/// {@template pulumi_networkservices_v1_edge_cache_origin_iam_binding_args_doc}
/// The set of arguments for EdgeCacheOriginIamBinding.
/// {@endtemplate}
/// {@macro pulumi_networkservices_v1_edge_cache_origin_iam_binding_args_doc}
class EdgeCacheOriginIamBindingArgs {
  ...
  /// Creates a new [EdgeCacheOriginIamBindingArgs].
  ...
  const EdgeCacheOriginIamBindingArgs({
    this.condition,
  ...
  factory EdgeCacheOriginIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return EdgeCacheOriginIamBindingArgs(
