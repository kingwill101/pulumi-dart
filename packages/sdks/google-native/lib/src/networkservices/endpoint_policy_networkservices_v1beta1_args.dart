...
class EndpointPolicyNetworkservicesV1beta1Args {
    ...
    return <String, dynamic>{
      ...
      'trafficPortSelector':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(trafficPortSelector, (value) => value.toMap()),
      'type':
          pulumi.Input.mapInputValue<
  ...
  factory EndpointPolicyNetworkservicesV1beta1Args.fromMap(
    ...
    return EndpointPolicyNetworkservicesV1beta1Args(
      ...
      endpointMatcher: pulumi.Input.fromValue(
        EndpointMatcherNetworkservicesV1beta1.fromMap(
      ...
      trafficPortSelector: (() {
        final guardedValue = map['trafficPortSelector'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TrafficPortSelectorNetworkservicesV1beta1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      type: pulumi.Input.fromValue(
        EndpointPolicyTypeNetworkservicesV1beta1.fromValue(
          map['type']! as String,
        ),
      ),
    );
