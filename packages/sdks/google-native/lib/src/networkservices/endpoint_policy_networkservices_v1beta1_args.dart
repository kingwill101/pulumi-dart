...
class EndpointPolicyNetworkservicesV1beta1Args {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'type': pulumi.Input.mapInputValue<EndpointPolicyTypeNetworkservicesV1beta1, String>(type, (value) => value.wireValue),
    };
  }
  ...
  factory EndpointPolicyNetworkservicesV1beta1Args.fromMap(Map<String, dynamic> map) {
    return EndpointPolicyNetworkservicesV1beta1Args(
      ...
      endpointMatcher: pulumi.Input.fromValue(EndpointMatcherNetworkservicesV1beta1.fromMap((map['endpointMatcher']! as Map).cast<String, dynamic>())),
      ...
      trafficPortSelector: (() { final guardedValue = map['trafficPortSelector']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TrafficPortSelectorNetworkservicesV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      type: pulumi.Input.fromValue(EndpointPolicyTypeNetworkservicesV1beta1.fromValue(map['type']! as String)),
    );
  }
}
