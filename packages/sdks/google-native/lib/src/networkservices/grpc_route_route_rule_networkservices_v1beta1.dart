...
class GrpcRouteRouteRuleNetworkservicesV1beta1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'action': action.toMap(),
      'matches': ?matches == null ? null : pulumi.Input.encodeList<GrpcRouteRouteMatchNetworkservicesV1beta1, Map<String, dynamic>>(matches!, (value) => value.toMap()),
    };
  }
  ...
  factory GrpcRouteRouteRuleNetworkservicesV1beta1.fromMap(Map<String, dynamic> map) {
    return GrpcRouteRouteRuleNetworkservicesV1beta1(
      action: GrpcRouteRouteActionNetworkservicesV1beta1.fromMap((map['action'] as Map).cast<String, dynamic>()),
      matches: map['matches'] == null ? null : pulumi.Input.decodeList<GrpcRouteRouteMatchNetworkservicesV1beta1>(map['matches'], (value) => GrpcRouteRouteMatchNetworkservicesV1beta1.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
