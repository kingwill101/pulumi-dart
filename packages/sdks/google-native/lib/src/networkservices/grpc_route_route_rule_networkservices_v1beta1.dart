...
class GrpcRouteRouteRuleNetworkservicesV1beta1 {
  ...
  const GrpcRouteRouteRuleNetworkservicesV1beta1({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'action': pulumi.Input.mapInputValue<GrpcRouteRouteActionNetworkservicesV1beta1, Map<String, dynamic>>(action, (value) => value.toMap()),
      'matches': ?pulumi.Input.mapOptionalInputValue<List<GrpcRouteRouteMatchNetworkservicesV1beta1>, List<Map<String, dynamic>>>(matches, (value) => pulumi.Input.encodeList<GrpcRouteRouteMatchNetworkservicesV1beta1, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory GrpcRouteRouteRuleNetworkservicesV1beta1.fromMap(Map<String, dynamic> map) {
    return GrpcRouteRouteRuleNetworkservicesV1beta1(
      action: pulumi.Input.fromValue(GrpcRouteRouteActionNetworkservicesV1beta1.fromMap((map['action']! as Map).cast<String, dynamic>())),
      matches: (() { final guardedValue = map['matches']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GrpcRouteRouteMatchNetworkservicesV1beta1>(guardedValue, (value) => GrpcRouteRouteMatchNetworkservicesV1beta1.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
