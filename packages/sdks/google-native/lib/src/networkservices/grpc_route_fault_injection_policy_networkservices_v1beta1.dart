...
class GrpcRouteFaultInjectionPolicyNetworkservicesV1beta1 {
  ...
  final pulumi.Input<GrpcRouteFaultInjectionPolicyAbortNetworkservicesV1beta1>?
  abort;

  /// The specification for injecting delay to client requests.
  final pulumi.Input<GrpcRouteFaultInjectionPolicyDelayNetworkservicesV1beta1>?
  delay;
