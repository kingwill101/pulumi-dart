...
/// {@template pulumi_networkservices_v1beta1_endpoint_policy_iam_binding_networkservices_v1beta1_args_doc}
/// The set of arguments for EndpointPolicyIamBinding.
/// {@endtemplate}
/// {@macro pulumi_networkservices_v1beta1_endpoint_policy_iam_binding_networkservices_v1beta1_args_doc}
class EndpointPolicyIamBindingNetworkservicesV1beta1Args {
  ...
  /// Creates a new [EndpointPolicyIamBindingNetworkservicesV1beta1Args].
  ...
  const EndpointPolicyIamBindingNetworkservicesV1beta1Args({
    this.condition,
  ...
  factory EndpointPolicyIamBindingNetworkservicesV1beta1Args.fromMap(Map<String, dynamic> map) {
    return EndpointPolicyIamBindingNetworkservicesV1beta1Args(
