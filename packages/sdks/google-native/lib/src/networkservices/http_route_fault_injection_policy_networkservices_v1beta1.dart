...
class HttpRouteFaultInjectionPolicyNetworkservicesV1beta1 {
  ...
  final pulumi.Input<HttpRouteFaultInjectionPolicyAbortNetworkservicesV1beta1>?
  abort;

  /// The specification for injecting delay to client requests.
  final pulumi.Input<HttpRouteFaultInjectionPolicyDelayNetworkservicesV1beta1>?
  delay;
  ...
  HttpRouteFaultInjectionPolicyNetworkservicesV1beta1({this.abort, this.delay});
