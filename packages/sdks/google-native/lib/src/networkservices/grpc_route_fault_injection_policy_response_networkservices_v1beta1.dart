...
class GrpcRouteFaultInjectionPolicyResponseNetworkservicesV1beta1 {
  ...
  final pulumi.Input<
    GrpcRouteFaultInjectionPolicyDelayResponseNetworkservicesV1beta1
  >
  delay;
  ...
  factory GrpcRouteFaultInjectionPolicyResponseNetworkservicesV1beta1.fromMap(
    ...
    return GrpcRouteFaultInjectionPolicyResponseNetworkservicesV1beta1(
      abort: pulumi.Input.fromValue(
        GrpcRouteFaultInjectionPolicyAbortResponseNetworkservicesV1beta1.fromMap(
          (map['abort']! as Map).cast<String, dynamic>(),
        ),
      ),
      delay: pulumi.Input.fromValue(
        GrpcRouteFaultInjectionPolicyDelayResponseNetworkservicesV1beta1.fromMap(
