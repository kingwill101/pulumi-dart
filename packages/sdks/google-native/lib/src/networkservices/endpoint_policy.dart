...
class EndpointPolicy extends pulumi.CustomResource {
  ...
  EndpointPolicy(
    ...
    this.endpointMatcher = registerOutput<EndpointMatcherResponse>('endpointMatcher');
    ...
    this.trafficPortSelector = registerOutput<TrafficPortSelectorResponse>('trafficPortSelector');
