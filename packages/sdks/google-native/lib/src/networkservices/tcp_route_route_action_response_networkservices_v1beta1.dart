...
class TcpRouteRouteActionResponseNetworkservicesV1beta1 {
  ...
  final pulumi.Input<List<TcpRouteRouteDestinationResponseNetworkservicesV1beta1>> destinations;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'destinations': pulumi.Input.mapInputValue<List<TcpRouteRouteDestinationResponseNetworkservicesV1beta1>, List<Map<String, dynamic>>>(destinations, (value) => pulumi.Input.encodeList<TcpRouteRouteDestinationResponseNetworkservicesV1beta1, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory TcpRouteRouteActionResponseNetworkservicesV1beta1.fromMap(Map<String, dynamic> map) {
    return TcpRouteRouteActionResponseNetworkservicesV1beta1(
      destinations: pulumi.Input.fromValue(pulumi.Input.decodeList<TcpRouteRouteDestinationResponseNetworkservicesV1beta1>(map['destinations']!, (value) => TcpRouteRouteDestinationResponseNetworkservicesV1beta1.fromMap((value as Map).cast<String, dynamic>()))),
      originalDestination: pulumi.Input.fromValue(map['originalDestination'] as bool),
    );
  }
}
