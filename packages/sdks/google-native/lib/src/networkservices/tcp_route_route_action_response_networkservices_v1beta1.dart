...
class TcpRouteRouteActionResponseNetworkservicesV1beta1 {
  ...
  factory TcpRouteRouteActionResponseNetworkservicesV1beta1.fromMap(Map<String, dynamic> map) {
    return TcpRouteRouteActionResponseNetworkservicesV1beta1(
      destinations: (pulumi.Input.decodeList<TcpRouteRouteDestinationResponseNetworkservicesV1beta1>(map['destinations'], (value) => TcpRouteRouteDestinationResponseNetworkservicesV1beta1.fromMap((value as Map).cast<String, dynamic>()))).input(),
      originalDestination: (map['originalDestination'] as bool).input(),
    );
  }
}
