...
class TlsRouteRouteRule {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'action':
          pulumi.Input.mapInputValue<TlsRouteRouteAction, Map<String, dynamic>>(
            action,
            (value) => value.toMap(),
          ),
      'matches':
          pulumi.Input.mapInputValue<
            List<TlsRouteRouteMatch>,
  ...
  factory TlsRouteRouteRule.fromMap(Map<String, dynamic> map) {
    return TlsRouteRouteRule(
      action: pulumi.Input.fromValue(
        TlsRouteRouteAction.fromMap(
          (map['action']! as Map).cast<String, dynamic>(),
        ),
      ),
      matches: pulumi.Input.fromValue(
        pulumi.Input.decodeList<TlsRouteRouteMatch>(
          map['matches']!,
