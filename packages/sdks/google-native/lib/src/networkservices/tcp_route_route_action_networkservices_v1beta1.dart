...
class TcpRouteRouteActionNetworkservicesV1beta1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'destinations': ?destinations == null ? null : pulumi.Input.encodeList<TcpRouteRouteDestinationNetworkservicesV1beta1, Map<String, dynamic>>(destinations!, (value) => value.toMap()),
  ...
  factory TcpRouteRouteActionNetworkservicesV1beta1.fromMap(Map<String, dynamic> map) {
    return TcpRouteRouteActionNetworkservicesV1beta1(
      destinations: map['destinations'] == null ? null : pulumi.Input.decodeList<TcpRouteRouteDestinationNetworkservicesV1beta1>(map['destinations'], (value) => TcpRouteRouteDestinationNetworkservicesV1beta1.fromMap((value as Map).cast<String, dynamic>())),
      originalDestination: map['originalDestination'] == null ? null : map['originalDestination'] as bool,
    );
  }
}
