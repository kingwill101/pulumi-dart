...
class TcpRouteRouteActionNetworkservicesV1beta1 {
  ...
  final pulumi.Input<List<TcpRouteRouteDestinationNetworkservicesV1beta1>>?
  destinations;
    ...
    return <String, dynamic>{
      'destinations':
          ?pulumi.Input.mapOptionalInputValue<
            List<TcpRouteRouteDestinationNetworkservicesV1beta1>,
    ...
    return TcpRouteRouteActionNetworkservicesV1beta1(
      destinations: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<TcpRouteRouteDestinationNetworkservicesV1beta1>(
            guardedValue,
