...
class HttpRouteRouteMatchNetworkservicesV1beta1 {
  ...
  final pulumi.Input<List<HttpRouteQueryParameterMatchNetworkservicesV1beta1>>?
  queryParameters;
    ...
    return <String, dynamic>{
      ...
      'headers':
          ?pulumi.Input.mapOptionalInputValue<
            List<HttpRouteHeaderMatchNetworkservicesV1beta1>,
      ...
      'queryParameters':
          ?pulumi.Input.mapOptionalInputValue<
            List<HttpRouteQueryParameterMatchNetworkservicesV1beta1>,
            List<Map<String, dynamic>>
          >(
            queryParameters,
            (value) =>
