...
class HttpRouteRouteActionResponseNetworkservicesV1beta1 {
  ...
  final HttpRouteFaultInjectionPolicyResponseNetworkservicesV1beta1 faultInjectionPolicy;
  ...
  final HttpRouteHeaderModifierResponseNetworkservicesV1beta1 requestHeaderModifier;
  /// Specifies the policy on how requests intended for the routes destination are shadowed to a separate mirrored destination. Proxy will not wait for the shadow destination to respond before returning the response. Prior to sending traffic to the shadow service, the host/authority header is suffixed with -shadow.
  final HttpRouteRequestMirrorPolicyResponseNetworkservicesV1beta1 requestMirrorPolicy;
  ...
  final HttpRouteHeaderModifierResponseNetworkservicesV1beta1 responseHeaderModifier;
  /// Specifies the retry policy associated with this route.
  final HttpRouteRetryPolicyResponseNetworkservicesV1beta1 retryPolicy;
  /// Optional. Specifies cookie-based stateful session affinity.
  final HttpRouteStatefulSessionAffinityPolicyResponseNetworkservicesV1beta1 statefulSessionAffinity;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'destinations': pulumi.Input.encodeList<HttpRouteDestinationResponseNetworkservicesV1beta1, Map<String, dynamic>>(destinations, (value) => value.toMap()),
  ...
  factory HttpRouteRouteActionResponseNetworkservicesV1beta1.fromMap(Map<String, dynamic> map) {
    return HttpRouteRouteActionResponseNetworkservicesV1beta1(
      corsPolicy: HttpRouteCorsPolicyResponseNetworkservicesV1beta1.fromMap((map['corsPolicy'] as Map).cast<String, dynamic>()),
      destinations: pulumi.Input.decodeList<HttpRouteDestinationResponseNetworkservicesV1beta1>(map['destinations'], (value) => HttpRouteDestinationResponseNetworkservicesV1beta1.fromMap((value as Map).cast<String, dynamic>())),
      faultInjectionPolicy: HttpRouteFaultInjectionPolicyResponseNetworkservicesV1beta1.fromMap((map['faultInjectionPolicy'] as Map).cast<String, dynamic>()),
      redirect: HttpRouteRedirectResponseNetworkservicesV1beta1.fromMap((map['redirect'] as Map).cast<String, dynamic>()),
      requestHeaderModifier: HttpRouteHeaderModifierResponseNetworkservicesV1beta1.fromMap((map['requestHeaderModifier'] as Map).cast<String, dynamic>()),
      requestMirrorPolicy: HttpRouteRequestMirrorPolicyResponseNetworkservicesV1beta1.fromMap((map['requestMirrorPolicy'] as Map).cast<String, dynamic>()),
      responseHeaderModifier: HttpRouteHeaderModifierResponseNetworkservicesV1beta1.fromMap((map['responseHeaderModifier'] as Map).cast<String, dynamic>()),
      retryPolicy: HttpRouteRetryPolicyResponseNetworkservicesV1beta1.fromMap((map['retryPolicy'] as Map).cast<String, dynamic>()),
      statefulSessionAffinity: HttpRouteStatefulSessionAffinityPolicyResponseNetworkservicesV1beta1.fromMap((map['statefulSessionAffinity'] as Map).cast<String, dynamic>()),
      timeout: map['timeout'] as String,
      urlRewrite: HttpRouteURLRewriteResponseNetworkservicesV1beta1.fromMap((map['urlRewrite'] as Map).cast<String, dynamic>()),
    );
  }
}
