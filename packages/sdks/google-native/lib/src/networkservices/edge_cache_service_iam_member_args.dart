...
/// {@template pulumi_networkservices_v1_edge_cache_service_iam_member_args_doc}
/// The set of arguments for EdgeCacheServiceIamMember.
/// {@endtemplate}
/// {@macro pulumi_networkservices_v1_edge_cache_service_iam_member_args_doc}
class EdgeCacheServiceIamMemberArgs {
  ...
  /// Creates a new [EdgeCacheServiceIamMemberArgs].
  ...
  const EdgeCacheServiceIamMemberArgs({
    this.condition,
  ...
  factory EdgeCacheServiceIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return EdgeCacheServiceIamMemberArgs(
