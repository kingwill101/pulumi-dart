...
/// {@template pulumi_networkservices_v1_edge_cache_keyset_iam_binding_args_doc}
/// The set of arguments for EdgeCacheKeysetIamBinding.
/// {@endtemplate}
/// {@macro pulumi_networkservices_v1_edge_cache_keyset_iam_binding_args_doc}
class EdgeCacheKeysetIamBindingArgs {
  ...
  /// Creates a new [EdgeCacheKeysetIamBindingArgs].
  ...
  const EdgeCacheKeysetIamBindingArgs({
    this.condition,
  ...
  factory EdgeCacheKeysetIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return EdgeCacheKeysetIamBindingArgs(
