...
class HttpRouteRouteAction {
  ...
  factory HttpRouteRouteAction.fromMap(Map<String, dynamic> map) {
    return HttpRouteRouteAction(
      corsPolicy: (() { final guardedValue = map['corsPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HttpRouteCorsPolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      destinations: (() { final guardedValue = map['destinations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<HttpRouteDestination>(guardedValue, (value) => HttpRouteDestination.fromMap((value as Map).cast<String, dynamic>()))); })(),
      faultInjectionPolicy: (() { final guardedValue = map['faultInjectionPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HttpRouteFaultInjectionPolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      redirect: (() { final guardedValue = map['redirect']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HttpRouteRedirect.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      requestHeaderModifier: (() { final guardedValue = map['requestHeaderModifier']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HttpRouteHeaderModifier.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      requestMirrorPolicy: (() { final guardedValue = map['requestMirrorPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HttpRouteRequestMirrorPolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      responseHeaderModifier: (() { final guardedValue = map['responseHeaderModifier']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HttpRouteHeaderModifier.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      retryPolicy: (() { final guardedValue = map['retryPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HttpRouteRetryPolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      statefulSessionAffinity: (() { final guardedValue = map['statefulSessionAffinity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HttpRouteStatefulSessionAffinityPolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      timeout: (() { final guardedValue = map['timeout']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      urlRewrite: (() { final guardedValue = map['urlRewrite']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HttpRouteURLRewrite.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
