...
class HttpRouteRouteActionResponse {
  ...
  final pulumi.Input<HttpRouteFaultInjectionPolicyResponse>
  ...
  final pulumi.Input<HttpRouteStatefulSessionAffinityPolicyResponse>
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'destinations':
          pulumi.Input.mapInputValue<
            List<HttpRouteDestinationResponse>,
  ...
  factory HttpRouteRouteActionResponse.fromMap(Map<String, dynamic> map) {
    return HttpRouteRouteActionResponse(
      corsPolicy: pulumi.Input.fromValue(
        HttpRouteCorsPolicyResponse.fromMap(
          (map['corsPolicy']! as Map).cast<String, dynamic>(),
        ),
      ),
      destinations: pulumi.Input.fromValue(
        pulumi.Input.decodeList<HttpRouteDestinationResponse>(
          map['destinations']!,
      ...
      retryPolicy: pulumi.Input.fromValue(
        HttpRouteRetryPolicyResponse.fromMap(
      ...
      urlRewrite: pulumi.Input.fromValue(
        HttpRouteURLRewriteResponse.fromMap(
