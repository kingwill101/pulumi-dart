...
class HttpRouteRouteActionResponse {
  ...
  const HttpRouteRouteActionResponse({
  ...
  factory HttpRouteRouteActionResponse.fromMap(Map<String, dynamic> map) {
    return HttpRouteRouteActionResponse(
      corsPolicy: pulumi.Input.fromValue(HttpRouteCorsPolicyResponse.fromMap((map['corsPolicy']! as Map).cast<String, dynamic>())),
      destinations: pulumi.Input.fromValue(pulumi.Input.decodeList<HttpRouteDestinationResponse>(map['destinations']!, (value) => HttpRouteDestinationResponse.fromMap((value as Map).cast<String, dynamic>()))),
      faultInjectionPolicy: pulumi.Input.fromValue(HttpRouteFaultInjectionPolicyResponse.fromMap((map['faultInjectionPolicy']! as Map).cast<String, dynamic>())),
      redirect: pulumi.Input.fromValue(HttpRouteRedirectResponse.fromMap((map['redirect']! as Map).cast<String, dynamic>())),
      requestHeaderModifier: pulumi.Input.fromValue(HttpRouteHeaderModifierResponse.fromMap((map['requestHeaderModifier']! as Map).cast<String, dynamic>())),
      requestMirrorPolicy: pulumi.Input.fromValue(HttpRouteRequestMirrorPolicyResponse.fromMap((map['requestMirrorPolicy']! as Map).cast<String, dynamic>())),
      responseHeaderModifier: pulumi.Input.fromValue(HttpRouteHeaderModifierResponse.fromMap((map['responseHeaderModifier']! as Map).cast<String, dynamic>())),
      retryPolicy: pulumi.Input.fromValue(HttpRouteRetryPolicyResponse.fromMap((map['retryPolicy']! as Map).cast<String, dynamic>())),
      statefulSessionAffinity: pulumi.Input.fromValue(HttpRouteStatefulSessionAffinityPolicyResponse.fromMap((map['statefulSessionAffinity']! as Map).cast<String, dynamic>())),
      timeout: pulumi.Input.fromValue(map['timeout'] as String),
      urlRewrite: pulumi.Input.fromValue(HttpRouteURLRewriteResponse.fromMap((map['urlRewrite']! as Map).cast<String, dynamic>())),
    );
  }
}
