...
class GrpcRouteNetworkservicesV1beta1Args {
    ...
    return <String, dynamic>{
      ...
      'rules':
          pulumi.Input.mapInputValue<
            List<GrpcRouteRouteRuleNetworkservicesV1beta1>,
  ...
  factory GrpcRouteNetworkservicesV1beta1Args.fromMap(
    ...
    return GrpcRouteNetworkservicesV1beta1Args(
      ...
      rules: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GrpcRouteRouteRuleNetworkservicesV1beta1>(
          map['rules']!,
          (value) => GrpcRouteRouteRuleNetworkservicesV1beta1.fromMap(
