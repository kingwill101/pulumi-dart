...
class GrpcRouteNetworkservicesV1beta1Args {
  ...
  const GrpcRouteNetworkservicesV1beta1Args({
    this.description,
    this.gateways,
  ...
  factory GrpcRouteNetworkservicesV1beta1Args.fromMap(Map<String, dynamic> map) {
    return GrpcRouteNetworkservicesV1beta1Args(
      ...
      rules: pulumi.Input.fromValue(pulumi.Input.decodeList<GrpcRouteRouteRuleNetworkservicesV1beta1>(map['rules']!, (value) => GrpcRouteRouteRuleNetworkservicesV1beta1.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
