...
class HttpRouteDestinationResponseNetworkservicesV1beta1 {
  ...
  /// Creates a new [HttpRouteDestinationResponseNetworkservicesV1beta1].
  ...
  const HttpRouteDestinationResponseNetworkservicesV1beta1({
  ...
  factory HttpRouteDestinationResponseNetworkservicesV1beta1.fromMap(Map<String, dynamic> map) {
    return HttpRouteDestinationResponseNetworkservicesV1beta1(
