...
class TcpRouteRouteDestinationNetworkservicesV1beta1 {
  ...
  /// Creates a new [TcpRouteRouteDestinationNetworkservicesV1beta1].
  ...
  const TcpRouteRouteDestinationNetworkservicesV1beta1({
  ...
  factory TcpRouteRouteDestinationNetworkservicesV1beta1.fromMap(Map<String, dynamic> map) {
    return TcpRouteRouteDestinationNetworkservicesV1beta1(
