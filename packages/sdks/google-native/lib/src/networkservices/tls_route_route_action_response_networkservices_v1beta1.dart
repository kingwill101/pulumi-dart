...
class TlsRouteRouteActionResponseNetworkservicesV1beta1 {
  ...
  factory TlsRouteRouteActionResponseNetworkservicesV1beta1.fromMap(Map<String, dynamic> map) {
    return TlsRouteRouteActionResponseNetworkservicesV1beta1(
      destinations: (pulumi.Input.decodeList<TlsRouteRouteDestinationResponseNetworkservicesV1beta1>(map['destinations'], (value) => TlsRouteRouteDestinationResponseNetworkservicesV1beta1.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
