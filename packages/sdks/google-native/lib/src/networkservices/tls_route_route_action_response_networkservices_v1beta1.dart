...
class TlsRouteRouteActionResponseNetworkservicesV1beta1 {
  ...
  final List<TlsRouteRouteDestinationResponseNetworkservicesV1beta1> destinations;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'destinations': pulumi.Input.encodeList<TlsRouteRouteDestinationResponseNetworkservicesV1beta1, Map<String, dynamic>>(destinations, (value) => value.toMap()),
    };
  }
  ...
  factory TlsRouteRouteActionResponseNetworkservicesV1beta1.fromMap(Map<String, dynamic> map) {
    return TlsRouteRouteActionResponseNetworkservicesV1beta1(
      destinations: pulumi.Input.decodeList<TlsRouteRouteDestinationResponseNetworkservicesV1beta1>(map['destinations'], (value) => TlsRouteRouteDestinationResponseNetworkservicesV1beta1.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
