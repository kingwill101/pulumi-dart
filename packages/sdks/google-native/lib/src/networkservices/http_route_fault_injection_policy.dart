...
class HttpRouteFaultInjectionPolicy {
  ...
  const HttpRouteFaultInjectionPolicy({
    this.abort,
    this.delay,
  });
  ...
  factory HttpRouteFaultInjectionPolicy.fromMap(Map<String, dynamic> map) {
    return HttpRouteFaultInjectionPolicy(
      abort: (() { final guardedValue = map['abort']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HttpRouteFaultInjectionPolicyAbort.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      delay: (() { final guardedValue = map['delay']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HttpRouteFaultInjectionPolicyDelay.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
