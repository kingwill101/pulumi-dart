...
class HttpRouteRedirectNetworkservicesV1beta1 {
  ...
  final pulumi.Input<HttpRouteRedirectResponseCodeNetworkservicesV1beta1>? responseCode;
  /// if set to true, any accompanying query portion of the original URL is removed prior to redirecting the request. If set to false, the query portion of the original URL is retained. The default is set to false.
  final pulumi.Input<bool>? stripQuery;

  /// Creates a new [HttpRouteRedirectNetworkservicesV1beta1].
  ...
  const HttpRouteRedirectNetworkservicesV1beta1({
    this.hostRedirect,
    this.httpsRedirect,
    this.pathRedirect,
    this.portRedirect,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'responseCode': ?pulumi.Input.mapOptionalInputValue<HttpRouteRedirectResponseCodeNetworkservicesV1beta1, String>(responseCode, (value) => value.wireValue),
      'stripQuery': ?stripQuery,
    };
  }

  factory HttpRouteRedirectNetworkservicesV1beta1.fromMap(Map<String, dynamic> map) {
    return HttpRouteRedirectNetworkservicesV1beta1(
      ...
      responseCode: (() { final guardedValue = map['responseCode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HttpRouteRedirectResponseCodeNetworkservicesV1beta1.fromValue(guardedValue as String)); })(),
