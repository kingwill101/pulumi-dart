...
class HttpRouteRedirectNetworkservicesV1beta1 {
  ...
  final pulumi.Input<HttpRouteRedirectResponseCodeNetworkservicesV1beta1>?
  responseCode;
    ...
    return <String, dynamic>{
      ...
      'responseCode':
          ?pulumi.Input.mapOptionalInputValue<
            HttpRouteRedirectResponseCodeNetworkservicesV1beta1,
            String
          >(responseCode, (value) => value.wireValue),
  ...
  factory HttpRouteRedirectNetworkservicesV1beta1.fromMap(
    ...
    return HttpRouteRedirectNetworkservicesV1beta1(
      ...
      portRedirect: (() {
        final guardedValue = map['portRedirect'];
        if (guardedValue == null) return null;
