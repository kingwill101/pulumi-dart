...
class GetEndpointPolicyResult {
  ...
  final EndpointMatcherResponse endpointMatcher;
  ...
  final TrafficPortSelectorResponse trafficPortSelector;
  /// The type of endpoint policy. This is primarily used to validate the configuration.
  final String type;
  /// The timestamp when the resource was updated.
  final String updateTime;

  /// Creates a new [GetEndpointPolicyResult].
  ...
  factory GetEndpointPolicyResult.fromMap(Map<String, dynamic> map) {
    return GetEndpointPolicyResult(
      ...
      endpointMatcher: EndpointMatcherResponse.fromMap((map['endpointMatcher']! as Map).cast<String, dynamic>()),
      labels: (map['labels'] as Map).cast<String, String>(),
      name: map['name'] as String,
      serverTlsPolicy: map['serverTlsPolicy'] as String,
      trafficPortSelector: TrafficPortSelectorResponse.fromMap((map['trafficPortSelector']! as Map).cast<String, dynamic>()),
