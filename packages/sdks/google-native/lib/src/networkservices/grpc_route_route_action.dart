...
class GrpcRouteRouteAction {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'destinations': ?destinations == null ? null : pulumi.Input.encodeList<GrpcRouteDestination, Map<String, dynamic>>(destinations!, (value) => value.toMap()),
  ...
  factory GrpcRouteRouteAction.fromMap(Map<String, dynamic> map) {
    return GrpcRouteRouteAction(
      destinations: map['destinations'] == null ? null : pulumi.Input.decodeList<GrpcRouteDestination>(map['destinations'], (value) => GrpcRouteDestination.fromMap((value as Map).cast<String, dynamic>())),
      faultInjectionPolicy: map['faultInjectionPolicy'] == null ? null : GrpcRouteFaultInjectionPolicy.fromMap((map['faultInjectionPolicy'] as Map).cast<String, dynamic>()),
      retryPolicy: map['retryPolicy'] == null ? null : GrpcRouteRetryPolicy.fromMap((map['retryPolicy'] as Map).cast<String, dynamic>()),
      statefulSessionAffinity: map['statefulSessionAffinity'] == null ? null : GrpcRouteStatefulSessionAffinityPolicy.fromMap((map['statefulSessionAffinity'] as Map).cast<String, dynamic>()),
