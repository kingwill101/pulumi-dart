...
class GrpcRouteRouteAction {
  ...
  factory GrpcRouteRouteAction.fromMap(Map<String, dynamic> map) {
    return GrpcRouteRouteAction(
      destinations: (() { final guardedValue = map['destinations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GrpcRouteDestination>(guardedValue, (value) => GrpcRouteDestination.fromMap((value as Map).cast<String, dynamic>()))); })(),
      faultInjectionPolicy: (() { final guardedValue = map['faultInjectionPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GrpcRouteFaultInjectionPolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      retryPolicy: (() { final guardedValue = map['retryPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GrpcRouteRetryPolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      statefulSessionAffinity: (() { final guardedValue = map['statefulSessionAffinity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GrpcRouteStatefulSessionAffinityPolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
