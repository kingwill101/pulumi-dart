...
class HttpRouteRouteActionNetworkservicesV1beta1 {
  ...
  final HttpRouteFaultInjectionPolicyNetworkservicesV1beta1? faultInjectionPolicy;
  ...
  final HttpRouteStatefulSessionAffinityPolicyNetworkservicesV1beta1? statefulSessionAffinity;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'destinations': ?destinations == null ? null : pulumi.Input.encodeList<HttpRouteDestinationNetworkservicesV1beta1, Map<String, dynamic>>(destinations!, (value) => value.toMap()),
  ...
  factory HttpRouteRouteActionNetworkservicesV1beta1.fromMap(Map<String, dynamic> map) {
    return HttpRouteRouteActionNetworkservicesV1beta1(
      corsPolicy: map['corsPolicy'] == null ? null : HttpRouteCorsPolicyNetworkservicesV1beta1.fromMap((map['corsPolicy'] as Map).cast<String, dynamic>()),
      destinations: map['destinations'] == null ? null : pulumi.Input.decodeList<HttpRouteDestinationNetworkservicesV1beta1>(map['destinations'], (value) => HttpRouteDestinationNetworkservicesV1beta1.fromMap((value as Map).cast<String, dynamic>())),
      faultInjectionPolicy: map['faultInjectionPolicy'] == null ? null : HttpRouteFaultInjectionPolicyNetworkservicesV1beta1.fromMap((map['faultInjectionPolicy'] as Map).cast<String, dynamic>()),
      redirect: map['redirect'] == null ? null : HttpRouteRedirectNetworkservicesV1beta1.fromMap((map['redirect'] as Map).cast<String, dynamic>()),
      requestHeaderModifier: map['requestHeaderModifier'] == null ? null : HttpRouteHeaderModifierNetworkservicesV1beta1.fromMap((map['requestHeaderModifier'] as Map).cast<String, dynamic>()),
      requestMirrorPolicy: map['requestMirrorPolicy'] == null ? null : HttpRouteRequestMirrorPolicyNetworkservicesV1beta1.fromMap((map['requestMirrorPolicy'] as Map).cast<String, dynamic>()),
      responseHeaderModifier: map['responseHeaderModifier'] == null ? null : HttpRouteHeaderModifierNetworkservicesV1beta1.fromMap((map['responseHeaderModifier'] as Map).cast<String, dynamic>()),
      retryPolicy: map['retryPolicy'] == null ? null : HttpRouteRetryPolicyNetworkservicesV1beta1.fromMap((map['retryPolicy'] as Map).cast<String, dynamic>()),
      statefulSessionAffinity: map['statefulSessionAffinity'] == null ? null : HttpRouteStatefulSessionAffinityPolicyNetworkservicesV1beta1.fromMap((map['statefulSessionAffinity'] as Map).cast<String, dynamic>()),
      timeout: map['timeout'] == null ? null : map['timeout'] as String,
      urlRewrite: map['urlRewrite'] == null ? null : HttpRouteURLRewriteNetworkservicesV1beta1.fromMap((map['urlRewrite'] as Map).cast<String, dynamic>()),
    );
  }
}
