...
/// {@template pulumi_networkservices_v1_mesh_iam_binding_args_doc}
/// The set of arguments for MeshIamBinding.
/// {@endtemplate}
/// {@macro pulumi_networkservices_v1_mesh_iam_binding_args_doc}
class MeshIamBindingArgs {
  ...
  /// Creates a new [MeshIamBindingArgs].
  ...
  factory MeshIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return MeshIamBindingArgs(
