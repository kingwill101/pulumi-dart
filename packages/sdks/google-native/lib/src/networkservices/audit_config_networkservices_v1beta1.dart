...
class AuditConfigNetworkservicesV1beta1 {
  ...
  const AuditConfigNetworkservicesV1beta1({
  ...
  factory AuditConfigNetworkservicesV1beta1.fromMap(Map<String, dynamic> map) {
    return AuditConfigNetworkservicesV1beta1(
      auditLogConfigs: (() { final guardedValue = map['auditLogConfigs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AuditLogConfigNetworkservicesV1beta1>(guardedValue, (value) => AuditLogConfigNetworkservicesV1beta1.fromMap((value as Map).cast<String, dynamic>()))); })(),
