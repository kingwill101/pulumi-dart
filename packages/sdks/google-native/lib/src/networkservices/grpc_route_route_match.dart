...
class GrpcRouteRouteMatch {
  ...
  factory GrpcRouteRouteMatch.fromMap(Map<String, dynamic> map) {
    return GrpcRouteRouteMatch(
      headers: (() { final guardedValue = map['headers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GrpcRouteHeaderMatch>(guardedValue, (value) => GrpcRouteHeaderMatch.fromMap((value as Map).cast<String, dynamic>()))); })(),
      method: (() { final guardedValue = map['method']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GrpcRouteMethodMatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
