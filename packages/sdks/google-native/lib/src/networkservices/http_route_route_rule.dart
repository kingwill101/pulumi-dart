...
class HttpRouteRouteRule {
  ...
  factory HttpRouteRouteRule.fromMap(Map<String, dynamic> map) {
    return HttpRouteRouteRule(
      action: (() { final guardedValue = map['action']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HttpRouteRouteAction.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      matches: (() { final guardedValue = map['matches']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<HttpRouteRouteMatch>(guardedValue, (value) => HttpRouteRouteMatch.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
