...
/// {@template pulumi_networkservices_v1beta1_mesh_iam_member_networkservices_v1beta1_args_doc}
/// The set of arguments for MeshIamMember.
/// {@endtemplate}
/// {@macro pulumi_networkservices_v1beta1_mesh_iam_member_networkservices_v1beta1_args_doc}
class MeshIamMemberNetworkservicesV1beta1Args {
  ...
  /// Creates a new [MeshIamMemberNetworkservicesV1beta1Args].
  ...
  const MeshIamMemberNetworkservicesV1beta1Args({
    this.condition,
  ...
  factory MeshIamMemberNetworkservicesV1beta1Args.fromMap(Map<String, dynamic> map) {
    return MeshIamMemberNetworkservicesV1beta1Args(
