...
class GrpcRouteRouteRuleResponse {
  ...
  GrpcRouteRouteRuleResponse({required this.action, required this.matches});
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'matches':
          pulumi.Input.mapInputValue<
            List<GrpcRouteRouteMatchResponse>,
  ...
  factory GrpcRouteRouteRuleResponse.fromMap(Map<String, dynamic> map) {
    return GrpcRouteRouteRuleResponse(
      action: pulumi.Input.fromValue(
        GrpcRouteRouteActionResponse.fromMap(
          (map['action']! as Map).cast<String, dynamic>(),
        ),
      ),
      matches: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GrpcRouteRouteMatchResponse>(
          map['matches']!,
