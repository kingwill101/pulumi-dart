...
class GrpcRouteRouteMatchResponse {
  ...
  factory GrpcRouteRouteMatchResponse.fromMap(Map<String, dynamic> map) {
    return GrpcRouteRouteMatchResponse(
      headers: (pulumi.Input.decodeList<GrpcRouteHeaderMatchResponse>(map['headers'], (value) => GrpcRouteHeaderMatchResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      method: (GrpcRouteMethodMatchResponse.fromMap((map['method'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
