...
class GrpcRouteRouteMatchResponse {
  ...
  GrpcRouteRouteMatchResponse({required this.headers, required this.method});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'headers':
          pulumi.Input.mapInputValue<
            List<GrpcRouteHeaderMatchResponse>,
  ...
  factory GrpcRouteRouteMatchResponse.fromMap(Map<String, dynamic> map) {
    return GrpcRouteRouteMatchResponse(
      headers: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GrpcRouteHeaderMatchResponse>(
          map['headers']!,
      ...
      method: pulumi.Input.fromValue(
        GrpcRouteMethodMatchResponse.fromMap(
