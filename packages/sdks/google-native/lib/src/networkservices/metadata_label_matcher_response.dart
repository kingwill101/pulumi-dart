...
class MetadataLabelMatcherResponse {
  ...
  final List<MetadataLabelsResponse> metadataLabels;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'metadataLabels': pulumi.Input.encodeList<MetadataLabelsResponse, Map<String, dynamic>>(metadataLabels, (value) => value.toMap()),
    };
  }
  ...
  factory MetadataLabelMatcherResponse.fromMap(Map<String, dynamic> map) {
    return MetadataLabelMatcherResponse(
      ...
      metadataLabels: pulumi.Input.decodeList<MetadataLabelsResponse>(map['metadataLabels'], (value) => MetadataLabelsResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
