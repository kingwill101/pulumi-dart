...
class MetadataLabelMatcherResponse {
  ...
  factory MetadataLabelMatcherResponse.fromMap(Map<String, dynamic> map) {
    return MetadataLabelMatcherResponse(
      ...
      metadataLabels: (pulumi.Input.decodeList<MetadataLabelsResponse>(map['metadataLabels'], (value) => MetadataLabelsResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
