...
import 'edge_cache_keyset_iam_member_args.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class EdgeCacheKeysetIamMember extends pulumi.CustomResource {
  ...
  /// Creates a new [EdgeCacheKeysetIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [EdgeCacheKeysetIamMember]. {@macro pulumi_networkservices_v1_edge_cache_keyset_iam_member_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  EdgeCacheKeysetIamMember(
    String name, {
    EdgeCacheKeysetIamMemberArgs? args,
