...
class GetTlsRouteResult {
  ...
  /// Creates a new [GetTlsRouteResult].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'meshes': meshes,
      'name': name,
      'rules': pulumi.Input.encodeList<TlsRouteRouteRuleResponse, Map<String, dynamic>>(rules, (value) => value.toMap()),
      'selfLink': selfLink,
  ...
  factory GetTlsRouteResult.fromMap(Map<String, dynamic> map) {
    return GetTlsRouteResult(
      ...
      rules: pulumi.Input.decodeList<TlsRouteRouteRuleResponse>(map['rules']!, (value) => TlsRouteRouteRuleResponse.fromMap((value as Map).cast<String, dynamic>())),
