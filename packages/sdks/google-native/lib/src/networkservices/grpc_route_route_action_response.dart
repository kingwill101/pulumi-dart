...
class GrpcRouteRouteActionResponse {
  ...
  factory GrpcRouteRouteActionResponse.fromMap(Map<String, dynamic> map) {
    return GrpcRouteRouteActionResponse(
      destinations: (pulumi.Input.decodeList<GrpcRouteDestinationResponse>(map['destinations'], (value) => GrpcRouteDestinationResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      faultInjectionPolicy: (GrpcRouteFaultInjectionPolicyResponse.fromMap((map['faultInjectionPolicy'] as Map).cast<String, dynamic>())).input(),
      retryPolicy: (GrpcRouteRetryPolicyResponse.fromMap((map['retryPolicy'] as Map).cast<String, dynamic>())).input(),
      statefulSessionAffinity: (GrpcRouteStatefulSessionAffinityPolicyResponse.fromMap((map['statefulSessionAffinity'] as Map).cast<String, dynamic>())).input(),
