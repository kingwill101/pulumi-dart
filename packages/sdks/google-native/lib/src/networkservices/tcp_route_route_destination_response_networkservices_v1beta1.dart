...
class TcpRouteRouteDestinationResponseNetworkservicesV1beta1 {
  ...
  const TcpRouteRouteDestinationResponseNetworkservicesV1beta1({
  ...
  factory TcpRouteRouteDestinationResponseNetworkservicesV1beta1.fromMap(Map<String, dynamic> map) {
