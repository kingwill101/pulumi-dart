...
/// {@template pulumi_networkservices_v1_edge_cache_keyset_iam_member_args_doc}
/// The set of arguments for EdgeCacheKeysetIamMember.
/// {@endtemplate}
/// {@macro pulumi_networkservices_v1_edge_cache_keyset_iam_member_args_doc}
class EdgeCacheKeysetIamMemberArgs {
  ...
  /// Creates a new [EdgeCacheKeysetIamMemberArgs].
  ...
  const EdgeCacheKeysetIamMemberArgs({
    this.condition,
  ...
  factory EdgeCacheKeysetIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return EdgeCacheKeysetIamMemberArgs(
