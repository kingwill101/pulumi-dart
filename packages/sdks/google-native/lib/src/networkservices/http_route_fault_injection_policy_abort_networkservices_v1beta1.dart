...
class HttpRouteFaultInjectionPolicyAbortNetworkservicesV1beta1 {
  ...
  /// Creates a new [HttpRouteFaultInjectionPolicyAbortNetworkservicesV1beta1].
  ...
  HttpRouteFaultInjectionPolicyAbortNetworkservicesV1beta1({
    this.httpStatus,
    this.percentage,
  });
  ...
  factory HttpRouteFaultInjectionPolicyAbortNetworkservicesV1beta1.fromMap(
