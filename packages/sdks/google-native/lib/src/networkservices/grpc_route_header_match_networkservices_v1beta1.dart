...
class GrpcRouteHeaderMatchNetworkservicesV1beta1 {
  ...
  const GrpcRouteHeaderMatchNetworkservicesV1beta1({
    required this.key,
    this.type,
    required this.value,
  });
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'key': key,
      'type': ?pulumi.Input.mapOptionalInputValue<GrpcRouteHeaderMatchTypeNetworkservicesV1beta1, String>(type, (value) => value.wireValue),
      'value': value,
    };
  }
  ...
  factory GrpcRouteHeaderMatchNetworkservicesV1beta1.fromMap(Map<String, dynamic> map) {
    return GrpcRouteHeaderMatchNetworkservicesV1beta1(
      ...
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GrpcRouteHeaderMatchTypeNetworkservicesV1beta1.fromValue(guardedValue as String)); })(),
