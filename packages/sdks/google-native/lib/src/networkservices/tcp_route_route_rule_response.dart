...
class TcpRouteRouteRuleResponse {
  ...
  TcpRouteRouteRuleResponse({required this.action, required this.matches});
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'matches':
          pulumi.Input.mapInputValue<
            List<TcpRouteRouteMatchResponse>,
  ...
  factory TcpRouteRouteRuleResponse.fromMap(Map<String, dynamic> map) {
    return TcpRouteRouteRuleResponse(
      action: pulumi.Input.fromValue(
        TcpRouteRouteActionResponse.fromMap(
          (map['action']! as Map).cast<String, dynamic>(),
        ),
      ),
      matches: pulumi.Input.fromValue(
        pulumi.Input.decodeList<TcpRouteRouteMatchResponse>(
          map['matches']!,
