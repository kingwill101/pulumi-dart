...
class GrpcRouteRouteMatchResponseNetworkservicesV1beta1 {
  ...
  final pulumi.Input<List<GrpcRouteHeaderMatchResponseNetworkservicesV1beta1>>
  headers;
    ...
    return <String, dynamic>{
      'headers':
          pulumi.Input.mapInputValue<
            List<GrpcRouteHeaderMatchResponseNetworkservicesV1beta1>,
  ...
  factory GrpcRouteRouteMatchResponseNetworkservicesV1beta1.fromMap(
    ...
    return GrpcRouteRouteMatchResponseNetworkservicesV1beta1(
      ...
      method: pulumi.Input.fromValue(
        GrpcRouteMethodMatchResponseNetworkservicesV1beta1.fromMap(
