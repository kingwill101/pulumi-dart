...
class GrpcRouteRouteMatchResponseNetworkservicesV1beta1 {
  ...
  factory GrpcRouteRouteMatchResponseNetworkservicesV1beta1.fromMap(Map<String, dynamic> map) {
    return GrpcRouteRouteMatchResponseNetworkservicesV1beta1(
      headers: (pulumi.Input.decodeList<GrpcRouteHeaderMatchResponseNetworkservicesV1beta1>(map['headers'], (value) => GrpcRouteHeaderMatchResponseNetworkservicesV1beta1.fromMap((value as Map).cast<String, dynamic>()))).input(),
      method: (GrpcRouteMethodMatchResponseNetworkservicesV1beta1.fromMap((map['method'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
