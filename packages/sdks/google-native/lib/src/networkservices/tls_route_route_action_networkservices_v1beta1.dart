...
class TlsRouteRouteActionNetworkservicesV1beta1 {
  ...
  final pulumi.Input<List<TlsRouteRouteDestinationNetworkservicesV1beta1>>
  destinations;
    ...
    return <String, dynamic>{
      'destinations':
          pulumi.Input.mapInputValue<
            List<TlsRouteRouteDestinationNetworkservicesV1beta1>,
  ...
  factory TlsRouteRouteActionNetworkservicesV1beta1.fromMap(
    ...
    return TlsRouteRouteActionNetworkservicesV1beta1(
      destinations: pulumi.Input.fromValue(
        pulumi.Input.decodeList<TlsRouteRouteDestinationNetworkservicesV1beta1>(
          map['destinations']!,
