...
class TcpRouteRouteRuleNetworkservicesV1beta1 {
  ...
  const TcpRouteRouteRuleNetworkservicesV1beta1({
  ...
  factory TcpRouteRouteRuleNetworkservicesV1beta1.fromMap(Map<String, dynamic> map) {
    return TcpRouteRouteRuleNetworkservicesV1beta1(
      action: pulumi.Input.fromValue(TcpRouteRouteActionNetworkservicesV1beta1.fromMap((map['action']! as Map).cast<String, dynamic>())),
      matches: (() { final guardedValue = map['matches']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<TcpRouteRouteMatchNetworkservicesV1beta1>(guardedValue, (value) => TcpRouteRouteMatchNetworkservicesV1beta1.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
