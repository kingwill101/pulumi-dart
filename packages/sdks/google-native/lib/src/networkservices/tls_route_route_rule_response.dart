...
class TlsRouteRouteRuleResponse {
  ...
  factory TlsRouteRouteRuleResponse.fromMap(Map<String, dynamic> map) {
    return TlsRouteRouteRuleResponse(
      action: (TlsRouteRouteActionResponse.fromMap((map['action'] as Map).cast<String, dynamic>())).input(),
      matches: (pulumi.Input.decodeList<TlsRouteRouteMatchResponse>(map['matches'], (value) => TlsRouteRouteMatchResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
