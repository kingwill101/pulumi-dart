...
class HttpRouteHeaderMatchNetworkservicesV1beta1 {
  ...
  final HttpRouteHeaderMatchIntegerRangeNetworkservicesV1beta1? rangeMatch;
  ...
  factory HttpRouteHeaderMatchNetworkservicesV1beta1.fromMap(Map<String, dynamic> map) {
    return HttpRouteHeaderMatchNetworkservicesV1beta1(
      ...
      rangeMatch: map['rangeMatch'] == null ? null : HttpRouteHeaderMatchIntegerRangeNetworkservicesV1beta1.fromMap((map['rangeMatch'] as Map).cast<String, dynamic>()),
