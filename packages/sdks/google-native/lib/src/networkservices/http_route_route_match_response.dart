...
class HttpRouteRouteMatchResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'headers': pulumi.Input.encodeList<HttpRouteHeaderMatchResponse, Map<String, dynamic>>(headers, (value) => value.toMap()),
      'ignoreCase': ignoreCase,
      'prefixMatch': prefixMatch,
      'queryParameters': pulumi.Input.encodeList<HttpRouteQueryParameterMatchResponse, Map<String, dynamic>>(queryParameters, (value) => value.toMap()),
  ...
  factory HttpRouteRouteMatchResponse.fromMap(Map<String, dynamic> map) {
    return HttpRouteRouteMatchResponse(
      ...
      headers: pulumi.Input.decodeList<HttpRouteHeaderMatchResponse>(map['headers'], (value) => HttpRouteHeaderMatchResponse.fromMap((value as Map).cast<String, dynamic>())),
      ignoreCase: map['ignoreCase'] as bool,
      prefixMatch: map['prefixMatch'] as String,
      queryParameters: pulumi.Input.decodeList<HttpRouteQueryParameterMatchResponse>(map['queryParameters'], (value) => HttpRouteQueryParameterMatchResponse.fromMap((value as Map).cast<String, dynamic>())),
