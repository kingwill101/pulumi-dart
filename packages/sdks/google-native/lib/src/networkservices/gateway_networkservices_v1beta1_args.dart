...
class GatewayNetworkservicesV1beta1Args {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'type': ?pulumi.Input.mapOptionalInputValue<GatewayTypeNetworkservicesV1beta1, String>(type, (value) => value.wireValue),
    };
  }
  ...
  factory GatewayNetworkservicesV1beta1Args.fromMap(Map<String, dynamic> map) {
    return GatewayNetworkservicesV1beta1Args(
      ...
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GatewayTypeNetworkservicesV1beta1.fromValue(guardedValue as String)); })(),
    );
  }
}
