...
class GatewayNetworkservicesV1beta1Args {
  ...
  GatewayNetworkservicesV1beta1Args({
    ...
    required pulumi.Output<List<int>> ports,
    pulumi.Output<String>? project,
    pulumi.Output<String>? scope,
    pulumi.Output<String>? serverTlsPolicy,
    pulumi.Output<String>? subnetwork,
    pulumi.Output<GatewayTypeNetworkservicesV1beta1>? type,
  }) :
      ...
      type = pulumi.Input.asOptionalInput<GatewayTypeNetworkservicesV1beta1>(type);
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'type': ?pulumi.Input.mapOptionalInputValue<GatewayTypeNetworkservicesV1beta1, String>(type, (value) => value.value),
    };
  }
  ...
  factory GatewayNetworkservicesV1beta1Args.fromMap(Map<String, dynamic> map) {
    return GatewayNetworkservicesV1beta1Args(
      ...
      ports: pulumi.Output.create<List<int>>((map['ports'] as List).cast<int>()),
      ...
      type: map['type'] == null ? null : pulumi.Output.create<GatewayTypeNetworkservicesV1beta1>(GatewayTypeNetworkservicesV1beta1.fromValue(map['type'] as String)),
    );
  }
}
