...
class HttpRouteDestinationResponse {
  ...
  /// Creates a new [HttpRouteDestinationResponse].
  ...
  const HttpRouteDestinationResponse({
  ...
  factory HttpRouteDestinationResponse.fromMap(Map<String, dynamic> map) {
    return HttpRouteDestinationResponse(
