...
/// {@template pulumi_networkservices_v1_edge_cache_origin_iam_policy_args_doc}
/// The set of arguments for EdgeCacheOriginIamPolicy.
/// {@endtemplate}
/// {@macro pulumi_networkservices_v1_edge_cache_origin_iam_policy_args_doc}
class EdgeCacheOriginIamPolicyArgs {
  ...
  /// Creates a new [EdgeCacheOriginIamPolicyArgs].
  ...
  factory EdgeCacheOriginIamPolicyArgs.fromMap(Map<String, dynamic> map) {
    return EdgeCacheOriginIamPolicyArgs(
      auditConfigs: (() {
      ...
      edgeCacheOriginId: pulumi.Input.fromValue(
        map['edgeCacheOriginId'] as String,
      ),
      etag: (() {
