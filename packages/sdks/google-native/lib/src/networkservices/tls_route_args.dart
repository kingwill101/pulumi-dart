...
class TlsRouteArgs {
  ...
  TlsRouteArgs({
    ...
    required pulumi.Output<List<TlsRouteRouteRule>> rules,
  ...
  factory TlsRouteArgs.fromMap(Map<String, dynamic> map) {
    return TlsRouteArgs(
      ...
      rules: pulumi.Output.create<List<TlsRouteRouteRule>>(pulumi.Input.decodeList<TlsRouteRouteRule>(map['rules'], (value) => TlsRouteRouteRule.fromMap((value as Map).cast<String, dynamic>()))),
