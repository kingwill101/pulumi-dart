...
class LbRouteExtensionArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'loadBalancingScheme': pulumi.Input.mapInputValue<LbRouteExtensionLoadBalancingScheme, String>(loadBalancingScheme, (value) => value.wireValue),
      'location': ?location,
      'name': ?name,
      'project': ?project,
      'requestId': ?requestId,
  ...
  factory LbRouteExtensionArgs.fromMap(Map<String, dynamic> map) {
    return LbRouteExtensionArgs(
      ...
      extensionChains: pulumi.Input.fromValue(pulumi.Input.decodeList<ExtensionChain>(map['extensionChains']!, (value) => ExtensionChain.fromMap((value as Map).cast<String, dynamic>()))),
      forwardingRules: pulumi.Input.fromValue((map['forwardingRules'] as List).cast<String>()),
      labels: (() { final guardedValue = map['labels']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      lbRouteExtensionId: pulumi.Input.fromValue(map['lbRouteExtensionId'] as String),
      loadBalancingScheme: pulumi.Input.fromValue(LbRouteExtensionLoadBalancingScheme.fromValue(map['loadBalancingScheme']! as String)),
