...
class LbRouteExtensionArgs {
  ...
  LbRouteExtensionArgs({
    ...
    required pulumi.Output<LbRouteExtensionLoadBalancingScheme> loadBalancingScheme,
    ...
    pulumi.Output<String>? requestId,
      ...
      loadBalancingScheme = pulumi.Input.asInput<LbRouteExtensionLoadBalancingScheme>(loadBalancingScheme),
  ...
  factory LbRouteExtensionArgs.fromMap(Map<String, dynamic> map) {
    return LbRouteExtensionArgs(
      ...
      loadBalancingScheme: pulumi.Output.create<LbRouteExtensionLoadBalancingScheme>(LbRouteExtensionLoadBalancingScheme.fromValue(map['loadBalancingScheme'] as String)),
