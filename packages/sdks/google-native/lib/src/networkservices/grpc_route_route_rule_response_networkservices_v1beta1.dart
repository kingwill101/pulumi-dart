...
class GrpcRouteRouteRuleResponseNetworkservicesV1beta1 {
  ...
  factory GrpcRouteRouteRuleResponseNetworkservicesV1beta1.fromMap(Map<String, dynamic> map) {
    return GrpcRouteRouteRuleResponseNetworkservicesV1beta1(
      action: (GrpcRouteRouteActionResponseNetworkservicesV1beta1.fromMap((map['action'] as Map).cast<String, dynamic>())).input(),
      matches: (pulumi.Input.decodeList<GrpcRouteRouteMatchResponseNetworkservicesV1beta1>(map['matches'], (value) => GrpcRouteRouteMatchResponseNetworkservicesV1beta1.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
