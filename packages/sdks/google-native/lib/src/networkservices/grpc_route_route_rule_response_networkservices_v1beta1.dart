...
class GrpcRouteRouteRuleResponseNetworkservicesV1beta1 {
  ...
  final pulumi.Input<List<GrpcRouteRouteMatchResponseNetworkservicesV1beta1>>
  matches;
  ...
  GrpcRouteRouteRuleResponseNetworkservicesV1beta1({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'matches':
          pulumi.Input.mapInputValue<
            List<GrpcRouteRouteMatchResponseNetworkservicesV1beta1>,
  ...
  factory GrpcRouteRouteRuleResponseNetworkservicesV1beta1.fromMap(
    Map<String, dynamic> map,
  ) {
    return GrpcRouteRouteRuleResponseNetworkservicesV1beta1(
      action: pulumi.Input.fromValue(
        GrpcRouteRouteActionResponseNetworkservicesV1beta1.fromMap(
      ...
      matches: pulumi.Input.fromValue(
        ...
        >(
          map['matches']!,
          (value) => GrpcRouteRouteMatchResponseNetworkservicesV1beta1.fromMap(
