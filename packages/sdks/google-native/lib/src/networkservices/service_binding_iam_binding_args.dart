...
/// {@template pulumi_networkservices_v1_service_binding_iam_binding_args_doc}
/// The set of arguments for ServiceBindingIamBinding.
/// {@endtemplate}
/// {@macro pulumi_networkservices_v1_service_binding_iam_binding_args_doc}
class ServiceBindingIamBindingArgs {
  ...
  /// Creates a new [ServiceBindingIamBindingArgs].
  ...
  const ServiceBindingIamBindingArgs({
    this.condition,
  ...
  factory ServiceBindingIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return ServiceBindingIamBindingArgs(
