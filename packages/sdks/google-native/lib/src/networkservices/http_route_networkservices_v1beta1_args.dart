...
class HttpRouteNetworkservicesV1beta1Args {
  ...
  factory HttpRouteNetworkservicesV1beta1Args.fromMap(Map<String, dynamic> map) {
    return HttpRouteNetworkservicesV1beta1Args(
      ...
      rules: pulumi.Input.fromValue(pulumi.Input.decodeList<HttpRouteRouteRuleNetworkservicesV1beta1>(map['rules']!, (value) => HttpRouteRouteRuleNetworkservicesV1beta1.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
