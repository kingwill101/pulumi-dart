...
class EndpointPolicyNetworkservicesV1beta1 extends pulumi.CustomResource {
  ...
  EndpointPolicyNetworkservicesV1beta1(
    ...
    this.endpointMatcher = registerOutput<EndpointMatcherResponseNetworkservicesV1beta1>('endpointMatcher');
    ...
    this.trafficPortSelector = registerOutput<TrafficPortSelectorResponseNetworkservicesV1beta1>('trafficPortSelector');
