...
/// {@template pulumi_networkservices_v1_endpoint_policy_iam_binding_args_doc}
/// The set of arguments for EndpointPolicyIamBinding.
/// {@endtemplate}
/// {@macro pulumi_networkservices_v1_endpoint_policy_iam_binding_args_doc}
class EndpointPolicyIamBindingArgs {
  ...
  /// Creates a new [EndpointPolicyIamBindingArgs].
  ...
  const EndpointPolicyIamBindingArgs({
    this.condition,
  ...
  factory EndpointPolicyIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return EndpointPolicyIamBindingArgs(
