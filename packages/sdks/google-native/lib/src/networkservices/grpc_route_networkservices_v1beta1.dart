...
class GrpcRouteNetworkservicesV1beta1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<GrpcRouteRouteRuleResponseNetworkservicesV1beta1>> rules;
  ...
  GrpcRouteNetworkservicesV1beta1(
    ...
    this.rules = registerOutput<List<GrpcRouteRouteRuleResponseNetworkservicesV1beta1>>('rules');
