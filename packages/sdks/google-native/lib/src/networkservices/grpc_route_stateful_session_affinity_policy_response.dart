...
class GrpcRouteStatefulSessionAffinityPolicyResponse {
  ...
  /// Creates a new [GrpcRouteStatefulSessionAffinityPolicyResponse].
  ...
  const GrpcRouteStatefulSessionAffinityPolicyResponse({
  ...
  factory GrpcRouteStatefulSessionAffinityPolicyResponse.fromMap(Map<String, dynamic> map) {
    return GrpcRouteStatefulSessionAffinityPolicyResponse(
