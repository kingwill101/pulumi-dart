...
class HttpRouteRouteRuleResponseNetworkservicesV1beta1 {
  ...
  final pulumi.Input<List<HttpRouteRouteMatchResponseNetworkservicesV1beta1>>
  matches;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'matches':
          pulumi.Input.mapInputValue<
            List<HttpRouteRouteMatchResponseNetworkservicesV1beta1>,
  ...
  factory HttpRouteRouteRuleResponseNetworkservicesV1beta1.fromMap(
    ...
    return HttpRouteRouteRuleResponseNetworkservicesV1beta1(
      action: pulumi.Input.fromValue(
        HttpRouteRouteActionResponseNetworkservicesV1beta1.fromMap(
