...
class ExtensionChain {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'extensions': pulumi.Input.mapInputValue<List<ExtensionChainExtension>, List<Map<String, dynamic>>>(extensions, (value) => pulumi.Input.encodeList<ExtensionChainExtension, Map<String, dynamic>>(value, (value) => value.toMap())),
      'matchCondition': pulumi.Input.mapInputValue<ExtensionChainMatchCondition, Map<String, dynamic>>(matchCondition, (value) => value.toMap()),
      'name': name,
    };
  }
  ...
  factory ExtensionChain.fromMap(Map<String, dynamic> map) {
    return ExtensionChain(
      extensions: pulumi.Input.fromValue(pulumi.Input.decodeList<ExtensionChainExtension>(map['extensions']!, (value) => ExtensionChainExtension.fromMap((value as Map).cast<String, dynamic>()))),
      matchCondition: pulumi.Input.fromValue(ExtensionChainMatchCondition.fromMap((map['matchCondition']! as Map).cast<String, dynamic>())),
