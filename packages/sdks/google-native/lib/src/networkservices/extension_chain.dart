...
class ExtensionChain {
  ...
  factory ExtensionChain.fromMap(Map<String, dynamic> map) {
    return ExtensionChain(
      extensions: (pulumi.Input.decodeList<ExtensionChainExtension>(map['extensions'], (value) => ExtensionChainExtension.fromMap((value as Map).cast<String, dynamic>()))).input(),
      matchCondition: (ExtensionChainMatchCondition.fromMap((map['matchCondition'] as Map).cast<String, dynamic>())).input(),
