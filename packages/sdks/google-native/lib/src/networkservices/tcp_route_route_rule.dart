...
class TcpRouteRouteRule {
  ...
  TcpRouteRouteRule({required this.action, this.matches});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'action':
          pulumi.Input.mapInputValue<TcpRouteRouteAction, Map<String, dynamic>>(
            action,
            (value) => value.toMap(),
          ),
      'matches':
          ?pulumi.Input.mapOptionalInputValue<
            List<TcpRouteRouteMatch>,
    ...
    return TcpRouteRouteRule(
      ...
      matches: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<TcpRouteRouteMatch>(
            guardedValue,
