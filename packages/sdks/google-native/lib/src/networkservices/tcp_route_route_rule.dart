...
class TcpRouteRouteRule {
  ...
  factory TcpRouteRouteRule.fromMap(Map<String, dynamic> map) {
    return TcpRouteRouteRule(
      action: pulumi.Input.fromValue(TcpRouteRouteAction.fromMap((map['action']! as Map).cast<String, dynamic>())),
      matches: (() { final guardedValue = map['matches']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<TcpRouteRouteMatch>(guardedValue, (value) => TcpRouteRouteMatch.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
