...
class HttpRouteArgs {
  ...
  HttpRouteArgs({
    ...
    required pulumi.Output<List<HttpRouteRouteRule>> rules,
  }) :
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'project': ?project,
      'rules': pulumi.Input.mapInputValue<List<HttpRouteRouteRule>, List<Map<String, dynamic>>>(rules, (value) => pulumi.Input.encodeList<HttpRouteRouteRule, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory HttpRouteArgs.fromMap(Map<String, dynamic> map) {
    return HttpRouteArgs(
      ...
      rules: pulumi.Output.create<List<HttpRouteRouteRule>>(pulumi.Input.decodeList<HttpRouteRouteRule>(map['rules'], (value) => HttpRouteRouteRule.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
