...
/// {@template pulumi_networkservices_v1_endpoint_policy_iam_member_args_doc}
/// The set of arguments for EndpointPolicyIamMember.
/// {@endtemplate}
/// {@macro pulumi_networkservices_v1_endpoint_policy_iam_member_args_doc}
class EndpointPolicyIamMemberArgs {
  ...
  /// Creates a new [EndpointPolicyIamMemberArgs].
  ...
  const EndpointPolicyIamMemberArgs({
    this.condition,
  ...
  factory EndpointPolicyIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return EndpointPolicyIamMemberArgs(
