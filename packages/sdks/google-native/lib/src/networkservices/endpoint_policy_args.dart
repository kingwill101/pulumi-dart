...
class EndpointPolicyArgs {
  ...
  EndpointPolicyArgs({
    ...
    required pulumi.Output<EndpointMatcher> endpointMatcher,
    ...
    pulumi.Output<TrafficPortSelector>? trafficPortSelector,
    required pulumi.Output<EndpointPolicyType> type,
  }) :
  ...
  factory EndpointPolicyArgs.fromMap(Map<String, dynamic> map) {
    return EndpointPolicyArgs(
      ...
      endpointMatcher: pulumi.Output.create<EndpointMatcher>(EndpointMatcher.fromMap((map['endpointMatcher'] as Map).cast<String, dynamic>())),
      ...
      trafficPortSelector: map['trafficPortSelector'] == null ? null : pulumi.Output.create<TrafficPortSelector>(TrafficPortSelector.fromMap((map['trafficPortSelector'] as Map).cast<String, dynamic>())),
      type: pulumi.Output.create<EndpointPolicyType>(EndpointPolicyType.fromValue(map['type'] as String)),
    );
  }
}
