...
class EndpointMatcherMetadataLabelMatcher {
  ...
  final EndpointMatcherMetadataLabelMatcherMetadataLabelMatchCriteria? metadataLabelMatchCriteria;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'metadataLabelMatchCriteria': ?metadataLabelMatchCriteria == null ? null : metadataLabelMatchCriteria!.value,
      'metadataLabels': ?metadataLabels == null ? null : pulumi.Input.encodeList<EndpointMatcherMetadataLabelMatcherMetadataLabels, Map<String, dynamic>>(metadataLabels!, (value) => value.toMap()),
    };
  }

  factory EndpointMatcherMetadataLabelMatcher.fromMap(Map<String, dynamic> map) {
    return EndpointMatcherMetadataLabelMatcher(
      metadataLabelMatchCriteria: map['metadataLabelMatchCriteria'] == null ? null : EndpointMatcherMetadataLabelMatcherMetadataLabelMatchCriteria.fromValue(map['metadataLabelMatchCriteria'] as String),
      metadataLabels: map['metadataLabels'] == null ? null : pulumi.Input.decodeList<EndpointMatcherMetadataLabelMatcherMetadataLabels>(map['metadataLabels'], (value) => EndpointMatcherMetadataLabelMatcherMetadataLabels.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
