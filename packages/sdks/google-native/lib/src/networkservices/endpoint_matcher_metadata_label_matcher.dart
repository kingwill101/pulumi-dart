...
class EndpointMatcherMetadataLabelMatcher {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'metadataLabelMatchCriteria': ?pulumi.Input.mapOptionalInputValue<EndpointMatcherMetadataLabelMatcherMetadataLabelMatchCriteria, String>(metadataLabelMatchCriteria, (value) => value.value),
