...
class HttpRouteRouteMatchResponseNetworkservicesV1beta1 {
  ...
  final pulumi.Input<List<HttpRouteHeaderMatchResponseNetworkservicesV1beta1>>
  headers;
  ...
  final pulumi.Input<
    List<HttpRouteQueryParameterMatchResponseNetworkservicesV1beta1>
  >
  queryParameters;
    ...
    return <String, dynamic>{
      ...
      'headers':
          pulumi.Input.mapInputValue<
            List<HttpRouteHeaderMatchResponseNetworkservicesV1beta1>,
    ...
    return HttpRouteRouteMatchResponseNetworkservicesV1beta1(
      ...
      queryParameters: pulumi.Input.fromValue(
        ...
        >(
          map['queryParameters']!,
          (value) =>
              HttpRouteQueryParameterMatchResponseNetworkservicesV1beta1.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
