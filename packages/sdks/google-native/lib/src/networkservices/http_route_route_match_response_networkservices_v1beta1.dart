...
class HttpRouteRouteMatchResponseNetworkservicesV1beta1 {
  ...
  factory HttpRouteRouteMatchResponseNetworkservicesV1beta1.fromMap(Map<String, dynamic> map) {
    return HttpRouteRouteMatchResponseNetworkservicesV1beta1(
      ...
      headers: (pulumi.Input.decodeList<HttpRouteHeaderMatchResponseNetworkservicesV1beta1>(map['headers'], (value) => HttpRouteHeaderMatchResponseNetworkservicesV1beta1.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ignoreCase: (map['ignoreCase'] as bool).input(),
      prefixMatch: (map['prefixMatch'] as String).input(),
      queryParameters: (pulumi.Input.decodeList<HttpRouteQueryParameterMatchResponseNetworkservicesV1beta1>(map['queryParameters'], (value) => HttpRouteQueryParameterMatchResponseNetworkservicesV1beta1.fromMap((value as Map).cast<String, dynamic>()))).input(),
