...
class GetServiceLbPolicyResult {
  ...
  factory GetServiceLbPolicyResult.fromMap(Map<String, dynamic> map) {
    return GetServiceLbPolicyResult(
      autoCapacityDrain: ServiceLbPolicyAutoCapacityDrainResponse.fromMap((map['autoCapacityDrain']! as Map).cast<String, dynamic>()),
      createTime: map['createTime'] as String,
      description: map['description'] as String,
      failoverConfig: ServiceLbPolicyFailoverConfigResponse.fromMap((map['failoverConfig']! as Map).cast<String, dynamic>()),
