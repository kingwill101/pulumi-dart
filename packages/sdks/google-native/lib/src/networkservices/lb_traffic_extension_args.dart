...
class LbTrafficExtensionArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'loadBalancingScheme': pulumi.Input.mapInputValue<LbTrafficExtensionLoadBalancingScheme, String>(loadBalancingScheme, (value) => value.wireValue),
      'location': ?location,
      'name': ?name,
      'project': ?project,
      'requestId': ?requestId,
  ...
  factory LbTrafficExtensionArgs.fromMap(Map<String, dynamic> map) {
    return LbTrafficExtensionArgs(
      ...
      loadBalancingScheme: pulumi.Input.fromValue(LbTrafficExtensionLoadBalancingScheme.fromValue(map['loadBalancingScheme']! as String)),
