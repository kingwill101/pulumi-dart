...
class GatewayArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'type': ?pulumi.Input.mapOptionalInputValue<GatewayType, String>(type, (value) => value.wireValue),
    };
  }
  ...
  factory GatewayArgs.fromMap(Map<String, dynamic> map) {
    return GatewayArgs(
      ...
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GatewayType.fromValue(guardedValue as String)); })(),
    );
  }
}
