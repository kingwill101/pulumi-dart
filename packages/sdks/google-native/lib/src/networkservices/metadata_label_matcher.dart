...
class MetadataLabelMatcher {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'metadataLabelMatchCriteria': ?pulumi.Input.mapOptionalInputValue<MetadataLabelMatcherMetadataLabelMatchCriteria, String>(metadataLabelMatchCriteria, (value) => value.value),
