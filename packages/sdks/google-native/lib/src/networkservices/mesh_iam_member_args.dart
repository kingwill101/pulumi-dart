...
/// {@template pulumi_networkservices_v1_mesh_iam_member_args_doc}
/// The set of arguments for MeshIamMember.
/// {@endtemplate}
/// {@macro pulumi_networkservices_v1_mesh_iam_member_args_doc}
class MeshIamMemberArgs {
  ...
  /// Creates a new [MeshIamMemberArgs].
  ...
  factory MeshIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return MeshIamMemberArgs(
