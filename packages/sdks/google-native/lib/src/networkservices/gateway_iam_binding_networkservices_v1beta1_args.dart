...
/// {@template pulumi_networkservices_v1beta1_gateway_iam_binding_networkservices_v1beta1_args_doc}
/// The set of arguments for GatewayIamBinding.
/// {@endtemplate}
/// {@macro pulumi_networkservices_v1beta1_gateway_iam_binding_networkservices_v1beta1_args_doc}
class GatewayIamBindingNetworkservicesV1beta1Args {
  ...
  /// Creates a new [GatewayIamBindingNetworkservicesV1beta1Args].
  ...
  const GatewayIamBindingNetworkservicesV1beta1Args({
    this.condition,
  ...
  factory GatewayIamBindingNetworkservicesV1beta1Args.fromMap(Map<String, dynamic> map) {
    return GatewayIamBindingNetworkservicesV1beta1Args(
