...
/// {@template pulumi_networkservices_v1beta1_service_lb_policy_iam_member_args_doc}
/// The set of arguments for ServiceLbPolicyIamMember.
/// {@endtemplate}
/// {@macro pulumi_networkservices_v1beta1_service_lb_policy_iam_member_args_doc}
class ServiceLbPolicyIamMemberArgs {
  ...
  /// Creates a new [ServiceLbPolicyIamMemberArgs].
  ...
  const ServiceLbPolicyIamMemberArgs({
    this.condition,
  ...
  factory ServiceLbPolicyIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return ServiceLbPolicyIamMemberArgs(
