...
class TlsRouteNetworkservicesV1beta1Args {
  ...
  const TlsRouteNetworkservicesV1beta1Args({
    this.description,
    this.gateways,
    this.labels,
    this.location,
  ...
  factory TlsRouteNetworkservicesV1beta1Args.fromMap(Map<String, dynamic> map) {
    return TlsRouteNetworkservicesV1beta1Args(
      ...
      rules: pulumi.Input.fromValue(pulumi.Input.decodeList<TlsRouteRouteRuleNetworkservicesV1beta1>(map['rules']!, (value) => TlsRouteRouteRuleNetworkservicesV1beta1.fromMap((value as Map).cast<String, dynamic>()))),
