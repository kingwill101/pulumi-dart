...
class GoogleCloudDatacatalogLineageV1EventLink {
  ...
  const GoogleCloudDatacatalogLineageV1EventLink({
  ...
  factory GoogleCloudDatacatalogLineageV1EventLink.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDatacatalogLineageV1EventLink(
      source: pulumi.Input.fromValue(GoogleCloudDatacatalogLineageV1EntityReference.fromMap((map['source']! as Map).cast<String, dynamic>())),
      target: pulumi.Input.fromValue(GoogleCloudDatacatalogLineageV1EntityReference.fromMap((map['target']! as Map).cast<String, dynamic>())),
    );
  }
}
