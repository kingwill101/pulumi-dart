...
class BuildConfig {
  ...
  final pulumi.Input<BuildConfigDockerRegistry>? dockerRegistry;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'dockerRegistry': ?pulumi.Input.mapOptionalInputValue<BuildConfigDockerRegistry, String>(dockerRegistry, (value) => value.wireValue),
  ...
  factory BuildConfig.fromMap(Map<String, dynamic> map) {
    return BuildConfig(
      dockerRegistry: (() { final guardedValue = map['dockerRegistry']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BuildConfigDockerRegistry.fromValue(guardedValue as String)); })(),
