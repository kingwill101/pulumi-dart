...
class SecretVolumeCloudfunctionsV2alpha {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'project': ?project,
      'secret': ?secret,
      'versions': ?versions == null ? null : pulumi.Input.encodeList<SecretVersionCloudfunctionsV2alpha, Map<String, dynamic>>(versions!, (value) => value.toMap()),
    };
  }
  ...
  factory SecretVolumeCloudfunctionsV2alpha.fromMap(Map<String, dynamic> map) {
    return SecretVolumeCloudfunctionsV2alpha(
      ...
      versions: map['versions'] == null ? null : pulumi.Input.decodeList<SecretVersionCloudfunctionsV2alpha>(map['versions'], (value) => SecretVersionCloudfunctionsV2alpha.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
