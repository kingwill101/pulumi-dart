...
class SecretVolumeCloudfunctionsV2alpha {
  ...
  const SecretVolumeCloudfunctionsV2alpha({
    this.mountPath,
    this.project,
    this.secret,
    this.versions,
  ...
  factory SecretVolumeCloudfunctionsV2alpha.fromMap(Map<String, dynamic> map) {
    return SecretVolumeCloudfunctionsV2alpha(
      ...
      versions: (() { final guardedValue = map['versions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SecretVersionCloudfunctionsV2alpha>(guardedValue, (value) => SecretVersionCloudfunctionsV2alpha.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
