...
class FunctionCloudfunctionsV2betaArgs {
  ...
  const FunctionCloudfunctionsV2betaArgs({
    this.buildConfig,
    this.description,
    this.environment,
    this.eventTrigger,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'environment': ?pulumi.Input.mapOptionalInputValue<FunctionEnvironmentCloudfunctionsV2beta, String>(environment, (value) => value.wireValue),
  ...
  factory FunctionCloudfunctionsV2betaArgs.fromMap(Map<String, dynamic> map) {
    return FunctionCloudfunctionsV2betaArgs(
      buildConfig: (() { final guardedValue = map['buildConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BuildConfigCloudfunctionsV2beta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      description: (() { final guardedValue = map['description']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      environment: (() { final guardedValue = map['environment']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FunctionEnvironmentCloudfunctionsV2beta.fromValue(guardedValue as String)); })(),
      eventTrigger: (() { final guardedValue = map['eventTrigger']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EventTriggerCloudfunctionsV2beta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      serviceConfig: (() { final guardedValue = map['serviceConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServiceConfigCloudfunctionsV2beta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
