...
class StorageSourceCloudfunctionsV2beta {
  ...
  /// Creates a new [StorageSourceCloudfunctionsV2beta].
  ...
  const StorageSourceCloudfunctionsV2beta({
    this.bucket,
    this.generation,
    this.object_,
  });
  ...
  factory StorageSourceCloudfunctionsV2beta.fromMap(Map<String, dynamic> map) {
    return StorageSourceCloudfunctionsV2beta(
