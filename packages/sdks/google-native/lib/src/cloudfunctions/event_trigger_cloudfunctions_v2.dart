...
class EventTriggerCloudfunctionsV2 {
  ...
  final pulumi.Input<EventTriggerRetryPolicy>? retryPolicy;
  ...
  /// Creates a new [EventTriggerCloudfunctionsV2].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'channel': ?channel,
      'eventFilters': ?pulumi.Input.mapOptionalInputValue<List<EventFilter>, List<Map<String, dynamic>>>(eventFilters, (value) => pulumi.Input.encodeList<EventFilter, Map<String, dynamic>>(value, (value) => value.toMap())),
      'eventType': eventType,
      'pubsubTopic': ?pubsubTopic,
      'retryPolicy': ?pulumi.Input.mapOptionalInputValue<EventTriggerRetryPolicy, String>(retryPolicy, (value) => value.wireValue),
  ...
  factory EventTriggerCloudfunctionsV2.fromMap(Map<String, dynamic> map) {
    return EventTriggerCloudfunctionsV2(
      ...
      eventFilters: (() { final guardedValue = map['eventFilters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<EventFilter>(guardedValue, (value) => EventFilter.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      retryPolicy: (() { final guardedValue = map['retryPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EventTriggerRetryPolicy.fromValue(guardedValue as String)); })(),
