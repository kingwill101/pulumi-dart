    ...
    return <String, dynamic>{
      ...
      'eventFilters':
          ...
          >(
            eventFilters,
            (value) =>
                pulumi.Input.encodeList<EventFilter, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      ...
      'retryPolicy':
          ?pulumi.Input.mapOptionalInputValue<EventTriggerRetryPolicy, String>(
            retryPolicy,
    ...
    return EventTriggerCloudfunctionsV2(
      ...
      eventFilters: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EventFilter>(
            guardedValue,
            (value) =>
      ...
      retryPolicy: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          EventTriggerRetryPolicy.fromValue(guardedValue as String),
        );
      })(),
      serviceAccountEmail: (() {
