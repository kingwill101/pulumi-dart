...
class ServiceConfig {
  ...
  final pulumi.Input<ServiceConfigIngressSettings>? ingressSettings;
  ...
  final pulumi.Input<List<SecretEnvVarCloudfunctionsV2>>? secretEnvironmentVariables;
  /// Secret volumes configuration.
  final pulumi.Input<List<SecretVolumeCloudfunctionsV2>>? secretVolumes;
  /// Security level configure whether the function only accepts https. This configuration is only applicable to 1st Gen functions with Http trigger. By default https is optional for 1st Gen functions; 2nd Gen functions are https ONLY.
  final pulumi.Input<ServiceConfigSecurityLevel>? securityLevel;
  ...
  final pulumi.Input<ServiceConfigVpcConnectorEgressSettings>? vpcConnectorEgressSettings;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ingressSettings': ?pulumi.Input.mapOptionalInputValue<ServiceConfigIngressSettings, String>(ingressSettings, (value) => value.wireValue),
      'maxInstanceCount': ?maxInstanceCount,
      'maxInstanceRequestConcurrency': ?maxInstanceRequestConcurrency,
      'minInstanceCount': ?minInstanceCount,
      'secretEnvironmentVariables': ?pulumi.Input.mapOptionalInputValue<List<SecretEnvVarCloudfunctionsV2>, List<Map<String, dynamic>>>(secretEnvironmentVariables, (value) => pulumi.Input.encodeList<SecretEnvVarCloudfunctionsV2, Map<String, dynamic>>(value, (value) => value.toMap())),
      'secretVolumes': ?pulumi.Input.mapOptionalInputValue<List<SecretVolumeCloudfunctionsV2>, List<Map<String, dynamic>>>(secretVolumes, (value) => pulumi.Input.encodeList<SecretVolumeCloudfunctionsV2, Map<String, dynamic>>(value, (value) => value.toMap())),
      'securityLevel': ?pulumi.Input.mapOptionalInputValue<ServiceConfigSecurityLevel, String>(securityLevel, (value) => value.wireValue),
      'serviceAccountEmail': ?serviceAccountEmail,
      'timeoutSeconds': ?timeoutSeconds,
      'vpcConnector': ?vpcConnector,
      'vpcConnectorEgressSettings': ?pulumi.Input.mapOptionalInputValue<ServiceConfigVpcConnectorEgressSettings, String>(vpcConnectorEgressSettings, (value) => value.wireValue),
    };
  }
  ...
  factory ServiceConfig.fromMap(Map<String, dynamic> map) {
    return ServiceConfig(
      ...
      ingressSettings: (() { final guardedValue = map['ingressSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServiceConfigIngressSettings.fromValue(guardedValue as String)); })(),
      ...
      secretEnvironmentVariables: (() { final guardedValue = map['secretEnvironmentVariables']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SecretEnvVarCloudfunctionsV2>(guardedValue, (value) => SecretEnvVarCloudfunctionsV2.fromMap((value as Map).cast<String, dynamic>()))); })(),
      secretVolumes: (() { final guardedValue = map['secretVolumes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SecretVolumeCloudfunctionsV2>(guardedValue, (value) => SecretVolumeCloudfunctionsV2.fromMap((value as Map).cast<String, dynamic>()))); })(),
      securityLevel: (() { final guardedValue = map['securityLevel']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServiceConfigSecurityLevel.fromValue(guardedValue as String)); })(),
      ...
      vpcConnectorEgressSettings: (() { final guardedValue = map['vpcConnectorEgressSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServiceConfigVpcConnectorEgressSettings.fromValue(guardedValue as String)); })(),
    );
  }
}
