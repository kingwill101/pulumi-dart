...
class ServiceConfig {
  ...
  final pulumi.Input<List<SecretEnvVarCloudfunctionsV2>>?
  ...
  final pulumi.Input<ServiceConfigVpcConnectorEgressSettings>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'secretEnvironmentVariables':
          ?pulumi.Input.mapOptionalInputValue<
            List<SecretEnvVarCloudfunctionsV2>,
            List<Map<String, dynamic>>
          >(
            secretEnvironmentVariables,
            (value) =>
                pulumi.Input.encodeList<
                  SecretEnvVarCloudfunctionsV2,
                  Map<String, dynamic>
                >(value, (value) => value.toMap()),
          ),
      'secretVolumes':
          ?pulumi.Input.mapOptionalInputValue<
            List<SecretVolumeCloudfunctionsV2>,
            List<Map<String, dynamic>>
          >(
            secretVolumes,
            (value) =>
  ...
  factory ServiceConfig.fromMap(Map<String, dynamic> map) {
    return ServiceConfig(
      ...
      ingressSettings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ServiceConfigIngressSettings.fromValue(guardedValue as String),
        );
      })(),
      maxInstanceCount: (() {
      ...
      securityLevel: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ServiceConfigSecurityLevel.fromValue(guardedValue as String),
        );
      })(),
      serviceAccountEmail: (() {
