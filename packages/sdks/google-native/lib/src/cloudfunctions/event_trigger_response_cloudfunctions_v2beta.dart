...
class EventTriggerResponseCloudfunctionsV2beta {
  ...
  final pulumi.Input<List<EventFilterResponseCloudfunctionsV2beta>>
  eventFilters;
    ...
    return <String, dynamic>{
      ...
      'eventFilters':
          pulumi.Input.mapInputValue<
            List<EventFilterResponseCloudfunctionsV2beta>,
  ...
  factory EventTriggerResponseCloudfunctionsV2beta.fromMap(
    ...
    return EventTriggerResponseCloudfunctionsV2beta(
      ...
      eventFilters: pulumi.Input.fromValue(
        pulumi.Input.decodeList<EventFilterResponseCloudfunctionsV2beta>(
          map['eventFilters']!,
          (value) => EventFilterResponseCloudfunctionsV2beta.fromMap(
