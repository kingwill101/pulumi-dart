...
import 'event_filter_response_cloudfunctions_v2beta.dart';

/// Describes EventTrigger, used to request events to be sent from another service.
class EventTriggerResponseCloudfunctionsV2beta {
  /// Optional. The name of the channel associated with the trigger in `projects/{project}/locations/{location}/channels/{channel}` format. You must provide a channel to receive events from Eventarc SaaS partners.
  final pulumi.Input<String> channel;
  /// Criteria used to filter events.
  final pulumi.Input<List<EventFilterResponseCloudfunctionsV2beta>> eventFilters;
  ...
  /// Creates a new [EventTriggerResponseCloudfunctionsV2beta].
  ...
  const EventTriggerResponseCloudfunctionsV2beta({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'channel': channel,
      'eventFilters': pulumi.Input.mapInputValue<List<EventFilterResponseCloudfunctionsV2beta>, List<Map<String, dynamic>>>(eventFilters, (value) => pulumi.Input.encodeList<EventFilterResponseCloudfunctionsV2beta, Map<String, dynamic>>(value, (value) => value.toMap())),
      'eventType': eventType,
  ...
  factory EventTriggerResponseCloudfunctionsV2beta.fromMap(Map<String, dynamic> map) {
    return EventTriggerResponseCloudfunctionsV2beta(
      channel: pulumi.Input.fromValue(map['channel'] as String),
      eventFilters: pulumi.Input.fromValue(pulumi.Input.decodeList<EventFilterResponseCloudfunctionsV2beta>(map['eventFilters']!, (value) => EventFilterResponseCloudfunctionsV2beta.fromMap((value as Map).cast<String, dynamic>()))),
