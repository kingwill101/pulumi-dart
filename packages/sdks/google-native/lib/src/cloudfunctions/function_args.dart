...
class FunctionArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'dockerRegistry': ?pulumi.Input.mapOptionalInputValue<FunctionDockerRegistry, String>(dockerRegistry, (value) => value.wireValue),
      ...
      'ingressSettings': ?pulumi.Input.mapOptionalInputValue<FunctionIngressSettings, String>(ingressSettings, (value) => value.wireValue),
      ...
      'vpcConnectorEgressSettings': ?pulumi.Input.mapOptionalInputValue<FunctionVpcConnectorEgressSettings, String>(vpcConnectorEgressSettings, (value) => value.wireValue),
    };
  }
  ...
  factory FunctionArgs.fromMap(Map<String, dynamic> map) {
    return FunctionArgs(
      ...
      dockerRegistry: (() { final guardedValue = map['dockerRegistry']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FunctionDockerRegistry.fromValue(guardedValue as String)); })(),
      ...
      eventTrigger: (() { final guardedValue = map['eventTrigger']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EventTrigger.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      httpsTrigger: (() { final guardedValue = map['httpsTrigger']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HttpsTrigger.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ingressSettings: (() { final guardedValue = map['ingressSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FunctionIngressSettings.fromValue(guardedValue as String)); })(),
      ...
      secretEnvironmentVariables: (() { final guardedValue = map['secretEnvironmentVariables']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SecretEnvVar>(guardedValue, (value) => SecretEnvVar.fromMap((value as Map).cast<String, dynamic>()))); })(),
      secretVolumes: (() { final guardedValue = map['secretVolumes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SecretVolume>(guardedValue, (value) => SecretVolume.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      sourceArchiveUrl: (() { final guardedValue = map['sourceArchiveUrl']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      sourceRepository: (() { final guardedValue = map['sourceRepository']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SourceRepository.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      sourceUploadUrl: (() { final guardedValue = map['sourceUploadUrl']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      vpcConnectorEgressSettings: (() { final guardedValue = map['vpcConnectorEgressSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FunctionVpcConnectorEgressSettings.fromValue(guardedValue as String)); })(),
    );
  }
}
