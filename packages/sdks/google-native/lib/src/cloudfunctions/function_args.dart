...
class FunctionArgs {
  ...
  FunctionArgs({
    ...
    pulumi.Output<FunctionDockerRegistry>? dockerRegistry,
    pulumi.Output<String>? dockerRepository,
    pulumi.Output<String>? entryPoint,
    pulumi.Output<Map<String, String>>? environmentVariables,
    pulumi.Output<EventTrigger>? eventTrigger,
    pulumi.Output<HttpsTrigger>? httpsTrigger,
    pulumi.Output<FunctionIngressSettings>? ingressSettings,
    ...
    pulumi.Output<List<SecretEnvVar>>? secretEnvironmentVariables,
    pulumi.Output<List<SecretVolume>>? secretVolumes,
    pulumi.Output<String>? serviceAccountEmail,
    pulumi.Output<String>? sourceArchiveUrl,
    pulumi.Output<SourceRepository>? sourceRepository,
    pulumi.Output<String>? sourceToken,
    pulumi.Output<String>? sourceUploadUrl,
    pulumi.Output<String>? timeout,
    pulumi.Output<String>? vpcConnector,
    pulumi.Output<FunctionVpcConnectorEgressSettings>? vpcConnectorEgressSettings,
  }) :
  ...
  factory FunctionArgs.fromMap(Map<String, dynamic> map) {
    return FunctionArgs(
      ...
      dockerRegistry: map['dockerRegistry'] == null ? null : pulumi.Output.create<FunctionDockerRegistry>(FunctionDockerRegistry.fromValue(map['dockerRegistry'] as String)),
      ...
      eventTrigger: map['eventTrigger'] == null ? null : pulumi.Output.create<EventTrigger>(EventTrigger.fromMap((map['eventTrigger'] as Map).cast<String, dynamic>())),
      httpsTrigger: map['httpsTrigger'] == null ? null : pulumi.Output.create<HttpsTrigger>(HttpsTrigger.fromMap((map['httpsTrigger'] as Map).cast<String, dynamic>())),
      ingressSettings: map['ingressSettings'] == null ? null : pulumi.Output.create<FunctionIngressSettings>(FunctionIngressSettings.fromValue(map['ingressSettings'] as String)),
      ...
      secretEnvironmentVariables: map['secretEnvironmentVariables'] == null ? null : pulumi.Output.create<List<SecretEnvVar>>(pulumi.Input.decodeList<SecretEnvVar>(map['secretEnvironmentVariables'], (value) => SecretEnvVar.fromMap((value as Map).cast<String, dynamic>()))),
      secretVolumes: map['secretVolumes'] == null ? null : pulumi.Output.create<List<SecretVolume>>(pulumi.Input.decodeList<SecretVolume>(map['secretVolumes'], (value) => SecretVolume.fromMap((value as Map).cast<String, dynamic>()))),
      serviceAccountEmail: map['serviceAccountEmail'] == null ? null : pulumi.Output.create<String>(map['serviceAccountEmail'] as String),
      sourceArchiveUrl: map['sourceArchiveUrl'] == null ? null : pulumi.Output.create<String>(map['sourceArchiveUrl'] as String),
      sourceRepository: map['sourceRepository'] == null ? null : pulumi.Output.create<SourceRepository>(SourceRepository.fromMap((map['sourceRepository'] as Map).cast<String, dynamic>())),
      sourceToken: map['sourceToken'] == null ? null : pulumi.Output.create<String>(map['sourceToken'] as String),
      sourceUploadUrl: map['sourceUploadUrl'] == null ? null : pulumi.Output.create<String>(map['sourceUploadUrl'] as String),
      ...
      vpcConnectorEgressSettings: map['vpcConnectorEgressSettings'] == null ? null : pulumi.Output.create<FunctionVpcConnectorEgressSettings>(FunctionVpcConnectorEgressSettings.fromValue(map['vpcConnectorEgressSettings'] as String)),
    );
  }
}
