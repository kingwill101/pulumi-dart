...
class FunctionArgs {
  ...
  factory FunctionArgs.fromMap(Map<String, dynamic> map) {
    return FunctionArgs(
      ...
      dockerRegistry: map['dockerRegistry'] == null ? null : (FunctionDockerRegistry.fromValue(map['dockerRegistry']! as String)).input(),
      ...
      eventTrigger: map['eventTrigger'] == null ? null : (EventTrigger.fromMap((map['eventTrigger']! as Map).cast<String, dynamic>())).input(),
      httpsTrigger: map['httpsTrigger'] == null ? null : (HttpsTrigger.fromMap((map['httpsTrigger']! as Map).cast<String, dynamic>())).input(),
      ingressSettings: map['ingressSettings'] == null ? null : (FunctionIngressSettings.fromValue(map['ingressSettings']! as String)).input(),
      ...
      secretEnvironmentVariables: map['secretEnvironmentVariables'] == null ? null : (pulumi.Input.decodeList<SecretEnvVar>(map['secretEnvironmentVariables']!, (value) => SecretEnvVar.fromMap((value as Map).cast<String, dynamic>()))).input(),
      secretVolumes: map['secretVolumes'] == null ? null : (pulumi.Input.decodeList<SecretVolume>(map['secretVolumes']!, (value) => SecretVolume.fromMap((value as Map).cast<String, dynamic>()))).input(),
      serviceAccountEmail: map['serviceAccountEmail'] == null ? null : (map['serviceAccountEmail']! as String).input(),
      sourceArchiveUrl: map['sourceArchiveUrl'] == null ? null : (map['sourceArchiveUrl']! as String).input(),
      sourceRepository: map['sourceRepository'] == null ? null : (SourceRepository.fromMap((map['sourceRepository']! as Map).cast<String, dynamic>())).input(),
      sourceToken: map['sourceToken'] == null ? null : (map['sourceToken']! as String).input(),
      sourceUploadUrl: map['sourceUploadUrl'] == null ? null : (map['sourceUploadUrl']! as String).input(),
      timeout: map['timeout'] == null ? null : (map['timeout']! as String).input(),
      vpcConnector: map['vpcConnector'] == null ? null : (map['vpcConnector']! as String).input(),
      vpcConnectorEgressSettings: map['vpcConnectorEgressSettings'] == null ? null : (FunctionVpcConnectorEgressSettings.fromValue(map['vpcConnectorEgressSettings']! as String)).input(),
    );
  }
}
