...
import 'source_provenance_response_cloudfunctions_v2alpha.dart';
import 'source_response_cloudfunctions_v2alpha.dart';

/// Describes the Build step of the function that builds a container from the given source.
class BuildConfigResponseCloudfunctionsV2alpha {
  ...
  final pulumi.Input<SourceResponseCloudfunctionsV2alpha> source;
  /// A permanent fixed identifier for source.
  final pulumi.Input<SourceProvenanceResponseCloudfunctionsV2alpha> sourceProvenance;
  ...
  /// Creates a new [BuildConfigResponseCloudfunctionsV2alpha].
  ...
  BuildConfigResponseCloudfunctionsV2alpha({
    required this.build,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'runtime': runtime,
      'source': pulumi.Input.mapInputValue<SourceResponseCloudfunctionsV2alpha, Map<String, dynamic>>(source, (value) => value.toMap()),
      'sourceProvenance': pulumi.Input.mapInputValue<SourceProvenanceResponseCloudfunctionsV2alpha, Map<String, dynamic>>(sourceProvenance, (value) => value.toMap()),
      'sourceToken': sourceToken,
      'workerPool': workerPool,
    };
  }

  factory BuildConfigResponseCloudfunctionsV2alpha.fromMap(Map<String, dynamic> map) {
    return BuildConfigResponseCloudfunctionsV2alpha(
      build: (map['build'] as String).input(),
      dockerRegistry: (map['dockerRegistry'] as String).input(),
      dockerRepository: (map['dockerRepository'] as String).input(),
      ...
      source: (SourceResponseCloudfunctionsV2alpha.fromMap((map['source'] as Map).cast<String, dynamic>())).input(),
      sourceProvenance: (SourceProvenanceResponseCloudfunctionsV2alpha.fromMap((map['sourceProvenance'] as Map).cast<String, dynamic>())).input(),
      sourceToken: (map['sourceToken'] as String).input(),
