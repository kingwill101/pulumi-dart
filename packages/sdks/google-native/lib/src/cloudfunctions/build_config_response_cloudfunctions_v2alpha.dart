...
class BuildConfigResponseCloudfunctionsV2alpha {
  ...
  final pulumi.Input<SourceProvenanceResponseCloudfunctionsV2alpha>
  sourceProvenance;
  ...
  factory BuildConfigResponseCloudfunctionsV2alpha.fromMap(
    ...
    return BuildConfigResponseCloudfunctionsV2alpha(
      ...
      source: pulumi.Input.fromValue(
        SourceResponseCloudfunctionsV2alpha.fromMap(
          (map['source']! as Map).cast<String, dynamic>(),
        ),
      ),
      sourceProvenance: pulumi.Input.fromValue(
        SourceProvenanceResponseCloudfunctionsV2alpha.fromMap(
