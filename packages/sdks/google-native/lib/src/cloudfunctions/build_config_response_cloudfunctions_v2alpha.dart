...
class BuildConfigResponseCloudfunctionsV2alpha {
  ...
  const BuildConfigResponseCloudfunctionsV2alpha({
    required this.build,
  ...
  factory BuildConfigResponseCloudfunctionsV2alpha.fromMap(Map<String, dynamic> map) {
    return BuildConfigResponseCloudfunctionsV2alpha(
      ...
      source: pulumi.Input.fromValue(SourceResponseCloudfunctionsV2alpha.fromMap((map['source']! as Map).cast<String, dynamic>())),
      sourceProvenance: pulumi.Input.fromValue(SourceProvenanceResponseCloudfunctionsV2alpha.fromMap((map['sourceProvenance']! as Map).cast<String, dynamic>())),
