...
class EventTrigger {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'eventType': eventType,
      'failurePolicy': ?pulumi.Input.mapOptionalInputValue<FailurePolicy, Map<String, dynamic>>(failurePolicy, (value) => value.toMap()),
      'resource': resource,
      'service': ?service,
    };
  }
  ...
  factory EventTrigger.fromMap(Map<String, dynamic> map) {
    return EventTrigger(
      ...
      failurePolicy: (() { final guardedValue = map['failurePolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FailurePolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
