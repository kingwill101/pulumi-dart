...
class EventTriggerCloudfunctionsV2alpha {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'retryPolicy': ?pulumi.Input.mapOptionalInputValue<EventTriggerRetryPolicyCloudfunctionsV2alpha, String>(retryPolicy, (value) => value.value),
  ...
  factory EventTriggerCloudfunctionsV2alpha.fromMap(Map<String, dynamic> map) {
    return EventTriggerCloudfunctionsV2alpha(
      ...
      eventFilters: map['eventFilters'] == null ? null : (pulumi.Input.decodeList<EventFilterCloudfunctionsV2alpha>(map['eventFilters'], (value) => EventFilterCloudfunctionsV2alpha.fromMap((value as Map).cast<String, dynamic>()))).input(),
      eventType: (map['eventType'] as String).input(),
      pubsubTopic: map['pubsubTopic'] == null ? null : (map['pubsubTopic'] as String).input(),
      retryPolicy: map['retryPolicy'] == null ? null : (EventTriggerRetryPolicyCloudfunctionsV2alpha.fromValue(map['retryPolicy'] as String)).input(),
