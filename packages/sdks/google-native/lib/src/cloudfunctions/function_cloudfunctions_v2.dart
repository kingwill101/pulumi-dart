...
class FunctionCloudfunctionsV2 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<GoogleCloudFunctionsV2StateMessageResponse>> stateMessages;
  ...
  FunctionCloudfunctionsV2(
    ...
    this.eventTrigger = registerOutput<EventTriggerResponseCloudfunctionsV2>('eventTrigger');
    ...
    this.stateMessages = registerOutput<List<GoogleCloudFunctionsV2StateMessageResponse>>('stateMessages');
