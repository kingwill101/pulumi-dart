...
class SecretVolumeCloudfunctionsV2beta {
  ...
  final List<SecretVersionCloudfunctionsV2beta>? versions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'project': ?project,
      'secret': ?secret,
      'versions': ?versions == null ? null : pulumi.Input.encodeList<SecretVersionCloudfunctionsV2beta, Map<String, dynamic>>(versions!, (value) => value.toMap()),
    };
  }
  ...
  factory SecretVolumeCloudfunctionsV2beta.fromMap(Map<String, dynamic> map) {
    return SecretVolumeCloudfunctionsV2beta(
      ...
      versions: map['versions'] == null ? null : pulumi.Input.decodeList<SecretVersionCloudfunctionsV2beta>(map['versions'], (value) => SecretVersionCloudfunctionsV2beta.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
