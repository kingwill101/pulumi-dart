...
class FunctionIamPolicyCloudfunctionsV2Args {
  ...
  FunctionIamPolicyCloudfunctionsV2Args({
    pulumi.Output<List<AuditConfigCloudfunctionsV2>>? auditConfigs,
    pulumi.Output<List<BindingCloudfunctionsV2>>? bindings,
    ...
    pulumi.Output<int>? version,
      ...
      auditConfigs = pulumi.Input.asOptionalInput<List<AuditConfigCloudfunctionsV2>>(auditConfigs),
      bindings = pulumi.Input.asOptionalInput<List<BindingCloudfunctionsV2>>(bindings),
  ...
  factory FunctionIamPolicyCloudfunctionsV2Args.fromMap(Map<String, dynamic> map) {
    return FunctionIamPolicyCloudfunctionsV2Args(
      auditConfigs: map['auditConfigs'] == null ? null : pulumi.Output.create<List<AuditConfigCloudfunctionsV2>>(pulumi.Input.decodeList<AuditConfigCloudfunctionsV2>(map['auditConfigs'], (value) => AuditConfigCloudfunctionsV2.fromMap((value as Map).cast<String, dynamic>()))),
      bindings: map['bindings'] == null ? null : pulumi.Output.create<List<BindingCloudfunctionsV2>>(pulumi.Input.decodeList<BindingCloudfunctionsV2>(map['bindings'], (value) => BindingCloudfunctionsV2.fromMap((value as Map).cast<String, dynamic>()))),
