...
class FunctionIamPolicyCloudfunctionsV2Args {
  ...
  factory FunctionIamPolicyCloudfunctionsV2Args.fromMap(Map<String, dynamic> map) {
    return FunctionIamPolicyCloudfunctionsV2Args(
      auditConfigs: map['auditConfigs'] == null ? null : (pulumi.Input.decodeList<AuditConfigCloudfunctionsV2>(map['auditConfigs']!, (value) => AuditConfigCloudfunctionsV2.fromMap((value as Map).cast<String, dynamic>()))).input(),
      bindings: map['bindings'] == null ? null : (pulumi.Input.decodeList<BindingCloudfunctionsV2>(map['bindings']!, (value) => BindingCloudfunctionsV2.fromMap((value as Map).cast<String, dynamic>()))).input(),
