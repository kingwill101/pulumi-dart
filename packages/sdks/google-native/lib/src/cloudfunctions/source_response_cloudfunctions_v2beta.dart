...
class SourceResponseCloudfunctionsV2beta {
  ...
  factory SourceResponseCloudfunctionsV2beta.fromMap(Map<String, dynamic> map) {
    return SourceResponseCloudfunctionsV2beta(
      ...
      repoSource: (RepoSourceResponseCloudfunctionsV2beta.fromMap((map['repoSource'] as Map).cast<String, dynamic>())).input(),
      storageSource: (StorageSourceResponseCloudfunctionsV2beta.fromMap((map['storageSource'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
