...
class SecretEnvVarResponse {
  ...
  /// Creates a new [SecretEnvVarResponse].
  ...
  factory SecretEnvVarResponse.fromMap(Map<String, dynamic> map) {
    return SecretEnvVarResponse(
