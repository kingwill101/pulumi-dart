...
class GetFunctionResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'network': network,
      'runtime': runtime,
      'secretEnvironmentVariables': pulumi.Input.encodeList<SecretEnvVarResponse, Map<String, dynamic>>(secretEnvironmentVariables, (value) => value.toMap()),
      'secretVolumes': pulumi.Input.encodeList<SecretVolumeResponse, Map<String, dynamic>>(secretVolumes, (value) => value.toMap()),
  ...
  factory GetFunctionResult.fromMap(Map<String, dynamic> map) {
    return GetFunctionResult(
      ...
      eventTrigger: EventTriggerResponse.fromMap((map['eventTrigger']! as Map).cast<String, dynamic>()),
      httpsTrigger: HttpsTriggerResponse.fromMap((map['httpsTrigger']! as Map).cast<String, dynamic>()),
      ...
      secretEnvironmentVariables: pulumi.Input.decodeList<SecretEnvVarResponse>(map['secretEnvironmentVariables']!, (value) => SecretEnvVarResponse.fromMap((value as Map).cast<String, dynamic>())),
      secretVolumes: pulumi.Input.decodeList<SecretVolumeResponse>(map['secretVolumes']!, (value) => SecretVolumeResponse.fromMap((value as Map).cast<String, dynamic>())),
      serviceAccountEmail: map['serviceAccountEmail'] as String,
      sourceArchiveUrl: map['sourceArchiveUrl'] as String,
      sourceRepository: SourceRepositoryResponse.fromMap((map['sourceRepository']! as Map).cast<String, dynamic>()),
