...
class AuditLogConfigCloudfunctionsV2 {
  ...
  const AuditLogConfigCloudfunctionsV2({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'logType': ?pulumi.Input.mapOptionalInputValue<AuditLogConfigLogTypeCloudfunctionsV2, String>(logType, (value) => value.wireValue),
    };
  }
  ...
  factory AuditLogConfigCloudfunctionsV2.fromMap(Map<String, dynamic> map) {
    return AuditLogConfigCloudfunctionsV2(
      ...
      logType: (() { final guardedValue = map['logType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AuditLogConfigLogTypeCloudfunctionsV2.fromValue(guardedValue as String)); })(),
    );
  }
}
