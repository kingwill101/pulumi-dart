...
class SecretEnvVarCloudfunctionsV2 {
  ...
  /// Creates a new [SecretEnvVarCloudfunctionsV2].
  ...
  const SecretEnvVarCloudfunctionsV2({
    this.key,
    this.project,
    this.secret,
    this.version,
  ...
  factory SecretEnvVarCloudfunctionsV2.fromMap(Map<String, dynamic> map) {
    return SecretEnvVarCloudfunctionsV2(
