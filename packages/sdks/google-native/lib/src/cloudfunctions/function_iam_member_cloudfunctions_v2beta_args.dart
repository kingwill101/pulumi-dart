...
/// {@template pulumi_cloudfunctions_v2beta_function_iam_member_cloudfunctions_v2beta_args_doc}
/// The set of arguments for FunctionIamMember.
/// {@endtemplate}
/// {@macro pulumi_cloudfunctions_v2beta_function_iam_member_cloudfunctions_v2beta_args_doc}
class FunctionIamMemberCloudfunctionsV2betaArgs {
  ...
  /// Creates a new [FunctionIamMemberCloudfunctionsV2betaArgs].
  ...
  const FunctionIamMemberCloudfunctionsV2betaArgs({
    this.condition,
  ...
  factory FunctionIamMemberCloudfunctionsV2betaArgs.fromMap(Map<String, dynamic> map) {
    return FunctionIamMemberCloudfunctionsV2betaArgs(
