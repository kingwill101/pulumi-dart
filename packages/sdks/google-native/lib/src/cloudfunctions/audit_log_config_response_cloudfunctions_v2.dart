...
class AuditLogConfigResponseCloudfunctionsV2 {
  ...
  factory AuditLogConfigResponseCloudfunctionsV2.fromMap(Map<String, dynamic> map) {
    return AuditLogConfigResponseCloudfunctionsV2(
