...
class EventTriggerResponseCloudfunctionsV2alpha {
  ...
  final List<EventFilterResponseCloudfunctionsV2alpha> eventFilters;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'channel': channel,
      'eventFilters': pulumi.Input.encodeList<EventFilterResponseCloudfunctionsV2alpha, Map<String, dynamic>>(eventFilters, (value) => value.toMap()),
      'eventType': eventType,
  ...
  factory EventTriggerResponseCloudfunctionsV2alpha.fromMap(Map<String, dynamic> map) {
    return EventTriggerResponseCloudfunctionsV2alpha(
      ...
      eventFilters: pulumi.Input.decodeList<EventFilterResponseCloudfunctionsV2alpha>(map['eventFilters'], (value) => EventFilterResponseCloudfunctionsV2alpha.fromMap((value as Map).cast<String, dynamic>())),
