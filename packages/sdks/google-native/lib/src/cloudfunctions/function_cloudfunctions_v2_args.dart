    ...
    return FunctionCloudfunctionsV2Args(
      buildConfig: (() {
        ...
        return pulumi.Input.fromValue(
          BuildConfig.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      description: (() {
      ...
      environment: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FunctionEnvironment.fromValue(guardedValue as String),
        );
      })(),
      eventTrigger: (() {
      ...
      serviceConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ServiceConfig.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
