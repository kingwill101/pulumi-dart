...
class SecretVolumeResponseCloudfunctionsV2alpha {
  ...
  const SecretVolumeResponseCloudfunctionsV2alpha({
  ...
  factory SecretVolumeResponseCloudfunctionsV2alpha.fromMap(Map<String, dynamic> map) {
    return SecretVolumeResponseCloudfunctionsV2alpha(
      ...
      versions: pulumi.Input.fromValue(pulumi.Input.decodeList<SecretVersionResponseCloudfunctionsV2alpha>(map['versions']!, (value) => SecretVersionResponseCloudfunctionsV2alpha.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
