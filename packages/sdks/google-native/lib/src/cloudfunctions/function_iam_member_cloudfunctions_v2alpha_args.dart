...
/// {@template pulumi_cloudfunctions_v2alpha_function_iam_member_cloudfunctions_v2alpha_args_doc}
/// The set of arguments for FunctionIamMember.
/// {@endtemplate}
/// {@macro pulumi_cloudfunctions_v2alpha_function_iam_member_cloudfunctions_v2alpha_args_doc}
class FunctionIamMemberCloudfunctionsV2alphaArgs {
  ...
  /// Creates a new [FunctionIamMemberCloudfunctionsV2alphaArgs].
  ...
  const FunctionIamMemberCloudfunctionsV2alphaArgs({
    this.condition,
  ...
  factory FunctionIamMemberCloudfunctionsV2alphaArgs.fromMap(Map<String, dynamic> map) {
    return FunctionIamMemberCloudfunctionsV2alphaArgs(
