...
/// {@template pulumi_cloudfunctions_v2alpha_function_iam_binding_cloudfunctions_v2alpha_args_doc}
/// The set of arguments for FunctionIamBinding.
/// {@endtemplate}
/// {@macro pulumi_cloudfunctions_v2alpha_function_iam_binding_cloudfunctions_v2alpha_args_doc}
class FunctionIamBindingCloudfunctionsV2alphaArgs {
  ...
  /// Creates a new [FunctionIamBindingCloudfunctionsV2alphaArgs].
  ...
  const FunctionIamBindingCloudfunctionsV2alphaArgs({
    this.condition,
  ...
  factory FunctionIamBindingCloudfunctionsV2alphaArgs.fromMap(Map<String, dynamic> map) {
