...
class BuildConfigCloudfunctionsV2beta {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'dockerRegistry': ?pulumi.Input.mapOptionalInputValue<BuildConfigDockerRegistryCloudfunctionsV2beta, String>(dockerRegistry, (value) => value.value),
  ...
  factory BuildConfigCloudfunctionsV2beta.fromMap(Map<String, dynamic> map) {
    return BuildConfigCloudfunctionsV2beta(
      dockerRegistry: map['dockerRegistry'] == null ? null : (BuildConfigDockerRegistryCloudfunctionsV2beta.fromValue(map['dockerRegistry']! as String)).input(),
      ...
      source: map['source'] == null ? null : (SourceCloudfunctionsV2beta.fromMap((map['source']! as Map).cast<String, dynamic>())).input(),
