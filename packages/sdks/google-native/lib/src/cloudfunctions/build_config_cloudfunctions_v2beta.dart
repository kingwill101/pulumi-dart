...
class BuildConfigCloudfunctionsV2beta {
  ...
  final pulumi.Input<BuildConfigDockerRegistryCloudfunctionsV2beta>? dockerRegistry;
  ...
  final pulumi.Input<SourceCloudfunctionsV2beta>? source;
  ...
  const BuildConfigCloudfunctionsV2beta({
    this.dockerRegistry,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'dockerRegistry': ?pulumi.Input.mapOptionalInputValue<BuildConfigDockerRegistryCloudfunctionsV2beta, String>(dockerRegistry, (value) => value.wireValue),
      'dockerRepository': ?dockerRepository,
      'entryPoint': ?entryPoint,
      'environmentVariables': ?environmentVariables,
      'runtime': ?runtime,
      'source': ?pulumi.Input.mapOptionalInputValue<SourceCloudfunctionsV2beta, Map<String, dynamic>>(source, (value) => value.toMap()),
  ...
  factory BuildConfigCloudfunctionsV2beta.fromMap(Map<String, dynamic> map) {
    return BuildConfigCloudfunctionsV2beta(
      dockerRegistry: (() { final guardedValue = map['dockerRegistry']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BuildConfigDockerRegistryCloudfunctionsV2beta.fromValue(guardedValue as String)); })(),
      ...
      source: (() { final guardedValue = map['source']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SourceCloudfunctionsV2beta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
