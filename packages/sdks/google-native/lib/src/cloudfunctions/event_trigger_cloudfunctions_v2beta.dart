...
class EventTriggerCloudfunctionsV2beta {
  ...
  const EventTriggerCloudfunctionsV2beta({
    this.channel,
    this.eventFilters,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'retryPolicy': ?pulumi.Input.mapOptionalInputValue<EventTriggerRetryPolicyCloudfunctionsV2beta, String>(retryPolicy, (value) => value.wireValue),
  ...
  factory EventTriggerCloudfunctionsV2beta.fromMap(Map<String, dynamic> map) {
    return EventTriggerCloudfunctionsV2beta(
      ...
      eventFilters: (() { final guardedValue = map['eventFilters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<EventFilterCloudfunctionsV2beta>(guardedValue, (value) => EventFilterCloudfunctionsV2beta.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      retryPolicy: (() { final guardedValue = map['retryPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EventTriggerRetryPolicyCloudfunctionsV2beta.fromValue(guardedValue as String)); })(),
