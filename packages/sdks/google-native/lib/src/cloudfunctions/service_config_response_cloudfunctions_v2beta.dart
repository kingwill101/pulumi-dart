...
class ServiceConfigResponseCloudfunctionsV2beta {
  ...
  final pulumi.Input<List<SecretEnvVarResponseCloudfunctionsV2beta>>
  secretEnvironmentVariables;

  /// Secret volumes configuration.
  final pulumi.Input<List<SecretVolumeResponseCloudfunctionsV2beta>>
  secretVolumes;
    ...
    return <String, dynamic>{
      ...
      'secretEnvironmentVariables':
          pulumi.Input.mapInputValue<
            List<SecretEnvVarResponseCloudfunctionsV2beta>,
      ...
      'secretVolumes':
          pulumi.Input.mapInputValue<
            List<SecretVolumeResponseCloudfunctionsV2beta>,
            List<Map<String, dynamic>>
          >(
            secretVolumes,
            (value) =>
