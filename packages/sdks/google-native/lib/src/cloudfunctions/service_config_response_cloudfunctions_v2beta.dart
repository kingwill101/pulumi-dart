...
class ServiceConfigResponseCloudfunctionsV2beta {
  ...
  factory ServiceConfigResponseCloudfunctionsV2beta.fromMap(Map<String, dynamic> map) {
    return ServiceConfigResponseCloudfunctionsV2beta(
      ...
      secretEnvironmentVariables: (pulumi.Input.decodeList<SecretEnvVarResponseCloudfunctionsV2beta>(map['secretEnvironmentVariables'], (value) => SecretEnvVarResponseCloudfunctionsV2beta.fromMap((value as Map).cast<String, dynamic>()))).input(),
      secretVolumes: (pulumi.Input.decodeList<SecretVolumeResponseCloudfunctionsV2beta>(map['secretVolumes'], (value) => SecretVolumeResponseCloudfunctionsV2beta.fromMap((value as Map).cast<String, dynamic>()))).input(),
