...
class SourceResponseCloudfunctionsV2alpha {
  ...
  factory SourceResponseCloudfunctionsV2alpha.fromMap(Map<String, dynamic> map) {
    return SourceResponseCloudfunctionsV2alpha(
      ...
      repoSource: (RepoSourceResponseCloudfunctionsV2alpha.fromMap((map['repoSource'] as Map).cast<String, dynamic>())).input(),
      storageSource: (StorageSourceResponseCloudfunctionsV2alpha.fromMap((map['storageSource'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
