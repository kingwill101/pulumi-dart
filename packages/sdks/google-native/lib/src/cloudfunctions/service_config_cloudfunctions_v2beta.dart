...
class ServiceConfigCloudfunctionsV2beta {
  ...
  final pulumi.Input<ServiceConfigIngressSettingsCloudfunctionsV2beta>?
  ingressSettings;
  ...
  final pulumi.Input<List<SecretEnvVarCloudfunctionsV2beta>>?
  ...
  final pulumi.Input<ServiceConfigSecurityLevelCloudfunctionsV2beta>?
  securityLevel;
    ...
    return <String, dynamic>{
      ...
      'ingressSettings':
          ?pulumi.Input.mapOptionalInputValue<
            ServiceConfigIngressSettingsCloudfunctionsV2beta,
            String
      ...
      'secretEnvironmentVariables':
          ?pulumi.Input.mapOptionalInputValue<
            List<SecretEnvVarCloudfunctionsV2beta>,
      ...
      'secretVolumes':
          ?pulumi.Input.mapOptionalInputValue<
            List<SecretVolumeCloudfunctionsV2beta>,
            List<Map<String, dynamic>>
          >(
            secretVolumes,
            (value) =>
      ...
      'securityLevel':
          ?pulumi.Input.mapOptionalInputValue<
            ServiceConfigSecurityLevelCloudfunctionsV2beta,
            String
