...
class ServiceConfigCloudfunctionsV2beta {
  ...
  final pulumi.Input<ServiceConfigIngressSettingsCloudfunctionsV2beta>? ingressSettings;
  ...
  final pulumi.Input<List<SecretEnvVarCloudfunctionsV2beta>>? secretEnvironmentVariables;
  /// Secret volumes configuration.
  final pulumi.Input<List<SecretVolumeCloudfunctionsV2beta>>? secretVolumes;
  /// Security level configure whether the function only accepts https. This configuration is only applicable to 1st Gen functions with Http trigger. By default https is optional for 1st Gen functions; 2nd Gen functions are https ONLY.
  final pulumi.Input<ServiceConfigSecurityLevelCloudfunctionsV2beta>? securityLevel;
  ...
  final pulumi.Input<ServiceConfigVpcConnectorEgressSettingsCloudfunctionsV2beta>? vpcConnectorEgressSettings;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ingressSettings': ?pulumi.Input.mapOptionalInputValue<ServiceConfigIngressSettingsCloudfunctionsV2beta, String>(ingressSettings, (value) => value.wireValue),
      'maxInstanceCount': ?maxInstanceCount,
      'maxInstanceRequestConcurrency': ?maxInstanceRequestConcurrency,
      'minInstanceCount': ?minInstanceCount,
      'secretEnvironmentVariables': ?pulumi.Input.mapOptionalInputValue<List<SecretEnvVarCloudfunctionsV2beta>, List<Map<String, dynamic>>>(secretEnvironmentVariables, (value) => pulumi.Input.encodeList<SecretEnvVarCloudfunctionsV2beta, Map<String, dynamic>>(value, (value) => value.toMap())),
      'secretVolumes': ?pulumi.Input.mapOptionalInputValue<List<SecretVolumeCloudfunctionsV2beta>, List<Map<String, dynamic>>>(secretVolumes, (value) => pulumi.Input.encodeList<SecretVolumeCloudfunctionsV2beta, Map<String, dynamic>>(value, (value) => value.toMap())),
      'securityLevel': ?pulumi.Input.mapOptionalInputValue<ServiceConfigSecurityLevelCloudfunctionsV2beta, String>(securityLevel, (value) => value.wireValue),
      'serviceAccountEmail': ?serviceAccountEmail,
      'timeoutSeconds': ?timeoutSeconds,
      'vpcConnector': ?vpcConnector,
      'vpcConnectorEgressSettings': ?pulumi.Input.mapOptionalInputValue<ServiceConfigVpcConnectorEgressSettingsCloudfunctionsV2beta, String>(vpcConnectorEgressSettings, (value) => value.wireValue),
    };
  }
  ...
  factory ServiceConfigCloudfunctionsV2beta.fromMap(Map<String, dynamic> map) {
    return ServiceConfigCloudfunctionsV2beta(
      ...
      ingressSettings: (() { final guardedValue = map['ingressSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServiceConfigIngressSettingsCloudfunctionsV2beta.fromValue(guardedValue as String)); })(),
      ...
      secretEnvironmentVariables: (() { final guardedValue = map['secretEnvironmentVariables']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SecretEnvVarCloudfunctionsV2beta>(guardedValue, (value) => SecretEnvVarCloudfunctionsV2beta.fromMap((value as Map).cast<String, dynamic>()))); })(),
      secretVolumes: (() { final guardedValue = map['secretVolumes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SecretVolumeCloudfunctionsV2beta>(guardedValue, (value) => SecretVolumeCloudfunctionsV2beta.fromMap((value as Map).cast<String, dynamic>()))); })(),
      securityLevel: (() { final guardedValue = map['securityLevel']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServiceConfigSecurityLevelCloudfunctionsV2beta.fromValue(guardedValue as String)); })(),
      ...
      vpcConnectorEgressSettings: (() { final guardedValue = map['vpcConnectorEgressSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServiceConfigVpcConnectorEgressSettingsCloudfunctionsV2beta.fromValue(guardedValue as String)); })(),
    );
  }
}
