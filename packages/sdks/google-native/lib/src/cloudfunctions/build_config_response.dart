...
class BuildConfigResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'sourceProvenance': pulumi.Input.mapInputValue<SourceProvenanceResponse, Map<String, dynamic>>(sourceProvenance, (value) => value.toMap()),
  ...
  factory BuildConfigResponse.fromMap(Map<String, dynamic> map) {
    return BuildConfigResponse(
      ...
      sourceProvenance: pulumi.Input.fromValue(SourceProvenanceResponse.fromMap((map['sourceProvenance']! as Map).cast<String, dynamic>())),
