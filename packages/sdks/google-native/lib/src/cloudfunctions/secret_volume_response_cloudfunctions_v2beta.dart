...
class SecretVolumeResponseCloudfunctionsV2beta {
  ...
  final pulumi.Input<List<SecretVersionResponseCloudfunctionsV2beta>> versions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'project': project,
      'secret': secret,
      'versions': pulumi.Input.mapInputValue<List<SecretVersionResponseCloudfunctionsV2beta>, List<Map<String, dynamic>>>(versions, (value) => pulumi.Input.encodeList<SecretVersionResponseCloudfunctionsV2beta, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory SecretVolumeResponseCloudfunctionsV2beta.fromMap(Map<String, dynamic> map) {
    return SecretVolumeResponseCloudfunctionsV2beta(
      ...
      versions: pulumi.Input.fromValue(pulumi.Input.decodeList<SecretVersionResponseCloudfunctionsV2beta>(map['versions']!, (value) => SecretVersionResponseCloudfunctionsV2beta.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
