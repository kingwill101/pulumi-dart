...
class SecretVersionResponseCloudfunctionsV2 {
  ...
  const SecretVersionResponseCloudfunctionsV2({
    required this.path,
  ...
  factory SecretVersionResponseCloudfunctionsV2.fromMap(Map<String, dynamic> map) {
    return SecretVersionResponseCloudfunctionsV2(
