...
class FunctionCloudfunctionsV2beta extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<GoogleCloudFunctionsV2betaStateMessageResponse>> stateMessages;
  ...
  FunctionCloudfunctionsV2beta(
    ...
    this.buildConfig = registerOutput<BuildConfigResponseCloudfunctionsV2beta>('buildConfig');
    this.description = registerOutput<String>('description');
    this.environment = registerOutput<String>('environment');
    this.eventTrigger = registerOutput<EventTriggerResponseCloudfunctionsV2beta>('eventTrigger');
    ...
    this.serviceConfig = registerOutput<ServiceConfigResponseCloudfunctionsV2beta>('serviceConfig');
    this.state = registerOutput<String>('state');
    this.stateMessages = registerOutput<List<GoogleCloudFunctionsV2betaStateMessageResponse>>('stateMessages');
