...
class ServiceConfigResponseCloudfunctionsV2alpha {
  ...
  factory ServiceConfigResponseCloudfunctionsV2alpha.fromMap(Map<String, dynamic> map) {
    return ServiceConfigResponseCloudfunctionsV2alpha(
      ...
      secretEnvironmentVariables: (pulumi.Input.decodeList<SecretEnvVarResponseCloudfunctionsV2alpha>(map['secretEnvironmentVariables'], (value) => SecretEnvVarResponseCloudfunctionsV2alpha.fromMap((value as Map).cast<String, dynamic>()))).input(),
      secretVolumes: (pulumi.Input.decodeList<SecretVolumeResponseCloudfunctionsV2alpha>(map['secretVolumes'], (value) => SecretVolumeResponseCloudfunctionsV2alpha.fromMap((value as Map).cast<String, dynamic>()))).input(),
