...
class ServiceConfigResponseCloudfunctionsV2alpha {
  ...
  final pulumi.Input<List<SecretEnvVarResponseCloudfunctionsV2alpha>> secretEnvironmentVariables;
  /// Secret volumes configuration.
  final pulumi.Input<List<SecretVolumeResponseCloudfunctionsV2alpha>> secretVolumes;
  ...
  const ServiceConfigResponseCloudfunctionsV2alpha({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'revision': revision,
      'secretEnvironmentVariables': pulumi.Input.mapInputValue<List<SecretEnvVarResponseCloudfunctionsV2alpha>, List<Map<String, dynamic>>>(secretEnvironmentVariables, (value) => pulumi.Input.encodeList<SecretEnvVarResponseCloudfunctionsV2alpha, Map<String, dynamic>>(value, (value) => value.toMap())),
      'secretVolumes': pulumi.Input.mapInputValue<List<SecretVolumeResponseCloudfunctionsV2alpha>, List<Map<String, dynamic>>>(secretVolumes, (value) => pulumi.Input.encodeList<SecretVolumeResponseCloudfunctionsV2alpha, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory ServiceConfigResponseCloudfunctionsV2alpha.fromMap(Map<String, dynamic> map) {
    return ServiceConfigResponseCloudfunctionsV2alpha(
      ...
      secretEnvironmentVariables: pulumi.Input.fromValue(pulumi.Input.decodeList<SecretEnvVarResponseCloudfunctionsV2alpha>(map['secretEnvironmentVariables']!, (value) => SecretEnvVarResponseCloudfunctionsV2alpha.fromMap((value as Map).cast<String, dynamic>()))),
      secretVolumes: pulumi.Input.fromValue(pulumi.Input.decodeList<SecretVolumeResponseCloudfunctionsV2alpha>(map['secretVolumes']!, (value) => SecretVolumeResponseCloudfunctionsV2alpha.fromMap((value as Map).cast<String, dynamic>()))),
