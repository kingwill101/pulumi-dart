...
class ServiceConfigResponseCloudfunctionsV2alpha {
  ...
  final pulumi.Input<List<SecretEnvVarResponseCloudfunctionsV2alpha>>
  secretEnvironmentVariables;

  /// Secret volumes configuration.
  final pulumi.Input<List<SecretVolumeResponseCloudfunctionsV2alpha>>
  secretVolumes;
    ...
    return <String, dynamic>{
      ...
      'secretEnvironmentVariables':
          pulumi.Input.mapInputValue<
            List<SecretEnvVarResponseCloudfunctionsV2alpha>,
      ...
      'secretVolumes':
          pulumi.Input.mapInputValue<
            List<SecretVolumeResponseCloudfunctionsV2alpha>,
            List<Map<String, dynamic>>
          >(
            secretVolumes,
            (value) =>
