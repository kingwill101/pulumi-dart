...
class BuildConfigResponseCloudfunctionsV2beta {
  ...
  factory BuildConfigResponseCloudfunctionsV2beta.fromMap(Map<String, dynamic> map) {
    return BuildConfigResponseCloudfunctionsV2beta(
      ...
      source: (SourceResponseCloudfunctionsV2beta.fromMap((map['source'] as Map).cast<String, dynamic>())).input(),
      sourceProvenance: (SourceProvenanceResponseCloudfunctionsV2beta.fromMap((map['sourceProvenance'] as Map).cast<String, dynamic>())).input(),
