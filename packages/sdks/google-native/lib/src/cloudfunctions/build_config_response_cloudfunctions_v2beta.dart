...
class BuildConfigResponseCloudfunctionsV2beta {
  ...
  final SourceResponseCloudfunctionsV2beta source;
  /// A permanent fixed identifier for source.
  final SourceProvenanceResponseCloudfunctionsV2beta sourceProvenance;
  ...
  factory BuildConfigResponseCloudfunctionsV2beta.fromMap(Map<String, dynamic> map) {
    return BuildConfigResponseCloudfunctionsV2beta(
      ...
      source: SourceResponseCloudfunctionsV2beta.fromMap((map['source'] as Map).cast<String, dynamic>()),
      sourceProvenance: SourceProvenanceResponseCloudfunctionsV2beta.fromMap((map['sourceProvenance'] as Map).cast<String, dynamic>()),
