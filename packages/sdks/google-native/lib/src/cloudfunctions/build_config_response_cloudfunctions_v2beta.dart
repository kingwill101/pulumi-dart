...
class BuildConfigResponseCloudfunctionsV2beta {
  ...
  final pulumi.Input<SourceProvenanceResponseCloudfunctionsV2beta>
  sourceProvenance;
  ...
  factory BuildConfigResponseCloudfunctionsV2beta.fromMap(
    ...
    return BuildConfigResponseCloudfunctionsV2beta(
      ...
      source: pulumi.Input.fromValue(
        SourceResponseCloudfunctionsV2beta.fromMap(
          (map['source']! as Map).cast<String, dynamic>(),
        ),
      ),
      sourceProvenance: pulumi.Input.fromValue(
        SourceProvenanceResponseCloudfunctionsV2beta.fromMap(
