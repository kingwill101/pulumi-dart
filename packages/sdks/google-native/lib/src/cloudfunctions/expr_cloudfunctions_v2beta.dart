...
class ExprCloudfunctionsV2beta {
  ...
  /// Creates a new [ExprCloudfunctionsV2beta].
  ...
  const ExprCloudfunctionsV2beta({
    this.description,
    this.expression,
    this.location,
    this.title,
  ...
  factory ExprCloudfunctionsV2beta.fromMap(Map<String, dynamic> map) {
    return ExprCloudfunctionsV2beta(
