...
class SecretVolume {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'project': ?project,
      'secret': ?secret,
      'versions': ?versions == null ? null : pulumi.Input.encodeList<SecretVersion, Map<String, dynamic>>(versions!, (value) => value.toMap()),
    };
  }
  ...
  factory SecretVolume.fromMap(Map<String, dynamic> map) {
    return SecretVolume(
      ...
      versions: map['versions'] == null ? null : pulumi.Input.decodeList<SecretVersion>(map['versions'], (value) => SecretVersion.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
