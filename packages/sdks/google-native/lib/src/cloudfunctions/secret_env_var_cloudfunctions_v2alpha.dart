...
class SecretEnvVarCloudfunctionsV2alpha {
  ...
  /// Creates a new [SecretEnvVarCloudfunctionsV2alpha].
  ...
  const SecretEnvVarCloudfunctionsV2alpha({
    this.key,
    this.project,
    this.secret,
    this.version,
  ...
  factory SecretEnvVarCloudfunctionsV2alpha.fromMap(Map<String, dynamic> map) {
    return SecretEnvVarCloudfunctionsV2alpha(
