...
class ExprResponseCloudfunctionsV2beta {
  ...
  /// Creates a new [ExprResponseCloudfunctionsV2beta].
  ...
  const ExprResponseCloudfunctionsV2beta({
  ...
  factory ExprResponseCloudfunctionsV2beta.fromMap(Map<String, dynamic> map) {
    return ExprResponseCloudfunctionsV2beta(
