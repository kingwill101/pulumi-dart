...
/// {@template pulumi_cloudfunctions_v2_function_iam_member_cloudfunctions_v2_args_doc}
/// The set of arguments for FunctionIamMember.
/// {@endtemplate}
/// {@macro pulumi_cloudfunctions_v2_function_iam_member_cloudfunctions_v2_args_doc}
class FunctionIamMemberCloudfunctionsV2Args {
  ...
  /// Creates a new [FunctionIamMemberCloudfunctionsV2Args].
  ...
  const FunctionIamMemberCloudfunctionsV2Args({
    this.condition,
  ...
  factory FunctionIamMemberCloudfunctionsV2Args.fromMap(Map<String, dynamic> map) {
    return FunctionIamMemberCloudfunctionsV2Args(
