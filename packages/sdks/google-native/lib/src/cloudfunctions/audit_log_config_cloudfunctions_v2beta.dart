...
class AuditLogConfigCloudfunctionsV2beta {
  ...
  AuditLogConfigCloudfunctionsV2beta({this.exemptedMembers, this.logType});
    ...
    return <String, dynamic>{
      ...
      'logType':
          ?pulumi.Input.mapOptionalInputValue<
            AuditLogConfigLogTypeCloudfunctionsV2beta,
            String
    ...
    return AuditLogConfigCloudfunctionsV2beta(
      ...
      logType: (() {
        ...
        return pulumi.Input.fromValue(
          AuditLogConfigLogTypeCloudfunctionsV2beta.fromValue(
