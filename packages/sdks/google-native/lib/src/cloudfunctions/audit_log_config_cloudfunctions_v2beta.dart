...
class AuditLogConfigCloudfunctionsV2beta {
  ...
  const AuditLogConfigCloudfunctionsV2beta({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'logType': ?pulumi.Input.mapOptionalInputValue<AuditLogConfigLogTypeCloudfunctionsV2beta, String>(logType, (value) => value.wireValue),
    };
  }
  ...
  factory AuditLogConfigCloudfunctionsV2beta.fromMap(Map<String, dynamic> map) {
    return AuditLogConfigCloudfunctionsV2beta(
      ...
      logType: (() { final guardedValue = map['logType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AuditLogConfigLogTypeCloudfunctionsV2beta.fromValue(guardedValue as String)); })(),
    );
  }
}
