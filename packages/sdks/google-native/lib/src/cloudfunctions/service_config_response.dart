...
class ServiceConfigResponse {
  ...
  final pulumi.Input<List<SecretEnvVarResponseCloudfunctionsV2>> secretEnvironmentVariables;
  /// Secret volumes configuration.
  final pulumi.Input<List<SecretVolumeResponseCloudfunctionsV2>> secretVolumes;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'revision': revision,
      'secretEnvironmentVariables': pulumi.Input.mapInputValue<List<SecretEnvVarResponseCloudfunctionsV2>, List<Map<String, dynamic>>>(secretEnvironmentVariables, (value) => pulumi.Input.encodeList<SecretEnvVarResponseCloudfunctionsV2, Map<String, dynamic>>(value, (value) => value.toMap())),
      'secretVolumes': pulumi.Input.mapInputValue<List<SecretVolumeResponseCloudfunctionsV2>, List<Map<String, dynamic>>>(secretVolumes, (value) => pulumi.Input.encodeList<SecretVolumeResponseCloudfunctionsV2, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory ServiceConfigResponse.fromMap(Map<String, dynamic> map) {
    return ServiceConfigResponse(
      ...
      secretEnvironmentVariables: pulumi.Input.fromValue(pulumi.Input.decodeList<SecretEnvVarResponseCloudfunctionsV2>(map['secretEnvironmentVariables']!, (value) => SecretEnvVarResponseCloudfunctionsV2.fromMap((value as Map).cast<String, dynamic>()))),
      secretVolumes: pulumi.Input.fromValue(pulumi.Input.decodeList<SecretVolumeResponseCloudfunctionsV2>(map['secretVolumes']!, (value) => SecretVolumeResponseCloudfunctionsV2.fromMap((value as Map).cast<String, dynamic>()))),
