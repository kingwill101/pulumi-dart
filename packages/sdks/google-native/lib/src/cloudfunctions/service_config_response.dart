...
class ServiceConfigResponse {
  ...
  factory ServiceConfigResponse.fromMap(Map<String, dynamic> map) {
    return ServiceConfigResponse(
      ...
      secretEnvironmentVariables: (pulumi.Input.decodeList<SecretEnvVarResponseCloudfunctionsV2>(map['secretEnvironmentVariables'], (value) => SecretEnvVarResponseCloudfunctionsV2.fromMap((value as Map).cast<String, dynamic>()))).input(),
      secretVolumes: (pulumi.Input.decodeList<SecretVolumeResponseCloudfunctionsV2>(map['secretVolumes'], (value) => SecretVolumeResponseCloudfunctionsV2.fromMap((value as Map).cast<String, dynamic>()))).input(),
