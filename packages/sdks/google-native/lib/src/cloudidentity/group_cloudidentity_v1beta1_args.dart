...
class GroupCloudidentityV1beta1Args {
  ...
  final pulumi.Input<DynamicGroupMetadataCloudidentityV1beta1>? dynamicGroupMetadata;
  ...
  const GroupCloudidentityV1beta1Args({
    this.description,
    this.displayName,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'dynamicGroupMetadata': ?pulumi.Input.mapOptionalInputValue<DynamicGroupMetadataCloudidentityV1beta1, Map<String, dynamic>>(dynamicGroupMetadata, (value) => value.toMap()),
      'groupKey': pulumi.Input.mapInputValue<EntityKeyCloudidentityV1beta1, Map<String, dynamic>>(groupKey, (value) => value.toMap()),
      'initialGroupConfig': initialGroupConfig,
      'labels': labels,
      'parent': parent,
      'posixGroups': ?pulumi.Input.mapOptionalInputValue<List<PosixGroup>, List<Map<String, dynamic>>>(posixGroups, (value) => pulumi.Input.encodeList<PosixGroup, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory GroupCloudidentityV1beta1Args.fromMap(Map<String, dynamic> map) {
    return GroupCloudidentityV1beta1Args(
      ...
      dynamicGroupMetadata: (() { final guardedValue = map['dynamicGroupMetadata']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DynamicGroupMetadataCloudidentityV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      groupKey: pulumi.Input.fromValue(EntityKeyCloudidentityV1beta1.fromMap((map['groupKey']! as Map).cast<String, dynamic>())),
      initialGroupConfig: pulumi.Input.fromValue(map['initialGroupConfig'] as String),
      labels: pulumi.Input.fromValue((map['labels'] as Map).cast<String, String>()),
      parent: pulumi.Input.fromValue(map['parent'] as String),
      posixGroups: (() { final guardedValue = map['posixGroups']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PosixGroup>(guardedValue, (value) => PosixGroup.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
