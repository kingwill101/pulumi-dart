...
class DynamicGroupQuery {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'query': ?query,
      'resourceType': ?pulumi.Input.mapOptionalInputValue<DynamicGroupQueryResourceType, String>(resourceType, (value) => value.wireValue),
    };
  }
  ...
  factory DynamicGroupQuery.fromMap(Map<String, dynamic> map) {
    return DynamicGroupQuery(
      ...
      resourceType: (() { final guardedValue = map['resourceType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DynamicGroupQueryResourceType.fromValue(guardedValue as String)); })(),
    );
  }
}
