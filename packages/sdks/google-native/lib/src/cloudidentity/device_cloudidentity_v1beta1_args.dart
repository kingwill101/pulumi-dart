...
class DeviceCloudidentityV1beta1Args {
  ...
  DeviceCloudidentityV1beta1Args({
    pulumi.Output<String>? assetTag,
    pulumi.Output<List<DeviceClientTypesItem>>? clientTypes,
    ...
    pulumi.Output<List<String>>? wifiMacAddresses,
  }) :
      assetTag = pulumi.Input.asOptionalInput<String>(assetTag),
      clientTypes = pulumi.Input.asOptionalInput<List<DeviceClientTypesItem>>(clientTypes),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'assetTag': ?assetTag,
      'clientTypes': ?pulumi.Input.mapOptionalInputValue<List<DeviceClientTypesItem>, List<String>>(clientTypes, (value) => pulumi.Input.encodeList<DeviceClientTypesItem, String>(value, (value) => value.value)),
      'customer': ?customer,
      'deviceId': ?deviceId,
      'hostname': ?hostname,
  ...
  factory DeviceCloudidentityV1beta1Args.fromMap(Map<String, dynamic> map) {
    return DeviceCloudidentityV1beta1Args(
      assetTag: map['assetTag'] == null ? null : pulumi.Output.create<String>(map['assetTag'] as String),
      clientTypes: map['clientTypes'] == null ? null : pulumi.Output.create<List<DeviceClientTypesItem>>(pulumi.Input.decodeList<DeviceClientTypesItem>(map['clientTypes'], (value) => DeviceClientTypesItem.fromValue(value as String))),
      ...
      wifiMacAddresses: map['wifiMacAddresses'] == null ? null : pulumi.Output.create<List<String>>((map['wifiMacAddresses'] as List).cast<String>()),
    );
  }
}
