...
class MembershipRoleResponse {
  ...
  factory MembershipRoleResponse.fromMap(Map<String, dynamic> map) {
    return MembershipRoleResponse(
      expiryDetail: (ExpiryDetailResponse.fromMap((map['expiryDetail'] as Map).cast<String, dynamic>())).input(),
      name: (map['name'] as String).input(),
      restrictionEvaluations: (RestrictionEvaluationsResponse.fromMap((map['restrictionEvaluations'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
