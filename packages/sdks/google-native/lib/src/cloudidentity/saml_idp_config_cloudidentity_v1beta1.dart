...
class SamlIdpConfigCloudidentityV1beta1 {
  ...
  const SamlIdpConfigCloudidentityV1beta1({
  ...
  factory SamlIdpConfigCloudidentityV1beta1.fromMap(Map<String, dynamic> map) {
    return SamlIdpConfigCloudidentityV1beta1(
      changePasswordUri: (() { final guardedValue = map['changePasswordUri']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      entityId: pulumi.Input.fromValue(map['entityId'] as String),
      logoutRedirectUri: (() { final guardedValue = map['logoutRedirectUri']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
