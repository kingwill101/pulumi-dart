...
class DynamicGroupMetadata {
  ...
  factory DynamicGroupMetadata.fromMap(Map<String, dynamic> map) {
    return DynamicGroupMetadata(
      queries: (() { final guardedValue = map['queries']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DynamicGroupQuery>(guardedValue, (value) => DynamicGroupQuery.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
