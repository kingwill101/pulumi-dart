...
class GetInboundSsoAssignmentCloudidentityV1beta1Result {
  ...
  factory GetInboundSsoAssignmentCloudidentityV1beta1Result.fromMap(
    ...
    return GetInboundSsoAssignmentCloudidentityV1beta1Result(
      ...
      samlSsoInfo: SamlSsoInfoResponseCloudidentityV1beta1.fromMap(
        (map['samlSsoInfo']! as Map).cast<String, dynamic>(),
      ),
      signInBehavior: SignInBehaviorResponseCloudidentityV1beta1.fromMap(
