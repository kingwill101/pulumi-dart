...
class GroupArgs {
  ...
  factory GroupArgs.fromMap(Map<String, dynamic> map) {
    return GroupArgs(
      ...
      dynamicGroupMetadata: (() { final guardedValue = map['dynamicGroupMetadata']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DynamicGroupMetadata.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      groupKey: pulumi.Input.fromValue(EntityKey.fromMap((map['groupKey']! as Map).cast<String, dynamic>())),
