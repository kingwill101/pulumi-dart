...
class MembershipRoleResponseCloudidentityV1beta1 {
  ...
  factory MembershipRoleResponseCloudidentityV1beta1.fromMap(Map<String, dynamic> map) {
    return MembershipRoleResponseCloudidentityV1beta1(
      expiryDetail: (ExpiryDetailResponseCloudidentityV1beta1.fromMap((map['expiryDetail'] as Map).cast<String, dynamic>())).input(),
      name: (map['name'] as String).input(),
      restrictionEvaluations: (RestrictionEvaluationsResponseCloudidentityV1beta1.fromMap((map['restrictionEvaluations'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
