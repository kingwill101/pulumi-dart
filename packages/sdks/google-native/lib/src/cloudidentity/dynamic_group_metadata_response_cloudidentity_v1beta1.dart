...
class DynamicGroupMetadataResponseCloudidentityV1beta1 {
  ...
  DynamicGroupMetadataResponseCloudidentityV1beta1({
  ...
  factory DynamicGroupMetadataResponseCloudidentityV1beta1.fromMap(Map<String, dynamic> map) {
    return DynamicGroupMetadataResponseCloudidentityV1beta1(
      queries: (pulumi.Input.decodeList<DynamicGroupQueryResponseCloudidentityV1beta1>(map['queries'], (value) => DynamicGroupQueryResponseCloudidentityV1beta1.fromMap((value as Map).cast<String, dynamic>()))).input(),
      status: (DynamicGroupStatusResponseCloudidentityV1beta1.fromMap((map['status'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
