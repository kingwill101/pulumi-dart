...
class DynamicGroupMetadataResponseCloudidentityV1beta1 {
  ...
  final pulumi.Input<List<DynamicGroupQueryResponseCloudidentityV1beta1>>
  queries;
    ...
    return <String, dynamic>{
      'queries':
          pulumi.Input.mapInputValue<
            List<DynamicGroupQueryResponseCloudidentityV1beta1>,
  ...
  factory DynamicGroupMetadataResponseCloudidentityV1beta1.fromMap(
    ...
    return DynamicGroupMetadataResponseCloudidentityV1beta1(
      queries: pulumi.Input.fromValue(
        pulumi.Input.decodeList<DynamicGroupQueryResponseCloudidentityV1beta1>(
          map['queries']!,
      ...
      status: pulumi.Input.fromValue(
        DynamicGroupStatusResponseCloudidentityV1beta1.fromMap(
