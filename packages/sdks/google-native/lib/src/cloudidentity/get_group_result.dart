...
class GetGroupResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'additionalGroupKeys': pulumi.Input.encodeList<EntityKeyResponse, Map<String, dynamic>>(additionalGroupKeys, (value) => value.toMap()),
  ...
  factory GetGroupResult.fromMap(Map<String, dynamic> map) {
    return GetGroupResult(
      additionalGroupKeys: pulumi.Input.decodeList<EntityKeyResponse>(map['additionalGroupKeys']!, (value) => EntityKeyResponse.fromMap((value as Map).cast<String, dynamic>())),
      createTime: map['createTime'] as String,
      description: map['description'] as String,
      displayName: map['displayName'] as String,
      dynamicGroupMetadata: DynamicGroupMetadataResponse.fromMap((map['dynamicGroupMetadata']! as Map).cast<String, dynamic>()),
      groupKey: EntityKeyResponse.fromMap((map['groupKey']! as Map).cast<String, dynamic>()),
