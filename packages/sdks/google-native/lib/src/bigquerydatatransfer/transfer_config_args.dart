...
class TransferConfigArgs {
  ...
  TransferConfigArgs({
    pulumi.Output<String>? authorizationCode,
    ...
    pulumi.Output<EmailPreferences>? emailPreferences,
    pulumi.Output<EncryptionConfiguration>? encryptionConfiguration,
    ...
    pulumi.Output<ScheduleOptions>? scheduleOptions,
    pulumi.Output<String>? serviceAccountName,
    pulumi.Output<String>? userId,
    pulumi.Output<String>? versionInfo,
  }) :
  ...
  factory TransferConfigArgs.fromMap(Map<String, dynamic> map) {
    return TransferConfigArgs(
      authorizationCode: map['authorizationCode'] == null ? null : pulumi.Output.create<String>(map['authorizationCode'] as String),
      ...
      emailPreferences: map['emailPreferences'] == null ? null : pulumi.Output.create<EmailPreferences>(EmailPreferences.fromMap((map['emailPreferences'] as Map).cast<String, dynamic>())),
      encryptionConfiguration: map['encryptionConfiguration'] == null ? null : pulumi.Output.create<EncryptionConfiguration>(EncryptionConfiguration.fromMap((map['encryptionConfiguration'] as Map).cast<String, dynamic>())),
      ...
      scheduleOptions: map['scheduleOptions'] == null ? null : pulumi.Output.create<ScheduleOptions>(ScheduleOptions.fromMap((map['scheduleOptions'] as Map).cast<String, dynamic>())),
      ...
      versionInfo: map['versionInfo'] == null ? null : pulumi.Output.create<String>(map['versionInfo'] as String),
    );
  }
}
