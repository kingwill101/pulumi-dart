...
class TransferConfigArgs {
  ...
  factory TransferConfigArgs.fromMap(Map<String, dynamic> map) {
    return TransferConfigArgs(
      ...
      emailPreferences: (() { final guardedValue = map['emailPreferences']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EmailPreferences.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      scheduleOptions: (() { final guardedValue = map['scheduleOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ScheduleOptions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      versionInfo: (() { final guardedValue = map['versionInfo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
