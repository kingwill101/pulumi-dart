...
class QueuedResourceArgs {
  ...
  factory QueuedResourceArgs.fromMap(Map<String, dynamic> map) {
    return QueuedResourceArgs(
      bestEffort: (() {
        final guardedValue = map['bestEffort'];
      ...
      guaranteed: (() {
        final guardedValue = map['guaranteed'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          Guaranteed.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      location: (() {
      ...
      queuedResourceId: (() {
        final guardedValue = map['queuedResourceId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      queueingPolicy: (() {
        final guardedValue = map['queueingPolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          QueueingPolicy.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      requestId: (() {
      ...
      tpu: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          Tpu.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
