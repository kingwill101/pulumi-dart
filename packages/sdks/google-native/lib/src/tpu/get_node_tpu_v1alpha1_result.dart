...
class GetNodeTpuV1alpha1Result {
  ...
  /// Creates a new [GetNodeTpuV1alpha1Result].
  ...
  const GetNodeTpuV1alpha1Result({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': name,
      'network': network,
      'networkEndpoints': pulumi.Input.encodeList<NetworkEndpointResponseTpuV1alpha1, Map<String, dynamic>>(networkEndpoints, (value) => value.toMap()),
      'port': port,
      'schedulingConfig': schedulingConfig.toMap(),
      'serviceAccount': serviceAccount,
      'state': state,
      'symptoms': pulumi.Input.encodeList<SymptomResponseTpuV1alpha1, Map<String, dynamic>>(symptoms, (value) => value.toMap()),
  ...
  factory GetNodeTpuV1alpha1Result.fromMap(Map<String, dynamic> map) {
    return GetNodeTpuV1alpha1Result(
      ...
      networkEndpoints: pulumi.Input.decodeList<NetworkEndpointResponseTpuV1alpha1>(map['networkEndpoints']!, (value) => NetworkEndpointResponseTpuV1alpha1.fromMap((value as Map).cast<String, dynamic>())),
      port: map['port'] as String,
      schedulingConfig: SchedulingConfigResponseTpuV1alpha1.fromMap((map['schedulingConfig']! as Map).cast<String, dynamic>()),
      serviceAccount: map['serviceAccount'] as String,
      state: map['state'] as String,
      symptoms: pulumi.Input.decodeList<SymptomResponseTpuV1alpha1>(map['symptoms']!, (value) => SymptomResponseTpuV1alpha1.fromMap((value as Map).cast<String, dynamic>())),
