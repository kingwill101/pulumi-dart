...
class NodeTpuV2alpha1Args {
  ...
  NodeTpuV2alpha1Args({
    pulumi.Output<AcceleratorConfigTpuV2alpha1>? acceleratorConfig,
    pulumi.Output<String>? acceleratorType,
    pulumi.Output<bool>? autocheckpointEnabled,
    pulumi.Output<BootDiskConfig>? bootDiskConfig,
    pulumi.Output<String>? cidrBlock,
    pulumi.Output<List<AttachedDiskTpuV2alpha1>>? dataDisks,
    pulumi.Output<String>? description,
    pulumi.Output<NodeHealthTpuV2alpha1>? health,
    pulumi.Output<Map<String, String>>? labels,
    pulumi.Output<String>? location,
    pulumi.Output<Map<String, String>>? metadata,
    pulumi.Output<NetworkConfigTpuV2alpha1>? networkConfig,
    pulumi.Output<String>? nodeId,
    pulumi.Output<String>? project,
    pulumi.Output<String>? requestId,
    required pulumi.Output<String> runtimeVersion,
    pulumi.Output<SchedulingConfigTpuV2alpha1>? schedulingConfig,
    pulumi.Output<ServiceAccountTpuV2alpha1>? serviceAccount,
    pulumi.Output<ShieldedInstanceConfigTpuV2alpha1>? shieldedInstanceConfig,
    pulumi.Output<List<String>>? tags,
  }) :
      acceleratorConfig = pulumi.Input.asOptionalInput<AcceleratorConfigTpuV2alpha1>(acceleratorConfig),
      acceleratorType = pulumi.Input.asOptionalInput<String>(acceleratorType),
      autocheckpointEnabled = pulumi.Input.asOptionalInput<bool>(autocheckpointEnabled),
      bootDiskConfig = pulumi.Input.asOptionalInput<BootDiskConfig>(bootDiskConfig),
      cidrBlock = pulumi.Input.asOptionalInput<String>(cidrBlock),
      dataDisks = pulumi.Input.asOptionalInput<List<AttachedDiskTpuV2alpha1>>(dataDisks),
      description = pulumi.Input.asOptionalInput<String>(description),
      health = pulumi.Input.asOptionalInput<NodeHealthTpuV2alpha1>(health),
      labels = pulumi.Input.asOptionalInput<Map<String, String>>(labels),
      location = pulumi.Input.asOptionalInput<String>(location),
      metadata = pulumi.Input.asOptionalInput<Map<String, String>>(metadata),
      networkConfig = pulumi.Input.asOptionalInput<NetworkConfigTpuV2alpha1>(networkConfig),
      ...
      schedulingConfig = pulumi.Input.asOptionalInput<SchedulingConfigTpuV2alpha1>(schedulingConfig),
      serviceAccount = pulumi.Input.asOptionalInput<ServiceAccountTpuV2alpha1>(serviceAccount),
      shieldedInstanceConfig = pulumi.Input.asOptionalInput<ShieldedInstanceConfigTpuV2alpha1>(shieldedInstanceConfig),
  ...
  factory NodeTpuV2alpha1Args.fromMap(Map<String, dynamic> map) {
    return NodeTpuV2alpha1Args(
      acceleratorConfig: map['acceleratorConfig'] == null ? null : pulumi.Output.create<AcceleratorConfigTpuV2alpha1>(AcceleratorConfigTpuV2alpha1.fromMap((map['acceleratorConfig'] as Map).cast<String, dynamic>())),
      acceleratorType: map['acceleratorType'] == null ? null : pulumi.Output.create<String>(map['acceleratorType'] as String),
      autocheckpointEnabled: map['autocheckpointEnabled'] == null ? null : pulumi.Output.create<bool>(map['autocheckpointEnabled'] as bool),
      bootDiskConfig: map['bootDiskConfig'] == null ? null : pulumi.Output.create<BootDiskConfig>(BootDiskConfig.fromMap((map['bootDiskConfig'] as Map).cast<String, dynamic>())),
      cidrBlock: map['cidrBlock'] == null ? null : pulumi.Output.create<String>(map['cidrBlock'] as String),
      dataDisks: map['dataDisks'] == null ? null : pulumi.Output.create<List<AttachedDiskTpuV2alpha1>>(pulumi.Input.decodeList<AttachedDiskTpuV2alpha1>(map['dataDisks'], (value) => AttachedDiskTpuV2alpha1.fromMap((value as Map).cast<String, dynamic>()))),
      description: map['description'] == null ? null : pulumi.Output.create<String>(map['description'] as String),
      health: map['health'] == null ? null : pulumi.Output.create<NodeHealthTpuV2alpha1>(NodeHealthTpuV2alpha1.fromValue(map['health'] as String)),
      labels: map['labels'] == null ? null : pulumi.Output.create<Map<String, String>>((map['labels'] as Map).cast<String, String>()),
      location: map['location'] == null ? null : pulumi.Output.create<String>(map['location'] as String),
      metadata: map['metadata'] == null ? null : pulumi.Output.create<Map<String, String>>((map['metadata'] as Map).cast<String, String>()),
      networkConfig: map['networkConfig'] == null ? null : pulumi.Output.create<NetworkConfigTpuV2alpha1>(NetworkConfigTpuV2alpha1.fromMap((map['networkConfig'] as Map).cast<String, dynamic>())),
      ...
      schedulingConfig: map['schedulingConfig'] == null ? null : pulumi.Output.create<SchedulingConfigTpuV2alpha1>(SchedulingConfigTpuV2alpha1.fromMap((map['schedulingConfig'] as Map).cast<String, dynamic>())),
      serviceAccount: map['serviceAccount'] == null ? null : pulumi.Output.create<ServiceAccountTpuV2alpha1>(ServiceAccountTpuV2alpha1.fromMap((map['serviceAccount'] as Map).cast<String, dynamic>())),
      shieldedInstanceConfig: map['shieldedInstanceConfig'] == null ? null : pulumi.Output.create<ShieldedInstanceConfigTpuV2alpha1>(ShieldedInstanceConfigTpuV2alpha1.fromMap((map['shieldedInstanceConfig'] as Map).cast<String, dynamic>())),
