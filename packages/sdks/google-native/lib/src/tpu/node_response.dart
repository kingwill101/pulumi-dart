...
class NodeResponse {
  ...
  factory NodeResponse.fromMap(Map<String, dynamic> map) {
    return NodeResponse(
      acceleratorConfig: pulumi.Input.fromValue(AcceleratorConfigResponseTpuV2alpha1.fromMap((map['acceleratorConfig']! as Map).cast<String, dynamic>())),
      ...
      autocheckpointEnabled: pulumi.Input.fromValue(map['autocheckpointEnabled'] as bool),
      bootDiskConfig: pulumi.Input.fromValue(BootDiskConfigResponse.fromMap((map['bootDiskConfig']! as Map).cast<String, dynamic>())),
      cidrBlock: pulumi.Input.fromValue(map['cidrBlock'] as String),
      createTime: pulumi.Input.fromValue(map['createTime'] as String),
      dataDisks: pulumi.Input.fromValue(pulumi.Input.decodeList<AttachedDiskResponseTpuV2alpha1>(map['dataDisks']!, (value) => AttachedDiskResponseTpuV2alpha1.fromMap((value as Map).cast<String, dynamic>()))),
      description: pulumi.Input.fromValue(map['description'] as String),
      health: pulumi.Input.fromValue(map['health'] as String),
      healthDescription: pulumi.Input.fromValue(map['healthDescription'] as String),
      ...
      networkConfig: pulumi.Input.fromValue(NetworkConfigResponseTpuV2alpha1.fromMap((map['networkConfig']! as Map).cast<String, dynamic>())),
      networkEndpoints: pulumi.Input.fromValue(pulumi.Input.decodeList<NetworkEndpointResponseTpuV2alpha1>(map['networkEndpoints']!, (value) => NetworkEndpointResponseTpuV2alpha1.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      schedulingConfig: pulumi.Input.fromValue(SchedulingConfigResponseTpuV2alpha1.fromMap((map['schedulingConfig']! as Map).cast<String, dynamic>())),
      serviceAccount: pulumi.Input.fromValue(ServiceAccountResponseTpuV2alpha1.fromMap((map['serviceAccount']! as Map).cast<String, dynamic>())),
      shieldedInstanceConfig: pulumi.Input.fromValue(ShieldedInstanceConfigResponseTpuV2alpha1.fromMap((map['shieldedInstanceConfig']! as Map).cast<String, dynamic>())),
      state: pulumi.Input.fromValue(map['state'] as String),
      symptoms: pulumi.Input.fromValue(pulumi.Input.decodeList<SymptomResponseTpuV2alpha1>(map['symptoms']!, (value) => SymptomResponseTpuV2alpha1.fromMap((value as Map).cast<String, dynamic>()))),
