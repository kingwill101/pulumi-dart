...
class AcceleratorConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'topology': topology,
      'type': pulumi.Input.mapInputValue<AcceleratorConfigType, String>(type, (value) => value.wireValue),
    };
  }
  ...
  factory AcceleratorConfig.fromMap(Map<String, dynamic> map) {
    return AcceleratorConfig(
      ...
      type: pulumi.Input.fromValue(AcceleratorConfigType.fromValue(map['type']! as String)),
    );
  }
}
