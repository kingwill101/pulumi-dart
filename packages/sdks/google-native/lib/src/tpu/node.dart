...
class Node {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'health': ?pulumi.Input.mapOptionalInputValue<NodeHealthTpuV2alpha1, String>(health, (value) => value.wireValue),
      'labels': ?labels,
      'metadata': ?metadata,
  ...
  factory Node.fromMap(Map<String, dynamic> map) {
    return Node(
      acceleratorConfig: (() { final guardedValue = map['acceleratorConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AcceleratorConfigTpuV2alpha1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      autocheckpointEnabled: (() { final guardedValue = map['autocheckpointEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      bootDiskConfig: (() { final guardedValue = map['bootDiskConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BootDiskConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      dataDisks: (() { final guardedValue = map['dataDisks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AttachedDiskTpuV2alpha1>(guardedValue, (value) => AttachedDiskTpuV2alpha1.fromMap((value as Map).cast<String, dynamic>()))); })(),
      description: (() { final guardedValue = map['description']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      health: (() { final guardedValue = map['health']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NodeHealthTpuV2alpha1.fromValue(guardedValue as String)); })(),
      labels: (() { final guardedValue = map['labels']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      metadata: (() { final guardedValue = map['metadata']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      networkConfig: (() { final guardedValue = map['networkConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkConfigTpuV2alpha1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      runtimeVersion: pulumi.Input.fromValue(map['runtimeVersion'] as String),
      schedulingConfig: (() { final guardedValue = map['schedulingConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SchedulingConfigTpuV2alpha1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      serviceAccount: (() { final guardedValue = map['serviceAccount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServiceAccountTpuV2alpha1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      shieldedInstanceConfig: (() { final guardedValue = map['shieldedInstanceConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ShieldedInstanceConfigTpuV2alpha1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
