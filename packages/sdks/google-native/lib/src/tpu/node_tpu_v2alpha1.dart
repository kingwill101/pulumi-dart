...
class NodeTpuV2alpha1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<NetworkEndpointResponseTpuV2alpha1>> networkEndpoints;
  ...
  NodeTpuV2alpha1(
    ...
    this.acceleratorConfig = registerOutput<AcceleratorConfigResponseTpuV2alpha1>('acceleratorConfig');
    ...
    this.bootDiskConfig = registerOutput<BootDiskConfigResponse>('bootDiskConfig');
    this.cidrBlock = registerOutput<String>('cidrBlock');
    this.createTime = registerOutput<String>('createTime');
    this.dataDisks = registerOutput<List<AttachedDiskResponseTpuV2alpha1>>('dataDisks');
    ...
    this.networkConfig = registerOutput<NetworkConfigResponseTpuV2alpha1>('networkConfig');
    this.networkEndpoints = registerOutput<List<NetworkEndpointResponseTpuV2alpha1>>('networkEndpoints');
    ...
    this.schedulingConfig = registerOutput<SchedulingConfigResponseTpuV2alpha1>('schedulingConfig');
    this.serviceAccount = registerOutput<ServiceAccountResponseTpuV2alpha1>('serviceAccount');
    this.shieldedInstanceConfig = registerOutput<ShieldedInstanceConfigResponseTpuV2alpha1>('shieldedInstanceConfig');
    this.state = registerOutput<String>('state');
    this.symptoms = registerOutput<List<SymptomResponseTpuV2alpha1>>('symptoms');
