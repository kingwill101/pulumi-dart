...
class NodeTpuV2Args {
  ...
  NodeTpuV2Args({
    ...
    pulumi.Output<List<AttachedDisk>>? dataDisks,
    pulumi.Output<String>? description,
    pulumi.Output<NodeHealthTpuV2>? health,
    ...
    pulumi.Output<SchedulingConfigTpuV2>? schedulingConfig,
    pulumi.Output<ServiceAccount>? serviceAccount,
  ...
  factory NodeTpuV2Args.fromMap(Map<String, dynamic> map) {
    return NodeTpuV2Args(
      ...
      dataDisks: map['dataDisks'] == null ? null : pulumi.Output.create<List<AttachedDisk>>(pulumi.Input.decodeList<AttachedDisk>(map['dataDisks'], (value) => AttachedDisk.fromMap((value as Map).cast<String, dynamic>()))),
      description: map['description'] == null ? null : pulumi.Output.create<String>(map['description'] as String),
      health: map['health'] == null ? null : pulumi.Output.create<NodeHealthTpuV2>(NodeHealthTpuV2.fromValue(map['health'] as String)),
      ...
      schedulingConfig: map['schedulingConfig'] == null ? null : pulumi.Output.create<SchedulingConfigTpuV2>(SchedulingConfigTpuV2.fromMap((map['schedulingConfig'] as Map).cast<String, dynamic>())),
      serviceAccount: map['serviceAccount'] == null ? null : pulumi.Output.create<ServiceAccount>(ServiceAccount.fromMap((map['serviceAccount'] as Map).cast<String, dynamic>())),
