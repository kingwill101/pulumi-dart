...
class NodeTpuV2Args {
  ...
  factory NodeTpuV2Args.fromMap(Map<String, dynamic> map) {
    return NodeTpuV2Args(
      ...
      dataDisks: map['dataDisks'] == null ? null : (pulumi.Input.decodeList<AttachedDisk>(map['dataDisks']!, (value) => AttachedDisk.fromMap((value as Map).cast<String, dynamic>()))).input(),
      description: map['description'] == null ? null : (map['description']! as String).input(),
      health: map['health'] == null ? null : (NodeHealthTpuV2.fromValue(map['health']! as String)).input(),
      ...
      schedulingConfig: map['schedulingConfig'] == null ? null : (SchedulingConfigTpuV2.fromMap((map['schedulingConfig']! as Map).cast<String, dynamic>())).input(),
