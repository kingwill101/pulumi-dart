...
class SpokeNetworkconnectivityV1alpha1Args {
  ...
  const SpokeNetworkconnectivityV1alpha1Args({
    this.createTime,
    this.description,
    this.hub,
    this.labels,
  ...
  factory SpokeNetworkconnectivityV1alpha1Args.fromMap(Map<String, dynamic> map) {
    return SpokeNetworkconnectivityV1alpha1Args(
      ...
      linkedInterconnectAttachments: (() { final guardedValue = map['linkedInterconnectAttachments']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      linkedRouterApplianceInstances: (() { final guardedValue = map['linkedRouterApplianceInstances']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RouterApplianceInstanceNetworkconnectivityV1alpha1>(guardedValue, (value) => RouterApplianceInstanceNetworkconnectivityV1alpha1.fromMap((value as Map).cast<String, dynamic>()))); })(),
      linkedVpnTunnels: (() { final guardedValue = map['linkedVpnTunnels']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      location: (() { final guardedValue = map['location']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      project: (() { final guardedValue = map['project']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      requestId: (() { final guardedValue = map['requestId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      spokeId: (() { final guardedValue = map['spokeId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
