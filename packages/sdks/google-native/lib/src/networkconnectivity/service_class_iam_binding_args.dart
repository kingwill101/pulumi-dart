...
/// {@template pulumi_networkconnectivity_v1_service_class_iam_binding_args_doc}
/// The set of arguments for ServiceClassIamBinding.
/// {@endtemplate}
/// {@macro pulumi_networkconnectivity_v1_service_class_iam_binding_args_doc}
class ServiceClassIamBindingArgs {
  ...
  /// Creates a new [ServiceClassIamBindingArgs].
  ...
  const ServiceClassIamBindingArgs({
    this.condition,
  ...
  factory ServiceClassIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return ServiceClassIamBindingArgs(
