...
class InternalRangeArgs {
  ...
  factory InternalRangeArgs.fromMap(Map<String, dynamic> map) {
    return InternalRangeArgs(
      ...
      overlaps: map['overlaps'] == null ? null : (pulumi.Input.decodeList<InternalRangeOverlapsItem>(map['overlaps'], (value) => InternalRangeOverlapsItem.fromValue(value as String))).input(),
      peering: map['peering'] == null ? null : (InternalRangePeering.fromValue(map['peering'] as String)).input(),
      ...
      usage: map['usage'] == null ? null : (InternalRangeUsage.fromValue(map['usage'] as String)).input(),
    );
  }
}
