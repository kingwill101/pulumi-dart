...
class InternalRangeArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'network': ?network,
      'overlaps': ?pulumi.Input.mapOptionalInputValue<List<InternalRangeOverlapsItem>, List<String>>(overlaps, (value) => pulumi.Input.encodeList<InternalRangeOverlapsItem, String>(value, (value) => value.wireValue)),
      'peering': ?pulumi.Input.mapOptionalInputValue<InternalRangePeering, String>(peering, (value) => value.wireValue),
      'prefixLength': ?prefixLength,
      'project': ?project,
      'requestId': ?requestId,
      'targetCidrRange': ?targetCidrRange,
      'updateTime': ?updateTime,
      'usage': ?pulumi.Input.mapOptionalInputValue<InternalRangeUsage, String>(usage, (value) => value.wireValue),
    };
  }
  ...
  factory InternalRangeArgs.fromMap(Map<String, dynamic> map) {
    return InternalRangeArgs(
      ...
      internalRangeId: (() { final guardedValue = map['internalRangeId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      overlaps: (() { final guardedValue = map['overlaps']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InternalRangeOverlapsItem>(guardedValue, (value) => InternalRangeOverlapsItem.fromValue(value as String))); })(),
      peering: (() { final guardedValue = map['peering']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InternalRangePeering.fromValue(guardedValue as String)); })(),
      ...
      targetCidrRange: (() { final guardedValue = map['targetCidrRange']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      updateTime: (() { final guardedValue = map['updateTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      usage: (() { final guardedValue = map['usage']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InternalRangeUsage.fromValue(guardedValue as String)); })(),
    );
  }
}
