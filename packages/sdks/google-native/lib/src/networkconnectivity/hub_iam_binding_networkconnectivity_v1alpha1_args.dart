...
/// {@template pulumi_networkconnectivity_v1alpha1_hub_iam_binding_networkconnectivity_v1alpha1_args_doc}
/// The set of arguments for HubIamBinding.
/// {@endtemplate}
/// {@macro pulumi_networkconnectivity_v1alpha1_hub_iam_binding_networkconnectivity_v1alpha1_args_doc}
class HubIamBindingNetworkconnectivityV1alpha1Args {
  ...
  /// Creates a new [HubIamBindingNetworkconnectivityV1alpha1Args].
  ...
  const HubIamBindingNetworkconnectivityV1alpha1Args({
    this.condition,
  ...
  factory HubIamBindingNetworkconnectivityV1alpha1Args.fromMap(Map<String, dynamic> map) {
    return HubIamBindingNetworkconnectivityV1alpha1Args(
