...
/// {@template pulumi_networkconnectivity_v1_policy_based_route_iam_binding_args_doc}
/// The set of arguments for PolicyBasedRouteIamBinding.
/// {@endtemplate}
/// {@macro pulumi_networkconnectivity_v1_policy_based_route_iam_binding_args_doc}
class PolicyBasedRouteIamBindingArgs {
  ...
  /// Creates a new [PolicyBasedRouteIamBindingArgs].
  ...
  const PolicyBasedRouteIamBindingArgs({
    this.condition,
  ...
  factory PolicyBasedRouteIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return PolicyBasedRouteIamBindingArgs(
