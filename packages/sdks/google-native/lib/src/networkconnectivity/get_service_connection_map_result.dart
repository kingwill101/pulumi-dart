...
class GetServiceConnectionMapResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'consumerPscConfigs': pulumi.Input.encodeList<ConsumerPscConfigResponse, Map<String, dynamic>>(consumerPscConfigs, (value) => value.toMap()),
      'consumerPscConnections': pulumi.Input.encodeList<ConsumerPscConnectionResponse, Map<String, dynamic>>(consumerPscConnections, (value) => value.toMap()),
      ...
      'labels': labels,
      'name': name,
      'producerPscConfigs': pulumi.Input.encodeList<ProducerPscConfigResponse, Map<String, dynamic>>(producerPscConfigs, (value) => value.toMap()),
  ...
  factory GetServiceConnectionMapResult.fromMap(Map<String, dynamic> map) {
    return GetServiceConnectionMapResult(
      consumerPscConfigs: pulumi.Input.decodeList<ConsumerPscConfigResponse>(map['consumerPscConfigs']!, (value) => ConsumerPscConfigResponse.fromMap((value as Map).cast<String, dynamic>())),
      consumerPscConnections: pulumi.Input.decodeList<ConsumerPscConnectionResponse>(map['consumerPscConnections']!, (value) => ConsumerPscConnectionResponse.fromMap((value as Map).cast<String, dynamic>())),
      ...
      producerPscConfigs: pulumi.Input.decodeList<ProducerPscConfigResponse>(map['producerPscConfigs']!, (value) => ProducerPscConfigResponse.fromMap((value as Map).cast<String, dynamic>())),
