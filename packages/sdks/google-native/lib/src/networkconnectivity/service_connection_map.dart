...
class ServiceConnectionMap extends pulumi.CustomResource {
  ...
  ServiceConnectionMap(
    ...
    consumerPscConfigs = registerOutput<List<Map<String, dynamic>>>(
      'consumerPscConfigs',
    );
    consumerPscConnections = registerOutput<List<Map<String, dynamic>>>(
    ...
    producerPscConfigs = registerOutput<List<Map<String, dynamic>>>(
      'producerPscConfigs',
    );
