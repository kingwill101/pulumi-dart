...
import 'service_class_iam_member_args.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class ServiceClassIamMember extends pulumi.CustomResource {
  ...
  /// Creates a new [ServiceClassIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ServiceClassIamMember]. {@macro pulumi_networkconnectivity_v1_service_class_iam_member_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  ServiceClassIamMember(
    String name, {
    ServiceClassIamMemberArgs? args,
