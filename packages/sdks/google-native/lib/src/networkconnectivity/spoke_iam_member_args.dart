...
/// {@template pulumi_networkconnectivity_v1_spoke_iam_member_args_doc}
/// The set of arguments for SpokeIamMember.
/// {@endtemplate}
/// {@macro pulumi_networkconnectivity_v1_spoke_iam_member_args_doc}
class SpokeIamMemberArgs {
  ...
  /// Creates a new [SpokeIamMemberArgs].
  ...
  factory SpokeIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return SpokeIamMemberArgs(
