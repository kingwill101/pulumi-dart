...
class SpokeSummaryResponse {
  ...
  final pulumi.Input<List<SpokeStateReasonCountResponse>>
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'spokeStateReasonCounts':
          pulumi.Input.mapInputValue<
            List<SpokeStateReasonCountResponse>,
            List<Map<String, dynamic>>
          >(
            spokeStateReasonCounts,
            (value) =>
  ...
  factory SpokeSummaryResponse.fromMap(Map<String, dynamic> map) {
    return SpokeSummaryResponse(
      spokeStateCounts: pulumi.Input.fromValue(
        pulumi.Input.decodeList<SpokeStateCountResponse>(
      ...
      spokeStateReasonCounts: pulumi.Input.fromValue(
      ...
      spokeTypeCounts: pulumi.Input.fromValue(
        pulumi.Input.decodeList<SpokeTypeCountResponse>(
          map['spokeTypeCounts']!,
