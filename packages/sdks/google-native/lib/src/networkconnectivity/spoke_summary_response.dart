...
class SpokeSummaryResponse {
  ...
  factory SpokeSummaryResponse.fromMap(Map<String, dynamic> map) {
    return SpokeSummaryResponse(
      spokeStateCounts: (pulumi.Input.decodeList<SpokeStateCountResponse>(map['spokeStateCounts'], (value) => SpokeStateCountResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      spokeStateReasonCounts: (pulumi.Input.decodeList<SpokeStateReasonCountResponse>(map['spokeStateReasonCounts'], (value) => SpokeStateReasonCountResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      spokeTypeCounts: (pulumi.Input.decodeList<SpokeTypeCountResponse>(map['spokeTypeCounts'], (value) => SpokeTypeCountResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
