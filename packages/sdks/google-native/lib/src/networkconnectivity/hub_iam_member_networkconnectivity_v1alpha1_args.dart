...
/// {@template pulumi_networkconnectivity_v1alpha1_hub_iam_member_networkconnectivity_v1alpha1_args_doc}
/// The set of arguments for HubIamMember.
/// {@endtemplate}
/// {@macro pulumi_networkconnectivity_v1alpha1_hub_iam_member_networkconnectivity_v1alpha1_args_doc}
class HubIamMemberNetworkconnectivityV1alpha1Args {
  ...
  /// Creates a new [HubIamMemberNetworkconnectivityV1alpha1Args].
  ...
  const HubIamMemberNetworkconnectivityV1alpha1Args({
    this.condition,
  ...
  factory HubIamMemberNetworkconnectivityV1alpha1Args.fromMap(Map<String, dynamic> map) {
    return HubIamMemberNetworkconnectivityV1alpha1Args(
