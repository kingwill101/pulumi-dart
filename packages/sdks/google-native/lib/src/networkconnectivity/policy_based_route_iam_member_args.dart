...
/// {@template pulumi_networkconnectivity_v1_policy_based_route_iam_member_args_doc}
/// The set of arguments for PolicyBasedRouteIamMember.
/// {@endtemplate}
/// {@macro pulumi_networkconnectivity_v1_policy_based_route_iam_member_args_doc}
class PolicyBasedRouteIamMemberArgs {
  ...
  /// Creates a new [PolicyBasedRouteIamMemberArgs].
  ...
  const PolicyBasedRouteIamMemberArgs({
    this.condition,
  ...
  factory PolicyBasedRouteIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return PolicyBasedRouteIamMemberArgs(
