...
class Filter {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'protocolVersion': pulumi.Input.mapInputValue<FilterProtocolVersion, String>(protocolVersion, (value) => value.wireValue),
      'srcRange': ?srcRange,
    };
  }
  ...
  factory Filter.fromMap(Map<String, dynamic> map) {
    return Filter(
      ...
      protocolVersion: pulumi.Input.fromValue(FilterProtocolVersion.fromValue(map['protocolVersion']! as String)),
