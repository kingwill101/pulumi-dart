...
/// {@template pulumi_networkconnectivity_v1_service_connection_map_iam_binding_args_doc}
/// The set of arguments for ServiceConnectionMapIamBinding.
/// {@endtemplate}
/// {@macro pulumi_networkconnectivity_v1_service_connection_map_iam_binding_args_doc}
class ServiceConnectionMapIamBindingArgs {
  ...
  /// Creates a new [ServiceConnectionMapIamBindingArgs].
  ...
  const ServiceConnectionMapIamBindingArgs({
    this.condition,
