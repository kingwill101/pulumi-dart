...
class ExprNetworkconnectivityV1alpha1 {
  ...
  /// Creates a new [ExprNetworkconnectivityV1alpha1].
  ...
  const ExprNetworkconnectivityV1alpha1({
    this.description,
    this.expression,
    this.location,
    this.title,
  ...
  factory ExprNetworkconnectivityV1alpha1.fromMap(Map<String, dynamic> map) {
    return ExprNetworkconnectivityV1alpha1(
