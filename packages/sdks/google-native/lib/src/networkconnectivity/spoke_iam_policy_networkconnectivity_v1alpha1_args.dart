...
/// {@template pulumi_networkconnectivity_v1alpha1_spoke_iam_policy_networkconnectivity_v1alpha1_args_doc}
/// The set of arguments for SpokeIamPolicy.
/// {@endtemplate}
/// {@macro pulumi_networkconnectivity_v1alpha1_spoke_iam_policy_networkconnectivity_v1alpha1_args_doc}
class SpokeIamPolicyNetworkconnectivityV1alpha1Args {
  ...
  /// Creates a new [SpokeIamPolicyNetworkconnectivityV1alpha1Args].
  ...
  /// [version] Specifies the format of the policy. Valid values are `0`, `1`, and `3`. Requests that specify an invalid value are rejected. Any operation that affects conditional role bindings must specify version `3`. This requirement applies to the following operations: * Getting a policy that includes a conditional role binding * Adding a conditional role binding to a policy * Changing a conditional role binding in a policy * Removing any role binding, with or without a condition, from a policy that includes conditions **Important:** If you use IAM Conditions, you must include the `etag` field whenever you call `setIamPolicy`. If you omit this field, then IAM allows you to overwrite a version `3` policy with a version `1` policy, and all of the conditions in the version `3` policy are lost. If a policy does not include any conditions, operations on that policy may specify any valid version or leave the field unset. To learn which resources support conditions in their IAM policies, see the [IAM documentation](https://cloud.google.com/iam/help/conditions/resource-policies).
  SpokeIamPolicyNetworkconnectivityV1alpha1Args({
    pulumi.Output<List<AuditConfigNetworkconnectivityV1alpha1>>? auditConfigs,
    pulumi.Output<List<BindingNetworkconnectivityV1alpha1>>? bindings,
    ...
    pulumi.Output<int>? version,
      ...
      auditConfigs = pulumi.Input.asOptionalInput<List<AuditConfigNetworkconnectivityV1alpha1>>(auditConfigs),
      bindings = pulumi.Input.asOptionalInput<List<BindingNetworkconnectivityV1alpha1>>(bindings),
  ...
  factory SpokeIamPolicyNetworkconnectivityV1alpha1Args.fromMap(Map<String, dynamic> map) {
    return SpokeIamPolicyNetworkconnectivityV1alpha1Args(
      auditConfigs: map['auditConfigs'] == null ? null : pulumi.Output.create<List<AuditConfigNetworkconnectivityV1alpha1>>(pulumi.Input.decodeList<AuditConfigNetworkconnectivityV1alpha1>(map['auditConfigs'], (value) => AuditConfigNetworkconnectivityV1alpha1.fromMap((value as Map).cast<String, dynamic>()))),
      bindings: map['bindings'] == null ? null : pulumi.Output.create<List<BindingNetworkconnectivityV1alpha1>>(pulumi.Input.decodeList<BindingNetworkconnectivityV1alpha1>(map['bindings'], (value) => BindingNetworkconnectivityV1alpha1.fromMap((value as Map).cast<String, dynamic>()))),
