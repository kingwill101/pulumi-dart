...
/// {@template pulumi_networkconnectivity_v1_hub_group_iam_binding_args_doc}
/// The set of arguments for HubGroupIamBinding.
/// {@endtemplate}
/// {@macro pulumi_networkconnectivity_v1_hub_group_iam_binding_args_doc}
class HubGroupIamBindingArgs {
  ...
  /// Creates a new [HubGroupIamBindingArgs].
  ...
  factory HubGroupIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return HubGroupIamBindingArgs(
