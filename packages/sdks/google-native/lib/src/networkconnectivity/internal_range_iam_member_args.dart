...
/// {@template pulumi_networkconnectivity_v1alpha1_internal_range_iam_member_args_doc}
/// The set of arguments for InternalRangeIamMember.
/// {@endtemplate}
/// {@macro pulumi_networkconnectivity_v1alpha1_internal_range_iam_member_args_doc}
class InternalRangeIamMemberArgs {
  ...
  /// Creates a new [InternalRangeIamMemberArgs].
  ...
  const InternalRangeIamMemberArgs({
    this.condition,
  ...
  factory InternalRangeIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return InternalRangeIamMemberArgs(
