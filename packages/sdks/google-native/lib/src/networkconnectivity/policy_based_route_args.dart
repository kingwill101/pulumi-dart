...
class PolicyBasedRouteArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'nextHopOtherRoutes': ?pulumi.Input.mapOptionalInputValue<PolicyBasedRouteNextHopOtherRoutes, String>(nextHopOtherRoutes, (value) => value.wireValue),
  ...
  factory PolicyBasedRouteArgs.fromMap(Map<String, dynamic> map) {
    return PolicyBasedRouteArgs(
      ...
      filter: pulumi.Input.fromValue(Filter.fromMap((map['filter']! as Map).cast<String, dynamic>())),
      interconnectAttachment: (() { final guardedValue = map['interconnectAttachment']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InterconnectAttachment.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      nextHopOtherRoutes: (() { final guardedValue = map['nextHopOtherRoutes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PolicyBasedRouteNextHopOtherRoutes.fromValue(guardedValue as String)); })(),
