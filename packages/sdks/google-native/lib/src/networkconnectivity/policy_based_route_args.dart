...
class PolicyBasedRouteArgs {
    ...
    return <String, dynamic>{
      ...
      'nextHopOtherRoutes':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(nextHopOtherRoutes, (value) => value.wireValue),
  ...
  factory PolicyBasedRouteArgs.fromMap(Map<String, dynamic> map) {
    return PolicyBasedRouteArgs(
      ...
      nextHopIlbIp: (() {
        final guardedValue = map['nextHopIlbIp'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      nextHopOtherRoutes: (() {
        final guardedValue = map['nextHopOtherRoutes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PolicyBasedRouteNextHopOtherRoutes.fromValue(guardedValue as String),
        );
      })(),
      ...
      virtualMachine: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VirtualMachine.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
