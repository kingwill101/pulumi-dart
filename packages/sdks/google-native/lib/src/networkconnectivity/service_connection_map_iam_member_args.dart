...
/// {@template pulumi_networkconnectivity_v1_service_connection_map_iam_member_args_doc}
/// The set of arguments for ServiceConnectionMapIamMember.
/// {@endtemplate}
/// {@macro pulumi_networkconnectivity_v1_service_connection_map_iam_member_args_doc}
class ServiceConnectionMapIamMemberArgs {
  ...
  /// Creates a new [ServiceConnectionMapIamMemberArgs].
  ...
  const ServiceConnectionMapIamMemberArgs({
    this.condition,
  ...
  factory ServiceConnectionMapIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return ServiceConnectionMapIamMemberArgs(
