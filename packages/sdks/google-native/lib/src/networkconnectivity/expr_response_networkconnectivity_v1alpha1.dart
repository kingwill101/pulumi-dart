...
class ExprResponseNetworkconnectivityV1alpha1 {
  ...
  /// Creates a new [ExprResponseNetworkconnectivityV1alpha1].
  ...
  const ExprResponseNetworkconnectivityV1alpha1({
  ...
  factory ExprResponseNetworkconnectivityV1alpha1.fromMap(Map<String, dynamic> map) {
    return ExprResponseNetworkconnectivityV1alpha1(
