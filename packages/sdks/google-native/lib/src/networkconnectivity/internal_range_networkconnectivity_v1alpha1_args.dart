...
class InternalRangeNetworkconnectivityV1alpha1Args {
  ...
  const InternalRangeNetworkconnectivityV1alpha1Args({
    this.createTime,
    this.description,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'network': ?network,
      'overlaps': ?pulumi.Input.mapOptionalInputValue<List<InternalRangeOverlapsItemNetworkconnectivityV1alpha1>, List<String>>(overlaps, (value) => pulumi.Input.encodeList<InternalRangeOverlapsItemNetworkconnectivityV1alpha1, String>(value, (value) => value.wireValue)),
      'peering': ?pulumi.Input.mapOptionalInputValue<InternalRangePeeringNetworkconnectivityV1alpha1, String>(peering, (value) => value.wireValue),
      'prefixLength': ?prefixLength,
      'project': ?project,
      'requestId': ?requestId,
      'targetCidrRange': ?targetCidrRange,
      'updateTime': ?updateTime,
      'usage': ?pulumi.Input.mapOptionalInputValue<InternalRangeUsageNetworkconnectivityV1alpha1, String>(usage, (value) => value.wireValue),
    };
  }
  ...
  factory InternalRangeNetworkconnectivityV1alpha1Args.fromMap(Map<String, dynamic> map) {
    return InternalRangeNetworkconnectivityV1alpha1Args(
      ...
      overlaps: (() { final guardedValue = map['overlaps']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InternalRangeOverlapsItemNetworkconnectivityV1alpha1>(guardedValue, (value) => InternalRangeOverlapsItemNetworkconnectivityV1alpha1.fromValue(value as String))); })(),
      peering: (() { final guardedValue = map['peering']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InternalRangePeeringNetworkconnectivityV1alpha1.fromValue(guardedValue as String)); })(),
      ...
      usage: (() { final guardedValue = map['usage']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InternalRangeUsageNetworkconnectivityV1alpha1.fromValue(guardedValue as String)); })(),
    );
  }
}
