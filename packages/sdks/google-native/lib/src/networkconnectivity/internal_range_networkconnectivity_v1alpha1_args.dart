...
class InternalRangeNetworkconnectivityV1alpha1Args {
  ...
  InternalRangeNetworkconnectivityV1alpha1Args({
    ...
    pulumi.Output<List<InternalRangeOverlapsItemNetworkconnectivityV1alpha1>>? overlaps,
    pulumi.Output<InternalRangePeeringNetworkconnectivityV1alpha1>? peering,
    pulumi.Output<int>? prefixLength,
    pulumi.Output<String>? project,
    pulumi.Output<String>? requestId,
    pulumi.Output<List<String>>? targetCidrRange,
    pulumi.Output<String>? updateTime,
    pulumi.Output<InternalRangeUsageNetworkconnectivityV1alpha1>? usage,
  }) :
  ...
  factory InternalRangeNetworkconnectivityV1alpha1Args.fromMap(Map<String, dynamic> map) {
    return InternalRangeNetworkconnectivityV1alpha1Args(
      ...
      overlaps: map['overlaps'] == null ? null : pulumi.Output.create<List<InternalRangeOverlapsItemNetworkconnectivityV1alpha1>>(pulumi.Input.decodeList<InternalRangeOverlapsItemNetworkconnectivityV1alpha1>(map['overlaps'], (value) => InternalRangeOverlapsItemNetworkconnectivityV1alpha1.fromValue(value as String))),
      peering: map['peering'] == null ? null : pulumi.Output.create<InternalRangePeeringNetworkconnectivityV1alpha1>(InternalRangePeeringNetworkconnectivityV1alpha1.fromValue(map['peering'] as String)),
      ...
      usage: map['usage'] == null ? null : pulumi.Output.create<InternalRangeUsageNetworkconnectivityV1alpha1>(InternalRangeUsageNetworkconnectivityV1alpha1.fromValue(map['usage'] as String)),
    );
  }
}
