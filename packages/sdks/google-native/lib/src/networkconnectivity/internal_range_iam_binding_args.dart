...
/// {@template pulumi_networkconnectivity_v1alpha1_internal_range_iam_binding_args_doc}
/// The set of arguments for InternalRangeIamBinding.
/// {@endtemplate}
/// {@macro pulumi_networkconnectivity_v1alpha1_internal_range_iam_binding_args_doc}
class InternalRangeIamBindingArgs {
  ...
  /// Creates a new [InternalRangeIamBindingArgs].
  ...
  const InternalRangeIamBindingArgs({
    this.condition,
  ...
  factory InternalRangeIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return InternalRangeIamBindingArgs(
