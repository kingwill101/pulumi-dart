...
/// {@template pulumi_networkconnectivity_v1alpha1_spoke_iam_binding_networkconnectivity_v1alpha1_args_doc}
/// The set of arguments for SpokeIamBinding.
/// {@endtemplate}
/// {@macro pulumi_networkconnectivity_v1alpha1_spoke_iam_binding_networkconnectivity_v1alpha1_args_doc}
class SpokeIamBindingNetworkconnectivityV1alpha1Args {
  ...
  /// Creates a new [SpokeIamBindingNetworkconnectivityV1alpha1Args].
  ...
  const SpokeIamBindingNetworkconnectivityV1alpha1Args({
    this.condition,
  ...
  factory SpokeIamBindingNetworkconnectivityV1alpha1Args.fromMap(Map<String, dynamic> map) {
    return SpokeIamBindingNetworkconnectivityV1alpha1Args(
