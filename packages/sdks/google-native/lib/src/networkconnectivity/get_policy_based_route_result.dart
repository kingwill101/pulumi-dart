...
class GetPolicyBasedRouteResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'warnings': pulumi.Input.encodeList<WarningsResponse, Map<String, dynamic>>(warnings, (value) => value.toMap()),
    };
  }
  ...
  factory GetPolicyBasedRouteResult.fromMap(Map<String, dynamic> map) {
    return GetPolicyBasedRouteResult(
      ...
      interconnectAttachment: InterconnectAttachmentResponse.fromMap((map['interconnectAttachment']! as Map).cast<String, dynamic>()),
      ...
      warnings: pulumi.Input.decodeList<WarningsResponse>(map['warnings']!, (value) => WarningsResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
