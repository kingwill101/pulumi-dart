...
/// {@template pulumi_networkconnectivity_v1_spoke_iam_binding_args_doc}
/// The set of arguments for SpokeIamBinding.
/// {@endtemplate}
/// {@macro pulumi_networkconnectivity_v1_spoke_iam_binding_args_doc}
class SpokeIamBindingArgs {
  ...
  /// Creates a new [SpokeIamBindingArgs].
  ...
  factory SpokeIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return SpokeIamBindingArgs(
