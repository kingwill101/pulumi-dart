...
class ServiceConnectionPolicyArgs {
  ...
  factory ServiceConnectionPolicyArgs.fromMap(Map<String, dynamic> map) {
    return ServiceConnectionPolicyArgs(
      ...
      serviceConnectionPolicyId: (() { final guardedValue = map['serviceConnectionPolicyId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
