...
class ServiceConnectionMapArgs {
  ...
  factory ServiceConnectionMapArgs.fromMap(Map<String, dynamic> map) {
    return ServiceConnectionMapArgs(
      consumerPscConfigs: (() { final guardedValue = map['consumerPscConfigs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ConsumerPscConfig>(guardedValue, (value) => ConsumerPscConfig.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      producerPscConfigs: (() { final guardedValue = map['producerPscConfigs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ProducerPscConfig>(guardedValue, (value) => ProducerPscConfig.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      serviceConnectionMapId: (() { final guardedValue = map['serviceConnectionMapId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
