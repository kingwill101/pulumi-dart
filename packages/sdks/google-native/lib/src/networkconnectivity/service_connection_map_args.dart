...
class ServiceConnectionMapArgs {
  ...
  ServiceConnectionMapArgs({
    pulumi.Output<List<ConsumerPscConfig>>? consumerPscConfigs,
    pulumi.Output<String>? description,
    pulumi.Output<String>? etag,
    pulumi.Output<Map<String, String>>? labels,
    pulumi.Output<String>? location,
    pulumi.Output<String>? name,
    pulumi.Output<List<ProducerPscConfig>>? producerPscConfigs,
    pulumi.Output<String>? project,
    pulumi.Output<String>? requestId,
    pulumi.Output<String>? serviceClass,
    pulumi.Output<String>? serviceConnectionMapId,
    pulumi.Output<String>? token,
  }) :
      consumerPscConfigs = pulumi.Input.asOptionalInput<List<ConsumerPscConfig>>(consumerPscConfigs),
      description = pulumi.Input.asOptionalInput<String>(description),
      etag = pulumi.Input.asOptionalInput<String>(etag),
      labels = pulumi.Input.asOptionalInput<Map<String, String>>(labels),
      location = pulumi.Input.asOptionalInput<String>(location),
      name = pulumi.Input.asOptionalInput<String>(name),
      producerPscConfigs = pulumi.Input.asOptionalInput<List<ProducerPscConfig>>(producerPscConfigs),
      project = pulumi.Input.asOptionalInput<String>(project),
      requestId = pulumi.Input.asOptionalInput<String>(requestId),
      serviceClass = pulumi.Input.asOptionalInput<String>(serviceClass),
      serviceConnectionMapId = pulumi.Input.asOptionalInput<String>(serviceConnectionMapId),
  ...
  factory ServiceConnectionMapArgs.fromMap(Map<String, dynamic> map) {
    return ServiceConnectionMapArgs(
      consumerPscConfigs: map['consumerPscConfigs'] == null ? null : pulumi.Output.create<List<ConsumerPscConfig>>(pulumi.Input.decodeList<ConsumerPscConfig>(map['consumerPscConfigs'], (value) => ConsumerPscConfig.fromMap((value as Map).cast<String, dynamic>()))),
      description: map['description'] == null ? null : pulumi.Output.create<String>(map['description'] as String),
      etag: map['etag'] == null ? null : pulumi.Output.create<String>(map['etag'] as String),
      labels: map['labels'] == null ? null : pulumi.Output.create<Map<String, String>>((map['labels'] as Map).cast<String, String>()),
      location: map['location'] == null ? null : pulumi.Output.create<String>(map['location'] as String),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      producerPscConfigs: map['producerPscConfigs'] == null ? null : pulumi.Output.create<List<ProducerPscConfig>>(pulumi.Input.decodeList<ProducerPscConfig>(map['producerPscConfigs'], (value) => ProducerPscConfig.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      serviceConnectionMapId: map['serviceConnectionMapId'] == null ? null : pulumi.Output.create<String>(map['serviceConnectionMapId'] as String),
