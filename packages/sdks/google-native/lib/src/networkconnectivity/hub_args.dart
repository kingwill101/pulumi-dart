...
class HubArgs {
  ...
  factory HubArgs.fromMap(Map<String, dynamic> map) {
    return HubArgs(
      ...
      routingVpcs: (() { final guardedValue = map['routingVpcs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RoutingVPC>(guardedValue, (value) => RoutingVPC.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
