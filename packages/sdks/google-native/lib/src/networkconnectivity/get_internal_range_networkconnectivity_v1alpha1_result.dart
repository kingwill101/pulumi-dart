...
class GetInternalRangeNetworkconnectivityV1alpha1Result {
  ...
  /// Creates a new [GetInternalRangeNetworkconnectivityV1alpha1Result].
  ...
  const GetInternalRangeNetworkconnectivityV1alpha1Result({
  ...
  factory GetInternalRangeNetworkconnectivityV1alpha1Result.fromMap(Map<String, dynamic> map) {
    return GetInternalRangeNetworkconnectivityV1alpha1Result(
