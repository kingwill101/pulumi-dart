...
/// {@template pulumi_cloudkms_v1_key_ring_crypto_key_iam_binding_args_doc}
/// The set of arguments for KeyRingCryptoKeyIamBinding.
/// {@endtemplate}
/// {@macro pulumi_cloudkms_v1_key_ring_crypto_key_iam_binding_args_doc}
class KeyRingCryptoKeyIamBindingArgs {
  ...
  /// Creates a new [KeyRingCryptoKeyIamBindingArgs].
  ...
  const KeyRingCryptoKeyIamBindingArgs({
    this.condition,
  ...
  factory KeyRingCryptoKeyIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return KeyRingCryptoKeyIamBindingArgs(
