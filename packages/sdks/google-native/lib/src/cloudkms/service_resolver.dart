...
class ServiceResolver {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'hostname': hostname,
      'serverCertificates': pulumi.Input.encodeList<Certificate, Map<String, dynamic>>(serverCertificates, (value) => value.toMap()),
  ...
  factory ServiceResolver.fromMap(Map<String, dynamic> map) {
    return ServiceResolver(
      ...
      serverCertificates: pulumi.Input.decodeList<Certificate>(map['serverCertificates'], (value) => Certificate.fromMap((value as Map).cast<String, dynamic>())),
