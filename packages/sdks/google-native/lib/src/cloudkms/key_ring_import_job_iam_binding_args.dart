...
/// {@template pulumi_cloudkms_v1_key_ring_import_job_iam_binding_args_doc}
/// The set of arguments for KeyRingImportJobIamBinding.
/// {@endtemplate}
/// {@macro pulumi_cloudkms_v1_key_ring_import_job_iam_binding_args_doc}
class KeyRingImportJobIamBindingArgs {
  ...
  /// Creates a new [KeyRingImportJobIamBindingArgs].
  ...
  const KeyRingImportJobIamBindingArgs({
    this.condition,
  ...
  factory KeyRingImportJobIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return KeyRingImportJobIamBindingArgs(
