...
/// {@template pulumi_cloudkms_v1_ekm_config_iam_policy_args_doc}
/// The set of arguments for EkmConfigIamPolicy.
/// {@endtemplate}
/// {@macro pulumi_cloudkms_v1_ekm_config_iam_policy_args_doc}
class EkmConfigIamPolicyArgs {
  ...
  /// Creates a new [EkmConfigIamPolicyArgs].
  ...
  factory EkmConfigIamPolicyArgs.fromMap(Map<String, dynamic> map) {
    return EkmConfigIamPolicyArgs(
