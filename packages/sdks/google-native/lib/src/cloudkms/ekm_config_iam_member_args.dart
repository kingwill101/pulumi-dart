...
/// {@template pulumi_cloudkms_v1_ekm_config_iam_member_args_doc}
/// The set of arguments for EkmConfigIamMember.
/// {@endtemplate}
/// {@macro pulumi_cloudkms_v1_ekm_config_iam_member_args_doc}
class EkmConfigIamMemberArgs {
  ...
  /// Creates a new [EkmConfigIamMemberArgs].
  ...
  factory EkmConfigIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return EkmConfigIamMemberArgs(
