...
class CryptoKeyArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'project': ?project,
      'purpose': ?pulumi.Input.mapOptionalInputValue<CryptoKeyPurpose, String>(purpose, (value) => value.wireValue),
  ...
  factory CryptoKeyArgs.fromMap(Map<String, dynamic> map) {
    return CryptoKeyArgs(
      ...
      purpose: (() { final guardedValue = map['purpose']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CryptoKeyPurpose.fromValue(guardedValue as String)); })(),
