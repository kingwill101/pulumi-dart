...
import 'ekm_config_iam_binding_args.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class EkmConfigIamBinding extends pulumi.CustomResource {
  ...
  /// Creates a new [EkmConfigIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [EkmConfigIamBinding]. {@macro pulumi_cloudkms_v1_ekm_config_iam_binding_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  EkmConfigIamBinding(
    String name, {
    EkmConfigIamBindingArgs? args,
