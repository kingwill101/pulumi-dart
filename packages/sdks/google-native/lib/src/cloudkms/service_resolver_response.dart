...
class ServiceResolverResponse {
  ...
  factory ServiceResolverResponse.fromMap(Map<String, dynamic> map) {
    return ServiceResolverResponse(
      endpointFilter: (map['endpointFilter'] as String).input(),
      hostname: (map['hostname'] as String).input(),
      serverCertificates: (pulumi.Input.decodeList<CertificateResponse>(map['serverCertificates'], (value) => CertificateResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
