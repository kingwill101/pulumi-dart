...
/// {@template pulumi_cloudkms_v1_key_ring_crypto_key_iam_member_args_doc}
/// The set of arguments for KeyRingCryptoKeyIamMember.
/// {@endtemplate}
/// {@macro pulumi_cloudkms_v1_key_ring_crypto_key_iam_member_args_doc}
class KeyRingCryptoKeyIamMemberArgs {
  ...
  /// Creates a new [KeyRingCryptoKeyIamMemberArgs].
  ...
  const KeyRingCryptoKeyIamMemberArgs({
    this.condition,
