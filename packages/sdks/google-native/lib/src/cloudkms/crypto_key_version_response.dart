...
class CryptoKeyVersionResponse {
  ...
  final pulumi.Input<ExternalProtectionLevelOptionsResponse>
  ...
  factory CryptoKeyVersionResponse.fromMap(Map<String, dynamic> map) {
    return CryptoKeyVersionResponse(
      ...
      attestation: pulumi.Input.fromValue(
        KeyOperationAttestationResponse.fromMap(
          (map['attestation']! as Map).cast<String, dynamic>(),
        ),
      ),
      createTime: pulumi.Input.fromValue(map['createTime'] as String),
      destroyEventTime: pulumi.Input.fromValue(
        map['destroyEventTime'] as String,
      ),
      destroyTime: pulumi.Input.fromValue(map['destroyTime'] as String),
      externalDestructionFailureReason: pulumi.Input.fromValue(
        map['externalDestructionFailureReason'] as String,
      ),
      externalProtectionLevelOptions: pulumi.Input.fromValue(
      ...
      generationFailureReason: pulumi.Input.fromValue(
        map['generationFailureReason'] as String,
      ),
      importFailureReason: pulumi.Input.fromValue(
        map['importFailureReason'] as String,
      ),
