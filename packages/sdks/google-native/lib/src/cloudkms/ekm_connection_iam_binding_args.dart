...
/// {@template pulumi_cloudkms_v1_ekm_connection_iam_binding_args_doc}
/// The set of arguments for EkmConnectionIamBinding.
/// {@endtemplate}
/// {@macro pulumi_cloudkms_v1_ekm_connection_iam_binding_args_doc}
class EkmConnectionIamBindingArgs {
  ...
  const EkmConnectionIamBindingArgs({
    this.condition,
