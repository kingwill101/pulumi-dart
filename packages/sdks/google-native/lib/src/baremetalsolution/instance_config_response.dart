...
class InstanceConfigResponse {
  ...
  final pulumi.Input<
    List<GoogleCloudBaremetalsolutionV2LogicalInterfaceResponse>
  >
  logicalInterfaces;
  ...
  factory InstanceConfigResponse.fromMap(Map<String, dynamic> map) {
    return InstanceConfigResponse(
      ...
      privateNetwork: pulumi.Input.fromValue(
        NetworkAddressResponse.fromMap(
          (map['privateNetwork']! as Map).cast<String, dynamic>(),
        ),
      ),
      sshKeyNames: pulumi.Input.fromValue(
