...
class InstanceConfigResponse {
  ...
  final List<GoogleCloudBaremetalsolutionV2LogicalInterfaceResponse> logicalInterfaces;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'logicalInterfaces': pulumi.Input.encodeList<GoogleCloudBaremetalsolutionV2LogicalInterfaceResponse, Map<String, dynamic>>(logicalInterfaces, (value) => value.toMap()),
      'name': name,
  ...
  factory InstanceConfigResponse.fromMap(Map<String, dynamic> map) {
    return InstanceConfigResponse(
      ...
      clientNetwork: NetworkAddressResponse.fromMap((map['clientNetwork'] as Map).cast<String, dynamic>()),
      hyperthreading: map['hyperthreading'] as bool,
      instanceType: map['instanceType'] as String,
      logicalInterfaces: pulumi.Input.decodeList<GoogleCloudBaremetalsolutionV2LogicalInterfaceResponse>(map['logicalInterfaces'], (value) => GoogleCloudBaremetalsolutionV2LogicalInterfaceResponse.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] as String,
      networkConfig: map['networkConfig'] as String,
      networkTemplate: map['networkTemplate'] as String,
      osImage: map['osImage'] as String,
      privateNetwork: NetworkAddressResponse.fromMap((map['privateNetwork'] as Map).cast<String, dynamic>()),
