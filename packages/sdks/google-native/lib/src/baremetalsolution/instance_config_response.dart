...
class InstanceConfigResponse {
  ...
  factory InstanceConfigResponse.fromMap(Map<String, dynamic> map) {
    return InstanceConfigResponse(
      accountNetworksEnabled: pulumi.Input.fromValue(map['accountNetworksEnabled'] as bool),
      clientNetwork: pulumi.Input.fromValue(NetworkAddressResponse.fromMap((map['clientNetwork']! as Map).cast<String, dynamic>())),
      hyperthreading: pulumi.Input.fromValue(map['hyperthreading'] as bool),
      instanceType: pulumi.Input.fromValue(map['instanceType'] as String),
      logicalInterfaces: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudBaremetalsolutionV2LogicalInterfaceResponse>(map['logicalInterfaces']!, (value) => GoogleCloudBaremetalsolutionV2LogicalInterfaceResponse.fromMap((value as Map).cast<String, dynamic>()))),
      name: pulumi.Input.fromValue(map['name'] as String),
      networkConfig: pulumi.Input.fromValue(map['networkConfig'] as String),
      networkTemplate: pulumi.Input.fromValue(map['networkTemplate'] as String),
      osImage: pulumi.Input.fromValue(map['osImage'] as String),
      privateNetwork: pulumi.Input.fromValue(NetworkAddressResponse.fromMap((map['privateNetwork']! as Map).cast<String, dynamic>())),
      sshKeyNames: pulumi.Input.fromValue((map['sshKeyNames'] as List).cast<String>()),
