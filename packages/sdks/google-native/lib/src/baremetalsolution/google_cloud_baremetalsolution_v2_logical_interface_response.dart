...
class GoogleCloudBaremetalsolutionV2LogicalInterfaceResponse {
  ...
  factory GoogleCloudBaremetalsolutionV2LogicalInterfaceResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudBaremetalsolutionV2LogicalInterfaceResponse(
      interfaceIndex: (map['interfaceIndex'] as int).input(),
      logicalNetworkInterfaces: (pulumi.Input.decodeList<LogicalNetworkInterfaceResponse>(map['logicalNetworkInterfaces'], (value) => LogicalNetworkInterfaceResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
