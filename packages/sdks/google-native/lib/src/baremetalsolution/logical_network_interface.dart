...
class LogicalNetworkInterface {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ipAddress': ?ipAddress,
      'network': ?network,
      'networkType': ?pulumi.Input.mapOptionalInputValue<LogicalNetworkInterfaceNetworkType, String>(networkType, (value) => value.wireValue),
    };
  }
  ...
  factory LogicalNetworkInterface.fromMap(Map<String, dynamic> map) {
    return LogicalNetworkInterface(
      ...
      networkType: (() { final guardedValue = map['networkType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LogicalNetworkInterfaceNetworkType.fromValue(guardedValue as String)); })(),
    );
  }
}
