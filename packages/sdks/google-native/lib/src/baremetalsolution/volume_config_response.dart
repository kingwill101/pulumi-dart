...
class VolumeConfigResponse {
  ...
  factory VolumeConfigResponse.fromMap(Map<String, dynamic> map) {
    return VolumeConfigResponse(
      ...
      lunRanges: (pulumi.Input.decodeList<LunRangeResponse>(map['lunRanges'], (value) => LunRangeResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      machineIds: ((map['machineIds'] as List).cast<String>()).input(),
      name: (map['name'] as String).input(),
      nfsExports: (pulumi.Input.decodeList<NfsExportResponse>(map['nfsExports'], (value) => NfsExportResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      performanceTier: (map['performanceTier'] as String).input(),
