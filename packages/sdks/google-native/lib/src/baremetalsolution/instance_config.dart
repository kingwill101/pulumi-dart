...
class InstanceConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'networkConfig': ?pulumi.Input.mapOptionalInputValue<InstanceConfigNetworkConfig, String>(networkConfig, (value) => value.wireValue),
  ...
  factory InstanceConfig.fromMap(Map<String, dynamic> map) {
    return InstanceConfig(
      accountNetworksEnabled: (() { final guardedValue = map['accountNetworksEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      clientNetwork: (() { final guardedValue = map['clientNetwork']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkAddress.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      hyperthreading: (() { final guardedValue = map['hyperthreading']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      id: (() { final guardedValue = map['id']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      instanceType: (() { final guardedValue = map['instanceType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      logicalInterfaces: (() { final guardedValue = map['logicalInterfaces']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudBaremetalsolutionV2LogicalInterface>(guardedValue, (value) => GoogleCloudBaremetalsolutionV2LogicalInterface.fromMap((value as Map).cast<String, dynamic>()))); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      networkConfig: (() { final guardedValue = map['networkConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceConfigNetworkConfig.fromValue(guardedValue as String)); })(),
      networkTemplate: (() { final guardedValue = map['networkTemplate']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      privateNetwork: (() { final guardedValue = map['privateNetwork']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkAddress.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      sshKeyNames: (() { final guardedValue = map['sshKeyNames']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
