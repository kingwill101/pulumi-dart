...
class NfsExport {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'permissions': ?pulumi.Input.mapOptionalInputValue<NfsExportPermissions, String>(permissions, (value) => value.wireValue),
    };
  }
  ...
  factory NfsExport.fromMap(Map<String, dynamic> map) {
    return NfsExport(
      ...
      permissions: (() { final guardedValue = map['permissions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NfsExportPermissions.fromValue(guardedValue as String)); })(),
    );
  }
}
