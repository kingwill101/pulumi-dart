...
class GetNfsShareResult {
  ...
  /// Creates a new [GetNfsShareResult].
  /// [allowedClients] List of allowed access points.
  /// [labels] Labels as key value pairs.
  /// [name] Immutable. The name of the NFS share.
  /// [nfsShareId] An identifier for the NFS share, generated by the backend. This field will be deprecated in the future, use `id` instead.
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'allowedClients': pulumi.Input.encodeList<AllowedClientResponse, Map<String, dynamic>>(allowedClients, (value) => value.toMap()),
      'labels': labels,
      'name': name,
  ...
  factory GetNfsShareResult.fromMap(Map<String, dynamic> map) {
    return GetNfsShareResult(
      allowedClients: pulumi.Input.decodeList<AllowedClientResponse>(map['allowedClients']!, (value) => AllowedClientResponse.fromMap((value as Map).cast<String, dynamic>())),
