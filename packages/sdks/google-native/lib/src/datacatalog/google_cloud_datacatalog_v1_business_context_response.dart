...
class GoogleCloudDatacatalogV1BusinessContextResponse {
  ...
  factory GoogleCloudDatacatalogV1BusinessContextResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDatacatalogV1BusinessContextResponse(
      contacts: (GoogleCloudDatacatalogV1ContactsResponse.fromMap((map['contacts'] as Map).cast<String, dynamic>())).input(),
      entryOverview: (GoogleCloudDatacatalogV1EntryOverviewResponse.fromMap((map['entryOverview'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
