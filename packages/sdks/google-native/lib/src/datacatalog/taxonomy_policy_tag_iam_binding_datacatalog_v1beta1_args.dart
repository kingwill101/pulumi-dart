...
/// {@template pulumi_datacatalog_v1beta1_taxonomy_policy_tag_iam_binding_datacatalog_v1beta1_args_doc}
/// The set of arguments for TaxonomyPolicyTagIamBinding.
/// {@endtemplate}
/// {@macro pulumi_datacatalog_v1beta1_taxonomy_policy_tag_iam_binding_datacatalog_v1beta1_args_doc}
class TaxonomyPolicyTagIamBindingDatacatalogV1beta1Args {
  ...
  /// Creates a new [TaxonomyPolicyTagIamBindingDatacatalogV1beta1Args].
  ...
  const TaxonomyPolicyTagIamBindingDatacatalogV1beta1Args({
    this.condition,
  ...
  factory TaxonomyPolicyTagIamBindingDatacatalogV1beta1Args.fromMap(Map<String, dynamic> map) {
    return TaxonomyPolicyTagIamBindingDatacatalogV1beta1Args(
