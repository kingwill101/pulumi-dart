...
class GoogleCloudDatacatalogV1LookerSystemSpecResponse {
  ...
  factory GoogleCloudDatacatalogV1LookerSystemSpecResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDatacatalogV1LookerSystemSpecResponse(
      parentInstanceDisplayName: pulumi.Input.fromValue(map['parentInstanceDisplayName'] as String),
      parentInstanceId: pulumi.Input.fromValue(map['parentInstanceId'] as String),
      parentModelDisplayName: pulumi.Input.fromValue(map['parentModelDisplayName'] as String),
      parentModelId: pulumi.Input.fromValue(map['parentModelId'] as String),
      parentViewDisplayName: pulumi.Input.fromValue(map['parentViewDisplayName'] as String),
