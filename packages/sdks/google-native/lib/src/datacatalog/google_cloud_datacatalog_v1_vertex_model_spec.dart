...
class GoogleCloudDatacatalogV1VertexModelSpec {
  ...
  final pulumi.Input<GoogleCloudDatacatalogV1VertexModelSourceInfo>?
    ...
    return <String, dynamic>{
      ...
      'vertexModelSourceInfo':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(vertexModelSourceInfo, (value) => value.toMap()),
    };
  }
  ...
  factory GoogleCloudDatacatalogV1VertexModelSpec.fromMap(
    ...
    return GoogleCloudDatacatalogV1VertexModelSpec(
      containerImageUri: (() {
        final guardedValue = map['containerImageUri'];
      ...
      vertexModelSourceInfo: (() {
        final guardedValue = map['vertexModelSourceInfo'];
        if (guardedValue == null) return null;
