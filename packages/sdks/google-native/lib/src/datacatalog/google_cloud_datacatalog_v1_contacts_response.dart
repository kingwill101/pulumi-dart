...
class GoogleCloudDatacatalogV1ContactsResponse {
  ...
  final pulumi.Input<List<GoogleCloudDatacatalogV1ContactsPersonResponse>>
  people;
    ...
    return <String, dynamic>{
      'people':
          pulumi.Input.mapInputValue<
            List<GoogleCloudDatacatalogV1ContactsPersonResponse>,
  ...
  factory GoogleCloudDatacatalogV1ContactsResponse.fromMap(
    ...
    return GoogleCloudDatacatalogV1ContactsResponse(
      people: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GoogleCloudDatacatalogV1ContactsPersonResponse>(
          map['people']!,
