...
class GoogleCloudDatacatalogV1ContactsResponse {
  ...
  const GoogleCloudDatacatalogV1ContactsResponse({
  ...
  factory GoogleCloudDatacatalogV1ContactsResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDatacatalogV1ContactsResponse(
      people: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudDatacatalogV1ContactsPersonResponse>(map['people']!, (value) => GoogleCloudDatacatalogV1ContactsPersonResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
