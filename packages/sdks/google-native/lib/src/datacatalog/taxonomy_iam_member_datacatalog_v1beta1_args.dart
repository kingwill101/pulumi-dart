...
/// {@template pulumi_datacatalog_v1beta1_taxonomy_iam_member_datacatalog_v1beta1_args_doc}
/// The set of arguments for TaxonomyIamMember.
/// {@endtemplate}
/// {@macro pulumi_datacatalog_v1beta1_taxonomy_iam_member_datacatalog_v1beta1_args_doc}
class TaxonomyIamMemberDatacatalogV1beta1Args {
  ...
  /// Creates a new [TaxonomyIamMemberDatacatalogV1beta1Args].
  ...
  const TaxonomyIamMemberDatacatalogV1beta1Args({
    this.condition,
  ...
  factory TaxonomyIamMemberDatacatalogV1beta1Args.fromMap(Map<String, dynamic> map) {
    return TaxonomyIamMemberDatacatalogV1beta1Args(
