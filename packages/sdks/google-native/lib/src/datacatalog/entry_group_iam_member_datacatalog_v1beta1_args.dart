...
/// {@template pulumi_datacatalog_v1beta1_entry_group_iam_member_datacatalog_v1beta1_args_doc}
/// The set of arguments for EntryGroupIamMember.
/// {@endtemplate}
/// {@macro pulumi_datacatalog_v1beta1_entry_group_iam_member_datacatalog_v1beta1_args_doc}
class EntryGroupIamMemberDatacatalogV1beta1Args {
  ...
  /// Creates a new [EntryGroupIamMemberDatacatalogV1beta1Args].
  ...
  const EntryGroupIamMemberDatacatalogV1beta1Args({
    this.condition,
  ...
  factory EntryGroupIamMemberDatacatalogV1beta1Args.fromMap(Map<String, dynamic> map) {
    return EntryGroupIamMemberDatacatalogV1beta1Args(
