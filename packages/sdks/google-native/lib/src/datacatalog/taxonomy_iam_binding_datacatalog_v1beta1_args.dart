...
/// {@template pulumi_datacatalog_v1beta1_taxonomy_iam_binding_datacatalog_v1beta1_args_doc}
/// The set of arguments for TaxonomyIamBinding.
/// {@endtemplate}
/// {@macro pulumi_datacatalog_v1beta1_taxonomy_iam_binding_datacatalog_v1beta1_args_doc}
class TaxonomyIamBindingDatacatalogV1beta1Args {
  ...
  /// Creates a new [TaxonomyIamBindingDatacatalogV1beta1Args].
  ...
  const TaxonomyIamBindingDatacatalogV1beta1Args({
    this.condition,
  ...
  factory TaxonomyIamBindingDatacatalogV1beta1Args.fromMap(Map<String, dynamic> map) {
