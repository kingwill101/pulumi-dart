...
/// {@template pulumi_datacatalog_v1beta1_tag_template_iam_binding_datacatalog_v1beta1_args_doc}
/// The set of arguments for TagTemplateIamBinding.
/// {@endtemplate}
/// {@macro pulumi_datacatalog_v1beta1_tag_template_iam_binding_datacatalog_v1beta1_args_doc}
class TagTemplateIamBindingDatacatalogV1beta1Args {
  ...
  /// Creates a new [TagTemplateIamBindingDatacatalogV1beta1Args].
  ...
  const TagTemplateIamBindingDatacatalogV1beta1Args({
    this.condition,
  ...
  factory TagTemplateIamBindingDatacatalogV1beta1Args.fromMap(Map<String, dynamic> map) {
    return TagTemplateIamBindingDatacatalogV1beta1Args(
