...
class GoogleCloudDatacatalogV1VertexModelSourceInfo {
  ...
  final pulumi.Input<GoogleCloudDatacatalogV1VertexModelSourceInfoSourceType>?
  sourceType;
  ...
  GoogleCloudDatacatalogV1VertexModelSourceInfo({this.copy, this.sourceType});
    ...
    return <String, dynamic>{
      ...
      'sourceType':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(sourceType, (value) => value.wireValue),
    };
  }
