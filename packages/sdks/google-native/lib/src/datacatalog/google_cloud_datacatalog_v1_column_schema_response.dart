...
class GoogleCloudDatacatalogV1ColumnSchemaResponse {
  ...
  factory GoogleCloudDatacatalogV1ColumnSchemaResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDatacatalogV1ColumnSchemaResponse(
      ...
      gcRule: (map['gcRule'] as String).input(),
      highestIndexingType: (map['highestIndexingType'] as String).input(),
      lookerColumnSpec: (GoogleCloudDatacatalogV1ColumnSchemaLookerColumnSpecResponse.fromMap((map['lookerColumnSpec'] as Map).cast<String, dynamic>())).input(),
      mode: (map['mode'] as String).input(),
      ordinalPosition: (map['ordinalPosition'] as int).input(),
      subcolumns: (pulumi.Input.decodeList<GoogleCloudDatacatalogV1ColumnSchemaResponse>(map['subcolumns'], (value) => GoogleCloudDatacatalogV1ColumnSchemaResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
