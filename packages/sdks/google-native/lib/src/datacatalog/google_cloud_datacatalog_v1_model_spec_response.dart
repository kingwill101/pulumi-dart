...
class GoogleCloudDatacatalogV1ModelSpecResponse {
  ...
  final pulumi.Input<GoogleCloudDatacatalogV1VertexModelSpecResponse> vertexModelSpec;

  /// Creates a new [GoogleCloudDatacatalogV1ModelSpecResponse].
  /// [vertexModelSpec] Specification for vertex model resources.
  const GoogleCloudDatacatalogV1ModelSpecResponse({
    required this.vertexModelSpec,
  });

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'vertexModelSpec': pulumi.Input.mapInputValue<GoogleCloudDatacatalogV1VertexModelSpecResponse, Map<String, dynamic>>(vertexModelSpec, (value) => value.toMap()),
    };
  }
  ...
  factory GoogleCloudDatacatalogV1ModelSpecResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDatacatalogV1ModelSpecResponse(
      vertexModelSpec: pulumi.Input.fromValue(GoogleCloudDatacatalogV1VertexModelSpecResponse.fromMap((map['vertexModelSpec']! as Map).cast<String, dynamic>())),
    );
  }
}
