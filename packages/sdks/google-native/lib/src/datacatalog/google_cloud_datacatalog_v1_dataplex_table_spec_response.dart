...
class GoogleCloudDatacatalogV1DataplexTableSpecResponse {
  ...
  factory GoogleCloudDatacatalogV1DataplexTableSpecResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDatacatalogV1DataplexTableSpecResponse(
      dataplexSpec: pulumi.Input.fromValue(GoogleCloudDatacatalogV1DataplexSpecResponse.fromMap((map['dataplexSpec']! as Map).cast<String, dynamic>())),
      externalTables: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudDatacatalogV1DataplexExternalTableResponse>(map['externalTables']!, (value) => GoogleCloudDatacatalogV1DataplexExternalTableResponse.fromMap((value as Map).cast<String, dynamic>()))),
