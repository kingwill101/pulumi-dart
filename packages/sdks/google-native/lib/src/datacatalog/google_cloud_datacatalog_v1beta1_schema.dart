...
class GoogleCloudDatacatalogV1beta1Schema {
  ...
  factory GoogleCloudDatacatalogV1beta1Schema.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDatacatalogV1beta1Schema(
      columns: (pulumi.Input.decodeList<GoogleCloudDatacatalogV1beta1ColumnSchema>(map['columns'], (value) => GoogleCloudDatacatalogV1beta1ColumnSchema.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
