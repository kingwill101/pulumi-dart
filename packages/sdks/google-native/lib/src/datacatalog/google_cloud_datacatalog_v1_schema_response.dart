...
class GoogleCloudDatacatalogV1SchemaResponse {
  ...
  final pulumi.Input<List<GoogleCloudDatacatalogV1ColumnSchemaResponse>>
  columns;
  ...
  GoogleCloudDatacatalogV1SchemaResponse({required this.columns});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'columns':
          pulumi.Input.mapInputValue<
            List<GoogleCloudDatacatalogV1ColumnSchemaResponse>,
