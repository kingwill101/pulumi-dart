...
class GoogleCloudDatacatalogV1SchemaResponse {
  ...
  factory GoogleCloudDatacatalogV1SchemaResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDatacatalogV1SchemaResponse(
      columns: (pulumi.Input.decodeList<GoogleCloudDatacatalogV1ColumnSchemaResponse>(map['columns'], (value) => GoogleCloudDatacatalogV1ColumnSchemaResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
