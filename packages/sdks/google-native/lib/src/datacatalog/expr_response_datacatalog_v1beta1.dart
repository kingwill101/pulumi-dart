...
class ExprResponseDatacatalogV1beta1 {
  ...
  /// Creates a new [ExprResponseDatacatalogV1beta1].
  ...
  const ExprResponseDatacatalogV1beta1({
  ...
  factory ExprResponseDatacatalogV1beta1.fromMap(Map<String, dynamic> map) {
    return ExprResponseDatacatalogV1beta1(
