...
class GoogleCloudDatacatalogV1DataplexSpec {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'dataFormat': ?dataFormat == null ? null : dataFormat!.toMap(),
      'project': ?project,
    };
  }
  ...
  factory GoogleCloudDatacatalogV1DataplexSpec.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDatacatalogV1DataplexSpec(
      ...
      dataFormat: map['dataFormat'] == null ? null : GoogleCloudDatacatalogV1PhysicalSchema.fromMap((map['dataFormat'] as Map).cast<String, dynamic>()),
