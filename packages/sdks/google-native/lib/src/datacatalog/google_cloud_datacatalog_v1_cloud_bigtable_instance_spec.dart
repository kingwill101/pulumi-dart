...
class GoogleCloudDatacatalogV1CloudBigtableInstanceSpec {
  ...
  final List<GoogleCloudDatacatalogV1CloudBigtableInstanceSpecCloudBigtableClusterSpec>? cloudBigtableClusterSpecs;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'cloudBigtableClusterSpecs': ?cloudBigtableClusterSpecs == null ? null : pulumi.Input.encodeList<GoogleCloudDatacatalogV1CloudBigtableInstanceSpecCloudBigtableClusterSpec, Map<String, dynamic>>(cloudBigtableClusterSpecs!, (value) => value.toMap()),
    };
  }
