...
class GoogleCloudDatacatalogV1beta1GcsFilesetSpecResponse {
  ...
  final List<GoogleCloudDatacatalogV1beta1GcsFileSpecResponse> sampleGcsFileSpecs;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'sampleGcsFileSpecs': pulumi.Input.encodeList<GoogleCloudDatacatalogV1beta1GcsFileSpecResponse, Map<String, dynamic>>(sampleGcsFileSpecs, (value) => value.toMap()),
    };
  }
  ...
  factory GoogleCloudDatacatalogV1beta1GcsFilesetSpecResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDatacatalogV1beta1GcsFilesetSpecResponse(
      ...
      sampleGcsFileSpecs: pulumi.Input.decodeList<GoogleCloudDatacatalogV1beta1GcsFileSpecResponse>(map['sampleGcsFileSpecs'], (value) => GoogleCloudDatacatalogV1beta1GcsFileSpecResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
