...
class GoogleCloudDatacatalogV1beta1GcsFilesetSpecResponse {
  ...
  const GoogleCloudDatacatalogV1beta1GcsFilesetSpecResponse({
  ...
  factory GoogleCloudDatacatalogV1beta1GcsFilesetSpecResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDatacatalogV1beta1GcsFilesetSpecResponse(
      ...
      sampleGcsFileSpecs: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudDatacatalogV1beta1GcsFileSpecResponse>(map['sampleGcsFileSpecs']!, (value) => GoogleCloudDatacatalogV1beta1GcsFileSpecResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
