...
class GoogleCloudDatacatalogV1beta1GcsFilesetSpecResponse {
  ...
  final pulumi.Input<List<GoogleCloudDatacatalogV1beta1GcsFileSpecResponse>>
  sampleGcsFileSpecs;
    ...
    return <String, dynamic>{
      ...
      'sampleGcsFileSpecs':
          pulumi.Input.mapInputValue<
            List<GoogleCloudDatacatalogV1beta1GcsFileSpecResponse>,
  ...
  factory GoogleCloudDatacatalogV1beta1GcsFilesetSpecResponse.fromMap(
    ...
    return GoogleCloudDatacatalogV1beta1GcsFilesetSpecResponse(
      ...
      sampleGcsFileSpecs: pulumi.Input.fromValue(
        pulumi
