...
/// {@template pulumi_datacatalog_v1_taxonomy_policy_tag_iam_member_args_doc}
/// The set of arguments for TaxonomyPolicyTagIamMember.
/// {@endtemplate}
/// {@macro pulumi_datacatalog_v1_taxonomy_policy_tag_iam_member_args_doc}
class TaxonomyPolicyTagIamMemberArgs {
  ...
  /// Creates a new [TaxonomyPolicyTagIamMemberArgs].
  ...
  const TaxonomyPolicyTagIamMemberArgs({
    this.condition,
  ...
  factory TaxonomyPolicyTagIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return TaxonomyPolicyTagIamMemberArgs(
