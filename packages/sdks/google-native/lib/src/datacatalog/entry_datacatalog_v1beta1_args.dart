    ...
    return <String, dynamic>{
      ...
      'bigqueryTableSpec':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(bigqueryTableSpec, (value) => value.toMap()),
  ...
  factory EntryDatacatalogV1beta1Args.fromMap(Map<String, dynamic> map) {
    return EntryDatacatalogV1beta1Args(
      bigqueryDateShardedSpec: (() {
        final guardedValue = map['bigqueryDateShardedSpec'];
      ...
      bigqueryTableSpec: (() {
        final guardedValue = map['bigqueryTableSpec'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      type: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          EntryTypeDatacatalogV1beta1.fromValue(guardedValue as String),
        );
      })(),
      userSpecifiedSystem: (() {
