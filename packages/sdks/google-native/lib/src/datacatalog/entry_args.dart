...
class EntryArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'type': ?pulumi.Input.mapOptionalInputValue<EntryType, String>(type, (value) => value.wireValue),
  ...
  factory EntryArgs.fromMap(Map<String, dynamic> map) {
    return EntryArgs(
      businessContext: (() { final guardedValue = map['businessContext']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDatacatalogV1BusinessContext.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      cloudBigtableSystemSpec: (() { final guardedValue = map['cloudBigtableSystemSpec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDatacatalogV1CloudBigtableSystemSpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      dataSourceConnectionSpec: (() { final guardedValue = map['dataSourceConnectionSpec']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, dynamic>()); })(),
      databaseTableSpec: (() { final guardedValue = map['databaseTableSpec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDatacatalogV1DatabaseTableSpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      datasetSpec: (() { final guardedValue = map['datasetSpec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDatacatalogV1DatasetSpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      filesetSpec: (() { final guardedValue = map['filesetSpec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDatacatalogV1FilesetSpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      gcsFilesetSpec: (() { final guardedValue = map['gcsFilesetSpec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDatacatalogV1GcsFilesetSpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      lookerSystemSpec: (() { final guardedValue = map['lookerSystemSpec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDatacatalogV1LookerSystemSpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      modelSpec: (() { final guardedValue = map['modelSpec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDatacatalogV1ModelSpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      project: (() { final guardedValue = map['project']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      routineSpec: (() { final guardedValue = map['routineSpec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDatacatalogV1RoutineSpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      schema: (() { final guardedValue = map['schema']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDatacatalogV1Schema.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      serviceSpec: (() { final guardedValue = map['serviceSpec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDatacatalogV1ServiceSpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      sourceSystemTimestamps: (() { final guardedValue = map['sourceSystemTimestamps']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDatacatalogV1SystemTimestamps.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      sqlDatabaseSystemSpec: (() { final guardedValue = map['sqlDatabaseSystemSpec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDatacatalogV1SqlDatabaseSystemSpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EntryType.fromValue(guardedValue as String)); })(),
      usageSignal: (() { final guardedValue = map['usageSignal']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDatacatalogV1UsageSignal.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
