...
class EntryArgs {
  ...
  factory EntryArgs.fromMap(Map<String, dynamic> map) {
    return EntryArgs(
      businessContext: (() {
        final guardedValue = map['businessContext'];
      ...
      cloudBigtableSystemSpec: (() {
        final guardedValue = map['cloudBigtableSystemSpec'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      dataSourceConnectionSpec: (() {
        final guardedValue = map['dataSourceConnectionSpec'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      ...
      databaseTableSpec: (() {
        final guardedValue = map['databaseTableSpec'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      datasetSpec: (() {
        final guardedValue = map['datasetSpec'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      filesetSpec: (() {
        final guardedValue = map['filesetSpec'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      lookerSystemSpec: (() {
        final guardedValue = map['lookerSystemSpec'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      modelSpec: (() {
        final guardedValue = map['modelSpec'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      routineSpec: (() {
        final guardedValue = map['routineSpec'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      sourceSystemTimestamps: (() {
        final guardedValue = map['sourceSystemTimestamps'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      sqlDatabaseSystemSpec: (() {
        final guardedValue = map['sqlDatabaseSystemSpec'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      type: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          EntryType.fromValue(guardedValue as String),
        );
      })(),
      usageSignal: (() {
        final guardedValue = map['usageSignal'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
