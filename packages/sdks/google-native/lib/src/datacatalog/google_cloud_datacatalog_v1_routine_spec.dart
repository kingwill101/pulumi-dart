...
class GoogleCloudDatacatalogV1RoutineSpec {
  ...
  final pulumi.Input<GoogleCloudDatacatalogV1BigQueryRoutineSpec>?
  bigqueryRoutineSpec;
  ...
  final pulumi.Input<List<GoogleCloudDatacatalogV1RoutineSpecArgument>>?
  routineArguments;

  /// The type of the routine.
  final pulumi.Input<GoogleCloudDatacatalogV1RoutineSpecRoutineType>?
  routineType;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'routineArguments':
          ?pulumi.Input.mapOptionalInputValue<
            List<GoogleCloudDatacatalogV1RoutineSpecArgument>,
      ...
      'routineType':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(routineType, (value) => value.wireValue),
    };
  }
  ...
  factory GoogleCloudDatacatalogV1RoutineSpec.fromMap(
    ...
    return GoogleCloudDatacatalogV1RoutineSpec(
      bigqueryRoutineSpec: (() {
        final guardedValue = map['bigqueryRoutineSpec'];
      ...
      definitionBody: (() {
        final guardedValue = map['definitionBody'];
        if (guardedValue == null) return null;
      ...
      routineArguments: (() {
        final guardedValue = map['routineArguments'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GoogleCloudDatacatalogV1RoutineSpecArgument>(
            guardedValue,
      ...
      routineType: (() {
        final guardedValue = map['routineType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
