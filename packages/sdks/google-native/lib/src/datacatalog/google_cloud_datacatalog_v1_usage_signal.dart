...
class GoogleCloudDatacatalogV1UsageSignal {
  ...
  factory GoogleCloudDatacatalogV1UsageSignal.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDatacatalogV1UsageSignal(
      commonUsageWithinTimeRange: map['commonUsageWithinTimeRange'] == null ? null : (map['commonUsageWithinTimeRange'] as Map).cast<String, String>(),
      favoriteCount: map['favoriteCount'] == null ? null : map['favoriteCount'] as String,
