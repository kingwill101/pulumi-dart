...
class GoogleCloudDatacatalogV1RoutineSpecResponse {
  ...
  final pulumi.Input<GoogleCloudDatacatalogV1BigQueryRoutineSpecResponse>
  bigqueryRoutineSpec;
  ...
  final pulumi.Input<List<GoogleCloudDatacatalogV1RoutineSpecArgumentResponse>>
  routineArguments;
    ...
    return <String, dynamic>{
      'bigqueryRoutineSpec':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(bigqueryRoutineSpec, (value) => value.toMap()),
      'definitionBody': definitionBody,
      'language': language,
      'returnType': returnType,
      'routineArguments':
          pulumi.Input.mapInputValue<
            List<GoogleCloudDatacatalogV1RoutineSpecArgumentResponse>,
  ...
  factory GoogleCloudDatacatalogV1RoutineSpecResponse.fromMap(
    ...
    return GoogleCloudDatacatalogV1RoutineSpecResponse(
      bigqueryRoutineSpec: pulumi.Input.fromValue(
      ...
      routineArguments: pulumi.Input.fromValue(
