...
class GoogleCloudDatacatalogV1RoutineSpecResponse {
  ...
  factory GoogleCloudDatacatalogV1RoutineSpecResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDatacatalogV1RoutineSpecResponse(
      bigqueryRoutineSpec: (GoogleCloudDatacatalogV1BigQueryRoutineSpecResponse.fromMap((map['bigqueryRoutineSpec'] as Map).cast<String, dynamic>())).input(),
      definitionBody: (map['definitionBody'] as String).input(),
      language: (map['language'] as String).input(),
      returnType: (map['returnType'] as String).input(),
      routineArguments: (pulumi.Input.decodeList<GoogleCloudDatacatalogV1RoutineSpecArgumentResponse>(map['routineArguments'], (value) => GoogleCloudDatacatalogV1RoutineSpecArgumentResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
