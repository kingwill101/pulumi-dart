...
class GoogleCloudDatacatalogV1DatabaseTableSpec {
  ...
  final pulumi.Input<GoogleCloudDatacatalogV1DatabaseTableSpecDatabaseViewSpec>?
  databaseViewSpec;
  ...
  GoogleCloudDatacatalogV1DatabaseTableSpec({this.databaseViewSpec, this.type});
  ...
  factory GoogleCloudDatacatalogV1DatabaseTableSpec.fromMap(
    ...
    return GoogleCloudDatacatalogV1DatabaseTableSpec(
      databaseViewSpec: (() {
        final guardedValue = map['databaseViewSpec'];
