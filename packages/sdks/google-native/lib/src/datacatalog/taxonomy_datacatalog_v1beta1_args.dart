...
class TaxonomyDatacatalogV1beta1Args {
  ...
  final pulumi.Input<List<TaxonomyActivatedPolicyTypesItemDatacatalogV1beta1>>?
    ...
    return <String, dynamic>{
      'activatedPolicyTypes':
          ?pulumi.Input.mapOptionalInputValue<
            List<TaxonomyActivatedPolicyTypesItemDatacatalogV1beta1>,
            List<String>
          >(
            activatedPolicyTypes,
            (value) =>
                pulumi.Input.encodeList<
                  TaxonomyActivatedPolicyTypesItemDatacatalogV1beta1,
                  String
      ...
      activatedPolicyTypes: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                TaxonomyActivatedPolicyTypesItemDatacatalogV1beta1.fromValue(
                  value as String,
                ),
          ),
        );
