...
class GoogleCloudDatacatalogV1ServiceSpecResponse {
  ...
  final pulumi.Input<GoogleCloudDatacatalogV1CloudBigtableInstanceSpecResponse>
    ...
    return <String, dynamic>{
      'cloudBigtableInstanceSpec':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(cloudBigtableInstanceSpec, (value) => value.toMap()),
    };
  }

  factory GoogleCloudDatacatalogV1ServiceSpecResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return GoogleCloudDatacatalogV1ServiceSpecResponse(
      cloudBigtableInstanceSpec: pulumi.Input.fromValue(
        GoogleCloudDatacatalogV1CloudBigtableInstanceSpecResponse.fromMap(
          (map['cloudBigtableInstanceSpec']! as Map).cast<String, dynamic>(),
        ),
      ),
    );
  }
