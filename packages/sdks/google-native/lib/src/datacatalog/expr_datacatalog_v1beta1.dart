...
class ExprDatacatalogV1beta1 {
  ...
  /// Creates a new [ExprDatacatalogV1beta1].
  ...
  factory ExprDatacatalogV1beta1.fromMap(Map<String, dynamic> map) {
    return ExprDatacatalogV1beta1(
