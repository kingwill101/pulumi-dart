...
class GoogleCloudDatacatalogV1PhysicalSchemaResponse {
  ...
  final pulumi.Input<GoogleCloudDatacatalogV1PhysicalSchemaAvroSchemaResponse>
  avro;
  ...
  final pulumi.Input<GoogleCloudDatacatalogV1PhysicalSchemaThriftSchemaResponse>
  thrift;
  ...
  factory GoogleCloudDatacatalogV1PhysicalSchemaResponse.fromMap(
    ...
    return GoogleCloudDatacatalogV1PhysicalSchemaResponse(
      avro: pulumi.Input.fromValue(
        GoogleCloudDatacatalogV1PhysicalSchemaAvroSchemaResponse.fromMap(
