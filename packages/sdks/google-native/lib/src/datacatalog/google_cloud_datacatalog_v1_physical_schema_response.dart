...
class GoogleCloudDatacatalogV1PhysicalSchemaResponse {
  ...
  factory GoogleCloudDatacatalogV1PhysicalSchemaResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDatacatalogV1PhysicalSchemaResponse(
      avro: (GoogleCloudDatacatalogV1PhysicalSchemaAvroSchemaResponse.fromMap((map['avro'] as Map).cast<String, dynamic>())).input(),
      csv: ((map['csv'] as Map).cast<String, dynamic>()).input(),
      orc: ((map['orc'] as Map).cast<String, dynamic>()).input(),
      parquet: ((map['parquet'] as Map).cast<String, dynamic>()).input(),
      protobuf: (GoogleCloudDatacatalogV1PhysicalSchemaProtobufSchemaResponse.fromMap((map['protobuf'] as Map).cast<String, dynamic>())).input(),
      thrift: (GoogleCloudDatacatalogV1PhysicalSchemaThriftSchemaResponse.fromMap((map['thrift'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
