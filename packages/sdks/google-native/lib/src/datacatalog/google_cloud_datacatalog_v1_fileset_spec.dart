...
class GoogleCloudDatacatalogV1FilesetSpec {
  ...
  factory GoogleCloudDatacatalogV1FilesetSpec.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDatacatalogV1FilesetSpec(
      dataplexFileset: (() { final guardedValue = map['dataplexFileset']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDatacatalogV1DataplexFilesetSpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
