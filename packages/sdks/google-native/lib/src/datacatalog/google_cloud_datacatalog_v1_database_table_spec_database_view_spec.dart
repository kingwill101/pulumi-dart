...
class GoogleCloudDatacatalogV1DatabaseTableSpecDatabaseViewSpec {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'baseTable': ?baseTable,
      'sqlQuery': ?sqlQuery,
      'viewType': ?pulumi.Input.mapOptionalInputValue<GoogleCloudDatacatalogV1DatabaseTableSpecDatabaseViewSpecViewType, String>(viewType, (value) => value.wireValue),
    };
  }
  ...
  factory GoogleCloudDatacatalogV1DatabaseTableSpecDatabaseViewSpec.fromMap(Map<String, dynamic> map) {
    return GoogleCloudDatacatalogV1DatabaseTableSpecDatabaseViewSpec(
      baseTable: (() { final guardedValue = map['baseTable']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      sqlQuery: (() { final guardedValue = map['sqlQuery']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      viewType: (() { final guardedValue = map['viewType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudDatacatalogV1DatabaseTableSpecDatabaseViewSpecViewType.fromValue(guardedValue as String)); })(),
    );
  }
}
