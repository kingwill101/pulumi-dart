...
/// {@template pulumi_datacatalog_v1beta1_taxonomy_policy_tag_iam_member_datacatalog_v1beta1_args_doc}
/// The set of arguments for TaxonomyPolicyTagIamMember.
/// {@endtemplate}
/// {@macro pulumi_datacatalog_v1beta1_taxonomy_policy_tag_iam_member_datacatalog_v1beta1_args_doc}
class TaxonomyPolicyTagIamMemberDatacatalogV1beta1Args {
  ...
  /// Creates a new [TaxonomyPolicyTagIamMemberDatacatalogV1beta1Args].
  ...
  const TaxonomyPolicyTagIamMemberDatacatalogV1beta1Args({
    this.condition,
  ...
  factory TaxonomyPolicyTagIamMemberDatacatalogV1beta1Args.fromMap(Map<String, dynamic> map) {
    return TaxonomyPolicyTagIamMemberDatacatalogV1beta1Args(
