...
/// {@template pulumi_datacatalog_v1beta1_entry_group_iam_binding_datacatalog_v1beta1_args_doc}
/// The set of arguments for EntryGroupIamBinding.
/// {@endtemplate}
/// {@macro pulumi_datacatalog_v1beta1_entry_group_iam_binding_datacatalog_v1beta1_args_doc}
class EntryGroupIamBindingDatacatalogV1beta1Args {
  ...
  /// Creates a new [EntryGroupIamBindingDatacatalogV1beta1Args].
  ...
  const EntryGroupIamBindingDatacatalogV1beta1Args({
    this.condition,
  ...
  factory EntryGroupIamBindingDatacatalogV1beta1Args.fromMap(Map<String, dynamic> map) {
    return EntryGroupIamBindingDatacatalogV1beta1Args(
