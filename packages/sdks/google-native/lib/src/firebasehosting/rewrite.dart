...
class Rewrite {
  ...
  factory Rewrite.fromMap(Map<String, dynamic> map) {
    return Rewrite(
      dynamicLinks: map['dynamicLinks'] == null ? null : map['dynamicLinks'] as bool,
      function: map['function'] == null ? null : map['function'] as String,
      functionRegion: map['functionRegion'] == null ? null : map['functionRegion'] as String,
      glob: map['glob'] == null ? null : map['glob'] as String,
      path: map['path'] == null ? null : map['path'] as String,
      regex: map['regex'] == null ? null : map['regex'] as String,
      run: map['run'] == null ? null : CloudRunRewrite.fromMap((map['run'] as Map).cast<String, dynamic>()),
    );
  }
}
