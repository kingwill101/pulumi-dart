...
class ServingConfigResponse {
  ...
  factory ServingConfigResponse.fromMap(Map<String, dynamic> map) {
    return ServingConfigResponse(
      ...
      i18n: pulumi.Input.fromValue(I18nConfigResponse.fromMap((map['i18n']! as Map).cast<String, dynamic>())),
      redirects: pulumi.Input.fromValue(pulumi.Input.decodeList<RedirectResponse>(map['redirects']!, (value) => RedirectResponse.fromMap((value as Map).cast<String, dynamic>()))),
      rewrites: pulumi.Input.fromValue(pulumi.Input.decodeList<RewriteResponse>(map['rewrites']!, (value) => RewriteResponse.fromMap((value as Map).cast<String, dynamic>()))),
      trailingSlashBehavior: pulumi.Input.fromValue(map['trailingSlashBehavior'] as String),
    );
  }
}
