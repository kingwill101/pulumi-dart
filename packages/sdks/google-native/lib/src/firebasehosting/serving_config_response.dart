...
class ServingConfigResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'i18n': pulumi.Input.mapInputValue<I18nConfigResponse, Map<String, dynamic>>(i18n, (value) => value.toMap()),
      'redirects': pulumi.Input.mapInputValue<List<RedirectResponse>, List<Map<String, dynamic>>>(redirects, (value) => pulumi.Input.encodeList<RedirectResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'rewrites': pulumi.Input.mapInputValue<List<RewriteResponse>, List<Map<String, dynamic>>>(rewrites, (value) => pulumi.Input.encodeList<RewriteResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory ServingConfigResponse.fromMap(Map<String, dynamic> map) {
    return ServingConfigResponse(
      appAssociation: (map['appAssociation'] as String).input(),
      cleanUrls: (map['cleanUrls'] as bool).input(),
      ...
      i18n: (I18nConfigResponse.fromMap((map['i18n'] as Map).cast<String, dynamic>())).input(),
      redirects: (pulumi.Input.decodeList<RedirectResponse>(map['redirects'], (value) => RedirectResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      rewrites: (pulumi.Input.decodeList<RewriteResponse>(map['rewrites'], (value) => RewriteResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      trailingSlashBehavior: (map['trailingSlashBehavior'] as String).input(),
    );
  }
}
