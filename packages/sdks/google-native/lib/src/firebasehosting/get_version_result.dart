...
class GetVersionResult {
  ...
  factory GetVersionResult.fromMap(Map<String, dynamic> map) {
    return GetVersionResult(
      config: ServingConfigResponse.fromMap((map['config']! as Map).cast<String, dynamic>()),
      createTime: map['createTime'] as String,
      createUser: ActingUserResponse.fromMap((map['createUser']! as Map).cast<String, dynamic>()),
      deleteTime: map['deleteTime'] as String,
      deleteUser: ActingUserResponse.fromMap((map['deleteUser']! as Map).cast<String, dynamic>()),
      fileCount: map['fileCount'] as String,
      finalizeTime: map['finalizeTime'] as String,
      finalizeUser: ActingUserResponse.fromMap((map['finalizeUser']! as Map).cast<String, dynamic>()),
