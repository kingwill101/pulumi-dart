...
class DomainProvisioningResponse {
  ...
  factory DomainProvisioningResponse.fromMap(Map<String, dynamic> map) {
    return DomainProvisioningResponse(
      certChallengeDiscoveredTxt: (map['certChallengeDiscoveredTxt'] as List).cast<String>(),
      certChallengeDns: CertDnsChallengeResponse.fromMap((map['certChallengeDns'] as Map).cast<String, dynamic>()),
      certChallengeHttp: CertHttpChallengeResponse.fromMap((map['certChallengeHttp'] as Map).cast<String, dynamic>()),
