...
class DomainRedirect {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'type': pulumi.Input.mapInputValue<DomainRedirectType, String>(type, (value) => value.wireValue),
    };
  }
  ...
  factory DomainRedirect.fromMap(Map<String, dynamic> map) {
    return DomainRedirect(
      ...
      type: pulumi.Input.fromValue(DomainRedirectType.fromValue(map['type']! as String)),
    );
  }
}
