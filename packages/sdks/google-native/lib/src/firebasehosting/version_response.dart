...
class VersionResponse {
  ...
  factory VersionResponse.fromMap(Map<String, dynamic> map) {
    return VersionResponse(
      config: (ServingConfigResponse.fromMap((map['config'] as Map).cast<String, dynamic>())).input(),
      createTime: (map['createTime'] as String).input(),
      createUser: (ActingUserResponse.fromMap((map['createUser'] as Map).cast<String, dynamic>())).input(),
      deleteTime: (map['deleteTime'] as String).input(),
      deleteUser: (ActingUserResponse.fromMap((map['deleteUser'] as Map).cast<String, dynamic>())).input(),
      fileCount: (map['fileCount'] as String).input(),
      finalizeTime: (map['finalizeTime'] as String).input(),
      finalizeUser: (ActingUserResponse.fromMap((map['finalizeUser'] as Map).cast<String, dynamic>())).input(),
      labels: ((map['labels'] as Map).cast<String, String>()).input(),
      name: (map['name'] as String).input(),
      status: (map['status'] as String).input(),
      versionBytes: (map['versionBytes'] as String).input(),
    );
  }
}
