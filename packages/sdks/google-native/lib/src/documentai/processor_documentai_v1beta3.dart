...
class ProcessorDocumentaiV1beta3 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<GoogleCloudDocumentaiV1beta3ProcessorVersionAliasResponse>> processorVersionAliases;
  ...
  ProcessorDocumentaiV1beta3(
    ...
    this.processorVersionAliases = registerOutput<List<GoogleCloudDocumentaiV1beta3ProcessorVersionAliasResponse>>('processorVersionAliases');
