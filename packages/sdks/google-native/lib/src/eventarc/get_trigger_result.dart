...
class GetTriggerResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'eventFilters': pulumi.Input.encodeList<EventFilterResponse, Map<String, dynamic>>(eventFilters, (value) => value.toMap()),
      'labels': labels,
      'name': name,
  ...
  factory GetTriggerResult.fromMap(Map<String, dynamic> map) {
    return GetTriggerResult(
      ...
      destination: DestinationResponse.fromMap((map['destination']! as Map).cast<String, dynamic>()),
      etag: map['etag'] as String,
      eventDataContentType: map['eventDataContentType'] as String,
      eventFilters: pulumi.Input.decodeList<EventFilterResponse>(map['eventFilters']!, (value) => EventFilterResponse.fromMap((value as Map).cast<String, dynamic>())),
      labels: (map['labels'] as Map).cast<String, String>(),
      name: map['name'] as String,
      serviceAccount: map['serviceAccount'] as String,
      transport: TransportResponse.fromMap((map['transport']! as Map).cast<String, dynamic>()),
