...
/// {@template pulumi_eventarc_v1_trigger_iam_binding_args_doc}
/// The set of arguments for TriggerIamBinding.
/// {@endtemplate}
/// {@macro pulumi_eventarc_v1_trigger_iam_binding_args_doc}
class TriggerIamBindingArgs {
  ...
  /// Creates a new [TriggerIamBindingArgs].
  ...
  factory TriggerIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return TriggerIamBindingArgs(
