...
/// {@template pulumi_eventarc_v1_channel_iam_binding_args_doc}
/// The set of arguments for ChannelIamBinding.
/// {@endtemplate}
/// {@macro pulumi_eventarc_v1_channel_iam_binding_args_doc}
class ChannelIamBindingArgs {
  ...
  /// Creates a new [ChannelIamBindingArgs].
  ...
  factory ChannelIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return ChannelIamBindingArgs(
