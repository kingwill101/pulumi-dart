...
class AuditLogConfigEventarcV1beta1 {
  ...
  const AuditLogConfigEventarcV1beta1({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'logType': ?pulumi.Input.mapOptionalInputValue<AuditLogConfigLogTypeEventarcV1beta1, String>(logType, (value) => value.wireValue),
    };
  }
  ...
  factory AuditLogConfigEventarcV1beta1.fromMap(Map<String, dynamic> map) {
    return AuditLogConfigEventarcV1beta1(
      ...
      logType: (() { final guardedValue = map['logType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AuditLogConfigLogTypeEventarcV1beta1.fromValue(guardedValue as String)); })(),
    );
  }
}
