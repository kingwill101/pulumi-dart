...
class TriggerEventarcV1beta1Args {
  ...
  const TriggerEventarcV1beta1Args({
  ...
  factory TriggerEventarcV1beta1Args.fromMap(Map<String, dynamic> map) {
    return TriggerEventarcV1beta1Args(
      destination: pulumi.Input.fromValue(DestinationEventarcV1beta1.fromMap((map['destination']! as Map).cast<String, dynamic>())),
      labels: (() { final guardedValue = map['labels']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      location: (() { final guardedValue = map['location']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      matchingCriteria: pulumi.Input.fromValue(pulumi.Input.decodeList<MatchingCriteria>(map['matchingCriteria']!, (value) => MatchingCriteria.fromMap((value as Map).cast<String, dynamic>()))),
