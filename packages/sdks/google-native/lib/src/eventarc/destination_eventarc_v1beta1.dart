...
class DestinationEventarcV1beta1 {
  ...
  const DestinationEventarcV1beta1({
  ...
  factory DestinationEventarcV1beta1.fromMap(Map<String, dynamic> map) {
    return DestinationEventarcV1beta1(
      cloudRunService: (() { final guardedValue = map['cloudRunService']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CloudRunService.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
