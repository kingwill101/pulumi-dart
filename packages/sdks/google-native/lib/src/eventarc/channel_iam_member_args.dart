...
/// {@template pulumi_eventarc_v1_channel_iam_member_args_doc}
/// The set of arguments for ChannelIamMember.
/// {@endtemplate}
/// {@macro pulumi_eventarc_v1_channel_iam_member_args_doc}
class ChannelIamMemberArgs {
  ...
  /// Creates a new [ChannelIamMemberArgs].
  ...
  factory ChannelIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return ChannelIamMemberArgs(
