...
class DestinationResponse {
  ...
  factory DestinationResponse.fromMap(Map<String, dynamic> map) {
    return DestinationResponse(
      ...
      cloudRun: pulumi.Input.fromValue(CloudRunResponse.fromMap((map['cloudRun']! as Map).cast<String, dynamic>())),
      gke: pulumi.Input.fromValue(GKEResponse.fromMap((map['gke']! as Map).cast<String, dynamic>())),
      httpEndpoint: pulumi.Input.fromValue(HttpEndpointResponse.fromMap((map['httpEndpoint']! as Map).cast<String, dynamic>())),
