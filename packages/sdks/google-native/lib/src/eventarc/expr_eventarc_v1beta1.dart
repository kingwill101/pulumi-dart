...
class ExprEventarcV1beta1 {
  ...
  /// Creates a new [ExprEventarcV1beta1].
  ...
  factory ExprEventarcV1beta1.fromMap(Map<String, dynamic> map) {
    return ExprEventarcV1beta1(
