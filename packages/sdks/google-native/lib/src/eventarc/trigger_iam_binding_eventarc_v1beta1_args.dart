...
/// {@template pulumi_eventarc_v1beta1_trigger_iam_binding_eventarc_v1beta1_args_doc}
/// The set of arguments for TriggerIamBinding.
/// {@endtemplate}
/// {@macro pulumi_eventarc_v1beta1_trigger_iam_binding_eventarc_v1beta1_args_doc}
class TriggerIamBindingEventarcV1beta1Args {
  ...
  /// Creates a new [TriggerIamBindingEventarcV1beta1Args].
  ...
  const TriggerIamBindingEventarcV1beta1Args({
    this.condition,
  ...
  factory TriggerIamBindingEventarcV1beta1Args.fromMap(Map<String, dynamic> map) {
    return TriggerIamBindingEventarcV1beta1Args(
