...
/// {@template pulumi_eventarc_v1_channel_connection_iam_binding_args_doc}
/// The set of arguments for ChannelConnectionIamBinding.
/// {@endtemplate}
/// {@macro pulumi_eventarc_v1_channel_connection_iam_binding_args_doc}
class ChannelConnectionIamBindingArgs {
  ...
  /// Creates a new [ChannelConnectionIamBindingArgs].
  ...
  const ChannelConnectionIamBindingArgs({
    this.condition,
  ...
  factory ChannelConnectionIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return ChannelConnectionIamBindingArgs(
