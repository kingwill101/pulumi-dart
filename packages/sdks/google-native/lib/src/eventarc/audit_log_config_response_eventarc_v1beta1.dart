...
class AuditLogConfigResponseEventarcV1beta1 {
  ...
  factory AuditLogConfigResponseEventarcV1beta1.fromMap(Map<String, dynamic> map) {
    return AuditLogConfigResponseEventarcV1beta1(
