...
class TransferJobArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'status': ?pulumi.Input.mapOptionalInputValue<TransferJobStatus, String>(
        status,
    ...
    return TransferJobArgs(
      ...
      eventStream: (() {
        ...
        return pulumi.Input.fromValue(
          EventStream.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      latestOperationName: (() {
        final guardedValue = map['latestOperationName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      loggingConfig: (() {
      ...
      status: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TransferJobStatus.fromValue(guardedValue as String),
        );
      })(),
      transferSpec: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TransferSpec.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
