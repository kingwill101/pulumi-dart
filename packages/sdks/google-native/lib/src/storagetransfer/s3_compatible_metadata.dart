...
class S3CompatibleMetadata {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'authMethod': ?pulumi.Input.mapOptionalInputValue<S3CompatibleMetadataAuthMethod, String>(authMethod, (value) => value.wireValue),
      'listApi': ?pulumi.Input.mapOptionalInputValue<S3CompatibleMetadataListApi, String>(listApi, (value) => value.wireValue),
      'protocol': ?pulumi.Input.mapOptionalInputValue<S3CompatibleMetadataProtocol, String>(protocol, (value) => value.wireValue),
      'requestModel': ?pulumi.Input.mapOptionalInputValue<S3CompatibleMetadataRequestModel, String>(requestModel, (value) => value.wireValue),
    };
  }

  factory S3CompatibleMetadata.fromMap(Map<String, dynamic> map) {
    return S3CompatibleMetadata(
      authMethod: (() { final guardedValue = map['authMethod']; if (guardedValue == null) return null; return pulumi.Input.fromValue(S3CompatibleMetadataAuthMethod.fromValue(guardedValue as String)); })(),
      listApi: (() { final guardedValue = map['listApi']; if (guardedValue == null) return null; return pulumi.Input.fromValue(S3CompatibleMetadataListApi.fromValue(guardedValue as String)); })(),
      protocol: (() { final guardedValue = map['protocol']; if (guardedValue == null) return null; return pulumi.Input.fromValue(S3CompatibleMetadataProtocol.fromValue(guardedValue as String)); })(),
      requestModel: (() { final guardedValue = map['requestModel']; if (guardedValue == null) return null; return pulumi.Input.fromValue(S3CompatibleMetadataRequestModel.fromValue(guardedValue as String)); })(),
    );
  }
}
