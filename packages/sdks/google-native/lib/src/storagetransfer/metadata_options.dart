...
class MetadataOptions {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'acl': ?pulumi.Input.mapOptionalInputValue<MetadataOptionsAcl, String>(acl, (value) => value.wireValue),
      'gid': ?pulumi.Input.mapOptionalInputValue<MetadataOptionsGid, String>(gid, (value) => value.wireValue),
      'kmsKey': ?pulumi.Input.mapOptionalInputValue<MetadataOptionsKmsKey, String>(kmsKey, (value) => value.wireValue),
      'mode': ?pulumi.Input.mapOptionalInputValue<MetadataOptionsMode, String>(mode, (value) => value.wireValue),
      'storageClass': ?pulumi.Input.mapOptionalInputValue<MetadataOptionsStorageClass, String>(storageClass, (value) => value.wireValue),
      'symlink': ?pulumi.Input.mapOptionalInputValue<MetadataOptionsSymlink, String>(symlink, (value) => value.wireValue),
      'temporaryHold': ?pulumi.Input.mapOptionalInputValue<MetadataOptionsTemporaryHold, String>(temporaryHold, (value) => value.wireValue),
      'timeCreated': ?pulumi.Input.mapOptionalInputValue<MetadataOptionsTimeCreated, String>(timeCreated, (value) => value.wireValue),
      'uid': ?pulumi.Input.mapOptionalInputValue<MetadataOptionsUid, String>(uid, (value) => value.wireValue),
    };
  }

  factory MetadataOptions.fromMap(Map<String, dynamic> map) {
    return MetadataOptions(
      acl: (() { final guardedValue = map['acl']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MetadataOptionsAcl.fromValue(guardedValue as String)); })(),
      gid: (() { final guardedValue = map['gid']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MetadataOptionsGid.fromValue(guardedValue as String)); })(),
      kmsKey: (() { final guardedValue = map['kmsKey']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MetadataOptionsKmsKey.fromValue(guardedValue as String)); })(),
      mode: (() { final guardedValue = map['mode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MetadataOptionsMode.fromValue(guardedValue as String)); })(),
      storageClass: (() { final guardedValue = map['storageClass']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MetadataOptionsStorageClass.fromValue(guardedValue as String)); })(),
      symlink: (() { final guardedValue = map['symlink']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MetadataOptionsSymlink.fromValue(guardedValue as String)); })(),
      temporaryHold: (() { final guardedValue = map['temporaryHold']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MetadataOptionsTemporaryHold.fromValue(guardedValue as String)); })(),
      timeCreated: (() { final guardedValue = map['timeCreated']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MetadataOptionsTimeCreated.fromValue(guardedValue as String)); })(),
      uid: (() { final guardedValue = map['uid']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MetadataOptionsUid.fromValue(guardedValue as String)); })(),
    );
  }
}
