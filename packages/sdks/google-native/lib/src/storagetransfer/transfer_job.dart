...
class TransferJob extends pulumi.CustomResource {
  ...
  TransferJob(
    ...
    eventStream = registerOutput<EventStreamResponse>('eventStream', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return EventStreamResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    transferSpec = registerOutput<TransferSpecResponse>('transferSpec', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return TransferSpecResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  }
}
