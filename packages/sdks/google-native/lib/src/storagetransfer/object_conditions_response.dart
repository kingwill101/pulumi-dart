...
class ObjectConditionsResponse {
  ...
  factory ObjectConditionsResponse.fromMap(Map<String, dynamic> map) {
    return ObjectConditionsResponse(
      excludePrefixes: ((map['excludePrefixes'] as List).cast<String>()).input(),
      includePrefixes: ((map['includePrefixes'] as List).cast<String>()).input(),
      lastModifiedBefore: (map['lastModifiedBefore'] as String).input(),
      lastModifiedSince: (map['lastModifiedSince'] as String).input(),
      maxTimeElapsedSinceLastModification: (map['maxTimeElapsedSinceLastModification'] as String).input(),
      minTimeElapsedSinceLastModification: (map['minTimeElapsedSinceLastModification'] as String).input(),
    );
  }
}
