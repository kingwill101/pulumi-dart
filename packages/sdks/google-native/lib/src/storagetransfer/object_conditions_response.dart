...
class ObjectConditionsResponse {
  ...
  factory ObjectConditionsResponse.fromMap(Map<String, dynamic> map) {
    return ObjectConditionsResponse(
      excludePrefixes: pulumi.Input.fromValue(
        (map['excludePrefixes'] as List).cast<String>(),
      ),
      includePrefixes: pulumi.Input.fromValue(
        (map['includePrefixes'] as List).cast<String>(),
      ),
      lastModifiedBefore: pulumi.Input.fromValue(
        map['lastModifiedBefore'] as String,
      ),
      lastModifiedSince: pulumi.Input.fromValue(
        map['lastModifiedSince'] as String,
      ),
      maxTimeElapsedSinceLastModification: pulumi.Input.fromValue(
        map['maxTimeElapsedSinceLastModification'] as String,
      ),
      minTimeElapsedSinceLastModification: pulumi.Input.fromValue(
