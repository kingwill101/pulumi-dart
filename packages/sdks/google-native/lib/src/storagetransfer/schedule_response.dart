...
class ScheduleResponse {
  ...
  final pulumi.Input<TimeOfDayResponse> endTimeOfDay;
  ...
  final pulumi.Input<DateResponse> scheduleEndDate;
  ...
  final pulumi.Input<DateResponse> scheduleStartDate;
  ...
  final pulumi.Input<TimeOfDayResponse> startTimeOfDay;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'endTimeOfDay': pulumi.Input.mapInputValue<TimeOfDayResponse, Map<String, dynamic>>(endTimeOfDay, (value) => value.toMap()),
      'repeatInterval': repeatInterval,
      'scheduleEndDate': pulumi.Input.mapInputValue<DateResponse, Map<String, dynamic>>(scheduleEndDate, (value) => value.toMap()),
      'scheduleStartDate': pulumi.Input.mapInputValue<DateResponse, Map<String, dynamic>>(scheduleStartDate, (value) => value.toMap()),
      'startTimeOfDay': pulumi.Input.mapInputValue<TimeOfDayResponse, Map<String, dynamic>>(startTimeOfDay, (value) => value.toMap()),
    };
  }

  factory ScheduleResponse.fromMap(Map<String, dynamic> map) {
    return ScheduleResponse(
      endTimeOfDay: pulumi.Input.fromValue(TimeOfDayResponse.fromMap((map['endTimeOfDay']! as Map).cast<String, dynamic>())),
      repeatInterval: pulumi.Input.fromValue(map['repeatInterval'] as String),
      scheduleEndDate: pulumi.Input.fromValue(DateResponse.fromMap((map['scheduleEndDate']! as Map).cast<String, dynamic>())),
      scheduleStartDate: pulumi.Input.fromValue(DateResponse.fromMap((map['scheduleStartDate']! as Map).cast<String, dynamic>())),
      startTimeOfDay: pulumi.Input.fromValue(TimeOfDayResponse.fromMap((map['startTimeOfDay']! as Map).cast<String, dynamic>())),
    );
  }
}
