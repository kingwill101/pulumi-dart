...
class ScheduleResponse {
  ...
  factory ScheduleResponse.fromMap(Map<String, dynamic> map) {
    return ScheduleResponse(
      endTimeOfDay: (TimeOfDayResponse.fromMap((map['endTimeOfDay'] as Map).cast<String, dynamic>())).input(),
      repeatInterval: (map['repeatInterval'] as String).input(),
      scheduleEndDate: (DateResponse.fromMap((map['scheduleEndDate'] as Map).cast<String, dynamic>())).input(),
      scheduleStartDate: (DateResponse.fromMap((map['scheduleStartDate'] as Map).cast<String, dynamic>())).input(),
      startTimeOfDay: (TimeOfDayResponse.fromMap((map['startTimeOfDay'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
