...
class AgentPoolArgs {
  ...
  factory AgentPoolArgs.fromMap(Map<String, dynamic> map) {
    return AgentPoolArgs(
      ...
      bandwidthLimit: (() { final guardedValue = map['bandwidthLimit']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BandwidthLimit.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
