...
class TransferSpec {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsS3DataSource':
          ?pulumi.Input.mapOptionalInputValue<AwsS3Data, Map<String, dynamic>>(
            awsS3DataSource,
            (value) => value.toMap(),
          ),
      ...
      'gcsDataSink':
          ?pulumi.Input.mapOptionalInputValue<GcsData, Map<String, dynamic>>(
            gcsDataSink,
            (value) => value.toMap(),
          ),
      'gcsDataSource':
      ...
      'httpDataSource':
          ?pulumi.Input.mapOptionalInputValue<HttpData, Map<String, dynamic>>(
            httpDataSource,
            (value) => value.toMap(),
          ),
      'objectConditions':
  ...
  factory TransferSpec.fromMap(Map<String, dynamic> map) {
    return TransferSpec(
      ...
      awsS3DataSource: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AwsS3Data.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      azureBlobStorageDataSource: (() {
      ...
      gcsDataSink: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GcsData.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      gcsDataSource: (() {
      ...
      gcsIntermediateDataLocation: (() {
        final guardedValue = map['gcsIntermediateDataLocation'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GcsData.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      ...
      httpDataSource: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          HttpData.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      objectConditions: (() {
