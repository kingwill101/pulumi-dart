...
class TransferSpec {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'gcsIntermediateDataLocation': ?gcsIntermediateDataLocation == null ? null : gcsIntermediateDataLocation!.toMap(),
  ...
  factory TransferSpec.fromMap(Map<String, dynamic> map) {
    return TransferSpec(
      awsS3CompatibleDataSource: map['awsS3CompatibleDataSource'] == null ? null : AwsS3CompatibleData.fromMap((map['awsS3CompatibleDataSource'] as Map).cast<String, dynamic>()),
      awsS3DataSource: map['awsS3DataSource'] == null ? null : AwsS3Data.fromMap((map['awsS3DataSource'] as Map).cast<String, dynamic>()),
      azureBlobStorageDataSource: map['azureBlobStorageDataSource'] == null ? null : AzureBlobStorageData.fromMap((map['azureBlobStorageDataSource'] as Map).cast<String, dynamic>()),
      gcsDataSink: map['gcsDataSink'] == null ? null : GcsData.fromMap((map['gcsDataSink'] as Map).cast<String, dynamic>()),
      gcsDataSource: map['gcsDataSource'] == null ? null : GcsData.fromMap((map['gcsDataSource'] as Map).cast<String, dynamic>()),
      gcsIntermediateDataLocation: map['gcsIntermediateDataLocation'] == null ? null : GcsData.fromMap((map['gcsIntermediateDataLocation'] as Map).cast<String, dynamic>()),
      httpDataSource: map['httpDataSource'] == null ? null : HttpData.fromMap((map['httpDataSource'] as Map).cast<String, dynamic>()),
      objectConditions: map['objectConditions'] == null ? null : ObjectConditions.fromMap((map['objectConditions'] as Map).cast<String, dynamic>()),
      posixDataSink: map['posixDataSink'] == null ? null : PosixFilesystem.fromMap((map['posixDataSink'] as Map).cast<String, dynamic>()),
      posixDataSource: map['posixDataSource'] == null ? null : PosixFilesystem.fromMap((map['posixDataSource'] as Map).cast<String, dynamic>()),
      ...
      transferManifest: map['transferManifest'] == null ? null : TransferManifest.fromMap((map['transferManifest'] as Map).cast<String, dynamic>()),
      transferOptions: map['transferOptions'] == null ? null : TransferOptions.fromMap((map['transferOptions'] as Map).cast<String, dynamic>()),
    );
  }
}
