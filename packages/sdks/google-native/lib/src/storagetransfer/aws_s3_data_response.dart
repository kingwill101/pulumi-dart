...
import 'aws_access_key_response.dart';

/// An AwsS3Data resource can be a data source, but not a data sink. In an AwsS3Data resource, an object's name is the S3 object's key name.
class AwsS3DataResponse {
  ...
  final pulumi.Input<AwsAccessKeyResponse> awsAccessKey;
  ...
  /// Creates a new [AwsS3DataResponse].
  ...
  const AwsS3DataResponse({
    required this.awsAccessKey,
    required this.bucketName,
    required this.cloudfrontDomain,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'awsAccessKey': pulumi.Input.mapInputValue<AwsAccessKeyResponse, Map<String, dynamic>>(awsAccessKey, (value) => value.toMap()),
  ...
  factory AwsS3DataResponse.fromMap(Map<String, dynamic> map) {
    return AwsS3DataResponse(
      awsAccessKey: pulumi.Input.fromValue(AwsAccessKeyResponse.fromMap((map['awsAccessKey']! as Map).cast<String, dynamic>())),
      bucketName: pulumi.Input.fromValue(map['bucketName'] as String),
      cloudfrontDomain: pulumi.Input.fromValue(map['cloudfrontDomain'] as String),
