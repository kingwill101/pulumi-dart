...
class AwsS3DataResponse {
  ...
  factory AwsS3DataResponse.fromMap(Map<String, dynamic> map) {
    return AwsS3DataResponse(
      awsAccessKey: (AwsAccessKeyResponse.fromMap((map['awsAccessKey'] as Map).cast<String, dynamic>())).input(),
      bucketName: (map['bucketName'] as String).input(),
      cloudfrontDomain: (map['cloudfrontDomain'] as String).input(),
      credentialsSecret: (map['credentialsSecret'] as String).input(),
