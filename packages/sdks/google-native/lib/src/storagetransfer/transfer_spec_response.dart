...
class TransferSpecResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsS3DataSource':
          pulumi.Input.mapInputValue<AwsS3DataResponse, Map<String, dynamic>>(
            awsS3DataSource,
            (value) => value.toMap(),
          ),
      ...
      'gcsDataSink':
          pulumi.Input.mapInputValue<GcsDataResponse, Map<String, dynamic>>(
            gcsDataSink,
            (value) => value.toMap(),
          ),
      'gcsDataSource':
      ...
      'httpDataSource':
          pulumi.Input.mapInputValue<HttpDataResponse, Map<String, dynamic>>(
            httpDataSource,
            (value) => value.toMap(),
          ),
      'objectConditions':
  ...
  factory TransferSpecResponse.fromMap(Map<String, dynamic> map) {
    return TransferSpecResponse(
      awsS3CompatibleDataSource: pulumi.Input.fromValue(
        AwsS3CompatibleDataResponse.fromMap(
          (map['awsS3CompatibleDataSource']! as Map).cast<String, dynamic>(),
        ),
      ),
      awsS3DataSource: pulumi.Input.fromValue(
        AwsS3DataResponse.fromMap(
          (map['awsS3DataSource']! as Map).cast<String, dynamic>(),
        ),
      ),
      azureBlobStorageDataSource: pulumi.Input.fromValue(
        AzureBlobStorageDataResponse.fromMap(
          (map['azureBlobStorageDataSource']! as Map).cast<String, dynamic>(),
        ),
      ),
      gcsDataSink: pulumi.Input.fromValue(
        GcsDataResponse.fromMap(
          (map['gcsDataSink']! as Map).cast<String, dynamic>(),
        ),
      ),
      gcsDataSource: pulumi.Input.fromValue(
        GcsDataResponse.fromMap(
          (map['gcsDataSource']! as Map).cast<String, dynamic>(),
        ),
      ),
      gcsIntermediateDataLocation: pulumi.Input.fromValue(
        GcsDataResponse.fromMap(
          (map['gcsIntermediateDataLocation']! as Map).cast<String, dynamic>(),
        ),
      ),
      httpDataSource: pulumi.Input.fromValue(
        HttpDataResponse.fromMap(
          (map['httpDataSource']! as Map).cast<String, dynamic>(),
        ),
      ),
      objectConditions: pulumi.Input.fromValue(
        ObjectConditionsResponse.fromMap(
          (map['objectConditions']! as Map).cast<String, dynamic>(),
        ),
      ),
      posixDataSink: pulumi.Input.fromValue(
        PosixFilesystemResponse.fromMap(
          (map['posixDataSink']! as Map).cast<String, dynamic>(),
        ),
      ),
      posixDataSource: pulumi.Input.fromValue(
        PosixFilesystemResponse.fromMap(
          (map['posixDataSource']! as Map).cast<String, dynamic>(),
        ),
      ),
      sinkAgentPoolName: pulumi.Input.fromValue(
        map['sinkAgentPoolName'] as String,
      ),
      sourceAgentPoolName: pulumi.Input.fromValue(
        map['sourceAgentPoolName'] as String,
      ),
      transferManifest: pulumi.Input.fromValue(
        TransferManifestResponse.fromMap(
          (map['transferManifest']! as Map).cast<String, dynamic>(),
        ),
      ),
      transferOptions: pulumi.Input.fromValue(
        TransferOptionsResponse.fromMap(
