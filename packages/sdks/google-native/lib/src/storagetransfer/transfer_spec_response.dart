...
class TransferSpecResponse {
  ...
  factory TransferSpecResponse.fromMap(Map<String, dynamic> map) {
    return TransferSpecResponse(
      awsS3CompatibleDataSource: (AwsS3CompatibleDataResponse.fromMap((map['awsS3CompatibleDataSource'] as Map).cast<String, dynamic>())).input(),
      awsS3DataSource: (AwsS3DataResponse.fromMap((map['awsS3DataSource'] as Map).cast<String, dynamic>())).input(),
      azureBlobStorageDataSource: (AzureBlobStorageDataResponse.fromMap((map['azureBlobStorageDataSource'] as Map).cast<String, dynamic>())).input(),
      gcsDataSink: (GcsDataResponse.fromMap((map['gcsDataSink'] as Map).cast<String, dynamic>())).input(),
      gcsDataSource: (GcsDataResponse.fromMap((map['gcsDataSource'] as Map).cast<String, dynamic>())).input(),
      gcsIntermediateDataLocation: (GcsDataResponse.fromMap((map['gcsIntermediateDataLocation'] as Map).cast<String, dynamic>())).input(),
      httpDataSource: (HttpDataResponse.fromMap((map['httpDataSource'] as Map).cast<String, dynamic>())).input(),
      objectConditions: (ObjectConditionsResponse.fromMap((map['objectConditions'] as Map).cast<String, dynamic>())).input(),
      posixDataSink: (PosixFilesystemResponse.fromMap((map['posixDataSink'] as Map).cast<String, dynamic>())).input(),
      posixDataSource: (PosixFilesystemResponse.fromMap((map['posixDataSource'] as Map).cast<String, dynamic>())).input(),
      sinkAgentPoolName: (map['sinkAgentPoolName'] as String).input(),
      sourceAgentPoolName: (map['sourceAgentPoolName'] as String).input(),
      transferManifest: (TransferManifestResponse.fromMap((map['transferManifest'] as Map).cast<String, dynamic>())).input(),
      transferOptions: (TransferOptionsResponse.fromMap((map['transferOptions'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
