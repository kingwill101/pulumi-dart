...
class TransferOptionsResponse {
  ...
  factory TransferOptionsResponse.fromMap(Map<String, dynamic> map) {
    return TransferOptionsResponse(
      deleteObjectsFromSourceAfterTransfer: (map['deleteObjectsFromSourceAfterTransfer'] as bool).input(),
      deleteObjectsUniqueInSink: (map['deleteObjectsUniqueInSink'] as bool).input(),
      metadataOptions: (MetadataOptionsResponse.fromMap((map['metadataOptions'] as Map).cast<String, dynamic>())).input(),
      overwriteObjectsAlreadyExistingInSink: (map['overwriteObjectsAlreadyExistingInSink'] as bool).input(),
      overwriteWhen: (map['overwriteWhen'] as String).input(),
    );
  }
}
