...
class TransferOptionsResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'metadataOptions': pulumi.Input.mapInputValue<MetadataOptionsResponse, Map<String, dynamic>>(metadataOptions, (value) => value.toMap()),
  ...
  factory TransferOptionsResponse.fromMap(Map<String, dynamic> map) {
    return TransferOptionsResponse(
      deleteObjectsFromSourceAfterTransfer: pulumi.Input.fromValue(map['deleteObjectsFromSourceAfterTransfer'] as bool),
      deleteObjectsUniqueInSink: pulumi.Input.fromValue(map['deleteObjectsUniqueInSink'] as bool),
      metadataOptions: pulumi.Input.fromValue(MetadataOptionsResponse.fromMap((map['metadataOptions']! as Map).cast<String, dynamic>())),
      overwriteObjectsAlreadyExistingInSink: pulumi.Input.fromValue(map['overwriteObjectsAlreadyExistingInSink'] as bool),
