...
class GetTransferJobResult {
  ...
  factory GetTransferJobResult.fromMap(Map<String, dynamic> map) {
    return GetTransferJobResult(
      ...
      eventStream: EventStreamResponse.fromMap((map['eventStream']! as Map).cast<String, dynamic>()),
      ...
      transferSpec: TransferSpecResponse.fromMap((map['transferSpec']! as Map).cast<String, dynamic>()),
    );
  }
}
