...
class LoggingConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'logActionStates': ?pulumi.Input.mapOptionalInputValue<List<LoggingConfigLogActionStatesItem>, List<String>>(logActionStates, (value) => pulumi.Input.encodeList<LoggingConfigLogActionStatesItem, String>(value, (value) => value.value)),
      'logActions': ?pulumi.Input.mapOptionalInputValue<List<LoggingConfigLogActionsItem>, List<String>>(logActions, (value) => pulumi.Input.encodeList<LoggingConfigLogActionsItem, String>(value, (value) => value.value)),
    };
  }
