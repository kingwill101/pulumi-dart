...
class LoggingConfigResponse {
  ...
  factory LoggingConfigResponse.fromMap(Map<String, dynamic> map) {
    return LoggingConfigResponse(
      enableOnpremGcsTransferLogs: pulumi.Input.fromValue(map['enableOnpremGcsTransferLogs'] as bool),
      logActionStates: pulumi.Input.fromValue((map['logActionStates'] as List).cast<String>()),
      logActions: pulumi.Input.fromValue((map['logActions'] as List).cast<String>()),
    );
  }
}
