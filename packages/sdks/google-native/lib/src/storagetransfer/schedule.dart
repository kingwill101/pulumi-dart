...
class Schedule {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'endTimeOfDay':
          ?pulumi.Input.mapOptionalInputValue<TimeOfDay, Map<String, dynamic>>(
            endTimeOfDay,
            (value) => value.toMap(),
          ),
      ...
      'scheduleStartDate':
          pulumi.Input.mapInputValue<Date, Map<String, dynamic>>(
            scheduleStartDate,
            (value) => value.toMap(),
          ),
      'startTimeOfDay':
  ...
  factory Schedule.fromMap(Map<String, dynamic> map) {
    return Schedule(
      endTimeOfDay: (() {
        final guardedValue = map['endTimeOfDay'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TimeOfDay.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      repeatInterval: (() {
      ...
      scheduleEndDate: (() {
        final guardedValue = map['scheduleEndDate'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          Date.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      scheduleStartDate: pulumi.Input.fromValue(
        Date.fromMap(
          (map['scheduleStartDate']! as Map).cast<String, dynamic>(),
        ),
      ),
      startTimeOfDay: (() {
        final guardedValue = map['startTimeOfDay'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TimeOfDay.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
