...
class Filter {
  ...
  factory Filter.fromMap(Map<String, dynamic> map) {
    return Filter(
      compositeFilter: (() { final guardedValue = map['compositeFilter']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CompositeFilter.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      valueFilter: (() { final guardedValue = map['valueFilter']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ValueFilter.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
