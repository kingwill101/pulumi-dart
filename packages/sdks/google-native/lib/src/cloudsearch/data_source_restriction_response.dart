...
class DataSourceRestrictionResponse {
  ...
  const DataSourceRestrictionResponse({
  ...
  factory DataSourceRestrictionResponse.fromMap(Map<String, dynamic> map) {
    return DataSourceRestrictionResponse(
      filterOptions: pulumi.Input.fromValue(pulumi.Input.decodeList<FilterOptionsResponse>(map['filterOptions']!, (value) => FilterOptionsResponse.fromMap((value as Map).cast<String, dynamic>()))),
