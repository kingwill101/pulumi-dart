...
class GetDataSourceResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'itemsVisibility': pulumi.Input.encodeList<GSuitePrincipalResponse, Map<String, dynamic>>(itemsVisibility, (value) => value.toMap()),
      'name': name,
  ...
  factory GetDataSourceResult.fromMap(Map<String, dynamic> map) {
    return GetDataSourceResult(
      ...
      indexingServiceAccounts: (map['indexingServiceAccounts'] as List).cast<String>(),
      itemsVisibility: pulumi.Input.decodeList<GSuitePrincipalResponse>(map['itemsVisibility']!, (value) => GSuitePrincipalResponse.fromMap((value as Map).cast<String, dynamic>())),
