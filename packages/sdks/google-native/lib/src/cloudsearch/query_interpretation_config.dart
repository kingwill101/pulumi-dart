...
class QueryInterpretationConfig {
  ...
  factory QueryInterpretationConfig.fromMap(Map<String, dynamic> map) {
    return QueryInterpretationConfig(
      forceDisableSupplementalResults: map['forceDisableSupplementalResults'] == null ? null : map['forceDisableSupplementalResults'] as bool,
      forceVerbatimMode: map['forceVerbatimMode'] == null ? null : map['forceVerbatimMode'] as bool,
    );
  }
}
