...
class Source {
  ...
  Source({this.name, this.predefinedSource});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'name': ?name,
      'predefinedSource':
          ?pulumi.Input.mapOptionalInputValue<SourcePredefinedSource, String>(
            predefinedSource,
  ...
  factory Source.fromMap(Map<String, dynamic> map) {
    return Source(
      ...
      predefinedSource: (() {
        final guardedValue = map['predefinedSource'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SourcePredefinedSource.fromValue(guardedValue as String),
        );
      })(),
    );
  }
