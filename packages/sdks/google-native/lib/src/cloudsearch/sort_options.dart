...
class SortOptions {
  ...
  SortOptions({this.operatorName, this.sortOrder});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'operatorName': ?operatorName,
      'sortOrder':
          ?pulumi.Input.mapOptionalInputValue<SortOptionsSortOrder, String>(
            sortOrder,
  ...
  factory SortOptions.fromMap(Map<String, dynamic> map) {
    return SortOptions(
      operatorName: (() {
        final guardedValue = map['operatorName'];
      ...
      sortOrder: (() {
        ...
        return pulumi.Input.fromValue(
          SortOptionsSortOrder.fromValue(guardedValue as String),
        );
      })(),
    );
  }
