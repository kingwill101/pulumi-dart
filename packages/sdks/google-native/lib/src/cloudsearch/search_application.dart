...
class SearchApplication extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<DataSourceRestrictionResponse>> dataSourceRestrictions;
  ...
  SearchApplication(
    ...
    this.dataSourceRestrictions = registerOutput<List<DataSourceRestrictionResponse>>('dataSourceRestrictions');
    this.defaultFacetOptions = registerOutput<List<FacetOptionsResponse>>('defaultFacetOptions');
    this.defaultSortOptions = registerOutput<SortOptionsResponse>('defaultSortOptions');
    ...
    this.queryInterpretationConfig = registerOutput<QueryInterpretationConfigResponse>('queryInterpretationConfig');
    this.returnResultThumbnailUrls = registerOutput<bool>('returnResultThumbnailUrls');
    this.scoringConfig = registerOutput<ScoringConfigResponse>('scoringConfig');
    this.sourceConfig = registerOutput<List<SourceConfigResponse>>('sourceConfig');
  }
}
