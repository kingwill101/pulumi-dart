  ...
  factory DataSourceArgs.fromMap(Map<String, dynamic> map) {
    return DataSourceArgs(
      disableModifications: (() {
        final guardedValue = map['disableModifications'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      disableServing: (() {
        final guardedValue = map['disableServing'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      displayName: pulumi.Input.fromValue(map['displayName'] as String),
      indexingServiceAccounts: (() {
        final guardedValue = map['indexingServiceAccounts'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      itemsVisibility: (() {
        final guardedValue = map['itemsVisibility'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GSuitePrincipal>(
            guardedValue,
            (value) =>
                GSuitePrincipal.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      name: (() {
      ...
      operationIds: (() {
        final guardedValue = map['operationIds'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      returnThumbnailUrls: (() {
        final guardedValue = map['returnThumbnailUrls'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      shortName: (() {
