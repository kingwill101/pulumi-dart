...
class ValueFilter {
  ...
  factory ValueFilter.fromMap(Map<String, dynamic> map) {
    return ValueFilter(
      ...
      value: (() { final guardedValue = map['value']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Value.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
