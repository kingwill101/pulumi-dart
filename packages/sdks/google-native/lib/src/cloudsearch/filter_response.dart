...
class FilterResponse {
  ...
  factory FilterResponse.fromMap(Map<String, dynamic> map) {
    return FilterResponse(
      compositeFilter: (CompositeFilterResponse.fromMap((map['compositeFilter'] as Map).cast<String, dynamic>())).input(),
      valueFilter: (ValueFilterResponse.fromMap((map['valueFilter'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
