...
class ScoringConfig {
  ...
  factory ScoringConfig.fromMap(Map<String, dynamic> map) {
    return ScoringConfig(
      disableFreshness: (() { final guardedValue = map['disableFreshness']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      disablePersonalization: (() { final guardedValue = map['disablePersonalization']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
    );
  }
}
