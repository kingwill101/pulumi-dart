...
class GoogleTypeDateResponsePolicysimulatorV1beta1 {
  ...
  /// Creates a new [GoogleTypeDateResponsePolicysimulatorV1beta1].
  ...
  const GoogleTypeDateResponsePolicysimulatorV1beta1({
    required this.day,
    required this.month,
    required this.year,
  });
  ...
  factory GoogleTypeDateResponsePolicysimulatorV1beta1.fromMap(Map<String, dynamic> map) {
    return GoogleTypeDateResponsePolicysimulatorV1beta1(
