...
class GetFolderReplayResult {
  ...
  /// Creates a new [GetFolderReplayResult].
  ...
  factory GetFolderReplayResult.fromMap(Map<String, dynamic> map) {
    return GetFolderReplayResult(
      config: GoogleCloudPolicysimulatorV1ReplayConfigResponse.fromMap(
        (map['config']! as Map).cast<String, dynamic>(),
      ),
      name: map['name'] as String,
      resultsSummary:
          GoogleCloudPolicysimulatorV1ReplayResultsSummaryResponse.fromMap(
