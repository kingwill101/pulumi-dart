...
class GoogleCloudPolicysimulatorV1ReplayConfig {
  ...
  /// Creates a new [GoogleCloudPolicysimulatorV1ReplayConfig].
  ...
  const GoogleCloudPolicysimulatorV1ReplayConfig({
    this.logSource,
    this.policyOverlay,
  });
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'logSource': ?pulumi.Input.mapOptionalInputValue<GoogleCloudPolicysimulatorV1ReplayConfigLogSource, String>(logSource, (value) => value.wireValue),
  ...
  factory GoogleCloudPolicysimulatorV1ReplayConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudPolicysimulatorV1ReplayConfig(
      logSource: (() { final guardedValue = map['logSource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudPolicysimulatorV1ReplayConfigLogSource.fromValue(guardedValue as String)); })(),
