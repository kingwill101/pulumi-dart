...
class GoogleCloudPolicysimulatorV1betaReplayConfigResponse {
  ...
  /// Creates a new [GoogleCloudPolicysimulatorV1betaReplayConfigResponse].
  ...
  factory GoogleCloudPolicysimulatorV1betaReplayConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudPolicysimulatorV1betaReplayConfigResponse(
