...
class GoogleCloudPolicysimulatorV1betaReplayConfig {
  ...
  final pulumi.Input<GoogleCloudPolicysimulatorV1betaReplayConfigLogSource>? logSource;
  ...
  const GoogleCloudPolicysimulatorV1betaReplayConfig({
    this.logSource,
    this.policyOverlay,
  });
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'logSource': ?pulumi.Input.mapOptionalInputValue<GoogleCloudPolicysimulatorV1betaReplayConfigLogSource, String>(logSource, (value) => value.wireValue),
  ...
  factory GoogleCloudPolicysimulatorV1betaReplayConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudPolicysimulatorV1betaReplayConfig(
      logSource: (() { final guardedValue = map['logSource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudPolicysimulatorV1betaReplayConfigLogSource.fromValue(guardedValue as String)); })(),
