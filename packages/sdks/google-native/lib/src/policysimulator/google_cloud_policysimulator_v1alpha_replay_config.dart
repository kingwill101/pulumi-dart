...
class GoogleCloudPolicysimulatorV1alphaReplayConfig {
  ...
  final pulumi.Input<GoogleCloudPolicysimulatorV1alphaReplayConfigLogSource>?
  logSource;
  ...
  factory GoogleCloudPolicysimulatorV1alphaReplayConfig.fromMap(
    ...
    return GoogleCloudPolicysimulatorV1alphaReplayConfig(
      logSource: (() {
        ...
        return pulumi.Input.fromValue(
          GoogleCloudPolicysimulatorV1alphaReplayConfigLogSource.fromValue(
