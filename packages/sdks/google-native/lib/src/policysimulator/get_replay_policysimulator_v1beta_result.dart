...
class GetReplayPolicysimulatorV1betaResult {
  ...
  /// Creates a new [GetReplayPolicysimulatorV1betaResult].
  ...
  const GetReplayPolicysimulatorV1betaResult({
  ...
  factory GetReplayPolicysimulatorV1betaResult.fromMap(Map<String, dynamic> map) {
