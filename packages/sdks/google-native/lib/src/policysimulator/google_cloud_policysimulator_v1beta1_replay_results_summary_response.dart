...
class GoogleCloudPolicysimulatorV1beta1ReplayResultsSummaryResponse {
  ...
  final GoogleTypeDateResponsePolicysimulatorV1beta1 newestDate;
  /// The date of the oldest log entry replayed.
  final GoogleTypeDateResponsePolicysimulatorV1beta1 oldestDate;
  ...
  factory GoogleCloudPolicysimulatorV1beta1ReplayResultsSummaryResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudPolicysimulatorV1beta1ReplayResultsSummaryResponse(
      ...
      newestDate: GoogleTypeDateResponsePolicysimulatorV1beta1.fromMap((map['newestDate'] as Map).cast<String, dynamic>()),
      oldestDate: GoogleTypeDateResponsePolicysimulatorV1beta1.fromMap((map['oldestDate'] as Map).cast<String, dynamic>()),
