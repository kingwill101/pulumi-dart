...
class GoogleCloudPolicysimulatorV1betaReplayResultsSummaryResponse {
  ...
  factory GoogleCloudPolicysimulatorV1betaReplayResultsSummaryResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudPolicysimulatorV1betaReplayResultsSummaryResponse(
      ...
      newestDate: pulumi.Input.fromValue(GoogleTypeDateResponsePolicysimulatorV1beta.fromMap((map['newestDate']! as Map).cast<String, dynamic>())),
      oldestDate: pulumi.Input.fromValue(GoogleTypeDateResponsePolicysimulatorV1beta.fromMap((map['oldestDate']! as Map).cast<String, dynamic>())),
