...
class OSPolicyAssignmentInstanceFilterInventoryResponseOsconfigV1alpha {
  /// The OS short name
  ...
  factory OSPolicyAssignmentInstanceFilterInventoryResponseOsconfigV1alpha.fromMap(Map<String, dynamic> map) {
    return OSPolicyAssignmentInstanceFilterInventoryResponseOsconfigV1alpha(
