...
class ExecStepConfigOsconfigV1beta {
  ...
  const ExecStepConfigOsconfigV1beta({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'interpreter': ?pulumi.Input.mapOptionalInputValue<ExecStepConfigInterpreterOsconfigV1beta, String>(interpreter, (value) => value.wireValue),
      'localPath': ?localPath,
    };
  }
  ...
  factory ExecStepConfigOsconfigV1beta.fromMap(Map<String, dynamic> map) {
    return ExecStepConfigOsconfigV1beta(
      ...
      gcsObject: (() { final guardedValue = map['gcsObject']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GcsObjectOsconfigV1beta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      interpreter: (() { final guardedValue = map['interpreter']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ExecStepConfigInterpreterOsconfigV1beta.fromValue(guardedValue as String)); })(),
