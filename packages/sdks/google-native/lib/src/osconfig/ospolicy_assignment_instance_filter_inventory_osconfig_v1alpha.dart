...
class OSPolicyAssignmentInstanceFilterInventoryOsconfigV1alpha {
  ...
  /// Creates a new [OSPolicyAssignmentInstanceFilterInventoryOsconfigV1alpha].
  ...
  const OSPolicyAssignmentInstanceFilterInventoryOsconfigV1alpha({
  ...
  factory OSPolicyAssignmentInstanceFilterInventoryOsconfigV1alpha.fromMap(Map<String, dynamic> map) {
