...
class OSPolicyResourceResponseOsconfigV1alpha {
  ...
  factory OSPolicyResourceResponseOsconfigV1alpha.fromMap(Map<String, dynamic> map) {
    return OSPolicyResourceResponseOsconfigV1alpha(
      exec: (OSPolicyResourceExecResourceResponseOsconfigV1alpha.fromMap((map['exec'] as Map).cast<String, dynamic>())).input(),
      file: (OSPolicyResourceFileResourceResponseOsconfigV1alpha.fromMap((map['file'] as Map).cast<String, dynamic>())).input(),
      pkg: (OSPolicyResourcePackageResourceResponseOsconfigV1alpha.fromMap((map['pkg'] as Map).cast<String, dynamic>())).input(),
      repository: (OSPolicyResourceRepositoryResourceResponseOsconfigV1alpha.fromMap((map['repository'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
