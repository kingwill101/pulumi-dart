...
class OSPolicyResourceResponseOsconfigV1alpha {
  ...
  /// Package resource
  final pulumi.Input<OSPolicyResourcePackageResourceResponseOsconfigV1alpha>
  pkg;

  /// Package repository resource
  final pulumi.Input<OSPolicyResourceRepositoryResourceResponseOsconfigV1alpha>
  repository;
  ...
  factory OSPolicyResourceResponseOsconfigV1alpha.fromMap(
    ...
    return OSPolicyResourceResponseOsconfigV1alpha(
      exec: pulumi.Input.fromValue(
        OSPolicyResourceExecResourceResponseOsconfigV1alpha.fromMap(
          (map['exec']! as Map).cast<String, dynamic>(),
        ),
      ),
      file: pulumi.Input.fromValue(
        OSPolicyResourceFileResourceResponseOsconfigV1alpha.fromMap(
          (map['file']! as Map).cast<String, dynamic>(),
        ),
      ),
      pkg: pulumi.Input.fromValue(
        OSPolicyResourcePackageResourceResponseOsconfigV1alpha.fromMap(
