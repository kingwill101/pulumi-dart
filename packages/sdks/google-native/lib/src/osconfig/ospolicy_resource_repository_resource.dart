...
class OSPolicyResourceRepositoryResource {
  ...
  const OSPolicyResourceRepositoryResource({
    this.apt,
    this.goo,
    this.yum,
    this.zypper,
  ...
  factory OSPolicyResourceRepositoryResource.fromMap(Map<String, dynamic> map) {
    return OSPolicyResourceRepositoryResource(
      apt: (() { final guardedValue = map['apt']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OSPolicyResourceRepositoryResourceAptRepository.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      goo: (() { final guardedValue = map['goo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OSPolicyResourceRepositoryResourceGooRepository.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      yum: (() { final guardedValue = map['yum']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OSPolicyResourceRepositoryResourceYumRepository.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      zypper: (() { final guardedValue = map['zypper']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OSPolicyResourceRepositoryResourceZypperRepository.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
