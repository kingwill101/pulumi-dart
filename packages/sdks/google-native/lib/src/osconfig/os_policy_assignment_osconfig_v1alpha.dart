...
class OsPolicyAssignmentOsconfigV1alpha extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<OSPolicyResponseOsconfigV1alpha>> osPolicies;
  ...
  OsPolicyAssignmentOsconfigV1alpha(
    ...
    this.instanceFilter = registerOutput<OSPolicyAssignmentInstanceFilterResponseOsconfigV1alpha>('instanceFilter');
    this.location = registerOutput<String>('location');
    this.name = registerOutput<String>('name');
    this.osPolicies = registerOutput<List<OSPolicyResponseOsconfigV1alpha>>('osPolicies');
    ...
    this.rollout = registerOutput<OSPolicyAssignmentRolloutResponseOsconfigV1alpha>('rollout');
