...
class OsPolicyAssignmentOsconfigV1alpha extends pulumi.CustomResource {
  ...
  late final pulumi.Output<OSPolicyAssignmentInstanceFilterResponseOsconfigV1alpha> instanceFilter;
  ...
  late final pulumi.Output<OSPolicyAssignmentRolloutResponseOsconfigV1alpha> rollout;
  ...
  OsPolicyAssignmentOsconfigV1alpha(
    ...
    instanceFilter = registerOutput<OSPolicyAssignmentInstanceFilterResponseOsconfigV1alpha>('instanceFilter', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return OSPolicyAssignmentInstanceFilterResponseOsconfigV1alpha.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    rollout = registerOutput<OSPolicyAssignmentRolloutResponseOsconfigV1alpha>('rollout', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return OSPolicyAssignmentRolloutResponseOsconfigV1alpha.fromMap((guardedValue as Map).cast<String, dynamic>()); });
