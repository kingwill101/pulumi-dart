...
class OSPolicyResourcePackageResourceResponse {
  ...
  factory OSPolicyResourcePackageResourceResponse.fromMap(Map<String, dynamic> map) {
    return OSPolicyResourcePackageResourceResponse(
      apt: pulumi.Input.fromValue(OSPolicyResourcePackageResourceAPTResponse.fromMap((map['apt']! as Map).cast<String, dynamic>())),
      deb: pulumi.Input.fromValue(OSPolicyResourcePackageResourceDebResponse.fromMap((map['deb']! as Map).cast<String, dynamic>())),
      desiredState: pulumi.Input.fromValue(map['desiredState'] as String),
      googet: pulumi.Input.fromValue(OSPolicyResourcePackageResourceGooGetResponse.fromMap((map['googet']! as Map).cast<String, dynamic>())),
      msi: pulumi.Input.fromValue(OSPolicyResourcePackageResourceMSIResponse.fromMap((map['msi']! as Map).cast<String, dynamic>())),
      rpm: pulumi.Input.fromValue(OSPolicyResourcePackageResourceRPMResponse.fromMap((map['rpm']! as Map).cast<String, dynamic>())),
      yum: pulumi.Input.fromValue(OSPolicyResourcePackageResourceYUMResponse.fromMap((map['yum']! as Map).cast<String, dynamic>())),
      zypper: pulumi.Input.fromValue(OSPolicyResourcePackageResourceZypperResponse.fromMap((map['zypper']! as Map).cast<String, dynamic>())),
    );
  }
}
