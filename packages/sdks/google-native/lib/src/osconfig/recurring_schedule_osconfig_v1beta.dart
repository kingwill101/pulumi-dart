...
class RecurringScheduleOsconfigV1beta {
  ...
  const RecurringScheduleOsconfigV1beta({
    this.endTime,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'endTime': ?endTime,
      'frequency': pulumi.Input.mapInputValue<RecurringScheduleFrequencyOsconfigV1beta, String>(frequency, (value) => value.wireValue),
  ...
  factory RecurringScheduleOsconfigV1beta.fromMap(Map<String, dynamic> map) {
    return RecurringScheduleOsconfigV1beta(
      ...
      frequency: pulumi.Input.fromValue(RecurringScheduleFrequencyOsconfigV1beta.fromValue(map['frequency']! as String)),
      monthly: pulumi.Input.fromValue(MonthlyScheduleOsconfigV1beta.fromMap((map['monthly']! as Map).cast<String, dynamic>())),
      startTime: (() { final guardedValue = map['startTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      timeOfDay: pulumi.Input.fromValue(TimeOfDayOsconfigV1beta.fromMap((map['timeOfDay']! as Map).cast<String, dynamic>())),
      timeZone: pulumi.Input.fromValue(TimeZoneOsconfigV1beta.fromMap((map['timeZone']! as Map).cast<String, dynamic>())),
      weekly: pulumi.Input.fromValue(WeeklyScheduleOsconfigV1beta.fromMap((map['weekly']! as Map).cast<String, dynamic>())),
    );
  }
}
