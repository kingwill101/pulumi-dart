...
class OSPolicyAssignmentInstanceFilterResponseOsconfigV1alpha {
  ...
  final List<OSPolicyAssignmentInstanceFilterInventoryResponseOsconfigV1alpha> inventories;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'all': all,
      'exclusionLabels': pulumi.Input.encodeList<OSPolicyAssignmentLabelSetResponseOsconfigV1alpha, Map<String, dynamic>>(exclusionLabels, (value) => value.toMap()),
      'inclusionLabels': pulumi.Input.encodeList<OSPolicyAssignmentLabelSetResponseOsconfigV1alpha, Map<String, dynamic>>(inclusionLabels, (value) => value.toMap()),
      'inventories': pulumi.Input.encodeList<OSPolicyAssignmentInstanceFilterInventoryResponseOsconfigV1alpha, Map<String, dynamic>>(inventories, (value) => value.toMap()),
  ...
  factory OSPolicyAssignmentInstanceFilterResponseOsconfigV1alpha.fromMap(Map<String, dynamic> map) {
    return OSPolicyAssignmentInstanceFilterResponseOsconfigV1alpha(
      all: map['all'] as bool,
      exclusionLabels: pulumi.Input.decodeList<OSPolicyAssignmentLabelSetResponseOsconfigV1alpha>(map['exclusionLabels'], (value) => OSPolicyAssignmentLabelSetResponseOsconfigV1alpha.fromMap((value as Map).cast<String, dynamic>())),
      inclusionLabels: pulumi.Input.decodeList<OSPolicyAssignmentLabelSetResponseOsconfigV1alpha>(map['inclusionLabels'], (value) => OSPolicyAssignmentLabelSetResponseOsconfigV1alpha.fromMap((value as Map).cast<String, dynamic>())),
      inventories: pulumi.Input.decodeList<OSPolicyAssignmentInstanceFilterInventoryResponseOsconfigV1alpha>(map['inventories'], (value) => OSPolicyAssignmentInstanceFilterInventoryResponseOsconfigV1alpha.fromMap((value as Map).cast<String, dynamic>())),
