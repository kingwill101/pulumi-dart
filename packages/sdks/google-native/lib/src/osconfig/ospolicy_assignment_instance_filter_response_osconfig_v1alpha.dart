...
class OSPolicyAssignmentInstanceFilterResponseOsconfigV1alpha {
  ...
  final pulumi.Input<List<OSPolicyAssignmentLabelSetResponseOsconfigV1alpha>>
  exclusionLabels;
  ...
  final pulumi.Input<
    List<OSPolicyAssignmentInstanceFilterInventoryResponseOsconfigV1alpha>
  >
  inventories;
    ...
    return <String, dynamic>{
      ...
      'exclusionLabels':
          pulumi.Input.mapInputValue<
            List<OSPolicyAssignmentLabelSetResponseOsconfigV1alpha>,
    ...
    return OSPolicyAssignmentInstanceFilterResponseOsconfigV1alpha(
      ...
      inventories: pulumi.Input.fromValue(
        ...
        >(
          map['inventories']!,
          (value) =>
              OSPolicyAssignmentInstanceFilterInventoryResponseOsconfigV1alpha.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
      osShortNames: pulumi.Input.fromValue(
