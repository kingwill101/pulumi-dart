...
class OSPolicyAssignmentInstanceFilterResponseOsconfigV1alpha {
  ...
  const OSPolicyAssignmentInstanceFilterResponseOsconfigV1alpha({
    required this.all,
  ...
  factory OSPolicyAssignmentInstanceFilterResponseOsconfigV1alpha.fromMap(Map<String, dynamic> map) {
    return OSPolicyAssignmentInstanceFilterResponseOsconfigV1alpha(
      ...
      exclusionLabels: pulumi.Input.fromValue(pulumi.Input.decodeList<OSPolicyAssignmentLabelSetResponseOsconfigV1alpha>(map['exclusionLabels']!, (value) => OSPolicyAssignmentLabelSetResponseOsconfigV1alpha.fromMap((value as Map).cast<String, dynamic>()))),
      inclusionLabels: pulumi.Input.fromValue(pulumi.Input.decodeList<OSPolicyAssignmentLabelSetResponseOsconfigV1alpha>(map['inclusionLabels']!, (value) => OSPolicyAssignmentLabelSetResponseOsconfigV1alpha.fromMap((value as Map).cast<String, dynamic>()))),
      inventories: pulumi.Input.fromValue(pulumi.Input.decodeList<OSPolicyAssignmentInstanceFilterInventoryResponseOsconfigV1alpha>(map['inventories']!, (value) => OSPolicyAssignmentInstanceFilterInventoryResponseOsconfigV1alpha.fromMap((value as Map).cast<String, dynamic>()))),
      osShortNames: pulumi.Input.fromValue((map['osShortNames'] as List).cast<String>()),
    );
  }
}
