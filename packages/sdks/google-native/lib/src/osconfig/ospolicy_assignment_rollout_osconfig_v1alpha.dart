...
class OSPolicyAssignmentRolloutOsconfigV1alpha {
  ...
  const OSPolicyAssignmentRolloutOsconfigV1alpha({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'disruptionBudget': pulumi.Input.mapInputValue<FixedOrPercentOsconfigV1alpha, Map<String, dynamic>>(disruptionBudget, (value) => value.toMap()),
      'minWaitDuration': minWaitDuration,
    };
  }

  factory OSPolicyAssignmentRolloutOsconfigV1alpha.fromMap(Map<String, dynamic> map) {
    return OSPolicyAssignmentRolloutOsconfigV1alpha(
      disruptionBudget: pulumi.Input.fromValue(FixedOrPercentOsconfigV1alpha.fromMap((map['disruptionBudget']! as Map).cast<String, dynamic>())),
