...
class OSPolicy {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'id': id,
      'mode': mode.value,
      'resourceGroups': pulumi.Input.encodeList<OSPolicyResourceGroup, Map<String, dynamic>>(resourceGroups, (value) => value.toMap()),
    };
  }
  ...
  factory OSPolicy.fromMap(Map<String, dynamic> map) {
    return OSPolicy(
      ...
      resourceGroups: pulumi.Input.decodeList<OSPolicyResourceGroup>(map['resourceGroups'], (value) => OSPolicyResourceGroup.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
