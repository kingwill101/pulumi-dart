...
class OSPolicy {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'id': id,
      'mode': pulumi.Input.mapInputValue<OSPolicyMode, String>(mode, (value) => value.wireValue),
  ...
  factory OSPolicy.fromMap(Map<String, dynamic> map) {
    return OSPolicy(
      ...
      mode: pulumi.Input.fromValue(OSPolicyMode.fromValue(map['mode']! as String)),
      resourceGroups: pulumi.Input.fromValue(pulumi.Input.decodeList<OSPolicyResourceGroup>(map['resourceGroups']!, (value) => OSPolicyResourceGroup.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
