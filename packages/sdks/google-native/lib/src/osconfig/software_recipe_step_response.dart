...
class SoftwareRecipeStepResponse {
  ...
  factory SoftwareRecipeStepResponse.fromMap(Map<String, dynamic> map) {
    return SoftwareRecipeStepResponse(
      archiveExtraction: (SoftwareRecipeStepExtractArchiveResponse.fromMap((map['archiveExtraction'] as Map).cast<String, dynamic>())).input(),
      dpkgInstallation: (SoftwareRecipeStepInstallDpkgResponse.fromMap((map['dpkgInstallation'] as Map).cast<String, dynamic>())).input(),
      fileCopy: (SoftwareRecipeStepCopyFileResponse.fromMap((map['fileCopy'] as Map).cast<String, dynamic>())).input(),
      fileExec: (SoftwareRecipeStepExecFileResponse.fromMap((map['fileExec'] as Map).cast<String, dynamic>())).input(),
      msiInstallation: (SoftwareRecipeStepInstallMsiResponse.fromMap((map['msiInstallation'] as Map).cast<String, dynamic>())).input(),
      rpmInstallation: (SoftwareRecipeStepInstallRpmResponse.fromMap((map['rpmInstallation'] as Map).cast<String, dynamic>())).input(),
      scriptRun: (SoftwareRecipeStepRunScriptResponse.fromMap((map['scriptRun'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
