...
class SoftwareRecipeStepResponse {
  ...
  final pulumi.Input<SoftwareRecipeStepExtractArchiveResponse>
  archiveExtraction;
  ...
  factory SoftwareRecipeStepResponse.fromMap(Map<String, dynamic> map) {
    return SoftwareRecipeStepResponse(
      archiveExtraction: pulumi.Input.fromValue(
        SoftwareRecipeStepExtractArchiveResponse.fromMap(
          (map['archiveExtraction']! as Map).cast<String, dynamic>(),
        ),
      ),
      dpkgInstallation: pulumi.Input.fromValue(
        SoftwareRecipeStepInstallDpkgResponse.fromMap(
          (map['dpkgInstallation']! as Map).cast<String, dynamic>(),
        ),
      ),
      fileCopy: pulumi.Input.fromValue(
        SoftwareRecipeStepCopyFileResponse.fromMap(
          (map['fileCopy']! as Map).cast<String, dynamic>(),
        ),
      ),
      fileExec: pulumi.Input.fromValue(
        SoftwareRecipeStepExecFileResponse.fromMap(
          (map['fileExec']! as Map).cast<String, dynamic>(),
        ),
      ),
      msiInstallation: pulumi.Input.fromValue(
        SoftwareRecipeStepInstallMsiResponse.fromMap(
          (map['msiInstallation']! as Map).cast<String, dynamic>(),
        ),
      ),
      rpmInstallation: pulumi.Input.fromValue(
        SoftwareRecipeStepInstallRpmResponse.fromMap(
          (map['rpmInstallation']! as Map).cast<String, dynamic>(),
        ),
      ),
      scriptRun: pulumi.Input.fromValue(
        SoftwareRecipeStepRunScriptResponse.fromMap(
