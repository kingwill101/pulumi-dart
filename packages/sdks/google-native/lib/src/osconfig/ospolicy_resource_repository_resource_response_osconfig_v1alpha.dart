...
class OSPolicyResourceRepositoryResourceResponseOsconfigV1alpha {
  ...
  factory OSPolicyResourceRepositoryResourceResponseOsconfigV1alpha.fromMap(Map<String, dynamic> map) {
    return OSPolicyResourceRepositoryResourceResponseOsconfigV1alpha(
      apt: (OSPolicyResourceRepositoryResourceAptRepositoryResponseOsconfigV1alpha.fromMap((map['apt'] as Map).cast<String, dynamic>())).input(),
      goo: (OSPolicyResourceRepositoryResourceGooRepositoryResponseOsconfigV1alpha.fromMap((map['goo'] as Map).cast<String, dynamic>())).input(),
      yum: (OSPolicyResourceRepositoryResourceYumRepositoryResponseOsconfigV1alpha.fromMap((map['yum'] as Map).cast<String, dynamic>())).input(),
      zypper: (OSPolicyResourceRepositoryResourceZypperRepositoryResponseOsconfigV1alpha.fromMap((map['zypper'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
