...
class OSPolicyResourceGroupOsconfigV1alpha {
  ...
  factory OSPolicyResourceGroupOsconfigV1alpha.fromMap(Map<String, dynamic> map) {
    return OSPolicyResourceGroupOsconfigV1alpha(
      inventoryFilters: (() { final guardedValue = map['inventoryFilters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OSPolicyInventoryFilterOsconfigV1alpha>(guardedValue, (value) => OSPolicyInventoryFilterOsconfigV1alpha.fromMap((value as Map).cast<String, dynamic>()))); })(),
      osFilter: (() { final guardedValue = map['osFilter']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OSPolicyOSFilter.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      resources: pulumi.Input.fromValue(pulumi.Input.decodeList<OSPolicyResourceOsconfigV1alpha>(map['resources']!, (value) => OSPolicyResourceOsconfigV1alpha.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
