...
class OSPolicyResourceGroupOsconfigV1alpha {
  ...
  final pulumi.Input<List<OSPolicyInventoryFilterOsconfigV1alpha>>?
  inventoryFilters;
    ...
    return <String, dynamic>{
      'inventoryFilters':
          ?pulumi.Input.mapOptionalInputValue<
            List<OSPolicyInventoryFilterOsconfigV1alpha>,
      ...
      'osFilter':
          ?pulumi.Input.mapOptionalInputValue<
            OSPolicyOSFilter,
            Map<String, dynamic>
          >(osFilter, (value) => value.toMap()),
      'resources':
          pulumi.Input.mapInputValue<
            List<OSPolicyResourceOsconfigV1alpha>,
            List<Map<String, dynamic>>
          >(
            resources,
            (value) =>
  ...
  factory OSPolicyResourceGroupOsconfigV1alpha.fromMap(
    ...
    return OSPolicyResourceGroupOsconfigV1alpha(
      ...
      osFilter: (() {
        final guardedValue = map['osFilter'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      resources: pulumi.Input.fromValue(
        pulumi.Input.decodeList<OSPolicyResourceOsconfigV1alpha>(
          map['resources']!,
