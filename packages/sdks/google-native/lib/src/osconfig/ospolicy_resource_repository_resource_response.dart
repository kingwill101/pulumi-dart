...
class OSPolicyResourceRepositoryResourceResponse {
  /// An Apt Repository.
  final pulumi.Input<OSPolicyResourceRepositoryResourceAptRepositoryResponse>
  apt;

  /// A Goo Repository.
  final pulumi.Input<OSPolicyResourceRepositoryResourceGooRepositoryResponse>
  goo;

  /// A Yum Repository.
  final pulumi.Input<OSPolicyResourceRepositoryResourceYumRepositoryResponse>
  yum;

  /// A Zypper Repository.
  final pulumi.Input<OSPolicyResourceRepositoryResourceZypperRepositoryResponse>
  zypper;
  ...
  factory OSPolicyResourceRepositoryResourceResponse.fromMap(
    ...
    return OSPolicyResourceRepositoryResourceResponse(
      apt: pulumi.Input.fromValue(
        OSPolicyResourceRepositoryResourceAptRepositoryResponse.fromMap(
          (map['apt']! as Map).cast<String, dynamic>(),
        ),
      ),
      goo: pulumi.Input.fromValue(
        OSPolicyResourceRepositoryResourceGooRepositoryResponse.fromMap(
          (map['goo']! as Map).cast<String, dynamic>(),
        ),
      ),
      yum: pulumi.Input.fromValue(
        OSPolicyResourceRepositoryResourceYumRepositoryResponse.fromMap(
