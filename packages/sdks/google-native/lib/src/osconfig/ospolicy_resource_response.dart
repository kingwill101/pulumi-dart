...
class OSPolicyResourceResponse {
  ...
  factory OSPolicyResourceResponse.fromMap(Map<String, dynamic> map) {
    return OSPolicyResourceResponse(
      exec: (OSPolicyResourceExecResourceResponse.fromMap((map['exec'] as Map).cast<String, dynamic>())).input(),
      file: (OSPolicyResourceFileResourceResponse.fromMap((map['file'] as Map).cast<String, dynamic>())).input(),
      pkg: (OSPolicyResourcePackageResourceResponse.fromMap((map['pkg'] as Map).cast<String, dynamic>())).input(),
      repository: (OSPolicyResourceRepositoryResourceResponse.fromMap((map['repository'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
