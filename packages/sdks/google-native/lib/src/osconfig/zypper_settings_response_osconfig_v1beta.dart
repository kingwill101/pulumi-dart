...
class ZypperSettingsResponseOsconfigV1beta {
  ...
  /// Creates a new [ZypperSettingsResponseOsconfigV1beta].
  ...
  factory ZypperSettingsResponseOsconfigV1beta.fromMap(Map<String, dynamic> map) {
    return ZypperSettingsResponseOsconfigV1beta(
      ...
      withOptional: (map['withOptional'] as bool).input(),
      withUpdate: (map['withUpdate'] as bool).input(),
    );
  }
}
