...
class PatchInstanceFilter {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'all': ?all,
      'groupLabels': ?groupLabels == null ? null : pulumi.Input.encodeList<PatchInstanceFilterGroupLabel, Map<String, dynamic>>(groupLabels!, (value) => value.toMap()),
  ...
  factory PatchInstanceFilter.fromMap(Map<String, dynamic> map) {
    return PatchInstanceFilter(
      ...
      groupLabels: map['groupLabels'] == null ? null : pulumi.Input.decodeList<PatchInstanceFilterGroupLabel>(map['groupLabels'], (value) => PatchInstanceFilterGroupLabel.fromMap((value as Map).cast<String, dynamic>())),
