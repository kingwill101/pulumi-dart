...
class OSPolicyAssignmentInstanceFilterResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'all': all,
      'exclusionLabels': pulumi.Input.encodeList<OSPolicyAssignmentLabelSetResponse, Map<String, dynamic>>(exclusionLabels, (value) => value.toMap()),
      'inclusionLabels': pulumi.Input.encodeList<OSPolicyAssignmentLabelSetResponse, Map<String, dynamic>>(inclusionLabels, (value) => value.toMap()),
      'inventories': pulumi.Input.encodeList<OSPolicyAssignmentInstanceFilterInventoryResponse, Map<String, dynamic>>(inventories, (value) => value.toMap()),
    };
  }
  ...
  factory OSPolicyAssignmentInstanceFilterResponse.fromMap(Map<String, dynamic> map) {
    return OSPolicyAssignmentInstanceFilterResponse(
      all: map['all'] as bool,
      exclusionLabels: pulumi.Input.decodeList<OSPolicyAssignmentLabelSetResponse>(map['exclusionLabels'], (value) => OSPolicyAssignmentLabelSetResponse.fromMap((value as Map).cast<String, dynamic>())),
      inclusionLabels: pulumi.Input.decodeList<OSPolicyAssignmentLabelSetResponse>(map['inclusionLabels'], (value) => OSPolicyAssignmentLabelSetResponse.fromMap((value as Map).cast<String, dynamic>())),
      inventories: pulumi.Input.decodeList<OSPolicyAssignmentInstanceFilterInventoryResponse>(map['inventories'], (value) => OSPolicyAssignmentInstanceFilterInventoryResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
