...
class OSPolicyResourceExecResourceResponseOsconfigV1alpha {
  ...
  final pulumi.Input<OSPolicyResourceExecResourceExecResponseOsconfigV1alpha> enforce;
  ...
  final pulumi.Input<OSPolicyResourceExecResourceExecResponseOsconfigV1alpha> validate;
  ...
  const OSPolicyResourceExecResourceResponseOsconfigV1alpha({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'enforce': pulumi.Input.mapInputValue<OSPolicyResourceExecResourceExecResponseOsconfigV1alpha, Map<String, dynamic>>(enforce, (value) => value.toMap()),
      'validate': pulumi.Input.mapInputValue<OSPolicyResourceExecResourceExecResponseOsconfigV1alpha, Map<String, dynamic>>(validate, (value) => value.toMap()),
    };
  }
  ...
  factory OSPolicyResourceExecResourceResponseOsconfigV1alpha.fromMap(Map<String, dynamic> map) {
    return OSPolicyResourceExecResourceResponseOsconfigV1alpha(
      enforce: pulumi.Input.fromValue(OSPolicyResourceExecResourceExecResponseOsconfigV1alpha.fromMap((map['enforce']! as Map).cast<String, dynamic>())),
      validate: pulumi.Input.fromValue(OSPolicyResourceExecResourceExecResponseOsconfigV1alpha.fromMap((map['validate']! as Map).cast<String, dynamic>())),
    );
  }
}
