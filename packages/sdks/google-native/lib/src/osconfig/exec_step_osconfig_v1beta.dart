...
class ExecStepOsconfigV1beta {
  ...
  factory ExecStepOsconfigV1beta.fromMap(Map<String, dynamic> map) {
    return ExecStepOsconfigV1beta(
      linuxExecStepConfig: (() { final guardedValue = map['linuxExecStepConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ExecStepConfigOsconfigV1beta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      windowsExecStepConfig: (() { final guardedValue = map['windowsExecStepConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ExecStepConfigOsconfigV1beta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
