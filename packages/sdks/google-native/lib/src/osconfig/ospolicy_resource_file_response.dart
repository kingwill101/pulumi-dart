...
class OSPolicyResourceFileResponse {
  ...
  factory OSPolicyResourceFileResponse.fromMap(Map<String, dynamic> map) {
    return OSPolicyResourceFileResponse(
      ...
      gcs: (OSPolicyResourceFileGcsResponse.fromMap((map['gcs'] as Map).cast<String, dynamic>())).input(),
      localPath: (map['localPath'] as String).input(),
      remote: (OSPolicyResourceFileRemoteResponse.fromMap((map['remote'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
