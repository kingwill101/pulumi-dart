...
class OSPolicyResourceGroupResponseOsconfigV1alpha {
  ...
  factory OSPolicyResourceGroupResponseOsconfigV1alpha.fromMap(Map<String, dynamic> map) {
    return OSPolicyResourceGroupResponseOsconfigV1alpha(
      inventoryFilters: (pulumi.Input.decodeList<OSPolicyInventoryFilterResponseOsconfigV1alpha>(map['inventoryFilters'], (value) => OSPolicyInventoryFilterResponseOsconfigV1alpha.fromMap((value as Map).cast<String, dynamic>()))).input(),
      osFilter: (OSPolicyOSFilterResponse.fromMap((map['osFilter'] as Map).cast<String, dynamic>())).input(),
      resources: (pulumi.Input.decodeList<OSPolicyResourceResponseOsconfigV1alpha>(map['resources'], (value) => OSPolicyResourceResponseOsconfigV1alpha.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
