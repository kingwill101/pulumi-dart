...
class OSPolicyResourceGroupResponseOsconfigV1alpha {
  ...
  final pulumi.Input<List<OSPolicyInventoryFilterResponseOsconfigV1alpha>>
  inventoryFilters;
    ...
    return <String, dynamic>{
      'inventoryFilters':
          pulumi.Input.mapInputValue<
            List<OSPolicyInventoryFilterResponseOsconfigV1alpha>,
      ...
      'resources':
          pulumi.Input.mapInputValue<
            List<OSPolicyResourceResponseOsconfigV1alpha>,
            List<Map<String, dynamic>>
          >(
            resources,
            (value) =>
  ...
  factory OSPolicyResourceGroupResponseOsconfigV1alpha.fromMap(
    ...
    return OSPolicyResourceGroupResponseOsconfigV1alpha(
      inventoryFilters: pulumi.Input.fromValue(
        pulumi.Input.decodeList<OSPolicyInventoryFilterResponseOsconfigV1alpha>(
      ...
      osFilter: pulumi.Input.fromValue(
        OSPolicyOSFilterResponse.fromMap(
