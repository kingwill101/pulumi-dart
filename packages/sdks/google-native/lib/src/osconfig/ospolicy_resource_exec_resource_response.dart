...
import 'ospolicy_resource_exec_resource_exec_response.dart';
...
class OSPolicyResourceExecResourceResponse {
  ...
  /// Creates a new [OSPolicyResourceExecResourceResponse].
  ...
  factory OSPolicyResourceExecResourceResponse.fromMap(Map<String, dynamic> map) {
    return OSPolicyResourceExecResourceResponse(
      enforce: (OSPolicyResourceExecResourceExecResponse.fromMap((map['enforce'] as Map).cast<String, dynamic>())).input(),
      validate: (OSPolicyResourceExecResourceExecResponse.fromMap((map['validate'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
