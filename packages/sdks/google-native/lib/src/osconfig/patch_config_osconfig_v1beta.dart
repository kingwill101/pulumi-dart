...
class PatchConfigOsconfigV1beta {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'rebootConfig': ?pulumi.Input.mapOptionalInputValue<PatchConfigRebootConfigOsconfigV1beta, String>(rebootConfig, (value) => value.wireValue),
  ...
  factory PatchConfigOsconfigV1beta.fromMap(Map<String, dynamic> map) {
    return PatchConfigOsconfigV1beta(
      apt: (() { final guardedValue = map['apt']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AptSettingsOsconfigV1beta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      postStep: (() { final guardedValue = map['postStep']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ExecStepOsconfigV1beta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      preStep: (() { final guardedValue = map['preStep']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ExecStepOsconfigV1beta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      rebootConfig: (() { final guardedValue = map['rebootConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PatchConfigRebootConfigOsconfigV1beta.fromValue(guardedValue as String)); })(),
      windowsUpdate: (() { final guardedValue = map['windowsUpdate']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WindowsUpdateSettingsOsconfigV1beta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      yum: (() { final guardedValue = map['yum']; if (guardedValue == null) return null; return pulumi.Input.fromValue(YumSettingsOsconfigV1beta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      zypper: (() { final guardedValue = map['zypper']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ZypperSettingsOsconfigV1beta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
