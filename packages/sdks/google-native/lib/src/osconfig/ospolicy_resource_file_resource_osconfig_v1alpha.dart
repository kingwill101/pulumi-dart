...
class OSPolicyResourceFileResourceOsconfigV1alpha {
  ...
  const OSPolicyResourceFileResourceOsconfigV1alpha({
    this.content,
    this.file,
    required this.path,
    this.permissions,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'state': pulumi.Input.mapInputValue<OSPolicyResourceFileResourceStateOsconfigV1alpha, String>(state, (value) => value.wireValue),
    };
  }
  ...
  factory OSPolicyResourceFileResourceOsconfigV1alpha.fromMap(Map<String, dynamic> map) {
    return OSPolicyResourceFileResourceOsconfigV1alpha(
      ...
      state: pulumi.Input.fromValue(OSPolicyResourceFileResourceStateOsconfigV1alpha.fromValue(map['state']! as String)),
    );
  }
}
