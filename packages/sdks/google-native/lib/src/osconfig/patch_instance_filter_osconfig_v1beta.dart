...
class PatchInstanceFilterOsconfigV1beta {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'all': ?all,
      'groupLabels': ?groupLabels == null ? null : pulumi.Input.encodeList<PatchInstanceFilterGroupLabelOsconfigV1beta, Map<String, dynamic>>(groupLabels!, (value) => value.toMap()),
  ...
  factory PatchInstanceFilterOsconfigV1beta.fromMap(Map<String, dynamic> map) {
    return PatchInstanceFilterOsconfigV1beta(
      ...
      groupLabels: map['groupLabels'] == null ? null : pulumi.Input.decodeList<PatchInstanceFilterGroupLabelOsconfigV1beta>(map['groupLabels'], (value) => PatchInstanceFilterGroupLabelOsconfigV1beta.fromMap((value as Map).cast<String, dynamic>())),
