...
class PatchInstanceFilterOsconfigV1beta {
  ...
  factory PatchInstanceFilterOsconfigV1beta.fromMap(Map<String, dynamic> map) {
    return PatchInstanceFilterOsconfigV1beta(
      ...
      groupLabels: (() { final guardedValue = map['groupLabels']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PatchInstanceFilterGroupLabelOsconfigV1beta>(guardedValue, (value) => PatchInstanceFilterGroupLabelOsconfigV1beta.fromMap((value as Map).cast<String, dynamic>()))); })(),
