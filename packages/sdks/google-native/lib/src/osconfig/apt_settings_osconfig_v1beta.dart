...
class AptSettingsOsconfigV1beta {
  ...
  const AptSettingsOsconfigV1beta({
    this.excludes,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'type': ?pulumi.Input.mapOptionalInputValue<AptSettingsTypeOsconfigV1beta, String>(type, (value) => value.wireValue),
    };
  }
  ...
  factory AptSettingsOsconfigV1beta.fromMap(Map<String, dynamic> map) {
    return AptSettingsOsconfigV1beta(
      ...
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AptSettingsTypeOsconfigV1beta.fromValue(guardedValue as String)); })(),
    );
  }
}
