...
class PatchInstanceFilterResponse {
  ...
  const PatchInstanceFilterResponse({
    required this.all,
  ...
  factory PatchInstanceFilterResponse.fromMap(Map<String, dynamic> map) {
    return PatchInstanceFilterResponse(
      ...
      groupLabels: pulumi.Input.fromValue(pulumi.Input.decodeList<PatchInstanceFilterGroupLabelResponse>(map['groupLabels']!, (value) => PatchInstanceFilterGroupLabelResponse.fromMap((value as Map).cast<String, dynamic>()))),
