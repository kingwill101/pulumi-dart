...
class ExecStepConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'gcsObject':
          ?pulumi.Input.mapOptionalInputValue<GcsObject, Map<String, dynamic>>(
            gcsObject,
            (value) => value.toMap(),
          ),
      'interpreter':
    ...
    return ExecStepConfig(
      ...
      gcsObject: (() {
        ...
        return pulumi.Input.fromValue(
          GcsObject.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      interpreter: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ExecStepConfigInterpreter.fromValue(guardedValue as String),
        );
      })(),
      localPath: (() {
