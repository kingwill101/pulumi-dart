...
class SoftwareRecipeArtifactResponse {
  ...
  factory SoftwareRecipeArtifactResponse.fromMap(Map<String, dynamic> map) {
    return SoftwareRecipeArtifactResponse(
      ...
      gcs: (SoftwareRecipeArtifactGcsResponse.fromMap((map['gcs'] as Map).cast<String, dynamic>())).input(),
      remote: (SoftwareRecipeArtifactRemoteResponse.fromMap((map['remote'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
