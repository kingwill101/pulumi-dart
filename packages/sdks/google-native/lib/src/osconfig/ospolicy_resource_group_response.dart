...
class OSPolicyResourceGroupResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'inventoryFilters': pulumi.Input.encodeList<OSPolicyInventoryFilterResponse, Map<String, dynamic>>(inventoryFilters, (value) => value.toMap()),
      'resources': pulumi.Input.encodeList<OSPolicyResourceResponse, Map<String, dynamic>>(resources, (value) => value.toMap()),
    };
  }

  factory OSPolicyResourceGroupResponse.fromMap(Map<String, dynamic> map) {
    return OSPolicyResourceGroupResponse(
      inventoryFilters: pulumi.Input.decodeList<OSPolicyInventoryFilterResponse>(map['inventoryFilters'], (value) => OSPolicyInventoryFilterResponse.fromMap((value as Map).cast<String, dynamic>())),
      resources: pulumi.Input.decodeList<OSPolicyResourceResponse>(map['resources'], (value) => OSPolicyResourceResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
