...
class OSPolicyResourceGroupResponse {
    ...
    return <String, dynamic>{
      'inventoryFilters':
          pulumi.Input.mapInputValue<
            List<OSPolicyInventoryFilterResponse>,
  ...
  factory OSPolicyResourceGroupResponse.fromMap(Map<String, dynamic> map) {
    return OSPolicyResourceGroupResponse(
      inventoryFilters: pulumi.Input.fromValue(
      ...
      resources: pulumi.Input.fromValue(
        pulumi.Input.decodeList<OSPolicyResourceResponse>(
          map['resources']!,
