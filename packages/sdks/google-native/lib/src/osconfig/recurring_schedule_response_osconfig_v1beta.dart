...
class RecurringScheduleResponseOsconfigV1beta {
  ...
  factory RecurringScheduleResponseOsconfigV1beta.fromMap(Map<String, dynamic> map) {
    return RecurringScheduleResponseOsconfigV1beta(
      ...
      monthly: pulumi.Input.fromValue(MonthlyScheduleResponseOsconfigV1beta.fromMap((map['monthly']! as Map).cast<String, dynamic>())),
      nextExecuteTime: pulumi.Input.fromValue(map['nextExecuteTime'] as String),
      startTime: pulumi.Input.fromValue(map['startTime'] as String),
      timeOfDay: pulumi.Input.fromValue(TimeOfDayResponseOsconfigV1beta.fromMap((map['timeOfDay']! as Map).cast<String, dynamic>())),
      timeZone: pulumi.Input.fromValue(TimeZoneResponseOsconfigV1beta.fromMap((map['timeZone']! as Map).cast<String, dynamic>())),
      weekly: pulumi.Input.fromValue(WeeklyScheduleResponseOsconfigV1beta.fromMap((map['weekly']! as Map).cast<String, dynamic>())),
    );
  }
}
