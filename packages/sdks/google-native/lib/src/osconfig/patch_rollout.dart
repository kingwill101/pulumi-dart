...
class PatchRollout {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'mode': ?pulumi.Input.mapOptionalInputValue<PatchRolloutMode, String>(mode, (value) => value.wireValue),
    };
  }

  factory PatchRollout.fromMap(Map<String, dynamic> map) {
    return PatchRollout(
      disruptionBudget: (() { final guardedValue = map['disruptionBudget']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FixedOrPercent.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      mode: (() { final guardedValue = map['mode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PatchRolloutMode.fromValue(guardedValue as String)); })(),
    );
  }
}
