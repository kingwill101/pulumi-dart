...
class SoftwareRecipeArtifact {
  ...
  factory SoftwareRecipeArtifact.fromMap(Map<String, dynamic> map) {
    return SoftwareRecipeArtifact(
      ...
      gcs: (() { final guardedValue = map['gcs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SoftwareRecipeArtifactGcs.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      id: pulumi.Input.fromValue(map['id'] as String),
      remote: (() { final guardedValue = map['remote']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SoftwareRecipeArtifactRemote.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
