...
class PackageRepositoryResponse {
  ...
  factory PackageRepositoryResponse.fromMap(Map<String, dynamic> map) {
    return PackageRepositoryResponse(
      apt: (AptRepositoryResponse.fromMap((map['apt'] as Map).cast<String, dynamic>())).input(),
      goo: (GooRepositoryResponse.fromMap((map['goo'] as Map).cast<String, dynamic>())).input(),
      yum: (YumRepositoryResponse.fromMap((map['yum'] as Map).cast<String, dynamic>())).input(),
      zypper: (ZypperRepositoryResponse.fromMap((map['zypper'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
