...
class OSPolicyResourceGroup {
  ...
  factory OSPolicyResourceGroup.fromMap(Map<String, dynamic> map) {
    return OSPolicyResourceGroup(
      inventoryFilters: (() { final guardedValue = map['inventoryFilters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OSPolicyInventoryFilter>(guardedValue, (value) => OSPolicyInventoryFilter.fromMap((value as Map).cast<String, dynamic>()))); })(),
      resources: pulumi.Input.fromValue(pulumi.Input.decodeList<OSPolicyResource>(map['resources']!, (value) => OSPolicyResource.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
