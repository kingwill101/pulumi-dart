...
class PatchConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'postStep':
          ?pulumi.Input.mapOptionalInputValue<ExecStep, Map<String, dynamic>>(
            postStep,
            (value) => value.toMap(),
          ),
      'preStep':
      ...
      'rebootConfig':
          ?pulumi.Input.mapOptionalInputValue<PatchConfigRebootConfig, String>(
            rebootConfig,
    ...
    return PatchConfig(
      apt: (() {
        ...
        return pulumi.Input.fromValue(
          AptSettings.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      goo: (() {
      ...
      postStep: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ExecStep.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      preStep: (() {
      ...
      rebootConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PatchConfigRebootConfig.fromValue(guardedValue as String),
        );
      })(),
      windowsUpdate: (() {
      ...
      yum: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          YumSettings.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      zypper: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ZypperSettings.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
