...
class AssignmentResponse {
  ...
  factory AssignmentResponse.fromMap(Map<String, dynamic> map) {
    return AssignmentResponse(
      groupLabels: (pulumi.Input.decodeList<AssignmentGroupLabelResponse>(map['groupLabels'], (value) => AssignmentGroupLabelResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      instanceNamePrefixes: ((map['instanceNamePrefixes'] as List).cast<String>()).input(),
      instances: ((map['instances'] as List).cast<String>()).input(),
      osTypes: (pulumi.Input.decodeList<AssignmentOsTypeResponse>(map['osTypes'], (value) => AssignmentOsTypeResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
