...
class AssignmentResponse {
    ...
    return <String, dynamic>{
      'groupLabels':
          pulumi.Input.mapInputValue<
            List<AssignmentGroupLabelResponse>,
  ...
  factory AssignmentResponse.fromMap(Map<String, dynamic> map) {
    return AssignmentResponse(
      groupLabels: pulumi.Input.fromValue(
        pulumi.Input.decodeList<AssignmentGroupLabelResponse>(
          map['groupLabels']!,
      ...
      instanceNamePrefixes: pulumi.Input.fromValue(
        (map['instanceNamePrefixes'] as List).cast<String>(),
      ),
      instances: pulumi.Input.fromValue(
        (map['instances'] as List).cast<String>(),
      ),
      osTypes: pulumi.Input.fromValue(
        pulumi.Input.decodeList<AssignmentOsTypeResponse>(
          map['osTypes']!,
