...
class OSPolicyOsconfigV1alpha {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'id': id,
      'mode': pulumi.Input.mapInputValue<OSPolicyModeOsconfigV1alpha, String>(mode, (value) => value.wireValue),
  ...
  factory OSPolicyOsconfigV1alpha.fromMap(Map<String, dynamic> map) {
    return OSPolicyOsconfigV1alpha(
      ...
      mode: pulumi.Input.fromValue(OSPolicyModeOsconfigV1alpha.fromValue(map['mode']! as String)),
      resourceGroups: pulumi.Input.fromValue(pulumi.Input.decodeList<OSPolicyResourceGroupOsconfigV1alpha>(map['resourceGroups']!, (value) => OSPolicyResourceGroupOsconfigV1alpha.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
