...
class OSPolicyOsconfigV1alpha {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'id': id,
      'mode': mode.value,
      'resourceGroups': pulumi.Input.encodeList<OSPolicyResourceGroupOsconfigV1alpha, Map<String, dynamic>>(resourceGroups, (value) => value.toMap()),
    };
  }
  ...
  factory OSPolicyOsconfigV1alpha.fromMap(Map<String, dynamic> map) {
    return OSPolicyOsconfigV1alpha(
      ...
      resourceGroups: pulumi.Input.decodeList<OSPolicyResourceGroupOsconfigV1alpha>(map['resourceGroups'], (value) => OSPolicyResourceGroupOsconfigV1alpha.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
