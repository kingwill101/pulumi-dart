...
class PatchRolloutOsconfigV1beta {
  ...
  PatchRolloutOsconfigV1beta({this.disruptionBudget, this.mode});
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'mode':
          ?pulumi.Input.mapOptionalInputValue<
            PatchRolloutModeOsconfigV1beta,
            String
  ...
  factory PatchRolloutOsconfigV1beta.fromMap(Map<String, dynamic> map) {
    return PatchRolloutOsconfigV1beta(
      ...
      mode: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PatchRolloutModeOsconfigV1beta.fromValue(guardedValue as String),
        );
      })(),
    );
  }
