...
class SoftwareRecipeResponse {
  ...
  factory SoftwareRecipeResponse.fromMap(Map<String, dynamic> map) {
    return SoftwareRecipeResponse(
      artifacts: pulumi.Input.fromValue(pulumi.Input.decodeList<SoftwareRecipeArtifactResponse>(map['artifacts']!, (value) => SoftwareRecipeArtifactResponse.fromMap((value as Map).cast<String, dynamic>()))),
      desiredState: pulumi.Input.fromValue(map['desiredState'] as String),
      installSteps: pulumi.Input.fromValue(pulumi.Input.decodeList<SoftwareRecipeStepResponse>(map['installSteps']!, (value) => SoftwareRecipeStepResponse.fromMap((value as Map).cast<String, dynamic>()))),
      name: pulumi.Input.fromValue(map['name'] as String),
      updateSteps: pulumi.Input.fromValue(pulumi.Input.decodeList<SoftwareRecipeStepResponse>(map['updateSteps']!, (value) => SoftwareRecipeStepResponse.fromMap((value as Map).cast<String, dynamic>()))),
