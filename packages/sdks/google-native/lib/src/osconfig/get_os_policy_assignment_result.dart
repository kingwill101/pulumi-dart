...
class GetOsPolicyAssignmentResult {
  ...
  /// Creates a new [GetOsPolicyAssignmentResult].
  ...
  const GetOsPolicyAssignmentResult({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': name,
      'osPolicies': pulumi.Input.encodeList<OSPolicyResponse, Map<String, dynamic>>(osPolicies, (value) => value.toMap()),
  ...
  factory GetOsPolicyAssignmentResult.fromMap(Map<String, dynamic> map) {
    return GetOsPolicyAssignmentResult(
      ...
      instanceFilter: OSPolicyAssignmentInstanceFilterResponse.fromMap((map['instanceFilter']! as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      osPolicies: pulumi.Input.decodeList<OSPolicyResponse>(map['osPolicies']!, (value) => OSPolicyResponse.fromMap((value as Map).cast<String, dynamic>())),
      ...
      rollout: OSPolicyAssignmentRolloutResponse.fromMap((map['rollout']! as Map).cast<String, dynamic>()),
