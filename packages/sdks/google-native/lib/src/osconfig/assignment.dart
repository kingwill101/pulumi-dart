...
class Assignment {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'groupLabels': ?groupLabels == null ? null : pulumi.Input.encodeList<AssignmentGroupLabel, Map<String, dynamic>>(groupLabels!, (value) => value.toMap()),
      'instanceNamePrefixes': ?instanceNamePrefixes,
      'instances': ?instances,
      'osTypes': ?osTypes == null ? null : pulumi.Input.encodeList<AssignmentOsType, Map<String, dynamic>>(osTypes!, (value) => value.toMap()),
      'zones': ?zones,
    };
  }
  ...
  factory Assignment.fromMap(Map<String, dynamic> map) {
    return Assignment(
      groupLabels: map['groupLabels'] == null ? null : pulumi.Input.decodeList<AssignmentGroupLabel>(map['groupLabels'], (value) => AssignmentGroupLabel.fromMap((value as Map).cast<String, dynamic>())),
      ...
      osTypes: map['osTypes'] == null ? null : pulumi.Input.decodeList<AssignmentOsType>(map['osTypes'], (value) => AssignmentOsType.fromMap((value as Map).cast<String, dynamic>())),
