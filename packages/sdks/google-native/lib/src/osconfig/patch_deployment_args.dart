...
class PatchDeploymentArgs {
  ...
  factory PatchDeploymentArgs.fromMap(Map<String, dynamic> map) {
    return PatchDeploymentArgs(
      ...
      instanceFilter: pulumi.Input.fromValue(PatchInstanceFilter.fromMap((map['instanceFilter']! as Map).cast<String, dynamic>())),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      oneTimeSchedule: pulumi.Input.fromValue(OneTimeSchedule.fromMap((map['oneTimeSchedule']! as Map).cast<String, dynamic>())),
      patchConfig: (() { final guardedValue = map['patchConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PatchConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      patchDeploymentId: pulumi.Input.fromValue(map['patchDeploymentId'] as String),
      project: (() { final guardedValue = map['project']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      recurringSchedule: pulumi.Input.fromValue(RecurringSchedule.fromMap((map['recurringSchedule']! as Map).cast<String, dynamic>())),
      rollout: (() { final guardedValue = map['rollout']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PatchRollout.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
