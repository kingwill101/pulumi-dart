...
class PatchDeploymentArgs {
  ...
  factory PatchDeploymentArgs.fromMap(Map<String, dynamic> map) {
    return PatchDeploymentArgs(
      ...
      oneTimeSchedule: pulumi.Input.fromValue(
        OneTimeSchedule.fromMap(
      ...
      patchConfig: (() {
        ...
        return pulumi.Input.fromValue(
          PatchConfig.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      ...
      recurringSchedule: pulumi.Input.fromValue(
        RecurringSchedule.fromMap(
      ...
      rollout: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PatchRollout.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
