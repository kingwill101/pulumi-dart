...
class OSPolicyResourceFileResource {
  ...
  const OSPolicyResourceFileResource({
    this.content,
    this.file,
    required this.path,
    this.permissions,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'state': pulumi.Input.mapInputValue<OSPolicyResourceFileResourceState, String>(state, (value) => value.wireValue),
    };
  }
  ...
  factory OSPolicyResourceFileResource.fromMap(Map<String, dynamic> map) {
    return OSPolicyResourceFileResource(
      ...
      state: pulumi.Input.fromValue(OSPolicyResourceFileResourceState.fromValue(map['state']! as String)),
    );
  }
}
