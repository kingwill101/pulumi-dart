  ...
  factory PatchConfigResponseOsconfigV1beta.fromMap(Map<String, dynamic> map) {
    return PatchConfigResponseOsconfigV1beta(
      apt: pulumi.Input.fromValue(
        AptSettingsResponseOsconfigV1beta.fromMap(
      ...
      postStep: pulumi.Input.fromValue(
        ExecStepResponseOsconfigV1beta.fromMap(
      ...
      windowsUpdate: pulumi.Input.fromValue(
        WindowsUpdateSettingsResponseOsconfigV1beta.fromMap(
          (map['windowsUpdate']! as Map).cast<String, dynamic>(),
        ),
      ),
      yum: pulumi.Input.fromValue(
        YumSettingsResponseOsconfigV1beta.fromMap(
          (map['yum']! as Map).cast<String, dynamic>(),
        ),
      ),
      zypper: pulumi.Input.fromValue(
        ZypperSettingsResponseOsconfigV1beta.fromMap(
