...
class OSPolicyResponse {
  ...
  final pulumi.Input<List<OSPolicyResourceGroupResponse>> resourceGroups;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'mode': mode,
      'resourceGroups': pulumi.Input.mapInputValue<List<OSPolicyResourceGroupResponse>, List<Map<String, dynamic>>>(resourceGroups, (value) => pulumi.Input.encodeList<OSPolicyResourceGroupResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory OSPolicyResponse.fromMap(Map<String, dynamic> map) {
    return OSPolicyResponse(
      allowNoResourceGroupMatch: (map['allowNoResourceGroupMatch'] as bool).input(),
      description: (map['description'] as String).input(),
      mode: (map['mode'] as String).input(),
      resourceGroups: (pulumi.Input.decodeList<OSPolicyResourceGroupResponse>(map['resourceGroups'], (value) => OSPolicyResourceGroupResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
