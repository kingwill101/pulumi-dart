...
class OSPolicyResponse {
  ...
  factory OSPolicyResponse.fromMap(Map<String, dynamic> map) {
    return OSPolicyResponse(
      ...
      resourceGroups: pulumi.Input.fromValue(pulumi.Input.decodeList<OSPolicyResourceGroupResponse>(map['resourceGroups']!, (value) => OSPolicyResourceGroupResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
