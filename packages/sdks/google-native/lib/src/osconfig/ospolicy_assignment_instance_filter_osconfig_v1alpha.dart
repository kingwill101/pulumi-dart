...
class OSPolicyAssignmentInstanceFilterOsconfigV1alpha {
  ...
  final pulumi.Input<List<OSPolicyAssignmentLabelSetOsconfigV1alpha>>?
  exclusionLabels;
  ...
  final pulumi.Input<
    List<OSPolicyAssignmentInstanceFilterInventoryOsconfigV1alpha>
  >?
  inventories;
    ...
    return <String, dynamic>{
      ...
      'exclusionLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<OSPolicyAssignmentLabelSetOsconfigV1alpha>,
  ...
  factory OSPolicyAssignmentInstanceFilterOsconfigV1alpha.fromMap(
    ...
    return OSPolicyAssignmentInstanceFilterOsconfigV1alpha(
      ...
      osShortNames: (() {
        final guardedValue = map['osShortNames'];
        if (guardedValue == null) return null;
