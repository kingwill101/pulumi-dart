  ...
  factory OsPolicyAssignmentOsconfigV1alphaArgs.fromMap(
    ...
    return OsPolicyAssignmentOsconfigV1alphaArgs(
      ...
      instanceFilter: pulumi.Input.fromValue(
        OSPolicyAssignmentInstanceFilterOsconfigV1alpha.fromMap(
      ...
      osPolicies: pulumi.Input.fromValue(
        pulumi.Input.decodeList<OSPolicyOsconfigV1alpha>(
          map['osPolicies']!,
      ...
      rollout: pulumi.Input.fromValue(
        OSPolicyAssignmentRolloutOsconfigV1alpha.fromMap(
