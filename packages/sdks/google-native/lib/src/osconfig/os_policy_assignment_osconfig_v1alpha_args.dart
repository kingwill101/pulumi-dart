...
class OsPolicyAssignmentOsconfigV1alphaArgs {
  ...
  const OsPolicyAssignmentOsconfigV1alphaArgs({
    this.description,
    this.etag,
  ...
  factory OsPolicyAssignmentOsconfigV1alphaArgs.fromMap(Map<String, dynamic> map) {
    return OsPolicyAssignmentOsconfigV1alphaArgs(
      ...
      instanceFilter: pulumi.Input.fromValue(OSPolicyAssignmentInstanceFilterOsconfigV1alpha.fromMap((map['instanceFilter']! as Map).cast<String, dynamic>())),
      location: (() { final guardedValue = map['location']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      osPolicies: pulumi.Input.fromValue(pulumi.Input.decodeList<OSPolicyOsconfigV1alpha>(map['osPolicies']!, (value) => OSPolicyOsconfigV1alpha.fromMap((value as Map).cast<String, dynamic>()))),
      osPolicyAssignmentId: pulumi.Input.fromValue(map['osPolicyAssignmentId'] as String),
      project: (() { final guardedValue = map['project']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      rollout: pulumi.Input.fromValue(OSPolicyAssignmentRolloutOsconfigV1alpha.fromMap((map['rollout']! as Map).cast<String, dynamic>())),
    );
  }
}
