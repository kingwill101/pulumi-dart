...
class WindowsUpdateSettingsOsconfigV1beta {
  ...
  final List<WindowsUpdateSettingsClassificationsItemOsconfigV1beta>? classifications;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'classifications': ?classifications == null ? null : pulumi.Input.encodeList<WindowsUpdateSettingsClassificationsItemOsconfigV1beta, String>(classifications!, (value) => value.value),
      'excludes': ?excludes,
  ...
  factory WindowsUpdateSettingsOsconfigV1beta.fromMap(Map<String, dynamic> map) {
    return WindowsUpdateSettingsOsconfigV1beta(
      classifications: map['classifications'] == null ? null : pulumi.Input.decodeList<WindowsUpdateSettingsClassificationsItemOsconfigV1beta>(map['classifications'], (value) => WindowsUpdateSettingsClassificationsItemOsconfigV1beta.fromValue(value as String)),
