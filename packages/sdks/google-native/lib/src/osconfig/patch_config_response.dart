...
class PatchConfigResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'apt':
          pulumi.Input.mapInputValue<AptSettingsResponse, Map<String, dynamic>>(
            apt,
            (value) => value.toMap(),
          ),
      'goo': goo,
      ...
      'postStep':
          pulumi.Input.mapInputValue<ExecStepResponse, Map<String, dynamic>>(
            postStep,
            (value) => value.toMap(),
          ),
      'preStep':
      ...
      'yum':
          pulumi.Input.mapInputValue<YumSettingsResponse, Map<String, dynamic>>(
            yum,
            (value) => value.toMap(),
          ),
      'zypper':
