...
class OSPolicyResourcePackageResourceResponseOsconfigV1alpha {
  ...
  factory OSPolicyResourcePackageResourceResponseOsconfigV1alpha.fromMap(Map<String, dynamic> map) {
    return OSPolicyResourcePackageResourceResponseOsconfigV1alpha(
      apt: (OSPolicyResourcePackageResourceAPTResponseOsconfigV1alpha.fromMap((map['apt'] as Map).cast<String, dynamic>())).input(),
      deb: (OSPolicyResourcePackageResourceDebResponseOsconfigV1alpha.fromMap((map['deb'] as Map).cast<String, dynamic>())).input(),
      desiredState: (map['desiredState'] as String).input(),
      googet: (OSPolicyResourcePackageResourceGooGetResponseOsconfigV1alpha.fromMap((map['googet'] as Map).cast<String, dynamic>())).input(),
      msi: (OSPolicyResourcePackageResourceMSIResponseOsconfigV1alpha.fromMap((map['msi'] as Map).cast<String, dynamic>())).input(),
      rpm: (OSPolicyResourcePackageResourceRPMResponseOsconfigV1alpha.fromMap((map['rpm'] as Map).cast<String, dynamic>())).input(),
      yum: (OSPolicyResourcePackageResourceYUMResponseOsconfigV1alpha.fromMap((map['yum'] as Map).cast<String, dynamic>())).input(),
      zypper: (OSPolicyResourcePackageResourceZypperResponseOsconfigV1alpha.fromMap((map['zypper'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
