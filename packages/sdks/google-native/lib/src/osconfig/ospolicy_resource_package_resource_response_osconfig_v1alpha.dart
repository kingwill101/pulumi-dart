...
class OSPolicyResourcePackageResourceResponseOsconfigV1alpha {
  ...
  final pulumi.Input<OSPolicyResourcePackageResourceAPTResponseOsconfigV1alpha>
  apt;

  /// A deb package file.
  final pulumi.Input<OSPolicyResourcePackageResourceDebResponseOsconfigV1alpha>
  deb;
  ...
  /// An MSI package.
  final pulumi.Input<OSPolicyResourcePackageResourceMSIResponseOsconfigV1alpha>
  msi;

  /// An rpm package file.
  final pulumi.Input<OSPolicyResourcePackageResourceRPMResponseOsconfigV1alpha>
  rpm;

  /// A package managed by YUM.
  final pulumi.Input<OSPolicyResourcePackageResourceYUMResponseOsconfigV1alpha>
  yum;
  ...
  factory OSPolicyResourcePackageResourceResponseOsconfigV1alpha.fromMap(
    ...
    return OSPolicyResourcePackageResourceResponseOsconfigV1alpha(
      apt: pulumi.Input.fromValue(
        OSPolicyResourcePackageResourceAPTResponseOsconfigV1alpha.fromMap(
          (map['apt']! as Map).cast<String, dynamic>(),
        ),
      ),
      deb: pulumi.Input.fromValue(
        OSPolicyResourcePackageResourceDebResponseOsconfigV1alpha.fromMap(
      ...
      msi: pulumi.Input.fromValue(
        OSPolicyResourcePackageResourceMSIResponseOsconfigV1alpha.fromMap(
          (map['msi']! as Map).cast<String, dynamic>(),
        ),
      ),
      rpm: pulumi.Input.fromValue(
        OSPolicyResourcePackageResourceRPMResponseOsconfigV1alpha.fromMap(
          (map['rpm']! as Map).cast<String, dynamic>(),
        ),
      ),
      yum: pulumi.Input.fromValue(
        OSPolicyResourcePackageResourceYUMResponseOsconfigV1alpha.fromMap(
