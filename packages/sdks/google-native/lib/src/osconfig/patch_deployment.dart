...
class PatchDeployment extends pulumi.CustomResource {
  ...
  PatchDeployment(
    ...
    this.instanceFilter = registerOutput<PatchInstanceFilterResponse>('instanceFilter');
    this.lastExecuteTime = registerOutput<String>('lastExecuteTime');
    this.name = registerOutput<String>('name');
    this.oneTimeSchedule = registerOutput<OneTimeScheduleResponse>('oneTimeSchedule');
    ...
    this.recurringSchedule = registerOutput<RecurringScheduleResponse>('recurringSchedule');
