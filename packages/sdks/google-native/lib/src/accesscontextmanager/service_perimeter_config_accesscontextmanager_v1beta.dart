...
class ServicePerimeterConfigAccesscontextmanagerV1beta {
  ...
  const ServicePerimeterConfigAccesscontextmanagerV1beta({
    this.accessLevels,
    this.resources,
  ...
  factory ServicePerimeterConfigAccesscontextmanagerV1beta.fromMap(Map<String, dynamic> map) {
    return ServicePerimeterConfigAccesscontextmanagerV1beta(
      ...
      unrestrictedServices: (() { final guardedValue = map['unrestrictedServices']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      vpcAccessibleServices: (() { final guardedValue = map['vpcAccessibleServices']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VpcAccessibleServicesAccesscontextmanagerV1beta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
