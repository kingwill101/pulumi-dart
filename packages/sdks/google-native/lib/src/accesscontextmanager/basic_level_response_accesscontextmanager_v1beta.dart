...
class BasicLevelResponseAccesscontextmanagerV1beta {
  ...
  factory BasicLevelResponseAccesscontextmanagerV1beta.fromMap(Map<String, dynamic> map) {
    return BasicLevelResponseAccesscontextmanagerV1beta(
      ...
      conditions: (pulumi.Input.decodeList<ConditionResponseAccesscontextmanagerV1beta>(map['conditions'], (value) => ConditionResponseAccesscontextmanagerV1beta.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
