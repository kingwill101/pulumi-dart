...
class BasicLevelResponseAccesscontextmanagerV1beta {
  ...
  final pulumi.Input<List<ConditionResponseAccesscontextmanagerV1beta>>
  conditions;
    ...
    return <String, dynamic>{
      ...
      'conditions':
          pulumi.Input.mapInputValue<
            List<ConditionResponseAccesscontextmanagerV1beta>,
  ...
  factory BasicLevelResponseAccesscontextmanagerV1beta.fromMap(
    ...
    return BasicLevelResponseAccesscontextmanagerV1beta(
      combiningFunction: pulumi.Input.fromValue(
