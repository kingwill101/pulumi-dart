...
class EgressPolicyResponse {
  ...
  factory EgressPolicyResponse.fromMap(Map<String, dynamic> map) {
    return EgressPolicyResponse(
      egressFrom: pulumi.Input.fromValue(EgressFromResponse.fromMap((map['egressFrom']! as Map).cast<String, dynamic>())),
      egressTo: pulumi.Input.fromValue(EgressToResponse.fromMap((map['egressTo']! as Map).cast<String, dynamic>())),
    );
  }
}
