...
/// {@template pulumi_accesscontextmanager_v1_access_policy_iam_member_args_doc}
/// The set of arguments for AccessPolicyIamMember.
/// {@endtemplate}
/// {@macro pulumi_accesscontextmanager_v1_access_policy_iam_member_args_doc}
class AccessPolicyIamMemberArgs {
  ...
  const AccessPolicyIamMemberArgs({
    this.condition,
