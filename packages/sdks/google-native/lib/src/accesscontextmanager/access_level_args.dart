...
class AccessLevelArgs {
  ...
  AccessLevelArgs({
    ...
    pulumi.Output<BasicLevel>? basic,
    pulumi.Output<CustomLevel>? custom,
  ...
  factory AccessLevelArgs.fromMap(Map<String, dynamic> map) {
    return AccessLevelArgs(
      ...
      basic: map['basic'] == null ? null : pulumi.Output.create<BasicLevel>(BasicLevel.fromMap((map['basic'] as Map).cast<String, dynamic>())),
      custom: map['custom'] == null ? null : pulumi.Output.create<CustomLevel>(CustomLevel.fromMap((map['custom'] as Map).cast<String, dynamic>())),
