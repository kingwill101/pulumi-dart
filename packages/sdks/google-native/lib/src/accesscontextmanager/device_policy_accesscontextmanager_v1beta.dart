...
class DevicePolicyAccesscontextmanagerV1beta {
  ...
  final pulumi.Input<List<OsConstraintAccesscontextmanagerV1beta>>?
  osConstraints;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'osConstraints':
          ?pulumi.Input.mapOptionalInputValue<
            List<OsConstraintAccesscontextmanagerV1beta>,
      ...
      allowedDeviceManagementLevels: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                DevicePolicyAllowedDeviceManagementLevelsItemAccesscontextmanagerV1beta.fromValue(
                  value as String,
                ),
          ),
        );
      ...
      allowedEncryptionStatuses: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                DevicePolicyAllowedEncryptionStatusesItemAccesscontextmanagerV1beta.fromValue(
                  value as String,
                ),
          ),
        );
