    ...
    return <String, dynamic>{
      ...
      'assetType':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(assetType, (value) => value.wireValue),
      'authorizationDirection':
          ?pulumi.Input.mapOptionalInputValue<
            AuthorizedOrgsDescAuthorizationDirection,
            String
          >(authorizationDirection, (value) => value.wireValue),
      'authorizationType':
          ?pulumi.Input.mapOptionalInputValue<
            AuthorizedOrgsDescAuthorizationType,
            String
          >(authorizationType, (value) => value.wireValue),
      'name': ?name,
      'orgs': ?orgs,
    };
  }
    ...
    return AuthorizedOrgsDescArgs(
      ...
      assetType: (() {
        ...
        return pulumi.Input.fromValue(
          AuthorizedOrgsDescAssetType.fromValue(guardedValue as String),
        );
      })(),
      authorizationDirection: (() {
      ...
      authorizationType: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AuthorizedOrgsDescAuthorizationType.fromValue(guardedValue as String),
        );
      })(),
      name: (() {
