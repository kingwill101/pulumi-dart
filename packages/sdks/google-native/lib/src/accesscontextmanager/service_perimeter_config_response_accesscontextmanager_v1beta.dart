...
class ServicePerimeterConfigResponseAccesscontextmanagerV1beta {
  ...
  final pulumi.Input<VpcAccessibleServicesResponseAccesscontextmanagerV1beta>
  ...
  factory ServicePerimeterConfigResponseAccesscontextmanagerV1beta.fromMap(
    Map<String, dynamic> map,
  ) {
    return ServicePerimeterConfigResponseAccesscontextmanagerV1beta(
      accessLevels: pulumi.Input.fromValue(
        (map['accessLevels'] as List).cast<String>(),
      ),
      resources: pulumi.Input.fromValue(
        (map['resources'] as List).cast<String>(),
      ),
      restrictedServices: pulumi.Input.fromValue(
        (map['restrictedServices'] as List).cast<String>(),
      ),
      unrestrictedServices: pulumi.Input.fromValue(
        (map['unrestrictedServices'] as List).cast<String>(),
      ),
      vpcAccessibleServices: pulumi.Input.fromValue(
        VpcAccessibleServicesResponseAccesscontextmanagerV1beta.fromMap(
