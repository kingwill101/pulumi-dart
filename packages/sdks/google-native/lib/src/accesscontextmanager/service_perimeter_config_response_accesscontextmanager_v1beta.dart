...
class ServicePerimeterConfigResponseAccesscontextmanagerV1beta {
  ...
  final pulumi.Input<VpcAccessibleServicesResponseAccesscontextmanagerV1beta> vpcAccessibleServices;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'vpcAccessibleServices': pulumi.Input.mapInputValue<VpcAccessibleServicesResponseAccesscontextmanagerV1beta, Map<String, dynamic>>(vpcAccessibleServices, (value) => value.toMap()),
    };
  }
  ...
  factory ServicePerimeterConfigResponseAccesscontextmanagerV1beta.fromMap(Map<String, dynamic> map) {
    return ServicePerimeterConfigResponseAccesscontextmanagerV1beta(
      accessLevels: ((map['accessLevels'] as List).cast<String>()).input(),
      resources: ((map['resources'] as List).cast<String>()).input(),
      restrictedServices: ((map['restrictedServices'] as List).cast<String>()).input(),
      unrestrictedServices: ((map['unrestrictedServices'] as List).cast<String>()).input(),
      vpcAccessibleServices: (VpcAccessibleServicesResponseAccesscontextmanagerV1beta.fromMap((map['vpcAccessibleServices'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
