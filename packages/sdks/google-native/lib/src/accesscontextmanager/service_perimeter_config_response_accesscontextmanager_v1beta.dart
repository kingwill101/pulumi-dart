...
class ServicePerimeterConfigResponseAccesscontextmanagerV1beta {
  ...
  factory ServicePerimeterConfigResponseAccesscontextmanagerV1beta.fromMap(Map<String, dynamic> map) {
    return ServicePerimeterConfigResponseAccesscontextmanagerV1beta(
      ...
      unrestrictedServices: pulumi.Input.fromValue((map['unrestrictedServices'] as List).cast<String>()),
      vpcAccessibleServices: pulumi.Input.fromValue(VpcAccessibleServicesResponseAccesscontextmanagerV1beta.fromMap((map['vpcAccessibleServices']! as Map).cast<String, dynamic>())),
    );
  }
}
