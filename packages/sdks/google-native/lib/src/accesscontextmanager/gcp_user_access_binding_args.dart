...
class GcpUserAccessBindingArgs {
  ...
  factory GcpUserAccessBindingArgs.fromMap(Map<String, dynamic> map) {
    return GcpUserAccessBindingArgs(
      ...
      dryRunAccessLevels: (() { final guardedValue = map['dryRunAccessLevels']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
