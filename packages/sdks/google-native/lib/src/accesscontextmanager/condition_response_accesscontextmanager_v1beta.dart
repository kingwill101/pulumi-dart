...
class ConditionResponseAccesscontextmanagerV1beta {
  ...
  final pulumi.Input<DevicePolicyResponseAccesscontextmanagerV1beta>
  devicePolicy;
  ...
  factory ConditionResponseAccesscontextmanagerV1beta.fromMap(
    Map<String, dynamic> map,
  ) {
    return ConditionResponseAccesscontextmanagerV1beta(
      devicePolicy: pulumi.Input.fromValue(
        DevicePolicyResponseAccesscontextmanagerV1beta.fromMap(
