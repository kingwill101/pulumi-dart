...
class ServicePerimeterAccesscontextmanagerV1betaArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'perimeterType': ?pulumi.Input.mapOptionalInputValue<ServicePerimeterPerimeterTypeAccesscontextmanagerV1beta, String>(perimeterType, (value) => value.wireValue),
      'title': ?title,
    };
  }
  ...
  factory ServicePerimeterAccesscontextmanagerV1betaArgs.fromMap(Map<String, dynamic> map) {
    return ServicePerimeterAccesscontextmanagerV1betaArgs(
      ...
      perimeterType: (() { final guardedValue = map['perimeterType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServicePerimeterPerimeterTypeAccesscontextmanagerV1beta.fromValue(guardedValue as String)); })(),
