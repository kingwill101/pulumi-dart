...
class ConditionResponse {
  ...
  factory ConditionResponse.fromMap(Map<String, dynamic> map) {
    return ConditionResponse(
      devicePolicy: pulumi.Input.fromValue(DevicePolicyResponse.fromMap((map['devicePolicy']! as Map).cast<String, dynamic>())),
      ...
      vpcNetworkSources: pulumi.Input.fromValue(pulumi.Input.decodeList<VpcNetworkSourceResponse>(map['vpcNetworkSources']!, (value) => VpcNetworkSourceResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
