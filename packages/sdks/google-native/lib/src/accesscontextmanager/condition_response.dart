...
class ConditionResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'vpcNetworkSources': pulumi.Input.encodeList<VpcNetworkSourceResponse, Map<String, dynamic>>(vpcNetworkSources, (value) => value.toMap()),
    };
  }

  factory ConditionResponse.fromMap(Map<String, dynamic> map) {
    return ConditionResponse(
      devicePolicy: DevicePolicyResponse.fromMap((map['devicePolicy'] as Map).cast<String, dynamic>()),
      ...
      requiredAccessLevels: (map['requiredAccessLevels'] as List).cast<String>(),
      vpcNetworkSources: pulumi.Input.decodeList<VpcNetworkSourceResponse>(map['vpcNetworkSources'], (value) => VpcNetworkSourceResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
