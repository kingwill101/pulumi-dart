...
class ConditionAccesscontextmanagerV1beta {
  ...
  final pulumi.Input<DevicePolicyAccesscontextmanagerV1beta>? devicePolicy;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'devicePolicy': ?pulumi.Input.mapOptionalInputValue<DevicePolicyAccesscontextmanagerV1beta, Map<String, dynamic>>(devicePolicy, (value) => value.toMap()),
  ...
  factory ConditionAccesscontextmanagerV1beta.fromMap(Map<String, dynamic> map) {
    return ConditionAccesscontextmanagerV1beta(
      devicePolicy: (() { final guardedValue = map['devicePolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DevicePolicyAccesscontextmanagerV1beta.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
