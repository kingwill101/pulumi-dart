...
class Condition {
  ...
  final pulumi.Input<DevicePolicy>? devicePolicy;
  ...
  final pulumi.Input<List<VpcNetworkSource>>? vpcNetworkSources;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'devicePolicy': ?pulumi.Input.mapOptionalInputValue<DevicePolicy, Map<String, dynamic>>(devicePolicy, (value) => value.toMap()),
      'ipSubnetworks': ?ipSubnetworks,
      'members': ?members,
      'negate': ?negate,
      'regions': ?regions,
      'requiredAccessLevels': ?requiredAccessLevels,
      'vpcNetworkSources': ?pulumi.Input.mapOptionalInputValue<List<VpcNetworkSource>, List<Map<String, dynamic>>>(vpcNetworkSources, (value) => pulumi.Input.encodeList<VpcNetworkSource, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory Condition.fromMap(Map<String, dynamic> map) {
    return Condition(
      devicePolicy: (() { final guardedValue = map['devicePolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DevicePolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      vpcNetworkSources: (() { final guardedValue = map['vpcNetworkSources']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<VpcNetworkSource>(guardedValue, (value) => VpcNetworkSource.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
