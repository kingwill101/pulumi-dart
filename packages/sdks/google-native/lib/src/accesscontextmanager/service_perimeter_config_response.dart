...
class ServicePerimeterConfigResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'egressPolicies': pulumi.Input.encodeList<EgressPolicyResponse, Map<String, dynamic>>(egressPolicies, (value) => value.toMap()),
      'ingressPolicies': pulumi.Input.encodeList<IngressPolicyResponse, Map<String, dynamic>>(ingressPolicies, (value) => value.toMap()),
      'resources': resources,
  ...
  factory ServicePerimeterConfigResponse.fromMap(Map<String, dynamic> map) {
    return ServicePerimeterConfigResponse(
      ...
      egressPolicies: pulumi.Input.decodeList<EgressPolicyResponse>(map['egressPolicies'], (value) => EgressPolicyResponse.fromMap((value as Map).cast<String, dynamic>())),
      ingressPolicies: pulumi.Input.decodeList<IngressPolicyResponse>(map['ingressPolicies'], (value) => IngressPolicyResponse.fromMap((value as Map).cast<String, dynamic>())),
      resources: (map['resources'] as List).cast<String>(),
      restrictedServices: (map['restrictedServices'] as List).cast<String>(),
      vpcAccessibleServices: VpcAccessibleServicesResponse.fromMap((map['vpcAccessibleServices'] as Map).cast<String, dynamic>()),
    );
  }
}
