...
class ServicePerimeterConfigResponse {
  ...
  factory ServicePerimeterConfigResponse.fromMap(Map<String, dynamic> map) {
    return ServicePerimeterConfigResponse(
      ...
      egressPolicies: (pulumi.Input.decodeList<EgressPolicyResponse>(map['egressPolicies'], (value) => EgressPolicyResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ingressPolicies: (pulumi.Input.decodeList<IngressPolicyResponse>(map['ingressPolicies'], (value) => IngressPolicyResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      resources: ((map['resources'] as List).cast<String>()).input(),
      restrictedServices: ((map['restrictedServices'] as List).cast<String>()).input(),
      vpcAccessibleServices: (VpcAccessibleServicesResponse.fromMap((map['vpcAccessibleServices'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
