...
class ServicePerimeterConfigResponse {
  ...
  factory ServicePerimeterConfigResponse.fromMap(Map<String, dynamic> map) {
    return ServicePerimeterConfigResponse(
      ...
      egressPolicies: pulumi.Input.fromValue(
        pulumi.Input.decodeList<EgressPolicyResponse>(
          map['egressPolicies']!,
      ...
      ingressPolicies: pulumi.Input.fromValue(
        pulumi.Input.decodeList<IngressPolicyResponse>(
          map['ingressPolicies']!,
      ...
      vpcAccessibleServices: pulumi.Input.fromValue(
        VpcAccessibleServicesResponse.fromMap(
