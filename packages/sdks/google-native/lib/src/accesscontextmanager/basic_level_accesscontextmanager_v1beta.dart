...
class BasicLevelAccesscontextmanagerV1beta {
  ...
  final BasicLevelCombiningFunctionAccesscontextmanagerV1beta? combiningFunction;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'conditions': pulumi.Input.encodeList<ConditionAccesscontextmanagerV1beta, Map<String, dynamic>>(conditions, (value) => value.toMap()),
    };
  }

  factory BasicLevelAccesscontextmanagerV1beta.fromMap(Map<String, dynamic> map) {
    return BasicLevelAccesscontextmanagerV1beta(
      combiningFunction: map['combiningFunction'] == null ? null : BasicLevelCombiningFunctionAccesscontextmanagerV1beta.fromValue(map['combiningFunction'] as String),
      conditions: pulumi.Input.decodeList<ConditionAccesscontextmanagerV1beta>(map['conditions'], (value) => ConditionAccesscontextmanagerV1beta.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
