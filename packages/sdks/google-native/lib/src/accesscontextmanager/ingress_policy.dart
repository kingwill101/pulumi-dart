...
class IngressPolicy {
  ...
  factory IngressPolicy.fromMap(Map<String, dynamic> map) {
    return IngressPolicy(
      ingressFrom: (() { final guardedValue = map['ingressFrom']; if (guardedValue == null) return null; return pulumi.Input.fromValue(IngressFrom.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ingressTo: (() { final guardedValue = map['ingressTo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(IngressTo.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
