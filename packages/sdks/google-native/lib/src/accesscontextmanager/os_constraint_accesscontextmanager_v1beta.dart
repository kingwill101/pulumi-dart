...
class OsConstraintAccesscontextmanagerV1beta {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'osType': pulumi.Input.mapInputValue<OsConstraintOsTypeAccesscontextmanagerV1beta, String>(osType, (value) => value.wireValue),
  ...
  factory OsConstraintAccesscontextmanagerV1beta.fromMap(Map<String, dynamic> map) {
    return OsConstraintAccesscontextmanagerV1beta(
      ...
      osType: pulumi.Input.fromValue(OsConstraintOsTypeAccesscontextmanagerV1beta.fromValue(map['osType']! as String)),
