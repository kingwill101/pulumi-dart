...
class BasicLevel {
  ...
  BasicLevel({this.combiningFunction, required this.conditions});
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'conditions':
          pulumi
              .Input.mapInputValue<List<Condition>, List<Map<String, dynamic>>>(
            conditions,
    ...
    return BasicLevel(
      combiningFunction: (() {
        ...
        return pulumi.Input.fromValue(
          BasicLevelCombiningFunction.fromValue(guardedValue as String),
        );
      })(),
