...
class DevicePolicyResponseAccesscontextmanagerV1beta {
  ...
  factory DevicePolicyResponseAccesscontextmanagerV1beta.fromMap(Map<String, dynamic> map) {
    return DevicePolicyResponseAccesscontextmanagerV1beta(
      allowedDeviceManagementLevels: ((map['allowedDeviceManagementLevels'] as List).cast<String>()).input(),
      allowedEncryptionStatuses: ((map['allowedEncryptionStatuses'] as List).cast<String>()).input(),
      osConstraints: (pulumi.Input.decodeList<OsConstraintResponseAccesscontextmanagerV1beta>(map['osConstraints'], (value) => OsConstraintResponseAccesscontextmanagerV1beta.fromMap((value as Map).cast<String, dynamic>()))).input(),
      requireAdminApproval: (map['requireAdminApproval'] as bool).input(),
      requireCorpOwned: (map['requireCorpOwned'] as bool).input(),
      requireScreenlock: (map['requireScreenlock'] as bool).input(),
    );
  }
}
