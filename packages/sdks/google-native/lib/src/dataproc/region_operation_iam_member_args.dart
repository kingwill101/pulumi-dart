...
/// {@template pulumi_dataproc_v1_region_operation_iam_member_args_doc}
/// The set of arguments for RegionOperationIamMember.
/// {@endtemplate}
/// {@macro pulumi_dataproc_v1_region_operation_iam_member_args_doc}
class RegionOperationIamMemberArgs {
  ...
  /// Creates a new [RegionOperationIamMemberArgs].
  ...
  const RegionOperationIamMemberArgs({
    this.condition,
  ...
  factory RegionOperationIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return RegionOperationIamMemberArgs(
