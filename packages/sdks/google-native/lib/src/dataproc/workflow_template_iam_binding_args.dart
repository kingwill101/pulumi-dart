...
/// {@template pulumi_dataproc_v1_workflow_template_iam_binding_args_doc}
/// The set of arguments for WorkflowTemplateIamBinding.
/// {@endtemplate}
/// {@macro pulumi_dataproc_v1_workflow_template_iam_binding_args_doc}
class WorkflowTemplateIamBindingArgs {
  ...
  /// Creates a new [WorkflowTemplateIamBindingArgs].
  ...
  const WorkflowTemplateIamBindingArgs({
    this.condition,
