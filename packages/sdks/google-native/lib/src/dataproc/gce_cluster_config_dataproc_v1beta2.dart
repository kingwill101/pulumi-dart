...
class GceClusterConfigDataprocV1beta2 {
  ...
  final pulumi.Input<GceClusterConfigPrivateIpv6GoogleAccessDataprocV1beta2>?
  ...
  final pulumi.Input<ShieldedInstanceConfigDataprocV1beta2>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'privateIpv6GoogleAccess':
          ?pulumi.Input.mapOptionalInputValue<
            GceClusterConfigPrivateIpv6GoogleAccessDataprocV1beta2,
            String
  ...
  factory GceClusterConfigDataprocV1beta2.fromMap(Map<String, dynamic> map) {
    return GceClusterConfigDataprocV1beta2(
      ...
      zoneUri: (() {
        final guardedValue = map['zoneUri'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
