...
class GkeNodePoolTarget {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'roles': pulumi.Input.mapInputValue<List<GkeNodePoolTargetRolesItem>, List<String>>(roles, (value) => pulumi.Input.encodeList<GkeNodePoolTargetRolesItem, String>(value, (value) => value.value)),
    };
  }
