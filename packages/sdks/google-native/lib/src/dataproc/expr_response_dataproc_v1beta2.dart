...
class ExprResponseDataprocV1beta2 {
  ...
  /// Creates a new [ExprResponseDataprocV1beta2].
  ...
  const ExprResponseDataprocV1beta2({
  ...
  factory ExprResponseDataprocV1beta2.fromMap(Map<String, dynamic> map) {
    return ExprResponseDataprocV1beta2(
