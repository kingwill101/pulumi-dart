...
/// {@template pulumi_dataproc_v1beta2_region_autoscaling_policy_iam_binding_dataproc_v1beta2_args_doc}
/// The set of arguments for RegionAutoscalingPolicyIamBinding.
/// {@endtemplate}
/// {@macro pulumi_dataproc_v1beta2_region_autoscaling_policy_iam_binding_dataproc_v1beta2_args_doc}
class RegionAutoscalingPolicyIamBindingDataprocV1beta2Args {
  ...
  /// Creates a new [RegionAutoscalingPolicyIamBindingDataprocV1beta2Args].
  ...
  const RegionAutoscalingPolicyIamBindingDataprocV1beta2Args({
    this.condition,
  ...
  factory RegionAutoscalingPolicyIamBindingDataprocV1beta2Args.fromMap(Map<String, dynamic> map) {
    return RegionAutoscalingPolicyIamBindingDataprocV1beta2Args(
