...
class SecurityConfig {
  ...
  factory SecurityConfig.fromMap(Map<String, dynamic> map) {
    return SecurityConfig(
      identityConfig: (() { final guardedValue = map['identityConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(IdentityConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      kerberosConfig: (() { final guardedValue = map['kerberosConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(KerberosConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
