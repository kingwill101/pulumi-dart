...
import 'region_cluster_iam_member_args.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy.Can return NOT_FOUND, INVALID_ARGUMENT, and PERMISSION_DENIED errors.
class RegionClusterIamMember extends pulumi.CustomResource {
  ...
  /// Creates a new [RegionClusterIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [RegionClusterIamMember]. {@macro pulumi_dataproc_v1_region_cluster_iam_member_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  RegionClusterIamMember(
    String name, {
    RegionClusterIamMemberArgs? args,
