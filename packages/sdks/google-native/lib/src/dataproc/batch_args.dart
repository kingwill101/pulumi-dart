  ...
  factory BatchArgs.fromMap(Map<String, dynamic> map) {
    return BatchArgs(
      ...
      pysparkBatch: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PySparkBatch.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      requestId: (() {
      ...
      sparkBatch: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SparkBatch.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      sparkRBatch: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SparkRBatch.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      sparkSqlBatch: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SparkSqlBatch.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
