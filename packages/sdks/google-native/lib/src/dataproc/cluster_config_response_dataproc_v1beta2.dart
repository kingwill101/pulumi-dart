...
class ClusterConfigResponseDataprocV1beta2 {
  ...
  final List<NodeInitializationActionResponseDataprocV1beta2> initializationActions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'initializationActions': pulumi.Input.encodeList<NodeInitializationActionResponseDataprocV1beta2, Map<String, dynamic>>(initializationActions, (value) => value.toMap()),
  ...
  factory ClusterConfigResponseDataprocV1beta2.fromMap(Map<String, dynamic> map) {
    return ClusterConfigResponseDataprocV1beta2(
      autoscalingConfig: AutoscalingConfigResponseDataprocV1beta2.fromMap((map['autoscalingConfig'] as Map).cast<String, dynamic>()),
      configBucket: map['configBucket'] as String,
      encryptionConfig: EncryptionConfigResponseDataprocV1beta2.fromMap((map['encryptionConfig'] as Map).cast<String, dynamic>()),
      endpointConfig: EndpointConfigResponseDataprocV1beta2.fromMap((map['endpointConfig'] as Map).cast<String, dynamic>()),
      gceClusterConfig: GceClusterConfigResponseDataprocV1beta2.fromMap((map['gceClusterConfig'] as Map).cast<String, dynamic>()),
      gkeClusterConfig: GkeClusterConfigResponseDataprocV1beta2.fromMap((map['gkeClusterConfig'] as Map).cast<String, dynamic>()),
      initializationActions: pulumi.Input.decodeList<NodeInitializationActionResponseDataprocV1beta2>(map['initializationActions'], (value) => NodeInitializationActionResponseDataprocV1beta2.fromMap((value as Map).cast<String, dynamic>())),
      lifecycleConfig: LifecycleConfigResponseDataprocV1beta2.fromMap((map['lifecycleConfig'] as Map).cast<String, dynamic>()),
      masterConfig: InstanceGroupConfigResponseDataprocV1beta2.fromMap((map['masterConfig'] as Map).cast<String, dynamic>()),
      metastoreConfig: MetastoreConfigResponseDataprocV1beta2.fromMap((map['metastoreConfig'] as Map).cast<String, dynamic>()),
      secondaryWorkerConfig: InstanceGroupConfigResponseDataprocV1beta2.fromMap((map['secondaryWorkerConfig'] as Map).cast<String, dynamic>()),
      securityConfig: SecurityConfigResponseDataprocV1beta2.fromMap((map['securityConfig'] as Map).cast<String, dynamic>()),
      softwareConfig: SoftwareConfigResponseDataprocV1beta2.fromMap((map['softwareConfig'] as Map).cast<String, dynamic>()),
      tempBucket: map['tempBucket'] as String,
      workerConfig: InstanceGroupConfigResponseDataprocV1beta2.fromMap((map['workerConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
