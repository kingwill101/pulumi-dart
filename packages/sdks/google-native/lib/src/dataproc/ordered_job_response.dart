...
class OrderedJobResponse {
  ...
  factory OrderedJobResponse.fromMap(Map<String, dynamic> map) {
    return OrderedJobResponse(
      flinkJob: pulumi.Input.fromValue(FlinkJobResponse.fromMap((map['flinkJob']! as Map).cast<String, dynamic>())),
      hadoopJob: pulumi.Input.fromValue(HadoopJobResponse.fromMap((map['hadoopJob']! as Map).cast<String, dynamic>())),
      hiveJob: pulumi.Input.fromValue(HiveJobResponse.fromMap((map['hiveJob']! as Map).cast<String, dynamic>())),
      labels: pulumi.Input.fromValue((map['labels'] as Map).cast<String, String>()),
      pigJob: pulumi.Input.fromValue(PigJobResponse.fromMap((map['pigJob']! as Map).cast<String, dynamic>())),
      prerequisiteStepIds: pulumi.Input.fromValue((map['prerequisiteStepIds'] as List).cast<String>()),
      prestoJob: pulumi.Input.fromValue(PrestoJobResponse.fromMap((map['prestoJob']! as Map).cast<String, dynamic>())),
      pysparkJob: pulumi.Input.fromValue(PySparkJobResponse.fromMap((map['pysparkJob']! as Map).cast<String, dynamic>())),
      scheduling: pulumi.Input.fromValue(JobSchedulingResponse.fromMap((map['scheduling']! as Map).cast<String, dynamic>())),
      sparkJob: pulumi.Input.fromValue(SparkJobResponse.fromMap((map['sparkJob']! as Map).cast<String, dynamic>())),
      sparkRJob: pulumi.Input.fromValue(SparkRJobResponse.fromMap((map['sparkRJob']! as Map).cast<String, dynamic>())),
      sparkSqlJob: pulumi.Input.fromValue(SparkSqlJobResponse.fromMap((map['sparkSqlJob']! as Map).cast<String, dynamic>())),
      stepId: pulumi.Input.fromValue(map['stepId'] as String),
      trinoJob: pulumi.Input.fromValue(TrinoJobResponse.fromMap((map['trinoJob']! as Map).cast<String, dynamic>())),
    );
  }
}
