...
class GkeClusterConfigResponse {
  ...
  final pulumi.Input<NamespacedGkeDeploymentTargetResponse>
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'nodePoolTarget':
          pulumi.Input.mapInputValue<
            List<GkeNodePoolTargetResponse>,
  ...
  factory GkeClusterConfigResponse.fromMap(Map<String, dynamic> map) {
    return GkeClusterConfigResponse(
      gkeClusterTarget: pulumi.Input.fromValue(
        map['gkeClusterTarget'] as String,
      ),
      namespacedGkeDeploymentTarget: pulumi.Input.fromValue(
        NamespacedGkeDeploymentTargetResponse.fromMap(
          (map['namespacedGkeDeploymentTarget']! as Map)
              .cast<String, dynamic>(),
        ),
      ),
      nodePoolTarget: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GkeNodePoolTargetResponse>(
          map['nodePoolTarget']!,
