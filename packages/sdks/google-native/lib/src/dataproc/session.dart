...
class Session extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<SessionStateHistoryResponse>> stateHistory;
  ...
  Session(
    ...
    this.environmentConfig = registerOutput<EnvironmentConfigResponse>('environmentConfig');
    this.jupyterSession = registerOutput<JupyterConfigResponse>('jupyterSession');
    ...
    this.stateHistory = registerOutput<List<SessionStateHistoryResponse>>('stateHistory');
