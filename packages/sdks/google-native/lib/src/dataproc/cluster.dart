...
class Cluster extends pulumi.CustomResource {
  ...
  Cluster(
    ...
    this.actionOnFailedPrimaryWorkers = registerOutput<String?>('actionOnFailedPrimaryWorkers');
    ...
    this.statusHistory = registerOutput<List<ClusterStatusResponse>>('statusHistory');
    this.virtualClusterConfig = registerOutput<VirtualClusterConfigResponse>('virtualClusterConfig');
  }
}
