...
/// {@template pulumi_dataproc_v1beta2_region_autoscaling_policy_iam_member_dataproc_v1beta2_args_doc}
/// The set of arguments for RegionAutoscalingPolicyIamMember.
/// {@endtemplate}
/// {@macro pulumi_dataproc_v1beta2_region_autoscaling_policy_iam_member_dataproc_v1beta2_args_doc}
class RegionAutoscalingPolicyIamMemberDataprocV1beta2Args {
  ...
  /// Creates a new [RegionAutoscalingPolicyIamMemberDataprocV1beta2Args].
  ...
  const RegionAutoscalingPolicyIamMemberDataprocV1beta2Args({
    this.condition,
  ...
  factory RegionAutoscalingPolicyIamMemberDataprocV1beta2Args.fromMap(Map<String, dynamic> map) {
    return RegionAutoscalingPolicyIamMemberDataprocV1beta2Args(
