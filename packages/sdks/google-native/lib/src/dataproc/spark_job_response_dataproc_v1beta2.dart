...
class SparkJobResponseDataprocV1beta2 {
  ...
  /// Creates a new [SparkJobResponseDataprocV1beta2].
  ...
  factory SparkJobResponseDataprocV1beta2.fromMap(Map<String, dynamic> map) {
    return SparkJobResponseDataprocV1beta2(
