...
/// {@template pulumi_dataproc_v1beta2_workflow_template_iam_binding_dataproc_v1beta2_args_doc}
/// The set of arguments for WorkflowTemplateIamBinding.
/// {@endtemplate}
/// {@macro pulumi_dataproc_v1beta2_workflow_template_iam_binding_dataproc_v1beta2_args_doc}
class WorkflowTemplateIamBindingDataprocV1beta2Args {
  ...
  /// Creates a new [WorkflowTemplateIamBindingDataprocV1beta2Args].
  ...
  const WorkflowTemplateIamBindingDataprocV1beta2Args({
    this.condition,
  ...
  factory WorkflowTemplateIamBindingDataprocV1beta2Args.fromMap(Map<String, dynamic> map) {
