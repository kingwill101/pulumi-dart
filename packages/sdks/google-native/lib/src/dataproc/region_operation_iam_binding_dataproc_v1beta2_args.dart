...
/// {@template pulumi_dataproc_v1beta2_region_operation_iam_binding_dataproc_v1beta2_args_doc}
/// The set of arguments for RegionOperationIamBinding.
/// {@endtemplate}
/// {@macro pulumi_dataproc_v1beta2_region_operation_iam_binding_dataproc_v1beta2_args_doc}
class RegionOperationIamBindingDataprocV1beta2Args {
  ...
  /// Creates a new [RegionOperationIamBindingDataprocV1beta2Args].
  ...
  RegionOperationIamBindingDataprocV1beta2Args({
    this.condition,
  ...
  factory RegionOperationIamBindingDataprocV1beta2Args.fromMap(
