...
class GkeNodePoolConfig {
  ...
  factory GkeNodePoolConfig.fromMap(Map<String, dynamic> map) {
    return GkeNodePoolConfig(
      autoscaling: map['autoscaling'] == null ? null : GkeNodePoolAutoscalingConfig.fromMap((map['autoscaling'] as Map).cast<String, dynamic>()),
      config: map['config'] == null ? null : GkeNodeConfig.fromMap((map['config'] as Map).cast<String, dynamic>()),
