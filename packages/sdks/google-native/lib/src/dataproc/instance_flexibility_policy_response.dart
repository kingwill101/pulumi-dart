...
class InstanceFlexibilityPolicyResponse {
  ...
  final pulumi.Input<List<InstanceSelectionResultResponse>>
    ...
    return <String, dynamic>{
      'instanceSelectionList':
          pulumi.Input.mapInputValue<
            List<InstanceSelectionResponse>,
      ...
      'instanceSelectionResults':
          pulumi.Input.mapInputValue<
            List<InstanceSelectionResultResponse>,
            List<Map<String, dynamic>>
          >(
            instanceSelectionResults,
            (value) =>
  ...
  factory InstanceFlexibilityPolicyResponse.fromMap(Map<String, dynamic> map) {
    return InstanceFlexibilityPolicyResponse(
      instanceSelectionList: pulumi.Input.fromValue(
        pulumi.Input.decodeList<InstanceSelectionResponse>(
      ...
      instanceSelectionResults: pulumi.Input.fromValue(
