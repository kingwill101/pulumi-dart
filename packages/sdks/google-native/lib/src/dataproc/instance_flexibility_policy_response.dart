...
class InstanceFlexibilityPolicyResponse {
  ...
  factory InstanceFlexibilityPolicyResponse.fromMap(Map<String, dynamic> map) {
    return InstanceFlexibilityPolicyResponse(
      instanceSelectionList: (pulumi.Input.decodeList<InstanceSelectionResponse>(map['instanceSelectionList'], (value) => InstanceSelectionResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      instanceSelectionResults: (pulumi.Input.decodeList<InstanceSelectionResultResponse>(map['instanceSelectionResults'], (value) => InstanceSelectionResultResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
