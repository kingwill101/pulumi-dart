...
class HiveJob {
  ...
  factory HiveJob.fromMap(Map<String, dynamic> map) {
    return HiveJob(
      ...
      queryList: (() { final guardedValue = map['queryList']; if (guardedValue == null) return null; return pulumi.Input.fromValue(QueryList.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
