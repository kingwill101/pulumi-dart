...
/// {@template pulumi_dataproc_v1_region_cluster_iam_binding_args_doc}
/// The set of arguments for RegionClusterIamBinding.
/// {@endtemplate}
/// {@macro pulumi_dataproc_v1_region_cluster_iam_binding_args_doc}
class RegionClusterIamBindingArgs {
  ...
  /// Creates a new [RegionClusterIamBindingArgs].
  ...
  const RegionClusterIamBindingArgs({
    this.condition,
  ...
  factory RegionClusterIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return RegionClusterIamBindingArgs(
