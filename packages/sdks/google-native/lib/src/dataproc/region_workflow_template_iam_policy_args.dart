...
/// {@template pulumi_dataproc_v1_region_workflow_template_iam_policy_args_doc}
/// The set of arguments for RegionWorkflowTemplateIamPolicy.
/// {@endtemplate}
/// {@macro pulumi_dataproc_v1_region_workflow_template_iam_policy_args_doc}
class RegionWorkflowTemplateIamPolicyArgs {
  ...
  /// Creates a new [RegionWorkflowTemplateIamPolicyArgs].
  ...
  const RegionWorkflowTemplateIamPolicyArgs({
    this.bindings,
    this.etag,
    this.project,
  ...
  factory RegionWorkflowTemplateIamPolicyArgs.fromMap(Map<String, dynamic> map) {
