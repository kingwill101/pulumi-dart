...
class KerberosConfigResponseDataprocV1beta2 {
  ...
  const KerberosConfigResponseDataprocV1beta2({
  ...
  factory KerberosConfigResponseDataprocV1beta2.fromMap(Map<String, dynamic> map) {
    return KerberosConfigResponseDataprocV1beta2(
      crossRealmTrustAdminServer: pulumi.Input.fromValue(map['crossRealmTrustAdminServer'] as String),
      crossRealmTrustKdc: pulumi.Input.fromValue(map['crossRealmTrustKdc'] as String),
      crossRealmTrustRealm: pulumi.Input.fromValue(map['crossRealmTrustRealm'] as String),
      crossRealmTrustSharedPasswordUri: pulumi.Input.fromValue(map['crossRealmTrustSharedPasswordUri'] as String),
      ...
      keystorePasswordUri: pulumi.Input.fromValue(map['keystorePasswordUri'] as String),
      ...
      rootPrincipalPasswordUri: pulumi.Input.fromValue(map['rootPrincipalPasswordUri'] as String),
      tgtLifetimeHours: pulumi.Input.fromValue(map['tgtLifetimeHours'] as int),
      truststorePasswordUri: pulumi.Input.fromValue(map['truststorePasswordUri'] as String),
