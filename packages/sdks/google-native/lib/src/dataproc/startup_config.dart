...
class StartupConfig {
  ...
  factory StartupConfig.fromMap(Map<String, dynamic> map) {
    return StartupConfig(
      requiredRegistrationFraction: (() { final guardedValue = map['requiredRegistrationFraction']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as double); })(),
    );
  }
}
