...
/// {@template pulumi_dataproc_v1beta2_autoscaling_policy_iam_member_dataproc_v1beta2_args_doc}
/// The set of arguments for AutoscalingPolicyIamMember.
/// {@endtemplate}
/// {@macro pulumi_dataproc_v1beta2_autoscaling_policy_iam_member_dataproc_v1beta2_args_doc}
class AutoscalingPolicyIamMemberDataprocV1beta2Args {
  ...
  /// Creates a new [AutoscalingPolicyIamMemberDataprocV1beta2Args].
  ...
  const AutoscalingPolicyIamMemberDataprocV1beta2Args({
    this.condition,
  ...
  factory AutoscalingPolicyIamMemberDataprocV1beta2Args.fromMap(Map<String, dynamic> map) {
    return AutoscalingPolicyIamMemberDataprocV1beta2Args(
