...
class GkeNodeConfigResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'accelerators': pulumi.Input.encodeList<GkeNodePoolAcceleratorConfigResponse, Map<String, dynamic>>(accelerators, (value) => value.toMap()),
  ...
  factory GkeNodeConfigResponse.fromMap(Map<String, dynamic> map) {
    return GkeNodeConfigResponse(
      accelerators: pulumi.Input.decodeList<GkeNodePoolAcceleratorConfigResponse>(map['accelerators'], (value) => GkeNodePoolAcceleratorConfigResponse.fromMap((value as Map).cast<String, dynamic>())),
