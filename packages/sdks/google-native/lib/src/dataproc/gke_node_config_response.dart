...
class GkeNodeConfigResponse {
  ...
  factory GkeNodeConfigResponse.fromMap(Map<String, dynamic> map) {
    return GkeNodeConfigResponse(
      accelerators: (pulumi.Input.decodeList<GkeNodePoolAcceleratorConfigResponse>(map['accelerators'], (value) => GkeNodePoolAcceleratorConfigResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
