...
class PySparkJobResponseDataprocV1beta2 {
  ...
  /// Creates a new [PySparkJobResponseDataprocV1beta2].
  ...
  const PySparkJobResponseDataprocV1beta2({
  ...
  factory PySparkJobResponseDataprocV1beta2.fromMap(Map<String, dynamic> map) {
    return PySparkJobResponseDataprocV1beta2(
