...
class ClusterDataprocV1beta2 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<ClusterStatusResponseDataprocV1beta2>> statusHistory;
  ...
  ClusterDataprocV1beta2(
    ...
    this.config = registerOutput<ClusterConfigResponseDataprocV1beta2>('config');
    this.labels = registerOutput<Map<String, String>>('labels');
    this.metrics = registerOutput<ClusterMetricsResponseDataprocV1beta2>('metrics');
    this.project = registerOutput<String>('project');
    this.region = registerOutput<String>('region');
    this.requestId = registerOutput<String?>('requestId');
    this.status = registerOutput<ClusterStatusResponseDataprocV1beta2>('status');
    this.statusHistory = registerOutput<List<ClusterStatusResponseDataprocV1beta2>>('statusHistory');
  }
}
