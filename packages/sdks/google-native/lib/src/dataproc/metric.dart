...
class Metric {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'metricSource': pulumi.Input.mapInputValue<MetricMetricSource, String>(metricSource, (value) => value.wireValue),
    };
  }
  ...
  factory Metric.fromMap(Map<String, dynamic> map) {
    return Metric(
      ...
      metricSource: pulumi.Input.fromValue(MetricMetricSource.fromValue(map['metricSource']! as String)),
    );
  }
}
