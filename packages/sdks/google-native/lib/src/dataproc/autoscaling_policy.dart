...
class AutoscalingPolicy extends pulumi.CustomResource {
  ...
  AutoscalingPolicy(
    ...
    this.basicAlgorithm = registerOutput<BasicAutoscalingAlgorithmResponse>('basicAlgorithm');
    this.labels = registerOutput<Map<String, String>>('labels');
    this.location = registerOutput<String>('location');
    this.name = registerOutput<String>('name');
    this.project = registerOutput<String>('project');
    this.secondaryWorkerConfig = registerOutput<InstanceGroupAutoscalingPolicyConfigResponse>('secondaryWorkerConfig');
    this.workerConfig = registerOutput<InstanceGroupAutoscalingPolicyConfigResponse>('workerConfig');
  }
}
