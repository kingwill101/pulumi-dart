...
class JobDataprocV1beta2Args {
  ...
  JobDataprocV1beta2Args({
    pulumi.Output<HadoopJobDataprocV1beta2>? hadoopJob,
    pulumi.Output<HiveJobDataprocV1beta2>? hiveJob,
    pulumi.Output<Map<String, String>>? labels,
    pulumi.Output<PigJobDataprocV1beta2>? pigJob,
    required pulumi.Output<JobPlacementDataprocV1beta2> placement,
    pulumi.Output<PrestoJobDataprocV1beta2>? prestoJob,
    pulumi.Output<String>? project,
    pulumi.Output<PySparkJobDataprocV1beta2>? pysparkJob,
    pulumi.Output<JobReferenceDataprocV1beta2>? reference,
    required pulumi.Output<String> region,
    pulumi.Output<String>? requestId,
    pulumi.Output<JobSchedulingDataprocV1beta2>? scheduling,
    pulumi.Output<SparkJobDataprocV1beta2>? sparkJob,
    pulumi.Output<SparkRJobDataprocV1beta2>? sparkRJob,
    pulumi.Output<SparkSqlJobDataprocV1beta2>? sparkSqlJob,
  }) :
      hadoopJob = pulumi.Input.asOptionalInput<HadoopJobDataprocV1beta2>(hadoopJob),
      ...
      prestoJob = pulumi.Input.asOptionalInput<PrestoJobDataprocV1beta2>(prestoJob),
      project = pulumi.Input.asOptionalInput<String>(project),
      pysparkJob = pulumi.Input.asOptionalInput<PySparkJobDataprocV1beta2>(pysparkJob),
      reference = pulumi.Input.asOptionalInput<JobReferenceDataprocV1beta2>(reference),
      region = pulumi.Input.asInput<String>(region),
      requestId = pulumi.Input.asOptionalInput<String>(requestId),
      scheduling = pulumi.Input.asOptionalInput<JobSchedulingDataprocV1beta2>(scheduling),
      sparkJob = pulumi.Input.asOptionalInput<SparkJobDataprocV1beta2>(sparkJob),
      sparkRJob = pulumi.Input.asOptionalInput<SparkRJobDataprocV1beta2>(sparkRJob),
      sparkSqlJob = pulumi.Input.asOptionalInput<SparkSqlJobDataprocV1beta2>(sparkSqlJob);
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'placement': pulumi.Input.mapInputValue<JobPlacementDataprocV1beta2, Map<String, dynamic>>(placement, (value) => value.toMap()),
      ...
      'reference': ?pulumi.Input.mapOptionalInputValue<JobReferenceDataprocV1beta2, Map<String, dynamic>>(reference, (value) => value.toMap()),
      'region': region,
      'requestId': ?requestId,
  ...
  factory JobDataprocV1beta2Args.fromMap(Map<String, dynamic> map) {
    return JobDataprocV1beta2Args(
      hadoopJob: map['hadoopJob'] == null ? null : pulumi.Output.create<HadoopJobDataprocV1beta2>(HadoopJobDataprocV1beta2.fromMap((map['hadoopJob'] as Map).cast<String, dynamic>())),
      hiveJob: map['hiveJob'] == null ? null : pulumi.Output.create<HiveJobDataprocV1beta2>(HiveJobDataprocV1beta2.fromMap((map['hiveJob'] as Map).cast<String, dynamic>())),
      labels: map['labels'] == null ? null : pulumi.Output.create<Map<String, String>>((map['labels'] as Map).cast<String, String>()),
      pigJob: map['pigJob'] == null ? null : pulumi.Output.create<PigJobDataprocV1beta2>(PigJobDataprocV1beta2.fromMap((map['pigJob'] as Map).cast<String, dynamic>())),
      placement: pulumi.Output.create<JobPlacementDataprocV1beta2>(JobPlacementDataprocV1beta2.fromMap((map['placement'] as Map).cast<String, dynamic>())),
      prestoJob: map['prestoJob'] == null ? null : pulumi.Output.create<PrestoJobDataprocV1beta2>(PrestoJobDataprocV1beta2.fromMap((map['prestoJob'] as Map).cast<String, dynamic>())),
      project: map['project'] == null ? null : pulumi.Output.create<String>(map['project'] as String),
      pysparkJob: map['pysparkJob'] == null ? null : pulumi.Output.create<PySparkJobDataprocV1beta2>(PySparkJobDataprocV1beta2.fromMap((map['pysparkJob'] as Map).cast<String, dynamic>())),
      reference: map['reference'] == null ? null : pulumi.Output.create<JobReferenceDataprocV1beta2>(JobReferenceDataprocV1beta2.fromMap((map['reference'] as Map).cast<String, dynamic>())),
      region: pulumi.Output.create<String>(map['region'] as String),
      requestId: map['requestId'] == null ? null : pulumi.Output.create<String>(map['requestId'] as String),
      scheduling: map['scheduling'] == null ? null : pulumi.Output.create<JobSchedulingDataprocV1beta2>(JobSchedulingDataprocV1beta2.fromMap((map['scheduling'] as Map).cast<String, dynamic>())),
      sparkJob: map['sparkJob'] == null ? null : pulumi.Output.create<SparkJobDataprocV1beta2>(SparkJobDataprocV1beta2.fromMap((map['sparkJob'] as Map).cast<String, dynamic>())),
      sparkRJob: map['sparkRJob'] == null ? null : pulumi.Output.create<SparkRJobDataprocV1beta2>(SparkRJobDataprocV1beta2.fromMap((map['sparkRJob'] as Map).cast<String, dynamic>())),
      sparkSqlJob: map['sparkSqlJob'] == null ? null : pulumi.Output.create<SparkSqlJobDataprocV1beta2>(SparkSqlJobDataprocV1beta2.fromMap((map['sparkSqlJob'] as Map).cast<String, dynamic>())),
    );
  }
}
