...
class JobDataprocV1beta2Args {
  ...
  factory JobDataprocV1beta2Args.fromMap(Map<String, dynamic> map) {
    return JobDataprocV1beta2Args(
      ...
      placement: pulumi.Input.fromValue(JobPlacementDataprocV1beta2.fromMap((map['placement']! as Map).cast<String, dynamic>())),
      ...
      reference: (() { final guardedValue = map['reference']; if (guardedValue == null) return null; return pulumi.Input.fromValue(JobReferenceDataprocV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
