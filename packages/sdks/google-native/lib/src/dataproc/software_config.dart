...
class SoftwareConfig {
  ...
  final pulumi.Input<List<SoftwareConfigOptionalComponentsItem>>?
  optionalComponents;
    ...
    return <String, dynamic>{
      ...
      'optionalComponents':
          ?pulumi.Input.mapOptionalInputValue<
            List<SoftwareConfigOptionalComponentsItem>,
            List<String>
          >(
            optionalComponents,
            (value) =>
      ...
      optionalComponents: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SoftwareConfigOptionalComponentsItem>(
            guardedValue,
            (value) =>
                SoftwareConfigOptionalComponentsItem.fromValue(value as String),
          ),
        );
      })(),
      properties: (() {
