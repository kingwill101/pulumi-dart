...
/// {@template pulumi_dataproc_v1beta2_region_cluster_iam_binding_dataproc_v1beta2_args_doc}
/// The set of arguments for RegionClusterIamBinding.
/// {@endtemplate}
/// {@macro pulumi_dataproc_v1beta2_region_cluster_iam_binding_dataproc_v1beta2_args_doc}
class RegionClusterIamBindingDataprocV1beta2Args {
  ...
  /// Creates a new [RegionClusterIamBindingDataprocV1beta2Args].
  ...
  const RegionClusterIamBindingDataprocV1beta2Args({
    this.condition,
  ...
  factory RegionClusterIamBindingDataprocV1beta2Args.fromMap(Map<String, dynamic> map) {
