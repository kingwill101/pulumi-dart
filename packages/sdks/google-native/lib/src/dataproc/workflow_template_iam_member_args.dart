...
/// {@template pulumi_dataproc_v1_workflow_template_iam_member_args_doc}
/// The set of arguments for WorkflowTemplateIamMember.
/// {@endtemplate}
/// {@macro pulumi_dataproc_v1_workflow_template_iam_member_args_doc}
class WorkflowTemplateIamMemberArgs {
  ...
  /// Creates a new [WorkflowTemplateIamMemberArgs].
  ...
  const WorkflowTemplateIamMemberArgs({
    this.condition,
  ...
  factory WorkflowTemplateIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return WorkflowTemplateIamMemberArgs(
