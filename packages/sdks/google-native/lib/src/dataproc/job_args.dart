...
class JobArgs {
  ...
  JobArgs({
    pulumi.Output<DriverSchedulingConfig>? driverSchedulingConfig,
    pulumi.Output<FlinkJob>? flinkJob,
    pulumi.Output<HadoopJob>? hadoopJob,
    pulumi.Output<HiveJob>? hiveJob,
    pulumi.Output<Map<String, String>>? labels,
    pulumi.Output<PigJob>? pigJob,
    required pulumi.Output<JobPlacement> placement,
    pulumi.Output<PrestoJob>? prestoJob,
    pulumi.Output<String>? project,
    pulumi.Output<PySparkJob>? pysparkJob,
    pulumi.Output<JobReference>? reference,
    required pulumi.Output<String> region,
    pulumi.Output<String>? requestId,
    pulumi.Output<JobScheduling>? scheduling,
    pulumi.Output<SparkJob>? sparkJob,
    pulumi.Output<SparkRJob>? sparkRJob,
    pulumi.Output<SparkSqlJob>? sparkSqlJob,
    pulumi.Output<TrinoJob>? trinoJob,
  }) :
      driverSchedulingConfig = pulumi.Input.asOptionalInput<DriverSchedulingConfig>(driverSchedulingConfig),
  ...
  factory JobArgs.fromMap(Map<String, dynamic> map) {
    return JobArgs(
      driverSchedulingConfig: map['driverSchedulingConfig'] == null ? null : pulumi.Output.create<DriverSchedulingConfig>(DriverSchedulingConfig.fromMap((map['driverSchedulingConfig'] as Map).cast<String, dynamic>())),
      flinkJob: map['flinkJob'] == null ? null : pulumi.Output.create<FlinkJob>(FlinkJob.fromMap((map['flinkJob'] as Map).cast<String, dynamic>())),
      hadoopJob: map['hadoopJob'] == null ? null : pulumi.Output.create<HadoopJob>(HadoopJob.fromMap((map['hadoopJob'] as Map).cast<String, dynamic>())),
      hiveJob: map['hiveJob'] == null ? null : pulumi.Output.create<HiveJob>(HiveJob.fromMap((map['hiveJob'] as Map).cast<String, dynamic>())),
      labels: map['labels'] == null ? null : pulumi.Output.create<Map<String, String>>((map['labels'] as Map).cast<String, String>()),
      pigJob: map['pigJob'] == null ? null : pulumi.Output.create<PigJob>(PigJob.fromMap((map['pigJob'] as Map).cast<String, dynamic>())),
      placement: pulumi.Output.create<JobPlacement>(JobPlacement.fromMap((map['placement'] as Map).cast<String, dynamic>())),
      prestoJob: map['prestoJob'] == null ? null : pulumi.Output.create<PrestoJob>(PrestoJob.fromMap((map['prestoJob'] as Map).cast<String, dynamic>())),
      project: map['project'] == null ? null : pulumi.Output.create<String>(map['project'] as String),
      pysparkJob: map['pysparkJob'] == null ? null : pulumi.Output.create<PySparkJob>(PySparkJob.fromMap((map['pysparkJob'] as Map).cast<String, dynamic>())),
      ...
      sparkJob: map['sparkJob'] == null ? null : pulumi.Output.create<SparkJob>(SparkJob.fromMap((map['sparkJob'] as Map).cast<String, dynamic>())),
      sparkRJob: map['sparkRJob'] == null ? null : pulumi.Output.create<SparkRJob>(SparkRJob.fromMap((map['sparkRJob'] as Map).cast<String, dynamic>())),
      sparkSqlJob: map['sparkSqlJob'] == null ? null : pulumi.Output.create<SparkSqlJob>(SparkSqlJob.fromMap((map['sparkSqlJob'] as Map).cast<String, dynamic>())),
      trinoJob: map['trinoJob'] == null ? null : pulumi.Output.create<TrinoJob>(TrinoJob.fromMap((map['trinoJob'] as Map).cast<String, dynamic>())),
    );
  }
}
