...
/// {@template pulumi_dataproc_v1beta2_region_cluster_iam_member_dataproc_v1beta2_args_doc}
/// The set of arguments for RegionClusterIamMember.
/// {@endtemplate}
/// {@macro pulumi_dataproc_v1beta2_region_cluster_iam_member_dataproc_v1beta2_args_doc}
class RegionClusterIamMemberDataprocV1beta2Args {
  ...
  /// Creates a new [RegionClusterIamMemberDataprocV1beta2Args].
  ...
  const RegionClusterIamMemberDataprocV1beta2Args({
    this.condition,
  ...
  factory RegionClusterIamMemberDataprocV1beta2Args.fromMap(Map<String, dynamic> map) {
    return RegionClusterIamMemberDataprocV1beta2Args(
