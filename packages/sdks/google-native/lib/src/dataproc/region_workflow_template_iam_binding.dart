...
import 'region_workflow_template_iam_binding_args.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy.Can return NOT_FOUND, INVALID_ARGUMENT, and PERMISSION_DENIED errors.
class RegionWorkflowTemplateIamBinding extends pulumi.CustomResource {
  ...
  /// Creates a new [RegionWorkflowTemplateIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [RegionWorkflowTemplateIamBinding]. {@macro pulumi_dataproc_v1_region_workflow_template_iam_binding_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  RegionWorkflowTemplateIamBinding(
    String name, {
    RegionWorkflowTemplateIamBindingArgs? args,
