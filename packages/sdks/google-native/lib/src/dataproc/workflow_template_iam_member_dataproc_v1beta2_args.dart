...
/// {@template pulumi_dataproc_v1beta2_workflow_template_iam_member_dataproc_v1beta2_args_doc}
/// The set of arguments for WorkflowTemplateIamMember.
/// {@endtemplate}
/// {@macro pulumi_dataproc_v1beta2_workflow_template_iam_member_dataproc_v1beta2_args_doc}
class WorkflowTemplateIamMemberDataprocV1beta2Args {
  ...
  /// Creates a new [WorkflowTemplateIamMemberDataprocV1beta2Args].
  ...
  const WorkflowTemplateIamMemberDataprocV1beta2Args({
    this.condition,
  ...
  factory WorkflowTemplateIamMemberDataprocV1beta2Args.fromMap(Map<String, dynamic> map) {
    return WorkflowTemplateIamMemberDataprocV1beta2Args(
