...
/// {@template pulumi_dataproc_v1_region_job_iam_policy_args_doc}
/// The set of arguments for RegionJobIamPolicy.
/// {@endtemplate}
/// {@macro pulumi_dataproc_v1_region_job_iam_policy_args_doc}
class RegionJobIamPolicyArgs {
  ...
  /// Creates a new [RegionJobIamPolicyArgs].
  ...
  factory RegionJobIamPolicyArgs.fromMap(Map<String, dynamic> map) {
    return RegionJobIamPolicyArgs(
