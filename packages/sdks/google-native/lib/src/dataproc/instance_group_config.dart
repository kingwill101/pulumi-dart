...
class InstanceGroupConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'preemptibility': ?pulumi.Input.mapOptionalInputValue<InstanceGroupConfigPreemptibility, String>(preemptibility, (value) => value.wireValue),
  ...
  factory InstanceGroupConfig.fromMap(Map<String, dynamic> map) {
    return InstanceGroupConfig(
      ...
      diskConfig: (() { final guardedValue = map['diskConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DiskConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      instanceFlexibilityPolicy: (() { final guardedValue = map['instanceFlexibilityPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceFlexibilityPolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      machineTypeUri: (() { final guardedValue = map['machineTypeUri']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      preemptibility: (() { final guardedValue = map['preemptibility']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceGroupConfigPreemptibility.fromValue(guardedValue as String)); })(),
      startupConfig: (() { final guardedValue = map['startupConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(StartupConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
