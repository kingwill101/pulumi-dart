...
class InstanceGroupConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'diskConfig':
          ?pulumi.Input.mapOptionalInputValue<DiskConfig, Map<String, dynamic>>(
            diskConfig,
            (value) => value.toMap(),
          ),
      'imageUri': ?imageUri,
      ...
      'startupConfig':
          ?pulumi.Input.mapOptionalInputValue<
            StartupConfig,
            Map<String, dynamic>
          >(startupConfig, (value) => value.toMap()),
    };
  }
  ...
  factory InstanceGroupConfig.fromMap(Map<String, dynamic> map) {
    return InstanceGroupConfig(
      ...
      diskConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DiskConfig.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      imageUri: (() {
      ...
      minNumInstances: (() {
        final guardedValue = map['minNumInstances'];
        if (guardedValue == null) return null;
      ...
      preemptibility: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          InstanceGroupConfigPreemptibility.fromValue(guardedValue as String),
        );
      })(),
      startupConfig: (() {
        final guardedValue = map['startupConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          StartupConfig.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
