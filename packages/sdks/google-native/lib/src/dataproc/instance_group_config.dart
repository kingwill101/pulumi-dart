...
class InstanceGroupConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'preemptibility': ?preemptibility == null ? null : preemptibility!.value,
      'startupConfig': ?startupConfig == null ? null : startupConfig!.toMap(),
    };
  }
  ...
  factory InstanceGroupConfig.fromMap(Map<String, dynamic> map) {
    return InstanceGroupConfig(
      ...
      diskConfig: map['diskConfig'] == null ? null : DiskConfig.fromMap((map['diskConfig'] as Map).cast<String, dynamic>()),
      imageUri: map['imageUri'] == null ? null : map['imageUri'] as String,
      instanceFlexibilityPolicy: map['instanceFlexibilityPolicy'] == null ? null : InstanceFlexibilityPolicy.fromMap((map['instanceFlexibilityPolicy'] as Map).cast<String, dynamic>()),
      ...
      minNumInstances: map['minNumInstances'] == null ? null : map['minNumInstances'] as int,
      numInstances: map['numInstances'] == null ? null : map['numInstances'] as int,
      preemptibility: map['preemptibility'] == null ? null : InstanceGroupConfigPreemptibility.fromValue(map['preemptibility'] as String),
      startupConfig: map['startupConfig'] == null ? null : StartupConfig.fromMap((map['startupConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
