...
/// {@template pulumi_dataproc_v1_region_cluster_iam_member_args_doc}
/// The set of arguments for RegionClusterIamMember.
/// {@endtemplate}
/// {@macro pulumi_dataproc_v1_region_cluster_iam_member_args_doc}
class RegionClusterIamMemberArgs {
  ...
  /// Creates a new [RegionClusterIamMemberArgs].
  ...
  const RegionClusterIamMemberArgs({
    this.condition,
  ...
  factory RegionClusterIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return RegionClusterIamMemberArgs(
