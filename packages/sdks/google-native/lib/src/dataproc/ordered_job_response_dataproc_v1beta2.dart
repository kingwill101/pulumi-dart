...
class OrderedJobResponseDataprocV1beta2 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'hiveJob':
          pulumi.Input.mapInputValue<
            HiveJobResponseDataprocV1beta2,
            Map<String, dynamic>
      ...
      'pysparkJob':
          pulumi.Input.mapInputValue<
            PySparkJobResponseDataprocV1beta2,
            Map<String, dynamic>
  ...
  factory OrderedJobResponseDataprocV1beta2.fromMap(Map<String, dynamic> map) {
    return OrderedJobResponseDataprocV1beta2(
      hadoopJob: pulumi.Input.fromValue(
        HadoopJobResponseDataprocV1beta2.fromMap(
          (map['hadoopJob']! as Map).cast<String, dynamic>(),
        ),
      ),
      hiveJob: pulumi.Input.fromValue(
        HiveJobResponseDataprocV1beta2.fromMap(
      ...
      pigJob: pulumi.Input.fromValue(
        PigJobResponseDataprocV1beta2.fromMap(
