...
class GkeNodeConfig {
  ...
  factory GkeNodeConfig.fromMap(Map<String, dynamic> map) {
    return GkeNodeConfig(
      accelerators: (() { final guardedValue = map['accelerators']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GkeNodePoolAcceleratorConfig>(guardedValue, (value) => GkeNodePoolAcceleratorConfig.fromMap((value as Map).cast<String, dynamic>()))); })(),
