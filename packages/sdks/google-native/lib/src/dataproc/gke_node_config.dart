...
class GkeNodeConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'accelerators': ?accelerators == null ? null : pulumi.Input.encodeList<GkeNodePoolAcceleratorConfig, Map<String, dynamic>>(accelerators!, (value) => value.toMap()),
  ...
  factory GkeNodeConfig.fromMap(Map<String, dynamic> map) {
    return GkeNodeConfig(
      accelerators: map['accelerators'] == null ? null : pulumi.Input.decodeList<GkeNodePoolAcceleratorConfig>(map['accelerators'], (value) => GkeNodePoolAcceleratorConfig.fromMap((value as Map).cast<String, dynamic>())),
