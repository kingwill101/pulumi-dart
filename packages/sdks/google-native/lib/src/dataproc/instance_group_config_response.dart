...
class InstanceGroupConfigResponse {
  ...
  final pulumi.Input<InstanceFlexibilityPolicyResponse>
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'diskConfig':
          pulumi.Input.mapInputValue<DiskConfigResponse, Map<String, dynamic>>(
            diskConfig,
            (value) => value.toMap(),
          ),
      'imageUri': imageUri,
      ...
      'instanceReferences':
          pulumi.Input.mapInputValue<
            List<InstanceReferenceResponse>,
            List<Map<String, dynamic>>
          >(
            instanceReferences,
            (value) =>
  ...
  factory InstanceGroupConfigResponse.fromMap(Map<String, dynamic> map) {
    return InstanceGroupConfigResponse(
      ...
      diskConfig: pulumi.Input.fromValue(
        DiskConfigResponse.fromMap(
          (map['diskConfig']! as Map).cast<String, dynamic>(),
        ),
      ),
      imageUri: pulumi.Input.fromValue(map['imageUri'] as String),
      instanceFlexibilityPolicy: pulumi.Input.fromValue(
        InstanceFlexibilityPolicyResponse.fromMap(
      ...
      instanceReferences: pulumi.Input.fromValue(
        pulumi.Input.decodeList<InstanceReferenceResponse>(
      ...
      managedGroupConfig: pulumi.Input.fromValue(
        ManagedGroupConfigResponse.fromMap(
      ...
      startupConfig: pulumi.Input.fromValue(
        StartupConfigResponse.fromMap(
