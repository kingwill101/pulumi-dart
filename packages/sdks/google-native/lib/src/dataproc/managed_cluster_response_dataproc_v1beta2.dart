...
class ManagedClusterResponseDataprocV1beta2 {
  ...
  final pulumi.Input<ClusterConfigResponseDataprocV1beta2> config;
  ...
  const ManagedClusterResponseDataprocV1beta2({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'config': pulumi.Input.mapInputValue<ClusterConfigResponseDataprocV1beta2, Map<String, dynamic>>(config, (value) => value.toMap()),
      'labels': labels,
    };
  }

  factory ManagedClusterResponseDataprocV1beta2.fromMap(Map<String, dynamic> map) {
    return ManagedClusterResponseDataprocV1beta2(
      clusterName: pulumi.Input.fromValue(map['clusterName'] as String),
      config: pulumi.Input.fromValue(ClusterConfigResponseDataprocV1beta2.fromMap((map['config']! as Map).cast<String, dynamic>())),
