...
/// {@template pulumi_dataproc_v1_region_operation_iam_binding_args_doc}
/// The set of arguments for RegionOperationIamBinding.
/// {@endtemplate}
/// {@macro pulumi_dataproc_v1_region_operation_iam_binding_args_doc}
class RegionOperationIamBindingArgs {
  ...
  /// Creates a new [RegionOperationIamBindingArgs].
  ...
  const RegionOperationIamBindingArgs({
    this.condition,
  ...
  factory RegionOperationIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return RegionOperationIamBindingArgs(
