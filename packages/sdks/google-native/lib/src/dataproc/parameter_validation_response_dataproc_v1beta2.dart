...
class ParameterValidationResponseDataprocV1beta2 {
  ...
  factory ParameterValidationResponseDataprocV1beta2.fromMap(Map<String, dynamic> map) {
    return ParameterValidationResponseDataprocV1beta2(
      regex: pulumi.Input.fromValue(RegexValidationResponseDataprocV1beta2.fromMap((map['regex']! as Map).cast<String, dynamic>())),
      values: pulumi.Input.fromValue(ValueValidationResponseDataprocV1beta2.fromMap((map['values']! as Map).cast<String, dynamic>())),
    );
  }
}
