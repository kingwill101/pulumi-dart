...
class ClusterConfigResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'auxiliaryNodeGroups': pulumi.Input.encodeList<AuxiliaryNodeGroupResponse, Map<String, dynamic>>(auxiliaryNodeGroups, (value) => value.toMap()),
      'configBucket': configBucket,
      'dataprocMetricConfig': dataprocMetricConfig.toMap(),
      ...
      'initializationActions': pulumi.Input.encodeList<NodeInitializationActionResponse, Map<String, dynamic>>(initializationActions, (value) => value.toMap()),
  ...
  factory ClusterConfigResponse.fromMap(Map<String, dynamic> map) {
    return ClusterConfigResponse(
      ...
      auxiliaryNodeGroups: pulumi.Input.decodeList<AuxiliaryNodeGroupResponse>(map['auxiliaryNodeGroups'], (value) => AuxiliaryNodeGroupResponse.fromMap((value as Map).cast<String, dynamic>())),
      configBucket: map['configBucket'] as String,
      dataprocMetricConfig: DataprocMetricConfigResponse.fromMap((map['dataprocMetricConfig'] as Map).cast<String, dynamic>()),
      encryptionConfig: EncryptionConfigResponse.fromMap((map['encryptionConfig'] as Map).cast<String, dynamic>()),
      endpointConfig: EndpointConfigResponse.fromMap((map['endpointConfig'] as Map).cast<String, dynamic>()),
      gceClusterConfig: GceClusterConfigResponse.fromMap((map['gceClusterConfig'] as Map).cast<String, dynamic>()),
      gkeClusterConfig: GkeClusterConfigResponse.fromMap((map['gkeClusterConfig'] as Map).cast<String, dynamic>()),
      initializationActions: pulumi.Input.decodeList<NodeInitializationActionResponse>(map['initializationActions'], (value) => NodeInitializationActionResponse.fromMap((value as Map).cast<String, dynamic>())),
      lifecycleConfig: LifecycleConfigResponse.fromMap((map['lifecycleConfig'] as Map).cast<String, dynamic>()),
      masterConfig: InstanceGroupConfigResponse.fromMap((map['masterConfig'] as Map).cast<String, dynamic>()),
      metastoreConfig: MetastoreConfigResponse.fromMap((map['metastoreConfig'] as Map).cast<String, dynamic>()),
      secondaryWorkerConfig: InstanceGroupConfigResponse.fromMap((map['secondaryWorkerConfig'] as Map).cast<String, dynamic>()),
      securityConfig: SecurityConfigResponse.fromMap((map['securityConfig'] as Map).cast<String, dynamic>()),
      ...
      workerConfig: InstanceGroupConfigResponse.fromMap((map['workerConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
