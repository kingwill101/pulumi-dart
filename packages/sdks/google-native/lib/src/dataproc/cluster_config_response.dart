...
class ClusterConfigResponse {
  ...
  factory ClusterConfigResponse.fromMap(Map<String, dynamic> map) {
    return ClusterConfigResponse(
      autoscalingConfig: (AutoscalingConfigResponse.fromMap((map['autoscalingConfig'] as Map).cast<String, dynamic>())).input(),
      auxiliaryNodeGroups: (pulumi.Input.decodeList<AuxiliaryNodeGroupResponse>(map['auxiliaryNodeGroups'], (value) => AuxiliaryNodeGroupResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      configBucket: (map['configBucket'] as String).input(),
      dataprocMetricConfig: (DataprocMetricConfigResponse.fromMap((map['dataprocMetricConfig'] as Map).cast<String, dynamic>())).input(),
      encryptionConfig: (EncryptionConfigResponse.fromMap((map['encryptionConfig'] as Map).cast<String, dynamic>())).input(),
      endpointConfig: (EndpointConfigResponse.fromMap((map['endpointConfig'] as Map).cast<String, dynamic>())).input(),
      gceClusterConfig: (GceClusterConfigResponse.fromMap((map['gceClusterConfig'] as Map).cast<String, dynamic>())).input(),
      gkeClusterConfig: (GkeClusterConfigResponse.fromMap((map['gkeClusterConfig'] as Map).cast<String, dynamic>())).input(),
      initializationActions: (pulumi.Input.decodeList<NodeInitializationActionResponse>(map['initializationActions'], (value) => NodeInitializationActionResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      lifecycleConfig: (LifecycleConfigResponse.fromMap((map['lifecycleConfig'] as Map).cast<String, dynamic>())).input(),
      masterConfig: (InstanceGroupConfigResponse.fromMap((map['masterConfig'] as Map).cast<String, dynamic>())).input(),
      metastoreConfig: (MetastoreConfigResponse.fromMap((map['metastoreConfig'] as Map).cast<String, dynamic>())).input(),
      secondaryWorkerConfig: (InstanceGroupConfigResponse.fromMap((map['secondaryWorkerConfig'] as Map).cast<String, dynamic>())).input(),
      securityConfig: (SecurityConfigResponse.fromMap((map['securityConfig'] as Map).cast<String, dynamic>())).input(),
      ...
      workerConfig: (InstanceGroupConfigResponse.fromMap((map['workerConfig'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
