...
class ClusterConfigResponse {
  ...
  final pulumi.Input<List<NodeInitializationActionResponse>>
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'auxiliaryNodeGroups':
          pulumi.Input.mapInputValue<
            List<AuxiliaryNodeGroupResponse>,
      ...
      'initializationActions':
          pulumi.Input.mapInputValue<
            List<NodeInitializationActionResponse>,
            List<Map<String, dynamic>>
          >(
            initializationActions,
            (value) =>
  ...
  factory ClusterConfigResponse.fromMap(Map<String, dynamic> map) {
    return ClusterConfigResponse(
      autoscalingConfig: pulumi.Input.fromValue(
        AutoscalingConfigResponse.fromMap(
          (map['autoscalingConfig']! as Map).cast<String, dynamic>(),
        ),
      ),
      auxiliaryNodeGroups: pulumi.Input.fromValue(
        pulumi.Input.decodeList<AuxiliaryNodeGroupResponse>(
      ...
      dataprocMetricConfig: pulumi.Input.fromValue(
        DataprocMetricConfigResponse.fromMap(
      ...
      lifecycleConfig: pulumi.Input.fromValue(
        LifecycleConfigResponse.fromMap(
      ...
      securityConfig: pulumi.Input.fromValue(
        SecurityConfigResponse.fromMap(
