...
class ClusterConfigDataprocV1beta2 {
  ...
  const ClusterConfigDataprocV1beta2({
  ...
  factory ClusterConfigDataprocV1beta2.fromMap(Map<String, dynamic> map) {
    return ClusterConfigDataprocV1beta2(
      autoscalingConfig: (() { final guardedValue = map['autoscalingConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AutoscalingConfigDataprocV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      configBucket: (() { final guardedValue = map['configBucket']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      encryptionConfig: (() { final guardedValue = map['encryptionConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EncryptionConfigDataprocV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      endpointConfig: (() { final guardedValue = map['endpointConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EndpointConfigDataprocV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      gceClusterConfig: (() { final guardedValue = map['gceClusterConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GceClusterConfigDataprocV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      gkeClusterConfig: (() { final guardedValue = map['gkeClusterConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GkeClusterConfigDataprocV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      initializationActions: (() { final guardedValue = map['initializationActions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NodeInitializationActionDataprocV1beta2>(guardedValue, (value) => NodeInitializationActionDataprocV1beta2.fromMap((value as Map).cast<String, dynamic>()))); })(),
      lifecycleConfig: (() { final guardedValue = map['lifecycleConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LifecycleConfigDataprocV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      masterConfig: (() { final guardedValue = map['masterConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceGroupConfigDataprocV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      metastoreConfig: (() { final guardedValue = map['metastoreConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MetastoreConfigDataprocV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      secondaryWorkerConfig: (() { final guardedValue = map['secondaryWorkerConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceGroupConfigDataprocV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      securityConfig: (() { final guardedValue = map['securityConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SecurityConfigDataprocV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      softwareConfig: (() { final guardedValue = map['softwareConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SoftwareConfigDataprocV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      workerConfig: (() { final guardedValue = map['workerConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceGroupConfigDataprocV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
