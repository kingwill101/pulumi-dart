...
/// {@template pulumi_dataproc_v1beta2_workflow_template_iam_policy_dataproc_v1beta2_args_doc}
/// The set of arguments for WorkflowTemplateIamPolicy.
/// {@endtemplate}
/// {@macro pulumi_dataproc_v1beta2_workflow_template_iam_policy_dataproc_v1beta2_args_doc}
class WorkflowTemplateIamPolicyDataprocV1beta2Args {
  ...
  /// Creates a new [WorkflowTemplateIamPolicyDataprocV1beta2Args].
  ...
  const WorkflowTemplateIamPolicyDataprocV1beta2Args({
    this.bindings,
    this.etag,
    this.location,
    this.project,
  ...
  factory WorkflowTemplateIamPolicyDataprocV1beta2Args.fromMap(Map<String, dynamic> map) {
