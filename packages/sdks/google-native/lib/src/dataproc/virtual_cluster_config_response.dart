...
class VirtualClusterConfigResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'auxiliaryServicesConfig': auxiliaryServicesConfig.toMap(),
  ...
  factory VirtualClusterConfigResponse.fromMap(Map<String, dynamic> map) {
    return VirtualClusterConfigResponse(
      auxiliaryServicesConfig: AuxiliaryServicesConfigResponse.fromMap((map['auxiliaryServicesConfig'] as Map).cast<String, dynamic>()),
      kubernetesClusterConfig: KubernetesClusterConfigResponse.fromMap((map['kubernetesClusterConfig'] as Map).cast<String, dynamic>()),
