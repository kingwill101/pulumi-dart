...
/// {@template pulumi_dataproc_v1_autoscaling_policy_iam_binding_args_doc}
/// The set of arguments for AutoscalingPolicyIamBinding.
/// {@endtemplate}
/// {@macro pulumi_dataproc_v1_autoscaling_policy_iam_binding_args_doc}
class AutoscalingPolicyIamBindingArgs {
  ...
  /// Creates a new [AutoscalingPolicyIamBindingArgs].
  ...
  const AutoscalingPolicyIamBindingArgs({
    this.condition,
