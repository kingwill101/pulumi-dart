...
class RuntimeInfoResponse {
    ...
    return <String, dynamic>{
      'approximateUsage':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(approximateUsage, (value) => value.toMap()),
      'currentUsage':
          pulumi.Input.mapInputValue<
            UsageSnapshotResponse,
            Map<String, dynamic>
          >(currentUsage, (value) => value.toMap()),
  ...
  factory RuntimeInfoResponse.fromMap(Map<String, dynamic> map) {
    return RuntimeInfoResponse(
      approximateUsage: pulumi.Input.fromValue(
        UsageMetricsResponse.fromMap(
          (map['approximateUsage']! as Map).cast<String, dynamic>(),
        ),
      ),
      currentUsage: pulumi.Input.fromValue(
        UsageSnapshotResponse.fromMap(
          (map['currentUsage']! as Map).cast<String, dynamic>(),
        ),
      ),
      diagnosticOutputUri: pulumi.Input.fromValue(
