...
class GceClusterConfigResponseDataprocV1beta2 {
  ...
  final pulumi.Input<NodeGroupAffinityResponseDataprocV1beta2>
  nodeGroupAffinity;
  ...
  final pulumi.Input<ReservationAffinityResponseDataprocV1beta2>
  reservationAffinity;
  ...
  final pulumi.Input<ShieldedInstanceConfigResponseDataprocV1beta2>
  ...
  factory GceClusterConfigResponseDataprocV1beta2.fromMap(
    ...
    return GceClusterConfigResponseDataprocV1beta2(
      ...
      nodeGroupAffinity: pulumi.Input.fromValue(
        NodeGroupAffinityResponseDataprocV1beta2.fromMap(
      ...
      reservationAffinity: pulumi.Input.fromValue(
        ReservationAffinityResponseDataprocV1beta2.fromMap(
