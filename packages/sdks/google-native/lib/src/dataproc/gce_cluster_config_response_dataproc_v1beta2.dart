...
class GceClusterConfigResponseDataprocV1beta2 {
  ...
  factory GceClusterConfigResponseDataprocV1beta2.fromMap(Map<String, dynamic> map) {
    return GceClusterConfigResponseDataprocV1beta2(
      ...
      nodeGroupAffinity: (NodeGroupAffinityResponseDataprocV1beta2.fromMap((map['nodeGroupAffinity'] as Map).cast<String, dynamic>())).input(),
      privateIpv6GoogleAccess: (map['privateIpv6GoogleAccess'] as String).input(),
      reservationAffinity: (ReservationAffinityResponseDataprocV1beta2.fromMap((map['reservationAffinity'] as Map).cast<String, dynamic>())).input(),
      serviceAccount: (map['serviceAccount'] as String).input(),
      serviceAccountScopes: ((map['serviceAccountScopes'] as List).cast<String>()).input(),
      shieldedInstanceConfig: (ShieldedInstanceConfigResponseDataprocV1beta2.fromMap((map['shieldedInstanceConfig'] as Map).cast<String, dynamic>())).input(),
      subnetworkUri: (map['subnetworkUri'] as String).input(),
      tags: ((map['tags'] as List).cast<String>()).input(),
      zoneUri: (map['zoneUri'] as String).input(),
    );
  }
}
