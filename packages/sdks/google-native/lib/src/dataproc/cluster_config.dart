...
class ClusterConfig {
  ...
  factory ClusterConfig.fromMap(Map<String, dynamic> map) {
    return ClusterConfig(
      ...
      auxiliaryNodeGroups: (() { final guardedValue = map['auxiliaryNodeGroups']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AuxiliaryNodeGroup>(guardedValue, (value) => AuxiliaryNodeGroup.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      dataprocMetricConfig: (() { final guardedValue = map['dataprocMetricConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DataprocMetricConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      endpointConfig: (() { final guardedValue = map['endpointConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EndpointConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      gceClusterConfig: (() { final guardedValue = map['gceClusterConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GceClusterConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      gkeClusterConfig: (() { final guardedValue = map['gkeClusterConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GkeClusterConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      initializationActions: (() { final guardedValue = map['initializationActions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NodeInitializationAction>(guardedValue, (value) => NodeInitializationAction.fromMap((value as Map).cast<String, dynamic>()))); })(),
      lifecycleConfig: (() { final guardedValue = map['lifecycleConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LifecycleConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      masterConfig: (() { final guardedValue = map['masterConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceGroupConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      secondaryWorkerConfig: (() { final guardedValue = map['secondaryWorkerConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceGroupConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      securityConfig: (() { final guardedValue = map['securityConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SecurityConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      softwareConfig: (() { final guardedValue = map['softwareConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SoftwareConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      workerConfig: (() { final guardedValue = map['workerConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceGroupConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
