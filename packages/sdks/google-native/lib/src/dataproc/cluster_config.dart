...
class ClusterConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'auxiliaryNodeGroups': ?auxiliaryNodeGroups == null ? null : pulumi.Input.encodeList<AuxiliaryNodeGroup, Map<String, dynamic>>(auxiliaryNodeGroups!, (value) => value.toMap()),
      ...
      'initializationActions': ?initializationActions == null ? null : pulumi.Input.encodeList<NodeInitializationAction, Map<String, dynamic>>(initializationActions!, (value) => value.toMap()),
  ...
  factory ClusterConfig.fromMap(Map<String, dynamic> map) {
    return ClusterConfig(
      ...
      auxiliaryNodeGroups: map['auxiliaryNodeGroups'] == null ? null : pulumi.Input.decodeList<AuxiliaryNodeGroup>(map['auxiliaryNodeGroups'], (value) => AuxiliaryNodeGroup.fromMap((value as Map).cast<String, dynamic>())),
      configBucket: map['configBucket'] == null ? null : map['configBucket'] as String,
      dataprocMetricConfig: map['dataprocMetricConfig'] == null ? null : DataprocMetricConfig.fromMap((map['dataprocMetricConfig'] as Map).cast<String, dynamic>()),
      encryptionConfig: map['encryptionConfig'] == null ? null : EncryptionConfig.fromMap((map['encryptionConfig'] as Map).cast<String, dynamic>()),
      endpointConfig: map['endpointConfig'] == null ? null : EndpointConfig.fromMap((map['endpointConfig'] as Map).cast<String, dynamic>()),
      gceClusterConfig: map['gceClusterConfig'] == null ? null : GceClusterConfig.fromMap((map['gceClusterConfig'] as Map).cast<String, dynamic>()),
      gkeClusterConfig: map['gkeClusterConfig'] == null ? null : GkeClusterConfig.fromMap((map['gkeClusterConfig'] as Map).cast<String, dynamic>()),
      initializationActions: map['initializationActions'] == null ? null : pulumi.Input.decodeList<NodeInitializationAction>(map['initializationActions'], (value) => NodeInitializationAction.fromMap((value as Map).cast<String, dynamic>())),
      lifecycleConfig: map['lifecycleConfig'] == null ? null : LifecycleConfig.fromMap((map['lifecycleConfig'] as Map).cast<String, dynamic>()),
      masterConfig: map['masterConfig'] == null ? null : InstanceGroupConfig.fromMap((map['masterConfig'] as Map).cast<String, dynamic>()),
      metastoreConfig: map['metastoreConfig'] == null ? null : MetastoreConfig.fromMap((map['metastoreConfig'] as Map).cast<String, dynamic>()),
      secondaryWorkerConfig: map['secondaryWorkerConfig'] == null ? null : InstanceGroupConfig.fromMap((map['secondaryWorkerConfig'] as Map).cast<String, dynamic>()),
      securityConfig: map['securityConfig'] == null ? null : SecurityConfig.fromMap((map['securityConfig'] as Map).cast<String, dynamic>()),
      ...
      workerConfig: map['workerConfig'] == null ? null : InstanceGroupConfig.fromMap((map['workerConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
