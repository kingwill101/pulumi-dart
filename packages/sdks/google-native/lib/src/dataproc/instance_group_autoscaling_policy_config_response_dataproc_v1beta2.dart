...
class InstanceGroupAutoscalingPolicyConfigResponseDataprocV1beta2 {
  ...
  const InstanceGroupAutoscalingPolicyConfigResponseDataprocV1beta2({
  ...
  factory InstanceGroupAutoscalingPolicyConfigResponseDataprocV1beta2.fromMap(Map<String, dynamic> map) {
