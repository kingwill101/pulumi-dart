...
class InstanceGroupConfigDataprocV1beta2 {
  ...
  const InstanceGroupConfigDataprocV1beta2({
    this.accelerators,
    this.diskConfig,
    this.imageUri,
    this.machineTypeUri,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'preemptibility': ?pulumi.Input.mapOptionalInputValue<InstanceGroupConfigPreemptibilityDataprocV1beta2, String>(preemptibility, (value) => value.wireValue),
    };
  }

  factory InstanceGroupConfigDataprocV1beta2.fromMap(Map<String, dynamic> map) {
    return InstanceGroupConfigDataprocV1beta2(
      accelerators: (() { final guardedValue = map['accelerators']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AcceleratorConfigDataprocV1beta2>(guardedValue, (value) => AcceleratorConfigDataprocV1beta2.fromMap((value as Map).cast<String, dynamic>()))); })(),
      diskConfig: (() { final guardedValue = map['diskConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DiskConfigDataprocV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      preemptibility: (() { final guardedValue = map['preemptibility']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceGroupConfigPreemptibilityDataprocV1beta2.fromValue(guardedValue as String)); })(),
    );
  }
}
