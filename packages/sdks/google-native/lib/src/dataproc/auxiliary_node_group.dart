...
class AuxiliaryNodeGroup {
  ...
  AuxiliaryNodeGroup({required this.nodeGroup, this.nodeGroupId});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'nodeGroup': pulumi.Input.mapInputValue<NodeGroup, Map<String, dynamic>>(
        nodeGroup,
        (value) => value.toMap(),
      ),
  ...
  factory AuxiliaryNodeGroup.fromMap(Map<String, dynamic> map) {
    return AuxiliaryNodeGroup(
      nodeGroup: pulumi.Input.fromValue(
