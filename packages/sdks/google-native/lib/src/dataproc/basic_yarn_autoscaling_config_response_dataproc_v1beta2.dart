...
class BasicYarnAutoscalingConfigResponseDataprocV1beta2 {
  ...
  /// Creates a new [BasicYarnAutoscalingConfigResponseDataprocV1beta2].
  ...
  factory BasicYarnAutoscalingConfigResponseDataprocV1beta2.fromMap(Map<String, dynamic> map) {
    return BasicYarnAutoscalingConfigResponseDataprocV1beta2(
      ...
      scaleDownMinWorkerFraction: (map['scaleDownMinWorkerFraction'] as double).input(),
      scaleUpFactor: (map['scaleUpFactor'] as double).input(),
      scaleUpMinWorkerFraction: (map['scaleUpMinWorkerFraction'] as double).input(),
    );
  }
}
