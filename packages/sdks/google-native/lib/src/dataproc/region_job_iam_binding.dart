...
import 'region_job_iam_binding_args.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy.Can return NOT_FOUND, INVALID_ARGUMENT, and PERMISSION_DENIED errors.
class RegionJobIamBinding extends pulumi.CustomResource {
  ...
  /// Creates a new [RegionJobIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [RegionJobIamBinding]. {@macro pulumi_dataproc_v1_region_job_iam_binding_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  RegionJobIamBinding(
    String name, {
    RegionJobIamBindingArgs? args,
