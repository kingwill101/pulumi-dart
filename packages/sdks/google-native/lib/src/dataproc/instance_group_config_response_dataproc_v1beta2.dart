...
class InstanceGroupConfigResponseDataprocV1beta2 {
  ...
  factory InstanceGroupConfigResponseDataprocV1beta2.fromMap(Map<String, dynamic> map) {
    return InstanceGroupConfigResponseDataprocV1beta2(
      accelerators: (pulumi.Input.decodeList<AcceleratorConfigResponseDataprocV1beta2>(map['accelerators'], (value) => AcceleratorConfigResponseDataprocV1beta2.fromMap((value as Map).cast<String, dynamic>()))).input(),
      diskConfig: (DiskConfigResponseDataprocV1beta2.fromMap((map['diskConfig'] as Map).cast<String, dynamic>())).input(),
      imageUri: (map['imageUri'] as String).input(),
      instanceNames: ((map['instanceNames'] as List).cast<String>()).input(),
      instanceReferences: (pulumi.Input.decodeList<InstanceReferenceResponseDataprocV1beta2>(map['instanceReferences'], (value) => InstanceReferenceResponseDataprocV1beta2.fromMap((value as Map).cast<String, dynamic>()))).input(),
      isPreemptible: (map['isPreemptible'] as bool).input(),
      machineTypeUri: (map['machineTypeUri'] as String).input(),
      managedGroupConfig: (ManagedGroupConfigResponseDataprocV1beta2.fromMap((map['managedGroupConfig'] as Map).cast<String, dynamic>())).input(),
