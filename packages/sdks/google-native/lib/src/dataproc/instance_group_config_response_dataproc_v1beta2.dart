...
class InstanceGroupConfigResponseDataprocV1beta2 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'accelerators': pulumi.Input.encodeList<AcceleratorConfigResponseDataprocV1beta2, Map<String, dynamic>>(accelerators, (value) => value.toMap()),
      'diskConfig': diskConfig.toMap(),
      'imageUri': imageUri,
      'instanceNames': instanceNames,
      'instanceReferences': pulumi.Input.encodeList<InstanceReferenceResponseDataprocV1beta2, Map<String, dynamic>>(instanceReferences, (value) => value.toMap()),
  ...
  factory InstanceGroupConfigResponseDataprocV1beta2.fromMap(Map<String, dynamic> map) {
    return InstanceGroupConfigResponseDataprocV1beta2(
      accelerators: pulumi.Input.decodeList<AcceleratorConfigResponseDataprocV1beta2>(map['accelerators'], (value) => AcceleratorConfigResponseDataprocV1beta2.fromMap((value as Map).cast<String, dynamic>())),
      diskConfig: DiskConfigResponseDataprocV1beta2.fromMap((map['diskConfig'] as Map).cast<String, dynamic>()),
      imageUri: map['imageUri'] as String,
      instanceNames: (map['instanceNames'] as List).cast<String>(),
      instanceReferences: pulumi.Input.decodeList<InstanceReferenceResponseDataprocV1beta2>(map['instanceReferences'], (value) => InstanceReferenceResponseDataprocV1beta2.fromMap((value as Map).cast<String, dynamic>())),
      isPreemptible: map['isPreemptible'] as bool,
      machineTypeUri: map['machineTypeUri'] as String,
      managedGroupConfig: ManagedGroupConfigResponseDataprocV1beta2.fromMap((map['managedGroupConfig'] as Map).cast<String, dynamic>()),
