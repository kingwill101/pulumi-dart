...
class InstanceGroupConfigResponseDataprocV1beta2 {
  ...
  final pulumi.Input<List<AcceleratorConfigResponseDataprocV1beta2>>
  accelerators;
  ...
  final pulumi.Input<List<InstanceReferenceResponseDataprocV1beta2>>
  instanceReferences;
  ...
  final pulumi.Input<ManagedGroupConfigResponseDataprocV1beta2>
  managedGroupConfig;
    ...
    return <String, dynamic>{
      'accelerators':
          pulumi.Input.mapInputValue<
            List<AcceleratorConfigResponseDataprocV1beta2>,
      ...
      'instanceReferences':
          pulumi.Input.mapInputValue<
            List<InstanceReferenceResponseDataprocV1beta2>,
            List<Map<String, dynamic>>
          >(
            instanceReferences,
            (value) =>
      ...
      'managedGroupConfig':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(managedGroupConfig, (value) => value.toMap()),
  ...
  factory InstanceGroupConfigResponseDataprocV1beta2.fromMap(
    ...
    return InstanceGroupConfigResponseDataprocV1beta2(
      ...
      diskConfig: pulumi.Input.fromValue(
        DiskConfigResponseDataprocV1beta2.fromMap(
          (map['diskConfig']! as Map).cast<String, dynamic>(),
        ),
      ),
      imageUri: pulumi.Input.fromValue(map['imageUri'] as String),
      instanceNames: pulumi.Input.fromValue(
        (map['instanceNames'] as List).cast<String>(),
      ),
      instanceReferences: pulumi.Input.fromValue(
      ...
      managedGroupConfig: pulumi.Input.fromValue(
        ManagedGroupConfigResponseDataprocV1beta2.fromMap(
