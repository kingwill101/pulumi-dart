...
class JobDataprocV1beta2 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<JobStatusResponseDataprocV1beta2>> statusHistory;
  ...
  late final pulumi.Output<List<YarnApplicationResponseDataprocV1beta2>> yarnApplications;
  ...
  JobDataprocV1beta2(
    ...
    this.hadoopJob = registerOutput<HadoopJobResponseDataprocV1beta2>('hadoopJob');
    ...
    this.placement = registerOutput<JobPlacementResponseDataprocV1beta2>('placement');
    this.prestoJob = registerOutput<PrestoJobResponseDataprocV1beta2>('prestoJob');
    this.project = registerOutput<String>('project');
    this.pysparkJob = registerOutput<PySparkJobResponseDataprocV1beta2>('pysparkJob');
    this.reference = registerOutput<JobReferenceResponseDataprocV1beta2>('reference');
    this.region = registerOutput<String>('region');
    this.scheduling = registerOutput<JobSchedulingResponseDataprocV1beta2>('scheduling');
    this.sparkJob = registerOutput<SparkJobResponseDataprocV1beta2>('sparkJob');
    this.sparkRJob = registerOutput<SparkRJobResponseDataprocV1beta2>('sparkRJob');
    this.sparkSqlJob = registerOutput<SparkSqlJobResponseDataprocV1beta2>('sparkSqlJob');
    this.status = registerOutput<JobStatusResponseDataprocV1beta2>('status');
    this.statusHistory = registerOutput<List<JobStatusResponseDataprocV1beta2>>('statusHistory');
    this.submittedBy = registerOutput<String>('submittedBy');
    this.yarnApplications = registerOutput<List<YarnApplicationResponseDataprocV1beta2>>('yarnApplications');
  }
}
