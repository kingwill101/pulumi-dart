...
class SoftwareConfigDataprocV1beta2 {
  ...
  const SoftwareConfigDataprocV1beta2({
    this.imageVersion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'optionalComponents': ?pulumi.Input.mapOptionalInputValue<List<SoftwareConfigOptionalComponentsItemDataprocV1beta2>, List<String>>(optionalComponents, (value) => pulumi.Input.encodeList<SoftwareConfigOptionalComponentsItemDataprocV1beta2, String>(value, (value) => value.wireValue)),
  ...
  factory SoftwareConfigDataprocV1beta2.fromMap(Map<String, dynamic> map) {
    return SoftwareConfigDataprocV1beta2(
      ...
      optionalComponents: (() { final guardedValue = map['optionalComponents']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SoftwareConfigOptionalComponentsItemDataprocV1beta2>(guardedValue, (value) => SoftwareConfigOptionalComponentsItemDataprocV1beta2.fromValue(value as String))); })(),
