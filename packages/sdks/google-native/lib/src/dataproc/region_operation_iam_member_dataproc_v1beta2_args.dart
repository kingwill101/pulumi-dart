...
/// {@template pulumi_dataproc_v1beta2_region_operation_iam_member_dataproc_v1beta2_args_doc}
/// The set of arguments for RegionOperationIamMember.
/// {@endtemplate}
/// {@macro pulumi_dataproc_v1beta2_region_operation_iam_member_dataproc_v1beta2_args_doc}
class RegionOperationIamMemberDataprocV1beta2Args {
  ...
  /// Creates a new [RegionOperationIamMemberDataprocV1beta2Args].
  ...
  const RegionOperationIamMemberDataprocV1beta2Args({
    this.condition,
  ...
  factory RegionOperationIamMemberDataprocV1beta2Args.fromMap(Map<String, dynamic> map) {
