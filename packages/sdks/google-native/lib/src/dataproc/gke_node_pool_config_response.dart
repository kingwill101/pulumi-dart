...
class GkeNodePoolConfigResponse {
  ...
  factory GkeNodePoolConfigResponse.fromMap(Map<String, dynamic> map) {
    return GkeNodePoolConfigResponse(
      autoscaling: (GkeNodePoolAutoscalingConfigResponse.fromMap((map['autoscaling'] as Map).cast<String, dynamic>())).input(),
      config: (GkeNodeConfigResponse.fromMap((map['config'] as Map).cast<String, dynamic>())).input(),
