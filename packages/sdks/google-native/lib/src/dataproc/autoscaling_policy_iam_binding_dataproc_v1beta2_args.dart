...
/// {@template pulumi_dataproc_v1beta2_autoscaling_policy_iam_binding_dataproc_v1beta2_args_doc}
/// The set of arguments for AutoscalingPolicyIamBinding.
/// {@endtemplate}
/// {@macro pulumi_dataproc_v1beta2_autoscaling_policy_iam_binding_dataproc_v1beta2_args_doc}
class AutoscalingPolicyIamBindingDataprocV1beta2Args {
  ...
  /// Creates a new [AutoscalingPolicyIamBindingDataprocV1beta2Args].
  ...
  const AutoscalingPolicyIamBindingDataprocV1beta2Args({
    this.condition,
  ...
  factory AutoscalingPolicyIamBindingDataprocV1beta2Args.fromMap(Map<String, dynamic> map) {
    return AutoscalingPolicyIamBindingDataprocV1beta2Args(
