...
/// {@template pulumi_dataproc_v1beta2_region_job_iam_binding_dataproc_v1beta2_args_doc}
/// The set of arguments for RegionJobIamBinding.
/// {@endtemplate}
/// {@macro pulumi_dataproc_v1beta2_region_job_iam_binding_dataproc_v1beta2_args_doc}
class RegionJobIamBindingDataprocV1beta2Args {
  ...
  /// Creates a new [RegionJobIamBindingDataprocV1beta2Args].
  ...
  const RegionJobIamBindingDataprocV1beta2Args({
    this.condition,
  ...
  factory RegionJobIamBindingDataprocV1beta2Args.fromMap(Map<String, dynamic> map) {
    return RegionJobIamBindingDataprocV1beta2Args(
