...
class GetIngressRuleAppengineV1betaResult {
  ...
  /// Creates a new [GetIngressRuleAppengineV1betaResult].
  ...
  const GetIngressRuleAppengineV1betaResult({
  ...
  factory GetIngressRuleAppengineV1betaResult.fromMap(Map<String, dynamic> map) {
    return GetIngressRuleAppengineV1betaResult(
