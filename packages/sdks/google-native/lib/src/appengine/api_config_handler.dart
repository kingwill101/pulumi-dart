...
class ApiConfigHandler {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'authFailAction': ?pulumi.Input.mapOptionalInputValue<ApiConfigHandlerAuthFailAction, String>(authFailAction, (value) => value.wireValue),
      'login': ?pulumi.Input.mapOptionalInputValue<ApiConfigHandlerLogin, String>(login, (value) => value.wireValue),
      'script': ?script,
      'securityLevel': ?pulumi.Input.mapOptionalInputValue<ApiConfigHandlerSecurityLevel, String>(securityLevel, (value) => value.wireValue),
      'url': ?url,
    };
  }
  ...
  factory ApiConfigHandler.fromMap(Map<String, dynamic> map) {
    return ApiConfigHandler(
      authFailAction: (() { final guardedValue = map['authFailAction']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ApiConfigHandlerAuthFailAction.fromValue(guardedValue as String)); })(),
      login: (() { final guardedValue = map['login']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ApiConfigHandlerLogin.fromValue(guardedValue as String)); })(),
      ...
      securityLevel: (() { final guardedValue = map['securityLevel']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ApiConfigHandlerSecurityLevel.fromValue(guardedValue as String)); })(),
