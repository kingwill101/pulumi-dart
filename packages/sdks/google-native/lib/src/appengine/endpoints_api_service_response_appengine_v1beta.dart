...
class EndpointsApiServiceResponseAppengineV1beta {
  ...
  factory EndpointsApiServiceResponseAppengineV1beta.fromMap(Map<String, dynamic> map) {
    return EndpointsApiServiceResponseAppengineV1beta(
      configId: (map['configId'] as String).input(),
      disableTraceSampling: (map['disableTraceSampling'] as bool).input(),
      name: (map['name'] as String).input(),
      rolloutStrategy: (map['rolloutStrategy'] as String).input(),
    );
  }
}
