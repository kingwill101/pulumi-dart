...
class DomainMappingAppengineV1beta extends pulumi.CustomResource {
  ...
  DomainMappingAppengineV1beta(
    ...
    sslSettings = registerOutput<SslSettingsResponseAppengineV1beta>('sslSettings', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SslSettingsResponseAppengineV1beta.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  }
}
