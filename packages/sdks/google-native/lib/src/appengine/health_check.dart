...
class HealthCheck {
  ...
  factory HealthCheck.fromMap(Map<String, dynamic> map) {
    return HealthCheck(
      ...
      disableHealthCheck: map['disableHealthCheck'] == null ? null : map['disableHealthCheck'] as bool,
      healthyThreshold: map['healthyThreshold'] == null ? null : map['healthyThreshold'] as int,
      host: map['host'] == null ? null : map['host'] as String,
      restartThreshold: map['restartThreshold'] == null ? null : map['restartThreshold'] as int,
