...
class DomainMappingAppengineV1alpha extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<ResourceRecordResponseAppengineV1alpha>> resourceRecords;
  ...
  DomainMappingAppengineV1alpha(
    ...
    this.resourceRecords = registerOutput<List<ResourceRecordResponseAppengineV1alpha>>('resourceRecords');
    this.sslSettings = registerOutput<SslSettingsResponseAppengineV1alpha>('sslSettings');
  }
}
