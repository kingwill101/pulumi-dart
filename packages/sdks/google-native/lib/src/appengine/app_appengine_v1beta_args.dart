...
class AppAppengineV1betaArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'dispatchRules':
          ?pulumi.Input.mapOptionalInputValue<
            List<UrlDispatchRuleAppengineV1beta>,
    ...
    return AppAppengineV1betaArgs(
      ...
      databaseType: (() {
        ...
        return pulumi.Input.fromValue(
          AppDatabaseTypeAppengineV1beta.fromValue(guardedValue as String),
        );
      })(),
      defaultCookieExpiration: (() {
        final guardedValue = map['defaultCookieExpiration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      dispatchRules: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<UrlDispatchRuleAppengineV1beta>(
            guardedValue,
            (value) => UrlDispatchRuleAppengineV1beta.fromMap(
      ...
      featureSettings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FeatureSettingsAppengineV1beta.fromMap(
      ...
      iap: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          IdentityAwareProxyAppengineV1beta.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      servingStatus: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AppServingStatusAppengineV1beta.fromValue(guardedValue as String),
        );
      })(),
    );
  }
