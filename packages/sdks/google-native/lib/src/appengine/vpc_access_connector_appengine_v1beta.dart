...
class VpcAccessConnectorAppengineV1beta {
  ...
  final pulumi.Input<VpcAccessConnectorEgressSettingAppengineV1beta>?
  egressSetting;
  ...
  VpcAccessConnectorAppengineV1beta({this.egressSetting, this.name});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'egressSetting':
          ?pulumi.Input.mapOptionalInputValue<
            VpcAccessConnectorEgressSettingAppengineV1beta,
            String
