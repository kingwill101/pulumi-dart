...
class StaticFilesHandlerResponse {
  ...
  const StaticFilesHandlerResponse({
  ...
  factory StaticFilesHandlerResponse.fromMap(Map<String, dynamic> map) {
    return StaticFilesHandlerResponse(
      applicationReadable: pulumi.Input.fromValue(map['applicationReadable'] as bool),
      expiration: pulumi.Input.fromValue(map['expiration'] as String),
      httpHeaders: pulumi.Input.fromValue((map['httpHeaders'] as Map).cast<String, String>()),
      mimeType: pulumi.Input.fromValue(map['mimeType'] as String),
      path: pulumi.Input.fromValue(map['path'] as String),
      requireMatchingFile: pulumi.Input.fromValue(map['requireMatchingFile'] as bool),
      uploadPathRegex: pulumi.Input.fromValue(map['uploadPathRegex'] as String),
    );
  }
}
