...
class SslSettingsAppengineV1beta {
  ...
  final pulumi.Input<SslSettingsSslManagementTypeAppengineV1beta>?
  sslManagementType;
  ...
  SslSettingsAppengineV1beta({this.certificateId, this.sslManagementType});
    ...
    return <String, dynamic>{
      ...
      'sslManagementType':
          ?pulumi.Input.mapOptionalInputValue<
            SslSettingsSslManagementTypeAppengineV1beta,
            String
          >(sslManagementType, (value) => value.wireValue),
    };
  }
  ...
  factory SslSettingsAppengineV1beta.fromMap(Map<String, dynamic> map) {
    return SslSettingsAppengineV1beta(
      ...
      sslManagementType: (() {
        final guardedValue = map['sslManagementType'];
        if (guardedValue == null) return null;
