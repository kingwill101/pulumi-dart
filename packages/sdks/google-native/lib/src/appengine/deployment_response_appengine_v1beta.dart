...
class DeploymentResponseAppengineV1beta {
  ...
  factory DeploymentResponseAppengineV1beta.fromMap(Map<String, dynamic> map) {
    return DeploymentResponseAppengineV1beta(
      build: pulumi.Input.fromValue(BuildInfoResponse.fromMap((map['build']! as Map).cast<String, dynamic>())),
      cloudBuildOptions: pulumi.Input.fromValue(CloudBuildOptionsResponseAppengineV1beta.fromMap((map['cloudBuildOptions']! as Map).cast<String, dynamic>())),
      container: pulumi.Input.fromValue(ContainerInfoResponseAppengineV1beta.fromMap((map['container']! as Map).cast<String, dynamic>())),
      files: pulumi.Input.fromValue((map['files'] as Map).cast<String, String>()),
      zip: pulumi.Input.fromValue(ZipInfoResponseAppengineV1beta.fromMap((map['zip']! as Map).cast<String, dynamic>())),
    );
  }
}
