...
class VersionAppengineV1betaArgs {
  ...
  factory VersionAppengineV1betaArgs.fromMap(Map<String, dynamic> map) {
    return VersionAppengineV1betaArgs(
      apiConfig: map['apiConfig'] == null ? null : (ApiConfigHandlerAppengineV1beta.fromMap((map['apiConfig'] as Map).cast<String, dynamic>())).input(),
      appEngineApis: map['appEngineApis'] == null ? null : (map['appEngineApis'] as bool).input(),
      appId: (map['appId'] as String).input(),
      automaticScaling: map['automaticScaling'] == null ? null : (AutomaticScalingAppengineV1beta.fromMap((map['automaticScaling'] as Map).cast<String, dynamic>())).input(),
      basicScaling: map['basicScaling'] == null ? null : (BasicScalingAppengineV1beta.fromMap((map['basicScaling'] as Map).cast<String, dynamic>())).input(),
      ...
      deployment: map['deployment'] == null ? null : (DeploymentAppengineV1beta.fromMap((map['deployment'] as Map).cast<String, dynamic>())).input(),
      endpointsApiService: map['endpointsApiService'] == null ? null : (EndpointsApiServiceAppengineV1beta.fromMap((map['endpointsApiService'] as Map).cast<String, dynamic>())).input(),
      entrypoint: map['entrypoint'] == null ? null : (EntrypointAppengineV1beta.fromMap((map['entrypoint'] as Map).cast<String, dynamic>())).input(),
      ...
      errorHandlers: map['errorHandlers'] == null ? null : (pulumi.Input.decodeList<ErrorHandlerAppengineV1beta>(map['errorHandlers'], (value) => ErrorHandlerAppengineV1beta.fromMap((value as Map).cast<String, dynamic>()))).input(),
      flexibleRuntimeSettings: map['flexibleRuntimeSettings'] == null ? null : (FlexibleRuntimeSettingsAppengineV1beta.fromMap((map['flexibleRuntimeSettings'] as Map).cast<String, dynamic>())).input(),
      ...
      handlers: map['handlers'] == null ? null : (pulumi.Input.decodeList<UrlMapAppengineV1beta>(map['handlers'], (value) => UrlMapAppengineV1beta.fromMap((value as Map).cast<String, dynamic>()))).input(),
      healthCheck: map['healthCheck'] == null ? null : (HealthCheckAppengineV1beta.fromMap((map['healthCheck'] as Map).cast<String, dynamic>())).input(),
      id: map['id'] == null ? null : (map['id'] as String).input(),
      inboundServices: map['inboundServices'] == null ? null : (pulumi.Input.decodeList<VersionInboundServicesItemAppengineV1beta>(map['inboundServices'], (value) => VersionInboundServicesItemAppengineV1beta.fromValue(value as String))).input(),
      instanceClass: map['instanceClass'] == null ? null : (map['instanceClass'] as String).input(),
      libraries: map['libraries'] == null ? null : (pulumi.Input.decodeList<LibraryAppengineV1beta>(map['libraries'], (value) => LibraryAppengineV1beta.fromMap((value as Map).cast<String, dynamic>()))).input(),
      livenessCheck: map['livenessCheck'] == null ? null : (LivenessCheckAppengineV1beta.fromMap((map['livenessCheck'] as Map).cast<String, dynamic>())).input(),
      manualScaling: map['manualScaling'] == null ? null : (ManualScalingAppengineV1beta.fromMap((map['manualScaling'] as Map).cast<String, dynamic>())).input(),
      network: map['network'] == null ? null : (NetworkAppengineV1beta.fromMap((map['network'] as Map).cast<String, dynamic>())).input(),
      nobuildFilesRegex: map['nobuildFilesRegex'] == null ? null : (map['nobuildFilesRegex'] as String).input(),
      readinessCheck: map['readinessCheck'] == null ? null : (ReadinessCheckAppengineV1beta.fromMap((map['readinessCheck'] as Map).cast<String, dynamic>())).input(),
      resources: map['resources'] == null ? null : (ResourcesAppengineV1beta.fromMap((map['resources'] as Map).cast<String, dynamic>())).input(),
      ...
      servingStatus: map['servingStatus'] == null ? null : (VersionServingStatusAppengineV1beta.fromValue(map['servingStatus'] as String)).input(),
      threadsafe: map['threadsafe'] == null ? null : (map['threadsafe'] as bool).input(),
      vm: map['vm'] == null ? null : (map['vm'] as bool).input(),
      vpcAccessConnector: map['vpcAccessConnector'] == null ? null : (VpcAccessConnectorAppengineV1beta.fromMap((map['vpcAccessConnector'] as Map).cast<String, dynamic>())).input(),
