...
class GetAppAppengineV1betaResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'dispatchRules': pulumi.Input.encodeList<UrlDispatchRuleResponseAppengineV1beta, Map<String, dynamic>>(dispatchRules, (value) => value.toMap()),
  ...
  factory GetAppAppengineV1betaResult.fromMap(Map<String, dynamic> map) {
    return GetAppAppengineV1betaResult(
      ...
      dispatchRules: pulumi.Input.decodeList<UrlDispatchRuleResponseAppengineV1beta>(map['dispatchRules']!, (value) => UrlDispatchRuleResponseAppengineV1beta.fromMap((value as Map).cast<String, dynamic>())),
      featureSettings: FeatureSettingsResponseAppengineV1beta.fromMap((map['featureSettings']! as Map).cast<String, dynamic>()),
      gcrDomain: map['gcrDomain'] as String,
      generatedCustomerMetadata: (map['generatedCustomerMetadata'] as Map).cast<String, String>(),
      iap: IdentityAwareProxyResponseAppengineV1beta.fromMap((map['iap']! as Map).cast<String, dynamic>()),
