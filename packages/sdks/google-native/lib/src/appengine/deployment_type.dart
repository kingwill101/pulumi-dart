...
class DeploymentType {
  ...
  factory DeploymentType.fromMap(Map<String, dynamic> map) {
    return DeploymentType(
      cloudBuildOptions: (() { final guardedValue = map['cloudBuildOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CloudBuildOptions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      container: (() { final guardedValue = map['container']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ContainerInfo.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      zip: (() { final guardedValue = map['zip']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ZipInfo.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
