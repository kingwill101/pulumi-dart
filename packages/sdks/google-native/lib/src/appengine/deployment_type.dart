...
class DeploymentType {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'files': ?files,
      'zip': ?pulumi.Input.mapOptionalInputValue<ZipInfo, Map<String, dynamic>>(
        zip,
        (value) => value.toMap(),
      ),
    };
  ...
  factory DeploymentType.fromMap(Map<String, dynamic> map) {
    return DeploymentType(
      ...
      container: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ContainerInfo.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      files: (() {
      ...
      zip: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ZipInfo.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
