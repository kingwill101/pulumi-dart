...
class IngressRuleAppengineV1betaArgs {
  ...
  IngressRuleAppengineV1betaArgs({
    pulumi.Output<IngressRuleActionAppengineV1beta>? action,
    required pulumi.Output<String> appId,
    pulumi.Output<String>? description,
    pulumi.Output<int>? priority,
    pulumi.Output<String>? sourceRange,
  }) :
      action = pulumi.Input.asOptionalInput<IngressRuleActionAppengineV1beta>(action),
  ...
  factory IngressRuleAppengineV1betaArgs.fromMap(Map<String, dynamic> map) {
    return IngressRuleAppengineV1betaArgs(
      action: map['action'] == null ? null : pulumi.Output.create<IngressRuleActionAppengineV1beta>(IngressRuleActionAppengineV1beta.fromValue(map['action'] as String)),
