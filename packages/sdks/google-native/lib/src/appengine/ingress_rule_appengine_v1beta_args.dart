...
class IngressRuleAppengineV1betaArgs {
  ...
  const IngressRuleAppengineV1betaArgs({
    this.action,
    required this.appId,
    this.description,
    this.priority,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'action': ?pulumi.Input.mapOptionalInputValue<IngressRuleActionAppengineV1beta, String>(action, (value) => value.wireValue),
      'appId': appId,
  ...
  factory IngressRuleAppengineV1betaArgs.fromMap(Map<String, dynamic> map) {
    return IngressRuleAppengineV1betaArgs(
      action: (() { final guardedValue = map['action']; if (guardedValue == null) return null; return pulumi.Input.fromValue(IngressRuleActionAppengineV1beta.fromValue(guardedValue as String)); })(),
