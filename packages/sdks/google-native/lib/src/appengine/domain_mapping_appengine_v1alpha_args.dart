...
class DomainMappingAppengineV1alphaArgs {
  ...
  factory DomainMappingAppengineV1alphaArgs.fromMap(Map<String, dynamic> map) {
    return DomainMappingAppengineV1alphaArgs(
      ...
      noManagedCertificate: (() { final guardedValue = map['noManagedCertificate']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      sslSettings: (() { final guardedValue = map['sslSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SslSettingsAppengineV1alpha.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
