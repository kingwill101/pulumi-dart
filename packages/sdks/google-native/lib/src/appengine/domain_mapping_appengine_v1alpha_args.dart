...
class DomainMappingAppengineV1alphaArgs {
  ...
  DomainMappingAppengineV1alphaArgs({
    ...
    pulumi.Output<bool>? noManagedCertificate,
    pulumi.Output<String>? overrideStrategy,
    pulumi.Output<SslSettingsAppengineV1alpha>? sslSettings,
  }) :
      appId = pulumi.Input.asInput<String>(appId),
      id = pulumi.Input.asOptionalInput<String>(id),
      noManagedCertificate = pulumi.Input.asOptionalInput<bool>(noManagedCertificate),
      overrideStrategy = pulumi.Input.asOptionalInput<String>(overrideStrategy),
      sslSettings = pulumi.Input.asOptionalInput<SslSettingsAppengineV1alpha>(sslSettings);
  ...
  factory DomainMappingAppengineV1alphaArgs.fromMap(Map<String, dynamic> map) {
    return DomainMappingAppengineV1alphaArgs(
      ...
      noManagedCertificate: map['noManagedCertificate'] == null ? null : pulumi.Output.create<bool>(map['noManagedCertificate'] as bool),
      overrideStrategy: map['overrideStrategy'] == null ? null : pulumi.Output.create<String>(map['overrideStrategy'] as String),
      sslSettings: map['sslSettings'] == null ? null : pulumi.Output.create<SslSettingsAppengineV1alpha>(SslSettingsAppengineV1alpha.fromMap((map['sslSettings'] as Map).cast<String, dynamic>())),
    );
  }
}
