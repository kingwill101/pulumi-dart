...
class GetAuthorizedCertificateResult {
  ...
  const GetAuthorizedCertificateResult({
  ...
  factory GetAuthorizedCertificateResult.fromMap(Map<String, dynamic> map) {
    return GetAuthorizedCertificateResult(
      certificateRawData: CertificateRawDataResponse.fromMap((map['certificateRawData']! as Map).cast<String, dynamic>()),
      displayName: map['displayName'] as String,
      domainMappingsCount: map['domainMappingsCount'] as int,
      domainNames: (map['domainNames'] as List).cast<String>(),
      expireTime: map['expireTime'] as String,
      managedCertificate: ManagedCertificateResponse.fromMap((map['managedCertificate']! as Map).cast<String, dynamic>()),
