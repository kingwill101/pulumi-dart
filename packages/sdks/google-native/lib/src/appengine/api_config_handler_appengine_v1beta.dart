...
class ApiConfigHandlerAppengineV1beta {
  ...
  final pulumi.Input<ApiConfigHandlerAuthFailActionAppengineV1beta>?
  authFailAction;
  ...
  final pulumi.Input<ApiConfigHandlerSecurityLevelAppengineV1beta>?
  securityLevel;
    ...
    return <String, dynamic>{
      'authFailAction':
          ?pulumi.Input.mapOptionalInputValue<
            ApiConfigHandlerAuthFailActionAppengineV1beta,
            String
          >(authFailAction, (value) => value.wireValue),
      'login':
          ?pulumi.Input.mapOptionalInputValue<
            ApiConfigHandlerLoginAppengineV1beta,
            String
          >(login, (value) => value.wireValue),
      'script': ?script,
      'securityLevel':
          ?pulumi.Input.mapOptionalInputValue<
            ApiConfigHandlerSecurityLevelAppengineV1beta,
            String
