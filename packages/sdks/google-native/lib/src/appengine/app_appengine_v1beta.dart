...
import 'app_appengine_v1beta_args.dart';
...
class AppAppengineV1beta extends pulumi.CustomResource {
  ...
  /// Creates a new [AppAppengineV1beta].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [AppAppengineV1beta]. {@macro pulumi_appengine_v1beta_app_appengine_v1beta_args_doc}
  ...
  AppAppengineV1beta(
    ...
    featureSettings = registerOutput<FeatureSettingsResponseAppengineV1beta>('featureSettings', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return FeatureSettingsResponseAppengineV1beta.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    iap = registerOutput<IdentityAwareProxyResponseAppengineV1beta>('iap', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return IdentityAwareProxyResponseAppengineV1beta.fromMap((guardedValue as Map).cast<String, dynamic>()); });
