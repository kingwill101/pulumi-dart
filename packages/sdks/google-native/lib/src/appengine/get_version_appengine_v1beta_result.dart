...
class GetVersionAppengineV1betaResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'errorHandlers': pulumi.Input.encodeList<ErrorHandlerResponseAppengineV1beta, Map<String, dynamic>>(errorHandlers, (value) => value.toMap()),
      'flexibleRuntimeSettings': flexibleRuntimeSettings.toMap(),
      'generatedCustomerMetadata': generatedCustomerMetadata,
      'handlers': pulumi.Input.encodeList<UrlMapResponseAppengineV1beta, Map<String, dynamic>>(handlers, (value) => value.toMap()),
      'healthCheck': healthCheck.toMap(),
      'inboundServices': inboundServices,
      'instanceClass': instanceClass,
      'libraries': pulumi.Input.encodeList<LibraryResponseAppengineV1beta, Map<String, dynamic>>(libraries, (value) => value.toMap()),
  ...
  factory GetVersionAppengineV1betaResult.fromMap(Map<String, dynamic> map) {
    return GetVersionAppengineV1betaResult(
      apiConfig: ApiConfigHandlerResponseAppengineV1beta.fromMap((map['apiConfig']! as Map).cast<String, dynamic>()),
      appEngineApis: map['appEngineApis'] as bool,
      automaticScaling: AutomaticScalingResponseAppengineV1beta.fromMap((map['automaticScaling']! as Map).cast<String, dynamic>()),
      basicScaling: BasicScalingResponseAppengineV1beta.fromMap((map['basicScaling']! as Map).cast<String, dynamic>()),
      ...
      deployment: DeploymentResponseAppengineV1beta.fromMap((map['deployment']! as Map).cast<String, dynamic>()),
      diskUsageBytes: map['diskUsageBytes'] as String,
      endpointsApiService: EndpointsApiServiceResponseAppengineV1beta.fromMap((map['endpointsApiService']! as Map).cast<String, dynamic>()),
      entrypoint: EntrypointResponseAppengineV1beta.fromMap((map['entrypoint']! as Map).cast<String, dynamic>()),
      env: map['env'] as String,
      envVariables: (map['envVariables'] as Map).cast<String, String>(),
      errorHandlers: pulumi.Input.decodeList<ErrorHandlerResponseAppengineV1beta>(map['errorHandlers']!, (value) => ErrorHandlerResponseAppengineV1beta.fromMap((value as Map).cast<String, dynamic>())),
      flexibleRuntimeSettings: FlexibleRuntimeSettingsResponseAppengineV1beta.fromMap((map['flexibleRuntimeSettings']! as Map).cast<String, dynamic>()),
      generatedCustomerMetadata: (map['generatedCustomerMetadata'] as Map).cast<String, String>(),
      handlers: pulumi.Input.decodeList<UrlMapResponseAppengineV1beta>(map['handlers']!, (value) => UrlMapResponseAppengineV1beta.fromMap((value as Map).cast<String, dynamic>())),
      healthCheck: HealthCheckResponseAppengineV1beta.fromMap((map['healthCheck']! as Map).cast<String, dynamic>()),
      inboundServices: (map['inboundServices'] as List).cast<String>(),
      instanceClass: map['instanceClass'] as String,
      libraries: pulumi.Input.decodeList<LibraryResponseAppengineV1beta>(map['libraries']!, (value) => LibraryResponseAppengineV1beta.fromMap((value as Map).cast<String, dynamic>())),
      livenessCheck: LivenessCheckResponseAppengineV1beta.fromMap((map['livenessCheck']! as Map).cast<String, dynamic>()),
      manualScaling: ManualScalingResponseAppengineV1beta.fromMap((map['manualScaling']! as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      network: NetworkResponseAppengineV1beta.fromMap((map['network']! as Map).cast<String, dynamic>()),
      nobuildFilesRegex: map['nobuildFilesRegex'] as String,
      readinessCheck: ReadinessCheckResponseAppengineV1beta.fromMap((map['readinessCheck']! as Map).cast<String, dynamic>()),
      resources: ResourcesResponseAppengineV1beta.fromMap((map['resources']! as Map).cast<String, dynamic>()),
      ...
      vm: map['vm'] as bool,
      vpcAccessConnector: VpcAccessConnectorResponseAppengineV1beta.fromMap((map['vpcAccessConnector']! as Map).cast<String, dynamic>()),
