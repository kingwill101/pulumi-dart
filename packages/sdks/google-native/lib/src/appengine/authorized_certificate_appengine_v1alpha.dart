...
class AuthorizedCertificateAppengineV1alpha extends pulumi.CustomResource {
  ...
  AuthorizedCertificateAppengineV1alpha(
    ...
    certificateRawData = registerOutput<CertificateRawDataResponseAppengineV1alpha>('certificateRawData', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return CertificateRawDataResponseAppengineV1alpha.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    managedCertificate = registerOutput<ManagedCertificateResponseAppengineV1alpha>('managedCertificate', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ManagedCertificateResponseAppengineV1alpha.fromMap((guardedValue as Map).cast<String, dynamic>()); });
