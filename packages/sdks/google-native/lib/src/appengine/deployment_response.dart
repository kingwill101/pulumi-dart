...
class DeploymentResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'cloudBuildOptions': pulumi.Input.mapInputValue<CloudBuildOptionsResponse, Map<String, dynamic>>(cloudBuildOptions, (value) => value.toMap()),
      'container': pulumi.Input.mapInputValue<ContainerInfoResponse, Map<String, dynamic>>(container, (value) => value.toMap()),
      'files': files,
      'zip': pulumi.Input.mapInputValue<ZipInfoResponse, Map<String, dynamic>>(zip, (value) => value.toMap()),
    };
  }

  factory DeploymentResponse.fromMap(Map<String, dynamic> map) {
    return DeploymentResponse(
      cloudBuildOptions: pulumi.Input.fromValue(CloudBuildOptionsResponse.fromMap((map['cloudBuildOptions']! as Map).cast<String, dynamic>())),
      container: pulumi.Input.fromValue(ContainerInfoResponse.fromMap((map['container']! as Map).cast<String, dynamic>())),
      files: pulumi.Input.fromValue((map['files'] as Map).cast<String, String>()),
      zip: pulumi.Input.fromValue(ZipInfoResponse.fromMap((map['zip']! as Map).cast<String, dynamic>())),
    );
  }
}
