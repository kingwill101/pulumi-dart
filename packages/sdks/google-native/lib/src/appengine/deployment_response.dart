...
class DeploymentResponse {
  ...
  factory DeploymentResponse.fromMap(Map<String, dynamic> map) {
    return DeploymentResponse(
      cloudBuildOptions: (CloudBuildOptionsResponse.fromMap((map['cloudBuildOptions'] as Map).cast<String, dynamic>())).input(),
      container: (ContainerInfoResponse.fromMap((map['container'] as Map).cast<String, dynamic>())).input(),
      files: ((map['files'] as Map).cast<String, String>()).input(),
      zip: (ZipInfoResponse.fromMap((map['zip'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
