...
class Network {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'instanceIpMode': ?pulumi.Input.mapOptionalInputValue<NetworkInstanceIpMode, String>(instanceIpMode, (value) => value.wireValue),
  ...
  factory Network.fromMap(Map<String, dynamic> map) {
    return Network(
      ...
      instanceIpMode: (() { final guardedValue = map['instanceIpMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkInstanceIpMode.fromValue(guardedValue as String)); })(),
