...
class UrlMapResponseAppengineV1beta {
  ...
  factory UrlMapResponseAppengineV1beta.fromMap(Map<String, dynamic> map) {
    return UrlMapResponseAppengineV1beta(
      apiEndpoint: (ApiEndpointHandlerResponseAppengineV1beta.fromMap((map['apiEndpoint'] as Map).cast<String, dynamic>())).input(),
      ...
      script: (ScriptHandlerResponseAppengineV1beta.fromMap((map['script'] as Map).cast<String, dynamic>())).input(),
      securityLevel: (map['securityLevel'] as String).input(),
      staticFiles: (StaticFilesHandlerResponseAppengineV1beta.fromMap((map['staticFiles'] as Map).cast<String, dynamic>())).input(),
