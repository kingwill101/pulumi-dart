...
class VersionArgs {
  ...
  VersionArgs({
    pulumi.Output<ApiConfigHandler>? apiConfig,
    pulumi.Output<bool>? appEngineApis,
    required pulumi.Output<String> appId,
    pulumi.Output<AutomaticScaling>? automaticScaling,
    pulumi.Output<BasicScaling>? basicScaling,
    ...
    pulumi.Output<EndpointsApiService>? endpointsApiService,
    pulumi.Output<Entrypoint>? entrypoint,
    pulumi.Output<String>? env,
    pulumi.Output<Map<String, String>>? envVariables,
    pulumi.Output<List<ErrorHandler>>? errorHandlers,
    pulumi.Output<FlexibleRuntimeSettings>? flexibleRuntimeSettings,
    pulumi.Output<Map<String, String>>? generatedCustomerMetadata,
    pulumi.Output<List<UrlMap>>? handlers,
    pulumi.Output<HealthCheck>? healthCheck,
    pulumi.Output<String>? id,
    pulumi.Output<List<VersionInboundServicesItem>>? inboundServices,
    pulumi.Output<String>? instanceClass,
    pulumi.Output<List<Library>>? libraries,
    pulumi.Output<LivenessCheck>? livenessCheck,
    pulumi.Output<ManualScaling>? manualScaling,
    pulumi.Output<Network>? network,
    pulumi.Output<String>? nobuildFilesRegex,
    pulumi.Output<ReadinessCheck>? readinessCheck,
    ...
    pulumi.Output<VersionServingStatus>? servingStatus,
    pulumi.Output<bool>? threadsafe,
    pulumi.Output<bool>? vm,
    pulumi.Output<VpcAccessConnector>? vpcAccessConnector,
    pulumi.Output<List<String>>? zones,
  }) :
      apiConfig = pulumi.Input.asOptionalInput<ApiConfigHandler>(apiConfig),
      appEngineApis = pulumi.Input.asOptionalInput<bool>(appEngineApis),
      appId = pulumi.Input.asInput<String>(appId),
      automaticScaling = pulumi.Input.asOptionalInput<AutomaticScaling>(automaticScaling),
      basicScaling = pulumi.Input.asOptionalInput<BasicScaling>(basicScaling),
      ...
      endpointsApiService = pulumi.Input.asOptionalInput<EndpointsApiService>(endpointsApiService),
      entrypoint = pulumi.Input.asOptionalInput<Entrypoint>(entrypoint),
      env = pulumi.Input.asOptionalInput<String>(env),
      envVariables = pulumi.Input.asOptionalInput<Map<String, String>>(envVariables),
      errorHandlers = pulumi.Input.asOptionalInput<List<ErrorHandler>>(errorHandlers),
      flexibleRuntimeSettings = pulumi.Input.asOptionalInput<FlexibleRuntimeSettings>(flexibleRuntimeSettings),
      generatedCustomerMetadata = pulumi.Input.asOptionalInput<Map<String, String>>(generatedCustomerMetadata),
      handlers = pulumi.Input.asOptionalInput<List<UrlMap>>(handlers),
      healthCheck = pulumi.Input.asOptionalInput<HealthCheck>(healthCheck),
      id = pulumi.Input.asOptionalInput<String>(id),
      inboundServices = pulumi.Input.asOptionalInput<List<VersionInboundServicesItem>>(inboundServices),
      instanceClass = pulumi.Input.asOptionalInput<String>(instanceClass),
      libraries = pulumi.Input.asOptionalInput<List<Library>>(libraries),
      livenessCheck = pulumi.Input.asOptionalInput<LivenessCheck>(livenessCheck),
      manualScaling = pulumi.Input.asOptionalInput<ManualScaling>(manualScaling),
      ...
      readinessCheck = pulumi.Input.asOptionalInput<ReadinessCheck>(readinessCheck),
      ...
      servingStatus = pulumi.Input.asOptionalInput<VersionServingStatus>(servingStatus),
      threadsafe = pulumi.Input.asOptionalInput<bool>(threadsafe),
      vm = pulumi.Input.asOptionalInput<bool>(vm),
      vpcAccessConnector = pulumi.Input.asOptionalInput<VpcAccessConnector>(vpcAccessConnector),
  ...
  factory VersionArgs.fromMap(Map<String, dynamic> map) {
    return VersionArgs(
      apiConfig: map['apiConfig'] == null ? null : pulumi.Output.create<ApiConfigHandler>(ApiConfigHandler.fromMap((map['apiConfig'] as Map).cast<String, dynamic>())),
      appEngineApis: map['appEngineApis'] == null ? null : pulumi.Output.create<bool>(map['appEngineApis'] as bool),
      appId: pulumi.Output.create<String>(map['appId'] as String),
      automaticScaling: map['automaticScaling'] == null ? null : pulumi.Output.create<AutomaticScaling>(AutomaticScaling.fromMap((map['automaticScaling'] as Map).cast<String, dynamic>())),
      basicScaling: map['basicScaling'] == null ? null : pulumi.Output.create<BasicScaling>(BasicScaling.fromMap((map['basicScaling'] as Map).cast<String, dynamic>())),
      ...
      endpointsApiService: map['endpointsApiService'] == null ? null : pulumi.Output.create<EndpointsApiService>(EndpointsApiService.fromMap((map['endpointsApiService'] as Map).cast<String, dynamic>())),
      entrypoint: map['entrypoint'] == null ? null : pulumi.Output.create<Entrypoint>(Entrypoint.fromMap((map['entrypoint'] as Map).cast<String, dynamic>())),
      ...
      errorHandlers: map['errorHandlers'] == null ? null : pulumi.Output.create<List<ErrorHandler>>(pulumi.Input.decodeList<ErrorHandler>(map['errorHandlers'], (value) => ErrorHandler.fromMap((value as Map).cast<String, dynamic>()))),
      flexibleRuntimeSettings: map['flexibleRuntimeSettings'] == null ? null : pulumi.Output.create<FlexibleRuntimeSettings>(FlexibleRuntimeSettings.fromMap((map['flexibleRuntimeSettings'] as Map).cast<String, dynamic>())),
      ...
      handlers: map['handlers'] == null ? null : pulumi.Output.create<List<UrlMap>>(pulumi.Input.decodeList<UrlMap>(map['handlers'], (value) => UrlMap.fromMap((value as Map).cast<String, dynamic>()))),
      healthCheck: map['healthCheck'] == null ? null : pulumi.Output.create<HealthCheck>(HealthCheck.fromMap((map['healthCheck'] as Map).cast<String, dynamic>())),
      id: map['id'] == null ? null : pulumi.Output.create<String>(map['id'] as String),
      inboundServices: map['inboundServices'] == null ? null : pulumi.Output.create<List<VersionInboundServicesItem>>(pulumi.Input.decodeList<VersionInboundServicesItem>(map['inboundServices'], (value) => VersionInboundServicesItem.fromValue(value as String))),
      instanceClass: map['instanceClass'] == null ? null : pulumi.Output.create<String>(map['instanceClass'] as String),
      libraries: map['libraries'] == null ? null : pulumi.Output.create<List<Library>>(pulumi.Input.decodeList<Library>(map['libraries'], (value) => Library.fromMap((value as Map).cast<String, dynamic>()))),
      livenessCheck: map['livenessCheck'] == null ? null : pulumi.Output.create<LivenessCheck>(LivenessCheck.fromMap((map['livenessCheck'] as Map).cast<String, dynamic>())),
      manualScaling: map['manualScaling'] == null ? null : pulumi.Output.create<ManualScaling>(ManualScaling.fromMap((map['manualScaling'] as Map).cast<String, dynamic>())),
      ...
      readinessCheck: map['readinessCheck'] == null ? null : pulumi.Output.create<ReadinessCheck>(ReadinessCheck.fromMap((map['readinessCheck'] as Map).cast<String, dynamic>())),
      ...
      servingStatus: map['servingStatus'] == null ? null : pulumi.Output.create<VersionServingStatus>(VersionServingStatus.fromValue(map['servingStatus'] as String)),
      ...
      vpcAccessConnector: map['vpcAccessConnector'] == null ? null : pulumi.Output.create<VpcAccessConnector>(VpcAccessConnector.fromMap((map['vpcAccessConnector'] as Map).cast<String, dynamic>())),
