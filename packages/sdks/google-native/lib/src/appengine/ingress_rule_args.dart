...
class IngressRuleArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'action': ?pulumi.Input.mapOptionalInputValue<IngressRuleAction, String>(action, (value) => value.wireValue),
      'appId': appId,
  ...
  factory IngressRuleArgs.fromMap(Map<String, dynamic> map) {
    return IngressRuleArgs(
      action: (() { final guardedValue = map['action']; if (guardedValue == null) return null; return pulumi.Input.fromValue(IngressRuleAction.fromValue(guardedValue as String)); })(),
