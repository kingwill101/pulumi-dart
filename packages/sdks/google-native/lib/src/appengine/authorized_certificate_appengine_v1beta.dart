...
class AuthorizedCertificateAppengineV1beta extends pulumi.CustomResource {
  ...
  AuthorizedCertificateAppengineV1beta(
    ...
    this.certificateRawData = registerOutput<CertificateRawDataResponseAppengineV1beta>('certificateRawData');
    ...
    this.managedCertificate = registerOutput<ManagedCertificateResponseAppengineV1beta>('managedCertificate');
