...
class AuthorizedCertificateAppengineV1alphaArgs {
  ...
  const AuthorizedCertificateAppengineV1alphaArgs({
    required this.appId,
  ...
  factory AuthorizedCertificateAppengineV1alphaArgs.fromMap(Map<String, dynamic> map) {
    return AuthorizedCertificateAppengineV1alphaArgs(
      ...
      certificateRawData: (() { final guardedValue = map['certificateRawData']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CertificateRawDataAppengineV1alpha.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
