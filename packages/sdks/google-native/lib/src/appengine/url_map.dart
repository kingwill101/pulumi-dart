...
class UrlMap {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'authFailAction': ?pulumi.Input.mapOptionalInputValue<UrlMapAuthFailAction, String>(authFailAction, (value) => value.wireValue),
      'login': ?pulumi.Input.mapOptionalInputValue<UrlMapLogin, String>(login, (value) => value.wireValue),
      'redirectHttpResponseCode': ?pulumi.Input.mapOptionalInputValue<UrlMapRedirectHttpResponseCode, String>(redirectHttpResponseCode, (value) => value.wireValue),
      'script': ?pulumi.Input.mapOptionalInputValue<ScriptHandler, Map<String, dynamic>>(script, (value) => value.toMap()),
      'securityLevel': ?pulumi.Input.mapOptionalInputValue<UrlMapSecurityLevel, String>(securityLevel, (value) => value.wireValue),
  ...
  factory UrlMap.fromMap(Map<String, dynamic> map) {
    return UrlMap(
      apiEndpoint: (() { final guardedValue = map['apiEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ApiEndpointHandler.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      authFailAction: (() { final guardedValue = map['authFailAction']; if (guardedValue == null) return null; return pulumi.Input.fromValue(UrlMapAuthFailAction.fromValue(guardedValue as String)); })(),
      login: (() { final guardedValue = map['login']; if (guardedValue == null) return null; return pulumi.Input.fromValue(UrlMapLogin.fromValue(guardedValue as String)); })(),
      redirectHttpResponseCode: (() { final guardedValue = map['redirectHttpResponseCode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(UrlMapRedirectHttpResponseCode.fromValue(guardedValue as String)); })(),
      script: (() { final guardedValue = map['script']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ScriptHandler.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      securityLevel: (() { final guardedValue = map['securityLevel']; if (guardedValue == null) return null; return pulumi.Input.fromValue(UrlMapSecurityLevel.fromValue(guardedValue as String)); })(),
      staticFiles: (() { final guardedValue = map['staticFiles']; if (guardedValue == null) return null; return pulumi.Input.fromValue(StaticFilesHandler.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
