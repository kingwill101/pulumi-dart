    ...
    return AppArgs(
      ...
      databaseType: (() {
        ...
        return pulumi.Input.fromValue(
          AppDatabaseType.fromValue(guardedValue as String),
        );
      })(),
      ...
      dispatchRules: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<UrlDispatchRule>(
            guardedValue,
            (value) =>
                UrlDispatchRule.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      featureSettings: (() {
      ...
      servingStatus: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AppServingStatus.fromValue(guardedValue as String),
        );
      })(),
    );
  }
