...
class AutomaticScalingAppengineV1beta {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'customMetrics': ?customMetrics == null ? null : pulumi.Input.encodeList<CustomMetric, Map<String, dynamic>>(customMetrics!, (value) => value.toMap()),
  ...
  factory AutomaticScalingAppengineV1beta.fromMap(Map<String, dynamic> map) {
    return AutomaticScalingAppengineV1beta(
      ...
      cpuUtilization: map['cpuUtilization'] == null ? null : CpuUtilizationAppengineV1beta.fromMap((map['cpuUtilization'] as Map).cast<String, dynamic>()),
      customMetrics: map['customMetrics'] == null ? null : pulumi.Input.decodeList<CustomMetric>(map['customMetrics'], (value) => CustomMetric.fromMap((value as Map).cast<String, dynamic>())),
      diskUtilization: map['diskUtilization'] == null ? null : DiskUtilizationAppengineV1beta.fromMap((map['diskUtilization'] as Map).cast<String, dynamic>()),
      ...
      networkUtilization: map['networkUtilization'] == null ? null : NetworkUtilizationAppengineV1beta.fromMap((map['networkUtilization'] as Map).cast<String, dynamic>()),
      requestUtilization: map['requestUtilization'] == null ? null : RequestUtilizationAppengineV1beta.fromMap((map['requestUtilization'] as Map).cast<String, dynamic>()),
      standardSchedulerSettings: map['standardSchedulerSettings'] == null ? null : StandardSchedulerSettingsAppengineV1beta.fromMap((map['standardSchedulerSettings'] as Map).cast<String, dynamic>()),
    );
  }
}
