...
class AuthorizedCertificateArgs {
  ...
  AuthorizedCertificateArgs({
    ...
    pulumi.Output<CertificateRawData>? certificateRawData,
  ...
  factory AuthorizedCertificateArgs.fromMap(Map<String, dynamic> map) {
    return AuthorizedCertificateArgs(
      ...
      certificateRawData: map['certificateRawData'] == null ? null : pulumi.Output.create<CertificateRawData>(CertificateRawData.fromMap((map['certificateRawData'] as Map).cast<String, dynamic>())),
