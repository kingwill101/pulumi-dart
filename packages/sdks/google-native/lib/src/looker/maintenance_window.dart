...
class MaintenanceWindow {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'dayOfWeek': pulumi.Input.mapInputValue<MaintenanceWindowDayOfWeek, String>(dayOfWeek, (value) => value.wireValue),
  ...
  factory MaintenanceWindow.fromMap(Map<String, dynamic> map) {
    return MaintenanceWindow(
      dayOfWeek: pulumi.Input.fromValue(MaintenanceWindowDayOfWeek.fromValue(map['dayOfWeek']! as String)),
