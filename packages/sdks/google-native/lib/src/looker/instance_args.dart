...
class InstanceArgs {
    ...
    return <String, dynamic>{
      'adminSettings':
          ?pulumi.Input.mapOptionalInputValue<
            AdminSettings,
            Map<String, dynamic>
          >(adminSettings, (value) => value.toMap()),
      ...
      'denyMaintenancePeriod':
          ?pulumi.Input.mapOptionalInputValue<
            DenyMaintenancePeriod,
            Map<String, dynamic>
          >(denyMaintenancePeriod, (value) => value.toMap()),
      'encryptionConfig':
          ?pulumi.Input.mapOptionalInputValue<
            EncryptionConfig,
            Map<String, dynamic>
      ...
      'maintenanceSchedule':
          ?pulumi.Input.mapOptionalInputValue<
            MaintenanceSchedule,
            Map<String, dynamic>
          >(maintenanceSchedule, (value) => value.toMap()),
      'maintenanceWindow':
          ?pulumi.Input.mapOptionalInputValue<
            MaintenanceWindow,
            Map<String, dynamic>
      ...
      'userMetadata':
          ?pulumi.Input.mapOptionalInputValue<
            UserMetadata,
            Map<String, dynamic>
          >(userMetadata, (value) => value.toMap()),
    };
  }
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      adminSettings: (() {
        final guardedValue = map['adminSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AdminSettings.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      consumerNetwork: (() {
      ...
      denyMaintenancePeriod: (() {
        final guardedValue = map['denyMaintenancePeriod'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      maintenanceSchedule: (() {
        final guardedValue = map['maintenanceSchedule'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      oauthConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          OAuthConfig.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      platformEdition: (() {
        final guardedValue = map['platformEdition'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          InstancePlatformEdition.fromValue(guardedValue as String),
        );
      })(),
      privateIpEnabled: (() {
        final guardedValue = map['privateIpEnabled'];
        if (guardedValue == null) return null;
      ...
      reservedRange: (() {
        final guardedValue = map['reservedRange'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      userMetadata: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          UserMetadata.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
