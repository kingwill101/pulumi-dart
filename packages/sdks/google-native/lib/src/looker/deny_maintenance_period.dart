...
class DenyMaintenancePeriod {
  ...
  factory DenyMaintenancePeriod.fromMap(Map<String, dynamic> map) {
    return DenyMaintenancePeriod(
      endDate: pulumi.Input.fromValue(Date.fromMap((map['endDate']! as Map).cast<String, dynamic>())),
      startDate: pulumi.Input.fromValue(Date.fromMap((map['startDate']! as Map).cast<String, dynamic>())),
      time: pulumi.Input.fromValue(TimeOfDay.fromMap((map['time']! as Map).cast<String, dynamic>())),
    );
  }
}
