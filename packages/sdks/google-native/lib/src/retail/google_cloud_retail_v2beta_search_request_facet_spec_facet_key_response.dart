...
class GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKeyResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'contains': contains,
      'intervals': pulumi.Input.encodeList<GoogleCloudRetailV2betaIntervalResponse, Map<String, dynamic>>(intervals, (value) => value.toMap()),
      'key': key,
      'orderBy': orderBy,
      'prefixes': prefixes,
      'query': query,
  ...
  factory GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKeyResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKeyResponse(
      ...
      intervals: pulumi.Input.decodeList<GoogleCloudRetailV2betaIntervalResponse>(map['intervals'], (value) => GoogleCloudRetailV2betaIntervalResponse.fromMap((value as Map).cast<String, dynamic>())),
