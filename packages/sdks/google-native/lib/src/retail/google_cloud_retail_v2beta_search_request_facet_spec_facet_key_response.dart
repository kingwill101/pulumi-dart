...
class GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKeyResponse {
  ...
  final pulumi.Input<List<GoogleCloudRetailV2betaIntervalResponse>> intervals;
  ...
  /// Creates a new [GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKeyResponse].
  ...
  const GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKeyResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'contains': contains,
      'intervals': pulumi.Input.mapInputValue<List<GoogleCloudRetailV2betaIntervalResponse>, List<Map<String, dynamic>>>(intervals, (value) => pulumi.Input.encodeList<GoogleCloudRetailV2betaIntervalResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'key': key,
      'orderBy': orderBy,
      'prefixes': prefixes,
      'query': query,
  ...
  factory GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKeyResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKeyResponse(
      ...
      intervals: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudRetailV2betaIntervalResponse>(map['intervals']!, (value) => GoogleCloudRetailV2betaIntervalResponse.fromMap((value as Map).cast<String, dynamic>()))),
