...
class GoogleCloudRetailV2alphaPriceInfoResponse {
  ...
  final pulumi.Input<GoogleCloudRetailV2alphaPriceInfoPriceRangeResponse> priceRange;
  ...
  const GoogleCloudRetailV2alphaPriceInfoResponse({
    required this.cost,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'priceRange': pulumi.Input.mapInputValue<GoogleCloudRetailV2alphaPriceInfoPriceRangeResponse, Map<String, dynamic>>(priceRange, (value) => value.toMap()),
    };
  }

  factory GoogleCloudRetailV2alphaPriceInfoResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2alphaPriceInfoResponse(
      ...
      priceRange: pulumi.Input.fromValue(GoogleCloudRetailV2alphaPriceInfoPriceRangeResponse.fromMap((map['priceRange']! as Map).cast<String, dynamic>())),
    );
  }
}
