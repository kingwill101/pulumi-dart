...
class GoogleCloudRetailV2betaRuleDoNotAssociateAction {
  ...
  factory GoogleCloudRetailV2betaRuleDoNotAssociateAction.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2betaRuleDoNotAssociateAction(
      doNotAssociateTerms: map['doNotAssociateTerms'] == null ? null : (map['doNotAssociateTerms'] as List).cast<String>(),
      queryTerms: map['queryTerms'] == null ? null : (map['queryTerms'] as List).cast<String>(),
      terms: map['terms'] == null ? null : (map['terms'] as List).cast<String>(),
    );
  }
}
