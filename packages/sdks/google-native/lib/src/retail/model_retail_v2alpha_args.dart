    ...
    return <String, dynamic>{
      ...
      'pageOptimizationConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(pageOptimizationConfig, (value) => value.toMap()),
      'periodicTuningState':
          ?pulumi.Input.mapOptionalInputValue<
    ...
    return ModelRetailV2alphaArgs(
      ...
      filteringOption: (() {
        ...
        return pulumi.Input.fromValue(
          ModelFilteringOptionRetailV2alpha.fromValue(guardedValue as String),
        );
      })(),
      location: (() {
      ...
      pageOptimizationConfig: (() {
        final guardedValue = map['pageOptimizationConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      trainingState: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ModelTrainingStateRetailV2alpha.fromValue(guardedValue as String),
        );
      })(),
