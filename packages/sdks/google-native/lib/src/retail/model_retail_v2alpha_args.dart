...
class ModelRetailV2alphaArgs {
  ...
  factory ModelRetailV2alphaArgs.fromMap(Map<String, dynamic> map) {
    return ModelRetailV2alphaArgs(
      ...
      filteringOption: map['filteringOption'] == null ? null : (ModelFilteringOptionRetailV2alpha.fromValue(map['filteringOption']! as String)).input(),
      location: map['location'] == null ? null : (map['location']! as String).input(),
      modelFeaturesConfig: map['modelFeaturesConfig'] == null ? null : (GoogleCloudRetailV2alphaModelModelFeaturesConfig.fromMap((map['modelFeaturesConfig']! as Map).cast<String, dynamic>())).input(),
      name: map['name'] == null ? null : (map['name']! as String).input(),
      optimizationObjective: map['optimizationObjective'] == null ? null : (map['optimizationObjective']! as String).input(),
      pageOptimizationConfig: map['pageOptimizationConfig'] == null ? null : (GoogleCloudRetailV2alphaModelPageOptimizationConfig.fromMap((map['pageOptimizationConfig']! as Map).cast<String, dynamic>())).input(),
      periodicTuningState: map['periodicTuningState'] == null ? null : (ModelPeriodicTuningStateRetailV2alpha.fromValue(map['periodicTuningState']! as String)).input(),
      project: map['project'] == null ? null : (map['project']! as String).input(),
      trainingState: map['trainingState'] == null ? null : (ModelTrainingStateRetailV2alpha.fromValue(map['trainingState']! as String)).input(),
