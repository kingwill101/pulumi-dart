...
class GoogleCloudRetailV2betaRuleRemoveFacetActionResponse {
  ...
  /// Creates a new [GoogleCloudRetailV2betaRuleRemoveFacetActionResponse].
  ...
  const GoogleCloudRetailV2betaRuleRemoveFacetActionResponse({
  ...
  factory GoogleCloudRetailV2betaRuleRemoveFacetActionResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2betaRuleRemoveFacetActionResponse(
