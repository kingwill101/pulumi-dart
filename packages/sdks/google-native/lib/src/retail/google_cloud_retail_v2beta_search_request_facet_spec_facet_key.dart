...
class GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey {
  ...
  final pulumi.Input<List<GoogleCloudRetailV2betaInterval>>? intervals;
  ...
  /// Creates a new [GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey].
  ...
  const GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'contains': ?contains,
      'intervals': ?pulumi.Input.mapOptionalInputValue<List<GoogleCloudRetailV2betaInterval>, List<Map<String, dynamic>>>(intervals, (value) => pulumi.Input.encodeList<GoogleCloudRetailV2betaInterval, Map<String, dynamic>>(value, (value) => value.toMap())),
      'key': key,
      'orderBy': ?orderBy,
      'prefixes': ?prefixes,
      'query': ?query,
  ...
  factory GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey(
      ...
      intervals: (() { final guardedValue = map['intervals']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudRetailV2betaInterval>(guardedValue, (value) => GoogleCloudRetailV2betaInterval.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      restrictedValues: (() { final guardedValue = map['restrictedValues']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      returnMinMax: (() { final guardedValue = map['returnMinMax']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
    );
  }
}
