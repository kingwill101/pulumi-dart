...
class GoogleCloudRetailV2Condition {
  ...
  final pulumi.Input<List<GoogleCloudRetailV2ConditionTimeRange>>? activeTimeRange;
  ...
  const GoogleCloudRetailV2Condition({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'activeTimeRange': ?pulumi.Input.mapOptionalInputValue<List<GoogleCloudRetailV2ConditionTimeRange>, List<Map<String, dynamic>>>(activeTimeRange, (value) => pulumi.Input.encodeList<GoogleCloudRetailV2ConditionTimeRange, Map<String, dynamic>>(value, (value) => value.toMap())),
      'pageCategories': ?pageCategories,
      'queryTerms': ?pulumi.Input.mapOptionalInputValue<List<GoogleCloudRetailV2ConditionQueryTerm>, List<Map<String, dynamic>>>(queryTerms, (value) => pulumi.Input.encodeList<GoogleCloudRetailV2ConditionQueryTerm, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory GoogleCloudRetailV2Condition.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2Condition(
      activeTimeRange: (() { final guardedValue = map['activeTimeRange']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudRetailV2ConditionTimeRange>(guardedValue, (value) => GoogleCloudRetailV2ConditionTimeRange.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      queryTerms: (() { final guardedValue = map['queryTerms']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudRetailV2ConditionQueryTerm>(guardedValue, (value) => GoogleCloudRetailV2ConditionQueryTerm.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
