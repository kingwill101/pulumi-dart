...
class GoogleCloudRetailV2Condition {
  ...
  factory GoogleCloudRetailV2Condition.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2Condition(
      activeTimeRange: map['activeTimeRange'] == null ? null : (pulumi.Input.decodeList<GoogleCloudRetailV2ConditionTimeRange>(map['activeTimeRange'], (value) => GoogleCloudRetailV2ConditionTimeRange.fromMap((value as Map).cast<String, dynamic>()))).input(),
      pageCategories: map['pageCategories'] == null ? null : ((map['pageCategories'] as List).cast<String>()).input(),
      queryTerms: map['queryTerms'] == null ? null : (pulumi.Input.decodeList<GoogleCloudRetailV2ConditionQueryTerm>(map['queryTerms'], (value) => GoogleCloudRetailV2ConditionQueryTerm.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
