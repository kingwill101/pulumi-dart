...
class GoogleCloudRetailV2Condition {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'activeTimeRange': ?activeTimeRange == null ? null : pulumi.Input.encodeList<GoogleCloudRetailV2ConditionTimeRange, Map<String, dynamic>>(activeTimeRange!, (value) => value.toMap()),
      'pageCategories': ?pageCategories,
      'queryTerms': ?queryTerms == null ? null : pulumi.Input.encodeList<GoogleCloudRetailV2ConditionQueryTerm, Map<String, dynamic>>(queryTerms!, (value) => value.toMap()),
    };
  }

  factory GoogleCloudRetailV2Condition.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2Condition(
      activeTimeRange: map['activeTimeRange'] == null ? null : pulumi.Input.decodeList<GoogleCloudRetailV2ConditionTimeRange>(map['activeTimeRange'], (value) => GoogleCloudRetailV2ConditionTimeRange.fromMap((value as Map).cast<String, dynamic>())),
      pageCategories: map['pageCategories'] == null ? null : (map['pageCategories'] as List).cast<String>(),
      queryTerms: map['queryTerms'] == null ? null : pulumi.Input.decodeList<GoogleCloudRetailV2ConditionQueryTerm>(map['queryTerms'], (value) => GoogleCloudRetailV2ConditionQueryTerm.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
