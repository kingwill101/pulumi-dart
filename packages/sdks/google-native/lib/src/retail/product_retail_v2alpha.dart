...
import 'product_retail_v2alpha_args.dart';

/// Creates a Product.
class ProductRetailV2alpha extends pulumi.CustomResource {
  ...
  late final pulumi.Output<GoogleCloudRetailV2alphaAudienceResponse> audience;
  ...
  late final pulumi.Output<GoogleCloudRetailV2alphaColorInfoResponse> colorInfo;
  ...
  late final pulumi.Output<GoogleCloudRetailV2alphaPriceInfoResponse> priceInfo;
  ...
  late final pulumi.Output<GoogleCloudRetailV2alphaRatingResponse> rating;
  ...
  /// Creates a new [ProductRetailV2alpha].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ProductRetailV2alpha]. {@macro pulumi_retail_v2alpha_product_retail_v2alpha_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  ProductRetailV2alpha(
    String name, {
    ProductRetailV2alphaArgs? args,
    ...
    audience = registerOutput<GoogleCloudRetailV2alphaAudienceResponse>('audience', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return GoogleCloudRetailV2alphaAudienceResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    colorInfo = registerOutput<GoogleCloudRetailV2alphaColorInfoResponse>('colorInfo', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return GoogleCloudRetailV2alphaColorInfoResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    conditions = registerOutput<List<String>>('conditions');
    description = registerOutput<String>('description');
    expireTime = registerOutput<String>('expireTime');
    fulfillmentInfo = registerOutput<List<Map<String, dynamic>>>('fulfillmentInfo');
    ...
    localInventories = registerOutput<List<Map<String, dynamic>>>('localInventories');
    location = registerOutput<String>('location');
    materials = registerOutput<List<String>>('materials');
    this.name = registerOutput<String>('name');
    patterns = registerOutput<List<String>>('patterns');
    priceInfo = registerOutput<GoogleCloudRetailV2alphaPriceInfoResponse>('priceInfo', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return GoogleCloudRetailV2alphaPriceInfoResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    rating = registerOutput<GoogleCloudRetailV2alphaRatingResponse>('rating', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return GoogleCloudRetailV2alphaRatingResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
