...
class GoogleCloudRetailV2betaConditionResponse {
  ...
  final pulumi.Input<List<GoogleCloudRetailV2betaConditionTimeRangeResponse>>
  activeTimeRange;
  ...
  final pulumi.Input<List<GoogleCloudRetailV2betaConditionQueryTermResponse>>
  queryTerms;
    ...
    return <String, dynamic>{
      'activeTimeRange':
          pulumi.Input.mapInputValue<
            List<GoogleCloudRetailV2betaConditionTimeRangeResponse>,
      ...
      'queryTerms':
          pulumi.Input.mapInputValue<
            List<GoogleCloudRetailV2betaConditionQueryTermResponse>,
            List<Map<String, dynamic>>
          >(
            queryTerms,
            (value) =>
