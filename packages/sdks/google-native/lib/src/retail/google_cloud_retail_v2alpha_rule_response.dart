...
class GoogleCloudRetailV2alphaRuleResponse {
  /// A boost action.
  final pulumi.Input<GoogleCloudRetailV2alphaRuleBoostActionResponse>
  boostAction;
  ...
  final pulumi.Input<GoogleCloudRetailV2alphaRuleDoNotAssociateActionResponse>
  doNotAssociateAction;

  /// Filters results.
  final pulumi.Input<GoogleCloudRetailV2alphaRuleFilterActionResponse>
  filterAction;

  /// Force returns an attribute as a facet in the request.
  final pulumi.Input<GoogleCloudRetailV2alphaRuleForceReturnFacetActionResponse>
  forceReturnFacetAction;

  /// Ignores specific terms from query during search.
  final pulumi.Input<GoogleCloudRetailV2alphaRuleIgnoreActionResponse>
  ignoreAction;

  /// Treats specific term as a synonym with a group of terms. Group of terms will not be treated as synonyms with the specific term.
  final pulumi.Input<GoogleCloudRetailV2alphaRuleOnewaySynonymsActionResponse>
  onewaySynonymsAction;

  /// Redirects a shopper to a specific page.
  final pulumi.Input<GoogleCloudRetailV2alphaRuleRedirectActionResponse>
  redirectAction;

  /// Remove an attribute as a facet in the request (if present).
  final pulumi.Input<GoogleCloudRetailV2alphaRuleRemoveFacetActionResponse>
  removeFacetAction;

  /// Replaces specific terms in the query.
  final pulumi.Input<GoogleCloudRetailV2alphaRuleReplacementActionResponse>
  replacementAction;

  /// Treats a set of terms as synonyms of one another.
  final pulumi.Input<GoogleCloudRetailV2alphaRuleTwowaySynonymsActionResponse>
  ...
  factory GoogleCloudRetailV2alphaRuleResponse.fromMap(
    ...
    return GoogleCloudRetailV2alphaRuleResponse(
      boostAction: pulumi.Input.fromValue(
        GoogleCloudRetailV2alphaRuleBoostActionResponse.fromMap(
          (map['boostAction']! as Map).cast<String, dynamic>(),
        ),
      ),
      condition: pulumi.Input.fromValue(
        GoogleCloudRetailV2alphaConditionResponse.fromMap(
      ...
      filterAction: pulumi.Input.fromValue(
        GoogleCloudRetailV2alphaRuleFilterActionResponse.fromMap(
      ...
      ignoreAction: pulumi.Input.fromValue(
        GoogleCloudRetailV2alphaRuleIgnoreActionResponse.fromMap(
