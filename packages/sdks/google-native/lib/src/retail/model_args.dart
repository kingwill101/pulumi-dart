...
class ModelArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'dryRun': ?dryRun,
      'filteringOption': ?pulumi.Input.mapOptionalInputValue<ModelFilteringOption, String>(filteringOption, (value) => value.wireValue),
      'location': ?location,
      ...
      'periodicTuningState': ?pulumi.Input.mapOptionalInputValue<ModelPeriodicTuningState, String>(periodicTuningState, (value) => value.wireValue),
      'project': ?project,
      'trainingState': ?pulumi.Input.mapOptionalInputValue<ModelTrainingState, String>(trainingState, (value) => value.wireValue),
      'type': type,
    };
  }
  ...
  factory ModelArgs.fromMap(Map<String, dynamic> map) {
    return ModelArgs(
      ...
      filteringOption: (() { final guardedValue = map['filteringOption']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ModelFilteringOption.fromValue(guardedValue as String)); })(),
      location: (() { final guardedValue = map['location']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      modelFeaturesConfig: (() { final guardedValue = map['modelFeaturesConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudRetailV2ModelModelFeaturesConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      periodicTuningState: (() { final guardedValue = map['periodicTuningState']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ModelPeriodicTuningState.fromValue(guardedValue as String)); })(),
      project: (() { final guardedValue = map['project']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      trainingState: (() { final guardedValue = map['trainingState']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ModelTrainingState.fromValue(guardedValue as String)); })(),
