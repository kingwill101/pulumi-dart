...
class GoogleCloudRetailV2betaRuleForceReturnFacetActionResponse {
  ...
  final List<GoogleCloudRetailV2betaRuleForceReturnFacetActionFacetPositionAdjustmentResponse> facetPositionAdjustments;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'facetPositionAdjustments': pulumi.Input.encodeList<GoogleCloudRetailV2betaRuleForceReturnFacetActionFacetPositionAdjustmentResponse, Map<String, dynamic>>(facetPositionAdjustments, (value) => value.toMap()),
    };
  }
  ...
  factory GoogleCloudRetailV2betaRuleForceReturnFacetActionResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2betaRuleForceReturnFacetActionResponse(
      facetPositionAdjustments: pulumi.Input.decodeList<GoogleCloudRetailV2betaRuleForceReturnFacetActionFacetPositionAdjustmentResponse>(map['facetPositionAdjustments'], (value) => GoogleCloudRetailV2betaRuleForceReturnFacetActionFacetPositionAdjustmentResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
