...
class GoogleCloudRetailV2betaRuleForceReturnFacetActionResponse {
  ...
  final pulumi.Input<List<GoogleCloudRetailV2betaRuleForceReturnFacetActionFacetPositionAdjustmentResponse>> facetPositionAdjustments;
  ...
  const GoogleCloudRetailV2betaRuleForceReturnFacetActionResponse({
    required this.facetPositionAdjustments,
  });

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'facetPositionAdjustments': pulumi.Input.mapInputValue<List<GoogleCloudRetailV2betaRuleForceReturnFacetActionFacetPositionAdjustmentResponse>, List<Map<String, dynamic>>>(facetPositionAdjustments, (value) => pulumi.Input.encodeList<GoogleCloudRetailV2betaRuleForceReturnFacetActionFacetPositionAdjustmentResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory GoogleCloudRetailV2betaRuleForceReturnFacetActionResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2betaRuleForceReturnFacetActionResponse(
      facetPositionAdjustments: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudRetailV2betaRuleForceReturnFacetActionFacetPositionAdjustmentResponse>(map['facetPositionAdjustments']!, (value) => GoogleCloudRetailV2betaRuleForceReturnFacetActionFacetPositionAdjustmentResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
