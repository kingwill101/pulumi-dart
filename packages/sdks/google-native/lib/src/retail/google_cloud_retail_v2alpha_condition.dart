...
class GoogleCloudRetailV2alphaCondition {
  ...
  final pulumi.Input<List<GoogleCloudRetailV2alphaConditionTimeRange>>?
  activeTimeRange;
  ...
  final pulumi.Input<List<GoogleCloudRetailV2alphaConditionQueryTerm>>?
  queryTerms;
    ...
    return <String, dynamic>{
      'activeTimeRange':
          ?pulumi.Input.mapOptionalInputValue<
            List<GoogleCloudRetailV2alphaConditionTimeRange>,
      ...
      'queryTerms':
          ?pulumi.Input.mapOptionalInputValue<
            List<GoogleCloudRetailV2alphaConditionQueryTerm>,
            List<Map<String, dynamic>>
          >(
            queryTerms,
            (value) =>
