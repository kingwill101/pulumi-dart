...
class ProductRetailV2beta extends pulumi.CustomResource {
  ...
  ProductRetailV2beta(
    ...
    audience = registerOutput<GoogleCloudRetailV2betaAudienceResponse>('audience', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return GoogleCloudRetailV2betaAudienceResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    colorInfo = registerOutput<GoogleCloudRetailV2betaColorInfoResponse>('colorInfo', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return GoogleCloudRetailV2betaColorInfoResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    priceInfo = registerOutput<GoogleCloudRetailV2betaPriceInfoResponse>('priceInfo', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return GoogleCloudRetailV2betaPriceInfoResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    rating = registerOutput<GoogleCloudRetailV2betaRatingResponse>('rating', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return GoogleCloudRetailV2betaRatingResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
