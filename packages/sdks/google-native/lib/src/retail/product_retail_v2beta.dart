...
class ProductRetailV2beta extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<GoogleCloudRetailV2betaFulfillmentInfoResponse>> fulfillmentInfo;
  ...
  late final pulumi.Output<List<GoogleCloudRetailV2betaImageResponse>> images;
  ...
  late final pulumi.Output<List<GoogleCloudRetailV2betaLocalInventoryResponse>> localInventories;
  ...
  late final pulumi.Output<List<GoogleCloudRetailV2betaPromotionResponse>> promotions;
  ...
  late final pulumi.Output<List<GoogleCloudRetailV2betaProductResponse>> variants;
  ...
  ProductRetailV2beta(
    ...
    this.audience = registerOutput<GoogleCloudRetailV2betaAudienceResponse>('audience');
    ...
    this.colorInfo = registerOutput<GoogleCloudRetailV2betaColorInfoResponse>('colorInfo');
    this.conditions = registerOutput<List<String>>('conditions');
    this.description = registerOutput<String>('description');
    this.expireTime = registerOutput<String>('expireTime');
    this.fulfillmentInfo = registerOutput<List<GoogleCloudRetailV2betaFulfillmentInfoResponse>>('fulfillmentInfo');
    this.gtin = registerOutput<String>('gtin');
    this.images = registerOutput<List<GoogleCloudRetailV2betaImageResponse>>('images');
    this.languageCode = registerOutput<String>('languageCode');
    this.localInventories = registerOutput<List<GoogleCloudRetailV2betaLocalInventoryResponse>>('localInventories');
    this.location = registerOutput<String>('location');
    this.materials = registerOutput<List<String>>('materials');
    this.name = registerOutput<String>('name');
    this.patterns = registerOutput<List<String>>('patterns');
    this.priceInfo = registerOutput<GoogleCloudRetailV2betaPriceInfoResponse>('priceInfo');
    this.primaryProductId = registerOutput<String>('primaryProductId');
    this.productId = registerOutput<String>('productId');
    this.project = registerOutput<String>('project');
    this.promotions = registerOutput<List<GoogleCloudRetailV2betaPromotionResponse>>('promotions');
    this.publishTime = registerOutput<String>('publishTime');
    this.rating = registerOutput<GoogleCloudRetailV2betaRatingResponse>('rating');
    ...
    this.variants = registerOutput<List<GoogleCloudRetailV2betaProductResponse>>('variants');
  }
}
