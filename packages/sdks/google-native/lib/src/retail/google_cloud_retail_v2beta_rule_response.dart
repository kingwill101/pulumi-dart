...
class GoogleCloudRetailV2betaRuleResponse {
  /// A boost action.
  final pulumi.Input<GoogleCloudRetailV2betaRuleBoostActionResponse>
  boostAction;
  ...
  final pulumi.Input<GoogleCloudRetailV2betaRuleDoNotAssociateActionResponse>
  doNotAssociateAction;

  /// Filters results.
  final pulumi.Input<GoogleCloudRetailV2betaRuleFilterActionResponse>
  filterAction;

  /// Force returns an attribute as a facet in the request.
  final pulumi.Input<GoogleCloudRetailV2betaRuleForceReturnFacetActionResponse>
  forceReturnFacetAction;

  /// Ignores specific terms from query during search.
  final pulumi.Input<GoogleCloudRetailV2betaRuleIgnoreActionResponse>
  ignoreAction;

  /// Treats specific term as a synonym with a group of terms. Group of terms will not be treated as synonyms with the specific term.
  final pulumi.Input<GoogleCloudRetailV2betaRuleOnewaySynonymsActionResponse>
  onewaySynonymsAction;

  /// Redirects a shopper to a specific page.
  final pulumi.Input<GoogleCloudRetailV2betaRuleRedirectActionResponse>
  redirectAction;

  /// Remove an attribute as a facet in the request (if present).
  final pulumi.Input<GoogleCloudRetailV2betaRuleRemoveFacetActionResponse>
  removeFacetAction;

  /// Replaces specific terms in the query.
  final pulumi.Input<GoogleCloudRetailV2betaRuleReplacementActionResponse>
  replacementAction;

  /// Treats a set of terms as synonyms of one another.
  final pulumi.Input<GoogleCloudRetailV2betaRuleTwowaySynonymsActionResponse>
    ...
    return <String, dynamic>{
      ...
      'doNotAssociateAction':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(doNotAssociateAction, (value) => value.toMap()),
      'filterAction':
          pulumi.Input.mapInputValue<
      ...
      'forceReturnFacetAction':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(forceReturnFacetAction, (value) => value.toMap()),
      'ignoreAction':
          pulumi.Input.mapInputValue<
            GoogleCloudRetailV2betaRuleIgnoreActionResponse,
            Map<String, dynamic>
          >(ignoreAction, (value) => value.toMap()),
      'onewaySynonymsAction':
          pulumi.Input.mapInputValue<
            GoogleCloudRetailV2betaRuleOnewaySynonymsActionResponse,
            Map<String, dynamic>
          >(onewaySynonymsAction, (value) => value.toMap()),
      'redirectAction':
          pulumi.Input.mapInputValue<
      ...
      'removeFacetAction':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(removeFacetAction, (value) => value.toMap()),
      'replacementAction':
          pulumi.Input.mapInputValue<
            GoogleCloudRetailV2betaRuleReplacementActionResponse,
            Map<String, dynamic>
          >(replacementAction, (value) => value.toMap()),
      'twowaySynonymsAction':
          pulumi.Input.mapInputValue<
            GoogleCloudRetailV2betaRuleTwowaySynonymsActionResponse,
            Map<String, dynamic>
          >(twowaySynonymsAction, (value) => value.toMap()),
    };
  }
