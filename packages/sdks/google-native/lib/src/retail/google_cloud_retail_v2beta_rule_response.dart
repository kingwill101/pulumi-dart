...
class GoogleCloudRetailV2betaRuleResponse {
  ...
  factory GoogleCloudRetailV2betaRuleResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2betaRuleResponse(
      boostAction: (GoogleCloudRetailV2betaRuleBoostActionResponse.fromMap((map['boostAction'] as Map).cast<String, dynamic>())).input(),
      condition: (GoogleCloudRetailV2betaConditionResponse.fromMap((map['condition'] as Map).cast<String, dynamic>())).input(),
      doNotAssociateAction: (GoogleCloudRetailV2betaRuleDoNotAssociateActionResponse.fromMap((map['doNotAssociateAction'] as Map).cast<String, dynamic>())).input(),
      filterAction: (GoogleCloudRetailV2betaRuleFilterActionResponse.fromMap((map['filterAction'] as Map).cast<String, dynamic>())).input(),
      forceReturnFacetAction: (GoogleCloudRetailV2betaRuleForceReturnFacetActionResponse.fromMap((map['forceReturnFacetAction'] as Map).cast<String, dynamic>())).input(),
      ignoreAction: (GoogleCloudRetailV2betaRuleIgnoreActionResponse.fromMap((map['ignoreAction'] as Map).cast<String, dynamic>())).input(),
      onewaySynonymsAction: (GoogleCloudRetailV2betaRuleOnewaySynonymsActionResponse.fromMap((map['onewaySynonymsAction'] as Map).cast<String, dynamic>())).input(),
      redirectAction: (GoogleCloudRetailV2betaRuleRedirectActionResponse.fromMap((map['redirectAction'] as Map).cast<String, dynamic>())).input(),
      removeFacetAction: (GoogleCloudRetailV2betaRuleRemoveFacetActionResponse.fromMap((map['removeFacetAction'] as Map).cast<String, dynamic>())).input(),
      replacementAction: (GoogleCloudRetailV2betaRuleReplacementActionResponse.fromMap((map['replacementAction'] as Map).cast<String, dynamic>())).input(),
      twowaySynonymsAction: (GoogleCloudRetailV2betaRuleTwowaySynonymsActionResponse.fromMap((map['twowaySynonymsAction'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
