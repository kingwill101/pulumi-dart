...
class GoogleCloudRetailV2alphaRuleDoNotAssociateActionResponse {
  ...
  /// Creates a new [GoogleCloudRetailV2alphaRuleDoNotAssociateActionResponse].
  ...
  factory GoogleCloudRetailV2alphaRuleDoNotAssociateActionResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2alphaRuleDoNotAssociateActionResponse(
      doNotAssociateTerms: ((map['doNotAssociateTerms'] as List).cast<String>()).input(),
      queryTerms: ((map['queryTerms'] as List).cast<String>()).input(),
      terms: ((map['terms'] as List).cast<String>()).input(),
    );
  }
}
