...
class GoogleCloudRetailV2betaCondition {
  ...
  const GoogleCloudRetailV2betaCondition({
  ...
  factory GoogleCloudRetailV2betaCondition.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2betaCondition(
      activeTimeRange: (() { final guardedValue = map['activeTimeRange']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudRetailV2betaConditionTimeRange>(guardedValue, (value) => GoogleCloudRetailV2betaConditionTimeRange.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      queryTerms: (() { final guardedValue = map['queryTerms']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudRetailV2betaConditionQueryTerm>(guardedValue, (value) => GoogleCloudRetailV2betaConditionQueryTerm.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
