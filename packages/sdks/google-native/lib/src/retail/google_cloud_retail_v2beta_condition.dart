...
class GoogleCloudRetailV2betaCondition {
  ...
  final pulumi.Input<List<GoogleCloudRetailV2betaConditionTimeRange>>?
  activeTimeRange;
  ...
  final pulumi.Input<List<GoogleCloudRetailV2betaConditionQueryTerm>>?
  queryTerms;
    ...
    return <String, dynamic>{
      'activeTimeRange':
          ?pulumi.Input.mapOptionalInputValue<
            List<GoogleCloudRetailV2betaConditionTimeRange>,
      ...
      'queryTerms':
          ?pulumi.Input.mapOptionalInputValue<
            List<GoogleCloudRetailV2betaConditionQueryTerm>,
            List<Map<String, dynamic>>
          >(
            queryTerms,
            (value) =>
