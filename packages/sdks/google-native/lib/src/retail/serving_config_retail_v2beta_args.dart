...
import 'serving_config_diversity_type_retail_v2beta.dart';
import 'serving_config_solution_types_item_retail_v2beta.dart';

/// {@template pulumi_retail_v2beta_serving_config_retail_v2beta_args_doc}
/// The set of arguments for ServingConfig.
/// {@endtemplate}
/// {@macro pulumi_retail_v2beta_serving_config_retail_v2beta_args_doc}
class ServingConfigRetailV2betaArgs {
  ...
  final pulumi.Input<ServingConfigDiversityTypeRetailV2beta>? diversityType;
  ...
  final pulumi.Input<GoogleCloudRetailV2betaSearchRequestDynamicFacetSpec>? dynamicFacetSpec;
  ...
  final pulumi.Input<GoogleCloudRetailV2betaSearchRequestPersonalizationSpec>? personalizationSpec;
  ...
  final pulumi.Input<List<ServingConfigSolutionTypesItemRetailV2beta>> solutionTypes;
  /// Condition synonyms specifications. If multiple syonyms conditions match, all matching synonyms control in the list will execute. Order of controls in the list will not matter. Maximum number of specifications is 100. Can only be set if solution_types is SOLUTION_TYPE_SEARCH.
  final pulumi.Input<List<String>>? twowaySynonymsControlIds;

  /// Creates a new [ServingConfigRetailV2betaArgs].
  ...
  ServingConfigRetailV2betaArgs({
    ...
    pulumi.Output<String>? diversityLevel,
    pulumi.Output<ServingConfigDiversityTypeRetailV2beta>? diversityType,
    pulumi.Output<List<String>>? doNotAssociateControlIds,
    pulumi.Output<GoogleCloudRetailV2betaSearchRequestDynamicFacetSpec>? dynamicFacetSpec,
    pulumi.Output<String>? enableCategoryFilterLevel,
    pulumi.Output<List<String>>? facetControlIds,
    pulumi.Output<List<String>>? filterControlIds,
    pulumi.Output<List<String>>? ignoreControlIds,
    pulumi.Output<String>? location,
    pulumi.Output<String>? modelId,
    pulumi.Output<String>? name,
    pulumi.Output<List<String>>? onewaySynonymsControlIds,
    pulumi.Output<GoogleCloudRetailV2betaSearchRequestPersonalizationSpec>? personalizationSpec,
    pulumi.Output<String>? priceRerankingLevel,
    pulumi.Output<String>? project,
    pulumi.Output<List<String>>? redirectControlIds,
    pulumi.Output<List<String>>? replacementControlIds,
    required pulumi.Output<String> servingConfigId,
    required pulumi.Output<List<ServingConfigSolutionTypesItemRetailV2beta>> solutionTypes,
    pulumi.Output<List<String>>? twowaySynonymsControlIds,
  }) :
      ...
      diversityType = pulumi.Input.asOptionalInput<ServingConfigDiversityTypeRetailV2beta>(diversityType),
      doNotAssociateControlIds = pulumi.Input.asOptionalInput<List<String>>(doNotAssociateControlIds),
      dynamicFacetSpec = pulumi.Input.asOptionalInput<GoogleCloudRetailV2betaSearchRequestDynamicFacetSpec>(dynamicFacetSpec),
      ...
      personalizationSpec = pulumi.Input.asOptionalInput<GoogleCloudRetailV2betaSearchRequestPersonalizationSpec>(personalizationSpec),
      ...
      solutionTypes = pulumi.Input.asInput<List<ServingConfigSolutionTypesItemRetailV2beta>>(solutionTypes),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'diversityType': ?pulumi.Input.mapOptionalInputValue<ServingConfigDiversityTypeRetailV2beta, String>(diversityType, (value) => value.value),
      'doNotAssociateControlIds': ?doNotAssociateControlIds,
      'dynamicFacetSpec': ?pulumi.Input.mapOptionalInputValue<GoogleCloudRetailV2betaSearchRequestDynamicFacetSpec, Map<String, dynamic>>(dynamicFacetSpec, (value) => value.toMap()),
      ...
      'personalizationSpec': ?pulumi.Input.mapOptionalInputValue<GoogleCloudRetailV2betaSearchRequestPersonalizationSpec, Map<String, dynamic>>(personalizationSpec, (value) => value.toMap()),
      ...
      'solutionTypes': pulumi.Input.mapInputValue<List<ServingConfigSolutionTypesItemRetailV2beta>, List<String>>(solutionTypes, (value) => pulumi.Input.encodeList<ServingConfigSolutionTypesItemRetailV2beta, String>(value, (value) => value.value)),
      'twowaySynonymsControlIds': ?twowaySynonymsControlIds,
    };
  }

  factory ServingConfigRetailV2betaArgs.fromMap(Map<String, dynamic> map) {
    return ServingConfigRetailV2betaArgs(
      ...
      diversityLevel: map['diversityLevel'] == null ? null : pulumi.Output.create<String>(map['diversityLevel'] as String),
      diversityType: map['diversityType'] == null ? null : pulumi.Output.create<ServingConfigDiversityTypeRetailV2beta>(ServingConfigDiversityTypeRetailV2beta.fromValue(map['diversityType'] as String)),
      doNotAssociateControlIds: map['doNotAssociateControlIds'] == null ? null : pulumi.Output.create<List<String>>((map['doNotAssociateControlIds'] as List).cast<String>()),
      dynamicFacetSpec: map['dynamicFacetSpec'] == null ? null : pulumi.Output.create<GoogleCloudRetailV2betaSearchRequestDynamicFacetSpec>(GoogleCloudRetailV2betaSearchRequestDynamicFacetSpec.fromMap((map['dynamicFacetSpec'] as Map).cast<String, dynamic>())),
      enableCategoryFilterLevel: map['enableCategoryFilterLevel'] == null ? null : pulumi.Output.create<String>(map['enableCategoryFilterLevel'] as String),
      facetControlIds: map['facetControlIds'] == null ? null : pulumi.Output.create<List<String>>((map['facetControlIds'] as List).cast<String>()),
      ...
      ignoreControlIds: map['ignoreControlIds'] == null ? null : pulumi.Output.create<List<String>>((map['ignoreControlIds'] as List).cast<String>()),
      location: map['location'] == null ? null : pulumi.Output.create<String>(map['location'] as String),
      modelId: map['modelId'] == null ? null : pulumi.Output.create<String>(map['modelId'] as String),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      onewaySynonymsControlIds: map['onewaySynonymsControlIds'] == null ? null : pulumi.Output.create<List<String>>((map['onewaySynonymsControlIds'] as List).cast<String>()),
      personalizationSpec: map['personalizationSpec'] == null ? null : pulumi.Output.create<GoogleCloudRetailV2betaSearchRequestPersonalizationSpec>(GoogleCloudRetailV2betaSearchRequestPersonalizationSpec.fromMap((map['personalizationSpec'] as Map).cast<String, dynamic>())),
      priceRerankingLevel: map['priceRerankingLevel'] == null ? null : pulumi.Output.create<String>(map['priceRerankingLevel'] as String),
      ...
      replacementControlIds: map['replacementControlIds'] == null ? null : pulumi.Output.create<List<String>>((map['replacementControlIds'] as List).cast<String>()),
      servingConfigId: pulumi.Output.create<String>(map['servingConfigId'] as String),
      solutionTypes: pulumi.Output.create<List<ServingConfigSolutionTypesItemRetailV2beta>>(pulumi.Input.decodeList<ServingConfigSolutionTypesItemRetailV2beta>(map['solutionTypes'], (value) => ServingConfigSolutionTypesItemRetailV2beta.fromValue(value as String))),
      twowaySynonymsControlIds: map['twowaySynonymsControlIds'] == null ? null : pulumi.Output.create<List<String>>((map['twowaySynonymsControlIds'] as List).cast<String>()),
    );
  }
}
