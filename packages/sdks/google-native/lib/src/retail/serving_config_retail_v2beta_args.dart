...
class ServingConfigRetailV2betaArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'diversityType': ?pulumi.Input.mapOptionalInputValue<ServingConfigDiversityTypeRetailV2beta, String>(diversityType, (value) => value.wireValue),
      ...
      'solutionTypes': pulumi.Input.mapInputValue<List<ServingConfigSolutionTypesItemRetailV2beta>, List<String>>(solutionTypes, (value) => pulumi.Input.encodeList<ServingConfigSolutionTypesItemRetailV2beta, String>(value, (value) => value.wireValue)),
  ...
  factory ServingConfigRetailV2betaArgs.fromMap(Map<String, dynamic> map) {
    return ServingConfigRetailV2betaArgs(
      ...
      diversityType: (() { final guardedValue = map['diversityType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServingConfigDiversityTypeRetailV2beta.fromValue(guardedValue as String)); })(),
      ...
      dynamicFacetSpec: (() { final guardedValue = map['dynamicFacetSpec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudRetailV2betaSearchRequestDynamicFacetSpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      personalizationSpec: (() { final guardedValue = map['personalizationSpec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudRetailV2betaSearchRequestPersonalizationSpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      solutionTypes: pulumi.Input.fromValue(pulumi.Input.decodeList<ServingConfigSolutionTypesItemRetailV2beta>(map['solutionTypes']!, (value) => ServingConfigSolutionTypesItemRetailV2beta.fromValue(value as String))),
