...
class GoogleCloudRetailV2alphaColorInfoResponse {
  ...
  /// Creates a new [GoogleCloudRetailV2alphaColorInfoResponse].
  ...
  const GoogleCloudRetailV2alphaColorInfoResponse({
  ...
  factory GoogleCloudRetailV2alphaColorInfoResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2alphaColorInfoResponse(
