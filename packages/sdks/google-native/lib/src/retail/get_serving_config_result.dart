...
class GetServingConfigResult {
  ...
  final GoogleCloudRetailV2SearchRequestDynamicFacetSpecResponse dynamicFacetSpec;
  ...
  final GoogleCloudRetailV2SearchRequestPersonalizationSpecResponse personalizationSpec;
  ...
  /// Creates a new [GetServingConfigResult].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'dynamicFacetSpec': dynamicFacetSpec.toMap(),
      ...
      'personalizationSpec': personalizationSpec.toMap(),
  ...
  factory GetServingConfigResult.fromMap(Map<String, dynamic> map) {
    return GetServingConfigResult(
      ...
      doNotAssociateControlIds: (map['doNotAssociateControlIds'] as List).cast<String>(),
      dynamicFacetSpec: GoogleCloudRetailV2SearchRequestDynamicFacetSpecResponse.fromMap((map['dynamicFacetSpec']! as Map).cast<String, dynamic>()),
      ...
      onewaySynonymsControlIds: (map['onewaySynonymsControlIds'] as List).cast<String>(),
      personalizationSpec: GoogleCloudRetailV2SearchRequestPersonalizationSpecResponse.fromMap((map['personalizationSpec']! as Map).cast<String, dynamic>()),
      priceRerankingLevel: map['priceRerankingLevel'] as String,
      redirectControlIds: (map['redirectControlIds'] as List).cast<String>(),
      replacementControlIds: (map['replacementControlIds'] as List).cast<String>(),
      solutionTypes: (map['solutionTypes'] as List).cast<String>(),
      twowaySynonymsControlIds: (map['twowaySynonymsControlIds'] as List).cast<String>(),
    );
  }
}
