...
class GoogleCloudRetailV2alphaRuleForceReturnFacetActionResponse {
  ...
  factory GoogleCloudRetailV2alphaRuleForceReturnFacetActionResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2alphaRuleForceReturnFacetActionResponse(
      facetPositionAdjustments: (pulumi.Input.decodeList<GoogleCloudRetailV2alphaRuleForceReturnFacetActionFacetPositionAdjustmentResponse>(map['facetPositionAdjustments'], (value) => GoogleCloudRetailV2alphaRuleForceReturnFacetActionFacetPositionAdjustmentResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
