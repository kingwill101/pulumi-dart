...
class GoogleCloudRetailV2alphaRuleForceReturnFacetActionResponse {
  ...
  final List<GoogleCloudRetailV2alphaRuleForceReturnFacetActionFacetPositionAdjustmentResponse> facetPositionAdjustments;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'facetPositionAdjustments': pulumi.Input.encodeList<GoogleCloudRetailV2alphaRuleForceReturnFacetActionFacetPositionAdjustmentResponse, Map<String, dynamic>>(facetPositionAdjustments, (value) => value.toMap()),
    };
  }
  ...
  factory GoogleCloudRetailV2alphaRuleForceReturnFacetActionResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2alphaRuleForceReturnFacetActionResponse(
      facetPositionAdjustments: pulumi.Input.decodeList<GoogleCloudRetailV2alphaRuleForceReturnFacetActionFacetPositionAdjustmentResponse>(map['facetPositionAdjustments'], (value) => GoogleCloudRetailV2alphaRuleForceReturnFacetActionFacetPositionAdjustmentResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
