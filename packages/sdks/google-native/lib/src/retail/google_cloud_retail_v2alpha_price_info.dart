...
class GoogleCloudRetailV2alphaPriceInfo {
  ...
  factory GoogleCloudRetailV2alphaPriceInfo.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2alphaPriceInfo(
      ...
      originalPrice: (() {
        final guardedValue = map['originalPrice'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as double);
      })(),
      price: (() {
        final guardedValue = map['price'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as double);
      })(),
      priceEffectiveTime: (() {
        final guardedValue = map['priceEffectiveTime'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      priceExpireTime: (() {
        final guardedValue = map['priceExpireTime'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
