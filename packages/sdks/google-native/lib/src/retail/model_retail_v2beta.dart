...
class ModelRetailV2beta extends pulumi.CustomResource {
  ...
  ModelRetailV2beta(
    ...
    modelFeaturesConfig = registerOutput<GoogleCloudRetailV2betaModelModelFeaturesConfigResponse>('modelFeaturesConfig', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return GoogleCloudRetailV2betaModelModelFeaturesConfigResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
