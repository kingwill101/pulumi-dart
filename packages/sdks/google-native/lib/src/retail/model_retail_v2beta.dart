...
class ModelRetailV2beta extends pulumi.CustomResource {
  ...
  late final pulumi.Output<GoogleCloudRetailV2betaModelModelFeaturesConfigResponse> modelFeaturesConfig;
  ...
  late final pulumi.Output<List<GoogleCloudRetailV2betaModelServingConfigListResponse>> servingConfigLists;
  ...
  ModelRetailV2beta(
    ...
    this.modelFeaturesConfig = registerOutput<GoogleCloudRetailV2betaModelModelFeaturesConfigResponse>('modelFeaturesConfig');
    this.name = registerOutput<String>('name');
    this.optimizationObjective = registerOutput<String>('optimizationObjective');
    this.periodicTuningState = registerOutput<String>('periodicTuningState');
    this.project = registerOutput<String>('project');
    this.servingConfigLists = registerOutput<List<GoogleCloudRetailV2betaModelServingConfigListResponse>>('servingConfigLists');
