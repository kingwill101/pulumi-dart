...
class GoogleCloudRetailV2betaModelFrequentlyBoughtTogetherFeaturesConfig {
  ...
  const GoogleCloudRetailV2betaModelFrequentlyBoughtTogetherFeaturesConfig({
    this.contextProductsType,
  });

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'contextProductsType': ?pulumi.Input.mapOptionalInputValue<GoogleCloudRetailV2betaModelFrequentlyBoughtTogetherFeaturesConfigContextProductsType, String>(contextProductsType, (value) => value.wireValue),
    };
  }
  ...
  factory GoogleCloudRetailV2betaModelFrequentlyBoughtTogetherFeaturesConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2betaModelFrequentlyBoughtTogetherFeaturesConfig(
      contextProductsType: (() { final guardedValue = map['contextProductsType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudRetailV2betaModelFrequentlyBoughtTogetherFeaturesConfigContextProductsType.fromValue(guardedValue as String)); })(),
    );
  }
}
