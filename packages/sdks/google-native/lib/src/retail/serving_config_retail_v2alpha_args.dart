...
class ServingConfigRetailV2alphaArgs {
  ...
  const ServingConfigRetailV2alphaArgs({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'diversityType': ?pulumi.Input.mapOptionalInputValue<ServingConfigDiversityTypeRetailV2alpha, String>(diversityType, (value) => value.wireValue),
      ...
      'solutionTypes': pulumi.Input.mapInputValue<List<ServingConfigSolutionTypesItemRetailV2alpha>, List<String>>(solutionTypes, (value) => pulumi.Input.encodeList<ServingConfigSolutionTypesItemRetailV2alpha, String>(value, (value) => value.wireValue)),
  ...
  factory ServingConfigRetailV2alphaArgs.fromMap(Map<String, dynamic> map) {
    return ServingConfigRetailV2alphaArgs(
      ...
      diversityType: (() { final guardedValue = map['diversityType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServingConfigDiversityTypeRetailV2alpha.fromValue(guardedValue as String)); })(),
      ...
      dynamicFacetSpec: (() { final guardedValue = map['dynamicFacetSpec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudRetailV2alphaSearchRequestDynamicFacetSpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      personalizationSpec: (() { final guardedValue = map['personalizationSpec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudRetailV2alphaSearchRequestPersonalizationSpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      solutionTypes: pulumi.Input.fromValue(pulumi.Input.decodeList<ServingConfigSolutionTypesItemRetailV2alpha>(map['solutionTypes']!, (value) => ServingConfigSolutionTypesItemRetailV2alpha.fromValue(value as String))),
