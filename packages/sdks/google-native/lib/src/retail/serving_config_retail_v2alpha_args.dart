...
/// {@template pulumi_retail_v2alpha_serving_config_retail_v2alpha_args_doc}
/// The set of arguments for ServingConfig.
/// {@endtemplate}
/// {@macro pulumi_retail_v2alpha_serving_config_retail_v2alpha_args_doc}
class ServingConfigRetailV2alphaArgs {
  ...
  final pulumi.Input<GoogleCloudRetailV2alphaSearchRequestDynamicFacetSpec>? dynamicFacetSpec;
  ...
  final pulumi.Input<GoogleCloudRetailV2alphaSearchRequestPersonalizationSpec>? personalizationSpec;
  ...
  final pulumi.Input<List<ServingConfigSolutionTypesItemRetailV2alpha>> solutionTypes;
  /// Condition synonyms specifications. If multiple syonyms conditions match, all matching synonyms control in the list will execute. Order of controls in the list will not matter. Maximum number of specifications is 100. Can only be set if solution_types is SOLUTION_TYPE_SEARCH.
  final pulumi.Input<List<String>>? twowaySynonymsControlIds;

  /// Creates a new [ServingConfigRetailV2alphaArgs].
  ...
  ServingConfigRetailV2alphaArgs({
    ...
    pulumi.Output<ServingConfigDiversityTypeRetailV2alpha>? diversityType,
    pulumi.Output<List<String>>? doNotAssociateControlIds,
    pulumi.Output<GoogleCloudRetailV2alphaSearchRequestDynamicFacetSpec>? dynamicFacetSpec,
    ...
    pulumi.Output<GoogleCloudRetailV2alphaSearchRequestPersonalizationSpec>? personalizationSpec,
    ...
    required pulumi.Output<List<ServingConfigSolutionTypesItemRetailV2alpha>> solutionTypes,
    pulumi.Output<List<String>>? twowaySynonymsControlIds,
      ...
      diversityType = pulumi.Input.asOptionalInput<ServingConfigDiversityTypeRetailV2alpha>(diversityType),
      doNotAssociateControlIds = pulumi.Input.asOptionalInput<List<String>>(doNotAssociateControlIds),
      dynamicFacetSpec = pulumi.Input.asOptionalInput<GoogleCloudRetailV2alphaSearchRequestDynamicFacetSpec>(dynamicFacetSpec),
      ...
      personalizationSpec = pulumi.Input.asOptionalInput<GoogleCloudRetailV2alphaSearchRequestPersonalizationSpec>(personalizationSpec),
      ...
      solutionTypes = pulumi.Input.asInput<List<ServingConfigSolutionTypesItemRetailV2alpha>>(solutionTypes),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'diversityType': ?pulumi.Input.mapOptionalInputValue<ServingConfigDiversityTypeRetailV2alpha, String>(diversityType, (value) => value.value),
      'doNotAssociateControlIds': ?doNotAssociateControlIds,
      'dynamicFacetSpec': ?pulumi.Input.mapOptionalInputValue<GoogleCloudRetailV2alphaSearchRequestDynamicFacetSpec, Map<String, dynamic>>(dynamicFacetSpec, (value) => value.toMap()),
      ...
      'personalizationSpec': ?pulumi.Input.mapOptionalInputValue<GoogleCloudRetailV2alphaSearchRequestPersonalizationSpec, Map<String, dynamic>>(personalizationSpec, (value) => value.toMap()),
      ...
      'solutionTypes': pulumi.Input.mapInputValue<List<ServingConfigSolutionTypesItemRetailV2alpha>, List<String>>(solutionTypes, (value) => pulumi.Input.encodeList<ServingConfigSolutionTypesItemRetailV2alpha, String>(value, (value) => value.value)),
  ...
  factory ServingConfigRetailV2alphaArgs.fromMap(Map<String, dynamic> map) {
    return ServingConfigRetailV2alphaArgs(
      ...
      diversityType: map['diversityType'] == null ? null : pulumi.Output.create<ServingConfigDiversityTypeRetailV2alpha>(ServingConfigDiversityTypeRetailV2alpha.fromValue(map['diversityType'] as String)),
      ...
      dynamicFacetSpec: map['dynamicFacetSpec'] == null ? null : pulumi.Output.create<GoogleCloudRetailV2alphaSearchRequestDynamicFacetSpec>(GoogleCloudRetailV2alphaSearchRequestDynamicFacetSpec.fromMap((map['dynamicFacetSpec'] as Map).cast<String, dynamic>())),
      ...
      personalizationSpec: map['personalizationSpec'] == null ? null : pulumi.Output.create<GoogleCloudRetailV2alphaSearchRequestPersonalizationSpec>(GoogleCloudRetailV2alphaSearchRequestPersonalizationSpec.fromMap((map['personalizationSpec'] as Map).cast<String, dynamic>())),
      ...
      solutionTypes: pulumi.Output.create<List<ServingConfigSolutionTypesItemRetailV2alpha>>(pulumi.Input.decodeList<ServingConfigSolutionTypesItemRetailV2alpha>(map['solutionTypes'], (value) => ServingConfigSolutionTypesItemRetailV2alpha.fromValue(value as String))),
