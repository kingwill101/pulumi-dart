...
class GoogleCloudRetailV2alphaLocalInventoryResponse {
  ...
  const GoogleCloudRetailV2alphaLocalInventoryResponse({
  ...
  factory GoogleCloudRetailV2alphaLocalInventoryResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2alphaLocalInventoryResponse(
      ...
      priceInfo: pulumi.Input.fromValue(GoogleCloudRetailV2alphaPriceInfoResponse.fromMap((map['priceInfo']! as Map).cast<String, dynamic>())),
    );
  }
}
