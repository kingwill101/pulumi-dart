...
class GoogleCloudRetailV2alphaLocalInventoryResponse {
  ...
  factory GoogleCloudRetailV2alphaLocalInventoryResponse.fromMap(
    ...
    return GoogleCloudRetailV2alphaLocalInventoryResponse(
      ...
      fulfillmentTypes: pulumi.Input.fromValue(
        (map['fulfillmentTypes'] as List).cast<String>(),
      ),
      placeId: pulumi.Input.fromValue(map['placeId'] as String),
      priceInfo: pulumi.Input.fromValue(
        GoogleCloudRetailV2alphaPriceInfoResponse.fromMap(
