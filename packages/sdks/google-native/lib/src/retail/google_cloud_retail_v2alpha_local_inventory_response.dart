...
class GoogleCloudRetailV2alphaLocalInventoryResponse {
  ...
  final pulumi.Input<GoogleCloudRetailV2alphaPriceInfoResponse> priceInfo;

  /// Creates a new [GoogleCloudRetailV2alphaLocalInventoryResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'placeId': placeId,
      'priceInfo': pulumi.Input.mapInputValue<GoogleCloudRetailV2alphaPriceInfoResponse, Map<String, dynamic>>(priceInfo, (value) => value.toMap()),
    };
  }

  factory GoogleCloudRetailV2alphaLocalInventoryResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2alphaLocalInventoryResponse(
      attributes: ((map['attributes'] as Map).cast<String, String>()).input(),
      fulfillmentTypes: ((map['fulfillmentTypes'] as List).cast<String>()).input(),
      placeId: (map['placeId'] as String).input(),
      priceInfo: (GoogleCloudRetailV2alphaPriceInfoResponse.fromMap((map['priceInfo'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
