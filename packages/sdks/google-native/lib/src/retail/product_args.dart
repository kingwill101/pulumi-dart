...
class ProductArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'promotions':
          ?pulumi.Input.mapOptionalInputValue<
            List<GoogleCloudRetailV2Promotion>,
            List<Map<String, dynamic>>
          >(
            promotions,
            (value) =>
      ...
      'title': title,
      'ttl': ?ttl,
      'type': ?pulumi.Input.mapOptionalInputValue<ProductType, String>(
        type,
        (value) => value.wireValue,
      ),
      'uri': ?uri,
  ...
  factory ProductArgs.fromMap(Map<String, dynamic> map) {
    return ProductArgs(
      ...
      availability: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ProductAvailability.fromValue(guardedValue as String),
        );
      })(),
      availableQuantity: (() {
      ...
      type: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ProductType.fromValue(guardedValue as String),
        );
      })(),
      uri: (() {
