...
class ProductArgs {
  ...
  factory ProductArgs.fromMap(Map<String, dynamic> map) {
    return ProductArgs(
      ...
      audience: map['audience'] == null ? null : (GoogleCloudRetailV2Audience.fromMap((map['audience'] as Map).cast<String, dynamic>())).input(),
      availability: map['availability'] == null ? null : (ProductAvailability.fromValue(map['availability'] as String)).input(),
      ...
      colorInfo: map['colorInfo'] == null ? null : (GoogleCloudRetailV2ColorInfo.fromMap((map['colorInfo'] as Map).cast<String, dynamic>())).input(),
      conditions: map['conditions'] == null ? null : ((map['conditions'] as List).cast<String>()).input(),
      description: map['description'] == null ? null : (map['description'] as String).input(),
      expireTime: map['expireTime'] == null ? null : (map['expireTime'] as String).input(),
      fulfillmentInfo: map['fulfillmentInfo'] == null ? null : (pulumi.Input.decodeList<GoogleCloudRetailV2FulfillmentInfo>(map['fulfillmentInfo'], (value) => GoogleCloudRetailV2FulfillmentInfo.fromMap((value as Map).cast<String, dynamic>()))).input(),
      gtin: map['gtin'] == null ? null : (map['gtin'] as String).input(),
      id: map['id'] == null ? null : (map['id'] as String).input(),
      images: map['images'] == null ? null : (pulumi.Input.decodeList<GoogleCloudRetailV2Image>(map['images'], (value) => GoogleCloudRetailV2Image.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      priceInfo: map['priceInfo'] == null ? null : (GoogleCloudRetailV2PriceInfo.fromMap((map['priceInfo'] as Map).cast<String, dynamic>())).input(),
      primaryProductId: map['primaryProductId'] == null ? null : (map['primaryProductId'] as String).input(),
      productId: (map['productId'] as String).input(),
      project: map['project'] == null ? null : (map['project'] as String).input(),
      promotions: map['promotions'] == null ? null : (pulumi.Input.decodeList<GoogleCloudRetailV2Promotion>(map['promotions'], (value) => GoogleCloudRetailV2Promotion.fromMap((value as Map).cast<String, dynamic>()))).input(),
      publishTime: map['publishTime'] == null ? null : (map['publishTime'] as String).input(),
      rating: map['rating'] == null ? null : (GoogleCloudRetailV2Rating.fromMap((map['rating'] as Map).cast<String, dynamic>())).input(),
      ...
      type: map['type'] == null ? null : (ProductType.fromValue(map['type'] as String)).input(),
