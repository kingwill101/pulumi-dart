...
class ProductArgs {
  ...
  ProductArgs({
    ...
    pulumi.Output<GoogleCloudRetailV2Audience>? audience,
    pulumi.Output<ProductAvailability>? availability,
    ...
    pulumi.Output<GoogleCloudRetailV2ColorInfo>? colorInfo,
    pulumi.Output<List<String>>? conditions,
    pulumi.Output<String>? description,
    pulumi.Output<String>? expireTime,
    pulumi.Output<List<GoogleCloudRetailV2FulfillmentInfo>>? fulfillmentInfo,
    pulumi.Output<String>? gtin,
    pulumi.Output<String>? id,
    pulumi.Output<List<GoogleCloudRetailV2Image>>? images,
    pulumi.Output<String>? languageCode,
    pulumi.Output<String>? location,
    pulumi.Output<List<String>>? materials,
    pulumi.Output<String>? name,
    pulumi.Output<List<String>>? patterns,
    pulumi.Output<GoogleCloudRetailV2PriceInfo>? priceInfo,
    pulumi.Output<String>? primaryProductId,
    required pulumi.Output<String> productId,
    pulumi.Output<String>? project,
    pulumi.Output<List<GoogleCloudRetailV2Promotion>>? promotions,
    pulumi.Output<String>? publishTime,
    pulumi.Output<GoogleCloudRetailV2Rating>? rating,
    ...
    pulumi.Output<ProductType>? type,
  ...
  factory ProductArgs.fromMap(Map<String, dynamic> map) {
    return ProductArgs(
      ...
      audience: map['audience'] == null ? null : pulumi.Output.create<GoogleCloudRetailV2Audience>(GoogleCloudRetailV2Audience.fromMap((map['audience'] as Map).cast<String, dynamic>())),
      availability: map['availability'] == null ? null : pulumi.Output.create<ProductAvailability>(ProductAvailability.fromValue(map['availability'] as String)),
      ...
      colorInfo: map['colorInfo'] == null ? null : pulumi.Output.create<GoogleCloudRetailV2ColorInfo>(GoogleCloudRetailV2ColorInfo.fromMap((map['colorInfo'] as Map).cast<String, dynamic>())),
      ...
      fulfillmentInfo: map['fulfillmentInfo'] == null ? null : pulumi.Output.create<List<GoogleCloudRetailV2FulfillmentInfo>>(pulumi.Input.decodeList<GoogleCloudRetailV2FulfillmentInfo>(map['fulfillmentInfo'], (value) => GoogleCloudRetailV2FulfillmentInfo.fromMap((value as Map).cast<String, dynamic>()))),
      gtin: map['gtin'] == null ? null : pulumi.Output.create<String>(map['gtin'] as String),
      id: map['id'] == null ? null : pulumi.Output.create<String>(map['id'] as String),
      images: map['images'] == null ? null : pulumi.Output.create<List<GoogleCloudRetailV2Image>>(pulumi.Input.decodeList<GoogleCloudRetailV2Image>(map['images'], (value) => GoogleCloudRetailV2Image.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      priceInfo: map['priceInfo'] == null ? null : pulumi.Output.create<GoogleCloudRetailV2PriceInfo>(GoogleCloudRetailV2PriceInfo.fromMap((map['priceInfo'] as Map).cast<String, dynamic>())),
      ...
      promotions: map['promotions'] == null ? null : pulumi.Output.create<List<GoogleCloudRetailV2Promotion>>(pulumi.Input.decodeList<GoogleCloudRetailV2Promotion>(map['promotions'], (value) => GoogleCloudRetailV2Promotion.fromMap((value as Map).cast<String, dynamic>()))),
      publishTime: map['publishTime'] == null ? null : pulumi.Output.create<String>(map['publishTime'] as String),
      rating: map['rating'] == null ? null : pulumi.Output.create<GoogleCloudRetailV2Rating>(GoogleCloudRetailV2Rating.fromMap((map['rating'] as Map).cast<String, dynamic>())),
      ...
      type: map['type'] == null ? null : pulumi.Output.create<ProductType>(ProductType.fromValue(map['type'] as String)),
