...
class GoogleCloudRetailV2RuleBoostAction {
  ...
  final pulumi.Input<String>? productsFilter;

  /// Creates a new [GoogleCloudRetailV2RuleBoostAction].
  ...
  const GoogleCloudRetailV2RuleBoostAction({
    this.boost,
    this.productsFilter,
  });
  ...
  factory GoogleCloudRetailV2RuleBoostAction.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2RuleBoostAction(
      ...
      productsFilter: (() { final guardedValue = map['productsFilter']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
