...
class GoogleCloudRetailV2alphaRuleForceReturnFacetActionFacetPositionAdjustment {
  ...
  /// Creates a new [GoogleCloudRetailV2alphaRuleForceReturnFacetActionFacetPositionAdjustment].
  ...
  const GoogleCloudRetailV2alphaRuleForceReturnFacetActionFacetPositionAdjustment({
    this.attributeName,
    this.position,
  });
