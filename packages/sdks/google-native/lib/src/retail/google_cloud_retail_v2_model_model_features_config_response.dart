...
class GoogleCloudRetailV2ModelModelFeaturesConfigResponse {
  ...
  const GoogleCloudRetailV2ModelModelFeaturesConfigResponse({
  ...
  factory GoogleCloudRetailV2ModelModelFeaturesConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2ModelModelFeaturesConfigResponse(
      frequentlyBoughtTogetherConfig: pulumi.Input.fromValue(GoogleCloudRetailV2ModelFrequentlyBoughtTogetherFeaturesConfigResponse.fromMap((map['frequentlyBoughtTogetherConfig']! as Map).cast<String, dynamic>())),
    );
  }
}
