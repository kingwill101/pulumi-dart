...
class ControlRetailV2betaArgs {
    ...
    return <String, dynamic>{
      ...
      'solutionTypes':
          pulumi.Input.mapInputValue<
            List<ControlSolutionTypesItemRetailV2beta>,
            List<String>
          >(
            solutionTypes,
            (value) =>
  ...
  factory ControlRetailV2betaArgs.fromMap(Map<String, dynamic> map) {
    return ControlRetailV2betaArgs(
      ...
      facetSpec: (() {
        final guardedValue = map['facetSpec'];
      ...
      searchSolutionUseCase: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ControlSearchSolutionUseCaseItemRetailV2beta>(
            guardedValue,
      ...
      solutionTypes: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ControlSolutionTypesItemRetailV2beta>(
          map['solutionTypes']!,
          (value) =>
