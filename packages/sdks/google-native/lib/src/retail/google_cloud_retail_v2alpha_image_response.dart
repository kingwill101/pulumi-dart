...
class GoogleCloudRetailV2alphaImageResponse {
  ...
  /// Creates a new [GoogleCloudRetailV2alphaImageResponse].
  ...
  const GoogleCloudRetailV2alphaImageResponse({
  ...
  factory GoogleCloudRetailV2alphaImageResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2alphaImageResponse(
