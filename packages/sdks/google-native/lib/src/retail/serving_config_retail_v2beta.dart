...
import 'serving_config_retail_v2beta_args.dart';

/// Creates a ServingConfig. A maximum of 100 ServingConfigs are allowed in a Catalog, otherwise a FAILED_PRECONDITION error is returned.
/// Auto-naming is currently not supported for this resource.
class ServingConfigRetailV2beta extends pulumi.CustomResource {
  ...
  late final pulumi.Output<GoogleCloudRetailV2betaSearchRequestDynamicFacetSpecResponse> dynamicFacetSpec;
  ...
  late final pulumi.Output<GoogleCloudRetailV2betaSearchRequestPersonalizationSpecResponse> personalizationSpec;
  ...
  /// Creates a new [ServingConfigRetailV2beta].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ServingConfigRetailV2beta]. {@macro pulumi_retail_v2beta_serving_config_retail_v2beta_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  ServingConfigRetailV2beta(
    String name, {
    ServingConfigRetailV2betaArgs? args,
    ...
    dynamicFacetSpec = registerOutput<GoogleCloudRetailV2betaSearchRequestDynamicFacetSpecResponse>('dynamicFacetSpec', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return GoogleCloudRetailV2betaSearchRequestDynamicFacetSpecResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    personalizationSpec = registerOutput<GoogleCloudRetailV2betaSearchRequestPersonalizationSpecResponse>('personalizationSpec', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return GoogleCloudRetailV2betaSearchRequestPersonalizationSpecResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
