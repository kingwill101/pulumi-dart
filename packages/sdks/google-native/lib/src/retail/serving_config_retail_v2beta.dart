...
class ServingConfigRetailV2beta extends pulumi.CustomResource {
  ...
  ServingConfigRetailV2beta(
    ...
    this.doNotAssociateControlIds = registerOutput<List<String>>('doNotAssociateControlIds');
    this.dynamicFacetSpec = registerOutput<GoogleCloudRetailV2betaSearchRequestDynamicFacetSpecResponse>('dynamicFacetSpec');
    this.enableCategoryFilterLevel = registerOutput<String>('enableCategoryFilterLevel');
    ...
    this.onewaySynonymsControlIds = registerOutput<List<String>>('onewaySynonymsControlIds');
    this.personalizationSpec = registerOutput<GoogleCloudRetailV2betaSearchRequestPersonalizationSpecResponse>('personalizationSpec');
    ...
    this.replacementControlIds = registerOutput<List<String>>('replacementControlIds');
    this.servingConfigId = registerOutput<String>('servingConfigId');
    this.solutionTypes = registerOutput<List<String>>('solutionTypes');
    this.twowaySynonymsControlIds = registerOutput<List<String>>('twowaySynonymsControlIds');
  }
}
