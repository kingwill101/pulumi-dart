...
class GoogleCloudRetailV2AudienceResponse {
  ...
  factory GoogleCloudRetailV2AudienceResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2AudienceResponse(
      ageGroups: ((map['ageGroups'] as List).cast<String>()).input(),
      genders: ((map['genders'] as List).cast<String>()).input(),
    );
  }
}
