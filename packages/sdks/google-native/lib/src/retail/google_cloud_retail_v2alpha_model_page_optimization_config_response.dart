...
class GoogleCloudRetailV2alphaModelPageOptimizationConfigResponse {
  ...
  factory GoogleCloudRetailV2alphaModelPageOptimizationConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2alphaModelPageOptimizationConfigResponse(
      ...
      panels: (pulumi.Input.decodeList<GoogleCloudRetailV2alphaModelPageOptimizationConfigPanelResponse>(map['panels'], (value) => GoogleCloudRetailV2alphaModelPageOptimizationConfigPanelResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      restriction: (map['restriction'] as String).input(),
    );
  }
}
