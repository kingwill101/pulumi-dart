...
class GoogleCloudRetailV2alphaRatingResponse {
  ...
  /// Creates a new [GoogleCloudRetailV2alphaRatingResponse].
  ...
  const GoogleCloudRetailV2alphaRatingResponse({
  ...
  factory GoogleCloudRetailV2alphaRatingResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2alphaRatingResponse(
