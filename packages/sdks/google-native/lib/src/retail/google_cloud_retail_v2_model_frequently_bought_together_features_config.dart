...
class GoogleCloudRetailV2ModelFrequentlyBoughtTogetherFeaturesConfig {
  ...
  final GoogleCloudRetailV2ModelFrequentlyBoughtTogetherFeaturesConfigContextProductsType? contextProductsType;
  ...
  factory GoogleCloudRetailV2ModelFrequentlyBoughtTogetherFeaturesConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2ModelFrequentlyBoughtTogetherFeaturesConfig(
      contextProductsType: map['contextProductsType'] == null ? null : GoogleCloudRetailV2ModelFrequentlyBoughtTogetherFeaturesConfigContextProductsType.fromValue(map['contextProductsType'] as String),
    );
  }
}
