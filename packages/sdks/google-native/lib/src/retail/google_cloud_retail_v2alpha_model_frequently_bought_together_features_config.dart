...
class GoogleCloudRetailV2alphaModelFrequentlyBoughtTogetherFeaturesConfig {
  ...
  const GoogleCloudRetailV2alphaModelFrequentlyBoughtTogetherFeaturesConfig({
    this.contextProductsType,
  });

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'contextProductsType': ?pulumi.Input.mapOptionalInputValue<GoogleCloudRetailV2alphaModelFrequentlyBoughtTogetherFeaturesConfigContextProductsType, String>(contextProductsType, (value) => value.wireValue),
    };
  }
  ...
  factory GoogleCloudRetailV2alphaModelFrequentlyBoughtTogetherFeaturesConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2alphaModelFrequentlyBoughtTogetherFeaturesConfig(
      contextProductsType: (() { final guardedValue = map['contextProductsType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudRetailV2alphaModelFrequentlyBoughtTogetherFeaturesConfigContextProductsType.fromValue(guardedValue as String)); })(),
    );
  }
}
