...
class GoogleCloudRetailV2alphaModelFrequentlyBoughtTogetherFeaturesConfig {
  ...
  final GoogleCloudRetailV2alphaModelFrequentlyBoughtTogetherFeaturesConfigContextProductsType? contextProductsType;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'contextProductsType': ?contextProductsType == null ? null : contextProductsType!.value,
    };
  }
  ...
  factory GoogleCloudRetailV2alphaModelFrequentlyBoughtTogetherFeaturesConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2alphaModelFrequentlyBoughtTogetherFeaturesConfig(
      contextProductsType: map['contextProductsType'] == null ? null : GoogleCloudRetailV2alphaModelFrequentlyBoughtTogetherFeaturesConfigContextProductsType.fromValue(map['contextProductsType'] as String),
    );
  }
}
