...
class ModelRetailV2alpha extends pulumi.CustomResource {
  ...
  late final pulumi.Output<GoogleCloudRetailV2alphaModelModelFeaturesConfigResponse> modelFeaturesConfig;
  ...
  late final pulumi.Output<GoogleCloudRetailV2alphaModelPageOptimizationConfigResponse> pageOptimizationConfig;
  ...
  ModelRetailV2alpha(
    ...
    modelFeaturesConfig = registerOutput<GoogleCloudRetailV2alphaModelModelFeaturesConfigResponse>('modelFeaturesConfig', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return GoogleCloudRetailV2alphaModelModelFeaturesConfigResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    this.name = registerOutput<String>('name');
    optimizationObjective = registerOutput<String>('optimizationObjective');
    pageOptimizationConfig = registerOutput<GoogleCloudRetailV2alphaModelPageOptimizationConfigResponse>('pageOptimizationConfig', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return GoogleCloudRetailV2alphaModelPageOptimizationConfigResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
