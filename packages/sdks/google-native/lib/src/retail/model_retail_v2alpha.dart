...
class ModelRetailV2alpha extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<GoogleCloudRetailV2alphaModelServingConfigListResponse>> servingConfigLists;
  ...
  ModelRetailV2alpha(
    ...
    this.modelFeaturesConfig = registerOutput<GoogleCloudRetailV2alphaModelModelFeaturesConfigResponse>('modelFeaturesConfig');
    this.name = registerOutput<String>('name');
    this.optimizationObjective = registerOutput<String>('optimizationObjective');
    this.pageOptimizationConfig = registerOutput<GoogleCloudRetailV2alphaModelPageOptimizationConfigResponse>('pageOptimizationConfig');
    this.periodicTuningState = registerOutput<String>('periodicTuningState');
    this.project = registerOutput<String>('project');
    this.servingConfigLists = registerOutput<List<GoogleCloudRetailV2alphaModelServingConfigListResponse>>('servingConfigLists');
