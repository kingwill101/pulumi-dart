...
class ProductRetailV2alphaArgs {
  ...
  factory ProductRetailV2alphaArgs.fromMap(Map<String, dynamic> map) {
    return ProductRetailV2alphaArgs(
      ...
      audience: map['audience'] == null ? null : (GoogleCloudRetailV2alphaAudience.fromMap((map['audience'] as Map).cast<String, dynamic>())).input(),
      availability: map['availability'] == null ? null : (ProductAvailabilityRetailV2alpha.fromValue(map['availability'] as String)).input(),
      ...
      colorInfo: map['colorInfo'] == null ? null : (GoogleCloudRetailV2alphaColorInfo.fromMap((map['colorInfo'] as Map).cast<String, dynamic>())).input(),
      conditions: map['conditions'] == null ? null : ((map['conditions'] as List).cast<String>()).input(),
      description: map['description'] == null ? null : (map['description'] as String).input(),
      expireTime: map['expireTime'] == null ? null : (map['expireTime'] as String).input(),
      fulfillmentInfo: map['fulfillmentInfo'] == null ? null : (pulumi.Input.decodeList<GoogleCloudRetailV2alphaFulfillmentInfo>(map['fulfillmentInfo'], (value) => GoogleCloudRetailV2alphaFulfillmentInfo.fromMap((value as Map).cast<String, dynamic>()))).input(),
      gtin: map['gtin'] == null ? null : (map['gtin'] as String).input(),
      id: map['id'] == null ? null : (map['id'] as String).input(),
      images: map['images'] == null ? null : (pulumi.Input.decodeList<GoogleCloudRetailV2alphaImage>(map['images'], (value) => GoogleCloudRetailV2alphaImage.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      priceInfo: map['priceInfo'] == null ? null : (GoogleCloudRetailV2alphaPriceInfo.fromMap((map['priceInfo'] as Map).cast<String, dynamic>())).input(),
      primaryProductId: map['primaryProductId'] == null ? null : (map['primaryProductId'] as String).input(),
      productId: (map['productId'] as String).input(),
      project: map['project'] == null ? null : (map['project'] as String).input(),
      promotions: map['promotions'] == null ? null : (pulumi.Input.decodeList<GoogleCloudRetailV2alphaPromotion>(map['promotions'], (value) => GoogleCloudRetailV2alphaPromotion.fromMap((value as Map).cast<String, dynamic>()))).input(),
      publishTime: map['publishTime'] == null ? null : (map['publishTime'] as String).input(),
      rating: map['rating'] == null ? null : (GoogleCloudRetailV2alphaRating.fromMap((map['rating'] as Map).cast<String, dynamic>())).input(),
      ...
      type: map['type'] == null ? null : (ProductTypeRetailV2alpha.fromValue(map['type'] as String)).input(),
