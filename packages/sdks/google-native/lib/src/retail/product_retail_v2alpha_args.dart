...
import 'google_cloud_retail_v2alpha_audience.dart';
import 'google_cloud_retail_v2alpha_color_info.dart';
import 'google_cloud_retail_v2alpha_fulfillment_info.dart';
import 'google_cloud_retail_v2alpha_image.dart';
import 'google_cloud_retail_v2alpha_price_info.dart';
import 'google_cloud_retail_v2alpha_promotion.dart';
import 'google_cloud_retail_v2alpha_rating.dart';
import 'product_availability_retail_v2alpha.dart';
import 'product_type_retail_v2alpha.dart';

/// {@template pulumi_retail_v2alpha_product_retail_v2alpha_args_doc}
/// The set of arguments for Product.
/// {@endtemplate}
/// {@macro pulumi_retail_v2alpha_product_retail_v2alpha_args_doc}
class ProductRetailV2alphaArgs {
  ...
  final pulumi.Input<GoogleCloudRetailV2alphaAudience>? audience;
  /// The online availability of the Product. Default to Availability.IN_STOCK. Corresponding properties: Google Merchant Center property [availability](https://support.google.com/merchants/answer/6324448). Schema.org property [Offer.availability](https://schema.org/availability).
  final pulumi.Input<ProductAvailabilityRetailV2alpha>? availability;
  ...
  final pulumi.Input<GoogleCloudRetailV2alphaColorInfo>? colorInfo;
  ...
  final pulumi.Input<List<GoogleCloudRetailV2alphaFulfillmentInfo>>? fulfillmentInfo;
  ...
  final pulumi.Input<List<GoogleCloudRetailV2alphaImage>>? images;
  ...
  final pulumi.Input<GoogleCloudRetailV2alphaPriceInfo>? priceInfo;
  ...
  final pulumi.Input<List<GoogleCloudRetailV2alphaPromotion>>? promotions;
  /// The timestamp when the product is published by the retailer for the first time, which indicates the freshness of the products. Note that this field is different from available_time, given it purely describes product freshness regardless of when it is available on search and recommendation.
  final pulumi.Input<String>? publishTime;
  /// The rating of this product.
  final pulumi.Input<GoogleCloudRetailV2alphaRating>? rating;
  ...
  final pulumi.Input<ProductTypeRetailV2alpha>? type;
  /// Canonical URL directly linking to the product detail page. It is strongly recommended to provide a valid uri for the product, otherwise the service performance could be significantly degraded. This field must be a UTF-8 encoded string with a length limit of 5,000 characters. Otherwise, an INVALID_ARGUMENT error is returned. Corresponding properties: Google Merchant Center property [link](https://support.google.com/merchants/answer/6324416). Schema.org property [Offer.url](https://schema.org/url).
  final pulumi.Input<String>? uri;

  /// Creates a new [ProductRetailV2alphaArgs].
  ...
  ProductRetailV2alphaArgs({
    pulumi.Output<Map<String, String>>? attributes,
    pulumi.Output<GoogleCloudRetailV2alphaAudience>? audience,
    pulumi.Output<ProductAvailabilityRetailV2alpha>? availability,
    ...
    pulumi.Output<GoogleCloudRetailV2alphaColorInfo>? colorInfo,
    pulumi.Output<List<String>>? conditions,
    pulumi.Output<String>? description,
    pulumi.Output<String>? expireTime,
    pulumi.Output<List<GoogleCloudRetailV2alphaFulfillmentInfo>>? fulfillmentInfo,
    pulumi.Output<String>? gtin,
    pulumi.Output<String>? id,
    pulumi.Output<List<GoogleCloudRetailV2alphaImage>>? images,
    pulumi.Output<String>? languageCode,
    pulumi.Output<String>? location,
    pulumi.Output<List<String>>? materials,
    pulumi.Output<String>? name,
    pulumi.Output<List<String>>? patterns,
    pulumi.Output<GoogleCloudRetailV2alphaPriceInfo>? priceInfo,
    pulumi.Output<String>? primaryProductId,
    required pulumi.Output<String> productId,
    pulumi.Output<String>? project,
    pulumi.Output<List<GoogleCloudRetailV2alphaPromotion>>? promotions,
    pulumi.Output<String>? publishTime,
    pulumi.Output<GoogleCloudRetailV2alphaRating>? rating,
    ...
    pulumi.Output<ProductTypeRetailV2alpha>? type,
    pulumi.Output<String>? uri,
  }) :
      attributes = pulumi.Input.asOptionalInput<Map<String, String>>(attributes),
      audience = pulumi.Input.asOptionalInput<GoogleCloudRetailV2alphaAudience>(audience),
      availability = pulumi.Input.asOptionalInput<ProductAvailabilityRetailV2alpha>(availability),
      ...
      colorInfo = pulumi.Input.asOptionalInput<GoogleCloudRetailV2alphaColorInfo>(colorInfo),
      ...
      fulfillmentInfo = pulumi.Input.asOptionalInput<List<GoogleCloudRetailV2alphaFulfillmentInfo>>(fulfillmentInfo),
      gtin = pulumi.Input.asOptionalInput<String>(gtin),
      id = pulumi.Input.asOptionalInput<String>(id),
      images = pulumi.Input.asOptionalInput<List<GoogleCloudRetailV2alphaImage>>(images),
      ...
      priceInfo = pulumi.Input.asOptionalInput<GoogleCloudRetailV2alphaPriceInfo>(priceInfo),
      primaryProductId = pulumi.Input.asOptionalInput<String>(primaryProductId),
      productId = pulumi.Input.asInput<String>(productId),
      project = pulumi.Input.asOptionalInput<String>(project),
      promotions = pulumi.Input.asOptionalInput<List<GoogleCloudRetailV2alphaPromotion>>(promotions),
      publishTime = pulumi.Input.asOptionalInput<String>(publishTime),
      rating = pulumi.Input.asOptionalInput<GoogleCloudRetailV2alphaRating>(rating),
      ...
      type = pulumi.Input.asOptionalInput<ProductTypeRetailV2alpha>(type),
      uri = pulumi.Input.asOptionalInput<String>(uri);

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'attributes': ?attributes,
      'audience': ?pulumi.Input.mapOptionalInputValue<GoogleCloudRetailV2alphaAudience, Map<String, dynamic>>(audience, (value) => value.toMap()),
      'availability': ?pulumi.Input.mapOptionalInputValue<ProductAvailabilityRetailV2alpha, String>(availability, (value) => value.value),
      ...
      'colorInfo': ?pulumi.Input.mapOptionalInputValue<GoogleCloudRetailV2alphaColorInfo, Map<String, dynamic>>(colorInfo, (value) => value.toMap()),
      'conditions': ?conditions,
      'description': ?description,
      'expireTime': ?expireTime,
      'fulfillmentInfo': ?pulumi.Input.mapOptionalInputValue<List<GoogleCloudRetailV2alphaFulfillmentInfo>, List<Map<String, dynamic>>>(fulfillmentInfo, (value) => pulumi.Input.encodeList<GoogleCloudRetailV2alphaFulfillmentInfo, Map<String, dynamic>>(value, (value) => value.toMap())),
      'gtin': ?gtin,
      'id': ?id,
      'images': ?pulumi.Input.mapOptionalInputValue<List<GoogleCloudRetailV2alphaImage>, List<Map<String, dynamic>>>(images, (value) => pulumi.Input.encodeList<GoogleCloudRetailV2alphaImage, Map<String, dynamic>>(value, (value) => value.toMap())),
      'languageCode': ?languageCode,
      'location': ?location,
      'materials': ?materials,
      'name': ?name,
      'patterns': ?patterns,
      'priceInfo': ?pulumi.Input.mapOptionalInputValue<GoogleCloudRetailV2alphaPriceInfo, Map<String, dynamic>>(priceInfo, (value) => value.toMap()),
      'primaryProductId': ?primaryProductId,
      'productId': productId,
      'project': ?project,
      'promotions': ?pulumi.Input.mapOptionalInputValue<List<GoogleCloudRetailV2alphaPromotion>, List<Map<String, dynamic>>>(promotions, (value) => pulumi.Input.encodeList<GoogleCloudRetailV2alphaPromotion, Map<String, dynamic>>(value, (value) => value.toMap())),
      'publishTime': ?publishTime,
      'rating': ?pulumi.Input.mapOptionalInputValue<GoogleCloudRetailV2alphaRating, Map<String, dynamic>>(rating, (value) => value.toMap()),
      'retrievableFields': ?retrievableFields,
      'sizes': ?sizes,
      'tags': ?tags,
      'title': title,
      'ttl': ?ttl,
      'type': ?pulumi.Input.mapOptionalInputValue<ProductTypeRetailV2alpha, String>(type, (value) => value.value),
      'uri': ?uri,
    };
  }

  factory ProductRetailV2alphaArgs.fromMap(Map<String, dynamic> map) {
    return ProductRetailV2alphaArgs(
      attributes: map['attributes'] == null ? null : pulumi.Output.create<Map<String, String>>((map['attributes'] as Map).cast<String, String>()),
      audience: map['audience'] == null ? null : pulumi.Output.create<GoogleCloudRetailV2alphaAudience>(GoogleCloudRetailV2alphaAudience.fromMap((map['audience'] as Map).cast<String, dynamic>())),
      availability: map['availability'] == null ? null : pulumi.Output.create<ProductAvailabilityRetailV2alpha>(ProductAvailabilityRetailV2alpha.fromValue(map['availability'] as String)),
      ...
      colorInfo: map['colorInfo'] == null ? null : pulumi.Output.create<GoogleCloudRetailV2alphaColorInfo>(GoogleCloudRetailV2alphaColorInfo.fromMap((map['colorInfo'] as Map).cast<String, dynamic>())),
      ...
      fulfillmentInfo: map['fulfillmentInfo'] == null ? null : pulumi.Output.create<List<GoogleCloudRetailV2alphaFulfillmentInfo>>(pulumi.Input.decodeList<GoogleCloudRetailV2alphaFulfillmentInfo>(map['fulfillmentInfo'], (value) => GoogleCloudRetailV2alphaFulfillmentInfo.fromMap((value as Map).cast<String, dynamic>()))),
      gtin: map['gtin'] == null ? null : pulumi.Output.create<String>(map['gtin'] as String),
      id: map['id'] == null ? null : pulumi.Output.create<String>(map['id'] as String),
      images: map['images'] == null ? null : pulumi.Output.create<List<GoogleCloudRetailV2alphaImage>>(pulumi.Input.decodeList<GoogleCloudRetailV2alphaImage>(map['images'], (value) => GoogleCloudRetailV2alphaImage.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      priceInfo: map['priceInfo'] == null ? null : pulumi.Output.create<GoogleCloudRetailV2alphaPriceInfo>(GoogleCloudRetailV2alphaPriceInfo.fromMap((map['priceInfo'] as Map).cast<String, dynamic>())),
      ...
      promotions: map['promotions'] == null ? null : pulumi.Output.create<List<GoogleCloudRetailV2alphaPromotion>>(pulumi.Input.decodeList<GoogleCloudRetailV2alphaPromotion>(map['promotions'], (value) => GoogleCloudRetailV2alphaPromotion.fromMap((value as Map).cast<String, dynamic>()))),
      publishTime: map['publishTime'] == null ? null : pulumi.Output.create<String>(map['publishTime'] as String),
      rating: map['rating'] == null ? null : pulumi.Output.create<GoogleCloudRetailV2alphaRating>(GoogleCloudRetailV2alphaRating.fromMap((map['rating'] as Map).cast<String, dynamic>())),
      ...
      type: map['type'] == null ? null : pulumi.Output.create<ProductTypeRetailV2alpha>(ProductTypeRetailV2alpha.fromValue(map['type'] as String)),
