...
class ProductRetailV2alphaArgs {
  ...
  const ProductRetailV2alphaArgs({
    this.attributes,
    this.audience,
    this.availability,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'availability': ?pulumi.Input.mapOptionalInputValue<ProductAvailabilityRetailV2alpha, String>(availability, (value) => value.wireValue),
      ...
      'title': title,
      'ttl': ?ttl,
      'type': ?pulumi.Input.mapOptionalInputValue<ProductTypeRetailV2alpha, String>(type, (value) => value.wireValue),
      'uri': ?uri,
    };
  }
  ...
  factory ProductRetailV2alphaArgs.fromMap(Map<String, dynamic> map) {
    return ProductRetailV2alphaArgs(
      ...
      audience: (() { final guardedValue = map['audience']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudRetailV2alphaAudience.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      availability: (() { final guardedValue = map['availability']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ProductAvailabilityRetailV2alpha.fromValue(guardedValue as String)); })(),
      ...
      colorInfo: (() { final guardedValue = map['colorInfo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudRetailV2alphaColorInfo.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      fulfillmentInfo: (() { final guardedValue = map['fulfillmentInfo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudRetailV2alphaFulfillmentInfo>(guardedValue, (value) => GoogleCloudRetailV2alphaFulfillmentInfo.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      images: (() { final guardedValue = map['images']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudRetailV2alphaImage>(guardedValue, (value) => GoogleCloudRetailV2alphaImage.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      priceInfo: (() { final guardedValue = map['priceInfo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudRetailV2alphaPriceInfo.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      promotions: (() { final guardedValue = map['promotions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudRetailV2alphaPromotion>(guardedValue, (value) => GoogleCloudRetailV2alphaPromotion.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      rating: (() { final guardedValue = map['rating']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudRetailV2alphaRating.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ProductTypeRetailV2alpha.fromValue(guardedValue as String)); })(),
