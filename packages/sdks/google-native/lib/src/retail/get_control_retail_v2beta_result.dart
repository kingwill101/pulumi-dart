...
class GetControlRetailV2betaResult {
  ...
  final GoogleCloudRetailV2betaSearchRequestFacetSpecResponse facetSpec;

  /// Immutable. Fully qualified name `projects/*/locations/global/catalogs/*/controls/*`
  final String name;

  /// A rule control - a condition-action pair. Enacts a set action when the condition is triggered. For example: Boost "gShoe" when query full matches "Running Shoes".
  final GoogleCloudRetailV2betaRuleResponse rule;
  ...
  /// Creates a new [GetControlRetailV2betaResult].
  ...
  factory GetControlRetailV2betaResult.fromMap(Map<String, dynamic> map) {
    return GetControlRetailV2betaResult(
      associatedServingConfigIds: (map['associatedServingConfigIds'] as List)
          .cast<String>(),
      displayName: map['displayName'] as String,
      facetSpec: GoogleCloudRetailV2betaSearchRequestFacetSpecResponse.fromMap(
        (map['facetSpec']! as Map).cast<String, dynamic>(),
      ),
      name: map['name'] as String,
      rule: GoogleCloudRetailV2betaRuleResponse.fromMap(
        (map['rule']! as Map).cast<String, dynamic>(),
      ),
      searchSolutionUseCase: (map['searchSolutionUseCase'] as List)
          .cast<String>(),
