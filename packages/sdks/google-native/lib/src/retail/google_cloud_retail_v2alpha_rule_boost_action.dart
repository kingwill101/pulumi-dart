...
class GoogleCloudRetailV2alphaRuleBoostAction {
  ...
  /// Creates a new [GoogleCloudRetailV2alphaRuleBoostAction].
  ...
  GoogleCloudRetailV2alphaRuleBoostAction({this.boost, this.productsFilter});
  ...
  factory GoogleCloudRetailV2alphaRuleBoostAction.fromMap(
