...
class ProductRetailV2betaArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'images':
          ?pulumi.Input.mapOptionalInputValue<
            List<GoogleCloudRetailV2betaImage>,
            List<Map<String, dynamic>>
          >(
            images,
            (value) =>
  ...
  factory ProductRetailV2betaArgs.fromMap(Map<String, dynamic> map) {
    return ProductRetailV2betaArgs(
      ...
      availability: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ProductAvailabilityRetailV2beta.fromValue(guardedValue as String),
        );
      })(),
      availableQuantity: (() {
      ...
      type: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ProductTypeRetailV2beta.fromValue(guardedValue as String),
        );
      })(),
      uri: (() {
