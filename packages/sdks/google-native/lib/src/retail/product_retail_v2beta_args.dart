...
class ProductRetailV2betaArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'availability': ?pulumi.Input.mapOptionalInputValue<ProductAvailabilityRetailV2beta, String>(availability, (value) => value.wireValue),
      ...
      'title': title,
      'ttl': ?ttl,
      'type': ?pulumi.Input.mapOptionalInputValue<ProductTypeRetailV2beta, String>(type, (value) => value.wireValue),
      'uri': ?uri,
    };
  }
  ...
  factory ProductRetailV2betaArgs.fromMap(Map<String, dynamic> map) {
    return ProductRetailV2betaArgs(
      ...
      audience: (() { final guardedValue = map['audience']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudRetailV2betaAudience.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      availability: (() { final guardedValue = map['availability']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ProductAvailabilityRetailV2beta.fromValue(guardedValue as String)); })(),
      ...
      colorInfo: (() { final guardedValue = map['colorInfo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudRetailV2betaColorInfo.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      fulfillmentInfo: (() { final guardedValue = map['fulfillmentInfo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudRetailV2betaFulfillmentInfo>(guardedValue, (value) => GoogleCloudRetailV2betaFulfillmentInfo.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      images: (() { final guardedValue = map['images']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudRetailV2betaImage>(guardedValue, (value) => GoogleCloudRetailV2betaImage.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      priceInfo: (() { final guardedValue = map['priceInfo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudRetailV2betaPriceInfo.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      promotions: (() { final guardedValue = map['promotions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudRetailV2betaPromotion>(guardedValue, (value) => GoogleCloudRetailV2betaPromotion.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      rating: (() { final guardedValue = map['rating']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudRetailV2betaRating.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ProductTypeRetailV2beta.fromValue(guardedValue as String)); })(),
