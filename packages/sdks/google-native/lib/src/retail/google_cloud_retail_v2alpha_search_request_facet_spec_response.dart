...
class GoogleCloudRetailV2alphaSearchRequestFacetSpecResponse {
  ...
  factory GoogleCloudRetailV2alphaSearchRequestFacetSpecResponse.fromMap(
    ...
    return GoogleCloudRetailV2alphaSearchRequestFacetSpecResponse(
      enableDynamicPosition: pulumi.Input.fromValue(
        map['enableDynamicPosition'] as bool,
      ),
      excludedFilterKeys: pulumi.Input.fromValue(
        (map['excludedFilterKeys'] as List).cast<String>(),
      ),
      facetKey: pulumi.Input.fromValue(
        GoogleCloudRetailV2alphaSearchRequestFacetSpecFacetKeyResponse.fromMap(
