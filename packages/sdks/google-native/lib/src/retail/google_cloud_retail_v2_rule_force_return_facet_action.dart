...
class GoogleCloudRetailV2RuleForceReturnFacetAction {
  ...
  final pulumi.Input<
    List<GoogleCloudRetailV2RuleForceReturnFacetActionFacetPositionAdjustment>
  >?
  ...
  factory GoogleCloudRetailV2RuleForceReturnFacetAction.fromMap(
    ...
    return GoogleCloudRetailV2RuleForceReturnFacetAction(
      facetPositionAdjustments: (() {
        final guardedValue = map['facetPositionAdjustments'];
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                GoogleCloudRetailV2RuleForceReturnFacetActionFacetPositionAdjustment.fromMap(
