...
class GoogleCloudRetailV2ColorInfoResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{'colorFamilies': colorFamilies, 'colors': colors};
  }

  factory GoogleCloudRetailV2ColorInfoResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return GoogleCloudRetailV2ColorInfoResponse(
      colorFamilies: pulumi.Input.fromValue(
