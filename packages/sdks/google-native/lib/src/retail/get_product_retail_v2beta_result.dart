...
class GetProductRetailV2betaResult {
  ...
  /// Creates a new [GetProductRetailV2betaResult].
  ...
  const GetProductRetailV2betaResult({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'fulfillmentInfo': pulumi.Input.encodeList<GoogleCloudRetailV2betaFulfillmentInfoResponse, Map<String, dynamic>>(fulfillmentInfo, (value) => value.toMap()),
      'gtin': gtin,
      'images': pulumi.Input.encodeList<GoogleCloudRetailV2betaImageResponse, Map<String, dynamic>>(images, (value) => value.toMap()),
      'languageCode': languageCode,
      'localInventories': pulumi.Input.encodeList<GoogleCloudRetailV2betaLocalInventoryResponse, Map<String, dynamic>>(localInventories, (value) => value.toMap()),
      'materials': materials,
      'name': name,
      'patterns': patterns,
      'priceInfo': priceInfo.toMap(),
      'primaryProductId': primaryProductId,
      'promotions': pulumi.Input.encodeList<GoogleCloudRetailV2betaPromotionResponse, Map<String, dynamic>>(promotions, (value) => value.toMap()),
      ...
      'type': type,
      'uri': uri,
      'variants': pulumi.Input.encodeList<GoogleCloudRetailV2betaProductResponse, Map<String, dynamic>>(variants, (value) => value.toMap()),
    };
  }
  ...
  factory GetProductRetailV2betaResult.fromMap(Map<String, dynamic> map) {
    return GetProductRetailV2betaResult(
      ...
      audience: GoogleCloudRetailV2betaAudienceResponse.fromMap((map['audience']! as Map).cast<String, dynamic>()),
      ...
      colorInfo: GoogleCloudRetailV2betaColorInfoResponse.fromMap((map['colorInfo']! as Map).cast<String, dynamic>()),
      conditions: (map['conditions'] as List).cast<String>(),
      description: map['description'] as String,
      expireTime: map['expireTime'] as String,
      fulfillmentInfo: pulumi.Input.decodeList<GoogleCloudRetailV2betaFulfillmentInfoResponse>(map['fulfillmentInfo']!, (value) => GoogleCloudRetailV2betaFulfillmentInfoResponse.fromMap((value as Map).cast<String, dynamic>())),
      gtin: map['gtin'] as String,
      images: pulumi.Input.decodeList<GoogleCloudRetailV2betaImageResponse>(map['images']!, (value) => GoogleCloudRetailV2betaImageResponse.fromMap((value as Map).cast<String, dynamic>())),
      languageCode: map['languageCode'] as String,
      localInventories: pulumi.Input.decodeList<GoogleCloudRetailV2betaLocalInventoryResponse>(map['localInventories']!, (value) => GoogleCloudRetailV2betaLocalInventoryResponse.fromMap((value as Map).cast<String, dynamic>())),
      ...
      promotions: pulumi.Input.decodeList<GoogleCloudRetailV2betaPromotionResponse>(map['promotions']!, (value) => GoogleCloudRetailV2betaPromotionResponse.fromMap((value as Map).cast<String, dynamic>())),
      publishTime: map['publishTime'] as String,
      rating: GoogleCloudRetailV2betaRatingResponse.fromMap((map['rating']! as Map).cast<String, dynamic>()),
      ...
      variants: pulumi.Input.decodeList<GoogleCloudRetailV2betaProductResponse>(map['variants']!, (value) => GoogleCloudRetailV2betaProductResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
