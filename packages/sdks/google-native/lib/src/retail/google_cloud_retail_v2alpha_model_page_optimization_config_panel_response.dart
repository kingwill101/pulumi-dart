...
class GoogleCloudRetailV2alphaModelPageOptimizationConfigPanelResponse {
  ...
  final pulumi.Input<
    List<GoogleCloudRetailV2alphaModelPageOptimizationConfigCandidateResponse>
  >
  candidates;
    ...
    return <String, dynamic>{
      ...
      'defaultCandidate':
          pulumi.Input.mapInputValue<
            GoogleCloudRetailV2alphaModelPageOptimizationConfigCandidateResponse,
            Map<String, dynamic>
          >(defaultCandidate, (value) => value.toMap()),
  ...
  factory GoogleCloudRetailV2alphaModelPageOptimizationConfigPanelResponse.fromMap(
    ...
    return GoogleCloudRetailV2alphaModelPageOptimizationConfigPanelResponse(
      candidates: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GoogleCloudRetailV2alphaModelPageOptimizationConfigCandidateResponse
        >(
          map['candidates']!,
          (value) =>
              GoogleCloudRetailV2alphaModelPageOptimizationConfigCandidateResponse.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
      defaultCandidate: pulumi.Input.fromValue(
        GoogleCloudRetailV2alphaModelPageOptimizationConfigCandidateResponse.fromMap(
