...
class GetModelResult {
  ...
  final List<GoogleCloudRetailV2ModelServingConfigListResponse> servingConfigLists;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'servingConfigLists': pulumi.Input.encodeList<GoogleCloudRetailV2ModelServingConfigListResponse, Map<String, dynamic>>(servingConfigLists, (value) => value.toMap()),
  ...
  factory GetModelResult.fromMap(Map<String, dynamic> map) {
    return GetModelResult(
      ...
      modelFeaturesConfig: GoogleCloudRetailV2ModelModelFeaturesConfigResponse.fromMap((map['modelFeaturesConfig']! as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      optimizationObjective: map['optimizationObjective'] as String,
      periodicTuningState: map['periodicTuningState'] as String,
      servingConfigLists: pulumi.Input.decodeList<GoogleCloudRetailV2ModelServingConfigListResponse>(map['servingConfigLists']!, (value) => GoogleCloudRetailV2ModelServingConfigListResponse.fromMap((value as Map).cast<String, dynamic>())),
