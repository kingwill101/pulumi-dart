...
class GoogleCloudRetailV2betaRule {
  ...
  final pulumi.Input<GoogleCloudRetailV2betaRuleDoNotAssociateAction>?
  ...
  final pulumi.Input<GoogleCloudRetailV2betaRuleForceReturnFacetAction>?
  ...
  final pulumi.Input<GoogleCloudRetailV2betaRuleOnewaySynonymsAction>?
  ...
  final pulumi.Input<GoogleCloudRetailV2betaRuleRemoveFacetAction>?
  removeFacetAction;

  /// Replaces specific terms in the query.
  final pulumi.Input<GoogleCloudRetailV2betaRuleReplacementAction>?
  replacementAction;

  /// Treats a set of terms as synonyms of one another.
  final pulumi.Input<GoogleCloudRetailV2betaRuleTwowaySynonymsAction>?
  ...
  factory GoogleCloudRetailV2betaRule.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2betaRule(
      ...
      condition: pulumi.Input.fromValue(
        GoogleCloudRetailV2betaCondition.fromMap(
