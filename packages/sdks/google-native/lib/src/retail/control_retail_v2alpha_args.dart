  ...
  factory ControlRetailV2alphaArgs.fromMap(Map<String, dynamic> map) {
    return ControlRetailV2alphaArgs(
      ...
      searchSolutionUseCase: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<ControlSearchSolutionUseCaseItemRetailV2alpha>(
            guardedValue,
            (value) => ControlSearchSolutionUseCaseItemRetailV2alpha.fromValue(
              value as String,
            ),
          ),
        );
      ...
      solutionTypes: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ControlSolutionTypesItemRetailV2alpha>(
          map['solutionTypes']!,
          (value) =>
              ControlSolutionTypesItemRetailV2alpha.fromValue(value as String),
        ),
      ),
    );
  }
