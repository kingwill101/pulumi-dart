...
class ControlRetailV2alphaArgs {
  ...
  const ControlRetailV2alphaArgs({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'searchSolutionUseCase': ?pulumi.Input.mapOptionalInputValue<List<ControlSearchSolutionUseCaseItemRetailV2alpha>, List<String>>(searchSolutionUseCase, (value) => pulumi.Input.encodeList<ControlSearchSolutionUseCaseItemRetailV2alpha, String>(value, (value) => value.wireValue)),
      'solutionTypes': pulumi.Input.mapInputValue<List<ControlSolutionTypesItemRetailV2alpha>, List<String>>(solutionTypes, (value) => pulumi.Input.encodeList<ControlSolutionTypesItemRetailV2alpha, String>(value, (value) => value.wireValue)),
    };
  }
  ...
  factory ControlRetailV2alphaArgs.fromMap(Map<String, dynamic> map) {
    return ControlRetailV2alphaArgs(
      ...
      facetSpec: (() { final guardedValue = map['facetSpec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudRetailV2alphaSearchRequestFacetSpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      location: (() { final guardedValue = map['location']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      project: (() { final guardedValue = map['project']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      rule: (() { final guardedValue = map['rule']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudRetailV2alphaRule.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      searchSolutionUseCase: (() { final guardedValue = map['searchSolutionUseCase']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ControlSearchSolutionUseCaseItemRetailV2alpha>(guardedValue, (value) => ControlSearchSolutionUseCaseItemRetailV2alpha.fromValue(value as String))); })(),
      solutionTypes: pulumi.Input.fromValue(pulumi.Input.decodeList<ControlSolutionTypesItemRetailV2alpha>(map['solutionTypes']!, (value) => ControlSolutionTypesItemRetailV2alpha.fromValue(value as String))),
    );
  }
}
