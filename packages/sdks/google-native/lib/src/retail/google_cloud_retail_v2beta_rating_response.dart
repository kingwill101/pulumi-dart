...
class GoogleCloudRetailV2betaRatingResponse {
  ...
  /// Creates a new [GoogleCloudRetailV2betaRatingResponse].
  ...
  const GoogleCloudRetailV2betaRatingResponse({
  ...
  factory GoogleCloudRetailV2betaRatingResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2betaRatingResponse(
