...
class GoogleCloudRetailV2PriceInfoResponse {
  ...
  const GoogleCloudRetailV2PriceInfoResponse({
    required this.cost,
  ...
  factory GoogleCloudRetailV2PriceInfoResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2PriceInfoResponse(
      ...
      priceEffectiveTime: pulumi.Input.fromValue(map['priceEffectiveTime'] as String),
      priceExpireTime: pulumi.Input.fromValue(map['priceExpireTime'] as String),
      priceRange: pulumi.Input.fromValue(GoogleCloudRetailV2PriceInfoPriceRangeResponse.fromMap((map['priceRange']! as Map).cast<String, dynamic>())),
    );
  }
}
