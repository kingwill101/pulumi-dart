...
import 'google_cloud_retail_v2_price_info_price_range_response.dart';

/// The price information of a Product.
class GoogleCloudRetailV2PriceInfoResponse {
  ...
  final pulumi.Input<GoogleCloudRetailV2PriceInfoPriceRangeResponse> priceRange;

  /// Creates a new [GoogleCloudRetailV2PriceInfoResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'priceRange': pulumi.Input.mapInputValue<GoogleCloudRetailV2PriceInfoPriceRangeResponse, Map<String, dynamic>>(priceRange, (value) => value.toMap()),
    };
  }

  factory GoogleCloudRetailV2PriceInfoResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2PriceInfoResponse(
      cost: (map['cost'] as double).input(),
      ...
      priceEffectiveTime: (map['priceEffectiveTime'] as String).input(),
      priceExpireTime: (map['priceExpireTime'] as String).input(),
      priceRange: (GoogleCloudRetailV2PriceInfoPriceRangeResponse.fromMap((map['priceRange'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
