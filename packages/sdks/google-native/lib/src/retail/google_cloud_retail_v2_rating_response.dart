...
class GoogleCloudRetailV2RatingResponse {
  ...
  /// Creates a new [GoogleCloudRetailV2RatingResponse].
  ...
  const GoogleCloudRetailV2RatingResponse({
  ...
  factory GoogleCloudRetailV2RatingResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2RatingResponse(
      averageRating: pulumi.Input.fromValue(map['averageRating'] as double),
      ratingCount: pulumi.Input.fromValue(map['ratingCount'] as int),
      ratingHistogram: pulumi.Input.fromValue((map['ratingHistogram'] as List).cast<int>()),
    );
  }
}
