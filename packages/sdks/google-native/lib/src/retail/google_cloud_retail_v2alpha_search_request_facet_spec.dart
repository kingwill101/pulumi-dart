...
class GoogleCloudRetailV2alphaSearchRequestFacetSpec {
  ...
  final pulumi.Input<GoogleCloudRetailV2alphaSearchRequestFacetSpecFacetKey>
  facetKey;
  ...
  factory GoogleCloudRetailV2alphaSearchRequestFacetSpec.fromMap(
    ...
    return GoogleCloudRetailV2alphaSearchRequestFacetSpec(
      enableDynamicPosition: (() {
        final guardedValue = map['enableDynamicPosition'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      excludedFilterKeys: (() {
        final guardedValue = map['excludedFilterKeys'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      facetKey: pulumi.Input.fromValue(
        GoogleCloudRetailV2alphaSearchRequestFacetSpecFacetKey.fromMap(
