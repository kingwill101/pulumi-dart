...
class GoogleCloudRetailV2alphaSearchRequestFacetSpecFacetKey {
  ...
  const GoogleCloudRetailV2alphaSearchRequestFacetSpecFacetKey({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'contains': ?contains,
      'intervals': ?pulumi.Input.mapOptionalInputValue<List<GoogleCloudRetailV2alphaInterval>, List<Map<String, dynamic>>>(intervals, (value) => pulumi.Input.encodeList<GoogleCloudRetailV2alphaInterval, Map<String, dynamic>>(value, (value) => value.toMap())),
      'key': key,
      'orderBy': ?orderBy,
      'prefixes': ?prefixes,
      'query': ?query,
  ...
  factory GoogleCloudRetailV2alphaSearchRequestFacetSpecFacetKey.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2alphaSearchRequestFacetSpecFacetKey(
      ...
      intervals: (() { final guardedValue = map['intervals']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudRetailV2alphaInterval>(guardedValue, (value) => GoogleCloudRetailV2alphaInterval.fromMap((value as Map).cast<String, dynamic>()))); })(),
