...
import 'google_cloud_retail_v2_image_response.dart';
import 'google_cloud_retail_v2_local_inventory_response.dart';
import 'google_cloud_retail_v2_price_info_response.dart';
import 'google_cloud_retail_v2_promotion_response.dart';
import 'google_cloud_retail_v2_rating_response.dart';

/// Product captures all metadata information of items to be recommended or searched.
class GoogleCloudRetailV2ProductResponse {
  ...
  final pulumi.Input<GoogleCloudRetailV2AudienceResponse> audience;
  ...
  final pulumi.Input<GoogleCloudRetailV2ColorInfoResponse> colorInfo;
  ...
  final pulumi.Input<List<GoogleCloudRetailV2FulfillmentInfoResponse>> fulfillmentInfo;
  ...
  final pulumi.Input<List<GoogleCloudRetailV2ImageResponse>> images;
  ...
  final pulumi.Input<List<GoogleCloudRetailV2LocalInventoryResponse>> localInventories;
  ...
  final pulumi.Input<GoogleCloudRetailV2PriceInfoResponse> priceInfo;
  ...
  final pulumi.Input<List<GoogleCloudRetailV2PromotionResponse>> promotions;
  /// The timestamp when the product is published by the retailer for the first time, which indicates the freshness of the products. Note that this field is different from available_time, given it purely describes product freshness regardless of when it is available on search and recommendation.
  final pulumi.Input<String> publishTime;
  /// The rating of this product.
  final pulumi.Input<GoogleCloudRetailV2RatingResponse> rating;
  ...
  final pulumi.Input<List<GoogleCloudRetailV2ProductResponse>> variants;

  /// Creates a new [GoogleCloudRetailV2ProductResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'audience': pulumi.Input.mapInputValue<GoogleCloudRetailV2AudienceResponse, Map<String, dynamic>>(audience, (value) => value.toMap()),
      ...
      'colorInfo': pulumi.Input.mapInputValue<GoogleCloudRetailV2ColorInfoResponse, Map<String, dynamic>>(colorInfo, (value) => value.toMap()),
      'conditions': conditions,
      'description': description,
      'expireTime': expireTime,
      'fulfillmentInfo': pulumi.Input.mapInputValue<List<GoogleCloudRetailV2FulfillmentInfoResponse>, List<Map<String, dynamic>>>(fulfillmentInfo, (value) => pulumi.Input.encodeList<GoogleCloudRetailV2FulfillmentInfoResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'gtin': gtin,
      'images': pulumi.Input.mapInputValue<List<GoogleCloudRetailV2ImageResponse>, List<Map<String, dynamic>>>(images, (value) => pulumi.Input.encodeList<GoogleCloudRetailV2ImageResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'languageCode': languageCode,
      'localInventories': pulumi.Input.mapInputValue<List<GoogleCloudRetailV2LocalInventoryResponse>, List<Map<String, dynamic>>>(localInventories, (value) => pulumi.Input.encodeList<GoogleCloudRetailV2LocalInventoryResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'materials': materials,
      'name': name,
      'patterns': patterns,
      'priceInfo': pulumi.Input.mapInputValue<GoogleCloudRetailV2PriceInfoResponse, Map<String, dynamic>>(priceInfo, (value) => value.toMap()),
      'primaryProductId': primaryProductId,
      'promotions': pulumi.Input.mapInputValue<List<GoogleCloudRetailV2PromotionResponse>, List<Map<String, dynamic>>>(promotions, (value) => pulumi.Input.encodeList<GoogleCloudRetailV2PromotionResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'publishTime': publishTime,
      'rating': pulumi.Input.mapInputValue<GoogleCloudRetailV2RatingResponse, Map<String, dynamic>>(rating, (value) => value.toMap()),
      ...
      'type': type,
      'uri': uri,
      'variants': pulumi.Input.mapInputValue<List<GoogleCloudRetailV2ProductResponse>, List<Map<String, dynamic>>>(variants, (value) => pulumi.Input.encodeList<GoogleCloudRetailV2ProductResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory GoogleCloudRetailV2ProductResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2ProductResponse(
      attributes: ((map['attributes'] as Map).cast<String, String>()).input(),
      audience: (GoogleCloudRetailV2AudienceResponse.fromMap((map['audience'] as Map).cast<String, dynamic>())).input(),
      availability: (map['availability'] as String).input(),
      availableQuantity: (map['availableQuantity'] as int).input(),
      availableTime: (map['availableTime'] as String).input(),
      brands: ((map['brands'] as List).cast<String>()).input(),
      categories: ((map['categories'] as List).cast<String>()).input(),
      collectionMemberIds: ((map['collectionMemberIds'] as List).cast<String>()).input(),
      colorInfo: (GoogleCloudRetailV2ColorInfoResponse.fromMap((map['colorInfo'] as Map).cast<String, dynamic>())).input(),
      conditions: ((map['conditions'] as List).cast<String>()).input(),
      description: (map['description'] as String).input(),
      expireTime: (map['expireTime'] as String).input(),
      fulfillmentInfo: (pulumi.Input.decodeList<GoogleCloudRetailV2FulfillmentInfoResponse>(map['fulfillmentInfo'], (value) => GoogleCloudRetailV2FulfillmentInfoResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      gtin: (map['gtin'] as String).input(),
      images: (pulumi.Input.decodeList<GoogleCloudRetailV2ImageResponse>(map['images'], (value) => GoogleCloudRetailV2ImageResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      languageCode: (map['languageCode'] as String).input(),
      localInventories: (pulumi.Input.decodeList<GoogleCloudRetailV2LocalInventoryResponse>(map['localInventories'], (value) => GoogleCloudRetailV2LocalInventoryResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      materials: ((map['materials'] as List).cast<String>()).input(),
      name: (map['name'] as String).input(),
      patterns: ((map['patterns'] as List).cast<String>()).input(),
      priceInfo: (GoogleCloudRetailV2PriceInfoResponse.fromMap((map['priceInfo'] as Map).cast<String, dynamic>())).input(),
      primaryProductId: (map['primaryProductId'] as String).input(),
      promotions: (pulumi.Input.decodeList<GoogleCloudRetailV2PromotionResponse>(map['promotions'], (value) => GoogleCloudRetailV2PromotionResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      publishTime: (map['publishTime'] as String).input(),
      rating: (GoogleCloudRetailV2RatingResponse.fromMap((map['rating'] as Map).cast<String, dynamic>())).input(),
      retrievableFields: (map['retrievableFields'] as String).input(),
      ...
      variants: (pulumi.Input.decodeList<GoogleCloudRetailV2ProductResponse>(map['variants'], (value) => GoogleCloudRetailV2ProductResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
