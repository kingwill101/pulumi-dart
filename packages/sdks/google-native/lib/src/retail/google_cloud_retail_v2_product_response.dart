...
class GoogleCloudRetailV2ProductResponse {
  ...
  final GoogleCloudRetailV2AudienceResponse audience;
  ...
  final List<String> collectionMemberIds;
  ...
  final GoogleCloudRetailV2ColorInfoResponse colorInfo;
  ...
  final List<GoogleCloudRetailV2FulfillmentInfoResponse> fulfillmentInfo;
  ...
  final List<GoogleCloudRetailV2ImageResponse> images;
  ...
  final List<GoogleCloudRetailV2LocalInventoryResponse> localInventories;
  ...
  final List<GoogleCloudRetailV2PromotionResponse> promotions;
  /// The timestamp when the product is published by the retailer for the first time, which indicates the freshness of the products. Note that this field is different from available_time, given it purely describes product freshness regardless of when it is available on search and recommendation.
  final String publishTime;
  /// The rating of this product.
  final GoogleCloudRetailV2RatingResponse rating;
  ...
  final String retrievableFields;
  ...
  final List<GoogleCloudRetailV2ProductResponse> variants;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'fulfillmentInfo': pulumi.Input.encodeList<GoogleCloudRetailV2FulfillmentInfoResponse, Map<String, dynamic>>(fulfillmentInfo, (value) => value.toMap()),
      'gtin': gtin,
      'images': pulumi.Input.encodeList<GoogleCloudRetailV2ImageResponse, Map<String, dynamic>>(images, (value) => value.toMap()),
      'languageCode': languageCode,
      'localInventories': pulumi.Input.encodeList<GoogleCloudRetailV2LocalInventoryResponse, Map<String, dynamic>>(localInventories, (value) => value.toMap()),
      'materials': materials,
      'name': name,
      'patterns': patterns,
      'priceInfo': priceInfo.toMap(),
      'primaryProductId': primaryProductId,
      'promotions': pulumi.Input.encodeList<GoogleCloudRetailV2PromotionResponse, Map<String, dynamic>>(promotions, (value) => value.toMap()),
      ...
      'type': type,
      'uri': uri,
      'variants': pulumi.Input.encodeList<GoogleCloudRetailV2ProductResponse, Map<String, dynamic>>(variants, (value) => value.toMap()),
    };
  }
  ...
  factory GoogleCloudRetailV2ProductResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2ProductResponse(
      ...
      audience: GoogleCloudRetailV2AudienceResponse.fromMap((map['audience'] as Map).cast<String, dynamic>()),
      ...
      collectionMemberIds: (map['collectionMemberIds'] as List).cast<String>(),
      colorInfo: GoogleCloudRetailV2ColorInfoResponse.fromMap((map['colorInfo'] as Map).cast<String, dynamic>()),
      conditions: (map['conditions'] as List).cast<String>(),
      description: map['description'] as String,
      expireTime: map['expireTime'] as String,
      fulfillmentInfo: pulumi.Input.decodeList<GoogleCloudRetailV2FulfillmentInfoResponse>(map['fulfillmentInfo'], (value) => GoogleCloudRetailV2FulfillmentInfoResponse.fromMap((value as Map).cast<String, dynamic>())),
      gtin: map['gtin'] as String,
      images: pulumi.Input.decodeList<GoogleCloudRetailV2ImageResponse>(map['images'], (value) => GoogleCloudRetailV2ImageResponse.fromMap((value as Map).cast<String, dynamic>())),
      languageCode: map['languageCode'] as String,
      localInventories: pulumi.Input.decodeList<GoogleCloudRetailV2LocalInventoryResponse>(map['localInventories'], (value) => GoogleCloudRetailV2LocalInventoryResponse.fromMap((value as Map).cast<String, dynamic>())),
      materials: (map['materials'] as List).cast<String>(),
      name: map['name'] as String,
      patterns: (map['patterns'] as List).cast<String>(),
      priceInfo: GoogleCloudRetailV2PriceInfoResponse.fromMap((map['priceInfo'] as Map).cast<String, dynamic>()),
      primaryProductId: map['primaryProductId'] as String,
      promotions: pulumi.Input.decodeList<GoogleCloudRetailV2PromotionResponse>(map['promotions'], (value) => GoogleCloudRetailV2PromotionResponse.fromMap((value as Map).cast<String, dynamic>())),
      publishTime: map['publishTime'] as String,
      rating: GoogleCloudRetailV2RatingResponse.fromMap((map['rating'] as Map).cast<String, dynamic>()),
      retrievableFields: map['retrievableFields'] as String,
      ...
      variants: pulumi.Input.decodeList<GoogleCloudRetailV2ProductResponse>(map['variants'], (value) => GoogleCloudRetailV2ProductResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
