...
class GoogleCloudRetailV2ProductResponse {
  ...
  final pulumi.Input<List<GoogleCloudRetailV2FulfillmentInfoResponse>>
  fulfillmentInfo;
  ...
  final pulumi.Input<List<GoogleCloudRetailV2LocalInventoryResponse>>
  localInventories;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'images':
          pulumi.Input.mapInputValue<
            List<GoogleCloudRetailV2ImageResponse>,
            List<Map<String, dynamic>>
          >(
            images,
            (value) =>
      ...
      'localInventories':
          pulumi.Input.mapInputValue<
            List<GoogleCloudRetailV2LocalInventoryResponse>,
            List<Map<String, dynamic>>
          >(
            localInventories,
            (value) =>
      ...
      'promotions':
          pulumi.Input.mapInputValue<
            List<GoogleCloudRetailV2PromotionResponse>,
            List<Map<String, dynamic>>
          >(
            promotions,
            (value) =>
      ...
      'variants':
          pulumi.Input.mapInputValue<
            List<GoogleCloudRetailV2ProductResponse>,
            List<Map<String, dynamic>>
          >(
            variants,
            (value) =>
  ...
  factory GoogleCloudRetailV2ProductResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2ProductResponse(
      ...
      audience: pulumi.Input.fromValue(
        GoogleCloudRetailV2AudienceResponse.fromMap(
      ...
      collectionMemberIds: pulumi.Input.fromValue(
        (map['collectionMemberIds'] as List).cast<String>(),
      ),
      colorInfo: pulumi.Input.fromValue(
        GoogleCloudRetailV2ColorInfoResponse.fromMap(
      ...
      fulfillmentInfo: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GoogleCloudRetailV2FulfillmentInfoResponse>(
          map['fulfillmentInfo']!,
          (value) => GoogleCloudRetailV2FulfillmentInfoResponse.fromMap(
      ...
      images: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GoogleCloudRetailV2ImageResponse>(
          map['images']!,
          (value) => GoogleCloudRetailV2ImageResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      languageCode: pulumi.Input.fromValue(map['languageCode'] as String),
      localInventories: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GoogleCloudRetailV2LocalInventoryResponse>(
          map['localInventories']!,
          (value) => GoogleCloudRetailV2LocalInventoryResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      ...
      priceInfo: pulumi.Input.fromValue(
        GoogleCloudRetailV2PriceInfoResponse.fromMap(
          (map['priceInfo']! as Map).cast<String, dynamic>(),
        ),
      ),
      primaryProductId: pulumi.Input.fromValue(
        map['primaryProductId'] as String,
      ),
      promotions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GoogleCloudRetailV2PromotionResponse>(
          map['promotions']!,
          (value) => GoogleCloudRetailV2PromotionResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      publishTime: pulumi.Input.fromValue(map['publishTime'] as String),
      rating: pulumi.Input.fromValue(
        GoogleCloudRetailV2RatingResponse.fromMap(
          (map['rating']! as Map).cast<String, dynamic>(),
        ),
      ),
      retrievableFields: pulumi.Input.fromValue(
      ...
      variants: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GoogleCloudRetailV2ProductResponse>(
          map['variants']!,
          (value) => GoogleCloudRetailV2ProductResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
