...
class GoogleCloudRetailV2ProductResponse {
  ...
  const GoogleCloudRetailV2ProductResponse({
  ...
  factory GoogleCloudRetailV2ProductResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2ProductResponse(
      ...
      audience: pulumi.Input.fromValue(GoogleCloudRetailV2AudienceResponse.fromMap((map['audience']! as Map).cast<String, dynamic>())),
      ...
      colorInfo: pulumi.Input.fromValue(GoogleCloudRetailV2ColorInfoResponse.fromMap((map['colorInfo']! as Map).cast<String, dynamic>())),
      ...
      fulfillmentInfo: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudRetailV2FulfillmentInfoResponse>(map['fulfillmentInfo']!, (value) => GoogleCloudRetailV2FulfillmentInfoResponse.fromMap((value as Map).cast<String, dynamic>()))),
      gtin: pulumi.Input.fromValue(map['gtin'] as String),
      images: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudRetailV2ImageResponse>(map['images']!, (value) => GoogleCloudRetailV2ImageResponse.fromMap((value as Map).cast<String, dynamic>()))),
      languageCode: pulumi.Input.fromValue(map['languageCode'] as String),
      localInventories: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudRetailV2LocalInventoryResponse>(map['localInventories']!, (value) => GoogleCloudRetailV2LocalInventoryResponse.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      priceInfo: pulumi.Input.fromValue(GoogleCloudRetailV2PriceInfoResponse.fromMap((map['priceInfo']! as Map).cast<String, dynamic>())),
      primaryProductId: pulumi.Input.fromValue(map['primaryProductId'] as String),
      promotions: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudRetailV2PromotionResponse>(map['promotions']!, (value) => GoogleCloudRetailV2PromotionResponse.fromMap((value as Map).cast<String, dynamic>()))),
      publishTime: pulumi.Input.fromValue(map['publishTime'] as String),
      rating: pulumi.Input.fromValue(GoogleCloudRetailV2RatingResponse.fromMap((map['rating']! as Map).cast<String, dynamic>())),
      ...
      variants: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudRetailV2ProductResponse>(map['variants']!, (value) => GoogleCloudRetailV2ProductResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
