...
class GoogleCloudRetailV2betaProductResponse {
  ...
  final pulumi.Input<List<GoogleCloudRetailV2betaFulfillmentInfoResponse>>
  fulfillmentInfo;
  ...
  final pulumi.Input<List<GoogleCloudRetailV2betaLocalInventoryResponse>>
  localInventories;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'images':
          pulumi.Input.mapInputValue<
            List<GoogleCloudRetailV2betaImageResponse>,
            List<Map<String, dynamic>>
          >(
            images,
            (value) =>
      ...
      'promotions':
          pulumi.Input.mapInputValue<
            List<GoogleCloudRetailV2betaPromotionResponse>,
            List<Map<String, dynamic>>
          >(
            promotions,
            (value) =>
      ...
      'variants':
          pulumi.Input.mapInputValue<
            List<GoogleCloudRetailV2betaProductResponse>,
            List<Map<String, dynamic>>
          >(
            variants,
            (value) =>
  ...
  factory GoogleCloudRetailV2betaProductResponse.fromMap(
    ...
    return GoogleCloudRetailV2betaProductResponse(
      ...
      audience: pulumi.Input.fromValue(
        GoogleCloudRetailV2betaAudienceResponse.fromMap(
      ...
      colorInfo: pulumi.Input.fromValue(
        GoogleCloudRetailV2betaColorInfoResponse.fromMap(
      ...
      fulfillmentInfo: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GoogleCloudRetailV2betaFulfillmentInfoResponse>(
          map['fulfillmentInfo']!,
      ...
      images: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GoogleCloudRetailV2betaImageResponse>(
          map['images']!,
      ...
      localInventories: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GoogleCloudRetailV2betaLocalInventoryResponse>(
      ...
      rating: pulumi.Input.fromValue(
        GoogleCloudRetailV2betaRatingResponse.fromMap(
      ...
      variants: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GoogleCloudRetailV2betaProductResponse>(
          map['variants']!,
