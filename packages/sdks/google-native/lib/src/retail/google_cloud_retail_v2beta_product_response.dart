...
class GoogleCloudRetailV2betaProductResponse {
  ...
  factory GoogleCloudRetailV2betaProductResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2betaProductResponse(
      ...
      audience: (GoogleCloudRetailV2betaAudienceResponse.fromMap((map['audience'] as Map).cast<String, dynamic>())).input(),
      ...
      colorInfo: (GoogleCloudRetailV2betaColorInfoResponse.fromMap((map['colorInfo'] as Map).cast<String, dynamic>())).input(),
      conditions: ((map['conditions'] as List).cast<String>()).input(),
      description: (map['description'] as String).input(),
      expireTime: (map['expireTime'] as String).input(),
      fulfillmentInfo: (pulumi.Input.decodeList<GoogleCloudRetailV2betaFulfillmentInfoResponse>(map['fulfillmentInfo'], (value) => GoogleCloudRetailV2betaFulfillmentInfoResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      gtin: (map['gtin'] as String).input(),
      images: (pulumi.Input.decodeList<GoogleCloudRetailV2betaImageResponse>(map['images'], (value) => GoogleCloudRetailV2betaImageResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      languageCode: (map['languageCode'] as String).input(),
      localInventories: (pulumi.Input.decodeList<GoogleCloudRetailV2betaLocalInventoryResponse>(map['localInventories'], (value) => GoogleCloudRetailV2betaLocalInventoryResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      promotions: (pulumi.Input.decodeList<GoogleCloudRetailV2betaPromotionResponse>(map['promotions'], (value) => GoogleCloudRetailV2betaPromotionResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      publishTime: (map['publishTime'] as String).input(),
      rating: (GoogleCloudRetailV2betaRatingResponse.fromMap((map['rating'] as Map).cast<String, dynamic>())).input(),
      ...
      variants: (pulumi.Input.decodeList<GoogleCloudRetailV2betaProductResponse>(map['variants'], (value) => GoogleCloudRetailV2betaProductResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
