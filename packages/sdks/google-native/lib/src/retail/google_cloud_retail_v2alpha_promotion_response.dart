...
class GoogleCloudRetailV2alphaPromotionResponse {
  ...
  const GoogleCloudRetailV2alphaPromotionResponse({
  ...
  factory GoogleCloudRetailV2alphaPromotionResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2alphaPromotionResponse(
      promotionId: pulumi.Input.fromValue(map['promotionId'] as String),
    );
  }
}
