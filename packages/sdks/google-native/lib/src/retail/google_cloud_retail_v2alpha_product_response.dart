...
class GoogleCloudRetailV2alphaProductResponse {
  ...
  factory GoogleCloudRetailV2alphaProductResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2alphaProductResponse(
      ...
      audience: (GoogleCloudRetailV2alphaAudienceResponse.fromMap((map['audience'] as Map).cast<String, dynamic>())).input(),
      ...
      colorInfo: (GoogleCloudRetailV2alphaColorInfoResponse.fromMap((map['colorInfo'] as Map).cast<String, dynamic>())).input(),
      conditions: ((map['conditions'] as List).cast<String>()).input(),
      description: (map['description'] as String).input(),
      expireTime: (map['expireTime'] as String).input(),
      fulfillmentInfo: (pulumi.Input.decodeList<GoogleCloudRetailV2alphaFulfillmentInfoResponse>(map['fulfillmentInfo'], (value) => GoogleCloudRetailV2alphaFulfillmentInfoResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      gtin: (map['gtin'] as String).input(),
      images: (pulumi.Input.decodeList<GoogleCloudRetailV2alphaImageResponse>(map['images'], (value) => GoogleCloudRetailV2alphaImageResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      languageCode: (map['languageCode'] as String).input(),
      localInventories: (pulumi.Input.decodeList<GoogleCloudRetailV2alphaLocalInventoryResponse>(map['localInventories'], (value) => GoogleCloudRetailV2alphaLocalInventoryResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      promotions: (pulumi.Input.decodeList<GoogleCloudRetailV2alphaPromotionResponse>(map['promotions'], (value) => GoogleCloudRetailV2alphaPromotionResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      publishTime: (map['publishTime'] as String).input(),
      rating: (GoogleCloudRetailV2alphaRatingResponse.fromMap((map['rating'] as Map).cast<String, dynamic>())).input(),
      ...
      variants: (pulumi.Input.decodeList<GoogleCloudRetailV2alphaProductResponse>(map['variants'], (value) => GoogleCloudRetailV2alphaProductResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
