...
class GoogleCloudRetailV2alphaProductResponse {
  ...
  final pulumi.Input<GoogleCloudRetailV2alphaAudienceResponse> audience;
  ...
  final pulumi.Input<GoogleCloudRetailV2alphaColorInfoResponse> colorInfo;
  ...
  final pulumi.Input<List<GoogleCloudRetailV2alphaFulfillmentInfoResponse>> fulfillmentInfo;
  ...
  final pulumi.Input<List<GoogleCloudRetailV2alphaImageResponse>> images;
  ...
  final pulumi.Input<List<GoogleCloudRetailV2alphaLocalInventoryResponse>> localInventories;
  ...
  final pulumi.Input<List<GoogleCloudRetailV2alphaPromotionResponse>> promotions;
  /// The timestamp when the product is published by the retailer for the first time, which indicates the freshness of the products. Note that this field is different from available_time, given it purely describes product freshness regardless of when it is available on search and recommendation.
  final pulumi.Input<String> publishTime;
  /// The rating of this product.
  final pulumi.Input<GoogleCloudRetailV2alphaRatingResponse> rating;
  ...
  final pulumi.Input<List<GoogleCloudRetailV2alphaProductResponse>> variants;

  /// Creates a new [GoogleCloudRetailV2alphaProductResponse].
  ...
  const GoogleCloudRetailV2alphaProductResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'audience': pulumi.Input.mapInputValue<GoogleCloudRetailV2alphaAudienceResponse, Map<String, dynamic>>(audience, (value) => value.toMap()),
      ...
      'colorInfo': pulumi.Input.mapInputValue<GoogleCloudRetailV2alphaColorInfoResponse, Map<String, dynamic>>(colorInfo, (value) => value.toMap()),
      'conditions': conditions,
      'description': description,
      'expireTime': expireTime,
      'fulfillmentInfo': pulumi.Input.mapInputValue<List<GoogleCloudRetailV2alphaFulfillmentInfoResponse>, List<Map<String, dynamic>>>(fulfillmentInfo, (value) => pulumi.Input.encodeList<GoogleCloudRetailV2alphaFulfillmentInfoResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'gtin': gtin,
      'images': pulumi.Input.mapInputValue<List<GoogleCloudRetailV2alphaImageResponse>, List<Map<String, dynamic>>>(images, (value) => pulumi.Input.encodeList<GoogleCloudRetailV2alphaImageResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'languageCode': languageCode,
      'localInventories': pulumi.Input.mapInputValue<List<GoogleCloudRetailV2alphaLocalInventoryResponse>, List<Map<String, dynamic>>>(localInventories, (value) => pulumi.Input.encodeList<GoogleCloudRetailV2alphaLocalInventoryResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'materials': materials,
      'name': name,
      'patterns': patterns,
      ...
      'promotions': pulumi.Input.mapInputValue<List<GoogleCloudRetailV2alphaPromotionResponse>, List<Map<String, dynamic>>>(promotions, (value) => pulumi.Input.encodeList<GoogleCloudRetailV2alphaPromotionResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'publishTime': publishTime,
      'rating': pulumi.Input.mapInputValue<GoogleCloudRetailV2alphaRatingResponse, Map<String, dynamic>>(rating, (value) => value.toMap()),
      ...
      'type': type,
      'uri': uri,
      'variants': pulumi.Input.mapInputValue<List<GoogleCloudRetailV2alphaProductResponse>, List<Map<String, dynamic>>>(variants, (value) => pulumi.Input.encodeList<GoogleCloudRetailV2alphaProductResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory GoogleCloudRetailV2alphaProductResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2alphaProductResponse(
      attributes: pulumi.Input.fromValue((map['attributes'] as Map).cast<String, String>()),
      audience: pulumi.Input.fromValue(GoogleCloudRetailV2alphaAudienceResponse.fromMap((map['audience']! as Map).cast<String, dynamic>())),
      ...
      colorInfo: pulumi.Input.fromValue(GoogleCloudRetailV2alphaColorInfoResponse.fromMap((map['colorInfo']! as Map).cast<String, dynamic>())),
      ...
      fulfillmentInfo: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudRetailV2alphaFulfillmentInfoResponse>(map['fulfillmentInfo']!, (value) => GoogleCloudRetailV2alphaFulfillmentInfoResponse.fromMap((value as Map).cast<String, dynamic>()))),
      gtin: pulumi.Input.fromValue(map['gtin'] as String),
      images: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudRetailV2alphaImageResponse>(map['images']!, (value) => GoogleCloudRetailV2alphaImageResponse.fromMap((value as Map).cast<String, dynamic>()))),
      languageCode: pulumi.Input.fromValue(map['languageCode'] as String),
      localInventories: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudRetailV2alphaLocalInventoryResponse>(map['localInventories']!, (value) => GoogleCloudRetailV2alphaLocalInventoryResponse.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      promotions: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudRetailV2alphaPromotionResponse>(map['promotions']!, (value) => GoogleCloudRetailV2alphaPromotionResponse.fromMap((value as Map).cast<String, dynamic>()))),
      publishTime: pulumi.Input.fromValue(map['publishTime'] as String),
      rating: pulumi.Input.fromValue(GoogleCloudRetailV2alphaRatingResponse.fromMap((map['rating']! as Map).cast<String, dynamic>())),
      ...
      variants: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudRetailV2alphaProductResponse>(map['variants']!, (value) => GoogleCloudRetailV2alphaProductResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
