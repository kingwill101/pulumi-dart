...
class GoogleCloudRetailV2alphaProductResponse {
  ...
  final pulumi.Input<List<GoogleCloudRetailV2alphaFulfillmentInfoResponse>>
  fulfillmentInfo;
  ...
  final pulumi.Input<List<GoogleCloudRetailV2alphaLocalInventoryResponse>>
  localInventories;
  ...
  final pulumi.Input<List<GoogleCloudRetailV2alphaPromotionResponse>>
  promotions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'images':
          pulumi.Input.mapInputValue<
            List<GoogleCloudRetailV2alphaImageResponse>,
            List<Map<String, dynamic>>
          >(
            images,
            (value) =>
      ...
      'promotions':
          pulumi.Input.mapInputValue<
            List<GoogleCloudRetailV2alphaPromotionResponse>,
            List<Map<String, dynamic>>
          >(
            promotions,
            (value) =>
      ...
      'variants':
          pulumi.Input.mapInputValue<
            List<GoogleCloudRetailV2alphaProductResponse>,
            List<Map<String, dynamic>>
          >(
            variants,
            (value) =>
  ...
  factory GoogleCloudRetailV2alphaProductResponse.fromMap(
    ...
    return GoogleCloudRetailV2alphaProductResponse(
      ...
      audience: pulumi.Input.fromValue(
        GoogleCloudRetailV2alphaAudienceResponse.fromMap(
      ...
      colorInfo: pulumi.Input.fromValue(
        GoogleCloudRetailV2alphaColorInfoResponse.fromMap(
      ...
      images: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GoogleCloudRetailV2alphaImageResponse>(
          map['images']!,
      ...
      localInventories: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GoogleCloudRetailV2alphaLocalInventoryResponse>(
      ...
      rating: pulumi.Input.fromValue(
        GoogleCloudRetailV2alphaRatingResponse.fromMap(
