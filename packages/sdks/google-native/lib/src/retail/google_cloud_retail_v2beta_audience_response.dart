...
class GoogleCloudRetailV2betaAudienceResponse {
  ...
  /// Creates a new [GoogleCloudRetailV2betaAudienceResponse].
  ...
  const GoogleCloudRetailV2betaAudienceResponse({
  ...
  factory GoogleCloudRetailV2betaAudienceResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2betaAudienceResponse(
