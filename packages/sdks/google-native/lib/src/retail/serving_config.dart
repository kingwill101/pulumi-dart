...
class ServingConfig extends pulumi.CustomResource {
  ...
  ServingConfig(
    ...
    this.dynamicFacetSpec = registerOutput<GoogleCloudRetailV2SearchRequestDynamicFacetSpecResponse>('dynamicFacetSpec');
    ...
    this.personalizationSpec = registerOutput<GoogleCloudRetailV2SearchRequestPersonalizationSpecResponse>('personalizationSpec');
