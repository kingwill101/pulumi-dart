...
class GoogleCloudRetailV2alphaRuleForceReturnFacetActionFacetPositionAdjustmentResponse {
  ...
  const GoogleCloudRetailV2alphaRuleForceReturnFacetActionFacetPositionAdjustmentResponse({
  ...
  factory GoogleCloudRetailV2alphaRuleForceReturnFacetActionFacetPositionAdjustmentResponse.fromMap(Map<String, dynamic> map) {
