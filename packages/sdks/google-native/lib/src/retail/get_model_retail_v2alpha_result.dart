...
class GetModelRetailV2alphaResult {
  ...
  final GoogleCloudRetailV2alphaModelModelFeaturesConfigResponse modelFeaturesConfig;
  ...
  final GoogleCloudRetailV2alphaModelPageOptimizationConfigResponse pageOptimizationConfig;
  ...
  final List<GoogleCloudRetailV2alphaModelServingConfigListResponse> servingConfigLists;
  ...
  const GetModelRetailV2alphaResult({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'servingConfigLists': pulumi.Input.encodeList<GoogleCloudRetailV2alphaModelServingConfigListResponse, Map<String, dynamic>>(servingConfigLists, (value) => value.toMap()),
  ...
  factory GetModelRetailV2alphaResult.fromMap(Map<String, dynamic> map) {
    return GetModelRetailV2alphaResult(
      ...
      modelFeaturesConfig: GoogleCloudRetailV2alphaModelModelFeaturesConfigResponse.fromMap((map['modelFeaturesConfig']! as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      optimizationObjective: map['optimizationObjective'] as String,
      pageOptimizationConfig: GoogleCloudRetailV2alphaModelPageOptimizationConfigResponse.fromMap((map['pageOptimizationConfig']! as Map).cast<String, dynamic>()),
      periodicTuningState: map['periodicTuningState'] as String,
      servingConfigLists: pulumi.Input.decodeList<GoogleCloudRetailV2alphaModelServingConfigListResponse>(map['servingConfigLists']!, (value) => GoogleCloudRetailV2alphaModelServingConfigListResponse.fromMap((value as Map).cast<String, dynamic>())),
