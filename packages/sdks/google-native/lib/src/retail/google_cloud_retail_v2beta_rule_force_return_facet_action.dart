...
class GoogleCloudRetailV2betaRuleForceReturnFacetAction {
  ...
  final List<GoogleCloudRetailV2betaRuleForceReturnFacetActionFacetPositionAdjustment>? facetPositionAdjustments;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'facetPositionAdjustments': ?facetPositionAdjustments == null ? null : pulumi.Input.encodeList<GoogleCloudRetailV2betaRuleForceReturnFacetActionFacetPositionAdjustment, Map<String, dynamic>>(facetPositionAdjustments!, (value) => value.toMap()),
    };
  }
