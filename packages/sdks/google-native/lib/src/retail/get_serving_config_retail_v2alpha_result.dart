...
class GetServingConfigRetailV2alphaResult {
  ...
  final GoogleCloudRetailV2alphaSearchRequestDynamicFacetSpecResponse
  dynamicFacetSpec;
  ...
  final GoogleCloudRetailV2alphaSearchRequestPersonalizationSpecResponse
  personalizationSpec;
  ...
  factory GetServingConfigRetailV2alphaResult.fromMap(
    ...
    return GetServingConfigRetailV2alphaResult(
      ...
      doNotAssociateControlIds: (map['doNotAssociateControlIds'] as List)
          .cast<String>(),
      dynamicFacetSpec:
          GoogleCloudRetailV2alphaSearchRequestDynamicFacetSpecResponse.fromMap(
      ...
      onewaySynonymsControlIds: (map['onewaySynonymsControlIds'] as List)
          .cast<String>(),
      personalizationSpec:
          GoogleCloudRetailV2alphaSearchRequestPersonalizationSpecResponse.fromMap(
