...
class GetServingConfigRetailV2alphaResult {
  ...
  final GoogleCloudRetailV2alphaSearchRequestDynamicFacetSpecResponse dynamicFacetSpec;
  ...
  final GoogleCloudRetailV2alphaSearchRequestPersonalizationSpecResponse personalizationSpec;
  ...
  /// Creates a new [GetServingConfigRetailV2alphaResult].
  ...
  const GetServingConfigRetailV2alphaResult({
  ...
  factory GetServingConfigRetailV2alphaResult.fromMap(Map<String, dynamic> map) {
    return GetServingConfigRetailV2alphaResult(
      ...
      dynamicFacetSpec: GoogleCloudRetailV2alphaSearchRequestDynamicFacetSpecResponse.fromMap((map['dynamicFacetSpec']! as Map).cast<String, dynamic>()),
      ...
      personalizationSpec: GoogleCloudRetailV2alphaSearchRequestPersonalizationSpecResponse.fromMap((map['personalizationSpec']! as Map).cast<String, dynamic>()),
