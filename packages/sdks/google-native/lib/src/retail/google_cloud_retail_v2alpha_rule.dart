...
class GoogleCloudRetailV2alphaRule {
  ...
  final pulumi.Input<GoogleCloudRetailV2alphaRuleDoNotAssociateAction>?
  ...
  final pulumi.Input<GoogleCloudRetailV2alphaRuleForceReturnFacetAction>?
  ...
  final pulumi.Input<GoogleCloudRetailV2alphaRuleOnewaySynonymsAction>?
  onewaySynonymsAction;

  /// Redirects a shopper to a specific page.
  final pulumi.Input<GoogleCloudRetailV2alphaRuleRedirectAction>?
  redirectAction;

  /// Remove an attribute as a facet in the request (if present).
  final pulumi.Input<GoogleCloudRetailV2alphaRuleRemoveFacetAction>?
  removeFacetAction;

  /// Replaces specific terms in the query.
  final pulumi.Input<GoogleCloudRetailV2alphaRuleReplacementAction>?
  replacementAction;

  /// Treats a set of terms as synonyms of one another.
  final pulumi.Input<GoogleCloudRetailV2alphaRuleTwowaySynonymsAction>?
  ...
  factory GoogleCloudRetailV2alphaRule.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2alphaRule(
      ...
      condition: pulumi.Input.fromValue(
        GoogleCloudRetailV2alphaCondition.fromMap(
