...
class GoogleCloudRetailV2betaSearchRequestFacetSpec {
  ...
  final pulumi.Input<GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey> facetKey;
  ...
  const GoogleCloudRetailV2betaSearchRequestFacetSpec({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'facetKey': pulumi.Input.mapInputValue<GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey, Map<String, dynamic>>(facetKey, (value) => value.toMap()),
      'limit': ?limit,
    };
  }
  ...
  factory GoogleCloudRetailV2betaSearchRequestFacetSpec.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2betaSearchRequestFacetSpec(
      ...
      facetKey: pulumi.Input.fromValue(GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey.fromMap((map['facetKey']! as Map).cast<String, dynamic>())),
