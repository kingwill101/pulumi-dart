...
class GoogleCloudRetailV2ConditionQueryTermResponse {
  ...
  /// Creates a new [GoogleCloudRetailV2ConditionQueryTermResponse].
  ...
  const GoogleCloudRetailV2ConditionQueryTermResponse({
  ...
  factory GoogleCloudRetailV2ConditionQueryTermResponse.fromMap(Map<String, dynamic> map) {
