...
import 'google_cloud_retail_v2beta_model_serving_config_list_response.dart';

/// Result data returned by getModel.
class GetModelRetailV2betaResult {
  ...
  final GoogleCloudRetailV2betaModelModelFeaturesConfigResponse modelFeaturesConfig;
  ...
  final List<GoogleCloudRetailV2betaModelServingConfigListResponse> servingConfigLists;
  ...
  /// Creates a new [GetModelRetailV2betaResult].
  ...
  const GetModelRetailV2betaResult({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'servingConfigLists': pulumi.Input.encodeList<GoogleCloudRetailV2betaModelServingConfigListResponse, Map<String, dynamic>>(servingConfigLists, (value) => value.toMap()),
  ...
  factory GetModelRetailV2betaResult.fromMap(Map<String, dynamic> map) {
    return GetModelRetailV2betaResult(
      ...
      modelFeaturesConfig: GoogleCloudRetailV2betaModelModelFeaturesConfigResponse.fromMap((map['modelFeaturesConfig']! as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      optimizationObjective: map['optimizationObjective'] as String,
      periodicTuningState: map['periodicTuningState'] as String,
      servingConfigLists: pulumi.Input.decodeList<GoogleCloudRetailV2betaModelServingConfigListResponse>(map['servingConfigLists']!, (value) => GoogleCloudRetailV2betaModelServingConfigListResponse.fromMap((value as Map).cast<String, dynamic>())),
