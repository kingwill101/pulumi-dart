...
class GetModelRetailV2betaResult {
  ...
  final GoogleCloudRetailV2betaModelModelFeaturesConfigResponse
  modelFeaturesConfig;
  ...
  final List<GoogleCloudRetailV2betaModelServingConfigListResponse>
  servingConfigLists;
  ...
  factory GetModelRetailV2betaResult.fromMap(Map<String, dynamic> map) {
    return GetModelRetailV2betaResult(
      ...
      modelFeaturesConfig:
          GoogleCloudRetailV2betaModelModelFeaturesConfigResponse.fromMap(
      ...
      servingConfigLists:
          ...
          >(
            ...
            (value) =>
                GoogleCloudRetailV2betaModelServingConfigListResponse.fromMap(
