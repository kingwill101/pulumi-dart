...
class GoogleCloudRetailV2ConditionResponse {
  ...
  const GoogleCloudRetailV2ConditionResponse({
  ...
  factory GoogleCloudRetailV2ConditionResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2ConditionResponse(
      activeTimeRange: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudRetailV2ConditionTimeRangeResponse>(map['activeTimeRange']!, (value) => GoogleCloudRetailV2ConditionTimeRangeResponse.fromMap((value as Map).cast<String, dynamic>()))),
      pageCategories: pulumi.Input.fromValue((map['pageCategories'] as List).cast<String>()),
      queryTerms: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudRetailV2ConditionQueryTermResponse>(map['queryTerms']!, (value) => GoogleCloudRetailV2ConditionQueryTermResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
