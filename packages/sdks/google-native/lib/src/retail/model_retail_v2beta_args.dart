    ...
    return <String, dynamic>{
      ...
      'filteringOption':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(filteringOption, (value) => value.wireValue),
      'location': ?location,
      'modelFeaturesConfig':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'periodicTuningState':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(periodicTuningState, (value) => value.wireValue),
      'project': ?project,
      'trainingState':
          ?pulumi.Input.mapOptionalInputValue<
            ModelTrainingStateRetailV2beta,
            String
          >(trainingState, (value) => value.wireValue),
      'type': type,
    };
  }
    ...
    return ModelRetailV2betaArgs(
      ...
      filteringOption: (() {
        ...
        return pulumi.Input.fromValue(
          ModelFilteringOptionRetailV2beta.fromValue(guardedValue as String),
        );
      })(),
      location: (() {
      ...
      trainingState: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ModelTrainingStateRetailV2beta.fromValue(guardedValue as String),
        );
      })(),
