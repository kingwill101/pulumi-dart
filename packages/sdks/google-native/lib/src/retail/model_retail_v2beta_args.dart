...
class ModelRetailV2betaArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'dryRun': ?dryRun,
      'filteringOption': ?pulumi.Input.mapOptionalInputValue<ModelFilteringOptionRetailV2beta, String>(filteringOption, (value) => value.wireValue),
      'location': ?location,
      ...
      'periodicTuningState': ?pulumi.Input.mapOptionalInputValue<ModelPeriodicTuningStateRetailV2beta, String>(periodicTuningState, (value) => value.wireValue),
      'project': ?project,
      'trainingState': ?pulumi.Input.mapOptionalInputValue<ModelTrainingStateRetailV2beta, String>(trainingState, (value) => value.wireValue),
      'type': type,
    };
  }
  ...
  factory ModelRetailV2betaArgs.fromMap(Map<String, dynamic> map) {
    return ModelRetailV2betaArgs(
      ...
      filteringOption: (() { final guardedValue = map['filteringOption']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ModelFilteringOptionRetailV2beta.fromValue(guardedValue as String)); })(),
      location: (() { final guardedValue = map['location']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      modelFeaturesConfig: (() { final guardedValue = map['modelFeaturesConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudRetailV2betaModelModelFeaturesConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      periodicTuningState: (() { final guardedValue = map['periodicTuningState']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ModelPeriodicTuningStateRetailV2beta.fromValue(guardedValue as String)); })(),
      project: (() { final guardedValue = map['project']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      trainingState: (() { final guardedValue = map['trainingState']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ModelTrainingStateRetailV2beta.fromValue(guardedValue as String)); })(),
