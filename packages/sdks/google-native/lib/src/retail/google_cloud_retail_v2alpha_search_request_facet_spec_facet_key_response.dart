...
class GoogleCloudRetailV2alphaSearchRequestFacetSpecFacetKeyResponse {
  ...
  factory GoogleCloudRetailV2alphaSearchRequestFacetSpecFacetKeyResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2alphaSearchRequestFacetSpecFacetKeyResponse(
      ...
      contains: ((map['contains'] as List).cast<String>()).input(),
      intervals: (pulumi.Input.decodeList<GoogleCloudRetailV2alphaIntervalResponse>(map['intervals'], (value) => GoogleCloudRetailV2alphaIntervalResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      key: (map['key'] as String).input(),
      orderBy: (map['orderBy'] as String).input(),
      prefixes: ((map['prefixes'] as List).cast<String>()).input(),
      query: (map['query'] as String).input(),
      restrictedValues: ((map['restrictedValues'] as List).cast<String>()).input(),
      returnMinMax: (map['returnMinMax'] as bool).input(),
    );
  }
}
