...
class GoogleCloudRetailV2alphaSearchRequestFacetSpecFacetKeyResponse {
  ...
  final pulumi.Input<List<GoogleCloudRetailV2alphaIntervalResponse>> intervals;
  ...
  /// Creates a new [GoogleCloudRetailV2alphaSearchRequestFacetSpecFacetKeyResponse].
  ...
  const GoogleCloudRetailV2alphaSearchRequestFacetSpecFacetKeyResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'contains': contains,
      'intervals': pulumi.Input.mapInputValue<List<GoogleCloudRetailV2alphaIntervalResponse>, List<Map<String, dynamic>>>(intervals, (value) => pulumi.Input.encodeList<GoogleCloudRetailV2alphaIntervalResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'key': key,
      'orderBy': orderBy,
      'prefixes': prefixes,
      'query': query,
  ...
  factory GoogleCloudRetailV2alphaSearchRequestFacetSpecFacetKeyResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2alphaSearchRequestFacetSpecFacetKeyResponse(
      caseInsensitive: pulumi.Input.fromValue(map['caseInsensitive'] as bool),
      contains: pulumi.Input.fromValue((map['contains'] as List).cast<String>()),
      intervals: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudRetailV2alphaIntervalResponse>(map['intervals']!, (value) => GoogleCloudRetailV2alphaIntervalResponse.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      restrictedValues: pulumi.Input.fromValue((map['restrictedValues'] as List).cast<String>()),
      returnMinMax: pulumi.Input.fromValue(map['returnMinMax'] as bool),
    );
  }
}
