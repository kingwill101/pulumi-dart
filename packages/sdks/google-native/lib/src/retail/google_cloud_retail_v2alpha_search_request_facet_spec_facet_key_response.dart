...
class GoogleCloudRetailV2alphaSearchRequestFacetSpecFacetKeyResponse {
    ...
    return <String, dynamic>{
      ...
      'intervals':
          pulumi.Input.mapInputValue<
            List<GoogleCloudRetailV2alphaIntervalResponse>,
  ...
  factory GoogleCloudRetailV2alphaSearchRequestFacetSpecFacetKeyResponse.fromMap(
    ...
    return GoogleCloudRetailV2alphaSearchRequestFacetSpecFacetKeyResponse(
      ...
      contains: pulumi.Input.fromValue(
        (map['contains'] as List).cast<String>(),
      ),
      intervals: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GoogleCloudRetailV2alphaIntervalResponse>(
          map['intervals']!,
          (value) => GoogleCloudRetailV2alphaIntervalResponse.fromMap(
      ...
      restrictedValues: pulumi.Input.fromValue(
        (map['restrictedValues'] as List).cast<String>(),
      ),
