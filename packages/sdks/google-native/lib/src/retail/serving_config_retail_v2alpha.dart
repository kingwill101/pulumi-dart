...
import 'serving_config_retail_v2alpha_args.dart';

/// Creates a ServingConfig. A maximum of 100 ServingConfigs are allowed in a Catalog, otherwise a FAILED_PRECONDITION error is returned.
/// Auto-naming is currently not supported for this resource.
class ServingConfigRetailV2alpha extends pulumi.CustomResource {
  ...
  late final pulumi.Output<String> diversityLevel;
  /// What kind of diversity to use - data driven or rule based. If unset, the server behavior defaults to RULE_BASED_DIVERSITY.
  late final pulumi.Output<String> diversityType;
  /// Condition do not associate specifications. If multiple do not associate conditions match, all matching do not associate controls in the list will execute. - Order does not matter. - Maximum number of specifications is 100. Can only be set if solution_types is SOLUTION_TYPE_SEARCH.
  late final pulumi.Output<List<String>> doNotAssociateControlIds;
  ...
  late final pulumi.Output<GoogleCloudRetailV2alphaSearchRequestDynamicFacetSpecResponse> dynamicFacetSpec;
  /// Whether to add additional category filters on the `similar-items` model. If not specified, we enable it by default. Allowed values are: * `no-category-match`: No additional filtering of original results from the model and the customer's filters. * `relaxed-category-match`: Only keep results with categories that match at least one item categories in the PredictRequests's context item. * If customer also sends filters in the PredictRequest, then the results will satisfy both conditions (user given and category match). Can only be set if solution_types is SOLUTION_TYPE_RECOMMENDATION.
  late final pulumi.Output<String> enableCategoryFilterLevel;
  /// Facet specifications for faceted search. If empty, no facets are returned. The ids refer to the ids of Control resources with only the Facet control set. These controls are assumed to be in the same Catalog as the ServingConfig. A maximum of 100 values are allowed. Otherwise, an INVALID_ARGUMENT error is returned. Can only be set if solution_types is SOLUTION_TYPE_SEARCH.
  late final pulumi.Output<List<String>> facetControlIds;
  ...
  late final pulumi.Output<List<String>> ignoreControlIds;
  ...
  late final pulumi.Output<List<String>> onewaySynonymsControlIds;
  ...
  late final pulumi.Output<GoogleCloudRetailV2alphaSearchRequestPersonalizationSpecResponse> personalizationSpec;
  ...
  late final pulumi.Output<String> priceRerankingLevel;
  ...
  late final pulumi.Output<List<String>> replacementControlIds;
  ...
  late final pulumi.Output<List<String>> twowaySynonymsControlIds;

  /// Creates a new [ServingConfigRetailV2alpha].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ServingConfigRetailV2alpha]. {@macro pulumi_retail_v2alpha_serving_config_retail_v2alpha_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  ServingConfigRetailV2alpha(
    String name, {
    ServingConfigRetailV2alphaArgs? args,
    ...
    diversityLevel = registerOutput<String>('diversityLevel');
    diversityType = registerOutput<String>('diversityType');
    doNotAssociateControlIds = registerOutput<List<String>>('doNotAssociateControlIds');
    dynamicFacetSpec = registerOutput<GoogleCloudRetailV2alphaSearchRequestDynamicFacetSpecResponse>('dynamicFacetSpec', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return GoogleCloudRetailV2alphaSearchRequestDynamicFacetSpecResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    enableCategoryFilterLevel = registerOutput<String>('enableCategoryFilterLevel');
    facetControlIds = registerOutput<List<String>>('facetControlIds');
    filterControlIds = registerOutput<List<String>>('filterControlIds');
    ignoreControlIds = registerOutput<List<String>>('ignoreControlIds');
    location = registerOutput<String>('location');
    modelId = registerOutput<String>('modelId');
    this.name = registerOutput<String>('name');
    onewaySynonymsControlIds = registerOutput<List<String>>('onewaySynonymsControlIds');
    personalizationSpec = registerOutput<GoogleCloudRetailV2alphaSearchRequestPersonalizationSpecResponse>('personalizationSpec', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return GoogleCloudRetailV2alphaSearchRequestPersonalizationSpecResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    replacementControlIds = registerOutput<List<String>>('replacementControlIds');
    servingConfigId = registerOutput<String>('servingConfigId');
    solutionTypes = registerOutput<List<String>>('solutionTypes');
    twowaySynonymsControlIds = registerOutput<List<String>>('twowaySynonymsControlIds');
  }
}
