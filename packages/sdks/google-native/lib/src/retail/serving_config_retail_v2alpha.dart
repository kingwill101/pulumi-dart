...
class ServingConfigRetailV2alpha extends pulumi.CustomResource {
  ...
  ServingConfigRetailV2alpha(
    ...
    doNotAssociateControlIds = registerOutput<List<String>>(
    ...
    dynamicFacetSpec =
        ...
        >(
          ...
          decoder: (raw) {
            ...
            return GoogleCloudRetailV2alphaSearchRequestDynamicFacetSpecResponse.fromMap(
    ...
    onewaySynonymsControlIds = registerOutput<List<String>>(
    ...
    personalizationSpec =
        ...
        >(
          ...
          decoder: (raw) {
            final guardedValue = raw;
            if (guardedValue == null) return null;
            return GoogleCloudRetailV2alphaSearchRequestPersonalizationSpecResponse.fromMap(
              (guardedValue as Map).cast<String, dynamic>(),
            );
          },
        );
