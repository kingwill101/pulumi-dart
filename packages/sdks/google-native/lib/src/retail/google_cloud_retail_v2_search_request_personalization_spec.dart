...
class GoogleCloudRetailV2SearchRequestPersonalizationSpec {
  ...
  const GoogleCloudRetailV2SearchRequestPersonalizationSpec({
    this.mode,
  });

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'mode': ?pulumi.Input.mapOptionalInputValue<GoogleCloudRetailV2SearchRequestPersonalizationSpecMode, String>(mode, (value) => value.wireValue),
    };
  }
  ...
  factory GoogleCloudRetailV2SearchRequestPersonalizationSpec.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2SearchRequestPersonalizationSpec(
      mode: (() { final guardedValue = map['mode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudRetailV2SearchRequestPersonalizationSpecMode.fromValue(guardedValue as String)); })(),
    );
  }
}
