...
class GoogleCloudRetailV2betaPriceInfoResponse {
  ...
  final pulumi.Input<GoogleCloudRetailV2betaPriceInfoPriceRangeResponse> priceRange;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'priceRange': pulumi.Input.mapInputValue<GoogleCloudRetailV2betaPriceInfoPriceRangeResponse, Map<String, dynamic>>(priceRange, (value) => value.toMap()),
    };
  }

  factory GoogleCloudRetailV2betaPriceInfoResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2betaPriceInfoResponse(
      ...
      priceRange: (GoogleCloudRetailV2betaPriceInfoPriceRangeResponse.fromMap((map['priceRange'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
