...
class GoogleCloudRetailV2alphaModelPageOptimizationConfig {
  ...
  final pulumi.Input<
    List<GoogleCloudRetailV2alphaModelPageOptimizationConfigPanel>
  >
  panels;
    ...
    return <String, dynamic>{
      ...
      'restriction':
          ?pulumi.Input.mapOptionalInputValue<
            GoogleCloudRetailV2alphaModelPageOptimizationConfigRestriction,
            String
          >(restriction, (value) => value.wireValue),
    };
  }
  ...
  factory GoogleCloudRetailV2alphaModelPageOptimizationConfig.fromMap(
    ...
    return GoogleCloudRetailV2alphaModelPageOptimizationConfig(
      pageOptimizationEventType: pulumi.Input.fromValue(
        map['pageOptimizationEventType'] as String,
      ),
      panels: pulumi.Input.fromValue(
      ...
      restriction: (() {
        final guardedValue = map['restriction'];
