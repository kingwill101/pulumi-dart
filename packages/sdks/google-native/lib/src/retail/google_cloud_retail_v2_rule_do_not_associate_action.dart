...
class GoogleCloudRetailV2RuleDoNotAssociateAction {
  ...
  /// Creates a new [GoogleCloudRetailV2RuleDoNotAssociateAction].
  ...
  const GoogleCloudRetailV2RuleDoNotAssociateAction({
  ...
  factory GoogleCloudRetailV2RuleDoNotAssociateAction.fromMap(Map<String, dynamic> map) {
