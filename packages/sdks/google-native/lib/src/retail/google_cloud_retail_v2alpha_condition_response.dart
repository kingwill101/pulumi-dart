...
class GoogleCloudRetailV2alphaConditionResponse {
  ...
  final pulumi.Input<List<GoogleCloudRetailV2alphaConditionTimeRangeResponse>>
  activeTimeRange;
  ...
  final pulumi.Input<List<GoogleCloudRetailV2alphaConditionQueryTermResponse>>
  queryTerms;
    ...
    return <String, dynamic>{
      'activeTimeRange':
          pulumi.Input.mapInputValue<
            List<GoogleCloudRetailV2alphaConditionTimeRangeResponse>,
      ...
      'queryTerms':
          pulumi.Input.mapInputValue<
            List<GoogleCloudRetailV2alphaConditionQueryTermResponse>,
            List<Map<String, dynamic>>
          >(
            queryTerms,
            (value) =>
