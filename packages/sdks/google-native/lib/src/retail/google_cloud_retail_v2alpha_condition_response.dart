...
class GoogleCloudRetailV2alphaConditionResponse {
  ...
  factory GoogleCloudRetailV2alphaConditionResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2alphaConditionResponse(
      activeTimeRange: (pulumi.Input.decodeList<GoogleCloudRetailV2alphaConditionTimeRangeResponse>(map['activeTimeRange'], (value) => GoogleCloudRetailV2alphaConditionTimeRangeResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      pageCategories: ((map['pageCategories'] as List).cast<String>()).input(),
      queryTerms: (pulumi.Input.decodeList<GoogleCloudRetailV2alphaConditionQueryTermResponse>(map['queryTerms'], (value) => GoogleCloudRetailV2alphaConditionQueryTermResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
