...
class GoogleCloudRetailV2PromotionResponse {
  ...
  /// Creates a new [GoogleCloudRetailV2PromotionResponse].
  ...
  const GoogleCloudRetailV2PromotionResponse({
  ...
  factory GoogleCloudRetailV2PromotionResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRetailV2PromotionResponse(
