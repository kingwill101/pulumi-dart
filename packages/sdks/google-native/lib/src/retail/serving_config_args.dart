...
class ServingConfigArgs {
  ...
  ServingConfigArgs({
    ...
    pulumi.Output<ServingConfigDiversityType>? diversityType,
    pulumi.Output<List<String>>? doNotAssociateControlIds,
    pulumi.Output<GoogleCloudRetailV2SearchRequestDynamicFacetSpec>? dynamicFacetSpec,
    ...
    pulumi.Output<GoogleCloudRetailV2SearchRequestPersonalizationSpec>? personalizationSpec,
    ...
    required pulumi.Output<List<ServingConfigSolutionTypesItem>> solutionTypes,
  ...
  factory ServingConfigArgs.fromMap(Map<String, dynamic> map) {
    return ServingConfigArgs(
      ...
      diversityType: map['diversityType'] == null ? null : pulumi.Output.create<ServingConfigDiversityType>(ServingConfigDiversityType.fromValue(map['diversityType'] as String)),
      ...
      dynamicFacetSpec: map['dynamicFacetSpec'] == null ? null : pulumi.Output.create<GoogleCloudRetailV2SearchRequestDynamicFacetSpec>(GoogleCloudRetailV2SearchRequestDynamicFacetSpec.fromMap((map['dynamicFacetSpec'] as Map).cast<String, dynamic>())),
      ...
      personalizationSpec: map['personalizationSpec'] == null ? null : pulumi.Output.create<GoogleCloudRetailV2SearchRequestPersonalizationSpec>(GoogleCloudRetailV2SearchRequestPersonalizationSpec.fromMap((map['personalizationSpec'] as Map).cast<String, dynamic>())),
      ...
      solutionTypes: pulumi.Output.create<List<ServingConfigSolutionTypesItem>>(pulumi.Input.decodeList<ServingConfigSolutionTypesItem>(map['solutionTypes'], (value) => ServingConfigSolutionTypesItem.fromValue(value as String))),
