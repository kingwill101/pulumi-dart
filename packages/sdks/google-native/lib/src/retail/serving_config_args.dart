...
class ServingConfigArgs {
  ...
  factory ServingConfigArgs.fromMap(Map<String, dynamic> map) {
    return ServingConfigArgs(
      ...
      diversityType: map['diversityType'] == null ? null : (ServingConfigDiversityType.fromValue(map['diversityType']! as String)).input(),
      doNotAssociateControlIds: map['doNotAssociateControlIds'] == null ? null : ((map['doNotAssociateControlIds']! as List).cast<String>()).input(),
      dynamicFacetSpec: map['dynamicFacetSpec'] == null ? null : (GoogleCloudRetailV2SearchRequestDynamicFacetSpec.fromMap((map['dynamicFacetSpec']! as Map).cast<String, dynamic>())).input(),
      ...
      personalizationSpec: map['personalizationSpec'] == null ? null : (GoogleCloudRetailV2SearchRequestPersonalizationSpec.fromMap((map['personalizationSpec']! as Map).cast<String, dynamic>())).input(),
      ...
      solutionTypes: (pulumi.Input.decodeList<ServingConfigSolutionTypesItem>(map['solutionTypes'], (value) => ServingConfigSolutionTypesItem.fromValue(value as String))).input(),
