...
class GoogleCloudRetailV2RuleRemoveFacetActionResponse {
  ...
  /// Creates a new [GoogleCloudRetailV2RuleRemoveFacetActionResponse].
  ...
  const GoogleCloudRetailV2RuleRemoveFacetActionResponse({
