...
class Runtime extends pulumi.CustomResource {
  ...
  Runtime(
    ...
    this.accessConfig = registerOutput<RuntimeAccessConfigResponse>('accessConfig');
    ...
    this.runtimeMigrationEligibility = registerOutput<RuntimeMigrationEligibilityResponse>('runtimeMigrationEligibility');
    this.softwareConfig = registerOutput<RuntimeSoftwareConfigResponse>('softwareConfig');
    this.state = registerOutput<String>('state');
    this.updateTime = registerOutput<String>('updateTime');
    this.virtualMachine = registerOutput<VirtualMachineResponse>('virtualMachine');
  }
}
