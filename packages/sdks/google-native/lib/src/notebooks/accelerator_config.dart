...
class AcceleratorConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'coreCount': ?coreCount,
      'type': ?pulumi.Input.mapOptionalInputValue<AcceleratorConfigType, String>(type, (value) => value.wireValue),
    };
  }
  ...
  factory AcceleratorConfig.fromMap(Map<String, dynamic> map) {
    return AcceleratorConfig(
      ...
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AcceleratorConfigType.fromValue(guardedValue as String)); })(),
    );
  }
}
