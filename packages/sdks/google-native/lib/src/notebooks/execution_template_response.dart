  ...
  factory ExecutionTemplateResponse.fromMap(Map<String, dynamic> map) {
    return ExecutionTemplateResponse(
      acceleratorConfig: pulumi.Input.fromValue(
        SchedulerAcceleratorConfigResponse.fromMap(
          (map['acceleratorConfig']! as Map).cast<String, dynamic>(),
        ),
      ),
      containerImageUri: pulumi.Input.fromValue(
        map['containerImageUri'] as String,
      ),
      dataprocParameters: pulumi.Input.fromValue(
        DataprocParametersResponse.fromMap(
          (map['dataprocParameters']! as Map).cast<String, dynamic>(),
        ),
      ),
      inputNotebookFile: pulumi.Input.fromValue(
      ...
      outputNotebookFolder: pulumi.Input.fromValue(
      ...
      vertexAiParameters: pulumi.Input.fromValue(
        VertexAIParametersResponse.fromMap(
