...
class ExecutionTemplateResponse {
  ...
  factory ExecutionTemplateResponse.fromMap(Map<String, dynamic> map) {
    return ExecutionTemplateResponse(
      acceleratorConfig: SchedulerAcceleratorConfigResponse.fromMap((map['acceleratorConfig'] as Map).cast<String, dynamic>()),
      containerImageUri: map['containerImageUri'] as String,
      dataprocParameters: DataprocParametersResponse.fromMap((map['dataprocParameters'] as Map).cast<String, dynamic>()),
      ...
      vertexAiParameters: VertexAIParametersResponse.fromMap((map['vertexAiParameters'] as Map).cast<String, dynamic>()),
    );
  }
}
