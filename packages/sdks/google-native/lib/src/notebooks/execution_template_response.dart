...
class ExecutionTemplateResponse {
  ...
  const ExecutionTemplateResponse({
  ...
  factory ExecutionTemplateResponse.fromMap(Map<String, dynamic> map) {
    return ExecutionTemplateResponse(
      acceleratorConfig: pulumi.Input.fromValue(SchedulerAcceleratorConfigResponse.fromMap((map['acceleratorConfig']! as Map).cast<String, dynamic>())),
      containerImageUri: pulumi.Input.fromValue(map['containerImageUri'] as String),
      dataprocParameters: pulumi.Input.fromValue(DataprocParametersResponse.fromMap((map['dataprocParameters']! as Map).cast<String, dynamic>())),
      inputNotebookFile: pulumi.Input.fromValue(map['inputNotebookFile'] as String),
      jobType: pulumi.Input.fromValue(map['jobType'] as String),
      kernelSpec: pulumi.Input.fromValue(map['kernelSpec'] as String),
      labels: pulumi.Input.fromValue((map['labels'] as Map).cast<String, String>()),
      masterType: pulumi.Input.fromValue(map['masterType'] as String),
      outputNotebookFolder: pulumi.Input.fromValue(map['outputNotebookFolder'] as String),
      parameters: pulumi.Input.fromValue(map['parameters'] as String),
      paramsYamlFile: pulumi.Input.fromValue(map['paramsYamlFile'] as String),
      ...
      vertexAiParameters: pulumi.Input.fromValue(VertexAIParametersResponse.fromMap((map['vertexAiParameters']! as Map).cast<String, dynamic>())),
    );
  }
}
