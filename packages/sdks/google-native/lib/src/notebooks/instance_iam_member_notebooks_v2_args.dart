...
/// {@template pulumi_notebooks_v2_instance_iam_member_notebooks_v2_args_doc}
/// The set of arguments for InstanceIamMember.
/// {@endtemplate}
/// {@macro pulumi_notebooks_v2_instance_iam_member_notebooks_v2_args_doc}
class InstanceIamMemberNotebooksV2Args {
  ...
  /// Creates a new [InstanceIamMemberNotebooksV2Args].
  ...
  const InstanceIamMemberNotebooksV2Args({
    this.condition,
  ...
  factory InstanceIamMemberNotebooksV2Args.fromMap(Map<String, dynamic> map) {
    return InstanceIamMemberNotebooksV2Args(
