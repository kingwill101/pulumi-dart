...
class LocalDiskResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'guestOsFeatures': pulumi.Input.mapInputValue<List<RuntimeGuestOsFeatureResponse>, List<Map<String, dynamic>>>(guestOsFeatures, (value) => pulumi.Input.encodeList<RuntimeGuestOsFeatureResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'index': index,
      'initializeParams': pulumi.Input.mapInputValue<LocalDiskInitializeParamsResponse, Map<String, dynamic>>(initializeParams, (value) => value.toMap()),
      'interface': interface,
      'kind': kind,
      'licenses': licenses,
      'mode': mode,
  ...
  factory LocalDiskResponse.fromMap(Map<String, dynamic> map) {
    return LocalDiskResponse(
      ...
      guestOsFeatures: pulumi.Input.fromValue(pulumi.Input.decodeList<RuntimeGuestOsFeatureResponse>(map['guestOsFeatures']!, (value) => RuntimeGuestOsFeatureResponse.fromMap((value as Map).cast<String, dynamic>()))),
      index: pulumi.Input.fromValue(map['index'] as int),
      initializeParams: pulumi.Input.fromValue(LocalDiskInitializeParamsResponse.fromMap((map['initializeParams']! as Map).cast<String, dynamic>())),
