...
class LocalDiskResponse {
  ...
  factory LocalDiskResponse.fromMap(Map<String, dynamic> map) {
    return LocalDiskResponse(
      ...
      guestOsFeatures: (pulumi.Input.decodeList<RuntimeGuestOsFeatureResponse>(map['guestOsFeatures'], (value) => RuntimeGuestOsFeatureResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      index: (map['index'] as int).input(),
      initializeParams: (LocalDiskInitializeParamsResponse.fromMap((map['initializeParams'] as Map).cast<String, dynamic>())).input(),
