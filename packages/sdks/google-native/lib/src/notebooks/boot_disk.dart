...
class BootDisk {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'diskEncryption':
          ?pulumi.Input.mapOptionalInputValue<BootDiskDiskEncryption, String>(
            diskEncryption,
            (value) => value.wireValue,
          ),
      'diskSizeGb': ?diskSizeGb,
      'diskType': ?pulumi.Input.mapOptionalInputValue<BootDiskDiskType, String>(
        diskType,
        (value) => value.wireValue,
      ),
      'kmsKey': ?kmsKey,
    ...
    return BootDisk(
      diskEncryption: (() {
        ...
        return pulumi.Input.fromValue(
          BootDiskDiskEncryption.fromValue(guardedValue as String),
        );
      })(),
      diskSizeGb: (() {
      ...
      diskType: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          BootDiskDiskType.fromValue(guardedValue as String),
        );
      })(),
      kmsKey: (() {
