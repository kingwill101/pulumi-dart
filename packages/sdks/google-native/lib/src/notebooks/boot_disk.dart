...
class BootDisk {
  ...
  factory BootDisk.fromMap(Map<String, dynamic> map) {
    return BootDisk(
      diskEncryption: map['diskEncryption'] == null ? null : BootDiskDiskEncryption.fromValue(map['diskEncryption'] as String),
      diskSizeGb: map['diskSizeGb'] == null ? null : map['diskSizeGb'] as String,
      diskType: map['diskType'] == null ? null : BootDiskDiskType.fromValue(map['diskType'] as String),
