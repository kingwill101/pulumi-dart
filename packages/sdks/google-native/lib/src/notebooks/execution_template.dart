...
class ExecutionTemplate {
    ...
    return <String, dynamic>{
      ...
      'dataprocParameters':
          ?pulumi.Input.mapOptionalInputValue<
            DataprocParameters,
            Map<String, dynamic>
          >(dataprocParameters, (value) => value.toMap()),
      'inputNotebookFile': ?inputNotebookFile,
      'jobType':
          ?pulumi.Input.mapOptionalInputValue<ExecutionTemplateJobType, String>(
            jobType,
      ...
      'scaleTier':
          pulumi.Input.mapInputValue<ExecutionTemplateScaleTier, String>(
            scaleTier,
            (value) => value.wireValue,
          ),
      ...
      'vertexAiParameters':
          ?pulumi.Input.mapOptionalInputValue<
            VertexAIParameters,
            Map<String, dynamic>
          >(vertexAiParameters, (value) => value.toMap()),
    };
  }
  ...
  factory ExecutionTemplate.fromMap(Map<String, dynamic> map) {
    return ExecutionTemplate(
      ...
      dataprocParameters: (() {
        final guardedValue = map['dataprocParameters'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      inputNotebookFile: (() {
        final guardedValue = map['inputNotebookFile'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      jobType: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ExecutionTemplateJobType.fromValue(guardedValue as String),
        );
      })(),
      kernelSpec: (() {
        final guardedValue = map['kernelSpec'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      labels: (() {
      ...
      masterType: (() {
        final guardedValue = map['masterType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      outputNotebookFolder: (() {
        final guardedValue = map['outputNotebookFolder'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      parameters: (() {
      ...
      paramsYamlFile: (() {
        final guardedValue = map['paramsYamlFile'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      scaleTier: pulumi.Input.fromValue(
      ...
      tensorboard: (() {
        final guardedValue = map['tensorboard'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      vertexAiParameters: (() {
        final guardedValue = map['vertexAiParameters'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
