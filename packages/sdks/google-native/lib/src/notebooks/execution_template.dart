...
class ExecutionTemplate {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'jobType': ?pulumi.Input.mapOptionalInputValue<ExecutionTemplateJobType, String>(jobType, (value) => value.value),
      ...
      'scaleTier': pulumi.Input.mapInputValue<ExecutionTemplateScaleTier, String>(scaleTier, (value) => value.value),
