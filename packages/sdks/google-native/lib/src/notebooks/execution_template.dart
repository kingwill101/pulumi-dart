...
class ExecutionTemplate {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'dataprocParameters': ?dataprocParameters == null ? null : dataprocParameters!.toMap(),
      ...
      'vertexAiParameters': ?vertexAiParameters == null ? null : vertexAiParameters!.toMap(),
    };
  }

  factory ExecutionTemplate.fromMap(Map<String, dynamic> map) {
    return ExecutionTemplate(
      acceleratorConfig: map['acceleratorConfig'] == null ? null : SchedulerAcceleratorConfig.fromMap((map['acceleratorConfig'] as Map).cast<String, dynamic>()),
      containerImageUri: map['containerImageUri'] == null ? null : map['containerImageUri'] as String,
      dataprocParameters: map['dataprocParameters'] == null ? null : DataprocParameters.fromMap((map['dataprocParameters'] as Map).cast<String, dynamic>()),
      inputNotebookFile: map['inputNotebookFile'] == null ? null : map['inputNotebookFile'] as String,
      jobType: map['jobType'] == null ? null : ExecutionTemplateJobType.fromValue(map['jobType'] as String),
      kernelSpec: map['kernelSpec'] == null ? null : map['kernelSpec'] as String,
      labels: map['labels'] == null ? null : (map['labels'] as Map).cast<String, String>(),
      masterType: map['masterType'] == null ? null : map['masterType'] as String,
      outputNotebookFolder: map['outputNotebookFolder'] == null ? null : map['outputNotebookFolder'] as String,
      parameters: map['parameters'] == null ? null : map['parameters'] as String,
      paramsYamlFile: map['paramsYamlFile'] == null ? null : map['paramsYamlFile'] as String,
      scaleTier: ExecutionTemplateScaleTier.fromValue(map['scaleTier'] as String),
      ...
      vertexAiParameters: map['vertexAiParameters'] == null ? null : VertexAIParameters.fromMap((map['vertexAiParameters'] as Map).cast<String, dynamic>()),
    );
  }
}
