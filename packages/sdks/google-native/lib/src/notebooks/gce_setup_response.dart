...
class GceSetupResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'acceleratorConfigs': pulumi.Input.encodeList<AcceleratorConfigResponseNotebooksV2, Map<String, dynamic>>(acceleratorConfigs, (value) => value.toMap()),
      'bootDisk': bootDisk.toMap(),
      'containerImage': containerImage.toMap(),
      'dataDisks': pulumi.Input.encodeList<DataDiskResponse, Map<String, dynamic>>(dataDisks, (value) => value.toMap()),
  ...
  factory GceSetupResponse.fromMap(Map<String, dynamic> map) {
    return GceSetupResponse(
      acceleratorConfigs: pulumi.Input.decodeList<AcceleratorConfigResponseNotebooksV2>(map['acceleratorConfigs'], (value) => AcceleratorConfigResponseNotebooksV2.fromMap((value as Map).cast<String, dynamic>())),
      bootDisk: BootDiskResponse.fromMap((map['bootDisk'] as Map).cast<String, dynamic>()),
      containerImage: ContainerImageResponseNotebooksV2.fromMap((map['containerImage'] as Map).cast<String, dynamic>()),
      dataDisks: pulumi.Input.decodeList<DataDiskResponse>(map['dataDisks'], (value) => DataDiskResponse.fromMap((value as Map).cast<String, dynamic>())),
      disablePublicIp: map['disablePublicIp'] as bool,
      enableIpForwarding: map['enableIpForwarding'] as bool,
      gpuDriverConfig: GPUDriverConfigResponse.fromMap((map['gpuDriverConfig'] as Map).cast<String, dynamic>()),
      ...
      shieldedInstanceConfig: ShieldedInstanceConfigResponseNotebooksV2.fromMap((map['shieldedInstanceConfig'] as Map).cast<String, dynamic>()),
      tags: (map['tags'] as List).cast<String>(),
      vmImage: VmImageResponseNotebooksV2.fromMap((map['vmImage'] as Map).cast<String, dynamic>()),
    );
  }
}
