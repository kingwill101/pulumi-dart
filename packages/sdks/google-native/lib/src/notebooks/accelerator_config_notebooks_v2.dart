...
class AcceleratorConfigNotebooksV2 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'coreCount': ?coreCount,
      'type': ?pulumi.Input.mapOptionalInputValue<AcceleratorConfigTypeNotebooksV2, String>(type, (value) => value.wireValue),
    };
  }
  ...
  factory AcceleratorConfigNotebooksV2.fromMap(Map<String, dynamic> map) {
    return AcceleratorConfigNotebooksV2(
      ...
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AcceleratorConfigTypeNotebooksV2.fromValue(guardedValue as String)); })(),
    );
  }
}
