...
class UpgradeHistoryEntry {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'snapshot': ?snapshot,
      'state':
          ?pulumi.Input.mapOptionalInputValue<UpgradeHistoryEntryState, String>(
            state,
    ...
    return UpgradeHistoryEntry(
      action: (() {
        ...
        return pulumi.Input.fromValue(
          UpgradeHistoryEntryAction.fromValue(guardedValue as String),
        );
      })(),
      containerImage: (() {
      ...
      state: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          UpgradeHistoryEntryState.fromValue(guardedValue as String),
        );
      })(),
      targetImage: (() {
