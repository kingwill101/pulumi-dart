...
class InstanceArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'bootDiskType': ?pulumi.Input.mapOptionalInputValue<InstanceBootDiskType, String>(bootDiskType, (value) => value.wireValue),
      ...
      'dataDiskType': ?pulumi.Input.mapOptionalInputValue<InstanceDataDiskType, String>(dataDiskType, (value) => value.wireValue),
      'diskEncryption': ?pulumi.Input.mapOptionalInputValue<InstanceDiskEncryption, String>(diskEncryption, (value) => value.wireValue),
      ...
      'metadata': ?metadata,
      'network': ?network,
      'nicType': ?pulumi.Input.mapOptionalInputValue<InstanceNicType, String>(nicType, (value) => value.wireValue),
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      ...
      bootDiskSizeGb: (() { final guardedValue = map['bootDiskSizeGb']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      bootDiskType: (() { final guardedValue = map['bootDiskType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceBootDiskType.fromValue(guardedValue as String)); })(),
      ...
      dataDiskType: (() { final guardedValue = map['dataDiskType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceDataDiskType.fromValue(guardedValue as String)); })(),
      diskEncryption: (() { final guardedValue = map['diskEncryption']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceDiskEncryption.fromValue(guardedValue as String)); })(),
      ...
      nicType: (() { final guardedValue = map['nicType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceNicType.fromValue(guardedValue as String)); })(),
      ...
      upgradeHistory: (() { final guardedValue = map['upgradeHistory']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<UpgradeHistoryEntry>(guardedValue, (value) => UpgradeHistoryEntry.fromMap((value as Map).cast<String, dynamic>()))); })(),
