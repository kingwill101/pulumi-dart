...
class InstanceArgs {
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      acceleratorConfig: map['acceleratorConfig'] == null ? null : (AcceleratorConfig.fromMap((map['acceleratorConfig']! as Map).cast<String, dynamic>())).input(),
      bootDiskSizeGb: map['bootDiskSizeGb'] == null ? null : (map['bootDiskSizeGb']! as String).input(),
      bootDiskType: map['bootDiskType'] == null ? null : (InstanceBootDiskType.fromValue(map['bootDiskType']! as String)).input(),
      ...
      dataDiskType: map['dataDiskType'] == null ? null : (InstanceDataDiskType.fromValue(map['dataDiskType']! as String)).input(),
      diskEncryption: map['diskEncryption'] == null ? null : (InstanceDiskEncryption.fromValue(map['diskEncryption']! as String)).input(),
      ...
      nicType: map['nicType'] == null ? null : (InstanceNicType.fromValue(map['nicType']! as String)).input(),
      ...
      upgradeHistory: map['upgradeHistory'] == null ? null : (pulumi.Input.decodeList<UpgradeHistoryEntry>(map['upgradeHistory']!, (value) => UpgradeHistoryEntry.fromMap((value as Map).cast<String, dynamic>()))).input(),
