...
class InstanceArgs {
  ...
  InstanceArgs({
    pulumi.Output<AcceleratorConfig>? acceleratorConfig,
    pulumi.Output<String>? bootDiskSizeGb,
    pulumi.Output<InstanceBootDiskType>? bootDiskType,
    pulumi.Output<bool>? canIpForward,
    pulumi.Output<ContainerImage>? containerImage,
    pulumi.Output<String>? customGpuDriverPath,
    pulumi.Output<String>? dataDiskSizeGb,
    pulumi.Output<InstanceDataDiskType>? dataDiskType,
    pulumi.Output<InstanceDiskEncryption>? diskEncryption,
    ...
    pulumi.Output<InstanceNicType>? nicType,
    ...
    pulumi.Output<ReservationAffinity>? reservationAffinity,
    pulumi.Output<String>? serviceAccount,
    pulumi.Output<List<String>>? serviceAccountScopes,
    pulumi.Output<ShieldedInstanceConfig>? shieldedInstanceConfig,
    pulumi.Output<String>? subnet,
    pulumi.Output<List<String>>? tags,
    pulumi.Output<List<UpgradeHistoryEntry>>? upgradeHistory,
    pulumi.Output<VmImage>? vmImage,
  }) :
      ...
      bootDiskType = pulumi.Input.asOptionalInput<InstanceBootDiskType>(bootDiskType),
      canIpForward = pulumi.Input.asOptionalInput<bool>(canIpForward),
      containerImage = pulumi.Input.asOptionalInput<ContainerImage>(containerImage),
      ...
      dataDiskType = pulumi.Input.asOptionalInput<InstanceDataDiskType>(dataDiskType),
      diskEncryption = pulumi.Input.asOptionalInput<InstanceDiskEncryption>(diskEncryption),
      ...
      upgradeHistory = pulumi.Input.asOptionalInput<List<UpgradeHistoryEntry>>(upgradeHistory),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'bootDiskType': ?pulumi.Input.mapOptionalInputValue<InstanceBootDiskType, String>(bootDiskType, (value) => value.value),
      ...
      'dataDiskType': ?pulumi.Input.mapOptionalInputValue<InstanceDataDiskType, String>(dataDiskType, (value) => value.value),
      'diskEncryption': ?pulumi.Input.mapOptionalInputValue<InstanceDiskEncryption, String>(diskEncryption, (value) => value.value),
      ...
      'metadata': ?metadata,
      'network': ?network,
      'nicType': ?pulumi.Input.mapOptionalInputValue<InstanceNicType, String>(nicType, (value) => value.value),
      ...
      'subnet': ?subnet,
      'tags': ?tags,
      'upgradeHistory': ?pulumi.Input.mapOptionalInputValue<List<UpgradeHistoryEntry>, List<Map<String, dynamic>>>(upgradeHistory, (value) => pulumi.Input.encodeList<UpgradeHistoryEntry, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      acceleratorConfig: map['acceleratorConfig'] == null ? null : pulumi.Output.create<AcceleratorConfig>(AcceleratorConfig.fromMap((map['acceleratorConfig'] as Map).cast<String, dynamic>())),
      bootDiskSizeGb: map['bootDiskSizeGb'] == null ? null : pulumi.Output.create<String>(map['bootDiskSizeGb'] as String),
      bootDiskType: map['bootDiskType'] == null ? null : pulumi.Output.create<InstanceBootDiskType>(InstanceBootDiskType.fromValue(map['bootDiskType'] as String)),
      canIpForward: map['canIpForward'] == null ? null : pulumi.Output.create<bool>(map['canIpForward'] as bool),
      containerImage: map['containerImage'] == null ? null : pulumi.Output.create<ContainerImage>(ContainerImage.fromMap((map['containerImage'] as Map).cast<String, dynamic>())),
      customGpuDriverPath: map['customGpuDriverPath'] == null ? null : pulumi.Output.create<String>(map['customGpuDriverPath'] as String),
      dataDiskSizeGb: map['dataDiskSizeGb'] == null ? null : pulumi.Output.create<String>(map['dataDiskSizeGb'] as String),
      dataDiskType: map['dataDiskType'] == null ? null : pulumi.Output.create<InstanceDataDiskType>(InstanceDataDiskType.fromValue(map['dataDiskType'] as String)),
      diskEncryption: map['diskEncryption'] == null ? null : pulumi.Output.create<InstanceDiskEncryption>(InstanceDiskEncryption.fromValue(map['diskEncryption'] as String)),
      ...
      nicType: map['nicType'] == null ? null : pulumi.Output.create<InstanceNicType>(InstanceNicType.fromValue(map['nicType'] as String)),
      ...
      reservationAffinity: map['reservationAffinity'] == null ? null : pulumi.Output.create<ReservationAffinity>(ReservationAffinity.fromMap((map['reservationAffinity'] as Map).cast<String, dynamic>())),
      ...
      shieldedInstanceConfig: map['shieldedInstanceConfig'] == null ? null : pulumi.Output.create<ShieldedInstanceConfig>(ShieldedInstanceConfig.fromMap((map['shieldedInstanceConfig'] as Map).cast<String, dynamic>())),
      subnet: map['subnet'] == null ? null : pulumi.Output.create<String>(map['subnet'] as String),
      tags: map['tags'] == null ? null : pulumi.Output.create<List<String>>((map['tags'] as List).cast<String>()),
      upgradeHistory: map['upgradeHistory'] == null ? null : pulumi.Output.create<List<UpgradeHistoryEntry>>(pulumi.Input.decodeList<UpgradeHistoryEntry>(map['upgradeHistory'], (value) => UpgradeHistoryEntry.fromMap((value as Map).cast<String, dynamic>()))),
      vmImage: map['vmImage'] == null ? null : pulumi.Output.create<VmImage>(VmImage.fromMap((map['vmImage'] as Map).cast<String, dynamic>())),
    );
  }
}
