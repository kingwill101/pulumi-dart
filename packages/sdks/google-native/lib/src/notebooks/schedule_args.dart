...
class ScheduleArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'state': ?pulumi.Input.mapOptionalInputValue<ScheduleState, String>(state, (value) => value.wireValue),
      'timeZone': ?timeZone,
    };
  }
  ...
  factory ScheduleArgs.fromMap(Map<String, dynamic> map) {
    return ScheduleArgs(
      ...
      state: (() { final guardedValue = map['state']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ScheduleState.fromValue(guardedValue as String)); })(),
