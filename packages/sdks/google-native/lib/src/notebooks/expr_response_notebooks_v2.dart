...
class ExprResponseNotebooksV2 {
  ...
  /// Creates a new [ExprResponseNotebooksV2].
  ...
  factory ExprResponseNotebooksV2.fromMap(Map<String, dynamic> map) {
    return ExprResponseNotebooksV2(
