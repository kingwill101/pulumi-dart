...
class VirtualMachineConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'dataDisk': pulumi.Input.mapInputValue<LocalDisk, Map<String, dynamic>>(
        dataDisk,
        (value) => value.toMap(),
      ),
      'encryptionConfig':
  ...
  factory VirtualMachineConfig.fromMap(Map<String, dynamic> map) {
    return VirtualMachineConfig(
      ...
      bootImage: (() {
        final guardedValue = map['bootImage'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      ...
      nicType: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VirtualMachineConfigNicType.fromValue(guardedValue as String),
        );
      })(),
      reservedIpRange: (() {
