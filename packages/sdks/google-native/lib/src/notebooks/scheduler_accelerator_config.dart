...
class SchedulerAcceleratorConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'coreCount': ?coreCount,
      'type': ?pulumi.Input.mapOptionalInputValue<SchedulerAcceleratorConfigType, String>(type, (value) => value.wireValue),
    };
  }
  ...
  factory SchedulerAcceleratorConfig.fromMap(Map<String, dynamic> map) {
    return SchedulerAcceleratorConfig(
      ...
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SchedulerAcceleratorConfigType.fromValue(guardedValue as String)); })(),
    );
  }
}
