...
class GceSetup {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'acceleratorConfigs': ?acceleratorConfigs == null ? null : pulumi.Input.encodeList<AcceleratorConfigNotebooksV2, Map<String, dynamic>>(acceleratorConfigs!, (value) => value.toMap()),
      ...
      'gpuDriverConfig': ?gpuDriverConfig == null ? null : gpuDriverConfig!.toMap(),
  ...
  factory GceSetup.fromMap(Map<String, dynamic> map) {
    return GceSetup(
      acceleratorConfigs: map['acceleratorConfigs'] == null ? null : pulumi.Input.decodeList<AcceleratorConfigNotebooksV2>(map['acceleratorConfigs'], (value) => AcceleratorConfigNotebooksV2.fromMap((value as Map).cast<String, dynamic>())),
      bootDisk: map['bootDisk'] == null ? null : BootDisk.fromMap((map['bootDisk'] as Map).cast<String, dynamic>()),
      containerImage: map['containerImage'] == null ? null : ContainerImageNotebooksV2.fromMap((map['containerImage'] as Map).cast<String, dynamic>()),
      ...
      gpuDriverConfig: map['gpuDriverConfig'] == null ? null : GPUDriverConfig.fromMap((map['gpuDriverConfig'] as Map).cast<String, dynamic>()),
      ...
      shieldedInstanceConfig: map['shieldedInstanceConfig'] == null ? null : ShieldedInstanceConfigNotebooksV2.fromMap((map['shieldedInstanceConfig'] as Map).cast<String, dynamic>()),
      tags: map['tags'] == null ? null : (map['tags'] as List).cast<String>(),
      vmImage: map['vmImage'] == null ? null : VmImageNotebooksV2.fromMap((map['vmImage'] as Map).cast<String, dynamic>()),
    );
  }
}
