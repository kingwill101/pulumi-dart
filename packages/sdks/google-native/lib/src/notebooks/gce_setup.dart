...
class GceSetup {
    ...
    return <String, dynamic>{
      'acceleratorConfigs':
          ?pulumi.Input.mapOptionalInputValue<
            List<AcceleratorConfigNotebooksV2>,
      ...
      'bootDisk':
          ?pulumi.Input.mapOptionalInputValue<BootDisk, Map<String, dynamic>>(
            bootDisk,
            (value) => value.toMap(),
          ),
      'containerImage':
  ...
  factory GceSetup.fromMap(Map<String, dynamic> map) {
    return GceSetup(
      acceleratorConfigs: (() {
        final guardedValue = map['acceleratorConfigs'];
      ...
      bootDisk: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          BootDisk.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      containerImage: (() {
      ...
      disablePublicIp: (() {
        final guardedValue = map['disablePublicIp'];
        if (guardedValue == null) return null;
      ...
      gpuDriverConfig: (() {
        final guardedValue = map['gpuDriverConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
