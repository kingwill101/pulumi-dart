...
class GetInstanceResult {
  ...
  /// [disks] Attached disks to notebook instance.
  ...
  /// [instanceMigrationEligibility] Checks how feasible a migration from UmN to WbI is.
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'instanceMigrationEligibility': instanceMigrationEligibility.toMap(),
      ...
      'upgradeHistory': pulumi.Input.encodeList<UpgradeHistoryEntryResponse, Map<String, dynamic>>(upgradeHistory, (value) => value.toMap()),
      'vmImage': vmImage.toMap(),
    };
  }
  ...
  factory GetInstanceResult.fromMap(Map<String, dynamic> map) {
    return GetInstanceResult(
      ...
      containerImage: ContainerImageResponse.fromMap((map['containerImage']! as Map).cast<String, dynamic>()),
      ...
      instanceMigrationEligibility: InstanceMigrationEligibilityResponse.fromMap((map['instanceMigrationEligibility']! as Map).cast<String, dynamic>()),
      ...
      upgradeHistory: pulumi.Input.decodeList<UpgradeHistoryEntryResponse>(map['upgradeHistory']!, (value) => UpgradeHistoryEntryResponse.fromMap((value as Map).cast<String, dynamic>())),
      vmImage: VmImageResponse.fromMap((map['vmImage']! as Map).cast<String, dynamic>()),
    );
  }
}
