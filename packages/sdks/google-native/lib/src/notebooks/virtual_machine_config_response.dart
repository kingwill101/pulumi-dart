...
class VirtualMachineConfigResponse {
  ...
  final pulumi.Input<RuntimeShieldedInstanceConfigResponse>
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'dataDisk':
          pulumi.Input.mapInputValue<LocalDiskResponse, Map<String, dynamic>>(
            dataDisk,
            (value) => value.toMap(),
          ),
      'encryptionConfig':
  ...
  factory VirtualMachineConfigResponse.fromMap(Map<String, dynamic> map) {
    return VirtualMachineConfigResponse(
      acceleratorConfig: pulumi.Input.fromValue(
        RuntimeAcceleratorConfigResponse.fromMap(
          (map['acceleratorConfig']! as Map).cast<String, dynamic>(),
        ),
      ),
      bootImage: pulumi.Input.fromValue(
        (map['bootImage']! as Map).cast<String, dynamic>(),
      ),
      containerImages: pulumi.Input.fromValue(
      ...
      guestAttributes: pulumi.Input.fromValue(
      ...
      shieldedInstanceConfig: pulumi.Input.fromValue(
        RuntimeShieldedInstanceConfigResponse.fromMap(
