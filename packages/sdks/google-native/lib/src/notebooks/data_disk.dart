...
class DataDisk {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'diskEncryption': ?pulumi.Input.mapOptionalInputValue<DataDiskDiskEncryption, String>(diskEncryption, (value) => value.wireValue),
      'diskSizeGb': ?diskSizeGb,
      'diskType': ?pulumi.Input.mapOptionalInputValue<DataDiskDiskType, String>(diskType, (value) => value.wireValue),
      'kmsKey': ?kmsKey,
    };
  }
  ...
  factory DataDisk.fromMap(Map<String, dynamic> map) {
    return DataDisk(
      diskEncryption: (() { final guardedValue = map['diskEncryption']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DataDiskDiskEncryption.fromValue(guardedValue as String)); })(),
      ...
      diskType: (() { final guardedValue = map['diskType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DataDiskDiskType.fromValue(guardedValue as String)); })(),
