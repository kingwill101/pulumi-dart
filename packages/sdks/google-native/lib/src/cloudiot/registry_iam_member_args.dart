...
/// {@template pulumi_cloudiot_v1_registry_iam_member_args_doc}
/// The set of arguments for RegistryIamMember.
/// {@endtemplate}
/// {@macro pulumi_cloudiot_v1_registry_iam_member_args_doc}
class RegistryIamMemberArgs {
  ...
  /// Creates a new [RegistryIamMemberArgs].
  ...
  factory RegistryIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return RegistryIamMemberArgs(
