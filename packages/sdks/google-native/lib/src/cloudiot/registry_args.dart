...
class RegistryArgs {
  ...
  factory RegistryArgs.fromMap(Map<String, dynamic> map) {
    return RegistryArgs(
      ...
      eventNotificationConfigs: (() {
        final guardedValue = map['eventNotificationConfigs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      httpConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          HttpConfig.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      id: (() {
      ...
      logLevel: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RegistryLogLevel.fromValue(guardedValue as String),
        );
      })(),
      mqttConfig: (() {
        final guardedValue = map['mqttConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          MqttConfig.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      name: (() {
      ...
      stateNotificationConfig: (() {
        final guardedValue = map['stateNotificationConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
