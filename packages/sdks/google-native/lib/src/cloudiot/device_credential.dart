...
class DeviceCredential {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'publicKey': ?pulumi.Input.mapOptionalInputValue<PublicKeyCredential, Map<String, dynamic>>(publicKey, (value) => value.toMap()),
    };
  }
  ...
  factory DeviceCredential.fromMap(Map<String, dynamic> map) {
    return DeviceCredential(
      ...
      publicKey: (() { final guardedValue = map['publicKey']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PublicKeyCredential.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
