...
class DeviceArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'id': ?id,
      'location': ?location,
      'logLevel': ?pulumi.Input.mapOptionalInputValue<DeviceLogLevel, String>(
        logLevel,
  ...
  factory DeviceArgs.fromMap(Map<String, dynamic> map) {
    return DeviceArgs(
      blocked: (() {
        final guardedValue = map['blocked'];
      ...
      config: (() {
        ...
        return pulumi.Input.fromValue(
          DeviceConfig.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      credentials: (() {
      ...
      gatewayConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GatewayConfig.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      id: (() {
      ...
      logLevel: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DeviceLogLevel.fromValue(guardedValue as String),
        );
      })(),
      metadata: (() {
