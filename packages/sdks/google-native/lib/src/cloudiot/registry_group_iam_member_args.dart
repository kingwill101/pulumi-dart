...
/// {@template pulumi_cloudiot_v1_registry_group_iam_member_args_doc}
/// The set of arguments for RegistryGroupIamMember.
/// {@endtemplate}
/// {@macro pulumi_cloudiot_v1_registry_group_iam_member_args_doc}
class RegistryGroupIamMemberArgs {
  ...
  /// Creates a new [RegistryGroupIamMemberArgs].
  ...
  const RegistryGroupIamMemberArgs({
    this.condition,
  ...
  factory RegistryGroupIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return RegistryGroupIamMemberArgs(
