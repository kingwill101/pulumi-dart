...
class GatewayConfig {
  ...
  GatewayConfig({this.gatewayAuthMethod, this.gatewayType});
    ...
    return <String, dynamic>{
      'gatewayAuthMethod':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(gatewayAuthMethod, (value) => value.wireValue),
      'gatewayType':
          ?pulumi.Input.mapOptionalInputValue<GatewayConfigGatewayType, String>(
            gatewayType,
  ...
  factory GatewayConfig.fromMap(Map<String, dynamic> map) {
    return GatewayConfig(
      gatewayAuthMethod: (() {
        final guardedValue = map['gatewayAuthMethod'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GatewayConfigGatewayAuthMethod.fromValue(guardedValue as String),
        );
      })(),
      gatewayType: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GatewayConfigGatewayType.fromValue(guardedValue as String),
        );
      })(),
    );
  }
