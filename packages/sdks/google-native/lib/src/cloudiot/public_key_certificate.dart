...
class PublicKeyCertificate {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'format': ?pulumi.Input.mapOptionalInputValue<PublicKeyCertificateFormat, String>(format, (value) => value.wireValue),
    };
  }
  ...
  factory PublicKeyCertificate.fromMap(Map<String, dynamic> map) {
    return PublicKeyCertificate(
      ...
      format: (() { final guardedValue = map['format']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PublicKeyCertificateFormat.fromValue(guardedValue as String)); })(),
    );
  }
}
