...
/// {@template pulumi_cloudiot_v1_registry_iam_binding_args_doc}
/// The set of arguments for RegistryIamBinding.
/// {@endtemplate}
/// {@macro pulumi_cloudiot_v1_registry_iam_binding_args_doc}
class RegistryIamBindingArgs {
  ...
  /// Creates a new [RegistryIamBindingArgs].
  ...
  factory RegistryIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return RegistryIamBindingArgs(
