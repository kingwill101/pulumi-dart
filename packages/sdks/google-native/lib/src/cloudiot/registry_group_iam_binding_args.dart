...
/// {@template pulumi_cloudiot_v1_registry_group_iam_binding_args_doc}
/// The set of arguments for RegistryGroupIamBinding.
/// {@endtemplate}
/// {@macro pulumi_cloudiot_v1_registry_group_iam_binding_args_doc}
class RegistryGroupIamBindingArgs {
  ...
  /// Creates a new [RegistryGroupIamBindingArgs].
  ...
  const RegistryGroupIamBindingArgs({
    this.condition,
  ...
  factory RegistryGroupIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return RegistryGroupIamBindingArgs(
