...
class IosTestResponse {
  ...
  factory IosTestResponse.fromMap(Map<String, dynamic> map) {
    return IosTestResponse(
      iosAppInfo: pulumi.Input.fromValue(IosAppInfoResponse.fromMap((map['iosAppInfo']! as Map).cast<String, dynamic>())),
      iosRoboTest: pulumi.Input.fromValue((map['iosRoboTest']! as Map).cast<String, dynamic>()),
