...
class InconclusiveDetailResponse {
  ...
  const InconclusiveDetailResponse({
  ...
  factory InconclusiveDetailResponse.fromMap(Map<String, dynamic> map) {
    return InconclusiveDetailResponse(
      abortedByUser: pulumi.Input.fromValue(map['abortedByUser'] as bool),
      hasErrorLogs: pulumi.Input.fromValue(map['hasErrorLogs'] as bool),
      infrastructureFailure: pulumi.Input.fromValue(map['infrastructureFailure'] as bool),
    );
  }
}
