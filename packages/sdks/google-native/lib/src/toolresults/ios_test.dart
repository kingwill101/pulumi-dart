...
class IosTest {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'iosAppInfo':
          ?pulumi.Input.mapOptionalInputValue<IosAppInfo, Map<String, dynamic>>(
            iosAppInfo,
            (value) => value.toMap(),
          ),
      ...
      'iosTestLoop':
          ?pulumi.Input.mapOptionalInputValue<
            IosTestLoop,
            Map<String, dynamic>
          >(iosTestLoop, (value) => value.toMap()),
      'iosXcTest':
          ?pulumi.Input.mapOptionalInputValue<IosXcTest, Map<String, dynamic>>(
            iosXcTest,
            (value) => value.toMap(),
          ),
      'testTimeout':
  ...
  factory IosTest.fromMap(Map<String, dynamic> map) {
    return IosTest(
      iosAppInfo: (() {
        final guardedValue = map['iosAppInfo'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          IosAppInfo.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      iosRoboTest: (() {
        final guardedValue = map['iosRoboTest'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      iosTestLoop: (() {
        final guardedValue = map['iosTestLoop'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          IosTestLoop.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      iosXcTest: (() {
        final guardedValue = map['iosXcTest'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          IosXcTest.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      testTimeout: (() {
