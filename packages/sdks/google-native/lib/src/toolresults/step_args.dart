...
class StepArgs {
  ...
  factory StepArgs.fromMap(Map<String, dynamic> map) {
    return StepArgs(
      ...
      deviceUsageDuration: (() {
        final guardedValue = map['deviceUsageDuration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      hasImages: (() {
        final guardedValue = map['hasImages'];
        if (guardedValue == null) return null;
      ...
      labels: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<StepLabelsEntry>(
            guardedValue,
            (value) =>
                StepLabelsEntry.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      multiStep: (() {
        final guardedValue = map['multiStep'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          MultiStep.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      name: (() {
      ...
      outcome: (() {
        final guardedValue = map['outcome'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          Outcome.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      project: (() {
      ...
      state: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          StepState.fromValue(guardedValue as String),
        );
      })(),
      stepId: (() {
      ...
      testExecutionStep: (() {
        final guardedValue = map['testExecutionStep'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      toolExecutionStep: (() {
        final guardedValue = map['toolExecutionStep'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
