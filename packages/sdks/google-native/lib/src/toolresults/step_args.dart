...
class StepArgs {
  ...
  StepArgs({
    ...
    pulumi.Output<Duration>? deviceUsageDuration,
    pulumi.Output<List<StepDimensionValueEntry>>? dimensionValue,
    required pulumi.Output<String> executionId,
    pulumi.Output<bool>? hasImages,
    required pulumi.Output<String> historyId,
    pulumi.Output<List<StepLabelsEntry>>? labels,
    pulumi.Output<MultiStep>? multiStep,
    pulumi.Output<String>? name,
    pulumi.Output<Outcome>? outcome,
    pulumi.Output<String>? project,
    pulumi.Output<String>? requestId,
    pulumi.Output<Duration>? runDuration,
    pulumi.Output<StepState>? state,
    pulumi.Output<String>? stepId,
    pulumi.Output<TestExecutionStep>? testExecutionStep,
    pulumi.Output<ToolExecutionStep>? toolExecutionStep,
  }) :
      ...
      deviceUsageDuration = pulumi.Input.asOptionalInput<Duration>(deviceUsageDuration),
      dimensionValue = pulumi.Input.asOptionalInput<List<StepDimensionValueEntry>>(dimensionValue),
      executionId = pulumi.Input.asInput<String>(executionId),
      hasImages = pulumi.Input.asOptionalInput<bool>(hasImages),
      historyId = pulumi.Input.asInput<String>(historyId),
      labels = pulumi.Input.asOptionalInput<List<StepLabelsEntry>>(labels),
      multiStep = pulumi.Input.asOptionalInput<MultiStep>(multiStep),
      name = pulumi.Input.asOptionalInput<String>(name),
      outcome = pulumi.Input.asOptionalInput<Outcome>(outcome),
      project = pulumi.Input.asOptionalInput<String>(project),
      requestId = pulumi.Input.asOptionalInput<String>(requestId),
      runDuration = pulumi.Input.asOptionalInput<Duration>(runDuration),
      state = pulumi.Input.asOptionalInput<StepState>(state),
      stepId = pulumi.Input.asOptionalInput<String>(stepId),
      testExecutionStep = pulumi.Input.asOptionalInput<TestExecutionStep>(testExecutionStep),
      toolExecutionStep = pulumi.Input.asOptionalInput<ToolExecutionStep>(toolExecutionStep);
  ...
  factory StepArgs.fromMap(Map<String, dynamic> map) {
    return StepArgs(
      ...
      deviceUsageDuration: map['deviceUsageDuration'] == null ? null : pulumi.Output.create<Duration>(Duration.fromMap((map['deviceUsageDuration'] as Map).cast<String, dynamic>())),
      dimensionValue: map['dimensionValue'] == null ? null : pulumi.Output.create<List<StepDimensionValueEntry>>(pulumi.Input.decodeList<StepDimensionValueEntry>(map['dimensionValue'], (value) => StepDimensionValueEntry.fromMap((value as Map).cast<String, dynamic>()))),
      executionId: pulumi.Output.create<String>(map['executionId'] as String),
      hasImages: map['hasImages'] == null ? null : pulumi.Output.create<bool>(map['hasImages'] as bool),
      historyId: pulumi.Output.create<String>(map['historyId'] as String),
      labels: map['labels'] == null ? null : pulumi.Output.create<List<StepLabelsEntry>>(pulumi.Input.decodeList<StepLabelsEntry>(map['labels'], (value) => StepLabelsEntry.fromMap((value as Map).cast<String, dynamic>()))),
      multiStep: map['multiStep'] == null ? null : pulumi.Output.create<MultiStep>(MultiStep.fromMap((map['multiStep'] as Map).cast<String, dynamic>())),
      ...
      runDuration: map['runDuration'] == null ? null : pulumi.Output.create<Duration>(Duration.fromMap((map['runDuration'] as Map).cast<String, dynamic>())),
      state: map['state'] == null ? null : pulumi.Output.create<StepState>(StepState.fromValue(map['state'] as String)),
      stepId: map['stepId'] == null ? null : pulumi.Output.create<String>(map['stepId'] as String),
      testExecutionStep: map['testExecutionStep'] == null ? null : pulumi.Output.create<TestExecutionStep>(TestExecutionStep.fromMap((map['testExecutionStep'] as Map).cast<String, dynamic>())),
      toolExecutionStep: map['toolExecutionStep'] == null ? null : pulumi.Output.create<ToolExecutionStep>(ToolExecutionStep.fromMap((map['toolExecutionStep'] as Map).cast<String, dynamic>())),
    );
  }
}
