...
class StepArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'state': ?pulumi.Input.mapOptionalInputValue<StepState, String>(state, (value) => value.wireValue),
      'stepId': ?stepId,
  ...
  factory StepArgs.fromMap(Map<String, dynamic> map) {
    return StepArgs(
      ...
      deviceUsageDuration: (() { final guardedValue = map['deviceUsageDuration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Duration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      dimensionValue: (() { final guardedValue = map['dimensionValue']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<StepDimensionValueEntry>(guardedValue, (value) => StepDimensionValueEntry.fromMap((value as Map).cast<String, dynamic>()))); })(),
      executionId: pulumi.Input.fromValue(map['executionId'] as String),
      hasImages: (() { final guardedValue = map['hasImages']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      historyId: pulumi.Input.fromValue(map['historyId'] as String),
      labels: (() { final guardedValue = map['labels']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<StepLabelsEntry>(guardedValue, (value) => StepLabelsEntry.fromMap((value as Map).cast<String, dynamic>()))); })(),
      multiStep: (() { final guardedValue = map['multiStep']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MultiStep.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      state: (() { final guardedValue = map['state']; if (guardedValue == null) return null; return pulumi.Input.fromValue(StepState.fromValue(guardedValue as String)); })(),
      ...
      testExecutionStep: (() { final guardedValue = map['testExecutionStep']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TestExecutionStep.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      toolExecutionStep: (() { final guardedValue = map['toolExecutionStep']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ToolExecutionStep.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
