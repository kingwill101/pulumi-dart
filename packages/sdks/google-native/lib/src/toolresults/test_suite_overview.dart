...
class TestSuiteOverview {
  ...
  factory TestSuiteOverview.fromMap(Map<String, dynamic> map) {
    return TestSuiteOverview(
      elapsedTime: (() {
        final guardedValue = map['elapsedTime'];
      ...
      errorCount: (() {
        final guardedValue = map['errorCount'];
        if (guardedValue == null) return null;
      ...
      flakyCount: (() {
        final guardedValue = map['flakyCount'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      name: (() {
      ...
      skippedCount: (() {
        final guardedValue = map['skippedCount'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      totalCount: (() {
      ...
      xmlSource: (() {
        final guardedValue = map['xmlSource'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
