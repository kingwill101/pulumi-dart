...
class ExecutionArgs {
  ...
  factory ExecutionArgs.fromMap(Map<String, dynamic> map) {
    return ExecutionArgs(
      ...
      dimensionDefinitions: (() {
        final guardedValue = map['dimensionDefinitions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      specification: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          Specification.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      state: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ExecutionState.fromValue(guardedValue as String),
        );
      })(),
      testExecutionMatrixId: (() {
        final guardedValue = map['testExecutionMatrixId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
