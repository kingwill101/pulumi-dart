...
class Specification {
  ...
  factory Specification.fromMap(Map<String, dynamic> map) {
    return Specification(
      androidTest: (() { final guardedValue = map['androidTest']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AndroidTest.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      iosTest: (() { final guardedValue = map['iosTest']; if (guardedValue == null) return null; return pulumi.Input.fromValue(IosTest.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
