...
class AndroidRoboTest {
  ...
  factory AndroidRoboTest.fromMap(Map<String, dynamic> map) {
    return AndroidRoboTest(
      ...
      bootstrapPackageId: map['bootstrapPackageId'] == null ? null : map['bootstrapPackageId'] as String,
      bootstrapRunnerClass: map['bootstrapRunnerClass'] == null ? null : map['bootstrapRunnerClass'] as String,
