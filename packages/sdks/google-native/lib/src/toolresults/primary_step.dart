...
class PrimaryStep {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'rollUp': ?pulumi.Input.mapOptionalInputValue<PrimaryStepRollUp, String>(
        rollUp,
  ...
  factory PrimaryStep.fromMap(Map<String, dynamic> map) {
    return PrimaryStep(
      individualOutcome: (() {
        final guardedValue = map['individualOutcome'];
      ...
      rollUp: (() {
        final guardedValue = map['rollUp'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PrimaryStepRollUp.fromValue(guardedValue as String),
        );
      })(),
    );
  }
