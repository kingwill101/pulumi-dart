...
class SpecificationResponse {
  ...
  factory SpecificationResponse.fromMap(Map<String, dynamic> map) {
    return SpecificationResponse(
      androidTest: pulumi.Input.fromValue(AndroidTestResponse.fromMap((map['androidTest']! as Map).cast<String, dynamic>())),
      iosTest: pulumi.Input.fromValue(IosTestResponse.fromMap((map['iosTest']! as Map).cast<String, dynamic>())),
    );
  }
}
