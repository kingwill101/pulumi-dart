...
class ToolOutputReference {
  ...
  factory ToolOutputReference.fromMap(Map<String, dynamic> map) {
    return ToolOutputReference(
      ...
      output: (() { final guardedValue = map['output']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FileReference.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      testCase: (() { final guardedValue = map['testCase']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TestCaseReference.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
