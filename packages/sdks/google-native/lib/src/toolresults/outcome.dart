...
class Outcome {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'summary': ?pulumi.Input.mapOptionalInputValue<OutcomeSummary, String>(
        summary,
  ...
  factory Outcome.fromMap(Map<String, dynamic> map) {
    return Outcome(
      failureDetail: (() {
        final guardedValue = map['failureDetail'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FailureDetail.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      inconclusiveDetail: (() {
        final guardedValue = map['inconclusiveDetail'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          InconclusiveDetail.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      skippedDetail: (() {
        final guardedValue = map['skippedDetail'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SkippedDetail.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      successDetail: (() {
        final guardedValue = map['successDetail'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SuccessDetail.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      summary: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          OutcomeSummary.fromValue(guardedValue as String),
        );
      })(),
    );
  }
