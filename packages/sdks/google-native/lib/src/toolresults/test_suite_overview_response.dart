...
class TestSuiteOverviewResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'elapsedTime': pulumi.Input.mapInputValue<DurationResponse, Map<String, dynamic>>(elapsedTime, (value) => value.toMap()),
      ...
      'xmlSource': pulumi.Input.mapInputValue<FileReferenceResponse, Map<String, dynamic>>(xmlSource, (value) => value.toMap()),
    };
  }

  factory TestSuiteOverviewResponse.fromMap(Map<String, dynamic> map) {
    return TestSuiteOverviewResponse(
      elapsedTime: (DurationResponse.fromMap((map['elapsedTime'] as Map).cast<String, dynamic>())).input(),
      errorCount: (map['errorCount'] as int).input(),
      failureCount: (map['failureCount'] as int).input(),
      flakyCount: (map['flakyCount'] as int).input(),
      name: (map['name'] as String).input(),
      skippedCount: (map['skippedCount'] as int).input(),
      totalCount: (map['totalCount'] as int).input(),
      xmlSource: (FileReferenceResponse.fromMap((map['xmlSource'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
