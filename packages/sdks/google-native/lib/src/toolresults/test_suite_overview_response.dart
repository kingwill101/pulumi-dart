...
class TestSuiteOverviewResponse {
  ...
  factory TestSuiteOverviewResponse.fromMap(Map<String, dynamic> map) {
    return TestSuiteOverviewResponse(
      elapsedTime: DurationResponse.fromMap((map['elapsedTime'] as Map).cast<String, dynamic>()),
      ...
      xmlSource: FileReferenceResponse.fromMap((map['xmlSource'] as Map).cast<String, dynamic>()),
    );
  }
}
