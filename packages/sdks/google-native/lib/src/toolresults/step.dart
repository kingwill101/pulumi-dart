...
class Step extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<StepDimensionValueEntryResponse>> dimensionValue;
  ...
  late final pulumi.Output<List<StepLabelsEntryResponse>> labels;
  ...
  Step(
    ...
    this.deviceUsageDuration = registerOutput<DurationResponse>('deviceUsageDuration');
    this.dimensionValue = registerOutput<List<StepDimensionValueEntryResponse>>('dimensionValue');
    ...
    this.runDuration = registerOutput<DurationResponse>('runDuration');
    this.state = registerOutput<String>('state');
    this.stepId = registerOutput<String>('stepId');
    this.testExecutionStep = registerOutput<TestExecutionStepResponse>('testExecutionStep');
    this.toolExecutionStep = registerOutput<ToolExecutionStepResponse>('toolExecutionStep');
  }
}
