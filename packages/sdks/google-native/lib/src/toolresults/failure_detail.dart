...
class FailureDetail {
  ...
  factory FailureDetail.fromMap(Map<String, dynamic> map) {
    return FailureDetail(
      crashed: (() {
        final guardedValue = map['crashed'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      deviceOutOfMemory: (() {
        final guardedValue = map['deviceOutOfMemory'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      failedRoboscript: (() {
        final guardedValue = map['failedRoboscript'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      notInstalled: (() {
        final guardedValue = map['notInstalled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      otherNativeCrash: (() {
      ...
      timedOut: (() {
        final guardedValue = map['timedOut'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      unableToCrawl: (() {
        final guardedValue = map['unableToCrawl'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
    );
