...
class TestExecutionStepResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'testIssues': pulumi.Input.encodeList<TestIssueResponse, Map<String, dynamic>>(testIssues, (value) => value.toMap()),
      'testSuiteOverviews': pulumi.Input.encodeList<TestSuiteOverviewResponse, Map<String, dynamic>>(testSuiteOverviews, (value) => value.toMap()),
      'testTiming': testTiming.toMap(),
  ...
  factory TestExecutionStepResponse.fromMap(Map<String, dynamic> map) {
    return TestExecutionStepResponse(
      testIssues: pulumi.Input.decodeList<TestIssueResponse>(map['testIssues'], (value) => TestIssueResponse.fromMap((value as Map).cast<String, dynamic>())),
      testSuiteOverviews: pulumi.Input.decodeList<TestSuiteOverviewResponse>(map['testSuiteOverviews'], (value) => TestSuiteOverviewResponse.fromMap((value as Map).cast<String, dynamic>())),
      testTiming: TestTimingResponse.fromMap((map['testTiming'] as Map).cast<String, dynamic>()),
