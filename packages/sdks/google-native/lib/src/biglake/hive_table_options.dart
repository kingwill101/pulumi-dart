...
class HiveTableOptions {
  ...
  factory HiveTableOptions.fromMap(Map<String, dynamic> map) {
    return HiveTableOptions(
      ...
      storageDescriptor: (() { final guardedValue = map['storageDescriptor']; if (guardedValue == null) return null; return pulumi.Input.fromValue(StorageDescriptor.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
