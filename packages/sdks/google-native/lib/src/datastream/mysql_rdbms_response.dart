...
class MysqlRdbmsResponse {
  ...
  factory MysqlRdbmsResponse.fromMap(Map<String, dynamic> map) {
    return MysqlRdbmsResponse(
      mysqlDatabases: (pulumi.Input.decodeList<MysqlDatabaseResponse>(map['mysqlDatabases'], (value) => MysqlDatabaseResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
