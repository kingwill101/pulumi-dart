...
class OracleSourceConfigDatastreamV1alpha1 {
  ...
  const OracleSourceConfigDatastreamV1alpha1({
    this.allowlist,
  ...
  factory OracleSourceConfigDatastreamV1alpha1.fromMap(Map<String, dynamic> map) {
    return OracleSourceConfigDatastreamV1alpha1(
      allowlist: (() { final guardedValue = map['allowlist']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OracleRdbmsDatastreamV1alpha1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      rejectlist: (() { final guardedValue = map['rejectlist']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OracleRdbmsDatastreamV1alpha1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
