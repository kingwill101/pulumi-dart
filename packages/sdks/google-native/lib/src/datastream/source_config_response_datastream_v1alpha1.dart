...
class SourceConfigResponseDatastreamV1alpha1 {
  ...
  factory SourceConfigResponseDatastreamV1alpha1.fromMap(Map<String, dynamic> map) {
    return SourceConfigResponseDatastreamV1alpha1(
      mysqlSourceConfig: (MysqlSourceConfigResponseDatastreamV1alpha1.fromMap((map['mysqlSourceConfig'] as Map).cast<String, dynamic>())).input(),
      oracleSourceConfig: (OracleSourceConfigResponseDatastreamV1alpha1.fromMap((map['oracleSourceConfig'] as Map).cast<String, dynamic>())).input(),
