...
class SourceConfigResponseDatastreamV1alpha1 {
  ...
  final pulumi.Input<MysqlSourceConfigResponseDatastreamV1alpha1> mysqlSourceConfig;
  /// Oracle data source configuration
  final pulumi.Input<OracleSourceConfigResponseDatastreamV1alpha1> oracleSourceConfig;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'mysqlSourceConfig': pulumi.Input.mapInputValue<MysqlSourceConfigResponseDatastreamV1alpha1, Map<String, dynamic>>(mysqlSourceConfig, (value) => value.toMap()),
      'oracleSourceConfig': pulumi.Input.mapInputValue<OracleSourceConfigResponseDatastreamV1alpha1, Map<String, dynamic>>(oracleSourceConfig, (value) => value.toMap()),
  ...
  factory SourceConfigResponseDatastreamV1alpha1.fromMap(Map<String, dynamic> map) {
    return SourceConfigResponseDatastreamV1alpha1(
      mysqlSourceConfig: pulumi.Input.fromValue(MysqlSourceConfigResponseDatastreamV1alpha1.fromMap((map['mysqlSourceConfig']! as Map).cast<String, dynamic>())),
      oracleSourceConfig: pulumi.Input.fromValue(OracleSourceConfigResponseDatastreamV1alpha1.fromMap((map['oracleSourceConfig']! as Map).cast<String, dynamic>())),
