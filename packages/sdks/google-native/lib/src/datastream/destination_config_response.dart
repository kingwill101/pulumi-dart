...
class DestinationConfigResponse {
  ...
  final pulumi.Input<BigQueryDestinationConfigResponse>
  ...
  factory DestinationConfigResponse.fromMap(Map<String, dynamic> map) {
    return DestinationConfigResponse(
      bigqueryDestinationConfig: pulumi.Input.fromValue(
        BigQueryDestinationConfigResponse.fromMap(
      ...
      gcsDestinationConfig: pulumi.Input.fromValue(
        GcsDestinationConfigResponse.fromMap(
