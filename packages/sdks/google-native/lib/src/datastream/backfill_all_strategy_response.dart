...
class BackfillAllStrategyResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'mysqlExcludedObjects':
          pulumi.Input.mapInputValue<MysqlRdbmsResponse, Map<String, dynamic>>(
            mysqlExcludedObjects,
            (value) => value.toMap(),
          ),
  ...
  factory BackfillAllStrategyResponse.fromMap(Map<String, dynamic> map) {
    return BackfillAllStrategyResponse(
      mysqlExcludedObjects: pulumi.Input.fromValue(
        MysqlRdbmsResponse.fromMap(
          (map['mysqlExcludedObjects']! as Map).cast<String, dynamic>(),
        ),
      ),
      oracleExcludedObjects: pulumi.Input.fromValue(
        OracleRdbmsResponse.fromMap(
          (map['oracleExcludedObjects']! as Map).cast<String, dynamic>(),
        ),
      ),
      postgresqlExcludedObjects: pulumi.Input.fromValue(
        PostgresqlRdbmsResponse.fromMap(
