...
class MysqlTableDatastreamV1alpha1 {
  ...
  factory MysqlTableDatastreamV1alpha1.fromMap(Map<String, dynamic> map) {
    return MysqlTableDatastreamV1alpha1(
      mysqlColumns: (() { final guardedValue = map['mysqlColumns']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<MysqlColumnDatastreamV1alpha1>(guardedValue, (value) => MysqlColumnDatastreamV1alpha1.fromMap((value as Map).cast<String, dynamic>()))); })(),
