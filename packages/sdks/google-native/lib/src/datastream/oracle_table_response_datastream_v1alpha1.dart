...
class OracleTableResponseDatastreamV1alpha1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'oracleColumns': pulumi.Input.encodeList<OracleColumnResponseDatastreamV1alpha1, Map<String, dynamic>>(oracleColumns, (value) => value.toMap()),
      'tableName': tableName,
    };
  }
  ...
  factory OracleTableResponseDatastreamV1alpha1.fromMap(Map<String, dynamic> map) {
    return OracleTableResponseDatastreamV1alpha1(
      oracleColumns: pulumi.Input.decodeList<OracleColumnResponseDatastreamV1alpha1>(map['oracleColumns'], (value) => OracleColumnResponseDatastreamV1alpha1.fromMap((value as Map).cast<String, dynamic>())),
