...
class SourceConfig {
  ...
  factory SourceConfig.fromMap(Map<String, dynamic> map) {
    return SourceConfig(
      mysqlSourceConfig: (() { final guardedValue = map['mysqlSourceConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MysqlSourceConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      oracleSourceConfig: (() { final guardedValue = map['oracleSourceConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OracleSourceConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      postgresqlSourceConfig: (() { final guardedValue = map['postgresqlSourceConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PostgresqlSourceConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
