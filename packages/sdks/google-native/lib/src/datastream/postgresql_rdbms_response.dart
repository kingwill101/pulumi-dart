...
class PostgresqlRdbmsResponse {
  ...
  factory PostgresqlRdbmsResponse.fromMap(Map<String, dynamic> map) {
    return PostgresqlRdbmsResponse(
      postgresqlSchemas: pulumi.Input.fromValue(pulumi.Input.decodeList<PostgresqlSchemaResponse>(map['postgresqlSchemas']!, (value) => PostgresqlSchemaResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
