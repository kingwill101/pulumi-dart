...
class JsonFileFormatDatastreamV1alpha1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'compression': ?pulumi.Input.mapOptionalInputValue<JsonFileFormatCompressionDatastreamV1alpha1, String>(compression, (value) => value.value),
      'schemaFileFormat': ?pulumi.Input.mapOptionalInputValue<JsonFileFormatSchemaFileFormatDatastreamV1alpha1, String>(schemaFileFormat, (value) => value.value),
    };
  }
