...
class OracleSchemaResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'oracleTables': pulumi.Input.mapInputValue<List<OracleTableResponse>, List<Map<String, dynamic>>>(oracleTables, (value) => pulumi.Input.encodeList<OracleTableResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'schema': schema,
    };
  }
  ...
  factory OracleSchemaResponse.fromMap(Map<String, dynamic> map) {
    return OracleSchemaResponse(
      oracleTables: pulumi.Input.fromValue(pulumi.Input.decodeList<OracleTableResponse>(map['oracleTables']!, (value) => OracleTableResponse.fromMap((value as Map).cast<String, dynamic>()))),
