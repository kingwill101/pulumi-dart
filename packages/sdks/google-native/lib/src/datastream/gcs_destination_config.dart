...
class GcsDestinationConfig {
  ...
  factory GcsDestinationConfig.fromMap(Map<String, dynamic> map) {
    return GcsDestinationConfig(
      ...
      jsonFileFormat: (() { final guardedValue = map['jsonFileFormat']; if (guardedValue == null) return null; return pulumi.Input.fromValue(JsonFileFormat.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
