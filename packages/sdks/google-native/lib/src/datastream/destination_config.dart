...
class DestinationConfig {
  ...
  factory DestinationConfig.fromMap(Map<String, dynamic> map) {
    return DestinationConfig(
      bigqueryDestinationConfig: (() { final guardedValue = map['bigqueryDestinationConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BigQueryDestinationConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      destinationConnectionProfile: pulumi.Input.fromValue(map['destinationConnectionProfile'] as String),
      gcsDestinationConfig: (() { final guardedValue = map['gcsDestinationConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GcsDestinationConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
