...
class BackfillAllStrategy {
  ...
  factory BackfillAllStrategy.fromMap(Map<String, dynamic> map) {
    return BackfillAllStrategy(
      mysqlExcludedObjects: (() { final guardedValue = map['mysqlExcludedObjects']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MysqlRdbms.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      oracleExcludedObjects: (() { final guardedValue = map['oracleExcludedObjects']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OracleRdbms.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      postgresqlExcludedObjects: (() { final guardedValue = map['postgresqlExcludedObjects']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PostgresqlRdbms.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
