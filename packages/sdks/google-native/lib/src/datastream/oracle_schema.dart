...
class OracleSchema {
  ...
  factory OracleSchema.fromMap(Map<String, dynamic> map) {
    return OracleSchema(
      oracleTables: (() { final guardedValue = map['oracleTables']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OracleTable>(guardedValue, (value) => OracleTable.fromMap((value as Map).cast<String, dynamic>()))); })(),
