...
class PostgresqlSourceConfig {
  ...
  factory PostgresqlSourceConfig.fromMap(Map<String, dynamic> map) {
    return PostgresqlSourceConfig(
      excludeObjects: (() { final guardedValue = map['excludeObjects']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PostgresqlRdbms.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      includeObjects: (() { final guardedValue = map['includeObjects']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PostgresqlRdbms.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
