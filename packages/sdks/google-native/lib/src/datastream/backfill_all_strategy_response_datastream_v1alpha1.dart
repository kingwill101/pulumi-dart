...
class BackfillAllStrategyResponseDatastreamV1alpha1 {
  ...
  factory BackfillAllStrategyResponseDatastreamV1alpha1.fromMap(Map<String, dynamic> map) {
    return BackfillAllStrategyResponseDatastreamV1alpha1(
      mysqlExcludedObjects: (MysqlRdbmsResponseDatastreamV1alpha1.fromMap((map['mysqlExcludedObjects'] as Map).cast<String, dynamic>())).input(),
      oracleExcludedObjects: (OracleRdbmsResponseDatastreamV1alpha1.fromMap((map['oracleExcludedObjects'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
