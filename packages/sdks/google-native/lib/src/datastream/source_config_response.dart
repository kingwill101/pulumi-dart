...
class SourceConfigResponse {
  ...
  factory SourceConfigResponse.fromMap(Map<String, dynamic> map) {
    return SourceConfigResponse(
      mysqlSourceConfig: pulumi.Input.fromValue(MysqlSourceConfigResponse.fromMap((map['mysqlSourceConfig']! as Map).cast<String, dynamic>())),
      oracleSourceConfig: pulumi.Input.fromValue(OracleSourceConfigResponse.fromMap((map['oracleSourceConfig']! as Map).cast<String, dynamic>())),
      postgresqlSourceConfig: pulumi.Input.fromValue(PostgresqlSourceConfigResponse.fromMap((map['postgresqlSourceConfig']! as Map).cast<String, dynamic>())),
