...
class SecurityProfileArgs {
  ...
  factory SecurityProfileArgs.fromMap(Map<String, dynamic> map) {
    return SecurityProfileArgs(
      ...
      environments: (() { final guardedValue = map['environments']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<Map<String, dynamic>>()); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      organizationId: pulumi.Input.fromValue(map['organizationId'] as String),
      profileConfig: pulumi.Input.fromValue(GoogleCloudApigeeV1ProfileConfig.fromMap((map['profileConfig']! as Map).cast<String, dynamic>())),
      scoringConfigs: (() { final guardedValue = map['scoringConfigs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudApigeeV1SecurityProfileScoringConfig>(guardedValue, (value) => GoogleCloudApigeeV1SecurityProfileScoringConfig.fromMap((value as Map).cast<String, dynamic>()))); })(),
