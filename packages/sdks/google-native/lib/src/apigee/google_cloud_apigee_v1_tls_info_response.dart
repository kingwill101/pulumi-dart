...
class GoogleCloudApigeeV1TlsInfoResponse {
  ...
  factory GoogleCloudApigeeV1TlsInfoResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudApigeeV1TlsInfoResponse(
      ...
      clientAuthEnabled: (map['clientAuthEnabled'] as bool).input(),
      commonName: (GoogleCloudApigeeV1TlsInfoCommonNameResponse.fromMap((map['commonName'] as Map).cast<String, dynamic>())).input(),
      enabled: (map['enabled'] as bool).input(),
      ignoreValidationErrors: (map['ignoreValidationErrors'] as bool).input(),
      keyAlias: (map['keyAlias'] as String).input(),
      keyStore: (map['keyStore'] as String).input(),
      protocols: ((map['protocols'] as List).cast<String>()).input(),
      trustStore: (map['trustStore'] as String).input(),
    );
  }
}
