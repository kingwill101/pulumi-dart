...
class OrganizationArgs {
  ...
  OrganizationArgs({
    pulumi.Output<GoogleCloudApigeeV1AddonsConfig>? addonsConfig,
    required pulumi.Output<String> analyticsRegion,
    ...
    pulumi.Output<OrganizationBillingType>? billingType,
    ...
    pulumi.Output<bool>? portalDisabled,
    pulumi.Output<GoogleCloudApigeeV1Properties>? properties,
    pulumi.Output<String>? runtimeDatabaseEncryptionKeyName,
    required pulumi.Output<OrganizationRuntimeType> runtimeType_,
    pulumi.Output<OrganizationType>? type,
  }) :
  ...
  factory OrganizationArgs.fromMap(Map<String, dynamic> map) {
    return OrganizationArgs(
      addonsConfig: map['addonsConfig'] == null ? null : pulumi.Output.create<GoogleCloudApigeeV1AddonsConfig>(GoogleCloudApigeeV1AddonsConfig.fromMap((map['addonsConfig'] as Map).cast<String, dynamic>())),
      analyticsRegion: pulumi.Output.create<String>(map['analyticsRegion'] as String),
      ...
      billingType: map['billingType'] == null ? null : pulumi.Output.create<OrganizationBillingType>(OrganizationBillingType.fromValue(map['billingType'] as String)),
      ...
      portalDisabled: map['portalDisabled'] == null ? null : pulumi.Output.create<bool>(map['portalDisabled'] as bool),
      ...
      runtimeType_: pulumi.Output.create<OrganizationRuntimeType>(OrganizationRuntimeType.fromValue(map['runtimeType'] as String)),
      type: map['type'] == null ? null : pulumi.Output.create<OrganizationType>(OrganizationType.fromValue(map['type'] as String)),
    );
  }
}
