...
class OrganizationArgs {
  ...
  factory OrganizationArgs.fromMap(Map<String, dynamic> map) {
    return OrganizationArgs(
      addonsConfig: map['addonsConfig'] == null ? null : (GoogleCloudApigeeV1AddonsConfig.fromMap((map['addonsConfig'] as Map).cast<String, dynamic>())).input(),
      analyticsRegion: (map['analyticsRegion'] as String).input(),
      ...
      billingType: map['billingType'] == null ? null : (OrganizationBillingType.fromValue(map['billingType'] as String)).input(),
      ...
      portalDisabled: map['portalDisabled'] == null ? null : (map['portalDisabled'] as bool).input(),
      ...
      runtimeType_: (OrganizationRuntimeType.fromValue(map['runtimeType'] as String)).input(),
      type: map['type'] == null ? null : (OrganizationType.fromValue(map['type'] as String)).input(),
    );
  }
}
