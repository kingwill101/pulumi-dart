...
class RatePlanArgs {
  ...
  RatePlanArgs({
    ...
    pulumi.Output<RatePlanBillingPeriod>? billingPeriod,
    pulumi.Output<List<GoogleCloudApigeeV1RateRange>>? consumptionPricingRates,
    pulumi.Output<RatePlanConsumptionPricingType>? consumptionPricingType,
    pulumi.Output<String>? currencyCode,
    pulumi.Output<String>? description,
    pulumi.Output<String>? displayName,
    pulumi.Output<String>? endTime,
    pulumi.Output<int>? fixedFeeFrequency,
    pulumi.Output<GoogleTypeMoney>? fixedRecurringFee,
    required pulumi.Output<String> organizationId,
    pulumi.Output<RatePlanPaymentFundingModel>? paymentFundingModel,
    pulumi.Output<List<GoogleCloudApigeeV1RevenueShareRange>>? revenueShareRates,
    pulumi.Output<RatePlanRevenueShareType>? revenueShareType,
    pulumi.Output<GoogleTypeMoney>? setupFee,
    pulumi.Output<String>? startTime,
    pulumi.Output<RatePlanState>? state,
  }) :
      apiproduct = pulumi.Input.asOptionalInput<String>(apiproduct),
      apiproductId = pulumi.Input.asInput<String>(apiproductId),
      billingPeriod = pulumi.Input.asOptionalInput<RatePlanBillingPeriod>(billingPeriod),
      consumptionPricingRates = pulumi.Input.asOptionalInput<List<GoogleCloudApigeeV1RateRange>>(consumptionPricingRates),
      consumptionPricingType = pulumi.Input.asOptionalInput<RatePlanConsumptionPricingType>(consumptionPricingType),
      currencyCode = pulumi.Input.asOptionalInput<String>(currencyCode),
      description = pulumi.Input.asOptionalInput<String>(description),
      displayName = pulumi.Input.asOptionalInput<String>(displayName),
      endTime = pulumi.Input.asOptionalInput<String>(endTime),
      fixedFeeFrequency = pulumi.Input.asOptionalInput<int>(fixedFeeFrequency),
      fixedRecurringFee = pulumi.Input.asOptionalInput<GoogleTypeMoney>(fixedRecurringFee),
      organizationId = pulumi.Input.asInput<String>(organizationId),
      paymentFundingModel = pulumi.Input.asOptionalInput<RatePlanPaymentFundingModel>(paymentFundingModel),
      revenueShareRates = pulumi.Input.asOptionalInput<List<GoogleCloudApigeeV1RevenueShareRange>>(revenueShareRates),
      revenueShareType = pulumi.Input.asOptionalInput<RatePlanRevenueShareType>(revenueShareType),
  ...
  factory RatePlanArgs.fromMap(Map<String, dynamic> map) {
    return RatePlanArgs(
      ...
      billingPeriod: map['billingPeriod'] == null ? null : pulumi.Output.create<RatePlanBillingPeriod>(RatePlanBillingPeriod.fromValue(map['billingPeriod'] as String)),
      consumptionPricingRates: map['consumptionPricingRates'] == null ? null : pulumi.Output.create<List<GoogleCloudApigeeV1RateRange>>(pulumi.Input.decodeList<GoogleCloudApigeeV1RateRange>(map['consumptionPricingRates'], (value) => GoogleCloudApigeeV1RateRange.fromMap((value as Map).cast<String, dynamic>()))),
      consumptionPricingType: map['consumptionPricingType'] == null ? null : pulumi.Output.create<RatePlanConsumptionPricingType>(RatePlanConsumptionPricingType.fromValue(map['consumptionPricingType'] as String)),
      ...
      fixedFeeFrequency: map['fixedFeeFrequency'] == null ? null : pulumi.Output.create<int>(map['fixedFeeFrequency'] as int),
      fixedRecurringFee: map['fixedRecurringFee'] == null ? null : pulumi.Output.create<GoogleTypeMoney>(GoogleTypeMoney.fromMap((map['fixedRecurringFee'] as Map).cast<String, dynamic>())),
      organizationId: pulumi.Output.create<String>(map['organizationId'] as String),
      paymentFundingModel: map['paymentFundingModel'] == null ? null : pulumi.Output.create<RatePlanPaymentFundingModel>(RatePlanPaymentFundingModel.fromValue(map['paymentFundingModel'] as String)),
      revenueShareRates: map['revenueShareRates'] == null ? null : pulumi.Output.create<List<GoogleCloudApigeeV1RevenueShareRange>>(pulumi.Input.decodeList<GoogleCloudApigeeV1RevenueShareRange>(map['revenueShareRates'], (value) => GoogleCloudApigeeV1RevenueShareRange.fromMap((value as Map).cast<String, dynamic>()))),
      revenueShareType: map['revenueShareType'] == null ? null : pulumi.Output.create<RatePlanRevenueShareType>(RatePlanRevenueShareType.fromValue(map['revenueShareType'] as String)),
      setupFee: map['setupFee'] == null ? null : pulumi.Output.create<GoogleTypeMoney>(GoogleTypeMoney.fromMap((map['setupFee'] as Map).cast<String, dynamic>())),
      startTime: map['startTime'] == null ? null : pulumi.Output.create<String>(map['startTime'] as String),
      state: map['state'] == null ? null : pulumi.Output.create<RatePlanState>(RatePlanState.fromValue(map['state'] as String)),
    );
  }
}
