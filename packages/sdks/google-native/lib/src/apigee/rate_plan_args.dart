    ...
    return <String, dynamic>{
      ...
      'consumptionPricingType':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(consumptionPricingType, (value) => value.wireValue),
      ...
      'fixedRecurringFee':
          ?pulumi.Input.mapOptionalInputValue<
            GoogleTypeMoney,
            Map<String, dynamic>
          >(fixedRecurringFee, (value) => value.toMap()),
      'organizationId': organizationId,
      'paymentFundingModel':
          ?pulumi.Input.mapOptionalInputValue<
            RatePlanPaymentFundingModel,
            String
          >(paymentFundingModel, (value) => value.wireValue),
      'revenueShareRates':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'setupFee':
          ?pulumi.Input.mapOptionalInputValue<
            GoogleTypeMoney,
            Map<String, dynamic>
          >(setupFee, (value) => value.toMap()),
      'startTime': ?startTime,
      'state': ?pulumi.Input.mapOptionalInputValue<RatePlanState, String>(
        state,
        (value) => value.wireValue,
      ),
    };
    ...
    return RatePlanArgs(
      ...
      billingPeriod: (() {
        ...
        return pulumi.Input.fromValue(
          RatePlanBillingPeriod.fromValue(guardedValue as String),
        );
      })(),
      consumptionPricingRates: (() {
        final guardedValue = map['consumptionPricingRates'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      consumptionPricingType: (() {
        final guardedValue = map['consumptionPricingType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RatePlanConsumptionPricingType.fromValue(guardedValue as String),
        );
      })(),
      currencyCode: (() {
      ...
      fixedFeeFrequency: (() {
        final guardedValue = map['fixedFeeFrequency'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      fixedRecurringFee: (() {
        final guardedValue = map['fixedRecurringFee'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      paymentFundingModel: (() {
        final guardedValue = map['paymentFundingModel'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RatePlanPaymentFundingModel.fromValue(guardedValue as String),
        );
      })(),
      revenueShareRates: (() {
        final guardedValue = map['revenueShareRates'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      revenueShareType: (() {
        final guardedValue = map['revenueShareType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RatePlanRevenueShareType.fromValue(guardedValue as String),
        );
      })(),
      setupFee: (() {
        final guardedValue = map['setupFee'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GoogleTypeMoney.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
      ...
      state: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RatePlanState.fromValue(guardedValue as String),
        );
      })(),
    );
  }
