...
class EnvironmentArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'apiProxyType': ?pulumi.Input.mapOptionalInputValue<EnvironmentApiProxyType, String>(apiProxyType, (value) => value.wireValue),
      'deploymentType': ?pulumi.Input.mapOptionalInputValue<EnvironmentDeploymentType, String>(deploymentType, (value) => value.wireValue),
      ...
      'type': ?pulumi.Input.mapOptionalInputValue<EnvironmentType, String>(type, (value) => value.wireValue),
    };
  }

  factory EnvironmentArgs.fromMap(Map<String, dynamic> map) {
    return EnvironmentArgs(
      apiProxyType: (() { final guardedValue = map['apiProxyType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EnvironmentApiProxyType.fromValue(guardedValue as String)); })(),
      deploymentType: (() { final guardedValue = map['deploymentType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EnvironmentDeploymentType.fromValue(guardedValue as String)); })(),
      ...
      hasAttachedFlowHooks: (() { final guardedValue = map['hasAttachedFlowHooks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      nodeConfig: (() { final guardedValue = map['nodeConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudApigeeV1NodeConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EnvironmentType.fromValue(guardedValue as String)); })(),
    );
  }
}
