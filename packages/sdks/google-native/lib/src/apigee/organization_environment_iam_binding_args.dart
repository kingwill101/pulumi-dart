...
/// {@template pulumi_apigee_v1_organization_environment_iam_binding_args_doc}
/// The set of arguments for OrganizationEnvironmentIamBinding.
/// {@endtemplate}
/// {@macro pulumi_apigee_v1_organization_environment_iam_binding_args_doc}
class OrganizationEnvironmentIamBindingArgs {
  ...
  /// Creates a new [OrganizationEnvironmentIamBindingArgs].
  ...
  const OrganizationEnvironmentIamBindingArgs({
    this.condition,
  ...
  factory OrganizationEnvironmentIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return OrganizationEnvironmentIamBindingArgs(
