...
class SecurityAction extends pulumi.CustomResource {
  ...
  SecurityAction(
    ...
    this.conditionConfig = registerOutput<GoogleCloudApigeeV1SecurityActionConditionConfigResponse>('conditionConfig');
    this.createTime = registerOutput<String>('createTime');
    this.deny = registerOutput<GoogleCloudApigeeV1SecurityActionDenyResponse>('deny');
    this.description = registerOutput<String>('description');
    this.environmentId = registerOutput<String>('environmentId');
    this.expireTime = registerOutput<String>('expireTime');
    this.flag = registerOutput<GoogleCloudApigeeV1SecurityActionFlagResponse>('flag');
