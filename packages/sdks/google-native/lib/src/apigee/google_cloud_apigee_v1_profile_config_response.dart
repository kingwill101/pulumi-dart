...
class GoogleCloudApigeeV1ProfileConfigResponse {
  ...
  factory GoogleCloudApigeeV1ProfileConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudApigeeV1ProfileConfigResponse(
      categories: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudApigeeV1ProfileConfigCategoryResponse>(map['categories']!, (value) => GoogleCloudApigeeV1ProfileConfigCategoryResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
