...
class GoogleCloudApigeeV1OperationGroup {
  ...
  const GoogleCloudApigeeV1OperationGroup({
  ...
  factory GoogleCloudApigeeV1OperationGroup.fromMap(Map<String, dynamic> map) {
    return GoogleCloudApigeeV1OperationGroup(
      ...
      operationConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudApigeeV1OperationConfig>(map['operationConfigs']!, (value) => GoogleCloudApigeeV1OperationConfig.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
