...
class GetRatePlanResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'consumptionPricingRates': pulumi.Input.encodeList<GoogleCloudApigeeV1RateRangeResponse, Map<String, dynamic>>(consumptionPricingRates, (value) => value.toMap()),
      ...
      'revenueShareRates': pulumi.Input.encodeList<GoogleCloudApigeeV1RevenueShareRangeResponse, Map<String, dynamic>>(revenueShareRates, (value) => value.toMap()),
  ...
  factory GetRatePlanResult.fromMap(Map<String, dynamic> map) {
    return GetRatePlanResult(
      ...
      consumptionPricingRates: pulumi.Input.decodeList<GoogleCloudApigeeV1RateRangeResponse>(map['consumptionPricingRates']!, (value) => GoogleCloudApigeeV1RateRangeResponse.fromMap((value as Map).cast<String, dynamic>())),
      ...
      fixedRecurringFee: GoogleTypeMoneyResponse.fromMap((map['fixedRecurringFee']! as Map).cast<String, dynamic>()),
      lastModifiedAt: map['lastModifiedAt'] as String,
      name: map['name'] as String,
      paymentFundingModel: map['paymentFundingModel'] as String,
      revenueShareRates: pulumi.Input.decodeList<GoogleCloudApigeeV1RevenueShareRangeResponse>(map['revenueShareRates']!, (value) => GoogleCloudApigeeV1RevenueShareRangeResponse.fromMap((value as Map).cast<String, dynamic>())),
      revenueShareType: map['revenueShareType'] as String,
      setupFee: GoogleTypeMoneyResponse.fromMap((map['setupFee']! as Map).cast<String, dynamic>()),
