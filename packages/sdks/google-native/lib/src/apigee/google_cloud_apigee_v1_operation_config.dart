...
class GoogleCloudApigeeV1OperationConfig {
  ...
  const GoogleCloudApigeeV1OperationConfig({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'operations': ?pulumi.Input.mapOptionalInputValue<List<GoogleCloudApigeeV1Operation>, List<Map<String, dynamic>>>(operations, (value) => pulumi.Input.encodeList<GoogleCloudApigeeV1Operation, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory GoogleCloudApigeeV1OperationConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudApigeeV1OperationConfig(
      ...
      operations: (() { final guardedValue = map['operations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudApigeeV1Operation>(guardedValue, (value) => GoogleCloudApigeeV1Operation.fromMap((value as Map).cast<String, dynamic>()))); })(),
      quota: (() { final guardedValue = map['quota']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudApigeeV1Quota.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
