...
class HostSecurityReportArgs {
  ...
  factory HostSecurityReportArgs.fromMap(Map<String, dynamic> map) {
    return HostSecurityReportArgs(
      ...
      envgroupHostname: (() {
        final guardedValue = map['envgroupHostname'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      filter: (() {
      ...
      groupByTimeUnit: (() {
        final guardedValue = map['groupByTimeUnit'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      limit: (() {
      ...
      metrics: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GoogleCloudApigeeV1SecurityReportQueryMetric>(
            guardedValue,
      ...
      reportDefinitionId: (() {
        final guardedValue = map['reportDefinitionId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
