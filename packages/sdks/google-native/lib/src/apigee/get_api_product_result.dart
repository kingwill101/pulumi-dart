...
class GetApiProductResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'graphqlOperationGroup': graphqlOperationGroup.toMap(),
      'grpcOperationGroup': grpcOperationGroup.toMap(),
      'lastModifiedAt': lastModifiedAt,
      'name': name,
      'operationGroup': operationGroup.toMap(),
      'proxies': proxies,
      'quota': quota,
  ...
  factory GetApiProductResult.fromMap(Map<String, dynamic> map) {
    return GetApiProductResult(
      ...
      graphqlOperationGroup: GoogleCloudApigeeV1GraphQLOperationGroupResponse.fromMap((map['graphqlOperationGroup']! as Map).cast<String, dynamic>()),
      grpcOperationGroup: GoogleCloudApigeeV1GrpcOperationGroupResponse.fromMap((map['grpcOperationGroup']! as Map).cast<String, dynamic>()),
      lastModifiedAt: map['lastModifiedAt'] as String,
      name: map['name'] as String,
      operationGroup: GoogleCloudApigeeV1OperationGroupResponse.fromMap((map['operationGroup']! as Map).cast<String, dynamic>()),
