...
class SecurityProfile extends pulumi.CustomResource {
  ...
  late final pulumi.Output<GoogleCloudApigeeV1ProfileConfigResponse> profileConfig;
  ...
  SecurityProfile(
    ...
    profileConfig = registerOutput<GoogleCloudApigeeV1ProfileConfigResponse>('profileConfig', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return GoogleCloudApigeeV1ProfileConfigResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    scoringConfigs = registerOutput<List<Map<String, dynamic>>>('scoringConfigs');
