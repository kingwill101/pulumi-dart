...
class GoogleCloudApigeeV1RevenueShareRange {
  ...
  const GoogleCloudApigeeV1RevenueShareRange({
    this.end,
  ...
  factory GoogleCloudApigeeV1RevenueShareRange.fromMap(Map<String, dynamic> map) {
    return GoogleCloudApigeeV1RevenueShareRange(
      ...
      sharePercentage: (() { final guardedValue = map['sharePercentage']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as double); })(),
