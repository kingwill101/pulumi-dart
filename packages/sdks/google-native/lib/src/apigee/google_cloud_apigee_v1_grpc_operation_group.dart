...
class GoogleCloudApigeeV1GrpcOperationGroup {
  ...
  final pulumi.Input<List<GoogleCloudApigeeV1GrpcOperationConfig>> operationConfigs;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'operationConfigs': pulumi.Input.mapInputValue<List<GoogleCloudApigeeV1GrpcOperationConfig>, List<Map<String, dynamic>>>(operationConfigs, (value) => pulumi.Input.encodeList<GoogleCloudApigeeV1GrpcOperationConfig, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory GoogleCloudApigeeV1GrpcOperationGroup.fromMap(Map<String, dynamic> map) {
    return GoogleCloudApigeeV1GrpcOperationGroup(
      operationConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudApigeeV1GrpcOperationConfig>(map['operationConfigs']!, (value) => GoogleCloudApigeeV1GrpcOperationConfig.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
