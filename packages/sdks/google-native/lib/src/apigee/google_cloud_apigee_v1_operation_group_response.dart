...
class GoogleCloudApigeeV1OperationGroupResponse {
  ...
  final pulumi.Input<List<GoogleCloudApigeeV1OperationConfigResponse>> operationConfigs;
  ...
  const GoogleCloudApigeeV1OperationGroupResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'operationConfigs': pulumi.Input.mapInputValue<List<GoogleCloudApigeeV1OperationConfigResponse>, List<Map<String, dynamic>>>(operationConfigs, (value) => pulumi.Input.encodeList<GoogleCloudApigeeV1OperationConfigResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory GoogleCloudApigeeV1OperationGroupResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudApigeeV1OperationGroupResponse(
      operationConfigType: pulumi.Input.fromValue(map['operationConfigType'] as String),
      operationConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudApigeeV1OperationConfigResponse>(map['operationConfigs']!, (value) => GoogleCloudApigeeV1OperationConfigResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
