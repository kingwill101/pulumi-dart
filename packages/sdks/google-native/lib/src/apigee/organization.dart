...
class Organization extends pulumi.CustomResource {
  ...
  late final pulumi.Output<GoogleCloudApigeeV1AddonsConfigResponse> addonsConfig;
  ...
  Organization(
    ...
    this.addonsConfig = registerOutput<GoogleCloudApigeeV1AddonsConfigResponse>('addonsConfig');
    this.analyticsRegion = registerOutput<String>('analyticsRegion');
    this.apiConsumerDataEncryptionKeyName = registerOutput<String>('apiConsumerDataEncryptionKeyName');
    this.apiConsumerDataLocation = registerOutput<String>('apiConsumerDataLocation');
    ...
    this.controlPlaneEncryptionKeyName = registerOutput<String>('controlPlaneEncryptionKeyName');
    ...
    this.properties = registerOutput<GoogleCloudApigeeV1PropertiesResponse>('properties');
    this.runtimeDatabaseEncryptionKeyName = registerOutput<String>('runtimeDatabaseEncryptionKeyName');
