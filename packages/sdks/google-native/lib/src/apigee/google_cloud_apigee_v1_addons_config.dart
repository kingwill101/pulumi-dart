...
class GoogleCloudApigeeV1AddonsConfig {
  ...
  final pulumi.Input<GoogleCloudApigeeV1AdvancedApiOpsConfig>?
  ...
  final pulumi.Input<GoogleCloudApigeeV1ConnectorsPlatformConfig>?
  ...
  factory GoogleCloudApigeeV1AddonsConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudApigeeV1AddonsConfig(
      ...
      analyticsConfig: (() {
        final guardedValue = map['analyticsConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
