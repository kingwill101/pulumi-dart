...
class ApiProductArgs {
  ...
  final pulumi.Input<GoogleCloudApigeeV1GraphQLOperationGroup>? graphqlOperationGroup;
  ...
  ApiProductArgs({
    pulumi.Output<List<String>>? apiResources,
    pulumi.Output<String>? approvalType,
    pulumi.Output<List<GoogleCloudApigeeV1Attribute>>? attributes,
    pulumi.Output<String>? createdAt,
    pulumi.Output<String>? description,
    pulumi.Output<String>? displayName,
    pulumi.Output<List<String>>? environments,
    pulumi.Output<GoogleCloudApigeeV1GraphQLOperationGroup>? graphqlOperationGroup,
    pulumi.Output<GoogleCloudApigeeV1GrpcOperationGroup>? grpcOperationGroup,
    pulumi.Output<String>? lastModifiedAt,
    pulumi.Output<String>? name,
    pulumi.Output<GoogleCloudApigeeV1OperationGroup>? operationGroup,
    required pulumi.Output<String> organizationId,
    pulumi.Output<List<String>>? proxies,
    pulumi.Output<String>? quota,
    pulumi.Output<ApiProductQuotaCounterScope>? quotaCounterScope,
    pulumi.Output<String>? quotaInterval,
    pulumi.Output<String>? quotaTimeUnit,
    pulumi.Output<List<String>>? scopes,
      ...
      graphqlOperationGroup = pulumi.Input.asOptionalInput<GoogleCloudApigeeV1GraphQLOperationGroup>(graphqlOperationGroup),
      grpcOperationGroup = pulumi.Input.asOptionalInput<GoogleCloudApigeeV1GrpcOperationGroup>(grpcOperationGroup),
      lastModifiedAt = pulumi.Input.asOptionalInput<String>(lastModifiedAt),
      name = pulumi.Input.asOptionalInput<String>(name),
      operationGroup = pulumi.Input.asOptionalInput<GoogleCloudApigeeV1OperationGroup>(operationGroup),
      organizationId = pulumi.Input.asInput<String>(organizationId),
      proxies = pulumi.Input.asOptionalInput<List<String>>(proxies),
      quota = pulumi.Input.asOptionalInput<String>(quota),
      quotaCounterScope = pulumi.Input.asOptionalInput<ApiProductQuotaCounterScope>(quotaCounterScope),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'graphqlOperationGroup': ?pulumi.Input.mapOptionalInputValue<GoogleCloudApigeeV1GraphQLOperationGroup, Map<String, dynamic>>(graphqlOperationGroup, (value) => value.toMap()),
      'grpcOperationGroup': ?pulumi.Input.mapOptionalInputValue<GoogleCloudApigeeV1GrpcOperationGroup, Map<String, dynamic>>(grpcOperationGroup, (value) => value.toMap()),
      'lastModifiedAt': ?lastModifiedAt,
      'name': ?name,
      'operationGroup': ?pulumi.Input.mapOptionalInputValue<GoogleCloudApigeeV1OperationGroup, Map<String, dynamic>>(operationGroup, (value) => value.toMap()),
      'organizationId': organizationId,
      'proxies': ?proxies,
      'quota': ?quota,
      'quotaCounterScope': ?pulumi.Input.mapOptionalInputValue<ApiProductQuotaCounterScope, String>(quotaCounterScope, (value) => value.value),
  ...
  factory ApiProductArgs.fromMap(Map<String, dynamic> map) {
    return ApiProductArgs(
      apiResources: map['apiResources'] == null ? null : pulumi.Output.create<List<String>>((map['apiResources'] as List).cast<String>()),
      approvalType: map['approvalType'] == null ? null : pulumi.Output.create<String>(map['approvalType'] as String),
      ...
      environments: map['environments'] == null ? null : pulumi.Output.create<List<String>>((map['environments'] as List).cast<String>()),
      graphqlOperationGroup: map['graphqlOperationGroup'] == null ? null : pulumi.Output.create<GoogleCloudApigeeV1GraphQLOperationGroup>(GoogleCloudApigeeV1GraphQLOperationGroup.fromMap((map['graphqlOperationGroup'] as Map).cast<String, dynamic>())),
      grpcOperationGroup: map['grpcOperationGroup'] == null ? null : pulumi.Output.create<GoogleCloudApigeeV1GrpcOperationGroup>(GoogleCloudApigeeV1GrpcOperationGroup.fromMap((map['grpcOperationGroup'] as Map).cast<String, dynamic>())),
      lastModifiedAt: map['lastModifiedAt'] == null ? null : pulumi.Output.create<String>(map['lastModifiedAt'] as String),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      operationGroup: map['operationGroup'] == null ? null : pulumi.Output.create<GoogleCloudApigeeV1OperationGroup>(GoogleCloudApigeeV1OperationGroup.fromMap((map['operationGroup'] as Map).cast<String, dynamic>())),
      organizationId: pulumi.Output.create<String>(map['organizationId'] as String),
      proxies: map['proxies'] == null ? null : pulumi.Output.create<List<String>>((map['proxies'] as List).cast<String>()),
      quota: map['quota'] == null ? null : pulumi.Output.create<String>(map['quota'] as String),
      quotaCounterScope: map['quotaCounterScope'] == null ? null : pulumi.Output.create<ApiProductQuotaCounterScope>(ApiProductQuotaCounterScope.fromValue(map['quotaCounterScope'] as String)),
      quotaInterval: map['quotaInterval'] == null ? null : pulumi.Output.create<String>(map['quotaInterval'] as String),
      quotaTimeUnit: map['quotaTimeUnit'] == null ? null : pulumi.Output.create<String>(map['quotaTimeUnit'] as String),
