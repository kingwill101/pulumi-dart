...
class ApiProductArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'proxies': ?proxies,
      'quota': ?quota,
      'quotaCounterScope': ?pulumi.Input.mapOptionalInputValue<ApiProductQuotaCounterScope, String>(quotaCounterScope, (value) => value.wireValue),
  ...
  factory ApiProductArgs.fromMap(Map<String, dynamic> map) {
    return ApiProductArgs(
      ...
      graphqlOperationGroup: (() { final guardedValue = map['graphqlOperationGroup']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudApigeeV1GraphQLOperationGroup.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      grpcOperationGroup: (() { final guardedValue = map['grpcOperationGroup']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudApigeeV1GrpcOperationGroup.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      operationGroup: (() { final guardedValue = map['operationGroup']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudApigeeV1OperationGroup.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      quotaCounterScope: (() { final guardedValue = map['quotaCounterScope']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ApiProductQuotaCounterScope.fromValue(guardedValue as String)); })(),
