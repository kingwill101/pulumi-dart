...
class ApiProductArgs {
  ...
  factory ApiProductArgs.fromMap(Map<String, dynamic> map) {
    return ApiProductArgs(
      ...
      graphqlOperationGroup: map['graphqlOperationGroup'] == null ? null : (GoogleCloudApigeeV1GraphQLOperationGroup.fromMap((map['graphqlOperationGroup'] as Map).cast<String, dynamic>())).input(),
      grpcOperationGroup: map['grpcOperationGroup'] == null ? null : (GoogleCloudApigeeV1GrpcOperationGroup.fromMap((map['grpcOperationGroup'] as Map).cast<String, dynamic>())).input(),
      lastModifiedAt: map['lastModifiedAt'] == null ? null : (map['lastModifiedAt'] as String).input(),
      name: map['name'] == null ? null : (map['name'] as String).input(),
      operationGroup: map['operationGroup'] == null ? null : (GoogleCloudApigeeV1OperationGroup.fromMap((map['operationGroup'] as Map).cast<String, dynamic>())).input(),
      ...
      quotaCounterScope: map['quotaCounterScope'] == null ? null : (ApiProductQuotaCounterScope.fromValue(map['quotaCounterScope'] as String)).input(),
