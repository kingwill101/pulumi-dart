...
class GoogleCloudApigeeV1GraphQLOperationConfigResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'operations': pulumi.Input.encodeList<GoogleCloudApigeeV1GraphQLOperationResponse, Map<String, dynamic>>(operations, (value) => value.toMap()),
      'quota': quota.toMap(),
    };
  }
  ...
  factory GoogleCloudApigeeV1GraphQLOperationConfigResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudApigeeV1GraphQLOperationConfigResponse(
      ...
      operations: pulumi.Input.decodeList<GoogleCloudApigeeV1GraphQLOperationResponse>(map['operations'], (value) => GoogleCloudApigeeV1GraphQLOperationResponse.fromMap((value as Map).cast<String, dynamic>())),
