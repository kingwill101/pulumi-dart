...
class GoogleCloudApigeeV1GraphQLOperationGroup {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'operationConfigs': pulumi.Input.encodeList<GoogleCloudApigeeV1GraphQLOperationConfig, Map<String, dynamic>>(operationConfigs, (value) => value.toMap()),
    };
  }
  ...
  factory GoogleCloudApigeeV1GraphQLOperationGroup.fromMap(Map<String, dynamic> map) {
    return GoogleCloudApigeeV1GraphQLOperationGroup(
      ...
      operationConfigs: pulumi.Input.decodeList<GoogleCloudApigeeV1GraphQLOperationConfig>(map['operationConfigs'], (value) => GoogleCloudApigeeV1GraphQLOperationConfig.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
