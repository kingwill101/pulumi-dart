...
class GoogleCloudApigeeV1GrpcOperationGroupResponse {
  ...
  factory GoogleCloudApigeeV1GrpcOperationGroupResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudApigeeV1GrpcOperationGroupResponse(
      operationConfigs: (pulumi.Input.decodeList<GoogleCloudApigeeV1GrpcOperationConfigResponse>(map['operationConfigs'], (value) => GoogleCloudApigeeV1GrpcOperationConfigResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
