...
class GoogleCloudApigeeV1GrpcOperationGroupResponse {
  ...
  final pulumi.Input<List<GoogleCloudApigeeV1GrpcOperationConfigResponse>>
  operationConfigs;
    ...
    return <String, dynamic>{
      'operationConfigs':
          pulumi.Input.mapInputValue<
            List<GoogleCloudApigeeV1GrpcOperationConfigResponse>,
  ...
  factory GoogleCloudApigeeV1GrpcOperationGroupResponse.fromMap(
    ...
    return GoogleCloudApigeeV1GrpcOperationGroupResponse(
      operationConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GoogleCloudApigeeV1GrpcOperationConfigResponse>(
