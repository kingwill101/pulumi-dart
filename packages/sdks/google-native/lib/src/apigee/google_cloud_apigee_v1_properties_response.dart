...
class GoogleCloudApigeeV1PropertiesResponse {
  ...
  factory GoogleCloudApigeeV1PropertiesResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudApigeeV1PropertiesResponse(
      property: (pulumi.Input.decodeList<GoogleCloudApigeeV1PropertyResponse>(map['property'], (value) => GoogleCloudApigeeV1PropertyResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
