...
class InstanceArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'peeringCidrRange': ?pulumi.Input.mapOptionalInputValue<InstancePeeringCidrRange, String>(peeringCidrRange, (value) => value.wireValue),
    };
  }

  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      consumerAcceptList: (() { final guardedValue = map['consumerAcceptList']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      ...
      peeringCidrRange: (() { final guardedValue = map['peeringCidrRange']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstancePeeringCidrRange.fromValue(guardedValue as String)); })(),
    );
  }
}
