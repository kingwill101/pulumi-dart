...
class Pipeline extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<Map<String, dynamic>>> outputParameters;
  ...
  Pipeline(
    ...
    docker = registerOutput<DockerExecutorResponse>('docker', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return DockerExecutorResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    inputParameters = registerOutput<List<Map<String, dynamic>>>('inputParameters');
    this.name = registerOutput<String>('name');
    outputParameters = registerOutput<List<Map<String, dynamic>>>('outputParameters');
    pipelineId = registerOutput<String>('pipelineId');
    project = registerOutput<String>('project');
    resources = registerOutput<PipelineResourcesResponse>('resources', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return PipelineResourcesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  }
}
