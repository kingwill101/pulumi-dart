...
class PipelineResourcesResponse {
  ...
  factory PipelineResourcesResponse.fromMap(Map<String, dynamic> map) {
    return PipelineResourcesResponse(
      ...
      disks: (pulumi.Input.decodeList<DiskResponse>(map['disks'], (value) => DiskResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      minimumCpuCores: (map['minimumCpuCores'] as int).input(),
      minimumRamGb: (map['minimumRamGb'] as double).input(),
      noAddress: (map['noAddress'] as bool).input(),
