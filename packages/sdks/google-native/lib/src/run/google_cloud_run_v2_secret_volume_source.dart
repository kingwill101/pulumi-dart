...
class GoogleCloudRunV2SecretVolumeSource {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'items': ?items == null ? null : pulumi.Input.encodeList<GoogleCloudRunV2VersionToPath, Map<String, dynamic>>(items!, (value) => value.toMap()),
      'secret': secret,
    };
  }
  ...
  factory GoogleCloudRunV2SecretVolumeSource.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRunV2SecretVolumeSource(
      ...
      items: map['items'] == null ? null : pulumi.Input.decodeList<GoogleCloudRunV2VersionToPath>(map['items'], (value) => GoogleCloudRunV2VersionToPath.fromMap((value as Map).cast<String, dynamic>())),
