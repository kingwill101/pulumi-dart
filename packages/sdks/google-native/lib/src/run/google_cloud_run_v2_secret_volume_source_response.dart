...
class GoogleCloudRunV2SecretVolumeSourceResponse {
    ...
    return <String, dynamic>{
      ...
      'items':
          pulumi.Input.mapInputValue<
            List<GoogleCloudRunV2VersionToPathResponse>,
  ...
  factory GoogleCloudRunV2SecretVolumeSourceResponse.fromMap(
    ...
    return GoogleCloudRunV2SecretVolumeSourceResponse(
      ...
      items: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GoogleCloudRunV2VersionToPathResponse>(
          map['items']!,
