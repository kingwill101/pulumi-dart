...
class GoogleCloudRunV2ProbeResponse {
  ...
  factory GoogleCloudRunV2ProbeResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRunV2ProbeResponse(
      ...
      grpc: (GoogleCloudRunV2GRPCActionResponse.fromMap((map['grpc'] as Map).cast<String, dynamic>())).input(),
      httpGet: (GoogleCloudRunV2HTTPGetActionResponse.fromMap((map['httpGet'] as Map).cast<String, dynamic>())).input(),
      initialDelaySeconds: (map['initialDelaySeconds'] as int).input(),
      periodSeconds: (map['periodSeconds'] as int).input(),
      tcpSocket: (GoogleCloudRunV2TCPSocketActionResponse.fromMap((map['tcpSocket'] as Map).cast<String, dynamic>())).input(),
