...
class ProbeResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'exec':
          pulumi.Input.mapInputValue<ExecActionResponse, Map<String, dynamic>>(
            exec,
            (value) => value.toMap(),
          ),
      'failureThreshold': failureThreshold,
      'grpc':
          pulumi.Input.mapInputValue<GRPCActionResponse, Map<String, dynamic>>(
            grpc,
            (value) => value.toMap(),
          ),
      'httpGet':
  ...
  factory ProbeResponse.fromMap(Map<String, dynamic> map) {
    return ProbeResponse(
      ...
      grpc: pulumi.Input.fromValue(
        GRPCActionResponse.fromMap(
          (map['grpc']! as Map).cast<String, dynamic>(),
        ),
      ),
      httpGet: pulumi.Input.fromValue(
        HTTPGetActionResponse.fromMap(
      ...
      tcpSocket: pulumi.Input.fromValue(
        TCPSocketActionResponse.fromMap(
