...
class ObjectMetaResponse {
  ...
  factory ObjectMetaResponse.fromMap(Map<String, dynamic> map) {
    return ObjectMetaResponse(
      ...
      deletionGracePeriodSeconds: (map['deletionGracePeriodSeconds'] as int).input(),
      deletionTimestamp: (map['deletionTimestamp'] as String).input(),
      finalizers: ((map['finalizers'] as List).cast<String>()).input(),
      generateName: (map['generateName'] as String).input(),
      generation: (map['generation'] as int).input(),
      labels: ((map['labels'] as Map).cast<String, String>()).input(),
      name: (map['name'] as String).input(),
      namespace: (map['namespace'] as String).input(),
      ownerReferences: (pulumi.Input.decodeList<OwnerReferenceResponse>(map['ownerReferences'], (value) => OwnerReferenceResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
