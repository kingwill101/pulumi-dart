...
class ObjectMetaResponse {
  ...
  factory ObjectMetaResponse.fromMap(Map<String, dynamic> map) {
    return ObjectMetaResponse(
      ...
      deletionGracePeriodSeconds: pulumi.Input.fromValue(
        map['deletionGracePeriodSeconds'] as int,
      ),
      deletionTimestamp: pulumi.Input.fromValue(
        map['deletionTimestamp'] as String,
      ),
      finalizers: pulumi.Input.fromValue(
      ...
      ownerReferences: pulumi.Input.fromValue(
        pulumi.Input.decodeList<OwnerReferenceResponse>(
          map['ownerReferences']!,
