...
class ServiceStatus {
  ...
  factory ServiceStatus.fromMap(Map<String, dynamic> map) {
    return ServiceStatus(
      address: (() { final guardedValue = map['address']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Addressable.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
