...
/// {@template pulumi_run_v2_service_iam_member_run_v2_args_doc}
/// The set of arguments for ServiceIamMember.
/// {@endtemplate}
/// {@macro pulumi_run_v2_service_iam_member_run_v2_args_doc}
class ServiceIamMemberRunV2Args {
  ...
  /// Creates a new [ServiceIamMemberRunV2Args].
  ...
  const ServiceIamMemberRunV2Args({
    this.condition,
  ...
  factory ServiceIamMemberRunV2Args.fromMap(Map<String, dynamic> map) {
    return ServiceIamMemberRunV2Args(
