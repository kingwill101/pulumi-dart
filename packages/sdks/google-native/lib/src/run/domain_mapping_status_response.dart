...
class DomainMappingStatusResponse {
  ...
  factory DomainMappingStatusResponse.fromMap(Map<String, dynamic> map) {
    return DomainMappingStatusResponse(
      ...
      mappedRouteName: (map['mappedRouteName'] as String).input(),
      observedGeneration: (map['observedGeneration'] as int).input(),
      resourceRecords: (pulumi.Input.decodeList<ResourceRecordResponse>(map['resourceRecords'], (value) => ResourceRecordResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
