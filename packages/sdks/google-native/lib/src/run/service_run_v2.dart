...
class ServiceRunV2 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<GoogleCloudRunV2ConditionResponse>> conditions;
  /// The creation time.
  ...
  late final pulumi.Output<List<GoogleCloudRunV2TrafficTargetResponse>> traffic;
  /// Detailed status information for corresponding traffic targets. See comments in `reconciling` for additional information on reconciliation process in Cloud Run.
  late final pulumi.Output<List<GoogleCloudRunV2TrafficTargetStatusResponse>> trafficStatuses;
  ...
  ServiceRunV2(
    ...
    this.binaryAuthorization = registerOutput<GoogleCloudRunV2BinaryAuthorizationResponse>('binaryAuthorization');
    this.client = registerOutput<String>('client');
    this.clientVersion = registerOutput<String>('clientVersion');
    this.conditions = registerOutput<List<GoogleCloudRunV2ConditionResponse>>('conditions');
    ...
    this.scaling = registerOutput<GoogleCloudRunV2ServiceScalingResponse>('scaling');
    this.serviceId = registerOutput<String>('serviceId');
    this.template = registerOutput<GoogleCloudRunV2RevisionTemplateResponse>('template');
    this.terminalCondition = registerOutput<GoogleCloudRunV2ConditionResponse>('terminalCondition');
    this.traffic = registerOutput<List<GoogleCloudRunV2TrafficTargetResponse>>('traffic');
    this.trafficStatuses = registerOutput<List<GoogleCloudRunV2TrafficTargetStatusResponse>>('trafficStatuses');
