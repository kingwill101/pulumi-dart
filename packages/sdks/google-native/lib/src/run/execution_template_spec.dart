...
class ExecutionTemplateSpec {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'spec': pulumi.Input.mapInputValue<ExecutionSpec, Map<String, dynamic>>(spec, (value) => value.toMap()),
    };
  }
  ...
  factory ExecutionTemplateSpec.fromMap(Map<String, dynamic> map) {
    return ExecutionTemplateSpec(
      ...
      spec: pulumi.Input.fromValue(ExecutionSpec.fromMap((map['spec']! as Map).cast<String, dynamic>())),
    );
  }
}
