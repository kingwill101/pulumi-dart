...
class GoogleCloudRunV2VolumeResponse {
  ...
  factory GoogleCloudRunV2VolumeResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRunV2VolumeResponse(
      cloudSqlInstance: (GoogleCloudRunV2CloudSqlInstanceResponse.fromMap((map['cloudSqlInstance'] as Map).cast<String, dynamic>())).input(),
      emptyDir: (GoogleCloudRunV2EmptyDirVolumeSourceResponse.fromMap((map['emptyDir'] as Map).cast<String, dynamic>())).input(),
      name: (map['name'] as String).input(),
      secret: (GoogleCloudRunV2SecretVolumeSourceResponse.fromMap((map['secret'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
