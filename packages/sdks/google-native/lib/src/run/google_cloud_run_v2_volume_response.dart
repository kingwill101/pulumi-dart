...
class GoogleCloudRunV2VolumeResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'cloudSqlInstance': pulumi.Input.mapInputValue<GoogleCloudRunV2CloudSqlInstanceResponse, Map<String, dynamic>>(cloudSqlInstance, (value) => value.toMap()),
      'emptyDir': pulumi.Input.mapInputValue<GoogleCloudRunV2EmptyDirVolumeSourceResponse, Map<String, dynamic>>(emptyDir, (value) => value.toMap()),
      'name': name,
      'secret': pulumi.Input.mapInputValue<GoogleCloudRunV2SecretVolumeSourceResponse, Map<String, dynamic>>(secret, (value) => value.toMap()),
    };
  }

  factory GoogleCloudRunV2VolumeResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRunV2VolumeResponse(
      cloudSqlInstance: pulumi.Input.fromValue(GoogleCloudRunV2CloudSqlInstanceResponse.fromMap((map['cloudSqlInstance']! as Map).cast<String, dynamic>())),
      emptyDir: pulumi.Input.fromValue(GoogleCloudRunV2EmptyDirVolumeSourceResponse.fromMap((map['emptyDir']! as Map).cast<String, dynamic>())),
      name: pulumi.Input.fromValue(map['name'] as String),
      secret: pulumi.Input.fromValue(GoogleCloudRunV2SecretVolumeSourceResponse.fromMap((map['secret']! as Map).cast<String, dynamic>())),
    );
  }
}
