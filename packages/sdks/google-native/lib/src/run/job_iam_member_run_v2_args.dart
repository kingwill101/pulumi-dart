...
/// {@template pulumi_run_v2_job_iam_member_run_v2_args_doc}
/// The set of arguments for JobIamMember.
/// {@endtemplate}
/// {@macro pulumi_run_v2_job_iam_member_run_v2_args_doc}
class JobIamMemberRunV2Args {
  ...
  /// Creates a new [JobIamMemberRunV2Args].
  ...
  factory JobIamMemberRunV2Args.fromMap(Map<String, dynamic> map) {
    return JobIamMemberRunV2Args(
