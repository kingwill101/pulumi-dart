...
class JobArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'jobId': jobId,
      'labels': ?labels,
      'launchStage': ?pulumi.Input.mapOptionalInputValue<JobLaunchStage, String>(launchStage, (value) => value.wireValue),
      'location': ?location,
      'name': ?name,
      'project': ?project,
      'template': pulumi.Input.mapInputValue<GoogleCloudRunV2ExecutionTemplate, Map<String, dynamic>>(template, (value) => value.toMap()),
    };
  }
  ...
  factory JobArgs.fromMap(Map<String, dynamic> map) {
    return JobArgs(
      ...
      binaryAuthorization: (() { final guardedValue = map['binaryAuthorization']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudRunV2BinaryAuthorization.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      launchStage: (() { final guardedValue = map['launchStage']; if (guardedValue == null) return null; return pulumi.Input.fromValue(JobLaunchStage.fromValue(guardedValue as String)); })(),
      location: (() { final guardedValue = map['location']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      project: (() { final guardedValue = map['project']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      template: pulumi.Input.fromValue(GoogleCloudRunV2ExecutionTemplate.fromMap((map['template']! as Map).cast<String, dynamic>())),
    );
  }
}
