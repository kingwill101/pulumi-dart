...
class GoogleCloudRunV2HTTPGetAction {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'httpHeaders': ?httpHeaders == null ? null : pulumi.Input.encodeList<GoogleCloudRunV2HTTPHeader, Map<String, dynamic>>(httpHeaders!, (value) => value.toMap()),
      'path': ?path,
      'port': ?port,
    };
  }
  ...
  factory GoogleCloudRunV2HTTPGetAction.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRunV2HTTPGetAction(
      httpHeaders: map['httpHeaders'] == null ? null : pulumi.Input.decodeList<GoogleCloudRunV2HTTPHeader>(map['httpHeaders'], (value) => GoogleCloudRunV2HTTPHeader.fromMap((value as Map).cast<String, dynamic>())),
