...
class GoogleCloudRunV2HTTPGetAction {
  ...
  const GoogleCloudRunV2HTTPGetAction({
    this.httpHeaders,
    this.path,
    this.port,
  });
  ...
  factory GoogleCloudRunV2HTTPGetAction.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRunV2HTTPGetAction(
      httpHeaders: (() { final guardedValue = map['httpHeaders']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudRunV2HTTPHeader>(guardedValue, (value) => GoogleCloudRunV2HTTPHeader.fromMap((value as Map).cast<String, dynamic>()))); })(),
