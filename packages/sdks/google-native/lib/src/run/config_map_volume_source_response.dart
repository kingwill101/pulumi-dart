...
class ConfigMapVolumeSourceResponse {
  ...
  final pulumi.Input<List<KeyToPathResponse>> items;
  /// Name of the config.
  final pulumi.Input<String> name;
  /// (Optional) Specify whether the Secret or its keys must be defined.
  final pulumi.Input<bool> optional;

  /// Creates a new [ConfigMapVolumeSourceResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'items': pulumi.Input.mapInputValue<List<KeyToPathResponse>, List<Map<String, dynamic>>>(items, (value) => pulumi.Input.encodeList<KeyToPathResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'name': name,
      'optional': optional,
    };
  }

  factory ConfigMapVolumeSourceResponse.fromMap(Map<String, dynamic> map) {
    return ConfigMapVolumeSourceResponse(
      defaultMode: pulumi.Input.fromValue(map['defaultMode'] as int),
      items: pulumi.Input.fromValue(pulumi.Input.decodeList<KeyToPathResponse>(map['items']!, (value) => KeyToPathResponse.fromMap((value as Map).cast<String, dynamic>()))),
