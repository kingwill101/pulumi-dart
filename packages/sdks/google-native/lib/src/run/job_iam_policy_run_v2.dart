...
import 'job_iam_policy_run_v2_args.dart';

/// Sets the IAM Access control policy for the specified Job. Overwrites any existing policy.
/// Note - this resource's API doesn't support deletion. When deleted, the resource will persist
/// on Google Cloud even though it will be deleted from Pulumi state.
class JobIamPolicyRunV2 extends pulumi.CustomResource {
  ...
  /// Creates a new [JobIamPolicyRunV2].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [JobIamPolicyRunV2]. {@macro pulumi_run_v2_job_iam_policy_run_v2_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  JobIamPolicyRunV2(
    String name, {
    JobIamPolicyRunV2Args? args,
