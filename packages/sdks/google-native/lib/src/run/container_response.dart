...
class ContainerResponse {
  ...
  factory ContainerResponse.fromMap(Map<String, dynamic> map) {
    return ContainerResponse(
      ...
      env: pulumi.Input.fromValue(pulumi.Input.decodeList<EnvVarResponse>(map['env']!, (value) => EnvVarResponse.fromMap((value as Map).cast<String, dynamic>()))),
      envFrom: pulumi.Input.fromValue(pulumi.Input.decodeList<EnvFromSourceResponse>(map['envFrom']!, (value) => EnvFromSourceResponse.fromMap((value as Map).cast<String, dynamic>()))),
      image: pulumi.Input.fromValue(map['image'] as String),
      imagePullPolicy: pulumi.Input.fromValue(map['imagePullPolicy'] as String),
      livenessProbe: pulumi.Input.fromValue(ProbeResponse.fromMap((map['livenessProbe']! as Map).cast<String, dynamic>())),
      name: pulumi.Input.fromValue(map['name'] as String),
      ports: pulumi.Input.fromValue(pulumi.Input.decodeList<ContainerPortResponse>(map['ports']!, (value) => ContainerPortResponse.fromMap((value as Map).cast<String, dynamic>()))),
      readinessProbe: pulumi.Input.fromValue(ProbeResponse.fromMap((map['readinessProbe']! as Map).cast<String, dynamic>())),
      resources: pulumi.Input.fromValue(ResourceRequirementsResponse.fromMap((map['resources']! as Map).cast<String, dynamic>())),
      securityContext: pulumi.Input.fromValue(SecurityContextResponse.fromMap((map['securityContext']! as Map).cast<String, dynamic>())),
      startupProbe: pulumi.Input.fromValue(ProbeResponse.fromMap((map['startupProbe']! as Map).cast<String, dynamic>())),
      terminationMessagePath: pulumi.Input.fromValue(map['terminationMessagePath'] as String),
      terminationMessagePolicy: pulumi.Input.fromValue(map['terminationMessagePolicy'] as String),
      volumeMounts: pulumi.Input.fromValue(pulumi.Input.decodeList<VolumeMountResponse>(map['volumeMounts']!, (value) => VolumeMountResponse.fromMap((value as Map).cast<String, dynamic>()))),
