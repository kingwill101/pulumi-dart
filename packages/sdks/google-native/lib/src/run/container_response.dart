    ...
    return <String, dynamic>{
      ...
      'env':
          ...
          >(
            env,
            (value) =>
                pulumi.Input.encodeList<EnvVarResponse, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      ...
      'livenessProbe':
          pulumi.Input.mapInputValue<ProbeResponse, Map<String, dynamic>>(
            livenessProbe,
            (value) => value.toMap(),
          ),
      'name': name,
  ...
  factory ContainerResponse.fromMap(Map<String, dynamic> map) {
    return ContainerResponse(
      ...
      env: pulumi.Input.fromValue(
        pulumi.Input.decodeList<EnvVarResponse>(
          map['env']!,
          (value) =>
              EnvVarResponse.fromMap((value as Map).cast<String, dynamic>()),
        ),
      ),
      envFrom: pulumi.Input.fromValue(
        pulumi.Input.decodeList<EnvFromSourceResponse>(
          map['envFrom']!,
      ...
      livenessProbe: pulumi.Input.fromValue(
        ProbeResponse.fromMap(
          (map['livenessProbe']! as Map).cast<String, dynamic>(),
        ),
      ),
      name: pulumi.Input.fromValue(map['name'] as String),
      ports: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ContainerPortResponse>(
          map['ports']!,
      ...
      readinessProbe: pulumi.Input.fromValue(
        ProbeResponse.fromMap(
      ...
      securityContext: pulumi.Input.fromValue(
        SecurityContextResponse.fromMap(
      ...
      terminationMessagePath: pulumi.Input.fromValue(
        map['terminationMessagePath'] as String,
      ),
      terminationMessagePolicy: pulumi.Input.fromValue(
