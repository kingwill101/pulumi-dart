    ...
    return <String, dynamic>{
      'conditions':
          pulumi.Input.mapInputValue<
            List<GoogleCloudRunV1ConditionResponse>,
      ...
      'latestCreatedExecution':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(latestCreatedExecution, (value) => value.toMap()),
  ...
  factory JobStatusResponse.fromMap(Map<String, dynamic> map) {
    return JobStatusResponse(
      conditions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GoogleCloudRunV1ConditionResponse>(
          map['conditions']!,
      ...
      latestCreatedExecution: pulumi.Input.fromValue(
        ExecutionReferenceResponse.fromMap(
