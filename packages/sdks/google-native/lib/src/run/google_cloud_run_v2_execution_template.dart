...
class GoogleCloudRunV2ExecutionTemplate {
  ...
  final pulumi.Input<GoogleCloudRunV2TaskTemplate> template;
  ...
  const GoogleCloudRunV2ExecutionTemplate({
    this.annotations,
    this.labels,
    this.parallelism,
    this.taskCount,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'taskCount': ?taskCount,
      'template': pulumi.Input.mapInputValue<GoogleCloudRunV2TaskTemplate, Map<String, dynamic>>(template, (value) => value.toMap()),
    };
  }
  ...
  factory GoogleCloudRunV2ExecutionTemplate.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRunV2ExecutionTemplate(
      ...
      template: pulumi.Input.fromValue(GoogleCloudRunV2TaskTemplate.fromMap((map['template']! as Map).cast<String, dynamic>())),
    );
  }
}
