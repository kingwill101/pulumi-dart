    ...
    return <String, dynamic>{
      ...
      'containers':
          pulumi.Input.mapInputValue<
            List<GoogleCloudRunV2ContainerResponse>,
      ...
      'volumes':
          pulumi.Input.mapInputValue<
            List<GoogleCloudRunV2VolumeResponse>,
            List<Map<String, dynamic>>
          >(
            volumes,
            (value) =>
  ...
  factory GoogleCloudRunV2RevisionTemplateResponse.fromMap(
    ...
    return GoogleCloudRunV2RevisionTemplateResponse(
      ...
      containers: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GoogleCloudRunV2ContainerResponse>(
          map['containers']!,
      ...
      scaling: pulumi.Input.fromValue(
        GoogleCloudRunV2RevisionScalingResponse.fromMap(
      ...
      volumes: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GoogleCloudRunV2VolumeResponse>(
          map['volumes']!,
      ...
      vpcAccess: pulumi.Input.fromValue(
        GoogleCloudRunV2VpcAccessResponse.fromMap(
