...
class GoogleCloudRunV2VersionToPathResponse {
  ...
  /// Creates a new [GoogleCloudRunV2VersionToPathResponse].
  ...
  const GoogleCloudRunV2VersionToPathResponse({
    required this.mode,
    required this.path,
  ...
  factory GoogleCloudRunV2VersionToPathResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRunV2VersionToPathResponse(
