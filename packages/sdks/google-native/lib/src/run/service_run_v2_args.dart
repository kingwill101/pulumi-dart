...
class ServiceRunV2Args {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ingress': ?pulumi.Input.mapOptionalInputValue<ServiceIngress, String>(ingress, (value) => value.wireValue),
      'labels': ?labels,
      'launchStage': ?pulumi.Input.mapOptionalInputValue<ServiceLaunchStage, String>(launchStage, (value) => value.wireValue),
      'location': ?location,
      'name': ?name,
      'project': ?project,
  ...
  factory ServiceRunV2Args.fromMap(Map<String, dynamic> map) {
    return ServiceRunV2Args(
      ...
      ingress: (() { final guardedValue = map['ingress']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServiceIngress.fromValue(guardedValue as String)); })(),
      labels: (() { final guardedValue = map['labels']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      launchStage: (() { final guardedValue = map['launchStage']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServiceLaunchStage.fromValue(guardedValue as String)); })(),
      location: (() { final guardedValue = map['location']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      project: (() { final guardedValue = map['project']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      scaling: (() { final guardedValue = map['scaling']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudRunV2ServiceScaling.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      serviceId: pulumi.Input.fromValue(map['serviceId'] as String),
      template: pulumi.Input.fromValue(GoogleCloudRunV2RevisionTemplate.fromMap((map['template']! as Map).cast<String, dynamic>())),
      traffic: (() { final guardedValue = map['traffic']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudRunV2TrafficTarget>(guardedValue, (value) => GoogleCloudRunV2TrafficTarget.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
