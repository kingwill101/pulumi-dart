...
class ServiceRunV2Args {
  ...
  ServiceRunV2Args({
    ...
    pulumi.Output<ServiceIngress>? ingress,
    pulumi.Output<Map<String, String>>? labels,
    pulumi.Output<ServiceLaunchStage>? launchStage,
    pulumi.Output<String>? location,
    pulumi.Output<String>? name,
    pulumi.Output<String>? project,
    pulumi.Output<GoogleCloudRunV2ServiceScaling>? scaling,
    required pulumi.Output<String> serviceId,
    required pulumi.Output<GoogleCloudRunV2RevisionTemplate> template,
    pulumi.Output<List<GoogleCloudRunV2TrafficTarget>>? traffic,
  }) :
  ...
  factory ServiceRunV2Args.fromMap(Map<String, dynamic> map) {
    return ServiceRunV2Args(
      ...
      ingress: map['ingress'] == null ? null : pulumi.Output.create<ServiceIngress>(ServiceIngress.fromValue(map['ingress'] as String)),
      labels: map['labels'] == null ? null : pulumi.Output.create<Map<String, String>>((map['labels'] as Map).cast<String, String>()),
      launchStage: map['launchStage'] == null ? null : pulumi.Output.create<ServiceLaunchStage>(ServiceLaunchStage.fromValue(map['launchStage'] as String)),
      location: map['location'] == null ? null : pulumi.Output.create<String>(map['location'] as String),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      project: map['project'] == null ? null : pulumi.Output.create<String>(map['project'] as String),
      scaling: map['scaling'] == null ? null : pulumi.Output.create<GoogleCloudRunV2ServiceScaling>(GoogleCloudRunV2ServiceScaling.fromMap((map['scaling'] as Map).cast<String, dynamic>())),
      serviceId: pulumi.Output.create<String>(map['serviceId'] as String),
      template: pulumi.Output.create<GoogleCloudRunV2RevisionTemplate>(GoogleCloudRunV2RevisionTemplate.fromMap((map['template'] as Map).cast<String, dynamic>())),
      traffic: map['traffic'] == null ? null : pulumi.Output.create<List<GoogleCloudRunV2TrafficTarget>>(pulumi.Input.decodeList<GoogleCloudRunV2TrafficTarget>(map['traffic'], (value) => GoogleCloudRunV2TrafficTarget.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
