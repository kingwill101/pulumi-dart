...
class ServiceStatusResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'address':
          pulumi.Input.mapInputValue<AddressableResponse, Map<String, dynamic>>(
            address,
            (value) => value.toMap(),
          ),
      'conditions':
  ...
  factory ServiceStatusResponse.fromMap(Map<String, dynamic> map) {
    return ServiceStatusResponse(
      ...
      traffic: pulumi.Input.fromValue(
        pulumi.Input.decodeList<TrafficTargetResponse>(
          map['traffic']!,
