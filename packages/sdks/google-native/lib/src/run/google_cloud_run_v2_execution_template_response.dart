...
import 'google_cloud_run_v2_task_template_response.dart';

/// ExecutionTemplate describes the data an execution should have when created from a template.
class GoogleCloudRunV2ExecutionTemplateResponse {
  ...
  final pulumi.Input<GoogleCloudRunV2TaskTemplateResponse> template;

  /// Creates a new [GoogleCloudRunV2ExecutionTemplateResponse].
  ...
  const GoogleCloudRunV2ExecutionTemplateResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'taskCount': taskCount,
      'template': pulumi.Input.mapInputValue<GoogleCloudRunV2TaskTemplateResponse, Map<String, dynamic>>(template, (value) => value.toMap()),
    };
  }

  factory GoogleCloudRunV2ExecutionTemplateResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudRunV2ExecutionTemplateResponse(
      ...
      template: pulumi.Input.fromValue(GoogleCloudRunV2TaskTemplateResponse.fromMap((map['template']! as Map).cast<String, dynamic>())),
    );
  }
}
