...
class GetServiceRunV2Result {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'traffic': pulumi.Input.encodeList<GoogleCloudRunV2TrafficTargetResponse, Map<String, dynamic>>(traffic, (value) => value.toMap()),
      'trafficStatuses': pulumi.Input.encodeList<GoogleCloudRunV2TrafficTargetStatusResponse, Map<String, dynamic>>(trafficStatuses, (value) => value.toMap()),
      'uid': uid,
  ...
  factory GetServiceRunV2Result.fromMap(Map<String, dynamic> map) {
    return GetServiceRunV2Result(
      ...
      scaling: GoogleCloudRunV2ServiceScalingResponse.fromMap((map['scaling']! as Map).cast<String, dynamic>()),
      template: GoogleCloudRunV2RevisionTemplateResponse.fromMap((map['template']! as Map).cast<String, dynamic>()),
      terminalCondition: GoogleCloudRunV2ConditionResponse.fromMap((map['terminalCondition']! as Map).cast<String, dynamic>()),
      traffic: pulumi.Input.decodeList<GoogleCloudRunV2TrafficTargetResponse>(map['traffic']!, (value) => GoogleCloudRunV2TrafficTargetResponse.fromMap((value as Map).cast<String, dynamic>())),
      trafficStatuses: pulumi.Input.decodeList<GoogleCloudRunV2TrafficTargetStatusResponse>(map['trafficStatuses']!, (value) => GoogleCloudRunV2TrafficTargetStatusResponse.fromMap((value as Map).cast<String, dynamic>())),
