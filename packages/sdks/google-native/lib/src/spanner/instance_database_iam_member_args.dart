...
/// {@template pulumi_spanner_v1_instance_database_iam_member_args_doc}
/// The set of arguments for InstanceDatabaseIamMember.
/// {@endtemplate}
/// {@macro pulumi_spanner_v1_instance_database_iam_member_args_doc}
class InstanceDatabaseIamMemberArgs {
  ...
  /// Creates a new [InstanceDatabaseIamMemberArgs].
  ...
  const InstanceDatabaseIamMemberArgs({
    this.condition,
  ...
  factory InstanceDatabaseIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return InstanceDatabaseIamMemberArgs(
