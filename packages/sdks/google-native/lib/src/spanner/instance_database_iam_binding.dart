...
import 'instance_database_iam_binding_args.dart';
...
class InstanceDatabaseIamBinding extends pulumi.CustomResource {
  ...
  /// Creates a new [InstanceDatabaseIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [InstanceDatabaseIamBinding]. {@macro pulumi_spanner_v1_instance_database_iam_binding_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  InstanceDatabaseIamBinding(
    String name, {
    InstanceDatabaseIamBindingArgs? args,
