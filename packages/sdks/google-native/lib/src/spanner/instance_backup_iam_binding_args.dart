...
/// {@template pulumi_spanner_v1_instance_backup_iam_binding_args_doc}
/// The set of arguments for InstanceBackupIamBinding.
/// {@endtemplate}
/// {@macro pulumi_spanner_v1_instance_backup_iam_binding_args_doc}
class InstanceBackupIamBindingArgs {
  ...
  /// Creates a new [InstanceBackupIamBindingArgs].
  ...
  const InstanceBackupIamBindingArgs({
    this.condition,
  ...
  factory InstanceBackupIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return InstanceBackupIamBindingArgs(
