...
class InstanceConfig extends pulumi.CustomResource {
  ...
  InstanceConfig(
    ...
    this.freeInstanceAvailability = registerOutput<String>('freeInstanceAvailability');
    this.labels = registerOutput<Map<String, String>>('labels');
    this.leaderOptions = registerOutput<List<String>>('leaderOptions');
    this.name = registerOutput<String>('name');
    this.optionalReplicas = registerOutput<List<ReplicaInfoResponse>>('optionalReplicas');
