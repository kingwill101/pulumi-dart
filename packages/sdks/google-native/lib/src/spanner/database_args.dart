...
class DatabaseArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'databaseDialect': ?pulumi.Input.mapOptionalInputValue<DatabaseDatabaseDialect, String>(databaseDialect, (value) => value.wireValue),
  ...
  factory DatabaseArgs.fromMap(Map<String, dynamic> map) {
    return DatabaseArgs(
      ...
      databaseDialect: (() { final guardedValue = map['databaseDialect']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DatabaseDatabaseDialect.fromValue(guardedValue as String)); })(),
      ...
      extraStatements: (() { final guardedValue = map['extraStatements']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      instanceId: pulumi.Input.fromValue(map['instanceId'] as String),
      project: (() { final guardedValue = map['project']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      protoDescriptors: (() { final guardedValue = map['protoDescriptors']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
