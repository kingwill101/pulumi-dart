...
class BackupArgs {
  ...
  factory BackupArgs.fromMap(Map<String, dynamic> map) {
    return BackupArgs(
      ...
      encryptionConfigEncryptionType: pulumi.Input.fromValue(map['encryptionConfigEncryptionType'] as String),
      encryptionConfigKmsKeyName: (() { final guardedValue = map['encryptionConfigKmsKeyName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      versionTime: (() { final guardedValue = map['versionTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
