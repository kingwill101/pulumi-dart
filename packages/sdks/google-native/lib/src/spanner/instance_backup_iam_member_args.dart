...
/// {@template pulumi_spanner_v1_instance_backup_iam_member_args_doc}
/// The set of arguments for InstanceBackupIamMember.
/// {@endtemplate}
/// {@macro pulumi_spanner_v1_instance_backup_iam_member_args_doc}
class InstanceBackupIamMemberArgs {
  ...
  const InstanceBackupIamMemberArgs({
    this.condition,
