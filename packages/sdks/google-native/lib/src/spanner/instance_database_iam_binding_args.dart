...
/// {@template pulumi_spanner_v1_instance_database_iam_binding_args_doc}
/// The set of arguments for InstanceDatabaseIamBinding.
/// {@endtemplate}
/// {@macro pulumi_spanner_v1_instance_database_iam_binding_args_doc}
class InstanceDatabaseIamBindingArgs {
  ...
  /// Creates a new [InstanceDatabaseIamBindingArgs].
  ...
  const InstanceDatabaseIamBindingArgs({
    this.condition,
  ...
  factory InstanceDatabaseIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return InstanceDatabaseIamBindingArgs(
