...
import 'instance_database_iam_member_args.dart';
...
class InstanceDatabaseIamMember extends pulumi.CustomResource {
  ...
  /// Creates a new [InstanceDatabaseIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [InstanceDatabaseIamMember]. {@macro pulumi_spanner_v1_instance_database_iam_member_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  InstanceDatabaseIamMember(
    String name, {
    InstanceDatabaseIamMemberArgs? args,
