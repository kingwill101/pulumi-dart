...
class Instance extends pulumi.CustomResource {
  ...
  Instance(
    ...
    this.autoscalingConfig = registerOutput<AutoscalingConfigResponse>('autoscalingConfig');
    this.config = registerOutput<String>('config');
    this.createTime = registerOutput<String>('createTime');
    this.displayName = registerOutput<String>('displayName');
    this.endpointUris = registerOutput<List<String>>('endpointUris');
    this.freeInstanceMetadata = registerOutput<FreeInstanceMetadataResponse>('freeInstanceMetadata');
