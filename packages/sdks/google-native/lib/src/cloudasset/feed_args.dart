  ...
  factory FeedArgs.fromMap(Map<String, dynamic> map) {
    return FeedArgs(
      ...
      contentType: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FeedContentType.fromValue(guardedValue as String),
        );
      })(),
      feedId: pulumi.Input.fromValue(map['feedId'] as String),
      feedOutputConfig: pulumi.Input.fromValue(
        FeedOutputConfig.fromMap(
          (map['feedOutputConfig']! as Map).cast<String, dynamic>(),
        ),
      ),
      name: pulumi.Input.fromValue(map['name'] as String),
      relationshipTypes: (() {
        final guardedValue = map['relationshipTypes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
