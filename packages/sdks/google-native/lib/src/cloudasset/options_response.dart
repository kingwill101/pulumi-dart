...
class OptionsResponse {
  ...
  factory OptionsResponse.fromMap(Map<String, dynamic> map) {
    return OptionsResponse(
      analyzeServiceAccountImpersonation: (map['analyzeServiceAccountImpersonation'] as bool).input(),
      expandGroups: (map['expandGroups'] as bool).input(),
      expandResources: (map['expandResources'] as bool).input(),
      expandRoles: (map['expandRoles'] as bool).input(),
      outputGroupEdges: (map['outputGroupEdges'] as bool).input(),
      outputResourceEdges: (map['outputResourceEdges'] as bool).input(),
    );
  }
}
