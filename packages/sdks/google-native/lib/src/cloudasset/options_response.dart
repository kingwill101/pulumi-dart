...
class OptionsResponse {
  ...
  factory OptionsResponse.fromMap(Map<String, dynamic> map) {
    return OptionsResponse(
      analyzeServiceAccountImpersonation: pulumi.Input.fromValue(map['analyzeServiceAccountImpersonation'] as bool),
      expandGroups: pulumi.Input.fromValue(map['expandGroups'] as bool),
      expandResources: pulumi.Input.fromValue(map['expandResources'] as bool),
      expandRoles: pulumi.Input.fromValue(map['expandRoles'] as bool),
      outputGroupEdges: pulumi.Input.fromValue(map['outputGroupEdges'] as bool),
      outputResourceEdges: pulumi.Input.fromValue(map['outputResourceEdges'] as bool),
    );
  }
}
