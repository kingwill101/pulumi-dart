...
class IamPolicyAnalysisQuery {
  ...
  factory IamPolicyAnalysisQuery.fromMap(Map<String, dynamic> map) {
    return IamPolicyAnalysisQuery(
      accessSelector: (() {
        final guardedValue = map['accessSelector'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AccessSelector.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      conditionContext: (() {
        final guardedValue = map['conditionContext'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      identitySelector: (() {
        final guardedValue = map['identitySelector'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
