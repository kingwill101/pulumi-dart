...
class IamPolicyAnalysisQuery {
  ...
  factory IamPolicyAnalysisQuery.fromMap(Map<String, dynamic> map) {
    return IamPolicyAnalysisQuery(
      accessSelector: (() { final guardedValue = map['accessSelector']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AccessSelector.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      conditionContext: (() { final guardedValue = map['conditionContext']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConditionContext.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      identitySelector: (() { final guardedValue = map['identitySelector']; if (guardedValue == null) return null; return pulumi.Input.fromValue(IdentitySelector.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      resourceSelector: (() { final guardedValue = map['resourceSelector']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResourceSelector.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
