...
class Feed extends pulumi.CustomResource {
  ...
  late final pulumi.Output<ExprResponse> condition;
  /// Asset content type. If not specified, no content but the asset name and type will be returned.
  late final pulumi.Output<String> contentType;
  /// Feed output configuration defining where the asset updates are published to.
  late final pulumi.Output<FeedOutputConfigResponse> feedOutputConfig;
  ...
  late final pulumi.Output<List<String>> relationshipTypes;
  late final pulumi.Output<String> v1Id;
  late final pulumi.Output<String> v1Id1;

  /// Creates a new [Feed].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [Feed]. {@macro pulumi_cloudasset_v1_feed_args_doc}
  ...
  Feed(
    ...
    condition = registerOutput<ExprResponse>('condition', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ExprResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    contentType = registerOutput<String>('contentType');
    feedOutputConfig = registerOutput<FeedOutputConfigResponse>('feedOutputConfig', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return FeedOutputConfigResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
