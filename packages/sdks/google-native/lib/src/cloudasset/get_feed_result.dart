...
class GetFeedResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'feedOutputConfig': feedOutputConfig.toMap(),
      'name': name,
  ...
  factory GetFeedResult.fromMap(Map<String, dynamic> map) {
    return GetFeedResult(
      ...
      feedOutputConfig: FeedOutputConfigResponse.fromMap((map['feedOutputConfig']! as Map).cast<String, dynamic>()),
