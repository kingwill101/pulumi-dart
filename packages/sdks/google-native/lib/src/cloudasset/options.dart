...
class Options {
  ...
  factory Options.fromMap(Map<String, dynamic> map) {
    return Options(
      analyzeServiceAccountImpersonation: (() { final guardedValue = map['analyzeServiceAccountImpersonation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      expandGroups: (() { final guardedValue = map['expandGroups']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      expandResources: (() { final guardedValue = map['expandResources']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      expandRoles: (() { final guardedValue = map['expandRoles']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      outputGroupEdges: (() { final guardedValue = map['outputGroupEdges']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      outputResourceEdges: (() { final guardedValue = map['outputResourceEdges']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
    );
  }
}
