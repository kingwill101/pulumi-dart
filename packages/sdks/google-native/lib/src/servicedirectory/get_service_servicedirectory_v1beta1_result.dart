...
class GetServiceServicedirectoryV1beta1Result {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'endpoints': pulumi.Input.encodeList<EndpointResponseServicedirectoryV1beta1, Map<String, dynamic>>(endpoints, (value) => value.toMap()),
      'metadata': metadata,
      'name': name,
      'uid': uid,
  ...
  factory GetServiceServicedirectoryV1beta1Result.fromMap(Map<String, dynamic> map) {
    return GetServiceServicedirectoryV1beta1Result(
      createTime: map['createTime'] as String,
      endpoints: pulumi.Input.decodeList<EndpointResponseServicedirectoryV1beta1>(map['endpoints']!, (value) => EndpointResponseServicedirectoryV1beta1.fromMap((value as Map).cast<String, dynamic>())),
