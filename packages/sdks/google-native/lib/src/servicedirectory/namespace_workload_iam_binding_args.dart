...
/// {@template pulumi_servicedirectory_v1beta1_namespace_workload_iam_binding_args_doc}
/// The set of arguments for NamespaceWorkloadIamBinding.
/// {@endtemplate}
/// {@macro pulumi_servicedirectory_v1beta1_namespace_workload_iam_binding_args_doc}
class NamespaceWorkloadIamBindingArgs {
  ...
  /// Creates a new [NamespaceWorkloadIamBindingArgs].
  ...
  const NamespaceWorkloadIamBindingArgs({
    this.condition,
