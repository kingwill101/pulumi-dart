...
/// {@template pulumi_servicedirectory_v1_namespace_service_iam_member_args_doc}
/// The set of arguments for NamespaceServiceIamMember.
/// {@endtemplate}
/// {@macro pulumi_servicedirectory_v1_namespace_service_iam_member_args_doc}
class NamespaceServiceIamMemberArgs {
  ...
  /// Creates a new [NamespaceServiceIamMemberArgs].
  ...
  const NamespaceServiceIamMemberArgs({
    this.condition,
  ...
  factory NamespaceServiceIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return NamespaceServiceIamMemberArgs(
