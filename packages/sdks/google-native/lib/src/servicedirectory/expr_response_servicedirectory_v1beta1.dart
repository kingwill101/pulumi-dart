...
class ExprResponseServicedirectoryV1beta1 {
  ...
  /// Creates a new [ExprResponseServicedirectoryV1beta1].
  ...
  const ExprResponseServicedirectoryV1beta1({
  ...
  factory ExprResponseServicedirectoryV1beta1.fromMap(Map<String, dynamic> map) {
    return ExprResponseServicedirectoryV1beta1(
