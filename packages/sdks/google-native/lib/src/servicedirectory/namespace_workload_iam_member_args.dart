...
/// {@template pulumi_servicedirectory_v1beta1_namespace_workload_iam_member_args_doc}
/// The set of arguments for NamespaceWorkloadIamMember.
/// {@endtemplate}
/// {@macro pulumi_servicedirectory_v1beta1_namespace_workload_iam_member_args_doc}
class NamespaceWorkloadIamMemberArgs {
  ...
  /// Creates a new [NamespaceWorkloadIamMemberArgs].
  ...
  const NamespaceWorkloadIamMemberArgs({
    this.condition,
  ...
  factory NamespaceWorkloadIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return NamespaceWorkloadIamMemberArgs(
