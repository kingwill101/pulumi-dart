...
/// {@template pulumi_servicedirectory_v1beta1_namespace_service_iam_member_servicedirectory_v1beta1_args_doc}
/// The set of arguments for NamespaceServiceIamMember.
/// {@endtemplate}
/// {@macro pulumi_servicedirectory_v1beta1_namespace_service_iam_member_servicedirectory_v1beta1_args_doc}
class NamespaceServiceIamMemberServicedirectoryV1beta1Args {
  ...
  /// Creates a new [NamespaceServiceIamMemberServicedirectoryV1beta1Args].
  ...
  const NamespaceServiceIamMemberServicedirectoryV1beta1Args({
    this.condition,
  ...
  factory NamespaceServiceIamMemberServicedirectoryV1beta1Args.fromMap(Map<String, dynamic> map) {
    return NamespaceServiceIamMemberServicedirectoryV1beta1Args(
