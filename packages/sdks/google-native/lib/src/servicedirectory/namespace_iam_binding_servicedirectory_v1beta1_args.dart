...
/// {@template pulumi_servicedirectory_v1beta1_namespace_iam_binding_servicedirectory_v1beta1_args_doc}
/// The set of arguments for NamespaceIamBinding.
/// {@endtemplate}
/// {@macro pulumi_servicedirectory_v1beta1_namespace_iam_binding_servicedirectory_v1beta1_args_doc}
class NamespaceIamBindingServicedirectoryV1beta1Args {
  ...
  /// Creates a new [NamespaceIamBindingServicedirectoryV1beta1Args].
  ...
  const NamespaceIamBindingServicedirectoryV1beta1Args({
    this.condition,
  ...
  factory NamespaceIamBindingServicedirectoryV1beta1Args.fromMap(Map<String, dynamic> map) {
    return NamespaceIamBindingServicedirectoryV1beta1Args(
