...
class ExprServicedirectoryV1beta1 {
  ...
  /// Creates a new [ExprServicedirectoryV1beta1].
  ...
  const ExprServicedirectoryV1beta1({
    this.description,
    this.expression,
    this.location,
    this.title,
  ...
  factory ExprServicedirectoryV1beta1.fromMap(Map<String, dynamic> map) {
    return ExprServicedirectoryV1beta1(
