...
/// {@template pulumi_servicedirectory_v1beta1_namespace_service_iam_binding_servicedirectory_v1beta1_args_doc}
/// The set of arguments for NamespaceServiceIamBinding.
/// {@endtemplate}
/// {@macro pulumi_servicedirectory_v1beta1_namespace_service_iam_binding_servicedirectory_v1beta1_args_doc}
class NamespaceServiceIamBindingServicedirectoryV1beta1Args {
  ...
  /// Creates a new [NamespaceServiceIamBindingServicedirectoryV1beta1Args].
  ...
  const NamespaceServiceIamBindingServicedirectoryV1beta1Args({
    this.condition,
  ...
  factory NamespaceServiceIamBindingServicedirectoryV1beta1Args.fromMap(Map<String, dynamic> map) {
    return NamespaceServiceIamBindingServicedirectoryV1beta1Args(
