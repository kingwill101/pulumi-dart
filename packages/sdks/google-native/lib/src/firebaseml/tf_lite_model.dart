...
class TfLiteModel {
  ...
  factory TfLiteModel.fromMap(Map<String, dynamic> map) {
    return TfLiteModel(
      automlModel: (() { final guardedValue = map['automlModel']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      gcsTfliteUri: (() { final guardedValue = map['gcsTfliteUri']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
