    ...
    return ModelArgs(
      ...
      state: (() {
        ...
        return pulumi.Input.fromValue(
          ModelState.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      tags: (() {
      ...
      tfliteModel: (() {
        final guardedValue = map['tfliteModel'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TfLiteModel.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
