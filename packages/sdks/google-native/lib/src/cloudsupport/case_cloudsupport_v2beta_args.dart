...
class CaseCloudsupportV2betaArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'severity': ?pulumi.Input.mapOptionalInputValue<CaseSeverity, String>(
        severity,
  ...
  factory CaseCloudsupportV2betaArgs.fromMap(Map<String, dynamic> map) {
    return CaseCloudsupportV2betaArgs(
      ...
      escalated: (() {
        final guardedValue = map['escalated'];
        if (guardedValue == null) return null;
      ...
      priority: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CasePriorityCloudsupportV2beta.fromValue(guardedValue as String),
        );
      })(),
      severity: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CaseSeverity.fromValue(guardedValue as String),
        );
      })(),
      subscriberEmailAddresses: (() {
        final guardedValue = map['subscriberEmailAddresses'];
        if (guardedValue == null) return null;
