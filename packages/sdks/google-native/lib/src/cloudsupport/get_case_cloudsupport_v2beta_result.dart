...
class GetCaseCloudsupportV2betaResult {
  ...
  factory GetCaseCloudsupportV2betaResult.fromMap(Map<String, dynamic> map) {
    return GetCaseCloudsupportV2betaResult(
      classification: CaseClassificationResponseCloudsupportV2beta.fromMap((map['classification']! as Map).cast<String, dynamic>()),
      contactEmail: map['contactEmail'] as String,
      createTime: map['createTime'] as String,
      creator: ActorResponseCloudsupportV2beta.fromMap((map['creator']! as Map).cast<String, dynamic>()),
