...
class Case extends pulumi.CustomResource {
  ...
  late final pulumi.Output<String> v2Id1;
  ...
  Case(
    ...
    this.classification = registerOutput<CaseClassificationResponse>('classification');
    ...
    this.subscriberEmailAddresses = registerOutput<List<String>>('subscriberEmailAddresses');
