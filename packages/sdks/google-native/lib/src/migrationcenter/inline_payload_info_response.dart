...
class InlinePayloadInfoResponse {
  ...
  factory InlinePayloadInfoResponse.fromMap(Map<String, dynamic> map) {
    return InlinePayloadInfoResponse(
      ...
      payload: pulumi.Input.fromValue(pulumi.Input.decodeList<PayloadFileResponse>(map['payload']!, (value) => PayloadFileResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
