...
class ReportSummaryHistogramChartDataResponseMigrationcenterV1alpha1 {
  ...
  final pulumi.Input<
    List<ReportSummaryHistogramChartDataBucketResponseMigrationcenterV1alpha1>
  >
  buckets;
  ...
  factory ReportSummaryHistogramChartDataResponseMigrationcenterV1alpha1.fromMap(
    ...
    return ReportSummaryHistogramChartDataResponseMigrationcenterV1alpha1(
      buckets: pulumi.Input.fromValue(
        ...
        >(
          map['buckets']!,
          (value) =>
              ReportSummaryHistogramChartDataBucketResponseMigrationcenterV1alpha1.fromMap(
