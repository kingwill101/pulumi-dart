...
class MachinePreferencesMigrationcenterV1alpha1 {
  ...
  factory MachinePreferencesMigrationcenterV1alpha1.fromMap(Map<String, dynamic> map) {
    return MachinePreferencesMigrationcenterV1alpha1(
      allowedMachineSeries: (() { final guardedValue = map['allowedMachineSeries']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<MachineSeriesMigrationcenterV1alpha1>(guardedValue, (value) => MachineSeriesMigrationcenterV1alpha1.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
