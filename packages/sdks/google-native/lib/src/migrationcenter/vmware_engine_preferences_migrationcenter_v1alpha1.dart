...
class VmwareEnginePreferencesMigrationcenterV1alpha1 {
  ...
  final pulumi.Input<VmwareEnginePreferencesCommitmentPlanMigrationcenterV1alpha1>? commitmentPlan;
  ...
  const VmwareEnginePreferencesMigrationcenterV1alpha1({
    this.commitmentPlan,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'commitmentPlan': ?pulumi.Input.mapOptionalInputValue<VmwareEnginePreferencesCommitmentPlanMigrationcenterV1alpha1, String>(commitmentPlan, (value) => value.wireValue),
  ...
  factory VmwareEnginePreferencesMigrationcenterV1alpha1.fromMap(Map<String, dynamic> map) {
    return VmwareEnginePreferencesMigrationcenterV1alpha1(
      commitmentPlan: (() { final guardedValue = map['commitmentPlan']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VmwareEnginePreferencesCommitmentPlanMigrationcenterV1alpha1.fromValue(guardedValue as String)); })(),
