...
class VmwareEnginePreferencesMigrationcenterV1alpha1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'commitmentPlan': ?pulumi.Input.mapOptionalInputValue<VmwareEnginePreferencesCommitmentPlanMigrationcenterV1alpha1, String>(commitmentPlan, (value) => value.value),
