...
class ReportSummaryResponseMigrationcenterV1alpha1 {
  ...
  final pulumi.Input<
    List<ReportSummaryGroupFindingResponseMigrationcenterV1alpha1>
  >
  groupFindings;
    ...
    return <String, dynamic>{
      'allAssetsStats':
          pulumi.Input.mapInputValue<
            ReportSummaryAssetAggregateStatsResponseMigrationcenterV1alpha1,
            Map<String, dynamic>
          >(allAssetsStats, (value) => value.toMap()),
      'groupFindings':
          pulumi.Input.mapInputValue<
            List<ReportSummaryGroupFindingResponseMigrationcenterV1alpha1>,
  ...
  factory ReportSummaryResponseMigrationcenterV1alpha1.fromMap(
    Map<String, dynamic> map,
  ) {
    return ReportSummaryResponseMigrationcenterV1alpha1(
      allAssetsStats: pulumi.Input.fromValue(
        ReportSummaryAssetAggregateStatsResponseMigrationcenterV1alpha1.fromMap(
          (map['allAssetsStats']! as Map).cast<String, dynamic>(),
        ),
      ),
      groupFindings: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          ReportSummaryGroupFindingResponseMigrationcenterV1alpha1
        >(
          map['groupFindings']!,
          (value) =>
              ReportSummaryGroupFindingResponseMigrationcenterV1alpha1.fromMap(
