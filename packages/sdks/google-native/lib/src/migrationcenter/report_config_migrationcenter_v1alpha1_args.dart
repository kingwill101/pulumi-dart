...
class ReportConfigMigrationcenterV1alpha1Args {
  ...
  final pulumi.Input<List<ReportConfigGroupPreferenceSetAssignmentMigrationcenterV1alpha1>> groupPreferencesetAssignments;
  ...
  const ReportConfigMigrationcenterV1alpha1Args({
    this.description,
    this.displayName,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'groupPreferencesetAssignments': pulumi.Input.mapInputValue<List<ReportConfigGroupPreferenceSetAssignmentMigrationcenterV1alpha1>, List<Map<String, dynamic>>>(groupPreferencesetAssignments, (value) => pulumi.Input.encodeList<ReportConfigGroupPreferenceSetAssignmentMigrationcenterV1alpha1, Map<String, dynamic>>(value, (value) => value.toMap())),
      'location': ?location,
      'project': ?project,
  ...
  factory ReportConfigMigrationcenterV1alpha1Args.fromMap(Map<String, dynamic> map) {
    return ReportConfigMigrationcenterV1alpha1Args(
      ...
      groupPreferencesetAssignments: pulumi.Input.fromValue(pulumi.Input.decodeList<ReportConfigGroupPreferenceSetAssignmentMigrationcenterV1alpha1>(map['groupPreferencesetAssignments']!, (value) => ReportConfigGroupPreferenceSetAssignmentMigrationcenterV1alpha1.fromMap((value as Map).cast<String, dynamic>()))),
