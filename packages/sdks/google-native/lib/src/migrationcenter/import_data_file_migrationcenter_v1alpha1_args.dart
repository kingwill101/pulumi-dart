...
class ImportDataFileMigrationcenterV1alpha1Args {
  ...
  const ImportDataFileMigrationcenterV1alpha1Args({
    this.displayName,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'format': pulumi.Input.mapInputValue<ImportDataFileFormatMigrationcenterV1alpha1, String>(format, (value) => value.wireValue),
  ...
  factory ImportDataFileMigrationcenterV1alpha1Args.fromMap(Map<String, dynamic> map) {
    return ImportDataFileMigrationcenterV1alpha1Args(
      ...
      format: pulumi.Input.fromValue(ImportDataFileFormatMigrationcenterV1alpha1.fromValue(map['format']! as String)),
