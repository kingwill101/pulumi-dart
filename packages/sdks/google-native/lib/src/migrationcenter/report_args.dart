...
class ReportArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'reportId': reportId,
      'requestId': ?requestId,
      'state': ?pulumi.Input.mapOptionalInputValue<ReportState, String>(
        state,
        (value) => value.wireValue,
      ),
      'type': ?pulumi.Input.mapOptionalInputValue<ReportType, String>(
        type,
        (value) => value.wireValue,
      ),
    };
    ...
    return ReportArgs(
      ...
      state: (() {
        ...
        return pulumi.Input.fromValue(
          ReportState.fromValue(guardedValue as String),
        );
      })(),
      type: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ReportType.fromValue(guardedValue as String),
        );
      })(),
    );
  }
