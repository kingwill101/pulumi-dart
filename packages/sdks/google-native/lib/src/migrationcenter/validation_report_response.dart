...
class ValidationReportResponse {
  ...
  factory ValidationReportResponse.fromMap(Map<String, dynamic> map) {
    return ValidationReportResponse(
      fileValidations: pulumi.Input.fromValue(pulumi.Input.decodeList<FileValidationReportResponse>(map['fileValidations']!, (value) => FileValidationReportResponse.fromMap((value as Map).cast<String, dynamic>()))),
      jobErrors: pulumi.Input.fromValue(pulumi.Input.decodeList<ImportErrorResponse>(map['jobErrors']!, (value) => ImportErrorResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
