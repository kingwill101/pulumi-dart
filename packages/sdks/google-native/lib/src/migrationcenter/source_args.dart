...
class SourceArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'requestId': ?requestId,
      'sourceId': sourceId,
      'type': ?pulumi.Input.mapOptionalInputValue<SourceType, String>(type, (value) => value.wireValue),
    };
  }
  ...
  factory SourceArgs.fromMap(Map<String, dynamic> map) {
    return SourceArgs(
      ...
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SourceType.fromValue(guardedValue as String)); })(),
    );
  }
}
