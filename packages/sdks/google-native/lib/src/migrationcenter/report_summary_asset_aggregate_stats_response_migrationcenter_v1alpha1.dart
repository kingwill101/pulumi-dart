...
class ReportSummaryAssetAggregateStatsResponseMigrationcenterV1alpha1 {
  ...
  factory ReportSummaryAssetAggregateStatsResponseMigrationcenterV1alpha1.fromMap(Map<String, dynamic> map) {
    return ReportSummaryAssetAggregateStatsResponseMigrationcenterV1alpha1(
      assetAge: pulumi.Input.fromValue(ReportSummaryChartDataResponseMigrationcenterV1alpha1.fromMap((map['assetAge']! as Map).cast<String, dynamic>())),
      coreCountHistogram: pulumi.Input.fromValue(ReportSummaryHistogramChartDataResponseMigrationcenterV1alpha1.fromMap((map['coreCountHistogram']! as Map).cast<String, dynamic>())),
      memoryBytesHistogram: pulumi.Input.fromValue(ReportSummaryHistogramChartDataResponseMigrationcenterV1alpha1.fromMap((map['memoryBytesHistogram']! as Map).cast<String, dynamic>())),
      memoryUtilization: pulumi.Input.fromValue(ReportSummaryChartDataResponseMigrationcenterV1alpha1.fromMap((map['memoryUtilization']! as Map).cast<String, dynamic>())),
      memoryUtilizationChart: pulumi.Input.fromValue(ReportSummaryUtilizationChartDataResponseMigrationcenterV1alpha1.fromMap((map['memoryUtilizationChart']! as Map).cast<String, dynamic>())),
      operatingSystem: pulumi.Input.fromValue(ReportSummaryChartDataResponseMigrationcenterV1alpha1.fromMap((map['operatingSystem']! as Map).cast<String, dynamic>())),
      storageBytesHistogram: pulumi.Input.fromValue(ReportSummaryHistogramChartDataResponseMigrationcenterV1alpha1.fromMap((map['storageBytesHistogram']! as Map).cast<String, dynamic>())),
      storageUtilization: pulumi.Input.fromValue(ReportSummaryChartDataResponseMigrationcenterV1alpha1.fromMap((map['storageUtilization']! as Map).cast<String, dynamic>())),
      storageUtilizationChart: pulumi.Input.fromValue(ReportSummaryUtilizationChartDataResponseMigrationcenterV1alpha1.fromMap((map['storageUtilizationChart']! as Map).cast<String, dynamic>())),
