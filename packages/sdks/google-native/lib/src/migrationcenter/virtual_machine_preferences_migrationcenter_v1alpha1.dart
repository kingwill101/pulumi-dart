...
class VirtualMachinePreferencesMigrationcenterV1alpha1 {
  ...
  final pulumi.Input<ComputeEnginePreferencesMigrationcenterV1alpha1>?
  computeEnginePreferences;

  /// Optional. Parameters that affect network cost estimations. If not set, default values will be used for the parameters.
  final pulumi.Input<VirtualMachinePreferencesNetworkCostParameters>?
  ...
  final pulumi.Input<RegionPreferencesMigrationcenterV1alpha1>?
  regionPreferences;
  ...
  final pulumi.Input<SoleTenancyPreferencesMigrationcenterV1alpha1>?
  ...
  final pulumi.Input<VmwareEnginePreferencesMigrationcenterV1alpha1>?
    ...
    return <String, dynamic>{
      ...
      'networkCostParameters':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(networkCostParameters, (value) => value.toMap()),
      'regionPreferences':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'sizingOptimizationCustomParameters':
          ?pulumi.Input.mapOptionalInputValue<
            VirtualMachinePreferencesSizingOptimizationCustomParameters,
            Map<String, dynamic>
          >(sizingOptimizationCustomParameters, (value) => value.toMap()),
      'sizingOptimizationStrategy':
          ?pulumi.Input.mapOptionalInputValue<
            VirtualMachinePreferencesSizingOptimizationStrategyMigrationcenterV1alpha1,
            String
  ...
  factory VirtualMachinePreferencesMigrationcenterV1alpha1.fromMap(
    ...
    return VirtualMachinePreferencesMigrationcenterV1alpha1(
      ...
      networkCostParameters: (() {
        final guardedValue = map['networkCostParameters'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      sizingOptimizationCustomParameters: (() {
        final guardedValue = map['sizingOptimizationCustomParameters'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
