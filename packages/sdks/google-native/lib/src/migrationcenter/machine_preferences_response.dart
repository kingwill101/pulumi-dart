...
class MachinePreferencesResponse {
  ...
  factory MachinePreferencesResponse.fromMap(Map<String, dynamic> map) {
    return MachinePreferencesResponse(
      allowedMachineSeries: (pulumi.Input.decodeList<MachineSeriesResponse>(map['allowedMachineSeries'], (value) => MachineSeriesResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
