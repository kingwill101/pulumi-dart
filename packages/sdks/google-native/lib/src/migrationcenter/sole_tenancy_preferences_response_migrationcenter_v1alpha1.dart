...
class SoleTenancyPreferencesResponseMigrationcenterV1alpha1 {
  ...
  final pulumi.Input<List<SoleTenantNodeTypeResponseMigrationcenterV1alpha1>>
  nodeTypes;
    ...
    return <String, dynamic>{
      ...
      'nodeTypes':
          pulumi.Input.mapInputValue<
            List<SoleTenantNodeTypeResponseMigrationcenterV1alpha1>,
  ...
  factory SoleTenancyPreferencesResponseMigrationcenterV1alpha1.fromMap(
    ...
    return SoleTenancyPreferencesResponseMigrationcenterV1alpha1(
      ...
      nodeTypes: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          SoleTenantNodeTypeResponseMigrationcenterV1alpha1
        >(
          map['nodeTypes']!,
          (value) => SoleTenantNodeTypeResponseMigrationcenterV1alpha1.fromMap(
