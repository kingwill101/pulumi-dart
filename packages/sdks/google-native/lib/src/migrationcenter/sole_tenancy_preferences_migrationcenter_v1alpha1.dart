...
class SoleTenancyPreferencesMigrationcenterV1alpha1 {
  ...
  final pulumi.Input<
    SoleTenancyPreferencesCommitmentPlanMigrationcenterV1alpha1
  >?
  commitmentPlan;
  ...
  final pulumi.Input<
    SoleTenancyPreferencesHostMaintenancePolicyMigrationcenterV1alpha1
  >?
  hostMaintenancePolicy;

  /// A list of sole tenant node types. An empty list means that all possible node types will be considered.
  final pulumi.Input<List<SoleTenantNodeTypeMigrationcenterV1alpha1>>?
  nodeTypes;
    ...
    return <String, dynamic>{
      ...
      'hostMaintenancePolicy':
          ?pulumi.Input.mapOptionalInputValue<
            SoleTenancyPreferencesHostMaintenancePolicyMigrationcenterV1alpha1,
            String
          >(hostMaintenancePolicy, (value) => value.wireValue),
      'nodeTypes':
          ?pulumi.Input.mapOptionalInputValue<
            List<SoleTenantNodeTypeMigrationcenterV1alpha1>,
  ...
  factory SoleTenancyPreferencesMigrationcenterV1alpha1.fromMap(
    ...
    return SoleTenancyPreferencesMigrationcenterV1alpha1(
      commitmentPlan: (() {
        ...
        return pulumi.Input.fromValue(
          SoleTenancyPreferencesCommitmentPlanMigrationcenterV1alpha1.fromValue(
            guardedValue as String,
          ),
        );
      })(),
      cpuOvercommitRatio: (() {
        final guardedValue = map['cpuOvercommitRatio'];
        if (guardedValue == null) return null;
      ...
      hostMaintenancePolicy: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SoleTenancyPreferencesHostMaintenancePolicyMigrationcenterV1alpha1.fromValue(
            guardedValue as String,
          ),
        );
      })(),
      nodeTypes: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SoleTenantNodeTypeMigrationcenterV1alpha1>(
            guardedValue,
            (value) => SoleTenantNodeTypeMigrationcenterV1alpha1.fromMap(
