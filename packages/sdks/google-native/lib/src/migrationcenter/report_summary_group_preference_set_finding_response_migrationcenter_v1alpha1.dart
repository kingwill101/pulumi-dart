...
class ReportSummaryGroupPreferenceSetFindingResponseMigrationcenterV1alpha1 {
  ...
  final pulumi.Input<VirtualMachinePreferencesResponseMigrationcenterV1alpha1>
  machinePreferences;
  ...
  final pulumi.Input<MoneyResponseMigrationcenterV1alpha1>
  ...
  final pulumi.Input<ReportSummaryVMWareEngineFindingResponse>
  vmwareEngineFinding;
    ...
    return <String, dynamic>{
      ...
      'machineFinding':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(machineFinding, (value) => value.toMap()),
      'machinePreferences':
          pulumi.Input.mapInputValue<
      ...
      'monthlyCostCompute':
          pulumi.Input.mapInputValue<
            MoneyResponseMigrationcenterV1alpha1,
            Map<String, dynamic>
          >(monthlyCostCompute, (value) => value.toMap()),
      'monthlyCostNetworkEgress':
          pulumi.Input.mapInputValue<
            MoneyResponseMigrationcenterV1alpha1,
            Map<String, dynamic>
          >(monthlyCostNetworkEgress, (value) => value.toMap()),
      'monthlyCostOsLicense':
          pulumi.Input.mapInputValue<
            MoneyResponseMigrationcenterV1alpha1,
            Map<String, dynamic>
          >(monthlyCostOsLicense, (value) => value.toMap()),
      'monthlyCostOther':
          pulumi.Input.mapInputValue<
            MoneyResponseMigrationcenterV1alpha1,
            Map<String, dynamic>
          >(monthlyCostOther, (value) => value.toMap()),
      'monthlyCostStorage':
          pulumi.Input.mapInputValue<
            MoneyResponseMigrationcenterV1alpha1,
            Map<String, dynamic>
          >(monthlyCostStorage, (value) => value.toMap()),
      'monthlyCostTotal':
          pulumi.Input.mapInputValue<
            MoneyResponseMigrationcenterV1alpha1,
            Map<String, dynamic>
          >(monthlyCostTotal, (value) => value.toMap()),
      ...
      'soleTenantFinding':
          pulumi.Input.mapInputValue<
            ReportSummarySoleTenantFindingResponseMigrationcenterV1alpha1,
            Map<String, dynamic>
          >(soleTenantFinding, (value) => value.toMap()),
      'topPriority': topPriority,
      'vmwareEngineFinding':
          pulumi.Input.mapInputValue<
            ReportSummaryVMWareEngineFindingResponse,
            Map<String, dynamic>
          >(vmwareEngineFinding, (value) => value.toMap()),
    };
  }
  ...
  factory ReportSummaryGroupPreferenceSetFindingResponseMigrationcenterV1alpha1.fromMap(
    ...
    return ReportSummaryGroupPreferenceSetFindingResponseMigrationcenterV1alpha1(
      ...
      machineFinding: pulumi.Input.fromValue(
        ReportSummaryMachineFindingResponse.fromMap(
      ...
      monthlyCostCompute: pulumi.Input.fromValue(
        MoneyResponseMigrationcenterV1alpha1.fromMap(
          (map['monthlyCostCompute']! as Map).cast<String, dynamic>(),
        ),
      ),
      monthlyCostNetworkEgress: pulumi.Input.fromValue(
        MoneyResponseMigrationcenterV1alpha1.fromMap(
          (map['monthlyCostNetworkEgress']! as Map).cast<String, dynamic>(),
        ),
      ),
      monthlyCostOsLicense: pulumi.Input.fromValue(
        MoneyResponseMigrationcenterV1alpha1.fromMap(
          (map['monthlyCostOsLicense']! as Map).cast<String, dynamic>(),
        ),
      ),
      monthlyCostOther: pulumi.Input.fromValue(
        MoneyResponseMigrationcenterV1alpha1.fromMap(
          (map['monthlyCostOther']! as Map).cast<String, dynamic>(),
        ),
      ),
      monthlyCostStorage: pulumi.Input.fromValue(
        MoneyResponseMigrationcenterV1alpha1.fromMap(
          (map['monthlyCostStorage']! as Map).cast<String, dynamic>(),
        ),
      ),
      monthlyCostTotal: pulumi.Input.fromValue(
        MoneyResponseMigrationcenterV1alpha1.fromMap(
      ...
      soleTenantFinding: pulumi.Input.fromValue(
      ...
      vmwareEngineFinding: pulumi.Input.fromValue(
        ReportSummaryVMWareEngineFindingResponse.fromMap(
