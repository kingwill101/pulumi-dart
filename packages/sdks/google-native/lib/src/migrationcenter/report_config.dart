...
class ReportConfig extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<ReportConfigGroupPreferenceSetAssignmentResponse>> groupPreferencesetAssignments;
  ...
  /// [args] Arguments used to configure this [ReportConfig]. {@macro pulumi_migrationcenter_v1_report_config_args_doc}
  ...
  ReportConfig(
    ...
    this.groupPreferencesetAssignments = registerOutput<List<ReportConfigGroupPreferenceSetAssignmentResponse>>('groupPreferencesetAssignments');
