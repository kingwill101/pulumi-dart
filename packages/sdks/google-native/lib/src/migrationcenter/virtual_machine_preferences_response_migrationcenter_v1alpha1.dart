...
class VirtualMachinePreferencesResponseMigrationcenterV1alpha1 {
  ...
  final pulumi.Input<ComputeEnginePreferencesResponseMigrationcenterV1alpha1>
  computeEnginePreferences;

  /// Optional. Parameters that affect network cost estimations. If not set, default values will be used for the parameters.
  final pulumi.Input<VirtualMachinePreferencesNetworkCostParametersResponse>
  ...
  final pulumi.Input<RegionPreferencesResponseMigrationcenterV1alpha1>
  regionPreferences;
  ...
  final pulumi.Input<SoleTenancyPreferencesResponseMigrationcenterV1alpha1>
  ...
  final pulumi.Input<VmwareEnginePreferencesResponseMigrationcenterV1alpha1>
  ...
  factory VirtualMachinePreferencesResponseMigrationcenterV1alpha1.fromMap(
    ...
    return VirtualMachinePreferencesResponseMigrationcenterV1alpha1(
      ...
      networkCostParameters: pulumi.Input.fromValue(
      ...
      sizingOptimizationCustomParameters: pulumi.Input.fromValue(
