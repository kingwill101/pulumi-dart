...
class VirtualMachinePreferencesResponseMigrationcenterV1alpha1 {
  ...
  factory VirtualMachinePreferencesResponseMigrationcenterV1alpha1.fromMap(Map<String, dynamic> map) {
    return VirtualMachinePreferencesResponseMigrationcenterV1alpha1(
      ...
      computeEnginePreferences: (ComputeEnginePreferencesResponseMigrationcenterV1alpha1.fromMap((map['computeEnginePreferences'] as Map).cast<String, dynamic>())).input(),
      networkCostParameters: (VirtualMachinePreferencesNetworkCostParametersResponse.fromMap((map['networkCostParameters'] as Map).cast<String, dynamic>())).input(),
      regionPreferences: (RegionPreferencesResponseMigrationcenterV1alpha1.fromMap((map['regionPreferences'] as Map).cast<String, dynamic>())).input(),
      sizingOptimizationCustomParameters: (VirtualMachinePreferencesSizingOptimizationCustomParametersResponse.fromMap((map['sizingOptimizationCustomParameters'] as Map).cast<String, dynamic>())).input(),
      sizingOptimizationStrategy: (map['sizingOptimizationStrategy'] as String).input(),
      soleTenancyPreferences: (SoleTenancyPreferencesResponseMigrationcenterV1alpha1.fromMap((map['soleTenancyPreferences'] as Map).cast<String, dynamic>())).input(),
      targetProduct: (map['targetProduct'] as String).input(),
      vmwareEnginePreferences: (VmwareEnginePreferencesResponseMigrationcenterV1alpha1.fromMap((map['vmwareEnginePreferences'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
