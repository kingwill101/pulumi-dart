...
class MachinePreferencesResponseMigrationcenterV1alpha1 {
  ...
  factory MachinePreferencesResponseMigrationcenterV1alpha1.fromMap(Map<String, dynamic> map) {
    return MachinePreferencesResponseMigrationcenterV1alpha1(
      allowedMachineSeries: (pulumi.Input.decodeList<MachineSeriesResponseMigrationcenterV1alpha1>(map['allowedMachineSeries'], (value) => MachineSeriesResponseMigrationcenterV1alpha1.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
