...
class ComputeEnginePreferencesMigrationcenterV1alpha1 {
  ...
  final pulumi.Input<MachinePreferencesMigrationcenterV1alpha1>?
  machinePreferences;

  /// Persistent disk type to use. If unspecified (default), all types are considered, based on available usage data.
  final pulumi.Input<ComputeEnginePreferencesPersistentDiskType>?
  persistentDiskType;
    ...
    return <String, dynamic>{
      ...
      'persistentDiskType':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(persistentDiskType, (value) => value.wireValue),
    };
  }
    ...
    return ComputeEnginePreferencesMigrationcenterV1alpha1(
      licenseType: (() {
        ...
        return pulumi.Input.fromValue(
          ComputeEnginePreferencesLicenseTypeMigrationcenterV1alpha1.fromValue(
      ...
      persistentDiskType: (() {
        final guardedValue = map['persistentDiskType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
