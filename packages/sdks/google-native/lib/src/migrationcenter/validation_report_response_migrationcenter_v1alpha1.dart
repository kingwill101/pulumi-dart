...
class ValidationReportResponseMigrationcenterV1alpha1 {
  ...
  factory ValidationReportResponseMigrationcenterV1alpha1.fromMap(Map<String, dynamic> map) {
    return ValidationReportResponseMigrationcenterV1alpha1(
      fileValidations: (pulumi.Input.decodeList<FileValidationReportResponseMigrationcenterV1alpha1>(map['fileValidations'], (value) => FileValidationReportResponseMigrationcenterV1alpha1.fromMap((value as Map).cast<String, dynamic>()))).input(),
