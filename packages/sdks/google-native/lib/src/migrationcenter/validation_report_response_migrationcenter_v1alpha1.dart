...
class ValidationReportResponseMigrationcenterV1alpha1 {
  ...
  final pulumi.Input<List<FileValidationReportResponseMigrationcenterV1alpha1>> fileValidations;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'fileValidations': pulumi.Input.mapInputValue<List<FileValidationReportResponseMigrationcenterV1alpha1>, List<Map<String, dynamic>>>(fileValidations, (value) => pulumi.Input.encodeList<FileValidationReportResponseMigrationcenterV1alpha1, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory ValidationReportResponseMigrationcenterV1alpha1.fromMap(Map<String, dynamic> map) {
    return ValidationReportResponseMigrationcenterV1alpha1(
      fileValidations: pulumi.Input.fromValue(pulumi.Input.decodeList<FileValidationReportResponseMigrationcenterV1alpha1>(map['fileValidations']!, (value) => FileValidationReportResponseMigrationcenterV1alpha1.fromMap((value as Map).cast<String, dynamic>()))),
