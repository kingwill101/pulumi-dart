...
class FileValidationReportResponseMigrationcenterV1alpha1 {
  ...
  final pulumi.Input<List<ImportRowErrorResponseMigrationcenterV1alpha1>>
  rowErrors;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'rowErrors':
          pulumi.Input.mapInputValue<
            List<ImportRowErrorResponseMigrationcenterV1alpha1>,
            List<Map<String, dynamic>>
          >(
            rowErrors,
            (value) =>
  ...
  factory FileValidationReportResponseMigrationcenterV1alpha1.fromMap(
    ...
    return FileValidationReportResponseMigrationcenterV1alpha1(
      fileErrors: pulumi.Input.fromValue(
      ...
      rowErrors: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ImportRowErrorResponseMigrationcenterV1alpha1>(
          map['rowErrors']!,
