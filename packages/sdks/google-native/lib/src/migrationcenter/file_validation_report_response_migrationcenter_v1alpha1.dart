...
class FileValidationReportResponseMigrationcenterV1alpha1 {
  ...
  factory FileValidationReportResponseMigrationcenterV1alpha1.fromMap(Map<String, dynamic> map) {
    return FileValidationReportResponseMigrationcenterV1alpha1(
      fileErrors: (pulumi.Input.decodeList<ImportErrorResponseMigrationcenterV1alpha1>(map['fileErrors'], (value) => ImportErrorResponseMigrationcenterV1alpha1.fromMap((value as Map).cast<String, dynamic>()))).input(),
      fileName: (map['fileName'] as String).input(),
      partialReport: (map['partialReport'] as bool).input(),
      rowErrors: (pulumi.Input.decodeList<ImportRowErrorResponseMigrationcenterV1alpha1>(map['rowErrors'], (value) => ImportRowErrorResponseMigrationcenterV1alpha1.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
