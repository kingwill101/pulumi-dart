...
class ImportDataFileArgs {
  ...
  ImportDataFileArgs({
    ...
    required pulumi.Output<ImportDataFileFormat> format,
  ...
  factory ImportDataFileArgs.fromMap(Map<String, dynamic> map) {
    return ImportDataFileArgs(
      ...
      format: pulumi.Output.create<ImportDataFileFormat>(ImportDataFileFormat.fromValue(map['format'] as String)),
