...
class ComputeEnginePreferences {
  ...
  factory ComputeEnginePreferences.fromMap(Map<String, dynamic> map) {
    return ComputeEnginePreferences(
      licenseType: map['licenseType'] == null ? null : ComputeEnginePreferencesLicenseType.fromValue(map['licenseType'] as String),
      machinePreferences: map['machinePreferences'] == null ? null : MachinePreferences.fromMap((map['machinePreferences'] as Map).cast<String, dynamic>()),
    );
  }
}
