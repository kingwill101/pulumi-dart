...
class ComputeEnginePreferences {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'licenseType': ?pulumi.Input.mapOptionalInputValue<ComputeEnginePreferencesLicenseType, String>(licenseType, (value) => value.wireValue),
      'machinePreferences': ?pulumi.Input.mapOptionalInputValue<MachinePreferences, Map<String, dynamic>>(machinePreferences, (value) => value.toMap()),
    };
  }

  factory ComputeEnginePreferences.fromMap(Map<String, dynamic> map) {
    return ComputeEnginePreferences(
      licenseType: (() { final guardedValue = map['licenseType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ComputeEnginePreferencesLicenseType.fromValue(guardedValue as String)); })(),
      machinePreferences: (() { final guardedValue = map['machinePreferences']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MachinePreferences.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
