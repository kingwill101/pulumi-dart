...
class ImportJobMigrationcenterV1alpha1Args {
  ...
  const ImportJobMigrationcenterV1alpha1Args({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'gcsPayload': ?pulumi.Input.mapOptionalInputValue<GCSPayloadInfo, Map<String, dynamic>>(gcsPayload, (value) => value.toMap()),
      'importJobId': importJobId,
      'inlinePayload': ?pulumi.Input.mapOptionalInputValue<InlinePayloadInfo, Map<String, dynamic>>(inlinePayload, (value) => value.toMap()),
      'labels': ?labels,
      'location': ?location,
      'project': ?project,
      'requestId': ?requestId,
  ...
  factory ImportJobMigrationcenterV1alpha1Args.fromMap(Map<String, dynamic> map) {
    return ImportJobMigrationcenterV1alpha1Args(
      ...
      gcsPayload: (() { final guardedValue = map['gcsPayload']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GCSPayloadInfo.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      importJobId: pulumi.Input.fromValue(map['importJobId'] as String),
      inlinePayload: (() { final guardedValue = map['inlinePayload']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InlinePayloadInfo.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
