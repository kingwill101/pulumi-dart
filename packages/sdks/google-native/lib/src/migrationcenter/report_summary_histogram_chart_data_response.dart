...
class ReportSummaryHistogramChartDataResponse {
  ...
  final pulumi.Input<List<ReportSummaryHistogramChartDataBucketResponse>>
  buckets;
    ...
    return <String, dynamic>{
      'buckets':
          pulumi.Input.mapInputValue<
            List<ReportSummaryHistogramChartDataBucketResponse>,
  ...
  factory ReportSummaryHistogramChartDataResponse.fromMap(
    ...
    return ReportSummaryHistogramChartDataResponse(
      buckets: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ReportSummaryHistogramChartDataBucketResponse>(
          map['buckets']!,
