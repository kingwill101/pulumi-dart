...
class ReportSummaryHistogramChartDataResponse {
  ...
  const ReportSummaryHistogramChartDataResponse({
  ...
  factory ReportSummaryHistogramChartDataResponse.fromMap(Map<String, dynamic> map) {
    return ReportSummaryHistogramChartDataResponse(
      buckets: pulumi.Input.fromValue(pulumi.Input.decodeList<ReportSummaryHistogramChartDataBucketResponse>(map['buckets']!, (value) => ReportSummaryHistogramChartDataBucketResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
