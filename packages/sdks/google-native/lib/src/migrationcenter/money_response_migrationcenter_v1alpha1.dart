...
class MoneyResponseMigrationcenterV1alpha1 {
  ...
  /// Creates a new [MoneyResponseMigrationcenterV1alpha1].
  ...
  const MoneyResponseMigrationcenterV1alpha1({
  ...
  factory MoneyResponseMigrationcenterV1alpha1.fromMap(Map<String, dynamic> map) {
    return MoneyResponseMigrationcenterV1alpha1(
