...
class VirtualMachinePreferences {
  ...
  final VirtualMachinePreferencesSizingOptimizationStrategy? sizingOptimizationStrategy;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'computeEnginePreferences': ?computeEnginePreferences == null ? null : computeEnginePreferences!.toMap(),
      'regionPreferences': ?regionPreferences == null ? null : regionPreferences!.toMap(),
      'sizingOptimizationStrategy': ?sizingOptimizationStrategy == null ? null : sizingOptimizationStrategy!.value,
      'soleTenancyPreferences': ?soleTenancyPreferences == null ? null : soleTenancyPreferences!.toMap(),
      'targetProduct': ?targetProduct == null ? null : targetProduct!.value,
      'vmwareEnginePreferences': ?vmwareEnginePreferences == null ? null : vmwareEnginePreferences!.toMap(),
    };
  }

  factory VirtualMachinePreferences.fromMap(Map<String, dynamic> map) {
    return VirtualMachinePreferences(
      commitmentPlan: map['commitmentPlan'] == null ? null : VirtualMachinePreferencesCommitmentPlan.fromValue(map['commitmentPlan'] as String),
      computeEnginePreferences: map['computeEnginePreferences'] == null ? null : ComputeEnginePreferences.fromMap((map['computeEnginePreferences'] as Map).cast<String, dynamic>()),
      regionPreferences: map['regionPreferences'] == null ? null : RegionPreferences.fromMap((map['regionPreferences'] as Map).cast<String, dynamic>()),
      sizingOptimizationStrategy: map['sizingOptimizationStrategy'] == null ? null : VirtualMachinePreferencesSizingOptimizationStrategy.fromValue(map['sizingOptimizationStrategy'] as String),
      soleTenancyPreferences: map['soleTenancyPreferences'] == null ? null : SoleTenancyPreferences.fromMap((map['soleTenancyPreferences'] as Map).cast<String, dynamic>()),
      targetProduct: map['targetProduct'] == null ? null : VirtualMachinePreferencesTargetProduct.fromValue(map['targetProduct'] as String),
      vmwareEnginePreferences: map['vmwareEnginePreferences'] == null ? null : VmwareEnginePreferences.fromMap((map['vmwareEnginePreferences'] as Map).cast<String, dynamic>()),
    );
  }
}
