...
class ReportSummaryChartDataResponse {
  ...
  factory ReportSummaryChartDataResponse.fromMap(Map<String, dynamic> map) {
    return ReportSummaryChartDataResponse(
      dataPoints: (pulumi.Input.decodeList<ReportSummaryChartDataDataPointResponse>(map['dataPoints'], (value) => ReportSummaryChartDataDataPointResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
