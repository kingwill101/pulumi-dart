...
import 'repo_iam_binding_args.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy.
class RepoIamBinding extends pulumi.CustomResource {
  ...
  /// Creates a new [RepoIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [RepoIamBinding]. {@macro pulumi_sourcerepo_v1_repo_iam_binding_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  RepoIamBinding(
    String name, {
    RepoIamBindingArgs? args,
