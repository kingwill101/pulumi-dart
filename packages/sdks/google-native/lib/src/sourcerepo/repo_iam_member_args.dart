...
/// {@template pulumi_sourcerepo_v1_repo_iam_member_args_doc}
/// The set of arguments for RepoIamMember.
/// {@endtemplate}
/// {@macro pulumi_sourcerepo_v1_repo_iam_member_args_doc}
class RepoIamMemberArgs {
  ...
  /// Creates a new [RepoIamMemberArgs].
  ...
  factory RepoIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return RepoIamMemberArgs(
