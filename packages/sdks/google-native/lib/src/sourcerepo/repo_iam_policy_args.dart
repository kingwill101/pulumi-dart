...
/// {@template pulumi_sourcerepo_v1_repo_iam_policy_args_doc}
/// The set of arguments for RepoIamPolicy.
/// {@endtemplate}
/// {@macro pulumi_sourcerepo_v1_repo_iam_policy_args_doc}
class RepoIamPolicyArgs {
  ...
  /// Creates a new [RepoIamPolicyArgs].
  ...
  factory RepoIamPolicyArgs.fromMap(Map<String, dynamic> map) {
    return RepoIamPolicyArgs(
      auditConfigs: (() {
