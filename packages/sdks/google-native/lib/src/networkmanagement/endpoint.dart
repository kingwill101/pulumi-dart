...
class Endpoint {
  ...
  factory Endpoint.fromMap(Map<String, dynamic> map) {
    return Endpoint(
      appEngineVersion: map['appEngineVersion'] == null ? null : AppEngineVersionEndpoint.fromMap((map['appEngineVersion'] as Map).cast<String, dynamic>()),
      cloudFunction: map['cloudFunction'] == null ? null : CloudFunctionEndpoint.fromMap((map['cloudFunction'] as Map).cast<String, dynamic>()),
      cloudRunRevision: map['cloudRunRevision'] == null ? null : CloudRunRevisionEndpoint.fromMap((map['cloudRunRevision'] as Map).cast<String, dynamic>()),
      ...
      networkType: map['networkType'] == null ? null : EndpointNetworkType.fromValue(map['networkType'] as String),
