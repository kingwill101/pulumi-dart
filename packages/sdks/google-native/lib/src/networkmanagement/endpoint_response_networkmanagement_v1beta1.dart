...
class EndpointResponseNetworkmanagementV1beta1 {
  ...
  factory EndpointResponseNetworkmanagementV1beta1.fromMap(Map<String, dynamic> map) {
    return EndpointResponseNetworkmanagementV1beta1(
      appEngineVersion: (AppEngineVersionEndpointResponseNetworkmanagementV1beta1.fromMap((map['appEngineVersion'] as Map).cast<String, dynamic>())).input(),
      cloudFunction: (CloudFunctionEndpointResponseNetworkmanagementV1beta1.fromMap((map['cloudFunction'] as Map).cast<String, dynamic>())).input(),
      cloudRunRevision: (CloudRunRevisionEndpointResponseNetworkmanagementV1beta1.fromMap((map['cloudRunRevision'] as Map).cast<String, dynamic>())).input(),
      cloudSqlInstance: (map['cloudSqlInstance'] as String).input(),
      forwardingRule: (map['forwardingRule'] as String).input(),
      forwardingRuleTarget: (map['forwardingRuleTarget'] as String).input(),
