...
class EndpointResponseNetworkmanagementV1beta1 {
  ...
  final pulumi.Input<AppEngineVersionEndpointResponseNetworkmanagementV1beta1>
  appEngineVersion;

  /// A [Cloud Function](https://cloud.google.com/functions).
  final pulumi.Input<CloudFunctionEndpointResponseNetworkmanagementV1beta1>
  cloudFunction;
  ...
  final pulumi.Input<CloudRunRevisionEndpointResponseNetworkmanagementV1beta1>
  cloudRunRevision;
  ...
  factory EndpointResponseNetworkmanagementV1beta1.fromMap(
    ...
    return EndpointResponseNetworkmanagementV1beta1(
      ...
      forwardingRuleTarget: pulumi.Input.fromValue(
        map['forwardingRuleTarget'] as String,
      ),
