...
class ProbingDetailsResponseNetworkmanagementV1beta1 {
  ...
  final pulumi.Input<EdgeLocationResponseNetworkmanagementV1beta1>
  ...
  final pulumi.Input<LatencyDistributionResponseNetworkmanagementV1beta1>
  probingLatency;
    ...
    return <String, dynamic>{
      ...
      'destinationEgressLocation':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(destinationEgressLocation, (value) => value.toMap()),
      'endpointInfo':
          pulumi.Input.mapInputValue<
      ...
      'error':
          pulumi.Input.mapInputValue<
            StatusResponseNetworkmanagementV1beta1,
            Map<String, dynamic>
      ...
      'probingLatency':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(probingLatency, (value) => value.toMap()),
      'result': result,
  ...
  factory ProbingDetailsResponseNetworkmanagementV1beta1.fromMap(
    ...
    return ProbingDetailsResponseNetworkmanagementV1beta1(
      ...
      destinationEgressLocation: pulumi.Input.fromValue(
      ...
      error: pulumi.Input.fromValue(
        StatusResponseNetworkmanagementV1beta1.fromMap(
          (map['error']! as Map).cast<String, dynamic>(),
        ),
      ),
      probingLatency: pulumi.Input.fromValue(
      ...
      successfulProbeCount: pulumi.Input.fromValue(
        map['successfulProbeCount'] as int,
      ),
