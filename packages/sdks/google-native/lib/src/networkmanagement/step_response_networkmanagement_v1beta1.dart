...
class StepResponseNetworkmanagementV1beta1 {
  ...
  factory StepResponseNetworkmanagementV1beta1.fromMap(Map<String, dynamic> map) {
    return StepResponseNetworkmanagementV1beta1(
      abort: (AbortInfoResponseNetworkmanagementV1beta1.fromMap((map['abort'] as Map).cast<String, dynamic>())).input(),
      appEngineVersion: (AppEngineVersionInfoResponseNetworkmanagementV1beta1.fromMap((map['appEngineVersion'] as Map).cast<String, dynamic>())).input(),
      causesDrop: (map['causesDrop'] as bool).input(),
      cloudFunction: (CloudFunctionInfoResponseNetworkmanagementV1beta1.fromMap((map['cloudFunction'] as Map).cast<String, dynamic>())).input(),
      cloudRunRevision: (CloudRunRevisionInfoResponseNetworkmanagementV1beta1.fromMap((map['cloudRunRevision'] as Map).cast<String, dynamic>())).input(),
      cloudSqlInstance: (CloudSQLInstanceInfoResponseNetworkmanagementV1beta1.fromMap((map['cloudSqlInstance'] as Map).cast<String, dynamic>())).input(),
      deliver: (DeliverInfoResponseNetworkmanagementV1beta1.fromMap((map['deliver'] as Map).cast<String, dynamic>())).input(),
      description: (map['description'] as String).input(),
      drop: (DropInfoResponseNetworkmanagementV1beta1.fromMap((map['drop'] as Map).cast<String, dynamic>())).input(),
      endpoint: (EndpointInfoResponseNetworkmanagementV1beta1.fromMap((map['endpoint'] as Map).cast<String, dynamic>())).input(),
      firewall: (FirewallInfoResponseNetworkmanagementV1beta1.fromMap((map['firewall'] as Map).cast<String, dynamic>())).input(),
      forward: (ForwardInfoResponseNetworkmanagementV1beta1.fromMap((map['forward'] as Map).cast<String, dynamic>())).input(),
      forwardingRule: (ForwardingRuleInfoResponseNetworkmanagementV1beta1.fromMap((map['forwardingRule'] as Map).cast<String, dynamic>())).input(),
      gkeMaster: (GKEMasterInfoResponseNetworkmanagementV1beta1.fromMap((map['gkeMaster'] as Map).cast<String, dynamic>())).input(),
      googleService: (GoogleServiceInfoResponseNetworkmanagementV1beta1.fromMap((map['googleService'] as Map).cast<String, dynamic>())).input(),
      instance: (InstanceInfoResponseNetworkmanagementV1beta1.fromMap((map['instance'] as Map).cast<String, dynamic>())).input(),
      loadBalancer: (LoadBalancerInfoResponseNetworkmanagementV1beta1.fromMap((map['loadBalancer'] as Map).cast<String, dynamic>())).input(),
      network: (NetworkInfoResponseNetworkmanagementV1beta1.fromMap((map['network'] as Map).cast<String, dynamic>())).input(),
      project: (map['project'] as String).input(),
      route: (RouteInfoResponseNetworkmanagementV1beta1.fromMap((map['route'] as Map).cast<String, dynamic>())).input(),
      state: (map['state'] as String).input(),
      vpcConnector: (VpcConnectorInfoResponseNetworkmanagementV1beta1.fromMap((map['vpcConnector'] as Map).cast<String, dynamic>())).input(),
      vpnGateway: (VpnGatewayInfoResponseNetworkmanagementV1beta1.fromMap((map['vpnGateway'] as Map).cast<String, dynamic>())).input(),
      vpnTunnel: (VpnTunnelInfoResponseNetworkmanagementV1beta1.fromMap((map['vpnTunnel'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
