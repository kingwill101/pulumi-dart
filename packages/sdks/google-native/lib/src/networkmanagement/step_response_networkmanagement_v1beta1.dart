...
class StepResponseNetworkmanagementV1beta1 {
  ...
  final pulumi.Input<AppEngineVersionInfoResponseNetworkmanagementV1beta1>
  appEngineVersion;
  ...
  final pulumi.Input<CloudFunctionInfoResponseNetworkmanagementV1beta1>
  cloudFunction;

  /// Display information of a Cloud Run revision.
  final pulumi.Input<CloudRunRevisionInfoResponseNetworkmanagementV1beta1>
  cloudRunRevision;

  /// Display information of a Cloud SQL instance.
  final pulumi.Input<CloudSQLInstanceInfoResponseNetworkmanagementV1beta1>
  cloudSqlInstance;
  ...
  final pulumi.Input<ForwardingRuleInfoResponseNetworkmanagementV1beta1>
  forwardingRule;
  ...
  final pulumi.Input<GoogleServiceInfoResponseNetworkmanagementV1beta1>
  googleService;
  ...
  final pulumi.Input<LoadBalancerInfoResponseNetworkmanagementV1beta1>
  loadBalancer;
  ...
  final pulumi.Input<VpcConnectorInfoResponseNetworkmanagementV1beta1>
  vpcConnector;
    ...
    return <String, dynamic>{
      ...
      'appEngineVersion':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(appEngineVersion, (value) => value.toMap()),
      ...
      'deliver':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(deliver, (value) => value.toMap()),
      'description': description,
      'drop':
          pulumi.Input.mapInputValue<
            DropInfoResponseNetworkmanagementV1beta1,
            Map<String, dynamic>
          >(drop, (value) => value.toMap()),
      'endpoint':
          pulumi.Input.mapInputValue<
            EndpointInfoResponseNetworkmanagementV1beta1,
            Map<String, dynamic>
      ...
      'route':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(route, (value) => value.toMap()),
      'state': state,
      'vpcConnector':
          pulumi.Input.mapInputValue<
            VpcConnectorInfoResponseNetworkmanagementV1beta1,
            Map<String, dynamic>
          >(vpcConnector, (value) => value.toMap()),
      'vpnGateway':
          pulumi.Input.mapInputValue<
  ...
  factory StepResponseNetworkmanagementV1beta1.fromMap(
    ...
    return StepResponseNetworkmanagementV1beta1(
      abort: pulumi.Input.fromValue(
        AbortInfoResponseNetworkmanagementV1beta1.fromMap(
          (map['abort']! as Map).cast<String, dynamic>(),
        ),
      ),
      appEngineVersion: pulumi.Input.fromValue(
      ...
      cloudFunction: pulumi.Input.fromValue(
        CloudFunctionInfoResponseNetworkmanagementV1beta1.fromMap(
      ...
      deliver: pulumi.Input.fromValue(
        DeliverInfoResponseNetworkmanagementV1beta1.fromMap(
          (map['deliver']! as Map).cast<String, dynamic>(),
        ),
      ),
      description: pulumi.Input.fromValue(map['description'] as String),
      drop: pulumi.Input.fromValue(
        DropInfoResponseNetworkmanagementV1beta1.fromMap(
          (map['drop']! as Map).cast<String, dynamic>(),
        ),
      ),
      endpoint: pulumi.Input.fromValue(
        EndpointInfoResponseNetworkmanagementV1beta1.fromMap(
          (map['endpoint']! as Map).cast<String, dynamic>(),
        ),
      ),
      firewall: pulumi.Input.fromValue(
        FirewallInfoResponseNetworkmanagementV1beta1.fromMap(
          (map['firewall']! as Map).cast<String, dynamic>(),
        ),
      ),
      forward: pulumi.Input.fromValue(
        ForwardInfoResponseNetworkmanagementV1beta1.fromMap(
          (map['forward']! as Map).cast<String, dynamic>(),
        ),
      ),
      forwardingRule: pulumi.Input.fromValue(
        ForwardingRuleInfoResponseNetworkmanagementV1beta1.fromMap(
          (map['forwardingRule']! as Map).cast<String, dynamic>(),
        ),
      ),
      gkeMaster: pulumi.Input.fromValue(
        GKEMasterInfoResponseNetworkmanagementV1beta1.fromMap(
          (map['gkeMaster']! as Map).cast<String, dynamic>(),
        ),
      ),
      googleService: pulumi.Input.fromValue(
        GoogleServiceInfoResponseNetworkmanagementV1beta1.fromMap(
          (map['googleService']! as Map).cast<String, dynamic>(),
        ),
      ),
      instance: pulumi.Input.fromValue(
        InstanceInfoResponseNetworkmanagementV1beta1.fromMap(
          (map['instance']! as Map).cast<String, dynamic>(),
        ),
      ),
      loadBalancer: pulumi.Input.fromValue(
        LoadBalancerInfoResponseNetworkmanagementV1beta1.fromMap(
          (map['loadBalancer']! as Map).cast<String, dynamic>(),
        ),
      ),
      network: pulumi.Input.fromValue(
        NetworkInfoResponseNetworkmanagementV1beta1.fromMap(
          (map['network']! as Map).cast<String, dynamic>(),
        ),
      ),
      project: pulumi.Input.fromValue(map['project'] as String),
      route: pulumi.Input.fromValue(
        RouteInfoResponseNetworkmanagementV1beta1.fromMap(
          (map['route']! as Map).cast<String, dynamic>(),
        ),
      ),
      state: pulumi.Input.fromValue(map['state'] as String),
      vpcConnector: pulumi.Input.fromValue(
        VpcConnectorInfoResponseNetworkmanagementV1beta1.fromMap(
          (map['vpcConnector']! as Map).cast<String, dynamic>(),
        ),
      ),
      vpnGateway: pulumi.Input.fromValue(
        VpnGatewayInfoResponseNetworkmanagementV1beta1.fromMap(
          (map['vpnGateway']! as Map).cast<String, dynamic>(),
        ),
      ),
      vpnTunnel: pulumi.Input.fromValue(
        VpnTunnelInfoResponseNetworkmanagementV1beta1.fromMap(
