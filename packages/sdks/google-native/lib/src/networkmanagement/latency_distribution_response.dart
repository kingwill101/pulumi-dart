...
class LatencyDistributionResponse {
  ...
  factory LatencyDistributionResponse.fromMap(Map<String, dynamic> map) {
    return LatencyDistributionResponse(
      latencyPercentiles: pulumi.Input.fromValue(pulumi.Input.decodeList<LatencyPercentileResponse>(map['latencyPercentiles']!, (value) => LatencyPercentileResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
