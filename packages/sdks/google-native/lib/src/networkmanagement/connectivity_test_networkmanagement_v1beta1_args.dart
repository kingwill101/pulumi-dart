...
class ConnectivityTestNetworkmanagementV1beta1Args {
  ...
  const ConnectivityTestNetworkmanagementV1beta1Args({
    this.description,
  ...
  factory ConnectivityTestNetworkmanagementV1beta1Args.fromMap(Map<String, dynamic> map) {
    return ConnectivityTestNetworkmanagementV1beta1Args(
      ...
      destination: pulumi.Input.fromValue(EndpointNetworkmanagementV1beta1.fromMap((map['destination']! as Map).cast<String, dynamic>())),
      ...
      source: pulumi.Input.fromValue(EndpointNetworkmanagementV1beta1.fromMap((map['source']! as Map).cast<String, dynamic>())),
