...
class StepResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'abort':
          pulumi.Input.mapInputValue<AbortInfoResponse, Map<String, dynamic>>(
            abort,
            (value) => value.toMap(),
          ),
      'appEngineVersion':
      ...
      'deliver':
          pulumi.Input.mapInputValue<DeliverInfoResponse, Map<String, dynamic>>(
            deliver,
            (value) => value.toMap(),
          ),
      'description': description,
      'drop':
          pulumi.Input.mapInputValue<DropInfoResponse, Map<String, dynamic>>(
            drop,
            (value) => value.toMap(),
          ),
      'endpoint':
      ...
      'forward':
          pulumi.Input.mapInputValue<ForwardInfoResponse, Map<String, dynamic>>(
            forward,
            (value) => value.toMap(),
          ),
      'forwardingRule':
      ...
      'network':
          pulumi.Input.mapInputValue<NetworkInfoResponse, Map<String, dynamic>>(
            network,
            (value) => value.toMap(),
          ),
      'project': project,
      'route':
          pulumi.Input.mapInputValue<RouteInfoResponse, Map<String, dynamic>>(
            route,
            (value) => value.toMap(),
          ),
      'state': state,
