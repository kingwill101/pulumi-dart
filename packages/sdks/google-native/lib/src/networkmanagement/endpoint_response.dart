...
class EndpointResponse {
  ...
  final pulumi.Input<AppEngineVersionEndpointResponse> appEngineVersion;
  /// A [Cloud Function](https://cloud.google.com/functions).
  final pulumi.Input<CloudFunctionEndpointResponse> cloudFunction;
  ...
  final pulumi.Input<CloudRunRevisionEndpointResponse> cloudRunRevision;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'appEngineVersion': pulumi.Input.mapInputValue<AppEngineVersionEndpointResponse, Map<String, dynamic>>(appEngineVersion, (value) => value.toMap()),
      'cloudFunction': pulumi.Input.mapInputValue<CloudFunctionEndpointResponse, Map<String, dynamic>>(cloudFunction, (value) => value.toMap()),
      'cloudRunRevision': pulumi.Input.mapInputValue<CloudRunRevisionEndpointResponse, Map<String, dynamic>>(cloudRunRevision, (value) => value.toMap()),
  ...
  factory EndpointResponse.fromMap(Map<String, dynamic> map) {
    return EndpointResponse(
      appEngineVersion: pulumi.Input.fromValue(AppEngineVersionEndpointResponse.fromMap((map['appEngineVersion']! as Map).cast<String, dynamic>())),
      cloudFunction: pulumi.Input.fromValue(CloudFunctionEndpointResponse.fromMap((map['cloudFunction']! as Map).cast<String, dynamic>())),
      cloudRunRevision: pulumi.Input.fromValue(CloudRunRevisionEndpointResponse.fromMap((map['cloudRunRevision']! as Map).cast<String, dynamic>())),
