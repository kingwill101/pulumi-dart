...
class EndpointResponse {
  ...
  factory EndpointResponse.fromMap(Map<String, dynamic> map) {
    return EndpointResponse(
      appEngineVersion: (AppEngineVersionEndpointResponse.fromMap((map['appEngineVersion'] as Map).cast<String, dynamic>())).input(),
      cloudFunction: (CloudFunctionEndpointResponse.fromMap((map['cloudFunction'] as Map).cast<String, dynamic>())).input(),
      cloudRunRevision: (CloudRunRevisionEndpointResponse.fromMap((map['cloudRunRevision'] as Map).cast<String, dynamic>())).input(),
