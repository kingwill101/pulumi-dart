...
class GetConnectivityTestNetworkmanagementV1beta1Result {
  ...
  const GetConnectivityTestNetworkmanagementV1beta1Result({
  ...
  factory GetConnectivityTestNetworkmanagementV1beta1Result.fromMap(Map<String, dynamic> map) {
    return GetConnectivityTestNetworkmanagementV1beta1Result(
      createTime: map['createTime'] as String,
      description: map['description'] as String,
      destination: EndpointResponseNetworkmanagementV1beta1.fromMap((map['destination']! as Map).cast<String, dynamic>()),
      displayName: map['displayName'] as String,
      labels: (map['labels'] as Map).cast<String, String>(),
      name: map['name'] as String,
      probingDetails: ProbingDetailsResponseNetworkmanagementV1beta1.fromMap((map['probingDetails']! as Map).cast<String, dynamic>()),
      protocol: map['protocol'] as String,
      reachabilityDetails: ReachabilityDetailsResponseNetworkmanagementV1beta1.fromMap((map['reachabilityDetails']! as Map).cast<String, dynamic>()),
      relatedProjects: (map['relatedProjects'] as List).cast<String>(),
      source: EndpointResponseNetworkmanagementV1beta1.fromMap((map['source']! as Map).cast<String, dynamic>()),
