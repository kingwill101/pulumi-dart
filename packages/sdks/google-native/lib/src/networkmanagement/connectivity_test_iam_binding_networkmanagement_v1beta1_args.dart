...
/// {@template pulumi_networkmanagement_v1beta1_connectivity_test_iam_binding_networkmanagement_v1beta1_args_doc}
/// The set of arguments for ConnectivityTestIamBinding.
/// {@endtemplate}
/// {@macro pulumi_networkmanagement_v1beta1_connectivity_test_iam_binding_networkmanagement_v1beta1_args_doc}
class ConnectivityTestIamBindingNetworkmanagementV1beta1Args {
  ...
  /// Creates a new [ConnectivityTestIamBindingNetworkmanagementV1beta1Args].
  ...
  const ConnectivityTestIamBindingNetworkmanagementV1beta1Args({
    this.condition,
  ...
  factory ConnectivityTestIamBindingNetworkmanagementV1beta1Args.fromMap(Map<String, dynamic> map) {
    return ConnectivityTestIamBindingNetworkmanagementV1beta1Args(
