...
class TraceResponseNetworkmanagementV1beta1 {
  ...
  const TraceResponseNetworkmanagementV1beta1({
  ...
  factory TraceResponseNetworkmanagementV1beta1.fromMap(Map<String, dynamic> map) {
    return TraceResponseNetworkmanagementV1beta1(
      ...
      steps: pulumi.Input.fromValue(pulumi.Input.decodeList<StepResponseNetworkmanagementV1beta1>(map['steps']!, (value) => StepResponseNetworkmanagementV1beta1.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
