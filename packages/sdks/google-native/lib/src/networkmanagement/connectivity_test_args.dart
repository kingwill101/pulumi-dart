...
class ConnectivityTestArgs {
  ...
  factory ConnectivityTestArgs.fromMap(Map<String, dynamic> map) {
    return ConnectivityTestArgs(
      ...
      destination: pulumi.Input.fromValue(Endpoint.fromMap((map['destination']! as Map).cast<String, dynamic>())),
      ...
      source: pulumi.Input.fromValue(Endpoint.fromMap((map['source']! as Map).cast<String, dynamic>())),
