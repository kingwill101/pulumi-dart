...
class ConnectivityTestArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'destination': pulumi.Input.mapInputValue<Endpoint, Map<String, dynamic>>(
        destination,
        (value) => value.toMap(),
      ),
      'labels': ?labels,
      ...
      'source': pulumi.Input.mapInputValue<Endpoint, Map<String, dynamic>>(
        source,
        (value) => value.toMap(),
      ),
      'testId': testId,
  ...
  factory ConnectivityTestArgs.fromMap(Map<String, dynamic> map) {
    return ConnectivityTestArgs(
      ...
      destination: pulumi.Input.fromValue(
        Endpoint.fromMap((map['destination']! as Map).cast<String, dynamic>()),
      ),
      labels: (() {
      ...
      source: pulumi.Input.fromValue(
        Endpoint.fromMap((map['source']! as Map).cast<String, dynamic>()),
      ),
