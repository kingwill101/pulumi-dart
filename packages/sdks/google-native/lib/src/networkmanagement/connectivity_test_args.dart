...
class ConnectivityTestArgs {
  ...
  factory ConnectivityTestArgs.fromMap(Map<String, dynamic> map) {
    return ConnectivityTestArgs(
      ...
      destination: pulumi.Output.create<Endpoint>(Endpoint.fromMap((map['destination'] as Map).cast<String, dynamic>())),
      ...
      source: pulumi.Output.create<Endpoint>(Endpoint.fromMap((map['source'] as Map).cast<String, dynamic>())),
