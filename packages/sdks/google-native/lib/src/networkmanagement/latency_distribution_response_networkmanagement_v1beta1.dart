...
class LatencyDistributionResponseNetworkmanagementV1beta1 {
  ...
  factory LatencyDistributionResponseNetworkmanagementV1beta1.fromMap(Map<String, dynamic> map) {
    return LatencyDistributionResponseNetworkmanagementV1beta1(
      latencyPercentiles: pulumi.Input.fromValue(pulumi.Input.decodeList<LatencyPercentileResponseNetworkmanagementV1beta1>(map['latencyPercentiles']!, (value) => LatencyPercentileResponseNetworkmanagementV1beta1.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
