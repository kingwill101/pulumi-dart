...
class EndpointNetworkmanagementV1beta1 {
  ...
  final pulumi.Input<AppEngineVersionEndpointNetworkmanagementV1beta1>?
  appEngineVersion;

  /// A [Cloud Function](https://cloud.google.com/functions).
  final pulumi.Input<CloudFunctionEndpointNetworkmanagementV1beta1>?
  cloudFunction;
  ...
  final pulumi.Input<CloudRunRevisionEndpointNetworkmanagementV1beta1>?
  cloudRunRevision;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'networkType':
          ?pulumi.Input.mapOptionalInputValue<
            EndpointNetworkTypeNetworkmanagementV1beta1,
            String
