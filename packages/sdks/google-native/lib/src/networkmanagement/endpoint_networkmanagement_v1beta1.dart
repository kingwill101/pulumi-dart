...
class EndpointNetworkmanagementV1beta1 {
  ...
  const EndpointNetworkmanagementV1beta1({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ipAddress': ?ipAddress,
      'network': ?network,
      'networkType': ?pulumi.Input.mapOptionalInputValue<EndpointNetworkTypeNetworkmanagementV1beta1, String>(networkType, (value) => value.wireValue),
      'port': ?port,
      'project': ?project,
    };
  }
  ...
  factory EndpointNetworkmanagementV1beta1.fromMap(Map<String, dynamic> map) {
    return EndpointNetworkmanagementV1beta1(
      appEngineVersion: (() { final guardedValue = map['appEngineVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AppEngineVersionEndpointNetworkmanagementV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      cloudFunction: (() { final guardedValue = map['cloudFunction']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CloudFunctionEndpointNetworkmanagementV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      cloudRunRevision: (() { final guardedValue = map['cloudRunRevision']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CloudRunRevisionEndpointNetworkmanagementV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      networkType: (() { final guardedValue = map['networkType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EndpointNetworkTypeNetworkmanagementV1beta1.fromValue(guardedValue as String)); })(),
