...
class EndpointNetworkmanagementV1beta1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'appEngineVersion': ?appEngineVersion == null ? null : appEngineVersion!.toMap(),
      'cloudFunction': ?cloudFunction == null ? null : cloudFunction!.toMap(),
      'cloudRunRevision': ?cloudRunRevision == null ? null : cloudRunRevision!.toMap(),
  ...
  factory EndpointNetworkmanagementV1beta1.fromMap(Map<String, dynamic> map) {
    return EndpointNetworkmanagementV1beta1(
      appEngineVersion: map['appEngineVersion'] == null ? null : AppEngineVersionEndpointNetworkmanagementV1beta1.fromMap((map['appEngineVersion'] as Map).cast<String, dynamic>()),
      cloudFunction: map['cloudFunction'] == null ? null : CloudFunctionEndpointNetworkmanagementV1beta1.fromMap((map['cloudFunction'] as Map).cast<String, dynamic>()),
      cloudRunRevision: map['cloudRunRevision'] == null ? null : CloudRunRevisionEndpointNetworkmanagementV1beta1.fromMap((map['cloudRunRevision'] as Map).cast<String, dynamic>()),
      ...
      networkType: map['networkType'] == null ? null : EndpointNetworkTypeNetworkmanagementV1beta1.fromValue(map['networkType'] as String),
