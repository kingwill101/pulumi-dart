...
/// {@template pulumi_networkmanagement_v1beta1_connectivity_test_iam_member_networkmanagement_v1beta1_args_doc}
/// The set of arguments for ConnectivityTestIamMember.
/// {@endtemplate}
/// {@macro pulumi_networkmanagement_v1beta1_connectivity_test_iam_member_networkmanagement_v1beta1_args_doc}
class ConnectivityTestIamMemberNetworkmanagementV1beta1Args {
  ...
  /// Creates a new [ConnectivityTestIamMemberNetworkmanagementV1beta1Args].
  ...
  const ConnectivityTestIamMemberNetworkmanagementV1beta1Args({
    this.condition,
  ...
  factory ConnectivityTestIamMemberNetworkmanagementV1beta1Args.fromMap(Map<String, dynamic> map) {
    return ConnectivityTestIamMemberNetworkmanagementV1beta1Args(
