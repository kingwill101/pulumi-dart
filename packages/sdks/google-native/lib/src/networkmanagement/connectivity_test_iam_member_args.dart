...
/// {@template pulumi_networkmanagement_v1_connectivity_test_iam_member_args_doc}
/// The set of arguments for ConnectivityTestIamMember.
/// {@endtemplate}
/// {@macro pulumi_networkmanagement_v1_connectivity_test_iam_member_args_doc}
class ConnectivityTestIamMemberArgs {
  ...
  /// Creates a new [ConnectivityTestIamMemberArgs].
  ...
  const ConnectivityTestIamMemberArgs({
    this.condition,
  ...
  factory ConnectivityTestIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return ConnectivityTestIamMemberArgs(
