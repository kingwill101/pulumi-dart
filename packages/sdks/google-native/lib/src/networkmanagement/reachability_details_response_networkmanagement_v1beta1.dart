...
class ReachabilityDetailsResponseNetworkmanagementV1beta1 {
  ...
  const ReachabilityDetailsResponseNetworkmanagementV1beta1({
    required this.error,
  ...
  factory ReachabilityDetailsResponseNetworkmanagementV1beta1.fromMap(Map<String, dynamic> map) {
    return ReachabilityDetailsResponseNetworkmanagementV1beta1(
      ...
      traces: pulumi.Input.fromValue(pulumi.Input.decodeList<TraceResponseNetworkmanagementV1beta1>(map['traces']!, (value) => TraceResponseNetworkmanagementV1beta1.fromMap((value as Map).cast<String, dynamic>()))),
