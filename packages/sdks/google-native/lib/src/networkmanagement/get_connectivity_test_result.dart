...
class GetConnectivityTestResult {
  ...
  /// Creates a new [GetConnectivityTestResult].
  ...
  const GetConnectivityTestResult({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'labels': labels,
      'name': name,
      'probingDetails': probingDetails.toMap(),
      'protocol': protocol,
      'reachabilityDetails': reachabilityDetails.toMap(),
  ...
  factory GetConnectivityTestResult.fromMap(Map<String, dynamic> map) {
