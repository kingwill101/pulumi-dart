...
class UserOwnedDrydockNoteResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'publicKeys': pulumi.Input.encodeList<AttestorPublicKeyResponseBinaryauthorizationV1beta1, Map<String, dynamic>>(publicKeys, (value) => value.toMap()),
    };
  }

  factory UserOwnedDrydockNoteResponse.fromMap(Map<String, dynamic> map) {
    return UserOwnedDrydockNoteResponse(
      delegationServiceAccountEmail: map['delegationServiceAccountEmail'] as String,
      noteReference: map['noteReference'] as String,
      publicKeys: pulumi.Input.decodeList<AttestorPublicKeyResponseBinaryauthorizationV1beta1>(map['publicKeys'], (value) => AttestorPublicKeyResponseBinaryauthorizationV1beta1.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
