...
class UserOwnedDrydockNoteResponse {
  ...
  factory UserOwnedDrydockNoteResponse.fromMap(Map<String, dynamic> map) {
    return UserOwnedDrydockNoteResponse(
      delegationServiceAccountEmail: (map['delegationServiceAccountEmail'] as String).input(),
      noteReference: (map['noteReference'] as String).input(),
      publicKeys: (pulumi.Input.decodeList<AttestorPublicKeyResponseBinaryauthorizationV1beta1>(map['publicKeys'], (value) => AttestorPublicKeyResponseBinaryauthorizationV1beta1.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
