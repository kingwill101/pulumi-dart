...
class UserOwnedDrydockNoteResponse {
  ...
  final pulumi.Input<List<AttestorPublicKeyResponseBinaryauthorizationV1beta1>> publicKeys;
  ...
  const UserOwnedDrydockNoteResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'publicKeys': pulumi.Input.mapInputValue<List<AttestorPublicKeyResponseBinaryauthorizationV1beta1>, List<Map<String, dynamic>>>(publicKeys, (value) => pulumi.Input.encodeList<AttestorPublicKeyResponseBinaryauthorizationV1beta1, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory UserOwnedDrydockNoteResponse.fromMap(Map<String, dynamic> map) {
    return UserOwnedDrydockNoteResponse(
      delegationServiceAccountEmail: pulumi.Input.fromValue(map['delegationServiceAccountEmail'] as String),
      noteReference: pulumi.Input.fromValue(map['noteReference'] as String),
      publicKeys: pulumi.Input.fromValue(pulumi.Input.decodeList<AttestorPublicKeyResponseBinaryauthorizationV1beta1>(map['publicKeys']!, (value) => AttestorPublicKeyResponseBinaryauthorizationV1beta1.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
