...
/// {@template pulumi_binaryauthorization_v1beta1_policy_iam_member_binaryauthorization_v1beta1_args_doc}
/// The set of arguments for PolicyIamMember.
/// {@endtemplate}
/// {@macro pulumi_binaryauthorization_v1beta1_policy_iam_member_binaryauthorization_v1beta1_args_doc}
class PolicyIamMemberBinaryauthorizationV1beta1Args {
  ...
  /// Creates a new [PolicyIamMemberBinaryauthorizationV1beta1Args].
  ...
  const PolicyIamMemberBinaryauthorizationV1beta1Args({
    this.condition,
  ...
  factory PolicyIamMemberBinaryauthorizationV1beta1Args.fromMap(Map<String, dynamic> map) {
    return PolicyIamMemberBinaryauthorizationV1beta1Args(
