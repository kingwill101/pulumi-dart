...
/// {@template pulumi_binaryauthorization_v1_policy_iam_member_args_doc}
/// The set of arguments for PolicyIamMember.
/// {@endtemplate}
/// {@macro pulumi_binaryauthorization_v1_policy_iam_member_args_doc}
class PolicyIamMemberArgs {
  ...
  /// Creates a new [PolicyIamMemberArgs].
  ...
  factory PolicyIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return PolicyIamMemberArgs(
