...
/// {@template pulumi_binaryauthorization_v1_policy_iam_binding_args_doc}
/// The set of arguments for PolicyIamBinding.
/// {@endtemplate}
/// {@macro pulumi_binaryauthorization_v1_policy_iam_binding_args_doc}
class PolicyIamBindingArgs {
  ...
  /// Creates a new [PolicyIamBindingArgs].
  ...
  factory PolicyIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return PolicyIamBindingArgs(
