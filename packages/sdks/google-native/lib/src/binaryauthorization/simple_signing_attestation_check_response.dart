...
class SimpleSigningAttestationCheckResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'attestationAuthenticators': pulumi.Input.encodeList<AttestationAuthenticatorResponse, Map<String, dynamic>>(attestationAuthenticators, (value) => value.toMap()),
  ...
  factory SimpleSigningAttestationCheckResponse.fromMap(Map<String, dynamic> map) {
    return SimpleSigningAttestationCheckResponse(
      attestationAuthenticators: pulumi.Input.decodeList<AttestationAuthenticatorResponse>(map['attestationAuthenticators'], (value) => AttestationAuthenticatorResponse.fromMap((value as Map).cast<String, dynamic>())),
