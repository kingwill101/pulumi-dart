...
class SimpleSigningAttestationCheckResponse {
  ...
  factory SimpleSigningAttestationCheckResponse.fromMap(Map<String, dynamic> map) {
    return SimpleSigningAttestationCheckResponse(
      attestationAuthenticators: (pulumi.Input.decodeList<AttestationAuthenticatorResponse>(map['attestationAuthenticators'], (value) => AttestationAuthenticatorResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
