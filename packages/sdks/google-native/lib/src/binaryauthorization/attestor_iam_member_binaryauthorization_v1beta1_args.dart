...
/// {@template pulumi_binaryauthorization_v1beta1_attestor_iam_member_binaryauthorization_v1beta1_args_doc}
/// The set of arguments for AttestorIamMember.
/// {@endtemplate}
/// {@macro pulumi_binaryauthorization_v1beta1_attestor_iam_member_binaryauthorization_v1beta1_args_doc}
class AttestorIamMemberBinaryauthorizationV1beta1Args {
  ...
  /// Creates a new [AttestorIamMemberBinaryauthorizationV1beta1Args].
  ...
  const AttestorIamMemberBinaryauthorizationV1beta1Args({
    this.condition,
  ...
  factory AttestorIamMemberBinaryauthorizationV1beta1Args.fromMap(Map<String, dynamic> map) {
    return AttestorIamMemberBinaryauthorizationV1beta1Args(
