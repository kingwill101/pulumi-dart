...
class PkixPublicKeyBinaryauthorizationV1beta1 {
  ...
  final PkixPublicKeySignatureAlgorithmBinaryauthorizationV1beta1? signatureAlgorithm;
  ...
  factory PkixPublicKeyBinaryauthorizationV1beta1.fromMap(Map<String, dynamic> map) {
    return PkixPublicKeyBinaryauthorizationV1beta1(
      ...
      signatureAlgorithm: map['signatureAlgorithm'] == null ? null : PkixPublicKeySignatureAlgorithmBinaryauthorizationV1beta1.fromValue(map['signatureAlgorithm'] as String),
    );
  }
}
