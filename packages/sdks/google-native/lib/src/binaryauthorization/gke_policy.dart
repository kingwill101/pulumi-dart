...
class GkePolicy {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'checkSets': ?checkSets == null ? null : pulumi.Input.encodeList<CheckSet, Map<String, dynamic>>(checkSets!, (value) => value.toMap()),
  ...
  factory GkePolicy.fromMap(Map<String, dynamic> map) {
    return GkePolicy(
      checkSets: map['checkSets'] == null ? null : pulumi.Input.decodeList<CheckSet>(map['checkSets'], (value) => CheckSet.fromMap((value as Map).cast<String, dynamic>())),
