...
class VerificationRuleResponse {
  ...
  factory VerificationRuleResponse.fromMap(Map<String, dynamic> map) {
    return VerificationRuleResponse(
      attestationSource: pulumi.Input.fromValue(
        AttestationSourceResponse.fromMap(
          (map['attestationSource']! as Map).cast<String, dynamic>(),
        ),
      ),
      configBasedBuildRequired: pulumi.Input.fromValue(
        map['configBasedBuildRequired'] as bool,
      ),
      trustedBuilder: pulumi.Input.fromValue(map['trustedBuilder'] as String),
      trustedSourceRepoPatterns: pulumi.Input.fromValue(
