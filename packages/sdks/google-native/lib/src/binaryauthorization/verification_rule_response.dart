...
class VerificationRuleResponse {
  ...
  final AttestationSourceResponse attestationSource;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'attestationSource': attestationSource.toMap(),
  ...
  factory VerificationRuleResponse.fromMap(Map<String, dynamic> map) {
    return VerificationRuleResponse(
      attestationSource: AttestationSourceResponse.fromMap((map['attestationSource'] as Map).cast<String, dynamic>()),
      configBasedBuildRequired: map['configBasedBuildRequired'] as bool,
      trustedBuilder: map['trustedBuilder'] as String,
      trustedSourceRepoPatterns: (map['trustedSourceRepoPatterns'] as List).cast<String>(),
    );
  }
}
