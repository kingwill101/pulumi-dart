...
import 'attestation_source_response.dart';
...
class VerificationRuleResponse {
  /// Specifies where to fetch the provenances attestations generated by the builder (group).
  final pulumi.Input<AttestationSourceResponse> attestationSource;
  ...
  final pulumi.Input<String> trustedBuilder;
  ...
  /// Creates a new [VerificationRuleResponse].
  ...
  const VerificationRuleResponse({
    required this.attestationSource,
    required this.configBasedBuildRequired,
    required this.trustedBuilder,
    required this.trustedSourceRepoPatterns,
  });

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'attestationSource': pulumi.Input.mapInputValue<AttestationSourceResponse, Map<String, dynamic>>(attestationSource, (value) => value.toMap()),
  ...
  factory VerificationRuleResponse.fromMap(Map<String, dynamic> map) {
    return VerificationRuleResponse(
      attestationSource: pulumi.Input.fromValue(AttestationSourceResponse.fromMap((map['attestationSource']! as Map).cast<String, dynamic>())),
      configBasedBuildRequired: pulumi.Input.fromValue(map['configBasedBuildRequired'] as bool),
      trustedBuilder: pulumi.Input.fromValue(map['trustedBuilder'] as String),
      trustedSourceRepoPatterns: pulumi.Input.fromValue((map['trustedSourceRepoPatterns'] as List).cast<String>()),
    );
  }
}
