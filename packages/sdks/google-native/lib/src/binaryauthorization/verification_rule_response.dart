...
class VerificationRuleResponse {
  ...
  factory VerificationRuleResponse.fromMap(Map<String, dynamic> map) {
    return VerificationRuleResponse(
      attestationSource: (AttestationSourceResponse.fromMap((map['attestationSource'] as Map).cast<String, dynamic>())).input(),
      configBasedBuildRequired: (map['configBasedBuildRequired'] as bool).input(),
      trustedBuilder: (map['trustedBuilder'] as String).input(),
      trustedSourceRepoPatterns: ((map['trustedSourceRepoPatterns'] as List).cast<String>()).input(),
    );
  }
}
