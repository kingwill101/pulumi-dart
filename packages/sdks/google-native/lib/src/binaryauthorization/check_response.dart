...
class CheckResponse {
  ...
  final pulumi.Input<SimpleSigningAttestationCheckResponse>
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'slsaCheck':
          pulumi.Input.mapInputValue<SlsaCheckResponse, Map<String, dynamic>>(
            slsaCheck,
            (value) => value.toMap(),
          ),
  ...
  factory CheckResponse.fromMap(Map<String, dynamic> map) {
    return CheckResponse(
      ...
      imageFreshnessCheck: pulumi.Input.fromValue(
        ImageFreshnessCheckResponse.fromMap(
          (map['imageFreshnessCheck']! as Map).cast<String, dynamic>(),
        ),
      ),
      simpleSigningAttestationCheck: pulumi.Input.fromValue(
        SimpleSigningAttestationCheckResponse.fromMap(
          (map['simpleSigningAttestationCheck']! as Map)
              .cast<String, dynamic>(),
        ),
      ),
      slsaCheck: pulumi.Input.fromValue(
        SlsaCheckResponse.fromMap(
          (map['slsaCheck']! as Map).cast<String, dynamic>(),
        ),
      ),
      trustedDirectoryCheck: pulumi.Input.fromValue(
        TrustedDirectoryCheckResponse.fromMap(
          (map['trustedDirectoryCheck']! as Map).cast<String, dynamic>(),
        ),
      ),
      vulnerabilityCheck: pulumi.Input.fromValue(
        VulnerabilityCheckResponse.fromMap(
