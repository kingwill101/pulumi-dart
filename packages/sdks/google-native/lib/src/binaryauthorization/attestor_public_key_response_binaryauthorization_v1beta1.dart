...
class AttestorPublicKeyResponseBinaryauthorizationV1beta1 {
  ...
  final pulumi.Input<PkixPublicKeyResponseBinaryauthorizationV1beta1>
  pkixPublicKey;
  ...
  factory AttestorPublicKeyResponseBinaryauthorizationV1beta1.fromMap(
    ...
    return AttestorPublicKeyResponseBinaryauthorizationV1beta1(
      asciiArmoredPgpPublicKey: pulumi.Input.fromValue(
        map['asciiArmoredPgpPublicKey'] as String,
      ),
      comment: pulumi.Input.fromValue(map['comment'] as String),
      pkixPublicKey: pulumi.Input.fromValue(
        PkixPublicKeyResponseBinaryauthorizationV1beta1.fromMap(
