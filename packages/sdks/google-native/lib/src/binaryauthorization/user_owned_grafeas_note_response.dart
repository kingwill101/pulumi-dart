...
class UserOwnedGrafeasNoteResponse {
  ...
  final pulumi.Input<List<AttestorPublicKeyResponse>> publicKeys;

  /// Creates a new [UserOwnedGrafeasNoteResponse].
  ...
  const UserOwnedGrafeasNoteResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'publicKeys': pulumi.Input.mapInputValue<List<AttestorPublicKeyResponse>, List<Map<String, dynamic>>>(publicKeys, (value) => pulumi.Input.encodeList<AttestorPublicKeyResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory UserOwnedGrafeasNoteResponse.fromMap(Map<String, dynamic> map) {
    return UserOwnedGrafeasNoteResponse(
      ...
      publicKeys: pulumi.Input.fromValue(pulumi.Input.decodeList<AttestorPublicKeyResponse>(map['publicKeys']!, (value) => AttestorPublicKeyResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
