...
class UserOwnedGrafeasNoteResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'publicKeys': pulumi.Input.encodeList<AttestorPublicKeyResponse, Map<String, dynamic>>(publicKeys, (value) => value.toMap()),
    };
  }
  ...
  factory UserOwnedGrafeasNoteResponse.fromMap(Map<String, dynamic> map) {
    return UserOwnedGrafeasNoteResponse(
      ...
      publicKeys: pulumi.Input.decodeList<AttestorPublicKeyResponse>(map['publicKeys'], (value) => AttestorPublicKeyResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
