...
class UserOwnedGrafeasNoteResponse {
  ...
  factory UserOwnedGrafeasNoteResponse.fromMap(Map<String, dynamic> map) {
    return UserOwnedGrafeasNoteResponse(
      ...
      publicKeys: (pulumi.Input.decodeList<AttestorPublicKeyResponse>(map['publicKeys'], (value) => AttestorPublicKeyResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
