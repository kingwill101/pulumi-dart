...
class Check {
  ...
  final pulumi.Input<SimpleSigningAttestationCheck>?
    ...
    return <String, dynamic>{
      ...
      'imageFreshnessCheck':
          ?pulumi.Input.mapOptionalInputValue<
            ImageFreshnessCheck,
            Map<String, dynamic>
          >(imageFreshnessCheck, (value) => value.toMap()),
      'simpleSigningAttestationCheck':
          ?pulumi.Input.mapOptionalInputValue<
            SimpleSigningAttestationCheck,
            Map<String, dynamic>
          >(simpleSigningAttestationCheck, (value) => value.toMap()),
      'slsaCheck':
          ?pulumi.Input.mapOptionalInputValue<SlsaCheck, Map<String, dynamic>>(
            slsaCheck,
            (value) => value.toMap(),
          ),
      'trustedDirectoryCheck':
          ?pulumi.Input.mapOptionalInputValue<
            TrustedDirectoryCheck,
            Map<String, dynamic>
          >(trustedDirectoryCheck, (value) => value.toMap()),
      'vulnerabilityCheck':
          ?pulumi.Input.mapOptionalInputValue<
            VulnerabilityCheck,
            Map<String, dynamic>
          >(vulnerabilityCheck, (value) => value.toMap()),
    };
  }
  ...
  factory Check.fromMap(Map<String, dynamic> map) {
    return Check(
      alwaysDeny: (() {
        final guardedValue = map['alwaysDeny'];
      ...
      imageFreshnessCheck: (() {
        final guardedValue = map['imageFreshnessCheck'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      simpleSigningAttestationCheck: (() {
        final guardedValue = map['simpleSigningAttestationCheck'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      slsaCheck: (() {
        final guardedValue = map['slsaCheck'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SlsaCheck.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      trustedDirectoryCheck: (() {
        final guardedValue = map['trustedDirectoryCheck'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      vulnerabilityCheck: (() {
        final guardedValue = map['vulnerabilityCheck'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
