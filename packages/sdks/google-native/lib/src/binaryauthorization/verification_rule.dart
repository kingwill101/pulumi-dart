...
class VerificationRule {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'attestationSource': ?attestationSource == null ? null : attestationSource!.toMap(),
  ...
  factory VerificationRule.fromMap(Map<String, dynamic> map) {
    return VerificationRule(
      attestationSource: map['attestationSource'] == null ? null : AttestationSource.fromMap((map['attestationSource'] as Map).cast<String, dynamic>()),
      configBasedBuildRequired: map['configBasedBuildRequired'] == null ? null : map['configBasedBuildRequired'] as bool,
      trustedBuilder: map['trustedBuilder'] == null ? null : VerificationRuleTrustedBuilder.fromValue(map['trustedBuilder'] as String),
      trustedSourceRepoPatterns: map['trustedSourceRepoPatterns'] == null ? null : (map['trustedSourceRepoPatterns'] as List).cast<String>(),
    );
  }
}
