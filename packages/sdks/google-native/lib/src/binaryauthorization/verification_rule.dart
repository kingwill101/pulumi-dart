...
class VerificationRule {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'attestationSource': ?pulumi.Input.mapOptionalInputValue<AttestationSource, Map<String, dynamic>>(attestationSource, (value) => value.toMap()),
      'configBasedBuildRequired': ?configBasedBuildRequired,
      'trustedBuilder': ?pulumi.Input.mapOptionalInputValue<VerificationRuleTrustedBuilder, String>(trustedBuilder, (value) => value.wireValue),
  ...
  factory VerificationRule.fromMap(Map<String, dynamic> map) {
    return VerificationRule(
      attestationSource: (() { final guardedValue = map['attestationSource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AttestationSource.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      configBasedBuildRequired: (() { final guardedValue = map['configBasedBuildRequired']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      trustedBuilder: (() { final guardedValue = map['trustedBuilder']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VerificationRuleTrustedBuilder.fromValue(guardedValue as String)); })(),
      trustedSourceRepoPatterns: (() { final guardedValue = map['trustedSourceRepoPatterns']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
    );
  }
}
