...
class UserOwnedDrydockNote {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'publicKeys': ?publicKeys == null ? null : pulumi.Input.encodeList<AttestorPublicKeyBinaryauthorizationV1beta1, Map<String, dynamic>>(publicKeys!, (value) => value.toMap()),
    };
  }
  ...
  factory UserOwnedDrydockNote.fromMap(Map<String, dynamic> map) {
    return UserOwnedDrydockNote(
      ...
      publicKeys: map['publicKeys'] == null ? null : pulumi.Input.decodeList<AttestorPublicKeyBinaryauthorizationV1beta1>(map['publicKeys'], (value) => AttestorPublicKeyBinaryauthorizationV1beta1.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
