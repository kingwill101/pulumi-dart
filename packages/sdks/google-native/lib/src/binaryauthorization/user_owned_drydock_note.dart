...
class UserOwnedDrydockNote {
  ...
  factory UserOwnedDrydockNote.fromMap(Map<String, dynamic> map) {
    return UserOwnedDrydockNote(
      ...
      publicKeys: (() { final guardedValue = map['publicKeys']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AttestorPublicKeyBinaryauthorizationV1beta1>(guardedValue, (value) => AttestorPublicKeyBinaryauthorizationV1beta1.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
