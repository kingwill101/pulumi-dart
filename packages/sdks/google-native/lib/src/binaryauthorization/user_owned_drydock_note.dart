...
class UserOwnedDrydockNote {
  ...
  final pulumi.Input<List<AttestorPublicKeyBinaryauthorizationV1beta1>>?
  publicKeys;
  ...
  UserOwnedDrydockNote({required this.noteReference, this.publicKeys});
    ...
    return <String, dynamic>{
      ...
      'publicKeys':
          ?pulumi.Input.mapOptionalInputValue<
            List<AttestorPublicKeyBinaryauthorizationV1beta1>,
    ...
    return UserOwnedDrydockNote(
      ...
      publicKeys: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AttestorPublicKeyBinaryauthorizationV1beta1>(
            guardedValue,
