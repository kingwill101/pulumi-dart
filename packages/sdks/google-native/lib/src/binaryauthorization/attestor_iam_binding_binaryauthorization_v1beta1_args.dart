...
/// {@template pulumi_binaryauthorization_v1beta1_attestor_iam_binding_binaryauthorization_v1beta1_args_doc}
/// The set of arguments for AttestorIamBinding.
/// {@endtemplate}
/// {@macro pulumi_binaryauthorization_v1beta1_attestor_iam_binding_binaryauthorization_v1beta1_args_doc}
class AttestorIamBindingBinaryauthorizationV1beta1Args {
  ...
  /// Creates a new [AttestorIamBindingBinaryauthorizationV1beta1Args].
  ...
  const AttestorIamBindingBinaryauthorizationV1beta1Args({
    this.condition,
  ...
  factory AttestorIamBindingBinaryauthorizationV1beta1Args.fromMap(Map<String, dynamic> map) {
    return AttestorIamBindingBinaryauthorizationV1beta1Args(
