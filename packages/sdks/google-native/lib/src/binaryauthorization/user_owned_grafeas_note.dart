...
class UserOwnedGrafeasNote {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'publicKeys': ?publicKeys == null ? null : pulumi.Input.encodeList<AttestorPublicKey, Map<String, dynamic>>(publicKeys!, (value) => value.toMap()),
    };
  }
  ...
  factory UserOwnedGrafeasNote.fromMap(Map<String, dynamic> map) {
    return UserOwnedGrafeasNote(
      ...
      publicKeys: map['publicKeys'] == null ? null : pulumi.Input.decodeList<AttestorPublicKey>(map['publicKeys'], (value) => AttestorPublicKey.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
