...
class SimpleSigningAttestationCheck {
  ...
  const SimpleSigningAttestationCheck({
  ...
  factory SimpleSigningAttestationCheck.fromMap(Map<String, dynamic> map) {
    return SimpleSigningAttestationCheck(
      attestationAuthenticators: pulumi.Input.fromValue(pulumi.Input.decodeList<AttestationAuthenticator>(map['attestationAuthenticators']!, (value) => AttestationAuthenticator.fromMap((value as Map).cast<String, dynamic>()))),
