...
class SlsaCheckResponse {
  ...
  final pulumi.Input<List<VerificationRuleResponse>> rules;
  ...
  factory SlsaCheckResponse.fromMap(Map<String, dynamic> map) {
    return SlsaCheckResponse(
      rules: pulumi.Input.fromValue(pulumi.Input.decodeList<VerificationRuleResponse>(map['rules']!, (value) => VerificationRuleResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
