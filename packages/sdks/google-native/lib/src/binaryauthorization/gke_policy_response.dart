...
class GkePolicyResponse {
  ...
  GkePolicyResponse({required this.checkSets, required this.imageAllowlist});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'checkSets':
          pulumi.Input.mapInputValue<
            List<CheckSetResponse>,
            List<Map<String, dynamic>>
          >(
            checkSets,
            (value) =>
                pulumi.Input.encodeList<CheckSetResponse, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory GkePolicyResponse.fromMap(Map<String, dynamic> map) {
    return GkePolicyResponse(
      checkSets: pulumi.Input.fromValue(
        pulumi.Input.decodeList<CheckSetResponse>(
          map['checkSets']!,
          (value) =>
              CheckSetResponse.fromMap((value as Map).cast<String, dynamic>()),
        ),
      ),
      imageAllowlist: pulumi.Input.fromValue(
        ImageAllowlistResponse.fromMap(
