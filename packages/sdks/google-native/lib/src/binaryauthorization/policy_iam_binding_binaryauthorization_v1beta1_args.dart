...
/// {@template pulumi_binaryauthorization_v1beta1_policy_iam_binding_binaryauthorization_v1beta1_args_doc}
/// The set of arguments for PolicyIamBinding.
/// {@endtemplate}
/// {@macro pulumi_binaryauthorization_v1beta1_policy_iam_binding_binaryauthorization_v1beta1_args_doc}
class PolicyIamBindingBinaryauthorizationV1beta1Args {
  ...
  /// Creates a new [PolicyIamBindingBinaryauthorizationV1beta1Args].
  ...
  const PolicyIamBindingBinaryauthorizationV1beta1Args({
    this.condition,
  ...
  factory PolicyIamBindingBinaryauthorizationV1beta1Args.fromMap(Map<String, dynamic> map) {
    return PolicyIamBindingBinaryauthorizationV1beta1Args(
