...
class ExprBinaryauthorizationV1beta1 {
  ...
  /// Creates a new [ExprBinaryauthorizationV1beta1].
  ...
  const ExprBinaryauthorizationV1beta1({
    this.description,
    this.expression,
    this.location,
    this.title,
  ...
  factory ExprBinaryauthorizationV1beta1.fromMap(Map<String, dynamic> map) {
    return ExprBinaryauthorizationV1beta1(
