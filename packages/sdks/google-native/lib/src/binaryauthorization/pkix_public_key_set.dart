...
class PkixPublicKeySet {
  ...
  factory PkixPublicKeySet.fromMap(Map<String, dynamic> map) {
    return PkixPublicKeySet(
      pkixPublicKeys: pulumi.Input.fromValue(pulumi.Input.decodeList<PkixPublicKey>(map['pkixPublicKeys']!, (value) => PkixPublicKey.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
