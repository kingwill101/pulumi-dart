...
class ExecutionConfigResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'defaultPool':
          pulumi.Input.mapInputValue<DefaultPoolResponse, Map<String, dynamic>>(
            defaultPool,
            (value) => value.toMap(),
          ),
      'executionTimeout': executionTimeout,
      'privatePool':
          pulumi.Input.mapInputValue<PrivatePoolResponse, Map<String, dynamic>>(
            privatePool,
            (value) => value.toMap(),
          ),
  ...
  factory ExecutionConfigResponse.fromMap(Map<String, dynamic> map) {
    return ExecutionConfigResponse(
      ...
      defaultPool: pulumi.Input.fromValue(
        DefaultPoolResponse.fromMap(
      ...
      privatePool: pulumi.Input.fromValue(
        PrivatePoolResponse.fromMap(
