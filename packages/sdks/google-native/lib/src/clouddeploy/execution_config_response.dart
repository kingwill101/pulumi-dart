...
class ExecutionConfigResponse {
  ...
  factory ExecutionConfigResponse.fromMap(Map<String, dynamic> map) {
    return ExecutionConfigResponse(
      ...
      defaultPool: (DefaultPoolResponse.fromMap((map['defaultPool'] as Map).cast<String, dynamic>())).input(),
      executionTimeout: (map['executionTimeout'] as String).input(),
      privatePool: (PrivatePoolResponse.fromMap((map['privatePool'] as Map).cast<String, dynamic>())).input(),
