    ...
    return <String, dynamic>{
      'deployParameters':
          ...
          >(
            deployParameters,
            (value) =>
                pulumi.Input.encodeList<DeployParameters, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      'profiles': ?profiles,
      'strategy':
          ?pulumi.Input.mapOptionalInputValue<Strategy, Map<String, dynamic>>(
            strategy,
            (value) => value.toMap(),
          ),
      'targetId': ?targetId,
    ...
    return Stage(
      deployParameters: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DeployParameters>(
            guardedValue,
      ...
      strategy: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          Strategy.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      targetId: (() {
