...
class Strategy {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'canary':
          ?pulumi.Input.mapOptionalInputValue<Canary, Map<String, dynamic>>(
            canary,
            (value) => value.toMap(),
          ),
      'standard':
          ?pulumi.Input.mapOptionalInputValue<Standard, Map<String, dynamic>>(
            standard,
            (value) => value.toMap(),
          ),
    };
    ...
    return Strategy(
      canary: (() {
        ...
        return pulumi.Input.fromValue(
          Canary.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      standard: (() {
        final guardedValue = map['standard'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          Standard.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
