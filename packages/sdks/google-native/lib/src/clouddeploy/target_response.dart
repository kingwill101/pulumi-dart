...
class TargetResponse {
  ...
  factory TargetResponse.fromMap(Map<String, dynamic> map) {
    return TargetResponse(
      ...
      anthosCluster: (AnthosClusterResponse.fromMap((map['anthosCluster'] as Map).cast<String, dynamic>())).input(),
      createTime: (map['createTime'] as String).input(),
      deployParameters: ((map['deployParameters'] as Map).cast<String, String>()).input(),
      description: (map['description'] as String).input(),
      etag: (map['etag'] as String).input(),
      executionConfigs: (pulumi.Input.decodeList<ExecutionConfigResponse>(map['executionConfigs'], (value) => ExecutionConfigResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      gke: (GkeClusterResponse.fromMap((map['gke'] as Map).cast<String, dynamic>())).input(),
      labels: ((map['labels'] as Map).cast<String, String>()).input(),
      multiTarget: (MultiTargetResponse.fromMap((map['multiTarget'] as Map).cast<String, dynamic>())).input(),
      name: (map['name'] as String).input(),
      requireApproval: (map['requireApproval'] as bool).input(),
      run: (CloudRunLocationResponse.fromMap((map['run'] as Map).cast<String, dynamic>())).input(),
