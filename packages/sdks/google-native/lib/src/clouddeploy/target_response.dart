...
class TargetResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'gke':
          pulumi.Input.mapInputValue<GkeClusterResponse, Map<String, dynamic>>(
            gke,
            (value) => value.toMap(),
          ),
      'labels': labels,
      'multiTarget':
          pulumi.Input.mapInputValue<MultiTargetResponse, Map<String, dynamic>>(
            multiTarget,
            (value) => value.toMap(),
          ),
      'name': name,
  ...
  factory TargetResponse.fromMap(Map<String, dynamic> map) {
    return TargetResponse(
      ...
      anthosCluster: pulumi.Input.fromValue(
        AnthosClusterResponse.fromMap(
          (map['anthosCluster']! as Map).cast<String, dynamic>(),
        ),
      ),
      createTime: pulumi.Input.fromValue(map['createTime'] as String),
      deployParameters: pulumi.Input.fromValue(
        (map['deployParameters'] as Map).cast<String, String>(),
      ),
      description: pulumi.Input.fromValue(map['description'] as String),
      etag: pulumi.Input.fromValue(map['etag'] as String),
      executionConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ExecutionConfigResponse>(
      ...
      multiTarget: pulumi.Input.fromValue(
        MultiTargetResponse.fromMap(
      ...
      run: pulumi.Input.fromValue(
        CloudRunLocationResponse.fromMap(
