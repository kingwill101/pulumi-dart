...
class StrategyResponse {
  ...
  factory StrategyResponse.fromMap(Map<String, dynamic> map) {
    return StrategyResponse(
      canary: pulumi.Input.fromValue(CanaryResponse.fromMap((map['canary']! as Map).cast<String, dynamic>())),
      standard: pulumi.Input.fromValue(StandardResponse.fromMap((map['standard']! as Map).cast<String, dynamic>())),
    );
  }
}
