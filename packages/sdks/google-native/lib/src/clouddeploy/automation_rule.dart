...
class AutomationRule {
  ...
  factory AutomationRule.fromMap(Map<String, dynamic> map) {
    return AutomationRule(
      advanceRolloutRule: (() { final guardedValue = map['advanceRolloutRule']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AdvanceRolloutRule.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      promoteReleaseRule: (() { final guardedValue = map['promoteReleaseRule']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PromoteReleaseRule.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      repairRolloutRule: (() { final guardedValue = map['repairRolloutRule']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RepairRolloutRule.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
