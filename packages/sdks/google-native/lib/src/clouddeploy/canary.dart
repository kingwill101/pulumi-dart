...
class Canary {
    ...
    return <String, dynamic>{
      'canaryDeployment':
          ?pulumi.Input.mapOptionalInputValue<
            CanaryDeployment,
            Map<String, dynamic>
          >(canaryDeployment, (value) => value.toMap()),
      'customCanaryDeployment':
          ?pulumi.Input.mapOptionalInputValue<
            CustomCanaryDeployment,
            Map<String, dynamic>
          >(customCanaryDeployment, (value) => value.toMap()),
      'runtimeConfig':
          ?pulumi.Input.mapOptionalInputValue<
            RuntimeConfig,
            Map<String, dynamic>
  ...
  factory Canary.fromMap(Map<String, dynamic> map) {
    return Canary(
      canaryDeployment: (() {
        final guardedValue = map['canaryDeployment'];
      ...
      customCanaryDeployment: (() {
        final guardedValue = map['customCanaryDeployment'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      runtimeConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RuntimeConfig.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
