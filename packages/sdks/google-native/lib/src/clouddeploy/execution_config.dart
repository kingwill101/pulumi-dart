...
class ExecutionConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'usages': pulumi.Input.mapInputValue<List<ExecutionConfigUsagesItem>, List<String>>(usages, (value) => pulumi.Input.encodeList<ExecutionConfigUsagesItem, String>(value, (value) => value.value)),
