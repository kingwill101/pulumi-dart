...
class ExecutionConfig {
    ...
    return <String, dynamic>{
      ...
      'defaultPool':
          ?pulumi.Input.mapOptionalInputValue<
            DefaultPool,
            Map<String, dynamic>
          >(defaultPool, (value) => value.toMap()),
      'executionTimeout': ?executionTimeout,
      'privatePool':
          ?pulumi.Input.mapOptionalInputValue<
            PrivatePool,
            Map<String, dynamic>
          >(privatePool, (value) => value.toMap()),
      'serviceAccount': ?serviceAccount,
      'usages':
          pulumi.Input.mapInputValue<
            List<ExecutionConfigUsagesItem>,
            List<String>
          >(
            usages,
            (value) =>
                pulumi.Input.encodeList<ExecutionConfigUsagesItem, String>(
                  value,
  ...
  factory ExecutionConfig.fromMap(Map<String, dynamic> map) {
    return ExecutionConfig(
      ...
      defaultPool: (() {
        final guardedValue = map['defaultPool'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DefaultPool.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      executionTimeout: (() {
      ...
      privatePool: (() {
        final guardedValue = map['privatePool'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PrivatePool.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      serviceAccount: (() {
      ...
      usages: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ExecutionConfigUsagesItem>(
          map['usages']!,
