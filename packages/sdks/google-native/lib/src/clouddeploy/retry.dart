...
class Retry {
  ...
  Retry({required this.attempts, this.backoffMode, this.wait});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'attempts': attempts,
      'backoffMode':
          ?pulumi.Input.mapOptionalInputValue<RetryBackoffMode, String>(
            backoffMode,
    ...
    return Retry(
      ...
      backoffMode: (() {
        ...
        return pulumi.Input.fromValue(
          RetryBackoffMode.fromValue(guardedValue as String),
        );
      })(),
      wait: (() {
