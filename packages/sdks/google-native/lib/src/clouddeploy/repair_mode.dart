...
class RepairMode {
  ...
  factory RepairMode.fromMap(Map<String, dynamic> map) {
    return RepairMode(
      retry: (() { final guardedValue = map['retry']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Retry.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      rollback: (() { final guardedValue = map['rollback']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Rollback.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
