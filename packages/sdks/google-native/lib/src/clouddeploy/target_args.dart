...
class TargetArgs {
  ...
  factory TargetArgs.fromMap(Map<String, dynamic> map) {
    return TargetArgs(
      ...
      anthosCluster: (() { final guardedValue = map['anthosCluster']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AnthosCluster.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      executionConfigs: (() { final guardedValue = map['executionConfigs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ExecutionConfig>(guardedValue, (value) => ExecutionConfig.fromMap((value as Map).cast<String, dynamic>()))); })(),
      gke: (() { final guardedValue = map['gke']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GkeCluster.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      labels: (() { final guardedValue = map['labels']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      location: (() { final guardedValue = map['location']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      multiTarget: (() { final guardedValue = map['multiTarget']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MultiTarget.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      run: (() { final guardedValue = map['run']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CloudRunLocation.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
