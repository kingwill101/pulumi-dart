...
class TargetArgs {
  ...
  TargetArgs({
    ...
    pulumi.Output<AnthosCluster>? anthosCluster,
    pulumi.Output<Map<String, String>>? deployParameters,
    pulumi.Output<String>? description,
    pulumi.Output<String>? etag,
    pulumi.Output<List<ExecutionConfig>>? executionConfigs,
    pulumi.Output<GkeCluster>? gke,
    pulumi.Output<Map<String, String>>? labels,
    pulumi.Output<String>? location,
    pulumi.Output<MultiTarget>? multiTarget,
    pulumi.Output<String>? name,
    pulumi.Output<String>? project,
    pulumi.Output<String>? requestId,
    pulumi.Output<bool>? requireApproval,
    pulumi.Output<CloudRunLocation>? run,
    required pulumi.Output<String> targetId,
  }) :
      annotations = pulumi.Input.asOptionalInput<Map<String, String>>(annotations),
      anthosCluster = pulumi.Input.asOptionalInput<AnthosCluster>(anthosCluster),
      deployParameters = pulumi.Input.asOptionalInput<Map<String, String>>(deployParameters),
      description = pulumi.Input.asOptionalInput<String>(description),
      etag = pulumi.Input.asOptionalInput<String>(etag),
      executionConfigs = pulumi.Input.asOptionalInput<List<ExecutionConfig>>(executionConfigs),
      gke = pulumi.Input.asOptionalInput<GkeCluster>(gke),
      labels = pulumi.Input.asOptionalInput<Map<String, String>>(labels),
      location = pulumi.Input.asOptionalInput<String>(location),
      multiTarget = pulumi.Input.asOptionalInput<MultiTarget>(multiTarget),
      name = pulumi.Input.asOptionalInput<String>(name),
      project = pulumi.Input.asOptionalInput<String>(project),
      requestId = pulumi.Input.asOptionalInput<String>(requestId),
      requireApproval = pulumi.Input.asOptionalInput<bool>(requireApproval),
      run = pulumi.Input.asOptionalInput<CloudRunLocation>(run),
      targetId = pulumi.Input.asInput<String>(targetId);

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'annotations': ?annotations,
      'anthosCluster': ?pulumi.Input.mapOptionalInputValue<AnthosCluster, Map<String, dynamic>>(anthosCluster, (value) => value.toMap()),
      'deployParameters': ?deployParameters,
      'description': ?description,
      'etag': ?etag,
      'executionConfigs': ?pulumi.Input.mapOptionalInputValue<List<ExecutionConfig>, List<Map<String, dynamic>>>(executionConfigs, (value) => pulumi.Input.encodeList<ExecutionConfig, Map<String, dynamic>>(value, (value) => value.toMap())),
      'gke': ?pulumi.Input.mapOptionalInputValue<GkeCluster, Map<String, dynamic>>(gke, (value) => value.toMap()),
      'labels': ?labels,
      'location': ?location,
      'multiTarget': ?pulumi.Input.mapOptionalInputValue<MultiTarget, Map<String, dynamic>>(multiTarget, (value) => value.toMap()),
      'name': ?name,
      'project': ?project,
      'requestId': ?requestId,
      'requireApproval': ?requireApproval,
      'run': ?pulumi.Input.mapOptionalInputValue<CloudRunLocation, Map<String, dynamic>>(run, (value) => value.toMap()),
      'targetId': targetId,
    };
  }
  ...
  factory TargetArgs.fromMap(Map<String, dynamic> map) {
    return TargetArgs(
      ...
      anthosCluster: map['anthosCluster'] == null ? null : pulumi.Output.create<AnthosCluster>(AnthosCluster.fromMap((map['anthosCluster'] as Map).cast<String, dynamic>())),
      ...
      executionConfigs: map['executionConfigs'] == null ? null : pulumi.Output.create<List<ExecutionConfig>>(pulumi.Input.decodeList<ExecutionConfig>(map['executionConfigs'], (value) => ExecutionConfig.fromMap((value as Map).cast<String, dynamic>()))),
      gke: map['gke'] == null ? null : pulumi.Output.create<GkeCluster>(GkeCluster.fromMap((map['gke'] as Map).cast<String, dynamic>())),
      labels: map['labels'] == null ? null : pulumi.Output.create<Map<String, String>>((map['labels'] as Map).cast<String, String>()),
      location: map['location'] == null ? null : pulumi.Output.create<String>(map['location'] as String),
      multiTarget: map['multiTarget'] == null ? null : pulumi.Output.create<MultiTarget>(MultiTarget.fromMap((map['multiTarget'] as Map).cast<String, dynamic>())),
      ...
      run: map['run'] == null ? null : pulumi.Output.create<CloudRunLocation>(CloudRunLocation.fromMap((map['run'] as Map).cast<String, dynamic>())),
