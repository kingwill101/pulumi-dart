...
class TargetArgs {
  ...
  factory TargetArgs.fromMap(Map<String, dynamic> map) {
    return TargetArgs(
      ...
      anthosCluster: map['anthosCluster'] == null ? null : (AnthosCluster.fromMap((map['anthosCluster'] as Map).cast<String, dynamic>())).input(),
      ...
      executionConfigs: map['executionConfigs'] == null ? null : (pulumi.Input.decodeList<ExecutionConfig>(map['executionConfigs'], (value) => ExecutionConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
      gke: map['gke'] == null ? null : (GkeCluster.fromMap((map['gke'] as Map).cast<String, dynamic>())).input(),
      labels: map['labels'] == null ? null : ((map['labels'] as Map).cast<String, String>()).input(),
      location: map['location'] == null ? null : (map['location'] as String).input(),
      multiTarget: map['multiTarget'] == null ? null : (MultiTarget.fromMap((map['multiTarget'] as Map).cast<String, dynamic>())).input(),
      name: map['name'] == null ? null : (map['name'] as String).input(),
      project: map['project'] == null ? null : (map['project'] as String).input(),
      requestId: map['requestId'] == null ? null : (map['requestId'] as String).input(),
      requireApproval: map['requireApproval'] == null ? null : (map['requireApproval'] as bool).input(),
      run: map['run'] == null ? null : (CloudRunLocation.fromMap((map['run'] as Map).cast<String, dynamic>())).input(),
