...
class CanaryResponse {
  ...
  factory CanaryResponse.fromMap(Map<String, dynamic> map) {
    return CanaryResponse(
      canaryDeployment: pulumi.Input.fromValue(
        CanaryDeploymentResponse.fromMap(
          (map['canaryDeployment']! as Map).cast<String, dynamic>(),
        ),
      ),
      customCanaryDeployment: pulumi.Input.fromValue(
        CustomCanaryDeploymentResponse.fromMap(
          (map['customCanaryDeployment']! as Map).cast<String, dynamic>(),
        ),
      ),
      runtimeConfig: pulumi.Input.fromValue(
        RuntimeConfigResponse.fromMap(
