...
class ReleaseArgs {
  ...
  factory ReleaseArgs.fromMap(Map<String, dynamic> map) {
    return ReleaseArgs(
      ...
      buildArtifacts: (() {
        final guardedValue = map['buildArtifacts'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      skaffoldConfigPath: (() {
        final guardedValue = map['skaffoldConfigPath'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      skaffoldConfigUri: (() {
        final guardedValue = map['skaffoldConfigUri'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      skaffoldVersion: (() {
        final guardedValue = map['skaffoldVersion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
