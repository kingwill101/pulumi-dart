...
class RepairModeResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'retry': pulumi.Input.mapInputValue<RetryResponse, Map<String, dynamic>>(
        retry,
        (value) => value.toMap(),
      ),
      'rollback':
          pulumi.Input.mapInputValue<RollbackResponse, Map<String, dynamic>>(
            rollback,
            (value) => value.toMap(),
          ),
    };
  ...
  factory RepairModeResponse.fromMap(Map<String, dynamic> map) {
    return RepairModeResponse(
      ...
      rollback: pulumi.Input.fromValue(
        RollbackResponse.fromMap(
