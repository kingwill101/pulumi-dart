...
class CustomCanaryDeploymentResponse {
  ...
  factory CustomCanaryDeploymentResponse.fromMap(Map<String, dynamic> map) {
    return CustomCanaryDeploymentResponse(
      phaseConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<PhaseConfigResponse>(map['phaseConfigs']!, (value) => PhaseConfigResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
