...
class StageResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'profiles': profiles,
      'strategy':
          pulumi.Input.mapInputValue<StrategyResponse, Map<String, dynamic>>(
            strategy,
            (value) => value.toMap(),
          ),
      'targetId': targetId,
  ...
  factory StageResponse.fromMap(Map<String, dynamic> map) {
    return StageResponse(
      deployParameters: pulumi.Input.fromValue(
        pulumi.Input.decodeList<DeployParametersResponse>(
