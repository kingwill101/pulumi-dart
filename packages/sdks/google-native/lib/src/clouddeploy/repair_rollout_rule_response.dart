...
class RepairRolloutRuleResponse {
  ...
  const RepairRolloutRuleResponse({
  ...
  factory RepairRolloutRuleResponse.fromMap(Map<String, dynamic> map) {
    return RepairRolloutRuleResponse(
      ...
      jobs: pulumi.Input.fromValue((map['jobs'] as List).cast<String>()),
      repairModes: pulumi.Input.fromValue(pulumi.Input.decodeList<RepairModeResponse>(map['repairModes']!, (value) => RepairModeResponse.fromMap((value as Map).cast<String, dynamic>()))),
