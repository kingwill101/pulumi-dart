...
class KubernetesConfig {
  ...
  factory KubernetesConfig.fromMap(Map<String, dynamic> map) {
    return KubernetesConfig(
      gatewayServiceMesh: (() { final guardedValue = map['gatewayServiceMesh']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GatewayServiceMesh.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      serviceNetworking: (() { final guardedValue = map['serviceNetworking']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServiceNetworking.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
