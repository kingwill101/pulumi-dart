...
class DeliveryPipelineArgs {
  ...
  DeliveryPipelineArgs({
    ...
    pulumi.Output<SerialPipeline>? serialPipeline,
    pulumi.Output<bool>? suspended,
      ...
      serialPipeline = pulumi.Input.asOptionalInput<SerialPipeline>(serialPipeline),
  ...
  factory DeliveryPipelineArgs.fromMap(Map<String, dynamic> map) {
    return DeliveryPipelineArgs(
      ...
      serialPipeline: map['serialPipeline'] == null ? null : pulumi.Output.create<SerialPipeline>(SerialPipeline.fromMap((map['serialPipeline'] as Map).cast<String, dynamic>())),
