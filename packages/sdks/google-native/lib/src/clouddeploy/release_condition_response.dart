...
class ReleaseConditionResponse {
  ...
  factory ReleaseConditionResponse.fromMap(Map<String, dynamic> map) {
    return ReleaseConditionResponse(
      releaseReadyCondition: (ReleaseReadyConditionResponse.fromMap((map['releaseReadyCondition'] as Map).cast<String, dynamic>())).input(),
      skaffoldSupportedCondition: (SkaffoldSupportedConditionResponse.fromMap((map['skaffoldSupportedCondition'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
