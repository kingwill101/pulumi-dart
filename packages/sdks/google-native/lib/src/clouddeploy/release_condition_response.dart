...
class ReleaseConditionResponse {
  ...
  final pulumi.Input<SkaffoldSupportedConditionResponse> skaffoldSupportedCondition;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'releaseReadyCondition': pulumi.Input.mapInputValue<ReleaseReadyConditionResponse, Map<String, dynamic>>(releaseReadyCondition, (value) => value.toMap()),
      'skaffoldSupportedCondition': pulumi.Input.mapInputValue<SkaffoldSupportedConditionResponse, Map<String, dynamic>>(skaffoldSupportedCondition, (value) => value.toMap()),
    };
  }

  factory ReleaseConditionResponse.fromMap(Map<String, dynamic> map) {
    return ReleaseConditionResponse(
      releaseReadyCondition: pulumi.Input.fromValue(ReleaseReadyConditionResponse.fromMap((map['releaseReadyCondition']! as Map).cast<String, dynamic>())),
      skaffoldSupportedCondition: pulumi.Input.fromValue(SkaffoldSupportedConditionResponse.fromMap((map['skaffoldSupportedCondition']! as Map).cast<String, dynamic>())),
    );
  }
}
