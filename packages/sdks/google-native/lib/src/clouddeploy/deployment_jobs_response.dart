...
class DeploymentJobsResponse {
  ...
  factory DeploymentJobsResponse.fromMap(Map<String, dynamic> map) {
    return DeploymentJobsResponse(
      deployJob: pulumi.Input.fromValue(JobResponse.fromMap((map['deployJob']! as Map).cast<String, dynamic>())),
      postdeployJob: pulumi.Input.fromValue(JobResponse.fromMap((map['postdeployJob']! as Map).cast<String, dynamic>())),
      predeployJob: pulumi.Input.fromValue(JobResponse.fromMap((map['predeployJob']! as Map).cast<String, dynamic>())),
      verifyJob: pulumi.Input.fromValue(JobResponse.fromMap((map['verifyJob']! as Map).cast<String, dynamic>())),
    );
  }
}
