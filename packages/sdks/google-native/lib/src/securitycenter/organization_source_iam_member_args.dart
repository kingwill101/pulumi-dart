...
/// {@template pulumi_securitycenter_v1_organization_source_iam_member_args_doc}
/// The set of arguments for OrganizationSourceIamMember.
/// {@endtemplate}
/// {@macro pulumi_securitycenter_v1_organization_source_iam_member_args_doc}
class OrganizationSourceIamMemberArgs {
  ...
  /// Creates a new [OrganizationSourceIamMemberArgs].
  ...
  const OrganizationSourceIamMemberArgs({
    this.condition,
  ...
  factory OrganizationSourceIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return OrganizationSourceIamMemberArgs(
