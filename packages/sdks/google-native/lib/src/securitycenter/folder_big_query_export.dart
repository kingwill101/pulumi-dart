...
import 'folder_big_query_export_args.dart';

/// Creates a BigQuery export.
/// Auto-naming is currently not supported for this resource.
class FolderBigQueryExport extends pulumi.CustomResource {
  ...
  /// Creates a new [FolderBigQueryExport].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [FolderBigQueryExport]. {@macro pulumi_securitycenter_v1_folder_big_query_export_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  FolderBigQueryExport(
    String name, {
    FolderBigQueryExportArgs? args,
