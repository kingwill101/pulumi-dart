...
class AuditLogConfigResponseSecuritycenterV1beta1 {
  ...
  factory AuditLogConfigResponseSecuritycenterV1beta1.fromMap(Map<String, dynamic> map) {
    return AuditLogConfigResponseSecuritycenterV1beta1(
