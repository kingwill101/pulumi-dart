...
/// {@template pulumi_securitycenter_v1beta1_organization_source_iam_member_securitycenter_v1beta1_args_doc}
/// The set of arguments for OrganizationSourceIamMember.
/// {@endtemplate}
/// {@macro pulumi_securitycenter_v1beta1_organization_source_iam_member_securitycenter_v1beta1_args_doc}
class OrganizationSourceIamMemberSecuritycenterV1beta1Args {
  ...
  /// Creates a new [OrganizationSourceIamMemberSecuritycenterV1beta1Args].
  ...
  const OrganizationSourceIamMemberSecuritycenterV1beta1Args({
    this.condition,
  ...
  factory OrganizationSourceIamMemberSecuritycenterV1beta1Args.fromMap(Map<String, dynamic> map) {
    return OrganizationSourceIamMemberSecuritycenterV1beta1Args(
