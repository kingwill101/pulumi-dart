...
class ExprResponseSecuritycenterV1beta1 {
  ...
  /// Creates a new [ExprResponseSecuritycenterV1beta1].
  ...
  const ExprResponseSecuritycenterV1beta1({
  ...
  factory ExprResponseSecuritycenterV1beta1.fromMap(Map<String, dynamic> map) {
    return ExprResponseSecuritycenterV1beta1(
