...
class GoogleCloudSecuritycenterV1CustomConfigResponse {
  ...
  final pulumi.Input<GoogleCloudSecuritycenterV1CustomOutputSpecResponse>
  customOutput;
  ...
  final pulumi.Input<GoogleCloudSecuritycenterV1ResourceSelectorResponse>
  resourceSelector;
  ...
  factory GoogleCloudSecuritycenterV1CustomConfigResponse.fromMap(
    ...
    return GoogleCloudSecuritycenterV1CustomConfigResponse(
      customOutput: pulumi.Input.fromValue(
        GoogleCloudSecuritycenterV1CustomOutputSpecResponse.fromMap(
