...
class GetOrganizationBigQueryExportResult {
  ...
  /// Creates a new [GetOrganizationBigQueryExportResult].
  ...
  const GetOrganizationBigQueryExportResult({
  ...
  factory GetOrganizationBigQueryExportResult.fromMap(Map<String, dynamic> map) {
