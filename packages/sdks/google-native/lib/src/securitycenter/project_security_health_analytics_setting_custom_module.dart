...
class ProjectSecurityHealthAnalyticsSettingCustomModule extends pulumi.CustomResource {
  ...
  ProjectSecurityHealthAnalyticsSettingCustomModule(
    ...
    this.customConfig = registerOutput<GoogleCloudSecuritycenterV1CustomConfigResponse>('customConfig');
