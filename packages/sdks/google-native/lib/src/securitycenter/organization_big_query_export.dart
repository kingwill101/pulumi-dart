...
import 'organization_big_query_export_args.dart';

/// Creates a BigQuery export.
class OrganizationBigQueryExport extends pulumi.CustomResource {
  ...
  /// Creates a new [OrganizationBigQueryExport].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [OrganizationBigQueryExport]. {@macro pulumi_securitycenter_v1_organization_big_query_export_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  OrganizationBigQueryExport(
    String name, {
    OrganizationBigQueryExportArgs? args,
