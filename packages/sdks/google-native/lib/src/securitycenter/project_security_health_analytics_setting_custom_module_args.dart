...
class ProjectSecurityHealthAnalyticsSettingCustomModuleArgs {
  ...
  /// [project] Optional.
  const ProjectSecurityHealthAnalyticsSettingCustomModuleArgs({
    this.customConfig,
    this.displayName,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'enablementState': ?pulumi.Input.mapOptionalInputValue<ProjectSecurityHealthAnalyticsSettingCustomModuleEnablementState, String>(enablementState, (value) => value.wireValue),
      'name': ?name,
      'project': ?project,
    };
  }
  ...
  factory ProjectSecurityHealthAnalyticsSettingCustomModuleArgs.fromMap(Map<String, dynamic> map) {
    return ProjectSecurityHealthAnalyticsSettingCustomModuleArgs(
      ...
      enablementState: (() { final guardedValue = map['enablementState']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ProjectSecurityHealthAnalyticsSettingCustomModuleEnablementState.fromValue(guardedValue as String)); })(),
