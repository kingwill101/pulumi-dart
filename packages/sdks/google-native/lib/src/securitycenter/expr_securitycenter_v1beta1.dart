...
class ExprSecuritycenterV1beta1 {
  ...
  /// Creates a new [ExprSecuritycenterV1beta1].
  ...
  const ExprSecuritycenterV1beta1({
    this.description,
    this.expression,
    this.location,
    this.title,
  ...
  factory ExprSecuritycenterV1beta1.fromMap(Map<String, dynamic> map) {
    return ExprSecuritycenterV1beta1(
