...
class FolderSecurityHealthAnalyticsSettingCustomModuleArgs {
  ...
  const FolderSecurityHealthAnalyticsSettingCustomModuleArgs({
    this.customConfig,
    this.displayName,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'enablementState': ?pulumi.Input.mapOptionalInputValue<FolderSecurityHealthAnalyticsSettingCustomModuleEnablementState, String>(enablementState, (value) => value.wireValue),
      'folderId': folderId,
      'name': ?name,
    };
  }
  ...
  factory FolderSecurityHealthAnalyticsSettingCustomModuleArgs.fromMap(Map<String, dynamic> map) {
    return FolderSecurityHealthAnalyticsSettingCustomModuleArgs(
      ...
      enablementState: (() { final guardedValue = map['enablementState']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FolderSecurityHealthAnalyticsSettingCustomModuleEnablementState.fromValue(guardedValue as String)); })(),
