...
/// Result data returned by getFolderBigQueryExport.
class GetFolderBigQueryExportResult {
  ...
  /// Creates a new [GetFolderBigQueryExportResult].
  ...
  factory GetFolderBigQueryExportResult.fromMap(Map<String, dynamic> map) {
