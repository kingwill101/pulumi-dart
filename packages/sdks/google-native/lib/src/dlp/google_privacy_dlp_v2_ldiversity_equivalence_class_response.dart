...
class GooglePrivacyDlpV2LDiversityEquivalenceClassResponse {
  ...
  factory GooglePrivacyDlpV2LDiversityEquivalenceClassResponse.fromMap(
    ...
    return GooglePrivacyDlpV2LDiversityEquivalenceClassResponse(
      equivalenceClassSize: pulumi.Input.fromValue(
        map['equivalenceClassSize'] as String,
      ),
      numDistinctSensitiveValues: pulumi.Input.fromValue(
        map['numDistinctSensitiveValues'] as String,
      ),
      ...
      topSensitiveValues: pulumi.Input.fromValue(
