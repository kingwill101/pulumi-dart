...
class GooglePrivacyDlpV2LDiversityEquivalenceClassResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'topSensitiveValues': pulumi.Input.encodeList<GooglePrivacyDlpV2ValueFrequencyResponse, Map<String, dynamic>>(topSensitiveValues, (value) => value.toMap()),
    };
  }
  ...
  factory GooglePrivacyDlpV2LDiversityEquivalenceClassResponse.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2LDiversityEquivalenceClassResponse(
      ...
      topSensitiveValues: pulumi.Input.decodeList<GooglePrivacyDlpV2ValueFrequencyResponse>(map['topSensitiveValues'], (value) => GooglePrivacyDlpV2ValueFrequencyResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
