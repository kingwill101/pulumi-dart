...
class GooglePrivacyDlpV2PrimitiveTransformation {
  ...
  /// Mask
  final pulumi.Input<GooglePrivacyDlpV2CharacterMaskConfig>?
  characterMaskConfig;

  /// Deterministic Crypto
  final pulumi.Input<GooglePrivacyDlpV2CryptoDeterministicConfig>?
  ...
  /// Ffx-Fpe
  final pulumi.Input<GooglePrivacyDlpV2CryptoReplaceFfxFpeConfig>?
  ...
  final pulumi.Input<GooglePrivacyDlpV2FixedSizeBucketingConfig>?
  ...
  final pulumi.Input<GooglePrivacyDlpV2ReplaceDictionaryConfig>?
