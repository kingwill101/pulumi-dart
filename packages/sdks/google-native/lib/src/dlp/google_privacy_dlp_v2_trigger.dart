...
class GooglePrivacyDlpV2Trigger {
  ...
  const GooglePrivacyDlpV2Trigger({
    this.manual,
    this.schedule,
  });
  ...
  factory GooglePrivacyDlpV2Trigger.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2Trigger(
      ...
      schedule: (() { final guardedValue = map['schedule']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GooglePrivacyDlpV2Schedule.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
