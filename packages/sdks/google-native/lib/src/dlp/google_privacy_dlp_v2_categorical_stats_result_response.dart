...
class GooglePrivacyDlpV2CategoricalStatsResultResponse {
  ...
  factory GooglePrivacyDlpV2CategoricalStatsResultResponse.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2CategoricalStatsResultResponse(
      valueFrequencyHistogramBuckets: (pulumi.Input.decodeList<GooglePrivacyDlpV2CategoricalStatsHistogramBucketResponse>(map['valueFrequencyHistogramBuckets'], (value) => GooglePrivacyDlpV2CategoricalStatsHistogramBucketResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
