...
class GooglePrivacyDlpV2DiscoveryGenerationCadenceResponse {
  ...
  factory GooglePrivacyDlpV2DiscoveryGenerationCadenceResponse.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2DiscoveryGenerationCadenceResponse(
      schemaModifiedCadence: (GooglePrivacyDlpV2DiscoverySchemaModifiedCadenceResponse.fromMap((map['schemaModifiedCadence'] as Map).cast<String, dynamic>())).input(),
      tableModifiedCadence: (GooglePrivacyDlpV2DiscoveryTableModifiedCadenceResponse.fromMap((map['tableModifiedCadence'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
