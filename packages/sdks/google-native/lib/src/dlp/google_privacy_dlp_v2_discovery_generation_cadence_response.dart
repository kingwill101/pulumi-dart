...
class GooglePrivacyDlpV2DiscoveryGenerationCadenceResponse {
  ...
  final pulumi.Input<GooglePrivacyDlpV2DiscoverySchemaModifiedCadenceResponse>
  schemaModifiedCadence;

  /// Governs when to update data profiles when a table is modified.
  final pulumi.Input<GooglePrivacyDlpV2DiscoveryTableModifiedCadenceResponse>
