...
class GooglePrivacyDlpV2HotwordRuleResponse {
  ...
  final pulumi.Input<GooglePrivacyDlpV2LikelihoodAdjustmentResponse> likelihoodAdjustment;
  ...
  const GooglePrivacyDlpV2HotwordRuleResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'likelihoodAdjustment': pulumi.Input.mapInputValue<GooglePrivacyDlpV2LikelihoodAdjustmentResponse, Map<String, dynamic>>(likelihoodAdjustment, (value) => value.toMap()),
  ...
  factory GooglePrivacyDlpV2HotwordRuleResponse.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2HotwordRuleResponse(
      ...
      likelihoodAdjustment: pulumi.Input.fromValue(GooglePrivacyDlpV2LikelihoodAdjustmentResponse.fromMap((map['likelihoodAdjustment']! as Map).cast<String, dynamic>())),
