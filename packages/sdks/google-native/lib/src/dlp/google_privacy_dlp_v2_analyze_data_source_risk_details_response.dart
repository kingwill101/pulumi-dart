...
class GooglePrivacyDlpV2AnalyzeDataSourceRiskDetailsResponse {
  ...
  final pulumi.Input<GooglePrivacyDlpV2CategoricalStatsResultResponse>
  categoricalStatsResult;

  /// Delta-presence result
  final pulumi.Input<GooglePrivacyDlpV2DeltaPresenceEstimationResultResponse>
  deltaPresenceEstimationResult;

  /// K-anonymity result
  final pulumi.Input<GooglePrivacyDlpV2KAnonymityResultResponse>
  kAnonymityResult;

  /// K-map result
  final pulumi.Input<GooglePrivacyDlpV2KMapEstimationResultResponse>
  kMapEstimationResult;

  /// L-divesity result
  final pulumi.Input<GooglePrivacyDlpV2LDiversityResultResponse>
  lDiversityResult;

  /// Numerical stats result
  final pulumi.Input<GooglePrivacyDlpV2NumericalStatsResultResponse>
  numericalStatsResult;

  /// The configuration used for this job.
  final pulumi.Input<GooglePrivacyDlpV2RequestedRiskAnalysisOptionsResponse>
  requestedOptions;

  /// Privacy metric to compute.
  final pulumi.Input<GooglePrivacyDlpV2PrivacyMetricResponse>
  requestedPrivacyMetric;

  /// Input dataset to compute metrics over.
  final pulumi.Input<GooglePrivacyDlpV2BigQueryTableResponse>
