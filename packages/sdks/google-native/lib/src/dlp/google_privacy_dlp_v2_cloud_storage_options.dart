...
class GooglePrivacyDlpV2CloudStorageOptions {
  ...
  final pulumi.Input<List<GooglePrivacyDlpV2CloudStorageOptionsFileTypesItem>>?
  fileTypes;

  /// Limits the number of files to scan to this percentage of the input FileSet. Number of files scanned is rounded down. Must be between 0 and 100, inclusively. Both 0 and 100 means no limit. Defaults to 0.
  final pulumi.Input<int>? filesLimitPercent;
  final pulumi.Input<GooglePrivacyDlpV2CloudStorageOptionsSampleMethod>?
  sampleMethod;
    ...
    return <String, dynamic>{
      ...
      'fileSet':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(fileSet, (value) => value.toMap()),
      'fileTypes':
          ?pulumi.Input.mapOptionalInputValue<
            List<GooglePrivacyDlpV2CloudStorageOptionsFileTypesItem>,
            List<String>
          >(
            fileTypes,
            (value) =>
      ...
      'sampleMethod':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(sampleMethod, (value) => value.wireValue),
    };
  }
  ...
  factory GooglePrivacyDlpV2CloudStorageOptions.fromMap(
    ...
    return GooglePrivacyDlpV2CloudStorageOptions(
      bytesLimitPerFile: (() {
        final guardedValue = map['bytesLimitPerFile'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      bytesLimitPerFilePercent: (() {
        final guardedValue = map['bytesLimitPerFilePercent'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      fileSet: (() {
        final guardedValue = map['fileSet'];
        if (guardedValue == null) return null;
      ...
      filesLimitPercent: (() {
        final guardedValue = map['filesLimitPercent'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      sampleMethod: (() {
        final guardedValue = map['sampleMethod'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
