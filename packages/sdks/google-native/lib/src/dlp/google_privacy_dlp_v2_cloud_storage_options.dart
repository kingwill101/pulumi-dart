...
class GooglePrivacyDlpV2CloudStorageOptions {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'fileTypes': ?pulumi.Input.mapOptionalInputValue<List<GooglePrivacyDlpV2CloudStorageOptionsFileTypesItem>, List<String>>(fileTypes, (value) => pulumi.Input.encodeList<GooglePrivacyDlpV2CloudStorageOptionsFileTypesItem, String>(value, (value) => value.value)),
      'filesLimitPercent': ?filesLimitPercent,
      'sampleMethod': ?pulumi.Input.mapOptionalInputValue<GooglePrivacyDlpV2CloudStorageOptionsSampleMethod, String>(sampleMethod, (value) => value.value),
    };
  }
