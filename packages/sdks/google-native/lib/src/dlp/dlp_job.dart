...
class DlpJob extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<GooglePrivacyDlpV2ActionDetailsResponse>> actionDetails;
  ...
  DlpJob(
    ...
    this.actionDetails = registerOutput<List<GooglePrivacyDlpV2ActionDetailsResponse>>('actionDetails');
    this.createTime = registerOutput<String>('createTime');
    this.endTime = registerOutput<String>('endTime');
    this.errors = registerOutput<List<GooglePrivacyDlpV2ErrorResponse>>('errors');
    this.inspectDetails = registerOutput<GooglePrivacyDlpV2InspectDataSourceDetailsResponse>('inspectDetails');
    ...
    this.riskDetails = registerOutput<GooglePrivacyDlpV2AnalyzeDataSourceRiskDetailsResponse>('riskDetails');
