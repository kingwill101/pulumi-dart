...
class GooglePrivacyDlpV2ResultResponse {
  ...
  final pulumi.Input<GooglePrivacyDlpV2HybridInspectStatisticsResponse>
  hybridStats;

  /// Statistics of how many instances of each info type were found during inspect job.
  final pulumi.Input<List<GooglePrivacyDlpV2InfoTypeStatsResponse>>
  infoTypeStats;
    ...
    return <String, dynamic>{
      'hybridStats':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(hybridStats, (value) => value.toMap()),
      'infoTypeStats':
          pulumi.Input.mapInputValue<
            List<GooglePrivacyDlpV2InfoTypeStatsResponse>,
  ...
  factory GooglePrivacyDlpV2ResultResponse.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2ResultResponse(
      hybridStats: pulumi.Input.fromValue(
        GooglePrivacyDlpV2HybridInspectStatisticsResponse.fromMap(
          (map['hybridStats']! as Map).cast<String, dynamic>(),
        ),
      ),
      infoTypeStats: pulumi.Input.fromValue(
      ...
      totalEstimatedBytes: pulumi.Input.fromValue(
        map['totalEstimatedBytes'] as String,
      ),
    );
  }
}
