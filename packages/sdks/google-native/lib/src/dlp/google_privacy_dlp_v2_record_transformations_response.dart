...
class GooglePrivacyDlpV2RecordTransformationsResponse {
  ...
  final pulumi.Input<List<GooglePrivacyDlpV2FieldTransformationResponse>>
  fieldTransformations;

  /// Configuration defining which records get suppressed entirely. Records that match any suppression rule are omitted from the output.
  final pulumi.Input<List<GooglePrivacyDlpV2RecordSuppressionResponse>>
  recordSuppressions;
    ...
    return <String, dynamic>{
      'fieldTransformations':
          pulumi.Input.mapInputValue<
            List<GooglePrivacyDlpV2FieldTransformationResponse>,
      ...
      'recordSuppressions':
          pulumi.Input.mapInputValue<
            List<GooglePrivacyDlpV2RecordSuppressionResponse>,
            List<Map<String, dynamic>>
          >(
            recordSuppressions,
            (value) =>
  ...
  factory GooglePrivacyDlpV2RecordTransformationsResponse.fromMap(
    ...
    return GooglePrivacyDlpV2RecordTransformationsResponse(
      fieldTransformations: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GooglePrivacyDlpV2FieldTransformationResponse>(
      ...
      recordSuppressions: pulumi.Input.fromValue(
