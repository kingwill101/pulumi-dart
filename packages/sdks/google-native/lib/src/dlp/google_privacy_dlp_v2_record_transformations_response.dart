...
class GooglePrivacyDlpV2RecordTransformationsResponse {
  ...
  factory GooglePrivacyDlpV2RecordTransformationsResponse.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2RecordTransformationsResponse(
      fieldTransformations: pulumi.Input.fromValue(pulumi.Input.decodeList<GooglePrivacyDlpV2FieldTransformationResponse>(map['fieldTransformations']!, (value) => GooglePrivacyDlpV2FieldTransformationResponse.fromMap((value as Map).cast<String, dynamic>()))),
      recordSuppressions: pulumi.Input.fromValue(pulumi.Input.decodeList<GooglePrivacyDlpV2RecordSuppressionResponse>(map['recordSuppressions']!, (value) => GooglePrivacyDlpV2RecordSuppressionResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
