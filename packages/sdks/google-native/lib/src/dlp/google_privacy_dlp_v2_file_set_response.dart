...
class GooglePrivacyDlpV2FileSetResponse {
  ...
  final pulumi.Input<GooglePrivacyDlpV2CloudStorageRegexFileSetResponse> regexFileSet;
  ...
  const GooglePrivacyDlpV2FileSetResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'regexFileSet': pulumi.Input.mapInputValue<GooglePrivacyDlpV2CloudStorageRegexFileSetResponse, Map<String, dynamic>>(regexFileSet, (value) => value.toMap()),
      'url': url,
    };
  }
  ...
  factory GooglePrivacyDlpV2FileSetResponse.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2FileSetResponse(
      regexFileSet: pulumi.Input.fromValue(GooglePrivacyDlpV2CloudStorageRegexFileSetResponse.fromMap((map['regexFileSet']! as Map).cast<String, dynamic>())),
