...
class GooglePrivacyDlpV2TransformationConfigResponse {
  ...
  factory GooglePrivacyDlpV2TransformationConfigResponse.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2TransformationConfigResponse(
      deidentifyTemplate: (map['deidentifyTemplate'] as String).input(),
      imageRedactTemplate: (map['imageRedactTemplate'] as String).input(),
      structuredDeidentifyTemplate: (map['structuredDeidentifyTemplate'] as String).input(),
    );
  }
}
