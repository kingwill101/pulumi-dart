...
class GooglePrivacyDlpV2KMapEstimationResultResponse {
  ...
  final pulumi.Input<
    List<GooglePrivacyDlpV2KMapEstimationHistogramBucketResponse>
  >
  ...
  factory GooglePrivacyDlpV2KMapEstimationResultResponse.fromMap(
    ...
    return GooglePrivacyDlpV2KMapEstimationResultResponse(
      kMapEstimationHistogram: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GooglePrivacyDlpV2KMapEstimationHistogramBucketResponse
        >(
          map['kMapEstimationHistogram']!,
          (value) =>
              GooglePrivacyDlpV2KMapEstimationHistogramBucketResponse.fromMap(
