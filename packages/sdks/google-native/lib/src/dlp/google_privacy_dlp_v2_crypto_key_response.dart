...
class GooglePrivacyDlpV2CryptoKeyResponse {
  ...
  const GooglePrivacyDlpV2CryptoKeyResponse({
  ...
  factory GooglePrivacyDlpV2CryptoKeyResponse.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2CryptoKeyResponse(
      kmsWrapped: pulumi.Input.fromValue(GooglePrivacyDlpV2KmsWrappedCryptoKeyResponse.fromMap((map['kmsWrapped']! as Map).cast<String, dynamic>())),
      transient: pulumi.Input.fromValue(GooglePrivacyDlpV2TransientCryptoKeyResponse.fromMap((map['transient']! as Map).cast<String, dynamic>())),
      unwrapped: pulumi.Input.fromValue(GooglePrivacyDlpV2UnwrappedCryptoKeyResponse.fromMap((map['unwrapped']! as Map).cast<String, dynamic>())),
    );
  }
}
