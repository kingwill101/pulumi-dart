...
class GooglePrivacyDlpV2CustomInfoType {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'detectionRules': ?detectionRules == null ? null : pulumi.Input.encodeList<GooglePrivacyDlpV2DetectionRule, Map<String, dynamic>>(detectionRules!, (value) => value.toMap()),
      'dictionary': ?dictionary == null ? null : dictionary!.toMap(),
      'exclusionType': ?exclusionType == null ? null : exclusionType!.value,
      'infoType': ?infoType == null ? null : infoType!.toMap(),
      'likelihood': ?likelihood == null ? null : likelihood!.value,
  ...
  factory GooglePrivacyDlpV2CustomInfoType.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2CustomInfoType(
      detectionRules: map['detectionRules'] == null ? null : pulumi.Input.decodeList<GooglePrivacyDlpV2DetectionRule>(map['detectionRules'], (value) => GooglePrivacyDlpV2DetectionRule.fromMap((value as Map).cast<String, dynamic>())),
      dictionary: map['dictionary'] == null ? null : GooglePrivacyDlpV2Dictionary.fromMap((map['dictionary'] as Map).cast<String, dynamic>()),
      exclusionType: map['exclusionType'] == null ? null : GooglePrivacyDlpV2CustomInfoTypeExclusionType.fromValue(map['exclusionType'] as String),
      infoType: map['infoType'] == null ? null : GooglePrivacyDlpV2InfoType.fromMap((map['infoType'] as Map).cast<String, dynamic>()),
      likelihood: map['likelihood'] == null ? null : GooglePrivacyDlpV2CustomInfoTypeLikelihood.fromValue(map['likelihood'] as String),
      ...
      storedType: map['storedType'] == null ? null : GooglePrivacyDlpV2StoredType.fromMap((map['storedType'] as Map).cast<String, dynamic>()),
