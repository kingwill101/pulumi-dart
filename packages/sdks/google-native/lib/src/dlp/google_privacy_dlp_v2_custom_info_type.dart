...
class GooglePrivacyDlpV2CustomInfoType {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'exclusionType': ?pulumi.Input.mapOptionalInputValue<GooglePrivacyDlpV2CustomInfoTypeExclusionType, String>(exclusionType, (value) => value.wireValue),
      'infoType': ?pulumi.Input.mapOptionalInputValue<GooglePrivacyDlpV2InfoType, Map<String, dynamic>>(infoType, (value) => value.toMap()),
      'likelihood': ?pulumi.Input.mapOptionalInputValue<GooglePrivacyDlpV2CustomInfoTypeLikelihood, String>(likelihood, (value) => value.wireValue),
  ...
  factory GooglePrivacyDlpV2CustomInfoType.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2CustomInfoType(
      detectionRules: (() { final guardedValue = map['detectionRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GooglePrivacyDlpV2DetectionRule>(guardedValue, (value) => GooglePrivacyDlpV2DetectionRule.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      exclusionType: (() { final guardedValue = map['exclusionType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GooglePrivacyDlpV2CustomInfoTypeExclusionType.fromValue(guardedValue as String)); })(),
      ...
      likelihood: (() { final guardedValue = map['likelihood']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GooglePrivacyDlpV2CustomInfoTypeLikelihood.fromValue(guardedValue as String)); })(),
      ...
      sensitivityScore: (() { final guardedValue = map['sensitivityScore']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GooglePrivacyDlpV2SensitivityScore.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      storedType: (() { final guardedValue = map['storedType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GooglePrivacyDlpV2StoredType.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
