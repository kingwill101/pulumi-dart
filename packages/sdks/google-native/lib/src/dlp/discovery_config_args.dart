...
class DiscoveryConfigArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'project': ?project,
      'status': pulumi.Input.mapInputValue<DiscoveryConfigStatus, String>(status, (value) => value.wireValue),
  ...
  factory DiscoveryConfigArgs.fromMap(Map<String, dynamic> map) {
    return DiscoveryConfigArgs(
      ...
      status: pulumi.Input.fromValue(DiscoveryConfigStatus.fromValue(map['status']! as String)),
