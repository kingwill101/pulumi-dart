...
class GooglePrivacyDlpV2ImageTransformationsResponse {
  final pulumi.Input<List<GooglePrivacyDlpV2ImageTransformationResponse>>
  transforms;
    ...
    return <String, dynamic>{
      'transforms':
          pulumi.Input.mapInputValue<
            List<GooglePrivacyDlpV2ImageTransformationResponse>,
  ...
  factory GooglePrivacyDlpV2ImageTransformationsResponse.fromMap(
    ...
    return GooglePrivacyDlpV2ImageTransformationsResponse(
      transforms: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GooglePrivacyDlpV2ImageTransformationResponse>(
          map['transforms']!,
