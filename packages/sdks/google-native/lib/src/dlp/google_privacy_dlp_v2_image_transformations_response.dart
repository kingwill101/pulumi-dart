...
class GooglePrivacyDlpV2ImageTransformationsResponse {
  ...
  factory GooglePrivacyDlpV2ImageTransformationsResponse.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2ImageTransformationsResponse(
      transforms: (pulumi.Input.decodeList<GooglePrivacyDlpV2ImageTransformationResponse>(map['transforms'], (value) => GooglePrivacyDlpV2ImageTransformationResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
