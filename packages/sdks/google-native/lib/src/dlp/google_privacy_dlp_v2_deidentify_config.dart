...
class GooglePrivacyDlpV2DeidentifyConfig {
  ...
  final pulumi.Input<GooglePrivacyDlpV2ImageTransformations>?
  imageTransformations;

  /// Treat the dataset as free-form text and apply the same free text transformation everywhere.
  final pulumi.Input<GooglePrivacyDlpV2InfoTypeTransformations>?
  infoTypeTransformations;

  /// Treat the dataset as structured. Transformations can be applied to specific locations within structured datasets, such as transforming a column within a table.
  final pulumi.Input<GooglePrivacyDlpV2RecordTransformations>?
  recordTransformations;

  /// Mode for handling transformation errors. If left unspecified, the default mode is `TransformationErrorHandling.ThrowError`.
  final pulumi.Input<GooglePrivacyDlpV2TransformationErrorHandling>?
  ...
  factory GooglePrivacyDlpV2DeidentifyConfig.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2DeidentifyConfig(
      ...
      transformationErrorHandling: (() {
        final guardedValue = map['transformationErrorHandling'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
