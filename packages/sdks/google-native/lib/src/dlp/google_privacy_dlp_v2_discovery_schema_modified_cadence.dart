...
class GooglePrivacyDlpV2DiscoverySchemaModifiedCadence {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'types': ?types == null ? null : pulumi.Input.encodeList<GooglePrivacyDlpV2DiscoverySchemaModifiedCadenceTypesItem, String>(types!, (value) => value.value),
    };
  }
  ...
  factory GooglePrivacyDlpV2DiscoverySchemaModifiedCadence.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2DiscoverySchemaModifiedCadence(
      frequency: map['frequency'] == null ? null : GooglePrivacyDlpV2DiscoverySchemaModifiedCadenceFrequency.fromValue(map['frequency'] as String),
      types: map['types'] == null ? null : pulumi.Input.decodeList<GooglePrivacyDlpV2DiscoverySchemaModifiedCadenceTypesItem>(map['types'], (value) => GooglePrivacyDlpV2DiscoverySchemaModifiedCadenceTypesItem.fromValue(value as String)),
    );
  }
}
