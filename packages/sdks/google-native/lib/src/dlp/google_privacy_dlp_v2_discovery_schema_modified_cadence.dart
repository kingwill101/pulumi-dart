...
class GooglePrivacyDlpV2DiscoverySchemaModifiedCadence {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'frequency': ?pulumi.Input.mapOptionalInputValue<GooglePrivacyDlpV2DiscoverySchemaModifiedCadenceFrequency, String>(frequency, (value) => value.wireValue),
      'types': ?pulumi.Input.mapOptionalInputValue<List<GooglePrivacyDlpV2DiscoverySchemaModifiedCadenceTypesItem>, List<String>>(types, (value) => pulumi.Input.encodeList<GooglePrivacyDlpV2DiscoverySchemaModifiedCadenceTypesItem, String>(value, (value) => value.wireValue)),
    };
  }
  ...
  factory GooglePrivacyDlpV2DiscoverySchemaModifiedCadence.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2DiscoverySchemaModifiedCadence(
      frequency: (() { final guardedValue = map['frequency']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GooglePrivacyDlpV2DiscoverySchemaModifiedCadenceFrequency.fromValue(guardedValue as String)); })(),
      types: (() { final guardedValue = map['types']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GooglePrivacyDlpV2DiscoverySchemaModifiedCadenceTypesItem>(guardedValue, (value) => GooglePrivacyDlpV2DiscoverySchemaModifiedCadenceTypesItem.fromValue(value as String))); })(),
    );
  }
}
