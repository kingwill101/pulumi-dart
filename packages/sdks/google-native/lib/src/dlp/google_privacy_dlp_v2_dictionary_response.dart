...
class GooglePrivacyDlpV2DictionaryResponse {
  ...
  final pulumi.Input<GooglePrivacyDlpV2CloudStoragePathResponse> cloudStoragePath;
  ...
  const GooglePrivacyDlpV2DictionaryResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'cloudStoragePath': pulumi.Input.mapInputValue<GooglePrivacyDlpV2CloudStoragePathResponse, Map<String, dynamic>>(cloudStoragePath, (value) => value.toMap()),
  ...
  factory GooglePrivacyDlpV2DictionaryResponse.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2DictionaryResponse(
      cloudStoragePath: pulumi.Input.fromValue(GooglePrivacyDlpV2CloudStoragePathResponse.fromMap((map['cloudStoragePath']! as Map).cast<String, dynamic>())),
