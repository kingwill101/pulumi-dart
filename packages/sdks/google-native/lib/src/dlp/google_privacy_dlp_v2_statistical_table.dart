...
class GooglePrivacyDlpV2StatisticalTable {
  ...
  factory GooglePrivacyDlpV2StatisticalTable.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2StatisticalTable(
      quasiIds: pulumi.Input.fromValue(pulumi.Input.decodeList<GooglePrivacyDlpV2QuasiIdentifierField>(map['quasiIds']!, (value) => GooglePrivacyDlpV2QuasiIdentifierField.fromMap((value as Map).cast<String, dynamic>()))),
