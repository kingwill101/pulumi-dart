...
class GooglePrivacyDlpV2BigQueryDiscoveryTargetResponse {
  ...
  factory GooglePrivacyDlpV2BigQueryDiscoveryTargetResponse.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2BigQueryDiscoveryTargetResponse(
      cadence: (GooglePrivacyDlpV2DiscoveryGenerationCadenceResponse.fromMap((map['cadence'] as Map).cast<String, dynamic>())).input(),
      conditions: (GooglePrivacyDlpV2DiscoveryBigQueryConditionsResponse.fromMap((map['conditions'] as Map).cast<String, dynamic>())).input(),
      disabled: ((map['disabled'] as Map).cast<String, dynamic>()).input(),
      filter: (GooglePrivacyDlpV2DiscoveryBigQueryFilterResponse.fromMap((map['filter'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
