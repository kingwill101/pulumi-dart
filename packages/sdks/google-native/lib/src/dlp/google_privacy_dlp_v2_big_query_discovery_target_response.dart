...
class GooglePrivacyDlpV2BigQueryDiscoveryTargetResponse {
  ...
  final pulumi.Input<GooglePrivacyDlpV2DiscoveryGenerationCadenceResponse>
  cadence;

  /// In addition to matching the filter, these conditions must be true before a profile is generated.
  final pulumi.Input<GooglePrivacyDlpV2DiscoveryBigQueryConditionsResponse>
  conditions;
  ...
  factory GooglePrivacyDlpV2BigQueryDiscoveryTargetResponse.fromMap(
    ...
    return GooglePrivacyDlpV2BigQueryDiscoveryTargetResponse(
      cadence: pulumi.Input.fromValue(
        GooglePrivacyDlpV2DiscoveryGenerationCadenceResponse.fromMap(
          (map['cadence']! as Map).cast<String, dynamic>(),
        ),
      ),
      conditions: pulumi.Input.fromValue(
        GooglePrivacyDlpV2DiscoveryBigQueryConditionsResponse.fromMap(
          (map['conditions']! as Map).cast<String, dynamic>(),
        ),
      ),
      disabled: pulumi.Input.fromValue(
        (map['disabled']! as Map).cast<String, dynamic>(),
      ),
      filter: pulumi.Input.fromValue(
        GooglePrivacyDlpV2DiscoveryBigQueryFilterResponse.fromMap(
