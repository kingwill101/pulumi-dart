...
class GooglePrivacyDlpV2NumericalStatsResultResponse {
  ...
  factory GooglePrivacyDlpV2NumericalStatsResultResponse.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2NumericalStatsResultResponse(
      maxValue: (GooglePrivacyDlpV2ValueResponse.fromMap((map['maxValue'] as Map).cast<String, dynamic>())).input(),
      minValue: (GooglePrivacyDlpV2ValueResponse.fromMap((map['minValue'] as Map).cast<String, dynamic>())).input(),
      quantileValues: (pulumi.Input.decodeList<GooglePrivacyDlpV2ValueResponse>(map['quantileValues'], (value) => GooglePrivacyDlpV2ValueResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
