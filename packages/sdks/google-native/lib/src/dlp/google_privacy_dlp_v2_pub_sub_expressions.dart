...
class GooglePrivacyDlpV2PubSubExpressions {
  ...
  final pulumi.Input<GooglePrivacyDlpV2PubSubExpressionsLogicalOperator>?
  logicalOperator;
  ...
  GooglePrivacyDlpV2PubSubExpressions({this.conditions, this.logicalOperator});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'conditions':
          ?pulumi.Input.mapOptionalInputValue<
            List<GooglePrivacyDlpV2PubSubCondition>,
