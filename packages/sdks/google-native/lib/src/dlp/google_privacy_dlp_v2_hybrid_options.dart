...
class GooglePrivacyDlpV2HybridOptions {
  ...
  factory GooglePrivacyDlpV2HybridOptions.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2HybridOptions(
      ...
      tableOptions: (() { final guardedValue = map['tableOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GooglePrivacyDlpV2TableOptions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
