...
class GooglePrivacyDlpV2DataProfileActionResponse {
  ...
  factory GooglePrivacyDlpV2DataProfileActionResponse.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2DataProfileActionResponse(
      exportData: (GooglePrivacyDlpV2ExportResponse.fromMap((map['exportData'] as Map).cast<String, dynamic>())).input(),
      pubSubNotification: (GooglePrivacyDlpV2PubSubNotificationResponse.fromMap((map['pubSubNotification'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
