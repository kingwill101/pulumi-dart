...
class GooglePrivacyDlpV2ImageTransformation {
  ...
  const GooglePrivacyDlpV2ImageTransformation({
    this.allInfoTypes,
    this.allText,
    this.redactionColor,
  ...
  factory GooglePrivacyDlpV2ImageTransformation.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2ImageTransformation(
      ...
      redactionColor: (() { final guardedValue = map['redactionColor']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GooglePrivacyDlpV2Color.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      selectedInfoTypes: (() { final guardedValue = map['selectedInfoTypes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GooglePrivacyDlpV2SelectedInfoTypes.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
