...
class GooglePrivacyDlpV2OrgConfigResponse {
  ...
  final pulumi.Input<GooglePrivacyDlpV2DiscoveryStartingLocationResponse> location;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'location': pulumi.Input.mapInputValue<GooglePrivacyDlpV2DiscoveryStartingLocationResponse, Map<String, dynamic>>(location, (value) => value.toMap()),
      'project': project,
    };
  }
  ...
  factory GooglePrivacyDlpV2OrgConfigResponse.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2OrgConfigResponse(
      location: pulumi.Input.fromValue(GooglePrivacyDlpV2DiscoveryStartingLocationResponse.fromMap((map['location']! as Map).cast<String, dynamic>())),
