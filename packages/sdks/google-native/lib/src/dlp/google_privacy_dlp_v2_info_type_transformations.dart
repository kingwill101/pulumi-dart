...
class GooglePrivacyDlpV2InfoTypeTransformations {
  ...
  final pulumi.Input<List<GooglePrivacyDlpV2InfoTypeTransformation>>
  transformations_;
  ...
  GooglePrivacyDlpV2InfoTypeTransformations({required this.transformations_});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'transformations':
          pulumi.Input.mapInputValue<
            List<GooglePrivacyDlpV2InfoTypeTransformation>,
