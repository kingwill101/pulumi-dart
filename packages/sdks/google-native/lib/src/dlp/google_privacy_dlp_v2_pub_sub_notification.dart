...
class GooglePrivacyDlpV2PubSubNotification {
  ...
  const GooglePrivacyDlpV2PubSubNotification({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'detailOfMessage': ?pulumi.Input.mapOptionalInputValue<GooglePrivacyDlpV2PubSubNotificationDetailOfMessage, String>(detailOfMessage, (value) => value.wireValue),
      'event': ?pulumi.Input.mapOptionalInputValue<GooglePrivacyDlpV2PubSubNotificationEvent, String>(event, (value) => value.wireValue),
  ...
  factory GooglePrivacyDlpV2PubSubNotification.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2PubSubNotification(
      detailOfMessage: (() { final guardedValue = map['detailOfMessage']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GooglePrivacyDlpV2PubSubNotificationDetailOfMessage.fromValue(guardedValue as String)); })(),
      event: (() { final guardedValue = map['event']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GooglePrivacyDlpV2PubSubNotificationEvent.fromValue(guardedValue as String)); })(),
      pubsubCondition: (() { final guardedValue = map['pubsubCondition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GooglePrivacyDlpV2DataProfilePubSubCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
