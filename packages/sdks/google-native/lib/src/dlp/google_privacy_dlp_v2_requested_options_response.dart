...
class GooglePrivacyDlpV2RequestedOptionsResponse {
  ...
  factory GooglePrivacyDlpV2RequestedOptionsResponse.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2RequestedOptionsResponse(
      jobConfig: pulumi.Input.fromValue(GooglePrivacyDlpV2InspectJobConfigResponse.fromMap((map['jobConfig']! as Map).cast<String, dynamic>())),
      snapshotInspectTemplate: pulumi.Input.fromValue(GooglePrivacyDlpV2InspectTemplateResponse.fromMap((map['snapshotInspectTemplate']! as Map).cast<String, dynamic>())),
    );
  }
}
