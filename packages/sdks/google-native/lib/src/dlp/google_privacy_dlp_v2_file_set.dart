...
class GooglePrivacyDlpV2FileSet {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'regexFileSet': ?pulumi.Input.mapOptionalInputValue<GooglePrivacyDlpV2CloudStorageRegexFileSet, Map<String, dynamic>>(regexFileSet, (value) => value.toMap()),
      'url': ?url,
    };
  }
  ...
  factory GooglePrivacyDlpV2FileSet.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2FileSet(
      regexFileSet: (() { final guardedValue = map['regexFileSet']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GooglePrivacyDlpV2CloudStorageRegexFileSet.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
