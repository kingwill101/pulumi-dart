...
class GooglePrivacyDlpV2BigQueryOptions {
  ...
  final pulumi.Input<GooglePrivacyDlpV2BigQueryOptionsSampleMethod>?
  sampleMethod;
  ...
  factory GooglePrivacyDlpV2BigQueryOptions.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2BigQueryOptions(
      excludedFields: (() {
        final guardedValue = map['excludedFields'];
      ...
      includedFields: (() {
        final guardedValue = map['includedFields'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GooglePrivacyDlpV2FieldId>(
            guardedValue,
      ...
      rowsLimit: (() {
        final guardedValue = map['rowsLimit'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      rowsLimitPercent: (() {
        final guardedValue = map['rowsLimitPercent'];
        if (guardedValue == null) return null;
