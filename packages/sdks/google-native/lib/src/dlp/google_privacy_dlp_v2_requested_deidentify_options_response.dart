...
class GooglePrivacyDlpV2RequestedDeidentifyOptionsResponse {
  ...
  final pulumi.Input<GooglePrivacyDlpV2DeidentifyTemplateResponse>
    ...
    return <String, dynamic>{
      'snapshotDeidentifyTemplate':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(snapshotDeidentifyTemplate, (value) => value.toMap()),
      'snapshotImageRedactTemplate':
          pulumi.Input.mapInputValue<
            GooglePrivacyDlpV2DeidentifyTemplateResponse,
            Map<String, dynamic>
          >(snapshotImageRedactTemplate, (value) => value.toMap()),
      'snapshotStructuredDeidentifyTemplate':
          pulumi.Input.mapInputValue<
            GooglePrivacyDlpV2DeidentifyTemplateResponse,
            Map<String, dynamic>
          >(snapshotStructuredDeidentifyTemplate, (value) => value.toMap()),
    };
  }
