...
class GooglePrivacyDlpV2PubSubExpressionsResponse {
  ...
  factory GooglePrivacyDlpV2PubSubExpressionsResponse.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2PubSubExpressionsResponse(
      conditions: (pulumi.Input.decodeList<GooglePrivacyDlpV2PubSubConditionResponse>(map['conditions'], (value) => GooglePrivacyDlpV2PubSubConditionResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
