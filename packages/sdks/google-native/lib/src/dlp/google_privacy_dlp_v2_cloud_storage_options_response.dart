...
class GooglePrivacyDlpV2CloudStorageOptionsResponse {
  ...
  factory GooglePrivacyDlpV2CloudStorageOptionsResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return GooglePrivacyDlpV2CloudStorageOptionsResponse(
      bytesLimitPerFile: pulumi.Input.fromValue(
        map['bytesLimitPerFile'] as String,
      ),
      bytesLimitPerFilePercent: pulumi.Input.fromValue(
        map['bytesLimitPerFilePercent'] as int,
      ),
      fileSet: pulumi.Input.fromValue(
        GooglePrivacyDlpV2FileSetResponse.fromMap(
          (map['fileSet']! as Map).cast<String, dynamic>(),
        ),
      ),
      fileTypes: pulumi.Input.fromValue(
        (map['fileTypes'] as List).cast<String>(),
      ),
      filesLimitPercent: pulumi.Input.fromValue(
