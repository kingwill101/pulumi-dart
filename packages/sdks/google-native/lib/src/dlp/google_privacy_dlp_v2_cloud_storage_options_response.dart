...
class GooglePrivacyDlpV2CloudStorageOptionsResponse {
  ...
  factory GooglePrivacyDlpV2CloudStorageOptionsResponse.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2CloudStorageOptionsResponse(
      bytesLimitPerFile: (map['bytesLimitPerFile'] as String).input(),
      bytesLimitPerFilePercent: (map['bytesLimitPerFilePercent'] as int).input(),
      fileSet: (GooglePrivacyDlpV2FileSetResponse.fromMap((map['fileSet'] as Map).cast<String, dynamic>())).input(),
      fileTypes: ((map['fileTypes'] as List).cast<String>()).input(),
      filesLimitPercent: (map['filesLimitPercent'] as int).input(),
