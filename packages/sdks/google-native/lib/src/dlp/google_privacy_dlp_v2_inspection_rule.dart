...
class GooglePrivacyDlpV2InspectionRule {
  ...
  const GooglePrivacyDlpV2InspectionRule({
    this.exclusionRule,
    this.hotwordRule,
  });
  ...
  factory GooglePrivacyDlpV2InspectionRule.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2InspectionRule(
      exclusionRule: (() { final guardedValue = map['exclusionRule']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GooglePrivacyDlpV2ExclusionRule.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
