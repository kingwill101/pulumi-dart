...
class GooglePrivacyDlpV2KAnonymityConfig {
  ...
  const GooglePrivacyDlpV2KAnonymityConfig({
    this.entityId,
    this.quasiIds,
  });
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'entityId': ?pulumi.Input.mapOptionalInputValue<GooglePrivacyDlpV2EntityId, Map<String, dynamic>>(entityId, (value) => value.toMap()),
  ...
  factory GooglePrivacyDlpV2KAnonymityConfig.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2KAnonymityConfig(
      entityId: (() { final guardedValue = map['entityId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GooglePrivacyDlpV2EntityId.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
