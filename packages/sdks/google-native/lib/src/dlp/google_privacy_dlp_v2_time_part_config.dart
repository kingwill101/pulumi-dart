...
class GooglePrivacyDlpV2TimePartConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'partToExtract': ?pulumi.Input.mapOptionalInputValue<GooglePrivacyDlpV2TimePartConfigPartToExtract, String>(partToExtract, (value) => value.wireValue),
    };
  }

  factory GooglePrivacyDlpV2TimePartConfig.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2TimePartConfig(
      partToExtract: (() { final guardedValue = map['partToExtract']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GooglePrivacyDlpV2TimePartConfigPartToExtract.fromValue(guardedValue as String)); })(),
    );
  }
}
