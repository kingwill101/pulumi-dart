...
class GooglePrivacyDlpV2CryptoReplaceFfxFpeConfigResponse {
  ...
  const GooglePrivacyDlpV2CryptoReplaceFfxFpeConfigResponse({
  ...
  factory GooglePrivacyDlpV2CryptoReplaceFfxFpeConfigResponse.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2CryptoReplaceFfxFpeConfigResponse(
      commonAlphabet: pulumi.Input.fromValue(map['commonAlphabet'] as String),
      ...
      customAlphabet: pulumi.Input.fromValue(map['customAlphabet'] as String),
      radix: pulumi.Input.fromValue(map['radix'] as int),
      surrogateInfoType: pulumi.Input.fromValue(GooglePrivacyDlpV2InfoTypeResponse.fromMap((map['surrogateInfoType']! as Map).cast<String, dynamic>())),
    );
  }
}
