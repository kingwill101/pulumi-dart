...
class GooglePrivacyDlpV2DeidentifyResponse {
  ...
  factory GooglePrivacyDlpV2DeidentifyResponse.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2DeidentifyResponse(
      ...
      fileTypesToTransform: ((map['fileTypesToTransform'] as List).cast<String>()).input(),
      transformationConfig: (GooglePrivacyDlpV2TransformationConfigResponse.fromMap((map['transformationConfig'] as Map).cast<String, dynamic>())).input(),
      transformationDetailsStorageConfig: (GooglePrivacyDlpV2TransformationDetailsStorageConfigResponse.fromMap((map['transformationDetailsStorageConfig'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
