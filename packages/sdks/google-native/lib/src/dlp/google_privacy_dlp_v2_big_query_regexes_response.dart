...
class GooglePrivacyDlpV2BigQueryRegexesResponse {
  ...
  factory GooglePrivacyDlpV2BigQueryRegexesResponse.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2BigQueryRegexesResponse(
      patterns: (pulumi.Input.decodeList<GooglePrivacyDlpV2BigQueryRegexResponse>(map['patterns'], (value) => GooglePrivacyDlpV2BigQueryRegexResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
