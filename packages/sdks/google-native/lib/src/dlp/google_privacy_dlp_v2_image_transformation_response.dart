...
class GooglePrivacyDlpV2ImageTransformationResponse {
  ...
  final pulumi.Input<GooglePrivacyDlpV2SelectedInfoTypesResponse>
  selectedInfoTypes;
  ...
  factory GooglePrivacyDlpV2ImageTransformationResponse.fromMap(
    ...
    return GooglePrivacyDlpV2ImageTransformationResponse(
      allInfoTypes: pulumi.Input.fromValue(
        (map['allInfoTypes']! as Map).cast<String, dynamic>(),
      ),
      allText: pulumi.Input.fromValue(
        (map['allText']! as Map).cast<String, dynamic>(),
      ),
      redactionColor: pulumi.Input.fromValue(
        GooglePrivacyDlpV2ColorResponse.fromMap(
          (map['redactionColor']! as Map).cast<String, dynamic>(),
        ),
      ),
      selectedInfoTypes: pulumi.Input.fromValue(
        GooglePrivacyDlpV2SelectedInfoTypesResponse.fromMap(
