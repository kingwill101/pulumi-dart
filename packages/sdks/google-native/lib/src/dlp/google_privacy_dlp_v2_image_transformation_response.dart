...
class GooglePrivacyDlpV2ImageTransformationResponse {
  ...
  factory GooglePrivacyDlpV2ImageTransformationResponse.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2ImageTransformationResponse(
      allInfoTypes: pulumi.Input.fromValue((map['allInfoTypes']! as Map).cast<String, dynamic>()),
      allText: pulumi.Input.fromValue((map['allText']! as Map).cast<String, dynamic>()),
      redactionColor: pulumi.Input.fromValue(GooglePrivacyDlpV2ColorResponse.fromMap((map['redactionColor']! as Map).cast<String, dynamic>())),
      selectedInfoTypes: pulumi.Input.fromValue(GooglePrivacyDlpV2SelectedInfoTypesResponse.fromMap((map['selectedInfoTypes']! as Map).cast<String, dynamic>())),
    );
  }
}
