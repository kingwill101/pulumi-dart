...
class GooglePrivacyDlpV2ErrorResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'details': pulumi.Input.mapInputValue<GoogleRpcStatusResponse, Map<String, dynamic>>(details, (value) => value.toMap()),
  ...
  factory GooglePrivacyDlpV2ErrorResponse.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2ErrorResponse(
      details: pulumi.Input.fromValue(GoogleRpcStatusResponse.fromMap((map['details']! as Map).cast<String, dynamic>())),
      timestamps: pulumi.Input.fromValue((map['timestamps'] as List).cast<String>()),
    );
  }
}
