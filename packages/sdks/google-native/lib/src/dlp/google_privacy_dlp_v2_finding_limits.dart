...
class GooglePrivacyDlpV2FindingLimits {
  ...
  const GooglePrivacyDlpV2FindingLimits({
  ...
  factory GooglePrivacyDlpV2FindingLimits.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2FindingLimits(
      maxFindingsPerInfoType: (() { final guardedValue = map['maxFindingsPerInfoType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GooglePrivacyDlpV2InfoTypeLimit>(guardedValue, (value) => GooglePrivacyDlpV2InfoTypeLimit.fromMap((value as Map).cast<String, dynamic>()))); })(),
      maxFindingsPerItem: (() { final guardedValue = map['maxFindingsPerItem']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      maxFindingsPerRequest: (() { final guardedValue = map['maxFindingsPerRequest']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
    );
  }
}
