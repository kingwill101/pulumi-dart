...
class GooglePrivacyDlpV2FindingLimits {
  ...
  final pulumi.Input<List<GooglePrivacyDlpV2InfoTypeLimit>>?
    ...
    return <String, dynamic>{
      'maxFindingsPerInfoType':
          ?pulumi.Input.mapOptionalInputValue<
            List<GooglePrivacyDlpV2InfoTypeLimit>,
  ...
  factory GooglePrivacyDlpV2FindingLimits.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2FindingLimits(
      maxFindingsPerInfoType: (() {
        final guardedValue = map['maxFindingsPerInfoType'];
      ...
      maxFindingsPerItem: (() {
        final guardedValue = map['maxFindingsPerItem'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      maxFindingsPerRequest: (() {
        final guardedValue = map['maxFindingsPerRequest'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
    );
