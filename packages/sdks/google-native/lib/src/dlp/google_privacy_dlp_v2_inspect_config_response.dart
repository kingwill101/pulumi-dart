...
class GooglePrivacyDlpV2InspectConfigResponse {
  ...
  final pulumi.Input<List<GooglePrivacyDlpV2CustomInfoTypeResponse>>
  customInfoTypes;
  ...
  final pulumi.Input<List<GooglePrivacyDlpV2InfoTypeLikelihoodResponse>>
    ...
    return <String, dynamic>{
      ...
      'customInfoTypes':
          pulumi.Input.mapInputValue<
            List<GooglePrivacyDlpV2CustomInfoTypeResponse>,
      ...
      'minLikelihoodPerInfoType':
          pulumi.Input.mapInputValue<
            List<GooglePrivacyDlpV2InfoTypeLikelihoodResponse>,
            List<Map<String, dynamic>>
          >(
            minLikelihoodPerInfoType,
            (value) =>
      ...
      'ruleSet':
          pulumi.Input.mapInputValue<
            List<GooglePrivacyDlpV2InspectionRuleSetResponse>,
            List<Map<String, dynamic>>
          >(
            ruleSet,
            (value) =>
  ...
  factory GooglePrivacyDlpV2InspectConfigResponse.fromMap(
    ...
    return GooglePrivacyDlpV2InspectConfigResponse(
      contentOptions: pulumi.Input.fromValue(
        (map['contentOptions'] as List).cast<String>(),
      ),
      customInfoTypes: pulumi.Input.fromValue(
      ...
      ruleSet: pulumi.Input.fromValue(
