...
class GooglePrivacyDlpV2InspectConfigResponse {
  ...
  final pulumi.Input<List<GooglePrivacyDlpV2CustomInfoTypeResponse>> customInfoTypes;
  ...
  final pulumi.Input<GooglePrivacyDlpV2FindingLimitsResponse> limits;
  ...
  final pulumi.Input<List<GooglePrivacyDlpV2InfoTypeLikelihoodResponse>> minLikelihoodPerInfoType;
  /// Set of rules to apply to the findings for this InspectConfig. Exclusion rules, contained in the set are executed in the end, other rules are executed in the order they are specified for each info type.
  final pulumi.Input<List<GooglePrivacyDlpV2InspectionRuleSetResponse>> ruleSet;
  ...
  const GooglePrivacyDlpV2InspectConfigResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'customInfoTypes': pulumi.Input.mapInputValue<List<GooglePrivacyDlpV2CustomInfoTypeResponse>, List<Map<String, dynamic>>>(customInfoTypes, (value) => pulumi.Input.encodeList<GooglePrivacyDlpV2CustomInfoTypeResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      ...
      'limits': pulumi.Input.mapInputValue<GooglePrivacyDlpV2FindingLimitsResponse, Map<String, dynamic>>(limits, (value) => value.toMap()),
      'minLikelihood': minLikelihood,
      'minLikelihoodPerInfoType': pulumi.Input.mapInputValue<List<GooglePrivacyDlpV2InfoTypeLikelihoodResponse>, List<Map<String, dynamic>>>(minLikelihoodPerInfoType, (value) => pulumi.Input.encodeList<GooglePrivacyDlpV2InfoTypeLikelihoodResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'ruleSet': pulumi.Input.mapInputValue<List<GooglePrivacyDlpV2InspectionRuleSetResponse>, List<Map<String, dynamic>>>(ruleSet, (value) => pulumi.Input.encodeList<GooglePrivacyDlpV2InspectionRuleSetResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory GooglePrivacyDlpV2InspectConfigResponse.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2InspectConfigResponse(
      contentOptions: pulumi.Input.fromValue((map['contentOptions'] as List).cast<String>()),
      customInfoTypes: pulumi.Input.fromValue(pulumi.Input.decodeList<GooglePrivacyDlpV2CustomInfoTypeResponse>(map['customInfoTypes']!, (value) => GooglePrivacyDlpV2CustomInfoTypeResponse.fromMap((value as Map).cast<String, dynamic>()))),
      excludeInfoTypes: pulumi.Input.fromValue(map['excludeInfoTypes'] as bool),
      includeQuote: pulumi.Input.fromValue(map['includeQuote'] as bool),
      ...
      limits: pulumi.Input.fromValue(GooglePrivacyDlpV2FindingLimitsResponse.fromMap((map['limits']! as Map).cast<String, dynamic>())),
      minLikelihood: pulumi.Input.fromValue(map['minLikelihood'] as String),
      minLikelihoodPerInfoType: pulumi.Input.fromValue(pulumi.Input.decodeList<GooglePrivacyDlpV2InfoTypeLikelihoodResponse>(map['minLikelihoodPerInfoType']!, (value) => GooglePrivacyDlpV2InfoTypeLikelihoodResponse.fromMap((value as Map).cast<String, dynamic>()))),
      ruleSet: pulumi.Input.fromValue(pulumi.Input.decodeList<GooglePrivacyDlpV2InspectionRuleSetResponse>(map['ruleSet']!, (value) => GooglePrivacyDlpV2InspectionRuleSetResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
