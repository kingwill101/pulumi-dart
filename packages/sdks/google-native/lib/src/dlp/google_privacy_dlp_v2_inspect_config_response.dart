...
class GooglePrivacyDlpV2InspectConfigResponse {
  ...
  factory GooglePrivacyDlpV2InspectConfigResponse.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2InspectConfigResponse(
      contentOptions: ((map['contentOptions'] as List).cast<String>()).input(),
      customInfoTypes: (pulumi.Input.decodeList<GooglePrivacyDlpV2CustomInfoTypeResponse>(map['customInfoTypes'], (value) => GooglePrivacyDlpV2CustomInfoTypeResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      excludeInfoTypes: (map['excludeInfoTypes'] as bool).input(),
      includeQuote: (map['includeQuote'] as bool).input(),
      ...
      limits: (GooglePrivacyDlpV2FindingLimitsResponse.fromMap((map['limits'] as Map).cast<String, dynamic>())).input(),
      minLikelihood: (map['minLikelihood'] as String).input(),
      minLikelihoodPerInfoType: (pulumi.Input.decodeList<GooglePrivacyDlpV2InfoTypeLikelihoodResponse>(map['minLikelihoodPerInfoType'], (value) => GooglePrivacyDlpV2InfoTypeLikelihoodResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ruleSet: (pulumi.Input.decodeList<GooglePrivacyDlpV2InspectionRuleSetResponse>(map['ruleSet'], (value) => GooglePrivacyDlpV2InspectionRuleSetResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
