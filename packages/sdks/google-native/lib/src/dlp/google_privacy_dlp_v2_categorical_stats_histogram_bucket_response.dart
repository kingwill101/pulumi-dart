...
class GooglePrivacyDlpV2CategoricalStatsHistogramBucketResponse {
  ...
  factory GooglePrivacyDlpV2CategoricalStatsHistogramBucketResponse.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2CategoricalStatsHistogramBucketResponse(
      ...
      bucketValues: pulumi.Input.fromValue(pulumi.Input.decodeList<GooglePrivacyDlpV2ValueFrequencyResponse>(map['bucketValues']!, (value) => GooglePrivacyDlpV2ValueFrequencyResponse.fromMap((value as Map).cast<String, dynamic>()))),
      valueFrequencyLowerBound: pulumi.Input.fromValue(map['valueFrequencyLowerBound'] as String),
      valueFrequencyUpperBound: pulumi.Input.fromValue(map['valueFrequencyUpperBound'] as String),
    );
  }
}
