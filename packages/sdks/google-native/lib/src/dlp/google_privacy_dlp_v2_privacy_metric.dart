...
class GooglePrivacyDlpV2PrivacyMetric {
  /// Categorical stats
  final pulumi.Input<GooglePrivacyDlpV2CategoricalStatsConfig>?
  categoricalStatsConfig;

  /// delta-presence
  final pulumi.Input<GooglePrivacyDlpV2DeltaPresenceEstimationConfig>?
  ...
  /// k-map
  final pulumi.Input<GooglePrivacyDlpV2KMapEstimationConfig>?
  ...
  /// Numerical stats
  final pulumi.Input<GooglePrivacyDlpV2NumericalStatsConfig>?
  ...
  factory GooglePrivacyDlpV2PrivacyMetric.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2PrivacyMetric(
      categoricalStatsConfig: (() {
        final guardedValue = map['categoricalStatsConfig'];
      ...
      deltaPresenceEstimationConfig: (() {
        final guardedValue = map['deltaPresenceEstimationConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      kAnonymityConfig: (() {
        final guardedValue = map['kAnonymityConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      kMapEstimationConfig: (() {
        final guardedValue = map['kMapEstimationConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      lDiversityConfig: (() {
        final guardedValue = map['lDiversityConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      numericalStatsConfig: (() {
        final guardedValue = map['numericalStatsConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
