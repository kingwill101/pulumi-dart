...
class GooglePrivacyDlpV2TimespanConfigResponse {
  ...
  factory GooglePrivacyDlpV2TimespanConfigResponse.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2TimespanConfigResponse(
      enableAutoPopulationOfTimespanConfig: (map['enableAutoPopulationOfTimespanConfig'] as bool).input(),
      endTime: (map['endTime'] as String).input(),
      startTime: (map['startTime'] as String).input(),
      timestampField: (GooglePrivacyDlpV2FieldIdResponse.fromMap((map['timestampField'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
