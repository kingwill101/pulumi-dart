...
class GooglePrivacyDlpV2TimespanConfigResponse {
  ...
  const GooglePrivacyDlpV2TimespanConfigResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'endTime': endTime,
      'startTime': startTime,
      'timestampField': pulumi.Input.mapInputValue<GooglePrivacyDlpV2FieldIdResponse, Map<String, dynamic>>(timestampField, (value) => value.toMap()),
    };
  }

  factory GooglePrivacyDlpV2TimespanConfigResponse.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2TimespanConfigResponse(
      enableAutoPopulationOfTimespanConfig: pulumi.Input.fromValue(map['enableAutoPopulationOfTimespanConfig'] as bool),
      endTime: pulumi.Input.fromValue(map['endTime'] as String),
      startTime: pulumi.Input.fromValue(map['startTime'] as String),
      timestampField: pulumi.Input.fromValue(GooglePrivacyDlpV2FieldIdResponse.fromMap((map['timestampField']! as Map).cast<String, dynamic>())),
    );
  }
}
