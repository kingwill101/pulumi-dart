...
class GooglePrivacyDlpV2LDiversityConfig {
  ...
  factory GooglePrivacyDlpV2LDiversityConfig.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2LDiversityConfig(
      quasiIds: (() { final guardedValue = map['quasiIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GooglePrivacyDlpV2FieldId>(guardedValue, (value) => GooglePrivacyDlpV2FieldId.fromMap((value as Map).cast<String, dynamic>()))); })(),
      sensitiveAttribute: (() { final guardedValue = map['sensitiveAttribute']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GooglePrivacyDlpV2FieldId.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
