...
class GooglePrivacyDlpV2InspectConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'contentOptions': ?pulumi.Input.mapOptionalInputValue<List<GooglePrivacyDlpV2InspectConfigContentOptionsItem>, List<String>>(contentOptions, (value) => pulumi.Input.encodeList<GooglePrivacyDlpV2InspectConfigContentOptionsItem, String>(value, (value) => value.wireValue)),
      ...
      'minLikelihood': ?pulumi.Input.mapOptionalInputValue<GooglePrivacyDlpV2InspectConfigMinLikelihood, String>(minLikelihood, (value) => value.wireValue),
  ...
  factory GooglePrivacyDlpV2InspectConfig.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2InspectConfig(
      contentOptions: (() { final guardedValue = map['contentOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GooglePrivacyDlpV2InspectConfigContentOptionsItem>(guardedValue, (value) => GooglePrivacyDlpV2InspectConfigContentOptionsItem.fromValue(value as String))); })(),
      customInfoTypes: (() { final guardedValue = map['customInfoTypes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GooglePrivacyDlpV2CustomInfoType>(guardedValue, (value) => GooglePrivacyDlpV2CustomInfoType.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      limits: (() { final guardedValue = map['limits']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GooglePrivacyDlpV2FindingLimits.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      minLikelihood: (() { final guardedValue = map['minLikelihood']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GooglePrivacyDlpV2InspectConfigMinLikelihood.fromValue(guardedValue as String)); })(),
      minLikelihoodPerInfoType: (() { final guardedValue = map['minLikelihoodPerInfoType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GooglePrivacyDlpV2InfoTypeLikelihood>(guardedValue, (value) => GooglePrivacyDlpV2InfoTypeLikelihood.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ruleSet: (() { final guardedValue = map['ruleSet']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GooglePrivacyDlpV2InspectionRuleSet>(guardedValue, (value) => GooglePrivacyDlpV2InspectionRuleSet.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
