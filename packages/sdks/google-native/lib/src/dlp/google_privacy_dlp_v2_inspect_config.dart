...
class GooglePrivacyDlpV2InspectConfig {
  ...
  final pulumi.Input<List<GooglePrivacyDlpV2InspectConfigContentOptionsItem>>?
  contentOptions;
  ...
  final pulumi.Input<GooglePrivacyDlpV2InspectConfigMinLikelihood>?
  minLikelihood;

  /// Minimum likelihood per infotype. For each infotype, a user can specify a minimum likelihood. The system only returns a finding if its likelihood is above this threshold. If this field is not set, the system uses the InspectConfig min_likelihood.
  final pulumi.Input<List<GooglePrivacyDlpV2InfoTypeLikelihood>>?
    ...
    return <String, dynamic>{
      'contentOptions':
          ?pulumi.Input.mapOptionalInputValue<
            List<GooglePrivacyDlpV2InspectConfigContentOptionsItem>,
            List<String>
          >(
            contentOptions,
            (value) =>
  ...
  factory GooglePrivacyDlpV2InspectConfig.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2InspectConfig(
      contentOptions: (() {
        final guardedValue = map['contentOptions'];
      ...
      customInfoTypes: (() {
        final guardedValue = map['customInfoTypes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      includeQuote: (() {
        final guardedValue = map['includeQuote'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      infoTypes: (() {
      ...
      minLikelihoodPerInfoType: (() {
        final guardedValue = map['minLikelihoodPerInfoType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      ruleSet: (() {
        final guardedValue = map['ruleSet'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
