...
class GooglePrivacyDlpV2PrivacyMetricResponse {
  /// Categorical stats
  final pulumi.Input<GooglePrivacyDlpV2CategoricalStatsConfigResponse>
  categoricalStatsConfig;

  /// delta-presence
  final pulumi.Input<GooglePrivacyDlpV2DeltaPresenceEstimationConfigResponse>
  deltaPresenceEstimationConfig;

  /// K-anonymity
  final pulumi.Input<GooglePrivacyDlpV2KAnonymityConfigResponse>
  kAnonymityConfig;

  /// k-map
  final pulumi.Input<GooglePrivacyDlpV2KMapEstimationConfigResponse>
  kMapEstimationConfig;

  /// l-diversity
  final pulumi.Input<GooglePrivacyDlpV2LDiversityConfigResponse>
  lDiversityConfig;

  /// Numerical stats
  final pulumi.Input<GooglePrivacyDlpV2NumericalStatsConfigResponse>
    ...
    return <String, dynamic>{
      'categoricalStatsConfig':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(categoricalStatsConfig, (value) => value.toMap()),
      'deltaPresenceEstimationConfig':
          pulumi.Input.mapInputValue<
            GooglePrivacyDlpV2DeltaPresenceEstimationConfigResponse,
            Map<String, dynamic>
          >(deltaPresenceEstimationConfig, (value) => value.toMap()),
      'kAnonymityConfig':
          pulumi.Input.mapInputValue<
            GooglePrivacyDlpV2KAnonymityConfigResponse,
            Map<String, dynamic>
          >(kAnonymityConfig, (value) => value.toMap()),
      'kMapEstimationConfig':
          pulumi.Input.mapInputValue<
            GooglePrivacyDlpV2KMapEstimationConfigResponse,
            Map<String, dynamic>
          >(kMapEstimationConfig, (value) => value.toMap()),
      'lDiversityConfig':
          pulumi.Input.mapInputValue<
            GooglePrivacyDlpV2LDiversityConfigResponse,
            Map<String, dynamic>
          >(lDiversityConfig, (value) => value.toMap()),
      'numericalStatsConfig':
          pulumi.Input.mapInputValue<
            GooglePrivacyDlpV2NumericalStatsConfigResponse,
            Map<String, dynamic>
          >(numericalStatsConfig, (value) => value.toMap()),
    };
  }
