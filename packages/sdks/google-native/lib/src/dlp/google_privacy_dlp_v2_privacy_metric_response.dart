...
class GooglePrivacyDlpV2PrivacyMetricResponse {
  ...
  factory GooglePrivacyDlpV2PrivacyMetricResponse.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2PrivacyMetricResponse(
      categoricalStatsConfig: (GooglePrivacyDlpV2CategoricalStatsConfigResponse.fromMap((map['categoricalStatsConfig'] as Map).cast<String, dynamic>())).input(),
      deltaPresenceEstimationConfig: (GooglePrivacyDlpV2DeltaPresenceEstimationConfigResponse.fromMap((map['deltaPresenceEstimationConfig'] as Map).cast<String, dynamic>())).input(),
      kAnonymityConfig: (GooglePrivacyDlpV2KAnonymityConfigResponse.fromMap((map['kAnonymityConfig'] as Map).cast<String, dynamic>())).input(),
      kMapEstimationConfig: (GooglePrivacyDlpV2KMapEstimationConfigResponse.fromMap((map['kMapEstimationConfig'] as Map).cast<String, dynamic>())).input(),
      lDiversityConfig: (GooglePrivacyDlpV2LDiversityConfigResponse.fromMap((map['lDiversityConfig'] as Map).cast<String, dynamic>())).input(),
      numericalStatsConfig: (GooglePrivacyDlpV2NumericalStatsConfigResponse.fromMap((map['numericalStatsConfig'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
