...
class GooglePrivacyDlpV2DeltaPresenceEstimationConfigResponse {
  ...
  factory GooglePrivacyDlpV2DeltaPresenceEstimationConfigResponse.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2DeltaPresenceEstimationConfigResponse(
      auxiliaryTables: (pulumi.Input.decodeList<GooglePrivacyDlpV2StatisticalTableResponse>(map['auxiliaryTables'], (value) => GooglePrivacyDlpV2StatisticalTableResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      quasiIds: (pulumi.Input.decodeList<GooglePrivacyDlpV2QuasiIdResponse>(map['quasiIds'], (value) => GooglePrivacyDlpV2QuasiIdResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
