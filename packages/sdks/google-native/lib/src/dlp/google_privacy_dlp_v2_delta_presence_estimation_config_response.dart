...
class GooglePrivacyDlpV2DeltaPresenceEstimationConfigResponse {
  ...
  final pulumi.Input<List<GooglePrivacyDlpV2StatisticalTableResponse>>
  auxiliaryTables;
    ...
    return <String, dynamic>{
      'auxiliaryTables':
          pulumi.Input.mapInputValue<
            List<GooglePrivacyDlpV2StatisticalTableResponse>,
      ...
      'quasiIds':
          pulumi.Input.mapInputValue<
            List<GooglePrivacyDlpV2QuasiIdResponse>,
            List<Map<String, dynamic>>
          >(
            quasiIds,
            (value) =>
  ...
  factory GooglePrivacyDlpV2DeltaPresenceEstimationConfigResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return GooglePrivacyDlpV2DeltaPresenceEstimationConfigResponse(
      auxiliaryTables: pulumi.Input.fromValue(
      ...
      quasiIds: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GooglePrivacyDlpV2QuasiIdResponse>(
          map['quasiIds']!,
