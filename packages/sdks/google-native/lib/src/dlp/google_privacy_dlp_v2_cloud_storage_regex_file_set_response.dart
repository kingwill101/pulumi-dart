...
class GooglePrivacyDlpV2CloudStorageRegexFileSetResponse {
  ...
  /// Creates a new [GooglePrivacyDlpV2CloudStorageRegexFileSetResponse].
  ...
  const GooglePrivacyDlpV2CloudStorageRegexFileSetResponse({
  ...
  factory GooglePrivacyDlpV2CloudStorageRegexFileSetResponse.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2CloudStorageRegexFileSetResponse(
      bucketName: pulumi.Input.fromValue(map['bucketName'] as String),
      excludeRegex: pulumi.Input.fromValue((map['excludeRegex'] as List).cast<String>()),
      includeRegex: pulumi.Input.fromValue((map['includeRegex'] as List).cast<String>()),
    );
  }
}
