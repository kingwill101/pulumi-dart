...
class GooglePrivacyDlpV2KMapEstimationConfig {
    ...
    return <String, dynamic>{
      'auxiliaryTables':
          ?pulumi.Input.mapOptionalInputValue<
            List<GooglePrivacyDlpV2AuxiliaryTable>,
      ...
      'quasiIds':
          pulumi.Input.mapInputValue<
            List<GooglePrivacyDlpV2TaggedField>,
            List<Map<String, dynamic>>
          >(
            quasiIds,
            (value) =>
  ...
  factory GooglePrivacyDlpV2KMapEstimationConfig.fromMap(
    ...
    return GooglePrivacyDlpV2KMapEstimationConfig(
      auxiliaryTables: (() {
        final guardedValue = map['auxiliaryTables'];
      ...
      quasiIds: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GooglePrivacyDlpV2TaggedField>(
          map['quasiIds']!,
