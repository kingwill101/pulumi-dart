...
class GooglePrivacyDlpV2KMapEstimationConfig {
  ...
  const GooglePrivacyDlpV2KMapEstimationConfig({
  ...
  factory GooglePrivacyDlpV2KMapEstimationConfig.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2KMapEstimationConfig(
      auxiliaryTables: (() { final guardedValue = map['auxiliaryTables']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GooglePrivacyDlpV2AuxiliaryTable>(guardedValue, (value) => GooglePrivacyDlpV2AuxiliaryTable.fromMap((value as Map).cast<String, dynamic>()))); })(),
      quasiIds: pulumi.Input.fromValue(pulumi.Input.decodeList<GooglePrivacyDlpV2TaggedField>(map['quasiIds']!, (value) => GooglePrivacyDlpV2TaggedField.fromMap((value as Map).cast<String, dynamic>()))),
