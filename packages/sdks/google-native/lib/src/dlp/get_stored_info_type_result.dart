...
class GetStoredInfoTypeResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': name,
      'pendingVersions': pulumi.Input.encodeList<GooglePrivacyDlpV2StoredInfoTypeVersionResponse, Map<String, dynamic>>(pendingVersions, (value) => value.toMap()),
    };
  }

  factory GetStoredInfoTypeResult.fromMap(Map<String, dynamic> map) {
    return GetStoredInfoTypeResult(
      currentVersion: GooglePrivacyDlpV2StoredInfoTypeVersionResponse.fromMap((map['currentVersion']! as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      pendingVersions: pulumi.Input.decodeList<GooglePrivacyDlpV2StoredInfoTypeVersionResponse>(map['pendingVersions']!, (value) => GooglePrivacyDlpV2StoredInfoTypeVersionResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
