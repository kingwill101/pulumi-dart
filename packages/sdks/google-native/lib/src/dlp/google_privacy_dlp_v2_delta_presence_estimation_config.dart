...
class GooglePrivacyDlpV2DeltaPresenceEstimationConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'auxiliaryTables': ?auxiliaryTables == null ? null : pulumi.Input.encodeList<GooglePrivacyDlpV2StatisticalTable, Map<String, dynamic>>(auxiliaryTables!, (value) => value.toMap()),
      'quasiIds': pulumi.Input.encodeList<GooglePrivacyDlpV2QuasiId, Map<String, dynamic>>(quasiIds, (value) => value.toMap()),
  ...
  factory GooglePrivacyDlpV2DeltaPresenceEstimationConfig.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2DeltaPresenceEstimationConfig(
      auxiliaryTables: map['auxiliaryTables'] == null ? null : pulumi.Input.decodeList<GooglePrivacyDlpV2StatisticalTable>(map['auxiliaryTables'], (value) => GooglePrivacyDlpV2StatisticalTable.fromMap((value as Map).cast<String, dynamic>())),
      quasiIds: pulumi.Input.decodeList<GooglePrivacyDlpV2QuasiId>(map['quasiIds'], (value) => GooglePrivacyDlpV2QuasiId.fromMap((value as Map).cast<String, dynamic>())),
