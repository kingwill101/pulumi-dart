...
class GooglePrivacyDlpV2TimespanConfig {
  ...
  final pulumi.Input<GooglePrivacyDlpV2FieldId>? timestampField;

  /// Creates a new [GooglePrivacyDlpV2TimespanConfig].
  ...
  const GooglePrivacyDlpV2TimespanConfig({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'endTime': ?endTime,
      'startTime': ?startTime,
      'timestampField': ?pulumi.Input.mapOptionalInputValue<GooglePrivacyDlpV2FieldId, Map<String, dynamic>>(timestampField, (value) => value.toMap()),
    };
  }
  ...
  factory GooglePrivacyDlpV2TimespanConfig.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2TimespanConfig(
      ...
      timestampField: (() { final guardedValue = map['timestampField']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GooglePrivacyDlpV2FieldId.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
