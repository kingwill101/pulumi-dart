...
class GooglePrivacyDlpV2StoredInfoTypeVersionResponse {
  ...
  factory GooglePrivacyDlpV2StoredInfoTypeVersionResponse.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2StoredInfoTypeVersionResponse(
      config: GooglePrivacyDlpV2StoredInfoTypeConfigResponse.fromMap((map['config'] as Map).cast<String, dynamic>()),
      ...
      stats: GooglePrivacyDlpV2StoredInfoTypeStatsResponse.fromMap((map['stats'] as Map).cast<String, dynamic>()),
    );
  }
}
