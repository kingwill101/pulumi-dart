...
class GooglePrivacyDlpV2StoredInfoTypeVersionResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'errors':
          pulumi.Input.mapInputValue<
            List<GooglePrivacyDlpV2ErrorResponse>,
  ...
  factory GooglePrivacyDlpV2StoredInfoTypeVersionResponse.fromMap(
    ...
    return GooglePrivacyDlpV2StoredInfoTypeVersionResponse(
      config: pulumi.Input.fromValue(
        GooglePrivacyDlpV2StoredInfoTypeConfigResponse.fromMap(
          (map['config']! as Map).cast<String, dynamic>(),
        ),
      ),
      createTime: pulumi.Input.fromValue(map['createTime'] as String),
      errors: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GooglePrivacyDlpV2ErrorResponse>(
          map['errors']!,
      ...
      stats: pulumi.Input.fromValue(
        GooglePrivacyDlpV2StoredInfoTypeStatsResponse.fromMap(
