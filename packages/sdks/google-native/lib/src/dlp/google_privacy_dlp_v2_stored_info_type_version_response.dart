...
class GooglePrivacyDlpV2StoredInfoTypeVersionResponse {
  ...
  factory GooglePrivacyDlpV2StoredInfoTypeVersionResponse.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2StoredInfoTypeVersionResponse(
      config: (GooglePrivacyDlpV2StoredInfoTypeConfigResponse.fromMap((map['config'] as Map).cast<String, dynamic>())).input(),
      createTime: (map['createTime'] as String).input(),
      errors: (pulumi.Input.decodeList<GooglePrivacyDlpV2ErrorResponse>(map['errors'], (value) => GooglePrivacyDlpV2ErrorResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      state: (map['state'] as String).input(),
      stats: (GooglePrivacyDlpV2StoredInfoTypeStatsResponse.fromMap((map['stats'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
