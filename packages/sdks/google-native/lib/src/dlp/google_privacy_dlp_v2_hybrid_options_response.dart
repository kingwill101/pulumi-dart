...
class GooglePrivacyDlpV2HybridOptionsResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'tableOptions': tableOptions.toMap(),
    };
  }
  ...
  factory GooglePrivacyDlpV2HybridOptionsResponse.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2HybridOptionsResponse(
      ...
      requiredFindingLabelKeys: (map['requiredFindingLabelKeys'] as List).cast<String>(),
      tableOptions: GooglePrivacyDlpV2TableOptionsResponse.fromMap((map['tableOptions'] as Map).cast<String, dynamic>()),
    );
  }
}
