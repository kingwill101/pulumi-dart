...
class GooglePrivacyDlpV2HybridOptionsResponse {
  ...
  factory GooglePrivacyDlpV2HybridOptionsResponse.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2HybridOptionsResponse(
      ...
      requiredFindingLabelKeys: ((map['requiredFindingLabelKeys'] as List).cast<String>()).input(),
      tableOptions: (GooglePrivacyDlpV2TableOptionsResponse.fromMap((map['tableOptions'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
