...
class GooglePrivacyDlpV2Deidentify {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'fileTypesToTransform': ?pulumi.Input.mapOptionalInputValue<List<GooglePrivacyDlpV2DeidentifyFileTypesToTransformItem>, List<String>>(fileTypesToTransform, (value) => pulumi.Input.encodeList<GooglePrivacyDlpV2DeidentifyFileTypesToTransformItem, String>(value, (value) => value.value)),
