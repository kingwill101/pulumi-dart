...
class GooglePrivacyDlpV2CryptoKey {
  ...
  factory GooglePrivacyDlpV2CryptoKey.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2CryptoKey(
      kmsWrapped: (() { final guardedValue = map['kmsWrapped']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GooglePrivacyDlpV2KmsWrappedCryptoKey.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      transient: (() { final guardedValue = map['transient']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GooglePrivacyDlpV2TransientCryptoKey.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      unwrapped: (() { final guardedValue = map['unwrapped']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GooglePrivacyDlpV2UnwrappedCryptoKey.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
