...
class GooglePrivacyDlpV2CustomInfoTypeResponse {
  ...
  factory GooglePrivacyDlpV2CustomInfoTypeResponse.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2CustomInfoTypeResponse(
      detectionRules: (pulumi.Input.decodeList<GooglePrivacyDlpV2DetectionRuleResponse>(map['detectionRules'], (value) => GooglePrivacyDlpV2DetectionRuleResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      dictionary: (GooglePrivacyDlpV2DictionaryResponse.fromMap((map['dictionary'] as Map).cast<String, dynamic>())).input(),
      exclusionType: (map['exclusionType'] as String).input(),
      infoType: (GooglePrivacyDlpV2InfoTypeResponse.fromMap((map['infoType'] as Map).cast<String, dynamic>())).input(),
      likelihood: (map['likelihood'] as String).input(),
      ...
      storedType: (GooglePrivacyDlpV2StoredTypeResponse.fromMap((map['storedType'] as Map).cast<String, dynamic>())).input(),
      surrogateType: ((map['surrogateType'] as Map).cast<String, dynamic>()).input(),
    );
  }
}
