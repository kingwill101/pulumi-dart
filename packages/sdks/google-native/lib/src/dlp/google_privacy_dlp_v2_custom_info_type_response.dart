...
class GooglePrivacyDlpV2CustomInfoTypeResponse {
  ...
  final pulumi.Input<List<GooglePrivacyDlpV2DetectionRuleResponse>> detectionRules;
  ...
  const GooglePrivacyDlpV2CustomInfoTypeResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'detectionRules': pulumi.Input.mapInputValue<List<GooglePrivacyDlpV2DetectionRuleResponse>, List<Map<String, dynamic>>>(detectionRules, (value) => pulumi.Input.encodeList<GooglePrivacyDlpV2DetectionRuleResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      ...
      'storedType': pulumi.Input.mapInputValue<GooglePrivacyDlpV2StoredTypeResponse, Map<String, dynamic>>(storedType, (value) => value.toMap()),
      'surrogateType': surrogateType,
    };
  }

  factory GooglePrivacyDlpV2CustomInfoTypeResponse.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2CustomInfoTypeResponse(
      detectionRules: pulumi.Input.fromValue(pulumi.Input.decodeList<GooglePrivacyDlpV2DetectionRuleResponse>(map['detectionRules']!, (value) => GooglePrivacyDlpV2DetectionRuleResponse.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      storedType: pulumi.Input.fromValue(GooglePrivacyDlpV2StoredTypeResponse.fromMap((map['storedType']! as Map).cast<String, dynamic>())),
      surrogateType: pulumi.Input.fromValue((map['surrogateType']! as Map).cast<String, dynamic>()),
    );
  }
}
