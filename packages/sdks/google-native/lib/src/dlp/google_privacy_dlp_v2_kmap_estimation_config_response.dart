...
class GooglePrivacyDlpV2KMapEstimationConfigResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'auxiliaryTables': pulumi.Input.encodeList<GooglePrivacyDlpV2AuxiliaryTableResponse, Map<String, dynamic>>(auxiliaryTables, (value) => value.toMap()),
      'quasiIds': pulumi.Input.encodeList<GooglePrivacyDlpV2TaggedFieldResponse, Map<String, dynamic>>(quasiIds, (value) => value.toMap()),
  ...
  factory GooglePrivacyDlpV2KMapEstimationConfigResponse.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2KMapEstimationConfigResponse(
      auxiliaryTables: pulumi.Input.decodeList<GooglePrivacyDlpV2AuxiliaryTableResponse>(map['auxiliaryTables'], (value) => GooglePrivacyDlpV2AuxiliaryTableResponse.fromMap((value as Map).cast<String, dynamic>())),
      quasiIds: pulumi.Input.decodeList<GooglePrivacyDlpV2TaggedFieldResponse>(map['quasiIds'], (value) => GooglePrivacyDlpV2TaggedFieldResponse.fromMap((value as Map).cast<String, dynamic>())),
