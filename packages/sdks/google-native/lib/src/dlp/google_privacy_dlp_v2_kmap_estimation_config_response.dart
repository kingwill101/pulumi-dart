...
class GooglePrivacyDlpV2KMapEstimationConfigResponse {
  ...
  final pulumi.Input<List<GooglePrivacyDlpV2AuxiliaryTableResponse>>
  auxiliaryTables;
    ...
    return <String, dynamic>{
      'auxiliaryTables':
          pulumi.Input.mapInputValue<
            List<GooglePrivacyDlpV2AuxiliaryTableResponse>,
      ...
      'quasiIds':
          pulumi.Input.mapInputValue<
            List<GooglePrivacyDlpV2TaggedFieldResponse>,
            List<Map<String, dynamic>>
          >(
            quasiIds,
            (value) =>
  ...
  factory GooglePrivacyDlpV2KMapEstimationConfigResponse.fromMap(
    ...
    return GooglePrivacyDlpV2KMapEstimationConfigResponse(
      ...
      quasiIds: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GooglePrivacyDlpV2TaggedFieldResponse>(
          map['quasiIds']!,
