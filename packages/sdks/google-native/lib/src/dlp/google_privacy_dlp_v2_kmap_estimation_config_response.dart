...
class GooglePrivacyDlpV2KMapEstimationConfigResponse {
  ...
  factory GooglePrivacyDlpV2KMapEstimationConfigResponse.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2KMapEstimationConfigResponse(
      auxiliaryTables: (pulumi.Input.decodeList<GooglePrivacyDlpV2AuxiliaryTableResponse>(map['auxiliaryTables'], (value) => GooglePrivacyDlpV2AuxiliaryTableResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      quasiIds: (pulumi.Input.decodeList<GooglePrivacyDlpV2TaggedFieldResponse>(map['quasiIds'], (value) => GooglePrivacyDlpV2TaggedFieldResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
