...
class GooglePrivacyDlpV2DeidentifyConfigResponse {
  ...
  factory GooglePrivacyDlpV2DeidentifyConfigResponse.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2DeidentifyConfigResponse(
      imageTransformations: pulumi.Input.fromValue(GooglePrivacyDlpV2ImageTransformationsResponse.fromMap((map['imageTransformations']! as Map).cast<String, dynamic>())),
      ...
      recordTransformations: pulumi.Input.fromValue(GooglePrivacyDlpV2RecordTransformationsResponse.fromMap((map['recordTransformations']! as Map).cast<String, dynamic>())),
      transformationErrorHandling: pulumi.Input.fromValue(GooglePrivacyDlpV2TransformationErrorHandlingResponse.fromMap((map['transformationErrorHandling']! as Map).cast<String, dynamic>())),
    );
  }
}
