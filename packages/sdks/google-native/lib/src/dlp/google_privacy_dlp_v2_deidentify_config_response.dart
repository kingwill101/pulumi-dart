...
class GooglePrivacyDlpV2DeidentifyConfigResponse {
  ...
  final pulumi.Input<GooglePrivacyDlpV2ImageTransformationsResponse>
  ...
  final pulumi.Input<GooglePrivacyDlpV2RecordTransformationsResponse>
  recordTransformations;

  /// Mode for handling transformation errors. If left unspecified, the default mode is `TransformationErrorHandling.ThrowError`.
  final pulumi.Input<GooglePrivacyDlpV2TransformationErrorHandlingResponse>
    ...
    return <String, dynamic>{
      ...
      'transformationErrorHandling':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(transformationErrorHandling, (value) => value.toMap()),
    };
  }
  ...
  factory GooglePrivacyDlpV2DeidentifyConfigResponse.fromMap(
    ...
    return GooglePrivacyDlpV2DeidentifyConfigResponse(
      imageTransformations: pulumi.Input.fromValue(
