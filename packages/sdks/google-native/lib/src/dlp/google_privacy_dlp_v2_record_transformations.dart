...
class GooglePrivacyDlpV2RecordTransformations {
  ...
  final pulumi.Input<List<GooglePrivacyDlpV2FieldTransformation>>?
  fieldTransformations;

  /// Configuration defining which records get suppressed entirely. Records that match any suppression rule are omitted from the output.
  final pulumi.Input<List<GooglePrivacyDlpV2RecordSuppression>>?
  recordSuppressions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'recordSuppressions':
          ?pulumi.Input.mapOptionalInputValue<
            List<GooglePrivacyDlpV2RecordSuppression>,
            List<Map<String, dynamic>>
          >(
            recordSuppressions,
            (value) =>
