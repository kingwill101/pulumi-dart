...
class GooglePrivacyDlpV2LikelihoodAdjustment {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'fixedLikelihood': ?pulumi.Input.mapOptionalInputValue<GooglePrivacyDlpV2LikelihoodAdjustmentFixedLikelihood, String>(fixedLikelihood, (value) => value.wireValue),
  ...
  factory GooglePrivacyDlpV2LikelihoodAdjustment.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2LikelihoodAdjustment(
      fixedLikelihood: (() { final guardedValue = map['fixedLikelihood']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GooglePrivacyDlpV2LikelihoodAdjustmentFixedLikelihood.fromValue(guardedValue as String)); })(),
