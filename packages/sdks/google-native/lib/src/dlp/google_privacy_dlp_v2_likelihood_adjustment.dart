...
class GooglePrivacyDlpV2LikelihoodAdjustment {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'fixedLikelihood': ?fixedLikelihood == null ? null : fixedLikelihood!.value,
  ...
  factory GooglePrivacyDlpV2LikelihoodAdjustment.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2LikelihoodAdjustment(
      fixedLikelihood: map['fixedLikelihood'] == null ? null : GooglePrivacyDlpV2LikelihoodAdjustmentFixedLikelihood.fromValue(map['fixedLikelihood'] as String),
