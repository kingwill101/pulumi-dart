...
class GooglePrivacyDlpV2KAnonymityConfigResponse {
  ...
  final pulumi.Input<GooglePrivacyDlpV2EntityIdResponse> entityId;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'entityId': pulumi.Input.mapInputValue<GooglePrivacyDlpV2EntityIdResponse, Map<String, dynamic>>(entityId, (value) => value.toMap()),
  ...
  factory GooglePrivacyDlpV2KAnonymityConfigResponse.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2KAnonymityConfigResponse(
      entityId: (GooglePrivacyDlpV2EntityIdResponse.fromMap((map['entityId'] as Map).cast<String, dynamic>())).input(),
      quasiIds: (pulumi.Input.decodeList<GooglePrivacyDlpV2FieldIdResponse>(map['quasiIds'], (value) => GooglePrivacyDlpV2FieldIdResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
