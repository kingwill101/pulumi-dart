...
class GooglePrivacyDlpV2InspectDataSourceDetailsResponse {
  ...
  factory GooglePrivacyDlpV2InspectDataSourceDetailsResponse.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2InspectDataSourceDetailsResponse(
      requestedOptions: (GooglePrivacyDlpV2RequestedOptionsResponse.fromMap((map['requestedOptions'] as Map).cast<String, dynamic>())).input(),
      result: (GooglePrivacyDlpV2ResultResponse.fromMap((map['result'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
