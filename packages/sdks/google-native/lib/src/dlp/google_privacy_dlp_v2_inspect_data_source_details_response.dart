...
class GooglePrivacyDlpV2InspectDataSourceDetailsResponse {
  ...
  final pulumi.Input<GooglePrivacyDlpV2RequestedOptionsResponse>
  requestedOptions;
  ...
  factory GooglePrivacyDlpV2InspectDataSourceDetailsResponse.fromMap(
    ...
    return GooglePrivacyDlpV2InspectDataSourceDetailsResponse(
      requestedOptions: pulumi.Input.fromValue(
        GooglePrivacyDlpV2RequestedOptionsResponse.fromMap(
          (map['requestedOptions']! as Map).cast<String, dynamic>(),
        ),
      ),
      result: pulumi.Input.fromValue(
        GooglePrivacyDlpV2ResultResponse.fromMap(
