...
class GooglePrivacyDlpV2PubSubCondition {
  ...
  final pulumi.Input<GooglePrivacyDlpV2PubSubConditionMinimumRiskScore>?
  minimumRiskScore;

  /// The minimum sensitivity level that triggers the condition.
  final pulumi.Input<GooglePrivacyDlpV2PubSubConditionMinimumSensitivityScore>?
    ...
    return <String, dynamic>{
      'minimumRiskScore':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(minimumRiskScore, (value) => value.wireValue),
      'minimumSensitivityScore':
          ?pulumi.Input.mapOptionalInputValue<
            GooglePrivacyDlpV2PubSubConditionMinimumSensitivityScore,
            String
          >(minimumSensitivityScore, (value) => value.wireValue),
    };
  }
