...
class GooglePrivacyDlpV2FieldTransformation {
  ...
  factory GooglePrivacyDlpV2FieldTransformation.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2FieldTransformation(
      ...
      fields: pulumi.Input.fromValue(pulumi.Input.decodeList<GooglePrivacyDlpV2FieldId>(map['fields']!, (value) => GooglePrivacyDlpV2FieldId.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      primitiveTransformation: (() { final guardedValue = map['primitiveTransformation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GooglePrivacyDlpV2PrimitiveTransformation.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
