...
class GooglePrivacyDlpV2DiscoveryBigQueryFilter {
  ...
  const GooglePrivacyDlpV2DiscoveryBigQueryFilter({
    this.otherTables,
    this.tables,
  });
  ...
  factory GooglePrivacyDlpV2DiscoveryBigQueryFilter.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2DiscoveryBigQueryFilter(
      otherTables: (() { final guardedValue = map['otherTables']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, dynamic>()); })(),
      tables: (() { final guardedValue = map['tables']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GooglePrivacyDlpV2BigQueryTableCollection.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
