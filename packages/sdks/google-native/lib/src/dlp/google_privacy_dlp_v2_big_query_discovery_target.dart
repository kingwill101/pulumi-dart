...
class GooglePrivacyDlpV2BigQueryDiscoveryTarget {
  ...
  const GooglePrivacyDlpV2BigQueryDiscoveryTarget({
    this.cadence,
    this.conditions,
    this.disabled,
  ...
  factory GooglePrivacyDlpV2BigQueryDiscoveryTarget.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2BigQueryDiscoveryTarget(
      cadence: (() { final guardedValue = map['cadence']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GooglePrivacyDlpV2DiscoveryGenerationCadence.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      conditions: (() { final guardedValue = map['conditions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GooglePrivacyDlpV2DiscoveryBigQueryConditions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      filter: pulumi.Input.fromValue(GooglePrivacyDlpV2DiscoveryBigQueryFilter.fromMap((map['filter']! as Map).cast<String, dynamic>())),
    );
  }
}
