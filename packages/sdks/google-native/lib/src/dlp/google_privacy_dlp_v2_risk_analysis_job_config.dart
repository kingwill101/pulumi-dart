...
class GooglePrivacyDlpV2RiskAnalysisJobConfig {
  ...
  factory GooglePrivacyDlpV2RiskAnalysisJobConfig.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2RiskAnalysisJobConfig(
      ...
      privacyMetric: (() { final guardedValue = map['privacyMetric']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GooglePrivacyDlpV2PrivacyMetric.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      sourceTable: (() { final guardedValue = map['sourceTable']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GooglePrivacyDlpV2BigQueryTable.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
