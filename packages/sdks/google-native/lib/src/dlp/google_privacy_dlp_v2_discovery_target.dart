...
class GooglePrivacyDlpV2DiscoveryTarget {
  ...
  const GooglePrivacyDlpV2DiscoveryTarget({
    this.bigQueryTarget,
  });
  ...
  factory GooglePrivacyDlpV2DiscoveryTarget.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2DiscoveryTarget(
      bigQueryTarget: (() { final guardedValue = map['bigQueryTarget']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GooglePrivacyDlpV2BigQueryDiscoveryTarget.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
