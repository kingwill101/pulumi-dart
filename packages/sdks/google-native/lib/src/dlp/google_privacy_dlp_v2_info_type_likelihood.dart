...
class GooglePrivacyDlpV2InfoTypeLikelihood {
  ...
  final pulumi.Input<GooglePrivacyDlpV2InfoTypeLikelihoodMinLikelihood>? minLikelihood;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'minLikelihood': ?pulumi.Input.mapOptionalInputValue<GooglePrivacyDlpV2InfoTypeLikelihoodMinLikelihood, String>(minLikelihood, (value) => value.wireValue),
    };
  }
  ...
  factory GooglePrivacyDlpV2InfoTypeLikelihood.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2InfoTypeLikelihood(
      ...
      minLikelihood: (() { final guardedValue = map['minLikelihood']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GooglePrivacyDlpV2InfoTypeLikelihoodMinLikelihood.fromValue(guardedValue as String)); })(),
    );
  }
}
