...
class GooglePrivacyDlpV2OutputStorageConfig {
  ...
  final pulumi.Input<GooglePrivacyDlpV2OutputStorageConfigOutputSchema>? outputSchema;
  ...
  const GooglePrivacyDlpV2OutputStorageConfig({
    this.outputSchema,
    this.table,
  });
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'outputSchema': ?pulumi.Input.mapOptionalInputValue<GooglePrivacyDlpV2OutputStorageConfigOutputSchema, String>(outputSchema, (value) => value.wireValue),
  ...
  factory GooglePrivacyDlpV2OutputStorageConfig.fromMap(Map<String, dynamic> map) {
    return GooglePrivacyDlpV2OutputStorageConfig(
      outputSchema: (() { final guardedValue = map['outputSchema']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GooglePrivacyDlpV2OutputStorageConfigOutputSchema.fromValue(guardedValue as String)); })(),
