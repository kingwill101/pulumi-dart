...
class ConversationArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'location': ?location,
      'medium': ?pulumi.Input.mapOptionalInputValue<ConversationMedium, String>(medium, (value) => value.wireValue),
      'name': ?name,
  ...
  factory ConversationArgs.fromMap(Map<String, dynamic> map) {
    return ConversationArgs(
      ...
      callMetadata: (() { final guardedValue = map['callMetadata']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudContactcenterinsightsV1ConversationCallMetadata.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      dataSource: (() { final guardedValue = map['dataSource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudContactcenterinsightsV1ConversationDataSource.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      medium: (() { final guardedValue = map['medium']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConversationMedium.fromValue(guardedValue as String)); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      obfuscatedUserId: (() { final guardedValue = map['obfuscatedUserId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
