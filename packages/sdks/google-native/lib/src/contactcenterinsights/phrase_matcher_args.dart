...
class PhraseMatcherArgs {
  ...
  factory PhraseMatcherArgs.fromMap(Map<String, dynamic> map) {
    return PhraseMatcherArgs(
      ...
      phraseMatchRuleGroups: (() {
        final guardedValue = map['phraseMatchRuleGroups'];
        if (guardedValue == null) return null;
      ...
      roleMatch: (() {
        final guardedValue = map['roleMatch'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PhraseMatcherRoleMatch.fromValue(guardedValue as String),
        );
      })(),
      type: pulumi.Input.fromValue(
        PhraseMatcherType.fromValue(map['type']! as String),
      ),
      versionTag: (() {
