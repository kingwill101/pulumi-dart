...
class GoogleCloudContactcenterinsightsV1ConversationDataSource {
  ...
  factory GoogleCloudContactcenterinsightsV1ConversationDataSource.fromMap(Map<String, dynamic> map) {
    return GoogleCloudContactcenterinsightsV1ConversationDataSource(
      dialogflowSource: (() { final guardedValue = map['dialogflowSource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudContactcenterinsightsV1DialogflowSource.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      gcsSource: (() { final guardedValue = map['gcsSource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudContactcenterinsightsV1GcsSource.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
