...
class GoogleCloudContactcenterinsightsV1PhraseMatchRuleGroupResponse {
  ...
  final List<GoogleCloudContactcenterinsightsV1PhraseMatchRuleResponse> phraseMatchRules;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'phraseMatchRules': pulumi.Input.encodeList<GoogleCloudContactcenterinsightsV1PhraseMatchRuleResponse, Map<String, dynamic>>(phraseMatchRules, (value) => value.toMap()),
      'type': type,
    };
  }
  ...
  factory GoogleCloudContactcenterinsightsV1PhraseMatchRuleGroupResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudContactcenterinsightsV1PhraseMatchRuleGroupResponse(
      phraseMatchRules: pulumi.Input.decodeList<GoogleCloudContactcenterinsightsV1PhraseMatchRuleResponse>(map['phraseMatchRules'], (value) => GoogleCloudContactcenterinsightsV1PhraseMatchRuleResponse.fromMap((value as Map).cast<String, dynamic>())),
