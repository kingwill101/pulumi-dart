...
class GoogleCloudContactcenterinsightsV1AnalysisResponse {
  ...
  factory GoogleCloudContactcenterinsightsV1AnalysisResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudContactcenterinsightsV1AnalysisResponse(
      analysisResult: pulumi.Input.fromValue(GoogleCloudContactcenterinsightsV1AnalysisResultResponse.fromMap((map['analysisResult']! as Map).cast<String, dynamic>())),
      annotatorSelector: pulumi.Input.fromValue(GoogleCloudContactcenterinsightsV1AnnotatorSelectorResponse.fromMap((map['annotatorSelector']! as Map).cast<String, dynamic>())),
