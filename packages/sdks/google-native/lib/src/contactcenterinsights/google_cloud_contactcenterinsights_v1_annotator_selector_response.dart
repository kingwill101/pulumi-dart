...
class GoogleCloudContactcenterinsightsV1AnnotatorSelectorResponse {
  ...
  factory GoogleCloudContactcenterinsightsV1AnnotatorSelectorResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudContactcenterinsightsV1AnnotatorSelectorResponse(
      issueModels: ((map['issueModels'] as List).cast<String>()).input(),
      phraseMatchers: ((map['phraseMatchers'] as List).cast<String>()).input(),
      runEntityAnnotator: (map['runEntityAnnotator'] as bool).input(),
      runIntentAnnotator: (map['runIntentAnnotator'] as bool).input(),
      runInterruptionAnnotator: (map['runInterruptionAnnotator'] as bool).input(),
      runIssueModelAnnotator: (map['runIssueModelAnnotator'] as bool).input(),
      runPhraseMatcherAnnotator: (map['runPhraseMatcherAnnotator'] as bool).input(),
      runSentimentAnnotator: (map['runSentimentAnnotator'] as bool).input(),
      runSilenceAnnotator: (map['runSilenceAnnotator'] as bool).input(),
      runSummarizationAnnotator: (map['runSummarizationAnnotator'] as bool).input(),
      summarizationConfig: (GoogleCloudContactcenterinsightsV1AnnotatorSelectorSummarizationConfigResponse.fromMap((map['summarizationConfig'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
