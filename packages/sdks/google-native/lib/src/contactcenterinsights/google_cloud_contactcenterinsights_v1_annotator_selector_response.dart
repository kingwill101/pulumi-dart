...
class GoogleCloudContactcenterinsightsV1AnnotatorSelectorResponse {
  ...
  factory GoogleCloudContactcenterinsightsV1AnnotatorSelectorResponse.fromMap(
    ...
    return GoogleCloudContactcenterinsightsV1AnnotatorSelectorResponse(
      issueModels: pulumi.Input.fromValue(
        (map['issueModels'] as List).cast<String>(),
      ),
      phraseMatchers: pulumi.Input.fromValue(
        (map['phraseMatchers'] as List).cast<String>(),
      ),
      runEntityAnnotator: pulumi.Input.fromValue(
        map['runEntityAnnotator'] as bool,
      ),
      runIntentAnnotator: pulumi.Input.fromValue(
        map['runIntentAnnotator'] as bool,
      ),
      runInterruptionAnnotator: pulumi.Input.fromValue(
        map['runInterruptionAnnotator'] as bool,
      ),
      runIssueModelAnnotator: pulumi.Input.fromValue(
        map['runIssueModelAnnotator'] as bool,
      ),
      runPhraseMatcherAnnotator: pulumi.Input.fromValue(
        map['runPhraseMatcherAnnotator'] as bool,
      ),
      runSentimentAnnotator: pulumi.Input.fromValue(
        map['runSentimentAnnotator'] as bool,
      ),
      runSilenceAnnotator: pulumi.Input.fromValue(
        map['runSilenceAnnotator'] as bool,
      ),
      runSummarizationAnnotator: pulumi.Input.fromValue(
        map['runSummarizationAnnotator'] as bool,
      ),
      summarizationConfig: pulumi.Input.fromValue(
        GoogleCloudContactcenterinsightsV1AnnotatorSelectorSummarizationConfigResponse.fromMap(
