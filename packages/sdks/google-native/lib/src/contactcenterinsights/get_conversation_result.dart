...
class GetConversationResult {
  ...
  final GoogleCloudContactcenterinsightsV1ConversationCallMetadataResponse callMetadata;
  /// The time at which the conversation was created.
  final String createTime;
  /// The source of the audio and transcription for the conversation.
  final GoogleCloudContactcenterinsightsV1ConversationDataSourceResponse dataSource;
  ...
  final GoogleCloudContactcenterinsightsV1ConversationSummarizationSuggestionDataResponse latestSummary;
  ...
  final List<GoogleCloudContactcenterinsightsV1RuntimeAnnotationResponse> runtimeAnnotations;
  /// The time at which the conversation started.
  final String startTime;
  /// The conversation transcript.
  final GoogleCloudContactcenterinsightsV1ConversationTranscriptResponse transcript;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'runtimeAnnotations': pulumi.Input.encodeList<GoogleCloudContactcenterinsightsV1RuntimeAnnotationResponse, Map<String, dynamic>>(runtimeAnnotations, (value) => value.toMap()),
      'startTime': startTime,
  ...
  factory GetConversationResult.fromMap(Map<String, dynamic> map) {
    return GetConversationResult(
      ...
      callMetadata: GoogleCloudContactcenterinsightsV1ConversationCallMetadataResponse.fromMap((map['callMetadata']! as Map).cast<String, dynamic>()),
      createTime: map['createTime'] as String,
      dataSource: GoogleCloudContactcenterinsightsV1ConversationDataSourceResponse.fromMap((map['dataSource']! as Map).cast<String, dynamic>()),
      dialogflowIntents: (map['dialogflowIntents'] as Map).cast<String, String>(),
      duration: map['duration'] as String,
      expireTime: map['expireTime'] as String,
      labels: (map['labels'] as Map).cast<String, String>(),
      languageCode: map['languageCode'] as String,
      latestAnalysis: GoogleCloudContactcenterinsightsV1AnalysisResponse.fromMap((map['latestAnalysis']! as Map).cast<String, dynamic>()),
      latestSummary: GoogleCloudContactcenterinsightsV1ConversationSummarizationSuggestionDataResponse.fromMap((map['latestSummary']! as Map).cast<String, dynamic>()),
      medium: map['medium'] as String,
      name: map['name'] as String,
      obfuscatedUserId: map['obfuscatedUserId'] as String,
      runtimeAnnotations: pulumi.Input.decodeList<GoogleCloudContactcenterinsightsV1RuntimeAnnotationResponse>(map['runtimeAnnotations']!, (value) => GoogleCloudContactcenterinsightsV1RuntimeAnnotationResponse.fromMap((value as Map).cast<String, dynamic>())),
      startTime: map['startTime'] as String,
      transcript: GoogleCloudContactcenterinsightsV1ConversationTranscriptResponse.fromMap((map['transcript']! as Map).cast<String, dynamic>()),
