...
class GoogleCloudContactcenterinsightsV1RuntimeAnnotationResponse {
  ...
  final pulumi.Input<GoogleCloudContactcenterinsightsV1AnswerFeedbackResponse>
  answerFeedback;
  ...
  final pulumi.Input<GoogleCloudContactcenterinsightsV1FaqAnswerDataResponse>
  faqAnswer;
  ...
  final pulumi.Input<GoogleCloudContactcenterinsightsV1SmartReplyDataResponse>
  smartReply;
    ...
    return <String, dynamic>{
      ...
      'answerFeedback':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(answerFeedback, (value) => value.toMap()),
      'articleSuggestion':
          pulumi.Input.mapInputValue<
            GoogleCloudContactcenterinsightsV1ArticleSuggestionDataResponse,
            Map<String, dynamic>
          >(articleSuggestion, (value) => value.toMap()),
      'conversationSummarizationSuggestion':
          pulumi.Input.mapInputValue<
            GoogleCloudContactcenterinsightsV1ConversationSummarizationSuggestionDataResponse,
            Map<String, dynamic>
          >(conversationSummarizationSuggestion, (value) => value.toMap()),
      'createTime': createTime,
      'dialogflowInteraction':
          pulumi.Input.mapInputValue<
            GoogleCloudContactcenterinsightsV1DialogflowInteractionDataResponse,
            Map<String, dynamic>
          >(dialogflowInteraction, (value) => value.toMap()),
      'endBoundary':
          pulumi.Input.mapInputValue<
            GoogleCloudContactcenterinsightsV1AnnotationBoundaryResponse,
            Map<String, dynamic>
          >(endBoundary, (value) => value.toMap()),
      'faqAnswer':
          pulumi.Input.mapInputValue<
            GoogleCloudContactcenterinsightsV1FaqAnswerDataResponse,
            Map<String, dynamic>
          >(faqAnswer, (value) => value.toMap()),
      'smartComposeSuggestion':
          pulumi.Input.mapInputValue<
            GoogleCloudContactcenterinsightsV1SmartComposeSuggestionDataResponse,
            Map<String, dynamic>
          >(smartComposeSuggestion, (value) => value.toMap()),
      'smartReply':
          pulumi.Input.mapInputValue<
            GoogleCloudContactcenterinsightsV1SmartReplyDataResponse,
            Map<String, dynamic>
          >(smartReply, (value) => value.toMap()),
      'startBoundary':
          pulumi.Input.mapInputValue<
            GoogleCloudContactcenterinsightsV1AnnotationBoundaryResponse,
            Map<String, dynamic>
          >(startBoundary, (value) => value.toMap()),
    };
  }
  ...
  factory GoogleCloudContactcenterinsightsV1RuntimeAnnotationResponse.fromMap(
    ...
    return GoogleCloudContactcenterinsightsV1RuntimeAnnotationResponse(
      ...
      answerFeedback: pulumi.Input.fromValue(
        GoogleCloudContactcenterinsightsV1AnswerFeedbackResponse.fromMap(
          (map['answerFeedback']! as Map).cast<String, dynamic>(),
        ),
      ),
      articleSuggestion: pulumi.Input.fromValue(
        GoogleCloudContactcenterinsightsV1ArticleSuggestionDataResponse.fromMap(
          (map['articleSuggestion']! as Map).cast<String, dynamic>(),
        ),
      ),
      conversationSummarizationSuggestion: pulumi.Input.fromValue(
        GoogleCloudContactcenterinsightsV1ConversationSummarizationSuggestionDataResponse.fromMap(
          (map['conversationSummarizationSuggestion']! as Map)
              .cast<String, dynamic>(),
        ),
      ),
      createTime: pulumi.Input.fromValue(map['createTime'] as String),
      dialogflowInteraction: pulumi.Input.fromValue(
        GoogleCloudContactcenterinsightsV1DialogflowInteractionDataResponse.fromMap(
          (map['dialogflowInteraction']! as Map).cast<String, dynamic>(),
        ),
      ),
      endBoundary: pulumi.Input.fromValue(
        GoogleCloudContactcenterinsightsV1AnnotationBoundaryResponse.fromMap(
          (map['endBoundary']! as Map).cast<String, dynamic>(),
        ),
      ),
      faqAnswer: pulumi.Input.fromValue(
        GoogleCloudContactcenterinsightsV1FaqAnswerDataResponse.fromMap(
          (map['faqAnswer']! as Map).cast<String, dynamic>(),
        ),
      ),
      smartComposeSuggestion: pulumi.Input.fromValue(
        GoogleCloudContactcenterinsightsV1SmartComposeSuggestionDataResponse.fromMap(
          (map['smartComposeSuggestion']! as Map).cast<String, dynamic>(),
        ),
      ),
      smartReply: pulumi.Input.fromValue(
        GoogleCloudContactcenterinsightsV1SmartReplyDataResponse.fromMap(
          (map['smartReply']! as Map).cast<String, dynamic>(),
        ),
      ),
      startBoundary: pulumi.Input.fromValue(
        GoogleCloudContactcenterinsightsV1AnnotationBoundaryResponse.fromMap(
