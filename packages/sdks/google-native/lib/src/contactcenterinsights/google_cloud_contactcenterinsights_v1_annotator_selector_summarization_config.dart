...
class GoogleCloudContactcenterinsightsV1AnnotatorSelectorSummarizationConfig {
  ...
  final GoogleCloudContactcenterinsightsV1AnnotatorSelectorSummarizationConfigSummarizationModel? summarizationModel;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'summarizationModel': ?summarizationModel == null ? null : summarizationModel!.value,
    };
  }
  ...
  factory GoogleCloudContactcenterinsightsV1AnnotatorSelectorSummarizationConfig.fromMap(Map<String, dynamic> map) {
    return GoogleCloudContactcenterinsightsV1AnnotatorSelectorSummarizationConfig(
      ...
      summarizationModel: map['summarizationModel'] == null ? null : GoogleCloudContactcenterinsightsV1AnnotatorSelectorSummarizationConfigSummarizationModel.fromValue(map['summarizationModel'] as String),
    );
  }
}
