...
class GoogleCloudContactcenterinsightsV1IssueModelResultResponse {
  ...
  factory GoogleCloudContactcenterinsightsV1IssueModelResultResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudContactcenterinsightsV1IssueModelResultResponse(
      ...
      issues: pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudContactcenterinsightsV1IssueAssignmentResponse>(map['issues']!, (value) => GoogleCloudContactcenterinsightsV1IssueAssignmentResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
