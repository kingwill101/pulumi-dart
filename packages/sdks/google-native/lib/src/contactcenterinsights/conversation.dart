...
class Conversation extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<GoogleCloudContactcenterinsightsV1RuntimeAnnotationResponse>> runtimeAnnotations;
  ...
  Conversation(
    ...
    this.callMetadata = registerOutput<GoogleCloudContactcenterinsightsV1ConversationCallMetadataResponse>('callMetadata');
    this.conversationId = registerOutput<String?>('conversationId');
    this.createTime = registerOutput<String>('createTime');
    this.dataSource = registerOutput<GoogleCloudContactcenterinsightsV1ConversationDataSourceResponse>('dataSource');
    this.dialogflowIntents = registerOutput<Map<String, String>>('dialogflowIntents');
    this.duration = registerOutput<String>('duration');
    this.expireTime = registerOutput<String>('expireTime');
    this.labels = registerOutput<Map<String, String>>('labels');
    this.languageCode = registerOutput<String>('languageCode');
    this.latestAnalysis = registerOutput<GoogleCloudContactcenterinsightsV1AnalysisResponse>('latestAnalysis');
    this.latestSummary = registerOutput<GoogleCloudContactcenterinsightsV1ConversationSummarizationSuggestionDataResponse>('latestSummary');
    ...
    this.runtimeAnnotations = registerOutput<List<GoogleCloudContactcenterinsightsV1RuntimeAnnotationResponse>>('runtimeAnnotations');
    this.startTime = registerOutput<String>('startTime');
    this.transcript = registerOutput<GoogleCloudContactcenterinsightsV1ConversationTranscriptResponse>('transcript');
