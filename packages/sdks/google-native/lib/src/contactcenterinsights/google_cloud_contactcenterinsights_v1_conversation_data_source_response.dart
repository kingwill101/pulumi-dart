...
class GoogleCloudContactcenterinsightsV1ConversationDataSourceResponse {
  ...
  final pulumi.Input<GoogleCloudContactcenterinsightsV1DialogflowSourceResponse>
  dialogflowSource;

  /// A Cloud Storage location specification for the audio and transcript.
  final pulumi.Input<GoogleCloudContactcenterinsightsV1GcsSourceResponse>
  gcsSource;
  ...
  factory GoogleCloudContactcenterinsightsV1ConversationDataSourceResponse.fromMap(
    ...
    return GoogleCloudContactcenterinsightsV1ConversationDataSourceResponse(
      dialogflowSource: pulumi.Input.fromValue(
      ...
      gcsSource: pulumi.Input.fromValue(
        GoogleCloudContactcenterinsightsV1GcsSourceResponse.fromMap(
