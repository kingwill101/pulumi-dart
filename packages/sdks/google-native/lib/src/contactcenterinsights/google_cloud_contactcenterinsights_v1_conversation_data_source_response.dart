...
class GoogleCloudContactcenterinsightsV1ConversationDataSourceResponse {
  ...
  factory GoogleCloudContactcenterinsightsV1ConversationDataSourceResponse.fromMap(Map<String, dynamic> map) {
    return GoogleCloudContactcenterinsightsV1ConversationDataSourceResponse(
      dialogflowSource: (GoogleCloudContactcenterinsightsV1DialogflowSourceResponse.fromMap((map['dialogflowSource'] as Map).cast<String, dynamic>())).input(),
      gcsSource: (GoogleCloudContactcenterinsightsV1GcsSourceResponse.fromMap((map['gcsSource'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
