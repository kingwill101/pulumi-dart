...
class WorkloadArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'partner': ?pulumi.Input.mapOptionalInputValue<WorkloadPartner, String>(
        partner,
        (value) => value.wireValue,
      ),
      'partnerPermissions':
  ...
  factory WorkloadArgs.fromMap(Map<String, dynamic> map) {
    return WorkloadArgs(
      ...
      complianceRegime: pulumi.Input.fromValue(
        WorkloadComplianceRegime.fromValue(map['complianceRegime']! as String),
      ),
      ...
      kmsSettings: (() {
        ...
        return pulumi.Input.fromValue(
          GoogleCloudAssuredworkloadsV1WorkloadKMSSettings.fromMap(
      ...
      partner: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          WorkloadPartner.fromValue(guardedValue as String),
        );
      })(),
      partnerPermissions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GoogleCloudAssuredworkloadsV1WorkloadPartnerPermissions.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      resourceSettings: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                GoogleCloudAssuredworkloadsV1WorkloadResourceSettings.fromMap(
