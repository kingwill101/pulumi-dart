...
class Workload extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<GoogleCloudAssuredworkloadsV1WorkloadResourceSettingsResponse>> resourceSettings;
  ...
  late final pulumi.Output<List<GoogleCloudAssuredworkloadsV1WorkloadResourceInfoResponse>> resources;
  ...
  Workload(
    ...
    this.complianceStatus = registerOutput<GoogleCloudAssuredworkloadsV1WorkloadComplianceStatusResponse>('complianceStatus');
    this.compliantButDisallowedServices = registerOutput<List<String>>('compliantButDisallowedServices');
    this.createTime = registerOutput<String>('createTime');
    this.displayName = registerOutput<String>('displayName');
    this.ekmProvisioningResponse = registerOutput<GoogleCloudAssuredworkloadsV1WorkloadEkmProvisioningResponseResponse>('ekmProvisioningResponse');
    ...
    this.kmsSettings = registerOutput<GoogleCloudAssuredworkloadsV1WorkloadKMSSettingsResponse>('kmsSettings');
    this.labels = registerOutput<Map<String, String>>('labels');
    this.location = registerOutput<String>('location');
    this.name = registerOutput<String>('name');
    this.organizationId = registerOutput<String>('organizationId');
    this.partner = registerOutput<String>('partner');
    this.partnerPermissions = registerOutput<GoogleCloudAssuredworkloadsV1WorkloadPartnerPermissionsResponse>('partnerPermissions');
    ...
    this.resourceSettings = registerOutput<List<GoogleCloudAssuredworkloadsV1WorkloadResourceSettingsResponse>>('resourceSettings');
    this.resources = registerOutput<List<GoogleCloudAssuredworkloadsV1WorkloadResourceInfoResponse>>('resources');
    this.saaEnrollmentResponse = registerOutput<GoogleCloudAssuredworkloadsV1WorkloadSaaEnrollmentResponseResponse>('saaEnrollmentResponse');
