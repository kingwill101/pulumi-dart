...
class GoogleCloudAssuredworkloadsV1beta1WorkloadResourceSettings {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'resourceType': ?pulumi.Input.mapOptionalInputValue<GoogleCloudAssuredworkloadsV1beta1WorkloadResourceSettingsResourceType, String>(resourceType, (value) => value.value),
    };
  }
