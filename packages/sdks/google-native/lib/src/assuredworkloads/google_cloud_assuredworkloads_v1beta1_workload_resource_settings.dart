...
class GoogleCloudAssuredworkloadsV1beta1WorkloadResourceSettings {
  ...
  final pulumi.Input<GoogleCloudAssuredworkloadsV1beta1WorkloadResourceSettingsResourceType>? resourceType;
  ...
  const GoogleCloudAssuredworkloadsV1beta1WorkloadResourceSettings({
    this.displayName,
    this.resourceId,
    this.resourceType,
  });
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'resourceType': ?pulumi.Input.mapOptionalInputValue<GoogleCloudAssuredworkloadsV1beta1WorkloadResourceSettingsResourceType, String>(resourceType, (value) => value.wireValue),
    };
  }
  ...
  factory GoogleCloudAssuredworkloadsV1beta1WorkloadResourceSettings.fromMap(Map<String, dynamic> map) {
    return GoogleCloudAssuredworkloadsV1beta1WorkloadResourceSettings(
      ...
      resourceType: (() { final guardedValue = map['resourceType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAssuredworkloadsV1beta1WorkloadResourceSettingsResourceType.fromValue(guardedValue as String)); })(),
    );
  }
}
