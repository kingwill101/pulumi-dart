...
class GetWorkloadResult {
  ...
  factory GetWorkloadResult.fromMap(Map<String, dynamic> map) {
    return GetWorkloadResult(
      ...
      ekmProvisioningResponse:
          GoogleCloudAssuredworkloadsV1WorkloadEkmProvisioningResponseResponse.fromMap(
            (map['ekmProvisioningResponse']! as Map).cast<String, dynamic>(),
          ),
      ...
      partnerPermissions:
          GoogleCloudAssuredworkloadsV1WorkloadPartnerPermissionsResponse.fromMap(
      ...
      resourceSettings:
          ...
          >(
            ...
            (value) =>
                GoogleCloudAssuredworkloadsV1WorkloadResourceSettingsResponse.fromMap(
      ...
      saaEnrollmentResponse:
          GoogleCloudAssuredworkloadsV1WorkloadSaaEnrollmentResponseResponse.fromMap(
            (map['saaEnrollmentResponse']! as Map).cast<String, dynamic>(),
          ),
