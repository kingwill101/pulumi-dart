...
class GetWorkloadResult {
  ...
  final GoogleCloudAssuredworkloadsV1WorkloadComplianceStatusResponse complianceStatus;
  ...
  final GoogleCloudAssuredworkloadsV1WorkloadEkmProvisioningResponseResponse ekmProvisioningResponse;
  ...
  final GoogleCloudAssuredworkloadsV1WorkloadPartnerPermissionsResponse partnerPermissions;
  ...
  final List<GoogleCloudAssuredworkloadsV1WorkloadResourceSettingsResponse> resourceSettings;
  ...
  final List<GoogleCloudAssuredworkloadsV1WorkloadResourceInfoResponse> resources;
  ...
  final GoogleCloudAssuredworkloadsV1WorkloadSaaEnrollmentResponseResponse saaEnrollmentResponse;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'resourceSettings': pulumi.Input.encodeList<GoogleCloudAssuredworkloadsV1WorkloadResourceSettingsResponse, Map<String, dynamic>>(resourceSettings, (value) => value.toMap()),
      'resources': pulumi.Input.encodeList<GoogleCloudAssuredworkloadsV1WorkloadResourceInfoResponse, Map<String, dynamic>>(resources, (value) => value.toMap()),
  ...
  factory GetWorkloadResult.fromMap(Map<String, dynamic> map) {
    return GetWorkloadResult(
      ...
      complianceStatus: GoogleCloudAssuredworkloadsV1WorkloadComplianceStatusResponse.fromMap((map['complianceStatus']! as Map).cast<String, dynamic>()),
      compliantButDisallowedServices: (map['compliantButDisallowedServices'] as List).cast<String>(),
      createTime: map['createTime'] as String,
      displayName: map['displayName'] as String,
      ekmProvisioningResponse: GoogleCloudAssuredworkloadsV1WorkloadEkmProvisioningResponseResponse.fromMap((map['ekmProvisioningResponse']! as Map).cast<String, dynamic>()),
      enableSovereignControls: map['enableSovereignControls'] as bool,
      etag: map['etag'] as String,
      kajEnrollmentState: map['kajEnrollmentState'] as String,
      kmsSettings: GoogleCloudAssuredworkloadsV1WorkloadKMSSettingsResponse.fromMap((map['kmsSettings']! as Map).cast<String, dynamic>()),
      labels: (map['labels'] as Map).cast<String, String>(),
      name: map['name'] as String,
      partner: map['partner'] as String,
      partnerPermissions: GoogleCloudAssuredworkloadsV1WorkloadPartnerPermissionsResponse.fromMap((map['partnerPermissions']! as Map).cast<String, dynamic>()),
      ...
      resourceSettings: pulumi.Input.decodeList<GoogleCloudAssuredworkloadsV1WorkloadResourceSettingsResponse>(map['resourceSettings']!, (value) => GoogleCloudAssuredworkloadsV1WorkloadResourceSettingsResponse.fromMap((value as Map).cast<String, dynamic>())),
      resources: pulumi.Input.decodeList<GoogleCloudAssuredworkloadsV1WorkloadResourceInfoResponse>(map['resources']!, (value) => GoogleCloudAssuredworkloadsV1WorkloadResourceInfoResponse.fromMap((value as Map).cast<String, dynamic>())),
      saaEnrollmentResponse: GoogleCloudAssuredworkloadsV1WorkloadSaaEnrollmentResponseResponse.fromMap((map['saaEnrollmentResponse']! as Map).cast<String, dynamic>()),
