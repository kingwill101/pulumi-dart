...
class WorkloadAssuredworkloadsV1beta1Args {
    ...
    return <String, dynamic>{
      ...
      'complianceRegime':
          pulumi.Input.mapInputValue<
            ...
            String
          >(complianceRegime, (value) => value.wireValue),
  ...
  factory WorkloadAssuredworkloadsV1beta1Args.fromMap(
    ...
    return WorkloadAssuredworkloadsV1beta1Args(
      ...
      cjisSettings: (() {
        final guardedValue = map['cjisSettings'];
        if (guardedValue == null) return null;
      ...
      fedrampHighSettings: (() {
        final guardedValue = map['fedrampHighSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      fedrampModerateSettings: (() {
        final guardedValue = map['fedrampModerateSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      il4Settings: (() {
        final guardedValue = map['il4Settings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
