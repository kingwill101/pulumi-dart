...
class WorkloadAssuredworkloadsV1beta1Args {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'complianceRegime': pulumi.Input.mapInputValue<WorkloadComplianceRegimeAssuredworkloadsV1beta1, String>(complianceRegime, (value) => value.wireValue),
      ...
      'partner': ?pulumi.Input.mapOptionalInputValue<WorkloadPartnerAssuredworkloadsV1beta1, String>(partner, (value) => value.wireValue),
  ...
  factory WorkloadAssuredworkloadsV1beta1Args.fromMap(Map<String, dynamic> map) {
    return WorkloadAssuredworkloadsV1beta1Args(
      ...
      cjisSettings: (() { final guardedValue = map['cjisSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAssuredworkloadsV1beta1WorkloadCJISSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      complianceRegime: pulumi.Input.fromValue(WorkloadComplianceRegimeAssuredworkloadsV1beta1.fromValue(map['complianceRegime']! as String)),
      ...
      fedrampHighSettings: (() { final guardedValue = map['fedrampHighSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAssuredworkloadsV1beta1WorkloadFedrampHighSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      fedrampModerateSettings: (() { final guardedValue = map['fedrampModerateSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAssuredworkloadsV1beta1WorkloadFedrampModerateSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      il4Settings: (() { final guardedValue = map['il4Settings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAssuredworkloadsV1beta1WorkloadIL4Settings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      partner: (() { final guardedValue = map['partner']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WorkloadPartnerAssuredworkloadsV1beta1.fromValue(guardedValue as String)); })(),
      partnerPermissions: (() { final guardedValue = map['partnerPermissions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleCloudAssuredworkloadsV1beta1WorkloadPartnerPermissions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      resourceSettings: (() { final guardedValue = map['resourceSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GoogleCloudAssuredworkloadsV1beta1WorkloadResourceSettings>(guardedValue, (value) => GoogleCloudAssuredworkloadsV1beta1WorkloadResourceSettings.fromMap((value as Map).cast<String, dynamic>()))); })(),
