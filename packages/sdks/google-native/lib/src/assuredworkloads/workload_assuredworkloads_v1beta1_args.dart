...
class WorkloadAssuredworkloadsV1beta1Args {
  ...
  WorkloadAssuredworkloadsV1beta1Args({
    ...
    pulumi.Output<GoogleCloudAssuredworkloadsV1beta1WorkloadCJISSettings>? cjisSettings,
    required pulumi.Output<WorkloadComplianceRegimeAssuredworkloadsV1beta1> complianceRegime,
    required pulumi.Output<String> displayName,
    pulumi.Output<bool>? enableSovereignControls,
    pulumi.Output<String>? etag,
    pulumi.Output<String>? externalId,
    pulumi.Output<GoogleCloudAssuredworkloadsV1beta1WorkloadFedrampHighSettings>? fedrampHighSettings,
    pulumi.Output<GoogleCloudAssuredworkloadsV1beta1WorkloadFedrampModerateSettings>? fedrampModerateSettings,
    pulumi.Output<GoogleCloudAssuredworkloadsV1beta1WorkloadIL4Settings>? il4Settings,
    pulumi.Output<GoogleCloudAssuredworkloadsV1beta1WorkloadKMSSettings>? kmsSettings,
    pulumi.Output<Map<String, String>>? labels,
    pulumi.Output<String>? location,
    pulumi.Output<String>? name,
    required pulumi.Output<String> organizationId,
    pulumi.Output<WorkloadPartnerAssuredworkloadsV1beta1>? partner,
    pulumi.Output<GoogleCloudAssuredworkloadsV1beta1WorkloadPartnerPermissions>? partnerPermissions,
    pulumi.Output<String>? provisionedResourcesParent,
    pulumi.Output<List<GoogleCloudAssuredworkloadsV1beta1WorkloadResourceSettings>>? resourceSettings,
  ...
  factory WorkloadAssuredworkloadsV1beta1Args.fromMap(Map<String, dynamic> map) {
    return WorkloadAssuredworkloadsV1beta1Args(
      ...
      cjisSettings: map['cjisSettings'] == null ? null : pulumi.Output.create<GoogleCloudAssuredworkloadsV1beta1WorkloadCJISSettings>(GoogleCloudAssuredworkloadsV1beta1WorkloadCJISSettings.fromMap((map['cjisSettings'] as Map).cast<String, dynamic>())),
      complianceRegime: pulumi.Output.create<WorkloadComplianceRegimeAssuredworkloadsV1beta1>(WorkloadComplianceRegimeAssuredworkloadsV1beta1.fromValue(map['complianceRegime'] as String)),
      ...
      fedrampHighSettings: map['fedrampHighSettings'] == null ? null : pulumi.Output.create<GoogleCloudAssuredworkloadsV1beta1WorkloadFedrampHighSettings>(GoogleCloudAssuredworkloadsV1beta1WorkloadFedrampHighSettings.fromMap((map['fedrampHighSettings'] as Map).cast<String, dynamic>())),
      fedrampModerateSettings: map['fedrampModerateSettings'] == null ? null : pulumi.Output.create<GoogleCloudAssuredworkloadsV1beta1WorkloadFedrampModerateSettings>(GoogleCloudAssuredworkloadsV1beta1WorkloadFedrampModerateSettings.fromMap((map['fedrampModerateSettings'] as Map).cast<String, dynamic>())),
      il4Settings: map['il4Settings'] == null ? null : pulumi.Output.create<GoogleCloudAssuredworkloadsV1beta1WorkloadIL4Settings>(GoogleCloudAssuredworkloadsV1beta1WorkloadIL4Settings.fromMap((map['il4Settings'] as Map).cast<String, dynamic>())),
      kmsSettings: map['kmsSettings'] == null ? null : pulumi.Output.create<GoogleCloudAssuredworkloadsV1beta1WorkloadKMSSettings>(GoogleCloudAssuredworkloadsV1beta1WorkloadKMSSettings.fromMap((map['kmsSettings'] as Map).cast<String, dynamic>())),
      labels: map['labels'] == null ? null : pulumi.Output.create<Map<String, String>>((map['labels'] as Map).cast<String, String>()),
      location: map['location'] == null ? null : pulumi.Output.create<String>(map['location'] as String),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      organizationId: pulumi.Output.create<String>(map['organizationId'] as String),
      partner: map['partner'] == null ? null : pulumi.Output.create<WorkloadPartnerAssuredworkloadsV1beta1>(WorkloadPartnerAssuredworkloadsV1beta1.fromValue(map['partner'] as String)),
      partnerPermissions: map['partnerPermissions'] == null ? null : pulumi.Output.create<GoogleCloudAssuredworkloadsV1beta1WorkloadPartnerPermissions>(GoogleCloudAssuredworkloadsV1beta1WorkloadPartnerPermissions.fromMap((map['partnerPermissions'] as Map).cast<String, dynamic>())),
      ...
      resourceSettings: map['resourceSettings'] == null ? null : pulumi.Output.create<List<GoogleCloudAssuredworkloadsV1beta1WorkloadResourceSettings>>(pulumi.Input.decodeList<GoogleCloudAssuredworkloadsV1beta1WorkloadResourceSettings>(map['resourceSettings'], (value) => GoogleCloudAssuredworkloadsV1beta1WorkloadResourceSettings.fromMap((value as Map).cast<String, dynamic>()))),
