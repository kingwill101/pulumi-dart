...
class GoogleCloudAssuredworkloadsV1beta1WorkloadKMSSettingsResponse {
  ...
  const GoogleCloudAssuredworkloadsV1beta1WorkloadKMSSettingsResponse({
  ...
  factory GoogleCloudAssuredworkloadsV1beta1WorkloadKMSSettingsResponse.fromMap(Map<String, dynamic> map) {
