...
/// {@template pulumi_dns_v1beta2_managed_zone_iam_binding_dns_v1beta2_args_doc}
/// The set of arguments for ManagedZoneIamBinding.
/// {@endtemplate}
/// {@macro pulumi_dns_v1beta2_managed_zone_iam_binding_dns_v1beta2_args_doc}
class ManagedZoneIamBindingDnsV1beta2Args {
  ...
  /// Creates a new [ManagedZoneIamBindingDnsV1beta2Args].
  ...
  const ManagedZoneIamBindingDnsV1beta2Args({
    this.condition,
  ...
  factory ManagedZoneIamBindingDnsV1beta2Args.fromMap(Map<String, dynamic> map) {
