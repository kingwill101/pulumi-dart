...
class ManagedZoneDnsSecConfigResponse {
  ...
  const ManagedZoneDnsSecConfigResponse({
  ...
  factory ManagedZoneDnsSecConfigResponse.fromMap(Map<String, dynamic> map) {
    return ManagedZoneDnsSecConfigResponse(
      defaultKeySpecs: pulumi.Input.fromValue(pulumi.Input.decodeList<DnsKeySpecResponse>(map['defaultKeySpecs']!, (value) => DnsKeySpecResponse.fromMap((value as Map).cast<String, dynamic>()))),
