...
class RRSetRoutingPolicyLoadBalancerTargetDnsV1beta2 {
  ...
  const RRSetRoutingPolicyLoadBalancerTargetDnsV1beta2({
    this.ipAddress,
    this.ipProtocol,
    this.kind,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'ipAddress': ?ipAddress,
      'ipProtocol': ?pulumi.Input.mapOptionalInputValue<RRSetRoutingPolicyLoadBalancerTargetIpProtocolDnsV1beta2, String>(ipProtocol, (value) => value.wireValue),
      'kind': ?kind,
      'loadBalancerType': ?pulumi.Input.mapOptionalInputValue<RRSetRoutingPolicyLoadBalancerTargetLoadBalancerTypeDnsV1beta2, String>(loadBalancerType, (value) => value.wireValue),
  ...
  factory RRSetRoutingPolicyLoadBalancerTargetDnsV1beta2.fromMap(Map<String, dynamic> map) {
    return RRSetRoutingPolicyLoadBalancerTargetDnsV1beta2(
      ...
      ipProtocol: (() { final guardedValue = map['ipProtocol']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RRSetRoutingPolicyLoadBalancerTargetIpProtocolDnsV1beta2.fromValue(guardedValue as String)); })(),
      kind: (() { final guardedValue = map['kind']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      loadBalancerType: (() { final guardedValue = map['loadBalancerType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RRSetRoutingPolicyLoadBalancerTargetLoadBalancerTypeDnsV1beta2.fromValue(guardedValue as String)); })(),
