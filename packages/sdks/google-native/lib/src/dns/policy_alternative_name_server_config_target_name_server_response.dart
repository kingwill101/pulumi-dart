...
class PolicyAlternativeNameServerConfigTargetNameServerResponse {
  ...
  /// Creates a new [PolicyAlternativeNameServerConfigTargetNameServerResponse].
  ...
  /// [kind] Required.
  const PolicyAlternativeNameServerConfigTargetNameServerResponse({
  ...
  factory PolicyAlternativeNameServerConfigTargetNameServerResponse.fromMap(Map<String, dynamic> map) {
