...
class ResponsePolicyRule extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [ResponsePolicyRule]. {@macro pulumi_dns_v1beta2_response_policy_rule_args_doc}
  ...
  ResponsePolicyRule(
    ...
    this.localData = registerOutput<ResponsePolicyRuleLocalDataResponseDnsV1beta2>('localData');
