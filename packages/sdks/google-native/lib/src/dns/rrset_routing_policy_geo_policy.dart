...
class RRSetRoutingPolicyGeoPolicy {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'items': ?items == null ? null : pulumi.Input.encodeList<RRSetRoutingPolicyGeoPolicyGeoPolicyItem, Map<String, dynamic>>(items!, (value) => value.toMap()),
      'kind': ?kind,
    };
  }
  ...
  factory RRSetRoutingPolicyGeoPolicy.fromMap(Map<String, dynamic> map) {
    return RRSetRoutingPolicyGeoPolicy(
      ...
      items: map['items'] == null ? null : pulumi.Input.decodeList<RRSetRoutingPolicyGeoPolicyGeoPolicyItem>(map['items'], (value) => RRSetRoutingPolicyGeoPolicyGeoPolicyItem.fromMap((value as Map).cast<String, dynamic>())),
