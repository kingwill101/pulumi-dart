...
class ResponsePolicyRuleLocalData {
  ...
  factory ResponsePolicyRuleLocalData.fromMap(Map<String, dynamic> map) {
    return ResponsePolicyRuleLocalData(
      localDatas: (() { final guardedValue = map['localDatas']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ResourceRecordSet>(guardedValue, (value) => ResourceRecordSet.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
