...
class ManagedZoneForwardingConfigNameServerTarget {
  ...
  /// [kind] Optional.
  const ManagedZoneForwardingConfigNameServerTarget({
    this.forwardingPath,
    this.ipv4Address,
    this.ipv6Address,
    this.kind,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'forwardingPath': ?pulumi.Input.mapOptionalInputValue<ManagedZoneForwardingConfigNameServerTargetForwardingPath, String>(forwardingPath, (value) => value.wireValue),
  ...
  factory ManagedZoneForwardingConfigNameServerTarget.fromMap(Map<String, dynamic> map) {
    return ManagedZoneForwardingConfigNameServerTarget(
      forwardingPath: (() { final guardedValue = map['forwardingPath']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagedZoneForwardingConfigNameServerTargetForwardingPath.fromValue(guardedValue as String)); })(),
