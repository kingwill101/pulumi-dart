...
class ManagedZoneServiceDirectoryConfigNamespaceResponse {
  ...
  /// Creates a new [ManagedZoneServiceDirectoryConfigNamespaceResponse].
  ...
  const ManagedZoneServiceDirectoryConfigNamespaceResponse({
  ...
  factory ManagedZoneServiceDirectoryConfigNamespaceResponse.fromMap(Map<String, dynamic> map) {
