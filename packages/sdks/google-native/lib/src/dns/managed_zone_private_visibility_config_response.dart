...
class ManagedZonePrivateVisibilityConfigResponse {
  ...
  factory ManagedZonePrivateVisibilityConfigResponse.fromMap(Map<String, dynamic> map) {
    return ManagedZonePrivateVisibilityConfigResponse(
      gkeClusters: (pulumi.Input.decodeList<ManagedZonePrivateVisibilityConfigGKEClusterResponse>(map['gkeClusters'], (value) => ManagedZonePrivateVisibilityConfigGKEClusterResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      kind: (map['kind'] as String).input(),
      networks: (pulumi.Input.decodeList<ManagedZonePrivateVisibilityConfigNetworkResponse>(map['networks'], (value) => ManagedZonePrivateVisibilityConfigNetworkResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
