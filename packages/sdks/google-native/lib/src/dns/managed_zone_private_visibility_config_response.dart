...
class ManagedZonePrivateVisibilityConfigResponse {
  ...
  final pulumi.Input<List<ManagedZonePrivateVisibilityConfigGKEClusterResponse>>
  gkeClusters;
  final pulumi.Input<String> kind;

  /// The list of VPC networks that can see this zone.
  final pulumi.Input<List<ManagedZonePrivateVisibilityConfigNetworkResponse>>
  networks;
    ...
    return <String, dynamic>{
      'gkeClusters':
          pulumi.Input.mapInputValue<
            List<ManagedZonePrivateVisibilityConfigGKEClusterResponse>,
      ...
      'networks':
          pulumi.Input.mapInputValue<
            List<ManagedZonePrivateVisibilityConfigNetworkResponse>,
            List<Map<String, dynamic>>
          >(
            networks,
            (value) =>
  ...
  factory ManagedZonePrivateVisibilityConfigResponse.fromMap(
    ...
    return ManagedZonePrivateVisibilityConfigResponse(
      gkeClusters: pulumi.Input.fromValue(
