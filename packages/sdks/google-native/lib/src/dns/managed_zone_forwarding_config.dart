...
class ManagedZoneForwardingConfig {
  ...
  factory ManagedZoneForwardingConfig.fromMap(Map<String, dynamic> map) {
    return ManagedZoneForwardingConfig(
      ...
      targetNameServers: (() { final guardedValue = map['targetNameServers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ManagedZoneForwardingConfigNameServerTarget>(guardedValue, (value) => ManagedZoneForwardingConfigNameServerTarget.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
