...
class PolicyAlternativeNameServerConfigTargetNameServerDnsV1beta2 {
  ...
  final pulumi.Input<PolicyAlternativeNameServerConfigTargetNameServerForwardingPathDnsV1beta2>? forwardingPath;
  ...
  /// [kind] Optional.
  const PolicyAlternativeNameServerConfigTargetNameServerDnsV1beta2({
    this.forwardingPath,
    this.ipv4Address,
    this.ipv6Address,
    this.kind,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'forwardingPath': ?pulumi.Input.mapOptionalInputValue<PolicyAlternativeNameServerConfigTargetNameServerForwardingPathDnsV1beta2, String>(forwardingPath, (value) => value.wireValue),
  ...
  factory PolicyAlternativeNameServerConfigTargetNameServerDnsV1beta2.fromMap(Map<String, dynamic> map) {
    return PolicyAlternativeNameServerConfigTargetNameServerDnsV1beta2(
      forwardingPath: (() { final guardedValue = map['forwardingPath']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PolicyAlternativeNameServerConfigTargetNameServerForwardingPathDnsV1beta2.fromValue(guardedValue as String)); })(),
