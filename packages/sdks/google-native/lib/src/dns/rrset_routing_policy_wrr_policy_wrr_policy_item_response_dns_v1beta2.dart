...
class RRSetRoutingPolicyWrrPolicyWrrPolicyItemResponseDnsV1beta2 {
  ...
  const RRSetRoutingPolicyWrrPolicyWrrPolicyItemResponseDnsV1beta2({
  ...
  factory RRSetRoutingPolicyWrrPolicyWrrPolicyItemResponseDnsV1beta2.fromMap(Map<String, dynamic> map) {
    return RRSetRoutingPolicyWrrPolicyWrrPolicyItemResponseDnsV1beta2(
      healthCheckedTargets: pulumi.Input.fromValue(RRSetRoutingPolicyHealthCheckTargetsResponseDnsV1beta2.fromMap((map['healthCheckedTargets']! as Map).cast<String, dynamic>())),
