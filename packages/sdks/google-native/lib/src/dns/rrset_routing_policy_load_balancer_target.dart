...
class RRSetRoutingPolicyLoadBalancerTarget {
  ...
  final RRSetRoutingPolicyLoadBalancerTargetIpProtocol? ipProtocol;
  final String? kind;
  /// The type of load balancer specified by this target. This value must match the configuration of the load balancer located at the LoadBalancerTarget's IP address, port, and region. Use the following: - *regionalL4ilb*: for a regional internal passthrough Network Load Balancer. - *regionalL7ilb*: for a regional internal Application Load Balancer. - *globalL7ilb*: for a global internal Application Load Balancer.
  final RRSetRoutingPolicyLoadBalancerTargetLoadBalancerType? loadBalancerType;
  ...
  factory RRSetRoutingPolicyLoadBalancerTarget.fromMap(Map<String, dynamic> map) {
    return RRSetRoutingPolicyLoadBalancerTarget(
      ...
      ipProtocol: map['ipProtocol'] == null ? null : RRSetRoutingPolicyLoadBalancerTargetIpProtocol.fromValue(map['ipProtocol'] as String),
      kind: map['kind'] == null ? null : map['kind'] as String,
      loadBalancerType: map['loadBalancerType'] == null ? null : RRSetRoutingPolicyLoadBalancerTargetLoadBalancerType.fromValue(map['loadBalancerType'] as String),
