...
class RRSetRoutingPolicyHealthCheckTargetsResponse {
  ...
  factory RRSetRoutingPolicyHealthCheckTargetsResponse.fromMap(Map<String, dynamic> map) {
    return RRSetRoutingPolicyHealthCheckTargetsResponse(
      internalLoadBalancers: (pulumi.Input.decodeList<RRSetRoutingPolicyLoadBalancerTargetResponse>(map['internalLoadBalancers'], (value) => RRSetRoutingPolicyLoadBalancerTargetResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
