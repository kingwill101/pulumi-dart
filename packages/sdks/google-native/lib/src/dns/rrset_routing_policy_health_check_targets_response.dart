...
class RRSetRoutingPolicyHealthCheckTargetsResponse {
  final List<RRSetRoutingPolicyLoadBalancerTargetResponse> internalLoadBalancers;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'internalLoadBalancers': pulumi.Input.encodeList<RRSetRoutingPolicyLoadBalancerTargetResponse, Map<String, dynamic>>(internalLoadBalancers, (value) => value.toMap()),
    };
  }
  ...
  factory RRSetRoutingPolicyHealthCheckTargetsResponse.fromMap(Map<String, dynamic> map) {
    return RRSetRoutingPolicyHealthCheckTargetsResponse(
      internalLoadBalancers: pulumi.Input.decodeList<RRSetRoutingPolicyLoadBalancerTargetResponse>(map['internalLoadBalancers'], (value) => RRSetRoutingPolicyLoadBalancerTargetResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
