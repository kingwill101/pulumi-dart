...
/// {@template pulumi_dns_v1_managed_zone_iam_member_args_doc}
/// The set of arguments for ManagedZoneIamMember.
/// {@endtemplate}
/// {@macro pulumi_dns_v1_managed_zone_iam_member_args_doc}
class ManagedZoneIamMemberArgs {
  ...
  /// Creates a new [ManagedZoneIamMemberArgs].
  ...
  const ManagedZoneIamMemberArgs({
    this.condition,
  ...
  factory ManagedZoneIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return ManagedZoneIamMemberArgs(
