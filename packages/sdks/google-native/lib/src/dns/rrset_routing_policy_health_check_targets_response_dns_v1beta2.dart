...
class RRSetRoutingPolicyHealthCheckTargetsResponseDnsV1beta2 {
  final List<RRSetRoutingPolicyLoadBalancerTargetResponseDnsV1beta2> internalLoadBalancers;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'internalLoadBalancers': pulumi.Input.encodeList<RRSetRoutingPolicyLoadBalancerTargetResponseDnsV1beta2, Map<String, dynamic>>(internalLoadBalancers, (value) => value.toMap()),
    };
  }
  ...
  factory RRSetRoutingPolicyHealthCheckTargetsResponseDnsV1beta2.fromMap(Map<String, dynamic> map) {
    return RRSetRoutingPolicyHealthCheckTargetsResponseDnsV1beta2(
      internalLoadBalancers: pulumi.Input.decodeList<RRSetRoutingPolicyLoadBalancerTargetResponseDnsV1beta2>(map['internalLoadBalancers'], (value) => RRSetRoutingPolicyLoadBalancerTargetResponseDnsV1beta2.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
