...
class RRSetRoutingPolicyHealthCheckTargetsResponseDnsV1beta2 {
  ...
  factory RRSetRoutingPolicyHealthCheckTargetsResponseDnsV1beta2.fromMap(Map<String, dynamic> map) {
    return RRSetRoutingPolicyHealthCheckTargetsResponseDnsV1beta2(
      internalLoadBalancers: (pulumi.Input.decodeList<RRSetRoutingPolicyLoadBalancerTargetResponseDnsV1beta2>(map['internalLoadBalancers'], (value) => RRSetRoutingPolicyLoadBalancerTargetResponseDnsV1beta2.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
