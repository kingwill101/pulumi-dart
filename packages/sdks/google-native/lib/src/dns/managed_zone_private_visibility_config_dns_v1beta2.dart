...
class ManagedZonePrivateVisibilityConfigDnsV1beta2 {
  ...
  final pulumi.Input<
    List<ManagedZonePrivateVisibilityConfigGKEClusterDnsV1beta2>
  >?
  gkeClusters;
  final pulumi.Input<String>? kind;

  /// The list of VPC networks that can see this zone.
  final pulumi.Input<List<ManagedZonePrivateVisibilityConfigNetworkDnsV1beta2>>?
  networks;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'networks':
          ?pulumi.Input.mapOptionalInputValue<
            List<ManagedZonePrivateVisibilityConfigNetworkDnsV1beta2>,
            List<Map<String, dynamic>>
          >(
            networks,
            (value) =>
