...
class GetResourceRecordSetDnsV1beta2Result {
  ...
  const GetResourceRecordSetDnsV1beta2Result({
    required this.kind,
    required this.name,
  ...
  factory GetResourceRecordSetDnsV1beta2Result.fromMap(Map<String, dynamic> map) {
    return GetResourceRecordSetDnsV1beta2Result(
      kind: map['kind'] as String,
      name: map['name'] as String,
      routingPolicy: RRSetRoutingPolicyResponseDnsV1beta2.fromMap((map['routingPolicy']! as Map).cast<String, dynamic>()),
