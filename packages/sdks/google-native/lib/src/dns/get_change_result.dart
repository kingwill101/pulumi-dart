...
class GetChangeResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'additions': pulumi.Input.encodeList<ResourceRecordSetResponse, Map<String, dynamic>>(additions, (value) => value.toMap()),
      'deletions': pulumi.Input.encodeList<ResourceRecordSetResponse, Map<String, dynamic>>(deletions, (value) => value.toMap()),
      'isServing': isServing,
      'kind': kind,
      'startTime': startTime,
      'status': status,
  ...
  factory GetChangeResult.fromMap(Map<String, dynamic> map) {
    return GetChangeResult(
      additions: pulumi.Input.decodeList<ResourceRecordSetResponse>(map['additions']!, (value) => ResourceRecordSetResponse.fromMap((value as Map).cast<String, dynamic>())),
      deletions: pulumi.Input.decodeList<ResourceRecordSetResponse>(map['deletions']!, (value) => ResourceRecordSetResponse.fromMap((value as Map).cast<String, dynamic>())),
