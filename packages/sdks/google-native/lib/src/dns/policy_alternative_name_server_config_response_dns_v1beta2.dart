...
class PolicyAlternativeNameServerConfigResponseDnsV1beta2 {
  ...
  factory PolicyAlternativeNameServerConfigResponseDnsV1beta2.fromMap(Map<String, dynamic> map) {
    return PolicyAlternativeNameServerConfigResponseDnsV1beta2(
      ...
      targetNameServers: (pulumi.Input.decodeList<PolicyAlternativeNameServerConfigTargetNameServerResponseDnsV1beta2>(map['targetNameServers'], (value) => PolicyAlternativeNameServerConfigTargetNameServerResponseDnsV1beta2.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
