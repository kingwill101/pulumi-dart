...
class GetPolicyDnsV1beta2Result {
  ...
  final PolicyAlternativeNameServerConfigResponseDnsV1beta2 alternativeNameServerConfig;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'kind': kind,
      'name': name,
      'networks': pulumi.Input.encodeList<PolicyNetworkResponseDnsV1beta2, Map<String, dynamic>>(networks, (value) => value.toMap()),
    };
  }

  factory GetPolicyDnsV1beta2Result.fromMap(Map<String, dynamic> map) {
    return GetPolicyDnsV1beta2Result(
      alternativeNameServerConfig: PolicyAlternativeNameServerConfigResponseDnsV1beta2.fromMap((map['alternativeNameServerConfig']! as Map).cast<String, dynamic>()),
      description: map['description'] as String,
      enableInboundForwarding: map['enableInboundForwarding'] as bool,
      enableLogging: map['enableLogging'] as bool,
      kind: map['kind'] as String,
      name: map['name'] as String,
      networks: pulumi.Input.decodeList<PolicyNetworkResponseDnsV1beta2>(map['networks']!, (value) => PolicyNetworkResponseDnsV1beta2.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
