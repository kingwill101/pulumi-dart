...
import 'managed_zone_iam_member_args.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class ManagedZoneIamMember extends pulumi.CustomResource {
  ...
  /// Creates a new [ManagedZoneIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ManagedZoneIamMember]. {@macro pulumi_dns_v1_managed_zone_iam_member_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  ManagedZoneIamMember(
    String name, {
    ManagedZoneIamMemberArgs? args,
