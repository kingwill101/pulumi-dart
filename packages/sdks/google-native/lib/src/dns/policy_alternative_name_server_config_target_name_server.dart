...
class PolicyAlternativeNameServerConfigTargetNameServer {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'forwardingPath': ?pulumi.Input.mapOptionalInputValue<PolicyAlternativeNameServerConfigTargetNameServerForwardingPath, String>(forwardingPath, (value) => value.wireValue),
  ...
  factory PolicyAlternativeNameServerConfigTargetNameServer.fromMap(Map<String, dynamic> map) {
    return PolicyAlternativeNameServerConfigTargetNameServer(
      forwardingPath: (() { final guardedValue = map['forwardingPath']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PolicyAlternativeNameServerConfigTargetNameServerForwardingPath.fromValue(guardedValue as String)); })(),
