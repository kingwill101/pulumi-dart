...
class GoogleIamV1AuditLogConfigDnsV1beta2 {
  ...
  const GoogleIamV1AuditLogConfigDnsV1beta2({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'logType': ?pulumi.Input.mapOptionalInputValue<GoogleIamV1AuditLogConfigLogTypeDnsV1beta2, String>(logType, (value) => value.wireValue),
    };
  }
  ...
  factory GoogleIamV1AuditLogConfigDnsV1beta2.fromMap(Map<String, dynamic> map) {
    return GoogleIamV1AuditLogConfigDnsV1beta2(
      ...
      logType: (() { final guardedValue = map['logType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GoogleIamV1AuditLogConfigLogTypeDnsV1beta2.fromValue(guardedValue as String)); })(),
    );
  }
}
