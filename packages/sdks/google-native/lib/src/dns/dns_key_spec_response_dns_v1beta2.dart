...
class DnsKeySpecResponseDnsV1beta2 {
  ...
  /// Creates a new [DnsKeySpecResponseDnsV1beta2].
  ...
  /// [kind] Required.
  const DnsKeySpecResponseDnsV1beta2({
  ...
  factory DnsKeySpecResponseDnsV1beta2.fromMap(Map<String, dynamic> map) {
    return DnsKeySpecResponseDnsV1beta2(
