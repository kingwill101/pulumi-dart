...
class ManagedZonePeeringConfig {
  ...
  factory ManagedZonePeeringConfig.fromMap(Map<String, dynamic> map) {
    return ManagedZonePeeringConfig(
      ...
      targetNetwork: (() { final guardedValue = map['targetNetwork']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagedZonePeeringConfigTargetNetwork.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
