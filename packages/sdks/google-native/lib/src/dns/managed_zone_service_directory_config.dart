...
class ManagedZoneServiceDirectoryConfig {
  ...
  factory ManagedZoneServiceDirectoryConfig.fromMap(Map<String, dynamic> map) {
    return ManagedZoneServiceDirectoryConfig(
      ...
      namespace: (() { final guardedValue = map['namespace']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagedZoneServiceDirectoryConfigNamespace.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
