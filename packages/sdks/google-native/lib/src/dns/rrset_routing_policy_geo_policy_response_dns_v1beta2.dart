...
class RRSetRoutingPolicyGeoPolicyResponseDnsV1beta2 {
  ...
  factory RRSetRoutingPolicyGeoPolicyResponseDnsV1beta2.fromMap(Map<String, dynamic> map) {
    return RRSetRoutingPolicyGeoPolicyResponseDnsV1beta2(
      enableFencing: (map['enableFencing'] as bool).input(),
      items: (pulumi.Input.decodeList<RRSetRoutingPolicyGeoPolicyGeoPolicyItemResponseDnsV1beta2>(map['items'], (value) => RRSetRoutingPolicyGeoPolicyGeoPolicyItemResponseDnsV1beta2.fromMap((value as Map).cast<String, dynamic>()))).input(),
