...
class RRSetRoutingPolicyGeoPolicyDnsV1beta2 {
  ...
  /// [kind] Optional.
  const RRSetRoutingPolicyGeoPolicyDnsV1beta2({
    this.enableFencing,
    this.items,
    this.kind,
  });
  ...
  factory RRSetRoutingPolicyGeoPolicyDnsV1beta2.fromMap(Map<String, dynamic> map) {
    return RRSetRoutingPolicyGeoPolicyDnsV1beta2(
      ...
      items: (() { final guardedValue = map['items']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RRSetRoutingPolicyGeoPolicyGeoPolicyItemDnsV1beta2>(guardedValue, (value) => RRSetRoutingPolicyGeoPolicyGeoPolicyItemDnsV1beta2.fromMap((value as Map).cast<String, dynamic>()))); })(),
