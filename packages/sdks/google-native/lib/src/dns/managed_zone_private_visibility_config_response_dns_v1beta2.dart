...
class ManagedZonePrivateVisibilityConfigResponseDnsV1beta2 {
  ...
  factory ManagedZonePrivateVisibilityConfigResponseDnsV1beta2.fromMap(Map<String, dynamic> map) {
    return ManagedZonePrivateVisibilityConfigResponseDnsV1beta2(
      gkeClusters: (pulumi.Input.decodeList<ManagedZonePrivateVisibilityConfigGKEClusterResponseDnsV1beta2>(map['gkeClusters'], (value) => ManagedZonePrivateVisibilityConfigGKEClusterResponseDnsV1beta2.fromMap((value as Map).cast<String, dynamic>()))).input(),
      kind: (map['kind'] as String).input(),
      networks: (pulumi.Input.decodeList<ManagedZonePrivateVisibilityConfigNetworkResponseDnsV1beta2>(map['networks'], (value) => ManagedZonePrivateVisibilityConfigNetworkResponseDnsV1beta2.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
