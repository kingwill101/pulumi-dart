...
class GoogleIamV1AuditConfigDnsV1beta2 {
  ...
  final pulumi.Input<List<GoogleIamV1AuditLogConfigDnsV1beta2>>?
  auditLogConfigs;
  ...
  GoogleIamV1AuditConfigDnsV1beta2({this.auditLogConfigs, this.service});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'auditLogConfigs':
          ?pulumi.Input.mapOptionalInputValue<
            List<GoogleIamV1AuditLogConfigDnsV1beta2>,
