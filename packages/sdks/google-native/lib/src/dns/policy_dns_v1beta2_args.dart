...
class PolicyDnsV1beta2Args {
  ...
  factory PolicyDnsV1beta2Args.fromMap(Map<String, dynamic> map) {
    return PolicyDnsV1beta2Args(
      alternativeNameServerConfig: (() { final guardedValue = map['alternativeNameServerConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PolicyAlternativeNameServerConfigDnsV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      networks: (() { final guardedValue = map['networks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PolicyNetworkDnsV1beta2>(guardedValue, (value) => PolicyNetworkDnsV1beta2.fromMap((value as Map).cast<String, dynamic>()))); })(),
