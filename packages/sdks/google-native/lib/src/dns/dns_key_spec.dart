...
class DnsKeySpec {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'algorithm':
          ?pulumi.Input.mapOptionalInputValue<DnsKeySpecAlgorithm, String>(
            algorithm,
            (value) => value.wireValue,
          ),
      'keyLength': ?keyLength,
      'keyType': ?pulumi.Input.mapOptionalInputValue<DnsKeySpecKeyType, String>(
        keyType,
        (value) => value.wireValue,
      ),
      'kind': ?kind,
    ...
    return DnsKeySpec(
      algorithm: (() {
        ...
        return pulumi.Input.fromValue(
          DnsKeySpecAlgorithm.fromValue(guardedValue as String),
        );
      })(),
      keyLength: (() {
      ...
      keyType: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DnsKeySpecKeyType.fromValue(guardedValue as String),
        );
      })(),
      kind: (() {
