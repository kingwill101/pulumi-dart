...
class RRSetRoutingPolicyHealthCheckTargetsDnsV1beta2 {
  final pulumi.Input<List<RRSetRoutingPolicyLoadBalancerTargetDnsV1beta2>>?
  internalLoadBalancers;

  /// Creates a new [RRSetRoutingPolicyHealthCheckTargetsDnsV1beta2].
  /// [internalLoadBalancers] Optional.
  RRSetRoutingPolicyHealthCheckTargetsDnsV1beta2({this.internalLoadBalancers});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'internalLoadBalancers':
          ?pulumi.Input.mapOptionalInputValue<
            List<RRSetRoutingPolicyLoadBalancerTargetDnsV1beta2>,
    ...
    return RRSetRoutingPolicyHealthCheckTargetsDnsV1beta2(
      internalLoadBalancers: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<RRSetRoutingPolicyLoadBalancerTargetDnsV1beta2>(
            guardedValue,
