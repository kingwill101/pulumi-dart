...
class ManagedZoneServiceDirectoryConfigDnsV1beta2 {
  ...
  const ManagedZoneServiceDirectoryConfigDnsV1beta2({
    this.kind,
    this.namespace,
  });
  ...
  factory ManagedZoneServiceDirectoryConfigDnsV1beta2.fromMap(Map<String, dynamic> map) {
    return ManagedZoneServiceDirectoryConfigDnsV1beta2(
      ...
      namespace: (() { final guardedValue = map['namespace']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagedZoneServiceDirectoryConfigNamespaceDnsV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
