...
class RRSetRoutingPolicyPrimaryBackupPolicyDnsV1beta2 {
  ...
  factory RRSetRoutingPolicyPrimaryBackupPolicyDnsV1beta2.fromMap(Map<String, dynamic> map) {
    return RRSetRoutingPolicyPrimaryBackupPolicyDnsV1beta2(
      backupGeoTargets: map['backupGeoTargets'] == null ? null : RRSetRoutingPolicyGeoPolicyDnsV1beta2.fromMap((map['backupGeoTargets'] as Map).cast<String, dynamic>()),
      kind: map['kind'] == null ? null : map['kind'] as String,
      primaryTargets: map['primaryTargets'] == null ? null : RRSetRoutingPolicyHealthCheckTargetsDnsV1beta2.fromMap((map['primaryTargets'] as Map).cast<String, dynamic>()),
