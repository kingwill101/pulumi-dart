...
class PolicyAlternativeNameServerConfigDnsV1beta2 {
  ...
  const PolicyAlternativeNameServerConfigDnsV1beta2({
    this.kind,
  ...
  factory PolicyAlternativeNameServerConfigDnsV1beta2.fromMap(Map<String, dynamic> map) {
    return PolicyAlternativeNameServerConfigDnsV1beta2(
      ...
      targetNameServers: (() { final guardedValue = map['targetNameServers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PolicyAlternativeNameServerConfigTargetNameServerDnsV1beta2>(guardedValue, (value) => PolicyAlternativeNameServerConfigTargetNameServerDnsV1beta2.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
