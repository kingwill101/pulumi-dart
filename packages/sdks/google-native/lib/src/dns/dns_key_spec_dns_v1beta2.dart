...
class DnsKeySpecDnsV1beta2 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'algorithm': ?pulumi.Input.mapOptionalInputValue<DnsKeySpecAlgorithmDnsV1beta2, String>(algorithm, (value) => value.wireValue),
      'keyLength': ?keyLength,
      'keyType': ?pulumi.Input.mapOptionalInputValue<DnsKeySpecKeyTypeDnsV1beta2, String>(keyType, (value) => value.wireValue),
      'kind': ?kind,
    };
  }
  ...
  factory DnsKeySpecDnsV1beta2.fromMap(Map<String, dynamic> map) {
    return DnsKeySpecDnsV1beta2(
      algorithm: (() { final guardedValue = map['algorithm']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DnsKeySpecAlgorithmDnsV1beta2.fromValue(guardedValue as String)); })(),
      ...
      keyType: (() { final guardedValue = map['keyType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DnsKeySpecKeyTypeDnsV1beta2.fromValue(guardedValue as String)); })(),
