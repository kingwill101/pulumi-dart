...
/// {@template pulumi_dns_v1beta2_managed_zone_iam_member_dns_v1beta2_args_doc}
/// The set of arguments for ManagedZoneIamMember.
/// {@endtemplate}
/// {@macro pulumi_dns_v1beta2_managed_zone_iam_member_dns_v1beta2_args_doc}
class ManagedZoneIamMemberDnsV1beta2Args {
  ...
  /// Creates a new [ManagedZoneIamMemberDnsV1beta2Args].
  ...
  const ManagedZoneIamMemberDnsV1beta2Args({
    this.condition,
  ...
  factory ManagedZoneIamMemberDnsV1beta2Args.fromMap(Map<String, dynamic> map) {
    return ManagedZoneIamMemberDnsV1beta2Args(
