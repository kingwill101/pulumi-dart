...
class GetManagedZoneDnsV1beta2Result {
  ...
  final ManagedZonePrivateVisibilityConfigResponseDnsV1beta2 privateVisibilityConfig;
  ...
  final ManagedZoneServiceDirectoryConfigResponseDnsV1beta2 serviceDirectoryConfig;
  ...
  factory GetManagedZoneDnsV1beta2Result.fromMap(Map<String, dynamic> map) {
    return GetManagedZoneDnsV1beta2Result(
      cloudLoggingConfig: ManagedZoneCloudLoggingConfigResponseDnsV1beta2.fromMap((map['cloudLoggingConfig']! as Map).cast<String, dynamic>()),
      creationTime: map['creationTime'] as String,
      description: map['description'] as String,
      dnsName: map['dnsName'] as String,
      dnssecConfig: ManagedZoneDnsSecConfigResponseDnsV1beta2.fromMap((map['dnssecConfig']! as Map).cast<String, dynamic>()),
      forwardingConfig: ManagedZoneForwardingConfigResponseDnsV1beta2.fromMap((map['forwardingConfig']! as Map).cast<String, dynamic>()),
      kind: map['kind'] as String,
      labels: (map['labels'] as Map).cast<String, String>(),
      name: map['name'] as String,
      nameServerSet: map['nameServerSet'] as String,
      nameServers: (map['nameServers'] as List).cast<String>(),
      peeringConfig: ManagedZonePeeringConfigResponseDnsV1beta2.fromMap((map['peeringConfig']! as Map).cast<String, dynamic>()),
      privateVisibilityConfig: ManagedZonePrivateVisibilityConfigResponseDnsV1beta2.fromMap((map['privateVisibilityConfig']! as Map).cast<String, dynamic>()),
      reverseLookupConfig: ManagedZoneReverseLookupConfigResponseDnsV1beta2.fromMap((map['reverseLookupConfig']! as Map).cast<String, dynamic>()),
      serviceDirectoryConfig: ManagedZoneServiceDirectoryConfigResponseDnsV1beta2.fromMap((map['serviceDirectoryConfig']! as Map).cast<String, dynamic>()),
