...
class ResponsePolicyRuleLocalDataDnsV1beta2 {
  ...
  final pulumi.Input<List<ResourceRecordSetDnsV1beta2>>? localDatas;
  ...
  const ResponsePolicyRuleLocalDataDnsV1beta2({
    this.localDatas,
  });
  ...
  factory ResponsePolicyRuleLocalDataDnsV1beta2.fromMap(Map<String, dynamic> map) {
    return ResponsePolicyRuleLocalDataDnsV1beta2(
      localDatas: (() { final guardedValue = map['localDatas']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ResourceRecordSetDnsV1beta2>(guardedValue, (value) => ResourceRecordSetDnsV1beta2.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
