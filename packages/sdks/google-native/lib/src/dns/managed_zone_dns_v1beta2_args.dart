...
class ManagedZoneDnsV1beta2Args {
  ...
  const ManagedZoneDnsV1beta2Args({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'visibility': ?pulumi.Input.mapOptionalInputValue<ManagedZoneVisibilityDnsV1beta2, String>(visibility, (value) => value.wireValue),
    };
  }
  ...
  factory ManagedZoneDnsV1beta2Args.fromMap(Map<String, dynamic> map) {
    return ManagedZoneDnsV1beta2Args(
      ...
      cloudLoggingConfig: (() { final guardedValue = map['cloudLoggingConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagedZoneCloudLoggingConfigDnsV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      dnssecConfig: (() { final guardedValue = map['dnssecConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagedZoneDnsSecConfigDnsV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      forwardingConfig: (() { final guardedValue = map['forwardingConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagedZoneForwardingConfigDnsV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      peeringConfig: (() { final guardedValue = map['peeringConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagedZonePeeringConfigDnsV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      privateVisibilityConfig: (() { final guardedValue = map['privateVisibilityConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagedZonePrivateVisibilityConfigDnsV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      project: (() { final guardedValue = map['project']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      reverseLookupConfig: (() { final guardedValue = map['reverseLookupConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagedZoneReverseLookupConfigDnsV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      serviceDirectoryConfig: (() { final guardedValue = map['serviceDirectoryConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagedZoneServiceDirectoryConfigDnsV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      visibility: (() { final guardedValue = map['visibility']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagedZoneVisibilityDnsV1beta2.fromValue(guardedValue as String)); })(),
    );
  }
}
