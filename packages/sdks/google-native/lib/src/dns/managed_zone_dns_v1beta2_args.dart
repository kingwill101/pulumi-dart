...
class ManagedZoneDnsV1beta2Args {
  ...
  ManagedZoneDnsV1beta2Args({
    ...
    pulumi.Output<ManagedZoneCloudLoggingConfigDnsV1beta2>? cloudLoggingConfig,
    pulumi.Output<String>? creationTime,
    pulumi.Output<String>? description,
    pulumi.Output<String>? dnsName,
    pulumi.Output<ManagedZoneDnsSecConfigDnsV1beta2>? dnssecConfig,
    pulumi.Output<ManagedZoneForwardingConfigDnsV1beta2>? forwardingConfig,
    pulumi.Output<String>? kind,
    pulumi.Output<Map<String, String>>? labels,
    pulumi.Output<String>? name,
    pulumi.Output<String>? nameServerSet,
    pulumi.Output<ManagedZonePeeringConfigDnsV1beta2>? peeringConfig,
    pulumi.Output<ManagedZonePrivateVisibilityConfigDnsV1beta2>? privateVisibilityConfig,
    pulumi.Output<String>? project,
    pulumi.Output<ManagedZoneReverseLookupConfigDnsV1beta2>? reverseLookupConfig,
    pulumi.Output<ManagedZoneServiceDirectoryConfigDnsV1beta2>? serviceDirectoryConfig,
    pulumi.Output<ManagedZoneVisibilityDnsV1beta2>? visibility,
  }) :
  ...
  factory ManagedZoneDnsV1beta2Args.fromMap(Map<String, dynamic> map) {
    return ManagedZoneDnsV1beta2Args(
      ...
      cloudLoggingConfig: map['cloudLoggingConfig'] == null ? null : pulumi.Output.create<ManagedZoneCloudLoggingConfigDnsV1beta2>(ManagedZoneCloudLoggingConfigDnsV1beta2.fromMap((map['cloudLoggingConfig'] as Map).cast<String, dynamic>())),
      ...
      dnssecConfig: map['dnssecConfig'] == null ? null : pulumi.Output.create<ManagedZoneDnsSecConfigDnsV1beta2>(ManagedZoneDnsSecConfigDnsV1beta2.fromMap((map['dnssecConfig'] as Map).cast<String, dynamic>())),
      forwardingConfig: map['forwardingConfig'] == null ? null : pulumi.Output.create<ManagedZoneForwardingConfigDnsV1beta2>(ManagedZoneForwardingConfigDnsV1beta2.fromMap((map['forwardingConfig'] as Map).cast<String, dynamic>())),
      ...
      peeringConfig: map['peeringConfig'] == null ? null : pulumi.Output.create<ManagedZonePeeringConfigDnsV1beta2>(ManagedZonePeeringConfigDnsV1beta2.fromMap((map['peeringConfig'] as Map).cast<String, dynamic>())),
      privateVisibilityConfig: map['privateVisibilityConfig'] == null ? null : pulumi.Output.create<ManagedZonePrivateVisibilityConfigDnsV1beta2>(ManagedZonePrivateVisibilityConfigDnsV1beta2.fromMap((map['privateVisibilityConfig'] as Map).cast<String, dynamic>())),
      project: map['project'] == null ? null : pulumi.Output.create<String>(map['project'] as String),
      reverseLookupConfig: map['reverseLookupConfig'] == null ? null : pulumi.Output.create<ManagedZoneReverseLookupConfigDnsV1beta2>(ManagedZoneReverseLookupConfigDnsV1beta2.fromMap((map['reverseLookupConfig'] as Map).cast<String, dynamic>())),
      serviceDirectoryConfig: map['serviceDirectoryConfig'] == null ? null : pulumi.Output.create<ManagedZoneServiceDirectoryConfigDnsV1beta2>(ManagedZoneServiceDirectoryConfigDnsV1beta2.fromMap((map['serviceDirectoryConfig'] as Map).cast<String, dynamic>())),
      visibility: map['visibility'] == null ? null : pulumi.Output.create<ManagedZoneVisibilityDnsV1beta2>(ManagedZoneVisibilityDnsV1beta2.fromValue(map['visibility'] as String)),
    );
  }
}
