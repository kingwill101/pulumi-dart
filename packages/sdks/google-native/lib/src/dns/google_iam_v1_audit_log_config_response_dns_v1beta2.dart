...
class GoogleIamV1AuditLogConfigResponseDnsV1beta2 {
  ...
  factory GoogleIamV1AuditLogConfigResponseDnsV1beta2.fromMap(Map<String, dynamic> map) {
    return GoogleIamV1AuditLogConfigResponseDnsV1beta2(
