...
class ManagedZoneArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'visibility': ?pulumi.Input.mapOptionalInputValue<ManagedZoneVisibility, String>(visibility, (value) => value.wireValue),
    };
  }
  ...
  factory ManagedZoneArgs.fromMap(Map<String, dynamic> map) {
    return ManagedZoneArgs(
      ...
      nameServerSet: (() { final guardedValue = map['nameServerSet']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      reverseLookupConfig: (() { final guardedValue = map['reverseLookupConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagedZoneReverseLookupConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      visibility: (() { final guardedValue = map['visibility']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagedZoneVisibility.fromValue(guardedValue as String)); })(),
    );
  }
}
