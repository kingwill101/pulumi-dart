...
class ManagedZoneArgs {
  ...
  ManagedZoneArgs({
    ...
    pulumi.Output<String>? nameServerSet,
    ...
    pulumi.Output<ManagedZoneReverseLookupConfig>? reverseLookupConfig,
    pulumi.Output<ManagedZoneServiceDirectoryConfig>? serviceDirectoryConfig,
    pulumi.Output<ManagedZoneVisibility>? visibility,
  }) :
      ...
      reverseLookupConfig = pulumi.Input.asOptionalInput<ManagedZoneReverseLookupConfig>(reverseLookupConfig),
      serviceDirectoryConfig = pulumi.Input.asOptionalInput<ManagedZoneServiceDirectoryConfig>(serviceDirectoryConfig),
      visibility = pulumi.Input.asOptionalInput<ManagedZoneVisibility>(visibility);
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'project': ?project,
      'reverseLookupConfig': ?pulumi.Input.mapOptionalInputValue<ManagedZoneReverseLookupConfig, Map<String, dynamic>>(reverseLookupConfig, (value) => value.toMap()),
      ...
      'visibility': ?pulumi.Input.mapOptionalInputValue<ManagedZoneVisibility, String>(visibility, (value) => value.value),
    };
  }
  ...
  factory ManagedZoneArgs.fromMap(Map<String, dynamic> map) {
    return ManagedZoneArgs(
      ...
      nameServerSet: map['nameServerSet'] == null ? null : pulumi.Output.create<String>(map['nameServerSet'] as String),
      ...
      reverseLookupConfig: map['reverseLookupConfig'] == null ? null : pulumi.Output.create<ManagedZoneReverseLookupConfig>(ManagedZoneReverseLookupConfig.fromMap((map['reverseLookupConfig'] as Map).cast<String, dynamic>())),
      ...
      visibility: map['visibility'] == null ? null : pulumi.Output.create<ManagedZoneVisibility>(ManagedZoneVisibility.fromValue(map['visibility'] as String)),
    );
  }
}
