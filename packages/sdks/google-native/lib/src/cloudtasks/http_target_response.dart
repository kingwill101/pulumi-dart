...
class HttpTargetResponse {
  ...
  final pulumi.Input<List<HeaderOverrideResponse>> headerOverrides;
  ...
  final pulumi.Input<UriOverrideResponse> uriOverride;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'headerOverrides': pulumi.Input.mapInputValue<List<HeaderOverrideResponse>, List<Map<String, dynamic>>>(headerOverrides, (value) => pulumi.Input.encodeList<HeaderOverrideResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      ...
      'uriOverride': pulumi.Input.mapInputValue<UriOverrideResponse, Map<String, dynamic>>(uriOverride, (value) => value.toMap()),
    };
  }

  factory HttpTargetResponse.fromMap(Map<String, dynamic> map) {
    return HttpTargetResponse(
      headerOverrides: pulumi.Input.fromValue(pulumi.Input.decodeList<HeaderOverrideResponse>(map['headerOverrides']!, (value) => HeaderOverrideResponse.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      uriOverride: pulumi.Input.fromValue(UriOverrideResponse.fromMap((map['uriOverride']! as Map).cast<String, dynamic>())),
    );
  }
}
