...
class HttpTargetResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'uriOverride':
          pulumi.Input.mapInputValue<UriOverrideResponse, Map<String, dynamic>>(
            uriOverride,
            (value) => value.toMap(),
          ),
    };
  ...
  factory HttpTargetResponse.fromMap(Map<String, dynamic> map) {
    return HttpTargetResponse(
      headerOverrides: pulumi.Input.fromValue(
        pulumi.Input.decodeList<HeaderOverrideResponse>(
          map['headerOverrides']!,
