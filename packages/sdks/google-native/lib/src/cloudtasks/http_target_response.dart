...
class HttpTargetResponse {
  ...
  factory HttpTargetResponse.fromMap(Map<String, dynamic> map) {
    return HttpTargetResponse(
      headerOverrides: (pulumi.Input.decodeList<HeaderOverrideResponse>(map['headerOverrides'], (value) => HeaderOverrideResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      uriOverride: (UriOverrideResponse.fromMap((map['uriOverride'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
