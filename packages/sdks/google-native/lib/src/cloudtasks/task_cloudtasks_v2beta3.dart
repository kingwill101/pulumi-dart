...
class TaskCloudtasksV2beta3 extends pulumi.CustomResource {
  ...
  TaskCloudtasksV2beta3(
    ...
    this.appEngineHttpRequest = registerOutput<AppEngineHttpRequestResponseCloudtasksV2beta3>('appEngineHttpRequest');
    this.createTime = registerOutput<String>('createTime');
    this.dispatchCount = registerOutput<int>('dispatchCount');
    this.dispatchDeadline = registerOutput<String>('dispatchDeadline');
    this.firstAttempt = registerOutput<AttemptResponseCloudtasksV2beta3>('firstAttempt');
    this.httpRequest = registerOutput<HttpRequestResponseCloudtasksV2beta3>('httpRequest');
    this.lastAttempt = registerOutput<AttemptResponseCloudtasksV2beta3>('lastAttempt');
    this.location = registerOutput<String>('location');
    this.name = registerOutput<String>('name');
    this.project = registerOutput<String>('project');
    this.pullMessage = registerOutput<PullMessageResponseCloudtasksV2beta3>('pullMessage');
