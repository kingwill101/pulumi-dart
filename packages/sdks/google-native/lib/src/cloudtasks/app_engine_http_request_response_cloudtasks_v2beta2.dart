...
class AppEngineHttpRequestResponseCloudtasksV2beta2 {
  ...
  final AppEngineRoutingResponseCloudtasksV2beta2 appEngineRouting;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'appEngineRouting': appEngineRouting.toMap(),
      'headers': headers,
  ...
  factory AppEngineHttpRequestResponseCloudtasksV2beta2.fromMap(Map<String, dynamic> map) {
    return AppEngineHttpRequestResponseCloudtasksV2beta2(
      appEngineRouting: AppEngineRoutingResponseCloudtasksV2beta2.fromMap((map['appEngineRouting'] as Map).cast<String, dynamic>()),
