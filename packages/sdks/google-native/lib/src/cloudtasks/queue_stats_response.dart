...
class QueueStatsResponse {
  ...
  factory QueueStatsResponse.fromMap(Map<String, dynamic> map) {
    return QueueStatsResponse(
      concurrentDispatchesCount: pulumi.Input.fromValue(
        map['concurrentDispatchesCount'] as String,
      ),
      effectiveExecutionRate: pulumi.Input.fromValue(
        map['effectiveExecutionRate'] as double,
      ),
      executedLastMinuteCount: pulumi.Input.fromValue(
        map['executedLastMinuteCount'] as String,
      ),
      oldestEstimatedArrivalTime: pulumi.Input.fromValue(
        map['oldestEstimatedArrivalTime'] as String,
      ),
