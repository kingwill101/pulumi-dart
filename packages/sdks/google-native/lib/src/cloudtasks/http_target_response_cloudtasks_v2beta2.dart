...
class HttpTargetResponseCloudtasksV2beta2 {
  ...
  factory HttpTargetResponseCloudtasksV2beta2.fromMap(Map<String, dynamic> map) {
    return HttpTargetResponseCloudtasksV2beta2(
      headerOverrides: (pulumi.Input.decodeList<HeaderOverrideResponseCloudtasksV2beta2>(map['headerOverrides'], (value) => HeaderOverrideResponseCloudtasksV2beta2.fromMap((value as Map).cast<String, dynamic>()))).input(),
      httpMethod: (map['httpMethod'] as String).input(),
      oauthToken: (OAuthTokenResponseCloudtasksV2beta2.fromMap((map['oauthToken'] as Map).cast<String, dynamic>())).input(),
      oidcToken: (OidcTokenResponseCloudtasksV2beta2.fromMap((map['oidcToken'] as Map).cast<String, dynamic>())).input(),
      uriOverride: (UriOverrideResponseCloudtasksV2beta2.fromMap((map['uriOverride'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
