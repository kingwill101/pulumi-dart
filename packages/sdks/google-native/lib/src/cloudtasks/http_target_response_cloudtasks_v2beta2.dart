...
class HttpTargetResponseCloudtasksV2beta2 {
  ...
  HttpTargetResponseCloudtasksV2beta2({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'headerOverrides': pulumi.Input.encodeList<HeaderOverrideResponseCloudtasksV2beta2, Map<String, dynamic>>(headerOverrides, (value) => value.toMap()),
  ...
  factory HttpTargetResponseCloudtasksV2beta2.fromMap(Map<String, dynamic> map) {
    return HttpTargetResponseCloudtasksV2beta2(
      headerOverrides: pulumi.Input.decodeList<HeaderOverrideResponseCloudtasksV2beta2>(map['headerOverrides'], (value) => HeaderOverrideResponseCloudtasksV2beta2.fromMap((value as Map).cast<String, dynamic>())),
      httpMethod: map['httpMethod'] as String,
      oauthToken: OAuthTokenResponseCloudtasksV2beta2.fromMap((map['oauthToken'] as Map).cast<String, dynamic>()),
      oidcToken: OidcTokenResponseCloudtasksV2beta2.fromMap((map['oidcToken'] as Map).cast<String, dynamic>()),
      uriOverride: UriOverrideResponseCloudtasksV2beta2.fromMap((map['uriOverride'] as Map).cast<String, dynamic>()),
    );
  }
}
