...
class HttpTargetResponseCloudtasksV2beta2 {
  ...
  final pulumi.Input<List<HeaderOverrideResponseCloudtasksV2beta2>>
  headerOverrides;
    ...
    return <String, dynamic>{
      'headerOverrides':
          pulumi.Input.mapInputValue<
            List<HeaderOverrideResponseCloudtasksV2beta2>,
      ...
      'oauthToken':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(oauthToken, (value) => value.toMap()),
      'oidcToken':
          pulumi.Input.mapInputValue<
            OidcTokenResponseCloudtasksV2beta2,
            Map<String, dynamic>
  ...
  factory HttpTargetResponseCloudtasksV2beta2.fromMap(
    ...
    return HttpTargetResponseCloudtasksV2beta2(
      headerOverrides: pulumi.Input.fromValue(
      ...
      oauthToken: pulumi.Input.fromValue(
        OAuthTokenResponseCloudtasksV2beta2.fromMap(
          (map['oauthToken']! as Map).cast<String, dynamic>(),
        ),
      ),
      oidcToken: pulumi.Input.fromValue(
        OidcTokenResponseCloudtasksV2beta2.fromMap(
          (map['oidcToken']! as Map).cast<String, dynamic>(),
        ),
      ),
      uriOverride: pulumi.Input.fromValue(
        UriOverrideResponseCloudtasksV2beta2.fromMap(
