...
class AttemptResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'responseStatus': pulumi.Input.mapInputValue<StatusResponse, Map<String, dynamic>>(responseStatus, (value) => value.toMap()),
  ...
  factory AttemptResponse.fromMap(Map<String, dynamic> map) {
    return AttemptResponse(
      ...
      responseStatus: pulumi.Input.fromValue(StatusResponse.fromMap((map['responseStatus']! as Map).cast<String, dynamic>())),
