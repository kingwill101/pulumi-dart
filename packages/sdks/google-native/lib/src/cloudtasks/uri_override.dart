...
class UriOverride {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'host': ?host,
      'pathOverride': ?pulumi.Input.mapOptionalInputValue<PathOverride, Map<String, dynamic>>(pathOverride, (value) => value.toMap()),
      'port': ?port,
      'queryOverride': ?pulumi.Input.mapOptionalInputValue<QueryOverride, Map<String, dynamic>>(queryOverride, (value) => value.toMap()),
      'scheme': ?pulumi.Input.mapOptionalInputValue<UriOverrideScheme, String>(scheme, (value) => value.wireValue),
      'uriOverrideEnforceMode': ?pulumi.Input.mapOptionalInputValue<UriOverrideUriOverrideEnforceMode, String>(uriOverrideEnforceMode, (value) => value.wireValue),
    };
  }
  ...
  factory UriOverride.fromMap(Map<String, dynamic> map) {
    return UriOverride(
      ...
      pathOverride: (() { final guardedValue = map['pathOverride']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PathOverride.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      port: (() { final guardedValue = map['port']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      queryOverride: (() { final guardedValue = map['queryOverride']; if (guardedValue == null) return null; return pulumi.Input.fromValue(QueryOverride.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      scheme: (() { final guardedValue = map['scheme']; if (guardedValue == null) return null; return pulumi.Input.fromValue(UriOverrideScheme.fromValue(guardedValue as String)); })(),
      uriOverrideEnforceMode: (() { final guardedValue = map['uriOverrideEnforceMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(UriOverrideUriOverrideEnforceMode.fromValue(guardedValue as String)); })(),
    );
  }
}
