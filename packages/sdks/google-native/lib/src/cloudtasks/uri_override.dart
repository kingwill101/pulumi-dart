...
class UriOverride {
  ...
  factory UriOverride.fromMap(Map<String, dynamic> map) {
    return UriOverride(
      ...
      pathOverride: map['pathOverride'] == null ? null : PathOverride.fromMap((map['pathOverride'] as Map).cast<String, dynamic>()),
      port: map['port'] == null ? null : map['port'] as String,
      queryOverride: map['queryOverride'] == null ? null : QueryOverride.fromMap((map['queryOverride'] as Map).cast<String, dynamic>()),
      scheme: map['scheme'] == null ? null : UriOverrideScheme.fromValue(map['scheme'] as String),
      uriOverrideEnforceMode: map['uriOverrideEnforceMode'] == null ? null : UriOverrideUriOverrideEnforceMode.fromValue(map['uriOverrideEnforceMode'] as String),
    );
  }
}
