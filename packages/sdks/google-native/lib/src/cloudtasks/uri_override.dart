...
class UriOverride {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'scheme': ?pulumi.Input.mapOptionalInputValue<UriOverrideScheme, String>(scheme, (value) => value.value),
      'uriOverrideEnforceMode': ?pulumi.Input.mapOptionalInputValue<UriOverrideUriOverrideEnforceMode, String>(uriOverrideEnforceMode, (value) => value.value),
    };
  }
