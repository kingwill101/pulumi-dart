...
class HttpTargetCloudtasksV2beta2 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'headerOverrides': ?headerOverrides == null ? null : pulumi.Input.encodeList<HeaderOverrideCloudtasksV2beta2, Map<String, dynamic>>(headerOverrides!, (value) => value.toMap()),
  ...
  factory HttpTargetCloudtasksV2beta2.fromMap(Map<String, dynamic> map) {
    return HttpTargetCloudtasksV2beta2(
      headerOverrides: map['headerOverrides'] == null ? null : pulumi.Input.decodeList<HeaderOverrideCloudtasksV2beta2>(map['headerOverrides'], (value) => HeaderOverrideCloudtasksV2beta2.fromMap((value as Map).cast<String, dynamic>())),
      httpMethod: map['httpMethod'] == null ? null : HttpTargetHttpMethodCloudtasksV2beta2.fromValue(map['httpMethod'] as String),
      oauthToken: map['oauthToken'] == null ? null : OAuthTokenCloudtasksV2beta2.fromMap((map['oauthToken'] as Map).cast<String, dynamic>()),
      oidcToken: map['oidcToken'] == null ? null : OidcTokenCloudtasksV2beta2.fromMap((map['oidcToken'] as Map).cast<String, dynamic>()),
      uriOverride: map['uriOverride'] == null ? null : UriOverrideCloudtasksV2beta2.fromMap((map['uriOverride'] as Map).cast<String, dynamic>()),
    );
  }
}
