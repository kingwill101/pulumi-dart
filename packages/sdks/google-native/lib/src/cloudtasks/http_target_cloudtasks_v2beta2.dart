...
class HttpTargetCloudtasksV2beta2 {
  ...
  const HttpTargetCloudtasksV2beta2({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'httpMethod': ?pulumi.Input.mapOptionalInputValue<HttpTargetHttpMethodCloudtasksV2beta2, String>(httpMethod, (value) => value.wireValue),
  ...
  factory HttpTargetCloudtasksV2beta2.fromMap(Map<String, dynamic> map) {
    return HttpTargetCloudtasksV2beta2(
      headerOverrides: (() { final guardedValue = map['headerOverrides']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<HeaderOverrideCloudtasksV2beta2>(guardedValue, (value) => HeaderOverrideCloudtasksV2beta2.fromMap((value as Map).cast<String, dynamic>()))); })(),
      httpMethod: (() { final guardedValue = map['httpMethod']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HttpTargetHttpMethodCloudtasksV2beta2.fromValue(guardedValue as String)); })(),
      ...
      uriOverride: (() { final guardedValue = map['uriOverride']; if (guardedValue == null) return null; return pulumi.Input.fromValue(UriOverrideCloudtasksV2beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
