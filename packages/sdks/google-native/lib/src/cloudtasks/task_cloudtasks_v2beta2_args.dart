...
class TaskCloudtasksV2beta2Args {
    ...
    return <String, dynamic>{
      ...
      'responseView':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(responseView, (value) => value.wireValue),
  ...
  factory TaskCloudtasksV2beta2Args.fromMap(Map<String, dynamic> map) {
    return TaskCloudtasksV2beta2Args(
      appEngineHttpRequest: (() {
        final guardedValue = map['appEngineHttpRequest'];
      ...
      httpRequest: (() {
        final guardedValue = map['httpRequest'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      pullMessage: (() {
        final guardedValue = map['pullMessage'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PullMessage.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      ...
      responseView: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TaskResponseViewCloudtasksV2beta2.fromValue(guardedValue as String),
        );
      })(),
      scheduleTime: (() {
