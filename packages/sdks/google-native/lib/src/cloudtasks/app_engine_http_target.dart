...
class AppEngineHttpTarget {
  ...
  factory AppEngineHttpTarget.fromMap(Map<String, dynamic> map) {
    return AppEngineHttpTarget(
      appEngineRoutingOverride: (() { final guardedValue = map['appEngineRoutingOverride']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AppEngineRoutingCloudtasksV2beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
