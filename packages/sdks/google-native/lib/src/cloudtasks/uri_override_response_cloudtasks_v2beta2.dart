...
class UriOverrideResponseCloudtasksV2beta2 {
  ...
  factory UriOverrideResponseCloudtasksV2beta2.fromMap(Map<String, dynamic> map) {
    return UriOverrideResponseCloudtasksV2beta2(
      ...
      pathOverride: pulumi.Input.fromValue(PathOverrideResponseCloudtasksV2beta2.fromMap((map['pathOverride']! as Map).cast<String, dynamic>())),
      port: pulumi.Input.fromValue(map['port'] as String),
      queryOverride: pulumi.Input.fromValue(QueryOverrideResponseCloudtasksV2beta2.fromMap((map['queryOverride']! as Map).cast<String, dynamic>())),
