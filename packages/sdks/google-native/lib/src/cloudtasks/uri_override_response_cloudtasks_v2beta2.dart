...
class UriOverrideResponseCloudtasksV2beta2 {
  ...
  final pulumi.Input<PathOverrideResponseCloudtasksV2beta2> pathOverride;
  ...
  final pulumi.Input<QueryOverrideResponseCloudtasksV2beta2> queryOverride;
  /// Scheme override. When specified, the task URI scheme is replaced by the provided value (HTTP or HTTPS).
  final pulumi.Input<String> scheme;
  /// URI Override Enforce Mode When specified, determines the Target UriOverride mode. If not specified, it defaults to ALWAYS.
  final pulumi.Input<String> uriOverrideEnforceMode;

  /// Creates a new [UriOverrideResponseCloudtasksV2beta2].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'host': host,
      'pathOverride': pulumi.Input.mapInputValue<PathOverrideResponseCloudtasksV2beta2, Map<String, dynamic>>(pathOverride, (value) => value.toMap()),
      'port': port,
      'queryOverride': pulumi.Input.mapInputValue<QueryOverrideResponseCloudtasksV2beta2, Map<String, dynamic>>(queryOverride, (value) => value.toMap()),
      'scheme': scheme,
      'uriOverrideEnforceMode': uriOverrideEnforceMode,
    };
  }

  factory UriOverrideResponseCloudtasksV2beta2.fromMap(Map<String, dynamic> map) {
    return UriOverrideResponseCloudtasksV2beta2(
      host: (map['host'] as String).input(),
      pathOverride: (PathOverrideResponseCloudtasksV2beta2.fromMap((map['pathOverride'] as Map).cast<String, dynamic>())).input(),
      port: (map['port'] as String).input(),
      queryOverride: (QueryOverrideResponseCloudtasksV2beta2.fromMap((map['queryOverride'] as Map).cast<String, dynamic>())).input(),
      scheme: (map['scheme'] as String).input(),
      uriOverrideEnforceMode: (map['uriOverrideEnforceMode'] as String).input(),
    );
  }
}
