...
class TaskArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'appEngineHttpRequest': ?pulumi.Input.mapOptionalInputValue<AppEngineHttpRequest, Map<String, dynamic>>(appEngineHttpRequest, (value) => value.toMap()),
      'dispatchDeadline': ?dispatchDeadline,
      'httpRequest': ?pulumi.Input.mapOptionalInputValue<HttpRequest, Map<String, dynamic>>(httpRequest, (value) => value.toMap()),
      'location': ?location,
      'name': ?name,
      'project': ?project,
      'queueId': queueId,
      'responseView': ?pulumi.Input.mapOptionalInputValue<TaskResponseView, String>(responseView, (value) => value.wireValue),
  ...
  factory TaskArgs.fromMap(Map<String, dynamic> map) {
    return TaskArgs(
      appEngineHttpRequest: (() { final guardedValue = map['appEngineHttpRequest']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AppEngineHttpRequest.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      httpRequest: (() { final guardedValue = map['httpRequest']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HttpRequest.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      responseView: (() { final guardedValue = map['responseView']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TaskResponseView.fromValue(guardedValue as String)); })(),
