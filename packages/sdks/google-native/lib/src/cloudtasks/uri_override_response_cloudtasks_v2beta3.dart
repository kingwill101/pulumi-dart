...
class UriOverrideResponseCloudtasksV2beta3 {
  ...
  factory UriOverrideResponseCloudtasksV2beta3.fromMap(Map<String, dynamic> map) {
    return UriOverrideResponseCloudtasksV2beta3(
      ...
      pathOverride: (PathOverrideResponseCloudtasksV2beta3.fromMap((map['pathOverride'] as Map).cast<String, dynamic>())).input(),
      port: (map['port'] as String).input(),
      queryOverride: (QueryOverrideResponseCloudtasksV2beta3.fromMap((map['queryOverride'] as Map).cast<String, dynamic>())).input(),
