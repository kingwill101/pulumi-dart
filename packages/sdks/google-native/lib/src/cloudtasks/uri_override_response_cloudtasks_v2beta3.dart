...
class UriOverrideResponseCloudtasksV2beta3 {
  ...
  final PathOverrideResponseCloudtasksV2beta3 pathOverride;
  ...
  final QueryOverrideResponseCloudtasksV2beta3 queryOverride;
  ...
  UriOverrideResponseCloudtasksV2beta3({
    required this.host,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'host': host,
      'pathOverride': pathOverride.toMap(),
      'port': port,
      'queryOverride': queryOverride.toMap(),
      'scheme': scheme,
  ...
  factory UriOverrideResponseCloudtasksV2beta3.fromMap(Map<String, dynamic> map) {
    return UriOverrideResponseCloudtasksV2beta3(
      ...
      pathOverride: PathOverrideResponseCloudtasksV2beta3.fromMap((map['pathOverride'] as Map).cast<String, dynamic>()),
      port: map['port'] as String,
      queryOverride: QueryOverrideResponseCloudtasksV2beta3.fromMap((map['queryOverride'] as Map).cast<String, dynamic>()),
