...
class ExprCloudtasksV2beta2 {
  ...
  /// Creates a new [ExprCloudtasksV2beta2].
  ...
  factory ExprCloudtasksV2beta2.fromMap(Map<String, dynamic> map) {
    return ExprCloudtasksV2beta2(
