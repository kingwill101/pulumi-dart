...
class RetryConfigResponseCloudtasksV2beta2 {
  ...
  final pulumi.Input<bool> unlimitedAttempts;
  ...
  factory RetryConfigResponseCloudtasksV2beta2.fromMap(Map<String, dynamic> map) {
    return RetryConfigResponseCloudtasksV2beta2(
      maxAttempts: (map['maxAttempts'] as int).input(),
      maxBackoff: (map['maxBackoff'] as String).input(),
      maxDoublings: (map['maxDoublings'] as int).input(),
      maxRetryDuration: (map['maxRetryDuration'] as String).input(),
      minBackoff: (map['minBackoff'] as String).input(),
      unlimitedAttempts: (map['unlimitedAttempts'] as bool).input(),
    );
  }
}
