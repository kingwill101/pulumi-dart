  ...
  factory GetTaskCloudtasksV2beta3Result.fromMap(Map<String, dynamic> map) {
    return GetTaskCloudtasksV2beta3Result(
      appEngineHttpRequest:
          AppEngineHttpRequestResponseCloudtasksV2beta3.fromMap(
      ...
      firstAttempt: AttemptResponseCloudtasksV2beta3.fromMap(
        (map['firstAttempt']! as Map).cast<String, dynamic>(),
      ),
      httpRequest: HttpRequestResponseCloudtasksV2beta3.fromMap(
        (map['httpRequest']! as Map).cast<String, dynamic>(),
      ),
      lastAttempt: AttemptResponseCloudtasksV2beta3.fromMap(
        (map['lastAttempt']! as Map).cast<String, dynamic>(),
      ),
      name: map['name'] as String,
      pullMessage: PullMessageResponseCloudtasksV2beta3.fromMap(
