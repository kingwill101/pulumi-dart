...
class GetTaskCloudtasksV2beta3Result {
  /// HTTP request that is sent to the App Engine app handler. An App Engine task is a task that has AppEngineHttpRequest set.
  final AppEngineHttpRequestResponseCloudtasksV2beta3 appEngineHttpRequest;
  ...
  final AttemptResponseCloudtasksV2beta3 firstAttempt;
  /// HTTP request that is sent to the task's target. An HTTP task is a task that has HttpRequest set.
  final HttpRequestResponseCloudtasksV2beta3 httpRequest;
  /// The status of the task's last attempt.
  final AttemptResponseCloudtasksV2beta3 lastAttempt;
  ...
  final PullMessageResponseCloudtasksV2beta3 pullMessage;
  ...
  /// Creates a new [GetTaskCloudtasksV2beta3Result].
  ...
  factory GetTaskCloudtasksV2beta3Result.fromMap(Map<String, dynamic> map) {
    return GetTaskCloudtasksV2beta3Result(
      appEngineHttpRequest: AppEngineHttpRequestResponseCloudtasksV2beta3.fromMap((map['appEngineHttpRequest']! as Map).cast<String, dynamic>()),
      createTime: map['createTime'] as String,
      dispatchCount: map['dispatchCount'] as int,
      dispatchDeadline: map['dispatchDeadline'] as String,
      firstAttempt: AttemptResponseCloudtasksV2beta3.fromMap((map['firstAttempt']! as Map).cast<String, dynamic>()),
      httpRequest: HttpRequestResponseCloudtasksV2beta3.fromMap((map['httpRequest']! as Map).cast<String, dynamic>()),
      lastAttempt: AttemptResponseCloudtasksV2beta3.fromMap((map['lastAttempt']! as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      pullMessage: PullMessageResponseCloudtasksV2beta3.fromMap((map['pullMessage']! as Map).cast<String, dynamic>()),
