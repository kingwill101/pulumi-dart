...
class HttpRequest {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'body': ?body,
      'headers': ?headers,
      'httpMethod': ?pulumi.Input.mapOptionalInputValue<HttpRequestHttpMethod, String>(httpMethod, (value) => value.value),
  ...
  factory HttpRequest.fromMap(Map<String, dynamic> map) {
    return HttpRequest(
      ...
      httpMethod: map['httpMethod'] == null ? null : (HttpRequestHttpMethod.fromValue(map['httpMethod']! as String)).input(),
