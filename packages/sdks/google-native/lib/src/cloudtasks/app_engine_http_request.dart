...
class AppEngineHttpRequest {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'body': ?body,
      'headers': ?headers,
      'httpMethod': ?pulumi.Input.mapOptionalInputValue<AppEngineHttpRequestHttpMethod, String>(httpMethod, (value) => value.value),
  ...
  factory AppEngineHttpRequest.fromMap(Map<String, dynamic> map) {
    return AppEngineHttpRequest(
      ...
      httpMethod: map['httpMethod'] == null ? null : (AppEngineHttpRequestHttpMethod.fromValue(map['httpMethod'] as String)).input(),
