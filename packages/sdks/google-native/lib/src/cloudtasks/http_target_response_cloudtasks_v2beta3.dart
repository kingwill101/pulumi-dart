...
class HttpTargetResponseCloudtasksV2beta3 {
  ...
  final pulumi.Input<List<HeaderOverrideResponseCloudtasksV2beta3>>
  headerOverrides;
    ...
    return <String, dynamic>{
      'headerOverrides':
          pulumi.Input.mapInputValue<
            List<HeaderOverrideResponseCloudtasksV2beta3>,
