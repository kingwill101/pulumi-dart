...
class UriOverrideCloudtasksV2beta3 {
  ...
  final pulumi.Input<UriOverrideUriOverrideEnforceModeCloudtasksV2beta3>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'scheme':
          ?pulumi.Input.mapOptionalInputValue<
            UriOverrideSchemeCloudtasksV2beta3,
            String
          >(scheme, (value) => value.wireValue),
      'uriOverrideEnforceMode':
          ?pulumi.Input.mapOptionalInputValue<
            UriOverrideUriOverrideEnforceModeCloudtasksV2beta3,
            String
  ...
  factory UriOverrideCloudtasksV2beta3.fromMap(Map<String, dynamic> map) {
    return UriOverrideCloudtasksV2beta3(
      ...
      scheme: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          UriOverrideSchemeCloudtasksV2beta3.fromValue(guardedValue as String),
        );
      })(),
      uriOverrideEnforceMode: (() {
