...
class RateLimitsCloudtasksV2beta2 {
  ...
  /// Creates a new [RateLimitsCloudtasksV2beta2].
  ...
  const RateLimitsCloudtasksV2beta2({
    this.maxBurstSize,
  ...
  factory RateLimitsCloudtasksV2beta2.fromMap(Map<String, dynamic> map) {
    return RateLimitsCloudtasksV2beta2(
      ...
      maxConcurrentTasks: (() { final guardedValue = map['maxConcurrentTasks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      maxTasksDispatchedPerSecond: (() { final guardedValue = map['maxTasksDispatchedPerSecond']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as double); })(),
    );
  }
}
