...
class ExprResponseCloudtasksV2beta2 {
  ...
  /// Creates a new [ExprResponseCloudtasksV2beta2].
  ...
  const ExprResponseCloudtasksV2beta2({
  ...
  factory ExprResponseCloudtasksV2beta2.fromMap(Map<String, dynamic> map) {
    return ExprResponseCloudtasksV2beta2(
