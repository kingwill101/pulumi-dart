...
class AppEngineHttpTargetResponse {
  ...
  factory AppEngineHttpTargetResponse.fromMap(Map<String, dynamic> map) {
    return AppEngineHttpTargetResponse(
      appEngineRoutingOverride: pulumi.Input.fromValue(AppEngineRoutingResponseCloudtasksV2beta2.fromMap((map['appEngineRoutingOverride']! as Map).cast<String, dynamic>())),
    );
  }
}
