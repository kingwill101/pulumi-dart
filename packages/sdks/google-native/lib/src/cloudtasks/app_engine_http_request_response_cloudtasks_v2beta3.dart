...
class AppEngineHttpRequestResponseCloudtasksV2beta3 {
  ...
  final pulumi.Input<AppEngineRoutingResponseCloudtasksV2beta3> appEngineRouting;
  ...
  const AppEngineHttpRequestResponseCloudtasksV2beta3({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'appEngineRouting': pulumi.Input.mapInputValue<AppEngineRoutingResponseCloudtasksV2beta3, Map<String, dynamic>>(appEngineRouting, (value) => value.toMap()),
      'body': body,
      'headers': headers,
  ...
  factory AppEngineHttpRequestResponseCloudtasksV2beta3.fromMap(Map<String, dynamic> map) {
    return AppEngineHttpRequestResponseCloudtasksV2beta3(
      appEngineRouting: pulumi.Input.fromValue(AppEngineRoutingResponseCloudtasksV2beta3.fromMap((map['appEngineRouting']! as Map).cast<String, dynamic>())),
