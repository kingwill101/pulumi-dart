...
class QueueCloudtasksV2beta2Args {
  ...
  /// [tombstoneTtl] The task tombstone time to live (TTL). After a task is deleted or completed, the task's tombstone is retained for the length of time specified by `tombstone_ttl`. The tombstone is used by task de-duplication; another task with the same name can't be created until the tombstone has expired. For more information about task de-duplication, see the documentation for CreateTaskRequest. Queues created by Cloud Tasks have a default `tombstone_ttl` of 1 hour.
  const QueueCloudtasksV2beta2Args({
  ...
  factory QueueCloudtasksV2beta2Args.fromMap(Map<String, dynamic> map) {
    return QueueCloudtasksV2beta2Args(
      appEngineHttpTarget: (() { final guardedValue = map['appEngineHttpTarget']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AppEngineHttpTarget.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      httpTarget: (() { final guardedValue = map['httpTarget']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HttpTargetCloudtasksV2beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      location: (() { final guardedValue = map['location']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      project: (() { final guardedValue = map['project']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      pullTarget: (() { final guardedValue = map['pullTarget']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, dynamic>()); })(),
      rateLimits: (() { final guardedValue = map['rateLimits']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RateLimitsCloudtasksV2beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      retryConfig: (() { final guardedValue = map['retryConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RetryConfigCloudtasksV2beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      taskTtl: (() { final guardedValue = map['taskTtl']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      tombstoneTtl: (() { final guardedValue = map['tombstoneTtl']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
