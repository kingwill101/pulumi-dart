...
class UriOverrideResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'host': host,
      'pathOverride': pulumi.Input.mapInputValue<PathOverrideResponse, Map<String, dynamic>>(pathOverride, (value) => value.toMap()),
      'port': port,
      'queryOverride': pulumi.Input.mapInputValue<QueryOverrideResponse, Map<String, dynamic>>(queryOverride, (value) => value.toMap()),
      'scheme': scheme,
  ...
  factory UriOverrideResponse.fromMap(Map<String, dynamic> map) {
    return UriOverrideResponse(
      ...
      pathOverride: pulumi.Input.fromValue(PathOverrideResponse.fromMap((map['pathOverride']! as Map).cast<String, dynamic>())),
      port: pulumi.Input.fromValue(map['port'] as String),
      queryOverride: pulumi.Input.fromValue(QueryOverrideResponse.fromMap((map['queryOverride']! as Map).cast<String, dynamic>())),
