...
class UriOverrideResponse {
  ...
  factory UriOverrideResponse.fromMap(Map<String, dynamic> map) {
    return UriOverrideResponse(
      ...
      pathOverride: (PathOverrideResponse.fromMap((map['pathOverride'] as Map).cast<String, dynamic>())).input(),
      port: (map['port'] as String).input(),
      queryOverride: (QueryOverrideResponse.fromMap((map['queryOverride'] as Map).cast<String, dynamic>())).input(),
