...
class ExprResponseCloudtasksV2beta3 {
  ...
  /// Creates a new [ExprResponseCloudtasksV2beta3].
  ...
  const ExprResponseCloudtasksV2beta3({
  ...
  factory ExprResponseCloudtasksV2beta3.fromMap(Map<String, dynamic> map) {
    return ExprResponseCloudtasksV2beta3(
