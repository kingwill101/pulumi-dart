...
/// {@template pulumi_cloudtasks_v2beta2_queue_iam_member_cloudtasks_v2beta2_args_doc}
/// The set of arguments for QueueIamMember.
/// {@endtemplate}
/// {@macro pulumi_cloudtasks_v2beta2_queue_iam_member_cloudtasks_v2beta2_args_doc}
class QueueIamMemberCloudtasksV2beta2Args {
  ...
  /// Creates a new [QueueIamMemberCloudtasksV2beta2Args].
  ...
  const QueueIamMemberCloudtasksV2beta2Args({
    this.condition,
  ...
  factory QueueIamMemberCloudtasksV2beta2Args.fromMap(Map<String, dynamic> map) {
    return QueueIamMemberCloudtasksV2beta2Args(
