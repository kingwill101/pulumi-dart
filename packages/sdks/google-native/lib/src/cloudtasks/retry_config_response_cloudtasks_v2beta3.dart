...
class RetryConfigResponseCloudtasksV2beta3 {
  ...
  /// Creates a new [RetryConfigResponseCloudtasksV2beta3].
  ...
  const RetryConfigResponseCloudtasksV2beta3({
  ...
  factory RetryConfigResponseCloudtasksV2beta3.fromMap(Map<String, dynamic> map) {
    return RetryConfigResponseCloudtasksV2beta3(
