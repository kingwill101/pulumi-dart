...
class HttpTarget {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'httpMethod':
          ?pulumi.Input.mapOptionalInputValue<HttpTargetHttpMethod, String>(
            httpMethod,
            (value) => value.wireValue,
          ),
      'oauthToken':
          ?pulumi.Input.mapOptionalInputValue<OAuthToken, Map<String, dynamic>>(
            oauthToken,
            (value) => value.toMap(),
          ),
      'oidcToken':
          ?pulumi.Input.mapOptionalInputValue<OidcToken, Map<String, dynamic>>(
            oidcToken,
            (value) => value.toMap(),
          ),
      'uriOverride':
  ...
  factory HttpTarget.fromMap(Map<String, dynamic> map) {
    return HttpTarget(
      headerOverrides: (() {
        final guardedValue = map['headerOverrides'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<HeaderOverride>(
            guardedValue,
            (value) =>
                HeaderOverride.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      httpMethod: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          HttpTargetHttpMethod.fromValue(guardedValue as String),
        );
      })(),
      oauthToken: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          OAuthToken.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      oidcToken: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          OidcToken.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      uriOverride: (() {
        final guardedValue = map['uriOverride'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          UriOverride.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
