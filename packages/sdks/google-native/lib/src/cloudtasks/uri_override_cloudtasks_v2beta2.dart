...
class UriOverrideCloudtasksV2beta2 {
  ...
  final PathOverrideCloudtasksV2beta2? pathOverride;
  ...
  final QueryOverrideCloudtasksV2beta2? queryOverride;
  /// Scheme override. When specified, the task URI scheme is replaced by the provided value (HTTP or HTTPS).
  final UriOverrideSchemeCloudtasksV2beta2? scheme;
  /// URI Override Enforce Mode When specified, determines the Target UriOverride mode. If not specified, it defaults to ALWAYS.
  final UriOverrideUriOverrideEnforceModeCloudtasksV2beta2? uriOverrideEnforceMode;
  ...
  factory UriOverrideCloudtasksV2beta2.fromMap(Map<String, dynamic> map) {
    return UriOverrideCloudtasksV2beta2(
      ...
      pathOverride: map['pathOverride'] == null ? null : PathOverrideCloudtasksV2beta2.fromMap((map['pathOverride'] as Map).cast<String, dynamic>()),
      port: map['port'] == null ? null : map['port'] as String,
      queryOverride: map['queryOverride'] == null ? null : QueryOverrideCloudtasksV2beta2.fromMap((map['queryOverride'] as Map).cast<String, dynamic>()),
      scheme: map['scheme'] == null ? null : UriOverrideSchemeCloudtasksV2beta2.fromValue(map['scheme'] as String),
      uriOverrideEnforceMode: map['uriOverrideEnforceMode'] == null ? null : UriOverrideUriOverrideEnforceModeCloudtasksV2beta2.fromValue(map['uriOverrideEnforceMode'] as String),
    );
  }
}
