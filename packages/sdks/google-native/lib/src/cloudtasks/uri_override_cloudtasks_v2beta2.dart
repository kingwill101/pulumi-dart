...
class UriOverrideCloudtasksV2beta2 {
  ...
  const UriOverrideCloudtasksV2beta2({
    this.host,
    this.pathOverride,
    this.port,
    this.queryOverride,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'scheme': ?pulumi.Input.mapOptionalInputValue<UriOverrideSchemeCloudtasksV2beta2, String>(scheme, (value) => value.wireValue),
      'uriOverrideEnforceMode': ?pulumi.Input.mapOptionalInputValue<UriOverrideUriOverrideEnforceModeCloudtasksV2beta2, String>(uriOverrideEnforceMode, (value) => value.wireValue),
    };
  }
  ...
  factory UriOverrideCloudtasksV2beta2.fromMap(Map<String, dynamic> map) {
    return UriOverrideCloudtasksV2beta2(
      ...
      pathOverride: (() { final guardedValue = map['pathOverride']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PathOverrideCloudtasksV2beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      port: (() { final guardedValue = map['port']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      queryOverride: (() { final guardedValue = map['queryOverride']; if (guardedValue == null) return null; return pulumi.Input.fromValue(QueryOverrideCloudtasksV2beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      scheme: (() { final guardedValue = map['scheme']; if (guardedValue == null) return null; return pulumi.Input.fromValue(UriOverrideSchemeCloudtasksV2beta2.fromValue(guardedValue as String)); })(),
      uriOverrideEnforceMode: (() { final guardedValue = map['uriOverrideEnforceMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(UriOverrideUriOverrideEnforceModeCloudtasksV2beta2.fromValue(guardedValue as String)); })(),
    );
  }
}
