...
class UriOverrideCloudtasksV2beta2 {
  ...
  final pulumi.Input<UriOverrideUriOverrideEnforceModeCloudtasksV2beta2>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'scheme':
          ?pulumi.Input.mapOptionalInputValue<
            UriOverrideSchemeCloudtasksV2beta2,
            String
          >(scheme, (value) => value.wireValue),
      'uriOverrideEnforceMode':
          ?pulumi.Input.mapOptionalInputValue<
            UriOverrideUriOverrideEnforceModeCloudtasksV2beta2,
            String
    ...
    return UriOverrideCloudtasksV2beta2(
      ...
      pathOverride: (() {
        ...
        return pulumi.Input.fromValue(
          PathOverrideCloudtasksV2beta2.fromMap(
      ...
      queryOverride: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          QueryOverrideCloudtasksV2beta2.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      scheme: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          UriOverrideSchemeCloudtasksV2beta2.fromValue(guardedValue as String),
        );
      })(),
      uriOverrideEnforceMode: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          UriOverrideUriOverrideEnforceModeCloudtasksV2beta2.fromValue(
