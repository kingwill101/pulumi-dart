...
class RetryConfigCloudtasksV2beta2 {
  ...
  /// Creates a new [RetryConfigCloudtasksV2beta2].
  ...
  const RetryConfigCloudtasksV2beta2({
    this.maxAttempts,
    this.maxBackoff,
    this.maxDoublings,
  ...
  factory RetryConfigCloudtasksV2beta2.fromMap(Map<String, dynamic> map) {
    return RetryConfigCloudtasksV2beta2(
      ...
      unlimitedAttempts: (() { final guardedValue = map['unlimitedAttempts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
    );
  }
}
