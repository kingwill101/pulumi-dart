...
import 'app_engine_http_request_http_method_cloudtasks_v2beta3.dart';
...
class AppEngineHttpRequestCloudtasksV2beta3 {
  ...
  final pulumi.Input<AppEngineRoutingCloudtasksV2beta3>? appEngineRouting;
  ...
  final pulumi.Input<AppEngineHttpRequestHttpMethodCloudtasksV2beta3>? httpMethod;
  /// The relative URI. The relative URI must begin with "/" and must be a valid HTTP relative URI. It can contain a path and query string arguments. If the relative URI is empty, then the root path "/" will be used. No spaces are allowed, and the maximum length allowed is 2083 characters.
  final pulumi.Input<String>? relativeUri;

  /// Creates a new [AppEngineHttpRequestCloudtasksV2beta3].
  ...
  const AppEngineHttpRequestCloudtasksV2beta3({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'appEngineRouting': ?pulumi.Input.mapOptionalInputValue<AppEngineRoutingCloudtasksV2beta3, Map<String, dynamic>>(appEngineRouting, (value) => value.toMap()),
      'body': ?body,
      'headers': ?headers,
      'httpMethod': ?pulumi.Input.mapOptionalInputValue<AppEngineHttpRequestHttpMethodCloudtasksV2beta3, String>(httpMethod, (value) => value.wireValue),
  ...
  factory AppEngineHttpRequestCloudtasksV2beta3.fromMap(Map<String, dynamic> map) {
    return AppEngineHttpRequestCloudtasksV2beta3(
      appEngineRouting: (() { final guardedValue = map['appEngineRouting']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AppEngineRoutingCloudtasksV2beta3.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      httpMethod: (() { final guardedValue = map['httpMethod']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AppEngineHttpRequestHttpMethodCloudtasksV2beta3.fromValue(guardedValue as String)); })(),
      relativeUri: (() { final guardedValue = map['relativeUri']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
