...
class HttpRequestCloudtasksV2beta2 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'body': ?body,
      'headers': ?headers,
      'httpMethod': ?pulumi.Input.mapOptionalInputValue<HttpRequestHttpMethodCloudtasksV2beta2, String>(httpMethod, (value) => value.value),
  ...
  factory HttpRequestCloudtasksV2beta2.fromMap(Map<String, dynamic> map) {
    return HttpRequestCloudtasksV2beta2(
      ...
      httpMethod: map['httpMethod'] == null ? null : (HttpRequestHttpMethodCloudtasksV2beta2.fromValue(map['httpMethod']! as String)).input(),
