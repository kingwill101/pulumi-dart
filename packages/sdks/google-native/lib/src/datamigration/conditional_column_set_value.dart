...
class ConditionalColumnSetValue {
  ...
  const ConditionalColumnSetValue({
    this.customFeatures,
  ...
  factory ConditionalColumnSetValue.fromMap(Map<String, dynamic> map) {
    return ConditionalColumnSetValue(
      ...
      valueTransformation: pulumi.Input.fromValue(ValueTransformation.fromMap((map['valueTransformation']! as Map).cast<String, dynamic>())),
    );
  }
}
