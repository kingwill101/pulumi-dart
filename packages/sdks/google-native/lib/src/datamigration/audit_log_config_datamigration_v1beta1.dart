...
class AuditLogConfigDatamigrationV1beta1 {
  ...
  const AuditLogConfigDatamigrationV1beta1({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'logType': ?pulumi.Input.mapOptionalInputValue<AuditLogConfigLogTypeDatamigrationV1beta1, String>(logType, (value) => value.wireValue),
    };
  }
  ...
  factory AuditLogConfigDatamigrationV1beta1.fromMap(Map<String, dynamic> map) {
    return AuditLogConfigDatamigrationV1beta1(
      ...
      logType: (() { final guardedValue = map['logType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AuditLogConfigLogTypeDatamigrationV1beta1.fromValue(guardedValue as String)); })(),
    );
  }
}
