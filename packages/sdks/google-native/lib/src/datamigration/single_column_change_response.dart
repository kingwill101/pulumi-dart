...
class SingleColumnChangeResponse {
  ...
  const SingleColumnChangeResponse({
    required this.array,
  ...
  factory SingleColumnChangeResponse.fromMap(Map<String, dynamic> map) {
    return SingleColumnChangeResponse(
      array: pulumi.Input.fromValue(map['array'] as bool),
      arrayLength: pulumi.Input.fromValue(map['arrayLength'] as int),
      autoGenerated: pulumi.Input.fromValue(map['autoGenerated'] as bool),
      ...
      fractionalSecondsPrecision: pulumi.Input.fromValue(map['fractionalSecondsPrecision'] as int),
      ...
      setValues: pulumi.Input.fromValue((map['setValues'] as List).cast<String>()),
      udt: pulumi.Input.fromValue(map['udt'] as bool),
    );
  }
}
