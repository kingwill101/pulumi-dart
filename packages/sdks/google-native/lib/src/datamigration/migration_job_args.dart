...
class MigrationJobArgs {
  ...
  factory MigrationJobArgs.fromMap(Map<String, dynamic> map) {
    return MigrationJobArgs(
      ...
      conversionWorkspace: (() {
        final guardedValue = map['conversionWorkspace'];
        if (guardedValue == null) return null;
      ...
      destinationDatabase: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DatabaseType.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      displayName: (() {
      ...
      dumpFlags: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DumpFlags.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      dumpPath: (() {
      ...
      state: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          MigrationJobState.fromValue(guardedValue as String),
        );
      })(),
      ...
      type: pulumi.Input.fromValue(
        MigrationJobType.fromValue(map['type']! as String),
      ),
      vpcPeeringConnectivity: (() {
