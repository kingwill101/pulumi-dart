...
class MigrationJobArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'state': ?pulumi.Input.mapOptionalInputValue<MigrationJobState, String>(state, (value) => value.wireValue),
      'staticIpConnectivity': ?staticIpConnectivity,
      'type': pulumi.Input.mapInputValue<MigrationJobType, String>(type, (value) => value.wireValue),
  ...
  factory MigrationJobArgs.fromMap(Map<String, dynamic> map) {
    return MigrationJobArgs(
      ...
      conversionWorkspace: (() { final guardedValue = map['conversionWorkspace']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConversionWorkspaceInfo.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      destination: pulumi.Input.fromValue(map['destination'] as String),
      destinationDatabase: (() { final guardedValue = map['destinationDatabase']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DatabaseType.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      displayName: (() { final guardedValue = map['displayName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      dumpFlags: (() { final guardedValue = map['dumpFlags']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DumpFlags.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      performanceConfig: (() { final guardedValue = map['performanceConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PerformanceConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      project: (() { final guardedValue = map['project']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      requestId: (() { final guardedValue = map['requestId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      reverseSshConnectivity: (() { final guardedValue = map['reverseSshConnectivity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ReverseSshConnectivity.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      source: pulumi.Input.fromValue(map['source'] as String),
      sourceDatabase: (() { final guardedValue = map['sourceDatabase']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DatabaseType.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      state: (() { final guardedValue = map['state']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MigrationJobState.fromValue(guardedValue as String)); })(),
      ...
      type: pulumi.Input.fromValue(MigrationJobType.fromValue(map['type']! as String)),
      vpcPeeringConnectivity: (() { final guardedValue = map['vpcPeeringConnectivity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VpcPeeringConnectivity.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
