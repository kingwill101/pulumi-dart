...
class MigrationJobArgs {
  ...
  MigrationJobArgs({
    pulumi.Output<String>? cmekKeyName,
    pulumi.Output<ConversionWorkspaceInfo>? conversionWorkspace,
    required pulumi.Output<String> destination,
    pulumi.Output<DatabaseType>? destinationDatabase,
    pulumi.Output<String>? displayName,
    pulumi.Output<DumpFlags>? dumpFlags,
    ...
    pulumi.Output<PerformanceConfig>? performanceConfig,
    pulumi.Output<String>? project,
    pulumi.Output<String>? requestId,
    pulumi.Output<ReverseSshConnectivity>? reverseSshConnectivity,
    required pulumi.Output<String> source,
    pulumi.Output<DatabaseType>? sourceDatabase,
    pulumi.Output<MigrationJobState>? state,
    pulumi.Output<Map<String, dynamic>>? staticIpConnectivity,
    required pulumi.Output<MigrationJobType> type,
    pulumi.Output<VpcPeeringConnectivity>? vpcPeeringConnectivity,
  }) :
  ...
  factory MigrationJobArgs.fromMap(Map<String, dynamic> map) {
    return MigrationJobArgs(
      cmekKeyName: map['cmekKeyName'] == null ? null : pulumi.Output.create<String>(map['cmekKeyName'] as String),
      conversionWorkspace: map['conversionWorkspace'] == null ? null : pulumi.Output.create<ConversionWorkspaceInfo>(ConversionWorkspaceInfo.fromMap((map['conversionWorkspace'] as Map).cast<String, dynamic>())),
      destination: pulumi.Output.create<String>(map['destination'] as String),
      destinationDatabase: map['destinationDatabase'] == null ? null : pulumi.Output.create<DatabaseType>(DatabaseType.fromMap((map['destinationDatabase'] as Map).cast<String, dynamic>())),
      displayName: map['displayName'] == null ? null : pulumi.Output.create<String>(map['displayName'] as String),
      dumpFlags: map['dumpFlags'] == null ? null : pulumi.Output.create<DumpFlags>(DumpFlags.fromMap((map['dumpFlags'] as Map).cast<String, dynamic>())),
      ...
      performanceConfig: map['performanceConfig'] == null ? null : pulumi.Output.create<PerformanceConfig>(PerformanceConfig.fromMap((map['performanceConfig'] as Map).cast<String, dynamic>())),
      project: map['project'] == null ? null : pulumi.Output.create<String>(map['project'] as String),
      requestId: map['requestId'] == null ? null : pulumi.Output.create<String>(map['requestId'] as String),
      reverseSshConnectivity: map['reverseSshConnectivity'] == null ? null : pulumi.Output.create<ReverseSshConnectivity>(ReverseSshConnectivity.fromMap((map['reverseSshConnectivity'] as Map).cast<String, dynamic>())),
      source: pulumi.Output.create<String>(map['source'] as String),
      sourceDatabase: map['sourceDatabase'] == null ? null : pulumi.Output.create<DatabaseType>(DatabaseType.fromMap((map['sourceDatabase'] as Map).cast<String, dynamic>())),
      state: map['state'] == null ? null : pulumi.Output.create<MigrationJobState>(MigrationJobState.fromValue(map['state'] as String)),
      ...
      type: pulumi.Output.create<MigrationJobType>(MigrationJobType.fromValue(map['type'] as String)),
      vpcPeeringConnectivity: map['vpcPeeringConnectivity'] == null ? null : pulumi.Output.create<VpcPeeringConnectivity>(VpcPeeringConnectivity.fromMap((map['vpcPeeringConnectivity'] as Map).cast<String, dynamic>())),
    );
  }
}
