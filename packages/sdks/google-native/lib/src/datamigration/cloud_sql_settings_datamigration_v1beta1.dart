...
class CloudSqlSettingsDatamigrationV1beta1 {
  ...
  final pulumi.Input<CloudSqlSettingsActivationPolicyDatamigrationV1beta1>?
  activationPolicy;
  ...
  final pulumi.Input<CloudSqlSettingsDataDiskTypeDatamigrationV1beta1>?
  dataDiskType;
  ...
  final pulumi.Input<CloudSqlSettingsDatabaseVersionDatamigrationV1beta1>?
  databaseVersion;
    ...
    return <String, dynamic>{
      'activationPolicy':
          ?pulumi.Input.mapOptionalInputValue<
            CloudSqlSettingsActivationPolicyDatamigrationV1beta1,
            String
      ...
      'dataDiskType':
          ?pulumi.Input.mapOptionalInputValue<
            CloudSqlSettingsDataDiskTypeDatamigrationV1beta1,
            String
          >(dataDiskType, (value) => value.wireValue),
      'databaseFlags': ?databaseFlags,
      'databaseVersion':
          ?pulumi.Input.mapOptionalInputValue<
            CloudSqlSettingsDatabaseVersionDatamigrationV1beta1,
            String
          >(databaseVersion, (value) => value.wireValue),
      'ipConfig':
          ?pulumi.Input.mapOptionalInputValue<
            SqlIpConfigDatamigrationV1beta1,
            Map<String, dynamic>
          >(ipConfig, (value) => value.toMap()),
  ...
  factory CloudSqlSettingsDatamigrationV1beta1.fromMap(
    ...
    return CloudSqlSettingsDatamigrationV1beta1(
      ...
      autoStorageIncrease: (() {
        final guardedValue = map['autoStorageIncrease'];
        if (guardedValue == null) return null;
      ...
      ipConfig: (() {
        final guardedValue = map['ipConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
