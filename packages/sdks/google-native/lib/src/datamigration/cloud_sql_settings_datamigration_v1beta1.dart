...
class CloudSqlSettingsDatamigrationV1beta1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'activationPolicy': ?pulumi.Input.mapOptionalInputValue<CloudSqlSettingsActivationPolicyDatamigrationV1beta1, String>(activationPolicy, (value) => value.value),
      'autoStorageIncrease': ?autoStorageIncrease,
      'dataDiskSizeGb': ?dataDiskSizeGb,
      'dataDiskType': ?pulumi.Input.mapOptionalInputValue<CloudSqlSettingsDataDiskTypeDatamigrationV1beta1, String>(dataDiskType, (value) => value.value),
      'databaseFlags': ?databaseFlags,
      'databaseVersion': ?pulumi.Input.mapOptionalInputValue<CloudSqlSettingsDatabaseVersionDatamigrationV1beta1, String>(databaseVersion, (value) => value.value),
