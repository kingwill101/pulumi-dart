...
class SingleColumnChange {
  ...
  factory SingleColumnChange.fromMap(Map<String, dynamic> map) {
    return SingleColumnChange(
      array: (() {
        final guardedValue = map['array'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      arrayLength: (() {
        final guardedValue = map['arrayLength'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      autoGenerated: (() {
        final guardedValue = map['autoGenerated'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      charset: (() {
      ...
      fractionalSecondsPrecision: (() {
        final guardedValue = map['fractionalSecondsPrecision'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      length: (() {
      ...
      setValues: (() {
        final guardedValue = map['setValues'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      udt: (() {
        final guardedValue = map['udt'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
    );
