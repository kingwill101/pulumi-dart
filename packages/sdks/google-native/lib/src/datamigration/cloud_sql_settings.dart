...
class CloudSqlSettings {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'edition':
          ?pulumi.Input.mapOptionalInputValue<CloudSqlSettingsEdition, String>(
            edition,
    ...
    return CloudSqlSettings(
      activationPolicy: (() {
        ...
        return pulumi.Input.fromValue(
          CloudSqlSettingsActivationPolicy.fromValue(guardedValue as String),
        );
      })(),
      autoStorageIncrease: (() {
      ...
      availabilityType: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CloudSqlSettingsAvailabilityType.fromValue(guardedValue as String),
        );
      })(),
      cmekKeyName: (() {
      ...
      dataDiskType: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CloudSqlSettingsDataDiskType.fromValue(guardedValue as String),
        );
      })(),
      databaseFlags: (() {
      ...
      databaseVersion: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CloudSqlSettingsDatabaseVersion.fromValue(guardedValue as String),
        );
      })(),
      edition: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CloudSqlSettingsEdition.fromValue(guardedValue as String),
        );
      })(),
      ipConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SqlIpConfig.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      rootPassword: (() {
