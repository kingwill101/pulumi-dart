...
/// {@template pulumi_datamigration_v1beta1_connection_profile_iam_binding_datamigration_v1beta1_args_doc}
/// The set of arguments for ConnectionProfileIamBinding.
/// {@endtemplate}
/// {@macro pulumi_datamigration_v1beta1_connection_profile_iam_binding_datamigration_v1beta1_args_doc}
class ConnectionProfileIamBindingDatamigrationV1beta1Args {
  ...
  /// Creates a new [ConnectionProfileIamBindingDatamigrationV1beta1Args].
  ...
  const ConnectionProfileIamBindingDatamigrationV1beta1Args({
    this.condition,
  ...
  factory ConnectionProfileIamBindingDatamigrationV1beta1Args.fromMap(Map<String, dynamic> map) {
    return ConnectionProfileIamBindingDatamigrationV1beta1Args(
