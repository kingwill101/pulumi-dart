...
/// {@template pulumi_datamigration_v1_conversion_workspace_iam_member_args_doc}
/// The set of arguments for ConversionWorkspaceIamMember.
/// {@endtemplate}
/// {@macro pulumi_datamigration_v1_conversion_workspace_iam_member_args_doc}
class ConversionWorkspaceIamMemberArgs {
  ...
  /// Creates a new [ConversionWorkspaceIamMemberArgs].
  ...
  const ConversionWorkspaceIamMemberArgs({
    this.condition,
  ...
  factory ConversionWorkspaceIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return ConversionWorkspaceIamMemberArgs(
