...
class ExprResponseDatamigrationV1beta1 {
  ...
  /// Creates a new [ExprResponseDatamigrationV1beta1].
  ...
  const ExprResponseDatamigrationV1beta1({
  ...
  factory ExprResponseDatamigrationV1beta1.fromMap(Map<String, dynamic> map) {
    return ExprResponseDatamigrationV1beta1(
