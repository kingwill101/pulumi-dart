...
/// {@template pulumi_datamigration_v1beta1_migration_job_iam_member_datamigration_v1beta1_args_doc}
/// The set of arguments for MigrationJobIamMember.
/// {@endtemplate}
/// {@macro pulumi_datamigration_v1beta1_migration_job_iam_member_datamigration_v1beta1_args_doc}
class MigrationJobIamMemberDatamigrationV1beta1Args {
  ...
  /// Creates a new [MigrationJobIamMemberDatamigrationV1beta1Args].
  ...
  const MigrationJobIamMemberDatamigrationV1beta1Args({
    this.condition,
  ...
  factory MigrationJobIamMemberDatamigrationV1beta1Args.fromMap(Map<String, dynamic> map) {
    return MigrationJobIamMemberDatamigrationV1beta1Args(
