...
/// {@template pulumi_datamigration_v1_connection_profile_iam_member_args_doc}
/// The set of arguments for ConnectionProfileIamMember.
/// {@endtemplate}
/// {@macro pulumi_datamigration_v1_connection_profile_iam_member_args_doc}
class ConnectionProfileIamMemberArgs {
  ...
  /// Creates a new [ConnectionProfileIamMemberArgs].
  ...
  const ConnectionProfileIamMemberArgs({
    this.condition,
  ...
  factory ConnectionProfileIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return ConnectionProfileIamMemberArgs(
