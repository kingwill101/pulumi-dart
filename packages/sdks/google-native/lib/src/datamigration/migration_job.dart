...
class MigrationJob extends pulumi.CustomResource {
  ...
  MigrationJob(
    ...
    this.conversionWorkspace = registerOutput<ConversionWorkspaceInfoResponse>('conversionWorkspace');
    this.createTime = registerOutput<String>('createTime');
    this.destination = registerOutput<String>('destination');
    this.destinationDatabase = registerOutput<DatabaseTypeResponse>('destinationDatabase');
    ...
    this.performanceConfig = registerOutput<PerformanceConfigResponse>('performanceConfig');
    this.phase = registerOutput<String>('phase');
    this.project = registerOutput<String>('project');
    this.requestId = registerOutput<String?>('requestId');
    this.reverseSshConnectivity = registerOutput<ReverseSshConnectivityResponse>('reverseSshConnectivity');
    this.source = registerOutput<String>('source');
    this.sourceDatabase = registerOutput<DatabaseTypeResponse>('sourceDatabase');
    this.state = registerOutput<String>('state');
    this.staticIpConnectivity = registerOutput<Map<String, dynamic>>('staticIpConnectivity');
    this.type = registerOutput<String>('type');
    this.updateTime = registerOutput<String>('updateTime');
    this.vpcPeeringConnectivity = registerOutput<VpcPeeringConnectivityResponse>('vpcPeeringConnectivity');
  }
}
