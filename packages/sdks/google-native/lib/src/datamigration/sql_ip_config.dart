...
class SqlIpConfig {
  ...
  factory SqlIpConfig.fromMap(Map<String, dynamic> map) {
    return SqlIpConfig(
      ...
      authorizedNetworks: (() { final guardedValue = map['authorizedNetworks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SqlAclEntry>(guardedValue, (value) => SqlAclEntry.fromMap((value as Map).cast<String, dynamic>()))); })(),
