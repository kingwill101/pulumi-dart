...
class ConnectionProfileArgs {
  ...
  ConnectionProfileArgs({
    pulumi.Output<AlloyDbConnectionProfile>? alloydb,
    pulumi.Output<CloudSqlConnectionProfile>? cloudsql,
    required pulumi.Output<String> connectionProfileId,
    pulumi.Output<String>? displayName,
    pulumi.Output<Map<String, String>>? labels,
    pulumi.Output<String>? location,
    pulumi.Output<MySqlConnectionProfile>? mysql,
    pulumi.Output<String>? name,
    pulumi.Output<OracleConnectionProfile>? oracle,
    pulumi.Output<PostgreSqlConnectionProfile>? postgresql,
    pulumi.Output<String>? project,
    pulumi.Output<ConnectionProfileProvider>? provider,
    pulumi.Output<String>? requestId,
    pulumi.Output<bool>? skipValidation,
    pulumi.Output<ConnectionProfileState>? state,
  }) :
      alloydb = pulumi.Input.asOptionalInput<AlloyDbConnectionProfile>(alloydb),
      cloudsql = pulumi.Input.asOptionalInput<CloudSqlConnectionProfile>(cloudsql),
      ...
      postgresql = pulumi.Input.asOptionalInput<PostgreSqlConnectionProfile>(postgresql),
      project = pulumi.Input.asOptionalInput<String>(project),
      provider = pulumi.Input.asOptionalInput<ConnectionProfileProvider>(provider),
  ...
  factory ConnectionProfileArgs.fromMap(Map<String, dynamic> map) {
    return ConnectionProfileArgs(
      alloydb: map['alloydb'] == null ? null : pulumi.Output.create<AlloyDbConnectionProfile>(AlloyDbConnectionProfile.fromMap((map['alloydb'] as Map).cast<String, dynamic>())),
      cloudsql: map['cloudsql'] == null ? null : pulumi.Output.create<CloudSqlConnectionProfile>(CloudSqlConnectionProfile.fromMap((map['cloudsql'] as Map).cast<String, dynamic>())),
      ...
      mysql: map['mysql'] == null ? null : pulumi.Output.create<MySqlConnectionProfile>(MySqlConnectionProfile.fromMap((map['mysql'] as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      oracle: map['oracle'] == null ? null : pulumi.Output.create<OracleConnectionProfile>(OracleConnectionProfile.fromMap((map['oracle'] as Map).cast<String, dynamic>())),
      postgresql: map['postgresql'] == null ? null : pulumi.Output.create<PostgreSqlConnectionProfile>(PostgreSqlConnectionProfile.fromMap((map['postgresql'] as Map).cast<String, dynamic>())),
      project: map['project'] == null ? null : pulumi.Output.create<String>(map['project'] as String),
      provider: map['provider'] == null ? null : pulumi.Output.create<ConnectionProfileProvider>(ConnectionProfileProvider.fromValue(map['provider'] as String)),
      requestId: map['requestId'] == null ? null : pulumi.Output.create<String>(map['requestId'] as String),
      skipValidation: map['skipValidation'] == null ? null : pulumi.Output.create<bool>(map['skipValidation'] as bool),
      state: map['state'] == null ? null : pulumi.Output.create<ConnectionProfileState>(ConnectionProfileState.fromValue(map['state'] as String)),
    );
  }
}
