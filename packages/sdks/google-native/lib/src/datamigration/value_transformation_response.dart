...
class ValueTransformationResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'applyHash':
          pulumi.Input.mapInputValue<ApplyHashResponse, Map<String, dynamic>>(
            applyHash,
            (value) => value.toMap(),
          ),
  ...
  factory ValueTransformationResponse.fromMap(Map<String, dynamic> map) {
    return ValueTransformationResponse(
      applyHash: pulumi.Input.fromValue(
        ApplyHashResponse.fromMap(
          (map['applyHash']! as Map).cast<String, dynamic>(),
        ),
      ),
      assignMaxValue: pulumi.Input.fromValue(
        (map['assignMaxValue']! as Map).cast<String, dynamic>(),
      ),
      assignMinValue: pulumi.Input.fromValue(
        (map['assignMinValue']! as Map).cast<String, dynamic>(),
      ),
      assignNull: pulumi.Input.fromValue(
        (map['assignNull']! as Map).cast<String, dynamic>(),
      ),
      assignSpecificValue: pulumi.Input.fromValue(
        AssignSpecificValueResponse.fromMap(
          (map['assignSpecificValue']! as Map).cast<String, dynamic>(),
        ),
      ),
      doubleComparison: pulumi.Input.fromValue(
        DoubleComparisonFilterResponse.fromMap(
          (map['doubleComparison']! as Map).cast<String, dynamic>(),
        ),
      ),
      intComparison: pulumi.Input.fromValue(
        IntComparisonFilterResponse.fromMap(
          (map['intComparison']! as Map).cast<String, dynamic>(),
        ),
      ),
      isNull: pulumi.Input.fromValue(
        (map['isNull']! as Map).cast<String, dynamic>(),
      ),
      roundScale: pulumi.Input.fromValue(
        RoundToScaleResponse.fromMap(
          (map['roundScale']! as Map).cast<String, dynamic>(),
        ),
      ),
      valueList: pulumi.Input.fromValue(
        ValueListFilterResponse.fromMap(
