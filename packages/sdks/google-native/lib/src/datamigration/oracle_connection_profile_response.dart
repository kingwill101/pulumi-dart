...
class OracleConnectionProfileResponse {
  ...
  final pulumi.Input<ForwardSshTunnelConnectivityResponse>
  ...
  factory OracleConnectionProfileResponse.fromMap(Map<String, dynamic> map) {
    return OracleConnectionProfileResponse(
      ...
      forwardSshConnectivity: pulumi.Input.fromValue(
        ForwardSshTunnelConnectivityResponse.fromMap(
      ...
      privateConnectivity: pulumi.Input.fromValue(
        PrivateConnectivityResponse.fromMap(
      ...
      staticServiceIpConnectivity: pulumi.Input.fromValue(
