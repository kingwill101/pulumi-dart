...
class ExprDatamigrationV1beta1 {
  ...
  /// Creates a new [ExprDatamigrationV1beta1].
  ...
  const ExprDatamigrationV1beta1({
    this.description,
    this.expression,
    this.location,
    this.title,
  ...
  factory ExprDatamigrationV1beta1.fromMap(Map<String, dynamic> map) {
    return ExprDatamigrationV1beta1(
