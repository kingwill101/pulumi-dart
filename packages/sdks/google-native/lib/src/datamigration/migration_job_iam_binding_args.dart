...
/// {@template pulumi_datamigration_v1_migration_job_iam_binding_args_doc}
/// The set of arguments for MigrationJobIamBinding.
/// {@endtemplate}
/// {@macro pulumi_datamigration_v1_migration_job_iam_binding_args_doc}
class MigrationJobIamBindingArgs {
  ...
  /// Creates a new [MigrationJobIamBindingArgs].
  ...
  const MigrationJobIamBindingArgs({
    this.condition,
  ...
  factory MigrationJobIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return MigrationJobIamBindingArgs(
