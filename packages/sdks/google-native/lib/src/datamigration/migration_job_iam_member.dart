...
import 'migration_job_iam_member_args.dart';

/// Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
class MigrationJobIamMember extends pulumi.CustomResource {
  ...
  /// Creates a new [MigrationJobIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [MigrationJobIamMember]. {@macro pulumi_datamigration_v1_migration_job_iam_member_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  MigrationJobIamMember(
    String name, {
    MigrationJobIamMemberArgs? args,
