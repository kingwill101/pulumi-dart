...
/// {@template pulumi_datamigration_v1beta1_migration_job_iam_binding_datamigration_v1beta1_args_doc}
/// The set of arguments for MigrationJobIamBinding.
/// {@endtemplate}
/// {@macro pulumi_datamigration_v1beta1_migration_job_iam_binding_datamigration_v1beta1_args_doc}
class MigrationJobIamBindingDatamigrationV1beta1Args {
  ...
  /// Creates a new [MigrationJobIamBindingDatamigrationV1beta1Args].
  ...
  const MigrationJobIamBindingDatamigrationV1beta1Args({
    this.condition,
  ...
  factory MigrationJobIamBindingDatamigrationV1beta1Args.fromMap(Map<String, dynamic> map) {
    return MigrationJobIamBindingDatamigrationV1beta1Args(
