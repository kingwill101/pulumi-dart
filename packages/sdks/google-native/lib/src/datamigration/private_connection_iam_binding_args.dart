...
/// {@template pulumi_datamigration_v1_private_connection_iam_binding_args_doc}
/// The set of arguments for PrivateConnectionIamBinding.
/// {@endtemplate}
/// {@macro pulumi_datamigration_v1_private_connection_iam_binding_args_doc}
class PrivateConnectionIamBindingArgs {
  ...
  /// Creates a new [PrivateConnectionIamBindingArgs].
  ...
  const PrivateConnectionIamBindingArgs({
    this.condition,
