...
/// {@template pulumi_datamigration_v1_connection_profile_iam_binding_args_doc}
/// The set of arguments for ConnectionProfileIamBinding.
/// {@endtemplate}
/// {@macro pulumi_datamigration_v1_connection_profile_iam_binding_args_doc}
class ConnectionProfileIamBindingArgs {
  ...
  /// Creates a new [ConnectionProfileIamBindingArgs].
  ...
  const ConnectionProfileIamBindingArgs({
    this.condition,
  ...
  factory ConnectionProfileIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return ConnectionProfileIamBindingArgs(
