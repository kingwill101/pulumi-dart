...
class PostgreSqlConnectionProfileResponse {
  ...
  final pulumi.Input<PrivateServiceConnectConnectivityResponse>
    ...
    return <String, dynamic>{
      ...
      'privateServiceConnectConnectivity':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(privateServiceConnectConnectivity, (value) => value.toMap()),
      'ssl':
  ...
  factory PostgreSqlConnectionProfileResponse.fromMap(
    ...
    return PostgreSqlConnectionProfileResponse(
      ...
      ssl: pulumi.Input.fromValue(
        SslConfigResponse.fromMap((map['ssl']! as Map).cast<String, dynamic>()),
      ),
      staticIpConnectivity: pulumi.Input.fromValue(
