...
/// {@template pulumi_datamigration_v1_conversion_workspace_iam_binding_args_doc}
/// The set of arguments for ConversionWorkspaceIamBinding.
/// {@endtemplate}
/// {@macro pulumi_datamigration_v1_conversion_workspace_iam_binding_args_doc}
class ConversionWorkspaceIamBindingArgs {
  ...
  /// Creates a new [ConversionWorkspaceIamBindingArgs].
  ...
  const ConversionWorkspaceIamBindingArgs({
    this.condition,
