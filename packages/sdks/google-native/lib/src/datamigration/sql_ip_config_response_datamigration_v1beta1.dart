...
class SqlIpConfigResponseDatamigrationV1beta1 {
  ...
  factory SqlIpConfigResponseDatamigrationV1beta1.fromMap(Map<String, dynamic> map) {
    return SqlIpConfigResponseDatamigrationV1beta1(
      authorizedNetworks: (pulumi.Input.decodeList<SqlAclEntryResponseDatamigrationV1beta1>(map['authorizedNetworks'], (value) => SqlAclEntryResponseDatamigrationV1beta1.fromMap((value as Map).cast<String, dynamic>()))).input(),
