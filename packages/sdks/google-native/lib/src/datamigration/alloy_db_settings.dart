...
class AlloyDbSettings {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'initialUser':
          pulumi.Input.mapInputValue<UserPassword, Map<String, dynamic>>(
            initialUser,
            (value) => value.toMap(),
          ),
      'labels': ?labels,
    ...
    return AlloyDbSettings(
      databaseVersion: (() {
        ...
        return pulumi.Input.fromValue(
          AlloyDbSettingsDatabaseVersion.fromValue(guardedValue as String),
        );
      })(),
      encryptionConfig: (() {
      ...
      primaryInstanceSettings: (() {
        final guardedValue = map['primaryInstanceSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PrimaryInstanceSettings.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
