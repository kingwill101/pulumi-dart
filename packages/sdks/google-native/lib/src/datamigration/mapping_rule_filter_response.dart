...
class MappingRuleFilterResponse {
  ...
  factory MappingRuleFilterResponse.fromMap(Map<String, dynamic> map) {
    return MappingRuleFilterResponse(
      ...
      entityNameContains: pulumi.Input.fromValue(map['entityNameContains'] as String),
      entityNamePrefix: pulumi.Input.fromValue(map['entityNamePrefix'] as String),
      entityNameSuffix: pulumi.Input.fromValue(map['entityNameSuffix'] as String),
