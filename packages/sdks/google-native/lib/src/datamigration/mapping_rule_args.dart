...
class MappingRuleArgs {
  ...
  MappingRuleArgs({
    pulumi.Output<ConditionalColumnSetValue>? conditionalColumnSetValue,
    required pulumi.Output<String> conversionWorkspaceId,
    pulumi.Output<ConvertRowIdToColumn>? convertRowidColumn,
    pulumi.Output<String>? displayName,
    pulumi.Output<EntityMove>? entityMove,
    required pulumi.Output<MappingRuleFilter> filter,
    pulumi.Output<FilterTableColumns>? filterTableColumns,
    pulumi.Output<String>? location,
    required pulumi.Output<String> mappingRuleId,
    pulumi.Output<MultiColumnDatatypeChange>? multiColumnDataTypeChange,
    pulumi.Output<MultiEntityRename>? multiEntityRename,
    pulumi.Output<String>? name,
    pulumi.Output<String>? project,
    pulumi.Output<String>? requestId,
    required pulumi.Output<String> ruleOrder,
    required pulumi.Output<MappingRuleRuleScope> ruleScope,
    pulumi.Output<SetTablePrimaryKey>? setTablePrimaryKey,
    pulumi.Output<SingleColumnChange>? singleColumnChange,
    pulumi.Output<SingleEntityRename>? singleEntityRename,
    pulumi.Output<SinglePackageChange>? singlePackageChange,
    pulumi.Output<SourceSqlChange>? sourceSqlChange,
    pulumi.Output<MappingRuleState>? state,
  }) :
      conditionalColumnSetValue = pulumi.Input.asOptionalInput<ConditionalColumnSetValue>(conditionalColumnSetValue),
      conversionWorkspaceId = pulumi.Input.asInput<String>(conversionWorkspaceId),
      convertRowidColumn = pulumi.Input.asOptionalInput<ConvertRowIdToColumn>(convertRowidColumn),
      ...
      filterTableColumns = pulumi.Input.asOptionalInput<FilterTableColumns>(filterTableColumns),
      location = pulumi.Input.asOptionalInput<String>(location),
      mappingRuleId = pulumi.Input.asInput<String>(mappingRuleId),
      multiColumnDataTypeChange = pulumi.Input.asOptionalInput<MultiColumnDatatypeChange>(multiColumnDataTypeChange),
      multiEntityRename = pulumi.Input.asOptionalInput<MultiEntityRename>(multiEntityRename),
      ...
      setTablePrimaryKey = pulumi.Input.asOptionalInput<SetTablePrimaryKey>(setTablePrimaryKey),
      singleColumnChange = pulumi.Input.asOptionalInput<SingleColumnChange>(singleColumnChange),
      singleEntityRename = pulumi.Input.asOptionalInput<SingleEntityRename>(singleEntityRename),
      singlePackageChange = pulumi.Input.asOptionalInput<SinglePackageChange>(singlePackageChange),
      sourceSqlChange = pulumi.Input.asOptionalInput<SourceSqlChange>(sourceSqlChange),
  ...
  factory MappingRuleArgs.fromMap(Map<String, dynamic> map) {
    return MappingRuleArgs(
      conditionalColumnSetValue: map['conditionalColumnSetValue'] == null ? null : pulumi.Output.create<ConditionalColumnSetValue>(ConditionalColumnSetValue.fromMap((map['conditionalColumnSetValue'] as Map).cast<String, dynamic>())),
      conversionWorkspaceId: pulumi.Output.create<String>(map['conversionWorkspaceId'] as String),
      convertRowidColumn: map['convertRowidColumn'] == null ? null : pulumi.Output.create<ConvertRowIdToColumn>(ConvertRowIdToColumn.fromMap((map['convertRowidColumn'] as Map).cast<String, dynamic>())),
      displayName: map['displayName'] == null ? null : pulumi.Output.create<String>(map['displayName'] as String),
      entityMove: map['entityMove'] == null ? null : pulumi.Output.create<EntityMove>(EntityMove.fromMap((map['entityMove'] as Map).cast<String, dynamic>())),
      filter: pulumi.Output.create<MappingRuleFilter>(MappingRuleFilter.fromMap((map['filter'] as Map).cast<String, dynamic>())),
      filterTableColumns: map['filterTableColumns'] == null ? null : pulumi.Output.create<FilterTableColumns>(FilterTableColumns.fromMap((map['filterTableColumns'] as Map).cast<String, dynamic>())),
      location: map['location'] == null ? null : pulumi.Output.create<String>(map['location'] as String),
      mappingRuleId: pulumi.Output.create<String>(map['mappingRuleId'] as String),
      multiColumnDataTypeChange: map['multiColumnDataTypeChange'] == null ? null : pulumi.Output.create<MultiColumnDatatypeChange>(MultiColumnDatatypeChange.fromMap((map['multiColumnDataTypeChange'] as Map).cast<String, dynamic>())),
      multiEntityRename: map['multiEntityRename'] == null ? null : pulumi.Output.create<MultiEntityRename>(MultiEntityRename.fromMap((map['multiEntityRename'] as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      project: map['project'] == null ? null : pulumi.Output.create<String>(map['project'] as String),
      requestId: map['requestId'] == null ? null : pulumi.Output.create<String>(map['requestId'] as String),
      ruleOrder: pulumi.Output.create<String>(map['ruleOrder'] as String),
      ruleScope: pulumi.Output.create<MappingRuleRuleScope>(MappingRuleRuleScope.fromValue(map['ruleScope'] as String)),
      setTablePrimaryKey: map['setTablePrimaryKey'] == null ? null : pulumi.Output.create<SetTablePrimaryKey>(SetTablePrimaryKey.fromMap((map['setTablePrimaryKey'] as Map).cast<String, dynamic>())),
      singleColumnChange: map['singleColumnChange'] == null ? null : pulumi.Output.create<SingleColumnChange>(SingleColumnChange.fromMap((map['singleColumnChange'] as Map).cast<String, dynamic>())),
      singleEntityRename: map['singleEntityRename'] == null ? null : pulumi.Output.create<SingleEntityRename>(SingleEntityRename.fromMap((map['singleEntityRename'] as Map).cast<String, dynamic>())),
      singlePackageChange: map['singlePackageChange'] == null ? null : pulumi.Output.create<SinglePackageChange>(SinglePackageChange.fromMap((map['singlePackageChange'] as Map).cast<String, dynamic>())),
      sourceSqlChange: map['sourceSqlChange'] == null ? null : pulumi.Output.create<SourceSqlChange>(SourceSqlChange.fromMap((map['sourceSqlChange'] as Map).cast<String, dynamic>())),
      state: map['state'] == null ? null : pulumi.Output.create<MappingRuleState>(MappingRuleState.fromValue(map['state'] as String)),
    );
  }
}
