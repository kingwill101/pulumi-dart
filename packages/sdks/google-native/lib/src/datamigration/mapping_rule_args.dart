...
class MappingRuleArgs {
  ...
  factory MappingRuleArgs.fromMap(Map<String, dynamic> map) {
    return MappingRuleArgs(
      conditionalColumnSetValue: (() {
        final guardedValue = map['conditionalColumnSetValue'];
      ...
      convertRowidColumn: (() {
        final guardedValue = map['convertRowidColumn'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      entityMove: (() {
        final guardedValue = map['entityMove'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          EntityMove.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      filter: pulumi.Input.fromValue(
        MappingRuleFilter.fromMap(
          (map['filter']! as Map).cast<String, dynamic>(),
        ),
      ),
      filterTableColumns: (() {
        final guardedValue = map['filterTableColumns'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      multiColumnDataTypeChange: (() {
        final guardedValue = map['multiColumnDataTypeChange'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      multiEntityRename: (() {
        final guardedValue = map['multiEntityRename'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      ruleScope: pulumi.Input.fromValue(
        MappingRuleRuleScope.fromValue(map['ruleScope']! as String),
      ),
      setTablePrimaryKey: (() {
        final guardedValue = map['setTablePrimaryKey'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      singleColumnChange: (() {
        final guardedValue = map['singleColumnChange'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      singleEntityRename: (() {
        final guardedValue = map['singleEntityRename'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      singlePackageChange: (() {
        final guardedValue = map['singlePackageChange'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      sourceSqlChange: (() {
        final guardedValue = map['sourceSqlChange'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      state: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          MappingRuleState.fromValue(guardedValue as String),
        );
      })(),
    );
  }
