...
class ValueTransformation {
  ...
  factory ValueTransformation.fromMap(Map<String, dynamic> map) {
    return ValueTransformation(
      applyHash: (() { final guardedValue = map['applyHash']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ApplyHash.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      assignMaxValue: (() { final guardedValue = map['assignMaxValue']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, dynamic>()); })(),
      assignMinValue: (() { final guardedValue = map['assignMinValue']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, dynamic>()); })(),
      assignNull: (() { final guardedValue = map['assignNull']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, dynamic>()); })(),
      assignSpecificValue: (() { final guardedValue = map['assignSpecificValue']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AssignSpecificValue.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      doubleComparison: (() { final guardedValue = map['doubleComparison']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DoubleComparisonFilter.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      intComparison: (() { final guardedValue = map['intComparison']; if (guardedValue == null) return null; return pulumi.Input.fromValue(IntComparisonFilter.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      isNull: (() { final guardedValue = map['isNull']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, dynamic>()); })(),
      roundScale: (() { final guardedValue = map['roundScale']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RoundToScale.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      valueList: (() { final guardedValue = map['valueList']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ValueListFilter.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
