...
class MultiEntityRename {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'sourceNameTransformation': ?pulumi.Input.mapOptionalInputValue<MultiEntityRenameSourceNameTransformation, String>(sourceNameTransformation, (value) => value.value),
    };
  }
