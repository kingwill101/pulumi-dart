...
class MultiEntityRename {
  ...
  final pulumi.Input<MultiEntityRenameSourceNameTransformation>?
    ...
    return <String, dynamic>{
      ...
      'sourceNameTransformation':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(sourceNameTransformation, (value) => value.wireValue),
    };
  }
  ...
  factory MultiEntityRename.fromMap(Map<String, dynamic> map) {
    return MultiEntityRename(
      newNamePattern: (() {
        final guardedValue = map['newNamePattern'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      sourceNameTransformation: (() {
        final guardedValue = map['sourceNameTransformation'];
        if (guardedValue == null) return null;
