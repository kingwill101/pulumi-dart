...
class MultiColumnDatatypeChange {
  ...
  factory MultiColumnDatatypeChange.fromMap(Map<String, dynamic> map) {
    return MultiColumnDatatypeChange(
      ...
      overrideFractionalSecondsPrecision: (() { final guardedValue = map['overrideFractionalSecondsPrecision']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      overrideLength: (() { final guardedValue = map['overrideLength']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      overridePrecision: (() { final guardedValue = map['overridePrecision']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      overrideScale: (() { final guardedValue = map['overrideScale']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      sourceDataTypeFilter: pulumi.Input.fromValue(map['sourceDataTypeFilter'] as String),
      sourceNumericFilter: (() { final guardedValue = map['sourceNumericFilter']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SourceNumericFilter.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      sourceTextFilter: (() { final guardedValue = map['sourceTextFilter']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SourceTextFilter.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
