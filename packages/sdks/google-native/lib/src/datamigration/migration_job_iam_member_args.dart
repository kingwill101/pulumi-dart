...
/// {@template pulumi_datamigration_v1_migration_job_iam_member_args_doc}
/// The set of arguments for MigrationJobIamMember.
/// {@endtemplate}
/// {@macro pulumi_datamigration_v1_migration_job_iam_member_args_doc}
class MigrationJobIamMemberArgs {
  ...
  /// Creates a new [MigrationJobIamMemberArgs].
  ...
  const MigrationJobIamMemberArgs({
    this.condition,
  ...
  factory MigrationJobIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return MigrationJobIamMemberArgs(
