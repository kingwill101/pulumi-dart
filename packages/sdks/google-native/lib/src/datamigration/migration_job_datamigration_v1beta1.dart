...
class MigrationJobDatamigrationV1beta1 extends pulumi.CustomResource {
  ...
  MigrationJobDatamigrationV1beta1(
    ...
    this.destinationDatabase = registerOutput<DatabaseTypeResponseDatamigrationV1beta1>('destinationDatabase');
    ...
    this.reverseSshConnectivity = registerOutput<ReverseSshConnectivityResponseDatamigrationV1beta1>('reverseSshConnectivity');
    this.source = registerOutput<String>('source');
    this.sourceDatabase = registerOutput<DatabaseTypeResponseDatamigrationV1beta1>('sourceDatabase');
    this.state = registerOutput<String>('state');
    this.staticIpConnectivity = registerOutput<Map<String, dynamic>>('staticIpConnectivity');
    this.type = registerOutput<String>('type');
    this.updateTime = registerOutput<String>('updateTime');
    this.vpcPeeringConnectivity = registerOutput<VpcPeeringConnectivityResponseDatamigrationV1beta1>('vpcPeeringConnectivity');
  }
}
