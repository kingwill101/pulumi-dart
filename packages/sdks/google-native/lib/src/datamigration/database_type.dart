...
class DatabaseType {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'engine': ?pulumi.Input.mapOptionalInputValue<DatabaseTypeEngine, String>(
        engine,
        (value) => value.wireValue,
      ),
      'provider':
          ?pulumi.Input.mapOptionalInputValue<DatabaseTypeProvider, String>(
            provider,
            (value) => value.wireValue,
          ),
    };
    ...
    return DatabaseType(
      engine: (() {
        ...
        return pulumi.Input.fromValue(
          DatabaseTypeEngine.fromValue(guardedValue as String),
        );
      })(),
      provider: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DatabaseTypeProvider.fromValue(guardedValue as String),
        );
      })(),
    );
  }
