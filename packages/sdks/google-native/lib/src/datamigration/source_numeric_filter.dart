...
class SourceNumericFilter {
  ...
  final pulumi.Input<SourceNumericFilterNumericFilterOption>
  numericFilterOption;
    ...
    return <String, dynamic>{
      'numericFilterOption':
          pulumi.Input.mapInputValue<
            ...
            String
          >(numericFilterOption, (value) => value.wireValue),
  ...
  factory SourceNumericFilter.fromMap(Map<String, dynamic> map) {
    return SourceNumericFilter(
      numericFilterOption: pulumi.Input.fromValue(
        SourceNumericFilterNumericFilterOption.fromValue(
          map['numericFilterOption']! as String,
        ),
      ),
      sourceMaxPrecisionFilter: (() {
        final guardedValue = map['sourceMaxPrecisionFilter'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      sourceMaxScaleFilter: (() {
        final guardedValue = map['sourceMaxScaleFilter'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      sourceMinPrecisionFilter: (() {
        final guardedValue = map['sourceMinPrecisionFilter'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      sourceMinScaleFilter: (() {
        final guardedValue = map['sourceMinScaleFilter'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
    );
