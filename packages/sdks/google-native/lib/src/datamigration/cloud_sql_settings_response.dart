...
class CloudSqlSettingsResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'edition': edition,
      'ipConfig': pulumi.Input.mapInputValue<SqlIpConfigResponse, Map<String, dynamic>>(ipConfig, (value) => value.toMap()),
  ...
  factory CloudSqlSettingsResponse.fromMap(Map<String, dynamic> map) {
    return CloudSqlSettingsResponse(
      ...
      autoStorageIncrease: pulumi.Input.fromValue(map['autoStorageIncrease'] as bool),
      ...
      databaseFlags: pulumi.Input.fromValue((map['databaseFlags'] as Map).cast<String, String>()),
      databaseVersion: pulumi.Input.fromValue(map['databaseVersion'] as String),
      edition: pulumi.Input.fromValue(map['edition'] as String),
      ipConfig: pulumi.Input.fromValue(SqlIpConfigResponse.fromMap((map['ipConfig']! as Map).cast<String, dynamic>())),
