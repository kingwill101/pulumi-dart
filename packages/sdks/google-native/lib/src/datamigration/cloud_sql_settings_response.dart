...
class CloudSqlSettingsResponse {
  ...
  factory CloudSqlSettingsResponse.fromMap(Map<String, dynamic> map) {
    return CloudSqlSettingsResponse(
      ...
      dataCacheConfig: (DataCacheConfigResponse.fromMap((map['dataCacheConfig'] as Map).cast<String, dynamic>())).input(),
      ...
      ipConfig: (SqlIpConfigResponse.fromMap((map['ipConfig'] as Map).cast<String, dynamic>())).input(),
