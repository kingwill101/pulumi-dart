...
/// {@template pulumi_datamigration_v1_private_connection_iam_member_args_doc}
/// The set of arguments for PrivateConnectionIamMember.
/// {@endtemplate}
/// {@macro pulumi_datamigration_v1_private_connection_iam_member_args_doc}
class PrivateConnectionIamMemberArgs {
  ...
  /// Creates a new [PrivateConnectionIamMemberArgs].
  ...
  const PrivateConnectionIamMemberArgs({
    this.condition,
  ...
  factory PrivateConnectionIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return PrivateConnectionIamMemberArgs(
