...
class GetConnectionProfileDatamigrationV1beta1Result {
  ...
  /// Creates a new [GetConnectionProfileDatamigrationV1beta1Result].
  ...
  factory GetConnectionProfileDatamigrationV1beta1Result.fromMap(Map<String, dynamic> map) {
    return GetConnectionProfileDatamigrationV1beta1Result(
      cloudsql: CloudSqlConnectionProfileResponseDatamigrationV1beta1.fromMap((map['cloudsql']! as Map).cast<String, dynamic>()),
      createTime: map['createTime'] as String,
      displayName: map['displayName'] as String,
      error: StatusResponseDatamigrationV1beta1.fromMap((map['error']! as Map).cast<String, dynamic>()),
      labels: (map['labels'] as Map).cast<String, String>(),
      mysql: MySqlConnectionProfileResponseDatamigrationV1beta1.fromMap((map['mysql']! as Map).cast<String, dynamic>()),
