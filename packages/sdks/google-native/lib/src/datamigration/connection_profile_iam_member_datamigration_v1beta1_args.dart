...
/// {@template pulumi_datamigration_v1beta1_connection_profile_iam_member_datamigration_v1beta1_args_doc}
/// The set of arguments for ConnectionProfileIamMember.
/// {@endtemplate}
/// {@macro pulumi_datamigration_v1beta1_connection_profile_iam_member_datamigration_v1beta1_args_doc}
class ConnectionProfileIamMemberDatamigrationV1beta1Args {
  ...
  /// Creates a new [ConnectionProfileIamMemberDatamigrationV1beta1Args].
  ...
  const ConnectionProfileIamMemberDatamigrationV1beta1Args({
    this.condition,
  ...
  factory ConnectionProfileIamMemberDatamigrationV1beta1Args.fromMap(Map<String, dynamic> map) {
    return ConnectionProfileIamMemberDatamigrationV1beta1Args(
