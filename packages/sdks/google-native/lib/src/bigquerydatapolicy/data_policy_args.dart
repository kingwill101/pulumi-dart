...
class DataPolicyArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'dataPolicyType': ?pulumi.Input.mapOptionalInputValue<DataPolicyDataPolicyType, String>(dataPolicyType, (value) => value.wireValue),
      'location': ?location,
      'policyTag': ?policyTag,
      'project': ?project,
    };
  ...
  factory DataPolicyArgs.fromMap(Map<String, dynamic> map) {
    return DataPolicyArgs(
      dataMaskingPolicy: (() { final guardedValue = map['dataMaskingPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DataMaskingPolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      dataPolicyType: (() { final guardedValue = map['dataPolicyType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DataPolicyDataPolicyType.fromValue(guardedValue as String)); })(),
