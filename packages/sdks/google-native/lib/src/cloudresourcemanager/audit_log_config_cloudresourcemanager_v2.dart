...
class AuditLogConfigCloudresourcemanagerV2 {
  ...
  const AuditLogConfigCloudresourcemanagerV2({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'logType': ?pulumi.Input.mapOptionalInputValue<AuditLogConfigLogTypeCloudresourcemanagerV2, String>(logType, (value) => value.wireValue),
    };
  }
  ...
  factory AuditLogConfigCloudresourcemanagerV2.fromMap(Map<String, dynamic> map) {
    return AuditLogConfigCloudresourcemanagerV2(
      ...
      logType: (() { final guardedValue = map['logType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AuditLogConfigLogTypeCloudresourcemanagerV2.fromValue(guardedValue as String)); })(),
    );
  }
}
