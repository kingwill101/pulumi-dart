...
import 'project_iam_binding_args.dart';
...
class ProjectIamBinding extends pulumi.CustomResource {
  ...
  /// Creates a new [ProjectIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ProjectIamBinding]. {@macro pulumi_cloudresourcemanager_v1_project_iam_binding_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  ProjectIamBinding(
    String name, {
    ProjectIamBindingArgs? args,
