...
/// {@template pulumi_cloudresourcemanager_v3_organization_iam_member_cloudresourcemanager_v3_args_doc}
/// The set of arguments for OrganizationIamMember.
/// {@endtemplate}
/// {@macro pulumi_cloudresourcemanager_v3_organization_iam_member_cloudresourcemanager_v3_args_doc}
class OrganizationIamMemberCloudresourcemanagerV3Args {
  ...
  /// Creates a new [OrganizationIamMemberCloudresourcemanagerV3Args].
  ...
  const OrganizationIamMemberCloudresourcemanagerV3Args({
    this.condition,
  ...
  factory OrganizationIamMemberCloudresourcemanagerV3Args.fromMap(Map<String, dynamic> map) {
    return OrganizationIamMemberCloudresourcemanagerV3Args(
