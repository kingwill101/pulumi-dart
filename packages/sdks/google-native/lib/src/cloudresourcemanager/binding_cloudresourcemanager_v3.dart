...
class BindingCloudresourcemanagerV3 {
  ...
  final ExprCloudresourcemanagerV3? condition;
  ...
  factory BindingCloudresourcemanagerV3.fromMap(Map<String, dynamic> map) {
    return BindingCloudresourcemanagerV3(
      condition: map['condition'] == null ? null : ExprCloudresourcemanagerV3.fromMap((map['condition'] as Map).cast<String, dynamic>()),
