...
/// {@template pulumi_cloudresourcemanager_v2_folder_iam_binding_args_doc}
/// The set of arguments for FolderIamBinding.
/// {@endtemplate}
/// {@macro pulumi_cloudresourcemanager_v2_folder_iam_binding_args_doc}
class FolderIamBindingArgs {
  ...
  /// Creates a new [FolderIamBindingArgs].
  ...
  factory FolderIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return FolderIamBindingArgs(
