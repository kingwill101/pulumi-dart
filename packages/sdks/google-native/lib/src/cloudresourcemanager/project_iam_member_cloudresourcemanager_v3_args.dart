...
/// {@template pulumi_cloudresourcemanager_v3_project_iam_member_cloudresourcemanager_v3_args_doc}
/// The set of arguments for ProjectIamMember.
/// {@endtemplate}
/// {@macro pulumi_cloudresourcemanager_v3_project_iam_member_cloudresourcemanager_v3_args_doc}
class ProjectIamMemberCloudresourcemanagerV3Args {
  ...
  /// Creates a new [ProjectIamMemberCloudresourcemanagerV3Args].
  ...
  const ProjectIamMemberCloudresourcemanagerV3Args({
    this.condition,
  ...
  factory ProjectIamMemberCloudresourcemanagerV3Args.fromMap(Map<String, dynamic> map) {
    return ProjectIamMemberCloudresourcemanagerV3Args(
