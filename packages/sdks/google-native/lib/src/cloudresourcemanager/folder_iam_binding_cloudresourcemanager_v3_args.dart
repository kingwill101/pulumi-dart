...
/// {@template pulumi_cloudresourcemanager_v3_folder_iam_binding_cloudresourcemanager_v3_args_doc}
/// The set of arguments for FolderIamBinding.
/// {@endtemplate}
/// {@macro pulumi_cloudresourcemanager_v3_folder_iam_binding_cloudresourcemanager_v3_args_doc}
class FolderIamBindingCloudresourcemanagerV3Args {
  ...
  /// Creates a new [FolderIamBindingCloudresourcemanagerV3Args].
  ...
  const FolderIamBindingCloudresourcemanagerV3Args({
    this.condition,
  ...
  factory FolderIamBindingCloudresourcemanagerV3Args.fromMap(Map<String, dynamic> map) {
    return FolderIamBindingCloudresourcemanagerV3Args(
