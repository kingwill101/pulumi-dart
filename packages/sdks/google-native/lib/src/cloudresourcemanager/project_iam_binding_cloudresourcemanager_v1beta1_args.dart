...
/// {@template pulumi_cloudresourcemanager_v1beta1_project_iam_binding_cloudresourcemanager_v1beta1_args_doc}
/// The set of arguments for ProjectIamBinding.
/// {@endtemplate}
/// {@macro pulumi_cloudresourcemanager_v1beta1_project_iam_binding_cloudresourcemanager_v1beta1_args_doc}
class ProjectIamBindingCloudresourcemanagerV1beta1Args {
  ...
  /// Creates a new [ProjectIamBindingCloudresourcemanagerV1beta1Args].
  ...
  const ProjectIamBindingCloudresourcemanagerV1beta1Args({
    this.condition,
  ...
  factory ProjectIamBindingCloudresourcemanagerV1beta1Args.fromMap(Map<String, dynamic> map) {
    return ProjectIamBindingCloudresourcemanagerV1beta1Args(
