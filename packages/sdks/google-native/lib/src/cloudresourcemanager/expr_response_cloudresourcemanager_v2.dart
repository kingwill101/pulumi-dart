...
class ExprResponseCloudresourcemanagerV2 {
  ...
  /// Creates a new [ExprResponseCloudresourcemanagerV2].
  ...
  const ExprResponseCloudresourcemanagerV2({
  ...
  factory ExprResponseCloudresourcemanagerV2.fromMap(Map<String, dynamic> map) {
    return ExprResponseCloudresourcemanagerV2(
