...
/// {@template pulumi_cloudresourcemanager_v1beta1_organization_iam_member_cloudresourcemanager_v1beta1_args_doc}
/// The set of arguments for OrganizationIamMember.
/// {@endtemplate}
/// {@macro pulumi_cloudresourcemanager_v1beta1_organization_iam_member_cloudresourcemanager_v1beta1_args_doc}
class OrganizationIamMemberCloudresourcemanagerV1beta1Args {
  ...
  /// Creates a new [OrganizationIamMemberCloudresourcemanagerV1beta1Args].
  ...
  const OrganizationIamMemberCloudresourcemanagerV1beta1Args({
    this.condition,
  ...
  factory OrganizationIamMemberCloudresourcemanagerV1beta1Args.fromMap(Map<String, dynamic> map) {
    return OrganizationIamMemberCloudresourcemanagerV1beta1Args(
