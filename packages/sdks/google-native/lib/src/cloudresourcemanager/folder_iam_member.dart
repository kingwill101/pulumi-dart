...
import 'folder_iam_member_args.dart';
...
class FolderIamMember extends pulumi.CustomResource {
  ...
  /// Creates a new [FolderIamMember].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [FolderIamMember]. {@macro pulumi_cloudresourcemanager_v2_folder_iam_member_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  FolderIamMember(
    String name, {
    FolderIamMemberArgs? args,
