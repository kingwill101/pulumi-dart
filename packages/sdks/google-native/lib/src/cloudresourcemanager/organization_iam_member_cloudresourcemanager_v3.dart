...
import 'organization_iam_member_cloudresourcemanager_v3_args.dart';
...
class OrganizationIamMemberCloudresourcemanagerV3 extends pulumi.CustomResource {
  ...
  /// Creates a new [OrganizationIamMemberCloudresourcemanagerV3].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [OrganizationIamMemberCloudresourcemanagerV3]. {@macro pulumi_cloudresourcemanager_v3_organization_iam_member_cloudresourcemanager_v3_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  OrganizationIamMemberCloudresourcemanagerV3(
    String name, {
    OrganizationIamMemberCloudresourcemanagerV3Args? args,
