...
/// {@template pulumi_cloudresourcemanager_v1_project_iam_member_args_doc}
/// The set of arguments for ProjectIamMember.
/// {@endtemplate}
/// {@macro pulumi_cloudresourcemanager_v1_project_iam_member_args_doc}
class ProjectIamMemberArgs {
  ...
  /// Creates a new [ProjectIamMemberArgs].
  ...
  factory ProjectIamMemberArgs.fromMap(Map<String, dynamic> map) {
    return ProjectIamMemberArgs(
