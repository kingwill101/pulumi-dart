...
class ExprResponseCloudresourcemanagerV2beta1 {
  ...
  /// Creates a new [ExprResponseCloudresourcemanagerV2beta1].
  ...
  const ExprResponseCloudresourcemanagerV2beta1({
  ...
  factory ExprResponseCloudresourcemanagerV2beta1.fromMap(Map<String, dynamic> map) {
    return ExprResponseCloudresourcemanagerV2beta1(
