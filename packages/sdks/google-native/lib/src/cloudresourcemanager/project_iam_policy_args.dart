...
/// {@template pulumi_cloudresourcemanager_v1_project_iam_policy_args_doc}
/// The set of arguments for ProjectIamPolicy.
/// {@endtemplate}
/// {@macro pulumi_cloudresourcemanager_v1_project_iam_policy_args_doc}
class ProjectIamPolicyArgs {
  ...
  /// Creates a new [ProjectIamPolicyArgs].
  ...
  factory ProjectIamPolicyArgs.fromMap(Map<String, dynamic> map) {
    return ProjectIamPolicyArgs(
      auditConfigs: (() {
