...
class ExprResponseCloudresourcemanagerV3 {
  ...
  /// Creates a new [ExprResponseCloudresourcemanagerV3].
  ...
  const ExprResponseCloudresourcemanagerV3({
  ...
  factory ExprResponseCloudresourcemanagerV3.fromMap(Map<String, dynamic> map) {
    return ExprResponseCloudresourcemanagerV3(
