...
/// {@template pulumi_cloudresourcemanager_v1_organization_iam_binding_args_doc}
/// The set of arguments for OrganizationIamBinding.
/// {@endtemplate}
/// {@macro pulumi_cloudresourcemanager_v1_organization_iam_binding_args_doc}
class OrganizationIamBindingArgs {
  ...
  /// Creates a new [OrganizationIamBindingArgs].
  ...
  const OrganizationIamBindingArgs({
    this.condition,
  ...
  factory OrganizationIamBindingArgs.fromMap(Map<String, dynamic> map) {
    return OrganizationIamBindingArgs(
