...
import 'organization_iam_binding_cloudresourcemanager_v3_args.dart';
...
class OrganizationIamBindingCloudresourcemanagerV3 extends pulumi.CustomResource {
  ...
  /// Creates a new [OrganizationIamBindingCloudresourcemanagerV3].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [OrganizationIamBindingCloudresourcemanagerV3]. {@macro pulumi_cloudresourcemanager_v3_organization_iam_binding_cloudresourcemanager_v3_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  OrganizationIamBindingCloudresourcemanagerV3(
    String name, {
    OrganizationIamBindingCloudresourcemanagerV3Args? args,
