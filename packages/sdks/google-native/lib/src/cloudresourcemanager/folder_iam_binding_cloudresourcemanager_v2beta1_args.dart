...
/// {@template pulumi_cloudresourcemanager_v2beta1_folder_iam_binding_cloudresourcemanager_v2beta1_args_doc}
/// The set of arguments for FolderIamBinding.
/// {@endtemplate}
/// {@macro pulumi_cloudresourcemanager_v2beta1_folder_iam_binding_cloudresourcemanager_v2beta1_args_doc}
class FolderIamBindingCloudresourcemanagerV2beta1Args {
  ...
  /// Creates a new [FolderIamBindingCloudresourcemanagerV2beta1Args].
  ...
  const FolderIamBindingCloudresourcemanagerV2beta1Args({
    this.condition,
  ...
  factory FolderIamBindingCloudresourcemanagerV2beta1Args.fromMap(Map<String, dynamic> map) {
    return FolderIamBindingCloudresourcemanagerV2beta1Args(
