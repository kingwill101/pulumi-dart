...
import 'project_iam_member_cloudresourcemanager_v1beta1_args.dart';
...
class ProjectIamMemberCloudresourcemanagerV1beta1 extends pulumi.CustomResource {
  ...
  /// Creates a new [ProjectIamMemberCloudresourcemanagerV1beta1].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ProjectIamMemberCloudresourcemanagerV1beta1]. {@macro pulumi_cloudresourcemanager_v1beta1_project_iam_member_cloudresourcemanager_v1beta1_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  ProjectIamMemberCloudresourcemanagerV1beta1(
    String name, {
    ProjectIamMemberCloudresourcemanagerV1beta1Args? args,
