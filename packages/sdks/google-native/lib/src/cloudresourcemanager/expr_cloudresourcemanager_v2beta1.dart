...
class ExprCloudresourcemanagerV2beta1 {
  ...
  /// Creates a new [ExprCloudresourcemanagerV2beta1].
  ...
  const ExprCloudresourcemanagerV2beta1({
    this.description,
    this.expression,
    this.location,
    this.title,
  ...
  factory ExprCloudresourcemanagerV2beta1.fromMap(Map<String, dynamic> map) {
    return ExprCloudresourcemanagerV2beta1(
