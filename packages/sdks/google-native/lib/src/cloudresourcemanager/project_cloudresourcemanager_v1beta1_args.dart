...
class ProjectCloudresourcemanagerV1beta1Args {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'labels': ?labels,
      'lifecycleState': ?pulumi.Input.mapOptionalInputValue<ProjectLifecycleStateCloudresourcemanagerV1beta1, String>(lifecycleState, (value) => value.wireValue),
      'name': ?name,
  ...
  factory ProjectCloudresourcemanagerV1beta1Args.fromMap(Map<String, dynamic> map) {
    return ProjectCloudresourcemanagerV1beta1Args(
      ...
      lifecycleState: (() { final guardedValue = map['lifecycleState']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ProjectLifecycleStateCloudresourcemanagerV1beta1.fromValue(guardedValue as String)); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      parent: (() { final guardedValue = map['parent']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResourceIdCloudresourcemanagerV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      useLegacyStack: (() { final guardedValue = map['useLegacyStack']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
    );
  }
}
