...
import 'folder_iam_binding_args.dart';
...
class FolderIamBinding extends pulumi.CustomResource {
  ...
  /// Creates a new [FolderIamBinding].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [FolderIamBinding]. {@macro pulumi_cloudresourcemanager_v2_folder_iam_binding_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  FolderIamBinding(
    String name, {
    FolderIamBindingArgs? args,
