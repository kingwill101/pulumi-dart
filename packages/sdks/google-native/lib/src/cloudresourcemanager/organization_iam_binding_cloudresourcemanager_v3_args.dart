...
/// {@template pulumi_cloudresourcemanager_v3_organization_iam_binding_cloudresourcemanager_v3_args_doc}
/// The set of arguments for OrganizationIamBinding.
/// {@endtemplate}
/// {@macro pulumi_cloudresourcemanager_v3_organization_iam_binding_cloudresourcemanager_v3_args_doc}
class OrganizationIamBindingCloudresourcemanagerV3Args {
  ...
  /// Creates a new [OrganizationIamBindingCloudresourcemanagerV3Args].
  ...
  const OrganizationIamBindingCloudresourcemanagerV3Args({
    this.condition,
  ...
  factory OrganizationIamBindingCloudresourcemanagerV3Args.fromMap(Map<String, dynamic> map) {
    return OrganizationIamBindingCloudresourcemanagerV3Args(
