...
class Webhook extends pulumi.CustomResource {
  ...
  Webhook(
    ...
    this.filters = registerOutput<List<WebhookFilters>?>('filters');
    this.format = registerOutput<WebhookFormat>('format');
    this.groups = registerOutput<List<WebhookGroup>?>('groups');
