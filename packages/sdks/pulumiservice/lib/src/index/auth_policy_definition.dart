...
class AuthPolicyDefinition {
    ...
    return <String, dynamic>{
      'authorizedPermissions':
          ?pulumi.Input.mapOptionalInputValue<
            List<AuthPolicyPermissionLevel>,
            List<String>
          >(
            authorizedPermissions,
            (value) =>
                pulumi.Input.encodeList<AuthPolicyPermissionLevel, String>(
                  value,
                  (value) => value.wireValue,
                ),
          ),
      'decision': pulumi.Input.mapInputValue<AuthPolicyDecision, String>(
        decision,
        (value) => value.wireValue,
      ),
      'rules': rules,
      'runnerID': ?runnerID,
      'teamName': ?teamName,
      'tokenType': pulumi.Input.mapInputValue<AuthPolicyTokenType, String>(
        tokenType,
        (value) => value.wireValue,
      ),
      'userLogin': ?userLogin,
  ...
  factory AuthPolicyDefinition.fromMap(Map<String, dynamic> map) {
    return AuthPolicyDefinition(
      authorizedPermissions: (() {
        final guardedValue = map['authorizedPermissions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AuthPolicyPermissionLevel>(
            guardedValue,
            (value) => AuthPolicyPermissionLevel.fromValue(value as String),
          ),
        );
      })(),
      decision: pulumi.Input.fromValue(
        AuthPolicyDecision.fromValue(map['decision']! as String),
      ),
      rules: pulumi.Input.fromValue(
        (map['rules'] as Map).cast<String, String>(),
      ),
      runnerID: (() {
        final guardedValue = map['runnerID'];
        if (guardedValue == null) return null;
      ...
      tokenType: pulumi.Input.fromValue(
        AuthPolicyTokenType.fromValue(map['tokenType']! as String),
      ),
      userLogin: (() {
        final guardedValue = map['userLogin'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
