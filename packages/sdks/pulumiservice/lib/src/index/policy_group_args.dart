...
class PolicyGroupArgs {
    ...
    return <String, dynamic>{
      ...
      'policyPacks':
          ?pulumi.Input.mapOptionalInputValue<
            List<PolicyGroupPolicyPackReference>,
      ...
      'stacks':
          ?pulumi.Input.mapOptionalInputValue<
            List<PolicyGroupStackReference>,
            List<Map<String, dynamic>>
          >(
            stacks,
            (value) =>
  ...
  factory PolicyGroupArgs.fromMap(Map<String, dynamic> map) {
    return PolicyGroupArgs(
      ...
      policyPacks: (() {
        final guardedValue = map['policyPacks'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PolicyGroupPolicyPackReference>(
            guardedValue,
            (value) => PolicyGroupPolicyPackReference.fromMap(
      ...
      stacks: (() {
        final guardedValue = map['stacks'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PolicyGroupStackReference>(
            guardedValue,
            (value) => PolicyGroupStackReference.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
