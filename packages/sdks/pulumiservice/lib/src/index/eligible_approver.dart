...
class EligibleApprover {
  ...
  EligibleApprover({this.rbacPermission, this.teamName, this.user});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'rbacPermission':
          ?pulumi.Input.mapOptionalInputValue<RbacPermission, String>(
            rbacPermission,
  ...
  factory EligibleApprover.fromMap(Map<String, dynamic> map) {
    return EligibleApprover(
      rbacPermission: (() {
        final guardedValue = map['rbacPermission'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RbacPermission.fromValue(guardedValue as String),
        );
      })(),
      teamName: (() {
