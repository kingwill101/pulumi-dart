...
class DeploymentScheduleArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'project': project,
      'pulumiOperation': pulumi.Input.mapInputValue<PulumiOperation, String>(
        pulumiOperation,
  ...
  factory DeploymentScheduleArgs.fromMap(Map<String, dynamic> map) {
    return DeploymentScheduleArgs(
      ...
      pulumiOperation: pulumi.Input.fromValue(
        PulumiOperation.fromValue(map['pulumiOperation']! as String),
      ),
      scheduleCron: (() {
