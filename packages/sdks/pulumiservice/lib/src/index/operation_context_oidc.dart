...
class OperationContextOIDC {
  ...
  OperationContextOIDC({this.aws, this.azure, this.gcp});
  ...
  factory OperationContextOIDC.fromMap(Map<String, dynamic> map) {
    return OperationContextOIDC(
      ...
      azure: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AzureOIDCConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      gcp: (() {
        final guardedValue = map['gcp'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GCPOIDCConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
