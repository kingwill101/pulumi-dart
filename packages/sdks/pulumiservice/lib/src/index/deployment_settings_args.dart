...
class DeploymentSettingsArgs {
    ...
    return <String, dynamic>{
      ...
      'cacheOptions':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(cacheOptions, (value) => value.toMap()),
      'executorContext':
          ?pulumi.Input.mapOptionalInputValue<
            DeploymentSettingsExecutorContext,
            Map<String, dynamic>
          >(executorContext, (value) => value.toMap()),
      'github':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'operationContext':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(operationContext, (value) => value.toMap()),
  ...
  factory DeploymentSettingsArgs.fromMap(Map<String, dynamic> map) {
    return DeploymentSettingsArgs(
      agentPoolId: (() {
        final guardedValue = map['agentPoolId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      cacheOptions: (() {
        final guardedValue = map['cacheOptions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DeploymentSettingsCacheOptions.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      executorContext: (() {
        final guardedValue = map['executorContext'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DeploymentSettingsExecutorContext.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      github: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DeploymentSettingsGithub.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      operationContext: (() {
        final guardedValue = map['operationContext'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DeploymentSettingsOperationContext.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      sourceContext: (() {
        final guardedValue = map['sourceContext'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DeploymentSettingsSourceContext.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
