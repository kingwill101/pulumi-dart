...
import 'webhook_api_stacks_args.dart';
...
class WebhookApiStacks extends pulumi.CustomResource {
  ...
  /// Creates a new [WebhookApiStacks].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [WebhookApiStacks]. {@macro pulumi_api_stacks_webhook_api_stacks_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  WebhookApiStacks(
    String name, {
    WebhookApiStacksArgs? args,
