...
import 'git_hub_enterprise_integration_args.dart';
...
class GitHubEnterpriseIntegration extends pulumi.CustomResource {
  ...
  /// Creates a new [GitHubEnterpriseIntegration].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [GitHubEnterpriseIntegration]. {@macro pulumi_api_integrations_git_hub_enterprise_integration_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  GitHubEnterpriseIntegration(
    String name, {
    GitHubEnterpriseIntegrationArgs? args,
