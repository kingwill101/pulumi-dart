...
class ProviderArgs {
  ...
  factory ProviderArgs.fromMap(Map<String, dynamic> map) {
    return ProviderArgs(
      awsRdsIamAuth: (() {
        final guardedValue = map['awsRdsIamAuth'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      awsRdsIamProfile: (() {
        final guardedValue = map['awsRdsIamProfile'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      awsRdsIamProviderRoleArn: (() {
        final guardedValue = map['awsRdsIamProviderRoleArn'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      awsRdsIamRegion: (() {
        final guardedValue = map['awsRdsIamRegion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      azureIdentityAuth: (() {
        final guardedValue = map['azureIdentityAuth'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      azureTenantId: (() {
      ...
      databaseUsername: (() {
        final guardedValue = map['databaseUsername'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      expectedVersion: (() {
        final guardedValue = map['expectedVersion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      gcpIamImpersonateServiceAccount: (() {
        final guardedValue = map['gcpIamImpersonateServiceAccount'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      host: (() {
      ...
      sslrootcert: (() {
        final guardedValue = map['sslrootcert'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      superuser: (() {
