...
class SubscriptionArgs {
  ...
  SubscriptionArgs({
    required pulumi.Output<String> conninfo,
    pulumi.Output<bool>? createSlot,
    pulumi.Output<String>? database,
    pulumi.Output<String>? name,
    required pulumi.Output<List<String>> publications,
  ...
  factory SubscriptionArgs.fromMap(Map<String, dynamic> map) {
    return SubscriptionArgs(
      conninfo: pulumi.Output.create<String>(map['conninfo'] as String),
      ...
      publications: pulumi.Output.create<List<String>>((map['publications'] as List).cast<String>()),
