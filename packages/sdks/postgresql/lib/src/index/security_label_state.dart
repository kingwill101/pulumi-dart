...
class SecurityLabelState {
  ...
  factory SecurityLabelState.fromMap(Map<String, dynamic> map) {
    return SecurityLabelState(
      ...
      labelProvider: (() { final guardedValue = map['labelProvider']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
