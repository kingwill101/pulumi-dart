...
/// {@template pulumi_index_publication_publication_args_doc}
/// The set of arguments for Publication.
/// {@endtemplate}
/// {@macro pulumi_index_publication_publication_args_doc}
class PublicationArgs {
  ...
  factory PublicationArgs.fromMap(Map<String, dynamic> map) {
    return PublicationArgs(
      allTables: (() { final guardedValue = map['allTables']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      publishParams: (() { final guardedValue = map['publishParams']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      publishViaPartitionRootParam: (() { final guardedValue = map['publishViaPartitionRootParam']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
