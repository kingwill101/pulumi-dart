...
class ProviderClientcert {
  ...
  ProviderClientcert({required this.cert, required this.key, this.sslinline});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'cert': cert, 'key': key, 'sslinline': ?sslinline};
  }
  ...
  factory ProviderClientcert.fromMap(Map<String, dynamic> map) {
    return ProviderClientcert(
      ...
      sslinline: (() {
        final guardedValue = map['sslinline'];
