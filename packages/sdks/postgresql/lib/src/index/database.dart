...
class Database extends pulumi.CustomResource {
  ...
  Database(
    ...
    this.allowConnections = registerOutput<bool?>('allowConnections');
    this.alterObjectOwnership = registerOutput<bool?>('alterObjectOwnership');
    this.connectionLimit = registerOutput<int?>('connectionLimit');
    this.encoding = registerOutput<String>('encoding');
    this.isTemplate = registerOutput<bool>('isTemplate');
    this.lcCollate = registerOutput<String>('lcCollate');
    this.lcCtype = registerOutput<String>('lcCtype');
    this.name = registerOutput<String>('name');
    this.owner = registerOutput<String>('owner');
    this.tablespaceName = registerOutput<String>('tablespaceName');
