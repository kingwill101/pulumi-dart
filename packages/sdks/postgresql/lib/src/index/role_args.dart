...
class RoleArgs {
  ...
  RoleArgs({
    pulumi.Output<String>? assumeRole,
    pulumi.Output<bool>? bypassRowLevelSecurity,
    pulumi.Output<int>? connectionLimit,
    pulumi.Output<bool>? createDatabase,
    pulumi.Output<bool>? createRole,
    pulumi.Output<String>? encrypted,
    pulumi.Output<bool>? encryptedPassword,
    pulumi.Output<int>? idleInTransactionSessionTimeout,
    pulumi.Output<bool>? inherit,
    pulumi.Output<bool>? login,
    pulumi.Output<String>? name,
    pulumi.Output<String>? password,
    pulumi.Output<String>? passwordWo,
    pulumi.Output<String>? passwordWoVersion,
    pulumi.Output<bool>? replication,
    pulumi.Output<List<String>>? roles,
    pulumi.Output<List<String>>? searchPaths,
    pulumi.Output<bool>? skipDropRole,
    pulumi.Output<bool>? skipReassignOwned,
    pulumi.Output<int>? statementTimeout,
  ...
  factory RoleArgs.fromMap(Map<String, dynamic> map) {
    return RoleArgs(
      assumeRole: map['assumeRole'] == null ? null : pulumi.Output.create<String>(map['assumeRole'] as String),
      bypassRowLevelSecurity: map['bypassRowLevelSecurity'] == null ? null : pulumi.Output.create<bool>(map['bypassRowLevelSecurity'] as bool),
      connectionLimit: map['connectionLimit'] == null ? null : pulumi.Output.create<int>(map['connectionLimit'] as int),
      createDatabase: map['createDatabase'] == null ? null : pulumi.Output.create<bool>(map['createDatabase'] as bool),
      createRole: map['createRole'] == null ? null : pulumi.Output.create<bool>(map['createRole'] as bool),
      encrypted: map['encrypted'] == null ? null : pulumi.Output.create<String>(map['encrypted'] as String),
      encryptedPassword: map['encryptedPassword'] == null ? null : pulumi.Output.create<bool>(map['encryptedPassword'] as bool),
      ...
      inherit: map['inherit'] == null ? null : pulumi.Output.create<bool>(map['inherit'] as bool),
      login: map['login'] == null ? null : pulumi.Output.create<bool>(map['login'] as bool),
      ...
      replication: map['replication'] == null ? null : pulumi.Output.create<bool>(map['replication'] as bool),
      roles: map['roles'] == null ? null : pulumi.Output.create<List<String>>((map['roles'] as List).cast<String>()),
      searchPaths: map['searchPaths'] == null ? null : pulumi.Output.create<List<String>>((map['searchPaths'] as List).cast<String>()),
      skipDropRole: map['skipDropRole'] == null ? null : pulumi.Output.create<bool>(map['skipDropRole'] as bool),
      skipReassignOwned: map['skipReassignOwned'] == null ? null : pulumi.Output.create<bool>(map['skipReassignOwned'] as bool),
      statementTimeout: map['statementTimeout'] == null ? null : pulumi.Output.create<int>(map['statementTimeout'] as int),
