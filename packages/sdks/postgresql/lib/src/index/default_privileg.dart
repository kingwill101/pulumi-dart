...
import 'default_privileg_args.dart';
import 'default_privileg_state.dart';
...
class DefaultPrivileg extends pulumi.CustomResource {
  ...
  /// Creates a new [DefaultPrivileg].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [DefaultPrivileg]. {@macro pulumi_index_default_privileg_default_privileg_args_doc}
  ...
  static DefaultPrivileg get(
    String name,
    pulumi.Input<String> id, {
    DefaultPrivilegState? state,
  }) {
    return DefaultPrivileg._get(
      name,
      state: state?.toMap(),
