...
Provider documentation: [Pulumi Registry](https://www.pulumi.com/registry/packages/postgresql/)
Upstream repository: [https://github.com/pulumi/pulumi-postgresql](https://github.com/pulumi/pulumi-postgresql)
...
~~~sh
dart pub add pulumi_postgresql
~~~
...
import 'package:pulumi_postgresql/pulumi_postgresql.dart' as provider;
~~~
