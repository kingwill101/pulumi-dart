    ...
    return <String, dynamic>{
      'accessPolicies':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, AccessPolicyAssociation>,
      ...
      'tags': ?tags,
      'type': ?pulumi.Input.mapOptionalInputValue<AccessEntryType, String>(
        type,
    ...
    return AccessEntry(
      accessPolicies: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<AccessPolicyAssociation>(
            guardedValue,
            (value) => AccessPolicyAssociation.fromMap(
      ...
      kubernetesGroups: (() {
        final guardedValue = map['kubernetesGroups'];
        if (guardedValue == null) return null;
      ...
      type: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AccessEntryType.fromValue(guardedValue as String),
        );
      })(),
      username: (() {
