...
class FargateProfile {
  ...
  FargateProfile({this.podExecutionRoleArn, this.selectors, this.subnetIds});
    ...
    return <String, dynamic>{
      ...
      'selectors':
          ?pulumi.Input.mapOptionalInputValue<
            List<pulumi_aws_eks.FargateProfileSelector>,
            List<Map<String, dynamic>>
          >(
            selectors,
            (value) =>
                pulumi.Input.encodeList<
                  pulumi_aws_eks.FargateProfileSelector,
                  Map<String, dynamic>
    ...
    return FargateProfile(
      ...
      selectors: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<pulumi_aws_eks.FargateProfileSelector>(
            guardedValue,
            (value) => pulumi_aws_eks.FargateProfileSelector.fromMap(
