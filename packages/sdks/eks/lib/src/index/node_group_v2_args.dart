...
class NodeGroupV2Args {
  ...
  factory NodeGroupV2Args.fromMap(Map<String, dynamic> map) {
    return NodeGroupV2Args(
      ...
      launchTemplateTagSpecifications: (() { final guardedValue = map['launchTemplateTagSpecifications']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<pulumi_aws_ec2.LaunchTemplateTagSpecification>(guardedValue, (value) => pulumi_aws_ec2.LaunchTemplateTagSpecification.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      minRefreshPercentage: (() { final guardedValue = map['minRefreshPercentage']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
