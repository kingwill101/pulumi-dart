...
class NodeGroupV2Args {
  ...
  factory NodeGroupV2Args.fromMap(Map<String, dynamic> map) {
    return NodeGroupV2Args(
      ...
      ignoreScalingChanges: map['ignoreScalingChanges'] == null ? null : (map['ignoreScalingChanges'] as bool).input(),
      ...
      launchTemplateTagSpecifications: map['launchTemplateTagSpecifications'] == null ? null : (pulumi.Input.decodeList<pulumi_aws_ec2.LaunchTemplateTagSpecification>(map['launchTemplateTagSpecifications'], (value) => pulumi_aws_ec2.LaunchTemplateTagSpecification.fromMap((value as Map).cast<String, dynamic>()))).input(),
      maxSize: map['maxSize'] == null ? null : (map['maxSize'] as int).input(),
      minRefreshPercentage: map['minRefreshPercentage'] == null ? null : (map['minRefreshPercentage'] as int).input(),
