...
class ClusterArgs {
  ...
  ClusterArgs({
    pulumi.Output<Map<String, AccessEntry>>? accessEntries,
    pulumi.Output<AuthenticationMode>? authenticationMode,
    pulumi.Output<AutoModeOptions>? autoMode,
    pulumi.Output<bool>? bootstrapSelfManagedAddons,
    pulumi.Output<pulumi_aws_ec2.SecurityGroup>? clusterSecurityGroup,
    pulumi.Output<Map<String, String>>? clusterSecurityGroupTags,
    pulumi.Output<Map<String, String>>? clusterTags,
    pulumi.Output<CoreDnsAddonOptions>? corednsAddonOptions,
    pulumi.Output<bool>? createInstanceRole,
    pulumi.Output<bool>? createOidcProvider,
    pulumi.Output<CreationRoleProvider>? creationRoleProvider,
    ...
    pulumi.Output<String>? encryptionConfigKeyArn,
    pulumi.Output<bool>? endpointPrivateAccess,
    pulumi.Output<bool>? endpointPublicAccess,
    pulumi.Output<bool>? fargate,
    pulumi.Output<bool>? gpu,
    pulumi.Output<String>? instanceProfileName,
    pulumi.Output<pulumi_aws_iam.Role>? instanceRole,
    pulumi.Output<List<pulumi_aws_iam.Role>>? instanceRoles,
    pulumi.Output<String>? instanceType,
    pulumi.Output<String>? ipFamily,
    pulumi.Output<KubeProxyAddonOptions>? kubeProxyAddonOptions,
    pulumi.Output<String>? kubernetesServiceIpAddressRange,
    pulumi.Output<int>? maxSize,
    pulumi.Output<int>? minSize,
    pulumi.Output<String>? name,
    pulumi.Output<String>? nodeAmiId,
    pulumi.Output<bool>? nodeAssociatePublicIpAddress,
    pulumi.Output<ClusterNodeGroupOptions>? nodeGroupOptions,
    pulumi.Output<String>? nodePublicKey,
    pulumi.Output<bool>? nodeRootVolumeEncrypted,
    pulumi.Output<int>? nodeRootVolumeSize,
    pulumi.Output<Map<String, String>>? nodeSecurityGroupTags,
    pulumi.Output<List<String>>? nodeSubnetIds,
    pulumi.Output<String>? nodeUserData,
    pulumi.Output<List<String>>? privateSubnetIds,
    pulumi.Output<KubeconfigOptions>? providerCredentialOpts,
    pulumi.Output<String>? proxy,
    pulumi.Output<List<String>>? publicAccessCidrs,
    pulumi.Output<List<String>>? publicSubnetIds,
    pulumi.Output<List<RoleMapping>>? roleMappings,
    pulumi.Output<pulumi_aws_iam.Role>? serviceRole,
    pulumi.Output<bool>? skipDefaultNodeGroup,
    pulumi.Output<bool>? skipDefaultSecurityGroups,
    pulumi.Output<String>? storageClasses,
    pulumi.Output<List<String>>? subnetIds,
    pulumi.Output<Map<String, String>>? tags,
    pulumi.Output<pulumi_aws_eks.ClusterUpgradePolicy>? upgradePolicy,
    pulumi.Output<bool>? useDefaultVpcCni,
    pulumi.Output<List<UserMapping>>? userMappings,
    pulumi.Output<String>? version,
    pulumi.Output<VpcCniOptions>? vpcCniOptions,
  ...
  factory ClusterArgs.fromMap(Map<String, dynamic> map) {
    return ClusterArgs(
      accessEntries: map['accessEntries'] == null ? null : pulumi.Output.create<Map<String, AccessEntry>>(pulumi.Input.decodeMapValues<AccessEntry>(map['accessEntries'], (value) => AccessEntry.fromMap((value as Map).cast<String, dynamic>()))),
      authenticationMode: map['authenticationMode'] == null ? null : pulumi.Output.create<AuthenticationMode>(AuthenticationMode.fromValue(map['authenticationMode'] as String)),
      autoMode: map['autoMode'] == null ? null : pulumi.Output.create<AutoModeOptions>(AutoModeOptions.fromMap((map['autoMode'] as Map).cast<String, dynamic>())),
      ...
      clusterSecurityGroup: map['clusterSecurityGroup'] == null ? null : pulumi.Output.create<pulumi_aws_ec2.SecurityGroup>(map['clusterSecurityGroup'] as pulumi_aws_ec2.SecurityGroup),
      clusterSecurityGroupTags: map['clusterSecurityGroupTags'] == null ? null : pulumi.Output.create<Map<String, String>>((map['clusterSecurityGroupTags'] as Map).cast<String, String>()),
      clusterTags: map['clusterTags'] == null ? null : pulumi.Output.create<Map<String, String>>((map['clusterTags'] as Map).cast<String, String>()),
      corednsAddonOptions: map['corednsAddonOptions'] == null ? null : pulumi.Output.create<CoreDnsAddonOptions>(CoreDnsAddonOptions.fromMap((map['corednsAddonOptions'] as Map).cast<String, dynamic>())),
      createInstanceRole: map['createInstanceRole'] == null ? null : pulumi.Output.create<bool>(map['createInstanceRole'] as bool),
      createOidcProvider: map['createOidcProvider'] == null ? null : pulumi.Output.create<bool>(map['createOidcProvider'] as bool),
      creationRoleProvider: map['creationRoleProvider'] == null ? null : pulumi.Output.create<CreationRoleProvider>(CreationRoleProvider.fromMap((map['creationRoleProvider'] as Map).cast<String, dynamic>())),
      ...
      encryptionConfigKeyArn: map['encryptionConfigKeyArn'] == null ? null : pulumi.Output.create<String>(map['encryptionConfigKeyArn'] as String),
      endpointPrivateAccess: map['endpointPrivateAccess'] == null ? null : pulumi.Output.create<bool>(map['endpointPrivateAccess'] as bool),
      endpointPublicAccess: map['endpointPublicAccess'] == null ? null : pulumi.Output.create<bool>(map['endpointPublicAccess'] as bool),
      fargate: map['fargate'] == null ? null : pulumi.Output.create<bool>(map['fargate'] as bool),
      ...
      instanceRole: map['instanceRole'] == null ? null : pulumi.Output.create<pulumi_aws_iam.Role>(map['instanceRole'] as pulumi_aws_iam.Role),
      instanceRoles: map['instanceRoles'] == null ? null : pulumi.Output.create<List<pulumi_aws_iam.Role>>((map['instanceRoles'] as List).cast<pulumi_aws_iam.Role>()),
      instanceType: map['instanceType'] == null ? null : pulumi.Output.create<String>(map['instanceType'] as String),
      ipFamily: map['ipFamily'] == null ? null : pulumi.Output.create<String>(map['ipFamily'] as String),
      kubeProxyAddonOptions: map['kubeProxyAddonOptions'] == null ? null : pulumi.Output.create<KubeProxyAddonOptions>(KubeProxyAddonOptions.fromMap((map['kubeProxyAddonOptions'] as Map).cast<String, dynamic>())),
      kubernetesServiceIpAddressRange: map['kubernetesServiceIpAddressRange'] == null ? null : pulumi.Output.create<String>(map['kubernetesServiceIpAddressRange'] as String),
      ...
      nodeAmiId: map['nodeAmiId'] == null ? null : pulumi.Output.create<String>(map['nodeAmiId'] as String),
      ...
      nodeGroupOptions: map['nodeGroupOptions'] == null ? null : pulumi.Output.create<ClusterNodeGroupOptions>(ClusterNodeGroupOptions.fromMap((map['nodeGroupOptions'] as Map).cast<String, dynamic>())),
      ...
      nodeSecurityGroupTags: map['nodeSecurityGroupTags'] == null ? null : pulumi.Output.create<Map<String, String>>((map['nodeSecurityGroupTags'] as Map).cast<String, String>()),
      ...
      privateSubnetIds: map['privateSubnetIds'] == null ? null : pulumi.Output.create<List<String>>((map['privateSubnetIds'] as List).cast<String>()),
      providerCredentialOpts: map['providerCredentialOpts'] == null ? null : pulumi.Output.create<KubeconfigOptions>(KubeconfigOptions.fromMap((map['providerCredentialOpts'] as Map).cast<String, dynamic>())),
      proxy: map['proxy'] == null ? null : pulumi.Output.create<String>(map['proxy'] as String),
      publicAccessCidrs: map['publicAccessCidrs'] == null ? null : pulumi.Output.create<List<String>>((map['publicAccessCidrs'] as List).cast<String>()),
      publicSubnetIds: map['publicSubnetIds'] == null ? null : pulumi.Output.create<List<String>>((map['publicSubnetIds'] as List).cast<String>()),
      roleMappings: map['roleMappings'] == null ? null : pulumi.Output.create<List<RoleMapping>>(pulumi.Input.decodeList<RoleMapping>(map['roleMappings'], (value) => RoleMapping.fromMap((value as Map).cast<String, dynamic>()))),
      serviceRole: map['serviceRole'] == null ? null : pulumi.Output.create<pulumi_aws_iam.Role>(map['serviceRole'] as pulumi_aws_iam.Role),
      skipDefaultNodeGroup: map['skipDefaultNodeGroup'] == null ? null : pulumi.Output.create<bool>(map['skipDefaultNodeGroup'] as bool),
      skipDefaultSecurityGroups: map['skipDefaultSecurityGroups'] == null ? null : pulumi.Output.create<bool>(map['skipDefaultSecurityGroups'] as bool),
      storageClasses: map['storageClasses'] == null ? null : pulumi.Output.create<String>(map['storageClasses'] as String),
      subnetIds: map['subnetIds'] == null ? null : pulumi.Output.create<List<String>>((map['subnetIds'] as List).cast<String>()),
      tags: map['tags'] == null ? null : pulumi.Output.create<Map<String, String>>((map['tags'] as Map).cast<String, String>()),
      upgradePolicy: map['upgradePolicy'] == null ? null : pulumi.Output.create<pulumi_aws_eks.ClusterUpgradePolicy>(pulumi_aws_eks.ClusterUpgradePolicy.fromMap((map['upgradePolicy'] as Map).cast<String, dynamic>())),
      useDefaultVpcCni: map['useDefaultVpcCni'] == null ? null : pulumi.Output.create<bool>(map['useDefaultVpcCni'] as bool),
      userMappings: map['userMappings'] == null ? null : pulumi.Output.create<List<UserMapping>>(pulumi.Input.decodeList<UserMapping>(map['userMappings'], (value) => UserMapping.fromMap((value as Map).cast<String, dynamic>()))),
      version: map['version'] == null ? null : pulumi.Output.create<String>(map['version'] as String),
      vpcCniOptions: map['vpcCniOptions'] == null ? null : pulumi.Output.create<VpcCniOptions>(VpcCniOptions.fromMap((map['vpcCniOptions'] as Map).cast<String, dynamic>())),
