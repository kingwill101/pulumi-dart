...
class ClusterArgs {
  ...
  factory ClusterArgs.fromMap(Map<String, dynamic> map) {
    return ClusterArgs(
      accessEntries: map['accessEntries'] == null ? null : (pulumi.Input.decodeMapValues<AccessEntry>(map['accessEntries'], (value) => AccessEntry.fromMap((value as Map).cast<String, dynamic>()))).input(),
      authenticationMode: map['authenticationMode'] == null ? null : (AuthenticationMode.fromValue(map['authenticationMode'] as String)).input(),
      autoMode: map['autoMode'] == null ? null : (AutoModeOptions.fromMap((map['autoMode'] as Map).cast<String, dynamic>())).input(),
      bootstrapSelfManagedAddons: map['bootstrapSelfManagedAddons'] == null ? null : (map['bootstrapSelfManagedAddons'] as bool).input(),
      clusterSecurityGroup: map['clusterSecurityGroup'] == null ? null : (map['clusterSecurityGroup'] as pulumi_aws_ec2.SecurityGroup).input(),
      clusterSecurityGroupTags: map['clusterSecurityGroupTags'] == null ? null : ((map['clusterSecurityGroupTags'] as Map).cast<String, String>()).input(),
      clusterTags: map['clusterTags'] == null ? null : ((map['clusterTags'] as Map).cast<String, String>()).input(),
      corednsAddonOptions: map['corednsAddonOptions'] == null ? null : (CoreDnsAddonOptions.fromMap((map['corednsAddonOptions'] as Map).cast<String, dynamic>())).input(),
      createInstanceRole: map['createInstanceRole'] == null ? null : (map['createInstanceRole'] as bool).input(),
      createOidcProvider: map['createOidcProvider'] == null ? null : (map['createOidcProvider'] as bool).input(),
      creationRoleProvider: map['creationRoleProvider'] == null ? null : (CreationRoleProvider.fromMap((map['creationRoleProvider'] as Map).cast<String, dynamic>())).input(),
      ...
      encryptionConfigKeyArn: map['encryptionConfigKeyArn'] == null ? null : (map['encryptionConfigKeyArn'] as String).input(),
      ...
      fargate: map['fargate'] == null ? null : (map['fargate'] as bool).input(),
      ...
      instanceRole: map['instanceRole'] == null ? null : (map['instanceRole'] as pulumi_aws_iam.Role).input(),
      instanceRoles: map['instanceRoles'] == null ? null : ((map['instanceRoles'] as List).cast<pulumi_aws_iam.Role>()).input(),
      instanceType: map['instanceType'] == null ? null : (map['instanceType'] as String).input(),
      ipFamily: map['ipFamily'] == null ? null : (map['ipFamily'] as String).input(),
      kubeProxyAddonOptions: map['kubeProxyAddonOptions'] == null ? null : (KubeProxyAddonOptions.fromMap((map['kubeProxyAddonOptions'] as Map).cast<String, dynamic>())).input(),
      kubernetesServiceIpAddressRange: map['kubernetesServiceIpAddressRange'] == null ? null : (map['kubernetesServiceIpAddressRange'] as String).input(),
      maxSize: map['maxSize'] == null ? null : (map['maxSize'] as int).input(),
      minSize: map['minSize'] == null ? null : (map['minSize'] as int).input(),
      name: map['name'] == null ? null : (map['name'] as String).input(),
      nodeAmiId: map['nodeAmiId'] == null ? null : (map['nodeAmiId'] as String).input(),
      nodeAssociatePublicIpAddress: map['nodeAssociatePublicIpAddress'] == null ? null : (map['nodeAssociatePublicIpAddress'] as bool).input(),
      nodeGroupOptions: map['nodeGroupOptions'] == null ? null : (ClusterNodeGroupOptions.fromMap((map['nodeGroupOptions'] as Map).cast<String, dynamic>())).input(),
      ...
      nodeSecurityGroupTags: map['nodeSecurityGroupTags'] == null ? null : ((map['nodeSecurityGroupTags'] as Map).cast<String, String>()).input(),
      ...
      privateSubnetIds: map['privateSubnetIds'] == null ? null : ((map['privateSubnetIds'] as List).cast<String>()).input(),
      providerCredentialOpts: map['providerCredentialOpts'] == null ? null : (KubeconfigOptions.fromMap((map['providerCredentialOpts'] as Map).cast<String, dynamic>())).input(),
      ...
      publicSubnetIds: map['publicSubnetIds'] == null ? null : ((map['publicSubnetIds'] as List).cast<String>()).input(),
      roleMappings: map['roleMappings'] == null ? null : (pulumi.Input.decodeList<RoleMapping>(map['roleMappings'], (value) => RoleMapping.fromMap((value as Map).cast<String, dynamic>()))).input(),
      serviceRole: map['serviceRole'] == null ? null : (map['serviceRole'] as pulumi_aws_iam.Role).input(),
      skipDefaultNodeGroup: map['skipDefaultNodeGroup'] == null ? null : (map['skipDefaultNodeGroup'] as bool).input(),
      skipDefaultSecurityGroups: map['skipDefaultSecurityGroups'] == null ? null : (map['skipDefaultSecurityGroups'] as bool).input(),
      storageClasses: map['storageClasses'] == null ? null : (map['storageClasses'] as String).input(),
      subnetIds: map['subnetIds'] == null ? null : ((map['subnetIds'] as List).cast<String>()).input(),
      tags: map['tags'] == null ? null : ((map['tags'] as Map).cast<String, String>()).input(),
      upgradePolicy: map['upgradePolicy'] == null ? null : (pulumi_aws_eks.ClusterUpgradePolicy.fromMap((map['upgradePolicy'] as Map).cast<String, dynamic>())).input(),
      useDefaultVpcCni: map['useDefaultVpcCni'] == null ? null : (map['useDefaultVpcCni'] as bool).input(),
      userMappings: map['userMappings'] == null ? null : (pulumi.Input.decodeList<UserMapping>(map['userMappings'], (value) => UserMapping.fromMap((value as Map).cast<String, dynamic>()))).input(),
      version: map['version'] == null ? null : (map['version'] as String).input(),
      vpcCniOptions: map['vpcCniOptions'] == null ? null : (VpcCniOptions.fromMap((map['vpcCniOptions'] as Map).cast<String, dynamic>())).input(),
