...
class NodeGroupSecurityGroup extends pulumi.ComponentResource {
  ...
  NodeGroupSecurityGroup(
    ...
    this.securityGroup = registerOutput<pulumi_aws_ec2.SecurityGroup>('securityGroup');
    this.securityGroupRule = registerOutput<pulumi_aws_ec2.SecurityGroupRule>('securityGroupRule');
  }
}
