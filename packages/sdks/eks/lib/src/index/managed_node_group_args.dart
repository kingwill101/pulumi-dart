...
class ManagedNodeGroupArgs {
  ...
  factory ManagedNodeGroupArgs.fromMap(Map<String, dynamic> map) {
    return ManagedNodeGroupArgs(
      ...
      enableEfaSupport: map['enableEfaSupport'] == null ? null : (map['enableEfaSupport']! as bool).input(),
      enableIMDSv2: map['enableIMDSv2'] == null ? null : (map['enableIMDSv2']! as bool).input(),
      ...
      launchTemplate: map['launchTemplate'] == null ? null : (pulumi_aws_eks.NodeGroupLaunchTemplate.fromMap((map['launchTemplate']! as Map).cast<String, dynamic>())).input(),
      ...
      nodeRole: map['nodeRole'] == null ? null : (map['nodeRole']! as pulumi_aws_iam.Role).input(),
      ...
      placementGroupAvailabilityZone: map['placementGroupAvailabilityZone'] == null ? null : (map['placementGroupAvailabilityZone']! as String).input(),
      releaseVersion: map['releaseVersion'] == null ? null : (map['releaseVersion']! as String).input(),
      remoteAccess: map['remoteAccess'] == null ? null : (pulumi_aws_eks.NodeGroupRemoteAccess.fromMap((map['remoteAccess']! as Map).cast<String, dynamic>())).input(),
      scalingConfig: map['scalingConfig'] == null ? null : (pulumi_aws_eks.NodeGroupScalingConfig.fromMap((map['scalingConfig']! as Map).cast<String, dynamic>())).input(),
      subnetIds: map['subnetIds'] == null ? null : ((map['subnetIds']! as List).cast<String>()).input(),
      tags: map['tags'] == null ? null : ((map['tags']! as Map).cast<String, String>()).input(),
      taints: map['taints'] == null ? null : (pulumi.Input.decodeList<pulumi_aws_eks.NodeGroupTaint>(map['taints']!, (value) => pulumi_aws_eks.NodeGroupTaint.fromMap((value as Map).cast<String, dynamic>()))).input(),
