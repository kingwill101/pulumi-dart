...
class ManagedNodeGroupArgs {
    ...
    return <String, dynamic>{
      ...
      'launchTemplate':
          ?pulumi.Input.mapOptionalInputValue<
            pulumi_aws_eks.NodeGroupLaunchTemplate,
            Map<String, dynamic>
      ...
      'remoteAccess':
          ?pulumi.Input.mapOptionalInputValue<
            pulumi_aws_eks.NodeGroupRemoteAccess,
            Map<String, dynamic>
          >(remoteAccess, (value) => value.toMap()),
      'scalingConfig':
          ?pulumi.Input.mapOptionalInputValue<
            pulumi_aws_eks.NodeGroupScalingConfig,
            Map<String, dynamic>
      ...
      'taints':
          ?pulumi.Input.mapOptionalInputValue<
            List<pulumi_aws_eks.NodeGroupTaint>,
            List<Map<String, dynamic>>
          >(
            taints,
            (value) =>
                pulumi.Input.encodeList<
                  pulumi_aws_eks.NodeGroupTaint,
                  Map<String, dynamic>
  ...
  factory ManagedNodeGroupArgs.fromMap(Map<String, dynamic> map) {
    return ManagedNodeGroupArgs(
      ...
      enableEfaSupport: (() {
        final guardedValue = map['enableEfaSupport'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      enableIMDSv2: (() {
        final guardedValue = map['enableIMDSv2'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      forceUpdateVersion: (() {
      ...
      launchTemplate: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi_aws_eks.NodeGroupLaunchTemplate.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      placementGroupAvailabilityZone: (() {
        final guardedValue = map['placementGroupAvailabilityZone'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      releaseVersion: (() {
      ...
      remoteAccess: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi_aws_eks.NodeGroupRemoteAccess.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      scalingConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi_aws_eks.NodeGroupScalingConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      taints: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<pulumi_aws_eks.NodeGroupTaint>(
            guardedValue,
            (value) => pulumi_aws_eks.NodeGroupTaint.fromMap(
