...
class AccessPolicyAssociation {
  ...
  final pulumi.Input<pulumi_aws_eks.AccessPolicyAssociationAccessScope> accessScope;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'accessScope': pulumi.Input.mapInputValue<pulumi_aws_eks.AccessPolicyAssociationAccessScope, Map<String, dynamic>>(accessScope, (value) => value.toMap()),
      'policyArn': policyArn,
    };
  }
  ...
  factory AccessPolicyAssociation.fromMap(Map<String, dynamic> map) {
    return AccessPolicyAssociation(
      accessScope: pulumi.Input.fromValue(pulumi_aws_eks.AccessPolicyAssociationAccessScope.fromMap((map['accessScope']! as Map).cast<String, dynamic>())),
