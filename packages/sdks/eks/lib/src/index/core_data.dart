...
import 'package:pulumi_kubernetes/providers.dart'
    as pulumi_kubernetes_providers;
import 'package:pulumi_kubernetes/storage_k8s_io.dart'
    as pulumi_kubernetes_storage_k8s_io;
...
class CoreData {
  ...
  final pulumi.Input<
    Map<String, pulumi_kubernetes_storage_k8s_io.StorageClass>
  >?
  storageClasses;
    ...
    return <String, dynamic>{
      'accessEntries':
          ...
          >(
            accessEntries,
            (value) =>
                pulumi.Input.encodeList<AccessEntry, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      ...
      'encryptionConfig':
          ?pulumi.Input.mapOptionalInputValue<
            pulumi_aws_eks.ClusterEncryptionConfig,
            Map<String, dynamic>
    ...
    return CoreData(
      accessEntries: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AccessEntry>(
            guardedValue,
            (value) =>
      ...
      awsProvider: (() {
        final guardedValue = map['awsProvider'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          guardedValue as pulumi_aws_providers.ProviderProvider,
        );
      })(),
      cluster: pulumi.Input.fromValue(map['cluster'] as pulumi_aws_eks.Cluster),
      clusterIamRole: pulumi.Input.fromValue(
        map['clusterIamRole'] as pulumi_aws_iam.Role,
      ),
      ...
      eksNodeAccess: (() {
        final guardedValue = map['eksNodeAccess'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          guardedValue as pulumi_kubernetes_core.ConfigMap,
        );
      })(),
      encryptionConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi_aws_eks.ClusterEncryptionConfig.fromMap(
      ...
      fargateProfile: (() {
        final guardedValue = map['fargateProfile'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          guardedValue as pulumi_aws_eks.FargateProfile,
        );
      })(),
      instanceRoles: pulumi.Input.fromValue(
        (map['instanceRoles'] as List).cast<pulumi_aws_iam.Role>(),
      ),
      kubeconfig: (() {
      ...
      nodeGroupOptions: pulumi.Input.fromValue(
        ClusterNodeGroupOptions.fromMap(
          (map['nodeGroupOptions']! as Map).cast<String, dynamic>(),
        ),
      ),
      ...
      oidcProvider: (() {
        final guardedValue = map['oidcProvider'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          guardedValue as pulumi_aws_iam.OpenIdConnectProvider,
        );
      })(),
      privateSubnetIds: (() {
      ...
      provider: pulumi.Input.fromValue(
        map['provider'] as pulumi_kubernetes_providers.ProviderProvider,
      ),
      publicSubnetIds: (() {
      ...
      storageClasses: (() {
        ...
        return pulumi.Input.fromValue(
          (guardedValue as Map)
              .cast<String, pulumi_kubernetes_storage_k8s_io.StorageClass>(),
        );
      })(),
