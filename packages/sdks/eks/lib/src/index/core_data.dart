...
class CoreData {
  ...
  final pulumi.Input<pulumi_aws_providers.Aws>? awsProvider;
  ...
  final pulumi.Input<pulumi_kubernetes_providers.Kubernetes> provider;
  ...
  factory CoreData.fromMap(Map<String, dynamic> map) {
    return CoreData(
      accessEntries: map['accessEntries'] == null ? null : (pulumi.Input.decodeList<AccessEntry>(map['accessEntries'], (value) => AccessEntry.fromMap((value as Map).cast<String, dynamic>()))).input(),
      awsProvider: map['awsProvider'] == null ? null : (map['awsProvider'] as pulumi_aws_providers.Aws).input(),
      cluster: (map['cluster'] as pulumi_aws_eks.Cluster).input(),
      clusterIamRole: (map['clusterIamRole'] as pulumi_aws_iam.Role).input(),
      clusterSecurityGroup: map['clusterSecurityGroup'] == null ? null : (map['clusterSecurityGroup'] as pulumi_aws_ec2.SecurityGroup).input(),
      eksNodeAccess: map['eksNodeAccess'] == null ? null : (map['eksNodeAccess'] as pulumi_kubernetes_core.ConfigMap).input(),
      encryptionConfig: map['encryptionConfig'] == null ? null : (pulumi_aws_eks.ClusterEncryptionConfig.fromMap((map['encryptionConfig'] as Map).cast<String, dynamic>())).input(),
      endpoint: (map['endpoint'] as String).input(),
      fargateProfile: map['fargateProfile'] == null ? null : (map['fargateProfile'] as pulumi_aws_eks.FargateProfile).input(),
      instanceRoles: ((map['instanceRoles'] as List).cast<pulumi_aws_iam.Role>()).input(),
      kubeconfig: map['kubeconfig'] == null ? null : (map['kubeconfig']).input(),
      nodeGroupOptions: (ClusterNodeGroupOptions.fromMap((map['nodeGroupOptions'] as Map).cast<String, dynamic>())).input(),
      nodeSecurityGroupTags: map['nodeSecurityGroupTags'] == null ? null : ((map['nodeSecurityGroupTags'] as Map).cast<String, String>()).input(),
      oidcProvider: map['oidcProvider'] == null ? null : (map['oidcProvider'] as pulumi_aws_iam.OpenIdConnectProvider).input(),
      privateSubnetIds: map['privateSubnetIds'] == null ? null : ((map['privateSubnetIds'] as List).cast<String>()).input(),
      provider: (map['provider'] as pulumi_kubernetes_providers.Kubernetes).input(),
      publicSubnetIds: map['publicSubnetIds'] == null ? null : ((map['publicSubnetIds'] as List).cast<String>()).input(),
      storageClasses: map['storageClasses'] == null ? null : ((map['storageClasses'] as Map).cast<String, pulumi_kubernetes_storage_k8s_io.StorageClass>()).input(),
      subnetIds: ((map['subnetIds'] as List).cast<String>()).input(),
      tags: map['tags'] == null ? null : ((map['tags'] as Map).cast<String, String>()).input(),
      vpcCni: map['vpcCni'] == null ? null : (map['vpcCni']).input(),
