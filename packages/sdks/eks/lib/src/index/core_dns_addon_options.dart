  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'resolveConflictsOnCreate':
          ?pulumi.Input.mapOptionalInputValue<ResolveConflictsOnCreate, String>(
            resolveConflictsOnCreate,
            (value) => value.wireValue,
          ),
      'resolveConflictsOnUpdate':
          ?pulumi.Input.mapOptionalInputValue<ResolveConflictsOnUpdate, String>(
            resolveConflictsOnUpdate,
            (value) => value.wireValue,
          ),
      'version': ?version,
  ...
  factory CoreDnsAddonOptions.fromMap(Map<String, dynamic> map) {
    return CoreDnsAddonOptions(
      ...
      resolveConflictsOnCreate: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ResolveConflictsOnCreate.fromValue(guardedValue as String),
        );
      })(),
      resolveConflictsOnUpdate: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ResolveConflictsOnUpdate.fromValue(guardedValue as String),
        );
      })(),
      version: (() {
