...
class ClusterNodeGroupOptions {
  ...
  final Map<String, String>? autoScalingGroupTags;
  /// Additional args to pass directly to `/etc/eks/bootstrap.sh`. For details on available options, see: https://github.com/awslabs/amazon-eks-ami/blob/master/files/bootstrap.sh. Note that the `--apiserver-endpoint`, `--b64-cluster-ca` and `--kubelet-extra-args` flags are included automatically based on other configuration parameters.
  final String? bootstrapExtraArgs;
  ...
  final Map<String, dynamic>? bottlerocketSettings;
  /// The tags to apply to the CloudFormation Stack of the Worker NodeGroup.
  ///
  /// Note: Given the inheritance of auto-generated CF tags and `cloudFormationTags`, you should either supply the tag in `autoScalingGroupTags` or `cloudFormationTags`, but not both.
  final Map<String, String>? cloudFormationTags;
  /// The ingress rule that gives node group access.
  final pulumi_aws_ec2.SecurityGroupRule? clusterIngressRule;
  /// The ID of the ingress rule that gives node group access.
  final String? clusterIngressRuleId;
  ...
  final bool? enableDetailedMonitoring;
  /// Encrypt the root block device of the nodes in the node group.
  final bool? encryptRootBlockDevice;
  /// Extra security groups to attach on all nodes in this worker node group.
  ///
  /// This additional set of security groups captures any user application rules that will be needed for the nodes.
  final List<pulumi_aws_ec2.SecurityGroup>? extraNodeSecurityGroups;
  ...
  final bool? ignoreScalingChanges;
  ...
  final pulumi_aws_iam.InstanceProfile? instanceProfile;
  ...
  final String? kubeletExtraArgs;
  /// Custom k8s node labels to be attached to each worker node. Adds the given key/value pairs to the `--node-labels` kubelet argument.
  final Map<String, String>? labels;
  /// The tag specifications to apply to the launch template.
  final List<pulumi_aws_ec2.LaunchTemplateTagSpecification>? launchTemplateTagSpecifications;
  ...
  final int? minRefreshPercentage;
  /// The minimum number of worker nodes running in the cluster. Defaults to 1.
  final int? minSize;
  /// Whether or not to auto-assign public IP addresses on the EKS worker nodes. If this toggle is set to true, the EKS workers will be auto-assigned public IPs. If false, they will not be auto-assigned public IPs.
  final bool? nodeAssociatePublicIpAddress;
  ...
  final bool? nodeRootVolumeDeleteOnTermination;
  /// Whether to encrypt a cluster node's root volume. Defaults to false.
  final bool? nodeRootVolumeEncrypted;
  /// The amount of provisioned IOPS. This is only valid with a volumeType of 'io1'.
  final int? nodeRootVolumeIops;
  /// The size in GiB of a cluster node's root volume. Defaults to 20.
  final int? nodeRootVolumeSize;
  ...
  final pulumi_aws_ec2.SecurityGroup? nodeSecurityGroup;
  ...
  final List<NodeadmOptions>? nodeadmExtraOptions;
  ...
  final Map<String, Taint>? taints;
  /// Desired Kubernetes master / control plane version. If you do not specify a value, the latest available version is used.
  final String? version;

  /// Creates a new [ClusterNodeGroupOptions].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'labels': ?labels,
      'launchTemplateTagSpecifications': ?launchTemplateTagSpecifications == null ? null : pulumi.Input.encodeList<pulumi_aws_ec2.LaunchTemplateTagSpecification, Map<String, dynamic>>(launchTemplateTagSpecifications!, (value) => value.toMap()),
      'maxSize': ?maxSize,
      ...
      'nodeadmExtraOptions': ?nodeadmExtraOptions == null ? null : pulumi.Input.encodeList<NodeadmOptions, Map<String, dynamic>>(nodeadmExtraOptions!, (value) => value.toMap()),
      'operatingSystem': ?operatingSystem == null ? null : operatingSystem!.value,
      'spotPrice': ?spotPrice,
      'taints': ?taints == null ? null : pulumi.Input.encodeMapValues<Taint, Map<String, dynamic>>(taints!, (value) => value.toMap()),
      'version': ?version,
    };
  }

  factory ClusterNodeGroupOptions.fromMap(Map<String, dynamic> map) {
    return ClusterNodeGroupOptions(
      ...
      ignoreScalingChanges: map['ignoreScalingChanges'] == null ? null : map['ignoreScalingChanges'] as bool,
      ...
      launchTemplateTagSpecifications: map['launchTemplateTagSpecifications'] == null ? null : pulumi.Input.decodeList<pulumi_aws_ec2.LaunchTemplateTagSpecification>(map['launchTemplateTagSpecifications'], (value) => pulumi_aws_ec2.LaunchTemplateTagSpecification.fromMap((value as Map).cast<String, dynamic>())),
      maxSize: map['maxSize'] == null ? null : map['maxSize'] as int,
      minRefreshPercentage: map['minRefreshPercentage'] == null ? null : map['minRefreshPercentage'] as int,
