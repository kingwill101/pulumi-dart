...
class VpcCniAddonArgs {
  ...
  VpcCniAddonArgs({
    ...
    pulumi.Output<bool>? cniConfigureRpfilter,
    pulumi.Output<bool>? cniCustomNetworkCfg,
    pulumi.Output<bool>? cniExternalSnat,
    pulumi.Output<Map<String, dynamic>>? configurationValues,
    pulumi.Output<bool>? customNetworkConfig,
    pulumi.Output<bool>? disableTcpEarlyDemux,
    pulumi.Output<bool>? enableNetworkPolicy,
    pulumi.Output<bool>? enablePodEni,
    pulumi.Output<bool>? enablePrefixDelegation,
    pulumi.Output<String>? eniConfigLabelDef,
    pulumi.Output<int>? eniMtu,
    pulumi.Output<bool>? externalSnat,
    pulumi.Output<String>? logFile,
    pulumi.Output<String>? logLevel,
    pulumi.Output<bool>? nodePortSupport,
    pulumi.Output<ResolveConflictsOnCreate>? resolveConflictsOnCreate,
    pulumi.Output<ResolveConflictsOnUpdate>? resolveConflictsOnUpdate,
    pulumi.Output<bool>? securityContextPrivileged,
    pulumi.Output<String>? serviceAccountRoleArn,
    pulumi.Output<List<Map<String, String>>>? tags,
    pulumi.Output<String>? vethPrefix,
    pulumi.Output<int>? warmEniTarget,
    pulumi.Output<int>? warmIpTarget,
    pulumi.Output<int>? warmPrefixTarget,
  }) :
      ...
      cniConfigureRpfilter = pulumi.Input.asOptionalInput<bool>(cniConfigureRpfilter),
      cniCustomNetworkCfg = pulumi.Input.asOptionalInput<bool>(cniCustomNetworkCfg),
      cniExternalSnat = pulumi.Input.asOptionalInput<bool>(cniExternalSnat),
      configurationValues = pulumi.Input.asOptionalInput<Map<String, dynamic>>(configurationValues),
      customNetworkConfig = pulumi.Input.asOptionalInput<bool>(customNetworkConfig),
      disableTcpEarlyDemux = pulumi.Input.asOptionalInput<bool>(disableTcpEarlyDemux),
      enableNetworkPolicy = pulumi.Input.asOptionalInput<bool>(enableNetworkPolicy),
      enablePodEni = pulumi.Input.asOptionalInput<bool>(enablePodEni),
      enablePrefixDelegation = pulumi.Input.asOptionalInput<bool>(enablePrefixDelegation),
      eniConfigLabelDef = pulumi.Input.asOptionalInput<String>(eniConfigLabelDef),
      eniMtu = pulumi.Input.asOptionalInput<int>(eniMtu),
      externalSnat = pulumi.Input.asOptionalInput<bool>(externalSnat),
      logFile = pulumi.Input.asOptionalInput<String>(logFile),
      logLevel = pulumi.Input.asOptionalInput<String>(logLevel),
      nodePortSupport = pulumi.Input.asOptionalInput<bool>(nodePortSupport),
      resolveConflictsOnCreate = pulumi.Input.asOptionalInput<ResolveConflictsOnCreate>(resolveConflictsOnCreate),
      resolveConflictsOnUpdate = pulumi.Input.asOptionalInput<ResolveConflictsOnUpdate>(resolveConflictsOnUpdate),
      securityContextPrivileged = pulumi.Input.asOptionalInput<bool>(securityContextPrivileged),
      ...
      vethPrefix = pulumi.Input.asOptionalInput<String>(vethPrefix),
      warmEniTarget = pulumi.Input.asOptionalInput<int>(warmEniTarget),
      warmIpTarget = pulumi.Input.asOptionalInput<int>(warmIpTarget),
      warmPrefixTarget = pulumi.Input.asOptionalInput<int>(warmPrefixTarget);
  ...
  factory VpcCniAddonArgs.fromMap(Map<String, dynamic> map) {
    return VpcCniAddonArgs(
      ...
      cniConfigureRpfilter: map['cniConfigureRpfilter'] == null ? null : pulumi.Output.create<bool>(map['cniConfigureRpfilter'] as bool),
      cniCustomNetworkCfg: map['cniCustomNetworkCfg'] == null ? null : pulumi.Output.create<bool>(map['cniCustomNetworkCfg'] as bool),
      cniExternalSnat: map['cniExternalSnat'] == null ? null : pulumi.Output.create<bool>(map['cniExternalSnat'] as bool),
      ...
      customNetworkConfig: map['customNetworkConfig'] == null ? null : pulumi.Output.create<bool>(map['customNetworkConfig'] as bool),
      disableTcpEarlyDemux: map['disableTcpEarlyDemux'] == null ? null : pulumi.Output.create<bool>(map['disableTcpEarlyDemux'] as bool),
      enableNetworkPolicy: map['enableNetworkPolicy'] == null ? null : pulumi.Output.create<bool>(map['enableNetworkPolicy'] as bool),
      enablePodEni: map['enablePodEni'] == null ? null : pulumi.Output.create<bool>(map['enablePodEni'] as bool),
      enablePrefixDelegation: map['enablePrefixDelegation'] == null ? null : pulumi.Output.create<bool>(map['enablePrefixDelegation'] as bool),
      eniConfigLabelDef: map['eniConfigLabelDef'] == null ? null : pulumi.Output.create<String>(map['eniConfigLabelDef'] as String),
      eniMtu: map['eniMtu'] == null ? null : pulumi.Output.create<int>(map['eniMtu'] as int),
      externalSnat: map['externalSnat'] == null ? null : pulumi.Output.create<bool>(map['externalSnat'] as bool),
      logFile: map['logFile'] == null ? null : pulumi.Output.create<String>(map['logFile'] as String),
      logLevel: map['logLevel'] == null ? null : pulumi.Output.create<String>(map['logLevel'] as String),
      nodePortSupport: map['nodePortSupport'] == null ? null : pulumi.Output.create<bool>(map['nodePortSupport'] as bool),
      resolveConflictsOnCreate: map['resolveConflictsOnCreate'] == null ? null : pulumi.Output.create<ResolveConflictsOnCreate>(ResolveConflictsOnCreate.fromValue(map['resolveConflictsOnCreate'] as String)),
      resolveConflictsOnUpdate: map['resolveConflictsOnUpdate'] == null ? null : pulumi.Output.create<ResolveConflictsOnUpdate>(ResolveConflictsOnUpdate.fromValue(map['resolveConflictsOnUpdate'] as String)),
      securityContextPrivileged: map['securityContextPrivileged'] == null ? null : pulumi.Output.create<bool>(map['securityContextPrivileged'] as bool),
      ...
      vethPrefix: map['vethPrefix'] == null ? null : pulumi.Output.create<String>(map['vethPrefix'] as String),
      warmEniTarget: map['warmEniTarget'] == null ? null : pulumi.Output.create<int>(map['warmEniTarget'] as int),
      warmIpTarget: map['warmIpTarget'] == null ? null : pulumi.Output.create<int>(map['warmIpTarget'] as int),
      warmPrefixTarget: map['warmPrefixTarget'] == null ? null : pulumi.Output.create<int>(map['warmPrefixTarget'] as int),
    );
  }
}
