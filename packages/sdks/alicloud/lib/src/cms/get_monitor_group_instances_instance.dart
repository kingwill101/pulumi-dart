...
class GetMonitorGroupInstancesInstance {
  ...
  factory GetMonitorGroupInstancesInstance.fromMap(Map<String, dynamic> map) {
    return GetMonitorGroupInstancesInstance(
      instances: pulumi.Input.fromValue(pulumi.Input.decodeList<GetMonitorGroupInstancesInstanceInstance>(map['instances']!, (value) => GetMonitorGroupInstancesInstanceInstance.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
