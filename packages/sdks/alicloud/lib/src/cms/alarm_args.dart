...
class AlarmArgs {
  ...
  factory AlarmArgs.fromMap(Map<String, dynamic> map) {
    return AlarmArgs(
      compositeExpression: (() { final guardedValue = map['compositeExpression']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AlarmCompositeExpression.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      escalationsCritical: (() { final guardedValue = map['escalationsCritical']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AlarmEscalationsCritical.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      escalationsInfo: (() { final guardedValue = map['escalationsInfo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AlarmEscalationsInfo.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      escalationsWarn: (() { final guardedValue = map['escalationsWarn']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AlarmEscalationsWarn.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      metric: pulumi.Input.fromValue(map['metric'] as String),
      metricDimensions: (() { final guardedValue = map['metricDimensions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      prometheuses: (() { final guardedValue = map['prometheuses']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AlarmPrometheus>(guardedValue, (value) => AlarmPrometheus.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      targets: (() { final guardedValue = map['targets']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AlarmTarget>(guardedValue, (value) => AlarmTarget.fromMap((value as Map).cast<String, dynamic>()))); })(),
