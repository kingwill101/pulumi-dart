...
class AlarmArgs {
  ...
  AlarmArgs({
    pulumi.Output<AlarmCompositeExpression>? compositeExpression,
    required pulumi.Output<List<String>> contactGroups,
    pulumi.Output<Map<String, String>>? dimensions,
    pulumi.Output<String>? effectiveInterval,
    pulumi.Output<bool>? enabled,
    pulumi.Output<int>? endTime,
    pulumi.Output<AlarmEscalationsCritical>? escalationsCritical,
    pulumi.Output<AlarmEscalationsInfo>? escalationsInfo,
    pulumi.Output<AlarmEscalationsWarn>? escalationsWarn,
    required pulumi.Output<String> metric,
    pulumi.Output<String>? metricDimensions,
    pulumi.Output<String>? name,
    pulumi.Output<int>? period,
    required pulumi.Output<String> project,
    pulumi.Output<List<AlarmPrometheus>>? prometheuses,
    pulumi.Output<int>? silenceTime,
    pulumi.Output<int>? startTime,
    pulumi.Output<Map<String, String>>? tags,
    pulumi.Output<List<AlarmTarget>>? targets,
    pulumi.Output<String>? webhook,
  }) :
      compositeExpression = pulumi.Input.asOptionalInput<AlarmCompositeExpression>(compositeExpression),
      contactGroups = pulumi.Input.asInput<List<String>>(contactGroups),
      ...
      escalationsCritical = pulumi.Input.asOptionalInput<AlarmEscalationsCritical>(escalationsCritical),
      escalationsInfo = pulumi.Input.asOptionalInput<AlarmEscalationsInfo>(escalationsInfo),
      escalationsWarn = pulumi.Input.asOptionalInput<AlarmEscalationsWarn>(escalationsWarn),
      metric = pulumi.Input.asInput<String>(metric),
      metricDimensions = pulumi.Input.asOptionalInput<String>(metricDimensions),
      name = pulumi.Input.asOptionalInput<String>(name),
      period = pulumi.Input.asOptionalInput<int>(period),
      project = pulumi.Input.asInput<String>(project),
      prometheuses = pulumi.Input.asOptionalInput<List<AlarmPrometheus>>(prometheuses),
      silenceTime = pulumi.Input.asOptionalInput<int>(silenceTime),
      startTime = pulumi.Input.asOptionalInput<int>(startTime),
      tags = pulumi.Input.asOptionalInput<Map<String, String>>(tags),
      targets = pulumi.Input.asOptionalInput<List<AlarmTarget>>(targets),
  ...
  factory AlarmArgs.fromMap(Map<String, dynamic> map) {
    return AlarmArgs(
      compositeExpression: map['compositeExpression'] == null ? null : pulumi.Output.create<AlarmCompositeExpression>(AlarmCompositeExpression.fromMap((map['compositeExpression'] as Map).cast<String, dynamic>())),
      contactGroups: pulumi.Output.create<List<String>>((map['contactGroups'] as List).cast<String>()),
      ...
      escalationsCritical: map['escalationsCritical'] == null ? null : pulumi.Output.create<AlarmEscalationsCritical>(AlarmEscalationsCritical.fromMap((map['escalationsCritical'] as Map).cast<String, dynamic>())),
      escalationsInfo: map['escalationsInfo'] == null ? null : pulumi.Output.create<AlarmEscalationsInfo>(AlarmEscalationsInfo.fromMap((map['escalationsInfo'] as Map).cast<String, dynamic>())),
      escalationsWarn: map['escalationsWarn'] == null ? null : pulumi.Output.create<AlarmEscalationsWarn>(AlarmEscalationsWarn.fromMap((map['escalationsWarn'] as Map).cast<String, dynamic>())),
      metric: pulumi.Output.create<String>(map['metric'] as String),
      metricDimensions: map['metricDimensions'] == null ? null : pulumi.Output.create<String>(map['metricDimensions'] as String),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      period: map['period'] == null ? null : pulumi.Output.create<int>(map['period'] as int),
      project: pulumi.Output.create<String>(map['project'] as String),
      prometheuses: map['prometheuses'] == null ? null : pulumi.Output.create<List<AlarmPrometheus>>(pulumi.Input.decodeList<AlarmPrometheus>(map['prometheuses'], (value) => AlarmPrometheus.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      targets: map['targets'] == null ? null : pulumi.Output.create<List<AlarmTarget>>(pulumi.Input.decodeList<AlarmTarget>(map['targets'], (value) => AlarmTarget.fromMap((value as Map).cast<String, dynamic>()))),
