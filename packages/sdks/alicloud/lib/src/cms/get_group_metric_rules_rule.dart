...
class GetGroupMetricRulesRule {
  ...
  factory GetGroupMetricRulesRule.fromMap(Map<String, dynamic> map) {
    return GetGroupMetricRulesRule(
      ...
      effectiveInterval: pulumi.Input.fromValue(map['effectiveInterval'] as String),
      emailSubject: pulumi.Input.fromValue(map['emailSubject'] as String),
      enableState: pulumi.Input.fromValue(map['enableState'] as bool),
      escalations: pulumi.Input.fromValue(pulumi.Input.decodeList<GetGroupMetricRulesRuleEscalation>(map['escalations']!, (value) => GetGroupMetricRulesRuleEscalation.fromMap((value as Map).cast<String, dynamic>()))),
      groupId: pulumi.Input.fromValue(map['groupId'] as String),
      groupMetricRuleName: pulumi.Input.fromValue(map['groupMetricRuleName'] as String),
      id: pulumi.Input.fromValue(map['id'] as String),
      metricName: pulumi.Input.fromValue(map['metricName'] as String),
      namespace: pulumi.Input.fromValue(map['namespace'] as String),
      noEffectiveInterval: pulumi.Input.fromValue(map['noEffectiveInterval'] as String),
