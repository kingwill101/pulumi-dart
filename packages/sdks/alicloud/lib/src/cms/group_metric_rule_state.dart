...
class GroupMetricRuleState {
  ...
  factory GroupMetricRuleState.fromMap(Map<String, dynamic> map) {
    return GroupMetricRuleState(
      ...
      escalations: (() {
        final guardedValue = map['escalations'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GroupMetricRuleEscalations.fromMap(
      ...
      noEffectiveInterval: (() {
        final guardedValue = map['noEffectiveInterval'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      period: (() {
      ...
      targets: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GroupMetricRuleTarget>(
            guardedValue,
            (value) => GroupMetricRuleTarget.fromMap(
