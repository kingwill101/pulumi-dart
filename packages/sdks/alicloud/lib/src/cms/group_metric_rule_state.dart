...
class GroupMetricRuleState {
  ...
  GroupMetricRuleState({
    ...
    pulumi.Output<GroupMetricRuleEscalations>? escalations,
    ...
    pulumi.Output<String>? webhook,
      ...
      escalations = pulumi.Input.asOptionalInput<GroupMetricRuleEscalations>(escalations),
  ...
  factory GroupMetricRuleState.fromMap(Map<String, dynamic> map) {
    return GroupMetricRuleState(
      ...
      escalations: map['escalations'] == null ? null : pulumi.Output.create<GroupMetricRuleEscalations>(GroupMetricRuleEscalations.fromMap((map['escalations'] as Map).cast<String, dynamic>())),
