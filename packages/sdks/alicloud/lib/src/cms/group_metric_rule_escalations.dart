...
class GroupMetricRuleEscalations {
  ...
  GroupMetricRuleEscalations({this.critical, this.info, this.warn});
    ...
    return GroupMetricRuleEscalations(
      critical: (() {
        ...
        return pulumi.Input.fromValue(
          GroupMetricRuleEscalationsCritical.fromMap(
      ...
      info: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GroupMetricRuleEscalationsInfo.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      warn: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GroupMetricRuleEscalationsWarn.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
