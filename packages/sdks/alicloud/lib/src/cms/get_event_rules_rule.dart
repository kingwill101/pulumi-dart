...
class GetEventRulesRule {
  ...
  factory GetEventRulesRule.fromMap(Map<String, dynamic> map) {
    return GetEventRulesRule(
      ...
      eventPatterns: pulumi.Input.fromValue(pulumi.Input.decodeList<GetEventRulesRuleEventPattern>(map['eventPatterns']!, (value) => GetEventRulesRuleEventPattern.fromMap((value as Map).cast<String, dynamic>()))),
