...
class GetHybridMonitorSlsTasksTask {
  ...
  final pulumi.Input<List<GetHybridMonitorSlsTasksTaskAttachLabel>>
  attachLabels;
  ...
  final pulumi.Input<List<GetHybridMonitorSlsTasksTaskMatchExpress>>
  matchExpresses;
  ...
  /// The configurations of the logs that are imported from Log Service.
  final pulumi.Input<List<GetHybridMonitorSlsTasksTaskSlsProcessConfig>>
  slsProcessConfigs;
    ...
    return <String, dynamic>{
      'attachLabels':
          pulumi.Input.mapInputValue<
            List<GetHybridMonitorSlsTasksTaskAttachLabel>,
      ...
      'matchExpresses':
          pulumi.Input.mapInputValue<
            List<GetHybridMonitorSlsTasksTaskMatchExpress>,
            List<Map<String, dynamic>>
          >(
            matchExpresses,
            (value) =>
      ...
      'slsProcessConfigs':
          pulumi.Input.mapInputValue<
            List<GetHybridMonitorSlsTasksTaskSlsProcessConfig>,
            List<Map<String, dynamic>>
          >(
            slsProcessConfigs,
            (value) =>
  ...
  factory GetHybridMonitorSlsTasksTask.fromMap(Map<String, dynamic> map) {
    return GetHybridMonitorSlsTasksTask(
      attachLabels: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetHybridMonitorSlsTasksTaskAttachLabel>(
          map['attachLabels']!,
          (value) => GetHybridMonitorSlsTasksTaskAttachLabel.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      collectInterval: pulumi.Input.fromValue(map['collectInterval'] as int),
      collectTargetEndpoint: pulumi.Input.fromValue(
        map['collectTargetEndpoint'] as String,
      ),
      collectTargetPath: pulumi.Input.fromValue(
        map['collectTargetPath'] as String,
      ),
      ...
      hybridMonitorSlsTaskId: pulumi.Input.fromValue(
        map['hybridMonitorSlsTaskId'] as String,
      ),
      ...
      matchExpressRelation: pulumi.Input.fromValue(
        map['matchExpressRelation'] as String,
      ),
      matchExpresses: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetHybridMonitorSlsTasksTaskMatchExpress>(
          map['matchExpresses']!,
          (value) => GetHybridMonitorSlsTasksTaskMatchExpress.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      ...
      slsProcessConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetHybridMonitorSlsTasksTaskSlsProcessConfig>(
          map['slsProcessConfigs']!,
          (value) => GetHybridMonitorSlsTasksTaskSlsProcessConfig.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
