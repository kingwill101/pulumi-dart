...
class GetAlarmContactsContact {
  ...
  factory GetAlarmContactsContact.fromMap(Map<String, dynamic> map) {
    return GetAlarmContactsContact(
      alarmContactName: pulumi.Input.fromValue(map['alarmContactName'] as String),
      channelsAliim: pulumi.Input.fromValue(map['channelsAliim'] as String),
      channelsDingWebHook: pulumi.Input.fromValue(map['channelsDingWebHook'] as String),
      ...
      channelsStateAliim: pulumi.Input.fromValue(map['channelsStateAliim'] as String),
      channelsStateDingWebHook: pulumi.Input.fromValue(map['channelsStateDingWebHook'] as String),
      channelsStateMail: pulumi.Input.fromValue(map['channelsStateMail'] as String),
      channelsStatusSms: pulumi.Input.fromValue(map['channelsStatusSms'] as String),
