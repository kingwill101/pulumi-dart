...
class GetMetricRuleBlackListsList {
  ...
  factory GetMetricRuleBlackListsList.fromMap(Map<String, dynamic> map) {
    return GetMetricRuleBlackListsList(
      ...
      metricRuleBlackListId: pulumi.Input.fromValue(map['metricRuleBlackListId'] as String),
      metricRuleBlackListName: pulumi.Input.fromValue(map['metricRuleBlackListName'] as String),
      metrics: pulumi.Input.fromValue(pulumi.Input.decodeList<GetMetricRuleBlackListsListMetric>(map['metrics']!, (value) => GetMetricRuleBlackListsListMetric.fromMap((value as Map).cast<String, dynamic>()))),
      namespace: pulumi.Input.fromValue(map['namespace'] as String),
      scopeType: pulumi.Input.fromValue(map['scopeType'] as String),
      scopeValues: pulumi.Input.fromValue((map['scopeValues'] as List).cast<String>()),
    );
  }
}
