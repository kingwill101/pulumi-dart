    ...
    return <String, dynamic>{
      'labels':
          pulumi.Input.mapInputValue<
            List<GetHybridMonitorDatasDataLabel>,
      ...
      'values':
          pulumi.Input.mapInputValue<
            List<GetHybridMonitorDatasDataValue>,
            List<Map<String, dynamic>>
          >(
            values,
            (value) =>
  ...
  factory GetHybridMonitorDatasData.fromMap(Map<String, dynamic> map) {
    return GetHybridMonitorDatasData(
      labels: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetHybridMonitorDatasDataLabel>(
          map['labels']!,
          (value) => GetHybridMonitorDatasDataLabel.fromMap(
      ...
      values: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetHybridMonitorDatasDataValue>(
          map['values']!,
          (value) => GetHybridMonitorDatasDataValue.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
