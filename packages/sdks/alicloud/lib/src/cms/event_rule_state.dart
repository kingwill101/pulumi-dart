...
class EventRuleState {
  ...
  factory EventRuleState.fromMap(Map<String, dynamic> map) {
    return EventRuleState(
      ...
      eventPattern: (() { final guardedValue = map['eventPattern']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EventRuleEventPattern.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
