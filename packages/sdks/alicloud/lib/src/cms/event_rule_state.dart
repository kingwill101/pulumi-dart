...
class EventRuleState {
  ...
  EventRuleState({
    ...
    pulumi.Output<EventRuleEventPattern>? eventPattern,
    ...
    pulumi.Output<List<EventRuleWebhookParameter>>? webhookParameters,
      ...
      eventPattern = pulumi.Input.asOptionalInput<EventRuleEventPattern>(eventPattern),
  ...
  factory EventRuleState.fromMap(Map<String, dynamic> map) {
    return EventRuleState(
      ...
      eventPattern: map['eventPattern'] == null ? null : pulumi.Output.create<EventRuleEventPattern>(EventRuleEventPattern.fromMap((map['eventPattern'] as Map).cast<String, dynamic>())),
