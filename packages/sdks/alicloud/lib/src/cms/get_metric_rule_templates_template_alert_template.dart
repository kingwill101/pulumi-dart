...
class GetMetricRuleTemplatesTemplateAlertTemplate {
  ...
  factory GetMetricRuleTemplatesTemplateAlertTemplate.fromMap(Map<String, dynamic> map) {
    return GetMetricRuleTemplatesTemplateAlertTemplate(
      ...
      escalations: pulumi.Input.fromValue(pulumi.Input.decodeList<GetMetricRuleTemplatesTemplateAlertTemplateEscalation>(map['escalations']!, (value) => GetMetricRuleTemplatesTemplateAlertTemplateEscalation.fromMap((value as Map).cast<String, dynamic>()))),
