...
class HybridMonitorSlsTaskSlsProcessConfigExpress {
  ...
  HybridMonitorSlsTaskSlsProcessConfigExpress({this.alias, this.express});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'alias': ?alias, 'express': ?express};
  }

  factory HybridMonitorSlsTaskSlsProcessConfigExpress.fromMap(
    ...
    return HybridMonitorSlsTaskSlsProcessConfigExpress(
      ...
      express: (() {
        final guardedValue = map['express'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
