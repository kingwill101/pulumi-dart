...
class EventRuleArgs {
  ...
  factory EventRuleArgs.fromMap(Map<String, dynamic> map) {
    return EventRuleArgs(
      contactParameters: (() { final guardedValue = map['contactParameters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<EventRuleContactParameter>(guardedValue, (value) => EventRuleContactParameter.fromMap((value as Map).cast<String, dynamic>()))); })(),
      description: (() { final guardedValue = map['description']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      eventPattern: pulumi.Input.fromValue(EventRuleEventPattern.fromMap((map['eventPattern']! as Map).cast<String, dynamic>())),
      fcParameters: (() { final guardedValue = map['fcParameters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<EventRuleFcParameter>(guardedValue, (value) => EventRuleFcParameter.fromMap((value as Map).cast<String, dynamic>()))); })(),
      groupId: (() { final guardedValue = map['groupId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      mnsParameters: (() { final guardedValue = map['mnsParameters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<EventRuleMnsParameter>(guardedValue, (value) => EventRuleMnsParameter.fromMap((value as Map).cast<String, dynamic>()))); })(),
      openApiParameters: (() { final guardedValue = map['openApiParameters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<EventRuleOpenApiParameter>(guardedValue, (value) => EventRuleOpenApiParameter.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      slsParameters: (() { final guardedValue = map['slsParameters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<EventRuleSlsParameter>(guardedValue, (value) => EventRuleSlsParameter.fromMap((value as Map).cast<String, dynamic>()))); })(),
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      webhookParameters: (() { final guardedValue = map['webhookParameters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<EventRuleWebhookParameter>(guardedValue, (value) => EventRuleWebhookParameter.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
