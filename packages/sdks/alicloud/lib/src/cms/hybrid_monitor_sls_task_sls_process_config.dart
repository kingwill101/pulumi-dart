...
class HybridMonitorSlsTaskSlsProcessConfig {
  ...
  final pulumi.Input<List<HybridMonitorSlsTaskSlsProcessConfigExpress>>?
  expresses;
  ...
  final pulumi.Input<List<HybridMonitorSlsTaskSlsProcessConfigGroupBy>>?
  groupBies;

  /// The method that is used to aggregate logs imported from Log Service. See `statistics` below.
  final pulumi.Input<List<HybridMonitorSlsTaskSlsProcessConfigStatistic>>?
  statistics;
    ...
    return <String, dynamic>{
      'expresses':
          ?pulumi.Input.mapOptionalInputValue<
            List<HybridMonitorSlsTaskSlsProcessConfigExpress>,
      ...
      'groupBies':
          ?pulumi.Input.mapOptionalInputValue<
            List<HybridMonitorSlsTaskSlsProcessConfigGroupBy>,
            List<Map<String, dynamic>>
          >(
            groupBies,
            (value) =>
      ...
      'statistics':
          ?pulumi.Input.mapOptionalInputValue<
            List<HybridMonitorSlsTaskSlsProcessConfigStatistic>,
            List<Map<String, dynamic>>
          >(
            statistics,
            (value) =>
  ...
  factory HybridMonitorSlsTaskSlsProcessConfig.fromMap(
    Map<String, dynamic> map,
  ) {
    return HybridMonitorSlsTaskSlsProcessConfig(
      expresses: (() {
        final guardedValue = map['expresses'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<HybridMonitorSlsTaskSlsProcessConfigExpress>(
            guardedValue,
            (value) => HybridMonitorSlsTaskSlsProcessConfigExpress.fromMap(
      ...
      filter: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          HybridMonitorSlsTaskSlsProcessConfigFilter.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      groupBies: (() {
        final guardedValue = map['groupBies'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<HybridMonitorSlsTaskSlsProcessConfigGroupBy>(
            guardedValue,
            (value) => HybridMonitorSlsTaskSlsProcessConfigGroupBy.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      statistics: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<HybridMonitorSlsTaskSlsProcessConfigStatistic>(
            guardedValue,
            (value) => HybridMonitorSlsTaskSlsProcessConfigStatistic.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
