...
class HybridMonitorSlsTaskState {
  ...
  const HybridMonitorSlsTaskState({
    this.attachLabels,
  ...
  factory HybridMonitorSlsTaskState.fromMap(Map<String, dynamic> map) {
    return HybridMonitorSlsTaskState(
      attachLabels: (() { final guardedValue = map['attachLabels']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<HybridMonitorSlsTaskAttachLabel>(guardedValue, (value) => HybridMonitorSlsTaskAttachLabel.fromMap((value as Map).cast<String, dynamic>()))); })(),
      collectInterval: (() { final guardedValue = map['collectInterval']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      collectTargetType: (() { final guardedValue = map['collectTargetType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      description: (() { final guardedValue = map['description']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      namespace: (() { final guardedValue = map['namespace']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      slsProcessConfig: (() { final guardedValue = map['slsProcessConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HybridMonitorSlsTaskSlsProcessConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
