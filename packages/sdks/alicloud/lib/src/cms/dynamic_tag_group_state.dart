...
class DynamicTagGroupState {
  ...
  factory DynamicTagGroupState.fromMap(Map<String, dynamic> map) {
    return DynamicTagGroupState(
      contactGroupLists: (() { final guardedValue = map['contactGroupLists']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      ...
      matchExpresses: (() { final guardedValue = map['matchExpresses']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DynamicTagGroupMatchExpress>(guardedValue, (value) => DynamicTagGroupMatchExpress.fromMap((value as Map).cast<String, dynamic>()))); })(),
