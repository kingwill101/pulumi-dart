...
class SiteMonitorState {
    ...
    return <String, dynamic>{
      ...
      'customSchedule':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(customSchedule, (value) => value.toMap()),
      'interval': ?interval,
      'ispCities':
          ?pulumi.Input.mapOptionalInputValue<
            List<SiteMonitorIspCity>,
  ...
  factory SiteMonitorState.fromMap(Map<String, dynamic> map) {
    return SiteMonitorState(
      ...
      agentGroup: (() {
        final guardedValue = map['agentGroup'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      alertIds: (() {
        final guardedValue = map['alertIds'];
        if (guardedValue == null) return null;
      ...
      customSchedule: (() {
        final guardedValue = map['customSchedule'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SiteMonitorCustomSchedule.fromMap(
      ...
      ispCities: (() {
        final guardedValue = map['ispCities'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SiteMonitorIspCity>(
            guardedValue,
            (value) => SiteMonitorIspCity.fromMap(
      ...
      optionJson: (() {
        final guardedValue = map['optionJson'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SiteMonitorOptionJson.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      optionsJson: (() {
        final guardedValue = map['optionsJson'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      status: (() {
      ...
      taskState: (() {
        final guardedValue = map['taskState'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      taskType: (() {
