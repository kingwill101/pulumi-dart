...
class GetMetricRuleTemplatesTemplate {
  ...
  final pulumi.Input<List<GetMetricRuleTemplatesTemplateAlertTemplate>>
  alertTemplates;
    ...
    return <String, dynamic>{
      'alertTemplates':
          pulumi.Input.mapInputValue<
            List<GetMetricRuleTemplatesTemplateAlertTemplate>,
  ...
  factory GetMetricRuleTemplatesTemplate.fromMap(Map<String, dynamic> map) {
    return GetMetricRuleTemplatesTemplate(
      alertTemplates: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetMetricRuleTemplatesTemplateAlertTemplate>(
          map['alertTemplates']!,
          (value) => GetMetricRuleTemplatesTemplateAlertTemplate.fromMap(
      ...
      metricRuleTemplateName: pulumi.Input.fromValue(
        map['metricRuleTemplateName'] as String,
      ),
