...
class HybridMonitorSlsTaskSlsProcessConfigFilter {
  ...
  factory HybridMonitorSlsTaskSlsProcessConfigFilter.fromMap(Map<String, dynamic> map) {
    return HybridMonitorSlsTaskSlsProcessConfigFilter(
      filters: (() { final guardedValue = map['filters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<HybridMonitorSlsTaskSlsProcessConfigFilterFilter>(guardedValue, (value) => HybridMonitorSlsTaskSlsProcessConfigFilterFilter.fromMap((value as Map).cast<String, dynamic>()))); })(),
