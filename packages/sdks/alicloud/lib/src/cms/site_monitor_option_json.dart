...
class SiteMonitorOptionJson {
    ...
    return <String, dynamic>{
      'assertions':
          ?pulumi.Input.mapOptionalInputValue<
            List<SiteMonitorOptionJsonAssertion>,
  ...
  factory SiteMonitorOptionJson.fromMap(Map<String, dynamic> map) {
    return SiteMonitorOptionJson(
      assertions: (() {
        final guardedValue = map['assertions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SiteMonitorOptionJsonAssertion>(
            guardedValue,
            (value) => SiteMonitorOptionJsonAssertion.fromMap(
      ...
      diagnosisMtr: (() {
        final guardedValue = map['diagnosisMtr'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      diagnosisPing: (() {
        final guardedValue = map['diagnosisPing'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      dnsHijackWhitelist: (() {
      ...
      dnsMatchRule: (() {
        final guardedValue = map['dnsMatchRule'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      dnsServer: (() {
      ...
      expectValue: (() {
        final guardedValue = map['expectValue'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      failureRate: (() {
        final guardedValue = map['failureRate'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      header: (() {
      ...
      isBaseEncode: (() {
        final guardedValue = map['isBaseEncode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      matchRule: (() {
        final guardedValue = map['matchRule'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      minTlsVersion: (() {
      ...
      pingNum: (() {
        final guardedValue = map['pingNum'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      pingPort: (() {
        final guardedValue = map['pingPort'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      pingType: (() {
        final guardedValue = map['pingType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      port: (() {
      ...
      requestContent: (() {
        final guardedValue = map['requestContent'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      requestFormat: (() {
        final guardedValue = map['requestFormat'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      responseContent: (() {
        final guardedValue = map['responseContent'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      responseFormat: (() {
        final guardedValue = map['responseFormat'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      timeout: (() {
