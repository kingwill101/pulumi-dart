...
class GetMetricRuleTemplatesArgs {
  ...
  factory GetMetricRuleTemplatesArgs.fromMap(Map<String, dynamic> map) {
    return GetMetricRuleTemplatesArgs(
      ...
      metricRuleTemplateName: (() { final guardedValue = map['metricRuleTemplateName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
