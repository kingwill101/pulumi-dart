...
class MetricRuleBlackListState {
  ...
  factory MetricRuleBlackListState.fromMap(Map<String, dynamic> map) {
    return MetricRuleBlackListState(
      ...
      metricRuleBlackListName: (() { final guardedValue = map['metricRuleBlackListName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
