...
class GetHybridMonitorSlsTasksTaskSlsProcessConfigFilter {
  ...
  final pulumi.Input<
    List<GetHybridMonitorSlsTasksTaskSlsProcessConfigFilterFilter>
  >
  filters;
  ...
  factory GetHybridMonitorSlsTasksTaskSlsProcessConfigFilter.fromMap(
    ...
    return GetHybridMonitorSlsTasksTaskSlsProcessConfigFilter(
      filters: pulumi.Input.fromValue(
        ...
        >(
          map['filters']!,
          (value) =>
              GetHybridMonitorSlsTasksTaskSlsProcessConfigFilterFilter.fromMap(
