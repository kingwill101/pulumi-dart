...
class MetricRuleTemplateState {
  ...
  factory MetricRuleTemplateState.fromMap(Map<String, dynamic> map) {
    return MetricRuleTemplateState(
      alertTemplates: (() { final guardedValue = map['alertTemplates']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<MetricRuleTemplateAlertTemplate>(guardedValue, (value) => MetricRuleTemplateAlertTemplate.fromMap((value as Map).cast<String, dynamic>()))); })(),
      applyMode: (() { final guardedValue = map['applyMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      notifyLevel: (() { final guardedValue = map['notifyLevel']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      restVersion: (() { final guardedValue = map['restVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
