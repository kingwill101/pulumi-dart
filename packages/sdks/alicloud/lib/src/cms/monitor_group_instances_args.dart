...
class MonitorGroupInstancesArgs {
  ...
  factory MonitorGroupInstancesArgs.fromMap(Map<String, dynamic> map) {
    return MonitorGroupInstancesArgs(
      ...
      instances: pulumi.Input.fromValue(pulumi.Input.decodeList<MonitorGroupInstancesInstance>(map['instances']!, (value) => MonitorGroupInstancesInstance.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
