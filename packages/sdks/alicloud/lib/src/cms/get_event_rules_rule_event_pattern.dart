...
class GetEventRulesRuleEventPattern {
  ...
  factory GetEventRulesRuleEventPattern.fromMap(Map<String, dynamic> map) {
    return GetEventRulesRuleEventPattern(
      eventTypeLists: pulumi.Input.fromValue((map['eventTypeLists'] as List).cast<String>()),
      keywordFilters: pulumi.Input.fromValue(pulumi.Input.decodeList<GetEventRulesRuleEventPatternKeywordFilter>(map['keywordFilters']!, (value) => GetEventRulesRuleEventPatternKeywordFilter.fromMap((value as Map).cast<String, dynamic>()))),
      levelLists: pulumi.Input.fromValue((map['levelLists'] as List).cast<String>()),
      nameLists: pulumi.Input.fromValue((map['nameLists'] as List).cast<String>()),
