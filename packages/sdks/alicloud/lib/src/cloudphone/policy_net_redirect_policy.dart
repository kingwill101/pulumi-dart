...
class PolicyNetRedirectPolicy {
  ...
  factory PolicyNetRedirectPolicy.fromMap(Map<String, dynamic> map) {
    return PolicyNetRedirectPolicy(
      customProxy: map['customProxy'] == null ? null : map['customProxy'] as String,
      hostAddr: map['hostAddr'] == null ? null : map['hostAddr'] as String,
      netRedirect: map['netRedirect'] == null ? null : map['netRedirect'] as String,
      ...
      proxyUserName: map['proxyUserName'] == null ? null : map['proxyUserName'] as String,
    );
  }
}
