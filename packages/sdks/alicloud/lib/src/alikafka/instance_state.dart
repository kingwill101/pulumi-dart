...
class InstanceState {
  ...
  factory InstanceState.fromMap(Map<String, dynamic> map) {
    return InstanceState(
      ...
      confluentConfig: (() { final guardedValue = map['confluentConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceConfluentConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      defaultTopicPartitionNum: (() { final guardedValue = map['defaultTopicPartitionNum']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      deployType: (() { final guardedValue = map['deployType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      diskType: (() { final guardedValue = map['diskType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      domainEndpoint: (() { final guardedValue = map['domainEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      eipMax: (() { final guardedValue = map['eipMax']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      enableAutoGroup: (() { final guardedValue = map['enableAutoGroup']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      enableAutoTopic: (() { final guardedValue = map['enableAutoTopic']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      endPoint: (() { final guardedValue = map['endPoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      groupLeft: (() { final guardedValue = map['groupLeft']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      groupUsed: (() { final guardedValue = map['groupUsed']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      instanceType: (() { final guardedValue = map['instanceType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ioMax: (() { final guardedValue = map['ioMax']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ioMaxSpec: (() { final guardedValue = map['ioMaxSpec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      isPartitionBuy: (() { final guardedValue = map['isPartitionBuy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      kmsKeyId: (() { final guardedValue = map['kmsKeyId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      paidType: (() { final guardedValue = map['paidType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      partitionLeft: (() { final guardedValue = map['partitionLeft']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      partitionUsed: (() { final guardedValue = map['partitionUsed']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      password: (() { final guardedValue = map['password']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      resourceGroupId: (() { final guardedValue = map['resourceGroupId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      saslDomainEndpoint: (() { final guardedValue = map['saslDomainEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      selectedZones: (() { final guardedValue = map['selectedZones']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      serverlessConfig: (() { final guardedValue = map['serverlessConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceServerlessConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      sslDomainEndpoint: (() { final guardedValue = map['sslDomainEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      sslEndpoint: (() { final guardedValue = map['sslEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      topicLeft: (() { final guardedValue = map['topicLeft']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      topicNumOfBuy: (() { final guardedValue = map['topicNumOfBuy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      topicQuota: (() { final guardedValue = map['topicQuota']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      topicUsed: (() { final guardedValue = map['topicUsed']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
