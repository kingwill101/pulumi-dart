...
class Instance extends pulumi.CustomResource {
  ...
  Instance(
    ...
    confluentConfig = registerOutput<InstanceConfluentConfig>('confluentConfig', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return InstanceConfluentConfig.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    serverlessConfig = registerOutput<InstanceServerlessConfig>('serverlessConfig', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return InstanceServerlessConfig.fromMap((guardedValue as Map).cast<String, dynamic>()); });
