...
import 'scheduled_scaling_rule_state.dart';
...
class ScheduledScalingRule extends pulumi.CustomResource {
  ...
  static ScheduledScalingRule get(
    String name,
    pulumi.Input<String> id, {
    ScheduledScalingRuleState? state,
  }) {
    return ScheduledScalingRule._get(
      name,
      state: state?.toMap(),
