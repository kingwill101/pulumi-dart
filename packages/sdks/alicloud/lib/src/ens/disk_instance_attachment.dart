...
import 'disk_instance_attachment_state.dart';
...
class DiskInstanceAttachment extends pulumi.CustomResource {
  ...
  static DiskInstanceAttachment get(
    String name,
    pulumi.Input<String> id, {
    DiskInstanceAttachmentState? state,
  }) {
    return DiskInstanceAttachment._get(
      name,
      state: state?.toMap(),
