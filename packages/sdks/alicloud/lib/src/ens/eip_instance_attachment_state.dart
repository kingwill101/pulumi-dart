...
class EipInstanceAttachmentState {
  ...
  const EipInstanceAttachmentState({
    this.allocationId,
    this.instanceId,
    this.instanceType,
    this.standby,
  ...
  factory EipInstanceAttachmentState.fromMap(Map<String, dynamic> map) {
    return EipInstanceAttachmentState(
      ...
      standby: (() { final guardedValue = map['standby']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
