...
class Instance extends pulumi.CustomResource {
  ...
  Instance(
    ...
    schedulingPriceStrategy = registerOutput<String?>('schedulingPriceStrategy');
    ...
    systemDisk = registerOutput<InstanceSystemDisk?>('systemDisk', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return InstanceSystemDisk.fromMap((guardedValue as Map).cast<String, dynamic>()); });
