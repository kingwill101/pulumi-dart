    ...
    return <String, dynamic>{
      ...
      'sources':
          pulumi.Input.mapInputValue<
            List<DomainNewSource>,
            List<Map<String, dynamic>>
          >(
            sources,
            (value) =>
                pulumi.Input.encodeList<DomainNewSource, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return DomainNewArgs(
      ...
      certificateConfig: (() {
        ...
        return pulumi.Input.fromValue(
          DomainNewCertificateConfig.fromMap(
      ...
      sources: pulumi.Input.fromValue(
        pulumi.Input.decodeList<DomainNewSource>(
          map['sources']!,
          (value) =>
              DomainNewSource.fromMap((value as Map).cast<String, dynamic>()),
        ),
      ),
      status: (() {
