...
class GetBlockedRegionsRegion {
  ...
  factory GetBlockedRegionsRegion.fromMap(Map<String, dynamic> map) {
    return GetBlockedRegionsRegion(
      ...
      countriesAndRegions: pulumi.Input.fromValue(map['countriesAndRegions'] as String),
      countriesAndRegionsName: pulumi.Input.fromValue(map['countriesAndRegionsName'] as String),
    );
  }
}
