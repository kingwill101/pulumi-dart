...
class K8sSlbAttachmentState {
  ...
  K8sSlbAttachmentState({this.appId, this.slbConfigs});
    ...
    return <String, dynamic>{
      ...
      'slbConfigs':
          ?pulumi.Input.mapOptionalInputValue<
            List<K8sSlbAttachmentSlbConfig>,
  ...
  factory K8sSlbAttachmentState.fromMap(Map<String, dynamic> map) {
    return K8sSlbAttachmentState(
      ...
      slbConfigs: (() {
        final guardedValue = map['slbConfigs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<K8sSlbAttachmentSlbConfig>(
            guardedValue,
            (value) => K8sSlbAttachmentSlbConfig.fromMap(
