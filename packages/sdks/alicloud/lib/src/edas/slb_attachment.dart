...
import 'slb_attachment_args.dart';
import 'slb_attachment_state.dart';
...
class SlbAttachment extends pulumi.CustomResource {
  ...
  /// Creates a new [SlbAttachment].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [SlbAttachment]. {@macro pulumi_edas_slb_attachment_slb_attachment_args_doc}
  ...
  static SlbAttachment get(
    String name,
    pulumi.Input<String> id, {
    SlbAttachmentState? state,
  }) {
    return SlbAttachment._get(
      name,
      state: state?.toMap(),
