  ...
  factory K8sApplicationArgs.fromMap(Map<String, dynamic> map) {
    return K8sApplicationArgs(
      applicationDescriotion: (() {
        final guardedValue = map['applicationDescriotion'];
      ...
      internetSlbPort: (() {
        final guardedValue = map['internetSlbPort'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      internetSlbProtocol: (() {
        final guardedValue = map['internetSlbProtocol'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      internetTargetPort: (() {
        final guardedValue = map['internetTargetPort'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      jdk: (() {
      ...
      limitMCpu: (() {
        final guardedValue = map['limitMCpu'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      limitMem: (() {
        final guardedValue = map['limitMem'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      liveness: (() {
      ...
      localVolume: (() {
        final guardedValue = map['localVolume'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      logicalRegionId: (() {
      ...
      mountDescs: (() {
        final guardedValue = map['mountDescs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      namespace: (() {
      ...
      requestsMCpu: (() {
        final guardedValue = map['requestsMCpu'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      requestsMem: (() {
        final guardedValue = map['requestsMem'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      webContainer: (() {
