...
class K8sSlbAttachmentSlbConfig {
  ...
  factory K8sSlbAttachmentSlbConfig.fromMap(Map<String, dynamic> map) {
    return K8sSlbAttachmentSlbConfig(
      ...
      portMappings: pulumi.Input.fromValue(pulumi.Input.decodeList<K8sSlbAttachmentSlbConfigPortMapping>(map['portMappings']!, (value) => K8sSlbAttachmentSlbConfigPortMapping.fromMap((value as Map).cast<String, dynamic>()))),
