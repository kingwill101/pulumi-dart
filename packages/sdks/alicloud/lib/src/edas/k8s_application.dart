...
class K8sApplication extends pulumi.CustomResource {
  ...
  K8sApplication(
    ...
    applicationDescriotion = registerOutput<String?>('applicationDescriotion');
    applicationName = registerOutput<String>('applicationName');
    clusterId = registerOutput<String>('clusterId');
    command = registerOutput<String?>('command');
    commandArgs = registerOutput<List<String>?>('commandArgs');
    edasContainerVersion = registerOutput<String?>('edasContainerVersion');
    envs = registerOutput<Map<String, String>?>('envs');
    imageUrl = registerOutput<String?>('imageUrl');
    internetSlbId = registerOutput<String?>('internetSlbId');
    internetSlbPort = registerOutput<int?>('internetSlbPort');
    internetSlbProtocol = registerOutput<String?>('internetSlbProtocol');
    internetTargetPort = registerOutput<int?>('internetTargetPort');
    jdk = registerOutput<String?>('jdk');
    limitMCpu = registerOutput<int?>('limitMCpu');
    limitMem = registerOutput<int?>('limitMem');
    liveness = registerOutput<String?>('liveness');
    localVolume = registerOutput<String?>('localVolume');
    logicalRegionId = registerOutput<String?>('logicalRegionId');
    mountDescs = registerOutput<String?>('mountDescs');
    namespace = registerOutput<String?>('namespace');
    nasId = registerOutput<String?>('nasId');
    ...
    requestsMCpu = registerOutput<int?>('requestsMCpu');
    requestsMem = registerOutput<int?>('requestsMem');
    webContainer = registerOutput<String?>('webContainer');
  }
