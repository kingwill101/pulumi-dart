...
class K8sSlbAttachmentSlbConfigPortMapping {
  ...
  final pulumi.Input<K8sSlbAttachmentSlbConfigPortMappingServicePort>
  servicePort;
    ...
    return <String, dynamic>{
      ...
      'servicePort':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(servicePort, (value) => value.toMap()),
    };
  }

  factory K8sSlbAttachmentSlbConfigPortMapping.fromMap(
    ...
    return K8sSlbAttachmentSlbConfigPortMapping(
      ...
      loadbalancerProtocol: pulumi.Input.fromValue(
        map['loadbalancerProtocol'] as String,
      ),
      servicePort: pulumi.Input.fromValue(
        K8sSlbAttachmentSlbConfigPortMappingServicePort.fromMap(
          (map['servicePort']! as Map).cast<String, dynamic>(),
        ),
      ),
    );
  }
