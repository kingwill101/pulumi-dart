...
class GetProductProductSkus {
  ...
  factory GetProductProductSkus.fromMap(Map<String, dynamic> map) {
    return GetProductProductSkus(
      images: pulumi.Input.fromValue(pulumi.Input.decodeList<GetProductProductSkusImage>(map['images']!, (value) => GetProductProductSkusImage.fromMap((value as Map).cast<String, dynamic>()))),
      packageVersions: pulumi.Input.fromValue(pulumi.Input.decodeList<GetProductProductSkusPackageVersion>(map['packageVersions']!, (value) => GetProductProductSkusPackageVersion.fromMap((value as Map).cast<String, dynamic>()))),
