...
class GetProductsResult {
  ...
  factory GetProductsResult.fromMap(Map<String, dynamic> map) {
    return GetProductsResult(
      ...
      searchTerm: (() { final guardedValue = map['searchTerm']; if (guardedValue == null) return null; return guardedValue as String; })(),
      sort: (() { final guardedValue = map['sort']; if (guardedValue == null) return null; return guardedValue as String; })(),
      suggestedPrice: (() { final guardedValue = map['suggestedPrice']; if (guardedValue == null) return null; return guardedValue as double; })(),
      supplierId: (() { final guardedValue = map['supplierId']; if (guardedValue == null) return null; return guardedValue as String; })(),
      supplierNameKeyword: (() { final guardedValue = map['supplierNameKeyword']; if (guardedValue == null) return null; return guardedValue as String; })(),
    );
  }
}
