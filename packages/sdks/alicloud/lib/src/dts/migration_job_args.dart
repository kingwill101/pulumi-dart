...
class MigrationJobArgs {
  ...
  MigrationJobArgs({
    ...
    required pulumi.Output<bool> dataInitialization,
    required pulumi.Output<bool> dataSynchronization,
    required pulumi.Output<String> dbList,
    ...
    required pulumi.Output<String> destinationEndpointInstanceType,
    ...
    required pulumi.Output<String> sourceEndpointInstanceType,
    ...
    required pulumi.Output<bool> structureInitialization,
  }) :
  ...
  factory MigrationJobArgs.fromMap(Map<String, dynamic> map) {
    return MigrationJobArgs(
      ...
      dataInitialization: pulumi.Output.create<bool>(map['dataInitialization'] as bool),
      dataSynchronization: pulumi.Output.create<bool>(map['dataSynchronization'] as bool),
      dbList: pulumi.Output.create<String>(map['dbList'] as String),
      ...
      destinationEndpointInstanceType: pulumi.Output.create<String>(map['destinationEndpointInstanceType'] as String),
      ...
      sourceEndpointInstanceType: pulumi.Output.create<String>(map['sourceEndpointInstanceType'] as String),
      ...
      structureInitialization: pulumi.Output.create<bool>(map['structureInitialization'] as bool),
    );
  }
}
