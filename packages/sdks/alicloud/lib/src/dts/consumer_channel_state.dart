...
class ConsumerChannelState {
  ...
  factory ConsumerChannelState.fromMap(Map<String, dynamic> map) {
    return ConsumerChannelState(
      ...
      consumerGroupPassword: (() { final guardedValue = map['consumerGroupPassword']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      consumerGroupUserName: (() { final guardedValue = map['consumerGroupUserName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
