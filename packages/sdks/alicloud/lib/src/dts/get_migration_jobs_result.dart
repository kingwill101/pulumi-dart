...
class GetMigrationJobsResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ids': ids,
      'jobs':
          pulumi.Input.encodeList<GetMigrationJobsJob, Map<String, dynamic>>(
            jobs,
            (value) => value.toMap(),
          ),
      'nameRegex': ?nameRegex,
  ...
  factory GetMigrationJobsResult.fromMap(Map<String, dynamic> map) {
    return GetMigrationJobsResult(
      ...
      jobs: pulumi.Input.decodeList<GetMigrationJobsJob>(
        map['jobs']!,
        (value) =>
            GetMigrationJobsJob.fromMap((value as Map).cast<String, dynamic>()),
      ),
      nameRegex: (() {
