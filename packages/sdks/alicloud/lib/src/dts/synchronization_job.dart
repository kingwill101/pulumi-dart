...
class SynchronizationJob extends pulumi.CustomResource {
  ...
  SynchronizationJob(
    ...
    dataCheckConfigure = registerOutput<String?>('dataCheckConfigure');
    ...
    destinationEndpointOwnerId = registerOutput<String?>('destinationEndpointOwnerId');
    ...
    destinationEndpointRole = registerOutput<String?>('destinationEndpointRole');
    destinationEndpointUserName = registerOutput<String?>('destinationEndpointUserName');
    dtsBisLabel = registerOutput<String?>('dtsBisLabel');
    ...
    jobParameters = registerOutput<String?>('jobParameters');
    ...
    sourceEndpointVswitchId = registerOutput<String?>('sourceEndpointVswitchId');
    status = registerOutput<String>('status');
    structureInitialization = registerOutput<bool>('structureInitialization');
