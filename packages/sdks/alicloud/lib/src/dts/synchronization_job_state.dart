...
class SynchronizationJobState {
  ...
  SynchronizationJobState({
    ...
    pulumi.Output<String>? dataCheckConfigure,
    pulumi.Output<bool>? dataInitialization,
    pulumi.Output<bool>? dataSynchronization,
    ...
    pulumi.Output<String>? destinationEndpointDatabaseName,
    pulumi.Output<String>? destinationEndpointEngineName,
    pulumi.Output<String>? destinationEndpointInstanceId,
    pulumi.Output<String>? destinationEndpointInstanceType,
    pulumi.Output<String>? destinationEndpointIp,
    pulumi.Output<String>? destinationEndpointOracleSid,
    pulumi.Output<String>? destinationEndpointOwnerId,
    pulumi.Output<String>? destinationEndpointPassword,
    pulumi.Output<String>? destinationEndpointPort,
    pulumi.Output<String>? destinationEndpointRegion,
    pulumi.Output<String>? destinationEndpointRole,
    pulumi.Output<String>? destinationEndpointUserName,
    pulumi.Output<String>? dtsBisLabel,
    ...
    pulumi.Output<String>? jobParameters,
    ...
    pulumi.Output<String>? sourceEndpointVswitchId,
    pulumi.Output<String>? status,
    pulumi.Output<bool>? structureInitialization,
    pulumi.Output<String>? synchronizationDirection,
  }) :
      checkpoint = pulumi.Input.asOptionalInput<String>(checkpoint),
      dataCheckConfigure = pulumi.Input.asOptionalInput<String>(dataCheckConfigure),
      dataInitialization = pulumi.Input.asOptionalInput<bool>(dataInitialization),
      dataSynchronization = pulumi.Input.asOptionalInput<bool>(dataSynchronization),
      ...
      destinationEndpointInstanceType = pulumi.Input.asOptionalInput<String>(destinationEndpointInstanceType),
      ...
      destinationEndpointOwnerId = pulumi.Input.asOptionalInput<String>(destinationEndpointOwnerId),
      ...
      destinationEndpointRole = pulumi.Input.asOptionalInput<String>(destinationEndpointRole),
      destinationEndpointUserName = pulumi.Input.asOptionalInput<String>(destinationEndpointUserName),
      dtsBisLabel = pulumi.Input.asOptionalInput<String>(dtsBisLabel),
      ...
      jobParameters = pulumi.Input.asOptionalInput<String>(jobParameters),
      ...
      sourceEndpointVswitchId = pulumi.Input.asOptionalInput<String>(sourceEndpointVswitchId),
      status = pulumi.Input.asOptionalInput<String>(status),
      structureInitialization = pulumi.Input.asOptionalInput<bool>(structureInitialization),
  ...
  factory SynchronizationJobState.fromMap(Map<String, dynamic> map) {
    return SynchronizationJobState(
      ...
      dataCheckConfigure: map['dataCheckConfigure'] == null ? null : pulumi.Output.create<String>(map['dataCheckConfigure'] as String),
      dataInitialization: map['dataInitialization'] == null ? null : pulumi.Output.create<bool>(map['dataInitialization'] as bool),
      dataSynchronization: map['dataSynchronization'] == null ? null : pulumi.Output.create<bool>(map['dataSynchronization'] as bool),
      ...
      destinationEndpointDatabaseName: map['destinationEndpointDatabaseName'] == null ? null : pulumi.Output.create<String>(map['destinationEndpointDatabaseName'] as String),
      ...
      destinationEndpointInstanceId: map['destinationEndpointInstanceId'] == null ? null : pulumi.Output.create<String>(map['destinationEndpointInstanceId'] as String),
      destinationEndpointInstanceType: map['destinationEndpointInstanceType'] == null ? null : pulumi.Output.create<String>(map['destinationEndpointInstanceType'] as String),
      destinationEndpointIp: map['destinationEndpointIp'] == null ? null : pulumi.Output.create<String>(map['destinationEndpointIp'] as String),
      destinationEndpointOracleSid: map['destinationEndpointOracleSid'] == null ? null : pulumi.Output.create<String>(map['destinationEndpointOracleSid'] as String),
      destinationEndpointOwnerId: map['destinationEndpointOwnerId'] == null ? null : pulumi.Output.create<String>(map['destinationEndpointOwnerId'] as String),
      destinationEndpointPassword: map['destinationEndpointPassword'] == null ? null : pulumi.Output.create<String>(map['destinationEndpointPassword'] as String),
      destinationEndpointPort: map['destinationEndpointPort'] == null ? null : pulumi.Output.create<String>(map['destinationEndpointPort'] as String),
      ...
      destinationEndpointRole: map['destinationEndpointRole'] == null ? null : pulumi.Output.create<String>(map['destinationEndpointRole'] as String),
      destinationEndpointUserName: map['destinationEndpointUserName'] == null ? null : pulumi.Output.create<String>(map['destinationEndpointUserName'] as String),
      dtsBisLabel: map['dtsBisLabel'] == null ? null : pulumi.Output.create<String>(map['dtsBisLabel'] as String),
      ...
      jobParameters: map['jobParameters'] == null ? null : pulumi.Output.create<String>(map['jobParameters'] as String),
      ...
      sourceEndpointVswitchId: map['sourceEndpointVswitchId'] == null ? null : pulumi.Output.create<String>(map['sourceEndpointVswitchId'] as String),
      status: map['status'] == null ? null : pulumi.Output.create<String>(map['status'] as String),
      structureInitialization: map['structureInitialization'] == null ? null : pulumi.Output.create<bool>(map['structureInitialization'] as bool),
