...
class SynchronizationInstanceState {
  ...
  /// Creates a new [SynchronizationInstanceState].
  ...
  factory SynchronizationInstanceState.fromMap(Map<String, dynamic> map) {
    return SynchronizationInstanceState(
      autoPay: (() { final guardedValue = map['autoPay']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      autoStart: (() { final guardedValue = map['autoStart']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
