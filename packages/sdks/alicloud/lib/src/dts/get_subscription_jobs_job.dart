...
class GetSubscriptionJobsJob {
  ...
  /// Network information.
  final pulumi.Input<List<GetSubscriptionJobsJobSubscriptionHost>>
  subscriptionHosts;
    ...
    return <String, dynamic>{
      ...
      'subscriptionHosts':
          pulumi.Input.mapInputValue<
            List<GetSubscriptionJobsJobSubscriptionHost>,
  ...
  factory GetSubscriptionJobsJob.fromMap(Map<String, dynamic> map) {
    return GetSubscriptionJobsJob(
      ...
      subscriptionDataTypeDdl: pulumi.Input.fromValue(
        map['subscriptionDataTypeDdl'] as bool,
      ),
      subscriptionDataTypeDml: pulumi.Input.fromValue(
        map['subscriptionDataTypeDml'] as bool,
      ),
      subscriptionHosts: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetSubscriptionJobsJobSubscriptionHost>(
          map['subscriptionHosts']!,
          (value) => GetSubscriptionJobsJobSubscriptionHost.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      subscriptionInstanceNetworkType: pulumi.Input.fromValue(
        map['subscriptionInstanceNetworkType'] as String,
      ),
      subscriptionInstanceVpcId: pulumi.Input.fromValue(
        map['subscriptionInstanceVpcId'] as String,
      ),
      subscriptionInstanceVswitchId: pulumi.Input.fromValue(
        map['subscriptionInstanceVswitchId'] as String,
      ),
