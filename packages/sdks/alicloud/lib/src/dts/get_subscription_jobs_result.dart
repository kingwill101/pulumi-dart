...
class GetSubscriptionJobsResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ids': ids,
      'jobs':
          pulumi.Input.encodeList<GetSubscriptionJobsJob, Map<String, dynamic>>(
            jobs,
            (value) => value.toMap(),
          ),
      'nameRegex': ?nameRegex,
  ...
  factory GetSubscriptionJobsResult.fromMap(Map<String, dynamic> map) {
    return GetSubscriptionJobsResult(
      ...
      jobs: pulumi.Input.decodeList<GetSubscriptionJobsJob>(
        map['jobs']!,
        (value) => GetSubscriptionJobsJob.fromMap(
