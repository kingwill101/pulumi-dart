...
class SubscriptionJobArgs {
  ...
  factory SubscriptionJobArgs.fromMap(Map<String, dynamic> map) {
    return SubscriptionJobArgs(
      ...
      subscriptionDataTypeDdl: (() { final guardedValue = map['subscriptionDataTypeDdl']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      subscriptionDataTypeDml: (() { final guardedValue = map['subscriptionDataTypeDml']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      subscriptionInstanceNetworkType: (() { final guardedValue = map['subscriptionInstanceNetworkType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      subscriptionInstanceVpcId: (() { final guardedValue = map['subscriptionInstanceVpcId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      subscriptionInstanceVswitchId: (() { final guardedValue = map['subscriptionInstanceVswitchId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
