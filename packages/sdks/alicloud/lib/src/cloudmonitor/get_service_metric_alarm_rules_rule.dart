...
class GetServiceMetricAlarmRulesRule {
  ...
  factory GetServiceMetricAlarmRulesRule.fromMap(Map<String, dynamic> map) {
    return GetServiceMetricAlarmRulesRule(
      compositeExpression: pulumi.Input.fromValue(GetServiceMetricAlarmRulesRuleCompositeExpression.fromMap((map['compositeExpression']! as Map).cast<String, dynamic>())),
      ...
      escalations: pulumi.Input.fromValue(GetServiceMetricAlarmRulesRuleEscalations.fromMap((map['escalations']! as Map).cast<String, dynamic>())),
      id: pulumi.Input.fromValue(map['id'] as String),
      labels: pulumi.Input.fromValue(pulumi.Input.decodeList<GetServiceMetricAlarmRulesRuleLabel>(map['labels']!, (value) => GetServiceMetricAlarmRulesRuleLabel.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      prometheus: pulumi.Input.fromValue(GetServiceMetricAlarmRulesRulePrometheus.fromMap((map['prometheus']! as Map).cast<String, dynamic>())),
