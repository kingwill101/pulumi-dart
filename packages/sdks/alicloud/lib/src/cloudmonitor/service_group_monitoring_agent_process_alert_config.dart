...
class ServiceGroupMonitoringAgentProcessAlertConfig {
  ...
  factory ServiceGroupMonitoringAgentProcessAlertConfig.fromMap(Map<String, dynamic> map) {
    return ServiceGroupMonitoringAgentProcessAlertConfig(
      ...
      escalationsLevel: pulumi.Input.fromValue(map['escalationsLevel'] as String),
      ...
      targetLists: (() { final guardedValue = map['targetLists']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ServiceGroupMonitoringAgentProcessAlertConfigTargetList>(guardedValue, (value) => ServiceGroupMonitoringAgentProcessAlertConfigTargetList.fromMap((value as Map).cast<String, dynamic>()))); })(),
