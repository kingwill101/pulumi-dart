...
class GetServiceMetricAlarmRulesRuleEscalations {
  ...
  factory GetServiceMetricAlarmRulesRuleEscalations.fromMap(Map<String, dynamic> map) {
    return GetServiceMetricAlarmRulesRuleEscalations(
      critical: (GetServiceMetricAlarmRulesRuleEscalationsCritical.fromMap((map['critical'] as Map).cast<String, dynamic>())).input(),
      info: (GetServiceMetricAlarmRulesRuleEscalationsInfo.fromMap((map['info'] as Map).cast<String, dynamic>())).input(),
      warn: (GetServiceMetricAlarmRulesRuleEscalationsWarn.fromMap((map['warn'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
