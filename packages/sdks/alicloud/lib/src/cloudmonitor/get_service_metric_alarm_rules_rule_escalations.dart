...
class GetServiceMetricAlarmRulesRuleEscalations {
  ...
  final pulumi.Input<GetServiceMetricAlarmRulesRuleEscalationsCritical> critical;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'critical': pulumi.Input.mapInputValue<GetServiceMetricAlarmRulesRuleEscalationsCritical, Map<String, dynamic>>(critical, (value) => value.toMap()),
      'info': pulumi.Input.mapInputValue<GetServiceMetricAlarmRulesRuleEscalationsInfo, Map<String, dynamic>>(info, (value) => value.toMap()),
      'warn': pulumi.Input.mapInputValue<GetServiceMetricAlarmRulesRuleEscalationsWarn, Map<String, dynamic>>(warn, (value) => value.toMap()),
    };
  }
  ...
  factory GetServiceMetricAlarmRulesRuleEscalations.fromMap(Map<String, dynamic> map) {
    return GetServiceMetricAlarmRulesRuleEscalations(
      critical: pulumi.Input.fromValue(GetServiceMetricAlarmRulesRuleEscalationsCritical.fromMap((map['critical']! as Map).cast<String, dynamic>())),
      info: pulumi.Input.fromValue(GetServiceMetricAlarmRulesRuleEscalationsInfo.fromMap((map['info']! as Map).cast<String, dynamic>())),
      warn: pulumi.Input.fromValue(GetServiceMetricAlarmRulesRuleEscalationsWarn.fromMap((map['warn']! as Map).cast<String, dynamic>())),
    );
  }
}
