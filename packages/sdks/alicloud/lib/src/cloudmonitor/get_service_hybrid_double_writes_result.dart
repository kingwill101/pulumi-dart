...
class GetServiceHybridDoubleWritesResult {
    ...
    return <String, dynamic>{
      'hybridDoubleWrites':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(hybridDoubleWrites, (value) => value.toMap()),
      'id': id,
      'ids': ids,
      'namespace': ?namespace,
  ...
  factory GetServiceHybridDoubleWritesResult.fromMap(Map<String, dynamic> map) {
    return GetServiceHybridDoubleWritesResult(
      hybridDoubleWrites:
          pulumi
              .Input.decodeList<GetServiceHybridDoubleWritesHybridDoubleWrite>(
            map['hybridDoubleWrites']!,
            (value) => GetServiceHybridDoubleWritesHybridDoubleWrite.fromMap(
