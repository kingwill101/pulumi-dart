...
class ServiceGroupMonitoringAgentProcessArgs {
  ...
  factory ServiceGroupMonitoringAgentProcessArgs.fromMap(Map<String, dynamic> map) {
    return ServiceGroupMonitoringAgentProcessArgs(
      alertConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<ServiceGroupMonitoringAgentProcessAlertConfig>(map['alertConfigs']!, (value) => ServiceGroupMonitoringAgentProcessAlertConfig.fromMap((value as Map).cast<String, dynamic>()))),
