...
import 'service_basic_public_state.dart';
...
/// ```
class ServiceBasicPublic extends pulumi.CustomResource {
  /// The creation time of the resource.
  late final pulumi.Output<String> createTime;

  /// Creates a new [ServiceBasicPublic].
  ...
  static ServiceBasicPublic get(
    String name,
    pulumi.Input<String> id, {
    ServiceBasicPublicState? state,
  }) {
    return ServiceBasicPublic._get(
      name,
      state: state?.toMap(),
