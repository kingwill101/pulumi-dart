...
class ServiceGroupMonitoringAgentProcessState {
  ...
  factory ServiceGroupMonitoringAgentProcessState.fromMap(
    ...
    return ServiceGroupMonitoringAgentProcessState(
      alertConfigs: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<ServiceGroupMonitoringAgentProcessAlertConfig>(
            guardedValue,
      ...
      groupMonitoringAgentProcessId: (() {
        final guardedValue = map['groupMonitoringAgentProcessId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
