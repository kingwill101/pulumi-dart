...
class AuditCallbackArgs {
  ...
  factory AuditCallbackArgs.fromMap(Map<String, dynamic> map) {
    return AuditCallbackArgs(
      auditCallbackName: pulumi.Input.fromValue(map['auditCallbackName'] as String),
      callbackSuggestions: pulumi.Input.fromValue((map['callbackSuggestions'] as List).cast<String>()),
      callbackTypes: pulumi.Input.fromValue((map['callbackTypes'] as List).cast<String>()),
      cryptType: pulumi.Input.fromValue(map['cryptType'] as String),
