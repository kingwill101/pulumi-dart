...
class OssStockTask extends pulumi.CustomResource {
  ...
  OssStockTask(
    ...
    audioAntispamFreezeConfig = registerOutput<String?>(
    ...
    imageTerrorismFreezeConfig = registerOutput<String?>(
    ...
    videoTerrorismFreezeConfig = registerOutput<String?>(
      'videoTerrorismFreezeConfig',
    );
    videoVoiceAntispamFreezeConfig = registerOutput<String?>(
