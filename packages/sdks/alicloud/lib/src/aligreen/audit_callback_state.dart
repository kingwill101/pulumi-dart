...
class AuditCallbackState {
  ...
  factory AuditCallbackState.fromMap(Map<String, dynamic> map) {
    return AuditCallbackState(
      auditCallbackName: (() { final guardedValue = map['auditCallbackName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      cryptType: (() { final guardedValue = map['cryptType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
