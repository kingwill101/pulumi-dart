...
class BizTypeState {
  ...
  factory BizTypeState.fromMap(Map<String, dynamic> map) {
    return BizTypeState(
      ...
      bizTypeName: (() { final guardedValue = map['bizTypeName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
