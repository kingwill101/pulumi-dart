...
class DbClusterState {
  ...
  factory DbClusterState.fromMap(Map<String, dynamic> map) {
    return DbClusterState(
      allocatePublicConnection: map['allocatePublicConnection'] == null ? null : (map['allocatePublicConnection'] as bool).input(),
      category: map['category'] == null ? null : (map['category'] as String).input(),
      coldStorage: map['coldStorage'] == null ? null : (map['coldStorage'] as String).input(),
      connectionString: map['connectionString'] == null ? null : (map['connectionString'] as String).input(),
      dbClusterAccessWhiteLists: map['dbClusterAccessWhiteLists'] == null ? null : (pulumi.Input.decodeList<DbClusterDbClusterAccessWhiteList>(map['dbClusterAccessWhiteLists'], (value) => DbClusterDbClusterAccessWhiteList.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      dbClusterNetworkType: map['dbClusterNetworkType'] == null ? null : (map['dbClusterNetworkType'] as String).input(),
      dbClusterVersion: map['dbClusterVersion'] == null ? null : (map['dbClusterVersion'] as String).input(),
      dbNodeGroupCount: map['dbNodeGroupCount'] == null ? null : (map['dbNodeGroupCount'] as int).input(),
      dbNodeStorage: map['dbNodeStorage'] == null ? null : (map['dbNodeStorage'] as String).input(),
      ...
      multiZoneVswitchLists: map['multiZoneVswitchLists'] == null ? null : (pulumi.Input.decodeList<DbClusterMultiZoneVswitchList>(map['multiZoneVswitchLists'], (value) => DbClusterMultiZoneVswitchList.fromMap((value as Map).cast<String, dynamic>()))).input(),
      paymentType: map['paymentType'] == null ? null : (map['paymentType'] as String).input(),
      period: map['period'] == null ? null : (map['period'] as String).input(),
      port: map['port'] == null ? null : (map['port'] as String).input(),
      publicConnectionString: map['publicConnectionString'] == null ? null : (map['publicConnectionString'] as String).input(),
