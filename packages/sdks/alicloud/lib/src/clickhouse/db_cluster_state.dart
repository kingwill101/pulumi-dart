...
class DbClusterState {
  ...
  /// [connectionString] (Available since v1.196.0) - The connection string of the cluster.
  ...
  /// [publicConnectionString] (Available since v1.245.0) The public connection string of the cluster. Only valid when `allocate_public_connection` is `true`.
  ...
  factory DbClusterState.fromMap(Map<String, dynamic> map) {
    return DbClusterState(
      allocatePublicConnection: (() { final guardedValue = map['allocatePublicConnection']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      category: (() { final guardedValue = map['category']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      coldStorage: (() { final guardedValue = map['coldStorage']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      dbClusterAccessWhiteLists: (() { final guardedValue = map['dbClusterAccessWhiteLists']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DbClusterDbClusterAccessWhiteList>(guardedValue, (value) => DbClusterDbClusterAccessWhiteList.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      dbClusterNetworkType: (() { final guardedValue = map['dbClusterNetworkType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      dbNodeGroupCount: (() { final guardedValue = map['dbNodeGroupCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      dbNodeStorage: (() { final guardedValue = map['dbNodeStorage']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      multiZoneVswitchLists: (() { final guardedValue = map['multiZoneVswitchLists']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DbClusterMultiZoneVswitchList>(guardedValue, (value) => DbClusterMultiZoneVswitchList.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      publicConnectionString: (() { final guardedValue = map['publicConnectionString']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
