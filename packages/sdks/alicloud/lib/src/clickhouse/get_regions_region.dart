...
class GetRegionsRegion {
  ...
  GetRegionsRegion({required this.regionId, required this.zoneIds});
  ...
  factory GetRegionsRegion.fromMap(Map<String, dynamic> map) {
    return GetRegionsRegion(
      ...
      zoneIds: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetRegionsRegionZoneId>(
          map['zoneIds']!,
          (value) => GetRegionsRegionZoneId.fromMap(
