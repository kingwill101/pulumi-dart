...
class AccountArgs {
  ...
  factory AccountArgs.fromMap(Map<String, dynamic> map) {
    return AccountArgs(
      ...
      allowDatabases: (() {
        final guardedValue = map['allowDatabases'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      allowDictionaries: (() {
        final guardedValue = map['allowDictionaries'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      dbClusterId: pulumi.Input.fromValue(map['dbClusterId'] as String),
      ddlAuthority: (() {
        final guardedValue = map['ddlAuthority'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      dmlAuthority: (() {
        final guardedValue = map['dmlAuthority'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      totalDatabases: (() {
        final guardedValue = map['totalDatabases'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      totalDictionaries: (() {
        final guardedValue = map['totalDictionaries'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      type: (() {
