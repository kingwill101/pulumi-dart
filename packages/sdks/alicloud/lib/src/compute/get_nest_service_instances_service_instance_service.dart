...
class GetNestServiceInstancesServiceInstanceService {
  ...
  factory GetNestServiceInstancesServiceInstanceService.fromMap(Map<String, dynamic> map) {
    return GetNestServiceInstancesServiceInstanceService(
      ...
      serviceInfos: pulumi.Input.fromValue(pulumi.Input.decodeList<GetNestServiceInstancesServiceInstanceServiceServiceInfo>(map['serviceInfos']!, (value) => GetNestServiceInstancesServiceInstanceServiceServiceInfo.fromMap((value as Map).cast<String, dynamic>()))),
