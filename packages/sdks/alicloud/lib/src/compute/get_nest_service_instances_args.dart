...
class GetNestServiceInstancesArgs {
  ...
  factory GetNestServiceInstancesArgs.fromMap(Map<String, dynamic> map) {
    return GetNestServiceInstancesArgs(
      filters: (() { final guardedValue = map['filters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetNestServiceInstancesFilter>(guardedValue, (value) => GetNestServiceInstancesFilter.fromMap((value as Map).cast<String, dynamic>()))); })(),
