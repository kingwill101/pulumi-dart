...
class DesktopArgs {
  ...
  DesktopArgs({
    ...
    required pulumi.Output<String> policyGroupId,
    pulumi.Output<int>? rootDiskSizeGib,
    pulumi.Output<String>? status,
    pulumi.Output<String>? stoppedMode,
    pulumi.Output<Map<String, String>>? tags,
    pulumi.Output<String>? userAssignMode,
    pulumi.Output<int>? userDiskSizeGib,
  }) :
  ...
  factory DesktopArgs.fromMap(Map<String, dynamic> map) {
    return DesktopArgs(
      ...
      policyGroupId: pulumi.Output.create<String>(map['policyGroupId'] as String),
      ...
      userAssignMode: map['userAssignMode'] == null ? null : pulumi.Output.create<String>(map['userAssignMode'] as String),
      userDiskSizeGib: map['userDiskSizeGib'] == null ? null : pulumi.Output.create<int>(map['userDiskSizeGib'] as int),
    );
  }
}
