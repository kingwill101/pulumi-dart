...
class BundleArgs {
  ...
  factory BundleArgs.fromMap(Map<String, dynamic> map) {
    return BundleArgs(
      bundleName: (() { final guardedValue = map['bundleName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      rootDiskPerformanceLevel: (() { final guardedValue = map['rootDiskPerformanceLevel']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      rootDiskSizeGib: pulumi.Input.fromValue(map['rootDiskSizeGib'] as int),
      userDiskPerformanceLevel: (() { final guardedValue = map['userDiskPerformanceLevel']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      userDiskSizeGibs: pulumi.Input.fromValue((map['userDiskSizeGibs'] as List).cast<int>()),
    );
  }
}
