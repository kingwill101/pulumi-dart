...
class GetAdConnectorDirectoriesDirectory {
  ...
  factory GetAdConnectorDirectoriesDirectory.fromMap(Map<String, dynamic> map) {
    return GetAdConnectorDirectoriesDirectory(
      adConnectorDirectoryId: (map['adConnectorDirectoryId'] as String).input(),
      adConnectors: (pulumi.Input.decodeList<GetAdConnectorDirectoriesDirectoryAdConnector>(map['adConnectors'], (value) => GetAdConnectorDirectoriesDirectoryAdConnector.fromMap((value as Map).cast<String, dynamic>()))).input(),
