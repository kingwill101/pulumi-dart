...
import 'ad_connector_office_site_state.dart';
...
class AdConnectorOfficeSite extends pulumi.CustomResource {
  ...
  AdConnectorOfficeSite(
    ...
    adConnectorOfficeSiteName = registerOutput<String>('adConnectorOfficeSiteName');
  ...
  static AdConnectorOfficeSite get(
    String name,
    pulumi.Input<String> id, {
    AdConnectorOfficeSiteState? state,
  }) {
    return AdConnectorOfficeSite._get(
      name,
      state: state?.toMap(),
