    ...
    return <String, dynamic>{
      'adConnectors':
          pulumi.Input.mapInputValue<
            List<GetRamDirectoriesDirectoryAdConnector>,
      ...
      'logs':
          pulumi.Input.mapInputValue<
            List<GetRamDirectoriesDirectoryLog>,
            List<Map<String, dynamic>>
          >(
            logs,
            (value) =>
  ...
  factory GetRamDirectoriesDirectory.fromMap(Map<String, dynamic> map) {
    return GetRamDirectoriesDirectory(
      adConnectors: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetRamDirectoriesDirectoryAdConnector>(
          map['adConnectors']!,
          (value) => GetRamDirectoriesDirectoryAdConnector.fromMap(
      ...
      logs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetRamDirectoriesDirectoryLog>(
          map['logs']!,
          (value) => GetRamDirectoriesDirectoryLog.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      ...
      ramDirectoryName: pulumi.Input.fromValue(
        map['ramDirectoryName'] as String,
      ),
