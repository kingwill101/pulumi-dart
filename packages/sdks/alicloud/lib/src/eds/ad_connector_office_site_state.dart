  ...
  factory AdConnectorOfficeSiteState.fromMap(Map<String, dynamic> map) {
    return AdConnectorOfficeSiteState(
      adConnectorOfficeSiteName: (() {
        final guardedValue = map['adConnectorOfficeSiteName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      adHostname: (() {
        final guardedValue = map['adHostname'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      bandwidth: (() {
      ...
      dnsAddresses: (() {
        final guardedValue = map['dnsAddresses'];
        if (guardedValue == null) return null;
      ...
      subDomainDnsAddresses: (() {
        final guardedValue = map['subDomainDnsAddresses'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      subDomainName: (() {
        final guardedValue = map['subDomainName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      verifyCode: (() {
        final guardedValue = map['verifyCode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
