...
class AdConnectorOfficeSiteState {
  ...
  AdConnectorOfficeSiteState({
    pulumi.Output<String>? adConnectorOfficeSiteName,
    ...
    pulumi.Output<String>? verifyCode,
      ...
      adConnectorOfficeSiteName = pulumi.Input.asOptionalInput<String>(adConnectorOfficeSiteName),
  ...
  factory AdConnectorOfficeSiteState.fromMap(Map<String, dynamic> map) {
    return AdConnectorOfficeSiteState(
      adConnectorOfficeSiteName: map['adConnectorOfficeSiteName'] == null ? null : pulumi.Output.create<String>(map['adConnectorOfficeSiteName'] as String),
