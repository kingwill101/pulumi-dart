...
class AdConnectorOfficeSiteState {
  ...
  const AdConnectorOfficeSiteState({
  ...
  factory AdConnectorOfficeSiteState.fromMap(Map<String, dynamic> map) {
    return AdConnectorOfficeSiteState(
      adConnectorOfficeSiteName: (() { final guardedValue = map['adConnectorOfficeSiteName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
