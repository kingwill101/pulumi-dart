...
class GetAdConnectorOfficeSitesSite {
  ...
  factory GetAdConnectorOfficeSitesSite.fromMap(Map<String, dynamic> map) {
    return GetAdConnectorOfficeSitesSite(
      ...
      adConnectors: pulumi.Input.fromValue(pulumi.Input.decodeList<GetAdConnectorOfficeSitesSiteAdConnector>(map['adConnectors']!, (value) => GetAdConnectorOfficeSitesSiteAdConnector.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      logs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetAdConnectorOfficeSitesSiteLog>(map['logs']!, (value) => GetAdConnectorOfficeSitesSiteLog.fromMap((value as Map).cast<String, dynamic>()))),
      mfaEnabled: pulumi.Input.fromValue(map['mfaEnabled'] as bool),
      networkPackageId: pulumi.Input.fromValue(map['networkPackageId'] as String),
      ...
      subDomainDnsAddresses: pulumi.Input.fromValue((map['subDomainDnsAddresses'] as List).cast<String>()),
