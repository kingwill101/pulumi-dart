...
class ErEnvConfPresetCanaryMacau {
  ...
  /// Creates a new [ErEnvConfPresetCanaryMacau].
  ...
  ErEnvConfPresetCanaryMacau({this.allowedHosts, this.codeRev, this.specName});
  ...
  factory ErEnvConfPresetCanaryMacau.fromMap(Map<String, dynamic> map) {
    return ErEnvConfPresetCanaryMacau(
      allowedHosts: (() {
