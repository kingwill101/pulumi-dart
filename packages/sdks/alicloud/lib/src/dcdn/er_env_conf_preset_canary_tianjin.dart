...
class ErEnvConfPresetCanaryTianjin {
  ...
  /// Creates a new [ErEnvConfPresetCanaryTianjin].
  ...
  const ErEnvConfPresetCanaryTianjin({
    this.allowedHosts,
    this.codeRev,
    this.specName,
  });
  ...
  factory ErEnvConfPresetCanaryTianjin.fromMap(Map<String, dynamic> map) {
    return ErEnvConfPresetCanaryTianjin(
