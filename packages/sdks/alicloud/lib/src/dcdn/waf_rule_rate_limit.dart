...
class WafRuleRateLimit {
  ...
  factory WafRuleRateLimit.fromMap(Map<String, dynamic> map) {
    return WafRuleRateLimit(
      ...
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WafRuleRateLimitStatus.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
