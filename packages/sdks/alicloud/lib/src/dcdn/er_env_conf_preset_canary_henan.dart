...
class ErEnvConfPresetCanaryHenan {
  ...
  /// Creates a new [ErEnvConfPresetCanaryHenan].
  ...
  ErEnvConfPresetCanaryHenan({this.allowedHosts, this.codeRev, this.specName});
  ...
  factory ErEnvConfPresetCanaryHenan.fromMap(Map<String, dynamic> map) {
    return ErEnvConfPresetCanaryHenan(
      allowedHosts: (() {
