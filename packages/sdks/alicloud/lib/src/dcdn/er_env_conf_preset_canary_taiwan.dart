...
class ErEnvConfPresetCanaryTaiwan {
  ...
  /// Creates a new [ErEnvConfPresetCanaryTaiwan].
  ...
  ErEnvConfPresetCanaryTaiwan({this.allowedHosts, this.codeRev, this.specName});
  ...
  factory ErEnvConfPresetCanaryTaiwan.fromMap(Map<String, dynamic> map) {
    return ErEnvConfPresetCanaryTaiwan(
      allowedHosts: (() {
