...
class ErEnvConfPresetCanaryXinjiang {
  ...
  /// Creates a new [ErEnvConfPresetCanaryXinjiang].
  ...
  const ErEnvConfPresetCanaryXinjiang({
    this.allowedHosts,
    this.codeRev,
    this.specName,
  });
  ...
  factory ErEnvConfPresetCanaryXinjiang.fromMap(Map<String, dynamic> map) {
    return ErEnvConfPresetCanaryXinjiang(
