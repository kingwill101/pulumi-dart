...
class WafRuleArgs {
    ...
    return <String, dynamic>{
      ...
      'conditions':
          ?pulumi.Input.mapOptionalInputValue<
            List<WafRuleCondition>,
            List<Map<String, dynamic>>
          >(
            conditions,
            (value) =>
                pulumi.Input.encodeList<WafRuleCondition, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory WafRuleArgs.fromMap(Map<String, dynamic> map) {
    return WafRuleArgs(
      ...
      ccStatus: (() {
        final guardedValue = map['ccStatus'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      cnRegionList: (() {
        final guardedValue = map['cnRegionList'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      conditions: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<WafRuleCondition>(
            guardedValue,
            (value) => WafRuleCondition.fromMap(
      ...
      otherRegionList: (() {
        final guardedValue = map['otherRegionList'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ...
      rateLimit: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          WafRuleRateLimit.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      regularRules: (() {
        final guardedValue = map['regularRules'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      regularTypes: (() {
        final guardedValue = map['regularTypes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      remoteAddrs: (() {
        final guardedValue = map['remoteAddrs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      ruleName: pulumi.Input.fromValue(map['ruleName'] as String),
      scenes: (() {
        final guardedValue = map['scenes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      status: (() {
      ...
      wafGroupIds: (() {
        final guardedValue = map['wafGroupIds'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
