...
class ErEnvConfPresetCanaryShaanxi {
  ...
  /// Creates a new [ErEnvConfPresetCanaryShaanxi].
  ...
  const ErEnvConfPresetCanaryShaanxi({
    this.allowedHosts,
    this.codeRev,
    this.specName,
  });
  ...
  factory ErEnvConfPresetCanaryShaanxi.fromMap(Map<String, dynamic> map) {
    return ErEnvConfPresetCanaryShaanxi(
