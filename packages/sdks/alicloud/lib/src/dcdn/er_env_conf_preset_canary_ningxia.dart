...
class ErEnvConfPresetCanaryNingxia {
  ...
  /// Creates a new [ErEnvConfPresetCanaryNingxia].
  ...
  const ErEnvConfPresetCanaryNingxia({
    this.allowedHosts,
    this.codeRev,
    this.specName,
  });
  ...
  factory ErEnvConfPresetCanaryNingxia.fromMap(Map<String, dynamic> map) {
    return ErEnvConfPresetCanaryNingxia(
