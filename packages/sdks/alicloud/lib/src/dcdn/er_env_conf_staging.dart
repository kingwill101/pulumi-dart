...
class ErEnvConfStaging {
  ...
  /// Creates a new [ErEnvConfStaging].
  ...
  ErEnvConfStaging({this.allowedHosts, this.codeRev, this.specName});
  ...
  factory ErEnvConfStaging.fromMap(Map<String, dynamic> map) {
    return ErEnvConfStaging(
      allowedHosts: (() {
