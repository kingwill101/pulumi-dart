...
class ErEnvConfPresetCanaryChongqing {
  ...
  /// Creates a new [ErEnvConfPresetCanaryChongqing].
  ...
  const ErEnvConfPresetCanaryChongqing({
    this.allowedHosts,
    this.codeRev,
    this.specName,
  });
  ...
  factory ErEnvConfPresetCanaryChongqing.fromMap(Map<String, dynamic> map) {
    return ErEnvConfPresetCanaryChongqing(
