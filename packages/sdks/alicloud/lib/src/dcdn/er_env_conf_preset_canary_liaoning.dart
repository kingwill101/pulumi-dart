...
class ErEnvConfPresetCanaryLiaoning {
  ...
  /// Creates a new [ErEnvConfPresetCanaryLiaoning].
  ...
  const ErEnvConfPresetCanaryLiaoning({
    this.allowedHosts,
    this.codeRev,
    this.specName,
  });
  ...
  factory ErEnvConfPresetCanaryLiaoning.fromMap(Map<String, dynamic> map) {
    return ErEnvConfPresetCanaryLiaoning(
