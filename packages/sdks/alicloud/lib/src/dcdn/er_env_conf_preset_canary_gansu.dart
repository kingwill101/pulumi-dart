...
class ErEnvConfPresetCanaryGansu {
  ...
  /// Creates a new [ErEnvConfPresetCanaryGansu].
  ...
  ErEnvConfPresetCanaryGansu({this.allowedHosts, this.codeRev, this.specName});
  ...
  factory ErEnvConfPresetCanaryGansu.fromMap(Map<String, dynamic> map) {
    return ErEnvConfPresetCanaryGansu(
      allowedHosts: (() {
