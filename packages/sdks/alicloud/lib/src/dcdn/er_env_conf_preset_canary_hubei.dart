...
class ErEnvConfPresetCanaryHubei {
  ...
  /// Creates a new [ErEnvConfPresetCanaryHubei].
  ...
  ErEnvConfPresetCanaryHubei({this.allowedHosts, this.codeRev, this.specName});
  ...
  factory ErEnvConfPresetCanaryHubei.fromMap(Map<String, dynamic> map) {
    return ErEnvConfPresetCanaryHubei(
      allowedHosts: (() {
