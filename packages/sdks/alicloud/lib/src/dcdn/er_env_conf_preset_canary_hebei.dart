...
class ErEnvConfPresetCanaryHebei {
  ...
  /// Creates a new [ErEnvConfPresetCanaryHebei].
  ...
  ErEnvConfPresetCanaryHebei({this.allowedHosts, this.codeRev, this.specName});
  ...
  factory ErEnvConfPresetCanaryHebei.fromMap(Map<String, dynamic> map) {
    return ErEnvConfPresetCanaryHebei(
      allowedHosts: (() {
