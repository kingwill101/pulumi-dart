...
class ErEnvConfProduction {
  ...
  /// Creates a new [ErEnvConfProduction].
  ...
  ErEnvConfProduction({this.allowedHosts, this.codeRev, this.specName});
  ...
  factory ErEnvConfProduction.fromMap(Map<String, dynamic> map) {
    return ErEnvConfProduction(
      allowedHosts: (() {
