...
class GetDomainsResult {
  ...
  factory GetDomainsResult.fromMap(Map<String, dynamic> map) {
    return GetDomainsResult(
      changeEndTime: (() { final guardedValue = map['changeEndTime']; if (guardedValue == null) return null; return guardedValue as String; })(),
      changeStartTime: (() { final guardedValue = map['changeStartTime']; if (guardedValue == null) return null; return guardedValue as String; })(),
      checkDomainShow: (() { final guardedValue = map['checkDomainShow']; if (guardedValue == null) return null; return guardedValue as bool; })(),
