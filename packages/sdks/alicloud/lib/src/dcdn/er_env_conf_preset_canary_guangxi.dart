...
class ErEnvConfPresetCanaryGuangxi {
  ...
  /// Creates a new [ErEnvConfPresetCanaryGuangxi].
  ...
  const ErEnvConfPresetCanaryGuangxi({
    this.allowedHosts,
    this.codeRev,
    this.specName,
  });
  ...
  factory ErEnvConfPresetCanaryGuangxi.fromMap(Map<String, dynamic> map) {
    return ErEnvConfPresetCanaryGuangxi(
