...
class ErEnvConfPresetCanaryJilin {
  ...
  /// Creates a new [ErEnvConfPresetCanaryJilin].
  ...
  ErEnvConfPresetCanaryJilin({this.allowedHosts, this.codeRev, this.specName});
  ...
  factory ErEnvConfPresetCanaryJilin.fromMap(Map<String, dynamic> map) {
    return ErEnvConfPresetCanaryJilin(
      allowedHosts: (() {
