...
class ErEnvConfPresetCanaryHunan {
  ...
  /// Creates a new [ErEnvConfPresetCanaryHunan].
  ...
  ErEnvConfPresetCanaryHunan({this.allowedHosts, this.codeRev, this.specName});
  ...
  factory ErEnvConfPresetCanaryHunan.fromMap(Map<String, dynamic> map) {
    return ErEnvConfPresetCanaryHunan(
      allowedHosts: (() {
