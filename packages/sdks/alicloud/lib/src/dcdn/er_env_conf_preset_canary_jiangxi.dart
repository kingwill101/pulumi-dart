...
class ErEnvConfPresetCanaryJiangxi {
  ...
  /// Creates a new [ErEnvConfPresetCanaryJiangxi].
  ...
  const ErEnvConfPresetCanaryJiangxi({
    this.allowedHosts,
    this.codeRev,
    this.specName,
  });
  ...
  factory ErEnvConfPresetCanaryJiangxi.fromMap(Map<String, dynamic> map) {
    return ErEnvConfPresetCanaryJiangxi(
