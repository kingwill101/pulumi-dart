...
class ErEnvConfPresetCanaryAnhui {
  ...
  /// Creates a new [ErEnvConfPresetCanaryAnhui].
  ...
  ErEnvConfPresetCanaryAnhui({this.allowedHosts, this.codeRev, this.specName});
  ...
  factory ErEnvConfPresetCanaryAnhui.fromMap(Map<String, dynamic> map) {
    return ErEnvConfPresetCanaryAnhui(
      allowedHosts: (() {
