...
class ErEnvConfPresetCanarySichuan {
  ...
  /// Creates a new [ErEnvConfPresetCanarySichuan].
  ...
  const ErEnvConfPresetCanarySichuan({
    this.allowedHosts,
    this.codeRev,
    this.specName,
  });
  ...
  factory ErEnvConfPresetCanarySichuan.fromMap(Map<String, dynamic> map) {
    return ErEnvConfPresetCanarySichuan(
