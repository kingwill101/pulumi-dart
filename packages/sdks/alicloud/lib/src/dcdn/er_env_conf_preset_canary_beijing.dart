...
class ErEnvConfPresetCanaryBeijing {
  ...
  /// Creates a new [ErEnvConfPresetCanaryBeijing].
  ...
  const ErEnvConfPresetCanaryBeijing({
    this.allowedHosts,
    this.codeRev,
    this.specName,
  });
  ...
  factory ErEnvConfPresetCanaryBeijing.fromMap(Map<String, dynamic> map) {
    return ErEnvConfPresetCanaryBeijing(
