...
class ErEnvConfPresetCanaryShandong {
  ...
  /// Creates a new [ErEnvConfPresetCanaryShandong].
  ...
  const ErEnvConfPresetCanaryShandong({
    this.allowedHosts,
    this.codeRev,
    this.specName,
  });
  ...
  factory ErEnvConfPresetCanaryShandong.fromMap(Map<String, dynamic> map) {
    return ErEnvConfPresetCanaryShandong(
