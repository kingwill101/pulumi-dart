...
class GetWafRulesWafRule {
  ...
  factory GetWafRulesWafRule.fromMap(Map<String, dynamic> map) {
    return GetWafRulesWafRule(
      ...
      conditions: pulumi.Input.fromValue(pulumi.Input.decodeList<GetWafRulesWafRuleCondition>(map['conditions']!, (value) => GetWafRulesWafRuleCondition.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      rateLimits: pulumi.Input.fromValue(pulumi.Input.decodeList<GetWafRulesWafRuleRateLimit>(map['rateLimits']!, (value) => GetWafRulesWafRuleRateLimit.fromMap((value as Map).cast<String, dynamic>()))),
      regularRules: pulumi.Input.fromValue((map['regularRules'] as List).cast<String>()),
      regularTypes: pulumi.Input.fromValue((map['regularTypes'] as List).cast<String>()),
      remoteAddrs: pulumi.Input.fromValue((map['remoteAddrs'] as List).cast<String>()),
