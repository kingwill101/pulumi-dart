...
class ErEnvConfPresetCanaryQinghai {
  ...
  /// Creates a new [ErEnvConfPresetCanaryQinghai].
  ...
  const ErEnvConfPresetCanaryQinghai({
    this.allowedHosts,
    this.codeRev,
    this.specName,
  });
  ...
  factory ErEnvConfPresetCanaryQinghai.fromMap(Map<String, dynamic> map) {
    return ErEnvConfPresetCanaryQinghai(
