...
class GetIpaDomainsDomain {
  ...
  factory GetIpaDomainsDomain.fromMap(Map<String, dynamic> map) {
    return GetIpaDomainsDomain(
      ...
      sources: pulumi.Input.fromValue(pulumi.Input.decodeList<GetIpaDomainsDomainSource>(map['sources']!, (value) => GetIpaDomainsDomainSource.fromMap((value as Map).cast<String, dynamic>()))),
