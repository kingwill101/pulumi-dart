...
class ErEnvConfPresetCanaryHeilongjiang {
  ...
  /// Creates a new [ErEnvConfPresetCanaryHeilongjiang].
  ...
  const ErEnvConfPresetCanaryHeilongjiang({
    this.allowedHosts,
    this.codeRev,
    this.specName,
  });
  ...
  factory ErEnvConfPresetCanaryHeilongjiang.fromMap(Map<String, dynamic> map) {
    return ErEnvConfPresetCanaryHeilongjiang(
