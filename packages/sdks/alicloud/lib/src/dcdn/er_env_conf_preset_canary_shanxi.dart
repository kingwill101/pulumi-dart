...
class ErEnvConfPresetCanaryShanxi {
  ...
  /// Creates a new [ErEnvConfPresetCanaryShanxi].
  ...
  ErEnvConfPresetCanaryShanxi({this.allowedHosts, this.codeRev, this.specName});
  ...
  factory ErEnvConfPresetCanaryShanxi.fromMap(Map<String, dynamic> map) {
    return ErEnvConfPresetCanaryShanxi(
      allowedHosts: (() {
