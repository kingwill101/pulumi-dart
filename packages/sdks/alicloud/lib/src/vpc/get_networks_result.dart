...
class GetNetworksResult {
  ...
  factory GetNetworksResult.fromMap(Map<String, dynamic> map) {
    return GetNetworksResult(
      ...
      dhcpOptionsSetId: (() { final guardedValue = map['dhcpOptionsSetId']; if (guardedValue == null) return null; return guardedValue as String; })(),
      ...
      vpcName: (() { final guardedValue = map['vpcName']; if (guardedValue == null) return null; return guardedValue as String; })(),
      vpcOwnerId: (() { final guardedValue = map['vpcOwnerId']; if (guardedValue == null) return null; return guardedValue as int; })(),
