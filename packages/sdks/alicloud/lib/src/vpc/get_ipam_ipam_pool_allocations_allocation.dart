...
class GetIpamIpamPoolAllocationsAllocation {
  ...
  factory GetIpamIpamPoolAllocationsAllocation.fromMap(Map<String, dynamic> map) {
    return GetIpamIpamPoolAllocationsAllocation(
      ...
      ipamPoolAllocationDescription: pulumi.Input.fromValue(map['ipamPoolAllocationDescription'] as String),
      ipamPoolAllocationId: pulumi.Input.fromValue(map['ipamPoolAllocationId'] as String),
      ipamPoolAllocationName: pulumi.Input.fromValue(map['ipamPoolAllocationName'] as String),
      ...
      resourceRegionId: pulumi.Input.fromValue(map['resourceRegionId'] as String),
