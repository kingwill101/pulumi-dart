...
class GetIpamIpamPoolAllocationsAllocation {
  ...
  final String ipamPoolAllocationDescription;
  ...
  factory GetIpamIpamPoolAllocationsAllocation.fromMap(Map<String, dynamic> map) {
    return GetIpamIpamPoolAllocationsAllocation(
      ...
      id: map['id'] as String,
      ipamPoolAllocationDescription: map['ipamPoolAllocationDescription'] as String,
      ipamPoolAllocationId: map['ipamPoolAllocationId'] as String,
      ipamPoolAllocationName: map['ipamPoolAllocationName'] as String,
      ipamPoolId: map['ipamPoolId'] as String,
      regionId: map['regionId'] as String,
      resourceId: map['resourceId'] as String,
      resourceOwnerId: map['resourceOwnerId'] as int,
      resourceRegionId: map['resourceRegionId'] as String,
