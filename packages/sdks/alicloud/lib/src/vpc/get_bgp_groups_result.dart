...
class GetBgpGroupsResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'groups':
          pulumi.Input.encodeList<GetBgpGroupsGroup, Map<String, dynamic>>(
            groups,
            (value) => value.toMap(),
          ),
      'id': id,
  ...
  factory GetBgpGroupsResult.fromMap(Map<String, dynamic> map) {
    return GetBgpGroupsResult(
      groups: pulumi.Input.decodeList<GetBgpGroupsGroup>(
        map['groups']!,
        (value) =>
            GetBgpGroupsGroup.fromMap((value as Map).cast<String, dynamic>()),
      ),
      id: map['id'] as String,
