...
class SnatEntry extends pulumi.CustomResource {
  ...
  SnatEntry(
    ...
    this.eipAffinity = registerOutput<int?>('eipAffinity');
    this.snatEntryId = registerOutput<String>('snatEntryId');
    this.snatEntryName = registerOutput<String?>('snatEntryName');
    this.snatIp = registerOutput<String>('snatIp');
    this.snatTableId = registerOutput<String>('snatTableId');
    this.sourceCidr = registerOutput<String>('sourceCidr');
    this.sourceVswitchId = registerOutput<String>('sourceVswitchId');
