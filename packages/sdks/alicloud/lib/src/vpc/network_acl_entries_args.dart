...
class NetworkAclEntriesArgs {
  ...
  factory NetworkAclEntriesArgs.fromMap(Map<String, dynamic> map) {
    return NetworkAclEntriesArgs(
      egresses: (() { final guardedValue = map['egresses']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NetworkAclEntriesEgress>(guardedValue, (value) => NetworkAclEntriesEgress.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ingresses: (() { final guardedValue = map['ingresses']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NetworkAclEntriesIngress>(guardedValue, (value) => NetworkAclEntriesIngress.fromMap((value as Map).cast<String, dynamic>()))); })(),
