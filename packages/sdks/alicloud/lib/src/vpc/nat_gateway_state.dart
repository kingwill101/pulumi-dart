...
class NatGatewayState {
  ...
  NatGatewayState({
    pulumi.Output<NatGatewayAccessMode>? accessMode,
    pulumi.Output<bool>? deletionProtection,
    pulumi.Output<String>? description,
    pulumi.Output<bool>? dryRun,
    pulumi.Output<String>? eipBindMode,
    pulumi.Output<bool>? force,
    pulumi.Output<String>? forwardTableIds,
    pulumi.Output<bool>? icmpReplyEnabled,
    pulumi.Output<String>? instanceChargeType,
    pulumi.Output<String>? internetChargeType,
    pulumi.Output<String>? name,
    pulumi.Output<String>? natGatewayName,
    pulumi.Output<String>? natType,
    pulumi.Output<String>? networkType,
    pulumi.Output<String>? paymentType,
    pulumi.Output<int>? period,
    pulumi.Output<bool>? privateLinkEnabled,
    pulumi.Output<String>? snatTableIds,
    ...
    pulumi.Output<String>? vswitchId,
      ...
      accessMode = pulumi.Input.asOptionalInput<NatGatewayAccessMode>(accessMode),
      deletionProtection = pulumi.Input.asOptionalInput<bool>(deletionProtection),
      description = pulumi.Input.asOptionalInput<String>(description),
      dryRun = pulumi.Input.asOptionalInput<bool>(dryRun),
      eipBindMode = pulumi.Input.asOptionalInput<String>(eipBindMode),
      force = pulumi.Input.asOptionalInput<bool>(force),
      forwardTableIds = pulumi.Input.asOptionalInput<String>(forwardTableIds),
      icmpReplyEnabled = pulumi.Input.asOptionalInput<bool>(icmpReplyEnabled),
      ...
      natType = pulumi.Input.asOptionalInput<String>(natType),
      networkType = pulumi.Input.asOptionalInput<String>(networkType),
      paymentType = pulumi.Input.asOptionalInput<String>(paymentType),
      period = pulumi.Input.asOptionalInput<int>(period),
      privateLinkEnabled = pulumi.Input.asOptionalInput<bool>(privateLinkEnabled),
      snatTableIds = pulumi.Input.asOptionalInput<String>(snatTableIds),
  ...
  factory NatGatewayState.fromMap(Map<String, dynamic> map) {
    return NatGatewayState(
      accessMode: map['accessMode'] == null ? null : pulumi.Output.create<NatGatewayAccessMode>(NatGatewayAccessMode.fromMap((map['accessMode'] as Map).cast<String, dynamic>())),
      deletionProtection: map['deletionProtection'] == null ? null : pulumi.Output.create<bool>(map['deletionProtection'] as bool),
      description: map['description'] == null ? null : pulumi.Output.create<String>(map['description'] as String),
      dryRun: map['dryRun'] == null ? null : pulumi.Output.create<bool>(map['dryRun'] as bool),
      eipBindMode: map['eipBindMode'] == null ? null : pulumi.Output.create<String>(map['eipBindMode'] as String),
      force: map['force'] == null ? null : pulumi.Output.create<bool>(map['force'] as bool),
      forwardTableIds: map['forwardTableIds'] == null ? null : pulumi.Output.create<String>(map['forwardTableIds'] as String),
      icmpReplyEnabled: map['icmpReplyEnabled'] == null ? null : pulumi.Output.create<bool>(map['icmpReplyEnabled'] as bool),
      ...
      natType: map['natType'] == null ? null : pulumi.Output.create<String>(map['natType'] as String),
      ...
      privateLinkEnabled: map['privateLinkEnabled'] == null ? null : pulumi.Output.create<bool>(map['privateLinkEnabled'] as bool),
      snatTableIds: map['snatTableIds'] == null ? null : pulumi.Output.create<String>(map['snatTableIds'] as String),
