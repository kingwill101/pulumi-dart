...
class NetworkAclState {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ingressAclEntries':
          ?pulumi.Input.mapOptionalInputValue<
            List<NetworkAclIngressAclEntry>,
            List<Map<String, dynamic>>
          >(
            ingressAclEntries,
            (value) =>
  ...
  factory NetworkAclState.fromMap(Map<String, dynamic> map) {
    return NetworkAclState(
      ...
      egressAclEntries: (() {
        final guardedValue = map['egressAclEntries'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NetworkAclEgressAclEntry>(
            guardedValue,
            (value) => NetworkAclEgressAclEntry.fromMap(
      ...
      ingressAclEntries: (() {
        final guardedValue = map['ingressAclEntries'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NetworkAclIngressAclEntry>(
            guardedValue,
            (value) => NetworkAclIngressAclEntry.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      resources: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NetworkAclResource>(
            guardedValue,
            (value) => NetworkAclResource.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      sourceNetworkAclId: (() {
        final guardedValue = map['sourceNetworkAclId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      status: (() {
