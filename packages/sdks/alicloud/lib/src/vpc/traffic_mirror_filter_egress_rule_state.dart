...
class TrafficMirrorFilterEgressRuleState {
  ...
  const TrafficMirrorFilterEgressRuleState({
    this.action,
  ...
  factory TrafficMirrorFilterEgressRuleState.fromMap(Map<String, dynamic> map) {
    return TrafficMirrorFilterEgressRuleState(
      ...
      trafficMirrorFilterEgressRuleId: (() { final guardedValue = map['trafficMirrorFilterEgressRuleId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
