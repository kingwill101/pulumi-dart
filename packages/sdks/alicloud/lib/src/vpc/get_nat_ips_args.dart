...
class GetNatIpsArgs {
  ...
  factory GetNatIpsArgs.fromMap(Map<String, dynamic> map) {
    return GetNatIpsArgs(
      ...
      natIpIds: (() { final guardedValue = map['natIpIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      natIpNames: (() { final guardedValue = map['natIpNames']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
