...
class TrafficMirrorFilterIngressRuleState {
  ...
  factory TrafficMirrorFilterIngressRuleState.fromMap(Map<String, dynamic> map) {
    return TrafficMirrorFilterIngressRuleState(
      ...
      trafficMirrorFilterIngressRuleId: (() { final guardedValue = map['trafficMirrorFilterIngressRuleId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
