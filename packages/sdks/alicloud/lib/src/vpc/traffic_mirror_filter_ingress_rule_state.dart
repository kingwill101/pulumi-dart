...
class TrafficMirrorFilterIngressRuleState {
  ...
  TrafficMirrorFilterIngressRuleState({
    ...
    pulumi.Output<String>? trafficMirrorFilterIngressRuleId,
  }) :
      ...
      trafficMirrorFilterIngressRuleId = pulumi.Input.asOptionalInput<String>(trafficMirrorFilterIngressRuleId);
  ...
  factory TrafficMirrorFilterIngressRuleState.fromMap(Map<String, dynamic> map) {
    return TrafficMirrorFilterIngressRuleState(
      ...
      trafficMirrorFilterIngressRuleId: map['trafficMirrorFilterIngressRuleId'] == null ? null : pulumi.Output.create<String>(map['trafficMirrorFilterIngressRuleId'] as String),
    );
  }
}
