...
class IpamIpamState {
  ...
  factory IpamIpamState.fromMap(Map<String, dynamic> map) {
    return IpamIpamState(
      ...
      ipamDescription: (() { final guardedValue = map['ipamDescription']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      operatingRegionLists: (() { final guardedValue = map['operatingRegionLists']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
