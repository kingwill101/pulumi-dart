...
class GetIpamIpamPoolsPool {
  ...
  factory GetIpamIpamPoolsPool.fromMap(Map<String, dynamic> map) {
    return GetIpamIpamPoolsPool(
      allocationDefaultCidrMask: pulumi.Input.fromValue(
        map['allocationDefaultCidrMask'] as int,
      ),
      allocationMaxCidrMask: pulumi.Input.fromValue(
        map['allocationMaxCidrMask'] as int,
      ),
      allocationMinCidrMask: pulumi.Input.fromValue(
        map['allocationMinCidrMask'] as int,
      ),
      ...
      ipamPoolDescription: pulumi.Input.fromValue(
        map['ipamPoolDescription'] as String,
      ),
      ...
      sourceIpamPoolId: pulumi.Input.fromValue(
