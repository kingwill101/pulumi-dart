...
import 'traffic_mirror_filter_ingress_rule_state.dart';
...
class TrafficMirrorFilterIngressRuleVpc extends pulumi.CustomResource {
  ...
  TrafficMirrorFilterIngressRuleVpc(
    ...
    trafficMirrorFilterIngressRuleId = registerOutput<String>('trafficMirrorFilterIngressRuleId');
  }

  /// Gets an existing [TrafficMirrorFilterIngressRuleVpc] resource's state with the given [name] and [id].
  static TrafficMirrorFilterIngressRuleVpc get(
    String name,
    pulumi.Input<String> id, {
    TrafficMirrorFilterIngressRuleState? state,
  }) {
    return TrafficMirrorFilterIngressRuleVpc._get(
      name,
      state: state?.toMap(),
  ...
  TrafficMirrorFilterIngressRuleVpc._get(
    String name, {
