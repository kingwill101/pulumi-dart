...
class NatGateway extends pulumi.CustomResource {
  ...
  NatGateway(
    ...
    eipBindMode = registerOutput<String>('eipBindMode');
    force = registerOutput<bool?>('force');
    forwardTableIds = registerOutput<String>('forwardTableIds');
    icmpReplyEnabled = registerOutput<bool>('icmpReplyEnabled');
    ...
    natGatewayName = registerOutput<String>('natGatewayName');
    natType = registerOutput<String>('natType');
    networkType = registerOutput<String>('networkType');
    paymentType = registerOutput<String>('paymentType');
    period = registerOutput<int?>('period');
    privateLinkEnabled = registerOutput<bool?>('privateLinkEnabled');
    snatTableIds = registerOutput<String>('snatTableIds');
