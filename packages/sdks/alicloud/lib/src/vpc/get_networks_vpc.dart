...
class GetNetworksVpc {
  ...
  factory GetNetworksVpc.fromMap(Map<String, dynamic> map) {
    return GetNetworksVpc(
      ...
      dhcpOptionsSetStatus: pulumi.Input.fromValue(
        map['dhcpOptionsSetStatus'] as String,
      ),
      dnsHostnameStatus: pulumi.Input.fromValue(
        map['dnsHostnameStatus'] as String,
      ),
      ...
      secondaryCidrBlocks: pulumi.Input.fromValue(
        (map['secondaryCidrBlocks'] as List).cast<String>(),
      ),
      status: pulumi.Input.fromValue(map['status'] as String),
      tags: pulumi.Input.fromValue((map['tags'] as Map).cast<String, String>()),
      userCidrs: pulumi.Input.fromValue(
        (map['userCidrs'] as List).cast<String>(),
      ),
