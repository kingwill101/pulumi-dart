...
class PrefixListState {
  ...
  final pulumi.Input<List<PrefixListPrefixListAssociation>>?
    ...
    return <String, dynamic>{
      ...
      'entrys':
          ...
          >(
            entrys,
            (value) =>
                pulumi.Input.encodeList<PrefixListEntry, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      ...
      'prefixListAssociations':
          ?pulumi.Input.mapOptionalInputValue<
            List<PrefixListPrefixListAssociation>,
            List<Map<String, dynamic>>
          >(
            prefixListAssociations,
            (value) =>
  ...
  factory PrefixListState.fromMap(Map<String, dynamic> map) {
    return PrefixListState(
      ...
      entrys: (() {
        final guardedValue = map['entrys'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PrefixListEntry>(
            guardedValue,
            (value) =>
                PrefixListEntry.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      ipVersion: (() {
      ...
      prefixListAssociations: (() {
        final guardedValue = map['prefixListAssociations'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PrefixListPrefixListAssociation>(
            guardedValue,
            (value) => PrefixListPrefixListAssociation.fromMap(
      ...
      prefixListDescription: (() {
        final guardedValue = map['prefixListDescription'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      prefixListId: (() {
