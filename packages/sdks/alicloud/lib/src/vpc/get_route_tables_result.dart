...
class GetRouteTablesResult {
  ...
  factory GetRouteTablesResult.fromMap(Map<String, dynamic> map) {
    return GetRouteTablesResult(
      ...
      routeTableName: (() { final guardedValue = map['routeTableName']; if (guardedValue == null) return null; return guardedValue as String; })(),
      routeTableType: (() { final guardedValue = map['routeTableType']; if (guardedValue == null) return null; return guardedValue as String; })(),
