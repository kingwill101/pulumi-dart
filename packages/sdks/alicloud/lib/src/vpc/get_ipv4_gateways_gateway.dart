...
class GetIpv4GatewaysGateway {
  ...
  factory GetIpv4GatewaysGateway.fromMap(Map<String, dynamic> map) {
    return GetIpv4GatewaysGateway(
      ...
      ipv4GatewayDescription: pulumi.Input.fromValue(
        map['ipv4GatewayDescription'] as String,
      ),
      ...
      ipv4GatewayRouteTableId: pulumi.Input.fromValue(
        map['ipv4GatewayRouteTableId'] as String,
      ),
