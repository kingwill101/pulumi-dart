...
class TrafficMirrorFilter extends pulumi.CustomResource {
  ...
  TrafficMirrorFilter(
    ...
    trafficMirrorFilterDescription = registerOutput<String?>('trafficMirrorFilterDescription');
    trafficMirrorFilterName = registerOutput<String?>('trafficMirrorFilterName');
  }
