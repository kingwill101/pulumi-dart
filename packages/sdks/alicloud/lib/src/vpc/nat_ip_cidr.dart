...
class NatIpCidr extends pulumi.CustomResource {
  ...
  NatIpCidr(
    ...
    natIpCidrDescription = registerOutput<String?>('natIpCidrDescription');
    natIpCidrName = registerOutput<String?>('natIpCidrName');
    status = registerOutput<String>('status');
  }

  /// Gets an existing [NatIpCidr] resource's state with the given [name] and [id].
  static NatIpCidr get(
    String name,
    pulumi.Input<String> id, {
    NatIpCidrState? state,
  }) {
    return NatIpCidr._get(
      name,
      state: state?.toMap(),
