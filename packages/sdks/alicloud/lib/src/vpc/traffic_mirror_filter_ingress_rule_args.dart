...
/// {@template pulumi_vpc_traffic_mirror_filter_ingress_rule_traffic_mirror_filter_ingress_rule_args_doc}
/// The set of arguments for TrafficMirrorFilterIngressRule.
/// {@endtemplate}
/// {@macro pulumi_vpc_traffic_mirror_filter_ingress_rule_traffic_mirror_filter_ingress_rule_args_doc}
class TrafficMirrorFilterIngressRuleArgs {
  ...
  /// Creates a new [TrafficMirrorFilterIngressRuleArgs].
  ...
  const TrafficMirrorFilterIngressRuleArgs({
    this.action,
