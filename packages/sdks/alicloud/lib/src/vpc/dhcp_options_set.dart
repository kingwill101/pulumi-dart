...
class DhcpOptionsSet extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<DhcpOptionsSetAssociateVpc>> associateVpcs;
  ...
  DhcpOptionsSet(
    ...
    this.associateVpcs = registerOutput<List<DhcpOptionsSetAssociateVpc>>('associateVpcs');
    this.dhcpOptionsSetDescription = registerOutput<String?>('dhcpOptionsSetDescription');
    this.dhcpOptionsSetName = registerOutput<String?>('dhcpOptionsSetName');
    this.domainName = registerOutput<String?>('domainName');
    this.domainNameServers = registerOutput<String?>('domainNameServers');
    this.dryRun = registerOutput<bool?>('dryRun');
    this.ipv6LeaseTime = registerOutput<String>('ipv6LeaseTime');
    this.leaseTime = registerOutput<String>('leaseTime');
    this.ownerId = registerOutput<int>('ownerId');
