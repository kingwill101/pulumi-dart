...
class GetTrafficMirrorSessionsResult {
  ...
  factory GetTrafficMirrorSessionsResult.fromMap(Map<String, dynamic> map) {
    return GetTrafficMirrorSessionsResult(
      ...
      trafficMirrorFilterId: (() { final guardedValue = map['trafficMirrorFilterId']; if (guardedValue == null) return null; return guardedValue as String; })(),
      trafficMirrorSessionName: (() { final guardedValue = map['trafficMirrorSessionName']; if (guardedValue == null) return null; return guardedValue as String; })(),
      trafficMirrorSourceId: (() { final guardedValue = map['trafficMirrorSourceId']; if (guardedValue == null) return null; return guardedValue as String; })(),
      trafficMirrorTargetId: (() { final guardedValue = map['trafficMirrorTargetId']; if (guardedValue == null) return null; return guardedValue as String; })(),
    );
  }
}
