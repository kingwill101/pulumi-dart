...
class NatGatewayAccessMode {
  ...
  factory NatGatewayAccessMode.fromMap(Map<String, dynamic> map) {
    return NatGatewayAccessMode(
      modeValue: (() { final guardedValue = map['modeValue']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
