...
class GetTrafficMirrorSessionsArgs {
  ...
  factory GetTrafficMirrorSessionsArgs.fromMap(Map<String, dynamic> map) {
    return GetTrafficMirrorSessionsArgs(
      ...
      trafficMirrorSourceId: (() { final guardedValue = map['trafficMirrorSourceId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
