...
class DhcpOptionsSetState {
    ...
    return <String, dynamic>{
      'associateVpcs':
          ?pulumi.Input.mapOptionalInputValue<
            List<DhcpOptionsSetAssociateVpc>,
  ...
  factory DhcpOptionsSetState.fromMap(Map<String, dynamic> map) {
    return DhcpOptionsSetState(
      associateVpcs: (() {
        final guardedValue = map['associateVpcs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DhcpOptionsSetAssociateVpc>(
            guardedValue,
            (value) => DhcpOptionsSetAssociateVpc.fromMap(
      ...
      dhcpOptionsSetDescription: (() {
        final guardedValue = map['dhcpOptionsSetDescription'];
        if (guardedValue == null) return null;
      ...
      ipv6LeaseTime: (() {
        final guardedValue = map['ipv6LeaseTime'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      leaseTime: (() {
