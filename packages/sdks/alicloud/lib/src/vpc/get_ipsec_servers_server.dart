...
class GetIpsecServersServer {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ikeConfigs': pulumi.Input.mapInputValue<List<GetIpsecServersServerIkeConfig>, List<Map<String, dynamic>>>(ikeConfigs, (value) => pulumi.Input.encodeList<GetIpsecServersServerIkeConfig, Map<String, dynamic>>(value, (value) => value.toMap())),
      'internetIp': internetIp,
      'ipsecConfigs': pulumi.Input.mapInputValue<List<GetIpsecServersServerIpsecConfig>, List<Map<String, dynamic>>>(ipsecConfigs, (value) => pulumi.Input.encodeList<GetIpsecServersServerIpsecConfig, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory GetIpsecServersServer.fromMap(Map<String, dynamic> map) {
    return GetIpsecServersServer(
      ...
      idaasInstanceId: (map['idaasInstanceId'] as String).input(),
      ikeConfigs: (pulumi.Input.decodeList<GetIpsecServersServerIkeConfig>(map['ikeConfigs'], (value) => GetIpsecServersServerIkeConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
      internetIp: (map['internetIp'] as String).input(),
      ipsecConfigs: (pulumi.Input.decodeList<GetIpsecServersServerIpsecConfig>(map['ipsecConfigs'], (value) => GetIpsecServersServerIpsecConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ipsecServerId: (map['ipsecServerId'] as String).input(),
      ipsecServerName: (map['ipsecServerName'] as String).input(),
      localSubnet: (map['localSubnet'] as String).input(),
      maxConnections: (map['maxConnections'] as int).input(),
      multiFactorAuthEnabled: (map['multiFactorAuthEnabled'] as bool).input(),
      onlineClientCount: (map['onlineClientCount'] as int).input(),
      psk: (map['psk'] as String).input(),
      pskEnabled: (map['pskEnabled'] as bool).input(),
