...
class GetIpsecServersServer {
  ...
  factory GetIpsecServersServer.fromMap(Map<String, dynamic> map) {
    return GetIpsecServersServer(
      ...
      ikeConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetIpsecServersServerIkeConfig>(map['ikeConfigs']!, (value) => GetIpsecServersServerIkeConfig.fromMap((value as Map).cast<String, dynamic>()))),
      internetIp: pulumi.Input.fromValue(map['internetIp'] as String),
      ipsecConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetIpsecServersServerIpsecConfig>(map['ipsecConfigs']!, (value) => GetIpsecServersServerIpsecConfig.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      multiFactorAuthEnabled: pulumi.Input.fromValue(map['multiFactorAuthEnabled'] as bool),
      onlineClientCount: pulumi.Input.fromValue(map['onlineClientCount'] as int),
