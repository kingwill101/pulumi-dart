...
class GetPublicIpAddressPoolsArgs {
  ...
  factory GetPublicIpAddressPoolsArgs.fromMap(Map<String, dynamic> map) {
    return GetPublicIpAddressPoolsArgs(
      ...
      publicIpAddressPoolIds: (() { final guardedValue = map['publicIpAddressPoolIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
