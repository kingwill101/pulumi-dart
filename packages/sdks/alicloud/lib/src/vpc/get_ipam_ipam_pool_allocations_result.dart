...
class GetIpamIpamPoolAllocationsResult {
  ...
  factory GetIpamIpamPoolAllocationsResult.fromMap(Map<String, dynamic> map) {
    return GetIpamIpamPoolAllocationsResult(
      ...
      ipamPoolAllocationId: (() { final guardedValue = map['ipamPoolAllocationId']; if (guardedValue == null) return null; return guardedValue as String; })(),
      ipamPoolAllocationName: (() { final guardedValue = map['ipamPoolAllocationName']; if (guardedValue == null) return null; return guardedValue as String; })(),
