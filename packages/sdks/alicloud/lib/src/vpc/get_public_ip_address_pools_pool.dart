...
class GetPublicIpAddressPoolsPool {
  ...
  factory GetPublicIpAddressPoolsPool.fromMap(Map<String, dynamic> map) {
    return GetPublicIpAddressPoolsPool(
      ...
      ipAddressRemaining: pulumi.Input.fromValue(
        map['ipAddressRemaining'] as bool,
      ),
      ...
      publicIpAddressPoolName: pulumi.Input.fromValue(
        map['publicIpAddressPoolName'] as String,
      ),
