...
class VswitchCidrReservation extends pulumi.CustomResource {
  ...
  VswitchCidrReservation(
    ...
    cidrReservationDescription = registerOutput<String?>('cidrReservationDescription');
    ...
    vswitchCidrReservationId = registerOutput<String>('vswitchCidrReservationId');
    vswitchCidrReservationName = registerOutput<String?>('vswitchCidrReservationName');
