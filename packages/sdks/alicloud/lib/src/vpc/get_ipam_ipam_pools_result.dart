...
class GetIpamIpamPoolsResult {
  ...
  factory GetIpamIpamPoolsResult.fromMap(Map<String, dynamic> map) {
    return GetIpamIpamPoolsResult(
      ...
      ipamPoolName: (() { final guardedValue = map['ipamPoolName']; if (guardedValue == null) return null; return guardedValue as String; })(),
      ...
      poolRegionId: (() { final guardedValue = map['poolRegionId']; if (guardedValue == null) return null; return guardedValue as String; })(),
