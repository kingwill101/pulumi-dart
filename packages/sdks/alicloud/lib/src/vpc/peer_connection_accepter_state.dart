...
class PeerConnectionAccepterState {
  ...
  factory PeerConnectionAccepterState.fromMap(Map<String, dynamic> map) {
    return PeerConnectionAccepterState(
      acceptingOwnerUid: (() {
        final guardedValue = map['acceptingOwnerUid'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      acceptingRegionId: (() {
        final guardedValue = map['acceptingRegionId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      acceptingVpcId: (() {
        final guardedValue = map['acceptingVpcId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      bandwidth: (() {
      ...
      peerConnectionAccepterName: (() {
        final guardedValue = map['peerConnectionAccepterName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      regionId: (() {
