...
class ForwardEntryState {
  ...
  factory ForwardEntryState.fromMap(Map<String, dynamic> map) {
    return ForwardEntryState(
      ...
      forwardEntryId: (() { final guardedValue = map['forwardEntryId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      forwardTableId: (() { final guardedValue = map['forwardTableId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
