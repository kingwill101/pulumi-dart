...
class VpcEndpointState {
  ...
  factory VpcEndpointState.fromMap(Map<String, dynamic> map) {
    return VpcEndpointState(
      ...
      endpointBusinessStatus: (() { final guardedValue = map['endpointBusinessStatus']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      endpointDescription: (() { final guardedValue = map['endpointDescription']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      protectedEnabled: (() { final guardedValue = map['protectedEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      zonePrivateIpAddressCount: (() { final guardedValue = map['zonePrivateIpAddressCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
    );
  }
}
