...
class GetVpcEndpointsEndpoint {
  ...
  factory GetVpcEndpointsEndpoint.fromMap(Map<String, dynamic> map) {
    return GetVpcEndpointsEndpoint(
      ...
      endpointBusinessStatus: pulumi.Input.fromValue(
        map['endpointBusinessStatus'] as String,
      ),
      endpointDescription: pulumi.Input.fromValue(
        map['endpointDescription'] as String,
      ),
