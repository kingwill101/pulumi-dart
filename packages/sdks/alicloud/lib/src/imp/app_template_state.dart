...
class AppTemplateState {
  ...
  factory AppTemplateState.fromMap(Map<String, dynamic> map) {
    return AppTemplateState(
      appTemplateName: (() { final guardedValue = map['appTemplateName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      componentLists: (() { final guardedValue = map['componentLists']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
