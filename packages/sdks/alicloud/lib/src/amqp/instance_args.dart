...
class InstanceArgs {
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      ...
      maxEipTps: (() {
        final guardedValue = map['maxEipTps'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      maxTps: (() {
        final guardedValue = map['maxTps'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      modifyType: (() {
      ...
      periodCycle: (() {
        final guardedValue = map['periodCycle'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      provisionedCapacity: (() {
        final guardedValue = map['provisionedCapacity'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      queueCapacity: (() {
        final guardedValue = map['queueCapacity'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      renewalDuration: (() {
      ...
      serverlessChargeType: (() {
        final guardedValue = map['serverlessChargeType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      storageSize: (() {
      ...
      supportEip: (() {
        final guardedValue = map['supportEip'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      supportTracing: (() {
        final guardedValue = map['supportTracing'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      tracingStorageTime: (() {
        final guardedValue = map['tracingStorageTime'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
    );
