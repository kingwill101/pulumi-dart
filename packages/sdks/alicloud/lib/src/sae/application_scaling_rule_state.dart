...
class ApplicationScalingRuleState {
  ...
  final pulumi.Input<ApplicationScalingRuleScalingRuleMetric>?
  scalingRuleMetric;
    ...
    return <String, dynamic>{
      ...
      'scalingRuleMetric':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(scalingRuleMetric, (value) => value.toMap()),
      'scalingRuleName': ?scalingRuleName,
      'scalingRuleTimer':
          ?pulumi.Input.mapOptionalInputValue<
            ApplicationScalingRuleScalingRuleTimer,
            Map<String, dynamic>
          >(scalingRuleTimer, (value) => value.toMap()),
  ...
  factory ApplicationScalingRuleState.fromMap(Map<String, dynamic> map) {
    return ApplicationScalingRuleState(
      ...
      scalingRuleEnable: (() {
        final guardedValue = map['scalingRuleEnable'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      scalingRuleMetric: (() {
        final guardedValue = map['scalingRuleMetric'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ApplicationScalingRuleScalingRuleMetric.fromMap(
      ...
      scalingRuleTimer: (() {
        final guardedValue = map['scalingRuleTimer'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ApplicationScalingRuleScalingRuleTimer.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
