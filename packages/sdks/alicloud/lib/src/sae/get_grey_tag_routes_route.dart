...
class GetGreyTagRoutesRoute {
  ...
  factory GetGreyTagRoutesRoute.fromMap(Map<String, dynamic> map) {
    return GetGreyTagRoutesRoute(
      ...
      dubboRules: (pulumi.Input.decodeList<GetGreyTagRoutesRouteDubboRule>(map['dubboRules'], (value) => GetGreyTagRoutesRouteDubboRule.fromMap((value as Map).cast<String, dynamic>()))).input(),
      greyTagRouteName: (map['greyTagRouteName'] as String).input(),
      id: (map['id'] as String).input(),
      scRules: (pulumi.Input.decodeList<GetGreyTagRoutesRouteScRule>(map['scRules'], (value) => GetGreyTagRoutesRouteScRule.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
