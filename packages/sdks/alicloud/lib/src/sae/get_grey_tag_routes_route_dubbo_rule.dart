...
class GetGreyTagRoutesRouteDubboRule {
  ...
  factory GetGreyTagRoutesRouteDubboRule.fromMap(Map<String, dynamic> map) {
    return GetGreyTagRoutesRouteDubboRule(
      ...
      items: pulumi.Input.fromValue(pulumi.Input.decodeList<GetGreyTagRoutesRouteDubboRuleItem>(map['items']!, (value) => GetGreyTagRoutesRouteDubboRuleItem.fromMap((value as Map).cast<String, dynamic>()))),
