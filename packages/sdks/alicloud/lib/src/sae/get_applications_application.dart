...
class GetApplicationsApplication {
  ...
  final pulumi.Input<List<GetApplicationsApplicationOssMountDetail>>
  ossMountDetails;
    ...
    return <String, dynamic>{
      ...
      'mountDescs':
          pulumi.Input.mapInputValue<
            List<GetApplicationsApplicationMountDesc>,
      ...
      'ossMountDetails':
          pulumi.Input.mapInputValue<
            List<GetApplicationsApplicationOssMountDetail>,
            List<Map<String, dynamic>>
          >(
            ossMountDetails,
            (value) =>
  ...
  factory GetApplicationsApplication.fromMap(Map<String, dynamic> map) {
    return GetApplicationsApplication(
      acrAssumeRoleArn: pulumi.Input.fromValue(
        map['acrAssumeRoleArn'] as String,
      ),
      ...
      configMapMountDesc: pulumi.Input.fromValue(
        map['configMapMountDesc'] as String,
      ),
      cpu: pulumi.Input.fromValue(map['cpu'] as int),
      createTime: pulumi.Input.fromValue(map['createTime'] as String),
      customHostAlias: pulumi.Input.fromValue(map['customHostAlias'] as String),
      edasContainerVersion: pulumi.Input.fromValue(
        map['edasContainerVersion'] as String,
      ),
      ...
      minReadyInstances: pulumi.Input.fromValue(
        map['minReadyInstances'] as int,
      ),
      mountDescs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetApplicationsApplicationMountDesc>(
          map['mountDescs']!,
          (value) => GetApplicationsApplicationMountDesc.fromMap(
      ...
      ossMountDetails: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetApplicationsApplicationOssMountDetail>(
          map['ossMountDetails']!,
          (value) => GetApplicationsApplicationOssMountDetail.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      ...
      phpArmsConfigLocation: pulumi.Input.fromValue(
        map['phpArmsConfigLocation'] as String,
      ),
      phpConfig: pulumi.Input.fromValue(map['phpConfig'] as String),
      phpConfigLocation: pulumi.Input.fromValue(
        map['phpConfigLocation'] as String,
      ),
