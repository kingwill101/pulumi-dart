...
class ApplicationScalingRuleScalingRuleMetric {
  ...
  final pulumi.Input<List<ApplicationScalingRuleScalingRuleMetricMetric>>?
  metrics;
  ...
  final pulumi.Input<ApplicationScalingRuleScalingRuleMetricScaleDownRules>?
  scaleDownRules;

  /// Apply expansion rules. See `scale_up_rules` below.
  final pulumi.Input<ApplicationScalingRuleScalingRuleMetricScaleUpRules>?
  scaleUpRules;
    ...
    return <String, dynamic>{
      ...
      'metrics':
          ?pulumi.Input.mapOptionalInputValue<
            List<ApplicationScalingRuleScalingRuleMetricMetric>,
      ...
      'scaleDownRules':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(scaleDownRules, (value) => value.toMap()),
      'scaleUpRules':
          ?pulumi.Input.mapOptionalInputValue<
            ApplicationScalingRuleScalingRuleMetricScaleUpRules,
            Map<String, dynamic>
          >(scaleUpRules, (value) => value.toMap()),
    };
  }

  factory ApplicationScalingRuleScalingRuleMetric.fromMap(
    ...
    return ApplicationScalingRuleScalingRuleMetric(
      ...
      metrics: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<ApplicationScalingRuleScalingRuleMetricMetric>(
            guardedValue,
            (value) => ApplicationScalingRuleScalingRuleMetricMetric.fromMap(
      ...
      scaleDownRules: (() {
        final guardedValue = map['scaleDownRules'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ApplicationScalingRuleScalingRuleMetricScaleDownRules.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      scaleUpRules: (() {
        final guardedValue = map['scaleUpRules'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ApplicationScalingRuleScalingRuleMetricScaleUpRules.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
