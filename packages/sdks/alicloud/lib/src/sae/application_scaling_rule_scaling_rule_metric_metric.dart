...
class ApplicationScalingRuleScalingRuleMetricMetric {
  ...
  factory ApplicationScalingRuleScalingRuleMetricMetric.fromMap(Map<String, dynamic> map) {
    return ApplicationScalingRuleScalingRuleMetricMetric(
      metricTargetAverageUtilization: (() { final guardedValue = map['metricTargetAverageUtilization']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      slbLogStore: (() { final guardedValue = map['slbLogStore']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      slbProject: (() { final guardedValue = map['slbProject']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      vport: (() { final guardedValue = map['vport']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
