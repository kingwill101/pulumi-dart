...
class ApplicationNasConfig {
  ...
  factory ApplicationNasConfig.fromMap(Map<String, dynamic> map) {
    return ApplicationNasConfig(
      mountDomain: (() { final guardedValue = map['mountDomain']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      nasPath: (() { final guardedValue = map['nasPath']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
