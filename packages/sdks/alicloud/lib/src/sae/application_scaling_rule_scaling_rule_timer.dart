...
class ApplicationScalingRuleScalingRuleTimer {
  ...
  factory ApplicationScalingRuleScalingRuleTimer.fromMap(Map<String, dynamic> map) {
    return ApplicationScalingRuleScalingRuleTimer(
      beginDate: (() { final guardedValue = map['beginDate']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      schedules: (() { final guardedValue = map['schedules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ApplicationScalingRuleScalingRuleTimerSchedule>(guardedValue, (value) => ApplicationScalingRuleScalingRuleTimerSchedule.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
