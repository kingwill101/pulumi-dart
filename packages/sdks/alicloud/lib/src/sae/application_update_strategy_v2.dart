...
class ApplicationUpdateStrategyV2 {
  ...
  ApplicationUpdateStrategyV2({this.batchUpdate, this.type});
  ...
  factory ApplicationUpdateStrategyV2.fromMap(Map<String, dynamic> map) {
    return ApplicationUpdateStrategyV2(
      batchUpdate: (() {
        final guardedValue = map['batchUpdate'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ApplicationUpdateStrategyV2BatchUpdate.fromMap(
