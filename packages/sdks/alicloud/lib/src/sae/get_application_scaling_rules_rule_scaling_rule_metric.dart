...
class GetApplicationScalingRulesRuleScalingRuleMetric {
  ...
  final pulumi.Input<
    List<GetApplicationScalingRulesRuleScalingRuleMetricMetric>
  >
  metrics;

  /// Monitor indicator elasticity status.
  final pulumi.Input<
    List<GetApplicationScalingRulesRuleScalingRuleMetricMetricsStatus>
  >
  metricsStatuses;
  ...
  /// The shrink rule.
  final pulumi.Input<
    List<GetApplicationScalingRulesRuleScalingRuleMetricScaleDownRule>
  >
  scaleDownRules;

  /// The expansion rules.
  final pulumi.Input<
    List<GetApplicationScalingRulesRuleScalingRuleMetricScaleUpRule>
  >
  scaleUpRules;
  ...
  factory GetApplicationScalingRulesRuleScalingRuleMetric.fromMap(
    ...
    return GetApplicationScalingRulesRuleScalingRuleMetric(
      ...
      metrics: pulumi.Input.fromValue(
        ...
        >(
          map['metrics']!,
          (value) =>
              GetApplicationScalingRulesRuleScalingRuleMetricMetric.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
      metricsStatuses: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetApplicationScalingRulesRuleScalingRuleMetricMetricsStatus
        >(
          map['metricsStatuses']!,
          (value) =>
              GetApplicationScalingRulesRuleScalingRuleMetricMetricsStatus.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
      minReplicas: pulumi.Input.fromValue(map['minReplicas'] as int),
      scaleDownRules: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetApplicationScalingRulesRuleScalingRuleMetricScaleDownRule
        >(
          map['scaleDownRules']!,
          (value) =>
              GetApplicationScalingRulesRuleScalingRuleMetricScaleDownRule.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
      scaleUpRules: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetApplicationScalingRulesRuleScalingRuleMetricScaleUpRule
        >(
          map['scaleUpRules']!,
          (value) =>
              GetApplicationScalingRulesRuleScalingRuleMetricScaleUpRule.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
