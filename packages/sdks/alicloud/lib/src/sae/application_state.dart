...
class ApplicationState {
  ...
  factory ApplicationState.fromMap(Map<String, dynamic> map) {
    return ApplicationState(
      acrAssumeRoleArn: (() { final guardedValue = map['acrAssumeRoleArn']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      acrInstanceId: (() { final guardedValue = map['acrInstanceId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      appDescription: (() { final guardedValue = map['appDescription']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      autoConfig: (() { final guardedValue = map['autoConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      autoEnableApplicationScalingRule: (() { final guardedValue = map['autoEnableApplicationScalingRule']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      changeOrderDesc: (() { final guardedValue = map['changeOrderDesc']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      commandArgs: (() { final guardedValue = map['commandArgs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      commandArgsV2s: (() { final guardedValue = map['commandArgsV2s']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      configMapMountDesc: (() { final guardedValue = map['configMapMountDesc']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      configMapMountDescV2s: (() { final guardedValue = map['configMapMountDescV2s']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ApplicationConfigMapMountDescV2>(guardedValue, (value) => ApplicationConfigMapMountDescV2.fromMap((value as Map).cast<String, dynamic>()))); })(),
      cpu: (() { final guardedValue = map['cpu']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      customHostAlias: (() { final guardedValue = map['customHostAlias']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      customHostAliasV2s: (() { final guardedValue = map['customHostAliasV2s']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ApplicationCustomHostAliasV2>(guardedValue, (value) => ApplicationCustomHostAliasV2.fromMap((value as Map).cast<String, dynamic>()))); })(),
      deploy: (() { final guardedValue = map['deploy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      enableAhas: (() { final guardedValue = map['enableAhas']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      enableGreyTagRoute: (() { final guardedValue = map['enableGreyTagRoute']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      envs: (() { final guardedValue = map['envs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      imagePullSecrets: (() { final guardedValue = map['imagePullSecrets']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      jarStartArgs: (() { final guardedValue = map['jarStartArgs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      jarStartOptions: (() { final guardedValue = map['jarStartOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      jdk: (() { final guardedValue = map['jdk']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      kafkaConfigs: (() { final guardedValue = map['kafkaConfigs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ApplicationKafkaConfigs.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      livenessV2: (() { final guardedValue = map['livenessV2']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ApplicationLivenessV2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      memory: (() { final guardedValue = map['memory']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      microRegistration: (() { final guardedValue = map['microRegistration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      nasConfigs: (() { final guardedValue = map['nasConfigs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ApplicationNasConfig>(guardedValue, (value) => ApplicationNasConfig.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ossAkId: (() { final guardedValue = map['ossAkId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ossAkSecret: (() { final guardedValue = map['ossAkSecret']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ossMountDescs: (() { final guardedValue = map['ossMountDescs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ossMountDescsV2s: (() { final guardedValue = map['ossMountDescsV2s']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ApplicationOssMountDescsV2>(guardedValue, (value) => ApplicationOssMountDescsV2.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      php: (() { final guardedValue = map['php']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      phpArmsConfigLocation: (() { final guardedValue = map['phpArmsConfigLocation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      phpConfig: (() { final guardedValue = map['phpConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      phpConfigLocation: (() { final guardedValue = map['phpConfigLocation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      postStartV2: (() { final guardedValue = map['postStartV2']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ApplicationPostStartV2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      preStopV2: (() { final guardedValue = map['preStopV2']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ApplicationPreStopV2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      programmingLanguage: (() { final guardedValue = map['programmingLanguage']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      pvtzDiscoverySvc: (() { final guardedValue = map['pvtzDiscoverySvc']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ApplicationPvtzDiscoverySvc.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      readinessV2: (() { final guardedValue = map['readinessV2']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ApplicationReadinessV2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      slsConfigs: (() { final guardedValue = map['slsConfigs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      tomcatConfig: (() { final guardedValue = map['tomcatConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      tomcatConfigV2: (() { final guardedValue = map['tomcatConfigV2']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ApplicationTomcatConfigV2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      updateStrategyV2: (() { final guardedValue = map['updateStrategyV2']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ApplicationUpdateStrategyV2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      vpcId: (() { final guardedValue = map['vpcId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      vswitchId: (() { final guardedValue = map['vswitchId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      warStartOptions: (() { final guardedValue = map['warStartOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
