...
class Application extends pulumi.CustomResource {
  ...
  Application(
    ...
    enableGreyTagRoute = registerOutput<bool>('enableGreyTagRoute');
    envs = registerOutput<String>('envs');
    imagePullSecrets = registerOutput<String?>('imagePullSecrets');
    ...
    nasConfigs = registerOutput<List<Map<String, dynamic>>?>('nasConfigs');
    ...
    php = registerOutput<String?>('php');
    phpArmsConfigLocation = registerOutput<String>('phpArmsConfigLocation');
