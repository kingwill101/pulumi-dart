...
class InstanceV2State {
  ...
  factory InstanceV2State.fromMap(Map<String, dynamic> map) {
    return InstanceV2State(
      ...
      engineLists: (() { final guardedValue = map['engineLists']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InstanceV2EngineList>(guardedValue, (value) => InstanceV2EngineList.fromMap((value as Map).cast<String, dynamic>()))); })(),
