...
class Instance extends pulumi.CustomResource {
  ...
  Instance(
    ...
    searchEngineSpecification = registerOutput<String>('searchEngineSpecification');
    ...
    streamEngineSpecification = registerOutput<String>('streamEngineSpecification');
    tableEngineNodeCount = registerOutput<int>('tableEngineNodeCount');
    tableEngineSpecification = registerOutput<String>('tableEngineSpecification');
    tags = registerOutput<Map<String, String>?>('tags');
    timeSeriesEngineNodeCount = registerOutput<int>('timeSeriesEngineNodeCount');
    timeSeriesEngineSpecification = registerOutput<String>('timeSeriesEngineSpecification');
    timeSeriresEngineSpecification = registerOutput<String>('timeSeriresEngineSpecification');
