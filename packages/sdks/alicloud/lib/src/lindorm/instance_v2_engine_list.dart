...
class InstanceV2EngineList {
  ...
  factory InstanceV2EngineList.fromMap(Map<String, dynamic> map) {
    return InstanceV2EngineList(
      connectAddressLists: (() { final guardedValue = map['connectAddressLists']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InstanceV2EngineListConnectAddressList>(guardedValue, (value) => InstanceV2EngineListConnectAddressList.fromMap((value as Map).cast<String, dynamic>()))); })(),
      engineType: pulumi.Input.fromValue(map['engineType'] as String),
      isLastVersion: (() { final guardedValue = map['isLastVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      nodeGroups: (() { final guardedValue = map['nodeGroups']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InstanceV2EngineListNodeGroup>(guardedValue, (value) => InstanceV2EngineListNodeGroup.fromMap((value as Map).cast<String, dynamic>()))); })(),
