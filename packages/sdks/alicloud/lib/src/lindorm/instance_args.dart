...
class InstanceArgs {
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      ...
      archVersion: (() { final guardedValue = map['archVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      autoRenewPeriod: (() { final guardedValue = map['autoRenewPeriod']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      coldStorage: (() { final guardedValue = map['coldStorage']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      coreSingleStorage: (() { final guardedValue = map['coreSingleStorage']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      coreSpec: (() { final guardedValue = map['coreSpec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      deletionProection: (() { final guardedValue = map['deletionProection']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      fileEngineNodeCount: (() { final guardedValue = map['fileEngineNodeCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      fileEngineSpecification: (() { final guardedValue = map['fileEngineSpecification']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      instanceStorage: (() { final guardedValue = map['instanceStorage']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      logDiskCategory: (() { final guardedValue = map['logDiskCategory']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      logNum: (() { final guardedValue = map['logNum']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      logSingleStorage: (() { final guardedValue = map['logSingleStorage']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      logSpec: (() { final guardedValue = map['logSpec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ltsNodeCount: (() { final guardedValue = map['ltsNodeCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ltsNodeSpecification: (() { final guardedValue = map['ltsNodeSpecification']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      multiZoneCombination: (() { final guardedValue = map['multiZoneCombination']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      searchEngineNodeCount: (() { final guardedValue = map['searchEngineNodeCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      searchEngineSpecification: (() { final guardedValue = map['searchEngineSpecification']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      streamEngineNodeCount: (() { final guardedValue = map['streamEngineNodeCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      streamEngineSpecification: (() { final guardedValue = map['streamEngineSpecification']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      tableEngineNodeCount: (() { final guardedValue = map['tableEngineNodeCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      tableEngineSpecification: (() { final guardedValue = map['tableEngineSpecification']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      tags: (() { final guardedValue = map['tags']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      timeSeriesEngineNodeCount: (() { final guardedValue = map['timeSeriesEngineNodeCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      timeSeriesEngineSpecification: (() { final guardedValue = map['timeSeriesEngineSpecification']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      timeSeriresEngineSpecification: (() { final guardedValue = map['timeSeriresEngineSpecification']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
