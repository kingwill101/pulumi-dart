...
class InstanceState {
  ...
  factory InstanceState.fromMap(Map<String, dynamic> map) {
    return InstanceState(
      ...
      enabledFileEngine: (() { final guardedValue = map['enabledFileEngine']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      enabledLtsEngine: (() { final guardedValue = map['enabledLtsEngine']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      enabledSearchEngine: (() { final guardedValue = map['enabledSearchEngine']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      enabledStreamEngine: (() { final guardedValue = map['enabledStreamEngine']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      enabledTableEngine: (() { final guardedValue = map['enabledTableEngine']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      enabledTimeSeriresEngine: (() { final guardedValue = map['enabledTimeSeriresEngine']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
