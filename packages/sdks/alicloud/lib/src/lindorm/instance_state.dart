...
class InstanceState {
  ...
  factory InstanceState.fromMap(Map<String, dynamic> map) {
    return InstanceState(
      ...
      enabledFileEngine: map['enabledFileEngine'] == null ? null : (map['enabledFileEngine']! as bool).input(),
      enabledLtsEngine: map['enabledLtsEngine'] == null ? null : (map['enabledLtsEngine']! as bool).input(),
      enabledSearchEngine: map['enabledSearchEngine'] == null ? null : (map['enabledSearchEngine']! as bool).input(),
      enabledStreamEngine: map['enabledStreamEngine'] == null ? null : (map['enabledStreamEngine']! as bool).input(),
      enabledTableEngine: map['enabledTableEngine'] == null ? null : (map['enabledTableEngine']! as bool).input(),
      enabledTimeSeriresEngine: map['enabledTimeSeriresEngine'] == null ? null : (map['enabledTimeSeriresEngine']! as bool).input(),
