...
class InstanceState {
  ...
  InstanceState({
    ...
    pulumi.Output<bool>? enabledFileEngine,
    pulumi.Output<bool>? enabledLtsEngine,
    pulumi.Output<bool>? enabledSearchEngine,
    pulumi.Output<bool>? enabledStreamEngine,
    pulumi.Output<bool>? enabledTableEngine,
    pulumi.Output<bool>? enabledTimeSeriresEngine,
    ...
    pulumi.Output<String>? zoneId,
      ...
      enabledFileEngine = pulumi.Input.asOptionalInput<bool>(enabledFileEngine),
      enabledLtsEngine = pulumi.Input.asOptionalInput<bool>(enabledLtsEngine),
      enabledSearchEngine = pulumi.Input.asOptionalInput<bool>(enabledSearchEngine),
      enabledStreamEngine = pulumi.Input.asOptionalInput<bool>(enabledStreamEngine),
      enabledTableEngine = pulumi.Input.asOptionalInput<bool>(enabledTableEngine),
      enabledTimeSeriresEngine = pulumi.Input.asOptionalInput<bool>(enabledTimeSeriresEngine),
  ...
  factory InstanceState.fromMap(Map<String, dynamic> map) {
    return InstanceState(
      ...
      enabledFileEngine: map['enabledFileEngine'] == null ? null : pulumi.Output.create<bool>(map['enabledFileEngine'] as bool),
      enabledLtsEngine: map['enabledLtsEngine'] == null ? null : pulumi.Output.create<bool>(map['enabledLtsEngine'] as bool),
      enabledSearchEngine: map['enabledSearchEngine'] == null ? null : pulumi.Output.create<bool>(map['enabledSearchEngine'] as bool),
      enabledStreamEngine: map['enabledStreamEngine'] == null ? null : pulumi.Output.create<bool>(map['enabledStreamEngine'] as bool),
      enabledTableEngine: map['enabledTableEngine'] == null ? null : pulumi.Output.create<bool>(map['enabledTableEngine'] as bool),
      enabledTimeSeriresEngine: map['enabledTimeSeriresEngine'] == null ? null : pulumi.Output.create<bool>(map['enabledTimeSeriresEngine'] as bool),
