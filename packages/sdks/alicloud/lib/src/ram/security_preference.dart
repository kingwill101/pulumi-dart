...
class SecurityPreference extends pulumi.CustomResource {
  ...
  SecurityPreference(
    ...
    allowUserToChangePassword = registerOutput<bool>(
      'allowUserToChangePassword',
    );
    allowUserToLoginWithPasskey = registerOutput<bool>(
      'allowUserToLoginWithPasskey',
    );
    allowUserToManageAccessKeys = registerOutput<bool>(
      'allowUserToManageAccessKeys',
    );
    allowUserToManageMfaDevices = registerOutput<bool>(
      'allowUserToManageMfaDevices',
    );
    allowUserToManagePersonalDingTalk = registerOutput<bool>(
