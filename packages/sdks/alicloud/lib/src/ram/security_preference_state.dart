  ...
  factory SecurityPreferenceState.fromMap(Map<String, dynamic> map) {
    return SecurityPreferenceState(
      allowUserToChangePassword: (() {
        final guardedValue = map['allowUserToChangePassword'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      allowUserToLoginWithPasskey: (() {
        final guardedValue = map['allowUserToLoginWithPasskey'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      allowUserToManageAccessKeys: (() {
        final guardedValue = map['allowUserToManageAccessKeys'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      allowUserToManageMfaDevices: (() {
        final guardedValue = map['allowUserToManageMfaDevices'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      allowUserToManagePersonalDingTalk: (() {
        final guardedValue = map['allowUserToManagePersonalDingTalk'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      enableSaveMfaTicket: (() {
        final guardedValue = map['enableSaveMfaTicket'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      enforceMfaForLogin: (() {
        final guardedValue = map['enforceMfaForLogin'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      loginNetworkMasks: (() {
      ...
      loginSessionDuration: (() {
        final guardedValue = map['loginSessionDuration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      maxIdleDaysForAccessKeys: (() {
        final guardedValue = map['maxIdleDaysForAccessKeys'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      maxIdleDaysForUsers: (() {
        final guardedValue = map['maxIdleDaysForUsers'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      mfaOperationForLogin: (() {
        final guardedValue = map['mfaOperationForLogin'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ...
      verificationTypes: (() {
        final guardedValue = map['verificationTypes'];
        if (guardedValue == null) return null;
