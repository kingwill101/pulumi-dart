...
import 'user_group_attachment_state.dart';
...
class UserGroupAttachment extends pulumi.CustomResource {
  ...
  static UserGroupAttachment get(
    String name,
    pulumi.Input<String> id, {
    UserGroupAttachmentState? state,
  }) {
    return UserGroupAttachment._get(
      name,
      state: state?.toMap(),
