...
class PasswordPolicyState {
  ...
  factory PasswordPolicyState.fromMap(Map<String, dynamic> map) {
    return PasswordPolicyState(
      ...
      maxLoginAttemps: (() { final guardedValue = map['maxLoginAttemps']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      minimumPasswordDifferentCharacter: (() { final guardedValue = map['minimumPasswordDifferentCharacter']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
