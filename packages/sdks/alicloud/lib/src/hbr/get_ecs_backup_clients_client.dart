...
class GetEcsBackupClientsClient {
  ...
  factory GetEcsBackupClientsClient.fromMap(Map<String, dynamic> map) {
    return GetEcsBackupClientsClient(
      ...
      dataProxySetting: pulumi.Input.fromValue(
        map['dataProxySetting'] as String,
      ),
      ecsBackupClientId: pulumi.Input.fromValue(
        map['ecsBackupClientId'] as String,
      ),
      hostname: pulumi.Input.fromValue(map['hostname'] as String),
      id: pulumi.Input.fromValue(map['id'] as String),
      instanceId: pulumi.Input.fromValue(map['instanceId'] as String),
      instanceName: pulumi.Input.fromValue(map['instanceName'] as String),
      lastHeartBeatTime: pulumi.Input.fromValue(
        map['lastHeartBeatTime'] as String,
      ),
      maxClientVersion: pulumi.Input.fromValue(
        map['maxClientVersion'] as String,
      ),
