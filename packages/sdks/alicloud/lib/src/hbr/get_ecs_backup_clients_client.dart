...
class GetEcsBackupClientsClient {
  ...
  factory GetEcsBackupClientsClient.fromMap(Map<String, dynamic> map) {
    return GetEcsBackupClientsClient(
      archType: (map['archType'] as String).input(),
      ...
      dataNetworkType: (map['dataNetworkType'] as String).input(),
      dataProxySetting: (map['dataProxySetting'] as String).input(),
      ecsBackupClientId: (map['ecsBackupClientId'] as String).input(),
      hostname: (map['hostname'] as String).input(),
      id: (map['id'] as String).input(),
      instanceId: (map['instanceId'] as String).input(),
      instanceName: (map['instanceName'] as String).input(),
      lastHeartBeatTime: (map['lastHeartBeatTime'] as String).input(),
      maxClientVersion: (map['maxClientVersion'] as String).input(),
      maxCpuCore: (map['maxCpuCore'] as String).input(),
      maxWorker: (map['maxWorker'] as String).input(),
      osType: (map['osType'] as String).input(),
      privateIpv4: (map['privateIpv4'] as String).input(),
      proxyHost: (map['proxyHost'] as String).input(),
      proxyPassword: (map['proxyPassword'] as String).input(),
      proxyPort: (map['proxyPort'] as String).input(),
      proxyUser: (map['proxyUser'] as String).input(),
