...
class EcsBackupPlanState {
  ...
  EcsBackupPlanState({
    ...
    pulumi.Output<String>? ecsBackupPlanName,
    ...
    pulumi.Output<String>? vaultId,
      ...
      ecsBackupPlanName = pulumi.Input.asOptionalInput<String>(ecsBackupPlanName),
  ...
  factory EcsBackupPlanState.fromMap(Map<String, dynamic> map) {
    return EcsBackupPlanState(
      ...
      ecsBackupPlanName: map['ecsBackupPlanName'] == null ? null : pulumi.Output.create<String>(map['ecsBackupPlanName'] as String),
