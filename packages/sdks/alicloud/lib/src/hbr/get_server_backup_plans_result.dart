  ...
  factory GetServerBackupPlansResult.fromMap(Map<String, dynamic> map) {
    return GetServerBackupPlansResult(
      filters: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<GetServerBackupPlansFilter>(
          guardedValue,
          (value) => GetServerBackupPlansFilter.fromMap(
      ...
      plans: pulumi.Input.decodeList<GetServerBackupPlansPlan>(
        map['plans']!,
        (value) => GetServerBackupPlansPlan.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
    );
