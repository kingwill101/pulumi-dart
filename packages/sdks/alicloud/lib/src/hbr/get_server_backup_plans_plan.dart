    ...
    return <String, dynamic>{
      ...
      'details':
          pulumi.Input.mapInputValue<
            List<GetServerBackupPlansPlanDetail>,
  ...
  factory GetServerBackupPlansPlan.fromMap(Map<String, dynamic> map) {
    return GetServerBackupPlansPlan(
      ...
      details: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetServerBackupPlansPlanDetail>(
          map['details']!,
          (value) => GetServerBackupPlansPlanDetail.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      disabled: pulumi.Input.fromValue(map['disabled'] as bool),
      ecsServerBackupPlanId: pulumi.Input.fromValue(
        map['ecsServerBackupPlanId'] as String,
      ),
      ecsServerBackupPlanName: pulumi.Input.fromValue(
        map['ecsServerBackupPlanName'] as String,
      ),
