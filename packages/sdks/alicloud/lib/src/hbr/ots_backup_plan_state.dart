...
class OtsBackupPlanState {
  ...
  factory OtsBackupPlanState.fromMap(Map<String, dynamic> map) {
    return OtsBackupPlanState(
      ...
      otsBackupPlanName: (() { final guardedValue = map['otsBackupPlanName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
