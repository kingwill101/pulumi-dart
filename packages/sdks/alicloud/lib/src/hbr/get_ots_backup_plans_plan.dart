...
class GetOtsBackupPlansPlan {
  ...
  factory GetOtsBackupPlansPlan.fromMap(Map<String, dynamic> map) {
    return GetOtsBackupPlansPlan(
      ...
      otsDetails: pulumi.Input.fromValue(pulumi.Input.decodeList<GetOtsBackupPlansPlanOtsDetail>(map['otsDetails']!, (value) => GetOtsBackupPlansPlanOtsDetail.fromMap((value as Map).cast<String, dynamic>()))),
