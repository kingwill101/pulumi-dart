...
class RestoreJobState {
  ...
  RestoreJobState({
    ...
    pulumi.Output<String>? snapshotHash,
    ...
    pulumi.Output<String>? vaultId,
      ...
      snapshotHash = pulumi.Input.asOptionalInput<String>(snapshotHash),
  ...
  factory RestoreJobState.fromMap(Map<String, dynamic> map) {
    return RestoreJobState(
      ...
      snapshotHash: map['snapshotHash'] == null ? null : pulumi.Output.create<String>(map['snapshotHash'] as String),
