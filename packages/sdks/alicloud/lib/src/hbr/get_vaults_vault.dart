...
class GetVaultsVault {
  ...
  factory GetVaultsVault.fromMap(Map<String, dynamic> map) {
    return GetVaultsVault(
      ...
      latestReplicationTime: pulumi.Input.fromValue(
        map['latestReplicationTime'] as String,
      ),
      ...
      sourceTypes: pulumi.Input.fromValue(
        (map['sourceTypes'] as List).cast<String>(),
      ),
      ...
      vaultStatusMessage: pulumi.Input.fromValue(
        map['vaultStatusMessage'] as String,
      ),
      vaultStorageClass: pulumi.Input.fromValue(
        map['vaultStorageClass'] as String,
      ),
