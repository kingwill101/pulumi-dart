...
class OtsBackupPlanArgs {
  ...
  factory OtsBackupPlanArgs.fromMap(Map<String, dynamic> map) {
    return OtsBackupPlanArgs(
      ...
      otsBackupPlanName: pulumi.Input.fromValue(map['otsBackupPlanName'] as String),
      otsDetails: (() { final guardedValue = map['otsDetails']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OtsBackupPlanOtsDetail>(guardedValue, (value) => OtsBackupPlanOtsDetail.fromMap((value as Map).cast<String, dynamic>()))); })(),
      retention: pulumi.Input.fromValue(map['retention'] as String),
      rules: (() { final guardedValue = map['rules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OtsBackupPlanRule>(guardedValue, (value) => OtsBackupPlanRule.fromMap((value as Map).cast<String, dynamic>()))); })(),
