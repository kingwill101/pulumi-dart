...
class ServerBackupPlanDetail {
  ...
  final pulumi.Input<bool> appConsistent;
  ...
  final pulumi.Input<int>? destinationRetention;
  ...
  final pulumi.Input<bool>? doCopy;
  ...
  final pulumi.Input<bool>? enableFsFreeze;
  ...
  final pulumi.Input<String>? postScriptPath;
  ...
  final pulumi.Input<String>? preScriptPath;
  ...
  final pulumi.Input<bool> snapshotGroup;
  ...
  factory ServerBackupPlanDetail.fromMap(Map<String, dynamic> map) {
    return ServerBackupPlanDetail(
      appConsistent: pulumi.Input.fromValue(map['appConsistent'] as bool),
      ...
      destinationRetention: (() { final guardedValue = map['destinationRetention']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      doCopy: (() { final guardedValue = map['doCopy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      enableFsFreeze: (() { final guardedValue = map['enableFsFreeze']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      postScriptPath: (() { final guardedValue = map['postScriptPath']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      preScriptPath: (() { final guardedValue = map['preScriptPath']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      snapshotGroup: pulumi.Input.fromValue(map['snapshotGroup'] as bool),
