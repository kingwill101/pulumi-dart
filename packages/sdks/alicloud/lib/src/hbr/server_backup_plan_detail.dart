  ...
  factory ServerBackupPlanDetail.fromMap(Map<String, dynamic> map) {
    return ServerBackupPlanDetail(
      ...
      destinationRetention: (() {
        final guardedValue = map['destinationRetention'];
        if (guardedValue == null) return null;
      ...
      doCopy: (() {
        final guardedValue = map['doCopy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      enableFsFreeze: (() {
        final guardedValue = map['enableFsFreeze'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      postScriptPath: (() {
        final guardedValue = map['postScriptPath'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      preScriptPath: (() {
        final guardedValue = map['preScriptPath'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
