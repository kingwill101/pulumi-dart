...
class PolicyRule {
    ...
    return <String, dynamic>{
      ...
      'dataSourceFilters':
          ?pulumi.Input.mapOptionalInputValue<
            List<PolicyRuleDataSourceFilter>,
  ...
  factory PolicyRule.fromMap(Map<String, dynamic> map) {
    return PolicyRule(
      archiveDays: (() {
        final guardedValue = map['archiveDays'];
      ...
      dataSourceFilters: (() {
        final guardedValue = map['dataSourceFilters'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PolicyRuleDataSourceFilter>(
            guardedValue,
            (value) => PolicyRuleDataSourceFilter.fromMap(
      ...
      keepLatestSnapshots: (() {
        final guardedValue = map['keepLatestSnapshots'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      replicationRegionId: (() {
        final guardedValue = map['replicationRegionId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      retention: (() {
      ...
      retentionRules: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PolicyRuleRetentionRule>(
            guardedValue,
            (value) => PolicyRuleRetentionRule.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      tagFilters: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PolicyRuleTagFilter>(
            guardedValue,
            (value) => PolicyRuleTagFilter.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
