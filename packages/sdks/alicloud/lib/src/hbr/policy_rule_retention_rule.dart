...
class PolicyRuleRetentionRule {
  ...
  factory PolicyRuleRetentionRule.fromMap(Map<String, dynamic> map) {
    return PolicyRuleRetentionRule(
      advancedRetentionType: (() { final guardedValue = map['advancedRetentionType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
