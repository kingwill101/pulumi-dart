...
class GetBackupJobsResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'id': id,
      'ids': ids,
      'jobs': pulumi.Input.encodeList<GetBackupJobsJob, Map<String, dynamic>>(
        jobs,
        (value) => value.toMap(),
      ),
  ...
  factory GetBackupJobsResult.fromMap(Map<String, dynamic> map) {
    return GetBackupJobsResult(
      filters: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<GetBackupJobsFilter>(
          guardedValue,
      ...
      jobs: pulumi.Input.decodeList<GetBackupJobsJob>(
        map['jobs']!,
        (value) =>
            GetBackupJobsJob.fromMap((value as Map).cast<String, dynamic>()),
      ),
      outputFile: (() {
