...
class V3FunctionCustomContainerConfig {
  ...
  factory V3FunctionCustomContainerConfig.fromMap(Map<String, dynamic> map) {
    return V3FunctionCustomContainerConfig(
      accelerationInfo: (() { final guardedValue = map['accelerationInfo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(V3FunctionCustomContainerConfigAccelerationInfo.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      healthCheckConfig: (() { final guardedValue = map['healthCheckConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(V3FunctionCustomContainerConfigHealthCheckConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
