...
class GetFunctionsResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'functions': pulumi.Input.encodeList<GetFunctionsFunction, Map<String, dynamic>>(functions, (value) => value.toMap()),
      'id': id,
      'ids': ids,
      'nameRegex': ?nameRegex,
      'names': names,
  ...
  factory GetFunctionsResult.fromMap(Map<String, dynamic> map) {
    return GetFunctionsResult(
      functions: pulumi.Input.decodeList<GetFunctionsFunction>(map['functions']!, (value) => GetFunctionsFunction.fromMap((value as Map).cast<String, dynamic>())),
      id: map['id'] as String,
