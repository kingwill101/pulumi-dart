...
class Service extends pulumi.CustomResource {
  ...
  Service(
    ...
    logConfig = registerOutput<ServiceLogConfig?>('logConfig', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ServiceLogConfig.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    this.name = registerOutput<String>('name');
    namePrefix = registerOutput<String?>('namePrefix');
    nasConfig = registerOutput<ServiceNasConfig?>('nasConfig', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ServiceNasConfig.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    publish = registerOutput<bool?>('publish');
    role = registerOutput<String?>('role');
    serviceId = registerOutput<String>('serviceId');
    tags = registerOutput<Map<String, String>?>('tags');
    tracingConfig = registerOutput<ServiceTracingConfig?>('tracingConfig', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ServiceTracingConfig.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    version = registerOutput<String>('version');
    vpcConfig = registerOutput<ServiceVpcConfig?>('vpcConfig', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ServiceVpcConfig.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  }
