...
class FunctionType extends pulumi.CustomResource {
  ...
  FunctionType(
    ...
    customContainerConfig = registerOutput<FunctionCustomContainerConfig?>('customContainerConfig', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return FunctionCustomContainerConfig.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    ossKey = registerOutput<String?>('ossKey');
