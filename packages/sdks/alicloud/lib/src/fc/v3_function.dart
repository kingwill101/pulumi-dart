...
class V3Function extends pulumi.CustomResource {
  ...
  late final pulumi.Output<V3FunctionCustomContainerConfig?>
  ...
  late final pulumi.Output<V3FunctionInstanceLifecycleConfig?>
  instanceLifecycleConfig;
  ...
  late final pulumi.Output<V3FunctionInvocationRestriction?>
  ...
  V3Function(
    ...
    lastUpdateStatusReasonCode = registerOutput<String>(
