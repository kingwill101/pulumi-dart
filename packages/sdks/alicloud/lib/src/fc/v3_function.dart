...
class V3Function extends pulumi.CustomResource {
  ...
  V3Function(
    ...
    code = registerOutput<V3FunctionCode?>('code', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return V3FunctionCode.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    codeSize = registerOutput<int>('codeSize');
    cpu = registerOutput<double>('cpu');
    createTime = registerOutput<String>('createTime');
    customContainerConfig = registerOutput<V3FunctionCustomContainerConfig?>('customContainerConfig', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return V3FunctionCustomContainerConfig.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    customDns = registerOutput<V3FunctionCustomDns?>('customDns', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return V3FunctionCustomDns.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    customRuntimeConfig = registerOutput<V3FunctionCustomRuntimeConfig?>('customRuntimeConfig', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return V3FunctionCustomRuntimeConfig.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    gpuConfig = registerOutput<V3FunctionGpuConfig?>('gpuConfig', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return V3FunctionGpuConfig.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    instanceIsolationMode = registerOutput<String>('instanceIsolationMode');
    instanceLifecycleConfig = registerOutput<V3FunctionInstanceLifecycleConfig?>('instanceLifecycleConfig', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return V3FunctionInstanceLifecycleConfig.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    internetAccess = registerOutput<bool>('internetAccess');
    invocationRestriction = registerOutput<V3FunctionInvocationRestriction?>('invocationRestriction', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return V3FunctionInvocationRestriction.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    lastModifiedTime = registerOutput<String>('lastModifiedTime');
    lastUpdateStatus = registerOutput<String>('lastUpdateStatus');
    lastUpdateStatusReason = registerOutput<String>('lastUpdateStatusReason');
    lastUpdateStatusReasonCode = registerOutput<String>('lastUpdateStatusReasonCode');
    layers = registerOutput<List<String>?>('layers');
    logConfig = registerOutput<V3FunctionLogConfig?>('logConfig', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return V3FunctionLogConfig.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    memorySize = registerOutput<int>('memorySize');
    nasConfig = registerOutput<V3FunctionNasConfig>('nasConfig', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return V3FunctionNasConfig.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ossMountConfig = registerOutput<V3FunctionOssMountConfig>('ossMountConfig', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return V3FunctionOssMountConfig.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    resourceGroupId = registerOutput<String>('resourceGroupId');
    role = registerOutput<String?>('role');
    runtime = registerOutput<String>('runtime');
    sessionAffinity = registerOutput<String>('sessionAffinity');
    sessionAffinityConfig = registerOutput<String?>('sessionAffinityConfig');
    ...
    tracingConfig = registerOutput<V3FunctionTracingConfig>('tracingConfig', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return V3FunctionTracingConfig.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    vpcConfig = registerOutput<V3FunctionVpcConfig>('vpcConfig', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return V3FunctionVpcConfig.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  }
