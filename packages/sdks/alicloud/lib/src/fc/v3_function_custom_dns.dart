...
class V3FunctionCustomDns {
  ...
  V3FunctionCustomDns({this.dnsOptions, this.nameServers, this.searches});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'dnsOptions':
          ?pulumi.Input.mapOptionalInputValue<
            List<V3FunctionCustomDnsDnsOption>,
    ...
    return V3FunctionCustomDns(
      dnsOptions: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<V3FunctionCustomDnsDnsOption>(
            guardedValue,
            (value) => V3FunctionCustomDnsDnsOption.fromMap(
