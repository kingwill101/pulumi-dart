...
class FunctionAsyncInvokeConfigState {
  ...
  const FunctionAsyncInvokeConfigState({
    this.createdTime,
  ...
  factory FunctionAsyncInvokeConfigState.fromMap(Map<String, dynamic> map) {
    return FunctionAsyncInvokeConfigState(
      ...
      destinationConfig: (() { final guardedValue = map['destinationConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FunctionAsyncInvokeConfigDestinationConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      statefulInvocation: (() { final guardedValue = map['statefulInvocation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
    );
  }
}
