...
class GetCustomDomainsDomain {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'routeConfigs':
          pulumi.Input.mapInputValue<
            List<GetCustomDomainsDomainRouteConfig>,
  ...
  factory GetCustomDomainsDomain.fromMap(Map<String, dynamic> map) {
    return GetCustomDomainsDomain(
      ...
      certConfig: pulumi.Input.fromValue(
        GetCustomDomainsDomainCertConfig.fromMap(
          (map['certConfig']! as Map).cast<String, dynamic>(),
        ),
      ),
      ...
      routeConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetCustomDomainsDomainRouteConfig>(
          map['routeConfigs']!,
          (value) => GetCustomDomainsDomainRouteConfig.fromMap(
