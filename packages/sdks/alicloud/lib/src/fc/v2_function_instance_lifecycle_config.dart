...
class V2FunctionInstanceLifecycleConfig {
  ...
  factory V2FunctionInstanceLifecycleConfig.fromMap(Map<String, dynamic> map) {
    return V2FunctionInstanceLifecycleConfig(
      preFreeze: (() { final guardedValue = map['preFreeze']; if (guardedValue == null) return null; return pulumi.Input.fromValue(V2FunctionInstanceLifecycleConfigPreFreeze.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      preStop: (() { final guardedValue = map['preStop']; if (guardedValue == null) return null; return pulumi.Input.fromValue(V2FunctionInstanceLifecycleConfigPreStop.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
