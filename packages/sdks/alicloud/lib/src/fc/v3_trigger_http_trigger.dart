...
class V3TriggerHttpTrigger {
  ...
  factory V3TriggerHttpTrigger.fromMap(Map<String, dynamic> map) {
    return V3TriggerHttpTrigger(
      urlInternet: (() { final guardedValue = map['urlInternet']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      urlIntranet: (() { final guardedValue = map['urlIntranet']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
