...
class V3CustomDomainRouteConfigRouteRewriteConfig {
  ...
  final pulumi.Input<
    List<V3CustomDomainRouteConfigRouteRewriteConfigEqualRule>
  >?
  equalRules;

  /// Regular match rule list See `regex_rules` below.
  final pulumi.Input<
    List<V3CustomDomainRouteConfigRouteRewriteConfigRegexRule>
  >?
  regexRules;

  /// List of wildcard matching rules See `wildcard_rules` below.
  final pulumi.Input<
    List<V3CustomDomainRouteConfigRouteRewriteConfigWildcardRule>
  >?
  wildcardRules;
  ...
  factory V3CustomDomainRouteConfigRouteRewriteConfig.fromMap(
    Map<String, dynamic> map,
  ) {
    return V3CustomDomainRouteConfigRouteRewriteConfig(
      equalRules: (() {
        final guardedValue = map['equalRules'];
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                V3CustomDomainRouteConfigRouteRewriteConfigEqualRule.fromMap(
      ...
      regexRules: (() {
        final guardedValue = map['regexRules'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<
            V3CustomDomainRouteConfigRouteRewriteConfigRegexRule
          >(
            guardedValue,
            (value) =>
                V3CustomDomainRouteConfigRouteRewriteConfigRegexRule.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      wildcardRules: (() {
        final guardedValue = map['wildcardRules'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<
            V3CustomDomainRouteConfigRouteRewriteConfigWildcardRule
          >(
            guardedValue,
            (value) =>
                V3CustomDomainRouteConfigRouteRewriteConfigWildcardRule.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
