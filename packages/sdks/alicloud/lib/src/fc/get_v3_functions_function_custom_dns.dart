...
class GetV3FunctionsFunctionCustomDns {
    ...
    return <String, dynamic>{
      'dnsOptions':
          pulumi.Input.mapInputValue<
            List<GetV3FunctionsFunctionCustomDnsDnsOption>,
  ...
  factory GetV3FunctionsFunctionCustomDns.fromMap(Map<String, dynamic> map) {
    return GetV3FunctionsFunctionCustomDns(
      dnsOptions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetV3FunctionsFunctionCustomDnsDnsOption>(
          map['dnsOptions']!,
          (value) => GetV3FunctionsFunctionCustomDnsDnsOption.fromMap(
