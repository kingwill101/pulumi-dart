...
class FunctionAsyncInvokeConfigDestinationConfig {
  ...
  final pulumi.Input<FunctionAsyncInvokeConfigDestinationConfigOnFailure>?
  onFailure;

  /// Configuration block with destination configuration for successful asynchronous invocations. See `on_success` below.
  final pulumi.Input<FunctionAsyncInvokeConfigDestinationConfigOnSuccess>?
  onSuccess;
  ...
  FunctionAsyncInvokeConfigDestinationConfig({this.onFailure, this.onSuccess});
  ...
  factory FunctionAsyncInvokeConfigDestinationConfig.fromMap(
    ...
    return FunctionAsyncInvokeConfigDestinationConfig(
      onFailure: (() {
        ...
        return pulumi.Input.fromValue(
          FunctionAsyncInvokeConfigDestinationConfigOnFailure.fromMap(
      ...
      onSuccess: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FunctionAsyncInvokeConfigDestinationConfigOnSuccess.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
