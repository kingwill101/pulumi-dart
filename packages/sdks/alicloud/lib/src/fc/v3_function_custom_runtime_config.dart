...
class V3FunctionCustomRuntimeConfig {
  ...
  factory V3FunctionCustomRuntimeConfig.fromMap(Map<String, dynamic> map) {
    return V3FunctionCustomRuntimeConfig(
      ...
      healthCheckConfig: (() { final guardedValue = map['healthCheckConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(V3FunctionCustomRuntimeConfigHealthCheckConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
