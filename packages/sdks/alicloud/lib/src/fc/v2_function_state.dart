...
class V2FunctionState {
  ...
  final pulumi.Input<V2FunctionCustomHealthCheckConfig>?
  ...
  final pulumi.Input<V2FunctionInstanceLifecycleConfig>?
    ...
    return <String, dynamic>{
      ...
      'customHealthCheckConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(customHealthCheckConfig, (value) => value.toMap()),
      'customRuntimeConfig':
          ?pulumi.Input.mapOptionalInputValue<
    ...
    return V2FunctionState(
      ...
      code: (() {
        ...
        return pulumi.Input.fromValue(
          V2FunctionCode.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      codeChecksum: (() {
      ...
      customContainerConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          V2FunctionCustomContainerConfig.fromMap(
      ...
      customDns: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          V2FunctionCustomDns.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      customHealthCheckConfig: (() {
        final guardedValue = map['customHealthCheckConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          V2FunctionCustomHealthCheckConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      customRuntimeConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          V2FunctionCustomRuntimeConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      instanceLifecycleConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          V2FunctionInstanceLifecycleConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
