...
class GetV3FunctionsFunctionCustomContainerConfig {
  ...
  const GetV3FunctionsFunctionCustomContainerConfig({
  ...
  factory GetV3FunctionsFunctionCustomContainerConfig.fromMap(Map<String, dynamic> map) {
    return GetV3FunctionsFunctionCustomContainerConfig(
      accelerationInfo: pulumi.Input.fromValue(GetV3FunctionsFunctionCustomContainerConfigAccelerationInfo.fromMap((map['accelerationInfo']! as Map).cast<String, dynamic>())),
      accelerationType: pulumi.Input.fromValue(map['accelerationType'] as String),
      ...
      healthCheckConfig: pulumi.Input.fromValue(GetV3FunctionsFunctionCustomContainerConfigHealthCheckConfig.fromMap((map['healthCheckConfig']! as Map).cast<String, dynamic>())),
      image: pulumi.Input.fromValue(map['image'] as String),
      port: pulumi.Input.fromValue(map['port'] as int),
      resolvedImageUri: pulumi.Input.fromValue(map['resolvedImageUri'] as String),
    );
  }
}
