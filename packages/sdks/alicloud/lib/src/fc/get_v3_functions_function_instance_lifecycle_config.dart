...
class GetV3FunctionsFunctionInstanceLifecycleConfig {
  ...
  factory GetV3FunctionsFunctionInstanceLifecycleConfig.fromMap(Map<String, dynamic> map) {
    return GetV3FunctionsFunctionInstanceLifecycleConfig(
      initializer: (GetV3FunctionsFunctionInstanceLifecycleConfigInitializer.fromMap((map['initializer'] as Map).cast<String, dynamic>())).input(),
      preStop: (GetV3FunctionsFunctionInstanceLifecycleConfigPreStop.fromMap((map['preStop'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
