...
class GetV3FunctionsFunctionInstanceLifecycleConfig {
  ...
  final pulumi.Input<GetV3FunctionsFunctionInstanceLifecycleConfigInitializer>
  initializer;

  /// PreStop handler method configuration.
  final pulumi.Input<GetV3FunctionsFunctionInstanceLifecycleConfigPreStop>
  preStop;
  ...
  factory GetV3FunctionsFunctionInstanceLifecycleConfig.fromMap(
    Map<String, dynamic> map,
  ) {
    return GetV3FunctionsFunctionInstanceLifecycleConfig(
      initializer: pulumi.Input.fromValue(
        GetV3FunctionsFunctionInstanceLifecycleConfigInitializer.fromMap(
          (map['initializer']! as Map).cast<String, dynamic>(),
        ),
      ),
      preStop: pulumi.Input.fromValue(
        GetV3FunctionsFunctionInstanceLifecycleConfigPreStop.fromMap(
          (map['preStop']! as Map).cast<String, dynamic>(),
        ),
      ),
    );
  }
