...
class V3FunctionInstanceLifecycleConfig {
  ...
  const V3FunctionInstanceLifecycleConfig({
    this.initializer,
    this.preStop,
  });
  ...
  factory V3FunctionInstanceLifecycleConfig.fromMap(Map<String, dynamic> map) {
    return V3FunctionInstanceLifecycleConfig(
      initializer: (() { final guardedValue = map['initializer']; if (guardedValue == null) return null; return pulumi.Input.fromValue(V3FunctionInstanceLifecycleConfigInitializer.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      preStop: (() { final guardedValue = map['preStop']; if (guardedValue == null) return null; return pulumi.Input.fromValue(V3FunctionInstanceLifecycleConfigPreStop.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
