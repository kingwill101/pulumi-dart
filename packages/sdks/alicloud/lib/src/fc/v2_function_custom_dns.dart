...
class V2FunctionCustomDns {
  ...
  V2FunctionCustomDns({this.dnsOptions, this.nameServers, this.searches});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'dnsOptions':
          ?pulumi.Input.mapOptionalInputValue<
            List<V2FunctionCustomDnsDnsOption>,
    ...
    return V2FunctionCustomDns(
      dnsOptions: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<V2FunctionCustomDnsDnsOption>(
            guardedValue,
            (value) => V2FunctionCustomDnsDnsOption.fromMap(
