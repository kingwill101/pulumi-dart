...
import 'grant_rule_to_cen_state.dart';
...
class GrantRuleToCen extends pulumi.CustomResource {
  ...
  /// Gets an existing [GrantRuleToCen] resource's state with the given [name] and [id].
  static GrantRuleToCen get(
    String name,
    pulumi.Input<String> id, {
    GrantRuleToCenState? state,
  }) {
    return GrantRuleToCen._get(
      name,
      state: state?.toMap(),
