...
class VirtualBorderRouterArgs {
  ...
  VirtualBorderRouterArgs({
    ...
    required pulumi.Output<String> localGatewayIp,
    ...
    required pulumi.Output<String> peerGatewayIp,
    pulumi.Output<String>? peerIpv6GatewayIp,
    pulumi.Output<String>? peeringIpv6SubnetMask,
    required pulumi.Output<String> peeringSubnetMask,
  ...
  factory VirtualBorderRouterArgs.fromMap(Map<String, dynamic> map) {
    return VirtualBorderRouterArgs(
      ...
      localGatewayIp: pulumi.Output.create<String>(map['localGatewayIp'] as String),
      ...
      peerGatewayIp: pulumi.Output.create<String>(map['peerGatewayIp'] as String),
      ...
      peeringSubnetMask: pulumi.Output.create<String>(map['peeringSubnetMask'] as String),
