...
class GetVirtualBorderRoutersRouter {
  ...
  factory GetVirtualBorderRoutersRouter.fromMap(Map<String, dynamic> map) {
    return GetVirtualBorderRoutersRouter(
      ...
      cloudBoxInstanceId: pulumi.Input.fromValue(map['cloudBoxInstanceId'] as String),
      ...
      paymentVbrExpireTime: pulumi.Input.fromValue(map['paymentVbrExpireTime'] as String),
      ...
      physicalConnectionBusinessStatus: pulumi.Input.fromValue(map['physicalConnectionBusinessStatus'] as String),
      physicalConnectionId: pulumi.Input.fromValue(map['physicalConnectionId'] as String),
      physicalConnectionOwnerUid: pulumi.Input.fromValue(map['physicalConnectionOwnerUid'] as String),
      physicalConnectionStatus: pulumi.Input.fromValue(map['physicalConnectionStatus'] as String),
      ...
      virtualBorderRouterId: pulumi.Input.fromValue(map['virtualBorderRouterId'] as String),
      virtualBorderRouterName: pulumi.Input.fromValue(map['virtualBorderRouterName'] as String),
