...
class GetVirtualBorderRoutersArgs {
  ...
  GetVirtualBorderRoutersArgs({
    pulumi.Output<List<GetVirtualBorderRoutersFilter>>? filters,
  ...
  factory GetVirtualBorderRoutersArgs.fromMap(Map<String, dynamic> map) {
    return GetVirtualBorderRoutersArgs(
      filters: map['filters'] == null ? null : pulumi.Output.create<List<GetVirtualBorderRoutersFilter>>(pulumi.Input.decodeList<GetVirtualBorderRoutersFilter>(map['filters'], (value) => GetVirtualBorderRoutersFilter.fromMap((value as Map).cast<String, dynamic>()))),
