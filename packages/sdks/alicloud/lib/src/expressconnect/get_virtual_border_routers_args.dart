...
class GetVirtualBorderRoutersArgs {
  ...
  factory GetVirtualBorderRoutersArgs.fromMap(Map<String, dynamic> map) {
    return GetVirtualBorderRoutersArgs(
      filters: (() { final guardedValue = map['filters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetVirtualBorderRoutersFilter>(guardedValue, (value) => GetVirtualBorderRoutersFilter.fromMap((value as Map).cast<String, dynamic>()))); })(),
