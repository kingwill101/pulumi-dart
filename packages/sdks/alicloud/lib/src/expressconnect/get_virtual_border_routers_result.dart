  ...
  factory GetVirtualBorderRoutersResult.fromMap(Map<String, dynamic> map) {
    return GetVirtualBorderRoutersResult(
      filters: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<GetVirtualBorderRoutersFilter>(
          guardedValue,
          (value) => GetVirtualBorderRoutersFilter.fromMap(
      ...
      routers: pulumi.Input.decodeList<GetVirtualBorderRoutersRouter>(
        map['routers']!,
        (value) => GetVirtualBorderRoutersRouter.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      status: (() {
