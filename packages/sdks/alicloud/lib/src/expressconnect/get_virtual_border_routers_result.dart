...
class GetVirtualBorderRoutersResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'filters': ?(() { final guardedValue = filters; if (guardedValue == null) return null; return pulumi.Input.encodeList<GetVirtualBorderRoutersFilter, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
      'id': id,
      'ids': ids,
      'nameRegex': ?nameRegex,
      'names': names,
  ...
  factory GetVirtualBorderRoutersResult.fromMap(Map<String, dynamic> map) {
    return GetVirtualBorderRoutersResult(
      filters: (() { final guardedValue = map['filters']; if (guardedValue == null) return null; return pulumi.Input.decodeList<GetVirtualBorderRoutersFilter>(guardedValue, (value) => GetVirtualBorderRoutersFilter.fromMap((value as Map).cast<String, dynamic>())); })(),
      id: map['id'] as String,
