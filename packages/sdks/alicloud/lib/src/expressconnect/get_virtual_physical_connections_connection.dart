...
class GetVirtualPhysicalConnectionsConnection {
  ...
  factory GetVirtualPhysicalConnectionsConnection.fromMap(
    ...
    return GetVirtualPhysicalConnectionsConnection(
      ...
      parentPhysicalConnectionAliUid: pulumi.Input.fromValue(
        map['parentPhysicalConnectionAliUid'] as String,
      ),
      parentPhysicalConnectionId: pulumi.Input.fromValue(
        map['parentPhysicalConnectionId'] as String,
      ),
      ...
      virtualPhysicalConnectionId: pulumi.Input.fromValue(
        map['virtualPhysicalConnectionId'] as String,
      ),
      virtualPhysicalConnectionName: pulumi.Input.fromValue(
        map['virtualPhysicalConnectionName'] as String,
      ),
      virtualPhysicalConnectionStatus: pulumi.Input.fromValue(
        map['virtualPhysicalConnectionStatus'] as String,
      ),
