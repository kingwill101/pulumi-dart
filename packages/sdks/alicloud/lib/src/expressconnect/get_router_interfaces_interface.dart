...
class GetRouterInterfacesInterface {
  ...
  factory GetRouterInterfacesInterface.fromMap(Map<String, dynamic> map) {
    return GetRouterInterfacesInterface(
      ...
      oppositeAccessPointId: pulumi.Input.fromValue(
        map['oppositeAccessPointId'] as String,
      ),
      oppositeBandwidth: pulumi.Input.fromValue(
        map['oppositeBandwidth'] as int,
      ),
      oppositeInterfaceBusinessStatus: pulumi.Input.fromValue(
        map['oppositeInterfaceBusinessStatus'] as String,
      ),
      ...
      oppositeInterfaceSpec: pulumi.Input.fromValue(
        map['oppositeInterfaceSpec'] as String,
      ),
      oppositeInterfaceStatus: pulumi.Input.fromValue(
        map['oppositeInterfaceStatus'] as String,
      ),
      ...
      oppositeVpcInstanceId: pulumi.Input.fromValue(
        map['oppositeVpcInstanceId'] as String,
      ),
      ...
      routerInterfaceId: pulumi.Input.fromValue(
        map['routerInterfaceId'] as String,
      ),
      routerInterfaceName: pulumi.Input.fromValue(
        map['routerInterfaceName'] as String,
      ),
