...
/// {@template pulumi_expressconnect_physical_connection_physical_connection_args_doc}
/// The set of arguments for PhysicalConnection.
/// {@endtemplate}
/// {@macro pulumi_expressconnect_physical_connection_physical_connection_args_doc}
class PhysicalConnectionArgs {
  ...
  /// Creates a new [PhysicalConnectionArgs].
  ...
  PhysicalConnectionArgs({
    ...
    required pulumi.Output<String> lineOperator,
    ...
    pulumi.Output<String>? type,
      ...
      lineOperator = pulumi.Input.asInput<String>(lineOperator),
  ...
  factory PhysicalConnectionArgs.fromMap(Map<String, dynamic> map) {
    return PhysicalConnectionArgs(
      ...
      lineOperator: pulumi.Output.create<String>(map['lineOperator'] as String),
