...
class VirtualPhysicalConnection extends pulumi.CustomResource {
  ...
  VirtualPhysicalConnection(
    ...
    this.adLocation = registerOutput<String>('adLocation');
    ...
    this.expectSpec = registerOutput<String?>('expectSpec');
    this.lineOperator = registerOutput<String>('lineOperator');
    this.loaStatus = registerOutput<String>('loaStatus');
    this.orderMode = registerOutput<String>('orderMode');
    this.parentPhysicalConnectionAliUid = registerOutput<String>('parentPhysicalConnectionAliUid');
    this.parentPhysicalConnectionId = registerOutput<String>('parentPhysicalConnectionId');
    ...
    this.virtualPhysicalConnectionName = registerOutput<String?>('virtualPhysicalConnectionName');
    this.virtualPhysicalConnectionStatus = registerOutput<String>('virtualPhysicalConnectionStatus');
    this.vlanId = registerOutput<int>('vlanId');
    this.vpconnAliUid = registerOutput<String>('vpconnAliUid');
  }
