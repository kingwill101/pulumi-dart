...
class VirtualPhysicalConnection extends pulumi.CustomResource {
  ...
  VirtualPhysicalConnection(
    ...
    parentPhysicalConnectionAliUid = registerOutput<String>('parentPhysicalConnectionAliUid');
    parentPhysicalConnectionId = registerOutput<String>('parentPhysicalConnectionId');
    ...
    redundantPhysicalConnectionId = registerOutput<String>('redundantPhysicalConnectionId');
    resourceGroupId = registerOutput<String>('resourceGroupId');
    spec = registerOutput<String>('spec');
    status = registerOutput<String>('status');
    virtualPhysicalConnectionName = registerOutput<String?>('virtualPhysicalConnectionName');
    virtualPhysicalConnectionStatus = registerOutput<String>('virtualPhysicalConnectionStatus');
