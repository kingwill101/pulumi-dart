...
class VirtualPhysicalConnectionState {
  ...
  factory VirtualPhysicalConnectionState.fromMap(Map<String, dynamic> map) {
    return VirtualPhysicalConnectionState(
      ...
      adLocation: (() {
        final guardedValue = map['adLocation'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      bandwidth: (() {
      ...
      expectSpec: (() {
        final guardedValue = map['expectSpec'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      lineOperator: (() {
        final guardedValue = map['lineOperator'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      loaStatus: (() {
        final guardedValue = map['loaStatus'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      orderMode: (() {
        final guardedValue = map['orderMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      parentPhysicalConnectionAliUid: (() {
        final guardedValue = map['parentPhysicalConnectionAliUid'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ...
      virtualPhysicalConnectionName: (() {
        final guardedValue = map['virtualPhysicalConnectionName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
