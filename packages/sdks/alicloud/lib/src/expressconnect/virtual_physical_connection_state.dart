...
class VirtualPhysicalConnectionState {
  ...
  factory VirtualPhysicalConnectionState.fromMap(Map<String, dynamic> map) {
    return VirtualPhysicalConnectionState(
      ...
      adLocation: map['adLocation'] == null ? null : (map['adLocation']! as String).input(),
      ...
      loaStatus: map['loaStatus'] == null ? null : (map['loaStatus']! as String).input(),
      orderMode: map['orderMode'] == null ? null : (map['orderMode']! as String).input(),
      parentPhysicalConnectionAliUid: map['parentPhysicalConnectionAliUid'] == null ? null : (map['parentPhysicalConnectionAliUid']! as String).input(),
