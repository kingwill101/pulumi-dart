...
class GetVbrPconnAssociationsAssociation {
  ...
  factory GetVbrPconnAssociationsAssociation.fromMap(Map<String, dynamic> map) {
    return GetVbrPconnAssociationsAssociation(
      ...
      localIpv6GatewayIp: pulumi.Input.fromValue(map['localIpv6GatewayIp'] as String),
      peerGatewayIp: pulumi.Input.fromValue(map['peerGatewayIp'] as String),
      peerIpv6GatewayIp: pulumi.Input.fromValue(map['peerIpv6GatewayIp'] as String),
      peeringIpv6SubnetMask: pulumi.Input.fromValue(map['peeringIpv6SubnetMask'] as String),
