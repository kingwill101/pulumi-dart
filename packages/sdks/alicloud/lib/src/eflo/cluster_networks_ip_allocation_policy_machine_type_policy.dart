...
class ClusterNetworksIpAllocationPolicyMachineTypePolicy {
  ...
  final pulumi.Input<
    List<ClusterNetworksIpAllocationPolicyMachineTypePolicyBond>
  >?
  bonds;
  ...
  factory ClusterNetworksIpAllocationPolicyMachineTypePolicy.fromMap(
      ...
      bonds: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                ClusterNetworksIpAllocationPolicyMachineTypePolicyBond.fromMap(
