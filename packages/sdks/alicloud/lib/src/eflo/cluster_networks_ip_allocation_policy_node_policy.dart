...
class ClusterNetworksIpAllocationPolicyNodePolicy {
  ...
  final pulumi.Input<List<ClusterNetworksIpAllocationPolicyNodePolicyBond>>?
  bonds;
  ...
  /// [nodeId] Optional.
  ClusterNetworksIpAllocationPolicyNodePolicy({this.bonds, this.nodeId});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'bonds':
          ?pulumi.Input.mapOptionalInputValue<
            List<ClusterNetworksIpAllocationPolicyNodePolicyBond>,
  ...
  factory ClusterNetworksIpAllocationPolicyNodePolicy.fromMap(
    ...
    return ClusterNetworksIpAllocationPolicyNodePolicy(
      bonds: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => ClusterNetworksIpAllocationPolicyNodePolicyBond.fromMap(
