...
class NodeGroupIpAllocationPolicyMachineTypePolicy {
  ...
  const NodeGroupIpAllocationPolicyMachineTypePolicy({
    this.bonds,
    this.machineType,
  });
  ...
  factory NodeGroupIpAllocationPolicyMachineTypePolicy.fromMap(Map<String, dynamic> map) {
    return NodeGroupIpAllocationPolicyMachineTypePolicy(
      bonds: (() { final guardedValue = map['bonds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NodeGroupIpAllocationPolicyMachineTypePolicyBond>(guardedValue, (value) => NodeGroupIpAllocationPolicyMachineTypePolicyBond.fromMap((value as Map).cast<String, dynamic>()))); })(),
