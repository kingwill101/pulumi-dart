...
class NodeGroupIpAllocationPolicyMachineTypePolicy {
  ...
  final pulumi.Input<List<NodeGroupIpAllocationPolicyMachineTypePolicyBond>>?
  bonds;
  ...
  NodeGroupIpAllocationPolicyMachineTypePolicy({this.bonds, this.machineType});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'bonds':
          ?pulumi.Input.mapOptionalInputValue<
            List<NodeGroupIpAllocationPolicyMachineTypePolicyBond>,
  ...
  factory NodeGroupIpAllocationPolicyMachineTypePolicy.fromMap(
    ...
    return NodeGroupIpAllocationPolicyMachineTypePolicy(
      bonds: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => NodeGroupIpAllocationPolicyMachineTypePolicyBond.fromMap(
