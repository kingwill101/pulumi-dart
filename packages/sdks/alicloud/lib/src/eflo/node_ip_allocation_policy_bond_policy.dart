...
class NodeIpAllocationPolicyBondPolicy {
  ...
  NodeIpAllocationPolicyBondPolicy({this.bondDefaultSubnet, this.bonds});
    ...
    return <String, dynamic>{
      ...
      'bonds':
          ?pulumi.Input.mapOptionalInputValue<
            List<NodeIpAllocationPolicyBondPolicyBond>,
    ...
    return NodeIpAllocationPolicyBondPolicy(
      ...
      bonds: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NodeIpAllocationPolicyBondPolicyBond>(
            guardedValue,
            (value) => NodeIpAllocationPolicyBondPolicyBond.fromMap(
