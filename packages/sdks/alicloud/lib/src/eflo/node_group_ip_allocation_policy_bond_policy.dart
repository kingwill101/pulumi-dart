...
class NodeGroupIpAllocationPolicyBondPolicy {
  ...
  const NodeGroupIpAllocationPolicyBondPolicy({
  ...
  factory NodeGroupIpAllocationPolicyBondPolicy.fromMap(Map<String, dynamic> map) {
    return NodeGroupIpAllocationPolicyBondPolicy(
      ...
      bonds: (() { final guardedValue = map['bonds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NodeGroupIpAllocationPolicyBondPolicyBond>(guardedValue, (value) => NodeGroupIpAllocationPolicyBondPolicyBond.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
