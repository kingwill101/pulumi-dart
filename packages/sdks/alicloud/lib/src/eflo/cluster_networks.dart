...
class ClusterNetworks {
  ...
  final pulumi.Input<List<ClusterNetworksIpAllocationPolicy>>?
    ...
    return <String, dynamic>{
      'ipAllocationPolicies':
          ?pulumi.Input.mapOptionalInputValue<
            List<ClusterNetworksIpAllocationPolicy>,
    ...
    return ClusterNetworks(
      ipAllocationPolicies: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ClusterNetworksIpAllocationPolicy>(
            guardedValue,
            (value) => ClusterNetworksIpAllocationPolicy.fromMap(
      ...
      newVpdInfo: (() {
        final guardedValue = map['newVpdInfo'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ClusterNetworksNewVpdInfo.fromMap(
      ...
      tailIpVersion: (() {
        final guardedValue = map['tailIpVersion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      vpcId: (() {
      ...
      vpdInfo: (() {
        final guardedValue = map['vpdInfo'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ClusterNetworksVpdInfo.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
