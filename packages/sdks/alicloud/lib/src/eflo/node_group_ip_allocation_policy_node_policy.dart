...
class NodeGroupIpAllocationPolicyNodePolicy {
  ...
  /// [nodeId] Optional.
  NodeGroupIpAllocationPolicyNodePolicy({this.bonds, this.nodeId});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'bonds':
          ?pulumi.Input.mapOptionalInputValue<
            List<NodeGroupIpAllocationPolicyNodePolicyBond>,
  ...
  factory NodeGroupIpAllocationPolicyNodePolicy.fromMap(
    ...
    return NodeGroupIpAllocationPolicyNodePolicy(
      bonds: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NodeGroupIpAllocationPolicyNodePolicyBond>(
            guardedValue,
            (value) => NodeGroupIpAllocationPolicyNodePolicyBond.fromMap(
