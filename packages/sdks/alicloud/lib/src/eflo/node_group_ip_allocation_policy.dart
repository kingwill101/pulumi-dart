...
class NodeGroupIpAllocationPolicy {
  ...
  const NodeGroupIpAllocationPolicy({
    this.bondPolicy,
  ...
  factory NodeGroupIpAllocationPolicy.fromMap(Map<String, dynamic> map) {
    return NodeGroupIpAllocationPolicy(
      bondPolicy: (() { final guardedValue = map['bondPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NodeGroupIpAllocationPolicyBondPolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      machineTypePolicies: (() { final guardedValue = map['machineTypePolicies']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NodeGroupIpAllocationPolicyMachineTypePolicy>(guardedValue, (value) => NodeGroupIpAllocationPolicyMachineTypePolicy.fromMap((value as Map).cast<String, dynamic>()))); })(),
      nodePolicies: (() { final guardedValue = map['nodePolicies']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NodeGroupIpAllocationPolicyNodePolicy>(guardedValue, (value) => NodeGroupIpAllocationPolicyNodePolicy.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
