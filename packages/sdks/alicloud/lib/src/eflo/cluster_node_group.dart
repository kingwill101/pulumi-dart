...
class ClusterNodeGroup {
  ...
  factory ClusterNodeGroup.fromMap(Map<String, dynamic> map) {
    return ClusterNodeGroup(
      ...
      nodes: (() { final guardedValue = map['nodes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ClusterNodeGroupNode>(guardedValue, (value) => ClusterNodeGroupNode.fromMap((value as Map).cast<String, dynamic>()))); })(),
