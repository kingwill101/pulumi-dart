...
class ClusterComponentComponentConfig {
  ...
  ClusterComponentComponentConfig({this.basicArgs, this.nodeUnits});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'basicArgs': ?basicArgs, 'nodeUnits': ?nodeUnits};
  }

  factory ClusterComponentComponentConfig.fromMap(Map<String, dynamic> map) {
    return ClusterComponentComponentConfig(
      basicArgs: (() {
        final guardedValue = map['basicArgs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      nodeUnits: (() {
        final guardedValue = map['nodeUnits'];
        if (guardedValue == null) return null;
