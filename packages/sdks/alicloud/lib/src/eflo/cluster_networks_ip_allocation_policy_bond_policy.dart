...
class ClusterNetworksIpAllocationPolicyBondPolicy {
  ...
  const ClusterNetworksIpAllocationPolicyBondPolicy({
  ...
  factory ClusterNetworksIpAllocationPolicyBondPolicy.fromMap(Map<String, dynamic> map) {
    return ClusterNetworksIpAllocationPolicyBondPolicy(
      ...
      bonds: (() { final guardedValue = map['bonds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ClusterNetworksIpAllocationPolicyBondPolicyBond>(guardedValue, (value) => ClusterNetworksIpAllocationPolicyBondPolicyBond.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
