...
class NodeIpAllocationPolicyNodePolicy {
  ...
  /// [hostname] Host name
  /// [nodeId] Node ID
  NodeIpAllocationPolicyNodePolicy({this.bonds, this.hostname, this.nodeId});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'bonds':
          ?pulumi.Input.mapOptionalInputValue<
            List<NodeIpAllocationPolicyNodePolicyBond>,
    ...
    return NodeIpAllocationPolicyNodePolicy(
      bonds: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NodeIpAllocationPolicyNodePolicyBond>(
            guardedValue,
            (value) => NodeIpAllocationPolicyNodePolicyBond.fromMap(
