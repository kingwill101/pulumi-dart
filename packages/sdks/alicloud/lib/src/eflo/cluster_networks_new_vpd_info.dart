...
class ClusterNetworksNewVpdInfo {
    ...
    return <String, dynamic>{
      ...
      'vpdSubnets':
          ?pulumi.Input.mapOptionalInputValue<
            List<ClusterNetworksNewVpdInfoVpdSubnet>,
  ...
  factory ClusterNetworksNewVpdInfo.fromMap(Map<String, dynamic> map) {
    return ClusterNetworksNewVpdInfo(
      ...
      cloudLinkCidr: (() {
        final guardedValue = map['cloudLinkCidr'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      cloudLinkId: (() {
        final guardedValue = map['cloudLinkId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      monitorVpcId: (() {
        final guardedValue = map['monitorVpcId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      monitorVswitchId: (() {
        final guardedValue = map['monitorVswitchId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      vpdCidr: (() {
        final guardedValue = map['vpdCidr'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      vpdSubnets: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ClusterNetworksNewVpdInfoVpdSubnet>(
            guardedValue,
            (value) => ClusterNetworksNewVpdInfoVpdSubnet.fromMap(
