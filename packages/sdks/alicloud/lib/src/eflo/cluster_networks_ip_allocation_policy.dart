...
class ClusterNetworksIpAllocationPolicy {
  ...
  factory ClusterNetworksIpAllocationPolicy.fromMap(Map<String, dynamic> map) {
    return ClusterNetworksIpAllocationPolicy(
      bondPolicy: (() { final guardedValue = map['bondPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterNetworksIpAllocationPolicyBondPolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      machineTypePolicies: (() { final guardedValue = map['machineTypePolicies']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ClusterNetworksIpAllocationPolicyMachineTypePolicy>(guardedValue, (value) => ClusterNetworksIpAllocationPolicyMachineTypePolicy.fromMap((value as Map).cast<String, dynamic>()))); })(),
      nodePolicies: (() { final guardedValue = map['nodePolicies']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ClusterNetworksIpAllocationPolicyNodePolicy>(guardedValue, (value) => ClusterNetworksIpAllocationPolicyNodePolicy.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
