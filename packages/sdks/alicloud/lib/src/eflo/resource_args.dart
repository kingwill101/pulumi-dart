...
class ResourceArgs {
    ...
    return <String, dynamic>{
      ...
      'userAccessParam':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(userAccessParam, (value) => value.toMap()),
    };
  }
  ...
  factory ResourceArgs.fromMap(Map<String, dynamic> map) {
    return ResourceArgs(
      clusterDesc: (() {
        final guardedValue = map['clusterDesc'];
      ...
      machineTypes: pulumi.Input.fromValue(
        ResourceMachineTypes.fromMap(
          (map['machineTypes']! as Map).cast<String, dynamic>(),
        ),
      ),
      userAccessParam: pulumi.Input.fromValue(
        ResourceUserAccessParam.fromMap(
          (map['userAccessParam']! as Map).cast<String, dynamic>(),
        ),
      ),
    );
  }
