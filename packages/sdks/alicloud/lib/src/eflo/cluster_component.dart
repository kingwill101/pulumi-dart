...
class ClusterComponent {
  ...
  factory ClusterComponent.fromMap(Map<String, dynamic> map) {
    return ClusterComponent(
      componentConfig: (() { final guardedValue = map['componentConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterComponentComponentConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
