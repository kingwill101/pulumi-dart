...
class ExperimentPlanTemplateTemplatePipelineEnvParams {
  ...
  factory ExperimentPlanTemplateTemplatePipelineEnvParams.fromMap(
    Map<String, dynamic> map,
  ) {
    return ExperimentPlanTemplateTemplatePipelineEnvParams(
      cpuPerWorker: pulumi.Input.fromValue(map['cpuPerWorker'] as int),
      cudaVersion: (() {
        final guardedValue = map['cudaVersion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      gpuDriverVersion: (() {
        final guardedValue = map['gpuDriverVersion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ...
      ncclVersion: (() {
        final guardedValue = map['ncclVersion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      pyTorchVersion: (() {
        final guardedValue = map['pyTorchVersion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
