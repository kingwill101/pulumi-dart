...
class InvocationState {
  ...
  InvocationState({
    ...
    pulumi.Output<String>? launcher,
    pulumi.Output<String>? name,
    pulumi.Output<List<String>>? nodeIdLists,
    pulumi.Output<Map<String, String>>? parameters,
    pulumi.Output<String>? repeatMode,
    pulumi.Output<String>? terminationMode,
  ...
  factory InvocationState.fromMap(Map<String, dynamic> map) {
    return InvocationState(
      ...
      launcher: map['launcher'] == null ? null : pulumi.Output.create<String>(map['launcher'] as String),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      nodeIdLists: map['nodeIdLists'] == null ? null : pulumi.Output.create<List<String>>((map['nodeIdLists'] as List).cast<String>()),
      parameters: map['parameters'] == null ? null : pulumi.Output.create<Map<String, String>>((map['parameters'] as Map).cast<String, String>()),
      repeatMode: map['repeatMode'] == null ? null : pulumi.Output.create<String>(map['repeatMode'] as String),
      terminationMode: map['terminationMode'] == null ? null : pulumi.Output.create<String>(map['terminationMode'] as String),
