...
class GetVpdsResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'vpdId': ?vpdId,
      'vpdName': ?vpdName,
      'vpds': pulumi.Input.encodeList<GetVpdsVpd, Map<String, dynamic>>(
        vpds,
        (value) => value.toMap(),
      ),
    };
  ...
  factory GetVpdsResult.fromMap(Map<String, dynamic> map) {
    return GetVpdsResult(
      ...
      vpds: pulumi.Input.decodeList<GetVpdsVpd>(
        map['vpds']!,
        (value) => GetVpdsVpd.fromMap((value as Map).cast<String, dynamic>()),
      ),
    );
  }
}
