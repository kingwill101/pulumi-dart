...
class NodeArgs {
  ...
  factory NodeArgs.fromMap(Map<String, dynamic> map) {
    return NodeArgs(
      ...
      classify: (() { final guardedValue = map['classify']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      clusterId: (() { final guardedValue = map['clusterId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      computingServer: (() { final guardedValue = map['computingServer']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      dataDisks: (() { final guardedValue = map['dataDisks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NodeDataDisk>(guardedValue, (value) => NodeDataDisk.fromMap((value as Map).cast<String, dynamic>()))); })(),
      discountLevel: (() { final guardedValue = map['discountLevel']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      installPai: (() { final guardedValue = map['installPai']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ipAllocationPolicies: (() { final guardedValue = map['ipAllocationPolicies']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NodeIpAllocationPolicy>(guardedValue, (value) => NodeIpAllocationPolicy.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      paymentRatio: (() { final guardedValue = map['paymentRatio']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      productForm: (() { final guardedValue = map['productForm']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
