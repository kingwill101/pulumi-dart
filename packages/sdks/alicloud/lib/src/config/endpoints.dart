...
class Endpoints {
  ...
  factory Endpoints.fromMap(Map<String, dynamic> map) {
    return Endpoints(
      acr: (() { final guardedValue = map['acr']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      actiontrail: (() { final guardedValue = map['actiontrail']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      adb: (() { final guardedValue = map['adb']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      aiworkspace: (() { final guardedValue = map['aiworkspace']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      alb: (() { final guardedValue = map['alb']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      alidfs: (() { final guardedValue = map['alidfs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      alidns: (() { final guardedValue = map['alidns']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      alikafka: (() { final guardedValue = map['alikafka']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      amqp: (() { final guardedValue = map['amqp']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      antiddosPublic: (() { final guardedValue = map['antiddosPublic']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      apig: (() { final guardedValue = map['apig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      arms: (() { final guardedValue = map['arms']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      bastionhost: (() { final guardedValue = map['bastionhost']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      beebot: (() { final guardedValue = map['beebot']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      bpstudio: (() { final guardedValue = map['bpstudio']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      brainIndustrial: (() { final guardedValue = map['brainIndustrial']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      bssopenapi: (() { final guardedValue = map['bssopenapi']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      cas: (() { final guardedValue = map['cas']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      cassandra: (() { final guardedValue = map['cassandra']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      cbn: (() { final guardedValue = map['cbn']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      cbs: (() { final guardedValue = map['cbs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      cddc: (() { final guardedValue = map['cddc']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      cdn: (() { final guardedValue = map['cdn']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      cds: (() { final guardedValue = map['cds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      clickhouse: (() { final guardedValue = map['clickhouse']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      cloudapi: (() { final guardedValue = map['cloudapi']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      cloudauth: (() { final guardedValue = map['cloudauth']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      cloudfirewall: (() { final guardedValue = map['cloudfirewall']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      cloudfw: (() { final guardedValue = map['cloudfw']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      cloudphone: (() { final guardedValue = map['cloudphone']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      cloudsso: (() { final guardedValue = map['cloudsso']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      cms: (() { final guardedValue = map['cms']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      computenest: (() { final guardedValue = map['computenest']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      cr: (() { final guardedValue = map['cr']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      cs: (() { final guardedValue = map['cs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      das: (() { final guardedValue = map['das']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      datahub: (() { final guardedValue = map['datahub']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      dataworksPublic: (() { final guardedValue = map['dataworksPublic']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      dataworkspublic: (() { final guardedValue = map['dataworkspublic']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      dbfs: (() { final guardedValue = map['dbfs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      dbs: (() { final guardedValue = map['dbs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      dcdn: (() { final guardedValue = map['dcdn']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ddosbasic: (() { final guardedValue = map['ddosbasic']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ddosbgp: (() { final guardedValue = map['ddosbgp']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ddoscoo: (() { final guardedValue = map['ddoscoo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      dds: (() { final guardedValue = map['dds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      devopsRdc: (() { final guardedValue = map['devopsRdc']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      devopsrdc: (() { final guardedValue = map['devopsrdc']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      dfs: (() { final guardedValue = map['dfs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      dg: (() { final guardedValue = map['dg']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      dm: (() { final guardedValue = map['dm']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      dmsEnterprise: (() { final guardedValue = map['dmsEnterprise']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      dmsenterprise: (() { final guardedValue = map['dmsenterprise']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      dns: (() { final guardedValue = map['dns']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      drds: (() { final guardedValue = map['drds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      dts: (() { final guardedValue = map['dts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      dysms: (() { final guardedValue = map['dysms']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      dysmsapi: (() { final guardedValue = map['dysmsapi']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      eais: (() { final guardedValue = map['eais']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ebs: (() { final guardedValue = map['ebs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ecd: (() { final guardedValue = map['ecd']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      eci: (() { final guardedValue = map['eci']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ecs: (() { final guardedValue = map['ecs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      edas: (() { final guardedValue = map['edas']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      edasschedulerx: (() { final guardedValue = map['edasschedulerx']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      edsUser: (() { final guardedValue = map['edsUser']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      edsuser: (() { final guardedValue = map['edsuser']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      eflo: (() { final guardedValue = map['eflo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      efloCnp: (() { final guardedValue = map['efloCnp']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      efloController: (() { final guardedValue = map['efloController']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ehpc: (() { final guardedValue = map['ehpc']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ehs: (() { final guardedValue = map['ehs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      eipanycast: (() { final guardedValue = map['eipanycast']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      ens: (() { final guardedValue = map['ens']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      esa: (() { final guardedValue = map['esa']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ess: (() { final guardedValue = map['ess']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      fc: (() { final guardedValue = map['fc']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      fcOpen: (() { final guardedValue = map['fcOpen']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      fnf: (() { final guardedValue = map['fnf']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ga: (() { final guardedValue = map['ga']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      gaplus: (() { final guardedValue = map['gaplus']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      gdb: (() { final guardedValue = map['gdb']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      gds: (() { final guardedValue = map['gds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      gpdb: (() { final guardedValue = map['gpdb']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      gwlb: (() { final guardedValue = map['gwlb']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      gwsecd: (() { final guardedValue = map['gwsecd']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      hbr: (() { final guardedValue = map['hbr']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      hcsSgw: (() { final guardedValue = map['hcsSgw']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      hitsdb: (() { final guardedValue = map['hitsdb']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      imm: (() { final guardedValue = map['imm']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      imp: (() { final guardedValue = map['imp']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ims: (() { final guardedValue = map['ims']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      kvstore: (() { final guardedValue = map['kvstore']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      market: (() { final guardedValue = map['market']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      maxcompute: (() { final guardedValue = map['maxcompute']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      mhub: (() { final guardedValue = map['mhub']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      mns: (() { final guardedValue = map['mns']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      mnsOpen: (() { final guardedValue = map['mnsOpen']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      mscopensubscription: (() { final guardedValue = map['mscopensubscription']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      mse: (() { final guardedValue = map['mse']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      nas: (() { final guardedValue = map['nas']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      nlb: (() { final guardedValue = map['nlb']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      oceanbase: (() { final guardedValue = map['oceanbase']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      oceanbasepro: (() { final guardedValue = map['oceanbasepro']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ons: (() { final guardedValue = map['ons']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      onsproxy: (() { final guardedValue = map['onsproxy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      oos: (() { final guardedValue = map['oos']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      ots: (() { final guardedValue = map['ots']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      polardb: (() { final guardedValue = map['polardb']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      polardbx: (() { final guardedValue = map['polardbx']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      pvtz: (() { final guardedValue = map['pvtz']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      quickbi: (() { final guardedValue = map['quickbi']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      quickbiPublic: (() { final guardedValue = map['quickbiPublic']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      quotas: (() { final guardedValue = map['quotas']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      rKvstore: (() { final guardedValue = map['rKvstore']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      redisa: (() { final guardedValue = map['redisa']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      resourcemanager: (() { final guardedValue = map['resourcemanager']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      resourcesharing: (() { final guardedValue = map['resourcesharing']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ressharing: (() { final guardedValue = map['ressharing']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      rocketmq: (() { final guardedValue = map['rocketmq']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ros: (() { final guardedValue = map['ros']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      sae: (() { final guardedValue = map['sae']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      sas: (() { final guardedValue = map['sas']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      scdn: (() { final guardedValue = map['scdn']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      schedulerx2: (() { final guardedValue = map['schedulerx2']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      sddp: (() { final guardedValue = map['sddp']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      selectdb: (() { final guardedValue = map['selectdb']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      serverless: (() { final guardedValue = map['serverless']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      servicemesh: (() { final guardedValue = map['servicemesh']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      sgw: (() { final guardedValue = map['sgw']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      slb: (() { final guardedValue = map['slb']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      smartag: (() { final guardedValue = map['smartag']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      srvcatalog: (() { final guardedValue = map['srvcatalog']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      sts: (() { final guardedValue = map['sts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      swas: (() { final guardedValue = map['swas']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      swasOpen: (() { final guardedValue = map['swasOpen']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      tag: (() { final guardedValue = map['tag']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      vod: (() { final guardedValue = map['vod']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      vpc: (() { final guardedValue = map['vpc']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      vpcipam: (() { final guardedValue = map['vpcipam']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      vpcpeer: (() { final guardedValue = map['vpcpeer']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      vs: (() { final guardedValue = map['vs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      waf: (() { final guardedValue = map['waf']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      wafOpenapi: (() { final guardedValue = map['wafOpenapi']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
