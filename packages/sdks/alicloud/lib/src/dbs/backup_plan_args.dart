...
class BackupPlanArgs {
  ...
  BackupPlanArgs({
    ...
    required pulumi.Output<String> backupMethod,
    pulumi.Output<String>? backupObjects,
    pulumi.Output<String>? backupPeriod,
    required pulumi.Output<String> backupPlanName,
  ...
  factory BackupPlanArgs.fromMap(Map<String, dynamic> map) {
    return BackupPlanArgs(
      ...
      backupMethod: pulumi.Output.create<String>(map['backupMethod'] as String),
      ...
      backupPlanName: pulumi.Output.create<String>(map['backupPlanName'] as String),
