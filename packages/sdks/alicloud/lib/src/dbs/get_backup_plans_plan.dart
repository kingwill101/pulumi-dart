...
class GetBackupPlansPlan {
  ...
  factory GetBackupPlansPlan.fromMap(Map<String, dynamic> map) {
    return GetBackupPlansPlan(
      ...
      backupStorageType: pulumi.Input.fromValue(map['backupStorageType'] as String),
      ...
      duplicationArchivePeriod: pulumi.Input.fromValue(map['duplicationArchivePeriod'] as int),
      duplicationInfrequentAccessPeriod: pulumi.Input.fromValue(map['duplicationInfrequentAccessPeriod'] as int),
      ...
      sourceEndpointSid: pulumi.Input.fromValue(map['sourceEndpointSid'] as String),
