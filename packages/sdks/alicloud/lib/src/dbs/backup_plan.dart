...
class BackupPlan extends pulumi.CustomResource {
  ...
  BackupPlan(
    ...
    backupObjects = registerOutput<String>('backupObjects');
    backupPeriod = registerOutput<String>('backupPeriod');
    backupPlanName = registerOutput<String>('backupPlanName');
    backupRateLimit = registerOutput<String?>('backupRateLimit');
    backupRetentionPeriod = registerOutput<int>('backupRetentionPeriod');
    backupSpeedLimit = registerOutput<String?>('backupSpeedLimit');
    backupStartTime = registerOutput<String>('backupStartTime');
    backupStorageType = registerOutput<String>('backupStorageType');
    backupStrategyType = registerOutput<String?>('backupStrategyType');
    crossAliyunId = registerOutput<String>('crossAliyunId');
    crossRoleName = registerOutput<String>('crossRoleName');
    ...
    sourceEndpointSid = registerOutput<String>('sourceEndpointSid');
