...
class BucketReplicationState {
  ...
  factory BucketReplicationState.fromMap(Map<String, dynamic> map) {
    return BucketReplicationState(
      ...
      destination: (() { final guardedValue = map['destination']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BucketReplicationDestination.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
