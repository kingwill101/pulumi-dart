...
class BucketWebsiteRoutingRulesRoutingRule {
  ...
  factory BucketWebsiteRoutingRulesRoutingRule.fromMap(Map<String, dynamic> map) {
    return BucketWebsiteRoutingRulesRoutingRule(
      condition: (() { final guardedValue = map['condition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BucketWebsiteRoutingRulesRoutingRuleCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      luaConfig: (() { final guardedValue = map['luaConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BucketWebsiteRoutingRulesRoutingRuleLuaConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      redirect: (() { final guardedValue = map['redirect']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BucketWebsiteRoutingRulesRoutingRuleRedirect.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
