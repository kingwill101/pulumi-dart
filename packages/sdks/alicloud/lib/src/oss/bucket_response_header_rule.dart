...
class BucketResponseHeaderRule {
  ...
  factory BucketResponseHeaderRule.fromMap(Map<String, dynamic> map) {
    return BucketResponseHeaderRule(
      filters: (() { final guardedValue = map['filters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BucketResponseHeaderRuleFilters.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      hideHeaders: (() { final guardedValue = map['hideHeaders']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BucketResponseHeaderRuleHideHeaders.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
