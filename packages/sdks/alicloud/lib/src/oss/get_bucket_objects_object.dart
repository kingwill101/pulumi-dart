...
class GetBucketObjectsObject {
  ...
  factory GetBucketObjectsObject.fromMap(Map<String, dynamic> map) {
    return GetBucketObjectsObject(
      ...
      contentDisposition: pulumi.Input.fromValue(map['contentDisposition'] as String),
      ...
      serverSideEncryption: pulumi.Input.fromValue(map['serverSideEncryption'] as String),
