...
class BucketWebsiteRoutingRulesRoutingRuleRedirectMirrorHeaders {
  ...
  final pulumi.Input<List<BucketWebsiteRoutingRulesRoutingRuleRedirectMirrorHeadersSet>>? sets;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'passes': ?passes,
      'removes': ?removes,
      'sets': ?pulumi.Input.mapOptionalInputValue<List<BucketWebsiteRoutingRulesRoutingRuleRedirectMirrorHeadersSet>, List<Map<String, dynamic>>>(sets, (value) => pulumi.Input.encodeList<BucketWebsiteRoutingRulesRoutingRuleRedirectMirrorHeadersSet, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory BucketWebsiteRoutingRulesRoutingRuleRedirectMirrorHeaders.fromMap(Map<String, dynamic> map) {
    return BucketWebsiteRoutingRulesRoutingRuleRedirectMirrorHeaders(
      passAll: (() { final guardedValue = map['passAll']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      passes: (() { final guardedValue = map['passes']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      ...
      sets: (() { final guardedValue = map['sets']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<BucketWebsiteRoutingRulesRoutingRuleRedirectMirrorHeadersSet>(guardedValue, (value) => BucketWebsiteRoutingRulesRoutingRuleRedirectMirrorHeadersSet.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
