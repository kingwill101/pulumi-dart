...
class BucketState {
  ...
  factory BucketState.fromMap(Map<String, dynamic> map) {
    return BucketState(
      ...
      extranetEndpoint: map['extranetEndpoint'] == null ? null : (map['extranetEndpoint']! as String).input(),
      forceDestroy: map['forceDestroy'] == null ? null : (map['forceDestroy']! as bool).input(),
      intranetEndpoint: map['intranetEndpoint'] == null ? null : (map['intranetEndpoint']! as String).input(),
