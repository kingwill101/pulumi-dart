...
class BucketState {
  ...
  factory BucketState.fromMap(Map<String, dynamic> map) {
    return BucketState(
      accessMonitor: (() { final guardedValue = map['accessMonitor']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BucketAccessMonitor.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      extranetEndpoint: (() { final guardedValue = map['extranetEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      forceDestroy: (() { final guardedValue = map['forceDestroy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      intranetEndpoint: (() { final guardedValue = map['intranetEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      lifecycleRuleAllowSameActionOverlap: (() { final guardedValue = map['lifecycleRuleAllowSameActionOverlap']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      loggingIsenable: (() { final guardedValue = map['loggingIsenable']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      refererConfig: (() { final guardedValue = map['refererConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BucketRefererConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      resourceGroupId: (() { final guardedValue = map['resourceGroupId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      serverSideEncryptionRule: (() { final guardedValue = map['serverSideEncryptionRule']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BucketServerSideEncryptionRule.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      transferAcceleration: (() { final guardedValue = map['transferAcceleration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BucketTransferAcceleration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
