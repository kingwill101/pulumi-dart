...
class BucketWebsiteRoutingRulesRoutingRuleRedirectMirrorTaggings {
  ...
  factory BucketWebsiteRoutingRulesRoutingRuleRedirectMirrorTaggings.fromMap(Map<String, dynamic> map) {
    return BucketWebsiteRoutingRulesRoutingRuleRedirectMirrorTaggings(
      taggings: (() { final guardedValue = map['taggings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<BucketWebsiteRoutingRulesRoutingRuleRedirectMirrorTaggingsTagging>(guardedValue, (value) => BucketWebsiteRoutingRulesRoutingRuleRedirectMirrorTaggingsTagging.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
