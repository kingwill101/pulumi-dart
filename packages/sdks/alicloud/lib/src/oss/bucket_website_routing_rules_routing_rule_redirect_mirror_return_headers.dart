...
class BucketWebsiteRoutingRulesRoutingRuleRedirectMirrorReturnHeaders {
  ...
  factory BucketWebsiteRoutingRulesRoutingRuleRedirectMirrorReturnHeaders.fromMap(
    Map<String, dynamic> map,
  ) {
    return BucketWebsiteRoutingRulesRoutingRuleRedirectMirrorReturnHeaders(
      returnHeaders: (() {
        final guardedValue = map['returnHeaders'];
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                BucketWebsiteRoutingRulesRoutingRuleRedirectMirrorReturnHeadersReturnHeader.fromMap(
