...
class BucketOverwriteConfigArgs {
  ...
  factory BucketOverwriteConfigArgs.fromMap(Map<String, dynamic> map) {
    return BucketOverwriteConfigArgs(
      ...
      rules: (() { final guardedValue = map['rules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<BucketOverwriteConfigRule>(guardedValue, (value) => BucketOverwriteConfigRule.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
