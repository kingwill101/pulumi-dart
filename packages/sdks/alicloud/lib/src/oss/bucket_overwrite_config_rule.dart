...
class BucketOverwriteConfigRule {
  ...
  factory BucketOverwriteConfigRule.fromMap(Map<String, dynamic> map) {
    return BucketOverwriteConfigRule(
      ...
      principals: (() { final guardedValue = map['principals']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BucketOverwriteConfigRulePrincipals.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
