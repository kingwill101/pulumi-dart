...
class BucketWebsiteRoutingRulesRoutingRuleRedirectMirrorMultiAlternates {
  ...
  factory BucketWebsiteRoutingRulesRoutingRuleRedirectMirrorMultiAlternates.fromMap(
      ...
      mirrorMultiAlternates: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                BucketWebsiteRoutingRulesRoutingRuleRedirectMirrorMultiAlternatesMirrorMultiAlternate.fromMap(
