...
class BucketWebsiteRoutingRulesRoutingRuleRedirectMirrorMultiAlternates {
  ...
  final List<BucketWebsiteRoutingRulesRoutingRuleRedirectMirrorMultiAlternatesMirrorMultiAlternate>? mirrorMultiAlternates;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'mirrorMultiAlternates': ?mirrorMultiAlternates == null ? null : pulumi.Input.encodeList<BucketWebsiteRoutingRulesRoutingRuleRedirectMirrorMultiAlternatesMirrorMultiAlternate, Map<String, dynamic>>(mirrorMultiAlternates!, (value) => value.toMap()),
    };
  }
