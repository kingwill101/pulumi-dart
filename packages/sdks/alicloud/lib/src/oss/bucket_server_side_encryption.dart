...
import 'bucket_server_side_encryption_state.dart';
...
class BucketServerSideEncryption extends pulumi.CustomResource {
  ...
  static BucketServerSideEncryption get(
    String name,
    pulumi.Input<String> id, {
    BucketServerSideEncryptionState? state,
  }) {
    return BucketServerSideEncryption._get(
      name,
      state: state?.toMap(),
  ...
  BucketServerSideEncryption._get(
    String name, {
