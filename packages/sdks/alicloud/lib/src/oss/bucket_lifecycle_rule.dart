...
class BucketLifecycleRule {
  ...
  final pulumi.Input<List<BucketLifecycleRuleAbortMultipartUpload>>?
  ...
  final pulumi.Input<List<BucketLifecycleRuleNoncurrentVersionExpiration>>?
  noncurrentVersionExpirations;

  /// Specifies when noncurrent object versions transitions. See `noncurrent_version_transition` below.
  final pulumi.Input<List<BucketLifecycleRuleNoncurrentVersionTransition>>?
    ...
    return <String, dynamic>{
      'abortMultipartUploads':
          ?pulumi.Input.mapOptionalInputValue<
            List<BucketLifecycleRuleAbortMultipartUpload>,
      ...
      'expirations':
          ?pulumi.Input.mapOptionalInputValue<
            List<BucketLifecycleRuleExpiration>,
            List<Map<String, dynamic>>
          >(
            expirations,
            (value) =>
      ...
      'noncurrentVersionExpirations':
          ?pulumi.Input.mapOptionalInputValue<
            List<BucketLifecycleRuleNoncurrentVersionExpiration>,
            List<Map<String, dynamic>>
          >(
            noncurrentVersionExpirations,
            (value) =>
      ...
      'noncurrentVersionTransitions':
          ?pulumi.Input.mapOptionalInputValue<
            List<BucketLifecycleRuleNoncurrentVersionTransition>,
            List<Map<String, dynamic>>
          >(
            noncurrentVersionTransitions,
            (value) =>
      ...
      'transitions':
          ?pulumi.Input.mapOptionalInputValue<
            List<BucketLifecycleRuleTransition>,
            List<Map<String, dynamic>>
          >(
            transitions,
            (value) =>
  ...
  factory BucketLifecycleRule.fromMap(Map<String, dynamic> map) {
    return BucketLifecycleRule(
      abortMultipartUploads: (() {
        final guardedValue = map['abortMultipartUploads'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<BucketLifecycleRuleAbortMultipartUpload>(
            guardedValue,
            (value) => BucketLifecycleRuleAbortMultipartUpload.fromMap(
      ...
      expirations: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<BucketLifecycleRuleExpiration>(
            guardedValue,
            (value) => BucketLifecycleRuleExpiration.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      filter: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          BucketLifecycleRuleFilter.fromMap(
      ...
      noncurrentVersionExpirations: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<BucketLifecycleRuleNoncurrentVersionExpiration>(
            guardedValue,
            (value) => BucketLifecycleRuleNoncurrentVersionExpiration.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
