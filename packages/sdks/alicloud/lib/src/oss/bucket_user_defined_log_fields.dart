...
import 'bucket_user_defined_log_fields_state.dart';
...
class BucketUserDefinedLogFields extends pulumi.CustomResource {
  ...
  static BucketUserDefinedLogFields get(
    String name,
    pulumi.Input<String> id, {
    BucketUserDefinedLogFieldsState? state,
  }) {
    return BucketUserDefinedLogFields._get(
      name,
      state: state?.toMap(),
  ...
  BucketUserDefinedLogFields._get(
    String name, {
