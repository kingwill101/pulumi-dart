...
class BucketLifecycleRuleNoncurrentVersionTransition {
  ...
  factory BucketLifecycleRuleNoncurrentVersionTransition.fromMap(Map<String, dynamic> map) {
    return BucketLifecycleRuleNoncurrentVersionTransition(
      ...
      isAccessTime: (() { final guardedValue = map['isAccessTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      returnToStdWhenVisit: (() { final guardedValue = map['returnToStdWhenVisit']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
