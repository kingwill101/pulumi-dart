...
class BucketWebsiteRoutingRules {
  ...
  BucketWebsiteRoutingRules({this.routingRules});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'routingRules':
          ?pulumi.Input.mapOptionalInputValue<
            List<BucketWebsiteRoutingRulesRoutingRule>,
    ...
    return BucketWebsiteRoutingRules(
      routingRules: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<BucketWebsiteRoutingRulesRoutingRule>(
            guardedValue,
            (value) => BucketWebsiteRoutingRulesRoutingRule.fromMap(
