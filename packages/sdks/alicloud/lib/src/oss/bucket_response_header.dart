...
class BucketResponseHeader extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [BucketResponseHeader]. {@macro pulumi_oss_bucket_response_header_bucket_response_header_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  BucketResponseHeader(
    String name, {
  ...
  static BucketResponseHeader get(
    String name,
    pulumi.Input<String> id, {
    BucketResponseHeaderState? state,
  }) {
    return BucketResponseHeader._get(
      name,
      state: state?.toMap(),
