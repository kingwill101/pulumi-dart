    ...
    return <String, dynamic>{
      ...
      'parameters':
          ...
          >(
            parameters,
            (value) =>
                pulumi.Input.encodeList<StackParameter, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return StackState(
      ...
      parameters: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<StackParameter>(
            guardedValue,
            (value) =>
                StackParameter.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      ramRoleName: (() {
      ...
      retainAllResources: (() {
        final guardedValue = map['retainAllResources'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      retainResources: (() {
