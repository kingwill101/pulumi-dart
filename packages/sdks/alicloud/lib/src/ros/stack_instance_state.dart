    ...
    return <String, dynamic>{
      ...
      'parameterOverrides':
          ?pulumi.Input.mapOptionalInputValue<
            List<StackInstanceParameterOverride>,
  ...
  factory StackInstanceState.fromMap(Map<String, dynamic> map) {
    return StackInstanceState(
      operationDescription: (() {
        final guardedValue = map['operationDescription'];
      ...
      parameterOverrides: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<StackInstanceParameterOverride>(
            guardedValue,
            (value) => StackInstanceParameterOverride.fromMap(
      ...
      retainStacks: (() {
        final guardedValue = map['retainStacks'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      stackGroupName: (() {
        final guardedValue = map['stackGroupName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
