...
class GetStackGroupsResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'groups':
          pulumi.Input.encodeList<GetStackGroupsGroup, Map<String, dynamic>>(
            groups,
            (value) => value.toMap(),
          ),
      'id': id,
  ...
  factory GetStackGroupsResult.fromMap(Map<String, dynamic> map) {
    return GetStackGroupsResult(
      ...
      groups: pulumi.Input.decodeList<GetStackGroupsGroup>(
        map['groups']!,
        (value) =>
            GetStackGroupsGroup.fromMap((value as Map).cast<String, dynamic>()),
      ),
      id: map['id'] as String,
