...
class GetTemplateScratchesScratch {
  ...
  factory GetTemplateScratchesScratch.fromMap(Map<String, dynamic> map) {
    return GetTemplateScratchesScratch(
      ...
      logicalIdStrategy: pulumi.Input.fromValue(map['logicalIdStrategy'] as String),
      preferenceParameters: pulumi.Input.fromValue(pulumi.Input.decodeList<GetTemplateScratchesScratchPreferenceParameter>(map['preferenceParameters']!, (value) => GetTemplateScratchesScratchPreferenceParameter.fromMap((value as Map).cast<String, dynamic>()))),
      sourceResourceGroups: pulumi.Input.fromValue(pulumi.Input.decodeList<GetTemplateScratchesScratchSourceResourceGroup>(map['sourceResourceGroups']!, (value) => GetTemplateScratchesScratchSourceResourceGroup.fromMap((value as Map).cast<String, dynamic>()))),
      sourceResources: pulumi.Input.fromValue(pulumi.Input.decodeList<GetTemplateScratchesScratchSourceResource>(map['sourceResources']!, (value) => GetTemplateScratchesScratchSourceResource.fromMap((value as Map).cast<String, dynamic>()))),
      sourceTags: pulumi.Input.fromValue(pulumi.Input.decodeList<GetTemplateScratchesScratchSourceTag>(map['sourceTags']!, (value) => GetTemplateScratchesScratchSourceTag.fromMap((value as Map).cast<String, dynamic>()))),
      stacks: pulumi.Input.fromValue(pulumi.Input.decodeList<GetTemplateScratchesScratchStack>(map['stacks']!, (value) => GetTemplateScratchesScratchStack.fromMap((value as Map).cast<String, dynamic>()))),
      status: pulumi.Input.fromValue(map['status'] as String),
      templateScratchId: pulumi.Input.fromValue(map['templateScratchId'] as String),
