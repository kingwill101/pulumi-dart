...
class TemplateScratchState {
  ...
  final pulumi.Input<List<TemplateScratchPreferenceParameter>>?
    ...
    return <String, dynamic>{
      ...
      'preferenceParameters':
          ?pulumi.Input.mapOptionalInputValue<
            List<TemplateScratchPreferenceParameter>,
      ...
      'sourceResourceGroup':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(sourceResourceGroup, (value) => value.toMap()),
      'sourceResources':
          ?pulumi.Input.mapOptionalInputValue<
            List<TemplateScratchSourceResource>,
            List<Map<String, dynamic>>
          >(
            sourceResources,
            (value) =>
  ...
  factory TemplateScratchState.fromMap(Map<String, dynamic> map) {
    return TemplateScratchState(
      ...
      executionMode: (() {
        final guardedValue = map['executionMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      logicalIdStrategy: (() {
        final guardedValue = map['logicalIdStrategy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      preferenceParameters: (() {
        final guardedValue = map['preferenceParameters'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<TemplateScratchPreferenceParameter>(
            guardedValue,
            (value) => TemplateScratchPreferenceParameter.fromMap(
      ...
      sourceResourceGroup: (() {
        final guardedValue = map['sourceResourceGroup'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TemplateScratchSourceResourceGroup.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      sourceResources: (() {
        final guardedValue = map['sourceResources'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<TemplateScratchSourceResource>(
            guardedValue,
            (value) => TemplateScratchSourceResource.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      sourceTag: (() {
        final guardedValue = map['sourceTag'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TemplateScratchSourceTag.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
