...
class StackGroupArgs {
  ...
  factory StackGroupArgs.fromMap(Map<String, dynamic> map) {
    return StackGroupArgs(
      administrationRoleName: (() { final guardedValue = map['administrationRoleName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      autoDeployment: (() { final guardedValue = map['autoDeployment']; if (guardedValue == null) return null; return pulumi.Input.fromValue(StackGroupAutoDeployment.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      parameters: (() { final guardedValue = map['parameters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<StackGroupParameter>(guardedValue, (value) => StackGroupParameter.fromMap((value as Map).cast<String, dynamic>()))); })(),
