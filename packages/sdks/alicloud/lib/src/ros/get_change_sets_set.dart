...
class GetChangeSetsSet {
  ...
  factory GetChangeSetsSet.fromMap(Map<String, dynamic> map) {
    return GetChangeSetsSet(
      ...
      changeSetType: pulumi.Input.fromValue(map['changeSetType'] as String),
      ...
      parameters: pulumi.Input.fromValue(pulumi.Input.decodeList<GetChangeSetsSetParameter>(map['parameters']!, (value) => GetChangeSetsSetParameter.fromMap((value as Map).cast<String, dynamic>()))),
