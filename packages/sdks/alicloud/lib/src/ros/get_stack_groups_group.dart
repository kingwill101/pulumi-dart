...
class GetStackGroupsGroup {
  ...
  factory GetStackGroupsGroup.fromMap(Map<String, dynamic> map) {
    return GetStackGroupsGroup(
      administrationRoleName: pulumi.Input.fromValue(map['administrationRoleName'] as String),
      description: pulumi.Input.fromValue(map['description'] as String),
      executionRoleName: pulumi.Input.fromValue(map['executionRoleName'] as String),
      id: pulumi.Input.fromValue(map['id'] as String),
      parameters: pulumi.Input.fromValue(pulumi.Input.decodeList<GetStackGroupsGroupParameter>(map['parameters']!, (value) => GetStackGroupsGroupParameter.fromMap((value as Map).cast<String, dynamic>()))),
