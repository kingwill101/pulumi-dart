...
class ChangeSetArgs {
  ...
  factory ChangeSetArgs.fromMap(Map<String, dynamic> map) {
    return ChangeSetArgs(
      ...
      changeSetType: (() { final guardedValue = map['changeSetType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      parameters: (() { final guardedValue = map['parameters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ChangeSetParameter>(guardedValue, (value) => ChangeSetParameter.fromMap((value as Map).cast<String, dynamic>()))); })(),
