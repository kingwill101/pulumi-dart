...
class StackGroupState {
  ...
  factory StackGroupState.fromMap(Map<String, dynamic> map) {
    return StackGroupState(
      ...
      stackGroupId: (() { final guardedValue = map['stackGroupId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
