...
class GetHistoryDeliveryJobsJob {
  ...
  factory GetHistoryDeliveryJobsJob.fromMap(Map<String, dynamic> map) {
    return GetHistoryDeliveryJobsJob(
      ...
      historyDeliveryJobId: pulumi.Input.fromValue(map['historyDeliveryJobId'] as String),
      homeRegion: pulumi.Input.fromValue(map['homeRegion'] as String),
      id: pulumi.Input.fromValue(map['id'] as String),
      jobStatuses: pulumi.Input.fromValue(pulumi.Input.decodeList<GetHistoryDeliveryJobsJobJobStatus>(map['jobStatuses']!, (value) => GetHistoryDeliveryJobsJobJobStatus.fromMap((value as Map).cast<String, dynamic>()))),
