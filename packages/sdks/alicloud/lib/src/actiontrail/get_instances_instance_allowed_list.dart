...
class GetInstancesInstanceAllowedList {
  ...
  factory GetInstancesInstanceAllowedList.fromMap(Map<String, dynamic> map) {
    return GetInstancesInstanceAllowedList(
      ...
      internetLists: pulumi.Input.fromValue(pulumi.Input.decodeList<GetInstancesInstanceAllowedListInternetList>(map['internetLists']!, (value) => GetInstancesInstanceAllowedListInternetList.fromMap((value as Map).cast<String, dynamic>()))),
      vpcLists: pulumi.Input.fromValue(pulumi.Input.decodeList<GetInstancesInstanceAllowedListVpcList>(map['vpcLists']!, (value) => GetInstancesInstanceAllowedListVpcList.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
