...
class RegistryEnterpriseInstanceInstanceEndpoint {
  /// Domain List
  final pulumi.Input<List<RegistryEnterpriseInstanceInstanceEndpointDomain>>?
  domains;
    ...
    return <String, dynamic>{
      'domains':
          ?pulumi.Input.mapOptionalInputValue<
            List<RegistryEnterpriseInstanceInstanceEndpointDomain>,
  ...
  factory RegistryEnterpriseInstanceInstanceEndpoint.fromMap(
    ...
    return RegistryEnterpriseInstanceInstanceEndpoint(
      domains: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => RegistryEnterpriseInstanceInstanceEndpointDomain.fromMap(
