...
class ChainChainConfigNodeNodeConfig {
  ...
  final pulumi.Input<List<ChainChainConfigNodeNodeConfigDenyPolicy>>?
  denyPolicies;
  ...
  ChainChainConfigNodeNodeConfig({this.denyPolicies});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'denyPolicies':
          ?pulumi.Input.mapOptionalInputValue<
            List<ChainChainConfigNodeNodeConfigDenyPolicy>,
  ...
  factory ChainChainConfigNodeNodeConfig.fromMap(Map<String, dynamic> map) {
    return ChainChainConfigNodeNodeConfig(
      denyPolicies: (() {
        final guardedValue = map['denyPolicies'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ChainChainConfigNodeNodeConfigDenyPolicy>(
            guardedValue,
            (value) => ChainChainConfigNodeNodeConfigDenyPolicy.fromMap(
