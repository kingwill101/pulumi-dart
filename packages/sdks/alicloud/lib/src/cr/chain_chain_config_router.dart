...
class ChainChainConfigRouter {
  ...
  factory ChainChainConfigRouter.fromMap(Map<String, dynamic> map) {
    return ChainChainConfigRouter(
      froms: (() { final guardedValue = map['froms']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ChainChainConfigRouterFrom>(guardedValue, (value) => ChainChainConfigRouterFrom.fromMap((value as Map).cast<String, dynamic>()))); })(),
      tos: (() { final guardedValue = map['tos']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ChainChainConfigRouterTo>(guardedValue, (value) => ChainChainConfigRouterTo.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
