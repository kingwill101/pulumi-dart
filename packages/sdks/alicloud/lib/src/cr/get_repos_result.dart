...
class GetReposResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'repos': pulumi.Input.encodeList<GetReposRepo, Map<String, dynamic>>(
        repos,
        (value) => value.toMap(),
      ),
    };
  ...
  factory GetReposResult.fromMap(Map<String, dynamic> map) {
    return GetReposResult(
      ...
      repos: pulumi.Input.decodeList<GetReposRepo>(
        map['repos']!,
        (value) => GetReposRepo.fromMap((value as Map).cast<String, dynamic>()),
      ),
    );
  }
}
