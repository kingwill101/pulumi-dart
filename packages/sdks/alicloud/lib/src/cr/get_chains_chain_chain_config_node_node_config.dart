...
class GetChainsChainChainConfigNodeNodeConfig {
  ...
  final pulumi.Input<List<GetChainsChainChainConfigNodeNodeConfigDenyPolicy>>
  denyPolicies;
  ...
  GetChainsChainChainConfigNodeNodeConfig({required this.denyPolicies});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'denyPolicies':
          pulumi.Input.mapInputValue<
            List<GetChainsChainChainConfigNodeNodeConfigDenyPolicy>,
  ...
  factory GetChainsChainChainConfigNodeNodeConfig.fromMap(
    Map<String, dynamic> map,
  ) {
    return GetChainsChainChainConfigNodeNodeConfig(
      denyPolicies: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetChainsChainChainConfigNodeNodeConfigDenyPolicy
        >(
          map['denyPolicies']!,
          (value) => GetChainsChainChainConfigNodeNodeConfigDenyPolicy.fromMap(
