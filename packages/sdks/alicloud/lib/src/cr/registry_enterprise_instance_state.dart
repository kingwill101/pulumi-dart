...
class RegistryEnterpriseInstanceState {
  ...
  factory RegistryEnterpriseInstanceState.fromMap(Map<String, dynamic> map) {
    return RegistryEnterpriseInstanceState(
      ...
      instanceEndpoints: (() { final guardedValue = map['instanceEndpoints']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RegistryEnterpriseInstanceInstanceEndpoint>(guardedValue, (value) => RegistryEnterpriseInstanceInstanceEndpoint.fromMap((value as Map).cast<String, dynamic>()))); })(),
