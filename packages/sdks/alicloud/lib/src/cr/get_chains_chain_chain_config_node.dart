    ...
    return <String, dynamic>{
      ...
      'nodeConfigs':
          pulumi.Input.mapInputValue<
            List<GetChainsChainChainConfigNodeNodeConfig>,
  ...
  factory GetChainsChainChainConfigNode.fromMap(Map<String, dynamic> map) {
    return GetChainsChainChainConfigNode(
      ...
      nodeConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetChainsChainChainConfigNodeNodeConfig>(
          map['nodeConfigs']!,
          (value) => GetChainsChainChainConfigNodeNodeConfig.fromMap(
