...
import 'registry_enterprise_instance_state.dart';
...
class RegistryEnterpriseInstance extends pulumi.CustomResource {
  ...
  RegistryEnterpriseInstance(
    ...
    repoQuota = registerOutput<int?>('repoQuota');
    resourceGroupId = registerOutput<String>('resourceGroupId');
    status = registerOutput<String>('status');
    vpcQuota = registerOutput<int?>('vpcQuota');
  }

  /// Gets an existing [RegistryEnterpriseInstance] resource's state with the given [name] and [id].
  static RegistryEnterpriseInstance get(
    String name,
    pulumi.Input<String> id, {
    RegistryEnterpriseInstanceState? state,
  }) {
    return RegistryEnterpriseInstance._get(
      name,
      state: state?.toMap(),
  ...
  RegistryEnterpriseInstance._get(
    String name, {
