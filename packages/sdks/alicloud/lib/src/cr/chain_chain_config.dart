...
class ChainChainConfig {
  ...
  ChainChainConfig({this.nodes, this.routers});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'nodes':
          ?pulumi.Input.mapOptionalInputValue<
            List<ChainChainConfigNode>,
    ...
    return ChainChainConfig(
      nodes: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ChainChainConfigNode>(
            guardedValue,
            (value) => ChainChainConfigNode.fromMap(
      ...
      routers: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ChainChainConfigRouter>(
            guardedValue,
            (value) => ChainChainConfigRouter.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
