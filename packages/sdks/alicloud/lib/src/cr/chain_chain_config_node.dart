...
class ChainChainConfigNode {
  ...
  ChainChainConfigNode({this.enable, this.nodeConfigs, this.nodeName});
    ...
    return <String, dynamic>{
      ...
      'nodeConfigs':
          ?pulumi.Input.mapOptionalInputValue<
            List<ChainChainConfigNodeNodeConfig>,
    ...
    return ChainChainConfigNode(
      ...
      nodeConfigs: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ChainChainConfigNodeNodeConfig>(
            guardedValue,
            (value) => ChainChainConfigNodeNodeConfig.fromMap(
