...
class GetChainsChainChainConfigRouter {
  ...
  GetChainsChainChainConfigRouter({required this.froms, required this.tos});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'froms':
          pulumi.Input.mapInputValue<
            List<GetChainsChainChainConfigRouterFrom>,
      ...
      'tos':
          pulumi.Input.mapInputValue<
            List<GetChainsChainChainConfigRouterTo>,
            List<Map<String, dynamic>>
          >(
            tos,
            (value) =>
  ...
  factory GetChainsChainChainConfigRouter.fromMap(Map<String, dynamic> map) {
    return GetChainsChainChainConfigRouter(
      froms: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetChainsChainChainConfigRouterFrom>(
          map['froms']!,
          (value) => GetChainsChainChainConfigRouterFrom.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      tos: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetChainsChainChainConfigRouterTo>(
          map['tos']!,
          (value) => GetChainsChainChainConfigRouterTo.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
