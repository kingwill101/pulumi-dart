...
class GetChainsChain {
  ...
  factory GetChainsChain.fromMap(Map<String, dynamic> map) {
    return GetChainsChain(
      chainConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetChainsChainChainConfig>(map['chainConfigs']!, (value) => GetChainsChainChainConfig.fromMap((value as Map).cast<String, dynamic>()))),
