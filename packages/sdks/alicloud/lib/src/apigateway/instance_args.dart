...
class InstanceArgs {
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      deleteVpcIpBlock: (() { final guardedValue = map['deleteVpcIpBlock']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      egressIpv6Enable: (() { final guardedValue = map['egressIpv6Enable']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      httpsPolicy: pulumi.Input.fromValue(map['httpsPolicy'] as String),
      ingressVpcId: (() { final guardedValue = map['ingressVpcId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ingressVpcOwnerId: (() { final guardedValue = map['ingressVpcOwnerId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ingressVswitchId: (() { final guardedValue = map['ingressVswitchId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      instanceCidr: (() { final guardedValue = map['instanceCidr']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      skipWaitSwitch: (() { final guardedValue = map['skipWaitSwitch']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      toConnectVpcIpBlock: (() { final guardedValue = map['toConnectVpcIpBlock']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceToConnectVpcIpBlock.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      userVpcId: (() { final guardedValue = map['userVpcId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      vpcSlbIntranetEnable: (() { final guardedValue = map['vpcSlbIntranetEnable']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      zoneId: (() { final guardedValue = map['zoneId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      zoneVswitchSecurityGroups: (() { final guardedValue = map['zoneVswitchSecurityGroups']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InstanceZoneVswitchSecurityGroup>(guardedValue, (value) => InstanceZoneVswitchSecurityGroup.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
