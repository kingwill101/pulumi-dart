...
class ApiArgs {
  ...
  factory ApiArgs.fromMap(Map<String, dynamic> map) {
    return ApiArgs(
      ...
      constantParameters: (() { final guardedValue = map['constantParameters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ApiConstantParameter>(guardedValue, (value) => ApiConstantParameter.fromMap((value as Map).cast<String, dynamic>()))); })(),
      description: pulumi.Input.fromValue(map['description'] as String),
      fcServiceConfig: (() { final guardedValue = map['fcServiceConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ApiFcServiceConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      forceNonceCheck: (() { final guardedValue = map['forceNonceCheck']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      groupId: pulumi.Input.fromValue(map['groupId'] as String),
      httpServiceConfig: (() { final guardedValue = map['httpServiceConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ApiHttpServiceConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      httpVpcServiceConfig: (() { final guardedValue = map['httpVpcServiceConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ApiHttpVpcServiceConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      mockServiceConfig: (() { final guardedValue = map['mockServiceConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ApiMockServiceConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      requestConfig: pulumi.Input.fromValue(ApiRequestConfig.fromMap((map['requestConfig']! as Map).cast<String, dynamic>())),
      requestParameters: (() { final guardedValue = map['requestParameters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ApiRequestParameter>(guardedValue, (value) => ApiRequestParameter.fromMap((value as Map).cast<String, dynamic>()))); })(),
      serviceType: pulumi.Input.fromValue(map['serviceType'] as String),
      stageNames: (() { final guardedValue = map['stageNames']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      systemParameters: (() { final guardedValue = map['systemParameters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ApiSystemParameter>(guardedValue, (value) => ApiSystemParameter.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
