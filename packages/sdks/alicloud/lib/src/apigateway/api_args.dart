...
class ApiArgs {
  ...
  ApiArgs({
    ...
    required pulumi.Output<ApiRequestConfig> requestConfig,
  ...
  factory ApiArgs.fromMap(Map<String, dynamic> map) {
    return ApiArgs(
      ...
      requestConfig: pulumi.Output.create<ApiRequestConfig>(ApiRequestConfig.fromMap((map['requestConfig'] as Map).cast<String, dynamic>())),
