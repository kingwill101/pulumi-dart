...
class AccessControlListState {
  ...
  factory AccessControlListState.fromMap(Map<String, dynamic> map) {
    return AccessControlListState(
      ...
      aclEntrys: (() { final guardedValue = map['aclEntrys']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AccessControlListAclEntry>(guardedValue, (value) => AccessControlListAclEntry.fromMap((value as Map).cast<String, dynamic>()))); })(),
