...
import 'instance_acl_attachment_state.dart';
...
class InstanceAclAttachment extends pulumi.CustomResource {
  ...
  static InstanceAclAttachment get(
    String name,
    pulumi.Input<String> id, {
    InstanceAclAttachmentState? state,
  }) {
    return InstanceAclAttachment._get(
      name,
      state: state?.toMap(),
