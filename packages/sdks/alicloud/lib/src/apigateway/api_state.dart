...
class ApiState {
  ...
  factory ApiState.fromMap(Map<String, dynamic> map) {
    return ApiState(
      ...
      requestConfig: (() { final guardedValue = map['requestConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ApiRequestConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
