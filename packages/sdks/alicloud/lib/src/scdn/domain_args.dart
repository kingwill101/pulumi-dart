    ...
    return <String, dynamic>{
      ...
      'certInfos':
          ...
          >(
            certInfos,
            (value) =>
                pulumi.Input.encodeList<DomainCertInfo, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return DomainArgs(
      ...
      certInfos: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainCertInfo>(
            guardedValue,
            (value) =>
                DomainCertInfo.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      checkUrl: (() {
      ...
      forceSet: (() {
        final guardedValue = map['forceSet'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      resourceGroupId: (() {
