...
class ClusterHostGroup {
  ...
  factory ClusterHostGroup.fromMap(Map<String, dynamic> map) {
    return ClusterHostGroup(
      ...
      decommissionTimeout: (() {
        final guardedValue = map['decommissionTimeout'];
        if (guardedValue == null) return null;
      ...
      enableGracefulDecommission: (() {
        final guardedValue = map['enableGracefulDecommission'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      gpuDriver: (() {
      ...
      hostGroupType: (() {
        final guardedValue = map['hostGroupType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      instanceList: (() {
        final guardedValue = map['instanceList'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      instanceType: (() {
      ...
      sysDiskCapacity: (() {
        final guardedValue = map['sysDiskCapacity'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      sysDiskType: (() {
        final guardedValue = map['sysDiskType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
