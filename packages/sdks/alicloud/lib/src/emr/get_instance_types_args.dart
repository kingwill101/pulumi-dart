...
class GetInstanceTypesArgs {
  ...
  factory GetInstanceTypesArgs.fromMap(Map<String, dynamic> map) {
    return GetInstanceTypesArgs(
      ...
      destinationResource: pulumi.Input.fromValue(map['destinationResource'] as String),
      ...
      supportLocalStorage: (() { final guardedValue = map['supportLocalStorage']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      supportNodeTypes: (() { final guardedValue = map['supportNodeTypes']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
