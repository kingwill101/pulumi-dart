...
class ClusterState {
  ...
  factory ClusterState.fromMap(Map<String, dynamic> map) {
    return ClusterState(
      ...
      configs: (() { final guardedValue = map['configs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ClusterConfig>(guardedValue, (value) => ClusterConfig.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      easEnable: (() { final guardedValue = map['easEnable']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      emrVer: (() { final guardedValue = map['emrVer']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      highAvailabilityEnable: (() { final guardedValue = map['highAvailabilityEnable']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      hostGroups: (() { final guardedValue = map['hostGroups']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ClusterHostGroup>(guardedValue, (value) => ClusterHostGroup.fromMap((value as Map).cast<String, dynamic>()))); })(),
      isOpenPublicIp: (() { final guardedValue = map['isOpenPublicIp']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      masterPwd: (() { final guardedValue = map['masterPwd']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      metaStoreConf: (() { final guardedValue = map['metaStoreConf']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterMetaStoreConf.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      metaStoreType: (() { final guardedValue = map['metaStoreType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      modifyClusterServiceConfig: (() { final guardedValue = map['modifyClusterServiceConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterModifyClusterServiceConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      optionSoftwareLists: (() { final guardedValue = map['optionSoftwareLists']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      period: (() { final guardedValue = map['period']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      relatedClusterId: (() { final guardedValue = map['relatedClusterId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      sshEnable: (() { final guardedValue = map['sshEnable']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      tags: (() { final guardedValue = map['tags']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      useLocalMetadb: (() { final guardedValue = map['useLocalMetadb']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      userDefinedEmrEcsRole: (() { final guardedValue = map['userDefinedEmrEcsRole']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
