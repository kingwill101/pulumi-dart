...
class EndpointState {
  ...
  factory EndpointState.fromMap(Map<String, dynamic> map) {
    return EndpointState(
      ...
      ipConfigs: (() { final guardedValue = map['ipConfigs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<EndpointIpConfig>(guardedValue, (value) => EndpointIpConfig.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      vpcRegionId: (() { final guardedValue = map['vpcRegionId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
