...
class ZoneArgs {
  ...
  factory ZoneArgs.fromMap(Map<String, dynamic> map) {
    return ZoneArgs(
      ...
      proxyPattern: (() { final guardedValue = map['proxyPattern']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      syncStatus: (() { final guardedValue = map['syncStatus']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      userInfos: (() { final guardedValue = map['userInfos']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ZoneUserInfo>(guardedValue, (value) => ZoneUserInfo.fromMap((value as Map).cast<String, dynamic>()))); })(),
