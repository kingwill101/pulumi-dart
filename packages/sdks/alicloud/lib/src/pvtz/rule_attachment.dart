...
class RuleAttachment extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [RuleAttachment]. {@macro pulumi_pvtz_rule_attachment_rule_attachment_args_doc}
  ...
  static RuleAttachment get(
    String name,
    pulumi.Input<String> id, {
    RuleAttachmentState? state,
  }) {
    return RuleAttachment._get(
      name,
      state: state?.toMap(),
