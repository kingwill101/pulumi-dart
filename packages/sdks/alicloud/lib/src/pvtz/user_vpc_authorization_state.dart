...
class UserVpcAuthorizationState {
  ...
  const UserVpcAuthorizationState({
    this.authChannel,
    this.authType,
  ...
  factory UserVpcAuthorizationState.fromMap(Map<String, dynamic> map) {
    return UserVpcAuthorizationState(
      ...
      authorizedUserId: (() { final guardedValue = map['authorizedUserId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
