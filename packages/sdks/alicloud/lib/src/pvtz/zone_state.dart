...
class ZoneState {
  ...
  factory ZoneState.fromMap(Map<String, dynamic> map) {
    return ZoneState(
      isPtr: (() { final guardedValue = map['isPtr']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      recordCount: (() { final guardedValue = map['recordCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
