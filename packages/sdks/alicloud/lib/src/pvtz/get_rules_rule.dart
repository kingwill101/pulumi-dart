  ...
  factory GetRulesRule.fromMap(Map<String, dynamic> map) {
    return GetRulesRule(
      bindVpcs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetRulesRuleBindVpc>(
          map['bindVpcs']!,
          (value) => GetRulesRuleBindVpc.fromMap(
      ...
      forwardIps: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetRulesRuleForwardIp>(
          map['forwardIps']!,
          (value) => GetRulesRuleForwardIp.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
