...
class GetTemplatesResult {
  ...
  factory GetTemplatesResult.fromMap(Map<String, dynamic> map) {
    return GetTemplatesResult(
      ...
      createdDateAfter: (() { final guardedValue = map['createdDateAfter']; if (guardedValue == null) return null; return guardedValue as String; })(),
      hasTrigger: (() { final guardedValue = map['hasTrigger']; if (guardedValue == null) return null; return guardedValue as bool; })(),
      id: map['id'] as String,
      ...
      templateFormat: (() { final guardedValue = map['templateFormat']; if (guardedValue == null) return null; return guardedValue as String; })(),
      templateType: (() { final guardedValue = map['templateType']; if (guardedValue == null) return null; return guardedValue as String; })(),
