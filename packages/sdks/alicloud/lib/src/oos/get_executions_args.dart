...
class GetExecutionsArgs {
  ...
  factory GetExecutionsArgs.fromMap(Map<String, dynamic> map) {
    return GetExecutionsArgs(
      ...
      endDateAfter: (() { final guardedValue = map['endDateAfter']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      includeChildExecution: (() { final guardedValue = map['includeChildExecution']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      startDateAfter: (() { final guardedValue = map['startDateAfter']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      startDateBefore: (() { final guardedValue = map['startDateBefore']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
