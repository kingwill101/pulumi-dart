...
class BasicAcceleratorArgs {
  ...
  factory BasicAcceleratorArgs.fromMap(Map<String, dynamic> map) {
    return BasicAcceleratorArgs(
      ...
      autoUseCoupon: (() { final guardedValue = map['autoUseCoupon']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      basicAcceleratorName: (() { final guardedValue = map['basicAcceleratorName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
