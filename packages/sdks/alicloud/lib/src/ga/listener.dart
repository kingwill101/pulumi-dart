...
class Listener extends pulumi.CustomResource {
  ...
  Listener(
    ...
    forwardedForConfig = registerOutput<ListenerForwardedForConfig?>('forwardedForConfig', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ListenerForwardedForConfig.fromMap((guardedValue as Map).cast<String, dynamic>()); });
