...
class EndpointGroupArgs {
  ...
  EndpointGroupArgs({
    ...
    required pulumi.Output<List<EndpointGroupEndpointConfiguration>> endpointConfigurations,
  ...
  factory EndpointGroupArgs.fromMap(Map<String, dynamic> map) {
    return EndpointGroupArgs(
      ...
      endpointConfigurations: pulumi.Output.create<List<EndpointGroupEndpointConfiguration>>(pulumi.Input.decodeList<EndpointGroupEndpointConfiguration>(map['endpointConfigurations'], (value) => EndpointGroupEndpointConfiguration.fromMap((value as Map).cast<String, dynamic>()))),
