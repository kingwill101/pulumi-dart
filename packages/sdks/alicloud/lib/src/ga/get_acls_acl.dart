...
class GetAclsAcl {
  ...
  factory GetAclsAcl.fromMap(Map<String, dynamic> map) {
    return GetAclsAcl(
      aclEntries: pulumi.Input.fromValue(pulumi.Input.decodeList<GetAclsAclAclEntry>(map['aclEntries']!, (value) => GetAclsAclAclEntry.fromMap((value as Map).cast<String, dynamic>()))),
