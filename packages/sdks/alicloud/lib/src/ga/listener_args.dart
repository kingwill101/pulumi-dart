    ...
    return <String, dynamic>{
      ...
      'forwardedForConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(forwardedForConfig, (value) => value.toMap()),
    ...
    return ListenerArgs(
      ...
      certificates: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ListenerCertificate>(
            guardedValue,
            (value) => ListenerCertificate.fromMap(
      ...
      forwardedForConfig: (() {
        final guardedValue = map['forwardedForConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ListenerForwardedForConfig.fromMap(
      ...
      listenerType: (() {
        final guardedValue = map['listenerType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      name: (() {
