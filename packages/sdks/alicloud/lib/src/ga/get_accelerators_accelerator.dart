...
class GetAcceleratorsAccelerator {
  ...
  final pulumi.Input<List<GetAcceleratorsAcceleratorBasicBandwidthPackage>>
  ...
  final pulumi.Input<
    List<GetAcceleratorsAcceleratorCrossDomainBandwidthPackage>
  >
    ...
    return <String, dynamic>{
      ...
      'basicBandwidthPackages':
          pulumi.Input.mapInputValue<
            List<GetAcceleratorsAcceleratorBasicBandwidthPackage>,
  ...
  factory GetAcceleratorsAccelerator.fromMap(Map<String, dynamic> map) {
    return GetAcceleratorsAccelerator(
      ...
      basicBandwidthPackages: pulumi.Input.fromValue(
        pulumi
            .Input.decodeList<GetAcceleratorsAcceleratorBasicBandwidthPackage>(
          map['basicBandwidthPackages']!,
          (value) => GetAcceleratorsAcceleratorBasicBandwidthPackage.fromMap(
      ...
      crossDomainBandwidthPackages: pulumi.Input.fromValue(
        ...
        >(
          ...
          (value) =>
              GetAcceleratorsAcceleratorCrossDomainBandwidthPackage.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
