    ...
    return <String, dynamic>{
      ...
      'relations':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(relations, (value) => value.toMap()),
      'status': ?status,
    };
  }

  factory GetBasicAccelerateIpEndpointRelationsResult.fromMap(
    ...
    return GetBasicAccelerateIpEndpointRelationsResult(
      ...
      relations:
          pulumi
              .Input.decodeList<GetBasicAccelerateIpEndpointRelationsRelation>(
            map['relations']!,
            (value) => GetBasicAccelerateIpEndpointRelationsRelation.fromMap(
