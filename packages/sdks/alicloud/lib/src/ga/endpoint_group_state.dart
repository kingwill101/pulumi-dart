...
class EndpointGroupState {
  ...
  factory EndpointGroupState.fromMap(Map<String, dynamic> map) {
    return EndpointGroupState(
      ...
      endpointGroupIpLists: (() { final guardedValue = map['endpointGroupIpLists']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
