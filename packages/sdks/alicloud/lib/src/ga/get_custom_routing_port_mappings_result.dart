...
class GetCustomRoutingPortMappingsResult {
  ...
  final List<GetCustomRoutingPortMappingsCustomRoutingPortMapping>
  customRoutingPortMappings;
    ...
    return <String, dynamic>{
      ...
      'customRoutingPortMappings':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(customRoutingPortMappings, (value) => value.toMap()),
    ...
    return GetCustomRoutingPortMappingsResult(
      ...
      customRoutingPortMappings:
          pulumi.Input.decodeList<
            GetCustomRoutingPortMappingsCustomRoutingPortMapping
          >(
            map['customRoutingPortMappings']!,
            (value) =>
                GetCustomRoutingPortMappingsCustomRoutingPortMapping.fromMap(
