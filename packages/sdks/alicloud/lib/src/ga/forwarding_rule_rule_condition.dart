...
class ForwardingRuleRuleCondition {
  ...
  factory ForwardingRuleRuleCondition.fromMap(Map<String, dynamic> map) {
    return ForwardingRuleRuleCondition(
      hostConfigs: (() { final guardedValue = map['hostConfigs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ForwardingRuleRuleConditionHostConfig>(guardedValue, (value) => ForwardingRuleRuleConditionHostConfig.fromMap((value as Map).cast<String, dynamic>()))); })(),
      pathConfig: (() { final guardedValue = map['pathConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ForwardingRuleRuleConditionPathConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ruleConditionType: pulumi.Input.fromValue(map['ruleConditionType'] as String),
      ruleConditionValue: (() { final guardedValue = map['ruleConditionValue']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
