...
class ForwardingRuleRuleCondition {
    ...
    return <String, dynamic>{
      'hostConfigs':
          ?pulumi.Input.mapOptionalInputValue<
            List<ForwardingRuleRuleConditionHostConfig>,
  ...
  factory ForwardingRuleRuleCondition.fromMap(Map<String, dynamic> map) {
    return ForwardingRuleRuleCondition(
      hostConfigs: (() {
        final guardedValue = map['hostConfigs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ForwardingRuleRuleConditionHostConfig>(
            guardedValue,
            (value) => ForwardingRuleRuleConditionHostConfig.fromMap(
      ...
      pathConfig: (() {
        final guardedValue = map['pathConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ForwardingRuleRuleConditionPathConfig.fromMap(
      ...
      ruleConditionValue: (() {
        final guardedValue = map['ruleConditionValue'];
        if (guardedValue == null) return null;
