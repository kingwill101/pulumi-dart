...
class GetForwardingRulesForwardingRuleRuleActionForwardGroupConfig {
  ...
  factory GetForwardingRulesForwardingRuleRuleActionForwardGroupConfig.fromMap(Map<String, dynamic> map) {
    return GetForwardingRulesForwardingRuleRuleActionForwardGroupConfig(
      serverGroupTuples: (pulumi.Input.decodeList<GetForwardingRulesForwardingRuleRuleActionForwardGroupConfigServerGroupTuple>(map['serverGroupTuples'], (value) => GetForwardingRulesForwardingRuleRuleActionForwardGroupConfigServerGroupTuple.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
