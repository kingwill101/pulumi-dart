...
class GetForwardingRulesForwardingRuleRuleActionForwardGroupConfig {
  ...
  factory GetForwardingRulesForwardingRuleRuleActionForwardGroupConfig.fromMap(
    ...
    return GetForwardingRulesForwardingRuleRuleActionForwardGroupConfig(
      serverGroupTuples: pulumi.Input.fromValue(
        ...
        >(
          ...
          (value) =>
              GetForwardingRulesForwardingRuleRuleActionForwardGroupConfigServerGroupTuple.fromMap(
