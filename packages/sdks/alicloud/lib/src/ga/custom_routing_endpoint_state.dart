...
class CustomRoutingEndpointState {
  ...
  factory CustomRoutingEndpointState.fromMap(Map<String, dynamic> map) {
    return CustomRoutingEndpointState(
      ...
      customRoutingEndpointId: (() { final guardedValue = map['customRoutingEndpointId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
