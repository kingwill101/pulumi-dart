...
class GetForwardingRulesForwardingRuleRuleCondition {
  ...
  factory GetForwardingRulesForwardingRuleRuleCondition.fromMap(Map<String, dynamic> map) {
    return GetForwardingRulesForwardingRuleRuleCondition(
      hostConfigs: (pulumi.Input.decodeList<GetForwardingRulesForwardingRuleRuleConditionHostConfig>(map['hostConfigs'], (value) => GetForwardingRulesForwardingRuleRuleConditionHostConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
      pathConfigs: (pulumi.Input.decodeList<GetForwardingRulesForwardingRuleRuleConditionPathConfig>(map['pathConfigs'], (value) => GetForwardingRulesForwardingRuleRuleConditionPathConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
