...
class GetForwardingRulesForwardingRuleRuleCondition {
  ...
  final pulumi.Input<
    List<GetForwardingRulesForwardingRuleRuleConditionHostConfig>
  >
  hostConfigs;

  /// Path configuration information.
  final pulumi.Input<
    List<GetForwardingRulesForwardingRuleRuleConditionPathConfig>
  >
  pathConfigs;
  ...
  factory GetForwardingRulesForwardingRuleRuleCondition.fromMap(
    ...
    return GetForwardingRulesForwardingRuleRuleCondition(
      hostConfigs: pulumi.Input.fromValue(
        ...
        >(
          map['hostConfigs']!,
          (value) =>
              GetForwardingRulesForwardingRuleRuleConditionHostConfig.fromMap(
      ...
      pathConfigs: pulumi.Input.fromValue(
        ...
        >(
          map['pathConfigs']!,
          (value) =>
              GetForwardingRulesForwardingRuleRuleConditionPathConfig.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
