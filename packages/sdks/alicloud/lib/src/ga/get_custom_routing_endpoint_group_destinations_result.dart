...
class GetCustomRoutingEndpointGroupDestinationsResult {
  ...
  >
  customRoutingEndpointGroupDestinations;
    ...
    return <String, dynamic>{
      ...
      'customRoutingEndpointGroupDestinations':
          pulumi.Input.encodeList<
            GetCustomRoutingEndpointGroupDestinationsCustomRoutingEndpointGroupDestination,
            Map<String, dynamic>
          >(customRoutingEndpointGroupDestinations, (value) => value.toMap()),
  ...
  factory GetCustomRoutingEndpointGroupDestinationsResult.fromMap(
    ...
    return GetCustomRoutingEndpointGroupDestinationsResult(
      ...
      customRoutingEndpointGroupDestinations:
          pulumi.Input.decodeList<
            GetCustomRoutingEndpointGroupDestinationsCustomRoutingEndpointGroupDestination
          >(
            map['customRoutingEndpointGroupDestinations']!,
            (value) =>
                GetCustomRoutingEndpointGroupDestinationsCustomRoutingEndpointGroupDestination.fromMap(
