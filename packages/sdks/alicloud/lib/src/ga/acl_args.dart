...
class AclArgs {
  ...
  factory AclArgs.fromMap(Map<String, dynamic> map) {
    return AclArgs(
      aclEntries: (() { final guardedValue = map['aclEntries']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AclAclEntry>(guardedValue, (value) => AclAclEntry.fromMap((value as Map).cast<String, dynamic>()))); })(),
