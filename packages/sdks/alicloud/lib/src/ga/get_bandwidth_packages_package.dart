...
class GetBandwidthPackagesPackage {
  ...
  factory GetBandwidthPackagesPackage.fromMap(Map<String, dynamic> map) {
    return GetBandwidthPackagesPackage(
      ...
      cbnGeographicRegionIda: pulumi.Input.fromValue(
        map['cbnGeographicRegionIda'] as String,
      ),
      cbnGeographicRegionIdb: pulumi.Input.fromValue(
        map['cbnGeographicRegionIdb'] as String,
      ),
