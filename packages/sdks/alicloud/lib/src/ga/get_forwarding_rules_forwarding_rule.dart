...
class GetForwardingRulesForwardingRule {
  ...
  final pulumi.Input<List<GetForwardingRulesForwardingRuleRuleAction>>
  ruleActions;

  /// Forward action.
  final pulumi.Input<List<GetForwardingRulesForwardingRuleRuleCondition>>
  ruleConditions;
    ...
    return <String, dynamic>{
      ...
      'ruleActions':
          pulumi.Input.mapInputValue<
            List<GetForwardingRulesForwardingRuleRuleAction>,
      ...
      'ruleConditions':
          pulumi.Input.mapInputValue<
            List<GetForwardingRulesForwardingRuleRuleCondition>,
            List<Map<String, dynamic>>
          >(
            ruleConditions,
            (value) =>
  ...
  factory GetForwardingRulesForwardingRule.fromMap(Map<String, dynamic> map) {
    return GetForwardingRulesForwardingRule(
      forwardingRuleId: pulumi.Input.fromValue(
        map['forwardingRuleId'] as String,
      ),
      forwardingRuleName: pulumi.Input.fromValue(
        map['forwardingRuleName'] as String,
      ),
      forwardingRuleStatus: pulumi.Input.fromValue(
        map['forwardingRuleStatus'] as String,
      ),
      id: pulumi.Input.fromValue(map['id'] as String),
      listenerId: pulumi.Input.fromValue(map['listenerId'] as String),
      priority: pulumi.Input.fromValue(map['priority'] as int),
      ruleActions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetForwardingRulesForwardingRuleRuleAction>(
          map['ruleActions']!,
          (value) => GetForwardingRulesForwardingRuleRuleAction.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      ruleConditions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetForwardingRulesForwardingRuleRuleCondition>(
          map['ruleConditions']!,
          (value) => GetForwardingRulesForwardingRuleRuleCondition.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
