...
import 'transit_router_prefix_list_association_state.dart';
...
class TransitRouterPrefixListAssociation extends pulumi.CustomResource {
  ...
  static TransitRouterPrefixListAssociation get(
    String name,
    pulumi.Input<String> id, {
    TransitRouterPrefixListAssociationState? state,
  }) {
    return TransitRouterPrefixListAssociation._get(
      name,
      state: state?.toMap(),
  ...
  TransitRouterPrefixListAssociation._get(
    String name, {
