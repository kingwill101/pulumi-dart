...
class GetTransitRouterVpcAttachmentsAttachment {
  ...
  final pulumi.Input<List<GetTransitRouterVpcAttachmentsAttachmentZoneMapping>>
  zoneMappings;
    ...
    return <String, dynamic>{
      ...
      'zoneMappings':
          pulumi.Input.mapInputValue<
            List<GetTransitRouterVpcAttachmentsAttachmentZoneMapping>,
  ...
  factory GetTransitRouterVpcAttachmentsAttachment.fromMap(
    ...
    return GetTransitRouterVpcAttachmentsAttachment(
      ...
      zoneMappings: pulumi.Input.fromValue(
        ...
        >(
          map['zoneMappings']!,
          (value) =>
              GetTransitRouterVpcAttachmentsAttachmentZoneMapping.fromMap(
