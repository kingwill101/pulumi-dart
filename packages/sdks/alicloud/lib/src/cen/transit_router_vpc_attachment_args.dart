...
class TransitRouterVpcAttachmentArgs {
  ...
  TransitRouterVpcAttachmentArgs({
    ...
    required pulumi.Output<List<TransitRouterVpcAttachmentZoneMapping>> zoneMappings,
  }) :
  ...
  factory TransitRouterVpcAttachmentArgs.fromMap(Map<String, dynamic> map) {
    return TransitRouterVpcAttachmentArgs(
      ...
      zoneMappings: pulumi.Output.create<List<TransitRouterVpcAttachmentZoneMapping>>(pulumi.Input.decodeList<TransitRouterVpcAttachmentZoneMapping>(map['zoneMappings'], (value) => TransitRouterVpcAttachmentZoneMapping.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
