...
class TransitRouterVpcAttachmentArgs {
  ...
  factory TransitRouterVpcAttachmentArgs.fromMap(Map<String, dynamic> map) {
    return TransitRouterVpcAttachmentArgs(
      ...
      zoneMappings: (pulumi.Input.decodeList<TransitRouterVpcAttachmentZoneMapping>(map['zoneMappings'], (value) => TransitRouterVpcAttachmentZoneMapping.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
