...
class GetTransitRouterVpnAttachmentsAttachment {
  ...
  factory GetTransitRouterVpnAttachmentsAttachment.fromMap(Map<String, dynamic> map) {
    return GetTransitRouterVpnAttachmentsAttachment(
      ...
      zones: pulumi.Input.fromValue(pulumi.Input.decodeList<GetTransitRouterVpnAttachmentsAttachmentZone>(map['zones']!, (value) => GetTransitRouterVpnAttachmentsAttachmentZone.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
