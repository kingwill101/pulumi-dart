...
class GetTransitRouterCidrsCidr {
  ...
  factory GetTransitRouterCidrsCidr.fromMap(Map<String, dynamic> map) {
    return GetTransitRouterCidrsCidr(
      ...
      transitRouterCidrId: pulumi.Input.fromValue(
        map['transitRouterCidrId'] as String,
      ),
      transitRouterCidrName: pulumi.Input.fromValue(
        map['transitRouterCidrName'] as String,
      ),
