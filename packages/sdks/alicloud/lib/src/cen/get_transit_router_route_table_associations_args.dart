...
class GetTransitRouterRouteTableAssociationsArgs {
  ...
  factory GetTransitRouterRouteTableAssociationsArgs.fromMap(Map<String, dynamic> map) {
    return GetTransitRouterRouteTableAssociationsArgs(
      ...
      transitRouterAttachmentResourceId: (() { final guardedValue = map['transitRouterAttachmentResourceId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      transitRouterAttachmentResourceType: (() { final guardedValue = map['transitRouterAttachmentResourceType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
