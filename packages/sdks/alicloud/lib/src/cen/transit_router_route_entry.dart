...
import 'transit_router_route_entry_state.dart';
...
class TransitRouterRouteEntry extends pulumi.CustomResource {
  ...
  static TransitRouterRouteEntry get(
    String name,
    pulumi.Input<String> id, {
    TransitRouterRouteEntryState? state,
  }) {
    return TransitRouterRouteEntry._get(
      name,
      state: state?.toMap(),
