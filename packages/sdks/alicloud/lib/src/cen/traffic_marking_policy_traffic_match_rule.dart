...
class TrafficMarkingPolicyTrafficMatchRule {
  ...
  factory TrafficMarkingPolicyTrafficMatchRule.fromMap(Map<String, dynamic> map) {
    return TrafficMarkingPolicyTrafficMatchRule(
      ...
      dstPortRanges: (() { final guardedValue = map['dstPortRanges']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<int>()); })(),
      ...
      srcPortRanges: (() { final guardedValue = map['srcPortRanges']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<int>()); })(),
      trafficMatchRuleDescription: (() { final guardedValue = map['trafficMatchRuleDescription']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      trafficMatchRuleName: (() { final guardedValue = map['trafficMatchRuleName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
