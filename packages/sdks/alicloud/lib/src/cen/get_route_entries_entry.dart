...
class GetRouteEntriesEntry {
    ...
    return <String, dynamic>{
      ...
      'conflicts':
          pulumi.Input.mapInputValue<
            List<GetRouteEntriesEntryConflict>,
  ...
  factory GetRouteEntriesEntry.fromMap(Map<String, dynamic> map) {
    return GetRouteEntriesEntry(
      ...
      conflicts: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetRouteEntriesEntryConflict>(
          map['conflicts']!,
          (value) => GetRouteEntriesEntryConflict.fromMap(
