...
import 'transit_router_vpc_attachment_state.dart';
...
class TransitRouterVpcAttachment extends pulumi.CustomResource {
  ...
  /// Gets an existing [TransitRouterVpcAttachment] resource's state with the given [name] and [id].
  static TransitRouterVpcAttachment get(
    String name,
    pulumi.Input<String> id, {
    TransitRouterVpcAttachmentState? state,
  }) {
    return TransitRouterVpcAttachment._get(
      name,
      state: state?.toMap(),
  ...
  TransitRouterVpcAttachment._get(
    String name, {
