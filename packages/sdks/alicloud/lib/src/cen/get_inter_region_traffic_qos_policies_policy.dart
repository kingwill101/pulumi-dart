...
class GetInterRegionTrafficQosPoliciesPolicy {
  ...
  factory GetInterRegionTrafficQosPoliciesPolicy.fromMap(Map<String, dynamic> map) {
    return GetInterRegionTrafficQosPoliciesPolicy(
      ...
      interRegionTrafficQosPolicyDescription: pulumi.Input.fromValue(map['interRegionTrafficQosPolicyDescription'] as String),
      interRegionTrafficQosPolicyId: pulumi.Input.fromValue(map['interRegionTrafficQosPolicyId'] as String),
      interRegionTrafficQosPolicyName: pulumi.Input.fromValue(map['interRegionTrafficQosPolicyName'] as String),
