    ...
    return <String, dynamic>{
      ...
      'zoneMappings':
          ?pulumi.Input.mapOptionalInputValue<
            List<TransitRouterVpcAttachmentZoneMapping>,
  ...
  factory TransitRouterVpcAttachmentState.fromMap(Map<String, dynamic> map) {
    return TransitRouterVpcAttachmentState(
      ...
      transitRouterVpcAttachmentName: (() {
        final guardedValue = map['transitRouterVpcAttachmentName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      transitRouterVpcAttachmentOptions: (() {
        final guardedValue = map['transitRouterVpcAttachmentOptions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as Map).cast<String, String>(),
        );
      ...
      zoneMappings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<TransitRouterVpcAttachmentZoneMapping>(
            guardedValue,
            (value) => TransitRouterVpcAttachmentZoneMapping.fromMap(
