...
class TransitRouterVpcAttachmentState {
  ...
  factory TransitRouterVpcAttachmentState.fromMap(Map<String, dynamic> map) {
    return TransitRouterVpcAttachmentState(
      ...
      transitRouterVpcAttachmentName: map['transitRouterVpcAttachmentName'] == null ? null : (map['transitRouterVpcAttachmentName'] as String).input(),
      transitRouterVpcAttachmentOptions: map['transitRouterVpcAttachmentOptions'] == null ? null : ((map['transitRouterVpcAttachmentOptions'] as Map).cast<String, String>()).input(),
      vpcId: map['vpcId'] == null ? null : (map['vpcId'] as String).input(),
      vpcOwnerId: map['vpcOwnerId'] == null ? null : (map['vpcOwnerId'] as String).input(),
      zoneMappings: map['zoneMappings'] == null ? null : (pulumi.Input.decodeList<TransitRouterVpcAttachmentZoneMapping>(map['zoneMappings'], (value) => TransitRouterVpcAttachmentZoneMapping.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
