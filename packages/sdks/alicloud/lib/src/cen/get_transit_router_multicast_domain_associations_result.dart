...
class GetTransitRouterMulticastDomainAssociationsResult {
  ...
  final List<GetTransitRouterMulticastDomainAssociationsAssociation>
  associations;
  ...
  factory GetTransitRouterMulticastDomainAssociationsResult.fromMap(
    ...
    return GetTransitRouterMulticastDomainAssociationsResult(
      associations:
          ...
          >(
            map['associations']!,
            (value) =>
                GetTransitRouterMulticastDomainAssociationsAssociation.fromMap(
