...
class GetRouteMapsResult {
  ...
  factory GetRouteMapsResult.fromMap(Map<String, dynamic> map) {
    return GetRouteMapsResult(
      ...
      cenRegionId: (() { final guardedValue = map['cenRegionId']; if (guardedValue == null) return null; return guardedValue as String; })(),
      ...
      transmitDirection: (() { final guardedValue = map['transmitDirection']; if (guardedValue == null) return null; return guardedValue as String; })(),
    );
  }
}
