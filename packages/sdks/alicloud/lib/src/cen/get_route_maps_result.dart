...
class GetRouteMapsResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'id': id,
      'ids': ids,
      'maps': pulumi.Input.encodeList<GetRouteMapsMap, Map<String, dynamic>>(
        maps,
        (value) => value.toMap(),
      ),
  ...
  factory GetRouteMapsResult.fromMap(Map<String, dynamic> map) {
    return GetRouteMapsResult(
      ...
      maps: pulumi.Input.decodeList<GetRouteMapsMap>(
        map['maps']!,
        (value) =>
            GetRouteMapsMap.fromMap((value as Map).cast<String, dynamic>()),
      ),
      outputFile: (() {
