...
class GetTransitRouterRouteTablesTable {
  ...
  factory GetTransitRouterRouteTablesTable.fromMap(Map<String, dynamic> map) {
    return GetTransitRouterRouteTablesTable(
      ...
      transitRouterRouteTableDescription: pulumi.Input.fromValue(map['transitRouterRouteTableDescription'] as String),
      transitRouterRouteTableId: pulumi.Input.fromValue(map['transitRouterRouteTableId'] as String),
      transitRouterRouteTableName: pulumi.Input.fromValue(map['transitRouterRouteTableName'] as String),
      transitRouterRouteTableType: pulumi.Input.fromValue(map['transitRouterRouteTableType'] as String),
    );
  }
}
