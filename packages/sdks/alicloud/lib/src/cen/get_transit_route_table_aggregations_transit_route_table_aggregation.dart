...
class GetTransitRouteTableAggregationsTransitRouteTableAggregation {
  ...
  factory GetTransitRouteTableAggregationsTransitRouteTableAggregation.fromMap(
    ...
    return GetTransitRouteTableAggregationsTransitRouteTableAggregation(
      ...
      transitRouteTableAggregationCidr: pulumi.Input.fromValue(
        map['transitRouteTableAggregationCidr'] as String,
      ),
      transitRouteTableAggregationDescription: pulumi.Input.fromValue(
        map['transitRouteTableAggregationDescription'] as String,
      ),
      transitRouteTableAggregationName: pulumi.Input.fromValue(
        map['transitRouteTableAggregationName'] as String,
      ),
      transitRouteTableAggregationScope: pulumi.Input.fromValue(
        map['transitRouteTableAggregationScope'] as String,
      ),
