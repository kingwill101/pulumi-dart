...
import 'inter_region_traffic_qos_policy_state.dart';
...
class InterRegionTrafficQosPolicy extends pulumi.CustomResource {
  ...
  InterRegionTrafficQosPolicy(
    ...
    interRegionTrafficQosPolicyDescription = registerOutput<String?>('interRegionTrafficQosPolicyDescription');
    interRegionTrafficQosPolicyName = registerOutput<String?>('interRegionTrafficQosPolicyName');
  ...
  static InterRegionTrafficQosPolicy get(
    String name,
    pulumi.Input<String> id, {
    InterRegionTrafficQosPolicyState? state,
  }) {
    return InterRegionTrafficQosPolicy._get(
      name,
      state: state?.toMap(),
  ...
  InterRegionTrafficQosPolicy._get(
    String name, {
