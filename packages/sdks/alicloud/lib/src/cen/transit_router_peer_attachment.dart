...
import 'transit_router_peer_attachment_state.dart';
...
class TransitRouterPeerAttachment extends pulumi.CustomResource {
  ...
  TransitRouterPeerAttachment(
    ...
    peerTransitRouterRegionId = registerOutput<String?>('peerTransitRouterRegionId');
    ...
    transitRouterPeerAttachmentName = registerOutput<String>('transitRouterPeerAttachmentName');
  }

  /// Gets an existing [TransitRouterPeerAttachment] resource's state with the given [name] and [id].
  static TransitRouterPeerAttachment get(
    String name,
    pulumi.Input<String> id, {
    TransitRouterPeerAttachmentState? state,
  }) {
    return TransitRouterPeerAttachment._get(
      name,
      state: state?.toMap(),
  ...
  TransitRouterPeerAttachment._get(
    String name, {
