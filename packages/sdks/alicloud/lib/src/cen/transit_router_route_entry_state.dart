...
class TransitRouterRouteEntryState {
  ...
  factory TransitRouterRouteEntryState.fromMap(Map<String, dynamic> map) {
    return TransitRouterRouteEntryState(
      ...
      transitRouterRouteEntryDestinationCidrBlock: (() { final guardedValue = map['transitRouterRouteEntryDestinationCidrBlock']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      transitRouterRouteEntryId: (() { final guardedValue = map['transitRouterRouteEntryId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      transitRouterRouteEntryNextHopType: (() { final guardedValue = map['transitRouterRouteEntryNextHopType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
