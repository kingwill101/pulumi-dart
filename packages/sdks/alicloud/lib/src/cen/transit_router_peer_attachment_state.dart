...
class TransitRouterPeerAttachmentState {
  ...
  factory TransitRouterPeerAttachmentState.fromMap(Map<String, dynamic> map) {
    return TransitRouterPeerAttachmentState(
      ...
      bandwidthType: (() {
        final guardedValue = map['bandwidthType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      cenBandwidthPackageId: (() {
        final guardedValue = map['cenBandwidthPackageId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      cenId: (() {
      ...
      defaultLinkType: (() {
        final guardedValue = map['defaultLinkType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      dryRun: (() {
      ...
      peerTransitRouterId: (() {
        final guardedValue = map['peerTransitRouterId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      peerTransitRouterRegionId: (() {
        final guardedValue = map['peerTransitRouterRegionId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      regionId: (() {
      ...
      transitRouterPeerAttachmentName: (() {
        final guardedValue = map['transitRouterPeerAttachmentName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
