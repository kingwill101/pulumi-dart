...
class GetTransitRoutersResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'transitRouters': pulumi.Input.encodeList<GetTransitRoutersTransitRouter, Map<String, dynamic>>(transitRouters, (value) => value.toMap()),
    };
  }
  ...
  factory GetTransitRoutersResult.fromMap(Map<String, dynamic> map) {
    return GetTransitRoutersResult(
      ...
      transitRouterIds: (() { final guardedValue = map['transitRouterIds']; if (guardedValue == null) return null; return (guardedValue as List).cast<String>(); })(),
