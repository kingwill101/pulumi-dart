...
class ChildInstanceRouteEntryToAttachmentState {
  ...
  const ChildInstanceRouteEntryToAttachmentState({
    this.cenId,
  ...
  factory ChildInstanceRouteEntryToAttachmentState.fromMap(Map<String, dynamic> map) {
    return ChildInstanceRouteEntryToAttachmentState(
      ...
      childInstanceRouteTableId: (() { final guardedValue = map['childInstanceRouteTableId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
