...
class RouteMapState {
  ...
  RouteMapState({
    ...
    pulumi.Output<String>? mapResult,
    ...
    pulumi.Output<String>? routeMapId,
    ...
    pulumi.Output<String>? transmitDirection,
      ...
      mapResult = pulumi.Input.asOptionalInput<String>(mapResult),
      ...
      routeMapId = pulumi.Input.asOptionalInput<String>(routeMapId),
  ...
  factory RouteMapState.fromMap(Map<String, dynamic> map) {
    return RouteMapState(
      ...
      mapResult: map['mapResult'] == null ? null : pulumi.Output.create<String>(map['mapResult'] as String),
      ...
      routeMapId: map['routeMapId'] == null ? null : pulumi.Output.create<String>(map['routeMapId'] as String),
