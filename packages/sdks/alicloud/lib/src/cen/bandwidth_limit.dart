...
import 'bandwidth_limit_state.dart';
...
class BandwidthLimit extends pulumi.CustomResource {
  ...
  /// Gets an existing [BandwidthLimit] resource's state with the given [name] and [id].
  static BandwidthLimit get(
    String name,
    pulumi.Input<String> id, {
    BandwidthLimitState? state,
  }) {
    return BandwidthLimit._get(
      name,
      state: state?.toMap(),
