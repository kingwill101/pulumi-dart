...
import 'transit_router_vbr_attachment_state.dart';
...
class TransitRouterVbrAttachment extends pulumi.CustomResource {
  ...
  /// Gets an existing [TransitRouterVbrAttachment] resource's state with the given [name] and [id].
  static TransitRouterVbrAttachment get(
    String name,
    pulumi.Input<String> id, {
    TransitRouterVbrAttachmentState? state,
  }) {
    return TransitRouterVbrAttachment._get(
      name,
      state: state?.toMap(),
  ...
  TransitRouterVbrAttachment._get(
    String name, {
