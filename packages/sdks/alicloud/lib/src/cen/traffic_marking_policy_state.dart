...
class TrafficMarkingPolicyState {
  ...
  const TrafficMarkingPolicyState({
    this.description,
    this.dryRun,
    this.force,
    this.markingDscp,
  ...
  factory TrafficMarkingPolicyState.fromMap(Map<String, dynamic> map) {
    return TrafficMarkingPolicyState(
      ...
      markingDscp: (() { final guardedValue = map['markingDscp']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      priority: (() { final guardedValue = map['priority']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      trafficMarkingPolicyId: (() { final guardedValue = map['trafficMarkingPolicyId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
