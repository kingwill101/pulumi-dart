...
import 'transit_router_route_table_state.dart';
...
class TransitRouterRouteTable extends pulumi.CustomResource {
  ...
  static TransitRouterRouteTable get(
    String name,
    pulumi.Input<String> id, {
    TransitRouterRouteTableState? state,
  }) {
    return TransitRouterRouteTable._get(
      name,
      state: state?.toMap(),
