...
class AttackPathSensitiveAssetConfigState {
  ...
  AttackPathSensitiveAssetConfigState({this.attackPathAssetLists});
  ...
  factory AttackPathSensitiveAssetConfigState.fromMap(
    Map<String, dynamic> map,
  ) {
    return AttackPathSensitiveAssetConfigState(
      attackPathAssetLists: (() {
        final guardedValue = map['attackPathAssetLists'];
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                AttackPathSensitiveAssetConfigAttackPathAssetList.fromMap(
