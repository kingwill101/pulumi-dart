...
class SasTrailState {
  ...
  factory SasTrailState.fromMap(Map<String, dynamic> map) {
    return SasTrailState(
      ...
      serviceTrail: (() { final guardedValue = map['serviceTrail']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SasTrailServiceTrail.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
