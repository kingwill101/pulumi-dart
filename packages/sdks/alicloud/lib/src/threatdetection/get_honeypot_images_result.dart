...
class GetHoneypotImagesResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ids': ids,
      'images':
          pulumi.Input.encodeList<GetHoneypotImagesImage, Map<String, dynamic>>(
            images,
            (value) => value.toMap(),
          ),
      'nameRegex': ?nameRegex,
  ...
  factory GetHoneypotImagesResult.fromMap(Map<String, dynamic> map) {
    return GetHoneypotImagesResult(
      ...
      images: pulumi.Input.decodeList<GetHoneypotImagesImage>(
        map['images']!,
        (value) => GetHoneypotImagesImage.fromMap(
