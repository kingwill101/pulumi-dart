...
class GetCheckItemConfigsConfig {
  ...
  factory GetCheckItemConfigsConfig.fromMap(Map<String, dynamic> map) {
    return GetCheckItemConfigsConfig(
      checkId: (map['checkId'] as int).input(),
      checkShowName: (map['checkShowName'] as String).input(),
      checkType: (map['checkType'] as String).input(),
      customConfigs: (pulumi.Input.decodeList<GetCheckItemConfigsConfigCustomConfig>(map['customConfigs'], (value) => GetCheckItemConfigsConfigCustomConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
      description: (GetCheckItemConfigsConfigDescription.fromMap((map['description'] as Map).cast<String, dynamic>())).input(),
      estimatedCount: (map['estimatedCount'] as int).input(),
      instanceSubType: (map['instanceSubType'] as String).input(),
      instanceType: (map['instanceType'] as String).input(),
      riskLevel: (map['riskLevel'] as String).input(),
      sectionIds: ((map['sectionIds'] as List).cast<int>()).input(),
