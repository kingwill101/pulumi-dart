...
class GetCheckItemConfigsConfig {
    ...
    return <String, dynamic>{
      ...
      'customConfigs':
          pulumi.Input.mapInputValue<
            List<GetCheckItemConfigsConfigCustomConfig>,
  ...
  factory GetCheckItemConfigsConfig.fromMap(Map<String, dynamic> map) {
    return GetCheckItemConfigsConfig(
      ...
      customConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetCheckItemConfigsConfigCustomConfig>(
          map['customConfigs']!,
          (value) => GetCheckItemConfigsConfigCustomConfig.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      description: pulumi.Input.fromValue(
        GetCheckItemConfigsConfigDescription.fromMap(
      ...
      sectionIds: pulumi.Input.fromValue(
        (map['sectionIds'] as List).cast<int>(),
      ),
