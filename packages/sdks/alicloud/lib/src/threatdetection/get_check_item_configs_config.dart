...
class GetCheckItemConfigsConfig {
  ...
  final List<GetCheckItemConfigsConfigCustomConfig> customConfigs;
  /// The description of the check item.
  final GetCheckItemConfigsConfigDescription description;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'checkType': checkType,
      'customConfigs': pulumi.Input.encodeList<GetCheckItemConfigsConfigCustomConfig, Map<String, dynamic>>(customConfigs, (value) => value.toMap()),
  ...
  factory GetCheckItemConfigsConfig.fromMap(Map<String, dynamic> map) {
    return GetCheckItemConfigsConfig(
      ...
      checkShowName: map['checkShowName'] as String,
      checkType: map['checkType'] as String,
      customConfigs: pulumi.Input.decodeList<GetCheckItemConfigsConfigCustomConfig>(map['customConfigs'], (value) => GetCheckItemConfigsConfigCustomConfig.fromMap((value as Map).cast<String, dynamic>())),
      description: GetCheckItemConfigsConfigDescription.fromMap((map['description'] as Map).cast<String, dynamic>()),
      estimatedCount: map['estimatedCount'] as int,
      instanceSubType: map['instanceSubType'] as String,
      instanceType: map['instanceType'] as String,
      riskLevel: map['riskLevel'] as String,
      sectionIds: (map['sectionIds'] as List).cast<int>(),
