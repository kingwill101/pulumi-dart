...
class GetHoneyPotsResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'pots': pulumi.Input.encodeList<GetHoneyPotsPot, Map<String, dynamic>>(
        pots,
        (value) => value.toMap(),
      ),
    };
  ...
  factory GetHoneyPotsResult.fromMap(Map<String, dynamic> map) {
    return GetHoneyPotsResult(
      ...
      pots: pulumi.Input.decodeList<GetHoneyPotsPot>(
        map['pots']!,
        (value) =>
            GetHoneyPotsPot.fromMap((value as Map).cast<String, dynamic>()),
      ),
    );
  }
}
