...
class Instance extends pulumi.CustomResource {
  ...
  Instance(
    ...
    buyNumber = registerOutput<String?>('buyNumber');
    containerImageScan = registerOutput<String?>('containerImageScan');
    containerImageScanNew = registerOutput<String?>('containerImageScanNew');
    createTime = registerOutput<String>('createTime');
    honeypot = registerOutput<String?>('honeypot');
    honeypotSwitch = registerOutput<String>('honeypotSwitch');
    modifyType = registerOutput<String?>('modifyType');
    paymentType = registerOutput<String>('paymentType');
    period = registerOutput<int?>('period');
    postPaidFlag = registerOutput<int?>('postPaidFlag');
    postPaidHostAutoBind = registerOutput<int>('postPaidHostAutoBind');
    postPaidHostAutoBindVersion = registerOutput<int>('postPaidHostAutoBindVersion');
    postPayModuleSwitch = registerOutput<String?>('postPayModuleSwitch');
    postPayModuleSwitchObj = registerOutput<InstancePostPayModuleSwitchObj>('postPayModuleSwitchObj', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return InstancePostPayModuleSwitchObj.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    sasAntiRansomware = registerOutput<String?>('sasAntiRansomware');
    sasCspm = registerOutput<String?>('sasCspm');
    sasCspmSwitch = registerOutput<String>('sasCspmSwitch');
    sasSc = registerOutput<bool?>('sasSc');
    sasSdk = registerOutput<String?>('sasSdk');
    sasSdkSwitch = registerOutput<String>('sasSdkSwitch');
    sasSlsStorage = registerOutput<String?>('sasSlsStorage');
    sasWebguardBoolean = registerOutput<String>('sasWebguardBoolean');
    sasWebguardOrderNum = registerOutput<String?>('sasWebguardOrderNum');
    status = registerOutput<String>('status');
    subscriptionType = registerOutput<String?>('subscriptionType');
    threatAnalysis = registerOutput<String?>('threatAnalysis');
    threatAnalysisFlow = registerOutput<String?>('threatAnalysisFlow');
    threatAnalysisSlsStorage = registerOutput<String?>('threatAnalysisSlsStorage');
    threatAnalysisSwitch = registerOutput<String>('threatAnalysisSwitch');
    threatAnalysisSwitch1 = registerOutput<String>('threatAnalysisSwitch1');
    vCore = registerOutput<String?>('vCore');
    versionCode = registerOutput<String?>('versionCode');
    vulCount = registerOutput<String?>('vulCount');
    vulSwitch = registerOutput<String>('vulSwitch');
  }
