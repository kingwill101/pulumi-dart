...
import 'client_user_define_rule_state.dart';
...
class ClientUserDefineRule extends pulumi.CustomResource {
  ...
  static ClientUserDefineRule get(
    String name,
    pulumi.Input<String> id, {
    ClientUserDefineRuleState? state,
  }) {
    return ClientUserDefineRule._get(
      name,
      state: state?.toMap(),
