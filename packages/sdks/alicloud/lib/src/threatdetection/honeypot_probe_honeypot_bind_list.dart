...
class HoneypotProbeHoneypotBindList {
  ...
  factory HoneypotProbeHoneypotBindList.fromMap(Map<String, dynamic> map) {
    return HoneypotProbeHoneypotBindList(
      bindPortLists: (() { final guardedValue = map['bindPortLists']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<HoneypotProbeHoneypotBindListBindPortList>(guardedValue, (value) => HoneypotProbeHoneypotBindListBindPortList.fromMap((value as Map).cast<String, dynamic>()))); })(),
