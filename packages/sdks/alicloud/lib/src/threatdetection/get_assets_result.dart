...
class GetAssetsResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'assets': pulumi.Input.encodeList<GetAssetsAsset, Map<String, dynamic>>(
        assets,
        (value) => value.toMap(),
      ),
      'criteria': ?criteria,
  ...
  factory GetAssetsResult.fromMap(Map<String, dynamic> map) {
    return GetAssetsResult(
      assets: pulumi.Input.decodeList<GetAssetsAsset>(
        map['assets']!,
        (value) =>
            GetAssetsAsset.fromMap((value as Map).cast<String, dynamic>()),
      ),
      criteria: (() {
      ...
      logicalExp: (() {
        final guardedValue = map['logicalExp'];
        if (guardedValue == null) return null;
        return guardedValue as String;
      })(),
      machineTypes: (() {
      ...
      noGroupTrace: (() {
        final guardedValue = map['noGroupTrace'];
        if (guardedValue == null) return null;
