...
class OssScanConfigArgs {
  ...
  factory OssScanConfigArgs.fromMap(Map<String, dynamic> map) {
    return OssScanConfigArgs(
      ...
      bucketNameLists: pulumi.Input.fromValue((map['bucketNameLists'] as List).cast<String>()),
      ...
      keySuffixLists: pulumi.Input.fromValue((map['keySuffixLists'] as List).cast<String>()),
      ...
      scanDayLists: pulumi.Input.fromValue((map['scanDayLists'] as List).cast<int>()),
