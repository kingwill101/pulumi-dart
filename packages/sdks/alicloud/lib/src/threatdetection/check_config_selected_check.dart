...
class CheckConfigSelectedCheck {
  ...
  factory CheckConfigSelectedCheck.fromMap(Map<String, dynamic> map) {
    return CheckConfigSelectedCheck(
      checkId: (() { final guardedValue = map['checkId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      sectionId: (() { final guardedValue = map['sectionId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
    );
  }
}
