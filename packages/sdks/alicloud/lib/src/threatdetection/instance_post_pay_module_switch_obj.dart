...
class InstancePostPayModuleSwitchObj {
  ...
  factory InstancePostPayModuleSwitchObj.fromMap(Map<String, dynamic> map) {
    return InstancePostPayModuleSwitchObj(
      agentless: (() { final guardedValue = map['agentless']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      antiRansomware: (() { final guardedValue = map['antiRansomware']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      basicService: (() { final guardedValue = map['basicService']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      cspm: (() { final guardedValue = map['cspm']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ctdr: (() { final guardedValue = map['ctdr']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ctdrStorage: (() { final guardedValue = map['ctdrStorage']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      postHost: (() { final guardedValue = map['postHost']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      rasp: (() { final guardedValue = map['rasp']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      sdk: (() { final guardedValue = map['sdk']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      serverless: (() { final guardedValue = map['serverless']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      vul: (() { final guardedValue = map['vul']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      webLock: (() { final guardedValue = map['webLock']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
    );
  }
}
