...
class GetHoneypotProbesProbeHoneypotBindList {
  ...
  final pulumi.Input<List<GetHoneypotProbesProbeHoneypotBindListBindPortList>>
  bindPortLists;
    ...
    return <String, dynamic>{
      'bindPortLists':
          pulumi.Input.mapInputValue<
            List<GetHoneypotProbesProbeHoneypotBindListBindPortList>,
  ...
  factory GetHoneypotProbesProbeHoneypotBindList.fromMap(
    Map<String, dynamic> map,
  ) {
    return GetHoneypotProbesProbeHoneypotBindList(
      bindPortLists: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetHoneypotProbesProbeHoneypotBindListBindPortList
        >(
          map['bindPortLists']!,
          (value) => GetHoneypotProbesProbeHoneypotBindListBindPortList.fromMap(
