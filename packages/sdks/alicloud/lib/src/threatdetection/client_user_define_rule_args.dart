...
class ClientUserDefineRuleArgs {
  ...
  ClientUserDefineRuleArgs({
    required pulumi.Output<int> actionType,
    required pulumi.Output<String> clientUserDefineRuleName,
  ...
  factory ClientUserDefineRuleArgs.fromMap(Map<String, dynamic> map) {
    return ClientUserDefineRuleArgs(
      actionType: pulumi.Output.create<int>(map['actionType'] as int),
      clientUserDefineRuleName: pulumi.Output.create<String>(map['clientUserDefineRuleName'] as String),
