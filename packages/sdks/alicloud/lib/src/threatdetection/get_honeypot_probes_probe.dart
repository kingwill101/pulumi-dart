...
class GetHoneypotProbesProbe {
  ...
  factory GetHoneypotProbesProbe.fromMap(Map<String, dynamic> map) {
    return GetHoneypotProbesProbe(
      ...
      honeypotBindLists: pulumi.Input.fromValue(pulumi.Input.decodeList<GetHoneypotProbesProbeHoneypotBindList>(map['honeypotBindLists']!, (value) => GetHoneypotProbesProbeHoneypotBindList.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      serviceIpLists: pulumi.Input.fromValue((map['serviceIpLists'] as List).cast<String>()),
