...
class WebLockConfigArgs {
  ...
  factory WebLockConfigArgs.fromMap(Map<String, dynamic> map) {
    return WebLockConfigArgs(
      ...
      exclusiveDir: (() {
        final guardedValue = map['exclusiveDir'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      exclusiveFile: (() {
        final guardedValue = map['exclusiveFile'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      exclusiveFileType: (() {
        final guardedValue = map['exclusiveFileType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      inclusiveFileType: (() {
        final guardedValue = map['inclusiveFileType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
