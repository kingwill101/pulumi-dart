...
class WebLockConfigState {
  ...
  factory WebLockConfigState.fromMap(Map<String, dynamic> map) {
    return WebLockConfigState(
      defenceMode: (() { final guardedValue = map['defenceMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      localBackupDir: (() { final guardedValue = map['localBackupDir']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
