...
class GetCheckStructuresStructure {
    ...
    return <String, dynamic>{
      ...
      'standards':
          pulumi.Input.mapInputValue<
            List<GetCheckStructuresStructureStandard>,
  ...
  factory GetCheckStructuresStructure.fromMap(Map<String, dynamic> map) {
    return GetCheckStructuresStructure(
      ...
      standards: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetCheckStructuresStructureStandard>(
          map['standards']!,
          (value) => GetCheckStructuresStructureStandard.fromMap(
