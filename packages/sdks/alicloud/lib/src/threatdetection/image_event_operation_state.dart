...
class ImageEventOperationState {
  ...
  factory ImageEventOperationState.fromMap(Map<String, dynamic> map) {
    return ImageEventOperationState(
      ...
      eventKey: (() { final guardedValue = map['eventKey']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      operationCode: (() { final guardedValue = map['operationCode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      scenarios: (() { final guardedValue = map['scenarios']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
