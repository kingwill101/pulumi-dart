...
class InstanceState {
  ...
  /// [udc] OSS Size.
  InstanceState({
    pulumi.Output<bool>? authed,
    pulumi.Output<String>? dataphin,
    pulumi.Output<String>? dataphinCount,
    pulumi.Output<String>? instanceNum,
    pulumi.Output<String>? logistics,
    pulumi.Output<String>? modifyType,
    pulumi.Output<bool>? odpsSet,
    pulumi.Output<bool>? ossBucketSet,
    pulumi.Output<String>? ossSize,
    pulumi.Output<String>? paymentType,
    pulumi.Output<int>? period,
    pulumi.Output<bool>? rdsSet,
    pulumi.Output<String>? remainDays,
    pulumi.Output<int>? renewPeriod,
    pulumi.Output<String>? renewalStatus,
    pulumi.Output<String>? sdCbool,
    pulumi.Output<String>? sdc,
    pulumi.Output<String>? sddpVersion,
    pulumi.Output<String>? status,
    pulumi.Output<String>? udCbool,
    pulumi.Output<String>? udc,
  }) :
      authed = pulumi.Input.asOptionalInput<bool>(authed),
      dataphin = pulumi.Input.asOptionalInput<String>(dataphin),
      dataphinCount = pulumi.Input.asOptionalInput<String>(dataphinCount),
      instanceNum = pulumi.Input.asOptionalInput<String>(instanceNum),
      logistics = pulumi.Input.asOptionalInput<String>(logistics),
      modifyType = pulumi.Input.asOptionalInput<String>(modifyType),
      odpsSet = pulumi.Input.asOptionalInput<bool>(odpsSet),
      ossBucketSet = pulumi.Input.asOptionalInput<bool>(ossBucketSet),
      ossSize = pulumi.Input.asOptionalInput<String>(ossSize),
      paymentType = pulumi.Input.asOptionalInput<String>(paymentType),
      period = pulumi.Input.asOptionalInput<int>(period),
      rdsSet = pulumi.Input.asOptionalInput<bool>(rdsSet),
      remainDays = pulumi.Input.asOptionalInput<String>(remainDays),
      renewPeriod = pulumi.Input.asOptionalInput<int>(renewPeriod),
      renewalStatus = pulumi.Input.asOptionalInput<String>(renewalStatus),
      sdCbool = pulumi.Input.asOptionalInput<String>(sdCbool),
      sdc = pulumi.Input.asOptionalInput<String>(sdc),
      sddpVersion = pulumi.Input.asOptionalInput<String>(sddpVersion),
      status = pulumi.Input.asOptionalInput<String>(status),
      udCbool = pulumi.Input.asOptionalInput<String>(udCbool),
      udc = pulumi.Input.asOptionalInput<String>(udc);
  ...
  factory InstanceState.fromMap(Map<String, dynamic> map) {
    return InstanceState(
      authed: map['authed'] == null ? null : pulumi.Output.create<bool>(map['authed'] as bool),
      ...
      instanceNum: map['instanceNum'] == null ? null : pulumi.Output.create<String>(map['instanceNum'] as String),
      ...
      odpsSet: map['odpsSet'] == null ? null : pulumi.Output.create<bool>(map['odpsSet'] as bool),
      ossBucketSet: map['ossBucketSet'] == null ? null : pulumi.Output.create<bool>(map['ossBucketSet'] as bool),
      ossSize: map['ossSize'] == null ? null : pulumi.Output.create<String>(map['ossSize'] as String),
      paymentType: map['paymentType'] == null ? null : pulumi.Output.create<String>(map['paymentType'] as String),
      period: map['period'] == null ? null : pulumi.Output.create<int>(map['period'] as int),
      rdsSet: map['rdsSet'] == null ? null : pulumi.Output.create<bool>(map['rdsSet'] as bool),
      remainDays: map['remainDays'] == null ? null : pulumi.Output.create<String>(map['remainDays'] as String),
      ...
      sdCbool: map['sdCbool'] == null ? null : pulumi.Output.create<String>(map['sdCbool'] as String),
      sdc: map['sdc'] == null ? null : pulumi.Output.create<String>(map['sdc'] as String),
      sddpVersion: map['sddpVersion'] == null ? null : pulumi.Output.create<String>(map['sddpVersion'] as String),
      status: map['status'] == null ? null : pulumi.Output.create<String>(map['status'] as String),
      udCbool: map['udCbool'] == null ? null : pulumi.Output.create<String>(map['udCbool'] as String),
      udc: map['udc'] == null ? null : pulumi.Output.create<String>(map['udc'] as String),
    );
  }
}
