...
class GetConfigsResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'configs': pulumi.Input.encodeList<GetConfigsConfig, Map<String, dynamic>>(configs, (value) => value.toMap()),
      'id': id,
      'ids': ids,
      'lang': ?lang,
  ...
  factory GetConfigsResult.fromMap(Map<String, dynamic> map) {
    return GetConfigsResult(
      configs: pulumi.Input.decodeList<GetConfigsConfig>(map['configs']!, (value) => GetConfigsConfig.fromMap((value as Map).cast<String, dynamic>())),
      id: map['id'] as String,
