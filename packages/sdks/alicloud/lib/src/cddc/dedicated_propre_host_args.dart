...
class DedicatedPropreHostArgs {
  ...
  factory DedicatedPropreHostArgs.fromMap(Map<String, dynamic> map) {
    return DedicatedPropreHostArgs(
      ...
      ecsClassLists: (pulumi.Input.decodeList<DedicatedPropreHostEcsClassList>(map['ecsClassLists'], (value) => DedicatedPropreHostEcsClassList.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      ecsZoneId: (map['ecsZoneId'] as String).input(),
