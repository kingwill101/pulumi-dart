...
class DedicatedPropreHostArgs {
  ...
  factory DedicatedPropreHostArgs.fromMap(Map<String, dynamic> map) {
    return DedicatedPropreHostArgs(
      ...
      ecsClassLists: pulumi.Input.fromValue(pulumi.Input.decodeList<DedicatedPropreHostEcsClassList>(map['ecsClassLists']!, (value) => DedicatedPropreHostEcsClassList.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      ecsZoneId: pulumi.Input.fromValue(map['ecsZoneId'] as String),
