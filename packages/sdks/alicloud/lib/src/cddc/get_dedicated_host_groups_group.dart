...
class GetDedicatedHostGroupsGroup {
  ...
  factory GetDedicatedHostGroupsGroup.fromMap(Map<String, dynamic> map) {
    return GetDedicatedHostGroupsGroup(
      allocationPolicy: pulumi.Input.fromValue(map['allocationPolicy'] as String),
      bastionInstanceId: pulumi.Input.fromValue(map['bastionInstanceId'] as String),
      cpuAllocateRation: pulumi.Input.fromValue(map['cpuAllocateRation'] as double),
      cpuAllocatedAmount: pulumi.Input.fromValue(map['cpuAllocatedAmount'] as double),
      cpuAllocationRatio: pulumi.Input.fromValue(map['cpuAllocationRatio'] as int),
      createTime: pulumi.Input.fromValue(map['createTime'] as String),
      dedicatedHostCountGroupByHostTypes: pulumi.Input.fromValue(pulumi.Input.decodeList<GetDedicatedHostGroupsGroupDedicatedHostCountGroupByHostType>(map['dedicatedHostCountGroupByHostTypes']!, (value) => GetDedicatedHostGroupsGroupDedicatedHostCountGroupByHostType.fromMap((value as Map).cast<String, dynamic>()))),
      dedicatedHostGroupDesc: pulumi.Input.fromValue(map['dedicatedHostGroupDesc'] as String),
      ...
      diskAllocateRation: pulumi.Input.fromValue(map['diskAllocateRation'] as double),
      diskAllocatedAmount: pulumi.Input.fromValue(map['diskAllocatedAmount'] as double),
      diskAllocationRatio: pulumi.Input.fromValue(map['diskAllocationRatio'] as int),
      ...
      hostReplacePolicy: pulumi.Input.fromValue(map['hostReplacePolicy'] as String),
      id: pulumi.Input.fromValue(map['id'] as String),
      instanceNumber: pulumi.Input.fromValue(map['instanceNumber'] as int),
      memAllocateRation: pulumi.Input.fromValue(map['memAllocateRation'] as double),
      memAllocatedAmount: pulumi.Input.fromValue(map['memAllocatedAmount'] as double),
      memAllocationRatio: pulumi.Input.fromValue(map['memAllocationRatio'] as int),
      ...
      zoneIdLists: pulumi.Input.fromValue(pulumi.Input.decodeList<GetDedicatedHostGroupsGroupZoneIdList>(map['zoneIdLists']!, (value) => GetDedicatedHostGroupsGroupZoneIdList.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
