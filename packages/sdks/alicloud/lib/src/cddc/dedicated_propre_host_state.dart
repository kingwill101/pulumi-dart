...
class DedicatedPropreHostState {
  ...
  DedicatedPropreHostState({
    ...
    pulumi.Output<List<DedicatedPropreHostEcsClassList>>? ecsClassLists,
    ...
    pulumi.Output<String>? ecsZoneId,
    ...
    pulumi.Output<String>? vswitchId,
      ...
      ecsClassLists = pulumi.Input.asOptionalInput<List<DedicatedPropreHostEcsClassList>>(ecsClassLists),
      ...
      ecsZoneId = pulumi.Input.asOptionalInput<String>(ecsZoneId),
  ...
  factory DedicatedPropreHostState.fromMap(Map<String, dynamic> map) {
    return DedicatedPropreHostState(
      ...
      ecsClassLists: map['ecsClassLists'] == null ? null : pulumi.Output.create<List<DedicatedPropreHostEcsClassList>>(pulumi.Input.decodeList<DedicatedPropreHostEcsClassList>(map['ecsClassLists'], (value) => DedicatedPropreHostEcsClassList.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      ecsZoneId: map['ecsZoneId'] == null ? null : pulumi.Output.create<String>(map['ecsZoneId'] as String),
