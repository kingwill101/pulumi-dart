...
class DedicatedPropreHost extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<DedicatedPropreHostEcsClassList>> ecsClassLists;
  ...
  DedicatedPropreHost(
    ...
    this.ecsClassLists = registerOutput<List<DedicatedPropreHostEcsClassList>>('ecsClassLists');
    this.ecsDeploymentSetId = registerOutput<String?>('ecsDeploymentSetId');
    this.ecsHostName = registerOutput<String?>('ecsHostName');
    this.ecsInstanceId = registerOutput<String>('ecsInstanceId');
    this.ecsInstanceName = registerOutput<String?>('ecsInstanceName');
    this.ecsUniqueSuffix = registerOutput<String?>('ecsUniqueSuffix');
    this.ecsZoneId = registerOutput<String>('ecsZoneId');
    ...
    this.passwordInherit = registerOutput<String?>('passwordInherit');
    this.paymentType = registerOutput<String>('paymentType');
    this.period = registerOutput<String?>('period');
    this.periodType = registerOutput<String?>('periodType');
    this.resourceGroupId = registerOutput<String>('resourceGroupId');
    this.securityGroupId = registerOutput<String>('securityGroupId');
    this.tags = registerOutput<Map<String, String>?>('tags');
    this.userData = registerOutput<String?>('userData');
    this.userDataEncoded = registerOutput<bool?>('userDataEncoded');
