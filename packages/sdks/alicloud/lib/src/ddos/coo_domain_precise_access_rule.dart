...
import 'coo_domain_precise_access_rule_state.dart';
...
class CooDomainPreciseAccessRule extends pulumi.CustomResource {
  ...
  CooDomainPreciseAccessRule(
    ...
    expires = registerOutput<int?>('expires');
    this.name = registerOutput<String>('name');
  }

  /// Gets an existing [CooDomainPreciseAccessRule] resource's state with the given [name] and [id].
  static CooDomainPreciseAccessRule get(
    String name,
    pulumi.Input<String> id, {
    CooDomainPreciseAccessRuleState? state,
  }) {
    return CooDomainPreciseAccessRule._get(
      name,
      state: state?.toMap(),
  ...
  CooDomainPreciseAccessRule._get(
    String name, {
