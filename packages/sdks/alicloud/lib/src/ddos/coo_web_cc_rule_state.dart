...
class CooWebCcRuleState {
  ...
  factory CooWebCcRuleState.fromMap(Map<String, dynamic> map) {
    return CooWebCcRuleState(
      ...
      ruleDetail: (() { final guardedValue = map['ruleDetail']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CooWebCcRuleRuleDetail.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
