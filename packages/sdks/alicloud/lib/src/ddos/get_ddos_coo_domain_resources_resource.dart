...
class GetDdosCooDomainResourcesResource {
  ...
  final pulumi.Input<List<GetDdosCooDomainResourcesResourceProxyType>>
  proxyTypes;
    ...
    return <String, dynamic>{
      ...
      'proxyTypes':
          pulumi.Input.mapInputValue<
            List<GetDdosCooDomainResourcesResourceProxyType>,
  ...
  factory GetDdosCooDomainResourcesResource.fromMap(Map<String, dynamic> map) {
    return GetDdosCooDomainResourcesResource(
      blackLists: pulumi.Input.fromValue(
        (map['blackLists'] as List).cast<String>(),
      ),
      ...
      proxyTypes: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetDdosCooDomainResourcesResourceProxyType>(
          map['proxyTypes']!,
          (value) => GetDdosCooDomainResourcesResourceProxyType.fromMap(
      ...
      whiteLists: pulumi.Input.fromValue(
        (map['whiteLists'] as List).cast<String>(),
      ),
    );
  }
}
