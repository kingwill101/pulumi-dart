...
class DomainResourceArgs {
  ...
  factory DomainResourceArgs.fromMap(Map<String, dynamic> map) {
    return DomainResourceArgs(
      ...
      proxyTypes: (pulumi.Input.decodeList<DomainResourceProxyType>(map['proxyTypes'], (value) => DomainResourceProxyType.fromMap((value as Map).cast<String, dynamic>()))).input(),
