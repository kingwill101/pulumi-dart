...
class DomainResourceArgs {
  ...
  DomainResourceArgs({
    ...
    required pulumi.Output<List<DomainResourceProxyType>> proxyTypes,
    required pulumi.Output<List<String>> realServers,
    required pulumi.Output<int> rsType,
  ...
  factory DomainResourceArgs.fromMap(Map<String, dynamic> map) {
    return DomainResourceArgs(
      ...
      proxyTypes: pulumi.Output.create<List<DomainResourceProxyType>>(pulumi.Input.decodeList<DomainResourceProxyType>(map['proxyTypes'], (value) => DomainResourceProxyType.fromMap((value as Map).cast<String, dynamic>()))),
      realServers: pulumi.Output.create<List<String>>((map['realServers'] as List).cast<String>()),
      rsType: pulumi.Output.create<int>(map['rsType'] as int),
