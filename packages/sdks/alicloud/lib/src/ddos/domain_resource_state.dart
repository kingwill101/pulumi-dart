...
class DomainResourceState {
  ...
  DomainResourceState({
    pulumi.Output<String>? aiMode,
    pulumi.Output<String>? aiTemplate,
    pulumi.Output<List<String>>? blackLists,
    pulumi.Output<int>? bwListEnable,
    pulumi.Output<String>? ccGlobalSwitch,
    pulumi.Output<String>? cert,
    pulumi.Output<String>? certIdentifier,
    ...
    pulumi.Output<String>? httpsExt,
    pulumi.Output<List<String>>? instanceIds,
    pulumi.Output<String>? key,
    pulumi.Output<bool>? ocspEnabled,
    pulumi.Output<List<DomainResourceProxyType>>? proxyTypes,
    pulumi.Output<List<String>>? realServers,
    pulumi.Output<int>? rsType,
    pulumi.Output<List<String>>? whiteLists,
  }) :
      aiMode = pulumi.Input.asOptionalInput<String>(aiMode),
      aiTemplate = pulumi.Input.asOptionalInput<String>(aiTemplate),
      blackLists = pulumi.Input.asOptionalInput<List<String>>(blackLists),
      bwListEnable = pulumi.Input.asOptionalInput<int>(bwListEnable),
      ccGlobalSwitch = pulumi.Input.asOptionalInput<String>(ccGlobalSwitch),
      cert = pulumi.Input.asOptionalInput<String>(cert),
      certIdentifier = pulumi.Input.asOptionalInput<String>(certIdentifier),
      ...
      httpsExt = pulumi.Input.asOptionalInput<String>(httpsExt),
      instanceIds = pulumi.Input.asOptionalInput<List<String>>(instanceIds),
      key = pulumi.Input.asOptionalInput<String>(key),
      ocspEnabled = pulumi.Input.asOptionalInput<bool>(ocspEnabled),
      proxyTypes = pulumi.Input.asOptionalInput<List<DomainResourceProxyType>>(proxyTypes),
      realServers = pulumi.Input.asOptionalInput<List<String>>(realServers),
      rsType = pulumi.Input.asOptionalInput<int>(rsType),
      whiteLists = pulumi.Input.asOptionalInput<List<String>>(whiteLists);
  ...
  factory DomainResourceState.fromMap(Map<String, dynamic> map) {
    return DomainResourceState(
      aiMode: map['aiMode'] == null ? null : pulumi.Output.create<String>(map['aiMode'] as String),
      aiTemplate: map['aiTemplate'] == null ? null : pulumi.Output.create<String>(map['aiTemplate'] as String),
      blackLists: map['blackLists'] == null ? null : pulumi.Output.create<List<String>>((map['blackLists'] as List).cast<String>()),
      bwListEnable: map['bwListEnable'] == null ? null : pulumi.Output.create<int>(map['bwListEnable'] as int),
      ccGlobalSwitch: map['ccGlobalSwitch'] == null ? null : pulumi.Output.create<String>(map['ccGlobalSwitch'] as String),
      cert: map['cert'] == null ? null : pulumi.Output.create<String>(map['cert'] as String),
      certIdentifier: map['certIdentifier'] == null ? null : pulumi.Output.create<String>(map['certIdentifier'] as String),
      ...
      httpsExt: map['httpsExt'] == null ? null : pulumi.Output.create<String>(map['httpsExt'] as String),
      ...
      ocspEnabled: map['ocspEnabled'] == null ? null : pulumi.Output.create<bool>(map['ocspEnabled'] as bool),
      proxyTypes: map['proxyTypes'] == null ? null : pulumi.Output.create<List<DomainResourceProxyType>>(pulumi.Input.decodeList<DomainResourceProxyType>(map['proxyTypes'], (value) => DomainResourceProxyType.fromMap((value as Map).cast<String, dynamic>()))),
      realServers: map['realServers'] == null ? null : pulumi.Output.create<List<String>>((map['realServers'] as List).cast<String>()),
      rsType: map['rsType'] == null ? null : pulumi.Output.create<int>(map['rsType'] as int),
      whiteLists: map['whiteLists'] == null ? null : pulumi.Output.create<List<String>>((map['whiteLists'] as List).cast<String>()),
    );
  }
}
