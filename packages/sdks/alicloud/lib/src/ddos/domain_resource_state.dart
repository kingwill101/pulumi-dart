...
class DomainResourceState {
  ...
  factory DomainResourceState.fromMap(Map<String, dynamic> map) {
    return DomainResourceState(
      aiMode: (() { final guardedValue = map['aiMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      aiTemplate: (() { final guardedValue = map['aiTemplate']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      blackLists: (() { final guardedValue = map['blackLists']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      bwListEnable: (() { final guardedValue = map['bwListEnable']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ccGlobalSwitch: (() { final guardedValue = map['ccGlobalSwitch']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      cert: (() { final guardedValue = map['cert']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      certIdentifier: (() { final guardedValue = map['certIdentifier']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      customHeaders: (() { final guardedValue = map['customHeaders']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      domain: (() { final guardedValue = map['domain']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      httpsExt: (() { final guardedValue = map['httpsExt']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      ocspEnabled: (() { final guardedValue = map['ocspEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      proxyTypes: (() { final guardedValue = map['proxyTypes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DomainResourceProxyType>(guardedValue, (value) => DomainResourceProxyType.fromMap((value as Map).cast<String, dynamic>()))); })(),
      realServers: (() { final guardedValue = map['realServers']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      rsType: (() { final guardedValue = map['rsType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      whiteLists: (() { final guardedValue = map['whiteLists']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
    );
  }
}
