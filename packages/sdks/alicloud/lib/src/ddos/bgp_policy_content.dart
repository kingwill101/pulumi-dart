...
class BgpPolicyContent {
  ...
  final pulumi.Input<List<BgpPolicyContentFingerPrintRuleList>>?
    ...
    return <String, dynamic>{
      ...
      'fingerPrintRuleLists':
          ?pulumi.Input.mapOptionalInputValue<
            List<BgpPolicyContentFingerPrintRuleList>,
      ...
      'layer4RuleLists':
          ?pulumi.Input.mapOptionalInputValue<
            List<BgpPolicyContentLayer4RuleList>,
            List<Map<String, dynamic>>
          >(
            layer4RuleLists,
            (value) =>
      ...
      'portRuleLists':
          ?pulumi.Input.mapOptionalInputValue<
            List<BgpPolicyContentPortRuleList>,
            List<Map<String, dynamic>>
          >(
            portRuleLists,
            (value) =>
      ...
      'sourceBlockLists':
          ?pulumi.Input.mapOptionalInputValue<
            List<BgpPolicyContentSourceBlockList>,
            List<Map<String, dynamic>>
          >(
            sourceBlockLists,
            (value) =>
  ...
  factory BgpPolicyContent.fromMap(Map<String, dynamic> map) {
    return BgpPolicyContent(
      blackIpListExpireAt: (() {
        final guardedValue = map['blackIpListExpireAt'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      enableDefense: (() {
        final guardedValue = map['enableDefense'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      enableDropIcmp: (() {
        final guardedValue = map['enableDropIcmp'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      enableIntelligence: (() {
        final guardedValue = map['enableIntelligence'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      fingerPrintRuleLists: (() {
        final guardedValue = map['fingerPrintRuleLists'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<BgpPolicyContentFingerPrintRuleList>(
            guardedValue,
            (value) => BgpPolicyContentFingerPrintRuleList.fromMap(
      ...
      intelligenceLevel: (() {
        final guardedValue = map['intelligenceLevel'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      layer4RuleLists: (() {
        final guardedValue = map['layer4RuleLists'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<BgpPolicyContentLayer4RuleList>(
            guardedValue,
            (value) => BgpPolicyContentLayer4RuleList.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      portRuleLists: (() {
        final guardedValue = map['portRuleLists'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<BgpPolicyContentPortRuleList>(
            guardedValue,
            (value) => BgpPolicyContentPortRuleList.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      reflectBlockUdpPortLists: (() {
        final guardedValue = map['reflectBlockUdpPortLists'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<int>());
      })(),
      regionBlockCountryLists: (() {
        final guardedValue = map['regionBlockCountryLists'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<int>());
      })(),
      regionBlockProvinceLists: (() {
        final guardedValue = map['regionBlockProvinceLists'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<int>());
      })(),
      sourceBlockLists: (() {
        final guardedValue = map['sourceBlockLists'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<BgpPolicyContentSourceBlockList>(
            guardedValue,
            (value) => BgpPolicyContentSourceBlockList.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      sourceLimit: (() {
        final guardedValue = map['sourceLimit'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          BgpPolicyContentSourceLimit.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      whitenGfbrNets: (() {
        final guardedValue = map['whitenGfbrNets'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
    );
