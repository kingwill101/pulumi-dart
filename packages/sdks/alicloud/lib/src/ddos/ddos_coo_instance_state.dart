...
class DdosCooInstanceState {
  ...
  factory DdosCooInstanceState.fromMap(Map<String, dynamic> map) {
    return DdosCooInstanceState(
      ...
      bandwidthMode: (() { final guardedValue = map['bandwidthMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      baseBandwidth: (() { final guardedValue = map['baseBandwidth']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      domainCount: (() { final guardedValue = map['domainCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      editionSale: (() { final guardedValue = map['editionSale']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      normalBandwidth: (() { final guardedValue = map['normalBandwidth']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      normalQps: (() { final guardedValue = map['normalQps']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      period: (() { final guardedValue = map['period']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      portCount: (() { final guardedValue = map['portCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      productPlan: (() { final guardedValue = map['productPlan']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      serviceBandwidth: (() { final guardedValue = map['serviceBandwidth']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
