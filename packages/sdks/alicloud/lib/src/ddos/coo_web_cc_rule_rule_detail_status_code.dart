...
class CooWebCcRuleRuleDetailStatusCode {
  ...
  factory CooWebCcRuleRuleDetailStatusCode.fromMap(Map<String, dynamic> map) {
    return CooWebCcRuleRuleDetailStatusCode(
      ...
      countThreshold: (() { final guardedValue = map['countThreshold']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      enabled: pulumi.Input.fromValue(map['enabled'] as bool),
      ratioThreshold: (() { final guardedValue = map['ratioThreshold']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
