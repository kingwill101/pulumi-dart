...
class BgpPolicyContentSourceLimit {
  ...
  factory BgpPolicyContentSourceLimit.fromMap(Map<String, dynamic> map) {
    return BgpPolicyContentSourceLimit(
      ...
      synBps: (() { final guardedValue = map['synBps']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      synPps: (() { final guardedValue = map['synPps']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
    );
  }
}
