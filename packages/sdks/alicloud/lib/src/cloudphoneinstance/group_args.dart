...
class GroupArgs {
  ...
  factory GroupArgs.fromMap(Map<String, dynamic> map) {
    return GroupArgs(
      ...
      gpuAcceleration: (() { final guardedValue = map['gpuAcceleration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      instanceGroupSpec: pulumi.Input.fromValue(map['instanceGroupSpec'] as String),
      numberOfInstances: (() { final guardedValue = map['numberOfInstances']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
