...
class AggregateConfigRuleArgs {
  ...
  AggregateConfigRuleArgs({
    required pulumi.Output<String> aggregateConfigRuleName,
    required pulumi.Output<String> aggregatorId,
    required pulumi.Output<String> configRuleTriggerTypes,
    ...
    required pulumi.Output<List<String>> resourceTypesScopes,
  ...
  factory AggregateConfigRuleArgs.fromMap(Map<String, dynamic> map) {
    return AggregateConfigRuleArgs(
      aggregateConfigRuleName: pulumi.Output.create<String>(map['aggregateConfigRuleName'] as String),
      aggregatorId: pulumi.Output.create<String>(map['aggregatorId'] as String),
      configRuleTriggerTypes: pulumi.Output.create<String>(map['configRuleTriggerTypes'] as String),
      ...
      resourceTypesScopes: pulumi.Output.create<List<String>>((map['resourceTypesScopes'] as List).cast<String>()),
