...
class AggregateDelivery extends pulumi.CustomResource {
  ...
  AggregateDelivery(
    ...
    this.configurationItemChangeNotification = registerOutput<bool?>('configurationItemChangeNotification');
    this.configurationSnapshot = registerOutput<bool?>('configurationSnapshot');
    this.deliveryChannelCondition = registerOutput<String?>('deliveryChannelCondition');
    this.deliveryChannelId = registerOutput<String>('deliveryChannelId');
    this.deliveryChannelName = registerOutput<String?>('deliveryChannelName');
    this.deliveryChannelTargetArn = registerOutput<String>('deliveryChannelTargetArn');
    this.deliveryChannelType = registerOutput<String>('deliveryChannelType');
    this.description = registerOutput<String?>('description');
    this.nonCompliantNotification = registerOutput<bool?>('nonCompliantNotification');
    this.oversizedDataOssTargetArn = registerOutput<String?>('oversizedDataOssTargetArn');
