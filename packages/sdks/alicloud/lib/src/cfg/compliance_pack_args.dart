...
class CompliancePackArgs {
    ...
    return <String, dynamic>{
      ...
      'configRuleIds':
          ?pulumi.Input.mapOptionalInputValue<
            List<CompliancePackConfigRuleId>,
  ...
  factory CompliancePackArgs.fromMap(Map<String, dynamic> map) {
    return CompliancePackArgs(
      compliancePackName: pulumi.Input.fromValue(
        map['compliancePackName'] as String,
      ),
      ...
      configRuleIds: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<CompliancePackConfigRuleId>(
            guardedValue,
            (value) => CompliancePackConfigRuleId.fromMap(
      ...
      configRules: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<CompliancePackConfigRule>(
            guardedValue,
            (value) => CompliancePackConfigRule.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
