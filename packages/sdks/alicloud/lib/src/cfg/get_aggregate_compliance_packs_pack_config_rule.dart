...
class GetAggregateCompliancePacksPackConfigRule {
  ...
  factory GetAggregateCompliancePacksPackConfigRule.fromMap(Map<String, dynamic> map) {
    return GetAggregateCompliancePacksPackConfigRule(
      ...
      configRuleParameters: pulumi.Input.fromValue(pulumi.Input.decodeList<GetAggregateCompliancePacksPackConfigRuleConfigRuleParameter>(map['configRuleParameters']!, (value) => GetAggregateCompliancePacksPackConfigRuleConfigRuleParameter.fromMap((value as Map).cast<String, dynamic>()))),
