...
import 'aggregate_remediation_state.dart';
...
class AggregateRemediation extends pulumi.CustomResource {
  ...
  /// Gets an existing [AggregateRemediation] resource's state with the given [name] and [id].
  static AggregateRemediation get(
    String name,
    pulumi.Input<String> id, {
    AggregateRemediationState? state,
  }) {
    return AggregateRemediation._get(
      name,
      state: state?.toMap(),
