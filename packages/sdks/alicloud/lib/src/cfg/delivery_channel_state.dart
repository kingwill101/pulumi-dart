...
class DeliveryChannelState {
  ...
  factory DeliveryChannelState.fromMap(Map<String, dynamic> map) {
    return DeliveryChannelState(
      deliveryChannelAssumeRoleArn: (() { final guardedValue = map['deliveryChannelAssumeRoleArn']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
