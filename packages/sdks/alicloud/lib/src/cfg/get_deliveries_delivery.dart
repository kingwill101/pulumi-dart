...
class GetDeliveriesDelivery {
  ...
  factory GetDeliveriesDelivery.fromMap(Map<String, dynamic> map) {
    return GetDeliveriesDelivery(
      ...
      configurationItemChangeNotification: pulumi.Input.fromValue(map['configurationItemChangeNotification'] as bool),
      configurationSnapshot: pulumi.Input.fromValue(map['configurationSnapshot'] as bool),
      ...
      nonCompliantNotification: pulumi.Input.fromValue(map['nonCompliantNotification'] as bool),
      oversizedDataOssTargetArn: pulumi.Input.fromValue(map['oversizedDataOssTargetArn'] as String),
