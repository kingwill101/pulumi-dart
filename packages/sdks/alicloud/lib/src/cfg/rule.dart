...
class Rule extends pulumi.CustomResource {
  ...
  Rule(
    ...
    compliance = registerOutput<RuleCompliance>('compliance', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return RuleCompliance.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    scopeComplianceResourceTypes = registerOutput<String>('scopeComplianceResourceTypes');
    ...
    sourceMaximumExecutionFrequency = registerOutput<String>('sourceMaximumExecutionFrequency');
