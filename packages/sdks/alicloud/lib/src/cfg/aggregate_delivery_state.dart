...
class AggregateDeliveryState {
  ...
  /// Creates a new [AggregateDeliveryState].
  ...
  /// [deliveryChannelId] The ID of the delivery method. This parameter is required when you modify a delivery method.
  ...
  factory AggregateDeliveryState.fromMap(Map<String, dynamic> map) {
    return AggregateDeliveryState(
      ...
      deliveryChannelId: (() { final guardedValue = map['deliveryChannelId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
