...
import 'aggregate_config_rule_state.dart';
...
class AggregateConfigRule extends pulumi.CustomResource {
  ...
  AggregateConfigRule(
    ...
    aggregateConfigRuleName = registerOutput<String>('aggregateConfigRuleName');
  ...
  /// Gets an existing [AggregateConfigRule] resource's state with the given [name] and [id].
  static AggregateConfigRule get(
    String name,
    pulumi.Input<String> id, {
    AggregateConfigRuleState? state,
  }) {
    return AggregateConfigRule._get(
      name,
      state: state?.toMap(),
