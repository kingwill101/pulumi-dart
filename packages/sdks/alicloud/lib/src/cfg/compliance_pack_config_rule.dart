...
class CompliancePackConfigRule {
  ...
  final pulumi.Input<List<CompliancePackConfigRuleConfigRuleParameter>>?
    ...
    return <String, dynamic>{
      'configRuleParameters':
          ?pulumi.Input.mapOptionalInputValue<
            List<CompliancePackConfigRuleConfigRuleParameter>,
    ...
    return CompliancePackConfigRule(
      configRuleParameters: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<CompliancePackConfigRuleConfigRuleParameter>(
            guardedValue,
            (value) => CompliancePackConfigRuleConfigRuleParameter.fromMap(
