...
class GetCompliancePacksPackConfigRule {
  ...
  const GetCompliancePacksPackConfigRule({
  ...
  factory GetCompliancePacksPackConfigRule.fromMap(Map<String, dynamic> map) {
    return GetCompliancePacksPackConfigRule(
      ...
      configRuleParameters: pulumi.Input.fromValue(pulumi.Input.decodeList<GetCompliancePacksPackConfigRuleConfigRuleParameter>(map['configRuleParameters']!, (value) => GetCompliancePacksPackConfigRuleConfigRuleParameter.fromMap((value as Map).cast<String, dynamic>()))),
