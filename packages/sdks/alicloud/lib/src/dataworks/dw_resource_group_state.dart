...
class DwResourceGroupState {
  ...
  factory DwResourceGroupState.fromMap(Map<String, dynamic> map) {
    return DwResourceGroupState(
      ...
      defaultVpcId: (() { final guardedValue = map['defaultVpcId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      defaultVswitchId: (() { final guardedValue = map['defaultVswitchId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
