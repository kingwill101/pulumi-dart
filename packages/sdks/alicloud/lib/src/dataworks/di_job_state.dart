...
class DiJobState {
  ...
  factory DiJobState.fromMap(Map<String, dynamic> map) {
    return DiJobState(
      ...
      destinationDataSourceSettings: (() {
        final guardedValue = map['destinationDataSourceSettings'];
        if (guardedValue == null) return null;
      ...
      destinationDataSourceType: (() {
        final guardedValue = map['destinationDataSourceType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      diJobId: (() {
      ...
      sourceDataSourceSettings: (() {
        final guardedValue = map['sourceDataSourceSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      sourceDataSourceType: (() {
        final guardedValue = map['sourceDataSourceType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      tableMappings: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DiJobTableMapping>(
            guardedValue,
            (value) => DiJobTableMapping.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
