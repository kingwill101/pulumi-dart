...
class DiJobArgs {
  ...
  factory DiJobArgs.fromMap(Map<String, dynamic> map) {
    return DiJobArgs(
      ...
      destinationDataSourceSettings: pulumi.Input.fromValue(pulumi.Input.decodeList<DiJobDestinationDataSourceSetting>(map['destinationDataSourceSettings']!, (value) => DiJobDestinationDataSourceSetting.fromMap((value as Map).cast<String, dynamic>()))),
      destinationDataSourceType: pulumi.Input.fromValue(map['destinationDataSourceType'] as String),
      ...
      resourceSettings: pulumi.Input.fromValue(DiJobResourceSettings.fromMap((map['resourceSettings']! as Map).cast<String, dynamic>())),
      sourceDataSourceSettings: pulumi.Input.fromValue(pulumi.Input.decodeList<DiJobSourceDataSourceSetting>(map['sourceDataSourceSettings']!, (value) => DiJobSourceDataSourceSetting.fromMap((value as Map).cast<String, dynamic>()))),
      sourceDataSourceType: pulumi.Input.fromValue(map['sourceDataSourceType'] as String),
      tableMappings: pulumi.Input.fromValue(pulumi.Input.decodeList<DiJobTableMapping>(map['tableMappings']!, (value) => DiJobTableMapping.fromMap((value as Map).cast<String, dynamic>()))),
