...
class DiJobArgs {
  ...
  final pulumi.Input<List<DiJobDestinationDataSourceSetting>>
  ...
  final pulumi.Input<List<DiJobSourceDataSourceSetting>>
  ...
  factory DiJobArgs.fromMap(Map<String, dynamic> map) {
    return DiJobArgs(
      ...
      destinationDataSourceSettings: pulumi.Input.fromValue(
        pulumi.Input.decodeList<DiJobDestinationDataSourceSetting>(
          map['destinationDataSourceSettings']!,
          (value) => DiJobDestinationDataSourceSetting.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      destinationDataSourceType: pulumi.Input.fromValue(
        map['destinationDataSourceType'] as String,
      ),
      jobName: pulumi.Input.fromValue(map['jobName'] as String),
      jobSettings: (() {
        final guardedValue = map['jobSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DiJobJobSettings.fromMap(
      ...
      resourceSettings: pulumi.Input.fromValue(
        DiJobResourceSettings.fromMap(
          (map['resourceSettings']! as Map).cast<String, dynamic>(),
        ),
      ),
      sourceDataSourceSettings: pulumi.Input.fromValue(
        pulumi.Input.decodeList<DiJobSourceDataSourceSetting>(
          map['sourceDataSourceSettings']!,
          (value) => DiJobSourceDataSourceSetting.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      sourceDataSourceType: pulumi.Input.fromValue(
        map['sourceDataSourceType'] as String,
      ),
      tableMappings: pulumi.Input.fromValue(
        pulumi.Input.decodeList<DiJobTableMapping>(
          map['tableMappings']!,
          (value) =>
              DiJobTableMapping.fromMap((value as Map).cast<String, dynamic>()),
        ),
      ),
      transformationRules: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DiJobTransformationRule>(
            guardedValue,
            (value) => DiJobTransformationRule.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
