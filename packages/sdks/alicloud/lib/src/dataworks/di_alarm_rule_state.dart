...
class DiAlarmRuleState {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'triggerConditions':
          ?pulumi.Input.mapOptionalInputValue<
            List<DiAlarmRuleTriggerCondition>,
  ...
  factory DiAlarmRuleState.fromMap(Map<String, dynamic> map) {
    return DiAlarmRuleState(
      ...
      diAlarmRuleId: (() {
        final guardedValue = map['diAlarmRuleId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      diAlarmRuleName: (() {
        final guardedValue = map['diAlarmRuleName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      diJobId: (() {
        final guardedValue = map['diJobId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      enabled: (() {
      ...
      notificationSettings: (() {
        ...
        return pulumi.Input.fromValue(
          DiAlarmRuleNotificationSettings.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      triggerConditions: (() {
        final guardedValue = map['triggerConditions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DiAlarmRuleTriggerCondition>(
            guardedValue,
            (value) => DiAlarmRuleTriggerCondition.fromMap(
