...
class DiAlarmRuleNotificationSettings {
  ...
  final pulumi.Input<List<DiAlarmRuleNotificationSettingsNotificationChannel>>?
  notificationChannels;

  /// List of alert notification recipients See `notification_receivers` below.
  final pulumi.Input<List<DiAlarmRuleNotificationSettingsNotificationReceiver>>?
    ...
    return <String, dynamic>{
      ...
      'notificationChannels':
          ?pulumi.Input.mapOptionalInputValue<
            List<DiAlarmRuleNotificationSettingsNotificationChannel>,
      ...
      'notificationReceivers':
          ?pulumi.Input.mapOptionalInputValue<
            List<DiAlarmRuleNotificationSettingsNotificationReceiver>,
            List<Map<String, dynamic>>
          >(
            notificationReceivers,
            (value) =>
  ...
  factory DiAlarmRuleNotificationSettings.fromMap(Map<String, dynamic> map) {
    return DiAlarmRuleNotificationSettings(
      inhibitionInterval: (() {
        final guardedValue = map['inhibitionInterval'];
      ...
      notificationChannels: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                DiAlarmRuleNotificationSettingsNotificationChannel.fromMap(
      ...
      notificationReceivers: (() {
        final guardedValue = map['notificationReceivers'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<
            DiAlarmRuleNotificationSettingsNotificationReceiver
          >(
            guardedValue,
            (value) =>
                DiAlarmRuleNotificationSettingsNotificationReceiver.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
