...
class DiJobSourceDataSourceSetting {
  ...
  final pulumi.Input<DiJobSourceDataSourceSettingDataSourceProperties>? dataSourceProperties;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'dataSourceProperties': ?pulumi.Input.mapOptionalInputValue<DiJobSourceDataSourceSettingDataSourceProperties, Map<String, dynamic>>(dataSourceProperties, (value) => value.toMap()),
    };
  }
  ...
  factory DiJobSourceDataSourceSetting.fromMap(Map<String, dynamic> map) {
    return DiJobSourceDataSourceSetting(
      ...
      dataSourceProperties: (() { final guardedValue = map['dataSourceProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DiJobSourceDataSourceSettingDataSourceProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
