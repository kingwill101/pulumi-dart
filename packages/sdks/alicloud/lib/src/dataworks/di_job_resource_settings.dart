...
class DiJobResourceSettings {
  ...
  factory DiJobResourceSettings.fromMap(Map<String, dynamic> map) {
    return DiJobResourceSettings(
      offlineResourceSettings: (() { final guardedValue = map['offlineResourceSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DiJobResourceSettingsOfflineResourceSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      realtimeResourceSettings: (() { final guardedValue = map['realtimeResourceSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DiJobResourceSettingsRealtimeResourceSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      scheduleResourceSettings: (() { final guardedValue = map['scheduleResourceSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DiJobResourceSettingsScheduleResourceSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
