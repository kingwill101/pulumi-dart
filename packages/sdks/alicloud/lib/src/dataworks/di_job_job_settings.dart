...
class DiJobJobSettings {
  ...
  final pulumi.Input<List<DiJobJobSettingsColumnDataTypeSetting>>?
  columnDataTypeSettings;

  /// Periodic scheduling settings See `cycle_schedule_settings` below.
  final pulumi.Input<DiJobJobSettingsCycleScheduleSettings>?
  cycleScheduleSettings;

  /// List of DDL processing settings for synchronization tasks See `ddl_handling_settings` below.
  final pulumi.Input<List<DiJobJobSettingsDdlHandlingSetting>>?
  ddlHandlingSettings;
    ...
    return <String, dynamic>{
      ...
      'columnDataTypeSettings':
          ?pulumi.Input.mapOptionalInputValue<
            List<DiJobJobSettingsColumnDataTypeSetting>,
      ...
      'cycleScheduleSettings':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(cycleScheduleSettings, (value) => value.toMap()),
      'ddlHandlingSettings':
          ?pulumi.Input.mapOptionalInputValue<
            List<DiJobJobSettingsDdlHandlingSetting>,
            List<Map<String, dynamic>>
          >(
            ddlHandlingSettings,
            (value) =>
      ...
      'runtimeSettings':
          ?pulumi.Input.mapOptionalInputValue<
            List<DiJobJobSettingsRuntimeSetting>,
            List<Map<String, dynamic>>
          >(
            runtimeSettings,
            (value) =>
  ...
  factory DiJobJobSettings.fromMap(Map<String, dynamic> map) {
    return DiJobJobSettings(
      channelSettings: (() {
        final guardedValue = map['channelSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      columnDataTypeSettings: (() {
        final guardedValue = map['columnDataTypeSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DiJobJobSettingsColumnDataTypeSetting>(
            guardedValue,
            (value) => DiJobJobSettingsColumnDataTypeSetting.fromMap(
      ...
      cycleScheduleSettings: (() {
        final guardedValue = map['cycleScheduleSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DiJobJobSettingsCycleScheduleSettings.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ddlHandlingSettings: (() {
        final guardedValue = map['ddlHandlingSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DiJobJobSettingsDdlHandlingSetting>(
            guardedValue,
            (value) => DiJobJobSettingsDdlHandlingSetting.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      runtimeSettings: (() {
        final guardedValue = map['runtimeSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DiJobJobSettingsRuntimeSetting>(
            guardedValue,
            (value) => DiJobJobSettingsRuntimeSetting.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
