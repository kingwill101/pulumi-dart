...
class GetResolutionLinesArgs {
  ...
  factory GetResolutionLinesArgs.fromMap(Map<String, dynamic> map) {
    return GetResolutionLinesArgs(
      ...
      lineCodes: (() { final guardedValue = map['lineCodes']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      lineDisplayNames: (() { final guardedValue = map['lineDisplayNames']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      lineNames: (() { final guardedValue = map['lineNames']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
