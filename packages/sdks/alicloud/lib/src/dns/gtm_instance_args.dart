...
class GtmInstanceArgs {
  ...
  factory GtmInstanceArgs.fromMap(Map<String, dynamic> map) {
    return GtmInstanceArgs(
      ...
      healthCheckTaskCount: pulumi.Input.fromValue(map['healthCheckTaskCount'] as int),
      ...
      smsNotificationCount: pulumi.Input.fromValue(map['smsNotificationCount'] as int),
