...
class CustomLineState {
  ...
  factory CustomLineState.fromMap(Map<String, dynamic> map) {
    return CustomLineState(
      customLineName: (() { final guardedValue = map['customLineName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      domainName: (() { final guardedValue = map['domainName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ipSegmentLists: (() { final guardedValue = map['ipSegmentLists']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<CustomLineIpSegmentList>(guardedValue, (value) => CustomLineIpSegmentList.fromMap((value as Map).cast<String, dynamic>()))); })(),
