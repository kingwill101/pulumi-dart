...
class GtmInstanceState {
  ...
  factory GtmInstanceState.fromMap(Map<String, dynamic> map) {
    return GtmInstanceState(
      alertConfigs: (() { final guardedValue = map['alertConfigs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GtmInstanceAlertConfig>(guardedValue, (value) => GtmInstanceAlertConfig.fromMap((value as Map).cast<String, dynamic>()))); })(),
      alertGroups: (() { final guardedValue = map['alertGroups']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      cnameType: (() { final guardedValue = map['cnameType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      healthCheckTaskCount: (() { final guardedValue = map['healthCheckTaskCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      packageEdition: (() { final guardedValue = map['packageEdition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      publicCnameMode: (() { final guardedValue = map['publicCnameMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      publicRr: (() { final guardedValue = map['publicRr']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      publicUserDomainName: (() { final guardedValue = map['publicUserDomainName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      publicZoneName: (() { final guardedValue = map['publicZoneName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      smsNotificationCount: (() { final guardedValue = map['smsNotificationCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      strategyMode: (() { final guardedValue = map['strategyMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
