...
class GetDomainsArgs {
  ...
  GetDomainsArgs({
    pulumi.Output<bool>? aliDomain,
    pulumi.Output<String>? domainNameRegex,
    pulumi.Output<bool>? enableDetails,
    pulumi.Output<String>? groupId,
    pulumi.Output<String>? groupNameRegex,
  ...
  factory GetDomainsArgs.fromMap(Map<String, dynamic> map) {
    return GetDomainsArgs(
      aliDomain: map['aliDomain'] == null ? null : pulumi.Output.create<bool>(map['aliDomain'] as bool),
      domainNameRegex: map['domainNameRegex'] == null ? null : pulumi.Output.create<String>(map['domainNameRegex'] as String),
      enableDetails: map['enableDetails'] == null ? null : pulumi.Output.create<bool>(map['enableDetails'] as bool),
      groupId: map['groupId'] == null ? null : pulumi.Output.create<String>(map['groupId'] as String),
      groupNameRegex: map['groupNameRegex'] == null ? null : pulumi.Output.create<String>(map['groupNameRegex'] as String),
      ...
      starmark: map['starmark'] == null ? null : pulumi.Output.create<bool>(map['starmark'] as bool),
