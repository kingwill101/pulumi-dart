...
class GetGtmInstancesInstance {
  ...
  factory GetGtmInstancesInstance.fromMap(Map<String, dynamic> map) {
    return GetGtmInstancesInstance(
      alertConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetGtmInstancesInstanceAlertConfig>(map['alertConfigs']!, (value) => GetGtmInstancesInstanceAlertConfig.fromMap((value as Map).cast<String, dynamic>()))),
      alertGroups: pulumi.Input.fromValue((map['alertGroups'] as List).cast<String>()),
      ...
      publicUserDomainName: pulumi.Input.fromValue(map['publicUserDomainName'] as String),
