...
class AccessStrategyState {
  ...
  factory AccessStrategyState.fromMap(Map<String, dynamic> map) {
    return AccessStrategyState(
      ...
      defaultAddrPoolType: (() { final guardedValue = map['defaultAddrPoolType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      defaultAddrPools: (() { final guardedValue = map['defaultAddrPools']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AccessStrategyDefaultAddrPool>(guardedValue, (value) => AccessStrategyDefaultAddrPool.fromMap((value as Map).cast<String, dynamic>()))); })(),
      defaultLatencyOptimization: (() { final guardedValue = map['defaultLatencyOptimization']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      defaultLbaStrategy: (() { final guardedValue = map['defaultLbaStrategy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      defaultMaxReturnAddrNum: (() { final guardedValue = map['defaultMaxReturnAddrNum']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      defaultMinAvailableAddrNum: (() { final guardedValue = map['defaultMinAvailableAddrNum']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      failoverAddrPoolType: (() { final guardedValue = map['failoverAddrPoolType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      failoverAddrPools: (() { final guardedValue = map['failoverAddrPools']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AccessStrategyFailoverAddrPool>(guardedValue, (value) => AccessStrategyFailoverAddrPool.fromMap((value as Map).cast<String, dynamic>()))); })(),
      failoverLatencyOptimization: (() { final guardedValue = map['failoverLatencyOptimization']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      failoverLbaStrategy: (() { final guardedValue = map['failoverLbaStrategy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      failoverMaxReturnAddrNum: (() { final guardedValue = map['failoverMaxReturnAddrNum']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      failoverMinAvailableAddrNum: (() { final guardedValue = map['failoverMinAvailableAddrNum']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      lines: (() { final guardedValue = map['lines']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AccessStrategyLine>(guardedValue, (value) => AccessStrategyLine.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      strategyName: (() { final guardedValue = map['strategyName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
