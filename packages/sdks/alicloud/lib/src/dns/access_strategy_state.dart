...
class AccessStrategyState {
  ...
  factory AccessStrategyState.fromMap(Map<String, dynamic> map) {
    return AccessStrategyState(
      ...
      defaultAddrPoolType: map['defaultAddrPoolType'] == null ? null : (map['defaultAddrPoolType'] as String).input(),
      defaultAddrPools: map['defaultAddrPools'] == null ? null : (pulumi.Input.decodeList<AccessStrategyDefaultAddrPool>(map['defaultAddrPools'], (value) => AccessStrategyDefaultAddrPool.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      defaultMinAvailableAddrNum: map['defaultMinAvailableAddrNum'] == null ? null : (map['defaultMinAvailableAddrNum'] as int).input(),
      ...
      strategyName: map['strategyName'] == null ? null : (map['strategyName'] as String).input(),
    );
  }
}
