...
class AccessStrategyArgs {
  ...
  factory AccessStrategyArgs.fromMap(Map<String, dynamic> map) {
    return AccessStrategyArgs(
      ...
      defaultAddrPools: pulumi.Input.fromValue(pulumi.Input.decodeList<AccessStrategyDefaultAddrPool>(map['defaultAddrPools']!, (value) => AccessStrategyDefaultAddrPool.fromMap((value as Map).cast<String, dynamic>()))),
