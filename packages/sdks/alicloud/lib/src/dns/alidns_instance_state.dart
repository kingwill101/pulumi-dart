...
class AlidnsInstanceState {
  ...
  factory AlidnsInstanceState.fromMap(Map<String, dynamic> map) {
    return AlidnsInstanceState(
      dnsSecurity: (() { final guardedValue = map['dnsSecurity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      domainNumbers: (() { final guardedValue = map['domainNumbers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
