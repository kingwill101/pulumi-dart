...
class GetAlidnsRecordsArgs {
  ...
  factory GetAlidnsRecordsArgs.fromMap(Map<String, dynamic> map) {
    return GetAlidnsRecordsArgs(
      ...
      rrKeyWord: (() { final guardedValue = map['rrKeyWord']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      rrRegex: (() { final guardedValue = map['rrRegex']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      typeKeyWord: (() { final guardedValue = map['typeKeyWord']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      valueKeyWord: (() { final guardedValue = map['valueKeyWord']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
