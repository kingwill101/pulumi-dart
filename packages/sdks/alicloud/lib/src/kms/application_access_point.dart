...
import 'application_access_point_state.dart';
...
class ApplicationAccessPoint extends pulumi.CustomResource {
  ...
  static ApplicationAccessPoint get(
    String name,
    pulumi.Input<String> id, {
    ApplicationAccessPointState? state,
  }) {
    return ApplicationAccessPoint._get(
      name,
      state: state?.toMap(),
