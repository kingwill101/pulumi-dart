...
class KeyState {
  ...
  KeyState({
    ...
    this.materialExpireTime,
    this.nextRotationDate,
    this.origin,
    this.pendingWindowInDays,
    this.policy,
    this.primaryKeyVersion,
  ...
  factory KeyState.fromMap(Map<String, dynamic> map) {
    return KeyState(
      ...
      automaticRotation: map['automaticRotation'] == null ? null : (map['automaticRotation']! as String).input(),
      ...
      deleteDate: map['deleteDate'] == null ? null : (map['deleteDate']! as String).input(),
      deletionProtection: map['deletionProtection'] == null ? null : (map['deletionProtection']! as String).input(),
      deletionProtectionDescription: map['deletionProtectionDescription'] == null ? null : (map['deletionProtectionDescription']! as String).input(),
      ...
      lastRotationDate: map['lastRotationDate'] == null ? null : (map['lastRotationDate']! as String).input(),
      materialExpireTime: map['materialExpireTime'] == null ? null : (map['materialExpireTime']! as String).input(),
      nextRotationDate: map['nextRotationDate'] == null ? null : (map['nextRotationDate']! as String).input(),
      ...
      primaryKeyVersion: map['primaryKeyVersion'] == null ? null : (map['primaryKeyVersion']! as String).input(),
