...
class KeyState {
  ...
  /// [creationDate] The time when the CMK was created.
  /// [creator] The creator of the CMK.
  /// [deleteDate] The time at which the CMK is scheduled for deletion.
  ...
  /// [materialExpireTime] The time when the key material expires.
  ...
  KeyState({
    ...
    pulumi.Output<String>? deleteDate,
    ...
    pulumi.Output<String>? lastRotationDate,
    pulumi.Output<String>? materialExpireTime,
    pulumi.Output<String>? nextRotationDate,
    pulumi.Output<String>? origin,
    pulumi.Output<int>? pendingWindowInDays,
    pulumi.Output<String>? policy,
    pulumi.Output<String>? primaryKeyVersion,
    ...
    pulumi.Output<Map<String, String>>? tags,
      ...
      deleteDate = pulumi.Input.asOptionalInput<String>(deleteDate),
      ...
      lastRotationDate = pulumi.Input.asOptionalInput<String>(lastRotationDate),
      materialExpireTime = pulumi.Input.asOptionalInput<String>(materialExpireTime),
      nextRotationDate = pulumi.Input.asOptionalInput<String>(nextRotationDate),
      ...
      primaryKeyVersion = pulumi.Input.asOptionalInput<String>(primaryKeyVersion),
  ...
  factory KeyState.fromMap(Map<String, dynamic> map) {
    return KeyState(
      ...
      deleteDate: map['deleteDate'] == null ? null : pulumi.Output.create<String>(map['deleteDate'] as String),
      ...
      lastRotationDate: map['lastRotationDate'] == null ? null : pulumi.Output.create<String>(map['lastRotationDate'] as String),
      materialExpireTime: map['materialExpireTime'] == null ? null : pulumi.Output.create<String>(map['materialExpireTime'] as String),
      nextRotationDate: map['nextRotationDate'] == null ? null : pulumi.Output.create<String>(map['nextRotationDate'] as String),
      ...
      primaryKeyVersion: map['primaryKeyVersion'] == null ? null : pulumi.Output.create<String>(map['primaryKeyVersion'] as String),
