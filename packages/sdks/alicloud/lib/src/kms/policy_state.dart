...
class PolicyState {
  ...
  factory PolicyState.fromMap(Map<String, dynamic> map) {
    return PolicyState(
      accessControlRules: (() { final guardedValue = map['accessControlRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      description: (() { final guardedValue = map['description']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      kmsInstanceId: (() { final guardedValue = map['kmsInstanceId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
