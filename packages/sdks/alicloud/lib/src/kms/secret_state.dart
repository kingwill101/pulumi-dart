...
class SecretState {
  ...
  factory SecretState.fromMap(Map<String, dynamic> map) {
    return SecretState(
      ...
      enableAutomaticRotation: (() { final guardedValue = map['enableAutomaticRotation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      encryptionKeyId: (() { final guardedValue = map['encryptionKeyId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      extendedConfig: (() { final guardedValue = map['extendedConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      forceDeleteWithoutRecovery: (() { final guardedValue = map['forceDeleteWithoutRecovery']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      plannedDeleteTime: (() { final guardedValue = map['plannedDeleteTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      secretDataType: (() { final guardedValue = map['secretDataType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
