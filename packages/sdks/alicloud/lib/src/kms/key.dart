...
class Key extends pulumi.CustomResource {
  ...
  Key(
    ...
    this.automaticRotation = registerOutput<String>('automaticRotation');
    this.creationDate = registerOutput<String>('creationDate');
    this.creator = registerOutput<String>('creator');
    this.deleteDate = registerOutput<String>('deleteDate');
    this.deletionProtection = registerOutput<String>('deletionProtection');
    this.deletionProtectionDescription = registerOutput<String?>('deletionProtectionDescription');
    ...
    this.lastRotationDate = registerOutput<String>('lastRotationDate');
    this.materialExpireTime = registerOutput<String>('materialExpireTime');
    this.nextRotationDate = registerOutput<String>('nextRotationDate');
    this.origin = registerOutput<String>('origin');
    this.pendingWindowInDays = registerOutput<int?>('pendingWindowInDays');
    this.policy = registerOutput<String>('policy');
    this.primaryKeyVersion = registerOutput<String>('primaryKeyVersion');
    this.protectionLevel = registerOutput<String?>('protectionLevel');
    this.rotationInterval = registerOutput<String?>('rotationInterval');
