...
class CertState {
  ...
  factory CertState.fromMap(Map<String, dynamic> map) {
    return CertState(
      afterTime: (() {
        final guardedValue = map['afterTime'];
      ...
      beforeTime: (() {
        final guardedValue = map['beforeTime'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      commonName: (() {
      ...
      customIdentifier: (() {
        final guardedValue = map['customIdentifier'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      days: (() {
      ...
      immediately: (() {
        final guardedValue = map['immediately'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      locality: (() {
      ...
      sanType: (() {
        final guardedValue = map['sanType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      sanValue: (() {
        final guardedValue = map['sanValue'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      state: (() {
      ...
      uploadFlag: (() {
        final guardedValue = map['uploadFlag'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      years: (() {
