...
/// {@template pulumi_securitycenter_get_groups_get_groups_args_doc}
/// Arguments for getGroups.
/// {@endtemplate}
/// {@macro pulumi_securitycenter_get_groups_get_groups_args_doc}
class GetGroupsArgs {
  /// A list of Group IDs.
  ...
  GetGroupsArgs({this.ids, this.nameRegex, this.outputFile});
