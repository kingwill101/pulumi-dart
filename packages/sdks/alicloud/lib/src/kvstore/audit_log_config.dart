...
import 'audit_log_config_state.dart';
...
class AuditLogConfig extends pulumi.CustomResource {
  ...
  /// Gets an existing [AuditLogConfig] resource's state with the given [name] and [id].
  static AuditLogConfig get(
    String name,
    pulumi.Input<String> id, {
    AuditLogConfigState? state,
  }) {
    return AuditLogConfig._get(
      name,
      state: state?.toMap(),
