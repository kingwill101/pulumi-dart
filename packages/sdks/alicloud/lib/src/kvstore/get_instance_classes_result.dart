...
class GetInstanceClassesResult {
  ...
  factory GetInstanceClassesResult.fromMap(Map<String, dynamic> map) {
    return GetInstanceClassesResult(
      ...
      performanceType: (() { final guardedValue = map['performanceType']; if (guardedValue == null) return null; return guardedValue as String; })(),
      productType: (() { final guardedValue = map['productType']; if (guardedValue == null) return null; return guardedValue as String; })(),
      seriesType: (() { final guardedValue = map['seriesType']; if (guardedValue == null) return null; return guardedValue as String; })(),
      shardNumber: (() { final guardedValue = map['shardNumber']; if (guardedValue == null) return null; return guardedValue as int; })(),
