...
class GetInstancesResult {
  ...
  factory GetInstancesResult.fromMap(Map<String, dynamic> map) {
    return GetInstancesResult(
      architectureType: (() { final guardedValue = map['architectureType']; if (guardedValue == null) return null; return guardedValue as String; })(),
      editionType: (() { final guardedValue = map['editionType']; if (guardedValue == null) return null; return guardedValue as String; })(),
      ...
      expired: (() { final guardedValue = map['expired']; if (guardedValue == null) return null; return guardedValue as String; })(),
      globalInstance: (() { final guardedValue = map['globalInstance']; if (guardedValue == null) return null; return guardedValue as bool; })(),
      id: map['id'] as String,
