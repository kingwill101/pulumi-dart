...
class DeploymentLogging {
  ...
  factory DeploymentLogging.fromMap(Map<String, dynamic> map) {
    return DeploymentLogging(
      log4j2ConfigurationTemplate: (() { final guardedValue = map['log4j2ConfigurationTemplate']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      log4jLoggers: (() { final guardedValue = map['log4jLoggers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DeploymentLoggingLog4jLogger>(guardedValue, (value) => DeploymentLoggingLog4jLogger.fromMap((value as Map).cast<String, dynamic>()))); })(),
      logReservePolicy: (() { final guardedValue = map['logReservePolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DeploymentLoggingLogReservePolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      loggingProfile: (() { final guardedValue = map['loggingProfile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
