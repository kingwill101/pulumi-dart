...
class DeploymentLoggingLog4jLogger {
  ...
  factory DeploymentLoggingLog4jLogger.fromMap(Map<String, dynamic> map) {
    return DeploymentLoggingLog4jLogger(
      loggerLevel: (() { final guardedValue = map['loggerLevel']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      loggerName: (() { final guardedValue = map['loggerName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
