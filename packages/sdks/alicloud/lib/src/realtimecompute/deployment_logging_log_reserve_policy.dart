...
class DeploymentLoggingLogReservePolicy {
  ...
  factory DeploymentLoggingLogReservePolicy.fromMap(Map<String, dynamic> map) {
    return DeploymentLoggingLogReservePolicy(
      expirationDays: (() { final guardedValue = map['expirationDays']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      openHistory: (() { final guardedValue = map['openHistory']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
    );
  }
}
