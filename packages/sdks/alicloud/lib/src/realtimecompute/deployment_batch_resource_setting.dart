...
class DeploymentBatchResourceSetting {
  ...
  final pulumi.Input<DeploymentBatchResourceSettingBasicResourceSetting>?
  ...
  DeploymentBatchResourceSetting({this.basicResourceSetting, this.maxSlot});
    ...
    return DeploymentBatchResourceSetting(
      basicResourceSetting: (() {
        ...
        return pulumi.Input.fromValue(
          DeploymentBatchResourceSettingBasicResourceSetting.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      maxSlot: (() {
        final guardedValue = map['maxSlot'];
        if (guardedValue == null) return null;
