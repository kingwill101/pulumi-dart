...
class DeploymentStreamingResourceSetting {
  ...
  factory DeploymentStreamingResourceSetting.fromMap(Map<String, dynamic> map) {
    return DeploymentStreamingResourceSetting(
      basicResourceSetting: (() { final guardedValue = map['basicResourceSetting']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DeploymentStreamingResourceSettingBasicResourceSetting.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      expertResourceSetting: (() { final guardedValue = map['expertResourceSetting']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DeploymentStreamingResourceSettingExpertResourceSetting.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      resourceSettingMode: (() { final guardedValue = map['resourceSettingMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
