...
class DeploymentArtifactPythonArtifact {
  ...
  factory DeploymentArtifactPythonArtifact.fromMap(Map<String, dynamic> map) {
    return DeploymentArtifactPythonArtifact(
      ...
      additionalPythonArchives: (() { final guardedValue = map['additionalPythonArchives']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      additionalPythonLibraries: (() { final guardedValue = map['additionalPythonLibraries']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      entryModule: (() { final guardedValue = map['entryModule']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      pythonArtifactUri: (() { final guardedValue = map['pythonArtifactUri']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
