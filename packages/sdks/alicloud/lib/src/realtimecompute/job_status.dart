...
class JobStatus {
  ...
  factory JobStatus.fromMap(Map<String, dynamic> map) {
    return JobStatus(
      currentJobStatus: (() { final guardedValue = map['currentJobStatus']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      failure: (() { final guardedValue = map['failure']; if (guardedValue == null) return null; return pulumi.Input.fromValue(JobStatusFailure.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      healthScore: (() { final guardedValue = map['healthScore']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      running: (() { final guardedValue = map['running']; if (guardedValue == null) return null; return pulumi.Input.fromValue(JobStatusRunning.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
