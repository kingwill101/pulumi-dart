    ...
    return <String, dynamic>{
      'jobmanagerResourceSettingSpec':
          ?pulumi.Input.mapOptionalInputValue<
            DeploymentBatchResourceSettingBasicResourceSettingJobmanagerResourceSettingSpec,
            Map<String, dynamic>
          >(jobmanagerResourceSettingSpec, (value) => value.toMap()),
      'parallelism': ?parallelism,
      'taskmanagerResourceSettingSpec':
          ?pulumi.Input.mapOptionalInputValue<
            DeploymentBatchResourceSettingBasicResourceSettingTaskmanagerResourceSettingSpec,
            Map<String, dynamic>
          >(taskmanagerResourceSettingSpec, (value) => value.toMap()),
    };
  }

  factory DeploymentBatchResourceSettingBasicResourceSetting.fromMap(
    Map<String, dynamic> map,
  ) {
    return DeploymentBatchResourceSettingBasicResourceSetting(
      jobmanagerResourceSettingSpec: (() {
        final guardedValue = map['jobmanagerResourceSettingSpec'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DeploymentBatchResourceSettingBasicResourceSettingJobmanagerResourceSettingSpec.fromMap(
      ...
      taskmanagerResourceSettingSpec: (() {
        final guardedValue = map['taskmanagerResourceSettingSpec'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DeploymentBatchResourceSettingBasicResourceSettingTaskmanagerResourceSettingSpec.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
