...
class DeploymentArgs {
  ...
  final pulumi.Input<DeploymentStreamingResourceSetting>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'artifact':
          pulumi.Input.mapInputValue<DeploymentArtifact, Map<String, dynamic>>(
            artifact,
            (value) => value.toMap(),
          ),
      'batchResourceSetting':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(batchResourceSetting, (value) => value.toMap()),
      'deploymentName': deploymentName,
      'deploymentTarget':
          pulumi.Input.mapInputValue<
            DeploymentDeploymentTarget,
            Map<String, dynamic>
          >(deploymentTarget, (value) => value.toMap()),
      'description': ?description,
      ...
      'streamingResourceSetting':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(streamingResourceSetting, (value) => value.toMap()),
    };
  }
  ...
  factory DeploymentArgs.fromMap(Map<String, dynamic> map) {
    return DeploymentArgs(
      artifact: pulumi.Input.fromValue(
        DeploymentArtifact.fromMap(
          (map['artifact']! as Map).cast<String, dynamic>(),
        ),
      ),
      batchResourceSetting: (() {
        final guardedValue = map['batchResourceSetting'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DeploymentBatchResourceSetting.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      deploymentName: pulumi.Input.fromValue(map['deploymentName'] as String),
      deploymentTarget: pulumi.Input.fromValue(
        DeploymentDeploymentTarget.fromMap(
          (map['deploymentTarget']! as Map).cast<String, dynamic>(),
        ),
      ),
      description: (() {
      ...
      flinkConf: (() {
        final guardedValue = map['flinkConf'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      localVariables: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DeploymentLocalVariable>(
            guardedValue,
            (value) => DeploymentLocalVariable.fromMap(
      ...
      streamingResourceSetting: (() {
        final guardedValue = map['streamingResourceSetting'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DeploymentStreamingResourceSetting.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
