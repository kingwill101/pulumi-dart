...
import 'dbaudit_instance_state.dart';
...
class DBAuditInstance extends pulumi.CustomResource {
  ...
  /// Gets an existing [DBAuditInstance] resource's state with the given [name] and [id].
  static DBAuditInstance get(
    String name,
    pulumi.Input<String> id, {
    DBAuditInstanceState? state,
  }) {
    return DBAuditInstance._get(
      name,
      state: state?.toMap(),
