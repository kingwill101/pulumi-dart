...
class JobTemplateState {
  ...
  factory JobTemplateState.fromMap(Map<String, dynamic> map) {
    return JobTemplateState(
      arrayRequest: (() {
        final guardedValue = map['arrayRequest'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      clockTime: (() {
        final guardedValue = map['clockTime'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      commandLine: (() {
      ...
      jobTemplateName: (() {
        final guardedValue = map['jobTemplateName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      mem: (() {
        final guardedValue = map['mem'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      node: (() {
      ...
      reRunable: (() {
        final guardedValue = map['reRunable'];
        if (guardedValue == null) return null;
      ...
      stderrRedirectPath: (() {
        final guardedValue = map['stderrRedirectPath'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      stdoutRedirectPath: (() {
        final guardedValue = map['stdoutRedirectPath'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      task: (() {
