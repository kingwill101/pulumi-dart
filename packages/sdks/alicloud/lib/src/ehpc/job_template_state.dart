...
class JobTemplateState {
  ...
  JobTemplateState({
    ...
    pulumi.Output<String>? jobTemplateName,
    ...
    pulumi.Output<String>? variables,
      ...
      jobTemplateName = pulumi.Input.asOptionalInput<String>(jobTemplateName),
  ...
  factory JobTemplateState.fromMap(Map<String, dynamic> map) {
    return JobTemplateState(
      ...
      jobTemplateName: map['jobTemplateName'] == null ? null : pulumi.Output.create<String>(map['jobTemplateName'] as String),
