...
class ClusterV2Args {
  ...
  factory ClusterV2Args.fromMap(Map<String, dynamic> map) {
    return ClusterV2Args(
      ...
      clusterCredentials: pulumi.Input.fromValue(ClusterV2ClusterCredentials.fromMap((map['clusterCredentials']! as Map).cast<String, dynamic>())),
      ...
      sharedStorages: pulumi.Input.fromValue(pulumi.Input.decodeList<ClusterV2SharedStorage>(map['sharedStorages']!, (value) => ClusterV2SharedStorage.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
