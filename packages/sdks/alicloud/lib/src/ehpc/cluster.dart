...
class Cluster extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<ClusterAdditionalVolume>?> additionalVolumes;
  /// The application. See `application` below.
  late final pulumi.Output<List<ClusterApplication>> applications;
  ...
  late final pulumi.Output<List<ClusterPostInstallScript>?> postInstallScripts;
  ...
  Cluster(
    ...
    this.additionalVolumes = registerOutput<List<ClusterAdditionalVolume>?>('additionalVolumes');
    this.applications = registerOutput<List<ClusterApplication>>('applications');
    ...
    this.computeEnableHt = registerOutput<bool?>('computeEnableHt');
    this.computeInstanceType = registerOutput<String>('computeInstanceType');
    this.computeSpotPriceLimit = registerOutput<String?>('computeSpotPriceLimit');
    this.computeSpotStrategy = registerOutput<String?>('computeSpotStrategy');
    this.deployMode = registerOutput<String>('deployMode');
    this.description = registerOutput<String>('description');
    this.domain = registerOutput<String?>('domain');
    this.ecsChargeType = registerOutput<String>('ecsChargeType');
    this.ehpcVersion = registerOutput<String>('ehpcVersion');
    this.haEnable = registerOutput<bool>('haEnable');
    this.imageId = registerOutput<String>('imageId');
    this.imageOwnerAlias = registerOutput<String>('imageOwnerAlias');
    this.inputFileUrl = registerOutput<String?>('inputFileUrl');
    this.isComputeEss = registerOutput<bool?>('isComputeEss');
    this.jobQueue = registerOutput<String?>('jobQueue');
    this.keyPairName = registerOutput<String?>('keyPairName');
    this.loginCount = registerOutput<int>('loginCount');
    this.loginInstanceType = registerOutput<String>('loginInstanceType');
    this.managerCount = registerOutput<int>('managerCount');
    this.managerInstanceType = registerOutput<String>('managerInstanceType');
    this.osTag = registerOutput<String>('osTag');
    this.password = registerOutput<String?>('password');
    this.period = registerOutput<int?>('period');
    this.periodUnit = registerOutput<String?>('periodUnit');
    this.plugin = registerOutput<String?>('plugin');
    this.postInstallScripts = registerOutput<List<ClusterPostInstallScript>?>('postInstallScripts');
    this.ramNodeTypes = registerOutput<List<String>?>('ramNodeTypes');
    this.ramRoleName = registerOutput<String?>('ramRoleName');
    this.releaseInstance = registerOutput<bool?>('releaseInstance');
    this.remoteDirectory = registerOutput<String>('remoteDirectory');
    this.remoteVisEnable = registerOutput<bool?>('remoteVisEnable');
    this.resourceGroupId = registerOutput<String?>('resourceGroupId');
    this.sccClusterId = registerOutput<String>('sccClusterId');
    this.schedulerType = registerOutput<String>('schedulerType');
    this.securityGroupId = registerOutput<String>('securityGroupId');
    this.securityGroupName = registerOutput<String?>('securityGroupName');
    this.status = registerOutput<String>('status');
    this.systemDiskLevel = registerOutput<String?>('systemDiskLevel');
    this.systemDiskSize = registerOutput<int?>('systemDiskSize');
    this.systemDiskType = registerOutput<String?>('systemDiskType');
    this.volumeId = registerOutput<String>('volumeId');
    this.volumeMountOption = registerOutput<String?>('volumeMountOption');
    this.volumeMountpoint = registerOutput<String>('volumeMountpoint');
    this.volumeProtocol = registerOutput<String>('volumeProtocol');
    this.volumeType = registerOutput<String>('volumeType');
    this.vpcId = registerOutput<String>('vpcId');
    this.vswitchId = registerOutput<String>('vswitchId');
    this.withoutAgent = registerOutput<bool?>('withoutAgent');
    this.withoutElasticIp = registerOutput<bool?>('withoutElasticIp');
