...
class QueueComputeNode {
  ...
  factory QueueComputeNode.fromMap(Map<String, dynamic> map) {
    return QueueComputeNode(
      ...
      systemDisk: (() { final guardedValue = map['systemDisk']; if (guardedValue == null) return null; return pulumi.Input.fromValue(QueueComputeNodeSystemDisk.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
