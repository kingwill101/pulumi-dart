...
class ClusterState {
  ...
  factory ClusterState.fromMap(Map<String, dynamic> map) {
    return ClusterState(
      ...
      additionalVolumes: map['additionalVolumes'] == null ? null : (pulumi.Input.decodeList<ClusterAdditionalVolume>(map['additionalVolumes']!, (value) => ClusterAdditionalVolume.fromMap((value as Map).cast<String, dynamic>()))).input(),
      applications: map['applications'] == null ? null : (pulumi.Input.decodeList<ClusterApplication>(map['applications']!, (value) => ClusterApplication.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      computeEnableHt: map['computeEnableHt'] == null ? null : (map['computeEnableHt']! as bool).input(),
      computeInstanceType: map['computeInstanceType'] == null ? null : (map['computeInstanceType']! as String).input(),
      computeSpotPriceLimit: map['computeSpotPriceLimit'] == null ? null : (map['computeSpotPriceLimit']! as String).input(),
      computeSpotStrategy: map['computeSpotStrategy'] == null ? null : (map['computeSpotStrategy']! as String).input(),
      deployMode: map['deployMode'] == null ? null : (map['deployMode']! as String).input(),
      description: map['description'] == null ? null : (map['description']! as String).input(),
      domain: map['domain'] == null ? null : (map['domain']! as String).input(),
      ecsChargeType: map['ecsChargeType'] == null ? null : (map['ecsChargeType']! as String).input(),
      ehpcVersion: map['ehpcVersion'] == null ? null : (map['ehpcVersion']! as String).input(),
      haEnable: map['haEnable'] == null ? null : (map['haEnable']! as bool).input(),
      imageId: map['imageId'] == null ? null : (map['imageId']! as String).input(),
      imageOwnerAlias: map['imageOwnerAlias'] == null ? null : (map['imageOwnerAlias']! as String).input(),
      inputFileUrl: map['inputFileUrl'] == null ? null : (map['inputFileUrl']! as String).input(),
      isComputeEss: map['isComputeEss'] == null ? null : (map['isComputeEss']! as bool).input(),
      ...
      loginCount: map['loginCount'] == null ? null : (map['loginCount']! as int).input(),
      loginInstanceType: map['loginInstanceType'] == null ? null : (map['loginInstanceType']! as String).input(),
      managerCount: map['managerCount'] == null ? null : (map['managerCount']! as int).input(),
      managerInstanceType: map['managerInstanceType'] == null ? null : (map['managerInstanceType']! as String).input(),
      osTag: map['osTag'] == null ? null : (map['osTag']! as String).input(),
      ...
      postInstallScripts: map['postInstallScripts'] == null ? null : (pulumi.Input.decodeList<ClusterPostInstallScript>(map['postInstallScripts']!, (value) => ClusterPostInstallScript.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ramNodeTypes: map['ramNodeTypes'] == null ? null : ((map['ramNodeTypes']! as List).cast<String>()).input(),
      ramRoleName: map['ramRoleName'] == null ? null : (map['ramRoleName']! as String).input(),
      releaseInstance: map['releaseInstance'] == null ? null : (map['releaseInstance']! as bool).input(),
      remoteDirectory: map['remoteDirectory'] == null ? null : (map['remoteDirectory']! as String).input(),
      remoteVisEnable: map['remoteVisEnable'] == null ? null : (map['remoteVisEnable']! as bool).input(),
      resourceGroupId: map['resourceGroupId'] == null ? null : (map['resourceGroupId']! as String).input(),
      sccClusterId: map['sccClusterId'] == null ? null : (map['sccClusterId']! as String).input(),
      ...
      systemDiskLevel: map['systemDiskLevel'] == null ? null : (map['systemDiskLevel']! as String).input(),
      systemDiskSize: map['systemDiskSize'] == null ? null : (map['systemDiskSize']! as int).input(),
      systemDiskType: map['systemDiskType'] == null ? null : (map['systemDiskType']! as String).input(),
      ...
      withoutAgent: map['withoutAgent'] == null ? null : (map['withoutAgent']! as bool).input(),
      withoutElasticIp: map['withoutElasticIp'] == null ? null : (map['withoutElasticIp']! as bool).input(),
