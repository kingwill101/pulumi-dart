...
class ClusterAdditionalVolume {
    ...
    return <String, dynamic>{
      ...
      'roles':
          ?pulumi.Input.mapOptionalInputValue<
            List<ClusterAdditionalVolumeRole>,
  ...
  factory ClusterAdditionalVolume.fromMap(Map<String, dynamic> map) {
    return ClusterAdditionalVolume(
      ...
      localDirectory: (() {
        final guardedValue = map['localDirectory'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      location: (() {
      ...
      roles: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ClusterAdditionalVolumeRole>(
            guardedValue,
            (value) => ClusterAdditionalVolumeRole.fromMap(
