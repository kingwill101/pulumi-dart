...
class ClusterV2State {
  ...
  factory ClusterV2State.fromMap(Map<String, dynamic> map) {
    return ClusterV2State(
      addons: (() { final guardedValue = map['addons']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ClusterV2Addon>(guardedValue, (value) => ClusterV2Addon.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      clusterCategory: (() { final guardedValue = map['clusterCategory']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      clusterCredentials: (() { final guardedValue = map['clusterCredentials']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterV2ClusterCredentials.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      clusterVpcId: (() { final guardedValue = map['clusterVpcId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      clusterVswitchId: (() { final guardedValue = map['clusterVswitchId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      createTime: (() { final guardedValue = map['createTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      deletionProtection: (() { final guardedValue = map['deletionProtection']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      manager: (() { final guardedValue = map['manager']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterV2Manager.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      sharedStorages: (() { final guardedValue = map['sharedStorages']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ClusterV2SharedStorage>(guardedValue, (value) => ClusterV2SharedStorage.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
