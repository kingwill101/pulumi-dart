...
class JobTemplate extends pulumi.CustomResource {
  ...
  JobTemplate(
    ...
    this.arrayRequest = registerOutput<String?>('arrayRequest');
    this.clockTime = registerOutput<String?>('clockTime');
    this.commandLine = registerOutput<String>('commandLine');
    this.gpu = registerOutput<int?>('gpu');
    this.jobTemplateName = registerOutput<String>('jobTemplateName');
    this.mem = registerOutput<String?>('mem');
    this.node = registerOutput<int?>('node');
    this.packagePath = registerOutput<String?>('packagePath');
    this.priority = registerOutput<int?>('priority');
    this.queue = registerOutput<String?>('queue');
    this.reRunable = registerOutput<bool>('reRunable');
    this.runasUser = registerOutput<String?>('runasUser');
    this.stderrRedirectPath = registerOutput<String?>('stderrRedirectPath');
    this.stdoutRedirectPath = registerOutput<String?>('stdoutRedirectPath');
    this.task = registerOutput<int?>('task');
    this.thread = registerOutput<int?>('thread');
    this.variables = registerOutput<String?>('variables');
  }
