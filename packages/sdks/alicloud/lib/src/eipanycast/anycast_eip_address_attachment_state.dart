...
class AnycastEipAddressAttachmentState {
  ...
  factory AnycastEipAddressAttachmentState.fromMap(Map<String, dynamic> map) {
    return AnycastEipAddressAttachmentState(
      anycastId: (() {
        final guardedValue = map['anycastId'];
      ...
      bindInstanceId: (() {
        final guardedValue = map['bindInstanceId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      bindInstanceRegionId: (() {
        final guardedValue = map['bindInstanceRegionId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      bindInstanceType: (() {
        final guardedValue = map['bindInstanceType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      bindTime: (() {
        final guardedValue = map['bindTime'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      popLocations: (() {
