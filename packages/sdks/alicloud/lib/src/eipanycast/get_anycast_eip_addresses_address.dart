...
class GetAnycastEipAddressesAddress {
  ...
  final pulumi.Input<List<GetAnycastEipAddressesAddressAnycastEipBindInfoList>>
  ...
  factory GetAnycastEipAddressesAddress.fromMap(Map<String, dynamic> map) {
    return GetAnycastEipAddressesAddress(
      ...
      anycastEipAddressName: pulumi.Input.fromValue(
        map['anycastEipAddressName'] as String,
      ),
      anycastEipBindInfoLists: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetAnycastEipAddressesAddressAnycastEipBindInfoList
        >(
          map['anycastEipBindInfoLists']!,
          (value) =>
              GetAnycastEipAddressesAddressAnycastEipBindInfoList.fromMap(
