...
class AnycastEipAddressAttachmentArgs {
  ...
  final pulumi.Input<List<AnycastEipAddressAttachmentPopLocation>>?
  popLocations;
    ...
    return <String, dynamic>{
      ...
      'popLocations':
          ?pulumi.Input.mapOptionalInputValue<
            List<AnycastEipAddressAttachmentPopLocation>,
  ...
  factory AnycastEipAddressAttachmentArgs.fromMap(Map<String, dynamic> map) {
    return AnycastEipAddressAttachmentArgs(
      ...
      associationMode: (() {
        final guardedValue = map['associationMode'];
      ...
      popLocations: (() {
        final guardedValue = map['popLocations'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AnycastEipAddressAttachmentPopLocation>(
            guardedValue,
            (value) => AnycastEipAddressAttachmentPopLocation.fromMap(
