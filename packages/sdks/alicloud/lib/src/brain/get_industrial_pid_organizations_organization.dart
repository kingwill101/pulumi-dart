...
class GetIndustrialPidOrganizationsOrganization {
  ...
  factory GetIndustrialPidOrganizationsOrganization.fromMap(Map<String, dynamic> map) {
    return GetIndustrialPidOrganizationsOrganization(
      ...
      parentPidOrganizationId: pulumi.Input.fromValue(map['parentPidOrganizationId'] as String),
      pidOrganizationId: pulumi.Input.fromValue(map['pidOrganizationId'] as String),
      pidOrganizationLevel: pulumi.Input.fromValue(map['pidOrganizationLevel'] as int),
      pidOrganizationName: pulumi.Input.fromValue(map['pidOrganizationName'] as String),
    );
  }
}
