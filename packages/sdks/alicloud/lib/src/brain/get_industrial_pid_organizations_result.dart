...
class GetIndustrialPidOrganizationsResult {
  ...
  factory GetIndustrialPidOrganizationsResult.fromMap(
    ...
    return GetIndustrialPidOrganizationsResult(
      ...
      organizations:
          pulumi.Input.decodeList<GetIndustrialPidOrganizationsOrganization>(
            map['organizations']!,
            (value) => GetIndustrialPidOrganizationsOrganization.fromMap(
