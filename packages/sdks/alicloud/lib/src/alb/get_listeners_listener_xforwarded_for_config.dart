...
class GetListenersListenerXforwardedForConfig {
  ...
  factory GetListenersListenerXforwardedForConfig.fromMap(Map<String, dynamic> map) {
    return GetListenersListenerXforwardedForConfig(
      xforwardedforclientcertIssuerdnalias: pulumi.Input.fromValue(map['xforwardedforclientcertIssuerdnalias'] as String),
      xforwardedforclientcertIssuerdnenabled: pulumi.Input.fromValue(map['xforwardedforclientcertIssuerdnenabled'] as bool),
      xforwardedforclientcertclientverifyalias: pulumi.Input.fromValue(map['xforwardedforclientcertclientverifyalias'] as String),
      xforwardedforclientcertclientverifyenabled: pulumi.Input.fromValue(map['xforwardedforclientcertclientverifyenabled'] as bool),
      xforwardedforclientcertfingerprintalias: pulumi.Input.fromValue(map['xforwardedforclientcertfingerprintalias'] as String),
      xforwardedforclientcertfingerprintenabled: pulumi.Input.fromValue(map['xforwardedforclientcertfingerprintenabled'] as bool),
      xforwardedforclientcertsubjectdnalias: pulumi.Input.fromValue(map['xforwardedforclientcertsubjectdnalias'] as String),
      xforwardedforclientcertsubjectdnenabled: pulumi.Input.fromValue(map['xforwardedforclientcertsubjectdnenabled'] as bool),
      xforwardedforclientsrcportenabled: pulumi.Input.fromValue(map['xforwardedforclientsrcportenabled'] as bool),
      xforwardedforenabled: pulumi.Input.fromValue(map['xforwardedforenabled'] as bool),
      xforwardedforprotoenabled: pulumi.Input.fromValue(map['xforwardedforprotoenabled'] as bool),
      xforwardedforslbidenabled: pulumi.Input.fromValue(map['xforwardedforslbidenabled'] as bool),
      xforwardedforslbportenabled: pulumi.Input.fromValue(map['xforwardedforslbportenabled'] as bool),
    );
  }
}
