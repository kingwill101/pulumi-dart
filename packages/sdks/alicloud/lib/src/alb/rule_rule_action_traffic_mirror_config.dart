...
class RuleRuleActionTrafficMirrorConfig {
  ...
  final pulumi.Input<RuleRuleActionTrafficMirrorConfigMirrorGroupConfig>?
  mirrorGroupConfig;
  ...
  RuleRuleActionTrafficMirrorConfig({this.mirrorGroupConfig, this.targetType});
    ...
    return <String, dynamic>{
      'mirrorGroupConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(mirrorGroupConfig, (value) => value.toMap()),
  ...
  factory RuleRuleActionTrafficMirrorConfig.fromMap(Map<String, dynamic> map) {
    return RuleRuleActionTrafficMirrorConfig(
      mirrorGroupConfig: (() {
        final guardedValue = map['mirrorGroupConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RuleRuleActionTrafficMirrorConfigMirrorGroupConfig.fromMap(
