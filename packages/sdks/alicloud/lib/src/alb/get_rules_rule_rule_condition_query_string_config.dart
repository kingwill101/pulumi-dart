...
class GetRulesRuleRuleConditionQueryStringConfig {
  ...
  final pulumi.Input<List<GetRulesRuleRuleConditionQueryStringConfigValue>>
  values;

  /// Creates a new [GetRulesRuleRuleConditionQueryStringConfig].
  /// [values] Add one or more IP addresses or IP address segments.
  GetRulesRuleRuleConditionQueryStringConfig({required this.values});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'values':
          pulumi.Input.mapInputValue<
            List<GetRulesRuleRuleConditionQueryStringConfigValue>,
  ...
  factory GetRulesRuleRuleConditionQueryStringConfig.fromMap(
    Map<String, dynamic> map,
  ) {
    return GetRulesRuleRuleConditionQueryStringConfig(
      values: pulumi.Input.fromValue(
        pulumi
            .Input.decodeList<GetRulesRuleRuleConditionQueryStringConfigValue>(
          map['values']!,
          (value) => GetRulesRuleRuleConditionQueryStringConfigValue.fromMap(
