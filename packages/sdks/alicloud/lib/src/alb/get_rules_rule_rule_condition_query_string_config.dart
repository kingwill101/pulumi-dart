...
class GetRulesRuleRuleConditionQueryStringConfig {
  ...
  factory GetRulesRuleRuleConditionQueryStringConfig.fromMap(Map<String, dynamic> map) {
    return GetRulesRuleRuleConditionQueryStringConfig(
      values: (pulumi.Input.decodeList<GetRulesRuleRuleConditionQueryStringConfigValue>(map['values'], (value) => GetRulesRuleRuleConditionQueryStringConfigValue.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
