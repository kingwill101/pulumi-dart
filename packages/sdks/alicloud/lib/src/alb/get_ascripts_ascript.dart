...
class GetAscriptsAscript {
  ...
  factory GetAscriptsAscript.fromMap(Map<String, dynamic> map) {
    return GetAscriptsAscript(
      ...
      extAttributeEnabled: pulumi.Input.fromValue(map['extAttributeEnabled'] as bool),
      extAttributes: pulumi.Input.fromValue(pulumi.Input.decodeList<GetAscriptsAscriptExtAttribute>(map['extAttributes']!, (value) => GetAscriptsAscriptExtAttribute.fromMap((value as Map).cast<String, dynamic>()))),
