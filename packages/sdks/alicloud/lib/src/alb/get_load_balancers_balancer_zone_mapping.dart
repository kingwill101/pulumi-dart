...
class GetLoadBalancersBalancerZoneMapping {
  ...
  final pulumi.Input<
    List<GetLoadBalancersBalancerZoneMappingLoadBalancerAddress>
  >
  ...
  factory GetLoadBalancersBalancerZoneMapping.fromMap(
    Map<String, dynamic> map,
  ) {
    return GetLoadBalancersBalancerZoneMapping(
      loadBalancerAddresses: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetLoadBalancersBalancerZoneMappingLoadBalancerAddress
        >(
          map['loadBalancerAddresses']!,
          (value) =>
              GetLoadBalancersBalancerZoneMappingLoadBalancerAddress.fromMap(
