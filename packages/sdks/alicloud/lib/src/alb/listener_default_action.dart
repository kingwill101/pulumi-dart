...
class ListenerDefaultAction {
  ...
  final pulumi.Input<ListenerDefaultActionForwardGroupConfig>?
  forwardGroupConfig;
  ...
  ListenerDefaultAction({this.forwardGroupConfig, required this.type});
    ...
    return ListenerDefaultAction(
      forwardGroupConfig: (() {
        ...
        return pulumi.Input.fromValue(
          ListenerDefaultActionForwardGroupConfig.fromMap(
