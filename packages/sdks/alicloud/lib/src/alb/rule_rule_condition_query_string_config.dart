...
class RuleRuleConditionQueryStringConfig {
  ...
  final List<RuleRuleConditionQueryStringConfigValue>? values;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'values': ?values == null ? null : pulumi.Input.encodeList<RuleRuleConditionQueryStringConfigValue, Map<String, dynamic>>(values!, (value) => value.toMap()),
    };
  }

  factory RuleRuleConditionQueryStringConfig.fromMap(Map<String, dynamic> map) {
    return RuleRuleConditionQueryStringConfig(
      values: map['values'] == null ? null : pulumi.Input.decodeList<RuleRuleConditionQueryStringConfigValue>(map['values'], (value) => RuleRuleConditionQueryStringConfigValue.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
