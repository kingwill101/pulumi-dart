...
class ListenerDefaultActionForwardGroupConfig {
  ...
  final List<ListenerDefaultActionForwardGroupConfigServerGroupTuple> serverGroupTuples;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'serverGroupTuples': pulumi.Input.encodeList<ListenerDefaultActionForwardGroupConfigServerGroupTuple, Map<String, dynamic>>(serverGroupTuples, (value) => value.toMap()),
    };
  }
  ...
  factory ListenerDefaultActionForwardGroupConfig.fromMap(Map<String, dynamic> map) {
    return ListenerDefaultActionForwardGroupConfig(
      serverGroupTuples: pulumi.Input.decodeList<ListenerDefaultActionForwardGroupConfigServerGroupTuple>(map['serverGroupTuples'], (value) => ListenerDefaultActionForwardGroupConfigServerGroupTuple.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
