...
class ListenerDefaultActionForwardGroupConfig {
  ...
  factory ListenerDefaultActionForwardGroupConfig.fromMap(Map<String, dynamic> map) {
    return ListenerDefaultActionForwardGroupConfig(
      serverGroupTuples: pulumi.Input.fromValue(pulumi.Input.decodeList<ListenerDefaultActionForwardGroupConfigServerGroupTuple>(map['serverGroupTuples']!, (value) => ListenerDefaultActionForwardGroupConfigServerGroupTuple.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
