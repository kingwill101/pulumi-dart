...
class LoadBalancerState {
  ...
  factory LoadBalancerState.fromMap(Map<String, dynamic> map) {
    return LoadBalancerState(
      ...
      loadBalancerBillingConfig: (() { final guardedValue = map['loadBalancerBillingConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LoadBalancerLoadBalancerBillingConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      loadBalancerEdition: (() { final guardedValue = map['loadBalancerEdition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
