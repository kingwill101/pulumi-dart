...
class RuleRuleCondition {
  ...
  final pulumi.Input<RuleRuleConditionResponseHeaderConfig>?
  responseHeaderConfig;

  /// The configuration of the header field. See `response_status_code_config` below.
  final pulumi.Input<RuleRuleConditionResponseStatusCodeConfig>?
    ...
    return <String, dynamic>{
      'cookieConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(cookieConfig, (value) => value.toMap()),
      'headerConfig':
          ?pulumi.Input.mapOptionalInputValue<
            RuleRuleConditionHeaderConfig,
            Map<String, dynamic>
          >(headerConfig, (value) => value.toMap()),
      'hostConfig':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'methodConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(methodConfig, (value) => value.toMap()),
      'pathConfig':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'queryStringConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(queryStringConfig, (value) => value.toMap()),
      'responseHeaderConfig':
          ?pulumi.Input.mapOptionalInputValue<
            RuleRuleConditionResponseHeaderConfig,
            Map<String, dynamic>
          >(responseHeaderConfig, (value) => value.toMap()),
      'responseStatusCodeConfig':
          ?pulumi.Input.mapOptionalInputValue<
            RuleRuleConditionResponseStatusCodeConfig,
            Map<String, dynamic>
          >(responseStatusCodeConfig, (value) => value.toMap()),
      'sourceIpConfig':
          ?pulumi.Input.mapOptionalInputValue<
  ...
  factory RuleRuleCondition.fromMap(Map<String, dynamic> map) {
    return RuleRuleCondition(
      cookieConfig: (() {
        final guardedValue = map['cookieConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RuleRuleConditionCookieConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      headerConfig: (() {
        final guardedValue = map['headerConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RuleRuleConditionHeaderConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      hostConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RuleRuleConditionHostConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      methodConfig: (() {
        final guardedValue = map['methodConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RuleRuleConditionMethodConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      pathConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RuleRuleConditionPathConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      queryStringConfig: (() {
        final guardedValue = map['queryStringConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RuleRuleConditionQueryStringConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      responseHeaderConfig: (() {
        final guardedValue = map['responseHeaderConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RuleRuleConditionResponseHeaderConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      responseStatusCodeConfig: (() {
        final guardedValue = map['responseStatusCodeConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RuleRuleConditionResponseStatusCodeConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      sourceIpConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RuleRuleConditionSourceIpConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
