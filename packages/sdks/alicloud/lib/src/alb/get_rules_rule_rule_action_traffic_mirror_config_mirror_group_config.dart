...
class GetRulesRuleRuleActionTrafficMirrorConfigMirrorGroupConfig {
  ...
  factory GetRulesRuleRuleActionTrafficMirrorConfigMirrorGroupConfig.fromMap(Map<String, dynamic> map) {
    return GetRulesRuleRuleActionTrafficMirrorConfigMirrorGroupConfig(
      serverGroupTuples: pulumi.Input.fromValue(pulumi.Input.decodeList<GetRulesRuleRuleActionTrafficMirrorConfigMirrorGroupConfigServerGroupTuple>(map['serverGroupTuples']!, (value) => GetRulesRuleRuleActionTrafficMirrorConfigMirrorGroupConfigServerGroupTuple.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
