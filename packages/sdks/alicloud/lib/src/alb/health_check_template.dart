...
class HealthCheckTemplate extends pulumi.CustomResource {
  ...
  HealthCheckTemplate(
    ...
    healthCheckCodes = registerOutput<List<String>>('healthCheckCodes');
    healthCheckConnectPort = registerOutput<int>('healthCheckConnectPort');
    healthCheckHost = registerOutput<String>('healthCheckHost');
    healthCheckHttpVersion = registerOutput<String>('healthCheckHttpVersion');
    ...
    healthCheckTemplateName = registerOutput<String>('healthCheckTemplateName');
