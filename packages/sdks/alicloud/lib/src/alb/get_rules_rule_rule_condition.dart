...
class GetRulesRuleRuleCondition {
  ...
  final pulumi.Input<List<GetRulesRuleRuleConditionQueryStringConfig>>
  queryStringConfigs;

  /// The Based on source IP traffic matching.
  final pulumi.Input<List<GetRulesRuleRuleConditionSourceIpConfig>>
  sourceIpConfigs;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'headerConfigs':
          pulumi.Input.mapInputValue<
            List<GetRulesRuleRuleConditionHeaderConfig>,
            List<Map<String, dynamic>>
          >(
            headerConfigs,
            (value) =>
      ...
      'hostConfigs':
          pulumi.Input.mapInputValue<
            List<GetRulesRuleRuleConditionHostConfig>,
            List<Map<String, dynamic>>
          >(
            hostConfigs,
            (value) =>
      ...
      'methodConfigs':
          pulumi.Input.mapInputValue<
            List<GetRulesRuleRuleConditionMethodConfig>,
            List<Map<String, dynamic>>
          >(
            methodConfigs,
            (value) =>
      ...
      'pathConfigs':
          pulumi.Input.mapInputValue<
            List<GetRulesRuleRuleConditionPathConfig>,
            List<Map<String, dynamic>>
          >(
            pathConfigs,
            (value) =>
      ...
      'queryStringConfigs':
          pulumi.Input.mapInputValue<
            List<GetRulesRuleRuleConditionQueryStringConfig>,
            List<Map<String, dynamic>>
          >(
            queryStringConfigs,
            (value) =>
      ...
      'sourceIpConfigs':
          pulumi.Input.mapInputValue<
            List<GetRulesRuleRuleConditionSourceIpConfig>,
            List<Map<String, dynamic>>
          >(
            sourceIpConfigs,
            (value) =>
  ...
  factory GetRulesRuleRuleCondition.fromMap(Map<String, dynamic> map) {
    return GetRulesRuleRuleCondition(
      cookieConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetRulesRuleRuleConditionCookieConfig>(
          map['cookieConfigs']!,
          (value) => GetRulesRuleRuleConditionCookieConfig.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      headerConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetRulesRuleRuleConditionHeaderConfig>(
          map['headerConfigs']!,
          (value) => GetRulesRuleRuleConditionHeaderConfig.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      hostConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetRulesRuleRuleConditionHostConfig>(
          map['hostConfigs']!,
          (value) => GetRulesRuleRuleConditionHostConfig.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      methodConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetRulesRuleRuleConditionMethodConfig>(
          map['methodConfigs']!,
          (value) => GetRulesRuleRuleConditionMethodConfig.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      pathConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetRulesRuleRuleConditionPathConfig>(
          map['pathConfigs']!,
          (value) => GetRulesRuleRuleConditionPathConfig.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      queryStringConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetRulesRuleRuleConditionQueryStringConfig>(
          map['queryStringConfigs']!,
          (value) => GetRulesRuleRuleConditionQueryStringConfig.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      sourceIpConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetRulesRuleRuleConditionSourceIpConfig>(
          map['sourceIpConfigs']!,
          (value) => GetRulesRuleRuleConditionSourceIpConfig.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
