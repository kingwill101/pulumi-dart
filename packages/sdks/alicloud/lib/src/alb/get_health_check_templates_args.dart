...
class GetHealthCheckTemplatesArgs {
  ...
  factory GetHealthCheckTemplatesArgs.fromMap(Map<String, dynamic> map) {
    return GetHealthCheckTemplatesArgs(
      healthCheckTemplateIds: (() { final guardedValue = map['healthCheckTemplateIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      healthCheckTemplateName: (() { final guardedValue = map['healthCheckTemplateName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
