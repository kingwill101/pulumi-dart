...
class GetServerGroupsGroup {
  ...
  factory GetServerGroupsGroup.fromMap(Map<String, dynamic> map) {
    return GetServerGroupsGroup(
      healthCheckConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetServerGroupsGroupHealthCheckConfig>(map['healthCheckConfigs']!, (value) => GetServerGroupsGroupHealthCheckConfig.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      servers: pulumi.Input.fromValue(pulumi.Input.decodeList<GetServerGroupsGroupServer>(map['servers']!, (value) => GetServerGroupsGroupServer.fromMap((value as Map).cast<String, dynamic>()))),
      status: pulumi.Input.fromValue(map['status'] as String),
      stickySessionConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetServerGroupsGroupStickySessionConfig>(map['stickySessionConfigs']!, (value) => GetServerGroupsGroupStickySessionConfig.fromMap((value as Map).cast<String, dynamic>()))),
