...
class GetListenersListenerDefaultAction {
  ...
  final pulumi.Input<List<GetListenersListenerDefaultActionForwardGroupConfig>> forwardGroupConfigs;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'forwardGroupConfigs': pulumi.Input.mapInputValue<List<GetListenersListenerDefaultActionForwardGroupConfig>, List<Map<String, dynamic>>>(forwardGroupConfigs, (value) => pulumi.Input.encodeList<GetListenersListenerDefaultActionForwardGroupConfig, Map<String, dynamic>>(value, (value) => value.toMap())),
      'type': type,
    };
  }
  ...
  factory GetListenersListenerDefaultAction.fromMap(Map<String, dynamic> map) {
    return GetListenersListenerDefaultAction(
      forwardGroupConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetListenersListenerDefaultActionForwardGroupConfig>(map['forwardGroupConfigs']!, (value) => GetListenersListenerDefaultActionForwardGroupConfig.fromMap((value as Map).cast<String, dynamic>()))),
