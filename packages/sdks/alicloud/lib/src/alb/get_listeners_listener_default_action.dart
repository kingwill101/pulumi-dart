...
class GetListenersListenerDefaultAction {
  ...
  factory GetListenersListenerDefaultAction.fromMap(Map<String, dynamic> map) {
    return GetListenersListenerDefaultAction(
      forwardGroupConfigs: (pulumi.Input.decodeList<GetListenersListenerDefaultActionForwardGroupConfig>(map['forwardGroupConfigs'], (value) => GetListenersListenerDefaultActionForwardGroupConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
