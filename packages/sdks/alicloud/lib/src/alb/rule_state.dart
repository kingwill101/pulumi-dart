...
class RuleState {
  ...
  factory RuleState.fromMap(Map<String, dynamic> map) {
    return RuleState(
      ...
      ruleActions: (() { final guardedValue = map['ruleActions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RuleRuleAction>(guardedValue, (value) => RuleRuleAction.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ruleConditions: (() { final guardedValue = map['ruleConditions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RuleRuleCondition>(guardedValue, (value) => RuleRuleCondition.fromMap((value as Map).cast<String, dynamic>()))); })(),
