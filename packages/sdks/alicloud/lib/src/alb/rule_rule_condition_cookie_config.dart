...
class RuleRuleConditionCookieConfig {
  ...
  RuleRuleConditionCookieConfig({this.values});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'values':
          ?pulumi.Input.mapOptionalInputValue<
            List<RuleRuleConditionCookieConfigValue>,
    ...
    return RuleRuleConditionCookieConfig(
      values: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RuleRuleConditionCookieConfigValue>(
            guardedValue,
            (value) => RuleRuleConditionCookieConfigValue.fromMap(
