...
class RuleRuleConditionCookieConfig {
  ...
  factory RuleRuleConditionCookieConfig.fromMap(Map<String, dynamic> map) {
    return RuleRuleConditionCookieConfig(
      values: (() { final guardedValue = map['values']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RuleRuleConditionCookieConfigValue>(guardedValue, (value) => RuleRuleConditionCookieConfigValue.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
