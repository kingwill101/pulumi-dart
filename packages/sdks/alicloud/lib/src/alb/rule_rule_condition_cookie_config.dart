...
class RuleRuleConditionCookieConfig {
  ...
  final List<RuleRuleConditionCookieConfigValue>? values;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'values': ?values == null ? null : pulumi.Input.encodeList<RuleRuleConditionCookieConfigValue, Map<String, dynamic>>(values!, (value) => value.toMap()),
    };
  }

  factory RuleRuleConditionCookieConfig.fromMap(Map<String, dynamic> map) {
    return RuleRuleConditionCookieConfig(
      values: map['values'] == null ? null : pulumi.Input.decodeList<RuleRuleConditionCookieConfigValue>(map['values'], (value) => RuleRuleConditionCookieConfigValue.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
