...
class RuleRuleActionTrafficMirrorConfigMirrorGroupConfig {
  ...
  const RuleRuleActionTrafficMirrorConfigMirrorGroupConfig({
  ...
  factory RuleRuleActionTrafficMirrorConfigMirrorGroupConfig.fromMap(Map<String, dynamic> map) {
    return RuleRuleActionTrafficMirrorConfigMirrorGroupConfig(
      serverGroupTuples: (() { final guardedValue = map['serverGroupTuples']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RuleRuleActionTrafficMirrorConfigMirrorGroupConfigServerGroupTuple>(guardedValue, (value) => RuleRuleActionTrafficMirrorConfigMirrorGroupConfigServerGroupTuple.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
