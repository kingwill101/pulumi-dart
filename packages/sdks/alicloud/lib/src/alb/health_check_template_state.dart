...
class HealthCheckTemplateState {
  ...
  /// Creates a new [HealthCheckTemplateState].
  ...
  const HealthCheckTemplateState({
    this.dryRun,
  ...
  factory HealthCheckTemplateState.fromMap(Map<String, dynamic> map) {
    return HealthCheckTemplateState(
      dryRun: (() { final guardedValue = map['dryRun']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      healthCheckCodes: (() { final guardedValue = map['healthCheckCodes']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      ...
      healthCheckHttpVersion: (() { final guardedValue = map['healthCheckHttpVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
