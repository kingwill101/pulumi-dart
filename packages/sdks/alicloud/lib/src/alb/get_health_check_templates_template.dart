...
class GetHealthCheckTemplatesTemplate {
  ...
  factory GetHealthCheckTemplatesTemplate.fromMap(Map<String, dynamic> map) {
    return GetHealthCheckTemplatesTemplate(
      healthCheckCodes: pulumi.Input.fromValue((map['healthCheckCodes'] as List).cast<String>()),
      ...
      healthCheckHttpVersion: pulumi.Input.fromValue(map['healthCheckHttpVersion'] as String),
      healthCheckInterval: pulumi.Input.fromValue(map['healthCheckInterval'] as int),
      healthCheckMethod: pulumi.Input.fromValue(map['healthCheckMethod'] as String),
      ...
      healthCheckTemplateId: pulumi.Input.fromValue(map['healthCheckTemplateId'] as String),
      healthCheckTemplateName: pulumi.Input.fromValue(map['healthCheckTemplateName'] as String),
