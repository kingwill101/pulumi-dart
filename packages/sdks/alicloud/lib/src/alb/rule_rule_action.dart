...
class RuleRuleAction {
  ...
  factory RuleRuleAction.fromMap(Map<String, dynamic> map) {
    return RuleRuleAction(
      corsConfig: (() { final guardedValue = map['corsConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RuleRuleActionCorsConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      fixedResponseConfig: (() { final guardedValue = map['fixedResponseConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RuleRuleActionFixedResponseConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      forwardGroupConfig: (() { final guardedValue = map['forwardGroupConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RuleRuleActionForwardGroupConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      insertHeaderConfig: (() { final guardedValue = map['insertHeaderConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RuleRuleActionInsertHeaderConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      order: pulumi.Input.fromValue(map['order'] as int),
      redirectConfig: (() { final guardedValue = map['redirectConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RuleRuleActionRedirectConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      removeHeaderConfig: (() { final guardedValue = map['removeHeaderConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RuleRuleActionRemoveHeaderConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      rewriteConfig: (() { final guardedValue = map['rewriteConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RuleRuleActionRewriteConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      trafficLimitConfig: (() { final guardedValue = map['trafficLimitConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RuleRuleActionTrafficLimitConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      trafficMirrorConfig: (() { final guardedValue = map['trafficMirrorConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RuleRuleActionTrafficMirrorConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
