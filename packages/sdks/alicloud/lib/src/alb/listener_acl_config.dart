...
class ListenerAclConfig {
  ...
  ListenerAclConfig({this.aclRelations, this.aclType});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'aclRelations':
          ?pulumi.Input.mapOptionalInputValue<
            List<ListenerAclConfigAclRelation>,
  ...
  factory ListenerAclConfig.fromMap(Map<String, dynamic> map) {
    return ListenerAclConfig(
      aclRelations: (() {
        final guardedValue = map['aclRelations'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ListenerAclConfigAclRelation>(
            guardedValue,
            (value) => ListenerAclConfigAclRelation.fromMap(
