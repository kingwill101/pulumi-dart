...
class GetListenersListenerAclConfig {
  ...
  final List<GetListenersListenerAclConfigAclRelation> aclRelations;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'aclRelations': pulumi.Input.encodeList<GetListenersListenerAclConfigAclRelation, Map<String, dynamic>>(aclRelations, (value) => value.toMap()),
      'aclType': aclType,
    };
  }
  ...
  factory GetListenersListenerAclConfig.fromMap(Map<String, dynamic> map) {
    return GetListenersListenerAclConfig(
      aclRelations: pulumi.Input.decodeList<GetListenersListenerAclConfigAclRelation>(map['aclRelations'], (value) => GetListenersListenerAclConfigAclRelation.fromMap((value as Map).cast<String, dynamic>())),
