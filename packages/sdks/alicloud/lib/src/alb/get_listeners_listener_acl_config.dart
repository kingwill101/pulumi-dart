...
class GetListenersListenerAclConfig {
  ...
  final pulumi.Input<List<GetListenersListenerAclConfigAclRelation>>
  aclRelations;
    ...
    return <String, dynamic>{
      'aclRelations':
          pulumi.Input.mapInputValue<
            List<GetListenersListenerAclConfigAclRelation>,
  ...
  factory GetListenersListenerAclConfig.fromMap(Map<String, dynamic> map) {
    return GetListenersListenerAclConfig(
      aclRelations: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetListenersListenerAclConfigAclRelation>(
          map['aclRelations']!,
          (value) => GetListenersListenerAclConfigAclRelation.fromMap(
