...
class GetListenersListenerAclConfig {
  ...
  factory GetListenersListenerAclConfig.fromMap(Map<String, dynamic> map) {
    return GetListenersListenerAclConfig(
      aclRelations: (pulumi.Input.decodeList<GetListenersListenerAclConfigAclRelation>(map['aclRelations'], (value) => GetListenersListenerAclConfigAclRelation.fromMap((value as Map).cast<String, dynamic>()))).input(),
