...
class GetRulesRuleRuleConditionCookieConfig {
  ...
  factory GetRulesRuleRuleConditionCookieConfig.fromMap(Map<String, dynamic> map) {
    return GetRulesRuleRuleConditionCookieConfig(
      values: pulumi.Input.fromValue(pulumi.Input.decodeList<GetRulesRuleRuleConditionCookieConfigValue>(map['values']!, (value) => GetRulesRuleRuleConditionCookieConfigValue.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
