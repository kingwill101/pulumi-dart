...
class GetLoadBalancersBalancer {
  ...
  factory GetLoadBalancersBalancer.fromMap(Map<String, dynamic> map) {
    return GetLoadBalancersBalancer(
      accessLogConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetLoadBalancersBalancerAccessLogConfig>(map['accessLogConfigs']!, (value) => GetLoadBalancersBalancerAccessLogConfig.fromMap((value as Map).cast<String, dynamic>()))),
      addressAllocatedMode: pulumi.Input.fromValue(map['addressAllocatedMode'] as String),
      ...
      deletionProtectionConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetLoadBalancersBalancerDeletionProtectionConfig>(map['deletionProtectionConfigs']!, (value) => GetLoadBalancersBalancerDeletionProtectionConfig.fromMap((value as Map).cast<String, dynamic>()))),
      dnsName: pulumi.Input.fromValue(map['dnsName'] as String),
      id: pulumi.Input.fromValue(map['id'] as String),
      loadBalancerBillingConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetLoadBalancersBalancerLoadBalancerBillingConfig>(map['loadBalancerBillingConfigs']!, (value) => GetLoadBalancersBalancerLoadBalancerBillingConfig.fromMap((value as Map).cast<String, dynamic>()))),
      loadBalancerBusinessStatus: pulumi.Input.fromValue(map['loadBalancerBusinessStatus'] as String),
      loadBalancerBussinessStatus: pulumi.Input.fromValue(map['loadBalancerBussinessStatus'] as String),
      ...
      loadBalancerOperationLocks: pulumi.Input.fromValue(pulumi.Input.decodeList<GetLoadBalancersBalancerLoadBalancerOperationLock>(map['loadBalancerOperationLocks']!, (value) => GetLoadBalancersBalancerLoadBalancerOperationLock.fromMap((value as Map).cast<String, dynamic>()))),
      modificationProtectionConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetLoadBalancersBalancerModificationProtectionConfig>(map['modificationProtectionConfigs']!, (value) => GetLoadBalancersBalancerModificationProtectionConfig.fromMap((value as Map).cast<String, dynamic>()))),
