...
class GetListenersListener {
  ...
  final pulumi.Input<List<GetListenersListenerAccessLogTracingConfig>>
  ...
  final pulumi.Input<List<GetListenersListenerXforwardedForConfig>>
    ...
    return <String, dynamic>{
      ...
      'accessLogTracingConfigs':
          pulumi.Input.mapInputValue<
            List<GetListenersListenerAccessLogTracingConfig>,
      ...
      'aclConfigs':
          pulumi.Input.mapInputValue<
            List<GetListenersListenerAclConfig>,
            List<Map<String, dynamic>>
          >(
            aclConfigs,
            (value) =>
      ...
      'defaultActions':
          pulumi.Input.mapInputValue<
            List<GetListenersListenerDefaultAction>,
            List<Map<String, dynamic>>
          >(
            defaultActions,
            (value) =>
      ...
      'quicConfigs':
          pulumi.Input.mapInputValue<
            List<GetListenersListenerQuicConfig>,
            List<Map<String, dynamic>>
          >(
            quicConfigs,
            (value) =>
      ...
      'xforwardedForConfigs':
          pulumi.Input.mapInputValue<
            List<GetListenersListenerXforwardedForConfig>,
            List<Map<String, dynamic>>
          >(
            xforwardedForConfigs,
            (value) =>
  ...
  factory GetListenersListener.fromMap(Map<String, dynamic> map) {
    return GetListenersListener(
      accessLogRecordCustomizedHeadersEnabled: pulumi.Input.fromValue(
        map['accessLogRecordCustomizedHeadersEnabled'] as bool,
      ),
      accessLogTracingConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetListenersListenerAccessLogTracingConfig>(
          map['accessLogTracingConfigs']!,
          (value) => GetListenersListenerAccessLogTracingConfig.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      aclConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetListenersListenerAclConfig>(
          map['aclConfigs']!,
          (value) => GetListenersListenerAclConfig.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      ...
      defaultActions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetListenersListenerDefaultAction>(
          map['defaultActions']!,
          (value) => GetListenersListenerDefaultAction.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      ...
      quicConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetListenersListenerQuicConfig>(
          map['quicConfigs']!,
          (value) => GetListenersListenerQuicConfig.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      ...
      xforwardedForConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetListenersListenerXforwardedForConfig>(
          map['xforwardedForConfigs']!,
          (value) => GetListenersListenerXforwardedForConfig.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
