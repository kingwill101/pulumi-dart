...
class ListenerState {
  ...
  factory ListenerState.fromMap(Map<String, dynamic> map) {
    return ListenerState(
      accessLogRecordCustomizedHeadersEnabled: map['accessLogRecordCustomizedHeadersEnabled'] == null ? null : (map['accessLogRecordCustomizedHeadersEnabled']! as bool).input(),
      accessLogTracingConfig: map['accessLogTracingConfig'] == null ? null : (ListenerAccessLogTracingConfig.fromMap((map['accessLogTracingConfig']! as Map).cast<String, dynamic>())).input(),
      aclConfig: map['aclConfig'] == null ? null : (ListenerAclConfig.fromMap((map['aclConfig']! as Map).cast<String, dynamic>())).input(),
      caCertificates: map['caCertificates'] == null ? null : (pulumi.Input.decodeList<ListenerCaCertificate>(map['caCertificates']!, (value) => ListenerCaCertificate.fromMap((value as Map).cast<String, dynamic>()))).input(),
      caEnabled: map['caEnabled'] == null ? null : (map['caEnabled']! as bool).input(),
      certificates: map['certificates'] == null ? null : (ListenerCertificates.fromMap((map['certificates']! as Map).cast<String, dynamic>())).input(),
      defaultActions: map['defaultActions'] == null ? null : (pulumi.Input.decodeList<ListenerDefaultAction>(map['defaultActions']!, (value) => ListenerDefaultAction.fromMap((value as Map).cast<String, dynamic>()))).input(),
      dryRun: map['dryRun'] == null ? null : (map['dryRun']! as bool).input(),
      gzipEnabled: map['gzipEnabled'] == null ? null : (map['gzipEnabled']! as bool).input(),
      ...
      quicConfig: map['quicConfig'] == null ? null : (ListenerQuicConfig.fromMap((map['quicConfig']! as Map).cast<String, dynamic>())).input(),
      ...
      xForwardedForConfig: map['xForwardedForConfig'] == null ? null : (ListenerXForwardedForConfig.fromMap((map['xForwardedForConfig']! as Map).cast<String, dynamic>())).input(),
    );
  }
}
