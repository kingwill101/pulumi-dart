...
class ListenerState {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'defaultActions': ?pulumi.Input.mapOptionalInputValue<List<ListenerDefaultAction>, List<Map<String, dynamic>>>(defaultActions, (value) => pulumi.Input.encodeList<ListenerDefaultAction, Map<String, dynamic>>(value, (value) => value.toMap())),
      'dryRun': ?dryRun,
  ...
  factory ListenerState.fromMap(Map<String, dynamic> map) {
    return ListenerState(
      accessLogRecordCustomizedHeadersEnabled: (() { final guardedValue = map['accessLogRecordCustomizedHeadersEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      accessLogTracingConfig: (() { final guardedValue = map['accessLogTracingConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ListenerAccessLogTracingConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      aclConfig: (() { final guardedValue = map['aclConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ListenerAclConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      caCertificates: (() { final guardedValue = map['caCertificates']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ListenerCaCertificate>(guardedValue, (value) => ListenerCaCertificate.fromMap((value as Map).cast<String, dynamic>()))); })(),
      caEnabled: (() { final guardedValue = map['caEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      certificates: (() { final guardedValue = map['certificates']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ListenerCertificates.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      defaultActions: (() { final guardedValue = map['defaultActions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ListenerDefaultAction>(guardedValue, (value) => ListenerDefaultAction.fromMap((value as Map).cast<String, dynamic>()))); })(),
      dryRun: (() { final guardedValue = map['dryRun']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      gzipEnabled: (() { final guardedValue = map['gzipEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      quicConfig: (() { final guardedValue = map['quicConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ListenerQuicConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      xForwardedForConfig: (() { final guardedValue = map['xForwardedForConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ListenerXForwardedForConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
