...
class GetSecurityPoliciesArgs {
  ...
  GetSecurityPoliciesArgs({
    ...
    pulumi.Output<List<String>>? securityPolicyIds,
  ...
  factory GetSecurityPoliciesArgs.fromMap(Map<String, dynamic> map) {
    return GetSecurityPoliciesArgs(
      ...
      securityPolicyIds: map['securityPolicyIds'] == null ? null : pulumi.Output.create<List<String>>((map['securityPolicyIds'] as List).cast<String>()),
