...
class GetRulesRule {
  ...
  factory GetRulesRule.fromMap(Map<String, dynamic> map) {
    return GetRulesRule(
      ...
      ruleActions: pulumi.Input.fromValue(pulumi.Input.decodeList<GetRulesRuleRuleAction>(map['ruleActions']!, (value) => GetRulesRuleRuleAction.fromMap((value as Map).cast<String, dynamic>()))),
      ruleConditions: pulumi.Input.fromValue(pulumi.Input.decodeList<GetRulesRuleRuleCondition>(map['ruleConditions']!, (value) => GetRulesRuleRuleCondition.fromMap((value as Map).cast<String, dynamic>()))),
