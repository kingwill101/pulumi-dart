...
class GetRulesRuleRuleActionTrafficMirrorConfig {
  ...
  final pulumi.Input<
    List<GetRulesRuleRuleActionTrafficMirrorConfigMirrorGroupConfig>
  >
  mirrorGroupConfigs;
  ...
  factory GetRulesRuleRuleActionTrafficMirrorConfig.fromMap(
    Map<String, dynamic> map,
  ) {
    return GetRulesRuleRuleActionTrafficMirrorConfig(
      mirrorGroupConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetRulesRuleRuleActionTrafficMirrorConfigMirrorGroupConfig
        >(
          map['mirrorGroupConfigs']!,
          (value) =>
              GetRulesRuleRuleActionTrafficMirrorConfigMirrorGroupConfig.fromMap(
