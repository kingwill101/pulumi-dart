...
class GetRulesRuleRuleActionForwardGroupConfig {
  ...
  final pulumi.Input<
    List<GetRulesRuleRuleActionForwardGroupConfigServerGroupTuple>
  >
  serverGroupTuples;
  ...
  GetRulesRuleRuleActionForwardGroupConfig({required this.serverGroupTuples});
  ...
  factory GetRulesRuleRuleActionForwardGroupConfig.fromMap(
    ...
    return GetRulesRuleRuleActionForwardGroupConfig(
      serverGroupTuples: pulumi.Input.fromValue(
        ...
        >(
          ...
          (value) =>
              GetRulesRuleRuleActionForwardGroupConfigServerGroupTuple.fromMap(
