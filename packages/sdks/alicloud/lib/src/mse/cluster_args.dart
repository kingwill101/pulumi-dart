...
class ClusterArgs {
  ...
  ClusterArgs({
    ...
    required pulumi.Output<String> clusterSpecification,
    ...
    required pulumi.Output<String> pubNetworkFlow,
  ...
  factory ClusterArgs.fromMap(Map<String, dynamic> map) {
    return ClusterArgs(
      ...
      clusterSpecification: pulumi.Output.create<String>(map['clusterSpecification'] as String),
      ...
      pubNetworkFlow: pulumi.Output.create<String>(map['pubNetworkFlow'] as String),
