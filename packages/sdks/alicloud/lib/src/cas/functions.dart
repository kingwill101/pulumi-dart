...
Future<GetCertificatesResult> getCertificates(
  ...
  final result = await deployment.invoke<Map<String, dynamic>>(
    'alicloud:cas/getCertificates:getCertificates',
    args.toMap(),
...
/// ```
/// [args] Arguments passed to this invoke. {@macro pulumi_cas_get_service_certificates_get_service_certificates_args_doc}
/// [options] Invoke options controlling this call.
Future<GetServiceCertificatesResult> getServiceCertificates(
  GetServiceCertificatesArgs args, {
  pulumi.InvokeOptions? options,
}) async {
  final deployment = pulumi.Deployment.instance;
  final result = await deployment.invoke<Map<String, dynamic>>(
    'alicloud:cas/getServiceCertificates:getServiceCertificates',
    args.toMap(),
    options: pulumi.toDeploymentInvokeOptions(options),
  );
  return GetServiceCertificatesResult.fromMap(result);
}
