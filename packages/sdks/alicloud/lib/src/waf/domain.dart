...
class Domain extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<Map<String, dynamic>>?> logHeaders;
  ...
  Domain(String name, {DomainArgs? args, pulumi.CustomResourceOptions? options})
    ...
    connectionTime = registerOutput<int?>('connectionTime');
    domain = registerOutput<String>('domain');
    domainName = registerOutput<String>('domainName');
    http2Ports = registerOutput<List<String>?>('http2Ports');
    httpPorts = registerOutput<List<String>?>('httpPorts');
    httpToUserIp = registerOutput<String?>('httpToUserIp');
    httpsPorts = registerOutput<List<String>?>('httpsPorts');
    httpsRedirect = registerOutput<String?>('httpsRedirect');
    instanceId = registerOutput<String>('instanceId');
    isAccessProduct = registerOutput<String>('isAccessProduct');
    loadBalancing = registerOutput<String?>('loadBalancing');
    logHeaders = registerOutput<List<Map<String, dynamic>>?>('logHeaders');
    readTime = registerOutput<int?>('readTime');
    resourceGroupId = registerOutput<String>('resourceGroupId');
    sourceIps = registerOutput<List<String>?>('sourceIps');
    writeTime = registerOutput<int?>('writeTime');
  }
