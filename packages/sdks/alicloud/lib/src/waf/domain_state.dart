...
class DomainState {
    ...
    return <String, dynamic>{
      ...
      'logHeaders':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainLogHeader>,
            List<Map<String, dynamic>>
          >(
            logHeaders,
            (value) =>
                pulumi.Input.encodeList<DomainLogHeader, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory DomainState.fromMap(Map<String, dynamic> map) {
    return DomainState(
      ...
      connectionTime: (() {
        final guardedValue = map['connectionTime'];
        if (guardedValue == null) return null;
      ...
      http2Ports: (() {
        final guardedValue = map['http2Ports'];
        if (guardedValue == null) return null;
      ...
      httpToUserIp: (() {
        final guardedValue = map['httpToUserIp'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      httpsPorts: (() {
      ...
      isAccessProduct: (() {
        final guardedValue = map['isAccessProduct'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      loadBalancing: (() {
      ...
      logHeaders: (() {
        final guardedValue = map['logHeaders'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainLogHeader>(
            guardedValue,
            (value) =>
                DomainLogHeader.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      readTime: (() {
        final guardedValue = map['readTime'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      resourceGroupId: (() {
      ...
      writeTime: (() {
        final guardedValue = map['writeTime'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
    );
