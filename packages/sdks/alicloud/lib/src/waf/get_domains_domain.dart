...
class GetDomainsDomain {
  ...
  final List<String> http2Ports;
  /// List of the HTTP ports.
  final List<String> httpPorts;
  ...
  final String httpToUserIp;
  /// List of the HTTPS ports.
  final List<String> httpsPorts;
  ...
  final String isAccessProduct;
  /// The load balancing algorithm that is used to forward requests to the origin. Valid values: `IpHash` and `RoundRobin`. Default to `IpHash`.
  final String loadBalancing;
  /// The key-value pair that is used to mark the traffic that flows through WAF to the domain. Each item contains two field:
  final List<GetDomainsDomainLogHeader> logHeaders;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'logHeaders': pulumi.Input.encodeList<GetDomainsDomainLogHeader, Map<String, dynamic>>(logHeaders, (value) => value.toMap()),
      'readTime': readTime,
  ...
  factory GetDomainsDomain.fromMap(Map<String, dynamic> map) {
    return GetDomainsDomain(
      ...
      connectionTime: map['connectionTime'] as int,
      domain: map['domain'] as String,
      domainName: map['domainName'] as String,
      http2Ports: (map['http2Ports'] as List).cast<String>(),
      httpPorts: (map['httpPorts'] as List).cast<String>(),
      httpToUserIp: map['httpToUserIp'] as String,
      httpsPorts: (map['httpsPorts'] as List).cast<String>(),
      httpsRedirect: map['httpsRedirect'] as String,
      id: map['id'] as String,
      isAccessProduct: map['isAccessProduct'] as String,
      loadBalancing: map['loadBalancing'] as String,
      logHeaders: pulumi.Input.decodeList<GetDomainsDomainLogHeader>(map['logHeaders'], (value) => GetDomainsDomainLogHeader.fromMap((value as Map).cast<String, dynamic>())),
      readTime: map['readTime'] as int,
      resourceGroupId: map['resourceGroupId'] as String,
      sourceIps: (map['sourceIps'] as List).cast<String>(),
      version: map['version'] as int,
      writeTime: map['writeTime'] as int,
    );
  }
}
