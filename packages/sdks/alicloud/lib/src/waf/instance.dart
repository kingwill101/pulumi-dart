...
class Instance extends pulumi.CustomResource {
  ...
  Instance(
    ...
    bigScreen = registerOutput<String>('bigScreen');
    exclusiveIpPackage = registerOutput<String>('exclusiveIpPackage');
    extBandwidth = registerOutput<String>('extBandwidth');
    extDomainPackage = registerOutput<String>('extDomainPackage');
    logStorage = registerOutput<String>('logStorage');
    logTime = registerOutput<String>('logTime');
    modifyType = registerOutput<String?>('modifyType');
    packageCode = registerOutput<String>('packageCode');
    period = registerOutput<int?>('period');
    prefessionalService = registerOutput<String>('prefessionalService');
    ...
    wafLog = registerOutput<String>('wafLog');
  }
