...
class InstanceArgs {
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      ...
      exclusiveIpPackage: pulumi.Input.fromValue(map['exclusiveIpPackage'] as String),
      extBandwidth: pulumi.Input.fromValue(map['extBandwidth'] as String),
      extDomainPackage: pulumi.Input.fromValue(map['extDomainPackage'] as String),
      ...
      prefessionalService: pulumi.Input.fromValue(map['prefessionalService'] as String),
