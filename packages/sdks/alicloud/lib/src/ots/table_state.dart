...
class TableState {
  ...
  factory TableState.fromMap(Map<String, dynamic> map) {
    return TableState(
      allowUpdate: (() { final guardedValue = map['allowUpdate']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      definedColumns: (() { final guardedValue = map['definedColumns']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<TableDefinedColumn>(guardedValue, (value) => TableDefinedColumn.fromMap((value as Map).cast<String, dynamic>()))); })(),
      deviationCellVersionInSec: (() { final guardedValue = map['deviationCellVersionInSec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      enableSse: (() { final guardedValue = map['enableSse']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      maxVersion: (() { final guardedValue = map['maxVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      primaryKeys: (() { final guardedValue = map['primaryKeys']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<TablePrimaryKey>(guardedValue, (value) => TablePrimaryKey.fromMap((value as Map).cast<String, dynamic>()))); })(),
      sseKeyId: (() { final guardedValue = map['sseKeyId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      sseKeyType: (() { final guardedValue = map['sseKeyType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      sseRoleArn: (() { final guardedValue = map['sseRoleArn']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
