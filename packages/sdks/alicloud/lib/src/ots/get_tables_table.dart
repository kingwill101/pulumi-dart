    ...
    return <String, dynamic>{
      'definedColumns':
          pulumi.Input.mapInputValue<
            List<GetTablesTableDefinedColumn>,
  ...
  factory GetTablesTable.fromMap(Map<String, dynamic> map) {
    return GetTablesTable(
      definedColumns: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetTablesTableDefinedColumn>(
          map['definedColumns']!,
          (value) => GetTablesTableDefinedColumn.fromMap(
      ...
      primaryKeys: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetTablesTablePrimaryKey>(
          map['primaryKeys']!,
          (value) => GetTablesTablePrimaryKey.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
