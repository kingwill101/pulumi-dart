...
class TableArgs {
  ...
  factory TableArgs.fromMap(Map<String, dynamic> map) {
    return TableArgs(
      ...
      primaryKeys: pulumi.Input.fromValue(pulumi.Input.decodeList<TablePrimaryKey>(map['primaryKeys']!, (value) => TablePrimaryKey.fromMap((value as Map).cast<String, dynamic>()))),
