...
class SearchIndexSchema {
  ...
  factory SearchIndexSchema.fromMap(Map<String, dynamic> map) {
    return SearchIndexSchema(
      fieldSchemas: pulumi.Input.fromValue(pulumi.Input.decodeList<SearchIndexSchemaFieldSchema>(map['fieldSchemas']!, (value) => SearchIndexSchemaFieldSchema.fromMap((value as Map).cast<String, dynamic>()))),
      indexSettings: (() { final guardedValue = map['indexSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SearchIndexSchemaIndexSetting>(guardedValue, (value) => SearchIndexSchemaIndexSetting.fromMap((value as Map).cast<String, dynamic>()))); })(),
      indexSorts: (() { final guardedValue = map['indexSorts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SearchIndexSchemaIndexSort>(guardedValue, (value) => SearchIndexSchemaIndexSort.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
