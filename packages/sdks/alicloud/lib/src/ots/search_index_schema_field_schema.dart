...
class SearchIndexSchemaFieldSchema {
  ...
  factory SearchIndexSchemaFieldSchema.fromMap(Map<String, dynamic> map) {
    return SearchIndexSchemaFieldSchema(
      analyzer: (() { final guardedValue = map['analyzer']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      enableSortAndAgg: (() { final guardedValue = map['enableSortAndAgg']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      fieldName: pulumi.Input.fromValue(map['fieldName'] as String),
      fieldType: pulumi.Input.fromValue(map['fieldType'] as String),
      index: (() { final guardedValue = map['index']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
