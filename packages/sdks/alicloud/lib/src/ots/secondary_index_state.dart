...
class SecondaryIndexState {
  ...
  factory SecondaryIndexState.fromMap(Map<String, dynamic> map) {
    return SecondaryIndexState(
      ...
      includeBaseData: (() { final guardedValue = map['includeBaseData']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      primaryKeys: (() { final guardedValue = map['primaryKeys']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
