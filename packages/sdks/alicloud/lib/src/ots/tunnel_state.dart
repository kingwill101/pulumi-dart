...
class TunnelState {
  ...
  factory TunnelState.fromMap(Map<String, dynamic> map) {
    return TunnelState(
      channels: (() { final guardedValue = map['channels']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<TunnelChannel>(guardedValue, (value) => TunnelChannel.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      tunnelRpo: (() { final guardedValue = map['tunnelRpo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      tunnelStage: (() { final guardedValue = map['tunnelStage']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
