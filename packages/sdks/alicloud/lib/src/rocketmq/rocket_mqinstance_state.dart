...
class RocketMQInstanceState {
  ...
  RocketMQInstanceState({
    ...
    pulumi.Output<RocketMQInstanceNetworkInfo>? networkInfo,
    ...
    pulumi.Output<Map<String, String>>? tags,
      ...
      networkInfo = pulumi.Input.asOptionalInput<RocketMQInstanceNetworkInfo>(networkInfo),
      ...
      seriesCode = pulumi.Input.asOptionalInput<String>(seriesCode),
      ...
      subSeriesCode = pulumi.Input.asOptionalInput<String>(subSeriesCode),
  ...
  factory RocketMQInstanceState.fromMap(Map<String, dynamic> map) {
    return RocketMQInstanceState(
      ...
      networkInfo: map['networkInfo'] == null ? null : pulumi.Output.create<RocketMQInstanceNetworkInfo>(RocketMQInstanceNetworkInfo.fromMap((map['networkInfo'] as Map).cast<String, dynamic>())),
      ...
      seriesCode: map['seriesCode'] == null ? null : pulumi.Output.create<String>(map['seriesCode'] as String),
      ...
      subSeriesCode: map['subSeriesCode'] == null ? null : pulumi.Output.create<String>(map['subSeriesCode'] as String),
