...
class RocketMQInstanceState {
  ...
  factory RocketMQInstanceState.fromMap(Map<String, dynamic> map) {
    return RocketMQInstanceState(
      ...
      networkInfo: (() { final guardedValue = map['networkInfo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RocketMQInstanceNetworkInfo.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      seriesCode: (() { final guardedValue = map['seriesCode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      subSeriesCode: (() { final guardedValue = map['subSeriesCode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
