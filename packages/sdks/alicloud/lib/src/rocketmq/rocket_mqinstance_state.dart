...
class RocketMQInstanceState {
  ...
  factory RocketMQInstanceState.fromMap(Map<String, dynamic> map) {
    return RocketMQInstanceState(
      aclInfo: (() {
        final guardedValue = map['aclInfo'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RocketMQInstanceAclInfo.fromMap(
      ...
      networkInfo: (() {
        final guardedValue = map['networkInfo'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RocketMQInstanceNetworkInfo.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      productInfo: (() {
        final guardedValue = map['productInfo'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RocketMQInstanceProductInfo.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      seriesCode: (() {
        final guardedValue = map['seriesCode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      serviceCode: (() {
        final guardedValue = map['serviceCode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      software: (() {
        final guardedValue = map['software'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RocketMQInstanceSoftware.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      subSeriesCode: (() {
        final guardedValue = map['subSeriesCode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      tags: (() {
