...
class RocketMQInstanceAclInfo {
  ...
  factory RocketMQInstanceAclInfo.fromMap(Map<String, dynamic> map) {
    return RocketMQInstanceAclInfo(
      aclTypes: map['aclTypes'] == null ? null : (map['aclTypes'] as List).cast<String>(),
      defaultVpcAuthFree: map['defaultVpcAuthFree'] == null ? null : map['defaultVpcAuthFree'] as bool,
    );
  }
}
