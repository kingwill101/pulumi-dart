  ...
  factory RocketMQInstanceProductInfo.fromMap(Map<String, dynamic> map) {
    return RocketMQInstanceProductInfo(
      ...
      messageRetentionTime: (() {
        final guardedValue = map['messageRetentionTime'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      msgProcessSpec: pulumi.Input.fromValue(map['msgProcessSpec'] as String),
      sendReceiveRatio: (() {
        final guardedValue = map['sendReceiveRatio'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as double);
      })(),
      storageEncryption: (() {
        final guardedValue = map['storageEncryption'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      storageSecretKey: (() {
        final guardedValue = map['storageSecretKey'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      supportAutoScaling: (() {
        final guardedValue = map['supportAutoScaling'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      traceOn: (() {
        final guardedValue = map['traceOn'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
    );
