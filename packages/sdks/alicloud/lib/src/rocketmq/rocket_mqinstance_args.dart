...
class RocketMQInstanceArgs {
  ...
  factory RocketMQInstanceArgs.fromMap(Map<String, dynamic> map) {
    return RocketMQInstanceArgs(
      ...
      networkInfo: (RocketMQInstanceNetworkInfo.fromMap((map['networkInfo'] as Map).cast<String, dynamic>())).input(),
      ...
      seriesCode: (map['seriesCode'] as String).input(),
      ...
      subSeriesCode: (map['subSeriesCode'] as String).input(),
