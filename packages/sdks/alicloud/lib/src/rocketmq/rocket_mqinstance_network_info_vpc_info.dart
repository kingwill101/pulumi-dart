...
class RocketMQInstanceNetworkInfoVpcInfo {
  ...
  final pulumi.Input<List<RocketMQInstanceNetworkInfoVpcInfoVswitch>>?
  vswitches;
    ...
    return <String, dynamic>{
      ...
      'vswitches':
          ?pulumi.Input.mapOptionalInputValue<
            List<RocketMQInstanceNetworkInfoVpcInfoVswitch>,
    ...
    return RocketMQInstanceNetworkInfoVpcInfo(
      ...
      vswitches: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RocketMQInstanceNetworkInfoVpcInfoVswitch>(
            guardedValue,
            (value) => RocketMQInstanceNetworkInfoVpcInfoVswitch.fromMap(
