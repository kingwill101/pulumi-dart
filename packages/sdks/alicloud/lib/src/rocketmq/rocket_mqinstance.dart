...
class RocketMQInstance extends pulumi.CustomResource {
  ...
  RocketMQInstance(
    ...
    aclInfo = registerOutput<RocketMQInstanceAclInfo>('aclInfo', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return RocketMQInstanceAclInfo.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    networkInfo = registerOutput<RocketMQInstanceNetworkInfo>('networkInfo', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return RocketMQInstanceNetworkInfo.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    paymentType = registerOutput<String>('paymentType');
    period = registerOutput<int?>('period');
    periodUnit = registerOutput<String>('periodUnit');
    productInfo = registerOutput<RocketMQInstanceProductInfo?>('productInfo', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return RocketMQInstanceProductInfo.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    software = registerOutput<RocketMQInstanceSoftware>('software', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return RocketMQInstanceSoftware.fromMap((guardedValue as Map).cast<String, dynamic>()); });
