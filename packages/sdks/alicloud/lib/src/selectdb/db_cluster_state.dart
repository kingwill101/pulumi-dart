...
class DbClusterState {
  ...
  factory DbClusterState.fromMap(Map<String, dynamic> map) {
    return DbClusterState(
      ...
      desiredParams: (() {
        final guardedValue = map['desiredParams'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DbClusterDesiredParam>(
            guardedValue,
            (value) => DbClusterDesiredParam.fromMap(
      ...
      paramChangeLogs: (() {
        final guardedValue = map['paramChangeLogs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DbClusterParamChangeLog>(
            guardedValue,
            (value) => DbClusterParamChangeLog.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
