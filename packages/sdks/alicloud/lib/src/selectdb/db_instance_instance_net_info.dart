...
class DbInstanceInstanceNetInfo {
    ...
    return <String, dynamic>{
      ...
      'portLists':
          ?pulumi.Input.mapOptionalInputValue<
            List<DbInstanceInstanceNetInfoPortList>,
  ...
  factory DbInstanceInstanceNetInfo.fromMap(Map<String, dynamic> map) {
    return DbInstanceInstanceNetInfo(
      ...
      portLists: (() {
        final guardedValue = map['portLists'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DbInstanceInstanceNetInfoPortList>(
            guardedValue,
            (value) => DbInstanceInstanceNetInfoPortList.fromMap(
