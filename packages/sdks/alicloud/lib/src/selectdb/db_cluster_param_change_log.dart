...
class DbClusterParamChangeLog {
  ...
  factory DbClusterParamChangeLog.fromMap(Map<String, dynamic> map) {
    return DbClusterParamChangeLog(
      ...
      isApplied: (() { final guardedValue = map['isApplied']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      oldValue: (() { final guardedValue = map['oldValue']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
