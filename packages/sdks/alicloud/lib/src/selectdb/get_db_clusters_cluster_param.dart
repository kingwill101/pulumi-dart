...
class GetDbClustersClusterParam {
  ...
  factory GetDbClustersClusterParam.fromMap(Map<String, dynamic> map) {
    return GetDbClustersClusterParam(
      ...
      isDynamic: pulumi.Input.fromValue(map['isDynamic'] as int),
      isUserModifiable: pulumi.Input.fromValue(map['isUserModifiable'] as int),
      name: pulumi.Input.fromValue(map['name'] as String),
      optional: pulumi.Input.fromValue(map['optional'] as String),
      paramCategory: pulumi.Input.fromValue(map['paramCategory'] as String),
