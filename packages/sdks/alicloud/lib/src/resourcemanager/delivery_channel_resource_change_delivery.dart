...
class DeliveryChannelResourceChangeDelivery {
  ...
  final DeliveryChannelResourceChangeDeliverySlsProperties? slsProperties;
  ...
  factory DeliveryChannelResourceChangeDelivery.fromMap(Map<String, dynamic> map) {
    return DeliveryChannelResourceChangeDelivery(
      ...
      slsProperties: map['slsProperties'] == null ? null : DeliveryChannelResourceChangeDeliverySlsProperties.fromMap((map['slsProperties'] as Map).cast<String, dynamic>()),
