...
class DeliveryChannelResourceChangeDelivery {
  ...
  final pulumi.Input<DeliveryChannelResourceChangeDeliverySlsProperties>?
  slsProperties;
  ...
  factory DeliveryChannelResourceChangeDelivery.fromMap(
    ...
    return DeliveryChannelResourceChangeDelivery(
      ...
      slsProperties: (() {
        ...
        return pulumi.Input.fromValue(
          DeliveryChannelResourceChangeDeliverySlsProperties.fromMap(
