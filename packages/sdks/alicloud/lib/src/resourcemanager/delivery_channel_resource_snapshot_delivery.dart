...
class DeliveryChannelResourceSnapshotDelivery {
  ...
  factory DeliveryChannelResourceSnapshotDelivery.fromMap(Map<String, dynamic> map) {
    return DeliveryChannelResourceSnapshotDelivery(
      ...
      slsProperties: (() { final guardedValue = map['slsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DeliveryChannelResourceSnapshotDeliverySlsProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
