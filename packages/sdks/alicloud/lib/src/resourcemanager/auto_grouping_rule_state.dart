...
class AutoGroupingRuleState {
  ...
  factory AutoGroupingRuleState.fromMap(Map<String, dynamic> map) {
    return AutoGroupingRuleState(
      ...
      ruleContents: (() { final guardedValue = map['ruleContents']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AutoGroupingRuleRuleContent>(guardedValue, (value) => AutoGroupingRuleRuleContent.fromMap((value as Map).cast<String, dynamic>()))); })(),
