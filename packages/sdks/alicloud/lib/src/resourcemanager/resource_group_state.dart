...
class ResourceGroupState {
    ...
    return <String, dynamic>{
      ...
      'regionStatuses':
          ?pulumi.Input.mapOptionalInputValue<
            List<ResourceGroupRegionStatus>,
  ...
  factory ResourceGroupState.fromMap(Map<String, dynamic> map) {
    return ResourceGroupState(
      ...
      regionStatuses: (() {
        final guardedValue = map['regionStatuses'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ResourceGroupRegionStatus>(
            guardedValue,
            (value) => ResourceGroupRegionStatus.fromMap(
