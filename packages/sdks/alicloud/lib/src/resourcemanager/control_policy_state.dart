...
class ControlPolicyState {
  ...
  factory ControlPolicyState.fromMap(Map<String, dynamic> map) {
    return ControlPolicyState(
      controlPolicyName: (() { final guardedValue = map['controlPolicyName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      createTime: (() { final guardedValue = map['createTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      description: (() { final guardedValue = map['description']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      effectScope: (() { final guardedValue = map['effectScope']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
