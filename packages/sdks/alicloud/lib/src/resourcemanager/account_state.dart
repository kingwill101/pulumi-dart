...
class AccountState {
  ...
  factory AccountState.fromMap(Map<String, dynamic> map) {
    return AccountState(
      ...
      joinMethod: (() { final guardedValue = map['joinMethod']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      joinTime: (() { final guardedValue = map['joinTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
