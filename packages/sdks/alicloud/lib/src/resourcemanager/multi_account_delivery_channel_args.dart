...
class MultiAccountDeliveryChannelArgs {
  ...
  factory MultiAccountDeliveryChannelArgs.fromMap(Map<String, dynamic> map) {
    return MultiAccountDeliveryChannelArgs(
      deliveryChannelDescription: pulumi.Input.fromValue(
        map['deliveryChannelDescription'] as String,
      ),
      ...
      multiAccountDeliveryChannelName: pulumi.Input.fromValue(
        map['multiAccountDeliveryChannelName'] as String,
      ),
      resourceChangeDelivery: (() {
