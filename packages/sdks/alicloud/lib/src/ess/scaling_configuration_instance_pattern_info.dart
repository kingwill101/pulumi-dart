...
class ScalingConfigurationInstancePatternInfo {
  ...
  factory ScalingConfigurationInstancePatternInfo.fromMap(Map<String, dynamic> map) {
    return ScalingConfigurationInstancePatternInfo(
      ...
      gpuSpecs: (() { final guardedValue = map['gpuSpecs']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      ...
      maximumCpuCoreCount: (() { final guardedValue = map['maximumCpuCoreCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      maximumGpuAmount: (() { final guardedValue = map['maximumGpuAmount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      maximumMemorySize: (() { final guardedValue = map['maximumMemorySize']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as double); })(),
      ...
      minimumBaselineCredit: (() { final guardedValue = map['minimumBaselineCredit']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      minimumCpuCoreCount: (() { final guardedValue = map['minimumCpuCoreCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      minimumEniQuantity: (() { final guardedValue = map['minimumEniQuantity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      minimumGpuAmount: (() { final guardedValue = map['minimumGpuAmount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      minimumInitialCredit: (() { final guardedValue = map['minimumInitialCredit']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      minimumMemorySize: (() { final guardedValue = map['minimumMemorySize']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as double); })(),
      physicalProcessorModels: (() { final guardedValue = map['physicalProcessorModels']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
    );
  }
}
