...
class GetScalingGroupsGroup {
  ...
  final pulumi.Input<List<GetScalingGroupsGroupLaunchTemplateOverride>>
    ...
    return <String, dynamic>{
      ...
      'launchTemplateOverrides':
          pulumi.Input.mapInputValue<
            List<GetScalingGroupsGroupLaunchTemplateOverride>,
  ...
  factory GetScalingGroupsGroup.fromMap(Map<String, dynamic> map) {
    return GetScalingGroupsGroup(
      ...
      activeScalingConfiguration: pulumi.Input.fromValue(
        map['activeScalingConfiguration'] as String,
      ),
      ...
      capacityOptionsCompensateWithOnDemand: pulumi.Input.fromValue(
        map['capacityOptionsCompensateWithOnDemand'] as bool,
      ),
      capacityOptionsOnDemandBaseCapacity: pulumi.Input.fromValue(
        map['capacityOptionsOnDemandBaseCapacity'] as int,
      ),
      capacityOptionsOnDemandPercentageAboveBaseCapacity:
          pulumi.Input.fromValue(
            map['capacityOptionsOnDemandPercentageAboveBaseCapacity'] as int,
          ),
      capacityOptionsSpotAutoReplaceOnDemand: pulumi.Input.fromValue(
        map['capacityOptionsSpotAutoReplaceOnDemand'] as bool,
      ),
      ...
      dbInstanceIds: pulumi.Input.fromValue(
        (map['dbInstanceIds'] as List).cast<String>(),
      ),
      desiredCapacity: pulumi.Input.fromValue(map['desiredCapacity'] as int),
      enableDesiredCapacity: pulumi.Input.fromValue(
        map['enableDesiredCapacity'] as bool,
      ),
      groupDeletionProtection: pulumi.Input.fromValue(
        map['groupDeletionProtection'] as bool,
      ),
      ...
      launchTemplateOverrides: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetScalingGroupsGroupLaunchTemplateOverride>(
          map['launchTemplateOverrides']!,
          (value) => GetScalingGroupsGroupLaunchTemplateOverride.fromMap(
      ...
      loadBalancerIds: pulumi.Input.fromValue(
        (map['loadBalancerIds'] as List).cast<String>(),
      ),
      maxInstanceLifetime: pulumi.Input.fromValue(
      ...
      modificationTime: pulumi.Input.fromValue(
        map['modificationTime'] as String,
      ),
      ...
      pendingWaitCapacity: pulumi.Input.fromValue(
        map['pendingWaitCapacity'] as int,
      ),
      protectedCapacity: pulumi.Input.fromValue(
        map['protectedCapacity'] as int,
      ),
      regionId: pulumi.Input.fromValue(map['regionId'] as String),
      removalPolicies: pulumi.Input.fromValue(
        (map['removalPolicies'] as List).cast<String>(),
      ),
      removingCapacity: pulumi.Input.fromValue(map['removingCapacity'] as int),
      removingWaitCapacity: pulumi.Input.fromValue(
        map['removingWaitCapacity'] as int,
      ),
      ...
      stopInstanceTimeout: pulumi.Input.fromValue(
        map['stopInstanceTimeout'] as int,
      ),
      stoppedCapacity: pulumi.Input.fromValue(map['stoppedCapacity'] as int),
      suspendedProcesses: pulumi.Input.fromValue(
      ...
      totalInstanceCount: pulumi.Input.fromValue(
        map['totalInstanceCount'] as int,
      ),
