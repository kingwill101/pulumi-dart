...
class GetScalingGroupsResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'groups':
          pulumi.Input.encodeList<GetScalingGroupsGroup, Map<String, dynamic>>(
            groups,
            (value) => value.toMap(),
          ),
      'id': id,
  ...
  factory GetScalingGroupsResult.fromMap(Map<String, dynamic> map) {
    return GetScalingGroupsResult(
      groups: pulumi.Input.decodeList<GetScalingGroupsGroup>(
        map['groups']!,
        (value) => GetScalingGroupsGroup.fromMap(
