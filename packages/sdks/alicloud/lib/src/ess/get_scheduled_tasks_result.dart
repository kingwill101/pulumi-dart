...
class GetScheduledTasksResult {
  ...
  factory GetScheduledTasksResult.fromMap(Map<String, dynamic> map) {
    return GetScheduledTasksResult(
      ...
      scheduledAction: (() { final guardedValue = map['scheduledAction']; if (guardedValue == null) return null; return guardedValue as String; })(),
      scheduledTaskId: (() { final guardedValue = map['scheduledTaskId']; if (guardedValue == null) return null; return guardedValue as String; })(),
