...
class ScalingConfigurationState {
  ...
  /// Creates a new [ScalingConfigurationState].
  ...
  const ScalingConfigurationState({
    this.active,
  ...
  factory ScalingConfigurationState.fromMap(Map<String, dynamic> map) {
    return ScalingConfigurationState(
