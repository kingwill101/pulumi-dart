...
class EciScalingConfigurationContainer {
  ...
  factory EciScalingConfigurationContainer.fromMap(Map<String, dynamic> map) {
    return EciScalingConfigurationContainer(
      ...
      environmentVars: (() { final guardedValue = map['environmentVars']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<EciScalingConfigurationContainerEnvironmentVar>(guardedValue, (value) => EciScalingConfigurationContainerEnvironmentVar.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      lifecyclePreStopHandlerExecs: (() { final guardedValue = map['lifecyclePreStopHandlerExecs']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      livenessProbeExecCommands: (() { final guardedValue = map['livenessProbeExecCommands']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      livenessProbeFailureThreshold: (() { final guardedValue = map['livenessProbeFailureThreshold']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      livenessProbeHttpGetPath: (() { final guardedValue = map['livenessProbeHttpGetPath']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      livenessProbeHttpGetPort: (() { final guardedValue = map['livenessProbeHttpGetPort']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      livenessProbeHttpGetScheme: (() { final guardedValue = map['livenessProbeHttpGetScheme']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      livenessProbeInitialDelaySeconds: (() { final guardedValue = map['livenessProbeInitialDelaySeconds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      livenessProbePeriodSeconds: (() { final guardedValue = map['livenessProbePeriodSeconds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      livenessProbeSuccessThreshold: (() { final guardedValue = map['livenessProbeSuccessThreshold']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      livenessProbeTcpSocketPort: (() { final guardedValue = map['livenessProbeTcpSocketPort']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      livenessProbeTimeoutSeconds: (() { final guardedValue = map['livenessProbeTimeoutSeconds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      ports: (() { final guardedValue = map['ports']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<EciScalingConfigurationContainerPort>(guardedValue, (value) => EciScalingConfigurationContainerPort.fromMap((value as Map).cast<String, dynamic>()))); })(),
      readinessProbeExecCommands: (() { final guardedValue = map['readinessProbeExecCommands']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      readinessProbeFailureThreshold: (() { final guardedValue = map['readinessProbeFailureThreshold']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      readinessProbeHttpGetPath: (() { final guardedValue = map['readinessProbeHttpGetPath']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      readinessProbeHttpGetPort: (() { final guardedValue = map['readinessProbeHttpGetPort']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      readinessProbeHttpGetScheme: (() { final guardedValue = map['readinessProbeHttpGetScheme']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      readinessProbeInitialDelaySeconds: (() { final guardedValue = map['readinessProbeInitialDelaySeconds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      readinessProbePeriodSeconds: (() { final guardedValue = map['readinessProbePeriodSeconds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      readinessProbeSuccessThreshold: (() { final guardedValue = map['readinessProbeSuccessThreshold']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      readinessProbeTcpSocketPort: (() { final guardedValue = map['readinessProbeTcpSocketPort']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      readinessProbeTimeoutSeconds: (() { final guardedValue = map['readinessProbeTimeoutSeconds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      volumeMounts: (() { final guardedValue = map['volumeMounts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<EciScalingConfigurationContainerVolumeMount>(guardedValue, (value) => EciScalingConfigurationContainerVolumeMount.fromMap((value as Map).cast<String, dynamic>()))); })(),
