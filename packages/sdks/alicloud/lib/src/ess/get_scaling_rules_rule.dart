...
class GetScalingRulesRule {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'hybridMetrics': pulumi.Input.mapInputValue<List<GetScalingRulesRuleHybridMetric>, List<Map<String, dynamic>>>(hybridMetrics, (value) => pulumi.Input.encodeList<GetScalingRulesRuleHybridMetric, Map<String, dynamic>>(value, (value) => value.toMap())),
      ...
      'stepAdjustments': pulumi.Input.mapInputValue<List<GetScalingRulesRuleStepAdjustment>, List<Map<String, dynamic>>>(stepAdjustments, (value) => pulumi.Input.encodeList<GetScalingRulesRuleStepAdjustment, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory GetScalingRulesRule.fromMap(Map<String, dynamic> map) {
    return GetScalingRulesRule(
      adjustmentType: (map['adjustmentType'] as String).input(),
      adjustmentValue: (map['adjustmentValue'] as int).input(),
      cooldown: (map['cooldown'] as int).input(),
      disableScaleIn: (map['disableScaleIn'] as bool).input(),
      estimatedInstanceWarmup: (map['estimatedInstanceWarmup'] as int).input(),
      hybridMetrics: (pulumi.Input.decodeList<GetScalingRulesRuleHybridMetric>(map['hybridMetrics'], (value) => GetScalingRulesRuleHybridMetric.fromMap((value as Map).cast<String, dynamic>()))).input(),
      hybridMonitorNamespace: (map['hybridMonitorNamespace'] as String).input(),
      id: (map['id'] as String).input(),
      initialMaxSize: (map['initialMaxSize'] as int).input(),
      metricName: (map['metricName'] as String).input(),
      metricType: (map['metricType'] as String).input(),
      minAdjustmentMagnitude: (map['minAdjustmentMagnitude'] as int).input(),
      name: (map['name'] as String).input(),
      predictiveScalingMode: (map['predictiveScalingMode'] as String).input(),
      predictiveTaskBufferTime: (map['predictiveTaskBufferTime'] as int).input(),
      predictiveValueBehavior: (map['predictiveValueBehavior'] as String).input(),
      predictiveValueBuffer: (map['predictiveValueBuffer'] as int).input(),
      scaleInEvaluationCount: (map['scaleInEvaluationCount'] as int).input(),
      scaleOutEvaluationCount: (map['scaleOutEvaluationCount'] as int).input(),
      scalingGroupId: (map['scalingGroupId'] as String).input(),
      scalingRuleAri: (map['scalingRuleAri'] as String).input(),
      stepAdjustments: (pulumi.Input.decodeList<GetScalingRulesRuleStepAdjustment>(map['stepAdjustments'], (value) => GetScalingRulesRuleStepAdjustment.fromMap((value as Map).cast<String, dynamic>()))).input(),
