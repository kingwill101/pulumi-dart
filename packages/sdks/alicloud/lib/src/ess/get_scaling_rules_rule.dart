...
class GetScalingRulesRule {
  ...
  factory GetScalingRulesRule.fromMap(Map<String, dynamic> map) {
    return GetScalingRulesRule(
      ...
      estimatedInstanceWarmup: pulumi.Input.fromValue(map['estimatedInstanceWarmup'] as int),
      hybridMetrics: pulumi.Input.fromValue(pulumi.Input.decodeList<GetScalingRulesRuleHybridMetric>(map['hybridMetrics']!, (value) => GetScalingRulesRuleHybridMetric.fromMap((value as Map).cast<String, dynamic>()))),
      hybridMonitorNamespace: pulumi.Input.fromValue(map['hybridMonitorNamespace'] as String),
      ...
      minAdjustmentMagnitude: pulumi.Input.fromValue(map['minAdjustmentMagnitude'] as int),
      name: pulumi.Input.fromValue(map['name'] as String),
      predictiveScalingMode: pulumi.Input.fromValue(map['predictiveScalingMode'] as String),
      predictiveTaskBufferTime: pulumi.Input.fromValue(map['predictiveTaskBufferTime'] as int),
      predictiveValueBehavior: pulumi.Input.fromValue(map['predictiveValueBehavior'] as String),
      predictiveValueBuffer: pulumi.Input.fromValue(map['predictiveValueBuffer'] as int),
      scaleInEvaluationCount: pulumi.Input.fromValue(map['scaleInEvaluationCount'] as int),
      scaleOutEvaluationCount: pulumi.Input.fromValue(map['scaleOutEvaluationCount'] as int),
      ...
      stepAdjustments: pulumi.Input.fromValue(pulumi.Input.decodeList<GetScalingRulesRuleStepAdjustment>(map['stepAdjustments']!, (value) => GetScalingRulesRuleStepAdjustment.fromMap((value as Map).cast<String, dynamic>()))),
