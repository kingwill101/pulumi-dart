...
class ScalingConfiguration extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<ScalingConfigurationCustomPriority>?> customPriorities;
  /// DataDisk mappings to attach to ecs instance. See `data_disk` below for details.
  late final pulumi.Output<List<ScalingConfigurationDataDisk>?> dataDisks;
  ...
  late final pulumi.Output<List<ScalingConfigurationInstancePatternInfo>?> instancePatternInfos;
  /// Resource type of an ECS instance.
  late final pulumi.Output<String?> instanceType;
  /// specify the weight of instance type.  See `instance_type_override` below for details.
  late final pulumi.Output<List<ScalingConfigurationInstanceTypeOverride>?> instanceTypeOverrides;
  ...
  late final pulumi.Output<List<ScalingConfigurationNetworkInterface>?> networkInterfaces;
  ...
  late final pulumi.Output<List<ScalingConfigurationSpotPriceLimit>?> spotPriceLimits;
  ...
  ScalingConfiguration(
    ...
    this.creditSpecification = registerOutput<String?>('creditSpecification');
    this.customPriorities = registerOutput<List<ScalingConfigurationCustomPriority>?>('customPriorities');
    this.dataDisks = registerOutput<List<ScalingConfigurationDataDisk>?>('dataDisks');
    ...
    this.imageOptionsLoginAsNonRoot = registerOutput<bool?>('imageOptionsLoginAsNonRoot');
    ...
    this.instancePatternInfos = registerOutput<List<ScalingConfigurationInstancePatternInfo>?>('instancePatternInfos');
    this.instanceType = registerOutput<String?>('instanceType');
    this.instanceTypeOverrides = registerOutput<List<ScalingConfigurationInstanceTypeOverride>?>('instanceTypeOverrides');
    ...
    this.networkInterfaces = registerOutput<List<ScalingConfigurationNetworkInterface>?>('networkInterfaces');
    ...
    this.spotDuration = registerOutput<int?>('spotDuration');
    this.spotPriceLimits = registerOutput<List<ScalingConfigurationSpotPriceLimit>?>('spotPriceLimits');
    this.spotStrategy = registerOutput<String?>('spotStrategy');
    this.substitute = registerOutput<String>('substitute');
    ...
    this.systemDiskKmsKeyId = registerOutput<String?>('systemDiskKmsKeyId');
