...
class ScalingGroupVServerGroupsVserverGroup {
  ...
  final pulumi.Input<
    List<ScalingGroupVServerGroupsVserverGroupVserverAttribute>
  >
  vserverAttributes;
  ...
  factory ScalingGroupVServerGroupsVserverGroup.fromMap(
    Map<String, dynamic> map,
  ) {
    return ScalingGroupVServerGroupsVserverGroup(
      loadbalancerId: pulumi.Input.fromValue(map['loadbalancerId'] as String),
      vserverAttributes: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          ScalingGroupVServerGroupsVserverGroupVserverAttribute
        >(
          map['vserverAttributes']!,
          (value) =>
              ScalingGroupVServerGroupsVserverGroupVserverAttribute.fromMap(
