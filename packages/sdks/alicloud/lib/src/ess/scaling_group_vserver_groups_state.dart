...
class ScalingGroupVServerGroupsState {
  ...
  factory ScalingGroupVServerGroupsState.fromMap(Map<String, dynamic> map) {
    return ScalingGroupVServerGroupsState(
      ...
      vserverGroups: (() { final guardedValue = map['vserverGroups']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ScalingGroupVServerGroupsVserverGroup>(guardedValue, (value) => ScalingGroupVServerGroupsVserverGroup.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
