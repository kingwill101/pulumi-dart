...
class EciScalingConfigurationState {
  ...
  factory EciScalingConfigurationState.fromMap(Map<String, dynamic> map) {
    return EciScalingConfigurationState(
      acrRegistryInfos: map['acrRegistryInfos'] == null ? null : (pulumi.Input.decodeList<EciScalingConfigurationAcrRegistryInfo>(map['acrRegistryInfos'], (value) => EciScalingConfigurationAcrRegistryInfo.fromMap((value as Map).cast<String, dynamic>()))).input(),
      active: map['active'] == null ? null : (map['active'] as bool).input(),
      activeDeadlineSeconds: map['activeDeadlineSeconds'] == null ? null : (map['activeDeadlineSeconds'] as int).input(),
      autoCreateEip: map['autoCreateEip'] == null ? null : (map['autoCreateEip'] as bool).input(),
      autoMatchImageCache: map['autoMatchImageCache'] == null ? null : (map['autoMatchImageCache'] as bool).input(),
      containerGroupName: map['containerGroupName'] == null ? null : (map['containerGroupName'] as String).input(),
      containers: map['containers'] == null ? null : (pulumi.Input.decodeList<EciScalingConfigurationContainer>(map['containers'], (value) => EciScalingConfigurationContainer.fromMap((value as Map).cast<String, dynamic>()))).input(),
      costOptimization: map['costOptimization'] == null ? null : (map['costOptimization'] as bool).input(),
      cpu: map['cpu'] == null ? null : (map['cpu'] as double).input(),
      cpuOptionsCore: map['cpuOptionsCore'] == null ? null : (map['cpuOptionsCore'] as int).input(),
      cpuOptionsThreadsPerCore: map['cpuOptionsThreadsPerCore'] == null ? null : (map['cpuOptionsThreadsPerCore'] as int).input(),
      description: map['description'] == null ? null : (map['description'] as String).input(),
      dnsConfigOptions: map['dnsConfigOptions'] == null ? null : (pulumi.Input.decodeList<EciScalingConfigurationDnsConfigOption>(map['dnsConfigOptions'], (value) => EciScalingConfigurationDnsConfigOption.fromMap((value as Map).cast<String, dynamic>()))).input(),
      dnsPolicy: map['dnsPolicy'] == null ? null : (map['dnsPolicy'] as String).input(),
      egressBandwidth: map['egressBandwidth'] == null ? null : (map['egressBandwidth'] as int).input(),
      eipBandwidth: map['eipBandwidth'] == null ? null : (map['eipBandwidth'] as int).input(),
      enableSls: map['enableSls'] == null ? null : (map['enableSls'] as bool).input(),
      ...
      hostAliases: map['hostAliases'] == null ? null : (pulumi.Input.decodeList<EciScalingConfigurationHostAlias>(map['hostAliases'], (value) => EciScalingConfigurationHostAlias.fromMap((value as Map).cast<String, dynamic>()))).input(),
      hostName: map['hostName'] == null ? null : (map['hostName'] as String).input(),
      imageRegistryCredentials: map['imageRegistryCredentials'] == null ? null : (pulumi.Input.decodeList<EciScalingConfigurationImageRegistryCredential>(map['imageRegistryCredentials'], (value) => EciScalingConfigurationImageRegistryCredential.fromMap((value as Map).cast<String, dynamic>()))).input(),
      imageSnapshotId: map['imageSnapshotId'] == null ? null : (map['imageSnapshotId'] as String).input(),
      ingressBandwidth: map['ingressBandwidth'] == null ? null : (map['ingressBandwidth'] as int).input(),
      initContainers: map['initContainers'] == null ? null : (pulumi.Input.decodeList<EciScalingConfigurationInitContainer>(map['initContainers'], (value) => EciScalingConfigurationInitContainer.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      loadBalancerWeight: map['loadBalancerWeight'] == null ? null : (map['loadBalancerWeight'] as int).input(),
      ...
      securityContextSysctls: map['securityContextSysctls'] == null ? null : (pulumi.Input.decodeList<EciScalingConfigurationSecurityContextSysctl>(map['securityContextSysctls'], (value) => EciScalingConfigurationSecurityContextSysctl.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      volumes: map['volumes'] == null ? null : (pulumi.Input.decodeList<EciScalingConfigurationVolume>(map['volumes'], (value) => EciScalingConfigurationVolume.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
