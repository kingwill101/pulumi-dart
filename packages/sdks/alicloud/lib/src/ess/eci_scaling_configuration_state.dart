...
class EciScalingConfigurationState {
  ...
  const EciScalingConfigurationState({
  ...
  factory EciScalingConfigurationState.fromMap(Map<String, dynamic> map) {
    return EciScalingConfigurationState(
      acrRegistryInfos: (() { final guardedValue = map['acrRegistryInfos']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<EciScalingConfigurationAcrRegistryInfo>(guardedValue, (value) => EciScalingConfigurationAcrRegistryInfo.fromMap((value as Map).cast<String, dynamic>()))); })(),
      active: (() { final guardedValue = map['active']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      activeDeadlineSeconds: (() { final guardedValue = map['activeDeadlineSeconds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      containers: (() { final guardedValue = map['containers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<EciScalingConfigurationContainer>(guardedValue, (value) => EciScalingConfigurationContainer.fromMap((value as Map).cast<String, dynamic>()))); })(),
      costOptimization: (() { final guardedValue = map['costOptimization']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      cpu: (() { final guardedValue = map['cpu']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as double); })(),
      cpuOptionsCore: (() { final guardedValue = map['cpuOptionsCore']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      cpuOptionsThreadsPerCore: (() { final guardedValue = map['cpuOptionsThreadsPerCore']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      description: (() { final guardedValue = map['description']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      dnsConfigOptions: (() { final guardedValue = map['dnsConfigOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<EciScalingConfigurationDnsConfigOption>(guardedValue, (value) => EciScalingConfigurationDnsConfigOption.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      egressBandwidth: (() { final guardedValue = map['egressBandwidth']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      enableSls: (() { final guardedValue = map['enableSls']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      hostAliases: (() { final guardedValue = map['hostAliases']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<EciScalingConfigurationHostAlias>(guardedValue, (value) => EciScalingConfigurationHostAlias.fromMap((value as Map).cast<String, dynamic>()))); })(),
      hostName: (() { final guardedValue = map['hostName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      imageRegistryCredentials: (() { final guardedValue = map['imageRegistryCredentials']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<EciScalingConfigurationImageRegistryCredential>(guardedValue, (value) => EciScalingConfigurationImageRegistryCredential.fromMap((value as Map).cast<String, dynamic>()))); })(),
      imageSnapshotId: (() { final guardedValue = map['imageSnapshotId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ingressBandwidth: (() { final guardedValue = map['ingressBandwidth']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      initContainers: (() { final guardedValue = map['initContainers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<EciScalingConfigurationInitContainer>(guardedValue, (value) => EciScalingConfigurationInitContainer.fromMap((value as Map).cast<String, dynamic>()))); })(),
      instanceFamilyLevel: (() { final guardedValue = map['instanceFamilyLevel']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      loadBalancerWeight: (() { final guardedValue = map['loadBalancerWeight']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      securityContextSysctls: (() { final guardedValue = map['securityContextSysctls']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<EciScalingConfigurationSecurityContextSysctl>(guardedValue, (value) => EciScalingConfigurationSecurityContextSysctl.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      volumes: (() { final guardedValue = map['volumes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<EciScalingConfigurationVolume>(guardedValue, (value) => EciScalingConfigurationVolume.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
