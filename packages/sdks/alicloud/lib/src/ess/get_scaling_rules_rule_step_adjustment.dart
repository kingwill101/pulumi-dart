...
class GetScalingRulesRuleStepAdjustment {
  ...
  const GetScalingRulesRuleStepAdjustment({
  ...
  factory GetScalingRulesRuleStepAdjustment.fromMap(Map<String, dynamic> map) {
    return GetScalingRulesRuleStepAdjustment(
      metricIntervalLowerBound: pulumi.Input.fromValue(map['metricIntervalLowerBound'] as String),
      metricIntervalUpperBound: pulumi.Input.fromValue(map['metricIntervalUpperBound'] as String),
