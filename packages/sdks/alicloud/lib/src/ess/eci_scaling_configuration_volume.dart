...
class EciScalingConfigurationVolume {
  ...
  factory EciScalingConfigurationVolume.fromMap(Map<String, dynamic> map) {
    return EciScalingConfigurationVolume(
      configFileVolumeConfigFileToPaths: (() {
        final guardedValue = map['configFileVolumeConfigFileToPaths'];
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                EciScalingConfigurationVolumeConfigFileVolumeConfigFileToPath.fromMap(
      ...
      configFileVolumeDefaultMode: (() {
        final guardedValue = map['configFileVolumeDefaultMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      diskVolumeDiskId: (() {
        final guardedValue = map['diskVolumeDiskId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      diskVolumeDiskSize: (() {
        final guardedValue = map['diskVolumeDiskSize'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      diskVolumeFsType: (() {
        final guardedValue = map['diskVolumeFsType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      emptyDirVolumeMedium: (() {
        final guardedValue = map['emptyDirVolumeMedium'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      emptyDirVolumeSizeLimit: (() {
        final guardedValue = map['emptyDirVolumeSizeLimit'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      flexVolumeDriver: (() {
        final guardedValue = map['flexVolumeDriver'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      flexVolumeFsType: (() {
        final guardedValue = map['flexVolumeFsType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      flexVolumeOptions: (() {
        final guardedValue = map['flexVolumeOptions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      hostPathVolumePath: (() {
        final guardedValue = map['hostPathVolumePath'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      hostPathVolumeType: (() {
        final guardedValue = map['hostPathVolumeType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      name: (() {
      ...
      nfsVolumePath: (() {
        final guardedValue = map['nfsVolumePath'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      nfsVolumeReadOnly: (() {
        final guardedValue = map['nfsVolumeReadOnly'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      nfsVolumeServer: (() {
        final guardedValue = map['nfsVolumeServer'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      type: (() {
