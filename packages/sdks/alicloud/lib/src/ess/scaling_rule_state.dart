...
class ScalingRuleState {
  ...
  factory ScalingRuleState.fromMap(Map<String, dynamic> map) {
    return ScalingRuleState(
      ...
      adjustmentValue: (() { final guardedValue = map['adjustmentValue']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      alarmDimension: (() { final guardedValue = map['alarmDimension']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ScalingRuleAlarmDimension.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ari: (() { final guardedValue = map['ari']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      hybridMetrics: (() { final guardedValue = map['hybridMetrics']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ScalingRuleHybridMetric>(guardedValue, (value) => ScalingRuleHybridMetric.fromMap((value as Map).cast<String, dynamic>()))); })(),
      hybridMonitorNamespace: (() { final guardedValue = map['hybridMonitorNamespace']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      initialMaxSize: (() { final guardedValue = map['initialMaxSize']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      predictiveTaskBufferTime: (() { final guardedValue = map['predictiveTaskBufferTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      predictiveValueBehavior: (() { final guardedValue = map['predictiveValueBehavior']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      predictiveValueBuffer: (() { final guardedValue = map['predictiveValueBuffer']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      scaleInEvaluationCount: (() { final guardedValue = map['scaleInEvaluationCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      scaleOutEvaluationCount: (() { final guardedValue = map['scaleOutEvaluationCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      stepAdjustments: (() { final guardedValue = map['stepAdjustments']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ScalingRuleStepAdjustment>(guardedValue, (value) => ScalingRuleStepAdjustment.fromMap((value as Map).cast<String, dynamic>()))); })(),
