...
class EciScalingConfigurationInitContainer {
  ...
  final pulumi.Input<List<EciScalingConfigurationInitContainerEnvironmentVar>>?
  environmentVars;
  ...
  final pulumi.Input<List<EciScalingConfigurationInitContainerVolumeMount>>?
  volumeMounts;
    ...
    return <String, dynamic>{
      ...
      'environmentVars':
          ?pulumi.Input.mapOptionalInputValue<
            List<EciScalingConfigurationInitContainerEnvironmentVar>,
      ...
      'ports':
          ?pulumi.Input.mapOptionalInputValue<
            List<EciScalingConfigurationInitContainerPort>,
            List<Map<String, dynamic>>
          >(
            ports,
            (value) =>
      ...
      'volumeMounts':
          ?pulumi.Input.mapOptionalInputValue<
            List<EciScalingConfigurationInitContainerVolumeMount>,
            List<Map<String, dynamic>>
          >(
            volumeMounts,
            (value) =>
  ...
  factory EciScalingConfigurationInitContainer.fromMap(
    ...
    return EciScalingConfigurationInitContainer(
      ...
      environmentVars: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                EciScalingConfigurationInitContainerEnvironmentVar.fromMap(
      ...
      ports: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EciScalingConfigurationInitContainerPort>(
            guardedValue,
            (value) => EciScalingConfigurationInitContainerPort.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      volumeMounts: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => EciScalingConfigurationInitContainerVolumeMount.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
