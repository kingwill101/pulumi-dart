...
class GetScalingConfigurationsConfiguration {
  ...
  factory GetScalingConfigurationsConfiguration.fromMap(Map<String, dynamic> map) {
    return GetScalingConfigurationsConfiguration(
      ...
      creditSpecification: pulumi.Input.fromValue(map['creditSpecification'] as String),
      dataDisks: pulumi.Input.fromValue(pulumi.Input.decodeList<GetScalingConfigurationsConfigurationDataDisk>(map['dataDisks']!, (value) => GetScalingConfigurationsConfigurationDataDisk.fromMap((value as Map).cast<String, dynamic>()))),
      hostName: pulumi.Input.fromValue(map['hostName'] as String),
      id: pulumi.Input.fromValue(map['id'] as String),
      imageId: pulumi.Input.fromValue(map['imageId'] as String),
      instanceName: pulumi.Input.fromValue(map['instanceName'] as String),
      instancePatternInfos: pulumi.Input.fromValue(pulumi.Input.decodeList<GetScalingConfigurationsConfigurationInstancePatternInfo>(map['instancePatternInfos']!, (value) => GetScalingConfigurationsConfigurationInstancePatternInfo.fromMap((value as Map).cast<String, dynamic>()))),
      instanceType: pulumi.Input.fromValue(map['instanceType'] as String),
      internetChargeType: pulumi.Input.fromValue(map['internetChargeType'] as String),
      internetMaxBandwidthIn: pulumi.Input.fromValue(map['internetMaxBandwidthIn'] as int),
      ...
      spotPriceLimits: pulumi.Input.fromValue(pulumi.Input.decodeList<GetScalingConfigurationsConfigurationSpotPriceLimit>(map['spotPriceLimits']!, (value) => GetScalingConfigurationsConfigurationSpotPriceLimit.fromMap((value as Map).cast<String, dynamic>()))),
      spotStrategy: pulumi.Input.fromValue(map['spotStrategy'] as String),
      systemDiskCategory: pulumi.Input.fromValue(map['systemDiskCategory'] as String),
      systemDiskPerformanceLevel: pulumi.Input.fromValue(map['systemDiskPerformanceLevel'] as String),
