...
import 'alb_server_group_attachment_args.dart';
import 'alb_server_group_attachment_state.dart';
...
class AlbServerGroupAttachment extends pulumi.CustomResource {
  ...
  /// Creates a new [AlbServerGroupAttachment].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [AlbServerGroupAttachment]. {@macro pulumi_ess_alb_server_group_attachment_alb_server_group_attachment_args_doc}
  ...
  static AlbServerGroupAttachment get(
    String name,
    pulumi.Input<String> id, {
    AlbServerGroupAttachmentState? state,
  }) {
    return AlbServerGroupAttachment._get(
      name,
      state: state?.toMap(),
