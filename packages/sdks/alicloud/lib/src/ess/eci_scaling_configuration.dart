...
import 'eci_scaling_configuration_state.dart';
...
class EciScalingConfiguration extends pulumi.CustomResource {
  ...
  EciScalingConfiguration(
    ...
    costOptimization = registerOutput<bool?>('costOptimization');
    ...
    enableSls = registerOutput<bool?>('enableSls');
    ...
    loadBalancerWeight = registerOutput<int?>('loadBalancerWeight');
  ...
  /// Gets an existing [EciScalingConfiguration] resource's state with the given [name] and [id].
  static EciScalingConfiguration get(
    String name,
    pulumi.Input<String> id, {
    EciScalingConfigurationState? state,
  }) {
    return EciScalingConfiguration._get(
      name,
      state: state?.toMap(),
