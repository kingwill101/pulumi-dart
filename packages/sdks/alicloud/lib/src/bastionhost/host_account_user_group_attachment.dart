...
import 'host_account_user_group_attachment_args.dart';
import 'host_account_user_group_attachment_state.dart';
...
class HostAccountUserGroupAttachment extends pulumi.CustomResource {
  ...
  /// Creates a new [HostAccountUserGroupAttachment].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [HostAccountUserGroupAttachment]. {@macro pulumi_bastionhost_host_account_user_group_attachment_host_account_user_group_attachment_args_doc}
  ...
  /// Gets an existing [HostAccountUserGroupAttachment] resource's state with the given [name] and [id].
  static HostAccountUserGroupAttachment get(
    String name,
    pulumi.Input<String> id, {
    HostAccountUserGroupAttachmentState? state,
  }) {
    return HostAccountUserGroupAttachment._get(
      name,
      state: state?.toMap(),
  ...
  HostAccountUserGroupAttachment._get(
    String name, {
