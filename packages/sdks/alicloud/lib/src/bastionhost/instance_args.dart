...
class InstanceArgs {
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      adAuthServers: map['adAuthServers'] == null ? null : (pulumi.Input.decodeList<InstanceAdAuthServer>(map['adAuthServers'], (value) => InstanceAdAuthServer.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      ldapAuthServers: map['ldapAuthServers'] == null ? null : (pulumi.Input.decodeList<InstanceLdapAuthServer>(map['ldapAuthServers'], (value) => InstanceLdapAuthServer.fromMap((value as Map).cast<String, dynamic>()))).input(),
