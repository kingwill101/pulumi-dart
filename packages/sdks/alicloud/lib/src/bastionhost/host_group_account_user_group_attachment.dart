...
import 'host_group_account_user_group_attachment_args.dart';
import 'host_group_account_user_group_attachment_state.dart';
...
class HostGroupAccountUserGroupAttachment extends pulumi.CustomResource {
  ...
  /// Creates a new [HostGroupAccountUserGroupAttachment].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [HostGroupAccountUserGroupAttachment]. {@macro pulumi_bastionhost_host_group_account_user_group_attachment_host_group_account_user_group_attachment_args_doc}
  ...
  HostGroupAccountUserGroupAttachment(
    ...
    this.hostAccountNames = registerOutput<List<String>>('hostAccountNames');
    this.hostGroupId = registerOutput<String>('hostGroupId');
    this.instanceId = registerOutput<String>('instanceId');
    this.userGroupId = registerOutput<String>('userGroupId');
  }

  /// Gets an existing [HostGroupAccountUserGroupAttachment] resource's state with the given [name] and [id].
  static HostGroupAccountUserGroupAttachment get(
    String name,
    pulumi.Input<String> id, {
    HostGroupAccountUserGroupAttachmentState? state,
  }) {
    return HostGroupAccountUserGroupAttachment._get(
      name,
      state: state?.toMap(),
  ...
  HostGroupAccountUserGroupAttachment._get(
    String name, {
