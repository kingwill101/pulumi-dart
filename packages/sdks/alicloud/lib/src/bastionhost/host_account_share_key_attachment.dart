...
import 'host_account_share_key_attachment_state.dart';
...
class HostAccountShareKeyAttachment extends pulumi.CustomResource {
  ...
  static HostAccountShareKeyAttachment get(
    String name,
    pulumi.Input<String> id, {
    HostAccountShareKeyAttachmentState? state,
  }) {
    return HostAccountShareKeyAttachment._get(
      name,
      state: state?.toMap(),
  ...
  HostAccountShareKeyAttachment._get(
    String name, {
