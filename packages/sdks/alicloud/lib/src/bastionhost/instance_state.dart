    ...
    return InstanceState(
      adAuthServers: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InstanceAdAuthServer>(
            guardedValue,
            (value) => InstanceAdAuthServer.fromMap(
      ...
      ldapAuthServers: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InstanceLdapAuthServer>(
            guardedValue,
            (value) => InstanceLdapAuthServer.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
