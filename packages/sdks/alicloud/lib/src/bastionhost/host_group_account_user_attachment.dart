...
import 'host_group_account_user_attachment_state.dart';
...
class HostGroupAccountUserAttachment extends pulumi.CustomResource {
  ...
  /// Gets an existing [HostGroupAccountUserAttachment] resource's state with the given [name] and [id].
  static HostGroupAccountUserAttachment get(
    String name,
    pulumi.Input<String> id, {
    HostGroupAccountUserAttachmentState? state,
  }) {
    return HostGroupAccountUserAttachment._get(
      name,
      state: state?.toMap(),
  ...
  HostGroupAccountUserAttachment._get(
    String name, {
