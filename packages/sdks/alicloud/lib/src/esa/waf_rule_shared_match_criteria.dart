...
class WafRuleSharedMatchCriteria {
  ...
  /// [logic] Optional.
  /// [matchType] Optional.
  const WafRuleSharedMatchCriteria({
    this.criterias,
    this.logic,
    this.matchType,
  });
  ...
  factory WafRuleSharedMatchCriteria.fromMap(Map<String, dynamic> map) {
    return WafRuleSharedMatchCriteria(
      criterias: (() { final guardedValue = map['criterias']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<WafRuleSharedMatchCriteriaCriteria>(guardedValue, (value) => WafRuleSharedMatchCriteriaCriteria.fromMap((value as Map).cast<String, dynamic>()))); })(),
