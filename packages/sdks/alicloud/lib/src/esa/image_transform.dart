...
import 'image_transform_state.dart';
...
class ImageTransform extends pulumi.CustomResource {
  ...
  /// Gets an existing [ImageTransform] resource's state with the given [name] and [id].
  static ImageTransform get(
    String name,
    pulumi.Input<String> id, {
    ImageTransformState? state,
  }) {
    return ImageTransform._get(
      name,
      state: state?.toMap(),
