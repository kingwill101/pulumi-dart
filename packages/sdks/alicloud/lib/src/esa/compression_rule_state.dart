...
class CompressionRuleState {
  ...
  /// Creates a new [CompressionRuleState].
  ...
  factory CompressionRuleState.fromMap(Map<String, dynamic> map) {
    return CompressionRuleState(
      brotli: (() { final guardedValue = map['brotli']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      gzip: (() { final guardedValue = map['gzip']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      zstd: (() { final guardedValue = map['zstd']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
