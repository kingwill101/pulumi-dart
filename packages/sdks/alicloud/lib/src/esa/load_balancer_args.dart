...
class LoadBalancerArgs {
  ...
  factory LoadBalancerArgs.fromMap(Map<String, dynamic> map) {
    return LoadBalancerArgs(
      ...
      defaultPools: pulumi.Input.fromValue((map['defaultPools'] as List).cast<int>()),
      ...
      monitor: pulumi.Input.fromValue(LoadBalancerMonitor.fromMap((map['monitor']! as Map).cast<String, dynamic>())),
