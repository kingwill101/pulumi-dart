...
class HttpIncomingRequestHeaderModificationRule extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<HttpIncomingRequestHeaderModificationRuleRequestHeaderModification>> requestHeaderModifications;
  ...
  HttpIncomingRequestHeaderModificationRule(
    ...
    this.requestHeaderModifications = registerOutput<List<HttpIncomingRequestHeaderModificationRuleRequestHeaderModification>>('requestHeaderModifications');
