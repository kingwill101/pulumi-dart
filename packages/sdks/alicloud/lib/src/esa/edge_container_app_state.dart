...
class EdgeContainerAppState {
  ...
  factory EdgeContainerAppState.fromMap(Map<String, dynamic> map) {
    return EdgeContainerAppState(
      ...
      edgeContainerAppName: (() { final guardedValue = map['edgeContainerAppName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
