...
class EdgeContainerAppArgs {
  ...
  factory EdgeContainerAppArgs.fromMap(Map<String, dynamic> map) {
    return EdgeContainerAppArgs(
      edgeContainerAppName: pulumi.Input.fromValue(map['edgeContainerAppName'] as String),
      healthCheckFailTimes: (() { final guardedValue = map['healthCheckFailTimes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      healthCheckHost: (() { final guardedValue = map['healthCheckHost']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      healthCheckSuccTimes: (() { final guardedValue = map['healthCheckSuccTimes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
