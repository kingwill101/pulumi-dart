...
class EdgeContainerAppArgs {
  ...
  EdgeContainerAppArgs({
    required pulumi.Output<String> edgeContainerAppName,
    ...
    required pulumi.Output<int> servicePort,
    required pulumi.Output<int> targetPort,
  }) :
  ...
  factory EdgeContainerAppArgs.fromMap(Map<String, dynamic> map) {
    return EdgeContainerAppArgs(
      edgeContainerAppName: pulumi.Output.create<String>(map['edgeContainerAppName'] as String),
      ...
      servicePort: pulumi.Output.create<int>(map['servicePort'] as int),
      targetPort: pulumi.Output.create<int>(map['targetPort'] as int),
    );
  }
}
