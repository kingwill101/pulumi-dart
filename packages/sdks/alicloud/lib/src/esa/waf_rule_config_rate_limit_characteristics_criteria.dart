...
class WafRuleConfigRateLimitCharacteristicsCriteria {
  final pulumi.Input<
    List<WafRuleConfigRateLimitCharacteristicsCriteriaCriteria>
  >?
  criterias;
  ...
  factory WafRuleConfigRateLimitCharacteristicsCriteria.fromMap(
      ...
      criterias: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                WafRuleConfigRateLimitCharacteristicsCriteriaCriteria.fromMap(
