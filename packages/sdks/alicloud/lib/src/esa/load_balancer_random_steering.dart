...
class LoadBalancerRandomSteering {
  ...
  factory LoadBalancerRandomSteering.fromMap(Map<String, dynamic> map) {
    return LoadBalancerRandomSteering(
      defaultWeight: (() { final guardedValue = map['defaultWeight']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      poolWeights: (() { final guardedValue = map['poolWeights']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
    );
  }
}
