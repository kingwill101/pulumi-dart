...
class HttpsApplicationConfigurationArgs {
  ...
  HttpsApplicationConfigurationArgs({
    pulumi.Output<String>? altSvc,
    pulumi.Output<String>? altSvcClear,
    pulumi.Output<String>? altSvcMa,
    pulumi.Output<String>? altSvcPersist,
    pulumi.Output<String>? hsts,
    pulumi.Output<String>? hstsIncludeSubdomains,
    pulumi.Output<String>? hstsMaxAge,
    pulumi.Output<String>? hstsPreload,
    pulumi.Output<String>? httpsForce,
    pulumi.Output<String>? httpsForceCode,
    pulumi.Output<String>? httpsNoSniDeny,
    pulumi.Output<String>? httpsSniVerify,
    pulumi.Output<String>? httpsSniWhitelist,
  ...
  factory HttpsApplicationConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return HttpsApplicationConfigurationArgs(
      altSvc: map['altSvc'] == null ? null : pulumi.Output.create<String>(map['altSvc'] as String),
      altSvcClear: map['altSvcClear'] == null ? null : pulumi.Output.create<String>(map['altSvcClear'] as String),
      altSvcMa: map['altSvcMa'] == null ? null : pulumi.Output.create<String>(map['altSvcMa'] as String),
      altSvcPersist: map['altSvcPersist'] == null ? null : pulumi.Output.create<String>(map['altSvcPersist'] as String),
      hsts: map['hsts'] == null ? null : pulumi.Output.create<String>(map['hsts'] as String),
      hstsIncludeSubdomains: map['hstsIncludeSubdomains'] == null ? null : pulumi.Output.create<String>(map['hstsIncludeSubdomains'] as String),
      hstsMaxAge: map['hstsMaxAge'] == null ? null : pulumi.Output.create<String>(map['hstsMaxAge'] as String),
      hstsPreload: map['hstsPreload'] == null ? null : pulumi.Output.create<String>(map['hstsPreload'] as String),
      httpsForce: map['httpsForce'] == null ? null : pulumi.Output.create<String>(map['httpsForce'] as String),
      httpsForceCode: map['httpsForceCode'] == null ? null : pulumi.Output.create<String>(map['httpsForceCode'] as String),
      httpsNoSniDeny: map['httpsNoSniDeny'] == null ? null : pulumi.Output.create<String>(map['httpsNoSniDeny'] as String),
      httpsSniVerify: map['httpsSniVerify'] == null ? null : pulumi.Output.create<String>(map['httpsSniVerify'] as String),
      httpsSniWhitelist: map['httpsSniWhitelist'] == null ? null : pulumi.Output.create<String>(map['httpsSniWhitelist'] as String),
