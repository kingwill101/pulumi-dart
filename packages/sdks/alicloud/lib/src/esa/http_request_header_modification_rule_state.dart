...
class HttpRequestHeaderModificationRuleState {
  ...
  final pulumi.Input<
    List<HttpRequestHeaderModificationRuleRequestHeaderModification>
  >?
  ...
  factory HttpRequestHeaderModificationRuleState.fromMap(
      ...
      requestHeaderModifications: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                HttpRequestHeaderModificationRuleRequestHeaderModification.fromMap(
