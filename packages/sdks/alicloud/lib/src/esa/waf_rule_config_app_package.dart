...
class WafRuleConfigAppPackage {
  ...
  WafRuleConfigAppPackage({this.packageSigns});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'packageSigns':
          ?pulumi.Input.mapOptionalInputValue<
            List<WafRuleConfigAppPackagePackageSign>,
  ...
  factory WafRuleConfigAppPackage.fromMap(Map<String, dynamic> map) {
    return WafRuleConfigAppPackage(
      packageSigns: (() {
        final guardedValue = map['packageSigns'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<WafRuleConfigAppPackagePackageSign>(
            guardedValue,
            (value) => WafRuleConfigAppPackagePackageSign.fromMap(
