...
class WafRuleConfig {
  ...
  factory WafRuleConfig.fromMap(Map<String, dynamic> map) {
    return WafRuleConfig(
      ...
      actions: (() { final guardedValue = map['actions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WafRuleConfigActions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      appPackage: (() { final guardedValue = map['appPackage']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WafRuleConfigAppPackage.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      appSdk: (() { final guardedValue = map['appSdk']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WafRuleConfigAppSdk.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      managedGroupId: (() { final guardedValue = map['managedGroupId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      managedList: (() { final guardedValue = map['managedList']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      managedRulesets: (() { final guardedValue = map['managedRulesets']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<WafRuleConfigManagedRuleset>(guardedValue, (value) => WafRuleConfigManagedRuleset.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      rateLimit: (() { final guardedValue = map['rateLimit']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WafRuleConfigRateLimit.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      securityLevel: (() { final guardedValue = map['securityLevel']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WafRuleConfigSecurityLevel.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      sigchls: (() { final guardedValue = map['sigchls']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      timer: (() { final guardedValue = map['timer']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WafRuleConfigTimer.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
