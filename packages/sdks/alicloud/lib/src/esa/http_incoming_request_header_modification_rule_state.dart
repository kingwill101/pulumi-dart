...
class HttpIncomingRequestHeaderModificationRuleState {
  ...
  factory HttpIncomingRequestHeaderModificationRuleState.fromMap(Map<String, dynamic> map) {
    return HttpIncomingRequestHeaderModificationRuleState(
      ...
      requestHeaderModifications: (() { final guardedValue = map['requestHeaderModifications']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<HttpIncomingRequestHeaderModificationRuleRequestHeaderModification>(guardedValue, (value) => HttpIncomingRequestHeaderModificationRuleRequestHeaderModification.fromMap((value as Map).cast<String, dynamic>()))); })(),
