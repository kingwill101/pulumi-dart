...
class HttpResponseHeaderModificationRuleArgs {
  ...
  HttpResponseHeaderModificationRuleArgs({
    required pulumi.Output<List<HttpResponseHeaderModificationRuleResponseHeaderModification>> responseHeaderModifications,
  ...
  factory HttpResponseHeaderModificationRuleArgs.fromMap(Map<String, dynamic> map) {
    return HttpResponseHeaderModificationRuleArgs(
      responseHeaderModifications: pulumi.Output.create<List<HttpResponseHeaderModificationRuleResponseHeaderModification>>(pulumi.Input.decodeList<HttpResponseHeaderModificationRuleResponseHeaderModification>(map['responseHeaderModifications'], (value) => HttpResponseHeaderModificationRuleResponseHeaderModification.fromMap((value as Map).cast<String, dynamic>()))),
