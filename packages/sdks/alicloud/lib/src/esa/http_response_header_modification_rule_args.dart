...
class HttpResponseHeaderModificationRuleArgs {
  ...
  final pulumi.Input<
    List<HttpResponseHeaderModificationRuleResponseHeaderModification>
  >
  ...
  factory HttpResponseHeaderModificationRuleArgs.fromMap(
    Map<String, dynamic> map,
  ) {
    return HttpResponseHeaderModificationRuleArgs(
      responseHeaderModifications: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          HttpResponseHeaderModificationRuleResponseHeaderModification
        >(
          map['responseHeaderModifications']!,
          (value) =>
              HttpResponseHeaderModificationRuleResponseHeaderModification.fromMap(
