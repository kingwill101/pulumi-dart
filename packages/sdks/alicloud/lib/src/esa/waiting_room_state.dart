...
class WaitingRoomState {
  ...
  WaitingRoomState({
    ...
    pulumi.Output<List<WaitingRoomHostNameAndPath>>? hostNameAndPaths,
    ...
    pulumi.Output<String>? waitingRoomName,
    pulumi.Output<String>? waitingRoomType,
      ...
      hostNameAndPaths = pulumi.Input.asOptionalInput<List<WaitingRoomHostNameAndPath>>(hostNameAndPaths),
      ...
      waitingRoomName = pulumi.Input.asOptionalInput<String>(waitingRoomName),
  ...
  factory WaitingRoomState.fromMap(Map<String, dynamic> map) {
    return WaitingRoomState(
      ...
      hostNameAndPaths: map['hostNameAndPaths'] == null ? null : pulumi.Output.create<List<WaitingRoomHostNameAndPath>>(pulumi.Input.decodeList<WaitingRoomHostNameAndPath>(map['hostNameAndPaths'], (value) => WaitingRoomHostNameAndPath.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      waitingRoomName: map['waitingRoomName'] == null ? null : pulumi.Output.create<String>(map['waitingRoomName'] as String),
