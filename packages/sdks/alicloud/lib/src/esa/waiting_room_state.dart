...
class WaitingRoomState {
  ...
  factory WaitingRoomState.fromMap(Map<String, dynamic> map) {
    return WaitingRoomState(
      ...
      hostNameAndPaths: (() { final guardedValue = map['hostNameAndPaths']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<WaitingRoomHostNameAndPath>(guardedValue, (value) => WaitingRoomHostNameAndPath.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      waitingRoomName: (() { final guardedValue = map['waitingRoomName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
