...
/// {@template pulumi_esa_http_incoming_request_header_modification_rule_http_incoming_request_header_modification_rule_args_doc}
/// The set of arguments for HttpIncomingRequestHeaderModificationRule.
/// {@endtemplate}
/// {@macro pulumi_esa_http_incoming_request_header_modification_rule_http_incoming_request_header_modification_rule_args_doc}
class HttpIncomingRequestHeaderModificationRuleArgs {
  ...
  /// Creates a new [HttpIncomingRequestHeaderModificationRuleArgs].
  ...
  HttpIncomingRequestHeaderModificationRuleArgs({
    required pulumi.Output<List<HttpIncomingRequestHeaderModificationRuleRequestHeaderModification>> requestHeaderModifications,
    ...
    pulumi.Output<int>? siteVersion,
      ...
      requestHeaderModifications = pulumi.Input.asInput<List<HttpIncomingRequestHeaderModificationRuleRequestHeaderModification>>(requestHeaderModifications),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'requestHeaderModifications': pulumi.Input.mapInputValue<List<HttpIncomingRequestHeaderModificationRuleRequestHeaderModification>, List<Map<String, dynamic>>>(requestHeaderModifications, (value) => pulumi.Input.encodeList<HttpIncomingRequestHeaderModificationRuleRequestHeaderModification, Map<String, dynamic>>(value, (value) => value.toMap())),
      'rule': ?rule,
  ...
  factory HttpIncomingRequestHeaderModificationRuleArgs.fromMap(Map<String, dynamic> map) {
    return HttpIncomingRequestHeaderModificationRuleArgs(
      requestHeaderModifications: pulumi.Output.create<List<HttpIncomingRequestHeaderModificationRuleRequestHeaderModification>>(pulumi.Input.decodeList<HttpIncomingRequestHeaderModificationRuleRequestHeaderModification>(map['requestHeaderModifications'], (value) => HttpIncomingRequestHeaderModificationRuleRequestHeaderModification.fromMap((value as Map).cast<String, dynamic>()))),
