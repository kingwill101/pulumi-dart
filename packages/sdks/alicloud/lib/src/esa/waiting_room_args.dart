...
class WaitingRoomArgs {
  ...
  factory WaitingRoomArgs.fromMap(Map<String, dynamic> map) {
    return WaitingRoomArgs(
      ...
      hostNameAndPaths: pulumi.Input.fromValue(pulumi.Input.decodeList<WaitingRoomHostNameAndPath>(map['hostNameAndPaths']!, (value) => WaitingRoomHostNameAndPath.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      queueAllEnable: (() { final guardedValue = map['queueAllEnable']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      waitingRoomName: pulumi.Input.fromValue(map['waitingRoomName'] as String),
