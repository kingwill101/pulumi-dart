...
class HttpIncomingResponseHeaderModificationRuleState {
  ...
  HttpIncomingResponseHeaderModificationRuleState({
    ...
    pulumi.Output<List<HttpIncomingResponseHeaderModificationRuleResponseHeaderModification>>? responseHeaderModifications,
    ...
    pulumi.Output<int>? siteVersion,
      ...
      responseHeaderModifications = pulumi.Input.asOptionalInput<List<HttpIncomingResponseHeaderModificationRuleResponseHeaderModification>>(responseHeaderModifications),
