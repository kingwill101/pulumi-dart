...
class HttpIncomingResponseHeaderModificationRuleState {
  ...
  factory HttpIncomingResponseHeaderModificationRuleState.fromMap(
    ...
    return HttpIncomingResponseHeaderModificationRuleState(
      ...
      responseHeaderModifications: (() {
        final guardedValue = map['responseHeaderModifications'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                HttpIncomingResponseHeaderModificationRuleResponseHeaderModification.fromMap(
