...
import 'origin_client_certificate_state.dart';
...
class OriginClientCertificate extends pulumi.CustomResource {
  ...
  /// Gets an existing [OriginClientCertificate] resource's state with the given [name] and [id].
  static OriginClientCertificate get(
    String name,
    pulumi.Input<String> id, {
    OriginClientCertificateState? state,
  }) {
    return OriginClientCertificate._get(
      name,
      state: state?.toMap(),
