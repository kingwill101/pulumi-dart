...
class SiteDeliveryTaskS3Delivery {
  ...
  factory SiteDeliveryTaskS3Delivery.fromMap(Map<String, dynamic> map) {
    return SiteDeliveryTaskS3Delivery(
      ...
      s3Cmpt: (() { final guardedValue = map['s3Cmpt']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      serverSideEncryption: (() { final guardedValue = map['serverSideEncryption']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      vertifyType: (() { final guardedValue = map['vertifyType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
