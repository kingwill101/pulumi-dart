...
class WaitingRoomEventState {
  ...
  factory WaitingRoomEventState.fromMap(Map<String, dynamic> map) {
    return WaitingRoomEventState(
      ...
      newUsersPerMinute: (() { final guardedValue = map['newUsersPerMinute']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      queuingMethod: (() { final guardedValue = map['queuingMethod']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      queuingStatusCode: (() { final guardedValue = map['queuingStatusCode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      totalActiveUsers: (() { final guardedValue = map['totalActiveUsers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      waitingRoomEventId: (() { final guardedValue = map['waitingRoomEventId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      waitingRoomEventName: (() { final guardedValue = map['waitingRoomEventName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      waitingRoomType: (() { final guardedValue = map['waitingRoomType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
