...
class WafRuleConfigTimer {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'weeklyPeriods':
          ?pulumi.Input.mapOptionalInputValue<
            List<WafRuleConfigTimerWeeklyPeriod>,
            List<Map<String, dynamic>>
          >(
            weeklyPeriods,
            (value) =>
  ...
  factory WafRuleConfigTimer.fromMap(Map<String, dynamic> map) {
    return WafRuleConfigTimer(
      periods: (() {
        final guardedValue = map['periods'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<WafRuleConfigTimerPeriod>(
            guardedValue,
            (value) => WafRuleConfigTimerPeriod.fromMap(
      ...
      weeklyPeriods: (() {
        final guardedValue = map['weeklyPeriods'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<WafRuleConfigTimerWeeklyPeriod>(
            guardedValue,
            (value) => WafRuleConfigTimerWeeklyPeriod.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
