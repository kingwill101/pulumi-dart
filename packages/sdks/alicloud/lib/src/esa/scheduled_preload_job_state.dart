...
class ScheduledPreloadJobState {
  ...
  const ScheduledPreloadJobState({
    this.createTime,
    this.insertWay,
    this.ossUrl,
  ...
  factory ScheduledPreloadJobState.fromMap(Map<String, dynamic> map) {
    return ScheduledPreloadJobState(
      ...
      insertWay: (() { final guardedValue = map['insertWay']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      scheduledPreloadJobName: (() { final guardedValue = map['scheduledPreloadJobName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
