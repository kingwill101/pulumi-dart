...
class HttpsBasicConfiguration extends pulumi.CustomResource {
  ...
  HttpsBasicConfiguration(
    ...
    this.ciphersuiteGroup = registerOutput<String?>('ciphersuiteGroup');
    this.configId = registerOutput<int>('configId');
    this.http2 = registerOutput<String?>('http2');
    this.http3 = registerOutput<String?>('http3');
    this.https = registerOutput<String?>('https');
    ...
    this.tls10 = registerOutput<String?>('tls10');
    this.tls11 = registerOutput<String?>('tls11');
    this.tls12 = registerOutput<String?>('tls12');
    this.tls13 = registerOutput<String?>('tls13');
  }
