...
class RecordState {
    ...
    return <String, dynamic>{
      'authConf':
          ?pulumi.Input.mapOptionalInputValue<
            RecordAuthConf,
            Map<String, dynamic>
          >(authConf, (value) => value.toMap()),
      'bizName': ?bizName,
      'comment': ?comment,
      'createTime': ?createTime,
      'data':
          ?pulumi.Input.mapOptionalInputValue<RecordData, Map<String, dynamic>>(
            data,
            (value) => value.toMap(),
          ),
  ...
  factory RecordState.fromMap(Map<String, dynamic> map) {
    return RecordState(
      authConf: (() {
        final guardedValue = map['authConf'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RecordAuthConf.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      bizName: (() {
      ...
      data: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RecordData.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      hostPolicy: (() {
        final guardedValue = map['hostPolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      proxied: (() {
        final guardedValue = map['proxied'];
        if (guardedValue == null) return null;
