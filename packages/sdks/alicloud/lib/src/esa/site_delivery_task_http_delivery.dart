...
class SiteDeliveryTaskHttpDelivery {
  ...
  final pulumi.Input<SiteDeliveryTaskHttpDeliveryStandardAuthParam>?
  standardAuthParam;
    ...
    return <String, dynamic>{
      ...
      'standardAuthParam':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(standardAuthParam, (value) => value.toMap()),
  ...
  factory SiteDeliveryTaskHttpDelivery.fromMap(Map<String, dynamic> map) {
    return SiteDeliveryTaskHttpDelivery(
      ...
      destUrl: (() {
        final guardedValue = map['destUrl'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      headerParam: (() {
        final guardedValue = map['headerParam'];
        if (guardedValue == null) return null;
      ...
      logBodyPrefix: (() {
        final guardedValue = map['logBodyPrefix'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      logBodySuffix: (() {
        final guardedValue = map['logBodySuffix'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      maxBatchMb: (() {
        final guardedValue = map['maxBatchMb'];
        if (guardedValue == null) return null;
      ...
      maxRetry: (() {
        final guardedValue = map['maxRetry'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      queryParam: (() {
        final guardedValue = map['queryParam'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as Map).cast<String, String>(),
        );
      ...
      standardAuthOn: (() {
        final guardedValue = map['standardAuthOn'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      standardAuthParam: (() {
        final guardedValue = map['standardAuthParam'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SiteDeliveryTaskHttpDeliveryStandardAuthParam.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      transformTimeout: (() {
        final guardedValue = map['transformTimeout'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
    );
