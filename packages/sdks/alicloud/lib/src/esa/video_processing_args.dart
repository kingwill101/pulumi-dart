...
class VideoProcessingArgs {
  ...
  factory VideoProcessingArgs.fromMap(Map<String, dynamic> map) {
    return VideoProcessingArgs(
      flvSeekEnd: (() {
        final guardedValue = map['flvSeekEnd'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      flvSeekStart: (() {
        final guardedValue = map['flvSeekStart'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      flvVideoSeekMode: (() {
        final guardedValue = map['flvVideoSeekMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      mp4SeekEnd: (() {
        final guardedValue = map['mp4SeekEnd'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      mp4SeekStart: (() {
        final guardedValue = map['mp4SeekStart'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      rule: (() {
