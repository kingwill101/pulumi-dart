...
class WafRuleConfigRateLimitThreshold {
  ...
  factory WafRuleConfigRateLimitThreshold.fromMap(Map<String, dynamic> map) {
    return WafRuleConfigRateLimitThreshold(
      distinctManagedRules: (() { final guardedValue = map['distinctManagedRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      managedRulesBlocked: (() { final guardedValue = map['managedRulesBlocked']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      request: (() { final guardedValue = map['request']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      responseStatus: (() { final guardedValue = map['responseStatus']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WafRuleConfigRateLimitThresholdResponseStatus.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
