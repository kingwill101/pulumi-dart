...
class TransportLayerApplicationState {
  ...
  factory TransportLayerApplicationState.fromMap(Map<String, dynamic> map) {
    return TransportLayerApplicationState(
      applicationId: (() { final guardedValue = map['applicationId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      rules: (() { final guardedValue = map['rules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<TransportLayerApplicationRule>(guardedValue, (value) => TransportLayerApplicationRule.fromMap((value as Map).cast<String, dynamic>()))); })(),
