...
class InstanceFrontendNodeGroup {
  ...
  /// Creates a new [InstanceFrontendNodeGroup].
  ...
  /// [zoneId] Zone ID.
  const InstanceFrontendNodeGroup({
    this.cu,
    this.diskNumber,
  ...
  factory InstanceFrontendNodeGroup.fromMap(Map<String, dynamic> map) {
    return InstanceFrontendNodeGroup(
