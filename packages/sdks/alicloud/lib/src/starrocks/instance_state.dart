...
class InstanceState {
  ...
  factory InstanceState.fromMap(Map<String, dynamic> map) {
    return InstanceState(
      ...
      backendNodeGroups: (() { final guardedValue = map['backendNodeGroups']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InstanceBackendNodeGroup>(guardedValue, (value) => InstanceBackendNodeGroup.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      frontendNodeGroups: (() { final guardedValue = map['frontendNodeGroups']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InstanceFrontendNodeGroup>(guardedValue, (value) => InstanceFrontendNodeGroup.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      observerNodeGroups: (() { final guardedValue = map['observerNodeGroups']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InstanceObserverNodeGroup>(guardedValue, (value) => InstanceObserverNodeGroup.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      vswitches: (() { final guardedValue = map['vswitches']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InstanceVswitch>(guardedValue, (value) => InstanceVswitch.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
