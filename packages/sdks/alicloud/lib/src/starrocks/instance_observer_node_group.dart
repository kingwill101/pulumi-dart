...
class InstanceObserverNodeGroup {
  ...
  /// Creates a new [InstanceObserverNodeGroup].
  ...
  /// [zoneId] Zone ID.
  const InstanceObserverNodeGroup({
    this.cu,
    this.diskNumber,
  ...
  factory InstanceObserverNodeGroup.fromMap(Map<String, dynamic> map) {
    return InstanceObserverNodeGroup(
