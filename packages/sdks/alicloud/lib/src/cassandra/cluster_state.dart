...
class ClusterState {
  ...
  ClusterState({
    ...
    pulumi.Output<String>? zoneId,
      ...
      majorVersion = pulumi.Input.asOptionalInput<String>(majorVersion),
      ...
      publicPoints = pulumi.Input.asOptionalInput<List<String>>(publicPoints),
  ...
  factory ClusterState.fromMap(Map<String, dynamic> map) {
    return ClusterState(
      ...
      majorVersion: map['majorVersion'] == null ? null : pulumi.Output.create<String>(map['majorVersion'] as String),
      ...
      publicPoints: map['publicPoints'] == null ? null : pulumi.Output.create<List<String>>((map['publicPoints'] as List).cast<String>()),
