...
class GatewayBlockVolumeArgs {
  ...
  GatewayBlockVolumeArgs({
    ...
    required pulumi.Output<String> gatewayBlockVolumeName,
    ...
    required pulumi.Output<String> ossEndpoint,
  ...
  factory GatewayBlockVolumeArgs.fromMap(Map<String, dynamic> map) {
    return GatewayBlockVolumeArgs(
      ...
      gatewayBlockVolumeName: pulumi.Output.create<String>(map['gatewayBlockVolumeName'] as String),
      ...
      ossEndpoint: pulumi.Output.create<String>(map['ossEndpoint'] as String),
