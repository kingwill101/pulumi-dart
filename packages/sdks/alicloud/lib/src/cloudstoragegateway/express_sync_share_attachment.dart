...
import 'express_sync_share_attachment_state.dart';
...
class ExpressSyncShareAttachment extends pulumi.CustomResource {
  ...
  static ExpressSyncShareAttachment get(
    String name,
    pulumi.Input<String> id, {
    ExpressSyncShareAttachmentState? state,
  }) {
    return ExpressSyncShareAttachment._get(
      name,
      state: state?.toMap(),
  ...
  ExpressSyncShareAttachment._get(
    String name, {
