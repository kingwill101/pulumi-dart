...
class GatewayFileShareState {
  ...
  factory GatewayFileShareState.fromMap(Map<String, dynamic> map) {
    return GatewayFileShareState(
      ...
      backendLimit: (() { final guardedValue = map['backendLimit']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      browsable: (() { final guardedValue = map['browsable']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      bypassCacheRead: (() { final guardedValue = map['bypassCacheRead']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      directIo: (() { final guardedValue = map['directIo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      downloadLimit: (() { final guardedValue = map['downloadLimit']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      fastReclaim: (() { final guardedValue = map['fastReclaim']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      feLimit: (() { final guardedValue = map['feLimit']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      gatewayFileShareName: (() { final guardedValue = map['gatewayFileShareName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      ignoreDelete: (() { final guardedValue = map['ignoreDelete']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      inPlace: (() { final guardedValue = map['inPlace']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      lagPeriod: (() { final guardedValue = map['lagPeriod']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      nfsV4Optimization: (() { final guardedValue = map['nfsV4Optimization']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      ossEndpoint: (() { final guardedValue = map['ossEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      partialSyncPaths: (() { final guardedValue = map['partialSyncPaths']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      remoteSync: (() { final guardedValue = map['remoteSync']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      remoteSyncDownload: (() { final guardedValue = map['remoteSyncDownload']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      roClientList: (() { final guardedValue = map['roClientList']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      roUserList: (() { final guardedValue = map['roUserList']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      rwClientList: (() { final guardedValue = map['rwClientList']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      rwUserList: (() { final guardedValue = map['rwUserList']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      supportArchive: (() { final guardedValue = map['supportArchive']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      transferAcceleration: (() { final guardedValue = map['transferAcceleration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      windowsAcl: (() { final guardedValue = map['windowsAcl']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
    );
  }
}
