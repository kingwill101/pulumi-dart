...
class GetGatewayFileSharesShare {
  ...
  factory GetGatewayFileSharesShare.fromMap(Map<String, dynamic> map) {
    return GetGatewayFileSharesShare(
      accessBasedEnumeration: (map['accessBasedEnumeration'] as bool).input(),
      address: (map['address'] as String).input(),
      backendLimit: (map['backendLimit'] as int).input(),
      browsable: (map['browsable'] as bool).input(),
      bucketInfos: (map['bucketInfos'] as String).input(),
      bucketsStub: (map['bucketsStub'] as bool).input(),
      bypassCacheRead: (map['bypassCacheRead'] as bool).input(),
      cacheMode: (map['cacheMode'] as String).input(),
      clientSideCmk: (map['clientSideCmk'] as String).input(),
      clientSideEncryption: (map['clientSideEncryption'] as bool).input(),
      directIo: (map['directIo'] as bool).input(),
      diskId: (map['diskId'] as String).input(),
      diskType: (map['diskType'] as String).input(),
      downloadLimit: (map['downloadLimit'] as int).input(),
      enabled: (map['enabled'] as bool).input(),
      expressSyncId: (map['expressSyncId'] as String).input(),
      fastReclaim: (map['fastReclaim'] as bool).input(),
      feLimit: (map['feLimit'] as int).input(),
      fileNumLimit: (map['fileNumLimit'] as String).input(),
      fsSizeLimit: (map['fsSizeLimit'] as String).input(),
      gatewayFileShareName: (map['gatewayFileShareName'] as String).input(),
      gatewayId: (map['gatewayId'] as String).input(),
      id: (map['id'] as String).input(),
      ignoreDelete: (map['ignoreDelete'] as bool).input(),
      inPlace: (map['inPlace'] as bool).input(),
      inRate: (map['inRate'] as String).input(),
      indexId: (map['indexId'] as String).input(),
      kmsRotatePeriod: (map['kmsRotatePeriod'] as int).input(),
      lagPeriod: (map['lagPeriod'] as String).input(),
      localPath: (map['localPath'] as String).input(),
      mnsHealth: (map['mnsHealth'] as String).input(),
      nfsV4Optimization: (map['nfsV4Optimization'] as bool).input(),
      obsoleteBuckets: (map['obsoleteBuckets'] as String).input(),
      ...
      ossHealth: (map['ossHealth'] as String).input(),
      ossUsed: (map['ossUsed'] as String).input(),
      outRate: (map['outRate'] as String).input(),
      partialSyncPaths: (map['partialSyncPaths'] as String).input(),
      pathPrefix: (map['pathPrefix'] as String).input(),
      pollingInterval: (map['pollingInterval'] as int).input(),
      protocol: (map['protocol'] as String).input(),
      remainingMetaSpace: (map['remainingMetaSpace'] as String).input(),
      remoteSync: (map['remoteSync'] as bool).input(),
      remoteSyncDownload: (map['remoteSyncDownload'] as bool).input(),
      roClientList: (map['roClientList'] as String).input(),
      roUserList: (map['roUserList'] as String).input(),
      rwClientList: (map['rwClientList'] as String).input(),
      rwUserList: (map['rwUserList'] as String).input(),
      serverSideCmk: (map['serverSideCmk'] as String).input(),
      serverSideEncryption: (map['serverSideEncryption'] as bool).input(),
      size: (map['size'] as String).input(),
      squash: (map['squash'] as String).input(),
      state: (map['state'] as String).input(),
      supportArchive: (map['supportArchive'] as bool).input(),
      syncProgress: (map['syncProgress'] as int).input(),
      totalDownload: (map['totalDownload'] as String).input(),
      totalUpload: (map['totalUpload'] as String).input(),
      transferAcceleration: (map['transferAcceleration'] as bool).input(),
      used: (map['used'] as String).input(),
      windowsAcl: (map['windowsAcl'] as bool).input(),
    );
  }
}
