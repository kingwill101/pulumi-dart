...
class GetGatewayFileSharesShare {
  ...
  factory GetGatewayFileSharesShare.fromMap(Map<String, dynamic> map) {
    return GetGatewayFileSharesShare(
      accessBasedEnumeration: pulumi.Input.fromValue(
      ...
      clientSideEncryption: pulumi.Input.fromValue(
        map['clientSideEncryption'] as bool,
      ),
      ...
      gatewayFileShareName: pulumi.Input.fromValue(
        map['gatewayFileShareName'] as String,
      ),
      ...
      nfsV4Optimization: pulumi.Input.fromValue(
        map['nfsV4Optimization'] as bool,
      ),
      ...
      partialSyncPaths: pulumi.Input.fromValue(
        map['partialSyncPaths'] as String,
      ),
      ...
      remainingMetaSpace: pulumi.Input.fromValue(
        map['remainingMetaSpace'] as String,
      ),
      remoteSync: pulumi.Input.fromValue(map['remoteSync'] as bool),
      remoteSyncDownload: pulumi.Input.fromValue(
        map['remoteSyncDownload'] as bool,
      ),
      ...
      serverSideEncryption: pulumi.Input.fromValue(
        map['serverSideEncryption'] as bool,
      ),
      ...
      transferAcceleration: pulumi.Input.fromValue(
        map['transferAcceleration'] as bool,
      ),
