...
import 'gateway_cache_disk_args.dart';
import 'gateway_cache_disk_state.dart';
...
class GatewayCacheDisk extends pulumi.CustomResource {
  ...
  /// Creates a new [GatewayCacheDisk].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [GatewayCacheDisk]. {@macro pulumi_cloudstoragegateway_gateway_cache_disk_gateway_cache_disk_args_doc}
  ...
  static GatewayCacheDisk get(
    String name,
    pulumi.Input<String> id, {
    GatewayCacheDiskState? state,
  }) {
    return GatewayCacheDisk._get(
      name,
      state: state?.toMap(),
