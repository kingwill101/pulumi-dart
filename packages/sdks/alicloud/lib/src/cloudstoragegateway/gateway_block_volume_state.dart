...
class GatewayBlockVolumeState {
  ...
  factory GatewayBlockVolumeState.fromMap(Map<String, dynamic> map) {
    return GatewayBlockVolumeState(
      ...
      gatewayBlockVolumeName: (() { final guardedValue = map['gatewayBlockVolumeName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
