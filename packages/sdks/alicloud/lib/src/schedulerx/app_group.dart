...
class AppGroup extends pulumi.CustomResource {
  ...
  AppGroup(
    ...
    deleteJobs = registerOutput<bool?>('deleteJobs');
    description = registerOutput<String?>('description');
    enableLog = registerOutput<bool?>('enableLog');
    groupId = registerOutput<String>('groupId');
    maxConcurrency = registerOutput<int?>('maxConcurrency');
    maxJobs = registerOutput<int>('maxJobs');
    monitorConfigJson = registerOutput<String?>('monitorConfigJson');
    monitorContactsJson = registerOutput<String?>('monitorContactsJson');
    namespace = registerOutput<String>('namespace');
    namespaceName = registerOutput<String>('namespaceName');
    namespaceSource = registerOutput<String?>('namespaceSource');
    scheduleBusyWorkers = registerOutput<bool?>('scheduleBusyWorkers');
  }
