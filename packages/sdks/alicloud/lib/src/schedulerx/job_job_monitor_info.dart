...
class JobJobMonitorInfo {
  ...
  factory JobJobMonitorInfo.fromMap(Map<String, dynamic> map) {
    return JobJobMonitorInfo(
      contactInfos: (() { final guardedValue = map['contactInfos']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<JobJobMonitorInfoContactInfo>(guardedValue, (value) => JobJobMonitorInfoContactInfo.fromMap((value as Map).cast<String, dynamic>()))); })(),
      monitorConfig: (() { final guardedValue = map['monitorConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(JobJobMonitorInfoMonitorConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
