...
class AppGroupArgs {
  ...
  factory AppGroupArgs.fromMap(Map<String, dynamic> map) {
    return AppGroupArgs(
      ...
      appType: (() { final guardedValue = map['appType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      deleteJobs: (() { final guardedValue = map['deleteJobs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      description: (() { final guardedValue = map['description']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      enableLog: (() { final guardedValue = map['enableLog']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      maxJobs: (() { final guardedValue = map['maxJobs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      monitorConfigJson: (() { final guardedValue = map['monitorConfigJson']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      monitorContactsJson: (() { final guardedValue = map['monitorContactsJson']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      namespace: pulumi.Input.fromValue(map['namespace'] as String),
      namespaceName: pulumi.Input.fromValue(map['namespaceName'] as String),
      namespaceSource: (() { final guardedValue = map['namespaceSource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      scheduleBusyWorkers: (() { final guardedValue = map['scheduleBusyWorkers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
    );
  }
}
