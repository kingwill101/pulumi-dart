...
class AppGroupArgs {
  ...
  AppGroupArgs({
    ...
    pulumi.Output<int>? appType,
    pulumi.Output<String>? appVersion,
    pulumi.Output<bool>? deleteJobs,
    pulumi.Output<String>? description,
    pulumi.Output<bool>? enableLog,
    required pulumi.Output<String> groupId,
    pulumi.Output<int>? maxConcurrency,
    pulumi.Output<int>? maxJobs,
    pulumi.Output<String>? monitorConfigJson,
    pulumi.Output<String>? monitorContactsJson,
    required pulumi.Output<String> namespace,
    required pulumi.Output<String> namespaceName,
    pulumi.Output<String>? namespaceSource,
    pulumi.Output<bool>? scheduleBusyWorkers,
  }) :
  ...
  factory AppGroupArgs.fromMap(Map<String, dynamic> map) {
    return AppGroupArgs(
      ...
      appType: map['appType'] == null ? null : pulumi.Output.create<int>(map['appType'] as int),
      appVersion: map['appVersion'] == null ? null : pulumi.Output.create<String>(map['appVersion'] as String),
      deleteJobs: map['deleteJobs'] == null ? null : pulumi.Output.create<bool>(map['deleteJobs'] as bool),
      description: map['description'] == null ? null : pulumi.Output.create<String>(map['description'] as String),
      enableLog: map['enableLog'] == null ? null : pulumi.Output.create<bool>(map['enableLog'] as bool),
      groupId: pulumi.Output.create<String>(map['groupId'] as String),
      maxConcurrency: map['maxConcurrency'] == null ? null : pulumi.Output.create<int>(map['maxConcurrency'] as int),
      maxJobs: map['maxJobs'] == null ? null : pulumi.Output.create<int>(map['maxJobs'] as int),
      monitorConfigJson: map['monitorConfigJson'] == null ? null : pulumi.Output.create<String>(map['monitorConfigJson'] as String),
      monitorContactsJson: map['monitorContactsJson'] == null ? null : pulumi.Output.create<String>(map['monitorContactsJson'] as String),
      ...
      scheduleBusyWorkers: map['scheduleBusyWorkers'] == null ? null : pulumi.Output.create<bool>(map['scheduleBusyWorkers'] as bool),
    );
  }
}
