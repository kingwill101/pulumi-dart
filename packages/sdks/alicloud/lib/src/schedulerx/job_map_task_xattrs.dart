...
class JobMapTaskXattrs {
  ...
  factory JobMapTaskXattrs.fromMap(Map<String, dynamic> map) {
    return JobMapTaskXattrs(
      consumerSize: (() { final guardedValue = map['consumerSize']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      dispatcherSize: (() { final guardedValue = map['dispatcherSize']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      pageSize: (() { final guardedValue = map['pageSize']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      queueSize: (() { final guardedValue = map['queueSize']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      taskAttemptInterval: (() { final guardedValue = map['taskAttemptInterval']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      taskMaxAttempt: (() { final guardedValue = map['taskMaxAttempt']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
    );
  }
}
