...
class JobArgs {
  ...
  JobArgs({
    ...
    required pulumi.Output<String> executeMode,
    ...
    required pulumi.Output<JobTimeConfig> timeConfig,
  ...
  factory JobArgs.fromMap(Map<String, dynamic> map) {
    return JobArgs(
      ...
      executeMode: pulumi.Output.create<String>(map['executeMode'] as String),
      ...
      timeConfig: pulumi.Output.create<JobTimeConfig>(JobTimeConfig.fromMap((map['timeConfig'] as Map).cast<String, dynamic>())),
