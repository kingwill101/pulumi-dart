...
class ReadOnlyInstanceState {
  ...
  factory ReadOnlyInstanceState.fromMap(Map<String, dynamic> map) {
    return ReadOnlyInstanceState(
      ...
      masterDbInstanceId: (() { final guardedValue = map['masterDbInstanceId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
