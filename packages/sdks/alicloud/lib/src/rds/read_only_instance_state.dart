...
class ReadOnlyInstanceState {
  ...
  /// Creates a new [ReadOnlyInstanceState].
  ...
  ReadOnlyInstanceState({
    ...
    pulumi.Output<String>? masterDbInstanceId,
    ...
    pulumi.Output<String>? zoneId,
      ...
      masterDbInstanceId = pulumi.Input.asOptionalInput<String>(masterDbInstanceId),
  ...
  factory ReadOnlyInstanceState.fromMap(Map<String, dynamic> map) {
    return ReadOnlyInstanceState(
      ...
      masterDbInstanceId: map['masterDbInstanceId'] == null ? null : pulumi.Output.create<String>(map['masterDbInstanceId'] as String),
