...
class GetCollationTimeZonesArgs {
  ...
  factory GetCollationTimeZonesArgs.fromMap(Map<String, dynamic> map) {
    return GetCollationTimeZonesArgs(
      collationTimeZones: (() { final guardedValue = map['collationTimeZones']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetCollationTimeZonesCollationTimeZone>(guardedValue, (value) => GetCollationTimeZonesCollationTimeZone.fromMap((value as Map).cast<String, dynamic>()))); })(),
