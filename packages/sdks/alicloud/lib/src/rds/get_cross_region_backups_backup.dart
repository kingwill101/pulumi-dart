...
class GetCrossRegionBackupsBackup {
  ...
  factory GetCrossRegionBackupsBackup.fromMap(Map<String, dynamic> map) {
    return GetCrossRegionBackupsBackup(
      ...
      crossBackupDownloadLink: pulumi.Input.fromValue(
        map['crossBackupDownloadLink'] as String,
      ),
      crossBackupId: pulumi.Input.fromValue(map['crossBackupId'] as String),
      crossBackupRegion: pulumi.Input.fromValue(
        map['crossBackupRegion'] as String,
      ),
      crossBackupSetFile: pulumi.Input.fromValue(
        map['crossBackupSetFile'] as String,
      ),
      crossBackupSetLocation: pulumi.Input.fromValue(
        map['crossBackupSetLocation'] as String,
      ),
      crossBackupSetSize: pulumi.Input.fromValue(
        map['crossBackupSetSize'] as int,
      ),
      ...
      recoveryBeginTime: pulumi.Input.fromValue(
        map['recoveryBeginTime'] as String,
      ),
      recoveryEndTime: pulumi.Input.fromValue(map['recoveryEndTime'] as String),
      restoreRegions: pulumi.Input.fromValue(
        (map['restoreRegions'] as List).cast<String>(),
      ),
    );
  }
}
