...
class DbInstanceEndpoint extends pulumi.CustomResource {
  ...
  /// Creates a new [DbInstanceEndpoint].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [DbInstanceEndpoint]. {@macro pulumi_rds_db_instance_endpoint_db_instance_endpoint_args_doc}
  ...
  DbInstanceEndpoint(
    ...
    dbInstanceEndpointDescription = registerOutput<String>('dbInstanceEndpointDescription');
  ...
  static DbInstanceEndpoint get(
    String name,
    pulumi.Input<String> id, {
    DbInstanceEndpointState? state,
  }) {
    return DbInstanceEndpoint._get(
      name,
      state: state?.toMap(),
