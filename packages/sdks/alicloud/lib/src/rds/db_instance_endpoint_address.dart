...
import 'db_instance_endpoint_address_state.dart';
...
class DbInstanceEndpointAddress extends pulumi.CustomResource {
  ...
  static DbInstanceEndpointAddress get(
    String name,
    pulumi.Input<String> id, {
    DbInstanceEndpointAddressState? state,
  }) {
    return DbInstanceEndpointAddress._get(
      name,
      state: state?.toMap(),
  ...
  DbInstanceEndpointAddress._get(
    String name, {
