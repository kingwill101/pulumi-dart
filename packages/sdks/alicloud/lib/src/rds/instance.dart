...
class Instance extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<Map<String, dynamic>>> babelfishConfigs;
  ...
  Instance(
    ...
    babelfishConfigs = registerOutput<List<Map<String, dynamic>>>('babelfishConfigs');
    ...
    coldDataEnabled = registerOutput<bool?>('coldDataEnabled');
    ...
    dbIsIgnoreCase = registerOutput<bool>('dbIsIgnoreCase');
    dbParamGroupId = registerOutput<String?>('dbParamGroupId');
    dbTimeZone = registerOutput<String>('dbTimeZone');
    ...
    freshWhiteListReadins = registerOutput<String?>('freshWhiteListReadins');
    haConfig = registerOutput<String>('haConfig');
    ...
    manualHaTime = registerOutput<String?>('manualHaTime');
    modifyMode = registerOutput<String?>('modifyMode');
    monitoringPeriod = registerOutput<int>('monitoringPeriod');
    nodeId = registerOutput<String>('nodeId');
    optimizedWrites = registerOutput<String>('optimizedWrites');
    parameters = registerOutput<List<Map<String, dynamic>>>('parameters');
    period = registerOutput<int?>('period');
    pgBouncerEnabled = registerOutput<bool?>('pgBouncerEnabled');
    pgHbaConfs = registerOutput<List<Map<String, dynamic>>>('pgHbaConfs');
    port = registerOutput<String>('port');
    privateIpAddress = registerOutput<String>('privateIpAddress');
    recoveryModel = registerOutput<String>('recoveryModel');
    ...
    securityIpMode = registerOutput<String?>('securityIpMode');
    ...
    sqlCollectorConfigValue = registerOutput<int?>('sqlCollectorConfigValue');
    sqlCollectorStatus = registerOutput<String>('sqlCollectorStatus');
    sslAction = registerOutput<String>('sslAction');
    sslConnectionString = registerOutput<String>('sslConnectionString');
    sslStatus = registerOutput<String>('sslStatus');
    status = registerOutput<String>('status');
    storageAutoScale = registerOutput<String?>('storageAutoScale');
    storageThreshold = registerOutput<int?>('storageThreshold');
    storageUpperBound = registerOutput<int?>('storageUpperBound');
    switchTime = registerOutput<String?>('switchTime');
    tags = registerOutput<Map<String, String>?>('tags');
    targetMinorVersion = registerOutput<String>('targetMinorVersion');
    tcpConnectionType = registerOutput<String>('tcpConnectionType');
    tdeEncryptionKey = registerOutput<String?>('tdeEncryptionKey');
    tdeStatus = registerOutput<String>('tdeStatus');
    templateIdLists = registerOutput<List<int>?>('templateIdLists');
    ...
    zoneIdSlaveA = registerOutput<String>('zoneIdSlaveA');
    zoneIdSlaveB = registerOutput<String>('zoneIdSlaveB');
  }
