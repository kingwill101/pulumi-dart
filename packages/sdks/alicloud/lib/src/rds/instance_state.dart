...
class InstanceState {
  ...
  factory InstanceState.fromMap(Map<String, dynamic> map) {
    return InstanceState(
      ...
      babelfishConfigs: map['babelfishConfigs'] == null ? null : (pulumi.Input.decodeList<InstanceBabelfishConfig>(map['babelfishConfigs']!, (value) => InstanceBabelfishConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      coldDataEnabled: map['coldDataEnabled'] == null ? null : (map['coldDataEnabled']! as bool).input(),
      ...
      dbIsIgnoreCase: map['dbIsIgnoreCase'] == null ? null : (map['dbIsIgnoreCase']! as bool).input(),
      dbParamGroupId: map['dbParamGroupId'] == null ? null : (map['dbParamGroupId']! as String).input(),
      dbTimeZone: map['dbTimeZone'] == null ? null : (map['dbTimeZone']! as String).input(),
      ...
      optimizedWrites: map['optimizedWrites'] == null ? null : (map['optimizedWrites']! as String).input(),
      ...
      pgBouncerEnabled: map['pgBouncerEnabled'] == null ? null : (map['pgBouncerEnabled']! as bool).input(),
      pgHbaConfs: map['pgHbaConfs'] == null ? null : (pulumi.Input.decodeList<InstancePgHbaConf>(map['pgHbaConfs']!, (value) => InstancePgHbaConf.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      serverlessConfigs: map['serverlessConfigs'] == null ? null : (pulumi.Input.decodeList<InstanceServerlessConfig>(map['serverlessConfigs']!, (value) => InstanceServerlessConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      tdeEncryptionKey: map['tdeEncryptionKey'] == null ? null : (map['tdeEncryptionKey']! as String).input(),
      tdeStatus: map['tdeStatus'] == null ? null : (map['tdeStatus']! as String).input(),
      templateIdLists: map['templateIdLists'] == null ? null : ((map['templateIdLists']! as List).cast<int>()).input(),
      templates: map['templates'] == null ? null : ((map['templates']! as List).cast<Map<String, String>>()).input(),
