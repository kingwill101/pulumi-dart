...
class RdsUpgradeDbInstanceState {
    ...
    return <String, dynamic>{
      ...
      'parameters':
          ?pulumi.Input.mapOptionalInputValue<
            List<RdsUpgradeDbInstanceParameter>,
      ...
      'pgHbaConfs':
          ?pulumi.Input.mapOptionalInputValue<
            List<RdsUpgradeDbInstancePgHbaConf>,
            List<Map<String, dynamic>>
          >(
            pgHbaConfs,
            (value) =>
  ...
  factory RdsUpgradeDbInstanceState.fromMap(Map<String, dynamic> map) {
    return RdsUpgradeDbInstanceState(
      ...
      collectStatMode: (() {
        final guardedValue = map['collectStatMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      connectionString: (() {
      ...
      parameters: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RdsUpgradeDbInstanceParameter>(
            guardedValue,
            (value) => RdsUpgradeDbInstanceParameter.fromMap(
      ...
      pgHbaConfs: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RdsUpgradeDbInstancePgHbaConf>(
            guardedValue,
            (value) => RdsUpgradeDbInstancePgHbaConf.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      switchOver: (() {
        final guardedValue = map['switchOver'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      switchTime: (() {
      ...
      switchTimeMode: (() {
        final guardedValue = map['switchTimeMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      syncMode: (() {
      ...
      targetMajorVersion: (() {
        final guardedValue = map['targetMajorVersion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      tcpConnectionType: (() {
      ...
      zoneIdSlave1: (() {
        final guardedValue = map['zoneIdSlave1'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
