...
class RdsUpgradeDbInstanceState {
  ...
  factory RdsUpgradeDbInstanceState.fromMap(Map<String, dynamic> map) {
    return RdsUpgradeDbInstanceState(
      ...
      collectStatMode: map['collectStatMode'] == null ? null : (map['collectStatMode'] as String).input(),
      ...
      parameters: map['parameters'] == null ? null : (pulumi.Input.decodeList<RdsUpgradeDbInstanceParameter>(map['parameters'], (value) => RdsUpgradeDbInstanceParameter.fromMap((value as Map).cast<String, dynamic>()))).input(),
      password: map['password'] == null ? null : (map['password'] as String).input(),
      paymentType: map['paymentType'] == null ? null : (map['paymentType'] as String).input(),
      pgHbaConfs: map['pgHbaConfs'] == null ? null : (pulumi.Input.decodeList<RdsUpgradeDbInstancePgHbaConf>(map['pgHbaConfs'], (value) => RdsUpgradeDbInstancePgHbaConf.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      sourceDbInstanceId: map['sourceDbInstanceId'] == null ? null : (map['sourceDbInstanceId'] as String).input(),
      sslEnabled: map['sslEnabled'] == null ? null : (map['sslEnabled'] as int).input(),
      switchOver: map['switchOver'] == null ? null : (map['switchOver'] as String).input(),
      switchTime: map['switchTime'] == null ? null : (map['switchTime'] as String).input(),
      switchTimeMode: map['switchTimeMode'] == null ? null : (map['switchTimeMode'] as String).input(),
      syncMode: map['syncMode'] == null ? null : (map['syncMode'] as String).input(),
      targetMajorVersion: map['targetMajorVersion'] == null ? null : (map['targetMajorVersion'] as String).input(),
      ...
      zoneIdSlave1: map['zoneIdSlave1'] == null ? null : (map['zoneIdSlave1'] as String).input(),
    );
  }
}
