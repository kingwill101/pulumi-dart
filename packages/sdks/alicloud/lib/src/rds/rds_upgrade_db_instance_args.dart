...
class RdsUpgradeDbInstanceArgs {
  ...
  RdsUpgradeDbInstanceArgs({
    ...
    required pulumi.Output<String> collectStatMode,
    ...
    required pulumi.Output<String> sourceDbInstanceId,
    pulumi.Output<int>? sslEnabled,
    required pulumi.Output<String> switchOver,
    pulumi.Output<String>? switchTime,
    pulumi.Output<String>? switchTimeMode,
    pulumi.Output<String>? syncMode,
    required pulumi.Output<String> targetMajorVersion,
  ...
  factory RdsUpgradeDbInstanceArgs.fromMap(Map<String, dynamic> map) {
    return RdsUpgradeDbInstanceArgs(
      ...
      collectStatMode: pulumi.Output.create<String>(map['collectStatMode'] as String),
      ...
      sourceDbInstanceId: pulumi.Output.create<String>(map['sourceDbInstanceId'] as String),
      sslEnabled: map['sslEnabled'] == null ? null : pulumi.Output.create<int>(map['sslEnabled'] as int),
      switchOver: pulumi.Output.create<String>(map['switchOver'] as String),
      ...
      targetMajorVersion: pulumi.Output.create<String>(map['targetMajorVersion'] as String),
