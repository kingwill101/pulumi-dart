...
class RdsUpgradeDbInstanceArgs {
  ...
  RdsUpgradeDbInstanceArgs({
    ...
    this.sslEnabled,
    required this.switchOver,
    this.switchTime,
    this.switchTimeMode,
    this.syncMode,
    required this.targetMajorVersion,
  ...
  factory RdsUpgradeDbInstanceArgs.fromMap(Map<String, dynamic> map) {
    return RdsUpgradeDbInstanceArgs(
      ...
      collectStatMode: pulumi.Input.fromValue(map['collectStatMode'] as String),
      ...
      sourceDbInstanceId: pulumi.Input.fromValue(map['sourceDbInstanceId'] as String),
      ...
      switchOver: pulumi.Input.fromValue(map['switchOver'] as String),
      ...
      targetMajorVersion: pulumi.Input.fromValue(map['targetMajorVersion'] as String),
