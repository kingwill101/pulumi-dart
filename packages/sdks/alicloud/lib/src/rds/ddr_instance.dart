...
import 'ddr_instance_state.dart';
...
class DdrInstance extends pulumi.CustomResource {
  ...
  DdrInstance(
    ...
    sourceDbInstanceName = registerOutput<String?>('sourceDbInstanceName');
  ...
  /// Gets an existing [DdrInstance] resource's state with the given [name] and [id].
  static DdrInstance get(
    String name,
    pulumi.Input<String> id, {
    DdrInstanceState? state,
  }) {
    return DdrInstance._get(
      name,
      state: state?.toMap(),
