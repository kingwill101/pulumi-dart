...
class InstancePgHbaConf {
  ...
  /// Creates a new [InstancePgHbaConf].
  ...
  factory InstancePgHbaConf.fromMap(Map<String, dynamic> map) {
    return InstancePgHbaConf(
