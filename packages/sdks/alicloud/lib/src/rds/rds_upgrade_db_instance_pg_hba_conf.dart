...
class RdsUpgradeDbInstancePgHbaConf {
  ...
  /// Creates a new [RdsUpgradeDbInstancePgHbaConf].
  ...
  const RdsUpgradeDbInstancePgHbaConf({
  ...
  factory RdsUpgradeDbInstancePgHbaConf.fromMap(Map<String, dynamic> map) {
    return RdsUpgradeDbInstancePgHbaConf(
