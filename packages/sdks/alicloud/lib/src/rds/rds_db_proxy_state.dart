...
class RdsDbProxyState {
  ...
  factory RdsDbProxyState.fromMap(Map<String, dynamic> map) {
    return RdsDbProxyState(
      ...
      dbProxyConnectionString: map['dbProxyConnectionString'] == null ? null : (map['dbProxyConnectionString'] as String).input(),
      dbProxyEndpointAliases: map['dbProxyEndpointAliases'] == null ? null : (map['dbProxyEndpointAliases'] as String).input(),
      ...
      dbProxyInstanceNum: map['dbProxyInstanceNum'] == null ? null : (map['dbProxyInstanceNum'] as int).input(),
      ...
      sslExpiredTime: map['sslExpiredTime'] == null ? null : (map['sslExpiredTime'] as String).input(),
