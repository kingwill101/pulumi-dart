...
class RdsDbProxyState {
  ...
  factory RdsDbProxyState.fromMap(Map<String, dynamic> map) {
    return RdsDbProxyState(
      ...
      dbProxyConnectionString: (() { final guardedValue = map['dbProxyConnectionString']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      dbProxyEndpointAliases: (() { final guardedValue = map['dbProxyEndpointAliases']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      dbProxyInstanceNum: (() { final guardedValue = map['dbProxyInstanceNum']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      sslExpiredTime: (() { final guardedValue = map['sslExpiredTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
