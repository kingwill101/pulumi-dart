...
/// {@template pulumi_rds_backup_policy_backup_policy_args_doc}
/// The set of arguments for BackupPolicy.
/// {@endtemplate}
/// {@macro pulumi_rds_backup_policy_backup_policy_args_doc}
class BackupPolicyArgs {
  ...
  BackupPolicyArgs({
    pulumi.Output<int>? archiveBackupKeepCount,
    pulumi.Output<String>? archiveBackupKeepPolicy,
    pulumi.Output<int>? archiveBackupRetentionPeriod,
    pulumi.Output<String>? backupInterval,
    pulumi.Output<String>? backupMethod,
    pulumi.Output<List<String>>? backupPeriods,
    pulumi.Output<int>? backupPriority,
    ...
    pulumi.Output<bool>? enableIncrementDataBackup,
    pulumi.Output<String>? highSpaceUsageProtection,
    required pulumi.Output<String> instanceId,
    pulumi.Output<int>? localLogRetentionHours,
    pulumi.Output<int>? localLogRetentionSpace,
    pulumi.Output<bool>? logBackup,
    pulumi.Output<String>? logBackupFrequency,
    pulumi.Output<int>? logBackupLocalRetentionNumber,
    pulumi.Output<int>? logBackupRetentionPeriod,
    pulumi.Output<int>? logRetentionPeriod,
    ...
    pulumi.Output<int>? retentionPeriod,
      ...
      archiveBackupKeepCount = pulumi.Input.asOptionalInput<int>(archiveBackupKeepCount),
      archiveBackupKeepPolicy = pulumi.Input.asOptionalInput<String>(archiveBackupKeepPolicy),
      archiveBackupRetentionPeriod = pulumi.Input.asOptionalInput<int>(archiveBackupRetentionPeriod),
      ...
      backupPriority = pulumi.Input.asOptionalInput<int>(backupPriority),
      ...
      enableIncrementDataBackup = pulumi.Input.asOptionalInput<bool>(enableIncrementDataBackup),
      highSpaceUsageProtection = pulumi.Input.asOptionalInput<String>(highSpaceUsageProtection),
      instanceId = pulumi.Input.asInput<String>(instanceId),
      localLogRetentionHours = pulumi.Input.asOptionalInput<int>(localLogRetentionHours),
      localLogRetentionSpace = pulumi.Input.asOptionalInput<int>(localLogRetentionSpace),
      logBackup = pulumi.Input.asOptionalInput<bool>(logBackup),
      logBackupFrequency = pulumi.Input.asOptionalInput<String>(logBackupFrequency),
      logBackupLocalRetentionNumber = pulumi.Input.asOptionalInput<int>(logBackupLocalRetentionNumber),
      logBackupRetentionPeriod = pulumi.Input.asOptionalInput<int>(logBackupRetentionPeriod),
      logRetentionPeriod = pulumi.Input.asOptionalInput<int>(logRetentionPeriod),
  ...
  factory BackupPolicyArgs.fromMap(Map<String, dynamic> map) {
    return BackupPolicyArgs(
      archiveBackupKeepCount: map['archiveBackupKeepCount'] == null ? null : pulumi.Output.create<int>(map['archiveBackupKeepCount'] as int),
      archiveBackupKeepPolicy: map['archiveBackupKeepPolicy'] == null ? null : pulumi.Output.create<String>(map['archiveBackupKeepPolicy'] as String),
      archiveBackupRetentionPeriod: map['archiveBackupRetentionPeriod'] == null ? null : pulumi.Output.create<int>(map['archiveBackupRetentionPeriod'] as int),
      ...
      backupPriority: map['backupPriority'] == null ? null : pulumi.Output.create<int>(map['backupPriority'] as int),
      ...
      enableIncrementDataBackup: map['enableIncrementDataBackup'] == null ? null : pulumi.Output.create<bool>(map['enableIncrementDataBackup'] as bool),
      highSpaceUsageProtection: map['highSpaceUsageProtection'] == null ? null : pulumi.Output.create<String>(map['highSpaceUsageProtection'] as String),
      instanceId: pulumi.Output.create<String>(map['instanceId'] as String),
      localLogRetentionHours: map['localLogRetentionHours'] == null ? null : pulumi.Output.create<int>(map['localLogRetentionHours'] as int),
      localLogRetentionSpace: map['localLogRetentionSpace'] == null ? null : pulumi.Output.create<int>(map['localLogRetentionSpace'] as int),
      logBackup: map['logBackup'] == null ? null : pulumi.Output.create<bool>(map['logBackup'] as bool),
      logBackupFrequency: map['logBackupFrequency'] == null ? null : pulumi.Output.create<String>(map['logBackupFrequency'] as String),
      logBackupLocalRetentionNumber: map['logBackupLocalRetentionNumber'] == null ? null : pulumi.Output.create<int>(map['logBackupLocalRetentionNumber'] as int),
      ...
      logRetentionPeriod: map['logRetentionPeriod'] == null ? null : pulumi.Output.create<int>(map['logRetentionPeriod'] as int),
