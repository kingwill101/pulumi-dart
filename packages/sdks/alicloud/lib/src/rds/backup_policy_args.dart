...
class BackupPolicyArgs {
  ...
  factory BackupPolicyArgs.fromMap(Map<String, dynamic> map) {
    return BackupPolicyArgs(
      archiveBackupKeepCount: (() { final guardedValue = map['archiveBackupKeepCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      archiveBackupKeepPolicy: (() { final guardedValue = map['archiveBackupKeepPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      archiveBackupRetentionPeriod: (() { final guardedValue = map['archiveBackupRetentionPeriod']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      enableIncrementDataBackup: (() { final guardedValue = map['enableIncrementDataBackup']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      highSpaceUsageProtection: (() { final guardedValue = map['highSpaceUsageProtection']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      instanceId: pulumi.Input.fromValue(map['instanceId'] as String),
      localLogRetentionHours: (() { final guardedValue = map['localLogRetentionHours']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      localLogRetentionSpace: (() { final guardedValue = map['localLogRetentionSpace']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      logBackup: (() { final guardedValue = map['logBackup']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      logBackupFrequency: (() { final guardedValue = map['logBackupFrequency']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      logBackupLocalRetentionNumber: (() { final guardedValue = map['logBackupLocalRetentionNumber']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      logRetentionPeriod: (() { final guardedValue = map['logRetentionPeriod']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
