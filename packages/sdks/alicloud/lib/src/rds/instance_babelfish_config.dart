...
class InstanceBabelfishConfig {
  ...
  factory InstanceBabelfishConfig.fromMap(Map<String, dynamic> map) {
    return InstanceBabelfishConfig(
      babelfishEnabled: map['babelfishEnabled'] as String,
      masterUserPassword: map['masterUserPassword'] as String,
      masterUsername: map['masterUsername'] as String,
      migrationMode: map['migrationMode'] as String,
    );
  }
}
