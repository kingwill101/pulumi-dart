...
class RdsParameterGroupState {
  ...
  factory RdsParameterGroupState.fromMap(Map<String, dynamic> map) {
    return RdsParameterGroupState(
      ...
      paramDetails: (() { final guardedValue = map['paramDetails']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RdsParameterGroupParamDetail>(guardedValue, (value) => RdsParameterGroupParamDetail.fromMap((value as Map).cast<String, dynamic>()))); })(),
