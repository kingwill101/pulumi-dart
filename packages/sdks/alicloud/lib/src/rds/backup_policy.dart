...
class BackupPolicy extends pulumi.CustomResource {
  ...
  BackupPolicy(
    ...
    archiveBackupRetentionPeriod = registerOutput<int>(
    ...
    enableIncrementDataBackup = registerOutput<bool>(
      'enableIncrementDataBackup',
    );
    highSpaceUsageProtection = registerOutput<String?>(
    ...
    logBackupLocalRetentionNumber = registerOutput<int>(
