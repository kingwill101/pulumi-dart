...
class RdsInstanceCrossBackupPolicyState {
  ...
  factory RdsInstanceCrossBackupPolicyState.fromMap(Map<String, dynamic> map) {
    return RdsInstanceCrossBackupPolicyState(
      backupEnabled: (() { final guardedValue = map['backupEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      backupEnabledTime: (() { final guardedValue = map['backupEnabledTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      crossBackupType: (() { final guardedValue = map['crossBackupType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      dbInstanceStatus: (() { final guardedValue = map['dbInstanceStatus']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      logBackupEnabledTime: (() { final guardedValue = map['logBackupEnabledTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      retentType: (() { final guardedValue = map['retentType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
