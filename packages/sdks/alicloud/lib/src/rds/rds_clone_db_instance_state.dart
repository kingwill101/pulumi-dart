...
class RdsCloneDbInstanceState {
  ...
  factory RdsCloneDbInstanceState.fromMap(Map<String, dynamic> map) {
    return RdsCloneDbInstanceState(
      ...
      dbNames: (() { final guardedValue = map['dbNames']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      parameters: (() { final guardedValue = map['parameters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RdsCloneDbInstanceParameter>(guardedValue, (value) => RdsCloneDbInstanceParameter.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      pgHbaConfs: (() { final guardedValue = map['pgHbaConfs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RdsCloneDbInstancePgHbaConf>(guardedValue, (value) => RdsCloneDbInstancePgHbaConf.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      restoreTable: (() { final guardedValue = map['restoreTable']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      serverlessConfigs: (() { final guardedValue = map['serverlessConfigs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RdsCloneDbInstanceServerlessConfig>(guardedValue, (value) => RdsCloneDbInstanceServerlessConfig.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      tableMeta: (() { final guardedValue = map['tableMeta']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
