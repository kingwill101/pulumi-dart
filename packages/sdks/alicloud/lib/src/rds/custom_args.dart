...
class CustomArgs {
    ...
    return <String, dynamic>{
      ...
      'dataDisks':
          ...
          >(
            dataDisks,
            (value) =>
                pulumi.Input.encodeList<CustomDataDisk, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory CustomArgs.fromMap(Map<String, dynamic> map) {
    return CustomArgs(
      ...
      createExtraParam: (() {
        final guardedValue = map['createExtraParam'];
        if (guardedValue == null) return null;
      ...
      dataDisks: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<CustomDataDisk>(
            guardedValue,
            (value) =>
                CustomDataDisk.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      deploymentSetId: (() {
      ...
      supportCase: (() {
        final guardedValue = map['supportCase'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      systemDisk: (() {
