...
class DbNode extends pulumi.CustomResource {
  ...
  DbNode(String name, {DbNodeArgs? args, pulumi.CustomResourceOptions? options})
    ...
    nodeRegionId = registerOutput<String>('nodeRegionId');
    nodeRole = registerOutput<String>('nodeRole');
    zoneId = registerOutput<String>('zoneId');
  }

  /// Gets an existing [DbNode] resource's state with the given [name] and [id].
  static DbNode get(
    String name,
