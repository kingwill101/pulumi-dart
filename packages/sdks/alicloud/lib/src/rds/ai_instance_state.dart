...
class AiInstanceState {
  ...
  factory AiInstanceState.fromMap(Map<String, dynamic> map) {
    return AiInstanceState(
      ...
      authConfigLists: (() { final guardedValue = map['authConfigLists']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AiInstanceAuthConfigList>(guardedValue, (value) => AiInstanceAuthConfigList.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      dashboardPassword: (() { final guardedValue = map['dashboardPassword']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      databasePassword: (() { final guardedValue = map['databasePassword']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      initializeWithExistingData: (() { final guardedValue = map['initializeWithExistingData']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      storageConfigLists: (() { final guardedValue = map['storageConfigLists']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AiInstanceStorageConfigList>(guardedValue, (value) => AiInstanceStorageConfigList.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
