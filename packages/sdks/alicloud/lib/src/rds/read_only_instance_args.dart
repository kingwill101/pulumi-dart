...
class ReadOnlyInstanceArgs {
  ...
  factory ReadOnlyInstanceArgs.fromMap(Map<String, dynamic> map) {
    return ReadOnlyInstanceArgs(
      ...
      parameters: map['parameters'] == null ? null : (pulumi.Input.decodeList<ReadOnlyInstanceParameter>(map['parameters']!, (value) => ReadOnlyInstanceParameter.fromMap((value as Map).cast<String, dynamic>()))).input(),
