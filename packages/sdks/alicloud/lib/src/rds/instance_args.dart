...
class InstanceArgs {
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      ...
      babelfishConfigs: (() {
        final guardedValue = map['babelfishConfigs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InstanceBabelfishConfig>(
            guardedValue,
            (value) => InstanceBabelfishConfig.fromMap(
      ...
      coldDataEnabled: (() {
        final guardedValue = map['coldDataEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      ...
      dbIsIgnoreCase: (() {
        final guardedValue = map['dbIsIgnoreCase'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      dbParamGroupId: (() {
        final guardedValue = map['dbParamGroupId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      dbTimeZone: (() {
        final guardedValue = map['dbTimeZone'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      deletionProtection: (() {
      ...
      optimizedWrites: (() {
        final guardedValue = map['optimizedWrites'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      parameters: (() {
      ...
      pgBouncerEnabled: (() {
        final guardedValue = map['pgBouncerEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      pgHbaConfs: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InstancePgHbaConf>(
            guardedValue,
            (value) => InstancePgHbaConf.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      serverlessConfigs: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InstanceServerlessConfig>(
            guardedValue,
            (value) => InstanceServerlessConfig.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      tdeEncryptionKey: (() {
        final guardedValue = map['tdeEncryptionKey'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      tdeStatus: (() {
