...
class RdsDbProxyArgs {
  ...
  factory RdsDbProxyArgs.fromMap(Map<String, dynamic> map) {
    return RdsDbProxyArgs(
      dbProxyConnectStringPort: (() { final guardedValue = map['dbProxyConnectStringPort']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      dbProxyConnectionPrefix: (() { final guardedValue = map['dbProxyConnectionPrefix']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      dbProxyEndpointReadWriteMode: (() { final guardedValue = map['dbProxyEndpointReadWriteMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      dbProxyFeatures: (() { final guardedValue = map['dbProxyFeatures']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      dbProxyInstanceNum: pulumi.Input.fromValue(map['dbProxyInstanceNum'] as int),
      dbProxyInstanceType: (() { final guardedValue = map['dbProxyInstanceType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      dbProxySslEnabled: (() { final guardedValue = map['dbProxySslEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      effectiveSpecificTime: (() { final guardedValue = map['effectiveSpecificTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      readOnlyInstanceDistributionType: (() { final guardedValue = map['readOnlyInstanceDistributionType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      readOnlyInstanceMaxDelayTime: (() { final guardedValue = map['readOnlyInstanceMaxDelayTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      readOnlyInstanceWeights: (() { final guardedValue = map['readOnlyInstanceWeights']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RdsDbProxyReadOnlyInstanceWeight>(guardedValue, (value) => RdsDbProxyReadOnlyInstanceWeight.fromMap((value as Map).cast<String, dynamic>()))); })(),
