...
class RdsDbProxyArgs {
  ...
  RdsDbProxyArgs({
    ...
    required pulumi.Output<int> dbProxyInstanceNum,
    ...
    required pulumi.Output<String> instanceNetworkType,
  ...
  factory RdsDbProxyArgs.fromMap(Map<String, dynamic> map) {
    return RdsDbProxyArgs(
      ...
      dbProxyInstanceNum: pulumi.Output.create<int>(map['dbProxyInstanceNum'] as int),
      ...
      instanceNetworkType: pulumi.Output.create<String>(map['instanceNetworkType'] as String),
