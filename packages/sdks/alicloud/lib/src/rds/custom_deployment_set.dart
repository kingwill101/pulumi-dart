...
import 'custom_deployment_set_state.dart';
...
class CustomDeploymentSet extends pulumi.CustomResource {
  ...
  static CustomDeploymentSet get(
    String name,
    pulumi.Input<String> id, {
    CustomDeploymentSetState? state,
  }) {
    return CustomDeploymentSet._get(
      name,
      state: state?.toMap(),
