...
class WhitelistTemplateState {
  ...
  factory WhitelistTemplateState.fromMap(Map<String, dynamic> map) {
    return WhitelistTemplateState(
      ipWhiteList: (() { final guardedValue = map['ipWhiteList']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
