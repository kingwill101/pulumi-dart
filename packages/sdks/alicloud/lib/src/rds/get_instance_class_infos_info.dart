...
class GetInstanceClassInfosInfo {
  ...
  factory GetInstanceClassInfosInfo.fromMap(Map<String, dynamic> map) {
    return GetInstanceClassInfosInfo(
      ...
      classGroup: (() { final guardedValue = map['classGroup']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      cpu: (() { final guardedValue = map['cpu']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      instructionSetArch: (() { final guardedValue = map['instructionSetArch']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      maxConnections: (() { final guardedValue = map['maxConnections']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      maxIombps: (() { final guardedValue = map['maxIombps']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      maxIops: (() { final guardedValue = map['maxIops']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      memoryClass: (() { final guardedValue = map['memoryClass']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      referencePrice: (() { final guardedValue = map['referencePrice']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
