...
class RdsCloneDbInstancePgHbaConf {
  ...
  /// Creates a new [RdsCloneDbInstancePgHbaConf].
  ...
  const RdsCloneDbInstancePgHbaConf({
  ...
  factory RdsCloneDbInstancePgHbaConf.fromMap(Map<String, dynamic> map) {
    return RdsCloneDbInstancePgHbaConf(
      ...
      priorityId: pulumi.Input.fromValue(map['priorityId'] as int),
