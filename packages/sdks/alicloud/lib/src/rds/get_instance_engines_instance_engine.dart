...
class GetInstanceEnginesInstanceEngine {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'zoneIds': pulumi.Input.mapInputValue<List<GetInstanceEnginesInstanceEngineZoneId>, List<Map<String, dynamic>>>(zoneIds, (value) => pulumi.Input.encodeList<GetInstanceEnginesInstanceEngineZoneId, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory GetInstanceEnginesInstanceEngine.fromMap(Map<String, dynamic> map) {
    return GetInstanceEnginesInstanceEngine(
      ...
      zoneIds: pulumi.Input.fromValue(pulumi.Input.decodeList<GetInstanceEnginesInstanceEngineZoneId>(map['zoneIds']!, (value) => GetInstanceEnginesInstanceEngineZoneId.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
