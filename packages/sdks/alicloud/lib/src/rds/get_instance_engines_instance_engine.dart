...
class GetInstanceEnginesInstanceEngine {
  ...
  factory GetInstanceEnginesInstanceEngine.fromMap(Map<String, dynamic> map) {
    return GetInstanceEnginesInstanceEngine(
      ...
      zoneIds: (pulumi.Input.decodeList<GetInstanceEnginesInstanceEngineZoneId>(map['zoneIds'], (value) => GetInstanceEnginesInstanceEngineZoneId.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
