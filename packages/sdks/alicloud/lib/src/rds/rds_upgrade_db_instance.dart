...
import 'rds_upgrade_db_instance_state.dart';
...
class RdsUpgradeDbInstance extends pulumi.CustomResource {
  ...
  RdsUpgradeDbInstance(
    ...
    collectStatMode = registerOutput<String>('collectStatMode');
    ...
    switchOver = registerOutput<String>('switchOver');
    switchTime = registerOutput<String?>('switchTime');
    switchTimeMode = registerOutput<String?>('switchTimeMode');
    syncMode = registerOutput<String>('syncMode');
    targetMajorVersion = registerOutput<String>('targetMajorVersion');
    tcpConnectionType = registerOutput<String>('tcpConnectionType');
    tdeStatus = registerOutput<String?>('tdeStatus');
    vpcId = registerOutput<String>('vpcId');
    vswitchId = registerOutput<String>('vswitchId');
    zoneId = registerOutput<String>('zoneId');
    zoneIdSlave1 = registerOutput<String>('zoneIdSlave1');
  }

  /// Gets an existing [RdsUpgradeDbInstance] resource's state with the given [name] and [id].
  static RdsUpgradeDbInstance get(
    String name,
    pulumi.Input<String> id, {
    RdsUpgradeDbInstanceState? state,
  }) {
    return RdsUpgradeDbInstance._get(
      name,
      state: state?.toMap(),
