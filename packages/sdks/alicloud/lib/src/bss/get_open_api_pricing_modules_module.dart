...
class GetOpenApiPricingModulesModule {
  ...
  factory GetOpenApiPricingModulesModule.fromMap(Map<String, dynamic> map) {
    return GetOpenApiPricingModulesModule(
      ...
      pricingModuleName: pulumi.Input.fromValue(map['pricingModuleName'] as String),
      ...
      values: pulumi.Input.fromValue(pulumi.Input.decodeList<GetOpenApiPricingModulesModuleValue>(map['values']!, (value) => GetOpenApiPricingModulesModuleValue.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
