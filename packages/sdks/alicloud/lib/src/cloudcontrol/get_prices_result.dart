...
class GetPricesResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'prices': pulumi.Input.encodeList<GetPricesPrice, Map<String, dynamic>>(
        prices,
        (value) => value.toMap(),
      ),
      'product': product,
  ...
  factory GetPricesResult.fromMap(Map<String, dynamic> map) {
    return GetPricesResult(
      ...
      prices: pulumi.Input.decodeList<GetPricesPrice>(
        map['prices']!,
        (value) =>
            GetPricesPrice.fromMap((value as Map).cast<String, dynamic>()),
      ),
