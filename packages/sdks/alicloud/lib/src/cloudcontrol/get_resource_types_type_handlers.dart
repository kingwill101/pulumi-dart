...
class GetResourceTypesTypeHandlers {
  ...
  factory GetResourceTypesTypeHandlers.fromMap(Map<String, dynamic> map) {
    return GetResourceTypesTypeHandlers(
      creates: (pulumi.Input.decodeList<GetResourceTypesTypeHandlersCreate>(map['creates'], (value) => GetResourceTypesTypeHandlersCreate.fromMap((value as Map).cast<String, dynamic>()))).input(),
      deletes: (pulumi.Input.decodeList<GetResourceTypesTypeHandlersDelete>(map['deletes'], (value) => GetResourceTypesTypeHandlersDelete.fromMap((value as Map).cast<String, dynamic>()))).input(),
      gets: (pulumi.Input.decodeList<GetResourceTypesTypeHandlersGet>(map['gets'], (value) => GetResourceTypesTypeHandlersGet.fromMap((value as Map).cast<String, dynamic>()))).input(),
      lists: (pulumi.Input.decodeList<GetResourceTypesTypeHandlersList>(map['lists'], (value) => GetResourceTypesTypeHandlersList.fromMap((value as Map).cast<String, dynamic>()))).input(),
      updates: (pulumi.Input.decodeList<GetResourceTypesTypeHandlersUpdate>(map['updates'], (value) => GetResourceTypesTypeHandlersUpdate.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
