...
class GetResourceTypesTypeHandlers {
    ...
    return <String, dynamic>{
      'creates':
          pulumi.Input.mapInputValue<
            List<GetResourceTypesTypeHandlersCreate>,
      ...
      'deletes':
          pulumi.Input.mapInputValue<
            List<GetResourceTypesTypeHandlersDelete>,
            List<Map<String, dynamic>>
          >(
            deletes,
            (value) =>
      ...
      'gets':
          pulumi.Input.mapInputValue<
            List<GetResourceTypesTypeHandlersGet>,
            List<Map<String, dynamic>>
          >(
            gets,
            (value) =>
      ...
      'lists':
          pulumi.Input.mapInputValue<
            List<GetResourceTypesTypeHandlersList>,
            List<Map<String, dynamic>>
          >(
            lists,
            (value) =>
      ...
      'updates':
          pulumi.Input.mapInputValue<
            List<GetResourceTypesTypeHandlersUpdate>,
            List<Map<String, dynamic>>
          >(
            updates,
            (value) =>
  ...
  factory GetResourceTypesTypeHandlers.fromMap(Map<String, dynamic> map) {
    return GetResourceTypesTypeHandlers(
      creates: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetResourceTypesTypeHandlersCreate>(
          map['creates']!,
          (value) => GetResourceTypesTypeHandlersCreate.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      deletes: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetResourceTypesTypeHandlersDelete>(
          map['deletes']!,
          (value) => GetResourceTypesTypeHandlersDelete.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      gets: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetResourceTypesTypeHandlersGet>(
          map['gets']!,
          (value) => GetResourceTypesTypeHandlersGet.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      lists: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetResourceTypesTypeHandlersList>(
          map['lists']!,
          (value) => GetResourceTypesTypeHandlersList.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      updates: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetResourceTypesTypeHandlersUpdate>(
          map['updates']!,
          (value) => GetResourceTypesTypeHandlersUpdate.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
