...
class AlertConfigurationConditionConfiguration {
  ...
  const AlertConfigurationConditionConfiguration({
    this.condition,
    this.countCondition,
  });
  ...
  factory AlertConfigurationConditionConfiguration.fromMap(Map<String, dynamic> map) {
    return AlertConfigurationConditionConfiguration(
      ...
      countCondition: (() { final guardedValue = map['countCondition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
