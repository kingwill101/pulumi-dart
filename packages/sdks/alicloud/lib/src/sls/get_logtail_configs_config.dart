...
class GetLogtailConfigsConfig {
  ...
  GetLogtailConfigsConfig({required this.id, required this.logtailConfigName});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'id': id, 'logtailConfigName': logtailConfigName};
  }

  factory GetLogtailConfigsConfig.fromMap(Map<String, dynamic> map) {
    return GetLogtailConfigsConfig(
      id: pulumi.Input.fromValue(map['id'] as String),
      logtailConfigName: pulumi.Input.fromValue(
        map['logtailConfigName'] as String,
      ),
    );
  }
}
