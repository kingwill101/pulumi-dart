...
class MachineGroupState {
  ...
  factory MachineGroupState.fromMap(Map<String, dynamic> map) {
    return MachineGroupState(
      groupAttribute: (() { final guardedValue = map['groupAttribute']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MachineGroupGroupAttribute.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      machineIdentifyType: (() { final guardedValue = map['machineIdentifyType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      machineLists: (() { final guardedValue = map['machineLists']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
