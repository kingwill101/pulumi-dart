...
class GetAlertsAlert {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'alertName': alertName,
      'configuration': pulumi.Input.mapInputValue<GetAlertsAlertConfiguration, Map<String, dynamic>>(configuration, (value) => value.toMap()),
      'description': description,
      'displayName': displayName,
      'id': id,
      'schedule': pulumi.Input.mapInputValue<GetAlertsAlertSchedule, Map<String, dynamic>>(schedule, (value) => value.toMap()),
    };
  }
  ...
  factory GetAlertsAlert.fromMap(Map<String, dynamic> map) {
    return GetAlertsAlert(
      ...
      configuration: pulumi.Input.fromValue(GetAlertsAlertConfiguration.fromMap((map['configuration']! as Map).cast<String, dynamic>())),
      description: pulumi.Input.fromValue(map['description'] as String),
      displayName: pulumi.Input.fromValue(map['displayName'] as String),
      id: pulumi.Input.fromValue(map['id'] as String),
      schedule: pulumi.Input.fromValue(GetAlertsAlertSchedule.fromMap((map['schedule']! as Map).cast<String, dynamic>())),
    );
  }
}
