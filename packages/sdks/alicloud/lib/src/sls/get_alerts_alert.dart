...
class GetAlertsAlert {
  ...
  factory GetAlertsAlert.fromMap(Map<String, dynamic> map) {
    return GetAlertsAlert(
      ...
      configuration: (GetAlertsAlertConfiguration.fromMap((map['configuration'] as Map).cast<String, dynamic>())).input(),
      description: (map['description'] as String).input(),
      displayName: (map['displayName'] as String).input(),
      id: (map['id'] as String).input(),
      schedule: (GetAlertsAlertSchedule.fromMap((map['schedule'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
