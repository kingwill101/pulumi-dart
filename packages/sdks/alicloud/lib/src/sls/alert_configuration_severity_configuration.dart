...
class AlertConfigurationSeverityConfiguration {
  ...
  final pulumi.Input<AlertConfigurationSeverityConfigurationEvalCondition>?
  evalCondition;
  ...
  AlertConfigurationSeverityConfiguration({this.evalCondition, this.severity});
  ...
  factory AlertConfigurationSeverityConfiguration.fromMap(
    Map<String, dynamic> map,
  ) {
    return AlertConfigurationSeverityConfiguration(
      evalCondition: (() {
        final guardedValue = map['evalCondition'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AlertConfigurationSeverityConfigurationEvalCondition.fromMap(
