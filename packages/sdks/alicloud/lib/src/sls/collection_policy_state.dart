...
class CollectionPolicyState {
  ...
  factory CollectionPolicyState.fromMap(Map<String, dynamic> map) {
    return CollectionPolicyState(
      ...
      dataCode: (() { final guardedValue = map['dataCode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      policyConfig: (() { final guardedValue = map['policyConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CollectionPolicyPolicyConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
