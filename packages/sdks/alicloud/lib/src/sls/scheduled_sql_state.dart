...
class ScheduledSqlState {
  ...
  factory ScheduledSqlState.fromMap(Map<String, dynamic> map) {
    return ScheduledSqlState(
      ...
      schedule: (() { final guardedValue = map['schedule']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ScheduledSqlSchedule.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      scheduledSqlConfiguration: (() { final guardedValue = map['scheduledSqlConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ScheduledSqlScheduledSqlConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      scheduledSqlName: (() { final guardedValue = map['scheduledSqlName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
