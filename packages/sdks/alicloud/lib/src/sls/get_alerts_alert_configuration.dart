...
class GetAlertsAlertConfiguration {
  ...
  final pulumi.Input<GetAlertsAlertConfigurationConditionConfiguration>
  ...
  final pulumi.Input<GetAlertsAlertConfigurationGroupConfiguration>
  groupConfiguration;

  /// Set operation configuration.
  final pulumi.Input<List<GetAlertsAlertConfigurationJoinConfiguration>>
  joinConfigurations;
  ...
  final pulumi.Input<GetAlertsAlertConfigurationPolicyConfiguration>
  policyConfiguration;
  ...
  final pulumi.Input<List<GetAlertsAlertConfigurationSeverityConfiguration>>
  ...
  final pulumi.Input<GetAlertsAlertConfigurationTemplateConfiguration>
    ...
    return <String, dynamic>{
      'annotations':
          pulumi.Input.mapInputValue<
            List<GetAlertsAlertConfigurationAnnotation>,
      ...
      'conditionConfiguration':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(conditionConfiguration, (value) => value.toMap()),
      'dashboard': dashboard,
      'groupConfiguration':
          pulumi.Input.mapInputValue<
      ...
      'joinConfigurations':
          pulumi.Input.mapInputValue<
            List<GetAlertsAlertConfigurationJoinConfiguration>,
            List<Map<String, dynamic>>
          >(
            joinConfigurations,
            (value) =>
      ...
      'labels':
          pulumi.Input.mapInputValue<
            List<GetAlertsAlertConfigurationLabel>,
            List<Map<String, dynamic>>
          >(
            labels,
            (value) =>
      ...
      'queryLists':
          pulumi.Input.mapInputValue<
            List<GetAlertsAlertConfigurationQueryList>,
            List<Map<String, dynamic>>
          >(
            queryLists,
            (value) =>
      ...
      'severityConfigurations':
          pulumi.Input.mapInputValue<
            List<GetAlertsAlertConfigurationSeverityConfiguration>,
            List<Map<String, dynamic>>
          >(
            severityConfigurations,
            (value) =>
      ...
      'sinkAlerthub':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(sinkAlerthub, (value) => value.toMap()),
      'sinkCms':
          pulumi.Input.mapInputValue<
            GetAlertsAlertConfigurationSinkCms,
            Map<String, dynamic>
          >(sinkCms, (value) => value.toMap()),
      'sinkEventStore':
          pulumi.Input.mapInputValue<
            GetAlertsAlertConfigurationSinkEventStore,
            Map<String, dynamic>
          >(sinkEventStore, (value) => value.toMap()),
      'tags': tags,
      'templateConfiguration':
          pulumi.Input.mapInputValue<
  ...
  factory GetAlertsAlertConfiguration.fromMap(Map<String, dynamic> map) {
    return GetAlertsAlertConfiguration(
      annotations: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetAlertsAlertConfigurationAnnotation>(
          map['annotations']!,
          (value) => GetAlertsAlertConfigurationAnnotation.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      autoAnnotation: pulumi.Input.fromValue(map['autoAnnotation'] as bool),
      conditionConfiguration: pulumi.Input.fromValue(
        GetAlertsAlertConfigurationConditionConfiguration.fromMap(
          (map['conditionConfiguration']! as Map).cast<String, dynamic>(),
        ),
      ),
      dashboard: pulumi.Input.fromValue(map['dashboard'] as String),
      groupConfiguration: pulumi.Input.fromValue(
        GetAlertsAlertConfigurationGroupConfiguration.fromMap(
          (map['groupConfiguration']! as Map).cast<String, dynamic>(),
        ),
      ),
      joinConfigurations: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetAlertsAlertConfigurationJoinConfiguration>(
          map['joinConfigurations']!,
          (value) => GetAlertsAlertConfigurationJoinConfiguration.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      labels: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetAlertsAlertConfigurationLabel>(
          map['labels']!,
          (value) => GetAlertsAlertConfigurationLabel.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      ...
      policyConfiguration: pulumi.Input.fromValue(
        GetAlertsAlertConfigurationPolicyConfiguration.fromMap(
          (map['policyConfiguration']! as Map).cast<String, dynamic>(),
        ),
      ),
      queryLists: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetAlertsAlertConfigurationQueryList>(
          map['queryLists']!,
          (value) => GetAlertsAlertConfigurationQueryList.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      sendResolved: pulumi.Input.fromValue(map['sendResolved'] as bool),
      severityConfigurations: pulumi.Input.fromValue(
        pulumi
            .Input.decodeList<GetAlertsAlertConfigurationSeverityConfiguration>(
          map['severityConfigurations']!,
          (value) => GetAlertsAlertConfigurationSeverityConfiguration.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      sinkAlerthub: pulumi.Input.fromValue(
        GetAlertsAlertConfigurationSinkAlerthub.fromMap(
          (map['sinkAlerthub']! as Map).cast<String, dynamic>(),
        ),
      ),
      sinkCms: pulumi.Input.fromValue(
        GetAlertsAlertConfigurationSinkCms.fromMap(
          (map['sinkCms']! as Map).cast<String, dynamic>(),
        ),
      ),
      sinkEventStore: pulumi.Input.fromValue(
        GetAlertsAlertConfigurationSinkEventStore.fromMap(
          (map['sinkEventStore']! as Map).cast<String, dynamic>(),
        ),
      ),
      tags: pulumi.Input.fromValue((map['tags'] as List).cast<String>()),
      templateConfiguration: pulumi.Input.fromValue(
        GetAlertsAlertConfigurationTemplateConfiguration.fromMap(
