...
class GetAlertsAlertConfiguration {
  ...
  factory GetAlertsAlertConfiguration.fromMap(Map<String, dynamic> map) {
    return GetAlertsAlertConfiguration(
      annotations: (pulumi.Input.decodeList<GetAlertsAlertConfigurationAnnotation>(map['annotations'], (value) => GetAlertsAlertConfigurationAnnotation.fromMap((value as Map).cast<String, dynamic>()))).input(),
      autoAnnotation: (map['autoAnnotation'] as bool).input(),
      conditionConfiguration: (GetAlertsAlertConfigurationConditionConfiguration.fromMap((map['conditionConfiguration'] as Map).cast<String, dynamic>())).input(),
      dashboard: (map['dashboard'] as String).input(),
      groupConfiguration: (GetAlertsAlertConfigurationGroupConfiguration.fromMap((map['groupConfiguration'] as Map).cast<String, dynamic>())).input(),
      joinConfigurations: (pulumi.Input.decodeList<GetAlertsAlertConfigurationJoinConfiguration>(map['joinConfigurations'], (value) => GetAlertsAlertConfigurationJoinConfiguration.fromMap((value as Map).cast<String, dynamic>()))).input(),
      labels: (pulumi.Input.decodeList<GetAlertsAlertConfigurationLabel>(map['labels'], (value) => GetAlertsAlertConfigurationLabel.fromMap((value as Map).cast<String, dynamic>()))).input(),
      muteUntil: (map['muteUntil'] as int).input(),
      noDataFire: (map['noDataFire'] as bool).input(),
      noDataSeverity: (map['noDataSeverity'] as int).input(),
      policyConfiguration: (GetAlertsAlertConfigurationPolicyConfiguration.fromMap((map['policyConfiguration'] as Map).cast<String, dynamic>())).input(),
      queryLists: (pulumi.Input.decodeList<GetAlertsAlertConfigurationQueryList>(map['queryLists'], (value) => GetAlertsAlertConfigurationQueryList.fromMap((value as Map).cast<String, dynamic>()))).input(),
      sendResolved: (map['sendResolved'] as bool).input(),
      severityConfigurations: (pulumi.Input.decodeList<GetAlertsAlertConfigurationSeverityConfiguration>(map['severityConfigurations'], (value) => GetAlertsAlertConfigurationSeverityConfiguration.fromMap((value as Map).cast<String, dynamic>()))).input(),
      sinkAlerthub: (GetAlertsAlertConfigurationSinkAlerthub.fromMap((map['sinkAlerthub'] as Map).cast<String, dynamic>())).input(),
      sinkCms: (GetAlertsAlertConfigurationSinkCms.fromMap((map['sinkCms'] as Map).cast<String, dynamic>())).input(),
      sinkEventStore: (GetAlertsAlertConfigurationSinkEventStore.fromMap((map['sinkEventStore'] as Map).cast<String, dynamic>())).input(),
      tags: ((map['tags'] as List).cast<String>()).input(),
      templateConfiguration: (GetAlertsAlertConfigurationTemplateConfiguration.fromMap((map['templateConfiguration'] as Map).cast<String, dynamic>())).input(),
