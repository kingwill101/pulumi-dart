...
class GetAlertsAlertConfigurationQueryList {
  ...
  factory GetAlertsAlertConfigurationQueryList.fromMap(
    ...
    return GetAlertsAlertConfigurationQueryList(
      ...
      powerSqlMode: pulumi.Input.fromValue(map['powerSqlMode'] as String),
      ...
      storeType: pulumi.Input.fromValue(map['storeType'] as String),
      timeSpanType: pulumi.Input.fromValue(map['timeSpanType'] as String),
      ui: pulumi.Input.fromValue(map['ui'] as String),
    );
  }
}
