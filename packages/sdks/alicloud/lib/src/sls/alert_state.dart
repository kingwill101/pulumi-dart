...
class AlertState {
  ...
  factory AlertState.fromMap(Map<String, dynamic> map) {
    return AlertState(
      ...
      configuration: (() { final guardedValue = map['configuration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AlertConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
