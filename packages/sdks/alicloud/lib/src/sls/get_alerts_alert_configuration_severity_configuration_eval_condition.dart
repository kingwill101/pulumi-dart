...
class GetAlertsAlertConfigurationSeverityConfigurationEvalCondition {
  ...
  /// Creates a new [GetAlertsAlertConfigurationSeverityConfigurationEvalCondition].
  ...
  const GetAlertsAlertConfigurationSeverityConfigurationEvalCondition({
  ...
  factory GetAlertsAlertConfigurationSeverityConfigurationEvalCondition.fromMap(Map<String, dynamic> map) {
    return GetAlertsAlertConfigurationSeverityConfigurationEvalCondition(
