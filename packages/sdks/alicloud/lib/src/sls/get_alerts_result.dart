...
class GetAlertsResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'alerts': pulumi.Input.encodeList<GetAlertsAlert, Map<String, dynamic>>(
        alerts,
        (value) => value.toMap(),
      ),
      'id': id,
  ...
  factory GetAlertsResult.fromMap(Map<String, dynamic> map) {
    return GetAlertsResult(
      alerts: pulumi.Input.decodeList<GetAlertsAlert>(
        map['alerts']!,
        (value) =>
            GetAlertsAlert.fromMap((value as Map).cast<String, dynamic>()),
      ),
      id: map['id'] as String,
