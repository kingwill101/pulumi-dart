...
class CollectionPolicyArgs {
    ...
    return <String, dynamic>{
      'centralizeConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(centralizeConfig, (value) => value.toMap()),
      ...
      'dataConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(dataConfig, (value) => value.toMap()),
      'enabled': enabled,
      'policyConfig':
          pulumi.Input.mapInputValue<
            CollectionPolicyPolicyConfig,
            Map<String, dynamic>
          >(policyConfig, (value) => value.toMap()),
      ...
      'resourceDirectory':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(resourceDirectory, (value) => value.toMap()),
    };
  }
  ...
  factory CollectionPolicyArgs.fromMap(Map<String, dynamic> map) {
    return CollectionPolicyArgs(
      centralizeConfig: (() {
        final guardedValue = map['centralizeConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CollectionPolicyCentralizeConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      centralizeEnabled: (() {
        final guardedValue = map['centralizeEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      dataCode: pulumi.Input.fromValue(map['dataCode'] as String),
      dataConfig: (() {
        final guardedValue = map['dataConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CollectionPolicyDataConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      enabled: pulumi.Input.fromValue(map['enabled'] as bool),
      policyConfig: pulumi.Input.fromValue(
        CollectionPolicyPolicyConfig.fromMap(
          (map['policyConfig']! as Map).cast<String, dynamic>(),
        ),
      ),
      policyName: pulumi.Input.fromValue(map['policyName'] as String),
      productCode: pulumi.Input.fromValue(map['productCode'] as String),
      resourceDirectory: (() {
        final guardedValue = map['resourceDirectory'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CollectionPolicyResourceDirectory.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
