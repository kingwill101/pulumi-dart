...
class DbInstanceState {
  ...
  factory DbInstanceState.fromMap(Map<String, dynamic> map) {
    return DbInstanceState(
      ...
      dbInstanceNetworkType: (() { final guardedValue = map['dbInstanceNetworkType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
