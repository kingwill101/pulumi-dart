...
class GetDbInstancesInstance {
  ...
  final pulumi.Input<List<GetDbInstancesInstanceDbInstanceIpArray>>
  dbInstanceIpArrays;
    ...
    return <String, dynamic>{
      ...
      'dbInstanceIpArrays':
          pulumi.Input.mapInputValue<
            List<GetDbInstancesInstanceDbInstanceIpArray>,
  ...
  factory GetDbInstancesInstance.fromMap(Map<String, dynamic> map) {
    return GetDbInstancesInstance(
      ...
      currentMinorVersion: pulumi.Input.fromValue(
        map['currentMinorVersion'] as String,
      ),
      dbInstanceCategory: pulumi.Input.fromValue(
        map['dbInstanceCategory'] as String,
      ),
      ...
      dbInstanceIpArrays: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetDbInstancesInstanceDbInstanceIpArray>(
          map['dbInstanceIpArrays']!,
          (value) => GetDbInstancesInstanceDbInstanceIpArray.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      dbInstanceMemory: pulumi.Input.fromValue(
        map['dbInstanceMemory'] as String,
      ),
      dbInstanceNetworkType: pulumi.Input.fromValue(
        map['dbInstanceNetworkType'] as String,
      ),
      ...
      latestMinorVersion: pulumi.Input.fromValue(
        map['latestMinorVersion'] as String,
      ),
      ...
      masterDbInstanceId: pulumi.Input.fromValue(
        map['masterDbInstanceId'] as String,
      ),
      ...
      readOnlyDbInstanceIds: pulumi.Input.fromValue(
        (map['readOnlyDbInstanceIds'] as List).cast<String>(),
      ),
