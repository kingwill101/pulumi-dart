...
class GetDbInstancesInstance {
  ...
  factory GetDbInstancesInstance.fromMap(Map<String, dynamic> map) {
    return GetDbInstancesInstance(
      ...
      currentMinorVersion: (map['currentMinorVersion'] as String).input(),
      dbInstanceCategory: (map['dbInstanceCategory'] as String).input(),
      dbInstanceCpu: (map['dbInstanceCpu'] as String).input(),
      dbInstanceDescription: (map['dbInstanceDescription'] as String).input(),
      dbInstanceId: (map['dbInstanceId'] as String).input(),
      dbInstanceIpArrays: (pulumi.Input.decodeList<GetDbInstancesInstanceDbInstanceIpArray>(map['dbInstanceIpArrays'], (value) => GetDbInstancesInstanceDbInstanceIpArray.fromMap((value as Map).cast<String, dynamic>()))).input(),
      dbInstanceMemory: (map['dbInstanceMemory'] as String).input(),
      ...
      latestMinorVersion: (map['latestMinorVersion'] as String).input(),
      ...
      masterDbInstanceId: (map['masterDbInstanceId'] as String).input(),
      paymentType: (map['paymentType'] as String).input(),
      port: (map['port'] as int).input(),
      publicConnectionString: (map['publicConnectionString'] as String).input(),
      publicPort: (map['publicPort'] as int).input(),
      readOnlyDbInstanceIds: ((map['readOnlyDbInstanceIds'] as List).cast<String>()).input(),
