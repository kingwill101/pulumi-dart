...
class FileSystem extends pulumi.CustomResource {
  ...
  FileSystem(
    ...
    this.encryptType = registerOutput<int>('encryptType');
    ...
    this.nfsAcl = registerOutput<FileSystemNfsAcl>('nfsAcl');
    this.options = registerOutput<FileSystemOptions>('options');
    this.protocolType = registerOutput<String>('protocolType');
    this.recycleBin = registerOutput<FileSystemRecycleBin>('recycleBin');
    this.redundancyType = registerOutput<String>('redundancyType');
    this.redundancyVswitchIds = registerOutput<List<String>?>('redundancyVswitchIds');
    this.regionId = registerOutput<String>('regionId');
    this.resourceGroupId = registerOutput<String>('resourceGroupId');
    this.smbAcl = registerOutput<FileSystemSmbAcl>('smbAcl');
