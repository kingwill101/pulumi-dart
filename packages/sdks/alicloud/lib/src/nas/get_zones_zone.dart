...
class GetZonesZone {
  ...
  factory GetZonesZone.fromMap(Map<String, dynamic> map) {
    return GetZonesZone(
      instanceTypes: pulumi.Input.fromValue(pulumi.Input.decodeList<GetZonesZoneInstanceType>(map['instanceTypes']!, (value) => GetZonesZoneInstanceType.fromMap((value as Map).cast<String, dynamic>()))),
