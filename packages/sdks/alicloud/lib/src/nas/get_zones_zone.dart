...
class GetZonesZone {
  ...
  GetZonesZone({required this.instanceTypes, required this.zoneId});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'instanceTypes':
          pulumi.Input.mapInputValue<
            List<GetZonesZoneInstanceType>,
  ...
  factory GetZonesZone.fromMap(Map<String, dynamic> map) {
    return GetZonesZone(
      instanceTypes: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetZonesZoneInstanceType>(
          map['instanceTypes']!,
          (value) => GetZonesZoneInstanceType.fromMap(
