...
class GetAccessRulesResult {
  ...
  factory GetAccessRulesResult.fromMap(Map<String, dynamic> map) {
    return GetAccessRulesResult(
      ...
      rwAccess: (() { final guardedValue = map['rwAccess']; if (guardedValue == null) return null; return guardedValue as String; })(),
      sourceCidrIp: (() { final guardedValue = map['sourceCidrIp']; if (guardedValue == null) return null; return guardedValue as String; })(),
      userAccess: (() { final guardedValue = map['userAccess']; if (guardedValue == null) return null; return guardedValue as String; })(),
    );
  }
}
