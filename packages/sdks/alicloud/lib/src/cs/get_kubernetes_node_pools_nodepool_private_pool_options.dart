...
class GetKubernetesNodePoolsNodepoolPrivatePoolOptions {
  ...
  const GetKubernetesNodePoolsNodepoolPrivatePoolOptions({
  ...
  factory GetKubernetesNodePoolsNodepoolPrivatePoolOptions.fromMap(Map<String, dynamic> map) {
    return GetKubernetesNodePoolsNodepoolPrivatePoolOptions(
      privatePoolOptionsId: pulumi.Input.fromValue(map['privatePoolOptionsId'] as String),
      privatePoolOptionsMatchCriteria: pulumi.Input.fromValue(map['privatePoolOptionsMatchCriteria'] as String),
    );
  }
}
