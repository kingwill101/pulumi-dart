...
import 'kubernetes_policy_instance_state.dart';
...
class KubernetesPolicyInstance extends pulumi.CustomResource {
  ...
  /// Gets an existing [KubernetesPolicyInstance] resource's state with the given [name] and [id].
  static KubernetesPolicyInstance get(
    String name,
    pulumi.Input<String> id, {
    KubernetesPolicyInstanceState? state,
  }) {
    return KubernetesPolicyInstance._get(
      name,
      state: state?.toMap(),
