...
class GetKubernetesVersionMetadata {
  ...
  factory GetKubernetesVersionMetadata.fromMap(Map<String, dynamic> map) {
    return GetKubernetesVersionMetadata(
      runtimes: (pulumi.Input.decodeList<GetKubernetesVersionMetadataRuntime>(map['runtimes'], (value) => GetKubernetesVersionMetadataRuntime.fromMap((value as Map).cast<String, dynamic>()))).input(),
