...
class GetKubernetesVersionMetadata {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'runtimes': pulumi.Input.mapInputValue<List<GetKubernetesVersionMetadataRuntime>, List<Map<String, dynamic>>>(runtimes, (value) => pulumi.Input.encodeList<GetKubernetesVersionMetadataRuntime, Map<String, dynamic>>(value, (value) => value.toMap())),
      'version': version,
    };
  }
  ...
  factory GetKubernetesVersionMetadata.fromMap(Map<String, dynamic> map) {
    return GetKubernetesVersionMetadata(
      runtimes: pulumi.Input.fromValue(pulumi.Input.decodeList<GetKubernetesVersionMetadataRuntime>(map['runtimes']!, (value) => GetKubernetesVersionMetadataRuntime.fromMap((value as Map).cast<String, dynamic>()))),
