...
class KubernetesAddonState {
  ...
  factory KubernetesAddonState.fromMap(Map<String, dynamic> map) {
    return KubernetesAddonState(
      canUpgrade: (() { final guardedValue = map['canUpgrade']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      cleanupCloudResources: (() { final guardedValue = map['cleanupCloudResources']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      nextVersion: (() { final guardedValue = map['nextVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
