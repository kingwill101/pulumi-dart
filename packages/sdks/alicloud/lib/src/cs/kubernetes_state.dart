...
class KubernetesState {
  ...
  factory KubernetesState.fromMap(Map<String, dynamic> map) {
    return KubernetesState(
      addons: (() { final guardedValue = map['addons']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<KubernetesAddon>(guardedValue, (value) => KubernetesAddon.fromMap((value as Map).cast<String, dynamic>()))); })(),
      apiAudiences: (() { final guardedValue = map['apiAudiences']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      certificateAuthority: (() { final guardedValue = map['certificateAuthority']; if (guardedValue == null) return null; return pulumi.Input.fromValue(KubernetesCertificateAuthority.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      connections: (() { final guardedValue = map['connections']; if (guardedValue == null) return null; return pulumi.Input.fromValue(KubernetesConnections.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      deleteOptions: (() { final guardedValue = map['deleteOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<KubernetesDeleteOption>(guardedValue, (value) => KubernetesDeleteOption.fromMap((value as Map).cast<String, dynamic>()))); })(),
      deletionProtection: (() { final guardedValue = map['deletionProtection']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      enableSsh: (() { final guardedValue = map['enableSsh']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      masterAutoRenew: (() { final guardedValue = map['masterAutoRenew']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      masterAutoRenewPeriod: (() { final guardedValue = map['masterAutoRenewPeriod']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      masterDiskCategory: (() { final guardedValue = map['masterDiskCategory']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      masterDiskPerformanceLevel: (() { final guardedValue = map['masterDiskPerformanceLevel']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      masterDiskSize: (() { final guardedValue = map['masterDiskSize']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      masterDiskSnapshotPolicyId: (() { final guardedValue = map['masterDiskSnapshotPolicyId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      masterInstanceChargeType: (() { final guardedValue = map['masterInstanceChargeType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      masterInstanceTypes: (() { final guardedValue = map['masterInstanceTypes']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      masterNodes: (() { final guardedValue = map['masterNodes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<KubernetesMasterNode>(guardedValue, (value) => KubernetesMasterNode.fromMap((value as Map).cast<String, dynamic>()))); })(),
      masterPeriod: (() { final guardedValue = map['masterPeriod']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      masterPeriodUnit: (() { final guardedValue = map['masterPeriodUnit']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      masterVswitchIds: (() { final guardedValue = map['masterVswitchIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      ...
      podVswitchIds: (() { final guardedValue = map['podVswitchIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      ...
      runtime: (() { final guardedValue = map['runtime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(KubernetesRuntime.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      serviceAccountIssuer: (() { final guardedValue = map['serviceAccountIssuer']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      userCa: (() { final guardedValue = map['userCa']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
