...
class KubernetesState {
  ...
  factory KubernetesState.fromMap(Map<String, dynamic> map) {
    return KubernetesState(
      ...
      certificateAuthority: map['certificateAuthority'] == null ? null : (KubernetesCertificateAuthority.fromMap((map['certificateAuthority'] as Map).cast<String, dynamic>())).input(),
      ...
      connections: map['connections'] == null ? null : (KubernetesConnections.fromMap((map['connections'] as Map).cast<String, dynamic>())).input(),
      ...
      masterInstanceTypes: map['masterInstanceTypes'] == null ? null : ((map['masterInstanceTypes'] as List).cast<String>()).input(),
      masterNodes: map['masterNodes'] == null ? null : (pulumi.Input.decodeList<KubernetesMasterNode>(map['masterNodes'], (value) => KubernetesMasterNode.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      masterVswitchIds: map['masterVswitchIds'] == null ? null : ((map['masterVswitchIds'] as List).cast<String>()).input(),
