...
class ServerlessKubernetesOperationPolicy {
  ...
  factory ServerlessKubernetesOperationPolicy.fromMap(Map<String, dynamic> map) {
    return ServerlessKubernetesOperationPolicy(
      clusterAutoUpgrade: (() { final guardedValue = map['clusterAutoUpgrade']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServerlessKubernetesOperationPolicyClusterAutoUpgrade.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
