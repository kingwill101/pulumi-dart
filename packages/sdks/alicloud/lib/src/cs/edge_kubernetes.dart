...
import 'edge_kubernetes_state.dart';
...
class EdgeKubernetes extends pulumi.CustomResource {
  ...
  /// Gets an existing [EdgeKubernetes] resource's state with the given [name] and [id].
  static EdgeKubernetes get(
    String name,
    pulumi.Input<String> id, {
    EdgeKubernetesState? state,
  }) {
    return EdgeKubernetes._get(
      name,
      state: state?.toMap(),
