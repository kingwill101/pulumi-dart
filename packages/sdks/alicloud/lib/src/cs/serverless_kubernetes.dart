...
class ServerlessKubernetes extends pulumi.CustomResource {
  ...
  late final pulumi.Output<ServerlessKubernetesMaintenanceWindow>
  maintenanceWindow;
  ...
  ServerlessKubernetes(
    ...
    endpointPublicAccessEnabled = registerOutput<bool?>(
    ...
    serviceDiscoveryTypes = registerOutput<List<String>?>(
