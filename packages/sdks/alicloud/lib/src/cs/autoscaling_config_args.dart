...
class AutoscalingConfigArgs {
  ...
  AutoscalingConfigArgs({
    ...
    pulumi.Output<bool>? daemonsetEvictionForNodes,
    pulumi.Output<String>? expander,
    pulumi.Output<String>? gpuUtilizationThreshold,
    pulumi.Output<int>? maxGracefulTerminationSec,
    pulumi.Output<int>? minReplicaCount,
    pulumi.Output<Map<String, String>>? priorities,
    pulumi.Output<bool>? recycleNodeDeletionEnabled,
    pulumi.Output<bool>? scaleDownEnabled,
    pulumi.Output<bool>? scaleUpFromZero,
    pulumi.Output<String>? scalerType,
    pulumi.Output<String>? scanInterval,
    pulumi.Output<bool>? skipNodesWithLocalStorage,
    pulumi.Output<bool>? skipNodesWithSystemPods,
    pulumi.Output<String>? unneededDuration,
    pulumi.Output<String>? utilizationThreshold,
  }) :
  ...
  factory AutoscalingConfigArgs.fromMap(Map<String, dynamic> map) {
    return AutoscalingConfigArgs(
      ...
      daemonsetEvictionForNodes: map['daemonsetEvictionForNodes'] == null ? null : pulumi.Output.create<bool>(map['daemonsetEvictionForNodes'] as bool),
      expander: map['expander'] == null ? null : pulumi.Output.create<String>(map['expander'] as String),
      gpuUtilizationThreshold: map['gpuUtilizationThreshold'] == null ? null : pulumi.Output.create<String>(map['gpuUtilizationThreshold'] as String),
      maxGracefulTerminationSec: map['maxGracefulTerminationSec'] == null ? null : pulumi.Output.create<int>(map['maxGracefulTerminationSec'] as int),
      minReplicaCount: map['minReplicaCount'] == null ? null : pulumi.Output.create<int>(map['minReplicaCount'] as int),
      priorities: map['priorities'] == null ? null : pulumi.Output.create<Map<String, String>>((map['priorities'] as Map).cast<String, String>()),
      recycleNodeDeletionEnabled: map['recycleNodeDeletionEnabled'] == null ? null : pulumi.Output.create<bool>(map['recycleNodeDeletionEnabled'] as bool),
      scaleDownEnabled: map['scaleDownEnabled'] == null ? null : pulumi.Output.create<bool>(map['scaleDownEnabled'] as bool),
      scaleUpFromZero: map['scaleUpFromZero'] == null ? null : pulumi.Output.create<bool>(map['scaleUpFromZero'] as bool),
      scalerType: map['scalerType'] == null ? null : pulumi.Output.create<String>(map['scalerType'] as String),
      scanInterval: map['scanInterval'] == null ? null : pulumi.Output.create<String>(map['scanInterval'] as String),
      skipNodesWithLocalStorage: map['skipNodesWithLocalStorage'] == null ? null : pulumi.Output.create<bool>(map['skipNodesWithLocalStorage'] as bool),
      skipNodesWithSystemPods: map['skipNodesWithSystemPods'] == null ? null : pulumi.Output.create<bool>(map['skipNodesWithSystemPods'] as bool),
      unneededDuration: map['unneededDuration'] == null ? null : pulumi.Output.create<String>(map['unneededDuration'] as String),
      utilizationThreshold: map['utilizationThreshold'] == null ? null : pulumi.Output.create<String>(map['utilizationThreshold'] as String),
    );
  }
}
