...
class AutoscalingConfigArgs {
  ...
  factory AutoscalingConfigArgs.fromMap(Map<String, dynamic> map) {
    return AutoscalingConfigArgs(
      ...
      coolDownDuration: (() { final guardedValue = map['coolDownDuration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      daemonsetEvictionForNodes: (() { final guardedValue = map['daemonsetEvictionForNodes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      gpuUtilizationThreshold: (() { final guardedValue = map['gpuUtilizationThreshold']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      maxGracefulTerminationSec: (() { final guardedValue = map['maxGracefulTerminationSec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      priorities: (() { final guardedValue = map['priorities']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      recycleNodeDeletionEnabled: (() { final guardedValue = map['recycleNodeDeletionEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      scaleDownEnabled: (() { final guardedValue = map['scaleDownEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      scaleUpFromZero: (() { final guardedValue = map['scaleUpFromZero']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      scalerType: (() { final guardedValue = map['scalerType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      unneededDuration: (() { final guardedValue = map['unneededDuration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      utilizationThreshold: (() { final guardedValue = map['utilizationThreshold']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
