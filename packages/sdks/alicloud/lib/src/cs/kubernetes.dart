...
class Kubernetes extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<KubernetesAddon>?> addons;
  ...
  late final pulumi.Output<List<KubernetesDeleteOption>?> deleteOptions;
  ...
  late final pulumi.Output<List<KubernetesMasterNode>> masterNodes;
  ...
  Kubernetes(
    ...
    this.addons = registerOutput<List<KubernetesAddon>?>('addons');
    this.apiAudiences = registerOutput<List<String>?>('apiAudiences');
    this.certificateAuthority = registerOutput<KubernetesCertificateAuthority>('certificateAuthority');
    ...
    this.connections = registerOutput<KubernetesConnections>('connections');
    this.customSan = registerOutput<String?>('customSan');
    this.deleteOptions = registerOutput<List<KubernetesDeleteOption>?>('deleteOptions');
    this.deletionProtection = registerOutput<bool?>('deletionProtection');
    this.enableSsh = registerOutput<bool?>('enableSsh');
    ...
    this.masterAutoRenew = registerOutput<bool?>('masterAutoRenew');
    this.masterAutoRenewPeriod = registerOutput<int?>('masterAutoRenewPeriod');
    this.masterDiskCategory = registerOutput<String?>('masterDiskCategory');
    this.masterDiskPerformanceLevel = registerOutput<String?>('masterDiskPerformanceLevel');
    this.masterDiskSize = registerOutput<int?>('masterDiskSize');
    this.masterDiskSnapshotPolicyId = registerOutput<String?>('masterDiskSnapshotPolicyId');
    this.masterInstanceChargeType = registerOutput<String?>('masterInstanceChargeType');
    this.masterInstanceTypes = registerOutput<List<String>>('masterInstanceTypes');
    this.masterNodes = registerOutput<List<KubernetesMasterNode>>('masterNodes');
    this.masterPeriod = registerOutput<int?>('masterPeriod');
    this.masterPeriodUnit = registerOutput<String?>('masterPeriodUnit');
    this.masterVswitchIds = registerOutput<List<String>>('masterVswitchIds');
    ...
    this.runtime = registerOutput<KubernetesRuntime?>('runtime');
