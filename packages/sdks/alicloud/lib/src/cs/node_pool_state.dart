...
class NodePoolState {
  ...
  factory NodePoolState.fromMap(Map<String, dynamic> map) {
    return NodePoolState(
      autoMode: map['autoMode'] == null ? null : (NodePoolAutoMode.fromMap((map['autoMode']! as Map).cast<String, dynamic>())).input(),
      autoRenew: map['autoRenew'] == null ? null : (map['autoRenew']! as bool).input(),
      autoRenewPeriod: map['autoRenewPeriod'] == null ? null : (map['autoRenewPeriod']! as int).input(),
      cisEnabled: map['cisEnabled'] == null ? null : (map['cisEnabled']! as bool).input(),
      clusterId: map['clusterId'] == null ? null : (map['clusterId']! as String).input(),
      compensateWithOnDemand: map['compensateWithOnDemand'] == null ? null : (map['compensateWithOnDemand']! as bool).input(),
      cpuPolicy: map['cpuPolicy'] == null ? null : (map['cpuPolicy']! as String).input(),
      dataDisks: map['dataDisks'] == null ? null : (pulumi.Input.decodeList<NodePoolDataDisk>(map['dataDisks']!, (value) => NodePoolDataDisk.fromMap((value as Map).cast<String, dynamic>()))).input(),
      deploymentSetId: map['deploymentSetId'] == null ? null : (map['deploymentSetId']! as String).input(),
      desiredSize: map['desiredSize'] == null ? null : (map['desiredSize']! as String).input(),
      efloNodeGroup: map['efloNodeGroup'] == null ? null : (NodePoolEfloNodeGroup.fromMap((map['efloNodeGroup']! as Map).cast<String, dynamic>())).input(),
      forceDelete: map['forceDelete'] == null ? null : (map['forceDelete']! as bool).input(),
      formatDisk: map['formatDisk'] == null ? null : (map['formatDisk']! as bool).input(),
      ...
      instanceMetadataOptions: map['instanceMetadataOptions'] == null ? null : (NodePoolInstanceMetadataOptions.fromMap((map['instanceMetadataOptions']! as Map).cast<String, dynamic>())).input(),
      instancePatterns: map['instancePatterns'] == null ? null : (pulumi.Input.decodeList<NodePoolInstancePattern>(map['instancePatterns']!, (value) => NodePoolInstancePattern.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      keepInstanceName: map['keepInstanceName'] == null ? null : (map['keepInstanceName']! as bool).input(),
      ...
      kubeletConfiguration: map['kubeletConfiguration'] == null ? null : (NodePoolKubeletConfiguration.fromMap((map['kubeletConfiguration']! as Map).cast<String, dynamic>())).input(),
      labels: map['labels'] == null ? null : (pulumi.Input.decodeList<NodePoolLabel>(map['labels']!, (value) => NodePoolLabel.fromMap((value as Map).cast<String, dynamic>()))).input(),
      loginAsNonRoot: map['loginAsNonRoot'] == null ? null : (map['loginAsNonRoot']! as bool).input(),
      management: map['management'] == null ? null : (NodePoolManagement.fromMap((map['management']! as Map).cast<String, dynamic>())).input(),
      ...
      nodePoolId: map['nodePoolId'] == null ? null : (map['nodePoolId']! as String).input(),
      nodePoolName: map['nodePoolName'] == null ? null : (map['nodePoolName']! as String).input(),
      onDemandBaseCapacity: map['onDemandBaseCapacity'] == null ? null : (map['onDemandBaseCapacity']! as String).input(),
      onDemandPercentageAboveBaseCapacity: map['onDemandPercentageAboveBaseCapacity'] == null ? null : (map['onDemandPercentageAboveBaseCapacity']! as String).input(),
      password: map['password'] == null ? null : (map['password']! as String).input(),
      period: map['period'] == null ? null : (map['period']! as int).input(),
      periodUnit: map['periodUnit'] == null ? null : (map['periodUnit']! as String).input(),
      platform: map['platform'] == null ? null : (map['platform']! as String).input(),
      preUserData: map['preUserData'] == null ? null : (map['preUserData']! as String).input(),
      privatePoolOptions: map['privatePoolOptions'] == null ? null : (NodePoolPrivatePoolOptions.fromMap((map['privatePoolOptions']! as Map).cast<String, dynamic>())).input(),
      ...
      rollingPolicy: map['rollingPolicy'] == null ? null : (NodePoolRollingPolicy.fromMap((map['rollingPolicy']! as Map).cast<String, dynamic>())).input(),
      runtimeName: map['runtimeName'] == null ? null : (map['runtimeName']! as String).input(),
      runtimeVersion: map['runtimeVersion'] == null ? null : (map['runtimeVersion']! as String).input(),
      scalingConfig: map['scalingConfig'] == null ? null : (NodePoolScalingConfig.fromMap((map['scalingConfig']! as Map).cast<String, dynamic>())).input(),
      ...
      securityHardeningOs: map['securityHardeningOs'] == null ? null : (map['securityHardeningOs']! as bool).input(),
      socEnabled: map['socEnabled'] == null ? null : (map['socEnabled']! as bool).input(),
      ...
      spotPriceLimits: map['spotPriceLimits'] == null ? null : (pulumi.Input.decodeList<NodePoolSpotPriceLimit>(map['spotPriceLimits']!, (value) => NodePoolSpotPriceLimit.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      systemDiskCategories: map['systemDiskCategories'] == null ? null : ((map['systemDiskCategories']! as List).cast<String>()).input(),
      ...
      systemDiskKmsKey: map['systemDiskKmsKey'] == null ? null : (map['systemDiskKmsKey']! as String).input(),
      ...
      systemDiskSnapshotPolicyId: map['systemDiskSnapshotPolicyId'] == null ? null : (map['systemDiskSnapshotPolicyId']! as String).input(),
      tags: map['tags'] == null ? null : ((map['tags']! as Map).cast<String, String>()).input(),
      taints: map['taints'] == null ? null : (pulumi.Input.decodeList<NodePoolTaint>(map['taints']!, (value) => NodePoolTaint.fromMap((value as Map).cast<String, dynamic>()))).input(),
      teeConfig: map['teeConfig'] == null ? null : (NodePoolTeeConfig.fromMap((map['teeConfig']! as Map).cast<String, dynamic>())).input(),
      type: map['type'] == null ? null : (map['type']! as String).input(),
      unschedulable: map['unschedulable'] == null ? null : (map['unschedulable']! as bool).input(),
      updateNodes: map['updateNodes'] == null ? null : (map['updateNodes']! as bool).input(),
      upgradePolicy: map['upgradePolicy'] == null ? null : (NodePoolUpgradePolicy.fromMap((map['upgradePolicy']! as Map).cast<String, dynamic>())).input(),
