...
class ManagedKubernetesOperationPolicy {
  ...
  final pulumi.Input<ManagedKubernetesOperationPolicyClusterAutoUpgrade>?
  clusterAutoUpgrade;
  ...
  ManagedKubernetesOperationPolicy({this.clusterAutoUpgrade});
    ...
    return ManagedKubernetesOperationPolicy(
      clusterAutoUpgrade: (() {
        ...
        return pulumi.Input.fromValue(
          ManagedKubernetesOperationPolicyClusterAutoUpgrade.fromMap(
