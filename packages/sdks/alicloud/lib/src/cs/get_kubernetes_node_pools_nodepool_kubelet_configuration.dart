...
class GetKubernetesNodePoolsNodepoolKubeletConfiguration {
  ...
  factory GetKubernetesNodePoolsNodepoolKubeletConfiguration.fromMap(Map<String, dynamic> map) {
    return GetKubernetesNodePoolsNodepoolKubeletConfiguration(
      ...
      clusterDns: pulumi.Input.fromValue((map['clusterDns'] as List).cast<String>()),
      containerLogMaxFiles: pulumi.Input.fromValue(map['containerLogMaxFiles'] as String),
      containerLogMaxSize: pulumi.Input.fromValue(map['containerLogMaxSize'] as String),
      containerLogMaxWorkers: pulumi.Input.fromValue(map['containerLogMaxWorkers'] as String),
      containerLogMonitorInterval: pulumi.Input.fromValue(map['containerLogMonitorInterval'] as String),
      ...
      evictionHard: pulumi.Input.fromValue((map['evictionHard'] as Map).cast<String, String>()),
      evictionSoft: pulumi.Input.fromValue((map['evictionSoft'] as Map).cast<String, String>()),
      evictionSoftGracePeriod: pulumi.Input.fromValue((map['evictionSoftGracePeriod'] as Map).cast<String, String>()),
      featureGates: pulumi.Input.fromValue((map['featureGates'] as Map).cast<String, String>()),
      imageGcHighThresholdPercent: pulumi.Input.fromValue(map['imageGcHighThresholdPercent'] as String),
      imageGcLowThresholdPercent: pulumi.Input.fromValue(map['imageGcLowThresholdPercent'] as String),
      kubeApiBurst: pulumi.Input.fromValue(map['kubeApiBurst'] as String),
      kubeApiQps: pulumi.Input.fromValue(map['kubeApiQps'] as String),
      kubeReserved: pulumi.Input.fromValue((map['kubeReserved'] as Map).cast<String, String>()),
      maxPods: pulumi.Input.fromValue(map['maxPods'] as String),
      memoryManagerPolicy: pulumi.Input.fromValue(map['memoryManagerPolicy'] as String),
      ...
      reservedMemories: pulumi.Input.fromValue(pulumi.Input.decodeList<GetKubernetesNodePoolsNodepoolKubeletConfigurationReservedMemory>(map['reservedMemories']!, (value) => GetKubernetesNodePoolsNodepoolKubeletConfigurationReservedMemory.fromMap((value as Map).cast<String, dynamic>()))),
      serializeImagePulls: pulumi.Input.fromValue(map['serializeImagePulls'] as String),
      systemReserved: pulumi.Input.fromValue((map['systemReserved'] as Map).cast<String, String>()),
      topologyManagerPolicy: pulumi.Input.fromValue(map['topologyManagerPolicy'] as String),
      tracing: pulumi.Input.fromValue(GetKubernetesNodePoolsNodepoolKubeletConfigurationTracing.fromMap((map['tracing']! as Map).cast<String, dynamic>())),
    );
  }
}
