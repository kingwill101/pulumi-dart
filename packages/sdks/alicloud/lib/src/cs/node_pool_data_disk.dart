...
class NodePoolDataDisk {
  ...
  factory NodePoolDataDisk.fromMap(Map<String, dynamic> map) {
    return NodePoolDataDisk(
      autoFormat: (() { final guardedValue = map['autoFormat']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      mountTarget: (() { final guardedValue = map['mountTarget']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
