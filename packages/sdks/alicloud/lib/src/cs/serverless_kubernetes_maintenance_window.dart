...
class ServerlessKubernetesMaintenanceWindow {
  ...
  factory ServerlessKubernetesMaintenanceWindow.fromMap(Map<String, dynamic> map) {
    return ServerlessKubernetesMaintenanceWindow(
      ...
      maintenanceTime: (() { final guardedValue = map['maintenanceTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      weeklyPeriod: (() { final guardedValue = map['weeklyPeriod']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
