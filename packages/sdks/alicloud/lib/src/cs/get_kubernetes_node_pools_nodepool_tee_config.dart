...
class GetKubernetesNodePoolsNodepoolTeeConfig {
  ...
  GetKubernetesNodePoolsNodepoolTeeConfig({required this.teeEnable});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'teeEnable': teeEnable};
  }

  factory GetKubernetesNodePoolsNodepoolTeeConfig.fromMap(
    Map<String, dynamic> map,
  ) {
    return GetKubernetesNodePoolsNodepoolTeeConfig(
      teeEnable: pulumi.Input.fromValue(map['teeEnable'] as bool),
    );
  }
}
