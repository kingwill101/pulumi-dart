...
class GetKubernetesNodePoolsNodepool {
  ...
  factory GetKubernetesNodePoolsNodepool.fromMap(Map<String, dynamic> map) {
    return GetKubernetesNodePoolsNodepool(
      ...
      dataDisks: pulumi.Input.fromValue(pulumi.Input.decodeList<GetKubernetesNodePoolsNodepoolDataDisk>(map['dataDisks']!, (value) => GetKubernetesNodePoolsNodepoolDataDisk.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      installCloudMonitor: pulumi.Input.fromValue(map['installCloudMonitor'] as bool),
      ...
      kubeletConfiguration: pulumi.Input.fromValue(GetKubernetesNodePoolsNodepoolKubeletConfiguration.fromMap((map['kubeletConfiguration']! as Map).cast<String, dynamic>())),
      labels: pulumi.Input.fromValue(pulumi.Input.decodeList<GetKubernetesNodePoolsNodepoolLabel>(map['labels']!, (value) => GetKubernetesNodePoolsNodepoolLabel.fromMap((value as Map).cast<String, dynamic>()))),
      loginAsNonRoot: pulumi.Input.fromValue(map['loginAsNonRoot'] as bool),
      management: pulumi.Input.fromValue(GetKubernetesNodePoolsNodepoolManagement.fromMap((map['management']! as Map).cast<String, dynamic>())),
      ...
      onDemandBaseCapacity: pulumi.Input.fromValue(map['onDemandBaseCapacity'] as String),
      onDemandPercentageAboveBaseCapacity: pulumi.Input.fromValue(map['onDemandPercentageAboveBaseCapacity'] as String),
      ...
      privatePoolOptions: pulumi.Input.fromValue(GetKubernetesNodePoolsNodepoolPrivatePoolOptions.fromMap((map['privatePoolOptions']! as Map).cast<String, dynamic>())),
      ramRoleName: pulumi.Input.fromValue(map['ramRoleName'] as String),
      rdsInstances: pulumi.Input.fromValue((map['rdsInstances'] as List).cast<String>()),
      ...
      scalingConfig: pulumi.Input.fromValue(GetKubernetesNodePoolsNodepoolScalingConfig.fromMap((map['scalingConfig']! as Map).cast<String, dynamic>())),
      ...
      securityHardeningOs: pulumi.Input.fromValue(map['securityHardeningOs'] as bool),
      ...
      spotPriceLimits: pulumi.Input.fromValue(pulumi.Input.decodeList<GetKubernetesNodePoolsNodepoolSpotPriceLimit>(map['spotPriceLimits']!, (value) => GetKubernetesNodePoolsNodepoolSpotPriceLimit.fromMap((value as Map).cast<String, dynamic>()))),
      spotStrategy: pulumi.Input.fromValue(map['spotStrategy'] as String),
      systemDiskBurstingEnabled: pulumi.Input.fromValue(map['systemDiskBurstingEnabled'] as bool),
      systemDiskCategories: pulumi.Input.fromValue((map['systemDiskCategories'] as List).cast<String>()),
      systemDiskCategory: pulumi.Input.fromValue(map['systemDiskCategory'] as String),
      systemDiskEncryptAlgorithm: pulumi.Input.fromValue(map['systemDiskEncryptAlgorithm'] as String),
      systemDiskEncrypted: pulumi.Input.fromValue(map['systemDiskEncrypted'] as bool),
      systemDiskKmsKey: pulumi.Input.fromValue(map['systemDiskKmsKey'] as String),
      systemDiskPerformanceLevel: pulumi.Input.fromValue(map['systemDiskPerformanceLevel'] as String),
      systemDiskProvisionedIops: pulumi.Input.fromValue(map['systemDiskProvisionedIops'] as int),
      systemDiskSize: pulumi.Input.fromValue(map['systemDiskSize'] as int),
      systemDiskSnapshotPolicyId: pulumi.Input.fromValue(map['systemDiskSnapshotPolicyId'] as String),
      tags: pulumi.Input.fromValue((map['tags'] as Map).cast<String, String>()),
      taints: pulumi.Input.fromValue(pulumi.Input.decodeList<GetKubernetesNodePoolsNodepoolTaint>(map['taints']!, (value) => GetKubernetesNodePoolsNodepoolTaint.fromMap((value as Map).cast<String, dynamic>()))),
      teeConfig: pulumi.Input.fromValue(GetKubernetesNodePoolsNodepoolTeeConfig.fromMap((map['teeConfig']! as Map).cast<String, dynamic>())),
