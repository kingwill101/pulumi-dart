...
class GetKubernetesNodePoolsNodepool {
  ...
  final pulumi.Input<GetKubernetesNodePoolsNodepoolKubeletConfiguration> kubeletConfiguration;
  ...
  final pulumi.Input<GetKubernetesNodePoolsNodepoolPrivatePoolOptions> privatePoolOptions;
  ...
  final pulumi.Input<List<GetKubernetesNodePoolsNodepoolSpotPriceLimit>> spotPriceLimits;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'cpuPolicy': cpuPolicy,
      'dataDisks': pulumi.Input.mapInputValue<List<GetKubernetesNodePoolsNodepoolDataDisk>, List<Map<String, dynamic>>>(dataDisks, (value) => pulumi.Input.encodeList<GetKubernetesNodePoolsNodepoolDataDisk, Map<String, dynamic>>(value, (value) => value.toMap())),
      ...
      'keyName': keyName,
      'kubeletConfiguration': pulumi.Input.mapInputValue<GetKubernetesNodePoolsNodepoolKubeletConfiguration, Map<String, dynamic>>(kubeletConfiguration, (value) => value.toMap()),
      'labels': pulumi.Input.mapInputValue<List<GetKubernetesNodePoolsNodepoolLabel>, List<Map<String, dynamic>>>(labels, (value) => pulumi.Input.encodeList<GetKubernetesNodePoolsNodepoolLabel, Map<String, dynamic>>(value, (value) => value.toMap())),
      'loginAsNonRoot': loginAsNonRoot,
      'management': pulumi.Input.mapInputValue<GetKubernetesNodePoolsNodepoolManagement, Map<String, dynamic>>(management, (value) => value.toMap()),
      ...
      'privatePoolOptions': pulumi.Input.mapInputValue<GetKubernetesNodePoolsNodepoolPrivatePoolOptions, Map<String, dynamic>>(privatePoolOptions, (value) => value.toMap()),
      'ramRoleName': ramRoleName,
      'rdsInstances': rdsInstances,
      'resourceGroupId': resourceGroupId,
      'runtimeName': runtimeName,
      'runtimeVersion': runtimeVersion,
      'scalingConfig': pulumi.Input.mapInputValue<GetKubernetesNodePoolsNodepoolScalingConfig, Map<String, dynamic>>(scalingConfig, (value) => value.toMap()),
      ...
      'spotPriceLimits': pulumi.Input.mapInputValue<List<GetKubernetesNodePoolsNodepoolSpotPriceLimit>, List<Map<String, dynamic>>>(spotPriceLimits, (value) => pulumi.Input.encodeList<GetKubernetesNodePoolsNodepoolSpotPriceLimit, Map<String, dynamic>>(value, (value) => value.toMap())),
      ...
      'tags': tags,
      'taints': pulumi.Input.mapInputValue<List<GetKubernetesNodePoolsNodepoolTaint>, List<Map<String, dynamic>>>(taints, (value) => pulumi.Input.encodeList<GetKubernetesNodePoolsNodepoolTaint, Map<String, dynamic>>(value, (value) => value.toMap())),
      'teeConfig': pulumi.Input.mapInputValue<GetKubernetesNodePoolsNodepoolTeeConfig, Map<String, dynamic>>(teeConfig, (value) => value.toMap()),
  ...
  factory GetKubernetesNodePoolsNodepool.fromMap(Map<String, dynamic> map) {
    return GetKubernetesNodePoolsNodepool(
      ...
      cisEnabled: (map['cisEnabled'] as bool).input(),
      compensateWithOnDemand: (map['compensateWithOnDemand'] as bool).input(),
      cpuPolicy: (map['cpuPolicy'] as String).input(),
      dataDisks: (pulumi.Input.decodeList<GetKubernetesNodePoolsNodepoolDataDisk>(map['dataDisks'], (value) => GetKubernetesNodePoolsNodepoolDataDisk.fromMap((value as Map).cast<String, dynamic>()))).input(),
      deploymentSetId: (map['deploymentSetId'] as String).input(),
      desiredSize: (map['desiredSize'] as String).input(),
      imageId: (map['imageId'] as String).input(),
      imageType: (map['imageType'] as String).input(),
      installCloudMonitor: (map['installCloudMonitor'] as bool).input(),
      ...
      kubeletConfiguration: (GetKubernetesNodePoolsNodepoolKubeletConfiguration.fromMap((map['kubeletConfiguration'] as Map).cast<String, dynamic>())).input(),
      labels: (pulumi.Input.decodeList<GetKubernetesNodePoolsNodepoolLabel>(map['labels'], (value) => GetKubernetesNodePoolsNodepoolLabel.fromMap((value as Map).cast<String, dynamic>()))).input(),
      loginAsNonRoot: (map['loginAsNonRoot'] as bool).input(),
      management: (GetKubernetesNodePoolsNodepoolManagement.fromMap((map['management'] as Map).cast<String, dynamic>())).input(),
      multiAzPolicy: (map['multiAzPolicy'] as String).input(),
      nodeNameMode: (map['nodeNameMode'] as String).input(),
      nodePoolId: (map['nodePoolId'] as String).input(),
      nodePoolName: (map['nodePoolName'] as String).input(),
      onDemandBaseCapacity: (map['onDemandBaseCapacity'] as String).input(),
      onDemandPercentageAboveBaseCapacity: (map['onDemandPercentageAboveBaseCapacity'] as String).input(),
      password: (map['password'] as String).input(),
      period: (map['period'] as int).input(),
      periodUnit: (map['periodUnit'] as String).input(),
      platform: (map['platform'] as String).input(),
      preUserData: (map['preUserData'] as String).input(),
      privatePoolOptions: (GetKubernetesNodePoolsNodepoolPrivatePoolOptions.fromMap((map['privatePoolOptions'] as Map).cast<String, dynamic>())).input(),
      ramRoleName: (map['ramRoleName'] as String).input(),
      rdsInstances: ((map['rdsInstances'] as List).cast<String>()).input(),
      resourceGroupId: (map['resourceGroupId'] as String).input(),
      runtimeName: (map['runtimeName'] as String).input(),
      runtimeVersion: (map['runtimeVersion'] as String).input(),
      scalingConfig: (GetKubernetesNodePoolsNodepoolScalingConfig.fromMap((map['scalingConfig'] as Map).cast<String, dynamic>())).input(),
      ...
      securityHardeningOs: (map['securityHardeningOs'] as bool).input(),
      socEnabled: (map['socEnabled'] as bool).input(),
      spotInstancePools: (map['spotInstancePools'] as int).input(),
      spotInstanceRemedy: (map['spotInstanceRemedy'] as bool).input(),
      spotPriceLimits: (pulumi.Input.decodeList<GetKubernetesNodePoolsNodepoolSpotPriceLimit>(map['spotPriceLimits'], (value) => GetKubernetesNodePoolsNodepoolSpotPriceLimit.fromMap((value as Map).cast<String, dynamic>()))).input(),
      spotStrategy: (map['spotStrategy'] as String).input(),
      systemDiskBurstingEnabled: (map['systemDiskBurstingEnabled'] as bool).input(),
      systemDiskCategories: ((map['systemDiskCategories'] as List).cast<String>()).input(),
      systemDiskCategory: (map['systemDiskCategory'] as String).input(),
      systemDiskEncryptAlgorithm: (map['systemDiskEncryptAlgorithm'] as String).input(),
      systemDiskEncrypted: (map['systemDiskEncrypted'] as bool).input(),
      systemDiskKmsKey: (map['systemDiskKmsKey'] as String).input(),
      systemDiskPerformanceLevel: (map['systemDiskPerformanceLevel'] as String).input(),
      systemDiskProvisionedIops: (map['systemDiskProvisionedIops'] as int).input(),
      systemDiskSize: (map['systemDiskSize'] as int).input(),
      systemDiskSnapshotPolicyId: (map['systemDiskSnapshotPolicyId'] as String).input(),
      tags: ((map['tags'] as Map).cast<String, String>()).input(),
      taints: (pulumi.Input.decodeList<GetKubernetesNodePoolsNodepoolTaint>(map['taints'], (value) => GetKubernetesNodePoolsNodepoolTaint.fromMap((value as Map).cast<String, dynamic>()))).input(),
      teeConfig: (GetKubernetesNodePoolsNodepoolTeeConfig.fromMap((map['teeConfig'] as Map).cast<String, dynamic>())).input(),
      unschedulable: (map['unschedulable'] as bool).input(),
