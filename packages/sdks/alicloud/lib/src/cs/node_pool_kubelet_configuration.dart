...
class NodePoolKubeletConfiguration {
  ...
  final pulumi.Input<List<NodePoolKubeletConfigurationReservedMemory>>?
  reservedMemories;
    ...
    return <String, dynamic>{
      ...
      'reservedMemories':
          ?pulumi.Input.mapOptionalInputValue<
            List<NodePoolKubeletConfigurationReservedMemory>,
  ...
  factory NodePoolKubeletConfiguration.fromMap(Map<String, dynamic> map) {
    return NodePoolKubeletConfiguration(
      ...
      containerLogMaxWorkers: (() {
        final guardedValue = map['containerLogMaxWorkers'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      containerLogMonitorInterval: (() {
        final guardedValue = map['containerLogMonitorInterval'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      cpuCfsQuota: (() {
      ...
      eventBurst: (() {
        final guardedValue = map['eventBurst'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      eventRecordQps: (() {
        final guardedValue = map['eventRecordQps'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      evictionHard: (() {
        final guardedValue = map['evictionHard'];
        if (guardedValue == null) return null;
      ...
      featureGates: (() {
        final guardedValue = map['featureGates'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      kubeApiBurst: (() {
        final guardedValue = map['kubeApiBurst'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      kubeApiQps: (() {
        final guardedValue = map['kubeApiQps'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      kubeReserved: (() {
        final guardedValue = map['kubeReserved'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as Map).cast<String, String>(),
        );
      ...
      memoryManagerPolicy: (() {
        final guardedValue = map['memoryManagerPolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      podPidsLimit: (() {
      ...
      readOnlyPort: (() {
        final guardedValue = map['readOnlyPort'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      registryBurst: (() {
      ...
      reservedMemories: (() {
        final guardedValue = map['reservedMemories'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NodePoolKubeletConfigurationReservedMemory>(
            guardedValue,
            (value) => NodePoolKubeletConfigurationReservedMemory.fromMap(
      ...
      serializeImagePulls: (() {
        final guardedValue = map['serializeImagePulls'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      serverTlsBootstrap: (() {
        final guardedValue = map['serverTlsBootstrap'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      systemReserved: (() {
        final guardedValue = map['systemReserved'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as Map).cast<String, String>(),
        );
      ...
      tracing: (() {
        final guardedValue = map['tracing'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          NodePoolKubeletConfigurationTracing.fromMap(
