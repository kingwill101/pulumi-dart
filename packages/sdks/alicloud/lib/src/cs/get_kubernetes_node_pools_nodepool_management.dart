...
class GetKubernetesNodePoolsNodepoolManagement {
  ...
  const GetKubernetesNodePoolsNodepoolManagement({
  ...
  factory GetKubernetesNodePoolsNodepoolManagement.fromMap(Map<String, dynamic> map) {
    return GetKubernetesNodePoolsNodepoolManagement(
      ...
      autoRepairPolicy: pulumi.Input.fromValue(GetKubernetesNodePoolsNodepoolManagementAutoRepairPolicy.fromMap((map['autoRepairPolicy']! as Map).cast<String, dynamic>())),
      autoUpgrade: pulumi.Input.fromValue(map['autoUpgrade'] as bool),
      autoUpgradePolicy: pulumi.Input.fromValue(GetKubernetesNodePoolsNodepoolManagementAutoUpgradePolicy.fromMap((map['autoUpgradePolicy']! as Map).cast<String, dynamic>())),
      autoVulFix: pulumi.Input.fromValue(map['autoVulFix'] as bool),
      autoVulFixPolicy: pulumi.Input.fromValue(GetKubernetesNodePoolsNodepoolManagementAutoVulFixPolicy.fromMap((map['autoVulFixPolicy']! as Map).cast<String, dynamic>())),
