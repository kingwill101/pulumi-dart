...
class NodePool extends pulumi.CustomResource {
  ...
  NodePool(
    ...
    autoMode = registerOutput<NodePoolAutoMode>('autoMode', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return NodePoolAutoMode.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    efloNodeGroup = registerOutput<NodePoolEfloNodeGroup?>('efloNodeGroup', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return NodePoolEfloNodeGroup.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    instanceMetadataOptions = registerOutput<NodePoolInstanceMetadataOptions>('instanceMetadataOptions', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return NodePoolInstanceMetadataOptions.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    instancePatterns = registerOutput<List<Map<String, dynamic>>?>('instancePatterns');
    ...
    kubeletConfiguration = registerOutput<NodePoolKubeletConfiguration?>('kubeletConfiguration', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return NodePoolKubeletConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    onDemandPercentageAboveBaseCapacity = registerOutput<String?>('onDemandPercentageAboveBaseCapacity');
    ...
    privatePoolOptions = registerOutput<NodePoolPrivatePoolOptions?>('privatePoolOptions', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return NodePoolPrivatePoolOptions.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ramRoleName = registerOutput<String>('ramRoleName');
    rdsInstances = registerOutput<List<String>?>('rdsInstances');
    resourceGroupId = registerOutput<String>('resourceGroupId');
    rollingPolicy = registerOutput<NodePoolRollingPolicy?>('rollingPolicy', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return NodePoolRollingPolicy.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    runtimeName = registerOutput<String>('runtimeName');
    runtimeVersion = registerOutput<String>('runtimeVersion');
    scalingConfig = registerOutput<NodePoolScalingConfig>('scalingConfig', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return NodePoolScalingConfig.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    systemDiskSnapshotPolicyId = registerOutput<String?>('systemDiskSnapshotPolicyId');
    tags = registerOutput<Map<String, String>?>('tags');
    taints = registerOutput<List<Map<String, dynamic>>?>('taints');
    teeConfig = registerOutput<NodePoolTeeConfig>('teeConfig', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return NodePoolTeeConfig.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    type = registerOutput<String>('type');
    unschedulable = registerOutput<bool?>('unschedulable');
    updateNodes = registerOutput<bool?>('updateNodes');
    upgradePolicy = registerOutput<NodePoolUpgradePolicy?>('upgradePolicy', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return NodePoolUpgradePolicy.fromMap((guardedValue as Map).cast<String, dynamic>()); });
