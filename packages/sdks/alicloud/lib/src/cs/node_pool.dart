...
class NodePool extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<NodePoolDataDisk>?> dataDisks;
  ...
  late final pulumi.Output<NodePoolInstanceMetadataOptions> instanceMetadataOptions;
  /// Instance property configuration. See `instance_patterns` below.
  late final pulumi.Output<List<NodePoolInstancePattern>?> instancePatterns;
  ...
  late final pulumi.Output<List<NodePoolLabel>?> labels;
  ...
  late final pulumi.Output<List<NodePoolSpotPriceLimit>?> spotPriceLimits;
  ...
  late final pulumi.Output<List<NodePoolTaint>?> taints;
  ...
  NodePool(
    ...
    this.autoMode = registerOutput<NodePoolAutoMode>('autoMode');
    this.autoRenew = registerOutput<bool?>('autoRenew');
    this.autoRenewPeriod = registerOutput<int?>('autoRenewPeriod');
    this.cisEnabled = registerOutput<bool?>('cisEnabled');
    this.clusterId = registerOutput<String>('clusterId');
    this.compensateWithOnDemand = registerOutput<bool?>('compensateWithOnDemand');
    this.cpuPolicy = registerOutput<String>('cpuPolicy');
    this.dataDisks = registerOutput<List<NodePoolDataDisk>?>('dataDisks');
    this.deploymentSetId = registerOutput<String?>('deploymentSetId');
    this.desiredSize = registerOutput<String?>('desiredSize');
    this.efloNodeGroup = registerOutput<NodePoolEfloNodeGroup?>('efloNodeGroup');
    this.forceDelete = registerOutput<bool?>('forceDelete');
    this.formatDisk = registerOutput<bool>('formatDisk');
    ...
    this.instanceMetadataOptions = registerOutput<NodePoolInstanceMetadataOptions>('instanceMetadataOptions');
    this.instancePatterns = registerOutput<List<NodePoolInstancePattern>?>('instancePatterns');
    ...
    this.keepInstanceName = registerOutput<bool>('keepInstanceName');
    ...
    this.kubeletConfiguration = registerOutput<NodePoolKubeletConfiguration?>('kubeletConfiguration');
    this.labels = registerOutput<List<NodePoolLabel>?>('labels');
    this.loginAsNonRoot = registerOutput<bool?>('loginAsNonRoot');
    ...
    this.nodeNameMode = registerOutput<String>('nodeNameMode');
    this.nodePoolId = registerOutput<String>('nodePoolId');
    this.nodePoolName = registerOutput<String>('nodePoolName');
    this.onDemandBaseCapacity = registerOutput<String?>('onDemandBaseCapacity');
    this.onDemandPercentageAboveBaseCapacity = registerOutput<String?>('onDemandPercentageAboveBaseCapacity');
    this.password = registerOutput<String?>('password');
    this.period = registerOutput<int?>('period');
    this.periodUnit = registerOutput<String?>('periodUnit');
    this.platform = registerOutput<String>('platform');
    this.preUserData = registerOutput<String?>('preUserData');
    this.privatePoolOptions = registerOutput<NodePoolPrivatePoolOptions?>('privatePoolOptions');
    this.ramRoleName = registerOutput<String>('ramRoleName');
    this.rdsInstances = registerOutput<List<String>?>('rdsInstances');
    this.resourceGroupId = registerOutput<String>('resourceGroupId');
    this.rollingPolicy = registerOutput<NodePoolRollingPolicy?>('rollingPolicy');
    this.runtimeName = registerOutput<String>('runtimeName');
    this.runtimeVersion = registerOutput<String>('runtimeVersion');
    this.scalingConfig = registerOutput<NodePoolScalingConfig>('scalingConfig');
    ...
    this.securityHardeningOs = registerOutput<bool?>('securityHardeningOs');
    this.socEnabled = registerOutput<bool?>('socEnabled');
    ...
    this.spotPriceLimits = registerOutput<List<NodePoolSpotPriceLimit>?>('spotPriceLimits');
    this.spotStrategy = registerOutput<String>('spotStrategy');
    this.systemDiskBurstingEnabled = registerOutput<bool?>('systemDiskBurstingEnabled');
    this.systemDiskCategories = registerOutput<List<String>>('systemDiskCategories');
    this.systemDiskCategory = registerOutput<String>('systemDiskCategory');
    this.systemDiskEncryptAlgorithm = registerOutput<String?>('systemDiskEncryptAlgorithm');
    this.systemDiskEncrypted = registerOutput<bool?>('systemDiskEncrypted');
    this.systemDiskKmsKey = registerOutput<String?>('systemDiskKmsKey');
    this.systemDiskPerformanceLevel = registerOutput<String?>('systemDiskPerformanceLevel');
    this.systemDiskProvisionedIops = registerOutput<int?>('systemDiskProvisionedIops');
    this.systemDiskSize = registerOutput<int?>('systemDiskSize');
    this.systemDiskSnapshotPolicyId = registerOutput<String?>('systemDiskSnapshotPolicyId');
    this.tags = registerOutput<Map<String, String>?>('tags');
    this.taints = registerOutput<List<NodePoolTaint>?>('taints');
    this.teeConfig = registerOutput<NodePoolTeeConfig>('teeConfig');
    this.type = registerOutput<String>('type');
    this.unschedulable = registerOutput<bool?>('unschedulable');
    this.updateNodes = registerOutput<bool?>('updateNodes');
    this.upgradePolicy = registerOutput<NodePoolUpgradePolicy?>('upgradePolicy');
