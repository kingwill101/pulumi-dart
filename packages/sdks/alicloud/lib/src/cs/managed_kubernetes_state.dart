...
class ManagedKubernetesState {
  ...
  factory ManagedKubernetesState.fromMap(Map<String, dynamic> map) {
    return ManagedKubernetesState(
      addons: (() { final guardedValue = map['addons']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ManagedKubernetesAddon>(guardedValue, (value) => ManagedKubernetesAddon.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      auditLogConfig: (() { final guardedValue = map['auditLogConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagedKubernetesAuditLogConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      autoMode: (() { final guardedValue = map['autoMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagedKubernetesAutoMode.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      certificateAuthority: (() { final guardedValue = map['certificateAuthority']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagedKubernetesCertificateAuthority.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      connections: (() { final guardedValue = map['connections']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagedKubernetesConnections.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      controlPlaneLogComponents: (() { final guardedValue = map['controlPlaneLogComponents']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      controlPlaneLogProject: (() { final guardedValue = map['controlPlaneLogProject']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      controlPlaneLogTtl: (() { final guardedValue = map['controlPlaneLogTtl']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      deleteOptions: (() { final guardedValue = map['deleteOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ManagedKubernetesDeleteOption>(guardedValue, (value) => ManagedKubernetesDeleteOption.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      encryptionProviderKey: (() { final guardedValue = map['encryptionProviderKey']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ipStack: (() { final guardedValue = map['ipStack']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      maintenanceWindow: (() { final guardedValue = map['maintenanceWindow']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagedKubernetesMaintenanceWindow.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      operationPolicy: (() { final guardedValue = map['operationPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagedKubernetesOperationPolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      rrsaMetadata: (() { final guardedValue = map['rrsaMetadata']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagedKubernetesRrsaMetadata.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      upgradePolicy: (() { final guardedValue = map['upgradePolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagedKubernetesUpgradePolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
