...
class SwarmState {
  ...
  SwarmState({
    ...
    pulumi.Output<List<SwarmNode>>? nodes,
    ...
    pulumi.Output<String>? vswitchId,
      ...
      nodes = pulumi.Input.asOptionalInput<List<SwarmNode>>(nodes),
  ...
  factory SwarmState.fromMap(Map<String, dynamic> map) {
    return SwarmState(
      ...
      nodes: map['nodes'] == null ? null : pulumi.Output.create<List<SwarmNode>>(pulumi.Input.decodeList<SwarmNode>(map['nodes'], (value) => SwarmNode.fromMap((value as Map).cast<String, dynamic>()))),
