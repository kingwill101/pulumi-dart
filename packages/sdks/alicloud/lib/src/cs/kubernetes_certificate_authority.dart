...
class KubernetesCertificateAuthority {
  ...
  /// Creates a new [KubernetesCertificateAuthority].
  ...
  const KubernetesCertificateAuthority({
    this.clientCert,
    this.clientKey,
    this.clusterCert,
  });
  ...
  factory KubernetesCertificateAuthority.fromMap(Map<String, dynamic> map) {
    return KubernetesCertificateAuthority(
      ...
      clusterCert: (() { final guardedValue = map['clusterCert']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
