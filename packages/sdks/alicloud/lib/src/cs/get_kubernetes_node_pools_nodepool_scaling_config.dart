...
class GetKubernetesNodePoolsNodepoolScalingConfig {
  ...
  factory GetKubernetesNodePoolsNodepoolScalingConfig.fromMap(
    Map<String, dynamic> map,
  ) {
    return GetKubernetesNodePoolsNodepoolScalingConfig(
      eipBandwidth: pulumi.Input.fromValue(map['eipBandwidth'] as int),
      eipInternetChargeType: pulumi.Input.fromValue(
        map['eipInternetChargeType'] as String,
      ),
      enable: pulumi.Input.fromValue(map['enable'] as bool),
      isBondEip: pulumi.Input.fromValue(map['isBondEip'] as bool),
