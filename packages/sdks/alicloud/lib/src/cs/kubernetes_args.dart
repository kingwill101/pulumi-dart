...
class KubernetesArgs {
  ...
  factory KubernetesArgs.fromMap(Map<String, dynamic> map) {
    return KubernetesArgs(
      ...
      masterInstanceTypes: pulumi.Input.fromValue((map['masterInstanceTypes'] as List).cast<String>()),
      ...
      masterVswitchIds: pulumi.Input.fromValue((map['masterVswitchIds'] as List).cast<String>()),
