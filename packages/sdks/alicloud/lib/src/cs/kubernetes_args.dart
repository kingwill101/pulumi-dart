...
class KubernetesArgs {
  ...
  KubernetesArgs({
    ...
    required pulumi.Output<List<String>> masterInstanceTypes,
    pulumi.Output<int>? masterPeriod,
    pulumi.Output<String>? masterPeriodUnit,
    required pulumi.Output<List<String>> masterVswitchIds,
  ...
  factory KubernetesArgs.fromMap(Map<String, dynamic> map) {
    return KubernetesArgs(
      ...
      masterInstanceTypes: pulumi.Output.create<List<String>>((map['masterInstanceTypes'] as List).cast<String>()),
      ...
      masterVswitchIds: pulumi.Output.create<List<String>>((map['masterVswitchIds'] as List).cast<String>()),
