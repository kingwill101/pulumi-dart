...
class ServerlessKubernetesState {
  ...
  ServerlessKubernetesState({
    ...
    pulumi.Output<ServerlessKubernetesRrsaMetadata>? rrsaMetadata,
    ...
    pulumi.Output<String>? zoneId,
      ...
      rrsaMetadata = pulumi.Input.asOptionalInput<ServerlessKubernetesRrsaMetadata>(rrsaMetadata),
  ...
  factory ServerlessKubernetesState.fromMap(Map<String, dynamic> map) {
    return ServerlessKubernetesState(
      ...
      rrsaMetadata: map['rrsaMetadata'] == null ? null : pulumi.Output.create<ServerlessKubernetesRrsaMetadata>(ServerlessKubernetesRrsaMetadata.fromMap((map['rrsaMetadata'] as Map).cast<String, dynamic>())),
