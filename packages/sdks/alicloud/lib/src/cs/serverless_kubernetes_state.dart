...
class ServerlessKubernetesState {
  ...
  factory ServerlessKubernetesState.fromMap(Map<String, dynamic> map) {
    return ServerlessKubernetesState(
      addons: (() { final guardedValue = map['addons']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ServerlessKubernetesAddon>(guardedValue, (value) => ServerlessKubernetesAddon.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      customSan: (() { final guardedValue = map['customSan']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      deleteOptions: (() { final guardedValue = map['deleteOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ServerlessKubernetesDeleteOption>(guardedValue, (value) => ServerlessKubernetesDeleteOption.fromMap((value as Map).cast<String, dynamic>()))); })(),
      deletionProtection: (() { final guardedValue = map['deletionProtection']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      enableRrsa: (() { final guardedValue = map['enableRrsa']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      endpointPublicAccessEnabled: (() { final guardedValue = map['endpointPublicAccessEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      loggingType: (() { final guardedValue = map['loggingType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      maintenanceWindow: (() { final guardedValue = map['maintenanceWindow']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServerlessKubernetesMaintenanceWindow.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      operationPolicy: (() { final guardedValue = map['operationPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServerlessKubernetesOperationPolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      privateZone: (() { final guardedValue = map['privateZone']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      rrsaMetadata: (() { final guardedValue = map['rrsaMetadata']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServerlessKubernetesRrsaMetadata.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      serviceDiscoveryTypes: (() { final guardedValue = map['serviceDiscoveryTypes']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
