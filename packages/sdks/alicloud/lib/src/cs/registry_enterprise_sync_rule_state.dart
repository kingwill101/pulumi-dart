...
class RegistryEnterpriseSyncRuleState {
  ...
  factory RegistryEnterpriseSyncRuleState.fromMap(Map<String, dynamic> map) {
    return RegistryEnterpriseSyncRuleState(
      ...
      repoSyncRuleId: (() { final guardedValue = map['repoSyncRuleId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      syncRuleName: (() { final guardedValue = map['syncRuleName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      syncTrigger: (() { final guardedValue = map['syncTrigger']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      targetNamespaceName: (() { final guardedValue = map['targetNamespaceName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      targetRegionId: (() { final guardedValue = map['targetRegionId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      targetRepoName: (() { final guardedValue = map['targetRepoName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
