...
class GetClustersCluster {
  ...
  factory GetClustersCluster.fromMap(Map<String, dynamic> map) {
    return GetClustersCluster(
      autoMode: pulumi.Input.fromValue(
        GetClustersClusterAutoMode.fromMap(
          (map['autoMode']! as Map).cast<String, dynamic>(),
        ),
      ),
      ...
      maintenanceWindow: pulumi.Input.fromValue(
        GetClustersClusterMaintenanceWindow.fromMap(
          (map['maintenanceWindow']! as Map).cast<String, dynamic>(),
        ),
      ),
      nodeCidrMask: pulumi.Input.fromValue(map['nodeCidrMask'] as String),
      operationPolicy: pulumi.Input.fromValue(
        GetClustersClusterOperationPolicy.fromMap(
          (map['operationPolicy']! as Map).cast<String, dynamic>(),
        ),
      ),
