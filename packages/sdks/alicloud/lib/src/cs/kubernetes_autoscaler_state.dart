...
class KubernetesAutoscalerState {
  ...
  const KubernetesAutoscalerState({
    this.clusterId,
  ...
  factory KubernetesAutoscalerState.fromMap(Map<String, dynamic> map) {
    return KubernetesAutoscalerState(
      ...
      deferScaleInDuration: (() { final guardedValue = map['deferScaleInDuration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      utilization: (() { final guardedValue = map['utilization']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
