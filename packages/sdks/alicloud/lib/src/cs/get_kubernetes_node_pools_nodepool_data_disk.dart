...
class GetKubernetesNodePoolsNodepoolDataDisk {
  ...
  factory GetKubernetesNodePoolsNodepoolDataDisk.fromMap(
    Map<String, dynamic> map,
  ) {
    return GetKubernetesNodePoolsNodepoolDataDisk(
      autoFormat: pulumi.Input.fromValue(map['autoFormat'] as String),
      autoSnapshotPolicyId: pulumi.Input.fromValue(
        map['autoSnapshotPolicyId'] as String,
      ),
      burstingEnabled: pulumi.Input.fromValue(map['burstingEnabled'] as bool),
      ...
      mountTarget: pulumi.Input.fromValue(map['mountTarget'] as String),
