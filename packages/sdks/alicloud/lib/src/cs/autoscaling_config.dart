...
import 'autoscaling_config_state.dart';
...
class AutoscalingConfig extends pulumi.CustomResource {
  ...
  /// Gets an existing [AutoscalingConfig] resource's state with the given [name] and [id].
  static AutoscalingConfig get(
    String name,
    pulumi.Input<String> id, {
    AutoscalingConfigState? state,
  }) {
    return AutoscalingConfig._get(
      name,
      state: state?.toMap(),
