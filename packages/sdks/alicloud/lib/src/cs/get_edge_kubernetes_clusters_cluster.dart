...
class GetEdgeKubernetesClustersCluster {
  ...
  final pulumi.Input<List<GetEdgeKubernetesClustersClusterWorkerNode>>
  workerNodes;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'workerNodes':
          pulumi.Input.mapInputValue<
            List<GetEdgeKubernetesClustersClusterWorkerNode>,
  ...
  factory GetEdgeKubernetesClustersCluster.fromMap(Map<String, dynamic> map) {
    return GetEdgeKubernetesClustersCluster(
      ...
      connections: pulumi.Input.fromValue(
        GetEdgeKubernetesClustersClusterConnections.fromMap(
      ...
      workerNodes: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetEdgeKubernetesClustersClusterWorkerNode>(
          map['workerNodes']!,
          (value) => GetEdgeKubernetesClustersClusterWorkerNode.fromMap(
