...
class NodePoolScalingConfig {
  ...
  factory NodePoolScalingConfig.fromMap(Map<String, dynamic> map) {
    return NodePoolScalingConfig(
      ...
      eipInternetChargeType: (() { final guardedValue = map['eipInternetChargeType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      enable: (() { final guardedValue = map['enable']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      isBondEip: (() { final guardedValue = map['isBondEip']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
