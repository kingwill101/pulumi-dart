...
class EdgeKubernetesState {
  ...
  factory EdgeKubernetesState.fromMap(Map<String, dynamic> map) {
    return EdgeKubernetesState(
      ...
      certificateAuthority: map['certificateAuthority'] == null ? null : (EdgeKubernetesCertificateAuthority.fromMap((map['certificateAuthority']! as Map).cast<String, dynamic>())).input(),
      ...
      connections: map['connections'] == null ? null : (EdgeKubernetesConnections.fromMap((map['connections']! as Map).cast<String, dynamic>())).input(),
      ...
      workerInstanceTypes: map['workerInstanceTypes'] == null ? null : ((map['workerInstanceTypes']! as List).cast<String>()).input(),
      workerNodes: map['workerNodes'] == null ? null : (pulumi.Input.decodeList<EdgeKubernetesWorkerNode>(map['workerNodes']!, (value) => EdgeKubernetesWorkerNode.fromMap((value as Map).cast<String, dynamic>()))).input(),
      workerNumber: map['workerNumber'] == null ? null : (map['workerNumber']! as int).input(),
