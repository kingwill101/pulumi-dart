  ...
  factory EdgeKubernetesState.fromMap(Map<String, dynamic> map) {
    return EdgeKubernetesState(
      ...
      certificateAuthority: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          EdgeKubernetesCertificateAuthority.fromMap(
      ...
      connections: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          EdgeKubernetesConnections.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      workerInstanceTypes: (() {
        final guardedValue = map['workerInstanceTypes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      workerNodes: (() {
        final guardedValue = map['workerNodes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EdgeKubernetesWorkerNode>(
            guardedValue,
            (value) => EdgeKubernetesWorkerNode.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      workerNumber: (() {
        final guardedValue = map['workerNumber'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      workerRamRoleName: (() {
