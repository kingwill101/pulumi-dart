...
class ImageImportDiskDeviceMapping {
  ...
  factory ImageImportDiskDeviceMapping.fromMap(Map<String, dynamic> map) {
    return ImageImportDiskDeviceMapping(
      ...
      diskImageSize: (() { final guardedValue = map['diskImageSize']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      ossObject: (() { final guardedValue = map['ossObject']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
