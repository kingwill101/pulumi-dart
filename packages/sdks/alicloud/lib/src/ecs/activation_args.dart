...
/// {@template pulumi_ecs_activation_activation_args_doc}
/// The set of arguments for Activation.
/// {@endtemplate}
/// {@macro pulumi_ecs_activation_activation_args_doc}
class ActivationArgs {
  ...
  factory ActivationArgs.fromMap(Map<String, dynamic> map) {
    return ActivationArgs(
      ...
      timeToLiveInHours: (() { final guardedValue = map['timeToLiveInHours']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
    );
  }
}
