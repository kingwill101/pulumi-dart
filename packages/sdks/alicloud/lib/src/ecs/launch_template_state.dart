    ...
    return LaunchTemplateState(
      ...
      dataDisks: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<LaunchTemplateDataDisk>(
            guardedValue,
            (value) => LaunchTemplateDataDisk.fromMap(
      ...
      imageOptions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          LaunchTemplateImageOptions.fromMap(
      ...
      networkInterfaces: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          LaunchTemplateNetworkInterfaces.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      systemDisk: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          LaunchTemplateSystemDisk.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
