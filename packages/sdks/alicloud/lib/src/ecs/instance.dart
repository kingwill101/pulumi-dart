...
class Instance extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<InstanceDataDisk>?> dataDisks;
  ...
  Instance(
    ...
    this.allocatePublicIp = registerOutput<bool?>('allocatePublicIp');
    ...
    this.dataDisks = registerOutput<List<InstanceDataDisk>?>('dataDisks');
    this.dedicatedHostId = registerOutput<String?>('dedicatedHostId');
    this.deletionProtection = registerOutput<bool?>('deletionProtection');
    this.deploymentSetGroupNo = registerOutput<String>('deploymentSetGroupNo');
    this.deploymentSetId = registerOutput<String?>('deploymentSetId');
    this.description = registerOutput<String>('description');
    this.dryRun = registerOutput<bool?>('dryRun');
    this.enableJumboFrame = registerOutput<bool>('enableJumboFrame');
    ...
    this.imageOptions = registerOutput<InstanceImageOptions>('imageOptions');
    this.includeDataDisks = registerOutput<bool?>('includeDataDisks');
    ...
    this.maintenanceAction = registerOutput<String>('maintenanceAction');
    this.maintenanceNotify = registerOutput<bool?>('maintenanceNotify');
    this.maintenanceTime = registerOutput<InstanceMaintenanceTime?>('maintenanceTime');
    ...
    this.networkInterfaces = registerOutput<InstanceNetworkInterfaces>('networkInterfaces');
    ...
    this.privatePoolOptionsId = registerOutput<String>('privatePoolOptionsId');
    ...
    this.queuePairNumber = registerOutput<int?>('queuePairNumber');
    ...
    this.systemDiskId = registerOutput<String>('systemDiskId');
    ...
    this.systemDiskStorageClusterId = registerOutput<String?>('systemDiskStorageClusterId');
