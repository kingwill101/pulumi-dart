...
class AutoProvisioningGroupState {
  ...
  const AutoProvisioningGroupState({
  ...
  factory AutoProvisioningGroupState.fromMap(Map<String, dynamic> map) {
    return AutoProvisioningGroupState(
      ...
      launchTemplateConfigs: (() { final guardedValue = map['launchTemplateConfigs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AutoProvisioningGroupLaunchTemplateConfig>(guardedValue, (value) => AutoProvisioningGroupLaunchTemplateConfig.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      totalTargetCapacity: (() { final guardedValue = map['totalTargetCapacity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
