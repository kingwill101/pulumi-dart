...
class AutoProvisioningGroupState {
  ...
  AutoProvisioningGroupState({
    pulumi.Output<String>? autoProvisioningGroupName,
    pulumi.Output<String>? autoProvisioningGroupType,
    pulumi.Output<String>? defaultTargetCapacityType,
    pulumi.Output<String>? description,
    pulumi.Output<String>? excessCapacityTerminationPolicy,
    pulumi.Output<List<AutoProvisioningGroupLaunchTemplateConfig>>? launchTemplateConfigs,
    pulumi.Output<String>? launchTemplateId,
    pulumi.Output<String>? launchTemplateVersion,
    pulumi.Output<double>? maxSpotPrice,
    pulumi.Output<String>? payAsYouGoAllocationStrategy,
    pulumi.Output<String>? payAsYouGoTargetCapacity,
    pulumi.Output<String>? spotAllocationStrategy,
    pulumi.Output<String>? spotInstanceInterruptionBehavior,
    pulumi.Output<int>? spotInstancePoolsToUseCount,
    pulumi.Output<String>? spotTargetCapacity,
    pulumi.Output<bool>? terminateInstances,
    pulumi.Output<bool>? terminateInstancesWithExpiration,
    pulumi.Output<String>? totalTargetCapacity,
    ...
    pulumi.Output<String>? validUntil,
      ...
      launchTemplateConfigs = pulumi.Input.asOptionalInput<List<AutoProvisioningGroupLaunchTemplateConfig>>(launchTemplateConfigs),
      ...
      totalTargetCapacity = pulumi.Input.asOptionalInput<String>(totalTargetCapacity),
  ...
  factory AutoProvisioningGroupState.fromMap(Map<String, dynamic> map) {
    return AutoProvisioningGroupState(
      autoProvisioningGroupName: map['autoProvisioningGroupName'] == null ? null : pulumi.Output.create<String>(map['autoProvisioningGroupName'] as String),
      autoProvisioningGroupType: map['autoProvisioningGroupType'] == null ? null : pulumi.Output.create<String>(map['autoProvisioningGroupType'] as String),
      defaultTargetCapacityType: map['defaultTargetCapacityType'] == null ? null : pulumi.Output.create<String>(map['defaultTargetCapacityType'] as String),
      ...
      launchTemplateConfigs: map['launchTemplateConfigs'] == null ? null : pulumi.Output.create<List<AutoProvisioningGroupLaunchTemplateConfig>>(pulumi.Input.decodeList<AutoProvisioningGroupLaunchTemplateConfig>(map['launchTemplateConfigs'], (value) => AutoProvisioningGroupLaunchTemplateConfig.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      maxSpotPrice: map['maxSpotPrice'] == null ? null : pulumi.Output.create<double>(map['maxSpotPrice'] as double),
      payAsYouGoAllocationStrategy: map['payAsYouGoAllocationStrategy'] == null ? null : pulumi.Output.create<String>(map['payAsYouGoAllocationStrategy'] as String),
      payAsYouGoTargetCapacity: map['payAsYouGoTargetCapacity'] == null ? null : pulumi.Output.create<String>(map['payAsYouGoTargetCapacity'] as String),
      ...
      spotInstanceInterruptionBehavior: map['spotInstanceInterruptionBehavior'] == null ? null : pulumi.Output.create<String>(map['spotInstanceInterruptionBehavior'] as String),
      spotInstancePoolsToUseCount: map['spotInstancePoolsToUseCount'] == null ? null : pulumi.Output.create<int>(map['spotInstancePoolsToUseCount'] as int),
      spotTargetCapacity: map['spotTargetCapacity'] == null ? null : pulumi.Output.create<String>(map['spotTargetCapacity'] as String),
      ...
      totalTargetCapacity: map['totalTargetCapacity'] == null ? null : pulumi.Output.create<String>(map['totalTargetCapacity'] as String),
