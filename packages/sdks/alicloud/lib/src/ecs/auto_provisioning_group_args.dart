...
class AutoProvisioningGroupArgs {
  ...
  factory AutoProvisioningGroupArgs.fromMap(Map<String, dynamic> map) {
    return AutoProvisioningGroupArgs(
      ...
      launchTemplateConfigs: (pulumi.Input.decodeList<AutoProvisioningGroupLaunchTemplateConfig>(map['launchTemplateConfigs'], (value) => AutoProvisioningGroupLaunchTemplateConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      totalTargetCapacity: (map['totalTargetCapacity'] as String).input(),
