...
class AutoProvisioningGroupArgs {
  ...
  AutoProvisioningGroupArgs({
    ...
    required pulumi.Output<List<AutoProvisioningGroupLaunchTemplateConfig>> launchTemplateConfigs,
    required pulumi.Output<String> launchTemplateId,
    ...
    required pulumi.Output<String> totalTargetCapacity,
  ...
  factory AutoProvisioningGroupArgs.fromMap(Map<String, dynamic> map) {
    return AutoProvisioningGroupArgs(
      ...
      launchTemplateConfigs: pulumi.Output.create<List<AutoProvisioningGroupLaunchTemplateConfig>>(pulumi.Input.decodeList<AutoProvisioningGroupLaunchTemplateConfig>(map['launchTemplateConfigs'], (value) => AutoProvisioningGroupLaunchTemplateConfig.fromMap((value as Map).cast<String, dynamic>()))),
      launchTemplateId: pulumi.Output.create<String>(map['launchTemplateId'] as String),
      ...
      totalTargetCapacity: pulumi.Output.create<String>(map['totalTargetCapacity'] as String),
