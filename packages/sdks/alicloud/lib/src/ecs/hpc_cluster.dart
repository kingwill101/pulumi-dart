...
class HpcCluster extends pulumi.CustomResource {
  ...
  /// Gets an existing [HpcCluster] resource's state with the given [name] and [id].
  static HpcCluster get(
    String name,
    pulumi.Input<String> id, {
    HpcClusterState? state,
  }) {
    return HpcCluster._get(
      name,
      state: state?.toMap(),
