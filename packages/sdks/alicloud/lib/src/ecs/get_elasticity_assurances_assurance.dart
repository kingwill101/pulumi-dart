...
class GetElasticityAssurancesAssurance {
  ...
  factory GetElasticityAssurancesAssurance.fromMap(Map<String, dynamic> map) {
    return GetElasticityAssurancesAssurance(
      allocatedResources: pulumi.Input.fromValue(pulumi.Input.decodeList<GetElasticityAssurancesAssuranceAllocatedResource>(map['allocatedResources']!, (value) => GetElasticityAssurancesAssuranceAllocatedResource.fromMap((value as Map).cast<String, dynamic>()))),
      description: pulumi.Input.fromValue(map['description'] as String),
      elasticityAssuranceId: pulumi.Input.fromValue(map['elasticityAssuranceId'] as String),
      ...
      privatePoolOptionsName: pulumi.Input.fromValue(map['privatePoolOptionsName'] as String),
      ...
      totalAssuranceTimes: pulumi.Input.fromValue(map['totalAssuranceTimes'] as String),
      usedAssuranceTimes: pulumi.Input.fromValue(map['usedAssuranceTimes'] as int),
    );
  }
}
