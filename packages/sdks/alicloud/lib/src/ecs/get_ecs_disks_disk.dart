...
class GetEcsDisksDisk {
    ...
    return <String, dynamic>{
      ...
      'mountInstances':
          pulumi.Input.mapInputValue<
            List<GetEcsDisksDiskMountInstance>,
      ...
      'operationLocks':
          pulumi.Input.mapInputValue<
            List<GetEcsDisksDiskOperationLock>,
            List<Map<String, dynamic>>
          >(
            operationLocks,
            (value) =>
  ...
  factory GetEcsDisksDisk.fromMap(Map<String, dynamic> map) {
    return GetEcsDisksDisk(
      ...
      deleteAutoSnapshot: pulumi.Input.fromValue(
        map['deleteAutoSnapshot'] as bool,
      ),
      ...
      enableAutoSnapshot: pulumi.Input.fromValue(
        map['enableAutoSnapshot'] as bool,
      ),
      enableAutomatedSnapshotPolicy: pulumi.Input.fromValue(
        map['enableAutomatedSnapshotPolicy'] as bool,
      ),
      ...
      mountInstances: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetEcsDisksDiskMountInstance>(
          map['mountInstances']!,
          (value) => GetEcsDisksDiskMountInstance.fromMap(
      ...
      operationLocks: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetEcsDisksDiskOperationLock>(
          map['operationLocks']!,
          (value) => GetEcsDisksDiskOperationLock.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
