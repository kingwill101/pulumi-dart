...
class EcsImagePipeline extends pulumi.CustomResource {
  ...
  EcsImagePipeline(
    ...
    this.addAccounts = registerOutput<List<String>?>('addAccounts');
    this.baseImage = registerOutput<String>('baseImage');
    this.baseImageType = registerOutput<String>('baseImageType');
    this.buildContent = registerOutput<String?>('buildContent');
    this.deleteInstanceOnFailure = registerOutput<bool>('deleteInstanceOnFailure');
    ...
    this.toRegionIds = registerOutput<List<String>?>('toRegionIds');
