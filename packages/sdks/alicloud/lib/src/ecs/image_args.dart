...
class ImageArgs {
  ...
  factory ImageArgs.fromMap(Map<String, dynamic> map) {
    return ImageArgs(
      ...
      detectionStrategy: (() {
        final guardedValue = map['detectionStrategy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      diskDeviceMappings: (() {
        final guardedValue = map['diskDeviceMappings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ImageDiskDeviceMapping>(
            guardedValue,
            (value) => ImageDiskDeviceMapping.fromMap(
      ...
      features: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ImageFeatures.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      force: (() {
