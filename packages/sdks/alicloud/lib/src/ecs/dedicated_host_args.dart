...
class DedicatedHostArgs {
    ...
    return <String, dynamic>{
      ...
      'networkAttributes':
          ?pulumi.Input.mapOptionalInputValue<
            List<DedicatedHostNetworkAttribute>,
  ...
  factory DedicatedHostArgs.fromMap(Map<String, dynamic> map) {
    return DedicatedHostArgs(
      actionOnMaintenance: (() {
        final guardedValue = map['actionOnMaintenance'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      autoPlacement: (() {
        final guardedValue = map['autoPlacement'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      autoReleaseTime: (() {
      ...
      detailFee: (() {
        final guardedValue = map['detailFee'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      dryRun: (() {
      ...
      minQuantity: (() {
        final guardedValue = map['minQuantity'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      networkAttributes: (() {
        final guardedValue = map['networkAttributes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DedicatedHostNetworkAttribute>(
            guardedValue,
            (value) => DedicatedHostNetworkAttribute.fromMap(
      ...
      saleCycle: (() {
        final guardedValue = map['saleCycle'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      tags: (() {
