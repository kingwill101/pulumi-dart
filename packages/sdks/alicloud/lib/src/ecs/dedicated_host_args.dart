...
class DedicatedHostArgs {
  ...
  DedicatedHostArgs({
    ...
    required pulumi.Output<String> dedicatedHostType,
    ...
    pulumi.Output<String>? zoneId,
      ...
      dedicatedHostType = pulumi.Input.asInput<String>(dedicatedHostType),
  ...
  factory DedicatedHostArgs.fromMap(Map<String, dynamic> map) {
    return DedicatedHostArgs(
      ...
      dedicatedHostType: pulumi.Output.create<String>(map['dedicatedHostType'] as String),
