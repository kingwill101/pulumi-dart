...
class GetEcsKeyPairsKeyPair {
  ...
  factory GetEcsKeyPairsKeyPair.fromMap(Map<String, dynamic> map) {
    return GetEcsKeyPairsKeyPair(
      ...
      instances: pulumi.Input.fromValue(pulumi.Input.decodeList<GetEcsKeyPairsKeyPairInstance>(map['instances']!, (value) => GetEcsKeyPairsKeyPairInstance.fromMap((value as Map).cast<String, dynamic>()))),
