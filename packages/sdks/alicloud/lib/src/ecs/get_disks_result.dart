...
class GetDisksResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'diskName': ?diskName,
      'diskType': ?diskType,
      'disks': pulumi.Input.encodeList<GetDisksDisk, Map<String, dynamic>>(
        disks,
        (value) => value.toMap(),
      ),
      'dryRun': ?dryRun,
  ...
  factory GetDisksResult.fromMap(Map<String, dynamic> map) {
    return GetDisksResult(
      ...
      disks: pulumi.Input.decodeList<GetDisksDisk>(
        map['disks']!,
        (value) => GetDisksDisk.fromMap((value as Map).cast<String, dynamic>()),
      ),
      dryRun: (() {
      ...
      operationLocks: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<GetDisksOperationLock>(
          guardedValue,
          (value) => GetDisksOperationLock.fromMap(
