...
class GetEcsLaunchTemplatesTemplate {
  ...
  factory GetEcsLaunchTemplatesTemplate.fromMap(Map<String, dynamic> map) {
    return GetEcsLaunchTemplatesTemplate(
      ...
      dataDisks: pulumi.Input.fromValue(pulumi.Input.decodeList<GetEcsLaunchTemplatesTemplateDataDisk>(map['dataDisks']!, (value) => GetEcsLaunchTemplatesTemplateDataDisk.fromMap((value as Map).cast<String, dynamic>()))),
      defaultVersionNumber: pulumi.Input.fromValue(map['defaultVersionNumber'] as int),
      ...
      latestVersionNumber: pulumi.Input.fromValue(map['latestVersionNumber'] as int),
      ...
      networkInterfaces: pulumi.Input.fromValue(pulumi.Input.decodeList<GetEcsLaunchTemplatesTemplateNetworkInterface>(map['networkInterfaces']!, (value) => GetEcsLaunchTemplatesTemplateNetworkInterface.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      securityEnhancementStrategy: pulumi.Input.fromValue(map['securityEnhancementStrategy'] as String),
      ...
      systemDisks: pulumi.Input.fromValue(pulumi.Input.decodeList<GetEcsLaunchTemplatesTemplateSystemDisk>(map['systemDisks']!, (value) => GetEcsLaunchTemplatesTemplateSystemDisk.fromMap((value as Map).cast<String, dynamic>()))),
      templateTags: pulumi.Input.fromValue((map['templateTags'] as Map).cast<String, String>()),
