  ...
  factory GetCapacityReservationsResult.fromMap(Map<String, dynamic> map) {
    return GetCapacityReservationsResult(
      capacityReservationIds: (() {
        final guardedValue = map['capacityReservationIds'];
      ...
      reservations: pulumi.Input.decodeList<GetCapacityReservationsReservation>(
        map['reservations']!,
        (value) => GetCapacityReservationsReservation.fromMap(
