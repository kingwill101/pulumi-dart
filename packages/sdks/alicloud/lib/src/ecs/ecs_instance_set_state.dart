...
class EcsInstanceSetState {
  ...
  final pulumi.Input<EcsInstanceSetExcludeInstanceFilter>?
    ...
    return <String, dynamic>{
      ...
      'excludeInstanceFilter':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(excludeInstanceFilter, (value) => value.toMap()),
      'hostName': ?hostName,
      ...
      'networkInterfaces':
          ?pulumi.Input.mapOptionalInputValue<
            List<EcsInstanceSetNetworkInterface>,
            List<Map<String, dynamic>>
          >(
            networkInterfaces,
            (value) =>
  ...
  factory EcsInstanceSetState.fromMap(Map<String, dynamic> map) {
    return EcsInstanceSetState(
      ...
      bootCheckOsWithAssistant: (() {
        final guardedValue = map['bootCheckOsWithAssistant'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      dataDisks: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EcsInstanceSetDataDisk>(
            guardedValue,
            (value) => EcsInstanceSetDataDisk.fromMap(
      ...
      excludeInstanceFilter: (() {
        final guardedValue = map['excludeInstanceFilter'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          EcsInstanceSetExcludeInstanceFilter.fromMap(
      ...
      hpcClusterId: (() {
        final guardedValue = map['hpcClusterId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      imageId: (() {
      ...
      networkInterfaces: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EcsInstanceSetNetworkInterface>(
            guardedValue,
            (value) => EcsInstanceSetNetworkInterface.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
