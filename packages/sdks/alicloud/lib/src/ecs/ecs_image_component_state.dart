...
class EcsImageComponentState {
  ...
  factory EcsImageComponentState.fromMap(Map<String, dynamic> map) {
    return EcsImageComponentState(
      ...
      componentVersion: (() { final guardedValue = map['componentVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      systemType: (() { final guardedValue = map['systemType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
