...
class EcsPrefixListState {
  ...
  factory EcsPrefixListState.fromMap(Map<String, dynamic> map) {
    return EcsPrefixListState(
      ...
      entries: (() { final guardedValue = map['entries']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<EcsPrefixListEntry>(guardedValue, (value) => EcsPrefixListEntry.fromMap((value as Map).cast<String, dynamic>()))); })(),
