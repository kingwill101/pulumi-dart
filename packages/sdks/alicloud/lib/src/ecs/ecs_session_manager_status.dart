...
import 'ecs_session_manager_status_state.dart';
...
class EcsSessionManagerStatus extends pulumi.CustomResource {
  ...
  static EcsSessionManagerStatus get(
    String name,
    pulumi.Input<String> id, {
    EcsSessionManagerStatusState? state,
  }) {
    return EcsSessionManagerStatus._get(
      name,
      state: state?.toMap(),
