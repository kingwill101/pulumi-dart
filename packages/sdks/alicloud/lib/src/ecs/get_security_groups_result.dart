...
class GetSecurityGroupsResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'groups':
          pulumi.Input.encodeList<GetSecurityGroupsGroup, Map<String, dynamic>>(
            groups,
            (value) => value.toMap(),
          ),
      'id': id,
  ...
  factory GetSecurityGroupsResult.fromMap(Map<String, dynamic> map) {
    return GetSecurityGroupsResult(
      ...
      groups: pulumi.Input.decodeList<GetSecurityGroupsGroup>(
        map['groups']!,
        (value) => GetSecurityGroupsGroup.fromMap(
