...
class EcsInstanceSet extends pulumi.CustomResource {
  ...
  EcsInstanceSet(
    ...
    bootCheckOsWithAssistant = registerOutput<bool?>('bootCheckOsWithAssistant');
    ...
    excludeInstanceFilter = registerOutput<EcsInstanceSetExcludeInstanceFilter?>('excludeInstanceFilter', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return EcsInstanceSetExcludeInstanceFilter.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  static EcsInstanceSet get(
    String name,
    pulumi.Input<String> id, {
    EcsInstanceSetState? state,
  }) {
    return EcsInstanceSet._get(
      name,
      state: state?.toMap(),
