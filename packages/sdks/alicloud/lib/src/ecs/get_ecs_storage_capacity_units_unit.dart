...
class GetEcsStorageCapacityUnitsUnit {
  ...
  factory GetEcsStorageCapacityUnitsUnit.fromMap(Map<String, dynamic> map) {
    return GetEcsStorageCapacityUnitsUnit(
      ...
      storageCapacityUnitId: pulumi.Input.fromValue(map['storageCapacityUnitId'] as String),
      storageCapacityUnitName: pulumi.Input.fromValue(map['storageCapacityUnitName'] as String),
    );
  }
}
