...
class ImageDiskDeviceMapping {
  ...
  factory ImageDiskDeviceMapping.fromMap(Map<String, dynamic> map) {
    return ImageDiskDeviceMapping(
      ...
      importOssBucket: (() { final guardedValue = map['importOssBucket']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      importOssObject: (() { final guardedValue = map['importOssObject']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      remainTime: (() { final guardedValue = map['remainTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
