...
class GetKeyPairsKeyPair {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'id': id,
      'instances': pulumi.Input.mapInputValue<List<GetKeyPairsKeyPairInstance>, List<Map<String, dynamic>>>(instances, (value) => pulumi.Input.encodeList<GetKeyPairsKeyPairInstance, Map<String, dynamic>>(value, (value) => value.toMap())),
      'keyName': keyName,
  ...
  factory GetKeyPairsKeyPair.fromMap(Map<String, dynamic> map) {
    return GetKeyPairsKeyPair(
      ...
      instances: pulumi.Input.fromValue(pulumi.Input.decodeList<GetKeyPairsKeyPairInstance>(map['instances']!, (value) => GetKeyPairsKeyPairInstance.fromMap((value as Map).cast<String, dynamic>()))),
