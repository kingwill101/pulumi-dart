...
class GetKeyPairsKeyPair {
  ...
  factory GetKeyPairsKeyPair.fromMap(Map<String, dynamic> map) {
    return GetKeyPairsKeyPair(
      ...
      instances: (pulumi.Input.decodeList<GetKeyPairsKeyPairInstance>(map['instances'], (value) => GetKeyPairsKeyPairInstance.fromMap((value as Map).cast<String, dynamic>()))).input(),
