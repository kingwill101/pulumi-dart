...
class Image extends pulumi.CustomResource {
  ...
  Image(
    ...
    features = registerOutput<ImageFeatures>('features', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ImageFeatures.fromMap((guardedValue as Map).cast<String, dynamic>()); });
