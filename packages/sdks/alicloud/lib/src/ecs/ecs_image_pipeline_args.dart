...
class EcsImagePipelineArgs {
  ...
  EcsImagePipelineArgs({
    ...
    required pulumi.Output<String> baseImageType,
    ...
    pulumi.Output<String>? vswitchId,
      ...
      baseImageType = pulumi.Input.asInput<String>(baseImageType),
  ...
  factory EcsImagePipelineArgs.fromMap(Map<String, dynamic> map) {
    return EcsImagePipelineArgs(
      ...
      baseImageType: pulumi.Output.create<String>(map['baseImageType'] as String),
