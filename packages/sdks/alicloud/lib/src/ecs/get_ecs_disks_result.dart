...
class GetEcsDisksResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'diskName': ?diskName,
      'diskType': ?diskType,
      'disks': pulumi.Input.encodeList<GetEcsDisksDisk, Map<String, dynamic>>(
        disks,
        (value) => value.toMap(),
      ),
      'dryRun': ?dryRun,
  ...
  factory GetEcsDisksResult.fromMap(Map<String, dynamic> map) {
    return GetEcsDisksResult(
      ...
      disks: pulumi.Input.decodeList<GetEcsDisksDisk>(
        map['disks']!,
        (value) =>
            GetEcsDisksDisk.fromMap((value as Map).cast<String, dynamic>()),
      ),
      dryRun: (() {
      ...
      operationLocks: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<GetEcsDisksOperationLock>(
          guardedValue,
