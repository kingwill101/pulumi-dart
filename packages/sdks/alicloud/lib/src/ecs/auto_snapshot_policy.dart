...
class AutoSnapshotPolicy extends pulumi.CustomResource {
  ...
  late final pulumi.Output<AutoSnapshotPolicyCopyEncryptionConfiguration?> copyEncryptionConfiguration;
  ...
  AutoSnapshotPolicy(
    ...
    copiedSnapshotsRetentionDays = registerOutput<int>('copiedSnapshotsRetentionDays');
    copyEncryptionConfiguration = registerOutput<AutoSnapshotPolicyCopyEncryptionConfiguration?>('copyEncryptionConfiguration', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return AutoSnapshotPolicyCopyEncryptionConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>()); });
