...
class GetEcsKeyPairsPair {
  ...
  factory GetEcsKeyPairsPair.fromMap(Map<String, dynamic> map) {
    return GetEcsKeyPairsPair(
      ...
      instances: pulumi.Input.fromValue(pulumi.Input.decodeList<GetEcsKeyPairsPairInstance>(map['instances']!, (value) => GetEcsKeyPairsPairInstance.fromMap((value as Map).cast<String, dynamic>()))),
