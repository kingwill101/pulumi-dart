...
class ImageImportArgs {
  ...
  ImageImportArgs({
    ...
    required pulumi.Output<List<ImageImportDiskDeviceMapping>> diskDeviceMappings,
  ...
  factory ImageImportArgs.fromMap(Map<String, dynamic> map) {
    return ImageImportArgs(
      ...
      diskDeviceMappings: pulumi.Output.create<List<ImageImportDiskDeviceMapping>>(pulumi.Input.decodeList<ImageImportDiskDeviceMapping>(map['diskDeviceMappings'], (value) => ImageImportDiskDeviceMapping.fromMap((value as Map).cast<String, dynamic>()))),
