...
class ImageImportArgs {
  ...
  factory ImageImportArgs.fromMap(Map<String, dynamic> map) {
    return ImageImportArgs(
      ...
      diskDeviceMappings: pulumi.Input.fromValue(pulumi.Input.decodeList<ImageImportDiskDeviceMapping>(map['diskDeviceMappings']!, (value) => ImageImportDiskDeviceMapping.fromMap((value as Map).cast<String, dynamic>()))),
