...
import 'ecs_network_interface_state.dart';
...
class EcsNetworkInterface extends pulumi.CustomResource {
  ...
  /// Gets an existing [EcsNetworkInterface] resource's state with the given [name] and [id].
  static EcsNetworkInterface get(
    String name,
    pulumi.Input<String> id, {
    EcsNetworkInterfaceState? state,
  }) {
    return EcsNetworkInterface._get(
      name,
      state: state?.toMap(),
