...
class EcsInvocationArgs {
  ...
  factory EcsInvocationArgs.fromMap(Map<String, dynamic> map) {
    return EcsInvocationArgs(
      ...
      timed: (() { final guardedValue = map['timed']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      username: (() { final guardedValue = map['username']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      windowsPasswordName: (() { final guardedValue = map['windowsPasswordName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
