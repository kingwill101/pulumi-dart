...
class GetEcsImagePipelinePipeline {
  ...
  factory GetEcsImagePipelinePipeline.fromMap(Map<String, dynamic> map) {
    return GetEcsImagePipelinePipeline(
      addAccounts: pulumi.Input.fromValue(
        (map['addAccounts'] as List).cast<String>(),
      ),
      ...
      deleteInstanceOnFailure: pulumi.Input.fromValue(
        map['deleteInstanceOnFailure'] as bool,
      ),
      ...
      toRegionIds: pulumi.Input.fromValue(
        (map['toRegionIds'] as List).cast<String>(),
      ),
