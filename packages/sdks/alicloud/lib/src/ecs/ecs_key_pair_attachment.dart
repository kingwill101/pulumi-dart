...
import 'ecs_key_pair_attachment_state.dart';
...
class EcsKeyPairAttachment extends pulumi.CustomResource {
  ...
  /// Gets an existing [EcsKeyPairAttachment] resource's state with the given [name] and [id].
  static EcsKeyPairAttachment get(
    String name,
    pulumi.Input<String> id, {
    EcsKeyPairAttachmentState? state,
  }) {
    return EcsKeyPairAttachment._get(
      name,
      state: state?.toMap(),
