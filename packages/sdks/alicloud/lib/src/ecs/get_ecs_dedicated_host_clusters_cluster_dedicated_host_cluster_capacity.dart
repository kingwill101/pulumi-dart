...
class GetEcsDedicatedHostClustersClusterDedicatedHostClusterCapacity {
  ...
  factory GetEcsDedicatedHostClustersClusterDedicatedHostClusterCapacity.fromMap(Map<String, dynamic> map) {
    return GetEcsDedicatedHostClustersClusterDedicatedHostClusterCapacity(
      ...
      localStorageCapacities: pulumi.Input.fromValue(pulumi.Input.decodeList<GetEcsDedicatedHostClustersClusterDedicatedHostClusterCapacityLocalStorageCapacity>(map['localStorageCapacities']!, (value) => GetEcsDedicatedHostClustersClusterDedicatedHostClusterCapacityLocalStorageCapacity.fromMap((value as Map).cast<String, dynamic>()))),
