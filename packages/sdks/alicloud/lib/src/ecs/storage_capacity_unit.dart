...
import 'storage_capacity_unit_state.dart';
...
class StorageCapacityUnit extends pulumi.CustomResource {
  ...
  StorageCapacityUnit(
    ...
    storageCapacityUnitName = registerOutput<String>('storageCapacityUnitName');
  }

  /// Gets an existing [StorageCapacityUnit] resource's state with the given [name] and [id].
  static StorageCapacityUnit get(
    String name,
    pulumi.Input<String> id, {
    StorageCapacityUnitState? state,
  }) {
    return StorageCapacityUnit._get(
      name,
      state: state?.toMap(),
