...
class SecurityGroupRuleState {
  ...
  factory SecurityGroupRuleState.fromMap(Map<String, dynamic> map) {
    return SecurityGroupRuleState(
      ...
      ipv6CidrIp: (() { final guardedValue = map['ipv6CidrIp']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      sourceGroupOwnerAccount: (() { final guardedValue = map['sourceGroupOwnerAccount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
