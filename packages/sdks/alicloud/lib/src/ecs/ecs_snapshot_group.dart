...
class EcsSnapshotGroup extends pulumi.CustomResource {
  ...
  EcsSnapshotGroup(
    ...
    this.diskIds = registerOutput<List<String>?>('diskIds');
    this.excludeDiskIds = registerOutput<List<String>?>('excludeDiskIds');
    ...
    this.snapshotGroupName = registerOutput<String?>('snapshotGroupName');
