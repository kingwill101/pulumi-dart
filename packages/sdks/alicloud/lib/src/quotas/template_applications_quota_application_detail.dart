...
class TemplateApplicationsQuotaApplicationDetail {
  ...
  factory TemplateApplicationsQuotaApplicationDetail.fromMap(Map<String, dynamic> map) {
    return TemplateApplicationsQuotaApplicationDetail(
      aliyunUid: (() { final guardedValue = map['aliyunUid']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      applicationId: (() { final guardedValue = map['applicationId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      approveValue: (() { final guardedValue = map['approveValue']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as double); })(),
      ...
      period: (() { final guardedValue = map['period']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TemplateApplicationsQuotaApplicationDetailPeriod.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      quotaArn: (() { final guardedValue = map['quotaArn']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
