...
class GetQuotasResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'dimensions': ?(() { final guardedValue = dimensions; if (guardedValue == null) return null; return pulumi.Input.encodeList<GetQuotasDimension, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
      'groupCode': ?groupCode,
      'id': id,
      'ids': ids,
      'keyWord': ?keyWord,
  ...
  factory GetQuotasResult.fromMap(Map<String, dynamic> map) {
    return GetQuotasResult(
      dimensions: (() { final guardedValue = map['dimensions']; if (guardedValue == null) return null; return pulumi.Input.decodeList<GetQuotasDimension>(guardedValue, (value) => GetQuotasDimension.fromMap((value as Map).cast<String, dynamic>())); })(),
      groupCode: (() { final guardedValue = map['groupCode']; if (guardedValue == null) return null; return guardedValue as String; })(),
      id: map['id'] as String,
