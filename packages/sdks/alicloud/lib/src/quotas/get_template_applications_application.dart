...
class GetTemplateApplicationsApplication {
  ...
  factory GetTemplateApplicationsApplication.fromMap(Map<String, dynamic> map) {
    return GetTemplateApplicationsApplication(
      ...
      auditStatusVos: pulumi.Input.fromValue(pulumi.Input.decodeList<GetTemplateApplicationsApplicationAuditStatusVo>(map['auditStatusVos']!, (value) => GetTemplateApplicationsApplicationAuditStatusVo.fromMap((value as Map).cast<String, dynamic>()))),
      batchQuotaApplicationId: pulumi.Input.fromValue(map['batchQuotaApplicationId'] as String),
      desireValue: pulumi.Input.fromValue(map['desireValue'] as double),
      dimensions: pulumi.Input.fromValue(pulumi.Input.decodeList<GetTemplateApplicationsApplicationDimension>(map['dimensions']!, (value) => GetTemplateApplicationsApplicationDimension.fromMap((value as Map).cast<String, dynamic>()))),
