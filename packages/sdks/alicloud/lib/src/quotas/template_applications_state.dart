...
class TemplateApplicationsState {
  ...
  factory TemplateApplicationsState.fromMap(Map<String, dynamic> map) {
    return TemplateApplicationsState(
      aliyunUids: (() { final guardedValue = map['aliyunUids']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      ...
      quotaApplicationDetails: (() { final guardedValue = map['quotaApplicationDetails']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<TemplateApplicationsQuotaApplicationDetail>(guardedValue, (value) => TemplateApplicationsQuotaApplicationDetail.fromMap((value as Map).cast<String, dynamic>()))); })(),
