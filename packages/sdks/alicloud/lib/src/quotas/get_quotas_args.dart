...
class GetQuotasArgs {
  ...
  factory GetQuotasArgs.fromMap(Map<String, dynamic> map) {
    return GetQuotasArgs(
      dimensions: (() { final guardedValue = map['dimensions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetQuotasDimension>(guardedValue, (value) => GetQuotasDimension.fromMap((value as Map).cast<String, dynamic>()))); })(),
      groupCode: (() { final guardedValue = map['groupCode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
