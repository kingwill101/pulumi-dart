...
class GetInstancesResult {
  ...
  factory GetInstancesResult.fromMap(Map<String, dynamic> map) {
    return GetInstancesResult(
      appKey: (() { final guardedValue = map['appKey']; if (guardedValue == null) return null; return guardedValue as String; })(),
      ...
      queryStr: (() { final guardedValue = map['queryStr']; if (guardedValue == null) return null; return guardedValue as String; })(),
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return guardedValue as String; })(),
      statusList: (() { final guardedValue = map['statusList']; if (guardedValue == null) return null; return guardedValue as String; })(),
    );
  }
}
