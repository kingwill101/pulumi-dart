...
class StoreIndexFieldSearch {
  ...
  factory StoreIndexFieldSearch.fromMap(Map<String, dynamic> map) {
    return StoreIndexFieldSearch(
      ...
      jsonKeys: (() { final guardedValue = map['jsonKeys']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<StoreIndexFieldSearchJsonKey>(guardedValue, (value) => StoreIndexFieldSearchJsonKey.fromMap((value as Map).cast<String, dynamic>()))); })(),
