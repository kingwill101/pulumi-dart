...
class EtlState {
  ...
  factory EtlState.fromMap(Map<String, dynamic> map) {
    return EtlState(
      ...
      etlName: (() { final guardedValue = map['etlName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      etlSinks: (() { final guardedValue = map['etlSinks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<EtlEtlSink>(guardedValue, (value) => EtlEtlSink.fromMap((value as Map).cast<String, dynamic>()))); })(),
