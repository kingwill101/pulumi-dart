...
class EtlState {
  ...
  EtlState({
    ...
    pulumi.Output<String>? etlName,
    pulumi.Output<List<EtlEtlSink>>? etlSinks,
    ...
    pulumi.Output<int>? version,
      ...
      etlName = pulumi.Input.asOptionalInput<String>(etlName),
      etlSinks = pulumi.Input.asOptionalInput<List<EtlEtlSink>>(etlSinks),
  ...
  factory EtlState.fromMap(Map<String, dynamic> map) {
    return EtlState(
      ...
      etlName: map['etlName'] == null ? null : pulumi.Output.create<String>(map['etlName'] as String),
      etlSinks: map['etlSinks'] == null ? null : pulumi.Output.create<List<EtlEtlSink>>(pulumi.Input.decodeList<EtlEtlSink>(map['etlSinks'], (value) => EtlEtlSink.fromMap((value as Map).cast<String, dynamic>()))),
