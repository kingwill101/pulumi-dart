...
class StoreEncryptConf {
  ...
  StoreEncryptConf({this.enable, this.encryptType, this.userCmkInfo});
  ...
  factory StoreEncryptConf.fromMap(Map<String, dynamic> map) {
    return StoreEncryptConf(
      ...
      userCmkInfo: (() {
        final guardedValue = map['userCmkInfo'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          StoreEncryptConfUserCmkInfo.fromMap(
