...
class EtlArgs {
  ...
  factory EtlArgs.fromMap(Map<String, dynamic> map) {
    return EtlArgs(
      ...
      etlName: (map['etlName'] as String).input(),
      etlSinks: (pulumi.Input.decodeList<EtlEtlSink>(map['etlSinks'], (value) => EtlEtlSink.fromMap((value as Map).cast<String, dynamic>()))).input(),
