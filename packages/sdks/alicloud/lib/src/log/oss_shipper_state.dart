...
class OssShipperState {
  ...
  OssShipperState({
    pulumi.Output<int>? bufferInterval,
    pulumi.Output<int>? bufferSize,
    ...
    pulumi.Output<String>? pathFormat,
    pulumi.Output<String>? projectName,
    pulumi.Output<String>? roleArn,
    pulumi.Output<String>? shipperName,
  }) :
      bufferInterval = pulumi.Input.asOptionalInput<int>(bufferInterval),
      bufferSize = pulumi.Input.asOptionalInput<int>(bufferSize),
      ...
      pathFormat = pulumi.Input.asOptionalInput<String>(pathFormat),
      projectName = pulumi.Input.asOptionalInput<String>(projectName),
      roleArn = pulumi.Input.asOptionalInput<String>(roleArn),
      shipperName = pulumi.Input.asOptionalInput<String>(shipperName);
  ...
  factory OssShipperState.fromMap(Map<String, dynamic> map) {
    return OssShipperState(
      bufferInterval: map['bufferInterval'] == null ? null : pulumi.Output.create<int>(map['bufferInterval'] as int),
      bufferSize: map['bufferSize'] == null ? null : pulumi.Output.create<int>(map['bufferSize'] as int),
      ...
      pathFormat: map['pathFormat'] == null ? null : pulumi.Output.create<String>(map['pathFormat'] as String),
      projectName: map['projectName'] == null ? null : pulumi.Output.create<String>(map['projectName'] as String),
      roleArn: map['roleArn'] == null ? null : pulumi.Output.create<String>(map['roleArn'] as String),
      shipperName: map['shipperName'] == null ? null : pulumi.Output.create<String>(map['shipperName'] as String),
    );
  }
}
