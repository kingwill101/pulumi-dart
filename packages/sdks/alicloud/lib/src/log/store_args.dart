...
class StoreArgs {
  ...
  factory StoreArgs.fromMap(Map<String, dynamic> map) {
    return StoreArgs(
      appendMeta: (() {
        final guardedValue = map['appendMeta'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      autoSplit: (() {
        final guardedValue = map['autoSplit'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      enableWebTracking: (() {
        final guardedValue = map['enableWebTracking'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      encryptConf: (() {
        final guardedValue = map['encryptConf'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          StoreEncryptConf.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      hotTtl: (() {
        final guardedValue = map['hotTtl'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      infrequentAccessTtl: (() {
        final guardedValue = map['infrequentAccessTtl'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      logstoreName: (() {
      ...
      maxSplitShardCount: (() {
        final guardedValue = map['maxSplitShardCount'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      meteringMode: (() {
        final guardedValue = map['meteringMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      mode: (() {
      ...
      telemetryType: (() {
        final guardedValue = map['telemetryType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
