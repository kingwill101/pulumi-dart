...
class AlertState {
  ...
  factory AlertState.fromMap(Map<String, dynamic> map) {
    return AlertState(
      alertDescription: (() { final guardedValue = map['alertDescription']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      alertDisplayname: (() { final guardedValue = map['alertDisplayname']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      annotations: (() { final guardedValue = map['annotations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AlertAnnotation>(guardedValue, (value) => AlertAnnotation.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      groupConfiguration: (() { final guardedValue = map['groupConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AlertGroupConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      joinConfigurations: (() { final guardedValue = map['joinConfigurations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AlertJoinConfiguration>(guardedValue, (value) => AlertJoinConfiguration.fromMap((value as Map).cast<String, dynamic>()))); })(),
      labels: (() { final guardedValue = map['labels']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AlertLabel>(guardedValue, (value) => AlertLabel.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      notificationLists: (() { final guardedValue = map['notificationLists']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AlertNotificationList>(guardedValue, (value) => AlertNotificationList.fromMap((value as Map).cast<String, dynamic>()))); })(),
      notifyThreshold: (() { final guardedValue = map['notifyThreshold']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      policyConfiguration: (() { final guardedValue = map['policyConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AlertPolicyConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      queryLists: (() { final guardedValue = map['queryLists']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AlertQueryList>(guardedValue, (value) => AlertQueryList.fromMap((value as Map).cast<String, dynamic>()))); })(),
      schedule: (() { final guardedValue = map['schedule']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AlertSchedule.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      scheduleInterval: (() { final guardedValue = map['scheduleInterval']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      severityConfigurations: (() { final guardedValue = map['severityConfigurations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AlertSeverityConfiguration>(guardedValue, (value) => AlertSeverityConfiguration.fromMap((value as Map).cast<String, dynamic>()))); })(),
      templateConfiguration: (() { final guardedValue = map['templateConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AlertTemplateConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      throttling: (() { final guardedValue = map['throttling']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
