...
class AlertState {
  ...
  AlertState({
    pulumi.Output<String>? alertDescription,
    pulumi.Output<String>? alertDisplayname,
    pulumi.Output<String>? alertName,
    pulumi.Output<List<AlertAnnotation>>? annotations,
    pulumi.Output<bool>? autoAnnotation,
    pulumi.Output<String>? condition,
    pulumi.Output<String>? dashboard,
    pulumi.Output<AlertGroupConfiguration>? groupConfiguration,
    pulumi.Output<List<AlertJoinConfiguration>>? joinConfigurations,
    pulumi.Output<List<AlertLabel>>? labels,
    pulumi.Output<int>? muteUntil,
    pulumi.Output<bool>? noDataFire,
    pulumi.Output<int>? noDataSeverity,
    pulumi.Output<List<AlertNotificationList>>? notificationLists,
    pulumi.Output<int>? notifyThreshold,
    pulumi.Output<AlertPolicyConfiguration>? policyConfiguration,
    pulumi.Output<String>? projectName,
    pulumi.Output<List<AlertQueryList>>? queryLists,
    pulumi.Output<AlertSchedule>? schedule,
    pulumi.Output<String>? scheduleInterval,
    pulumi.Output<String>? scheduleType,
    pulumi.Output<bool>? sendResolved,
    pulumi.Output<List<AlertSeverityConfiguration>>? severityConfigurations,
    pulumi.Output<AlertTemplateConfiguration>? templateConfiguration,
    pulumi.Output<int>? threshold,
    pulumi.Output<String>? throttling,
    pulumi.Output<String>? type,
    pulumi.Output<String>? version,
  }) :
      alertDescription = pulumi.Input.asOptionalInput<String>(alertDescription),
      alertDisplayname = pulumi.Input.asOptionalInput<String>(alertDisplayname),
  ...
  factory AlertState.fromMap(Map<String, dynamic> map) {
    return AlertState(
      alertDescription: map['alertDescription'] == null ? null : pulumi.Output.create<String>(map['alertDescription'] as String),
      alertDisplayname: map['alertDisplayname'] == null ? null : pulumi.Output.create<String>(map['alertDisplayname'] as String),
      alertName: map['alertName'] == null ? null : pulumi.Output.create<String>(map['alertName'] as String),
      annotations: map['annotations'] == null ? null : pulumi.Output.create<List<AlertAnnotation>>(pulumi.Input.decodeList<AlertAnnotation>(map['annotations'], (value) => AlertAnnotation.fromMap((value as Map).cast<String, dynamic>()))),
      autoAnnotation: map['autoAnnotation'] == null ? null : pulumi.Output.create<bool>(map['autoAnnotation'] as bool),
      condition: map['condition'] == null ? null : pulumi.Output.create<String>(map['condition'] as String),
      dashboard: map['dashboard'] == null ? null : pulumi.Output.create<String>(map['dashboard'] as String),
      groupConfiguration: map['groupConfiguration'] == null ? null : pulumi.Output.create<AlertGroupConfiguration>(AlertGroupConfiguration.fromMap((map['groupConfiguration'] as Map).cast<String, dynamic>())),
      joinConfigurations: map['joinConfigurations'] == null ? null : pulumi.Output.create<List<AlertJoinConfiguration>>(pulumi.Input.decodeList<AlertJoinConfiguration>(map['joinConfigurations'], (value) => AlertJoinConfiguration.fromMap((value as Map).cast<String, dynamic>()))),
      labels: map['labels'] == null ? null : pulumi.Output.create<List<AlertLabel>>(pulumi.Input.decodeList<AlertLabel>(map['labels'], (value) => AlertLabel.fromMap((value as Map).cast<String, dynamic>()))),
      muteUntil: map['muteUntil'] == null ? null : pulumi.Output.create<int>(map['muteUntil'] as int),
      noDataFire: map['noDataFire'] == null ? null : pulumi.Output.create<bool>(map['noDataFire'] as bool),
      noDataSeverity: map['noDataSeverity'] == null ? null : pulumi.Output.create<int>(map['noDataSeverity'] as int),
      notificationLists: map['notificationLists'] == null ? null : pulumi.Output.create<List<AlertNotificationList>>(pulumi.Input.decodeList<AlertNotificationList>(map['notificationLists'], (value) => AlertNotificationList.fromMap((value as Map).cast<String, dynamic>()))),
      notifyThreshold: map['notifyThreshold'] == null ? null : pulumi.Output.create<int>(map['notifyThreshold'] as int),
      policyConfiguration: map['policyConfiguration'] == null ? null : pulumi.Output.create<AlertPolicyConfiguration>(AlertPolicyConfiguration.fromMap((map['policyConfiguration'] as Map).cast<String, dynamic>())),
      projectName: map['projectName'] == null ? null : pulumi.Output.create<String>(map['projectName'] as String),
      queryLists: map['queryLists'] == null ? null : pulumi.Output.create<List<AlertQueryList>>(pulumi.Input.decodeList<AlertQueryList>(map['queryLists'], (value) => AlertQueryList.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      scheduleInterval: map['scheduleInterval'] == null ? null : pulumi.Output.create<String>(map['scheduleInterval'] as String),
      scheduleType: map['scheduleType'] == null ? null : pulumi.Output.create<String>(map['scheduleType'] as String),
      sendResolved: map['sendResolved'] == null ? null : pulumi.Output.create<bool>(map['sendResolved'] as bool),
      severityConfigurations: map['severityConfigurations'] == null ? null : pulumi.Output.create<List<AlertSeverityConfiguration>>(pulumi.Input.decodeList<AlertSeverityConfiguration>(map['severityConfigurations'], (value) => AlertSeverityConfiguration.fromMap((value as Map).cast<String, dynamic>()))),
      templateConfiguration: map['templateConfiguration'] == null ? null : pulumi.Output.create<AlertTemplateConfiguration>(AlertTemplateConfiguration.fromMap((map['templateConfiguration'] as Map).cast<String, dynamic>())),
      threshold: map['threshold'] == null ? null : pulumi.Output.create<int>(map['threshold'] as int),
      throttling: map['throttling'] == null ? null : pulumi.Output.create<String>(map['throttling'] as String),
