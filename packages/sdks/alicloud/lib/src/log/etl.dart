...
class Etl extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<Map<String, dynamic>>> etlSinks;
  ...
  Etl(
    ...
    accessKeySecret = registerOutput<String?>('accessKeySecret');
    createTime = registerOutput<int>('createTime');
    description = registerOutput<String?>('description');
    displayName = registerOutput<String>('displayName');
    etlName = registerOutput<String>('etlName');
    etlSinks = registerOutput<List<Map<String, dynamic>>>('etlSinks');
    etlType = registerOutput<String?>('etlType');
    fromTime = registerOutput<int?>('fromTime');
    kmsEncryptedAccessKeyId = registerOutput<String?>('kmsEncryptedAccessKeyId');
    kmsEncryptedAccessKeySecret = registerOutput<String?>('kmsEncryptedAccessKeySecret');
    kmsEncryptionAccessKeyIdContext = registerOutput<Map<String, String>?>('kmsEncryptionAccessKeyIdContext');
    kmsEncryptionAccessKeySecretContext = registerOutput<Map<String, String>?>('kmsEncryptionAccessKeySecretContext');
    ...
    toTime = registerOutput<int?>('toTime');
