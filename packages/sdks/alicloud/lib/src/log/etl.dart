...
class Etl extends pulumi.CustomResource {
  ...
  Etl(String name, {EtlArgs? args, pulumi.CustomResourceOptions? options})
    ...
    kmsEncryptedAccessKeyId = registerOutput<String?>(
      'kmsEncryptedAccessKeyId',
    );
    kmsEncryptedAccessKeySecret = registerOutput<String?>(
      'kmsEncryptedAccessKeySecret',
    );
    kmsEncryptionAccessKeyIdContext = registerOutput<Map<String, String>?>(
      'kmsEncryptionAccessKeyIdContext',
    );
    kmsEncryptionAccessKeySecretContext = registerOutput<Map<String, String>?>(
      'kmsEncryptionAccessKeySecretContext',
    );
