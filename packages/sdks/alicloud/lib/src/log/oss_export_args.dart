...
class OssExportArgs {
  ...
  factory OssExportArgs.fromMap(Map<String, dynamic> map) {
    return OssExportArgs(
      ...
      configColumns: (() {
        final guardedValue = map['configColumns'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<OssExportConfigColumn>(
            guardedValue,
            (value) => OssExportConfigColumn.fromMap(
      ...
      csvConfigEscape: (() {
        final guardedValue = map['csvConfigEscape'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      csvConfigHeader: (() {
      ...
      csvConfigNull: (() {
        final guardedValue = map['csvConfigNull'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      csvConfigQuote: (() {
      ...
      logReadRoleArn: (() {
        final guardedValue = map['logReadRoleArn'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
