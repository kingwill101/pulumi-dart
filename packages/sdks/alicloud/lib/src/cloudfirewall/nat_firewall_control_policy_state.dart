...
class NatFirewallControlPolicyState {
  ...
  const NatFirewallControlPolicyState({
    this.aclAction,
    this.aclUuid,
  ...
  factory NatFirewallControlPolicyState.fromMap(Map<String, dynamic> map) {
    return NatFirewallControlPolicyState(
      ...
      domainResolveType: (() { final guardedValue = map['domainResolveType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      newOrder: (() { final guardedValue = map['newOrder']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
