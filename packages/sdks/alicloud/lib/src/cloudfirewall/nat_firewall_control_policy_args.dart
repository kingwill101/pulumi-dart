...
class NatFirewallControlPolicyArgs {
  ...
  factory NatFirewallControlPolicyArgs.fromMap(Map<String, dynamic> map) {
    return NatFirewallControlPolicyArgs(
      ...
      applicationNameLists: ((map['applicationNameLists'] as List).cast<String>()).input(),
      ...
      domainResolveType: map['domainResolveType'] == null ? null : (map['domainResolveType']! as int).input(),
      ...
      newOrder: (map['newOrder'] as String).input(),
