...
class FirewallVpcFirewallCenLocalVpc {
  ...
  final pulumi.Input<List<FirewallVpcFirewallCenLocalVpcVpcCidrTableList>>?
  vpcCidrTableLists;
    ...
    return <String, dynamic>{
      ...
      'eniLists':
          ?pulumi.Input.mapOptionalInputValue<
            List<FirewallVpcFirewallCenLocalVpcEniList>,
      ...
      'vpcCidrTableLists':
          ?pulumi.Input.mapOptionalInputValue<
            List<FirewallVpcFirewallCenLocalVpcVpcCidrTableList>,
            List<Map<String, dynamic>>
          >(
            vpcCidrTableLists,
            (value) =>
  ...
  factory FirewallVpcFirewallCenLocalVpc.fromMap(Map<String, dynamic> map) {
    return FirewallVpcFirewallCenLocalVpc(
      ...
      attachmentName: (() {
        final guardedValue = map['attachmentName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      defendCidrLists: (() {
        final guardedValue = map['defendCidrLists'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      eniLists: (() {
        final guardedValue = map['eniLists'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FirewallVpcFirewallCenLocalVpcEniList>(
            guardedValue,
            (value) => FirewallVpcFirewallCenLocalVpcEniList.fromMap(
      ...
      manualVswitchId: (() {
        final guardedValue = map['manualVswitchId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ...
      networkInstanceName: (() {
        final guardedValue = map['networkInstanceName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      networkInstanceType: (() {
        final guardedValue = map['networkInstanceType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ownerId: (() {
      ...
      supportManualMode: (() {
        final guardedValue = map['supportManualMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      transitRouterId: (() {
      ...
      transitRouterType: (() {
        final guardedValue = map['transitRouterType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      vpcCidrTableLists: (() {
        final guardedValue = map['vpcCidrTableLists'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<FirewallVpcFirewallCenLocalVpcVpcCidrTableList>(
            guardedValue,
            (value) => FirewallVpcFirewallCenLocalVpcVpcCidrTableList.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
