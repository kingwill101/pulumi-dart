...
class GetAddressBooksResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'books':
          pulumi.Input.encodeList<GetAddressBooksBook, Map<String, dynamic>>(
            books,
            (value) => value.toMap(),
          ),
      'groupType': ?groupType,
  ...
  factory GetAddressBooksResult.fromMap(Map<String, dynamic> map) {
    return GetAddressBooksResult(
      books: pulumi.Input.decodeList<GetAddressBooksBook>(
        map['books']!,
        (value) =>
            GetAddressBooksBook.fromMap((value as Map).cast<String, dynamic>()),
      ),
      groupType: (() {
