...
class FirewallVpcFirewallCenState {
  ...
  factory FirewallVpcFirewallCenState.fromMap(Map<String, dynamic> map) {
    return FirewallVpcFirewallCenState(
      ...
      localVpc: (() { final guardedValue = map['localVpc']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FirewallVpcFirewallCenLocalVpc.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
