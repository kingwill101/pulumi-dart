...
class VpcCenTrFirewallArgs {
  ...
  factory VpcCenTrFirewallArgs.fromMap(Map<String, dynamic> map) {
    return VpcCenTrFirewallArgs(
      ...
      firewallSubnetCidr: pulumi.Input.fromValue(map['firewallSubnetCidr'] as String),
      ...
      trAttachmentMasterCidr: pulumi.Input.fromValue(map['trAttachmentMasterCidr'] as String),
      ...
      trAttachmentSlaveCidr: pulumi.Input.fromValue(map['trAttachmentSlaveCidr'] as String),
