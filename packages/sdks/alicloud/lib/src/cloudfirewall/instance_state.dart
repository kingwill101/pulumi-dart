...
class InstanceState {
  ...
  InstanceState({
    ...
    pulumi.Output<bool>? userStatus,
      ...
      userStatus = pulumi.Input.asOptionalInput<bool>(userStatus);
  ...
  factory InstanceState.fromMap(Map<String, dynamic> map) {
    return InstanceState(
      ...
      userStatus: map['userStatus'] == null ? null : pulumi.Output.create<bool>(map['userStatus'] as bool),
    );
  }
}
