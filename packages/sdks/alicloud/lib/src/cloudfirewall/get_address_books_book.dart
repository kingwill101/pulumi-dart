...
class GetAddressBooksBook {
  ...
  factory GetAddressBooksBook.fromMap(Map<String, dynamic> map) {
    return GetAddressBooksBook(
      ...
      ecsTags: pulumi.Input.fromValue(pulumi.Input.decodeList<GetAddressBooksBookEcsTag>(map['ecsTags']!, (value) => GetAddressBooksBookEcsTag.fromMap((value as Map).cast<String, dynamic>()))),
