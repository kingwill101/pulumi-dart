...
import 'firewall_vpc_firewall_control_policy_state.dart';
...
class FirewallVpcFirewallControlPolicy extends pulumi.CustomResource {
  ...
  FirewallVpcFirewallControlPolicy(
    ...
    destinationGroupCidrs = registerOutput<List<String>>('destinationGroupCidrs');
  ...
  static FirewallVpcFirewallControlPolicy get(
    String name,
    pulumi.Input<String> id, {
    FirewallVpcFirewallControlPolicyState? state,
  }) {
    return FirewallVpcFirewallControlPolicy._get(
      name,
      state: state?.toMap(),
  ...
  FirewallVpcFirewallControlPolicy._get(
    String name, {
