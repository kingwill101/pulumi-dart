...
class UserAlarmConfigAlarmConfig {
  ...
  factory UserAlarmConfigAlarmConfig.fromMap(Map<String, dynamic> map) {
    return UserAlarmConfigAlarmConfig(
      alarmHour: (() { final guardedValue = map['alarmHour']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      alarmNotify: (() { final guardedValue = map['alarmNotify']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      alarmPeriod: (() { final guardedValue = map['alarmPeriod']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      alarmType: (() { final guardedValue = map['alarmType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      alarmValue: (() { final guardedValue = map['alarmValue']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      alarmWeekDay: (() { final guardedValue = map['alarmWeekDay']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
