...
class GetVpcFirewallsFirewallPeerVpcPeerVpcCidrTableList {
  ...
  final pulumi.Input<
    List<GetVpcFirewallsFirewallPeerVpcPeerVpcCidrTableListPeerRouteEntryList>
  >
  peerRouteEntryLists;
  ...
  factory GetVpcFirewallsFirewallPeerVpcPeerVpcCidrTableList.fromMap(
    Map<String, dynamic> map,
  ) {
    return GetVpcFirewallsFirewallPeerVpcPeerVpcCidrTableList(
      peerRouteEntryLists: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetVpcFirewallsFirewallPeerVpcPeerVpcCidrTableListPeerRouteEntryList
        >(
          map['peerRouteEntryLists']!,
          (value) =>
              GetVpcFirewallsFirewallPeerVpcPeerVpcCidrTableListPeerRouteEntryList.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
      peerRouteTableId: pulumi.Input.fromValue(
        map['peerRouteTableId'] as String,
      ),
    );
  }
}
