...
class FirewallVpcFirewallState {
  ...
  factory FirewallVpcFirewallState.fromMap(Map<String, dynamic> map) {
    return FirewallVpcFirewallState(
      ...
      connectType: (() { final guardedValue = map['connectType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      lang: (() { final guardedValue = map['lang']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      localVpc: (() { final guardedValue = map['localVpc']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FirewallVpcFirewallLocalVpc.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      peerVpc: (() { final guardedValue = map['peerVpc']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FirewallVpcFirewallPeerVpc.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      regionStatus: (() { final guardedValue = map['regionStatus']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
