...
class NatFirewallState {
  ...
  factory NatFirewallState.fromMap(Map<String, dynamic> map) {
    return NatFirewallState(
      firewallSwitch: (() { final guardedValue = map['firewallSwitch']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      natRouteEntryLists: (() { final guardedValue = map['natRouteEntryLists']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NatFirewallNatRouteEntryList>(guardedValue, (value) => NatFirewallNatRouteEntryList.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      vswitchAuto: (() { final guardedValue = map['vswitchAuto']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      vswitchCidr: (() { final guardedValue = map['vswitchCidr']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
