...
class NatFirewallArgs {
  ...
  factory NatFirewallArgs.fromMap(Map<String, dynamic> map) {
    return NatFirewallArgs(
      ...
      natRouteEntryLists: pulumi.Input.fromValue(pulumi.Input.decodeList<NatFirewallNatRouteEntryList>(map['natRouteEntryLists']!, (value) => NatFirewallNatRouteEntryList.fromMap((value as Map).cast<String, dynamic>()))),
