...
class FirewallVpcFirewallLocalVpc {
  ...
  final pulumi.Input<List<FirewallVpcFirewallLocalVpcLocalVpcCidrTableList>>
  ...
  factory FirewallVpcFirewallLocalVpc.fromMap(Map<String, dynamic> map) {
    return FirewallVpcFirewallLocalVpc(
      ...
      localVpcCidrTableLists: pulumi.Input.fromValue(
        pulumi
            .Input.decodeList<FirewallVpcFirewallLocalVpcLocalVpcCidrTableList>(
          map['localVpcCidrTableLists']!,
          (value) => FirewallVpcFirewallLocalVpcLocalVpcCidrTableList.fromMap(
