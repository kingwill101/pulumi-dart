...
class GetVpcCenTrFirewallsFirewall {
  ...
  factory GetVpcCenTrFirewallsFirewall.fromMap(Map<String, dynamic> map) {
    return GetVpcCenTrFirewallsFirewall(
      ...
      firewallSwitchStatus: pulumi.Input.fromValue(map['firewallSwitchStatus'] as String),
      id: pulumi.Input.fromValue(map['id'] as String),
      ipsConfig: pulumi.Input.fromValue(GetVpcCenTrFirewallsFirewallIpsConfig.fromMap((map['ipsConfig']! as Map).cast<String, dynamic>())),
