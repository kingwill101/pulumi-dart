...
import 'nat_firewall_control_policy_state.dart';
...
class NatFirewallControlPolicy extends pulumi.CustomResource {
  ...
  static NatFirewallControlPolicy get(
    String name,
    pulumi.Input<String> id, {
    NatFirewallControlPolicyState? state,
  }) {
    return NatFirewallControlPolicy._get(
      name,
      state: state?.toMap(),
