...
class FirewallVpcFirewallLocalVpcLocalVpcCidrTableList {
  ...
  final pulumi.Input<List<FirewallVpcFirewallLocalVpcLocalVpcCidrTableListLocalRouteEntryList>> localRouteEntryLists;
  ...
  const FirewallVpcFirewallLocalVpcLocalVpcCidrTableList({
  ...
  factory FirewallVpcFirewallLocalVpcLocalVpcCidrTableList.fromMap(Map<String, dynamic> map) {
    return FirewallVpcFirewallLocalVpcLocalVpcCidrTableList(
      localRouteEntryLists: pulumi.Input.fromValue(pulumi.Input.decodeList<FirewallVpcFirewallLocalVpcLocalVpcCidrTableListLocalRouteEntryList>(map['localRouteEntryLists']!, (value) => FirewallVpcFirewallLocalVpcLocalVpcCidrTableListLocalRouteEntryList.fromMap((value as Map).cast<String, dynamic>()))),
