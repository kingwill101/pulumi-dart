...
class FirewallVpcFirewallCenLocalVpcVpcCidrTableList {
  ...
  final pulumi.Input<
    List<FirewallVpcFirewallCenLocalVpcVpcCidrTableListRouteEntryList>
  >?
  routeEntryLists;
  ...
  factory FirewallVpcFirewallCenLocalVpcVpcCidrTableList.fromMap(
    Map<String, dynamic> map,
  ) {
    return FirewallVpcFirewallCenLocalVpcVpcCidrTableList(
      routeEntryLists: (() {
        final guardedValue = map['routeEntryLists'];
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                FirewallVpcFirewallCenLocalVpcVpcCidrTableListRouteEntryList.fromMap(
