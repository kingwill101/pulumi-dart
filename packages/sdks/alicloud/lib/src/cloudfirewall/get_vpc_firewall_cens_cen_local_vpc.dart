...
class GetVpcFirewallCensCenLocalVpc {
  ...
  final pulumi.Input<List<GetVpcFirewallCensCenLocalVpcVpcCidrTableList>>
  vpcCidrTableLists;
    ...
    return <String, dynamic>{
      ...
      'eniLists':
          pulumi.Input.mapInputValue<
            List<GetVpcFirewallCensCenLocalVpcEniList>,
      ...
      'vpcCidrTableLists':
          pulumi.Input.mapInputValue<
            List<GetVpcFirewallCensCenLocalVpcVpcCidrTableList>,
            List<Map<String, dynamic>>
          >(
            vpcCidrTableLists,
            (value) =>
  ...
  factory GetVpcFirewallCensCenLocalVpc.fromMap(Map<String, dynamic> map) {
    return GetVpcFirewallCensCenLocalVpc(
      ...
      defendCidrLists: pulumi.Input.fromValue(
        (map['defendCidrLists'] as List).cast<String>(),
      ),
      eniLists: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetVpcFirewallCensCenLocalVpcEniList>(
          map['eniLists']!,
          (value) => GetVpcFirewallCensCenLocalVpcEniList.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      manualVswitchId: pulumi.Input.fromValue(map['manualVswitchId'] as String),
      networkInstanceId: pulumi.Input.fromValue(
        map['networkInstanceId'] as String,
      ),
      networkInstanceName: pulumi.Input.fromValue(
        map['networkInstanceName'] as String,
      ),
      networkInstanceType: pulumi.Input.fromValue(
        map['networkInstanceType'] as String,
      ),
      ...
      supportManualMode: pulumi.Input.fromValue(
        map['supportManualMode'] as String,
      ),
      transitRouterId: pulumi.Input.fromValue(map['transitRouterId'] as String),
      transitRouterType: pulumi.Input.fromValue(
        map['transitRouterType'] as String,
      ),
      vpcCidrTableLists: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetVpcFirewallCensCenLocalVpcVpcCidrTableList>(
          map['vpcCidrTableLists']!,
          (value) => GetVpcFirewallCensCenLocalVpcVpcCidrTableList.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
