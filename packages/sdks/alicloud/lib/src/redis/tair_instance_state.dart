...
class TairInstanceState {
  ...
  factory TairInstanceState.fromMap(Map<String, dynamic> map) {
    return TairInstanceState(
      architectureType: (() { final guardedValue = map['architectureType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      clusterBackupId: (() { final guardedValue = map['clusterBackupId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      intranetBandwidth: (() { final guardedValue = map['intranetBandwidth']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      paramNoLooseSentinelEnabled: (() { final guardedValue = map['paramNoLooseSentinelEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      paramNoLooseSentinelPasswordFreeAccess: (() { final guardedValue = map['paramNoLooseSentinelPasswordFreeAccess']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      paramNoLooseSentinelPasswordFreeCommands: (() { final guardedValue = map['paramNoLooseSentinelPasswordFreeCommands']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      paramReplMode: (() { final guardedValue = map['paramReplMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      paramSemisyncReplTimeout: (() { final guardedValue = map['paramSemisyncReplTimeout']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      paramSentinelCompatEnable: (() { final guardedValue = map['paramSentinelCompatEnable']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      recoverConfigMode: (() { final guardedValue = map['recoverConfigMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      tairInstanceId: (() { final guardedValue = map['tairInstanceId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      tairInstanceName: (() { final guardedValue = map['tairInstanceName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
