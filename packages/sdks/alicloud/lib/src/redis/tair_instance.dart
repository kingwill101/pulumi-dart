...
import 'tair_instance_state.dart';
...
class TairInstance extends pulumi.CustomResource {
  ...
  TairInstance(
    ...
    architectureType = registerOutput<String>('architectureType');
    ...
    clusterBackupId = registerOutput<String?>('clusterBackupId');
    ...
    intranetBandwidth = registerOutput<int>('intranetBandwidth');
    ...
    paramNoLooseSentinelEnabled = registerOutput<String>('paramNoLooseSentinelEnabled');
    paramNoLooseSentinelPasswordFreeAccess = registerOutput<String>('paramNoLooseSentinelPasswordFreeAccess');
    paramNoLooseSentinelPasswordFreeCommands = registerOutput<String>('paramNoLooseSentinelPasswordFreeCommands');
    paramReplMode = registerOutput<String>('paramReplMode');
    paramSemisyncReplTimeout = registerOutput<String>('paramSemisyncReplTimeout');
    paramSentinelCompatEnable = registerOutput<String>('paramSentinelCompatEnable');
    password = registerOutput<String?>('password');
    paymentType = registerOutput<String>('paymentType');
    period = registerOutput<int?>('period');
    port = registerOutput<int>('port');
    readOnlyCount = registerOutput<int?>('readOnlyCount');
    recoverConfigMode = registerOutput<String?>('recoverConfigMode');
    ...
    storageSizeGb = registerOutput<int>('storageSizeGb');
    tags = registerOutput<Map<String, String>?>('tags');
    tairInstanceId = registerOutput<String>('tairInstanceId');
    tairInstanceName = registerOutput<String?>('tairInstanceName');
  ...
  /// Gets an existing [TairInstance] resource's state with the given [name] and [id].
  static TairInstance get(
    String name,
    pulumi.Input<String> id, {
    TairInstanceState? state,
  }) {
    return TairInstance._get(
      name,
      state: state?.toMap(),
