...
class TairInstance extends pulumi.CustomResource {
  ...
  TairInstance(
    ...
    paramNoLooseSentinelEnabled = registerOutput<String>(
      'paramNoLooseSentinelEnabled',
    );
    paramNoLooseSentinelPasswordFreeAccess = registerOutput<String>(
      'paramNoLooseSentinelPasswordFreeAccess',
    );
    paramNoLooseSentinelPasswordFreeCommands = registerOutput<String>(
      'paramNoLooseSentinelPasswordFreeCommands',
    );
    paramReplMode = registerOutput<String>('paramReplMode');
    paramSemisyncReplTimeout = registerOutput<String>(
      'paramSemisyncReplTimeout',
    );
    paramSentinelCompatEnable = registerOutput<String>(
