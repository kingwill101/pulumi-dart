...
class GetContainerGroupsGroup {
  ...
  factory GetContainerGroupsGroup.fromMap(Map<String, dynamic> map) {
    return GetContainerGroupsGroup(
      containerGroupId: pulumi.Input.fromValue(map['containerGroupId'] as String),
      containerGroupName: pulumi.Input.fromValue(map['containerGroupName'] as String),
      containers: pulumi.Input.fromValue(pulumi.Input.decodeList<GetContainerGroupsGroupContainer>(map['containers']!, (value) => GetContainerGroupsGroupContainer.fromMap((value as Map).cast<String, dynamic>()))),
      cpu: pulumi.Input.fromValue(map['cpu'] as double),
      discount: pulumi.Input.fromValue(map['discount'] as int),
      dnsConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetContainerGroupsGroupDnsConfig>(map['dnsConfigs']!, (value) => GetContainerGroupsGroupDnsConfig.fromMap((value as Map).cast<String, dynamic>()))),
      eciSecurityContexts: pulumi.Input.fromValue(pulumi.Input.decodeList<GetContainerGroupsGroupEciSecurityContext>(map['eciSecurityContexts']!, (value) => GetContainerGroupsGroupEciSecurityContext.fromMap((value as Map).cast<String, dynamic>()))),
      eniInstanceId: pulumi.Input.fromValue(map['eniInstanceId'] as String),
      events: pulumi.Input.fromValue(pulumi.Input.decodeList<GetContainerGroupsGroupEvent>(map['events']!, (value) => GetContainerGroupsGroupEvent.fromMap((value as Map).cast<String, dynamic>()))),
      expiredTime: pulumi.Input.fromValue(map['expiredTime'] as String),
      failedTime: pulumi.Input.fromValue(map['failedTime'] as String),
      hostAliases: pulumi.Input.fromValue(pulumi.Input.decodeList<GetContainerGroupsGroupHostAlias>(map['hostAliases']!, (value) => GetContainerGroupsGroupHostAlias.fromMap((value as Map).cast<String, dynamic>()))),
      id: pulumi.Input.fromValue(map['id'] as String),
      initContainers: pulumi.Input.fromValue(pulumi.Input.decodeList<GetContainerGroupsGroupInitContainer>(map['initContainers']!, (value) => GetContainerGroupsGroupInitContainer.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      volumes: pulumi.Input.fromValue(pulumi.Input.decodeList<GetContainerGroupsGroupVolume>(map['volumes']!, (value) => GetContainerGroupsGroupVolume.fromMap((value as Map).cast<String, dynamic>()))),
