...
class GetContainerGroupsGroupInitContainer {
  ...
  factory GetContainerGroupsGroupInitContainer.fromMap(Map<String, dynamic> map) {
    return GetContainerGroupsGroupInitContainer(
      ...
      environmentVars: pulumi.Input.fromValue(pulumi.Input.decodeList<GetContainerGroupsGroupInitContainerEnvironmentVar>(map['environmentVars']!, (value) => GetContainerGroupsGroupInitContainerEnvironmentVar.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      ports: pulumi.Input.fromValue(pulumi.Input.decodeList<GetContainerGroupsGroupInitContainerPort>(map['ports']!, (value) => GetContainerGroupsGroupInitContainerPort.fromMap((value as Map).cast<String, dynamic>()))),
      ready: pulumi.Input.fromValue(map['ready'] as bool),
      restartCount: pulumi.Input.fromValue(map['restartCount'] as int),
      volumeMounts: pulumi.Input.fromValue(pulumi.Input.decodeList<GetContainerGroupsGroupInitContainerVolumeMount>(map['volumeMounts']!, (value) => GetContainerGroupsGroupInitContainerVolumeMount.fromMap((value as Map).cast<String, dynamic>()))),
