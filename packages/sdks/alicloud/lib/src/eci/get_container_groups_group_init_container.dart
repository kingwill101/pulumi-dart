...
class GetContainerGroupsGroupInitContainer {
  ...
  final pulumi.Input<List<GetContainerGroupsGroupInitContainerEnvironmentVar>>
  environmentVars;
  ...
  final pulumi.Input<List<GetContainerGroupsGroupInitContainerVolumeMount>>
  volumeMounts;
    ...
    return <String, dynamic>{
      ...
      'environmentVars':
          pulumi.Input.mapInputValue<
            List<GetContainerGroupsGroupInitContainerEnvironmentVar>,
      ...
      'ports':
          pulumi.Input.mapInputValue<
            List<GetContainerGroupsGroupInitContainerPort>,
            List<Map<String, dynamic>>
          >(
            ports,
            (value) =>
      ...
      'volumeMounts':
          pulumi.Input.mapInputValue<
            List<GetContainerGroupsGroupInitContainerVolumeMount>,
            List<Map<String, dynamic>>
          >(
            volumeMounts,
            (value) =>
  ...
  factory GetContainerGroupsGroupInitContainer.fromMap(
    ...
    return GetContainerGroupsGroupInitContainer(
      ...
      environmentVars: pulumi.Input.fromValue(
        ...
        >(
          map['environmentVars']!,
          (value) => GetContainerGroupsGroupInitContainerEnvironmentVar.fromMap(
      ...
      ports: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetContainerGroupsGroupInitContainerPort>(
          map['ports']!,
          (value) => GetContainerGroupsGroupInitContainerPort.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      ...
      volumeMounts: pulumi.Input.fromValue(
        pulumi
            .Input.decodeList<GetContainerGroupsGroupInitContainerVolumeMount>(
          map['volumeMounts']!,
          (value) => GetContainerGroupsGroupInitContainerVolumeMount.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
