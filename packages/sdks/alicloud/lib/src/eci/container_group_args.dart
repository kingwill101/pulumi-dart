...
class ContainerGroupArgs {
  ...
  factory ContainerGroupArgs.fromMap(Map<String, dynamic> map) {
    return ContainerGroupArgs(
      acrRegistryInfos: map['acrRegistryInfos'] == null ? null : (pulumi.Input.decodeList<ContainerGroupAcrRegistryInfo>(map['acrRegistryInfos'], (value) => ContainerGroupAcrRegistryInfo.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      containers: (pulumi.Input.decodeList<ContainerGroupContainer>(map['containers'], (value) => ContainerGroupContainer.fromMap((value as Map).cast<String, dynamic>()))).input(),
      cpu: map['cpu'] == null ? null : (map['cpu'] as double).input(),
      dnsConfig: map['dnsConfig'] == null ? null : (ContainerGroupDnsConfig.fromMap((map['dnsConfig'] as Map).cast<String, dynamic>())).input(),
      ...
      hostAliases: map['hostAliases'] == null ? null : (pulumi.Input.decodeList<ContainerGroupHostAlias>(map['hostAliases'], (value) => ContainerGroupHostAlias.fromMap((value as Map).cast<String, dynamic>()))).input(),
      imageRegistryCredentials: map['imageRegistryCredentials'] == null ? null : (pulumi.Input.decodeList<ContainerGroupImageRegistryCredential>(map['imageRegistryCredentials'], (value) => ContainerGroupImageRegistryCredential.fromMap((value as Map).cast<String, dynamic>()))).input(),
      initContainers: map['initContainers'] == null ? null : (pulumi.Input.decodeList<ContainerGroupInitContainer>(map['initContainers'], (value) => ContainerGroupInitContainer.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      plainHttpRegistry: map['plainHttpRegistry'] == null ? null : (map['plainHttpRegistry'] as String).input(),
      ...
      securityContext: map['securityContext'] == null ? null : (ContainerGroupSecurityContext.fromMap((map['securityContext'] as Map).cast<String, dynamic>())).input(),
      ...
      volumes: map['volumes'] == null ? null : (pulumi.Input.decodeList<ContainerGroupVolume>(map['volumes'], (value) => ContainerGroupVolume.fromMap((value as Map).cast<String, dynamic>()))).input(),
