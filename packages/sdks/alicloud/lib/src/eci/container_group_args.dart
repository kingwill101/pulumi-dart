...
class ContainerGroupArgs {
  ...
  ContainerGroupArgs({
    ...
    required pulumi.Output<List<ContainerGroupContainer>> containers,
  ...
  factory ContainerGroupArgs.fromMap(Map<String, dynamic> map) {
    return ContainerGroupArgs(
      ...
      containers: pulumi.Output.create<List<ContainerGroupContainer>>(pulumi.Input.decodeList<ContainerGroupContainer>(map['containers'], (value) => ContainerGroupContainer.fromMap((value as Map).cast<String, dynamic>()))),
