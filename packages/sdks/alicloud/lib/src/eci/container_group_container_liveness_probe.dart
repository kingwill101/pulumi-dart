...
class ContainerGroupContainerLivenessProbe {
  ...
  final pulumi.Input<List<ContainerGroupContainerLivenessProbeHttpGet>>?
  httpGets;
  ...
  final pulumi.Input<List<ContainerGroupContainerLivenessProbeTcpSocket>>?
  tcpSockets;
    ...
    return <String, dynamic>{
      'execs':
          ?pulumi.Input.mapOptionalInputValue<
            List<ContainerGroupContainerLivenessProbeExec>,
      ...
      'httpGets':
          ?pulumi.Input.mapOptionalInputValue<
            List<ContainerGroupContainerLivenessProbeHttpGet>,
            List<Map<String, dynamic>>
          >(
            httpGets,
            (value) =>
      ...
      'tcpSockets':
          ?pulumi.Input.mapOptionalInputValue<
            List<ContainerGroupContainerLivenessProbeTcpSocket>,
            List<Map<String, dynamic>>
          >(
            tcpSockets,
            (value) =>
  ...
  factory ContainerGroupContainerLivenessProbe.fromMap(
    ...
    return ContainerGroupContainerLivenessProbe(
      execs: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ContainerGroupContainerLivenessProbeExec>(
            guardedValue,
            (value) => ContainerGroupContainerLivenessProbeExec.fromMap(
      ...
      httpGets: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ContainerGroupContainerLivenessProbeHttpGet>(
            guardedValue,
            (value) => ContainerGroupContainerLivenessProbeHttpGet.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      tcpSockets: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<ContainerGroupContainerLivenessProbeTcpSocket>(
            guardedValue,
            (value) => ContainerGroupContainerLivenessProbeTcpSocket.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
