...
class ImageCacheArgs {
  ...
  final pulumi.Input<List<ImageCacheImageRegistryCredential>>?
    ...
    return <String, dynamic>{
      ...
      'imageRegistryCredentials':
          ?pulumi.Input.mapOptionalInputValue<
            List<ImageCacheImageRegistryCredential>,
    ...
    return ImageCacheArgs(
      ...
      imageRegistryCredentials: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ImageCacheImageRegistryCredential>(
            guardedValue,
            (value) => ImageCacheImageRegistryCredential.fromMap(
