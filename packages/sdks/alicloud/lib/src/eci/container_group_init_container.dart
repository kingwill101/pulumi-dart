...
class ContainerGroupInitContainer {
  ...
  final pulumi.Input<List<ContainerGroupInitContainerEnvironmentVar>>?
  environmentVars;
  ...
  final pulumi.Input<List<ContainerGroupInitContainerSecurityContext>>?
  securityContexts;

  /// The structure of volumeMounts. See `volume_mounts` below.
  final pulumi.Input<List<ContainerGroupInitContainerVolumeMount>>?
  volumeMounts;
    ...
    return <String, dynamic>{
      ...
      'environmentVars':
          ?pulumi.Input.mapOptionalInputValue<
            List<ContainerGroupInitContainerEnvironmentVar>,
      ...
      'ports':
          ?pulumi.Input.mapOptionalInputValue<
            List<ContainerGroupInitContainerPort>,
            List<Map<String, dynamic>>
          >(
            ports,
            (value) =>
      ...
      'securityContexts':
          ?pulumi.Input.mapOptionalInputValue<
            List<ContainerGroupInitContainerSecurityContext>,
            List<Map<String, dynamic>>
          >(
            securityContexts,
            (value) =>
      ...
      'volumeMounts':
          ?pulumi.Input.mapOptionalInputValue<
            List<ContainerGroupInitContainerVolumeMount>,
            List<Map<String, dynamic>>
          >(
            volumeMounts,
            (value) =>
    ...
    return ContainerGroupInitContainer(
      ...
      environmentVars: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ContainerGroupInitContainerEnvironmentVar>(
            guardedValue,
            (value) => ContainerGroupInitContainerEnvironmentVar.fromMap(
      ...
      ports: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ContainerGroupInitContainerPort>(
            guardedValue,
            (value) => ContainerGroupInitContainerPort.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      securityContexts: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ContainerGroupInitContainerSecurityContext>(
            guardedValue,
            (value) => ContainerGroupInitContainerSecurityContext.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      volumeMounts: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ContainerGroupInitContainerVolumeMount>(
            guardedValue,
            (value) => ContainerGroupInitContainerVolumeMount.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
