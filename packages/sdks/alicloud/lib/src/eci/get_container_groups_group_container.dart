...
class GetContainerGroupsGroupContainer {
  ...
  factory GetContainerGroupsGroupContainer.fromMap(Map<String, dynamic> map) {
    return GetContainerGroupsGroupContainer(
      ...
      environmentVars: (pulumi.Input.decodeList<GetContainerGroupsGroupContainerEnvironmentVar>(map['environmentVars'], (value) => GetContainerGroupsGroupContainerEnvironmentVar.fromMap((value as Map).cast<String, dynamic>()))).input(),
      gpu: (map['gpu'] as int).input(),
      image: (map['image'] as String).input(),
      imagePullPolicy: (map['imagePullPolicy'] as String).input(),
      memory: (map['memory'] as double).input(),
      name: (map['name'] as String).input(),
      ports: (pulumi.Input.decodeList<GetContainerGroupsGroupContainerPort>(map['ports'], (value) => GetContainerGroupsGroupContainerPort.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ready: (map['ready'] as bool).input(),
      restartCount: (map['restartCount'] as int).input(),
      volumeMounts: (pulumi.Input.decodeList<GetContainerGroupsGroupContainerVolumeMount>(map['volumeMounts'], (value) => GetContainerGroupsGroupContainerVolumeMount.fromMap((value as Map).cast<String, dynamic>()))).input(),
