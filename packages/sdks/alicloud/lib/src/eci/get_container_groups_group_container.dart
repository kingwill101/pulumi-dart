...
class GetContainerGroupsGroupContainer {
  ...
  final pulumi.Input<List<GetContainerGroupsGroupContainerEnvironmentVar>>
  environmentVars;
  ...
  final pulumi.Input<List<GetContainerGroupsGroupContainerVolumeMount>>
  volumeMounts;
    ...
    return <String, dynamic>{
      ...
      'environmentVars':
          pulumi.Input.mapInputValue<
            List<GetContainerGroupsGroupContainerEnvironmentVar>,
      ...
      'ports':
          pulumi.Input.mapInputValue<
            List<GetContainerGroupsGroupContainerPort>,
            List<Map<String, dynamic>>
          >(
            ports,
            (value) =>
      ...
      'volumeMounts':
          pulumi.Input.mapInputValue<
            List<GetContainerGroupsGroupContainerVolumeMount>,
            List<Map<String, dynamic>>
          >(
            volumeMounts,
            (value) =>
  ...
  factory GetContainerGroupsGroupContainer.fromMap(Map<String, dynamic> map) {
    return GetContainerGroupsGroupContainer(
      ...
      environmentVars: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetContainerGroupsGroupContainerEnvironmentVar>(
          map['environmentVars']!,
          (value) => GetContainerGroupsGroupContainerEnvironmentVar.fromMap(
      ...
      ports: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetContainerGroupsGroupContainerPort>(
          map['ports']!,
          (value) => GetContainerGroupsGroupContainerPort.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      ...
      volumeMounts: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetContainerGroupsGroupContainerVolumeMount>(
          map['volumeMounts']!,
          (value) => GetContainerGroupsGroupContainerVolumeMount.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
