...
class GetImageCachesCache {
  ...
  factory GetImageCachesCache.fromMap(Map<String, dynamic> map) {
    return GetImageCachesCache(
      ...
      events: pulumi.Input.fromValue(pulumi.Input.decodeList<GetImageCachesCacheEvent>(map['events']!, (value) => GetImageCachesCacheEvent.fromMap((value as Map).cast<String, dynamic>()))),
