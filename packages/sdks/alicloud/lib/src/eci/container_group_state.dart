...
class ContainerGroupState {
  ...
  factory ContainerGroupState.fromMap(Map<String, dynamic> map) {
    return ContainerGroupState(
      ...
      containers: map['containers'] == null ? null : (pulumi.Input.decodeList<ContainerGroupContainer>(map['containers']!, (value) => ContainerGroupContainer.fromMap((value as Map).cast<String, dynamic>()))).input(),
