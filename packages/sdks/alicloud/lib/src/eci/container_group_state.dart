...
class ContainerGroupState {
  ...
  factory ContainerGroupState.fromMap(Map<String, dynamic> map) {
    return ContainerGroupState(
      ...
      containers: (() { final guardedValue = map['containers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ContainerGroupContainer>(guardedValue, (value) => ContainerGroupContainer.fromMap((value as Map).cast<String, dynamic>()))); })(),
