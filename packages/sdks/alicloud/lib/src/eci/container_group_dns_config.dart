...
class ContainerGroupDnsConfig {
  ...
  factory ContainerGroupDnsConfig.fromMap(Map<String, dynamic> map) {
    return ContainerGroupDnsConfig(
      ...
      options: (() { final guardedValue = map['options']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ContainerGroupDnsConfigOption>(guardedValue, (value) => ContainerGroupDnsConfigOption.fromMap((value as Map).cast<String, dynamic>()))); })(),
