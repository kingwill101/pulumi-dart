...
class ContainerGroupContainer {
  ...
  factory ContainerGroupContainer.fromMap(Map<String, dynamic> map) {
    return ContainerGroupContainer(
      ...
      environmentVars: (() { final guardedValue = map['environmentVars']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ContainerGroupContainerEnvironmentVar>(guardedValue, (value) => ContainerGroupContainerEnvironmentVar.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      livenessProbes: (() { final guardedValue = map['livenessProbes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ContainerGroupContainerLivenessProbe>(guardedValue, (value) => ContainerGroupContainerLivenessProbe.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      ports: (() { final guardedValue = map['ports']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ContainerGroupContainerPort>(guardedValue, (value) => ContainerGroupContainerPort.fromMap((value as Map).cast<String, dynamic>()))); })(),
      readinessProbes: (() { final guardedValue = map['readinessProbes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ContainerGroupContainerReadinessProbe>(guardedValue, (value) => ContainerGroupContainerReadinessProbe.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      securityContexts: (() { final guardedValue = map['securityContexts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ContainerGroupContainerSecurityContext>(guardedValue, (value) => ContainerGroupContainerSecurityContext.fromMap((value as Map).cast<String, dynamic>()))); })(),
      volumeMounts: (() { final guardedValue = map['volumeMounts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ContainerGroupContainerVolumeMount>(guardedValue, (value) => ContainerGroupContainerVolumeMount.fromMap((value as Map).cast<String, dynamic>()))); })(),
