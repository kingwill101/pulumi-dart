...
class GetContainerGroupsGroupVolume {
  ...
  final pulumi.Input<
    List<GetContainerGroupsGroupVolumeConfigFileVolumeConfigFileToPath>
  >
  ...
  factory GetContainerGroupsGroupVolume.fromMap(Map<String, dynamic> map) {
    return GetContainerGroupsGroupVolume(
      configFileVolumeConfigFileToPaths: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetContainerGroupsGroupVolumeConfigFileVolumeConfigFileToPath
        >(
          map['configFileVolumeConfigFileToPaths']!,
          (value) =>
              GetContainerGroupsGroupVolumeConfigFileVolumeConfigFileToPath.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
      diskVolumeDiskId: pulumi.Input.fromValue(
        map['diskVolumeDiskId'] as String,
      ),
      diskVolumeFsType: pulumi.Input.fromValue(
        map['diskVolumeFsType'] as String,
      ),
      flexVolumeDriver: pulumi.Input.fromValue(
        map['flexVolumeDriver'] as String,
      ),
      flexVolumeFsType: pulumi.Input.fromValue(
        map['flexVolumeFsType'] as String,
      ),
      flexVolumeOptions: pulumi.Input.fromValue(
        map['flexVolumeOptions'] as String,
      ),
      name: pulumi.Input.fromValue(map['name'] as String),
      nfsVolumePath: pulumi.Input.fromValue(map['nfsVolumePath'] as String),
      nfsVolumeReadOnly: pulumi.Input.fromValue(
        map['nfsVolumeReadOnly'] as bool,
      ),
