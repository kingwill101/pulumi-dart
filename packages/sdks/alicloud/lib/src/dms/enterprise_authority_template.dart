...
import 'enterprise_authority_template_state.dart';
...
class EnterpriseAuthorityTemplate extends pulumi.CustomResource {
  ...
  static EnterpriseAuthorityTemplate get(
    String name,
    pulumi.Input<String> id, {
    EnterpriseAuthorityTemplateState? state,
  }) {
    return EnterpriseAuthorityTemplate._get(
      name,
      state: state?.toMap(),
  ...
  EnterpriseAuthorityTemplate._get(
    String name, {
