...
import 'enterprise_proxy_state.dart';
...
class EnterpriseProxy extends pulumi.CustomResource {
  ...
  /// Gets an existing [EnterpriseProxy] resource's state with the given [name] and [id].
  static EnterpriseProxy get(
    String name,
    pulumi.Input<String> id, {
    EnterpriseProxyState? state,
  }) {
    return EnterpriseProxy._get(
      name,
      state: state?.toMap(),
