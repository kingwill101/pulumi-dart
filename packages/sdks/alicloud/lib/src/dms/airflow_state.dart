...
class AirflowState {
  ...
  factory AirflowState.fromMap(Map<String, dynamic> map) {
    return AirflowState(
      airflowId: (() {
        final guardedValue = map['airflowId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      airflowName: (() {
        final guardedValue = map['airflowName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      appSpec: (() {
        final guardedValue = map['appSpec'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      dagsDir: (() {
        final guardedValue = map['dagsDir'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      description: (() {
      ...
      ossPath: (() {
        final guardedValue = map['ossPath'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      pluginsDir: (() {
        final guardedValue = map['pluginsDir'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      regionId: (() {
      ...
      requirementFile: (() {
        final guardedValue = map['requirementFile'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      securityGroupId: (() {
      ...
      startupFile: (() {
        final guardedValue = map['startupFile'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      vpcId: (() {
      ...
      workerServerlessReplicas: (() {
        final guardedValue = map['workerServerlessReplicas'];
        if (guardedValue == null) return null;
