...
class EnterpriseInstanceState {
  ...
  factory EnterpriseInstanceState.fromMap(Map<String, dynamic> map) {
    return EnterpriseInstanceState(
      ...
      dbaNickName: (() { final guardedValue = map['dbaNickName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      dbaUid: (() { final guardedValue = map['dbaUid']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      exportTimeout: (() { final guardedValue = map['exportTimeout']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      safeRule: (() { final guardedValue = map['safeRule']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
