...
class EnterpriseInstanceState {
  ...
  EnterpriseInstanceState({
    ...
    pulumi.Output<int>? queryTimeout,
    pulumi.Output<String>? safeRule,
    ...
    pulumi.Output<String>? vpcId,
      ...
      databaseUser = pulumi.Input.asOptionalInput<String>(databaseUser),
      dbaId = pulumi.Input.asOptionalInput<String>(dbaId),
      dbaNickName = pulumi.Input.asOptionalInput<String>(dbaNickName),
      dbaUid = pulumi.Input.asOptionalInput<int>(dbaUid),
      ...
      exportTimeout = pulumi.Input.asOptionalInput<int>(exportTimeout),
      ...
      queryTimeout = pulumi.Input.asOptionalInput<int>(queryTimeout),
      safeRule = pulumi.Input.asOptionalInput<String>(safeRule),
  ...
  factory EnterpriseInstanceState.fromMap(Map<String, dynamic> map) {
    return EnterpriseInstanceState(
      ...
      databaseUser: map['databaseUser'] == null ? null : pulumi.Output.create<String>(map['databaseUser'] as String),
      dbaId: map['dbaId'] == null ? null : pulumi.Output.create<String>(map['dbaId'] as String),
      dbaNickName: map['dbaNickName'] == null ? null : pulumi.Output.create<String>(map['dbaNickName'] as String),
      dbaUid: map['dbaUid'] == null ? null : pulumi.Output.create<int>(map['dbaUid'] as int),
      ...
      exportTimeout: map['exportTimeout'] == null ? null : pulumi.Output.create<int>(map['exportTimeout'] as int),
      ...
      queryTimeout: map['queryTimeout'] == null ? null : pulumi.Output.create<int>(map['queryTimeout'] as int),
      safeRule: map['safeRule'] == null ? null : pulumi.Output.create<String>(map['safeRule'] as String),
