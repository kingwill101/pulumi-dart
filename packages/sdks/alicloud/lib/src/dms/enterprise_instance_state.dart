...
class EnterpriseInstanceState {
  ...
  factory EnterpriseInstanceState.fromMap(Map<String, dynamic> map) {
    return EnterpriseInstanceState(
      dataLinkName: (() {
        final guardedValue = map['dataLinkName'];
      ...
      dbaId: (() {
        final guardedValue = map['dbaId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      dbaNickName: (() {
        final guardedValue = map['dbaNickName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      dbaUid: (() {
        final guardedValue = map['dbaUid'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      ddlOnline: (() {
        final guardedValue = map['ddlOnline'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      ecsInstanceId: (() {
      ...
      ecsRegion: (() {
        final guardedValue = map['ecsRegion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      envType: (() {
      ...
      exportTimeout: (() {
        final guardedValue = map['exportTimeout'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      host: (() {
      ...
      safeRule: (() {
        final guardedValue = map['safeRule'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      safeRuleId: (() {
        final guardedValue = map['safeRuleId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      sid: (() {
      ...
      skipTest: (() {
        final guardedValue = map['skipTest'];
        if (guardedValue == null) return null;
      ...
      useDsql: (() {
        final guardedValue = map['useDsql'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      vpcId: (() {
