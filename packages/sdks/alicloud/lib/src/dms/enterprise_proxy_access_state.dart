...
class EnterpriseProxyAccessState {
  ...
  factory EnterpriseProxyAccessState.fromMap(Map<String, dynamic> map) {
    return EnterpriseProxyAccessState(
      ...
      accessSecret: (() { final guardedValue = map['accessSecret']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      originInfo: (() { final guardedValue = map['originInfo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      userUid: (() { final guardedValue = map['userUid']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
