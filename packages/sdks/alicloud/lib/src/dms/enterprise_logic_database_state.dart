...
class EnterpriseLogicDatabaseState {
  ...
  factory EnterpriseLogicDatabaseState.fromMap(Map<String, dynamic> map) {
    return EnterpriseLogicDatabaseState(
      ...
      databaseIds: (() { final guardedValue = map['databaseIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      ...
      logic: (() { final guardedValue = map['logic']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      ownerIdLists: (() { final guardedValue = map['ownerIdLists']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      ownerNameLists: (() { final guardedValue = map['ownerNameLists']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      ...
      searchName: (() { final guardedValue = map['searchName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
