...
class GetLoadBalancersBalancer {
  ...
  final pulumi.Input<List<GetLoadBalancersBalancerBackendServer>>
  backendServers;
  ...
  final pulumi.Input<List<GetLoadBalancersBalancerListenerPortsAndProtocal>>
  listenerPortsAndProtocals;
  final pulumi.Input<List<GetLoadBalancersBalancerListenerPortsAndProtocol>>
    ...
    return <String, dynamic>{
      ...
      'backendServers':
          pulumi.Input.mapInputValue<
            List<GetLoadBalancersBalancerBackendServer>,
      ...
      'listenerPortsAndProtocals':
          pulumi.Input.mapInputValue<
            List<GetLoadBalancersBalancerListenerPortsAndProtocal>,
            List<Map<String, dynamic>>
          >(
            listenerPortsAndProtocals,
            (value) =>
      ...
      'listenerPortsAndProtocols':
          pulumi.Input.mapInputValue<
            List<GetLoadBalancersBalancerListenerPortsAndProtocol>,
            List<Map<String, dynamic>>
          >(
            listenerPortsAndProtocols,
            (value) =>
  ...
  factory GetLoadBalancersBalancer.fromMap(Map<String, dynamic> map) {
    return GetLoadBalancersBalancer(
      ...
      backendServers: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetLoadBalancersBalancerBackendServer>(
          map['backendServers']!,
          (value) => GetLoadBalancersBalancerBackendServer.fromMap(
      ...
      listenerPortsAndProtocals: pulumi.Input.fromValue(
        pulumi
            .Input.decodeList<GetLoadBalancersBalancerListenerPortsAndProtocal>(
          map['listenerPortsAndProtocals']!,
          (value) => GetLoadBalancersBalancerListenerPortsAndProtocal.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      listenerPortsAndProtocols: pulumi.Input.fromValue(
        pulumi
            .Input.decodeList<GetLoadBalancersBalancerListenerPortsAndProtocol>(
          map['listenerPortsAndProtocols']!,
          (value) => GetLoadBalancersBalancerListenerPortsAndProtocol.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
