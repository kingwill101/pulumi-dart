...
class GetMasterSlaveServerGroupsGroup {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'id': id,
      'name': name,
      'servers': pulumi.Input.mapInputValue<List<GetMasterSlaveServerGroupsGroupServer>, List<Map<String, dynamic>>>(servers, (value) => pulumi.Input.encodeList<GetMasterSlaveServerGroupsGroupServer, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory GetMasterSlaveServerGroupsGroup.fromMap(Map<String, dynamic> map) {
    return GetMasterSlaveServerGroupsGroup(
      ...
      servers: pulumi.Input.fromValue(pulumi.Input.decodeList<GetMasterSlaveServerGroupsGroupServer>(map['servers']!, (value) => GetMasterSlaveServerGroupsGroupServer.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
