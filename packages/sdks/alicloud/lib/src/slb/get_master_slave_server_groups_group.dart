...
class GetMasterSlaveServerGroupsGroup {
  ...
  factory GetMasterSlaveServerGroupsGroup.fromMap(Map<String, dynamic> map) {
    return GetMasterSlaveServerGroupsGroup(
      ...
      servers: (pulumi.Input.decodeList<GetMasterSlaveServerGroupsGroupServer>(map['servers'], (value) => GetMasterSlaveServerGroupsGroupServer.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
