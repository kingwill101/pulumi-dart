...
class GetServerGroupsSlbServerGroup {
  ...
  factory GetServerGroupsSlbServerGroup.fromMap(Map<String, dynamic> map) {
    return GetServerGroupsSlbServerGroup(
      ...
      servers: pulumi.Input.fromValue(pulumi.Input.decodeList<GetServerGroupsSlbServerGroupServer>(map['servers']!, (value) => GetServerGroupsSlbServerGroupServer.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
