...
class ServerCertificateState {
  ...
  factory ServerCertificateState.fromMap(Map<String, dynamic> map) {
    return ServerCertificateState(
      alicloudCertifacteId: (() { final guardedValue = map['alicloudCertifacteId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      alicloudCertifacteName: (() { final guardedValue = map['alicloudCertifacteName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      alicloudCertificateId: (() { final guardedValue = map['alicloudCertificateId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      alicloudCertificateName: (() { final guardedValue = map['alicloudCertificateName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      alicloudCertificateRegionId: (() { final guardedValue = map['alicloudCertificateRegionId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
