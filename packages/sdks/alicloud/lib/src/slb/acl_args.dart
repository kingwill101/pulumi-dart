...
/// {@template pulumi_slb_acl_acl_args_doc}
/// The set of arguments for Acl.
/// {@endtemplate}
/// {@macro pulumi_slb_acl_acl_args_doc}
class AclArgs {
  ...
  factory AclArgs.fromMap(Map<String, dynamic> map) {
    return AclArgs(
      entryLists: (() { final guardedValue = map['entryLists']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AclEntryList>(guardedValue, (value) => AclEntryList.fromMap((value as Map).cast<String, dynamic>()))); })(),
