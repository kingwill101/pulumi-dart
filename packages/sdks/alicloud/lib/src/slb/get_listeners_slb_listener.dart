...
class GetListenersSlbListener {
  ...
  factory GetListenersSlbListener.fromMap(Map<String, dynamic> map) {
    return GetListenersSlbListener(
      ...
      establishedTimeout: pulumi.Input.fromValue(
        map['establishedTimeout'] as int,
      ),
      ...
      healthCheckConnectTimeout: pulumi.Input.fromValue(
        map['healthCheckConnectTimeout'] as int,
      ),
      healthCheckDomain: pulumi.Input.fromValue(
        map['healthCheckDomain'] as String,
      ),
      healthCheckHttpCode: pulumi.Input.fromValue(
        map['healthCheckHttpCode'] as String,
      ),
      ...
      masterSlaveServerGroupId: pulumi.Input.fromValue(
        map['masterSlaveServerGroupId'] as String,
      ),
      persistenceTimeout: pulumi.Input.fromValue(
        map['persistenceTimeout'] as int,
      ),
      protocol: pulumi.Input.fromValue(map['protocol'] as String),
      proxyProtocolV2Enabled: pulumi.Input.fromValue(
        map['proxyProtocolV2Enabled'] as bool,
      ),
      ...
      xForwardedForSlbId: pulumi.Input.fromValue(
        map['xForwardedForSlbId'] as String,
      ),
      xForwardedForSlbIp: pulumi.Input.fromValue(
        map['xForwardedForSlbIp'] as String,
      ),
      xForwardedForSlbProto: pulumi.Input.fromValue(
        map['xForwardedForSlbProto'] as String,
      ),
    );
  }
}
