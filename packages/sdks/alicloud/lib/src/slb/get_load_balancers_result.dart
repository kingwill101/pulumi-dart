...
class GetLoadBalancersResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'slbs':
          pulumi.Input.encodeList<GetLoadBalancersSlb, Map<String, dynamic>>(
            slbs,
            (value) => value.toMap(),
          ),
      'status': ?status,
  ...
  factory GetLoadBalancersResult.fromMap(Map<String, dynamic> map) {
    return GetLoadBalancersResult(
      ...
      slbs: pulumi.Input.decodeList<GetLoadBalancersSlb>(
        map['slbs']!,
        (value) =>
            GetLoadBalancersSlb.fromMap((value as Map).cast<String, dynamic>()),
      ),
      status: (() {
