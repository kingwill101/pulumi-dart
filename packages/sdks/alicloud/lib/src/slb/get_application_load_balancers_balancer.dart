...
class GetApplicationLoadBalancersBalancer {
  ...
  const GetApplicationLoadBalancersBalancer({
  ...
  factory GetApplicationLoadBalancersBalancer.fromMap(Map<String, dynamic> map) {
    return GetApplicationLoadBalancersBalancer(
      ...
      backendServers: pulumi.Input.fromValue(pulumi.Input.decodeList<GetApplicationLoadBalancersBalancerBackendServer>(map['backendServers']!, (value) => GetApplicationLoadBalancersBalancerBackendServer.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      listenerPortsAndProtocals: pulumi.Input.fromValue(pulumi.Input.decodeList<GetApplicationLoadBalancersBalancerListenerPortsAndProtocal>(map['listenerPortsAndProtocals']!, (value) => GetApplicationLoadBalancersBalancerListenerPortsAndProtocal.fromMap((value as Map).cast<String, dynamic>()))),
      listenerPortsAndProtocols: pulumi.Input.fromValue(pulumi.Input.decodeList<GetApplicationLoadBalancersBalancerListenerPortsAndProtocol>(map['listenerPortsAndProtocols']!, (value) => GetApplicationLoadBalancersBalancerListenerPortsAndProtocol.fromMap((value as Map).cast<String, dynamic>()))),
