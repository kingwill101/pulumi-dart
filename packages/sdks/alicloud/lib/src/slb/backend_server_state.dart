...
class BackendServerState {
    ...
    return <String, dynamic>{
      'backendServers':
          ?pulumi.Input.mapOptionalInputValue<
            List<BackendServerBackendServer>,
  ...
  factory BackendServerState.fromMap(Map<String, dynamic> map) {
    return BackendServerState(
      backendServers: (() {
        final guardedValue = map['backendServers'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<BackendServerBackendServer>(
            guardedValue,
            (value) => BackendServerBackendServer.fromMap(
