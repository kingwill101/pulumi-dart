...
class GetAclsAcl {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'relatedListeners':
          pulumi.Input.mapInputValue<
            List<GetAclsAclRelatedListener>,
            List<Map<String, dynamic>>
          >(
            relatedListeners,
            (value) =>
  ...
  factory GetAclsAcl.fromMap(Map<String, dynamic> map) {
    return GetAclsAcl(
      entryLists: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetAclsAclEntryList>(
          map['entryLists']!,
          (value) => GetAclsAclEntryList.fromMap(
      ...
      relatedListeners: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetAclsAclRelatedListener>(
          map['relatedListeners']!,
          (value) => GetAclsAclRelatedListener.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
