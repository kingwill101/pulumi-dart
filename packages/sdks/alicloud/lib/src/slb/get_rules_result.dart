...
class GetRulesResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'slbRules': pulumi.Input.encodeList<GetRulesSlbRule, Map<String, dynamic>>(slbRules, (value) => value.toMap()),
    };
  }
  ...
  factory GetRulesResult.fromMap(Map<String, dynamic> map) {
    return GetRulesResult(
      ...
      slbRules: pulumi.Input.decodeList<GetRulesSlbRule>(map['slbRules'], (value) => GetRulesSlbRule.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
