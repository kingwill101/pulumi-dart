...
import 'enterprise_snapshot_policy_attachment_state.dart';
...
class EnterpriseSnapshotPolicyAttachment extends pulumi.CustomResource {
  ...
  static EnterpriseSnapshotPolicyAttachment get(
    String name,
    pulumi.Input<String> id, {
    EnterpriseSnapshotPolicyAttachmentState? state,
  }) {
    return EnterpriseSnapshotPolicyAttachment._get(
      name,
      state: state?.toMap(),
  ...
  EnterpriseSnapshotPolicyAttachment._get(
    String name, {
