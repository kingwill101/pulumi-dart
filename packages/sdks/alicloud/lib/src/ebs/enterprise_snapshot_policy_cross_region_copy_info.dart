...
class EnterpriseSnapshotPolicyCrossRegionCopyInfo {
  ...
  factory EnterpriseSnapshotPolicyCrossRegionCopyInfo.fromMap(Map<String, dynamic> map) {
    return EnterpriseSnapshotPolicyCrossRegionCopyInfo(
      ...
      regions: (() { final guardedValue = map['regions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<EnterpriseSnapshotPolicyCrossRegionCopyInfoRegion>(guardedValue, (value) => EnterpriseSnapshotPolicyCrossRegionCopyInfoRegion.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
