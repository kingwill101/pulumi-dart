...
class EnterpriseSnapshotPolicyCrossRegionCopyInfo {
  ...
  final pulumi.Input<List<EnterpriseSnapshotPolicyCrossRegionCopyInfoRegion>>?
  regions;
  ...
  EnterpriseSnapshotPolicyCrossRegionCopyInfo({this.enabled, this.regions});
    ...
    return <String, dynamic>{
      ...
      'regions':
          ?pulumi.Input.mapOptionalInputValue<
            List<EnterpriseSnapshotPolicyCrossRegionCopyInfoRegion>,
  ...
  factory EnterpriseSnapshotPolicyCrossRegionCopyInfo.fromMap(
      ...
      regions: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                EnterpriseSnapshotPolicyCrossRegionCopyInfoRegion.fromMap(
