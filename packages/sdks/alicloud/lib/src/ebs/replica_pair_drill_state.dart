...
class ReplicaPairDrillState {
  ...
  factory ReplicaPairDrillState.fromMap(Map<String, dynamic> map) {
    return ReplicaPairDrillState(
      pairId: (() { final guardedValue = map['pairId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      replicaPairDrillId: (() { final guardedValue = map['replicaPairDrillId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
