...
class GetRegionsRegion {
  ...
  GetRegionsRegion({required this.regionId, required this.zones});
  ...
  factory GetRegionsRegion.fromMap(Map<String, dynamic> map) {
    return GetRegionsRegion(
      ...
      zones: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetRegionsRegionZone>(
          map['zones']!,
          (value) => GetRegionsRegionZone.fromMap(
