...
class EnterpriseSnapshotPolicyArgs {
  ...
  factory EnterpriseSnapshotPolicyArgs.fromMap(Map<String, dynamic> map) {
    return EnterpriseSnapshotPolicyArgs(
      ...
      enterpriseSnapshotPolicyName: pulumi.Input.fromValue(map['enterpriseSnapshotPolicyName'] as String),
      resourceGroupId: (() { final guardedValue = map['resourceGroupId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      retainRule: pulumi.Input.fromValue(EnterpriseSnapshotPolicyRetainRule.fromMap((map['retainRule']! as Map).cast<String, dynamic>())),
      schedule: pulumi.Input.fromValue(EnterpriseSnapshotPolicySchedule.fromMap((map['schedule']! as Map).cast<String, dynamic>())),
