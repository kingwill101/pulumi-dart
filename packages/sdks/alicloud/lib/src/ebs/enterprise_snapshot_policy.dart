...
import 'enterprise_snapshot_policy_state.dart';
...
class EnterpriseSnapshotPolicy extends pulumi.CustomResource {
  ...
  static EnterpriseSnapshotPolicy get(
    String name,
    pulumi.Input<String> id, {
    EnterpriseSnapshotPolicyState? state,
  }) {
    return EnterpriseSnapshotPolicy._get(
      name,
      state: state?.toMap(),
