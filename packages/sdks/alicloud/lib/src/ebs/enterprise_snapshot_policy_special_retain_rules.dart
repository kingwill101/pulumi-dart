...
class EnterpriseSnapshotPolicySpecialRetainRules {
  ...
  final pulumi.Input<List<EnterpriseSnapshotPolicySpecialRetainRulesRule>>?
  rules;
  ...
  EnterpriseSnapshotPolicySpecialRetainRules({this.enabled, this.rules});
    ...
    return <String, dynamic>{
      ...
      'rules':
          ?pulumi.Input.mapOptionalInputValue<
            List<EnterpriseSnapshotPolicySpecialRetainRulesRule>,
  ...
  factory EnterpriseSnapshotPolicySpecialRetainRules.fromMap(
    ...
    return EnterpriseSnapshotPolicySpecialRetainRules(
      ...
      rules: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<EnterpriseSnapshotPolicySpecialRetainRulesRule>(
            guardedValue,
            (value) => EnterpriseSnapshotPolicySpecialRetainRulesRule.fromMap(
