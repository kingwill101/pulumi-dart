...
class GetDedicatedBlockStorageClustersCluster {
  ...
  const GetDedicatedBlockStorageClustersCluster({
  ...
  factory GetDedicatedBlockStorageClustersCluster.fromMap(Map<String, dynamic> map) {
    return GetDedicatedBlockStorageClustersCluster(
      availableCapacity: pulumi.Input.fromValue(map['availableCapacity'] as String),
      category: pulumi.Input.fromValue(map['category'] as String),
      createTime: pulumi.Input.fromValue(map['createTime'] as String),
      dedicatedBlockStorageClusterId: pulumi.Input.fromValue(map['dedicatedBlockStorageClusterId'] as String),
      dedicatedBlockStorageClusterName: pulumi.Input.fromValue(map['dedicatedBlockStorageClusterName'] as String),
      deliveryCapacity: pulumi.Input.fromValue(map['deliveryCapacity'] as String),
      ...
      supportedCategory: pulumi.Input.fromValue(map['supportedCategory'] as String),
