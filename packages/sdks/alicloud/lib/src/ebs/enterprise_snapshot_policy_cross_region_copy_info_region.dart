...
class EnterpriseSnapshotPolicyCrossRegionCopyInfoRegion {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{'regionId': ?regionId, 'retainDays': ?retainDays};
  }

  factory EnterpriseSnapshotPolicyCrossRegionCopyInfoRegion.fromMap(
    ...
    return EnterpriseSnapshotPolicyCrossRegionCopyInfoRegion(
      ...
      retainDays: (() {
        final guardedValue = map['retainDays'];
        if (guardedValue == null) return null;
