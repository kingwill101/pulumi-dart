...
class ProviderArgs {
  ...
  factory ProviderArgs.fromMap(Map<String, dynamic> map) {
    return ProviderArgs(
      ...
      assumeRole: (() { final guardedValue = map['assumeRole']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ProviderAssumeRole.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      assumeRoleWithOidc: (() { final guardedValue = map['assumeRoleWithOidc']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ProviderAssumeRoleWithOidc.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      clientConnectTimeout: (() { final guardedValue = map['clientConnectTimeout']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      clientReadTimeout: (() { final guardedValue = map['clientReadTimeout']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      configurationSource: (() { final guardedValue = map['configurationSource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      credentialsUri: (() { final guardedValue = map['credentialsUri']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ecsRoleName: (() { final guardedValue = map['ecsRoleName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      logEndpoint: (() { final guardedValue = map['logEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      maxRetryTimeout: (() { final guardedValue = map['maxRetryTimeout']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      mnsEndpoint: (() { final guardedValue = map['mnsEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      otsInstanceName: (() { final guardedValue = map['otsInstanceName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      secureTransport: (() { final guardedValue = map['secureTransport']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      securityTransport: (() { final guardedValue = map['securityTransport']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      signVersion: (() { final guardedValue = map['signVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ProviderSignVersion.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
