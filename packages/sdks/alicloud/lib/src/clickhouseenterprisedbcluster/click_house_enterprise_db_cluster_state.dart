...
class ClickHouseEnterpriseDbClusterState {
    ...
    return <String, dynamic>{
      ...
      'endpoints':
          ?pulumi.Input.mapOptionalInputValue<
            List<ClickHouseEnterpriseDbClusterEndpoint>,
  ...
  factory ClickHouseEnterpriseDbClusterState.fromMap(Map<String, dynamic> map) {
    return ClickHouseEnterpriseDbClusterState(
      ...
      computingGroupIds: (() {
        final guardedValue = map['computingGroupIds'];
        if (guardedValue == null) return null;
      ...
      endpoints: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ClickHouseEnterpriseDbClusterEndpoint>(
            guardedValue,
            (value) => ClickHouseEnterpriseDbClusterEndpoint.fromMap(
      ...
      storageQuota: (() {
        final guardedValue = map['storageQuota'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      storageSize: (() {
