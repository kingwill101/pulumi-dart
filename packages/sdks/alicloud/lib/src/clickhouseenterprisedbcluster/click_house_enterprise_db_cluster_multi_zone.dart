...
class ClickHouseEnterpriseDbClusterMultiZone {
  ...
  /// [zoneId] Zone ID.
  ClickHouseEnterpriseDbClusterMultiZone({this.vswitchIds, this.zoneId});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'vswitchIds': ?vswitchIds, 'zoneId': ?zoneId};
  }

  factory ClickHouseEnterpriseDbClusterMultiZone.fromMap(
