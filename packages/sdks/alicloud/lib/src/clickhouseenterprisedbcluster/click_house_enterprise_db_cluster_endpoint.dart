...
class ClickHouseEnterpriseDbClusterEndpoint {
  ...
  factory ClickHouseEnterpriseDbClusterEndpoint.fromMap(Map<String, dynamic> map) {
    return ClickHouseEnterpriseDbClusterEndpoint(
      ...
      ports: (() { final guardedValue = map['ports']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ClickHouseEnterpriseDbClusterEndpointPort>(guardedValue, (value) => ClickHouseEnterpriseDbClusterEndpointPort.fromMap((value as Map).cast<String, dynamic>()))); })(),
