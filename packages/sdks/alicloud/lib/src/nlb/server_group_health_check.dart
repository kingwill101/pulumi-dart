...
class ServerGroupHealthCheck {
  ...
  factory ServerGroupHealthCheck.fromMap(Map<String, dynamic> map) {
    return ServerGroupHealthCheck(
      ...
      healthCheckExp: (() { final guardedValue = map['healthCheckExp']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      healthCheckReq: (() { final guardedValue = map['healthCheckReq']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      httpCheckMethod: (() { final guardedValue = map['httpCheckMethod']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
