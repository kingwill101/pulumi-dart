...
class GetLoadBalancersBalancer {
  ...
  factory GetLoadBalancersBalancer.fromMap(Map<String, dynamic> map) {
    return GetLoadBalancersBalancer(
      ...
      loadBalancerBusinessStatus: pulumi.Input.fromValue(map['loadBalancerBusinessStatus'] as String),
      ...
      operationLocks: pulumi.Input.fromValue(pulumi.Input.decodeList<GetLoadBalancersBalancerOperationLock>(map['operationLocks']!, (value) => GetLoadBalancersBalancerOperationLock.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      zoneMappings: pulumi.Input.fromValue(pulumi.Input.decodeList<GetLoadBalancersBalancerZoneMapping>(map['zoneMappings']!, (value) => GetLoadBalancersBalancerZoneMapping.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
