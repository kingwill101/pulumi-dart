...
class GetListenersListener {
  ...
  factory GetListenersListener.fromMap(Map<String, dynamic> map) {
    return GetListenersListener(
      ...
      caCertificateIds: pulumi.Input.fromValue((map['caCertificateIds'] as List).cast<String>()),
      caEnabled: pulumi.Input.fromValue(map['caEnabled'] as bool),
      certificateIds: pulumi.Input.fromValue((map['certificateIds'] as List).cast<String>()),
      ...
      proxyProtocolEnabled: pulumi.Input.fromValue(map['proxyProtocolEnabled'] as bool),
