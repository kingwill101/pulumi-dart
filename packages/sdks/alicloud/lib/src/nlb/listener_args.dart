...
class ListenerArgs {
  ...
  factory ListenerArgs.fromMap(Map<String, dynamic> map) {
    return ListenerArgs(
      alpnEnabled: (() { final guardedValue = map['alpnEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      caCertificateIds: (() { final guardedValue = map['caCertificateIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      ...
      mss: (() { final guardedValue = map['mss']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      proxyProtocolConfig: (() { final guardedValue = map['proxyProtocolConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ListenerProxyProtocolConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      secSensorEnabled: (() { final guardedValue = map['secSensorEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
