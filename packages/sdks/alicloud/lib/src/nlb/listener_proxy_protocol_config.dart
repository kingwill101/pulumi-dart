...
class ListenerProxyProtocolConfig {
  ...
  factory ListenerProxyProtocolConfig.fromMap(Map<String, dynamic> map) {
    return ListenerProxyProtocolConfig(
      proxyProtocolConfigPrivateLinkEpIdEnabled: (() { final guardedValue = map['proxyProtocolConfigPrivateLinkEpIdEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      proxyProtocolConfigPrivateLinkEpsIdEnabled: (() { final guardedValue = map['proxyProtocolConfigPrivateLinkEpsIdEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      proxyProtocolConfigVpcIdEnabled: (() { final guardedValue = map['proxyProtocolConfigVpcIdEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
    );
  }
}
