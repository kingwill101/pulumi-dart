...
class RuleState {
  ...
  factory RuleState.fromMap(Map<String, dynamic> map) {
    return RuleState(
      ...
      targets: (() { final guardedValue = map['targets']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RuleTarget>(guardedValue, (value) => RuleTarget.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
