...
class EventSourceV2SourceOssEventParameters {
  ...
  final pulumi.Input<
    List<List<EventSourceV2SourceOssEventParametersMatchRule>>
  >?
  matchRules;
          ...
          >(
            ...
            (value) =>
                pulumi.Input.encodeList<
                  List<EventSourceV2SourceOssEventParametersMatchRule>,
  ...
  factory EventSourceV2SourceOssEventParameters.fromMap(
          ...
          >(
            ...
            (value) =>
                ...
                >(
                  value,
                  (value) =>
                      EventSourceV2SourceOssEventParametersMatchRule.fromMap(
