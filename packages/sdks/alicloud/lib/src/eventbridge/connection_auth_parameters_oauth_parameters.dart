...
class ConnectionAuthParametersOauthParameters {
  ...
  final ConnectionAuthParametersOauthParametersClientParameters? clientParameters;
  ...
  final ConnectionAuthParametersOauthParametersOauthHttpParameters? oauthHttpParameters;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'oauthHttpParameters': ?oauthHttpParameters == null ? null : oauthHttpParameters!.toMap(),
    };
  }
  ...
  factory ConnectionAuthParametersOauthParameters.fromMap(Map<String, dynamic> map) {
    return ConnectionAuthParametersOauthParameters(
      ...
      clientParameters: map['clientParameters'] == null ? null : ConnectionAuthParametersOauthParametersClientParameters.fromMap((map['clientParameters'] as Map).cast<String, dynamic>()),
      httpMethod: map['httpMethod'] == null ? null : map['httpMethod'] as String,
      oauthHttpParameters: map['oauthHttpParameters'] == null ? null : ConnectionAuthParametersOauthParametersOauthHttpParameters.fromMap((map['oauthHttpParameters'] as Map).cast<String, dynamic>()),
    );
  }
}
