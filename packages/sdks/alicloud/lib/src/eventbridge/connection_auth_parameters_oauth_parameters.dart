...
class ConnectionAuthParametersOauthParameters {
  ...
  final pulumi.Input<ConnectionAuthParametersOauthParametersClientParameters>?
  clientParameters;
  ...
  factory ConnectionAuthParametersOauthParameters.fromMap(
    ...
    return ConnectionAuthParametersOauthParameters(
      ...
      clientParameters: (() {
        ...
        return pulumi.Input.fromValue(
          ConnectionAuthParametersOauthParametersClientParameters.fromMap(
      ...
      oauthHttpParameters: (() {
        final guardedValue = map['oauthHttpParameters'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ConnectionAuthParametersOauthParametersOauthHttpParameters.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
