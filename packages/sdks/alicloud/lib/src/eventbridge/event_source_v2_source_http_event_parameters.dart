...
class EventSourceV2SourceHttpEventParameters {
  ...
  factory EventSourceV2SourceHttpEventParameters.fromMap(Map<String, dynamic> map) {
    return EventSourceV2SourceHttpEventParameters(
      ...
      publicWebHookUrls: (() { final guardedValue = map['publicWebHookUrls']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      referers: (() { final guardedValue = map['referers']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      securityConfig: (() { final guardedValue = map['securityConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      vpcWebHookUrls: (() { final guardedValue = map['vpcWebHookUrls']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
    );
  }
}
