...
class ConnectionAuthParametersOauthParametersOauthHttpParameters {
  ...
  factory ConnectionAuthParametersOauthParametersOauthHttpParameters.fromMap(
    Map<String, dynamic> map,
  ) {
    return ConnectionAuthParametersOauthParametersOauthHttpParameters(
      bodyParameters: (() {
        final guardedValue = map['bodyParameters'];
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                ConnectionAuthParametersOauthParametersOauthHttpParametersBodyParameter.fromMap(
      ...
      headerParameters: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                ConnectionAuthParametersOauthParametersOauthHttpParametersHeaderParameter.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      queryStringParameters: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                ConnectionAuthParametersOauthParametersOauthHttpParametersQueryStringParameter.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
