...
class RuleTarget {
  ...
  final RuleTargetDeadLetterQueue? deadLetterQueue;
  /// The endpoint of the event target.
  final String endpoint;
  /// The parameters that are configured for the event target. See `param_list` below.
  final List<RuleTargetParamList> paramLists;
  ...
  final String? pushRetryStrategy;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'deadLetterQueue': ?deadLetterQueue == null ? null : deadLetterQueue!.toMap(),
      'endpoint': endpoint,
      'paramLists': pulumi.Input.encodeList<RuleTargetParamList, Map<String, dynamic>>(paramLists, (value) => value.toMap()),
  ...
  factory RuleTarget.fromMap(Map<String, dynamic> map) {
    return RuleTarget(
      deadLetterQueue: map['deadLetterQueue'] == null ? null : RuleTargetDeadLetterQueue.fromMap((map['deadLetterQueue'] as Map).cast<String, dynamic>()),
      endpoint: map['endpoint'] as String,
      paramLists: pulumi.Input.decodeList<RuleTargetParamList>(map['paramLists'], (value) => RuleTargetParamList.fromMap((value as Map).cast<String, dynamic>())),
      pushRetryStrategy: map['pushRetryStrategy'] == null ? null : map['pushRetryStrategy'] as String,
