...
class RuleTarget {
    ...
    return <String, dynamic>{
      'deadLetterQueue':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(deadLetterQueue, (value) => value.toMap()),
      'endpoint': endpoint,
      'paramLists':
          pulumi.Input.mapInputValue<
            List<RuleTargetParamList>,
  ...
  factory RuleTarget.fromMap(Map<String, dynamic> map) {
    return RuleTarget(
      deadLetterQueue: (() {
        final guardedValue = map['deadLetterQueue'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RuleTargetDeadLetterQueue.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      endpoint: pulumi.Input.fromValue(map['endpoint'] as String),
      paramLists: pulumi.Input.fromValue(
        pulumi.Input.decodeList<RuleTargetParamList>(
          map['paramLists']!,
          (value) => RuleTargetParamList.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      pushRetryStrategy: (() {
        final guardedValue = map['pushRetryStrategy'];
        if (guardedValue == null) return null;
