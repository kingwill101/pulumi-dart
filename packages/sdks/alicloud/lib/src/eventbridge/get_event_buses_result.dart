...
class GetEventBusesResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'buses': pulumi.Input.encodeList<GetEventBusesBus, Map<String, dynamic>>(buses, (value) => value.toMap()),
  ...
  factory GetEventBusesResult.fromMap(Map<String, dynamic> map) {
    return GetEventBusesResult(
      ...
      eventBusType: (() { final guardedValue = map['eventBusType']; if (guardedValue == null) return null; return guardedValue as String; })(),
      id: map['id'] as String,
