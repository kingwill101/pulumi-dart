...
class InstanceState {
  ...
  InstanceState({
    ...
    pulumi.Output<String>? coreInstanceType,
    ...
    pulumi.Output<int>? masterInstanceQuantity,
    pulumi.Output<String>? masterInstanceType,
    pulumi.Output<String>? name,
    pulumi.Output<String>? password,
    pulumi.Output<String>? payType,
    pulumi.Output<List<String>>? securityGroups,
    pulumi.Output<List<InstanceSlbConnAddr>>? slbConnAddrs,
    pulumi.Output<Map<String, String>>? tags,
    pulumi.Output<List<InstanceUiProxyConnAddr>>? uiProxyConnAddrs,
    pulumi.Output<String>? vpcId,
    pulumi.Output<String>? vswitchId,
    pulumi.Output<List<InstanceZkConnAddr>>? zkConnAddrs,
    pulumi.Output<String>? zoneId,
      ...
      coreInstanceType = pulumi.Input.asOptionalInput<String>(coreInstanceType),
      ...
      masterInstanceQuantity = pulumi.Input.asOptionalInput<int>(masterInstanceQuantity),
      masterInstanceType = pulumi.Input.asOptionalInput<String>(masterInstanceType),
      ...
      slbConnAddrs = pulumi.Input.asOptionalInput<List<InstanceSlbConnAddr>>(slbConnAddrs),
      tags = pulumi.Input.asOptionalInput<Map<String, String>>(tags),
      uiProxyConnAddrs = pulumi.Input.asOptionalInput<List<InstanceUiProxyConnAddr>>(uiProxyConnAddrs),
      vpcId = pulumi.Input.asOptionalInput<String>(vpcId),
      vswitchId = pulumi.Input.asOptionalInput<String>(vswitchId),
      zkConnAddrs = pulumi.Input.asOptionalInput<List<InstanceZkConnAddr>>(zkConnAddrs),
  ...
  factory InstanceState.fromMap(Map<String, dynamic> map) {
    return InstanceState(
      ...
      coreInstanceType: map['coreInstanceType'] == null ? null : pulumi.Output.create<String>(map['coreInstanceType'] as String),
      ...
      masterInstanceQuantity: map['masterInstanceQuantity'] == null ? null : pulumi.Output.create<int>(map['masterInstanceQuantity'] as int),
      masterInstanceType: map['masterInstanceType'] == null ? null : pulumi.Output.create<String>(map['masterInstanceType'] as String),
      ...
      slbConnAddrs: map['slbConnAddrs'] == null ? null : pulumi.Output.create<List<InstanceSlbConnAddr>>(pulumi.Input.decodeList<InstanceSlbConnAddr>(map['slbConnAddrs'], (value) => InstanceSlbConnAddr.fromMap((value as Map).cast<String, dynamic>()))),
      tags: map['tags'] == null ? null : pulumi.Output.create<Map<String, String>>((map['tags'] as Map).cast<String, String>()),
      uiProxyConnAddrs: map['uiProxyConnAddrs'] == null ? null : pulumi.Output.create<List<InstanceUiProxyConnAddr>>(pulumi.Input.decodeList<InstanceUiProxyConnAddr>(map['uiProxyConnAddrs'], (value) => InstanceUiProxyConnAddr.fromMap((value as Map).cast<String, dynamic>()))),
      vpcId: map['vpcId'] == null ? null : pulumi.Output.create<String>(map['vpcId'] as String),
      vswitchId: map['vswitchId'] == null ? null : pulumi.Output.create<String>(map['vswitchId'] as String),
      zkConnAddrs: map['zkConnAddrs'] == null ? null : pulumi.Output.create<List<InstanceZkConnAddr>>(pulumi.Input.decodeList<InstanceZkConnAddr>(map['zkConnAddrs'], (value) => InstanceZkConnAddr.fromMap((value as Map).cast<String, dynamic>()))),
