...
class InstanceState {
  ...
  factory InstanceState.fromMap(Map<String, dynamic> map) {
    return InstanceState(
      ...
      coreInstanceType: map['coreInstanceType'] == null ? null : (map['coreInstanceType']! as String).input(),
      ...
      masterInstanceQuantity: map['masterInstanceQuantity'] == null ? null : (map['masterInstanceQuantity']! as int).input(),
      masterInstanceType: map['masterInstanceType'] == null ? null : (map['masterInstanceType']! as String).input(),
      ...
      slbConnAddrs: map['slbConnAddrs'] == null ? null : (pulumi.Input.decodeList<InstanceSlbConnAddr>(map['slbConnAddrs']!, (value) => InstanceSlbConnAddr.fromMap((value as Map).cast<String, dynamic>()))).input(),
      tags: map['tags'] == null ? null : ((map['tags']! as Map).cast<String, String>()).input(),
      uiProxyConnAddrs: map['uiProxyConnAddrs'] == null ? null : (pulumi.Input.decodeList<InstanceUiProxyConnAddr>(map['uiProxyConnAddrs']!, (value) => InstanceUiProxyConnAddr.fromMap((value as Map).cast<String, dynamic>()))).input(),
      vpcId: map['vpcId'] == null ? null : (map['vpcId']! as String).input(),
      vswitchId: map['vswitchId'] == null ? null : (map['vswitchId']! as String).input(),
      zkConnAddrs: map['zkConnAddrs'] == null ? null : (pulumi.Input.decodeList<InstanceZkConnAddr>(map['zkConnAddrs']!, (value) => InstanceZkConnAddr.fromMap((value as Map).cast<String, dynamic>()))).input(),
