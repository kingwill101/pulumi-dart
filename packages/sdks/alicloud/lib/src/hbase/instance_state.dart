...
class InstanceState {
  ...
  factory InstanceState.fromMap(Map<String, dynamic> map) {
    return InstanceState(
      ...
      coreInstanceType: (() {
        final guardedValue = map['coreInstanceType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      deletionProtection: (() {
      ...
      masterInstanceQuantity: (() {
        final guardedValue = map['masterInstanceQuantity'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      masterInstanceType: (() {
        final guardedValue = map['masterInstanceType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      name: (() {
      ...
      slbConnAddrs: (() {
        final guardedValue = map['slbConnAddrs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InstanceSlbConnAddr>(
            guardedValue,
            (value) => InstanceSlbConnAddr.fromMap(
      ...
      uiProxyConnAddrs: (() {
        final guardedValue = map['uiProxyConnAddrs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InstanceUiProxyConnAddr>(
            guardedValue,
            (value) => InstanceUiProxyConnAddr.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      zkConnAddrs: (() {
        final guardedValue = map['zkConnAddrs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InstanceZkConnAddr>(
            guardedValue,
            (value) => InstanceZkConnAddr.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
