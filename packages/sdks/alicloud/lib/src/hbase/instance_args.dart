...
class InstanceArgs {
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      ...
      coreDiskSize: map['coreDiskSize'] == null ? null : (map['coreDiskSize']! as int).input(),
      coreDiskType: map['coreDiskType'] == null ? null : (map['coreDiskType']! as String).input(),
      coreInstanceQuantity: map['coreInstanceQuantity'] == null ? null : (map['coreInstanceQuantity']! as int).input(),
      ...
      immediateDeleteFlag: map['immediateDeleteFlag'] == null ? null : (map['immediateDeleteFlag']! as bool).input(),
