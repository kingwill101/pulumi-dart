...
class InstanceArgs {
  ...
  InstanceArgs({
    ...
    pulumi.Output<int>? coreDiskSize,
    pulumi.Output<String>? coreDiskType,
    pulumi.Output<int>? coreInstanceQuantity,
    required pulumi.Output<String> coreInstanceType,
    pulumi.Output<bool>? deletionProtection,
    pulumi.Output<int>? duration,
    pulumi.Output<String>? engine,
    required pulumi.Output<String> engineVersion,
    pulumi.Output<bool>? immediateDeleteFlag,
    pulumi.Output<String>? ipWhite,
    pulumi.Output<String>? maintainEndTime,
    pulumi.Output<String>? maintainStartTime,
    required pulumi.Output<String> masterInstanceType,
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      ...
      coreDiskSize: map['coreDiskSize'] == null ? null : pulumi.Output.create<int>(map['coreDiskSize'] as int),
      coreDiskType: map['coreDiskType'] == null ? null : pulumi.Output.create<String>(map['coreDiskType'] as String),
      coreInstanceQuantity: map['coreInstanceQuantity'] == null ? null : pulumi.Output.create<int>(map['coreInstanceQuantity'] as int),
      coreInstanceType: pulumi.Output.create<String>(map['coreInstanceType'] as String),
      ...
      immediateDeleteFlag: map['immediateDeleteFlag'] == null ? null : pulumi.Output.create<bool>(map['immediateDeleteFlag'] as bool),
      ...
      masterInstanceType: pulumi.Output.create<String>(map['masterInstanceType'] as String),
