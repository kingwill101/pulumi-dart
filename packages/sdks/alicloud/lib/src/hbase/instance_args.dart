...
class InstanceArgs {
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      ...
      coreDiskSize: (() {
        final guardedValue = map['coreDiskSize'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      coreDiskType: (() {
        final guardedValue = map['coreDiskType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      coreInstanceQuantity: (() {
        final guardedValue = map['coreInstanceQuantity'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      coreInstanceType: pulumi.Input.fromValue(
        map['coreInstanceType'] as String,
      ),
      deletionProtection: (() {
      ...
      immediateDeleteFlag: (() {
        final guardedValue = map['immediateDeleteFlag'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      ipWhite: (() {
      ...
      masterInstanceType: pulumi.Input.fromValue(
        map['masterInstanceType'] as String,
      ),
      name: (() {
