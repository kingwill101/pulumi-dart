...
class BaseInstanceArgs {
  ...
  BaseInstanceArgs({
    ...
    required pulumi.Output<int> diskSize,
    ...
    required pulumi.Output<String> series,
  ...
  factory BaseInstanceArgs.fromMap(Map<String, dynamic> map) {
    return BaseInstanceArgs(
      ...
      diskSize: pulumi.Output.create<int>(map['diskSize'] as int),
      ...
      series: pulumi.Output.create<String>(map['series'] as String),
