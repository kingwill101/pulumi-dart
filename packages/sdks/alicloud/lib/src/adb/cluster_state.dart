...
class ClusterState {
  ...
  ClusterState({
    ...
    pulumi.Output<String>? dbClusterCategory,
    ...
    pulumi.Output<String>? zoneId,
      ...
      dbClusterCategory = pulumi.Input.asOptionalInput<String>(dbClusterCategory),
  ...
  factory ClusterState.fromMap(Map<String, dynamic> map) {
    return ClusterState(
      ...
      dbClusterCategory: map['dbClusterCategory'] == null ? null : pulumi.Output.create<String>(map['dbClusterCategory'] as String),
