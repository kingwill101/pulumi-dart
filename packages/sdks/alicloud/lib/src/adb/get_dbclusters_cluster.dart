...
class GetDBClustersCluster {
  ...
  factory GetDBClustersCluster.fromMap(Map<String, dynamic> map) {
    return GetDBClustersCluster(
      ...
      availableKernelVersions: pulumi.Input.fromValue(pulumi.Input.decodeList<GetDBClustersClusterAvailableKernelVersion>(map['availableKernelVersions']!, (value) => GetDBClustersClusterAvailableKernelVersion.fromMap((value as Map).cast<String, dynamic>()))),
