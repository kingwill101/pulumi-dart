...
class ResourceGroupState {
  ...
  factory ResourceGroupState.fromMap(Map<String, dynamic> map) {
    return ResourceGroupState(
      ...
      clusterSizeResource: (() { final guardedValue = map['clusterSizeResource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      engineParams: (() { final guardedValue = map['engineParams']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      ...
      maxClusterCount: (() { final guardedValue = map['maxClusterCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      maxComputeResource: (() { final guardedValue = map['maxComputeResource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      minClusterCount: (() { final guardedValue = map['minClusterCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      minComputeResource: (() { final guardedValue = map['minComputeResource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      nodeNum: (() { final guardedValue = map['nodeNum']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
