...
class TunnelQuotaTimerState {
  ...
  TunnelQuotaTimerState({this.nickname, this.quotaTimers, this.timeZone});
    ...
    return <String, dynamic>{
      ...
      'quotaTimers':
          ?pulumi.Input.mapOptionalInputValue<
            List<TunnelQuotaTimerQuotaTimer>,
  ...
  factory TunnelQuotaTimerState.fromMap(Map<String, dynamic> map) {
    return TunnelQuotaTimerState(
      ...
      quotaTimers: (() {
        final guardedValue = map['quotaTimers'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<TunnelQuotaTimerQuotaTimer>(
            guardedValue,
            (value) => TunnelQuotaTimerQuotaTimer.fromMap(
