...
class TunnelQuotaTimerState {
  ...
  /// Creates a new [TunnelQuotaTimerState].
  ...
  factory TunnelQuotaTimerState.fromMap(Map<String, dynamic> map) {
    return TunnelQuotaTimerState(
      ...
      quotaTimers: (() { final guardedValue = map['quotaTimers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<TunnelQuotaTimerQuotaTimer>(guardedValue, (value) => TunnelQuotaTimerQuotaTimer.fromMap((value as Map).cast<String, dynamic>()))); })(),
