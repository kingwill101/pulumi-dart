...
class ProjectSecurityProperties {
  ...
  final pulumi.Input<ProjectSecurityPropertiesProjectProtection>?
  projectProtection;
  ...
  factory ProjectSecurityProperties.fromMap(Map<String, dynamic> map) {
    return ProjectSecurityProperties(
      enableDownloadPrivilege: (() {
        final guardedValue = map['enableDownloadPrivilege'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      labelSecurity: (() {
        final guardedValue = map['labelSecurity'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      objectCreatorHasAccessPermission: (() {
        final guardedValue = map['objectCreatorHasAccessPermission'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      objectCreatorHasGrantPermission: (() {
        final guardedValue = map['objectCreatorHasGrantPermission'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      projectProtection: (() {
        final guardedValue = map['projectProtection'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ProjectSecurityPropertiesProjectProtection.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      usingAcl: (() {
        final guardedValue = map['usingAcl'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      usingPolicy: (() {
        final guardedValue = map['usingPolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
    );
