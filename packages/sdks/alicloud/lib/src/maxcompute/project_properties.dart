...
class ProjectProperties {
  ...
  factory ProjectProperties.fromMap(Map<String, dynamic> map) {
    return ProjectProperties(
      allowFullScan: (() {
        final guardedValue = map['allowFullScan'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      enableDecimal2: (() {
        final guardedValue = map['enableDecimal2'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      enableDr: (() {
        final guardedValue = map['enableDr'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      encryption: (() {
        ...
        return pulumi.Input.fromValue(
          ProjectPropertiesEncryption.fromMap(
      ...
      sqlMeteringMax: (() {
        final guardedValue = map['sqlMeteringMax'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      tableLifecycle: (() {
        final guardedValue = map['tableLifecycle'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ProjectPropertiesTableLifecycle.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      typeSystem: (() {
        final guardedValue = map['typeSystem'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
