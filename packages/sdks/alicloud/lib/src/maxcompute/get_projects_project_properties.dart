...
class GetProjectsProjectProperties {
  ...
  final bool allowFullScan;
  /// Whether to turn on Decimal2.0.
  final bool enableDecimal2;
  ...
  final GetProjectsProjectPropertiesEncryption encryption;
  ...
  final GetProjectsProjectPropertiesTableLifecycle tableLifecycle;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'tableLifecycle': tableLifecycle.toMap(),
      'timezone': timezone,
  ...
  factory GetProjectsProjectProperties.fromMap(Map<String, dynamic> map) {
    return GetProjectsProjectProperties(
      allowFullScan: map['allowFullScan'] as bool,
      enableDecimal2: map['enableDecimal2'] as bool,
      encryption: GetProjectsProjectPropertiesEncryption.fromMap((map['encryption'] as Map).cast<String, dynamic>()),
      retentionDays: map['retentionDays'] as int,
      sqlMeteringMax: map['sqlMeteringMax'] as String,
      tableLifecycle: GetProjectsProjectPropertiesTableLifecycle.fromMap((map['tableLifecycle'] as Map).cast<String, dynamic>()),
