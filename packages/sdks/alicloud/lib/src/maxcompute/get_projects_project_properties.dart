...
class GetProjectsProjectProperties {
  ...
  factory GetProjectsProjectProperties.fromMap(Map<String, dynamic> map) {
    return GetProjectsProjectProperties(
      allowFullScan: pulumi.Input.fromValue(map['allowFullScan'] as bool),
      enableDecimal2: pulumi.Input.fromValue(map['enableDecimal2'] as bool),
      encryption: pulumi.Input.fromValue(GetProjectsProjectPropertiesEncryption.fromMap((map['encryption']! as Map).cast<String, dynamic>())),
      retentionDays: pulumi.Input.fromValue(map['retentionDays'] as int),
      sqlMeteringMax: pulumi.Input.fromValue(map['sqlMeteringMax'] as String),
      tableLifecycle: pulumi.Input.fromValue(GetProjectsProjectPropertiesTableLifecycle.fromMap((map['tableLifecycle']! as Map).cast<String, dynamic>())),
