    ...
    return <String, dynamic>{
      ...
      'tableLifecycle':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(tableLifecycle, (value) => value.toMap()),
      'timezone': timezone,
  ...
  factory GetProjectsProjectProperties.fromMap(Map<String, dynamic> map) {
    return GetProjectsProjectProperties(
      ...
      encryption: pulumi.Input.fromValue(
        GetProjectsProjectPropertiesEncryption.fromMap(
      ...
      tableLifecycle: pulumi.Input.fromValue(
        GetProjectsProjectPropertiesTableLifecycle.fromMap(
          (map['tableLifecycle']! as Map).cast<String, dynamic>(),
        ),
      ),
