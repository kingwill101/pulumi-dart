...
import 'tenant_role_user_attachment_state.dart';
...
class TenantRoleUserAttachment extends pulumi.CustomResource {
  ...
  static TenantRoleUserAttachment get(
    String name,
    pulumi.Input<String> id, {
    TenantRoleUserAttachmentState? state,
  }) {
    return TenantRoleUserAttachment._get(
      name,
      state: state?.toMap(),
