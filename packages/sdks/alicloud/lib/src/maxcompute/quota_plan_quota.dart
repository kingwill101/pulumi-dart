...
class QuotaPlanQuota {
  ...
  factory QuotaPlanQuota.fromMap(Map<String, dynamic> map) {
    return QuotaPlanQuota(
      parameter: (() { final guardedValue = map['parameter']; if (guardedValue == null) return null; return pulumi.Input.fromValue(QuotaPlanQuotaParameter.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      subQuotaInfoLists: (() { final guardedValue = map['subQuotaInfoLists']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<QuotaPlanQuotaSubQuotaInfoList>(guardedValue, (value) => QuotaPlanQuotaSubQuotaInfoList.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
