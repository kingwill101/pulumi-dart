...
class QuotaScheduleState {
  ...
  QuotaScheduleState({this.nickname, this.scheduleLists, this.timezone});
    ...
    return <String, dynamic>{
      ...
      'scheduleLists':
          ?pulumi.Input.mapOptionalInputValue<
            List<QuotaScheduleScheduleList>,
  ...
  factory QuotaScheduleState.fromMap(Map<String, dynamic> map) {
    return QuotaScheduleState(
      ...
      scheduleLists: (() {
        final guardedValue = map['scheduleLists'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<QuotaScheduleScheduleList>(
            guardedValue,
            (value) => QuotaScheduleScheduleList.fromMap(
