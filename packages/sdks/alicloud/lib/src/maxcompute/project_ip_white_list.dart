...
class ProjectIpWhiteList {
  ...
  factory ProjectIpWhiteList.fromMap(Map<String, dynamic> map) {
    return ProjectIpWhiteList(
      ipList: (() { final guardedValue = map['ipList']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      vpcIpList: (() { final guardedValue = map['vpcIpList']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
