...
class Quota extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<QuotaSubQuotaInfoList>> subQuotaInfoLists;
  ...
  Quota(
    ...
    this.commodityData = registerOutput<String?>('commodityData');
    this.partNickName = registerOutput<String?>('partNickName');
    this.paymentType = registerOutput<String>('paymentType');
    this.subQuotaInfoLists = registerOutput<List<QuotaSubQuotaInfoList>>('subQuotaInfoLists');
  }
