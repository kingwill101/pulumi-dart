...
import 'workspace_experiment_state.dart';
...
class WorkspaceExperiment extends pulumi.CustomResource {
  ...
  static WorkspaceExperiment get(
    String name,
    pulumi.Input<String> id, {
    WorkspaceExperimentState? state,
  }) {
    return WorkspaceExperiment._get(
      name,
      state: state?.toMap(),
