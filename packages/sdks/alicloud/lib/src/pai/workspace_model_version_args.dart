...
class WorkspaceModelVersionArgs {
  ...
  factory WorkspaceModelVersionArgs.fromMap(Map<String, dynamic> map) {
    return WorkspaceModelVersionArgs(
      ...
      formatType: (() { final guardedValue = map['formatType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      inferenceSpec: (() { final guardedValue = map['inferenceSpec']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      labels: (() { final guardedValue = map['labels']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<WorkspaceModelVersionLabel>(guardedValue, (value) => WorkspaceModelVersionLabel.fromMap((value as Map).cast<String, dynamic>()))); })(),
      metrics: (() { final guardedValue = map['metrics']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      ...
      trainingSpec: (() { final guardedValue = map['trainingSpec']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
