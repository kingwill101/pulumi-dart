...
class WorkspaceModelArgs {
  ...
  factory WorkspaceModelArgs.fromMap(Map<String, dynamic> map) {
    return WorkspaceModelArgs(
      ...
      labels: (() { final guardedValue = map['labels']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<WorkspaceModelLabel>(guardedValue, (value) => WorkspaceModelLabel.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      modelDoc: (() { final guardedValue = map['modelDoc']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      orderNumber: (() { final guardedValue = map['orderNumber']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
