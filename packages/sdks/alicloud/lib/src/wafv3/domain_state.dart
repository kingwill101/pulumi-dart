...
class DomainState {
  ...
  factory DomainState.fromMap(Map<String, dynamic> map) {
    return DomainState(
      ...
      listen: (() { final guardedValue = map['listen']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainListen.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      redirect: (() { final guardedValue = map['redirect']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainRedirect.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
