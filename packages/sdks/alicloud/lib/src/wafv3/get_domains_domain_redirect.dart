...
class GetDomainsDomainRedirect {
  ...
  final pulumi.Input<List<GetDomainsDomainRedirectRequestHeader>>
  requestHeaders;
    ...
    return <String, dynamic>{
      ...
      'requestHeaders':
          pulumi.Input.mapInputValue<
            List<GetDomainsDomainRedirectRequestHeader>,
  ...
  factory GetDomainsDomainRedirect.fromMap(Map<String, dynamic> map) {
    return GetDomainsDomainRedirect(
      ...
      keepaliveRequests: pulumi.Input.fromValue(
        map['keepaliveRequests'] as int,
      ),
      ...
      requestHeaders: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetDomainsDomainRedirectRequestHeader>(
          map['requestHeaders']!,
          (value) => GetDomainsDomainRedirectRequestHeader.fromMap(
