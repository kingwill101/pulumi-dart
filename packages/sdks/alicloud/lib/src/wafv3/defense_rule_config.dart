...
class DefenseRuleConfig {
  ...
  final pulumi.Input<List<DefenseRuleConfigAccountIdentifier>>?
  accountIdentifiers;
    ...
    return <String, dynamic>{
      ...
      'accountIdentifiers':
          ?pulumi.Input.mapOptionalInputValue<
            List<DefenseRuleConfigAccountIdentifier>,
      ...
      'conditions':
          ?pulumi.Input.mapOptionalInputValue<
            List<DefenseRuleConfigCondition>,
            List<Map<String, dynamic>>
          >(
            conditions,
            (value) =>
      ...
      'timeConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(timeConfig, (value) => value.toMap()),
      'ua': ?ua,
      'url': ?url,
      'wafBaseConfigs':
          ?pulumi.Input.mapOptionalInputValue<
            List<DefenseRuleConfigWafBaseConfig>,
            List<Map<String, dynamic>>
          >(
            wafBaseConfigs,
            (value) =>
  ...
  factory DefenseRuleConfig.fromMap(Map<String, dynamic> map) {
    return DefenseRuleConfig(
      abroadRegions: (() {
        final guardedValue = map['abroadRegions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      accountIdentifiers: (() {
        final guardedValue = map['accountIdentifiers'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DefenseRuleConfigAccountIdentifier>(
            guardedValue,
            (value) => DefenseRuleConfigAccountIdentifier.fromMap(
      ...
      bypassRegularRules: (() {
        final guardedValue = map['bypassRegularRules'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      bypassRegularTypes: (() {
        final guardedValue = map['bypassRegularTypes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      bypassTags: (() {
        final guardedValue = map['bypassTags'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      ccEffect: (() {
        final guardedValue = map['ccEffect'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ccStatus: (() {
      ...
      cnRegions: (() {
        final guardedValue = map['cnRegions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      codecLists: (() {
        final guardedValue = map['codecLists'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      conditions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DefenseRuleConfigCondition>(
            guardedValue,
            (value) => DefenseRuleConfigCondition.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      grayConfig: (() {
        final guardedValue = map['grayConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DefenseRuleConfigGrayConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      grayStatus: (() {
        final guardedValue = map['grayStatus'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      mode: (() {
      ...
      rateLimit: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DefenseRuleConfigRateLimit.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      throttleThrehold: (() {
        final guardedValue = map['throttleThrehold'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      throttleType: (() {
        final guardedValue = map['throttleType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      timeConfig: (() {
        final guardedValue = map['timeConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DefenseRuleConfigTimeConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ua: (() {
        final guardedValue = map['ua'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      url: (() {
      ...
      wafBaseConfigs: (() {
        final guardedValue = map['wafBaseConfigs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DefenseRuleConfigWafBaseConfig>(
            guardedValue,
            (value) => DefenseRuleConfigWafBaseConfig.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
