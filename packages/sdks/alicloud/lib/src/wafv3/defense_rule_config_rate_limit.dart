...
class DefenseRuleConfigRateLimit {
  ...
  final pulumi.Input<DefenseRuleConfigRateLimitStatus>? status;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'interval': ?interval,
      'status': ?pulumi.Input.mapOptionalInputValue<DefenseRuleConfigRateLimitStatus, Map<String, dynamic>>(status, (value) => value.toMap()),
      'subKey': ?subKey,
      'target': ?target,
      'threshold': ?threshold,
      'ttl': ?ttl,
  ...
  factory DefenseRuleConfigRateLimit.fromMap(Map<String, dynamic> map) {
    return DefenseRuleConfigRateLimit(
      ...
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DefenseRuleConfigRateLimitStatus.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
