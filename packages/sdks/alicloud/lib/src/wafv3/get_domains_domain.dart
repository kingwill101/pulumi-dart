...
class GetDomainsDomain {
  ...
  factory GetDomainsDomain.fromMap(Map<String, dynamic> map) {
    return GetDomainsDomain(
      ...
      listens: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetDomainsDomainListen>(
          map['listens']!,
          (value) => GetDomainsDomainListen.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      redirects: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetDomainsDomainRedirect>(
          map['redirects']!,
          (value) => GetDomainsDomainRedirect.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      resourceManagerResourceGroupId: pulumi.Input.fromValue(
        map['resourceManagerResourceGroupId'] as String,
      ),
