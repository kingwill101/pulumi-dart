...
class DefenseRuleConfigWafBaseConfig {
  ...
  final pulumi.Input<List<DefenseRuleConfigWafBaseConfigRuleDetail>>?
  ruleDetails;
    ...
    return <String, dynamic>{
      ...
      'ruleDetails':
          ?pulumi.Input.mapOptionalInputValue<
            List<DefenseRuleConfigWafBaseConfigRuleDetail>,
  ...
  factory DefenseRuleConfigWafBaseConfig.fromMap(Map<String, dynamic> map) {
    return DefenseRuleConfigWafBaseConfig(
      ruleBatchOperationConfig: (() {
        final guardedValue = map['ruleBatchOperationConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ruleDetails: (() {
        final guardedValue = map['ruleDetails'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DefenseRuleConfigWafBaseConfigRuleDetail>(
            guardedValue,
            (value) => DefenseRuleConfigWafBaseConfigRuleDetail.fromMap(
