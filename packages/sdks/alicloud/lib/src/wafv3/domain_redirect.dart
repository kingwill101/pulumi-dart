...
class DomainRedirect {
    ...
    return <String, dynamic>{
      ...
      'requestHeaders':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainRedirectRequestHeader>,
  ...
  factory DomainRedirect.fromMap(Map<String, dynamic> map) {
    return DomainRedirect(
      ...
      backupBackends: (() {
        final guardedValue = map['backupBackends'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      connectTimeout: (() {
      ...
      focusHttpBackend: (() {
        final guardedValue = map['focusHttpBackend'];
        if (guardedValue == null) return null;
      ...
      http2OriginMaxConcurrency: (() {
        final guardedValue = map['http2OriginMaxConcurrency'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      keepalive: (() {
        final guardedValue = map['keepalive'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      keepaliveRequests: (() {
        final guardedValue = map['keepaliveRequests'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      keepaliveTimeout: (() {
        final guardedValue = map['keepaliveTimeout'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      loadbalance: pulumi.Input.fromValue(map['loadbalance'] as String),
      maxBodySize: (() {
        final guardedValue = map['maxBodySize'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      readTimeout: (() {
      ...
      requestHeaders: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainRedirectRequestHeader>(
            guardedValue,
            (value) => DomainRedirectRequestHeader.fromMap(
      ...
      sniEnabled: (() {
        final guardedValue = map['sniEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      sniHost: (() {
      ...
      writeTimeout: (() {
        final guardedValue = map['writeTimeout'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      xffProto: (() {
        final guardedValue = map['xffProto'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
    );
