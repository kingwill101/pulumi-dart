...
class DefenseRuleConfigTimeConfigTimePeriod {
  ...
  /// Creates a new [DefenseRuleConfigTimeConfigTimePeriod].
  ...
  const DefenseRuleConfigTimeConfigTimePeriod({
    this.end,
    this.start,
  });
  ...
  factory DefenseRuleConfigTimeConfigTimePeriod.fromMap(Map<String, dynamic> map) {
    return DefenseRuleConfigTimeConfigTimePeriod(
