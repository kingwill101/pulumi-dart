...
class DefenseRuleConfigTimeConfig {
  ...
  final pulumi.Input<List<DefenseRuleConfigTimeConfigWeekTimePeriod>>?
  weekTimePeriods;
    ...
    return <String, dynamic>{
      'timePeriods':
          ?pulumi.Input.mapOptionalInputValue<
            List<DefenseRuleConfigTimeConfigTimePeriod>,
      ...
      'weekTimePeriods':
          ?pulumi.Input.mapOptionalInputValue<
            List<DefenseRuleConfigTimeConfigWeekTimePeriod>,
            List<Map<String, dynamic>>
          >(
            weekTimePeriods,
            (value) =>
  ...
  factory DefenseRuleConfigTimeConfig.fromMap(Map<String, dynamic> map) {
    return DefenseRuleConfigTimeConfig(
      timePeriods: (() {
        final guardedValue = map['timePeriods'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DefenseRuleConfigTimeConfigTimePeriod>(
            guardedValue,
            (value) => DefenseRuleConfigTimeConfigTimePeriod.fromMap(
      ...
      timeScope: (() {
        final guardedValue = map['timeScope'];
        if (guardedValue == null) return null;
      ...
      weekTimePeriods: (() {
        final guardedValue = map['weekTimePeriods'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DefenseRuleConfigTimeConfigWeekTimePeriod>(
            guardedValue,
            (value) => DefenseRuleConfigTimeConfigWeekTimePeriod.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
