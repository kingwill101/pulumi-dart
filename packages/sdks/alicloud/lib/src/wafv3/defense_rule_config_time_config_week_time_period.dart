...
class DefenseRuleConfigTimeConfigWeekTimePeriod {
  ...
  factory DefenseRuleConfigTimeConfigWeekTimePeriod.fromMap(Map<String, dynamic> map) {
    return DefenseRuleConfigTimeConfigWeekTimePeriod(
      ...
      dayPeriods: (() { final guardedValue = map['dayPeriods']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DefenseRuleConfigTimeConfigWeekTimePeriodDayPeriod>(guardedValue, (value) => DefenseRuleConfigTimeConfigWeekTimePeriodDayPeriod.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
