...
class AppGroupState {
  ...
  factory AppGroupState.fromMap(Map<String, dynamic> map) {
    return AppGroupState(
      appGroupName: (() { final guardedValue = map['appGroupName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      quota: (() { final guardedValue = map['quota']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AppGroupQuota.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
