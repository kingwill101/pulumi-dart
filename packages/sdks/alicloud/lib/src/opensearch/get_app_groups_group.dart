...
class GetAppGroupsGroup {
  ...
  factory GetAppGroupsGroup.fromMap(Map<String, dynamic> map) {
    return GetAppGroupsGroup(
      ...
      firstRankAlgoDeploymentId: pulumi.Input.fromValue(
        map['firstRankAlgoDeploymentId'] as int,
      ),
      hasPendingQuotaReviewTask: pulumi.Input.fromValue(
        map['hasPendingQuotaReviewTask'] as int,
      ),
      id: pulumi.Input.fromValue(map['id'] as String),
      instanceId: pulumi.Input.fromValue(map['instanceId'] as String),
      lockMode: pulumi.Input.fromValue(map['lockMode'] as String),
      lockedByExpiration: pulumi.Input.fromValue(
        map['lockedByExpiration'] as int,
      ),
      paymentType: pulumi.Input.fromValue(map['paymentType'] as String),
      pendingSecondRankAlgoDeploymentId: pulumi.Input.fromValue(
        map['pendingSecondRankAlgoDeploymentId'] as int,
      ),
      processingOrderId: pulumi.Input.fromValue(
        map['processingOrderId'] as String,
      ),
      produced: pulumi.Input.fromValue(map['produced'] as int),
      projectId: pulumi.Input.fromValue(map['projectId'] as String),
      quotas: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetAppGroupsGroupQuota>(
          map['quotas']!,
          (value) => GetAppGroupsGroupQuota.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      resourceGroupId: pulumi.Input.fromValue(map['resourceGroupId'] as String),
      secondRankAlgoDeploymentId: pulumi.Input.fromValue(
        map['secondRankAlgoDeploymentId'] as int,
      ),
