...
class EnvFeatureState {
  ...
  factory EnvFeatureState.fromMap(Map<String, dynamic> map) {
    return EnvFeatureState(
      envFeatureName: (() { final guardedValue = map['envFeatureName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      featureVersion: (() { final guardedValue = map['featureVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
