...
import 'prometheus_monitoring_state.dart';
...
class PrometheusMonitoring extends pulumi.CustomResource {
  ...
  static PrometheusMonitoring get(
    String name,
    pulumi.Input<String> id, {
    PrometheusMonitoringState? state,
  }) {
    return PrometheusMonitoring._get(
      name,
      state: state?.toMap(),
