...
class DispatchRuleLabelMatchExpressionGrid {
  ...
  factory DispatchRuleLabelMatchExpressionGrid.fromMap(Map<String, dynamic> map) {
    return DispatchRuleLabelMatchExpressionGrid(
      labelMatchExpressionGroups: (pulumi.Input.decodeList<DispatchRuleLabelMatchExpressionGridLabelMatchExpressionGroup>(map['labelMatchExpressionGroups'], (value) => DispatchRuleLabelMatchExpressionGridLabelMatchExpressionGroup.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
