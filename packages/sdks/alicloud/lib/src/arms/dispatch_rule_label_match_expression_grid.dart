...
class DispatchRuleLabelMatchExpressionGrid {
  ...
  final pulumi.Input<
    List<DispatchRuleLabelMatchExpressionGridLabelMatchExpressionGroup>
  >
  ...
  factory DispatchRuleLabelMatchExpressionGrid.fromMap(
    ...
    return DispatchRuleLabelMatchExpressionGrid(
      labelMatchExpressionGroups: pulumi.Input.fromValue(
        ...
        >(
          ...
          (value) =>
              DispatchRuleLabelMatchExpressionGridLabelMatchExpressionGroup.fromMap(
