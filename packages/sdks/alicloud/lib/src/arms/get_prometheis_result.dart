...
class GetPrometheisResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'prometheis':
          pulumi.Input.encodeList<GetPrometheisPromethei, Map<String, dynamic>>(
            prometheis,
            (value) => value.toMap(),
          ),
  ...
  factory GetPrometheisResult.fromMap(Map<String, dynamic> map) {
    return GetPrometheisResult(
      ...
      prometheis: pulumi.Input.decodeList<GetPrometheisPromethei>(
        map['prometheis']!,
        (value) => GetPrometheisPromethei.fromMap(
