...
import 'addon_release_args.dart';
import 'addon_release_state.dart';
...
class AddonRelease extends pulumi.CustomResource {
  ...
  /// Creates a new [AddonRelease].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [AddonRelease]. {@macro pulumi_arms_addon_release_addon_release_args_doc}
  ...
  static AddonRelease get(
    String name,
    pulumi.Input<String> id, {
    AddonReleaseState? state,
  }) {
    return AddonRelease._get(
      name,
      state: state?.toMap(),
