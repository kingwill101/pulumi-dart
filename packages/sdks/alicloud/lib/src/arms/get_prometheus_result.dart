...
class GetPrometheusResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'prometheis':
          pulumi.Input.encodeList<GetPrometheusPromethei, Map<String, dynamic>>(
            prometheis,
            (value) => value.toMap(),
          ),
  ...
  factory GetPrometheusResult.fromMap(Map<String, dynamic> map) {
    return GetPrometheusResult(
      ...
      prometheis: pulumi.Input.decodeList<GetPrometheusPromethei>(
        map['prometheis']!,
        (value) => GetPrometheusPromethei.fromMap(
