...
class SyntheticTaskMonitorConfWebsite {
  ...
  factory SyntheticTaskMonitorConfWebsite.fromMap(Map<String, dynamic> map) {
    return SyntheticTaskMonitorConfWebsite(
      automaticScrolling: (() {
        final guardedValue = map['automaticScrolling'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      customHeader: (() {
        final guardedValue = map['customHeader'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      customHeaderContent: (() {
      ...
      disableCompression: (() {
        final guardedValue = map['disableCompression'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      dnsHijackWhitelist: (() {
        final guardedValue = map['dnsHijackWhitelist'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      elementBlacklist: (() {
        final guardedValue = map['elementBlacklist'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      filterInvalidIp: (() {
        final guardedValue = map['filterInvalidIp'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      flowHijackJumpTimes: (() {
        final guardedValue = map['flowHijackJumpTimes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      flowHijackLogo: (() {
        final guardedValue = map['flowHijackLogo'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ignoreCertificateError: (() {
        final guardedValue = map['ignoreCertificateError'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      monitorTimeout: (() {
      ...
      pageTamper: (() {
        final guardedValue = map['pageTamper'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      redirection: (() {
      ...
      slowElementThreshold: (() {
        final guardedValue = map['slowElementThreshold'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      targetUrl: pulumi.Input.fromValue(map['targetUrl'] as String),
      verifyStringBlacklist: (() {
        final guardedValue = map['verifyStringBlacklist'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      verifyStringWhitelist: (() {
        final guardedValue = map['verifyStringWhitelist'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      waitCompletionTime: (() {
        final guardedValue = map['waitCompletionTime'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
    );
