...
class SyntheticTaskMonitorConfWebsite {
  ...
  factory SyntheticTaskMonitorConfWebsite.fromMap(Map<String, dynamic> map) {
    return SyntheticTaskMonitorConfWebsite(
      automaticScrolling: map['automaticScrolling'] == null ? null : (map['automaticScrolling']! as int).input(),
      customHeader: map['customHeader'] == null ? null : (map['customHeader']! as int).input(),
      customHeaderContent: map['customHeaderContent'] == null ? null : ((map['customHeaderContent']! as Map).cast<String, String>()).input(),
      disableCache: map['disableCache'] == null ? null : (map['disableCache']! as int).input(),
      disableCompression: map['disableCompression'] == null ? null : (map['disableCompression']! as int).input(),
      dnsHijackWhitelist: map['dnsHijackWhitelist'] == null ? null : (map['dnsHijackWhitelist']! as String).input(),
      elementBlacklist: map['elementBlacklist'] == null ? null : (map['elementBlacklist']! as String).input(),
      filterInvalidIp: map['filterInvalidIp'] == null ? null : (map['filterInvalidIp']! as int).input(),
      flowHijackJumpTimes: map['flowHijackJumpTimes'] == null ? null : (map['flowHijackJumpTimes']! as int).input(),
      flowHijackLogo: map['flowHijackLogo'] == null ? null : (map['flowHijackLogo']! as String).input(),
      ignoreCertificateError: map['ignoreCertificateError'] == null ? null : (map['ignoreCertificateError']! as int).input(),
      monitorTimeout: map['monitorTimeout'] == null ? null : (map['monitorTimeout']! as int).input(),
      pageTamper: map['pageTamper'] == null ? null : (map['pageTamper']! as String).input(),
      redirection: map['redirection'] == null ? null : (map['redirection']! as int).input(),
      slowElementThreshold: map['slowElementThreshold'] == null ? null : (map['slowElementThreshold']! as int).input(),
      targetUrl: (map['targetUrl'] as String).input(),
      verifyStringBlacklist: map['verifyStringBlacklist'] == null ? null : (map['verifyStringBlacklist']! as String).input(),
      verifyStringWhitelist: map['verifyStringWhitelist'] == null ? null : (map['verifyStringWhitelist']! as String).input(),
      waitCompletionTime: map['waitCompletionTime'] == null ? null : (map['waitCompletionTime']! as int).input(),
    );
  }
}
