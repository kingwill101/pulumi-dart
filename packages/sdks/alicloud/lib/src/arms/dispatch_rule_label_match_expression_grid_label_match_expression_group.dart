...
class DispatchRuleLabelMatchExpressionGridLabelMatchExpressionGroup {
  ...
  final pulumi.Input<List<DispatchRuleLabelMatchExpressionGridLabelMatchExpressionGroupLabelMatchExpression>> labelMatchExpressions;
  ...
  const DispatchRuleLabelMatchExpressionGridLabelMatchExpressionGroup({
    required this.labelMatchExpressions,
  });

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'labelMatchExpressions': pulumi.Input.mapInputValue<List<DispatchRuleLabelMatchExpressionGridLabelMatchExpressionGroupLabelMatchExpression>, List<Map<String, dynamic>>>(labelMatchExpressions, (value) => pulumi.Input.encodeList<DispatchRuleLabelMatchExpressionGridLabelMatchExpressionGroupLabelMatchExpression, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory DispatchRuleLabelMatchExpressionGridLabelMatchExpressionGroup.fromMap(Map<String, dynamic> map) {
    return DispatchRuleLabelMatchExpressionGridLabelMatchExpressionGroup(
      labelMatchExpressions: pulumi.Input.fromValue(pulumi.Input.decodeList<DispatchRuleLabelMatchExpressionGridLabelMatchExpressionGroupLabelMatchExpression>(map['labelMatchExpressions']!, (value) => DispatchRuleLabelMatchExpressionGridLabelMatchExpressionGroupLabelMatchExpression.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
