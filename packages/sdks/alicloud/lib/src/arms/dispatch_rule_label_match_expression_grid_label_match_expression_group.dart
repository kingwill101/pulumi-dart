...
class DispatchRuleLabelMatchExpressionGridLabelMatchExpressionGroup {
  ...
  factory DispatchRuleLabelMatchExpressionGridLabelMatchExpressionGroup.fromMap(Map<String, dynamic> map) {
    return DispatchRuleLabelMatchExpressionGridLabelMatchExpressionGroup(
      labelMatchExpressions: (pulumi.Input.decodeList<DispatchRuleLabelMatchExpressionGridLabelMatchExpressionGroupLabelMatchExpression>(map['labelMatchExpressions'], (value) => DispatchRuleLabelMatchExpressionGridLabelMatchExpressionGroupLabelMatchExpression.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
