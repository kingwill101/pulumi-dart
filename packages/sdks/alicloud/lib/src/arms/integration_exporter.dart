...
import 'integration_exporter_state.dart';
...
class IntegrationExporter extends pulumi.CustomResource {
  ...
  static IntegrationExporter get(
    String name,
    pulumi.Input<String> id, {
    IntegrationExporterState? state,
  }) {
    return IntegrationExporter._get(
      name,
      state: state?.toMap(),
