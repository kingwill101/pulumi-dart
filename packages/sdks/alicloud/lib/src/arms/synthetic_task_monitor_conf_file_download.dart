...
class SyntheticTaskMonitorConfFileDownload {
  ...
  factory SyntheticTaskMonitorConfFileDownload.fromMap(Map<String, dynamic> map) {
    return SyntheticTaskMonitorConfFileDownload(
      ...
      downloadKernel: (() { final guardedValue = map['downloadKernel']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ignoreCertificateAuthError: (() { final guardedValue = map['ignoreCertificateAuthError']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ignoreCertificateCanceledError: (() { final guardedValue = map['ignoreCertificateCanceledError']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ignoreCertificateOutOfDateError: (() { final guardedValue = map['ignoreCertificateOutOfDateError']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ignoreCertificateStatusError: (() { final guardedValue = map['ignoreCertificateStatusError']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ignoreCertificateUntrustworthyError: (() { final guardedValue = map['ignoreCertificateUntrustworthyError']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ignoreCertificateUsingError: (() { final guardedValue = map['ignoreCertificateUsingError']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ignoreInvalidHostError: (() { final guardedValue = map['ignoreInvalidHostError']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      quickProtocol: (() { final guardedValue = map['quickProtocol']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      transmissionSize: (() { final guardedValue = map['transmissionSize']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      validateKeywords: (() { final guardedValue = map['validateKeywords']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      verifyWay: (() { final guardedValue = map['verifyWay']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
