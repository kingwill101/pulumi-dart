...
class SyntheticTaskCommonSettingCustomHost {
  ...
  factory SyntheticTaskCommonSettingCustomHost.fromMap(Map<String, dynamic> map) {
    return SyntheticTaskCommonSettingCustomHost(
      hosts: pulumi.Input.fromValue(pulumi.Input.decodeList<SyntheticTaskCommonSettingCustomHostHost>(map['hosts']!, (value) => SyntheticTaskCommonSettingCustomHostHost.fromMap((value as Map).cast<String, dynamic>()))),
