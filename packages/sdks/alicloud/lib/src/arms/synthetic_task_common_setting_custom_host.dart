...
class SyntheticTaskCommonSettingCustomHost {
    ...
    return <String, dynamic>{
      'hosts':
          pulumi.Input.mapInputValue<
            List<SyntheticTaskCommonSettingCustomHostHost>,
  ...
  factory SyntheticTaskCommonSettingCustomHost.fromMap(
    Map<String, dynamic> map,
  ) {
    return SyntheticTaskCommonSettingCustomHost(
      hosts: pulumi.Input.fromValue(
        pulumi.Input.decodeList<SyntheticTaskCommonSettingCustomHostHost>(
          map['hosts']!,
          (value) => SyntheticTaskCommonSettingCustomHostHost.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      selectType: pulumi.Input.fromValue(map['selectType'] as int),
    );
  }
}
