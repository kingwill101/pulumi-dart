...
class DispatchRuleNotifyRule {
  ...
  factory DispatchRuleNotifyRule.fromMap(Map<String, dynamic> map) {
    return DispatchRuleNotifyRule(
      ...
      notifyObjects: pulumi.Input.fromValue(pulumi.Input.decodeList<DispatchRuleNotifyRuleNotifyObject>(map['notifyObjects']!, (value) => DispatchRuleNotifyRuleNotifyObject.fromMap((value as Map).cast<String, dynamic>()))),
