...
class GetDispatchRulesRuleLabelMatchExpressionGridLabelMatchExpressionGroup {
  ...
  const GetDispatchRulesRuleLabelMatchExpressionGridLabelMatchExpressionGroup({
  ...
  factory GetDispatchRulesRuleLabelMatchExpressionGridLabelMatchExpressionGroup.fromMap(Map<String, dynamic> map) {
    return GetDispatchRulesRuleLabelMatchExpressionGridLabelMatchExpressionGroup(
      labelMatchExpressions: pulumi.Input.fromValue(pulumi.Input.decodeList<GetDispatchRulesRuleLabelMatchExpressionGridLabelMatchExpressionGroupLabelMatchExpression>(map['labelMatchExpressions']!, (value) => GetDispatchRulesRuleLabelMatchExpressionGridLabelMatchExpressionGroupLabelMatchExpression.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
