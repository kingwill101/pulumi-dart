...
class GetAlertContactGroupsResult {
  ...
  factory GetAlertContactGroupsResult.fromMap(Map<String, dynamic> map) {
    return GetAlertContactGroupsResult(
      alertContactGroupName: (() { final guardedValue = map['alertContactGroupName']; if (guardedValue == null) return null; return guardedValue as String; })(),
      contactId: (() { final guardedValue = map['contactId']; if (guardedValue == null) return null; return guardedValue as String; })(),
      contactName: (() { final guardedValue = map['contactName']; if (guardedValue == null) return null; return guardedValue as String; })(),
