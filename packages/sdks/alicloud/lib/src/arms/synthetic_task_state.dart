...
class SyntheticTaskState {
  ...
  factory SyntheticTaskState.fromMap(Map<String, dynamic> map) {
    return SyntheticTaskState(
      ...
      monitorCategory: (() { final guardedValue = map['monitorCategory']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      monitorConf: (() { final guardedValue = map['monitorConf']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SyntheticTaskMonitorConf.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      monitors: (() { final guardedValue = map['monitors']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SyntheticTaskMonitor>(guardedValue, (value) => SyntheticTaskMonitor.fromMap((value as Map).cast<String, dynamic>()))); })(),
      resourceGroupId: (() { final guardedValue = map['resourceGroupId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      syntheticTaskName: (() { final guardedValue = map['syntheticTaskName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      tags: (() { final guardedValue = map['tags']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      taskType: (() { final guardedValue = map['taskType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
    );
  }
}
