...
class PrometheusState {
  ...
  factory PrometheusState.fromMap(Map<String, dynamic> map) {
    return PrometheusState(
      ...
      grafanaInstanceId: (() { final guardedValue = map['grafanaInstanceId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
