    ...
    return <String, dynamic>{
      'annotations':
          pulumi.Input.mapInputValue<
            List<GetPrometheusAlertRulesRuleAnnotation>,
      ...
      'labels':
          pulumi.Input.mapInputValue<
            List<GetPrometheusAlertRulesRuleLabel>,
            List<Map<String, dynamic>>
          >(
            labels,
            (value) =>
  ...
  factory GetPrometheusAlertRulesRule.fromMap(Map<String, dynamic> map) {
    return GetPrometheusAlertRulesRule(
      annotations: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetPrometheusAlertRulesRuleAnnotation>(
          map['annotations']!,
          (value) => GetPrometheusAlertRulesRuleAnnotation.fromMap(
      ...
      labels: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetPrometheusAlertRulesRuleLabel>(
          map['labels']!,
          (value) => GetPrometheusAlertRulesRuleLabel.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      ...
      prometheusAlertRuleId: pulumi.Input.fromValue(
        map['prometheusAlertRuleId'] as String,
      ),
