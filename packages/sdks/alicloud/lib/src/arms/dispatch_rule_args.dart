...
class DispatchRuleArgs {
  ...
  factory DispatchRuleArgs.fromMap(Map<String, dynamic> map) {
    return DispatchRuleArgs(
      ...
      groupRules: pulumi.Input.fromValue(pulumi.Input.decodeList<DispatchRuleGroupRule>(map['groupRules']!, (value) => DispatchRuleGroupRule.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      labelMatchExpressionGrids: pulumi.Input.fromValue(pulumi.Input.decodeList<DispatchRuleLabelMatchExpressionGrid>(map['labelMatchExpressionGrids']!, (value) => DispatchRuleLabelMatchExpressionGrid.fromMap((value as Map).cast<String, dynamic>()))),
      notifyRules: pulumi.Input.fromValue(pulumi.Input.decodeList<DispatchRuleNotifyRule>(map['notifyRules']!, (value) => DispatchRuleNotifyRule.fromMap((value as Map).cast<String, dynamic>()))),
