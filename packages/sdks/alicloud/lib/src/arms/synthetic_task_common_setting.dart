...
class SyntheticTaskCommonSetting {
  ...
  factory SyntheticTaskCommonSetting.fromMap(Map<String, dynamic> map) {
    return SyntheticTaskCommonSetting(
      customHost: (() { final guardedValue = map['customHost']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SyntheticTaskCommonSettingCustomHost.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ipType: (() { final guardedValue = map['ipType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      isOpenTrace: (() { final guardedValue = map['isOpenTrace']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      monitorSamples: (() { final guardedValue = map['monitorSamples']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      traceClientType: (() { final guardedValue = map['traceClientType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      xtraceRegion: (() { final guardedValue = map['xtraceRegion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
