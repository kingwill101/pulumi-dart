...
class VscMountPointInstance {
  ...
  VscMountPointInstance({this.instanceId, this.status, this.vscs});
  ...
  factory VscMountPointInstance.fromMap(Map<String, dynamic> map) {
    return VscMountPointInstance(
      ...
      vscs: (() {
        final guardedValue = map['vscs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VscMountPointInstanceVsc>(
            guardedValue,
            (value) => VscMountPointInstanceVsc.fromMap(
