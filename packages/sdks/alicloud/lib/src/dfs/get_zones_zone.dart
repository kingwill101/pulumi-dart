...
class GetZonesZone {
  ...
  factory GetZonesZone.fromMap(Map<String, dynamic> map) {
    return GetZonesZone(
      options: pulumi.Input.fromValue(pulumi.Input.decodeList<GetZonesZoneOption>(map['options']!, (value) => GetZonesZoneOption.fromMap((value as Map).cast<String, dynamic>()))),
