...
class GetZonesZone {
  ...
  /// [zoneId] The zone ID.
  GetZonesZone({required this.options, required this.zoneId});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'options':
          pulumi.Input.mapInputValue<
            List<GetZonesZoneOption>,
  ...
  factory GetZonesZone.fromMap(Map<String, dynamic> map) {
    return GetZonesZone(
      options: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetZonesZoneOption>(
          map['options']!,
          (value) => GetZonesZoneOption.fromMap(
