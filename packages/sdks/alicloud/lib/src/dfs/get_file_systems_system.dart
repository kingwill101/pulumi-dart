...
class GetFileSystemsSystem {
  ...
  factory GetFileSystemsSystem.fromMap(Map<String, dynamic> map) {
    return GetFileSystemsSystem(
      ...
      numberOfDirectories: pulumi.Input.fromValue(map['numberOfDirectories'] as int),
      ...
      provisionedThroughputInMiBps: pulumi.Input.fromValue(map['provisionedThroughputInMiBps'] as int),
      spaceCapacity: pulumi.Input.fromValue(map['spaceCapacity'] as int),
      storagePackageId: pulumi.Input.fromValue(map['storagePackageId'] as String),
