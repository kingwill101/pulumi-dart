...
class VscMountPointInstanceVsc {
  ...
  factory VscMountPointInstanceVsc.fromMap(Map<String, dynamic> map) {
    return VscMountPointInstanceVsc(
      vscId: (() { final guardedValue = map['vscId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      vscStatus: (() { final guardedValue = map['vscStatus']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
