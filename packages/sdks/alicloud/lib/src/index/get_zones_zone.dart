...
class GetZonesZone {
  ...
  factory GetZonesZone.fromMap(Map<String, dynamic> map) {
    return GetZonesZone(
      availableDiskCategories: pulumi.Input.fromValue((map['availableDiskCategories'] as List).cast<String>()),
      availableInstanceTypes: pulumi.Input.fromValue((map['availableInstanceTypes'] as List).cast<String>()),
      availableResourceCreations: pulumi.Input.fromValue((map['availableResourceCreations'] as List).cast<String>()),
