...
class OpenApiExplorerApiMcpServerArgs {
  ...
  OpenApiExplorerApiMcpServerArgs({
    ...
    required pulumi.Output<List<OpenApiExplorerApiMcpServerApi>> apis,
  ...
  factory OpenApiExplorerApiMcpServerArgs.fromMap(Map<String, dynamic> map) {
    return OpenApiExplorerApiMcpServerArgs(
      ...
      apis: pulumi.Output.create<List<OpenApiExplorerApiMcpServerApi>>(pulumi.Input.decodeList<OpenApiExplorerApiMcpServerApi>(map['apis'], (value) => OpenApiExplorerApiMcpServerApi.fromMap((value as Map).cast<String, dynamic>()))),
