...
class OpenApiExplorerApiMcpServerArgs {
  ...
  factory OpenApiExplorerApiMcpServerArgs.fromMap(Map<String, dynamic> map) {
    return OpenApiExplorerApiMcpServerArgs(
      ...
      apis: (pulumi.Input.decodeList<OpenApiExplorerApiMcpServerApi>(map['apis'], (value) => OpenApiExplorerApiMcpServerApi.fromMap((value as Map).cast<String, dynamic>()))).input(),
