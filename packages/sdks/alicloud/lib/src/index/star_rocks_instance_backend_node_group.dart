...
class StarRocksInstanceBackendNodeGroup {
  ...
  /// [zoneId] Zone ID.
  const StarRocksInstanceBackendNodeGroup({
    this.cu,
    this.diskNumber,
  ...
  factory StarRocksInstanceBackendNodeGroup.fromMap(Map<String, dynamic> map) {
    return StarRocksInstanceBackendNodeGroup(
