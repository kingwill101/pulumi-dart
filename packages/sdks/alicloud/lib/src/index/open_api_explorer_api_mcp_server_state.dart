...
class OpenApiExplorerApiMcpServerState {
  ...
  const OpenApiExplorerApiMcpServerState({
  ...
  factory OpenApiExplorerApiMcpServerState.fromMap(Map<String, dynamic> map) {
    return OpenApiExplorerApiMcpServerState(
      ...
      apis: (() { final guardedValue = map['apis']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OpenApiExplorerApiMcpServerApi>(guardedValue, (value) => OpenApiExplorerApiMcpServerApi.fromMap((value as Map).cast<String, dynamic>()))); })(),
