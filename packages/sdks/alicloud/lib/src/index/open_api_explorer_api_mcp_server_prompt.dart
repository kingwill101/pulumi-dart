...
class OpenApiExplorerApiMcpServerPrompt {
  ...
  factory OpenApiExplorerApiMcpServerPrompt.fromMap(Map<String, dynamic> map) {
    return OpenApiExplorerApiMcpServerPrompt(
      arguments: (() { final guardedValue = map['arguments']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OpenApiExplorerApiMcpServerPromptArgument>(guardedValue, (value) => OpenApiExplorerApiMcpServerPromptArgument.fromMap((value as Map).cast<String, dynamic>()))); })(),
