...
class StarRocksInstanceArgs {
  ...
  StarRocksInstanceArgs({
    ...
    required pulumi.Output<String> clusterZoneId,
    ...
    required pulumi.Output<String> runMode,
  ...
  factory StarRocksInstanceArgs.fromMap(Map<String, dynamic> map) {
    return StarRocksInstanceArgs(
      ...
      clusterZoneId: pulumi.Output.create<String>(map['clusterZoneId'] as String),
      ...
      runMode: pulumi.Output.create<String>(map['runMode'] as String),
