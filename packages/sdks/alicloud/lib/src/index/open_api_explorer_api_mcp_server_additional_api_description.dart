...
class OpenApiExplorerApiMcpServerAdditionalApiDescription {
  ...
  final pulumi.Input<
    List<OpenApiExplorerApiMcpServerAdditionalApiDescriptionConstParameter>
  >?
  constParameters;
  ...
  factory OpenApiExplorerApiMcpServerAdditionalApiDescription.fromMap(
    ...
    return OpenApiExplorerApiMcpServerAdditionalApiDescription(
      ...
      apiOverrideJson: (() {
        final guardedValue = map['apiOverrideJson'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      apiVersion: (() {
      ...
      constParameters: (() {
        final guardedValue = map['constParameters'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                OpenApiExplorerApiMcpServerAdditionalApiDescriptionConstParameter.fromMap(
      ...
      enableOutputSchema: (() {
        final guardedValue = map['enableOutputSchema'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      executeCliCommand: (() {
        final guardedValue = map['executeCliCommand'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      product: (() {
