...
class StarRocksInstance extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [StarRocksInstance]. {@macro pulumi_index_star_rocks_instance_star_rocks_instance_args_doc}
  ...
  static StarRocksInstance get(
    String name,
    pulumi.Input<String> id, {
    StarRocksInstanceState? state,
  }) {
    return StarRocksInstance._get(
      name,
      state: state?.toMap(),
