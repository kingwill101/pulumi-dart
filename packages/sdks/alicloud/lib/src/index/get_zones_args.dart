...
class GetZonesArgs {
  ...
  factory GetZonesArgs.fromMap(Map<String, dynamic> map) {
    return GetZonesArgs(
      availableDiskCategory: (() { final guardedValue = map['availableDiskCategory']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      availableInstanceType: (() { final guardedValue = map['availableInstanceType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      availableResourceCreation: (() { final guardedValue = map['availableResourceCreation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
