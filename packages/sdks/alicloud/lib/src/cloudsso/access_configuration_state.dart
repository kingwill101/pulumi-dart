...
class AccessConfigurationState {
  ...
  AccessConfigurationState({
    ...
    pulumi.Output<String>? accessConfigurationName,
    ...
    pulumi.Output<int>? sessionDuration,
      ...
      accessConfigurationName = pulumi.Input.asOptionalInput<String>(accessConfigurationName),
  ...
  factory AccessConfigurationState.fromMap(Map<String, dynamic> map) {
    return AccessConfigurationState(
      ...
      accessConfigurationName: map['accessConfigurationName'] == null ? null : pulumi.Output.create<String>(map['accessConfigurationName'] as String),
