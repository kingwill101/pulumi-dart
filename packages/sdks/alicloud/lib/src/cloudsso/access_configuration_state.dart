...
class AccessConfigurationState {
  ...
  const AccessConfigurationState({
  ...
  factory AccessConfigurationState.fromMap(Map<String, dynamic> map) {
    return AccessConfigurationState(
      ...
      accessConfigurationName: (() { final guardedValue = map['accessConfigurationName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
