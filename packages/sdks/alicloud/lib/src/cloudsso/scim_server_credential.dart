...
import 'scim_server_credential_state.dart';
...
class ScimServerCredential extends pulumi.CustomResource {
  ...
  /// Gets an existing [ScimServerCredential] resource's state with the given [name] and [id].
  static ScimServerCredential get(
    String name,
    pulumi.Input<String> id, {
    ScimServerCredentialState? state,
  }) {
    return ScimServerCredential._get(
      name,
      state: state?.toMap(),
