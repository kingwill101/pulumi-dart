...
class InstanceArgs {
  ...
  factory InstanceArgs.fromMap(Map<String, dynamic> map) {
    return InstanceArgs(
      ...
      environmentVars: (() { final guardedValue = map['environmentVars']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InstanceEnvironmentVar>(guardedValue, (value) => InstanceEnvironmentVar.fromMap((value as Map).cast<String, dynamic>()))); })(),
