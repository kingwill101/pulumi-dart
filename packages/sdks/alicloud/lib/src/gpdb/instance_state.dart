...
class InstanceState {
  ...
  InstanceState({
    ...
    pulumi.Output<String>? dbInstanceMode,
    ...
    pulumi.Output<String>? zoneId,
      ...
      dbInstanceMode = pulumi.Input.asOptionalInput<String>(dbInstanceMode),
  ...
  factory InstanceState.fromMap(Map<String, dynamic> map) {
    return InstanceState(
      ...
      dbInstanceMode: map['dbInstanceMode'] == null ? null : pulumi.Output.create<String>(map['dbInstanceMode'] as String),
