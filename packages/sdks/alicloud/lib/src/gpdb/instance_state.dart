...
class InstanceState {
  ...
  /// [connectionString] (Available since v1.196.0) The connection string of the instance.
  ...
  factory InstanceState.fromMap(Map<String, dynamic> map) {
    return InstanceState(
      ...
      createSampleData: (() {
        final guardedValue = map['createSampleData'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      dataShareStatus: (() {
        final guardedValue = map['dataShareStatus'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      dbInstanceCategory: (() {
      ...
      dbInstanceMode: (() {
        final guardedValue = map['dbInstanceMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      description: (() {
      ...
      instanceGroupCount: (() {
        final guardedValue = map['instanceGroupCount'];
        if (guardedValue == null) return null;
      ...
      ipWhitelists: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InstanceIpWhitelist>(
            guardedValue,
            (value) => InstanceIpWhitelist.fromMap(
      ...
      masterCu: (() {
        final guardedValue = map['masterCu'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      masterNodeNum: (() {
        final guardedValue = map['masterNodeNum'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      parameters: (() {
      ...
      prodType: (() {
        final guardedValue = map['prodType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      resourceGroupId: (() {
      ...
      resourceManagementMode: (() {
        final guardedValue = map['resourceManagementMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      securityIpLists: (() {
      ...
      segDiskPerformanceLevel: (() {
        final guardedValue = map['segDiskPerformanceLevel'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      segNodeNum: (() {
        final guardedValue = map['segNodeNum'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      segStorageType: (() {
        final guardedValue = map['segStorageType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      serverlessMode: (() {
        final guardedValue = map['serverlessMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      sslEnabled: (() {
      ...
      vectorConfigurationStatus: (() {
        final guardedValue = map['vectorConfigurationStatus'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      vpcId: (() {
