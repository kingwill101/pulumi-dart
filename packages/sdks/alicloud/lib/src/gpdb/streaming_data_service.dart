...
import 'streaming_data_service_state.dart';
...
class StreamingDataService extends pulumi.CustomResource {
  ...
  static StreamingDataService get(
    String name,
    pulumi.Input<String> id, {
    StreamingDataServiceState? state,
  }) {
    return StreamingDataService._get(
      name,
      state: state?.toMap(),
