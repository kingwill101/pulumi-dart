...
class GetDataBackupsBackup {
  ...
  factory GetDataBackupsBackup.fromMap(Map<String, dynamic> map) {
    return GetDataBackupsBackup(
      ...
      backupEndTimeLocal: pulumi.Input.fromValue(
        map['backupEndTimeLocal'] as String,
      ),
      ...
      backupStartTimeLocal: pulumi.Input.fromValue(
        map['backupStartTimeLocal'] as String,
      ),
