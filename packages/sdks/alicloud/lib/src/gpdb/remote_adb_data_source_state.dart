...
class RemoteAdbDataSourceState {
  ...
  factory RemoteAdbDataSourceState.fromMap(Map<String, dynamic> map) {
    return RemoteAdbDataSourceState(
      ...
      localDatabase: (() {
        final guardedValue = map['localDatabase'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      localDbInstanceId: (() {
        final guardedValue = map['localDbInstanceId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      managerUserName: (() {
        final guardedValue = map['managerUserName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      managerUserPassword: (() {
        final guardedValue = map['managerUserPassword'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      remoteAdbDataSourceId: (() {
        final guardedValue = map['remoteAdbDataSourceId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      remoteDatabase: (() {
        final guardedValue = map['remoteDatabase'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      remoteDbInstanceId: (() {
        final guardedValue = map['remoteDbInstanceId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      status: (() {
