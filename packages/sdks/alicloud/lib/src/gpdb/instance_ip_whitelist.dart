...
class InstanceIpWhitelist {
  ...
  final String? ipGroupAttribute;
  /// IP whitelist group name.
  final String? ipGroupName;
  ...
  factory InstanceIpWhitelist.fromMap(Map<String, dynamic> map) {
    return InstanceIpWhitelist(
      ipGroupAttribute: map['ipGroupAttribute'] == null ? null : map['ipGroupAttribute'] as String,
      ipGroupName: map['ipGroupName'] == null ? null : map['ipGroupName'] as String,
