...
class GetDbInstancePlansPlanPlanConfig {
    ...
    return <String, dynamic>{
      'pauses':
          pulumi.Input.mapInputValue<
            List<GetDbInstancePlansPlanPlanConfigPause>,
      ...
      'resumes':
          pulumi.Input.mapInputValue<
            List<GetDbInstancePlansPlanPlanConfigResume>,
            List<Map<String, dynamic>>
          >(
            resumes,
            (value) =>
      ...
      'scaleIns':
          pulumi.Input.mapInputValue<
            List<GetDbInstancePlansPlanPlanConfigScaleIn>,
            List<Map<String, dynamic>>
          >(
            scaleIns,
            (value) =>
      ...
      'scaleOuts':
          pulumi.Input.mapInputValue<
            List<GetDbInstancePlansPlanPlanConfigScaleOut>,
            List<Map<String, dynamic>>
          >(
            scaleOuts,
            (value) =>
  ...
  factory GetDbInstancePlansPlanPlanConfig.fromMap(Map<String, dynamic> map) {
    return GetDbInstancePlansPlanPlanConfig(
      pauses: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetDbInstancePlansPlanPlanConfigPause>(
          map['pauses']!,
          (value) => GetDbInstancePlansPlanPlanConfigPause.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      resumes: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetDbInstancePlansPlanPlanConfigResume>(
          map['resumes']!,
          (value) => GetDbInstancePlansPlanPlanConfigResume.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      scaleIns: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetDbInstancePlansPlanPlanConfigScaleIn>(
          map['scaleIns']!,
          (value) => GetDbInstancePlansPlanPlanConfigScaleIn.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      scaleOuts: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetDbInstancePlansPlanPlanConfigScaleOut>(
          map['scaleOuts']!,
          (value) => GetDbInstancePlansPlanPlanConfigScaleOut.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
