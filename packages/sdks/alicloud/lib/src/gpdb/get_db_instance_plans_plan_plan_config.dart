...
class GetDbInstancePlansPlanPlanConfig {
  ...
  factory GetDbInstancePlansPlanPlanConfig.fromMap(Map<String, dynamic> map) {
    return GetDbInstancePlansPlanPlanConfig(
      pauses: (pulumi.Input.decodeList<GetDbInstancePlansPlanPlanConfigPause>(map['pauses'], (value) => GetDbInstancePlansPlanPlanConfigPause.fromMap((value as Map).cast<String, dynamic>()))).input(),
      resumes: (pulumi.Input.decodeList<GetDbInstancePlansPlanPlanConfigResume>(map['resumes'], (value) => GetDbInstancePlansPlanPlanConfigResume.fromMap((value as Map).cast<String, dynamic>()))).input(),
      scaleIns: (pulumi.Input.decodeList<GetDbInstancePlansPlanPlanConfigScaleIn>(map['scaleIns'], (value) => GetDbInstancePlansPlanPlanConfigScaleIn.fromMap((value as Map).cast<String, dynamic>()))).input(),
      scaleOuts: (pulumi.Input.decodeList<GetDbInstancePlansPlanPlanConfigScaleOut>(map['scaleOuts'], (value) => GetDbInstancePlansPlanPlanConfigScaleOut.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
