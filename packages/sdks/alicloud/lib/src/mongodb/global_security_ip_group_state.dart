...
class GlobalSecurityIpGroupState {
  ...
  factory GlobalSecurityIpGroupState.fromMap(Map<String, dynamic> map) {
    return GlobalSecurityIpGroupState(
      globalIgName: (() { final guardedValue = map['globalIgName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      globalSecurityIpList: (() { final guardedValue = map['globalSecurityIpList']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
