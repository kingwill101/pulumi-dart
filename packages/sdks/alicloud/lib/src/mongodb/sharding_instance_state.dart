...
class ShardingInstanceState {
  ...
  factory ShardingInstanceState.fromMap(Map<String, dynamic> map) {
    return ShardingInstanceState(
      ...
      configServerLists: (() { final guardedValue = map['configServerLists']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ShardingInstanceConfigServerList>(guardedValue, (value) => ShardingInstanceConfigServerList.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      mongoLists: (() { final guardedValue = map['mongoLists']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ShardingInstanceMongoList>(guardedValue, (value) => ShardingInstanceMongoList.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      parameters: (() { final guardedValue = map['parameters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ShardingInstanceParameter>(guardedValue, (value) => ShardingInstanceParameter.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      shardLists: (() { final guardedValue = map['shardLists']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ShardingInstanceShardList>(guardedValue, (value) => ShardingInstanceShardList.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      zoneInfos: (() { final guardedValue = map['zoneInfos']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ShardingInstanceZoneInfo>(guardedValue, (value) => ShardingInstanceZoneInfo.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
