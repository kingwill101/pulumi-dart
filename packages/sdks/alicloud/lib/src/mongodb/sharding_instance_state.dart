...
class ShardingInstanceState {
  ...
  factory ShardingInstanceState.fromMap(Map<String, dynamic> map) {
    return ShardingInstanceState(
      ...
      configServerLists: map['configServerLists'] == null ? null : (pulumi.Input.decodeList<ShardingInstanceConfigServerList>(map['configServerLists'], (value) => ShardingInstanceConfigServerList.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      mongoLists: map['mongoLists'] == null ? null : (pulumi.Input.decodeList<ShardingInstanceMongoList>(map['mongoLists'], (value) => ShardingInstanceMongoList.fromMap((value as Map).cast<String, dynamic>()))).input(),
      name: map['name'] == null ? null : (map['name'] as String).input(),
      networkType: map['networkType'] == null ? null : (map['networkType'] as String).input(),
      orderType: map['orderType'] == null ? null : (map['orderType'] as String).input(),
      parameters: map['parameters'] == null ? null : (pulumi.Input.decodeList<ShardingInstanceParameter>(map['parameters'], (value) => ShardingInstanceParameter.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      shardLists: map['shardLists'] == null ? null : (pulumi.Input.decodeList<ShardingInstanceShardList>(map['shardLists'], (value) => ShardingInstanceShardList.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      zoneInfos: map['zoneInfos'] == null ? null : (pulumi.Input.decodeList<ShardingInstanceZoneInfo>(map['zoneInfos'], (value) => ShardingInstanceZoneInfo.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
