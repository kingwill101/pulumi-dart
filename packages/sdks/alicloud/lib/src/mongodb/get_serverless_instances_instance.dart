...
class GetServerlessInstancesInstance {
  ...
  factory GetServerlessInstancesInstance.fromMap(Map<String, dynamic> map) {
    return GetServerlessInstancesInstance(
      ...
      dbInstanceReleaseProtection: pulumi.Input.fromValue(map['dbInstanceReleaseProtection'] as bool),
      dbInstanceStorage: pulumi.Input.fromValue(map['dbInstanceStorage'] as int),
      ...
      securityIpGroups: pulumi.Input.fromValue(pulumi.Input.decodeList<GetServerlessInstancesInstanceSecurityIpGroup>(map['securityIpGroups']!, (value) => GetServerlessInstancesInstanceSecurityIpGroup.fromMap((value as Map).cast<String, dynamic>()))),
