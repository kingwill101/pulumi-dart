...
import 'sharding_instance_state.dart';
...
class ShardingInstance extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<Map<String, dynamic>>> configServerLists;
  ...
  late final pulumi.Output<List<Map<String, dynamic>>> mongoLists;
  ...
  late final pulumi.Output<List<Map<String, dynamic>>> shardLists;
  ...
  ShardingInstance(
    ...
    configServerLists = registerOutput<List<Map<String, dynamic>>>('configServerLists');
    ...
    mongoLists = registerOutput<List<Map<String, dynamic>>>('mongoLists');
    ...
    shardLists = registerOutput<List<Map<String, dynamic>>>('shardLists');
    snapshotBackupType = registerOutput<String>('snapshotBackupType');
    ...
    zoneInfos = registerOutput<List<Map<String, dynamic>>>('zoneInfos');
  }

  /// Gets an existing [ShardingInstance] resource's state with the given [name] and [id].
  static ShardingInstance get(
    String name,
    pulumi.Input<String> id, {
    ShardingInstanceState? state,
  }) {
    return ShardingInstance._get(
      name,
      state: state?.toMap(),
