...
class InstanceState {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'zoneInfos':
          ?pulumi.Input.mapOptionalInputValue<
            List<InstanceZoneInfo>,
            List<Map<String, dynamic>>
          >(
            zoneInfos,
            (value) =>
                pulumi.Input.encodeList<InstanceZoneInfo, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory InstanceState.fromMap(Map<String, dynamic> map) {
    return InstanceState(
      ...
      replicaSetName: (() {
        final guardedValue = map['replicaSetName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      replicaSets: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InstanceReplicaSet>(
            guardedValue,
            (value) => InstanceReplicaSet.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      zoneInfos: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InstanceZoneInfo>(
            guardedValue,
            (value) => InstanceZoneInfo.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
