...
class InstanceState {
  ...
  InstanceState({
    ...
    pulumi.Output<String>? replicaSetName,
    pulumi.Output<List<InstanceReplicaSet>>? replicaSets,
    ...
    pulumi.Output<List<InstanceZoneInfo>>? zoneInfos,
  }) :
      ...
      replicaSetName = pulumi.Input.asOptionalInput<String>(replicaSetName),
      replicaSets = pulumi.Input.asOptionalInput<List<InstanceReplicaSet>>(replicaSets),
      ...
      zoneInfos = pulumi.Input.asOptionalInput<List<InstanceZoneInfo>>(zoneInfos);
  ...
  factory InstanceState.fromMap(Map<String, dynamic> map) {
    return InstanceState(
      ...
      replicaSetName: map['replicaSetName'] == null ? null : pulumi.Output.create<String>(map['replicaSetName'] as String),
      replicaSets: map['replicaSets'] == null ? null : pulumi.Output.create<List<InstanceReplicaSet>>(pulumi.Input.decodeList<InstanceReplicaSet>(map['replicaSets'], (value) => InstanceReplicaSet.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      zoneInfos: map['zoneInfos'] == null ? null : pulumi.Output.create<List<InstanceZoneInfo>>(pulumi.Input.decodeList<InstanceZoneInfo>(map['zoneInfos'], (value) => InstanceZoneInfo.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
