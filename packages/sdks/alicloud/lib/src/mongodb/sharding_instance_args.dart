...
class ShardingInstanceArgs {
  ...
  ShardingInstanceArgs({
    ...
    required pulumi.Output<List<ShardingInstanceMongoList>> mongoLists,
    ...
    required pulumi.Output<List<ShardingInstanceShardList>> shardLists,
  ...
  factory ShardingInstanceArgs.fromMap(Map<String, dynamic> map) {
    return ShardingInstanceArgs(
      ...
      mongoLists: pulumi.Output.create<List<ShardingInstanceMongoList>>(pulumi.Input.decodeList<ShardingInstanceMongoList>(map['mongoLists'], (value) => ShardingInstanceMongoList.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      shardLists: pulumi.Output.create<List<ShardingInstanceShardList>>(pulumi.Input.decodeList<ShardingInstanceShardList>(map['shardLists'], (value) => ShardingInstanceShardList.fromMap((value as Map).cast<String, dynamic>()))),
