...
class PublicNetworkAddressState {
  ...
  factory PublicNetworkAddressState.fromMap(Map<String, dynamic> map) {
    return PublicNetworkAddressState(
      ...
      replicaSets: (() { final guardedValue = map['replicaSets']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PublicNetworkAddressReplicaSet>(guardedValue, (value) => PublicNetworkAddressReplicaSet.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
