...
import 'serverless_instance_state.dart';
...
class ServerlessInstance extends pulumi.CustomResource {
  ...
  /// Gets an existing [ServerlessInstance] resource's state with the given [name] and [id].
  static ServerlessInstance get(
    String name,
    pulumi.Input<String> id, {
    ServerlessInstanceState? state,
  }) {
    return ServerlessInstance._get(
      name,
      state: state?.toMap(),
