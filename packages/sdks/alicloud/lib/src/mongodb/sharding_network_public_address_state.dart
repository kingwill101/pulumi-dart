...
class ShardingNetworkPublicAddressState {
  ...
  factory ShardingNetworkPublicAddressState.fromMap(Map<String, dynamic> map) {
    return ShardingNetworkPublicAddressState(
      ...
      networkAddresses: (() { final guardedValue = map['networkAddresses']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ShardingNetworkPublicAddressNetworkAddress>(guardedValue, (value) => ShardingNetworkPublicAddressNetworkAddress.fromMap((value as Map).cast<String, dynamic>()))); })(),
