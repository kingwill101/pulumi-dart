...
class ShardingNetworkPrivateAddressState {
  ...
  factory ShardingNetworkPrivateAddressState.fromMap(Map<String, dynamic> map) {
    return ShardingNetworkPrivateAddressState(
      ...
      networkAddresses: (() { final guardedValue = map['networkAddresses']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ShardingNetworkPrivateAddressNetworkAddress>(guardedValue, (value) => ShardingNetworkPrivateAddressNetworkAddress.fromMap((value as Map).cast<String, dynamic>()))); })(),
