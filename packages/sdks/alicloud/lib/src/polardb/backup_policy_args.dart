...
class BackupPolicyArgs {
  ...
  factory BackupPolicyArgs.fromMap(Map<String, dynamic> map) {
    return BackupPolicyArgs(
      backupFrequency: (() { final guardedValue = map['backupFrequency']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      dataLevel1BackupFrequency: (() { final guardedValue = map['dataLevel1BackupFrequency']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      dataLevel1BackupPeriods: (() { final guardedValue = map['dataLevel1BackupPeriods']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      dataLevel1BackupRetentionPeriod: (() { final guardedValue = map['dataLevel1BackupRetentionPeriod']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      dataLevel1BackupTime: (() { final guardedValue = map['dataLevel1BackupTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      dataLevel2BackupAnotherRegionRegion: (() { final guardedValue = map['dataLevel2BackupAnotherRegionRegion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      dataLevel2BackupAnotherRegionRetentionPeriod: (() { final guardedValue = map['dataLevel2BackupAnotherRegionRetentionPeriod']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      dataLevel2BackupPeriods: (() { final guardedValue = map['dataLevel2BackupPeriods']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      dataLevel2BackupRetentionPeriod: (() { final guardedValue = map['dataLevel2BackupRetentionPeriod']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      dbClusterId: pulumi.Input.fromValue(map['dbClusterId'] as String),
      logBackupAnotherRegionRegion: (() { final guardedValue = map['logBackupAnotherRegionRegion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      logBackupAnotherRegionRetentionPeriod: (() { final guardedValue = map['logBackupAnotherRegionRetentionPeriod']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
