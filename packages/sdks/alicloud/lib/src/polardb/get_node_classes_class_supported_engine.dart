...
class GetNodeClassesClassSupportedEngine {
  ...
  final pulumi.Input<List<GetNodeClassesClassSupportedEngineAvailableResource>>
  availableResources;
    ...
    return <String, dynamic>{
      'availableResources':
          pulumi.Input.mapInputValue<
            List<GetNodeClassesClassSupportedEngineAvailableResource>,
  ...
  factory GetNodeClassesClassSupportedEngine.fromMap(Map<String, dynamic> map) {
    return GetNodeClassesClassSupportedEngine(
      availableResources: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetNodeClassesClassSupportedEngineAvailableResource
        >(
          map['availableResources']!,
          (value) =>
              GetNodeClassesClassSupportedEngineAvailableResource.fromMap(
