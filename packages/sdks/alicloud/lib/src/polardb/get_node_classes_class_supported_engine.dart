...
class GetNodeClassesClassSupportedEngine {
  ...
  factory GetNodeClassesClassSupportedEngine.fromMap(Map<String, dynamic> map) {
    return GetNodeClassesClassSupportedEngine(
      availableResources: pulumi.Input.fromValue(pulumi.Input.decodeList<GetNodeClassesClassSupportedEngineAvailableResource>(map['availableResources']!, (value) => GetNodeClassesClassSupportedEngineAvailableResource.fromMap((value as Map).cast<String, dynamic>()))),
