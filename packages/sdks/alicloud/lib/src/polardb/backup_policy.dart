...
class BackupPolicy extends pulumi.CustomResource {
  ...
  BackupPolicy(
    ...
    this.backupFrequency = registerOutput<String>('backupFrequency');
    ...
    this.dataLevel1BackupFrequency = registerOutput<String>('dataLevel1BackupFrequency');
    this.dataLevel1BackupPeriods = registerOutput<List<String>>('dataLevel1BackupPeriods');
    this.dataLevel1BackupRetentionPeriod = registerOutput<int>('dataLevel1BackupRetentionPeriod');
    this.dataLevel1BackupTime = registerOutput<String>('dataLevel1BackupTime');
    this.dataLevel2BackupAnotherRegionRegion = registerOutput<String?>('dataLevel2BackupAnotherRegionRegion');
    this.dataLevel2BackupAnotherRegionRetentionPeriod = registerOutput<int>('dataLevel2BackupAnotherRegionRetentionPeriod');
    this.dataLevel2BackupPeriods = registerOutput<List<String>?>('dataLevel2BackupPeriods');
    this.dataLevel2BackupRetentionPeriod = registerOutput<int>('dataLevel2BackupRetentionPeriod');
    this.dbClusterId = registerOutput<String>('dbClusterId');
    this.enableBackupLog = registerOutput<int>('enableBackupLog');
    this.logBackupAnotherRegionRegion = registerOutput<String?>('logBackupAnotherRegionRegion');
    this.logBackupAnotherRegionRetentionPeriod = registerOutput<int?>('logBackupAnotherRegionRetentionPeriod');
