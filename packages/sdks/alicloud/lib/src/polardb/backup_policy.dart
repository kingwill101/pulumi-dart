...
class BackupPolicy extends pulumi.CustomResource {
  ...
  BackupPolicy(
    ...
    dataLevel1BackupFrequency = registerOutput<String>('dataLevel1BackupFrequency');
    dataLevel1BackupPeriods = registerOutput<List<String>>('dataLevel1BackupPeriods');
    dataLevel1BackupRetentionPeriod = registerOutput<int>('dataLevel1BackupRetentionPeriod');
    dataLevel1BackupTime = registerOutput<String>('dataLevel1BackupTime');
    dataLevel2BackupAnotherRegionRegion = registerOutput<String?>('dataLevel2BackupAnotherRegionRegion');
    dataLevel2BackupAnotherRegionRetentionPeriod = registerOutput<int>('dataLevel2BackupAnotherRegionRetentionPeriod');
    dataLevel2BackupPeriods = registerOutput<List<String>?>('dataLevel2BackupPeriods');
    dataLevel2BackupRetentionPeriod = registerOutput<int>('dataLevel2BackupRetentionPeriod');
    dbClusterId = registerOutput<String>('dbClusterId');
    enableBackupLog = registerOutput<int>('enableBackupLog');
    logBackupAnotherRegionRegion = registerOutput<String?>('logBackupAnotherRegionRegion');
    logBackupAnotherRegionRetentionPeriod = registerOutput<int?>('logBackupAnotherRegionRetentionPeriod');
