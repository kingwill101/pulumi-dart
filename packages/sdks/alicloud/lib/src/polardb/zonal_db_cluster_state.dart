  ...
  factory ZonalDbClusterState.fromMap(Map<String, dynamic> map) {
    return ZonalDbClusterState(
      ...
      clusterLatestVersion: (() {
        final guardedValue = map['clusterLatestVersion'];
        if (guardedValue == null) return null;
      ...
      dbClusterNodesAttributes: (() {
        final guardedValue = map['dbClusterNodesAttributes'];
        if (guardedValue == null) return null;
      ...
      dbClusterNodesConfigs: (() {
        final guardedValue = map['dbClusterNodesConfigs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as Map).cast<String, String>(),
        );
      ...
      dbClusterNodesIds: (() {
        final guardedValue = map['dbClusterNodesIds'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as Map).cast<String, String>(),
        );
