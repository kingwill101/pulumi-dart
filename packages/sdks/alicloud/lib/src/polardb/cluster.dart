...
class Cluster extends pulumi.CustomResource {
  ...
  Cluster(
    ...
    dbClusterIpArrays = registerOutput<List<Map<String, dynamic>>>(
      'dbClusterIpArrays',
    );
    ...
    dbRevisionVersionLists = registerOutput<List<Map<String, dynamic>>>(
      'dbRevisionVersionLists',
    );
    ...
    serverlessRuleCpuEnlargeThreshold = registerOutput<int>(
      'serverlessRuleCpuEnlargeThreshold',
    );
    serverlessRuleCpuShrinkThreshold = registerOutput<int>(
    ...
    targetDbRevisionVersionCode = registerOutput<String?>(
