...
class GetEndpointsEndpoint {
  ...
  factory GetEndpointsEndpoint.fromMap(Map<String, dynamic> map) {
    return GetEndpointsEndpoint(
      addressItems: pulumi.Input.fromValue(pulumi.Input.decodeList<GetEndpointsEndpointAddressItem>(map['addressItems']!, (value) => GetEndpointsEndpointAddressItem.fromMap((value as Map).cast<String, dynamic>()))),
