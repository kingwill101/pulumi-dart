...
class GetGlobalDatabaseNetworksNetwork {
  ...
  final pulumi.Input<List<GetGlobalDatabaseNetworksNetworkDbCluster>>
  dbClusters;
    ...
    return <String, dynamic>{
      ...
      'dbClusters':
          pulumi.Input.mapInputValue<
            List<GetGlobalDatabaseNetworksNetworkDbCluster>,
  ...
  factory GetGlobalDatabaseNetworksNetwork.fromMap(Map<String, dynamic> map) {
    return GetGlobalDatabaseNetworksNetwork(
      ...
      dbClusters: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetGlobalDatabaseNetworksNetworkDbCluster>(
          map['dbClusters']!,
          (value) => GetGlobalDatabaseNetworksNetworkDbCluster.fromMap(
