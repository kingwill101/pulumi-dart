...
class ClusterState {
  ...
  factory ClusterState.fromMap(Map<String, dynamic> map) {
    return ClusterState(
      allowShutDown: map['allowShutDown'] == null ? null : (map['allowShutDown']! as String).input(),
      ...
      cloneDataPoint: map['cloneDataPoint'] == null ? null : (map['cloneDataPoint']! as String).input(),
      collectorStatus: map['collectorStatus'] == null ? null : (map['collectorStatus']! as String).input(),
      compressStorage: map['compressStorage'] == null ? null : (map['compressStorage']! as String).input(),
      connectionString: map['connectionString'] == null ? null : (map['connectionString']! as String).input(),
      createTime: map['createTime'] == null ? null : (map['createTime']! as String).input(),
      creationCategory: map['creationCategory'] == null ? null : (map['creationCategory']! as String).input(),
      creationOption: map['creationOption'] == null ? null : (map['creationOption']! as String).input(),
      dbClusterIpArrays: map['dbClusterIpArrays'] == null ? null : (pulumi.Input.decodeList<ClusterDbClusterIpArray>(map['dbClusterIpArrays']!, (value) => ClusterDbClusterIpArray.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      dbNodeId: map['dbNodeId'] == null ? null : (map['dbNodeId']! as String).input(),
      dbNodeNum: map['dbNodeNum'] == null ? null : (map['dbNodeNum']! as int).input(),
      dbRevisionVersionLists: map['dbRevisionVersionLists'] == null ? null : (pulumi.Input.decodeList<ClusterDbRevisionVersionList>(map['dbRevisionVersionLists']!, (value) => ClusterDbRevisionVersionList.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      deletionLock: map['deletionLock'] == null ? null : (map['deletionLock']! as int).input(),
      description: map['description'] == null ? null : (map['description']! as String).input(),
      encryptNewTables: map['encryptNewTables'] == null ? null : (map['encryptNewTables']! as String).input(),
      encryptionKey: map['encryptionKey'] == null ? null : (map['encryptionKey']! as String).input(),
      fromTimeService: map['fromTimeService'] == null ? null : (map['fromTimeService']! as String).input(),
      ...
      hotReplicaMode: map['hotReplicaMode'] == null ? null : (map['hotReplicaMode']! as String).input(),
      hotStandbyCluster: map['hotStandbyCluster'] == null ? null : (map['hotStandbyCluster']! as String).input(),
      imciSwitch: map['imciSwitch'] == null ? null : (map['imciSwitch']! as String).input(),
      loosePolarLogBin: map['loosePolarLogBin'] == null ? null : (map['loosePolarLogBin']! as String).input(),
      looseXengine: map['looseXengine'] == null ? null : (map['looseXengine']! as String).input(),
      looseXengineUseMemoryPct: map['looseXengineUseMemoryPct'] == null ? null : (map['looseXengineUseMemoryPct']! as int).input(),
      lowerCaseTableNames: map['lowerCaseTableNames'] == null ? null : (map['lowerCaseTableNames']! as int).input(),
      ...
      parameterGroupId: map['parameterGroupId'] == null ? null : (map['parameterGroupId']! as String).input(),
      parameters: map['parameters'] == null ? null : (pulumi.Input.decodeList<ClusterParameter>(map['parameters']!, (value) => ClusterParameter.fromMap((value as Map).cast<String, dynamic>()))).input(),
      payType: map['payType'] == null ? null : (map['payType']! as String).input(),
      period: map['period'] == null ? null : (map['period']! as int).input(),
      plannedEndTime: map['plannedEndTime'] == null ? null : (map['plannedEndTime']! as String).input(),
      plannedStartTime: map['plannedStartTime'] == null ? null : (map['plannedStartTime']! as String).input(),
      port: map['port'] == null ? null : (map['port']! as String).input(),
      provisionedIops: map['provisionedIops'] == null ? null : (map['provisionedIops']! as String).input(),
      proxyClass: map['proxyClass'] == null ? null : (map['proxyClass']! as String).input(),
      ...
      scaleApRoNumMax: map['scaleApRoNumMax'] == null ? null : (map['scaleApRoNumMax']! as int).input(),
      scaleApRoNumMin: map['scaleApRoNumMin'] == null ? null : (map['scaleApRoNumMin']! as int).input(),
      scaleMax: map['scaleMax'] == null ? null : (map['scaleMax']! as int).input(),
      scaleMin: map['scaleMin'] == null ? null : (map['scaleMin']! as int).input(),
      scaleRoNumMax: map['scaleRoNumMax'] == null ? null : (map['scaleRoNumMax']! as int).input(),
      scaleRoNumMin: map['scaleRoNumMin'] == null ? null : (map['scaleRoNumMin']! as int).input(),
      ...
      serverlessRuleCpuEnlargeThreshold: map['serverlessRuleCpuEnlargeThreshold'] == null ? null : (map['serverlessRuleCpuEnlargeThreshold']! as int).input(),
      serverlessRuleCpuShrinkThreshold: map['serverlessRuleCpuShrinkThreshold'] == null ? null : (map['serverlessRuleCpuShrinkThreshold']! as int).input(),
      serverlessRuleMode: map['serverlessRuleMode'] == null ? null : (map['serverlessRuleMode']! as String).input(),
      serverlessSteadySwitch: map['serverlessSteadySwitch'] == null ? null : (map['serverlessSteadySwitch']! as String).input(),
      serverlessType: map['serverlessType'] == null ? null : (map['serverlessType']! as String).input(),
      sourceResourceId: map['sourceResourceId'] == null ? null : (map['sourceResourceId']! as String).input(),
      standbyAz: map['standbyAz'] == null ? null : (map['standbyAz']! as String).input(),
      ...
      strictConsistency: map['strictConsistency'] == null ? null : (map['strictConsistency']! as String).input(),
      subCategory: map['subCategory'] == null ? null : (map['subCategory']! as String).input(),
      tags: map['tags'] == null ? null : ((map['tags']! as Map).cast<String, String>()).input(),
      targetDbRevisionVersionCode: map['targetDbRevisionVersionCode'] == null ? null : (map['targetDbRevisionVersionCode']! as String).input(),
      tdeRegion: map['tdeRegion'] == null ? null : (map['tdeRegion']! as String).input(),
      tdeStatus: map['tdeStatus'] == null ? null : (map['tdeStatus']! as String).input(),
      upgradeType: map['upgradeType'] == null ? null : (map['upgradeType']! as String).input(),
