...
class ClusterState {
  ...
  factory ClusterState.fromMap(Map<String, dynamic> map) {
    return ClusterState(
      ...
      dbRevisionVersionLists: (() { final guardedValue = map['dbRevisionVersionLists']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ClusterDbRevisionVersionList>(guardedValue, (value) => ClusterDbRevisionVersionList.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      tdeRegion: (() { final guardedValue = map['tdeRegion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
