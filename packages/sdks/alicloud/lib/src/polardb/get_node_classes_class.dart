...
class GetNodeClassesClass {
  ...
  factory GetNodeClassesClass.fromMap(Map<String, dynamic> map) {
    return GetNodeClassesClass(
      supportedEngines: (pulumi.Input.decodeList<GetNodeClassesClassSupportedEngine>(map['supportedEngines'], (value) => GetNodeClassesClassSupportedEngine.fromMap((value as Map).cast<String, dynamic>()))).input(),
