...
class GetNodeClassesClass {
  ...
  GetNodeClassesClass({required this.supportedEngines, required this.zoneId});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'supportedEngines':
          pulumi.Input.mapInputValue<
            List<GetNodeClassesClassSupportedEngine>,
  ...
  factory GetNodeClassesClass.fromMap(Map<String, dynamic> map) {
    return GetNodeClassesClass(
      supportedEngines: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetNodeClassesClassSupportedEngine>(
          map['supportedEngines']!,
          (value) => GetNodeClassesClassSupportedEngine.fromMap(
