...
class AutoSnapShotPolicyState {
  ...
  factory AutoSnapShotPolicyState.fromMap(Map<String, dynamic> map) {
    return AutoSnapShotPolicyState(
      appliedDbfsNumber: (() { final guardedValue = map['appliedDbfsNumber']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      statusDetail: (() { final guardedValue = map['statusDetail']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
