...
class GetInstancesInstance {
  ...
  factory GetInstancesInstance.fromMap(Map<String, dynamic> map) {
    return GetInstancesInstance(
      ...
      ecsLists: pulumi.Input.fromValue(pulumi.Input.decodeList<GetInstancesInstanceEcsList>(map['ecsLists']!, (value) => GetInstancesInstanceEcsList.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      raidStripeUnitNumber: pulumi.Input.fromValue(map['raidStripeUnitNumber'] as String),
