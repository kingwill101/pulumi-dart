...
class InstanceState {
    ...
    return <String, dynamic>{
      ...
      'ecsLists':
          ?pulumi.Input.mapOptionalInputValue<
            List<InstanceEcsList>,
            List<Map<String, dynamic>>
          >(
            ecsLists,
            (value) =>
                pulumi.Input.encodeList<InstanceEcsList, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory InstanceState.fromMap(Map<String, dynamic> map) {
    return InstanceState(
      ...
      deleteSnapshot: (() {
        final guardedValue = map['deleteSnapshot'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      ecsLists: (() {
        final guardedValue = map['ecsLists'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InstanceEcsList>(
            guardedValue,
            (value) =>
                InstanceEcsList.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      enableRaid: (() {
        final guardedValue = map['enableRaid'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      encryption: (() {
      ...
      raidStripeUnitNumber: (() {
        final guardedValue = map['raidStripeUnitNumber'];
        if (guardedValue == null) return null;
      ...
      usedScene: (() {
        final guardedValue = map['usedScene'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      zoneId: (() {
