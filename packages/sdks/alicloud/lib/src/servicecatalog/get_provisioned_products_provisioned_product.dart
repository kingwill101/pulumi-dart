...
class GetProvisionedProductsProvisionedProduct {
  ...
  final pulumi.Input<List<GetProvisionedProductsProvisionedProductOutput>>
  outputs;
  ...
  final pulumi.Input<List<GetProvisionedProductsProvisionedProductParameter>>
  parameters;
    ...
    return <String, dynamic>{
      ...
      'outputs':
          pulumi.Input.mapInputValue<
            List<GetProvisionedProductsProvisionedProductOutput>,
      ...
      'parameters':
          pulumi.Input.mapInputValue<
            List<GetProvisionedProductsProvisionedProductParameter>,
            List<Map<String, dynamic>>
          >(
            parameters,
            (value) =>
  ...
  factory GetProvisionedProductsProvisionedProduct.fromMap(
    ...
    return GetProvisionedProductsProvisionedProduct(
      ...
      outputs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetProvisionedProductsProvisionedProductOutput>(
          map['outputs']!,
          (value) => GetProvisionedProductsProvisionedProductOutput.fromMap(
      ...
      parameters: pulumi.Input.fromValue(
        ...
        >(
          map['parameters']!,
          (value) => GetProvisionedProductsProvisionedProductParameter.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
