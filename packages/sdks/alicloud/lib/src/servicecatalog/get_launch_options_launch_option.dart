...
class GetLaunchOptionsLaunchOption {
  /// List of constraints.
  final pulumi.Input<List<GetLaunchOptionsLaunchOptionConstraintSummary>>
  constraintSummaries;
    ...
    return <String, dynamic>{
      'constraintSummaries':
          pulumi.Input.mapInputValue<
            List<GetLaunchOptionsLaunchOptionConstraintSummary>,
  ...
  factory GetLaunchOptionsLaunchOption.fromMap(Map<String, dynamic> map) {
    return GetLaunchOptionsLaunchOption(
      constraintSummaries: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetLaunchOptionsLaunchOptionConstraintSummary>(
          map['constraintSummaries']!,
          (value) => GetLaunchOptionsLaunchOptionConstraintSummary.fromMap(
