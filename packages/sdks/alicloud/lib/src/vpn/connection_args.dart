...
class ConnectionArgs {
  ...
  ConnectionArgs({
    ...
    required pulumi.Output<List<String>> localSubnets,
    pulumi.Output<String>? name,
    pulumi.Output<String>? networkType,
    required pulumi.Output<List<String>> remoteSubnets,
  ...
  factory ConnectionArgs.fromMap(Map<String, dynamic> map) {
    return ConnectionArgs(
      ...
      localSubnets: pulumi.Output.create<List<String>>((map['localSubnets'] as List).cast<String>()),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      networkType: map['networkType'] == null ? null : pulumi.Output.create<String>(map['networkType'] as String),
      remoteSubnets: pulumi.Output.create<List<String>>((map['remoteSubnets'] as List).cast<String>()),
