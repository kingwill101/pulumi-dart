...
class GatewayVpnAttachmentTunnelOptionsSpecification {
  ...
  factory GatewayVpnAttachmentTunnelOptionsSpecification.fromMap(
    ...
    return GatewayVpnAttachmentTunnelOptionsSpecification(
      ...
      tunnelBgpConfig: (() {
        ...
        return pulumi.Input.fromValue(
          GatewayVpnAttachmentTunnelOptionsSpecificationTunnelBgpConfig.fromMap(
      ...
      tunnelIkeConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GatewayVpnAttachmentTunnelOptionsSpecificationTunnelIkeConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      tunnelIpsecConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GatewayVpnAttachmentTunnelOptionsSpecificationTunnelIpsecConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
