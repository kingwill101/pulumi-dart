...
class GatewayVpnAttachmentState {
  ...
  GatewayVpnAttachmentState({
    pulumi.Output<GatewayVpnAttachmentBgpConfig>? bgpConfig,
    ...
    pulumi.Output<GatewayVpnAttachmentHealthCheckConfig>? healthCheckConfig,
    pulumi.Output<GatewayVpnAttachmentIkeConfig>? ikeConfig,
    pulumi.Output<GatewayVpnAttachmentIpsecConfig>? ipsecConfig,
    pulumi.Output<String>? localSubnet,
    pulumi.Output<String>? networkType,
    pulumi.Output<String>? remoteSubnet,
    pulumi.Output<String>? resourceGroupId,
    pulumi.Output<String>? status,
    pulumi.Output<Map<String, String>>? tags,
    pulumi.Output<List<GatewayVpnAttachmentTunnelOptionsSpecification>>? tunnelOptionsSpecifications,
    pulumi.Output<String>? vpnAttachmentName,
  }) :
      ...
      remoteSubnet = pulumi.Input.asOptionalInput<String>(remoteSubnet),
  ...
  factory GatewayVpnAttachmentState.fromMap(Map<String, dynamic> map) {
    return GatewayVpnAttachmentState(
      bgpConfig: map['bgpConfig'] == null ? null : pulumi.Output.create<GatewayVpnAttachmentBgpConfig>(GatewayVpnAttachmentBgpConfig.fromMap((map['bgpConfig'] as Map).cast<String, dynamic>())),
      ...
      healthCheckConfig: map['healthCheckConfig'] == null ? null : pulumi.Output.create<GatewayVpnAttachmentHealthCheckConfig>(GatewayVpnAttachmentHealthCheckConfig.fromMap((map['healthCheckConfig'] as Map).cast<String, dynamic>())),
      ikeConfig: map['ikeConfig'] == null ? null : pulumi.Output.create<GatewayVpnAttachmentIkeConfig>(GatewayVpnAttachmentIkeConfig.fromMap((map['ikeConfig'] as Map).cast<String, dynamic>())),
      ipsecConfig: map['ipsecConfig'] == null ? null : pulumi.Output.create<GatewayVpnAttachmentIpsecConfig>(GatewayVpnAttachmentIpsecConfig.fromMap((map['ipsecConfig'] as Map).cast<String, dynamic>())),
      ...
      remoteSubnet: map['remoteSubnet'] == null ? null : pulumi.Output.create<String>(map['remoteSubnet'] as String),
      resourceGroupId: map['resourceGroupId'] == null ? null : pulumi.Output.create<String>(map['resourceGroupId'] as String),
      status: map['status'] == null ? null : pulumi.Output.create<String>(map['status'] as String),
      tags: map['tags'] == null ? null : pulumi.Output.create<Map<String, String>>((map['tags'] as Map).cast<String, String>()),
      tunnelOptionsSpecifications: map['tunnelOptionsSpecifications'] == null ? null : pulumi.Output.create<List<GatewayVpnAttachmentTunnelOptionsSpecification>>(pulumi.Input.decodeList<GatewayVpnAttachmentTunnelOptionsSpecification>(map['tunnelOptionsSpecifications'], (value) => GatewayVpnAttachmentTunnelOptionsSpecification.fromMap((value as Map).cast<String, dynamic>()))),
      vpnAttachmentName: map['vpnAttachmentName'] == null ? null : pulumi.Output.create<String>(map['vpnAttachmentName'] as String),
    );
  }
}
