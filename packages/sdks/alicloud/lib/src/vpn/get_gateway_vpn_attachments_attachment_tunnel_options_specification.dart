...
class GetGatewayVpnAttachmentsAttachmentTunnelOptionsSpecification {
  ...
  factory GetGatewayVpnAttachmentsAttachmentTunnelOptionsSpecification.fromMap(
    ...
    return GetGatewayVpnAttachmentsAttachmentTunnelOptionsSpecification(
      ...
      tunnelBgpConfig: pulumi.Input.fromValue(
        GetGatewayVpnAttachmentsAttachmentTunnelOptionsSpecificationTunnelBgpConfig.fromMap(
      ...
      tunnelIkeConfig: pulumi.Input.fromValue(
        GetGatewayVpnAttachmentsAttachmentTunnelOptionsSpecificationTunnelIkeConfig.fromMap(
      ...
      tunnelIpsecConfig: pulumi.Input.fromValue(
        GetGatewayVpnAttachmentsAttachmentTunnelOptionsSpecificationTunnelIpsecConfig.fromMap(
