...
class GetGatewayVpnAttachmentsAttachment {
  ...
  final pulumi.Input<List<GetGatewayVpnAttachmentsAttachmentBgpConfig>>
  bgpConfigs;
  ...
  final pulumi.Input<List<GetGatewayVpnAttachmentsAttachmentHealthCheckConfig>>
  healthCheckConfigs;
  ...
  final pulumi.Input<List<GetGatewayVpnAttachmentsAttachmentIkeConfig>>
  ikeConfigs;
  ...
  final pulumi.Input<List<GetGatewayVpnAttachmentsAttachmentIpsecConfig>>
  ipsecConfigs;
  ...
  final pulumi.Input<
    List<GetGatewayVpnAttachmentsAttachmentTunnelOptionsSpecification>
  >
    ...
    return <String, dynamic>{
      ...
      'bgpConfigs':
          pulumi.Input.mapInputValue<
            List<GetGatewayVpnAttachmentsAttachmentBgpConfig>,
      ...
      'ikeConfigs':
          pulumi.Input.mapInputValue<
            List<GetGatewayVpnAttachmentsAttachmentIkeConfig>,
            List<Map<String, dynamic>>
          >(
            ikeConfigs,
            (value) =>
      ...
      'ipsecConfigs':
          pulumi.Input.mapInputValue<
            List<GetGatewayVpnAttachmentsAttachmentIpsecConfig>,
            List<Map<String, dynamic>>
          >(
            ipsecConfigs,
            (value) =>
  ...
  factory GetGatewayVpnAttachmentsAttachment.fromMap(Map<String, dynamic> map) {
    return GetGatewayVpnAttachmentsAttachment(
      ...
      bgpConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetGatewayVpnAttachmentsAttachmentBgpConfig>(
          map['bgpConfigs']!,
          (value) => GetGatewayVpnAttachmentsAttachmentBgpConfig.fromMap(
      ...
      healthCheckConfigs: pulumi.Input.fromValue(
        ...
        >(
          ...
          (value) =>
              GetGatewayVpnAttachmentsAttachmentHealthCheckConfig.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
      ...
      ikeConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetGatewayVpnAttachmentsAttachmentIkeConfig>(
          map['ikeConfigs']!,
          (value) => GetGatewayVpnAttachmentsAttachmentIkeConfig.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      ...
      ipsecConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetGatewayVpnAttachmentsAttachmentIpsecConfig>(
          map['ipsecConfigs']!,
          (value) => GetGatewayVpnAttachmentsAttachmentIpsecConfig.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      ...
      tunnelOptionsSpecifications: pulumi.Input.fromValue(
        ...
        >(
          ...
          (value) =>
              GetGatewayVpnAttachmentsAttachmentTunnelOptionsSpecification.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
      vpnAttachmentName: pulumi.Input.fromValue(
        map['vpnAttachmentName'] as String,
      ),
