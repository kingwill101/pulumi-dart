...
class GetGatewayVpnAttachmentsAttachment {
  ...
  factory GetGatewayVpnAttachmentsAttachment.fromMap(Map<String, dynamic> map) {
    return GetGatewayVpnAttachmentsAttachment(
      attachType: pulumi.Input.fromValue(map['attachType'] as String),
      bgpConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetGatewayVpnAttachmentsAttachmentBgpConfig>(map['bgpConfigs']!, (value) => GetGatewayVpnAttachmentsAttachmentBgpConfig.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      healthCheckConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetGatewayVpnAttachmentsAttachmentHealthCheckConfig>(map['healthCheckConfigs']!, (value) => GetGatewayVpnAttachmentsAttachmentHealthCheckConfig.fromMap((value as Map).cast<String, dynamic>()))),
      id: pulumi.Input.fromValue(map['id'] as String),
      ikeConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetGatewayVpnAttachmentsAttachmentIkeConfig>(map['ikeConfigs']!, (value) => GetGatewayVpnAttachmentsAttachmentIkeConfig.fromMap((value as Map).cast<String, dynamic>()))),
      internetIp: pulumi.Input.fromValue(map['internetIp'] as String),
      ipsecConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetGatewayVpnAttachmentsAttachmentIpsecConfig>(map['ipsecConfigs']!, (value) => GetGatewayVpnAttachmentsAttachmentIpsecConfig.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      tunnelOptionsSpecifications: pulumi.Input.fromValue(pulumi.Input.decodeList<GetGatewayVpnAttachmentsAttachmentTunnelOptionsSpecification>(map['tunnelOptionsSpecifications']!, (value) => GetGatewayVpnAttachmentsAttachmentTunnelOptionsSpecification.fromMap((value as Map).cast<String, dynamic>()))),
      vpnAttachmentName: pulumi.Input.fromValue(map['vpnAttachmentName'] as String),
