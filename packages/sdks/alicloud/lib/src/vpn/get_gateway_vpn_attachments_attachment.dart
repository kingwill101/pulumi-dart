...
class GetGatewayVpnAttachmentsAttachment {
  ...
  final List<GetGatewayVpnAttachmentsAttachmentBgpConfig> bgpConfigs;
  ...
  final List<GetGatewayVpnAttachmentsAttachmentHealthCheckConfig> healthCheckConfigs;
  ...
  final List<GetGatewayVpnAttachmentsAttachmentIkeConfig> ikeConfigs;
  ...
  final List<GetGatewayVpnAttachmentsAttachmentIpsecConfig> ipsecConfigs;
  ...
  final List<GetGatewayVpnAttachmentsAttachmentTunnelOptionsSpecification> tunnelOptionsSpecifications;
  /// vpn attachment name
  final String vpnAttachmentName;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'bgpConfigs': pulumi.Input.encodeList<GetGatewayVpnAttachmentsAttachmentBgpConfig, Map<String, dynamic>>(bgpConfigs, (value) => value.toMap()),
      ...
      'healthCheckConfigs': pulumi.Input.encodeList<GetGatewayVpnAttachmentsAttachmentHealthCheckConfig, Map<String, dynamic>>(healthCheckConfigs, (value) => value.toMap()),
      'id': id,
      'ikeConfigs': pulumi.Input.encodeList<GetGatewayVpnAttachmentsAttachmentIkeConfig, Map<String, dynamic>>(ikeConfigs, (value) => value.toMap()),
      'internetIp': internetIp,
      'ipsecConfigs': pulumi.Input.encodeList<GetGatewayVpnAttachmentsAttachmentIpsecConfig, Map<String, dynamic>>(ipsecConfigs, (value) => value.toMap()),
      ...
      'status': status,
      'tags': tags,
      'tunnelOptionsSpecifications': pulumi.Input.encodeList<GetGatewayVpnAttachmentsAttachmentTunnelOptionsSpecification, Map<String, dynamic>>(tunnelOptionsSpecifications, (value) => value.toMap()),
  ...
  factory GetGatewayVpnAttachmentsAttachment.fromMap(Map<String, dynamic> map) {
    return GetGatewayVpnAttachmentsAttachment(
      attachType: map['attachType'] as String,
      bgpConfigs: pulumi.Input.decodeList<GetGatewayVpnAttachmentsAttachmentBgpConfig>(map['bgpConfigs'], (value) => GetGatewayVpnAttachmentsAttachmentBgpConfig.fromMap((value as Map).cast<String, dynamic>())),
      ...
      healthCheckConfigs: pulumi.Input.decodeList<GetGatewayVpnAttachmentsAttachmentHealthCheckConfig>(map['healthCheckConfigs'], (value) => GetGatewayVpnAttachmentsAttachmentHealthCheckConfig.fromMap((value as Map).cast<String, dynamic>())),
      id: map['id'] as String,
      ikeConfigs: pulumi.Input.decodeList<GetGatewayVpnAttachmentsAttachmentIkeConfig>(map['ikeConfigs'], (value) => GetGatewayVpnAttachmentsAttachmentIkeConfig.fromMap((value as Map).cast<String, dynamic>())),
      internetIp: map['internetIp'] as String,
      ipsecConfigs: pulumi.Input.decodeList<GetGatewayVpnAttachmentsAttachmentIpsecConfig>(map['ipsecConfigs'], (value) => GetGatewayVpnAttachmentsAttachmentIpsecConfig.fromMap((value as Map).cast<String, dynamic>())),
      ...
      tunnelOptionsSpecifications: pulumi.Input.decodeList<GetGatewayVpnAttachmentsAttachmentTunnelOptionsSpecification>(map['tunnelOptionsSpecifications'], (value) => GetGatewayVpnAttachmentsAttachmentTunnelOptionsSpecification.fromMap((value as Map).cast<String, dynamic>())),
      vpnAttachmentName: map['vpnAttachmentName'] as String,
