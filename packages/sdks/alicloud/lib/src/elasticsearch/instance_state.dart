...
class InstanceState {
  ...
  factory InstanceState.fromMap(Map<String, dynamic> map) {
    return InstanceState(
      archType: map['archType'] == null ? null : (map['archType'] as String).input(),
      ...
      kibanaDomain: map['kibanaDomain'] == null ? null : (map['kibanaDomain'] as String).input(),
      kibanaNodeSpec: map['kibanaNodeSpec'] == null ? null : (map['kibanaNodeSpec'] as String).input(),
      kibanaPort: map['kibanaPort'] == null ? null : (map['kibanaPort'] as int).input(),
      ...
      publicDomain: map['publicDomain'] == null ? null : (map['publicDomain'] as String).input(),
