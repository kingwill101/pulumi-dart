...
class ClusterBootstrapScript {
  ...
  factory ClusterBootstrapScript.fromMap(Map<String, dynamic> map) {
    return ClusterBootstrapScript(
      executionFailStrategy: pulumi.Input.fromValue(map['executionFailStrategy'] as String),
      executionMoment: pulumi.Input.fromValue(map['executionMoment'] as String),
      nodeSelector: pulumi.Input.fromValue(ClusterBootstrapScriptNodeSelector.fromMap((map['nodeSelector']! as Map).cast<String, dynamic>())),
