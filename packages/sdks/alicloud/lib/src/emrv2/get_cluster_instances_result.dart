...
class GetClusterInstancesResult {
  ...
  factory GetClusterInstancesResult.fromMap(Map<String, dynamic> map) {
    return GetClusterInstancesResult(
      ...
      instanceStates: (() { final guardedValue = map['instanceStates']; if (guardedValue == null) return null; return (guardedValue as List).cast<String>(); })(),
      ...
      nodeGroupIds: (() { final guardedValue = map['nodeGroupIds']; if (guardedValue == null) return null; return (guardedValue as List).cast<String>(); })(),
      nodeGroupNames: (() { final guardedValue = map['nodeGroupNames']; if (guardedValue == null) return null; return (guardedValue as List).cast<String>(); })(),
