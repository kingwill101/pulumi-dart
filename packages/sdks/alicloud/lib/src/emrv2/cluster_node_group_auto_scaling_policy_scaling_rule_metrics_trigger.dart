...
class ClusterNodeGroupAutoScalingPolicyScalingRuleMetricsTrigger {
  ...
  final pulumi.Input<
    List<ClusterNodeGroupAutoScalingPolicyScalingRuleMetricsTriggerCondition>
  >?
  conditions;
  ...
  factory ClusterNodeGroupAutoScalingPolicyScalingRuleMetricsTrigger.fromMap(
    Map<String, dynamic> map,
  ) {
    return ClusterNodeGroupAutoScalingPolicyScalingRuleMetricsTrigger(
      conditionLogicOperator: (() {
        final guardedValue = map['conditionLogicOperator'];
      ...
      conditions: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                ClusterNodeGroupAutoScalingPolicyScalingRuleMetricsTriggerCondition.fromMap(
      ...
      coolDownInterval: (() {
        final guardedValue = map['coolDownInterval'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      evaluationCount: pulumi.Input.fromValue(map['evaluationCount'] as int),
      timeConstraints: (() {
        final guardedValue = map['timeConstraints'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<
            ClusterNodeGroupAutoScalingPolicyScalingRuleMetricsTriggerTimeConstraint
          >(
            guardedValue,
            (value) =>
                ClusterNodeGroupAutoScalingPolicyScalingRuleMetricsTriggerTimeConstraint.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
