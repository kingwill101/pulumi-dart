...
class ClusterNodeGroup {
    ...
    return <String, dynamic>{
      ...
      'costOptimizedConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(costOptimizedConfig, (value) => value.toMap()),
      'dataDisks':
          pulumi.Input.mapInputValue<
            List<ClusterNodeGroupDataDisk>,
      ...
      'spotBidPrices':
          ?pulumi.Input.mapOptionalInputValue<
            List<ClusterNodeGroupSpotBidPrice>,
            List<Map<String, dynamic>>
          >(
            spotBidPrices,
            (value) =>
      ...
      'subscriptionConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(subscriptionConfig, (value) => value.toMap()),
      'systemDisk':
          pulumi.Input.mapInputValue<
  ...
  factory ClusterNodeGroup.fromMap(Map<String, dynamic> map) {
    return ClusterNodeGroup(
      ackConfig: (() {
        final guardedValue = map['ackConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ClusterNodeGroupAckConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      additionalSecurityGroupIds: (() {
        final guardedValue = map['additionalSecurityGroupIds'];
        if (guardedValue == null) return null;
      ...
      autoScalingPolicy: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ClusterNodeGroupAutoScalingPolicy.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      costOptimizedConfig: (() {
        final guardedValue = map['costOptimizedConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ClusterNodeGroupCostOptimizedConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      dataDisks: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ClusterNodeGroupDataDisk>(
          map['dataDisks']!,
          (value) => ClusterNodeGroupDataDisk.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      deploymentSetStrategy: (() {
        final guardedValue = map['deploymentSetStrategy'];
        if (guardedValue == null) return null;
      ...
      nodeResizeStrategy: (() {
        final guardedValue = map['nodeResizeStrategy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      paymentType: (() {
      ...
      privatePoolOptions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ClusterNodeGroupPrivatePoolOptions.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      spotBidPrices: (() {
        final guardedValue = map['spotBidPrices'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ClusterNodeGroupSpotBidPrice>(
            guardedValue,
            (value) => ClusterNodeGroupSpotBidPrice.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      subscriptionConfig: (() {
        final guardedValue = map['subscriptionConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ClusterNodeGroupSubscriptionConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      systemDisk: pulumi.Input.fromValue(
        ClusterNodeGroupSystemDisk.fromMap(
          (map['systemDisk']! as Map).cast<String, dynamic>(),
        ),
      ),
      vswitchIds: (() {
      ...
      withPublicIp: (() {
        final guardedValue = map['withPublicIp'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
    );
