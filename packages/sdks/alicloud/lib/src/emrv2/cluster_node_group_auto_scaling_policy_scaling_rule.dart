...
class ClusterNodeGroupAutoScalingPolicyScalingRule {
  ...
  final pulumi.Input<ClusterNodeGroupAutoScalingPolicyScalingRuleTimeTrigger>?
  timeTrigger;
    ...
    return <String, dynamic>{
      ...
      'metricsTrigger':
          ?pulumi.Input.mapOptionalInputValue<
            ClusterNodeGroupAutoScalingPolicyScalingRuleMetricsTrigger,
            Map<String, dynamic>
          >(metricsTrigger, (value) => value.toMap()),
      ...
      'timeTrigger':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(timeTrigger, (value) => value.toMap()),
      'triggerType': triggerType,
    };
  }

  factory ClusterNodeGroupAutoScalingPolicyScalingRule.fromMap(
    ...
    return ClusterNodeGroupAutoScalingPolicyScalingRule(
      ...
      metricsTrigger: (() {
        final guardedValue = map['metricsTrigger'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ClusterNodeGroupAutoScalingPolicyScalingRuleMetricsTrigger.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      minAdjustmentValue: (() {
        final guardedValue = map['minAdjustmentValue'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      ruleName: pulumi.Input.fromValue(map['ruleName'] as String),
      timeTrigger: (() {
        final guardedValue = map['timeTrigger'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ClusterNodeGroupAutoScalingPolicyScalingRuleTimeTrigger.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
