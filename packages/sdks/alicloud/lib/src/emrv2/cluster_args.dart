...
class ClusterArgs {
  ...
  factory ClusterArgs.fromMap(Map<String, dynamic> map) {
    return ClusterArgs(
      applicationConfigs: (() {
        final guardedValue = map['applicationConfigs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ClusterApplicationConfig>(
            guardedValue,
            (value) => ClusterApplicationConfig.fromMap(
      ...
      bootstrapScripts: (() {
        final guardedValue = map['bootstrapScripts'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ClusterBootstrapScript>(
            guardedValue,
            (value) => ClusterBootstrapScript.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      logCollectStrategy: (() {
        final guardedValue = map['logCollectStrategy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      nodeAttributes: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ClusterNodeAttribute>(
          map['nodeAttributes']!,
          (value) => ClusterNodeAttribute.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      nodeGroups: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ClusterNodeGroup>(
          map['nodeGroups']!,
          (value) =>
              ClusterNodeGroup.fromMap((value as Map).cast<String, dynamic>()),
        ),
      ),
      paymentType: (() {
      ...
      subscriptionConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ClusterSubscriptionConfig.fromMap(
