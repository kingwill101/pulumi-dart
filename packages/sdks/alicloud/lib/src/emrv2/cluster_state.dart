...
class ClusterState {
  ...
  factory ClusterState.fromMap(Map<String, dynamic> map) {
    return ClusterState(
      ...
      nodeAttributes: (() { final guardedValue = map['nodeAttributes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ClusterNodeAttribute>(guardedValue, (value) => ClusterNodeAttribute.fromMap((value as Map).cast<String, dynamic>()))); })(),
