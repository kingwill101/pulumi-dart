...
class ClusterState {
  ...
  ClusterState({
    ...
    pulumi.Output<List<ClusterNodeAttribute>>? nodeAttributes,
    ...
    pulumi.Output<Map<String, String>>? tags,
      ...
      nodeAttributes = pulumi.Input.asOptionalInput<List<ClusterNodeAttribute>>(nodeAttributes),
  ...
  factory ClusterState.fromMap(Map<String, dynamic> map) {
    return ClusterState(
      ...
      nodeAttributes: map['nodeAttributes'] == null ? null : pulumi.Output.create<List<ClusterNodeAttribute>>(pulumi.Input.decodeList<ClusterNodeAttribute>(map['nodeAttributes'], (value) => ClusterNodeAttribute.fromMap((value as Map).cast<String, dynamic>()))),
