...
class Cluster extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<ClusterApplicationConfig>?> applicationConfigs;
  ...
  late final pulumi.Output<List<ClusterBootstrapScript>?> bootstrapScripts;
  ...
  late final pulumi.Output<List<ClusterNodeAttribute>> nodeAttributes;
  ...
  Cluster(
    ...
    this.applicationConfigs = registerOutput<List<ClusterApplicationConfig>?>('applicationConfigs');
    this.applications = registerOutput<List<String>>('applications');
    this.bootstrapScripts = registerOutput<List<ClusterBootstrapScript>?>('bootstrapScripts');
    this.clusterName = registerOutput<String>('clusterName');
    this.clusterType = registerOutput<String>('clusterType');
    this.deletionProtection = registerOutput<bool?>('deletionProtection');
    this.deployMode = registerOutput<String>('deployMode');
    this.logCollectStrategy = registerOutput<String>('logCollectStrategy');
    this.nodeAttributes = registerOutput<List<ClusterNodeAttribute>>('nodeAttributes');
    ...
    this.subscriptionConfig = registerOutput<ClusterSubscriptionConfig?>('subscriptionConfig');
