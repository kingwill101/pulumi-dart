    ...
    return <String, dynamic>{
      ...
      'audit':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(audit, (value) => value.toMap()),
      'controlPlaneLog':
          ?pulumi.Input.mapOptionalInputValue<
            ServiceMeshMeshConfigControlPlaneLog,
            Map<String, dynamic>
          >(controlPlaneLog, (value) => value.toMap()),
      ...
      'kiali':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(kiali, (value) => value.toMap()),
      'opa':
          ?pulumi.Input.mapOptionalInputValue<
            ServiceMeshMeshConfigOpa,
            Map<String, dynamic>
          >(opa, (value) => value.toMap()),
      'outboundTrafficPolicy': ?outboundTrafficPolicy,
      'pilot':
          ?pulumi.Input.mapOptionalInputValue<
            ServiceMeshMeshConfigPilot,
            Map<String, dynamic>
          >(pilot, (value) => value.toMap()),
      'prometheus':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'sidecarInjector':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(sidecarInjector, (value) => value.toMap()),
      'telemetry': ?telemetry,
      'tracing': ?tracing,
    };
  }
    ...
    return ServiceMeshMeshConfig(
      accessLog: (() {
        ...
        return pulumi.Input.fromValue(
          ServiceMeshMeshConfigAccessLog.fromMap(
      ...
      audit: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ServiceMeshMeshConfigAudit.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      controlPlaneLog: (() {
        final guardedValue = map['controlPlaneLog'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ServiceMeshMeshConfigControlPlaneLog.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      customizedZipkin: (() {
        final guardedValue = map['customizedZipkin'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      enableLocalityLb: (() {
        final guardedValue = map['enableLocalityLb'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      includeIpRanges: (() {
        final guardedValue = map['includeIpRanges'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      kiali: (() {
        final guardedValue = map['kiali'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ServiceMeshMeshConfigKiali.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      opa: (() {
        final guardedValue = map['opa'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ServiceMeshMeshConfigOpa.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      outboundTrafficPolicy: (() {
        final guardedValue = map['outboundTrafficPolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      pilot: (() {
        final guardedValue = map['pilot'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ServiceMeshMeshConfigPilot.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      prometheus: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ServiceMeshMeshConfigPrometheus.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      proxy: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ServiceMeshMeshConfigProxy.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      sidecarInjector: (() {
        final guardedValue = map['sidecarInjector'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ServiceMeshMeshConfigSidecarInjector.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
