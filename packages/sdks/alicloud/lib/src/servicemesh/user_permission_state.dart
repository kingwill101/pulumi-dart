...
class UserPermissionState {
  ...
  factory UserPermissionState.fromMap(Map<String, dynamic> map) {
    return UserPermissionState(
      permissions: (() { final guardedValue = map['permissions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<UserPermissionPermission>(guardedValue, (value) => UserPermissionPermission.fromMap((value as Map).cast<String, dynamic>()))); })(),
      subAccountUserId: (() { final guardedValue = map['subAccountUserId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
