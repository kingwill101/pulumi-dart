...
class ServiceMeshState {
  ...
  factory ServiceMeshState.fromMap(Map<String, dynamic> map) {
    return ServiceMeshState(
      ...
      network: (() { final guardedValue = map['network']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServiceMeshNetwork.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
