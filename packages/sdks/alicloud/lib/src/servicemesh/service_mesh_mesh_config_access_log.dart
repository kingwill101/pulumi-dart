...
class ServiceMeshMeshConfigAccessLog {
  ...
  factory ServiceMeshMeshConfigAccessLog.fromMap(Map<String, dynamic> map) {
    return ServiceMeshMeshConfigAccessLog(
      ...
      gatewayEnabled: (() {
        final guardedValue = map['gatewayEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      gatewayLifecycle: (() {
        final guardedValue = map['gatewayLifecycle'];
        if (guardedValue == null) return null;
      ...
      sidecarEnabled: (() {
        final guardedValue = map['sidecarEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      sidecarLifecycle: (() {
        final guardedValue = map['sidecarLifecycle'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
    );
