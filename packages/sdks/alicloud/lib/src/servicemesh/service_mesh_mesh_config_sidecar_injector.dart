...
class ServiceMeshMeshConfigSidecarInjector {
  ...
  factory ServiceMeshMeshConfigSidecarInjector.fromMap(Map<String, dynamic> map) {
    return ServiceMeshMeshConfigSidecarInjector(
      autoInjectionPolicyEnabled: (() { final guardedValue = map['autoInjectionPolicyEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      enableNamespacesByDefault: (() { final guardedValue = map['enableNamespacesByDefault']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      initCniConfiguration: (() { final guardedValue = map['initCniConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServiceMeshMeshConfigSidecarInjectorInitCniConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      sidecarInjectorWebhookAsYaml: (() { final guardedValue = map['sidecarInjectorWebhookAsYaml']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
