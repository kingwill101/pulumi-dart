...
class GetServiceMeshesMeshLoadBalancer {
  ...
  factory GetServiceMeshesMeshLoadBalancer.fromMap(Map<String, dynamic> map) {
    return GetServiceMeshesMeshLoadBalancer(
      apiServerLoadbalancerId: pulumi.Input.fromValue(
        map['apiServerLoadbalancerId'] as String,
      ),
      apiServerPublicEip: pulumi.Input.fromValue(
        map['apiServerPublicEip'] as bool,
      ),
      pilotPublicEip: pulumi.Input.fromValue(map['pilotPublicEip'] as bool),
      pilotPublicLoadbalancerId: pulumi.Input.fromValue(
        map['pilotPublicLoadbalancerId'] as String,
      ),
    );
  }
}
