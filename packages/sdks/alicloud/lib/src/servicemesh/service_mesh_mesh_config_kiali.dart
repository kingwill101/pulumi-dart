    ...
    return <String, dynamic>{
      ...
      'openIdConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(openIdConfig, (value) => value.toMap()),
      'ramOauthConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ServiceMeshMeshConfigKialiRamOauthConfig,
            Map<String, dynamic>
          >(ramOauthConfig, (value) => value.toMap()),
      'serverConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ServiceMeshMeshConfigKialiServerConfig,
            Map<String, dynamic>
          >(serverConfig, (value) => value.toMap()),
      'url': ?url,
  ...
  factory ServiceMeshMeshConfigKiali.fromMap(Map<String, dynamic> map) {
    return ServiceMeshMeshConfigKiali(
      aggregatedKialiAddress: (() {
        final guardedValue = map['aggregatedKialiAddress'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      authStrategy: (() {
        final guardedValue = map['authStrategy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      customPrometheusUrl: (() {
        final guardedValue = map['customPrometheusUrl'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      distributedKialiAccessTokens: (() {
        final guardedValue = map['distributedKialiAccessTokens'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      distributedKialiAddresses: (() {
        final guardedValue = map['distributedKialiAddresses'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      enabled: (() {
      ...
      integrateClb: (() {
        final guardedValue = map['integrateClb'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      kialiArmsAuthTokens: (() {
        final guardedValue = map['kialiArmsAuthTokens'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      kialiServiceAnnotations: (() {
        final guardedValue = map['kialiServiceAnnotations'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      openIdConfig: (() {
        final guardedValue = map['openIdConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ServiceMeshMeshConfigKialiOpenIdConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ramOauthConfig: (() {
        final guardedValue = map['ramOauthConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ServiceMeshMeshConfigKialiRamOauthConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      serverConfig: (() {
        final guardedValue = map['serverConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ServiceMeshMeshConfigKialiServerConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      usePopulatedArmsPrometheus: (() {
        final guardedValue = map['usePopulatedArmsPrometheus'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
    );
