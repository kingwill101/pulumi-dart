...
class GetServiceMeshesMesh {
    ...
    return <String, dynamic>{
      ...
      'endpoints':
          pulumi.Input.mapInputValue<
            List<GetServiceMeshesMeshEndpoint>,
      ...
      'loadBalancers':
          pulumi.Input.mapInputValue<
            List<GetServiceMeshesMeshLoadBalancer>,
            List<Map<String, dynamic>>
          >(
            loadBalancers,
            (value) =>
      ...
      'meshConfigs':
          pulumi.Input.mapInputValue<
            List<GetServiceMeshesMeshMeshConfig>,
            List<Map<String, dynamic>>
          >(
            meshConfigs,
            (value) =>
      ...
      'networks':
          pulumi.Input.mapInputValue<
            List<GetServiceMeshesMeshNetwork>,
            List<Map<String, dynamic>>
          >(
            networks,
            (value) =>
  ...
  factory GetServiceMeshesMesh.fromMap(Map<String, dynamic> map) {
    return GetServiceMeshesMesh(
      clusters: pulumi.Input.fromValue(
      ...
      endpoints: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetServiceMeshesMeshEndpoint>(
          map['endpoints']!,
          (value) => GetServiceMeshesMeshEndpoint.fromMap(
      ...
      istioOperatorVersion: pulumi.Input.fromValue(
        map['istioOperatorVersion'] as String,
      ),
      kubeConfig: pulumi.Input.fromValue(map['kubeConfig'] as String),
      loadBalancers: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetServiceMeshesMeshLoadBalancer>(
          map['loadBalancers']!,
          (value) => GetServiceMeshesMeshLoadBalancer.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      meshConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetServiceMeshesMeshMeshConfig>(
          map['meshConfigs']!,
          (value) => GetServiceMeshesMeshMeshConfig.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      networks: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetServiceMeshesMeshNetwork>(
          map['networks']!,
          (value) => GetServiceMeshesMeshNetwork.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
