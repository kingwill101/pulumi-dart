...
class GetServiceMeshesMeshMeshConfigSidecarInjector {
  ...
  factory GetServiceMeshesMeshMeshConfigSidecarInjector.fromMap(Map<String, dynamic> map) {
    return GetServiceMeshesMeshMeshConfigSidecarInjector(
      autoInjectionPolicyEnabled: pulumi.Input.fromValue(map['autoInjectionPolicyEnabled'] as bool),
      enableNamespacesByDefault: pulumi.Input.fromValue(map['enableNamespacesByDefault'] as bool),
      initCniConfigurations: pulumi.Input.fromValue(pulumi.Input.decodeList<GetServiceMeshesMeshMeshConfigSidecarInjectorInitCniConfiguration>(map['initCniConfigurations']!, (value) => GetServiceMeshesMeshMeshConfigSidecarInjectorInitCniConfiguration.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      sidecarInjectorWebhookAsYaml: pulumi.Input.fromValue(map['sidecarInjectorWebhookAsYaml'] as String),
    );
  }
}
