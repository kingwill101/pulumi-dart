...
class Connection {
  ...
  factory Connection.fromMap(Map<String, dynamic> map) {
    return Connection(
      agentSocketPath: (() { final guardedValue = map['agentSocketPath']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      dialErrorLimit: (() { final guardedValue = map['dialErrorLimit']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      perDialTimeout: (() { final guardedValue = map['perDialTimeout']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      privateKeyPassword: (() { final guardedValue = map['privateKeyPassword']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      proxy: (() { final guardedValue = map['proxy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ProxyConnection.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
