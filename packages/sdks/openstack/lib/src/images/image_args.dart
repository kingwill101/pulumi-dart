...
class ImageArgs {
  ...
  ImageArgs({
    required pulumi.Output<String> containerFormat,
    pulumi.Output<bool>? decompress,
    required pulumi.Output<String> diskFormat,
  ...
  factory ImageArgs.fromMap(Map<String, dynamic> map) {
    return ImageArgs(
      containerFormat: pulumi.Output.create<String>(map['containerFormat'] as String),
      decompress: map['decompress'] == null ? null : pulumi.Output.create<bool>(map['decompress'] as bool),
      diskFormat: pulumi.Output.create<String>(map['diskFormat'] as String),
