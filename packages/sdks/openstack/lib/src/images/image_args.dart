...
class ImageArgs {
  ...
  factory ImageArgs.fromMap(Map<String, dynamic> map) {
    return ImageArgs(
      containerFormat: pulumi.Input.fromValue(map['containerFormat'] as String),
      ...
      diskFormat: pulumi.Input.fromValue(map['diskFormat'] as String),
      hidden: (() { final guardedValue = map['hidden']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      imageCachePath: (() { final guardedValue = map['imageCachePath']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      imageSourcePassword: (() { final guardedValue = map['imageSourcePassword']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      imageSourceUrl: (() { final guardedValue = map['imageSourceUrl']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      imageSourceUsername: (() { final guardedValue = map['imageSourceUsername']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      minDiskGb: (() { final guardedValue = map['minDiskGb']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      minRamMb: (() { final guardedValue = map['minRamMb']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      verifyChecksum: (() { final guardedValue = map['verifyChecksum']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      webDownload: (() { final guardedValue = map['webDownload']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
    );
  }
}
