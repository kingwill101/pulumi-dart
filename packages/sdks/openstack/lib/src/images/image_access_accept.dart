...
import 'image_access_accept_state.dart';
...
class ImageAccessAccept extends pulumi.CustomResource {
  ...
  /// Gets an existing [ImageAccessAccept] resource's state with the given [name] and [id].
  static ImageAccessAccept get(
    String name,
    pulumi.Input<String> id, {
    ImageAccessAcceptState? state,
  }) {
    return ImageAccessAccept._get(
      name,
      state: state?.toMap(),
