    ...
    return IkePolicyState(
      ...
      lifetimes: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<IkePolicyLifetime>(
            guardedValue,
            (value) => IkePolicyLifetime.fromMap(
      ...
      phase1NegotiationMode: (() {
        final guardedValue = map['phase1NegotiationMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      region: (() {
