...
class SiteConnectionState {
  ...
  SiteConnectionState({
    ...
    pulumi.Output<String>? ikepolicyId,
    pulumi.Output<String>? initiator,
    pulumi.Output<String>? ipsecpolicyId,
    ...
    pulumi.Output<String>? vpnserviceId,
      ...
      ikepolicyId = pulumi.Input.asOptionalInput<String>(ikepolicyId),
      initiator = pulumi.Input.asOptionalInput<String>(initiator),
      ipsecpolicyId = pulumi.Input.asOptionalInput<String>(ipsecpolicyId),
      ...
      peerId = pulumi.Input.asOptionalInput<String>(peerId),
      ...
      vpnserviceId = pulumi.Input.asOptionalInput<String>(vpnserviceId);
  ...
  factory SiteConnectionState.fromMap(Map<String, dynamic> map) {
    return SiteConnectionState(
      ...
      ikepolicyId: map['ikepolicyId'] == null ? null : pulumi.Output.create<String>(map['ikepolicyId'] as String),
      initiator: map['initiator'] == null ? null : pulumi.Output.create<String>(map['initiator'] as String),
      ipsecpolicyId: map['ipsecpolicyId'] == null ? null : pulumi.Output.create<String>(map['ipsecpolicyId'] as String),
      ...
      peerId: map['peerId'] == null ? null : pulumi.Output.create<String>(map['peerId'] as String),
      ...
      vpnserviceId: map['vpnserviceId'] == null ? null : pulumi.Output.create<String>(map['vpnserviceId'] as String),
    );
  }
}
