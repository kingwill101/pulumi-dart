...
class SiteConnectionArgs {
  ...
  const SiteConnectionArgs({
    ...
    this.description,
    this.dpds,
    required this.ikepolicyId,
    this.initiator,
    required this.ipsecpolicyId,
    this.localEpGroupId,
    this.localId,
    this.mtu,
    this.name,
  ...
  factory SiteConnectionArgs.fromMap(Map<String, dynamic> map) {
    return SiteConnectionArgs(
      ...
      ikepolicyId: pulumi.Input.fromValue(map['ikepolicyId'] as String),
      ...
      ipsecpolicyId: pulumi.Input.fromValue(map['ipsecpolicyId'] as String),
      ...
      vpnserviceId: pulumi.Input.fromValue(map['vpnserviceId'] as String),
    );
  }
}
