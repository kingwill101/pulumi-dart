...
class SiteConnectionArgs {
  ...
  factory SiteConnectionArgs.fromMap(Map<String, dynamic> map) {
    return SiteConnectionArgs(
      ...
      ikepolicyId: (map['ikepolicyId'] as String).input(),
      initiator: map['initiator'] == null ? null : (map['initiator']! as String).input(),
      ipsecpolicyId: (map['ipsecpolicyId'] as String).input(),
      ...
      peerId: (map['peerId'] as String).input(),
      ...
      vpnserviceId: (map['vpnserviceId'] as String).input(),
    );
  }
}
