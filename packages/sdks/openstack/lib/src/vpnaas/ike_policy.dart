...
class IkePolicy extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<IkePolicyLifetime>> lifetimes;
  ...
  IkePolicy(
    ...
    this.ikeVersion = registerOutput<String?>('ikeVersion');
    this.lifetimes = registerOutput<List<IkePolicyLifetime>>('lifetimes');
    this.name = registerOutput<String>('name');
    this.pfs = registerOutput<String?>('pfs');
    this.phase1NegotiationMode = registerOutput<String?>('phase1NegotiationMode');
