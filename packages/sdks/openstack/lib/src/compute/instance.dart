...
class Instance extends pulumi.CustomResource {
  ...
  Instance(
    ...
    personalities = registerOutput<List<Map<String, dynamic>>?>('personalities');
    powerState = registerOutput<String?>('powerState');
    region = registerOutput<String>('region');
    schedulerHints = registerOutput<List<Map<String, dynamic>>?>('schedulerHints');
    ...
    vendorOptions = registerOutput<InstanceVendorOptions?>('vendorOptions', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return InstanceVendorOptions.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  }
