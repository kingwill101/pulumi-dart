...
class InstanceState {
  ...
  InstanceState({
    pulumi.Output<String>? accessIpV4,
    pulumi.Output<String>? accessIpV6,
    ...
    pulumi.Output<InstanceVendorOptions>? vendorOptions,
      ...
      accessIpV4 = pulumi.Input.asOptionalInput<String>(accessIpV4),
      accessIpV6 = pulumi.Input.asOptionalInput<String>(accessIpV6),
  ...
  factory InstanceState.fromMap(Map<String, dynamic> map) {
    return InstanceState(
      accessIpV4: map['accessIpV4'] == null ? null : pulumi.Output.create<String>(map['accessIpV4'] as String),
      accessIpV6: map['accessIpV6'] == null ? null : pulumi.Output.create<String>(map['accessIpV6'] as String),
