...
class InstanceState {
  ...
  factory InstanceState.fromMap(Map<String, dynamic> map) {
    return InstanceState(
      accessIpV4: (() { final guardedValue = map['accessIpV4']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      accessIpV6: (() { final guardedValue = map['accessIpV6']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      availabilityZoneHints: (() { final guardedValue = map['availabilityZoneHints']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      blockDevices: (() { final guardedValue = map['blockDevices']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InstanceBlockDevice>(guardedValue, (value) => InstanceBlockDevice.fromMap((value as Map).cast<String, dynamic>()))); })(),
      configDrive: (() { final guardedValue = map['configDrive']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      flavorName: (() { final guardedValue = map['flavorName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      hypervisorHostname: (() { final guardedValue = map['hypervisorHostname']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      personalities: (() { final guardedValue = map['personalities']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InstancePersonality>(guardedValue, (value) => InstancePersonality.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      schedulerHints: (() { final guardedValue = map['schedulerHints']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InstanceSchedulerHint>(guardedValue, (value) => InstanceSchedulerHint.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      stopBeforeDestroy: (() { final guardedValue = map['stopBeforeDestroy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      vendorOptions: (() { final guardedValue = map['vendorOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceVendorOptions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
