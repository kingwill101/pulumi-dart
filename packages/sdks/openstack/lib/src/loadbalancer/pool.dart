...
class Pool extends pulumi.CustomResource {
  ...
  Pool(
    ...
    persistence = registerOutput<PoolPersistence?>('persistence', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return PoolPersistence.fromMap((guardedValue as Map).cast<String, dynamic>()); });
