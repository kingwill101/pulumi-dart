...
/// Result data returned by getLbFlavorDeprecated.
class GetLbFlavorDeprecatedResult {
  ...
  /// Creates a new [GetLbFlavorDeprecatedResult].
  ...
  factory GetLbFlavorDeprecatedResult.fromMap(Map<String, dynamic> map) {
