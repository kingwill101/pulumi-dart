...
class MembersState {
  ...
  MembersState({this.members, this.poolId, this.region});
    ...
    return <String, dynamic>{
      'members':
          ...
          >(
            members,
            (value) =>
                pulumi.Input.encodeList<MembersMember, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return MembersState(
      members: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MembersMember>(
            guardedValue,
            (value) =>
                MembersMember.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      poolId: (() {
