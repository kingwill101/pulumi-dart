...
class L7RuleV2State {
  ...
  factory L7RuleV2State.fromMap(Map<String, dynamic> map) {
    return L7RuleV2State(
      ...
      compareType: (() { final guardedValue = map['compareType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      l7policyId: (() { final guardedValue = map['l7policyId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
