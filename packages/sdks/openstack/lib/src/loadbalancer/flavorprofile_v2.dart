...
import 'flavorprofile_v2_args.dart';
import 'flavorprofile_v2_state.dart';
...
class FlavorprofileV2 extends pulumi.CustomResource {
  ...
  /// Creates a new [FlavorprofileV2].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [FlavorprofileV2]. {@macro pulumi_loadbalancer_flavorprofile_v2_flavorprofile_v2_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  FlavorprofileV2(
    String name, {
    FlavorprofileV2Args? args,
    ...
    this.flavorData = registerOutput<String>('flavorData');
    this.name = registerOutput<String>('name');
    this.providerName = registerOutput<String>('providerName');
    this.region = registerOutput<String>('region');
  }

  /// Gets an existing [FlavorprofileV2] resource's state with the given [name] and [id].
  static FlavorprofileV2 get(
    String name,
    pulumi.Input<String> id, {
    FlavorprofileV2State? state,
  }) {
    return FlavorprofileV2._get(
      name,
      state: state?.toMap(),
