...
class L7PolicyV2Args {
  ...
  factory L7PolicyV2Args.fromMap(Map<String, dynamic> map) {
    return L7PolicyV2Args(
      ...
      redirectHttpCode: (() { final guardedValue = map['redirectHttpCode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      redirectPoolId: (() { final guardedValue = map['redirectPoolId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      redirectPrefix: (() { final guardedValue = map['redirectPrefix']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
