...
class InstanceState {
  ...
  InstanceState({
    ...
    pulumi.Output<InstanceDatastore>? datastore,
    ...
    pulumi.Output<String>? volumeType,
      ...
      datastore = pulumi.Input.asOptionalInput<InstanceDatastore>(datastore),
  ...
  factory InstanceState.fromMap(Map<String, dynamic> map) {
    return InstanceState(
      ...
      datastore: map['datastore'] == null ? null : pulumi.Output.create<InstanceDatastore>(InstanceDatastore.fromMap((map['datastore'] as Map).cast<String, dynamic>())),
