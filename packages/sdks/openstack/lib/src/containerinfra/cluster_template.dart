...
import 'cluster_template_state.dart';
...
class ClusterTemplate extends pulumi.CustomResource {
  ...
  ClusterTemplate(
    ...
    apiserverPort = registerOutput<int?>('apiserverPort');
    clusterDistro = registerOutput<String>('clusterDistro');
    coe = registerOutput<String>('coe');
    createdAt = registerOutput<String>('createdAt');
    dnsNameserver = registerOutput<String?>('dnsNameserver');
    dockerStorageDriver = registerOutput<String?>('dockerStorageDriver');
    ...
    networkDriver = registerOutput<String>('networkDriver');
    noProxy = registerOutput<String?>('noProxy');
    projectId = registerOutput<String>('projectId');
    public = registerOutput<bool?>('public');
    region = registerOutput<String>('region');
    registryEnabled = registerOutput<bool?>('registryEnabled');
    serverType = registerOutput<String>('serverType');
    tlsDisabled = registerOutput<bool?>('tlsDisabled');
    updatedAt = registerOutput<String>('updatedAt');
    userId = registerOutput<String>('userId');
    volumeDriver = registerOutput<String?>('volumeDriver');
  }

  /// Gets an existing [ClusterTemplate] resource's state with the given [name] and [id].
  static ClusterTemplate get(
    String name,
    pulumi.Input<String> id, {
    ClusterTemplateState? state,
  }) {
    return ClusterTemplate._get(
      name,
      state: state?.toMap(),
