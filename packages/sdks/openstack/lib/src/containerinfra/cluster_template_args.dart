...
class ClusterTemplateArgs {
  ...
  factory ClusterTemplateArgs.fromMap(Map<String, dynamic> map) {
    return ClusterTemplateArgs(
      apiserverPort: (() {
        final guardedValue = map['apiserverPort'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      clusterDistro: (() {
        final guardedValue = map['clusterDistro'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      coe: pulumi.Input.fromValue(map['coe'] as String),
      dnsNameserver: (() {
        final guardedValue = map['dnsNameserver'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      dockerStorageDriver: (() {
        final guardedValue = map['dockerStorageDriver'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      dockerVolumeSize: (() {
      ...
      networkDriver: (() {
        final guardedValue = map['networkDriver'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      noProxy: (() {
      ...
      registryEnabled: (() {
        final guardedValue = map['registryEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      serverType: (() {
      ...
      tlsDisabled: (() {
        final guardedValue = map['tlsDisabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      volumeDriver: (() {
        final guardedValue = map['volumeDriver'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
