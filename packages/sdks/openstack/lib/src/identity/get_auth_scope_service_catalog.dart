...
class GetAuthScopeServiceCatalog {
  ...
  factory GetAuthScopeServiceCatalog.fromMap(Map<String, dynamic> map) {
    return GetAuthScopeServiceCatalog(
      endpoints: pulumi.Input.fromValue(pulumi.Input.decodeList<GetAuthScopeServiceCatalogEndpoint>(map['endpoints']!, (value) => GetAuthScopeServiceCatalogEndpoint.fromMap((value as Map).cast<String, dynamic>()))),
