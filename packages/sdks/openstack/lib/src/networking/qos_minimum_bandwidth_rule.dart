...
import 'qos_minimum_bandwidth_rule_state.dart';
...
class QosMinimumBandwidthRule extends pulumi.CustomResource {
  ...
  /// Gets an existing [QosMinimumBandwidthRule] resource's state with the given [name] and [id].
  static QosMinimumBandwidthRule get(
    String name,
    pulumi.Input<String> id, {
    QosMinimumBandwidthRuleState? state,
  }) {
    return QosMinimumBandwidthRule._get(
      name,
      state: state?.toMap(),
