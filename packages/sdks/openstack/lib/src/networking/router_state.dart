...
class RouterState {
  ...
  factory RouterState.fromMap(Map<String, dynamic> map) {
    return RouterState(
      ...
      externalFixedIps: (() { final guardedValue = map['externalFixedIps']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RouterExternalFixedIp>(guardedValue, (value) => RouterExternalFixedIp.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      externalQosPolicyId: (() { final guardedValue = map['externalQosPolicyId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      externalSubnetIds: (() { final guardedValue = map['externalSubnetIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      ...
      vendorOptions: (() { final guardedValue = map['vendorOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RouterVendorOptions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
