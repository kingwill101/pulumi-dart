...
class PortState {
    ...
    return <String, dynamic>{
      ...
      'fixedIps':
          ...
          >(
            fixedIps,
            (value) =>
                pulumi.Input.encodeList<PortFixedIp, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory PortState.fromMap(Map<String, dynamic> map) {
    return PortState(
      ...
      allFixedIps: (() {
        final guardedValue = map['allFixedIps'];
        if (guardedValue == null) return null;
      ...
      allowedAddressPairs: (() {
        final guardedValue = map['allowedAddressPairs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PortAllowedAddressPair>(
            guardedValue,
            (value) => PortAllowedAddressPair.fromMap(
      ...
      binding: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PortBinding.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      description: (() {
      ...
      dnsAssignments: (() {
        final guardedValue = map['dnsAssignments'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      extraDhcpOptions: (() {
        final guardedValue = map['extraDhcpOptions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PortExtraDhcpOption>(
            guardedValue,
            (value) => PortExtraDhcpOption.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      fixedIps: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PortFixedIp>(
            guardedValue,
            (value) =>
                PortFixedIp.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      macAddress: (() {
      ...
      noFixedIp: (() {
        final guardedValue = map['noFixedIp'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      noSecurityGroups: (() {
        final guardedValue = map['noSecurityGroups'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      portSecurityEnabled: (() {
