...
class PortState {
  ...
  final pulumi.Input<List<String>>? allFixedIps;
  ...
  final pulumi.Input<List<Map<String, String>>>? dnsAssignments;
  ...
  PortState({
    ...
    pulumi.Output<List<String>>? allFixedIps,
    pulumi.Output<List<String>>? allSecurityGroupIds,
    pulumi.Output<List<String>>? allTags,
    pulumi.Output<List<PortAllowedAddressPair>>? allowedAddressPairs,
    pulumi.Output<PortBinding>? binding,
    pulumi.Output<String>? description,
    pulumi.Output<String>? deviceId,
    pulumi.Output<String>? deviceOwner,
    pulumi.Output<List<Map<String, String>>>? dnsAssignments,
    pulumi.Output<String>? dnsName,
    pulumi.Output<List<PortExtraDhcpOption>>? extraDhcpOptions,
    pulumi.Output<List<PortFixedIp>>? fixedIps,
    pulumi.Output<String>? macAddress,
    pulumi.Output<String>? name,
    pulumi.Output<String>? networkId,
    pulumi.Output<bool>? noFixedIp,
    pulumi.Output<bool>? noSecurityGroups,
    ...
    pulumi.Output<Map<String, String>>? valueSpecs,
      ...
      allFixedIps = pulumi.Input.asOptionalInput<List<String>>(allFixedIps),
      ...
      dnsAssignments = pulumi.Input.asOptionalInput<List<Map<String, String>>>(dnsAssignments),
  ...
  factory PortState.fromMap(Map<String, dynamic> map) {
    return PortState(
      ...
      allFixedIps: map['allFixedIps'] == null ? null : pulumi.Output.create<List<String>>((map['allFixedIps'] as List).cast<String>()),
      ...
      allowedAddressPairs: map['allowedAddressPairs'] == null ? null : pulumi.Output.create<List<PortAllowedAddressPair>>(pulumi.Input.decodeList<PortAllowedAddressPair>(map['allowedAddressPairs'], (value) => PortAllowedAddressPair.fromMap((value as Map).cast<String, dynamic>()))),
      binding: map['binding'] == null ? null : pulumi.Output.create<PortBinding>(PortBinding.fromMap((map['binding'] as Map).cast<String, dynamic>())),
      ...
      dnsAssignments: map['dnsAssignments'] == null ? null : pulumi.Output.create<List<Map<String, String>>>((map['dnsAssignments'] as List).cast<Map<String, String>>()),
      dnsName: map['dnsName'] == null ? null : pulumi.Output.create<String>(map['dnsName'] as String),
      extraDhcpOptions: map['extraDhcpOptions'] == null ? null : pulumi.Output.create<List<PortExtraDhcpOption>>(pulumi.Input.decodeList<PortExtraDhcpOption>(map['extraDhcpOptions'], (value) => PortExtraDhcpOption.fromMap((value as Map).cast<String, dynamic>()))),
      fixedIps: map['fixedIps'] == null ? null : pulumi.Output.create<List<PortFixedIp>>(pulumi.Input.decodeList<PortFixedIp>(map['fixedIps'], (value) => PortFixedIp.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      noFixedIp: map['noFixedIp'] == null ? null : pulumi.Output.create<bool>(map['noFixedIp'] as bool),
      noSecurityGroups: map['noSecurityGroups'] == null ? null : pulumi.Output.create<bool>(map['noSecurityGroups'] as bool),
