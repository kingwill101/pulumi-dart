...
class PortState {
  ...
  factory PortState.fromMap(Map<String, dynamic> map) {
    return PortState(
      ...
      allFixedIps: (() { final guardedValue = map['allFixedIps']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      allSecurityGroupIds: (() { final guardedValue = map['allSecurityGroupIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      ...
      dnsAssignments: (() { final guardedValue = map['dnsAssignments']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<Map<String, String>>()); })(),
