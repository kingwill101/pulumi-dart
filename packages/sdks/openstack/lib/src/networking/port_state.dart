...
class PortState {
  ...
  factory PortState.fromMap(Map<String, dynamic> map) {
    return PortState(
      ...
      allFixedIps: map['allFixedIps'] == null ? null : ((map['allFixedIps'] as List).cast<String>()).input(),
      ...
      allowedAddressPairs: map['allowedAddressPairs'] == null ? null : (pulumi.Input.decodeList<PortAllowedAddressPair>(map['allowedAddressPairs'], (value) => PortAllowedAddressPair.fromMap((value as Map).cast<String, dynamic>()))).input(),
      binding: map['binding'] == null ? null : (PortBinding.fromMap((map['binding'] as Map).cast<String, dynamic>())).input(),
      ...
      dnsAssignments: map['dnsAssignments'] == null ? null : ((map['dnsAssignments'] as List).cast<Map<String, String>>()).input(),
      dnsName: map['dnsName'] == null ? null : (map['dnsName'] as String).input(),
      extraDhcpOptions: map['extraDhcpOptions'] == null ? null : (pulumi.Input.decodeList<PortExtraDhcpOption>(map['extraDhcpOptions'], (value) => PortExtraDhcpOption.fromMap((value as Map).cast<String, dynamic>()))).input(),
      fixedIps: map['fixedIps'] == null ? null : (pulumi.Input.decodeList<PortFixedIp>(map['fixedIps'], (value) => PortFixedIp.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      noFixedIp: map['noFixedIp'] == null ? null : (map['noFixedIp'] as bool).input(),
      noSecurityGroups: map['noSecurityGroups'] == null ? null : (map['noSecurityGroups'] as bool).input(),
