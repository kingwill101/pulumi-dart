...
class Router extends pulumi.CustomResource {
  ...
  Router(
    ...
    availabilityZoneHints = registerOutput<List<String>>('availabilityZoneHints');
    description = registerOutput<String?>('description');
    distributed = registerOutput<bool>('distributed');
    enableSnat = registerOutput<bool>('enableSnat');
    externalFixedIps = registerOutput<List<Map<String, dynamic>>>('externalFixedIps');
    ...
    vendorOptions = registerOutput<RouterVendorOptions?>('vendorOptions', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return RouterVendorOptions.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  }
