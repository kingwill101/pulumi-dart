...
import 'qos_dscp_marking_rule_state.dart';
...
class QosDscpMarkingRule extends pulumi.CustomResource {
  ...
  /// Gets an existing [QosDscpMarkingRule] resource's state with the given [name] and [id].
  static QosDscpMarkingRule get(
    String name,
    pulumi.Input<String> id, {
    QosDscpMarkingRuleState? state,
  }) {
    return QosDscpMarkingRule._get(
      name,
      state: state?.toMap(),
