...
class BgpSpeakerV2Args {
  ...
  factory BgpSpeakerV2Args.fromMap(Map<String, dynamic> map) {
    return BgpSpeakerV2Args(
      advertiseFloatingIpHostRoutes: (() { final guardedValue = map['advertiseFloatingIpHostRoutes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      advertiseTenantNetworks: (() { final guardedValue = map['advertiseTenantNetworks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
