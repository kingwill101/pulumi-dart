...
class BgpSpeakerV2State {
  ...
  factory BgpSpeakerV2State.fromMap(Map<String, dynamic> map) {
    return BgpSpeakerV2State(
      ...
      advertisedRoutes: (() { final guardedValue = map['advertisedRoutes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<BgpSpeakerV2AdvertisedRoute>(guardedValue, (value) => BgpSpeakerV2AdvertisedRoute.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      localAs: (() { final guardedValue = map['localAs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
