...
class GetPortResult {
    ...
    return <String, dynamic>{
      ...
      'allowedAddressPairs':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(allowedAddressPairs, (value) => value.toMap()),
      'bindings': pulumi.Input.encodeList<GetPortBinding, Map<String, dynamic>>(
        bindings,
        (value) => value.toMap(),
      ),
      ...
      'dnsName': ?dnsName,
      'extraDhcpOptions':
          pulumi.Input.encodeList<GetPortExtraDhcpOption, Map<String, dynamic>>(
            extraDhcpOptions,
            (value) => value.toMap(),
          ),
      'fixedIp': ?fixedIp,
  ...
  factory GetPortResult.fromMap(Map<String, dynamic> map) {
    return GetPortResult(
      ...
      allowedAddressPairs: pulumi.Input.decodeList<GetPortAllowedAddressPair>(
        map['allowedAddressPairs']!,
        (value) => GetPortAllowedAddressPair.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      bindings: pulumi.Input.decodeList<GetPortBinding>(
        map['bindings']!,
        (value) =>
            GetPortBinding.fromMap((value as Map).cast<String, dynamic>()),
      ),
      description: (() {
      ...
      dnsAssignments: (map['dnsAssignments'] as List)
      ...
      extraDhcpOptions: pulumi.Input.decodeList<GetPortExtraDhcpOption>(
        map['extraDhcpOptions']!,
        (value) => GetPortExtraDhcpOption.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      fixedIp: (() {
