...
class SubnetState {
  ...
  factory SubnetState.fromMap(Map<String, dynamic> map) {
    return SubnetState(
      ...
      allocationPools: (() {
        final guardedValue = map['allocationPools'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SubnetAllocationPool>(
            guardedValue,
            (value) => SubnetAllocationPool.fromMap(
      ...
      enableDhcp: (() {
        final guardedValue = map['enableDhcp'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      gatewayIp: (() {
      ...
      noGateway: (() {
        final guardedValue = map['noGateway'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      prefixLength: (() {
      ...
      serviceTypes: (() {
        final guardedValue = map['serviceTypes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      subnetpoolId: (() {
