...
import 'volume_type_access_v3_state.dart';
...
class VolumeTypeAccessV3 extends pulumi.CustomResource {
  ...
  static VolumeTypeAccessV3 get(
    String name,
    pulumi.Input<String> id, {
    VolumeTypeAccessV3State? state,
  }) {
    return VolumeTypeAccessV3._get(
      name,
      state: state?.toMap(),
