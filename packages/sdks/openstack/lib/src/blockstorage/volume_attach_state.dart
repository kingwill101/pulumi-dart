...
class VolumeAttachState {
  ...
  factory VolumeAttachState.fromMap(Map<String, dynamic> map) {
    return VolumeAttachState(
      attachMode: (() {
        final guardedValue = map['attachMode'];
      ...
      driverVolumeType: (() {
        final guardedValue = map['driverVolumeType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      hostName: (() {
      ...
      mountPointBase: (() {
        final guardedValue = map['mountPointBase'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      multipath: (() {
        final guardedValue = map['multipath'];
        if (guardedValue == null) return null;
      ...
      wwnn: (() {
        final guardedValue = map['wwnn'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      wwpns: (() {
        final guardedValue = map['wwpns'];
        if (guardedValue == null) return null;
