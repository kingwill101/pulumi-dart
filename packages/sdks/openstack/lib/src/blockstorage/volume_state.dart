...
class VolumeState {
  ...
  /// sees it.
  final pulumi.Input<List<VolumeAttachment>>? attachments;
  ...
  VolumeState({
    pulumi.Output<List<VolumeAttachment>>? attachments,
    ...
    pulumi.Output<String>? volumeType,
      ...
      attachments = pulumi.Input.asOptionalInput<List<VolumeAttachment>>(attachments),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'attachments': ?pulumi.Input.mapOptionalInputValue<List<VolumeAttachment>, List<Map<String, dynamic>>>(attachments, (value) => pulumi.Input.encodeList<VolumeAttachment, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory VolumeState.fromMap(Map<String, dynamic> map) {
    return VolumeState(
      attachments: map['attachments'] == null ? null : pulumi.Output.create<List<VolumeAttachment>>(pulumi.Input.decodeList<VolumeAttachment>(map['attachments'], (value) => VolumeAttachment.fromMap((value as Map).cast<String, dynamic>()))),
