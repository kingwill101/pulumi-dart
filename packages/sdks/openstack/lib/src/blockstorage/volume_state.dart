...
class VolumeState {
  ...
  factory VolumeState.fromMap(Map<String, dynamic> map) {
    return VolumeState(
      attachments: (() { final guardedValue = map['attachments']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<VolumeAttachment>(guardedValue, (value) => VolumeAttachment.fromMap((value as Map).cast<String, dynamic>()))); })(),
