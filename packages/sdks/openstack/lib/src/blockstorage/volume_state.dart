...
class VolumeState {
  ...
  factory VolumeState.fromMap(Map<String, dynamic> map) {
    return VolumeState(
      attachments: map['attachments'] == null ? null : (pulumi.Input.decodeList<VolumeAttachment>(map['attachments']!, (value) => VolumeAttachment.fromMap((value as Map).cast<String, dynamic>()))).input(),
