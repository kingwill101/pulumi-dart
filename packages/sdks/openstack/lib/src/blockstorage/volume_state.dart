...
class VolumeState {
  ...
  factory VolumeState.fromMap(Map<String, dynamic> map) {
    return VolumeState(
      attachments: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VolumeAttachment>(
            guardedValue,
            (value) => VolumeAttachment.fromMap(
      ...
      consistencyGroupId: (() {
        final guardedValue = map['consistencyGroupId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      description: (() {
      ...
      enableOnlineResize: (() {
        final guardedValue = map['enableOnlineResize'];
        if (guardedValue == null) return null;
      ...
      schedulerHints: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VolumeSchedulerHint>(
            guardedValue,
            (value) => VolumeSchedulerHint.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      sourceReplica: (() {
        final guardedValue = map['sourceReplica'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      sourceVolId: (() {
        final guardedValue = map['sourceVolId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      volumeRetypePolicy: (() {
        final guardedValue = map['volumeRetypePolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      volumeType: (() {
