...
class StackV1State {
  ...
  factory StackV1State.fromMap(Map<String, dynamic> map) {
    return StackV1State(
      stackOutputs: (() { final guardedValue = map['StackOutputs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<StackV1StackOutput>(guardedValue, (value) => StackV1StackOutput.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      environmentOpts: (() { final guardedValue = map['environmentOpts']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      notificationTopics: (() { final guardedValue = map['notificationTopics']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      ...
      templateOpts: (() { final guardedValue = map['templateOpts']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
