...
class StackV1State {
  ...
  StackV1State({
    ...
    pulumi.Output<Map<String, String>>? templateOpts,
    ...
    pulumi.Output<String>? updatedTime,
      ...
      templateOpts = pulumi.Input.asOptionalInput<Map<String, String>>(templateOpts),
  ...
  factory StackV1State.fromMap(Map<String, dynamic> map) {
    return StackV1State(
      ...
      templateOpts: map['templateOpts'] == null ? null : pulumi.Output.create<Map<String, String>>((map['templateOpts'] as Map).cast<String, String>()),
