...
import 'bgpvpn_router_associate_v2_args.dart';
import 'bgpvpn_router_associate_v2_state.dart';
...
class BgpvpnRouterAssociateV2 extends pulumi.CustomResource {
  ...
  /// Creates a new [BgpvpnRouterAssociateV2].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [BgpvpnRouterAssociateV2]. {@macro pulumi_index_bgpvpn_router_associate_v2_bgpvpn_router_associate_v2_args_doc}
  ...
  BgpvpnRouterAssociateV2(
    ...
    this.advertiseExtraRoutes = registerOutput<bool>('advertiseExtraRoutes');
  ...
  /// Gets an existing [BgpvpnRouterAssociateV2] resource's state with the given [name] and [id].
  static BgpvpnRouterAssociateV2 get(
    String name,
    pulumi.Input<String> id, {
    BgpvpnRouterAssociateV2State? state,
  }) {
    return BgpvpnRouterAssociateV2._get(
      name,
      state: state?.toMap(),
