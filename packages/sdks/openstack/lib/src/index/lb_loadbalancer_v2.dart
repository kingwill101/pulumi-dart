...
import 'lb_loadbalancer_v2_args.dart';
import 'lb_loadbalancer_v2_state.dart';
...
class LbLoadbalancerV2 extends pulumi.CustomResource {
  ...
  /// Creates a new [LbLoadbalancerV2].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [LbLoadbalancerV2]. {@macro pulumi_index_lb_loadbalancer_v2_lb_loadbalancer_v2_args_doc}
  ...
  LbLoadbalancerV2(
    ...
    loadbalancerProvider = registerOutput<String>('loadbalancerProvider');
    this.name = registerOutput<String>('name');
    region = registerOutput<String>('region');
    securityGroupIds = registerOutput<List<String>>('securityGroupIds');
    tags = registerOutput<List<String>?>('tags');
    tenantId = registerOutput<String>('tenantId');
    vipAddress = registerOutput<String>('vipAddress');
    vipNetworkId = registerOutput<String>('vipNetworkId');
    vipPortId = registerOutput<String>('vipPortId');
    vipQosPolicyId = registerOutput<String?>('vipQosPolicyId');
    vipSubnetId = registerOutput<String>('vipSubnetId');
  }

  /// Gets an existing [LbLoadbalancerV2] resource's state with the given [name] and [id].
  static LbLoadbalancerV2 get(
    String name,
    pulumi.Input<String> id, {
    LbLoadbalancerV2State? state,
  }) {
    return LbLoadbalancerV2._get(
      name,
      state: state?.toMap(),
