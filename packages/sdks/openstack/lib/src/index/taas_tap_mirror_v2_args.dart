...
class TaasTapMirrorV2Args {
  ...
  factory TaasTapMirrorV2Args.fromMap(Map<String, dynamic> map) {
    return TaasTapMirrorV2Args(
      ...
      directions: pulumi.Input.fromValue(TaasTapMirrorV2Directions.fromMap((map['directions']! as Map).cast<String, dynamic>())),
      mirrorType: pulumi.Input.fromValue(map['mirrorType'] as String),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      portId: pulumi.Input.fromValue(map['portId'] as String),
      region: (() { final guardedValue = map['region']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      remoteIp: pulumi.Input.fromValue(map['remoteIp'] as String),
