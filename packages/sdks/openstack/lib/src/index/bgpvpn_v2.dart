...
import 'bgpvpn_v2_args.dart';
import 'bgpvpn_v2_state.dart';
...
class BgpvpnV2 extends pulumi.CustomResource {
  ...
  /// Creates a new [BgpvpnV2].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [BgpvpnV2]. {@macro pulumi_index_bgpvpn_v2_bgpvpn_v2_args_doc}
  ...
  BgpvpnV2(
    ...
    routeDistinguishers = registerOutput<List<String>>('routeDistinguishers');
    routeTargets = registerOutput<List<String>>('routeTargets');
    routers = registerOutput<List<String>>('routers');
    shared = registerOutput<bool>('shared');
    type = registerOutput<String>('type');
    vni = registerOutput<int?>('vni');
  }

  /// Gets an existing [BgpvpnV2] resource's state with the given [name] and [id].
  static BgpvpnV2 get(
    String name,
    pulumi.Input<String> id, {
    BgpvpnV2State? state,
  }) {
    return BgpvpnV2._get(
      name,
      state: state?.toMap(),
