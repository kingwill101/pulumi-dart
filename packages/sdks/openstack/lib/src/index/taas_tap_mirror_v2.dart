...
import 'taas_tap_mirror_v2_state.dart';
...
class TaasTapMirrorV2 extends pulumi.CustomResource {
  ...
  TaasTapMirrorV2(
    ...
    remoteIp = registerOutput<String>('remoteIp');
    tenantId = registerOutput<String>('tenantId');
  }

  /// Gets an existing [TaasTapMirrorV2] resource's state with the given [name] and [id].
  static TaasTapMirrorV2 get(
    String name,
    pulumi.Input<String> id, {
    TaasTapMirrorV2State? state,
  }) {
    return TaasTapMirrorV2._get(
      name,
      state: state?.toMap(),
