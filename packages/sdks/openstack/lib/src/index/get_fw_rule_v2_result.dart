...
class GetFwRuleV2Result {
  ...
  factory GetFwRuleV2Result.fromMap(Map<String, dynamic> map) {
    return GetFwRuleV2Result(
      ...
      destinationPort: (() { final guardedValue = map['destinationPort']; if (guardedValue == null) return null; return guardedValue as String; })(),
      ...
      sourceIpAddress: (() { final guardedValue = map['sourceIpAddress']; if (guardedValue == null) return null; return guardedValue as String; })(),
      sourcePort: (() { final guardedValue = map['sourcePort']; if (guardedValue == null) return null; return guardedValue as String; })(),
