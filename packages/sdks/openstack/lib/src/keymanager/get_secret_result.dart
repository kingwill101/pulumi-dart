...
class GetSecretResult {
  ...
  factory GetSecretResult.fromMap(Map<String, dynamic> map) {
    return GetSecretResult(
      aclOnly: (() { final guardedValue = map['aclOnly']; if (guardedValue == null) return null; return guardedValue as bool; })(),
      ...
      bitLength: (() { final guardedValue = map['bitLength']; if (guardedValue == null) return null; return guardedValue as int; })(),
      contentTypes: (map['contentTypes'] as Map).cast<String, String>(),
      createdAt: map['createdAt'] as String,
      createdAtFilter: (() { final guardedValue = map['createdAtFilter']; if (guardedValue == null) return null; return guardedValue as String; })(),
      creatorId: map['creatorId'] as String,
      expiration: map['expiration'] as String,
      expirationFilter: (() { final guardedValue = map['expirationFilter']; if (guardedValue == null) return null; return guardedValue as String; })(),
      id: map['id'] as String,
      ...
      secretType: (() { final guardedValue = map['secretType']; if (guardedValue == null) return null; return guardedValue as String; })(),
      status: map['status'] as String,
      updatedAt: map['updatedAt'] as String,
      updatedAtFilter: (() { final guardedValue = map['updatedAtFilter']; if (guardedValue == null) return null; return guardedValue as String; })(),
    );
  }
}
