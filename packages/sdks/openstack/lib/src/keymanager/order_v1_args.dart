...
class OrderV1Args {
  ...
  OrderV1Args({required this.meta, this.region, required this.type});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'meta': pulumi.Input.mapInputValue<OrderV1Meta, Map<String, dynamic>>(
        meta,
        (value) => value.toMap(),
      ),
      'region': ?region,
  ...
  factory OrderV1Args.fromMap(Map<String, dynamic> map) {
    return OrderV1Args(
      meta: pulumi.Input.fromValue(
        OrderV1Meta.fromMap((map['meta']! as Map).cast<String, dynamic>()),
      ),
      region: (() {
