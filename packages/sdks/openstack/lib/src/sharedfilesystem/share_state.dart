...
class ShareState {
  ...
  factory ShareState.fromMap(Map<String, dynamic> map) {
    return ShareState(
      ...
      exportLocations: (() { final guardedValue = map['exportLocations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ShareExportLocation>(guardedValue, (value) => ShareExportLocation.fromMap((value as Map).cast<String, dynamic>()))); })(),
      hasReplicas: (() { final guardedValue = map['hasReplicas']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      shareProto: (() { final guardedValue = map['shareProto']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      shareServerId: (() { final guardedValue = map['shareServerId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
