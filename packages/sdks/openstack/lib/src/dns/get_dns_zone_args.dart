...
class GetDnsZoneArgs {
  ...
  GetDnsZoneArgs({
    ...
    pulumi.Output<int>? serial,
    pulumi.Output<String>? status,
    pulumi.Output<String>? transferredAt,
  ...
  factory GetDnsZoneArgs.fromMap(Map<String, dynamic> map) {
    return GetDnsZoneArgs(
      ...
      serial: map['serial'] == null ? null : pulumi.Output.create<int>(map['serial'] as int),
      status: map['status'] == null ? null : pulumi.Output.create<String>(map['status'] as String),
      transferredAt: map['transferredAt'] == null ? null : pulumi.Output.create<String>(map['transferredAt'] as String),
