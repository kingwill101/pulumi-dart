...
import 'network_associate_v2_state.dart';
...
class NetworkAssociateV2 extends pulumi.CustomResource {
  ...
  /// Gets an existing [NetworkAssociateV2] resource's state with the given [name] and [id].
  static NetworkAssociateV2 get(
    String name,
    pulumi.Input<String> id, {
    NetworkAssociateV2State? state,
  }) {
    return NetworkAssociateV2._get(
      name,
      state: state?.toMap(),
