...
class PortAssociateV2 extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [PortAssociateV2]. {@macro pulumi_bgpvpn_port_associate_v2_port_associate_v2_args_doc}
  ...
  static PortAssociateV2 get(
    String name,
    pulumi.Input<String> id, {
    PortAssociateV2State? state,
  }) {
    return PortAssociateV2._get(
      name,
      state: state?.toMap(),
