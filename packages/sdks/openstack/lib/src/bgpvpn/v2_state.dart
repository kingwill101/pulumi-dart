...
class V2State {
  ...
  factory V2State.fromMap(Map<String, dynamic> map) {
    return V2State(
      exportTargets: (() { final guardedValue = map['exportTargets']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      importTargets: (() { final guardedValue = map['importTargets']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      ...
      routeDistinguishers: (() { final guardedValue = map['routeDistinguishers']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      routeTargets: (() { final guardedValue = map['routeTargets']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      routers: (() { final guardedValue = map['routers']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
