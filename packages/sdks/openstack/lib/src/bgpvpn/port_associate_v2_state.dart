...
class PortAssociateV2State {
  ...
  factory PortAssociateV2State.fromMap(Map<String, dynamic> map) {
    return PortAssociateV2State(
      ...
      routes: (() { final guardedValue = map['routes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PortAssociateV2Route>(guardedValue, (value) => PortAssociateV2Route.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
