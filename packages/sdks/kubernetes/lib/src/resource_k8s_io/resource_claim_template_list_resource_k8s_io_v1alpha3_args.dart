...
class ResourceClaimTemplateListResourceK8sIoV1alpha3Args {
  ...
  final pulumi.Input<List<ResourceClaimTemplateResourceK8sIoV1alpha3Resource>>
  items;
  ...
  factory ResourceClaimTemplateListResourceK8sIoV1alpha3Args.fromMap(
    ...
    return ResourceClaimTemplateListResourceK8sIoV1alpha3Args(
      ...
      items: pulumi.Input.fromValue(
        (map['items'] as List)
            .cast<ResourceClaimTemplateResourceK8sIoV1alpha3Resource>(),
      ),
      kind: (() {
