...
class ResourceClaimResourceK8sIoV1beta2 {
  ...
  const ResourceClaimResourceK8sIoV1beta2({
    this.apiVersion,
    this.kind,
    this.metadata,
    required this.spec,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'status': ?pulumi.Input.mapOptionalInputValue<ResourceClaimStatusResourceK8sIoV1beta2, Map<String, dynamic>>(status, (value) => value.toMap()),
    };
  }

  factory ResourceClaimResourceK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return ResourceClaimResourceK8sIoV1beta2(
      ...
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResourceClaimStatusResourceK8sIoV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
