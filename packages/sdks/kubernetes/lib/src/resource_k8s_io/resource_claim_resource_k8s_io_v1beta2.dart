...
class ResourceClaimResourceK8sIoV1beta2 {
  ...
  final ResourceClaimStatusResourceK8sIoV1beta2? status;
  ...
  factory ResourceClaimResourceK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return ResourceClaimResourceK8sIoV1beta2(
      ...
      status: map['status'] == null ? null : ResourceClaimStatusResourceK8sIoV1beta2.fromMap((map['status'] as Map).cast<String, dynamic>()),
    );
  }
}
