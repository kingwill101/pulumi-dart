...
class DeviceAllocationResultPatch {
  ...
  DeviceAllocationResultPatch({this.config, this.results});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'config':
          ?pulumi.Input.mapOptionalInputValue<
            List<DeviceAllocationConfigurationPatch>,
      ...
      'results':
          ?pulumi.Input.mapOptionalInputValue<
            List<DeviceRequestAllocationResultPatch>,
            List<Map<String, dynamic>>
          >(
            results,
            (value) =>
    ...
    return DeviceAllocationResultPatch(
      config: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DeviceAllocationConfigurationPatch>(
            guardedValue,
            (value) => DeviceAllocationConfigurationPatch.fromMap(
      ...
      results: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DeviceRequestAllocationResultPatch>(
            guardedValue,
            (value) => DeviceRequestAllocationResultPatch.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
