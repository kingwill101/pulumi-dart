...
class OpaqueDeviceConfigurationPatchResourceK8sIoV1beta1 {
  ...
  /// Creates a new [OpaqueDeviceConfigurationPatchResourceK8sIoV1beta1].
  ...
  const OpaqueDeviceConfigurationPatchResourceK8sIoV1beta1({
    this.driver,
    this.parameters,
  });
  ...
  factory OpaqueDeviceConfigurationPatchResourceK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return OpaqueDeviceConfigurationPatchResourceK8sIoV1beta1(
