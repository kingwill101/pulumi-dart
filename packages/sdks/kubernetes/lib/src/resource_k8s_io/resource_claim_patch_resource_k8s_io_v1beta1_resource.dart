...
import 'resource_claim_patch_resource_k8s_io_v1beta1_args.dart';
...
class ResourceClaimPatchResourceK8sIoV1beta1Resource extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [ResourceClaimPatchResourceK8sIoV1beta1Resource]. {@macro pulumi_resource_k8s_io_v1beta1_resource_claim_patch_resource_k8s_io_v1beta1_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  ResourceClaimPatchResourceK8sIoV1beta1Resource(
    String name, {
  ...
  /// Creates a typed reference to an existing [ResourceClaimPatchResourceK8sIoV1beta1Resource] resource.
  ResourceClaimPatchResourceK8sIoV1beta1Resource.reference(String urn)
    : super(
        'kubernetes:resource.k8s.io/v1beta1:ResourceClaimPatch',
