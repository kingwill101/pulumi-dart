...
class DeviceClassPatchArgs {
  ...
  factory DeviceClassPatchArgs.fromMap(Map<String, dynamic> map) {
    return DeviceClassPatchArgs(
      ...
      spec: (() { final guardedValue = map['spec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DeviceClassSpecPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
