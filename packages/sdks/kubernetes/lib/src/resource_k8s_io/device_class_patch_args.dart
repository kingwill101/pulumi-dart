...
class DeviceClassPatchArgs {
  ...
  DeviceClassPatchArgs({
    ...
    pulumi.Output<DeviceClassSpecPatch>? spec,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMetaPatch>(metadata),
      spec = pulumi.Input.asOptionalInput<DeviceClassSpecPatch>(spec);
  ...
  factory DeviceClassPatchArgs.fromMap(Map<String, dynamic> map) {
    return DeviceClassPatchArgs(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<DeviceClassSpecPatch>(DeviceClassSpecPatch.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
