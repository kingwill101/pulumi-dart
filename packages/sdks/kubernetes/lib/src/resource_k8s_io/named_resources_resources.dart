...
class NamedResourcesResources {
  ...
  factory NamedResourcesResources.fromMap(Map<String, dynamic> map) {
    return NamedResourcesResources(
      instances: pulumi.Input.fromValue(pulumi.Input.decodeList<NamedResourcesInstance>(map['instances']!, (value) => NamedResourcesInstance.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
