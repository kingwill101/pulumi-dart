...
class BasicDeviceResourceK8sIoV1beta1 {
  ...
  final pulumi.Input<Map<String, DeviceAttributeResourceK8sIoV1beta1>>?
  attributes;
  ...
  final pulumi.Input<List<DeviceCounterConsumptionResourceK8sIoV1beta1>>?
  consumesCounters;
    ...
    return <String, dynamic>{
      ...
      'attributes':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, DeviceAttributeResourceK8sIoV1beta1>,
            Map<String, Map<String, dynamic>>
          >(
            attributes,
            (value) =>
                pulumi.Input.encodeMapValues<
                  DeviceAttributeResourceK8sIoV1beta1,
                  Map<String, dynamic>
      ...
      'capacity':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, DeviceCapacityResourceK8sIoV1beta1>,
            Map<String, Map<String, dynamic>>
          >(
            capacity,
            (value) =>
                pulumi.Input.encodeMapValues<
                  DeviceCapacityResourceK8sIoV1beta1,
                  Map<String, dynamic>
                >(value, (value) => value.toMap()),
          ),
      'consumesCounters':
          ?pulumi.Input.mapOptionalInputValue<
            List<DeviceCounterConsumptionResourceK8sIoV1beta1>,
      ...
      'taints':
          ?pulumi.Input.mapOptionalInputValue<
            List<DeviceTaintResourceK8sIoV1beta1>,
            List<Map<String, dynamic>>
          >(
            taints,
            (value) =>
    ...
    return BasicDeviceResourceK8sIoV1beta1(
      ...
      attributes: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<DeviceAttributeResourceK8sIoV1beta1>(
            guardedValue,
            (value) => DeviceAttributeResourceK8sIoV1beta1.fromMap(
      ...
      capacity: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<DeviceCapacityResourceK8sIoV1beta1>(
            guardedValue,
            (value) => DeviceCapacityResourceK8sIoV1beta1.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      consumesCounters: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DeviceCounterConsumptionResourceK8sIoV1beta1>(
            guardedValue,
            (value) => DeviceCounterConsumptionResourceK8sIoV1beta1.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      taints: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DeviceTaintResourceK8sIoV1beta1>(
            guardedValue,
            (value) => DeviceTaintResourceK8sIoV1beta1.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
