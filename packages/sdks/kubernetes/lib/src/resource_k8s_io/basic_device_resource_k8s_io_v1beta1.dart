...
class BasicDeviceResourceK8sIoV1beta1 {
  ...
  final List<DeviceCounterConsumptionResourceK8sIoV1beta1>? consumesCounters;
  ...
  final List<DeviceTaintResourceK8sIoV1beta1>? taints;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'consumesCounters': ?consumesCounters == null ? null : pulumi.Input.encodeList<DeviceCounterConsumptionResourceK8sIoV1beta1, Map<String, dynamic>>(consumesCounters!, (value) => value.toMap()),
      'nodeName': ?nodeName,
      'nodeSelector': ?nodeSelector == null ? null : nodeSelector!.toMap(),
      'taints': ?taints == null ? null : pulumi.Input.encodeList<DeviceTaintResourceK8sIoV1beta1, Map<String, dynamic>>(taints!, (value) => value.toMap()),
    };
  }
  ...
  factory BasicDeviceResourceK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return BasicDeviceResourceK8sIoV1beta1(
      ...
      consumesCounters: map['consumesCounters'] == null ? null : pulumi.Input.decodeList<DeviceCounterConsumptionResourceK8sIoV1beta1>(map['consumesCounters'], (value) => DeviceCounterConsumptionResourceK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>())),
      ...
      taints: map['taints'] == null ? null : pulumi.Input.decodeList<DeviceTaintResourceK8sIoV1beta1>(map['taints'], (value) => DeviceTaintResourceK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
