...
class NodeAllocatableOverheadPatch {
  ...
  /// Creates a new [NodeAllocatableOverheadPatch].
  ...
  const NodeAllocatableOverheadPatch({
    this.perContainer,
    this.perPod,
  });
  ...
  factory NodeAllocatableOverheadPatch.fromMap(Map<String, dynamic> map) {
    return NodeAllocatableOverheadPatch(
