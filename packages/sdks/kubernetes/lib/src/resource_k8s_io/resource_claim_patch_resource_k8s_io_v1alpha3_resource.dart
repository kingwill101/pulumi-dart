...
class ResourceClaimPatchResourceK8sIoV1alpha3Resource
  ...
  ResourceClaimPatchResourceK8sIoV1alpha3Resource(
    ...
    spec = registerOutput<ResourceClaimSpecPatchResourceK8sIoV1alpha3?>(
      'spec',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return ResourceClaimSpecPatchResourceK8sIoV1alpha3.fromMap(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      },
    );
    status = registerOutput<ResourceClaimStatusPatchResourceK8sIoV1alpha3?>(
      ...
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return ResourceClaimStatusPatchResourceK8sIoV1alpha3.fromMap(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      },
    );
