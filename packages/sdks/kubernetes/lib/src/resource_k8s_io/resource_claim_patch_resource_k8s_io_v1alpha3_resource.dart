...
class ResourceClaimPatchResourceK8sIoV1alpha3Resource extends pulumi.CustomResource {
  ...
  ResourceClaimPatchResourceK8sIoV1alpha3Resource(
    ...
    this.spec = registerOutput<ResourceClaimSpecPatchResourceK8sIoV1alpha3?>('spec');
    this.status = registerOutput<ResourceClaimStatusPatchResourceK8sIoV1alpha3?>('status');
  }
}
