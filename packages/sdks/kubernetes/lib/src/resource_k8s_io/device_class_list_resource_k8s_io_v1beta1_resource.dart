...
class DeviceClassListResourceK8sIoV1beta1Resource extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<DeviceClassResourceK8sIoV1beta1Resource>> items;
  ...
  DeviceClassListResourceK8sIoV1beta1Resource(
    ...
    this.items = registerOutput<List<DeviceClassResourceK8sIoV1beta1Resource>>('items');
