...
class DeviceConstraintResourceK8sIoV1beta1 {
  ...
  /// Creates a new [DeviceConstraintResourceK8sIoV1beta1].
  ...
  factory DeviceConstraintResourceK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return DeviceConstraintResourceK8sIoV1beta1(
