...
class ResourceClaimParametersList {
  ...
  /// Creates a new [ResourceClaimParametersList].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'items': pulumi.Input.encodeList<ResourceClaimParameters, Map<String, dynamic>>(items, (value) => value.toMap()),
      'kind': ?kind,
      'metadata': ?metadata == null ? null : metadata!.toMap(),
    };
  }

  factory ResourceClaimParametersList.fromMap(Map<String, dynamic> map) {
    return ResourceClaimParametersList(
      apiVersion: map['apiVersion'] == null ? null : map['apiVersion'] as String,
      items: pulumi.Input.decodeList<ResourceClaimParameters>(map['items'], (value) => ResourceClaimParameters.fromMap((value as Map).cast<String, dynamic>())),
