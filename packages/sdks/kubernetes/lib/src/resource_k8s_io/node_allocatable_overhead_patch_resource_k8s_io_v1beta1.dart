...
class NodeAllocatableOverheadPatchResourceK8sIoV1beta1 {
  ...
  /// Creates a new [NodeAllocatableOverheadPatchResourceK8sIoV1beta1].
  ...
  const NodeAllocatableOverheadPatchResourceK8sIoV1beta1({
    this.perContainer,
    this.perPod,
  });
  ...
  factory NodeAllocatableOverheadPatchResourceK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return NodeAllocatableOverheadPatchResourceK8sIoV1beta1(
