...
class PodSchedulingContextListArgs {
  ...
  factory PodSchedulingContextListArgs.fromMap(Map<String, dynamic> map) {
    return PodSchedulingContextListArgs(
      ...
      items: pulumi.Input.fromValue(pulumi.Input.decodeList<PodSchedulingContext>(map['items']!, (value) => PodSchedulingContext.fromMap((value as Map).cast<String, dynamic>()))),
