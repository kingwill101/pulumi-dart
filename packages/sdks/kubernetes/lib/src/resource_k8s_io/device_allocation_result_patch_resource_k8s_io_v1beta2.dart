...
class DeviceAllocationResultPatchResourceK8sIoV1beta2 {
  ...
  factory DeviceAllocationResultPatchResourceK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return DeviceAllocationResultPatchResourceK8sIoV1beta2(
      config: (() { final guardedValue = map['config']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DeviceAllocationConfigurationPatchResourceK8sIoV1beta2>(guardedValue, (value) => DeviceAllocationConfigurationPatchResourceK8sIoV1beta2.fromMap((value as Map).cast<String, dynamic>()))); })(),
      results: (() { final guardedValue = map['results']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DeviceRequestAllocationResultPatchResourceK8sIoV1beta2>(guardedValue, (value) => DeviceRequestAllocationResultPatchResourceK8sIoV1beta2.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
