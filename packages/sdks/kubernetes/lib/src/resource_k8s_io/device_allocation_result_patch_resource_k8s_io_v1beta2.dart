...
class DeviceAllocationResultPatchResourceK8sIoV1beta2 {
  ...
  final pulumi.Input<
    List<DeviceAllocationConfigurationPatchResourceK8sIoV1beta2>
  >?
  config;

  /// Results lists all allocated devices.
  final pulumi.Input<
    List<DeviceRequestAllocationResultPatchResourceK8sIoV1beta2>
  >?
  results;
  ...
  DeviceAllocationResultPatchResourceK8sIoV1beta2({this.config, this.results});
  ...
  factory DeviceAllocationResultPatchResourceK8sIoV1beta2.fromMap(
      ...
      config: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                DeviceAllocationConfigurationPatchResourceK8sIoV1beta2.fromMap(
      ...
      results: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                DeviceRequestAllocationResultPatchResourceK8sIoV1beta2.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
