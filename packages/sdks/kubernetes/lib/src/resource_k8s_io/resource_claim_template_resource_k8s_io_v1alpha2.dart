    ...
    return <String, dynamic>{
      ...
      'spec':
          pulumi.Input.mapInputValue<
            ResourceClaimTemplateSpecResourceK8sIoV1alpha2,
            Map<String, dynamic>
          >(spec, (value) => value.toMap()),
    };
  }

  factory ResourceClaimTemplateResourceK8sIoV1alpha2.fromMap(
    ...
    return ResourceClaimTemplateResourceK8sIoV1alpha2(
      ...
      spec: pulumi.Input.fromValue(
        ResourceClaimTemplateSpecResourceK8sIoV1alpha2.fromMap(
