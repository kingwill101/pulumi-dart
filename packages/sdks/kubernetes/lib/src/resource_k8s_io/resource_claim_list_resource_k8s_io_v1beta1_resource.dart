...
class ResourceClaimListResourceK8sIoV1beta1Resource extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<ResourceClaimResourceK8sIoV1beta1Resource>> items;
  ...
  ResourceClaimListResourceK8sIoV1beta1Resource(
    ...
    this.items = registerOutput<List<ResourceClaimResourceK8sIoV1beta1Resource>>('items');
