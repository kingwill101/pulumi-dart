...
/// {@template pulumi_resource_k8s_io_v1_resource_claim_patch_args_doc}
...
class ResourceClaimPatchArgs {
  ...
  ResourceClaimPatchArgs({
    ...
    pulumi.Output<ResourceClaimSpecPatch>? spec,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMetaPatch>(metadata),
      spec = pulumi.Input.asOptionalInput<ResourceClaimSpecPatch>(spec);
  ...
  factory ResourceClaimPatchArgs.fromMap(Map<String, dynamic> map) {
    return ResourceClaimPatchArgs(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<ResourceClaimSpecPatch>(ResourceClaimSpecPatch.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
