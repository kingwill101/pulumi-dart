...
class ResourceClaimTemplateResourceK8sIoV1beta1Resource extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [ResourceClaimTemplateResourceK8sIoV1beta1Resource] resource.
  ResourceClaimTemplateResourceK8sIoV1beta1Resource.reference(String urn)
    : super(
        'kubernetes:resource.k8s.io/v1beta1:ResourceClaimTemplate',
