...
class PodSchedulingContextStatusPatch {
  ...
  final pulumi.Input<
    List<ResourceClaimSchedulingStatusPatchResourceK8sIoV1alpha2>
  >?
  resourceClaims;
  ...
  PodSchedulingContextStatusPatch({this.resourceClaims});
      ...
      resourceClaims: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                ResourceClaimSchedulingStatusPatchResourceK8sIoV1alpha2.fromMap(
