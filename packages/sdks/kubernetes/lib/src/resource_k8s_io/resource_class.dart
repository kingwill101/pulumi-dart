...
class ResourceClass {
  ...
  factory ResourceClass.fromMap(Map<String, dynamic> map) {
    return ResourceClass(
      ...
      parametersRef: (() { final guardedValue = map['parametersRef']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResourceClassParametersReference.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
