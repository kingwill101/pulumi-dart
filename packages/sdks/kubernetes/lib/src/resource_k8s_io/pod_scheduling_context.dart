...
class PodSchedulingContext {
  ...
  factory PodSchedulingContext.fromMap(Map<String, dynamic> map) {
    return PodSchedulingContext(
      ...
      spec: PodSchedulingContextSpec.fromMap((map['spec'] as Map).cast<String, dynamic>()),
      status: map['status'] == null ? null : PodSchedulingContextStatus.fromMap((map['status'] as Map).cast<String, dynamic>()),
    );
  }
}
