...
class ResourceClaimParametersListArgs {
  ...
  ResourceClaimParametersListArgs({
    pulumi.Output<String>? apiVersion,
    required pulumi.Output<List<ResourceClaimParametersResourceK8sIoV1alpha2>> items,
    pulumi.Output<String>? kind,
    pulumi.Output<ListMeta>? metadata,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      items = pulumi.Input.asInput<List<ResourceClaimParametersResourceK8sIoV1alpha2>>(items),
  ...
  factory ResourceClaimParametersListArgs.fromMap(Map<String, dynamic> map) {
    return ResourceClaimParametersListArgs(
      ...
      items: pulumi.Output.create<List<ResourceClaimParametersResourceK8sIoV1alpha2>>((map['items'] as List).cast<ResourceClaimParametersResourceK8sIoV1alpha2>()),
