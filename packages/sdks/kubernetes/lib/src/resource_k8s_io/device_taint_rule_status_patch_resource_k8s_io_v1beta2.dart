...
class DeviceTaintRuleStatusPatchResourceK8sIoV1beta2 {
  ...
  const DeviceTaintRuleStatusPatchResourceK8sIoV1beta2({
    this.conditions,
  });
  ...
  factory DeviceTaintRuleStatusPatchResourceK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return DeviceTaintRuleStatusPatchResourceK8sIoV1beta2(
