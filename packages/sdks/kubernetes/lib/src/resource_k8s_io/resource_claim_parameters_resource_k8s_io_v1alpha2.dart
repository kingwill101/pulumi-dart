...
class ResourceClaimParametersResourceK8sIoV1alpha2
  ...
  late final pulumi.Output<List<Map<String, dynamic>>> driverRequests;
  ...
  ResourceClaimParametersResourceK8sIoV1alpha2(
    ...
    driverRequests = registerOutput<List<Map<String, dynamic>>>(
      'driverRequests',
    );
    generatedFrom =
