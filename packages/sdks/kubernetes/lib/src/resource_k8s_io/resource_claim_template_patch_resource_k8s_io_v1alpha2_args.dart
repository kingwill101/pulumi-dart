...
class ResourceClaimTemplatePatchResourceK8sIoV1alpha2Args {
  ...
  const ResourceClaimTemplatePatchResourceK8sIoV1alpha2Args({
    this.apiVersion,
    this.kind,
    this.metadata,
    this.spec,
  ...
  factory ResourceClaimTemplatePatchResourceK8sIoV1alpha2Args.fromMap(Map<String, dynamic> map) {
    return ResourceClaimTemplatePatchResourceK8sIoV1alpha2Args(
      ...
      spec: (() { final guardedValue = map['spec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResourceClaimTemplateSpecPatchResourceK8sIoV1alpha2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
