...
class ResourceClaimTemplateListResourceK8sIoV1beta2Resource extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<ResourceClaimTemplateResourceK8sIoV1beta2Resource>> items;
  ...
  ResourceClaimTemplateListResourceK8sIoV1beta2Resource(
    ...
    this.items = registerOutput<List<ResourceClaimTemplateResourceK8sIoV1beta2Resource>>('items');
