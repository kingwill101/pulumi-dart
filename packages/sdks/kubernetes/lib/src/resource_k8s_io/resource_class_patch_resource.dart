...
class ResourceClassPatchResource extends pulumi.CustomResource {
  ...
  ResourceClassPatchResource(
    ...
    this.parametersRef = registerOutput<ResourceClassParametersReferencePatchResourceK8sIoV1alpha2?>('parametersRef');
    this.structuredParameters = registerOutput<bool?>('structuredParameters');
