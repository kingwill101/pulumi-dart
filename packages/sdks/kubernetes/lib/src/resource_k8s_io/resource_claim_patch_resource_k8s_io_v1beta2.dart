...
class ResourceClaimPatchResourceK8sIoV1beta2 {
  ...
  final pulumi.Input<ResourceClaimStatusPatchResourceK8sIoV1beta2>? status;

  /// Creates a new [ResourceClaimPatchResourceK8sIoV1beta2].
  ...
  const ResourceClaimPatchResourceK8sIoV1beta2({
    this.apiVersion,
    this.kind,
    this.metadata,
    this.spec,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'status': ?pulumi.Input.mapOptionalInputValue<ResourceClaimStatusPatchResourceK8sIoV1beta2, Map<String, dynamic>>(status, (value) => value.toMap()),
    };
  }

  factory ResourceClaimPatchResourceK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return ResourceClaimPatchResourceK8sIoV1beta2(
      ...
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResourceClaimStatusPatchResourceK8sIoV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
