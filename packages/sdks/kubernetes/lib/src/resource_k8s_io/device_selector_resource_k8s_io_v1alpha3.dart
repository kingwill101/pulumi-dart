...
class DeviceSelectorResourceK8sIoV1alpha3 {
  ...
  final pulumi.Input<CELDeviceSelectorResourceK8sIoV1alpha3>? cel;
  ...
  factory DeviceSelectorResourceK8sIoV1alpha3.fromMap(Map<String, dynamic> map) {
    return DeviceSelectorResourceK8sIoV1alpha3(
      cel: map['cel'] == null ? null : (CELDeviceSelectorResourceK8sIoV1alpha3.fromMap((map['cel']! as Map).cast<String, dynamic>())).input(),
    );
  }
}
