...
class DeviceAllocationResult {
  ...
  DeviceAllocationResult({this.config, this.results});
    ...
    return DeviceAllocationResult(
      config: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DeviceAllocationConfiguration>(
            guardedValue,
            (value) => DeviceAllocationConfiguration.fromMap(
      ...
      results: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DeviceRequestAllocationResult>(
            guardedValue,
            (value) => DeviceRequestAllocationResult.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
