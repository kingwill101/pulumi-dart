...
class DeviceClaimPatch {
  ...
  DeviceClaimPatch({this.config, this.constraints, this.requests});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'config':
          ?pulumi.Input.mapOptionalInputValue<
            List<DeviceClaimConfigurationPatch>,
    ...
    return DeviceClaimPatch(
      config: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DeviceClaimConfigurationPatch>(
            guardedValue,
            (value) => DeviceClaimConfigurationPatch.fromMap(
      ...
      constraints: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DeviceConstraintPatch>(
            guardedValue,
            (value) => DeviceConstraintPatch.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      requests: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DeviceRequestPatch>(
            guardedValue,
            (value) => DeviceRequestPatch.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
