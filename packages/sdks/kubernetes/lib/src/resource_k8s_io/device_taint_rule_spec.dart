...
class DeviceTaintRuleSpec {
  ...
  DeviceTaintRuleSpec({this.deviceSelector, required this.taint});
    ...
    return DeviceTaintRuleSpec(
      deviceSelector: (() {
        ...
        return pulumi.Input.fromValue(
          DeviceTaintSelector.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      taint: pulumi.Input.fromValue(
        DeviceTaintResourceK8sIoV1alpha3.fromMap(
          (map['taint']! as Map).cast<String, dynamic>(),
        ),
      ),
    );
  }
