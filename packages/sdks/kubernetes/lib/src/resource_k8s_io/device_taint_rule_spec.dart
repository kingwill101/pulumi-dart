...
class DeviceTaintRuleSpec {
  ...
  final pulumi.Input<DeviceTaint> taint;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'taint': pulumi.Input.mapInputValue<DeviceTaint, Map<String, dynamic>>(taint, (value) => value.toMap()),
    };
  }
  ...
  factory DeviceTaintRuleSpec.fromMap(Map<String, dynamic> map) {
    return DeviceTaintRuleSpec(
      ...
      taint: pulumi.Input.fromValue(DeviceTaint.fromMap((map['taint']! as Map).cast<String, dynamic>())),
    );
  }
}
