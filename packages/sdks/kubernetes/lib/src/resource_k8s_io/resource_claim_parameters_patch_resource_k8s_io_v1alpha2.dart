...
class ResourceClaimParametersPatchResourceK8sIoV1alpha2 extends pulumi.CustomResource {
  ...
  ResourceClaimParametersPatchResourceK8sIoV1alpha2(
    ...
    driverRequests = registerOutput<List<DriverRequestsPatch>?>('driverRequests', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return pulumi.Input.decodeList<DriverRequestsPatch>(guardedValue, (value) => DriverRequestsPatch.fromMap((value as Map).cast<String, dynamic>())); });
    generatedFrom = registerOutput<ResourceClaimParametersReferencePatchResourceK8sIoV1alpha2?>('generatedFrom', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ResourceClaimParametersReferencePatchResourceK8sIoV1alpha2.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    kind = registerOutput<String?>('kind');
    metadata = registerOutput<ObjectMetaPatch?>('metadata', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ObjectMetaPatch.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    shareable = registerOutput<bool?>('shareable');
  }

  /// Creates a typed reference to an existing [ResourceClaimParametersPatchResourceK8sIoV1alpha2] resource.
  ResourceClaimParametersPatchResourceK8sIoV1alpha2.reference(String urn)
    : super(
        'kubernetes:resource.k8s.io/v1alpha2:ResourceClaimParametersPatch',
