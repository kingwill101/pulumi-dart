...
class DriverAllocationResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'namedResources': ?pulumi.Input.mapOptionalInputValue<NamedResourcesAllocationResult, Map<String, dynamic>>(namedResources, (value) => value.toMap()),
  ...
  factory DriverAllocationResult.fromMap(Map<String, dynamic> map) {
    return DriverAllocationResult(
      namedResources: (() { final guardedValue = map['namedResources']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NamedResourcesAllocationResult.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
