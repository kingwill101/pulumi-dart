...
class DeviceDerivedAttributePatch {
  ...
  /// Creates a new [DeviceDerivedAttributePatch].
  ...
  const DeviceDerivedAttributePatch({
    this.expression,
    this.name,
  });
  ...
  factory DeviceDerivedAttributePatch.fromMap(Map<String, dynamic> map) {
    return DeviceDerivedAttributePatch(
