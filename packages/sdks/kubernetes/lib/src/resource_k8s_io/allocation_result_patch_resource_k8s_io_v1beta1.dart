...
import 'device_allocation_result_patch_resource_k8s_io_v1beta1.dart';

/// AllocationResult contains attributes of an allocated resource.
class AllocationResultPatchResourceK8sIoV1beta1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'devices': ?pulumi.Input.mapOptionalInputValue<DeviceAllocationResultPatchResourceK8sIoV1beta1, Map<String, dynamic>>(devices, (value) => value.toMap()),
      'nodeSelector': ?pulumi.Input.mapOptionalInputValue<NodeSelectorPatch, Map<String, dynamic>>(nodeSelector, (value) => value.toMap()),
    };
  }

  factory AllocationResultPatchResourceK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return AllocationResultPatchResourceK8sIoV1beta1(
      ...
      devices: (() { final guardedValue = map['devices']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DeviceAllocationResultPatchResourceK8sIoV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
