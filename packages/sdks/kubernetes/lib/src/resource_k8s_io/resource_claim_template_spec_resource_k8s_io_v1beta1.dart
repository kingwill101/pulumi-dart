...
class ResourceClaimTemplateSpecResourceK8sIoV1beta1 {
  ...
  ResourceClaimTemplateSpecResourceK8sIoV1beta1({
    this.metadata,
    required this.spec,
  });
  ...
  factory ResourceClaimTemplateSpecResourceK8sIoV1beta1.fromMap(
    ...
    return ResourceClaimTemplateSpecResourceK8sIoV1beta1(
      ...
      spec: pulumi.Input.fromValue(
        ResourceClaimSpecResourceK8sIoV1beta1.fromMap(
