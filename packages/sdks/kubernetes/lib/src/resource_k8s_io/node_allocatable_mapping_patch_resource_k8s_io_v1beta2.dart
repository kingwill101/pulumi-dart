...
class NodeAllocatableMappingPatchResourceK8sIoV1beta2 {
  ...
  /// Creates a new [NodeAllocatableMappingPatchResourceK8sIoV1beta2].
  ...
  const NodeAllocatableMappingPatchResourceK8sIoV1beta2({
    this.capacityKey,
  ...
  factory NodeAllocatableMappingPatchResourceK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return NodeAllocatableMappingPatchResourceK8sIoV1beta2(
