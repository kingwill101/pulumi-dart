...
class Device {
  ...
  factory Device.fromMap(Map<String, dynamic> map) {
    return Device(
      ...
      consumesCounters: map['consumesCounters'] == null ? null : (pulumi.Input.decodeList<DeviceCounterConsumption>(map['consumesCounters'], (value) => DeviceCounterConsumption.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      taints: map['taints'] == null ? null : (pulumi.Input.decodeList<DeviceTaint>(map['taints'], (value) => DeviceTaint.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
