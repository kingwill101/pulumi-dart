...
class ResourceClaimConsumerReferenceResourceK8sIoV1alpha3 {
  ...
  /// Creates a new [ResourceClaimConsumerReferenceResourceK8sIoV1alpha3].
  ...
  const ResourceClaimConsumerReferenceResourceK8sIoV1alpha3({
    this.apiGroup,
    required this.name,
  ...
  factory ResourceClaimConsumerReferenceResourceK8sIoV1alpha3.fromMap(Map<String, dynamic> map) {
    return ResourceClaimConsumerReferenceResourceK8sIoV1alpha3(
