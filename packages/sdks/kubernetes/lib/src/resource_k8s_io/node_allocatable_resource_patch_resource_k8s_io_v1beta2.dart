...
import 'node_allocatable_mapping_patch_resource_k8s_io_v1beta2.dart';
import 'node_allocatable_overhead_patch_resource_k8s_io_v1beta2.dart';
...
class NodeAllocatableResourcePatchResourceK8sIoV1beta2 {
  ...
  final pulumi.Input<NodeAllocatableMappingPatchResourceK8sIoV1beta2?>? mapping;
  ...
  final pulumi.Input<NodeAllocatableOverheadPatchResourceK8sIoV1beta2?>? overhead;

  /// Creates a new [NodeAllocatableResourcePatchResourceK8sIoV1beta2].
  ...
  const NodeAllocatableResourcePatchResourceK8sIoV1beta2({
    this.mapping,
    this.overhead,
  });
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'mapping': ?pulumi.Input.mapOptionalInputValue<NodeAllocatableMappingPatchResourceK8sIoV1beta2, Map<String, dynamic>>(mapping, (value) => value.toMap()),
      'overhead': ?pulumi.Input.mapOptionalInputValue<NodeAllocatableOverheadPatchResourceK8sIoV1beta2, Map<String, dynamic>>(overhead, (value) => value.toMap()),
    };
  }

  factory NodeAllocatableResourcePatchResourceK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return NodeAllocatableResourcePatchResourceK8sIoV1beta2(
      mapping: (() { final guardedValue = map['mapping']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NodeAllocatableMappingPatchResourceK8sIoV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      overhead: (() { final guardedValue = map['overhead']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NodeAllocatableOverheadPatchResourceK8sIoV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
