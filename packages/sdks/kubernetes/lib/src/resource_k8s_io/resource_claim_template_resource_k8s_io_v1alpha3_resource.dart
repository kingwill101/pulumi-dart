...
class ResourceClaimTemplateResourceK8sIoV1alpha3Resource extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [ResourceClaimTemplateResourceK8sIoV1alpha3Resource] resource.
  ResourceClaimTemplateResourceK8sIoV1alpha3Resource.reference(String urn)
    : super(
        'kubernetes:resource.k8s.io/v1alpha3:ResourceClaimTemplate',
