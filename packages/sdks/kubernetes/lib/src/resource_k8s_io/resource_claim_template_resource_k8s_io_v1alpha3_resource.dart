...
class ResourceClaimTemplateResourceK8sIoV1alpha3Resource
  ...
  ResourceClaimTemplateResourceK8sIoV1alpha3Resource(
    ...
    spec = registerOutput<ResourceClaimTemplateSpecResourceK8sIoV1alpha3>(
      'spec',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return ResourceClaimTemplateSpecResourceK8sIoV1alpha3.fromMap(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      },
    );
