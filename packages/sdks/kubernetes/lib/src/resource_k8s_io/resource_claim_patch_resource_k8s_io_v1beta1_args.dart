...
class ResourceClaimPatchResourceK8sIoV1beta1Args {
  ...
  ResourceClaimPatchResourceK8sIoV1beta1Args({
    ...
    pulumi.Output<ResourceClaimSpecPatchResourceK8sIoV1beta1>? spec,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMetaPatch>(metadata),
      spec = pulumi.Input.asOptionalInput<ResourceClaimSpecPatchResourceK8sIoV1beta1>(spec);
  ...
  factory ResourceClaimPatchResourceK8sIoV1beta1Args.fromMap(Map<String, dynamic> map) {
    return ResourceClaimPatchResourceK8sIoV1beta1Args(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<ResourceClaimSpecPatchResourceK8sIoV1beta1>(ResourceClaimSpecPatchResourceK8sIoV1beta1.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
