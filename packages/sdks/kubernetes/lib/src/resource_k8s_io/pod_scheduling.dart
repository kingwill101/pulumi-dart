...
class PodScheduling {
  ...
  factory PodScheduling.fromMap(Map<String, dynamic> map) {
    return PodScheduling(
      ...
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PodSchedulingStatus.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
