...
class BasicDevicePatchResourceK8sIoV1beta1 {
  ...
  factory BasicDevicePatchResourceK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return BasicDevicePatchResourceK8sIoV1beta1(
      ...
      consumesCounters: map['consumesCounters'] == null ? null : (pulumi.Input.decodeList<DeviceCounterConsumptionPatchResourceK8sIoV1beta1>(map['consumesCounters']!, (value) => DeviceCounterConsumptionPatchResourceK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      taints: map['taints'] == null ? null : (pulumi.Input.decodeList<DeviceTaintPatchResourceK8sIoV1beta1>(map['taints']!, (value) => DeviceTaintPatchResourceK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
