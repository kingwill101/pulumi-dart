...
class BasicDevicePatchResourceK8sIoV1beta1 {
  ...
  final pulumi.Input<List<DeviceCounterConsumptionPatchResourceK8sIoV1beta1>>?
  consumesCounters;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'consumesCounters':
          ?pulumi.Input.mapOptionalInputValue<
            List<DeviceCounterConsumptionPatchResourceK8sIoV1beta1>,
      ...
      'taints':
          ?pulumi.Input.mapOptionalInputValue<
            List<DeviceTaintPatchResourceK8sIoV1beta1>,
            List<Map<String, dynamic>>
          >(
            taints,
            (value) =>
  ...
  factory BasicDevicePatchResourceK8sIoV1beta1.fromMap(
    ...
    return BasicDevicePatchResourceK8sIoV1beta1(
      ...
      consumesCounters: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                DeviceCounterConsumptionPatchResourceK8sIoV1beta1.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      taints: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DeviceTaintPatchResourceK8sIoV1beta1>(
            guardedValue,
            (value) => DeviceTaintPatchResourceK8sIoV1beta1.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
