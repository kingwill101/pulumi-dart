...
class DeviceClassSpecPatchResourceK8sIoV1beta2 {
  ...
  final pulumi.Input<List<DeviceClassConfigurationPatchResourceK8sIoV1beta2>>?
  config;
  ...
  DeviceClassSpecPatchResourceK8sIoV1beta2({
    this.config,
    ...
    return <String, dynamic>{
      'config':
          ?pulumi.Input.mapOptionalInputValue<
            List<DeviceClassConfigurationPatchResourceK8sIoV1beta2>,
      ...
      'selectors':
          ?pulumi.Input.mapOptionalInputValue<
            List<DeviceSelectorPatchResourceK8sIoV1beta2>,
            List<Map<String, dynamic>>
          >(
            selectors,
            (value) =>
  ...
  factory DeviceClassSpecPatchResourceK8sIoV1beta2.fromMap(
    ...
    return DeviceClassSpecPatchResourceK8sIoV1beta2(
      config: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                DeviceClassConfigurationPatchResourceK8sIoV1beta2.fromMap(
      ...
      selectors: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DeviceSelectorPatchResourceK8sIoV1beta2>(
            guardedValue,
            (value) => DeviceSelectorPatchResourceK8sIoV1beta2.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
