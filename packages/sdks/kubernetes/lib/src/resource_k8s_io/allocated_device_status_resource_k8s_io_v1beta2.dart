...
class AllocatedDeviceStatusResourceK8sIoV1beta2 {
  ...
  final NetworkDeviceDataResourceK8sIoV1beta2? networkData;
  ...
  factory AllocatedDeviceStatusResourceK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return AllocatedDeviceStatusResourceK8sIoV1beta2(
      ...
      networkData: map['networkData'] == null ? null : NetworkDeviceDataResourceK8sIoV1beta2.fromMap((map['networkData'] as Map).cast<String, dynamic>()),
