...
import 'network_device_data_resource_k8s_io_v1beta2.dart';
...
class AllocatedDeviceStatusResourceK8sIoV1beta2 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'device': device,
      'driver': driver,
      'networkData': ?pulumi.Input.mapOptionalInputValue<NetworkDeviceDataResourceK8sIoV1beta2, Map<String, dynamic>>(networkData, (value) => value.toMap()),
      'pool': pool,
      'shareID': ?shareID,
    };
  }

  factory AllocatedDeviceStatusResourceK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return AllocatedDeviceStatusResourceK8sIoV1beta2(
      ...
      networkData: (() { final guardedValue = map['networkData']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkDeviceDataResourceK8sIoV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
