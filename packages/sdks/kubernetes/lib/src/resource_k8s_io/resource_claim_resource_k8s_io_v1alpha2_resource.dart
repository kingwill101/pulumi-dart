...
class ResourceClaimResourceK8sIoV1alpha2Resource extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [ResourceClaimResourceK8sIoV1alpha2Resource] resource.
  ResourceClaimResourceK8sIoV1alpha2Resource.reference(String urn)
    : super(
        'kubernetes:resource.k8s.io/v1alpha2:ResourceClaim',
