...
class ResourceClaimTemplateListResourceK8sIoV1beta2Args {
  ...
  final pulumi.Input<List<ResourceClaimTemplateResourceK8sIoV1beta2Resource>>
  items;
  ...
  factory ResourceClaimTemplateListResourceK8sIoV1beta2Args.fromMap(
    ...
    return ResourceClaimTemplateListResourceK8sIoV1beta2Args(
      ...
      items: pulumi.Input.fromValue(
        (map['items'] as List)
            .cast<ResourceClaimTemplateResourceK8sIoV1beta2Resource>(),
      ),
      kind: (() {
