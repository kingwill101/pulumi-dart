...
class ResourceClaimTemplateListResourceK8sIoV1beta2Args {
  ...
  ResourceClaimTemplateListResourceK8sIoV1beta2Args({
    ...
    required pulumi.Output<List<ResourceClaimTemplateResourceK8sIoV1beta2Resource>> items,
  ...
  factory ResourceClaimTemplateListResourceK8sIoV1beta2Args.fromMap(Map<String, dynamic> map) {
    return ResourceClaimTemplateListResourceK8sIoV1beta2Args(
      ...
      items: pulumi.Output.create<List<ResourceClaimTemplateResourceK8sIoV1beta2Resource>>((map['items'] as List).cast<ResourceClaimTemplateResourceK8sIoV1beta2Resource>()),
