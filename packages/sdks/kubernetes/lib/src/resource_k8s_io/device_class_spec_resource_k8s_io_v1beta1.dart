...
class DeviceClassSpecResourceK8sIoV1beta1 {
  ...
  final pulumi.Input<List<DeviceClassConfigurationResourceK8sIoV1beta1>>? config;
  ...
  const DeviceClassSpecResourceK8sIoV1beta1({
    this.config,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'config': ?pulumi.Input.mapOptionalInputValue<List<DeviceClassConfigurationResourceK8sIoV1beta1>, List<Map<String, dynamic>>>(config, (value) => pulumi.Input.encodeList<DeviceClassConfigurationResourceK8sIoV1beta1, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory DeviceClassSpecResourceK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return DeviceClassSpecResourceK8sIoV1beta1(
      config: (() { final guardedValue = map['config']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DeviceClassConfigurationResourceK8sIoV1beta1>(guardedValue, (value) => DeviceClassConfigurationResourceK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>()))); })(),
