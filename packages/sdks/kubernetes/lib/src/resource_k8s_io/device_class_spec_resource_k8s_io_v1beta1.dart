...
class DeviceClassSpecResourceK8sIoV1beta1 {
  ...
  final pulumi.Input<List<DeviceClassConfigurationResourceK8sIoV1beta1>>?
  config;
    ...
    return <String, dynamic>{
      'config':
          ?pulumi.Input.mapOptionalInputValue<
            List<DeviceClassConfigurationResourceK8sIoV1beta1>,
      ...
      'selectors':
          ?pulumi.Input.mapOptionalInputValue<
            List<DeviceSelectorResourceK8sIoV1beta1>,
            List<Map<String, dynamic>>
          >(
            selectors,
            (value) =>
  ...
  factory DeviceClassSpecResourceK8sIoV1beta1.fromMap(
    ...
    return DeviceClassSpecResourceK8sIoV1beta1(
      config: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DeviceClassConfigurationResourceK8sIoV1beta1>(
            guardedValue,
            (value) => DeviceClassConfigurationResourceK8sIoV1beta1.fromMap(
      ...
      selectors: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DeviceSelectorResourceK8sIoV1beta1>(
            guardedValue,
            (value) => DeviceSelectorResourceK8sIoV1beta1.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
