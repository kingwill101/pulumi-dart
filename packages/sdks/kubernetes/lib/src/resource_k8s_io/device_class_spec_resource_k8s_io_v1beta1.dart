...
class DeviceClassSpecResourceK8sIoV1beta1 {
  ...
  factory DeviceClassSpecResourceK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return DeviceClassSpecResourceK8sIoV1beta1(
      config: map['config'] == null ? null : (pulumi.Input.decodeList<DeviceClassConfigurationResourceK8sIoV1beta1>(map['config']!, (value) => DeviceClassConfigurationResourceK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>()))).input(),
