...
class ResourceClaimStatusPatchResourceK8sIoV1alpha3 {
  ...
  final pulumi.Input<
    List<ResourceClaimConsumerReferencePatchResourceK8sIoV1alpha3>
  >?
  reservedFor;
          ...
          >(
            ...
            (value) =>
                pulumi.Input.encodeList<
                  ResourceClaimConsumerReferencePatchResourceK8sIoV1alpha3,
                  Map<String, dynamic>
  ...
  factory ResourceClaimStatusPatchResourceK8sIoV1alpha3.fromMap(
    ...
    return ResourceClaimStatusPatchResourceK8sIoV1alpha3(
      allocation: (() {
        ...
        return pulumi.Input.fromValue(
          AllocationResultPatchResourceK8sIoV1alpha3.fromMap(
      ...
      reservedFor: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                ResourceClaimConsumerReferencePatchResourceK8sIoV1alpha3.fromMap(
