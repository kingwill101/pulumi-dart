...
class ResourceClaimStatusPatchResourceK8sIoV1alpha3 {
  ...
  final pulumi.Input<AllocationResultPatchResourceK8sIoV1alpha3>? allocation;
  ...
  final pulumi.Input<List<ResourceClaimConsumerReferencePatchResourceK8sIoV1alpha3>>? reservedFor;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'allocation': ?pulumi.Input.mapOptionalInputValue<AllocationResultPatchResourceK8sIoV1alpha3, Map<String, dynamic>>(allocation, (value) => value.toMap()),
      'deallocationRequested': ?deallocationRequested,
      'reservedFor': ?pulumi.Input.mapOptionalInputValue<List<ResourceClaimConsumerReferencePatchResourceK8sIoV1alpha3>, List<Map<String, dynamic>>>(reservedFor, (value) => pulumi.Input.encodeList<ResourceClaimConsumerReferencePatchResourceK8sIoV1alpha3, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory ResourceClaimStatusPatchResourceK8sIoV1alpha3.fromMap(Map<String, dynamic> map) {
    return ResourceClaimStatusPatchResourceK8sIoV1alpha3(
      allocation: (() { final guardedValue = map['allocation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AllocationResultPatchResourceK8sIoV1alpha3.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      reservedFor: (() { final guardedValue = map['reservedFor']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ResourceClaimConsumerReferencePatchResourceK8sIoV1alpha3>(guardedValue, (value) => ResourceClaimConsumerReferencePatchResourceK8sIoV1alpha3.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
