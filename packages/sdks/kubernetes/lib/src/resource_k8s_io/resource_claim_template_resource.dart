...
class ResourceClaimTemplateResource extends pulumi.CustomResource {
  ...
  ResourceClaimTemplateResource(
    ...
    spec = registerOutput<ResourceClaimTemplateSpecResourceK8sIoV1alpha1>('spec', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ResourceClaimTemplateSpecResourceK8sIoV1alpha1.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  }

  /// Creates a typed reference to an existing [ResourceClaimTemplateResource] resource.
  ResourceClaimTemplateResource.reference(String urn)
    : super(
        'kubernetes:resource.k8s.io/v1alpha1:ResourceClaimTemplate',
