...
class NodeAllocatableMappingPatch {
  ...
  /// Creates a new [NodeAllocatableMappingPatch].
  ...
  const NodeAllocatableMappingPatch({
    this.capacityKey,
  ...
  factory NodeAllocatableMappingPatch.fromMap(Map<String, dynamic> map) {
    return NodeAllocatableMappingPatch(
