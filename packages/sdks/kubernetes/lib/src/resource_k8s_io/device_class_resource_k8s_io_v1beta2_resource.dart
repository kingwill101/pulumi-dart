...
class DeviceClassResourceK8sIoV1beta2Resource extends pulumi.CustomResource {
  ...
  DeviceClassResourceK8sIoV1beta2Resource(
    ...
    spec = registerOutput<DeviceClassSpecResourceK8sIoV1beta2>('spec', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return DeviceClassSpecResourceK8sIoV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  }

  /// Creates a typed reference to an existing [DeviceClassResourceK8sIoV1beta2Resource] resource.
  DeviceClassResourceK8sIoV1beta2Resource.reference(String urn)
    : super(
        'kubernetes:resource.k8s.io/v1beta2:DeviceClass',
