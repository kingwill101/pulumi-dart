...
class ResourceClaimStatusResourceK8sIoV1beta2 {
  ...
  final pulumi.Input<List<ResourceClaimConsumerReferenceResourceK8sIoV1beta2>>?
  reservedFor;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'devices':
          ?pulumi.Input.mapOptionalInputValue<
            List<AllocatedDeviceStatusResourceK8sIoV1beta2>,
      ...
      'reservedFor':
          ?pulumi.Input.mapOptionalInputValue<
            List<ResourceClaimConsumerReferenceResourceK8sIoV1beta2>,
            List<Map<String, dynamic>>
          >(
            reservedFor,
            (value) =>
  ...
  factory ResourceClaimStatusResourceK8sIoV1beta2.fromMap(
    ...
    return ResourceClaimStatusResourceK8sIoV1beta2(
      allocation: (() {
        ...
        return pulumi.Input.fromValue(
          AllocationResultResourceK8sIoV1beta2.fromMap(
      ...
      devices: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AllocatedDeviceStatusResourceK8sIoV1beta2>(
            guardedValue,
            (value) => AllocatedDeviceStatusResourceK8sIoV1beta2.fromMap(
      ...
      reservedFor: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                ResourceClaimConsumerReferenceResourceK8sIoV1beta2.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
