...
class ResourceSlicePatchResourceK8sIoV1alpha3Args {
  ...
  ResourceSlicePatchResourceK8sIoV1alpha3Args({
    pulumi.Output<String>? apiVersion,
    pulumi.Output<String>? kind,
    pulumi.Output<ObjectMetaPatch>? metadata,
    pulumi.Output<ResourceSliceSpecPatchResourceK8sIoV1alpha3>? spec,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMetaPatch>(metadata),
      spec = pulumi.Input.asOptionalInput<ResourceSliceSpecPatchResourceK8sIoV1alpha3>(spec);
  ...
  factory ResourceSlicePatchResourceK8sIoV1alpha3Args.fromMap(Map<String, dynamic> map) {
    return ResourceSlicePatchResourceK8sIoV1alpha3Args(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<ResourceSliceSpecPatchResourceK8sIoV1alpha3>(ResourceSliceSpecPatchResourceK8sIoV1alpha3.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
