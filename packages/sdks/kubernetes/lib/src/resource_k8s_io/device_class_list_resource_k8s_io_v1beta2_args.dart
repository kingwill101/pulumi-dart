...
class DeviceClassListResourceK8sIoV1beta2Args {
  ...
  DeviceClassListResourceK8sIoV1beta2Args({
    pulumi.Output<String>? apiVersion,
    required pulumi.Output<List<DeviceClassResourceK8sIoV1beta2Resource>> items,
    pulumi.Output<String>? kind,
    pulumi.Output<ListMeta>? metadata,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      items = pulumi.Input.asInput<List<DeviceClassResourceK8sIoV1beta2Resource>>(items),
  ...
  factory DeviceClassListResourceK8sIoV1beta2Args.fromMap(Map<String, dynamic> map) {
    return DeviceClassListResourceK8sIoV1beta2Args(
      ...
      items: pulumi.Output.create<List<DeviceClassResourceK8sIoV1beta2Resource>>((map['items'] as List).cast<DeviceClassResourceK8sIoV1beta2Resource>()),
