...
class DeviceClaimResourceK8sIoV1beta2 {
  ...
  factory DeviceClaimResourceK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return DeviceClaimResourceK8sIoV1beta2(
      config: map['config'] == null ? null : (pulumi.Input.decodeList<DeviceClaimConfigurationResourceK8sIoV1beta2>(map['config']!, (value) => DeviceClaimConfigurationResourceK8sIoV1beta2.fromMap((value as Map).cast<String, dynamic>()))).input(),
      constraints: map['constraints'] == null ? null : (pulumi.Input.decodeList<DeviceConstraintResourceK8sIoV1beta2>(map['constraints']!, (value) => DeviceConstraintResourceK8sIoV1beta2.fromMap((value as Map).cast<String, dynamic>()))).input(),
      requests: map['requests'] == null ? null : (pulumi.Input.decodeList<DeviceRequestResourceK8sIoV1beta2>(map['requests']!, (value) => DeviceRequestResourceK8sIoV1beta2.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
