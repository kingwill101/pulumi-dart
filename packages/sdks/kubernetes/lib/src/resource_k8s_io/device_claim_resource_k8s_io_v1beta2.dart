...
class DeviceClaimResourceK8sIoV1beta2 {
  ...
  final pulumi.Input<List<DeviceClaimConfigurationResourceK8sIoV1beta2>>?
  config;
    ...
    return <String, dynamic>{
      'config':
          ?pulumi.Input.mapOptionalInputValue<
            List<DeviceClaimConfigurationResourceK8sIoV1beta2>,
      ...
      'constraints':
          ?pulumi.Input.mapOptionalInputValue<
            List<DeviceConstraintResourceK8sIoV1beta2>,
            List<Map<String, dynamic>>
          >(
            constraints,
            (value) =>
      ...
      'requests':
          ?pulumi.Input.mapOptionalInputValue<
            List<DeviceRequestResourceK8sIoV1beta2>,
            List<Map<String, dynamic>>
          >(
            requests,
            (value) =>
    ...
    return DeviceClaimResourceK8sIoV1beta2(
      config: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DeviceClaimConfigurationResourceK8sIoV1beta2>(
            guardedValue,
            (value) => DeviceClaimConfigurationResourceK8sIoV1beta2.fromMap(
      ...
      constraints: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DeviceConstraintResourceK8sIoV1beta2>(
            guardedValue,
            (value) => DeviceConstraintResourceK8sIoV1beta2.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      requests: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DeviceRequestResourceK8sIoV1beta2>(
            guardedValue,
            (value) => DeviceRequestResourceK8sIoV1beta2.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
