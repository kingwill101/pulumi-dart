...
class ResourceSliceResourceK8sIoV1beta1Args {
  ...
  ResourceSliceResourceK8sIoV1beta1Args({
    pulumi.Output<String>? apiVersion,
    pulumi.Output<String>? kind,
    pulumi.Output<ObjectMeta>? metadata,
    required pulumi.Output<ResourceSliceSpecResourceK8sIoV1beta1> spec,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMeta>(metadata),
      spec = pulumi.Input.asInput<ResourceSliceSpecResourceK8sIoV1beta1>(spec);
  ...
  factory ResourceSliceResourceK8sIoV1beta1Args.fromMap(Map<String, dynamic> map) {
    return ResourceSliceResourceK8sIoV1beta1Args(
      ...
      spec: pulumi.Output.create<ResourceSliceSpecResourceK8sIoV1beta1>(ResourceSliceSpecResourceK8sIoV1beta1.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
