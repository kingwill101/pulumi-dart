...
class NodeAllocatableMappingResourceK8sIoV1beta1 {
  ...
  /// Creates a new [NodeAllocatableMappingResourceK8sIoV1beta1].
  ...
  const NodeAllocatableMappingResourceK8sIoV1beta1({
    this.capacityKey,
  ...
  factory NodeAllocatableMappingResourceK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return NodeAllocatableMappingResourceK8sIoV1beta1(
