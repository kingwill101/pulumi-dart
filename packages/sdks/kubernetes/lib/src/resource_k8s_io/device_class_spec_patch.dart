...
class DeviceClassSpecPatch {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'config': ?pulumi.Input.mapOptionalInputValue<List<DeviceClassConfigurationPatch>, List<Map<String, dynamic>>>(config, (value) => pulumi.Input.encodeList<DeviceClassConfigurationPatch, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory DeviceClassSpecPatch.fromMap(Map<String, dynamic> map) {
    return DeviceClassSpecPatch(
      config: (() { final guardedValue = map['config']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DeviceClassConfigurationPatch>(guardedValue, (value) => DeviceClassConfigurationPatch.fromMap((value as Map).cast<String, dynamic>()))); })(),
