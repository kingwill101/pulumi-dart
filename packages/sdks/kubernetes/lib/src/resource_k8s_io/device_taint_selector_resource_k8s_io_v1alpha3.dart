...
class DeviceTaintSelectorResourceK8sIoV1alpha3 {
  ...
  /// Creates a new [DeviceTaintSelectorResourceK8sIoV1alpha3].
  ...
  const DeviceTaintSelectorResourceK8sIoV1alpha3({
    this.device,
    this.driver,
    this.pool,
  });
  ...
  factory DeviceTaintSelectorResourceK8sIoV1alpha3.fromMap(Map<String, dynamic> map) {
    return DeviceTaintSelectorResourceK8sIoV1alpha3(
