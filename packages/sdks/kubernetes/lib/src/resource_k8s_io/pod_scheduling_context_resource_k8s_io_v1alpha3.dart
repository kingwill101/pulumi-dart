...
class PodSchedulingContextResourceK8sIoV1alpha3 {
  ...
  factory PodSchedulingContextResourceK8sIoV1alpha3.fromMap(
    ...
    return PodSchedulingContextResourceK8sIoV1alpha3(
      ...
      spec: pulumi.Input.fromValue(
        PodSchedulingContextSpecResourceK8sIoV1alpha3.fromMap(
      ...
      status: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PodSchedulingContextStatusResourceK8sIoV1alpha3.fromMap(
