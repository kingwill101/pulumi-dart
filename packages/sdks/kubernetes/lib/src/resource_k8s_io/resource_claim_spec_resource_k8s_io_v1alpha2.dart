...
class ResourceClaimSpecResourceK8sIoV1alpha2 {
  ...
  final ResourceClaimParametersReferenceResourceK8sIoV1alpha2? parametersRef;
  ...
  factory ResourceClaimSpecResourceK8sIoV1alpha2.fromMap(Map<String, dynamic> map) {
    return ResourceClaimSpecResourceK8sIoV1alpha2(
      ...
      parametersRef: map['parametersRef'] == null ? null : ResourceClaimParametersReferenceResourceK8sIoV1alpha2.fromMap((map['parametersRef'] as Map).cast<String, dynamic>()),
