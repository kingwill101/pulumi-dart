...
class ResourceClaimSpecResourceK8sIoV1alpha2 {
  ...
  final pulumi.Input<ResourceClaimParametersReferenceResourceK8sIoV1alpha2>? parametersRef;
  ...
  const ResourceClaimSpecResourceK8sIoV1alpha2({
    this.allocationMode,
    this.parametersRef,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'parametersRef': ?pulumi.Input.mapOptionalInputValue<ResourceClaimParametersReferenceResourceK8sIoV1alpha2, Map<String, dynamic>>(parametersRef, (value) => value.toMap()),
      'resourceClassName': resourceClassName,
    };
  }

  factory ResourceClaimSpecResourceK8sIoV1alpha2.fromMap(Map<String, dynamic> map) {
    return ResourceClaimSpecResourceK8sIoV1alpha2(
      ...
      parametersRef: (() { final guardedValue = map['parametersRef']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResourceClaimParametersReferenceResourceK8sIoV1alpha2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
