...
class DevicePatch {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'consumesCounters':
          ?pulumi.Input.mapOptionalInputValue<
            List<DeviceCounterConsumptionPatch>,
      ...
      'taints':
          ?pulumi.Input.mapOptionalInputValue<
            List<DeviceTaintPatch>,
            List<Map<String, dynamic>>
          >(
            taints,
            (value) =>
                pulumi.Input.encodeList<DeviceTaintPatch, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory DevicePatch.fromMap(Map<String, dynamic> map) {
    return DevicePatch(
      ...
      consumesCounters: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DeviceCounterConsumptionPatch>(
            guardedValue,
            (value) => DeviceCounterConsumptionPatch.fromMap(
      ...
      taints: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DeviceTaintPatch>(
            guardedValue,
            (value) => DeviceTaintPatch.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
