...
class DevicePatch {
  ...
  factory DevicePatch.fromMap(Map<String, dynamic> map) {
    return DevicePatch(
      ...
      consumesCounters: (() { final guardedValue = map['consumesCounters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DeviceCounterConsumptionPatch>(guardedValue, (value) => DeviceCounterConsumptionPatch.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      taints: (() { final guardedValue = map['taints']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DeviceTaintPatch>(guardedValue, (value) => DeviceTaintPatch.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
