...
class DeviceRequest {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'exactly': ?pulumi.Input.mapOptionalInputValue<ExactDeviceRequest, Map<String, dynamic>>(exactly, (value) => value.toMap()),
      'firstAvailable': ?pulumi.Input.mapOptionalInputValue<List<DeviceSubRequest>, List<Map<String, dynamic>>>(firstAvailable, (value) => pulumi.Input.encodeList<DeviceSubRequest, Map<String, dynamic>>(value, (value) => value.toMap())),
      'name': name,
    };
  }
  ...
  factory DeviceRequest.fromMap(Map<String, dynamic> map) {
    return DeviceRequest(
      exactly: (() { final guardedValue = map['exactly']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ExactDeviceRequest.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      firstAvailable: (() { final guardedValue = map['firstAvailable']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DeviceSubRequest>(guardedValue, (value) => DeviceSubRequest.fromMap((value as Map).cast<String, dynamic>()))); })(),
