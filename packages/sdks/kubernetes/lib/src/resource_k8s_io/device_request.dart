...
class DeviceRequest {
  ...
  final ExactDeviceRequest? exactly;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'firstAvailable': ?firstAvailable == null ? null : pulumi.Input.encodeList<DeviceSubRequest, Map<String, dynamic>>(firstAvailable!, (value) => value.toMap()),
      'name': name,
    };
  }
  ...
  factory DeviceRequest.fromMap(Map<String, dynamic> map) {
    return DeviceRequest(
      exactly: map['exactly'] == null ? null : ExactDeviceRequest.fromMap((map['exactly'] as Map).cast<String, dynamic>()),
      firstAvailable: map['firstAvailable'] == null ? null : pulumi.Input.decodeList<DeviceSubRequest>(map['firstAvailable'], (value) => DeviceSubRequest.fromMap((value as Map).cast<String, dynamic>())),
