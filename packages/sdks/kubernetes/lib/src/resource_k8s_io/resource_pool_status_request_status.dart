...
class ResourcePoolStatusRequestStatus {
  ...
  final pulumi.Input<List<PoolStatus>?>? pools;

  /// Creates a new [ResourcePoolStatusRequestStatus].
  ...
  const ResourcePoolStatusRequestStatus({
    this.conditions,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'poolCount': poolCount,
      'pools': ?pulumi.Input.mapOptionalInputValue<List<PoolStatus>, List<Map<String, dynamic>>>(pools, (value) => pulumi.Input.encodeList<PoolStatus, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory ResourcePoolStatusRequestStatus.fromMap(Map<String, dynamic> map) {
    return ResourcePoolStatusRequestStatus(
      ...
      poolCount: pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(map['poolCount'])),
      pools: (() { final guardedValue = map['pools']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PoolStatus>(guardedValue, (value) => PoolStatus.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
