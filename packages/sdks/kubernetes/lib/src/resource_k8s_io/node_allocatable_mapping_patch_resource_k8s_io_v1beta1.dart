...
class NodeAllocatableMappingPatchResourceK8sIoV1beta1 {
  ...
  /// Creates a new [NodeAllocatableMappingPatchResourceK8sIoV1beta1].
  ...
  const NodeAllocatableMappingPatchResourceK8sIoV1beta1({
    this.capacityKey,
  ...
  factory NodeAllocatableMappingPatchResourceK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return NodeAllocatableMappingPatchResourceK8sIoV1beta1(
