...
class DeviceTaintRuleSpecPatch {
  ...
  final pulumi.Input<DeviceTaintPatch?>? taint;
  ...
  const DeviceTaintRuleSpecPatch({
    this.deviceSelector,
    this.taint,
  });
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'taint': ?pulumi.Input.mapOptionalInputValue<DeviceTaintPatch, Map<String, dynamic>>(taint, (value) => value.toMap()),
    };
  }

  factory DeviceTaintRuleSpecPatch.fromMap(Map<String, dynamic> map) {
    return DeviceTaintRuleSpecPatch(
      deviceSelector: (() { final guardedValue = map['deviceSelector']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DeviceTaintSelectorPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      taint: (() { final guardedValue = map['taint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DeviceTaintPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
