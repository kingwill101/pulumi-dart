...
class PodSchedulingStatusPatch {
  ...
  final List<ResourceClaimSchedulingStatusPatch>? resourceClaims;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'resourceClaims': ?resourceClaims == null ? null : pulumi.Input.encodeList<ResourceClaimSchedulingStatusPatch, Map<String, dynamic>>(resourceClaims!, (value) => value.toMap()),
    };
  }

  factory PodSchedulingStatusPatch.fromMap(Map<String, dynamic> map) {
    return PodSchedulingStatusPatch(
      resourceClaims: map['resourceClaims'] == null ? null : pulumi.Input.decodeList<ResourceClaimSchedulingStatusPatch>(map['resourceClaims'], (value) => ResourceClaimSchedulingStatusPatch.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
