...
class ResourceSliceSpecPatch {
  ...
  factory ResourceSliceSpecPatch.fromMap(Map<String, dynamic> map) {
    return ResourceSliceSpecPatch(
      ...
      devices: map['devices'] == null ? null : (pulumi.Input.decodeList<DevicePatch>(map['devices']!, (value) => DevicePatch.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      pool: map['pool'] == null ? null : (ResourcePoolPatch.fromMap((map['pool']! as Map).cast<String, dynamic>())).input(),
      sharedCounters: map['sharedCounters'] == null ? null : (pulumi.Input.decodeList<CounterSetPatch>(map['sharedCounters']!, (value) => CounterSetPatch.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
