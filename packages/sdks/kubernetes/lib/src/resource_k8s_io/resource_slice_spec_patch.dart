    ...
    return <String, dynamic>{
      ...
      'devices':
          ...
          >(
            devices,
            (value) =>
                pulumi.Input.encodeList<DevicePatch, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      ...
      'sharedCounters':
          ?pulumi.Input.mapOptionalInputValue<
            List<CounterSetPatch>,
            List<Map<String, dynamic>>
          >(
            sharedCounters,
            (value) =>
                pulumi.Input.encodeList<CounterSetPatch, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return ResourceSliceSpecPatch(
      ...
      devices: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DevicePatch>(
            guardedValue,
            (value) =>
                DevicePatch.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      driver: (() {
      ...
      sharedCounters: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<CounterSetPatch>(
            guardedValue,
            (value) =>
                CounterSetPatch.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
    );
