...
class ResourceClaimParametersListResourceK8sIoV1alpha2 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<ResourceClaimParametersResourceK8sIoV1alpha2>> items;
  ...
  ResourceClaimParametersListResourceK8sIoV1alpha2(
    ...
    this.items = registerOutput<List<ResourceClaimParametersResourceK8sIoV1alpha2>>('items');
