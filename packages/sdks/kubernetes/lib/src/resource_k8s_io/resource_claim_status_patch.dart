...
class ResourceClaimStatusPatch {
  ...
  const ResourceClaimStatusPatch({
    this.allocation,
    this.devices,
    this.reservedFor,
  });
  ...
  factory ResourceClaimStatusPatch.fromMap(Map<String, dynamic> map) {
    return ResourceClaimStatusPatch(
      allocation: (() { final guardedValue = map['allocation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AllocationResultPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      devices: (() { final guardedValue = map['devices']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AllocatedDeviceStatusPatch>(guardedValue, (value) => AllocatedDeviceStatusPatch.fromMap((value as Map).cast<String, dynamic>()))); })(),
      reservedFor: (() { final guardedValue = map['reservedFor']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ResourceClaimConsumerReferencePatch>(guardedValue, (value) => ResourceClaimConsumerReferencePatch.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
