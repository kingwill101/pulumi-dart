...
class ResourceClaimStatusPatch {
  ...
  ResourceClaimStatusPatch({this.allocation, this.devices, this.reservedFor});
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'devices':
          ?pulumi.Input.mapOptionalInputValue<
            List<AllocatedDeviceStatusPatch>,
      ...
      'reservedFor':
          ?pulumi.Input.mapOptionalInputValue<
            List<ResourceClaimConsumerReferencePatch>,
            List<Map<String, dynamic>>
          >(
            reservedFor,
            (value) =>
  ...
  factory ResourceClaimStatusPatch.fromMap(Map<String, dynamic> map) {
    return ResourceClaimStatusPatch(
      ...
      devices: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AllocatedDeviceStatusPatch>(
            guardedValue,
            (value) => AllocatedDeviceStatusPatch.fromMap(
      ...
      reservedFor: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ResourceClaimConsumerReferencePatch>(
            guardedValue,
            (value) => ResourceClaimConsumerReferencePatch.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
