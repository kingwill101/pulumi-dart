...
class PodSchedulingContextPatchArgs {
  ...
  PodSchedulingContextPatchArgs({
    ...
    pulumi.Output<PodSchedulingContextSpecPatch>? spec,
  }) :
  ...
  factory PodSchedulingContextPatchArgs.fromMap(Map<String, dynamic> map) {
    return PodSchedulingContextPatchArgs(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<PodSchedulingContextSpecPatch>(PodSchedulingContextSpecPatch.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
