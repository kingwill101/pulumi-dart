...
class ResourceClaimSchedulingStatusPatchResourceK8sIoV1alpha2 {
  ...
  /// Creates a new [ResourceClaimSchedulingStatusPatchResourceK8sIoV1alpha2].
  ...
  const ResourceClaimSchedulingStatusPatchResourceK8sIoV1alpha2({
    this.name,
  ...
  factory ResourceClaimSchedulingStatusPatchResourceK8sIoV1alpha2.fromMap(Map<String, dynamic> map) {
    return ResourceClaimSchedulingStatusPatchResourceK8sIoV1alpha2(
