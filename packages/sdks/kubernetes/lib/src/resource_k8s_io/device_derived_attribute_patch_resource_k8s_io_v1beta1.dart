...
class DeviceDerivedAttributePatchResourceK8sIoV1beta1 {
  ...
  /// Creates a new [DeviceDerivedAttributePatchResourceK8sIoV1beta1].
  ...
  const DeviceDerivedAttributePatchResourceK8sIoV1beta1({
    this.expression,
    this.name,
  });
  ...
  factory DeviceDerivedAttributePatchResourceK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return DeviceDerivedAttributePatchResourceK8sIoV1beta1(
