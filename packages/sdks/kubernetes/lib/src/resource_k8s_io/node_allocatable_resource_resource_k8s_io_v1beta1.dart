...
import 'node_allocatable_mapping_resource_k8s_io_v1beta1.dart';
import 'node_allocatable_overhead_resource_k8s_io_v1beta1.dart';
...
class NodeAllocatableResourceResourceK8sIoV1beta1 {
  ...
  final pulumi.Input<NodeAllocatableMappingResourceK8sIoV1beta1?>? mapping;
  ...
  final pulumi.Input<NodeAllocatableOverheadResourceK8sIoV1beta1?>? overhead;

  /// Creates a new [NodeAllocatableResourceResourceK8sIoV1beta1].
  ...
  const NodeAllocatableResourceResourceK8sIoV1beta1({
    this.mapping,
    this.overhead,
  });
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'mapping': ?pulumi.Input.mapOptionalInputValue<NodeAllocatableMappingResourceK8sIoV1beta1, Map<String, dynamic>>(mapping, (value) => value.toMap()),
      'overhead': ?pulumi.Input.mapOptionalInputValue<NodeAllocatableOverheadResourceK8sIoV1beta1, Map<String, dynamic>>(overhead, (value) => value.toMap()),
    };
  }

  factory NodeAllocatableResourceResourceK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return NodeAllocatableResourceResourceK8sIoV1beta1(
      mapping: (() { final guardedValue = map['mapping']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NodeAllocatableMappingResourceK8sIoV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      overhead: (() { final guardedValue = map['overhead']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NodeAllocatableOverheadResourceK8sIoV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
