...
class ResourceClaimTemplatePatchResourceK8sIoV1alpha1Args {
  ...
  ResourceClaimTemplatePatchResourceK8sIoV1alpha1Args({
    ...
    pulumi.Output<ResourceClaimTemplateSpecPatchResourceK8sIoV1alpha1>? spec,
  }) :
  ...
  factory ResourceClaimTemplatePatchResourceK8sIoV1alpha1Args.fromMap(Map<String, dynamic> map) {
    return ResourceClaimTemplatePatchResourceK8sIoV1alpha1Args(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<ResourceClaimTemplateSpecPatchResourceK8sIoV1alpha1>(ResourceClaimTemplateSpecPatchResourceK8sIoV1alpha1.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
