...
class ResourceSlicePatchResourceK8sIoV1alpha2 {
  ...
  final NamedResourcesResourcesPatch? namedResources;
  ...
  factory ResourceSlicePatchResourceK8sIoV1alpha2.fromMap(Map<String, dynamic> map) {
    return ResourceSlicePatchResourceK8sIoV1alpha2(
      ...
      namedResources: map['namedResources'] == null ? null : NamedResourcesResourcesPatch.fromMap((map['namedResources'] as Map).cast<String, dynamic>()),
