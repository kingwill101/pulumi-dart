...
class ResourceSliceSpecPatchResourceK8sIoV1beta2 {
  ...
  factory ResourceSliceSpecPatchResourceK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return ResourceSliceSpecPatchResourceK8sIoV1beta2(
      ...
      devices: map['devices'] == null ? null : (pulumi.Input.decodeList<DevicePatchResourceK8sIoV1beta2>(map['devices']!, (value) => DevicePatchResourceK8sIoV1beta2.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      pool: map['pool'] == null ? null : (ResourcePoolPatchResourceK8sIoV1beta2.fromMap((map['pool']! as Map).cast<String, dynamic>())).input(),
      sharedCounters: map['sharedCounters'] == null ? null : (pulumi.Input.decodeList<CounterSetPatchResourceK8sIoV1beta2>(map['sharedCounters']!, (value) => CounterSetPatchResourceK8sIoV1beta2.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
