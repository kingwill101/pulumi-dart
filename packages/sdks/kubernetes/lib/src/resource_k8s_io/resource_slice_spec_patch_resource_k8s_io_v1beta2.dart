...
class ResourceSliceSpecPatchResourceK8sIoV1beta2 {
  ...
  const ResourceSliceSpecPatchResourceK8sIoV1beta2({
    this.allNodes,
    this.devices,
    this.driver,
    this.nodeName,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'allNodes': ?allNodes,
      'devices': ?pulumi.Input.mapOptionalInputValue<List<DevicePatchResourceK8sIoV1beta2>, List<Map<String, dynamic>>>(devices, (value) => pulumi.Input.encodeList<DevicePatchResourceK8sIoV1beta2, Map<String, dynamic>>(value, (value) => value.toMap())),
      'driver': ?driver,
      'nodeName': ?nodeName,
      ...
      'pool': ?pulumi.Input.mapOptionalInputValue<ResourcePoolPatchResourceK8sIoV1beta2, Map<String, dynamic>>(pool, (value) => value.toMap()),
      'sharedCounters': ?pulumi.Input.mapOptionalInputValue<List<CounterSetPatchResourceK8sIoV1beta2>, List<Map<String, dynamic>>>(sharedCounters, (value) => pulumi.Input.encodeList<CounterSetPatchResourceK8sIoV1beta2, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory ResourceSliceSpecPatchResourceK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return ResourceSliceSpecPatchResourceK8sIoV1beta2(
      ...
      devices: (() { final guardedValue = map['devices']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DevicePatchResourceK8sIoV1beta2>(guardedValue, (value) => DevicePatchResourceK8sIoV1beta2.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      pool: (() { final guardedValue = map['pool']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResourcePoolPatchResourceK8sIoV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      sharedCounters: (() { final guardedValue = map['sharedCounters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<CounterSetPatchResourceK8sIoV1beta2>(guardedValue, (value) => CounterSetPatchResourceK8sIoV1beta2.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
