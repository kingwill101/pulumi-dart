...
class CounterSetResourceK8sIoV1beta2 {
  ...
  factory CounterSetResourceK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return CounterSetResourceK8sIoV1beta2(
      counters: (pulumi.Input.decodeMapValues<CounterResourceK8sIoV1beta2>(map['counters'], (value) => CounterResourceK8sIoV1beta2.fromMap((value as Map).cast<String, dynamic>()))).input(),
