...
class DeviceClassPatchResourceK8sIoV1alpha3Args {
  ...
  DeviceClassPatchResourceK8sIoV1alpha3Args({
    ...
    pulumi.Output<DeviceClassSpecPatchResourceK8sIoV1alpha3>? spec,
  }) :
  ...
  factory DeviceClassPatchResourceK8sIoV1alpha3Args.fromMap(Map<String, dynamic> map) {
    return DeviceClassPatchResourceK8sIoV1alpha3Args(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<DeviceClassSpecPatchResourceK8sIoV1alpha3>(DeviceClassSpecPatchResourceK8sIoV1alpha3.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
