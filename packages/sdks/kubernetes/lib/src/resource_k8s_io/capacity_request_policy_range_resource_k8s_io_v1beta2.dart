...
class CapacityRequestPolicyRangeResourceK8sIoV1beta2 {
  ...
  /// Creates a new [CapacityRequestPolicyRangeResourceK8sIoV1beta2].
  ...
  const CapacityRequestPolicyRangeResourceK8sIoV1beta2({
    this.max,
    required this.min,
    this.step,
  });
  ...
  factory CapacityRequestPolicyRangeResourceK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return CapacityRequestPolicyRangeResourceK8sIoV1beta2(
