...
class DeviceTaintSelectorPatchResourceK8sIoV1beta2 {
  ...
  /// Creates a new [DeviceTaintSelectorPatchResourceK8sIoV1beta2].
  ...
  const DeviceTaintSelectorPatchResourceK8sIoV1beta2({
    this.device,
    this.driver,
    this.pool,
  });
  ...
  factory DeviceTaintSelectorPatchResourceK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return DeviceTaintSelectorPatchResourceK8sIoV1beta2(
