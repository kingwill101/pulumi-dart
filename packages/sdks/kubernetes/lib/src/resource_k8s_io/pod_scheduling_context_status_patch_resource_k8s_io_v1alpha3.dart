...
class PodSchedulingContextStatusPatchResourceK8sIoV1alpha3 {
  ...
  final pulumi.Input<
    List<ResourceClaimSchedulingStatusPatchResourceK8sIoV1alpha3>
  >?
  resourceClaims;
  ...
  PodSchedulingContextStatusPatchResourceK8sIoV1alpha3({this.resourceClaims});
  ...
  factory PodSchedulingContextStatusPatchResourceK8sIoV1alpha3.fromMap(
      ...
      resourceClaims: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                ResourceClaimSchedulingStatusPatchResourceK8sIoV1alpha3.fromMap(
