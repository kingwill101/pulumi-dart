...
class DeviceSubRequestResourceK8sIoV1beta2 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'selectors':
          ?pulumi.Input.mapOptionalInputValue<
            List<DeviceSelectorResourceK8sIoV1beta2>,
            List<Map<String, dynamic>>
          >(
            selectors,
            (value) =>
                pulumi.Input.encodeList<
                  DeviceSelectorResourceK8sIoV1beta2,
                  Map<String, dynamic>
                >(value, (value) => value.toMap()),
          ),
      'tolerations':
          ?pulumi.Input.mapOptionalInputValue<
            List<DeviceTolerationResourceK8sIoV1beta2>,
            List<Map<String, dynamic>>
          >(
            tolerations,
            (value) =>
  ...
  factory DeviceSubRequestResourceK8sIoV1beta2.fromMap(
    ...
    return DeviceSubRequestResourceK8sIoV1beta2(
      ...
      capacity: (() {
        ...
        return pulumi.Input.fromValue(
          CapacityRequirementsResourceK8sIoV1beta2.fromMap(
      ...
      selectors: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DeviceSelectorResourceK8sIoV1beta2>(
            guardedValue,
            (value) => DeviceSelectorResourceK8sIoV1beta2.fromMap(
      ...
      tolerations: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DeviceTolerationResourceK8sIoV1beta2>(
            guardedValue,
            (value) => DeviceTolerationResourceK8sIoV1beta2.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
