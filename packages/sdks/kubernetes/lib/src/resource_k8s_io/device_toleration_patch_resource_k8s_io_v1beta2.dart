...
class DeviceTolerationPatchResourceK8sIoV1beta2 {
  ...
  /// Creates a new [DeviceTolerationPatchResourceK8sIoV1beta2].
  ...
  const DeviceTolerationPatchResourceK8sIoV1beta2({
    this.effect,
    this.key,
    this.operator,
  ...
  factory DeviceTolerationPatchResourceK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return DeviceTolerationPatchResourceK8sIoV1beta2(
      ...
      tolerationSeconds: (() { final guardedValue = map['tolerationSeconds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
