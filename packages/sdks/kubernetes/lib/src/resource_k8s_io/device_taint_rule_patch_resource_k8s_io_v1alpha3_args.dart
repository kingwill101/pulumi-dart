...
/// {@template pulumi_resource_k8s_io_v1alpha3_device_taint_rule_patch_resource_k8s_io_v1alpha3_args_doc}
/// The set of arguments for DeviceTaintRulePatch.
/// {@endtemplate}
/// {@macro pulumi_resource_k8s_io_v1alpha3_device_taint_rule_patch_resource_k8s_io_v1alpha3_args_doc}
class DeviceTaintRulePatchResourceK8sIoV1alpha3Args {
  ...
  /// Creates a new [DeviceTaintRulePatchResourceK8sIoV1alpha3Args].
  ...
  const DeviceTaintRulePatchResourceK8sIoV1alpha3Args({
    this.apiVersion,
    this.kind,
    this.metadata,
    this.spec,
  ...
  factory DeviceTaintRulePatchResourceK8sIoV1alpha3Args.fromMap(Map<String, dynamic> map) {
    return DeviceTaintRulePatchResourceK8sIoV1alpha3Args(
