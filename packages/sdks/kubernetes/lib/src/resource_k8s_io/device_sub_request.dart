...
import 'device_derived_attribute.dart';
...
class DeviceSubRequest {
  ...
  final pulumi.Input<List<DeviceDerivedAttribute>?>? derivedAttributes;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'count': ?count,
      'derivedAttributes': ?pulumi.Input.mapOptionalInputValue<List<DeviceDerivedAttribute>, List<Map<String, dynamic>>>(derivedAttributes, (value) => pulumi.Input.encodeList<DeviceDerivedAttribute, Map<String, dynamic>>(value, (value) => value.toMap())),
