...
class DevicePatchResourceK8sIoV1alpha3 {
  ...
  const DevicePatchResourceK8sIoV1alpha3({
    this.basic,
    this.name,
  });
  ...
  factory DevicePatchResourceK8sIoV1alpha3.fromMap(Map<String, dynamic> map) {
    return DevicePatchResourceK8sIoV1alpha3(
      basic: (() { final guardedValue = map['basic']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BasicDevicePatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
