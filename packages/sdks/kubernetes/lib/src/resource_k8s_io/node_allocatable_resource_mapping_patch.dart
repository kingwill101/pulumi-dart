...
class NodeAllocatableResourceMappingPatch {
  ...
  /// Creates a new [NodeAllocatableResourceMappingPatch].
  ...
  const NodeAllocatableResourceMappingPatch({
  ...
  factory NodeAllocatableResourceMappingPatch.fromMap(Map<String, dynamic> map) {
    return NodeAllocatableResourceMappingPatch(
