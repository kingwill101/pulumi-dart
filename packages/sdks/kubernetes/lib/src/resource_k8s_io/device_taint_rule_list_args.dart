...
class DeviceTaintRuleListArgs {
  ...
  DeviceTaintRuleListArgs({
    ...
    required pulumi.Output<List<DeviceTaintRuleResourceK8sIoV1alpha3>> items,
    pulumi.Output<String>? kind,
    pulumi.Output<ListMeta>? metadata,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      items = pulumi.Input.asInput<List<DeviceTaintRuleResourceK8sIoV1alpha3>>(items),
  ...
  factory DeviceTaintRuleListArgs.fromMap(Map<String, dynamic> map) {
    return DeviceTaintRuleListArgs(
      ...
      items: pulumi.Output.create<List<DeviceTaintRuleResourceK8sIoV1alpha3>>((map['items'] as List).cast<DeviceTaintRuleResourceK8sIoV1alpha3>()),
